// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/DafnyTests/RunAllTests/RunAllTestsOption.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/DafnyTests/RunAllTests/RunAllTestsOption-@PROC@.smt2 /normalizeNames:0 /emitDebugInformation:1 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/DafnyTests/RunAllTests/RunAllTestsOption.dfy
...
procedure {:verboseName "Passing1 (well-formedness)"} CheckWellFormed$$_module.__default.Passing1();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Passing1 (call)"} Call$$_module.__default.Passing1();
  modifies $Heap;
...
procedure {:verboseName "Passing1 (correctness)"} Impl$$_module.__default.Passing1() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "Passing2 (well-formedness)"} CheckWellFormed$$_module.__default.Passing2();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Passing2 (call)"} Call$$_module.__default.Passing2();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "Passing2 (correctness)"} Impl$$_module.__default.Passing2() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "Failing1 (well-formedness)"} CheckWellFormed$$_module.__default.Failing1();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Failing1 (call)"} Call$$_module.__default.Failing1();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "Failing1 (correctness)"} Impl$$_module.__default.Failing1() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "Passing3 (well-formedness)"} CheckWellFormed$$_module.__default.Passing3();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Passing3 (call)"} Call$$_module.__default.Passing3();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "Passing3 (correctness)"} Impl$$_module.__default.Passing3() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "Failing2 (well-formedness)"} CheckWellFormed$$_module.__default.Failing2();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Failing2 (call)"} Call$$_module.__default.Failing2();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "Failing2 (correctness)"} Impl$$_module.__default.Failing2() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "FailingReturnValue (well-formedness)"} CheckWellFormed$$_module.__default.FailingReturnValue()
   returns (result#0: DatatypeType
       where $Is(result#0, Tclass._module.VoidOutcome())
         && $IsAlloc(result#0, Tclass._module.VoidOutcome(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "FailingReturnValue (call)"} Call$$_module.__default.FailingReturnValue()
   returns (result#0: DatatypeType
       where $Is(result#0, Tclass._module.VoidOutcome())
         && $IsAlloc(result#0, Tclass._module.VoidOutcome(), $Heap));
  modifies $Heap;
...
procedure {:verboseName "FailingReturnValue (correctness)"} Impl$$_module.__default.FailingReturnValue()
   returns (result#0: DatatypeType
       where $Is(result#0, Tclass._module.VoidOutcome())
         && $IsAlloc(result#0, Tclass._module.VoidOutcome(), $Heap), 
    $_reverifyPost: bool);
...
axiom {:id "id1"} (forall this: DatatypeType :: 
...
axiom {:id "id2"} (forall this: DatatypeType :: 
...
axiom {:id "id3"} (forall this: DatatypeType :: 
  { _module.NatOutcome.PropagateFailure(this) } 
  _module.NatOutcome.PropagateFailure#canCall(this)
       || ($Is(this, Tclass._module.NatOutcome()) && _module.NatOutcome.IsFailure(this))
...
axiom {:id "id4"} (forall this: DatatypeType :: 
...
axiom {:id "id5"} (forall this: DatatypeType :: 
  { _module.NatOutcome.Extract(this) } 
  _module.NatOutcome.Extract#canCall(this)
       || ($Is(this, Tclass._module.NatOutcome()) && !_module.NatOutcome.IsFailure(this))
...
axiom {:id "id6"} (forall this: DatatypeType :: 
...
axiom {:id "id7"} (forall this: DatatypeType :: 
...
axiom {:id "id8"} (forall this: DatatypeType :: 
...
axiom {:id "id9"} (forall this: DatatypeType :: 
  { _module.VoidOutcome.PropagateFailure(this) } 
  _module.VoidOutcome.PropagateFailure#canCall(this)
       || ($Is(this, Tclass._module.VoidOutcome()) && _module.VoidOutcome.IsFailure(this))
...
axiom {:id "id10"} (forall this: DatatypeType :: 
