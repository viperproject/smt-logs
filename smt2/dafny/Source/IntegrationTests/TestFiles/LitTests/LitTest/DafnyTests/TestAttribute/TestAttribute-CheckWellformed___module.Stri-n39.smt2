...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) (|key#0@@1| T@U) ) (!  (=> (or (|_module.StringMap.Get#canCall| $Heap@@1 this@@1 |key#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.StringMap) ($IsAlloc refType this@@1 Tclass._module.StringMap $Heap@@1)))) ($Is SeqType |key#0@@1| (TSeq TChar))) (_module.StringMap.Contains $Heap@@1 this@@1 |key#0@@1|)))) (= (_module.StringMap.Get $Heap@@1 this@@1 |key#0@@1|) ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.StringMap.m))) ($Box SeqType |key#0@@1|)))))
 :qid |TestAttributedfy.259:12|
 :skolemid |767|
 :pattern ( (_module.StringMap.Get $Heap@@1 this@@1 |key#0@@1|) ($IsGoodHeap $Heap@@1))
))))
...
(declare-fun |key#0@@2| () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.StringMap.Get)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (=> (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.StringMap.m))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.StringMap.m))) ($Box SeqType |key#0@@2|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.StringMap.m))) ($Box SeqType |key#0@@2|)) (=> (= (_module.StringMap.Get $Heap@@2 this@@2 |key#0@@2|) ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.StringMap.m))) ($Box SeqType |key#0@@2|)))) (=> (and ($Is SeqType (_module.StringMap.Get $Heap@@2 this@@2 |key#0@@2|) (TSeq TChar)) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#1@0|)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#34| null $Heap@@2 alloc this@@2)) ($IsAllocBox ($Box refType this@@2) Tclass._module.StringMap? $Heap@@2)) (=> (and (and ($IsAlloc SeqType |key#0@@2| (TSeq TChar) $Heap@@2) (= |b$reqreads#0@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@4) alloc)))) (= $o@@4 this@@2)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |TestAttributedfy.260:14|
 :skolemid |768|
)))) (and (|_module.StringMap.Contains#canCall| $Heap@@2 this@@2 |key#0@@2|) (_module.StringMap.Contains $Heap@@2 this@@2 |key#0@@2|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.StringMap) ($IsAlloc refType this@@2 Tclass._module.StringMap $Heap@@2))) ($Is SeqType |key#0@@2| (TSeq TChar))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 5))) anon0_correct))))
