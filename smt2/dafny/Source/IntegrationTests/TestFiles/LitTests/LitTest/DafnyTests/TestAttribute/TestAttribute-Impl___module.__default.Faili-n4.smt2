...
(set-info :boogie-vc-id Impl$$_module.__default.FailingTestUsingAssignOrHalt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (not (_module.NatOutcome.IsFailure |valueOrError0#0@1|)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |valueOrError0#0@1|) Tclass._module.NatOutcome $Heap) (= (ControlFlow 0 3) (- 0 2))) (not (_module.NatOutcome.IsFailure |valueOrError0#0@1|))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |x#0@0| (LitInt 5)) (= |y#0@0| (LitInt 0))) (and ($Is DatatypeTypeType |valueOrError0#0@0| Tclass._module.NatOutcome) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| Tclass._module.NatOutcome $Heap))) (and (=> (= (ControlFlow 0 4) (- 0 6)) ($Is intType (int_2_U |x#0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |x#0@0|) Tclass._System.nat) (=> ($IsAlloc intType (int_2_U |x#0@0|) Tclass._System.nat $Heap) (and (=> (= (ControlFlow 0 4) (- 0 5)) ($Is intType (int_2_U |y#0@0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |y#0@0|) Tclass._System.nat) (=> ($IsAlloc intType (int_2_U |y#0@0|) Tclass._System.nat $Heap) (=> (and (|_module.__default.SafeDivide#canCall| |x#0@0| |y#0@0|) (|_module.__default.SafeDivide#canCall| |x#0@0| |y#0@0|)) (=> (and (and (= |valueOrError0#0@1| (_module.__default.SafeDivide |x#0@0| |y#0@0|)) ($IsAllocBox ($Box DatatypeTypeType |valueOrError0#0@1|) Tclass._module.NatOutcome $Heap)) (and (|_module.NatOutcome.IsFailure#canCall| |valueOrError0#0@1|) (|_module.NatOutcome.IsFailure#canCall| |valueOrError0#0@1|))) (and (=> (= (ControlFlow 0 4) 1) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 0) |q#0|) true)) (=> (and (and (and ($Is DatatypeTypeType |valueOrError0#0| Tclass._module.NatOutcome) ($IsAlloc DatatypeTypeType |valueOrError0#0| Tclass._module.NatOutcome $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 4))) anon0_correct))))
