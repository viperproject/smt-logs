...
(set-info :boogie-vc-id Impl$$_module.__default.UnsafeDivide)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (or (not (= |b#0| 0)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |b#0| 0)) (not true))) (=> (or (not (= |b#0| 0)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) ($Is intType (int_2_U (Div |a#0| |b#0|)) Tclass._System.nat)))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 3) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |a#0|)) (and (and (<= (LitInt 0) |b#0|) (<= (LitInt 0) |r#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
