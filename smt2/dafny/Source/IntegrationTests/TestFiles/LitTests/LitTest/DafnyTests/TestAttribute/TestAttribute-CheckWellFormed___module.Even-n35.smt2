...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@164  (=> (and (= $generated@@162 ($generated@@120 $generated@@30 $generated@@163 $generated@@1 false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= ($generated@@71 2) 0)) (not true)))))
(let (($generated@@165  (=> (and (and ($generated@@79 $generated@@163) ($generated@@105 $generated@@163)) (and (= 1 $generated@@114) (= (ControlFlow 0 3) 2))) $generated@@164)))
$generated@@165)))
))
(check-sat)
(get-info :rlimit)
