...
(assert (distinct TBool TChar TagBool TagChar TagSet TagSeq TagMap alloc allocName |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.StringMap Tagclass._module.StringMap? class._module.StringMap? |tytagFamily$_tuple#2| tytagFamily$StringMap field$m)
)
(assert (= (FDim alloc) 0))
...
(assert  (and (= (Ctor SeqType) 9) (= (Ctor MapType) 10)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|key#0| T@U) ) (!  (=> (or (|_module.StringMap.Contains#canCall| $Heap this |key#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.StringMap) ($IsAlloc refType this Tclass._module.StringMap $Heap)))) ($Is SeqType |key#0| (TSeq TChar))))) (= (_module.StringMap.Contains $Heap this |key#0|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.StringMap.m))) ($Box SeqType |key#0|))))
 :qid |TestAttributedfy.255:12|
 :skolemid |762|
 :pattern ( (_module.StringMap.Contains $Heap this |key#0|) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.StringMap.Contains)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@0 _module.StringMap.m))) (= (_module.StringMap.Contains $Heap@@0 this@@0 |key#0@@0|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.StringMap.m))) ($Box SeqType |key#0@@0|)))) (and ($Is boolType (bool_2_U (_module.StringMap.Contains $Heap@@0 this@@0 |key#0@@0|)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#34| null $Heap@@0 alloc this@@0)) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.StringMap) ($IsAlloc refType this@@0 Tclass._module.StringMap $Heap@@0))) ($Is SeqType |key#0@@0| (TSeq TChar))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
