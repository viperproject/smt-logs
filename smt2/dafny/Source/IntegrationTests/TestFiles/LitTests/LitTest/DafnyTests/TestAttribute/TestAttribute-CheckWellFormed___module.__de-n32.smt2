...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) (|key#0@@0| T@U) ) (!  (=> (or (|_module.StringMap.Contains#canCall| $Heap@@0 this@@0 |key#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.StringMap) ($IsAlloc refType this@@0 Tclass._module.StringMap $Heap@@0)))) ($Is SeqType |key#0@@0| (TSeq TChar))))) (= (_module.StringMap.Contains $Heap@@0 this@@0 |key#0@@0|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.StringMap.m))) ($Box SeqType |key#0@@0|))))
 :qid |TestAttributedfy.255:12|
 :skolemid |762|
 :pattern ( (_module.StringMap.Contains $Heap@@0 this@@0 |key#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((v@@5 T@U) (t0@@3 T@U) (t1@@0 T@U) (h@@5 T@U) ) (! (= ($IsAlloc MapType v@@5 (TMap t0@@3 t1@@0) h@@5) (forall ((bx@@5 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@5) bx@@5) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@5) bx@@5) t1@@0 h@@5) ($IsAllocBox bx@@5 t0@@3 h@@5)))
...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@1 T@U) (|key#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.StringMap))) (or (|_module.StringMap.Contains#canCall| $h0 this@@1 |key#0@@1|) ($Is SeqType |key#0@@1| (TSeq TChar)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 this@@1)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))
 :qid |unknown.0:0|
 :skolemid |758|
)) (= (_module.StringMap.Contains $h0 this@@1 |key#0@@1|) (_module.StringMap.Contains $h1 this@@1 |key#0@@1|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |759|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.StringMap.Contains $h1 this@@1 |key#0@@1|))
)))
(assert (forall ((bx@@6 T@U) (s@@0 T@U) (t@@10 T@U) ) (!  (=> ($IsBox bx@@6 (TMap s@@0 t@@10)) (and (= ($Box MapType ($Unbox MapType bx@@6)) bx@@6) ($Is MapType ($Unbox MapType bx@@6) (TMap s@@0 t@@10))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@6 (TMap s@@0 t@@10)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|key#0@@2| T@U) ) (!  (=> (or (|_module.StringMap.Get#canCall| $Heap@@1 this@@2 |key#0@@2|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.StringMap) ($IsAlloc refType this@@2 Tclass._module.StringMap $Heap@@1)))) ($Is SeqType |key#0@@2| (TSeq TChar))) (_module.StringMap.Contains $Heap@@1 this@@2 |key#0@@2|)))) (= (_module.StringMap.Get $Heap@@1 this@@2 |key#0@@2|) ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.StringMap.m))) ($Box SeqType |key#0@@2|)))))
 :qid |TestAttributedfy.259:12|
 :skolemid |767|
 :pattern ( (_module.StringMap.Get $Heap@@1 this@@2 |key#0@@2|) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((bx@@8 T@U) (t@@11 T@U) ) (!  (=> ($IsBox bx@@8 (TSet t@@11)) (and (= ($Box SetType ($Unbox SetType bx@@8)) bx@@8) ($Is SetType ($Unbox SetType bx@@8) (TSet t@@11))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |32|
 :pattern ( ($IsBox bx@@8 (TSet t@@11)))
)))
(assert (forall ((bx@@9 T@U) (t@@12 T@U) ) (!  (=> ($IsBox bx@@9 (TSeq t@@12)) (and (= ($Box SeqType ($Unbox SeqType bx@@9)) bx@@9) ($Is SeqType ($Unbox SeqType bx@@9) (TSeq t@@12))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx@@9 (TSeq t@@12)))
)))
(assert (forall ((v@@8 T@U) (t0@@5 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@8 (TMap t0@@5 t1@@2)) (forall ((bx@@10 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@10) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@10) t1@@2) ($IsBox bx@@10 t0@@5)))
...
(assert (forall (($h@@5 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.StringMap?))) ($Is MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) _module.StringMap.m)) (TMap (TSeq TChar) (TSeq TChar))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |756|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) _module.StringMap.m)))
)))
...
(declare-fun |v#0| () T@U)
(declare-fun |m#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MockStringMap)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@6)))
 :qid |TestAttributedfy.271:22|
 :skolemid |712|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap@@2 $Heap@0)) (and ($Is refType |m#0@0| Tclass._module.StringMap) ($IsAlloc refType |m#0@0| Tclass._module.StringMap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |m#0@0|) Tclass._module.StringMap? $Heap@0) ($IsAlloc SeqType |k#0| (TSeq TChar) $Heap@0)) (and (|_module.StringMap.Contains#canCall| $Heap@0 |m#0@0| |k#0|) (= (_module.StringMap.Contains $Heap@0 |m#0@0| |k#0|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |m#0@0|) Tclass._module.StringMap? $Heap@0) (=> (and (and ($IsAlloc SeqType |k#0| (TSeq TChar) $Heap@0) (= (ControlFlow 0 2) (- 0 1))) (|_module.StringMap.Contains#canCall| $Heap@0 |m#0@0| |k#0|)) (or (_module.StringMap.Contains $Heap@0 |m#0@0| |k#0|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.StringMap.m))) ($Box SeqType |k#0|)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and ($Is SeqType |k#0| (TSeq TChar)) ($IsAlloc SeqType |k#0| (TSeq TChar) $Heap@@2)) (and ($Is SeqType |v#0| (TSeq TChar)) ($IsAlloc SeqType |v#0| (TSeq TChar) $Heap@@2))) (and (and ($Is refType |m#0| Tclass._module.StringMap) ($IsAlloc refType |m#0| Tclass._module.StringMap $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
