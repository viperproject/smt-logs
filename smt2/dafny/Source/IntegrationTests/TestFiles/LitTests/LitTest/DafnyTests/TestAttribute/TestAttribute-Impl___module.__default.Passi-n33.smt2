...
(declare-fun Tagclass._module.StringMap () T@U)
(declare-fun Tagclass._module.StringMap? () T@U)
(declare-fun class._module.StringMap? () T@U)
(declare-fun |tytagFamily$_tuple#2| () T@U)
(declare-fun tytagFamily$StringMap () T@U)
...
(declare-fun _module.StringMap.Get (T@U T@U T@U) T@U)
(declare-fun |_module.StringMap.Get#canCall| (T@U T@U T@U) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun null () T@U)
(declare-fun $Is (T@T T@U T@U) Bool)
(declare-fun refType () T@T)
(declare-fun Tclass._module.StringMap () T@U)
(declare-fun $IsAlloc (T@T T@U T@U T@U) Bool)
(declare-fun SeqType () T@T)
(declare-fun TSeq (T@U) T@U)
(declare-fun _module.StringMap.Contains (T@U T@U T@U) Bool)
...
(declare-fun _module.StringMap.m () T@U)
...
(declare-fun _module.StringMap.GetOrDefault (T@U T@U T@U T@U) T@U)
(declare-fun |_module.StringMap.GetOrDefault#canCall| (T@U T@U T@U T@U) Bool)
(declare-fun |_module.StringMap.Contains#canCall| (T@U T@U T@U) Bool)
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.StringMap) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) Tclass._module.StringMap)))
 :qid |unknown.0:0|
 :skolemid |711|
 :pattern ( ($IsBox bx@@2 Tclass._module.StringMap))
)))
(assert (forall ((bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 Tclass._module.StringMap?) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) Tclass._module.StringMap?)))
 :qid |unknown.0:0|
 :skolemid |713|
 :pattern ( ($IsBox bx@@3 Tclass._module.StringMap?))
)))
...
(assert (forall (($h@@2 T@U) ($o@@1 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) Tclass._module.StringMap?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))) ($IsAlloc MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) _module.StringMap.m)) (TMap (TSeq TChar) (TSeq TChar)) $h@@2))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |757|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) _module.StringMap.m)))
)))
...
(assert (forall ((v@@7 T@U) (t0@@3 T@U) (t1@@0 T@U) (h@@5 T@U) ) (! (= ($IsAlloc MapType v@@7 (TMap t0@@3 t1@@0) h@@5) (forall ((bx@@6 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@6) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@6) t1@@0 h@@5) ($IsAllocBox bx@@6 t0@@3 h@@5)))
...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@1 T@U) (|key#0@@3| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.StringMap))) (or (|_module.StringMap.Contains#canCall| $h0 this@@1 |key#0@@3|) ($Is SeqType |key#0@@3| (TSeq TChar)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 this@@1)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))
 :qid |unknown.0:0|
 :skolemid |758|
)) (= (_module.StringMap.Contains $h0 this@@1 |key#0@@3|) (_module.StringMap.Contains $h1 this@@1 |key#0@@3|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |759|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.StringMap.Contains $h1 this@@1 |key#0@@3|))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@3 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@3 $f@@0))  (=> (and (or (not (= $o@@3 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |840|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@3 $f@@0))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@2 T@U) (|key#0@@4| T@U) ) (!  (=> (or (|_module.StringMap.Get#canCall| $Heap@@3 this@@2 |key#0@@4|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.StringMap) ($IsAlloc refType this@@2 Tclass._module.StringMap $Heap@@3)))) ($Is SeqType |key#0@@4| (TSeq TChar))) (_module.StringMap.Contains $Heap@@3 this@@2 |key#0@@4|)))) (= (_module.StringMap.Get $Heap@@3 this@@2 |key#0@@4|) ($Unbox SeqType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.StringMap.m))) ($Box SeqType |key#0@@4|)))))
 :qid |TestAttributedfy.259:12|
 :skolemid |767|
 :pattern ( (_module.StringMap.Get $Heap@@3 this@@2 |key#0@@4|) ($IsGoodHeap $Heap@@3))
))))
...
(assert (forall ((v@@10 T@U) (t0@@5 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@10 (TMap t0@@5 t1@@2)) (forall ((bx@@11 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@10) bx@@11) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@10) bx@@11) t1@@2) ($IsBox bx@@11 t0@@5)))
 :qid |DafnyPreludebpl.261:19|
 :skolemid |55|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@10) bx@@11))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@10) bx@@11))
)))
...
(assert (= (Tag Tclass._module.StringMap?) Tagclass._module.StringMap?))
(assert (= (TagFamily Tclass._module.StringMap?) tytagFamily$StringMap))
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@3 T@U) (|key#0@@5| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.StringMap))) (or (|_module.StringMap.Get#canCall| $h0@@0 this@@3 |key#0@@5|) ($Is SeqType |key#0@@5| (TSeq TChar)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@4 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (= $o@@4 this@@3)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@4) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@4) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |763|
)) (= (_module.StringMap.Get $h0@@0 this@@3 |key#0@@5|) (_module.StringMap.Get $h1@@0 this@@3 |key#0@@5|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |764|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.StringMap.Get $h1@@0 this@@3 |key#0@@5|))
)))
...
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (|m#0@@1| T@U) (|key#0@@6| T@U) (|default#0@@1| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (or (|_module.StringMap.GetOrDefault#canCall| $h0@@1 |m#0@@1| |key#0@@6| |default#0@@1|) (and (and ($Is refType |m#0@@1| Tclass._module.StringMap) ($Is SeqType |key#0@@6| (TSeq TChar))) ($Is SeqType |default#0@@1| (TSeq TChar))))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@5 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (= $o@@5 |m#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@5) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@5) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |769|
)) (= (_module.StringMap.GetOrDefault $h0@@1 |m#0@@1| |key#0@@6| |default#0@@1|) (_module.StringMap.GetOrDefault $h1@@1 |m#0@@1| |key#0@@6| |default#0@@1|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |770|
 :pattern ( ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1) (_module.StringMap.GetOrDefault $h1@@1 |m#0@@1| |key#0@@6| |default#0@@1|))
)))
(assert (forall ((h@@6 T@U) (v@@11 T@U) ) (! ($IsAlloc charType v@@11 TChar h@@6)
 :qid |DafnyPreludebpl.292:14|
 :skolemid |64|
 :pattern ( ($IsAlloc charType v@@11 TChar h@@6))
)))
(assert (forall (($h@@5 T@U) ($o@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) Tclass._module.StringMap?))) ($Is MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@6) _module.StringMap.m)) (TMap (TSeq TChar) (TSeq TChar))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |756|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@6) _module.StringMap.m)))
)))
...
(declare-fun |##default#0@0| () T@U)
(declare-fun |##key#1@0| () T@U)
(declare-fun |##default#1@0| () T@U)
(declare-fun |defass#stringMap#0| () Bool)
(declare-fun |stringMap#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.PassingTestGetOrDefault)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_Else_correct true))
(let ((anon2_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (=> (and (and (and (and (= |k##0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97))))) (= |v##0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98)))))) (and ($Is refType |call3formal@m#0| Tclass._module.StringMap) ($IsAlloc refType |call3formal@m#0| Tclass._module.StringMap $Heap@@4))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($Is refType |call3formal@m#0@0| Tclass._module.StringMap) ($IsAlloc refType |call3formal@m#0@0| Tclass._module.StringMap $Heap@0)))) (and (and (and (|_module.StringMap.Contains#canCall| $Heap@0 |call3formal@m#0@0| |k##0@0|) (=> (= (_module.StringMap.Contains $Heap@0 |call3formal@m#0@0| |k##0@0|) (U_2_bool (Lit boolType (bool_2_U true)))) (|_module.StringMap.Get#canCall| $Heap@0 |call3formal@m#0@0| |k##0@0|))) (and (= (_module.StringMap.Contains $Heap@0 |call3formal@m#0@0| |k##0@0|) (U_2_bool (Lit boolType (bool_2_U true)))) (|Seq#Equal| (_module.StringMap.Get $Heap@0 |call3formal@m#0@0| |k##0@0|) |v##0@0|))) (and (and (or (not (= |call3formal@m#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |call3formal@m#0@0|) alloc))))) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@7)))
 :qid |TestAttributedfy.271:22|
 :skolemid |714|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap@@4 $Heap@0))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) true) (=> ($IsAlloc refType |call3formal@m#0@0| Tclass._module.StringMap $Heap@0) (=> (and (= |##key#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97))))) ($IsAlloc SeqType |##key#0@0| (TSeq TChar) $Heap@0)) (=> (and (and (= |##default#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 99))))) ($IsAlloc SeqType |##default#0@0| (TSeq TChar) $Heap@0)) (and (|_module.StringMap.GetOrDefault#canCall| $Heap@0 |call3formal@m#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97)))) (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 99))))) (|_module.StringMap.GetOrDefault#canCall| $Heap@0 |call3formal@m#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97)))) (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 99))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (|Seq#Equal| (_module.StringMap.GetOrDefault $Heap@0 |call3formal@m#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97)))) (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 99))))) (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98))))) (=> (|Seq#Equal| (_module.StringMap.GetOrDefault $Heap@0 |call3formal@m#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97)))) (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 99))))) (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 98)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) true) (=> ($IsAlloc refType |call3formal@m#0@0| Tclass._module.StringMap $Heap@0) (=> (and (= |##key#1@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97))))) ($IsAlloc SeqType |##key#1@0| (TSeq TChar) $Heap@0)) (=> (and (and (= |##default#1@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 99))))) ($IsAlloc SeqType |##default#1@0| (TSeq TChar) $Heap@0)) (and (|_module.StringMap.GetOrDefault#canCall| $Heap@0 |call3formal@m#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97)))) (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 99))))) (|_module.StringMap.GetOrDefault#canCall| $Heap@0 |call3formal@m#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97)))) (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 99))))))) (and (=> (= (ControlFlow 0 3) 1) anon2_Then_correct) (=> (= (ControlFlow 0 3) 2) anon2_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (=> |defass#stringMap#0| (and ($Is refType |stringMap#0| Tclass._module.StringMap) ($IsAlloc refType |stringMap#0| Tclass._module.StringMap $Heap@@4))) true) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 7) 3))) anon0_correct))))
