...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@1 T@U) (|key#0@@3| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.StringMap))) (or (|_module.StringMap.Contains#canCall| $h0 this@@1 |key#0@@3|) ($Is SeqType |key#0@@3| (TSeq TChar)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 this@@1)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))) (= (_module.StringMap.Contains $h0 this@@1 |key#0@@3|) (_module.StringMap.Contains $h1 this@@1 |key#0@@3|))))
...
(assert (= (Tag Tclass._module.StringMap?) Tagclass._module.StringMap?))
(assert (= (TagFamily Tclass._module.StringMap?) tytagFamily$StringMap))
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@3 T@U) (|key#0@@5| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.StringMap))) (or (|_module.StringMap.Get#canCall| $h0@@0 this@@3 |key#0@@5|) ($Is SeqType |key#0@@5| (TSeq TChar)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@4 T@U) ($f@@1 T@U) )  (=> (and (or (not (= $o@@4 null)) (not true)) (= $o@@4 this@@3)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@4) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@4) $f@@1)))) (= (_module.StringMap.Get $h0@@0 this@@3 |key#0@@5|) (_module.StringMap.Get $h1@@0 this@@3 |key#0@@5|))))
...
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (|m#0@@1| T@U) (|key#0@@6| T@U) (|default#0@@1| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (or (|_module.StringMap.GetOrDefault#canCall| $h0@@1 |m#0@@1| |key#0@@6| |default#0@@1|) (and (and ($Is refType |m#0@@1| Tclass._module.StringMap) ($Is SeqType |key#0@@6| (TSeq TChar))) ($Is SeqType |default#0@@1| (TSeq TChar))))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@5 T@U) ($f@@2 T@U) )  (=> (and (or (not (= $o@@5 null)) (not true)) (= $o@@5 |m#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@5) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@5) $f@@2)))) (= (_module.StringMap.GetOrDefault $h0@@1 |m#0@@1| |key#0@@6| |default#0@@1|) (_module.StringMap.GetOrDefault $h1@@1 |m#0@@1| |key#0@@6| |default#0@@1|))))
