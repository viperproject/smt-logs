...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split43)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((anon103_correct  (=> (=> (or (not (= |d#0@2| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|)) (=> (and (=> (or (not (= |d#0@2| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|) |dest#0@@3|))) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U true)))))))
...
(let ((anon96_correct  (=> (and (and (and (and (and (and (=> (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)) (=> (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (ite (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| (|Set#Union| |N#0@0| |newlyEncountered#4_0@1|)) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |$rhs#4_0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))) (and (= |$rhs#4_2@1| (|Set#Union| |V#0@0| |newlyEncountered#4_0@1|)) (= |$rhs#4_3@1| (|Set#Union| |N#0@0| |newlyEncountered#4_0@1|)))) (and (and ($Is MapType |call8formal@newPaths#0| (TMap call0formal@_module.BreadthFirstSearch$Vertex (Tclass._module.List call0formal@_module.BreadthFirstSearch$Vertex))) ($IsAlloc MapType |call8formal@newPaths#0| (TMap call0formal@_module.BreadthFirstSearch$Vertex (Tclass._module.List call0formal@_module.BreadthFirstSearch$Vertex)) $Heap@@3)) (=> (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (or (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (forall ((|v#4@@0| T@U) ) (!  (=> ($IsBox |v#4@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#4@@0|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#4@@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#4@@0|)))))
...
)))) (|Set#Equal| (|Map#Domain| |call8formal@newPaths#0@0|) (|Set#Union| (|Map#Domain| |paths#0@0|) |newlyEncountered#4_0@1|))) (and (forall ((|x#1@@0| T@U) ) (!  (=> ($IsBox |x#1@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@0|) (and (and (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|)) (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |call8formal@newPaths#0@0|))) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |call8formal@newPaths#0@0|)))))
 ...
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@0|))
)) (forall ((|x#1@@1| T@U) ) (!  (=> ($IsBox |x#1@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@1|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |call8formal@newPaths#0@0|))))
 :qid |BreadthFirstSearchdfy.248:20|
 :skolemid |814|
 ...
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@1|))
)))) (and (and (forall ((|x#3@@0| T@U) ) (!  (=> ($IsBox |x#3@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@0|) (and (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |call8formal@newPaths#0@0|)) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |call8formal@newPaths#0@0|))))
 ...
 :pattern ( (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@0|))
)) (forall ((|x#3@@1| T@U) ) (!  (=> ($IsBox |x#3@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@1|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@1| |call8formal@newPaths#0@0|) (|#_module.List.Cons| |v#4_0@1| |pathToV#4_0@1|))))
 :qid |BreadthFirstSearchdfy.250:20|
 :skolemid |816|
 ...
 :pattern ( (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@1|))
...
)))))) (and (=> |$w$loop#0@0| (|Set#Equal| |$rhs#0@0| (|Map#Domain| |$rhs#4@0|))) (=> |$w$loop#0@0| (forall ((|x#1@@2| T@U) ) (!  (=> ($IsBox |x#1@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |$rhs#1@0| |x#1@@2|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |$rhs#4@0|)) |d#0@0|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |670|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |$rhs#4@0|))
 :pattern ( (|Set#IsMember| |$rhs#1@0| |x#1@@2|))
)))))) (and (and (and (=> |$w$loop#0@0| (forall ((|x#3@@2| T@U) ) (!  (=> ($IsBox |x#3@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |$rhs#2@0| |x#3@@2|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@2| |$rhs#4@0|)) (+ |d#0@0| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@2| |$rhs#4@0|))
 :pattern ( (|Set#IsMember| |$rhs#2@0| |x#3@@2|))
...
))))) (=> |$w$loop#0@0| (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|)))) (and (=> |$w$loop#0@0| (forall ((|x#1@@3| T@U) ) (!  (=> ($IsBox |x#1@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@3|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |669|
...
))) (=> |$w$loop#0@0| (forall ((|x#1@@4| T@U) ) (!  (=> ($IsBox |x#1@@4| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@4|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@4| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |670|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@4| |paths#0@0|))
 :pattern ( (|Set#IsMember| |C#0@0| |x#1@@4|))
))))) (and (and (=> |$w$loop#0@0| (forall ((|x#1@@5| T@U) ) (!  (=> ($IsBox |x#1@@5| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@5|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@5| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |671|
...
))) (=> |$w$loop#0@0| (forall ((|x#3@@3| T@U) ) (!  (=> ($IsBox |x#3@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@3|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@3| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@3| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |677|
...
)))) (and (=> |$w$loop#0@0| (forall ((|x#3@@4| T@U) ) (!  (=> ($IsBox |x#3@@4| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@4|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@4| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@4| |paths#0@0|))
 :pattern ( (|Set#IsMember| |N#0@0| |x#3@@4|))
))) (=> |$w$loop#0@0| (forall ((|x#3@@5| T@U) ) (!  (=> ($IsBox |x#3@@5| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@5|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@5| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |679|
