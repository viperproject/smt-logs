...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.build__rec_split30)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon27_Then_correct  (=> ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap) (=> (and ($IsAlloc SeqType |s#0@@3| (TSeq TInt) $Heap) (= (ControlFlow 0 2) (- 0 1))) (or (<= 0 (|Seq#Length| |s#0@@3|)) (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)))))))
