...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split40)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon167_Then_correct  (=> (and (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (and (= $Heap@8 $Heap@9) reveal__module.BreadthFirstSearch.R)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@9) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@9)) (and ($Is intType (int_2_U |d#0@2|) Tclass._System.nat) ($IsAlloc intType (int_2_U |d#0@2|) Tclass._System.nat $Heap@9))) (and (and ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@9) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) (= (ControlFlow 0 2) (- 0 1))))) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |C#0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|))))))
(let ((anon166_Else_correct  (=> (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (=> (and (and (= |C#0@1| |$rhs#4_0@1|) (= |N#0@1| |$rhs#4_3@1|)) (and (= |d#0@2| |d#0@1|) (= (ControlFlow 0 4) 2))) anon167_Then_correct))))
(let ((anon166_Then_correct  (=> (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (=> (and (= |$rhs#4_4_1@1| (Lit SetType |Set#Empty|)) (= |$rhs#4_4_2@1| (+ |d#0@1| 1))) (=> (and (and (= |C#0@1| |$rhs#4_3@1|) (= |N#0@1| |$rhs#4_4_1@1|)) (and (= |d#0@2| |$rhs#4_4_2@1|) (= (ControlFlow 0 3) 2))) anon167_Then_correct)))))
