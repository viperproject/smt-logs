...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split95)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon31_correct  (=> (and (and (forall ((|x#1@@0| T@U) ) (!  (=> ($IsBox |x#1@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@0|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|)))))
 ...
 :pattern ( (|Set#IsMember| |C#0@0| |x#1@@0|))
)) (forall ((|x#1@@1| T@U) ) (!  (=> ($IsBox |x#1@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@1|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |668|
...
))) (and ($IsBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (=> (and (and (and (|Set#IsMember| |N#0@0| |x#2@0|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (and (and ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4) (= (ControlFlow 0 2) (- 0 1))) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|))) (or (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (forall ((|v#8| T@U) ) (!  (=> ($IsBox |v#8| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#8|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#8| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#8|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |672|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#8|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#8|))
)))))))
(let ((anon134_Else_correct  (=> (and (not (|Set#IsMember| |C#0@0| |x#0@0|)) (= (ControlFlow 0 5) 2)) anon31_correct)))
(let ((anon134_Then_correct  (=> (and (|Set#IsMember| |C#0@0| |x#0@0|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (=> (and (and (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#0@0| |paths#0@0|))) (and (and (= |##list#3@0| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#0@0| |paths#0@0|)) ($IsAlloc DatatypeTypeType |##list#3@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#0@0| |paths#0@0|)) (= (ControlFlow 0 4) 2)))) anon31_correct))))
(let ((anon133_Then_correct  (=> (and ($IsBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and (=> (= (ControlFlow 0 6) 4) anon134_Then_correct) (=> (= (ControlFlow 0 6) 5) anon134_Else_correct)))))
(let ((anon133_Else_correct  (=> (and (not (and ($IsBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 3) 2)) anon31_correct)))
(let ((anon28_correct  (=> (and (and (and (and (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (|Set#Disjoint| (|Set#Union| |Processed#0@0| |C#0@0|) |N#0@0|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4))) (and (and (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|)) (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))))) (and (=> (= (ControlFlow 0 7) 6) anon133_Then_correct) (=> (= (ControlFlow 0 7) 3) anon133_Else_correct)))))
(let ((anon132_Else_correct  (=> (and (not (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|))) (= (ControlFlow 0 9) 7)) anon28_correct)))
(let ((anon132_Then_correct  (=> (and (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (= (ControlFlow 0 8) 7)) anon28_correct)))
(let ((anon131_Else_correct  (=> (not (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (and (=> (= (ControlFlow 0 11) 8) anon132_Then_correct) (=> (= (ControlFlow 0 11) 9) anon132_Else_correct)))))
(let ((anon131_Then_correct  (=> (|Set#Disjoint| |Processed#0@0| |C#0@0|) (and (=> (= (ControlFlow 0 10) 8) anon132_Then_correct) (=> (= (ControlFlow 0 10) 9) anon132_Else_correct)))))
(let ((anon24_correct  (=> (and (and (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|)) (|Set#Subset| |N#0@0| |AllVertices#0@@10|)) (and (|Set#IsMember| |V#0@0| |source#0@@17|) (|Set#Equal| |V#0@0| (|Set#Union| (|Set#Union| |Processed#0@0| |C#0@0|) |N#0@0|)))) (and (=> (= (ControlFlow 0 12) 10) anon131_Then_correct) (=> (= (ControlFlow 0 12) 11) anon131_Else_correct)))))
(let ((anon130_Else_correct  (=> (and (not (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|))) (= (ControlFlow 0 14) 12)) anon24_correct)))
(let ((anon130_Then_correct  (=> (and (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|)) (= (ControlFlow 0 13) 12)) anon24_correct)))
(let ((anon129_Else_correct  (=> (not (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|))) (and (=> (= (ControlFlow 0 16) 13) anon130_Then_correct) (=> (= (ControlFlow 0 16) 14) anon130_Else_correct)))))
(let ((anon129_Then_correct  (=> (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (and (=> (= (ControlFlow 0 15) 13) anon130_Then_correct) (=> (= (ControlFlow 0 15) 14) anon130_Else_correct)))))
(let ((anon128_Else_correct  (=> (not (|Set#Subset| |V#0@0| |AllVertices#0@@10|)) (and (=> (= (ControlFlow 0 18) 15) anon129_Then_correct) (=> (= (ControlFlow 0 18) 16) anon129_Else_correct)))))
(let ((anon128_Then_correct  (=> (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (and (=> (= (ControlFlow 0 17) 15) anon129_Then_correct) (=> (= (ControlFlow 0 17) 16) anon129_Else_correct)))))
...
))))) (=> |$w$loop#0@0| (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))))) (and (and (=> |$w$loop#0@0| (forall ((|x#1@@3| T@U) ) (!  (=> ($IsBox |x#1@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@3|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |669|
...
)))) (and (=> |$w$loop#0@0| (forall ((|x#1@@5| T@U) ) (!  (=> ($IsBox |x#1@@5| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@5|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@5| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |671|
...
))))))) (and (and (and (and (=> |$w$loop#0@0| (forall ((|x#3@@2| T@U) ) (!  (=> ($IsBox |x#3@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@2|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@2| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
...
)))) (and (=> |$w$loop#0@0| (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)) (=> |$w$loop#0@0| (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |C#0@0| |dest#0@@3|))))) (and (and (=> |$w$loop#0@0| (=> (or (not (= |d#0@1| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|))) (=> |$w$loop#0@0| (=> (or (not (= |d#0@1| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|) |dest#0@@3|))))) (and (=> |$w$loop#0@0| (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)) (=> |$w$loop#0@0| (|Set#Equal| (|Set#Union| |Processed#0@0| |C#0@0|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))))) (and (and (and (=> |$w$loop#0@0| (and (|_module.BreadthFirstSearch.Successors#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |Processed#0@0| |AllVertices#0@@10|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (=> |$w$loop#0@0| (|Set#Equal| |N#0@0| (|Set#Difference| (_module.BreadthFirstSearch.Successors _module.BreadthFirstSearch$Vertex@@37 this@@27 |Processed#0@0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))))) (and (=> |$w$loop#0@0| (=> (|Set#Equal| |C#0@0| |Set#Empty|) (|Set#Equal| |N#0@0| |Set#Empty|))) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@2)))
 :qid |BreadthFirstSearchdfy.64:5|
 :skolemid |680|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@2))
)))) (and (and ($HeapSucc $Heap@@3 $Heap@4) (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@3) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@3) $f@@0)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@3 $f@@0))))
 :qid |BreadthFirstSearchdfy.64:5|
 :skolemid |681|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@3) $f@@0))
))) (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) (not |$w$loop#0@0|)))))))) (and (=> (= (ControlFlow 0 19) 17) anon128_Then_correct) (=> (= (ControlFlow 0 19) 18) anon128_Else_correct))))))
(let ((anon123_Else_correct  (=> (and (= |d#0@0| 0) (= (ControlFlow 0 21) 19)) anon12_correct)))
(let ((anon123_Then_correct  (=> (or (not (= |d#0@0| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@@3)) (and ($Is intType (int_2_U (- |d#0@0| 1)) Tclass._System.nat) (= |##n#3@0| (- |d#0@0| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#3@0|) Tclass._System.nat $Heap@@3) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|) (= (ControlFlow 0 20) 19)))) anon12_correct))))
(let ((anon6_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |$rhs#1@0| |dest#0@@3|))) (and (=> (= (ControlFlow 0 22) 20) anon123_Then_correct) (=> (= (ControlFlow 0 22) 21) anon123_Else_correct)))))
(let ((anon120_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|)) (= (ControlFlow 0 24) 22)) anon6_correct)))
(let ((anon120_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (= (ControlFlow 0 23) 22)) anon6_correct)))
