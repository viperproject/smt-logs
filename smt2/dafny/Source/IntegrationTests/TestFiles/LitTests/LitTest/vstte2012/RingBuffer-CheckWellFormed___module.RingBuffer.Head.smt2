...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@20 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@20 $f@@0))  (=> (and (or (not (= $o@@20 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@20) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |558|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@20 $f@@0))
)))
...
(assert (forall ((_module.RingBuffer$T@@20 T@U) ($h@@19 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) (Tclass._module.RingBuffer? _module.RingBuffer$T@@20)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) _module.RingBuffer.Contents)) (TSeq _module.RingBuffer$T@@20)))
 :qid |unknown.0:0|
 :skolemid |497|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) _module.RingBuffer.Contents)) (Tclass._module.RingBuffer? _module.RingBuffer$T@@20))
)))
(assert (forall ((_module.RingBuffer$T@@21 T@U) ($h@@20 T@U) ($o@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) (Tclass._module.RingBuffer? _module.RingBuffer$T@@21)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@22) _module.RingBuffer.data)) (Tclass._System.array _module.RingBuffer$T@@21)))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@22) _module.RingBuffer.data)) (Tclass._module.RingBuffer? _module.RingBuffer$T@@21))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.RingBuffer.Head)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and ($IsAllocBox ($Box refType this@@2) (Tclass._module.RingBuffer? _module.RingBuffer$T@@24) $Heap@@1) (|_module.RingBuffer.Valid#canCall| _module.RingBuffer$T@@24 $Heap@@1 this@@2)) (and (_module.RingBuffer.Valid _module.RingBuffer$T@@24 $Heap@@1 this@@2) (not (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Contents)) |Seq#Empty|)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@23 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@23) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@23)))
 :qid |RingBufferdfy.50:10|
 :skolemid |535|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (and ($IsBox |x#0@0| _module.RingBuffer$T@@24) ($IsAllocBox |x#0@0| _module.RingBuffer$T@@24 $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.RingBuffer.Contents))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24)) ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1)))) (and (and ($IsBox |x#0@@1| _module.RingBuffer$T@@24) ($IsAllocBox |x#0@@1| _module.RingBuffer$T@@24 $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
