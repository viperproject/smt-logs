...
(assert (forall ((d@@8 T@U) (_module.List$T@@5 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.List.Cons_q d@@8) ($IsAlloc DatatypeTypeType d@@8 (Tclass._module.List _module.List$T@@5) $h@@4))) ($IsAllocBox (_module.List.head d@@8) _module.List$T@@5 $h@@4))
 :qid |unknown.0:0|
 :skolemid |845|
 :pattern ( ($IsAllocBox (_module.List.head d@@8) _module.List$T@@5 $h@@4))
)))
...
(assert (forall ((m@@5 T@U) ) (!  (or (= m@@5 |Map#Empty|) (exists ((k@@3 T@U) ) (! (|Set#IsMember| (|Map#Domain| m@@5) k@@3)
...
(assert (forall ((d@@10 T@U) (_module.List$T@@7 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_module.List.Cons_q d@@10) ($IsAlloc DatatypeTypeType d@@10 (Tclass._module.List _module.List$T@@7) $h@@5))) ($IsAlloc DatatypeTypeType (_module.List.tail d@@10) (Tclass._module.List _module.List$T@@7) $h@@5))
 :qid |unknown.0:0|
 :skolemid |846|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List.tail d@@10) (Tclass._module.List _module.List$T@@7) $h@@5))
)))
...
(assert (forall ((d@@11 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_System.Tuple2.___hMake2_q d@@11) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@11 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@6)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@11 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@6))
)))) ($IsAllocBox (_System.Tuple2._0 d@@11) |_System._tuple#2$T0@@6| $h@@6))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@11) |_System._tuple#2$T0@@6| $h@@6))
)))
(assert (forall ((d@@12 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_System.Tuple2.___hMake2_q d@@12) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@12 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@7)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@12 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@7))
)))) ($IsAllocBox (_System.Tuple2._1 d@@12) |_System._tuple#2$T1@@7| $h@@7))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@12) |_System._tuple#2$T1@@7| $h@@7))
)))
...
(assert (forall ((m@@10 T@U) ) (!  (or (= m@@10 |Map#Empty|) (exists ((k@@4 T@U) (v@@9 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@10) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@4 v@@9)))
...
(declare-fun |$rhs#4_2@1| () T@U)
(declare-fun |C#0@1| () T@U)
(declare-fun |N#0@1| () T@U)
(declare-fun |call8formal@newPaths#0@0| () T@U)
(declare-fun |$w$loop#0@0| () Bool)
(declare-fun $Heap@8 () T@U)
(declare-fun |##n#4_10@1| () Int)
(declare-fun |$rhs#4_0@1| () T@U)
(declare-fun |$rhs#4_3@1| () T@U)
(declare-fun |d#0@1| () Int)
(declare-fun |$rhs#4_4_1@1| () T@U)
(declare-fun |$rhs#4_4_2@1| () Int)
(declare-fun |N#0@0| () T@U)
(declare-fun |newlyEncountered#4_0@1| () T@U)
...
(declare-fun |##n#4_6@1| () Int)
(declare-fun |w#4_3@1| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split49)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((anon103_correct  (=> (=> (or (not (= |d#0@2| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|)) (=> (and (and (=> (or (not (= |d#0@2| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|) |dest#0@@3|))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |$rhs#4_1@1|) |$decr$loop#00@1|) (not (|Set#Subset| |$decr$loop#00@1| (|Set#Difference| |AllVertices#0@@10| |$rhs#4_1@1|))))) (=> (and (and (and (=> (|Set#Subset| |$rhs#4_2@1| |AllVertices#0@@10|) (=> (|Set#Subset| |$rhs#4_1@1| |AllVertices#0@@10|) (=> (|Set#Subset| |C#0@1| |AllVertices#0@@10|) (=> (|Set#Subset| |N#0@1| |AllVertices#0@@10|) (=> (|Set#IsMember| |$rhs#4_2@1| |source#0@@17|) (=> (|Set#Equal| |$rhs#4_2@1| (|Set#Union| (|Set#Union| |$rhs#4_1@1| |C#0@1|) |N#0@1|)) (=> (and (and (|Set#Disjoint| |$rhs#4_1@1| |C#0@1|) (|Set#Disjoint| |$rhs#4_1@1| |C#0@1|)) (|Set#Disjoint| (|Set#Union| |$rhs#4_1@1| |C#0@1|) |N#0@1|)) (and (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |call8formal@newPaths#0@0|) (=> (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |call8formal@newPaths#0@0|) (=> (|Set#Equal| |$rhs#4_2@1| (|Map#Domain| |call8formal@newPaths#0@0|)) (and (forall ((|x#1@@0| T@U) ) (!  (=> ($IsBox |x#1@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@1| |x#1@@0|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |call8formal@newPaths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |call8formal@newPaths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |695|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |call8formal@newPaths#0@0|))
 :pattern ( (|Set#IsMember| |C#0@1| |x#1@@0|))
)) (=> (forall ((|x#1@@1| T@U) ) (!  (=> ($IsBox |x#1@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@1| |x#1@@1|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |call8formal@newPaths#0@0|)) |d#0@2|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |698|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |call8formal@newPaths#0@0|))
 :pattern ( (|Set#IsMember| |C#0@1| |x#1@@1|))
)) (and (forall ((|x#3@@0| T@U) ) (!  (=> ($IsBox |x#3@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@1| |x#3@@0|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |call8formal@newPaths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |call8formal@newPaths#0@0|)))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |696|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |call8formal@newPaths#0@0|))
 :pattern ( (|Set#IsMember| |N#0@1| |x#3@@0|))
)) (=> (forall ((|x#3@@1| T@U) ) (!  (=> ($IsBox |x#3@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@1| |x#3@@1|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@1| |call8formal@newPaths#0@0|)) (+ |d#0@2| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |697|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@1| |call8formal@newPaths#0@0|))
 :pattern ( (|Set#IsMember| |N#0@1| |x#3@@1|))
)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) (=> (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |C#0@1| |dest#0@@3|)) (and (=> (or (not (= |d#0@2| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|)) (=> (=> (or (not (= |d#0@2| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|) |dest#0@@3|))) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) (=> (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |C#0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|)) (and (|_module.BreadthFirstSearch.Successors#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |$rhs#4_1@1| |AllVertices#0@@10|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|)))))))))))))))))))))) (=> |$w$loop#0@0| (|Set#Subset| |$rhs#4_2@1| |AllVertices#0@@10|))) (and (=> |$w$loop#0@0| (|Set#Subset| |$rhs#4_1@1| |AllVertices#0@@10|)) (=> |$w$loop#0@0| (|Set#Subset| |C#0@1| |AllVertices#0@@10|)))) (and (and (=> |$w$loop#0@0| (|Set#Subset| |N#0@1| |AllVertices#0@@10|)) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|)) (|Set#IsMember| |$rhs#4_2@1| |source#0@@17|))))))
(let ((anon168_Else_correct  (=> (and (= |d#0@2| 0) (= (ControlFlow 0 4) 2)) anon103_correct)))
(let ((anon168_Then_correct  (=> (or (not (= |d#0@2| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@8) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@8)) (and ($Is intType (int_2_U (- |d#0@2| 1)) Tclass._System.nat) (= |##n#4_10@1| (- |d#0@2| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#4_10@1|) Tclass._System.nat $Heap@8) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@8)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|) (= (ControlFlow 0 3) 2)))) anon103_correct))))
(let ((anon167_Else_correct  (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@8) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@8)) (and ($Is intType (int_2_U |d#0@2|) Tclass._System.nat) ($IsAlloc intType (int_2_U |d#0@2|) Tclass._System.nat $Heap@8))) (and (and ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@8) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |C#0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|))))) (and (=> (= (ControlFlow 0 5) 3) anon168_Then_correct) (=> (= (ControlFlow 0 5) 4) anon168_Else_correct)))))
(let ((anon166_Else_correct  (=> (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (=> (and (and (= |C#0@1| |$rhs#4_0@1|) (= |N#0@1| |$rhs#4_3@1|)) (and (= |d#0@2| |d#0@1|) (= (ControlFlow 0 7) 5))) anon167_Else_correct))))
(let ((anon166_Then_correct  (=> (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (=> (and (= |$rhs#4_4_1@1| (Lit SetType |Set#Empty|)) (= |$rhs#4_4_2@1| (+ |d#0@1| 1))) (=> (and (and (= |C#0@1| |$rhs#4_3@1|) (= |N#0@1| |$rhs#4_4_1@1|)) (and (= |d#0@2| |$rhs#4_4_2@1|) (= (ControlFlow 0 6) 5))) anon167_Else_correct)))))
(let ((anon96_correct  (=> (and (and (and (and (and (and (=> (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)) (=> (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (ite (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| (|Set#Union| |N#0@0| |newlyEncountered#4_0@1|)) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |$rhs#4_0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))) (and (= |$rhs#4_2@1| (|Set#Union| |V#0@0| |newlyEncountered#4_0@1|)) (= |$rhs#4_3@1| (|Set#Union| |N#0@0| |newlyEncountered#4_0@1|)))) (and (and ($Is MapType |call8formal@newPaths#0| (TMap call0formal@_module.BreadthFirstSearch$Vertex (Tclass._module.List call0formal@_module.BreadthFirstSearch$Vertex))) ($IsAlloc MapType |call8formal@newPaths#0| (TMap call0formal@_module.BreadthFirstSearch$Vertex (Tclass._module.List call0formal@_module.BreadthFirstSearch$Vertex)) $Heap@@3)) (=> (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (or (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (forall ((|v#4@@0| T@U) ) (!  (=> ($IsBox |v#4@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#4@@0|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#4@@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#4@@0|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |805|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#4@@0|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#4@@0|))
)))))) (and (and (and (|Set#Disjoint| |newlyEncountered#4_0@1| (|Map#Domain| |paths#0@0|)) (forall ((|succ#1| T@U) ) (!  (=> ($IsBox |succ#1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |newlyEncountered#4_0@1| |succ#1|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |succ#1| (|#_module.List.Cons| |v#4_0@1| |pathToV#4_0@1|))))
 :qid |BreadthFirstSearchdfy.246:21|
 :skolemid |808|
 :pattern ( (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |succ#1| (|#_module.List.Cons| |v#4_0@1| |pathToV#4_0@1|)))
 :pattern ( (|Set#IsMember| |newlyEncountered#4_0@1| |succ#1|))
))) (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8))) (and (and ($Is MapType |call8formal@newPaths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37))) ($IsAlloc MapType |call8formal@newPaths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@8)) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |call8formal@newPaths#0@0|)))) (and (and (and (and (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |call8formal@newPaths#0@0|) (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |call8formal@newPaths#0@0|) (forall ((|v#5@@0| T@U) ) (!  (=> ($IsBox |v#5@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |call8formal@newPaths#0@0|) |v#5@@0|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |v#5@@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |call8formal@newPaths#0@0|) |v#5@@0|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |812|
...
)))) (|Set#Equal| (|Map#Domain| |call8formal@newPaths#0@0|) (|Set#Union| (|Map#Domain| |paths#0@0|) |newlyEncountered#4_0@1|))) (and (forall ((|x#1@@2| T@U) ) (!  (=> ($IsBox |x#1@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@2|) (and (and (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |paths#0@0|)) (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |call8formal@newPaths#0@0|))) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |paths#0@0|) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |call8formal@newPaths#0@0|)))))
 :qid |BreadthFirstSearchdfy.248:20|
 :skolemid |813|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |call8formal@newPaths#0@0|))
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |paths#0@0|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@2|))
)) (forall ((|x#1@@3| T@U) ) (!  (=> ($IsBox |x#1@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@3|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |call8formal@newPaths#0@0|))))
 :qid |BreadthFirstSearchdfy.248:20|
 :skolemid |814|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |call8formal@newPaths#0@0|))
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@3|))
)))) (and (and (forall ((|x#3@@2| T@U) ) (!  (=> ($IsBox |x#3@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@2|) (and (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@2| |call8formal@newPaths#0@0|)) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@2| |call8formal@newPaths#0@0|))))
 :qid |BreadthFirstSearchdfy.250:20|
 :skolemid |815|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@2| |call8formal@newPaths#0@0|))
 :pattern ( (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@2|))
)) (forall ((|x#3@@3| T@U) ) (!  (=> ($IsBox |x#3@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@3|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@3| |call8formal@newPaths#0@0|) (|#_module.List.Cons| |v#4_0@1| |pathToV#4_0@1|))))
 :qid |BreadthFirstSearchdfy.250:20|
 :skolemid |816|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@3| |call8formal@newPaths#0@0|))
 :pattern ( (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@3|))
))) (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@2)))
 :qid |BreadthFirstSearchdfy.241:16|
 :skolemid |817|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@2))
)) ($HeapSuccGhost $Heap@4 $Heap@8))))) (and (=> (= (ControlFlow 0 8) 6) anon166_Then_correct) (=> (= (ControlFlow 0 8) 7) anon166_Else_correct)))))
(let ((anon165_Else_correct  (=> (and (and (and (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($Is intType (int_2_U |d#0@1|) Tclass._System.nat))) (and (and ($IsAlloc intType (int_2_U |d#0@1|) Tclass._System.nat $Heap@4) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) (= (ControlFlow 0 10) 8)))) anon96_correct)))
(let ((anon165_Then_correct  (=> (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($Is intType (int_2_U (+ |d#0@1| 1)) Tclass._System.nat) (= |##n#4_6@1| (+ |d#0@1| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#4_6@1|) Tclass._System.nat $Heap@4) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|) (= (ControlFlow 0 9) 8)))) anon96_correct))))
(let ((anon88_correct  (=> (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (= |newlyEncountered#4_0@1| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (and (=> (= (ControlFlow 0 11) 9) anon165_Then_correct) (=> (= (ControlFlow 0 11) 10) anon165_Else_correct)))))
(let ((anon162_Else_correct  (=> (and (not (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_3@1|) (not (|Set#IsMember| |V#0@0| |w#4_3@1|)))) (= (ControlFlow 0 14) 11)) anon88_correct)))
(let ((anon162_Then_correct  (=> (and (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_3@1|) (not (|Set#IsMember| |V#0@0| |w#4_3@1|))) (= (ControlFlow 0 13) 11)) anon88_correct)))
(let ((anon161_Else_correct  (=> (not (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_3@1|)) (and (=> (= (ControlFlow 0 16) 13) anon162_Then_correct) (=> (= (ControlFlow 0 16) 14) anon162_Else_correct)))))
(let ((anon161_Then_correct  (=> (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_3@1|) (and (=> (= (ControlFlow 0 15) 13) anon162_Then_correct) (=> (= (ControlFlow 0 15) 14) anon162_Else_correct)))))
(let ((anon160_Then_correct  (=> (and (and (and ($IsBox |w#4_3@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_3@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|))) (and (=> (= (ControlFlow 0 17) 15) anon161_Then_correct) (=> (= (ControlFlow 0 17) 16) anon161_Else_correct)))))
(let ((anon160_Else_correct  (=> (and (not (and ($IsBox |w#4_3@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_3@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 12) 11)) anon88_correct)))
(let ((anon83_correct  (=> (=> (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)) (=> (and (=> (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |$rhs#4_0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 18) 17) anon160_Then_correct) (=> (= (ControlFlow 0 18) 12) anon160_Else_correct))))))
(let ((anon159_Else_correct  (=> (and (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (= (ControlFlow 0 20) 18)) anon83_correct)))
(let ((anon159_Then_correct  (=> (and (and (and (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($Is intType (int_2_U |d#0@1|) Tclass._System.nat))) (and (and ($IsAlloc intType (int_2_U |d#0@1|) Tclass._System.nat $Heap@4) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) (= (ControlFlow 0 19) 18)))) anon83_correct)))
(let ((anon65_correct  (=> (and (and (and (and (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (=> (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (|Set#Equal| (|Set#Union| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (|Set#Union| |N#0@0| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (and (= |$rhs#4_0@1| (|Set#Difference| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (= |$rhs#4_1@1| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))))) (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4)))) (and (and (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#4_0@1|)) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|)) (and (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|) (= |pathToV#4_0@1| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|))) (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 21) 19) anon159_Then_correct) (=> (= (ControlFlow 0 21) 20) anon159_Else_correct)))))
(let ((anon64_correct  (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($Is intType (int_2_U (+ |d#0@1| 1)) Tclass._System.nat) (= |##n#4_1@1| (+ |d#0@1| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#4_1@1|) Tclass._System.nat $Heap@4) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|) (= (ControlFlow 0 23) 21)))) anon65_correct)))
(let ((anon152_Else_correct  (=> (and (not (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_2@1|) (not (|Set#IsMember| |V#0@0| |w#4_2@1|)))) (= (ControlFlow 0 26) 23)) anon64_correct)))
(let ((anon152_Then_correct  (=> (and (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_2@1|) (not (|Set#IsMember| |V#0@0| |w#4_2@1|))) (= (ControlFlow 0 25) 23)) anon64_correct)))
(let ((anon151_Else_correct  (=> (not (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_2@1|)) (and (=> (= (ControlFlow 0 28) 25) anon152_Then_correct) (=> (= (ControlFlow 0 28) 26) anon152_Else_correct)))))
(let ((anon151_Then_correct  (=> (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_2@1|) (and (=> (= (ControlFlow 0 27) 25) anon152_Then_correct) (=> (= (ControlFlow 0 27) 26) anon152_Else_correct)))))
(let ((anon150_Then_correct  (=> (and (and (and ($IsBox |w#4_2@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_2@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|))) (and (=> (= (ControlFlow 0 29) 27) anon151_Then_correct) (=> (= (ControlFlow 0 29) 28) anon151_Else_correct)))))
(let ((anon150_Else_correct  (=> (and (not (and ($IsBox |w#4_2@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_2@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 24) 23)) anon64_correct)))
(let ((anon149_Then_correct  (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (and (=> (= (ControlFlow 0 30) 29) anon150_Then_correct) (=> (= (ControlFlow 0 30) 24) anon150_Else_correct)))))
(let ((anon149_Else_correct  (=> (and (not (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)))) (= (ControlFlow 0 22) 21)) anon65_correct)))
(let ((anon148_Else_correct  (=> (= |v#4_0@1| |dest#0@@3|) (and (=> (= (ControlFlow 0 32) 30) anon149_Then_correct) (=> (= (ControlFlow 0 32) 22) anon149_Else_correct)))))
(let ((anon148_Then_correct  (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (and (=> (= (ControlFlow 0 31) 30) anon149_Then_correct) (=> (= (ControlFlow 0 31) 22) anon149_Else_correct)))))
(let ((anon45_correct  (=> (exists ((|$as#v4_0#4_0| T@U) ) (!  (and ($IsBox |$as#v4_0#4_0| _module.BreadthFirstSearch$Vertex@@37) (|Set#IsMember| |C#0@0| |$as#v4_0#4_0|))
 ...
 :skolemid |682|
)) (=> (and (=> true (and ($IsBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (|Set#IsMember| |C#0@0| |v#4_0@1|)) (and (=> (= (ControlFlow 0 33) 31) anon148_Then_correct) (=> (= (ControlFlow 0 33) 32) anon148_Else_correct))))))
(let ((anon141_Else_correct  (=> (and (not (and ($IsBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 35) 33)) anon45_correct)))
(let ((anon141_Then_correct  (=> (and (and ($IsBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (= (ControlFlow 0 34) 33)) anon45_correct)))
...
)))))) (and (=> |$w$loop#0@0| (|Set#Equal| |$rhs#0@0| (|Map#Domain| |$rhs#4@0|))) (=> |$w$loop#0@0| (forall ((|x#1@@4| T@U) ) (!  (=> ($IsBox |x#1@@4| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |$rhs#1@0| |x#1@@4|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@4| |$rhs#4@0|)) |d#0@0|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |670|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@4| |$rhs#4@0|))
 :pattern ( (|Set#IsMember| |$rhs#1@0| |x#1@@4|))
)))))) (and (and (and (=> |$w$loop#0@0| (forall ((|x#3@@4| T@U) ) (!  (=> ($IsBox |x#3@@4| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |$rhs#2@0| |x#3@@4|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@4| |$rhs#4@0|)) (+ |d#0@0| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@4| |$rhs#4@0|))
 :pattern ( (|Set#IsMember| |$rhs#2@0| |x#3@@4|))
...
))))) (=> |$w$loop#0@0| (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|)))) (and (=> |$w$loop#0@0| (forall ((|x#1@@5| T@U) ) (!  (=> ($IsBox |x#1@@5| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@5|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@5| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@5| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |669|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@5| |paths#0@0|))
 :pattern ( (|Set#IsMember| |C#0@0| |x#1@@5|))
))) (=> |$w$loop#0@0| (forall ((|x#1@@6| T@U) ) (!  (=> ($IsBox |x#1@@6| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@6|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@6| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |670|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@6| |paths#0@0|))
 :pattern ( (|Set#IsMember| |C#0@0| |x#1@@6|))
))))) (and (and (=> |$w$loop#0@0| (forall ((|x#1@@7| T@U) ) (!  (=> ($IsBox |x#1@@7| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@7|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@7| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |671|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@7| |paths#0@0|))
 :pattern ( (|Set#IsMember| |C#0@0| |x#1@@7|))
))) (=> |$w$loop#0@0| (forall ((|x#3@@5| T@U) ) (!  (=> ($IsBox |x#3@@5| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@5|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@5| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@5| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |677|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@5| |paths#0@0|))
 :pattern ( (|Set#IsMember| |N#0@0| |x#3@@5|))
)))) (and (=> |$w$loop#0@0| (forall ((|x#3@@6| T@U) ) (!  (=> ($IsBox |x#3@@6| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@6|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@6| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@6| |paths#0@0|))
 :pattern ( (|Set#IsMember| |N#0@0| |x#3@@6|))
))) (=> |$w$loop#0@0| (forall ((|x#3@@7| T@U) ) (!  (=> ($IsBox |x#3@@7| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@7|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@7| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |679|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@7| |paths#0@0|))
 :pattern ( (|Set#IsMember| |N#0@0| |x#3@@7|))
))))))) (and (and (and (and (=> |$w$loop#0@0| (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)) (=> |$w$loop#0@0| (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |C#0@0| |dest#0@@3|)))) (and (=> |$w$loop#0@0| (=> (or (not (= |d#0@1| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|))) (=> |$w$loop#0@0| (=> (or (not (= |d#0@1| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|) |dest#0@@3|)))))) (and (and (=> |$w$loop#0@0| (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)) (=> |$w$loop#0@0| (|Set#Equal| (|Set#Union| |Processed#0@0| |C#0@0|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))) (and (=> |$w$loop#0@0| (and (|_module.BreadthFirstSearch.Successors#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |Processed#0@0| |AllVertices#0@@10|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (=> |$w$loop#0@0| (|Set#Equal| |N#0@0| (|Set#Difference| (_module.BreadthFirstSearch.Successors _module.BreadthFirstSearch$Vertex@@37 this@@27 |Processed#0@0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))))))) (and (and (and (=> |$w$loop#0@0| (=> (|Set#Equal| |C#0@0| |Set#Empty|) (|Set#Equal| |N#0@0| |Set#Empty|))) (forall (($o@@3 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@3) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@3) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@3)))
 :qid |BreadthFirstSearchdfy.64:5|
 :skolemid |680|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@3))
))) (and ($HeapSucc $Heap@@3 $Heap@4) (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@4) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@4) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@4) $f@@0)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@4 $f@@0))))
 :qid |BreadthFirstSearchdfy.64:5|
 :skolemid |681|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@4) $f@@0))
)))) (and (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) |$w$loop#0@0|) (and (not (|Set#Equal| |C#0@0| |Set#Empty|)) (= |$decr$loop#00@1| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|)))))))) (and (=> (= (ControlFlow 0 36) 34) anon141_Then_correct) (=> (= (ControlFlow 0 36) 35) anon141_Else_correct)))))))
(let ((anon123_Else_correct  (=> (and (= |d#0@0| 0) (= (ControlFlow 0 38) 36)) anon12_correct)))
(let ((anon123_Then_correct  (=> (or (not (= |d#0@0| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@@3)) (and ($Is intType (int_2_U (- |d#0@0| 1)) Tclass._System.nat) (= |##n#3@0| (- |d#0@0| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#3@0|) Tclass._System.nat $Heap@@3) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|) (= (ControlFlow 0 37) 36)))) anon12_correct))))
(let ((anon6_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |$rhs#1@0| |dest#0@@3|))) (and (=> (= (ControlFlow 0 39) 37) anon123_Then_correct) (=> (= (ControlFlow 0 39) 38) anon123_Else_correct)))))
(let ((anon120_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|)) (= (ControlFlow 0 41) 39)) anon6_correct)))
(let ((anon120_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (= (ControlFlow 0 40) 39)) anon6_correct)))
