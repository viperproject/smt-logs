...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split89)
...
)))))) (and (and (and (=> |$w$loop#0@0| (forall ((|x#3@@3| T@U) ) (!  (=> ($IsBox |x#3@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@3|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@3| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |679|
...
)) (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|)) (and |$w$loop#0@0| (|Set#Equal| |C#0@0| |Set#Empty|)))) (and (and (and (U_2_bool (Lit boolType (bool_2_U true))) (<= (LitInt 0) |n#5_0@0|)) (and ($IsGoodHeap $Heap@15) ($IsHeapAnchor $Heap@15))) (and (and (= $Heap@4 $Heap@15) reveal__module.BreadthFirstSearch.R) (and (<= |d#0@1| |n#5_0@0|) (= (ControlFlow 0 2) (- 0 1)))))))) ($Is intType (int_2_U |d#0@1|) Tclass._System.nat))))))
