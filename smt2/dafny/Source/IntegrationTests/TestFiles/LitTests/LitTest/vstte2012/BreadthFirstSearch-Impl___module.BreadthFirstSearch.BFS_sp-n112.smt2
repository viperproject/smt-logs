...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split109)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon65_correct  (=> (and (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (=> (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (|Set#Equal| (|Set#Union| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (|Set#Union| |N#0@0| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (=> (and (and (and (= |$rhs#4_0@1| (|Set#Difference| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (= |$rhs#4_1@1| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)))) (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (and (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4)) (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#4_0@1|)))) (=> (and (and (and (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|)) (and (= |pathToV#4_0@1| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|)) (= |v#4_0@1| |dest#0@@3|))) (and (and (forall ((|p#4_1_0_1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |p#4_1_0_1| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) ($IsAlloc DatatypeTypeType |p#4_1_0_1| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_1|)) (<= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |pathToV#4_0@1|) (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#4_1_0_1|)))
 :qid |BreadthFirstSearchdfy.99:16|
 :skolemid |690|
 :pattern ( (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#4_1_0_1|))
 :pattern ( (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_1|))
)) (= $Heap@18 $Heap@4)) (and (= |d#0@4| |d#0@1|) (= |path#0@1| |pathToV#4_0@1|)))) (and (and (and (=> (<= (LitInt 0) |d#0@4|) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (_module.List.Nil_q |path#0@1|) (= |source#0@@17| |dest#0@@3|))))) (=> (<= (LitInt 0) |d#0@4|) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (not (_module.List.Nil_q |path#0@1|)) (let ((|v#4@@0| (_module.List.head |path#0@1|)))
(|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4@@0|) |dest#0@@3|))))))) (and (=> (<= (LitInt 0) |d#0@4|) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (not (_module.List.Nil_q |path#0@1|)) (let ((|tail#2@@1| (_module.List.tail |path#0@1|)))
(let ((|v#4@@1| (_module.List.head |path#0@1|)))
(_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#4@@1| |tail#2@@1|))))))) (=> (<= (LitInt 0) |d#0@4|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) |path#0@1|) |d#0@4|)))) (and (and (=> (<= (LitInt 0) |d#0@4|) (forall ((|p#1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |p#1| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) ($IsAlloc DatatypeTypeType |p#1| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@18)) (=> (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |dest#0@@3| |p#1|) (<= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) |path#0@1|) (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) |p#1|))))
 :qid |BreadthFirstSearchdfy.44:31|
 :skolemid |651|
 :pattern ( (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) |p#1|))
 :pattern ( (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |dest#0@@3| |p#1|))
))) (= (ControlFlow 0 2) (- 0 1))) (< |d#0@4| 0)))) (not (exists ((|p#3| T@U) ) (!  (and (and ($Is DatatypeTypeType |p#3| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) ($IsAlloc DatatypeTypeType |p#3| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@18)) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |dest#0@@3| |p#3|))
 :qid |BreadthFirstSearchdfy.46:31|
 :skolemid |654|
 :pattern ( (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |dest#0@@3| |p#3|))
))))))))
