...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.build__rec_split55)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon29_Then_correct  (=> (or (|Seq#Equal| |s#0@@3| |Seq#Empty|) (< (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)) (=> (and (= (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|) (Lit DatatypeTypeType |#_module.Result.Fail|)) ($Is DatatypeTypeType (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|) Tclass._module.Result)) (=> (and (and (=> (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|)) (< (|Seq#Length| (_module.Result.sOut (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| |s#0@@3|))) (|Seq#Length| |s#0@@3|))) (= (ControlFlow 0 2) (- 0 1))) (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|))) (|Seq#Equal| (_module.Result.sOut (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| |s#0@@3|)) (|Seq#Drop| |s#0@@3| (- (|Seq#Length| |s#0@@3|) (|Seq#Length| (_module.Result.sOut (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| |s#0@@3|)))))))))))
