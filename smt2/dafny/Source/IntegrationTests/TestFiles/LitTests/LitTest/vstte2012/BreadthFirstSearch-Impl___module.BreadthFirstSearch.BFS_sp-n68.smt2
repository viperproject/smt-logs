...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split65)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon92_correct  (=> (and (and (and (=> (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)) (=> (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (= (ControlFlow 0 2) (- 0 1))) (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| (|Set#Union| |N#0@0| |newlyEncountered#4_0@1|)) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))))
(let ((anon164_Else_correct  (=> (and (and (and (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@7)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@7) ($Is intType (int_2_U |d#0@1|) Tclass._System.nat))) (and (and ($IsAlloc intType (int_2_U |d#0@1|) Tclass._System.nat $Heap@7) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@7)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) (= (ControlFlow 0 4) 2)))) anon92_correct)))
(let ((anon164_Then_correct  (=> (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@7) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@7)) (and ($Is intType (int_2_U (+ |d#0@1| 1)) Tclass._System.nat) (= |##n#4_4@0| (+ |d#0@1| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#4_4@0|) Tclass._System.nat $Heap@7) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@7)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|) (= (ControlFlow 0 3) 2)))) anon92_correct))))
(let ((anon88_correct  (=> (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (= |newlyEncountered#4_0@1| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (=> (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (and (= $Heap@4 $Heap@7) reveal__module.BreadthFirstSearch.R)) (and (=> (= (ControlFlow 0 5) 3) anon164_Then_correct) (=> (= (ControlFlow 0 5) 4) anon164_Else_correct))))))
