...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split86)
...
))) (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) |$w$loop#0@0|)))) (and (and (and (and (|Set#Equal| |C#0@0| |Set#Empty|) (U_2_bool (Lit boolType (bool_2_U true)))) (and (forall ((|n#5_1| Int) ) (!  (=> (and (<= (LitInt 0) |n#5_1|) (U_2_bool (Lit boolType (bool_2_U true)))) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |n#5_1| |AllVertices#0@@10|) |dest#0@@3|)))
 :qid |BreadthFirstSearchdfy.136:12|
 :skolemid |702|
