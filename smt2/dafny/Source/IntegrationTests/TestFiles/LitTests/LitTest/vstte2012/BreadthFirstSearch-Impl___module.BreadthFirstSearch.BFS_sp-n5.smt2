...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon12_correct  (=> (and (=> (or (not (= |d#0@0| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| (- |d#0@0| 1) |AllVertices#0@@10|)) (=> (or (not (= |d#0@0| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| (- |d#0@0| 1) |AllVertices#0@@10|) |dest#0|)))) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@@2 $Heap@2)) (and (and reveal__module.BreadthFirstSearch.R ($IsAllocBox ($Box refType this@@15) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@25) $Heap@2)) (and ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@25 $Heap@2) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U |d#0@0|) Tclass._System.nat)))))
