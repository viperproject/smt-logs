...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split94)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon28_correct  (=> (and (and (and (and (and (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (|Set#Disjoint| (|Set#Union| |Processed#0@0| |C#0@0|) |N#0@0|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4))) (and (and (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|)) (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))))) (and (and (and ($IsBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and (|Set#IsMember| |C#0@0| |x#0@0|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4))) (and (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4) (= (ControlFlow 0 2) (- 0 1)))))) (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#0@0|))))
(let ((anon132_Else_correct  (=> (and (not (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|))) (= (ControlFlow 0 4) 2)) anon28_correct)))
(let ((anon132_Then_correct  (=> (and (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (= (ControlFlow 0 3) 2)) anon28_correct)))
(let ((anon131_Else_correct  (=> (not (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (and (=> (= (ControlFlow 0 6) 3) anon132_Then_correct) (=> (= (ControlFlow 0 6) 4) anon132_Else_correct)))))
(let ((anon131_Then_correct  (=> (|Set#Disjoint| |Processed#0@0| |C#0@0|) (and (=> (= (ControlFlow 0 5) 3) anon132_Then_correct) (=> (= (ControlFlow 0 5) 4) anon132_Else_correct)))))
(let ((anon24_correct  (=> (and (and (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|)) (|Set#Subset| |N#0@0| |AllVertices#0@@10|)) (and (|Set#IsMember| |V#0@0| |source#0@@17|) (|Set#Equal| |V#0@0| (|Set#Union| (|Set#Union| |Processed#0@0| |C#0@0|) |N#0@0|)))) (and (=> (= (ControlFlow 0 7) 5) anon131_Then_correct) (=> (= (ControlFlow 0 7) 6) anon131_Else_correct)))))
(let ((anon130_Else_correct  (=> (and (not (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|))) (= (ControlFlow 0 9) 7)) anon24_correct)))
(let ((anon130_Then_correct  (=> (and (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|)) (= (ControlFlow 0 8) 7)) anon24_correct)))
(let ((anon129_Else_correct  (=> (not (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|))) (and (=> (= (ControlFlow 0 11) 8) anon130_Then_correct) (=> (= (ControlFlow 0 11) 9) anon130_Else_correct)))))
(let ((anon129_Then_correct  (=> (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (and (=> (= (ControlFlow 0 10) 8) anon130_Then_correct) (=> (= (ControlFlow 0 10) 9) anon130_Else_correct)))))
(let ((anon128_Else_correct  (=> (not (|Set#Subset| |V#0@0| |AllVertices#0@@10|)) (and (=> (= (ControlFlow 0 13) 10) anon129_Then_correct) (=> (= (ControlFlow 0 13) 11) anon129_Else_correct)))))
(let ((anon128_Then_correct  (=> (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (and (=> (= (ControlFlow 0 12) 10) anon129_Then_correct) (=> (= (ControlFlow 0 12) 11) anon129_Else_correct)))))
...
))))) (=> |$w$loop#0@0| (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))))) (and (and (=> |$w$loop#0@0| (forall ((|x#1@@1| T@U) ) (!  (=> ($IsBox |x#1@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@1|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |669|
...
)))) (and (=> |$w$loop#0@0| (forall ((|x#1@@3| T@U) ) (!  (=> ($IsBox |x#1@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@3|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |671|
...
))) (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) (not |$w$loop#0@0|)))))))) (and (=> (= (ControlFlow 0 14) 12) anon128_Then_correct) (=> (= (ControlFlow 0 14) 13) anon128_Else_correct))))))
(let ((anon123_Else_correct  (=> (and (= |d#0@0| 0) (= (ControlFlow 0 16) 14)) anon12_correct)))
(let ((anon123_Then_correct  (=> (or (not (= |d#0@0| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@@3)) (and ($Is intType (int_2_U (- |d#0@0| 1)) Tclass._System.nat) (= |##n#3@0| (- |d#0@0| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#3@0|) Tclass._System.nat $Heap@@3) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|) (= (ControlFlow 0 15) 14)))) anon12_correct))))
(let ((anon6_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |$rhs#1@0| |dest#0@@3|))) (and (=> (= (ControlFlow 0 17) 15) anon123_Then_correct) (=> (= (ControlFlow 0 17) 16) anon123_Else_correct)))))
(let ((anon120_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|)) (= (ControlFlow 0 19) 17)) anon6_correct)))
(let ((anon120_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (= (ControlFlow 0 18) 17)) anon6_correct)))
