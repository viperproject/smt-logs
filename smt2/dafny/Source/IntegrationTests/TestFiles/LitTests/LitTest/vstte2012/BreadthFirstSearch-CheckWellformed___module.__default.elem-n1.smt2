...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.elements$T@@1 T@U) ($ly@@1 T@U) (|list#0@@1| T@U) ) (!  (=> (or (|_module.__default.elements#canCall| _module._default.elements$T@@1 (Lit DatatypeTypeType |list#0@@1|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@1| (Tclass._module.List _module._default.elements$T@@1)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |list#0@@1|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |list#0@@1|)))))
(|_module.__default.elements#canCall| _module._default.elements$T@@1 |tail#3|))) (= (_module.__default.elements _module._default.elements$T@@1 ($LS $ly@@1) (Lit DatatypeTypeType |list#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |list#0@@1|)) |Set#Empty| (let ((|tail#2| (Lit DatatypeTypeType (_module.List.tail (Lit DatatypeTypeType |list#0@@1|)))))
(let ((|x#2| (Lit BoxType (_module.List.head (Lit DatatypeTypeType |list#0@@1|)))))
(|Set#Union| (|Set#UnionOne| |Set#Empty| |x#2|) (_module.__default.elements _module._default.elements$T@@1 ($LS $ly@@1) |tail#2|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |597|
 :pattern ( (_module.__default.elements _module._default.elements$T@@1 ($LS $ly@@1) (Lit DatatypeTypeType |list#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.elements$T@@2 T@U) ($ly@@2 T@U) (|list#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.elements#canCall| _module._default.elements$T@@2 |list#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |list#0@@2| (Tclass._module.List _module._default.elements$T@@2)) ($IsAlloc DatatypeTypeType |list#0@@2| (Tclass._module.List _module._default.elements$T@@2) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.__default.elements _module._default.elements$T@@2 $ly@@2 |list#0@@2|) (TSet _module._default.elements$T@@2) $Heap))
 :qid |BreadthFirstSearchdfy.272:16|
 :skolemid |594|
 :pattern ( ($IsAlloc SetType (_module.__default.elements _module._default.elements$T@@2 $ly@@2 |list#0@@2|) (TSet _module._default.elements$T@@2) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.elements$T@@3 T@U) ($ly@@3 T@U) (|list#0@@3| T@U) ) (!  (=> (or (|_module.__default.elements#canCall| _module._default.elements$T@@3 |list#0@@3|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@3| (Tclass._module.List _module._default.elements$T@@3)))) ($Is SetType (_module.__default.elements _module._default.elements$T@@3 $ly@@3 |list#0@@3|) (TSet _module._default.elements$T@@3)))
 :qid |unknown.0:0|
 :skolemid |593|
 :pattern ( (_module.__default.elements _module._default.elements$T@@3 $ly@@3 |list#0@@3|))
))))
...
(declare-fun _module._default.elements$T@@4 () T@U)
...
(let ((anon10_Then_correct  (=> (= |list#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.elements$T@@4) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.elements$T@@4))) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.elements$T@@4))) (and (= |tail#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($IsBox |let#1#0#0| _module._default.elements$T@@4) (= |x#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |tail#Z#0@0| (Tclass._module.List _module._default.elements$T@@4) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |tail#Z#0@0|) (DtRank |list#0@@4|)))))))
(let ((anon9_Else_correct  (=> (or (not (= |list#0@@4| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is DatatypeTypeType |list#0@@4| (Tclass._module.List _module._default.elements$T@@4))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
