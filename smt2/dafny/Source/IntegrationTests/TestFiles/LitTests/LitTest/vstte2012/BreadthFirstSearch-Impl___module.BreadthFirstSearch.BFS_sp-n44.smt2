...
(let ((anon45_correct  (=> (exists ((|$as#v4_0#4_0| T@U) )  (and ($IsBox |$as#v4_0#4_0| _module.BreadthFirstSearch$Vertex@@37) (|Set#IsMember| |C#0@0| |$as#v4_0#4_0|))) (=> (and (=> true (and ($IsBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (|Set#IsMember| |C#0@0| |v#4_0@1|)) (and (=> (= (ControlFlow 0 30) 28) anon148_Then_correct) (=> (= (ControlFlow 0 30) 29) anon148_Else_correct))))))
