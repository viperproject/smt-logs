...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.build__rec_split11)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon29_Else_correct  (=> (not (or (|Seq#Equal| |s#0@@3| |Seq#Empty|) (< (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@3|))) (=> (and (and (or (not (= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)) (not true)) (= |##d#8@0| (+ |d#0@@8| 1))) (and ($IsAlloc intType (int_2_U |##d#8@0|) TInt $Heap) ($IsAlloc SeqType |s#0@@3| (TSeq TInt) $Heap))) (=> (and (and (and (or (<= 0 (|Seq#Length| |s#0@@3|)) (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|))) (or (or (<= 0 (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (< (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|))) (= (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |##d#8@0|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))))) (and (or (< (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)) (and (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)) (< (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |##d#8@0|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))))) (|_module.__default.build__rec#canCall| (+ |d#0@@8| 1) |s#0@@3|))) (and (and (= |let#0#0#0| (_module.__default.build__rec ($LS $LZ) (+ |d#0@@8| 1) |s#0@@3|)) (|_module.__default.build__rec#canCall| (+ |d#0@@8| 1) |s#0@@3|)) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Result) (= |left#Z#0@0| |let#0#0#0|)))) (=> (and (and (and (and (not (_module.Result.Fail_q |left#Z#0@0|)) (= |##d#9@0| (+ |d#0@@8| 1))) (and ($IsAlloc intType (int_2_U |##d#9@0|) TInt $Heap) (_module.Result.Res_q |left#Z#0@0|))) (and (and (= |##s#8@0| (_module.Result.sOut |left#Z#0@0|)) ($IsAlloc SeqType |##s#8@0| (TSeq TInt) $Heap)) (and (or (<= 0 (|Seq#Length| |s#0@@3|)) (= (|Seq#Length| |##s#8@0|) (|Seq#Length| |s#0@@3|))) (or (or (<= 0 (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (< (|Seq#Length| |##s#8@0|) (|Seq#Length| |s#0@@3|))) (= (ite (|Seq#Equal| |##s#8@0| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |##s#8@0| (LitInt 0)))) |##d#9@0|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))))))) (and (and (and (or (< (|Seq#Length| |##s#8@0|) (|Seq#Length| |s#0@@3|)) (and (= (|Seq#Length| |##s#8@0|) (|Seq#Length| |s#0@@3|)) (< (ite (|Seq#Equal| |##s#8@0| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |##s#8@0| (LitInt 0)))) |##d#9@0|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))))) (|_module.__default.build__rec#canCall| (+ |d#0@@8| 1) (_module.Result.sOut |left#Z#0@0|))) (and (= |let#1#0#0| (_module.__default.build__rec ($LS $LZ) (+ |d#0@@8| 1) (_module.Result.sOut |left#Z#0@0|))) (|_module.__default.build__rec#canCall| (+ |d#0@@8| 1) (_module.Result.sOut |left#Z#0@0|)))) (and (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Result) (= |right#Z#0@0| |let#1#0#0|)) (and (not (_module.Result.Fail_q |right#Z#0@0|)) (= (ControlFlow 0 2) (- 0 1)))))) (_module.Result.Res_q |left#Z#0@0|))))))))
