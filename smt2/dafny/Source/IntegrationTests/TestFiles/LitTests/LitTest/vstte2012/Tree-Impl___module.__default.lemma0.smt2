...
(set-info :boogie-vc-id Impl$$_module.__default.lemma0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.Result.Res_q (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) |d#0@@8| |t#0@@4|) |s#0@@3|)))) (=> (_module.Result.Res_q (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) |d#0@@8| |t#0@@4|) |s#0@@3|))) (=> (= (ControlFlow 0 3) (- 0 2)) (|Seq#Equal| (_module.Result.sOut (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) |d#0@@8| |t#0@@4|) |s#0@@3|))) |s#0@@3|))))))
(let ((anon5_Then_correct  (=> (= |t#0@@4| (|#_module.Tree.Node| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#0#0_0@0| Tclass._module.Tree) ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass._module.Tree)) (=> (and (and (and ($Is DatatypeTypeType |r#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |r#0_0@0| Tclass._module.Tree $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Tree) (= |r#0_0@0| |let#0_0#0#0|)) (and ($Is DatatypeTypeType |l#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |l#0_0@0| Tclass._module.Tree $Heap@0)))) (=> (and (and (and (and (= |let#0_1#0#0| |_mcc#0#0_0@0|) ($Is DatatypeTypeType |let#0_1#0#0| Tclass._module.Tree)) (and (= |l#0_0@0| |let#0_1#0#0|) ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |t#0@@4| Tclass._module.Tree $Heap@0) (|_module.__default.toList#canCall| |d#0@@8| |t#0@@4|)) (and (= |##d#0_1@0| (+ |d#0@@8| 1)) ($IsAlloc intType (int_2_U |##d#0_1@0|) TInt $Heap@0)))) (and (and (and ($IsAlloc DatatypeTypeType |l#0_0@0| Tclass._module.Tree $Heap@0) (|_module.__default.toList#canCall| (+ |d#0@@8| 1) |l#0_0@0|)) (and (= |##d#0_2@0| (+ |d#0@@8| 1)) ($IsAlloc intType (int_2_U |##d#0_2@0|) TInt $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |r#0_0@0| Tclass._module.Tree $Heap@0) (|_module.__default.toList#canCall| (+ |d#0@@8| 1) |r#0_0@0|)) (and (|_module.__default.toList#canCall| |d#0@@8| |t#0@@4|) (and (|_module.__default.toList#canCall| (+ |d#0@@8| 1) |l#0_0@0|) (|_module.__default.toList#canCall| (+ |d#0@@8| 1) |r#0_0@0|)))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (|Seq#Equal| (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) |d#0@@8| |t#0@@4|) |s#0@@3|) (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) (+ |d#0@@8| 1) |l#0_0@0|) (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) (+ |d#0@@8| 1) |r#0_0@0|) |s#0@@3|)))) (=> (and (|Seq#Equal| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d#0@@8| |t#0@@4|) |s#0@@3|) (|Seq#Append| (_module.__default.toList ($LS $LZ) (+ |d#0@@8| 1) |l#0_0@0|) (|Seq#Append| (_module.__default.toList ($LS $LZ) (+ |d#0@@8| 1) |r#0_0@0|) |s#0@@3|))) (= (ControlFlow 0 7) 3)) GeneratedUnifiedExit_correct))))))))
(let ((anon4_Then_correct  (=> (= |t#0@@4| |#_module.Tree.Leaf|) (=> (and (and ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap@0) ($IsAlloc DatatypeTypeType |t#0@@4| Tclass._module.Tree $Heap@0)) (and (|_module.__default.toList#canCall| |d#0@@8| |t#0@@4|) (|_module.__default.toList#canCall| |d#0@@8| |t#0@@4|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|Seq#Equal| (_module.__default.toList ($LS ($LS $LZ)) |d#0@@8| |t#0@@4|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |d#0@@8|))))) (=> (and (|Seq#Equal| (_module.__default.toList ($LS $LZ) |d#0@@8| |t#0@@4|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |d#0@@8|)))) (= (ControlFlow 0 5) 3)) GeneratedUnifiedExit_correct))))))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |t#0@@4| |#_module.Tree.Leaf|)) (not true)) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Tree| |t#0@@4|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#t0#0| T@U) (|$ih#d0#0| Int) (|$ih#s0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#t0#0| Tclass._module.Tree) ($Is SeqType |$ih#s0#0| (TSeq TInt))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#t0#0|) (DtRank |t#0@@4|)) (and (= (DtRank |$ih#t0#0|) (DtRank |t#0@@4|)) (or (and (<= 0 |$ih#d0#0|) (< |$ih#d0#0| |d#0@@8|)) (and (= |$ih#d0#0| |d#0@@8|) (< (|Seq#Rank| |$ih#s0#0|) (|Seq#Rank| |s#0@@3|))))))) (and (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |$ih#d0#0| (|Seq#Append| (_module.__default.toList ($LS $LZ) |$ih#d0#0| |$ih#t0#0|) |$ih#s0#0|))) (|Seq#Equal| (_module.Result.sOut (_module.__default.build__rec ($LS $LZ) |$ih#d0#0| (|Seq#Append| (_module.__default.toList ($LS $LZ) |$ih#d0#0| |$ih#t0#0|) |$ih#s0#0|))) |$ih#s0#0|)))
 :qid |Treedfy.87:14|
 :skolemid |552|
 :pattern ( (|Seq#Append| (_module.__default.toList ($LS $LZ) |$ih#d0#0| |$ih#t0#0|) |$ih#s0#0|))
)))) (and (=> (= (ControlFlow 0 10) 5) anon4_Then_correct) (=> (= (ControlFlow 0 10) 9) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |t#0@@4| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |t#0@@4| Tclass._module.Tree $Heap)) (|$IsA#_module.Tree| |t#0@@4|)) (and (and ($Is SeqType |s#0@@3| (TSeq TInt)) ($IsAlloc SeqType |s#0@@3| (TSeq TInt) $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct))))
