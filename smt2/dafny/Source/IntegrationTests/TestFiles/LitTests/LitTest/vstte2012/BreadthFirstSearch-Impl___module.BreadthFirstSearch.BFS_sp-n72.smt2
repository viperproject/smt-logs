...
(declare-fun |p#4_1_0_0@0| () T@U)
(declare-fun $Heap@10 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $Heap@11 () T@U)
(declare-fun |m##4_1_0_0_0@0| () Int)
...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split69)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon65_correct  (=> (and (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (=> (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (|Set#Equal| (|Set#Union| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (|Set#Union| |N#0@0| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (=> (and (and (= |$rhs#4_0@1| (|Set#Difference| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (= |$rhs#4_1@1| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)))) (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (=> (and (and (and (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4)) (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#4_0@1|))) (and (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|)) (and (= |pathToV#4_0@1| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|)) (= |v#4_0@1| |dest#0@@3|)))) (and (and (and ($Is DatatypeTypeType |p#4_1_0_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) ($IsAlloc DatatypeTypeType |p#4_1_0_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |dest#0@@3| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)))) (=> (and (and (and (and (and ($IsAlloc DatatypeTypeType |p#4_1_0_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@4) (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|)) (and (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|))) (and (and ($IsGoodHeap $Heap@10) ($IsHeapAnchor $Heap@10)) (= $Heap@4 $Heap@10))) (and (and (and reveal__module.BreadthFirstSearch.R (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|) (=> (_module.List.Nil_q |p#4_1_0_0@0|) (= |source#0@@17| |dest#0@@3|))))) (and (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|) (=> (not (_module.List.Nil_q |p#4_1_0_0@0|)) (let ((|v#0@@4| (_module.List.head |p#4_1_0_0@0|)))
(|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#0@@4|) |dest#0@@3|))))) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#4_1_0_0@0|) (=> (not (_module.List.Nil_q |p#4_1_0_0@0|)) (let ((|tail#0@@1| (_module.List.tail |p#4_1_0_0@0|)))
(let ((|v#0@@5| (_module.List.head |p#4_1_0_0@0|)))
(_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#0@@5| |tail#0@@1|)))))))) (and (and (|Set#IsMember| |AllVertices#0@@10| |source#0@@17|) (=> (|_module.BreadthFirstSearch.IsClosed#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |AllVertices#0@@10|) (or (_module.BreadthFirstSearch.IsClosed _module.BreadthFirstSearch$Vertex@@37 this@@27 |AllVertices#0@@10|) (forall ((|v#2@@4| T@U) ) (!  (=> ($IsBox |v#2@@4| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |AllVertices#0@@10| |v#2@@4|) (|Set#Subset| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#2@@4|) |AllVertices#0@@10|)))
 :qid |BreadthFirstSearchdfy.21:12|
 :skolemid |759|
 :pattern ( (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#2@@4|))
 :pattern ( (|Set#IsMember| |AllVertices#0@@10| |v#2@@4|))
))))) (and ($IsGoodHeap $Heap@11) ($IsHeapAnchor $Heap@11))))) (and (and (and (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#4_1_0_0@0|) |AllVertices#0@@10|)) (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) |p#4_1_0_0@0|) |AllVertices#0@@10|) |dest#0@@3|) (= $Heap@10 $Heap@11))) (and (and ($IsAlloc DatatypeTypeType |p#4_1_0_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@11) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|)) (and ($IsAlloc DatatypeTypeType |pathToV#4_0@1| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@11) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |pathToV#4_0@1|)))) (and (and (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |pathToV#4_0@1|)) (and (< (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#4_1_0_0@0|) (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |pathToV#4_0@1|)) ($IsAlloc DatatypeTypeType |p#4_1_0_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@11))) (and (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|)) (and (= |m##4_1_0_0_0@0| (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#4_1_0_0@0|)) (= (ControlFlow 0 2) (- 0 1))))))) ($Is intType (int_2_U (- |d#0@1| 1)) Tclass._System.nat)))))))
(let ((anon64_correct  (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($Is intType (int_2_U (+ |d#0@1| 1)) Tclass._System.nat) (= |##n#4_1@1| (+ |d#0@1| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#4_1@1|) Tclass._System.nat $Heap@4) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|) (= (ControlFlow 0 4) 2)))) anon65_correct)))
(let ((anon152_Else_correct  (=> (and (not (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_2@1|) (not (|Set#IsMember| |V#0@0| |w#4_2@1|)))) (= (ControlFlow 0 7) 4)) anon64_correct)))
(let ((anon152_Then_correct  (=> (and (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_2@1|) (not (|Set#IsMember| |V#0@0| |w#4_2@1|))) (= (ControlFlow 0 6) 4)) anon64_correct)))
(let ((anon151_Else_correct  (=> (not (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_2@1|)) (and (=> (= (ControlFlow 0 9) 6) anon152_Then_correct) (=> (= (ControlFlow 0 9) 7) anon152_Else_correct)))))
(let ((anon151_Then_correct  (=> (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_2@1|) (and (=> (= (ControlFlow 0 8) 6) anon152_Then_correct) (=> (= (ControlFlow 0 8) 7) anon152_Else_correct)))))
(let ((anon150_Then_correct  (=> (and (and (and ($IsBox |w#4_2@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_2@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|))) (and (=> (= (ControlFlow 0 10) 8) anon151_Then_correct) (=> (= (ControlFlow 0 10) 9) anon151_Else_correct)))))
(let ((anon150_Else_correct  (=> (and (not (and ($IsBox |w#4_2@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_2@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 5) 4)) anon64_correct)))
(let ((anon149_Then_correct  (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (and (=> (= (ControlFlow 0 11) 10) anon150_Then_correct) (=> (= (ControlFlow 0 11) 5) anon150_Else_correct)))))
(let ((anon149_Else_correct  (=> (and (not (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)))) (= (ControlFlow 0 3) 2)) anon65_correct)))
(let ((anon148_Else_correct  (=> (= |v#4_0@1| |dest#0@@3|) (and (=> (= (ControlFlow 0 13) 11) anon149_Then_correct) (=> (= (ControlFlow 0 13) 3) anon149_Else_correct)))))
(let ((anon148_Then_correct  (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (and (=> (= (ControlFlow 0 12) 11) anon149_Then_correct) (=> (= (ControlFlow 0 12) 3) anon149_Else_correct)))))
(let ((anon45_correct  (=> (exists ((|$as#v4_0#4_0| T@U) ) (!  (and ($IsBox |$as#v4_0#4_0| _module.BreadthFirstSearch$Vertex@@37) (|Set#IsMember| |C#0@0| |$as#v4_0#4_0|))
 ...
 :skolemid |682|
)) (=> (and (=> true (and ($IsBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (|Set#IsMember| |C#0@0| |v#4_0@1|)) (and (=> (= (ControlFlow 0 14) 12) anon148_Then_correct) (=> (= (ControlFlow 0 14) 13) anon148_Else_correct))))))
(let ((anon141_Else_correct  (=> (and (not (and ($IsBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 16) 14)) anon45_correct)))
(let ((anon141_Then_correct  (=> (and (and ($IsBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (= (ControlFlow 0 15) 14)) anon45_correct)))
...
)))) (and (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) |$w$loop#0@0|) (and (not (|Set#Equal| |C#0@0| |Set#Empty|)) (= |$decr$loop#00@1| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|)))))))) (and (=> (= (ControlFlow 0 17) 15) anon141_Then_correct) (=> (= (ControlFlow 0 17) 16) anon141_Else_correct)))))))
(let ((anon123_Else_correct  (=> (and (= |d#0@0| 0) (= (ControlFlow 0 19) 17)) anon12_correct)))
(let ((anon123_Then_correct  (=> (or (not (= |d#0@0| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@@3)) (and ($Is intType (int_2_U (- |d#0@0| 1)) Tclass._System.nat) (= |##n#3@0| (- |d#0@0| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#3@0|) Tclass._System.nat $Heap@@3) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|) (= (ControlFlow 0 18) 17)))) anon12_correct))))
(let ((anon6_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |$rhs#1@0| |dest#0@@3|))) (and (=> (= (ControlFlow 0 20) 18) anon123_Then_correct) (=> (= (ControlFlow 0 20) 19) anon123_Else_correct)))))
(let ((anon120_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|)) (= (ControlFlow 0 22) 20)) anon6_correct)))
(let ((anon120_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (= (ControlFlow 0 21) 20)) anon6_correct)))
