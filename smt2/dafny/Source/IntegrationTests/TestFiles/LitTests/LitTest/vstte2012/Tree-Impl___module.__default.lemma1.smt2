...
(declare-fun _module.__default.build (T@U) T@U)
(declare-fun |_module.__default.build#canCall| (T@U) Bool)
...
(assert (forall ((d@@7 T@U) ) (!  (=> (|$IsA#_module.Tree| d@@7) (or (_module.Tree.Leaf_q d@@7) (_module.Tree.Node_q d@@7)))
 :qid |unknown.0:0|
 :skolemid |607|
 :pattern ( (|$IsA#_module.Tree| d@@7))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.build#canCall| |s#0@@0|) (and (< 3 $FunctionContextHeight) ($Is SeqType |s#0@@0| (TSeq TInt)))) (and (|_module.__default.build__rec#canCall| (LitInt 0) |s#0@@0|) (= (_module.__default.build |s#0@@0|) (let ((|r#0| (_module.__default.build__rec ($LS $LZ) (LitInt 0) |s#0@@0|)))
(ite  (and (_module.Result.Res_q |r#0|) (|Seq#Equal| (_module.Result.sOut |r#0|) |Seq#Empty|)) |r#0| |#_module.Result.Fail|)))))
 :qid |Treedfy.70:16|
 :skolemid |549|
 :pattern ( (_module.__default.build |s#0@@0|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.build#canCall| |s#0@@1|) (and (< 3 $FunctionContextHeight) ($Is SeqType |s#0@@1| (TSeq TInt)))) (and (=> (_module.Result.Res_q (_module.__default.build |s#0@@1|)) (|Seq#Equal| (_module.__default.toList ($LS $LZ) (LitInt 0) (_module.Result.t (_module.__default.build |s#0@@1|))) |s#0@@1|)) ($Is DatatypeTypeType (_module.__default.build |s#0@@1|) Tclass._module.Result)))
 :qid |Treedfy.70:16|
 :skolemid |547|
 :pattern ( (_module.__default.build |s#0@@1|))
))))
...
(assert (forall ((d@@8 T@U) ) (!  (=> ($Is DatatypeTypeType d@@8 Tclass._module.Tree) (or (_module.Tree.Leaf_q d@@8) (_module.Tree.Node_q d@@8)))
 :qid |unknown.0:0|
 :skolemid |608|
 :pattern ( (_module.Tree.Node_q d@@8) ($Is DatatypeTypeType d@@8 Tclass._module.Tree))
 :pattern ( (_module.Tree.Leaf_q d@@8) ($Is DatatypeTypeType d@@8 Tclass._module.Tree))
)))
(assert (forall ((d@@9 T@U) ) (!  (=> ($Is DatatypeTypeType d@@9 Tclass._module.Result) (or (_module.Result.Fail_q d@@9) (_module.Result.Res_q d@@9)))
 :qid |unknown.0:0|
 :skolemid |629|
 :pattern ( (_module.Result.Res_q d@@9) ($Is DatatypeTypeType d@@9 Tclass._module.Result))
 :pattern ( (_module.Result.Fail_q d@@9) ($Is DatatypeTypeType d@@9 Tclass._module.Result))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) (|d#0@@2| Int) (|s#0@@2| T@U) ) (!  (=> (or (|_module.__default.build__rec#canCall| |d#0@@2| |s#0@@2|) (and (< 2 $FunctionContextHeight) ($Is SeqType |s#0@@2| (TSeq TInt)))) (and (and (=> (_module.Result.Res_q (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|)) (and (< (|Seq#Length| (_module.Result.sOut (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|))) (|Seq#Length| |s#0@@2|)) (|Seq#Equal| (_module.Result.sOut (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|)) (|Seq#Drop| |s#0@@2| (- (|Seq#Length| |s#0@@2|) (|Seq#Length| (_module.Result.sOut (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|)))))))) (=> (_module.Result.Res_q (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|)) (|Seq#Equal| (_module.__default.toList ($LS $LZ) |d#0@@2| (_module.Result.t (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|))) (|Seq#Take| |s#0@@2| (- (|Seq#Length| |s#0@@2|) (|Seq#Length| (_module.Result.sOut (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|)))))))) ($Is DatatypeTypeType (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|) Tclass._module.Result)))
 :qid |Treedfy.43:32|
 :skolemid |541|
 :pattern ( (_module.__default.build__rec $ly@@2 |d#0@@2| |s#0@@2|))
))))
...
(let ((|l#1| (_module.Tree._h0 |t#0@@1|)))
 (and (|_module.__default.toList#canCall| (+ |d#0@@3| 1) |l#1|) (|_module.__default.toList#canCall| (+ |d#0@@3| 1) |r#1|))))) (= (_module.__default.toList ($LS $ly@@3) |d#0@@3| |t#0@@1|) (ite (_module.Tree.Leaf_q |t#0@@1|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |d#0@@3|))) (let ((|r#0@@0| (_module.Tree._h1 |t#0@@1|)))
(let ((|l#0| (_module.Tree._h0 |t#0@@1|)))
(|Seq#Append| (_module.__default.toList $ly@@3 (+ |d#0@@3| 1) |l#0|) (_module.__default.toList $ly@@3 (+ |d#0@@3| 1) |r#0@@0|))))))))
 :qid |Treedfy.24:16|
 :skolemid |533|
...
(assert (forall ((d@@10 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) ($Is DatatypeTypeType d@@10 Tclass._module.Tree)) ($IsAlloc DatatypeTypeType d@@10 Tclass._module.Tree $h))
 :qid |unknown.0:0|
 :skolemid |606|
 :pattern ( ($IsAlloc DatatypeTypeType d@@10 Tclass._module.Tree $h))
)))
(assert (forall ((d@@11 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) ($Is DatatypeTypeType d@@11 Tclass._module.Result)) ($IsAlloc DatatypeTypeType d@@11 Tclass._module.Result $h@@0))
 :qid |unknown.0:0|
 :skolemid |627|
 :pattern ( ($IsAlloc DatatypeTypeType d@@11 Tclass._module.Result $h@@0))
)))
...
(assert (forall ((d@@12 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Result.Res_q d@@12) ($IsAlloc DatatypeTypeType d@@12 Tclass._module.Result $h@@1))) ($IsAlloc SeqType (_module.Result.sOut d@@12) (TSeq TInt) $h@@1))
 :qid |unknown.0:0|
 :skolemid |620|
 :pattern ( ($IsAlloc SeqType (_module.Result.sOut d@@12) (TSeq TInt) $h@@1))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) (|d#0@@6| Int) (|s#0@@3| T@U) ) (!  (=> (or (|_module.__default.build__rec#canCall| |d#0@@6| |s#0@@3|) (and (< 2 $FunctionContextHeight) ($Is SeqType |s#0@@3| (TSeq TInt)))) (and (=> (not (or (|Seq#Equal| |s#0@@3| |Seq#Empty|) (< (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@6|))) (=> (or (not (= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@6|)) (not true)) (and (|_module.__default.build__rec#canCall| (+ |d#0@@6| 1) |s#0@@3|) (let ((|left#0| (_module.__default.build__rec $ly@@6 (+ |d#0@@6| 1) |s#0@@3|)))
 (=> (not (_module.Result.Fail_q |left#0|)) (|_module.__default.build__rec#canCall| (+ |d#0@@6| 1) (_module.Result.sOut |left#0|))))))) (= (_module.__default.build__rec ($LS $ly@@6) |d#0@@6| |s#0@@3|) (ite  (or (|Seq#Equal| |s#0@@3| |Seq#Empty|) (< (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@6|)) |#_module.Result.Fail| (ite (= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@6|) (|#_module.Result.Res| (Lit DatatypeTypeType |#_module.Tree.Leaf|) (|Seq#Drop| |s#0@@3| (LitInt 1))) (let ((|left#0@@0| (_module.__default.build__rec $ly@@6 (+ |d#0@@6| 1) |s#0@@3|)))
...
(ite (_module.Result.Fail_q |right#0|) |#_module.Result.Fail| (|#_module.Result.Res| (|#_module.Tree.Node| (_module.Result.t |left#0@@0|) (_module.Result.t |right#0|)) (_module.Result.sOut |right#0|)))))))))))
 :qid |Treedfy.43:32|
 :skolemid |543|
 :pattern ( (_module.__default.build__rec ($LS $ly@@6) |d#0@@6| |s#0@@3|))
))))
...
(assert (forall ((d@@13 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Tree.Node_q d@@13) ($IsAlloc DatatypeTypeType d@@13 Tclass._module.Tree $h@@2))) ($IsAlloc DatatypeTypeType (_module.Tree._h0 d@@13) Tclass._module.Tree $h@@2))
 :qid |unknown.0:0|
 :skolemid |599|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Tree._h0 d@@13) Tclass._module.Tree $h@@2))
)))
(assert (forall ((d@@14 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Tree.Node_q d@@14) ($IsAlloc DatatypeTypeType d@@14 Tclass._module.Tree $h@@3))) ($IsAlloc DatatypeTypeType (_module.Tree._h1 d@@14) Tclass._module.Tree $h@@3))
 :qid |unknown.0:0|
 :skolemid |600|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Tree._h1 d@@14) Tclass._module.Tree $h@@3))
)))
(assert (forall ((d@@15 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Result.Res_q d@@15) ($IsAlloc DatatypeTypeType d@@15 Tclass._module.Result $h@@4))) ($IsAlloc DatatypeTypeType (_module.Result.t d@@15) Tclass._module.Tree $h@@4))
 :qid |unknown.0:0|
 :skolemid |619|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Result.t d@@15) Tclass._module.Tree $h@@4))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@7 T@U) (|d#0@@7| Int) (|s#0@@4| T@U) ) (!  (=> (or (|_module.__default.build__rec#canCall| (LitInt |d#0@@7|) (Lit SeqType |s#0@@4|)) (and (< 2 $FunctionContextHeight) ($Is SeqType |s#0@@4| (TSeq TInt)))) (and (=> (not (or (|Seq#Equal| |s#0@@4| |Seq#Empty|) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@4|) (LitInt 0)))) |d#0@@7|))) (=> (or (not (= (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@4|) (LitInt 0)))) (LitInt |d#0@@7|))) (not true)) (and (|_module.__default.build__rec#canCall| (LitInt (+ |d#0@@7| 1)) (Lit SeqType |s#0@@4|)) (let ((|left#1| (Lit DatatypeTypeType (_module.__default.build__rec ($LS $ly@@7) (LitInt (+ |d#0@@7| 1)) (Lit SeqType |s#0@@4|)))))
 (=> (not (_module.Result.Fail_q |left#1|)) (|_module.__default.build__rec#canCall| (LitInt (+ |d#0@@7| 1)) (_module.Result.sOut |left#1|))))))) (= (_module.__default.build__rec ($LS $ly@@7) (LitInt |d#0@@7|) (Lit SeqType |s#0@@4|)) (ite  (or (|Seq#Equal| |s#0@@4| |Seq#Empty|) (< (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@4|) (LitInt 0)))) |d#0@@7|)) |#_module.Result.Fail| (ite (= (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@4|) (LitInt 0)))) (LitInt |d#0@@7|)) (|#_module.Result.Res| (Lit DatatypeTypeType |#_module.Tree.Leaf|) (Lit SeqType (|Seq#Drop| (Lit SeqType |s#0@@4|) (LitInt 1)))) (let ((|left#1@@0| (Lit DatatypeTypeType (_module.__default.build__rec ($LS $ly@@7) (LitInt (+ |d#0@@7| 1)) (Lit SeqType |s#0@@4|)))))
...
(ite (_module.Result.Fail_q |right#1|) |#_module.Result.Fail| (|#_module.Result.Res| (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType (_module.Result.t |left#1@@0|)) (Lit DatatypeTypeType (_module.Result.t |right#1|)))) (Lit SeqType (_module.Result.sOut |right#1|))))))))))))
 ...
 :weight 3
 :skolemid |544|
 :pattern ( (_module.__default.build__rec ($LS $ly@@7) (LitInt |d#0@@7|) (Lit SeqType |s#0@@4|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|s#0@@5| T@U) ) (!  (=> (or (|_module.__default.build#canCall| (Lit SeqType |s#0@@5|)) (and (< 3 $FunctionContextHeight) ($Is SeqType |s#0@@5| (TSeq TInt)))) (and (|_module.__default.build__rec#canCall| (LitInt 0) (Lit SeqType |s#0@@5|)) (= (_module.__default.build (Lit SeqType |s#0@@5|)) (let ((|r#1@@0| (Lit DatatypeTypeType (_module.__default.build__rec ($LS $LZ) (LitInt 0) (Lit SeqType |s#0@@5|)))))
(ite  (and (_module.Result.Res_q |r#1@@0|) (|Seq#Equal| (_module.Result.sOut |r#1@@0|) |Seq#Empty|)) |r#1@@0| |#_module.Result.Fail|)))))
 :qid |Treedfy.70:16|
 :weight 3
 :skolemid |550|
 :pattern ( (_module.__default.build (Lit SeqType |s#0@@5|)))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.lemma1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Tree| |t#0@@4|)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#t0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#t0#0| Tclass._module.Tree) (|Seq#Equal| |s#0@@6| (|Seq#Append| (_module.__default.toList ($LS $LZ) (LitInt 0) |$ih#t0#0|) |Seq#Empty|))) (or (< (DtRank |$ih#t0#0|) (DtRank |t#0@@4|)) (and (= (DtRank |$ih#t0#0|) (DtRank |t#0@@4|)) (< (|Seq#Rank| |s#0@@6|) (|Seq#Rank| |s#0@@6|))))) (_module.Result.Res_q (_module.__default.build |s#0@@6|)))
 :qid |Treedfy.107:14|
 :skolemid |553|
 :pattern ( (_module.__default.toList ($LS $LZ) (LitInt 0) |$ih#t0#0|))
)))) (and (and (= |d##0@0| (LitInt 0)) (= |s##0@0| (Lit SeqType |Seq#Empty|))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (and (and (|_module.__default.toList#canCall| |d##0@0| |t#0@@4|) (|_module.__default.build__rec#canCall| |d##0@0| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d##0@0| |t#0@@4|) |s##0@0|))) (=> (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |d##0@0| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d##0@0| |t#0@@4|) |s##0@0|))) (and (|_module.__default.toList#canCall| |d##0@0| |t#0@@4|) (|_module.__default.build__rec#canCall| |d##0@0| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d##0@0| |t#0@@4|) |s##0@0|))))) (and (and (_module.Result.Res_q (_module.__default.build__rec ($LS ($LS $LZ)) |d##0@0| (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) |d##0@0| |t#0@@4|) |s##0@0|))) (|Seq#Equal| (_module.Result.sOut (_module.__default.build__rec ($LS ($LS $LZ)) |d##0@0| (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) |d##0@0| |t#0@@4|) |s##0@0|))) |s##0@0|)) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1)))))) (_module.Result.Res_q (_module.__default.build |s#0@@6|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |t#0@@4| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |t#0@@4| Tclass._module.Tree $Heap)) (|$IsA#_module.Tree| |t#0@@4|)) (=> (and (and (and ($Is SeqType |s#0@@6| (TSeq TInt)) ($IsAlloc SeqType |s#0@@6| (TSeq TInt) $Heap)) (= 4 $FunctionContextHeight)) (and (|Seq#Equal| |s#0@@6| (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) (LitInt 0) |t#0@@4|) |Seq#Empty|)) (= (ControlFlow 0 3) 2))) anon0_correct)))))
