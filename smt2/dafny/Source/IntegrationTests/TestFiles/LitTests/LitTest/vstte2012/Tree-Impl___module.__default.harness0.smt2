...
(set-info :boogie-vc-id Impl$$_module.__default.harness0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (Lit boolType (bool_2_U (_module.Result.Res_q (Lit DatatypeTypeType (_module.__default.build (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2)))))))))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.Result.Res_q (Lit DatatypeTypeType (_module.__default.build (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|_module.Tree#Equal| (_module.Result.t (Lit DatatypeTypeType (_module.__default.build (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2)))))))) (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Tree.Leaf|) (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType (|#_module.Tree.Node| (Lit DatatypeTypeType |#_module.Tree.Leaf|) (Lit DatatypeTypeType |#_module.Tree.Leaf|))) (Lit DatatypeTypeType |#_module.Tree.Leaf|)))))))))))
