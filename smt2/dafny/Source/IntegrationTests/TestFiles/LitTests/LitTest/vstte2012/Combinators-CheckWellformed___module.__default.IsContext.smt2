...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|C#0| T@U) ) (!  (=> (or (|_module.__default.IsContext#canCall| |C#0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |C#0| Tclass._module.Context))) (and (=> (not (_module.Context.Hole_q |C#0|)) (and (=> (_module.Context.C__term_q |C#0|) (let ((|D#2| (_module.Context._h0 |C#0|)))
(|_module.__default.IsContext#canCall| |D#2|))) (=> (not (_module.Context.C__term_q |C#0|)) (let ((|D#3| (_module.Context._h3 |C#0|)))
(let ((|v#1| (_module.Context._h2 |C#0|)))
 (and (|_module.__default.IsValue#canCall| |v#1|) (=> (_module.__default.IsValue ($LS $LZ) |v#1|) (|_module.__default.IsContext#canCall| |D#3|)))))))) (= (_module.__default.IsContext ($LS $ly@@0) |C#0|) (ite (_module.Context.Hole_q |C#0|) true (ite (_module.Context.C__term_q |C#0|) (let ((|D#0| (_module.Context._h0 |C#0|)))
(_module.__default.IsContext $ly@@0 |D#0|)) (let ((|D#1| (_module.Context._h3 |C#0|)))
(let ((|v#0| (_module.Context._h2 |C#0|)))
 (and (_module.__default.IsValue ($LS $LZ) |v#0|) (_module.__default.IsContext $ly@@0 |D#1|)))))))))
 :qid |Combinatorsdfy.49:16|
 :skolemid |602|
 :pattern ( (_module.__default.IsContext ($LS $ly@@0) |C#0|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|t#0@@0| T@U) ) (!  (=> (or (|_module.__default.IsValue#canCall| |t#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@0| Tclass._module.Term))) (and (=> (not (_module.Term.S_q |t#0@@0|)) (=> (not (_module.Term.K_q |t#0@@0|)) (let ((|b#1| (_module.Term.cdr |t#0@@0|)))
...
(let ((|x#1| (_module.Term.car |a#1|)))
 (and (|$IsA#_module.Term| |x#1|) (=> (|_module.Term#Equal| |x#1| |#_module.Term.S|) (and (|_module.__default.IsValue#canCall| |y#1|) (=> (_module.__default.IsValue $ly@@1 |y#1|) (|_module.__default.IsValue#canCall| |b#1|))))))))))))))) (= (_module.__default.IsValue ($LS $ly@@1) |t#0@@0|) (ite (_module.Term.S_q |t#0@@0|) true (ite (_module.Term.K_q |t#0@@0|) true (let ((|b#0| (_module.Term.cdr |t#0@@0|)))
(let ((|a#0| (_module.Term.car |t#0@@0|)))
(ite (_module.Term.S_q |a#0|) (_module.__default.IsValue $ly@@1 |b#0|) (ite (_module.Term.K_q |a#0|) (_module.__default.IsValue $ly@@1 |b#0|) (let ((|y#0| (_module.Term.cdr |a#0|)))
(let ((|x#0| (_module.Term.car |a#0|)))
 (and (and (|_module.Term#Equal| |x#0| |#_module.Term.S|) (_module.__default.IsValue $ly@@1 |y#0|)) (_module.__default.IsValue $ly@@1 |b#0|)))))))))))))
 :qid |Combinatorsdfy.21:10|
 :skolemid |586|
 :pattern ( (_module.__default.IsValue ($LS $ly@@1) |t#0@@0|))
))))
...
(assert (forall (($ly@@2 T@U) (|t#0@@1| T@U) ) (! (= (_module.__default.IsValue ($LS $ly@@2) |t#0@@1|) (_module.__default.IsValue $ly@@2 |t#0@@1|))
 :qid |Combinatorsdfy.21:10|
 :skolemid |581|
 :pattern ( (_module.__default.IsValue ($LS $ly@@2) |t#0@@1|))
)))
(assert (forall (($ly@@3 T@U) (|C#0@@0| T@U) ) (! (= (_module.__default.IsContext ($LS $ly@@3) |C#0@@0|) (_module.__default.IsContext $ly@@3 |C#0@@0|))
 :qid |Combinatorsdfy.49:16|
 :skolemid |597|
 :pattern ( (_module.__default.IsContext ($LS $ly@@3) |C#0@@0|))
)))
...
(let ((|x#3| (_module.Term.car |a#3|)))
 (and (|$IsA#_module.Term| |x#3|) (=> (|_module.Term#Equal| |x#3| |#_module.Term.S|) (and (|_module.__default.IsValue#canCall| |y#3|) (=> (_module.__default.IsValue ($LS $ly@@4) |y#3|) (|_module.__default.IsValue#canCall| |b#3|))))))))))))))) (= (_module.__default.IsValue ($LS $ly@@4) (Lit DatatypeTypeType |t#0@@2|)) (ite (_module.Term.S_q (Lit DatatypeTypeType |t#0@@2|)) true (ite (_module.Term.K_q (Lit DatatypeTypeType |t#0@@2|)) true (let ((|b#2| (Lit DatatypeTypeType (_module.Term.cdr (Lit DatatypeTypeType |t#0@@2|)))))
(let ((|a#2| (Lit DatatypeTypeType (_module.Term.car (Lit DatatypeTypeType |t#0@@2|)))))
(ite (_module.Term.S_q |a#2|) (_module.__default.IsValue ($LS $ly@@4) |b#2|) (ite (_module.Term.K_q |a#2|) (_module.__default.IsValue ($LS $ly@@4) |b#2|) (let ((|y#2| (Lit DatatypeTypeType (_module.Term.cdr |a#2|))))
(let ((|x#2| (Lit DatatypeTypeType (_module.Term.car |a#2|))))
 (and (and (|_module.Term#Equal| |x#2| |#_module.Term.S|) (_module.__default.IsValue ($LS $ly@@4) |y#2|)) (_module.__default.IsValue ($LS $ly@@4) |b#2|)))))))))))))
 :qid |Combinatorsdfy.21:10|
 :weight 3
 :skolemid |587|
 :pattern ( (_module.__default.IsValue ($LS $ly@@4) (Lit DatatypeTypeType |t#0@@2|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|C#0@@1| T@U) ) (!  (=> (or (|_module.__default.IsContext#canCall| (Lit DatatypeTypeType |C#0@@1|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |C#0@@1| Tclass._module.Context))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Context.Hole_q (Lit DatatypeTypeType |C#0@@1|)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U (_module.Context.C__term_q (Lit DatatypeTypeType |C#0@@1|))))) (let ((|D#6| (Lit DatatypeTypeType (_module.Context._h0 (Lit DatatypeTypeType |C#0@@1|)))))
(|_module.__default.IsContext#canCall| |D#6|))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Context.C__term_q (Lit DatatypeTypeType |C#0@@1|)))))) (let ((|D#7| (Lit DatatypeTypeType (_module.Context._h3 (Lit DatatypeTypeType |C#0@@1|)))))
(let ((|v#3| (Lit DatatypeTypeType (_module.Context._h2 (Lit DatatypeTypeType |C#0@@1|)))))
 (and (|_module.__default.IsValue#canCall| |v#3|) (=> (_module.__default.IsValue ($LS $LZ) |v#3|) (|_module.__default.IsContext#canCall| |D#7|)))))))) (= (_module.__default.IsContext ($LS $ly@@5) (Lit DatatypeTypeType |C#0@@1|)) (ite (_module.Context.Hole_q (Lit DatatypeTypeType |C#0@@1|)) true (ite (_module.Context.C__term_q (Lit DatatypeTypeType |C#0@@1|)) (U_2_bool (let ((|D#4| (Lit DatatypeTypeType (_module.Context._h0 (Lit DatatypeTypeType |C#0@@1|)))))
(Lit boolType (bool_2_U (_module.__default.IsContext ($LS $ly@@5) |D#4|))))) (U_2_bool (let ((|D#5| (Lit DatatypeTypeType (_module.Context._h3 (Lit DatatypeTypeType |C#0@@1|)))))
(let ((|v#2| (Lit DatatypeTypeType (_module.Context._h2 (Lit DatatypeTypeType |C#0@@1|)))))
(Lit boolType (bool_2_U  (and (_module.__default.IsValue ($LS $LZ) |v#2|) (_module.__default.IsContext ($LS $ly@@5) |D#5|))))))))))))
 :qid |Combinatorsdfy.49:16|
 :weight 3
 :skolemid |603|
 :pattern ( (_module.__default.IsContext ($LS $ly@@5) (Lit DatatypeTypeType |C#0@@1|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.IsContext)
...
(let ((anon15_Else_correct  (=> (and (not (_module.__default.IsValue ($LS $LZ) |v#Z#0@0|)) (= (ControlFlow 0 9) 6)) anon8_correct)))
(let ((anon15_Then_correct  (=> (and (_module.__default.IsValue ($LS $LZ) |v#Z#0@0|) ($IsAlloc DatatypeTypeType |D#Z#0@0| Tclass._module.Context $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< (DtRank |D#Z#0@0|) (DtRank |C#0@@2|))) (=> (< (DtRank |D#Z#0@0|) (DtRank |C#0@@2|)) (=> (and (|_module.__default.IsContext#canCall| |D#Z#0@0|) (= (ControlFlow 0 7) 6)) anon8_correct))))))
(let ((anon14_Then_correct  (=> (= |C#0@@2| (|#_module.Context.value_C| |_mcc#2#0| |_mcc#3#0|)) (=> (and ($Is DatatypeTypeType |_mcc#2#0| Tclass._module.Term) ($Is DatatypeTypeType |_mcc#3#0| Tclass._module.Context)) (=> (and (and (and (= |let#0#0#0| |_mcc#3#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Context)) (and (= |D#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#2#0|))) (and (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Term) (= |v#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |v#Z#0@0| Tclass._module.Term $Heap) (|_module.__default.IsValue#canCall| |v#Z#0@0|)))) (and (=> (= (ControlFlow 0 10) 7) anon15_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Else_correct)))))))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |C#0@@2| (|#_module.Context.C_term| |_mcc#0#0| |_mcc#1#0|))) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon14_Then_correct) (=> (= (ControlFlow 0 11) 5) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (= |C#0@@2| (|#_module.Context.C_term| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Context) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.Term)) (=> (and (and (and (= |let#2#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#2#0#0| Tclass._module.Term)) (and (= |t#Z#0@0| |let#2#0#0|) (= |let#3#0#0| |_mcc#0#0|))) (and (and ($Is DatatypeTypeType |let#3#0#0| Tclass._module.Context) (= |D#Z#1@0| |let#3#0#0|)) (and ($IsAlloc DatatypeTypeType |D#Z#1@0| Tclass._module.Context $Heap) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |D#Z#1@0|) (DtRank |C#0@@2|)))))))
(let ((anon12_Else_correct  (=> (or (not (= |C#0@@2| |#_module.Context.Hole|)) (not true)) (and (=> (= (ControlFlow 0 12) 4) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |C#0@@2| Tclass._module.Context)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))
