...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split84)
...
))))))) (and (and (and (and (and (=> |$w$loop#0@0| (forall ((|x#1@@3| T@U) ) (!  (=> ($IsBox |x#1@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@3|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |671|
...
)))))) (and (and (and (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) |$w$loop#0@0|) (and (|Set#Equal| |C#0@0| |Set#Empty|) (U_2_bool (Lit boolType (bool_2_U true))))) (and (and (forall ((|n#5_1| Int) ) (!  (=> (and (<= (LitInt 0) |n#5_1|) (U_2_bool (Lit boolType (bool_2_U true)))) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |n#5_1| |AllVertices#0@@10|) |dest#0@@3|)))
