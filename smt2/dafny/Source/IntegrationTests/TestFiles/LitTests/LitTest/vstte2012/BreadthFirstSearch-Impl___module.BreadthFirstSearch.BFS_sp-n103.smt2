...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split100)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 36) (let ((anon38_correct  (=> (=> (or (not (= |d#0@1| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|)) (=> (and (and (and (and (=> (or (not (= |d#0@1| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|) |dest#0@@3|))) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($Is intType (int_2_U |d#0@1|) Tclass._System.nat))) (and (and ($IsAlloc intType (int_2_U |d#0@1|) Tclass._System.nat $Heap@4) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))) (and (and (and (|Set#Equal| (|Set#Union| |Processed#0@0| |C#0@0|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAlloc SetType |Processed#0@0| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4))) (and (and (|_module.BreadthFirstSearch.Successors#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |Processed#0@0| |AllVertices#0@@10|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) (= (ControlFlow 0 2) (- 0 1)))))) ($Is intType (int_2_U |d#0@1|) Tclass._System.nat)))))
(let ((anon138_Else_correct  (=> (and (= |d#0@1| 0) (= (ControlFlow 0 4) 2)) anon38_correct)))
(let ((anon138_Then_correct  (=> (or (not (= |d#0@1| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($Is intType (int_2_U (- |d#0@1| 1)) Tclass._System.nat) (= |##n#9@0| (- |d#0@1| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#9@0|) Tclass._System.nat $Heap@4) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|) (= (ControlFlow 0 3) 2)))) anon38_correct))))
(let ((anon36_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |C#0@0| |dest#0@@3|))) (and (=> (= (ControlFlow 0 5) 3) anon138_Then_correct) (=> (= (ControlFlow 0 5) 4) anon138_Else_correct)))))
(let ((anon137_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) |dest#0@@3|)) (= (ControlFlow 0 7) 5)) anon36_correct)))
(let ((anon137_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) |dest#0@@3|) (= (ControlFlow 0 6) 5)) anon36_correct)))
(let ((anon34_correct  (=> (and (and (and (forall ((|x#3@@0| T@U) ) (!  (=> ($IsBox |x#3@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@0|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |675|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |paths#0@0|))
 :pattern ( (|Set#IsMember| |N#0@0| |x#3@@0|))
)) (forall ((|x#3@@1| T@U) ) (!  (=> ($IsBox |x#3@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@1|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@1| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |676|
...
))) (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (and (and ($Is intType (int_2_U |d#0@1|) Tclass._System.nat) ($IsAlloc intType (int_2_U |d#0@1|) Tclass._System.nat $Heap@4)) (and ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@4) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))) (and (=> (= (ControlFlow 0 8) 6) anon137_Then_correct) (=> (= (ControlFlow 0 8) 7) anon137_Else_correct)))))
(let ((anon136_Else_correct  (=> (and (not (|Set#IsMember| |N#0@0| |x#2@0|)) (= (ControlFlow 0 11) 8)) anon34_correct)))
(let ((anon136_Then_correct  (=> (and (|Set#IsMember| |N#0@0| |x#2@0|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (=> (and (and (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#2@0| |paths#0@0|))) (and (and (= |##list#4@0| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#2@0| |paths#0@0|)) ($IsAlloc DatatypeTypeType |##list#4@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#2@0| |paths#0@0|)) (= (ControlFlow 0 10) 8)))) anon34_correct))))
(let ((anon135_Then_correct  (=> (and ($IsBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and (=> (= (ControlFlow 0 12) 10) anon136_Then_correct) (=> (= (ControlFlow 0 12) 11) anon136_Else_correct)))))
(let ((anon135_Else_correct  (=> (and (not (and ($IsBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 9) 8)) anon34_correct)))
(let ((anon31_correct  (=> (and (forall ((|x#1@@0| T@U) ) (!  (=> ($IsBox |x#1@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@0|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|)))))
...
))) (and (=> (= (ControlFlow 0 13) 12) anon135_Then_correct) (=> (= (ControlFlow 0 13) 9) anon135_Else_correct)))))
(let ((anon134_Else_correct  (=> (and (not (|Set#IsMember| |C#0@0| |x#0@0|)) (= (ControlFlow 0 16) 13)) anon31_correct)))
(let ((anon134_Then_correct  (=> (and (|Set#IsMember| |C#0@0| |x#0@0|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (=> (and (and (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#0@0| |paths#0@0|))) (and (and (= |##list#3@0| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#0@0| |paths#0@0|)) ($IsAlloc DatatypeTypeType |##list#3@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#0@0| |paths#0@0|)) (= (ControlFlow 0 15) 13)))) anon31_correct))))
(let ((anon133_Then_correct  (=> (and ($IsBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and (=> (= (ControlFlow 0 17) 15) anon134_Then_correct) (=> (= (ControlFlow 0 17) 16) anon134_Else_correct)))))
(let ((anon133_Else_correct  (=> (and (not (and ($IsBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 14) 13)) anon31_correct)))
(let ((anon28_correct  (=> (and (and (and (and (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (|Set#Disjoint| (|Set#Union| |Processed#0@0| |C#0@0|) |N#0@0|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4))) (and (and (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|)) (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))))) (and (=> (= (ControlFlow 0 18) 17) anon133_Then_correct) (=> (= (ControlFlow 0 18) 14) anon133_Else_correct)))))
(let ((anon132_Else_correct  (=> (and (not (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|))) (= (ControlFlow 0 20) 18)) anon28_correct)))
(let ((anon132_Then_correct  (=> (and (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (= (ControlFlow 0 19) 18)) anon28_correct)))
(let ((anon131_Else_correct  (=> (not (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (and (=> (= (ControlFlow 0 22) 19) anon132_Then_correct) (=> (= (ControlFlow 0 22) 20) anon132_Else_correct)))))
(let ((anon131_Then_correct  (=> (|Set#Disjoint| |Processed#0@0| |C#0@0|) (and (=> (= (ControlFlow 0 21) 19) anon132_Then_correct) (=> (= (ControlFlow 0 21) 20) anon132_Else_correct)))))
(let ((anon24_correct  (=> (and (and (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|)) (|Set#Subset| |N#0@0| |AllVertices#0@@10|)) (and (|Set#IsMember| |V#0@0| |source#0@@17|) (|Set#Equal| |V#0@0| (|Set#Union| (|Set#Union| |Processed#0@0| |C#0@0|) |N#0@0|)))) (and (=> (= (ControlFlow 0 23) 21) anon131_Then_correct) (=> (= (ControlFlow 0 23) 22) anon131_Else_correct)))))
(let ((anon130_Else_correct  (=> (and (not (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|))) (= (ControlFlow 0 25) 23)) anon24_correct)))
(let ((anon130_Then_correct  (=> (and (and (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (|Set#Subset| |C#0@0| |AllVertices#0@@10|)) (= (ControlFlow 0 24) 23)) anon24_correct)))
(let ((anon129_Else_correct  (=> (not (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|))) (and (=> (= (ControlFlow 0 27) 24) anon130_Then_correct) (=> (= (ControlFlow 0 27) 25) anon130_Else_correct)))))
(let ((anon129_Then_correct  (=> (and (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (|Set#Subset| |Processed#0@0| |AllVertices#0@@10|)) (and (=> (= (ControlFlow 0 26) 24) anon130_Then_correct) (=> (= (ControlFlow 0 26) 25) anon130_Else_correct)))))
(let ((anon128_Else_correct  (=> (not (|Set#Subset| |V#0@0| |AllVertices#0@@10|)) (and (=> (= (ControlFlow 0 29) 26) anon129_Then_correct) (=> (= (ControlFlow 0 29) 27) anon129_Else_correct)))))
(let ((anon128_Then_correct  (=> (|Set#Subset| |V#0@0| |AllVertices#0@@10|) (and (=> (= (ControlFlow 0 28) 26) anon129_Then_correct) (=> (= (ControlFlow 0 28) 27) anon129_Else_correct)))))
...
))))))) (and (and (and (and (=> |$w$loop#0@0| (forall ((|x#3@@4| T@U) ) (!  (=> ($IsBox |x#3@@4| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@4|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@4| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
...
))) (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) (not |$w$loop#0@0|)))))))) (and (=> (= (ControlFlow 0 30) 28) anon128_Then_correct) (=> (= (ControlFlow 0 30) 29) anon128_Else_correct))))))
