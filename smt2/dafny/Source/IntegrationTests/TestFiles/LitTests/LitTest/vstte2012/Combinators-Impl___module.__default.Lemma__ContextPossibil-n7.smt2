...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__ContextPossibilities)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|C#1| T@U) (|u#1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |C#1| Tclass._module.Context) ($Is DatatypeTypeType |u#1| Tclass._module.Term)) (=> (and (_module.__default.IsContext ($LS ($LS $LZ)) |C#1|) (|_module.Term#Equal| |t#0@@7| (_module.__default.EvalExpr ($LS ($LS $LZ)) |C#1| |u#1|))) (or (or (and (|_module.Context#Equal| |C#1| |#_module.Context.Hole|) (|_module.Term#Equal| |t#0@@7| |u#1|)) (and (_module.Term.Apply_q |t#0@@7|) (exists ((|D#16| T@U) ) (!  (and ($Is DatatypeTypeType |D#16| Tclass._module.Context) (and (|_module.Context#Equal| |C#1| (|#_module.Context.C_term| |D#16| (_module.Term.cdr |t#0@@7|))) (|_module.Term#Equal| (_module.Term.car |t#0@@7|) (_module.__default.EvalExpr ($LS ($LS $LZ)) |D#16| |u#1|))))
 :qid |Combinatorsdfy.261:25|
 :skolemid |709|
 :pattern ( (_module.__default.EvalExpr ($LS ($LS $LZ)) |D#16| |u#1|))
 :pattern ( (|#_module.Context.C_term| |D#16| (_module.Term.cdr |t#0@@7|)))
)))) (and (and (_module.Term.Apply_q |t#0@@7|) (_module.__default.IsValue ($LS ($LS $LZ)) (_module.Term.car |t#0@@7|))) (exists ((|D#17| T@U) ) (!  (and ($Is DatatypeTypeType |D#17| Tclass._module.Context) (and (|_module.Context#Equal| |C#1| (|#_module.Context.value_C| (_module.Term.car |t#0@@7|) |D#17|)) (|_module.Term#Equal| (_module.Term.cdr |t#0@@7|) (_module.__default.EvalExpr ($LS ($LS $LZ)) |D#17| |u#1|))))
 :qid |Combinatorsdfy.263:16|
 :skolemid |710|
 :pattern ( (_module.__default.EvalExpr ($LS ($LS $LZ)) |D#17| |u#1|))
 :pattern ( (|#_module.Context.value_C| (_module.Term.car |t#0@@7|) |D#17|))
))))))
 :qid |Combinatorsdfy.259:18|
 :skolemid |711|
 :pattern ( (_module.__default.EvalExpr ($LS ($LS $LZ)) |C#1| |u#1|))
)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |t#0@@7| Tclass._module.Term) ($IsAlloc DatatypeTypeType |t#0@@7| Tclass._module.Term $Heap)) (|$IsA#_module.Term| |t#0@@7|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
