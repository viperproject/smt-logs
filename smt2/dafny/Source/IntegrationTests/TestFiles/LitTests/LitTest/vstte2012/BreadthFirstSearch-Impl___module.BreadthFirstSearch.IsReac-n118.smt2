...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.IsReachFixpoint_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@22)) ($IsAlloc refType this@@12 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@22) $Heap@@2)))) (=> (and (and (and (and ($IsBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@22) ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@22 $Heap@@2)) (and (<= (LitInt 0) |m#0|) (<= (LitInt 0) |n#0@@5|))) (and (and ($Is SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@22)) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@22) $Heap@@2)) (and (= 3 $FunctionContextHeight) (|Set#Equal| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| |m#0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| (+ |m#0| 1) |AllVertices#0@@10|))))) (and (and (and (<= |m#0| |n#0@@5|) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap@@2 $Heap@0) reveal__module.BreadthFirstSearch.R) (and (< |m#0| |n#0@@5|) (= (ControlFlow 0 2) (- 0 1)))))) ($Is intType (int_2_U (+ |m#0| 1)) Tclass._System.nat)))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
