...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.build)
...
(let ((anon13_Else_correct  (=> (and (=> (_module.Result.Res_q (_module.__default.build |s#0@@6|)) (|Seq#Equal| (_module.__default.toList ($LS $LZ) (LitInt 0) (_module.Result.t (_module.__default.build |s#0@@6|))) |s#0@@6|)) (= (ControlFlow 0 14) 9)) anon5_correct)))
(let ((anon13_Then_correct  (=> ($IsAlloc SeqType |s#0@@6| (TSeq TInt) $Heap) (and (=> (= (ControlFlow 0 10) (- 0 13)) (or (|Seq#Equal| |s#0@@6| |s#0@@6|) (< (|Seq#Rank| |s#0@@6|) (|Seq#Rank| |s#0@@6|)))) (=> (or (|Seq#Equal| |s#0@@6| |s#0@@6|) (< (|Seq#Rank| |s#0@@6|) (|Seq#Rank| |s#0@@6|))) (=> (or (|Seq#Equal| |s#0@@6| |s#0@@6|) (|_module.__default.build#canCall| |s#0@@6|)) (=> (and (and (_module.Result.Res_q (_module.__default.build |s#0@@6|)) (= |##d#0@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##d#0@0|) TInt $Heap) ($IsAlloc SeqType |s#0@@6| (TSeq TInt) $Heap))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (|Seq#Equal| |s#0@@6| |s#0@@6|) (< (|Seq#Rank| |s#0@@6|) (|Seq#Rank| |s#0@@6|)))) (=> (or (|Seq#Equal| |s#0@@6| |s#0@@6|) (< (|Seq#Rank| |s#0@@6|) (|Seq#Rank| |s#0@@6|))) (=> (or (|Seq#Equal| |s#0@@6| |s#0@@6|) (|_module.__default.build#canCall| |s#0@@6|)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (_module.Result.Res_q (_module.__default.build |s#0@@6|))) (=> (_module.Result.Res_q (_module.__default.build |s#0@@6|)) (=> (= |##t#0@0| (_module.Result.t (_module.__default.build |s#0@@6|))) (=> (and (and ($IsAlloc DatatypeTypeType |##t#0@0| Tclass._module.Tree $Heap) (|_module.__default.toList#canCall| (LitInt 0) (_module.Result.t (_module.__default.build |s#0@@6|)))) (and (|Seq#Equal| (_module.__default.toList ($LS $LZ) (LitInt 0) (_module.Result.t (_module.__default.build |s#0@@6|))) |s#0@@6|) (= (ControlFlow 0 10) 9))) anon5_correct))))))))))))))
(let ((anon12_Then_correct  (=> ($Is DatatypeTypeType (_module.__default.build |s#0@@6|) Tclass._module.Result) (and (=> (= (ControlFlow 0 15) 10) anon13_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.Result.Res_q (_module.__default.build |s#0@@6|)) (|Seq#Equal| (_module.__default.toList ($LS ($LS $LZ)) (LitInt 0) (_module.Result.t (_module.__default.build |s#0@@6|))) |s#0@@6|)))))
(let ((anon15_Else_correct  (=> (and (and (not (and (_module.Result.Res_q |r#Z#0@0|) (|Seq#Equal| (_module.Result.sOut |r#Z#0@0|) |Seq#Empty|))) (= (_module.__default.build |s#0@@6|) (Lit DatatypeTypeType |#_module.Result.Fail|))) (and ($Is DatatypeTypeType (_module.__default.build |s#0@@6|) Tclass._module.Result) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct)))
(let ((anon15_Then_correct  (=> (and (and (and (_module.Result.Res_q |r#Z#0@0|) (|Seq#Equal| (_module.Result.sOut |r#Z#0@0|) |Seq#Empty|)) (= (_module.__default.build |s#0@@6|) |r#Z#0@0|)) (and ($Is DatatypeTypeType (_module.__default.build |s#0@@6|) Tclass._module.Result) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))
(let ((anon14_Else_correct  (=> (not (_module.Result.Res_q |r#Z#0@0|)) (and (=> (= (ControlFlow 0 7) 3) anon15_Then_correct) (=> (= (ControlFlow 0 7) 4) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (_module.Result.Res_q |r#Z#0@0|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (_module.Result.Res_q |r#Z#0@0|)) (=> (_module.Result.Res_q |r#Z#0@0|) (and (=> (= (ControlFlow 0 5) 3) anon15_Then_correct) (=> (= (ControlFlow 0 5) 4) anon15_Else_correct)))))))
(let ((anon12_Else_correct  (=> (and (and (and (= |##d#1@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##d#1@0|) TInt $Heap)) (and ($IsAlloc SeqType |s#0@@6| (TSeq TInt) $Heap) (|_module.__default.build__rec#canCall| (LitInt 0) |s#0@@6|))) (and (and (= |let#0#0#0| (_module.__default.build__rec ($LS $LZ) (LitInt 0) |s#0@@6|)) (|_module.__default.build__rec#canCall| (LitInt 0) |s#0@@6|)) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Result) (= |r#Z#0@0| |let#0#0#0|)))) (and (=> (= (ControlFlow 0 8) 5) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon14_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 16) 15) anon12_Then_correct) (=> (= (ControlFlow 0 16) 8) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |s#0@@6| (TSeq TInt))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct)))
