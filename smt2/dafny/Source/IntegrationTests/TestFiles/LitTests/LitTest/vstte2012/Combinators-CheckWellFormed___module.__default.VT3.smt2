...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.VT3)
...
(let ((anon5_Else_correct  (=> (and (or (not (= (Mod |n#0@@4| (LitInt 2)) (LitInt 0))) (not true)) (= (ControlFlow 0 3) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and (= (Mod |n#0@@4| (LitInt 2)) (LitInt 0)) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($IsAlloc intType (int_2_U |n#0@@4|) Tclass._System.nat $Heap@0) (|_module.__default.ks#canCall| |n#0@@4|)) (and (= |##t#0@0| (_module.__default.ks ($LS $LZ) |n#0@@4|)) ($IsAlloc DatatypeTypeType |##t#0@0| Tclass._module.Term $Heap@0)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (_module.__default.ContainsS ($LS ($LS $LZ)) |##t#0@0|))) (=> (and (not (_module.__default.ContainsS ($LS $LZ) |##t#0@0|)) (|_module.__default.TerminatingReduction#canCall| (_module.__default.ks ($LS $LZ) |n#0@@4|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 4) 2) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0@@4|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 7) 4))) anon0_correct)))
