...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split38)
...
))))) (and (|Set#Disjoint| |newlyEncountered#4_0@1| (|Map#Domain| |paths#0@0|)) (= (ControlFlow 0 2) (- 0 1))))) (forall ((|succ#1| T@U) ) (!  (=> ($IsBox |succ#1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |newlyEncountered#4_0@1| |succ#1|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |succ#1| (|#_module.List.Cons| |v#4_0@1| |pathToV#4_0@1|))))
...
(let ((anon45_correct  (=> (exists ((|$as#v4_0#4_0| T@U) ) (!  (and ($IsBox |$as#v4_0#4_0| _module.BreadthFirstSearch$Vertex@@37) (|Set#IsMember| |C#0@0| |$as#v4_0#4_0|))
 ...
 :skolemid |682|
)) (=> (and (=> true (and ($IsBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (|Set#IsMember| |C#0@0| |v#4_0@1|)) (and (=> (= (ControlFlow 0 27) 25) anon148_Then_correct) (=> (= (ControlFlow 0 27) 26) anon148_Else_correct))))))
(let ((anon141_Else_correct  (=> (and (not (and ($IsBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 29) 27)) anon45_correct)))
(let ((anon141_Then_correct  (=> (and (and ($IsBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (= (ControlFlow 0 28) 27)) anon45_correct)))
...
)))) (and (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) |$w$loop#0@0|) (and (not (|Set#Equal| |C#0@0| |Set#Empty|)) (= |$decr$loop#00@1| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|)))))))) (and (=> (= (ControlFlow 0 30) 28) anon141_Then_correct) (=> (= (ControlFlow 0 30) 29) anon141_Else_correct)))))))
(let ((anon123_Else_correct  (=> (and (= |d#0@0| 0) (= (ControlFlow 0 32) 30)) anon12_correct)))
(let ((anon123_Then_correct  (=> (or (not (= |d#0@0| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@@3)) (and ($Is intType (int_2_U (- |d#0@0| 1)) Tclass._System.nat) (= |##n#3@0| (- |d#0@0| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#3@0|) Tclass._System.nat $Heap@@3) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|) (= (ControlFlow 0 31) 30)))) anon12_correct))))
(let ((anon6_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |$rhs#1@0| |dest#0@@3|))) (and (=> (= (ControlFlow 0 33) 31) anon123_Then_correct) (=> (= (ControlFlow 0 33) 32) anon123_Else_correct)))))
(let ((anon120_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|)) (= (ControlFlow 0 35) 33)) anon6_correct)))
(let ((anon120_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (= (ControlFlow 0 34) 33)) anon6_correct)))
