...
(set-info :boogie-vc-id Impl$$_module.__default.VerificationTask3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((|n#1@@0| Int) ) (!  (=> (<= (LitInt 0) |n#1@@0|) (|_module.Term#Equal| (_module.__default.TerminatingReduction ($LS ($LS $LZ)) (_module.__default.ks ($LS ($LS $LZ)) |n#1@@0|)) (ite (= (Mod |n#1@@0| (LitInt 2)) (LitInt 0)) |#_module.Term.K| (|#_module.Term.Apply| (Lit DatatypeTypeType |#_module.Term.K|) (Lit DatatypeTypeType |#_module.Term.K|)))))
 :qid |Combinatorsdfy.446:18|
 :skolemid |798|
 :pattern ( (_module.__default.ks ($LS ($LS $LZ)) |n#1@@0|))
)))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|n#0_1| Int) ) (!  (=> (and (<= (LitInt 0) |n#0_1|) (U_2_bool (Lit boolType (bool_2_U true)))) (|_module.Term#Equal| (_module.__default.TerminatingReduction ($LS $LZ) (_module.__default.ks ($LS $LZ) |n#0_1|)) (ite (= (Mod |n#0_1| (LitInt 2)) (LitInt 0)) |#_module.Term.K| (|#_module.Term.Apply| (Lit DatatypeTypeType |#_module.Term.K|) (Lit DatatypeTypeType |#_module.Term.K|)))))
 :qid |Combinatorsdfy.449:10|
 :skolemid |801|
 :pattern ( (_module.__default.ks ($LS $LZ) |n#0_1|))
)) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
