...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split39)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon167_Then_correct  (=> (and (and (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (= $Heap@8 $Heap@9)) (and (and reveal__module.BreadthFirstSearch.R ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@9)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@9) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U |d#0@2|) Tclass._System.nat))))
