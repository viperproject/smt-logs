...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split63)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon88_correct  (=> (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (= |newlyEncountered#4_0@1| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (=> (and (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (and (= $Heap@4 $Heap@7) reveal__module.BreadthFirstSearch.R)) (and (and (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@7)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@7) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (+ |d#0@1| 1)) Tclass._System.nat)))))
