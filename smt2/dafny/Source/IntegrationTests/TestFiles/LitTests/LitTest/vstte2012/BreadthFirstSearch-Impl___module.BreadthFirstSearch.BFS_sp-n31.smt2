...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split28)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon65_correct  (=> (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (=> (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (=> (and (and (and (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (|Set#Equal| (|Set#Union| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (|Set#Union| |N#0@0| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|))) (= |$rhs#4_0@1| (|Set#Difference| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)))) (and (= |$rhs#4_1@1| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4))) (and (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4) (= (ControlFlow 0 2) (- 0 1))))) (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#4_0@1|)))))
