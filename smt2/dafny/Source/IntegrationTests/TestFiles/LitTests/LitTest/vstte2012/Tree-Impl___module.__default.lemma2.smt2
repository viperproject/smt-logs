...
(set-info :boogie-vc-id Impl$$_module.__default.lemma2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (exists ((|t#1| T@U) ) (!  (and ($Is DatatypeTypeType |t#1| Tclass._module.Tree) (|Seq#Equal| (_module.__default.toList ($LS $LZ) (LitInt 0) |t#1|) |s#0@@6|))
 :qid |Treedfy.118:19|
 :skolemid |562|
 :pattern ( (_module.__default.toList ($LS $LZ) 0 |t#1|))
)) (_module.Result.Res_q (_module.__default.build |s#0@@6|))))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|t#0_1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |t#0_1| Tclass._module.Tree) (|Seq#Equal| (_module.__default.toList ($LS $LZ) (LitInt 0) |t#0_1|) |s#0@@6|)) (_module.Result.Res_q (_module.__default.build |s#0@@6|)))
 :qid |Treedfy.120:10|
 :skolemid |564|
 :pattern ( (_module.__default.toList ($LS $LZ) 0 |t#0_1|))
)) (= (ControlFlow 0 5) 4))) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |t#0_0@0| Tclass._module.Tree) (= |##d#0_0@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##d#0_0@0|) TInt $Heap) ($IsAlloc DatatypeTypeType |t#0_0@0| Tclass._module.Tree $Heap))) (and (and (|_module.__default.toList#canCall| (LitInt 0) |t#0_0@0|) (|_module.__default.toList#canCall| (LitInt 0) |t#0_0@0|)) (and (|Seq#Equal| (_module.__default.toList ($LS $LZ) (LitInt 0) |t#0_0@0|) |s#0@@6|) (= (ControlFlow 0 2) (- 0 1))))) (|Seq#Equal| |s#0@@6| (|Seq#Append| (_module.__default.toList ($LS ($LS $LZ)) (LitInt 0) |t#0_0@0|) |Seq#Empty|)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |s#0@@6| (TSeq TInt)) ($IsAlloc SeqType |s#0@@6| (TSeq TInt) $Heap)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
