...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon12_correct  (=> (and (=> (or (not (= |d#0@0| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| (- |d#0@0| 1) |AllVertices#0@@10|)) (=> (or (not (= |d#0@0| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| (- |d#0@0| 1) |AllVertices#0@@10|) |dest#0|)))) (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (= $Heap@@2 $Heap@2) reveal__module.BreadthFirstSearch.R)) (=> (and (and (and ($IsAllocBox ($Box refType this@@15) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@25) $Heap@2) ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@25 $Heap@2)) (and ($Is intType (int_2_U |d#0@0|) Tclass._System.nat) ($IsAlloc intType (int_2_U |d#0@0|) Tclass._System.nat $Heap@2))) (and (and ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@2) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) (= (ControlFlow 0 2) (- 0 1))))) (|Set#Equal| (|Set#Union| |$rhs#3@0| |$rhs#1@0|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|)))))))
