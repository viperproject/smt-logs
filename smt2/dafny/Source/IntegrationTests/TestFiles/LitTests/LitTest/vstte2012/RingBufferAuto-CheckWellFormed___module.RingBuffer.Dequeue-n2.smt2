...
(set-info :boogie-vc-id CheckWellFormed$$_module.RingBuffer.Dequeue)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Repr)))) (=> (and (and (and (and ($IsAllocBox ($Box refType this@@2) (Tclass._module.RingBuffer? _module.RingBuffer$T@@24) $Heap@@1) (|_module.RingBuffer.Valid#canCall| _module.RingBuffer$T@@24 $Heap@@1 this@@2)) (and (_module.RingBuffer.Valid _module.RingBuffer$T@@24 $Heap@@1 this@@2) (not (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Contents)) |Seq#Empty|)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@23 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@23) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@23)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Repr)) ($Box refType $o@@23))))
 :qid |RingBufferAutodfy.76:10|
 :skolemid |558|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23))
)) ($HeapSucc $Heap@@1 $Heap@0)))) (and (and (and ($IsBox |x#0@0| _module.RingBuffer$T@@24) ($IsAllocBox |x#0@0| _module.RingBuffer$T@@24 $Heap@0)) ($IsAllocBox ($Box refType this@@2) (Tclass._module.RingBuffer? _module.RingBuffer$T@@24) $Heap@0)) (and (|_module.RingBuffer.Valid#canCall| _module.RingBuffer$T@@24 $Heap@0 this@@2) (_module.RingBuffer.Valid _module.RingBuffer$T@@24 $Heap@0 this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1)) (=> ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1) (=> (and (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.RingBuffer.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Repr)) ($Box refType $o@@24)))) (or (not (= $o@@24 null)) (not true)))
 :qid |RingBufferAutodfy.76:10|
 :skolemid |559|
 :pattern (  (or (not (= $o@@24 null)) (not true)))
)) (forall (($o@@25 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.RingBuffer.Repr)) ($Box refType $o@@25)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Repr)) ($Box refType $o@@25)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@25) alloc)))))
 :qid |RingBufferAutodfy.76:10|
 :skolemid |560|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@25) alloc)))
))) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1)) (=> ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Contents)))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Contents))))) (=> (= |x#0@0| (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Contents)) (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1)) (=> ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Contents)))))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Contents))))) (=> (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.RingBuffer.Contents)) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.RingBuffer.Contents)) (LitInt 1))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24)) ($IsAlloc refType this@@2 (Tclass._module.RingBuffer _module.RingBuffer$T@@24) $Heap@@1)))) (and (and ($IsBox |x#0@@1| _module.RingBuffer$T@@24) ($IsAllocBox |x#0@@1| _module.RingBuffer$T@@24 $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 2)))) anon0_correct)))
