...
(assert (forall ((s@@9 T@U) (i@@2 Int) (v@@1 T@U) ) (!  (and (=> (= i@@2 (|Seq#Length| s@@9)) (= (|Seq#Index| (|Seq#Build| s@@9 v@@1) i@@2) v@@1)) (=> (or (not (= i@@2 (|Seq#Length| s@@9))) (not true)) (= (|Seq#Index| (|Seq#Build| s@@9 v@@1) i@@2) (|Seq#Index| s@@9 i@@2))))
 :qid |DafnyPreludebpl.1148:15|
 :skolemid |225|
 :pattern ( (|Seq#Index| (|Seq#Build| s@@9 v@@1) i@@2))
)))
...
(assert (forall ((v@@3 T@U) (t0@@1 T@U) ) (! (= ($Is SeqType v@@3 (TSeq t0@@1)) (forall ((i@@4 Int) ) (!  (=> (and (<= 0 i@@4) (< i@@4 (|Seq#Length| v@@3))) ($IsBox (|Seq#Index| v@@3 i@@4) t0@@1))
 :qid |DafnyPreludebpl.254:11|
 :skolemid |53|
 :pattern ( (|Seq#Index| v@@3 i@@4))
)))
 :qid |DafnyPreludebpl.252:15|
 :skolemid |54|
 :pattern ( ($Is SeqType v@@3 (TSeq t0@@1)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.build__rec_split52)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon29_Else_correct  (=> (not (or (|Seq#Equal| |s#0@@3| |Seq#Empty|) (< (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (=> (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@3|))) (= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)) (=> (and (and (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@3|))) (and (= (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|) (|#_module.Result.Res| (Lit DatatypeTypeType |#_module.Tree.Leaf|) (|Seq#Drop| |s#0@@3| (LitInt 1)))) ($Is DatatypeTypeType (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|) Tclass._module.Result))) (and (and (=> (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|)) (< (|Seq#Length| (_module.Result.sOut (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| |s#0@@3|))) (|Seq#Length| |s#0@@3|))) (= (ControlFlow 0 2) (- 0 1))) (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|)))) (|Seq#Equal| (_module.Result.sOut (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| |s#0@@3|)) (|Seq#Drop| |s#0@@3| (- (|Seq#Length| |s#0@@3|) (|Seq#Length| (_module.Result.sOut (_module.__default.build__rec ($LS ($LS $LZ)) |d#0@@8| |s#0@@3|)))))))))))
