...
(set-info :boogie-vc-id Impl$$_module.__default.completeness)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (forall ((|s#1| T@U) ) (!  (=> ($Is SeqType |s#1| (TSeq TInt)) (=> (exists ((|t#2| T@U) ) (!  (and ($Is DatatypeTypeType |t#2| Tclass._module.Tree) (|Seq#Equal| (_module.__default.toList ($LS ($LS $LZ)) (LitInt 0) |t#2|) |s#1|))
 :qid |Treedfy.132:42|
 :skolemid |579|
 :pattern ( (_module.__default.toList ($LS ($LS $LZ)) 0 |t#2|))
)) (_module.Result.Res_q (_module.__default.build |s#1|))))
 :qid |Treedfy.132:18|
 :skolemid |580|
 :pattern ( (_module.__default.build |s#1|))
)))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|s#0_1| T@U) ) (!  (=> (and ($Is SeqType |s#0_1| (TSeq TInt)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (exists ((|_'t#0_0| T@U) ) (!  (and ($Is DatatypeTypeType |_'t#0_0| Tclass._module.Tree) (|Seq#Equal| (_module.__default.toList ($LS $LZ) (LitInt 0) |_'t#0_0|) |s#0_1|))
 :qid |Treedfy.118:19|
 :skolemid |584|
 :pattern ( (_module.__default.toList ($LS $LZ) 0 |_'t#0_0|))
)) (_module.Result.Res_q (_module.__default.build |s#0_1|))))
 :qid |Treedfy.134:10|
 :skolemid |585|
 :pattern ( (_module.__default.build |s#0_1|))
