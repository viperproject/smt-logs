...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split93)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon28_correct  (=> (and (and (and (|Set#Disjoint| |Processed#0@0| |C#0@0|) (|Set#Disjoint| |Processed#0@0| |C#0@0|)) (|Set#Disjoint| (|Set#Union| |Processed#0@0| |C#0@0|) |N#0@0|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (=> (and (and (and (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4)) (and (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|))) (and (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))) (and ($IsBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)))) (and (and (and (|Set#IsMember| |C#0@0| |x#0@0|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (and (and ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4) (= (ControlFlow 0 2) (- 0 1))) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|)))) (or (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (forall ((|v#7| T@U) ) (!  (=> ($IsBox |v#7| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#7|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#7| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#7|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |664|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#7|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#7|))
)))))))
