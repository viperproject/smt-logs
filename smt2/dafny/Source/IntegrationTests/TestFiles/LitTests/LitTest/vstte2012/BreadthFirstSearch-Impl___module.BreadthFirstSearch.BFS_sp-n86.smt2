...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split83)
...
)))))) (and (=> |$w$loop#0@0| (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))) (=> |$w$loop#0@0| (forall ((|x#1@@1| T@U) ) (!  (=> ($IsBox |x#1@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@1|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |669|
...
))))) (and (and (=> |$w$loop#0@0| (forall ((|x#1@@2| T@U) ) (!  (=> ($IsBox |x#1@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@2|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@2| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |670|
...
)))) (and (=> |$w$loop#0@0| (forall ((|x#3@@1| T@U) ) (!  (=> ($IsBox |x#3@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@1|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@1| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@1| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |677|
...
)))))))) (and (and (and (and (and (=> |$w$loop#0@0| (forall ((|x#3@@3| T@U) ) (!  (=> ($IsBox |x#3@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@3|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@3| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |679|
...
))) (=> |$w$loop#0@0| (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (and (=> |$w$loop#0@0| (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |C#0@0| |dest#0@@3|))) (=> |$w$loop#0@0| (=> (or (not (= |d#0@1| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|))))) (and (and (=> |$w$loop#0@0| (=> (or (not (= |d#0@1| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@1| 1) |AllVertices#0@@10|) |dest#0@@3|)))) (=> |$w$loop#0@0| (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (and (=> |$w$loop#0@0| (|Set#Equal| (|Set#Union| |Processed#0@0| |C#0@0|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|))) (=> |$w$loop#0@0| (and (|_module.BreadthFirstSearch.Successors#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |Processed#0@0| |AllVertices#0@@10|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))))) (and (and (and (=> |$w$loop#0@0| (|Set#Equal| |N#0@0| (|Set#Difference| (_module.BreadthFirstSearch.Successors _module.BreadthFirstSearch$Vertex@@37 this@@27 |Processed#0@0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))) (=> |$w$loop#0@0| (=> (|Set#Equal| |C#0@0| |Set#Empty|) (|Set#Equal| |N#0@0| |Set#Empty|)))) (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@2)))
 :qid |BreadthFirstSearchdfy.64:5|
 :skolemid |680|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@2))
)) ($HeapSucc $Heap@@3 $Heap@4))) (and (and (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@3) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@3) $f@@0)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@3 $f@@0))))
 :qid |BreadthFirstSearchdfy.64:5|
 :skolemid |681|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@3) $f@@0))
)) (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|)) (and |$w$loop#0@0| (|Set#Equal| |C#0@0| |Set#Empty|))))) (and (and (and (and (U_2_bool (Lit boolType (bool_2_U true))) (forall ((|n#5_1| Int) ) (!  (=> (and (<= (LitInt 0) |n#5_1|) (U_2_bool (Lit boolType (bool_2_U true)))) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |n#5_1| |AllVertices#0@@10|) |dest#0@@3|)))
...
)) (= |d#0@3| (LitInt (- 0 1))))) (and (and (= $Heap@18 $Heap@4) (= |d#0@4| |d#0@3|)) (and (= |path#0@1| |path#0@0|) (=> (<= (LitInt 0) |d#0@4|) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (_module.List.Nil_q |path#0@1|) (= |source#0@@17| |dest#0@@3|)))))))) (and (and (and (=> (<= (LitInt 0) |d#0@4|) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (not (_module.List.Nil_q |path#0@1|)) (let ((|v#4@@0| (_module.List.head |path#0@1|)))
(|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4@@0|) |dest#0@@3|)))))) (= (ControlFlow 0 2) (- 0 1))) (<= (LitInt 0) |d#0@4|)) (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|))))) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (not (_module.List.Nil_q |path#0@1|)) (let ((|tail#2@@1| (_module.List.tail |path#0@1|)))
(let ((|v#4@@1| (_module.List.head |path#0@1|)))
(_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#4@@1| |tail#2@@1|))))))))))
