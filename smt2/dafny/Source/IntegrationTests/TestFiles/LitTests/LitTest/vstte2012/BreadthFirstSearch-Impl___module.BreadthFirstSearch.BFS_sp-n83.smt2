...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split80)
...
)))))))) (and (and (and (=> |$w$loop#0@0| (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))) (=> |$w$loop#0@0| (forall ((|x#1@@1| T@U) ) (!  (=> ($IsBox |x#1@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@1|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |669|
...
))))) (and (and (=> |$w$loop#0@0| (forall ((|x#3@@1| T@U) ) (!  (=> ($IsBox |x#3@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@1|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@1| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@1| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |677|
...
)) (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|))) (and (and |$w$loop#0@0| (|Set#Equal| |C#0@0| |Set#Empty|)) (and (U_2_bool (Lit boolType (bool_2_U true))) (forall ((|n#5_1| Int) ) (!  (=> (and (<= (LitInt 0) |n#5_1|) (U_2_bool (Lit boolType (bool_2_U true)))) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |n#5_1| |AllVertices#0@@10|) |dest#0@@3|)))
...
))))))) (and (and (and (and (and ($Is DatatypeTypeType |p#6_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) ($IsAlloc DatatypeTypeType |p#6_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |dest#0@@3| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (and (and (and ($IsAlloc DatatypeTypeType |p#6_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@4) (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|)) (and (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|))) (and (and ($IsGoodHeap $Heap@13) ($IsHeapAnchor $Heap@13)) (= $Heap@4 $Heap@13)))) (and (and (and (and reveal__module.BreadthFirstSearch.R (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|) (=> (_module.List.Nil_q |p#6_0@0|) (= |source#0@@17| |dest#0@@3|))))) (and (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|) (=> (not (_module.List.Nil_q |p#6_0@0|)) (let ((|v#0@@4| (_module.List.head |p#6_0@0|)))
(|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#0@@4|) |dest#0@@3|))))) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |p#6_0@0|) (=> (not (_module.List.Nil_q |p#6_0@0|)) (let ((|tail#0@@1| (_module.List.tail |p#6_0@0|)))
(let ((|v#0@@5| (_module.List.head |p#6_0@0|)))
...
))))) (and ($IsGoodHeap $Heap@14) ($IsHeapAnchor $Heap@14)))) (and (and (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#6_0@0|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#6_0@0|) |AllVertices#0@@10|)) (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) |p#6_0@0|) |AllVertices#0@@10|) |dest#0@@3|)) (and (= $Heap@13 $Heap@14) (= (ControlFlow 0 2) (- 0 1)))))))) (U_2_bool (Lit boolType (bool_2_U false))))))))
