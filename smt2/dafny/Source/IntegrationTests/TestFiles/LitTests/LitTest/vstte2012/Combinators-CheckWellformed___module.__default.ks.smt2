...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.ks#canCall| |n#0|) (and (< 2 $FunctionContextHeight) (<= (LitInt 0) |n#0|))) (and (=> (or (not (= |n#0| (LitInt 0))) (not true)) (|_module.__default.ks#canCall| (- |n#0| 1))) (= (_module.__default.ks ($LS $ly@@0) |n#0|) (ite (= |n#0| (LitInt 0)) |#_module.Term.K| (|#_module.Term.Apply| (_module.__default.ks $ly@@0 (- |n#0| 1)) (Lit DatatypeTypeType |#_module.Term.K|))))))
 :qid |Combinatorsdfy.432:10|
 :skolemid |790|
 :pattern ( (_module.__default.ks ($LS $ly@@0) |n#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.ks#canCall| (LitInt |n#0@@0|)) (and (< 2 $FunctionContextHeight) (<= (LitInt 0) |n#0@@0|))) (and (=> (or (not (= (LitInt |n#0@@0|) (LitInt 0))) (not true)) (|_module.__default.ks#canCall| (LitInt (- |n#0@@0| 1)))) (= (_module.__default.ks ($LS $ly@@1) (LitInt |n#0@@0|)) (ite (= (LitInt |n#0@@0|) (LitInt 0)) |#_module.Term.K| (|#_module.Term.Apply| (Lit DatatypeTypeType (_module.__default.ks ($LS $ly@@1) (LitInt (- |n#0@@0| 1)))) (Lit DatatypeTypeType |#_module.Term.K|))))))
 :qid |Combinatorsdfy.432:10|
 :weight 3
 :skolemid |791|
 :pattern ( (_module.__default.ks ($LS $ly@@1) (LitInt |n#0@@0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|t#0@@0| T@U) ) (!  (=> (or (|_module.__default.ContainsS#canCall| (Lit DatatypeTypeType |t#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |t#0@@0| Tclass._module.Term))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Term.S_q (Lit DatatypeTypeType |t#0@@0|)))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Term.K_q (Lit DatatypeTypeType |t#0@@0|)))))) (let ((|y#3| (Lit DatatypeTypeType (_module.Term.cdr (Lit DatatypeTypeType |t#0@@0|)))))
(let ((|x#3| (Lit DatatypeTypeType (_module.Term.car (Lit DatatypeTypeType |t#0@@0|)))))
 (and (|_module.__default.ContainsS#canCall| |x#3|) (=> (not (_module.__default.ContainsS ($LS $ly@@2) |x#3|)) (|_module.__default.ContainsS#canCall| |y#3|))))))) (= (_module.__default.ContainsS ($LS $ly@@2) (Lit DatatypeTypeType |t#0@@0|)) (ite (_module.Term.S_q (Lit DatatypeTypeType |t#0@@0|)) true (ite (_module.Term.K_q (Lit DatatypeTypeType |t#0@@0|)) false (U_2_bool (let ((|y#2| (Lit DatatypeTypeType (_module.Term.cdr (Lit DatatypeTypeType |t#0@@0|)))))
(let ((|x#2| (Lit DatatypeTypeType (_module.Term.car (Lit DatatypeTypeType |t#0@@0|)))))
(Lit boolType (bool_2_U  (or (_module.__default.ContainsS ($LS $ly@@2) |x#2|) (_module.__default.ContainsS ($LS $ly@@2) |y#2|))))))))))))
 :qid |Combinatorsdfy.333:10|
 :weight 3
 :skolemid |747|
 :pattern ( (_module.__default.ContainsS ($LS $ly@@2) (Lit DatatypeTypeType |t#0@@0|)))
))))
(assert (forall (($ly@@3 T@U) (|t#0@@1| T@U) ) (! (= (_module.__default.ContainsS ($LS $ly@@3) |t#0@@1|) (_module.__default.ContainsS $ly@@3 |t#0@@1|))
 :qid |Combinatorsdfy.333:10|
 :skolemid |742|
 :pattern ( (_module.__default.ContainsS ($LS $ly@@3) |t#0@@1|))
)))
...
(assert (forall (($ly@@4 T@U) (|n#0@@1| Int) ) (! (= (_module.__default.ks ($LS $ly@@4) |n#0@@1|) (_module.__default.ks $ly@@4 |n#0@@1|))
 :qid |Combinatorsdfy.432:10|
 :skolemid |786|
 :pattern ( (_module.__default.ks ($LS $ly@@4) |n#0@@1|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.ks#canCall| |n#0@@2|) (and (< 2 $FunctionContextHeight) (<= (LitInt 0) |n#0@@2|))) (and (not (_module.__default.ContainsS ($LS $LZ) (_module.__default.ks $ly@@5 |n#0@@2|))) ($Is DatatypeTypeType (_module.__default.ks $ly@@5 |n#0@@2|) Tclass._module.Term)))
 :qid |Combinatorsdfy.432:10|
 :skolemid |788|
 :pattern ( (_module.__default.ks $ly@@5 |n#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ks)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (not (_module.__default.ContainsS ($LS ($LS $LZ)) (_module.__default.ks ($LS ($LS $LZ)) |n#0@@3|))))))
(let ((anon8_Else_correct  (=> (or (not (= |n#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 10)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (and (= |##n#1@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#1@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (<= 0 |n#0@@3|) (= |##n#1@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#1@0| |n#0@@3|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< |##n#1@0| |n#0@@3|)) (=> (< |##n#1@0| |n#0@@3|) (=> (|_module.__default.ks#canCall| (- |n#0@@3| 1)) (=> (and (and (= (_module.__default.ks ($LS $LZ) |n#0@@3|) (|#_module.Term.Apply| (_module.__default.ks ($LS $LZ) (- |n#0@@3| 1)) (Lit DatatypeTypeType |#_module.Term.K|))) (|_module.__default.ks#canCall| (- |n#0@@3| 1))) (and ($Is DatatypeTypeType (_module.__default.ks ($LS $LZ) |n#0@@3|) Tclass._module.Term) (= (ControlFlow 0 7) 5))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon8_Then_correct  (=> (and (and (= |n#0@@3| (LitInt 0)) (= (_module.__default.ks ($LS $LZ) |n#0@@3|) (Lit DatatypeTypeType |#_module.Term.K|))) (and ($Is DatatypeTypeType (_module.__default.ks ($LS $LZ) |n#0@@3|) Tclass._module.Term) (= (ControlFlow 0 6) 5))) GeneratedUnifiedExit_correct)))
(let ((anon7_Then_correct  (=> (and ($Is DatatypeTypeType (_module.__default.ks ($LS $LZ) |n#0@@3|) Tclass._module.Term) ($IsAlloc intType (int_2_U |n#0@@3|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 |n#0@@3|) (= |n#0@@3| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |n#0@@3| |n#0@@3|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (= |n#0@@3| |n#0@@3|) (< |n#0@@3| |n#0@@3|))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 11) 2) anon7_Then_correct) (=> (= (ControlFlow 0 11) 6) anon8_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0@@3|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
