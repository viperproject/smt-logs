...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split58)
...
))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) |dest#0@@3|))) (|Set#IsMember| |C#0@1| |dest#0@@3|)))))))
