...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@1 T@U) ($ly@@1 T@U) (|list#0@@1| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@1 |list#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@1| (Tclass._module.List _module._default.length$_T0@@1)))) (and (=> (not (_module.List.Nil_q |list#0@@1|)) (let ((|tail#1| (_module.List.tail |list#0@@1|)))
(|_module.__default.length#canCall| _module._default.length$_T0@@1 |tail#1|))) (= (_module.__default.length _module._default.length$_T0@@1 ($LS $ly@@1) |list#0@@1|) (ite (_module.List.Nil_q |list#0@@1|) 0 (let ((|tail#0| (_module.List.tail |list#0@@1|)))
(+ 1 (_module.__default.length _module._default.length$_T0@@1 $ly@@1 |tail#0|)))))))
 :qid |unknown.0:0|
 :skolemid |588|
 :pattern ( (_module.__default.length _module._default.length$_T0@@1 ($LS $ly@@1) |list#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@2 T@U) ($ly@@2 T@U) (|list#0@@2| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@2 |list#0@@2|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@2| (Tclass._module.List _module._default.length$_T0@@2)))) (<= (LitInt 0) (_module.__default.length _module._default.length$_T0@@2 $ly@@2 |list#0@@2|)))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( (_module.__default.length _module._default.length$_T0@@2 $ly@@2 |list#0@@2|))
))))
...
(declare-fun _module._default.length$_T0@@3 () T@U)
...
(let ((anon10_Then_correct  (=> (= |list#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.length$_T0@@3) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.length$_T0@@3))) (=> (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.length$_T0@@3))) (and (= |tail#Z#0@0| |let#0#0#0|) ($IsAlloc DatatypeTypeType |tail#Z#0@0| (Tclass._module.List _module._default.length$_T0@@3) $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |tail#Z#0@0|) (DtRank |list#0@@3|))) (=> (< (DtRank |tail#Z#0@0|) (DtRank |list#0@@3|)) (=> (and (|_module.__default.length#canCall| _module._default.length$_T0@@3 |tail#Z#0@0|) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (+ 1 (_module.__default.length _module._default.length$_T0@@3 ($LS $LZ) |tail#Z#0@0|))) Tclass._System.nat)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |list#0@@3| (Tclass._module.List _module._default.length$_T0@@3))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
