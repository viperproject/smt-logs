...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split68)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon80_correct  (=> (and (and (=> (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)) (= (ControlFlow 0 2) (- 0 1))) (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|))) (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |$rhs#4_0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|)))))
(let ((anon158_Else_correct  (=> (and (|Set#Equal| |$rhs#4_0@1| |Set#Empty|) (= (ControlFlow 0 4) 2)) anon80_correct)))
(let ((anon158_Then_correct  (=> (and (and (and (not (|Set#Equal| |$rhs#4_0@1| |Set#Empty|)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@6)) (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@6) ($Is intType (int_2_U |d#0@1|) Tclass._System.nat))) (and (and ($IsAlloc intType (int_2_U |d#0@1|) Tclass._System.nat $Heap@6) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@6)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) (= (ControlFlow 0 3) 2)))) anon80_correct)))
(let ((anon65_correct  (=> (and (and (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (=> (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (|Set#Equal| (|Set#Union| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (|Set#Union| |N#0@0| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (and (= |$rhs#4_0@1| (|Set#Difference| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (= |$rhs#4_1@1| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))))) (=> (and (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4))) (and (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#4_0@1|)) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|))) (and (and (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|) (= |pathToV#4_0@1| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |v#4_0@1| |paths#0@0|))) (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (U_2_bool (Lit boolType (bool_2_U true))))) (and (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (and (= $Heap@4 $Heap@6) reveal__module.BreadthFirstSearch.R)))) (and (=> (= (ControlFlow 0 5) 3) anon158_Then_correct) (=> (= (ControlFlow 0 5) 4) anon158_Else_correct))))))
