...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split18)
...
))))))) (and (and (=> |$w$loop#0@0| (|Set#Equal| |$rhs#0@0| (|Map#Domain| |$rhs#4@0|))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|)))) (forall ((|x#1@@0| T@U) ) (!  (=> ($IsBox |x#1@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |$rhs#1@0| |x#1@@0|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |$rhs#4@0|)) |d#0@0|)))
