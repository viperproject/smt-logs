...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.build__rec_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |s#0| (TSeq TInt))) (and (and (= 2 $FunctionContextHeight) (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false))) (and (not (|Seq#Equal| |s#0| |Seq#Empty|)) (= (ControlFlow 0 2) (- 0 1))))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
