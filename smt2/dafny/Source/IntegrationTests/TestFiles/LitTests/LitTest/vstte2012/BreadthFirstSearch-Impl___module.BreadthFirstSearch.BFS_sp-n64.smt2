...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split61)
...
)))) (and (=> |$w$loop#0@0| (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |C#0@1| |dest#0@@3|))) (=> |$w$loop#0@0| (=> (or (not (= |d#0@2| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|) |dest#0@@3|)))))) (and (and (=> |$w$loop#0@0| (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |C#0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))) (|Set#Equal| |N#0@1| (|Set#Difference| (_module.BreadthFirstSearch.Successors _module.BreadthFirstSearch$Vertex@@37 this@@27 |$rhs#4_1@1| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|))))))))
