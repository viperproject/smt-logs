// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestHarness (correctness)"} Impl$$_module.__default.TestHarness(x#0: int, y#0: int, z#0: int) returns ($_reverifyPost: bool)
{
  ...
  var $tmp##2: Box;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(88,9)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(88,27)
    ...
    b#0 := $nw;
    defass#b#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(89,12)
    // TrCallStmt: Before ProcessCallStmt
    ...
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(90,12)
    // TrCallStmt: Before ProcessCallStmt
    ...
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(91,21)
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    h#0 := $rhs##0;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(91,26)
    assume true;
    assert {:id "id16"} h#0 == x#0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(92,12)
    // TrCallStmt: Before ProcessCallStmt
    ...
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(93,17)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    ...
    // TrCallStmt: After ProcessCallStmt
    h#0 := $rhs##1;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(93,22)
    assume true;
    assert {:id "id26"} h#0 == y#0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(94,17)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    ...
    // TrCallStmt: After ProcessCallStmt
    h#0 := $rhs##2;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(94,22)
    assume true;
  ...
  var b$reqreads#33: bool;
    ...
    else
    {
           ...
           && !Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(null)))
        {
            ...
            if (Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
              read($Heap, this, _module.RingBuffer.data)))
            {
                ...
                if (_System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
                   == $Unbox(read($Heap, this, _module.RingBuffer.N)): int)
                {
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RingBuffer.Create (correctness)"} Impl$$_module.RingBuffer.Create(_module.RingBuffer$T: Ty, n#0: int) returns (this: ref, $_reverifyPost: bool)
{
  ...
  var $rhs#0_0: Set;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- divided block before new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(27,3)
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(28,10)
    assume true;
    ...
    this.data := $nw;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(29,16)
    assume true;
    $obj0 := this;
    assume true;
    $obj1 := this;
    assert {:id "id105"} $Is(LitInt(0), Tclass._System.nat());
    assume true;
    $rhs#0 := LitInt(0);
    assert {:id "id107"} $Is(LitInt(0), Tclass._System.nat());
    assume true;
    $rhs#1 := LitInt(0);
    this.start := $rhs#0;
    this.len := $rhs#1;
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(30,17)
    assume true;
    $obj0 := this;
    assume true;
    $obj1 := this;
    ...
    this.Contents := $rhs#2;
    this.N := $rhs#3;
    // ----- new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(27,3)
    ...
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- divided block after new; ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(27,3)
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(4,24)
    assume true;
    assert {:id "id115"} $_ModifiesFrame[this, _module.RingBuffer.Repr];
    assume true;
    $rhs#4 := Set#UnionOne(Set#Empty(): Set, $Box(this));
    $Heap := update($Heap, this, _module.RingBuffer.Repr, $Box($rhs#4));
    assume $IsGoodHeap($Heap);
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(25,15)
    assume true;
    if (!Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
      read($Heap, this, _module.RingBuffer.data)))
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(4,24)
        assume true;
        assert {:id "id118"} $_ModifiesFrame[this, _module.RingBuffer.Repr];
        assume true;
        $rhs#0_0 := Set#Union($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
          Set#UnionOne(Set#Empty(): Set, read($Heap, this, _module.RingBuffer.data)));
        $Heap := update($Heap, this, _module.RingBuffer.Repr, $Box($rhs#0_0));
        assume $IsGoodHeap($Heap);
    }
    else
    {
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RingBuffer.Clear (well-formedness)"} CheckWellFormed$$_module.RingBuffer.Clear(_module.RingBuffer$T: Ty, this: ref)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    assume {:id "id121"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
    ...
    assume $IsAllocBox($Box(this), Tclass._module.RingBuffer?(_module.RingBuffer$T), $Heap);
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume {:id "id122"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assert {:id "id123"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id124"} (forall $o: ref :: 
       ...
       && (forall $o: ref :: 
        ...
        Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
             && !Set#IsMember($Unbox(read(old($Heap), this, _module.RingBuffer.Repr)): Set, $Box($o))
           ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
    assume {:id "id125"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
    assert {:id "id126"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id127"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
...
procedure {:verboseName "RingBuffer.Clear (call)"} Call$$_module.RingBuffer.Clear(_module.RingBuffer$T: Ty, 
  ...
  requires {:id "id132"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           == $Unbox(read($Heap, this, _module.RingBuffer.start)): int);
  requires {:id "id133"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int == LitInt(0));
  requires {:id "id134"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  requires {:id "id135"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id136"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id137"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
  ...
  // user-defined postconditions
  free ensures _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
  free ensures {:id "id138"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
  ...
  ensures {:id "id139"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id140"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
  ensures {:id "id141"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
     == $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "RingBuffer.Clear (correctness)"} Impl$$_module.RingBuffer.Clear(_module.RingBuffer$T: Ty, 
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  free requires {:id "id142"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
  ...
  ensures {:id "id147"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           == $Unbox(read($Heap, this, _module.RingBuffer.start)): int);
  ensures {:id "id148"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int == LitInt(0));
  ensures {:id "id149"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  ensures {:id "id150"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  ensures {:id "id151"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  ensures {:id "id152"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
  ...
  ensures {:id "id153"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id154"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
  ensures {:id "id155"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
     == $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
  ...
  var $rhs#0_0: Set;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o)));
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(36,9)
    assume true;
    assert {:id "id156"} $_ModifiesFrame[this, _module.RingBuffer.len];
    assert {:id "id157"} $Is(LitInt(0), Tclass._System.nat());
    assume true;
    $rhs#0 := LitInt(0);
    $Heap := update($Heap, this, _module.RingBuffer.len, $Box($rhs#0));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(37,14)
    assume true;
    assert {:id "id160"} $_ModifiesFrame[this, _module.RingBuffer.Contents];
    assume true;
    $rhs#1 := Lit(Seq#Empty(): Seq);
    $Heap := update($Heap, this, _module.RingBuffer.Contents, $Box($rhs#1));
    assume $IsGoodHeap($Heap);
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(33,10)
    assume true;
    if (!Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
      read($Heap, this, _module.RingBuffer.data)))
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(4,24)
        assume true;
        assert {:id "id163"} $_ModifiesFrame[this, _module.RingBuffer.Repr];
        assume true;
        $rhs#0_0 := Set#Union($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
          Set#UnionOne(Set#Empty(): Set, read($Heap, this, _module.RingBuffer.data)));
        $Heap := update($Heap, this, _module.RingBuffer.Repr, $Box($rhs#0_0));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RingBuffer.Head (well-formedness)"} CheckWellFormed$$_module.RingBuffer.Head(_module.RingBuffer$T: Ty, this: ref) returns (x#0: Box)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    assume $IsAllocBox($Box(this), Tclass._module.RingBuffer?(_module.RingBuffer$T), $Heap);
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume {:id "id166"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assume {:id "id167"} !Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
procedure {:verboseName "RingBuffer.Head (call)"} Call$$_module.RingBuffer.Head(_module.RingBuffer$T: Ty, 
  ...
  requires {:id "id171"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || !Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(null));
  requires {:id "id172"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
        read($Heap, this, _module.RingBuffer.data));
  requires {:id "id173"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
         == $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
  requires {:id "id174"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           == $Unbox(read($Heap, this, _module.RingBuffer.start)): int);
  requires {:id "id175"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int == LitInt(0));
  requires {:id "id176"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  requires {:id "id177"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id178"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id179"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           ...
           then Seq#Drop(Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
            ...
            Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
              $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                   + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
                 - $Unbox(read($Heap, this, _module.RingBuffer.N)): int))));
  requires {:id "id180"} !Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id181"} x#0
     == Seq#Index($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, LitInt(0));
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "RingBuffer.Head (correctness)"} Impl$$_module.RingBuffer.Head(_module.RingBuffer$T: Ty, 
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  free requires {:id "id182"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
         ...
         then Seq#Drop(Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
          ...
          Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
            $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                 + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
               - $Unbox(read($Heap, this, _module.RingBuffer.N)): int))));
  requires {:id "id183"} !Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id184"} x#0
     == Seq#Index($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, LitInt(0));
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RingBuffer.Head (correctness)"} Impl$$_module.RingBuffer.Head(_module.RingBuffer$T: Ty, this: ref) returns (x#0: Box, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(44,7)
    assume true;
    assert {:id "id185"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    assert {:id "id186"} 0 <= $Unbox(read($Heap, this, _module.RingBuffer.start)): int
       && $Unbox(read($Heap, this, _module.RingBuffer.start)): int
         < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref);
    assume true;
    x#0 := read($Heap, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RingBuffer.Enqueue (well-formedness)"} CheckWellFormed$$_module.RingBuffer.Enqueue(_module.RingBuffer$T: Ty, this: ref, x#0: Box)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    assume $IsAllocBox($Box(this), Tclass._module.RingBuffer?(_module.RingBuffer$T), $Heap);
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume {:id "id188"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assume {:id "id189"} Seq#Length($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq)
       != $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
    ...
    assume $IsAllocBox($Box(this), Tclass._module.RingBuffer?(_module.RingBuffer$T), $Heap);
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume {:id "id190"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assert {:id "id191"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id192"} (forall $o: ref :: 
       ...
       && (forall $o: ref :: 
        ...
        Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
             && !Set#IsMember($Unbox(read(old($Heap), this, _module.RingBuffer.Repr)): Set, $Box($o))
           ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
    assert {:id "id193"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id194"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
      Seq#Append($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, 
        Seq#Build(Seq#Empty(): Seq, x#0)));
    assert {:id "id195"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id196"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
       == $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
}
...
procedure {:verboseName "RingBuffer.Enqueue (call)"} Call$$_module.RingBuffer.Enqueue(_module.RingBuffer$T: Ty, 
  ...
  requires {:id "id198"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || !Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(null));
  requires {:id "id199"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
        read($Heap, this, _module.RingBuffer.data));
  requires {:id "id200"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
         == $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
  requires {:id "id201"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           == $Unbox(read($Heap, this, _module.RingBuffer.start)): int);
  requires {:id "id202"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int == LitInt(0));
  requires {:id "id203"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  requires {:id "id204"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id205"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id206"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           ...
           then Seq#Drop(Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
            ...
            Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
              $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                   + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
                 - $Unbox(read($Heap, this, _module.RingBuffer.N)): int))));
  requires {:id "id207"} Seq#Length($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq)
     != $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
  free ensures {:id "id208"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
  ...
  ensures {:id "id209"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id210"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
    Seq#Append($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, 
      Seq#Build(Seq#Empty(): Seq, x#0)));
  ensures {:id "id211"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
     == $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "RingBuffer.Enqueue (correctness)"} Impl$$_module.RingBuffer.Enqueue(_module.RingBuffer$T: Ty, 
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  free requires {:id "id212"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
         ...
         then Seq#Drop(Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
          ...
          Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
            $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                 + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
               - $Unbox(read($Heap, this, _module.RingBuffer.N)): int))));
  requires {:id "id213"} Seq#Length($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq)
     != $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
  ...
  ensures {:id "id215"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || !Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(null));
  ensures {:id "id216"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
        read($Heap, this, _module.RingBuffer.data));
  ensures {:id "id217"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
         == $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
  ensures {:id "id218"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           == $Unbox(read($Heap, this, _module.RingBuffer.start)): int);
  ensures {:id "id219"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int == LitInt(0));
  ensures {:id "id220"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  ensures {:id "id221"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  ensures {:id "id222"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  ensures {:id "id223"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
  ...
  ensures {:id "id224"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id225"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
    Seq#Append($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, 
      Seq#Build(Seq#Empty(): Seq, x#0)));
  ensures {:id "id226"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
     == $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
  ...
  var $rhs#0_0: Set;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o)));
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(51,19)
    assume true;
    assert {:id "id227"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    if ($Unbox(read($Heap, this, _module.RingBuffer.start)): int
         + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
       < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref))
    {
    ...
    {
        assert {:id "id228"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    }
    ...
    nextEmpty#0 := (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
       ...
       then $Unbox(read($Heap, this, _module.RingBuffer.start)): int
         + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           ...
           + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
         - _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(53,21)
    assert {:id "id230"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    assert {:id "id231"} 0 <= nextEmpty#0
       && nextEmpty#0
         < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref);
    assume true;
    assert {:id "id232"} $_ModifiesFrame[$Unbox(read($Heap, this, _module.RingBuffer.data)): ref, IndexField(nextEmpty#0)];
    assume true;
    $rhs#0 := x#0;
    $Heap := update($Heap, 
      $Unbox(read($Heap, this, _module.RingBuffer.data)): ref, 
      ...
      $rhs#0);
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(54,9)
    assume true;
    assert {:id "id235"} $_ModifiesFrame[this, _module.RingBuffer.len];
    assert {:id "id236"} $Is($Unbox(read($Heap, this, _module.RingBuffer.len)): int + 1, Tclass._System.nat());
    assume true;
    $rhs#1 := $Unbox(read($Heap, this, _module.RingBuffer.len)): int + 1;
    $Heap := update($Heap, this, _module.RingBuffer.len, $Box($rhs#1));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(55,14)
    assume true;
    assert {:id "id239"} $_ModifiesFrame[this, _module.RingBuffer.Contents];
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(47,10)
    assume true;
    if (!Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
      read($Heap, this, _module.RingBuffer.data)))
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(4,24)
        assume true;
        assert {:id "id242"} $_ModifiesFrame[this, _module.RingBuffer.Repr];
        assume true;
        $rhs#0_0 := Set#Union($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
          Set#UnionOne(Set#Empty(): Set, read($Heap, this, _module.RingBuffer.data)));
        $Heap := update($Heap, this, _module.RingBuffer.Repr, $Box($rhs#0_0));
...
procedure {:verboseName "RingBuffer.ResizingEnqueue (well-formedness)"} CheckWellFormed$$_module.RingBuffer.ResizingEnqueue(_module.RingBuffer$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass._module.RingBuffer(_module.RingBuffer$T))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RingBuffer.ResizingEnqueue (well-formedness)"} CheckWellFormed$$_module.RingBuffer.ResizingEnqueue(_module.RingBuffer$T: Ty, this: ref, x#0: Box)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: ResizingEnqueue, CheckWellFormed$$_module.RingBuffer.ResizingEnqueue
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o)));
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(this), Tclass._module.RingBuffer?(_module.RingBuffer$T), $Heap);
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume {:id "id245"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
    ...
    assume $IsAllocBox($Box(this), Tclass._module.RingBuffer?(_module.RingBuffer$T), $Heap);
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume {:id "id246"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assert {:id "id247"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id248"} (forall $o: ref :: 
        { $o != null } 
        Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
             && !Set#IsMember($Unbox(read(old($Heap), this, _module.RingBuffer.Repr)): Set, $Box($o))
           ==> $o != null)
       && (forall $o: ref :: 
        ...
        Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
             && !Set#IsMember($Unbox(read(old($Heap), this, _module.RingBuffer.Repr)): Set, $Box($o))
           ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
    assert {:id "id249"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id250"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
      Seq#Append($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, 
        Seq#Build(Seq#Empty(): Seq, x#0)));
    assert {:id "id251"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id252"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
       >= $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
}



procedure {:verboseName "RingBuffer.ResizingEnqueue (call)"} Call$$_module.RingBuffer.ResizingEnqueue(_module.RingBuffer$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass._module.RingBuffer(_module.RingBuffer$T))
  ...
  requires {:id "id256"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
         == $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
  requires {:id "id257"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           == $Unbox(read($Heap, this, _module.RingBuffer.start)): int);
  requires {:id "id258"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int == LitInt(0));
  requires {:id "id259"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  requires {:id "id260"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id261"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id262"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
  ...
  // user-defined postconditions
  free ensures _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
  free ensures {:id "id263"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
  ...
  ensures {:id "id264"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id265"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
    Seq#Append($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, 
      Seq#Build(Seq#Empty(): Seq, x#0)));
  ensures {:id "id266"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
     >= $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "RingBuffer.ResizingEnqueue (correctness)"} Impl$$_module.RingBuffer.ResizingEnqueue(_module.RingBuffer$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass._module.RingBuffer(_module.RingBuffer$T))
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  free requires {:id "id267"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
  ...
  ensures {:id "id274"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  ensures {:id "id275"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  ensures {:id "id276"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  ensures {:id "id277"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
  ...
  ensures {:id "id278"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id279"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
    Seq#Append($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, 
      Seq#Build(Seq#Empty(): Seq, x#0)));
  ensures {:id "id280"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
     >= $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RingBuffer.ResizingEnqueue (correctness)"} Impl$$_module.RingBuffer.ResizingEnqueue(_module.RingBuffer$T: Ty, this: ref, x#0: Box) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var more#0_0: int;
  var d#0_0: ref
     where $Is(d#0_0, Tclass._System.array(_module.RingBuffer$T))
       && $IsAlloc(d#0_0, Tclass._System.array(_module.RingBuffer$T), $Heap);
  var $nw: ref;
  var i#0_0_0: int;
  var i#0_0_1: int;
  var $prevHeap: Heap;
  ...
  var $rhs#1_0: Set;
    ...
    // AddMethodImpl: ResizingEnqueue, Impl$$_module.RingBuffer.ResizingEnqueue
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o)));
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(61,5)
    assert {:id "id281"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    assume true;
    if (_System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
       == $Unbox(read($Heap, this, _module.RingBuffer.len)): int)
    {
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(62,16)
        assume true;
        assert {:id "id282"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
        assume true;
        more#0_0 := _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
           + 1;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(63,13)
        assume true;
        assert {:id "id284"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
        assert {:id "id285"} 0
           <= _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
             + more#0_0;
        havoc $nw;
        ...
        assume $IsHeapAnchor($Heap);
        d#0_0 := $nw;
        // ----- forall statement (assign) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(64,7)
        if (*)
        {
            ...
            if (LitInt(0) <= i#0_0_0)
            {
                assert {:id "id287"} {:subsumption 0} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
            }
            ...
            assume LitInt(0) <= i#0_0_0
               && i#0_0_0
                 < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref);
            assert {:id "id288"} d#0_0 != null;
            if (i#0_0_0 < $Unbox(read($Heap, this, _module.RingBuffer.start)): int)
            {
            }
            else
            {
            ...
            assert {:id "id289"} {:subsumption 0} 0
                 <= (if i#0_0_0 < $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                   then i#0_0_0
                   else i#0_0_0 + more#0_0)
               && (if i#0_0_0 < $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                   then i#0_0_0
                   else i#0_0_0 + more#0_0)
                 < _System.array.Length(d#0_0);
            assume true;
            assert {:id "id290"} $_ModifiesFrame[d#0_0, IndexField((if i#0_0_0 < $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                 then i#0_0_0
                 else i#0_0_0 + more#0_0))];
            assert {:id "id291"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
            assert {:id "id292"} {:subsumption 0} 0 <= i#0_0_0
               && i#0_0_0
                 < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref);
            assume true;
            havoc i#0_0_1;
            assume true;
            assume LitInt(0) <= i#0_0_1
               && i#0_0_1
                 < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref);
            assume i#0_0_0 != i#0_0_1;
            assert {:id "id293"} d#0_0 != d#0_0
               || IndexField((if i#0_0_0 < $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                     then i#0_0_0
                     else i#0_0_0 + more#0_0))
                 != IndexField((if i#0_0_1 < $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                     then i#0_0_1
                     else i#0_0_1 + more#0_0))
               || read($Heap, 
                  $Unbox(read($Heap, this, _module.RingBuffer.data)): ref, 
                  IndexField(i#0_0_0))
                 == read($Heap, 
            ...
            assume (forall $o: ref, $f: Field :: 
              ...
              read($Heap, $o, $f) == read($prevHeap, $o, $f)
                 || (exists i#0_0_2: int :: 
                  LitInt(0) <= i#0_0_2
                     && i#0_0_2
                       < _System.array.Length($Unbox(read($prevHeap, this, _module.RingBuffer.data)): ref)
                     && $o == d#0_0
                     && $f
                       == IndexField((if i#0_0_2 < $Unbox(read($prevHeap, this, _module.RingBuffer.start)): int
                           then i#0_0_2
                           else i#0_0_2 + more#0_0))));
            assume (forall i#inv#0_0_0: int :: 
              { read($Heap, d#0_0, IndexField(i#inv#0_0_0)) } 
              LitInt(0) <= i#inv#0_0_0
                   && i#inv#0_0_0
                     < _System.array.Length($Unbox(read($prevHeap, this, _module.RingBuffer.data)): ref)
                   && i#inv#0_0_0 < $Unbox(read($prevHeap, this, _module.RingBuffer.start)): int
                 ==> read($Heap, d#0_0, IndexField(i#inv#0_0_0))
                   == read($prevHeap, 
                    $Unbox(read($prevHeap, this, _module.RingBuffer.data)): ref, 
                    IndexField(i#inv#0_0_0)));
            assume (forall i#inv#0_0_0: int :: 
              { read($Heap, d#0_0, IndexField(i#inv#0_0_0)) } 
              LitInt(0) <= i#inv#0_0_0 - more#0_0
                   && i#inv#0_0_0 - more#0_0
                     < _System.array.Length($Unbox(read($prevHeap, this, _module.RingBuffer.data)): ref)
                   && !(i#inv#0_0_0 - more#0_0
                     < $Unbox(read($prevHeap, this, _module.RingBuffer.start)): int)
                 ==> read($Heap, d#0_0, IndexField(i#inv#0_0_0))
                   == read($prevHeap, 
                    $Unbox(read($prevHeap, this, _module.RingBuffer.data)): ref, 
                    IndexField(i#inv#0_0_0 - more#0_0)));
        }

        // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(67,22)
        assume true;
        $obj0 := this;
        assert {:id "id294"} $_ModifiesFrame[$obj0, _module.RingBuffer.N];
        assume true;
        $obj1 := this;
        assert {:id "id295"} $_ModifiesFrame[$obj1, _module.RingBuffer.data];
        assume true;
        $obj2 := this;
        assert {:id "id296"} $_ModifiesFrame[$obj2, _module.RingBuffer.start];
        assert {:id "id297"} $Is($Unbox(read($Heap, this, _module.RingBuffer.N)): int + more#0_0, 
          Tclass._System.nat());
        assume true;
        $rhs#0_0 := $Unbox(read($Heap, this, _module.RingBuffer.N)): int + more#0_0;
        assume true;
        $rhs#0_1 := d#0_0;
        if ($Unbox(read($Heap, this, _module.RingBuffer.len)): int == LitInt(0))
        {
            assert {:id "id300"} $Is((if $Unbox(read($Heap, this, _module.RingBuffer.len)): int == LitInt(0)
                 then 0
                 else $Unbox(read($Heap, this, _module.RingBuffer.start)): int + more#0_0), 
              Tclass._System.nat());
        }
        else
        {
            assert {:id "id301"} $Is((if $Unbox(read($Heap, this, _module.RingBuffer.len)): int == LitInt(0)
                 then 0
                 else $Unbox(read($Heap, this, _module.RingBuffer.start)): int + more#0_0), 
              Tclass._System.nat());
        }
        ...
        assume true;
        $rhs#0_2 := (if $Unbox(read($Heap, this, _module.RingBuffer.len)): int == LitInt(0)
           then 0
           else $Unbox(read($Heap, this, _module.RingBuffer.start)): int + more#0_0);
        $Heap := update($Heap, $obj0, _module.RingBuffer.N, $Box($rhs#0_0));
        assume $IsGoodHeap($Heap);
        $Heap := update($Heap, $obj1, _module.RingBuffer.data, $Box($rhs#0_1));
        assume $IsGoodHeap($Heap);
        $Heap := update($Heap, $obj2, _module.RingBuffer.start, $Box($rhs#0_2));
        assume $IsGoodHeap($Heap);
        pop;
    }
    else
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(69,19)
    assume true;
    assert {:id "id306"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    if ($Unbox(read($Heap, this, _module.RingBuffer.start)): int
         + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
       < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref))
    {
    ...
    {
        assert {:id "id307"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    }
    ...
    nextEmpty#0 := (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
       ...
       then $Unbox(read($Heap, this, _module.RingBuffer.start)): int
         + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           ...
           + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
         - _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(71,21)
    assert {:id "id309"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    assert {:id "id310"} 0 <= nextEmpty#0
       && nextEmpty#0
         < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref);
    assume true;
    assert {:id "id311"} $_ModifiesFrame[$Unbox(read($Heap, this, _module.RingBuffer.data)): ref, IndexField(nextEmpty#0)];
    assume true;
    $rhs#0 := x#0;
    $Heap := update($Heap, 
      $Unbox(read($Heap, this, _module.RingBuffer.data)): ref, 
      ...
      $rhs#0);
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(72,9)
    assume true;
    assert {:id "id314"} $_ModifiesFrame[this, _module.RingBuffer.len];
    assert {:id "id315"} $Is($Unbox(read($Heap, this, _module.RingBuffer.len)): int + 1, Tclass._System.nat());
    assume true;
    $rhs#1 := $Unbox(read($Heap, this, _module.RingBuffer.len)): int + 1;
    $Heap := update($Heap, this, _module.RingBuffer.len, $Box($rhs#1));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(73,14)
    assume true;
    assert {:id "id318"} $_ModifiesFrame[this, _module.RingBuffer.Contents];
    assume true;
    $rhs#2 := Seq#Append($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
      Seq#Build(Seq#Empty(): Seq, x#0));
    $Heap := update($Heap, this, _module.RingBuffer.Contents, $Box($rhs#2));
    assume $IsGoodHeap($Heap);
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(58,10)
    assume true;
    if (!Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
      read($Heap, this, _module.RingBuffer.data)))
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(4,24)
        assume true;
        assert {:id "id321"} $_ModifiesFrame[this, _module.RingBuffer.Repr];
        assume true;
        $rhs#1_0 := Set#Union($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
          Set#UnionOne(Set#Empty(): Set, read($Heap, this, _module.RingBuffer.data)));
        $Heap := update($Heap, this, _module.RingBuffer.Repr, $Box($rhs#1_0));
        assume $IsGoodHeap($Heap);
    }
    else
    {
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RingBuffer.Dequeue (well-formedness)"} CheckWellFormed$$_module.RingBuffer.Dequeue(_module.RingBuffer$T: Ty, this: ref) returns (x#0: Box)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    assume $IsAllocBox($Box(this), Tclass._module.RingBuffer?(_module.RingBuffer$T), $Heap);
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume {:id "id324"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assume {:id "id325"} !Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
    ...
    assume $IsAllocBox($Box(this), Tclass._module.RingBuffer?(_module.RingBuffer$T), $Heap);
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume {:id "id326"} _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assert {:id "id327"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id328"} (forall $o: ref :: 
        { $o != null } 
        Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
             && !Set#IsMember($Unbox(read(old($Heap), this, _module.RingBuffer.Repr)): Set, $Box($o))
           ==> $o != null)
       && (forall $o: ref :: 
        ...
        Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
             && !Set#IsMember($Unbox(read(old($Heap), this, _module.RingBuffer.Repr)): Set, $Box($o))
           ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
    assert {:id "id329"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assert {:id "id330"} 0 <= LitInt(0)
       && LitInt(0)
    ...
    assert {:id "id332"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assert {:id "id333"} 0 <= LitInt(1)
       && LitInt(1)
         <= Seq#Length($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq);
    assume {:id "id334"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
      Seq#Drop($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, LitInt(1)));
    assert {:id "id335"} $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume {:id "id336"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
       == $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
}
...
procedure {:verboseName "RingBuffer.Dequeue (call)"} Call$$_module.RingBuffer.Dequeue(_module.RingBuffer$T: Ty, 
   ...
   returns (x#0: Box
       where $IsBox(x#0, _module.RingBuffer$T)
         && $IsAllocBox(x#0, _module.RingBuffer$T, $Heap));
  // user-defined preconditions
  requires {:id "id337"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this));
  requires {:id "id338"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || !Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(null));
  requires {:id "id339"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
        read($Heap, this, _module.RingBuffer.data));
  requires {:id "id340"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
         == $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
  requires {:id "id341"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           == $Unbox(read($Heap, this, _module.RingBuffer.start)): int);
  requires {:id "id342"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int == LitInt(0));
  requires {:id "id343"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  requires {:id "id344"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id345"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  requires {:id "id346"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           ...
           then Seq#Drop(Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
            ...
            Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
              $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                   + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
                 - $Unbox(read($Heap, this, _module.RingBuffer.N)): int))));
  requires {:id "id347"} !Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
  free ensures {:id "id348"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
  ...
  ensures {:id "id349"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id350"} x#0
     == Seq#Index($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, LitInt(0));
  ensures {:id "id351"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
    Seq#Drop($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, LitInt(1)));
  ensures {:id "id352"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
     == $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "RingBuffer.Dequeue (correctness)"} Impl$$_module.RingBuffer.Dequeue(_module.RingBuffer$T: Ty, 
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  free requires {:id "id353"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     && 
    _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
     && 
    Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this))
         ...
         then Seq#Drop(Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
          ...
          Seq#Take(Seq#FromArray($Heap, $Unbox(read($Heap, this, _module.RingBuffer.data)): ref), 
            $Unbox(read($Heap, this, _module.RingBuffer.start)): int
                 + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
               - $Unbox(read($Heap, this, _module.RingBuffer.N)): int))));
  requires {:id "id354"} !Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq);
  modifies $Heap;
  // user-defined postconditions
  free ensures _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
  ensures {:id "id355"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(this));
  ensures {:id "id356"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || !Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box(null));
  ensures {:id "id357"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
        read($Heap, this, _module.RingBuffer.data));
  ensures {:id "id358"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
         == $Unbox(read($Heap, this, _module.RingBuffer.N)): int;
  ensures {:id "id359"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           == $Unbox(read($Heap, this, _module.RingBuffer.start)): int);
  ensures {:id "id360"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int == LitInt(0));
  ensures {:id "id361"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int == LitInt(0)
         ==> Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, Seq#Empty(): Seq));
  ensures {:id "id362"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.len)): int
           <= $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  ensures {:id "id363"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || ($Unbox(read($Heap, this, _module.RingBuffer.N)): int != 0
         ==> $Unbox(read($Heap, this, _module.RingBuffer.start)): int
           < $Unbox(read($Heap, this, _module.RingBuffer.N)): int);
  ensures {:id "id364"} _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this)
     ==> _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this)
       || Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
        (if $Unbox(read($Heap, this, _module.RingBuffer.start)): int
               + $Unbox(read($Heap, this, _module.RingBuffer.len)): int
  ...
  ensures {:id "id365"} (forall $o: ref :: 
     ...
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id366"} x#0
     == Seq#Index($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, LitInt(0));
  ensures {:id "id367"} Seq#Equal($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, 
    Seq#Drop($Unbox(read(old($Heap), this, _module.RingBuffer.Contents)): Seq, LitInt(1)));
  ensures {:id "id368"} $Unbox(read($Heap, this, _module.RingBuffer.N)): int
     == $Unbox(read(old($Heap), this, _module.RingBuffer.N)): int;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
  ...
  var $rhs#0_0: Set;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, $Box($o)));
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(80,7)
    assume true;
    assert {:id "id369"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    assert {:id "id370"} 0 <= $Unbox(read($Heap, this, _module.RingBuffer.start)): int
       && $Unbox(read($Heap, this, _module.RingBuffer.start)): int
         < _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref);
    assume true;
    x#0 := read($Heap, 
      $Unbox(read($Heap, this, _module.RingBuffer.data)): ref, 
      IndexField($Unbox(read($Heap, this, _module.RingBuffer.start)): int));
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(80,24)
    assert {:id "id372"} {:subsumption 0} 0 <= LitInt(0)
       && LitInt(0)
         < Seq#Length($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq);
    assume true;
    assert {:id "id373"} x#0
       == Seq#Index($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq, LitInt(0));
    // ----- update statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(81,16)
    assume true;
    $obj0 := this;
    assert {:id "id374"} $_ModifiesFrame[$obj0, _module.RingBuffer.start];
    assume true;
    $obj1 := this;
    assert {:id "id375"} $_ModifiesFrame[$obj1, _module.RingBuffer.len];
    assert {:id "id376"} $Unbox(read($Heap, this, _module.RingBuffer.data)): ref != null;
    if ($Unbox(read($Heap, this, _module.RingBuffer.start)): int + 1
       == _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref))
    {
        assert {:id "id377"} $Is((if $Unbox(read($Heap, this, _module.RingBuffer.start)): int + 1
               == _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
             then 0
    ...
    {
        assert {:id "id378"} $Is((if $Unbox(read($Heap, this, _module.RingBuffer.start)): int + 1
               == _System.array.Length($Unbox(read($Heap, this, _module.RingBuffer.data)): ref)
             then 0
             else $Unbox(read($Heap, this, _module.RingBuffer.start)): int + 1), 
          Tclass._System.nat());
    ...
    assert {:id "id380"} $Is($Unbox(read($Heap, this, _module.RingBuffer.len)): int - 1, Tclass._System.nat());
    assume true;
    $rhs#1 := $Unbox(read($Heap, this, _module.RingBuffer.len)): int - 1;
    ...
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(82,14)
    assume true;
    assert {:id "id384"} $_ModifiesFrame[this, _module.RingBuffer.Contents];
    assert {:id "id385"} 0 <= LitInt(1)
       && LitInt(1)
         <= Seq#Length($Unbox(read($Heap, this, _module.RingBuffer.Contents)): Seq);
    assume true;
    ...
    $Heap := update($Heap, this, _module.RingBuffer.Contents, $Box($rhs#2));
    assume $IsGoodHeap($Heap);
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(76,10)
    assume true;
    if (!Set#IsMember($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
      read($Heap, this, _module.RingBuffer.data)))
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/vstte2012/RingBufferAuto.dfy(4,24)
        assume true;
        assert {:id "id388"} $_ModifiesFrame[this, _module.RingBuffer.Repr];
        assume true;
        $rhs#0_0 := Set#Union($Unbox(read($Heap, this, _module.RingBuffer.Repr)): Set, 
          Set#UnionOne(Set#Empty(): Set, read($Heap, this, _module.RingBuffer.data)));
        $Heap := update($Heap, this, _module.RingBuffer.Repr, $Box($rhs#0_0));
