...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.two__way__sort)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon10_correct  (=> (forall ((|m#1| Int) (|n#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |m#1|) (< |m#1| |n#1|)) (< |n#1| (_System.array.Length |a#0|))) (or (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |m#1|))))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |n#1|))))))
 :qid |TwoWaySortdfy.38:18|
 :skolemid |486|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |n#1|))) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |m#1|))))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |a#0| (Tclass._System.array? TBool) $Heap)))))))))
(let ((anon8_correct  (=> (and (or (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |m#0@0|))))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |n#0@0|))))) (= (ControlFlow 0 6) 2)) anon10_correct)))
(let ((anon14_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |m#0@0|))))) (= (ControlFlow 0 10) 6)) anon8_correct)))
(let ((anon14_Then_correct  (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |m#0@0|)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 |n#0@0|) (< |n#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |n#0@0|) (< |n#0@0| (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 7) 6) anon8_correct))))))))
(let ((anon6_correct  (=> (and (and (<= (LitInt 0) |m#0@0|) (< |m#0@0| |n#0@0|)) (< |n#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (and (<= 0 |m#0@0|) (< |m#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |m#0@0|) (< |m#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 11) 7) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))))
(let ((anon13_Else_correct  (=> (and (not (and (<= (LitInt 0) |m#0@0|) (< |m#0@0| |n#0@0|))) (= (ControlFlow 0 16) 11)) anon6_correct)))
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) |m#0@0|) (< |m#0@0| |n#0@0|)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 14) 11) anon6_correct))))))
(let ((anon12_Else_correct  (=> (< |m#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 18) 14) anon13_Then_correct) (=> (= (ControlFlow 0 18) 16) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |m#0@0|) (and (=> (= (ControlFlow 0 17) 14) anon13_Then_correct) (=> (= (ControlFlow 0 17) 16) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (=> (and (and (<= (LitInt 0) |m#0@0|) (< |m#0@0| |n#0@0|)) (< |n#0@0| (_System.array.Length |a#0|))) (or (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |m#0@0|))))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |n#0@0|)))))) (= (ControlFlow 0 5) 2)) anon10_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)) (= $o@@6 |a#0|)))
 :qid |TwoWaySortdfy.36:8|
 :skolemid |485|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (and (=> (= (ControlFlow 0 19) 5) anon11_Else_correct) (=> (= (ControlFlow 0 19) 17) anon12_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon12_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TBool)) ($IsAlloc refType |a#0| (Tclass._System.array TBool) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct))))
