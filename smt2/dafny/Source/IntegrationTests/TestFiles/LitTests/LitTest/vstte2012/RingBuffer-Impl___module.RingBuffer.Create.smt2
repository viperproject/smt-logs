...
(assert (forall ((h@@4 T@U) (a@@3 T@U) ) (! (forall ((i@@2 Int) ) (!  (=> (and (<= 0 i@@2) (< i@@2 (|Seq#Length| (|Seq#FromArray| h@@4 a@@3)))) (= (|Seq#Index| (|Seq#FromArray| h@@4 a@@3) i@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@4 a@@3) (IndexField i@@2))))
 :qid |DafnyPreludebpl.1328:11|
 :skolemid |262|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@4 a@@3) (IndexField i@@2)))
 :pattern ( (|Seq#Index| (|Seq#FromArray| h@@4 a@@3) i@@2))
))
...
(assert (forall ((h@@7 T@U) (i@@8 Int) (v@@12 T@U) (a@@6 T@U) ) (!  (=> (and (<= 0 i@@8) (< i@@8 (_System.array.Length a@@6))) (= (|Seq#FromArray| (MapType0Store refType (MapType0Type FieldType BoxType) h@@7 a@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@7 a@@6) (IndexField i@@8) v@@12)) a@@6) (|Seq#Update| (|Seq#FromArray| h@@7 a@@6) i@@8 v@@12)))
 :qid |DafnyPreludebpl.1343:15|
 :skolemid |265|
 :pattern ( (|Seq#FromArray| (MapType0Store refType (MapType0Type FieldType BoxType) h@@7 a@@6 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@7 a@@6) (IndexField i@@8) v@@12)) a@@6))
)))
...
(assert (not
 ...
 :qid |RingBufferdfy.31:24|
 :skolemid |524|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) _module.RingBuffer.Repr)) ($Box refType $o@@24)))
)))) (=> (and (forall (($o@@25 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) _module.RingBuffer.Repr)) ($Box refType $o@@25)) (or (not (= $o@@25 null)) (not true)))
 :qid |RingBufferdfy.31:24|
 :skolemid |523|
 ...
 :qid |RingBufferdfy.31:24|
 :skolemid |524|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@2) _module.RingBuffer.Repr)) ($Box refType $o@@26)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (<= (LitInt 0) |n#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 18) 2))) anon0_correct)))
