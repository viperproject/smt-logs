...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split70)
...
)))))) (and (and ($IsGoodHeap $Heap@11) ($IsHeapAnchor $Heap@11)) (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#4_1_0_0@0|) |AllVertices#0@@10|))))) (and (and (and (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) |p#4_1_0_0@0|) |AllVertices#0@@10|) |dest#0@@3|) (= $Heap@10 $Heap@11)) (and ($IsAlloc DatatypeTypeType |p#4_1_0_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@11) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|))) (and (and ($IsAlloc DatatypeTypeType |pathToV#4_0@1| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@11) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |pathToV#4_0@1|)) (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |pathToV#4_0@1|)))) (and (and (and (< (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#4_1_0_0@0|) (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |pathToV#4_0@1|)) ($IsAlloc DatatypeTypeType |p#4_1_0_0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37) $Heap@11)) (and (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 |p#4_1_0_0@0|))) (and (and (= |m##4_1_0_0_0@0| (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) |p#4_1_0_0@0|)) ($Is intType (int_2_U (- |d#0@1| 1)) Tclass._System.nat)) (and (= |n##4_1_0_0_0@0| (- |d#0@1| 1)) (= (ControlFlow 0 2) (- 0 1))))))) (<= |m##4_1_0_0_0@0| |n##4_1_0_0_0@0|))))))))
