...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.IsReachFixpoint_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| |m#0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| |n#0@@5| |AllVertices#0@@10|)))))
(let ((anon3_Else_correct  (=> (and (<= |n#0@@5| |m#0|) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (< |m#0| |n#0@@5|) (=> (and (and (and (and ($Is intType (int_2_U (+ |m#0| 1)) Tclass._System.nat) (= |m##0_0@0| (+ |m#0| 1))) (and (or (<= 0 (- |n#0@@5| |m#0|)) (= (- |n#0@@5| |m##0_0@0|) (- |n#0@@5| |m#0|))) (< (- |n#0@@5| |m##0_0@0|) (- |n#0@@5| |m#0|)))) (and (and (|Set#Equal| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| |m##0_0@0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| (+ |m##0_0@0| 1) |AllVertices#0@@10|)) (<= |m##0_0@0| |n#0@@5|)) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (and (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@22 this@@12 |source#0@@5| |m##0_0@0| |AllVertices#0@@10|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@22 this@@12 |source#0@@5| |n#0@@5| |AllVertices#0@@10|)) (|Set#Equal| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| |m##0_0@0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| |n#0@@5| |AllVertices#0@@10|))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) 2)))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@22)) ($IsAlloc refType this@@12 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@22) $Heap@@2))) (and ($IsBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@22) ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@22 $Heap@@2))) (and (and (<= (LitInt 0) |m#0|) (<= (LitInt 0) |n#0@@5|)) (and ($Is SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@22)) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@22) $Heap@@2)))) (and (and (and (= 3 $FunctionContextHeight) (|Set#Equal| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| |m#0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@22 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@12 |source#0@@5| (+ |m#0| 1) |AllVertices#0@@10|))) (and (<= |m#0| |n#0@@5|) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@2 $Heap@0) reveal__module.BreadthFirstSearch.R)))) (and (=> (= (ControlFlow 0 5) 3) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
