...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split59)
...
))) (=> |$w$loop#0@0| (forall ((|x#3@@2| T@U) ) (!  (=> ($IsBox |x#3@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@1| |x#3@@2|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@2| |call8formal@newPaths#0@0|)) (+ |d#0@2| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
...
)))))) (and (and (and (=> |$w$loop#0@0| (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |C#0@1| |dest#0@@3|))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (or (not (= |d#0@2| 0)) (not true)))) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|) |dest#0@@3|))))))))
