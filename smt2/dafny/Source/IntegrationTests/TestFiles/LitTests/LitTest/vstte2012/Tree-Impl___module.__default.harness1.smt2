...
(set-info :boogie-vc-id Impl$$_module.__default.harness1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U (_module.Result.Fail_q (Lit DatatypeTypeType (_module.__default.build (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 2))))))))))))))
