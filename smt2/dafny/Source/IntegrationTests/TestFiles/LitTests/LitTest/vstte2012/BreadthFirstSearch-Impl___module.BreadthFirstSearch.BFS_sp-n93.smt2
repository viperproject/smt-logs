...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split90)
...
))))))))) (and (and (and (and (and (=> |$w$loop#0@0| (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|))) (=> |$w$loop#0@0| (forall ((|x#1@@1| T@U) ) (!  (=> ($IsBox |x#1@@1| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@1|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@1| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |669|
...
)) (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|))) (and (and |$w$loop#0@0| (|Set#Equal| |C#0@0| |Set#Empty|)) (and (U_2_bool (Lit boolType (bool_2_U true))) (<= (LitInt 0) |n#5_0@0|)))) (and (and (and ($IsGoodHeap $Heap@15) ($IsHeapAnchor $Heap@15)) (= $Heap@4 $Heap@15)) (and (and reveal__module.BreadthFirstSearch.R (<= |d#0@1| |n#5_0@0|)) (and ($Is intType (int_2_U |d#0@1|) Tclass._System.nat) (= (ControlFlow 0 2) (- 0 1)))))))) (|Set#Equal| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@1| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))))))
