...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split25)
...
)))) (and (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) |$w$loop#0@0|) (and (|Set#Equal| |C#0@0| |Set#Empty|) (= (ControlFlow 0 2) (- 0 1)))))))) (U_2_bool (Lit boolType (bool_2_U true))))))))
