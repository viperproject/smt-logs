...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split37)
...
)))) (= (ControlFlow 0 2) (- 0 1))))) (|Set#Disjoint| |newlyEncountered#4_0@1| (|Map#Domain| |paths#0@0|)))))
