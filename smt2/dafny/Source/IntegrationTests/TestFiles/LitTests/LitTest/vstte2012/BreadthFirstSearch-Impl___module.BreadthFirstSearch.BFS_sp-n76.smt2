...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split73)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon54_correct  (=> ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@5) (=> (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@5) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U (+ |d#0@1| 1)) Tclass._System.nat)))))
(let ((anon147_Else_correct  (=> (and (not (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_0@0|) (not (|Set#IsMember| |V#0@0| |w#4_0@0|)))) (= (ControlFlow 0 5) 2)) anon54_correct)))
(let ((anon147_Then_correct  (=> (and (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_0@0|) (not (|Set#IsMember| |V#0@0| |w#4_0@0|))) (= (ControlFlow 0 4) 2)) anon54_correct)))
(let ((anon146_Else_correct  (=> (not (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_0@0|)) (and (=> (= (ControlFlow 0 7) 4) anon147_Then_correct) (=> (= (ControlFlow 0 7) 5) anon147_Else_correct)))))
(let ((anon146_Then_correct  (=> (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_0@0|) (and (=> (= (ControlFlow 0 6) 4) anon147_Then_correct) (=> (= (ControlFlow 0 6) 5) anon147_Else_correct)))))
(let ((anon145_Then_correct  (=> (and (and (and ($IsBox |w#4_0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@5)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@5)) (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@5) (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|))) (and (=> (= (ControlFlow 0 8) 6) anon146_Then_correct) (=> (= (ControlFlow 0 8) 7) anon146_Else_correct)))))
(let ((anon145_Else_correct  (=> (and (not (and ($IsBox |w#4_0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@5))) (= (ControlFlow 0 3) 2)) anon54_correct)))
(let ((anon144_Then_correct  (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (and (=> (= (ControlFlow 0 9) 8) anon145_Then_correct) (=> (= (ControlFlow 0 9) 3) anon145_Else_correct)))))
(let ((anon143_Else_correct  (=> (and (= |v#4_0@1| |dest#0@@3|) (= (ControlFlow 0 11) 9)) anon144_Then_correct)))
(let ((anon143_Then_correct  (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (= (ControlFlow 0 10) 9)) anon144_Then_correct)))
(let ((anon45_correct  (=> (exists ((|$as#v4_0#4_0| T@U) ) (!  (and ($IsBox |$as#v4_0#4_0| _module.BreadthFirstSearch$Vertex@@37) (|Set#IsMember| |C#0@0| |$as#v4_0#4_0|))
 ...
 :skolemid |682|
)) (=> (and (=> true (and ($IsBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (|Set#IsMember| |C#0@0| |v#4_0@1|)) (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (= $Heap@4 $Heap@5) reveal__module.BreadthFirstSearch.R)) (and (=> (= (ControlFlow 0 12) 10) anon143_Then_correct) (=> (= (ControlFlow 0 12) 11) anon143_Else_correct)))))))
(let ((anon141_Else_correct  (=> (and (not (and ($IsBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (= (ControlFlow 0 14) 12)) anon45_correct)))
(let ((anon141_Then_correct  (=> (and (and ($IsBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_1@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (= (ControlFlow 0 13) 12)) anon45_correct)))
...
)))) (and (and (|Set#Subset| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|) |$decr_init$loop#00@0|) |$w$loop#0@0|) (and (not (|Set#Equal| |C#0@0| |Set#Empty|)) (= |$decr$loop#00@1| (|Set#Difference| |AllVertices#0@@10| |Processed#0@0|)))))))) (and (=> (= (ControlFlow 0 15) 13) anon141_Then_correct) (=> (= (ControlFlow 0 15) 14) anon141_Else_correct)))))))
(let ((anon123_Else_correct  (=> (and (= |d#0@0| 0) (= (ControlFlow 0 17) 15)) anon12_correct)))
(let ((anon123_Then_correct  (=> (or (not (= |d#0@0| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@@3)) (and ($Is intType (int_2_U (- |d#0@0| 1)) Tclass._System.nat) (= |##n#3@0| (- |d#0@0| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#3@0|) Tclass._System.nat $Heap@@3) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|) (= (ControlFlow 0 16) 15)))) anon12_correct))))
(let ((anon6_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |$rhs#1@0| |dest#0@@3|))) (and (=> (= (ControlFlow 0 18) 16) anon123_Then_correct) (=> (= (ControlFlow 0 18) 17) anon123_Else_correct)))))
(let ((anon120_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|)) (= (ControlFlow 0 20) 18)) anon6_correct)))
(let ((anon120_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (= (ControlFlow 0 19) 18)) anon6_correct)))
