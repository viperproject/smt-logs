...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.build__rec_split35)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon27_Then_correct  (=> ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap) (=> (and (and ($IsAlloc SeqType |s#0@@3| (TSeq TInt) $Heap) (or (<= 0 (|Seq#Length| |s#0@@3|)) (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)))) (and (or (or (<= 0 (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (< (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|))) (= (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)))) (or (and (= |d#0@@8| |d#0@@8|) (|Seq#Equal| |s#0@@3| |s#0@@3|)) (or (< (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)) (and (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)) (< (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)))))))) (=> (and (and (and (or (and (= |d#0@@8| |d#0@@8|) (|Seq#Equal| |s#0@@3| |s#0@@3|)) (|_module.__default.build__rec#canCall| |d#0@@8| |s#0@@3|)) (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |d#0@@8| |s#0@@3|))) (and ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap) ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap))) (and (and ($IsAlloc SeqType |s#0@@3| (TSeq TInt) $Heap) (or (<= 0 (|Seq#Length| |s#0@@3|)) (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)))) (and (or (or (<= 0 (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (< (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|))) (= (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)))) (= (ControlFlow 0 2) (- 0 1))))) (or (and (= |d#0@@8| |d#0@@8|) (|Seq#Equal| |s#0@@3| |s#0@@3|)) (or (< (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)) (and (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)) (< (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)))))))))))
