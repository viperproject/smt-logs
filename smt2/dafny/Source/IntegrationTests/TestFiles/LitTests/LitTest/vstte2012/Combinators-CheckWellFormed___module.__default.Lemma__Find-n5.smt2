...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Lemma__FindAndStep)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon8_Else_correct true))
(let ((anon8_Then_correct  (=> (and (not (|_module.Term#Equal| |r#0@0| |t#0@@23|)) ($IsAlloc DatatypeTypeType |C#0@0| Tclass._module.Context $Heap@0)) (=> (and (and (|_module.__default.IsContext#canCall| |C#0@0|) (_module.__default.IsContext ($LS $LZ) |C#0@0|)) (and ($IsAlloc DatatypeTypeType |C#0@0| Tclass._module.Context $Heap@0) ($IsAlloc DatatypeTypeType |u#0@0| Tclass._module.Term $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (_module.Context.Hole_q |C#0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (_module.Context.C__term_q |C#0@0|) (let ((|D#0@@1| (_module.Context._h0 |C#0@0|)))
(_module.__default.IsContext ($LS ($LS $LZ)) |D#0@@1|))))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#0@@1| (_module.Context._h2 |C#0@0|)))
 (=> (|_module.__default.IsValue#canCall| |v#0@@1|) (or (_module.__default.IsValue ($LS $LZ) |v#0@@1|) (=> (_module.Term.S_q |v#0@@1|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#0@@2| (_module.Context._h2 |C#0@0|)))
 (=> (|_module.__default.IsValue#canCall| |v#0@@2|) (or (_module.__default.IsValue ($LS $LZ) |v#0@@2|) (=> (not (_module.Term.S_q |v#0@@2|)) (=> (_module.Term.K_q |v#0@@2|) (U_2_bool (Lit boolType (bool_2_U true))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#0@@3| (_module.Context._h2 |C#0@0|)))
...
(let ((|x#0@@5| (_module.Term.car |a#0@@4|)))
 (=> (=> (and (and (|_module.Term#Equal| |x#0@@5| |#_module.Term.S|) (_module.__default.IsValue ($LS $LZ) |y#0@@5|)) (_module.__default.IsValue ($LS $LZ) |b#0@@4|)) (_module.__default.IsValue ($LS $LZ) |a#0@@4|)) (_module.__default.IsValue ($LS ($LS $LZ)) |b#0@@4|)))))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|D#1@@1| (_module.Context._h3 |C#0@0|)))
(_module.__default.IsContext ($LS ($LS $LZ)) |D#1@@1|))))))) (=> (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (and (|_module.__default.EvalExpr#canCall| |C#0@0| |u#0@0|) (|_module.Term#Equal| |t#0@@23| (_module.__default.EvalExpr ($LS $LZ) |C#0@0| |u#0@0|))) (=> (and (and (and ($IsAlloc DatatypeTypeType |u#0@0| Tclass._module.Term $Heap@0) (|_module.__default.Step#canCall| |u#0@0|)) (and (not (|_module.Term#Equal| (_module.__default.Step |u#0@0|) |u#0@0|)) ($IsAlloc DatatypeTypeType |C#0@0| Tclass._module.Context $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |u#0@0| Tclass._module.Term $Heap@0) (|_module.__default.Step#canCall| |u#0@0|)) (and (= |##t#4@0| (_module.__default.Step |u#0@0|)) ($IsAlloc DatatypeTypeType |##t#4@0| Tclass._module.Term $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (_module.Context.Hole_q |C#0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (_module.Context.C__term_q |C#0@0|) (let ((|D#4@@1| (_module.Context._h0 |C#0@0|)))
(_module.__default.IsContext ($LS ($LS $LZ)) |D#4@@1|))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#2@@1| (_module.Context._h2 |C#0@0|)))
 (=> (|_module.__default.IsValue#canCall| |v#2@@1|) (or (_module.__default.IsValue ($LS $LZ) |v#2@@1|) (=> (_module.Term.S_q |v#2@@1|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#2@@2| (_module.Context._h2 |C#0@0|)))
 (=> (|_module.__default.IsValue#canCall| |v#2@@2|) (or (_module.__default.IsValue ($LS $LZ) |v#2@@2|) (=> (not (_module.Term.S_q |v#2@@2|)) (=> (_module.Term.K_q |v#2@@2|) (U_2_bool (Lit boolType (bool_2_U true))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#2@@3| (_module.Context._h2 |C#0@0|)))
...
(let ((|a#2@@0| (_module.Term.car |v#2@@3|)))
 (=> (_module.Term.S_q |a#2@@0|) (=> (_module.__default.IsValue ($LS $LZ) |a#2@@0|) (_module.__default.IsValue ($LS ($LS $LZ)) |b#2@@0|))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#2@@4| (_module.Context._h2 |C#0@0|)))
...
(let ((|a#2@@1| (_module.Term.car |v#2@@4|)))
 (=> (not (_module.Term.S_q |a#2@@1|)) (=> (_module.Term.K_q |a#2@@1|) (=> (_module.__default.IsValue ($LS $LZ) |a#2@@1|) (_module.__default.IsValue ($LS ($LS $LZ)) |b#2@@1|)))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#2@@5| (_module.Context._h2 |C#0@0|)))
...
(let ((|a#2@@2| (_module.Term.car |v#2@@5|)))
 (=> (not (_module.Term.S_q |a#2@@2|)) (=> (not (_module.Term.K_q |a#2@@2|)) (let ((|y#2@@3| (_module.Term.cdr |a#2@@2|)))
(let ((|x#2@@3| (_module.Term.car |a#2@@2|)))
 (=> (=> (and (and (|_module.Term#Equal| |x#2@@3| |#_module.Term.S|) (_module.__default.IsValue ($LS $LZ) |y#2@@3|)) (_module.__default.IsValue ($LS $LZ) |b#2@@2|)) (_module.__default.IsValue ($LS $LZ) |a#2@@2|)) (|_module.Term#Equal| |x#2@@3| |#_module.Term.S|)))))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#2@@6| (_module.Context._h2 |C#0@0|)))
...
(let ((|a#2@@3| (_module.Term.car |v#2@@6|)))
 (=> (not (_module.Term.S_q |a#2@@3|)) (=> (not (_module.Term.K_q |a#2@@3|)) (let ((|y#2@@4| (_module.Term.cdr |a#2@@3|)))
(let ((|x#2@@4| (_module.Term.car |a#2@@3|)))
 (=> (=> (and (and (|_module.Term#Equal| |x#2@@4| |#_module.Term.S|) (_module.__default.IsValue ($LS $LZ) |y#2@@4|)) (_module.__default.IsValue ($LS $LZ) |b#2@@3|)) (_module.__default.IsValue ($LS $LZ) |a#2@@3|)) (_module.__default.IsValue ($LS ($LS $LZ)) |y#2@@4|)))))))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|v#2@@7| (_module.Context._h2 |C#0@0|)))
...
(let ((|a#2@@4| (_module.Term.car |v#2@@7|)))
 (=> (not (_module.Term.S_q |a#2@@4|)) (=> (not (_module.Term.K_q |a#2@@4|)) (let ((|y#2@@5| (_module.Term.cdr |a#2@@4|)))
(let ((|x#2@@5| (_module.Term.car |a#2@@4|)))
 (=> (=> (and (and (|_module.Term#Equal| |x#2@@5| |#_module.Term.S|) (_module.__default.IsValue ($LS $LZ) |y#2@@5|)) (_module.__default.IsValue ($LS $LZ) |b#2@@4|)) (_module.__default.IsValue ($LS $LZ) |a#2@@4|)) (_module.__default.IsValue ($LS ($LS $LZ)) |b#2@@4|)))))))))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (not (_module.Context.C__term_q |C#0@0|)) (let ((|D#5@@1| (_module.Context._h3 |C#0@0|)))
(_module.__default.IsContext ($LS ($LS $LZ)) |D#5@@1|)))))))))))))))))))))))))))))))))
(let ((anon7_Else_correct  (=> (=> (|_module.Term#Equal| |r#0@0| |t#0@@23|) (_module.__default.IsTerminal |t#0@@23|)) (and (=> (= (ControlFlow 0 24) 2) anon8_Then_correct) (=> (= (ControlFlow 0 24) 22) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (and (|_module.Term#Equal| |r#0@0| |t#0@@23|) ($IsAlloc DatatypeTypeType |t#0@@23| Tclass._module.Term $Heap@0)) (and (|_module.__default.IsTerminal#canCall| |t#0@@23|) (_module.__default.IsTerminal |t#0@@23|))) (and (=> (= (ControlFlow 0 23) 2) anon8_Then_correct) (=> (= (ControlFlow 0 23) 22) anon8_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($Is DatatypeTypeType |r#0@0| Tclass._module.Term) ($IsAlloc DatatypeTypeType |r#0@0| Tclass._module.Term $Heap@0)) (and ($Is DatatypeTypeType |C#0@0| Tclass._module.Context) ($IsAlloc DatatypeTypeType |C#0@0| Tclass._module.Context $Heap@0)))) (and (and (and ($Is DatatypeTypeType |u#0@0| Tclass._module.Term) ($IsAlloc DatatypeTypeType |u#0@0| Tclass._module.Term $Heap@0)) ($IsAlloc DatatypeTypeType |t#0@@23| Tclass._module.Term $Heap@0)) (and (|_module.__default.FindAndStep#canCall| |t#0@@23|) (|_module.Term#Equal| |r#0@0| (_module.__default.FindAndStep ($LS $LZ) |t#0@@23|))))) (and (=> (= (ControlFlow 0 25) 23) anon7_Then_correct) (=> (= (ControlFlow 0 25) 24) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |t#0@@23| Tclass._module.Term) ($IsAlloc DatatypeTypeType |t#0@@23| Tclass._module.Term $Heap)) (|$IsA#_module.Term| |t#0@@23|)) (=> (and (and (and ($Is DatatypeTypeType |r#0| Tclass._module.Term) ($IsAlloc DatatypeTypeType |r#0| Tclass._module.Term $Heap)) (and ($Is DatatypeTypeType |C#0@@8| Tclass._module.Context) ($IsAlloc DatatypeTypeType |C#0@@8| Tclass._module.Context $Heap))) (and (and ($Is DatatypeTypeType |u#0@@2| Tclass._module.Term) ($IsAlloc DatatypeTypeType |u#0@@2| Tclass._module.Term $Heap)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 26) 25)))) anon0_correct)))))
