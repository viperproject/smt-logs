...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split101)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) |dest#0|) (|Set#IsMember| |$rhs#1@0| |dest#0|))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@@2 $Heap@1) reveal__module.BreadthFirstSearch.R)) (and (and (or (not (= |d#0@0| 0)) (not true)) ($IsAllocBox ($Box refType this@@15) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@25) $Heap@1)) (and ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@25 $Heap@1) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (- |d#0@0| 1)) Tclass._System.nat)))))
(let ((anon120_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) |dest#0|)) (= (ControlFlow 0 4) 2)) anon6_correct)))
(let ((anon120_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) |dest#0|) (= (ControlFlow 0 3) 2)) anon6_correct)))
