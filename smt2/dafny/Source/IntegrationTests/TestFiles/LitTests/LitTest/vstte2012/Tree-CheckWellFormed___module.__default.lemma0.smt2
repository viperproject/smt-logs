...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.lemma0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (=> (and (and (and (and ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap@0) ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap@0)) (and ($IsAlloc DatatypeTypeType |t#0@@4| Tclass._module.Tree $Heap@0) (|_module.__default.toList#canCall| |d#0@@8| |t#0@@4|))) (and (and (= |##s#0@0| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d#0@@8| |t#0@@4|) |s#0@@3|)) ($IsAlloc SeqType |##s#0@0| (TSeq TInt) $Heap@0)) (and (|_module.__default.build__rec#canCall| |d#0@@8| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d#0@@8| |t#0@@4|) |s#0@@3|)) (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |d#0@@8| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d#0@@8| |t#0@@4|) |s#0@@3|)))))) (and (and (and ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap@0) ($IsAlloc intType (int_2_U |d#0@@8|) TInt $Heap@0)) (and ($IsAlloc DatatypeTypeType |t#0@@4| Tclass._module.Tree $Heap@0) (|_module.__default.toList#canCall| |d#0@@8| |t#0@@4|))) (and (and (= |##s#1@0| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d#0@@8| |t#0@@4|) |s#0@@3|)) ($IsAlloc SeqType |##s#1@0| (TSeq TInt) $Heap@0)) (and (|_module.__default.build__rec#canCall| |d#0@@8| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d#0@@8| |t#0@@4|) |s#0@@3|)) (= (ControlFlow 0 2) (- 0 1)))))) (_module.Result.Res_q (_module.__default.build__rec ($LS $LZ) |d#0@@8| (|Seq#Append| (_module.__default.toList ($LS $LZ) |d#0@@8| |t#0@@4|) |s#0@@3|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |t#0@@4| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |t#0@@4| Tclass._module.Tree $Heap)) (|$IsA#_module.Tree| |t#0@@4|)) (and (and ($Is SeqType |s#0@@3| (TSeq TInt)) ($IsAlloc SeqType |s#0@@3| (TSeq TInt) $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
