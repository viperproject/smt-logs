...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Theorem__FindAndStep)
...
(_module.__default.IsContext ($LS ($LS $LZ)) |D#1@@1|))))))) (=> (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (and (and (|_module.__default.EvalExpr#canCall| |C#0@0| |u#0@0|) (|_module.Term#Equal| |t#0@@23| (_module.__default.EvalExpr ($LS $LZ) |C#0@0| |u#0@0|))) (and ($IsAlloc DatatypeTypeType |u#0@0| Tclass._module.Term $Heap@0) (|_module.__default.Step#canCall| |u#0@0|))) (=> (and (and (and (not (|_module.Term#Equal| (_module.__default.Step |u#0@0|) |u#0@0|)) ($IsAlloc DatatypeTypeType |t#0@@23| Tclass._module.Term $Heap@0)) (and (|_module.__default.FindAndStep#canCall| |t#0@@23|) ($IsAlloc DatatypeTypeType |C#0@0| Tclass._module.Context $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |u#0@0| Tclass._module.Term $Heap@0) (|_module.__default.Step#canCall| |u#0@0|)) (and (= |##t#6@0| (_module.__default.Step |u#0@0|)) ($IsAlloc DatatypeTypeType |##t#6@0| Tclass._module.Term $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (_module.Context.Hole_q |C#0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.__default.IsContext#canCall| |C#0@0|) (or (_module.__default.IsContext ($LS $LZ) |C#0@0|) (=> (not (_module.Context.Hole_q |C#0@0|)) (=> (_module.Context.C__term_q |C#0@0|) (let ((|D#4@@1| (_module.Context._h0 |C#0@0|)))
...
(let ((anon7_Else_correct  (=> (=> (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |t#0@@23|) |t#0@@23|) (_module.__default.IsTerminal |t#0@@23|)) (and (=> (= (ControlFlow 0 24) 2) anon8_Then_correct) (=> (= (ControlFlow 0 24) 22) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and ($IsAlloc DatatypeTypeType |t#0@@23| Tclass._module.Term $Heap@0) (|_module.__default.FindAndStep#canCall| |t#0@@23|)) (=> (and (and (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |t#0@@23|) |t#0@@23|) ($IsAlloc DatatypeTypeType |t#0@@23| Tclass._module.Term $Heap@0)) (and (|_module.__default.IsTerminal#canCall| |t#0@@23|) (_module.__default.IsTerminal |t#0@@23|))) (and (=> (= (ControlFlow 0 23) 2) anon8_Then_correct) (=> (= (ControlFlow 0 23) 22) anon8_Else_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 25) 23) anon7_Then_correct) (=> (= (ControlFlow 0 25) 24) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |t#0@@23| Tclass._module.Term) ($IsAlloc DatatypeTypeType |t#0@@23| Tclass._module.Term $Heap)) (|$IsA#_module.Term| |t#0@@23|)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 26) 25))) anon0_correct))))
