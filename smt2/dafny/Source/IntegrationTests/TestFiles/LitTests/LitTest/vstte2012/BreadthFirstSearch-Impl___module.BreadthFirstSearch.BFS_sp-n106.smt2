...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split103)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_correct  (=> (and (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) (= (ControlFlow 0 2) (- 0 1))) (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) |dest#0|)) (|Set#IsMember| |$rhs#1@0| |dest#0|))))
(let ((anon119_Else_correct  (=> (and (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) |dest#0|)) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon119_Then_correct  (=> (and (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) |dest#0|) (= (ControlFlow 0 3) 2)) anon3_correct)))
(let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc refType this@@15 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)))) (=> (and (and (and ($IsBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@25) ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@25 $Heap@@2)) (and ($IsBox |dest#0| _module.BreadthFirstSearch$Vertex@@25) ($IsAllocBox |dest#0| _module.BreadthFirstSearch$Vertex@@25 $Heap@@2))) (and (and ($Is SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)) (and ($Is DatatypeTypeType |path#0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc DatatypeTypeType |path#0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)))) (=> (and (and (and (and (and ($Is SetType |V#0| (TSet _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc SetType |V#0| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)) true) (and (and ($Is SetType |C#0| (TSet _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc SetType |C#0| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)) true)) (and (and (and ($Is SetType |N#0| (TSet _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc SetType |N#0| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)) true) (and (and ($Is SetType |Processed#0| (TSet _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc SetType |Processed#0| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)) true))) (and (and (and (and ($Is MapType |paths#0| (TMap _module.BreadthFirstSearch$Vertex@@25 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@25))) ($IsAlloc MapType |paths#0| (TMap _module.BreadthFirstSearch$Vertex@@25 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@25)) $Heap@@2)) true) (and (=> |defass#v#4_0| (and ($IsBox |v#4_0| _module.BreadthFirstSearch$Vertex@@25) ($IsAllocBox |v#4_0| _module.BreadthFirstSearch$Vertex@@25 $Heap@@2))) true)) (and (and ($Is DatatypeTypeType |pathToV#4_0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc DatatypeTypeType |pathToV#4_0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)) true))) (=> (and (and (and (and (and (and ($Is SetType |newlyEncountered#4_0| (TSet _module.BreadthFirstSearch$Vertex@@25)) ($IsAlloc SetType |newlyEncountered#4_0| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@@2)) true) (= 5 $FunctionContextHeight)) (and (|Set#IsMember| |AllVertices#0@@10| |source#0@@5|) (|Set#IsMember| |AllVertices#0@@10| |dest#0|))) (and (and (and (|_module.BreadthFirstSearch.IsClosed#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |AllVertices#0@@10|) (and (_module.BreadthFirstSearch.IsClosed _module.BreadthFirstSearch$Vertex@@25 this@@15 |AllVertices#0@@10|) (forall ((|v#3| T@U) ) (!  (=> ($IsBox |v#3| _module.BreadthFirstSearch$Vertex@@25) (=> (|Set#IsMember| |AllVertices#0@@10| |v#3|) (|Set#Subset| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@25 this@@15 |v#3|) |AllVertices#0@@10|)))
 :qid |BreadthFirstSearchdfy.21:12|
 :skolemid |649|
...
)))) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false))) (and (= |path#0@0| (Lit DatatypeTypeType |#_module.List.Nil|)) (= |$rhs#0@0| (|Set#UnionOne| |Set#Empty| |source#0@@5|))))) (and (and (and (and (= |$rhs#1@0| (|Set#UnionOne| |Set#Empty| |source#0@@5|)) (= |$rhs#2@0| (Lit SetType |Set#Empty|))) (and (= |$rhs#3@0| (Lit SetType |Set#Empty|)) (= |$rhs#4@0| (|Map#Build| |Map#Empty| |source#0@@5| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)))))) (and (and (|Set#Equal| (|Map#Domain| |$rhs#4@0|) (|Set#UnionOne| |Set#Empty| |source#0@@5|)) (= |d#0@0| (LitInt 0))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (and (and (= $Heap@@2 $Heap@0) reveal__module.BreadthFirstSearch.R) (and ($IsAllocBox ($Box refType this@@15) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@25) $Heap@0) ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@25 $Heap@0))) (and (and ($Is intType (int_2_U |d#0@0|) Tclass._System.nat) ($IsAlloc intType (int_2_U |d#0@0|) Tclass._System.nat $Heap@0)) (and ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@0) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|)))))) (and (=> (= (ControlFlow 0 5) 3) anon119_Then_correct) (=> (= (ControlFlow 0 5) 4) anon119_Else_correct))))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
