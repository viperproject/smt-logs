...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split42)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((anon103_correct  (=> (and (and (=> (or (not (= |d#0@2| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |d#0@2| 0)) (not true))) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|) |dest#0@@3|)))))
