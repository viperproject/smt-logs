...
(assert (forall ((a@@4 T@U) (b@@4 T@U) ) (! (= (|_module.List#Equal| a@@4 b@@4) (= a@@4 b@@4))
 :qid |unknown.0:0|
 :skolemid |856|
 :pattern ( (|_module.List#Equal| a@@4 b@@4))
)))
...
(assert (forall ((a@@5 T@U) (b@@5 T@U) ) (!  (=> (and (_module.List.Cons_q a@@5) (_module.List.Cons_q b@@5)) (= (|_module.List#Equal| a@@5 b@@5)  (and (= (_module.List.head a@@5) (_module.List.head b@@5)) (|_module.List#Equal| (_module.List.tail a@@5) (_module.List.tail b@@5)))))
 :qid |unknown.0:0|
 :skolemid |855|
 :pattern ( (|_module.List#Equal| a@@5 b@@5) (_module.List.Cons_q a@@5))
 :pattern ( (|_module.List#Equal| a@@5 b@@5) (_module.List.Cons_q b@@5))
)))
...
(assert (forall ((h@@3 T@U) (k@@2 T@U) ) (!  (=> ($HeapSuccGhost h@@3 k@@2) (and ($HeapSucc h@@3 k@@2) (forall ((o@@2 T@U) (f T@U) ) (!  (=> (not ($IsGhostField f)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@3 o@@2) f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) k@@2 o@@2) f)))
 :qid |DafnyPreludebpl.544:13|
 :skolemid |108|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) k@@2 o@@2) f))
))))
...
(assert (forall ((a@@7 T@U) (b@@7 T@U) (o@@3 T@U) ) (! (= (|Set#IsMember| (|Set#Union| a@@7 b@@7) o@@3)  (or (|Set#IsMember| a@@7 o@@3) (|Set#IsMember| b@@7 o@@3)))
 :qid |DafnyPreludebpl.704:15|
 :skolemid |133|
 :pattern ( (|Set#IsMember| (|Set#Union| a@@7 b@@7) o@@3))
)))
...
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (!  (=> (and (_module.List.Nil_q a@@11) (_module.List.Nil_q b@@11)) (|_module.List#Equal| a@@11 b@@11))
 :qid |unknown.0:0|
 :skolemid |854|
 :pattern ( (|_module.List#Equal| a@@11 b@@11) (_module.List.Nil_q a@@11))
 :pattern ( (|_module.List#Equal| a@@11 b@@11) (_module.List.Nil_q b@@11))
)))
...
(assert (forall ((m@@8 T@U) ) (!  (or (= m@@8 |Map#Empty|) (exists ((k@@4 T@U) (v@@8 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@8) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@4 v@@8)))
...
(declare-fun |succ#0@0| () T@U)
(declare-fun |##p#0@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun |newPaths#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.BreadthFirstSearch.UpdatePaths)
...
(let ((anon13_Else_correct  (=> (and (=> (|Set#IsMember| |vSuccs#0| |x#2@0|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#2@0| |newPaths#0@0|) (|#_module.List.Cons| |v#0@@2| |pathToV#0|))) (= (ControlFlow 0 5) 1)) anon10_correct)))
(let ((anon13_Then_correct  (=> (|Set#IsMember| |vSuccs#0| |x#2@0|) (=> (and (and ($IsAllocBox ($Box refType this@@13) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@23) $Heap@0) ($IsAllocBox |source#0@@11| _module.BreadthFirstSearch$Vertex@@23 $Heap@0)) (and ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@23 $Heap@0) ($IsAlloc MapType |newPaths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |newPaths#0@0|) (or (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |newPaths#0@0|) (forall ((|v#3@@0| T@U) ) (!  (=> ($IsBox |v#3@@0| _module.BreadthFirstSearch$Vertex@@23) (=> (|Set#IsMember| (|Map#Domain| |newPaths#0@0|) |v#3@@0|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@23 ($LS ($LS $LZ)) this@@13 |source#0@@11| |v#3@@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |newPaths#0@0|) |v#3@@0|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |801|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |newPaths#0@0|) |v#3@@0|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |newPaths#0@0|) |v#3@@0|))
))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |newPaths#0@0|) |x#2@0|)) (=> (and (and (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |newPaths#0@0|) (|Set#IsMember| (|Map#Domain| |newPaths#0@0|) |x#2@0|)) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#2@0| |newPaths#0@0|)) (and (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#2@0| |newPaths#0@0|) (|#_module.List.Cons| |v#0@@2| |pathToV#0|)) (= (ControlFlow 0 2) 1))) anon10_correct)))))))
(let ((anon7_correct  (=> (forall ((|x#1| T@U) ) (!  (=> ($IsBox |x#1| _module.BreadthFirstSearch$Vertex@@23) (=> (|Set#IsMember| (|Map#Domain| |paths#0|) |x#1|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#1| |paths#0|) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#1| |newPaths#0@0|))))
 :qid |BreadthFirstSearchdfy.248:20|
 :skolemid |800|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#1| |newPaths#0@0|))
...
)) (=> (and ($IsBox |x#2@0| _module.BreadthFirstSearch$Vertex@@23) ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@23 $Heap@0)) (and (=> (= (ControlFlow 0 6) 2) anon13_Then_correct) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct))))))
(let ((anon12_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |paths#0|) |x#0@0|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#0@0| |paths#0|) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#0@0| |newPaths#0@0|))) (= (ControlFlow 0 12) 6)) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |paths#0|) |x#0@0|) (=> (and (and ($IsAllocBox ($Box refType this@@13) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@23) $Heap@0) ($IsAllocBox |source#0@@11| _module.BreadthFirstSearch$Vertex@@23 $Heap@0)) (and ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@23 $Heap@0) ($IsAlloc MapType |paths#0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) $Heap@0))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (=> (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |paths#0|) (or (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |paths#0|) (forall ((|v#1@@2| T@U) ) (!  (=> ($IsBox |v#1@@2| _module.BreadthFirstSearch$Vertex@@23) (=> (|Set#IsMember| (|Map#Domain| |paths#0|) |v#1@@2|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@23 ($LS ($LS $LZ)) this@@13 |source#0@@11| |v#1@@2| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0|) |v#1@@2|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |794|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0|) |v#1@@2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0|) |v#1@@2|))
))))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (|Set#IsMember| (|Map#Domain| |paths#0|) |x#0@0|)) (=> (and (and (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |paths#0|) (|Set#IsMember| (|Map#Domain| |paths#0|) |x#0@0|)) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#0@0| |paths#0|)) (and (and ($IsAllocBox ($Box refType this@@13) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@23) $Heap@0) ($IsAllocBox |source#0@@11| _module.BreadthFirstSearch$Vertex@@23 $Heap@0)) (and ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@23 $Heap@0) ($IsAlloc MapType |newPaths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) $Heap@0)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (=> (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |newPaths#0@0|) (or (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |newPaths#0@0|) (forall ((|v#2@@2| T@U) ) (!  (=> ($IsBox |v#2@@2| _module.BreadthFirstSearch$Vertex@@23) (=> (|Set#IsMember| (|Map#Domain| |newPaths#0@0|) |v#2@@2|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@23 ($LS ($LS $LZ)) this@@13 |source#0@@11| |v#2@@2| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |newPaths#0@0|) |v#2@@2|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |797|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |newPaths#0@0|) |v#2@@2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |newPaths#0@0|) |v#2@@2|))
))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (|Set#IsMember| (|Map#Domain| |newPaths#0@0|) |x#0@0|)) (=> (and (and (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |newPaths#0@0|) (|Set#IsMember| (|Map#Domain| |newPaths#0@0|) |x#0@0|)) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#0@0| |newPaths#0@0|)) (and (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#0@0| |paths#0|) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |x#0@0| |newPaths#0@0|)) (= (ControlFlow 0 7) 6))) anon7_correct))))))))))
(let ((anon4_correct  (=> (forall ((|succ#1| T@U) ) (!  (=> ($IsBox |succ#1| _module.BreadthFirstSearch$Vertex@@23) (=> (|Set#IsMember| |vSuccs#0| |succ#1|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@23 ($LS $LZ) this@@13 |source#0@@11| |succ#1| (|#_module.List.Cons| |v#0@@2| |pathToV#0|))))
 :qid |BreadthFirstSearchdfy.246:21|
 :skolemid |792|
 :pattern ( (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@23 ($LS $LZ) this@@13 |source#0@@11| |succ#1| (|#_module.List.Cons| |v#0@@2| |pathToV#0|)))
 :pattern ( (|Set#IsMember| |vSuccs#0| |succ#1|))
...
)) ($HeapSuccGhost $Heap@@1 $Heap@0)) (and ($Is MapType |newPaths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23))) ($IsAlloc MapType |newPaths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) $Heap@0))) (=> (and (and (and ($IsAllocBox ($Box refType this@@13) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@23) $Heap@0) ($IsAllocBox |source#0@@11| _module.BreadthFirstSearch$Vertex@@23 $Heap@0)) (and ($IsAlloc MapType |newPaths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) $Heap@0) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |newPaths#0@0|))) (and (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |newPaths#0@0|) (|Set#Equal| (|Map#Domain| |newPaths#0@0|) (|Set#Union| (|Map#Domain| |paths#0|) |vSuccs#0|))) (and ($IsBox |x#0@0| _module.BreadthFirstSearch$Vertex@@23) ($IsAllocBox |x#0@0| _module.BreadthFirstSearch$Vertex@@23 $Heap@0)))) (and (=> (= (ControlFlow 0 13) 7) anon12_Then_correct) (=> (= (ControlFlow 0 13) 12) anon12_Else_correct))))))))
(let ((anon11_Else_correct  (=> (and (=> (|Set#IsMember| |vSuccs#0| |succ#0@0|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@23 ($LS $LZ) this@@13 |source#0@@11| |succ#0@0| (|#_module.List.Cons| |v#0@@2| |pathToV#0|))) (= (ControlFlow 0 15) 13)) anon4_correct)))
(let ((anon11_Then_correct  (=> (|Set#IsMember| |vSuccs#0| |succ#0@0|) (=> (and (and (and ($IsAllocBox ($Box refType this@@13) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@23) $Heap@@1) ($IsAllocBox |source#0@@11| _module.BreadthFirstSearch$Vertex@@23 $Heap@@1)) (and ($IsAllocBox |succ#0@0| _module.BreadthFirstSearch$Vertex@@23 $Heap@@1) (= |##p#0@0| (|#_module.List.Cons| |v#0@@2| |pathToV#0|)))) (and (and ($IsAlloc DatatypeTypeType |##p#0@0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23) $Heap@@1) (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |succ#0@0| (|#_module.List.Cons| |v#0@@2| |pathToV#0|))) (and (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@23 ($LS $LZ) this@@13 |source#0@@11| |succ#0@0| (|#_module.List.Cons| |v#0@@2| |pathToV#0|)) (= (ControlFlow 0 14) 13)))) anon4_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and ($IsAllocBox ($Box refType this@@13) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@23) $Heap@@1) ($IsAllocBox |source#0@@11| _module.BreadthFirstSearch$Vertex@@23 $Heap@@1)) (and ($IsAlloc MapType |paths#0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) $Heap@@1) (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |paths#0|))) (and (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@23 this@@13 |source#0@@11| |paths#0|) (|Set#Disjoint| |vSuccs#0| (|Map#Domain| |paths#0|))) (and ($IsBox |succ#0@0| _module.BreadthFirstSearch$Vertex@@23) ($IsAllocBox |succ#0@0| _module.BreadthFirstSearch$Vertex@@23 $Heap@@1)))) (and (=> (= (ControlFlow 0 16) 14) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@23)) ($IsAlloc refType this@@13 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@23) $Heap@@1)))) (=> (and (and (and (and ($Is SetType |vSuccs#0| (TSet _module.BreadthFirstSearch$Vertex@@23)) ($IsAlloc SetType |vSuccs#0| (TSet _module.BreadthFirstSearch$Vertex@@23) $Heap@@1)) (and ($IsBox |source#0@@11| _module.BreadthFirstSearch$Vertex@@23) ($IsAllocBox |source#0@@11| _module.BreadthFirstSearch$Vertex@@23 $Heap@@1))) (and (and ($Is MapType |paths#0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23))) ($IsAlloc MapType |paths#0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) $Heap@@1)) (and ($IsBox |v#0@@2| _module.BreadthFirstSearch$Vertex@@23) ($IsAllocBox |v#0@@2| _module.BreadthFirstSearch$Vertex@@23 $Heap@@1)))) (and (and (and ($Is DatatypeTypeType |pathToV#0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) ($IsAlloc DatatypeTypeType |pathToV#0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23) $Heap@@1)) (|$IsA#_module.List| |pathToV#0|)) (and (and ($Is MapType |newPaths#0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23))) ($IsAlloc MapType |newPaths#0| (TMap _module.BreadthFirstSearch$Vertex@@23 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@23)) $Heap@@1)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 17) 16))))) anon0_correct))))
