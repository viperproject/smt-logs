...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split62)
...
(assert (not
 ...
 :pattern ( (|Set#IsMember| |C#0@1| |x#1@@2|))
))))) (and (and (=> |$w$loop#0@0| (forall ((|x#3@@2| T@U) ) (!  (=> ($IsBox |x#3@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@1| |x#3@@2|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@2| |call8formal@newPaths#0@0|)) (+ |d#0@2| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
 ...
 :pattern ( (|Set#IsMember| |N#0@1| |x#3@@2|))
))) (=> |$w$loop#0@0| (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |C#0@1| |dest#0@@3|)))) (and (=> |$w$loop#0@0| (=> (or (not (= |d#0@2| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@2| 1) |AllVertices#0@@10|) |dest#0@@3|)))) (=> |$w$loop#0@0| (|Set#Equal| (|Set#Union| |$rhs#4_1@1| |C#0@1|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|)))))) (and (and (and (=> |$w$loop#0@0| (|Set#Equal| |N#0@1| (|Set#Difference| (_module.BreadthFirstSearch.Successors _module.BreadthFirstSearch$Vertex@@37 this@@27 |$rhs#4_1@1| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@2| |AllVertices#0@@10|)))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|Set#Equal| |C#0@1| |Set#Empty|))) (|Set#Equal| |N#0@1| |Set#Empty|))))))))
...
)))) (|Set#Equal| (|Map#Domain| |call8formal@newPaths#0@0|) (|Set#Union| (|Map#Domain| |paths#0@0|) |newlyEncountered#4_0@1|))) (and (forall ((|x#1@@3| T@U) ) (!  (=> ($IsBox |x#1@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@3|) (and (and (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|)) (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |call8formal@newPaths#0@0|))) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |paths#0@0|) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@3| |call8formal@newPaths#0@0|)))))
...
)) (forall ((|x#1@@4| T@U) ) (!  (=> ($IsBox |x#1@@4| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@4|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@4| |paths#0@0|) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@4| |call8formal@newPaths#0@0|))))
 :qid |BreadthFirstSearchdfy.248:20|
 :skolemid |814|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@4| |call8formal@newPaths#0@0|))
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@4| |paths#0@0|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#1@@4|))
)))) (and (and (forall ((|x#3@@3| T@U) ) (!  (=> ($IsBox |x#3@@3| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@3|) (and (|$IsA#_module.List| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@3| |call8formal@newPaths#0@0|)) (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@3| |call8formal@newPaths#0@0|))))
...
)) (forall ((|x#3@@4| T@U) ) (!  (=> ($IsBox |x#3@@4| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@4|) (|_module.List#Equal| (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@4| |call8formal@newPaths#0@0|) (|#_module.List.Cons| |v#4_0@1| |pathToV#4_0@1|))))
 :qid |BreadthFirstSearchdfy.250:20|
 :skolemid |816|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@4| |call8formal@newPaths#0@0|))
 :pattern ( (|Set#IsMember| |newlyEncountered#4_0@1| |x#3@@4|))
...
)))))))) (and (and (and (=> |$w$loop#0@0| (and (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (and (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |paths#0@0|) (forall ((|v#6@@2| T@U) ) (!  (=> ($IsBox |v#6@@2| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#6@@2|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |v#6@@2| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#6@@2|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |663|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |paths#0@0|) |v#6@@2|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |paths#0@0|) |v#6@@2|))
))))) (=> |$w$loop#0@0| (|Set#Equal| |V#0@0| (|Map#Domain| |paths#0@0|)))) (and (=> |$w$loop#0@0| (forall ((|x#1@@6| T@U) ) (!  (=> ($IsBox |x#1@@6| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@6|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@6| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@6| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |669|
...
))) (=> |$w$loop#0@0| (forall ((|x#1@@7| T@U) ) (!  (=> ($IsBox |x#1@@7| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@7|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@7| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |670|
...
))))) (and (and (=> |$w$loop#0@0| (forall ((|x#1@@8| T@U) ) (!  (=> ($IsBox |x#1@@8| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@8|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@8| |paths#0@0|)) |d#0@1|)))
 :qid |BreadthFirstSearchdfy.77:24|
 :skolemid |671|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@8| |paths#0@0|))
 :pattern ( (|Set#IsMember| |C#0@0| |x#1@@8|))
))) (=> |$w$loop#0@0| (forall ((|x#3@@6| T@U) ) (!  (=> ($IsBox |x#3@@6| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@6|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@6| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@6| |paths#0@0|)))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |677|
...
)))) (and (=> |$w$loop#0@0| (forall ((|x#3@@7| T@U) ) (!  (=> ($IsBox |x#3@@7| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@7|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@7| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |678|
...
))) (=> |$w$loop#0@0| (forall ((|x#3@@8| T@U) ) (!  (=> ($IsBox |x#3@@8| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |N#0@0| |x#3@@8|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@8| |paths#0@0|)) (+ |d#0@1| 1))))
 :qid |BreadthFirstSearchdfy.78:24|
 :skolemid |679|
 :pattern ( (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@8| |paths#0@0|))
 :pattern ( (|Set#IsMember| |N#0@0| |x#3@@8|))
