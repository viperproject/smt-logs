...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split102)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon9_correct  (=> (and (and (=> (or (not (= |d#0@0| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| (- |d#0@0| 1) |AllVertices#0@@10|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |d#0@0| 0)) (not true))) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| (- |d#0@0| 1) |AllVertices#0@@10|) |dest#0|)))))
(let ((anon122_Else_correct  (=> (and (= |d#0@0| 0) (= (ControlFlow 0 4) 2)) anon9_correct)))
(let ((anon122_Then_correct  (=> (or (not (= |d#0@0| 0)) (not true)) (=> (and (and (and ($IsAllocBox ($Box refType this@@15) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@25) $Heap@1) ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@25 $Heap@1)) (and ($Is intType (int_2_U (- |d#0@0| 1)) Tclass._System.nat) (= |##n#2@0| (- |d#0@0| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#2@0|) Tclass._System.nat $Heap@1) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@25) $Heap@1)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| (- |d#0@0| 1) |AllVertices#0@@10|) (= (ControlFlow 0 3) 2)))) anon9_correct))))
(let ((anon6_correct  (=> (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@25 this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@25 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@15 |source#0@@5| |d#0@0| |AllVertices#0@@10|) |dest#0|) (|Set#IsMember| |$rhs#1@0| |dest#0|))) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@@2 $Heap@1) reveal__module.BreadthFirstSearch.R)) (and (=> (= (ControlFlow 0 5) 3) anon122_Then_correct) (=> (= (ControlFlow 0 5) 4) anon122_Else_correct))))))
