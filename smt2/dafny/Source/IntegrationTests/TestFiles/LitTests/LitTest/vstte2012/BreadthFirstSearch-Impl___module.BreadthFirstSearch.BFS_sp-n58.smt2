...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split55)
...
))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))) (|Set#Equal| |$rhs#4_2@1| (|Map#Domain| |call8formal@newPaths#0@0|)))))))
