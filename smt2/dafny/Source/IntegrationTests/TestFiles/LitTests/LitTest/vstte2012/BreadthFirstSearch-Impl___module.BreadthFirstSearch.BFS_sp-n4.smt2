...
(assert (forall ((_module.BreadthFirstSearch$Vertex@@0 T@U) ($o T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@0) $h@@2)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |603|
 :pattern ( ($IsAlloc refType $o (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@0) $h@@2))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module.BreadthFirstSearch$Vertex@@2 T@U) (this@@0 T@U) (|S#0@@0| T@U) ) (!  (=> (or (|_module.BreadthFirstSearch.IsClosed#canCall| _module.BreadthFirstSearch$Vertex@@2 (Lit refType this@@0) (Lit SetType |S#0@@0|)) (and (< 1 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@2))) ($Is SetType |S#0@@0| (TSet _module.BreadthFirstSearch$Vertex@@2))))) (and (forall ((|v#2| T@U) ) (!  (=> ($IsBox |v#2| _module.BreadthFirstSearch$Vertex@@2) (=> (|Set#IsMember| (Lit SetType |S#0@@0|) |v#2|) (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@2 (Lit refType this@@0) |v#2|)))
 :qid |BreadthFirstSearchdfy.21:12|
 :skolemid |628|
 :pattern ( (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@2 this@@0 |v#2|))
 :pattern ( (|Set#IsMember| |S#0@@0| |v#2|))
)) (= (_module.BreadthFirstSearch.IsClosed _module.BreadthFirstSearch$Vertex@@2 (Lit refType this@@0) (Lit SetType |S#0@@0|)) (forall ((|v#2@@0| T@U) ) (!  (=> ($IsBox |v#2@@0| _module.BreadthFirstSearch$Vertex@@2) (=> (|Set#IsMember| (Lit SetType |S#0@@0|) |v#2@@0|) (|Set#Subset| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@2 (Lit refType this@@0) |v#2@@0|) |S#0@@0|)))
 :qid |BreadthFirstSearchdfy.21:12|
 :skolemid |627|
 :pattern ( (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@2 this@@0 |v#2@@0|))
 :pattern ( (|Set#IsMember| |S#0@@0| |v#2@@0|))
)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |629|
 :pattern ( (_module.BreadthFirstSearch.IsClosed _module.BreadthFirstSearch$Vertex@@2 (Lit refType this@@0) (Lit SetType |S#0@@0|)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.BreadthFirstSearch$Vertex@@3 T@U) (this@@1 T@U) (|x#0@@1| T@U) ) (!  (=> (or (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@3 this@@1 |x#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@3))) ($IsBox |x#0@@1| _module.BreadthFirstSearch$Vertex@@3)))) ($Is SetType (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@3 this@@1 |x#0@@1|) (TSet _module.BreadthFirstSearch$Vertex@@3)))
 :qid |unknown.0:0|
 :skolemid |607|
 :pattern ( (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@3 this@@1 |x#0@@1|))
))))
(assert (forall ((_module.BreadthFirstSearch$Vertex@@4 T@U) (|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@4))  (and ($Is refType |c#0@@0| (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@4)) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |833|
 :pattern ( ($Is refType |c#0@@0| (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@4)))
 :pattern ( ($Is refType |c#0@@0| (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@4)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (_module.BreadthFirstSearch$Vertex@@8 T@U) (this@@2 T@U) (|x#0@@2| T@U) ) (!  (=> (and (or (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@8 this@@2 |x#0@@2|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@2 null)) (not true)) ($IsAlloc refType this@@2 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@8) $Heap)) (and ($IsBox |x#0@@2| _module.BreadthFirstSearch$Vertex@@8) ($IsAllocBox |x#0@@2| _module.BreadthFirstSearch$Vertex@@8 $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@8 this@@2 |x#0@@2|) (TSet _module.BreadthFirstSearch$Vertex@@8) $Heap))
 :qid |BreadthFirstSearchdfy.8:12|
 :skolemid |608|
 :pattern ( ($IsAlloc SetType (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@8 this@@2 |x#0@@2|) (TSet _module.BreadthFirstSearch$Vertex@@8) $Heap))
))))
...
(assert (forall ((_module.BreadthFirstSearch$Vertex@@9 T@U) ) (! (= (Tclass._module.BreadthFirstSearch?_0 (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@9)) _module.BreadthFirstSearch$Vertex@@9)
 :qid |unknown.0:0|
 :skolemid |600|
 :pattern ( (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@9))
)))
(assert (forall ((_module.BreadthFirstSearch$Vertex@@10 T@U) ) (! (= (Tclass._module.BreadthFirstSearch_0 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@10)) _module.BreadthFirstSearch$Vertex@@10)
 :qid |unknown.0:0|
 :skolemid |605|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module.BreadthFirstSearch$Vertex@@11 T@U) (this@@3 T@U) (|S#0@@1| T@U) ) (!  (=> (or (|_module.BreadthFirstSearch.IsClosed#canCall| _module.BreadthFirstSearch$Vertex@@11 this@@3 (Lit SetType |S#0@@1|)) (and (< 1 $FunctionContextHeight) (and (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@11))) ($Is SetType |S#0@@1| (TSet _module.BreadthFirstSearch$Vertex@@11))))) (and (forall ((|v#1| T@U) ) (!  (=> ($IsBox |v#1| _module.BreadthFirstSearch$Vertex@@11) (=> (|Set#IsMember| (Lit SetType |S#0@@1|) |v#1|) (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@11 this@@3 |v#1|)))
 :qid |BreadthFirstSearchdfy.21:12|
 :skolemid |625|
 :pattern ( (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@11 this@@3 |v#1|))
 :pattern ( (|Set#IsMember| |S#0@@1| |v#1|))
)) (= (_module.BreadthFirstSearch.IsClosed _module.BreadthFirstSearch$Vertex@@11 this@@3 (Lit SetType |S#0@@1|)) (forall ((|v#1@@0| T@U) ) (!  (=> ($IsBox |v#1@@0| _module.BreadthFirstSearch$Vertex@@11) (=> (|Set#IsMember| (Lit SetType |S#0@@1|) |v#1@@0|) (|Set#Subset| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@11 this@@3 |v#1@@0|) |S#0@@1|)))
 :qid |BreadthFirstSearchdfy.21:12|
 :skolemid |624|
 :pattern ( (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@11 this@@3 |v#1@@0|))
 :pattern ( (|Set#IsMember| |S#0@@1| |v#1@@0|))
)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |626|
 :pattern ( (_module.BreadthFirstSearch.IsClosed _module.BreadthFirstSearch$Vertex@@11 this@@3 (Lit SetType |S#0@@1|)))
))))
...
(assert (forall ((_module.List$T@@3 T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass._module.List _module.List$T@@3)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@6)) bx@@6) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@6) (Tclass._module.List _module.List$T@@3))))
 :qid |unknown.0:0|
 :skolemid |585|
 :pattern ( ($IsBox bx@@6 (Tclass._module.List _module.List$T@@3)))
)))
(assert (forall ((_module.BreadthFirstSearch$Vertex@@12 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@12)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@12))))
 :qid |unknown.0:0|
 :skolemid |601|
 :pattern ( ($IsBox bx@@7 (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@12)))
)))
(assert (forall ((_module.BreadthFirstSearch$Vertex@@13 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@13)) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@13))))
 :qid |unknown.0:0|
 :skolemid |606|
 :pattern ( ($IsBox bx@@8 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@13)))
)))
...
(declare-fun _module.BreadthFirstSearch$Vertex@@14 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc refType this@@4 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)))) (=> (and (and (and ($IsBox |source#0| _module.BreadthFirstSearch$Vertex@@14) ($IsAllocBox |source#0| _module.BreadthFirstSearch$Vertex@@14 $Heap@@0)) (and ($IsBox |dest#0| _module.BreadthFirstSearch$Vertex@@14) ($IsAllocBox |dest#0| _module.BreadthFirstSearch$Vertex@@14 $Heap@@0))) (and (and ($Is SetType |AllVertices#0| (TSet _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc SetType |AllVertices#0| (TSet _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)) (and ($Is DatatypeTypeType |path#0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc DatatypeTypeType |path#0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)))) (=> (and (and (and (and (and ($Is SetType |V#0| (TSet _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc SetType |V#0| (TSet _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)) true) (and (and ($Is SetType |C#0| (TSet _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc SetType |C#0| (TSet _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)) true)) (and (and (and ($Is SetType |N#0| (TSet _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc SetType |N#0| (TSet _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)) true) (and (and ($Is SetType |Processed#0| (TSet _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc SetType |Processed#0| (TSet _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)) true))) (and (and (and (and ($Is MapType |paths#0| (TMap _module.BreadthFirstSearch$Vertex@@14 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@14))) ($IsAlloc MapType |paths#0| (TMap _module.BreadthFirstSearch$Vertex@@14 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@14)) $Heap@@0)) true) (and (=> |defass#v#4_0| (and ($IsBox |v#4_0| _module.BreadthFirstSearch$Vertex@@14) ($IsAllocBox |v#4_0| _module.BreadthFirstSearch$Vertex@@14 $Heap@@0))) true)) (and (and ($Is DatatypeTypeType |pathToV#4_0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc DatatypeTypeType |pathToV#4_0| (Tclass._module.List _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)) true))) (=> (and (and (and (and (and (and ($Is SetType |newlyEncountered#4_0| (TSet _module.BreadthFirstSearch$Vertex@@14)) ($IsAlloc SetType |newlyEncountered#4_0| (TSet _module.BreadthFirstSearch$Vertex@@14) $Heap@@0)) true) (= 5 $FunctionContextHeight)) (and (|Set#IsMember| |AllVertices#0| |source#0|) (|Set#IsMember| |AllVertices#0| |dest#0|))) (and (and (|_module.BreadthFirstSearch.IsClosed#canCall| _module.BreadthFirstSearch$Vertex@@14 this@@4 |AllVertices#0|) (and (_module.BreadthFirstSearch.IsClosed _module.BreadthFirstSearch$Vertex@@14 this@@4 |AllVertices#0|) (forall ((|v#3| T@U) ) (!  (=> ($IsBox |v#3| _module.BreadthFirstSearch$Vertex@@14) (=> (|Set#IsMember| |AllVertices#0| |v#3|) (|Set#Subset| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@14 this@@4 |v#3|) |AllVertices#0|)))
 :qid |BreadthFirstSearchdfy.21:12|
 :skolemid |649|
 :pattern ( (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@14 this@@4 |v#3|))
 :pattern ( (|Set#IsMember| |AllVertices#0| |v#3|))
)))) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)))) (and (and (and (and (= |path#0@0| (Lit DatatypeTypeType |#_module.List.Nil|)) (= |$rhs#0@0| (|Set#UnionOne| |Set#Empty| |source#0|))) (and (= |$rhs#1@0| (|Set#UnionOne| |Set#Empty| |source#0|)) (= |$rhs#2@0| (Lit SetType |Set#Empty|)))) (and (and (= |$rhs#3@0| (Lit SetType |Set#Empty|)) (= |$rhs#4@0| (|Map#Build| |Map#Empty| |source#0| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))))) (and (|Set#Equal| (|Map#Domain| |$rhs#4@0|) (|Set#UnionOne| |Set#Empty| |source#0|)) (= |d#0@0| (LitInt 0))))) (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@0 $Heap@0)) (and (and reveal__module.BreadthFirstSearch.R ($IsAllocBox ($Box refType this@@4) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@14) $Heap@0)) (and ($IsAllocBox |source#0| _module.BreadthFirstSearch$Vertex@@14 $Heap@0) (= (ControlFlow 0 2) (- 0 1))))))) ($Is intType (int_2_U |d#0@0|) Tclass._System.nat)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
