...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split96)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((anon31_correct  (=> (and (forall ((|x#1@@0| T@U) ) (!  (=> ($IsBox |x#1@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |C#0@0| |x#1@@0|) (and (|_module.BreadthFirstSearch.Find#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|) (|_module.__default.length#canCall| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |paths#0@0|)))))
...
))) (=> (and (and (and ($IsBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and (|Set#IsMember| |N#0@0| |x#2@0|) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@4))) (and (and ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@4) ($IsAllocBox |x#2@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@4)) (and ($IsAlloc MapType |paths#0@0| (TMap _module.BreadthFirstSearch$Vertex@@37 (Tclass._module.List _module.BreadthFirstSearch$Vertex@@37)) $Heap@4) (= (ControlFlow 0 2) (- 0 1))))) (|Set#IsMember| (|Map#Domain| |paths#0@0|) |x#2@0|)))))
