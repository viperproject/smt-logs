...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.build__rec_split10)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon29_Else_correct  (=> (not (or (|Seq#Equal| |s#0@@3| |Seq#Empty|) (< (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (=> (and (and (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@3|))) (or (not (= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)) (not true))) (and (and (= |##d#8@0| (+ |d#0@@8| 1)) ($IsAlloc intType (int_2_U |##d#8@0|) TInt $Heap)) (and ($IsAlloc SeqType |s#0@@3| (TSeq TInt) $Heap) (or (<= 0 (|Seq#Length| |s#0@@3|)) (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)))))) (=> (and (and (and (and (or (or (<= 0 (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (< (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|))) (= (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |##d#8@0|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)))) (or (< (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)) (and (= (|Seq#Length| |s#0@@3|) (|Seq#Length| |s#0@@3|)) (< (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |##d#8@0|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)))))) (and (|_module.__default.build__rec#canCall| (+ |d#0@@8| 1) |s#0@@3|) (= |let#0#0#0| (_module.__default.build__rec ($LS $LZ) (+ |d#0@@8| 1) |s#0@@3|)))) (and (and (|_module.__default.build__rec#canCall| (+ |d#0@@8| 1) |s#0@@3|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Result)) (and (= |left#Z#0@0| |let#0#0#0|) (not (_module.Result.Fail_q |left#Z#0@0|))))) (and (and (and (= |##d#9@0| (+ |d#0@@8| 1)) ($IsAlloc intType (int_2_U |##d#9@0|) TInt $Heap)) (and (_module.Result.Res_q |left#Z#0@0|) (= |##s#8@0| (_module.Result.sOut |left#Z#0@0|)))) (and (and ($IsAlloc SeqType |##s#8@0| (TSeq TInt) $Heap) (or (<= 0 (|Seq#Length| |s#0@@3|)) (= (|Seq#Length| |##s#8@0|) (|Seq#Length| |s#0@@3|)))) (and (or (or (<= 0 (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))) (< (|Seq#Length| |##s#8@0|) (|Seq#Length| |s#0@@3|))) (= (ite (|Seq#Equal| |##s#8@0| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |##s#8@0| (LitInt 0)))) |##d#9@0|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|)))) (= (ControlFlow 0 2) (- 0 1)))))) (or (< (|Seq#Length| |##s#8@0|) (|Seq#Length| |s#0@@3|)) (and (= (|Seq#Length| |##s#8@0|) (|Seq#Length| |s#0@@3|)) (< (ite (|Seq#Equal| |##s#8@0| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |##s#8@0| (LitInt 0)))) |##d#9@0|)) (ite (|Seq#Equal| |s#0@@3| |Seq#Empty|) 0 (- (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| (LitInt 0)))) |d#0@@8|))))))))))
