...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split104)
...
))) (and (= $Heap@18 $Heap@4) (= |d#0@4| |d#0@1|)))) (and (and (and (= |path#0@1| |pathToV#4_0@1|) (= (ControlFlow 0 2) (- 0 1))) (<= (LitInt 0) |d#0@4|)) (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|))) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (_module.List.Nil_q |path#0@1|) (= |source#0@@17| |dest#0@@3|)))))))
