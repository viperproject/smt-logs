...
(assert (distinct TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.List Tagclass._module.BreadthFirstSearch? Tagclass._module.BreadthFirstSearch |##_module.List.Nil| |tytagFamily$_tuple#2| tytagFamily$List tytagFamily$BreadthFirstSearch)
)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.BreadthFirstSearch$Vertex@@3 T@U) (this@@1 T@U) (|x#0| T@U) ) (!  (=> (or (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@3 this@@1 |x#0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@3))) ($IsBox |x#0| _module.BreadthFirstSearch$Vertex@@3)))) ($Is SetType (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@3 this@@1 |x#0|) (TSet _module.BreadthFirstSearch$Vertex@@3)))
 :qid |unknown.0:0|
 :skolemid |607|
 :pattern ( (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@3 this@@1 |x#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (_module.BreadthFirstSearch$Vertex@@8 T@U) (this@@2 T@U) (|x#0@@0| T@U) ) (!  (=> (and (or (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@8 this@@2 |x#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@2 null)) (not true)) ($IsAlloc refType this@@2 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@8) $Heap)) (and ($IsBox |x#0@@0| _module.BreadthFirstSearch$Vertex@@8) ($IsAllocBox |x#0@@0| _module.BreadthFirstSearch$Vertex@@8 $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@8 this@@2 |x#0@@0|) (TSet _module.BreadthFirstSearch$Vertex@@8) $Heap))
 :qid |BreadthFirstSearchdfy.8:12|
 :skolemid |608|
 :pattern ( ($IsAlloc SetType (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@8 this@@2 |x#0@@0|) (TSet _module.BreadthFirstSearch$Vertex@@8) $Heap))
))))
...
(assert (forall ((_module.List$T@@3 T@U) (bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 (Tclass._module.List _module.List$T@@3)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@5)) bx@@5) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@5) (Tclass._module.List _module.List$T@@3))))
 :qid |unknown.0:0|
 :skolemid |585|
 :pattern ( ($IsBox bx@@5 (Tclass._module.List _module.List$T@@3)))
)))
(assert (forall ((_module.BreadthFirstSearch$Vertex@@12 T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@12)) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@12))))
 :qid |unknown.0:0|
 :skolemid |601|
 :pattern ( ($IsBox bx@@6 (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@12)))
)))
(assert (forall ((_module.BreadthFirstSearch$Vertex@@13 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@13)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@13))))
 :qid |unknown.0:0|
 :skolemid |606|
 :pattern ( ($IsBox bx@@7 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@13)))
)))
...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split0)
...
)))))) (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (= |path#0@0| (Lit DatatypeTypeType |#_module.List.Nil|))) (and (= |$rhs#0@0| (|Set#UnionOne| |Set#Empty| |source#0|)) (= |$rhs#1@0| (|Set#UnionOne| |Set#Empty| |source#0|)))) (and (and (= |$rhs#2@0| (Lit SetType |Set#Empty|)) (= |$rhs#3@0| (Lit SetType |Set#Empty|))) (and (= |$rhs#4@0| (|Map#Build| |Map#Empty| |source#0| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)))) (= (ControlFlow 0 2) (- 0 1))))))) (|Set#Equal| (|Map#Domain| |$rhs#4@0|) (|Set#UnionOne| |Set#Empty| |source#0|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
