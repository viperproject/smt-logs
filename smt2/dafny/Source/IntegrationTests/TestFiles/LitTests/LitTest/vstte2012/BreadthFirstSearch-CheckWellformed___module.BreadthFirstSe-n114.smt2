...
(set-info :boogie-vc-id CheckWellformed$$_module.BreadthFirstSearch.R)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (or (not (= |n#0@@5| (LitInt 0))) (not true)) (=> (and ($IsAllocBox ($Box refType this@@12) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@22) $Heap@@2) ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@22 $Heap@@2)) (and (=> (= (ControlFlow 0 4) (- 0 9)) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat) (=> (= |##n#0@0| (- |n#0@@5| 1)) (=> (and ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@@2) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@22) $Heap@@2)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (<= 0 |n#0@@5|) (= |##n#0@0| |n#0@@5|))) (=> (or (<= 0 |n#0@@5|) (= |##n#0@0| |n#0@@5|)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (< |##n#0@0| |n#0@@5|) (and (= |##n#0@0| |n#0@@5|) (and (|Set#Subset| |AllVertices#0@@10| |AllVertices#0@@10|) (not (|Set#Subset| |AllVertices#0@@10| |AllVertices#0@@10|)))))) (=> (or (< |##n#0@0| |n#0@@5|) (and (= |##n#0@0| |n#0@@5|) (and (|Set#Subset| |AllVertices#0@@10| |AllVertices#0@@10|) (not (|Set#Subset| |AllVertices#0@@10| |AllVertices#0@@10|))))) (=> (and (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@22 this@@12 |source#0@@5| (- |n#0@@5| 1) |AllVertices#0@@10|) ($IsAllocBox ($Box refType this@@12) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@22) $Heap@@2)) (and ($IsAllocBox ($Box refType this@@12) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@22) $Heap@@2) ($IsAllocBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@22 $Heap@@2))) (and (=> (= (ControlFlow 0 4) (- 0 6)) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat) (=> (= |##n#1@0| (- |n#0@@5| 1)) (=> (and ($IsAlloc intType (int_2_U |##n#1@0|) Tclass._System.nat $Heap@@2) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@22) $Heap@@2)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (<= 0 |n#0@@5|) (= |##n#1@0| |n#0@@5|))) (=> (or (<= 0 |n#0@@5|) (= |##n#1@0| |n#0@@5|)) (=> (= (ControlFlow 0 4) (- 0 3)) (or (< |##n#1@0| |n#0@@5|) (and (= |##n#1@0| |n#0@@5|) (and (|Set#Subset| |AllVertices#0@@10| |AllVertices#0@@10|) (not (|Set#Subset| |AllVertices#0@@10| |AllVertices#0@@10|)))))))))))))))))))))))))
(let ((anon8_Then_correct true))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@22)) ($IsAlloc refType this@@12 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@22) $Heap@@2))) ($IsBox |source#0@@5| _module.BreadthFirstSearch$Vertex@@22)) (and (and (<= (LitInt 0) |n#0@@5|) ($Is SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@22))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct))))
