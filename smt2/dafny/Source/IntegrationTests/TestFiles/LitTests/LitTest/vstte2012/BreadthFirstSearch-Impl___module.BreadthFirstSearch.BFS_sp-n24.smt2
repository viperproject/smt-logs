...
(assert (forall ((_module.BreadthFirstSearch$Vertex@@32 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@32)) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@32))))
 :qid |unknown.0:0|
 :skolemid |601|
 :pattern ( ($IsBox bx@@8 (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@32)))
)))
(assert (forall ((_module.BreadthFirstSearch$Vertex@@33 T@U) (bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@33)) (and (= ($Box refType ($Unbox refType bx@@9)) bx@@9) ($Is refType ($Unbox refType bx@@9) (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@33))))
 :qid |unknown.0:0|
 :skolemid |606|
 :pattern ( ($IsBox bx@@9 (Tclass._module.BreadthFirstSearch _module.BreadthFirstSearch$Vertex@@33)))
)))
...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split21)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon12_correct  (=> (and (=> (or (not (= |d#0@0| 0)) (not true)) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|)) (=> (or (not (= |d#0@0| 0)) (not true)) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|) |dest#0@@3|)))) (=> (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@@3)) (and ($Is intType (int_2_U |d#0@0|) Tclass._System.nat) ($IsAlloc intType (int_2_U |d#0@0|) Tclass._System.nat $Heap@@3))) (=> (and (and (and ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) (|Set#Equal| (|Set#Union| |$rhs#3@0| |$rhs#1@0|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|)))) (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAlloc SetType |$rhs#3@0| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3)) (and ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) (|_module.BreadthFirstSearch.Successors#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |$rhs#3@0| |AllVertices#0@@10|)))) (=> (and (and (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@@3)) (and ($Is intType (int_2_U |d#0@0|) Tclass._System.nat) ($IsAlloc intType (int_2_U |d#0@0|) Tclass._System.nat $Heap@@3))) (and (and ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@@3) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|)) (and (|_module.BreadthFirstSearch.Successors#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |$rhs#3@0| |AllVertices#0@@10|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|)))) (and (and (and (|Set#Equal| |$rhs#2@0| (|Set#Difference| (_module.BreadthFirstSearch.Successors _module.BreadthFirstSearch$Vertex@@37 this@@27 |$rhs#3@0| |AllVertices#0@@10|) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (= |$decr_init$loop#00@0| (|Set#Difference| |AllVertices#0@@10| |$rhs#3@0|)) (=> |$w$loop#0@0| (|Set#Subset| |$rhs#0@0| |AllVertices#0@@10|)))) (and (and (=> |$w$loop#0@0| (|Set#Subset| |$rhs#3@0| |AllVertices#0@@10|)) (=> |$w$loop#0@0| (|Set#Subset| |$rhs#1@0| |AllVertices#0@@10|))) (and (=> |$w$loop#0@0| (|Set#Subset| |$rhs#2@0| |AllVertices#0@@10|)) (=> |$w$loop#0@0| (|Set#IsMember| |$rhs#0@0| |source#0@@17|)))))) (and (and (and (and (=> |$w$loop#0@0| (|Set#Equal| |$rhs#0@0| (|Set#Union| (|Set#Union| |$rhs#3@0| |$rhs#1@0|) |$rhs#2@0|))) (=> |$w$loop#0@0| (|Set#Disjoint| |$rhs#3@0| |$rhs#1@0|))) (and (=> |$w$loop#0@0| (|Set#Disjoint| |$rhs#3@0| |$rhs#1@0|)) (=> |$w$loop#0@0| (|Set#Disjoint| (|Set#Union| |$rhs#3@0| |$rhs#1@0|) |$rhs#2@0|)))) (and (and (=> |$w$loop#0@0| (=> (|_module.BreadthFirstSearch.ValidMap#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |$rhs#4@0|) (or (_module.BreadthFirstSearch.ValidMap _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |$rhs#4@0|) (forall ((|v#6| T@U) ) (!  (=> ($IsBox |v#6| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| (|Map#Domain| |$rhs#4@0|) |v#6|) (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#6| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |$rhs#4@0|) |v#6|)))))
 :qid |BreadthFirstSearchdfy.231:12|
 :skolemid |661|
...
))))) (=> |$w$loop#0@0| (|Set#Equal| |$rhs#0@0| (|Map#Domain| |$rhs#4@0|)))) (and (=> |$w$loop#0@0| (forall ((|x#1@@0| T@U) ) (!  (=> ($IsBox |x#1@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |$rhs#1@0| |x#1@@0|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#1@@0| |$rhs#4@0|)) |d#0@0|)))
...
))) (=> |$w$loop#0@0| (forall ((|x#3@@0| T@U) ) (!  (=> ($IsBox |x#3@@0| _module.BreadthFirstSearch$Vertex@@37) (=> (|Set#IsMember| |$rhs#2@0| |x#3@@0|) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) (_module.BreadthFirstSearch.Find _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |x#3@@0| |$rhs#4@0|)) (+ |d#0@0| 1))))
...
)))))) (and (and (and (=> |$w$loop#0@0| (=> (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| |d#0@0| |AllVertices#0@@10|) |dest#0@@3|) (|Set#IsMember| |$rhs#1@0| |dest#0@@3|))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (or (not (= |d#0@0| 0)) (not true))))) (not (|Set#IsMember| (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (- |d#0@0| 1) |AllVertices#0@@10|) |dest#0@@3|))))))))
