...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split107)
...
)) (= $Heap@18 $Heap@4)))) (and (and (and (= |d#0@4| |d#0@1|) (= |path#0@1| |pathToV#4_0@1|)) (and (=> (<= (LitInt 0) |d#0@4|) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (_module.List.Nil_q |path#0@1|) (= |source#0@@17| |dest#0@@3|))))) (=> (<= (LitInt 0) |d#0@4|) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (not (_module.List.Nil_q |path#0@1|)) (let ((|v#4@@0| (_module.List.head |path#0@1|)))
(|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4@@0|) |dest#0@@3|)))))))) (and (and (=> (<= (LitInt 0) |d#0@4|) (=> (|_module.BreadthFirstSearch.IsPath#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (or (_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS $LZ) this@@27 |source#0@@17| |dest#0@@3| |path#0@1|) (=> (not (_module.List.Nil_q |path#0@1|)) (let ((|tail#2@@1| (_module.List.tail |path#0@1|)))
(let ((|v#4@@1| (_module.List.head |path#0@1|)))
(_module.BreadthFirstSearch.IsPath _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) this@@27 |source#0@@17| |v#4@@1| |tail#2@@1|))))))) (= (ControlFlow 0 2) (- 0 1))) (<= (LitInt 0) |d#0@4|)))) (= (_module.__default.length _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) |path#0@1|) |d#0@4|)))))
