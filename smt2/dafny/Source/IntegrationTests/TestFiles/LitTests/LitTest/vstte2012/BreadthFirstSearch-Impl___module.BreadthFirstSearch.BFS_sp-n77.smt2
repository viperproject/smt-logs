...
(let ((anon45_correct  (=> (exists ((|$as#v4_0#4_0| T@U) )  (and ($IsBox |$as#v4_0#4_0| _module.BreadthFirstSearch$Vertex@@37) (|Set#IsMember| |C#0@0| |$as#v4_0#4_0|))) (=> (and (=> true (and ($IsBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (|Set#IsMember| |C#0@0| |v#4_0@1|)) (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (= $Heap@4 $Heap@5) reveal__module.BreadthFirstSearch.R)) (and (=> (= (ControlFlow 0 14) 12) anon143_Then_correct) (=> (= (ControlFlow 0 14) 13) anon143_Else_correct)))))))
