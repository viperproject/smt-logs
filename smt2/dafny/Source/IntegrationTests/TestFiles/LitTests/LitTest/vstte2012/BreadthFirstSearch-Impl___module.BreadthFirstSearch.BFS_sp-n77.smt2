...
(declare-fun |##n#4_0@0| () Int)
(declare-fun |w#4_0@0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.BreadthFirstSearch.BFS_split74)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon55_correct  (=> (and (and (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (=> (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (and (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))) (= (ControlFlow 0 2) (- 0 1))) (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)))) (|Set#Equal| (|Set#Union| (|Set#Union| |Processed#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)) (|Set#Union| |N#0@0| (|Set#FromBoogieMap| (|lambda#4| _module.BreadthFirstSearch$Vertex@@37 (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |V#0@0|)))) (_module.BreadthFirstSearch.R _module.BreadthFirstSearch$Vertex@@37 ($LS ($LS $LZ)) reveal__module.BreadthFirstSearch.R this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|)))))
(let ((anon54_correct  (=> (and (and (and ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@5) ($IsAllocBox |source#0@@17| _module.BreadthFirstSearch$Vertex@@37 $Heap@5)) (and ($Is intType (int_2_U (+ |d#0@1| 1)) Tclass._System.nat) (= |##n#4_0@0| (+ |d#0@1| 1)))) (and (and ($IsAlloc intType (int_2_U |##n#4_0@0|) Tclass._System.nat $Heap@5) ($IsAlloc SetType |AllVertices#0@@10| (TSet _module.BreadthFirstSearch$Vertex@@37) $Heap@5)) (and (|_module.BreadthFirstSearch.R#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |source#0@@17| (+ |d#0@1| 1) |AllVertices#0@@10|) (= (ControlFlow 0 4) 2)))) anon55_correct)))
(let ((anon147_Else_correct  (=> (and (not (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_0@0|) (not (|Set#IsMember| |V#0@0| |w#4_0@0|)))) (= (ControlFlow 0 7) 4)) anon54_correct)))
(let ((anon147_Then_correct  (=> (and (and (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_0@0|) (not (|Set#IsMember| |V#0@0| |w#4_0@0|))) (= (ControlFlow 0 6) 4)) anon54_correct)))
(let ((anon146_Else_correct  (=> (not (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_0@0|)) (and (=> (= (ControlFlow 0 9) 6) anon147_Then_correct) (=> (= (ControlFlow 0 9) 7) anon147_Else_correct)))))
(let ((anon146_Then_correct  (=> (|Set#IsMember| (_module.BreadthFirstSearch.Succ _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|) |w#4_0@0|) (and (=> (= (ControlFlow 0 8) 6) anon147_Then_correct) (=> (= (ControlFlow 0 8) 7) anon147_Else_correct)))))
(let ((anon145_Then_correct  (=> (and (and (and ($IsBox |w#4_0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@5)) ($IsAllocBox ($Box refType this@@27) (Tclass._module.BreadthFirstSearch? _module.BreadthFirstSearch$Vertex@@37) $Heap@5)) (and ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@5) (|_module.BreadthFirstSearch.Succ#canCall| _module.BreadthFirstSearch$Vertex@@37 this@@27 |v#4_0@1|))) (and (=> (= (ControlFlow 0 10) 8) anon146_Then_correct) (=> (= (ControlFlow 0 10) 9) anon146_Else_correct)))))
(let ((anon145_Else_correct  (=> (and (not (and ($IsBox |w#4_0@0| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |w#4_0@0| _module.BreadthFirstSearch$Vertex@@37 $Heap@5))) (= (ControlFlow 0 5) 4)) anon54_correct)))
(let ((anon144_Then_correct  (=> (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|))) (and (=> (= (ControlFlow 0 11) 10) anon145_Then_correct) (=> (= (ControlFlow 0 11) 5) anon145_Else_correct)))))
(let ((anon144_Else_correct  (=> (and (not (and (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (|Set#Equal| |C#0@0| (|Set#UnionOne| |Set#Empty| |v#4_0@1|)))) (= (ControlFlow 0 3) 2)) anon55_correct)))
(let ((anon143_Else_correct  (=> (= |v#4_0@1| |dest#0@@3|) (and (=> (= (ControlFlow 0 13) 11) anon144_Then_correct) (=> (= (ControlFlow 0 13) 3) anon144_Else_correct)))))
(let ((anon143_Then_correct  (=> (or (not (= |v#4_0@1| |dest#0@@3|)) (not true)) (and (=> (= (ControlFlow 0 12) 11) anon144_Then_correct) (=> (= (ControlFlow 0 12) 3) anon144_Else_correct)))))
(let ((anon45_correct  (=> (exists ((|$as#v4_0#4_0| T@U) ) (!  (and ($IsBox |$as#v4_0#4_0| _module.BreadthFirstSearch$Vertex@@37) (|Set#IsMember| |C#0@0| |$as#v4_0#4_0|))
 ...
 :skolemid |682|
)) (=> (and (=> true (and ($IsBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37) ($IsAllocBox |v#4_0@1| _module.BreadthFirstSearch$Vertex@@37 $Heap@4))) (|Set#IsMember| |C#0@0| |v#4_0@1|)) (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (= $Heap@4 $Heap@5) reveal__module.BreadthFirstSearch.R)) (and (=> (= (ControlFlow 0 14) 12) anon143_Then_correct) (=> (= (ControlFlow 0 14) 13) anon143_Else_correct)))))))
