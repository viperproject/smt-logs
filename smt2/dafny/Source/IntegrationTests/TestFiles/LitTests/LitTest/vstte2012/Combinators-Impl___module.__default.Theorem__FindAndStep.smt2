...
(declare-fun |C#5| () T@U)
(declare-fun |u#5| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem__FindAndStep)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Term| |t#0@@23|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (and (= $Heap $Heap@0) (forall ((|$ih#t0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#t0#0| Tclass._module.Term) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#t0#0|) (DtRank |t#0@@23|))) (and (=> (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |$ih#t0#0|) |$ih#t0#0|) (_module.__default.IsTerminal |$ih#t0#0|)) (=> (not (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |$ih#t0#0|) |$ih#t0#0|)) (exists ((|C#4| T@U) (|u#4| T@U) ) (!  (and (and ($Is DatatypeTypeType |C#4| Tclass._module.Context) ($Is DatatypeTypeType |u#4| Tclass._module.Term)) (and (and (and (_module.__default.IsContext ($LS $LZ) |C#4|) (|_module.Term#Equal| |$ih#t0#0| (_module.__default.EvalExpr ($LS $LZ) |C#4| |u#4|))) (not (|_module.Term#Equal| (_module.__default.Step |u#4|) |u#4|))) (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |$ih#t0#0|) (_module.__default.EvalExpr ($LS $LZ) |C#4| (_module.__default.Step |u#4|)))))
 :qid |Combinatorsdfy.182:18|
 :skolemid |671|
 :pattern ( (_module.__default.Step |u#4|) (_module.__default.IsContext ($LS $LZ) |C#4|))
)))))
 :qid |Combinatorsdfy.173:27|
 :skolemid |672|
 :pattern ( (_module.__default.IsTerminal |$ih#t0#0|))
 :pattern ( (_module.__default.FindAndStep ($LS $LZ) |$ih#t0#0|))
))) (and ($Is DatatypeTypeType |call2formal@r#0| Tclass._module.Term) ($IsAlloc DatatypeTypeType |call2formal@r#0| Tclass._module.Term $Heap))) (and (and ($Is DatatypeTypeType |call3formal@C#0| Tclass._module.Context) ($IsAlloc DatatypeTypeType |call3formal@C#0| Tclass._module.Context $Heap)) (and ($Is DatatypeTypeType |call4formal@u#0| Tclass._module.Term) ($IsAlloc DatatypeTypeType |call4formal@u#0| Tclass._module.Term $Heap)))) (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and ($Is DatatypeTypeType |call2formal@r#0@0| Tclass._module.Term) ($IsAlloc DatatypeTypeType |call2formal@r#0@0| Tclass._module.Term $Heap@1))) (and (and ($Is DatatypeTypeType |call3formal@C#0@0| Tclass._module.Context) ($IsAlloc DatatypeTypeType |call3formal@C#0@0| Tclass._module.Context $Heap@1)) (and ($Is DatatypeTypeType |call4formal@u#0@0| Tclass._module.Term) ($IsAlloc DatatypeTypeType |call4formal@u#0@0| Tclass._module.Term $Heap@1))))) (=> (and (and (and (and (and (|$IsA#_module.Term| |call2formal@r#0@0|) (|$IsA#_module.Term| (_module.__default.FindAndStep ($LS $LZ) |t#0@@23|))) (|_module.__default.FindAndStep#canCall| |t#0@@23|)) (|_module.Term#Equal| |call2formal@r#0@0| (_module.__default.FindAndStep ($LS ($LS $LZ)) |t#0@@23|))) (and (and (and (|$IsA#_module.Term| |call2formal@r#0@0|) (|$IsA#_module.Term| |t#0@@23|)) (=> (|_module.Term#Equal| |call2formal@r#0@0| |t#0@@23|) (|_module.__default.IsTerminal#canCall| |t#0@@23|))) (=> (|_module.Term#Equal| |call2formal@r#0@0| |t#0@@23|) (and (|_module.__default.IsTerminal#canCall| |t#0@@23|) (and (_module.__default.IsTerminal |t#0@@23|) (not (exists ((|C#1@@1| T@U) (|u#1@@1| T@U) ) (!  (and (and ($Is DatatypeTypeType |C#1@@1| Tclass._module.Context) ($Is DatatypeTypeType |u#1@@1| Tclass._module.Term)) (and (and (_module.__default.IsContext ($LS $LZ) |C#1@@1|) (|_module.Term#Equal| |t#0@@23| (_module.__default.EvalExpr ($LS $LZ) |C#1@@1| |u#1@@1|))) (not (|_module.Term#Equal| (_module.__default.Step |u#1@@1|) |u#1@@1|))))
 :qid |Combinatorsdfy.168:12|
 :skolemid |676|
...
)))))))) (and (and (and (and (|$IsA#_module.Term| |call2formal@r#0@0|) (|$IsA#_module.Term| |t#0@@23|)) (=> (not (|_module.Term#Equal| |call2formal@r#0@0| |t#0@@23|)) (and (|_module.__default.IsContext#canCall| |call3formal@C#0@0|) (=> (_module.__default.IsContext ($LS $LZ) |call3formal@C#0@0|) (and (and (and (|$IsA#_module.Term| |t#0@@23|) (|$IsA#_module.Term| (_module.__default.EvalExpr ($LS $LZ) |call3formal@C#0@0| |call4formal@u#0@0|))) (|_module.__default.EvalExpr#canCall| |call3formal@C#0@0| |call4formal@u#0@0|)) (=> (|_module.Term#Equal| |t#0@@23| (_module.__default.EvalExpr ($LS $LZ) |call3formal@C#0@0| |call4formal@u#0@0|)) (and (and (and (|$IsA#_module.Term| (_module.__default.Step |call4formal@u#0@0|)) (|$IsA#_module.Term| |call4formal@u#0@0|)) (|_module.__default.Step#canCall| |call4formal@u#0@0|)) (=> (not (|_module.Term#Equal| (_module.__default.Step |call4formal@u#0@0|) |call4formal@u#0@0|)) (and (and (|$IsA#_module.Term| |call2formal@r#0@0|) (|$IsA#_module.Term| (_module.__default.EvalExpr ($LS $LZ) |call3formal@C#0@0| (_module.__default.Step |call4formal@u#0@0|)))) (and (|_module.__default.Step#canCall| |call4formal@u#0@0|) (|_module.__default.EvalExpr#canCall| |call3formal@C#0@0| (_module.__default.Step |call4formal@u#0@0|)))))))))))) (=> (not (|_module.Term#Equal| |call2formal@r#0@0| |t#0@@23|)) (and (|_module.__default.IsContext#canCall| |call3formal@C#0@0|) (and (_module.__default.IsContext ($LS $LZ) |call3formal@C#0@0|) (ite (_module.Context.Hole_q |call3formal@C#0@0|) true (ite (_module.Context.C__term_q |call3formal@C#0@0|) (let ((|D#10| (_module.Context._h0 |call3formal@C#0@0|)))
...
(let ((|v#5| (_module.Context._h2 |call3formal@C#0@0|)))
 (and (_module.__default.IsValue ($LS $LZ) |v#5|) (_module.__default.IsContext ($LS $LZ) |D#11|)))))))))) (and (and (=> (not (|_module.Term#Equal| |call2formal@r#0@0| |t#0@@23|)) (|_module.Term#Equal| |t#0@@23| (_module.__default.EvalExpr ($LS ($LS $LZ)) |call3formal@C#0@0| |call4formal@u#0@0|))) (=> (not (|_module.Term#Equal| |call2formal@r#0@0| |t#0@@23|)) (not (|_module.Term#Equal| (_module.__default.Step |call4formal@u#0@0|) |call4formal@u#0@0|)))) (and (=> (not (|_module.Term#Equal| |call2formal@r#0@0| |t#0@@23|)) (|_module.Term#Equal| |call2formal@r#0@0| (_module.__default.EvalExpr ($LS ($LS $LZ)) |call3formal@C#0@0| (_module.__default.Step |call4formal@u#0@0|)))) (= $Heap@0 $Heap@1))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |t#0@@23|) |t#0@@23|) (=> (|_module.__default.IsTerminal#canCall| |t#0@@23|) (or (_module.__default.IsTerminal |t#0@@23|) (not (exists ((|C#3| T@U) (|u#3| T@U) ) (!  (and (and ($Is DatatypeTypeType |C#3| Tclass._module.Context) ($Is DatatypeTypeType |u#3| Tclass._module.Term)) (and (and (_module.__default.IsContext ($LS ($LS $LZ)) |C#3|) (|_module.Term#Equal| |t#0@@23| (_module.__default.EvalExpr ($LS ($LS $LZ)) |C#3| |u#3|))) (not (|_module.Term#Equal| (_module.__default.Step |u#3|) |u#3|))))
 :qid |Combinatorsdfy.168:12|
 :skolemid |665|
 :pattern ( (_module.__default.Step |u#3|) (_module.__default.IsContext ($LS ($LS $LZ)) |C#3|))
 :pattern ( (_module.__default.EvalExpr ($LS ($LS $LZ)) |C#3| |u#3|))
))))))) (=> (=> (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |t#0@@23|) |t#0@@23|) (=> (|_module.__default.IsTerminal#canCall| |t#0@@23|) (or (_module.__default.IsTerminal |t#0@@23|) (not (exists ((|C#3@@0| T@U) (|u#3@@0| T@U) ) (!  (and (and ($Is DatatypeTypeType |C#3@@0| Tclass._module.Context) ($Is DatatypeTypeType |u#3@@0| Tclass._module.Term)) (and (and (_module.__default.IsContext ($LS ($LS $LZ)) |C#3@@0|) (|_module.Term#Equal| |t#0@@23| (_module.__default.EvalExpr ($LS ($LS $LZ)) |C#3@@0| |u#3@@0|))) (not (|_module.Term#Equal| (_module.__default.Step |u#3@@0|) |u#3@@0|))))
 :qid |Combinatorsdfy.168:12|
 :skolemid |665|
 :pattern ( (_module.__default.Step |u#3@@0|) (_module.__default.IsContext ($LS ($LS $LZ)) |C#3@@0|))
 :pattern ( (_module.__default.EvalExpr ($LS ($LS $LZ)) |C#3@@0| |u#3@@0|))
)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (not (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |t#0@@23|) |t#0@@23|)) (exists ((|C#1@@2| T@U) (|u#1@@2| T@U) ) (!  (and (and ($Is DatatypeTypeType |C#1@@2| Tclass._module.Context) ($Is DatatypeTypeType |u#1@@2| Tclass._module.Term)) (and (and (and (_module.__default.IsContext ($LS $LZ) |C#1@@2|) (|_module.Term#Equal| |t#0@@23| (_module.__default.EvalExpr ($LS $LZ) |C#1@@2| |u#1@@2|))) (not (|_module.Term#Equal| (_module.__default.Step |u#1@@2|) |u#1@@2|))) (|_module.Term#Equal| (_module.__default.FindAndStep ($LS $LZ) |t#0@@23|) (_module.__default.EvalExpr ($LS $LZ) |C#1@@2| (_module.__default.Step |u#1@@2|)))))
 :qid |Combinatorsdfy.182:18|
 :skolemid |669|
 :pattern ( (_module.__default.Step |u#1@@2|) (_module.__default.IsContext ($LS $LZ) |C#1@@2|))
)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |t#0@@23| Tclass._module.Term) ($IsAlloc DatatypeTypeType |t#0@@23| Tclass._module.Term $Heap)) (|$IsA#_module.Term| |t#0@@23|)) (=> (and (and (and (and ($Is DatatypeTypeType |r#0| Tclass._module.Term) ($IsAlloc DatatypeTypeType |r#0| Tclass._module.Term $Heap)) true) (and (and ($Is DatatypeTypeType |C#5| Tclass._module.Context) ($IsAlloc DatatypeTypeType |C#5| Tclass._module.Context $Heap)) true)) (and (and (and ($Is DatatypeTypeType |u#5| Tclass._module.Term) ($IsAlloc DatatypeTypeType |u#5| Tclass._module.Term $Heap)) true) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))))
