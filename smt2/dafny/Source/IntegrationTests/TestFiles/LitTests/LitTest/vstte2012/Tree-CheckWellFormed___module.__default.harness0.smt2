...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.Result) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) Tclass._module.Result)))
 :qid |unknown.0:0|
 :skolemid |540|
 :pattern ( ($IsBox bx@@2 Tclass._module.Result))
)))
(assert (forall ((s@@9 T@U) (i@@2 Int) (v@@3 T@U) ) (!  (and (=> (= i@@2 (|Seq#Length| s@@9)) (= (|Seq#Index| (|Seq#Build| s@@9 v@@3) i@@2) v@@3)) (=> (or (not (= i@@2 (|Seq#Length| s@@9))) (not true)) (= (|Seq#Index| (|Seq#Build| s@@9 v@@3) i@@2) (|Seq#Index| s@@9 i@@2))))
 :qid |DafnyPreludebpl.1148:15|
 :skolemid |225|
 :pattern ( (|Seq#Index| (|Seq#Build| s@@9 v@@3) i@@2))
)))
...
(assert (forall ((a@@2 T@U) (b@@2 T@U) ) (!  (=> (and (_module.Tree.Node_q a@@2) (_module.Tree.Node_q b@@2)) (= (|_module.Tree#Equal| a@@2 b@@2)  (and (|_module.Tree#Equal| (_module.Tree._h0 a@@2) (_module.Tree._h0 b@@2)) (|_module.Tree#Equal| (_module.Tree._h1 a@@2) (_module.Tree._h1 b@@2)))))
 :qid |unknown.0:0|
 :skolemid |610|
...
(assert (forall ((a@@3 T@U) (b@@3 T@U) ) (!  (=> (and (_module.Tree.Leaf_q a@@3) (_module.Tree.Leaf_q b@@3)) (|_module.Tree#Equal| a@@3 b@@3))
 :qid |unknown.0:0|
 :skolemid |609|
 :pattern ( (|_module.Tree#Equal| a@@3 b@@3) (_module.Tree.Leaf_q a@@3))
 :pattern ( (|_module.Tree#Equal| a@@3 b@@3) (_module.Tree.Leaf_q b@@3))
)))
...
(assert (forall ((v@@5 T@U) (t0@@0 T@U) (h@@3 T@U) ) (! (= ($IsAlloc SeqType v@@5 (TSeq t0@@0) h@@3) (forall ((i@@4 Int) ) (!  (=> (and (<= 0 i@@4) (< i@@4 (|Seq#Length| v@@5))) ($IsAllocBox (|Seq#Index| v@@5 i@@4) t0@@0 h@@3))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.harness0)
...
)) ($HeapSucc $Heap $Heap@0))) (=> (and (and (and (= |##s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2)))))) ($IsAlloc SeqType |##s#0@0| (TSeq TInt) $Heap@0)) (and (|_module.__default.build#canCall| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2)))))) (U_2_bool (Lit boolType (bool_2_U (_module.Result.Res_q (Lit DatatypeTypeType (_module.__default.build (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2))))))))))))) (and (and (= |##s#1@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2)))))) ($IsAlloc SeqType |##s#1@0| (TSeq TInt) $Heap@0)) (and (|_module.__default.build#canCall| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2)))))) (= (ControlFlow 0 2) (- 0 1))))) (_module.Result.Res_q (Lit DatatypeTypeType (_module.__default.build (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 2)))))))))))))
