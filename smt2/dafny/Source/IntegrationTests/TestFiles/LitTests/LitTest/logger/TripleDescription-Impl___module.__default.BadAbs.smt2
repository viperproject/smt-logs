...
(set-info :boogie-vc-id Impl$$_module.__default.BadAbs)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> |r#0@1| 0))))
(let ((anon3_Else_correct  (=> (<= 0 |x#0|) (=> (and (= |r#0@1| |x#0|) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (and (and (< |x#0| 0) (= |r#0@0| (- 0 |x#0|))) (and (= |r#0@1| |r#0@0|) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))
