...
(set-info :boogie-vc-id CheckWellFormed$$_module.smallPrime)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (or (or (= (LitInt 2) (LitInt 2)) (= (LitInt 2) (LitInt 3))) (= (LitInt 2) (LitInt 5))) (= (LitInt 2) (LitInt 7))))))
