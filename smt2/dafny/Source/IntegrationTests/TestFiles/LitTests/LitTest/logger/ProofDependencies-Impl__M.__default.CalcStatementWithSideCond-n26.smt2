...
(set-info :boogie-vc-id Impl$$M.__default.CalcStatementWithSideConditions)
...
(let ((anon5_Then_correct  (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= (LitInt 4) 0)) (not true))) (=> (= (ControlFlow 0 4) (- 0 3)) (= (Div |x#0| (LitInt 2)) (Div (Mul |x#0| (LitInt 2)) (LitInt 4))))))))
(let ((anon4_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= (LitInt 2) 0)) (not true)))))
