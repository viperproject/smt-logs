...
(set-info :boogie-vc-id Impl$$M.__default.ObviouslyUnreachableReturnStatementMethod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> |r#0@2| 1))))
(let ((anon5_Else_correct  (=> (and (and (M.T.A_q |t#0|) (= |r#0@1| (LitInt 1))) (and (= |r#0@2| |r#0@1|) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct)))
(let ((anon5_Then_correct  (=> (and (and (not (M.T.A_q |t#0|)) (= |r#0@0| (LitInt 2))) (and (= |r#0@2| |r#0@0|) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0| Tclass.M.T) ($IsAlloc DatatypeTypeType |t#0| Tclass.M.T $Heap)) (|$IsA#M.T| |t#0|)) (= 1 $FunctionContextHeight)) (and (not (|M.T#Equal| |t#0| |#M.T.A|)) (= (ControlFlow 0 6) 5))) anon0_correct))))
