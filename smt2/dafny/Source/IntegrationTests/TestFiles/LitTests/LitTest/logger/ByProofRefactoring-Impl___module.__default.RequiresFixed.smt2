...
(set-info :boogie-vc-id Impl$$_module.__default.RequiresFixed)
...
(let ((anon3_Then_correct  (=> (and (and (_module.__default.P reveal__module._default.P) |_module.__default.P#canCall|) (and |_module.__default.P#canCall| (= (ControlFlow 0 2) (- 0 1)))) (_module.__default.P reveal__module._default.P))))
