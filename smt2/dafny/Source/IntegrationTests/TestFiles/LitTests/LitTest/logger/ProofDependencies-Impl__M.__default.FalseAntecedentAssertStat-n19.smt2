...
(set-info :boogie-vc-id Impl$$M.__default.FalseAntecedentAssertStatementMethod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< |y#0@0| 0) (< |x#0| 0)))))
(let ((anon3_Else_correct  (=> (and (<= 0 |y#0@0|) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (< |y#0@0| 0) (= (ControlFlow 0 3) 2)) anon2_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |y#0@0| (Mul |x#0| |x#0|))) (and (=> (= (ControlFlow 0 5) 3) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
