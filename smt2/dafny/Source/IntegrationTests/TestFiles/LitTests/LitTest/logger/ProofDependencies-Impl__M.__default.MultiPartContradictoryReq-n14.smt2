...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@97  (=> (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false)) (= (ControlFlow 0 2) (- 0 1))) (= $generated@@92 ($generated 11)))))
(let (($generated@@98  (=> (and (and (and ($generated@@93 $generated@@90) ($generated@@94 $generated@@90)) (= 0 $generated@@95)) (and (and (> $generated@@92 10) (< $generated@@92 12)) (and (or (not (= $generated@@96 11)) (not true)) (= (ControlFlow 0 3) 2)))) $generated@@97)))
$generated@@98)))
))
(check-sat)
(get-info :rlimit)
