...
(set-info :boogie-vc-id Impl$$M.__default.ObviouslyUnnecessaryRequiresMethod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (>= 5 |x#0@@0|) (= (ControlFlow 0 4) (- 0 3))) ($Is intType (int_2_U (+ |x#0@@0| 1)) Tclass._System.nat))))
(let ((anon3_Then_correct  (=> (and (> |x#0@@0| 5) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U (+ |x#0@@0| 2)) Tclass._System.nat))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |x#0@@0|)) (and (and (<= (LitInt 0) |r#0|) (= 0 $FunctionContextHeight)) (and (< |x#0@@0| 10) (= (ControlFlow 0 6) 5)))) anon0_correct)))
