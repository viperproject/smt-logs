...
(set-info :boogie-vc-id Impl$$_module.__default.ExampleWithSplits_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x#0@1| (LitInt 5))) (and (= |y#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- |x#0@1| 0))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> |$w$loop#0@0| (= (+ |x#0@1| |y#0@0|) (LitInt 5)))) (=> (=> |$w$loop#0@0| (= (+ |x#0@1| |y#0@0|) (LitInt 5))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> |$w$loop#0@0| (<= (Mul |x#0@1| |x#0@1|) (LitInt 25)))) (=> (=> |$w$loop#0@0| (<= (Mul |x#0@1| |x#0@1|) (LitInt 25))) (=> (and (and (and (and (and (<= 0 |y#0@1|) (not false)) (and (<= 0 |x#0@2|) (< |x#0@2| 6))) (= |$decr_init$loop#00@0| 5)) (and (=> |$w$loop#0@0| (= (+ |x#0@2| |y#0@1|) (LitInt 5))) (=> |$w$loop#0@0| (<= (Mul |x#0@2| |x#0@2|) (LitInt 25))))) (and (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
...
)) (<= (- |x#0@2| 0) |$decr_init$loop#00@0|))) (and (and |$w$loop#0@0| (>= 0 |x#0@2|)) (and (= |y#0@3| |y#0@1|) (= (ControlFlow 0 2) (- 0 1)))))) (>= |y#0@3| (LitInt 0))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
