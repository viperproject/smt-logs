...
(set-info :boogie-vc-id Impl$$_module.__default.ExampleWithSplits_split1)
...
(assert (not
 ...
 :qid |VerificationLoggerdfy.14:3|
 :skolemid |482|
...
)) (<= (- |x#0@2| 0) |$decr_init$loop#00@0|))) (and (and |$w$loop#0@0| (> |x#0@2| 0)) (and (= |$decr$loop#00@1| (- |x#0@2| 0)) (= |x#0@3| (- |x#0@2| 1)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (Mul (+ |x#0@3| |y#0@1|) (+ |x#0@3| |y#0@1|)) 25)) (=> (> (Mul (+ |x#0@3| |y#0@1|) (+ |x#0@3| |y#0@1|)) 25) (=> (= |y#0@2| (+ |y#0@1| 1)) (=> (and (< |x#0@3| 3) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U (< 2 2))))))))))))
anon0_correct))
))
(check-sat)
