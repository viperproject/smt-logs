...
(set-info :boogie-vc-id Impl$$M.__default.FalseAntecedentEnsuresClauseMethod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |r#0@0| (Mul |x#0| |x#0|)) (= (ControlFlow 0 2) (- 0 1))) (< |r#0@0| 0)) (< |x#0| 0)))))
