...
(set-info :boogie-vc-id Impl$$M.__default.ContradictoryAssumeMethod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (> |n#0| 0) (< |n#0| 0)) (and (= |n#0| (LitInt 5)) (= (ControlFlow 0 2) (- 0 1)))) (< |n#0| 10)))))
