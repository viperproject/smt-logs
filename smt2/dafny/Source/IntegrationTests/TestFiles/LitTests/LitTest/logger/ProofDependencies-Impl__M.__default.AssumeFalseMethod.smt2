...
(set-info :boogie-vc-id Impl$$M.__default.AssumeFalseMethod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |n#0| (LitInt 15))) (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 2) (- 0 1)))) (< |n#0| 10))))
