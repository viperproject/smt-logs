...
(set-info :boogie-vc-id Impl$$M.__default.RedundantAssumeMethod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (> |n#0| 4)) (and (> |n#0| 3) (= (ControlFlow 0 2) (- 0 1)))) (> |n#0| 1))))
