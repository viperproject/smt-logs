...
(set-info :boogie-vc-id CheckWellFormed$$Lists.__default.ContainsOneOK)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= StartFuel_Lists.List.Length ($LS ($LS ($LS ($LS ($LS BaseFuel_Lists.List.Length)))))) (=> (and (= StartFuelAssert_Lists.List.Length ($LS ($LS ($LS ($LS ($LS ($LS BaseFuel_Lists.List.Length))))))) (= (AsFuelBottom BaseFuel_Lists.List.Length) BaseFuel_Lists.List.Length)) (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAllocBox ($Box DatatypeTypeType |l#0@@4|) (Tclass.Lists.List TInt) $Heap)) (and (|Lists.List.Length#canCall| TInt |l#0@@4|) (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@4|) (LitInt 3)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) ($IsAlloc DatatypeTypeType |l#0@@4| (Tclass.Lists.List TInt) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@4|) (LitInt 3))) (=> (and (and (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@4|) (LitInt 3)) (|Lists.__default.ContainsOne#canCall| |l#0@@4|)) (and ($IsAlloc DatatypeTypeType |l#0@@4| (Tclass.Lists.List TInt) $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@4|) (LitInt 3)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |l#0@@4| (Tclass.Lists.List TInt)) ($IsAlloc DatatypeTypeType |l#0@@4| (Tclass.Lists.List TInt) $Heap)) (|$IsA#Lists.List| |l#0@@4|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
