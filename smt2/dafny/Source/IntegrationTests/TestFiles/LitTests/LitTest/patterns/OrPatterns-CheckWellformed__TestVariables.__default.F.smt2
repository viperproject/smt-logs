...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|dt#0| T@U) ) (!  (=> (or (|TestVariables.__default.F#canCall| |dt#0|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is DatatypeTypeType |dt#0| Tclass.TestVariables.DT)))) (= (TestVariables.__default.F |dt#0|) (ite (TestVariables.DT.A_q |dt#0|) (let ((|x#0| (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U (LitInt 1))))))))
...
|x#1|) 0))))
 ...
 :skolemid |1494|
 :pattern ( (TestVariables.__default.F |dt#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|dt#0@@0| T@U) ) (!  (=> (or (|TestVariables.__default.F#canCall| (Lit DatatypeTypeType |dt#0@@0|)) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is DatatypeTypeType |dt#0@@0| Tclass.TestVariables.DT)))) (= (TestVariables.__default.F (Lit DatatypeTypeType |dt#0@@0|)) (ite (TestVariables.DT.A_q (Lit DatatypeTypeType |dt#0@@0|)) (let ((|x#4| (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U (LitInt 1))))))))
...
|x#5|) 0))))
 ...
 :weight 3
 :skolemid |1495|
 :pattern ( (TestVariables.__default.F (Lit DatatypeTypeType |dt#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$TestVariables.__default.F)
