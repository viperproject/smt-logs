...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|xs#0| T@U) ) (!  (=> (or (|_module.__default.F#canCall| (Lit DatatypeTypeType |xs#0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0| (Tclass._module.List TInt)))) (= (_module.__default.F (Lit DatatypeTypeType |xs#0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0|)) 8 (LitInt 5))))
 :qid |PatternMatchingErrorsdfy.12:18|
 :weight 3
 :skolemid |595|
 :pattern ( (_module.__default.F (Lit DatatypeTypeType |xs#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.F#canCall| |xs#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@0| (Tclass._module.List TInt)))) (= (_module.__default.F |xs#0@@0|) (ite (_module.List.Nil_q |xs#0@@0|) 8 (LitInt 5))))
 :qid |PatternMatchingErrorsdfy.12:18|
 :skolemid |594|
 :pattern ( (_module.__default.F |xs#0@@0|))
))))
...
(let ((anon15_Then_correct  (=> (and (= |_mcc#1#0| |#_module.List.Nil|) (= (ControlFlow 0 6) (- 0 5))) false)))
(let ((anon14_Else_correct  (=> (or (not (= |_mcc#1#0| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#2#0|)) |_mcc#3#0|))) (not true)) (and (=> (= (ControlFlow 0 8) 6) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct)))))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct  (=> (and (= |xs#0@@1| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List TInt))) (and (=> (= (ControlFlow 0 9) 4) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (or (not (= |xs#0@@1| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 10) 9) anon13_Then_correct) (=> (= (ControlFlow 0 10) 3) anon13_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
