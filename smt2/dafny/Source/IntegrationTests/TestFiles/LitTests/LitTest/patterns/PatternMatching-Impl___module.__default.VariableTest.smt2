...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.List.Cons_q d@@1) (exists ((|a#33#0#0| T@U) (|a#33#1#0| T@U) ) (! (= d@@1 (|#_module.List.Cons| |a#33#0#0| |a#33#1#0|))
...
(assert (forall ((_module.List$T@@8 T@U) (|a#34#0#0@@0| T@U) (|a#34#1#0@@0| T@U) ($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) (= ($IsAlloc DatatypeTypeType (|#_module.List.Cons| |a#34#0#0@@0| |a#34#1#0@@0|) (Tclass._module.List _module.List$T@@8) $h@@2)  (and ($IsAllocBox |a#34#0#0@@0| _module.List$T@@8 $h@@2) ($IsAlloc DatatypeTypeType |a#34#1#0@@0| (Tclass._module.List _module.List$T@@8) $h@@2))))
 :qid |unknown.0:0|
 :skolemid |605|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.List.Cons| |a#34#0#0@@0| |a#34#1#0@@0|) (Tclass._module.List _module.List$T@@8) $h@@2))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.VariableTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and (and ($Is DatatypeTypeType |a#0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |a#0@0| (Tclass._module.List TInt) $Heap)) (= |let#0#0#0| |x#0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List TInt)) (= |a#0@0| |let#0#0#0|))) (and (and (|$IsA#_module.List| |a#0@0|) (|$IsA#_module.List| |x#0|)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| |a#0@0| |x#0|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |x#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |x#0| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |x#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
