...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.List.Cons_q d@@1) (exists ((|a#5#0#0| T@U) (|a#5#1#0| T@U) ) (! (= d@@1 (|#_module.List.Cons| |a#5#0#0| |a#5#1#0|))
 :qid |PatternMatchingErrorsdfy.10:31|
 :skolemid |705|
)))
 :qid |unknown.0:0|
 :skolemid |706|
...
(set-info :boogie-vc-id Impl$$_module.__default.PostTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= |r#0@2| (LitInt 0)))))
(let ((anon10_Then_correct  (=> (= |_mcc#1#0_0@0| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#2#0_0_0@0|)) |_mcc#3#0_0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#3#0_0_0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |_mcc#3#0_0_0@0| (Tclass._module.List TInt) $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |zs#0_0_0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |zs#0_0_0@0| (Tclass._module.List TInt) $Heap)) (= |let#0_0_0#0#0| |_mcc#3#0_0_0@0|)) (and ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.List TInt)) (= |zs#0_0_0@0| |let#0_0_0#0#0|))) (and (and (and (= |let#0_0_1#0#0| |_mcc#2#0_0_0@0|) ($Is intType (int_2_U |let#0_0_1#0#0|) TInt)) (and (= |z#0_0_0@0| |let#0_0_1#0#0|) (= |let#0_0_2#0#0| |_mcc#0#0_0@0|))) (and (and ($Is intType (int_2_U |let#0_0_2#0#0|) TInt) (= |y#0_0_0@0| |let#0_0_2#0#0|)) (and (= |r#0@2| |z#0_0_0@0|) (= (ControlFlow 0 7) 4))))) GeneratedUnifiedExit_correct)))))
(let ((anon9_Then_correct  (=> (= |_mcc#1#0_0@0| |#_module.List.Nil|) (=> (and (= |let#0_1_0#0#0| |_mcc#0#0_0@0|) ($Is intType (int_2_U |let#0_1_0#0#0|) TInt)) (=> (and (and (= |y#0_1_0@0| |let#0_1_0#0#0|) (= |r#0@1| (LitInt 0))) (and (= |r#0@2| |r#0@1|) (= (ControlFlow 0 6) 4))) GeneratedUnifiedExit_correct)))))
(let ((anon7_Then_correct  (=> (and (and (= |xs#0| |#_module.List.Nil|) (= |r#0@0| (LitInt 0))) (and (= |r#0@2| |r#0@0|) (= (ControlFlow 0 5) 4))) GeneratedUnifiedExit_correct)))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (=> (or (not (= |_mcc#1#0_0@0| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 8) 7) anon10_Then_correct) (=> (= (ControlFlow 0 8) 2) anon10_Else_correct)))))
(let ((anon8_Then_correct  (=> (= |xs#0| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0_0@0|)) |_mcc#1#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List TInt) $Heap)) (and (=> (= (ControlFlow 0 9) 6) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (=> (or (not (= |xs#0| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 10) 9) anon8_Then_correct) (=> (= (ControlFlow 0 10) 1) anon8_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 11) 5) anon7_Then_correct) (=> (= (ControlFlow 0 11) 10) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |xs#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |xs#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
