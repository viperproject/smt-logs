...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|l#0| T@U) ) (!  (=> (or (|Lists.__default.ContainsOne#canCall| (Lit DatatypeTypeType |l#0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0| (Tclass.Lists.List TInt)) (= (LitInt (Lists.List.Length TInt StartFuelAssert_Lists.List.Length (Lit DatatypeTypeType |l#0|))) (LitInt 3))))) (= (Lists.__default.ContainsOne (Lit DatatypeTypeType |l#0|))  (or (or (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType |l#0|))))) (LitInt 1)) (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType |l#0|))))))) (LitInt 1))) (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType |l#0|))))))))) (LitInt 1)))))
 :qid |OrPatternsdfy.43:25|
 :weight 3
 :skolemid |969|
 :pattern ( (Lists.__default.ContainsOne (Lit DatatypeTypeType |l#0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|l#0@@0| T@U) ) (!  (=> (or (|Lists.__default.ContainsOne#canCall| |l#0@@0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@0| (Tclass.Lists.List TInt)) (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@0|) (LitInt 3))))) (= (Lists.__default.ContainsOne |l#0@@0|)  (or (or (= (U_2_int ($Unbox intType (Lists.List.car |l#0@@0|))) (LitInt 1)) (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr |l#0@@0|)))) (LitInt 1))) (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr (Lists.List.cdr |l#0@@0|))))) (LitInt 1)))))
 :qid |OrPatternsdfy.43:25|
 :skolemid |968|
...
(set-info :boogie-vc-id CheckWellformed$$Lists.__default.ContainsOne)
...
(let ((anon11_Else_correct  (=> (and (or (= (U_2_int ($Unbox intType (Lists.List.car |l#0@@2|))) (LitInt 1)) (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr |l#0@@2|)))) (LitInt 1))) (= (ControlFlow 0 7) 2)) anon7_correct)))
(let ((anon11_Then_correct  (=> (not (or (= (U_2_int ($Unbox intType (Lists.List.car |l#0@@2|))) (LitInt 1)) (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr |l#0@@2|)))) (LitInt 1)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (Lists.List.Cons_q |l#0@@2|)) (=> (Lists.List.Cons_q |l#0@@2|) (and (=> (= (ControlFlow 0 3) (- 0 5)) (Lists.List.Cons_q (Lists.List.cdr |l#0@@2|))) (=> (Lists.List.Cons_q (Lists.List.cdr |l#0@@2|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Lists.List.Cons_q (Lists.List.cdr (Lists.List.cdr |l#0@@2|)))) (=> (Lists.List.Cons_q (Lists.List.cdr (Lists.List.cdr |l#0@@2|))) (=> (= (ControlFlow 0 3) 2) anon7_correct))))))))))
(let ((anon10_Else_correct  (=> (= (U_2_int ($Unbox intType (Lists.List.car |l#0@@2|))) (LitInt 1)) (and (=> (= (ControlFlow 0 11) 3) anon11_Then_correct) (=> (= (ControlFlow 0 11) 7) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (or (not (= (U_2_int ($Unbox intType (Lists.List.car |l#0@@2|))) (LitInt 1))) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (Lists.List.Cons_q |l#0@@2|)) (=> (Lists.List.Cons_q |l#0@@2|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (Lists.List.Cons_q (Lists.List.cdr |l#0@@2|))) (=> (Lists.List.Cons_q (Lists.List.cdr |l#0@@2|)) (and (=> (= (ControlFlow 0 8) 3) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (Lists.List.Cons_q |l#0@@2|)) (=> (Lists.List.Cons_q |l#0@@2|) (and (=> (= (ControlFlow 0 12) 8) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= StartFuel_Lists.List.Length ($LS ($LS ($LS ($LS ($LS BaseFuel_Lists.List.Length)))))) (= StartFuelAssert_Lists.List.Length ($LS ($LS ($LS ($LS ($LS ($LS BaseFuel_Lists.List.Length)))))))) (=> (and (and (= (AsFuelBottom BaseFuel_Lists.List.Length) BaseFuel_Lists.List.Length) ($IsAllocBox ($Box DatatypeTypeType |l#0@@2|) (Tclass.Lists.List TInt) $Heap)) (and (|Lists.List.Length#canCall| TInt |l#0@@2|) (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@2|) (LitInt 3)))) (and (=> (= (ControlFlow 0 14) 1) anon9_Then_correct) (=> (= (ControlFlow 0 14) 12) anon9_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |l#0@@2| (Tclass.Lists.List TInt))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct)))
