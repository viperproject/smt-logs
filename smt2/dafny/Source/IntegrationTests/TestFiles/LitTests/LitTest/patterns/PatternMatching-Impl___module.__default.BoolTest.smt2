...
(set-info :boogie-vc-id Impl$$_module.__default.BoolTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (= |x#0|  (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 3) (- 0 2))) (= |x#0| (U_2_bool (Lit boolType (bool_2_U false)))))))
