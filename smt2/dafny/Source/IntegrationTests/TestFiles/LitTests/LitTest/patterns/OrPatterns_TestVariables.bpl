...
procedure {:verboseName "TestVariables.M (correctness)"} Impl$$TestVariables.__default.M(dt#0: DatatypeType
       where $Is(dt#0, Tclass.TestVariables.DT())
         && $IsAlloc(dt#0, Tclass.TestVariables.DT(), $Heap)
         && $IsA#TestVariables.DT(dt#0))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestVariables.M (correctness)"} Impl$$TestVariables.__default.M(dt#0: DatatypeType) returns (j#0: int, $_reverifyPost: bool)
{
  ...
  var lambdaResult#2_0: int;
    ...
    // AddMethodImpl: M, Impl$$TestVariables.__default.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    assume true;
    if (dt#0 == #TestVariables.DT.A())
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(75,27)
        assume true;
        ...
        if (*)
        {
            ...
            if (true)
            {
                ...
                assume {:id "id58"} lambdaResult#2_0 == y#2_0;
                assume true;
        ...
        assume true;
        x#2_0 := $Unbox(Apply1(TInt, 
            TInt, 
            $Heap, 
            Lit(AtLayer((lambda $l#2_0#ly#0: LayerType :: 
                  Handle1((lambda $l#2_0#heap#0: Heap, $l#2_0#y#0: Box :: $Box($Unbox($l#2_0#y#0): int)), 
                    (lambda $l#2_0#heap#0: Heap, $l#2_0#y#0: Box :: $IsBox($l#2_0#y#0, TInt)), 
                    (lambda $l#2_0#heap#0: Heap, $l#2_0#y#0: Box :: 
                      SetRef_to_SetBox((lambda $l#2_0#o#0: ref :: false))))), 
                $LS($LZ))), 
            $Box(LitInt(1)))): int;
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(75,43)
        assume true;
        assert {:id "id60"} x#2_0 == LitInt(1);
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(76,9)
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(76,9)
        assume true;
        assume true;
        j#0 := x#2_0;
        return;
    }
    else if (dt#0 == #TestVariables.DT.B())
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(75,27)
        assume true;
        // Begin Comprehension WF check
        if (*)
        {
            ...
            if (true)
            {
                ...
                assume {:id "id54"} lambdaResult#1_0 == y#1_0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(lambdaResult#1_0, TInt);
            }
        ...
        // End Comprehension WF check
        assume true;
        x#1_0 := $Unbox(Apply1(TInt, 
            TInt, 
            $Heap, 
            Lit(AtLayer((lambda $l#1_0#ly#0: LayerType :: 
                  Handle1((lambda $l#1_0#heap#0: Heap, $l#1_0#y#0: Box :: $Box($Unbox($l#1_0#y#0): int)), 
                    (lambda $l#1_0#heap#0: Heap, $l#1_0#y#0: Box :: $IsBox($l#1_0#y#0, TInt)), 
                    (lambda $l#1_0#heap#0: Heap, $l#1_0#y#0: Box :: 
                      SetRef_to_SetBox((lambda $l#1_0#o#0: ref :: false))))), 
                $LS($LZ))), 
            $Box(LitInt(1)))): int;
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(75,43)
        assume true;
        assert {:id "id56"} x#1_0 == LitInt(1);
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(76,9)
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(76,9)
        assume true;
        assume true;
    ...
    else if (dt#0 == #TestVariables.DT.C())
    {
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(74,17)
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(74,17)
        assume true;
        assume true;
        j#0 := LitInt(0);
        return;
...
procedure {:verboseName "TestVariables.M2 (correctness)"} Impl$$TestVariables.__default.M2(dt#0: DatatypeType
       where $Is(dt#0, Tclass.TestVariables.DT())
         && $IsAlloc(dt#0, Tclass.TestVariables.DT(), $Heap)
         && $IsA#TestVariables.DT(dt#0))
   returns (j#0: int, $_reverifyPost: bool);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestVariables.M2 (correctness)"} Impl$$TestVariables.__default.M2(dt#0: DatatypeType) returns (j#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x#1_0: int;
  var $lambdaHeap#1_0: Heap;
  ...
  var lambdaResult#2_0: int;
    ...
    // AddMethodImpl: M2, Impl$$TestVariables.__default.M2
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    assume true;
    if (dt#0 == #TestVariables.DT.A())
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(83,23)
        assume true;
        // Begin Comprehension WF check
        if (*)
        {
            ...
            if (true)
            {
                $_Frame#l2_0 := (lambda $o: ref, $f: Field :: 
                  $o != null && $Unbox(read($lambdaHeap#2_0, $o, alloc)): bool ==> false);
                assume {:id "id67"} lambdaResult#2_0 == y#2_0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(lambdaResult#2_0, TInt);
            }
        ...
        x#2_0 := $Unbox(Apply1(TInt, 
            ...
            Lit(AtLayer((lambda $l#2_0#ly#0: LayerType :: 
                ...
                $LS($LZ))), 
            $Box(LitInt(1)))): int;
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(83,39)
        assume true;
        assert {:id "id69"} x#2_0 == LitInt(1);
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(84,9)
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(84,9)
        assume true;
        assume true;
        j#0 := x#2_0;
        return;
    ...
    else if (dt#0 == #TestVariables.DT.B())
    {
        ...
        if (*)
        {
            ...
            if (true)
            {
                $_Frame#l1_0 := (lambda $o: ref, $f: Field :: 
                  $o != null && $Unbox(read($lambdaHeap#1_0, $o, alloc)): bool ==> false);
                assume {:id "id63"} lambdaResult#1_0 == y#1_0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(lambdaResult#1_0, TInt);
            }
    ...
    {
        // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(82,17)
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(82,17)
        assume true;
        assume true;
        j#0 := LitInt(0);
        return;
...
axiom {:id "id71"} 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, dt#0: DatatypeType :: 
    { TestVariables.__default.F(dt#0), $IsGoodHeap($Heap) } 
    TestVariables.__default.F#canCall(dt#0)
         || (1 < $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
           && $Is(dt#0, Tclass.TestVariables.DT()))
       ==> TestVariables.__default.F(dt#0)
         == (if TestVariables.DT.A_q(dt#0)
           then (var x#0 := $Unbox(Apply1(TInt, 
                  TInt, 
                  $Heap, 
                  Lit(AtLayer((lambda $l#0#ly#0: LayerType :: 
                        Handle1((lambda $l#0#heap#0: Heap, $l#0#y#0: Box :: $Box($Unbox($l#0#y#0): int)), 
                          (lambda $l#0#heap#0: Heap, $l#0#y#0: Box :: $IsBox($l#0#y#0, TInt)), 
                          (lambda $l#0#heap#0: Heap, $l#0#y#0: Box :: 
                            SetRef_to_SetBox((lambda $l#0#o#0: ref :: false))))), 
                      $LS($LZ))), 
                  $Box(LitInt(1)))): int; 
            x#0)
           else (if TestVariables.DT.B_q(dt#0)
             then (var x#1 := $Unbox(Apply1(TInt, 
                    TInt, 
                    $Heap, 
                    Lit(AtLayer((lambda $l#1#ly#0: LayerType :: 
                          Handle1((lambda $l#1#heap#0: Heap, $l#1#y#0: Box :: $Box($Unbox($l#1#y#0): int)), 
                            (lambda $l#1#heap#0: Heap, $l#1#y#0: Box :: $IsBox($l#1#y#0, TInt)), 
                            (lambda $l#1#heap#0: Heap, $l#1#y#0: Box :: 
    ...
    TestVariables.__default.F#canCall(Lit(dt#0))
       ...
       ==> TestVariables.__default.F(Lit(dt#0))
         == (if TestVariables.DT.A_q(Lit(dt#0))
           then (var x#4 := $Unbox(Apply1(TInt, 
                  TInt, 
                  $Heap, 
                  Lit(AtLayer((lambda $l#6#ly#0: LayerType :: 
                        Handle1((lambda $l#6#heap#0: Heap, $l#6#y#0: Box :: $Box($Unbox($l#6#y#0): int)), 
                          (lambda $l#6#heap#0: Heap, $l#6#y#0: Box :: $IsBox($l#6#y#0, TInt)), 
                          (lambda $l#6#heap#0: Heap, $l#6#y#0: Box :: 
                            SetRef_to_SetBox((lambda $l#6#o#0: ref :: false))))), 
                      $LS($LZ))), 
                  $Box(LitInt(1)))): int; 
            x#4)
           else (if TestVariables.DT.B_q(Lit(dt#0))
             then (var x#5 := $Unbox(Apply1(TInt, 
                    TInt, 
                    $Heap, 
                    Lit(AtLayer((lambda $l#7#ly#0: LayerType :: 
                          Handle1((lambda $l#7#heap#0: Heap, $l#7#y#0: Box :: $Box($Unbox($l#7#y#0): int)), 
                            (lambda $l#7#heap#0: Heap, $l#7#y#0: Box :: $IsBox($l#7#y#0, TInt)), 
                            (lambda $l#7#heap#0: Heap, $l#7#y#0: Box :: 
...
procedure {:verboseName "TestVariables.F (well-formedness)"} CheckWellformed$$TestVariables.__default.F(dt#0: DatatypeType where $Is(dt#0, Tclass.TestVariables.DT()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestVariables.F (well-formedness)"} CheckWellformed$$TestVariables.__default.F(dt#0: DatatypeType)
{
  ...
  var lambdaResult#1: int;
    ...
    else
    {
        ...
        if (dt#0 == #TestVariables.DT.A())
        {
            ...
            if (*)
            {
                ...
                if (true)
                {
                    ...
                    assume {:id "id79"} lambdaResult#1 == y#1;
                    assume true;
                    // CheckWellformedWithResult: any expression
            ...
            // End Comprehension WF check
            assume {:id "id80"} let#1#0#0
               == $Unbox(Apply1(TInt, 
                  TInt, 
                  $Heap, 
                  Lit(AtLayer((lambda $l#18#ly#0: LayerType :: 
                        Handle1((lambda $l#18#heap#0: Heap, $l#18#y#0: Box :: $Box($Unbox($l#18#y#0): int)), 
                          (lambda $l#18#heap#0: Heap, $l#18#y#0: Box :: $IsBox($l#18#y#0, TInt)), 
                          (lambda $l#18#heap#0: Heap, $l#18#y#0: Box :: 
            ...
            assume {:id "id81"} x#Z#1 == let#1#0#0;
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(91,43)
            assume true;
            assert {:id "id82"} x#Z#1 == LitInt(1);
            assume {:id "id83"} TestVariables.__default.F(dt#0) == x#Z#1;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(TestVariables.__default.F(dt#0), TInt);
            return;
        }
        else if (dt#0 == #TestVariables.DT.B())
        {
            ...
            if (*)
            {
                ...
                if (true)
                {
                    ...
                    assume {:id "id74"} lambdaResult#0 == y#0;
                    assume true;
                    // CheckWellformedWithResult: any expression
            ...
            // End Comprehension WF check
            assume {:id "id75"} let#0#0#0
               == $Unbox(Apply1(TInt, 
                  TInt, 
                  $Heap, 
                  Lit(AtLayer((lambda $l#14#ly#0: LayerType :: 
                        Handle1((lambda $l#14#heap#0: Heap, $l#14#y#0: Box :: $Box($Unbox($l#14#y#0): int)), 
                          (lambda $l#14#heap#0: Heap, $l#14#y#0: Box :: $IsBox($l#14#y#0, TInt)), 
                          (lambda $l#14#heap#0: Heap, $l#14#y#0: Box :: 
            ...
            assume {:id "id76"} x#Z#0 == let#0#0#0;
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(91,43)
            assume true;
            assert {:id "id77"} x#Z#0 == LitInt(1);
            assume {:id "id78"} TestVariables.__default.F(dt#0) == x#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(TestVariables.__default.F(dt#0), TInt);
            return;
        ...
        {
            assume {:id "id73"} TestVariables.__default.F(dt#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(TestVariables.__default.F(dt#0), TInt);
            return;
...
procedure {:verboseName "TestVariables.F2 (well-formedness)"} CheckWellformed$$TestVariables.__default.F2(dt#0: DatatypeType where $Is(dt#0, Tclass.TestVariables.DT()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestVariables.F2 (well-formedness)"} CheckWellformed$$TestVariables.__default.F2(dt#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#Z#0: int;
  var let#0#0#0: int;
  ...
  var lambdaResult#1: int;
    ...
    else
    {
        ...
        if (dt#0 == #TestVariables.DT.A())
        {
            ...
            if (*)
            {
                ...
                if (true)
                {
                    $_Frame#l1 := (lambda $o: ref, $f: Field :: 
                      $o != null && $Unbox(read($lambdaHeap#1, $o, alloc)): bool ==> false);
                    assume {:id "id92"} lambdaResult#1 == y#1;
                    assume true;
                    // CheckWellformedWithResult: any expression
                    assume $Is(lambdaResult#1, TInt);
                }
            ...
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, TInt);
            assume {:id "id94"} x#Z#1 == let#1#0#0;
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(97,39)
            assume true;
            assert {:id "id95"} x#Z#1 == LitInt(1);
            assume {:id "id96"} TestVariables.__default.F2(dt#0) == x#Z#1;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(TestVariables.__default.F2(dt#0), TInt);
            return;
        }
        else if (dt#0 == #TestVariables.DT.B())
        {
            ...
            if (*)
            {
                ...
                if (true)
                {
                    $_Frame#l0 := (lambda $o: ref, $f: Field :: 
                      $o != null && $Unbox(read($lambdaHeap#0, $o, alloc)): bool ==> false);
                    assume {:id "id87"} lambdaResult#0 == y#0;
                    assume true;
                    // CheckWellformedWithResult: any expression
                    assume $Is(lambdaResult#0, TInt);
                }
            ...
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, TInt);
            assume {:id "id89"} x#Z#0 == let#0#0#0;
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(97,39)
            assume true;
            assert {:id "id90"} x#Z#0 == LitInt(1);
            assume {:id "id91"} TestVariables.__default.F2(dt#0) == x#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(TestVariables.__default.F2(dt#0), TInt);
            return;
        ...
        {
            assume {:id "id86"} TestVariables.__default.F2(dt#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(TestVariables.__default.F2(dt#0), TInt);
            return;
