...
axiom 0 < $FunctionContextHeight ==> $Is(Constants.__default.ONE(), TInt);
}

procedure {:verboseName "Constants.ONE (well-formedness)"} CheckWellFormed$$Constants.__default.ONE();
...
axiom 0 < $FunctionContextHeight ==> $Is(Constants.__default.TWO(), TInt);
}

procedure {:verboseName "Constants.TWO (well-formedness)"} CheckWellFormed$$Constants.__default.TWO();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "Constants.M (well-formedness)"} CheckWellFormed$$Constants.__default.M(i#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Constants.M (call)"} Call$$Constants.__default.M(i#0: int);
  modifies $Heap;
...
procedure {:verboseName "Constants.M (correctness)"} Impl$$Constants.__default.M(i#0: int) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
