...
(declare-fun |$IsA#Lists.List| (T@U) Bool)
...
(assert (distinct TInt TagInt alloc Tagclass.Lists.List |##Lists.List.Nil| |##Lists.List.Cons| tytagFamily$List)
)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|l#0@@0| T@U) ) (!  (=> (or (|Lists.__default.ContainsOne_k#canCall| (Lit DatatypeTypeType |l#0@@0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@0| (Tclass.Lists.List TInt)) (= (LitInt (Lists.List.Length TInt StartFuelAssert_Lists.List.Length (Lit DatatypeTypeType |l#0@@0|))) (LitInt 3))))) (= (Lists.__default.ContainsOne_k (Lit DatatypeTypeType |l#0@@0|)) (ite (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType |l#0@@0|))))) (LitInt 1)) (ite (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType |l#0@@0|))))))) (LitInt 1)) (ite (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType |l#0@@0|))))))))) (LitInt 1)) true true) (ite (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType |l#0@@0|))))))))) (LitInt 1)) true true)) (ite (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType |l#0@@0|))))))) (LitInt 1)) (ite (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType |l#0@@0|))))))))) (LitInt 1)) true true) (ite (= (LitInt (U_2_int ($Unbox intType (Lists.List.car (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType (Lists.List.cdr (Lit DatatypeTypeType |l#0@@0|))))))))) (LitInt 1)) true false)))))
 :qid |OrPatternsdfy.49:26|
 :weight 3
 :skolemid |974|
 :pattern ( (Lists.__default.ContainsOne_k (Lit DatatypeTypeType |l#0@@0|)))
))))
(assert (forall ((d@@3 T@U) ) (!  (=> (|$IsA#Lists.List| d@@3) (or (Lists.List.Nil_q d@@3) (Lists.List.Cons_q d@@3)))
 :qid |unknown.0:0|
 :skolemid |994|
 :pattern ( (|$IsA#Lists.List| d@@3))
)))
(assert (forall ((Lists.List$T@@7 T@U) (d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 (Tclass.Lists.List Lists.List$T@@7)) (or (Lists.List.Nil_q d@@4) (Lists.List.Cons_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |995|
 :pattern ( (Lists.List.Cons_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass.Lists.List Lists.List$T@@7)))
 :pattern ( (Lists.List.Nil_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass.Lists.List Lists.List$T@@7)))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|l#0@@1| T@U) ) (!  (=> (or (|Lists.__default.ContainsOne#canCall| |l#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@1| (Tclass.Lists.List TInt)) (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@1|) (LitInt 3))))) (= (Lists.__default.ContainsOne |l#0@@1|)  (or (or (= (U_2_int ($Unbox intType (Lists.List.car |l#0@@1|))) (LitInt 1)) (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr |l#0@@1|)))) (LitInt 1))) (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr (Lists.List.cdr |l#0@@1|))))) (LitInt 1)))))
 :qid |OrPatternsdfy.43:25|
 :skolemid |968|
 :pattern ( (Lists.__default.ContainsOne |l#0@@1|))
))))
...
(assert (forall ((d@@5 T@U) (Lists.List$T@@9 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (Lists.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass.Lists.List Lists.List$T@@9) $h@@0))) ($IsAllocBox (Lists.List.car d@@5) Lists.List$T@@9 $h@@0))
 :qid |unknown.0:0|
 :skolemid |987|
 :pattern ( ($IsAllocBox (Lists.List.car d@@5) Lists.List$T@@9 $h@@0))
)))
...
(assert (forall ((d@@7 T@U) (Lists.List$T@@11 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (Lists.List.Cons_q d@@7) ($IsAlloc DatatypeTypeType d@@7 (Tclass.Lists.List Lists.List$T@@11) $h@@1))) ($IsAlloc DatatypeTypeType (Lists.List.cdr d@@7) (Tclass.Lists.List Lists.List$T@@11) $h@@1))
 :qid |unknown.0:0|
 :skolemid |988|
 :pattern ( ($IsAlloc DatatypeTypeType (Lists.List.cdr d@@7) (Tclass.Lists.List Lists.List$T@@11) $h@@1))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|l#0@@3| T@U) ) (!  (=> (or (|Lists.__default.ContainsOne_k#canCall| |l#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |l#0@@3| (Tclass.Lists.List TInt)) (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@3|) (LitInt 3))))) (= (Lists.__default.ContainsOne_k |l#0@@3|) (ite (= (U_2_int ($Unbox intType (Lists.List.car |l#0@@3|))) (LitInt 1)) (ite (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr |l#0@@3|)))) (LitInt 1)) (ite (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr (Lists.List.cdr |l#0@@3|))))) (LitInt 1)) true true) (ite (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr (Lists.List.cdr |l#0@@3|))))) (LitInt 1)) true true)) (ite (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr |l#0@@3|)))) (LitInt 1)) (ite (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr (Lists.List.cdr |l#0@@3|))))) (LitInt 1)) true true) (ite (= (U_2_int ($Unbox intType (Lists.List.car (Lists.List.cdr (Lists.List.cdr |l#0@@3|))))) (LitInt 1)) true false)))))
 :qid |OrPatternsdfy.49:26|
 :skolemid |973|
 :pattern ( (Lists.__default.ContainsOne_k |l#0@@3|))
))))
...
(set-info :boogie-vc-id Impl$$Lists.__default.ContainsOneOK)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= StartFuel_Lists.List.Length ($LS ($LS ($LS ($LS ($LS BaseFuel_Lists.List.Length)))))) (=> (and (and (= StartFuelAssert_Lists.List.Length ($LS ($LS ($LS ($LS ($LS ($LS BaseFuel_Lists.List.Length))))))) (= (AsFuelBottom BaseFuel_Lists.List.Length) BaseFuel_Lists.List.Length)) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#Lists.List| |l#0@@4|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#l0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#l0#0| (Tclass.Lists.List TInt)) (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |$ih#l0#0|) (LitInt 3))) (< (DtRank |$ih#l0#0|) (DtRank |l#0@@4|))) (= (Lists.__default.ContainsOne |$ih#l0#0|) (Lists.__default.ContainsOne_k |$ih#l0#0|)))
 :qid |OrPatternsdfy.61:23|
 :skolemid |976|
 :pattern ( (Lists.__default.ContainsOne_k |$ih#l0#0|))
 :pattern ( (Lists.__default.ContainsOne |$ih#l0#0|))
 :pattern ( (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |$ih#l0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (Lists.__default.ContainsOne |l#0@@4|) (Lists.__default.ContainsOne_k |l#0@@4|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |l#0@@4| (Tclass.Lists.List TInt)) ($IsAlloc DatatypeTypeType |l#0@@4| (Tclass.Lists.List TInt) $Heap)) (|$IsA#Lists.List| |l#0@@4|)) (= 3 $FunctionContextHeight)) (and (= (Lists.List.Length TInt StartFuelAssert_Lists.List.Length |l#0@@4|) (LitInt 3)) (= (ControlFlow 0 3) 2))) anon0_correct))))
