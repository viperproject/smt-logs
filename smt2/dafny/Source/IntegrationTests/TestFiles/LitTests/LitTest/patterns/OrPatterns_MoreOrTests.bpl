...
procedure {:verboseName "MoreOrTests.Test (correctness)"} Impl$$MoreOrTests.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MoreOrTests.Test (correctness)"} Impl$$MoreOrTests.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var d##6: DatatypeType;

    // AddMethodImpl: Test, Impl$$MoreOrTests.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(136,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    d##0 := Lit(#MoreOrTests.Dt.A());
    call {:id "id97"} Call$$MoreOrTests.__default.M(d##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(137,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    d##1 := Lit(#MoreOrTests.Dt.B());
    call {:id "id98"} Call$$MoreOrTests.__default.M(d##1);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(138,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    d##2 := Lit(#MoreOrTests.Dt.C());
    call {:id "id99"} Call$$MoreOrTests.__default.M(d##2);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(139,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    d##3 := Lit(#MoreOrTests.Dt.D());
    call {:id "id100"} Call$$MoreOrTests.__default.M(d##3);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(140,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    d##4 := Lit(#MoreOrTests.Dt.E());
    call {:id "id101"} Call$$MoreOrTests.__default.M(d##4);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(141,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    d##5 := Lit(#MoreOrTests.Dt.F());
    call {:id "id102"} Call$$MoreOrTests.__default.M(d##5);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/patterns/OrPatterns.dfy(142,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    d##6 := Lit(#MoreOrTests.Dt.G());
    call {:id "id103"} Call$$MoreOrTests.__default.M(d##6);
    // TrCallStmt: After ProcessCallStmt
}
...
procedure {:verboseName "MoreOrTests.M (well-formedness)"} CheckWellFormed$$MoreOrTests.__default.M(d#0: DatatypeType
       where $Is(d#0, Tclass.MoreOrTests.Dt())
         && $IsAlloc(d#0, Tclass.MoreOrTests.Dt(), $Heap)
         && $IsA#MoreOrTests.Dt(d#0));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "MoreOrTests.M (call)"} Call$$MoreOrTests.__default.M(d#0: DatatypeType
       where $Is(d#0, Tclass.MoreOrTests.Dt())
         && $IsAlloc(d#0, Tclass.MoreOrTests.Dt(), $Heap)
         && $IsA#MoreOrTests.Dt(d#0));
  modifies $Heap;
...
procedure {:verboseName "MoreOrTests.M (correctness)"} Impl$$MoreOrTests.__default.M(d#0: DatatypeType
       where $Is(d#0, Tclass.MoreOrTests.Dt())
         && $IsAlloc(d#0, Tclass.MoreOrTests.Dt(), $Heap)
         && $IsA#MoreOrTests.Dt(d#0))
