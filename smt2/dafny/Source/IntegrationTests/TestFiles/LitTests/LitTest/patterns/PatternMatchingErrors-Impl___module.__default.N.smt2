...
(let ((anon10_Then_correct  (=> (and (= |_mcc#1#0_0@0| |#_module.List.Nil|) (= (ControlFlow 0 5) (- 0 4))) false)))
(let ((anon9_Else_correct  (=> (or (not (= |_mcc#1#0_0@0| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#2#0_0_0@0|)) |_mcc#3#0_0_0@0|))) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon10_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Else_correct)))))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct  (=> (= |xs#0| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0_0@0|)) |_mcc#1#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List TInt) $Heap)) (and (=> (= (ControlFlow 0 8) 3) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct))))))
(let ((anon8_Else_correct true))
(let ((anon7_Else_correct  (=> (or (not (= |xs#0| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 9) 8) anon8_Then_correct) (=> (= (ControlFlow 0 9) 2) anon8_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |xs#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0| (Tclass._module.List TInt) $Heap)) (|$IsA#_module.List| |xs#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
