...
procedure {:verboseName "Lists.ContainsOne (well-formedness)"} CheckWellformed$$Lists.__default.ContainsOne(l#0: DatatypeType where $Is(l#0, Tclass.Lists.List(TInt)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Lists.ContainsOne (well-formedness)"} CheckWellformed$$Lists.__default.ContainsOne(l#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume $IsAllocBox($Box(l#0), Tclass.Lists.List(TInt), $Heap);
    assume Lists.List.Length#canCall(TInt, l#0);
    assume {:id "id2"} Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, l#0) == LitInt(3);
    ...
    else
    {
        ...
        assert {:id "id3"} Lists.List.Cons_q(l#0);
        if ($Unbox(Lists.List.car(l#0)): int != LitInt(1))
        {
            assert {:id "id4"} Lists.List.Cons_q(l#0);
            assert {:id "id5"} Lists.List.Cons_q(Lists.List.cdr(l#0));
        }

        if (!($Unbox(Lists.List.car(l#0)): int == LitInt(1)
           || $Unbox(Lists.List.car(Lists.List.cdr(l#0))): int == LitInt(1)))
        {
            assert {:id "id6"} Lists.List.Cons_q(l#0);
            assert {:id "id7"} Lists.List.Cons_q(Lists.List.cdr(l#0));
            assert {:id "id8"} Lists.List.Cons_q(Lists.List.cdr(Lists.List.cdr(l#0)));
        }

        assume {:id "id9"} Lists.__default.ContainsOne(l#0)
           == (
            $Unbox(Lists.List.car(l#0)): int == LitInt(1)
             || $Unbox(Lists.List.car(Lists.List.cdr(l#0))): int == LitInt(1)
             || $Unbox(Lists.List.car(Lists.List.cdr(Lists.List.cdr(l#0)))): int == LitInt(1));
        ...
        assume $Is(Lists.__default.ContainsOne(l#0), TBool);
        return;
...
procedure {:verboseName "Lists.ContainsOne' (well-formedness)"} CheckWellformed$$Lists.__default.ContainsOne_k(l#0: DatatypeType where $Is(l#0, Tclass.Lists.List(TInt)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Lists.ContainsOne' (well-formedness)"} CheckWellformed$$Lists.__default.ContainsOne_k(l#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var _mcc#0#0: int;
  ...
  var a#3#0#0: Box;
  var a#3#1#0: DatatypeType;
  var a#4#0#0: Box;
  var a#4#1#0: DatatypeType;
  var _mcc#10#0: int;
  var _mcc#11#0: DatatypeType;
  var a#6#0#0: Box;
  var a#6#1#0: DatatypeType;
  var a#7#0#0: Box;
  var a#7#1#0: DatatypeType;
  var _mcc#16#0: int;
  var _mcc#17#0: DatatypeType;
  var _mcc#18#0: int;
  var _mcc#19#0: DatatypeType;
  var a#10#0#0: Box;
  var a#10#1#0: DatatypeType;
  var a#11#0#0: Box;
  var a#11#1#0: DatatypeType;
  var _mcc#24#0: int;
  var _mcc#25#0: DatatypeType;
  var a#13#0#0: Box;
  var a#13#1#0: DatatypeType;
  var a#14#0#0: Box;
  var a#14#1#0: DatatypeType;
    ...
    assume $IsAllocBox($Box(l#0), Tclass.Lists.List(TInt), $Heap);
    assume Lists.List.Length#canCall(TInt, l#0);
    assume {:id "id12"} Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, l#0) == LitInt(3);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    {
        // Check well-formedness of body and result subset type constraint
        if (l#0 == #Lists.List.Cons($Box(_mcc#0#0), _mcc#1#0))
        {
            assume $Is(_mcc#1#0, Tclass.Lists.List(TInt));
            if (_mcc#0#0 == LitInt(1))
            {
                if (_mcc#1#0 == #Lists.List.Cons($Box(_mcc#2#0), _mcc#3#0))
                {
                    assume $Is(_mcc#3#0, Tclass.Lists.List(TInt));
                    if (_mcc#2#0 == LitInt(1))
                    {
                        if (_mcc#3#0 == #Lists.List.Cons($Box(_mcc#4#0), _mcc#5#0))
                        {
                            assume $Is(_mcc#5#0, Tclass.Lists.List(TInt));
                            if (_mcc#4#0 == LitInt(1))
                            {
                                havoc a#3#0#0, a#3#1#0;
                                if (_mcc#5#0 == #Lists.List.Nil())
                                {
                                    assume {:id "id17"} Lists.__default.ContainsOne_k(l#0) == Lit(true);
                                    assume true;
                                    // CheckWellformedWithResult: any expression
                                    assume $Is(Lists.__default.ContainsOne_k(l#0), TBool);
                                    return;
                                }
                                else if (_mcc#5#0 == #Lists.List.Cons(a#3#0#0, a#3#1#0))
                                {
                            ...
                            {
                                havoc a#4#0#0, a#4#1#0;
                                if (_mcc#5#0 == #Lists.List.Nil())
                                {
                                    assume {:id "id19"} Lists.__default.ContainsOne_k(l#0) == Lit(true);
                                    assume true;
                                    // CheckWellformedWithResult: any expression
                                    assume $Is(Lists.__default.ContainsOne_k(l#0), TBool);
                                    return;
                                }
                                else if (_mcc#5#0 == #Lists.List.Cons(a#4#0#0, a#4#1#0))
                                {
                        ...
                        else if (_mcc#3#0 == #Lists.List.Nil())
                        {
                            assert {:id "id15"} false;
                        }
                        else
                        {
                            assume false;
                    ...
                    {
                        if (_mcc#3#0 == #Lists.List.Cons($Box(_mcc#10#0), _mcc#11#0))
                        {
                            assume $Is(_mcc#11#0, Tclass.Lists.List(TInt));
                            if (_mcc#10#0 == LitInt(1))
                            {
                                havoc a#6#0#0, a#6#1#0;
                                if (_mcc#11#0 == #Lists.List.Nil())
                                {
                                    assume {:id "id22"} Lists.__default.ContainsOne_k(l#0) == Lit(true);
                                    assume true;
                                    // CheckWellformedWithResult: any expression
                                    assume $Is(Lists.__default.ContainsOne_k(l#0), TBool);
                                    return;
                                }
                                else if (_mcc#11#0 == #Lists.List.Cons(a#6#0#0, a#6#1#0))
                                {
                            ...
                            {
                                havoc a#7#0#0, a#7#1#0;
                                if (_mcc#11#0 == #Lists.List.Nil())
                                {
                                    assume {:id "id24"} Lists.__default.ContainsOne_k(l#0) == Lit(true);
                                    assume true;
                                    // CheckWellformedWithResult: any expression
                                    assume $Is(Lists.__default.ContainsOne_k(l#0), TBool);
                                    return;
                                }
                                else if (_mcc#11#0 == #Lists.List.Cons(a#7#0#0, a#7#1#0))
                                {
                ...
                else if (_mcc#1#0 == #Lists.List.Nil())
                {
            ...
            {
                if (_mcc#1#0 == #Lists.List.Cons($Box(_mcc#16#0), _mcc#17#0))
                {
                    assume $Is(_mcc#17#0, Tclass.Lists.List(TInt));
                    if (_mcc#16#0 == LitInt(1))
                    {
                        if (_mcc#17#0 == #Lists.List.Cons($Box(_mcc#18#0), _mcc#19#0))
                        {
                            assume $Is(_mcc#19#0, Tclass.Lists.List(TInt));
                            if (_mcc#18#0 == LitInt(1))
                            {
                                havoc a#10#0#0, a#10#1#0;
                                if (_mcc#19#0 == #Lists.List.Nil())
                                {
                                    assume {:id "id28"} Lists.__default.ContainsOne_k(l#0) == Lit(true);
                                    assume true;
                                    // CheckWellformedWithResult: any expression
                                    assume $Is(Lists.__default.ContainsOne_k(l#0), TBool);
                                    return;
                                }
                                else if (_mcc#19#0 == #Lists.List.Cons(a#10#0#0, a#10#1#0))
                                {
                            ...
                            {
                                havoc a#11#0#0, a#11#1#0;
                                if (_mcc#19#0 == #Lists.List.Nil())
                                {
                                    assume {:id "id30"} Lists.__default.ContainsOne_k(l#0) == Lit(true);
                                    assume true;
                                    // CheckWellformedWithResult: any expression
                                    assume $Is(Lists.__default.ContainsOne_k(l#0), TBool);
                                    return;
                                }
                                else if (_mcc#19#0 == #Lists.List.Cons(a#11#0#0, a#11#1#0))
                                {
                        ...
                        else if (_mcc#17#0 == #Lists.List.Nil())
                        {
                    ...
                    {
                        if (_mcc#17#0 == #Lists.List.Cons($Box(_mcc#24#0), _mcc#25#0))
                        {
                            assume $Is(_mcc#25#0, Tclass.Lists.List(TInt));
                            if (_mcc#24#0 == LitInt(1))
                            {
                                havoc a#13#0#0, a#13#1#0;
                                if (_mcc#25#0 == #Lists.List.Nil())
                                {
                                    assume {:id "id33"} Lists.__default.ContainsOne_k(l#0) == Lit(true);
                                    assume true;
                                    // CheckWellformedWithResult: any expression
                                    assume $Is(Lists.__default.ContainsOne_k(l#0), TBool);
                                    return;
                                }
                                else if (_mcc#25#0 == #Lists.List.Cons(a#13#0#0, a#13#1#0))
                                {
                                    assert {:id "id32"} false;
                                }
                                else
                                {
                                    assume false;
                            ...
                            {
                                havoc a#14#0#0, a#14#1#0;
                                if (_mcc#25#0 == #Lists.List.Nil())
                                {
                                    assume {:id "id35"} Lists.__default.ContainsOne_k(l#0) == Lit(false);
                                    assume true;
                                    // CheckWellformedWithResult: any expression
                                    assume $Is(Lists.__default.ContainsOne_k(l#0), TBool);
                                    return;
                                }
                                else if (_mcc#25#0 == #Lists.List.Cons(a#14#0#0, a#14#1#0))
                                {
...
procedure {:verboseName "Lists.ContainsOneOK (well-formedness)"} CheckWellFormed$$Lists.__default.ContainsOneOK(l#0: DatatypeType
       where $Is(l#0, Tclass.Lists.List(TInt))
         && $IsAlloc(l#0, Tclass.Lists.List(TInt), $Heap)
         && $IsA#Lists.List(l#0));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Lists.ContainsOneOK (well-formedness)"} CheckWellFormed$$Lists.__default.ContainsOneOK(l#0: DatatypeType)
{
  ...
  var ##l#1: DatatypeType;
    ...
    // AddMethodImpl: ContainsOneOK, CheckWellFormed$$Lists.__default.ContainsOneOK
    // initialize fuel constant
    assume StartFuel_Lists.List.Length
       == $LS($LS($LS($LS($LS(BaseFuel_Lists.List.Length)))));
    assume StartFuelAssert_Lists.List.Length
    ...
    assume $IsAllocBox($Box(l#0), Tclass.Lists.List(TInt), $Heap);
    assume Lists.List.Length#canCall(TInt, l#0);
    assume {:id "id36"} Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, l#0) == LitInt(3);
    havoc $Heap;
    assume old($Heap) == $Heap;
    ##l#0 := l#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##l#0, Tclass.Lists.List(TInt), $Heap);
    assert {:id "id37"} {:subsumption 0} Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, ##l#0) == LitInt(3);
    assume Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, ##l#0) == LitInt(3);
    assume Lists.__default.ContainsOne#canCall(l#0);
    ##l#1 := l#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##l#1, Tclass.Lists.List(TInt), $Heap);
    assert {:id "id38"} {:subsumption 0} Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, ##l#1) == LitInt(3);
    assume Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, ##l#1) == LitInt(3);
    assume Lists.__default.ContainsOne_k#canCall(l#0);
    assume {:id "id39"} Lists.__default.ContainsOne(l#0) == Lists.__default.ContainsOne_k(l#0);
}



procedure {:verboseName "Lists.ContainsOneOK (call)"} Call$$Lists.__default.ContainsOneOK(l#0: DatatypeType
       where $Is(l#0, Tclass.Lists.List(TInt))
         && $IsAlloc(l#0, Tclass.Lists.List(TInt), $Heap)
         && $IsA#Lists.List(l#0));
  // user-defined preconditions
  requires {:id "id40"} Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, l#0) == LitInt(3);
  modifies $Heap;
  // user-defined postconditions
  free ensures Lists.__default.ContainsOne#canCall(l#0)
     && Lists.__default.ContainsOne_k#canCall(l#0);
  ensures {:id "id41"} Lists.__default.ContainsOne(l#0) == Lists.__default.ContainsOne_k(l#0);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "Lists.ContainsOneOK (correctness)"} Impl$$Lists.__default.ContainsOneOK(l#0: DatatypeType
       where $Is(l#0, Tclass.Lists.List(TInt))
         && $IsAlloc(l#0, Tclass.Lists.List(TInt), $Heap)
         && $IsA#Lists.List(l#0))
  ...
  free requires 3 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id42"} Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, l#0) == LitInt(3);
  modifies $Heap;
  // user-defined postconditions
  free ensures Lists.__default.ContainsOne#canCall(l#0)
     && Lists.__default.ContainsOne_k#canCall(l#0);
  ensures {:id "id43"} Lists.__default.ContainsOne(l#0) == Lists.__default.ContainsOne_k(l#0);
  // frame condition
  free ensures old($Heap) == $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Lists.ContainsOneOK (correctness)"} Impl$$Lists.__default.ContainsOneOK(l#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $initHeapForallStmt#0: Heap;

    // AddMethodImpl: ContainsOneOK, Impl$$Lists.__default.ContainsOneOK
    // initialize fuel constant
    assume StartFuel_Lists.List.Length
       == $LS($LS($LS($LS($LS(BaseFuel_Lists.List.Length)))));
    assume StartFuelAssert_Lists.List.Length
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assume $IsA#Lists.List(l#0);
    $initHeapForallStmt#0 := $Heap;
    havoc $Heap;
    assume $initHeapForallStmt#0 == $Heap;
    assume (forall $ih#l0#0: DatatypeType :: 
      { Lists.__default.ContainsOne_k($ih#l0#0) } 
        { Lists.__default.ContainsOne($ih#l0#0) } 
        { Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, $ih#l0#0) } 
      $Is($ih#l0#0, Tclass.Lists.List(TInt))
           && Lists.List.Length(TInt, StartFuelAssert_Lists.List.Length, $ih#l0#0)
             == LitInt(3)
           && DtRank($ih#l0#0) < DtRank(l#0)
         ==> Lists.__default.ContainsOne($ih#l0#0) == Lists.__default.ContainsOne_k($ih#l0#0));
    $_reverifyPost := false;
}
...
axiom 1 <= $FunctionContextHeight
   ==> (forall Lists.List$T: Ty, $ly: LayerType, this: DatatypeType :: 
    { Lists.List.Length(Lists.List$T, $ly, this) } 
    Lists.List.Length#canCall(Lists.List$T, this)
         || (1 < $FunctionContextHeight && $Is(this, Tclass.Lists.List(Lists.List$T)))
   ...
   ==> (forall Lists.List$T: Ty, $ly: LayerType, this: DatatypeType :: 
    ...
    Lists.List.Length#canCall(Lists.List$T, this)
       ...
       ==> (!Lists.List.Nil_q(this)
           ==> (var t#1 := Lists.List.cdr(this); Lists.List.Length#canCall(Lists.List$T, t#1)))
         && Lists.List.Length(Lists.List$T, $LS($ly), this)
           == (if Lists.List.Nil_q(this)
             then 0
             else (var t#0 := Lists.List.cdr(this); 1 + Lists.List.Length(Lists.List$T, $ly, t#0))));
   ...
   ==> (forall Lists.List$T: Ty, $ly: LayerType, this: DatatypeType :: 
    ...
    Lists.List.Length#canCall(Lists.List$T, Lit(this))
       ...
       ==> (!Lit(Lists.List.Nil_q(Lit(this)))
           ==> (var t#3 := Lit(Lists.List.cdr(Lit(this))); 
            Lists.List.Length#canCall(Lists.List$T, t#3)))
         && Lists.List.Length(Lists.List$T, $LS($ly), Lit(this))
           == (if Lists.List.Nil_q(Lit(this))
             then 0
             else (var t#2 := Lit(Lists.List.cdr(Lit(this))); 
              LitInt(1 + Lists.List.Length(Lists.List$T, $LS($ly), t#2)))));
}
...
procedure {:verboseName "Lists.List.Length (well-formedness)"} CheckWellformed$$Lists.List.Length(Lists.List$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass.Lists.List(Lists.List$T))
         && $IsAlloc(this, Tclass.Lists.List(Lists.List$T), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Lists.List.Length (well-formedness)"} CheckWellformed$$Lists.List.Length(Lists.List$T: Ty, this: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var _mcc#0#0: Box;
  var _mcc#1#0: DatatypeType;
  ...
  var let#0#0#0: DatatypeType;
    ...
    if (*)
    {
        // Check well-formedness of postcondition and assume false
        assume LitInt(0)
           <= Lists.List.Length(Lists.List$T, StartFuelAssert_Lists.List.Length, this);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        if (this == #Lists.List.Nil())
        {
            assert {:id "id51"} $Is(LitInt(0), Tclass._System.nat());
            assume {:id "id52"} Lists.List.Length(Lists.List$T, StartFuelAssert_Lists.List.Length, this)
               == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(Lists.List.Length(Lists.List$T, StartFuelAssert_Lists.List.Length, this), 
              Tclass._System.nat());
            return;
        }
        else if (this == #Lists.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            assume $IsBox(_mcc#0#0, Lists.List$T);
            assume $Is(_mcc#1#0, Tclass.Lists.List(Lists.List$T));
            havoc t#Z#0;
            assume {:id "id46"} let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass.Lists.List(Lists.List$T));
            assume {:id "id47"} t#Z#0 == let#0#0#0;
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(t#Z#0), Tclass.Lists.List(Lists.List$T), $Heap);
            assert {:id "id48"} DtRank(t#Z#0) < DtRank(this);
            assume Lists.List.Length#canCall(Lists.List$T, t#Z#0);
            assert {:id "id49"} $Is(1 + Lists.List.Length(Lists.List$T, StartFuelAssert_Lists.List.Length, t#Z#0), 
              Tclass._System.nat());
            assume {:id "id50"} Lists.List.Length(Lists.List$T, StartFuelAssert_Lists.List.Length, this)
               == 1 + Lists.List.Length(Lists.List$T, StartFuelAssert_Lists.List.Length, t#Z#0);
            assume Lists.List.Length#canCall(Lists.List$T, t#Z#0);
            // CheckWellformedWithResult: any expression
            assume $Is(Lists.List.Length(Lists.List$T, StartFuelAssert_Lists.List.Length, this), 
              Tclass._System.nat());
