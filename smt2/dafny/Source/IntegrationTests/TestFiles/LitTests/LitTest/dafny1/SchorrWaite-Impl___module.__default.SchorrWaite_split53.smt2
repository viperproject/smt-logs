...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split53)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon128_Then_correct  (=> (and (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |n#14@0| null)) (not true)))))
