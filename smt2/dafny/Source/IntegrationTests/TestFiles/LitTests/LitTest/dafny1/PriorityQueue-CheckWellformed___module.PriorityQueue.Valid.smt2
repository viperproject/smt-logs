...
(assert (forall (($h@@16 T@U) ($o@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) Tclass._module.PriorityQueue?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@17) _module.PriorityQueue.a)) (Tclass._System.array TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |488|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@17) _module.PriorityQueue.a)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.PriorityQueue.Valid)
...
(let ((anon10_correct  (=> (= (_module.PriorityQueue.Valid $Heap@@1 this@@1)  (and (_module.PriorityQueue.MostlyValid $Heap@@1 this@@1) (forall ((|j#2| Int) ) (!  (=> (and (<= (LitInt 2) |j#2|) (<= |j#2| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.n))))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a))) (IndexField (Div |j#2| (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a))) (IndexField |j#2|))))))
 :qid |PriorityQueuedfy.15:12|
 :skolemid |499|
 :pattern ( (Div |j#2| 2))
)))) (=> (and (|_module.PriorityQueue.MostlyValid#canCall| $Heap@@1 this@@1) ($Is boolType (bool_2_U (_module.PriorityQueue.Valid $Heap@@1 this@@1)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 8)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 3) (- 0 7)) |b$reqreads#2@2|) (=> |b$reqreads#2@2| (and (=> (= (ControlFlow 0 3) (- 0 6)) |b$reqreads#3@2|) (=> |b$reqreads#3@2| (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#4@2|) (=> |b$reqreads#4@2| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#5@2|) (=> |b$reqreads#5@2| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#6@2|)))))))))))))))
...
(let ((anon16_Else_correct  (=> (and (not (and (<= (LitInt 2) |j#1@0|) (<= |j#1@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.n)))))) (= |b$reqreads#3@1| true)) (=> (and (and (= |b$reqreads#4@1| true) (= |b$reqreads#5@1| true)) (and (= |b$reqreads#6@1| true) (= (ControlFlow 0 18) 11))) anon9_correct))))
(let ((anon16_Then_correct  (=> (and (and (<= (LitInt 2) |j#1@0|) (<= |j#1@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.n))))) (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.PriorityQueue.a)))) (and (=> (= (ControlFlow 0 12) (- 0 17)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a)) null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 16)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (and (<= 0 (Div |j#1@0| (LitInt 2))) (< (Div |j#1@0| (LitInt 2)) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a)))))) (=> (and (<= 0 (Div |j#1@0| (LitInt 2))) (< (Div |j#1@0| (LitInt 2)) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a))))) (=> (and (= |b$reqreads#4@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a)) (IndexField (Div |j#1@0| (LitInt 2)))))) (= |b$reqreads#5@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.PriorityQueue.a)))) (and (=> (= (ControlFlow 0 12) (- 0 14)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a)) null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (and (<= 0 |j#1@0|) (< |j#1@0| (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a)))))) (=> (and (<= 0 |j#1@0|) (< |j#1@0| (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a))))) (=> (and (= |b$reqreads#6@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.a)) (IndexField |j#1@0|)))) (= |b$reqreads#3@1| |b$reqreads#3@0|)) (=> (and (and (= |b$reqreads#4@1| |b$reqreads#4@0|) (= |b$reqreads#5@1| |b$reqreads#5@0|)) (and (= |b$reqreads#6@1| |b$reqreads#6@0|) (= (ControlFlow 0 12) 11))) anon9_correct))))))))))))))))
...
(let ((anon15_Then_correct  (=> (<= (LitInt 2) |j#1@0|) (=> (and (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.PriorityQueue.n))) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (=> (= (ControlFlow 0 19) 12) anon16_Then_correct) (=> (= (ControlFlow 0 19) 18) anon16_Else_correct))))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 21) 19) anon15_Then_correct) (=> (= (ControlFlow 0 21) 20) anon15_Else_correct))))
(let ((anon13_Then_correct  (=> (_module.PriorityQueue.MostlyValid $Heap@@1 this@@1) (and (=> (= (ControlFlow 0 22) 21) anon14_Then_correct) (=> (= (ControlFlow 0 22) 10) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (not (_module.PriorityQueue.MostlyValid $Heap@@1 this@@1)) (=> (and (= |b$reqreads#2@2| true) (= |b$reqreads#6@2| true)) (=> (and (and (= |b$reqreads#5@2| true) (= |b$reqreads#4@2| true)) (and (= |b$reqreads#3@2| true) (= (ControlFlow 0 9) 3))) anon10_correct)))))
(let ((anon12_Else_correct  (=> ($IsAllocBox ($Box refType this@@1) Tclass._module.PriorityQueue? $Heap@@1) (=> (and (= |b$reqreads#1@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@18) alloc)))) (or (= $o@@18 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.Repr)) ($Box refType $o@@18)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |PriorityQueuedfy.14:5|
 :skolemid |497|
))) (|_module.PriorityQueue.MostlyValid#canCall| $Heap@@1 this@@1)) (and (=> (= (ControlFlow 0 23) 22) anon13_Then_correct) (=> (= (ControlFlow 0 23) 9) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc this@@1 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.PriorityQueue.Repr)))) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.PriorityQueue.Repr)))) (and (=> (= (ControlFlow 0 24) (- 0 25)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 24) 1) anon12_Then_correct) (=> (= (ControlFlow 0 24) 23) anon12_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.PriorityQueue) ($IsAlloc refType this@@1 Tclass._module.PriorityQueue $Heap@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 26) 24))) anon0_correct))))
