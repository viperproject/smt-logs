...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split117)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 110) (let ((anon164_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#26@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#26@0|) _module.Node.marked)))) (and ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType |n#26@0| Tclass._module.Node $Heap@@3))))
(let ((anon163_Else_correct  (=> (and (not (|Set#IsMember| |S#0@@5| ($Box refType |n#26@0|))) (= (ControlFlow 0 4) 2)) anon164_Then_correct)))
(let ((anon163_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#26@0|)) (= (ControlFlow 0 3) 2)) anon164_Then_correct)))
(let ((anon85_correct  (=> (and (and (forall ((|n#25| T@U) ) (!  (=> ($Is refType |n#25| Tclass._module.Node) (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#25|)) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#25|) _module.Node.marked))) (let ((|pth#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#25|) _module.Node.pathFromRoot))))
...
))) (and ($Is refType |n#26@0| Tclass._module.Node) ($IsAlloc refType |n#26@0| Tclass._module.Node $Heap@2))) (and (=> (= (ControlFlow 0 5) 3) anon163_Then_correct) (=> (= (ControlFlow 0 5) 4) anon163_Else_correct)))))
(let ((anon161_Else_correct  (=> (and (not ($IsAllocBox ($Box DatatypeTypeType |pth#Z#0@0|) Tclass._module.Path $Heap@@3)) (= (ControlFlow 0 9) 5)) anon85_correct)))
(let ((anon161_Then_correct  (=> ($IsAllocBox ($Box DatatypeTypeType |pth#Z#0@0|) Tclass._module.Path $Heap@@3) (=> (and ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3) ($IsAlloc DatatypeTypeType |pth#Z#0@0| Tclass._module.Path $Heap@@3)) (=> (and (and ($IsAlloc refType |n#24@0| Tclass._module.Node $Heap@@3) ($IsAlloc SetType |S#0@@5| (TSet Tclass._module.Node) $Heap@@3)) (and (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |pth#Z#0@0| |n#24@0| |S#0@@5|) (= (ControlFlow 0 8) 5))) anon85_correct)))))
(let ((anon160_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.marked)))) (= |let#0#0#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.pathFromRoot)))) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Path) (= |pth#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 10) 8) anon161_Then_correct) (=> (= (ControlFlow 0 10) 9) anon161_Else_correct)))))
(let ((anon160_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.marked))))) (= (ControlFlow 0 7) 5)) anon85_correct)))
(let ((anon159_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|))) (and (=> (= (ControlFlow 0 12) 10) anon160_Then_correct) (=> (= (ControlFlow 0 12) 7) anon160_Else_correct)))))
(let ((anon159_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|)) (and (=> (= (ControlFlow 0 11) 10) anon160_Then_correct) (=> (= (ControlFlow 0 11) 7) anon160_Else_correct)))))
(let ((anon158_Then_correct  (=> (and ($Is refType |n#24@0| Tclass._module.Node) ($IsAlloc refType |n#24@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 13) 11) anon159_Then_correct) (=> (= (ControlFlow 0 13) 12) anon159_Else_correct)))))
(let ((anon158_Else_correct  (=> (and (not (and ($Is refType |n#24@0| Tclass._module.Node) ($IsAlloc refType |n#24@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 6) 5)) anon85_correct)))
(let ((anon79_correct  (=> (=> ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3) (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@1| |t#0@0| |S#0@@5|)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3) (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |root#0| |path#0@1| |t#0@0| |S#0@@5|)) (and (=> (= (ControlFlow 0 14) 13) anon158_Then_correct) (=> (= (ControlFlow 0 14) 6) anon158_Else_correct))))))
(let ((anon157_Else_correct  (=> (and (not ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3)) (= (ControlFlow 0 16) 14)) anon79_correct)))
(let ((anon157_Then_correct  (=> (and (and (and ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3) ($Is refType |t#0@0| Tclass._module.Node)) (and ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3) ($IsAlloc DatatypeTypeType |path#0@1| Tclass._module.Path $Heap@@3))) (and (and ($IsAlloc refType |t#0@0| Tclass._module.Node? $Heap@@3) ($IsAlloc SetType |S#0@@5| (TSet Tclass._module.Node) $Heap@@3)) (and (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@1| |t#0@0| |S#0@@5|) (= (ControlFlow 0 15) 14)))) anon79_correct)))
...
))) (and (=> (= (ControlFlow 0 17) 15) anon157_Then_correct) (=> (= (ControlFlow 0 17) 16) anon157_Else_correct)))))
(let ((anon156_Else_correct  (=> (and (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.children)) |j#2@0|)) null) (= (ControlFlow 0 23) 17)) anon77_correct)))
(let ((anon156_Then_correct  (=> (and (or (not (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.children)) |j#2@0|)) null)) (not true)) (= (ControlFlow 0 22) 17)) anon77_correct)))
(let ((anon155_Then_correct  (=> (and (<= (LitInt 0) |j#2@0|) (< |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.childrenVisited))))) (and (=> (= (ControlFlow 0 24) 22) anon156_Then_correct) (=> (= (ControlFlow 0 24) 23) anon156_Else_correct)))))
(let ((anon155_Else_correct  (=> (and (not (and (<= (LitInt 0) |j#2@0|) (< |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.childrenVisited)))))) (= (ControlFlow 0 21) 17)) anon77_correct)))
(let ((anon154_Else_correct  (=> (< |j#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 26) 24) anon155_Then_correct) (=> (= (ControlFlow 0 26) 21) anon155_Else_correct)))))
(let ((anon154_Then_correct  (=> (<= (LitInt 0) |j#2@0|) (and (=> (= (ControlFlow 0 25) 24) anon155_Then_correct) (=> (= (ControlFlow 0 25) 21) anon155_Else_correct)))))
(let ((anon152_Then_correct  (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.marked))) (and (=> (= (ControlFlow 0 27) 25) anon154_Then_correct) (=> (= (ControlFlow 0 27) 26) anon154_Else_correct)))))
(let ((anon152_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.marked)))) (= (ControlFlow 0 20) 17)) anon77_correct)))
(let ((anon151_Then_correct  (=> (or (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#20@0|)) (= |n#20@0| |t#0@0|)) (and (=> (= (ControlFlow 0 28) 27) anon152_Then_correct) (=> (= (ControlFlow 0 28) 20) anon152_Else_correct)))))
(let ((anon151_Else_correct  (=> (and (not (or (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#20@0|)) (= |n#20@0| |t#0@0|))) (= (ControlFlow 0 19) 17)) anon77_correct)))
(let ((anon150_Else_correct  (=> (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#20@0|)) (and (=> (= (ControlFlow 0 30) 28) anon151_Then_correct) (=> (= (ControlFlow 0 30) 19) anon151_Else_correct)))))
(let ((anon150_Then_correct  (=> (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#20@0|))) (and (=> (= (ControlFlow 0 29) 28) anon151_Then_correct) (=> (= (ControlFlow 0 29) 19) anon151_Else_correct)))))
(let ((anon149_Then_correct  (=> (and ($Is refType |n#20@0| Tclass._module.Node) ($IsAlloc refType |n#20@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 31) 29) anon150_Then_correct) (=> (= (ControlFlow 0 31) 30) anon150_Else_correct)))))
(let ((anon149_Else_correct  (=> (and (not (and ($Is refType |n#20@0| Tclass._module.Node) ($IsAlloc refType |n#20@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 18) 17)) anon77_correct)))
...
)) (and (=> (= (ControlFlow 0 32) 31) anon149_Then_correct) (=> (= (ControlFlow 0 32) 18) anon149_Else_correct)))))
(let ((anon148_Else_correct  (=> (and (not (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.children)) ($Box refType |ch#6@0|)) (or (not (= |ch#6@0| null)) (not true)))) (= (ControlFlow 0 37) 32)) anon65_correct)))
(let ((anon148_Then_correct  (=> (and (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.children)) ($Box refType |ch#6@0|)) (or (not (= |ch#6@0| null)) (not true))) (= (ControlFlow 0 36) 32)) anon65_correct)))
(let ((anon147_Else_correct  (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.children)) ($Box refType |ch#6@0|))) (and (=> (= (ControlFlow 0 39) 36) anon148_Then_correct) (=> (= (ControlFlow 0 39) 37) anon148_Else_correct)))))
(let ((anon147_Then_correct  (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.children)) ($Box refType |ch#6@0|)) (and (=> (= (ControlFlow 0 38) 36) anon148_Then_correct) (=> (= (ControlFlow 0 38) 37) anon148_Else_correct)))))
(let ((anon146_Then_correct  (=> (and ($Is refType |ch#6@0| Tclass._module.Node?) ($IsAlloc refType |ch#6@0| Tclass._module.Node? $Heap@2)) (and (=> (= (ControlFlow 0 40) 38) anon147_Then_correct) (=> (= (ControlFlow 0 40) 39) anon147_Else_correct)))))
(let ((anon146_Else_correct  (=> (and (not (and ($Is refType |ch#6@0| Tclass._module.Node?) ($IsAlloc refType |ch#6@0| Tclass._module.Node? $Heap@2))) (= (ControlFlow 0 35) 32)) anon65_correct)))
(let ((anon145_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#18@0|)))) (or (not (= |n#18@0| |t#0@0|)) (not true))) (and (=> (= (ControlFlow 0 41) 40) anon146_Then_correct) (=> (= (ControlFlow 0 41) 35) anon146_Else_correct)))))
(let ((anon145_Else_correct  (=> (and (not (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#18@0|)))) (or (not (= |n#18@0| |t#0@0|)) (not true)))) (= (ControlFlow 0 34) 32)) anon65_correct)))
(let ((anon144_Else_correct  (=> (not (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#18@0|))))) (and (=> (= (ControlFlow 0 43) 41) anon145_Then_correct) (=> (= (ControlFlow 0 43) 34) anon145_Else_correct)))))
(let ((anon144_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#18@0|)))) (and (=> (= (ControlFlow 0 42) 41) anon145_Then_correct) (=> (= (ControlFlow 0 42) 34) anon145_Else_correct)))))
(let ((anon143_Else_correct  (=> (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked))))) (and (=> (= (ControlFlow 0 45) 42) anon144_Then_correct) (=> (= (ControlFlow 0 45) 43) anon144_Else_correct)))))
(let ((anon143_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (and (=> (= (ControlFlow 0 44) 42) anon144_Then_correct) (=> (= (ControlFlow 0 44) 43) anon144_Else_correct)))))
(let ((anon142_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|))) (and (=> (= (ControlFlow 0 47) 44) anon143_Then_correct) (=> (= (ControlFlow 0 47) 45) anon143_Else_correct)))))
(let ((anon142_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (and (=> (= (ControlFlow 0 46) 44) anon143_Then_correct) (=> (= (ControlFlow 0 46) 45) anon143_Else_correct)))))
(let ((anon141_Then_correct  (=> (and ($Is refType |n#18@0| Tclass._module.Node) ($IsAlloc refType |n#18@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 48) 46) anon142_Then_correct) (=> (= (ControlFlow 0 48) 47) anon142_Else_correct)))))
(let ((anon141_Else_correct  (=> (and (not (and ($Is refType |n#18@0| Tclass._module.Node) ($IsAlloc refType |n#18@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 33) 32)) anon65_correct)))
(let ((anon51_correct  (=> (and (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1)))) _module.Node.childrenVisited))))) |t#0@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |root#0|) _module.Node.marked)))) (and (=> (= (ControlFlow 0 49) 48) anon141_Then_correct) (=> (= (ControlFlow 0 49) 33) anon141_Else_correct)))))
(let ((anon140_Else_correct  (=> (and (<= (|Seq#Length| |stackNodes#0@1|) 0) (= (ControlFlow 0 51) 49)) anon51_correct)))
(let ((anon140_Then_correct  (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (=> (and ($IsAlloc refType ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))) Tclass._module.Node $Heap@@3) (= (ControlFlow 0 50) 49)) anon51_correct))))
...
)) (and (=> (= (ControlFlow 0 52) 50) anon140_Then_correct) (=> (= (ControlFlow 0 52) 51) anon140_Else_correct)))))
(let ((anon139_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#2@0|) (< |k#2@0| (- (|Seq#Length| |stackNodes#0@1|) 1)))) (= (ControlFlow 0 54) 52)) anon49_correct)))
(let ((anon139_Then_correct  (=> (and (and (<= (LitInt 0) |k#2@0|) (< |k#2@0| (- (|Seq#Length| |stackNodes#0@1|) 1))) (and ($IsAlloc refType ($Unbox refType (|Seq#Index| |stackNodes#0@1| |k#2@0|)) Tclass._module.Node $Heap@@3) (= (ControlFlow 0 53) 52))) anon49_correct)))
(let ((anon138_Else_correct  (=> (< |k#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 56) 53) anon139_Then_correct) (=> (= (ControlFlow 0 56) 54) anon139_Else_correct)))))
(let ((anon138_Then_correct  (=> (<= (LitInt 0) |k#2@0|) (and (=> (= (ControlFlow 0 55) 53) anon139_Then_correct) (=> (= (ControlFlow 0 55) 54) anon139_Else_correct)))))
...
)) (and (=> (= (ControlFlow 0 57) 55) anon138_Then_correct) (=> (= (ControlFlow 0 57) 56) anon138_Else_correct)))))
(let ((anon136_Else_correct  (=> (and (not (and (< 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |stackNodes#0@1|)))) (= (ControlFlow 0 59) 57)) anon44_correct)))
(let ((anon136_Then_correct  (=> (and (and (< 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 58) 57)) anon44_correct)))
(let ((anon135_Else_correct  (=> (<= |k#0@0| 0) (and (=> (= (ControlFlow 0 61) 58) anon136_Then_correct) (=> (= (ControlFlow 0 61) 59) anon136_Else_correct)))))
(let ((anon135_Then_correct  (=> (< 0 |k#0@0|) (and (=> (= (ControlFlow 0 60) 58) anon136_Then_correct) (=> (= (ControlFlow 0 60) 59) anon136_Else_correct)))))
(let ((anon39_correct  (=> (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.childrenVisited))))) null)) (and (=> (= (ControlFlow 0 62) 60) anon135_Then_correct) (=> (= (ControlFlow 0 62) 61) anon135_Else_correct)))))
(let ((anon133_Else_correct  (=> (and (<= (|Seq#Length| |stackNodes#0@1|) 0) (= (ControlFlow 0 64) 62)) anon39_correct)))
(let ((anon133_Then_correct  (=> (and (and (< 0 (|Seq#Length| |stackNodes#0@1|)) (|Seq#Contains| |stackNodes#0@1| (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.children)))) (= (ControlFlow 0 63) 62))) anon39_correct)))
...
)) (and (=> (= (ControlFlow 0 65) 63) anon133_Then_correct) (=> (= (ControlFlow 0 65) 64) anon133_Else_correct)))))
(let ((anon132_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#16@0|))))) (= (ControlFlow 0 68) 65)) anon37_correct)))
(let ((anon132_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#16@0|)))) (and ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@@3) (= (ControlFlow 0 67) 65))) anon37_correct)))
(let ((anon131_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|))) (and (=> (= (ControlFlow 0 70) 67) anon132_Then_correct) (=> (= (ControlFlow 0 70) 68) anon132_Else_correct)))))
(let ((anon131_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (and (=> (= (ControlFlow 0 69) 67) anon132_Then_correct) (=> (= (ControlFlow 0 69) 68) anon132_Else_correct)))))
(let ((anon130_Then_correct  (=> (and ($Is refType |n#16@0| Tclass._module.Node) ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 71) 69) anon131_Then_correct) (=> (= (ControlFlow 0 71) 70) anon131_Else_correct)))))
(let ((anon130_Else_correct  (=> (and (not (and ($Is refType |n#16@0| Tclass._module.Node) ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 66) 65)) anon37_correct)))
...
)) (and (=> (= (ControlFlow 0 72) 71) anon130_Then_correct) (=> (= (ControlFlow 0 72) 66) anon130_Else_correct)))))
(let ((anon129_Else_correct  (=> (and (= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.childrenVisited)))) (= (ControlFlow 0 78) 72)) anon32_correct)))
(let ((anon129_Then_correct  (=> (or (not (= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.childrenVisited))))) (not true)) (=> (and ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@@3) (= (ControlFlow 0 77) 72)) anon32_correct))))
(let ((anon128_Then_correct  (=> (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))))) (and (=> (= (ControlFlow 0 79) 77) anon129_Then_correct) (=> (= (ControlFlow 0 79) 78) anon129_Else_correct)))))
(let ((anon128_Else_correct  (=> (and (not (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children)))))) (= (ControlFlow 0 76) 72)) anon32_correct)))
(let ((anon127_Else_correct  (=> (< |j#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 81) 79) anon128_Then_correct) (=> (= (ControlFlow 0 81) 76) anon128_Else_correct)))))
(let ((anon127_Then_correct  (=> (<= (LitInt 0) |j#0@0|) (and (=> (= (ControlFlow 0 80) 79) anon128_Then_correct) (=> (= (ControlFlow 0 80) 76) anon128_Else_correct)))))
(let ((anon125_Then_correct  (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#14@0|) _module.Node.children)))) (and (=> (= (ControlFlow 0 82) 80) anon127_Then_correct) (=> (= (ControlFlow 0 82) 81) anon127_Else_correct)))))
(let ((anon125_Else_correct  (=> (and (or (not (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#14@0|) _module.Node.children))))) (not true)) (= (ControlFlow 0 75) 72)) anon32_correct)))
(let ((anon124_Then_correct  (=> (and (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#14@0|)) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@@3)) (and (=> (= (ControlFlow 0 83) 82) anon125_Then_correct) (=> (= (ControlFlow 0 83) 75) anon125_Else_correct)))))
(let ((anon124_Else_correct  (=> (and (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#14@0|))) (= (ControlFlow 0 74) 72)) anon32_correct)))
(let ((anon123_Then_correct  (=> (and ($Is refType |n#14@0| Tclass._module.Node) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 84) 83) anon124_Then_correct) (=> (= (ControlFlow 0 84) 74) anon124_Else_correct)))))
(let ((anon123_Else_correct  (=> (and (not (and ($Is refType |n#14@0| Tclass._module.Node) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 73) 72)) anon32_correct)))
...
)) (and (=> (= (ControlFlow 0 85) 84) anon123_Then_correct) (=> (= (ControlFlow 0 85) 73) anon123_Else_correct)))))
(let ((anon122_Else_correct  (=> (and (not (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (or (not (= |n#12@0| |t#0@0|)) (not true)))) (= (ControlFlow 0 88) 85)) anon22_correct)))
(let ((anon122_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (or (not (= |n#12@0| |t#0@0|)) (not true))) (= (ControlFlow 0 87) 85)) anon22_correct)))
(let ((anon121_Else_correct  (=> (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|))))) (and (=> (= (ControlFlow 0 90) 87) anon122_Then_correct) (=> (= (ControlFlow 0 90) 88) anon122_Else_correct)))))
(let ((anon121_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (and (=> (= (ControlFlow 0 89) 87) anon122_Then_correct) (=> (= (ControlFlow 0 89) 88) anon122_Else_correct)))))
(let ((anon120_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|))) (and (=> (= (ControlFlow 0 92) 89) anon121_Then_correct) (=> (= (ControlFlow 0 92) 90) anon121_Else_correct)))))
(let ((anon120_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (and (=> (= (ControlFlow 0 91) 89) anon121_Then_correct) (=> (= (ControlFlow 0 91) 90) anon121_Else_correct)))))
(let ((anon119_Then_correct  (=> (and ($Is refType |n#12@0| Tclass._module.Node) ($IsAlloc refType |n#12@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 93) 91) anon120_Then_correct) (=> (= (ControlFlow 0 93) 92) anon120_Else_correct)))))
(let ((anon119_Else_correct  (=> (and (not (and ($Is refType |n#12@0| Tclass._module.Node) ($IsAlloc refType |n#12@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 86) 85)) anon22_correct)))
...
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))))) (and (=> (= (ControlFlow 0 94) 93) anon119_Then_correct) (=> (= (ControlFlow 0 94) 86) anon119_Else_correct)))))
(let ((anon118_Else_correct  (=> (and (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#10@0|))) (= (ControlFlow 0 97) 94)) anon15_correct)))
(let ((anon118_Then_correct  (=> (and (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#10@0|)) (= (ControlFlow 0 96) 94)) anon15_correct)))
(let ((anon117_Then_correct  (=> (and ($Is refType |n#10@0| Tclass._module.Node) ($IsAlloc refType |n#10@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 98) 96) anon118_Then_correct) (=> (= (ControlFlow 0 98) 97) anon118_Else_correct)))))
(let ((anon117_Else_correct  (=> (and (not (and ($Is refType |n#10@0| Tclass._module.Node) ($IsAlloc refType |n#10@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 95) 94)) anon15_correct)))
(let ((anon12_correct  (=> (= |p#0@0| (ite (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))))) (and (=> (= (ControlFlow 0 99) 98) anon117_Then_correct) (=> (= (ControlFlow 0 99) 95) anon117_Else_correct)))))
(let ((anon116_Else_correct  (=> (and (or (not (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0))) (not true)) (= (ControlFlow 0 101) 99)) anon12_correct)))
(let ((anon116_Then_correct  (=> (and (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) (= (ControlFlow 0 100) 99)) anon12_correct)))
(let ((anon9_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |t#0@0|)))) (and (=> (= (ControlFlow 0 102) 100) anon116_Then_correct) (=> (= (ControlFlow 0 102) 101) anon116_Else_correct)))))
(let ((anon115_Else_correct  (=> (and (not (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|))) (= (ControlFlow 0 104) 102)) anon9_correct)))
(let ((anon115_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|)) (= (ControlFlow 0 103) 102)) anon9_correct)))
...
)) (and (=> (= (ControlFlow 0 105) 103) anon115_Then_correct) (=> (= (ControlFlow 0 105) 104) anon115_Else_correct)))))
(let ((anon114_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|)))) (= (ControlFlow 0 107) 105)) anon7_correct)))
(let ((anon114_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 106) 105)) anon7_correct)))
(let ((anon113_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 109) 106) anon114_Then_correct) (=> (= (ControlFlow 0 109) 107) anon114_Else_correct)))))
(let ((anon113_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 108) 106) anon114_Then_correct) (=> (= (ControlFlow 0 108) 107) anon114_Else_correct)))))
...
)))) (and (and (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (=> (|Set#Equal| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (and (<= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (=> (= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) |$decr_init$loop#02@0|))))) (not |$w$loop#0@0|))))))) (and (=> (= (ControlFlow 0 110) 108) anon113_Then_correct) (=> (= (ControlFlow 0 110) 109) anon113_Else_correct)))))))
anon0_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
