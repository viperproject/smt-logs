...
(assert (distinct alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 Tagclass._module.Nat Tagclass._module.List |##_module.List.Nil| |##_module.List.Cons| |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| tytagFamily$Nat tytagFamily$List)
)
...
(assert (forall (($ly@@2 T@U) (|f#0@@4| T@U) (|xs#0@@2| T@U) ) (! (= (_module.__default.apply ($LS $ly@@2) |f#0@@4| |xs#0@@2|) (_module.__default.apply $ly@@2 |f#0@@4| |xs#0@@2|))
 :qid |Ripplinglegacydfy.163:16|
 :skolemid |699|
 :pattern ( (_module.__default.apply ($LS $ly@@2) |f#0@@4| |xs#0@@2|))
)))
...
(assert (forall ((d@@4 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) ($Is DatatypeTypeType d@@4 Tclass._module.Nat)) ($IsAlloc DatatypeTypeType d@@4 Tclass._module.Nat $h@@1))
 :qid |unknown.0:0|
 :skolemid |1233|
 :pattern ( ($IsAlloc DatatypeTypeType d@@4 Tclass._module.Nat $h@@1))
)))
(assert (forall ((d@@5 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) ($Is DatatypeTypeType d@@5 Tclass._module.List)) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.List $h@@2))
 :qid |unknown.0:0|
 :skolemid |1253|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 Tclass._module.List $h@@2))
)))
...
(assert (forall ((d@@6 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.List $h@@3))) ($IsAlloc DatatypeTypeType (_module.List._h1 d@@6) Tclass._module.Nat $h@@3))
 :qid |unknown.0:0|
 :skolemid |1246|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h1 d@@6) Tclass._module.Nat $h@@3))
)))
(assert (forall ((d@@7 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.List.Cons_q d@@7) ($IsAlloc DatatypeTypeType d@@7 Tclass._module.List $h@@4))) ($IsAlloc DatatypeTypeType (_module.List._h2 d@@7) Tclass._module.List $h@@4))
 :qid |unknown.0:0|
 :skolemid |1247|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h2 d@@7) Tclass._module.List $h@@4))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|f#0@@7| T@U) (|xs#0@@3| T@U) ) (!  (=> (or (|_module.__default.apply#canCall| |f#0@@7| |xs#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.apply $ly@@3 |f#0@@7| |xs#0@@3|) Tclass._module.List))
 :qid |Ripplinglegacydfy.163:16|
 :skolemid |701|
 :pattern ( (_module.__default.apply $ly@@3 |f#0@@7| |xs#0@@3|))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.apply)
...
(let ((anon10_Then_correct  (=> (and (and (= |xs#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat)) (and ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List) (= |let#0#0#0| |_mcc#1#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List) (= |ys#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#0#0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat))) (and (and (= |y#Z#0@0| |let#1#0#0|) ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat) $Heap@@2)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap@@2) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@4|))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($Is DatatypeTypeType |xs#0@@4| Tclass._module.List)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
