...
(declare-fun |u#0| () T@U)
(declare-fun |v#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Main.Main2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#16| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q0#0|) _module.Queue.footprint)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q1#0|) _module.Queue.footprint)))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= |q0#0| null)) (not true))) (=> (or (not (= |q0#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |q0#0|) (Tclass._module.Queue? _module.Main$U@@9) $Heap@@1) (=> (and (|_module.Queue.Valid#canCall| _module.Main$U@@9 $Heap@@1 |q0#0|) (_module.Queue.Valid _module.Main$U@@9 $Heap@@1 |q0#0|)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (or (not (= |q1#0| null)) (not true))) (=> (or (not (= |q1#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |q1#0|) (Tclass._module.Queue? _module.Main$U@@9) $Heap@@1) (=> (and (|_module.Queue.Valid#canCall| _module.Main$U@@9 $Heap@@1 |q1#0|) (_module.Queue.Valid _module.Main$U@@9 $Heap@@1 |q1#0|)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= |q0#0| null)) (not true))) (=> (or (not (= |q0#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= |q1#0| null)) (not true))) (=> (or (not (= |q1#0| null)) (not true)) (=> (|Set#Disjoint| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q0#0|) _module.Queue.footprint)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q1#0|) _module.Queue.footprint))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |q0#0| null)) (not true))) (=> (or (not (= |q0#0| null)) (not true)) (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q0#0|) _module.Queue.contents))) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= |q0#0| null)) (not true))) (=> (or (not (= |q0#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |q1#0| null)) (not true))) (=> (or (not (= |q1#0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@28 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@28) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@28)) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q0#0|) _module.Queue.footprint)) ($Box refType $o@@28)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q1#0|) _module.Queue.footprint)) ($Box refType $o@@28)))))
 :qid |Queuedfy.174:10|
 :skolemid |726|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |q0#0| null)) (not true))) (=> (or (not (= |q0#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |q0#0| null)) (not true))) (=> (or (not (= |q0#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType |q0#0| (Tclass._module.Queue _module.Main$U@@9) $Heap@@1)) (=> ($IsAlloc refType |q0#0| (Tclass._module.Queue _module.Main$U@@9) $Heap@@1) (=> (and (forall (($o@@29 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q0#0|) _module.Queue.footprint)) ($Box refType $o@@29)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q0#0|) _module.Queue.footprint)) ($Box refType $o@@29)))) (or (not (= $o@@29 null)) (not true)))
 :qid |Queuedfy.180:13|
 :skolemid |727|
 :pattern (  (or (not (= $o@@29 null)) (not true)))
)) (forall (($o@@30 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |q0#0|) _module.Queue.footprint)) ($Box refType $o@@30)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |q0#0|) _module.Queue.footprint)) ($Box refType $o@@30)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@30) alloc)))))
 :qid |Queuedfy.180:13|
 :skolemid |728|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |q1#0| null)) (not true))) (=> (or (not (= |q1#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |q1#0| null)) (not true))) (=> (or (not (= |q1#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |q1#0| (Tclass._module.Queue _module.Main$U@@9) $Heap@@1)))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.Main _module.Main$U@@9)) ($IsAlloc refType this@@3 (Tclass._module.Main _module.Main$U@@9) $Heap@@1)))) (and (and ($IsBox |t#0| _module.Main$U@@9) ($IsAllocBox |t#0| _module.Main$U@@9 $Heap@@1)) (and ($IsBox |u#0| _module.Main$U@@9) ($IsAllocBox |u#0| _module.Main$U@@9 $Heap@@1)))) (and (and (and ($IsBox |v#0| _module.Main$U@@9) ($IsAllocBox |v#0| _module.Main$U@@9 $Heap@@1)) (and ($Is refType |q0#0| (Tclass._module.Queue _module.Main$U@@9)) ($IsAlloc refType |q0#0| (Tclass._module.Queue _module.Main$U@@9) $Heap@@1))) (and (and ($Is refType |q1#0| (Tclass._module.Queue _module.Main$U@@9)) ($IsAlloc refType |q1#0| (Tclass._module.Queue _module.Main$U@@9) $Heap@@1)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 15) 2))))) anon0_correct)))
