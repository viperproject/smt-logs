...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split67)
...
)) (< 0 (|Seq#Length| |stackNodes#0@1|))) (and (|Seq#Contains| |stackNodes#0@1| (|Seq#Index| |stackNodes#0@1| (LitInt 0))) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0))) null)) (not true)))))
