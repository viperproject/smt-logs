...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.len#canCall| |xs#0@@0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List))) ($Is DatatypeTypeType (_module.__default.len $ly@@0 |xs#0@@0|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.139:16|
 :skolemid |679|
 :pattern ( (_module.__default.len $ly@@0 |xs#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.len#canCall| (Lit DatatypeTypeType |xs#0@@1|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@1|)))))
(|_module.__default.len#canCall| |ys#3|))) (= (_module.__default.len ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)) |#_module.Nat.Zero| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@1|)))))
(Lit DatatypeTypeType (|#_module.Nat.Suc| (Lit DatatypeTypeType (_module.__default.len ($LS $ly@@1) |ys#2|)))))))))
 :qid |Ripplinglegacydfy.139:16|
 :weight 3
 :skolemid |682|
 :pattern ( (_module.__default.len ($LS $ly@@1) (Lit DatatypeTypeType |xs#0@@1|)))
))))
...
(assert (forall (($ly@@2 T@U) (|xs#0@@2| T@U) ) (! (= (_module.__default.len ($LS $ly@@2) |xs#0@@2|) (_module.__default.len $ly@@2 |xs#0@@2|))
 :qid |Ripplinglegacydfy.139:16|
 :skolemid |677|
 :pattern ( (_module.__default.len ($LS $ly@@2) |xs#0@@2|))
)))
...
(let ((anon10_Then_correct  (=> (= |xs#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List)) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List)) (and (= |ys#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat) (= |y#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
