...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) (|x#0@@0| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.mem#canCall| |x#0@@0| |xs#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.mem $ly@@2 |x#0@@0| |xs#0@@2|) Tclass._module.Bool))
 :qid |Ripplinglegacydfy.106:16|
 :skolemid |650|
 :pattern ( (_module.__default.mem $ly@@2 |x#0@@0| |xs#0@@2|))
))))
(assert (forall (($ly@@3 T@U) (|xs#0@@3| T@U) (|ys#0@@2| T@U) ) (! (= (_module.__default.concat ($LS $ly@@3) |xs#0@@3| |ys#0@@2|) (_module.__default.concat $ly@@3 |xs#0@@3| |ys#0@@2|))
 :qid |Ripplinglegacydfy.99:16|
 :skolemid |640|
 :pattern ( (_module.__default.concat ($LS $ly@@3) |xs#0@@3| |ys#0@@2|))
)))
(assert (forall (($ly@@4 T@U) (|x#0@@1| T@U) (|xs#0@@4| T@U) ) (! (= (_module.__default.mem ($LS $ly@@4) |x#0@@1| |xs#0@@4|) (_module.__default.mem $ly@@4 |x#0@@1| |xs#0@@4|))
 :qid |Ripplinglegacydfy.106:16|
 :skolemid |648|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|x#0@@2| T@U) (|xs#0@@5| T@U) ) (!  (=> (or (|_module.__default.mem#canCall| |x#0@@2| |xs#0@@5|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@5| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@5|)) (let ((|ys#1| (_module.List._h2 |xs#0@@5|)))
(let ((|y#1| (_module.List._h1 |xs#0@@5|)))
 (and (and (|$IsA#_module.Nat| |x#0@@2|) (|$IsA#_module.Nat| |y#1|)) (=> (not (|_module.Nat#Equal| |x#0@@2| |y#1|)) (|_module.__default.mem#canCall| |x#0@@2| |ys#1|)))))) (= (_module.__default.mem ($LS $ly@@5) |x#0@@2| |xs#0@@5|) (ite (_module.List.Nil_q |xs#0@@5|) |#_module.Bool.False| (let ((|ys#0@@3| (_module.List._h2 |xs#0@@5|)))
(let ((|y#0| (_module.List._h1 |xs#0@@5|)))
(ite (|_module.Nat#Equal| |x#0@@2| |y#0|) |#_module.Bool.True| (_module.__default.mem $ly@@5 |x#0@@2| |ys#0@@3|))))))))
 :qid |Ripplinglegacydfy.106:16|
 :skolemid |652|
 :pattern ( (_module.__default.mem ($LS $ly@@5) |x#0@@2| |xs#0@@5|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) (|x#0@@3| T@U) (|xs#0@@6| T@U) ) (!  (=> (or (|_module.__default.mem#canCall| (Lit DatatypeTypeType |x#0@@3|) (Lit DatatypeTypeType |xs#0@@6|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@6| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@6|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@6|)))))
(let ((|y#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@6|)))))
 (and (and (|$IsA#_module.Nat| (Lit DatatypeTypeType |x#0@@3|)) (|$IsA#_module.Nat| |y#3|)) (=> (not (|_module.Nat#Equal| |x#0@@3| |y#3|)) (|_module.__default.mem#canCall| (Lit DatatypeTypeType |x#0@@3|) |ys#3|)))))) (= (_module.__default.mem ($LS $ly@@6) (Lit DatatypeTypeType |x#0@@3|) (Lit DatatypeTypeType |xs#0@@6|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@6|)) |#_module.Bool.False| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@6|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@6|)))))
(ite (|_module.Nat#Equal| |x#0@@3| |y#2|) |#_module.Bool.True| (_module.__default.mem ($LS $ly@@6) (Lit DatatypeTypeType |x#0@@3|) |ys#2|))))))))
 :qid |Ripplinglegacydfy.106:16|
 :weight 3
 :skolemid |653|
 :pattern ( (_module.__default.mem ($LS $ly@@6) (Lit DatatypeTypeType |x#0@@3|) (Lit DatatypeTypeType |xs#0@@6|)))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.P27)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|x#1| T@U) (|xs#1| T@U) (|ys#1@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |x#1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#1| Tclass._module.List)) ($Is DatatypeTypeType |ys#1@@0| Tclass._module.List)) (=> (|_module.Bool#Equal| (_module.__default.mem ($LS ($LS $LZ)) |x#1| |ys#1@@0|) |#_module.Bool.True|) (|_module.Bool#Equal| (_module.__default.mem ($LS ($LS $LZ)) |x#1| (_module.__default.concat ($LS ($LS $LZ)) |xs#1| |ys#1@@0|)) |#_module.Bool.True|)))
 :qid |Ripplinglegacydfy.437:18|
 :skolemid |1003|
 :pattern ( (_module.__default.mem ($LS ($LS $LZ)) |x#1| (_module.__default.concat ($LS ($LS $LZ)) |xs#1| |ys#1@@0|)))
)))))
