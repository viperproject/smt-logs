...
))) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1)) (=> ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1) (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.Queue.contents))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Queue.contents)))) (=> (and (<= (LitInt 0) |i#0@0|) (<= |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.Queue.contents))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1)) (=> ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |i#0@0|) (<= |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Queue.contents)))))) (=> (and (<= 0 |i#0@0|) (<= |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Queue.contents))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1)) (=> ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 |i#0@0|) (<= |i#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Queue.contents))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.Queue _module.Queue$T@@21)) ($IsAlloc refType this@@3 (Tclass._module.Queue _module.Queue$T@@21) $Heap@@1))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct))))
