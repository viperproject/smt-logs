...
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (and ($IsBox |t#0@0| _module.ExtensibleArray$T@@24) ($IsAllocBox |t#0@0| _module.ExtensibleArray$T@@24 $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |i#0@@0|) (< |i#0@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.ExtensibleArray.Contents)))))))))
...
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) ($IsAllocBox ($Box refType this@@2) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@24) $Heap@@1)) (and (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@24 $Heap@@1 this@@2) (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@24 $Heap@@1 this@@2))) (and (=> (= (ControlFlow 0 5) 3) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24)) ($IsAlloc refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24) $Heap@@1)))) (and (and ($IsBox |t#0| _module.ExtensibleArray$T@@24) ($IsAllocBox |t#0| _module.ExtensibleArray$T@@24 $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
