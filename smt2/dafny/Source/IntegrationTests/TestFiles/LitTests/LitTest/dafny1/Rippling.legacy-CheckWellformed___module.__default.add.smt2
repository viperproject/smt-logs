...
(assert (forall (($ly@@1 T@U) (|x#0@@1| T@U) (|y#0@@1| T@U) ) (! (= (_module.__default.add ($LS $ly@@1) |x#0@@1| |y#0@@1|) (_module.__default.add $ly@@1 |x#0@@1| |y#0@@1|))
 :qid |Ripplinglegacydfy.34:16|
 :skolemid |590|
 :pattern ( (_module.__default.add ($LS $ly@@1) |x#0@@1| |y#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|x#0@@2| T@U) (|y#0@@2| T@U) ) (!  (=> (or (|_module.__default.add#canCall| |x#0@@2| |y#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@2| Tclass._module.Nat)))) (and (=> (not (_module.Nat.Zero_q |x#0@@2|)) (let ((|w#1| (_module.Nat._h0 |x#0@@2|)))
(|_module.__default.add#canCall| |w#1| |y#0@@2|))) (= (_module.__default.add ($LS $ly@@2) |x#0@@2| |y#0@@2|) (ite (_module.Nat.Zero_q |x#0@@2|) |y#0@@2| (let ((|w#0| (_module.Nat._h0 |x#0@@2|)))
(|#_module.Nat.Suc| (_module.__default.add $ly@@2 |w#0| |y#0@@2|)))))))
 :qid |Ripplinglegacydfy.34:16|
 :skolemid |595|
...
(declare-fun |w#Z#0@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun |y#0@@3| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.add)
...
(let ((anon10_Then_correct  (=> (and (and (and (= |x#0@@3| (|#_module.Nat.Suc| |_mcc#0#0|)) ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat)) (and (= |let#0#0#0| |_mcc#0#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Nat))) (and (and (= |w#Z#0@0| |let#0#0#0|) ($IsAlloc DatatypeTypeType |w#Z#0@0| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |y#0@@3| Tclass._module.Nat $Heap) (= (ControlFlow 0 4) (- 0 3))))) (or (< (DtRank |w#Z#0@0|) (DtRank |x#0@@3|)) (and (= (DtRank |w#Z#0@0|) (DtRank |x#0@@3|)) (< (DtRank |y#0@@3|) (DtRank |y#0@@3|)))))))
(let ((anon9_Else_correct  (=> (or (not (= |x#0@@3| |#_module.Nat.Zero|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |x#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@3| Tclass._module.Nat)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
