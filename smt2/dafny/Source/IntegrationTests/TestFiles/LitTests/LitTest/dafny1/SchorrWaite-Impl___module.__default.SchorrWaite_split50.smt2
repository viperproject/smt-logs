...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split50)
...
)) (=> (and (and ($Is refType |n#14@0| Tclass._module.Node) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@2)) (and (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#14@0|)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |n#14@0| null)) (not true))))))
