...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__H3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| (|Set#Union| |M#0| |Set#Empty|) |M#0|)) (=> (|Set#Equal| (|Set#Union| |M#0| |Set#Empty|) |M#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (not (|Set#IsMember| |h#0| ($Box SetType (Lit SetType |Set#Empty|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |h#0| (TSet (TSet Tclass._module.G))) ($IsAlloc SetType |h#0| (TSet (TSet Tclass._module.G)) $Heap))) (=> (and (and (and (and ($Is SetType |f#0@@1| (TSet (TSet Tclass._module.G))) ($IsAlloc SetType |f#0@@1| (TSet (TSet Tclass._module.G)) $Heap)) (and ($Is SetType |S#0@@1| (TSet Tclass._module.G)) ($IsAlloc SetType |S#0@@1| (TSet Tclass._module.G) $Heap))) (and (and ($Is SetType |M#0| (TSet Tclass._module.G)) ($IsAlloc SetType |M#0| (TSet Tclass._module.G) $Heap)) (= 1 $FunctionContextHeight))) (and (and (and (|_module.__default.IsFilter#canCall| |f#0@@1| |S#0@@1|) (and (_module.__default.IsFilter |f#0@@1| |S#0@@1|) (and (and (and (forall ((|A#1@@0| T@U) (|B#1@@0| T@U) ) (!  (=> (and ($Is SetType |A#1@@0| (TSet Tclass._module.G)) ($Is SetType |B#1@@0| (TSet Tclass._module.G))) (=> (and (|Set#IsMember| |f#0@@1| ($Box SetType |A#1@@0|)) (|Set#Subset| |A#1@@0| |B#1@@0|)) (|Set#IsMember| |f#0@@1| ($Box SetType |B#1@@0|))))
 :qid |UltraFilterdfy.10:11|
 :skolemid |630|
 :pattern ( (|Set#IsMember| |f#0@@1| ($Box SetType |B#1@@0|)) (|Set#IsMember| |f#0@@1| ($Box SetType |A#1@@0|)))
 :pattern ( (|Set#Subset| |A#1@@0| |B#1@@0|))
)) (forall ((|C#1@@0| T@U) (|D#1@@0| T@U) ) (!  (=> (and ($Is SetType |C#1@@0| (TSet Tclass._module.G)) ($Is SetType |D#1@@0| (TSet Tclass._module.G))) (=> (and (|Set#IsMember| |f#0@@1| ($Box SetType |C#1@@0|)) (|Set#IsMember| |f#0@@1| ($Box SetType |D#1@@0|))) (|Set#IsMember| |f#0@@1| ($Box SetType (|Set#Intersection| |C#1@@0| |D#1@@0|)))))
 :qid |UltraFilterdfy.11:11|
 :skolemid |631|
...
))) (and (not (|Set#IsMember| |f#0@@1| ($Box SetType |M#0|))) (= (ControlFlow 0 4) 2)))) anon0_correct))))
