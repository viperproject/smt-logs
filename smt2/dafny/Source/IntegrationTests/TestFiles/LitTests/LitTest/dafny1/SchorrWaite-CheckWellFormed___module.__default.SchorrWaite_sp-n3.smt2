...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SchorrWaite_split2)
...
)) (=> (and (and (and ($Is refType |n#8@0| Tclass._module.Node) ($IsAlloc refType |n#8@0| Tclass._module.Node $Heap@0)) (|Set#IsMember| |S#0@@5| ($Box refType |n#8@0|))) (and (or (not (= |n#8@0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |n#8@0| null)) (not true))))))
