...
(set-info :boogie-vc-id CheckWellFormed$$_module.PriorityQueue.SiftDown)
...
(let ((anon11_correct  (=> (and (<= (LitInt 1) (Div (Div |j#2@0| (LitInt 2)) (LitInt 2))) (or (not (= (Div (Div |j#2@0| (LitInt 2)) (LitInt 2)) |k#0|)) (not true))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 (Div (Div |j#2@0| (LitInt 2)) (LitInt 2))) (< (Div (Div |j#2@0| (LitInt 2)) (LitInt 2)) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)))))) (=> (and (<= 0 (Div (Div |j#2@0| (LitInt 2)) (LitInt 2))) (< (Div (Div |j#2@0| (LitInt 2)) (LitInt 2)) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |j#2@0|) (< |j#2@0| (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)))))) (=> (and (<= 0 |j#2@0|) (< |j#2@0| (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))))) (=> (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField (Div (Div |j#2@0| (LitInt 2)) (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField |j#2@0|))))) (= (ControlFlow 0 3) 1)) anon13_correct))))))))))))))))
(let ((anon18_Else_correct  (=> (and (< (Div (Div |j#2@0| (LitInt 2)) (LitInt 2)) (LitInt 1)) (= (ControlFlow 0 13) 3)) anon11_correct)))
(let ((anon18_Then_correct  (=> (<= (LitInt 1) (Div (Div |j#2@0| (LitInt 2)) (LitInt 2))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (= (ControlFlow 0 10) 3) anon11_correct))))))))
(let ((anon9_correct  (=> (and (<= (LitInt 2) |j#2@0|) (<= |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 14) 10) anon18_Then_correct) (=> (= (ControlFlow 0 14) 13) anon18_Else_correct)))))))))
(let ((anon17_Else_correct  (=> (and (< |j#2@0| (LitInt 2)) (= (ControlFlow 0 18) 14)) anon9_correct)))
(let ((anon17_Then_correct  (=> (and (<= (LitInt 2) |j#2@0|) (= (ControlFlow 0 17) 14)) anon9_correct)))
(let ((anon16_Else_correct  (=> (and (=> (and (and (<= (LitInt 2) |j#2@0|) (<= |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (and (<= (LitInt 1) (Div (Div |j#2@0| (LitInt 2)) (LitInt 2))) (or (not (= (Div (Div |j#2@0| (LitInt 2)) (LitInt 2)) |k#0|)) (not true)))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField (Div (Div |j#2@0| (LitInt 2)) (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField |j#2@0|)))))) (= (ControlFlow 0 2) 1)) anon13_correct)))
(let ((anon6_correct  (=> (forall ((|j#1| Int) ) (!  (=> (and (and (<= (LitInt 2) |j#1|) (<= |j#1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (or (not (= (Div |j#1| (LitInt 2)) |k#0|)) (not true))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField (Div |j#1| (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField |j#1|))))))
 :qid |PriorityQueuedfy.85:21|
 :skolemid |576|
 :pattern ( (Div |j#1| 2))
)) (and (and (=> (= (ControlFlow 0 19) 2) anon16_Else_correct) (=> (= (ControlFlow 0 19) 17) anon17_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon17_Else_correct)))))
(let ((anon4_correct  (=> (and (<= (LitInt 2) |j#0@0|) (<= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (and (=> (= (ControlFlow 0 21) (- 0 27)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (or (not (= (Div |j#0@0| (LitInt 2)) |k#0|)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 26)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 25)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (and (<= 0 (Div |j#0@0| (LitInt 2))) (< (Div |j#0@0| (LitInt 2)) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)))))) (=> (and (<= 0 (Div |j#0@0| (LitInt 2))) (< (Div |j#0@0| (LitInt 2)) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)))))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))))) (=> (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField (Div |j#0@0| (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField |j#0@0|))))) (= (ControlFlow 0 21) 19)) anon6_correct)))))))))))))))))
(let ((anon15_Else_correct  (=> (and (< |j#0@0| (LitInt 2)) (= (ControlFlow 0 29) 21)) anon4_correct)))
(let ((anon15_Then_correct  (=> (and (<= (LitInt 2) |j#0@0|) (= (ControlFlow 0 28) 21)) anon4_correct)))
(let ((anon14_Else_correct  (=> (and (=> (and (and (<= (LitInt 2) |j#0@0|) (<= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (or (not (= (Div |j#0@0| (LitInt 2)) |k#0|)) (not true))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField (Div |j#0@0| (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField |j#0@0|)))))) (= (ControlFlow 0 20) 19)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#5| null $Heap@@1 alloc ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)))) (=> (and (and (<= (LitInt 1) |k#0|) ($IsAllocBox ($Box refType this@@3) Tclass._module.PriorityQueue? $Heap@@1)) (and (|_module.PriorityQueue.MostlyValid#canCall| $Heap@@1 this@@3) (_module.PriorityQueue.MostlyValid $Heap@@1 this@@3))) (and (and (=> (= (ControlFlow 0 30) 20) anon14_Else_correct) (=> (= (ControlFlow 0 30) 28) anon15_Then_correct)) (=> (= (ControlFlow 0 30) 29) anon15_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.PriorityQueue) ($IsAlloc refType this@@3 Tclass._module.PriorityQueue $Heap@@1))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 31) 30))) anon0_correct))))
