...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split2)
...
))))) (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |S#0|)) (= |path#0@0| (Lit DatatypeTypeType |#_module.Path.Empty|))) (and (or (not (= |root#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.marked)))) (and (and (= |$rhs#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |root#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |root#0|) _module.Node.marked ($Box boolType (bool_2_U |$rhs#0@0|)))))) (and ($IsGoodHeap $Heap@0) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= |root#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
