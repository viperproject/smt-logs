...
(assert (distinct TBool TagBool TagSet TagSeq alloc allocName Tagclass._System.object? Tagclass._System.object Tagclass._module.Node? class._module.Node? Tagclass._module.Node tytagFamily$object tytagFamily$Node field$content field$footprint field$next field$val)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((_module.Node$T@@6 T@U) ($h@@5 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) (Tclass._module.Node? _module.Node$T@@6)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) alloc)))) ($IsAlloc SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) _module.Node.content)) (TSeq _module.Node$T@@6) $h@@5))
 :qid |unknown.0:0|
 :skolemid |522|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@4) _module.Node.content)) (Tclass._module.Node? _module.Node$T@@6))
)))
(assert (forall ((_module.Node$T@@7 T@U) ($h@@6 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) (Tclass._module.Node? _module.Node$T@@7)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) _module.Node.next)) (Tclass._module.Node? _module.Node$T@@7) $h@@6))
 :qid |unknown.0:0|
 :skolemid |526|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) _module.Node.next)) (Tclass._module.Node? _module.Node$T@@7))
)))
...
(assert (forall ((_module.Node$T@@16 T@U) ($h@@10 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) (Tclass._module.Node? _module.Node$T@@16)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@11) _module.Node.next)) (Tclass._module.Node? _module.Node$T@@16)))
 :qid |unknown.0:0|
 :skolemid |525|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@11) _module.Node.next)) (Tclass._module.Node? _module.Node$T@@16))
)))
...
(let ((anon21_Else_correct  (=> (and (and (and (and (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.footprint)) ($Box refType this@@1)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) null) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.content)) (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.val)))))) (= |b$reqreads#5@1| true)) (and (= |b$reqreads#6@1| true) (= |b$reqreads#7@1| true))) (and (and (= |b$reqreads#10@2| true) (= |b$reqreads#9@2| true)) (and (= |b$reqreads#8@2| true) (= |b$reqreads#12@2| true)))) (and (and (and (= |b$reqreads#11@2| true) (= |b$reqreads#16@2| true)) (and (= |b$reqreads#15@2| true) (= |b$reqreads#14@2| true))) (and (and (= |b$reqreads#13@2| true) (= |b$reqreads#17@1| true)) (and (= |b$reqreads#18@1| true) (= (ControlFlow 0 21) 3))))) anon16_correct)))
...
(let ((anon19_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.footprint)) ($Box refType this@@1))) (= |b$reqreads#2@1| true)) (and (= |b$reqreads#3@1| true) (= |b$reqreads#4@1| true))) (and (=> (= (ControlFlow 0 38) 37) anon21_Then_correct) (=> (= (ControlFlow 0 38) 21) anon21_Else_correct)))))
(let ((anon18_Else_correct  (=> (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Node.footprint))) (and (=> (= (ControlFlow 0 42) 41) anon19_Then_correct) (=> (= (ControlFlow 0 42) 38) anon19_Else_correct)))))
(let ((anon18_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc this@@1 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.footprint)))) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Node.footprint)))) (and (=> (= (ControlFlow 0 43) (- 0 44)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 43) 1) anon18_Then_correct) (=> (= (ControlFlow 0 43) 42) anon18_Else_correct)))))))
