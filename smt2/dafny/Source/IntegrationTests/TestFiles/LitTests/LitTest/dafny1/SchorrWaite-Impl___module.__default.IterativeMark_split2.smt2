...
(assert (forall ((s@@1 T@U) (n@@0 Int) (x@@9 T@U) ) (! (= (|Seq#Contains| (|Seq#Take| s@@1 n@@0) x@@9) (exists ((i@@0 Int) ) (!  (and (and (and (<= 0 i@@0) (< i@@0 n@@0)) (< i@@0 (|Seq#Length| s@@1))) (= (|Seq#Index| s@@1 i@@0) x@@9))
 ...
 :skolemid |236|
 :pattern ( (|Seq#Contains| (|Seq#Take| s@@1 n@@0) x@@9))
)))
(assert (forall ((s@@2 T@U) (x@@10 T@U) ) (! (= (|Seq#Contains| s@@2 x@@10) (exists ((i@@1 Int) ) (!  (and (and (<= 0 i@@1) (< i@@1 (|Seq#Length| s@@2))) (= (|Seq#Index| s@@2 i@@1) x@@10))
...
(assert (forall ((s@@3 T@U) (n@@1 Int) ) (!  (=> (and (<= 0 n@@1) (<= n@@1 (|Seq#Length| s@@3))) (= (|Seq#Length| (|Seq#Take| s@@3 n@@1)) n@@1))
 :qid |DafnyPreludebpl.1238:15|
 :skolemid |244|
 :pattern ( (|Seq#Length| (|Seq#Take| s@@3 n@@1)))
)))
...
(assert (forall ((v@@4 T@U) (t0@@2 T@U) (h@@4 T@U) ) (! (= ($IsAlloc SeqType v@@4 (TSeq t0@@2) h@@4) (forall ((i@@2 Int) ) (!  (=> (and (<= 0 i@@2) (< i@@2 (|Seq#Length| v@@4))) ($IsAllocBox (|Seq#Index| v@@4 i@@2) t0@@2 h@@4))
...
(assert (forall ((s@@6 T@U) (n@@2 Int) ) (!  (=> (= n@@2 0) (= (|Seq#Take| s@@6 n@@2) |Seq#Empty|))
 :qid |DafnyPreludebpl.1295:15|
 :skolemid |256|
 :pattern ( (|Seq#Take| s@@6 n@@2))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.IterativeMark_split2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon130_Else_correct  (=> (or (not (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 28)) (and (<= 0 (- (|Seq#Length| |stackNodes#0@1|) 1)) (< (- (|Seq#Length| |stackNodes#0@1|) 1) (|Seq#Length| |stackNodes#0@1|)))) (=> (and (<= 0 (- (|Seq#Length| |stackNodes#0@1|) 1)) (< (- (|Seq#Length| |stackNodes#0@1|) 1) (|Seq#Length| |stackNodes#0@1|))) (=> (= |t#0@2| ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1)))) (and (=> (= (ControlFlow 0 6) (- 0 27)) (and (<= 0 (- (|Seq#Length| |stackNodes#0@1|) 1)) (<= (- (|Seq#Length| |stackNodes#0@1|) 1) (|Seq#Length| |stackNodes#0@1|)))) (=> (and (<= 0 (- (|Seq#Length| |stackNodes#0@1|) 1)) (<= (- (|Seq#Length| |stackNodes#0@1|) 1) (|Seq#Length| |stackNodes#0@1|))) (=> (= |stackNodes#0@3| (|Seq#Take| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))) (and (=> (= (ControlFlow 0 6) (- 0 26)) (or (not (= |t#0@2| null)) (not true))) (=> (or (not (= |t#0@2| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 25)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |t#0@2| _module.Node.childrenVisited))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |t#0@2| _module.Node.childrenVisited)) (and (=> (= (ControlFlow 0 6) (- 0 24)) (or (not (= |t#0@2| null)) (not true))) (=> (or (not (= |t#0@2| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 23)) ($Is intType (int_2_U (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@2|) _module.Node.childrenVisited))) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@2|) _module.Node.childrenVisited))) 1)) Tclass._System.nat) (=> (= |$rhs#0_0_1@1| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@2|) _module.Node.childrenVisited))) 1)) (=> (and (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@2| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@2|) _module.Node.childrenVisited ($Box intType (int_2_U |$rhs#0_0_1@1|))))) ($IsGoodHeap $Heap@5)) (=> (and (and (= |t#0@3| |t#0@2|) (= $Heap@6 $Heap@5)) (and (= |stackNodes#0@4| |stackNodes#0@3|) (= |unmarkedNodes#0@3| |unmarkedNodes#0@1|))) (and (=> (= (ControlFlow 0 6) (- 0 22)) (or (or (or (<= 0 |$decr$loop#02@1|) (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|)))) (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|))) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |t#0@3|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |t#0@3|) _module.Node.childrenVisited)))) |$decr$loop#02@1|))) (=> (or (or (or (<= 0 |$decr$loop#02@1|) (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|)))) (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|))) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |t#0@3|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |t#0@3|) _module.Node.childrenVisited)))) |$decr$loop#02@1|)) (and (=> (= (ControlFlow 0 6) (- 0 21)) (or (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|))) (and (|Set#Equal| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (or (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (and (= (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |t#0@3|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |t#0@3|) _module.Node.childrenVisited)))) |$decr$loop#02@1|)))))) (=> (or (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|))) (and (|Set#Equal| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (or (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (and (= (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |t#0@3|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |t#0@3|) _module.Node.childrenVisited)))) |$decr$loop#02@1|))))) (and (=> (= (ControlFlow 0 6) (- 0 20)) (=> |$w$loop#0@0| (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |root#0|) _module.Node.marked))))) (=> (=> |$w$loop#0@0| (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |root#0|) _module.Node.marked)))) (and (=> (= (ControlFlow 0 6) (- 0 19)) (=> |$w$loop#0@0| (|Set#IsMember| |S#0| ($Box refType |t#0@3|)))) (=> (=> |$w$loop#0@0| (|Set#IsMember| |S#0| ($Box refType |t#0@3|))) (and (=> (= (ControlFlow 0 6) (- 0 18)) (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@4| ($Box refType |t#0@3|))))) (=> (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@4| ($Box refType |t#0@3|)))) (and (=> (= (ControlFlow 0 6) (- 0 17)) (=> |$w$loop#0@0| (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1|) (< |i#1| |j#1|)) (< |j#1| (|Seq#Length| |stackNodes#0@4|))) (or (not (= ($Unbox refType (|Seq#Index| |stackNodes#0@4| |i#1|)) ($Unbox refType (|Seq#Index| |stackNodes#0@4| |j#1|)))) (not true)))
...
))) (and (=> (= (ControlFlow 0 6) (- 0 16)) (=> |$w$loop#0@0| (forall ((|n#9| T@U) ) (!  (=> ($Is refType |n#9| Tclass._module.Node) (=> (|Seq#Contains| |stackNodes#0@4| ($Box refType |n#9|)) (|Set#IsMember| |S#0| ($Box refType |n#9|))))
...
))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> |$w$loop#0@0| (forall ((|n#21| T@U) ) (!  (=> ($Is refType |n#21| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0| ($Box refType |n#21|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |n#21|) _module.Node.marked))))) (|Set#IsMember| |unmarkedNodes#0@3| ($Box refType |n#21|))))
...
(let ((anon130_Then_correct  (=> (and (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) (= $Heap@7 $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |root#0|) _module.Node.marked)))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |root#0|) _module.Node.marked))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|n#5| T@U) ) (!  (=> ($Is refType |n#5| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0| ($Box refType |n#5|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |n#5|) _module.Node.marked)))) (forall ((|ch#5| T@U) ) (!  (=> ($Is refType |ch#5| Tclass._module.Node?) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |n#5|) _module.Node.children)) ($Box refType |ch#5|)) (or (not (= |ch#5| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |ch#5|) _module.Node.marked)))))
 :qid |SchorrWaitedfy.94:22|
 :skolemid |696|
...
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is refType |root#0| Tclass._module.Node) ($IsAlloc refType |root#0| Tclass._module.Node $Heap)) (and ($Is SetType |S#0| (TSet Tclass._module.Node)) ($IsAlloc SetType |S#0| (TSet Tclass._module.Node) $Heap))) (and (and ($Is refType |t#0| Tclass._module.Node?) ($IsAlloc refType |t#0| Tclass._module.Node? $Heap)) true)) (and (and (and ($Is SeqType |stackNodes#0| (TSeq Tclass._module.Node)) ($IsAlloc SeqType |stackNodes#0| (TSeq Tclass._module.Node) $Heap)) true) (and (and ($Is SetType |unmarkedNodes#0| (TSet Tclass._module.Node?)) ($IsAlloc SetType |unmarkedNodes#0| (TSet Tclass._module.Node?) $Heap)) true))) (=> (and (and (and (and (and (and (= 1 $FunctionContextHeight) (|Set#IsMember| |S#0| ($Box refType |root#0|))) (and (forall ((|n#1| T@U) ) (!  (=> ($Is refType |n#1| Tclass._module.Node) (=> (|Set#IsMember| |S#0| ($Box refType |n#1|)) (forall ((|ch#2| T@U) ) (!  (=> ($Is refType |ch#2| Tclass._module.Node?) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#1|) _module.Node.children)) ($Box refType |ch#2|)) (or (= |ch#2| null) (|Set#IsMember| |S#0| ($Box refType |ch#2|)))))
...
)))) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |S#0|)) (or (not (= |root#0| null)) (not true))) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.marked)) (= |$rhs#0@0| (U_2_bool (Lit boolType (bool_2_U true))))))) (and (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |root#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |root#0|) _module.Node.marked ($Box boolType (bool_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (= |stackNodes#0@0| (Lit SeqType |Seq#Empty|)) (= |unmarkedNodes#0@0| (|Set#Difference| |S#0| (|Set#UnionOne| |Set#Empty| ($Box refType |root#0|)))))) (and (and (= |$decr_init$loop#02@0| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.childrenVisited))))) (=> |$w$loop#0@0| (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.marked))))) (and (=> |$w$loop#0@0| (|Set#IsMember| |S#0| ($Box refType |root#0|))) (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@0| ($Box refType |root#0|)))))))) (and (and (and (and (=> |$w$loop#0@0| (forall ((|i#1@@1| Int) (|j#1@@1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1@@1|) (< |i#1@@1| |j#1@@1|)) (< |j#1@@1| (|Seq#Length| |stackNodes#0@0|))) (or (not (= ($Unbox refType (|Seq#Index| |stackNodes#0@0| |i#1@@1|)) ($Unbox refType (|Seq#Index| |stackNodes#0@0| |j#1@@1|)))) (not true)))
 :qid |SchorrWaitedfy.106:22|
 :skolemid |702|
...
))))) (and (and ($Is SeqType |stackNodes#0@1| (TSeq Tclass._module.Node)) ($IsAlloc SeqType |stackNodes#0@1| (TSeq Tclass._module.Node) $Heap@1)) (and ($Is refType |t#0@0| Tclass._module.Node?) ($IsAlloc refType |t#0@0| Tclass._module.Node? $Heap@1)))))) (and (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and ($Is SetType |unmarkedNodes#0@1| (TSet Tclass._module.Node?)) ($IsAlloc SetType |unmarkedNodes#0@1| (TSet Tclass._module.Node?) $Heap@1))) (and (and (not false) |$rhs#0@0|) (and (=> |$w$loop#0@0| (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |root#0|) _module.Node.marked)))) (=> |$w$loop#0@0| (|Set#IsMember| |S#0| ($Box refType |t#0@0|)))))) (and (and (and (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |t#0@0|)))) (=> |$w$loop#0@0| (forall ((|i#1@@2| Int) (|j#1@@2| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1@@2|) (< |i#1@@2| |j#1@@2|)) (< |j#1@@2| (|Seq#Length| |stackNodes#0@1|))) (or (not (= ($Unbox refType (|Seq#Index| |stackNodes#0@1| |i#1@@2|)) ($Unbox refType (|Seq#Index| |stackNodes#0@1| |j#1@@2|)))) (not true)))
 :qid |SchorrWaitedfy.106:22|
 :skolemid |702|
...
))))) (and (and (and (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (=> (|Set#Equal| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (and (<= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (=> (= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |t#0@0|) _module.Node.childrenVisited)))) |$decr_init$loop#02@0|))))) (and |$w$loop#0@0| (U_2_bool (Lit boolType (bool_2_U true))))) (and (and (= |$decr$loop#02@1| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |t#0@0|) _module.Node.childrenVisited))))) (or (not (= |t#0@0| null)) (not true))) (and (or (not (= |t#0@0| null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |t#0@0|) _module.Node.children)))))))))) (and (=> (= (ControlFlow 0 29) (- 0 33)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 29) (- 0 32)) (or (not (= |t#0@0| null)) (not true))) (=> (or (not (= |t#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 29) (- 0 31)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |t#0@0| _module.Node.childrenVisited))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |t#0@0| _module.Node.childrenVisited)) (and (=> (= (ControlFlow 0 29) (- 0 30)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |$rhs#0_0_0@1| (LitInt 0)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 |t#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |t#0@0|) _module.Node.childrenVisited ($Box intType (int_2_U |$rhs#0_0_0@1|))))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 29) 2) anon130_Then_correct) (=> (= (ControlFlow 0 29) 6) anon130_Else_correct)))))))))))))))))
anon0_correct))))
))
(check-sat)
(get-info :rlimit)
