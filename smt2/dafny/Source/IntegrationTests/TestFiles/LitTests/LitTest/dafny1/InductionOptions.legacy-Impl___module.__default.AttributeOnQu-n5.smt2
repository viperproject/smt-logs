...
(set-info :boogie-vc-id Impl$$_module.__default.AttributeOnQuantifier)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (forall ((|xs#1| T@U) ) (!  (=> ($Is DatatypeTypeType |xs#1| Tclass._module.List) (and (and (|$IsA#_module.List| (_module.__default.Append ($LS $LZ) |xs#1| (Lit DatatypeTypeType |#_module.List.Nil|))) (|$IsA#_module.List| |xs#1|)) (|_module.__default.Append#canCall| |xs#1| (Lit DatatypeTypeType |#_module.List.Nil|))))
 :qid |InductionOptionslegacydfy.44:17|
 :skolemid |559|
 :pattern ( (_module.__default.Append ($LS $LZ) |xs#1| |#_module.List.Nil|))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|xs#1@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |xs#1@@0| Tclass._module.List) (forall ((|xs$ih#0#0| T@U) ) (!  (=> ($Is DatatypeTypeType |xs$ih#0#0| Tclass._module.List) (=> (< (DtRank |xs$ih#0#0|) (DtRank |xs#1@@0|)) (|_module.List#Equal| (_module.__default.Append ($LS $LZ) |xs$ih#0#0| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs$ih#0#0|)))
 :qid |InductionOptionslegacydfy.44:17|
 :skolemid |560|
 :pattern ( (_module.__default.Append ($LS $LZ) |xs$ih#0#0| |#_module.List.Nil|))
))) (and true (= |#_module.List.Nil| |xs#1@@0|))) (|_module.List#Equal| (_module.__default.Append ($LS ($LS $LZ)) |xs#1@@0| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs#1@@0|))
 :qid |InductionOptionslegacydfy.44:17|
 :skolemid |562|
 :pattern ( (_module.__default.Append ($LS ($LS $LZ)) |xs#1@@0| |#_module.List.Nil|))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|xs#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |xs#1@@1| Tclass._module.List) (forall ((|xs$ih#0#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |xs$ih#0#0@@0| Tclass._module.List) (=> (< (DtRank |xs$ih#0#0@@0|) (DtRank |xs#1@@1|)) (|_module.List#Equal| (_module.__default.Append ($LS $LZ) |xs$ih#0#0@@0| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs$ih#0#0@@0|)))
 :qid |InductionOptionslegacydfy.44:17|
 :skolemid |560|
 :pattern ( (_module.__default.Append ($LS $LZ) |xs$ih#0#0@@0| |#_module.List.Nil|))
))) (and true (exists ((|a#1#0#0| Int) (|a#1#1#0| T@U) ) (!  (and ($Is DatatypeTypeType |a#1#1#0| Tclass._module.List) (= (|#_module.List.Cons| |a#1#0#0| |a#1#1#0|) |xs#1@@1|))
 :qid |InductionOptionslegacydfy.10:28|
 :skolemid |561|
 :pattern ( (|#_module.List.Cons| |a#1#0#0| |a#1#1#0|))
)))) (|_module.List#Equal| (_module.__default.Append ($LS ($LS $LZ)) |xs#1@@1| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs#1@@1|))
 :qid |InductionOptionslegacydfy.44:17|
 :skolemid |563|
 :pattern ( (_module.__default.Append ($LS ($LS $LZ)) |xs#1@@1| |#_module.List.Nil|))
)))))))
(let ((anon3_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |xs#0@0| Tclass._module.List) ($IsAlloc DatatypeTypeType |xs#0@0| Tclass._module.List $Heap))) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |xs#0@0| Tclass._module.List) ($IsAlloc DatatypeTypeType |xs#0@0| Tclass._module.List $Heap)) ($IsAlloc DatatypeTypeType |xs#0@0| Tclass._module.List $Heap)) (and (and (= |##ys#0@0| (Lit DatatypeTypeType |#_module.List.Nil|)) ($IsAlloc DatatypeTypeType |##ys#0@0| Tclass._module.List $Heap)) (and (|_module.__default.Append#canCall| |xs#0@0| (Lit DatatypeTypeType |#_module.List.Nil|)) (= (ControlFlow 0 4) 2)))) anon2_correct)))
