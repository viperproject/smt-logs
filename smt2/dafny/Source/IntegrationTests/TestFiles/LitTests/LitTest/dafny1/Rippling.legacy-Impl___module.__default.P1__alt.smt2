...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.P1__alt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (|$IsA#_module.Nat| |n#0@@7|) (|$IsA#_module.List| |xs#0@@11|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#n0#0| T@U) (|$ih#xs0#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#n0#0| Tclass._module.Nat) ($Is DatatypeTypeType |$ih#xs0#0| Tclass._module.List)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#n0#0|) (DtRank |n#0@@7|)) (and (= (DtRank |$ih#n0#0|) (DtRank |n#0@@7|)) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@11|))))) (|_module.List#Equal| (_module.__default.concat ($LS $LZ) (_module.__default.take ($LS $LZ) |$ih#n0#0| |$ih#xs0#0|) (_module.__default.drop ($LS $LZ) |$ih#n0#0| |$ih#xs0#0|)) |$ih#xs0#0|))
 :qid |Ripplinglegacydfy.585:14|
 :skolemid |1199|
 :pattern ( (_module.__default.drop ($LS $LZ) |$ih#n0#0| |$ih#xs0#0|))
 :pattern ( (_module.__default.take ($LS $LZ) |$ih#n0#0| |$ih#xs0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| (_module.__default.concat ($LS ($LS $LZ)) (_module.__default.take ($LS ($LS $LZ)) |n#0@@7| |xs#0@@11|) (_module.__default.drop ($LS ($LS $LZ)) |n#0@@7| |xs#0@@11|)) |xs#0@@11|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |n#0@@7| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |n#0@@7| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |n#0@@7|)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@11| Tclass._module.List) ($IsAlloc DatatypeTypeType |xs#0@@11| Tclass._module.List $Heap)) (|$IsA#_module.List| |xs#0@@11|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
