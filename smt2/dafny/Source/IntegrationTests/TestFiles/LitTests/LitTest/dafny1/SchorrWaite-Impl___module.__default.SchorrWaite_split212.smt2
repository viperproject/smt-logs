...
(assert (forall ((s@@0 T@U) (x@@9 T@U) ) (! (= (|Seq#Contains| s@@0 x@@9) (exists ((i@@0 Int) ) (!  (and (and (<= 0 i@@0) (< i@@0 (|Seq#Length| s@@0))) (= (|Seq#Index| s@@0 i@@0) x@@9))
...
(assert (forall ((v@@4 T@U) (t0@@1 T@U) (h@@3 T@U) ) (! (= ($IsAlloc SetType v@@4 (TSet t0@@1) h@@3) (forall ((bx@@6 T@U) ) (!  (=> (|Set#IsMember| v@@4 bx@@6) ($IsAllocBox bx@@6 t0@@1 h@@3))
...
(assert (forall ((v@@5 T@U) (t0@@2 T@U) (h@@4 T@U) ) (! (= ($IsAlloc SeqType v@@5 (TSeq t0@@2) h@@4) (forall ((i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| v@@5))) ($IsAllocBox (|Seq#Index| v@@5 i@@1) t0@@2 h@@4))
...
(assert (forall ((s@@2 T@U) (i@@2 Int) (v@@6 T@U) ) (!  (=> (and (<= 0 i@@2) (< i@@2 (|Seq#Length| s@@2))) (= (|Seq#Length| (|Seq#Update| s@@2 i@@2 v@@6)) (|Seq#Length| s@@2)))
 :qid |DafnyPreludebpl.1167:15|
 :skolemid |228|
 :pattern ( (|Seq#Length| (|Seq#Update| s@@2 i@@2 v@@6)))
)))
...
(assert (forall ((s@@4 T@U) (i@@4 Int) ) (!  (=> (and (<= 0 i@@4) (< i@@4 (|Seq#Length| s@@4))) (< (DtRank ($Unbox DatatypeTypeType (|Seq#Index| s@@4 i@@4))) (|Seq#Rank| s@@4)))
 :qid |DafnyPreludebpl.1353:15|
 :skolemid |267|
 :pattern ( (DtRank ($Unbox DatatypeTypeType (|Seq#Index| s@@4 i@@4))))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split212)
