...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split224)
...
))) (and (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (=> (|Set#Equal| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (and (<= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (=> (= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) |$decr_init$loop#02@0|))))))) (and (and (and |$w$loop#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (and (= |$decr$loop#02@1| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))))) (or (not (= |t#0@0| null)) (not true)))) (and (and (or (not (= |t#0@0| null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))))) (and (U_2_bool (Lit boolType (bool_2_U true))) (or (not (= |t#0@0| null)) (not true)))))) (and (and (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |t#0@0| _module.Node.childrenVisited)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (and (= |$rhs#0_0_0@1| (LitInt 0)) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited ($Box intType (int_2_U |$rhs#0_0_0@1|))))))) (and (and ($IsGoodHeap $Heap@3) (or (not (= |p#0@0| null)) (not true))) (and (or (not (= |p#0@0| null)) (not true)) (or (not (= |p#0@0| null)) (not true))))) (and (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited)))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children))))) (= |oldP#0_0_0@1| ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited))))))) (and (and (or (not (= |p#0@0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |p#0@0| _module.Node.children))) (and (or (not (= |p#0@0| null)) (not true)) (or (not (= |p#0@0| null)) (not true)))))))) (and (and (and (and (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited)))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children))))) (= |$rhs#0_0_1@1| (|Seq#Update| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited))) ($Box refType |t#0@0|)))) (and (= $Heap@8 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children ($Box SeqType |$rhs#0_0_1@1|)))) ($IsGoodHeap $Heap@8))) (and (and (<= 0 (- (|Seq#Length| |stackNodes#0@1|) 1)) (<= (- (|Seq#Length| |stackNodes#0@1|) 1) (|Seq#Length| |stackNodes#0@1|))) (and (= |stackNodes#0@3| (|Seq#Take| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))) (or (not (= |p#0@0| null)) (not true))))) (and (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |p#0@0| _module.Node.childrenVisited)) (or (not (= |p#0@0| null)) (not true))) (and ($Is intType (int_2_U (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |p#0@0|) _module.Node.childrenVisited))) 1)) Tclass._System.nat) (= |$rhs#0_0_2@1| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |p#0@0|) _module.Node.childrenVisited))) 1)))) (and (and (= $Heap@9 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@8 |p#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |p#0@0|) _module.Node.childrenVisited ($Box intType (int_2_U |$rhs#0_0_2@1|))))) ($IsGoodHeap $Heap@9)) (and (or (not (= |p#0@0| null)) (not true)) (= |path#0@3| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |p#0@0|) _module.Node.pathFromRoot))))))) (and (and (and (and (= |t#0@1| |p#0@0|) (= |p#0@1| |oldP#0_0_0@1|)) (and (= |path#0@4| |path#0@3|) (= $Heap@10 $Heap@9))) (and (and (= |stackNodes#0@4| |stackNodes#0@3|) (= |unmarkedNodes#0@3| |unmarkedNodes#0@1|)) (and (or (or (or (<= 0 |$decr$loop#02@1|) (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|)))) (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|))) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.childrenVisited)))) |$decr$loop#02@1|)) (or (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|))) (and (|Set#Equal| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (or (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (and (= (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.childrenVisited)))) |$decr$loop#02@1|)))))))) (and (and (and (=> (forall ((|i#1@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@1|) (< |i#1@@1| (|Seq#Length| |stackNodes#0@4|))) (|Set#IsMember| |S#0@@5| (|Seq#Index| |stackNodes#0@4| |i#1@@1|)))
 :qid |SchorrWaitedfy.197:22|
 :skolemid |877|
...
)))) (and (=> |$w$loop#0@0| (|Set#IsMember| |S#0@@5| ($Box refType |t#0@1|))) (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@4| ($Box refType |t#0@1|)))))) (and (and (=> |$w$loop#0@0| (= |p#0@1| (ite (= (|Seq#Length| |stackNodes#0@4|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@4| (- (|Seq#Length| |stackNodes#0@4|) 1)))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|)))))) (forall ((|n#11@@2| T@U) ) (!  (=> ($Is refType |n#11@@2| Tclass._module.Node) (=> (|Seq#Contains| |stackNodes#0@4| ($Box refType |n#11@@2|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#11@@2|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#11@@2|) _module.Node.children))))))
 :qid |SchorrWaitedfy.216:22|
 :skolemid |812|
