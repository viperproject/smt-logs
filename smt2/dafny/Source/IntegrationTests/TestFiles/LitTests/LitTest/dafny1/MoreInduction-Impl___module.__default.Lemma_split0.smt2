...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma_split0)
...
)))) (and (and (or (not (= |list#0@@12| |#_module.List.Nil|)) (not true)) (= |list#0@@12| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|))) (and ($Is DatatypeTypeType |_mcc#0#0_0@0| (Tclass._module.Node _module._default.Lemma$X)) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module._default.Lemma$X))))) (and (and (and ($Is DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module._default.Lemma$X)) (= |rest#0_0@0| |let#0_0#0#0|)) (and ($Is DatatypeTypeType |n#0_0@0| (Tclass._module.Node _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |n#0_0@0| (Tclass._module.Node _module._default.Lemma$X) $Heap@0))))) (and (and (and (and (= |let#0_1#0#0| |_mcc#0#0_0@0|) ($Is DatatypeTypeType |let#0_1#0#0| (Tclass._module.Node _module._default.Lemma$X))) (and (= |n#0_0@0| |let#0_1#0#0|) (or (not (= |n#0_0@0| (|#_module.Node.Element| |_mcc#2#0_1_0@0|))) (not true)))) (and (and (= |n#0_0@0| (|#_module.Node.Nary| |_mcc#3#0_0_0@0|)) ($Is DatatypeTypeType |_mcc#3#0_0_0@0| (Tclass._module.List _module._default.Lemma$X))) (and ($Is DatatypeTypeType |nn#0_0_0@0| (Tclass._module.List _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |nn#0_0_0@0| (Tclass._module.List _module._default.Lemma$X) $Heap@0)))) (and (and (and (= |let#0_0_0#0#0| |_mcc#3#0_0_0@0|) ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.List _module._default.Lemma$X))) (and (= |nn#0_0_0@0| |let#0_0_0#0#0|) ($IsAlloc DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X) $Heap@0))) (and (and ($IsAlloc DatatypeTypeType |ext#0@@4| (Tclass._module.List _module._default.Lemma$X) $Heap@0) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext#0@@4|))))) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (=> (_module.List.Nil_q |ext#0@@4|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
