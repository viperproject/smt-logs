...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split1)
...
)))) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |S#0|)) (= |path#0@0| (Lit DatatypeTypeType |#_module.Path.Empty|))) (and (or (not (= |root#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.marked)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
