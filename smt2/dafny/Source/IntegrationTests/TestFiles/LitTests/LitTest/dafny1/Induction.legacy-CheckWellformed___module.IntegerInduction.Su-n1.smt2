...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) (this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.IntegerInduction.SumOfCubes#canCall| this@@0 |n#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.IntegerInduction)) (<= (LitInt 0) |n#0@@0|)))) (and (=> (or (not (= |n#0@@0| (LitInt 0))) (not true)) (|_module.IntegerInduction.SumOfCubes#canCall| this@@0 (- |n#0@@0| 1))) (= (_module.IntegerInduction.SumOfCubes ($LS $ly@@0) this@@0 |n#0@@0|) (ite (= |n#0@@0| (LitInt 0)) 0 (+ (_module.IntegerInduction.SumOfCubes $ly@@0 this@@0 (- |n#0@@0| 1)) (Mul (Mul |n#0@@0| |n#0@@0|) |n#0@@0|))))))
 :qid |Inductionlegacydfy.11:18|
 :skolemid |548|
 :pattern ( (_module.IntegerInduction.SumOfCubes ($LS $ly@@0) this@@0 |n#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (this@@1 T@U) (|n#0@@1| Int) ) (! (= (_module.IntegerInduction.SumOfCubes ($LS $ly@@1) this@@1 |n#0@@1|) (_module.IntegerInduction.SumOfCubes $ly@@1 this@@1 |n#0@@1|))
 :qid |Inductionlegacydfy.11:18|
 :skolemid |543|
 :pattern ( (_module.IntegerInduction.SumOfCubes ($LS $ly@@1) this@@1 |n#0@@1|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) (this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.IntegerInduction.SumOfCubes#canCall| (Lit refType this@@2) (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.IntegerInduction)) (<= (LitInt 0) (LitInt |n#0@@2|))))) (and (=> (or (not (= (LitInt |n#0@@2|) (LitInt 0))) (not true)) (|_module.IntegerInduction.SumOfCubes#canCall| (Lit refType this@@2) (LitInt (- |n#0@@2| 1)))) (= (_module.IntegerInduction.SumOfCubes ($LS $ly@@2) (Lit refType this@@2) (LitInt |n#0@@2|)) (ite (= (LitInt |n#0@@2|) (LitInt 0)) 0 (+ (_module.IntegerInduction.SumOfCubes ($LS $ly@@2) (Lit refType this@@2) (LitInt (- |n#0@@2| 1))) (Mul (LitInt (Mul (LitInt |n#0@@2|) (LitInt |n#0@@2|))) (LitInt |n#0@@2|)))))))
 :qid |Inductionlegacydfy.11:18|
 :weight 3
 :skolemid |550|
 :pattern ( (_module.IntegerInduction.SumOfCubes ($LS $ly@@2) (Lit refType this@@2) (LitInt |n#0@@2|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.IntegerInduction.SumOfCubes)
