...
(set-info :boogie-vc-id Impl$$_module.__default.P26)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|x#1| T@U) (|xs#1| T@U) (|ys#1@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |x#1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#1| Tclass._module.List)) ($Is DatatypeTypeType |ys#1@@0| Tclass._module.List)) (=> (|_module.Bool#Equal| (_module.__default.mem ($LS ($LS $LZ)) |x#1| |xs#1|) |#_module.Bool.True|) (|_module.Bool#Equal| (_module.__default.mem ($LS ($LS $LZ)) |x#1| (_module.__default.concat ($LS ($LS $LZ)) |xs#1| |ys#1@@0|)) |#_module.Bool.True|)))
 :qid |Ripplinglegacydfy.432:18|
 :skolemid |996|
