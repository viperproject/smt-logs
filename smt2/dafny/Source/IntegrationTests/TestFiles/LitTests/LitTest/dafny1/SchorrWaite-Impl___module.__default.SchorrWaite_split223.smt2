...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split223)
...
))) (=> |$w$loop#0@0| (|Set#IsMember| |S#0@@5| ($Box refType |t#0@1|))))) (and (and (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@4| ($Box refType |t#0@1|)))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|)))))) (= |p#0@1| (ite (= (|Seq#Length| |stackNodes#0@4|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@4| (- (|Seq#Length| |stackNodes#0@4|) 1))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
