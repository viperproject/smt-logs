...
(let ((anon15_Then_correct  (=> (= |ys#Z#0@0| (|#_module.List.Cons| |_mcc#2#0| |_mcc#3#0|)) (=> (and ($Is DatatypeTypeType |_mcc#2#0| Tclass._module.Nat) ($Is DatatypeTypeType |_mcc#3#0| Tclass._module.List)) (=> (and (and (and (= |let#2#0#0| |_mcc#3#0|) ($Is DatatypeTypeType |let#2#0#0| Tclass._module.List)) (and (= |zs#Z#0@0| |let#2#0#0|) (= |let#3#0#0| |_mcc#2#0|))) (and (and ($Is DatatypeTypeType |let#3#0#0| Tclass._module.Nat) (= |z#Z#0@0| |let#3#0#0|)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 6) (- 0 5))))) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)))))))
(let ((anon14_Else_correct  (=> (or (not (= |ys#Z#0@0| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 8) 6) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct)))))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct  (=> (= |xs#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List))) (and (and (= |ys#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat) (= |y#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 9) 4) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (or (not (= |xs#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 10) 9) anon13_Then_correct) (=> (= (ControlFlow 0 10) 3) anon13_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
