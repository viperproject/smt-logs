...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0| T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.drop#canCall| (Lit DatatypeTypeType |n#0|) (Lit DatatypeTypeType |xs#0@@0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType |n#0|)))))) (let ((|m#3| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |n#0|)))))
 (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@0|)))))
(|_module.__default.drop#canCall| |m#3| |tail#3|))))) (= (_module.__default.drop ($LS $ly@@0) (Lit DatatypeTypeType |n#0|) (Lit DatatypeTypeType |xs#0@@0|)) (ite (_module.Nat.Zero_q (Lit DatatypeTypeType |n#0|)) |xs#0@@0| (let ((|m#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |n#0|)))))
(ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)) |#_module.List.Nil| (let ((|tail#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@0|)))))
(Lit DatatypeTypeType (_module.__default.drop ($LS $ly@@0) |m#2| |tail#2|)))))))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@0 T@U) (|f#0@@0| T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.apply#canCall| |f#0@@0| |xs#0@@1|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|ys#1| (_module.List._h2 |xs#0@@1|)))
(|_module.__default.apply#canCall| |f#0@@0| |ys#1|))) (= (_module.__default.apply ($LS $ly@@1) |f#0@@0| |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) |#_module.List.Nil| (let ((|ys#0| (_module.List._h2 |xs#0@@1|)))
(let ((|y#0| (_module.List._h1 |xs#0@@1|)))
(|#_module.List.Cons| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@0 |f#0@@0| ($Box DatatypeTypeType |y#0|))) (_module.__default.apply $ly@@1 |f#0@@0| |ys#0|))))))))
 :qid |Ripplinglegacydfy.163:16|
 :skolemid |703|
 :pattern ( (_module.__default.apply ($LS $ly@@1) |f#0@@0| |xs#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@1 T@U) (|f#0@@1| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.apply#canCall| |f#0@@1| (Lit DatatypeTypeType |xs#0@@2|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(|_module.__default.apply#canCall| |f#0@@1| |ys#3|))) (= (_module.__default.apply ($LS $ly@@2) |f#0@@1| (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |#_module.List.Nil| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
(|#_module.List.Cons| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 |f#0@@1| ($Box DatatypeTypeType |y#2|))) (_module.__default.apply ($LS $ly@@2) |f#0@@1| |ys#2|))))))))
 :qid |Ripplinglegacydfy.163:16|
 :weight 3
 :skolemid |704|
 :pattern ( (_module.__default.apply ($LS $ly@@2) |f#0@@1| (Lit DatatypeTypeType |xs#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|n#0@@0| T@U) (|xs#0@@3| T@U) ) (!  (=> (or (|_module.__default.drop#canCall| |n#0@@0| |xs#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)))) (and (=> (not (_module.Nat.Zero_q |n#0@@0|)) (let ((|m#1| (_module.Nat._h0 |n#0@@0|)))
 (=> (not (_module.List.Nil_q |xs#0@@3|)) (let ((|tail#1| (_module.List._h2 |xs#0@@3|)))
(|_module.__default.drop#canCall| |m#1| |tail#1|))))) (= (_module.__default.drop ($LS $ly@@3) |n#0@@0| |xs#0@@3|) (ite (_module.Nat.Zero_q |n#0@@0|) |xs#0@@3| (let ((|m#0| (_module.Nat._h0 |n#0@@0|)))
(ite (_module.List.Nil_q |xs#0@@3|) |#_module.List.Nil| (let ((|tail#0| (_module.List._h2 |xs#0@@3|)))
(_module.__default.drop $ly@@3 |m#0| |tail#0|))))))))
 :qid |Ripplinglegacydfy.121:16|
 :skolemid |667|
 :pattern ( (_module.__default.drop ($LS $ly@@3) |n#0@@0| |xs#0@@3|))
))))
...
(assert (forall (($ly@@5 T@U) (|n#0@@2| T@U) (|xs#0@@5| T@U) ) (! (= (_module.__default.drop ($LS $ly@@5) |n#0@@2| |xs#0@@5|) (_module.__default.drop $ly@@5 |n#0@@2| |xs#0@@5|))
 :qid |Ripplinglegacydfy.121:16|
 :skolemid |663|
 :pattern ( (_module.__default.drop ($LS $ly@@5) |n#0@@2| |xs#0@@5|))
)))
(assert (forall (($ly@@6 T@U) (|f#0@@2| T@U) (|xs#0@@6| T@U) ) (! (= (_module.__default.apply ($LS $ly@@6) |f#0@@2| |xs#0@@6|) (_module.__default.apply $ly@@6 |f#0@@2| |xs#0@@6|))
 :qid |Ripplinglegacydfy.163:16|
 :skolemid |699|
 :pattern ( (_module.__default.apply ($LS $ly@@6) |f#0@@2| |xs#0@@6|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@7 T@U) (|f#0@@5| T@U) (|xs#0@@7| T@U) ) (!  (=> (or (|_module.__default.apply#canCall| |f#0@@5| |xs#0@@7|) (and (< 2 $FunctionContextHeight) (and ($Is HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($Is DatatypeTypeType |xs#0@@7| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.apply $ly@@7 |f#0@@5| |xs#0@@7|) Tclass._module.List))
 :qid |Ripplinglegacydfy.163:16|
 :skolemid |701|
 :pattern ( (_module.__default.apply $ly@@7 |f#0@@5| |xs#0@@7|))
))))
(push 1)
...
(set-info :boogie-vc-id Impl$$_module.__default.P12)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|n#1| T@U) (|xs#1| T@U) (|f#1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |n#1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#1| Tclass._module.List)) ($Is HandleTypeType |f#1| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) (|_module.List#Equal| (_module.__default.drop ($LS ($LS $LZ)) |n#1| (_module.__default.apply ($LS ($LS $LZ)) |f#1| |xs#1|)) (_module.__default.apply ($LS ($LS $LZ)) |f#1| (_module.__default.drop ($LS ($LS $LZ)) |n#1| |xs#1|))))
 :qid |Ripplinglegacydfy.360:18|
 :skolemid |894|
 :pattern ( (_module.__default.apply ($LS ($LS $LZ)) |f#1| (_module.__default.drop ($LS ($LS $LZ)) |n#1| |xs#1|)))
 :pattern ( (_module.__default.drop ($LS ($LS $LZ)) |n#1| (_module.__default.apply ($LS ($LS $LZ)) |f#1| |xs#1|)))
)))))
