...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.SkipHead)
...
(let ((anon8_Then_correct  (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |r#0@0|) (Tclass._module.Node? _module.Node$T@@20) $Heap@0) (=> (and (|_module.Node.Valid#canCall| _module.Node$T@@20 $Heap@0 |r#0@0|) (_module.Node.Valid _module.Node$T@@20 ($LS $LZ) $Heap@0 |r#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Node.List)))))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Node.List))))) (=> (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Node.List)) (|Seq#Drop| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Node.List)) (LitInt 1))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |r#0@0| null)) (not true))))))))))))))
(let ((anon7_Else_correct  (=> (=> (= |r#0@0| null) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Node.List))) (LitInt 1))) (and (=> (= (ControlFlow 0 8) 2) anon8_Then_correct) (=> (= (ControlFlow 0 8) 6) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (= |r#0@0| null) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.Node.List))) (LitInt 1))) (and (=> (= (ControlFlow 0 7) 2) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc false)) ($IsAllocBox ($Box refType this@@2) (Tclass._module.Node? _module.Node$T@@20) $Heap@@1)) (=> (and (and (and (|_module.Node.Valid#canCall| _module.Node$T@@20 $Heap@@1 this@@2) (_module.Node.Valid _module.Node$T@@20 ($LS $LZ) $Heap@@1 this@@2)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11)))
 :qid |ListContentsdfy.48:10|
 :skolemid |531|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11))
)) ($HeapSucc $Heap@@1 $Heap@0)) (and ($Is refType |r#0@0| (Tclass._module.Node? _module.Node$T@@20)) ($IsAlloc refType |r#0@0| (Tclass._module.Node? _module.Node$T@@20) $Heap@0)))) (and (=> (= (ControlFlow 0 9) 7) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Node _module.Node$T@@20)) ($IsAlloc refType this@@2 (Tclass._module.Node _module.Node$T@@20) $Heap@@1)))) (and (and ($Is refType |r#0| (Tclass._module.Node? _module.Node$T@@20)) ($IsAlloc refType |r#0| (Tclass._module.Node? _module.Node$T@@20) $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct)))
