...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.AttributeOnLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.List| |xs#0@@3|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| Tclass._module.List) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@3|))) (|_module.List#Equal| (_module.__default.Append ($LS $LZ) |$ih#xs0#0| (Lit DatatypeTypeType |#_module.List.Nil|)) |$ih#xs0#0|))
 :qid |InductionOptionslegacydfy.38:37|
 :skolemid |555|
 :pattern ( (_module.__default.Append ($LS $LZ) |$ih#xs0#0| (Lit DatatypeTypeType |#_module.List.Nil|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (|_module.List#Equal| (_module.__default.Append ($LS ($LS $LZ)) |xs#0@@3| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs#0@@3|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List) ($IsAlloc DatatypeTypeType |xs#0@@3| Tclass._module.List $Heap)) (|$IsA#_module.List| |xs#0@@3|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
