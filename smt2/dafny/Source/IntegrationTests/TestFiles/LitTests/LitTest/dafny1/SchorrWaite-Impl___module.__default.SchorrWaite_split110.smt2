...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split110)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 101) (let ((anon160_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.marked)))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |n#24@0| null)) (not true)))))
