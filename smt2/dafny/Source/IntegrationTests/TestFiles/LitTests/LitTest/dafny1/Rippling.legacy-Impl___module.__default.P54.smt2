...
(let ((anon2_correct  (=> (forall ((|m#3| T@U) (|n#3| T@U) )  (=> (and ($Is DatatypeTypeType |m#3| Tclass._module.Nat) ($Is DatatypeTypeType |n#3| Tclass._module.Nat)) (and (and (|$IsA#_module.Nat| (_module.__default.minus ($LS $LZ) (_module.__default.add ($LS $LZ) |n#3| |m#3|) |n#3|)) (|$IsA#_module.Nat| |m#3|)) (and (|_module.__default.add#canCall| |n#3| |m#3|) (|_module.__default.minus#canCall| (_module.__default.add ($LS $LZ) |n#3| |m#3|) |n#3|))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (forall ((|m#3@@0| T@U) (|n#3@@0| T@U) )  (=> (and ($Is DatatypeTypeType |m#3@@0| Tclass._module.Nat) ($Is DatatypeTypeType |n#3@@0| Tclass._module.Nat)) (|_module.Nat#Equal| (_module.__default.minus ($LS ($LS $LZ)) (_module.__default.add ($LS ($LS $LZ)) |n#3@@0| |m#3@@0|) |n#3@@0|) |m#3@@0|)))) (=> (forall ((|m#3@@1| T@U) (|n#3@@1| T@U) )  (=> (and ($Is DatatypeTypeType |m#3@@1| Tclass._module.Nat) ($Is DatatypeTypeType |n#3@@1| Tclass._module.Nat)) (|_module.Nat#Equal| (_module.__default.minus ($LS $LZ) (_module.__default.add ($LS $LZ) |n#3@@1| |m#3@@1|) |n#3@@1|) |m#3@@1|))) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))))
