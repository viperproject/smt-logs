...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SchorrWaite_split10)
...
)) (=> (and (and (and ($Is refType |n#6@0| Tclass._module.Node) ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap@0)) (and (|Set#IsMember| |S#0| ($Box refType |n#6@0|)) (or (not (= |n#6@0| null)) (not true)))) (and (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#6@0|) _module.Node.marked))) ($IsAlloc refType |root#0| Tclass._module.Node $Heap)) (and ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc SetType |S#0| (TSet Tclass._module.Node) $Heap)))))
...
)) (= (ControlFlow 0 4) 2)) anon18_correct)))
(let ((anon30_Else_correct  (=> (and (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.children)) ($Box refType |ch#3@0|)) (or (not (= |ch#3@0| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ch#3@0|) _module.Node.marked)))) (= (ControlFlow 0 6) 4)) anon16_correct)))
(let ((anon30_Then_correct  (=> (and (or (not (= |n#4@0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.children)) ($Box refType |ch#3@0|))) (=> (and (and (or (not (= |ch#3@0| null)) (not true)) (or (not (= |ch#3@0| null)) (not true))) (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ch#3@0|) _module.Node.marked))) (= (ControlFlow 0 5) 4))) anon16_correct))))
(let ((anon29_Then_correct  (=> (|Set#IsMember| |S#0| ($Box refType |n#4@0|)) (=> (and (and (or (not (= |n#4@0| null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.marked)))) (and ($Is refType |ch#3@0| Tclass._module.Node?) ($IsAlloc refType |ch#3@0| Tclass._module.Node? $Heap@0))) (and (=> (= (ControlFlow 0 7) 5) anon30_Then_correct) (=> (= (ControlFlow 0 7) 6) anon30_Else_correct))))))
...
))) (= (ControlFlow 0 3) 2)) anon18_correct)))
...
)) ($HeapSucc $Heap $Heap@0))) (and (and (or (not (= |root#0| null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.marked)))) (and ($Is refType |n#4@0| Tclass._module.Node) ($IsAlloc refType |n#4@0| Tclass._module.Node $Heap@0)))) (and (=> (= (ControlFlow 0 8) 7) anon29_Then_correct) (=> (= (ControlFlow 0 8) 3) anon29_Else_correct))))))
(let ((anon28_Else_correct  (=> (and (=> (|Set#IsMember| |S#0| ($Box refType |n#2@0|)) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#2@0|) _module.Node.marked)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#2@0|) _module.Node.childrenVisited))) (LitInt 0)))) (= (ControlFlow 0 10) 8)) anon12_correct)))
(let ((anon28_Then_correct  (=> (and (|Set#IsMember| |S#0| ($Box refType |n#2@0|)) (or (not (= |n#2@0| null)) (not true))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#2@0|) _module.Node.marked)))) (or (not (= |n#2@0| null)) (not true))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#2@0|) _module.Node.childrenVisited))) (LitInt 0)) (= (ControlFlow 0 9) 8))) anon12_correct))))
...
)) (=> (and ($Is refType |n#2@0| Tclass._module.Node) ($IsAlloc refType |n#2@0| Tclass._module.Node $Heap)) (and (=> (= (ControlFlow 0 11) 9) anon28_Then_correct) (=> (= (ControlFlow 0 11) 10) anon28_Else_correct))))))
...
)) (= (ControlFlow 0 13) 11)) anon9_correct)))
(let ((anon27_Else_correct  (=> (or (not (= |ch#0@0| null)) (not true)) (=> (and (|Set#IsMember| |S#0| ($Box refType |ch#0@0|)) (= (ControlFlow 0 16) 13)) anon7_correct))))
(let ((anon27_Then_correct  (=> (and (= |ch#0@0| null) (= (ControlFlow 0 15) 13)) anon7_correct)))
(let ((anon26_Then_correct  (=> (and (or (not (= |n#0@0| null)) (not true)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#0@0|) _module.Node.children)) ($Box refType |ch#0@0|))) (and (=> (= (ControlFlow 0 17) 15) anon27_Then_correct) (=> (= (ControlFlow 0 17) 16) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#0@0|) _module.Node.children)) ($Box refType |ch#0@0|)) (or (= |ch#0@0| null) (|Set#IsMember| |S#0| ($Box refType |ch#0@0|)))) (= (ControlFlow 0 14) 13)) anon7_correct)))
(let ((anon25_Then_correct  (=> (|Set#IsMember| |S#0| ($Box refType |n#0@0|)) (=> (and ($Is refType |ch#0@0| Tclass._module.Node?) ($IsAlloc refType |ch#0@0| Tclass._module.Node? $Heap)) (and (=> (= (ControlFlow 0 18) 17) anon26_Then_correct) (=> (= (ControlFlow 0 18) 14) anon26_Else_correct))))))
