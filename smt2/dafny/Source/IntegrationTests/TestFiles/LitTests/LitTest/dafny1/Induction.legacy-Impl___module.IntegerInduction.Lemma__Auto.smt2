...
(set-info :boogie-vc-id Impl$$_module.IntegerInduction.Lemma__Auto)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#n0#0| Int) ) (!  (=> (and (<= (LitInt 0) |$ih#n0#0|) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@3|))) (= (Mul (LitInt 2) (_module.IntegerInduction.Gauss ($LS $LZ) this@@3 |$ih#n0#0|)) (Mul |$ih#n0#0| (+ |$ih#n0#0| 1))))
 :qid |Inductionlegacydfy.66:20|
 :skolemid |574|
 :pattern ( (_module.IntegerInduction.Gauss ($LS $LZ) this@@3 |$ih#n0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (Mul (LitInt 2) (_module.IntegerInduction.Gauss ($LS ($LS $LZ)) this@@3 |n#0@@3|)) (Mul |n#0@@3| (+ |n#0@@3| 1)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.IntegerInduction) ($IsAlloc refType this@@3 Tclass._module.IntegerInduction $Heap))) (= 1 $FunctionContextHeight)) (and (<= (LitInt 0) |n#0@@3|) (= (ControlFlow 0 3) 2))) anon0_correct))))
