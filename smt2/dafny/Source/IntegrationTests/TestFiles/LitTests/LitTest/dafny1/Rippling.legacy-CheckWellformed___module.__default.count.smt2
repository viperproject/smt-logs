...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|x#0@@1| T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.count#canCall| |x#0@@1| |xs#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.count $ly@@1 |x#0@@1| |xs#0@@1|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |686|
 :pattern ( (_module.__default.count $ly@@1 |x#0@@1| |xs#0@@1|))
))))
(assert (forall (($ly@@2 T@U) (|x#0@@2| T@U) (|xs#0@@2| T@U) ) (! (= (_module.__default.count ($LS $ly@@2) |x#0@@2| |xs#0@@2|) (_module.__default.count $ly@@2 |x#0@@2| |xs#0@@2|))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |684|
 :pattern ( (_module.__default.count ($LS $ly@@2) |x#0@@2| |xs#0@@2|))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon13_Else_correct  (=> (and (and (not (|_module.Nat#Equal| |x#0@@3| |y#Z#0@0|)) ($IsAlloc DatatypeTypeType |x#0@@3| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 7) (- 0 6)))) (or (< (DtRank |x#0@@3|) (DtRank |x#0@@3|)) (and (= (DtRank |x#0@@3|) (DtRank |x#0@@3|)) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)))))))
(let ((anon13_Then_correct  (=> (and (and (|_module.Nat#Equal| |x#0@@3| |y#Z#0@0|) ($IsAlloc DatatypeTypeType |x#0@@3| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 5) (- 0 4)))) (or (< (DtRank |x#0@@3|) (DtRank |x#0@@3|)) (and (= (DtRank |x#0@@3|) (DtRank |x#0@@3|)) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |x#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
