...
(assert (forall ((_module._default.ToSeq$X T@U) ($ly@@1 T@U) (|list#0@@2| T@U) ) (! (= (_module.__default.ToSeq _module._default.ToSeq$X ($LS $ly@@1) |list#0@@2|) (_module.__default.ToSeq _module._default.ToSeq$X $ly@@1 |list#0@@2|))
 :qid |unknown.0:0|
 :skolemid |558|
 :pattern ( (_module.__default.ToSeq _module._default.ToSeq$X ($LS $ly@@1) |list#0@@2|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.Flatten$X T@U) ($ly@@2 T@U) (|list#0@@3| T@U) (|ext#0| T@U) ) (!  (=> (or (|_module.__default.Flatten#canCall| _module._default.Flatten$X |list#0@@3| |ext#0|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |list#0@@3| (Tclass._module.List _module._default.Flatten$X)) ($Is DatatypeTypeType |ext#0| (Tclass._module.List _module._default.Flatten$X))) (_module.__default.IsFlat _module._default.Flatten$X ($LS $LZ) |ext#0|)))) (and (_module.__default.IsFlat _module._default.Flatten$X ($LS $LZ) (_module.__default.Flatten _module._default.Flatten$X $ly@@2 |list#0@@3| |ext#0|)) ($Is DatatypeTypeType (_module.__default.Flatten _module._default.Flatten$X $ly@@2 |list#0@@3| |ext#0|) (Tclass._module.List _module._default.Flatten$X))))
 :qid |unknown.0:0|
 :skolemid |539|
 :pattern ( (_module.__default.Flatten _module._default.Flatten$X $ly@@2 |list#0@@3| |ext#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.ToSeq$X@@0 T@U) ($ly@@3 T@U) (|list#0@@4| T@U) ) (!  (=> (or (|_module.__default.ToSeq#canCall| _module._default.ToSeq$X@@0 (Lit DatatypeTypeType |list#0@@4|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@4| (Tclass._module.List _module._default.ToSeq$X@@0)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |list#0@@4|)))))) (let ((|rest#3@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |list#0@@4|)))))
(let ((|n#3@@0| (Lit DatatypeTypeType (_module.List._h0 (Lit DatatypeTypeType |list#0@@4|)))))
 ...
 (and (|_module.__default.ToSeq#canCall| _module._default.ToSeq$X@@0 |nn#3|) (|_module.__default.ToSeq#canCall| _module._default.ToSeq$X@@0 |rest#3@@0|)))))))) (= (_module.__default.ToSeq _module._default.ToSeq$X@@0 ($LS $ly@@3) (Lit DatatypeTypeType |list#0@@4|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |list#0@@4|)) |Seq#Empty| (let ((|rest#2@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |list#0@@4|)))))
(let ((|n#2@@0| (Lit DatatypeTypeType (_module.List._h0 (Lit DatatypeTypeType |list#0@@4|)))))
...
(|Seq#Append| (_module.__default.ToSeq _module._default.ToSeq$X@@0 ($LS $ly@@3) |nn#2|) (_module.__default.ToSeq _module._default.ToSeq$X@@0 ($LS $ly@@3) |rest#2@@0|))))))))))
 ...
 :weight 3
 :skolemid |564|
 :pattern ( (_module.__default.ToSeq _module._default.ToSeq$X@@0 ($LS $ly@@3) (Lit DatatypeTypeType |list#0@@4|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.ToSeq$X@@1 T@U) ($ly@@4 T@U) (|list#0@@5| T@U) ) (!  (=> (and (or (|_module.__default.ToSeq#canCall| _module._default.ToSeq$X@@1 |list#0@@5|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |list#0@@5| (Tclass._module.List _module._default.ToSeq$X@@1)) ($IsAlloc DatatypeTypeType |list#0@@5| (Tclass._module.List _module._default.ToSeq$X@@1) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc SeqType (_module.__default.ToSeq _module._default.ToSeq$X@@1 $ly@@4 |list#0@@5|) (TSeq _module._default.ToSeq$X@@1) $Heap))
 :qid |MoreInductiondfy.35:16|
 :skolemid |561|
 :pattern ( ($IsAlloc SeqType (_module.__default.ToSeq _module._default.ToSeq$X@@1 $ly@@4 |list#0@@5|) (TSeq _module._default.ToSeq$X@@1) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.ToSeq$X@@2 T@U) ($ly@@5 T@U) (|list#0@@6| T@U) ) (!  (=> (or (|_module.__default.ToSeq#canCall| _module._default.ToSeq$X@@2 |list#0@@6|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@6| (Tclass._module.List _module._default.ToSeq$X@@2)))) (and (=> (not (_module.List.Nil_q |list#0@@6|)) (let ((|rest#1| (_module.List._h1 |list#0@@6|)))
(let ((|n#1| (_module.List._h0 |list#0@@6|)))
 ...
 (and (|_module.__default.ToSeq#canCall| _module._default.ToSeq$X@@2 |nn#1|) (|_module.__default.ToSeq#canCall| _module._default.ToSeq$X@@2 |rest#1|)))))))) (= (_module.__default.ToSeq _module._default.ToSeq$X@@2 ($LS $ly@@5) |list#0@@6|) (ite (_module.List.Nil_q |list#0@@6|) |Seq#Empty| (let ((|rest#0| (_module.List._h1 |list#0@@6|)))
...
(|Seq#Append| (_module.__default.ToSeq _module._default.ToSeq$X@@2 $ly@@5 |nn#0|) (_module.__default.ToSeq _module._default.ToSeq$X@@2 $ly@@5 |rest#0|))))))))))
 :qid |unknown.0:0|
 :skolemid |563|
 :pattern ( (_module.__default.ToSeq _module._default.ToSeq$X@@2 ($LS $ly@@5) |list#0@@6|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.ToSeq$X@@3 T@U) ($ly@@6 T@U) (|list#0@@7| T@U) ) (!  (=> (or (|_module.__default.ToSeq#canCall| _module._default.ToSeq$X@@3 |list#0@@7|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@7| (Tclass._module.List _module._default.ToSeq$X@@3)))) ($Is SeqType (_module.__default.ToSeq _module._default.ToSeq$X@@3 $ly@@6 |list#0@@7|) (TSeq _module._default.ToSeq$X@@3)))
 :qid |unknown.0:0|
 :skolemid |560|
 :pattern ( (_module.__default.ToSeq _module._default.ToSeq$X@@3 $ly@@6 |list#0@@7|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((_module._default.FlattenMain$M@@0 T@U) (|list#0@@8| T@U) ) (!  (=> (or (|_module.__default.FlattenMain#canCall| _module._default.FlattenMain$M@@0 |list#0@@8|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@8| (Tclass._module.List _module._default.FlattenMain$M@@0)))) (and (|_module.__default.Flatten#canCall| _module._default.FlattenMain$M@@0 |list#0@@8| (Lit DatatypeTypeType |#_module.List.Nil|)) (= (_module.__default.FlattenMain _module._default.FlattenMain$M@@0 |list#0@@8|) (_module.__default.Flatten _module._default.FlattenMain$M@@0 ($LS $LZ) |list#0@@8| (Lit DatatypeTypeType |#_module.List.Nil|)))))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( (_module.__default.FlattenMain _module._default.FlattenMain$M@@0 |list#0@@8|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@0 T@U) (_module._default.Flatten$X@@0 T@U) ($ly@@7 T@U) (|list#0@@9| T@U) (|ext#0@@0| T@U) ) (!  (=> (and (or (|_module.__default.Flatten#canCall| _module._default.Flatten$X@@0 |list#0@@9| |ext#0@@0|) (and (< 2 $FunctionContextHeight) (and (and (and ($Is DatatypeTypeType |list#0@@9| (Tclass._module.List _module._default.Flatten$X@@0)) ($IsAlloc DatatypeTypeType |list#0@@9| (Tclass._module.List _module._default.Flatten$X@@0) $Heap@@0)) (and ($Is DatatypeTypeType |ext#0@@0| (Tclass._module.List _module._default.Flatten$X@@0)) ($IsAlloc DatatypeTypeType |ext#0@@0| (Tclass._module.List _module._default.Flatten$X@@0) $Heap@@0))) (_module.__default.IsFlat _module._default.Flatten$X@@0 ($LS $LZ) |ext#0@@0|)))) ($IsGoodHeap $Heap@@0)) ($IsAlloc DatatypeTypeType (_module.__default.Flatten _module._default.Flatten$X@@0 $ly@@7 |list#0@@9| |ext#0@@0|) (Tclass._module.List _module._default.Flatten$X@@0) $Heap@@0))
 :qid |MoreInductiondfy.13:16|
 :skolemid |540|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.Flatten _module._default.Flatten$X@@0 $ly@@7 |list#0@@9| |ext#0@@0|) (Tclass._module.List _module._default.Flatten$X@@0) $Heap@@0))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@1 T@U) (_module._default.FlattenMain$M@@1 T@U) (|list#0@@10| T@U) ) (!  (=> (and (or (|_module.__default.FlattenMain#canCall| _module._default.FlattenMain$M@@1 |list#0@@10|) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |list#0@@10| (Tclass._module.List _module._default.FlattenMain$M@@1)) ($IsAlloc DatatypeTypeType |list#0@@10| (Tclass._module.List _module._default.FlattenMain$M@@1) $Heap@@1)))) ($IsGoodHeap $Heap@@1)) ($IsAlloc DatatypeTypeType (_module.__default.FlattenMain _module._default.FlattenMain$M@@1 |list#0@@10|) (Tclass._module.List _module._default.FlattenMain$M@@1) $Heap@@1))
 :qid |MoreInductiondfy.7:16|
 :skolemid |532|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.FlattenMain _module._default.FlattenMain$M@@1 |list#0@@10|) (Tclass._module.List _module._default.FlattenMain$M@@1) $Heap@@1))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.IsFlat$F@@1 T@U) ($ly@@8 T@U) (|list#0@@11| T@U) ) (!  (=> (or (|_module.__default.IsFlat#canCall| _module._default.IsFlat$F@@1 |list#0@@11|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@11| (Tclass._module.List _module._default.IsFlat$F@@1)))) (and (=> (not (_module.List.Nil_q |list#0@@11|)) (let ((|rest#1@@0| (_module.List._h1 |list#0@@11|)))
(let ((|n#1@@0| (_module.List._h0 |list#0@@11|)))
 (=> (_module.Node.Element_q |n#1@@0|) (|_module.__default.IsFlat#canCall| _module._default.IsFlat$F@@1 |rest#1@@0|))))) (= (_module.__default.IsFlat _module._default.IsFlat$F@@1 ($LS $ly@@8) |list#0@@11|) (ite (_module.List.Nil_q |list#0@@11|) true (let ((|rest#0@@0| (_module.List._h1 |list#0@@11|)))
(let ((|n#0@@0| (_module.List._h0 |list#0@@11|)))
(ite (_module.Node.Element_q |n#0@@0|) (_module.__default.IsFlat _module._default.IsFlat$F@@1 $ly@@8 |rest#0@@0|) (U_2_bool (Lit boolType (bool_2_U false))))))))))
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( (_module.__default.IsFlat _module._default.IsFlat$F@@1 ($LS $ly@@8) |list#0@@11|))
))))
...
(assert (forall ((_module._default.Flatten$X@@1 T@U) ($ly@@9 T@U) (|list#0@@12| T@U) (|ext#0@@1| T@U) ) (! (= (_module.__default.Flatten _module._default.Flatten$X@@1 ($LS $ly@@9) |list#0@@12| |ext#0@@1|) (_module.__default.Flatten _module._default.Flatten$X@@1 $ly@@9 |list#0@@12| |ext#0@@1|))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( (_module.__default.Flatten _module._default.Flatten$X@@1 ($LS $ly@@9) |list#0@@12| |ext#0@@1|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.Flatten$X@@2 T@U) ($ly@@10 T@U) (|list#0@@13| T@U) (|ext#0@@2| T@U) ) (!  (=> (or (|_module.__default.Flatten#canCall| _module._default.Flatten$X@@2 |list#0@@13| |ext#0@@2|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |list#0@@13| (Tclass._module.List _module._default.Flatten$X@@2)) ($Is DatatypeTypeType |ext#0@@2| (Tclass._module.List _module._default.Flatten$X@@2))) (_module.__default.IsFlat _module._default.Flatten$X@@2 ($LS $LZ) |ext#0@@2|)))) (and (=> (not (_module.List.Nil_q |list#0@@13|)) (let ((|rest#1@@1| (_module.List._h1 |list#0@@13|)))
(let ((|n#1@@1| (_module.List._h0 |list#0@@13|)))
...
(_module.__default.Flatten _module._default.Flatten$X@@2 $ly@@10 |nn#0@@0| (_module.__default.Flatten _module._default.Flatten$X@@2 $ly@@10 |rest#0@@1| |ext#0@@2|))))))))))
 :qid |unknown.0:0|
 :skolemid |542|
 :pattern ( (_module.__default.Flatten _module._default.Flatten$X@@2 ($LS $ly@@10) |list#0@@13| |ext#0@@2|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((_module._default.FlattenMain$M@@2 T@U) (|list#0@@14| T@U) ) (!  (=> (or (|_module.__default.FlattenMain#canCall| _module._default.FlattenMain$M@@2 |list#0@@14|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |list#0@@14| (Tclass._module.List _module._default.FlattenMain$M@@2)))) (and (_module.__default.IsFlat _module._default.FlattenMain$M@@2 ($LS $LZ) (_module.__default.FlattenMain _module._default.FlattenMain$M@@2 |list#0@@14|)) ($Is DatatypeTypeType (_module.__default.FlattenMain _module._default.FlattenMain$M@@2 |list#0@@14|) (Tclass._module.List _module._default.FlattenMain$M@@2))))
 :qid |unknown.0:0|
 :skolemid |531|
 :pattern ( (_module.__default.FlattenMain _module._default.FlattenMain$M@@2 |list#0@@14|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.Flatten$X@@3 T@U) ($ly@@11 T@U) (|list#0@@15| T@U) (|ext#0@@3| T@U) ) (!  (=> (or (|_module.__default.Flatten#canCall| _module._default.Flatten$X@@3 (Lit DatatypeTypeType |list#0@@15|) (Lit DatatypeTypeType |ext#0@@3|)) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |list#0@@15| (Tclass._module.List _module._default.Flatten$X@@3)) ($Is DatatypeTypeType |ext#0@@3| (Tclass._module.List _module._default.Flatten$X@@3))) (U_2_bool (Lit boolType (bool_2_U (_module.__default.IsFlat _module._default.Flatten$X@@3 ($LS $LZ) (Lit DatatypeTypeType |ext#0@@3|)))))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |list#0@@15|)))))) (let ((|rest#3@@1| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |list#0@@15|)))))
(let ((|n#3@@1| (Lit DatatypeTypeType (_module.List._h0 (Lit DatatypeTypeType |list#0@@15|)))))
...
(Lit DatatypeTypeType (_module.__default.Flatten _module._default.Flatten$X@@3 ($LS $ly@@11) |nn#2@@0| (Lit DatatypeTypeType (_module.__default.Flatten _module._default.Flatten$X@@3 ($LS $ly@@11) |rest#2@@1| (Lit DatatypeTypeType |ext#0@@3|)))))))))))))
 ...
 :weight 3
 :skolemid |543|
 :pattern ( (_module.__default.Flatten _module._default.Flatten$X@@3 ($LS $ly@@11) (Lit DatatypeTypeType |list#0@@15|) (Lit DatatypeTypeType |ext#0@@3|)))
))))
...
(declare-fun |list#0@@16| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun _module._default.Theorem$X () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (|$IsA#_module.List| |list#0@@16|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and (forall ((|$ih#list0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#list0#0| (Tclass._module.List _module._default.Theorem$X)) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#list0#0|) (DtRank |list#0@@16|))) (|Seq#Equal| (_module.__default.ToSeq _module._default.Theorem$X ($LS $LZ) |$ih#list0#0|) (_module.__default.ToSeq _module._default.Theorem$X ($LS $LZ) (_module.__default.FlattenMain _module._default.Theorem$X |$ih#list0#0|))))
 :qid |MoreInductiondfy.45:18|
 :skolemid |568|
 :pattern ( (_module.__default.FlattenMain _module._default.Theorem$X |$ih#list0#0|))
)) (= |ext##0@0| (Lit DatatypeTypeType |#_module.List.Nil|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.IsFlat#canCall| _module._default.Theorem$X |ext##0@0|) (or (_module.__default.IsFlat _module._default.Theorem$X ($LS $LZ) |ext##0@0|) (=> (_module.List.Nil_q |ext##0@0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.IsFlat#canCall| _module._default.Theorem$X |ext##0@0|) (or (_module.__default.IsFlat _module._default.Theorem$X ($LS $LZ) |ext##0@0|) (=> (_module.List.Nil_q |ext##0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.IsFlat#canCall| _module._default.Theorem$X |ext##0@0|) (or (_module.__default.IsFlat _module._default.Theorem$X ($LS $LZ) |ext##0@0|) (=> (not (_module.List.Nil_q |ext##0@0|)) (let ((|rest#2@@2| (_module.List._h1 |ext##0@0|)))
(let ((|n#2@@2| (_module.List._h0 |ext##0@0|)))
 (=> (_module.Node.Element_q |n#2@@2|) (_module.__default.IsFlat _module._default.Theorem$X ($LS ($LS $LZ)) |rest#2@@2|)))))))) (=> (=> (|_module.__default.IsFlat#canCall| _module._default.Theorem$X |ext##0@0|) (or (_module.__default.IsFlat _module._default.Theorem$X ($LS $LZ) |ext##0@0|) (=> (not (_module.List.Nil_q |ext##0@0|)) (let ((|rest#2@@3| (_module.List._h1 |ext##0@0|)))
(let ((|n#2@@3| (_module.List._h0 |ext##0@0|)))
 (=> (_module.Node.Element_q |n#2@@3|) (_module.__default.IsFlat _module._default.Theorem$X ($LS ($LS $LZ)) |rest#2@@3|))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.IsFlat#canCall| _module._default.Theorem$X |ext##0@0|) (or (_module.__default.IsFlat _module._default.Theorem$X ($LS $LZ) |ext##0@0|) (=> (not (_module.List.Nil_q |ext##0@0|)) (let ((|n#2@@4| (_module.List._h0 |ext##0@0|)))
 (=> (not (_module.Node.Element_q |n#2@@4|)) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (=> (|_module.__default.IsFlat#canCall| _module._default.Theorem$X |ext##0@0|) (or (_module.__default.IsFlat _module._default.Theorem$X ($LS $LZ) |ext##0@0|) (=> (not (_module.List.Nil_q |ext##0@0|)) (let ((|n#2@@5| (_module.List._h0 |ext##0@0|)))
 (=> (not (_module.Node.Element_q |n#2@@5|)) (U_2_bool (Lit boolType (bool_2_U false)))))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (|_module.__default.ToSeq#canCall| _module._default.Theorem$X |list#0@@16|) (|_module.__default.ToSeq#canCall| _module._default.Theorem$X |ext##0@0|)) (and (|_module.__default.Flatten#canCall| _module._default.Theorem$X |list#0@@16| |ext##0@0|) (|_module.__default.ToSeq#canCall| _module._default.Theorem$X (_module.__default.Flatten _module._default.Theorem$X ($LS $LZ) |list#0@@16| |ext##0@0|)))) (|Seq#Equal| (|Seq#Append| (_module.__default.ToSeq _module._default.Theorem$X ($LS ($LS $LZ)) |list#0@@16|) (_module.__default.ToSeq _module._default.Theorem$X ($LS ($LS $LZ)) |ext##0@0|)) (_module.__default.ToSeq _module._default.Theorem$X ($LS ($LS $LZ)) (_module.__default.Flatten _module._default.Theorem$X ($LS ($LS $LZ)) |list#0@@16| |ext##0@0|)))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1)))) (|Seq#Equal| (_module.__default.ToSeq _module._default.Theorem$X ($LS ($LS $LZ)) |list#0@@16|) (_module.__default.ToSeq _module._default.Theorem$X ($LS ($LS $LZ)) (_module.__default.FlattenMain _module._default.Theorem$X |list#0@@16|)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and ($Is DatatypeTypeType |list#0@@16| (Tclass._module.List _module._default.Theorem$X)) ($IsAlloc DatatypeTypeType |list#0@@16| (Tclass._module.List _module._default.Theorem$X) $Heap@@2)) (|$IsA#_module.List| |list#0@@16|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
