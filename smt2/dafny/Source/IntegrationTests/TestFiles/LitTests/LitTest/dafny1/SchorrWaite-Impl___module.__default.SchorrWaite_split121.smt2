...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split121)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 121) (let ((anon95_correct  (=> (forall ((|n#29| T@U) ) (!  (=> ($Is refType |n#29| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#29|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#29|) _module.Node.marked))))) (|Set#IsMember| |unmarkedNodes#0@1| ($Box refType |n#29|))))
 :qid |SchorrWaitedfy.254:22|
 :skolemid |855|
 :pattern ( (|Set#IsMember| |unmarkedNodes#0@1| ($Box refType |n#29|)))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#29|) _module.Node.marked)))
 :pattern ( (|Set#IsMember| |S#0@@5| ($Box refType |n#29|)))
)) (=> (and (or (not (= |t#0@0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |t#0@0| null)) (not true))))))
(let ((anon167_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#28@0|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#28@0|) _module.Node.marked)))))) (= (ControlFlow 0 5) 2)) anon95_correct)))
(let ((anon167_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#28@0|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#28@0|) _module.Node.marked))))) (= (ControlFlow 0 4) 2)) anon95_correct)))
(let ((anon166_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#28@0|))) (and (=> (= (ControlFlow 0 7) 4) anon167_Then_correct) (=> (= (ControlFlow 0 7) 5) anon167_Else_correct)))))
(let ((anon166_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#28@0|)) (and (=> (= (ControlFlow 0 6) 4) anon167_Then_correct) (=> (= (ControlFlow 0 6) 5) anon167_Else_correct)))))
(let ((anon165_Then_correct  (=> (and ($Is refType |n#28@0| Tclass._module.Node) ($IsAlloc refType |n#28@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 8) 6) anon166_Then_correct) (=> (= (ControlFlow 0 8) 7) anon166_Else_correct)))))
(let ((anon165_Else_correct  (=> (and (not (and ($Is refType |n#28@0| Tclass._module.Node) ($IsAlloc refType |n#28@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 3) 2)) anon95_correct)))
(let ((anon90_correct  (=> (and (forall ((|n#27| T@U) ) (!  (=> ($Is refType |n#27| Tclass._module.Node) (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#27|)) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#27|) _module.Node.marked))) (|_module.__default.Reachable#canCall| $Heap@@3 |root#0| |n#27| |S#0@@5|))))
 :qid |SchorrWaitedfy.252:22|
 :skolemid |850|
 :pattern ( (_module.__default.Reachable $Heap@@3 |root#0| |n#27| |S#0@@5|))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#27|) _module.Node.marked)))
 :pattern ( (|Set#IsMember| |S#0@@5| ($Box refType |n#27|)))
)) (forall ((|n#27@@0| T@U) ) (!  (=> ($Is refType |n#27@@0| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#27@@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#27@@0|) _module.Node.marked)))) (_module.__default.Reachable $Heap@@3 |root#0| |n#27@@0| |S#0@@5|)))
 :qid |SchorrWaitedfy.252:22|
 :skolemid |851|
...
))) (and (=> (= (ControlFlow 0 9) 8) anon165_Then_correct) (=> (= (ControlFlow 0 9) 3) anon165_Else_correct)))))
(let ((anon164_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#26@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#26@0|) _module.Node.marked))))) (= (ControlFlow 0 12) 9)) anon90_correct)))
(let ((anon164_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#26@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#26@0|) _module.Node.marked)))) ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3)) (and (and ($IsAlloc refType |n#26@0| Tclass._module.Node $Heap@@3) ($IsAlloc SetType |S#0@@5| (TSet Tclass._module.Node) $Heap@@3)) (and (|_module.__default.Reachable#canCall| $Heap@@3 |root#0| |n#26@0| |S#0@@5|) (= (ControlFlow 0 11) 9)))) anon90_correct)))
(let ((anon163_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#26@0|))) (and (=> (= (ControlFlow 0 14) 11) anon164_Then_correct) (=> (= (ControlFlow 0 14) 12) anon164_Else_correct)))))
(let ((anon163_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#26@0|)) (and (=> (= (ControlFlow 0 13) 11) anon164_Then_correct) (=> (= (ControlFlow 0 13) 12) anon164_Else_correct)))))
(let ((anon162_Then_correct  (=> (and ($Is refType |n#26@0| Tclass._module.Node) ($IsAlloc refType |n#26@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 15) 13) anon163_Then_correct) (=> (= (ControlFlow 0 15) 14) anon163_Else_correct)))))
(let ((anon162_Else_correct  (=> (and (not (and ($Is refType |n#26@0| Tclass._module.Node) ($IsAlloc refType |n#26@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 10) 9)) anon90_correct)))
(let ((anon85_correct  (=> (and (forall ((|n#25| T@U) ) (!  (=> ($Is refType |n#25| Tclass._module.Node) (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#25|)) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#25|) _module.Node.marked))) (let ((|pth#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#25|) _module.Node.pathFromRoot))))
 ...
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#25|) _module.Node.pathFromRoot)))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#25|) _module.Node.marked)))
 :pattern ( (|Set#IsMember| |S#0@@5| ($Box refType |n#25|)))
)) (forall ((|n#25@@0| T@U) ) (!  (=> ($Is refType |n#25@@0| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#25@@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#25@@0|) _module.Node.marked)))) (let ((|pth#0@@0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#25@@0|) _module.Node.pathFromRoot))))
...
))) (and (=> (= (ControlFlow 0 16) 15) anon162_Then_correct) (=> (= (ControlFlow 0 16) 10) anon162_Else_correct)))))
(let ((anon161_Else_correct  (=> (and (not ($IsAllocBox ($Box DatatypeTypeType |pth#Z#0@0|) Tclass._module.Path $Heap@@3)) (= (ControlFlow 0 20) 16)) anon85_correct)))
(let ((anon161_Then_correct  (=> ($IsAllocBox ($Box DatatypeTypeType |pth#Z#0@0|) Tclass._module.Path $Heap@@3) (=> (and ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3) ($IsAlloc DatatypeTypeType |pth#Z#0@0| Tclass._module.Path $Heap@@3)) (=> (and (and ($IsAlloc refType |n#24@0| Tclass._module.Node $Heap@@3) ($IsAlloc SetType |S#0@@5| (TSet Tclass._module.Node) $Heap@@3)) (and (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |pth#Z#0@0| |n#24@0| |S#0@@5|) (= (ControlFlow 0 19) 16))) anon85_correct)))))
(let ((anon160_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.marked)))) (= |let#0#0#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.pathFromRoot)))) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Path) (= |pth#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 21) 19) anon161_Then_correct) (=> (= (ControlFlow 0 21) 20) anon161_Else_correct)))))
(let ((anon160_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.marked))))) (= (ControlFlow 0 18) 16)) anon85_correct)))
(let ((anon159_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|))) (and (=> (= (ControlFlow 0 23) 21) anon160_Then_correct) (=> (= (ControlFlow 0 23) 18) anon160_Else_correct)))))
(let ((anon159_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|)) (and (=> (= (ControlFlow 0 22) 21) anon160_Then_correct) (=> (= (ControlFlow 0 22) 18) anon160_Else_correct)))))
(let ((anon158_Then_correct  (=> (and ($Is refType |n#24@0| Tclass._module.Node) ($IsAlloc refType |n#24@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 24) 22) anon159_Then_correct) (=> (= (ControlFlow 0 24) 23) anon159_Else_correct)))))
(let ((anon158_Else_correct  (=> (and (not (and ($Is refType |n#24@0| Tclass._module.Node) ($IsAlloc refType |n#24@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 17) 16)) anon85_correct)))
(let ((anon79_correct  (=> (=> ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3) (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@1| |t#0@0| |S#0@@5|)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3) (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |root#0| |path#0@1| |t#0@0| |S#0@@5|)) (and (=> (= (ControlFlow 0 25) 24) anon158_Then_correct) (=> (= (ControlFlow 0 25) 17) anon158_Else_correct))))))
(let ((anon157_Else_correct  (=> (and (not ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3)) (= (ControlFlow 0 27) 25)) anon79_correct)))
(let ((anon157_Then_correct  (=> (and (and (and ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3) ($Is refType |t#0@0| Tclass._module.Node)) (and ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3) ($IsAlloc DatatypeTypeType |path#0@1| Tclass._module.Path $Heap@@3))) (and (and ($IsAlloc refType |t#0@0| Tclass._module.Node? $Heap@@3) ($IsAlloc SetType |S#0@@5| (TSet Tclass._module.Node) $Heap@@3)) (and (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@1| |t#0@0| |S#0@@5|) (= (ControlFlow 0 26) 25)))) anon79_correct)))
(let ((anon77_correct  (=> (and (forall ((|n#21| T@U) ) (!  (=> (and ($Is refType |n#21| Tclass._module.Node) ($IsAlloc refType |n#21| Tclass._module.Node $Heap@2)) (=> (or (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#21|)) (= |n#21| |t#0@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#21|) _module.Node.marked)))))
 :qid |SchorrWaitedfy.245:22|
 :skolemid |838|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#21|) _module.Node.marked)))
 :pattern ( (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#21|)))
)) (forall ((|n#21@@0| T@U) ) (!  (=> (and ($Is refType |n#21@@0| Tclass._module.Node) ($IsAlloc refType |n#21@@0| Tclass._module.Node $Heap@2)) (=> (or (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#21@@0|)) (= |n#21@@0| |t#0@0|)) (forall ((|j#3| Int) ) (!  (=> (and (<= (LitInt 0) |j#3|) (< |j#3| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#21@@0|) _module.Node.childrenVisited))))) (or (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#21@@0|) _module.Node.children)) |j#3|)) null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#21@@0|) _module.Node.children)) |j#3|))) _module.Node.marked)))))
 :qid |SchorrWaitedfy.247:24|
 :skolemid |839|
 :pattern ( ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#21@@0|) _module.Node.children)) |j#3|)))
))))
 :qid |SchorrWaitedfy.245:22|
 :skolemid |840|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#21@@0|) _module.Node.children)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#21@@0|) _module.Node.childrenVisited)))
 :pattern ( (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#21@@0|)))
))) (and (=> (= (ControlFlow 0 28) 26) anon157_Then_correct) (=> (= (ControlFlow 0 28) 27) anon157_Else_correct)))))
(let ((anon156_Else_correct  (=> (and (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.children)) |j#2@0|)) null) (= (ControlFlow 0 34) 28)) anon77_correct)))
(let ((anon156_Then_correct  (=> (and (or (not (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.children)) |j#2@0|)) null)) (not true)) (= (ControlFlow 0 33) 28)) anon77_correct)))
(let ((anon155_Then_correct  (=> (and (<= (LitInt 0) |j#2@0|) (< |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.childrenVisited))))) (and (=> (= (ControlFlow 0 35) 33) anon156_Then_correct) (=> (= (ControlFlow 0 35) 34) anon156_Else_correct)))))
(let ((anon155_Else_correct  (=> (and (not (and (<= (LitInt 0) |j#2@0|) (< |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.childrenVisited)))))) (= (ControlFlow 0 32) 28)) anon77_correct)))
(let ((anon154_Else_correct  (=> (< |j#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 37) 35) anon155_Then_correct) (=> (= (ControlFlow 0 37) 32) anon155_Else_correct)))))
(let ((anon154_Then_correct  (=> (<= (LitInt 0) |j#2@0|) (and (=> (= (ControlFlow 0 36) 35) anon155_Then_correct) (=> (= (ControlFlow 0 36) 32) anon155_Else_correct)))))
(let ((anon152_Then_correct  (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.marked))) (and (=> (= (ControlFlow 0 38) 36) anon154_Then_correct) (=> (= (ControlFlow 0 38) 37) anon154_Else_correct)))))
(let ((anon152_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.marked)))) (= (ControlFlow 0 31) 28)) anon77_correct)))
(let ((anon151_Then_correct  (=> (or (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#20@0|)) (= |n#20@0| |t#0@0|)) (and (=> (= (ControlFlow 0 39) 38) anon152_Then_correct) (=> (= (ControlFlow 0 39) 31) anon152_Else_correct)))))
(let ((anon151_Else_correct  (=> (and (not (or (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#20@0|)) (= |n#20@0| |t#0@0|))) (= (ControlFlow 0 30) 28)) anon77_correct)))
(let ((anon150_Else_correct  (=> (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#20@0|)) (and (=> (= (ControlFlow 0 41) 39) anon151_Then_correct) (=> (= (ControlFlow 0 41) 30) anon151_Else_correct)))))
(let ((anon150_Then_correct  (=> (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#20@0|))) (and (=> (= (ControlFlow 0 40) 39) anon151_Then_correct) (=> (= (ControlFlow 0 40) 30) anon151_Else_correct)))))
(let ((anon149_Then_correct  (=> (and ($Is refType |n#20@0| Tclass._module.Node) ($IsAlloc refType |n#20@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 42) 40) anon150_Then_correct) (=> (= (ControlFlow 0 42) 41) anon150_Else_correct)))))
(let ((anon149_Else_correct  (=> (and (not (and ($Is refType |n#20@0| Tclass._module.Node) ($IsAlloc refType |n#20@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 29) 28)) anon77_correct)))
(let ((anon65_correct  (=> (forall ((|n#19| T@U) ) (!  (=> ($Is refType |n#19| Tclass._module.Node) (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#19|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#19|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#19|)))) (or (not (= |n#19| |t#0@0|)) (not true))) (forall ((|ch#7| T@U) ) (!  (=> ($Is refType |ch#7| Tclass._module.Node?) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#19|) _module.Node.children)) ($Box refType |ch#7|)) (or (not (= |ch#7| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |ch#7|) _module.Node.marked)))))
 :qid |SchorrWaitedfy.244:24|
 :skolemid |831|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |ch#7|) _module.Node.marked)))
 :pattern ( (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#19|) _module.Node.children)) ($Box refType |ch#7|)))
))))
 :qid |SchorrWaitedfy.243:22|
 :skolemid |832|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#19|) _module.Node.children)))
 :pattern ( (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#19|)))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#19|) _module.Node.marked)))
 :pattern ( (|Set#IsMember| |S#0@@5| ($Box refType |n#19|)))
)) (and (=> (= (ControlFlow 0 43) 42) anon149_Then_correct) (=> (= (ControlFlow 0 43) 29) anon149_Else_correct)))))
(let ((anon148_Else_correct  (=> (and (not (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.children)) ($Box refType |ch#6@0|)) (or (not (= |ch#6@0| null)) (not true)))) (= (ControlFlow 0 48) 43)) anon65_correct)))
(let ((anon148_Then_correct  (=> (and (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.children)) ($Box refType |ch#6@0|)) (or (not (= |ch#6@0| null)) (not true))) (= (ControlFlow 0 47) 43)) anon65_correct)))
(let ((anon147_Else_correct  (=> (not (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.children)) ($Box refType |ch#6@0|))) (and (=> (= (ControlFlow 0 50) 47) anon148_Then_correct) (=> (= (ControlFlow 0 50) 48) anon148_Else_correct)))))
(let ((anon147_Then_correct  (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.children)) ($Box refType |ch#6@0|)) (and (=> (= (ControlFlow 0 49) 47) anon148_Then_correct) (=> (= (ControlFlow 0 49) 48) anon148_Else_correct)))))
(let ((anon146_Then_correct  (=> (and ($Is refType |ch#6@0| Tclass._module.Node?) ($IsAlloc refType |ch#6@0| Tclass._module.Node? $Heap@2)) (and (=> (= (ControlFlow 0 51) 49) anon147_Then_correct) (=> (= (ControlFlow 0 51) 50) anon147_Else_correct)))))
(let ((anon146_Else_correct  (=> (and (not (and ($Is refType |ch#6@0| Tclass._module.Node?) ($IsAlloc refType |ch#6@0| Tclass._module.Node? $Heap@2))) (= (ControlFlow 0 46) 43)) anon65_correct)))
(let ((anon145_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#18@0|)))) (or (not (= |n#18@0| |t#0@0|)) (not true))) (and (=> (= (ControlFlow 0 52) 51) anon146_Then_correct) (=> (= (ControlFlow 0 52) 46) anon146_Else_correct)))))
(let ((anon145_Else_correct  (=> (and (not (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#18@0|)))) (or (not (= |n#18@0| |t#0@0|)) (not true)))) (= (ControlFlow 0 45) 43)) anon65_correct)))
(let ((anon144_Else_correct  (=> (not (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#18@0|))))) (and (=> (= (ControlFlow 0 54) 52) anon145_Then_correct) (=> (= (ControlFlow 0 54) 45) anon145_Else_correct)))))
(let ((anon144_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#18@0|)))) (and (=> (= (ControlFlow 0 53) 52) anon145_Then_correct) (=> (= (ControlFlow 0 53) 45) anon145_Else_correct)))))
(let ((anon143_Else_correct  (=> (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked))))) (and (=> (= (ControlFlow 0 56) 53) anon144_Then_correct) (=> (= (ControlFlow 0 56) 54) anon144_Else_correct)))))
(let ((anon143_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#18@0|) _module.Node.marked)))) (and (=> (= (ControlFlow 0 55) 53) anon144_Then_correct) (=> (= (ControlFlow 0 55) 54) anon144_Else_correct)))))
(let ((anon142_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|))) (and (=> (= (ControlFlow 0 58) 55) anon143_Then_correct) (=> (= (ControlFlow 0 58) 56) anon143_Else_correct)))))
(let ((anon142_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (and (=> (= (ControlFlow 0 57) 55) anon143_Then_correct) (=> (= (ControlFlow 0 57) 56) anon143_Else_correct)))))
(let ((anon141_Then_correct  (=> (and ($Is refType |n#18@0| Tclass._module.Node) ($IsAlloc refType |n#18@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 59) 57) anon142_Then_correct) (=> (= (ControlFlow 0 59) 58) anon142_Else_correct)))))
(let ((anon141_Else_correct  (=> (and (not (and ($Is refType |n#18@0| Tclass._module.Node) ($IsAlloc refType |n#18@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 44) 43)) anon65_correct)))
(let ((anon51_correct  (=> (and (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1)))) _module.Node.childrenVisited))))) |t#0@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |root#0|) _module.Node.marked)))) (and (=> (= (ControlFlow 0 60) 59) anon141_Then_correct) (=> (= (ControlFlow 0 60) 44) anon141_Else_correct)))))
(let ((anon140_Else_correct  (=> (and (<= (|Seq#Length| |stackNodes#0@1|) 0) (= (ControlFlow 0 62) 60)) anon51_correct)))
(let ((anon140_Then_correct  (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (=> (and ($IsAlloc refType ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))) Tclass._module.Node $Heap@@3) (= (ControlFlow 0 61) 60)) anon51_correct))))
...
)) (and (=> (= (ControlFlow 0 63) 61) anon140_Then_correct) (=> (= (ControlFlow 0 63) 62) anon140_Else_correct)))))
(let ((anon139_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#2@0|) (< |k#2@0| (- (|Seq#Length| |stackNodes#0@1|) 1)))) (= (ControlFlow 0 65) 63)) anon49_correct)))
(let ((anon139_Then_correct  (=> (and (and (<= (LitInt 0) |k#2@0|) (< |k#2@0| (- (|Seq#Length| |stackNodes#0@1|) 1))) (and ($IsAlloc refType ($Unbox refType (|Seq#Index| |stackNodes#0@1| |k#2@0|)) Tclass._module.Node $Heap@@3) (= (ControlFlow 0 64) 63))) anon49_correct)))
(let ((anon138_Else_correct  (=> (< |k#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 67) 64) anon139_Then_correct) (=> (= (ControlFlow 0 67) 65) anon139_Else_correct)))))
(let ((anon138_Then_correct  (=> (<= (LitInt 0) |k#2@0|) (and (=> (= (ControlFlow 0 66) 64) anon139_Then_correct) (=> (= (ControlFlow 0 66) 65) anon139_Else_correct)))))
...
)) (and (=> (= (ControlFlow 0 68) 66) anon138_Then_correct) (=> (= (ControlFlow 0 68) 67) anon138_Else_correct)))))
(let ((anon136_Else_correct  (=> (and (not (and (< 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |stackNodes#0@1|)))) (= (ControlFlow 0 70) 68)) anon44_correct)))
(let ((anon136_Then_correct  (=> (and (and (< 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 69) 68)) anon44_correct)))
(let ((anon135_Else_correct  (=> (<= |k#0@0| 0) (and (=> (= (ControlFlow 0 72) 69) anon136_Then_correct) (=> (= (ControlFlow 0 72) 70) anon136_Else_correct)))))
(let ((anon135_Then_correct  (=> (< 0 |k#0@0|) (and (=> (= (ControlFlow 0 71) 69) anon136_Then_correct) (=> (= (ControlFlow 0 71) 70) anon136_Else_correct)))))
(let ((anon39_correct  (=> (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.childrenVisited))))) null)) (and (=> (= (ControlFlow 0 73) 71) anon135_Then_correct) (=> (= (ControlFlow 0 73) 72) anon135_Else_correct)))))
(let ((anon133_Else_correct  (=> (and (<= (|Seq#Length| |stackNodes#0@1|) 0) (= (ControlFlow 0 75) 73)) anon39_correct)))
(let ((anon133_Then_correct  (=> (and (and (< 0 (|Seq#Length| |stackNodes#0@1|)) (|Seq#Contains| |stackNodes#0@1| (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.children)))) (= (ControlFlow 0 74) 73))) anon39_correct)))
...
)) (and (=> (= (ControlFlow 0 76) 74) anon133_Then_correct) (=> (= (ControlFlow 0 76) 75) anon133_Else_correct)))))
(let ((anon132_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#16@0|))))) (= (ControlFlow 0 79) 76)) anon37_correct)))
(let ((anon132_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#16@0|)))) (and ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@@3) (= (ControlFlow 0 78) 76))) anon37_correct)))
(let ((anon131_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|))) (and (=> (= (ControlFlow 0 81) 78) anon132_Then_correct) (=> (= (ControlFlow 0 81) 79) anon132_Else_correct)))))
(let ((anon131_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (and (=> (= (ControlFlow 0 80) 78) anon132_Then_correct) (=> (= (ControlFlow 0 80) 79) anon132_Else_correct)))))
(let ((anon130_Then_correct  (=> (and ($Is refType |n#16@0| Tclass._module.Node) ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 82) 80) anon131_Then_correct) (=> (= (ControlFlow 0 82) 81) anon131_Else_correct)))))
(let ((anon130_Else_correct  (=> (and (not (and ($Is refType |n#16@0| Tclass._module.Node) ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 77) 76)) anon37_correct)))
...
)) (and (=> (= (ControlFlow 0 83) 82) anon130_Then_correct) (=> (= (ControlFlow 0 83) 77) anon130_Else_correct)))))
(let ((anon129_Else_correct  (=> (and (= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.childrenVisited)))) (= (ControlFlow 0 89) 83)) anon32_correct)))
(let ((anon129_Then_correct  (=> (or (not (= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.childrenVisited))))) (not true)) (=> (and ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@@3) (= (ControlFlow 0 88) 83)) anon32_correct))))
(let ((anon128_Then_correct  (=> (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))))) (and (=> (= (ControlFlow 0 90) 88) anon129_Then_correct) (=> (= (ControlFlow 0 90) 89) anon129_Else_correct)))))
(let ((anon128_Else_correct  (=> (and (not (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children)))))) (= (ControlFlow 0 87) 83)) anon32_correct)))
(let ((anon127_Else_correct  (=> (< |j#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 92) 90) anon128_Then_correct) (=> (= (ControlFlow 0 92) 87) anon128_Else_correct)))))
(let ((anon127_Then_correct  (=> (<= (LitInt 0) |j#0@0|) (and (=> (= (ControlFlow 0 91) 90) anon128_Then_correct) (=> (= (ControlFlow 0 91) 87) anon128_Else_correct)))))
(let ((anon125_Then_correct  (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#14@0|) _module.Node.children)))) (and (=> (= (ControlFlow 0 93) 91) anon127_Then_correct) (=> (= (ControlFlow 0 93) 92) anon127_Else_correct)))))
(let ((anon125_Else_correct  (=> (and (or (not (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#14@0|) _module.Node.children))))) (not true)) (= (ControlFlow 0 86) 83)) anon32_correct)))
(let ((anon124_Then_correct  (=> (and (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#14@0|)) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@@3)) (and (=> (= (ControlFlow 0 94) 93) anon125_Then_correct) (=> (= (ControlFlow 0 94) 86) anon125_Else_correct)))))
(let ((anon124_Else_correct  (=> (and (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#14@0|))) (= (ControlFlow 0 85) 83)) anon32_correct)))
(let ((anon123_Then_correct  (=> (and ($Is refType |n#14@0| Tclass._module.Node) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 95) 94) anon124_Then_correct) (=> (= (ControlFlow 0 95) 85) anon124_Else_correct)))))
(let ((anon123_Else_correct  (=> (and (not (and ($Is refType |n#14@0| Tclass._module.Node) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 84) 83)) anon32_correct)))
...
)) (and (=> (= (ControlFlow 0 96) 95) anon123_Then_correct) (=> (= (ControlFlow 0 96) 84) anon123_Else_correct)))))
(let ((anon122_Else_correct  (=> (and (not (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (or (not (= |n#12@0| |t#0@0|)) (not true)))) (= (ControlFlow 0 99) 96)) anon22_correct)))
(let ((anon122_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (or (not (= |n#12@0| |t#0@0|)) (not true))) (= (ControlFlow 0 98) 96)) anon22_correct)))
(let ((anon121_Else_correct  (=> (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|))))) (and (=> (= (ControlFlow 0 101) 98) anon122_Then_correct) (=> (= (ControlFlow 0 101) 99) anon122_Else_correct)))))
(let ((anon121_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (and (=> (= (ControlFlow 0 100) 98) anon122_Then_correct) (=> (= (ControlFlow 0 100) 99) anon122_Else_correct)))))
(let ((anon120_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|))) (and (=> (= (ControlFlow 0 103) 100) anon121_Then_correct) (=> (= (ControlFlow 0 103) 101) anon121_Else_correct)))))
(let ((anon120_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (and (=> (= (ControlFlow 0 102) 100) anon121_Then_correct) (=> (= (ControlFlow 0 102) 101) anon121_Else_correct)))))
(let ((anon119_Then_correct  (=> (and ($Is refType |n#12@0| Tclass._module.Node) ($IsAlloc refType |n#12@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 104) 102) anon120_Then_correct) (=> (= (ControlFlow 0 104) 103) anon120_Else_correct)))))
(let ((anon119_Else_correct  (=> (and (not (and ($Is refType |n#12@0| Tclass._module.Node) ($IsAlloc refType |n#12@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 97) 96)) anon22_correct)))
...
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))))) (and (=> (= (ControlFlow 0 105) 104) anon119_Then_correct) (=> (= (ControlFlow 0 105) 97) anon119_Else_correct)))))
(let ((anon118_Else_correct  (=> (and (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#10@0|))) (= (ControlFlow 0 108) 105)) anon15_correct)))
(let ((anon118_Then_correct  (=> (and (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#10@0|)) (= (ControlFlow 0 107) 105)) anon15_correct)))
(let ((anon117_Then_correct  (=> (and ($Is refType |n#10@0| Tclass._module.Node) ($IsAlloc refType |n#10@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 109) 107) anon118_Then_correct) (=> (= (ControlFlow 0 109) 108) anon118_Else_correct)))))
(let ((anon117_Else_correct  (=> (and (not (and ($Is refType |n#10@0| Tclass._module.Node) ($IsAlloc refType |n#10@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 106) 105)) anon15_correct)))
(let ((anon12_correct  (=> (= |p#0@0| (ite (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))))) (and (=> (= (ControlFlow 0 110) 109) anon117_Then_correct) (=> (= (ControlFlow 0 110) 106) anon117_Else_correct)))))
(let ((anon116_Else_correct  (=> (and (or (not (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0))) (not true)) (= (ControlFlow 0 112) 110)) anon12_correct)))
(let ((anon116_Then_correct  (=> (and (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) (= (ControlFlow 0 111) 110)) anon12_correct)))
(let ((anon9_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |t#0@0|)))) (and (=> (= (ControlFlow 0 113) 111) anon116_Then_correct) (=> (= (ControlFlow 0 113) 112) anon116_Else_correct)))))
(let ((anon115_Else_correct  (=> (and (not (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|))) (= (ControlFlow 0 115) 113)) anon9_correct)))
(let ((anon115_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|)) (= (ControlFlow 0 114) 113)) anon9_correct)))
...
)) (and (=> (= (ControlFlow 0 116) 114) anon115_Then_correct) (=> (= (ControlFlow 0 116) 115) anon115_Else_correct)))))
(let ((anon114_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|)))) (= (ControlFlow 0 118) 116)) anon7_correct)))
(let ((anon114_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 117) 116)) anon7_correct)))
(let ((anon113_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 120) 117) anon114_Then_correct) (=> (= (ControlFlow 0 120) 118) anon114_Else_correct)))))
(let ((anon113_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 119) 117) anon114_Then_correct) (=> (= (ControlFlow 0 119) 118) anon114_Else_correct)))))
...
)))))) (and (and (and (=> |$w$loop#0@0| (forall ((|n#27@@1| T@U) ) (!  (=> ($Is refType |n#27@@1| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#27@@1|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#27@@1|) _module.Node.marked)))) (_module.__default.Reachable $Heap@@3 |root#0| |n#27@@1| |S#0@@5|)))
 :qid |SchorrWaitedfy.252:22|
 :skolemid |854|
 :pattern ( (_module.__default.Reachable $Heap@@3 |root#0| |n#27@@1| |S#0@@5|))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#27@@1|) _module.Node.marked)))
 :pattern ( (|Set#IsMember| |S#0@@5| ($Box refType |n#27@@1|)))
))) (=> |$w$loop#0@0| (forall ((|n#29@@0| T@U) ) (!  (=> ($Is refType |n#29@@0| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#29@@0|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#29@@0|) _module.Node.marked))))) (|Set#IsMember| |unmarkedNodes#0@0| ($Box refType |n#29@@0|))))
 :qid |SchorrWaitedfy.254:22|
 :skolemid |857|
 :pattern ( (|Set#IsMember| |unmarkedNodes#0@0| ($Box refType |n#29@@0|)))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#29@@0|) _module.Node.marked)))
...
)))) (and (=> |$w$loop#0@0| (forall ((|n#27@@2| T@U) ) (!  (=> ($Is refType |n#27@@2| Tclass._module.Node) (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#27@@2|)) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#27@@2|) _module.Node.marked))) (|_module.__default.Reachable#canCall| $Heap@@3 |root#0| |n#27@@2| |S#0@@5|))))
 :qid |SchorrWaitedfy.252:22|
 :skolemid |852|
...
))) (=> |$w$loop#0@0| (forall ((|n#27@@3| T@U) ) (!  (=> ($Is refType |n#27@@3| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#27@@3|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#27@@3|) _module.Node.marked)))) (_module.__default.Reachable $Heap@@3 |root#0| |n#27@@3| |S#0@@5|)))
 :qid |SchorrWaitedfy.252:22|
 :skolemid |854|
 :pattern ( (_module.__default.Reachable $Heap@@3 |root#0| |n#27@@3| |S#0@@5|))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#27@@3|) _module.Node.marked)))
 :pattern ( (|Set#IsMember| |S#0@@5| ($Box refType |n#27@@3|)))
)))))) (and (and (and (=> |$w$loop#0@0| (forall ((|n#29@@1| T@U) ) (!  (=> ($Is refType |n#29@@1| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#29@@1|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#29@@1|) _module.Node.marked))))) (|Set#IsMember| |unmarkedNodes#0@1| ($Box refType |n#29@@1|))))
 :qid |SchorrWaitedfy.254:22|
 :skolemid |857|
 :pattern ( (|Set#IsMember| |unmarkedNodes#0@1| ($Box refType |n#29@@1|)))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#29@@1|) _module.Node.marked)))
...
)))) (and (and (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (=> (|Set#Equal| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (and (<= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (=> (= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) |$decr_init$loop#02@0|))))) (not |$w$loop#0@0|))))))) (and (=> (= (ControlFlow 0 121) 119) anon113_Then_correct) (=> (= (ControlFlow 0 121) 120) anon113_Else_correct)))))))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
