...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma_split12)
...
)))) (and (and (or (not (= |list#0@@12| |#_module.List.Nil|)) (not true)) (= |list#0@@12| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|))) (and ($Is DatatypeTypeType |_mcc#0#0_0@0| (Tclass._module.Node _module._default.Lemma$X)) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module._default.Lemma$X))))) (and (and (and ($Is DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module._default.Lemma$X)) (= |rest#0_0@0| |let#0_0#0#0|)))) (and (and (and (and ($Is DatatypeTypeType |n#0_0@0| (Tclass._module.Node _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |n#0_0@0| (Tclass._module.Node _module._default.Lemma$X) $Heap@0)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($Is DatatypeTypeType |let#0_1#0#0| (Tclass._module.Node _module._default.Lemma$X)) (= |n#0_0@0| |let#0_1#0#0|))) (and (and (and (= |n#0_0@0| (|#_module.Node.Element| |_mcc#2#0_1_0@0|)) ($IsBox |_mcc#2#0_1_0@0| _module._default.Lemma$X)) (and ($IsBox |x#0_1_0@0| _module._default.Lemma$X) ($IsAllocBox |x#0_1_0@0| _module._default.Lemma$X $Heap@0))) (and (and (= |let#0_1_0#0#0| |_mcc#2#0_1_0@0|) ($IsBox |let#0_1_0#0#0| _module._default.Lemma$X)) (and (= |x#0_1_0@0| |let#0_1_0#0#0|) (= (ControlFlow 0 2) (- 0 1))))))) (or (< (DtRank |rest#0_0@0|) (DtRank |list#0@@12|)) (and (= (DtRank |rest#0_0@0|) (DtRank |list#0@@12|)) (< (DtRank |ext#0@@4|) (DtRank |ext#0@@4|))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
