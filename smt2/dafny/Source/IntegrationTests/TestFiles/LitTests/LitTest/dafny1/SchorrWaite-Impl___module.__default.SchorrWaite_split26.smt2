...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split26)
...
)))))) (and (and (and (=> |$w$loop#0@0| ($IsAllocBox ($Box DatatypeTypeType |path#0@0|) Tclass._module.Path $Heap@@2)) (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (_module.Path.Empty_q |path#0@0|) (= |root#0| |root#0|)))))) (and (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22| (_module.Path._h1 |path#0@0|)))
(|Set#IsMember| |S#0@@3| ($Box refType |n#22|))))))) (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22@@0| (_module.Path._h1 |path#0@0|)))
(|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#22@@0|) _module.Node.children)) ($Box refType |root#0|))))))))) (and (and (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22@@1| (_module.Path._h1 |path#0@0|)))
(let ((|prefix#0@@0| (_module.Path._h0 |path#0@0|)))
(_module.__default.ReachableVia ($LS ($LS $LZ)) $Heap@@2 |root#0| |prefix#0@@0| |n#22@@1| |S#0@@3|))))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))))) (forall ((|n#25| T@U) ) (!  (=> ($Is refType |n#25| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@3| ($Box refType |n#25|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#25|) _module.Node.marked)))) (let ((|pth#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#25|) _module.Node.pathFromRoot))))
 (and ($IsAllocBox ($Box DatatypeTypeType |pth#0|) Tclass._module.Path $Heap@@2) (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |pth#0| |n#25| |S#0@@3|)))))
 :qid |SchorrWaitedfy.250:22|
 :skolemid |849|
 :pattern ( (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#25|) _module.Node.pathFromRoot)) |n#25| |S#0@@3|))
 ...
 :pattern ( (|Set#IsMember| |S#0@@3| ($Box refType |n#25|)))
)))))))))
anon0_correct))
))
(check-sat)
