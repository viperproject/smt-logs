...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split27)
...
)) (forall ((|n#3| T@U) ) (!  (=> ($Is refType |n#3| Tclass._module.Node) (and (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#3|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#3|) _module.Node.marked))))) (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#3|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#3|) _module.Node.childrenVisited))) (LitInt 0)))))
...
))))) (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc |S#0@@5|)) (= |path#0@0| (Lit DatatypeTypeType |#_module.Path.Empty|))) (and (or (not (= |root#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.marked)))) (and (and (= |$rhs#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@3 |root#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |root#0|) _module.Node.marked ($Box boolType (bool_2_U |$rhs#0@0|)))))) (and ($IsGoodHeap $Heap@0) (or (not (= |root#0| null)) (not true))))))) (and (and (and (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.pathFromRoot)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |root#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.pathFromRoot ($Box DatatypeTypeType |path#0@0|))))) (and ($IsGoodHeap $Heap@1) (= |stackNodes#0@0| (Lit SeqType |Seq#Empty|)))) (and (and (= |unmarkedNodes#0@0| (|Set#Difference| |S#0@@5| (|Set#UnionOne| |Set#Empty| ($Box refType |root#0|)))) (= |$decr_init$loop#02@0| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |root#0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |root#0|) _module.Node.childrenVisited)))))) (and (=> |$w$loop#0@0| (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |stackNodes#0@0|))) (|Set#IsMember| |S#0@@5| (|Seq#Index| |stackNodes#0@0| |i#1|)))
 :qid |SchorrWaitedfy.197:22|
 :skolemid |809|
 :pattern ( ($Unbox refType (|Seq#Index| |stackNodes#0@0| |i#1|)))
))) (=> |$w$loop#0@0| (|Set#IsMember| |S#0@@5| ($Box refType |root#0|)))))) (and (and (and (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@0| ($Box refType |root#0|)))) (=> |$w$loop#0@0| (= null (ite (= (|Seq#Length| |stackNodes#0@0|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@0| (- (|Seq#Length| |stackNodes#0@0|) 1))))))) (and (=> |$w$loop#0@0| (forall ((|n#11| T@U) ) (!  (=> ($Is refType |n#11| Tclass._module.Node) (=> (|Seq#Contains| |stackNodes#0@0| ($Box refType |n#11|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#11|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#11|) _module.Node.children))))))
...
))) (=> |$w$loop#0@0| ($IsAllocBox ($Box DatatypeTypeType |path#0@0|) Tclass._module.Path $Heap@@3))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@0| |root#0| |S#0@@5|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |root#0| |path#0@0| |root#0| |S#0@@5|) (=> (_module.Path.Empty_q |path#0@0|) (= |root#0| |root#0|))))) (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@0| |root#0| |S#0@@5|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |root#0| |path#0@0| |root#0| |S#0@@5|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22| (_module.Path._h1 |path#0@0|)))
(|Set#IsMember| |S#0@@5| ($Box refType |n#22|)))))))) (and (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@0| |root#0| |S#0@@5|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |root#0| |path#0@0| |root#0| |S#0@@5|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22@@0| (_module.Path._h1 |path#0@0|)))
(|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#22@@0|) _module.Node.children)) ($Box refType |root#0|))))))) (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@0| |root#0| |S#0@@5|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |root#0| |path#0@0| |root#0| |S#0@@5|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22@@1| (_module.Path._h1 |path#0@0|)))
(let ((|prefix#0@@0| (_module.Path._h0 |path#0@0|)))
(_module.__default.ReachableVia ($LS ($LS $LZ)) $Heap@@3 |root#0| |prefix#0@@0| |n#22@@1| |S#0@@5|))))))))) (and (and (=> |$w$loop#0@0| (forall ((|n#25| T@U) ) (!  (=> ($Is refType |n#25| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#25|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#25|) _module.Node.marked)))) (let ((|pth#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#25|) _module.Node.pathFromRoot))))
...
))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))))) (forall ((|n#27| T@U) ) (!  (=> ($Is refType |n#27| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#27|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#27|) _module.Node.marked)))) (_module.__default.Reachable $Heap@@3 |root#0| |n#27| |S#0@@5|)))
