...
(assert (forall ((_module.ExtensibleArray$T@@21 T@U) (bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@21)) (and (= ($Box refType ($Unbox refType bx@@10)) bx@@10) ($Is refType ($Unbox refType bx@@10) (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@21))))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( ($IsBox bx@@10 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@21)))
)))
(assert (forall ((_module.ExtensibleArray$T@@22 T@U) (bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@22)) (and (= ($Box refType ($Unbox refType bx@@11)) bx@@11) ($Is refType ($Unbox refType bx@@11) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@22))))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($IsBox bx@@11 (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@22)))
)))
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24) $Heap@@1))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24)) ($IsAlloc refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24) $Heap@@1)))) (and (and ($IsBox |t#0| _module.ExtensibleArray$T@@24) ($IsAllocBox |t#0| _module.ExtensibleArray$T@@24 $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
