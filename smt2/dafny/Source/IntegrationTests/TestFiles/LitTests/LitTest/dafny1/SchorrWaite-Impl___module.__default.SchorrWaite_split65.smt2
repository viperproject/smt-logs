...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split65)
...
)) (=> (and (< 0 (|Seq#Length| |stackNodes#0@1|)) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Contains| |stackNodes#0@1| (|Seq#Index| |stackNodes#0@1| (LitInt 0)))))))
