...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split57)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon128_Then_correct  (=> (and (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))))) (and (or (not (= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.childrenVisited))))) (not true)) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@@3))))
(let ((anon127_Else_correct  (=> (and (< |j#0@0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon128_Then_correct)))
(let ((anon127_Then_correct  (=> (and (<= (LitInt 0) |j#0@0|) (= (ControlFlow 0 3) 2)) anon128_Then_correct)))
...
)) (=> (and (and (and ($Is refType |n#14@0| Tclass._module.Node) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@2)) (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#14@0|))) (and ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@@3) (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#14@0|) _module.Node.children)))))) (and (=> (= (ControlFlow 0 5) 3) anon127_Then_correct) (=> (= (ControlFlow 0 5) 4) anon127_Else_correct))))))
(let ((anon122_Else_correct  (=> (and (not (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (or (not (= |n#12@0| |t#0@0|)) (not true)))) (= (ControlFlow 0 8) 5)) anon22_correct)))
(let ((anon122_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (or (not (= |n#12@0| |t#0@0|)) (not true))) (= (ControlFlow 0 7) 5)) anon22_correct)))
(let ((anon121_Else_correct  (=> (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|))))) (and (=> (= (ControlFlow 0 10) 7) anon122_Then_correct) (=> (= (ControlFlow 0 10) 8) anon122_Else_correct)))))
(let ((anon121_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (and (=> (= (ControlFlow 0 9) 7) anon122_Then_correct) (=> (= (ControlFlow 0 9) 8) anon122_Else_correct)))))
(let ((anon120_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|))) (and (=> (= (ControlFlow 0 12) 9) anon121_Then_correct) (=> (= (ControlFlow 0 12) 10) anon121_Else_correct)))))
(let ((anon120_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (and (=> (= (ControlFlow 0 11) 9) anon121_Then_correct) (=> (= (ControlFlow 0 11) 10) anon121_Else_correct)))))
(let ((anon119_Then_correct  (=> (and ($Is refType |n#12@0| Tclass._module.Node) ($IsAlloc refType |n#12@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 13) 11) anon120_Then_correct) (=> (= (ControlFlow 0 13) 12) anon120_Else_correct)))))
(let ((anon119_Else_correct  (=> (and (not (and ($Is refType |n#12@0| Tclass._module.Node) ($IsAlloc refType |n#12@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 6) 5)) anon22_correct)))
...
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))))) (and (=> (= (ControlFlow 0 14) 13) anon119_Then_correct) (=> (= (ControlFlow 0 14) 6) anon119_Else_correct)))))
(let ((anon118_Else_correct  (=> (and (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#10@0|))) (= (ControlFlow 0 17) 14)) anon15_correct)))
(let ((anon118_Then_correct  (=> (and (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#10@0|)) (= (ControlFlow 0 16) 14)) anon15_correct)))
(let ((anon117_Then_correct  (=> (and ($Is refType |n#10@0| Tclass._module.Node) ($IsAlloc refType |n#10@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 18) 16) anon118_Then_correct) (=> (= (ControlFlow 0 18) 17) anon118_Else_correct)))))
(let ((anon117_Else_correct  (=> (and (not (and ($Is refType |n#10@0| Tclass._module.Node) ($IsAlloc refType |n#10@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 15) 14)) anon15_correct)))
(let ((anon12_correct  (=> (= |p#0@0| (ite (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))))) (and (=> (= (ControlFlow 0 19) 18) anon117_Then_correct) (=> (= (ControlFlow 0 19) 15) anon117_Else_correct)))))
(let ((anon116_Else_correct  (=> (and (or (not (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0))) (not true)) (= (ControlFlow 0 21) 19)) anon12_correct)))
(let ((anon116_Then_correct  (=> (and (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) (= (ControlFlow 0 20) 19)) anon12_correct)))
(let ((anon9_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |t#0@0|)))) (and (=> (= (ControlFlow 0 22) 20) anon116_Then_correct) (=> (= (ControlFlow 0 22) 21) anon116_Else_correct)))))
(let ((anon115_Else_correct  (=> (and (not (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|))) (= (ControlFlow 0 24) 22)) anon9_correct)))
(let ((anon115_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|)) (= (ControlFlow 0 23) 22)) anon9_correct)))
...
)) (and (=> (= (ControlFlow 0 25) 23) anon115_Then_correct) (=> (= (ControlFlow 0 25) 24) anon115_Else_correct)))))
(let ((anon114_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|)))) (= (ControlFlow 0 27) 25)) anon7_correct)))
(let ((anon114_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 26) 25)) anon7_correct)))
(let ((anon113_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 29) 26) anon114_Then_correct) (=> (= (ControlFlow 0 29) 27) anon114_Else_correct)))))
(let ((anon113_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 28) 26) anon114_Then_correct) (=> (= (ControlFlow 0 28) 27) anon114_Else_correct)))))
...
)))) (and (and (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (=> (|Set#Equal| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (and (<= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (=> (= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) |$decr_init$loop#02@0|))))) (not |$w$loop#0@0|))))))) (and (=> (= (ControlFlow 0 30) 28) anon113_Then_correct) (=> (= (ControlFlow 0 30) 29) anon113_Else_correct)))))))
anon0_correct))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
