...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@4 T@U) (|x#0@@2| T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.count#canCall| |x#0@@2| |xs#0@@4|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@4| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.count $ly@@4 |x#0@@2| |xs#0@@4|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |686|
 :pattern ( (_module.__default.count $ly@@4 |x#0@@2| |xs#0@@4|))
))))
(assert (forall (($ly@@5 T@U) (|xs#0@@5| T@U) (|ys#0@@3| T@U) ) (! (= (_module.__default.concat ($LS $ly@@5) |xs#0@@5| |ys#0@@3|) (_module.__default.concat $ly@@5 |xs#0@@5| |ys#0@@3|))
 :qid |Ripplinglegacydfy.99:16|
 :skolemid |640|
 :pattern ( (_module.__default.concat ($LS $ly@@5) |xs#0@@5| |ys#0@@3|))
)))
(assert (forall (($ly@@6 T@U) (|x#0@@3| T@U) (|xs#0@@6| T@U) ) (! (= (_module.__default.count ($LS $ly@@6) |x#0@@3| |xs#0@@6|) (_module.__default.count $ly@@6 |x#0@@3| |xs#0@@6|))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |684|
 :pattern ( (_module.__default.count ($LS $ly@@6) |x#0@@3| |xs#0@@6|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.P38)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|n#1| T@U) (|xs#1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |n#1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#1| Tclass._module.List)) (|_module.Nat#Equal| (_module.__default.count ($LS ($LS $LZ)) |n#1| (_module.__default.concat ($LS ($LS $LZ)) |xs#1| (|#_module.List.Cons| |n#1| (Lit DatatypeTypeType |#_module.List.Nil|)))) (|#_module.Nat.Suc| (_module.__default.count ($LS ($LS $LZ)) |n#1| |xs#1|))))
 :qid |Ripplinglegacydfy.492:18|
 :skolemid |1080|
 :pattern ( (|#_module.Nat.Suc| (_module.__default.count ($LS ($LS $LZ)) |n#1| |xs#1|)))
 :pattern ( (_module.__default.concat ($LS ($LS $LZ)) |xs#1| (|#_module.List.Cons| |n#1| |#_module.List.Nil|)))
)))))
