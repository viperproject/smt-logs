...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) (|x#0@@2| T@U) (|y#0@@0| T@U) ) (!  (=> (or (|_module.__default.leq#canCall| |x#0@@2| |y#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@0| Tclass._module.Nat)))) ($Is DatatypeTypeType (_module.__default.leq $ly@@3 |x#0@@2| |y#0@@0|) Tclass._module.Bool))
 :qid |Ripplinglegacydfy.61:16|
 :skolemid |614|
 :pattern ( (_module.__default.leq $ly@@3 |x#0@@2| |y#0@@0|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@4 T@U) (|xs#0@@3| T@U) (|ys#0@@2| T@U) ) (!  (=> (or (|_module.__default.concat#canCall| |xs#0@@3| |ys#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List) ($Is DatatypeTypeType |ys#0@@2| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.concat $ly@@4 |xs#0@@3| |ys#0@@2|) Tclass._module.List))
 :qid |Ripplinglegacydfy.99:16|
 :skolemid |643|
 :pattern ( (_module.__default.concat $ly@@4 |xs#0@@3| |ys#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|x#0@@3| T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.count#canCall| |x#0@@3| |xs#0@@4|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@4| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.count $ly@@5 |x#0@@3| |xs#0@@4|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |686|
 :pattern ( (_module.__default.count $ly@@5 |x#0@@3| |xs#0@@4|))
))))
(assert (forall (($ly@@6 T@U) (|x#0@@4| T@U) (|y#0@@1| T@U) ) (! (= (_module.__default.leq ($LS $ly@@6) |x#0@@4| |y#0@@1|) (_module.__default.leq $ly@@6 |x#0@@4| |y#0@@1|))
 :qid |Ripplinglegacydfy.61:16|
 :skolemid |612|
 :pattern ( (_module.__default.leq ($LS $ly@@6) |x#0@@4| |y#0@@1|))
)))
(assert (forall (($ly@@7 T@U) (|xs#0@@5| T@U) (|ys#0@@3| T@U) ) (! (= (_module.__default.concat ($LS $ly@@7) |xs#0@@5| |ys#0@@3|) (_module.__default.concat $ly@@7 |xs#0@@5| |ys#0@@3|))
 :qid |Ripplinglegacydfy.99:16|
 :skolemid |640|
 :pattern ( (_module.__default.concat ($LS $ly@@7) |xs#0@@5| |ys#0@@3|))
)))
(assert (forall (($ly@@8 T@U) (|x#0@@5| T@U) (|xs#0@@6| T@U) ) (! (= (_module.__default.count ($LS $ly@@8) |x#0@@5| |xs#0@@6|) (_module.__default.count $ly@@8 |x#0@@5| |xs#0@@6|))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |684|
 :pattern ( (_module.__default.count ($LS $ly@@8) |x#0@@5| |xs#0@@6|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@9 T@U) (|x#0@@6| T@U) (|y#0@@2| T@U) ) (!  (=> (or (|_module.__default.leq#canCall| (Lit DatatypeTypeType |x#0@@6|) (Lit DatatypeTypeType |y#0@@2|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@6| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@2| Tclass._module.Nat)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType |x#0@@6|)))))) (let ((|a#3| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |x#0@@6|)))))
...
(|_module.__default.leq#canCall| |a#3| |b#3|))))) (= (_module.__default.leq ($LS $ly@@9) (Lit DatatypeTypeType |x#0@@6|) (Lit DatatypeTypeType |y#0@@2|)) (ite (_module.Nat.Zero_q (Lit DatatypeTypeType |x#0@@6|)) |#_module.Bool.True| (let ((|a#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |x#0@@6|)))))
(ite (_module.Nat.Zero_q (Lit DatatypeTypeType |y#0@@2|)) |#_module.Bool.False| (let ((|b#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |y#0@@2|)))))
(Lit DatatypeTypeType (_module.__default.leq ($LS $ly@@9) |a#2| |b#2|)))))))))
 :qid |Ripplinglegacydfy.61:16|
 :weight 3
 :skolemid |617|
 :pattern ( (_module.__default.leq ($LS $ly@@9) (Lit DatatypeTypeType |x#0@@6|) (Lit DatatypeTypeType |y#0@@2|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@10 T@U) (|x#0@@7| T@U) (|y#0@@3| T@U) ) (!  (=> (or (|_module.__default.leq#canCall| |x#0@@7| |y#0@@3|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@7| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@3| Tclass._module.Nat)))) (and (=> (not (_module.Nat.Zero_q |x#0@@7|)) (let ((|a#1| (_module.Nat._h0 |x#0@@7|)))
 (=> (not (_module.Nat.Zero_q |y#0@@3|)) (let ((|b#1| (_module.Nat._h0 |y#0@@3|)))
(|_module.__default.leq#canCall| |a#1| |b#1|))))) (= (_module.__default.leq ($LS $ly@@10) |x#0@@7| |y#0@@3|) (ite (_module.Nat.Zero_q |x#0@@7|) |#_module.Bool.True| (let ((|a#0| (_module.Nat._h0 |x#0@@7|)))
(ite (_module.Nat.Zero_q |y#0@@3|) |#_module.Bool.False| (let ((|b#0| (_module.Nat._h0 |y#0@@3|)))
(_module.__default.leq $ly@@10 |a#0| |b#0|))))))))
 :qid |Ripplinglegacydfy.61:16|
 :skolemid |616|
 :pattern ( (_module.__default.leq ($LS $ly@@10) |x#0@@7| |y#0@@3|))
))))
