...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split28)
...
))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))))) (forall ((|n#29| T@U) ) (!  (=> ($Is refType |n#29| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#29|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#29|) _module.Node.marked))))) (|Set#IsMember| |unmarkedNodes#0@0| ($Box refType |n#29|))))
