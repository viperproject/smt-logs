...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SchorrWaite_split8)
...
)) (=> (and ($Is refType |n#6@0| Tclass._module.Node) ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap@0)) (=> (and (and (|Set#IsMember| |S#0| ($Box refType |n#6@0|)) (or (not (= |n#6@0| null)) (not true))) (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#6@0|) _module.Node.marked))) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType |root#0| Tclass._module.Node $Heap))))))
