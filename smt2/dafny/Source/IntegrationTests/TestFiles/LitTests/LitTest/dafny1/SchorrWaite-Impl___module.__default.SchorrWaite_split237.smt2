...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split237)
...
)))))) (and (and (and (=> |$w$loop#0@0| (=> (< 0 (|Seq#Length| |stackNodes#0@4|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (|Seq#Index| |stackNodes#0@4| (- (|Seq#Length| |stackNodes#0@4|) 1)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (|Seq#Index| |stackNodes#0@4| (- (|Seq#Length| |stackNodes#0@4|) 1)))) _module.Node.childrenVisited))))) |t#0@1|))) (=> |$w$loop#0@0| (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |root#0|) _module.Node.marked))))) (and (=> |$w$loop#0@0| (forall ((|n#19@@2| T@U) ) (!  (=> ($Is refType |n#19@@2| Tclass._module.Node) (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#19@@2|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19@@2|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@4| ($Box refType |n#19@@2|)))) (or (not (= |n#19@@2| |t#0@1|)) (not true))) (forall ((|ch#7@@2| T@U) ) (!  (=> ($Is refType |ch#7@@2| Tclass._module.Node?) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19@@2|) _module.Node.children)) ($Box refType |ch#7@@2|)) (or (not (= |ch#7@@2| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |ch#7@@2|) _module.Node.marked)))))
 :qid |SchorrWaitedfy.244:24|
 :skolemid |835|
...
))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))))))) ($IsAllocBox ($Box DatatypeTypeType |path#0@4|) Tclass._module.Path $Heap@@3))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
