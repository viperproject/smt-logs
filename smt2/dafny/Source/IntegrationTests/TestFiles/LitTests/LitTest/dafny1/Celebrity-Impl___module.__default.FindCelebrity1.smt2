...
(set-info :boogie-vc-id Impl$$_module.__default.FindCelebrity1)
...
(let ((anon9_correct  (and (=> (= (ControlFlow 0 18) (- 0 22)) (exists ((|$as#y0_0#0_0| T@U) ) (!  (and ($IsBox |$as#y0_0#0_0| _module._default.FindCelebrity1$W) (|Set#IsMember| (|Set#Difference| |Q#0@0| (|Set#UnionOne| |Set#Empty| |x#0@1|)) |$as#y0_0#0_0|))
 :qid |Celebritydfy.35:9|
 :skolemid |563|
))) (=> (exists ((|$as#y0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#y0_0#0_0@@0| _module._default.FindCelebrity1$W) (|Set#IsMember| (|Set#Difference| |Q#0@0| (|Set#UnionOne| |Set#Empty| |x#0@1|)) |$as#y0_0#0_0@@0|))
 :qid |Celebritydfy.35:9|
 :skolemid |563|
)) (=> (and (=> true (and ($IsBox |y#0_0@1| _module._default.FindCelebrity1$W) ($IsAllocBox |y#0_0@1| _module._default.FindCelebrity1$W $Heap))) (|Set#IsMember| (|Set#Difference| |Q#0@0| (|Set#UnionOne| |Set#Empty| |x#0@1|)) |y#0_0@1|)) (and (=> (= (ControlFlow 0 18) (- 0 21)) |defass#x#0@0|) (=> |defass#x#0@0| (=> ($IsAllocBox |x#0@1| _module._default.FindCelebrity1$W $Heap) (and (=> (= (ControlFlow 0 18) (- 0 20)) true) (=> ($IsAllocBox |y#0_0@1| _module._default.FindCelebrity1$W $Heap) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |x#0@1| |y#0_0@1|)) (not true))) (=> (or (not (= |x#0@1| |y#0_0@1|)) (not true)) (=> (and (|_module.__default.Knows#canCall| _module._default.FindCelebrity1$W |x#0@1| |y#0_0@1|) (|_module.__default.Knows#canCall| _module._default.FindCelebrity1$W |x#0@1| |y#0_0@1|)) (and (=> (= (ControlFlow 0 18) 12) anon21_Then_correct) (=> (= (ControlFlow 0 18) 14) anon21_Else_correct)))))))))))))))
