...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.RecursiveMark)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon21_correct true))
(let ((anon28_Else_correct  (=> (and (=> (|Set#IsMember| |S#0| ($Box refType |n#6@0|)) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#6@0|) _module.Node.childrenVisited))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#6@0|) _module.Node.childrenVisited)))) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#6@0|) _module.Node.children)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#6@0|) _module.Node.children))))) (= (ControlFlow 0 9) 1)) anon21_correct)))
(let ((anon28_Then_correct  (=> (|Set#IsMember| |S#0| ($Box refType |n#6@0|)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |n#6@0| null)) (not true))) (=> (or (not (= |n#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |n#6@0| null)) (not true))) (=> (or (not (= |n#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap)) (=> ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#6@0|) _module.Node.childrenVisited))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#6@0|) _module.Node.childrenVisited)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |n#6@0| null)) (not true))) (=> (or (not (= |n#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |n#6@0| null)) (not true))) (=> (or (not (= |n#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap)) (=> ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap) (=> (and (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#6@0|) _module.Node.children)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#6@0|) _module.Node.children))) (= (ControlFlow 0 2) 1)) anon21_correct)))))))))))))))))
(let ((anon18_correct  (=> (forall ((|n#5| T@U) ) (!  (=> ($Is refType |n#5| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0| ($Box refType |n#5|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#5|) _module.Node.marked)))) (forall ((|ch#5| T@U) ) (!  (=> ($Is refType |ch#5| Tclass._module.Node?) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#5|) _module.Node.children)) ($Box refType |ch#5|)) (or (not (= |ch#5| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ch#5|) _module.Node.marked)))))
...
)) (=> (and ($Is refType |n#6@0| Tclass._module.Node) ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap@0)) (and (=> (= (ControlFlow 0 10) 2) anon28_Then_correct) (=> (= (ControlFlow 0 10) 9) anon28_Else_correct))))))
...
)) (= (ControlFlow 0 12) 10)) anon18_correct)))
(let ((anon27_Else_correct  (=> (and (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.children)) ($Box refType |ch#3@0|)) (or (not (= |ch#3@0| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ch#3@0|) _module.Node.marked)))) (= (ControlFlow 0 16) 12)) anon16_correct)))
(let ((anon27_Then_correct  (and (=> (= (ControlFlow 0 13) (- 0 15)) (or (not (= |n#4@0| null)) (not true))) (=> (or (not (= |n#4@0| null)) (not true)) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.children)) ($Box refType |ch#3@0|)) (or (not (= |ch#3@0| null)) (not true))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (not (= |ch#3@0| null)) (not true))) (=> (or (not (= |ch#3@0| null)) (not true)) (=> (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ch#3@0|) _module.Node.marked))) (= (ControlFlow 0 13) 12)) anon16_correct))))))))
(let ((anon26_Then_correct  (=> (|Set#IsMember| |S#0| ($Box refType |n#4@0|)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= |n#4@0| null)) (not true))) (=> (or (not (= |n#4@0| null)) (not true)) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.marked))) (=> (and ($Is refType |ch#3@0| Tclass._module.Node?) ($IsAlloc refType |ch#3@0| Tclass._module.Node? $Heap@0)) (and (=> (= (ControlFlow 0 17) 13) anon27_Then_correct) (=> (= (ControlFlow 0 17) 16) anon27_Else_correct)))))))))
(let ((anon26_Else_correct  (=> (and (=> (and (|Set#IsMember| |S#0| ($Box refType |n#4@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.marked)))) (forall ((|ch#4@@0| T@U) ) (!  (=> ($Is refType |ch#4@@0| Tclass._module.Node?) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.children)) ($Box refType |ch#4@@0|)) (or (not (= |ch#4@@0| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |ch#4@@0|) _module.Node.marked)))))
 :qid |SchorrWaitedfy.29:22|
 :skolemid |598|
...
))) (= (ControlFlow 0 11) 10)) anon18_correct)))
(let ((anon12_correct  (=> (forall ((|n#3| T@U) ) (!  (=> ($Is refType |n#3| Tclass._module.Node) (and (=> (|Set#IsMember| |S#0| ($Box refType |n#3|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#3|) _module.Node.marked))))) (=> (|Set#IsMember| |S#0| ($Box refType |n#3|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#3|) _module.Node.childrenVisited))) (LitInt 0)))))
...
)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8)) (|Set#IsMember| |S#0| ($Box refType $o@@8))))
 :qid |SchorrWaitedfy.19:8|
 :skolemid |596|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (not (= |root#0| null)) (not true))) (=> (or (not (= |root#0| null)) (not true)) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.marked))) (=> (and ($Is refType |n#4@0| Tclass._module.Node) ($IsAlloc refType |n#4@0| Tclass._module.Node $Heap@0)) (and (=> (= (ControlFlow 0 19) 17) anon26_Then_correct) (=> (= (ControlFlow 0 19) 11) anon26_Else_correct))))))))))
(let ((anon25_Else_correct  (=> (and (=> (|Set#IsMember| |S#0| ($Box refType |n#2@0|)) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#2@0|) _module.Node.marked)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#2@0|) _module.Node.childrenVisited))) (LitInt 0)))) (= (ControlFlow 0 24) 19)) anon12_correct)))
(let ((anon25_Then_correct  (=> (|Set#IsMember| |S#0| ($Box refType |n#2@0|)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (or (not (= |n#2@0| null)) (not true))) (=> (or (not (= |n#2@0| null)) (not true)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#2@0|) _module.Node.marked)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (or (not (= |n#2@0| null)) (not true))) (=> (or (not (= |n#2@0| null)) (not true)) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#2@0|) _module.Node.childrenVisited))) (LitInt 0)) (= (ControlFlow 0 21) 19)) anon12_correct)))))))))
...
)) (=> (and ($Is refType |n#2@0| Tclass._module.Node) ($IsAlloc refType |n#2@0| Tclass._module.Node $Heap)) (and (=> (= (ControlFlow 0 25) 21) anon25_Then_correct) (=> (= (ControlFlow 0 25) 24) anon25_Else_correct))))))
...
)) (= (ControlFlow 0 27) 25)) anon9_correct)))
(let ((anon24_Else_correct  (=> (or (not (= |ch#0@0| null)) (not true)) (=> (and (|Set#IsMember| |S#0| ($Box refType |ch#0@0|)) (= (ControlFlow 0 30) 27)) anon7_correct))))
(let ((anon24_Then_correct  (=> (and (= |ch#0@0| null) (= (ControlFlow 0 29) 27)) anon7_correct)))
(let ((anon23_Then_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (or (not (= |n#0@0| null)) (not true))) (=> (or (not (= |n#0@0| null)) (not true)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#0@0|) _module.Node.children)) ($Box refType |ch#0@0|)) (and (=> (= (ControlFlow 0 31) 29) anon24_Then_correct) (=> (= (ControlFlow 0 31) 30) anon24_Else_correct)))))))
(let ((anon23_Else_correct  (=> (and (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#0@0|) _module.Node.children)) ($Box refType |ch#0@0|)) (or (= |ch#0@0| null) (|Set#IsMember| |S#0| ($Box refType |ch#0@0|)))) (= (ControlFlow 0 28) 27)) anon7_correct)))
(let ((anon22_Then_correct  (=> (|Set#IsMember| |S#0| ($Box refType |n#0@0|)) (=> (and ($Is refType |ch#0@0| Tclass._module.Node?) ($IsAlloc refType |ch#0@0| Tclass._module.Node? $Heap)) (and (=> (= (ControlFlow 0 33) 31) anon23_Then_correct) (=> (= (ControlFlow 0 33) 28) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (=> (|Set#IsMember| |S#0| ($Box refType |n#0@0|)) (forall ((|ch#1@@0| T@U) ) (!  (=> ($Is refType |ch#1@@0| Tclass._module.Node?) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#0@0|) _module.Node.children)) ($Box refType |ch#1@@0|)) (or (= |ch#1@@0| null) (|Set#IsMember| |S#0| ($Box refType |ch#1@@0|)))))
 :qid |SchorrWaitedfy.23:22|
 :skolemid |592|
...
))) (= (ControlFlow 0 26) 25)) anon9_correct)))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |S#0|)) (|Set#IsMember| |S#0| ($Box refType |root#0|))) (and ($Is refType |n#0@0| Tclass._module.Node) ($IsAlloc refType |n#0@0| Tclass._module.Node $Heap))) (and (=> (= (ControlFlow 0 34) 33) anon22_Then_correct) (=> (= (ControlFlow 0 34) 26) anon22_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |root#0| Tclass._module.Node) ($IsAlloc refType |root#0| Tclass._module.Node $Heap))) (and (and ($Is SetType |S#0| (TSet Tclass._module.Node)) ($IsAlloc SetType |S#0| (TSet Tclass._module.Node) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 35) 34)))) anon0_correct)))
