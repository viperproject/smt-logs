...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split171)
...
))))))))))))))))))))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))) (forall ((|i#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (|Seq#Length| |stackNodes#0@4|))) (|Set#IsMember| |S#0@@5| (|Seq#Index| |stackNodes#0@4| |i#1@@0|)))
 :qid |SchorrWaitedfy.197:22|
 :skolemid |809|
