...
(declare-fun _module.__default.ins1 (T@U T@U T@U) T@U)
(declare-fun |_module.__default.ins1#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly T@U) (|x#0| T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.mem#canCall| |x#0| |xs#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.mem $ly |x#0| |xs#0|) Tclass._module.Bool))
 :qid |Ripplinglegacydfy.106:16|
 :skolemid |650|
 :pattern ( (_module.__default.mem $ly |x#0| |xs#0|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0| T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.ins1#canCall| |n#0| |xs#0@@0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.ins1 $ly@@0 |n#0| |xs#0@@0|) Tclass._module.List))
 :qid |Ripplinglegacydfy.223:16|
 :skolemid |750|
 :pattern ( (_module.__default.ins1 $ly@@0 |n#0| |xs#0@@0|))
))))
(assert (forall (($ly@@1 T@U) (|x#0@@0| T@U) (|xs#0@@1| T@U) ) (! (= (_module.__default.mem ($LS $ly@@1) |x#0@@0| |xs#0@@1|) (_module.__default.mem $ly@@1 |x#0@@0| |xs#0@@1|))
 :qid |Ripplinglegacydfy.106:16|
 :skolemid |648|
 :pattern ( (_module.__default.mem ($LS $ly@@1) |x#0@@0| |xs#0@@1|))
)))
(assert (forall (($ly@@2 T@U) (|n#0@@0| T@U) (|xs#0@@2| T@U) ) (! (= (_module.__default.ins1 ($LS $ly@@2) |n#0@@0| |xs#0@@2|) (_module.__default.ins1 $ly@@2 |n#0@@0| |xs#0@@2|))
 :qid |Ripplinglegacydfy.223:16|
 :skolemid |748|
 :pattern ( (_module.__default.ins1 ($LS $ly@@2) |n#0@@0| |xs#0@@2|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|n#0@@1| T@U) (|xs#0@@3| T@U) ) (!  (=> (or (|_module.__default.ins1#canCall| |n#0@@1| |xs#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@3|)) (let ((|ys#1| (_module.List._h2 |xs#0@@3|)))
(let ((|y#1| (_module.List._h1 |xs#0@@3|)))
 (and (and (|$IsA#_module.Nat| |n#0@@1|) (|$IsA#_module.Nat| |y#1|)) (=> (not (|_module.Nat#Equal| |n#0@@1| |y#1|)) (|_module.__default.ins1#canCall| |n#0@@1| |ys#1|)))))) (= (_module.__default.ins1 ($LS $ly@@3) |n#0@@1| |xs#0@@3|) (ite (_module.List.Nil_q |xs#0@@3|) (|#_module.List.Cons| |n#0@@1| (Lit DatatypeTypeType |#_module.List.Nil|)) (let ((|ys#0| (_module.List._h2 |xs#0@@3|)))
(let ((|y#0| (_module.List._h1 |xs#0@@3|)))
(ite (|_module.Nat#Equal| |n#0@@1| |y#0|) (|#_module.List.Cons| |y#0| |ys#0|) (|#_module.List.Cons| |y#0| (_module.__default.ins1 $ly@@3 |n#0@@1| |ys#0|)))))))))
 :qid |Ripplinglegacydfy.223:16|
 :skolemid |752|
 :pattern ( (_module.__default.ins1 ($LS $ly@@3) |n#0@@1| |xs#0@@3|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@4 T@U) (|n#0@@2| T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.ins1#canCall| (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@4|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@4| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@4|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@4|)))))
(let ((|y#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@4|)))))
 (and (and (|$IsA#_module.Nat| (Lit DatatypeTypeType |n#0@@2|)) (|$IsA#_module.Nat| |y#3|)) (=> (not (|_module.Nat#Equal| |n#0@@2| |y#3|)) (|_module.__default.ins1#canCall| (Lit DatatypeTypeType |n#0@@2|) |ys#3|)))))) (= (_module.__default.ins1 ($LS $ly@@4) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@4|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@4|)) (|#_module.List.Cons| (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |#_module.List.Nil|)) (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@4|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@4|)))))
(ite (|_module.Nat#Equal| |n#0@@2| |y#2|) (|#_module.List.Cons| |y#2| |ys#2|) (|#_module.List.Cons| |y#2| (Lit DatatypeTypeType (_module.__default.ins1 ($LS $ly@@4) (Lit DatatypeTypeType |n#0@@2|) |ys#2|))))))))))
 :qid |Ripplinglegacydfy.223:16|
 :weight 3
 :skolemid |753|
 :pattern ( (_module.__default.ins1 ($LS $ly@@4) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@4|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|x#0@@1| T@U) (|xs#0@@5| T@U) ) (!  (=> (or (|_module.__default.mem#canCall| |x#0@@1| |xs#0@@5|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@5| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@5|)) (let ((|ys#1@@0| (_module.List._h2 |xs#0@@5|)))
(let ((|y#1@@0| (_module.List._h1 |xs#0@@5|)))
 (and (and (|$IsA#_module.Nat| |x#0@@1|) (|$IsA#_module.Nat| |y#1@@0|)) (=> (not (|_module.Nat#Equal| |x#0@@1| |y#1@@0|)) (|_module.__default.mem#canCall| |x#0@@1| |ys#1@@0|)))))) (= (_module.__default.mem ($LS $ly@@5) |x#0@@1| |xs#0@@5|) (ite (_module.List.Nil_q |xs#0@@5|) |#_module.Bool.False| (let ((|ys#0@@0| (_module.List._h2 |xs#0@@5|)))
(let ((|y#0@@0| (_module.List._h1 |xs#0@@5|)))
(ite (|_module.Nat#Equal| |x#0@@1| |y#0@@0|) |#_module.Bool.True| (_module.__default.mem $ly@@5 |x#0@@1| |ys#0@@0|))))))))
 :qid |Ripplinglegacydfy.106:16|
 :skolemid |652|
 :pattern ( (_module.__default.mem ($LS $ly@@5) |x#0@@1| |xs#0@@5|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) (|x#0@@2| T@U) (|xs#0@@6| T@U) ) (!  (=> (or (|_module.__default.mem#canCall| (Lit DatatypeTypeType |x#0@@2|) (Lit DatatypeTypeType |xs#0@@6|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@6| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@6|)))))) (let ((|ys#3@@0| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@6|)))))
(let ((|y#3@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@6|)))))
 (and (and (|$IsA#_module.Nat| (Lit DatatypeTypeType |x#0@@2|)) (|$IsA#_module.Nat| |y#3@@0|)) (=> (not (|_module.Nat#Equal| |x#0@@2| |y#3@@0|)) (|_module.__default.mem#canCall| (Lit DatatypeTypeType |x#0@@2|) |ys#3@@0|)))))) (= (_module.__default.mem ($LS $ly@@6) (Lit DatatypeTypeType |x#0@@2|) (Lit DatatypeTypeType |xs#0@@6|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@6|)) |#_module.Bool.False| (let ((|ys#2@@0| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@6|)))))
(let ((|y#2@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@6|)))))
(ite (|_module.Nat#Equal| |x#0@@2| |y#2@@0|) |#_module.Bool.True| (_module.__default.mem ($LS $ly@@6) (Lit DatatypeTypeType |x#0@@2|) |ys#2@@0|))))))))
 :qid |Ripplinglegacydfy.106:16|
 :weight 3
 :skolemid |653|
 :pattern ( (_module.__default.mem ($LS $ly@@6) (Lit DatatypeTypeType |x#0@@2|) (Lit DatatypeTypeType |xs#0@@6|)))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.P29)
