...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split120)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 121) (let ((anon95_correct  (=> (and (forall ((|n#29| T@U) ) (!  (=> ($Is refType |n#29| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#29|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#29|) _module.Node.marked))))) (|Set#IsMember| |unmarkedNodes#0@1| ($Box refType |n#29|))))
...
)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |t#0@0| null)) (not true)))))
