...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split239)
...
)))) (and (and (forall ((|n#3| T@U) ) (!  (=> ($Is refType |n#3| Tclass._module.Node) (and (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#3|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#3|) _module.Node.marked))))) (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#3|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#3|) _module.Node.childrenVisited))) (LitInt 0)))))
...
))) (and (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (=> (|Set#Equal| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (and (<= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (=> (= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) |$decr_init$loop#02@0|)))))))) (and (and (and (and |$w$loop#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (and (= |$decr$loop#02@1| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))))) (or (not (= |t#0@0| null)) (not true)))) (and (and (or (not (= |t#0@0| null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))))) (and (U_2_bool (Lit boolType (bool_2_U true))) (or (not (= |t#0@0| null)) (not true))))) (and (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |t#0@0| _module.Node.childrenVisited)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (and (= |$rhs#0_0_0@1| (LitInt 0)) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited ($Box intType (int_2_U |$rhs#0_0_0@1|))))))) (and (and ($IsGoodHeap $Heap@3) (or (not (= |p#0@0| null)) (not true))) (and (or (not (= |p#0@0| null)) (not true)) (or (not (= |p#0@0| null)) (not true)))))))) (and (and (and (and (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited)))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children))))) (= |oldP#0_0_0@1| ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited))))))) (and (and (or (not (= |p#0@0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |p#0@0| _module.Node.children))) (and (or (not (= |p#0@0| null)) (not true)) (or (not (= |p#0@0| null)) (not true))))) (and (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited)))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children))))) (= |$rhs#0_0_1@1| (|Seq#Update| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.childrenVisited))) ($Box refType |t#0@0|)))) (and (= $Heap@8 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |p#0@0|) _module.Node.children ($Box SeqType |$rhs#0_0_1@1|)))) ($IsGoodHeap $Heap@8)))) (and (and (and (and (<= 0 (- (|Seq#Length| |stackNodes#0@1|) 1)) (<= (- (|Seq#Length| |stackNodes#0@1|) 1) (|Seq#Length| |stackNodes#0@1|))) (= |stackNodes#0@3| (|Seq#Take| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1)))) (and (and (or (not (= |p#0@0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |p#0@0| _module.Node.childrenVisited))) (and (or (not (= |p#0@0| null)) (not true)) ($Is intType (int_2_U (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |p#0@0|) _module.Node.childrenVisited))) 1)) Tclass._System.nat)))) (and (and (and (= |$rhs#0_0_2@1| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |p#0@0|) _module.Node.childrenVisited))) 1)) (= $Heap@9 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@8 |p#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |p#0@0|) _module.Node.childrenVisited ($Box intType (int_2_U |$rhs#0_0_2@1|)))))) (and ($IsGoodHeap $Heap@9) (or (not (= |p#0@0| null)) (not true)))) (and (and (= |path#0@3| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |p#0@0|) _module.Node.pathFromRoot))) (= |t#0@1| |p#0@0|)) (and (= |p#0@1| |oldP#0_0_0@1|) (= |path#0@4| |path#0@3|)))))) (and (and (and (and (and (= $Heap@10 $Heap@9) (= |stackNodes#0@4| |stackNodes#0@3|)) (and (= |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (or (or (or (<= 0 |$decr$loop#02@1|) (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|)))) (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|))) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.childrenVisited)))) |$decr$loop#02@1|)))) (and (and (or (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|))) (and (|Set#Equal| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (or (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (and (= (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.childrenVisited)))) |$decr$loop#02@1|))))) (=> (forall ((|i#1@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@1|) (< |i#1@@1| (|Seq#Length| |stackNodes#0@4|))) (|Set#IsMember| |S#0@@5| (|Seq#Index| |stackNodes#0@4| |i#1@@1|)))
 :qid |SchorrWaitedfy.197:22|
 :skolemid |877|
...
)))) (and (=> |$w$loop#0@0| (=> (< 0 (|Seq#Length| |stackNodes#0@4|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (|Seq#Index| |stackNodes#0@4| (- (|Seq#Length| |stackNodes#0@4|) 1)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (|Seq#Index| |stackNodes#0@4| (- (|Seq#Length| |stackNodes#0@4|) 1)))) _module.Node.childrenVisited))))) |t#0@1|))) (=> |$w$loop#0@0| (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |root#0|) _module.Node.marked)))))) (and (and (=> |$w$loop#0@0| (forall ((|n#19@@2| T@U) ) (!  (=> ($Is refType |n#19@@2| Tclass._module.Node) (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#19@@2|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19@@2|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@4| ($Box refType |n#19@@2|)))) (or (not (= |n#19@@2| |t#0@1|)) (not true))) (forall ((|ch#7@@2| T@U) ) (!  (=> ($Is refType |ch#7@@2| Tclass._module.Node?) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |n#19@@2|) _module.Node.children)) ($Box refType |ch#7@@2|)) (or (not (= |ch#7@@2| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |ch#7@@2|) _module.Node.marked)))))
 :qid |SchorrWaitedfy.244:24|
 :skolemid |835|
...
(|Set#IsMember| |S#0@@5| ($Box refType |n#22@@5|))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
