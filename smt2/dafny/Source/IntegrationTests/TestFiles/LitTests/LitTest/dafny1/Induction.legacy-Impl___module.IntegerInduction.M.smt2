...
(set-info :boogie-vc-id Impl$$_module.IntegerInduction.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon5_correct  (=> (and (and (forall ((|k#1| Int) ) (!  (=> (<= (LitInt 0) |k#1|) (=> (< |k#1| |n#0@@3|) (|_module.IntegerInduction.Gauss#canCall| this@@3 |k#1|)))
 :qid |Inductionlegacydfy.96:20|
 :skolemid |582|
 :pattern ( (_module.IntegerInduction.Gauss ($LS $LZ) this@@3 |k#1|))
)) (forall ((|k#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |k#1@@0|) (< |k#1@@0| |n#0@@3|)) (= (Mul (LitInt 2) (_module.IntegerInduction.Gauss ($LS $LZ) this@@3 |k#1@@0|)) (Mul |k#1@@0| (+ |k#1@@0| 1))))
 :qid |Inductionlegacydfy.96:20|
 :skolemid |583|
 :pattern ( (_module.IntegerInduction.Gauss ($LS $LZ) this@@3 |k#1@@0|))
))) (and ($IsAllocBox ($Box refType this@@3) Tclass._module.IntegerInduction? $Heap) ($IsAlloc intType (int_2_U |n#0@@3|) TInt $Heap))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) |n#0@@3|)) (=> (|_module.IntegerInduction.Gauss#canCall| this@@3 |n#0@@3|) (=> (and (|_module.IntegerInduction.Gauss#canCall| this@@3 |n#0@@3|) (= (ControlFlow 0 3) (- 0 2))) (= (Mul (LitInt 2) (_module.IntegerInduction.Gauss ($LS ($LS $LZ)) this@@3 |n#0@@3|)) (Mul |n#0@@3| (+ |n#0@@3| 1)))))))))
(let ((anon8_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |n#0@@3|))) (= (ControlFlow 0 7) 3)) anon5_correct)))
(let ((anon8_Then_correct  (=> (and (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| |n#0@@3|)) (and ($IsAllocBox ($Box refType this@@3) Tclass._module.IntegerInduction? $Heap) ($IsAlloc intType (int_2_U |k#0@0|) TInt $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= (LitInt 0) |k#0@0|)) (=> (and (|_module.IntegerInduction.Gauss#canCall| this@@3 |k#0@0|) (= (ControlFlow 0 5) 3)) anon5_correct)))))
(let ((anon7_Else_correct  (=> (< |k#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 9) 5) anon8_Then_correct) (=> (= (ControlFlow 0 9) 7) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.IntegerInduction) ($IsAlloc refType this@@3 Tclass._module.IntegerInduction $Heap))) (= 1 $FunctionContextHeight)) (and (<= (LitInt 0) |n#0@@3|) (= (ControlFlow 0 12) 11))) anon0_correct))))
