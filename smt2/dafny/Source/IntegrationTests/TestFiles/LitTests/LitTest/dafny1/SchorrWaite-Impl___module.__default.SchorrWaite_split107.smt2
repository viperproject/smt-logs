...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split107)
...
))) ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3)) (and (and ($Is refType |t#0@0| Tclass._module.Node) ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3)) (and ($IsAlloc DatatypeTypeType |path#0@1| Tclass._module.Path $Heap@@3) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType |t#0@0| Tclass._module.Node? $Heap@@3))))
