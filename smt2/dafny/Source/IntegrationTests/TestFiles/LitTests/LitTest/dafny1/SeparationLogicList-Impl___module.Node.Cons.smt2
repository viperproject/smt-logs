...
(assert (forall ((_module.Node$T@@3 T@U) ($ly T@U) ($h0 T@U) ($h1 T@U) (|q#0| T@U) (|from#0| T@U) (|to#0| T@U) (|S#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.Node.ListSegment#canCall| _module.Node$T@@3 $h0 |q#0| |from#0| |to#0| |S#0|) (and (and (and ($Is SeqType |q#0| (TSeq _module.Node$T@@3)) ($Is refType |from#0| (Tclass._module.Node? _module.Node$T@@3))) ($Is refType |to#0| (Tclass._module.Node? _module.Node$T@@3))) ($Is SetType |S#0| (TSet (Tclass._module.Node _module.Node$T@@3)))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (|Set#IsMember| |S#0| ($Box refType $o@@2))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))) (= (_module.Node.ListSegment _module.Node$T@@3 $ly $h0 |q#0| |from#0| |to#0| |S#0|) (_module.Node.ListSegment _module.Node$T@@3 $ly $h1 |q#0| |from#0| |to#0| |S#0|))))
