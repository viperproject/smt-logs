...
(assert (distinct TagSet alloc allocName class._module.List? Tagclass._module.List? Tagclass._module.List tytagFamily$List field$next field$ListNodes)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.List.Prepend)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon4_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7)))
 :qid |TerminationDemosdfy.97:10|
 :skolemid |617|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (and ($Is refType |list#0@0| Tclass._module.List) ($IsAlloc refType |list#0@0| Tclass._module.List $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |list#0@0| null)) (not true)))))
(let ((anon5_Else_correct  (=> (or (not (= |tail#0| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |tail#0| null)) (not true))) (=> (or (not (= |tail#0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |tail#0|) Tclass._module.List? $Heap@@1) (|_module.List.IsAcyclic#canCall| $Heap@@1 |tail#0|)) (and (_module.List.IsAcyclic ($LS $LZ) $Heap@@1 |tail#0|) (= (ControlFlow 0 4) 2))) anon4_correct))))))
(let ((anon5_Then_correct  (=> (and (= |tail#0| null) (= (ControlFlow 0 3) 2)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 6) 3) anon5_Then_correct) (=> (= (ControlFlow 0 6) 4) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.List) ($IsAlloc refType this@@2 Tclass._module.List $Heap@@1))) (and ($Is refType |tail#0| Tclass._module.List?) ($IsAlloc refType |tail#0| Tclass._module.List? $Heap@@1))) (and (and ($Is refType |list#0| Tclass._module.List) ($IsAlloc refType |list#0| Tclass._module.List $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct))))
