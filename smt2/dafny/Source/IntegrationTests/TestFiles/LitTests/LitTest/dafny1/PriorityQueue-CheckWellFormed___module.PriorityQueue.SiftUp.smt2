...
(set-info :boogie-vc-id CheckWellFormed$$_module.PriorityQueue.SiftUp)
...
(let ((anon11_correct  (=> (and (<= (LitInt 1) |j#2@0|) (<= |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (and (or (not (= (Div |j#2@0| (LitInt 2)) |k#0|)) (not true)) (= (ControlFlow 0 3) 1)) anon13_correct))))))
(let ((anon18_Else_correct  (=> (and (< |j#2@0| (LitInt 1)) (= (ControlFlow 0 6) 3)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and (<= (LitInt 1) |j#2@0|) (= (ControlFlow 0 5) 3)) anon11_correct)))
(let ((anon17_Else_correct  (=> (and (=> (and (<= (LitInt 1) |j#2@0|) (<= |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (or (not (= (Div |j#2@0| (LitInt 2)) |k#0|)) (not true))) (= (ControlFlow 0 2) 1)) anon13_correct)))
(let ((anon8_correct  (=> (forall ((|j#1| Int) ) (!  (=> (and (and (<= (LitInt 2) |j#1|) (<= |j#1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (or (not (= |j#1| |k#0|)) (not true))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField (Div |j#1| (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField |j#1|))))))
 :qid |PriorityQueuedfy.50:21|
 :skolemid |536|
 :pattern ( (Div |j#1| 2))
)) (and (and (=> (= (ControlFlow 0 7) 2) anon17_Else_correct) (=> (= (ControlFlow 0 7) 5) anon18_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon18_Else_correct)))))
(let ((anon6_correct  (=> (and (and (<= (LitInt 2) |j#0@0|) (<= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (or (not (= |j#0@0| |k#0|)) (not true))) (and (=> (= (ControlFlow 0 9) (- 0 14)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 13)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (and (<= 0 (Div |j#0@0| (LitInt 2))) (< (Div |j#0@0| (LitInt 2)) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)))))) (=> (and (<= 0 (Div |j#0@0| (LitInt 2))) (< (Div |j#0@0| (LitInt 2)) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)) null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)))))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))))) (=> (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField (Div |j#0@0| (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField |j#0@0|))))) (= (ControlFlow 0 9) 7)) anon8_correct))))))))))))))
(let ((anon16_Else_correct  (=> (and (< |j#0@0| (LitInt 2)) (= (ControlFlow 0 16) 9)) anon6_correct)))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 2) |j#0@0|) (= (ControlFlow 0 15) 9)) anon6_correct)))
(let ((anon15_Else_correct  (=> (and (=> (and (and (<= (LitInt 2) |j#0@0|) (<= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) (or (not (= |j#0@0| |k#0|)) (not true))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField (Div |j#0@0| (LitInt 2)))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a))) (IndexField |j#0@0|)))))) (= (ControlFlow 0 8) 7)) anon8_correct)))
(let ((anon3_correct  (=> (and (and (and (<= (LitInt 1) |k#0|) (<= |k#0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))))) ($IsAllocBox ($Box refType this@@3) Tclass._module.PriorityQueue? $Heap@@1)) (and (|_module.PriorityQueue.MostlyValid#canCall| $Heap@@1 this@@3) (_module.PriorityQueue.MostlyValid $Heap@@1 this@@3))) (and (and (=> (= (ControlFlow 0 17) 8) anon15_Else_correct) (=> (= (ControlFlow 0 17) 15) anon16_Then_correct)) (=> (= (ControlFlow 0 17) 16) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (< |k#0| (LitInt 1)) (= (ControlFlow 0 19) 17)) anon3_correct)))
(let ((anon14_Then_correct  (=> (and (<= (LitInt 1) |k#0|) (= (ControlFlow 0 18) 17)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#5| null $Heap@@1 alloc ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.a)))) (and (=> (= (ControlFlow 0 20) 18) anon14_Then_correct) (=> (= (ControlFlow 0 20) 19) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.PriorityQueue) ($IsAlloc refType this@@3 Tclass._module.PriorityQueue $Heap@@1))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 21) 20))) anon0_correct))))
