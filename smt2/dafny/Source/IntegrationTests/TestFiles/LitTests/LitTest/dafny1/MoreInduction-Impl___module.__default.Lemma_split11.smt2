...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma_split11)
...
(let ((|n#2@@4| (_module.List._h0 |ext#0@@4|)))
 (=> (_module.Node.Element_q |n#2@@4|) (_module.__default.IsFlat _module._default.Lemma$X ($LS ($LS $LZ)) |rest#2@@3|))))))) (=> (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext#0@@4|) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (=> (not (_module.List.Nil_q |ext#0@@4|)) (let ((|n#2@@5| (_module.List._h0 |ext#0@@4|)))
 (=> (not (_module.Node.Element_q |n#2@@5|)) (U_2_bool (Lit boolType (bool_2_U false))))))))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3))))) (and (and (and (and (|_module.__default.ToSeq#canCall| _module._default.Lemma$X |rest#0_0@0|) (|_module.__default.ToSeq#canCall| _module._default.Lemma$X |ext#0@@4|)) (and (|_module.__default.Flatten#canCall| _module._default.Lemma$X |rest#0_0@0| |ext#0@@4|) (|_module.__default.ToSeq#canCall| _module._default.Lemma$X (_module.__default.Flatten _module._default.Lemma$X ($LS $LZ) |rest#0_0@0| |ext#0@@4|)))) (|Seq#Equal| (|Seq#Append| (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) |rest#0_0@0|) (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) |ext#0@@4|)) (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) (_module.__default.Flatten _module._default.Lemma$X ($LS ($LS $LZ)) |rest#0_0@0| |ext#0@@4|)))) (and (= $Heap@2 $Heap@3) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct))))))
(let ((anon9_Then_correct  (=> (and (= |n#0_0@0| (|#_module.Node.Element| |_mcc#2#0_1_0@0|)) ($IsBox |_mcc#2#0_1_0@0| _module._default.Lemma$X)) (=> (and (and ($IsBox |x#0_1_0@0| _module._default.Lemma$X) ($IsAllocBox |x#0_1_0@0| _module._default.Lemma$X $Heap@0)) (= |let#0_1_0#0#0| |_mcc#2#0_1_0@0|)) (=> (and (and (and ($IsBox |let#0_1_0#0#0| _module._default.Lemma$X) (= |x#0_1_0@0| |let#0_1_0#0#0|)) (and (or (< (DtRank |rest#0_0@0|) (DtRank |list#0@@12|)) (and (= (DtRank |rest#0_0@0|) (DtRank |list#0@@12|)) (< (DtRank |ext#0@@4|) (DtRank |ext#0@@4|)))) (=> (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext#0@@4|) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (=> (_module.List.Nil_q |ext#0@@4|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (and (=> (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext#0@@4|) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (=> (not (_module.List.Nil_q |ext#0@@4|)) (let ((|rest#2@@4| (_module.List._h1 |ext#0@@4|)))
(let ((|n#2@@6| (_module.List._h0 |ext#0@@4|)))
 (=> (_module.Node.Element_q |n#2@@6|) (_module.__default.IsFlat _module._default.Lemma$X ($LS ($LS $LZ)) |rest#2@@4|))))))) (=> (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext#0@@4|) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (=> (not (_module.List.Nil_q |ext#0@@4|)) (let ((|n#2@@7| (_module.List._h0 |ext#0@@4|)))
 (=> (not (_module.Node.Element_q |n#2@@7|)) (U_2_bool (Lit boolType (bool_2_U false))))))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (=> (and (and (and (and (|_module.__default.ToSeq#canCall| _module._default.Lemma$X |rest#0_0@0|) (|_module.__default.ToSeq#canCall| _module._default.Lemma$X |ext#0@@4|)) (and (|_module.__default.Flatten#canCall| _module._default.Lemma$X |rest#0_0@0| |ext#0@@4|) (|_module.__default.ToSeq#canCall| _module._default.Lemma$X (_module.__default.Flatten _module._default.Lemma$X ($LS $LZ) |rest#0_0@0| |ext#0@@4|)))) (|Seq#Equal| (|Seq#Append| (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) |rest#0_0@0|) (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) |ext#0@@4|)) (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) (_module.__default.Flatten _module._default.Lemma$X ($LS ($LS $LZ)) |rest#0_0@0| |ext#0@@4|)))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))))
(let ((anon7_Else_correct  (=> (and (and (or (not (= |list#0@@12| |#_module.List.Nil|)) (not true)) (= |list#0@@12| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|))) (and ($Is DatatypeTypeType |_mcc#0#0_0@0| (Tclass._module.Node _module._default.Lemma$X)) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module._default.Lemma$X)))) (=> (and (and (and (and ($Is DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module._default.Lemma$X)) (= |rest#0_0@0| |let#0_0#0#0|))) (and (and (and ($Is DatatypeTypeType |n#0_0@0| (Tclass._module.Node _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |n#0_0@0| (Tclass._module.Node _module._default.Lemma$X) $Heap@0)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($Is DatatypeTypeType |let#0_1#0#0| (Tclass._module.Node _module._default.Lemma$X)) (= |n#0_0@0| |let#0_1#0#0|)))) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))
(let ((anon7_Then_correct  (=> (and (= |list#0@@12| |#_module.List.Nil|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
...
))))) (and (=> (= (ControlFlow 0 7) 3) anon7_Then_correct) (=> (= (ControlFlow 0 7) 6) anon7_Else_correct))))))))
anon0_correct)))))))
))
(check-sat)
(get-info :rlimit)
