...
(declare-fun |d#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.InitAsPredecessor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |succ#0| null)) (not true))) (=> (or (not (= |succ#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |succ#0|) (Tclass._module.Node? _module.Node$T@@20) $Heap@@1) (=> (and (|_module.Node.Valid#canCall| _module.Node$T@@20 $Heap@@1 |succ#0|) (_module.Node.Valid _module.Node$T@@20 ($LS $LZ) $Heap@@1 |succ#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11)))
 :qid |ListContentsdfy.30:15|
 :skolemid |512|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11))
)) ($HeapSucc $Heap@@1 $Heap@0))) (=> (and (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 (Tclass._module.Node _module.Node$T@@20)) ($IsAlloc refType this@0 (Tclass._module.Node _module.Node$T@@20) $Heap@0))) ($IsAllocBox ($Box refType this@0) (Tclass._module.Node? _module.Node$T@@20) $Heap@0)) (and (|_module.Node.Valid#canCall| _module.Node$T@@20 $Heap@0 this@0) (_module.Node.Valid _module.Node$T@@20 ($LS $LZ) $Heap@0 this@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |succ#0| null)) (not true))) (=> (or (not (= |succ#0| null)) (not true)) (=> (and (and (forall (($o@@12 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.Node.Repr)) ($Box refType $o@@12)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |succ#0|) _module.Node.Repr)) ($Box refType $o@@12)))) (or (not (= $o@@12 null)) (not true)))
 :qid |ListContentsdfy.32:24|
 :skolemid |513|
 :pattern (  (or (not (= $o@@12 null)) (not true)))
)) (forall (($o@@13 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.Node.Repr)) ($Box refType $o@@13)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |succ#0|) _module.Node.Repr)) ($Box refType $o@@13)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@13) alloc)))))
 :qid |ListContentsdfy.32:24|
 :skolemid |514|
...
))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |succ#0| null)) (not true))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($IsBox |d#0| _module.Node$T@@20) ($IsAllocBox |d#0| _module.Node$T@@20 $Heap@@1))) (and (and ($Is refType |succ#0| (Tclass._module.Node _module.Node$T@@20)) ($IsAlloc refType |succ#0| (Tclass._module.Node _module.Node$T@@20) $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))
