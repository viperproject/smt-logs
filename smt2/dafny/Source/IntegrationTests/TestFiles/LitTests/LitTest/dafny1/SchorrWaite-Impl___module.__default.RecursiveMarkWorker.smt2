...
(let ((anon64_Then_correct  (=> (or (not (= |c#0_0_0@1| null)) (not true)) (and (=> (= (ControlFlow 0 18) (- 0 25)) ($Is refType |c#0_0_0@1| Tclass._module.Node)) (=> ($Is refType |c#0_0_0@1| Tclass._module.Node) (=> (= |stackNodes##0_0_0_0@1| (|Set#Union| |stackNodes#0| (|Set#UnionOne| |Set#Empty| ($Box refType |root#0|)))) (and (=> (= (ControlFlow 0 18) (- 0 24)) (forall (($o@@8 T@U) ($f@@0 T@U) )  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@8) alloc)))) (|Set#IsMember| |S#0| ($Box refType $o@@8))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@8 $f@@0))))) (=> (forall (($o@@9 T@U) ($f@@1 T@U) )  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@9) alloc)))) (|Set#IsMember| |S#0| ($Box refType $o@@9))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@9 $f@@1)))) (and (=> (= (ControlFlow 0 18) (- 0 23)) (and (|Set#Subset| (|Set#Difference| |S#0| |stackNodes##0_0_0_0@1|) (|Set#Difference| |S#0| |stackNodes#0|)) (not (|Set#Subset| (|Set#Difference| |S#0| |stackNodes#0|) (|Set#Difference| |S#0| |stackNodes##0_0_0_0@1|))))) (=> (and (|Set#Subset| (|Set#Difference| |S#0| |stackNodes##0_0_0_0@1|) (|Set#Difference| |S#0| |stackNodes#0|)) (not (|Set#Subset| (|Set#Difference| |S#0| |stackNodes#0|) (|Set#Difference| |S#0| |stackNodes##0_0_0_0@1|)))) (and (=> (= (ControlFlow 0 18) (- 0 22)) (|Set#IsMember| |S#0| ($Box refType |c#0_0_0@1|))) (=> (|Set#IsMember| |S#0| ($Box refType |c#0_0_0@1|)) (and (=> (= (ControlFlow 0 18) (- 0 21)) (forall ((|n#1| T@U) ) (!  (=> ($Is refType |n#1| Tclass._module.Node) (=> (|Set#IsMember| |S#0| ($Box refType |n#1|)) (forall ((|ch#2| T@U) ) (!  (=> ($Is refType |ch#2| Tclass._module.Node?) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#1|) _module.Node.children)) ($Box refType |ch#2|)) (or (= |ch#2| null) (|Set#IsMember| |S#0| ($Box refType |ch#2|)))))
