...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split77)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 53) (let ((anon136_Then_correct  (=> (and (and (< 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= ($Unbox refType (|Seq#Index| |stackNodes#0@1| |k#0@0|)) null)) (not true)))))
