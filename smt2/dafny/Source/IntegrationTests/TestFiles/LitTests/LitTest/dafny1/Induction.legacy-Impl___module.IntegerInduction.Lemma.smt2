...
(set-info :boogie-vc-id Impl$$_module.IntegerInduction.Lemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mul (LitInt 2) (_module.IntegerInduction.Gauss ($LS ($LS $LZ)) this@@3 |n#0@@3|)) (Mul |n#0@@3| (+ |n#0@@3| 1))))))
(let ((anon3_Else_correct  (=> (and (= |n#0@@3| 0) (= (ControlFlow 0 7) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (and (or (not (= |n#0@@3| 0)) (not true)) (= |n##0_0@0| (- |n#0@@3| 1))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (<= 0 |n#0@@3|) (= |n##0_0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |n##0_0@0| |n#0@@3|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< |n##0_0@0| |n#0@@3|)) (=> (< |n##0_0@0| |n#0@@3|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) |n##0_0@0|)) (=> (<= (LitInt 0) |n##0_0@0|) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.IntegerInduction.Gauss#canCall| this@@3 |n##0_0@0|) (= (Mul (LitInt 2) (_module.IntegerInduction.Gauss ($LS ($LS $LZ)) this@@3 |n##0_0@0|)) (Mul |n##0_0@0| (+ |n##0_0@0| 1)))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#n0#0| Int) ) (!  (=> (and (<= (LitInt 0) |$ih#n0#0|) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@3|))) (= (Mul (LitInt 2) (_module.IntegerInduction.Gauss ($LS $LZ) this@@3 |$ih#n0#0|)) (Mul |$ih#n0#0| (+ |$ih#n0#0| 1))))
 :qid |Inductionlegacydfy.35:15|
 :skolemid |563|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.IntegerInduction) ($IsAlloc refType this@@3 Tclass._module.IntegerInduction $Heap))) (= 1 $FunctionContextHeight)) (and (<= (LitInt 0) |n#0@@3|) (= (ControlFlow 0 9) 8))) anon0_correct))))
