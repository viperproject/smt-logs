...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|_module.Expr#Equal| (_module.__default.Subst ($LS ($LS $LZ)) (_module.__default.Subst ($LS ($LS $LZ)) |e#0@@4| |v#0@@7| |val#0@@7|) |v#0@@7| |val#0@@7|) (_module.__default.Subst ($LS ($LS $LZ)) |e#0@@4| |v#0@@7| |val#0@@7|)))))
(let ((anon7_Then_correct  (=> (and (= |e#0@@4| (|#_module.Expr.Nary| |_mcc#2#0_0@0| |_mcc#3#0_0@0|)) ($Is DatatypeTypeType |_mcc#3#0_0@0| Tclass._module.List)) (=> (and (and (and ($Is DatatypeTypeType |args#0_0@0| Tclass._module.List) ($IsAlloc DatatypeTypeType |args#0_0@0| Tclass._module.List $Heap@0)) (and (= |let#0_0#0#0| |_mcc#3#0_0@0|) ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.List))) (and (and (= |args#0_0@0| |let#0_0#0#0|) (= |let#0_1#0#0| |_mcc#2#0_0@0|)) (and ($Is intType (int_2_U |let#0_1#0#0|) TInt) (= |op#0_0@0| |let#0_1#0#0|)))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (or (<= 0 |v#0@@7|) (< (DtRank |args#0_0@0|) (DtRank |e#0@@4|))) (= |v#0@@7| |v#0@@7|))) (=> (or (or (<= 0 |v#0@@7|) (< (DtRank |args#0_0@0|) (DtRank |e#0@@4|))) (= |v#0@@7| |v#0@@7|)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (or (or (<= 0 |val#0@@7|) (< (DtRank |args#0_0@0|) (DtRank |e#0@@4|))) (< |v#0@@7| |v#0@@7|)) (= |val#0@@7| |val#0@@7|))) (=> (or (or (or (<= 0 |val#0@@7|) (< (DtRank |args#0_0@0|) (DtRank |e#0@@4|))) (< |v#0@@7| |v#0@@7|)) (= |val#0@@7| |val#0@@7|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (< (DtRank |args#0_0@0|) (DtRank |e#0@@4|)) (and (= (DtRank |args#0_0@0|) (DtRank |e#0@@4|)) (or (< |v#0@@7| |v#0@@7|) (and (= |v#0@@7| |v#0@@7|) (< |val#0@@7| |val#0@@7|)))))) (=> (or (< (DtRank |args#0_0@0|) (DtRank |e#0@@4|)) (and (= (DtRank |args#0_0@0|) (DtRank |e#0@@4|)) (or (< |v#0@@7| |v#0@@7|) (and (= |v#0@@7| |v#0@@7|) (< |val#0@@7| |val#0@@7|))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (|$IsA#_module.List| (_module.__default.SubstList ($LS $LZ) (_module.__default.SubstList ($LS $LZ) |args#0_0@0| |v#0@@7| |val#0@@7|) |v#0@@7| |val#0@@7|)) (|$IsA#_module.List| (_module.__default.SubstList ($LS $LZ) |args#0_0@0| |v#0@@7| |val#0@@7|))) (and (and (|_module.__default.SubstList#canCall| |args#0_0@0| |v#0@@7| |val#0@@7|) (|_module.__default.SubstList#canCall| (_module.__default.SubstList ($LS $LZ) |args#0_0@0| |v#0@@7| |val#0@@7|) |v#0@@7| |val#0@@7|)) (|_module.__default.SubstList#canCall| |args#0_0@0| |v#0@@7| |val#0@@7|))) (|_module.List#Equal| (_module.__default.SubstList ($LS ($LS $LZ)) (_module.__default.SubstList ($LS ($LS $LZ)) |args#0_0@0| |v#0@@7| |val#0@@7|) |v#0@@7| |val#0@@7|) (_module.__default.SubstList ($LS ($LS $LZ)) |args#0_0@0| |v#0@@7| |val#0@@7|))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 6) 3))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon6_Then_correct  (=> (and (= |e#0@@4| (|#_module.Expr.Var| |_mcc#1#1_0@0|)) (= (ControlFlow 0 5) 3)) GeneratedUnifiedExit_correct)))
(let ((anon5_Then_correct  (=> (and (= |e#0@@4| (|#_module.Expr.Const| |_mcc#0#2_0@0|)) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
(let ((anon7_Else_correct true))
(let ((anon6_Else_correct  (=> (or (not (= |e#0@@4| (|#_module.Expr.Var| |_mcc#1#1_0@0|))) (not true)) (and (=> (= (ControlFlow 0 10) 6) anon7_Then_correct) (=> (= (ControlFlow 0 10) 1) anon7_Else_correct)))))
(let ((anon5_Else_correct  (=> (or (not (= |e#0@@4| (|#_module.Expr.Const| |_mcc#0#2_0@0|))) (not true)) (and (=> (= (ControlFlow 0 11) 5) anon6_Then_correct) (=> (= (ControlFlow 0 11) 10) anon6_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Expr| |e#0@@4|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#e0#0| T@U) (|$ih#v0#0| Int) (|$ih#val0#0| Int) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#e0#0| Tclass._module.Expr) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#e0#0|) (DtRank |e#0@@4|)) (and (= (DtRank |$ih#e0#0|) (DtRank |e#0@@4|)) (or (and (<= 0 |$ih#v0#0|) (< |$ih#v0#0| |v#0@@7|)) (and (= |$ih#v0#0| |v#0@@7|) (and (<= 0 |$ih#val0#0|) (< |$ih#val0#0| |val#0@@7|))))))) (|_module.Expr#Equal| (_module.__default.Subst ($LS $LZ) (_module.__default.Subst ($LS $LZ) |$ih#e0#0| |$ih#v0#0| |$ih#val0#0|) |$ih#v0#0| |$ih#val0#0|) (_module.__default.Subst ($LS $LZ) |$ih#e0#0| |$ih#v0#0| |$ih#val0#0|)))
 :qid |Substitutiondfy.26:15|
 :skolemid |606|
 :pattern ( (_module.__default.Subst ($LS $LZ) (_module.__default.Subst ($LS $LZ) |$ih#e0#0| |$ih#v0#0| |$ih#val0#0|) |$ih#v0#0| |$ih#val0#0|))
)))) (and (=> (= (ControlFlow 0 12) 4) anon5_Then_correct) (=> (= (ControlFlow 0 12) 11) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |e#0@@4| Tclass._module.Expr) ($IsAlloc DatatypeTypeType |e#0@@4| Tclass._module.Expr $Heap)) (|$IsA#_module.Expr| |e#0@@4|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
