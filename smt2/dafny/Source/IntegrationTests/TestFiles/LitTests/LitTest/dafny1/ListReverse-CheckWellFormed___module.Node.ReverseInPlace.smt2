...
(let ((anon23_Else_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |y#2@0|) _module.Node.nxt)) null) (= (ControlFlow 0 6) 1)) anon15_correct)))
(let ((anon23_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |y#2@0|) _module.Node.nxt)) null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |y#2@0| null)) (not true))) (=> (or (not (= |y#2@0| null)) (not true)) (=> (= (ControlFlow 0 4) 1) anon15_correct))))))
(let ((anon22_Then_correct  (=> (|Set#IsMember| |r#0| ($Box refType |y#2@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |y#2@0| null)) (not true))) (=> (or (not (= |y#2@0| null)) (not true)) (and (=> (= (ControlFlow 0 7) 4) anon23_Then_correct) (=> (= (ControlFlow 0 7) 6) anon23_Else_correct)))))))
(let ((anon22_Else_correct  (=> (and (not (|Set#IsMember| |r#0| ($Box refType |y#2@0|))) (= (ControlFlow 0 3) 1)) anon15_correct)))
(let ((anon21_Then_correct  (=> (and ($Is refType |y#2@0| Tclass._module.Node) ($IsAlloc refType |y#2@0| Tclass._module.Node $Heap@0)) (and (=> (= (ControlFlow 0 9) 7) anon22_Then_correct) (=> (= (ControlFlow 0 9) 3) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and ($Is refType |y#2@0| Tclass._module.Node) ($IsAlloc refType |y#2@0| Tclass._module.Node $Heap@0))) (= (ControlFlow 0 2) 1)) anon15_correct)))
(let ((anon20_Else_correct  (=> (and (or (not (= |reverse#0@0| null)) (not true)) (|Set#IsMember| |r#0| ($Box refType |reverse#0@0|))) (and (=> (= (ControlFlow 0 11) 9) anon21_Then_correct) (=> (= (ControlFlow 0 11) 2) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (= |reverse#0@0| null) (and (=> (= (ControlFlow 0 10) 9) anon21_Then_correct) (=> (= (ControlFlow 0 10) 2) anon21_Else_correct)))))
(let ((anon8_correct  (=> (forall ((|y#1| T@U) ) (!  (=> ($Is refType |y#1| Tclass._module.Node) (=> (|Set#IsMember| |r#0| ($Box refType |y#1|)) (or (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |y#1|) _module.Node.nxt)) null) (|Set#IsMember| |r#0| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |y#1|) _module.Node.nxt)))))
 ...
 :qid |ListReversedfy.7:10|
 :skolemid |486|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0)) (and ($Is refType |reverse#0@0| Tclass._module.Node?) ($IsAlloc refType |reverse#0@0| Tclass._module.Node? $Heap@0))) (and (=> (= (ControlFlow 0 12) 10) anon20_Then_correct) (=> (= (ControlFlow 0 12) 11) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |y#0@0|) _module.Node.nxt)) null) (= (ControlFlow 0 17) 12)) anon8_correct)))
(let ((anon19_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |y#0@0|) _module.Node.nxt)) null)) (not true)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= |y#0@0| null)) (not true))) (=> (or (not (= |y#0@0| null)) (not true)) (=> (= (ControlFlow 0 15) 12) anon8_correct))))))
(let ((anon18_Then_correct  (=> (|Set#IsMember| |r#0| ($Box refType |y#0@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |y#0@0| null)) (not true))) (=> (or (not (= |y#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 18) 15) anon19_Then_correct) (=> (= (ControlFlow 0 18) 17) anon19_Else_correct)))))))
(let ((anon18_Else_correct  (=> (and (not (|Set#IsMember| |r#0| ($Box refType |y#0@0|))) (= (ControlFlow 0 14) 12)) anon8_correct)))
(let ((anon17_Then_correct  (=> (and ($Is refType |y#0@0| Tclass._module.Node) ($IsAlloc refType |y#0@0| Tclass._module.Node $Heap)) (and (=> (= (ControlFlow 0 20) 18) anon18_Then_correct) (=> (= (ControlFlow 0 20) 14) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and ($Is refType |y#0@0| Tclass._module.Node) ($IsAlloc refType |y#0@0| Tclass._module.Node $Heap))) (= (ControlFlow 0 13) 12)) anon8_correct)))
(let ((anon16_Else_correct  (=> (and (or (not (= |x#0| null)) (not true)) (|Set#IsMember| |r#0| ($Box refType |x#0|))) (and (=> (= (ControlFlow 0 22) 20) anon17_Then_correct) (=> (= (ControlFlow 0 22) 13) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (= |x#0| null) (and (=> (= (ControlFlow 0 21) 20) anon17_Then_correct) (=> (= (ControlFlow 0 21) 13) anon17_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |r#0|)) (and (=> (= (ControlFlow 0 23) 21) anon16_Then_correct) (=> (= (ControlFlow 0 23) 22) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Node) ($IsAlloc refType this Tclass._module.Node $Heap)))) (=> (and (and (and ($Is refType |x#0| Tclass._module.Node?) ($IsAlloc refType |x#0| Tclass._module.Node? $Heap)) (and ($Is SetType |r#0| (TSet Tclass._module.Node)) ($IsAlloc SetType |r#0| (TSet Tclass._module.Node) $Heap))) (and (and ($Is refType |reverse#0| Tclass._module.Node?) ($IsAlloc refType |reverse#0| Tclass._module.Node? $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 24) 23)))) anon0_correct))))
