...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split62)
...
)) (=> (and (< 0 (|Seq#Length| |stackNodes#0@1|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |stackNodes#0@1|)))))))
