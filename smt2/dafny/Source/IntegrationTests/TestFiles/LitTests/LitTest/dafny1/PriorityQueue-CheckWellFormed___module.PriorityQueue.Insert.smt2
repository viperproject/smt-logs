...
(set-info :boogie-vc-id CheckWellFormed$$_module.PriorityQueue.Insert)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.Repr)))) (=> (and (and ($IsAllocBox ($Box refType this@@3) Tclass._module.PriorityQueue? $Heap@@1) (|_module.PriorityQueue.Valid#canCall| $Heap@@1 this@@3)) (and (_module.PriorityQueue.Valid $Heap@@1 this@@3) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.N)))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@20 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@20) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@20) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@20)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.Repr)) ($Box refType $o@@20))))
 :qid |PriorityQueuedfy.36:10|
 :skolemid |518|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@20))
))) (and (and ($HeapSucc $Heap@@1 $Heap@0) ($IsAllocBox ($Box refType this@@3) Tclass._module.PriorityQueue? $Heap@0)) (and (|_module.PriorityQueue.Valid#canCall| $Heap@0 this@@3) (_module.PriorityQueue.Valid $Heap@0 this@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@3 Tclass._module.PriorityQueue $Heap@@1)) (=> ($IsAlloc refType this@@3 Tclass._module.PriorityQueue $Heap@@1) (=> (and (forall (($o@@21 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.PriorityQueue.Repr)) ($Box refType $o@@21)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.Repr)) ($Box refType $o@@21)))) (or (not (= $o@@21 null)) (not true)))
 :qid |PriorityQueuedfy.39:24|
 :skolemid |519|
 :pattern (  (or (not (= $o@@21 null)) (not true)))
)) (forall (($o@@22 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.PriorityQueue.Repr)) ($Box refType $o@@22)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.Repr)) ($Box refType $o@@22)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@22) alloc)))))
 :qid |PriorityQueuedfy.39:24|
 :skolemid |520|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@3 Tclass._module.PriorityQueue $Heap@@1)) (=> ($IsAlloc refType this@@3 Tclass._module.PriorityQueue $Heap@@1) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.PriorityQueue.n))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.PriorityQueue.n))) 1)) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@3 Tclass._module.PriorityQueue $Heap@@1))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.PriorityQueue) ($IsAlloc refType this@@3 Tclass._module.PriorityQueue $Heap@@1))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
