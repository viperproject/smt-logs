...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__H2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|Set#Subset| |M#0| |S#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| (|Set#Union| |M#0| |S#0@@1|) |S#0@@1|)) (=> (|Set#Equal| (|Set#Union| |M#0| |S#0@@1|) |S#0@@1|) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| |h#0| ($Box SetType |S#0@@1|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |h#0| (TSet (TSet Tclass._module.G))) ($IsAlloc SetType |h#0| (TSet (TSet Tclass._module.G)) $Heap))) (and (and ($Is SetType |f#0@@1| (TSet (TSet Tclass._module.G))) ($IsAlloc SetType |f#0@@1| (TSet (TSet Tclass._module.G)) $Heap)) (and ($Is SetType |S#0@@1| (TSet Tclass._module.G)) ($IsAlloc SetType |S#0@@1| (TSet Tclass._module.G) $Heap)))) (and (and (and ($Is SetType |M#0| (TSet Tclass._module.G)) ($IsAlloc SetType |M#0| (TSet Tclass._module.G) $Heap)) (= 1 $FunctionContextHeight)) (and (and (|_module.__default.IsFilter#canCall| |f#0@@1| |S#0@@1|) (and (_module.__default.IsFilter |f#0@@1| |S#0@@1|) (and (and (and (forall ((|A#1@@0| T@U) (|B#1@@0| T@U) ) (!  (=> (and ($Is SetType |A#1@@0| (TSet Tclass._module.G)) ($Is SetType |B#1@@0| (TSet Tclass._module.G))) (=> (and (|Set#IsMember| |f#0@@1| ($Box SetType |A#1@@0|)) (|Set#Subset| |A#1@@0| |B#1@@0|)) (|Set#IsMember| |f#0@@1| ($Box SetType |B#1@@0|))))
 :qid |UltraFilterdfy.10:11|
 :skolemid |619|
...
))) (|Set#IsMember| |f#0@@1| ($Box SetType |S#0@@1|))) (not (|Set#IsMember| |f#0@@1| ($Box SetType (Lit SetType |Set#Empty|))))))) (and (forall ((|X#1| T@U) ) (!  (=> ($Is SetType |X#1| (TSet Tclass._module.G)) (= (|Set#IsMember| |h#0| ($Box SetType |X#1|)) (|Set#IsMember| |f#0@@1| ($Box SetType (|Set#Union| |M#0| |X#1|)))))
