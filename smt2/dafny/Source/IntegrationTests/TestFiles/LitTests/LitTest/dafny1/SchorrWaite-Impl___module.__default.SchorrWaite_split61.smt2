...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split61)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 43) (let ((anon132_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#16@0|)))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@@3))))
