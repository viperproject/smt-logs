...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.reverse)
...
(let ((anon10_Then_correct  (=> (= |xs#0@@7| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List)) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List)) (and (= |rest#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat) (= |t#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |rest#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |rest#Z#0@0|) (DtRank |xs#0@@7|)))))))
