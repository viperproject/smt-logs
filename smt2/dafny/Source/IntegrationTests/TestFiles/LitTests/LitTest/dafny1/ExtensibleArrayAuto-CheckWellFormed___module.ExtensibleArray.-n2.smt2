...
(assert (forall ((_module.ExtensibleArray$T@@19 T@U) ($h@@17 T@U) ($o@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@19)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) _module.ExtensibleArray.Contents)) (TSeq _module.ExtensibleArray$T@@19)))
 :qid |unknown.0:0|
 :skolemid |515|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@19) _module.ExtensibleArray.Contents)) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@19))
)))
(assert (forall ((_module.ExtensibleArray$T@@20 T@U) ($h@@18 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@20)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@20) _module.ExtensibleArray.elements)) (Tclass._System.array? _module.ExtensibleArray$T@@20)))
 :qid |unknown.0:0|
 :skolemid |517|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@20) _module.ExtensibleArray.elements)) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@20))
)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (forall ((_module.ExtensibleArray$T@@23 T@U) ($h@@19 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@23)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) _module.ExtensibleArray.more)) (Tclass._module.ExtensibleArray? (Tclass._System.array? _module.ExtensibleArray$T@@23))))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@21) _module.ExtensibleArray.more)) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@23))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.ExtensibleArray.Contents))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@23 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@23) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@23)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.ExtensibleArray.Repr)) ($Box refType $o@@23))))
 :qid |ExtensibleArrayAutodfy.61:10|
 :skolemid |607|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23))
))) (and (and ($HeapSucc $Heap@@1 $Heap@0) ($IsAllocBox ($Box refType this@@2) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@24) $Heap@0)) (and (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@24 $Heap@0 this@@2) (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@24 $Heap@0 this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24) $Heap@@1)) (=> ($IsAlloc refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24) $Heap@@1) (=> (and (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.ExtensibleArray.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.ExtensibleArray.Repr)) ($Box refType $o@@24)))) (or (not (= $o@@24 null)) (not true)))
 :qid |ExtensibleArrayAutodfy.61:10|
 :skolemid |608|
 :pattern (  (or (not (= $o@@24 null)) (not true)))
)) (forall (($o@@25 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) _module.ExtensibleArray.Repr)) ($Box refType $o@@25)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.ExtensibleArray.Repr)) ($Box refType $o@@25)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@25) alloc)))))
 :qid |ExtensibleArrayAutodfy.61:10|
 :skolemid |609|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24) $Heap@@1)) (=> ($IsAlloc refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24) $Heap@@1) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 |i#0@@0|) (< |i#0@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.ExtensibleArray.Contents)))))))))))))))
...
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#5| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.ExtensibleArray.Repr)))) ($IsAllocBox ($Box refType this@@2) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@24) $Heap@@1)) (and (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@24 $Heap@@1 this@@2) (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@24 $Heap@@1 this@@2))) (and (=> (= (ControlFlow 0 7) 5) anon4_Then_correct) (=> (= (ControlFlow 0 7) 6) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24)) ($IsAlloc refType this@@2 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@24) $Heap@@1)))) (and (and ($IsBox |t#0| _module.ExtensibleArray$T@@24) ($IsAllocBox |t#0| _module.ExtensibleArray$T@@24 $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
