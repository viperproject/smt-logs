...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma_split8)
...
(let ((|n#2@@2| (_module.List._h0 |ext##0_0_0@0|)))
 ...
 (=> (not (_module.Node.Element_q |n#2@@3|)) (U_2_bool (Lit boolType (bool_2_U false))))))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))))) (and (and (and (and (|_module.__default.ToSeq#canCall| _module._default.Lemma$X |nn#0_0_0@0|) (|_module.__default.ToSeq#canCall| _module._default.Lemma$X |ext##0_0_0@0|)) (and (|_module.__default.Flatten#canCall| _module._default.Lemma$X |nn#0_0_0@0| |ext##0_0_0@0|) (|_module.__default.ToSeq#canCall| _module._default.Lemma$X (_module.__default.Flatten _module._default.Lemma$X ($LS $LZ) |nn#0_0_0@0| |ext##0_0_0@0|)))) (and (|Seq#Equal| (|Seq#Append| (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) |nn#0_0_0@0|) (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) |ext##0_0_0@0|)) (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) (_module.__default.Flatten _module._default.Lemma$X ($LS ($LS $LZ)) |nn#0_0_0@0| |ext##0_0_0@0|))) (= $Heap@0 $Heap@2))) (and (and (or (< (DtRank |rest#0_0@0|) (DtRank |list#0@@12|)) (and (= (DtRank |rest#0_0@0|) (DtRank |list#0@@12|)) (< (DtRank |ext#0@@4|) (DtRank |ext#0@@4|)))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext#0@@4|)))) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (=> (_module.List.Nil_q |ext#0@@4|) (U_2_bool (Lit boolType (bool_2_U true))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
