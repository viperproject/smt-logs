...
(set-info :boogie-vc-id CheckWellFormed$$_module.IntegerInduction.Lemma__Auto)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 0) |n#0@@3|)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (= $Heap $Heap@0) ($IsAllocBox ($Box refType this@@3) Tclass._module.IntegerInduction? $Heap@0)) (and ($IsAlloc intType (int_2_U |n#0@@3|) TInt $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (<= (LitInt 0) |n#0@@3|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.IntegerInduction) ($IsAlloc refType this@@3 Tclass._module.IntegerInduction $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
