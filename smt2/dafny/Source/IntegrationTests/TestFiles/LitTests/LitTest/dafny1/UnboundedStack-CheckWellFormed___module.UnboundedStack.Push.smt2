...
(set-info :boogie-vc-id CheckWellFormed$$_module.UnboundedStack.Push)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@2 alloc this@@4)) ($IsAllocBox ($Box refType this@@4) (Tclass._module.UnboundedStack? _module.UnboundedStack$T@@17) $Heap@@2)) (and (|_module.UnboundedStack.IsUnboundedStack#canCall| _module.UnboundedStack$T@@17 $Heap@@2 this@@4) (_module.UnboundedStack.IsUnboundedStack _module.UnboundedStack$T@@17 $Heap@@2 this@@4))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@22 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@22) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@22) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@22)) (= $o@@22 this@@4)))
 :qid |UnboundedStackdfy.31:10|
 :skolemid |505|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@22))
)) ($HeapSucc $Heap@@2 $Heap@0))) (and (and ($IsAllocBox ($Box refType this@@4) (Tclass._module.UnboundedStack? _module.UnboundedStack$T@@17) $Heap@0) (|_module.UnboundedStack.IsUnboundedStack#canCall| _module.UnboundedStack$T@@17 $Heap@0 this@@4)) (and (_module.UnboundedStack.IsUnboundedStack _module.UnboundedStack$T@@17 $Heap@0 this@@4) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType this@@4 (Tclass._module.UnboundedStack _module.UnboundedStack$T@@17) $Heap@@2)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 (Tclass._module.UnboundedStack _module.UnboundedStack$T@@17)) ($IsAlloc refType this@@4 (Tclass._module.UnboundedStack _module.UnboundedStack$T@@17) $Heap@@2)))) (and (and ($IsBox |val#0| _module.UnboundedStack$T@@17) ($IsAllocBox |val#0| _module.UnboundedStack$T@@17 $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
