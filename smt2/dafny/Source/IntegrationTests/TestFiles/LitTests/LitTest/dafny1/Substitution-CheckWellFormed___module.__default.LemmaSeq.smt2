...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.LemmaSeq)
...
(let ((anon14_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (|Seq#Length| |q#0@@4|)))) (= (ControlFlow 0 7) 2)) anon9_correct)))
(let ((anon14_Then_correct  (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (|Seq#Length| |q#0@@4|))) (=> (and (and ($IsAlloc DatatypeTypeType |parent#0@@4| Tclass._module.Expression $Heap@0) ($IsAlloc SeqType |q#0@@4| (TSeq Tclass._module.Expression) $Heap@0)) (and ($IsAlloc intType (int_2_U |v#0@@9|) TInt $Heap@0) ($IsAlloc intType (int_2_U |val#0@@9|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((|a#3@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |a#3@@0| Tclass._module.Expression) (=> (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#3@@0|)) (< (DtRank |a#3@@0|) (DtRank |parent#0@@4|))))
 :qid |Substitutiondfy.66:20|
 :skolemid |656|
 :pattern ( (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#3@@0|)))
))) (=> (and (forall ((|a#3@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |a#3@@1| Tclass._module.Expression) (=> (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#3@@1|)) (< (DtRank |a#3@@1|) (DtRank |parent#0@@4|))))
 :qid |Substitutiondfy.66:20|
 :skolemid |657|
 :pattern ( (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#3@@1|)))
)) (|_module.__default.SubstSeq#canCall| |parent#0@@4| |q#0@@4| |v#0@@9| |val#0@@9|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |k#0@0|) (< |k#0@0| (|Seq#Length| (_module.__default.SubstSeq ($LS $LZ) |parent#0@@4| |q#0@@4| |v#0@@9| |val#0@@9|))))) (=> (and (<= 0 |k#0@0|) (< |k#0@0| (|Seq#Length| (_module.__default.SubstSeq ($LS $LZ) |parent#0@@4| |q#0@@4| |v#0@@9| |val#0@@9|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |q#0@@4|)))) (=> (and (<= 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |q#0@@4|))) (=> (and (= |##e#0@0| ($Unbox DatatypeTypeType (|Seq#Index| |q#0@@4| |k#0@0|))) ($IsAlloc DatatypeTypeType |##e#0@0| Tclass._module.Expression $Heap@0)) (=> (and (and ($IsAlloc intType (int_2_U |v#0@@9|) TInt $Heap@0) ($IsAlloc intType (int_2_U |val#0@@9|) TInt $Heap@0)) (and (|_module.__default.Substitute#canCall| ($Unbox DatatypeTypeType (|Seq#Index| |q#0@@4| |k#0@0|)) |v#0@@9| |val#0@@9|) (= (ControlFlow 0 3) 2))) anon9_correct))))))))))))
(let ((anon13_Else_correct  (=> (< |k#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 9) 3) anon14_Then_correct) (=> (= (ControlFlow 0 9) 7) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 8) 3) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon14_Else_correct)))))
...
(let ((anon4_correct  (=> (forall ((|a#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |a#1@@0| Tclass._module.Expression) (=> (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#1@@0|)) (< (DtRank |a#1@@0|) (DtRank |parent#0@@4|))))
 :qid |Substitutiondfy.101:20|
 :skolemid |653|
 :pattern ( (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#1@@0|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($IsAlloc DatatypeTypeType |parent#0@@4| Tclass._module.Expression $Heap@0) ($IsAlloc SeqType |q#0@@4| (TSeq Tclass._module.Expression) $Heap@0)) (and ($IsAlloc intType (int_2_U |v#0@@9|) TInt $Heap@0) ($IsAlloc intType (int_2_U |val#0@@9|) TInt $Heap@0)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall ((|a#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |a#2@@0| Tclass._module.Expression) (=> (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#2@@0|)) (< (DtRank |a#2@@0|) (DtRank |parent#0@@4|))))
 :qid |Substitutiondfy.66:20|
 :skolemid |654|
 :pattern ( (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#2@@0|)))
))) (=> (forall ((|a#2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |a#2@@1| Tclass._module.Expression) (=> (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#2@@1|)) (< (DtRank |a#2@@1|) (DtRank |parent#0@@4|))))
 :qid |Substitutiondfy.66:20|
 :skolemid |655|
 :pattern ( (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#2@@1|)))
)) (=> (and (|_module.__default.SubstSeq#canCall| |parent#0@@4| |q#0@@4| |v#0@@9| |val#0@@9|) (= (|Seq#Length| (_module.__default.SubstSeq ($LS $LZ) |parent#0@@4| |q#0@@4| |v#0@@9| |val#0@@9|)) (|Seq#Length| |q#0@@4|))) (and (=> (= (ControlFlow 0 11) 10) anon12_Then_correct) (=> (= (ControlFlow 0 11) 1) anon12_Else_correct)))))))))
(let ((anon11_Else_correct  (=> (and (not (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#0@0|))) (= (ControlFlow 0 15) 11)) anon4_correct)))
(let ((anon11_Then_correct  (=> (and (|Seq#Contains| |q#0@@4| ($Box DatatypeTypeType |a#0@0|)) (= (ControlFlow 0 14) 11)) anon4_correct)))
(let ((anon10_Then_correct  (=> (and ($Is DatatypeTypeType |a#0@0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |a#0@0| Tclass._module.Expression $Heap)) (and (=> (= (ControlFlow 0 16) 14) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |a#0@0| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |a#0@0| Tclass._module.Expression $Heap))) (= (ControlFlow 0 13) 11)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 17) 16) anon10_Then_correct) (=> (= (ControlFlow 0 17) 13) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |parent#0@@4| Tclass._module.Expression) ($IsAlloc DatatypeTypeType |parent#0@@4| Tclass._module.Expression $Heap)) (|$IsA#_module.Expression| |parent#0@@4|)) (and (and ($Is SeqType |q#0@@4| (TSeq Tclass._module.Expression)) ($IsAlloc SeqType |q#0@@4| (TSeq Tclass._module.Expression) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 18) 17)))) anon0_correct))))
