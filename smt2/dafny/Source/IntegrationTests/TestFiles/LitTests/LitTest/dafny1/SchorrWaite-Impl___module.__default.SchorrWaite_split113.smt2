...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split113)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 101) (let ((anon160_Then_correct  (=> (and (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#24@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.marked)))) (= |let#0#0#0| ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#24@0|) _module.Node.pathFromRoot)))) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Path) (= |pth#Z#0@0| |let#0#0#0|))) (and (and ($IsAllocBox ($Box DatatypeTypeType |pth#Z#0@0|) Tclass._module.Path $Heap@@3) ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3)) (and ($IsAlloc DatatypeTypeType |pth#Z#0@0| Tclass._module.Path $Heap@@3) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType |n#24@0| Tclass._module.Node $Heap@@3))))
