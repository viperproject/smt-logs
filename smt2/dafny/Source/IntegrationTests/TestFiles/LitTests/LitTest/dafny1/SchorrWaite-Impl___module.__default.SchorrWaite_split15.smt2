...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split15)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (and (and ($Is refType |root#0| Tclass._module.Node) ($IsAlloc refType |root#0| Tclass._module.Node $Heap)) (and ($Is SetType |S#0| (TSet Tclass._module.Node)) ($IsAlloc SetType |S#0| (TSet Tclass._module.Node) $Heap))) (and (and ($Is refType |t#0| Tclass._module.Node?) ($IsAlloc refType |t#0| Tclass._module.Node? $Heap)) true)) (and (and (and ($Is refType |p#0| Tclass._module.Node?) ($IsAlloc refType |p#0| Tclass._module.Node? $Heap)) true) (and (and ($Is DatatypeTypeType |path#0| Tclass._module.Path) ($IsAlloc DatatypeTypeType |path#0| Tclass._module.Path $Heap)) true))) (and (and (and (and ($Is SeqType |stackNodes#0| (TSeq Tclass._module.Node)) ($IsAlloc SeqType |stackNodes#0| (TSeq Tclass._module.Node) $Heap)) true) (and (and ($Is SetType |unmarkedNodes#0| (TSet Tclass._module.Node?)) ($IsAlloc SetType |unmarkedNodes#0| (TSet Tclass._module.Node?) $Heap)) true)) (and (and (and ($Is refType |oldP#0_0_0| Tclass._module.Node?) ($IsAlloc refType |oldP#0_0_0| Tclass._module.Node? $Heap)) true) (and (and ($Is refType |newT#0_1_1_0| Tclass._module.Node?) ($IsAlloc refType |newT#0_1_1_0| Tclass._module.Node? $Heap)) true)))) (and (and (and (and (and (= 4 $FunctionContextHeight) (|Set#IsMember| |S#0| ($Box refType |root#0|))) (and (forall ((|n#1| T@U) ) (!  (=> ($Is refType |n#1| Tclass._module.Node) (=> (|Set#IsMember| |S#0| ($Box refType |n#1|)) (forall ((|ch#2| T@U) ) (!  (=> ($Is refType |ch#2| Tclass._module.Node?) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#1|) _module.Node.children)) ($Box refType |ch#2|)) (or (= |ch#2| null) (|Set#IsMember| |S#0| ($Box refType |ch#2|)))))
...
)))) (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |S#0|)) (= |path#0@0| (Lit DatatypeTypeType |#_module.Path.Empty|))) (and (or (not (= |root#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.marked))))) (and (and (and (= |$rhs#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |root#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |root#0|) _module.Node.marked ($Box boolType (bool_2_U |$rhs#0@0|)))))) (and ($IsGoodHeap $Heap@0) (or (not (= |root#0| null)) (not true)))) (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.pathFromRoot)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |root#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.pathFromRoot ($Box DatatypeTypeType |path#0@0|))))) (and ($IsGoodHeap $Heap@1) (= |stackNodes#0@0| (Lit SeqType |Seq#Empty|)))))) (and (and (and (and (= |unmarkedNodes#0@0| (|Set#Difference| |S#0| (|Set#UnionOne| |Set#Empty| ($Box refType |root#0|)))) (= |$decr_init$loop#02@0| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |root#0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |root#0|) _module.Node.childrenVisited)))))) (and (=> |$w$loop#0@0| (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |stackNodes#0@0|))) (|Set#IsMember| |S#0| (|Seq#Index| |stackNodes#0@0| |i#1|)))
 :qid |SchorrWaitedfy.197:22|
 :skolemid |809|
 :pattern ( ($Unbox refType (|Seq#Index| |stackNodes#0@0| |i#1|)))
))) (=> |$w$loop#0@0| (|Set#IsMember| |S#0| ($Box refType |root#0|))))) (and (and (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@0| ($Box refType |root#0|)))) (=> |$w$loop#0@0| (= null (ite (= (|Seq#Length| |stackNodes#0@0|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@0| (- (|Seq#Length| |stackNodes#0@0|) 1))))))) (and (=> |$w$loop#0@0| (forall ((|n#11| T@U) ) (!  (=> ($Is refType |n#11| Tclass._module.Node) (=> (|Seq#Contains| |stackNodes#0@0| ($Box refType |n#11|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#11|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#11|) _module.Node.children))))))
