...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split135)
...
))))))))) (and (and (and (and (and (and (=> |$w$loop#0@0| (forall ((|n#27| T@U) ) (!  (=> ($Is refType |n#27| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#27|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#27|) _module.Node.marked)))) (_module.__default.Reachable $Heap@@3 |root#0| |n#27| |S#0@@5|)))
