...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split79)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 53) (let ((anon136_Then_correct  (=> (and (and (< 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (- |k#0@0| 1)) (< (- |k#0@0| 1) (|Seq#Length| |stackNodes#0@1|))))))
