...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@5 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3|) $o@@5 $f))  (=> (and (or (not (= $o@@5 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |611|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3|) $o@@5 $f))
)))
...
(declare-fun _module._default.PrintMatrix$T () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon13_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (<= 0 |$decr$loop#0_00@2|) (= (- (_System.array2.Length1 |m#0|) |j#0_0@3|) |$decr$loop#0_00@2|))) (=> (or (<= 0 |$decr$loop#0_00@2|) (= (- (_System.array2.Length1 |m#0|) |j#0_0@3|) |$decr$loop#0_00@2|)) (=> (= (ControlFlow 0 12) (- 0 11)) (< (- (_System.array2.Length1 |m#0|) |j#0_0@3|) |$decr$loop#0_00@2|))))))
(let ((anon21_Else_correct  (=> (and (or (not (= |j#0_0@3| (_System.array2.Length1 |m#0|))) (not true)) (= (ControlFlow 0 15) 12)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (= |j#0_0@3| (_System.array2.Length1 |m#0|)) (= (ControlFlow 0 14) 12)) anon13_correct)))
(let ((anon20_Else_correct  (=> (and (< |j#0_0@2| (_System.array2.Length1 |m#0|)) (= |$decr$loop#0_00@2| (- (_System.array2.Length1 |m#0|) |j#0_0@2|))) (and (=> (= (ControlFlow 0 16) (- 0 20)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array2.Length0 |m#0|)))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (and (<= 0 |j#0_0@2|) (< |j#0_0@2| (_System.array2.Length1 |m#0|)))) (=> (= |j#0_0@3| (+ |j#0_0@2| 1)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 16) 14) anon21_Then_correct) (=> (= (ControlFlow 0 16) 15) anon21_Else_correct))))))))))))
(let ((anon20_Then_correct  (=> (and (<= (_System.array2.Length1 |m#0|) |j#0_0@2|) (= |i#0@2| (+ |i#0@1| 1))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (<= 0 |$decr$loop#00@1|) (= (- (_System.array2.Length0 |m#0|) |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- (_System.array2.Length0 |m#0|) |i#0@2|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 9) (- 0 8)) (< (- (_System.array2.Length0 |m#0|) |i#0@2|) |$decr$loop#00@1|)))))))
(let ((anon19_Else_correct  (=> |$w$loop#0_0@1| (and (=> (= (ControlFlow 0 21) (- 0 22)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 21) 9) anon20_Then_correct) (=> (= (ControlFlow 0 21) 16) anon20_Else_correct)))))))
(let ((anon19_Then_correct  (=> (and (not |$w$loop#0_0@1|) (= (ControlFlow 0 7) (- 0 6))) (or (not (= |m#0| null)) (not true)))))
(let ((anon18_LoopBody_correct  (and (=> (= (ControlFlow 0 23) 7) anon19_Then_correct) (=> (= (ControlFlow 0 23) 21) anon19_Else_correct))))
(let ((anon18_LoopDone_correct true))
(let ((anon18_LoopHead_correct  (=> (and (and (and (and (not false) (<= 0 |i#0@1|)) |$w$loop#0@0|) (<= 0 |j#0_0@2|)) (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |MatrixFundfy.88:5|
 :skolemid |608|
...
)) (<= (- (_System.array2.Length1 |m#0|) |j#0_0@2|) |$decr_init$loop#0_00@1|)))) (and (=> (= (ControlFlow 0 24) 5) anon18_LoopDone_correct) (=> (= (ControlFlow 0 24) 23) anon18_LoopBody_correct)))))
(let ((anon17_Else_correct  (=> (< |i#0@1| (_System.array2.Length0 |m#0|)) (=> (and (and (= |$decr$loop#00@1| (- (_System.array2.Length0 |m#0|) |i#0@1|)) (= |j#0_0@1| (LitInt 0))) (and (= |$decr_init$loop#0_00@1| (- (_System.array2.Length1 |m#0|) |j#0_0@1|)) (= (ControlFlow 0 25) 24))) anon18_LoopHead_correct))))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 26) (- 0 27)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 26) 4) anon17_Then_correct) (=> (= (ControlFlow 0 26) 25) anon17_Else_correct)))))))
(let ((anon16_Then_correct  (=> (and (not |$w$loop#0@0|) (= (ControlFlow 0 3) (- 0 2))) (or (not (= |m#0| null)) (not true)))))
(let ((anon15_LoopBody_correct  (and (=> (= (ControlFlow 0 28) 3) anon16_Then_correct) (=> (= (ControlFlow 0 28) 26) anon16_Else_correct))))
(let ((anon15_LoopDone_correct true))
(let ((anon15_LoopHead_correct  (=> (and (not false) (<= 0 |i#0@1|)) (=> (and (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8)))
 :qid |MatrixFundfy.86:3|
 :skolemid |606|
...
)) (<= (- (_System.array2.Length0 |m#0|) |i#0@1|) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 29) 1) anon15_LoopDone_correct) (=> (= (ControlFlow 0 29) 28) anon15_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc false)) (= |i#0@0| (LitInt 0))) (and (= |$decr_init$loop#00@0| (- (_System.array2.Length0 |m#0|) |i#0@0|)) (= (ControlFlow 0 30) 29))) anon15_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |m#0| (Tclass._System.array2 _module._default.PrintMatrix$T)) ($IsAlloc refType |m#0| (Tclass._System.array2 _module._default.PrintMatrix$T) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 31) 30))) anon0_correct))))
