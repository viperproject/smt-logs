...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split99)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 86) (let ((anon155_Then_correct  (=> (and (and (<= (LitInt 0) |j#2@0|) (< |j#2@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#20@0|) _module.Node.childrenVisited))))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |n#20@0| null)) (not true)))))
