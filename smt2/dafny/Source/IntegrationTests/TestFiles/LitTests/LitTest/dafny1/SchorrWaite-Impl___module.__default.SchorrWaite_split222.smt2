...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split222)
...
))))) (and (and (=> |$w$loop#0@0| (|Set#IsMember| |S#0@@5| ($Box refType |t#0@1|))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|)))))) (not (|Seq#Contains| |stackNodes#0@4| ($Box refType |t#0@1|)))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
