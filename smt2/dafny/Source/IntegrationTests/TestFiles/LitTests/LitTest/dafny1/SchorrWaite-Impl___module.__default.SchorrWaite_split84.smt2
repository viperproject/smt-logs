...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split84)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 58) (let ((anon139_Then_correct  (=> (and (and (<= (LitInt 0) |k#2@0|) (< |k#2@0| (- (|Seq#Length| |stackNodes#0@1|) 1))) (and ($IsAlloc refType ($Unbox refType (|Seq#Index| |stackNodes#0@1| |k#2@0|)) Tclass._module.Node $Heap@@3) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= ($Unbox refType (|Seq#Index| |stackNodes#0@1| |k#2@0|)) null)) (not true)))))
