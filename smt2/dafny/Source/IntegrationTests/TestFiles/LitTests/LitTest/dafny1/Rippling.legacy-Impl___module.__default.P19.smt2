...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.len#canCall| |xs#0@@1|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|ys#1| (_module.List._h2 |xs#0@@1|)))
(|_module.__default.len#canCall| |ys#1|))) (= (_module.__default.len ($LS $ly@@1) |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) |#_module.Nat.Zero| (let ((|ys#0| (_module.List._h2 |xs#0@@1|)))
(|#_module.Nat.Suc| (_module.__default.len $ly@@1 |ys#0|)))))))
 :qid |Ripplinglegacydfy.139:16|
 :skolemid |681|
 :pattern ( (_module.__default.len ($LS $ly@@1) |xs#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|x#0| T@U) (|y#0| T@U) ) (!  (=> (or (|_module.__default.minus#canCall| |x#0| |y#0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0| Tclass._module.Nat) ($Is DatatypeTypeType |y#0| Tclass._module.Nat)))) ($Is DatatypeTypeType (_module.__default.minus $ly@@2 |x#0| |y#0|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.41:16|
 :skolemid |600|
 :pattern ( (_module.__default.minus $ly@@2 |x#0| |y#0|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|n#0@@1| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.drop#canCall| |n#0@@1| |xs#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.drop $ly@@3 |n#0@@1| |xs#0@@2|) Tclass._module.List))
 :qid |Ripplinglegacydfy.121:16|
 :skolemid |665|
 :pattern ( (_module.__default.drop $ly@@3 |n#0@@1| |xs#0@@2|))
))))
(assert (forall (($ly@@4 T@U) (|x#0@@0| T@U) (|y#0@@0| T@U) ) (! (= (_module.__default.minus ($LS $ly@@4) |x#0@@0| |y#0@@0|) (_module.__default.minus $ly@@4 |x#0@@0| |y#0@@0|))
 :qid |Ripplinglegacydfy.41:16|
 :skolemid |598|
 :pattern ( (_module.__default.minus ($LS $ly@@4) |x#0@@0| |y#0@@0|))
)))
(assert (forall (($ly@@5 T@U) (|n#0@@2| T@U) (|xs#0@@3| T@U) ) (! (= (_module.__default.drop ($LS $ly@@5) |n#0@@2| |xs#0@@3|) (_module.__default.drop $ly@@5 |n#0@@2| |xs#0@@3|))
 :qid |Ripplinglegacydfy.121:16|
 :skolemid |663|
 :pattern ( (_module.__default.drop ($LS $ly@@5) |n#0@@2| |xs#0@@3|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@6 T@U) (|x#0@@1| T@U) (|y#0@@1| T@U) ) (!  (=> (or (|_module.__default.minus#canCall| (Lit DatatypeTypeType |x#0@@1|) (Lit DatatypeTypeType |y#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@1| Tclass._module.Nat)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType |x#0@@1|)))))) (let ((|a#3| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |x#0@@1|)))))
...
(|_module.__default.minus#canCall| |a#3| |b#3|))))) (= (_module.__default.minus ($LS $ly@@6) (Lit DatatypeTypeType |x#0@@1|) (Lit DatatypeTypeType |y#0@@1|)) (ite (_module.Nat.Zero_q (Lit DatatypeTypeType |x#0@@1|)) |#_module.Nat.Zero| (let ((|a#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |x#0@@1|)))))
(ite (_module.Nat.Zero_q (Lit DatatypeTypeType |y#0@@1|)) |x#0@@1| (let ((|b#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |y#0@@1|)))))
(Lit DatatypeTypeType (_module.__default.minus ($LS $ly@@6) |a#2| |b#2|)))))))))
 :qid |Ripplinglegacydfy.41:16|
 :weight 3
 :skolemid |603|
 :pattern ( (_module.__default.minus ($LS $ly@@6) (Lit DatatypeTypeType |x#0@@1|) (Lit DatatypeTypeType |y#0@@1|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@7 T@U) (|x#0@@2| T@U) (|y#0@@2| T@U) ) (!  (=> (or (|_module.__default.minus#canCall| |x#0@@2| |y#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@2| Tclass._module.Nat)))) (and (=> (not (_module.Nat.Zero_q |x#0@@2|)) (let ((|a#1| (_module.Nat._h0 |x#0@@2|)))
 (=> (not (_module.Nat.Zero_q |y#0@@2|)) (let ((|b#1| (_module.Nat._h0 |y#0@@2|)))
(|_module.__default.minus#canCall| |a#1| |b#1|))))) (= (_module.__default.minus ($LS $ly@@7) |x#0@@2| |y#0@@2|) (ite (_module.Nat.Zero_q |x#0@@2|) |#_module.Nat.Zero| (let ((|a#0| (_module.Nat._h0 |x#0@@2|)))
(ite (_module.Nat.Zero_q |y#0@@2|) |x#0@@2| (let ((|b#0| (_module.Nat._h0 |y#0@@2|)))
(_module.__default.minus $ly@@7 |a#0| |b#0|))))))))
 :qid |Ripplinglegacydfy.41:16|
 :skolemid |602|
 :pattern ( (_module.__default.minus ($LS $ly@@7) |x#0@@2| |y#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@8 T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.len#canCall| |xs#0@@4|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@4| Tclass._module.List))) ($Is DatatypeTypeType (_module.__default.len $ly@@8 |xs#0@@4|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.139:16|
 :skolemid |679|
 :pattern ( (_module.__default.len $ly@@8 |xs#0@@4|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@9 T@U) (|xs#0@@5| T@U) ) (!  (=> (or (|_module.__default.len#canCall| (Lit DatatypeTypeType |xs#0@@5|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@5| Tclass._module.List))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@5|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@5|)))))
(|_module.__default.len#canCall| |ys#3|))) (= (_module.__default.len ($LS $ly@@9) (Lit DatatypeTypeType |xs#0@@5|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@5|)) |#_module.Nat.Zero| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@5|)))))
(Lit DatatypeTypeType (|#_module.Nat.Suc| (Lit DatatypeTypeType (_module.__default.len ($LS $ly@@9) |ys#2|)))))))))
 :qid |Ripplinglegacydfy.139:16|
 :weight 3
 :skolemid |682|
...
(set-info :boogie-vc-id Impl$$_module.__default.P19)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|n#1| T@U) (|xs#1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |n#1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#1| Tclass._module.List)) (|_module.Nat#Equal| (_module.__default.len ($LS ($LS $LZ)) (_module.__default.drop ($LS ($LS $LZ)) |n#1| |xs#1|)) (_module.__default.minus ($LS ($LS $LZ)) (_module.__default.len ($LS ($LS $LZ)) |xs#1|) |n#1|)))
 :qid |Ripplinglegacydfy.395:18|
 :skolemid |943|
 :pattern ( (_module.__default.minus ($LS ($LS $LZ)) (_module.__default.len ($LS ($LS $LZ)) |xs#1|) |n#1|))
