...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split202)
...
)) (= (ControlFlow 0 2) (- 0 1))))))))) (forall ((|n#7| T@U) ) (!  (=> ($Is refType |n#7| Tclass._module.Node) (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#7|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |n#7|) _module.Node.marked)))) (_module.__default.Reachable $Heap@@3 |root#0| |n#7| |S#0@@5|)))
 :qid |SchorrWaitedfy.182:18|
 :skolemid |804|
 :pattern ( (_module.__default.Reachable $Heap@@3 |root#0| |n#7| |S#0@@5|))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |n#7|) _module.Node.marked)))
