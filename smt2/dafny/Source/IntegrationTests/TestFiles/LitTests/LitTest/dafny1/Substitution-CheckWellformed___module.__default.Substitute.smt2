...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Substitute)
...
(let ((anon13_Then_correct  (=> (and (and (= |e#0@@4| (|#_module.Expression.Var| |_mcc#1#0|)) (= |let#2#0#0| |_mcc#1#0|)) (and ($Is intType (int_2_U |let#2#0#0|) TInt) (= |x#Z#0@0| |let#2#0#0|))) (and (=> (= (ControlFlow 0 10) 8) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct)))))
(let ((anon15_Else_correct true))
(let ((anon15_Then_correct  (=> (and (and (= |e#0@@4| (|#_module.Expression.Nary| |_mcc#2#0| |_mcc#3#0|)) ($Is SeqType |_mcc#3#0| (TSeq Tclass._module.Expression))) (and (= |let#0#0#0| |_mcc#3#0|) ($Is SeqType |let#0#0#0| (TSeq Tclass._module.Expression)))) (=> (and (and (and (= |args#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#2#0|)) (and ($Is intType (int_2_U |let#1#0#0|) TInt) (= |op#Z#0@0| |let#1#0#0|))) (and (and ($IsAlloc DatatypeTypeType |e#0@@4| Tclass._module.Expression $Heap) ($IsAlloc SeqType |args#Z#0@0| (TSeq Tclass._module.Expression) $Heap)) (and ($IsAlloc intType (int_2_U |v#0@@9|) TInt $Heap) ($IsAlloc intType (int_2_U |val#0@@9|) TInt $Heap)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (forall ((|a#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |a#0@@0| Tclass._module.Expression) (=> (|Seq#Contains| |args#Z#0@0| ($Box DatatypeTypeType |a#0@@0|)) (< (DtRank |a#0@@0|) (DtRank |e#0@@4|))))
 :qid |Substitutiondfy.66:20|
 :skolemid |619|
 :pattern ( (|Seq#Contains| |args#Z#0@0| ($Box DatatypeTypeType |a#0@@0|)))
))) (=> (and (forall ((|a#0@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |a#0@@1| Tclass._module.Expression) (=> (|Seq#Contains| |args#Z#0@0| ($Box DatatypeTypeType |a#0@@1|)) (< (DtRank |a#0@@1|) (DtRank |e#0@@4|))))
 :qid |Substitutiondfy.66:20|
 :skolemid |620|
 :pattern ( (|Seq#Contains| |args#Z#0@0| ($Box DatatypeTypeType |a#0@@1|)))
)) (= (ControlFlow 0 4) (- 0 3))) (<= (DtRank |e#0@@4|) (DtRank |e#0@@4|))))))))
(let ((anon13_Else_correct  (=> (or (not (= |e#0@@4| (|#_module.Expression.Var| |_mcc#1#0|))) (not true)) (and (=> (= (ControlFlow 0 7) 4) anon15_Then_correct) (=> (= (ControlFlow 0 7) 6) anon15_Else_correct)))))
(let ((anon12_Else_correct  (=> (or (not (= |e#0@@4| (|#_module.Expression.Const| |_mcc#0#0|))) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon13_Then_correct) (=> (= (ControlFlow 0 11) 7) anon13_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |e#0@@4| Tclass._module.Expression)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct)))
