...
(assert (forall (($h@@4 T@U) ($o@@2 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass._module.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) alloc)))) ($IsAlloc boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) _module.Node.marked)) TBool $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |883|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) _module.Node.marked)))
)))
...
(assert (forall (($h@@5 T@U) ($o@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass._module.Node?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@3) _module.Node.childrenVisited)) Tclass._System.nat))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |884|
...
(assert (forall (($h@@6 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.Node?))) ($Is DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@4) _module.Node.pathFromRoot)) Tclass._module.Path))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |886|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@4) _module.Node.pathFromRoot)))
)))
...
(assert (forall (($h@@7 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@5) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@5) _module.Node.childrenVisited)) Tclass._System.nat $h@@7))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |885|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@5) _module.Node.childrenVisited)))
)))
(assert (forall (($h@@8 T@U) ($o@@6 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) Tclass._module.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@6) alloc)))) ($IsAlloc DatatypeTypeType ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@6) _module.Node.pathFromRoot)) Tclass._module.Path $h@@8))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |887|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@6) _module.Node.pathFromRoot)))
)))
...
(assert (forall (($h@@9 T@U) ($o@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) Tclass._module.Node?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@7) _module.Node.children)) (TSeq Tclass._module.Node?)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |880|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@7) _module.Node.children)))
)))
(assert (forall (($h@@10 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass._module.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@8) alloc)))) ($IsAlloc SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@8) _module.Node.children)) (TSeq Tclass._module.Node?) $h@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |881|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@8) _module.Node.children)))
)))
...
(assert (forall (($ly@@2 T@U) ($Heap@@1 T@U) (|source#0@@2| T@U) (|p#0@@2| T@U) (|sink#0@@2| T@U) (|S#0@@2| T@U) ) (! (= (_module.__default.ReachableVia ($LS $ly@@2) $Heap@@1 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2|) (_module.__default.ReachableVia $ly@@2 $Heap@@1 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2|))
 :qid |SchorrWaitedfy.160:17|
 :skolemid |767|
 :pattern ( (_module.__default.ReachableVia ($LS $ly@@2) $Heap@@1 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2|))
)))
...
(assert (forall (($h@@11 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass._module.Node?))) ($Is boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@9) _module.Node.marked)) TBool))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |882|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@9) _module.Node.marked)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@10 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@10 $f@@0))  (=> (and (or (not (= $o@@10 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@10) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@10))))
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split24)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is refType |root#0| Tclass._module.Node) ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@2)) (and ($Is SetType |S#0@@3| (TSet Tclass._module.Node)) ($IsAlloc SetType |S#0@@3| (TSet Tclass._module.Node) $Heap@@2))) (=> (and (and (and ($Is refType |t#0| Tclass._module.Node?) ($IsAlloc refType |t#0| Tclass._module.Node? $Heap@@2)) true) (and (and ($Is refType |p#0@@3| Tclass._module.Node?) ($IsAlloc refType |p#0@@3| Tclass._module.Node? $Heap@@2)) true)) (=> (and (and (and (and ($Is DatatypeTypeType |path#0| Tclass._module.Path) ($IsAlloc DatatypeTypeType |path#0| Tclass._module.Path $Heap@@2)) true) (and (and ($Is SeqType |stackNodes#0| (TSeq Tclass._module.Node)) ($IsAlloc SeqType |stackNodes#0| (TSeq Tclass._module.Node) $Heap@@2)) true)) (and (and (and ($Is SetType |unmarkedNodes#0| (TSet Tclass._module.Node?)) ($IsAlloc SetType |unmarkedNodes#0| (TSet Tclass._module.Node?) $Heap@@2)) true) (and (and ($Is refType |oldP#0_0_0| Tclass._module.Node?) ($IsAlloc refType |oldP#0_0_0| Tclass._module.Node? $Heap@@2)) true))) (=> (and (and (and (and (and (and ($Is refType |newT#0_1_1_0| Tclass._module.Node?) ($IsAlloc refType |newT#0_1_1_0| Tclass._module.Node? $Heap@@2)) true) (= 4 $FunctionContextHeight)) (and (and (|Set#IsMember| |S#0@@3| ($Box refType |root#0|)) (forall ((|n#1@@0| T@U) ) (!  (=> ($Is refType |n#1@@0| Tclass._module.Node) (=> (|Set#IsMember| |S#0@@3| ($Box refType |n#1@@0|)) (forall ((|ch#2| T@U) ) (!  (=> ($Is refType |ch#2| Tclass._module.Node?) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#1@@0|) _module.Node.children)) ($Box refType |ch#2|)) (or (= |ch#2| null) (|Set#IsMember| |S#0@@3| ($Box refType |ch#2|)))))
 :qid |SchorrWaitedfy.173:22|
 :skolemid |798|
 :pattern ( (|Set#IsMember| |S#0@@3| ($Box refType |ch#2|)))
 :pattern ( (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#1@@0|) _module.Node.children)) ($Box refType |ch#2|)))
))))
 :qid |SchorrWaitedfy.172:19|
 :skolemid |799|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#1@@0|) _module.Node.children)))
 :pattern ( (|Set#IsMember| |S#0@@3| ($Box refType |n#1@@0|)))
))) (and (forall ((|n#3| T@U) ) (!  (=> ($Is refType |n#3| Tclass._module.Node) (and (=> (|Set#IsMember| |S#0@@3| ($Box refType |n#3|)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#3|) _module.Node.marked))))) (=> (|Set#IsMember| |S#0@@3| ($Box refType |n#3|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#3|) _module.Node.childrenVisited))) (LitInt 0)))))
 :qid |SchorrWaitedfy.175:19|
 :skolemid |800|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#3|) _module.Node.childrenVisited)))
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#3|) _module.Node.marked)))
 :pattern ( (|Set#IsMember| |S#0@@3| ($Box refType |n#3|)))
)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc |S#0@@3|))))) (and (and (and (= |path#0@0| (Lit DatatypeTypeType |#_module.Path.Empty|)) (or (not (= |root#0| null)) (not true))) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.marked)) (= |$rhs#0@0| (U_2_bool (Lit boolType (bool_2_U true)))))) (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@2 |root#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |root#0|) _module.Node.marked ($Box boolType (bool_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (or (not (= |root#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |root#0| _module.Node.pathFromRoot)))))) (and (and (and (and (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |root#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.pathFromRoot ($Box DatatypeTypeType |path#0@0|)))) ($IsGoodHeap $Heap@1)) (and (= |stackNodes#0@0| (Lit SeqType |Seq#Empty|)) (= |unmarkedNodes#0@0| (|Set#Difference| |S#0@@3| (|Set#UnionOne| |Set#Empty| ($Box refType |root#0|)))))) (and (and (= |$decr_init$loop#02@0| (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |root#0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |root#0|) _module.Node.childrenVisited))))) (=> |$w$loop#0@0| (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |stackNodes#0@0|))) (|Set#IsMember| |S#0@@3| (|Seq#Index| |stackNodes#0@0| |i#1|)))
 :qid |SchorrWaitedfy.197:22|
 :skolemid |809|
 :pattern ( ($Unbox refType (|Seq#Index| |stackNodes#0@0| |i#1|)))
)))) (and (=> |$w$loop#0@0| (|Set#IsMember| |S#0@@3| ($Box refType |root#0|))) (=> |$w$loop#0@0| (not (|Seq#Contains| |stackNodes#0@0| ($Box refType |root#0|))))))) (and (and (and (=> |$w$loop#0@0| (= null (ite (= (|Seq#Length| |stackNodes#0@0|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@0| (- (|Seq#Length| |stackNodes#0@0|) 1)))))) (=> |$w$loop#0@0| (forall ((|n#11| T@U) ) (!  (=> ($Is refType |n#11| Tclass._module.Node) (=> (|Seq#Contains| |stackNodes#0@0| ($Box refType |n#11|)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#11|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#11|) _module.Node.children))))))
 ...
 :pattern ( (|Set#IsMember| |S#0@@3| ($Box refType |n#13|)))
 ...
 :pattern ( (|Set#IsMember| |S#0@@3| ($Box refType |n#17|)))
...
))))))) (and (and (and (and (=> |$w$loop#0@0| (forall ((|k#3| Int) ) (!  (=> (and (<= (LitInt 0) |k#3|) (< |k#3| (- (|Seq#Length| |stackNodes#0@0|) 1))) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (|Seq#Index| |stackNodes#0@0| |k#3|))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (|Seq#Index| |stackNodes#0@0| |k#3|))) _module.Node.childrenVisited))))) ($Unbox refType (|Seq#Index| |stackNodes#0@0| (+ |k#3| 1)))))
...
))) (=> |$w$loop#0@0| (=> (< 0 (|Seq#Length| |stackNodes#0@0|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (|Seq#Index| |stackNodes#0@0| (- (|Seq#Length| |stackNodes#0@0|) 1)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (|Seq#Index| |stackNodes#0@0| (- (|Seq#Length| |stackNodes#0@0|) 1)))) _module.Node.childrenVisited))))) |root#0|)))) (and (=> |$w$loop#0@0| (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |root#0|) _module.Node.marked)))) (=> |$w$loop#0@0| (forall ((|n#19| T@U) ) (!  (=> ($Is refType |n#19| Tclass._module.Node) (=> (and (and (and (|Set#IsMember| |S#0@@3| ($Box refType |n#19|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#19|) _module.Node.marked)))) (not (|Seq#Contains| |stackNodes#0@0| ($Box refType |n#19|)))) (or (not (= |n#19| |root#0|)) (not true))) (forall ((|ch#7| T@U) ) (!  (=> ($Is refType |ch#7| Tclass._module.Node?) (=> (and (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |n#19|) _module.Node.children)) ($Box refType |ch#7|)) (or (not (= |ch#7| null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |ch#7|) _module.Node.marked)))))
 ...
 :pattern ( (|Set#IsMember| |S#0@@3| ($Box refType |n#19|)))
...
)))) (and (=> |$w$loop#0@0| ($IsAllocBox ($Box DatatypeTypeType |path#0@0|) Tclass._module.Path $Heap@@2)) (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (_module.Path.Empty_q |path#0@0|) (= |root#0| |root#0|)))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22| (_module.Path._h1 |path#0@0|)))
(|Set#IsMember| |S#0@@3| ($Box refType |n#22|))))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|))))) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22@@0| (_module.Path._h1 |path#0@0|)))
(|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#22@@0|) _module.Node.children)) ($Box refType |root#0|))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
