...
(assert (forall ((d@@5 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (_module.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.List $h))) ($IsAlloc intType (int_2_U (_module.List._h0 d@@5)) TInt $h))
 :qid |unknown.0:0|
 :skolemid |573|
 :pattern ( ($IsAlloc intType (int_2_U (_module.List._h0 d@@5)) TInt $h))
)))
...
(assert (forall ((d@@7 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.List.Cons_q d@@7) ($IsAlloc DatatypeTypeType d@@7 Tclass._module.List $h@@1))) ($IsAlloc DatatypeTypeType (_module.List._h1 d@@7) Tclass._module.List $h@@1))
 :qid |unknown.0:0|
 :skolemid |574|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h1 d@@7) Tclass._module.List $h@@1))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.QuantifierOnly)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (and (forall ((|xs#1| T@U) ) (!  (=> ($Is DatatypeTypeType |xs#1| Tclass._module.List) (and (and (|$IsA#_module.List| (_module.__default.Append ($LS $LZ) |xs#1| (Lit DatatypeTypeType |#_module.List.Nil|))) (|$IsA#_module.List| |xs#1|)) (|_module.__default.Append#canCall| |xs#1| (Lit DatatypeTypeType |#_module.List.Nil|))))
 :qid |InductionOptionslegacydfy.25:17|
 :skolemid |540|
 :pattern ( (_module.__default.Append ($LS $LZ) |xs#1| |#_module.List.Nil|))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|xs#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |xs#1@@0| Tclass._module.List) (|_module.List#Equal| (_module.__default.Append ($LS ($LS $LZ)) |xs#1@@0| (Lit DatatypeTypeType |#_module.List.Nil|)) |xs#1@@0|))
 :qid |InductionOptionslegacydfy.25:17|
 :skolemid |541|
 :pattern ( (_module.__default.Append ($LS ($LS $LZ)) |xs#1@@0| |#_module.List.Nil|))
)))))
(let ((anon3_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |xs#0@0| Tclass._module.List) ($IsAlloc DatatypeTypeType |xs#0@0| Tclass._module.List $Heap))) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |xs#0@0| Tclass._module.List) ($IsAlloc DatatypeTypeType |xs#0@0| Tclass._module.List $Heap)) ($IsAlloc DatatypeTypeType |xs#0@0| Tclass._module.List $Heap)) (and (and (= |##ys#0@0| (Lit DatatypeTypeType |#_module.List.Nil|)) ($IsAlloc DatatypeTypeType |##ys#0@0| Tclass._module.List $Heap)) (and (|_module.__default.Append#canCall| |xs#0@0| (Lit DatatypeTypeType |#_module.List.Nil|)) (= (ControlFlow 0 3) 2)))) anon2_correct)))
