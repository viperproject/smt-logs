...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.leq)
...
(let ((anon15_Then_correct  (=> (and (and (and (= |y#0@@3| (|#_module.Nat.Suc| |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.Nat)) (and (= |let#1#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat))) (and (and (= |b#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |a#Z#0@0| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |b#Z#0@0| Tclass._module.Nat $Heap) (= (ControlFlow 0 6) (- 0 5))))) (or (< (DtRank |a#Z#0@0|) (DtRank |x#0@@3|)) (and (= (DtRank |a#Z#0@0|) (DtRank |x#0@@3|)) (< (DtRank |b#Z#0@0|) (DtRank |y#0@@3|)))))))
(let ((anon14_Else_correct  (=> (or (not (= |y#0@@3| |#_module.Nat.Zero|)) (not true)) (and (=> (= (ControlFlow 0 8) 6) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct)))))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct  (=> (= |x#0@@3| (|#_module.Nat.Suc| |_mcc#0#0|)) (=> (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat) (= |let#0#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Nat) (= |a#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 9) 4) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (or (not (= |x#0@@3| |#_module.Nat.Zero|)) (not true)) (and (=> (= (ControlFlow 0 10) 9) anon13_Then_correct) (=> (= (ControlFlow 0 10) 3) anon13_Else_correct)))))
