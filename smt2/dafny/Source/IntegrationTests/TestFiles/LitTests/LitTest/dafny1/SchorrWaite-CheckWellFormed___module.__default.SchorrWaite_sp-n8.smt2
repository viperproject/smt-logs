...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SchorrWaite_split7)
...
)) (=> (and (and ($Is refType |n#6@0| Tclass._module.Node) ($IsAlloc refType |n#6@0| Tclass._module.Node $Heap@0)) (and (|Set#IsMember| |S#0| ($Box refType |n#6@0|)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |n#6@0| null)) (not true))))))
