...
(declare-fun |_module.__default.apply#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly T@U) ($Heap T@U) (|f#0| T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.apply#canCall| (Lit HandleTypeType |f#0|) (Lit DatatypeTypeType |xs#0|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0|)))))) (let ((|ys#5| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0|)))))
(|_module.__default.apply#canCall| (Lit HandleTypeType |f#0|) |ys#5|))) (= (_module.__default.apply ($LS $ly) (Lit HandleTypeType |f#0|) (Lit DatatypeTypeType |xs#0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0|)) |#_module.List.Nil| (let ((|ys#4| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0|)))))
(let ((|y#4| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0|)))))
(|#_module.List.Cons| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap (Lit HandleTypeType |f#0|) ($Box DatatypeTypeType |y#4|))) (Lit DatatypeTypeType (_module.__default.apply ($LS $ly) (Lit HandleTypeType |f#0|) |ys#4|)))))))))
 :qid |Ripplinglegacydfy.163:16|
 :weight 3
 :skolemid |705|
 :pattern ( (_module.__default.apply ($LS $ly) (Lit HandleTypeType |f#0|) (Lit DatatypeTypeType |xs#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap@@0 T@U) (|f#0@@0| T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.apply#canCall| |f#0@@0| |xs#0@@0|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@0|)) (let ((|ys#1| (_module.List._h2 |xs#0@@0|)))
(|_module.__default.apply#canCall| |f#0@@0| |ys#1|))) (= (_module.__default.apply ($LS $ly@@0) |f#0@@0| |xs#0@@0|) (ite (_module.List.Nil_q |xs#0@@0|) |#_module.List.Nil| (let ((|ys#0| (_module.List._h2 |xs#0@@0|)))
(let ((|y#0| (_module.List._h1 |xs#0@@0|)))
(|#_module.List.Cons| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@0 |f#0@@0| ($Box DatatypeTypeType |y#0|))) (_module.__default.apply $ly@@0 |f#0@@0| |ys#0|))))))))
 :qid |Ripplinglegacydfy.163:16|
 :skolemid |703|
 :pattern ( (_module.__default.apply ($LS $ly@@0) |f#0@@0| |xs#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@1 T@U) (|f#0@@1| T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.apply#canCall| |f#0@@1| (Lit DatatypeTypeType |xs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@1|)))))
(|_module.__default.apply#canCall| |f#0@@1| |ys#3|))) (= (_module.__default.apply ($LS $ly@@1) |f#0@@1| (Lit DatatypeTypeType |xs#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)) |#_module.List.Nil| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@1|)))))
(|#_module.List.Cons| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 |f#0@@1| ($Box DatatypeTypeType |y#2|))) (_module.__default.apply ($LS $ly@@1) |f#0@@1| |ys#2|))))))))
 :qid |Ripplinglegacydfy.163:16|
 :weight 3
 :skolemid |704|
 :pattern ( (_module.__default.apply ($LS $ly@@1) |f#0@@1| (Lit DatatypeTypeType |xs#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.take#canCall| |n#0| |xs#0@@2|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.take $ly@@2 |n#0| |xs#0@@2|) Tclass._module.List))
 :qid |Ripplinglegacydfy.130:16|
 :skolemid |672|
 :pattern ( (_module.__default.take $ly@@2 |n#0| |xs#0@@2|))
))))
(assert (forall (($ly@@3 T@U) (|n#0@@0| T@U) (|xs#0@@3| T@U) ) (! (= (_module.__default.take ($LS $ly@@3) |n#0@@0| |xs#0@@3|) (_module.__default.take $ly@@3 |n#0@@0| |xs#0@@3|))
 :qid |Ripplinglegacydfy.130:16|
 :skolemid |670|
 :pattern ( (_module.__default.take ($LS $ly@@3) |n#0@@0| |xs#0@@3|))
)))
(assert (forall (($ly@@4 T@U) (|f#0@@2| T@U) (|xs#0@@4| T@U) ) (! (= (_module.__default.apply ($LS $ly@@4) |f#0@@2| |xs#0@@4|) (_module.__default.apply $ly@@4 |f#0@@2| |xs#0@@4|))
 :qid |Ripplinglegacydfy.163:16|
 :skolemid |699|
 :pattern ( (_module.__default.apply ($LS $ly@@4) |f#0@@2| |xs#0@@4|))
)))
...
(assert (forall ((|#$T0@@5| T@U) (|#$R@@5| T@U) (|f#0@@3| T@U) ) (! (= ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 |#$T0@@5| |#$R@@5|))  (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hPartialFunc1 |#$T0@@5| |#$R@@5|)) (forall ((|x0#0| T@U) ) (!  (=> ($IsBox |x0#0| |#$T0@@5|) (Requires1 |#$T0@@5| |#$R@@5| $OneHeap |f#0@@3| |x0#0|))
 :qid |unknown.0:0|
 :skolemid |408|
))))
 :qid |unknown.0:0|
 :skolemid |409|
 :pattern ( ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 |#$T0@@5| |#$R@@5|)))
)))
(assert (forall ((|#$T0@@6| T@U) (|#$R@@6| T@U) (|f#0@@4| T@U) ) (! (= ($Is HandleTypeType |f#0@@4| (Tclass._System.___hPartialFunc1 |#$T0@@6| |#$R@@6|))  (and ($Is HandleTypeType |f#0@@4| (Tclass._System.___hFunc1 |#$T0@@6| |#$R@@6|)) (forall ((|x0#0@@0| T@U) ) (!  (=> ($IsBox |x0#0@@0| |#$T0@@6|) (|Set#Equal| (Reads1 |#$T0@@6| |#$R@@6| $OneHeap |f#0@@4| |x0#0@@0|) |Set#Empty|))
 :qid |unknown.0:0|
 :skolemid |401|
))))
 :qid |unknown.0:0|
 :skolemid |402|
 :pattern ( ($Is HandleTypeType |f#0@@4| (Tclass._System.___hPartialFunc1 |#$T0@@6| |#$R@@6|)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (forall ((t0@@2 T@T) (t1@@2 T@T) (t2 T@T) (val T@U) (m T@U) (x0 T@U) (x1 T@U) ) (! (= (MapType0Select t0@@2 t1@@2 t2 (MapType0Store t0@@2 t1@@2 t2 m x0 x1 val) x0 x1) val)
 ...
 :weight 0
)))) (= (Ctor refType) 5)) (= (Ctor FieldType) 6)) (forall ((t0@@3 T@T) (t1@@3 T@T) (val@@2 T@U) (m@@2 T@U) (x0@@2 T@U) ) (! (= (MapType1Select t0@@3 t1@@3 (MapType1Store t0@@3 t1@@3 m@@2 x0@@2 val@@2) x0@@2) val@@2)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) (|n#0@@1| T@U) (|xs#0@@5| T@U) ) (!  (=> (or (|_module.__default.take#canCall| |n#0@@1| |xs#0@@5|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@5| Tclass._module.List)))) (and (=> (not (_module.Nat.Zero_q |n#0@@1|)) (let ((|m#1| (_module.Nat._h0 |n#0@@1|)))
 (=> (not (_module.List.Nil_q |xs#0@@5|)) (let ((|tail#1| (_module.List._h2 |xs#0@@5|)))
(|_module.__default.take#canCall| |m#1| |tail#1|))))) (= (_module.__default.take ($LS $ly@@5) |n#0@@1| |xs#0@@5|) (ite (_module.Nat.Zero_q |n#0@@1|) |#_module.List.Nil| (let ((|m#0| (_module.Nat._h0 |n#0@@1|)))
(ite (_module.List.Nil_q |xs#0@@5|) |#_module.List.Nil| (let ((|tail#0| (_module.List._h2 |xs#0@@5|)))
(let ((|x#0| (_module.List._h1 |xs#0@@5|)))
(|#_module.List.Cons| |x#0| (_module.__default.take $ly@@5 |m#0| |tail#0|))))))))))
 :qid |Ripplinglegacydfy.130:16|
 :skolemid |674|
 :pattern ( (_module.__default.take ($LS $ly@@5) |n#0@@1| |xs#0@@5|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) (|f#0@@5| T@U) (|xs#0@@6| T@U) ) (!  (=> (or (|_module.__default.apply#canCall| |f#0@@5| |xs#0@@6|) (and (< 2 $FunctionContextHeight) (and ($Is HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($Is DatatypeTypeType |xs#0@@6| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.apply $ly@@6 |f#0@@5| |xs#0@@6|) Tclass._module.List))
 :qid |Ripplinglegacydfy.163:16|
 :skolemid |701|
 :pattern ( (_module.__default.apply $ly@@6 |f#0@@5| |xs#0@@6|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@7 T@U) (|n#0@@2| T@U) (|xs#0@@7| T@U) ) (!  (=> (or (|_module.__default.take#canCall| (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@7|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@7| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType |n#0@@2|)))))) (let ((|m#3| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |n#0@@2|)))))
 (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@7|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@7|)))))
(|_module.__default.take#canCall| |m#3| |tail#3|))))) (= (_module.__default.take ($LS $ly@@7) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@7|)) (ite (_module.Nat.Zero_q (Lit DatatypeTypeType |n#0@@2|)) |#_module.List.Nil| (let ((|m#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |n#0@@2|)))))
(ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@7|)) |#_module.List.Nil| (let ((|tail#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@7|)))))
(let ((|x#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@7|)))))
(Lit DatatypeTypeType (|#_module.List.Cons| |x#2| (Lit DatatypeTypeType (_module.__default.take ($LS $ly@@7) |m#2| |tail#2|))))))))))))
 :qid |Ripplinglegacydfy.130:16|
 :weight 3
 :skolemid |675|
 :pattern ( (_module.__default.take ($LS $ly@@7) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@7|)))
))))
(push 1)
...
(set-info :boogie-vc-id Impl$$_module.__default.P41)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|n#1| T@U) (|xs#1| T@U) (|f#1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |n#1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#1| Tclass._module.List)) ($Is HandleTypeType |f#1| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) (|_module.List#Equal| (_module.__default.take ($LS ($LS $LZ)) |n#1| (_module.__default.apply ($LS ($LS $LZ)) |f#1| |xs#1|)) (_module.__default.apply ($LS ($LS $LZ)) |f#1| (_module.__default.take ($LS ($LS $LZ)) |n#1| |xs#1|))))
 :qid |Ripplinglegacydfy.508:18|
 :skolemid |1101|
 :pattern ( (_module.__default.apply ($LS ($LS $LZ)) |f#1| (_module.__default.take ($LS ($LS $LZ)) |n#1| |xs#1|)))
 :pattern ( (_module.__default.take ($LS ($LS $LZ)) |n#1| (_module.__default.apply ($LS ($LS $LZ)) |f#1| |xs#1|)))
)))))
