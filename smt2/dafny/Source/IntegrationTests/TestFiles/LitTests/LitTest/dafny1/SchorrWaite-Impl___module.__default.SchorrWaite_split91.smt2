...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split91)
...
)) (< 0 (|Seq#Length| |stackNodes#0@1|))) (and ($IsAlloc refType ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))) Tclass._module.Node $Heap@@3) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))) null)) (not true)))))
