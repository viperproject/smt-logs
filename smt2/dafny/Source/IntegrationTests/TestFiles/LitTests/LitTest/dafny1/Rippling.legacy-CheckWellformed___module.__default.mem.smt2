...
(assert (forall (($ly@@0 T@U) (|x#0@@0| T@U) (|xs#0@@0| T@U) ) (! (= (_module.__default.mem ($LS $ly@@0) |x#0@@0| |xs#0@@0|) (_module.__default.mem $ly@@0 |x#0@@0| |xs#0@@0|))
 :qid |Ripplinglegacydfy.106:16|
 :skolemid |648|
 :pattern ( (_module.__default.mem ($LS $ly@@0) |x#0@@0| |xs#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|x#0@@1| T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.mem#canCall| |x#0@@1| |xs#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|ys#1| (_module.List._h2 |xs#0@@1|)))
(let ((|y#1| (_module.List._h1 |xs#0@@1|)))
 (and (and (|$IsA#_module.Nat| |x#0@@1|) (|$IsA#_module.Nat| |y#1|)) (=> (not (|_module.Nat#Equal| |x#0@@1| |y#1|)) (|_module.__default.mem#canCall| |x#0@@1| |ys#1|)))))) (= (_module.__default.mem ($LS $ly@@1) |x#0@@1| |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) |#_module.Bool.False| (let ((|ys#0| (_module.List._h2 |xs#0@@1|)))
(let ((|y#0| (_module.List._h1 |xs#0@@1|)))
(ite (|_module.Nat#Equal| |x#0@@1| |y#0|) |#_module.Bool.True| (_module.__default.mem $ly@@1 |x#0@@1| |ys#0|))))))))
 :qid |Ripplinglegacydfy.106:16|
 :skolemid |652|
 :pattern ( (_module.__default.mem ($LS $ly@@1) |x#0@@1| |xs#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) (|x#0@@2| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.mem#canCall| (Lit DatatypeTypeType |x#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
 (and (and (|$IsA#_module.Nat| (Lit DatatypeTypeType |x#0@@2|)) (|$IsA#_module.Nat| |y#3|)) (=> (not (|_module.Nat#Equal| |x#0@@2| |y#3|)) (|_module.__default.mem#canCall| (Lit DatatypeTypeType |x#0@@2|) |ys#3|)))))) (= (_module.__default.mem ($LS $ly@@2) (Lit DatatypeTypeType |x#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |#_module.Bool.False| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
(ite (|_module.Nat#Equal| |x#0@@2| |y#2|) |#_module.Bool.True| (_module.__default.mem ($LS $ly@@2) (Lit DatatypeTypeType |x#0@@2|) |ys#2|))))))))
 :qid |Ripplinglegacydfy.106:16|
 :weight 3
 :skolemid |653|
 :pattern ( (_module.__default.mem ($LS $ly@@2) (Lit DatatypeTypeType |x#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)))
))))
...
(assert (forall ((d@@12 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) ($Is DatatypeTypeType d@@12 Tclass._module.List)) ($IsAlloc DatatypeTypeType d@@12 Tclass._module.List $h@@1))
 :qid |unknown.0:0|
 :skolemid |1253|
 :pattern ( ($IsAlloc DatatypeTypeType d@@12 Tclass._module.List $h@@1))
)))
...
(assert (forall ((d@@13 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.Nat.Suc_q d@@13) ($IsAlloc DatatypeTypeType d@@13 Tclass._module.Nat $h@@2))) ($IsAlloc DatatypeTypeType (_module.Nat._h0 d@@13) Tclass._module.Nat $h@@2))
 :qid |unknown.0:0|
 :skolemid |1229|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Nat._h0 d@@13) Tclass._module.Nat $h@@2))
)))
(assert (forall ((d@@14 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.List.Cons_q d@@14) ($IsAlloc DatatypeTypeType d@@14 Tclass._module.List $h@@3))) ($IsAlloc DatatypeTypeType (_module.List._h1 d@@14) Tclass._module.Nat $h@@3))
 :qid |unknown.0:0|
 :skolemid |1246|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h1 d@@14) Tclass._module.Nat $h@@3))
)))
(assert (forall ((d@@15 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.List.Cons_q d@@15) ($IsAlloc DatatypeTypeType d@@15 Tclass._module.List $h@@4))) ($IsAlloc DatatypeTypeType (_module.List._h2 d@@15) Tclass._module.List $h@@4))
 :qid |unknown.0:0|
 :skolemid |1247|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h2 d@@15) Tclass._module.List $h@@4))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.mem)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon13_Else_correct  (=> (and (and (not (|_module.Nat#Equal| |x#0@@3| |y#Z#0@0|)) ($IsAlloc DatatypeTypeType |x#0@@3| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 6) (- 0 5)))) (or (< (DtRank |x#0@@3|) (DtRank |x#0@@3|)) (and (= (DtRank |x#0@@3|) (DtRank |x#0@@3|)) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |x#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
