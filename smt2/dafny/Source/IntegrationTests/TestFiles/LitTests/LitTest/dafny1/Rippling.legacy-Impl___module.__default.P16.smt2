...
(declare-fun |_module.__default.last#canCall| (T@U) Bool)
...
(assert (distinct alloc Tagclass._module.Nat Tagclass._module.List |##_module.Nat.Zero| |##_module.List.Nil| |##_module.List.Cons| tytagFamily$Nat tytagFamily$List)
)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.last#canCall| |xs#0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0| Tclass._module.List))) (and (=> (not (_module.List.Nil_q |xs#0|)) (let ((|ys#1| (_module.List._h2 |xs#0|)))
 (=> (not (_module.List.Nil_q |ys#1|)) (|_module.__default.last#canCall| |ys#1|)))) (= (_module.__default.last ($LS $ly) |xs#0|) (ite (_module.List.Nil_q |xs#0|) |#_module.Nat.Zero| (let ((|ys#0| (_module.List._h2 |xs#0|)))
(let ((|y#0| (_module.List._h1 |xs#0|)))
(ite (_module.List.Nil_q |ys#0|) |y#0| (_module.__default.last $ly |ys#0|))))))))
 :qid |Ripplinglegacydfy.154:16|
 :skolemid |696|
 :pattern ( (_module.__default.last ($LS $ly) |xs#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.last#canCall| (Lit DatatypeTypeType |xs#0@@0|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@0|)))))
 (=> (not (_module.List.Nil_q |ys#3|)) (|_module.__default.last#canCall| |ys#3|)))) (= (_module.__default.last ($LS $ly@@0) (Lit DatatypeTypeType |xs#0@@0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)) |#_module.Nat.Zero| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@0|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@0|)))))
(ite (_module.List.Nil_q |ys#2|) |y#2| (Lit DatatypeTypeType (_module.__default.last ($LS $ly@@0) |ys#2|)))))))))
 :qid |Ripplinglegacydfy.154:16|
 :weight 3
 :skolemid |697|
 :pattern ( (_module.__default.last ($LS $ly@@0) (Lit DatatypeTypeType |xs#0@@0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.last#canCall| |xs#0@@1|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List))) ($Is DatatypeTypeType (_module.__default.last $ly@@1 |xs#0@@1|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.154:16|
 :skolemid |694|
 :pattern ( (_module.__default.last $ly@@1 |xs#0@@1|))
))))
...
(assert (forall (($ly@@2 T@U) (|xs#0@@2| T@U) ) (! (= (_module.__default.last ($LS $ly@@2) |xs#0@@2|) (_module.__default.last $ly@@2 |xs#0@@2|))
 :qid |Ripplinglegacydfy.154:16|
 :skolemid |692|
 :pattern ( (_module.__default.last ($LS $ly@@2) |xs#0@@2|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.P16)
