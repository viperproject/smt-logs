...
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.Remove)
...
(let ((anon12_Then_correct  (=> (or (not (= |node#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |node#0@0| null)) (not true))) (=> (or (not (= |node#0@0| null)) (not true)) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |node#0@0|) _module.Node.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.Node.Repr))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |node#0@0| null)) (not true))) (=> (or (not (= |node#0@0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType this@@3 Tclass._module.Node $Heap@@2))))))))))
(let ((anon11_Else_correct  (=> (=> (= |node#0@0| null) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.Node.Contents)) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |x#0|))))) (and (=> (= (ControlFlow 0 8) 2) anon12_Then_correct) (=> (= (ControlFlow 0 8) 5) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (= |node#0@0| null) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType this@@3 Tclass._module.Node $Heap@@2)) (=> ($IsAlloc refType this@@3 Tclass._module.Node $Heap@@2) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.Node.Contents)) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 6) 2) anon12_Then_correct) (=> (= (ControlFlow 0 6) 5) anon12_Else_correct))))))))
(let ((anon10_Else_correct  (=> (=> (or (not (= |node#0@0| null)) (not true)) (_module.Node.Valid ($LS $LZ) $Heap@0 |node#0@0|)) (and (=> (= (ControlFlow 0 11) 6) anon11_Then_correct) (=> (= (ControlFlow 0 11) 8) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (or (not (= |node#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |node#0@0| null)) (not true))) (=> (or (not (= |node#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |node#0@0|) Tclass._module.Node? $Heap@0) (=> (and (|_module.Node.Valid#canCall| $Heap@0 |node#0@0|) (_module.Node.Valid ($LS $LZ) $Heap@0 |node#0@0|)) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))))))
