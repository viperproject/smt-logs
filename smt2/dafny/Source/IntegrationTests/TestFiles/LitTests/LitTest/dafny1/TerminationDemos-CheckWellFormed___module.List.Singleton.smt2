...
(set-info :boogie-vc-id CheckWellFormed$$_module.List.Singleton)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.List) ($IsAlloc refType this@@2 Tclass._module.List $Heap@@1)))) (and (and ($Is refType |list#0| Tclass._module.List) ($IsAlloc refType |list#0| Tclass._module.List $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
