...
(assert (forall ((d@@4 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (_module.List.Cons_q d@@4) ($IsAlloc DatatypeTypeType d@@4 Tclass._module.List $h))) ($IsAlloc intType (int_2_U (_module.List._h0 d@@4)) TInt $h))
 :qid |unknown.0:0|
 :skolemid |573|
 :pattern ( ($IsAlloc intType (int_2_U (_module.List._h0 d@@4)) TInt $h))
)))
...
(assert (forall ((d@@6 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.List $h@@1))) ($IsAlloc DatatypeTypeType (_module.List._h1 d@@6) Tclass._module.List $h@@1))
 :qid |unknown.0:0|
 :skolemid |574|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h1 d@@6) Tclass._module.List $h@@1))
)))
...
(let ((anon10_Then_correct  (=> (= |xs#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List) (= |let#0#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List) (= |tail#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#0#0|) ($Is intType (int_2_U |let#1#0#0|) TInt))) (and (and (= |x#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |tail#Z#0@0| Tclass._module.List $Heap)) (and ($IsAlloc DatatypeTypeType |ys#0@@3| Tclass._module.List $Heap) (= (ControlFlow 0 4) (- 0 3))))) (or (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@3|)) (and (= (DtRank |tail#Z#0@0|) (DtRank |xs#0@@3|)) (< (DtRank |ys#0@@3|) (DtRank |ys#0@@3|)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List) ($Is DatatypeTypeType |ys#0@@3| Tclass._module.List)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
