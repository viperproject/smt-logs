...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly T@U) (|n#0| T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.ins1#canCall| |n#0| |xs#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.ins1 $ly |n#0| |xs#0|) Tclass._module.List))
 :qid |Ripplinglegacydfy.223:16|
 :skolemid |750|
 :pattern ( (_module.__default.ins1 $ly |n#0| |xs#0|))
))))
(assert (forall (($ly@@0 T@U) (|n#0@@0| T@U) (|xs#0@@0| T@U) ) (! (= (_module.__default.ins1 ($LS $ly@@0) |n#0@@0| |xs#0@@0|) (_module.__default.ins1 $ly@@0 |n#0@@0| |xs#0@@0|))
 :qid |Ripplinglegacydfy.223:16|
 :skolemid |748|
 :pattern ( (_module.__default.ins1 ($LS $ly@@0) |n#0@@0| |xs#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) (|n#0@@1| T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.ins1#canCall| |n#0@@1| |xs#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|ys#1| (_module.List._h2 |xs#0@@1|)))
(let ((|y#1| (_module.List._h1 |xs#0@@1|)))
 (and (and (|$IsA#_module.Nat| |n#0@@1|) (|$IsA#_module.Nat| |y#1|)) (=> (not (|_module.Nat#Equal| |n#0@@1| |y#1|)) (|_module.__default.ins1#canCall| |n#0@@1| |ys#1|)))))) (= (_module.__default.ins1 ($LS $ly@@1) |n#0@@1| |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) (|#_module.List.Cons| |n#0@@1| (Lit DatatypeTypeType |#_module.List.Nil|)) (let ((|ys#0| (_module.List._h2 |xs#0@@1|)))
(let ((|y#0| (_module.List._h1 |xs#0@@1|)))
(ite (|_module.Nat#Equal| |n#0@@1| |y#0|) (|#_module.List.Cons| |y#0| |ys#0|) (|#_module.List.Cons| |y#0| (_module.__default.ins1 $ly@@1 |n#0@@1| |ys#0|)))))))))
 :qid |Ripplinglegacydfy.223:16|
 :skolemid |752|
 :pattern ( (_module.__default.ins1 ($LS $ly@@1) |n#0@@1| |xs#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.ins1#canCall| (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
 (and (and (|$IsA#_module.Nat| (Lit DatatypeTypeType |n#0@@2|)) (|$IsA#_module.Nat| |y#3|)) (=> (not (|_module.Nat#Equal| |n#0@@2| |y#3|)) (|_module.__default.ins1#canCall| (Lit DatatypeTypeType |n#0@@2|) |ys#3|)))))) (= (_module.__default.ins1 ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) (|#_module.List.Cons| (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |#_module.List.Nil|)) (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
(ite (|_module.Nat#Equal| |n#0@@2| |y#2|) (|#_module.List.Cons| |y#2| |ys#2|) (|#_module.List.Cons| |y#2| (Lit DatatypeTypeType (_module.__default.ins1 ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) |ys#2|))))))))))
 :qid |Ripplinglegacydfy.223:16|
 :weight 3
 :skolemid |753|
 :pattern ( (_module.__default.ins1 ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ins1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon13_Else_correct  (=> (and (and (not (|_module.Nat#Equal| |n#0@@3| |y#Z#0@0|)) ($IsAlloc DatatypeTypeType |n#0@@3| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 6) (- 0 5)))) (or (< (DtRank |n#0@@3|) (DtRank |n#0@@3|)) (and (= (DtRank |n#0@@3|) (DtRank |n#0@@3|)) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)))))))
(let ((anon13_Then_correct true))
(let ((anon12_Then_correct  (=> (= |xs#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List))) (and (and (= |ys#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat) (= |y#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 7) 4) anon13_Then_correct) (=> (= (ControlFlow 0 7) 6) anon13_Else_correct))))))
(let ((anon12_Else_correct true))
(let ((anon11_Else_correct  (=> (or (not (= |xs#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 8) 7) anon12_Then_correct) (=> (= (ControlFlow 0 8) 3) anon12_Else_correct)))))
(let ((anon11_Then_correct true))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 9) 1) anon10_Then_correct) (=> (= (ControlFlow 0 9) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |n#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
