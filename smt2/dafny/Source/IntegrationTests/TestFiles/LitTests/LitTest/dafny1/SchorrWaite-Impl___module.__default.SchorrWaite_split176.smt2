...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split176)
...
))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.children)))))))))
