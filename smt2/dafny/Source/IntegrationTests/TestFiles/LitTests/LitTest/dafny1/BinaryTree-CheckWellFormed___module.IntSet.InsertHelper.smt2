...
(declare-fun |m#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.IntSet.InsertHelper)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon24_Else_correct true))
(let ((anon24_Then_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |n#0| Tclass._module.Node? $Heap@@2)))))))))
(let ((anon23_Else_correct  (=> (=> (or (not (= |n#0| null)) (not true)) (and (= |m#0@0| |n#0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) _module.Node.Contents)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#0|) _module.Node.Contents)) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |x#0|))))))) (and (=> (= (ControlFlow 0 10) 2) anon24_Then_correct) (=> (= (ControlFlow 0 10) 5) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (and (or (not (= |n#0| null)) (not true)) (= |m#0@0| |n#0|)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType |n#0| Tclass._module.Node? $Heap@@2)) (=> ($IsAlloc refType |n#0| Tclass._module.Node? $Heap@@2) (=> (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#0|) _module.Node.Contents)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#0|) _module.Node.Contents)) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |x#0|))))) (and (=> (= (ControlFlow 0 6) 2) anon24_Then_correct) (=> (= (ControlFlow 0 6) 5) anon24_Else_correct))))))))))))
(let ((anon22_Else_correct  (=> (=> (= |n#0| null) (and (and (forall (($o@@15 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.Node.Repr)) ($Box refType $o@@15)) (or (not (= $o@@15 null)) (not true)))
 :qid |BinaryTreedfy.55:27|
 :skolemid |558|
 :pattern (  (or (not (= $o@@15 null)) (not true)))
)) (forall (($o@@16 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.Node.Repr)) ($Box refType $o@@16)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@16) alloc)))))
 :qid |BinaryTreedfy.55:27|
 :skolemid |559|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.Node.Repr)) ($Box refType $o@@16)))
))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.Node.Contents)) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |x#0|)))))) (and (=> (= (ControlFlow 0 14) 6) anon23_Then_correct) (=> (= (ControlFlow 0 14) 10) anon23_Else_correct)))))
(let ((anon22_Then_correct  (=> (= |n#0| null) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (=> (and (forall (($o@@17 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.Node.Repr)) ($Box refType $o@@17)) (or (not (= $o@@17 null)) (not true)))
 :qid |BinaryTreedfy.55:27|
 :skolemid |556|
 :pattern (  (or (not (= $o@@17 null)) (not true)))
)) (forall (($o@@18 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.Node.Repr)) ($Box refType $o@@18)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@18) alloc)))))
 :qid |BinaryTreedfy.55:27|
 :skolemid |557|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.Node.Repr)) ($Box refType $o@@18)))
))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (=> (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0@0|) _module.Node.Contents)) (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 11) 6) anon23_Then_correct) (=> (= (ControlFlow 0 11) 10) anon23_Else_correct)))))))))))
(let ((anon10_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@19 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@19) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@19) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@19)) (|Set#IsMember| (ite  (or (not (= |n#0| null)) (not true)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#0|) _module.Node.Repr)) |Set#Empty|) ($Box refType $o@@19))))
 :qid |BinaryTreedfy.51:17|
 :skolemid |555|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@19))
)) ($HeapSucc $Heap@@2 $Heap@0)) (and ($Is refType |m#0@0| Tclass._module.Node) ($IsAlloc refType |m#0@0| Tclass._module.Node $Heap@0))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= |m#0@0| null)) (not true))) (=> (or (not (= |m#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |m#0@0|) Tclass._module.Node? $Heap@0) (=> (and (|_module.Node.Valid#canCall| $Heap@0 |m#0@0|) (_module.Node.Valid ($LS $LZ) $Heap@0 |m#0@0|)) (and (=> (= (ControlFlow 0 15) 11) anon22_Then_correct) (=> (= (ControlFlow 0 15) 14) anon22_Else_correct))))))))))
(let ((anon21_Else_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> (= (ControlFlow 0 18) 15) anon10_correct))))))
(let ((anon21_Then_correct  (=> (and (= |n#0| null) (= (ControlFlow 0 17) 15)) anon10_correct)))
(let ((anon20_Else_correct  (=> (= |n#0| null) (and (=> (= (ControlFlow 0 22) 17) anon21_Then_correct) (=> (= (ControlFlow 0 22) 18) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 20) 17) anon21_Then_correct) (=> (= (ControlFlow 0 20) 18) anon21_Else_correct)))))))
(let ((anon19_Else_correct  (=> (or (not (= |n#0| null)) (not true)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (or (not (= |n#0| null)) (not true))) (=> (or (not (= |n#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |n#0|) Tclass._module.Node? $Heap@@2) (=> (and (|_module.Node.Valid#canCall| $Heap@@2 |n#0|) (_module.Node.Valid ($LS $LZ) $Heap@@2 |n#0|)) (and (=> (= (ControlFlow 0 24) 20) anon20_Then_correct) (=> (= (ControlFlow 0 24) 22) anon20_Else_correct)))))))))
(let ((anon19_Then_correct  (=> (= |n#0| null) (and (=> (= (ControlFlow 0 23) 20) anon20_Then_correct) (=> (= (ControlFlow 0 23) 22) anon20_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@2 alloc (ite  (or (not (= |n#0| null)) (not true)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#0|) _module.Node.Repr)) |Set#Empty|))) (and (=> (= (ControlFlow 0 26) 23) anon19_Then_correct) (=> (= (ControlFlow 0 26) 24) anon19_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($Is refType |n#0| Tclass._module.Node?) ($IsAlloc refType |n#0| Tclass._module.Node? $Heap@@2))) (and (and ($Is refType |m#0| Tclass._module.Node) ($IsAlloc refType |m#0| Tclass._module.Node $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 27) 26)))) anon0_correct)))
