...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split63)
...
)) (=> (and (< 0 (|Seq#Length| |stackNodes#0@1|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0))) null)) (not true))))))
