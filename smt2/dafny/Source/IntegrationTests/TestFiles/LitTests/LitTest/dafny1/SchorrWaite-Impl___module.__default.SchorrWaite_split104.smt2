...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split104)
...
))) (and ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3) (= (ControlFlow 0 2) (- 0 1)))) ($Is refType |t#0@0| Tclass._module.Node))))
