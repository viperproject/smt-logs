...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.SingletonList$T@@0 T@U) (|h#0@@0| T@U) ) (!  (=> (or (|_module.__default.SingletonList#canCall| _module._default.SingletonList$T@@0 |h#0@@0|) (and (< 2 $FunctionContextHeight) ($IsBox |h#0@@0| _module._default.SingletonList$T@@0))) (= (_module.__default.SingletonList _module._default.SingletonList$T@@0 |h#0@@0|) (|#_module.List.Cons| |h#0@@0| (Lit DatatypeTypeType |#_module.List.Nil|))))
 :qid |unknown.0:0|
 :skolemid |592|
 :pattern ( (_module.__default.SingletonList _module._default.SingletonList$T@@0 |h#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.SingletonList$T@@1 T@U) (|h#0@@1| T@U) ) (!  (=> (and (or (|_module.__default.SingletonList#canCall| _module._default.SingletonList$T@@1 |h#0@@1|) (and (< 2 $FunctionContextHeight) (and ($IsBox |h#0@@1| _module._default.SingletonList$T@@1) ($IsAllocBox |h#0@@1| _module._default.SingletonList$T@@1 $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.SingletonList _module._default.SingletonList$T@@1 |h#0@@1|) (Tclass._module.List _module._default.SingletonList$T@@1) $Heap))
 :qid |TreeDatatypedfy.68:16|
 :skolemid |590|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.SingletonList _module._default.SingletonList$T@@1 |h#0@@1|) (Tclass._module.List _module._default.SingletonList$T@@1) $Heap))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((_module._default.SingletonList$T@@2 T@U) (|h#0@@2| T@U) ) (!  (=> (or (|_module.__default.SingletonList#canCall| _module._default.SingletonList$T@@2 (Lit BoxType |h#0@@2|)) (and (< 2 $FunctionContextHeight) ($IsBox |h#0@@2| _module._default.SingletonList$T@@2))) (= (_module.__default.SingletonList _module._default.SingletonList$T@@2 (Lit BoxType |h#0@@2|)) (Lit DatatypeTypeType (|#_module.List.Cons| (Lit BoxType |h#0@@2|) (Lit DatatypeTypeType |#_module.List.Nil|)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |593|
 :pattern ( (_module.__default.SingletonList _module._default.SingletonList$T@@2 (Lit BoxType |h#0@@2|)))
))))
...
(declare-fun _module._default.SingletonList$T@@3 () T@U)
(declare-fun |h#0@@3| () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.SingletonList)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (_module.__default.len _module._default.SingletonList$T@@3 ($LS ($LS $LZ)) (_module.__default.SingletonList _module._default.SingletonList$T@@3 |h#0@@3|)) (LitInt 1)))))
(let ((anon5_Else_correct  (=> (= (_module.__default.SingletonList _module._default.SingletonList$T@@3 |h#0@@3|) (|#_module.List.Cons| |h#0@@3| (Lit DatatypeTypeType |#_module.List.Nil|))) (=> (and ($Is DatatypeTypeType (_module.__default.SingletonList _module._default.SingletonList$T@@3 |h#0@@3|) (Tclass._module.List _module._default.SingletonList$T@@3)) (= (ControlFlow 0 5) 4)) GeneratedUnifiedExit_correct))))
(let ((anon5_Then_correct  (=> ($Is DatatypeTypeType (_module.__default.SingletonList _module._default.SingletonList$T@@3 |h#0@@3|) (Tclass._module.List _module._default.SingletonList$T@@3)) (=> (and ($IsAllocBox |h#0@@3| _module._default.SingletonList$T@@3 $Heap@@0) (= (ControlFlow 0 2) (- 0 1))) (= |h#0@@3| |h#0@@3|)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($IsBox |h#0@@3| _module._default.SingletonList$T@@3)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
