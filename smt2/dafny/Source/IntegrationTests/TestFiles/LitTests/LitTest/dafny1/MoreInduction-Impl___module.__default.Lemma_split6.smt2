...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma_split6)
...
(let ((|n#2@@2| (_module.List._h0 |ext##0_0_0@0|)))
 (=> (_module.Node.Element_q |n#2@@2|) (_module.__default.IsFlat _module._default.Lemma$X ($LS ($LS $LZ)) |rest#2@@2|))))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext##0_0_0@0|))))) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext##0_0_0@0|) (=> (not (_module.List.Nil_q |ext##0_0_0@0|)) (let ((|n#2@@3| (_module.List._h0 |ext##0_0_0@0|)))
 (=> (not (_module.Node.Element_q |n#2@@3|)) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
