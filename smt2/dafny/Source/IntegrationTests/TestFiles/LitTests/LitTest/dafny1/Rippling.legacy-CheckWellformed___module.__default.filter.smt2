...
(assert (forall (($ly@@1 T@U) (|p#0@@1| T@U) (|xs#0@@1| T@U) ) (! (= (_module.__default.filter ($LS $ly@@1) |p#0@@1| |xs#0@@1|) (_module.__default.filter $ly@@1 |p#0@@1| |xs#0@@1|))
 :qid |Ripplinglegacydfy.193:16|
 :skolemid |723|
 :pattern ( (_module.__default.filter ($LS $ly@@1) |p#0@@1| |xs#0@@1|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@1 T@U) (|p#0@@2| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.filter#canCall| |p#0@@2| (Lit DatatypeTypeType |xs#0@@2|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
 (and (and (|$IsA#_module.Nat| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 |p#0@@2| ($Box DatatypeTypeType |y#3|)))) (=> (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 |p#0@@2| ($Box DatatypeTypeType |y#3|))) |#_module.Nat.Zero|)) (|_module.__default.filter#canCall| |p#0@@2| |ys#3|))) (=> (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 |p#0@@2| ($Box DatatypeTypeType |y#3|))) |#_module.Nat.Zero|) (|_module.__default.filter#canCall| |p#0@@2| |ys#3|)))))) (= (_module.__default.filter ($LS $ly@@2) |p#0@@2| (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |#_module.List.Nil| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
(ite  (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 |p#0@@2| ($Box DatatypeTypeType |y#2|))) |#_module.Nat.Zero|)) (|#_module.List.Cons| |y#2| (_module.__default.filter ($LS $ly@@2) |p#0@@2| |ys#2|)) (_module.__default.filter ($LS $ly@@2) |p#0@@2| |ys#2|))))))))
 :qid |Ripplinglegacydfy.193:16|
 :weight 3
 :skolemid |728|
 :pattern ( (_module.__default.filter ($LS $ly@@2) |p#0@@2| (Lit DatatypeTypeType |xs#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|p#0@@3| T@U) (|xs#0@@3| T@U) ) (!  (=> (or (|_module.__default.filter#canCall| |p#0@@3| |xs#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is HandleTypeType |p#0@@3| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.filter $ly@@3 |p#0@@3| |xs#0@@3|) Tclass._module.List))
 :qid |Ripplinglegacydfy.193:16|
 :skolemid |725|
 :pattern ( (_module.__default.filter $ly@@3 |p#0@@3| |xs#0@@3|))
))))
(push 1)
...
(let ((anon12_Then_correct  (=> (= |xs#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List))) (and (and (= |ys#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat) (= |y#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 8) 5) anon13_Then_correct) (=> (= (ControlFlow 0 8) 7) anon13_Else_correct))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon10_Then_correct) (=> (= (ControlFlow 0 10) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is HandleTypeType |p#0@@4| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($Is DatatypeTypeType |xs#0@@4| Tclass._module.List)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
