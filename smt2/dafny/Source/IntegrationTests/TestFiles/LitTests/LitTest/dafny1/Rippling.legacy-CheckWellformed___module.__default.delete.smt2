...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.delete#canCall| |n#0@@0| |xs#0@@0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.delete $ly@@0 |n#0@@0| |xs#0@@0|) Tclass._module.List))
 :qid |Ripplinglegacydfy.113:16|
 :skolemid |657|
 :pattern ( (_module.__default.delete $ly@@0 |n#0@@0| |xs#0@@0|))
))))
(assert (forall (($ly@@1 T@U) (|n#0@@1| T@U) (|xs#0@@1| T@U) ) (! (= (_module.__default.delete ($LS $ly@@1) |n#0@@1| |xs#0@@1|) (_module.__default.delete $ly@@1 |n#0@@1| |xs#0@@1|))
 :qid |Ripplinglegacydfy.113:16|
 :skolemid |655|
 :pattern ( (_module.__default.delete ($LS $ly@@1) |n#0@@1| |xs#0@@1|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.delete#canCall| (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
 (and (and (and (|$IsA#_module.Nat| |y#3|) (|$IsA#_module.Nat| (Lit DatatypeTypeType |n#0@@2|))) (=> (|_module.Nat#Equal| |y#3| |n#0@@2|) (|_module.__default.delete#canCall| (Lit DatatypeTypeType |n#0@@2|) |ys#3|))) (=> (not (|_module.Nat#Equal| |y#3| |n#0@@2|)) (|_module.__default.delete#canCall| (Lit DatatypeTypeType |n#0@@2|) |ys#3|)))))) (= (_module.__default.delete ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |#_module.List.Nil| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
(ite (|_module.Nat#Equal| |y#2| |n#0@@2|) (_module.__default.delete ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) |ys#2|) (|#_module.List.Cons| |y#2| (Lit DatatypeTypeType (_module.__default.delete ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) |ys#2|))))))))))
 :qid |Ripplinglegacydfy.113:16|
 :weight 3
 :skolemid |660|
 :pattern ( (_module.__default.delete ($LS $ly@@2) (Lit DatatypeTypeType |n#0@@2|) (Lit DatatypeTypeType |xs#0@@2|)))
))))
(assert (forall ((d@@10 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) ($Is DatatypeTypeType d@@10 Tclass._module.Nat)) ($IsAlloc DatatypeTypeType d@@10 Tclass._module.Nat $h))
 :qid |unknown.0:0|
 :skolemid |1233|
 :pattern ( ($IsAlloc DatatypeTypeType d@@10 Tclass._module.Nat $h))
)))
(assert (forall ((d@@11 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) ($Is DatatypeTypeType d@@11 Tclass._module.List)) ($IsAlloc DatatypeTypeType d@@11 Tclass._module.List $h@@0))
 :qid |unknown.0:0|
 :skolemid |1253|
 :pattern ( ($IsAlloc DatatypeTypeType d@@11 Tclass._module.List $h@@0))
)))
...
(assert (forall ((d@@12 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Nat.Suc_q d@@12) ($IsAlloc DatatypeTypeType d@@12 Tclass._module.Nat $h@@1))) ($IsAlloc DatatypeTypeType (_module.Nat._h0 d@@12) Tclass._module.Nat $h@@1))
 :qid |unknown.0:0|
 :skolemid |1229|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Nat._h0 d@@12) Tclass._module.Nat $h@@1))
)))
(assert (forall ((d@@13 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.List.Cons_q d@@13) ($IsAlloc DatatypeTypeType d@@13 Tclass._module.List $h@@2))) ($IsAlloc DatatypeTypeType (_module.List._h1 d@@13) Tclass._module.Nat $h@@2))
 :qid |unknown.0:0|
 :skolemid |1246|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h1 d@@13) Tclass._module.Nat $h@@2))
)))
(assert (forall ((d@@14 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.List.Cons_q d@@14) ($IsAlloc DatatypeTypeType d@@14 Tclass._module.List $h@@3))) ($IsAlloc DatatypeTypeType (_module.List._h2 d@@14) Tclass._module.List $h@@3))
 :qid |unknown.0:0|
 :skolemid |1247|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h2 d@@14) Tclass._module.List $h@@3))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.delete)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon13_Else_correct  (=> (and (and (not (|_module.Nat#Equal| |y#Z#0@0| |n#0@@3|)) ($IsAlloc DatatypeTypeType |n#0@@3| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 7) (- 0 6)))) (or (< (DtRank |n#0@@3|) (DtRank |n#0@@3|)) (and (= (DtRank |n#0@@3|) (DtRank |n#0@@3|)) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)))))))
(let ((anon13_Then_correct  (=> (and (and (|_module.Nat#Equal| |y#Z#0@0| |n#0@@3|) ($IsAlloc DatatypeTypeType |n#0@@3| Tclass._module.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |ys#Z#0@0| Tclass._module.List $Heap) (= (ControlFlow 0 5) (- 0 4)))) (or (< (DtRank |n#0@@3|) (DtRank |n#0@@3|)) (and (= (DtRank |n#0@@3|) (DtRank |n#0@@3|)) (< (DtRank |ys#Z#0@0|) (DtRank |xs#0@@3|)))))))
(let ((anon12_Then_correct  (=> (= |xs#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Nat) ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.List)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass._module.List))) (and (and (= |ys#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Nat) (= |y#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 8) 5) anon13_Then_correct) (=> (= (ControlFlow 0 8) 7) anon13_Else_correct))))))
(let ((anon12_Else_correct true))
(let ((anon11_Else_correct  (=> (or (not (= |xs#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 9) 8) anon12_Then_correct) (=> (= (ControlFlow 0 9) 3) anon12_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |n#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
