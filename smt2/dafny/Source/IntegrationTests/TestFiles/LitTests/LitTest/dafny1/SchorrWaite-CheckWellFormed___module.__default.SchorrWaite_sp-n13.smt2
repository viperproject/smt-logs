...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SchorrWaite_split12)
...
)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8)) (|Set#IsMember| |S#0| ($Box refType $o@@8))))
 :qid |SchorrWaitedfy.169:30|
 :skolemid |782|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8))
)) ($HeapSucc $Heap $Heap@0)) (and (or (not (= |root#0| null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |root#0|) _module.Node.marked))))) (=> (and (and (and (and ($Is refType |n#4@0| Tclass._module.Node) ($IsAlloc refType |n#4@0| Tclass._module.Node $Heap@0)) (|Set#IsMember| |S#0| ($Box refType |n#4@0|))) (and (or (not (= |n#4@0| null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#4@0|) _module.Node.marked))))) (and (and ($Is refType |ch#3@0| Tclass._module.Node?) ($IsAlloc refType |ch#3@0| Tclass._module.Node? $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |n#4@0| null)) (not true))))))))
