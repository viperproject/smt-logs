...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split23)
...
))) (=> |$w$loop#0@0| ($IsAllocBox ($Box DatatypeTypeType |path#0@0|) Tclass._module.Path $Heap@@2))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (_module.Path.Empty_q |path#0@0|) (= |root#0| |root#0|))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|_module.__default.ReachableVia#canCall| $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|))))) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@2 |root#0| |path#0@0| |root#0| |S#0@@3|) (=> (not (_module.Path.Empty_q |path#0@0|)) (let ((|n#22| (_module.Path._h1 |path#0@0|)))
(|Set#IsMember| |S#0@@3| ($Box refType |n#22|)))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
