...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split240)
...
(|Set#IsMember| |S#0@@5| ($Box refType |n#22@@5|))))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@4| |t#0@1| |S#0@@5|))))))) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |root#0| |path#0@4| |t#0@1| |S#0@@5|) (=> (not (_module.Path.Empty_q |path#0@4|)) (let ((|n#22@@6| (_module.Path._h1 |path#0@4|)))
(|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#22@@6|) _module.Node.children)) ($Box refType |t#0@1|))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
