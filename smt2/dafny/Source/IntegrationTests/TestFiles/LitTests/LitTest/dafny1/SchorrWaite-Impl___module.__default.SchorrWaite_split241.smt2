...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split241)
...
(|Set#IsMember| |S#0@@5| ($Box refType |n#22@@5|)))))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.__default.ReachableVia#canCall| $Heap@@3 |root#0| |path#0@4| |t#0@1| |S#0@@5|) (or (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |root#0| |path#0@4| |t#0@1| |S#0@@5|) (=> (not (_module.Path.Empty_q |path#0@4|)) (let ((|n#22@@6| (_module.Path._h1 |path#0@4|)))
...
(_module.__default.ReachableVia ($LS ($LS $LZ)) $Heap@@3 |root#0| |prefix#0@@2| |n#22@@7| |S#0@@5|))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
