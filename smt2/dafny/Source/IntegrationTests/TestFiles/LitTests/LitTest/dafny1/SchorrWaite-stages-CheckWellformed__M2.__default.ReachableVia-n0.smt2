...
(assert (distinct TBool TagBool TagSet TagSeq alloc allocName Tagclass.M2.Node Tagclass.M2.Node? Tagclass.M2.Path class.M2.Node? |##M2.Path.Empty| |##M2.Path.Extend| tytagFamily$Node tytagFamily$Path field$children)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|a#6#0#0@@0| T@U) (|a#6#1#0@@0| T@U) ($h T@U) ) (!  (=> ($IsGoodHeap $h) (= ($IsAlloc DatatypeTypeType (|#M2.Path.Extend| |a#6#0#0@@0| |a#6#1#0@@0|) Tclass.M2.Path $h)  (and ($IsAlloc DatatypeTypeType |a#6#0#0@@0| Tclass.M2.Path $h) ($IsAlloc refType |a#6#1#0@@0| Tclass.M2.Node $h))))
 :qid |SchorrWaitestagesdfy.19:34|
 :skolemid |2178|
 :pattern ( ($IsAlloc DatatypeTypeType (|#M2.Path.Extend| |a#6#0#0@@0| |a#6#1#0@@0|) Tclass.M2.Path $h))
)))
...
(assert (forall ((|c#0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0| Tclass.M2.Node $h@@0) ($IsAlloc refType |c#0| Tclass.M2.Node? $h@@0))
 :qid |unknown.0:0|
 :skolemid |2169|
 :pattern ( ($IsAlloc refType |c#0| Tclass.M2.Node $h@@0))
 :pattern ( ($IsAlloc refType |c#0| Tclass.M2.Node? $h@@0))
)))
...
(assert (forall (($h@@1 T@U) ) (!  (=> ($IsGoodHeap $h@@1) ($IsAlloc DatatypeTypeType |#M2.Path.Empty| Tclass.M2.Path $h@@1))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2172|
 :pattern ( ($IsAlloc DatatypeTypeType |#M2.Path.Empty| Tclass.M2.Path $h@@1))
)))
...
(assert (forall (($o@@0 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass.M2.Node? $h@@2)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2159|
 :pattern ( ($IsAlloc refType $o@@0 Tclass.M2.Node? $h@@2))
)))
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.M2.Node) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) Tclass.M2.Node)))
 :qid |unknown.0:0|
 :skolemid |2030|
 :pattern ( ($IsBox bx@@0 Tclass.M2.Node))
)))
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass.M2.Node?) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) Tclass.M2.Node?)))
 :qid |unknown.0:0|
 :skolemid |2031|
 :pattern ( ($IsBox bx@@1 Tclass.M2.Node?))
)))
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.M2.Path) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@2)) bx@@2) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@2) Tclass.M2.Path)))
 :qid |unknown.0:0|
 :skolemid |2062|
 :pattern ( ($IsBox bx@@2 Tclass.M2.Path))
)))
...
(assert (forall (($h@@3 T@U) ($o@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) Tclass.M2.Node?))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@1) M2.Node.children)) (TSeq Tclass.M2.Node?)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2162|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@1) M2.Node.children)))
)))
(assert (forall (($h@@4 T@U) ($o@@2 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass.M2.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) alloc)))) ($IsAlloc SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) M2.Node.children)) (TSeq Tclass.M2.Node?) $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2163|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) M2.Node.children)))
)))
(assert (forall (($ly@@1 T@U) ($Heap@@1 T@U) (|source#0@@1| T@U) (|p#0@@1| T@U) (|sink#0@@1| T@U) (|S#0@@1| T@U) ) (! (= (M2.__default.ReachableVia ($LS $ly@@1) $Heap@@1 |source#0@@1| |p#0@@1| |sink#0@@1| |S#0@@1|) (M2.__default.ReachableVia $ly@@1 $Heap@@1 |source#0@@1| |p#0@@1| |sink#0@@1| |S#0@@1|))
 :qid |SchorrWaitestagesdfy.27:19|
 :skolemid |2148|
 :pattern ( (M2.__default.ReachableVia ($LS $ly@@1) $Heap@@1 |source#0@@1| |p#0@@1| |sink#0@@1| |S#0@@1|))
)))
...
(assert (forall ((d@@4 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (M2.Path.Extend_q d@@4) ($IsAlloc DatatypeTypeType d@@4 Tclass.M2.Path $h@@5))) ($IsAlloc DatatypeTypeType (M2.Path._h0 d@@4) Tclass.M2.Path $h@@5))
 :qid |unknown.0:0|
 :skolemid |2179|
 :pattern ( ($IsAlloc DatatypeTypeType (M2.Path._h0 d@@4) Tclass.M2.Path $h@@5))
)))
(assert (forall ((d@@5 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (M2.Path.Extend_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass.M2.Path $h@@6))) ($IsAlloc refType (M2.Path._h1 d@@5) Tclass.M2.Node $h@@6))
 :qid |unknown.0:0|
 :skolemid |2180|
 :pattern ( ($IsAlloc refType (M2.Path._h1 d@@5) Tclass.M2.Node $h@@6))
)))
...
(set-info :boogie-vc-id CheckWellformed$$M2.__default.ReachableVia)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall (($olderHeap@@0 T@U) ) (!  (=> (and (and ($IsGoodHeap $olderHeap@@0) ($OlderTag $olderHeap@@0)) (and (M2.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2|) (and (and ($IsAlloc refType |source#0@@2| Tclass.M2.Node $olderHeap@@0) ($IsAlloc refType |sink#0@@2| Tclass.M2.Node $olderHeap@@0)) ($IsAlloc SetType |S#0@@2| (TSet Tclass.M2.Node) $olderHeap@@0)))) ($IsAlloc DatatypeTypeType |p#0@@2| Tclass.M2.Path $olderHeap@@0))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2156|
 :pattern ( ($OlderTag $olderHeap@@0))
)))))
(let ((anon9_correct  (=> (and (= (M2.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2|)  (and (and (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#Z#0@0|) M2.Node.children)) ($Box refType |sink#0@@2|))) (M2.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |prefix#Z#0@0| |n#Z#0@0| |S#0@@2|))) (=> (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#Z#0@0|) M2.Node.children)) ($Box refType |sink#0@@2|)) (|M2.__default.ReachableVia#canCall| $Heap@@2 |source#0@@2| |prefix#Z#0@0| |n#Z#0@0| |S#0@@2|)))) (=> (and (and ($Is boolType (bool_2_U (M2.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2|)) TBool) |b$reqreads#0@1|) (and |b$reqreads#1@1| (= (ControlFlow 0 6) 4))) GeneratedUnifiedExit_correct))))
(let ((anon16_Else_correct  (=> (not (and (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#Z#0@0|) M2.Node.children)) ($Box refType |sink#0@@2|)))) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 8) 6)) anon9_correct))))
(let ((anon16_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#Z#0@0|) M2.Node.children)) ($Box refType |sink#0@@2|))) ($IsAlloc refType |source#0@@2| Tclass.M2.Node $Heap@@2)) (=> (and (and (and ($IsAlloc DatatypeTypeType |prefix#Z#0@0| Tclass.M2.Path $Heap@@2) ($IsAlloc refType |n#Z#0@0| Tclass.M2.Node $Heap@@2)) (and ($IsAlloc SetType |S#0@@2| (TSet Tclass.M2.Node) $Heap@@2) (= |b$reqreads#1@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@4) alloc)))) (|Set#IsMember| |S#0@@2| ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |SchorrWaitestagesdfy.33:63|
 :skolemid |2157|
))))) (and (and (< (DtRank |prefix#Z#0@0|) (DtRank |p#0@@2|)) (|M2.__default.ReachableVia#canCall| $Heap@@2 |source#0@@2| |prefix#Z#0@0| |n#Z#0@0| |S#0@@2|)) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 7) 6)))) anon9_correct))))
...
(let ((anon15_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (or (not (= |n#Z#0@0| null)) (not true))) (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |n#Z#0@0| M2.Node.children))) (= |b$reqreads#0@1| |b$reqreads#0@0|))) (and (=> (= (ControlFlow 0 9) 7) anon16_Then_correct) (=> (= (ControlFlow 0 9) 8) anon16_Else_correct)))))
(let ((anon14_Then_correct  (=> (= |p#0@@2| (|#M2.Path.Extend| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#0| Tclass.M2.Path) ($Is refType |_mcc#1#0| Tclass.M2.Node)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is refType |let#0#0#0| Tclass.M2.Node))) (and (and (= |n#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| Tclass.M2.Path) (= |prefix#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 11) 9) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (and (and (= |p#0@@2| |#M2.Path.Empty|) (= (M2.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2|) (= |source#0@@2| |sink#0@@2|))) (and ($Is boolType (bool_2_U (M2.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2|)) TBool) (= (ControlFlow 0 5) 4))) GeneratedUnifiedExit_correct)))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |p#0@@2| |#M2.Path.Empty|)) (not true)) (and (=> (= (ControlFlow 0 12) 11) anon14_Then_correct) (=> (= (ControlFlow 0 12) 2) anon14_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($Is refType |source#0@@2| Tclass.M2.Node) ($Is DatatypeTypeType |p#0@@2| Tclass.M2.Path))) (and (and ($Is refType |sink#0@@2| Tclass.M2.Node) ($Is SetType |S#0@@2| (TSet Tclass.M2.Node))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 14) 13)))) anon0_correct)))
