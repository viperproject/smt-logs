...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@17 T@U) ($f@@1 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@17 $f@@1))  (=> (and (or (not (= $o@@17 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@17) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |699|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@17 $f@@1))
)))
...
(assert (forall ((_module.List$T@@13 T@U) ($h@@15 T@U) ($o@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) (Tclass._module.List? _module.List$T@@13)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@18) _module.List.Contents)) (TSeq _module.List$T@@13)))
 :qid |unknown.0:0|
 :skolemid |637|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@18) _module.List.Contents)) (Tclass._module.List? _module.List$T@@13))
)))
(assert (forall ((_module.List$T@@14 T@U) ($h@@16 T@U) ($o@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) (Tclass._module.List? _module.List$T@@14)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@19) _module.List.head)) (Tclass._module.LLNode _module.List$T@@14)))
 :qid |unknown.0:0|
 :skolemid |644|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@19) _module.List.head)) (Tclass._module.List? _module.List$T@@14))
)))
(assert (forall ((_module.LLNode$T@@16 T@U) ($h@@17 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) (Tclass._module.LLNode? _module.LLNode$T@@16)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) _module.LLNode.next)) (Tclass._module.LLNode? _module.LLNode$T@@16)))
 :qid |unknown.0:0|
 :skolemid |682|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) _module.LLNode.next)) (Tclass._module.LLNode? _module.LLNode$T@@16))
)))
(assert (forall ((_module.LLNode$T@@17 T@U) ($h@@18 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) (Tclass._module.LLNode? _module.LLNode$T@@17)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) _module.LLNode.TailContents)) (TSeq _module.LLNode$T@@17)))
 :qid |unknown.0:0|
 :skolemid |684|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) _module.LLNode.TailContents)) (Tclass._module.LLNode? _module.LLNode$T@@17))
)))
...
(declare-fun |h#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.List.Init)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@2 alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._module.LLNode? _module.List$T@@17))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@2 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 29)) true) (and (=> (= (ControlFlow 0 2) (- 0 28)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 27)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.LLNode.next))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.LLNode.next)) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.LLNode.next ($Box refType null)))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 2) (- 0 26)) true) (and (=> (= (ControlFlow 0 2) (- 0 25)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 24)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.LLNode.TailContents))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.LLNode.TailContents)) (=> (= |$rhs#1@0| (Lit SeqType |Seq#Empty|)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) _module.LLNode.TailContents ($Box SeqType |$rhs#1@0|)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 23)) true) (and (=> (= (ControlFlow 0 2) (- 0 22)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 21)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.LLNode.Repr))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.LLNode.Repr)) (and (=> (= (ControlFlow 0 2) (- 0 20)) true) (=> (= |$rhs#2@0| (|Set#UnionOne| |Set#Empty| ($Box refType $nw@0))) (=> (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.LLNode.Repr ($Box SetType |$rhs#2@0|)))) ($IsGoodHeap $Heap@3)) (and (=> (= (ControlFlow 0 2) (- 0 19)) true) (=> (= this.Contents@0 (Lit SeqType |Seq#Empty|)) (and (=> (= (ControlFlow 0 2) (- 0 18)) true) (and (=> (= (ControlFlow 0 2) (- 0 17)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (= this.Repr@0 (|Set#Union| (|Set#UnionOne| |Set#Empty| ($Box refType this@@4)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) _module.LLNode.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) true) (=> (and (and (and (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 (Tclass._module.List? _module.List$T@@17))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@4) alloc))))) (and (= ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@4) _module.List.Contents)) this.Contents@0) (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@4) _module.List.Repr)) this.Repr@0))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@4) _module.List.head)) $nw@0) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@4 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@4) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr)) ($Box refType this@@4))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr)) ($Box refType this@@4)))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head)))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr)))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)) ($Box refType this@@4)))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)) ($Box refType this@@4))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.TailContents)) |Seq#Empty|))))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.TailContents)) |Seq#Empty|)))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)))))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))) _module.LLNode.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr))))))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))) _module.LLNode.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.Repr)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))) _module.LLNode.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))))))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))) _module.LLNode.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head)))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS ($LS $LZ)) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))))))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS ($LS $LZ)) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.TailContents)) (|Seq#Append| (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))) _module.LLNode.data)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))) _module.LLNode.TailContents)))))))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (=> (|_module.LLNode.IsWellFormed#canCall| _module.List$T@@17 $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (or (_module.LLNode.IsWellFormed _module.List$T@@17 ($LS $LZ) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next)) null)) (not true)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.TailContents)) (|Seq#Append| (|Seq#Build| |Seq#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))) _module.LLNode.data)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.next))) _module.LLNode.TailContents))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.TailContents)))))) (=> (=> (|_module.List.IsList#canCall| _module.List$T@@17 $Heap@4 this@@4) (or (_module.List.IsList _module.List$T@@17 $Heap@4 this@@4) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Contents)) ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.head))) _module.LLNode.TailContents))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Contents)) |Seq#Empty|)) (=> (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Contents)) |Seq#Empty|) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@22 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr)) ($Box refType $o@@22)) (or (not (= $o@@22 null)) (not true)))
 :qid |SeparationLogicListdfy.123:43|
 :skolemid |664|
 :pattern (  (or (not (= $o@@22 null)) (not true)))
)) (forall (($o@@23 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr)) ($Box refType $o@@23)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@23) alloc)))))
 :qid |SeparationLogicListdfy.123:43|
 :skolemid |665|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@4) _module.List.Repr)) ($Box refType $o@@23)))
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (=> |defass#h#0| (and ($Is refType |h#0| (Tclass._module.LLNode _module.List$T@@17)) ($IsAlloc refType |h#0| (Tclass._module.LLNode _module.List$T@@17) $Heap@@2))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 30) 2))) anon0_correct))))
