...
(declare-fun $LZ () T@U)
(declare-fun |t#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.ExtensibleArray.Get)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.Contents))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@23 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@23) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@23)))
 :qid |ExtensibleArraydfy.55:10|
 :skolemid |591|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23))
)) ($HeapSucc $Heap@@2 $Heap@0))) (and (and ($IsBox |t#0@0| _module.ExtensibleArray$T@@25) ($IsAllocBox |t#0@0| _module.ExtensibleArray$T@@25 $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 |i#0@@0|) (< |i#0@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)))))))))
(let ((anon4_Else_correct  (=> (and (< |i#0@@0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (<= (LitInt 0) |i#0@@0|) (= (ControlFlow 0 3) 2)) anon3_correct)))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) ($IsAllocBox ($Box refType this@@3) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@25) $Heap@@2)) (and (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@@2 this@@3) (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@@2 this@@3))) (and (=> (= (ControlFlow 0 5) 3) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@25)) ($IsAlloc refType this@@3 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@25) $Heap@@2)))) (and (and ($IsBox |t#0| _module.ExtensibleArray$T@@25) ($IsAllocBox |t#0| _module.ExtensibleArray$T@@25 $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
