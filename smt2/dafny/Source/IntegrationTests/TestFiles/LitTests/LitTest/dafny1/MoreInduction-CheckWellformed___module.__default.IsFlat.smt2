...
(assert (distinct TBool TagBool alloc Tagclass._module.List Tagclass._module.Node |##_module.List.Nil| |##_module.List.Cons| |##_module.Node.Element| |##_module.Node.Nary| tytagFamily$List tytagFamily$Node)
)
...
(assert (forall ((_module.List$X@@6 T@U) (bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 (Tclass._module.List _module.List$X@@6)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@0)) bx@@0) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@0) (Tclass._module.List _module.List$X@@6))))
 :qid |unknown.0:0|
 :skolemid |530|
 :pattern ( ($IsBox bx@@0 (Tclass._module.List _module.List$X@@6)))
)))
(assert (forall ((_module.Node$X@@6 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._module.Node _module.Node$X@@6)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) (Tclass._module.Node _module.Node$X@@6))))
 :qid |unknown.0:0|
 :skolemid |547|
 :pattern ( ($IsBox bx@@1 (Tclass._module.Node _module.Node$X@@6)))
)))
...
(declare-fun _module._default.IsFlat$F@@2 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.IsFlat)
...
(let ((anon14_Else_correct  (=> (or (not (= |n#Z#0@0| (|#_module.Node.Element| |_mcc#2#0|))) (not true)) (and (=> (= (ControlFlow 0 8) 6) anon15_Then_correct) (=> (= (ControlFlow 0 8) 7) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (= |n#Z#0@0| (|#_module.Node.Element| |_mcc#2#0|)) (=> (and ($IsBox |_mcc#2#0| _module._default.IsFlat$F@@2) (= |let#3#0#0| |_mcc#2#0|)) (=> (and (and ($IsBox |let#3#0#0| _module._default.IsFlat$F@@2) (= |x#Z#0@0| |let#3#0#0|)) (and ($IsAlloc DatatypeTypeType |rest#Z#0@0| (Tclass._module.List _module._default.IsFlat$F@@2) $Heap) (= (ControlFlow 0 5) (- 0 4)))) (< (DtRank |rest#Z#0@0|) (DtRank |list#0@@2|)))))))
(let ((anon13_Then_correct  (=> (= |list#0@@2| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#0| (Tclass._module.Node _module._default.IsFlat$F@@2)) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.IsFlat$F@@2))) (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.IsFlat$F@@2)))) (and (and (= |rest#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| (Tclass._module.Node _module._default.IsFlat$F@@2)) (= |n#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 9) 5) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct))))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (or (not (= |list#0@@2| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 10) 9) anon13_Then_correct) (=> (= (ControlFlow 0 10) 3) anon13_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |list#0@@2| (Tclass._module.List _module._default.IsFlat$F@@2))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
