...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split87)
...
)) (=> (and (< 0 (|Seq#Length| |stackNodes#0@1|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (- (|Seq#Length| |stackNodes#0@1|) 1)) (< (- (|Seq#Length| |stackNodes#0@1|) 1) (|Seq#Length| |stackNodes#0@1|)))))))
