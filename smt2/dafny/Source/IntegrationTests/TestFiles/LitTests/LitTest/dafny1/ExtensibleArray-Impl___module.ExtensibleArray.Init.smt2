...
(assert (forall ((_module.ExtensibleArray$T@@6 T@U) ($ly@@1 T@U) ($h0 T@U) ($h1 T@U) (this@@1 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@6)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f T@U) )  (=> (and (or (not (= $o@@6 null)) (not true)) (or (= $o@@6 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 this@@1) _module.ExtensibleArray.Repr)) ($Box refType $o@@6)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@6) $f)))) (= (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@6 $ly@@1 $h0 this@@1) (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@6 $ly@@1 $h1 this@@1))))
