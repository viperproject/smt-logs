...
(assert (forall ((_module.ExtensibleArray$T@@20 T@U) ($h@@17 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@20)))) ($Is SeqType ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) _module.ExtensibleArray.Contents)) (TSeq _module.ExtensibleArray$T@@20)))
 :qid |unknown.0:0|
 :skolemid |515|
 :pattern ( ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) _module.ExtensibleArray.Contents)) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@20))
)))
(assert (forall ((_module.ExtensibleArray$T@@21 T@U) ($h@@18 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@21)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) _module.ExtensibleArray.elements)) (Tclass._System.array? _module.ExtensibleArray$T@@21)))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) _module.ExtensibleArray.elements)) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@21))
)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (forall ((_module.ExtensibleArray$T@@24 T@U) ($h@@19 T@U) ($o@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@24)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@22) _module.ExtensibleArray.more)) (Tclass._module.ExtensibleArray? (Tclass._System.array? _module.ExtensibleArray$T@@24))))
 :qid |unknown.0:0|
 :skolemid |521|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@22) _module.ExtensibleArray.more)) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@24))
)))
...
(declare-fun this.length@0 () Int)
(declare-fun this.M@0 () Int)
...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.ExtensibleArray.Init)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (and (and (and (= this.length@0 (LitInt 0)) (= this.M@0 (LitInt 0))) (and (= this.Contents@0 (Lit SeqType |Seq#Empty|)) (= this.Repr@0 (|Set#UnionOne| |Set#Empty| ($Box refType this@@3))))) (and (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@25))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) alloc)))) (= ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.Contents)) this.Contents@0)))) (and (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.Repr)) this.Repr@0) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.elements)) null)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.more)) null) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.length))) this.length@0))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.M))) this.M@0) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType this@@3))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType this@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType null)))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (or (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |Seq#Empty|)) (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements)) null)) (not true)) (= (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements))) (LitInt 256))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (or (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |Seq#Empty|)) (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements)) null)) (not true)) (= (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements))) (LitInt 256))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements)))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Repr)) ($Box refType this@@3))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Repr)) ($Box refType this@@3)))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements)))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (_module.ExtensibleArray.Valid (Tclass._System.array? _module.ExtensibleArray$T@@25) ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (_module.ExtensibleArray.Valid (Tclass._System.array? _module.ExtensibleArray$T@@25) ($LS ($LS $LZ)) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (or (not (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))) 0)) (not true)))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (or (not (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))) 0)) (not true))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (forall ((|j#1| Int) ) (!  (and (and (and (and (and (=> (and (<= (LitInt 0) |j#1|) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (or (not (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1|)) null)) (not true))) (=> (and (<= (LitInt 0) |j#1|) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (= (_System.array.Length ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1|))) (LitInt 256)))) (=> (and (<= (LitInt 0) |j#1|) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1|)))) (=> (and (<= (LitInt 0) |j#1|) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Repr)) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1|))))) (=> (and (<= (LitInt 0) |j#1|) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (or (not (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1|)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements)))) (not true)))) (=> (and (<= (LitInt 0) |j#1|) (< |j#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (forall ((|k#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |k#1|) (< |k#1| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (or (not (= |k#1| |j#1|)) (not true))) (or (not (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1|)) ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |k#1|)))) (not true)))
 :qid |ExtensibleArraydfy.29:20|
 :skolemid |580|
 :pattern ( ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |k#1|)))
))))
 :qid |ExtensibleArraydfy.25:16|
 :skolemid |581|
 :pattern ( ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1|)))
)))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (forall ((|j#1@@0| Int) ) (!  (and (and (and (and (and (=> (and (<= (LitInt 0) |j#1@@0|) (< |j#1@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (or (not (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1@@0|)) null)) (not true))) (=> (and (<= (LitInt 0) |j#1@@0|) (< |j#1@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (= (_System.array.Length ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1@@0|))) (LitInt 256)))) (=> (and (<= (LitInt 0) |j#1@@0|) (< |j#1@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1@@0|)))) (=> (and (<= (LitInt 0) |j#1@@0|) (< |j#1@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Repr)) (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1@@0|))))) (=> (and (<= (LitInt 0) |j#1@@0|) (< |j#1@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (or (not (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1@@0|)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements)))) (not true)))) (=> (and (<= (LitInt 0) |j#1@@0|) (< |j#1@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (forall ((|k#1@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) |k#1@@0|) (< |k#1@@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))) (or (not (= |k#1@@0| |j#1@@0|)) (not true))) (or (not (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1@@0|)) ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |k#1@@0|)))) (not true)))
 :qid |ExtensibleArraydfy.29:20|
 :skolemid |580|
 :pattern ( ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |k#1@@0|)))
))))
 :qid |ExtensibleArraydfy.25:16|
 :skolemid |581|
 :pattern ( ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) |j#1@@0|)))
))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null) 0 (Mul (LitInt 256) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents))))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null) 0 (Mul (LitInt 256) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))) 256))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))) 256)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length)))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more)) null)) (not true)) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents))))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (forall ((|i#2| Int) ) (!  (=> (and (<= (LitInt 0) |i#2|) (< |i#2| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))))) (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |i#2|) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) (Div |i#2| (LitInt 256))))) (IndexField (Mod |i#2| (LitInt 256))))))
 :qid |ExtensibleArraydfy.38:13|
 :skolemid |582|
 :pattern ( ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) (Div |i#2| 256))))
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |i#2|))
))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (forall ((|i#2@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#2@@0|) (< |i#2@@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))))) (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |i#2@@0|) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) (Div |i#2@@0| (LitInt 256))))) (IndexField (Mod |i#2@@0| (LitInt 256))))))
 :qid |ExtensibleArraydfy.38:13|
 :skolemid |582|
 :pattern ( ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.more))) _module.ExtensibleArray.Contents)) (Div |i#2@@0| 256))))
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |i#2@@0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (forall ((|i#3| Int) ) (!  (=> (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))) |i#3|) (< |i#3| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length))))) (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |i#3|) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements))) (IndexField (- |i#3| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))))))))
 :qid |ExtensibleArraydfy.39:13|
 :skolemid |583|
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |i#3|))
))))) (=> (=> (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (or (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3) (forall ((|i#3@@0| Int) ) (!  (=> (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))) |i#3@@0|) (< |i#3@@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.length))))) (= (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |i#3@@0|) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.elements))) (IndexField (- |i#3@@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.M))))))))
 :qid |ExtensibleArraydfy.39:13|
 :skolemid |583|
 :pattern ( (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |i#3@@0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (forall (($o@@23 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@23)) (or (not (= $o@@23 null)) (not true)))
 :qid |ExtensibleArraydfy.43:24|
 :skolemid |588|
 :pattern (  (or (not (= $o@@23 null)) (not true)))
)) (forall (($o@@24 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@24)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@24) alloc)))))
 :qid |ExtensibleArraydfy.43:24|
 :skolemid |589|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@24)))
)))) (=> (and (forall (($o@@25 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@25)) (or (not (= $o@@25 null)) (not true)))
 :qid |ExtensibleArraydfy.43:24|
 :skolemid |588|
 :pattern (  (or (not (= $o@@25 null)) (not true)))
)) (forall (($o@@26 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@26)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@26) alloc)))))
 :qid |ExtensibleArraydfy.43:24|
 :skolemid |589|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@26)))
))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Seq#Equal| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Contents)) |Seq#Empty|))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 21) 2))) anon0_correct)))
