...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap T@U) (|p#0| T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.dropWhileAlways#canCall| |p#0| (Lit DatatypeTypeType |xs#0@@1|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |p#0| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|y#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@1|)))))
 (and (|$IsA#_module.Nat| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap |p#0| ($Box DatatypeTypeType |y#3|)))) (=> (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap |p#0| ($Box DatatypeTypeType |y#3|))) |#_module.Nat.Zero|)) (|_module.__default.dropWhileAlways#canCall| |p#0| |ys#3|)))))) (= (_module.__default.dropWhileAlways ($LS $ly@@1) |p#0| (Lit DatatypeTypeType |xs#0@@1|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@1|)) |#_module.List.Nil| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@1|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@1|)))))
(ite  (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap |p#0| ($Box DatatypeTypeType |y#2|))) |#_module.Nat.Zero|)) (_module.__default.dropWhileAlways ($LS $ly@@1) |p#0| |ys#2|) (|#_module.List.Cons| |y#2| |ys#2|))))))))
 :qid |Ripplinglegacydfy.183:16|
 :weight 3
 :skolemid |720|
 :pattern ( (_module.__default.dropWhileAlways ($LS $ly@@1) |p#0| (Lit DatatypeTypeType |xs#0@@1|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@0 T@U) (|p#0@@0| T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.takeWhileAlways#canCall| |p#0@@0| (Lit DatatypeTypeType |xs#0@@2|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |p#0@@0| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|ys#3@@0| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#3@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
 (and (|$IsA#_module.Nat| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@0 |p#0@@0| ($Box DatatypeTypeType |y#3@@0|)))) (=> (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@0 |p#0@@0| ($Box DatatypeTypeType |y#3@@0|))) |#_module.Nat.Zero|)) (|_module.__default.takeWhileAlways#canCall| |p#0@@0| |ys#3@@0|)))))) (= (_module.__default.takeWhileAlways ($LS $ly@@2) |p#0@@0| (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |#_module.List.Nil| (let ((|ys#2@@0| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|y#2@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
(ite  (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@0 |p#0@@0| ($Box DatatypeTypeType |y#2@@0|))) |#_module.Nat.Zero|)) (|#_module.List.Cons| |y#2@@0| (_module.__default.takeWhileAlways ($LS $ly@@2) |p#0@@0| |ys#2@@0|)) |#_module.List.Nil|)))))))
 :qid |Ripplinglegacydfy.173:16|
 :weight 3
 :skolemid |712|
 :pattern ( (_module.__default.takeWhileAlways ($LS $ly@@2) |p#0@@0| (Lit DatatypeTypeType |xs#0@@2|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) ($Heap@@1 T@U) (|p#0@@1| T@U) (|xs#0@@3| T@U) ) (!  (=> (or (|_module.__default.dropWhileAlways#canCall| (Lit HandleTypeType |p#0@@1|) (Lit DatatypeTypeType |xs#0@@3|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@3| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@3|)))))) (let ((|ys#5| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@3|)))))
(let ((|y#5| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@3|)))))
 (and (|$IsA#_module.Nat| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 (Lit HandleTypeType |p#0@@1|) ($Box DatatypeTypeType |y#5|)))) (=> (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 (Lit HandleTypeType |p#0@@1|) ($Box DatatypeTypeType |y#5|))) |#_module.Nat.Zero|)) (|_module.__default.dropWhileAlways#canCall| (Lit HandleTypeType |p#0@@1|) |ys#5|)))))) (= (_module.__default.dropWhileAlways ($LS $ly@@3) (Lit HandleTypeType |p#0@@1|) (Lit DatatypeTypeType |xs#0@@3|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@3|)) |#_module.List.Nil| (let ((|ys#4| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@3|)))))
(let ((|y#4| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@3|)))))
(ite  (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@1 (Lit HandleTypeType |p#0@@1|) ($Box DatatypeTypeType |y#4|))) |#_module.Nat.Zero|)) (_module.__default.dropWhileAlways ($LS $ly@@3) (Lit HandleTypeType |p#0@@1|) |ys#4|) (|#_module.List.Cons| |y#4| |ys#4|))))))))
 :qid |Ripplinglegacydfy.183:16|
 :weight 3
 :skolemid |721|
 :pattern ( (_module.__default.dropWhileAlways ($LS $ly@@3) (Lit HandleTypeType |p#0@@1|) (Lit DatatypeTypeType |xs#0@@3|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@4 T@U) (|xs#0@@4| T@U) (|ys#0@@1| T@U) ) (!  (=> (or (|_module.__default.concat#canCall| |xs#0@@4| |ys#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@4| Tclass._module.List) ($Is DatatypeTypeType |ys#0@@1| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.concat $ly@@4 |xs#0@@4| |ys#0@@1|) Tclass._module.List))
 :qid |Ripplinglegacydfy.99:16|
 :skolemid |643|
 :pattern ( (_module.__default.concat $ly@@4 |xs#0@@4| |ys#0@@1|))
))))
(assert (forall (($ly@@5 T@U) (|xs#0@@5| T@U) (|ys#0@@2| T@U) ) (! (= (_module.__default.concat ($LS $ly@@5) |xs#0@@5| |ys#0@@2|) (_module.__default.concat $ly@@5 |xs#0@@5| |ys#0@@2|))
 :qid |Ripplinglegacydfy.99:16|
 :skolemid |640|
 :pattern ( (_module.__default.concat ($LS $ly@@5) |xs#0@@5| |ys#0@@2|))
)))
(assert (forall (($ly@@6 T@U) (|p#0@@2| T@U) (|xs#0@@6| T@U) ) (! (= (_module.__default.takeWhileAlways ($LS $ly@@6) |p#0@@2| |xs#0@@6|) (_module.__default.takeWhileAlways $ly@@6 |p#0@@2| |xs#0@@6|))
 :qid |Ripplinglegacydfy.173:16|
 :skolemid |707|
 :pattern ( (_module.__default.takeWhileAlways ($LS $ly@@6) |p#0@@2| |xs#0@@6|))
)))
(assert (forall (($ly@@7 T@U) (|p#0@@3| T@U) (|xs#0@@7| T@U) ) (! (= (_module.__default.dropWhileAlways ($LS $ly@@7) |p#0@@3| |xs#0@@7|) (_module.__default.dropWhileAlways $ly@@7 |p#0@@3| |xs#0@@7|))
 :qid |Ripplinglegacydfy.183:16|
 :skolemid |715|
 :pattern ( (_module.__default.dropWhileAlways ($LS $ly@@7) |p#0@@3| |xs#0@@7|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@8 T@U) ($Heap@@2 T@U) (|p#0@@4| T@U) (|xs#0@@8| T@U) ) (!  (=> (or (|_module.__default.takeWhileAlways#canCall| (Lit HandleTypeType |p#0@@4|) (Lit DatatypeTypeType |xs#0@@8|)) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@2) ($Is HandleTypeType |p#0@@4| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@8| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@8|)))))) (let ((|ys#5@@0| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@8|)))))
(let ((|y#5@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@8|)))))
 (and (|$IsA#_module.Nat| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@2 (Lit HandleTypeType |p#0@@4|) ($Box DatatypeTypeType |y#5@@0|)))) (=> (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@2 (Lit HandleTypeType |p#0@@4|) ($Box DatatypeTypeType |y#5@@0|))) |#_module.Nat.Zero|)) (|_module.__default.takeWhileAlways#canCall| (Lit HandleTypeType |p#0@@4|) |ys#5@@0|)))))) (= (_module.__default.takeWhileAlways ($LS $ly@@8) (Lit HandleTypeType |p#0@@4|) (Lit DatatypeTypeType |xs#0@@8|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@8|)) |#_module.List.Nil| (let ((|ys#4@@0| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@8|)))))
(let ((|y#4@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@8|)))))
(ite  (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@2 (Lit HandleTypeType |p#0@@4|) ($Box DatatypeTypeType |y#4@@0|))) |#_module.Nat.Zero|)) (|#_module.List.Cons| |y#4@@0| (Lit DatatypeTypeType (_module.__default.takeWhileAlways ($LS $ly@@8) (Lit HandleTypeType |p#0@@4|) |ys#4@@0|))) |#_module.List.Nil|)))))))
 :qid |Ripplinglegacydfy.173:16|
 :weight 3
 :skolemid |713|
 :pattern ( (_module.__default.takeWhileAlways ($LS $ly@@8) (Lit HandleTypeType |p#0@@4|) (Lit DatatypeTypeType |xs#0@@8|)) ($IsGoodHeap $Heap@@2))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@9 T@U) ($Heap@@3 T@U) (|p#0@@5| T@U) (|xs#0@@9| T@U) ) (!  (=> (or (|_module.__default.dropWhileAlways#canCall| |p#0@@5| |xs#0@@9|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) ($Is HandleTypeType |p#0@@5| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@9| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@9|)) (let ((|ys#1| (_module.List._h2 |xs#0@@9|)))
(let ((|y#1| (_module.List._h1 |xs#0@@9|)))
 (and (|$IsA#_module.Nat| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@3 |p#0@@5| ($Box DatatypeTypeType |y#1|)))) (=> (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@3 |p#0@@5| ($Box DatatypeTypeType |y#1|))) |#_module.Nat.Zero|)) (|_module.__default.dropWhileAlways#canCall| |p#0@@5| |ys#1|)))))) (= (_module.__default.dropWhileAlways ($LS $ly@@9) |p#0@@5| |xs#0@@9|) (ite (_module.List.Nil_q |xs#0@@9|) |#_module.List.Nil| (let ((|ys#0@@3| (_module.List._h2 |xs#0@@9|)))
(let ((|y#0| (_module.List._h1 |xs#0@@9|)))
(ite  (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@3 |p#0@@5| ($Box DatatypeTypeType |y#0|))) |#_module.Nat.Zero|)) (_module.__default.dropWhileAlways $ly@@9 |p#0@@5| |ys#0@@3|) (|#_module.List.Cons| |y#0| |ys#0@@3|))))))))
 :qid |Ripplinglegacydfy.183:16|
 :skolemid |719|
 :pattern ( (_module.__default.dropWhileAlways ($LS $ly@@9) |p#0@@5| |xs#0@@9|) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@10 T@U) (|p#0@@6| T@U) (|xs#0@@10| T@U) ) (!  (=> (or (|_module.__default.takeWhileAlways#canCall| |p#0@@6| |xs#0@@10|) (and (< 2 $FunctionContextHeight) (and ($Is HandleTypeType |p#0@@6| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($Is DatatypeTypeType |xs#0@@10| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.takeWhileAlways $ly@@10 |p#0@@6| |xs#0@@10|) Tclass._module.List))
 :qid |Ripplinglegacydfy.173:16|
 :skolemid |709|
 :pattern ( (_module.__default.takeWhileAlways $ly@@10 |p#0@@6| |xs#0@@10|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@11 T@U) (|p#0@@7| T@U) (|xs#0@@11| T@U) ) (!  (=> (or (|_module.__default.dropWhileAlways#canCall| |p#0@@7| |xs#0@@11|) (and (< 2 $FunctionContextHeight) (and ($Is HandleTypeType |p#0@@7| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($Is DatatypeTypeType |xs#0@@11| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.dropWhileAlways $ly@@11 |p#0@@7| |xs#0@@11|) Tclass._module.List))
 :qid |Ripplinglegacydfy.183:16|
 :skolemid |717|
 :pattern ( (_module.__default.dropWhileAlways $ly@@11 |p#0@@7| |xs#0@@11|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@12 T@U) ($Heap@@4 T@U) (|p#0@@8| T@U) (|xs#0@@12| T@U) ) (!  (=> (or (|_module.__default.takeWhileAlways#canCall| |p#0@@8| |xs#0@@12|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@4) ($Is HandleTypeType |p#0@@8| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat))) ($Is DatatypeTypeType |xs#0@@12| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0@@12|)) (let ((|ys#1@@0| (_module.List._h2 |xs#0@@12|)))
(let ((|y#1@@0| (_module.List._h1 |xs#0@@12|)))
 (and (|$IsA#_module.Nat| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@4 |p#0@@8| ($Box DatatypeTypeType |y#1@@0|)))) (=> (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@4 |p#0@@8| ($Box DatatypeTypeType |y#1@@0|))) |#_module.Nat.Zero|)) (|_module.__default.takeWhileAlways#canCall| |p#0@@8| |ys#1@@0|)))))) (= (_module.__default.takeWhileAlways ($LS $ly@@12) |p#0@@8| |xs#0@@12|) (ite (_module.List.Nil_q |xs#0@@12|) |#_module.List.Nil| (let ((|ys#0@@4| (_module.List._h2 |xs#0@@12|)))
(let ((|y#0@@0| (_module.List._h1 |xs#0@@12|)))
(ite  (not (|_module.Nat#Equal| ($Unbox DatatypeTypeType (Apply1 Tclass._module.Nat Tclass._module.Nat $Heap@@4 |p#0@@8| ($Box DatatypeTypeType |y#0@@0|))) |#_module.Nat.Zero|)) (|#_module.List.Cons| |y#0@@0| (_module.__default.takeWhileAlways $ly@@12 |p#0@@8| |ys#0@@4|)) |#_module.List.Nil|)))))))
 :qid |Ripplinglegacydfy.173:16|
 :skolemid |711|
 :pattern ( (_module.__default.takeWhileAlways ($LS $ly@@12) |p#0@@8| |xs#0@@12|) ($IsGoodHeap $Heap@@4))
))))
(push 1)
...
(set-info :boogie-vc-id Impl$$_module.__default.P43)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@5 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|xs#1| T@U) ) (!  (=> ($Is DatatypeTypeType |xs#1| Tclass._module.List) (|_module.List#Equal| (_module.__default.concat ($LS ($LS $LZ)) (_module.__default.takeWhileAlways ($LS ($LS $LZ)) |p#0@@9| |xs#1|) (_module.__default.dropWhileAlways ($LS ($LS $LZ)) |p#0@@9| |xs#1|)) |xs#1|))
 :qid |Ripplinglegacydfy.518:18|
 :skolemid |1115|
 :pattern ( (_module.__default.dropWhileAlways ($LS ($LS $LZ)) |p#0@@9| |xs#1|))
 :pattern ( (_module.__default.takeWhileAlways ($LS ($LS $LZ)) |p#0@@9| |xs#1|))
)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and ($Is HandleTypeType |p#0@@9| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($IsAlloc HandleTypeType |p#0@@9| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat) $Heap@@5)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
