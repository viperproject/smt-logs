...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc false)) ($IsAllocBox ($Box refType this@@2) (Tclass._module.Node? _module.Node$T@@20) $Heap@@1)) (=> (and (and (and (|_module.Node.Valid#canCall| _module.Node$T@@20 $Heap@@1 this@@2) (_module.Node.Valid _module.Node$T@@20 ($LS $LZ) $Heap@@1 this@@2)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11)))
 :qid |ListContentsdfy.40:10|
 :skolemid |521|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11))
)) ($HeapSucc $Heap@@1 $Heap@0)) (and ($Is refType |r#0@0| (Tclass._module.Node _module.Node$T@@20)) ($IsAlloc refType |r#0@0| (Tclass._module.Node _module.Node$T@@20) $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |r#0@0|) (Tclass._module.Node? _module.Node$T@@20) $Heap@0) (=> (and (|_module.Node.Valid#canCall| _module.Node$T@@20 $Heap@0 |r#0@0|) (_module.Node.Valid _module.Node$T@@20 ($LS $LZ) $Heap@0 |r#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@2 (Tclass._module.Node _module.Node$T@@20) $Heap@@1)) (=> ($IsAlloc refType this@@2 (Tclass._module.Node _module.Node$T@@20) $Heap@@1) (=> (and (and (forall (($o@@12 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Node.Repr)) ($Box refType $o@@12)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.Repr)) ($Box refType $o@@12)))) (or (not (= $o@@12 null)) (not true)))
 :qid |ListContentsdfy.42:26|
 :skolemid |522|
 :pattern (  (or (not (= $o@@12 null)) (not true)))
)) (forall (($o@@13 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) _module.Node.Repr)) ($Box refType $o@@13)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.Repr)) ($Box refType $o@@13)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@13) alloc)))))
 :qid |ListContentsdfy.42:26|
 :skolemid |523|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass._module.Node _module.Node$T@@20)) ($IsAlloc refType this@@2 (Tclass._module.Node _module.Node$T@@20) $Heap@@1))) (and ($IsBox |d#0| _module.Node$T@@20) ($IsAllocBox |d#0| _module.Node$T@@20 $Heap@@1))) (and (and ($Is refType |r#0| (Tclass._module.Node _module.Node$T@@20)) ($IsAlloc refType |r#0| (Tclass._module.Node _module.Node$T@@20) $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
