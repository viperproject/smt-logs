...
(let ((|h#0| (_module.List._h0 |a#0@@1|)))
(|#_module.List.Cons| |h#0| (_module.__default.Append _module._default.Append$T@@1 $ly@@2 |t#0| |b#0@@1|))))))))
 :qid |unknown.0:0|
 :skolemid |599|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.len$T@@0 T@U) ($ly@@3 T@U) (|l#0@@0| T@U) ) (!  (=> (or (|_module.__default.len#canCall| _module._default.len$T@@0 |l#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@0| (Tclass._module.List _module._default.len$T@@0)))) (and (=> (not (_module.List.Nil_q |l#0@@0|)) (let ((|t#1@@0| (_module.List._h1 |l#0@@0|)))
(|_module.__default.len#canCall| _module._default.len$T@@0 |t#1@@0|))) (= (_module.__default.len _module._default.len$T@@0 ($LS $ly@@3) |l#0@@0|) (ite (_module.List.Nil_q |l#0@@0|) 0 (let ((|t#0@@0| (_module.List._h1 |l#0@@0|)))
(+ 1 (_module.__default.len _module._default.len$T@@0 $ly@@3 |t#0@@0|)))))))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( (_module.__default.len _module._default.len$T@@0 ($LS $ly@@3) |l#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.Append$T@@2 T@U) ($ly@@4 T@U) (|a#0@@2| T@U) (|b#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.Append#canCall| _module._default.Append$T@@2 |a#0@@2| |b#0@@2|) (and (< 2 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |a#0@@2| (Tclass._module.List _module._default.Append$T@@2)) ($IsAlloc DatatypeTypeType |a#0@@2| (Tclass._module.List _module._default.Append$T@@2) $Heap)) (and ($Is DatatypeTypeType |b#0@@2| (Tclass._module.List _module._default.Append$T@@2)) ($IsAlloc DatatypeTypeType |b#0@@2| (Tclass._module.List _module._default.Append$T@@2) $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.__default.Append _module._default.Append$T@@2 $ly@@4 |a#0@@2| |b#0@@2|) (Tclass._module.List _module._default.Append$T@@2) $Heap))
 :qid |TreeDatatypedfy.74:16|
 :skolemid |597|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.__default.Append _module._default.Append$T@@2 $ly@@4 |a#0@@2| |b#0@@2|) (Tclass._module.List _module._default.Append$T@@2) $Heap))
))))
...
(assert (forall ((_module._default.Append$T@@3 T@U) ($ly@@5 T@U) (|a#0@@3| T@U) (|b#0@@3| T@U) ) (! (= (_module.__default.Append _module._default.Append$T@@3 ($LS $ly@@5) |a#0@@3| |b#0@@3|) (_module.__default.Append _module._default.Append$T@@3 $ly@@5 |a#0@@3| |b#0@@3|))
 :qid |unknown.0:0|
 :skolemid |594|
 :pattern ( (_module.__default.Append _module._default.Append$T@@3 ($LS $ly@@5) |a#0@@3| |b#0@@3|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.len$T@@1 T@U) ($ly@@6 T@U) (|l#0@@2| T@U) ) (!  (=> (or (|_module.__default.len#canCall| _module._default.len$T@@1 (Lit DatatypeTypeType |l#0@@2|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@2| (Tclass._module.List _module._default.len$T@@1)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@2|)))))) (let ((|t#3@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@2|)))))
(|_module.__default.len#canCall| _module._default.len$T@@1 |t#3@@0|))) (= (_module.__default.len _module._default.len$T@@1 ($LS $ly@@6) (Lit DatatypeTypeType |l#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@2|)) 0 (let ((|t#2@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@2|)))))
(LitInt (+ 1 (_module.__default.len _module._default.len$T@@1 ($LS $ly@@6) |t#2@@0|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |587|
 :pattern ( (_module.__default.len _module._default.len$T@@1 ($LS $ly@@6) (Lit DatatypeTypeType |l#0@@2|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Append)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= (_module.__default.len _module._default.Append$T@@4 ($LS ($LS $LZ)) (_module.__default.Append _module._default.Append$T@@4 ($LS ($LS $LZ)) |a#0@@4| |b#0@@4|)) (+ (_module.__default.len _module._default.Append$T@@4 ($LS ($LS $LZ)) |a#0@@4|) (_module.__default.len _module._default.Append$T@@4 ($LS ($LS $LZ)) |b#0@@4|))))))
(let ((anon10_Then_correct  (=> (= |a#0@@4| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.Append$T@@4) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.Append$T@@4))) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.Append$T@@4))) (and (= |t#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($IsBox |let#1#0#0| _module._default.Append$T@@4) (= |h#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |t#Z#0@0| (Tclass._module.List _module._default.Append$T@@4) $Heap@@0) ($IsAlloc DatatypeTypeType |b#0@@4| (Tclass._module.List _module._default.Append$T@@4) $Heap@@0)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (< (DtRank |t#Z#0@0|) (DtRank |a#0@@4|)) (and (= (DtRank |t#Z#0@0|) (DtRank |a#0@@4|)) (< (DtRank |b#0@@4|) (DtRank |b#0@@4|))))) (=> (or (< (DtRank |t#Z#0@0|) (DtRank |a#0@@4|)) (and (= (DtRank |t#Z#0@0|) (DtRank |a#0@@4|)) (< (DtRank |b#0@@4|) (DtRank |b#0@@4|)))) (=> (|_module.__default.Append#canCall| _module._default.Append$T@@4 |t#Z#0@0| |b#0@@4|) (=> (and (and (= (_module.__default.Append _module._default.Append$T@@4 ($LS $LZ) |a#0@@4| |b#0@@4|) (|#_module.List.Cons| |h#Z#0@0| (_module.__default.Append _module._default.Append$T@@4 ($LS $LZ) |t#Z#0@0| |b#0@@4|))) (|_module.__default.Append#canCall| _module._default.Append$T@@4 |t#Z#0@0| |b#0@@4|)) (and ($Is DatatypeTypeType (_module.__default.Append _module._default.Append$T@@4 ($LS $LZ) |a#0@@4| |b#0@@4|) (Tclass._module.List _module._default.Append$T@@4)) (= (ControlFlow 0 7) 5))) GeneratedUnifiedExit_correct)))))))))
(let ((anon9_Then_correct  (=> (and (and (= |a#0@@4| |#_module.List.Nil|) (= (_module.__default.Append _module._default.Append$T@@4 ($LS $LZ) |a#0@@4| |b#0@@4|) |b#0@@4|)) (and ($Is DatatypeTypeType (_module.__default.Append _module._default.Append$T@@4 ($LS $LZ) |a#0@@4| |b#0@@4|) (Tclass._module.List _module._default.Append$T@@4)) (= (ControlFlow 0 6) 5))) GeneratedUnifiedExit_correct)))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (=> (or (not (= |a#0@@4| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 9) 7) anon10_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_Else_correct)))))
(let ((anon8_Then_correct  (=> (and (and ($Is DatatypeTypeType (_module.__default.Append _module._default.Append$T@@4 ($LS $LZ) |a#0@@4| |b#0@@4|) (Tclass._module.List _module._default.Append$T@@4)) ($IsAlloc DatatypeTypeType |a#0@@4| (Tclass._module.List _module._default.Append$T@@4) $Heap@@0)) (and ($IsAlloc DatatypeTypeType |b#0@@4| (Tclass._module.List _module._default.Append$T@@4) $Heap@@0) (= (ControlFlow 0 2) (- 0 1)))) (or (and (|_module.List#Equal| |a#0@@4| |a#0@@4|) (|_module.List#Equal| |b#0@@4| |b#0@@4|)) (or (< (DtRank |a#0@@4|) (DtRank |a#0@@4|)) (and (= (DtRank |a#0@@4|) (DtRank |a#0@@4|)) (< (DtRank |b#0@@4|) (DtRank |b#0@@4|))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (and (=> (= (ControlFlow 0 10) 2) anon8_Then_correct) (=> (= (ControlFlow 0 10) 6) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |a#0@@4| (Tclass._module.List _module._default.Append$T@@4)) ($Is DatatypeTypeType |b#0@@4| (Tclass._module.List _module._default.Append$T@@4))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
