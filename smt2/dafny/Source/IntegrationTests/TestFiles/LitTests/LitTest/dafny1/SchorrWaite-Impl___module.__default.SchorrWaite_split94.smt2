...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split94)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 63) (let ((anon51_correct  (=> (and (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1)))) _module.Node.childrenVisited))))) |t#0@0|)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |root#0|) _module.Node.marked)))) (=> (and (and ($Is refType |n#18@0| Tclass._module.Node) ($IsAlloc refType |n#18@0| Tclass._module.Node $Heap@2)) (and (|Set#IsMember| |S#0@@5| ($Box refType |n#18@0|)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |n#18@0| null)) (not true))))))
(let ((anon140_Else_correct  (=> (and (<= (|Seq#Length| |stackNodes#0@1|) 0) (= (ControlFlow 0 4) 2)) anon51_correct)))
(let ((anon140_Then_correct  (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (=> (and ($IsAlloc refType ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))) Tclass._module.Node $Heap@@3) (= (ControlFlow 0 3) 2)) anon51_correct))))
...
)) (and (=> (= (ControlFlow 0 5) 3) anon140_Then_correct) (=> (= (ControlFlow 0 5) 4) anon140_Else_correct)))))
(let ((anon139_Else_correct  (=> (and (not (and (<= (LitInt 0) |k#2@0|) (< |k#2@0| (- (|Seq#Length| |stackNodes#0@1|) 1)))) (= (ControlFlow 0 7) 5)) anon49_correct)))
(let ((anon139_Then_correct  (=> (and (and (<= (LitInt 0) |k#2@0|) (< |k#2@0| (- (|Seq#Length| |stackNodes#0@1|) 1))) (and ($IsAlloc refType ($Unbox refType (|Seq#Index| |stackNodes#0@1| |k#2@0|)) Tclass._module.Node $Heap@@3) (= (ControlFlow 0 6) 5))) anon49_correct)))
(let ((anon138_Else_correct  (=> (< |k#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 9) 6) anon139_Then_correct) (=> (= (ControlFlow 0 9) 7) anon139_Else_correct)))))
(let ((anon138_Then_correct  (=> (<= (LitInt 0) |k#2@0|) (and (=> (= (ControlFlow 0 8) 6) anon139_Then_correct) (=> (= (ControlFlow 0 8) 7) anon139_Else_correct)))))
...
)) (and (=> (= (ControlFlow 0 10) 8) anon138_Then_correct) (=> (= (ControlFlow 0 10) 9) anon138_Else_correct)))))
(let ((anon136_Else_correct  (=> (and (not (and (< 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |stackNodes#0@1|)))) (= (ControlFlow 0 12) 10)) anon44_correct)))
(let ((anon136_Then_correct  (=> (and (and (< 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 11) 10)) anon44_correct)))
(let ((anon135_Else_correct  (=> (<= |k#0@0| 0) (and (=> (= (ControlFlow 0 14) 11) anon136_Then_correct) (=> (= (ControlFlow 0 14) 12) anon136_Else_correct)))))
(let ((anon135_Then_correct  (=> (< 0 |k#0@0|) (and (=> (= (ControlFlow 0 13) 11) anon136_Then_correct) (=> (= (ControlFlow 0 13) 12) anon136_Else_correct)))))
(let ((anon39_correct  (=> (=> (< 0 (|Seq#Length| |stackNodes#0@1|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.childrenVisited))))) null)) (and (=> (= (ControlFlow 0 15) 13) anon135_Then_correct) (=> (= (ControlFlow 0 15) 14) anon135_Else_correct)))))
(let ((anon133_Else_correct  (=> (and (<= (|Seq#Length| |stackNodes#0@1|) 0) (= (ControlFlow 0 17) 15)) anon39_correct)))
(let ((anon133_Then_correct  (=> (and (and (< 0 (|Seq#Length| |stackNodes#0@1|)) (|Seq#Contains| |stackNodes#0@1| (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |stackNodes#0@1| (LitInt 0)))) _module.Node.children)))) (= (ControlFlow 0 16) 15))) anon39_correct)))
...
)) (and (=> (= (ControlFlow 0 18) 16) anon133_Then_correct) (=> (= (ControlFlow 0 18) 17) anon133_Else_correct)))))
(let ((anon132_Else_correct  (=> (and (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#16@0|))))) (= (ControlFlow 0 21) 18)) anon37_correct)))
(let ((anon132_Then_correct  (=> (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#16@0|)))) (and ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@@3) (= (ControlFlow 0 20) 18))) anon37_correct)))
(let ((anon131_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|))) (and (=> (= (ControlFlow 0 23) 20) anon132_Then_correct) (=> (= (ControlFlow 0 23) 21) anon132_Else_correct)))))
(let ((anon131_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#16@0|)) (and (=> (= (ControlFlow 0 22) 20) anon132_Then_correct) (=> (= (ControlFlow 0 22) 21) anon132_Else_correct)))))
(let ((anon130_Then_correct  (=> (and ($Is refType |n#16@0| Tclass._module.Node) ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 24) 22) anon131_Then_correct) (=> (= (ControlFlow 0 24) 23) anon131_Else_correct)))))
(let ((anon130_Else_correct  (=> (and (not (and ($Is refType |n#16@0| Tclass._module.Node) ($IsAlloc refType |n#16@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 19) 18)) anon37_correct)))
...
)) (and (=> (= (ControlFlow 0 25) 24) anon130_Then_correct) (=> (= (ControlFlow 0 25) 19) anon130_Else_correct)))))
(let ((anon129_Else_correct  (=> (and (= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.childrenVisited)))) (= (ControlFlow 0 31) 25)) anon32_correct)))
(let ((anon129_Then_correct  (=> (or (not (= |j#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.childrenVisited))))) (not true)) (=> (and ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@@3) (= (ControlFlow 0 30) 25)) anon32_correct))))
(let ((anon128_Then_correct  (=> (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))))) (and (=> (= (ControlFlow 0 32) 30) anon129_Then_correct) (=> (= (ControlFlow 0 32) 31) anon129_Else_correct)))))
(let ((anon128_Else_correct  (=> (and (not (and (<= (LitInt 0) |j#0@0|) (< |j#0@0| (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children)))))) (= (ControlFlow 0 29) 25)) anon32_correct)))
(let ((anon127_Else_correct  (=> (< |j#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 34) 32) anon128_Then_correct) (=> (= (ControlFlow 0 34) 29) anon128_Else_correct)))))
(let ((anon127_Then_correct  (=> (<= (LitInt 0) |j#0@0|) (and (=> (= (ControlFlow 0 33) 32) anon128_Then_correct) (=> (= (ControlFlow 0 33) 29) anon128_Else_correct)))))
(let ((anon125_Then_correct  (=> (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#14@0|) _module.Node.children)))) (and (=> (= (ControlFlow 0 35) 33) anon127_Then_correct) (=> (= (ControlFlow 0 35) 34) anon127_Else_correct)))))
(let ((anon125_Else_correct  (=> (and (or (not (= (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |n#14@0|) _module.Node.children))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#14@0|) _module.Node.children))))) (not true)) (= (ControlFlow 0 28) 25)) anon32_correct)))
(let ((anon124_Then_correct  (=> (and (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#14@0|)) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@@3)) (and (=> (= (ControlFlow 0 36) 35) anon125_Then_correct) (=> (= (ControlFlow 0 36) 28) anon125_Else_correct)))))
(let ((anon124_Else_correct  (=> (and (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#14@0|))) (= (ControlFlow 0 27) 25)) anon32_correct)))
(let ((anon123_Then_correct  (=> (and ($Is refType |n#14@0| Tclass._module.Node) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 37) 36) anon124_Then_correct) (=> (= (ControlFlow 0 37) 27) anon124_Else_correct)))))
(let ((anon123_Else_correct  (=> (and (not (and ($Is refType |n#14@0| Tclass._module.Node) ($IsAlloc refType |n#14@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 26) 25)) anon32_correct)))
...
)) (and (=> (= (ControlFlow 0 38) 37) anon123_Then_correct) (=> (= (ControlFlow 0 38) 26) anon123_Else_correct)))))
(let ((anon122_Else_correct  (=> (and (not (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (or (not (= |n#12@0| |t#0@0|)) (not true)))) (= (ControlFlow 0 41) 38)) anon22_correct)))
(let ((anon122_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (or (not (= |n#12@0| |t#0@0|)) (not true))) (= (ControlFlow 0 40) 38)) anon22_correct)))
(let ((anon121_Else_correct  (=> (not (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|))))) (and (=> (= (ControlFlow 0 43) 40) anon122_Then_correct) (=> (= (ControlFlow 0 43) 41) anon122_Else_correct)))))
(let ((anon121_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#12@0|)))) (and (=> (= (ControlFlow 0 42) 40) anon122_Then_correct) (=> (= (ControlFlow 0 42) 41) anon122_Else_correct)))))
(let ((anon120_Else_correct  (=> (not (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|))) (and (=> (= (ControlFlow 0 45) 42) anon121_Then_correct) (=> (= (ControlFlow 0 45) 43) anon121_Else_correct)))))
(let ((anon120_Then_correct  (=> (|Set#IsMember| |S#0@@5| ($Box refType |n#12@0|)) (and (=> (= (ControlFlow 0 44) 42) anon121_Then_correct) (=> (= (ControlFlow 0 44) 43) anon121_Else_correct)))))
(let ((anon119_Then_correct  (=> (and ($Is refType |n#12@0| Tclass._module.Node) ($IsAlloc refType |n#12@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 46) 44) anon120_Then_correct) (=> (= (ControlFlow 0 46) 45) anon120_Else_correct)))))
(let ((anon119_Else_correct  (=> (and (not (and ($Is refType |n#12@0| Tclass._module.Node) ($IsAlloc refType |n#12@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 39) 38)) anon22_correct)))
...
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))))) (and (=> (= (ControlFlow 0 47) 46) anon119_Then_correct) (=> (= (ControlFlow 0 47) 39) anon119_Else_correct)))))
(let ((anon118_Else_correct  (=> (and (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#10@0|))) (= (ControlFlow 0 50) 47)) anon15_correct)))
(let ((anon118_Then_correct  (=> (and (|Seq#Contains| |stackNodes#0@1| ($Box refType |n#10@0|)) (= (ControlFlow 0 49) 47)) anon15_correct)))
(let ((anon117_Then_correct  (=> (and ($Is refType |n#10@0| Tclass._module.Node) ($IsAlloc refType |n#10@0| Tclass._module.Node $Heap@2)) (and (=> (= (ControlFlow 0 51) 49) anon118_Then_correct) (=> (= (ControlFlow 0 51) 50) anon118_Else_correct)))))
(let ((anon117_Else_correct  (=> (and (not (and ($Is refType |n#10@0| Tclass._module.Node) ($IsAlloc refType |n#10@0| Tclass._module.Node $Heap@2))) (= (ControlFlow 0 48) 47)) anon15_correct)))
(let ((anon12_correct  (=> (= |p#0@0| (ite (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) null ($Unbox refType (|Seq#Index| |stackNodes#0@1| (- (|Seq#Length| |stackNodes#0@1|) 1))))) (and (=> (= (ControlFlow 0 52) 51) anon117_Then_correct) (=> (= (ControlFlow 0 52) 48) anon117_Else_correct)))))
(let ((anon116_Else_correct  (=> (and (or (not (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0))) (not true)) (= (ControlFlow 0 54) 52)) anon12_correct)))
(let ((anon116_Then_correct  (=> (and (= (|Seq#Length| |stackNodes#0@1|) (LitInt 0)) (= (ControlFlow 0 53) 52)) anon12_correct)))
(let ((anon9_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|)) (not (|Seq#Contains| |stackNodes#0@1| ($Box refType |t#0@0|)))) (and (=> (= (ControlFlow 0 55) 53) anon116_Then_correct) (=> (= (ControlFlow 0 55) 54) anon116_Else_correct)))))
(let ((anon115_Else_correct  (=> (and (not (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|))) (= (ControlFlow 0 57) 55)) anon9_correct)))
(let ((anon115_Then_correct  (=> (and (|Set#IsMember| |S#0@@5| ($Box refType |t#0@0|)) (= (ControlFlow 0 56) 55)) anon9_correct)))
...
)) (and (=> (= (ControlFlow 0 58) 56) anon115_Then_correct) (=> (= (ControlFlow 0 58) 57) anon115_Else_correct)))))
(let ((anon114_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|)))) (= (ControlFlow 0 60) 58)) anon7_correct)))
(let ((anon114_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 59) 58)) anon7_correct)))
(let ((anon113_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 62) 59) anon114_Then_correct) (=> (= (ControlFlow 0 62) 60) anon114_Else_correct)))))
(let ((anon113_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 61) 59) anon114_Then_correct) (=> (= (ControlFlow 0 61) 60) anon114_Else_correct)))))
...
)))) (and (and (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (=> (|Set#Equal| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (and (<= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (=> (= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) |$decr_init$loop#02@0|))))) (not |$w$loop#0@0|))))))) (and (=> (= (ControlFlow 0 63) 61) anon113_Then_correct) (=> (= (ControlFlow 0 63) 62) anon113_Else_correct)))))))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
