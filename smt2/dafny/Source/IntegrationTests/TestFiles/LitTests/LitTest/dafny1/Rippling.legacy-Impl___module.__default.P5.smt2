...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly T@U) (|x#0| T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.count#canCall| |x#0| |xs#0|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |xs#0|)) (let ((|ys#1| (_module.List._h2 |xs#0|)))
(let ((|y#1| (_module.List._h1 |xs#0|)))
 (and (and (and (|$IsA#_module.Nat| |x#0|) (|$IsA#_module.Nat| |y#1|)) (=> (|_module.Nat#Equal| |x#0| |y#1|) (|_module.__default.count#canCall| |x#0| |ys#1|))) (=> (not (|_module.Nat#Equal| |x#0| |y#1|)) (|_module.__default.count#canCall| |x#0| |ys#1|)))))) (= (_module.__default.count ($LS $ly) |x#0| |xs#0|) (ite (_module.List.Nil_q |xs#0|) |#_module.Nat.Zero| (let ((|ys#0| (_module.List._h2 |xs#0|)))
(let ((|y#0| (_module.List._h1 |xs#0|)))
(ite (|_module.Nat#Equal| |x#0| |y#0|) (|#_module.Nat.Suc| (_module.__default.count $ly |x#0| |ys#0|)) (_module.__default.count $ly |x#0| |ys#0|))))))))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |688|
 :pattern ( (_module.__default.count ($LS $ly) |x#0| |xs#0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@0 T@U) (|x#0@@0| T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.count#canCall| (Lit DatatypeTypeType |x#0@@0|) (Lit DatatypeTypeType |xs#0@@0|)) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@0|)))))
(let ((|y#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@0|)))))
 (and (and (and (|$IsA#_module.Nat| (Lit DatatypeTypeType |x#0@@0|)) (|$IsA#_module.Nat| |y#3|)) (=> (|_module.Nat#Equal| |x#0@@0| |y#3|) (|_module.__default.count#canCall| (Lit DatatypeTypeType |x#0@@0|) |ys#3|))) (=> (not (|_module.Nat#Equal| |x#0@@0| |y#3|)) (|_module.__default.count#canCall| (Lit DatatypeTypeType |x#0@@0|) |ys#3|)))))) (= (_module.__default.count ($LS $ly@@0) (Lit DatatypeTypeType |x#0@@0|) (Lit DatatypeTypeType |xs#0@@0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@0|)) |#_module.Nat.Zero| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@0|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@0|)))))
(ite (|_module.Nat#Equal| |x#0@@0| |y#2|) (|#_module.Nat.Suc| (Lit DatatypeTypeType (_module.__default.count ($LS $ly@@0) (Lit DatatypeTypeType |x#0@@0|) |ys#2|))) (_module.__default.count ($LS $ly@@0) (Lit DatatypeTypeType |x#0@@0|) |ys#2|))))))))
 :qid |Ripplinglegacydfy.146:16|
 :weight 3
 :skolemid |689|
 :pattern ( (_module.__default.count ($LS $ly@@0) (Lit DatatypeTypeType |x#0@@0|) (Lit DatatypeTypeType |xs#0@@0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|x#0@@1| T@U) (|y#0@@0| T@U) ) (!  (=> (or (|_module.__default.add#canCall| (Lit DatatypeTypeType |x#0@@1|) (Lit DatatypeTypeType |y#0@@0|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@0| Tclass._module.Nat)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType |x#0@@1|)))))) (let ((|w#3| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |x#0@@1|)))))
(|_module.__default.add#canCall| |w#3| (Lit DatatypeTypeType |y#0@@0|)))) (= (_module.__default.add ($LS $ly@@1) (Lit DatatypeTypeType |x#0@@1|) (Lit DatatypeTypeType |y#0@@0|)) (ite (_module.Nat.Zero_q (Lit DatatypeTypeType |x#0@@1|)) |y#0@@0| (let ((|w#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |x#0@@1|)))))
(Lit DatatypeTypeType (|#_module.Nat.Suc| (Lit DatatypeTypeType (_module.__default.add ($LS $ly@@1) |w#2| (Lit DatatypeTypeType |y#0@@0|))))))))))
 :qid |Ripplinglegacydfy.34:16|
 :weight 3
 :skolemid |596|
 :pattern ( (_module.__default.add ($LS $ly@@1) (Lit DatatypeTypeType |x#0@@1|) (Lit DatatypeTypeType |y#0@@0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|x#0@@2| T@U) (|y#0@@1| T@U) ) (!  (=> (or (|_module.__default.add#canCall| |x#0@@2| |y#0@@1|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@1| Tclass._module.Nat)))) ($Is DatatypeTypeType (_module.__default.add $ly@@2 |x#0@@2| |y#0@@1|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.34:16|
 :skolemid |593|
 :pattern ( (_module.__default.add $ly@@2 |x#0@@2| |y#0@@1|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|x#0@@3| T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.count#canCall| |x#0@@3| |xs#0@@1|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@3| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.count $ly@@3 |x#0@@3| |xs#0@@1|) Tclass._module.Nat))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |686|
 :pattern ( (_module.__default.count $ly@@3 |x#0@@3| |xs#0@@1|))
))))
(assert (forall (($ly@@4 T@U) (|x#0@@4| T@U) (|y#0@@2| T@U) ) (! (= (_module.__default.add ($LS $ly@@4) |x#0@@4| |y#0@@2|) (_module.__default.add $ly@@4 |x#0@@4| |y#0@@2|))
 :qid |Ripplinglegacydfy.34:16|
 :skolemid |590|
 :pattern ( (_module.__default.add ($LS $ly@@4) |x#0@@4| |y#0@@2|))
)))
(assert (forall (($ly@@5 T@U) (|x#0@@5| T@U) (|xs#0@@2| T@U) ) (! (= (_module.__default.count ($LS $ly@@5) |x#0@@5| |xs#0@@2|) (_module.__default.count $ly@@5 |x#0@@5| |xs#0@@2|))
 :qid |Ripplinglegacydfy.146:16|
 :skolemid |684|
 :pattern ( (_module.__default.count ($LS $ly@@5) |x#0@@5| |xs#0@@2|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@6 T@U) (|x#0@@6| T@U) (|y#0@@3| T@U) ) (!  (=> (or (|_module.__default.add#canCall| |x#0@@6| |y#0@@3|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@6| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@3| Tclass._module.Nat)))) (and (=> (not (_module.Nat.Zero_q |x#0@@6|)) (let ((|w#1| (_module.Nat._h0 |x#0@@6|)))
(|_module.__default.add#canCall| |w#1| |y#0@@3|))) (= (_module.__default.add ($LS $ly@@6) |x#0@@6| |y#0@@3|) (ite (_module.Nat.Zero_q |x#0@@6|) |y#0@@3| (let ((|w#0| (_module.Nat._h0 |x#0@@6|)))
(|#_module.Nat.Suc| (_module.__default.add $ly@@6 |w#0| |y#0@@3|)))))))
 :qid |Ripplinglegacydfy.34:16|
 :skolemid |595|
 :pattern ( (_module.__default.add ($LS $ly@@6) |x#0@@6| |y#0@@3|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.P5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|n#1| T@U) (|xs#1| T@U) (|x#1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |n#1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#1| Tclass._module.List)) ($Is DatatypeTypeType |x#1| Tclass._module.Nat)) (=> (|_module.Nat#Equal| (_module.__default.add ($LS ($LS $LZ)) (Lit DatatypeTypeType (|#_module.Nat.Suc| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (_module.__default.count ($LS ($LS $LZ)) |n#1| |xs#1|)) (_module.__default.count ($LS ($LS $LZ)) |n#1| (|#_module.List.Cons| |x#1| |xs#1|))) (|_module.Nat#Equal| |n#1| |x#1|)))
 :qid |Ripplinglegacydfy.323:18|
 :skolemid |845|
 :pattern ( (|#_module.List.Cons| |x#1| |xs#1|) (_module.__default.add ($LS ($LS $LZ)) (|#_module.Nat.Suc| |#_module.Nat.Zero|) (_module.__default.count ($LS ($LS $LZ)) |n#1| |xs#1|)))
)))))
