...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@1 T@U) (|s#0@@1| T@U) ) (!  (=> (or (|_module.IntegerInduction.IsSorted#canCall| this@@1 |s#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.IntegerInduction)) ($Is SeqType |s#0@@1| (TSeq TInt))))) (and (=> (_module.IntegerInduction.IsSorted this@@1 |s#0@@1|) (forall ((|i#0| Int) (|j#0| Int) )  (=> (and (and (<= (LitInt 0) |i#0|) (< |i#0| |j#0|)) (< |j#0| (|Seq#Length| |s#0@@1|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |j#0|))))))) (=> (forall ((|i#1| Int) (|j#1| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#1|) (< |i#1| |j#1|)) (< |j#1| (|Seq#Length| |s#0@@1|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#1|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |j#1|)))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 31) (- 0 32)) (=> (_module.IntegerInduction.IsSorted this@@3 |s#0@@3|) (forall ((|i#5| Int) (|j#2| Int) )  (=> (and (forall ((|j$ih#0#0| Int) )  (=> (and (<= 0 |j$ih#0#0|) (< |j$ih#0#0| |j#2|)) (=> (and (and (<= (LitInt 0) |i#5|) (< |i#5| |j$ih#0#0|)) (< |j$ih#0#0| (|Seq#Length| |s#0@@3|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |i#5|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |j$ih#0#0|))))))) true) (=> (and (and (<= (LitInt 0) |i#5|) (< |i#5| |j#2|)) (< |j#2| (|Seq#Length| |s#0@@3|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |i#5|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |j#2|))))))))) (=> (=> (_module.IntegerInduction.IsSorted this@@3 |s#0@@3|) (forall ((|i#5@@0| Int) (|j#2@@0| Int) )  (=> (and (forall ((|j$ih#0#0@@0| Int) )  (=> (and (<= 0 |j$ih#0#0@@0|) (< |j$ih#0#0@@0| |j#2@@0|)) (=> (and (and (<= (LitInt 0) |i#5@@0|) (< |i#5@@0| |j$ih#0#0@@0|)) (< |j$ih#0#0@@0| (|Seq#Length| |s#0@@3|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |i#5@@0|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |j$ih#0#0@@0|))))))) true) (=> (and (and (<= (LitInt 0) |i#5@@0|) (< |i#5@@0| |j#2@@0|)) (< |j#2@@0| (|Seq#Length| |s#0@@3|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |i#5@@0|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |j#2@@0|)))))))) (=> (= (ControlFlow 0 31) (- 0 30)) (=> (forall ((|i#6| Int) (|j#3| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#6|) (< |i#6| |j#3|)) (< |j#3| (|Seq#Length| |s#0@@3|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |i#6|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |j#3|)))))
...
(let ((anon10_correct  (=> (forall ((|i#5@@1| Int) (|j#2@@1| Int) )  (=> (and (and (<= (LitInt 0) |i#5@@1|) (< |i#5@@1| |j#2@@1|)) (< |j#2@@1| (|Seq#Length| |s#0@@3|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |i#5@@1|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |j#2@@1|)))))) (and (and (=> (= (ControlFlow 0 18) 4) anon36_Else_correct) (=> (= (ControlFlow 0 18) 15) anon37_Then_correct)) (=> (= (ControlFlow 0 18) 2) anon37_Else_correct)))))
...
(let ((anon31_Else_correct  (=> (=> (_module.IntegerInduction.IsSorted this@@3 |s#0@@3|) (forall ((|i#5@@2| Int) (|j#2@@2| Int) )  (=> (and (and (<= (LitInt 0) |i#5@@2|) (< |i#5@@2| |j#2@@2|)) (< |j#2@@2| (|Seq#Length| |s#0@@3|))) (<= (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |i#5@@2|))) (U_2_int ($Unbox intType (|Seq#Index| |s#0@@3| |j#2@@2|))))))) (and (and (=> (= (ControlFlow 0 16) 4) anon36_Else_correct) (=> (= (ControlFlow 0 16) 15) anon37_Then_correct)) (=> (= (ControlFlow 0 16) 2) anon37_Else_correct)))))
