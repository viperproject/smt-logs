...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SchorrWaite_split16)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |root#0| Tclass._module.Node) ($IsAlloc refType |root#0| Tclass._module.Node $Heap))) (=> (and (and (and (and ($Is SetType |S#0| (TSet Tclass._module.Node)) ($IsAlloc SetType |S#0| (TSet Tclass._module.Node) $Heap)) (= 4 $FunctionContextHeight)) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |S#0|)) (|Set#IsMember| |S#0| ($Box refType |root#0|)))) (and (and (and ($Is refType |n#0@0| Tclass._module.Node) ($IsAlloc refType |n#0@0| Tclass._module.Node $Heap)) (|Set#IsMember| |S#0| ($Box refType |n#0@0|))) (and (and ($Is refType |ch#0@0| Tclass._module.Node?) ($IsAlloc refType |ch#0@0| Tclass._module.Node? $Heap)) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |n#0@0| null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
