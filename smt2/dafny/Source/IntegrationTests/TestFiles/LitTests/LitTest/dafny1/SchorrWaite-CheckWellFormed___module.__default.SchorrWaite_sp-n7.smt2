...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.SchorrWaite_split6)
...
)) (=> (and ($Is refType |n#8@0| Tclass._module.Node) ($IsAlloc refType |n#8@0| Tclass._module.Node $Heap@0)) (=> (and (and (and (|Set#IsMember| |S#0@@5| ($Box refType |n#8@0|)) (or (not (= |n#8@0| null)) (not true))) (and (or (not (= |n#8@0| null)) (not true)) ($IsAlloc refType |n#8@0| Tclass._module.Node $Heap@@3))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |n#8@0|) _module.Node.childrenVisited))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |n#8@0|) _module.Node.childrenVisited)))) (or (not (= |n#8@0| null)) (not true))) (and (or (not (= |n#8@0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType |n#8@0| Tclass._module.Node $Heap@@3))))))
