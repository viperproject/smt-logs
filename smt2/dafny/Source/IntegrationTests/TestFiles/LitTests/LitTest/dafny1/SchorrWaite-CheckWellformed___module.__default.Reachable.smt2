...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|source#0@@1| T@U) (|sink#0@@1| T@U) (|S#0@@1| T@U) ) (!  (=> (or (|_module.__default.Reachable#canCall| $Heap@@1 |source#0@@1| |sink#0@@1| |S#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) ($Is refType |source#0@@1| Tclass._module.Node)) ($Is refType |sink#0@@1| Tclass._module.Node)) ($Is SetType |S#0@@1| (TSet Tclass._module.Node))))) (and (forall ((|via#0| T@U) ) (!  (=> ($Is DatatypeTypeType |via#0| Tclass._module.Path) (|_module.__default.ReachableVia#canCall| $Heap@@1 |source#0@@1| |via#0| |sink#0@@1| |S#0@@1|))
 :qid |SchorrWaitedfy.157:10|
 :skolemid |761|
 :pattern ( (_module.__default.ReachableVia ($LS $LZ) $Heap@@1 |source#0@@1| |via#0| |sink#0@@1| |S#0@@1|))
)) (= (_module.__default.Reachable $Heap@@1 |source#0@@1| |sink#0@@1| |S#0@@1|) (exists ((|via#0@@0| T@U) ) (!  (and ($Is DatatypeTypeType |via#0@@0| Tclass._module.Path) (_module.__default.ReachableVia ($LS $LZ) $Heap@@1 |source#0@@1| |via#0@@0| |sink#0@@1| |S#0@@1|))
 :qid |SchorrWaitedfy.157:10|
 :skolemid |760|
 :pattern ( (_module.__default.ReachableVia ($LS $LZ) $Heap@@1 |source#0@@1| |via#0@@0| |sink#0@@1| |S#0@@1|))
)))))
 :qid |SchorrWaitedfy.154:17|
 :skolemid |762|
 :pattern ( (_module.__default.Reachable $Heap@@1 |source#0@@1| |sink#0@@1| |S#0@@1|) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall (($ly@@1 T@U) ($Heap@@2 T@U) (|source#0@@2| T@U) (|p#0@@1| T@U) (|sink#0@@2| T@U) (|S#0@@2| T@U) ) (! (= (_module.__default.ReachableVia ($LS $ly@@1) $Heap@@2 |source#0@@2| |p#0@@1| |sink#0@@2| |S#0@@2|) (_module.__default.ReachableVia $ly@@1 $Heap@@2 |source#0@@2| |p#0@@1| |sink#0@@2| |S#0@@2|))
 :qid |SchorrWaitedfy.160:17|
 :skolemid |767|
 :pattern ( (_module.__default.ReachableVia ($LS $ly@@1) $Heap@@2 |source#0@@2| |p#0@@1| |sink#0@@2| |S#0@@2|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Reachable)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_correct  (=> (and (and (= (_module.__default.Reachable $Heap@@3 |source#0@@3| |sink#0@@3| |S#0@@3|) (exists ((|via#2| T@U) ) (!  (and ($Is DatatypeTypeType |via#2| Tclass._module.Path) (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |source#0@@3| |via#2| |sink#0@@3| |S#0@@3|))
 :qid |SchorrWaitedfy.157:10|
 :skolemid |765|
 :pattern ( (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |source#0@@3| |via#2| |sink#0@@3| |S#0@@3|))
))) (forall ((|via#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |via#2@@0| Tclass._module.Path) (|_module.__default.ReachableVia#canCall| $Heap@@3 |source#0@@3| |via#2@@0| |sink#0@@3| |S#0@@3|))
 :qid |SchorrWaitedfy.157:10|
 :skolemid |766|
 :pattern ( (_module.__default.ReachableVia ($LS $LZ) $Heap@@3 |source#0@@3| |via#2@@0| |sink#0@@3| |S#0@@3|))
))) (and ($Is boolType (bool_2_U (_module.__default.Reachable $Heap@@3 |source#0@@3| |sink#0@@3| |S#0@@3|)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@1|)))
(let ((anon8_Else_correct  (=> (not (and ($Is DatatypeTypeType |via#1@0| Tclass._module.Path) ($IsAlloc DatatypeTypeType |via#1@0| Tclass._module.Path $Heap@@3))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 5) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (and ($Is DatatypeTypeType |via#1@0| Tclass._module.Path) ($IsAlloc DatatypeTypeType |via#1@0| Tclass._module.Path $Heap@@3)) (=> (and (and (and ($IsAlloc refType |source#0@@3| Tclass._module.Node $Heap@@3) ($IsAlloc DatatypeTypeType |via#1@0| Tclass._module.Path $Heap@@3)) (and ($IsAlloc refType |sink#0@@3| Tclass._module.Node $Heap@@3) ($IsAlloc SetType |S#0@@3| (TSet Tclass._module.Node) $Heap@@3))) (and (and (= |b$reqreads#0@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@4) alloc)))) (|Set#IsMember| |S#0@@3| ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |SchorrWaitedfy.157:17|
 :skolemid |763|
))) (|_module.__default.ReachableVia#canCall| $Heap@@3 |source#0@@3| |via#1@0| |sink#0@@3| |S#0@@3|)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3)))) anon5_correct))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) ($Is refType |source#0@@3| Tclass._module.Node)) (and (and ($Is refType |sink#0@@3| Tclass._module.Node) ($Is SetType |S#0@@3| (TSet Tclass._module.Node))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
