...
(declare-fun _module.__default.zipConcat (T@U T@U T@U) T@U)
(declare-fun |_module.__default.zipConcat#canCall| (T@U T@U T@U) Bool)
(declare-fun $LZ () T@U)
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|x#0@@0| T@U) (|xs#0@@0| T@U) (|more#0| T@U) ) (!  (=> (or (|_module.__default.zipConcat#canCall| (Lit DatatypeTypeType |x#0@@0|) (Lit DatatypeTypeType |xs#0@@0|) (Lit DatatypeTypeType |more#0|)) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |x#0@@0| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@0| Tclass._module.List)) ($Is DatatypeTypeType |more#0| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |more#0|)))))) (let ((|ys#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |more#0|)))))
(|_module.__default.zip#canCall| (Lit DatatypeTypeType |xs#0@@0|) |ys#3|))) (= (_module.__default.zipConcat (Lit DatatypeTypeType |x#0@@0|) (Lit DatatypeTypeType |xs#0@@0|) (Lit DatatypeTypeType |more#0|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |more#0|)) |#_module.PList.PNil| (let ((|ys#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |more#0|)))))
(let ((|y#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |more#0|)))))
(Lit DatatypeTypeType (|#_module.PList.PCons| (Lit DatatypeTypeType (|#_module.Pair.Pair| (Lit DatatypeTypeType |x#0@@0|) |y#2|)) (Lit DatatypeTypeType (_module.__default.zip ($LS $LZ) (Lit DatatypeTypeType |xs#0@@0|) |ys#2|))))))))))
 :qid |Ripplinglegacydfy.258:26|
 :weight 3
 :skolemid |782|
 :pattern ( (_module.__default.zipConcat (Lit DatatypeTypeType |x#0@@0|) (Lit DatatypeTypeType |xs#0@@0|) (Lit DatatypeTypeType |more#0|)))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|x#0@@1| T@U) (|xs#0@@1| T@U) (|more#0@@0| T@U) ) (!  (=> (or (|_module.__default.zipConcat#canCall| |x#0@@1| |xs#0@@1| |more#0@@0|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |x#0@@1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@1| Tclass._module.List)) ($Is DatatypeTypeType |more#0@@0| Tclass._module.List)))) ($Is DatatypeTypeType (_module.__default.zipConcat |x#0@@1| |xs#0@@1| |more#0@@0|) Tclass._module.PList))
 :qid |Ripplinglegacydfy.258:26|
 :skolemid |779|
 :pattern ( (_module.__default.zipConcat |x#0@@1| |xs#0@@1| |more#0@@0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($ly@@2 T@U) (|a#0@@2| T@U) (|b#0@@2| T@U) ) (!  (=> (or (|_module.__default.zip#canCall| (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |b#0@@2|)) (and (< 3 $FunctionContextHeight) (and ($Is DatatypeTypeType |a#0@@2| Tclass._module.List) ($Is DatatypeTypeType |b#0@@2| Tclass._module.List)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |a#0@@2|)))))) (let ((|xs#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |a#0@@2|)))))
 (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |b#0@@2|)))))) (let ((|ys#3@@0| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |b#0@@2|)))))
(|_module.__default.zip#canCall| |xs#3| |ys#3@@0|))))) (= (_module.__default.zip ($LS $ly@@2) (Lit DatatypeTypeType |a#0@@2|) (Lit DatatypeTypeType |b#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |a#0@@2|)) |#_module.PList.PNil| (let ((|xs#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |a#0@@2|)))))
(let ((|x#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |a#0@@2|)))))
(ite (_module.List.Nil_q (Lit DatatypeTypeType |b#0@@2|)) |#_module.PList.PNil| (let ((|ys#2@@0| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |b#0@@2|)))))
(let ((|y#2@@0| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |b#0@@2|)))))
(Lit DatatypeTypeType (|#_module.PList.PCons| (Lit DatatypeTypeType (|#_module.Pair.Pair| |x#2| |y#2@@0|)) (Lit DatatypeTypeType (_module.__default.zip ($LS $ly@@2) |xs#2| |ys#2@@0|)))))))))))))
 :qid |Ripplinglegacydfy.249:16|
 :weight 3
 :skolemid |777|
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|x#0@@2| T@U) (|xs#0@@2| T@U) (|more#0@@1| T@U) ) (!  (=> (or (|_module.__default.zipConcat#canCall| |x#0@@2| |xs#0@@2| |more#0@@1|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |xs#0@@2| Tclass._module.List)) ($Is DatatypeTypeType |more#0@@1| Tclass._module.List)))) (and (=> (not (_module.List.Nil_q |more#0@@1|)) (let ((|ys#1@@0| (_module.List._h2 |more#0@@1|)))
(|_module.__default.zip#canCall| |xs#0@@2| |ys#1@@0|))) (= (_module.__default.zipConcat |x#0@@2| |xs#0@@2| |more#0@@1|) (ite (_module.List.Nil_q |more#0@@1|) |#_module.PList.PNil| (let ((|ys#0@@0| (_module.List._h2 |more#0@@1|)))
(let ((|y#0@@0| (_module.List._h1 |more#0@@1|)))
(|#_module.PList.PCons| (|#_module.Pair.Pair| |x#0@@2| |y#0@@0|) (_module.__default.zip ($LS $LZ) |xs#0@@2| |ys#0@@0|))))))))
 :qid |Ripplinglegacydfy.258:26|
 :skolemid |781|
 :pattern ( (_module.__default.zipConcat |x#0@@2| |xs#0@@2| |more#0@@1|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.P44)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|x#1| T@U) (|xs#1@@0| T@U) (|ys#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |x#1| Tclass._module.Nat) ($Is DatatypeTypeType |xs#1@@0| Tclass._module.List)) ($Is DatatypeTypeType |ys#1@@1| Tclass._module.List)) (|_module.PList#Equal| (_module.__default.zip ($LS ($LS $LZ)) (|#_module.List.Cons| |x#1| |xs#1@@0|) |ys#1@@1|) (_module.__default.zipConcat |x#1| |xs#1@@0| |ys#1@@1|)))
 :qid |Ripplinglegacydfy.523:18|
 :skolemid |1122|
 :pattern ( (_module.__default.zipConcat |x#1| |xs#1@@0| |ys#1@@1|))
 :pattern ( (_module.__default.zip ($LS ($LS $LZ)) (|#_module.List.Cons| |x#1| |xs#1@@0|) |ys#1@@1|))
)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
