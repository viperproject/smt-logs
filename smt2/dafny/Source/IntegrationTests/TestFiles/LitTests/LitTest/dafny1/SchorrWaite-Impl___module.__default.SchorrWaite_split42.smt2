...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split42)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon114_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|))) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |stackNodes#0@1|))))))
(let ((anon113_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 4) 2)) anon114_Then_correct)))
(let ((anon113_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (= (ControlFlow 0 3) 2)) anon114_Then_correct)))
...
)))) (and (and (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (=> (|Set#Equal| |unmarkedNodes#0@1| |unmarkedNodes#0@0|) (and (<= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (=> (= (|Seq#Rank| |stackNodes#0@1|) (|Seq#Rank| |stackNodes#0@0|)) (<= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) |$decr_init$loop#02@0|))))) (not |$w$loop#0@0|))))))) (and (=> (= (ControlFlow 0 5) 3) anon113_Then_correct) (=> (= (ControlFlow 0 5) 4) anon113_Else_correct)))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
