...
(assert (forall (($ly@@0 T@U) (|x#0@@0| T@U) (|y#0@@0| T@U) ) (! (= (_module.__default.leq ($LS $ly@@0) |x#0@@0| |y#0@@0|) (_module.__default.leq $ly@@0 |x#0@@0| |y#0@@0|))
 :qid |Ripplinglegacydfy.61:16|
 :skolemid |612|
 :pattern ( (_module.__default.leq ($LS $ly@@0) |x#0@@0| |y#0@@0|))
)))
...
(|_module.__default.leq#canCall| |a#3| |b#3|))))) (= (_module.__default.leq ($LS $ly@@1) (Lit DatatypeTypeType |x#0@@1|) (Lit DatatypeTypeType |y#0@@1|)) (ite (_module.Nat.Zero_q (Lit DatatypeTypeType |x#0@@1|)) |#_module.Bool.True| (let ((|a#2| (Lit DatatypeTypeType (_module.Nat._h0 (Lit DatatypeTypeType |x#0@@1|)))))
...
(Lit DatatypeTypeType (_module.__default.leq ($LS $ly@@1) |a#2| |b#2|)))))))))
 :qid |Ripplinglegacydfy.61:16|
 :weight 3
 :skolemid |617|
 :pattern ( (_module.__default.leq ($LS $ly@@1) (Lit DatatypeTypeType |x#0@@1|) (Lit DatatypeTypeType |y#0@@1|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|x#0@@2| T@U) (|y#0@@2| T@U) ) (!  (=> (or (|_module.__default.leq#canCall| |x#0@@2| |y#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |x#0@@2| Tclass._module.Nat) ($Is DatatypeTypeType |y#0@@2| Tclass._module.Nat)))) (and (=> (not (_module.Nat.Zero_q |x#0@@2|)) (let ((|a#1| (_module.Nat._h0 |x#0@@2|)))
 (=> (not (_module.Nat.Zero_q |y#0@@2|)) (let ((|b#1| (_module.Nat._h0 |y#0@@2|)))
(|_module.__default.leq#canCall| |a#1| |b#1|))))) (= (_module.__default.leq ($LS $ly@@2) |x#0@@2| |y#0@@2|) (ite (_module.Nat.Zero_q |x#0@@2|) |#_module.Bool.True| (let ((|a#0| (_module.Nat._h0 |x#0@@2|)))
(ite (_module.Nat.Zero_q |y#0@@2|) |#_module.Bool.False| (let ((|b#0| (_module.Nat._h0 |y#0@@2|)))
(_module.__default.leq $ly@@2 |a#0| |b#0|))))))))
 :qid |Ripplinglegacydfy.61:16|
 :skolemid |616|
 :pattern ( (_module.__default.leq ($LS $ly@@2) |x#0@@2| |y#0@@2|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.P17)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|n#1| T@U) ) (!  (=> ($Is DatatypeTypeType |n#1| Tclass._module.Nat) (= (|_module.Bool#Equal| (_module.__default.leq ($LS ($LS $LZ)) |n#1| (Lit DatatypeTypeType |#_module.Nat.Zero|)) |#_module.Bool.True|) (|_module.Nat#Equal| |n#1| |#_module.Nat.Zero|)))
 :qid |Ripplinglegacydfy.385:18|
 :skolemid |929|
 :pattern ( (_module.__default.leq ($LS ($LS $LZ)) |n#1| |#_module.Nat.Zero|))
)))))
