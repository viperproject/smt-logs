...
(declare-fun |nn#0_0_0@0| () T@U)
(declare-fun |let#0_0_0#0#0| () T@U)
(declare-fun |ext##0_0_0@0| () T@U)
(declare-fun $Heap@2 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Lemma_split9)
...
)))) (and (and (or (not (= |list#0@@12| |#_module.List.Nil|)) (not true)) (= |list#0@@12| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|))) (and ($Is DatatypeTypeType |_mcc#0#0_0@0| (Tclass._module.Node _module._default.Lemma$X)) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module._default.Lemma$X)))))) (and (and (and (and ($Is DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module._default.Lemma$X)) (= |rest#0_0@0| |let#0_0#0#0|))) (and (and (and ($Is DatatypeTypeType |n#0_0@0| (Tclass._module.Node _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |n#0_0@0| (Tclass._module.Node _module._default.Lemma$X) $Heap@0)) (and (= |let#0_1#0#0| |_mcc#0#0_0@0|) ($Is DatatypeTypeType |let#0_1#0#0| (Tclass._module.Node _module._default.Lemma$X)))) (and (and (= |n#0_0@0| |let#0_1#0#0|) (or (not (= |n#0_0@0| (|#_module.Node.Element| |_mcc#2#0_1_0@0|))) (not true))) (and (= |n#0_0@0| (|#_module.Node.Nary| |_mcc#3#0_0_0@0|)) ($Is DatatypeTypeType |_mcc#3#0_0_0@0| (Tclass._module.List _module._default.Lemma$X))))))) (=> (and (and (and (and (and (and ($Is DatatypeTypeType |nn#0_0_0@0| (Tclass._module.List _module._default.Lemma$X)) ($IsAlloc DatatypeTypeType |nn#0_0_0@0| (Tclass._module.List _module._default.Lemma$X) $Heap@0)) (= |let#0_0_0#0#0| |_mcc#3#0_0_0@0|)) (and ($Is DatatypeTypeType |let#0_0_0#0#0| (Tclass._module.List _module._default.Lemma$X)) (= |nn#0_0_0@0| |let#0_0_0#0#0|))) (and (and ($IsAlloc DatatypeTypeType |rest#0_0@0| (Tclass._module.List _module._default.Lemma$X) $Heap@0) ($IsAlloc DatatypeTypeType |ext#0@@4| (Tclass._module.List _module._default.Lemma$X) $Heap@0)) (and (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (|_module.__default.Flatten#canCall| _module._default.Lemma$X |rest#0_0@0| |ext#0@@4|)))) (and (and (and (|_module.__default.Flatten#canCall| _module._default.Lemma$X |rest#0_0@0| |ext#0@@4|) (= |ext##0_0_0@0| (_module.__default.Flatten _module._default.Lemma$X ($LS $LZ) |rest#0_0@0| |ext#0@@4|))) (and (or (< (DtRank |nn#0_0_0@0|) (DtRank |list#0@@12|)) (and (= (DtRank |nn#0_0_0@0|) (DtRank |list#0@@12|)) (< (DtRank |ext##0_0_0@0|) (DtRank |ext#0@@4|)))) (=> (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext##0_0_0@0|) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext##0_0_0@0|) (=> (_module.List.Nil_q |ext##0_0_0@0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (and (=> (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext##0_0_0@0|) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext##0_0_0@0|) (=> (not (_module.List.Nil_q |ext##0_0_0@0|)) (let ((|rest#2@@2| (_module.List._h1 |ext##0_0_0@0|)))
(let ((|n#2@@2| (_module.List._h0 |ext##0_0_0@0|)))
 (=> (_module.Node.Element_q |n#2@@2|) (_module.__default.IsFlat _module._default.Lemma$X ($LS ($LS $LZ)) |rest#2@@2|))))))) (=> (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext##0_0_0@0|) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext##0_0_0@0|) (=> (not (_module.List.Nil_q |ext##0_0_0@0|)) (let ((|n#2@@3| (_module.List._h0 |ext##0_0_0@0|)))
 (=> (not (_module.Node.Element_q |n#2@@3|)) (U_2_bool (Lit boolType (bool_2_U false))))))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))))) (and (and (and (and (and (|_module.__default.ToSeq#canCall| _module._default.Lemma$X |nn#0_0_0@0|) (|_module.__default.ToSeq#canCall| _module._default.Lemma$X |ext##0_0_0@0|)) (and (|_module.__default.Flatten#canCall| _module._default.Lemma$X |nn#0_0_0@0| |ext##0_0_0@0|) (|_module.__default.ToSeq#canCall| _module._default.Lemma$X (_module.__default.Flatten _module._default.Lemma$X ($LS $LZ) |nn#0_0_0@0| |ext##0_0_0@0|)))) (|Seq#Equal| (|Seq#Append| (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) |nn#0_0_0@0|) (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) |ext##0_0_0@0|)) (_module.__default.ToSeq _module._default.Lemma$X ($LS ($LS $LZ)) (_module.__default.Flatten _module._default.Lemma$X ($LS ($LS $LZ)) |nn#0_0_0@0| |ext##0_0_0@0|)))) (and (= $Heap@0 $Heap@2) (or (< (DtRank |rest#0_0@0|) (DtRank |list#0@@12|)) (and (= (DtRank |rest#0_0@0|) (DtRank |list#0@@12|)) (< (DtRank |ext#0@@4|) (DtRank |ext#0@@4|)))))) (and (and (=> (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext#0@@4|) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (=> (_module.List.Nil_q |ext#0@@4|) (U_2_bool (Lit boolType (bool_2_U true)))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsFlat#canCall| _module._default.Lemma$X |ext#0@@4|)))) (or (_module.__default.IsFlat _module._default.Lemma$X ($LS $LZ) |ext#0@@4|) (=> (not (_module.List.Nil_q |ext#0@@4|)) (let ((|rest#2@@3| (_module.List._h1 |ext#0@@4|)))
(let ((|n#2@@4| (_module.List._h0 |ext#0@@4|)))
 (=> (_module.Node.Element_q |n#2@@4|) (_module.__default.IsFlat _module._default.Lemma$X ($LS ($LS $LZ)) |rest#2@@3|)))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
