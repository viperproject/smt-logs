...
)) ($HeapSucc $Heap@23 $Heap@24))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@14 T@U) ($f@@2 T@U) )  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@14) alloc)))) (= $o@@14 $nw@1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@14 $f@@2))))) (=> (forall (($o@@15 T@U) ($f@@3 T@U) )  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@15) alloc)))) (= $o@@15 $nw@1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@15 $f@@3)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (_System.array2.Length0 $nw@1) (_System.array2.Length1 $nw@1)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
