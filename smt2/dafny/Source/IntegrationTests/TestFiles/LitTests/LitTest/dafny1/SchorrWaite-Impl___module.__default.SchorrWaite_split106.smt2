...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split106)
...
))) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |path#0@1|) Tclass._module.Path $Heap@@3) ($Is refType |t#0@0| Tclass._module.Node)) (and ($IsAlloc refType |root#0| Tclass._module.Node $Heap@@3) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc DatatypeTypeType |path#0@1| Tclass._module.Path $Heap@@3)))))
