...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split230)
...
))))) (and (and (=> |$w$loop#0@0| (=> (< 0 (|Seq#Length| |stackNodes#0@4|)) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (|Seq#Index| |stackNodes#0@4| (LitInt 0)))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (|Seq#Index| |stackNodes#0@4| (LitInt 0)))) _module.Node.childrenVisited))))) null))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))))))) (forall ((|k#1@@2| Int) ) (!  (=> (and (< 0 |k#1@@2|) (< |k#1@@2| (|Seq#Length| |stackNodes#0@4|))) (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (|Seq#Index| |stackNodes#0@4| |k#1@@2|))) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 ($Unbox refType (|Seq#Index| |stackNodes#0@4| |k#1@@2|))) _module.Node.childrenVisited))))) ($Unbox refType (|Seq#Index| |stackNodes#0@4| (- |k#1@@2| 1)))))
 :qid |SchorrWaitedfy.232:22|
 :skolemid |827|
