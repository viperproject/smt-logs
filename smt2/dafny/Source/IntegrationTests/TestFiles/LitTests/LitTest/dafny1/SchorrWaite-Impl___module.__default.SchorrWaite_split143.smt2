...
(set-info :boogie-vc-id Impl$$_module.__default.SchorrWaite_split143)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon106_correct  (=> (and (and (and (and (not (or (= ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))))) null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))))) _module.Node.marked))))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (or (not (= |t#0@0| null)) (not true)) (or (not (= |t#0@0| null)) (not true)))) (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))))) (= |newT#0_1_1_0@1| ($Unbox refType (|Seq#Index| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))))))) (and (and (and (or (not (= |t#0@0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |t#0@0| _module.Node.children))) (and (or (not (= |t#0@0| null)) (not true)) (or (not (= |t#0@0| null)) (not true)))) (and (and (<= 0 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited)))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children))))) (= |$rhs#0_1_1_0@1| (|Seq#Update| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.childrenVisited))) ($Box refType |p#0@0|)))))) (=> (and (and (and (and (and (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |t#0@0|) _module.Node.children ($Box SeqType |$rhs#0_1_1_0@1|)))) ($IsGoodHeap $Heap@5)) (and ($Is SeqType (|Seq#Append| |stackNodes#0@1| (|Seq#Build| |Seq#Empty| ($Box refType |t#0@0|))) (TSeq Tclass._module.Node)) (= |stackNodes#0@2| (|Seq#Append| |stackNodes#0@1| (|Seq#Build| |Seq#Empty| ($Box refType |t#0@0|)))))) (and (and ($Is refType |t#0@0| Tclass._module.Node) (= |path#0@2| (|#_module.Path.Extend| |path#0@1| |t#0@0|))) (and (or (not (= |newT#0_1_1_0@1| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |newT#0_1_1_0@1| _module.Node.marked))))) (and (and (and (= |$rhs#0_1_1_1@1| (U_2_bool (Lit boolType (bool_2_U true)))) (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 |newT#0_1_1_0@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |newT#0_1_1_0@1|) _module.Node.marked ($Box boolType (bool_2_U |$rhs#0_1_1_1@1|)))))) (and ($IsGoodHeap $Heap@6) (or (not (= |newT#0_1_1_0@1| null)) (not true)))) (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |newT#0_1_1_0@1| _module.Node.pathFromRoot)) (= $Heap@7 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@6 |newT#0_1_1_0@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |newT#0_1_1_0@1|) _module.Node.pathFromRoot ($Box DatatypeTypeType |path#0@2|))))) (and ($IsGoodHeap $Heap@7) (= |unmarkedNodes#0@2| (|Set#Difference| |unmarkedNodes#0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |newT#0_1_1_0@1|)))))))) (and (and (and (and (= |t#0@1| |newT#0_1_1_0@1|) (= |p#0@1| |t#0@0|)) (and (= |path#0@4| |path#0@2|) (= $Heap@10 $Heap@7))) (and (and (= |stackNodes#0@4| |stackNodes#0@2|) (= |unmarkedNodes#0@3| |unmarkedNodes#0@2|)) (and (or (or (or (<= 0 |$decr$loop#02@1|) (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|)))) (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|))) (= (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.childrenVisited)))) |$decr$loop#02@1|)) (or (and (|Set#Subset| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (not (|Set#Subset| |unmarkedNodes#0@1| |unmarkedNodes#0@3|))) (and (|Set#Equal| |unmarkedNodes#0@3| |unmarkedNodes#0@1|) (or (< (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (and (= (|Seq#Rank| |stackNodes#0@4|) (|Seq#Rank| |stackNodes#0@1|)) (< (- (|Seq#Length| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.children))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |t#0@1|) _module.Node.childrenVisited)))) |$decr$loop#02@1|)))))))) (and (and (and (=> (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |stackNodes#0@4|))) (|Set#IsMember| |S#0@@5| (|Seq#Index| |stackNodes#0@4| |i#1|)))
