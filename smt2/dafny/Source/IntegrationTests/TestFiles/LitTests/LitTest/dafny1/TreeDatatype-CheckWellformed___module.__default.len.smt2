...
(assert (forall ((_module._default.len$T T@U) ($ly T@U) (|l#0| T@U) ) (! (= (_module.__default.len _module._default.len$T ($LS $ly) |l#0|) (_module.__default.len _module._default.len$T $ly |l#0|))
 :qid |unknown.0:0|
 :skolemid |582|
 :pattern ( (_module.__default.len _module._default.len$T ($LS $ly) |l#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.len$T@@0 T@U) ($ly@@0 T@U) (|l#0@@0| T@U) ) (!  (=> (or (|_module.__default.len#canCall| _module._default.len$T@@0 |l#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@0| (Tclass._module.List _module._default.len$T@@0)))) (and (=> (not (_module.List.Nil_q |l#0@@0|)) (let ((|t#1| (_module.List._h1 |l#0@@0|)))
(|_module.__default.len#canCall| _module._default.len$T@@0 |t#1|))) (= (_module.__default.len _module._default.len$T@@0 ($LS $ly@@0) |l#0@@0|) (ite (_module.List.Nil_q |l#0@@0|) 0 (let ((|t#0| (_module.List._h1 |l#0@@0|)))
(+ 1 (_module.__default.len _module._default.len$T@@0 $ly@@0 |t#0|)))))))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( (_module.__default.len _module._default.len$T@@0 ($LS $ly@@0) |l#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.len$T@@1 T@U) ($ly@@1 T@U) (|l#0@@2| T@U) ) (!  (=> (or (|_module.__default.len#canCall| _module._default.len$T@@1 (Lit DatatypeTypeType |l#0@@2|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@2| (Tclass._module.List _module._default.len$T@@1)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@2|)))))) (let ((|t#3| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@2|)))))
(|_module.__default.len#canCall| _module._default.len$T@@1 |t#3|))) (= (_module.__default.len _module._default.len$T@@1 ($LS $ly@@1) (Lit DatatypeTypeType |l#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |l#0@@2|)) 0 (let ((|t#2| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |l#0@@2|)))))
(LitInt (+ 1 (_module.__default.len _module._default.len$T@@1 ($LS $ly@@1) |t#2|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |587|
 :pattern ( (_module.__default.len _module._default.len$T@@1 ($LS $ly@@1) (Lit DatatypeTypeType |l#0@@2|)))
))))
...
(declare-fun _module._default.len$T@@2 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.len)
...
(let ((anon10_Then_correct  (=> (= |l#0@@3| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.len$T@@2) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.len$T@@2))) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.len$T@@2))) (and (= |t#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($IsBox |let#1#0#0| _module._default.len$T@@2) (= |h#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |t#Z#0@0| (Tclass._module.List _module._default.len$T@@2) $Heap) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |t#Z#0@0|) (DtRank |l#0@@3|)))))))
(let ((anon9_Else_correct  (=> (or (not (= |l#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |l#0@@3| (Tclass._module.List _module._default.len$T@@2))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
