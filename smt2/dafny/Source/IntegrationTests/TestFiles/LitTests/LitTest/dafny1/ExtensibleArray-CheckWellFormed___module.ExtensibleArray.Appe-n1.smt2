...
(assert (forall ((_module.ExtensibleArray$T@@23 T@U) (bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@23)) (and (= ($Box refType ($Unbox refType bx@@11)) bx@@11) ($Is refType ($Unbox refType bx@@11) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@23))))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($IsBox bx@@11 (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@23)))
)))
...
(declare-fun |t#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.ExtensibleArray.Append)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#5| null $Heap@@2 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.Repr)))) ($IsAllocBox ($Box refType this@@3) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@25) $Heap@@2)) (and (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@@2 this@@3) (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@@2 this@@3))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@23 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@23) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@23)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@23))))
 :qid |ExtensibleArraydfy.85:10|
 :skolemid |653|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@23))
))) (and (and ($HeapSucc $Heap@@2 $Heap@0) ($IsAllocBox ($Box refType this@@3) (Tclass._module.ExtensibleArray? _module.ExtensibleArray$T@@25) $Heap@0)) (and (|_module.ExtensibleArray.Valid#canCall| _module.ExtensibleArray$T@@25 $Heap@0 this@@3) (_module.ExtensibleArray.Valid _module.ExtensibleArray$T@@25 ($LS $LZ) $Heap@0 this@@3)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@3 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@25) $Heap@@2)) (=> ($IsAlloc refType this@@3 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@25) $Heap@@2) (=> (and (and (forall (($o@@24 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@24)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.ExtensibleArray.Repr)) ($Box refType $o@@24)))) (or (not (= $o@@24 null)) (not true)))
...
))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@3 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@25) $Heap@@2))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@25)) ($IsAlloc refType this@@3 (Tclass._module.ExtensibleArray _module.ExtensibleArray$T@@25) $Heap@@2)))) (and (and ($IsBox |t#0| _module.ExtensibleArray$T@@25) ($IsAllocBox |t#0| _module.ExtensibleArray$T@@25 $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
