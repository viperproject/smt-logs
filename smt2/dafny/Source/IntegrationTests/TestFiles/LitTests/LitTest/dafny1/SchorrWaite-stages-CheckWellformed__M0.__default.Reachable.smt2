...
(set-info :boogie-vc-id CheckWellformed$$M0.__default.Reachable)
...
(let ((anon8_Then_correct  (=> (and ($Is DatatypeTypeType |via#1@0| Tclass.M0.Path) ($IsAlloc DatatypeTypeType |via#1@0| Tclass.M0.Path $Heap@@3)) (=> (and (and (and ($IsAlloc refType |source#0@@3| Tclass.M0.Node $Heap@@3) ($IsAlloc DatatypeTypeType |via#1@0| Tclass.M0.Path $Heap@@3)) (and ($IsAlloc refType |sink#0@@3| Tclass.M0.Node $Heap@@3) ($IsAlloc SetType |S#0@@3| (TSet Tclass.M0.Node) $Heap@@3))) (and (and (= |b$reqreads#0@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@4) alloc)))) (|Set#IsMember| |S#0@@3| ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |SchorrWaitestagesdfy.24:19|
 :skolemid |598|
))) (|M0.__default.ReachableVia#canCall| $Heap@@3 |source#0@@3| |via#1@0| |sink#0@@3| |S#0@@3|)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3)))) anon5_correct))))
