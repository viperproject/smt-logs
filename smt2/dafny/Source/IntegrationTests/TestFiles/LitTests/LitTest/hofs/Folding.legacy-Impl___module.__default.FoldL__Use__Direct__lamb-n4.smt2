...
(set-info :boogie-vc-id Impl$$_module.__default.FoldL__Use__Direct__lambda_split2)
...
)) (= (ControlFlow 0 2) (- 0 1))) (= (Mod |r#0@0| (LitInt 2)) (LitInt 0))))))
