...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.length$_T0@@1 T@U) ($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.length#canCall| _module._default.length$_T0@@1 |xs#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List _module._default.length$_T0@@1)))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|tail#1| (_module.List._h3 |xs#0@@1|)))
(|_module.__default.length#canCall| _module._default.length$_T0@@1 |tail#1|))) (= (_module.__default.length _module._default.length$_T0@@1 ($LS $ly@@1) |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) 0 (let ((|tail#0| (_module.List._h3 |xs#0@@1|)))
...
(assert (forall ((d@@4 T@U) (_module.List$T@@5 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.List.Cons_q d@@4) ($IsAlloc DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@5) $h@@1))) ($IsAllocBox (_module.List._h2 d@@4) _module.List$T@@5 $h@@1))
 :qid |unknown.0:0|
 :skolemid |773|
 :pattern ( ($IsAllocBox (_module.List._h2 d@@4) _module.List$T@@5 $h@@1))
)))
...
(assert (forall ((d@@6 T@U) (_module.List$T@@7 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (_module.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 (Tclass._module.List _module.List$T@@7) $h@@2))) ($IsAlloc DatatypeTypeType (_module.List._h3 d@@6) (Tclass._module.List _module.List$T@@7) $h@@2))
 :qid |unknown.0:0|
 :skolemid |774|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h3 d@@6) (Tclass._module.List _module.List$T@@7) $h@@2))
)))
