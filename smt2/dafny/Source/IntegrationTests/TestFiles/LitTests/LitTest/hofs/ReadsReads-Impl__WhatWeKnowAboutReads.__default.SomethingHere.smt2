...
(declare-fun Tagclass.WhatWeKnowAboutReads.S? () T@U)
(declare-fun Tagclass.WhatWeKnowAboutReads.S () T@U)
...
(declare-fun Tclass.WhatWeKnowAboutReads.S? () T@U)
...
(assert (distinct TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 |##_System._tuple#0._#Make0| Tagclass._System.Tuple0 Tagclass.WhatWeKnowAboutReads.S? Tagclass.WhatWeKnowAboutReads.S tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_tuple#0| tytagFamily$S)
)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#u#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#26| |l#0|) |$l#0#heap#0| |$l#0#u#0|)) ($IsBox |$l#0#u#0| |l#0|))
 :qid |ReadsReadsdfy.80:9|
 :skolemid |3460|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#26| |l#0|) |$l#0#heap#0| |$l#0#u#0|))
)))
...
(assert (forall (($o T@U) ) (! (= ($Is refType $o Tclass.WhatWeKnowAboutReads.S?)  (or (= $o null) (= (dtype $o) Tclass.WhatWeKnowAboutReads.S?)))
 :qid |unknown.0:0|
 :skolemid |1387|
 :pattern ( ($Is refType $o Tclass.WhatWeKnowAboutReads.S?))
)))
...
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass.WhatWeKnowAboutReads.S $h@@0) ($IsAlloc refType |c#0@@0| Tclass.WhatWeKnowAboutReads.S? $h@@0))
 :qid |unknown.0:0|
 :skolemid |1392|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.WhatWeKnowAboutReads.S $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.WhatWeKnowAboutReads.S? $h@@0))
)))
...
(assert (forall (($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass.WhatWeKnowAboutReads.S? $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1388|
 :pattern ( ($IsAlloc refType $o@@1 Tclass.WhatWeKnowAboutReads.S? $h@@2))
)))
...
(assert (forall ((|l#0@@0| T@U) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#27| |l#0@@0|) |$l#0#o#0|)) (= |$l#0#o#0| |l#0@@0|))
 :qid |unknown.0:0|
 :skolemid |3461|
 :pattern ( (MapType1Select refType boolType (|lambda#27| |l#0@@0|) |$l#0#o#0|))
)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@2 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#30| |l#0@@1| |l#1| |l#2| |l#3|) $o@@2 $f))  (=> (and (or (not (= $o@@2 |l#0@@1|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@2) |l#2|)))) (= $o@@2 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3463|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#30| |l#0@@1| |l#1| |l#2| |l#3|) $o@@2 $f))
)))
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass.WhatWeKnowAboutReads.S?) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) Tclass.WhatWeKnowAboutReads.S?)))
 :qid |unknown.0:0|
 :skolemid |1371|
 :pattern ( ($IsBox bx@@8 Tclass.WhatWeKnowAboutReads.S?))
)))
(assert (forall ((bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 Tclass.WhatWeKnowAboutReads.S) (and (= ($Box refType ($Unbox refType bx@@9)) bx@@9) ($Is refType ($Unbox refType bx@@9) Tclass.WhatWeKnowAboutReads.S)))
 :qid |unknown.0:0|
 :skolemid |1379|
 :pattern ( ($IsBox bx@@9 Tclass.WhatWeKnowAboutReads.S))
)))
...
(assert (forall ((|c#0@@2| T@U) ) (! (= ($Is refType |c#0@@2| Tclass.WhatWeKnowAboutReads.S)  (and ($Is refType |c#0@@2| Tclass.WhatWeKnowAboutReads.S?) (or (not (= |c#0@@2| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |1391|
 :pattern ( ($Is refType |c#0@@2| Tclass.WhatWeKnowAboutReads.S))
 :pattern ( ($Is refType |c#0@@2| Tclass.WhatWeKnowAboutReads.S?))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@4 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@4 $f@@0))  (=> (and (or (not (= $o@@4 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@4) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3453|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@4 $f@@0))
)))
...
(assert (forall ((h@@10 T@U) (r@@3 T@U) (f@@13 T@U) (x@@5 T@U) ) (!  (=> ($IsGoodHeap (MapType1Store refType (MapType1Type FieldType BoxType) h@@10 r@@3 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h@@10 r@@3) f@@13 x@@5))) ($HeapSucc h@@10 (MapType1Store refType (MapType1Type FieldType BoxType) h@@10 r@@3 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h@@10 r@@3) f@@13 x@@5))))
 :qid |DafnyPreludebpl.603:15|
 :skolemid |837|
 :pattern ( (MapType1Store refType (MapType1Type FieldType BoxType) h@@10 r@@3 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h@@10 r@@3) f@@13 x@@5)))
)))
...
(assert (= (Tag Tclass.WhatWeKnowAboutReads.S?) Tagclass.WhatWeKnowAboutReads.S?))
(assert (= (TagFamily Tclass.WhatWeKnowAboutReads.S?) tytagFamily$S))
(assert (= (Tag Tclass.WhatWeKnowAboutReads.S) Tagclass.WhatWeKnowAboutReads.S))
(assert (= (TagFamily Tclass.WhatWeKnowAboutReads.S) tytagFamily$S))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#u#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType |lambda#28| |$l#0#heap#0@@0| |$l#0#u#0@@0|) (SetRef_to_SetBox (|lambda#27| ($Unbox refType |$l#0#u#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3462|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType |lambda#28| |$l#0#heap#0@@0| |$l#0#u#0@@0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#u#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#25| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#u#0@@1|) |l#0@@4|)
 :qid |ReadsReadsdfy.102:29|
 :skolemid |3459|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#25| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#u#0@@1|))
)))
(push 1)
...
(set-info :boogie-vc-id Impl$$WhatWeKnowAboutReads.__default.SomethingHere)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 40) (let ((anon3_correct true))
(let ((anon18_Else_correct  (=> (and (not (and ($Is refType |u#0@0| Tclass.WhatWeKnowAboutReads.S) ($IsAlloc refType |u#0@0| Tclass.WhatWeKnowAboutReads.S |$lambdaHeap#0@0|))) (= (ControlFlow 0 37) 35)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and ($Is refType |u#0@0| Tclass.WhatWeKnowAboutReads.S) ($IsAlloc refType |u#0@0| Tclass.WhatWeKnowAboutReads.S |$lambdaHeap#0@0|)) (=> (and (and (= |$_Frame#l0@0| (|lambda#30| null |$lambdaHeap#0@0| alloc |u#0@0|)) (= |lambdaResult#0| (Lit DatatypeTypeType |#_System._tuple#0._#Make0|))) (and ($Is DatatypeTypeType |lambdaResult#0| Tclass._System.Tuple0) (= (ControlFlow 0 36) 35))) anon3_correct))))
(let ((anon17_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 38) 36) anon18_Then_correct) (=> (= (ControlFlow 0 38) 37) anon18_Else_correct)))))
(let ((anon7_correct  (=> (and (and true (=> (not (|Set#IsMember| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) ($Box refType $nw@0))) true)) (= (ControlFlow 0 25) (- 0 24))) (or (|Set#IsMember| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) ($Box refType $nw@0)) (|Set#Equal| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) |Set#Empty|)))))
(let ((anon20_Else_correct  (=> (and (|Set#IsMember| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) ($Box refType $nw@0)) (= (ControlFlow 0 29) 25)) anon7_correct)))
(let ((anon20_Then_correct  (=> (and (not (|Set#IsMember| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) ($Box refType $nw@0))) ($IsAllocBox ($Box HandleTypeType |f#0@0|) (Tclass._System.___hFunc1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0) $Heap@1)) (and (=> (= (ControlFlow 0 26) (- 0 28)) true) (=> ($IsAlloc refType $nw@0 Tclass.WhatWeKnowAboutReads.S $Heap@1) (and (=> (= (ControlFlow 0 26) (- 0 27)) (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0))) (=> (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) (=> (= (ControlFlow 0 26) 25) anon7_correct))))))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 30) (- 0 33)) true) (=> ($IsAllocBox ($Box HandleTypeType |f#0@0|) (Tclass._System.___hFunc1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0) $Heap@1) (and (=> (= (ControlFlow 0 30) (- 0 32)) true) (=> ($IsAlloc refType $nw@0 Tclass.WhatWeKnowAboutReads.S $Heap@1) (and (=> (= (ControlFlow 0 30) (- 0 31)) (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0))) (=> (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) (and (=> (= (ControlFlow 0 30) 26) anon20_Then_correct) (=> (= (ControlFlow 0 30) 29) anon20_Else_correct))))))))))
(let ((anon24_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 19)) true) (=> ($IsAllocBox ($Box HandleTypeType |f#0@0|) (Tclass._System.___hFunc1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0) $Heap@1) (and (=> (= (ControlFlow 0 16) (- 0 18)) true) (=> ($IsAlloc refType $nw@0 Tclass.WhatWeKnowAboutReads.S $Heap@1) (and (=> (= (ControlFlow 0 16) (- 0 17)) (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0))) (=> (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) (=> (= (ControlFlow 0 16) (- 0 15)) (|Set#IsMember| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) ($Box refType $nw@1)))))))))))
(let ((anon23_Else_correct  (=> (= (ControlFlow 0 20) 16) anon24_Then_correct)))
(let ((anon23_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 14)) true) (=> ($IsAllocBox ($Box HandleTypeType |f#0@0|) (Tclass._System.___hFunc1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0) $Heap@1) (and (=> (= (ControlFlow 0 11) (- 0 13)) true) (=> ($IsAlloc refType $nw@0 Tclass.WhatWeKnowAboutReads.S $Heap@1) (and (=> (= (ControlFlow 0 11) (- 0 12)) (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0))) (=> (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) (=> (= (ControlFlow 0 11) (- 0 10)) (not (|Set#IsMember| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) ($Box refType $nw@1))))))))))))
(let ((anon22_Else_correct  (and (=> (= (ControlFlow 0 21) 11) anon23_Then_correct) (=> (= (ControlFlow 0 21) 20) anon23_Else_correct))))
(let ((anon22_Then_correct  (=> ($IsAllocBox ($Box HandleTypeType |f#0@0|) (Tclass._System.___hFunc1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0) $Heap@1) (and (=> (= (ControlFlow 0 7) (- 0 9)) true) (=> ($IsAlloc refType $nw@0 Tclass.WhatWeKnowAboutReads.S $Heap@1) (and (=> (= (ControlFlow 0 7) (- 0 8)) (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0))) (=> (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) (=> (= (ControlFlow 0 7) (- 0 6)) (|Set#Equal| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) |Set#Empty|)))))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 22) 7) anon22_Then_correct) (=> (= (ControlFlow 0 22) 21) anon22_Else_correct))))
(let ((anon21_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (=> ($IsAllocBox ($Box HandleTypeType |f#0@0|) (Tclass._System.___hFunc1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0) $Heap@1) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (=> ($IsAlloc refType $nw@0 Tclass.WhatWeKnowAboutReads.S $Heap@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0))) (=> (Requires1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (Reads1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0 $Heap@1 |f#0@0| ($Box refType $nw@0)) ($Box refType $nw@0)))))))))))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 23) 2) anon21_Then_correct) (=> (= (ControlFlow 0 23) 22) anon21_Else_correct))))
(let ((anon17_Else_correct  (=> (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#25| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_System._tuple#0._#Make0|))) (|lambda#26| Tclass.WhatWeKnowAboutReads.S) |lambda#28|)) ($LS $LZ)))) (and (=> (= (ControlFlow 0 34) 30) anon19_Then_correct) (=> (= (ControlFlow 0 34) 23) anon19_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass.WhatWeKnowAboutReads.S?)) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 Tclass.WhatWeKnowAboutReads.S?))) (and (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) alloc)))) (= $Heap@1 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (=> (= (ControlFlow 0 39) 38) anon17_Then_correct) (=> (= (ControlFlow 0 39) 34) anon17_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#s#0| (and ($Is refType |s#0| Tclass.WhatWeKnowAboutReads.S) ($IsAlloc refType |s#0| Tclass.WhatWeKnowAboutReads.S $Heap))) true) (and (=> |defass#s'#0| (and ($Is refType |s'#0| Tclass.WhatWeKnowAboutReads.S) ($IsAlloc refType |s'#0| Tclass.WhatWeKnowAboutReads.S $Heap))) true)) (=> (and (and (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 Tclass.WhatWeKnowAboutReads.S Tclass._System.Tuple0) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 40) 39))) anon0_correct)))))
