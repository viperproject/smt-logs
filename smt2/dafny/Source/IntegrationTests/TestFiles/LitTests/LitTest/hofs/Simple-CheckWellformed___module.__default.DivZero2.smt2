...
(assert (forall ((|l#0| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType0Select refType boolType (|lambda#2| |l#0|) |$l#0#o#0|)) |l#0|)
 :qid |unknown.0:0|
 :skolemid |607|
 :pattern ( (MapType0Select refType boolType (|lambda#2| |l#0|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@0| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@0|) |$l#0#ly#0|) |l#0@@0|)
 :qid |Simpledfy.5:3|
 :skolemid |609|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@0|) |$l#0#ly#0|))
)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1| T@U) (|l#2| Int) (|$l#0#heap#0| T@U) (|$l#0#x#0| T@U) (|$l#0#y#0| T@U) ) (! (= (U_2_bool (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType boolType (|lambda#55| |l#0@@1| |l#1| |l#2|) |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|))  (and (and ($IsBox |$l#0#x#0| |l#0@@1|) ($IsBox |$l#0#y#0| |l#1|)) (or (not (= (U_2_int ($Unbox intType |$l#0#y#0|)) |l#2|)) (not true))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |615|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType boolType (|lambda#55| |l#0@@1| |l#1| |l#2|) |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|))
)))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) (|$l#0#y#0@@0| T@U) ) (! (= (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType BoxType |lambda#54| |$l#0#heap#0@@0| |$l#0#x#0@@0| |$l#0#y#0@@0|) ($Box intType (int_2_U (Div (U_2_int ($Unbox intType |$l#0#x#0@@0|)) (U_2_int ($Unbox intType |$l#0#y#0@@0|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |614|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType BoxType |lambda#54| |$l#0#heap#0@@0| |$l#0#x#0@@0| |$l#0#y#0@@0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) (|$l#0#y#0@@1| T@U) ) (! (= (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType SetType (|lambda#57| |l#0@@2|) |$l#0#heap#0@@1| |$l#0#x#0@@1| |$l#0#y#0@@1|) |l#0@@2|)
 :qid |Simpledfy.23:3|
 :skolemid |616|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType SetType (|lambda#57| |l#0@@2|) |$l#0#heap#0@@1| |$l#0#x#0@@1| |$l#0#y#0@@1|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType2Select refType FieldType boolType (|lambda#30| |l#0@@3| |l#1@@0| |l#2@@0| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@0) |l#2@@0|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |612|
 :pattern ( (MapType2Select refType FieldType boolType (|lambda#30| |l#0@@3| |l#1@@0| |l#2@@0| |l#3|) $o@@0 $f))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.DivZero2)
...
(let ((anon13_Else_correct  (=> (and (= |y#0@0| 0) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon13_Then_correct  (=> (or (not (= |y#0@0| 0)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |y#0@0| 0)) (not true))) (=> (or (not (= |y#0@0| 0)) (not true)) (=> (= |lambdaResult#0| (Div |x#0@0| |y#0@0|)) (=> (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 5) 4)) anon7_correct)))))))
