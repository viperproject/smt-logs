...
(set-info :boogie-vc-id Impl$$Maybe.__default.RightIdentity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@4 alloc false)) ($IsAlloc DatatypeTypeType |m#0@@4| (Tclass.Maybe.M Maybe._default.RightIdentity$A) $Heap@@4)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (= |##f#1@0| (|Maybe.__default.Return#Handle| Maybe._default.RightIdentity$A)) (=> (and ($IsAlloc HandleTypeType |##f#1@0| (Tclass._System.___hTotalFunc1 Maybe._default.RightIdentity$A (Tclass.Maybe.M Maybe._default.RightIdentity$A)) $Heap@@4) (|Maybe.__default.Bind#canCall| Maybe._default.RightIdentity$A Maybe._default.RightIdentity$A |m#0@@4| (|Maybe.__default.Return#Handle| Maybe._default.RightIdentity$A))) (=> (and (and (|$IsA#Maybe.M| (Maybe.__default.Bind Maybe._default.RightIdentity$A Maybe._default.RightIdentity$A |m#0@@4| (|Maybe.__default.Return#Handle| Maybe._default.RightIdentity$A))) (|$IsA#Maybe.M| |m#0@@4|)) (|Maybe.__default.Bind#canCall| Maybe._default.RightIdentity$A Maybe._default.RightIdentity$A |m#0@@4| (|Maybe.__default.Return#Handle| Maybe._default.RightIdentity$A))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Maybe.M#Equal| (Maybe.__default.Bind Maybe._default.RightIdentity$A Maybe._default.RightIdentity$A |m#0@@4| (|Maybe.__default.Return#Handle| Maybe._default.RightIdentity$A)) |m#0@@4|)) (=> (|Maybe.M#Equal| (Maybe.__default.Bind Maybe._default.RightIdentity$A Maybe._default.RightIdentity$A |m#0@@4| (|Maybe.__default.Return#Handle| Maybe._default.RightIdentity$A)) |m#0@@4|) (=> (= (ControlFlow 0 2) (- 0 1)) (|Maybe.M#Equal| (Maybe.__default.Bind Maybe._default.RightIdentity$A Maybe._default.RightIdentity$A |m#0@@4| (|Maybe.__default.Return#Handle| Maybe._default.RightIdentity$A)) |m#0@@4|))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and ($Is DatatypeTypeType |m#0@@4| (Tclass.Maybe.M Maybe._default.RightIdentity$A)) ($IsAlloc DatatypeTypeType |m#0@@4| (Tclass.Maybe.M Maybe._default.RightIdentity$A) $Heap@@4)) (|$IsA#Maybe.M| |m#0@@4|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
