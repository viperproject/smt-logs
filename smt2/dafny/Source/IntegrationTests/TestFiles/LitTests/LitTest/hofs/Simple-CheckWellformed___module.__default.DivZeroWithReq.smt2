...
(declare-fun |lambda#20| (Int) T@U)
(declare-fun Div (Int Int) Int)
(declare-fun |lambda#38| (T@U Int) T@U)
...
(declare-fun |_module.__default.DivZeroWithReq#canCall| () Bool)
(declare-fun _module.__default.DivZeroWithReq () T@U)
...
(assert (forall ((|l#0| Int) (|$l#0#heap#0| T@U) (|$l#0#z#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#20| |l#0|) |$l#0#heap#0| |$l#0#z#0|) ($Box intType (int_2_U (Div |l#0| (U_2_int ($Unbox intType |$l#0#z#0|))))))
 :qid |unknown.0:0|
 :skolemid |611|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#20| |l#0|) |$l#0#heap#0| |$l#0#z#0|))
)))
(assert (forall ((|l#0@@0| T@U) (|l#1| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#z#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#38| |l#0@@0| |l#1|) |$l#0#heap#0@@0| |$l#0#z#0@@0|))  (and ($IsBox |$l#0#z#0@@0| |l#0@@0|) (or (not (= (U_2_int ($Unbox intType |$l#0#z#0@@0|)) |l#1|)) (not true))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |613|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#38| |l#0@@0| |l#1|) |$l#0#heap#0@@0| |$l#0#z#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZeroWithReq#canCall| (< 0 $FunctionContextHeight)) ($Is HandleTypeType _module.__default.DivZeroWithReq (Tclass._System.___hFunc1 TInt TInt)))))
...
(assert (forall ((|l#0@@1| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#2| |l#0@@1|) |$l#0#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |607|
 :pattern ( (MapType1Select refType boolType (|lambda#2| |l#0@@1|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@2|) |$l#0#ly#0|) |l#0@@2|)
 :qid |Simpledfy.5:3|
 :skolemid |609|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@2|) |$l#0#ly#0|))
)))
...
(assert (forall ((|#$T0@@8| T@U) (|#$R@@8| T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._System.___hFunc1 |#$T0@@8| |#$R@@8|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@8)) bx@@8) ($Is HandleTypeType ($Unbox HandleTypeType bx@@8) (Tclass._System.___hFunc1 |#$T0@@8| |#$R@@8|))))
 :qid |unknown.0:0|
 :skolemid |369|
 :pattern ( ($IsBox bx@@8 (Tclass._System.___hFunc1 |#$T0@@8| |#$R@@8|)))
)))
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#30| |l#0@@3| |l#1@@0| |l#2| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@0) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |612|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#30| |l#0@@3| |l#1@@0| |l#2| |l#3|) $o@@0 $f))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZeroWithReq#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.DivZeroWithReq (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#20| 5) (|lambda#38| TInt 0) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZeroWithReq#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.DivZeroWithReq (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#20| 5) (|lambda#38| TInt 0) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))
...
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0|) |l#0@@4|)
 :qid |Simpledfy.5:3|
 :skolemid |608|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.DivZeroWithReq)
...
(let ((anon13_Else_correct  (=> (and (= |z#0@0| 0) (= (ControlFlow 0 7) 4)) anon7_correct)))
(let ((anon13_Then_correct  (=> (or (not (= |z#0@0| 0)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |z#0@0| 0)) (not true))) (=> (or (not (= |z#0@0| 0)) (not true)) (=> (= |lambdaResult#0| (Div 5 |z#0@0|)) (=> (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 5) 4)) anon7_correct)))))))
(let ((anon12_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#30| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 8) 5) anon13_Then_correct) (=> (= (ControlFlow 0 8) 7) anon13_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 9) 8) anon12_Then_correct) (=> (= (ControlFlow 0 9) 3) anon12_Else_correct)))))
(let ((anon11_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#30| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Then_correct)) (=> (= (ControlFlow 0 10) 2) anon11_Else_correct)))))
