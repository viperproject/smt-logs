...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (|t#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (or (|_module.__default.B#canCall| $h0@@0 |t#0@@0|) ($Is refType |t#0@@0| Tclass._module.T))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |t#0@@0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0@@0 $o@@3) $f@@0) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1@@0 $o@@3) $f@@0)))) (= (_module.__default.B $h0@@0 |t#0@@0|) (_module.__default.B $h1@@0 |t#0@@0|))))
