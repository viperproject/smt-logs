...
(assert (distinct TInt TagInt TagSet alloc allocName Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._module.T class._module.T? Tagclass._module.T? tytagFamily$object |tytagFamily$_#Func1| tytagFamily$T field$h)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#x#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#5| |l#0|) |$l#0#heap#0| |$l#0#x#0|)) ($IsBox |$l#0#x#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |543|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#5| |l#0|) |$l#0#heap#0| |$l#0#x#0|))
)))
...
(assert (forall (($h0 T@U) ($h1 T@U) (|t#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.J#canCall| $h0 |t#0|) ($Is refType |t#0| Tclass._module.T))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (or (= $o@@0 |t#0|) (|Set#IsMember| (Reads1 TInt TInt $h0 ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 |t#0|) _module.T.h)) ($Box intType (int_2_U (LitInt 0)))) ($Box refType $o@@0)))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@0) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@0) $f)))
 :qid |unknown.0:0|
 :skolemid |492|
)) (= (_module.__default.J $h0 |t#0|) (_module.__default.J $h1 |t#0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.__default.J $h1 |t#0|))
)))
...
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.T $h@@0) ($IsAlloc refType |c#0@@0| Tclass._module.T? $h@@0))
 :qid |unknown.0:0|
 :skolemid |518|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.T $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.T? $h@@0))
)))
...
(assert (forall (($o@@2 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.T? $h@@2)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@2 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |514|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.T? $h@@2))
)))
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (|t#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (or (|_module.__default.B#canCall| $h0@@0 |t#0@@0|) ($Is refType |t#0@@0| Tclass._module.T))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |t#0@@0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0@@0 $o@@3) $f@@0) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1@@0 $o@@3) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |486|
)) (= (_module.__default.B $h0@@0 |t#0@@0|) (_module.__default.B $h1@@0 |t#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |488|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.__default.B $h1@@0 |t#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (|t#0@@1| T@U) ) (!  (=> (or (|_module.__default.J#canCall| $Heap |t#0@@1|) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is refType |t#0@@1| Tclass._module.T)))) (and (and (and true (=> (Requires1 TInt TInt $Heap ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |t#0@@1|) _module.T.h)) ($Box intType (int_2_U (LitInt 0)))) (|_module.__default.B#canCall| $Heap |t#0@@1|))) (=> (not (Requires1 TInt TInt $Heap ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |t#0@@1|) _module.T.h)) ($Box intType (int_2_U (LitInt 0))))) (|_module.__default.B#canCall| $Heap |t#0@@1|))) (= (_module.__default.J $Heap |t#0@@1|) (ite (Requires1 TInt TInt $Heap ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |t#0@@1|) _module.T.h)) ($Box intType (int_2_U (LitInt 0)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (_module.__default.B $Heap |t#0@@1|) ($Box intType (int_2_U (LitInt 0)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (_module.__default.B $Heap |t#0@@1|) ($Box intType (int_2_U (LitInt 0))))))))))
 :qid |Classesdfy.31:16|
 :skolemid |496|
 :pattern ( (_module.__default.J $Heap |t#0@@1|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($h@@3 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.T?))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@4) alloc)))) ($IsAlloc HandleTypeType ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@4) _module.T.h)) (Tclass._System.___hFunc1 TInt TInt) $h@@3))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |516|
 :pattern ( ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@4) _module.T.h)))
)))
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@5 T@U) ($f@@1 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#1| |l#0@@0| |l#1| |l#2| |l#3|) $o@@5 $f@@1))  (=> (and (or (not (= $o@@5 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) (= $o@@5 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |540|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#1| |l#0@@0| |l#1| |l#2| |l#3|) $o@@5 $f@@1))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|t#0@@2| T@U) ) (!  (=> (or (|_module.__default.B#canCall| $Heap@@0 |t#0@@2|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and ($Is refType |t#0@@2| Tclass._module.T) ($IsAlloc refType |t#0@@2| Tclass._module.T $Heap@@0))))) ($Is HandleTypeType (_module.__default.B $Heap@@0 |t#0@@2|) (Tclass._System.___hFunc1 TInt TInt)))
 :qid |Classesdfy.25:16|
 :skolemid |489|
 :pattern ( (_module.__default.B $Heap@@0 |t#0@@2|))
))))
...
(assert (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 Tclass._module.T) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) Tclass._module.T)))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( ($IsBox bx@@7 Tclass._module.T))
)))
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass._module.T?) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) Tclass._module.T?)))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsBox bx@@8 Tclass._module.T?))
)))
...
(assert (forall ((|c#0@@2| T@U) ) (! (= ($Is refType |c#0@@2| Tclass._module.T)  (and ($Is refType |c#0@@2| Tclass._module.T?) (or (not (= |c#0@@2| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |517|
 :pattern ( ($Is refType |c#0@@2| Tclass._module.T))
 :pattern ( ($Is refType |c#0@@2| Tclass._module.T?))
)))
...
(assert (forall ((|l#0@@1| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#6| |l#0@@1|) |$l#0#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |544|
 :pattern ( (MapType1Select refType boolType (|lambda#6| |l#0@@1|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#8| |l#0@@2|) |$l#0#ly#0|) |l#0@@2|)
 :qid |Classesdfy.44:10|
 :skolemid |546|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#8| |l#0@@2|) |$l#0#ly#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|t#0@@3| T@U) ) (!  (=> (or (|_module.__default.B#canCall| $Heap@@1 |t#0@@3|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is refType |t#0@@3| Tclass._module.T)))) (= (_module.__default.B $Heap@@1 |t#0@@3|) ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@1 |t#0@@3|) _module.T.h))))
 :qid |Classesdfy.25:16|
 :skolemid |491|
 :pattern ( (_module.__default.B $Heap@@1 |t#0@@3|) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@7 T@U) ($f@@2 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@7 $f@@2))  (=> (and (or (not (= $o@@7 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@7) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |539|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@7 $f@@2))
)))
...
(assert (forall (($h@@4 T@U) ($o@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass._module.T?))) ($Is HandleTypeType ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@8) _module.T.h)) (Tclass._System.___hFunc1 TInt TInt)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |515|
 :pattern ( ($Unbox HandleTypeType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@8) _module.T.h)))
)))
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#4| |$l#0#heap#0@@0| |$l#0#x#0@@0|) ($Box intType ($Unbox intType |$l#0#x#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |542|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#4| |$l#0#heap#0@@0| |$l#0#x#0@@0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0@@1|) |l#0@@4|)
 :qid |Classesdfy.44:10|
 :skolemid |545|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.U)
...
(let ((anon5_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (= |$rhs#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ)))) (=> (and (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@@2 |t#0@@4| (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 |t#0@@4|) _module.T.h ($Box HandleTypeType |$rhs#0@0|)))) ($IsGoodHeap $Heap@0)) (=> (and (and ($IsAlloc refType |t#0@@4| Tclass._module.T $Heap@0) (|_module.__default.J#canCall| $Heap@0 |t#0@@4|)) (and (|_module.__default.J#canCall| $Heap@0 |t#0@@4|) (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.J $Heap@0 |t#0@@4|) (LitInt 0)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@2 alloc |t#0@@4|)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= |t#0@@4| null)) (not true))) (=> (or (not (= |t#0@@4| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 |t#0@@4| _module.T.h))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 |t#0@@4| _module.T.h)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 2) anon5_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is refType |t#0@@4| Tclass._module.T) ($IsAlloc refType |t#0@@4| Tclass._module.T $Heap@@2)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 9) 6))) anon0_correct))))
