...
(declare-fun ReadsRequiresReads.__default.MyRequiresOk (T@U T@U T@U T@U T@U) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |ReadsRequiresReads.__default.MyRequiresOk#canCall| (T@U T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyRequiresOk$A T@U) (ReadsRequiresReads._default.MyRequiresOk$B T@U) ($Heap T@U) (|f#0| T@U) (|a#0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyRequiresOk#canCall| ReadsRequiresReads._default.MyRequiresOk$A ReadsRequiresReads._default.MyRequiresOk$B $Heap |f#0| |a#0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresOk$A ReadsRequiresReads._default.MyRequiresOk$B))) ($IsBox |a#0| ReadsRequiresReads._default.MyRequiresOk$A)) (Requires1 ReadsRequiresReads._default.MyRequiresOk$A ReadsRequiresReads._default.MyRequiresOk$B $Heap |f#0| |a#0|)))) (and true (= (ReadsRequiresReads.__default.MyRequiresOk ReadsRequiresReads._default.MyRequiresOk$A ReadsRequiresReads._default.MyRequiresOk$B $Heap |f#0| |a#0|) (Requires1 ReadsRequiresReads._default.MyRequiresOk$A ReadsRequiresReads._default.MyRequiresOk$B $Heap |f#0| |a#0|))))
 :qid |unknown.0:0|
 :skolemid |712|
 :pattern ( (ReadsRequiresReads.__default.MyRequiresOk ReadsRequiresReads._default.MyRequiresOk$A ReadsRequiresReads._default.MyRequiresOk$B $Heap |f#0| |a#0|) ($IsGoodHeap $Heap))
))))
...
(declare-fun ReadsRequiresReads._default.MyRequiresOk$A@@0 () T@U)
(declare-fun ReadsRequiresReads._default.MyRequiresOk$B@@0 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$ReadsRequiresReads.__default.MyRequiresOk)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_Else_correct  (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0) $Heap@@0) ($IsAllocBox |a#0@@0| ReadsRequiresReads._default.MyRequiresOk$A@@0 $Heap@@0)) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@2) alloc)))) (|Set#IsMember| (Reads1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |ReadsReadsdfy.59:7|
 :skolemid |715|
))) (= (ReadsRequiresReads.__default.MyRequiresOk ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) (Requires1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|))) (and ($Is boolType (bool_2_U (ReadsRequiresReads.__default.MyRequiresOk ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#2@0|))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc (Reads1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|))) (=> (and (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0) $Heap@@0) ($IsAllocBox |a#0@@0| ReadsRequiresReads._default.MyRequiresOk$A@@0 $Heap@@0)) (and (= |b$reqreads#0@0| (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@3) alloc)))) (|Set#IsMember| (Reads1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) ($Box refType $o@@3))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@3 $f@@1)))
 :qid |ReadsReadsdfy.56:16|
 :skolemid |713|
))) (Requires1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|))) (and (=> (= (ControlFlow 0 4) (- 0 8)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0) $Heap@@0) ($IsAllocBox |a#0@@0| ReadsRequiresReads._default.MyRequiresOk$A@@0 $Heap@@0)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (Requires1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|)) (=> (Requires1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) (=> (= |b$reqreads#1@0| (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@4) alloc)))) (|Set#IsMember| (Reads1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@2)))
 :qid |ReadsReadsdfy.57:13|
 :skolemid |714|
))) (and (=> (= (ControlFlow 0 4) (- 0 6)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0) $Heap@@0) ($IsAllocBox |a#0@@0| ReadsRequiresReads._default.MyRequiresOk$A@@0 $Heap@@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (Requires1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|)) (=> (Requires1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresOk$A@@0 ReadsRequiresReads._default.MyRequiresOk$B@@0)) ($IsBox |a#0@@0| ReadsRequiresReads._default.MyRequiresOk$A@@0)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 4))) anon0_correct))))
