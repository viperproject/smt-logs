...
(declare-fun |Requires.__default.g#Handle| (T@U) T@U)
(declare-fun |Requires.__default.g#requires| (T@U Int) Bool)
...
(declare-fun Requires.__default.g (T@U Int) Int)
(declare-fun $FunctionContextHeight () Int)
(declare-fun |Requires.__default.g#canCall| (Int) Bool)
...
(assert (forall (($ly T@U) ($heap T@U) (|$fh$0x#0| T@U) ) (! (= (Requires1 Tclass._System.nat Tclass._System.nat $heap (|Requires.__default.g#Handle| $ly) |$fh$0x#0|) (|Requires.__default.g#requires| $ly (U_2_int ($Unbox intType |$fh$0x#0|))))
 :qid |unknown.0:0|
 :skolemid |1103|
 :pattern ( (Requires1 Tclass._System.nat Tclass._System.nat $heap (|Requires.__default.g#Handle| $ly) |$fh$0x#0|))
)))
...
(assert (forall (($ly@@0 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Apply1 Tclass._System.nat Tclass._System.nat $heap@@0 (|Requires.__default.g#Handle| $ly@@0) |$fh$0x#0@@0|) ($Box intType (int_2_U (Requires.__default.g $ly@@0 (U_2_int ($Unbox intType |$fh$0x#0@@0|))))))
 :qid |unknown.0:0|
 :skolemid |1102|
 :pattern ( (Apply1 Tclass._System.nat Tclass._System.nat $heap@@0 (|Requires.__default.g#Handle| $ly@@0) |$fh$0x#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap T@U) (|x#0@@1| Int) ) (!  (=> (or (|Requires.__default.g#canCall| |x#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (<= (LitInt 0) |x#0@@1|)) (not (Requires1 Tclass._System.nat Tclass._System.nat $Heap (|Requires.__default.g#Handle| $ly@@1) ($Box intType (int_2_U |x#0@@1|))))))) (<= (LitInt 0) (Requires.__default.g $ly@@1 |x#0@@1|)))
 :qid |Nakeddfy.25:18|
 :skolemid |1106|
 :pattern ( (Requires.__default.g $ly@@1 |x#0@@1|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@0 T@U) (|x#0@@2| Int) ) (!  (=> (or (|Requires.__default.g#canCall| |x#0@@2|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (<= (LitInt 0) |x#0@@2|)) (not (Requires1 Tclass._System.nat Tclass._System.nat $Heap@@0 (|Requires.__default.g#Handle| ($LS $LZ)) ($Box intType (int_2_U |x#0@@2|))))))) (= (Requires.__default.g ($LS $ly@@2) |x#0@@2|) |x#0@@2|))
 :qid |Nakeddfy.25:18|
 :skolemid |1108|
 :pattern ( (Requires.__default.g ($LS $ly@@2) |x#0@@2|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($bx T@U) ($ly@@3 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (|Set#IsMember| (Reads1 Tclass._System.nat Tclass._System.nat $heap@@1 (|Requires.__default.g#Handle| $ly@@3) |$fh$0x#0@@1|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |1104|
 :pattern ( (|Set#IsMember| (Reads1 Tclass._System.nat Tclass._System.nat $heap@@1 (|Requires.__default.g#Handle| $ly@@3) |$fh$0x#0@@1|) $bx))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@4 T@U) ($Heap@@1 T@U) (|x#0@@3| Int) ) (!  (=> (or (|Requires.__default.g#canCall| (LitInt |x#0@@3|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (<= (LitInt 0) |x#0@@3|)) (not (Requires1 Tclass._System.nat Tclass._System.nat $Heap@@1 (|Requires.__default.g#Handle| ($LS $LZ)) ($Box intType (int_2_U (LitInt |x#0@@3|)))))))) (= (Requires.__default.g ($LS $ly@@4) (LitInt |x#0@@3|)) (LitInt |x#0@@3|)))
 :qid |Nakeddfy.25:18|
 :weight 3
 :skolemid |1109|
 :pattern ( (Requires.__default.g ($LS $ly@@4) (LitInt |x#0@@3|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall (($ly@@5 T@U) (|x#0@@4| Int) ) (! (= (Requires.__default.g ($LS $ly@@5) |x#0@@4|) (Requires.__default.g $ly@@5 |x#0@@4|))
 :qid |Nakeddfy.25:18|
 :skolemid |1099|
 :pattern ( (Requires.__default.g ($LS $ly@@5) |x#0@@4|))
)))
(assert (forall (($ly@@6 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| Int) ) (! (= (Requires.__default.g $ly@@6 |$fh$0x#0@@2|) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass._System.nat $heap@@2 (|Requires.__default.g#Handle| $ly@@6) ($Box intType (int_2_U |$fh$0x#0@@2|))))))
 :qid |unknown.0:0|
 :skolemid |1105|
 :pattern ( (Requires.__default.g $ly@@6 |$fh$0x#0@@2|) ($IsGoodHeap $heap@@2))
)))
...
(assert (forall (($ly@@7 T@U) ) (! (= (|Requires.__default.g#Handle| ($LS $ly@@7)) (|Requires.__default.g#Handle| $ly@@7))
 :qid |Nakeddfy.25:18|
 :skolemid |1101|
 :pattern ( (|Requires.__default.g#Handle| ($LS $ly@@7)))
)))
...
(assert (forall (($ly@@8 T@U) ($Heap@@2 T@U) (|x#0@@5| Int) ) (!  (=> (and ($IsGoodHeap $Heap@@2) (<= (LitInt 0) |x#0@@5|)) (= (|Requires.__default.g#requires| $ly@@8 |x#0@@5|)  (not (Requires1 Tclass._System.nat Tclass._System.nat $Heap@@2 (|Requires.__default.g#Handle| ($LS $LZ)) ($Box intType (int_2_U |x#0@@5|))))))
 :qid |Nakeddfy.25:18|
 :skolemid |1107|
 :pattern ( (|Requires.__default.g#requires| $ly@@8 |x#0@@5|) ($IsGoodHeap $Heap@@2))
)))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$Requires.__default.g)
