...
(declare-fun ReadsRequiresReads.__default.MyRequiresBad (T@U T@U T@U T@U) Bool)
(declare-fun |ReadsRequiresReads.__default.MyRequiresBad#canCall| (T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyRequiresBad$A T@U) (ReadsRequiresReads._default.MyRequiresBad$B T@U) ($Heap T@U) (|f#0| T@U) (|a#0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyRequiresBad#canCall| ReadsRequiresReads._default.MyRequiresBad$A ReadsRequiresReads._default.MyRequiresBad$B (Lit HandleTypeType |f#0|) (Lit BoxType |a#0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresBad$A ReadsRequiresReads._default.MyRequiresBad$B))) ($IsBox |a#0| ReadsRequiresReads._default.MyRequiresBad$A)))) (and true (= (ReadsRequiresReads.__default.MyRequiresBad ReadsRequiresReads._default.MyRequiresBad$A ReadsRequiresReads._default.MyRequiresBad$B (Lit HandleTypeType |f#0|) (Lit BoxType |a#0|)) (Requires1 ReadsRequiresReads._default.MyRequiresBad$A ReadsRequiresReads._default.MyRequiresBad$B $Heap (Lit HandleTypeType |f#0|) (Lit BoxType |a#0|)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |719|
 :pattern ( (ReadsRequiresReads.__default.MyRequiresBad ReadsRequiresReads._default.MyRequiresBad$A ReadsRequiresReads._default.MyRequiresBad$B (Lit HandleTypeType |f#0|) (Lit BoxType |a#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyRequiresBad$A@@0 T@U) (ReadsRequiresReads._default.MyRequiresBad$B@@0 T@U) ($Heap@@0 T@U) (|f#0@@0| T@U) (|a#0@@0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyRequiresBad#canCall| ReadsRequiresReads._default.MyRequiresBad$A@@0 ReadsRequiresReads._default.MyRequiresBad$B@@0 |f#0@@0| |a#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresBad$A@@0 ReadsRequiresReads._default.MyRequiresBad$B@@0))) ($IsBox |a#0@@0| ReadsRequiresReads._default.MyRequiresBad$A@@0)))) (and true (= (ReadsRequiresReads.__default.MyRequiresBad ReadsRequiresReads._default.MyRequiresBad$A@@0 ReadsRequiresReads._default.MyRequiresBad$B@@0 |f#0@@0| |a#0@@0|) (Requires1 ReadsRequiresReads._default.MyRequiresBad$A@@0 ReadsRequiresReads._default.MyRequiresBad$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |718|
 :pattern ( (ReadsRequiresReads.__default.MyRequiresBad ReadsRequiresReads._default.MyRequiresBad$A@@0 ReadsRequiresReads._default.MyRequiresBad$B@@0 |f#0@@0| |a#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(declare-fun ReadsRequiresReads._default.MyRequiresBad$A@@1 () T@U)
(declare-fun ReadsRequiresReads._default.MyRequiresBad$B@@1 () T@U)
(declare-fun $Heap@@1 () T@U)
(declare-fun |a#0@@1| () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$ReadsRequiresReads.__default.MyRequiresBad)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@1|) (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresBad$A@@1 ReadsRequiresReads._default.MyRequiresBad$B@@1) $Heap@@1) ($IsAllocBox |a#0@@1| ReadsRequiresReads._default.MyRequiresBad$A@@1 $Heap@@1)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@2) alloc)))) (|Set#IsMember| (Reads1 ReadsRequiresReads._default.MyRequiresBad$A@@1 ReadsRequiresReads._default.MyRequiresBad$B@@1 $Heap@@1 |f#0@@1| |a#0@@1|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |ReadsReadsdfy.64:7|
 :skolemid |720|
))) (= (ReadsRequiresReads.__default.MyRequiresBad ReadsRequiresReads._default.MyRequiresBad$A@@1 ReadsRequiresReads._default.MyRequiresBad$B@@1 |f#0@@1| |a#0@@1|) (Requires1 ReadsRequiresReads._default.MyRequiresBad$A@@1 ReadsRequiresReads._default.MyRequiresBad$B@@1 $Heap@@1 |f#0@@1| |a#0@@1|))) (and ($Is boolType (bool_2_U (ReadsRequiresReads.__default.MyRequiresBad ReadsRequiresReads._default.MyRequiresBad$A@@1 ReadsRequiresReads._default.MyRequiresBad$B@@1 |f#0@@1| |a#0@@1|)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyRequiresBad$A@@1 ReadsRequiresReads._default.MyRequiresBad$B@@1)) ($IsBox |a#0@@1| ReadsRequiresReads._default.MyRequiresBad$A@@1)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
