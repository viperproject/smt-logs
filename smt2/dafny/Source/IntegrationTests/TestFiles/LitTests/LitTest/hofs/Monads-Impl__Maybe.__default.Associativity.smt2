...
(assert (forall ((|l#0| T@U) (|$l#6#heap#0| T@U) (|$l#6#x#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#4| |l#0|) |$l#6#heap#0| |$l#6#x#0|)) ($IsBox |$l#6#x#0| |l#0|))
 :qid |unknown.0:0|
 :skolemid |2326|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#4| |l#0|) |$l#6#heap#0| |$l#6#x#0|))
)))
...
(assert  (and (= (Ctor DatatypeTypeType) 8) (= (Ctor HandleTypeType) 9)))
...
(assert (forall ((Maybe.M$A T@U) ($h@@0 T@U) ) (!  (=> ($IsGoodHeap $h@@0) ($IsAlloc DatatypeTypeType |#Maybe.M.Nothing| (Tclass.Maybe.M Maybe.M$A) $h@@0))
 :qid |unknown.0:0|
 :skolemid |1669|
 :pattern ( ($IsAlloc DatatypeTypeType |#Maybe.M.Nothing| (Tclass.Maybe.M Maybe.M$A) $h@@0))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|$l#6#heap#0@@0| T@U) (|$l#6#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#3| |l#0@@0| |l#1| |l#2| |l#3| |l#4| |l#5|) |$l#6#heap#0@@0| |$l#6#x#0@@0|) ($Box DatatypeTypeType (Maybe.__default.Bind |l#0@@0| |l#1| ($Unbox DatatypeTypeType (Apply1 |l#2| |l#3| |$l#6#heap#0@@0| |l#4| |$l#6#x#0@@0|)) |l#5|)))
 :qid |unknown.0:0|
 :skolemid |2325|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#3| |l#0@@0| |l#1| |l#2| |l#3| |l#4| |l#5|) |$l#6#heap#0@@0| |$l#6#x#0@@0|))
)))
...
(assert (forall ((Maybe.M$A@@2 T@U) (|a#2#0#0| T@U) ($h@@4 T@U) ) (!  (=> ($IsGoodHeap $h@@4) (= ($IsAlloc DatatypeTypeType (|#Maybe.M.Just| |a#2#0#0|) (Tclass.Maybe.M Maybe.M$A@@2) $h@@4) ($IsAllocBox |a#2#0#0| Maybe.M$A@@2 $h@@4)))
 :qid |unknown.0:0|
 :skolemid |1661|
 :pattern ( ($IsAlloc DatatypeTypeType (|#Maybe.M.Just| |a#2#0#0|) (Tclass.Maybe.M Maybe.M$A@@2) $h@@4))
)))
...
(assert (forall ((|l#0@@1| Bool) (|$l#6#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#5| |l#0@@1|) |$l#6#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |2327|
 :pattern ( (MapType1Select refType boolType (|lambda#5| |l#0@@1|) |$l#6#o#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#6#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#7| |l#0@@2|) |$l#6#ly#0|) |l#0@@2|)
 :qid |Monadsdfy.21:20|
 :skolemid |2329|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#7| |l#0@@2|) |$l#6#ly#0|))
)))
...
(assert (forall ((a@@3 T@U) (b@@3 T@U) ) (!  (=> (and (Maybe.M.Nothing_q a@@3) (Maybe.M.Nothing_q b@@3)) (|Maybe.M#Equal| a@@3 b@@3))
 :qid |unknown.0:0|
 :skolemid |1673|
 :pattern ( (|Maybe.M#Equal| a@@3 b@@3) (Maybe.M.Nothing_q a@@3))
 :pattern ( (|Maybe.M#Equal| a@@3 b@@3) (Maybe.M.Nothing_q b@@3))
)))
...
(assert (forall ((d@@5 T@U) (Maybe.M$A@@6 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (Maybe.M.Just_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass.Maybe.M Maybe.M$A@@6) $h@@5))) ($IsAllocBox (Maybe.M._h1 d@@5) Maybe.M$A@@6 $h@@5))
 :qid |unknown.0:0|
 :skolemid |1662|
 :pattern ( ($IsAllocBox (Maybe.M._h1 d@@5) Maybe.M$A@@6 $h@@5))
)))
...
(assert (forall ((Maybe.M$A@@7 T@U) (bx@@12 T@U) ) (!  (=> ($IsBox bx@@12 (Tclass.Maybe.M Maybe.M$A@@7)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@12)) bx@@12) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@12) (Tclass.Maybe.M Maybe.M$A@@7))))
 :qid |unknown.0:0|
 :skolemid |1635|
 :pattern ( ($IsBox bx@@12 (Tclass.Maybe.M Maybe.M$A@@7)))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#6#heap#0@@1| T@U) (|$l#6#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#6| |l#0@@4|) |$l#6#heap#0@@1| |$l#6#x#0@@1|) |l#0@@4|)
 :qid |Monadsdfy.21:20|
 :skolemid |2328|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#6| |l#0@@4|) |$l#6#heap#0@@1| |$l#6#x#0@@1|))
)))
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun |x#1@0| () T@U)
(declare-fun Maybe._default.Associativity$A () T@U)
(declare-fun |$lambdaHeap#1@0| () T@U)
(declare-fun |$_Frame#l1@0| () T@U)
(declare-fun |##m#7@0| () T@U)
(declare-fun Maybe._default.Associativity$B () T@U)
(declare-fun |f#0@@8| () T@U)
(declare-fun |g#0| () T@U)
(declare-fun Maybe._default.Associativity$C () T@U)
(declare-fun |lambdaResult#1| () T@U)
(declare-fun $Heap@@3 () T@U)
(declare-fun |m#0@@4| () T@U)
(declare-fun $LZ () T@U)
(declare-fun |##f#6@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun |##m#4@0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$Maybe.__default.Associativity)
...
(let ((anon6_Else_correct  (=> (and (not (and ($IsBox |x#1@0| Maybe._default.Associativity$A) ($IsAllocBox |x#1@0| Maybe._default.Associativity$A |$lambdaHeap#1@0|))) (= (ControlFlow 0 7) 5)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (and ($IsBox |x#1@0| Maybe._default.Associativity$A) ($IsAllocBox |x#1@0| Maybe._default.Associativity$A |$lambdaHeap#1@0|)) (= |$_Frame#l1@0| (|lambda#0| null |$lambdaHeap#1@0| alloc false))) (=> (and (and (and (= |##m#7@0| ($Unbox DatatypeTypeType (Apply1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |$lambdaHeap#1@0| |f#0@@8| |x#1@0|))) ($IsAlloc DatatypeTypeType |##m#7@0| (Tclass.Maybe.M Maybe._default.Associativity$B) |$lambdaHeap#1@0|)) (and ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 Maybe._default.Associativity$B (Tclass.Maybe.M Maybe._default.Associativity$C)) |$lambdaHeap#1@0|) (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$B Maybe._default.Associativity$C ($Unbox DatatypeTypeType (Apply1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |$lambdaHeap#1@0| |f#0@@8| |x#1@0|)) |g#0|))) (and (and (= |lambdaResult#1| (Maybe.__default.Bind Maybe._default.Associativity$B Maybe._default.Associativity$C ($Unbox DatatypeTypeType (Apply1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) $Heap@@3 |f#0@@8| |x#1@0|)) |g#0|)) (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$B Maybe._default.Associativity$C ($Unbox DatatypeTypeType (Apply1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) $Heap@@3 |f#0@@8| |x#1@0|)) |g#0|)) (and ($Is DatatypeTypeType |lambdaResult#1| (Tclass.Maybe.M Maybe._default.Associativity$C)) (= (ControlFlow 0 6) 5)))) anon3_correct))))
(let ((anon5_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap@@3 |$lambdaHeap#1@0|) ($HeapSucc $Heap@@3 |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|Maybe.M#Equal| (Maybe.__default.Bind Maybe._default.Associativity$B Maybe._default.Associativity$C (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|) |g#0|) (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$C |m#0@@4| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| Maybe._default.Associativity$B Maybe._default.Associativity$C Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |f#0@@8| |g#0|) (|lambda#4| Maybe._default.Associativity$A) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))))))
(let ((anon5_Else_correct  (=> (= |##f#6@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| Maybe._default.Associativity$B Maybe._default.Associativity$C Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |f#0@@8| |g#0|) (|lambda#4| Maybe._default.Associativity$A) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##f#6@0| (Tclass._System.___hTotalFunc1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$C)) $Heap@@3) (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$A Maybe._default.Associativity$C |m#0@@4| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| Maybe._default.Associativity$B Maybe._default.Associativity$C Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |f#0@@8| |g#0|) (|lambda#4| Maybe._default.Associativity$A) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))) (=> (and (and (|$IsA#Maybe.M| (Maybe.__default.Bind Maybe._default.Associativity$B Maybe._default.Associativity$C (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|) |g#0|)) (|$IsA#Maybe.M| (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$C |m#0@@4| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| Maybe._default.Associativity$B Maybe._default.Associativity$C Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |f#0@@8| |g#0|) (|lambda#4| Maybe._default.Associativity$A) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ)))))) (and (and (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|) (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$B Maybe._default.Associativity$C (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|) |g#0|)) (and (forall ((|$l#15#x#0| T@U) (|$l#15#heap#0| T@U) ) (!  (=> (and ($IsBox |$l#15#x#0| Maybe._default.Associativity$A) ($IsGoodHeap |$l#15#heap#0|)) (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$B Maybe._default.Associativity$C ($Unbox DatatypeTypeType (Apply1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |$l#15#heap#0| |f#0@@8| |$l#15#x#0|)) |g#0|))
 :qid |unknown.0:0|
 :skolemid |1655|
)) (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$A Maybe._default.Associativity$C |m#0@@4| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| Maybe._default.Associativity$B Maybe._default.Associativity$C Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |f#0@@8| |g#0|) (|lambda#4| Maybe._default.Associativity$A) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Maybe.M#Equal| (Maybe.__default.Bind Maybe._default.Associativity$B Maybe._default.Associativity$C (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|) |g#0|) (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$C |m#0@@4| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| Maybe._default.Associativity$B Maybe._default.Associativity$C Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |f#0@@8| |g#0|) (|lambda#4| Maybe._default.Associativity$A) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ)))))) (=> (|Maybe.M#Equal| (Maybe.__default.Bind Maybe._default.Associativity$B Maybe._default.Associativity$C (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|) |g#0|) (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$C |m#0@@4| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| Maybe._default.Associativity$B Maybe._default.Associativity$C Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B) |f#0@@8| |g#0|) (|lambda#4| Maybe._default.Associativity$A) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))) (=> (= (ControlFlow 0 3) 2) GeneratedUnifiedExit_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (=> (and (and (and ($IsAlloc DatatypeTypeType |m#0@@4| (Tclass.Maybe.M Maybe._default.Associativity$A) $Heap@@3) ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B)) $Heap@@3)) (and (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|) (= |##m#4@0| (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|)))) (and (and ($IsAlloc DatatypeTypeType |##m#4@0| (Tclass.Maybe.M Maybe._default.Associativity$B) $Heap@@3) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 Maybe._default.Associativity$B (Tclass.Maybe.M Maybe._default.Associativity$C)) $Heap@@3)) (and (|Maybe.__default.Bind#canCall| Maybe._default.Associativity$B Maybe._default.Associativity$C (Maybe.__default.Bind Maybe._default.Associativity$A Maybe._default.Associativity$B |m#0@@4| |f#0@@8|) |g#0|) ($IsAlloc DatatypeTypeType |m#0@@4| (Tclass.Maybe.M Maybe._default.Associativity$A) $Heap@@3)))) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 3) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (and ($Is DatatypeTypeType |m#0@@4| (Tclass.Maybe.M Maybe._default.Associativity$A)) ($IsAlloc DatatypeTypeType |m#0@@4| (Tclass.Maybe.M Maybe._default.Associativity$A) $Heap@@3)) (|$IsA#Maybe.M| |m#0@@4|)) (and ($Is HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B))) ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc1 Maybe._default.Associativity$A (Tclass.Maybe.M Maybe._default.Associativity$B)) $Heap@@3))) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 Maybe._default.Associativity$B (Tclass.Maybe.M Maybe._default.Associativity$C))) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 Maybe._default.Associativity$B (Tclass.Maybe.M Maybe._default.Associativity$C)) $Heap@@3)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct))))
