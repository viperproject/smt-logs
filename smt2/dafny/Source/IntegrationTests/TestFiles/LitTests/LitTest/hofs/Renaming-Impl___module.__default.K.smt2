...
(declare-fun |lambda#109| (T@U T@U T@U) T@U)
(declare-fun AtLayer (T@T T@U T@U) T@U)
(declare-fun |lambda#4| (T@U) T@U)
(declare-fun |lambda#104| (T@U) T@U)
...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|$l#30#heap#0| T@U) (|$l#30#x#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#109| |l#0@@0| |l#1| |l#2|) |$l#30#heap#0| |$l#30#x#0|) ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#104| |$l#30#x#0|) |l#0@@0| |l#1|)) |l#2|))))
 :qid |nofile.1:7|
 :skolemid |508|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#109| |l#0@@0| |l#1| |l#2|) |$l#30#heap#0| |$l#30#x#0|))
)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| T@U) (|$l#30#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#113| |l#0@@1| |l#1@@0| |l#2@@0| |l#3|) |$l#30#ly#0|) (Handle1 (|lambda#109| |l#0@@1| |l#1@@0| |$l#30#ly#0|) |l#2@@0| |l#3|))
 :qid |nofile.1:7|
 :skolemid |509|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#113| |l#0@@1| |l#1@@0| |l#2@@0| |l#3|) |$l#30#ly#0|))
)))
...
(assert (forall ((|$l#7#heap#0| T@U) (|$l#7#x#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#78| |$l#7#heap#0| |$l#7#x#0|) |$l#7#x#0|)
 :qid |DafnyPreludebpl.593:12|
 :skolemid |506|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#78| |$l#7#heap#0| |$l#7#x#0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@1| T@U) (|l#2@@1| T@U) (|l#3@@0| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#61| |l#0@@4| |l#1@@1| |l#2@@1| |l#3@@0|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@1| $o@@1) |l#2@@1|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |505|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#61| |l#0@@4| |l#1@@1| |l#2@@1| |l#3@@0|) $o@@1 $f))
)))
...
(assert (forall ((|l#0@@5| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@5|) |$l#0#heap#0@@0| |$l#0#x#0@@0|) |l#0@@5|)
 :qid |Renamingdfy.4:17|
 :skolemid |502|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@5|) |$l#0#heap#0@@0| |$l#0#x#0@@0|))
)))
(assert (forall ((|l#0@@6| T@U) (|$l#31#heap#0| T@U) (|$l#31#y#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#104| |l#0@@6|) |$l#31#heap#0| |$l#31#y#0|) |l#0@@6|)
 :qid |unknown.0:0|
 :skolemid |507|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#104| |l#0@@6|) |$l#31#heap#0| |$l#31#y#0|))
)))
...
(declare-fun |lambdaResult#6| () T@U)
(declare-fun |a#0@0| () T@U)
(declare-fun |$lambdaHeap#5@0| () T@U)
(declare-fun |lambdaResult#5| () T@U)
...
(let ((anon22_Else_correct  (=> (and (not (and ($IsBox |z#0@0| _module._default.K$A) ($IsAllocBox |z#0@0| _module._default.K$A |$lambdaHeap#2@0|))) (= (ControlFlow 0 25) 23)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and ($IsBox |z#0@0| _module._default.K$A) ($IsAllocBox |z#0@0| _module._default.K$A |$lambdaHeap#2@0|)) (=> (and (and (= |$_Frame#l2@0| (|lambda#61| null |$lambdaHeap#2@0| alloc false)) (= |lambdaResult#2| |z#0@0|)) (and ($IsBox |lambdaResult#2| _module._default.K$A) (= (ControlFlow 0 24) 23))) anon3_correct))))
(let ((anon21_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2@0|) (or (= $Heap |$lambdaHeap#2@0|) ($HeapSucc $Heap |$lambdaHeap#2@0|))) (and (=> (= (ControlFlow 0 26) 24) anon22_Then_correct) (=> (= (ControlFlow 0 26) 25) anon22_Else_correct)))))
(let ((anon9_correct true))
(let ((anon26_Else_correct  (=> (and (not (and ($IsBox |y#1@0| _module._default.K$B) ($IsAllocBox |y#1@0| _module._default.K$B |$lambdaHeap#4@0|))) (= (ControlFlow 0 17) 15)) anon9_correct)))
(let ((anon26_Then_correct  (=> (and ($IsBox |y#1@0| _module._default.K$B) ($IsAllocBox |y#1@0| _module._default.K$B |$lambdaHeap#4@0|)) (=> (and (and (= |$_Frame#l4@0| (|lambda#61| null |$lambdaHeap#4@0| alloc false)) (= |lambdaResult#4| |x#1@0|)) (and ($IsBox |lambdaResult#4| _module._default.K$A) (= (ControlFlow 0 16) 15))) anon9_correct))))
(let ((anon25_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#4@0|) (or (= |$lambdaHeap#3@0| |$lambdaHeap#4@0|) ($HeapSucc |$lambdaHeap#3@0| |$lambdaHeap#4@0|))) (and (=> (= (ControlFlow 0 18) 16) anon26_Then_correct) (=> (= (ControlFlow 0 18) 17) anon26_Else_correct)))))
(let ((anon11_correct true))
(let ((anon25_Else_correct  (=> (= |lambdaResult#3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#104| |x#1@0|) (|lambda#1| _module._default.K$B) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (=> (and ($Is HandleTypeType |lambdaResult#3| (Tclass._System.___hTotalFunc1 _module._default.K$B _module._default.K$A)) (= (ControlFlow 0 14) 12)) anon11_correct))))
(let ((anon24_Then_correct  (=> (and (and ($IsBox |x#1@0| _module._default.K$A) ($IsAllocBox |x#1@0| _module._default.K$A |$lambdaHeap#3@0|)) (= |$_Frame#l3@0| (|lambda#61| null |$lambdaHeap#3@0| alloc false))) (and (=> (= (ControlFlow 0 19) 18) anon25_Then_correct) (=> (= (ControlFlow 0 19) 14) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (not (and ($IsBox |x#1@0| _module._default.K$A) ($IsAllocBox |x#1@0| _module._default.K$A |$lambdaHeap#3@0|))) (= (ControlFlow 0 13) 12)) anon11_correct)))
(let ((anon23_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#3@0|) (or (= $Heap |$lambdaHeap#3@0|) ($HeapSucc $Heap |$lambdaHeap#3@0|))) (and (=> (= (ControlFlow 0 20) 19) anon24_Then_correct) (=> (= (ControlFlow 0 20) 13) anon24_Else_correct)))))
(let ((anon17_correct true))
(let ((anon30_Else_correct  (=> (and (not (and ($IsBox |b#0@0| _module._default.K$B) ($IsAllocBox |b#0@0| _module._default.K$B |$lambdaHeap#6@0|))) (= (ControlFlow 0 8) 6)) anon17_correct)))
(let ((anon30_Then_correct  (=> (and ($IsBox |b#0@0| _module._default.K$B) ($IsAllocBox |b#0@0| _module._default.K$B |$lambdaHeap#6@0|)) (=> (and (and (= |$_Frame#l6@0| (|lambda#61| null |$lambdaHeap#6@0| alloc false)) (= |lambdaResult#6| |a#0@0|)) (and ($IsBox |lambdaResult#6| _module._default.K$A) (= (ControlFlow 0 7) 6))) anon17_correct))))
(let ((anon29_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#6@0|) (or (= |$lambdaHeap#5@0| |$lambdaHeap#6@0|) ($HeapSucc |$lambdaHeap#5@0| |$lambdaHeap#6@0|))) (and (=> (= (ControlFlow 0 9) 7) anon30_Then_correct) (=> (= (ControlFlow 0 9) 8) anon30_Else_correct)))))
(let ((anon19_correct true))
(let ((anon29_Else_correct  (=> (= |lambdaResult#5| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#104| |a#0@0|) (|lambda#1| _module._default.K$B) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (=> (and ($Is HandleTypeType |lambdaResult#5| (Tclass._System.___hTotalFunc1 _module._default.K$B _module._default.K$A)) (= (ControlFlow 0 5) 3)) anon19_correct))))
(let ((anon28_Then_correct  (=> (and (and ($IsBox |a#0@0| _module._default.K$A) ($IsAllocBox |a#0@0| _module._default.K$A |$lambdaHeap#5@0|)) (= |$_Frame#l5@0| (|lambda#61| null |$lambdaHeap#5@0| alloc false))) (and (=> (= (ControlFlow 0 10) 9) anon29_Then_correct) (=> (= (ControlFlow 0 10) 5) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (not (and ($IsBox |a#0@0| _module._default.K$A) ($IsAllocBox |a#0@0| _module._default.K$A |$lambdaHeap#5@0|))) (= (ControlFlow 0 4) 3)) anon19_correct)))
(let ((anon27_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#5@0|) (or (= $Heap |$lambdaHeap#5@0|) ($HeapSucc $Heap |$lambdaHeap#5@0|))) (and (=> (= (ControlFlow 0 11) 10) anon28_Then_correct) (=> (= (ControlFlow 0 11) 4) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#113| (|lambda#1| _module._default.K$B) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))) (|lambda#1| _module._default.K$A) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) ($LS $LZ))) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#113| (|lambda#1| _module._default.K$B) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))) (|lambda#1| _module._default.K$A) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) ($LS $LZ)))))))
(let ((anon21_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (U_2_bool ($Unbox boolType (Apply1 (Tclass._System.___hTotalFunc1 _module._default.K$A _module._default.K$A) TBool $Heap |P#0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#78| (|lambda#1| _module._default.K$A) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))) (=> (U_2_bool ($Unbox boolType (Apply1 (Tclass._System.___hTotalFunc1 _module._default.K$A _module._default.K$A) TBool $Heap |P#0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#78| (|lambda#1| _module._default.K$A) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))) (and (and (=> (= (ControlFlow 0 21) 20) anon23_Then_correct) (=> (= (ControlFlow 0 21) 11) anon27_Then_correct)) (=> (= (ControlFlow 0 21) 2) anon27_Else_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#61| null $Heap alloc false)) (and (=> (= (ControlFlow 0 27) 26) anon21_Then_correct) (=> (= (ControlFlow 0 27) 21) anon21_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |P#0| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 _module._default.K$A _module._default.K$A) TBool)) ($IsAlloc HandleTypeType |P#0| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 _module._default.K$A _module._default.K$A) TBool) $Heap))) (and (and (= 0 $FunctionContextHeight) (Requires1 (Tclass._System.___hTotalFunc1 _module._default.K$A _module._default.K$A) TBool $Heap |P#0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#78| (|lambda#1| _module._default.K$A) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))) (and (U_2_bool ($Unbox boolType (Apply1 (Tclass._System.___hTotalFunc1 _module._default.K$A _module._default.K$A) TBool $Heap |P#0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#78| (|lambda#1| _module._default.K$A) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))) (= (ControlFlow 0 28) 27)))) anon0_correct)))
