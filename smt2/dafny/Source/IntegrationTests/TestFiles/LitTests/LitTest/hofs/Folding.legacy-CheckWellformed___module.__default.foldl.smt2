...
(declare-fun _module._default.foldl$A@@5 () T@U)
(declare-fun |let#0#0#0| () T@U)
(declare-fun |tail#Z#0@0| () T@U)
(declare-fun |let#1#0#0| () T@U)
(declare-fun |head#Z#0@0| () T@U)
(declare-fun |f#0@@9| () T@U)
(declare-fun _module._default.foldl$B@@5 () T@U)
(declare-fun $Heap@@3 () T@U)
(declare-fun |##b#0@0| () T@U)
(declare-fun |b#0@@5| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.foldl)
...
(let ((anon10_Then_correct  (=> (and (= |xs#0@@5| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| _module._default.foldl$A@@5)) (=> (and (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.foldl$A@@5)) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.foldl$A@@5)) (= |tail#Z#0@0| |let#0#0#0|))) (=> (and (and (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| _module._default.foldl$A@@5)) (and (= |head#Z#0@0| |let#1#0#0|) ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc2 _module._default.foldl$B@@5 _module._default.foldl$A@@5 _module._default.foldl$B@@5) $Heap@@3))) (and (and (= |##b#0@0| (Apply2 _module._default.foldl$B@@5 _module._default.foldl$A@@5 _module._default.foldl$B@@5 $Heap@@3 |f#0@@9| |b#0@@5| |head#Z#0@0|)) ($IsAllocBox |##b#0@0| _module._default.foldl$B@@5 $Heap@@3)) (and ($IsAlloc DatatypeTypeType |tail#Z#0@0| (Tclass._module.List _module._default.foldl$A@@5) $Heap@@3) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@5|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc2 _module._default.foldl$B@@5 _module._default.foldl$A@@5 _module._default.foldl$B@@5))) (and (and ($IsBox |b#0@@5| _module._default.foldl$B@@5) ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List _module._default.foldl$A@@5))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
