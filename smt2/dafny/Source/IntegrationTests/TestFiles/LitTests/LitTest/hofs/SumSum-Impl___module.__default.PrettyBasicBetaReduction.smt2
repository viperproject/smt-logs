...
(let ((anon100_Else_correct  (=> (and (forall ((|$l#0_0_1_9#x#0| T@U) ) (|_module.__default.Sum#canCall| |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#0_0_1_9#x#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (= (ControlFlow 0 79) (- 0 78))) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#57| |n#0@@3| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0|))))) (LitInt 0)))))
...
(let ((anon117_Else_correct  (=> (and (forall ((|$l#1_0_3_21#x#0| T@U) ) (|_module.__default.Sum#canCall| (- |n#0@@3| 1) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#1_0_3_21#x#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (= (ControlFlow 0 10) (- 0 9))) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#57| |n#0@@3| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0|))))) (+ (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $Heap@@2 |g#0| ($Box intType (int_2_U |i#0|)) ($Box intType (int_2_U (- |n#0@@3| 1)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#57| (- |n#0@@3| 1) TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0|))))))))))
(let ((anon113_Else_correct  (=> (forall ((|$l#1_0_3_9#x#0| T@U) ) (|_module.__default.Sum#canCall| |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#1_0_3_9#x#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (and (=> (= (ControlFlow 0 19) 18) anon117_Then_correct) (=> (= (ControlFlow 0 19) 10) anon117_Else_correct)))))
