...
(declare-fun Tagclass._module.FnRef () T@U)
(declare-fun Tagclass._module.FnRef? () T@U)
(declare-fun class._module.FnRef? () T@U)
(declare-fun |tytagFamily$_#Func1| () T@U)
(declare-fun |tytagFamily$_#PartialFunc1| () T@U)
(declare-fun tytagFamily$FnRef () T@U)
(declare-fun field$fn () T@U)
...
(declare-fun _module.FnRef.fn () T@U)
...
(declare-fun Tclass._module.FnRef (T@U T@U) T@U)
(declare-fun Tclass._module.FnRef? (T@U T@U) T@U)
...
(declare-fun Tclass._module.FnRef_0 (T@U) T@U)
(declare-fun Tclass._module.FnRef_1 (T@U) T@U)
(declare-fun Tclass._module.FnRef?_0 (T@U) T@U)
(declare-fun Tclass._module.FnRef?_1 (T@U) T@U)
...
(assert (distinct TBool TInt TagBool TagInt alloc allocName Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._module.FnRef Tagclass._module.FnRef? class._module.FnRef? |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| tytagFamily$FnRef field$fn)
)
(assert (= (FDim alloc) 0))
...
(assert (= (FDim _module.FnRef.fn) 0))
(assert (= (FieldOfDecl class._module.FnRef? field$fn) _module.FnRef.fn))
(assert  (not ($IsGhostField _module.FnRef.fn)))
...
(assert (forall ((_module.FnRef$A T@U) (_module.FnRef$B T@U) (|c#0| T@U) ) (! (= ($Is refType |c#0| (Tclass._module.FnRef _module.FnRef$A _module.FnRef$B))  (and ($Is refType |c#0| (Tclass._module.FnRef? _module.FnRef$A _module.FnRef$B)) (or (not (= |c#0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |509|
 :pattern ( ($Is refType |c#0| (Tclass._module.FnRef _module.FnRef$A _module.FnRef$B)))
 :pattern ( ($Is refType |c#0| (Tclass._module.FnRef? _module.FnRef$A _module.FnRef$B)))
)))
...
(assert (forall ((_module.FnRef$A@@0 T@U) (_module.FnRef$B@@0 T@U) ($o T@U) ) (! (= ($Is refType $o (Tclass._module.FnRef? _module.FnRef$A@@0 _module.FnRef$B@@0))  (or (= $o null) (= (dtype $o) (Tclass._module.FnRef? _module.FnRef$A@@0 _module.FnRef$B@@0))))
 :qid |unknown.0:0|
 :skolemid |505|
 :pattern ( ($Is refType $o (Tclass._module.FnRef? _module.FnRef$A@@0 _module.FnRef$B@@0)))
)))
...
(assert (forall ((_module.FnRef$A@@1 T@U) (_module.FnRef$B@@1 T@U) (|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| (Tclass._module.FnRef _module.FnRef$A@@1 _module.FnRef$B@@1) $h@@0) ($IsAlloc refType |c#0@@0| (Tclass._module.FnRef? _module.FnRef$A@@1 _module.FnRef$B@@1) $h@@0))
 :qid |unknown.0:0|
 :skolemid |510|
 :pattern ( ($IsAlloc refType |c#0@@0| (Tclass._module.FnRef _module.FnRef$A@@1 _module.FnRef$B@@1) $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| (Tclass._module.FnRef? _module.FnRef$A@@1 _module.FnRef$B@@1) $h@@0))
)))
...
(assert (forall ((_module.FnRef$A@@2 T@U) (_module.FnRef$B@@2 T@U) ($o@@0 T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType $o@@0 (Tclass._module.FnRef? _module.FnRef$A@@2 _module.FnRef$B@@2) $h@@1)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |506|
 :pattern ( ($IsAlloc refType $o@@0 (Tclass._module.FnRef? _module.FnRef$A@@2 _module.FnRef$B@@2) $h@@1))
)))
...
(assert (forall ((_module.FnRef$A@@3 T@U) (_module.FnRef$B@@3 T@U) ) (! (= (Tclass._module.FnRef_0 (Tclass._module.FnRef _module.FnRef$A@@3 _module.FnRef$B@@3)) _module.FnRef$A@@3)
 :qid |unknown.0:0|
 :skolemid |492|
 :pattern ( (Tclass._module.FnRef _module.FnRef$A@@3 _module.FnRef$B@@3))
)))
(assert (forall ((_module.FnRef$A@@4 T@U) (_module.FnRef$B@@4 T@U) ) (! (= (Tclass._module.FnRef_1 (Tclass._module.FnRef _module.FnRef$A@@4 _module.FnRef$B@@4)) _module.FnRef$B@@4)
 :qid |unknown.0:0|
 :skolemid |493|
 :pattern ( (Tclass._module.FnRef _module.FnRef$A@@4 _module.FnRef$B@@4))
)))
(assert (forall ((_module.FnRef$A@@5 T@U) (_module.FnRef$B@@5 T@U) ) (! (= (Tclass._module.FnRef?_0 (Tclass._module.FnRef? _module.FnRef$A@@5 _module.FnRef$B@@5)) _module.FnRef$A@@5)
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( (Tclass._module.FnRef? _module.FnRef$A@@5 _module.FnRef$B@@5))
)))
(assert (forall ((_module.FnRef$A@@6 T@U) (_module.FnRef$B@@6 T@U) ) (! (= (Tclass._module.FnRef?_1 (Tclass._module.FnRef? _module.FnRef$A@@6 _module.FnRef$B@@6)) _module.FnRef$B@@6)
 :qid |unknown.0:0|
 :skolemid |497|
 :pattern ( (Tclass._module.FnRef? _module.FnRef$A@@6 _module.FnRef$B@@6))
)))
...
(assert (forall ((_module.FnRef$A@@7 T@U) (_module.FnRef$B@@7 T@U) ($h@@2 T@U) ($o@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) (Tclass._module.FnRef? _module.FnRef$A@@7 _module.FnRef$B@@7)))) ($Is HandleTypeType ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) _module.FnRef.fn)) (Tclass._System.___hPartialFunc1 _module.FnRef$A@@7 _module.FnRef$B@@7)))
 :qid |unknown.0:0|
 :skolemid |507|
 :pattern ( ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) _module.FnRef.fn)) (Tclass._module.FnRef? _module.FnRef$A@@7 _module.FnRef$B@@7))
)))
...
(assert (forall ((_module.FnRef$A@@8 T@U) (_module.FnRef$B@@8 T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass._module.FnRef _module.FnRef$A@@8 _module.FnRef$B@@8)) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) (Tclass._module.FnRef _module.FnRef$A@@8 _module.FnRef$B@@8))))
 :qid |unknown.0:0|
 :skolemid |494|
 :pattern ( ($IsBox bx@@6 (Tclass._module.FnRef _module.FnRef$A@@8 _module.FnRef$B@@8)))
)))
(assert (forall ((_module.FnRef$A@@9 T@U) (_module.FnRef$B@@9 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._module.FnRef? _module.FnRef$A@@9 _module.FnRef$B@@9)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass._module.FnRef? _module.FnRef$A@@9 _module.FnRef$B@@9))))
 :qid |unknown.0:0|
 :skolemid |498|
 :pattern ( ($IsBox bx@@7 (Tclass._module.FnRef? _module.FnRef$A@@9 _module.FnRef$B@@9)))
)))
...
(assert (forall ((_module.FnRef$A@@10 T@U) (_module.FnRef$B@@10 T@U) ) (!  (and (= (Tag (Tclass._module.FnRef _module.FnRef$A@@10 _module.FnRef$B@@10)) Tagclass._module.FnRef) (= (TagFamily (Tclass._module.FnRef _module.FnRef$A@@10 _module.FnRef$B@@10)) tytagFamily$FnRef))
 :qid |unknown.0:0|
 :skolemid |491|
 :pattern ( (Tclass._module.FnRef _module.FnRef$A@@10 _module.FnRef$B@@10))
)))
(assert (forall ((_module.FnRef$A@@11 T@U) (_module.FnRef$B@@11 T@U) ) (!  (and (= (Tag (Tclass._module.FnRef? _module.FnRef$A@@11 _module.FnRef$B@@11)) Tagclass._module.FnRef?) (= (TagFamily (Tclass._module.FnRef? _module.FnRef$A@@11 _module.FnRef$B@@11)) tytagFamily$FnRef))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( (Tclass._module.FnRef? _module.FnRef$A@@11 _module.FnRef$B@@11))
)))
(assert (forall ((_module.FnRef$A@@12 T@U) (_module.FnRef$B@@12 T@U) ($h@@3 T@U) ($o@@3 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) (Tclass._module.FnRef? _module.FnRef$A@@12 _module.FnRef$B@@12)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) alloc)))) ($IsAlloc HandleTypeType ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) _module.FnRef.fn)) (Tclass._System.___hPartialFunc1 _module.FnRef$A@@12 _module.FnRef$B@@12) $h@@3))
 :qid |unknown.0:0|
 :skolemid |508|
 :pattern ( ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) _module.FnRef.fn)) (Tclass._module.FnRef? _module.FnRef$A@@12 _module.FnRef$B@@12))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Nope2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._module.FnRef? TInt TBool))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= $nw@0 null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.FnRef.fn)) ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.FnRef.fn)) ($Box intType (int_2_U (LitInt 0)))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.FnRef.fn)) ($Box intType (int_2_U (LitInt 0))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#f#0| (and ($Is refType |f#0@@1| (Tclass._module.FnRef TInt TBool)) ($IsAlloc refType |f#0@@1| (Tclass._module.FnRef TInt TBool) $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
