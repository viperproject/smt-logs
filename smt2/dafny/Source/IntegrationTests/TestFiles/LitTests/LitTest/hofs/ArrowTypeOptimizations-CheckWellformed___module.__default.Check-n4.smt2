...
(declare-fun _module.__default.CheckReadsLambdaGeneral (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.CheckReadsLambdaGeneral#canCall| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|x#0@@0| Int) ) (!  (=> (or (|_module.__default.CheckReadsLambdaGeneral#canCall| (LitInt |x#0@@0|)) (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (= (_module.__default.CheckReadsLambdaGeneral (LitInt |x#0@@0|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt (U_2_bool (Lit boolType (bool_2_U true)))) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U (LitInt |x#0@@0|))))))))
 :qid |ArrowTypeOptimizationsdfy.31:16|
 :weight 3
 :skolemid |552|
 :pattern ( (_module.__default.CheckReadsLambdaGeneral (LitInt |x#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.CheckReadsLambdaGeneral)
...
(let ((anon13_Else_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 8) 6)) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (and (U_2_bool (Lit boolType (bool_2_U true))) (= |lambdaResult#0| |y#0@0|)) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 7) 6))) anon7_correct)))
(let ((anon12_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 9) 7) anon13_Then_correct) (=> (= (ControlFlow 0 9) 8) anon13_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 10) 9) anon12_Then_correct) (=> (= (ControlFlow 0 10) 5) anon12_Else_correct)))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt (U_2_bool (Lit boolType (bool_2_U true)))) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |x#0@@1|)))) (=> (Requires1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt (U_2_bool (Lit boolType (bool_2_U true)))) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |x#0@@1|))) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@1 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@1 $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt (U_2_bool (Lit boolType (bool_2_U true)))) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |x#0@@1|))) ($Box refType $o@@1))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@0)))
 :qid |ArrowTypeOptimizationsdfy.34:3|
 :skolemid |553|
))) (= (_module.__default.CheckReadsLambdaGeneral |x#0@@1|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt (U_2_bool (Lit boolType (bool_2_U true)))) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |x#0@@1|))))))) (and ($Is intType (int_2_U (_module.__default.CheckReadsLambdaGeneral |x#0@@1|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 11) 10) anon11_Then_correct) (=> (= (ControlFlow 0 11) 3) anon11_Else_correct))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 13) 1) anon10_Then_correct) (=> (= (ControlFlow 0 13) 11) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))
