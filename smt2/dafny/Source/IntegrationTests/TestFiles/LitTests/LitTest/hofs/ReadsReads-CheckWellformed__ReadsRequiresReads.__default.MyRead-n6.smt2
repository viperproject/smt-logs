...
(declare-fun ReadsRequiresReads.__default.MyReadsOk_k (T@U T@U T@U T@U T@U T@U) Bool)
(declare-fun |ReadsRequiresReads.__default.MyReadsOk_k#canCall| (T@U T@U T@U T@U T@U T@U) Bool)
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ReadsRequiresReads._default.MyReadsOk'$A| T@U) (|ReadsRequiresReads._default.MyReadsOk'$B| T@U) ($Heap T@U) (|f#0| T@U) (|a#0| T@U) (|o#0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsOk_k#canCall| |ReadsRequiresReads._default.MyReadsOk'$A| |ReadsRequiresReads._default.MyReadsOk'$B| $Heap |f#0| |a#0| |o#0|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsOk'$A| |ReadsRequiresReads._default.MyReadsOk'$B|))) ($IsBox |a#0| |ReadsRequiresReads._default.MyReadsOk'$A|)) ($Is refType |o#0| Tclass._System.object)) (Requires1 |ReadsRequiresReads._default.MyReadsOk'$A| |ReadsRequiresReads._default.MyReadsOk'$B| $Heap |f#0| |a#0|)))) (and true (= (ReadsRequiresReads.__default.MyReadsOk_k |ReadsRequiresReads._default.MyReadsOk'$A| |ReadsRequiresReads._default.MyReadsOk'$B| $Heap |f#0| |a#0| |o#0|) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsOk'$A| |ReadsRequiresReads._default.MyReadsOk'$B| $Heap |f#0| |a#0|) ($Box refType |o#0|)))))
 :qid |unknown.0:0|
 :skolemid |698|
 :pattern ( (ReadsRequiresReads.__default.MyReadsOk_k |ReadsRequiresReads._default.MyReadsOk'$A| |ReadsRequiresReads._default.MyReadsOk'$B| $Heap |f#0| |a#0| |o#0|) ($IsGoodHeap $Heap))
))))
...
(declare-fun |ReadsRequiresReads._default.MyReadsOk'$A@@0| () T@U)
(declare-fun |ReadsRequiresReads._default.MyReadsOk'$B@@0| () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$ReadsRequiresReads.__default.MyReadsOk_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_Else_correct  (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0|) $Heap@@0) ($IsAllocBox |a#0@@0| |ReadsRequiresReads._default.MyReadsOk'$A@@0| $Heap@@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|)) (=> (Requires1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@2) alloc)))) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |ReadsReadsdfy.47:12|
 :skolemid |701|
))) (= (ReadsRequiresReads.__default.MyReadsOk_k |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0| |o#0@@0|) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|) ($Box refType |o#0@@0|)))) (and ($Is boolType (bool_2_U (ReadsRequiresReads.__default.MyReadsOk_k |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0| |o#0@@0|)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#2@0|))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc (Reads1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|))) (=> (and (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0|) $Heap@@0) ($IsAllocBox |a#0@@0| |ReadsRequiresReads._default.MyReadsOk'$A@@0| $Heap@@0)) (and (= |b$reqreads#0@0| (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@3) alloc)))) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|) ($Box refType $o@@3))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@3 $f@@1)))
 :qid |ReadsReadsdfy.44:16|
 :skolemid |699|
))) (Requires1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|))) (and (=> (= (ControlFlow 0 5) (- 0 9)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0|) $Heap@@0) ($IsAllocBox |a#0@@0| |ReadsRequiresReads._default.MyReadsOk'$A@@0| $Heap@@0)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (Requires1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|)) (=> (Requires1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|) (=> (= |b$reqreads#1@0| (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@4) alloc)))) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|) ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@2)))
 :qid |ReadsReadsdfy.45:13|
 :skolemid |700|
))) (and (=> (= (ControlFlow 0 5) (- 0 7)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0|) $Heap@@0) ($IsAllocBox |a#0@@0| |ReadsRequiresReads._default.MyReadsOk'$A@@0| $Heap@@0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (Requires1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|)) (=> (Requires1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsOk'$A@@0| |ReadsRequiresReads._default.MyReadsOk'$B@@0|))) (and (and ($IsBox |a#0@@0| |ReadsRequiresReads._default.MyReadsOk'$A@@0|) ($Is refType |o#0@@0| Tclass._System.object)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 5)))) anon0_correct)))
