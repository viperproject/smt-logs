...
(assert (forall ((v@@8 T@U) (t0@@7 T@U) (h@@5 T@U) ) (! (= ($IsAlloc SeqType v@@8 (TSeq t0@@7) h@@5) (forall ((i Int) ) (!  (=> (and (<= 0 i) (< i (|Seq#Length| v@@8))) ($IsAllocBox (|Seq#Index| v@@8 i) t0@@7 h@@5))
 :qid |DafnyPreludebpl.311:11|
 :skolemid |2810|
 :pattern ( (|Seq#Index| v@@8 i))
)))
...
(assert (forall ((v@@11 T@U) (t0@@9 T@U) ) (! (= ($Is SeqType v@@11 (TSeq t0@@9)) (forall ((i@@0 Int) ) (!  (=> (and (<= 0 i@@0) (< i@@0 (|Seq#Length| v@@11))) ($IsBox (|Seq#Index| v@@11 i@@0) t0@@9))
...
(set-info :boogie-vc-id Impl$$FuncCollectionRegressions.__default.CallF3)
