...
(set-info :boogie-vc-id Impl$$_module.__default.VectorUpdate_k_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 5) (- 0 11)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 10)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |i#0_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |i#0_0@0|))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (Requires2 TInt |_module._default.VectorUpdate''$A| |_module._default.VectorUpdate''$A| $Heap |f#0| ($Box intType (int_2_U |i#0_0@0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_0@0|)))) (=> (Requires2 TInt |_module._default.VectorUpdate''$A| |_module._default.VectorUpdate''$A| $Heap |f#0| ($Box intType (int_2_U |i#0_0@0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_0@0|))) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 5) (- 0 4)))) (or (or (or (not (= |a#0| |a#0|)) (not true)) (or (not (= (IndexField |i#0_0@0|) (IndexField |i#0_1@0|))) (not true))) (= (Apply2 TInt |_module._default.VectorUpdate''$A| |_module._default.VectorUpdate''$A| $Heap |f#0| ($Box intType (int_2_U |i#0_0@0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_0@0|))) (Apply2 TInt |_module._default.VectorUpdate''$A| |_module._default.VectorUpdate''$A| $Heap |f#0| ($Box intType (int_2_U |i#0_1@0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0_1@0|)))))))))))))))))))
(let ((anon6_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 14) 5)) anon3_correct)))
(let ((anon6_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 12) 5) anon3_correct)))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 15) 12) anon6_Then_correct) (=> (= (ControlFlow 0 15) 14) anon6_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|j#3| Int) ) (!  (=> (and (<= (LitInt 0) |j#3|) (< |j#3| (_System.array.Length |a#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |a#0|) (IndexField |j#3|)) (Apply2 TInt |_module._default.VectorUpdate''$A| |_module._default.VectorUpdate''$A| $Heap@1 |f#0| ($Box intType (int_2_U |j#3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#3|)))))
 :qid |VectorUpdatedfy.46:18|
 :skolemid |595|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#3|)))
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |a#0|) (IndexField |j#3|)))
)))))
(let ((anon5_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) ($HeapSucc $Heap $Heap@0)) (and (and (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) $f@@0)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| (_System.array.Length |a#0|))) (= $o@@6 |a#0|)) (= $f@@0 (IndexField |i#0_2|)))
 :qid |VectorUpdatedfy.48:10|
 :skolemid |597|
)))
 :qid |VectorUpdatedfy.48:3|
 :skolemid |598|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) $f@@0))
)) (forall ((|i#inv#0_0| Int) ) (!  (=> (and (<= (LitInt 0) |i#inv#0_0|) (< |i#inv#0_0| (_System.array.Length |a#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |i#inv#0_0|)) (Apply2 TInt |_module._default.VectorUpdate''$A| |_module._default.VectorUpdate''$A| $Heap |f#0| ($Box intType (int_2_U |i#inv#0_0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |i#inv#0_0|)))))
 :qid |VectorUpdatedfy.48:10|
 :skolemid |599|
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 16) 15) anon5_Then_correct) (=> (= (ControlFlow 0 16) 3) anon5_Else_correct)))))
