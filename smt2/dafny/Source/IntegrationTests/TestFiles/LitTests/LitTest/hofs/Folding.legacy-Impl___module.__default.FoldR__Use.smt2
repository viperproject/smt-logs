...
(declare-fun |lambda#11| (Int Int) T@U)
...
(declare-fun |lambda#16| (Int Int Int Int) T@U)
...
(assert (forall ((|l#0| Int) (|l#1| Int) (|$l#2#heap#0| T@U) (|$l#2#xs#0| T@U) (|$l#2#b#0| T@U) ) (! (= (MapType2Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#11| |l#0| |l#1|) |$l#2#heap#0| |$l#2#xs#0| |$l#2#b#0|) ($Box boolType (bool_2_U (= (Mod (U_2_int ($Unbox intType |$l#2#b#0|)) |l#0|) |l#1|))))
 :qid |unknown.0:0|
 :skolemid |791|
 :pattern ( (MapType2Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#11| |l#0| |l#1|) |$l#2#heap#0| |$l#2#xs#0| |$l#2#b#0|))
)))
...
(assert (forall ((|l#0@@1| Int) (|l#1@@1| Int) (|l#2| Int) (|l#3| Int) (|$l#4#heap#0| T@U) (|$l#4#a#0| T@U) (|$l#4#b#0| T@U) (|$l#4#b'#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType BoxType (|lambda#16| |l#0@@1| |l#1@@1| |l#2| |l#3|) |$l#4#heap#0| |$l#4#a#0| |$l#4#b#0| |$l#4#b'#0|) ($Box boolType (bool_2_U  (=> (= (Mod (U_2_int ($Unbox intType |$l#4#b#0|)) |l#0@@1|) |l#1@@1|) (= (Mod (U_2_int ($Unbox intType |$l#4#b'#0|)) |l#2|) |l#3|)))))
 :qid |unknown.0:0|
 :skolemid |792|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType BoxType (|lambda#16| |l#0@@1| |l#1@@1| |l#2| |l#3|) |$l#4#heap#0| |$l#4#a#0| |$l#4#b#0| |$l#4#b'#0|))
)))
...
(assert (forall ((|#$T0@@35| T@U) (|#$T1@@35| T@U) (|#$R@@35| T@U) (|f#0@@8| T@U) ($h@@3 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hPartialFunc2 |#$T0@@35| |#$T1@@35| |#$R@@35|) $h@@3) ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hFunc2 |#$T0@@35| |#$T1@@35| |#$R@@35|) $h@@3))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hPartialFunc2 |#$T0@@35| |#$T1@@35| |#$R@@35|) $h@@3))
)))
(assert (forall ((|#$T0@@36| T@U) (|#$T1@@36| T@U) (|#$R@@36| T@U) (|f#0@@9| T@U) ($h@@4 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc2 |#$T0@@36| |#$T1@@36| |#$R@@36|) $h@@4) ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hPartialFunc2 |#$T0@@36| |#$T1@@36| |#$R@@36|) $h@@4))
 :qid |unknown.0:0|
 :skolemid |527|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc2 |#$T0@@36| |#$T1@@36| |#$R@@36|) $h@@4))
)))
...
(assert (forall ((t0@@26 T@U) (t1@@24 T@U) (t2@@23 T@U) (h0@@3 T@U) (h1@@3 T@U) (f@@17 T@U) (bx0@@18 T@U) (bx1@@18 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@3 h1@@3) (and ($IsGoodHeap h0@@3) ($IsGoodHeap h1@@3))) (and (and ($IsBox bx0@@18 t0@@26) ($IsBox bx1@@18 t1@@24)) ($Is HandleTypeType f@@17 (Tclass._System.___hFunc2 t0@@26 t1@@24 t2@@23)))) (forall ((o@@6 T@U) (fld@@3 T@U) ) (!  (=> (and (or (not (= o@@6 null)) (not true)) (|Set#IsMember| (Reads2 t0@@26 t1@@24 t2@@23 h0@@3 f@@17 bx0@@18 bx1@@18) ($Box refType o@@6))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h0@@3 o@@6) fld@@3) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h1@@3 o@@6) fld@@3)))
 :qid |unknown.0:0|
 :skolemid |487|
))) (= (Reads2 t0@@26 t1@@24 t2@@23 h0@@3 f@@17 bx0@@18 bx1@@18) (Reads2 t0@@26 t1@@24 t2@@23 h1@@3 f@@17 bx0@@18 bx1@@18)))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($HeapSucc h0@@3 h1@@3) (Reads2 t0@@26 t1@@24 t2@@23 h1@@3 f@@17 bx0@@18 bx1@@18))
)))
(assert (forall ((t0@@27 T@U) (t1@@25 T@U) (t2@@24 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@18 T@U) (bx0@@19 T@U) (bx1@@19 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) (and (and ($IsBox bx0@@19 t0@@27) ($IsBox bx1@@19 t1@@25)) ($Is HandleTypeType f@@18 (Tclass._System.___hFunc2 t0@@27 t1@@25 t2@@24)))) (forall ((o@@7 T@U) (fld@@4 T@U) ) (!  (=> (and (or (not (= o@@7 null)) (not true)) (|Set#IsMember| (Reads2 t0@@27 t1@@25 t2@@24 h1@@4 f@@18 bx0@@19 bx1@@19) ($Box refType o@@7))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h0@@4 o@@7) fld@@4) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h1@@4 o@@7) fld@@4)))
 :qid |unknown.0:0|
 :skolemid |489|
))) (= (Reads2 t0@@27 t1@@25 t2@@24 h0@@4 f@@18 bx0@@19 bx1@@19) (Reads2 t0@@27 t1@@25 t2@@24 h1@@4 f@@18 bx0@@19 bx1@@19)))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($HeapSucc h0@@4 h1@@4) (Reads2 t0@@27 t1@@25 t2@@24 h1@@4 f@@18 bx0@@19 bx1@@19))
)))
(assert (forall ((t0@@28 T@U) (t1@@26 T@U) (t2@@25 T@U) (h0@@5 T@U) (h1@@5 T@U) (f@@19 T@U) (bx0@@20 T@U) (bx1@@20 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@5 h1@@5) (and ($IsGoodHeap h0@@5) ($IsGoodHeap h1@@5))) (and (and ($IsBox bx0@@20 t0@@28) ($IsBox bx1@@20 t1@@26)) ($Is HandleTypeType f@@19 (Tclass._System.___hFunc2 t0@@28 t1@@26 t2@@25)))) (forall ((o@@8 T@U) (fld@@5 T@U) ) (!  (=> (and (or (not (= o@@8 null)) (not true)) (|Set#IsMember| (Reads2 t0@@28 t1@@26 t2@@25 h0@@5 f@@19 bx0@@20 bx1@@20) ($Box refType o@@8))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h0@@5 o@@8) fld@@5) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h1@@5 o@@8) fld@@5)))
 :qid |unknown.0:0|
 :skolemid |495|
))) (= (Apply2 t0@@28 t1@@26 t2@@25 h0@@5 f@@19 bx0@@20 bx1@@20) (Apply2 t0@@28 t1@@26 t2@@25 h1@@5 f@@19 bx0@@20 bx1@@20)))
 :qid |unknown.0:0|
 :skolemid |496|
...
(set-info :boogie-vc-id Impl$$_module.__default.FoldR__Use)
...
(let ((anon19_Else_correct  (=> (= |stp#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#10| (Handle3 (|lambda#16| (LitInt 2) (LitInt 0) (LitInt 2) (LitInt 0)) (|lambda#17| TInt TInt TInt) (|lambda#19| (SetRef_to_SetBox (|lambda#8| false))))) ($LS $LZ)))) (=> (and (= |b##0@0| (LitInt 0)) (= |call5formal@b#0@0| ($Box intType (int_2_U |b##0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.InvR#canCall| TInt TInt |inv#0@0| |stp#0@0|) (or (_module.__default.InvR TInt TInt |inv#0@0| |stp#0@0|) (forall ((|x#0@@0| T@U) (|xs#1@@0| T@U) (|b#3| T@U) (|b'#0@@0| T@U) ) (!  (=> (and (and (and ($IsBox |x#0@@0| TInt) ($Is DatatypeTypeType |xs#1@@0| (Tclass._module.List TInt))) ($IsBox |b#3| TInt)) ($IsBox |b'#0@@0| TInt)) (=> (and (U_2_bool ($Unbox boolType (Apply2 (Tclass._module.List TInt) TInt TBool $Heap@@5 |inv#0@0| ($Box DatatypeTypeType |xs#1@@0|) |b#3|))) (U_2_bool ($Unbox boolType (Apply3 TInt TInt TInt TBool $Heap@@5 |stp#0@0| |x#0@@0| |b#3| |b'#0@@0|)))) (U_2_bool ($Unbox boolType (Apply2 (Tclass._module.List TInt) TInt TBool $Heap@@5 |inv#0@0| ($Box DatatypeTypeType (|#_module.List.Cons| |x#0@@0| |xs#1@@0|)) |b'#0@@0|)))))
 :qid |Foldinglegacydfy.50:10|
 :skolemid |648|
 :pattern ( (|#_module.List.Cons| |x#0@@0| |xs#1@@0|) ($Unbox boolType (Apply3 TInt TInt TInt TBool $Heap@@5 |stp#0@0| |x#0@@0| |b#3| |b'#0@@0|)))
))))) (=> (=> (|_module.__default.InvR#canCall| TInt TInt |inv#0@0| |stp#0@0|) (or (_module.__default.InvR TInt TInt |inv#0@0| |stp#0@0|) (forall ((|x#0@@1| T@U) (|xs#1@@1| T@U) (|b#3@@0| T@U) (|b'#0@@1| T@U) ) (!  (=> (and (and (and ($IsBox |x#0@@1| TInt) ($Is DatatypeTypeType |xs#1@@1| (Tclass._module.List TInt))) ($IsBox |b#3@@0| TInt)) ($IsBox |b'#0@@1| TInt)) (=> (and (U_2_bool ($Unbox boolType (Apply2 (Tclass._module.List TInt) TInt TBool $Heap@@5 |inv#0@0| ($Box DatatypeTypeType |xs#1@@1|) |b#3@@0|))) (U_2_bool ($Unbox boolType (Apply3 TInt TInt TInt TBool $Heap@@5 |stp#0@0| |x#0@@1| |b#3@@0| |b'#0@@1|)))) (U_2_bool ($Unbox boolType (Apply2 (Tclass._module.List TInt) TInt TBool $Heap@@5 |inv#0@0| ($Box DatatypeTypeType (|#_module.List.Cons| |x#0@@1| |xs#1@@1|)) |b'#0@@1|)))))
 :qid |Foldinglegacydfy.50:10|
 :skolemid |648|
 :pattern ( (|#_module.List.Cons| |x#0@@1| |xs#1@@1|) ($Unbox boolType (Apply3 TInt TInt TInt TBool $Heap@@5 |stp#0@0| |x#0@@1| |b#3@@0| |b'#0@@1|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|a#1| T@U) (|b#2| T@U) ) (!  (=> (and ($IsBox |a#1| TInt) ($IsBox |b#2| TInt)) (U_2_bool ($Unbox boolType (Apply3 TInt TInt TInt TBool $Heap@@5 |stp#0@0| |a#1| |b#2| (Apply2 TInt TInt TInt $Heap@@5 |f#0@0| |a#1| |b#2|)))))
 :qid |Foldinglegacydfy.56:19|
 :skolemid |650|
 :pattern ( (Apply2 TInt TInt TInt $Heap@@5 |f#0@0| |a#1| |b#2|))
))) (=> (forall ((|a#1@@0| T@U) (|b#2@@0| T@U) ) (!  (=> (and ($IsBox |a#1@@0| TInt) ($IsBox |b#2@@0| TInt)) (U_2_bool ($Unbox boolType (Apply3 TInt TInt TInt TBool $Heap@@5 |stp#0@0| |a#1@@0| |b#2@@0| (Apply2 TInt TInt TInt $Heap@@5 |f#0@0| |a#1@@0| |b#2@@0|)))))
 :qid |Foldinglegacydfy.56:19|
 :skolemid |650|
 :pattern ( (Apply2 TInt TInt TInt $Heap@@5 |f#0@0| |a#1@@0| |b#2@@0|))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool ($Unbox boolType (Apply2 (Tclass._module.List TInt) TInt TBool $Heap@@5 |inv#0@0| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) |call5formal@b#0@0|)))) (=> (U_2_bool ($Unbox boolType (Apply2 (Tclass._module.List TInt) TInt TBool $Heap@@5 |inv#0@0| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)) |call5formal@b#0@0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.__default.foldr#canCall| TInt TInt |f#0@0| |call5formal@b#0@0| |xs#0@@6|)) (and (U_2_bool ($Unbox boolType (Apply2 (Tclass._module.List TInt) TInt TBool $Heap@0 |inv#0@0| ($Box DatatypeTypeType |xs#0@@6|) (_module.__default.foldr TInt TInt ($LS ($LS $LZ)) |f#0@0| |call5formal@b#0@0| |xs#0@@6|)))) (= $Heap@@5 $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod |r#0@0| (LitInt 2)) (LitInt 0)))))))))))))))
(let ((anon17_Else_correct  (=> (= |inv#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#10| (Handle2 (|lambda#11| (LitInt 2) (LitInt 0)) (|lambda#7| (Tclass._module.List TInt) TInt) (|lambda#9| (SetRef_to_SetBox (|lambda#8| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 15) 14) anon19_Then_correct) (=> (= (ControlFlow 0 15) 2) anon19_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (and (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#10| (Handle2 (|lambda#6| (LitInt 2) (LitInt 3)) (|lambda#7| TInt TInt) (|lambda#9| (SetRef_to_SetBox (|lambda#8| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@5)) (and (= |##b#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##b#0@0|) TInt $Heap@@5))) (and (and ($IsAlloc DatatypeTypeType |xs#0@@6| (Tclass._module.List TInt) $Heap@@5) (|_module.__default.foldr#canCall| TInt TInt |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@6|)) (and (|_module.__default.foldr#canCall| TInt TInt |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@6|) (= |r#0@0| (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@6|))))))) (and (=> (= (ControlFlow 0 21) 20) anon17_Then_correct) (=> (= (ControlFlow 0 21) 15) anon17_Else_correct)))))
