...
const unique class.ReadsOnFunctions.__default: ClassName;

procedure {:verboseName "ReadsOnFunctions.Requires_Reads_What_Function_Reads (well-formedness)"} CheckWellFormed$$ReadsOnFunctions.__default.Requires__Reads__What__Function__Reads(f#0: HandleType
...
procedure {:verboseName "ReadsOnFunctions.Requires_Reads_What_Function_Reads (call)"} Call$$ReadsOnFunctions.__default.Requires__Reads__What__Function__Reads(f#0: HandleType
       where $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
         && $IsAlloc(f#0, Tclass._System.___hFunc1(TInt, TInt), $Heap));
  // user-defined preconditions
  requires {:id "id212"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(10)));
  modifies $Heap;
  // frame condition
...
procedure {:verboseName "ReadsOnFunctions.Requires_Reads_What_Function_Reads (correctness)"} Impl$$ReadsOnFunctions.__default.Requires__Reads__What__Function__Reads(f#0: HandleType
       where $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
         && $IsAlloc(f#0, Tclass._System.___hFunc1(TInt, TInt), $Heap))
   returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id213"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(10)));
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
axiom (forall #$T0: Ty, #$R: Ty, $self: HandleType, $heap: Heap, $fh$1x#0: Box :: 
  { Apply1(#$T0, TBool, $heap, Requires1#Handle(#$T0, #$R, $self), $fh$1x#0) } 
  Apply1(#$T0, TBool, $heap, Requires1#Handle(#$T0, #$R, $self), $fh$1x#0)
     == $Box(Requires1(#$T0, #$R, $heap, $self, $fh$1x#0)));

axiom (forall #$T0: Ty, #$R: Ty, $self: HandleType, $heap: Heap, $fh$1x#0: Box :: 
  { Requires1(#$T0, TBool, $heap, Requires1#Handle(#$T0, #$R, $self), $fh$1x#0) } 
  Requires1(#$T0, TBool, $heap, Requires1#Handle(#$T0, #$R, $self), $fh$1x#0)
     == true);

axiom (forall $bx: Box, #$T0: Ty, #$R: Ty, $self: HandleType, $heap: Heap, $fh$1x#0: Box :: 
  { Set#IsMember(Reads1(#$T0, TBool, $heap, Requires1#Handle(#$T0, #$R, $self), $fh$1x#0), $bx) } 
...
axiom (forall #$T0: Ty, #$R: Ty, $self: HandleType, $heap: Heap, $fh$1x#0: Box :: 
  { Requires1(#$T0, #$R, $heap, $self, $fh$1x#0) } 
  Requires1(#$T0, #$R, $heap, $self, $fh$1x#0)
     == $Unbox(Apply1(#$T0, TBool, $heap, Requires1#Handle(#$T0, #$R, $self), $fh$1x#0)): bool);

implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ReadsOnFunctions.Requires_Reads_What_Function_Reads (correctness)"} Impl$$ReadsOnFunctions.__default.Requires__Reads__What__Function__Reads(f#0: HandleType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var g#0: HandleType
     where $Is(g#0, Tclass._System.___hFunc1(TInt, TBool))
       && $IsAlloc(g#0, Tclass._System.___hFunc1(TInt, TBool), $Heap);
  var ##x0#1: int;
  var ##x0#2: int;

    // AddMethodImpl: Requires_Reads_What_Function_Reads, Impl$$ReadsOnFunctions.__default.Requires__Reads__What__Function__Reads
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/hofs/ReadsReads.dfy(145,11)
    assume true;
    assert {:id "id214"} true;
    assume true;
    g#0 := Requires1#Handle(TInt, TInt, f#0);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/hofs/ReadsReads.dfy(146,5)
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(g#0), Tclass._System.___hFunc1(TInt, TBool), $Heap);
    ##x0#1 := LitInt(10);
    // assume allocatedness for argument to function
    assume $IsAlloc(##x0#1, TInt, $Heap);
    assert {:id "id216"} Requires1(TInt, TBool, $Heap, g#0, $Box(LitInt(10)));
    assume Reads1#canCall(TInt, TBool, $Heap, g#0, $Box(LitInt(10)));
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(f#0), Tclass._System.___hFunc1(TInt, TInt), $Heap);
    ##x0#2 := LitInt(10);
    // assume allocatedness for argument to function
    assume $IsAlloc(##x0#2, TInt, $Heap);
    assert {:id "id217"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(10)));
    assume Reads1#canCall(TInt, TInt, $Heap, f#0, $Box(LitInt(10)));
    assume Reads1#canCall(TInt, TBool, $Heap, g#0, $Box(LitInt(10)))
       && Reads1#canCall(TInt, TInt, $Heap, f#0, $Box(LitInt(10)));
    assert {:id "id218"} Set#Equal(Reads1(TInt, TBool, $Heap, g#0, $Box(LitInt(10))), 
      Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(10))));
}
