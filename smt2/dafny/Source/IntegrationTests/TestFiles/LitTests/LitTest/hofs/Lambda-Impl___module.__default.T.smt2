...
(declare-fun |lambda#89| (Int T@U T@U T@U) T@U)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun $OneHeap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |Set#Equal| (T@U T@U) Bool)
(declare-fun |lambda#84| (Int) T@U)
...
(assert (forall ((|l#0@@0| Int) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|$l#2#heap#0| T@U) (|$l#2#u#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#89| |l#0@@0| |l#1| |l#2| |l#3|) |$l#2#heap#0| |$l#2#u#0|) ($Box intType (int_2_U (ite (> (U_2_int ($Unbox intType |$l#2#u#0|)) |l#0@@0|) (U_2_int ($Unbox intType (Apply1 |l#1| |l#2| |$l#2#heap#0| |l#3| ($Box intType ($Unbox intType |$l#2#u#0|))))) (U_2_int ($Unbox intType |$l#2#u#0|))))))
 :qid |unknown.0:0|
 :skolemid |591|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#89| |l#0@@0| |l#1| |l#2| |l#3|) |$l#2#heap#0| |$l#2#u#0|))
)))
...
(assert (forall ((|l#0@@1| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#84| |l#0@@1|) |$l#0#heap#0@@0| |$l#0#x#0@@0|) ($Box intType (int_2_U (+ (U_2_int ($Unbox intType |$l#0#x#0@@0|)) |l#0@@1|))))
 :qid |unknown.0:0|
 :skolemid |590|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#84| |l#0@@1|) |$l#0#heap#0@@0| |$l#0#x#0@@0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@1) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |574|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@1 $f))
)))
...
(assert (forall ((|l#0@@5| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@5|) |$l#0#heap#0@@1| |$l#0#x#0@@1|) |l#0@@5|)
 :qid |Lambdadfy.6:24|
 :skolemid |578|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@5|) |$l#0#heap#0@@1| |$l#0#x#0@@1|))
)))
...
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 16) 14) anon14_Then_correct) (=> (= (ControlFlow 0 16) 15) anon14_Else_correct)))))
(let ((anon9_correct true))
(let ((anon17_Else_correct  (=> (and (and (>= 0 |u#0@0|) (= |lambdaResult#1| |u#0@0|)) (and ($Is intType (int_2_U |lambdaResult#1|) TInt) (= (ControlFlow 0 10) 8))) anon9_correct)))
(let ((anon17_Then_correct  (=> (and (and (> |u#0@0| 0) (= |lambdaResult#1| (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0@0| ($Box intType (int_2_U |u#0@0|))))))) (and ($Is intType (int_2_U |lambdaResult#1|) TInt) (= (ControlFlow 0 9) 8))) anon9_correct)))
(let ((anon16_Then_correct  (=> (= |$_Frame#l1@0| (|lambda#0| null |$lambdaHeap#1@0| alloc false)) (and (=> (= (ControlFlow 0 11) 9) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct)))))
(let ((anon16_Else_correct true))
(let ((anon15_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap |$lambdaHeap#1@0|) ($HeapSucc $Heap |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 12) 11) anon16_Then_correct) (=> (= (ControlFlow 0 12) 7) anon16_Else_correct)))))
(let ((anon12_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0@1| ($Box intType (int_2_U (LitInt 1)))))) (LitInt 2))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0@1| ($Box intType (int_2_U (LitInt 0)))))) (LitInt 0))))))
(let ((anon18_Else_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0@1| ($Box intType (int_2_U (LitInt 1)))))) (LitInt 2))) (not true)) (= (ControlFlow 0 5) 2)) anon12_correct)))
(let ((anon18_Then_correct  (=> (and (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0@1| ($Box intType (int_2_U (LitInt 1)))))) (LitInt 2)) (= (ControlFlow 0 4) 2)) anon12_correct)))
(let ((anon15_Else_correct  (=> (= |f#0@1| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#89| 0 TInt TInt |f#0@0|) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 6) 4) anon18_Then_correct) (=> (= (ControlFlow 0 6) 5) anon18_Else_correct)))))
(let ((anon13_Else_correct  (=> (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#84| 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 13) 12) anon15_Then_correct) (=> (= (ControlFlow 0 13) 6) anon15_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 17) 16) anon13_Then_correct) (=> (= (ControlFlow 0 17) 13) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 18) 17))) anon0_correct))))
