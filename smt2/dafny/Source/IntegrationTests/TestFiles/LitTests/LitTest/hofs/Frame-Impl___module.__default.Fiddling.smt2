...
(assert (forall ((t0@@23 T@U) (h0@@7 T@U) (h1@@7 T@U) (f@@15 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@7 h1@@7) (and ($IsGoodHeap h0@@7) ($IsGoodHeap h1@@7))) ($Is HandleTypeType f@@15 (Tclass._System.___hFunc0 t0@@23))) (forall ((o@@10 T@U) (fld@@7 T@U) ) (!  (=> (and (or (not (= o@@10 null)) (not true)) (|Set#IsMember| (Reads0 t0@@23 h0@@7 f@@15) ($Box refType o@@10))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@7 o@@10) fld@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@7 o@@10) fld@@7)))
 :qid |unknown.0:0|
 :skolemid |417|
))) (= (Reads0 t0@@23 h0@@7 f@@15) (Reads0 t0@@23 h1@@7 f@@15)))
 :qid |unknown.0:0|
 :skolemid |418|
 :pattern ( ($HeapSucc h0@@7 h1@@7) (Reads0 t0@@23 h1@@7 f@@15))
)))
(assert (forall ((t0@@24 T@U) (h0@@8 T@U) (h1@@8 T@U) (f@@16 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@8 h1@@8) (and ($IsGoodHeap h0@@8) ($IsGoodHeap h1@@8))) ($Is HandleTypeType f@@16 (Tclass._System.___hFunc0 t0@@24))) (forall ((o@@11 T@U) (fld@@8 T@U) ) (!  (=> (and (or (not (= o@@11 null)) (not true)) (|Set#IsMember| (Reads0 t0@@24 h1@@8 f@@16) ($Box refType o@@11))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@8 o@@11) fld@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@8 o@@11) fld@@8)))
 :qid |unknown.0:0|
 :skolemid |419|
))) (= (Reads0 t0@@24 h0@@8 f@@16) (Reads0 t0@@24 h1@@8 f@@16)))
 :qid |unknown.0:0|
 :skolemid |420|
...
(assert (forall ((t0@@25 T@U) (h0@@9 T@U) (h1@@9 T@U) (f@@17 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@9 h1@@9) (and ($IsGoodHeap h0@@9) ($IsGoodHeap h1@@9))) ($Is HandleTypeType f@@17 (Tclass._System.___hFunc0 t0@@25))) (forall ((o@@12 T@U) (fld@@9 T@U) ) (!  (=> (and (or (not (= o@@12 null)) (not true)) (|Set#IsMember| (Reads0 t0@@25 h0@@9 f@@17) ($Box refType o@@12))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@9 o@@12) fld@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@9 o@@12) fld@@9)))
 :qid |unknown.0:0|
 :skolemid |425|
))) (= (Apply0 t0@@25 h0@@9 f@@17) (Apply0 t0@@25 h1@@9 f@@17)))
 :qid |unknown.0:0|
 :skolemid |426|
 :pattern ( ($HeapSucc h0@@9 h1@@9) (Apply0 t0@@25 h1@@9 f@@17))
)))
(assert (forall ((t0@@26 T@U) (h0@@10 T@U) (h1@@10 T@U) (f@@18 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@10 h1@@10) (and ($IsGoodHeap h0@@10) ($IsGoodHeap h1@@10))) ($Is HandleTypeType f@@18 (Tclass._System.___hFunc0 t0@@26))) (forall ((o@@13 T@U) (fld@@10 T@U) ) (!  (=> (and (or (not (= o@@13 null)) (not true)) (|Set#IsMember| (Reads0 t0@@26 h1@@10 f@@18) ($Box refType o@@13))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@10 o@@13) fld@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@10 o@@13) fld@@10)))
 :qid |unknown.0:0|
 :skolemid |427|
))) (= (Apply0 t0@@26 h0@@10 f@@18) (Apply0 t0@@26 h1@@10 f@@18)))
 :qid |unknown.0:0|
 :skolemid |428|
...
(set-info :boogie-vc-id Impl$$_module.__default.Fiddling)
