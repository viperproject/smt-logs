...
(declare-fun _module.__default.CheckReads (T@U Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.CheckReads#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0| T@U) (|x#0| Int) ) (!  (=> (or (|_module.__default.CheckReads#canCall| |f#0| |x#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TInt))))) (= (_module.__default.CheckReads |f#0| |x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |x#0|)))))))
 :qid |ArrowTypeOptimizationsdfy.7:16|
 :skolemid |530|
 :pattern ( (_module.__default.CheckReads |f#0| |x#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|f#0@@0| T@U) (|x#0@@0| Int) ) (!  (=> (or (|_module.__default.CheckReads#canCall| |f#0@@0| (LitInt |x#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 TInt TInt))))) (= (_module.__default.CheckReads |f#0@@0| (LitInt |x#0@@0|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt |x#0@@0|))))))))
 :qid |ArrowTypeOptimizationsdfy.7:16|
 :weight 3
 :skolemid |531|
 :pattern ( (_module.__default.CheckReads |f#0@@0| (LitInt |x#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|f#0@@1| T@U) (|x#0@@1| Int) ) (!  (=> (or (|_module.__default.CheckReads#canCall| (Lit HandleTypeType |f#0@@1|) (LitInt |x#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 TInt TInt))))) (= (_module.__default.CheckReads (Lit HandleTypeType |f#0@@1|) (LitInt |x#0@@1|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 (Lit HandleTypeType |f#0@@1|) ($Box intType (int_2_U (LitInt |x#0@@1|))))))))
 :qid |ArrowTypeOptimizationsdfy.7:16|
 :weight 3
 :skolemid |532|
 :pattern ( (_module.__default.CheckReads (Lit HandleTypeType |f#0@@1|) (LitInt |x#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.CheckReads)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 TInt TInt $Heap@@2 |f#0@@2| ($Box intType (int_2_U |x#0@@2|)))) (=> (Requires1 TInt TInt $Heap@@2 |f#0@@2| ($Box intType (int_2_U |x#0@@2|))) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@0 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 $o@@0) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@2 |f#0@@2| ($Box intType (int_2_U |x#0@@2|))) ($Box refType $o@@0))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@0 $f@@0)))
 :qid |ArrowTypeOptimizationsdfy.10:3|
 :skolemid |533|
))) (= (_module.__default.CheckReads |f#0@@2| |x#0@@2|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@2| ($Box intType (int_2_U |x#0@@2|))))))) (and ($Is intType (int_2_U (_module.__default.CheckReads |f#0@@2| |x#0@@2|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is HandleTypeType |f#0@@2| (Tclass._System.___hFunc1 TInt TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
