...
(set-info :boogie-vc-id Impl$$_module.__default.FoldL__Use__Direct__lambda_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon7_correct  (=> (and (forall ((|ys#1| T@U) (|b#2| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1| (Tclass._module.List TInt)) (=> (= (Mod (U_2_int |b#2|) (LitInt 2)) (LitInt 0)) (|_module.__default.foldl#canCall| TInt TInt |f#0@0| ($Box intType |b#2|) |ys#1|)))
 :qid |Foldinglegacydfy.242:17|
 :skolemid |754|
 :pattern ( ($Unbox intType (_module.__default.foldl TInt TInt ($LS $LZ) |f#0@0| ($Box intType |b#2|) |ys#1|)))
)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|ys#1@@0| T@U) (|b#2@@0| Int) ) (!  (=> ($Is DatatypeTypeType |ys#1@@0| (Tclass._module.List TInt)) (=> (= (Mod |b#2@@0| (LitInt 2)) (LitInt 0)) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldl TInt TInt ($LS ($LS $LZ)) |f#0@0| ($Box intType (int_2_U |b#2@@0|)) |ys#1@@0|))) (LitInt 2)) (LitInt 0))))
 :qid |Foldinglegacydfy.242:17|
 :skolemid |755|
 :pattern ( ($Unbox intType (_module.__default.foldl TInt TInt ($LS ($LS $LZ)) |f#0@0| ($Box intType (int_2_U |b#2@@0|)) |ys#1@@0|)))
)))))
