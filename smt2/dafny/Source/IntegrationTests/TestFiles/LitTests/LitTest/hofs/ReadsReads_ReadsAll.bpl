...
const unique class.ReadsAll.__default: ClassName;

// function declaration for ReadsAll._default.A
function ReadsAll.__default.A($heap: Heap, f#0: HandleType) : int
uses {
// definition axiom for ReadsAll.__default.A (revealed)
axiom {:id "id151"} 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, f#0: HandleType :: 
    { ReadsAll.__default.A($Heap, f#0), $IsGoodHeap($Heap) } 
    ReadsAll.__default.A#canCall($Heap, f#0)
         || (0 < $FunctionContextHeight
          ...
          $IsGoodHeap($Heap)
           ...
           && (forall x#2: int :: 
            ...
            Requires1(TInt, TInt, $Heap, f#0, $Box(x#2))))
       ==> ReadsAll.__default.A($Heap, f#0)
         == $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)))): int
           + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)))): int
           + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)))): int);
}

function ReadsAll.__default.A#canCall($heap: Heap, f#0: HandleType) : bool;

// frame axiom for ReadsAll.__default.A
axiom (forall $h0: Heap, $h1: Heap, f#0: HandleType :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), ReadsAll.__default.A($h1, f#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && (ReadsAll.__default.A#canCall($h0, f#0)
         || $Is(f#0, Tclass._System.___hFunc1(TInt, TInt)))
       && 
      $IsHeapAnchor($h0)
       && $HeapSucc($h0, $h1)
    ...
    (forall $o: ref, $f: Field :: 
      $o != null
           && (exists x#0: int, o#0: ref :: 
            { Set#IsMember(Reads1(TInt, TInt, $h0, f#0, $Box(x#0)), $Box(o#0)) } 
            $Is(o#0, Tclass._System.object?())
               && Set#IsMember(Reads1(TInt, TInt, $h0, f#0, $Box(x#0)), $Box(o#0))
               && $Box($o) == $Box(o#0))
         ==> read($h0, $o, $f) == read($h1, $o, $f))
     ==> ReadsAll.__default.A($h0, f#0) == ReadsAll.__default.A($h1, f#0));

function ReadsAll.__default.A#requires(Heap, HandleType) : bool;

// #requires axiom for ReadsAll.__default.A
axiom (forall $Heap: Heap, f#0: HandleType :: 
  { ReadsAll.__default.A#requires($Heap, f#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap) && $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
     ==> ReadsAll.__default.A#requires($Heap, f#0)
       == (forall x#2: int :: 
        { Requires1(TInt, TInt, $Heap, f#0, $Box(x#2)) } 
        Requires1(TInt, TInt, $Heap, f#0, $Box(x#2))));

procedure {:verboseName "ReadsAll.A (well-formedness)"} CheckWellformed$$ReadsAll.__default.A(f#0: HandleType where $Is(f#0, Tclass._System.___hFunc1(TInt, TInt)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ReadsAll.A (well-formedness)"} CheckWellformed$$ReadsAll.__default.A(f#0: HandleType)
{
  ...
  var b$reqreads#4: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> (exists x#0: int, o#0: ref :: 
          { Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(x#0)), $Box(o#0)) } 
          $Is(o#0, Tclass._System.object?())
             && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(x#0)), $Box(o#0))
             && $Box($o) == $Box(o#0)));
    ...
    assume {:id "id152"} Requires1(TInt, TInt, $Heap, f#0, $Box(x#3));
    assume {:id "id153"} (forall x#1: int :: 
       ...
       && $IsAlloc(o#1, Tclass._System.object?(), $Heap))
    {
        ...
        assert {:id "id155"} Requires1(TInt, TInt, $Heap, f#0, $Box(x#4));
        b$reqreads#1 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(x#4)), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assume Reads1#canCall(TInt, TInt, $Heap, f#0, $Box(x#4));
        if (Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(x#4)), $Box(o#1)))
        {
        }
    }

    // End Comprehension WF check
    assert {:id "id156"} b$reqreads#1;
       ...
       && $IsAlloc(o#2, Tclass._System.object?(), $Heap))
    {
        ...
        assert {:id "id157"} Requires1(TInt, TInt, $Heap, f#0, $Box(x#5));
        assume Reads1#canCall(TInt, TInt, $Heap, f#0, $Box(x#5));
        if (Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(x#5)), $Box(o#2)))
        {
        }
    }
    ...
    else
    {
        ...
        assert {:id "id158"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)));
        b$reqreads#2 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(0))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assert {:id "id159"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)));
        b$reqreads#3 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(1))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assert {:id "id160"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)));
        b$reqreads#4 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(2))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assume {:id "id161"} ReadsAll.__default.A($Heap, f#0)
           == $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)))): int
             + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)))): int
             + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)))): int;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(ReadsAll.__default.A($Heap, f#0), TInt);
        assert {:id "id162"} b$reqreads#2;
        assert {:id "id163"} b$reqreads#3;
        assert {:id "id164"} b$reqreads#4;
        return;
...
// function declaration for ReadsAll._default.B
function ReadsAll.__default.B($heap: Heap, f#0: HandleType) : int
uses {
// definition axiom for ReadsAll.__default.B (revealed)
axiom {:id "id165"} 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, f#0: HandleType :: 
    { ReadsAll.__default.B($Heap, f#0), $IsGoodHeap($Heap) } 
    ReadsAll.__default.B#canCall($Heap, f#0)
         || (0 < $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
           && $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
           && (forall x#2: int :: 
            { Requires1(TInt, TInt, $Heap, f#0, $Box(x#2)) } 
            Requires1(TInt, TInt, $Heap, f#0, $Box(x#2))))
       ==> ReadsAll.__default.B($Heap, f#0)
         == $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)))): int
           + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)))): int
           + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)))): int);
}

function ReadsAll.__default.B#canCall($heap: Heap, f#0: HandleType) : bool;

// frame axiom for ReadsAll.__default.B
axiom (forall $h0: Heap, $h1: Heap, f#0: HandleType :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), ReadsAll.__default.B($h1, f#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && (ReadsAll.__default.B#canCall($h0, f#0)
         || $Is(f#0, Tclass._System.___hFunc1(TInt, TInt)))
       && 
      $IsHeapAnchor($h0)
       && $HeapSucc($h0, $h1)
      ...
      $o != null
           && (exists x#0: int, o#0: ref :: 
            ...
            $Is(o#0, Tclass._System.object?())
               ...
               && $Box($o) == $Box(o#0))
         ==> read($h0, $o, $f) == read($h1, $o, $f))
     ==> ReadsAll.__default.B($h0, f#0) == ReadsAll.__default.B($h1, f#0));

function ReadsAll.__default.B#requires(Heap, HandleType) : bool;

// #requires axiom for ReadsAll.__default.B
axiom (forall $Heap: Heap, f#0: HandleType :: 
  { ReadsAll.__default.B#requires($Heap, f#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap) && $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
     ==> ReadsAll.__default.B#requires($Heap, f#0)
       == (forall x#2: int :: 
        { Requires1(TInt, TInt, $Heap, f#0, $Box(x#2)) } 
        Requires1(TInt, TInt, $Heap, f#0, $Box(x#2))));

procedure {:verboseName "ReadsAll.B (well-formedness)"} CheckWellformed$$ReadsAll.__default.B(f#0: HandleType where $Is(f#0, Tclass._System.___hFunc1(TInt, TInt)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ReadsAll.B (well-formedness)"} CheckWellformed$$ReadsAll.__default.B(f#0: HandleType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#3: int;
  var ##x0#0: int;
  ...
  var b$reqreads#4: bool;
    ...
    b$reqreads#0 := (forall $o: ref, $f: Field :: 
      $o != null
         ...
         ==> $_ReadsFrame[$o, $f]);
    assume Requires1#canCall(TInt, TInt, $Heap, f#0, $Box(x#3));
    assume {:id "id166"} Requires1(TInt, TInt, $Heap, f#0, $Box(x#3));
    assume {:id "id167"} (forall x#1: int :: 
      { Requires1(TInt, TInt, $Heap, f#0, $Box(x#1)) } 
      Requires1(TInt, TInt, $Heap, f#0, $Box(x#1)));
    assert {:id "id168"} b$reqreads#0;
    // Check well-formedness of the reads clause
    // Begin Comprehension WF check
    havoc x#4;
    havoc o#1;
       ...
       && $IsAlloc(o#1, Tclass._System.object?(), $Heap))
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##x0#1, TInt, $Heap);
        assert {:id "id169"} Requires1(TInt, TInt, $Heap, f#0, $Box(x#4));
        b$reqreads#1 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(x#4)), $Box($o))
       ...
       && $IsAlloc(o#2, Tclass._System.object?(), $Heap))
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##x0#2, TInt, $Heap);
        assert {:id "id171"} Requires1(TInt, TInt, $Heap, f#0, $Box(x#5));
        assume Reads1#canCall(TInt, TInt, $Heap, f#0, $Box(x#5));
        if (Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(x#5)), $Box(o#2)))
        {
        }
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assert {:id "id172"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)));
        b$reqreads#2 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(0))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assert {:id "id173"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)));
        b$reqreads#3 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(1))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assert {:id "id174"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)));
        b$reqreads#4 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(2))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assume {:id "id175"} ReadsAll.__default.B($Heap, f#0)
           == $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)))): int
             + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)))): int
             + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)))): int;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(ReadsAll.__default.B($Heap, f#0), TInt);
        assert {:id "id176"} b$reqreads#2;
        assert {:id "id177"} b$reqreads#3;
        assert {:id "id178"} b$reqreads#4;
        return;
...
// function declaration for ReadsAll._default.C
function ReadsAll.__default.C($heap: Heap, f#0: HandleType) : int
uses {
// definition axiom for ReadsAll.__default.C (revealed)
axiom {:id "id179"} 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, f#0: HandleType :: 
    { ReadsAll.__default.C($Heap, f#0), $IsGoodHeap($Heap) } 
    ReadsAll.__default.C#canCall($Heap, f#0)
         || (0 < $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
           && $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
           && (forall x#1: int :: 
            { Requires1(TInt, TInt, $Heap, f#0, $Box(x#1)) } 
            Requires1(TInt, TInt, $Heap, f#0, $Box(x#1))))
       ==> ReadsAll.__default.C($Heap, f#0)
         == $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)))): int
           + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)))): int
           + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)))): int);
}

function ReadsAll.__default.C#canCall($heap: Heap, f#0: HandleType) : bool;

// frame axiom for ReadsAll.__default.C
axiom (forall $h0: Heap, $h1: Heap, f#0: HandleType :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), ReadsAll.__default.C($h1, f#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && (ReadsAll.__default.C#canCall($h0, f#0)
         || $Is(f#0, Tclass._System.___hFunc1(TInt, TInt)))
       && 
      $IsHeapAnchor($h0)
       && $HeapSucc($h0, $h1)
    ...
    (forall $o: ref, $f: Field :: 
      $o != null
           && (exists _x0#0: int, _obj#0: ref :: 
            { Set#IsMember(Reads1(TInt, TInt, $h0, f#0, $Box(_x0#0)), $Box(_obj#0)) } 
            $Is(_obj#0, Tclass._System.object?())
               && Set#IsMember(Reads1(TInt, TInt, $h0, f#0, $Box(_x0#0)), $Box(_obj#0))
               && $Box($o) == $Box(_obj#0))
         ==> read($h0, $o, $f) == read($h1, $o, $f))
     ==> ReadsAll.__default.C($h0, f#0) == ReadsAll.__default.C($h1, f#0));

function ReadsAll.__default.C#requires(Heap, HandleType) : bool;

// #requires axiom for ReadsAll.__default.C
axiom (forall $Heap: Heap, f#0: HandleType :: 
  { ReadsAll.__default.C#requires($Heap, f#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap) && $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
     ==> ReadsAll.__default.C#requires($Heap, f#0)
       == (forall x#1: int :: 
        { Requires1(TInt, TInt, $Heap, f#0, $Box(x#1)) } 
        Requires1(TInt, TInt, $Heap, f#0, $Box(x#1))));

procedure {:verboseName "ReadsAll.C (well-formedness)"} CheckWellformed$$ReadsAll.__default.C(f#0: HandleType where $Is(f#0, Tclass._System.___hFunc1(TInt, TInt)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom (forall #$T0: Ty, #$R: Ty, $self: HandleType, $heap: Heap, $fh$1x#0: Box :: 
  { Apply1(#$T0, 
  ...
  Apply1(#$T0, 
      ...
      Reads1#Handle(#$T0, #$R, $self), 
      $fh$1x#0)
     == $Box(Reads1(#$T0, #$R, $heap, $self, $fh$1x#0)));
...
axiom (forall #$T0: Ty, #$R: Ty, $self: HandleType, $heap: Heap, $fh$1x#0: Box :: 
  ...
  Requires1(#$T0, 
      ...
      Reads1#Handle(#$T0, #$R, $self), 
      $fh$1x#0)
     == Requires1(#$T0, #$R, $heap, $self, $fh$1x#0));

axiom (forall $bx: Box, #$T0: Ty, #$R: Ty, $self: HandleType, $heap: Heap, $fh$1x#0: Box :: 
  ...
  Requires1(#$T0, #$R, $heap, $self, $fh$1x#0)
     ==> Set#IsMember(Reads1(#$T0, 
          ...
          $fh$1x#0), 
        $bx)
       == Set#IsMember(Reads1(#$T0, #$R, $heap, $self, $fh$1x#0), $bx));

axiom (forall #$T0: Ty, #$R: Ty, $self: HandleType, $heap: Heap, $fh$1x#0: Box :: 
  { Reads1(#$T0, #$R, $heap, $self, $fh$1x#0) } 
  Reads1(#$T0, #$R, $heap, $self, $fh$1x#0)
     == $Unbox(Apply1(#$T0, 
        TSet(Tclass._System.object?()), 
        $heap, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ReadsAll.C (well-formedness)"} CheckWellformed$$ReadsAll.__default.C(f#0: HandleType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: int;
  var ##x0#0: int;
  ...
  var b$reqreads#4: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> (exists _x0#0: int, _obj#0: ref :: 
          { Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(_x0#0)), $Box(_obj#0)) } 
          $Is(_obj#0, Tclass._System.object?())
             && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(_x0#0)), $Box(_obj#0))
             && $Box($o) == $Box(_obj#0)));
    // Check well-formedness of preconditions, and then assume them
    ...
    b$reqreads#0 := (forall $o: ref, $f: Field :: 
      $o != null
           ...
           && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(##x0#0)), $Box($o))
         ==> $_ReadsFrame[$o, $f]);
    assume Requires1#canCall(TInt, TInt, $Heap, f#0, $Box(x#2));
    assume {:id "id180"} Requires1(TInt, TInt, $Heap, f#0, $Box(x#2));
    assume {:id "id181"} (forall x#0: int :: 
      { Requires1(TInt, TInt, $Heap, f#0, $Box(x#0)) } 
      Requires1(TInt, TInt, $Heap, f#0, $Box(x#0)));
    ...
    {
        assert {:id "id183"} true;
        assert {:id "id184"} Requires1(TInt, 
          TSet(Tclass._System.object?()), 
          $Heap, 
        ...
        b$reqreads#1 := (forall $o: ref, $f: Field :: 
          $o != null
               ...
               && Set#IsMember(Reads1(TInt, 
                ...
                $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        if (Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(_x0#1)), $Box(_obj#1)))
        {
        }
    }
    ...
    {
        assert {:id "id186"} true;
        assert {:id "id187"} Requires1(TInt, 
          TSet(Tclass._System.object?()), 
          $Heap, 
          Reads1#Handle(TInt, TInt, f#0), 
          $Box(_x0#2));
        if (Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(_x0#2)), $Box(_obj#2)))
        {
        }
    }
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assert {:id "id188"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)));
        b$reqreads#2 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(0))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assert {:id "id189"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)));
        b$reqreads#3 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(1))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assert {:id "id190"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)));
        b$reqreads#4 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(2))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assume {:id "id191"} ReadsAll.__default.C($Heap, f#0)
           == $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)))): int
             + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)))): int
             + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)))): int;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(ReadsAll.__default.C($Heap, f#0), TInt);
        assert {:id "id192"} b$reqreads#2;
        assert {:id "id193"} b$reqreads#3;
        assert {:id "id194"} b$reqreads#4;
        return;
...
// function declaration for ReadsAll._default.D
function ReadsAll.__default.D($heap: Heap, f#0: HandleType) : int
uses {
// definition axiom for ReadsAll.__default.D (revealed)
axiom {:id "id195"} 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, f#0: HandleType :: 
    { ReadsAll.__default.D($Heap, f#0), $IsGoodHeap($Heap) } 
    ReadsAll.__default.D#canCall($Heap, f#0)
         || (0 < $FunctionContextHeight
           && 
          $IsGoodHeap($Heap)
           && $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
           && (forall x#1: int :: 
            { Requires1(TInt, TInt, $Heap, f#0, $Box(x#1)) } 
            Requires1(TInt, TInt, $Heap, f#0, $Box(x#1))))
       ==> ReadsAll.__default.D($Heap, f#0)
         == $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)))): int
           + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)))): int
           + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)))): int);
}

function ReadsAll.__default.D#canCall($heap: Heap, f#0: HandleType) : bool;

// frame axiom for ReadsAll.__default.D
axiom (forall $h0: Heap, $h1: Heap, f#0: HandleType :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), ReadsAll.__default.D($h1, f#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && (ReadsAll.__default.D#canCall($h0, f#0)
         || $Is(f#0, Tclass._System.___hFunc1(TInt, TInt)))
       && 
      $IsHeapAnchor($h0)
       && $HeapSucc($h0, $h1)
      ...
      $o != null
           && (exists _x0#0: int, _obj#0: ref :: 
            ...
            $Is(_obj#0, Tclass._System.object?())
               ...
               && $Box($o) == $Box(_obj#0))
         ==> read($h0, $o, $f) == read($h1, $o, $f))
     ==> ReadsAll.__default.D($h0, f#0) == ReadsAll.__default.D($h1, f#0));

function ReadsAll.__default.D#requires(Heap, HandleType) : bool;

// #requires axiom for ReadsAll.__default.D
axiom (forall $Heap: Heap, f#0: HandleType :: 
  { ReadsAll.__default.D#requires($Heap, f#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap) && $Is(f#0, Tclass._System.___hFunc1(TInt, TInt))
     ==> ReadsAll.__default.D#requires($Heap, f#0)
       == (forall x#1: int :: 
        { Requires1(TInt, TInt, $Heap, f#0, $Box(x#1)) } 
        Requires1(TInt, TInt, $Heap, f#0, $Box(x#1))));

procedure {:verboseName "ReadsAll.D (well-formedness)"} CheckWellformed$$ReadsAll.__default.D(f#0: HandleType where $Is(f#0, Tclass._System.___hFunc1(TInt, TInt)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ReadsAll.D (well-formedness)"} CheckWellformed$$ReadsAll.__default.D(f#0: HandleType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var x#2: int;
  var ##x0#0: int;
  ...
  var b$reqreads#4: bool;
    ...
    b$reqreads#0 := (forall $o: ref, $f: Field :: 
      $o != null
         ...
         ==> $_ReadsFrame[$o, $f]);
    assume Requires1#canCall(TInt, TInt, $Heap, f#0, $Box(x#2));
    assume {:id "id196"} Requires1(TInt, TInt, $Heap, f#0, $Box(x#2));
    assume {:id "id197"} (forall x#0: int :: 
      { Requires1(TInt, TInt, $Heap, f#0, $Box(x#0)) } 
      Requires1(TInt, TInt, $Heap, f#0, $Box(x#0)));
    ...
    if ($Is(_obj#1, Tclass._System.object?())
       && $IsAlloc(_obj#1, Tclass._System.object?(), $Heap))
    {
        assert {:id "id199"} true;
        assert {:id "id200"} Requires1(TInt, 
          TSet(Tclass._System.object?()), 
          $Heap, 
          Reads1#Handle(TInt, TInt, f#0), 
          $Box(_x0#1));
    ...
    if ($Is(_obj#2, Tclass._System.object?())
       && $IsAlloc(_obj#2, Tclass._System.object?(), $Heap))
    {
        assert {:id "id202"} true;
        assert {:id "id203"} Requires1(TInt, 
          TSet(Tclass._System.object?()), 
          $Heap, 
          Reads1#Handle(TInt, TInt, f#0), 
          $Box(_x0#2));
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assert {:id "id204"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)));
        b$reqreads#2 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(0))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assert {:id "id205"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)));
        b$reqreads#3 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(1))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assert {:id "id206"} Requires1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)));
        b$reqreads#4 := (forall $o: ref, $f: Field :: 
          $o != null
               && $Unbox(read($Heap, $o, alloc)): bool
               && Set#IsMember(Reads1(TInt, TInt, $Heap, f#0, $Box(LitInt(2))), $Box($o))
             ==> $_ReadsFrame[$o, $f]);
        assume {:id "id207"} ReadsAll.__default.D($Heap, f#0)
           == $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(0)))): int
             + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(1)))): int
             + $Unbox(Apply1(TInt, TInt, $Heap, f#0, $Box(LitInt(2)))): int;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(ReadsAll.__default.D($Heap, f#0), TInt);
        assert {:id "id208"} b$reqreads#2;
        assert {:id "id209"} b$reqreads#3;
        assert {:id "id210"} b$reqreads#4;
        return;
