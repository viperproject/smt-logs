...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|$l#14#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#28| |l#0@@0| |l#1| |l#2| |l#3|) |$l#14#ly#0|) (Handle1 (|lambda#24| |l#0@@0| |l#1| |$l#14#ly#0|) |l#2| |l#3|))
 :qid |nofile.1:7|
 :skolemid |569|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#28| |l#0@@0| |l#1| |l#2| |l#3|) |$l#14#ly#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.Const$A@@1 T@U) (_module._default.Const$B@@1 T@U) (|a#0@@1| T@U) ) (!  (=> (or (|_module.__default.Const#canCall| _module._default.Const$A@@1 _module._default.Const$B@@1 |a#0@@1|) (and (< 0 $FunctionContextHeight) ($IsBox |a#0@@1| _module._default.Const$A@@1))) (= (_module.__default.Const _module._default.Const$A@@1 _module._default.Const$B@@1 |a#0@@1|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#7| |a#0@@1|) (|lambda#2| _module._default.Const$B@@1) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( (_module.__default.Const _module._default.Const$A@@1 _module._default.Const$B@@1 |a#0@@1|))
))))
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|$l#14#heap#0| T@U) (|$l#14#a#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#24| |l#0@@1| |l#1@@0| |l#2@@0|) |$l#14#heap#0| |$l#14#a#0|) ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#7| ($Box intType ($Unbox intType |$l#14#a#0|))) |l#0@@1| |l#1@@0|)) |l#2@@0|))))
 :qid |nofile.1:7|
 :skolemid |568|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#24| |l#0@@1| |l#1@@0| |l#2@@0|) |$l#14#heap#0| |$l#14#a#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.Const$A@@2 T@U) (_module._default.Const$B@@2 T@U) (|a#0@@2| T@U) ) (!  (=> (or (|_module.__default.Const#canCall| _module._default.Const$A@@2 _module._default.Const$B@@2 |a#0@@2|) (and (< 0 $FunctionContextHeight) ($IsBox |a#0@@2| _module._default.Const$A@@2))) ($Is HandleTypeType (_module.__default.Const _module._default.Const$A@@2 _module._default.Const$B@@2 |a#0@@2|) (Tclass._System.___hTotalFunc1 _module._default.Const$B@@2 _module._default.Const$A@@2)))
 :qid |unknown.0:0|
 :skolemid |531|
 :pattern ( (_module.__default.Const _module._default.Const$A@@2 _module._default.Const$B@@2 |a#0@@2|))
))))
...
(assert (forall ((|l#0@@5| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@5|) |$l#0#heap#0@@0| |$l#0#x#0@@0|) |l#0@@5|)
 :qid |Applydfy.8:9|
 :skolemid |565|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@5|) |$l#0#heap#0@@0| |$l#0#x#0@@0|))
)))
(assert (forall ((|l#0@@6| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#b#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#7| |l#0@@6|) |$l#0#heap#0@@1| |$l#0#b#0|) |l#0@@6|)
 :qid |Applydfy.11:21|
 :skolemid |567|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#7| |l#0@@6|) |$l#0#heap#0@@1| |$l#0#b#0|))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon23_Else_correct true))
(let ((anon23_Then_correct true))
(let ((anon22_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= |$lambdaHeap#0@0| |$lambdaHeap#1@0|) ($HeapSucc |$lambdaHeap#0@0| |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 15) 13) anon23_Then_correct) (=> (= (ControlFlow 0 15) 14) anon23_Else_correct)))))
(let ((anon22_Else_correct true))
(let ((anon21_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 16) 15) anon22_Then_correct) (=> (= (ControlFlow 0 16) 12) anon22_Else_correct)))))
(let ((anon21_Else_correct true))
(let ((anon20_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 17) 16) anon21_Then_correct) (=> (= (ControlFlow 0 17) 11) anon21_Else_correct)))))
(let ((anon27_Else_correct true))
(let ((anon27_Then_correct true))
(let ((anon26_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#3@0|) (or (= |$lambdaHeap#2@0| |$lambdaHeap#3@0|) ($HeapSucc |$lambdaHeap#2@0| |$lambdaHeap#3@0|))) (and (=> (= (ControlFlow 0 8) 6) anon27_Then_correct) (=> (= (ControlFlow 0 8) 7) anon27_Else_correct)))))
(let ((anon26_Else_correct true))
(let ((anon25_Then_correct  (=> (= |$_Frame#l2@0| (|lambda#0| null |$lambdaHeap#2@0| alloc false)) (and (=> (= (ControlFlow 0 9) 8) anon26_Then_correct) (=> (= (ControlFlow 0 9) 5) anon26_Else_correct)))))
(let ((anon25_Else_correct true))
(let ((anon24_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2@0|) (or (= $Heap@@0 |$lambdaHeap#2@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#2@0|))) (and (=> (= (ControlFlow 0 10) 9) anon25_Then_correct) (=> (= (ControlFlow 0 10) 4) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#28| (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false)))) ($LS $LZ))) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#28| (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false)))) ($LS $LZ)))))))
(let ((anon19_Then_correct  (=> ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap@@0) (=> (and (and (|_module.__default.Const#canCall| TInt TInt ($Box intType (int_2_U |x#0@0|))) ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap@@0)) (and (|_module.__default.Const#canCall| TInt TInt ($Box intType (int_2_U |x#0@0|))) (forall ((|x#1| T@U) (|y#1| T@U) ) (!  (and (|_module.__default.Const#canCall| TInt TInt ($Box intType |x#1|)) (|_module.__default.Const#canCall| TInt TInt ($Box intType |x#1|)))
 :qid |Applydfy.25:17|
 :skolemid |547|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@0 (_module.__default.Const TInt TInt ($Box intType |x#1|)) ($Box intType |y#1|))))
)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((|x#1@@0| Int) (|y#1@@0| Int) ) (! (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (_module.__default.Const TInt TInt ($Box intType (int_2_U |x#1@@0|))) ($Box intType (int_2_U |y#1@@0|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (_module.__default.Const TInt TInt ($Box intType (int_2_U |x#1@@0|))) ($Box intType (int_2_U |y#1@@0|))))))
 :qid |Applydfy.25:17|
 :skolemid |549|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@0 (_module.__default.Const TInt TInt ($Box intType (int_2_U |x#1@@0|))) ($Box intType (int_2_U |y#1@@0|)))))
))) (=> (forall ((|x#1@@1| T@U) (|y#1@@1| T@U) ) (! (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (_module.__default.Const TInt TInt ($Box intType |x#1@@1|)) ($Box intType |y#1@@1|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (_module.__default.Const TInt TInt ($Box intType |x#1@@1|)) ($Box intType |y#1@@1|)))))
 :qid |Applydfy.25:17|
 :skolemid |549|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@0 (_module.__default.Const TInt TInt ($Box intType |x#1@@1|)) ($Box intType |y#1@@1|))))
)) (and (and (=> (= (ControlFlow 0 18) 17) anon20_Then_correct) (=> (= (ControlFlow 0 18) 10) anon24_Then_correct)) (=> (= (ControlFlow 0 18) 3) anon24_Else_correct))))))))
(let ((anon19_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 20) 18) anon19_Then_correct) (=> (= (ControlFlow 0 20) 1) anon19_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 21) 20))) anon0_correct)))
