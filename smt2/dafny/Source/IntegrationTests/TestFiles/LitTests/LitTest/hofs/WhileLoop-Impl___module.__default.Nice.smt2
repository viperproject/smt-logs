...
(set-info :boogie-vc-id Impl$$_module.__default.Nice)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 45) (let ((anon22_Else_correct true))
(let ((anon22_Then_correct true))
(let ((anon21_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 43) 41) anon22_Then_correct) (=> (= (ControlFlow 0 43) 42) anon22_Else_correct)))))
(let ((anon27_Else_correct true))
(let ((anon27_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 27)) true) (and (=> (= (ControlFlow 0 24) (- 0 26)) (or (not (= $nw@0 null)) (not true))) (=> (forall ((|u#5| T@U) ) (! (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#5|)))) (+ (U_2_int |u#5|) (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) _module.Ref.val)))))
 :qid |WhileLoopdfy.14:22|
 :skolemid |498|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#5|))))
)) (and (=> (= (ControlFlow 0 24) (- 0 25)) true) (=> (= (ControlFlow 0 24) (- 0 23)) (or (not (= $nw@0 null)) (not true)))))))))
...
)))) (and (=> (= (ControlFlow 0 29) 24) anon27_Then_correct) (=> (= (ControlFlow 0 29) 28) anon27_Else_correct)))))
...
)))) (and (=> (= (ControlFlow 0 30) 29) anon26_Then_correct) (=> (= (ControlFlow 0 30) 22) anon26_Else_correct)))))
(let ((anon25_Else_correct true))
(let ((anon24_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 31) 30) anon25_Then_correct) (=> (= (ControlFlow 0 31) 21) anon25_Else_correct)))))
(let ((anon30_Else_correct true))
(let ((anon30_Then_correct true))
(let ((anon29_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0@0|) (or (= $Heap@3 |$lambdaHeap#0_0@0|) ($HeapSucc $Heap@3 |$lambdaHeap#0_0@0|))) (and (=> (= (ControlFlow 0 11) 9) anon30_Then_correct) (=> (= (ControlFlow 0 11) 10) anon30_Else_correct)))))
(let ((anon29_Else_correct  (=> (= |f#0@2| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#6| TInt TInt |f#0@1| 1) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (<= 0 |$decr$loop#00@1|) (= (- |n#0| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@0) _module.Ref.val)))) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |n#0| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@0) _module.Ref.val)))) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 4) (- 0 7)) (< (- |n#0| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@0) _module.Ref.val)))) |$decr$loop#00@1|)) (=> (< (- |n#0| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@0) _module.Ref.val)))) |$decr$loop#00@1|) (=> (and (forall ((|u#1@@1| T@U) ) (! true
 :qid |WhileLoopdfy.12:22|
 :skolemid |503|
...
)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (=> |$w$loop#0@0| (forall ((|u#1@@3| Int) ) (! (Requires1 TInt TInt $Heap@3 |f#0@2| ($Box intType (int_2_U |u#1@@3|)))
 :qid |WhileLoopdfy.12:22|
 :skolemid |492|
...
))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> |$w$loop#0@0| (forall ((|u#3@@2| Int) ) (! (|Set#Equal| (Reads1 TInt TInt $Heap@3 |f#0@2| ($Box intType (int_2_U |u#3@@2|))) |Set#Empty|)
 :qid |WhileLoopdfy.13:22|
 :skolemid |497|
...
))) (=> (= (ControlFlow 0 4) (- 0 3)) (=> |$w$loop#0@0| (forall ((|u#5@@0| Int) ) (! (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@3 |f#0@2| ($Box intType (int_2_U |u#5@@0|))))) (+ |u#5@@0| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@0) _module.Ref.val)))))
 :qid |WhileLoopdfy.14:22|
 :skolemid |500|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@3 |f#0@2| ($Box intType (int_2_U |u#5@@0|)))))
))))))))))))))))
(let ((anon28_Else_correct  (=> (and (< (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) _module.Ref.val))) |n#0|) (= |$decr$loop#00@1| (- |n#0| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) _module.Ref.val)))))) (and (=> (= (ControlFlow 0 12) (- 0 17)) true) (and (=> (= (ControlFlow 0 12) (- 0 16)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Ref.val))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Ref.val)) (and (=> (= (ControlFlow 0 12) (- 0 14)) true) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (= |$rhs#0_0@1| (+ (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) _module.Ref.val))) 1)) (=> (and (= $Heap@3 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) _module.Ref.val ($Box intType (int_2_U |$rhs#0_0@1|))))) ($IsGoodHeap $Heap@3)) (and (=> (= (ControlFlow 0 12) 11) anon29_Then_correct) (=> (= (ControlFlow 0 12) 4) anon29_Else_correct)))))))))))))))
(let ((anon28_Then_correct true))
(let ((anon24_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 18) (- 0 20)) true) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 18) 2) anon28_Then_correct) (=> (= (ControlFlow 0 18) 12) anon28_Else_correct))))))))
(let ((anon23_LoopBody_correct  (and (=> (= (ControlFlow 0 32) 31) anon24_Then_correct) (=> (= (ControlFlow 0 32) 18) anon24_Else_correct))))
(let ((anon23_LoopDone_correct true))
(let ((anon23_LoopHead_correct  (=> (and (and ($Is HandleTypeType |f#0@1| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@1| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@2)) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (=> (and (and (and (and (not false) true) (= |$rhs#0@0| 0)) (=> |$w$loop#0@0| (forall ((|u#1@@5| T@U) ) (! true
 :qid |WhileLoopdfy.12:22|
 :skolemid |490|
 :pattern ( (Requires1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#1@@5|)))
)))) (and (and (and (=> |$w$loop#0@0| (forall ((|u#1@@6| T@U) ) (! (Requires1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#1@@6|))
 :qid |WhileLoopdfy.12:22|
 :skolemid |492|
 :pattern ( (Requires1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#1@@6|)))
))) (=> |$w$loop#0@0| (forall ((|u#3@@4| T@U) ) (! true
 :qid |WhileLoopdfy.13:22|
 :skolemid |495|
 :pattern ( (Reads1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#3@@4|)))
)))) (and (=> |$w$loop#0@0| (forall ((|u#3@@5| T@U) ) (! (|Set#Equal| (Reads1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#3@@5|)) |Set#Empty|)
 :qid |WhileLoopdfy.13:22|
 :skolemid |497|
 :pattern ( (Reads1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#3@@5|)))
))) (=> |$w$loop#0@0| (forall ((|u#5@@1| T@U) ) (! (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@2 |f#0@1| ($Box intType |u#5@@1|)))) (+ (U_2_int |u#5@@1|) (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) _module.Ref.val)))))
 :qid |WhileLoopdfy.14:22|
 :skolemid |500|
...
)) (<= (- |n#0| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) _module.Ref.val)))) |$decr_init$loop#00@0|))))) (and (=> (= (ControlFlow 0 33) 1) anon23_LoopDone_correct) (=> (= (ControlFlow 0 33) 32) anon23_LoopBody_correct))))))
(let ((anon21_Else_correct  (=> (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._module.Ref? TInt))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 34) (- 0 40)) true) (and (=> (= (ControlFlow 0 34) (- 0 39)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 34) (- 0 38)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Ref.val))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Ref.val)) (=> (and (and (= |$rhs#0@0| (LitInt 0)) (= $Heap@1 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@0 $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@0) _module.Ref.val ($Box intType (int_2_U |$rhs#0@0|)))))) (and ($IsGoodHeap $Heap@1) (= |$decr_init$loop#00@0| (- |n#0| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) _module.Ref.val))))))) (and (=> (= (ControlFlow 0 34) (- 0 37)) (=> |$w$loop#0@0| (forall ((|u#1@@7| Int) ) (! (Requires1 TInt TInt $Heap@1 |f#0@0| ($Box intType (int_2_U |u#1@@7|)))
 :qid |WhileLoopdfy.12:22|
 :skolemid |492|
...
))) (and (=> (= (ControlFlow 0 34) (- 0 36)) (=> |$w$loop#0@0| (forall ((|u#3@@6| Int) ) (! (|Set#Equal| (Reads1 TInt TInt $Heap@1 |f#0@0| ($Box intType (int_2_U |u#3@@6|))) |Set#Empty|)
 :qid |WhileLoopdfy.13:22|
 :skolemid |497|
...
))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (=> |$w$loop#0@0| (forall ((|u#5@@2| Int) ) (! (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 |f#0@0| ($Box intType (int_2_U |u#5@@2|))))) (+ |u#5@@2| (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) _module.Ref.val)))))
 :qid |WhileLoopdfy.14:22|
 :skolemid |500|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@1 |f#0@0| ($Box intType (int_2_U |u#5@@2|)))))
)))) (=> (=> |$w$loop#0@0| (forall ((|u#5@@3| T@U) ) (! (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@1 |f#0@0| ($Box intType |u#5@@3|)))) (+ (U_2_int |u#5@@3|) (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) _module.Ref.val)))))
 :qid |WhileLoopdfy.14:22|
 :skolemid |500|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@1 |f#0@0| ($Box intType |u#5@@3|))))
))) (=> (= (ControlFlow 0 34) 33) anon23_LoopHead_correct))))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 44) 43) anon21_Then_correct) (=> (= (ControlFlow 0 44) 34) anon21_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true) (and (and (=> |defass#i#0| (and ($Is refType |i#0| (Tclass._module.Ref TInt)) ($IsAlloc refType |i#0| (Tclass._module.Ref TInt) $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 45) 44)))) anon0_correct))))
