...
(declare-fun ReadsRequiresReads.__default.MyReadsBad_k (T@U T@U T@U T@U T@U) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |ReadsRequiresReads.__default.MyReadsBad_k#canCall| (T@U T@U T@U T@U T@U) Bool)
...
(assert  (and (= (Ctor HandleTypeType) 3) (= (Ctor refType) 4)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ReadsRequiresReads._default.MyReadsBad'$A| T@U) (|ReadsRequiresReads._default.MyReadsBad'$B| T@U) ($Heap T@U) (|f#0| T@U) (|a#0| T@U) (|o#0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsBad_k#canCall| |ReadsRequiresReads._default.MyReadsBad'$A| |ReadsRequiresReads._default.MyReadsBad'$B| |f#0| |a#0| |o#0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsBad'$A| |ReadsRequiresReads._default.MyReadsBad'$B|))) ($IsBox |a#0| |ReadsRequiresReads._default.MyReadsBad'$A|)) ($Is refType |o#0| Tclass._System.object)))) (and true (= (ReadsRequiresReads.__default.MyReadsBad_k |ReadsRequiresReads._default.MyReadsBad'$A| |ReadsRequiresReads._default.MyReadsBad'$B| |f#0| |a#0| |o#0|) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsBad'$A| |ReadsRequiresReads._default.MyReadsBad'$B| $Heap |f#0| |a#0|) ($Box refType |o#0|)))))
 :qid |unknown.0:0|
 :skolemid |704|
 :pattern ( (ReadsRequiresReads.__default.MyReadsBad_k |ReadsRequiresReads._default.MyReadsBad'$A| |ReadsRequiresReads._default.MyReadsBad'$B| |f#0| |a#0| |o#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ReadsRequiresReads._default.MyReadsBad'$A@@0| T@U) (|ReadsRequiresReads._default.MyReadsBad'$B@@0| T@U) ($Heap@@0 T@U) (|f#0@@0| T@U) (|a#0@@0| T@U) (|o#0@@0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsBad_k#canCall| |ReadsRequiresReads._default.MyReadsBad'$A@@0| |ReadsRequiresReads._default.MyReadsBad'$B@@0| |f#0@@0| |a#0@@0| (Lit refType |o#0@@0|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsBad'$A@@0| |ReadsRequiresReads._default.MyReadsBad'$B@@0|))) ($IsBox |a#0@@0| |ReadsRequiresReads._default.MyReadsBad'$A@@0|)) ($Is refType |o#0@@0| Tclass._System.object)))) (and true (= (ReadsRequiresReads.__default.MyReadsBad_k |ReadsRequiresReads._default.MyReadsBad'$A@@0| |ReadsRequiresReads._default.MyReadsBad'$B@@0| |f#0@@0| |a#0@@0| (Lit refType |o#0@@0|)) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsBad'$A@@0| |ReadsRequiresReads._default.MyReadsBad'$B@@0| $Heap@@0 |f#0@@0| |a#0@@0|) ($Box refType (Lit refType |o#0@@0|))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |705|
 :pattern ( (ReadsRequiresReads.__default.MyReadsBad_k |ReadsRequiresReads._default.MyReadsBad'$A@@0| |ReadsRequiresReads._default.MyReadsBad'$B@@0| |f#0@@0| |a#0@@0| (Lit refType |o#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|ReadsRequiresReads._default.MyReadsBad'$A@@1| T@U) (|ReadsRequiresReads._default.MyReadsBad'$B@@1| T@U) ($Heap@@1 T@U) (|f#0@@1| T@U) (|a#0@@1| T@U) (|o#0@@1| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsBad_k#canCall| |ReadsRequiresReads._default.MyReadsBad'$A@@1| |ReadsRequiresReads._default.MyReadsBad'$B@@1| (Lit HandleTypeType |f#0@@1|) (Lit BoxType |a#0@@1|) (Lit refType |o#0@@1|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsBad'$A@@1| |ReadsRequiresReads._default.MyReadsBad'$B@@1|))) ($IsBox |a#0@@1| |ReadsRequiresReads._default.MyReadsBad'$A@@1|)) ($Is refType |o#0@@1| Tclass._System.object)))) (and true (= (ReadsRequiresReads.__default.MyReadsBad_k |ReadsRequiresReads._default.MyReadsBad'$A@@1| |ReadsRequiresReads._default.MyReadsBad'$B@@1| (Lit HandleTypeType |f#0@@1|) (Lit BoxType |a#0@@1|) (Lit refType |o#0@@1|)) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsBad'$A@@1| |ReadsRequiresReads._default.MyReadsBad'$B@@1| $Heap@@1 (Lit HandleTypeType |f#0@@1|) (Lit BoxType |a#0@@1|)) ($Box refType (Lit refType |o#0@@1|))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |706|
 :pattern ( (ReadsRequiresReads.__default.MyReadsBad_k |ReadsRequiresReads._default.MyReadsBad'$A@@1| |ReadsRequiresReads._default.MyReadsBad'$B@@1| (Lit HandleTypeType |f#0@@1|) (Lit BoxType |a#0@@1|) (Lit refType |o#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(declare-fun |ReadsRequiresReads._default.MyReadsBad'$A@@2| () T@U)
(declare-fun |ReadsRequiresReads._default.MyReadsBad'$B@@2| () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$ReadsRequiresReads.__default.MyReadsBad_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@2|) (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsBad'$A@@2| |ReadsRequiresReads._default.MyReadsBad'$B@@2|) $Heap@@2) ($IsAllocBox |a#0@@2| |ReadsRequiresReads._default.MyReadsBad'$A@@2| $Heap@@2)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 |ReadsRequiresReads._default.MyReadsBad'$A@@2| |ReadsRequiresReads._default.MyReadsBad'$B@@2| $Heap@@2 |f#0@@2| |a#0@@2|)) (=> (Requires1 |ReadsRequiresReads._default.MyReadsBad'$A@@2| |ReadsRequiresReads._default.MyReadsBad'$B@@2| $Heap@@2 |f#0@@2| |a#0@@2|) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@2) alloc)))) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsBad'$A@@2| |ReadsRequiresReads._default.MyReadsBad'$B@@2| $Heap@@2 |f#0@@2| |a#0@@2|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |ReadsReadsdfy.52:12|
 :skolemid |707|
))) (= (ReadsRequiresReads.__default.MyReadsBad_k |ReadsRequiresReads._default.MyReadsBad'$A@@2| |ReadsRequiresReads._default.MyReadsBad'$B@@2| |f#0@@2| |a#0@@2| |o#0@@2|) (|Set#IsMember| (Reads1 |ReadsRequiresReads._default.MyReadsBad'$A@@2| |ReadsRequiresReads._default.MyReadsBad'$B@@2| $Heap@@2 |f#0@@2| |a#0@@2|) ($Box refType |o#0@@2|)))) (and ($Is boolType (bool_2_U (ReadsRequiresReads.__default.MyReadsBad_k |ReadsRequiresReads._default.MyReadsBad'$A@@2| |ReadsRequiresReads._default.MyReadsBad'$B@@2| |f#0@@2| |a#0@@2| |o#0@@2|)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is HandleTypeType |f#0@@2| (Tclass._System.___hFunc1 |ReadsRequiresReads._default.MyReadsBad'$A@@2| |ReadsRequiresReads._default.MyReadsBad'$B@@2|))) (and (and ($IsBox |a#0@@2| |ReadsRequiresReads._default.MyReadsBad'$A@@2|) ($Is refType |o#0@@2| Tclass._System.object)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
