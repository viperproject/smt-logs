...
(set-info :boogie-vc-id Impl$$_module.__default.FoldR__F23)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS ($LS $LZ)) |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|))) (LitInt 2)) (LitInt 0)))))
(let ((anon5_Then_correct  (=> (= |xs#0@@5| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0_0@0|)) |_mcc#1#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List TInt)) (= (ControlFlow 0 5) 3)) GeneratedUnifiedExit_correct))))
(let ((anon4_Then_correct  (=> (and (= |xs#0@@5| |#_module.List.Nil|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |xs#0@@5| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (|$IsA#_module.List| |xs#0@@5|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@3 $Heap@0) (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List TInt)) (U_2_bool (Lit boolType (bool_2_U true)))) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@5|))) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |$ih#xs0#0|))) (LitInt 2)) (LitInt 0)))
 :qid |Foldinglegacydfy.101:17|
 :skolemid |677|
 :pattern ( ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |$ih#xs0#0|)))
)))) (and (=> (= (ControlFlow 0 7) 4) anon4_Then_correct) (=> (= (ControlFlow 0 7) 6) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3)) (|$IsA#_module.List| |xs#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
