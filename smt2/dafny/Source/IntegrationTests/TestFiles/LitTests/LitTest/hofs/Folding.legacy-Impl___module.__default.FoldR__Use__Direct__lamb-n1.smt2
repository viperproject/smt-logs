...
(assert (forall ((|#$T0@@16| T@U) (|#$T1@@16| T@U) (|#$R@@16| T@U) (|f#0@@7| T@U) ($h@@3 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@3) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@3))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@3))
)))
(assert (forall ((|#$T0@@17| T@U) (|#$T1@@17| T@U) (|#$R@@17| T@U) (|f#0@@8| T@U) ($h@@4 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@4) ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hPartialFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@4))
 :qid |unknown.0:0|
 :skolemid |527|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@4))
)))
...
(assert (forall ((_module.List$T@@6 T@U) (bx@@14 T@U) ) (!  (=> ($IsBox bx@@14 (Tclass._module.List _module.List$T@@6)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@14)) bx@@14) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@14) (Tclass._module.List _module.List$T@@6))))
 :qid |unknown.0:0|
 :skolemid |614|
 :pattern ( ($IsBox bx@@14 (Tclass._module.List _module.List$T@@6)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.FoldR__Use__Direct__lambda)
...
(let ((anon7_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@3 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@3 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 11) 9) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon8_Else_correct)))))
(let ((anon6_correct  (=> (forall ((|ys#1| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1| (Tclass._module.List TInt)) (|_module.__default.foldr#canCall| TInt TInt |f#0@0| ($Box intType (int_2_U (LitInt 0))) |ys#1|))
 :qid |Foldinglegacydfy.123:17|
 :skolemid |688|
 :pattern ( ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |f#0@0| ($Box intType (int_2_U 0)) |ys#1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|ys#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1@@0| (Tclass._module.List TInt)) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS ($LS $LZ)) |f#0@0| ($Box intType (int_2_U (LitInt 0))) |ys#1@@0|))) (LitInt 2)) (LitInt 0)))
 :qid |Foldinglegacydfy.123:17|
 :skolemid |689|
 :pattern ( ($Unbox intType (_module.__default.foldr TInt TInt ($LS ($LS $LZ)) |f#0@0| ($Box intType (int_2_U 0)) |ys#1@@0|)))
))) (=> (forall ((|ys#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1@@1| (Tclass._module.List TInt)) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |f#0@0| ($Box intType (int_2_U (LitInt 0))) |ys#1@@1|))) (LitInt 2)) (LitInt 0)))
 :qid |Foldinglegacydfy.123:17|
 :skolemid |691|
 :pattern ( ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |f#0@0| ($Box intType (int_2_U 0)) |ys#1@@1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod |r#0@0| (LitInt 2)) (LitInt 0)))))))))
(let ((anon9_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |ys#0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3))) (= (ControlFlow 0 7) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |ys#0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3)) ($IsAlloc HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3)) (and (and (= |##b#1@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##b#1@0|) TInt $Heap@@3)) (and ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3) (|_module.__default.foldr#canCall| TInt TInt |f#0@0| ($Box intType (int_2_U (LitInt 0))) |ys#0@0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 5) 2) anon6_correct)))))
(let ((anon7_Else_correct  (=> (and (and (and (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#10| (Handle2 (|lambda#6| (LitInt 2) (LitInt 3)) (|lambda#7| TInt TInt) (|lambda#9| (SetRef_to_SetBox (|lambda#8| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3)) (and (= |##b#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##b#0@0|) TInt $Heap@@3))) (and (and ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3) (|_module.__default.foldr#canCall| TInt TInt |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|)) (and (|_module.__default.foldr#canCall| TInt TInt |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|) (= |r#0@0| (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|))))))) (and (=> (= (ControlFlow 0 8) 5) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (and (=> (= (ControlFlow 0 12) 11) anon7_Then_correct) (=> (= (ControlFlow 0 12) 8) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3)) (|$IsA#_module.List| |xs#0@@5|)) (=> (and (and (and ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc2 TInt TInt TInt)) ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct)))))
