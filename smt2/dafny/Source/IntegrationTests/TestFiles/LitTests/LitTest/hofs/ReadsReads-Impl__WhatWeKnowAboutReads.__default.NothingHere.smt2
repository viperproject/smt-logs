...
(assert (forall ((|#$R@@2| T@U) ($self@@1 T@U) ($heap@@1 T@U) ) (! (= (Requires0 (TSet Tclass._System.object?) $heap@@1 (|Reads0#Handle| |#$R@@2| $self@@1)) (Requires0 |#$R@@2| $heap@@1 $self@@1))
 :qid |unknown.0:0|
 :skolemid |1364|
 :pattern ( (Requires0 (TSet Tclass._System.object?) $heap@@1 (|Reads0#Handle| |#$R@@2| $self@@1)))
)))
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#2| |l#0|) |$l#0#heap#0|) |l#0|)
 :qid |ReadsReadsdfy.77:19|
 :skolemid |3454|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#2| |l#0|) |$l#0#heap#0|))
)))
(assert (forall ((|l#0@@0| Bool) (|$l#0#heap#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#3| |l#0@@0|) |$l#0#heap#0@@0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |3455|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#3| |l#0@@0|) |$l#0#heap#0@@0|))
)))
(assert (forall ((|l#0@@1| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType0Select refType boolType (|lambda#4| |l#0@@1|) |$l#0#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |3456|
 :pattern ( (MapType0Select refType boolType (|lambda#4| |l#0@@1|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#0#heap#0@@1| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#5| |l#0@@2|) |$l#0#heap#0@@1|) |l#0@@2|)
 :qid |ReadsReadsdfy.77:13|
 :skolemid |3457|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#5| |l#0@@2|) |$l#0#heap#0@@1|))
)))
(assert (forall ((|l#0@@3| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#6| |l#0@@3|) |$l#0#ly#0|) |l#0@@3|)
 :qid |ReadsReadsdfy.77:13|
 :skolemid |3458|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#6| |l#0@@3|) |$l#0#ly#0|))
)))
...
(assert (forall ((|#$R@@3| T@U) ($self@@2 T@U) ($heap@@2 T@U) ) (! (= (Apply0 (TSet Tclass._System.object?) $heap@@2 (|Reads0#Handle| |#$R@@3| $self@@2)) ($Box SetType (Reads0 |#$R@@3| $heap@@2 $self@@2)))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( (Apply0 (TSet Tclass._System.object?) $heap@@2 (|Reads0#Handle| |#$R@@3| $self@@2)))
)))
...
(assert (forall ((|#$R@@5| T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._System.___hFunc0 |#$R@@5|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@8)) bx@@8) ($Is HandleTypeType ($Unbox HandleTypeType bx@@8) (Tclass._System.___hFunc0 |#$R@@5|))))
 :qid |unknown.0:0|
 :skolemid |1134|
 :pattern ( ($IsBox bx@@8 (Tclass._System.___hFunc0 |#$R@@5|)))
)))
...
(assert (forall ((f@@12 T@U) (t0@@16 T@U) (u0@@2 T@U) ) (!  (=> (and ($Is HandleTypeType f@@12 (Tclass._System.___hFunc0 t0@@16)) (forall ((bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 t0@@16) ($IsBox bx@@9 u0@@2))
 :qid |unknown.0:0|
 :skolemid |1154|
 :pattern ( ($IsBox bx@@9 t0@@16))
 :pattern ( ($IsBox bx@@9 u0@@2))
...
(set-info :boogie-vc-id Impl$$WhatWeKnowAboutReads.__default.NothingHere)
...
(let ((anon5_Else_correct  (=> (and ($IsAllocBox ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle0 (|lambda#2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_System._tuple#0._#Make0|))) (|lambda#3| true) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (Tclass._System.___hFunc0 Tclass._System.Tuple0) $Heap) (= (ControlFlow 0 2) (- 0 1))) (|Set#Equal| (Reads0 Tclass._System.Tuple0 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle0 (|lambda#2| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_System._tuple#0._#Make0|))) (|lambda#3| true) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) |Set#Empty|))))
