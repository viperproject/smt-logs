...
(declare-fun |Reads.__default.g#Handle| (T@U) T@U)
(declare-fun |Reads.__default.g#requires| (T@U T@U Int) Bool)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun |Set#IsMember| (T@U T@U) Bool)
(declare-fun |Set#Empty| () T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun Reads.__default.g (T@U T@U Int) Int)
(declare-fun |Reads.__default.g#canCall| (T@U Int) Bool)
...
(assert (forall (($ly T@U) ($heap T@U) (|$fh$0x#0| T@U) ) (! (= (Requires1 Tclass._System.nat Tclass._System.nat $heap (|Reads.__default.g#Handle| $ly) |$fh$0x#0|) (|Reads.__default.g#requires| $ly $heap (U_2_int ($Unbox intType |$fh$0x#0|))))
 :qid |unknown.0:0|
 :skolemid |1677|
 :pattern ( (Requires1 Tclass._System.nat Tclass._System.nat $heap (|Reads.__default.g#Handle| $ly) |$fh$0x#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap T@U) (|x#0@@0| Int) ) (!  (=> (or (|Reads.__default.g#canCall| $Heap |x#0@@0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (<= (LitInt 0) |x#0@@0|)))) (<= (LitInt 0) (Reads.__default.g $ly@@0 $Heap |x#0@@0|)))
 :qid |Nakeddfy.41:18|
 :skolemid |1682|
 :pattern ( (Reads.__default.g $ly@@0 $Heap |x#0@@0|))
))))
(assert (forall (($bx T@U) ($ly@@1 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (|Set#IsMember| (Reads1 Tclass._System.nat Tclass._System.nat $heap@@0 (|Reads.__default.g#Handle| $ly@@1) |$fh$0x#0@@0|) $bx) (|Set#IsMember| (Reads1 Tclass._System.nat Tclass._System.nat $heap@@0 (|Reads.__default.g#Handle| ($LS $LZ)) |$fh$0x#0@@0|) $bx))
 :qid |unknown.0:0|
 :skolemid |1678|
 :pattern ( (|Set#IsMember| (Reads1 Tclass._System.nat Tclass._System.nat $heap@@0 (|Reads.__default.g#Handle| $ly@@1) |$fh$0x#0@@0|) $bx))
)))
...
(assert (forall (($ly@@2 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| Int) ) (! (= (Reads.__default.g $ly@@2 $heap@@1 |$fh$0x#0@@1|) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass._System.nat $heap@@1 (|Reads.__default.g#Handle| $ly@@2) ($Box intType (int_2_U |$fh$0x#0@@1|))))))
 :qid |unknown.0:0|
 :skolemid |1679|
 :pattern ( (Reads.__default.g $ly@@2 $heap@@1 |$fh$0x#0@@1|))
)))
(assert (forall (($ly@@3 T@U) ($Heap@@0 T@U) (|x#0@@1| Int) ) (!  (=> (and ($IsGoodHeap $Heap@@0) (<= (LitInt 0) |x#0@@1|)) (= (|Reads.__default.g#requires| $ly@@3 $Heap@@0 |x#0@@1|) true))
 :qid |Nakeddfy.41:18|
 :skolemid |1683|
 :pattern ( (|Reads.__default.g#requires| $ly@@3 $Heap@@0 |x#0@@1|) ($IsGoodHeap $Heap@@0))
)))
...
(assert (forall (($ly@@4 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Apply1 Tclass._System.nat Tclass._System.nat $heap@@2 (|Reads.__default.g#Handle| $ly@@4) |$fh$0x#0@@2|) ($Box intType (int_2_U (Reads.__default.g $ly@@4 $heap@@2 (U_2_int ($Unbox intType |$fh$0x#0@@2|))))))
 :qid |unknown.0:0|
 :skolemid |1676|
 :pattern ( (Apply1 Tclass._System.nat Tclass._System.nat $heap@@2 (|Reads.__default.g#Handle| $ly@@4) |$fh$0x#0@@2|))
)))
...
(assert (forall (($ly@@5 T@U) ($Heap@@1 T@U) (|x#0@@3| Int) ) (! (= (Reads.__default.g ($LS $ly@@5) $Heap@@1 |x#0@@3|) (Reads.__default.g $ly@@5 $Heap@@1 |x#0@@3|))
 :qid |Nakeddfy.41:18|
 :skolemid |1673|
 :pattern ( (Reads.__default.g ($LS $ly@@5) $Heap@@1 |x#0@@3|))
)))
...
(assert (forall (($ly@@6 T@U) ) (! (= (|Reads.__default.g#Handle| ($LS $ly@@6)) (|Reads.__default.g#Handle| $ly@@6))
 :qid |Nakeddfy.41:18|
 :skolemid |1675|
 :pattern ( (|Reads.__default.g#Handle| ($LS $ly@@6)))
)))
(assert (= (Tag Tclass._System.nat) Tagclass._System.nat))
(assert (= (TagFamily Tclass._System.nat) tytagFamily$nat))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@7 T@U) ($Heap@@2 T@U) (|x#0@@4| Int) ) (!  (=> (or (|Reads.__default.g#canCall| $Heap@@2 |x#0@@4|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) (<= (LitInt 0) |x#0@@4|)))) (= (Reads.__default.g ($LS $ly@@7) $Heap@@2 |x#0@@4|) |x#0@@4|))
 :qid |Nakeddfy.41:18|
 :skolemid |1684|
 :pattern ( (Reads.__default.g ($LS $ly@@7) $Heap@@2 |x#0@@4|) ($IsGoodHeap $Heap@@2))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Reads.__default.g)
