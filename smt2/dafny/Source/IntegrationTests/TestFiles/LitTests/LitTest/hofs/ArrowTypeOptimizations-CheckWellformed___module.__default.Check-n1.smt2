...
(declare-fun _module.__default.CheckPre (T@U Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.CheckPre#canCall| (T@U Int) Bool)
...
(assert (distinct TInt TagInt alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1|)
)
(assert (= (Tag TInt) TagInt))
(assert (= (Ctor HandleTypeType) 3))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0| T@U) (|x#0| Int) ) (!  (=> (or (|_module.__default.CheckPre#canCall| |f#0| |x#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hPartialFunc1 TInt TInt))))) (= (_module.__default.CheckPre |f#0| |x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |x#0|)))))))
 :qid |ArrowTypeOptimizationsdfy.13:16|
 :skolemid |536|
 :pattern ( (_module.__default.CheckPre |f#0| |x#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|f#0@@0| T@U) (|x#0@@0| Int) ) (!  (=> (or (|_module.__default.CheckPre#canCall| |f#0@@0| (LitInt |x#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hPartialFunc1 TInt TInt))))) (= (_module.__default.CheckPre |f#0@@0| (LitInt |x#0@@0|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt |x#0@@0|))))))))
 :qid |ArrowTypeOptimizationsdfy.13:16|
 :weight 3
 :skolemid |537|
 :pattern ( (_module.__default.CheckPre |f#0@@0| (LitInt |x#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|#$T0@@3| T@U) (|#$R@@3| T@U) (|f#0@@1| T@U) ) (! (= ($Is HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc1 |#$T0@@3| |#$R@@3|))  (and ($Is HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 |#$T0@@3| |#$R@@3|)) (forall ((|x0#0| T@U) ) (!  (=> ($IsBox |x0#0| |#$T0@@3|) (|Set#Equal| (Reads1 |#$T0@@3| |#$R@@3| $OneHeap |f#0@@1| |x0#0|) |Set#Empty|))
 :qid |unknown.0:0|
 :skolemid |401|
))))
 :qid |unknown.0:0|
 :skolemid |402|
 :pattern ( ($Is HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc1 |#$T0@@3| |#$R@@3|)))
)))
(assert (forall ((|#$T0@@4| T@U) (|#$R@@4| T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass._System.___hFunc1 |#$T0@@4| |#$R@@4|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@2)) bx@@2) ($Is HandleTypeType ($Unbox HandleTypeType bx@@2) (Tclass._System.___hFunc1 |#$T0@@4| |#$R@@4|))))
 :qid |unknown.0:0|
 :skolemid |369|
 :pattern ( ($IsBox bx@@2 (Tclass._System.___hFunc1 |#$T0@@4| |#$R@@4|)))
)))
(assert (forall ((|#$T0@@5| T@U) (|#$R@@5| T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._System.___hPartialFunc1 |#$T0@@5| |#$R@@5|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@3)) bx@@3) ($Is HandleTypeType ($Unbox HandleTypeType bx@@3) (Tclass._System.___hPartialFunc1 |#$T0@@5| |#$R@@5|))))
 :qid |unknown.0:0|
 :skolemid |400|
 :pattern ( ($IsBox bx@@3 (Tclass._System.___hPartialFunc1 |#$T0@@5| |#$R@@5|)))
)))
...
(assert (forall ((|#$T0@@7| T@U) (|#$R@@7| T@U) ) (!  (and (= (Tag (Tclass._System.___hPartialFunc1 |#$T0@@7| |#$R@@7|)) Tagclass._System.___hPartialFunc1) (= (TagFamily (Tclass._System.___hPartialFunc1 |#$T0@@7| |#$R@@7|)) |tytagFamily$_#PartialFunc1|))
 :qid |unknown.0:0|
 :skolemid |397|
 :pattern ( (Tclass._System.___hPartialFunc1 |#$T0@@7| |#$R@@7|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|f#0@@2| T@U) (|x#0@@1| Int) ) (!  (=> (or (|_module.__default.CheckPre#canCall| (Lit HandleTypeType |f#0@@2|) (LitInt |x#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@2| (Tclass._System.___hPartialFunc1 TInt TInt))))) (= (_module.__default.CheckPre (Lit HandleTypeType |f#0@@2|) (LitInt |x#0@@1|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 (Lit HandleTypeType |f#0@@2|) ($Box intType (int_2_U (LitInt |x#0@@1|))))))))
 :qid |ArrowTypeOptimizationsdfy.13:16|
 :weight 3
 :skolemid |538|
 :pattern ( (_module.__default.CheckPre (Lit HandleTypeType |f#0@@2|) (LitInt |x#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.CheckPre)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (= (ControlFlow 0 3) (- 0 2)) (Requires1 TInt TInt $Heap@@2 |f#0@@3| ($Box intType (int_2_U |x#0@@2|))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hPartialFunc1 TInt TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
