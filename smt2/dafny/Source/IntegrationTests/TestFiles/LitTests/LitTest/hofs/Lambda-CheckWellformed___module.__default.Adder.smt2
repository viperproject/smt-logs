...
(declare-fun |_module.__default.Adder#canCall| () Bool)
(declare-fun _module.__default.Adder () T@U)
...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc2 Tagclass._System.___hPartialFunc2 Tagclass._System.___hTotalFunc2 tytagFamily$object |tytagFamily$_#Func2| |tytagFamily$_#PartialFunc2| |tytagFamily$_#TotalFunc2|)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$l#6#heap#0| T@U) (|$l#6#x#0| T@U) (|$l#6#y#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#17| |l#0| |l#1|) |$l#6#heap#0| |$l#6#x#0| |$l#6#y#0|))  (and ($IsBox |$l#6#x#0| |l#0|) ($IsBox |$l#6#y#0| |l#1|)))
 :qid |unknown.0:0|
 :skolemid |584|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#17| |l#0| |l#1|) |$l#6#heap#0| |$l#6#x#0| |$l#6#y#0|))
)))
...
(assert (forall ((|$l#0#heap#0| T@U) (|$l#0#x#0| T@U) (|$l#0#y#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType |lambda#56| |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|) ($Box intType (int_2_U (+ (U_2_int ($Unbox intType |$l#0#x#0|)) (U_2_int ($Unbox intType |$l#0#y#0|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |589|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType |lambda#56| |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.Adder#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.Adder (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle2 |lambda#56| (|lambda#17| TInt TInt) (|lambda#19| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.Adder#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.Adder (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle2 |lambda#56| (|lambda#17| TInt TInt) (|lambda#19| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))))))
...
(assert (forall ((|l#0@@2| T@U) (|$l#6#heap#0@@0| T@U) (|$l#6#x#0@@0| T@U) (|$l#6#y#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#19| |l#0@@2|) |$l#6#heap#0@@0| |$l#6#x#0@@0| |$l#6#y#0@@0|) |l#0@@2|)
 :qid |Lambdadfy.10:34|
 :skolemid |585|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#19| |l#0@@2|) |$l#6#heap#0@@0| |$l#6#x#0@@0| |$l#6#y#0@@0|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) ) (!  (=> (or |_module.__default.Adder#canCall| (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap))) (and (and (forall ((|x#0| T@U) (|y#0| T@U) ) (! (Requires2 TInt TInt TInt $Heap (Lit HandleTypeType _module.__default.Adder) ($Box intType |x#0|) ($Box intType |y#0|))
 :qid |Lambdadfy.41:18|
 :skolemid |537|
 :pattern ( (Requires2 TInt TInt TInt $Heap _module.__default.Adder ($Box intType |x#0|) ($Box intType |y#0|)))
)) (forall ((|x#1| T@U) (|y#1| T@U) ) (! (= (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $Heap (Lit HandleTypeType _module.__default.Adder) ($Box intType |x#1|) ($Box intType |y#1|)))) (+ (U_2_int |x#1|) (U_2_int |y#1|)))
 :qid |Lambdadfy.42:18|
 :skolemid |538|
 :pattern ( ($Unbox intType (Apply2 TInt TInt TInt $Heap _module.__default.Adder ($Box intType |x#1|) ($Box intType |y#1|))))
))) ($Is HandleTypeType _module.__default.Adder (Tclass._System.___hTotalFunc2 TInt TInt TInt))))
 :qid |Lambdadfy.40:16|
 :skolemid |539|
 :pattern ( _module.__default.Adder ($IsGoodHeap $Heap))
))))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType2Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@1) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |574|
 :pattern ( (MapType2Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@0| |l#2| |l#3|) $o@@1 $f))
)))
...
(assert (forall ((t0@@17 T@U) (t1@@15 T@U) (t2@@14 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@12 T@U) (bx0@@11 T@U) (bx1@@11 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) (and (and ($IsBox bx0@@11 t0@@17) ($IsBox bx1@@11 t1@@15)) ($Is HandleTypeType f@@12 (Tclass._System.___hFunc2 t0@@17 t1@@15 t2@@14)))) (forall ((o@@7 T@U) (fld@@4 T@U) ) (!  (=> (and (or (not (= o@@7 null)) (not true)) (|Set#IsMember| (Reads2 t0@@17 t1@@15 t2@@14 h1@@4 f@@12 bx0@@11 bx1@@11) ($Box refType o@@7))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h0@@4 o@@7) fld@@4) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h1@@4 o@@7) fld@@4)))
 :qid |unknown.0:0|
 :skolemid |497|
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Adder)
...
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 10) 8) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (forall ((|x#2| Int) (|y#2| Int) ) (! (Requires2 TInt TInt TInt $Heap@@0 (Lit HandleTypeType _module.__default.Adder) ($Box intType (int_2_U |x#2|)) ($Box intType (int_2_U |y#2|)))
 :qid |Lambdadfy.41:18|
 :skolemid |540|
 :pattern ( (Requires2 TInt TInt TInt $Heap@@0 _module.__default.Adder ($Box intType (int_2_U |x#2|)) ($Box intType (int_2_U |y#2|))))
))) (=> (forall ((|x#2@@0| T@U) (|y#2@@0| T@U) ) (! (Requires2 TInt TInt TInt $Heap@@0 (Lit HandleTypeType _module.__default.Adder) ($Box intType |x#2@@0|) ($Box intType |y#2@@0|))
 :qid |Lambdadfy.41:18|
 :skolemid |540|
 :pattern ( (Requires2 TInt TInt TInt $Heap@@0 _module.__default.Adder ($Box intType |x#2@@0|) ($Box intType |y#2@@0|)))
)) (=> (= (ControlFlow 0 5) (- 0 4)) (forall ((|x#3| Int) (|y#3| Int) ) (! (= (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $Heap@@0 (Lit HandleTypeType _module.__default.Adder) ($Box intType (int_2_U |x#3|)) ($Box intType (int_2_U |y#3|))))) (+ |x#3| |y#3|))
 :qid |Lambdadfy.42:18|
 :skolemid |541|
 :pattern ( ($Unbox intType (Apply2 TInt TInt TInt $Heap@@0 _module.__default.Adder ($Box intType (int_2_U |x#3|)) ($Box intType (int_2_U |y#3|)))))
)))))))
(let ((anon10_Else_correct  (=> (= _module.__default.Adder (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle2 |lambda#56| (|lambda#17| TInt TInt) (|lambda#19| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (=> (and ($Is HandleTypeType _module.__default.Adder (Tclass._System.___hTotalFunc2 TInt TInt TInt)) (= (ControlFlow 0 7) 5)) GeneratedUnifiedExit_correct))))
(let ((anon9_Then_correct  (=> ($Is HandleTypeType _module.__default.Adder (Tclass._System.___hTotalFunc2 TInt TInt TInt)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (or (U_2_bool (Lit boolType (bool_2_U true))) |_module.__default.Adder#canCall|) (=> (and ($IsAllocBox ($Box HandleTypeType (Lit HandleTypeType _module.__default.Adder)) (Tclass._System.___hFunc2 TInt TInt TInt) $Heap@@0) ($IsAlloc intType (int_2_U |x#4@0|) TInt $Heap@@0)) (=> (and (and ($IsAlloc intType (int_2_U |y#4@0|) TInt $Heap@@0) (Requires2 TInt TInt TInt $Heap@@0 (Lit HandleTypeType _module.__default.Adder) ($Box intType (int_2_U |x#4@0|)) ($Box intType (int_2_U |y#4@0|)))) (and (forall ((|x#2@@1| T@U) (|y#2@@1| T@U) ) (! (Requires2 TInt TInt TInt $Heap@@0 (Lit HandleTypeType _module.__default.Adder) ($Box intType |x#2@@1|) ($Box intType |y#2@@1|))
 :qid |Lambdadfy.41:18|
 :skolemid |542|
 :pattern ( (Requires2 TInt TInt TInt $Heap@@0 _module.__default.Adder ($Box intType |x#2@@1|) ($Box intType |y#2@@1|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (and (=> (= (ControlFlow 0 11) 2) anon9_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
