...
(set-info :boogie-vc-id Impl$$_module.__default.FoldL__Use__Direct)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon3_correct  (=> (forall ((|ys#1| T@U) (|b#1| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1| (Tclass._module.List TInt)) (=> (= (Mod (U_2_int |b#1|) (LitInt 2)) (LitInt 0)) (|_module.__default.foldl#canCall| TInt TInt |_module.__default.F32#Handle| ($Box intType |b#1|) |ys#1|)))
 :qid |Foldinglegacydfy.234:17|
 :skolemid |747|
 :pattern ( ($Unbox intType (_module.__default.foldl TInt TInt ($LS $LZ) |_module.__default.F32#Handle| ($Box intType |b#1|) |ys#1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|ys#1@@0| T@U) (|b#1@@0| Int) ) (!  (=> ($Is DatatypeTypeType |ys#1@@0| (Tclass._module.List TInt)) (=> (= (Mod |b#1@@0| (LitInt 2)) (LitInt 0)) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldl TInt TInt ($LS ($LS $LZ)) |_module.__default.F32#Handle| ($Box intType (int_2_U |b#1@@0|)) |ys#1@@0|))) (LitInt 2)) (LitInt 0))))
 :qid |Foldinglegacydfy.234:17|
 :skolemid |748|
 :pattern ( ($Unbox intType (_module.__default.foldl TInt TInt ($LS ($LS $LZ)) |_module.__default.F32#Handle| ($Box intType (int_2_U |b#1@@0|)) |ys#1@@0|)))
))) (=> (forall ((|ys#1@@1| T@U) (|b#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1@@1| (Tclass._module.List TInt)) (=> (= (Mod (U_2_int |b#1@@1|) (LitInt 2)) (LitInt 0)) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldl TInt TInt ($LS $LZ) |_module.__default.F32#Handle| ($Box intType |b#1@@1|) |ys#1@@1|))) (LitInt 2)) (LitInt 0))))
 :qid |Foldinglegacydfy.234:17|
 :skolemid |750|
 :pattern ( ($Unbox intType (_module.__default.foldl TInt TInt ($LS $LZ) |_module.__default.F32#Handle| ($Box intType |b#1@@1|) |ys#1@@1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod |r#0@0| (LitInt 2)) (LitInt 0)))))))))
(let ((anon5_Else_correct  (=> (and (or (not (= (Mod |b#0@0| (LitInt 2)) (LitInt 0))) (not true)) (= (ControlFlow 0 9) 2)) anon3_correct)))
(let ((anon5_Then_correct  (=> (= (Mod |b#0@0| (LitInt 2)) (LitInt 0)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |##f#1@0| |_module.__default.F32#Handle|) (=> (and (and ($IsAlloc HandleTypeType |##f#1@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3) ($IsAlloc intType (int_2_U |b#0@0|) TInt $Heap@@3)) (and ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3) (|_module.__default.foldl#canCall| TInt TInt |_module.__default.F32#Handle| ($Box intType (int_2_U |b#0@0|)) |ys#0@0|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 6) 2) anon3_correct)))))))))
(let ((anon4_Then_correct  (=> (and ($Is DatatypeTypeType |ys#0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= (LitInt 2) 0)) (not true))) (and (=> (= (ControlFlow 0 10) 6) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct))))))
(let ((anon4_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |ys#0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3))) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (and (and (= |##f#0@0| |_module.__default.F32#Handle|) ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3)) (and (= |##b#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##b#0@0|) TInt $Heap@@3))) (and (and ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3) (|_module.__default.foldl#canCall| TInt TInt |_module.__default.F32#Handle| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|)) (and (|_module.__default.foldl#canCall| TInt TInt |_module.__default.F32#Handle| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|) (= |r#0@0| (U_2_int ($Unbox intType (_module.__default.foldl TInt TInt ($LS $LZ) |_module.__default.F32#Handle| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|))))))) (and (=> (= (ControlFlow 0 12) 10) anon4_Then_correct) (=> (= (ControlFlow 0 12) 5) anon4_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3)) (|$IsA#_module.List| |xs#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 14) 12))) anon0_correct))))
