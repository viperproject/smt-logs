...
(assert (forall ((|l#0| Bool) (|$l#0#heap#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#3| |l#0|) |$l#0#heap#0|)) |l#0|)
 :qid |unknown.0:0|
 :skolemid |516|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#3| |l#0|) |$l#0#heap#0|))
)))
(assert (forall ((|l#0@@0| T@U) (|$l#0#heap#0@@0| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#5| |l#0@@0|) |$l#0#heap#0@@0|) |l#0@@0|)
 :qid |Framedfy.19:12|
 :skolemid |518|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#5| |l#0@@0|) |$l#0#heap#0@@0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#6| |l#0@@1|) |$l#0#ly#0|) |l#0@@1|)
 :qid |Framedfy.19:12|
 :skolemid |519|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#6| |l#0@@1|) |$l#0#ly#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#0#heap#0@@1| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#16| |l#0@@2|) |$l#0#heap#0@@1|) |l#0@@2|)
 :qid |Framedfy.43:22|
 :skolemid |521|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#16| |l#0@@2|) |$l#0#heap#0@@1|))
)))
(assert (forall ((|l#0@@3| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType0Select refType boolType (|lambda#18| |l#0@@3|) |$l#0#o#0|)) |l#0@@3|)
 :qid |unknown.0:0|
 :skolemid |522|
 :pattern ( (MapType0Select refType boolType (|lambda#18| |l#0@@3|) |$l#0#o#0|))
)))
...
(declare-fun |getX#0@0| () T@U)
(declare-fun |x#0@0| () Int)
(declare-fun $LZ () T@U)
(declare-fun |x#0@1| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |getX#0| () T@U)
...
(let ((anon5_Else_correct  (=> (= |getX#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle0 (|lambda#16| ($Box intType (int_2_U |x#0@0|))) (|lambda#3| true) (|lambda#5| (SetRef_to_SetBox (|lambda#18| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int ($Unbox intType (Apply0 TInt $Heap |getX#0@0|))) (LitInt 2))) (=> (= (U_2_int ($Unbox intType (Apply0 TInt $Heap |getX#0@0|))) (LitInt 2)) (=> (and (= |x#0@1| (LitInt 3)) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_int ($Unbox intType (Apply0 TInt $Heap |getX#0@0|))) (LitInt 2))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x#0@0| (LitInt 2))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |getX#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |getX#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
