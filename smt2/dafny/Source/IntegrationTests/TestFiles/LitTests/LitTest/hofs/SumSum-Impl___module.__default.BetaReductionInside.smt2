...
(declare-fun |$lambdaHeap#0_0_0_5@0| () T@U)
(declare-fun |$lambdaHeap#0_0_0_4@0| () T@U)
(declare-fun |$_Frame#l0_0_0_4@0| () T@U)
...
(declare-fun |$lambdaHeap#0_3@0| () T@U)
(declare-fun |$lambdaHeap#0_2@0| () T@U)
(declare-fun |$lambdaHeap#0_5@0| () T@U)
(declare-fun |$lambdaHeap#0_4@0| () T@U)
(declare-fun |$_Frame#l0_4@0| () T@U)
(declare-fun |$_Frame#l0_2@0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.BetaReductionInside)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 90) (let ((anon115_Else_correct true))
(let ((anon115_Then_correct true))
(let ((anon114_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0_0_1@0|) (or (= |$lambdaHeap#0_0_0_0@0| |$lambdaHeap#0_0_0_1@0|) ($HeapSucc |$lambdaHeap#0_0_0_0@0| |$lambdaHeap#0_0_0_1@0|))) (and (=> (= (ControlFlow 0 81) 79) anon115_Then_correct) (=> (= (ControlFlow 0 81) 80) anon115_Else_correct)))))
(let ((anon114_Else_correct true))
(let ((anon113_Then_correct  (=> (and (= |$_Frame#l0_0_0_0@0| (|lambda#0| null |$lambdaHeap#0_0_0_0@0| alloc false)) ($IsAlloc intType (int_2_U |n'#0|) Tclass._System.nat |$lambdaHeap#0_0_0_0@0|)) (and (=> (= (ControlFlow 0 82) 81) anon114_Then_correct) (=> (= (ControlFlow 0 82) 78) anon114_Else_correct)))))
(let ((anon113_Else_correct true))
(let ((anon112_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0_0_0@0|) (or (= $Heap@@2 |$lambdaHeap#0_0_0_0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0_0_0_0@0|))) (and (=> (= (ControlFlow 0 83) 82) anon113_Then_correct) (=> (= (ControlFlow 0 83) 77) anon113_Else_correct)))))
(let ((anon119_Else_correct true))
(let ((anon119_Then_correct true))
(let ((anon118_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0_0_3@0|) (or (= |$lambdaHeap#0_0_0_2@0| |$lambdaHeap#0_0_0_3@0|) ($HeapSucc |$lambdaHeap#0_0_0_2@0| |$lambdaHeap#0_0_0_3@0|))) (and (=> (= (ControlFlow 0 73) 71) anon119_Then_correct) (=> (= (ControlFlow 0 73) 72) anon119_Else_correct)))))
(let ((anon123_Else_correct true))
(let ((anon123_Then_correct true))
(let ((anon122_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0_0_5@0|) (or (= |$lambdaHeap#0_0_0_4@0| |$lambdaHeap#0_0_0_5@0|) ($HeapSucc |$lambdaHeap#0_0_0_4@0| |$lambdaHeap#0_0_0_5@0|))) (and (=> (= (ControlFlow 0 68) 66) anon123_Then_correct) (=> (= (ControlFlow 0 68) 67) anon123_Else_correct)))))
(let ((anon122_Else_correct true))
(let ((anon121_Then_correct  (=> (and (= |$_Frame#l0_0_0_4@0| (|lambda#0| null |$lambdaHeap#0_0_0_4@0| alloc false)) ($IsAlloc intType (int_2_U |n'#0|) Tclass._System.nat |$lambdaHeap#0_0_0_4@0|)) (and (=> (= (ControlFlow 0 69) 68) anon122_Then_correct) (=> (= (ControlFlow 0 69) 65) anon122_Else_correct)))))
(let ((anon121_Else_correct true))
(let ((anon120_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0_0_4@0|) (or (= |$lambdaHeap#0_0_0_2@0| |$lambdaHeap#0_0_0_4@0|) ($HeapSucc |$lambdaHeap#0_0_0_2@0| |$lambdaHeap#0_0_0_4@0|))) (and (=> (= (ControlFlow 0 70) 69) anon121_Then_correct) (=> (= (ControlFlow 0 70) 64) anon121_Else_correct)))))
(let ((anon120_Else_correct true))
(let ((anon117_Then_correct  (=> (= |$_Frame#l0_0_0_2@0| (|lambda#0| null |$lambdaHeap#0_0_0_2@0| alloc false)) (and (and (=> (= (ControlFlow 0 74) 73) anon118_Then_correct) (=> (= (ControlFlow 0 74) 70) anon120_Then_correct)) (=> (= (ControlFlow 0 74) 63) anon120_Else_correct)))))
(let ((anon117_Else_correct true))
(let ((anon116_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0_0_2@0|) (or (= $Heap@@2 |$lambdaHeap#0_0_0_2@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0_0_0_2@0|))) (and (=> (= (ControlFlow 0 75) 74) anon117_Then_correct) (=> (= (ControlFlow 0 75) 62) anon117_Else_correct)))))
(let ((anon116_Else_correct  (=> (and (forall ((|$l#0_0_0_38#w#0| T@U) ) (! (|_module.__default.Sum#canCall| |n'#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#0_0_0_38#w#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |unknown.0:0|
 :skolemid |592|
)) (= (ControlFlow 0 61) (- 0 60))) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#692| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|)) |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0_0@0|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#773| TInt TInt (|lambda#6| (Handle1 (|lambda#754| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) TInt TInt (|lambda#57| |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0_0@0|)))))))))
(let ((anon112_Else_correct  (=> (forall ((|$l#0_0_0_9#x#0| T@U) ) (! (|_module.__default.Sum#canCall| |n'#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#0_0_0_9#x#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |unknown.0:0|
 :skolemid |589|
)) (and (=> (= (ControlFlow 0 76) 75) anon116_Then_correct) (=> (= (ControlFlow 0 76) 61) anon116_Else_correct)))))
(let ((anon110_Else_correct true))
(let ((anon110_Then_correct true))
(let ((anon109_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0_1@0|) (or (= |$lambdaHeap#0_0_0@0| |$lambdaHeap#0_0_1@0|) ($HeapSucc |$lambdaHeap#0_0_0@0| |$lambdaHeap#0_0_1@0|))) (and (=> (= (ControlFlow 0 57) 55) anon110_Then_correct) (=> (= (ControlFlow 0 57) 56) anon110_Else_correct)))))
(let ((anon109_Else_correct true))
(let ((anon108_Then_correct  (=> (and (= |$_Frame#l0_0_0@0| (|lambda#0| null |$lambdaHeap#0_0_0@0| alloc false)) ($IsAlloc intType (int_2_U |n'#0|) Tclass._System.nat |$lambdaHeap#0_0_0@0|)) (and (=> (= (ControlFlow 0 58) 57) anon109_Then_correct) (=> (= (ControlFlow 0 58) 54) anon109_Else_correct)))))
(let ((anon108_Else_correct true))
(let ((anon107_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0_0@0|) (or (= $Heap@@2 |$lambdaHeap#0_0_0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0_0_0@0|))) (and (=> (= (ControlFlow 0 59) 58) anon108_Then_correct) (=> (= (ControlFlow 0 59) 53) anon108_Else_correct)))))
(let ((anon107_Else_correct true))
(let ((anon111_Else_correct  (=> (and (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#692| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|)) |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0_0@0|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#773| TInt TInt (|lambda#6| (Handle1 (|lambda#754| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) TInt TInt (|lambda#57| |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0_0@0|)))))) (= (ControlFlow 0 51) (- 0 50))) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#692| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|)) |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0_0@0|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#773| TInt TInt (|lambda#6| (Handle1 (|lambda#754| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) TInt TInt (|lambda#57| |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0_0@0|)))))))))
(let ((anon93_Else_correct  (and (and (and (and (=> (= (ControlFlow 0 84) 51) anon111_Else_correct) (=> (= (ControlFlow 0 84) 83) anon112_Then_correct)) (=> (= (ControlFlow 0 84) 76) anon112_Else_correct)) (=> (= (ControlFlow 0 84) 59) anon107_Then_correct)) (=> (= (ControlFlow 0 84) 52) anon107_Else_correct))))
(let ((anon97_Else_correct true))
(let ((anon97_Then_correct true))
(let ((anon96_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_1@0|) (or (= |$lambdaHeap#0_0@0| |$lambdaHeap#0_1@0|) ($HeapSucc |$lambdaHeap#0_0@0| |$lambdaHeap#0_1@0|))) (and (=> (= (ControlFlow 0 47) 45) anon97_Then_correct) (=> (= (ControlFlow 0 47) 46) anon97_Else_correct)))))
(let ((anon96_Else_correct true))
(let ((anon95_Then_correct  (=> (and (= |$_Frame#l0_0@0| (|lambda#0| null |$lambdaHeap#0_0@0| alloc false)) ($IsAlloc intType (int_2_U |n'#0|) Tclass._System.nat |$lambdaHeap#0_0@0|)) (and (=> (= (ControlFlow 0 48) 47) anon96_Then_correct) (=> (= (ControlFlow 0 48) 44) anon96_Else_correct)))))
(let ((anon95_Else_correct true))
(let ((anon94_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0@0|) (or (= $Heap@@2 |$lambdaHeap#0_0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0_0@0|))) (and (=> (= (ControlFlow 0 49) 48) anon95_Then_correct) (=> (= (ControlFlow 0 49) 43) anon95_Else_correct)))))
(let ((anon101_Else_correct true))
(let ((anon101_Then_correct true))
(let ((anon100_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_3@0|) (or (= |$lambdaHeap#0_2@0| |$lambdaHeap#0_3@0|) ($HeapSucc |$lambdaHeap#0_2@0| |$lambdaHeap#0_3@0|))) (and (=> (= (ControlFlow 0 40) 38) anon101_Then_correct) (=> (= (ControlFlow 0 40) 39) anon101_Else_correct)))))
(let ((anon105_Else_correct true))
(let ((anon105_Then_correct true))
(let ((anon104_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_5@0|) (or (= |$lambdaHeap#0_4@0| |$lambdaHeap#0_5@0|) ($HeapSucc |$lambdaHeap#0_4@0| |$lambdaHeap#0_5@0|))) (and (=> (= (ControlFlow 0 35) 33) anon105_Then_correct) (=> (= (ControlFlow 0 35) 34) anon105_Else_correct)))))
(let ((anon104_Else_correct true))
(let ((anon103_Then_correct  (=> (and (= |$_Frame#l0_4@0| (|lambda#0| null |$lambdaHeap#0_4@0| alloc false)) ($IsAlloc intType (int_2_U |n'#0|) Tclass._System.nat |$lambdaHeap#0_4@0|)) (and (=> (= (ControlFlow 0 36) 35) anon104_Then_correct) (=> (= (ControlFlow 0 36) 32) anon104_Else_correct)))))
(let ((anon103_Else_correct true))
(let ((anon102_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_4@0|) (or (= |$lambdaHeap#0_2@0| |$lambdaHeap#0_4@0|) ($HeapSucc |$lambdaHeap#0_2@0| |$lambdaHeap#0_4@0|))) (and (=> (= (ControlFlow 0 37) 36) anon103_Then_correct) (=> (= (ControlFlow 0 37) 31) anon103_Else_correct)))))
(let ((anon102_Else_correct true))
(let ((anon99_Then_correct  (=> (= |$_Frame#l0_2@0| (|lambda#0| null |$lambdaHeap#0_2@0| alloc false)) (and (and (=> (= (ControlFlow 0 41) 40) anon100_Then_correct) (=> (= (ControlFlow 0 41) 37) anon102_Then_correct)) (=> (= (ControlFlow 0 41) 30) anon102_Else_correct)))))
(let ((anon99_Else_correct true))
(let ((anon98_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_2@0|) (or (= $Heap@@2 |$lambdaHeap#0_2@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0_2@0|))) (and (=> (= (ControlFlow 0 42) 41) anon99_Then_correct) (=> (= (ControlFlow 0 42) 29) anon99_Else_correct)))))
(let ((anon98_Else_correct true))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| |n'#0|)) (and (and (and (=> (= (ControlFlow 0 85) 84) anon93_Else_correct) (=> (= (ControlFlow 0 85) 49) anon94_Then_correct)) (=> (= (ControlFlow 0 85) 42) anon98_Then_correct)) (=> (= (ControlFlow 0 85) 28) anon98_Else_correct)))))
(let ((anon92_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 87) 85)) anon3_correct)))
(let ((anon92_Then_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (= (ControlFlow 0 86) 85)) anon3_correct)))
(let ((anon91_Then_correct  (and (=> (= (ControlFlow 0 88) 86) anon92_Then_correct) (=> (= (ControlFlow 0 88) 87) anon92_Else_correct))))
(let ((anon127_Else_correct true))
(let ((anon127_Then_correct true))
(let ((anon126_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#7@0|) (or (= |$lambdaHeap#6@0| |$lambdaHeap#7@0|) ($HeapSucc |$lambdaHeap#6@0| |$lambdaHeap#7@0|))) (and (=> (= (ControlFlow 0 24) 22) anon127_Then_correct) (=> (= (ControlFlow 0 24) 23) anon127_Else_correct)))))
(let ((anon126_Else_correct true))
(let ((anon125_Then_correct  (=> (and (= |$_Frame#l6@0| (|lambda#0| null |$lambdaHeap#6@0| alloc false)) ($IsAlloc intType (int_2_U |n'#0|) Tclass._System.nat |$lambdaHeap#6@0|)) (and (=> (= (ControlFlow 0 25) 24) anon126_Then_correct) (=> (= (ControlFlow 0 25) 21) anon126_Else_correct)))))
(let ((anon125_Else_correct true))
(let ((anon124_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#6@0|) (or (= $Heap@@2 |$lambdaHeap#6@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#6@0|))) (and (=> (= (ControlFlow 0 26) 25) anon125_Then_correct) (=> (= (ControlFlow 0 26) 20) anon125_Else_correct)))))
(let ((anon131_Else_correct true))
(let ((anon131_Then_correct true))
(let ((anon130_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#9@0|) (or (= |$lambdaHeap#8@0| |$lambdaHeap#9@0|) ($HeapSucc |$lambdaHeap#8@0| |$lambdaHeap#9@0|))) (and (=> (= (ControlFlow 0 16) 14) anon131_Then_correct) (=> (= (ControlFlow 0 16) 15) anon131_Else_correct)))))
(let ((anon135_Else_correct true))
(let ((anon135_Then_correct true))
(let ((anon134_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#11@0|) (or (= |$lambdaHeap#10@0| |$lambdaHeap#11@0|) ($HeapSucc |$lambdaHeap#10@0| |$lambdaHeap#11@0|))) (and (=> (= (ControlFlow 0 11) 9) anon135_Then_correct) (=> (= (ControlFlow 0 11) 10) anon135_Else_correct)))))
(let ((anon134_Else_correct true))
(let ((anon133_Then_correct  (=> (and (= |$_Frame#l10@0| (|lambda#0| null |$lambdaHeap#10@0| alloc false)) ($IsAlloc intType (int_2_U |n'#0|) Tclass._System.nat |$lambdaHeap#10@0|)) (and (=> (= (ControlFlow 0 12) 11) anon134_Then_correct) (=> (= (ControlFlow 0 12) 8) anon134_Else_correct)))))
(let ((anon133_Else_correct true))
(let ((anon132_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#10@0|) (or (= |$lambdaHeap#8@0| |$lambdaHeap#10@0|) ($HeapSucc |$lambdaHeap#8@0| |$lambdaHeap#10@0|))) (and (=> (= (ControlFlow 0 13) 12) anon133_Then_correct) (=> (= (ControlFlow 0 13) 7) anon133_Else_correct)))))
(let ((anon132_Else_correct true))
(let ((anon129_Then_correct  (=> (= |$_Frame#l8@0| (|lambda#0| null |$lambdaHeap#8@0| alloc false)) (and (and (=> (= (ControlFlow 0 17) 16) anon130_Then_correct) (=> (= (ControlFlow 0 17) 13) anon132_Then_correct)) (=> (= (ControlFlow 0 17) 6) anon132_Else_correct)))))
(let ((anon129_Else_correct true))
(let ((anon128_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#8@0|) (or (= $Heap@@2 |$lambdaHeap#8@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#8@0|))) (and (=> (= (ControlFlow 0 18) 17) anon129_Then_correct) (=> (= (ControlFlow 0 18) 5) anon129_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (_module.__default.Sum ($LS ($LS $LZ)) |n'#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#692| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|)) |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ)))) (_module.__default.Sum ($LS ($LS $LZ)) |n'#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#773| TInt TInt (|lambda#6| (Handle1 (|lambda#754| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) TInt TInt (|lambda#57| |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))))))))
(let ((anon128_Else_correct  (=> (and (forall ((|$l#125#w#0| T@U) ) (! (|_module.__default.Sum#canCall| |n'#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#125#w#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |unknown.0:0|
 :skolemid |600|
)) (= |g##0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#773| TInt TInt (|lambda#6| (Handle1 (|lambda#754| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) TInt TInt (|lambda#57| |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| |n'#0|)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f##0@0| ($Box intType (int_2_U |i#1|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g##0@0| ($Box intType (int_2_U |i#1|)))))))
 :qid |SumSumdfy.14:19|
 :skolemid |537|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g##0@0| ($Box intType (int_2_U |i#1|)))))
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f##0@0| ($Box intType (int_2_U |i#1|)))))
))) (=> (forall ((|i#1@@0| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |i#1@@0|)) (< (U_2_int |i#1@@0|) |n'#0|)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f##0@0| ($Box intType |i#1@@0|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g##0@0| ($Box intType |i#1@@0|))))))
 :qid |SumSumdfy.14:19|
 :skolemid |537|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g##0@0| ($Box intType |i#1@@0|))))
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f##0@0| ($Box intType |i#1@@0|))))
)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|_module.__default.Sum#canCall| |n'#0| |f##0@0|) (|_module.__default.Sum#canCall| |n'#0| |g##0@0|)) (= (_module.__default.Sum ($LS ($LS $LZ)) |n'#0| |f##0@0|) (_module.__default.Sum ($LS ($LS $LZ)) |n'#0| |g##0@0|))) (and (= $Heap@@2 $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon124_Else_correct  (=> (and (forall ((|$l#98#x#0| T@U) ) (! (|_module.__default.Sum#canCall| |n'#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#98#x#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |unknown.0:0|
 :skolemid |597|
)) (= |f##0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#692| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|)) |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))))) (and (=> (= (ControlFlow 0 19) 18) anon128_Then_correct) (=> (= (ControlFlow 0 19) 3) anon128_Else_correct)))))
(let ((anon91_Else_correct  (=> (forall ((|i#0_1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |i#0_1|)) (< (U_2_int |i#0_1|) |n'#0|)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#692| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|)) |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType |i#0_1|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#773| TInt TInt (|lambda#6| (Handle1 (|lambda#754| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) TInt TInt (|lambda#57| |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType |i#0_1|))))))
 :qid |SumSumdfy.77:10|
 :skolemid |595|
)) (and (=> (= (ControlFlow 0 27) 26) anon124_Then_correct) (=> (= (ControlFlow 0 27) 19) anon124_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 89) 88) anon91_Then_correct) (=> (= (ControlFlow 0 89) 27) anon91_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (<= (LitInt 0) |n'#0|)) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc2 TInt TInt TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 90) 89)))) anon0_correct)))
