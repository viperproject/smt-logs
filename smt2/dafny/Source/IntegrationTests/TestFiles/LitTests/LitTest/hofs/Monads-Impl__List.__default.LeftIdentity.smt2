...
(declare-fun List._default.LeftIdentity$B () T@U)
(declare-fun $Heap@@7 () T@U)
(declare-fun List._default.LeftIdentity$A () T@U)
(declare-fun |f#0@@14| () T@U)
(declare-fun |x#0@@6| () T@U)
(declare-fun |xs#0_0_0@0| () T@U)
(declare-fun |##ys#0_0_1@0| () T@U)
(declare-fun |##xs#0_0_0@0| () T@U)
(declare-fun |##ys#0_0_0@0| () T@U)
(declare-fun |##xss#0_1_0@0| () T@U)
(declare-fun |##xs#0_1_0@0| () T@U)
(declare-fun |##ys#0_1_0@0| () T@U)
(declare-fun |##xs#0_2_0@0| () T@U)
(declare-fun |##xss#0_2_0@0| () T@U)
(declare-fun |##xss#0_2_1@0| () T@U)
(declare-fun |##m#0_3_0@0| () T@U)
(declare-fun |##xs#0_3_0@0| () T@U)
(declare-fun |##xss#0_3_0@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$List.__default.LeftIdentity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_correct  (=> (forall ((|xs#0_0_1| T@U) ) (!  (=> ($Is DatatypeTypeType |xs#0_0_1| (Tclass.List.M List._default.LeftIdentity$B)) (and (and (|$IsA#List.M| (List.__default.Concat List._default.LeftIdentity$B ($LS $LZ) |xs#0_0_1| (Lit DatatypeTypeType |#List.M.Nil|))) (|$IsA#List.M| |xs#0_0_1|)) (|List.__default.Concat#canCall| List._default.LeftIdentity$B |xs#0_0_1| (Lit DatatypeTypeType |#List.M.Nil|))))
 :qid |Monadsdfy.123:24|
 :skolemid |2245|
 :pattern ( (List.__default.Concat List._default.LeftIdentity$B ($LS $LZ) |xs#0_0_1| |#List.M.Nil|))
)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (forall ((|xs#0_0_1@@0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |xs#0_0_1@@0| (Tclass.List.M List._default.LeftIdentity$B)) ($IsAlloc DatatypeTypeType |xs#0_0_1@@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7)) (forall ((|xs$ih#0_0_0#0_0_0| T@U) ) (!  (=> ($Is DatatypeTypeType |xs$ih#0_0_0#0_0_0| (Tclass.List.M List._default.LeftIdentity$B)) (=> (< (DtRank |xs$ih#0_0_0#0_0_0|) (DtRank |xs#0_0_1@@0|)) (|List.M#Equal| (List.__default.Concat List._default.LeftIdentity$B ($LS $LZ) |xs$ih#0_0_0#0_0_0| (Lit DatatypeTypeType |#List.M.Nil|)) |xs$ih#0_0_0#0_0_0|)))
 :qid |Monadsdfy.123:24|
 :skolemid |2246|
 :pattern ( (List.__default.Concat List._default.LeftIdentity$B ($LS $LZ) |xs$ih#0_0_0#0_0_0| |#List.M.Nil|))
))) (and true (exists ((|a#0_0_0#0#0| T@U) (|a#0_0_0#1#0| T@U) ) (!  (and (and ($IsBox |a#0_0_0#0#0| List._default.LeftIdentity$B) ($Is DatatypeTypeType |a#0_0_0#1#0| (Tclass.List.M List._default.LeftIdentity$B))) (= (|#List.M.Cons| |a#0_0_0#0#0| |a#0_0_0#1#0|) |xs#0_0_1@@0|))
 :qid |Monadsdfy.85:24|
 :skolemid |2247|
 :pattern ( (|#List.M.Cons| |a#0_0_0#0#0| |a#0_0_0#1#0|))
)))) (|List.M#Equal| (List.__default.Concat List._default.LeftIdentity$B ($LS ($LS $LZ)) |xs#0_0_1@@0| (Lit DatatypeTypeType |#List.M.Nil|)) |xs#0_0_1@@0|))
 :qid |Monadsdfy.123:24|
 :skolemid |2248|
 :pattern ( (List.__default.Concat List._default.LeftIdentity$B ($LS ($LS $LZ)) |xs#0_0_1@@0| |#List.M.Nil|))
))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((|xs#0_0_1@@1| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |xs#0_0_1@@1| (Tclass.List.M List._default.LeftIdentity$B)) ($IsAlloc DatatypeTypeType |xs#0_0_1@@1| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7)) (forall ((|xs$ih#0_0_0#0_0_0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |xs$ih#0_0_0#0_0_0@@0| (Tclass.List.M List._default.LeftIdentity$B)) (=> (< (DtRank |xs$ih#0_0_0#0_0_0@@0|) (DtRank |xs#0_0_1@@1|)) (|List.M#Equal| (List.__default.Concat List._default.LeftIdentity$B ($LS $LZ) |xs$ih#0_0_0#0_0_0@@0| (Lit DatatypeTypeType |#List.M.Nil|)) |xs$ih#0_0_0#0_0_0@@0|)))
 :qid |Monadsdfy.123:24|
 :skolemid |2246|
 :pattern ( (List.__default.Concat List._default.LeftIdentity$B ($LS $LZ) |xs$ih#0_0_0#0_0_0@@0| |#List.M.Nil|))
))) (and true (= |#List.M.Nil| |xs#0_0_1@@1|))) (|List.M#Equal| (List.__default.Concat List._default.LeftIdentity$B ($LS ($LS $LZ)) |xs#0_0_1@@1| (Lit DatatypeTypeType |#List.M.Nil|)) |xs#0_0_1@@1|))
 :qid |Monadsdfy.123:24|
 :skolemid |2249|
 :pattern ( (List.__default.Concat List._default.LeftIdentity$B ($LS ($LS $LZ)) |xs#0_0_1@@1| |#List.M.Nil|))
))) (=> (and (forall ((|xs#0_0_1@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |xs#0_0_1@@2| (Tclass.List.M List._default.LeftIdentity$B)) ($IsAlloc DatatypeTypeType |xs#0_0_1@@2| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7)) (|List.M#Equal| (List.__default.Concat List._default.LeftIdentity$B ($LS $LZ) |xs#0_0_1@@2| (Lit DatatypeTypeType |#List.M.Nil|)) |xs#0_0_1@@2|))
 :qid |Monadsdfy.123:24|
 :skolemid |2251|
 :pattern ( (List.__default.Concat List._default.LeftIdentity$B ($LS $LZ) |xs#0_0_1@@2| |#List.M.Nil|))
)) (= (ControlFlow 0 12) (- 0 11))) (|List.M#Equal| (List.__default.Concat List._default.LeftIdentity$B ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|)) (Lit DatatypeTypeType |#List.M.Nil|)) ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|)))))))))
(let ((anon14_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |xs#0_0_0@0| (Tclass.List.M List._default.LeftIdentity$B)) ($IsAlloc DatatypeTypeType |xs#0_0_0@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7))) (= (ControlFlow 0 16) 12)) anon7_correct)))
(let ((anon14_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |xs#0_0_0@0| (Tclass.List.M List._default.LeftIdentity$B)) ($IsAlloc DatatypeTypeType |xs#0_0_0@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7)) ($IsAlloc DatatypeTypeType |xs#0_0_0@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7)) (and (and (= |##ys#0_0_1@0| (Lit DatatypeTypeType |#List.M.Nil|)) ($IsAlloc DatatypeTypeType |##ys#0_0_1@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7)) (and (|List.__default.Concat#canCall| List._default.LeftIdentity$B |xs#0_0_0@0| (Lit DatatypeTypeType |#List.M.Nil|)) (= (ControlFlow 0 15) 12)))) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (= |##xs#0_0_0@0| ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|))) ($IsAlloc DatatypeTypeType |##xs#0_0_0@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7)) (=> (and (and (= |##ys#0_0_0@0| (Lit DatatypeTypeType |#List.M.Nil|)) ($IsAlloc DatatypeTypeType |##ys#0_0_0@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7)) (and (|List.__default.Concat#canCall| List._default.LeftIdentity$B ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|)) (Lit DatatypeTypeType |#List.M.Nil|)) (|List.__default.Concat#canCall| List._default.LeftIdentity$B ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|)) (Lit DatatypeTypeType |#List.M.Nil|)))) (and (=> (= (ControlFlow 0 17) 15) anon14_Then_correct) (=> (= (ControlFlow 0 17) 16) anon14_Else_correct))))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (|List.M#Equal| (List.__default.Bind List._default.LeftIdentity$A List._default.LeftIdentity$B (List.__default.Return List._default.LeftIdentity$A |x#0@@6|) |f#0@@14|) ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|))))))
(let ((anon13_Else_correct  (=> (and (|List.M#Equal| (List.__default.Bind List._default.LeftIdentity$A List._default.LeftIdentity$B (List.__default.Return List._default.LeftIdentity$A |x#0@@6|) |f#0@@14|) ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|))) (= (ControlFlow 0 10) 9)) GeneratedUnifiedExit_correct)))
(let ((anon12_Then_correct  (=> (= |##xss#0_1_0@0| (|#List.M.Cons| (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|) (Lit DatatypeTypeType |#List.M.Nil|))) (=> (and ($IsAlloc DatatypeTypeType |##xss#0_1_0@0| (Tclass.List.M (Tclass.List.M List._default.LeftIdentity$B)) $Heap@@7) (|List.__default.Join#canCall| List._default.LeftIdentity$B (|#List.M.Cons| (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|) (Lit DatatypeTypeType |#List.M.Nil|)))) (=> (and (and (and (|List.__default.Join#canCall| List._default.LeftIdentity$B (|#List.M.Cons| (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|) (Lit DatatypeTypeType |#List.M.Nil|))) (= |##xs#0_1_0@0| ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|)))) (and ($IsAlloc DatatypeTypeType |##xs#0_1_0@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7) (= |##ys#0_1_0@0| (Lit DatatypeTypeType |#List.M.Nil|)))) (and (and ($IsAlloc DatatypeTypeType |##ys#0_1_0@0| (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7) (|List.__default.Concat#canCall| List._default.LeftIdentity$B ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|)) (Lit DatatypeTypeType |#List.M.Nil|))) (and (|List.__default.Concat#canCall| List._default.LeftIdentity$B ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|)) (Lit DatatypeTypeType |#List.M.Nil|)) (= (ControlFlow 0 7) (- 0 6))))) (|List.M#Equal| (List.__default.Join List._default.LeftIdentity$B ($LS ($LS $LZ)) (|#List.M.Cons| (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|) (Lit DatatypeTypeType |#List.M.Nil|))) (List.__default.Concat List._default.LeftIdentity$B ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|)) (Lit DatatypeTypeType |#List.M.Nil|))))))))
(let ((anon11_Then_correct  (=> (= |##xs#0_2_0@0| (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|))) (=> (and ($IsAlloc DatatypeTypeType |##xs#0_2_0@0| (Tclass.List.M List._default.LeftIdentity$A) $Heap@@7) ($IsAlloc HandleTypeType |f#0@@14| (Tclass._System.___hTotalFunc1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B)) $Heap@@7)) (=> (and (and (|List.__default.Map#canCall| List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|) (= |##xss#0_2_0@0| (List.__default.Map List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) ($LS $LZ) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|))) (and ($IsAlloc DatatypeTypeType |##xss#0_2_0@0| (Tclass.List.M (Tclass.List.M List._default.LeftIdentity$B)) $Heap@@7) (|List.__default.Join#canCall| List._default.LeftIdentity$B (List.__default.Map List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) ($LS $LZ) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|)))) (=> (and (and (and (|List.__default.Map#canCall| List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|) (|List.__default.Join#canCall| List._default.LeftIdentity$B (List.__default.Map List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) ($LS $LZ) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|))) (= |##xss#0_2_1@0| (|#List.M.Cons| (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|) (Lit DatatypeTypeType |#List.M.Nil|)))) (and (and ($IsAlloc DatatypeTypeType |##xss#0_2_1@0| (Tclass.List.M (Tclass.List.M List._default.LeftIdentity$B)) $Heap@@7) (|List.__default.Join#canCall| List._default.LeftIdentity$B (|#List.M.Cons| (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|) (Lit DatatypeTypeType |#List.M.Nil|)))) (and (|List.__default.Join#canCall| List._default.LeftIdentity$B (|#List.M.Cons| (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|) (Lit DatatypeTypeType |#List.M.Nil|))) (= (ControlFlow 0 5) (- 0 4))))) (|List.M#Equal| (List.__default.Join List._default.LeftIdentity$B ($LS ($LS $LZ)) (List.__default.Map List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) ($LS ($LS $LZ)) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|)) (List.__default.Join List._default.LeftIdentity$B ($LS ($LS $LZ)) (|#List.M.Cons| (Apply1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) $Heap@@7 |f#0@@14| |x#0@@6|) (Lit DatatypeTypeType |#List.M.Nil|))))))))))
(let ((anon10_Then_correct  (=> (and ($IsAllocBox |x#0@@6| List._default.LeftIdentity$A $Heap@@7) (|List.__default.Return#canCall| List._default.LeftIdentity$A |x#0@@6|)) (=> (and (and (= |##m#0_3_0@0| (List.__default.Return List._default.LeftIdentity$A |x#0@@6|)) ($IsAlloc DatatypeTypeType |##m#0_3_0@0| (Tclass.List.M List._default.LeftIdentity$A) $Heap@@7)) (and ($IsAlloc HandleTypeType |f#0@@14| (Tclass._System.___hTotalFunc1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B)) $Heap@@7) (|List.__default.Bind#canCall| List._default.LeftIdentity$A List._default.LeftIdentity$B (List.__default.Return List._default.LeftIdentity$A |x#0@@6|) |f#0@@14|))) (=> (and (and (and (and (|List.__default.Return#canCall| List._default.LeftIdentity$A |x#0@@6|) (|List.__default.Bind#canCall| List._default.LeftIdentity$A List._default.LeftIdentity$B (List.__default.Return List._default.LeftIdentity$A |x#0@@6|) |f#0@@14|)) (= |##xs#0_3_0@0| (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)))) (and ($IsAlloc DatatypeTypeType |##xs#0_3_0@0| (Tclass.List.M List._default.LeftIdentity$A) $Heap@@7) ($IsAlloc HandleTypeType |f#0@@14| (Tclass._System.___hTotalFunc1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B)) $Heap@@7))) (and (and (and (|List.__default.Map#canCall| List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|) (= |##xss#0_3_0@0| (List.__default.Map List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) ($LS $LZ) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|))) (and ($IsAlloc DatatypeTypeType |##xss#0_3_0@0| (Tclass.List.M (Tclass.List.M List._default.LeftIdentity$B)) $Heap@@7) (|List.__default.Join#canCall| List._default.LeftIdentity$B (List.__default.Map List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) ($LS $LZ) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|)))) (and (and (|List.__default.Map#canCall| List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|) (|List.__default.Join#canCall| List._default.LeftIdentity$B (List.__default.Map List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) ($LS $LZ) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|))) (= (ControlFlow 0 3) (- 0 2))))) (|List.M#Equal| (List.__default.Bind List._default.LeftIdentity$A List._default.LeftIdentity$B (List.__default.Return List._default.LeftIdentity$A |x#0@@6|) |f#0@@14|) (List.__default.Join List._default.LeftIdentity$B ($LS ($LS $LZ)) (List.__default.Map List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B) ($LS ($LS $LZ)) (|#List.M.Cons| |x#0@@6| (Lit DatatypeTypeType |#List.M.Nil|)) |f#0@@14|))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@7 alloc false)) (and (and (and (and (and (=> (= (ControlFlow 0 18) 1) anon9_Then_correct) (=> (= (ControlFlow 0 18) 3) anon10_Then_correct)) (=> (= (ControlFlow 0 18) 5) anon11_Then_correct)) (=> (= (ControlFlow 0 18) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 18) 17) anon13_Then_correct)) (=> (= (ControlFlow 0 18) 10) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (and ($IsBox |x#0@@6| List._default.LeftIdentity$A) ($IsAllocBox |x#0@@6| List._default.LeftIdentity$A $Heap@@7))) (and (and ($Is HandleTypeType |f#0@@14| (Tclass._System.___hTotalFunc1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B))) ($IsAlloc HandleTypeType |f#0@@14| (Tclass._System.___hTotalFunc1 List._default.LeftIdentity$A (Tclass.List.M List._default.LeftIdentity$B)) $Heap@@7)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 19) 18)))) anon0_correct)))
