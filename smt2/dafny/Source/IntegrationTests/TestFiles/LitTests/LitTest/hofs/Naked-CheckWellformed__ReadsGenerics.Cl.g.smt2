...
(declare-fun ReadsGenerics.Cl.g (T@U T@U T@U T@U T@U T@U T@U) T@U)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun DatatypeTypeType () T@T)
(declare-fun Apply2 (T@U T@U T@U T@U T@U T@U T@U) T@U)
(declare-fun Tclass._System.Tuple2 (T@U T@U) T@U)
(declare-fun |ReadsGenerics.Cl.g#Handle| (T@U T@U T@U T@U) T@U)
...
(declare-fun |ReadsGenerics.Cl.g#canCall| (T@U T@U T@U T@U T@U T@U) Bool)
(declare-fun Requires2 (T@U T@U T@U T@U T@U T@U T@U) Bool)
(declare-fun |ReadsGenerics.Cl.g#requires| (T@U T@U T@U T@U T@U T@U T@U) Bool)
...
(assert (forall ((ReadsGenerics.Cl$A T@U) (ReadsGenerics.Cl.g$B T@U) ($ly T@U) ($self T@U) ($heap T@U) (|$fh$0x#0| T@U) (|$fh$0x#1| T@U) ) (! (= (ReadsGenerics.Cl.g ReadsGenerics.Cl$A ReadsGenerics.Cl.g$B $ly $heap $self |$fh$0x#0| |$fh$0x#1|) ($Unbox DatatypeTypeType (Apply2 ReadsGenerics.Cl$A ReadsGenerics.Cl.g$B (Tclass._System.Tuple2 ReadsGenerics.Cl$A ReadsGenerics.Cl.g$B) $heap (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A ReadsGenerics.Cl.g$B $ly $self) |$fh$0x#0| |$fh$0x#1|)))
 :qid |unknown.0:0|
 :skolemid |2262|
 :pattern ( (ReadsGenerics.Cl.g ReadsGenerics.Cl$A ReadsGenerics.Cl.g$B $ly $heap $self |$fh$0x#0| |$fh$0x#1|))
)))
...
(assert (forall ((ReadsGenerics.Cl$A@@2 T@U) (ReadsGenerics.Cl.g$B@@0 T@U) ($ly@@0 T@U) ($Heap T@U) (this T@U) (|a#0| T@U) (|b#0| T@U) ) (! (= (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@2 ReadsGenerics.Cl.g$B@@0 ($LS $ly@@0) $Heap this |a#0| |b#0|) (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@2 ReadsGenerics.Cl.g$B@@0 $ly@@0 $Heap this |a#0| |b#0|))
 :qid |unknown.0:0|
 :skolemid |2256|
 :pattern ( (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@2 ReadsGenerics.Cl.g$B@@0 ($LS $ly@@0) $Heap this |a#0| |b#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsGenerics.Cl$A@@3 T@U) (ReadsGenerics.Cl.g$B@@1 T@U) ($ly@@1 T@U) ($Heap@@0 T@U) (this@@0 T@U) (|a#0@@0| T@U) (|b#0@@0| T@U) ) (!  (=> (or (|ReadsGenerics.Cl.g#canCall| ReadsGenerics.Cl$A@@3 ReadsGenerics.Cl.g$B@@1 $Heap@@0 this@@0 |a#0@@0| |b#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@0) (or (not (= this@@0 null)) (not true))) ($IsAlloc refType this@@0 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@3) $Heap@@0)) (and ($IsBox |a#0@@0| ReadsGenerics.Cl$A@@3) ($IsAllocBox |a#0@@0| ReadsGenerics.Cl$A@@3 $Heap@@0))) (and ($IsBox |b#0@@0| ReadsGenerics.Cl.g$B@@1) ($IsAllocBox |b#0@@0| ReadsGenerics.Cl.g$B@@1 $Heap@@0))))) ($IsAlloc DatatypeTypeType (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@3 ReadsGenerics.Cl.g$B@@1 $ly@@1 $Heap@@0 this@@0 |a#0@@0| |b#0@@0|) (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@3 ReadsGenerics.Cl.g$B@@1) $Heap@@0))
 :qid |unknown.0:0|
 :skolemid |2266|
 :pattern ( ($IsAlloc DatatypeTypeType (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@3 ReadsGenerics.Cl.g$B@@1 $ly@@1 $Heap@@0 this@@0 |a#0@@0| |b#0@@0|) (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@3 ReadsGenerics.Cl.g$B@@1) $Heap@@0))
))))
...
(assert (forall ((ReadsGenerics.Cl$A@@5 T@U) (ReadsGenerics.Cl.g$B@@2 T@U) ($ly@@2 T@U) ($self@@0 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) (|$fh$0x#1@@0| T@U) ) (! (= (Requires2 ReadsGenerics.Cl$A@@5 ReadsGenerics.Cl.g$B@@2 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@5 ReadsGenerics.Cl.g$B@@2) $heap@@0 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@5 ReadsGenerics.Cl.g$B@@2 $ly@@2 $self@@0) |$fh$0x#0@@0| |$fh$0x#1@@0|) (|ReadsGenerics.Cl.g#requires| ReadsGenerics.Cl$A@@5 ReadsGenerics.Cl.g$B@@2 $ly@@2 $heap@@0 $self@@0 |$fh$0x#0@@0| |$fh$0x#1@@0|))
 :qid |unknown.0:0|
 :skolemid |2260|
 :pattern ( (Requires2 ReadsGenerics.Cl$A@@5 ReadsGenerics.Cl.g$B@@2 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@5 ReadsGenerics.Cl.g$B@@2) $heap@@0 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@5 ReadsGenerics.Cl.g$B@@2 $ly@@2 $self@@0) |$fh$0x#0@@0| |$fh$0x#1@@0|))
)))
...
(assert (forall (($bx T@U) (ReadsGenerics.Cl$A@@8 T@U) (ReadsGenerics.Cl.g$B@@3 T@U) ($ly@@3 T@U) ($self@@1 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) (|$fh$0x#1@@1| T@U) ) (! (= (|Set#IsMember| (Reads2 ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3) $heap@@1 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3 $ly@@3 $self@@1) |$fh$0x#0@@1| |$fh$0x#1@@1|) $bx) (|Set#IsMember| (Reads2 ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3) $heap@@1 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3 ($LS $LZ) $self@@1) |$fh$0x#0@@1| |$fh$0x#1@@1|) $bx))
 :qid |unknown.0:0|
 :skolemid |2261|
 :pattern ( (|Set#IsMember| (Reads2 ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3) $heap@@1 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@8 ReadsGenerics.Cl.g$B@@3 $ly@@3 $self@@1) |$fh$0x#0@@1| |$fh$0x#1@@1|) $bx))
)))
(assert (forall ((ReadsGenerics.Cl$A@@9 T@U) (ReadsGenerics.Cl.g$B@@4 T@U) ($ly@@4 T@U) (this@@1 T@U) ) (! (= (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@9 ReadsGenerics.Cl.g$B@@4 ($LS $ly@@4) this@@1) (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@9 ReadsGenerics.Cl.g$B@@4 $ly@@4 this@@1))
 :qid |unknown.0:0|
 :skolemid |2258|
 :pattern ( (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@9 ReadsGenerics.Cl.g$B@@4 ($LS $ly@@4) this@@1))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsGenerics.Cl$A@@11 T@U) (ReadsGenerics.Cl.g$B@@5 T@U) ($ly@@5 T@U) ($Heap@@1 T@U) (this@@2 T@U) (|a#0@@1| T@U) (|b#0@@1| T@U) ) (!  (=> (or (|ReadsGenerics.Cl.g#canCall| ReadsGenerics.Cl$A@@11 ReadsGenerics.Cl.g$B@@5 $Heap@@1 this@@2 |a#0@@1| |b#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@11)) ($IsAlloc refType this@@2 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@11) $Heap@@1)))) ($IsBox |a#0@@1| ReadsGenerics.Cl$A@@11)) ($IsBox |b#0@@1| ReadsGenerics.Cl.g$B@@5)))) (= (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@11 ReadsGenerics.Cl.g$B@@5 ($LS $ly@@5) $Heap@@1 this@@2 |a#0@@1| |b#0@@1|) (|#_System._tuple#2._#Make2| |a#0@@1| |b#0@@1|)))
 :qid |unknown.0:0|
 :skolemid |2268|
 :pattern ( (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@11 ReadsGenerics.Cl.g$B@@5 ($LS $ly@@5) $Heap@@1 this@@2 |a#0@@1| |b#0@@1|) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((ReadsGenerics.Cl$A@@12 T@U) (ReadsGenerics.Cl.g$B@@6 T@U) ($ly@@6 T@U) ($self@@2 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) (|$fh$0x#1@@2| T@U) ) (! (= (Apply2 ReadsGenerics.Cl$A@@12 ReadsGenerics.Cl.g$B@@6 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@12 ReadsGenerics.Cl.g$B@@6) $heap@@2 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@12 ReadsGenerics.Cl.g$B@@6 $ly@@6 $self@@2) |$fh$0x#0@@2| |$fh$0x#1@@2|) ($Box DatatypeTypeType (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@12 ReadsGenerics.Cl.g$B@@6 $ly@@6 $heap@@2 $self@@2 |$fh$0x#0@@2| |$fh$0x#1@@2|)))
 :qid |unknown.0:0|
 :skolemid |2259|
 :pattern ( (Apply2 ReadsGenerics.Cl$A@@12 ReadsGenerics.Cl.g$B@@6 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@12 ReadsGenerics.Cl.g$B@@6) $heap@@2 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@12 ReadsGenerics.Cl.g$B@@6 $ly@@6 $self@@2) |$fh$0x#0@@2| |$fh$0x#1@@2|))
)))
...
(assert (forall ((ReadsGenerics.Cl$A@@17 T@U) (ReadsGenerics.Cl.g$B@@7 T@U) ($ly@@7 T@U) ($Heap@@2 T@U) (this@@3 T@U) (|a#0@@2| T@U) (|b#0@@2| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@17)) ($IsAlloc refType this@@3 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@17) $Heap@@2)))) ($IsBox |a#0@@2| ReadsGenerics.Cl$A@@17)) ($IsBox |b#0@@2| ReadsGenerics.Cl.g$B@@7)) (= (|ReadsGenerics.Cl.g#requires| ReadsGenerics.Cl$A@@17 ReadsGenerics.Cl.g$B@@7 $ly@@7 $Heap@@2 this@@3 |a#0@@2| |b#0@@2|) true))
 :qid |unknown.0:0|
 :skolemid |2267|
 :pattern ( (|ReadsGenerics.Cl.g#requires| ReadsGenerics.Cl$A@@17 ReadsGenerics.Cl.g$B@@7 $ly@@7 $Heap@@2 this@@3 |a#0@@2| |b#0@@2|) ($IsGoodHeap $Heap@@2))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsGenerics.Cl$A@@18 T@U) (ReadsGenerics.Cl.g$B@@8 T@U) ($ly@@8 T@U) ($Heap@@3 T@U) (this@@4 T@U) (|a#0@@3| T@U) (|b#0@@3| T@U) ) (!  (=> (or (|ReadsGenerics.Cl.g#canCall| ReadsGenerics.Cl$A@@18 ReadsGenerics.Cl.g$B@@8 $Heap@@3 this@@4 |a#0@@3| |b#0@@3|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@18)) ($IsAlloc refType this@@4 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@18) $Heap@@3)))) (and ($IsBox |a#0@@3| ReadsGenerics.Cl$A@@18) ($IsAllocBox |a#0@@3| ReadsGenerics.Cl$A@@18 $Heap@@3))) (and ($IsBox |b#0@@3| ReadsGenerics.Cl.g$B@@8) ($IsAllocBox |b#0@@3| ReadsGenerics.Cl.g$B@@8 $Heap@@3))))) ($Is DatatypeTypeType (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@18 ReadsGenerics.Cl.g$B@@8 $ly@@8 $Heap@@3 this@@4 |a#0@@3| |b#0@@3|) (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@18 ReadsGenerics.Cl.g$B@@8)))
 :qid |unknown.0:0|
 :skolemid |2265|
 :pattern ( (ReadsGenerics.Cl.g ReadsGenerics.Cl$A@@18 ReadsGenerics.Cl.g$B@@8 $ly@@8 $Heap@@3 this@@4 |a#0@@3| |b#0@@3|))
))))
...
(declare-fun ReadsGenerics.Cl.g$B@@9 () T@U)
(declare-fun this@@5 () T@U)
(declare-fun |a#0@@4| () T@U)
(declare-fun |b#0@@4| () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$ReadsGenerics.Cl.g)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@4 alloc (Reads2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9) $Heap@@4 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 ($LS $LZ) this@@5) |a#0@@4| |b#0@@4|))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> ($IsAllocBox ($Box HandleTypeType (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 ($LS $LZ) this@@5)) (Tclass._System.___hFunc2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9)) $Heap@@4) (=> (and ($IsAllocBox |a#0@@4| ReadsGenerics.Cl$A@@19 $Heap@@4) ($IsAllocBox |b#0@@4| ReadsGenerics.Cl.g$B@@9 $Heap@@4)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (Requires2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9) $Heap@@4 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 ($LS $LZ) this@@5) |a#0@@4| |b#0@@4|)) (=> (Requires2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9) $Heap@@4 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 ($LS $LZ) this@@5) |a#0@@4| |b#0@@4|) (=> (= |b$reqreads#0@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@2) alloc)))) (|Set#IsMember| (Reads2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9) $Heap@@4 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 ($LS $LZ) this@@5) |a#0@@4| |b#0@@4|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |Nakeddfy.60:17|
 :skolemid |2269|
))) (and (=> (= (ControlFlow 0 3) (- 0 6)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> ($IsAllocBox ($Box HandleTypeType (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 ($LS $LZ) this@@5)) (Tclass._System.___hFunc2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9)) $Heap@@4) (=> (and ($IsAllocBox |a#0@@4| ReadsGenerics.Cl$A@@19 $Heap@@4) ($IsAllocBox |b#0@@4| ReadsGenerics.Cl.g$B@@9 $Heap@@4)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9) $Heap@@4 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 ($LS $LZ) this@@5) |a#0@@4| |b#0@@4|)) (=> (Requires2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9) $Heap@@4 (|ReadsGenerics.Cl.g#Handle| ReadsGenerics.Cl$A@@19 ReadsGenerics.Cl.g$B@@9 ($LS $LZ) this@@5) |a#0@@4| |b#0@@4|) (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@19)) ($IsAlloc refType this@@5 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@19) $Heap@@4)))) (and (and ($IsBox |a#0@@4| ReadsGenerics.Cl$A@@19) ($IsBox |b#0@@4| ReadsGenerics.Cl.g$B@@9)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 3)))) anon0_correct)))
