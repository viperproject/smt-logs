...
(assert (distinct alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 Tagclass._module.Nat |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| tytagFamily$Nat)
)
(assert (forall ((|x#0| T@U) ($h T@U) ) (! ($IsAlloc intType |x#0| Tclass._module.Nat $h)
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( ($IsAlloc intType |x#0| Tclass._module.Nat $h))
)))
...
(assert (forall ((|x#0@@0| T@U) ) (! (= ($Is intType |x#0@@0| Tclass._module.Nat) (<= (LitInt 0) (U_2_int |x#0@@0|)))
 :qid |unknown.0:0|
 :skolemid |483|
 :pattern ( ($Is intType |x#0@@0| Tclass._module.Nat))
)))
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.Nat) (and (= ($Box intType ($Unbox intType bx@@1)) bx@@1) ($Is intType ($Unbox intType bx@@1) Tclass._module.Nat)))
 :qid |unknown.0:0|
 :skolemid |482|
...
(set-info :boogie-vc-id Impl$$_module.__default.Check)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($Is HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($IsAlloc HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat) $Heap)) (and ($IsAllocBox ($Box HandleTypeType |f#0@0|) (Tclass._System.___hFunc1 Tclass._module.Nat Tclass._module.Nat) $Heap) (= |newtype$check#0@0| (LitInt 0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (= |##x0#0@0| (LitInt 0)) (=> (and (and ($IsAlloc intType (int_2_U |##x0#0@0|) Tclass._module.Nat $Heap) (Requires1 Tclass._module.Nat Tclass._module.Nat $Heap |f#0@0| ($Box intType (int_2_U (LitInt 0))))) (and (= |newtype$check#1@0| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 0) |newtype$check#1@0|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._module.Nat Tclass._module.Nat) $Heap)) true) (and (and (<= (LitInt 0) |i#0|) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
