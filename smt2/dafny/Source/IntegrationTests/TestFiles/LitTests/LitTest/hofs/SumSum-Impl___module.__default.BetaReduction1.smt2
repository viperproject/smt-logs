...
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| T@U) (|l#4@@0| T@U) (|l#5| Int) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|l#11| T@U) (|l#12| T@U) (|l#13| T@U) (|$l#21#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#692| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10| |l#11| |l#12| |l#13|) |$l#21#ly#0|) (Handle1 (|lambda#688| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0| |$l#21#ly#0| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10| |l#11| |$l#21#ly#0|) |l#12| |l#13|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |695|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#692| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10| |l#11| |l#12| |l#13|) |$l#21#ly#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@1| T@U) (|l#2@@1| T@U) (|l#3@@1| T@U) (|l#4@@1| T@U) (|l#5@@0| T@U) (|l#6@@0| Int) (|l#7@@0| T@U) (|l#8@@0| T@U) (|l#9@@0| T@U) (|l#10@@0| T@U) (|l#11@@0| T@U) (|l#12@@0| T@U) (|l#13@@0| T@U) (|$l#21#heap#0| T@U) (|$l#21#x#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#688| |l#0@@2| |l#1@@1| |l#2@@1| |l#3@@1| |l#4@@1| |l#5@@0| |l#6@@0| |l#7@@0| |l#8@@0| |l#9@@0| |l#10@@0| |l#11@@0| |l#12@@0| |l#13@@0|) |$l#21#heap#0| |$l#21#x#0|) ($Box intType (int_2_U (+ (U_2_int ($Unbox intType (Apply2 |l#0@@2| |l#1@@1| |l#2@@1| |$l#21#heap#0| |l#3@@1| ($Box intType ($Unbox intType |$l#21#x#0|)) |l#4@@1|))) (_module.__default.Sum |l#5@@0| |l#6@@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| |l#7@@0| |l#8@@0| |l#9@@0| |l#10@@0| ($Box intType ($Unbox intType |$l#21#x#0|))) |l#11@@0| |l#12@@0|)) |l#13@@0|)))))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |694|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#688| |l#0@@2| |l#1@@1| |l#2@@1| |l#3@@1| |l#4@@1| |l#5@@0| |l#6@@0| |l#7@@0| |l#8@@0| |l#9@@0| |l#10@@0| |l#11@@0| |l#12@@0| |l#13@@0|) |$l#21#heap#0| |$l#21#x#0|))
)))
...
(declare-fun |n'#0| () Int)
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.BetaReduction1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and (forall ((|$ih#n'0#0| T@U) ) (!  (=> (and (and (<= (LitInt 0) (U_2_int |$ih#n'0#0|)) (U_2_bool (Lit boolType (bool_2_U true)))) (or (and (<= 0 (U_2_int |$ih#n'0#0|)) (< (U_2_int |$ih#n'0#0|) |n'#0|)) (and (= (U_2_int |$ih#n'0#0|) |n'#0|) (and (<= 0 |i#0|) (< |i#0| |i#0|))))) (= (+ (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $Heap@0 |g#0| ($Box intType (int_2_U |i#0|)) ($Box intType |$ih#n'0#0|)))) (_module.__default.Sum ($LS $LZ) (U_2_int |$ih#n'0#0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType (int_2_U |i#0|))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#692| TInt TInt TInt |g#0| ($Box intType |$ih#n'0#0|) (U_2_int |$ih#n'0#0|) TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0|)))))))
 :qid |SumSumdfy.68:22|
 :skolemid |575|
 :pattern ( ($Unbox intType (Apply2 TInt TInt TInt $Heap@0 |g#0| ($Box intType (int_2_U |i#0|)) ($Box intType |$ih#n'0#0|))))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (+ (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $Heap@0 |g#0| ($Box intType (int_2_U |i#0|)) ($Box intType (int_2_U |n'#0|))))) (_module.__default.Sum ($LS ($LS $LZ)) |n'#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType (int_2_U |i#0|))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#692| TInt TInt TInt |g#0| ($Box intType (int_2_U |n'#0|)) |n'#0| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))) ($Box intType (int_2_U |i#0|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (<= (LitInt 0) |n'#0|)) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc2 TInt TInt TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
