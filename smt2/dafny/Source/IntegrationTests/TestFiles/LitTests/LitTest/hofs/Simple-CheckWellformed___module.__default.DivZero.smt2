...
(declare-fun |_module.__default.DivZero#canCall| () Bool)
(declare-fun _module.__default.DivZero () T@U)
...
(assert (forall ((|l#0@@0| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#z#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#20| |l#0@@0|) |$l#0#heap#0@@0| |$l#0#z#0|) ($Box intType (int_2_U (Div |l#0@@0| (U_2_int ($Unbox intType |$l#0#z#0|))))))
 :qid |unknown.0:0|
 :skolemid |611|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#20| |l#0@@0|) |$l#0#heap#0@@0| |$l#0#z#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZero#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.DivZero (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#20| 5) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZero#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.DivZero (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#20| 5) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZero#canCall| (< 0 $FunctionContextHeight)) ($Is HandleTypeType _module.__default.DivZero (Tclass._System.___hFunc1 TInt TInt)))))
...
(assert (forall ((|l#0@@3| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#30| |l#0@@3| |l#1| |l#2| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@0) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |612|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#30| |l#0@@3| |l#1| |l#2| |l#3|) $o@@0 $f))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.DivZero)
...
(let ((anon11_Then_correct  (=> (and (= |$_Frame#l0@0| (|lambda#30| null |$lambdaHeap#0@0| alloc false)) (= (ControlFlow 0 4) (- 0 3))) (or (not (= |z#0@0| 0)) (not true)))))
