...
(declare-fun ReadsRequiresReads.__default.MyReadsBad2 (T@U T@U T@U T@U) T@U)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun HandleTypeType () T@T)
(declare-fun BoxType () T@T)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |ReadsRequiresReads.__default.MyReadsBad2#canCall| (T@U T@U T@U T@U) Bool)
...
(assert  (and (= (Ctor HandleTypeType) 3) (= (Ctor BoxType) 4)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyReadsBad2$A T@U) (ReadsRequiresReads._default.MyReadsBad2$B T@U) ($Heap T@U) (|f#0| T@U) (|a#0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsBad2#canCall| ReadsRequiresReads._default.MyReadsBad2$A ReadsRequiresReads._default.MyReadsBad2$B (Lit HandleTypeType |f#0|) (Lit BoxType |a#0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsBad2$A ReadsRequiresReads._default.MyReadsBad2$B))) ($IsBox |a#0| ReadsRequiresReads._default.MyReadsBad2$A)))) (= (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A ReadsRequiresReads._default.MyReadsBad2$B (Lit HandleTypeType |f#0|) (Lit BoxType |a#0|)) (Reads1 ReadsRequiresReads._default.MyReadsBad2$A ReadsRequiresReads._default.MyReadsBad2$B $Heap (Lit HandleTypeType |f#0|) (Lit BoxType |a#0|))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |692|
 :pattern ( (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A ReadsRequiresReads._default.MyReadsBad2$B (Lit HandleTypeType |f#0|) (Lit BoxType |a#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (and (and (and (and (and (forall ((t0@@0 T@T) (t1@@0 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0@@0 t1@@0 (MapType0Store t0@@0 t1@@0 m x0 val) x0) val)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyReadsBad2$A@@0 T@U) (ReadsRequiresReads._default.MyReadsBad2$B@@0 T@U) ($Heap@@0 T@U) (|f#0@@0| T@U) (|a#0@@0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsBad2#canCall| ReadsRequiresReads._default.MyReadsBad2$A@@0 ReadsRequiresReads._default.MyReadsBad2$B@@0 |f#0@@0| |a#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsBad2$A@@0 ReadsRequiresReads._default.MyReadsBad2$B@@0))) ($IsBox |a#0@@0| ReadsRequiresReads._default.MyReadsBad2$A@@0)))) (= (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A@@0 ReadsRequiresReads._default.MyReadsBad2$B@@0 |f#0@@0| |a#0@@0|) (Reads1 ReadsRequiresReads._default.MyReadsBad2$A@@0 ReadsRequiresReads._default.MyReadsBad2$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|)))
 :qid |unknown.0:0|
 :skolemid |691|
 :pattern ( (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A@@0 ReadsRequiresReads._default.MyReadsBad2$B@@0 |f#0@@0| |a#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (ReadsRequiresReads._default.MyReadsBad2$A@@1 T@U) (ReadsRequiresReads._default.MyReadsBad2$B@@1 T@U) (|f#0@@1| T@U) (|a#0@@1| T@U) ) (!  (=> (and (or (|ReadsRequiresReads.__default.MyReadsBad2#canCall| ReadsRequiresReads._default.MyReadsBad2$A@@1 ReadsRequiresReads._default.MyReadsBad2$B@@1 |f#0@@1| |a#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($Is HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsBad2$A@@1 ReadsRequiresReads._default.MyReadsBad2$B@@1)) ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsBad2$A@@1 ReadsRequiresReads._default.MyReadsBad2$B@@1) $Heap@@1)) (and ($IsBox |a#0@@1| ReadsRequiresReads._default.MyReadsBad2$A@@1) ($IsAllocBox |a#0@@1| ReadsRequiresReads._default.MyReadsBad2$A@@1 $Heap@@1))))) ($IsGoodHeap $Heap@@1)) ($IsAlloc SetType (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A@@1 ReadsRequiresReads._default.MyReadsBad2$B@@1 |f#0@@1| |a#0@@1|) (TSet Tclass._System.object?) $Heap@@1))
 :qid |ReadsReadsdfy.38:18|
 :skolemid |689|
 :pattern ( ($IsAlloc SetType (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A@@1 ReadsRequiresReads._default.MyReadsBad2$B@@1 |f#0@@1| |a#0@@1|) (TSet Tclass._System.object?) $Heap@@1))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyReadsBad2$A@@2 T@U) (ReadsRequiresReads._default.MyReadsBad2$B@@2 T@U) (|f#0@@2| T@U) (|a#0@@2| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsBad2#canCall| ReadsRequiresReads._default.MyReadsBad2$A@@2 ReadsRequiresReads._default.MyReadsBad2$B@@2 |f#0@@2| |a#0@@2|) (and (< 0 $FunctionContextHeight) (and ($Is HandleTypeType |f#0@@2| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsBad2$A@@2 ReadsRequiresReads._default.MyReadsBad2$B@@2)) ($IsBox |a#0@@2| ReadsRequiresReads._default.MyReadsBad2$A@@2)))) ($Is SetType (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A@@2 ReadsRequiresReads._default.MyReadsBad2$B@@2 |f#0@@2| |a#0@@2|) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |688|
 :pattern ( (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A@@2 ReadsRequiresReads._default.MyReadsBad2$B@@2 |f#0@@2| |a#0@@2|))
))))
...
(declare-fun ReadsRequiresReads._default.MyReadsBad2$A@@3 () T@U)
(declare-fun $Heap@@2 () T@U)
(declare-fun ReadsRequiresReads._default.MyReadsBad2$B@@3 () T@U)
(declare-fun |f#0@@3| () T@U)
(declare-fun |a#0@@3| () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$ReadsRequiresReads.__default.MyReadsBad2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) true) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 ReadsRequiresReads._default.MyReadsBad2$A@@3 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| ReadsRequiresReads._default.MyReadsBad2$A@@3 ReadsRequiresReads._default.MyReadsBad2$B@@3 |f#0@@3|) |a#0@@3|)) (=> (Requires1 ReadsRequiresReads._default.MyReadsBad2$A@@3 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| ReadsRequiresReads._default.MyReadsBad2$A@@3 ReadsRequiresReads._default.MyReadsBad2$B@@3 |f#0@@3|) |a#0@@3|) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@2) alloc)))) (|Set#IsMember| (Reads1 ReadsRequiresReads._default.MyReadsBad2$A@@3 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| ReadsRequiresReads._default.MyReadsBad2$A@@3 ReadsRequiresReads._default.MyReadsBad2$B@@3 |f#0@@3|) |a#0@@3|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |ReadsReadsdfy.40:5|
 :skolemid |693|
))) (= (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A@@3 ReadsRequiresReads._default.MyReadsBad2$B@@3 |f#0@@3| |a#0@@3|) (Reads1 ReadsRequiresReads._default.MyReadsBad2$A@@3 ReadsRequiresReads._default.MyReadsBad2$B@@3 $Heap@@2 |f#0@@3| |a#0@@3|))) (and ($Is SetType (ReadsRequiresReads.__default.MyReadsBad2 ReadsRequiresReads._default.MyReadsBad2$A@@3 ReadsRequiresReads._default.MyReadsBad2$B@@3 |f#0@@3| |a#0@@3|) (TSet Tclass._System.object?)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsBad2$A@@3 ReadsRequiresReads._default.MyReadsBad2$B@@3)) ($IsBox |a#0@@3| ReadsRequiresReads._default.MyReadsBad2$A@@3)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
