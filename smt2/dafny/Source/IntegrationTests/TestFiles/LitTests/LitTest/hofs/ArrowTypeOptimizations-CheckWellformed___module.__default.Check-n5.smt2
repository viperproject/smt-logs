...
(declare-fun _module.__default.CheckReadsLambdaPartial (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.CheckReadsLambdaPartial#canCall| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|x#0| Int) ) (!  (=> (or (|_module.__default.CheckReadsLambdaPartial#canCall| |x#0|) (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap))) (= (_module.__default.CheckReadsLambdaPartial |x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt (U_2_bool (Lit boolType (bool_2_U true)))) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |x#0|)))))))
 :qid |ArrowTypeOptimizationsdfy.37:16|
 :skolemid |556|
 :pattern ( (_module.__default.CheckReadsLambdaPartial |x#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|x#0@@0| Int) ) (!  (=> (or (|_module.__default.CheckReadsLambdaPartial#canCall| (LitInt |x#0@@0|)) (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (= (_module.__default.CheckReadsLambdaPartial (LitInt |x#0@@0|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt (U_2_bool (Lit boolType (bool_2_U true)))) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U (LitInt |x#0@@0|))))))))
 :qid |ArrowTypeOptimizationsdfy.37:16|
 :weight 3
 :skolemid |557|
 :pattern ( (_module.__default.CheckReadsLambdaPartial (LitInt |x#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#6| |l#0|) |$l#0#o#0|)) |l#0|)
 :qid |unknown.0:0|
 :skolemid |565|
 :pattern ( (MapType1Select refType boolType (|lambda#6| |l#0|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@0| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#8| |l#0@@0|) |$l#0#ly#0|) |l#0@@0|)
 :qid |ArrowTypeOptimizationsdfy.34:4|
 :skolemid |567|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#8| |l#0@@0|) |$l#0#ly#0|))
)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@1| |l#1| |l#2| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@1|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@0) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |562|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@1| |l#1| |l#2| |l#3|) $o@@0 $f))
)))
...
(assert (forall ((|$l#0#heap#0| T@U) (|$l#0#y#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#4| |$l#0#heap#0| |$l#0#y#0|) ($Box intType ($Unbox intType |$l#0#y#0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |563|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#4| |$l#0#heap#0| |$l#0#y#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#y#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@2|) |$l#0#heap#0@@0| |$l#0#y#0@@0|) |l#0@@2|)
 :qid |ArrowTypeOptimizationsdfy.34:4|
 :skolemid |566|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@2|) |$l#0#heap#0@@0| |$l#0#y#0@@0|))
)))
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| Bool) (|$l#0#heap#0@@1| T@U) (|$l#0#y#0@@1| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#5| |l#0@@3| |l#1@@0|) |$l#0#heap#0@@1| |$l#0#y#0@@1|))  (and ($IsBox |$l#0#y#0@@1| |l#0@@3|) |l#1@@0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |564|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#5| |l#0@@3| |l#1@@0|) |$l#0#heap#0@@1| |$l#0#y#0@@1|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.CheckReadsLambdaPartial)
...
(let ((anon13_Else_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 7) 5)) anon7_correct)))
(let ((anon13_Then_correct  (=> (and (and (U_2_bool (Lit boolType (bool_2_U true))) (= |lambdaResult#0| |y#0@0|)) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 6) 5))) anon7_correct)))
(let ((anon12_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 8) 6) anon13_Then_correct) (=> (= (ControlFlow 0 8) 7) anon13_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 9) 8) anon12_Then_correct) (=> (= (ControlFlow 0 9) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (Requires1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#5| TInt (U_2_bool (Lit boolType (bool_2_U true)))) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |x#0@@1|))))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 10) 9) anon11_Then_correct) (=> (= (ControlFlow 0 10) 3) anon11_Else_correct))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 12) 1) anon10_Then_correct) (=> (= (ControlFlow 0 12) 10) anon10_Else_correct)))))
