...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (Requires1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 0)))) (=> (= |init#0@0| (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 0))))))) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.C?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 TInt TInt $Heap@0 |f#0| ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TInt $Heap@0 |f#0| ($Box intType (int_2_U (LitInt 0)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= |init#0@0| (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@0 |f#0| ($Box intType (int_2_U (LitInt 0))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TInt) $Heap))) (=> (and (and (and (=> |defass#o#0| (and ($Is refType |o#0| Tclass._module.C) ($IsAlloc refType |o#0| Tclass._module.C $Heap))) true) (= 1 $FunctionContextHeight)) (and (Requires1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 0)))) (= (ControlFlow 0 5) 2))) anon0_correct))))
