...
(declare-fun _module.__default.CheckReadsLambdaTotal (Int) Int)
(declare-fun |_module.__default.CheckReadsLambdaTotal#canCall| (Int) Bool)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#y#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#49| |l#0|) |$l#0#heap#0| |$l#0#y#0|)) ($IsBox |$l#0#y#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |568|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#49| |l#0|) |$l#0#heap#0| |$l#0#y#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|x#0| Int) ) (!  (=> (or (|_module.__default.CheckReadsLambdaTotal#canCall| |x#0|) (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap))) (= (_module.__default.CheckReadsLambdaTotal |x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#49| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |x#0|)))))))
 :qid |ArrowTypeOptimizationsdfy.43:16|
 :skolemid |560|
 :pattern ( (_module.__default.CheckReadsLambdaTotal |x#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#y#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#4| |$l#0#heap#0@@0| |$l#0#y#0@@0|) ($Box intType ($Unbox intType |$l#0#y#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |563|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#4| |$l#0#heap#0@@0| |$l#0#y#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|x#0@@0| Int) ) (!  (=> (or (|_module.__default.CheckReadsLambdaTotal#canCall| (LitInt |x#0@@0|)) (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (= (_module.__default.CheckReadsLambdaTotal (LitInt |x#0@@0|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 |lambda#4| (|lambda#49| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U (LitInt |x#0@@0|))))))))
 :qid |ArrowTypeOptimizationsdfy.43:16|
 :weight 3
 :skolemid |561|
 :pattern ( (_module.__default.CheckReadsLambdaTotal (LitInt |x#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#y#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#y#0@@1|) |l#0@@3|)
 :qid |ArrowTypeOptimizationsdfy.34:4|
 :skolemid |566|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#y#0@@1|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.CheckReadsLambdaTotal)
...
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 5) 3) anon11_Then_correct) (=> (= (ControlFlow 0 5) 4) anon11_Else_correct)))))
(let ((anon10_Else_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 6) 5) anon10_Then_correct) (=> (= (ControlFlow 0 6) 2) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 8) 1) anon9_Then_correct) (=> (= (ControlFlow 0 8) 6) anon9_Else_correct)))))
