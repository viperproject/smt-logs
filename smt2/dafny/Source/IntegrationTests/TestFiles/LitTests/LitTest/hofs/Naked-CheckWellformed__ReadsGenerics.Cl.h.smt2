...
(declare-fun ReadsGenerics.Cl.h$B@@3 () T@U)
(declare-fun $LZ () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$ReadsGenerics.Cl.h)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@7 alloc (Reads2 ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3) $Heap@@7 (|ReadsGenerics.Cl.g2#Handle| ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3 ($LS $LZ) this@@10) |a#0@@9| |b#0@@9|))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (and ($IsAllocBox ($Box HandleTypeType (|ReadsGenerics.Cl.g2#Handle| ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3 ($LS $LZ) this@@10)) (Tclass._System.___hFunc2 ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3)) $Heap@@7) ($IsAllocBox |a#0@@9| ReadsGenerics.Cl$A@@24 $Heap@@7)) (and ($IsAllocBox |b#0@@9| ReadsGenerics.Cl.h$B@@3 $Heap@@7) (= |b$reqreads#0@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@2) alloc)))) (|Set#IsMember| (Reads2 ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3) $Heap@@7 (|ReadsGenerics.Cl.g2#Handle| ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3 ($LS $LZ) this@@10) |a#0@@9| |b#0@@9|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |Nakeddfy.67:16|
 :skolemid |2291|
))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> ($IsAllocBox ($Box HandleTypeType (|ReadsGenerics.Cl.g2#Handle| ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3 ($LS $LZ) this@@10)) (Tclass._System.___hFunc2 ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3 (Tclass._System.Tuple2 ReadsGenerics.Cl$A@@24 ReadsGenerics.Cl.h$B@@3)) $Heap@@7) (=> (and ($IsAllocBox |a#0@@9| ReadsGenerics.Cl$A@@24 $Heap@@7) ($IsAllocBox |b#0@@9| ReadsGenerics.Cl.h$B@@3 $Heap@@7)) (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@24)) ($IsAlloc refType this@@10 (Tclass.ReadsGenerics.Cl ReadsGenerics.Cl$A@@24) $Heap@@7)))) (and (and ($IsBox |a#0@@9| ReadsGenerics.Cl$A@@24) ($IsBox |b#0@@9| ReadsGenerics.Cl.h$B@@3)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 3)))) anon0_correct)))
