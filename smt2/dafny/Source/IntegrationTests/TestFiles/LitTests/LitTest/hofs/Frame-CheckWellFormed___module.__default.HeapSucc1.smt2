...
(assert (distinct TInt TagInt alloc Tagclass._System.___hFunc1 Tagclass._module.C Tagclass._module.C? |tytagFamily$_#Func1| tytagFamily$C)
)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.HeapSucc1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#7| null $Heap alloc |c#0@@1|)) (=> (and (and (and ($IsAllocBox ($Box HandleTypeType |k#0|) (Tclass._System.___hFunc1 TInt TInt) $Heap) (= |##x0#0@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##x0#0@0|) TInt $Heap) (Requires1 TInt TInt $Heap |k#0| ($Box intType (int_2_U (LitInt 0)))))) (and (and ($IsAllocBox ($Box HandleTypeType |k#0|) (Tclass._System.___hFunc1 TInt TInt) $Heap) (= |##x0#1@0| (LitInt 0))) (and ($IsAlloc intType (int_2_U |##x0#1@0|) TInt $Heap) (= (ControlFlow 0 2) (- 0 1))))) (Requires1 TInt TInt $Heap |k#0| ($Box intType (int_2_U (LitInt 0))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |k#0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |k#0| (Tclass._System.___hFunc1 TInt TInt) $Heap))) (and (and ($Is refType |c#0@@1| Tclass._module.C?) ($IsAlloc refType |c#0@@1| Tclass._module.C? $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
