...
(assert (distinct TBool TagBool TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1|)
)
...
(assert (forall ((|l#0@@2| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#61| |l#0@@2| |l#1| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@1) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |505|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#61| |l#0@@2| |l#1| |l#2| |l#3|) $o@@1 $f))
)))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#0| |$l#0#heap#0@@0| |$l#0#x#0@@0|) ($Box boolType ($Unbox boolType |$l#0#x#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |499|
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#x#0@@1|) |l#0@@3|)
 :qid |Renamingdfy.4:17|
 :skolemid |502|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#x#0@@1|))
)))
...
(declare-fun |id2#0@0| () T@U)
(declare-fun |id1#0@0| () T@U)
(declare-fun $LZ () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Equal)
...
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 12) 10) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct)))))
(let ((anon14_Else_correct true))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap |$lambdaHeap#1@0|) ($HeapSucc $Heap |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 8) 6) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon14_Else_correct)))))
(let ((anon15_Else_correct true))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|x#2| Bool) ) (! (= (U_2_bool ($Unbox boolType (Apply1 TBool TBool $Heap |id1#0@0| ($Box boolType (bool_2_U |x#2|))))) (U_2_bool ($Unbox boolType (Apply1 TBool TBool $Heap |id2#0@0| ($Box boolType (bool_2_U |x#2|))))))
 :qid |Renamingdfy.13:17|
 :skolemid |490|
 :pattern ( ($Unbox boolType (Apply1 TBool TBool $Heap |id2#0@0| ($Box boolType (bool_2_U |x#2|)))))
 :pattern ( ($Unbox boolType (Apply1 TBool TBool $Heap |id1#0@0| ($Box boolType (bool_2_U |x#2|)))))
))) (=> (forall ((|x#2@@0| T@U) ) (! (= (U_2_bool ($Unbox boolType (Apply1 TBool TBool $Heap |id1#0@0| ($Box boolType |x#2@@0|)))) (U_2_bool ($Unbox boolType (Apply1 TBool TBool $Heap |id2#0@0| ($Box boolType |x#2@@0|)))))
 :qid |Renamingdfy.13:17|
 :skolemid |490|
 :pattern ( ($Unbox boolType (Apply1 TBool TBool $Heap |id2#0@0| ($Box boolType |x#2@@0|))))
 :pattern ( ($Unbox boolType (Apply1 TBool TBool $Heap |id1#0@0| ($Box boolType |x#2@@0|))))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (= |id1#0@0| |id2#0@0|))))))
(let ((anon13_Else_correct  (=> (= |id2#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 5) 2) anon15_Then_correct) (=> (= (ControlFlow 0 5) 4) anon15_Else_correct)))))
(let ((anon11_Else_correct  (=> (= |id1#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 9) 8) anon13_Then_correct) (=> (= (ControlFlow 0 9) 5) anon13_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#61| null $Heap alloc false)) (and (=> (= (ControlFlow 0 13) 12) anon11_Then_correct) (=> (= (ControlFlow 0 13) 9) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is HandleTypeType |id1#0| (Tclass._System.___hTotalFunc1 TBool TBool)) ($IsAlloc HandleTypeType |id1#0| (Tclass._System.___hTotalFunc1 TBool TBool) $Heap)) true) (=> (and (and (and ($Is HandleTypeType |id2#0| (Tclass._System.___hTotalFunc1 TBool TBool)) ($IsAlloc HandleTypeType |id2#0| (Tclass._System.___hTotalFunc1 TBool TBool) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))))
