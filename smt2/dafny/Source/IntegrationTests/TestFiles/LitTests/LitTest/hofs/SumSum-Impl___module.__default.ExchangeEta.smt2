...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|$l#9#heap#0@@0| T@U) (|$l#9#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@3| |l#1@@0| |l#2@@0|) |$l#9#heap#0@@0| |$l#9#x#0@@0|) ($Box intType ($Unbox intType (Apply1 |l#0@@3| |l#1@@0| |$l#9#heap#0@@0| |l#2@@0| ($Box intType ($Unbox intType |$l#9#x#0@@0|))))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |684|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@3| |l#1@@0| |l#2@@0|) |$l#9#heap#0@@0| |$l#9#x#0@@0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#9#heap#0@@1| T@U) (|$l#9#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#9#heap#0@@1| |$l#9#x#0@@1|) |l#0@@4|)
 :qid |SumSumdfy.21:18|
 :skolemid |687|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@4|) |$l#9#heap#0@@1| |$l#9#x#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.ExchangeEta)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (_module.__default.Sum ($LS ($LS $LZ)) |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| TInt TInt |f#0@@7|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (_module.__default.Sum ($LS ($LS $LZ)) |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| TInt TInt |g#0|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))))))
(let ((anon3_Else_correct  (=> (and (= |n#0@@3| 0) (= (ControlFlow 0 8) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (or (not (= |n#0@@3| 0)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (= |n##0_0@0| (- |n#0@@3| 1)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (<= 0 |n#0@@3|) (= |n##0_0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |n##0_0@0| |n#0@@3|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (< |n##0_0@0| |n#0@@3|)) (=> (< |n##0_0@0| |n#0@@3|) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| |n##0_0@0|)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@7| ($Box intType (int_2_U |i#1|))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g#0| ($Box intType (int_2_U |i#1|)))))))
 :qid |SumSumdfy.20:19|
 :skolemid |542|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g#0| ($Box intType (int_2_U |i#1|)))))
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@7| ($Box intType (int_2_U |i#1|)))))
))) (=> (forall ((|i#1@@0| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |i#1@@0|)) (< (U_2_int |i#1@@0|) |n##0_0@0|)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@7| ($Box intType |i#1@@0|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g#0| ($Box intType |i#1@@0|))))))
 :qid |SumSumdfy.20:19|
 :skolemid |542|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g#0| ($Box intType |i#1@@0|))))
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@7| ($Box intType |i#1@@0|))))
)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|_module.__default.Sum#canCall| |n##0_0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| TInt TInt |f#0@@7|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (|_module.__default.Sum#canCall| |n##0_0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| TInt TInt |g#0|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))) (= (_module.__default.Sum ($LS ($LS $LZ)) |n##0_0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| TInt TInt |f#0@@7|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (_module.__default.Sum ($LS ($LS $LZ)) |n##0_0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| TInt TInt |g#0|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))))) (and (= $Heap@@2 $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 9) 3) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (<= (LitInt 0) |n#0@@3|)) (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2))) (and (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap@@2)) (= 1 $FunctionContextHeight)) (and (forall ((|i#1@@1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |i#1@@1|)) (< (U_2_int |i#1@@1|) |n#0@@3|)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@7| ($Box intType |i#1@@1|)))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g#0| ($Box intType |i#1@@1|))))))
 :qid |SumSumdfy.20:19|
 :skolemid |543|
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |g#0| ($Box intType |i#1@@1|))))
 :pattern ( ($Unbox intType (Apply1 TInt TInt $Heap@@2 |f#0@@7| ($Box intType |i#1@@1|))))
