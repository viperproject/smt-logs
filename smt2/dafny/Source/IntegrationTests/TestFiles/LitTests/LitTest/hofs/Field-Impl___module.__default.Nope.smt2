...
(assert (distinct TBool TInt TagBool TagInt alloc allocName Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._module.Ref Tagclass._module.Ref? class._module.Ref? |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| tytagFamily$Ref field$val)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((_module.Ref$A T@U) ($h T@U) ($o T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (or (not (= $o null)) (not true)) (= (dtype $o) (Tclass._module.Ref? _module.Ref$A)))) ($IsBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) _module.Ref.val) _module.Ref$A))
 :qid |unknown.0:0|
 :skolemid |501|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) _module.Ref.val) (Tclass._module.Ref? _module.Ref$A))
)))
(assert (forall ((_module.Ref$A@@0 T@U) ($h@@0 T@U) ($o@@0 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@0) (and (or (not (= $o@@0 null)) (not true)) (= (dtype $o@@0) (Tclass._module.Ref? _module.Ref$A@@0)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) _module.Ref.val) _module.Ref$A@@0 $h@@0))
 :qid |unknown.0:0|
 :skolemid |502|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) _module.Ref.val) (Tclass._module.Ref? _module.Ref$A@@0))
)))
...
(assert (forall ((_module.Ref$A@@2 T@U) ($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 (Tclass._module.Ref? _module.Ref$A@@2) $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |500|
 :pattern ( ($IsAlloc refType $o@@1 (Tclass._module.Ref? _module.Ref$A@@2) $h@@2))
)))
...
(assert (forall ((_module.Ref$A@@3 T@U) (|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| (Tclass._module.Ref _module.Ref$A@@3))  (and ($Is refType |c#0@@0| (Tclass._module.Ref? _module.Ref$A@@3)) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($Is refType |c#0@@0| (Tclass._module.Ref _module.Ref$A@@3)))
 :pattern ( ($Is refType |c#0@@0| (Tclass._module.Ref? _module.Ref$A@@3)))
)))
...
(assert (forall ((_module.Ref$A@@6 T@U) ($o@@2 T@U) ) (! (= ($Is refType $o@@2 (Tclass._module.Ref? _module.Ref$A@@6))  (or (= $o@@2 null) (= (dtype $o@@2) (Tclass._module.Ref? _module.Ref$A@@6))))
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( ($Is refType $o@@2 (Tclass._module.Ref? _module.Ref$A@@6)))
)))
...
(assert (forall ((_module.Ref$A@@9 T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass._module.Ref _module.Ref$A@@9)) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) (Tclass._module.Ref _module.Ref$A@@9))))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( ($IsBox bx@@6 (Tclass._module.Ref _module.Ref$A@@9)))
)))
(assert (forall ((_module.Ref$A@@10 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._module.Ref? _module.Ref$A@@10)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass._module.Ref? _module.Ref$A@@10))))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( ($IsBox bx@@7 (Tclass._module.Ref? _module.Ref$A@@10)))
)))
...
(assert (forall ((h@@8 T@U) (v@@3 T@U) ) (! ($IsAlloc boolType v@@3 TBool h@@8)
 :qid |DafnyPreludebpl.291:14|
 :skolemid |63|
 :pattern ( ($IsAlloc boolType v@@3 TBool h@@8))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Nope)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._module.Ref? (Tclass._System.___hPartialFunc1 TInt TBool)))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= $nw@0 null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.Ref.val)) ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.Ref.val)) ($Box intType (int_2_U (LitInt 0)))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@0 ($Unbox HandleTypeType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.Ref.val)) ($Box intType (int_2_U (LitInt 0))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#f#0| (and ($Is refType |f#0@@1| (Tclass._module.Ref (Tclass._System.___hPartialFunc1 TInt TBool))) ($IsAlloc refType |f#0@@1| (Tclass._module.Ref (Tclass._System.___hPartialFunc1 TInt TBool)) $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
