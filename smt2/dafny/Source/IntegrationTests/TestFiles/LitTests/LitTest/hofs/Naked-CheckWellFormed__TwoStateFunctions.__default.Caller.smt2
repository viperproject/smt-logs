...
(assert (distinct TInt TagInt alloc allocName Tagclass.TwoStateFunctions.Cell Tagclass.TwoStateFunctions.Cell? class.TwoStateFunctions.Cell? tytagFamily$Cell field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($o@@0 T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass.TwoStateFunctions.Cell? $h@@0)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2839|
 :pattern ( ($IsAlloc refType $o@@0 Tclass.TwoStateFunctions.Cell? $h@@0))
)))
...
(assert (forall (($h@@1 T@U) ($o@@1 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@1) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) Tclass.TwoStateFunctions.Cell?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) TwoStateFunctions.Cell.data)) TInt $h@@1))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2841|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) TwoStateFunctions.Cell.data)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$TwoStateFunctions.__default.Caller)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |c#0@@1| Tclass.TwoStateFunctions.Cell) ($IsAlloc refType |c#0@@1| Tclass.TwoStateFunctions.Cell $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
