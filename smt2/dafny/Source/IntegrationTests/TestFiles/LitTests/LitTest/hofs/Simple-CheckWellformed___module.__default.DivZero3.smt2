...
(declare-fun |_module.__default.DivZero3#canCall| () Bool)
(declare-fun _module.__default.DivZero3 () T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZero3#canCall| (< 0 $FunctionContextHeight)) ($Is HandleTypeType _module.__default.DivZero3 (Tclass._System.___hFunc1 TInt TInt)))))
...
(assert (forall ((|l#0@@2| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#30| |l#0@@2| |l#1| |l#2| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@0) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |612|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#30| |l#0@@2| |l#1| |l#2| |l#3|) $o@@0 $f))
)))
...
(assert (forall ((|l#0@@3| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#z#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#71| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#z#0|) ($Box intType (int_2_U (Div (U_2_int ($Unbox intType |$l#0#z#0|)) |l#0@@3|))))
 :qid |unknown.0:0|
 :skolemid |617|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#71| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#z#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZero3#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.DivZero3 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#71| (LitInt 0)) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.DivZero3#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.DivZero3 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#71| (LitInt 0)) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0@@0|) |l#0@@4|)
 :qid |Simpledfy.5:3|
 :skolemid |608|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0@@0|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.DivZero3)
...
(let ((anon11_Then_correct  (=> (and (= |$_Frame#l0@0| (|lambda#30| null |$lambdaHeap#0@0| alloc false)) (= (ControlFlow 0 4) (- 0 3))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 6) 4) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct)))))
(let ((anon10_Else_correct true))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#30| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 7) 1) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon10_Then_correct)) (=> (= (ControlFlow 0 7) 2) anon10_Else_correct)))))
