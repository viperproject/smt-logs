...
(declare-fun Monad.__default.Return (T@U T@U) T@U)
(declare-fun |Monad.__default.Return#canCall| (T@U T@U) Bool)
(declare-fun Tclass.Monad.M (T@U) T@U)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun $IsAllocBox (T@U T@U T@U) Bool)
(declare-fun $IsAlloc (T@T T@U T@U T@U) Bool)
(declare-fun |Monad.__default.Return#Handle| (T@U) T@U)
(declare-fun Tclass._System.___hPartialFunc1 (T@U T@U) T@U)
(declare-fun Tclass._System.___hTotalFunc1 (T@U T@U) T@U)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun Requires1 (T@U T@U T@U T@U T@U) Bool)
(declare-fun |Monad.__default.Return#requires| (T@U T@U) Bool)
...
(declare-fun Monad.__default.Bind (T@U T@U T@U T@U) T@U)
(declare-fun |Monad.__default.Bind#canCall| (T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Monad._default.Return$A T@U) (|x#0| T@U) ) (!  (=> (or (|Monad.__default.Return#canCall| Monad._default.Return$A |x#0|) (and (< 0 $FunctionContextHeight) ($IsBox |x#0| Monad._default.Return$A))) ($IsBox (Monad.__default.Return Monad._default.Return$A |x#0|) (Tclass.Monad.M Monad._default.Return$A)))
 :qid |unknown.0:0|
 :skolemid |528|
 :pattern ( (Monad.__default.Return Monad._default.Return$A |x#0|))
))))
...
(assert (forall (($bx T@U) (Monad._default.Return$A@@0 T@U) ($heap T@U) (|$fh$0x#0| T@U) ) (! (= (|Set#IsMember| (Reads1 Monad._default.Return$A@@0 (Tclass.Monad.M Monad._default.Return$A@@0) $heap (|Monad.__default.Return#Handle| Monad._default.Return$A@@0) |$fh$0x#0|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |536|
 :pattern ( (|Set#IsMember| (Reads1 Monad._default.Return$A@@0 (Tclass.Monad.M Monad._default.Return$A@@0) $heap (|Monad.__default.Return#Handle| Monad._default.Return$A@@0) |$fh$0x#0|) $bx))
)))
...
(assert (forall ((Monad._default.Return$A@@1 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Monad.__default.Return Monad._default.Return$A@@1 |$fh$0x#0@@0|) (Apply1 Monad._default.Return$A@@1 (Tclass.Monad.M Monad._default.Return$A@@1) $heap@@0 (|Monad.__default.Return#Handle| Monad._default.Return$A@@1) |$fh$0x#0@@0|))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( (Monad.__default.Return Monad._default.Return$A@@1 |$fh$0x#0@@0|) ($IsGoodHeap $heap@@0))
)))
...
(assert (forall ((Monad._default.Return$A@@2 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (Requires1 Monad._default.Return$A@@2 (Tclass.Monad.M Monad._default.Return$A@@2) $heap@@1 (|Monad.__default.Return#Handle| Monad._default.Return$A@@2) |$fh$0x#0@@1|) (|Monad.__default.Return#requires| Monad._default.Return$A@@2 |$fh$0x#0@@1|))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( (Requires1 Monad._default.Return$A@@2 (Tclass.Monad.M Monad._default.Return$A@@2) $heap@@1 (|Monad.__default.Return#Handle| Monad._default.Return$A@@2) |$fh$0x#0@@1|))
)))
(assert (forall ((Monad._default.Return$A@@3 T@U) (|x#0@@0| T@U) ) (!  (=> ($IsBox |x#0@@0| Monad._default.Return$A@@3) (= (|Monad.__default.Return#requires| Monad._default.Return$A@@3 |x#0@@0|) true))
 :qid |unknown.0:0|
 :skolemid |530|
 :pattern ( (|Monad.__default.Return#requires| Monad._default.Return$A@@3 |x#0@@0|))
)))
...
(assert (forall ((Monad._default.Return$A@@4 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Apply1 Monad._default.Return$A@@4 (Tclass.Monad.M Monad._default.Return$A@@4) $heap@@2 (|Monad.__default.Return#Handle| Monad._default.Return$A@@4) |$fh$0x#0@@2|) (Monad.__default.Return Monad._default.Return$A@@4 |$fh$0x#0@@2|))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( (Apply1 Monad._default.Return$A@@4 (Tclass.Monad.M Monad._default.Return$A@@4) $heap@@2 (|Monad.__default.Return#Handle| Monad._default.Return$A@@4) |$fh$0x#0@@2|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (Monad._default.Bind$A T@U) (Monad._default.Bind$B T@U) (|m#0| T@U) (|f#0@@3| T@U) ) (!  (=> (and (or (|Monad.__default.Bind#canCall| Monad._default.Bind$A Monad._default.Bind$B |m#0| |f#0@@3|) (and (< 0 $FunctionContextHeight) (and (and ($IsBox |m#0| (Tclass.Monad.M Monad._default.Bind$A)) ($IsAllocBox |m#0| (Tclass.Monad.M Monad._default.Bind$A) $Heap)) (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Monad._default.Bind$A (Tclass.Monad.M Monad._default.Bind$B))) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Monad._default.Bind$A (Tclass.Monad.M Monad._default.Bind$B)) $Heap))))) ($IsGoodHeap $Heap)) ($IsAllocBox (Monad.__default.Bind Monad._default.Bind$A Monad._default.Bind$B |m#0| |f#0@@3|) (Tclass.Monad.M Monad._default.Bind$B) $Heap))
 :qid |Monadsdfy.8:12|
 :skolemid |532|
 :pattern ( ($IsAllocBox (Monad.__default.Bind Monad._default.Bind$A Monad._default.Bind$B |m#0| |f#0@@3|) (Tclass.Monad.M Monad._default.Bind$B) $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (Monad._default.Return$A@@5 T@U) (|x#0@@1| T@U) ) (!  (=> (and (or (|Monad.__default.Return#canCall| Monad._default.Return$A@@5 |x#0@@1|) (and (< 0 $FunctionContextHeight) (and ($IsBox |x#0@@1| Monad._default.Return$A@@5) ($IsAllocBox |x#0@@1| Monad._default.Return$A@@5 $Heap@@0)))) ($IsGoodHeap $Heap@@0)) ($IsAllocBox (Monad.__default.Return Monad._default.Return$A@@5 |x#0@@1|) (Tclass.Monad.M Monad._default.Return$A@@5) $Heap@@0))
 :qid |Monadsdfy.7:12|
 :skolemid |529|
 :pattern ( ($IsAllocBox (Monad.__default.Return Monad._default.Return$A@@5 |x#0@@1|) (Tclass.Monad.M Monad._default.Return$A@@5) $Heap@@0))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((Monad._default.Bind$A@@0 T@U) (Monad._default.Bind$B@@0 T@U) (|m#0@@0| T@U) (|f#0@@4| T@U) ) (!  (=> (or (|Monad.__default.Bind#canCall| Monad._default.Bind$A@@0 Monad._default.Bind$B@@0 |m#0@@0| |f#0@@4|) (and (< 0 $FunctionContextHeight) (and ($IsBox |m#0@@0| (Tclass.Monad.M Monad._default.Bind$A@@0)) ($Is HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc1 Monad._default.Bind$A@@0 (Tclass.Monad.M Monad._default.Bind$B@@0)))))) ($IsBox (Monad.__default.Bind Monad._default.Bind$A@@0 Monad._default.Bind$B@@0 |m#0@@0| |f#0@@4|) (Tclass.Monad.M Monad._default.Bind$B@@0)))
 :qid |unknown.0:0|
 :skolemid |531|
 :pattern ( (Monad.__default.Bind Monad._default.Bind$A@@0 Monad._default.Bind$B@@0 |m#0@@0| |f#0@@4|))
))))
(push 1)
...
(declare-fun Monad._default.RightIdentity$A () T@U)
(set-info :boogie-vc-id CheckWellFormed$$Monad.__default.RightIdentity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and ($IsAllocBox |m#0@@1| (Tclass.Monad.M Monad._default.RightIdentity$A) $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= 0 $FunctionContextHeight)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($IsBox |m#0@@1| (Tclass.Monad.M Monad._default.RightIdentity$A)) ($IsAllocBox |m#0@@1| (Tclass.Monad.M Monad._default.RightIdentity$A) $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
