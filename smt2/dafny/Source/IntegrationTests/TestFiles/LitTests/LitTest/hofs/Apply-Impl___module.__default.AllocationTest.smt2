...
(assert (forall ((t0@@14 T@U) (h0 T@U) (h1 T@U) (f@@7 T@U) ) (!  (=> (and (and (and ($HeapSucc h0 h1) (and ($IsGoodHeap h0) ($IsGoodHeap h1))) ($Is HandleTypeType f@@7 (Tclass._System.___hFunc0 t0@@14))) (forall ((o@@1 T@U) (fld T@U) ) (!  (=> (and (or (not (= o@@1 null)) (not true)) (|Set#IsMember| (Reads0 t0@@14 h0 f@@7) ($Box refType o@@1))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0 o@@1) fld) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1 o@@1) fld)))
 :qid |unknown.0:0|
 :skolemid |421|
))) (= (Requires0 t0@@14 h0 f@@7) (Requires0 t0@@14 h1 f@@7)))
 :qid |unknown.0:0|
 :skolemid |422|
 :pattern ( ($HeapSucc h0 h1) (Requires0 t0@@14 h1 f@@7))
)))
(assert (forall ((t0@@15 T@U) (h0@@0 T@U) (h1@@0 T@U) (f@@8 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@0 h1@@0) (and ($IsGoodHeap h0@@0) ($IsGoodHeap h1@@0))) ($Is HandleTypeType f@@8 (Tclass._System.___hFunc0 t0@@15))) (forall ((o@@2 T@U) (fld@@0 T@U) ) (!  (=> (and (or (not (= o@@2 null)) (not true)) (|Set#IsMember| (Reads0 t0@@15 h1@@0 f@@8) ($Box refType o@@2))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@0 o@@2) fld@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@0 o@@2) fld@@0)))
 :qid |unknown.0:0|
 :skolemid |423|
))) (= (Requires0 t0@@15 h0@@0 f@@8) (Requires0 t0@@15 h1@@0 f@@8)))
 :qid |unknown.0:0|
 :skolemid |424|
...
(assert (forall ((t0@@18 T@U) (h0@@1 T@U) (h1@@1 T@U) (f@@10 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@1 h1@@1) (and ($IsGoodHeap h0@@1) ($IsGoodHeap h1@@1))) ($Is HandleTypeType f@@10 (Tclass._System.___hFunc0 t0@@18))) (forall ((o@@3 T@U) (fld@@1 T@U) ) (!  (=> (and (or (not (= o@@3 null)) (not true)) (|Set#IsMember| (Reads0 t0@@18 h0@@1 f@@10) ($Box refType o@@3))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@1 o@@3) fld@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@1 o@@3) fld@@1)))
 :qid |unknown.0:0|
 :skolemid |417|
))) (= (Reads0 t0@@18 h0@@1 f@@10) (Reads0 t0@@18 h1@@1 f@@10)))
 :qid |unknown.0:0|
 :skolemid |418|
 :pattern ( ($HeapSucc h0@@1 h1@@1) (Reads0 t0@@18 h1@@1 f@@10))
)))
(assert (forall ((t0@@19 T@U) (h0@@2 T@U) (h1@@2 T@U) (f@@11 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@2 h1@@2) (and ($IsGoodHeap h0@@2) ($IsGoodHeap h1@@2))) ($Is HandleTypeType f@@11 (Tclass._System.___hFunc0 t0@@19))) (forall ((o@@4 T@U) (fld@@2 T@U) ) (!  (=> (and (or (not (= o@@4 null)) (not true)) (|Set#IsMember| (Reads0 t0@@19 h1@@2 f@@11) ($Box refType o@@4))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@2 o@@4) fld@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@2 o@@4) fld@@2)))
 :qid |unknown.0:0|
 :skolemid |419|
))) (= (Reads0 t0@@19 h0@@2 f@@11) (Reads0 t0@@19 h1@@2 f@@11)))
 :qid |unknown.0:0|
 :skolemid |420|
...
(assert (forall ((t0@@20 T@U) (h0@@3 T@U) (h1@@3 T@U) (f@@12 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@3 h1@@3) (and ($IsGoodHeap h0@@3) ($IsGoodHeap h1@@3))) ($Is HandleTypeType f@@12 (Tclass._System.___hFunc0 t0@@20))) (forall ((o@@5 T@U) (fld@@3 T@U) ) (!  (=> (and (or (not (= o@@5 null)) (not true)) (|Set#IsMember| (Reads0 t0@@20 h0@@3 f@@12) ($Box refType o@@5))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@3 o@@5) fld@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@3 o@@5) fld@@3)))
 :qid |unknown.0:0|
 :skolemid |425|
))) (= (Apply0 t0@@20 h0@@3 f@@12) (Apply0 t0@@20 h1@@3 f@@12)))
 :qid |unknown.0:0|
 :skolemid |426|
 :pattern ( ($HeapSucc h0@@3 h1@@3) (Apply0 t0@@20 h1@@3 f@@12))
)))
(assert (forall ((t0@@21 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@13 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) ($Is HandleTypeType f@@13 (Tclass._System.___hFunc0 t0@@21))) (forall ((o@@6 T@U) (fld@@4 T@U) ) (!  (=> (and (or (not (= o@@6 null)) (not true)) (|Set#IsMember| (Reads0 t0@@21 h1@@4 f@@13) ($Box refType o@@6))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@4 o@@6) fld@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@4 o@@6) fld@@4)))
 :qid |unknown.0:0|
 :skolemid |427|
))) (= (Apply0 t0@@21 h0@@4 f@@13) (Apply0 t0@@21 h1@@4 f@@13)))
 :qid |unknown.0:0|
 :skolemid |428|
...
(assert (forall ((t0@@24 T@U) (t1@@10 T@U) (t2@@9 T@U) (h0@@5 T@U) (h1@@5 T@U) (f@@17 T@U) (bx0@@6 T@U) (bx1@@6 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@5 h1@@5) (and ($IsGoodHeap h0@@5) ($IsGoodHeap h1@@5))) (and (and ($IsBox bx0@@6 t0@@24) ($IsBox bx1@@6 t1@@10)) ($Is HandleTypeType f@@17 (Tclass._System.___hFunc2 t0@@24 t1@@10 t2@@9)))) (forall ((o@@7 T@U) (fld@@5 T@U) ) (!  (=> (and (or (not (= o@@7 null)) (not true)) (|Set#IsMember| (Reads2 t0@@24 t1@@10 t2@@9 h0@@5 f@@17 bx0@@6 bx1@@6) ($Box refType o@@7))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@5 o@@7) fld@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@5 o@@7) fld@@5)))
 :qid |unknown.0:0|
 :skolemid |491|
))) (= (Requires2 t0@@24 t1@@10 t2@@9 h0@@5 f@@17 bx0@@6 bx1@@6) (Requires2 t0@@24 t1@@10 t2@@9 h1@@5 f@@17 bx0@@6 bx1@@6)))
 :qid |unknown.0:0|
 :skolemid |492|
 :pattern ( ($HeapSucc h0@@5 h1@@5) (Requires2 t0@@24 t1@@10 t2@@9 h1@@5 f@@17 bx0@@6 bx1@@6))
)))
(assert (forall ((t0@@25 T@U) (t1@@11 T@U) (t2@@10 T@U) (h0@@6 T@U) (h1@@6 T@U) (f@@18 T@U) (bx0@@7 T@U) (bx1@@7 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@6 h1@@6) (and ($IsGoodHeap h0@@6) ($IsGoodHeap h1@@6))) (and (and ($IsBox bx0@@7 t0@@25) ($IsBox bx1@@7 t1@@11)) ($Is HandleTypeType f@@18 (Tclass._System.___hFunc2 t0@@25 t1@@11 t2@@10)))) (forall ((o@@8 T@U) (fld@@6 T@U) ) (!  (=> (and (or (not (= o@@8 null)) (not true)) (|Set#IsMember| (Reads2 t0@@25 t1@@11 t2@@10 h1@@6 f@@18 bx0@@7 bx1@@7) ($Box refType o@@8))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@6 o@@8) fld@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@6 o@@8) fld@@6)))
 :qid |unknown.0:0|
 :skolemid |493|
))) (= (Requires2 t0@@25 t1@@11 t2@@10 h0@@6 f@@18 bx0@@7 bx1@@7) (Requires2 t0@@25 t1@@11 t2@@10 h1@@6 f@@18 bx0@@7 bx1@@7)))
 :qid |unknown.0:0|
 :skolemid |494|
...
(assert (forall ((t0@@28 T@U) (t1@@12 T@U) (t2@@11 T@U) (h0@@7 T@U) (h1@@7 T@U) (f@@22 T@U) (bx0@@8 T@U) (bx1@@8 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@7 h1@@7) (and ($IsGoodHeap h0@@7) ($IsGoodHeap h1@@7))) (and (and ($IsBox bx0@@8 t0@@28) ($IsBox bx1@@8 t1@@12)) ($Is HandleTypeType f@@22 (Tclass._System.___hFunc2 t0@@28 t1@@12 t2@@11)))) (forall ((o@@10 T@U) (fld@@7 T@U) ) (!  (=> (and (or (not (= o@@10 null)) (not true)) (|Set#IsMember| (Reads2 t0@@28 t1@@12 t2@@11 h0@@7 f@@22 bx0@@8 bx1@@8) ($Box refType o@@10))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@7 o@@10) fld@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@7 o@@10) fld@@7)))
 :qid |unknown.0:0|
 :skolemid |487|
))) (= (Reads2 t0@@28 t1@@12 t2@@11 h0@@7 f@@22 bx0@@8 bx1@@8) (Reads2 t0@@28 t1@@12 t2@@11 h1@@7 f@@22 bx0@@8 bx1@@8)))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($HeapSucc h0@@7 h1@@7) (Reads2 t0@@28 t1@@12 t2@@11 h1@@7 f@@22 bx0@@8 bx1@@8))
)))
(assert (forall ((t0@@29 T@U) (t1@@13 T@U) (t2@@12 T@U) (h0@@8 T@U) (h1@@8 T@U) (f@@23 T@U) (bx0@@9 T@U) (bx1@@9 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@8 h1@@8) (and ($IsGoodHeap h0@@8) ($IsGoodHeap h1@@8))) (and (and ($IsBox bx0@@9 t0@@29) ($IsBox bx1@@9 t1@@13)) ($Is HandleTypeType f@@23 (Tclass._System.___hFunc2 t0@@29 t1@@13 t2@@12)))) (forall ((o@@11 T@U) (fld@@8 T@U) ) (!  (=> (and (or (not (= o@@11 null)) (not true)) (|Set#IsMember| (Reads2 t0@@29 t1@@13 t2@@12 h1@@8 f@@23 bx0@@9 bx1@@9) ($Box refType o@@11))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@8 o@@11) fld@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@8 o@@11) fld@@8)))
 :qid |unknown.0:0|
 :skolemid |489|
))) (= (Reads2 t0@@29 t1@@13 t2@@12 h0@@8 f@@23 bx0@@9 bx1@@9) (Reads2 t0@@29 t1@@13 t2@@12 h1@@8 f@@23 bx0@@9 bx1@@9)))
 :qid |unknown.0:0|
 :skolemid |490|
...
(assert (forall ((t0@@30 T@U) (t1@@14 T@U) (t2@@13 T@U) (h0@@9 T@U) (h1@@9 T@U) (f@@24 T@U) (bx0@@10 T@U) (bx1@@10 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@9 h1@@9) (and ($IsGoodHeap h0@@9) ($IsGoodHeap h1@@9))) (and (and ($IsBox bx0@@10 t0@@30) ($IsBox bx1@@10 t1@@14)) ($Is HandleTypeType f@@24 (Tclass._System.___hFunc2 t0@@30 t1@@14 t2@@13)))) (forall ((o@@12 T@U) (fld@@9 T@U) ) (!  (=> (and (or (not (= o@@12 null)) (not true)) (|Set#IsMember| (Reads2 t0@@30 t1@@14 t2@@13 h0@@9 f@@24 bx0@@10 bx1@@10) ($Box refType o@@12))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@9 o@@12) fld@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@9 o@@12) fld@@9)))
 :qid |unknown.0:0|
 :skolemid |495|
))) (= (Apply2 t0@@30 t1@@14 t2@@13 h0@@9 f@@24 bx0@@10 bx1@@10) (Apply2 t0@@30 t1@@14 t2@@13 h1@@9 f@@24 bx0@@10 bx1@@10)))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( ($HeapSucc h0@@9 h1@@9) (Apply2 t0@@30 t1@@14 t2@@13 h1@@9 f@@24 bx0@@10 bx1@@10))
)))
(assert (forall ((t0@@31 T@U) (t1@@15 T@U) (t2@@14 T@U) (h0@@10 T@U) (h1@@10 T@U) (f@@25 T@U) (bx0@@11 T@U) (bx1@@11 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@10 h1@@10) (and ($IsGoodHeap h0@@10) ($IsGoodHeap h1@@10))) (and (and ($IsBox bx0@@11 t0@@31) ($IsBox bx1@@11 t1@@15)) ($Is HandleTypeType f@@25 (Tclass._System.___hFunc2 t0@@31 t1@@15 t2@@14)))) (forall ((o@@13 T@U) (fld@@10 T@U) ) (!  (=> (and (or (not (= o@@13 null)) (not true)) (|Set#IsMember| (Reads2 t0@@31 t1@@15 t2@@14 h1@@10 f@@25 bx0@@11 bx1@@11) ($Box refType o@@13))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@10 o@@13) fld@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@10 o@@13) fld@@10)))
 :qid |unknown.0:0|
 :skolemid |497|
))) (= (Apply2 t0@@31 t1@@15 t2@@14 h0@@10 f@@25 bx0@@11 bx1@@11) (Apply2 t0@@31 t1@@15 t2@@14 h1@@10 f@@25 bx0@@11 bx1@@11)))
 :qid |unknown.0:0|
 :skolemid |498|
...
(set-info :boogie-vc-id Impl$$_module.__default.AllocationTest)
