...
(declare-fun |lambda#110| (T@U) T@U)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#u#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#110| |l#0|) |$l#0#heap#0| |$l#0#u#0|))  (and ($IsBox |$l#0#u#0| |l#0|) (U_2_bool ($Unbox boolType |$l#0#u#0|))))
 :qid |DafnyPreludebpl.21:1|
 :skolemid |622|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#110| |l#0|) |$l#0#heap#0| |$l#0#u#0|))
)))
...
(assert (forall ((|#$T0@@5| T@U) (|#$R@@5| T@U) ($self@@4 T@U) ($heap@@4 T@U) (|$fh$0x#0@@4| T@U) ) (! (= (Reads1 |#$T0@@5| |#$R@@5| $heap@@4 $self@@4 |$fh$0x#0@@4|) ($Unbox SetType (Apply1 |#$T0@@5| (TSet Tclass._System.object?) $heap@@4 (|Reads1#Handle| |#$T0@@5| |#$R@@5| $self@@4) |$fh$0x#0@@4|)))
 :qid |unknown.0:0|
 :skolemid |580|
 :pattern ( (Reads1 |#$T0@@5| |#$R@@5| $heap@@4 $self@@4 |$fh$0x#0@@4|))
)))
...
(assert (forall ((|#$T0@@6| T@U) (|#$R@@6| T@U) ($self@@5 T@U) ($heap@@5 T@U) (|$fh$0x#0@@5| T@U) ) (! (= (Requires1 |#$T0@@6| (TSet Tclass._System.object?) $heap@@5 (|Reads1#Handle| |#$T0@@6| |#$R@@6| $self@@5) |$fh$0x#0@@5|) (Requires1 |#$T0@@6| |#$R@@6| $heap@@5 $self@@5 |$fh$0x#0@@5|))
 :qid |unknown.0:0|
 :skolemid |578|
 :pattern ( (Requires1 |#$T0@@6| (TSet Tclass._System.object?) $heap@@5 (|Reads1#Handle| |#$T0@@6| |#$R@@6| $self@@5) |$fh$0x#0@@5|))
)))
...
(assert (forall ((|#$T0@@12| T@U) (|#$R@@12| T@U) (bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 (Tclass._System.___hFunc1 |#$T0@@12| |#$R@@12|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@9)) bx@@9) ($Is HandleTypeType ($Unbox HandleTypeType bx@@9) (Tclass._System.___hFunc1 |#$T0@@12| |#$R@@12|))))
 :qid |unknown.0:0|
 :skolemid |369|
 :pattern ( ($IsBox bx@@9 (Tclass._System.___hFunc1 |#$T0@@12| |#$R@@12|)))
)))
(assert (forall ((|#$T0@@13| T@U) (|#$R@@13| T@U) (bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 (Tclass._System.___hPartialFunc1 |#$T0@@13| |#$R@@13|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@10)) bx@@10) ($Is HandleTypeType ($Unbox HandleTypeType bx@@10) (Tclass._System.___hPartialFunc1 |#$T0@@13| |#$R@@13|))))
 :qid |unknown.0:0|
 :skolemid |400|
 :pattern ( ($IsBox bx@@10 (Tclass._System.___hPartialFunc1 |#$T0@@13| |#$R@@13|)))
)))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#u#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#109| |$l#0#heap#0@@0| |$l#0#u#0@@0|) ($Box boolType ($Unbox boolType |$l#0#u#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |621|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#109| |$l#0#heap#0@@0| |$l#0#u#0@@0|))
)))
...
(assert (forall ((|#$T0@@16| T@U) (|#$R@@16| T@U) ($self@@6 T@U) ($heap@@6 T@U) (|$fh$0x#0@@6| T@U) ) (! (= (Apply1 |#$T0@@16| (TSet Tclass._System.object?) $heap@@6 (|Reads1#Handle| |#$T0@@16| |#$R@@16| $self@@6) |$fh$0x#0@@6|) ($Box SetType (Reads1 |#$T0@@16| |#$R@@16| $heap@@6 $self@@6 |$fh$0x#0@@6|)))
 :qid |unknown.0:0|
 :skolemid |577|
 :pattern ( (Apply1 |#$T0@@16| (TSet Tclass._System.object?) $heap@@6 (|Reads1#Handle| |#$T0@@16| |#$R@@16| $self@@6) |$fh$0x#0@@6|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#x#0|) |l#0@@3|)
 :qid |Simpledfy.5:3|
 :skolemid |608|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#x#0|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Reqs)
...
(let ((anon8_Else_correct  (=> (and (not |u#0@0|) (= (ControlFlow 0 7) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (and |u#0@0| (= |lambdaResult#0| |u#0@0|)) (and ($Is boolType (bool_2_U |lambdaResult#0|) TBool) (= (ControlFlow 0 6) 5))) anon4_correct)))
(let ((anon7_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#30| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
(let ((anon7_Else_correct true))
(let ((anon6_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 9) 8) anon7_Then_correct) (=> (= (ControlFlow 0 9) 4) anon7_Else_correct)))))
(let ((anon6_Else_correct  (=> (= |fn#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#109| (|lambda#110| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 TBool TBool $Heap |fn#0@0| ($Box boolType (Lit boolType (bool_2_U true))))) (=> (Requires1 TBool TBool $Heap |fn#0@0| ($Box boolType (Lit boolType (bool_2_U true)))) (=> (= (ControlFlow 0 2) (- 0 1)) (Requires1 TBool TBool $Heap |fn#0@0| ($Box boolType (Lit boolType (bool_2_U false))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#30| null $Heap alloc false)) (and (=> (= (ControlFlow 0 10) 9) anon6_Then_correct) (=> (= (ControlFlow 0 10) 2) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |fn#0| (Tclass._System.___hPartialFunc1 TBool TBool)) ($IsAlloc HandleTypeType |fn#0| (Tclass._System.___hPartialFunc1 TBool TBool) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
