...
(assert (forall ((|#$T0@@35| T@U) (|#$T1@@35| T@U) (|#$R@@35| T@U) (|f#0@@7| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc2 |#$T0@@35| |#$T1@@35| |#$R@@35|) $h@@1) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hFunc2 |#$T0@@35| |#$T1@@35| |#$R@@35|) $h@@1))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc2 |#$T0@@35| |#$T1@@35| |#$R@@35|) $h@@1))
)))
(assert (forall ((|#$T0@@36| T@U) (|#$T1@@36| T@U) (|#$R@@36| T@U) (|f#0@@8| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc2 |#$T0@@36| |#$T1@@36| |#$R@@36|) $h@@2) ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hPartialFunc2 |#$T0@@36| |#$T1@@36| |#$R@@36|) $h@@2))
 :qid |unknown.0:0|
 :skolemid |527|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc2 |#$T0@@36| |#$T1@@36| |#$R@@36|) $h@@2))
)))
...
(declare-fun _module._default.FoldL_Property$B () T@U)
(declare-fun _module._default.FoldL_Property$A () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.FoldL__Property)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon7_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (=> (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|))))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|))))))) (=> (= (ControlFlow 0 20) (- 0 19)) (=> (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|))))) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#0@@6| |head#0_0@0| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#0@@6| |head#0_0@0|)))))))))
(let ((anon19_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|)))))) (= (ControlFlow 0 23) 20)) anon7_correct)))
(let ((anon19_Then_correct  (=> (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|))))) (= (ControlFlow 0 22) 20)) anon7_correct)))
(let ((anon18_Then_correct  (=> (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|))))) (and (=> (= (ControlFlow 0 24) 22) anon19_Then_correct) (=> (= (ControlFlow 0 24) 23) anon19_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 16) (- 0 15)) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@2 |inv#0@@1| (_module.__default.foldl _module._default.FoldL_Property$A _module._default.FoldL_Property$B ($LS ($LS $LZ)) |f#0@@13| |b#0@@6| |xs#0@@6|) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))))))))
(let ((anon22_Else_correct  (=> (=> true (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| (_module.__default.foldl _module._default.FoldL_Property$A _module._default.FoldL_Property$B ($LS $LZ) |f#0@@13| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#0@@6| |head#0_0@0|) |tail#0_0@0|) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)))))) (=> (and (= $Heap@2 $Heap@0) (= (ControlFlow 0 18) 16)) GeneratedUnifiedExit_correct))))
(let ((anon14_Then_correct  (=> (= |xs#0@@6| |#_module.List.Nil|) (=> (and (= $Heap@2 $Heap@0) (= (ControlFlow 0 17) 16)) GeneratedUnifiedExit_correct))))
(let ((anon10_correct  (=> (and (and (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|))))) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#0@@6| |head#0_0@0| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#0@@6| |head#0_0@0|))))) (= (ControlFlow 0 12) (- 0 11))) (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|))))) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#0@@6| |head#0_0@0| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#0@@6| |head#0_0@0|)))))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#0@@6| |head#0_0@0|) ($Box DatatypeTypeType |tail#0_0@0|)))))))
(let ((anon21_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|)))))) (= (ControlFlow 0 14) 12)) anon10_correct)))
(let ((anon21_Then_correct  (=> (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|))))) (= (ControlFlow 0 13) 12)) anon10_correct)))
(let ((anon22_Then_correct  (=> (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#0@@6| |head#0_0@0|) ($Box DatatypeTypeType |tail#0_0@0|)))) (= |b##0_0_0_0@0| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#0@@6| |head#0_0@0|))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (< (DtRank |tail#0_0@0|) (DtRank |xs#0@@6|))) (=> (< (DtRank |tail#0_0@0|) (DtRank |xs#0@@6|)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (|_module.__default.InvL#canCall| _module._default.FoldL_Property$A _module._default.FoldL_Property$B |inv#0@@1| |stp#0@@1|) (or (_module.__default.InvL _module._default.FoldL_Property$A _module._default.FoldL_Property$B |inv#0@@1| |stp#0@@1|) (forall ((|x#0@@0| T@U) (|xs#1@@0| T@U) (|b#3| T@U) (|b'#0@@0| T@U) ) (!  (=> (and (and (and ($IsBox |x#0@@0| _module._default.FoldL_Property$A) ($Is DatatypeTypeType |xs#1@@0| (Tclass._module.List _module._default.FoldL_Property$A))) ($IsBox |b#3| _module._default.FoldL_Property$B)) ($IsBox |b'#0@@0| _module._default.FoldL_Property$B)) (=> (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#3| ($Box DatatypeTypeType (|#_module.List.Cons| |x#0@@0| |xs#1@@0|))))) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#3| |x#0@@0| |b'#0@@0|)))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b'#0@@0| ($Box DatatypeTypeType |xs#1@@0|))))))
 :qid |Foldinglegacydfy.155:10|
 :skolemid |719|
 :pattern ( ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#3| |x#0@@0| |b'#0@@0|)) (|#_module.List.Cons| |x#0@@0| |xs#1@@0|))
))))) (=> (=> (|_module.__default.InvL#canCall| _module._default.FoldL_Property$A _module._default.FoldL_Property$B |inv#0@@1| |stp#0@@1|) (or (_module.__default.InvL _module._default.FoldL_Property$A _module._default.FoldL_Property$B |inv#0@@1| |stp#0@@1|) (forall ((|x#0@@1| T@U) (|xs#1@@1| T@U) (|b#3@@0| T@U) (|b'#0@@1| T@U) ) (!  (=> (and (and (and ($IsBox |x#0@@1| _module._default.FoldL_Property$A) ($Is DatatypeTypeType |xs#1@@1| (Tclass._module.List _module._default.FoldL_Property$A))) ($IsBox |b#3@@0| _module._default.FoldL_Property$B)) ($IsBox |b'#0@@1| _module._default.FoldL_Property$B)) (=> (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#3@@0| ($Box DatatypeTypeType (|#_module.List.Cons| |x#0@@1| |xs#1@@1|))))) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#3@@0| |x#0@@1| |b'#0@@1|)))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b'#0@@1| ($Box DatatypeTypeType |xs#1@@1|))))))
 :qid |Foldinglegacydfy.155:10|
 :skolemid |719|
 :pattern ( ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#3@@0| |x#0@@1| |b'#0@@1|)) (|#_module.List.Cons| |x#0@@1| |xs#1@@1|))
)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (forall ((|b#2| T@U) (|a#1| T@U) ) (!  (=> (and ($IsBox |b#2| _module._default.FoldL_Property$B) ($IsBox |a#1| _module._default.FoldL_Property$A)) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#2| |a#1| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#2| |a#1|)))))
 :qid |Foldinglegacydfy.165:19|
 :skolemid |721|
 :pattern ( (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#2| |a#1|))
))) (=> (forall ((|b#2@@0| T@U) (|a#1@@0| T@U) ) (!  (=> (and ($IsBox |b#2@@0| _module._default.FoldL_Property$B) ($IsBox |a#1@@0| _module._default.FoldL_Property$A)) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@0 |stp#0@@1| |b#2@@0| |a#1@@0| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#2@@0| |a#1@@0|)))))
 :qid |Foldinglegacydfy.165:19|
 :skolemid |721|
 :pattern ( (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@0 |f#0@@13| |b#2@@0| |a#1@@0|))
)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b##0_0_0_0@0| ($Box DatatypeTypeType |tail#0_0@0|))))) (=> (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b##0_0_0_0@0| ($Box DatatypeTypeType |tail#0_0@0|)))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.__default.foldl#canCall| _module._default.FoldL_Property$A _module._default.FoldL_Property$B |f#0@@13| |b##0_0_0_0@0| |tail#0_0@0|) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@1 |inv#0@@1| (_module.__default.foldl _module._default.FoldL_Property$A _module._default.FoldL_Property$B ($LS ($LS $LZ)) |f#0@@13| |b##0_0_0_0@0| |tail#0_0@0|) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)))))) (and (= $Heap@0 $Heap@1) ($IsAlloc HandleTypeType |f#0@@13| (Tclass._System.___hTotalFunc2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B) $Heap@1))) (=> (and (and (and (= |##b#0_0_0_0@0| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@1 |f#0@@13| |b#0@@6| |head#0_0@0|)) ($IsAllocBox |##b#0_0_0_0@0| _module._default.FoldL_Property$B $Heap@1)) (and ($IsAlloc DatatypeTypeType |tail#0_0@0| (Tclass._module.List _module._default.FoldL_Property$A) $Heap@1) (|_module.__default.foldl#canCall| _module._default.FoldL_Property$A _module._default.FoldL_Property$B |f#0@@13| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@1 |f#0@@13| |b#0@@6| |head#0_0@0|) |tail#0_0@0|))) (and (and (|_module.__default.foldl#canCall| _module._default.FoldL_Property$A _module._default.FoldL_Property$B |f#0@@13| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@1 |f#0@@13| |b#0@@6| |head#0_0@0|) |tail#0_0@0|) (= (ControlFlow 0 6) (- 0 5))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@1 |inv#0@@1| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@1 |f#0@@13| |b#0@@6| |head#0_0@0|) ($Box DatatypeTypeType |tail#0_0@0|)))))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@1 |inv#0@@1| (_module.__default.foldl _module._default.FoldL_Property$A _module._default.FoldL_Property$B ($LS ($LS $LZ)) |f#0@@13| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@1 |f#0@@13| |b#0@@6| |head#0_0@0|) |tail#0_0@0|) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|)))))))))))))))))))
(let ((anon17_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType (|#_module.List.Cons| |head#0_0@0| |tail#0_0@0|)))))))))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (= |xs#0@@6| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($IsBox |_mcc#0#0_0@0| _module._default.FoldL_Property$A) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module._default.FoldL_Property$A))) (=> (and (and (and (and ($Is DatatypeTypeType |tail#0_0@0| (Tclass._module.List _module._default.FoldL_Property$A)) ($IsAlloc DatatypeTypeType |tail#0_0@0| (Tclass._module.List _module._default.FoldL_Property$A) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module._default.FoldL_Property$A)) (= |tail#0_0@0| |let#0_0#0#0|))) (and (and (and ($IsBox |head#0_0@0| _module._default.FoldL_Property$A) ($IsAllocBox |head#0_0@0| _module._default.FoldL_Property$A $Heap@0)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($IsBox |let#0_1#0#0| _module._default.FoldL_Property$A) (= |head#0_0@0| |let#0_1#0#0|)))) (and (and (and (and (and (and (=> (= (ControlFlow 0 25) 2) anon16_Then_correct) (=> (= (ControlFlow 0 25) 4) anon17_Then_correct)) (=> (= (ControlFlow 0 25) 24) anon18_Then_correct)) (=> (= (ControlFlow 0 25) 6) anon22_Then_correct)) (=> (= (ControlFlow 0 25) 18) anon22_Else_correct)) (=> (= (ControlFlow 0 25) 13) anon21_Then_correct)) (=> (= (ControlFlow 0 25) 14) anon21_Else_correct)))))))
(let ((anon15_Else_correct true))
(let ((anon14_Else_correct  (=> (or (not (= |xs#0@@6| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 26) 25) anon15_Then_correct) (=> (= (ControlFlow 0 26) 1) anon15_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@5 alloc false)) (|$IsA#_module.List| |xs#0@@6|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@5 $Heap@0) (forall ((|$ih#xs0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List _module._default.FoldL_Property$A)) (and (and (_module.__default.InvL _module._default.FoldL_Property$A _module._default.FoldL_Property$B |inv#0@@1| |stp#0@@1|) (forall ((|b#5| T@U) (|a#2| T@U) ) (!  (=> (and ($IsBox |b#5| _module._default.FoldL_Property$B) ($IsBox |a#2| _module._default.FoldL_Property$A)) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@@5 |stp#0@@1| |b#5| |a#2| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@@5 |f#0@@13| |b#5| |a#2|)))))
 :qid |Foldinglegacydfy.165:19|
 :skolemid |725|
 :pattern ( (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@@5 |f#0@@13| |b#5| |a#2|))
))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@@5 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType |$ih#xs0#0|)))))) (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@6|))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| (_module.__default.foldl _module._default.FoldL_Property$A _module._default.FoldL_Property$B ($LS $LZ) |f#0@@13| |b#0@@6| |$ih#xs0#0|) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.List.Nil|))))))
 :qid |Foldinglegacydfy.163:108|
 :skolemid |726|
 :pattern ( (_module.__default.foldl _module._default.FoldL_Property$A _module._default.FoldL_Property$B ($LS $LZ) |f#0@@13| |b#0@@6| |$ih#xs0#0|))
 :pattern ( ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@0 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType |$ih#xs0#0|))))
)))) (and (=> (= (ControlFlow 0 27) 17) anon14_Then_correct) (=> (= (ControlFlow 0 27) 26) anon14_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (and ($AlwaysAllocated _module._default.FoldL_Property$A) ($AlwaysAllocated _module._default.FoldL_Property$B))) (=> (and (and (and ($Is HandleTypeType |inv#0@@1| (Tclass._System.___hTotalFunc2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool)) ($IsAlloc HandleTypeType |inv#0@@1| (Tclass._System.___hTotalFunc2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool) $Heap@@5)) (and ($Is HandleTypeType |stp#0@@1| (Tclass._System.___hTotalFunc3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool)) ($IsAlloc HandleTypeType |stp#0@@1| (Tclass._System.___hTotalFunc3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool) $Heap@@5))) (and (and ($Is HandleTypeType |f#0@@13| (Tclass._System.___hTotalFunc2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B)) ($IsAlloc HandleTypeType |f#0@@13| (Tclass._System.___hTotalFunc2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B) $Heap@@5)) (and ($IsBox |b#0@@6| _module._default.FoldL_Property$B) ($IsAllocBox |b#0@@6| _module._default.FoldL_Property$B $Heap@@5)))) (=> (and (and (and (and ($Is DatatypeTypeType |xs#0@@6| (Tclass._module.List _module._default.FoldL_Property$A)) ($IsAlloc DatatypeTypeType |xs#0@@6| (Tclass._module.List _module._default.FoldL_Property$A) $Heap@@5)) (|$IsA#_module.List| |xs#0@@6|)) (= 2 $FunctionContextHeight)) (and (and (and (|_module.__default.InvL#canCall| _module._default.FoldL_Property$A _module._default.FoldL_Property$B |inv#0@@1| |stp#0@@1|) (and (_module.__default.InvL _module._default.FoldL_Property$A _module._default.FoldL_Property$B |inv#0@@1| |stp#0@@1|) (forall ((|x#1@@0| T@U) (|xs#2| T@U) (|b#4| T@U) (|b'#1@@0| T@U) ) (!  (=> (and (and (and ($IsBox |x#1@@0| _module._default.FoldL_Property$A) ($Is DatatypeTypeType |xs#2| (Tclass._module.List _module._default.FoldL_Property$A))) ($IsBox |b#4| _module._default.FoldL_Property$B)) ($IsBox |b'#1@@0| _module._default.FoldL_Property$B)) (=> (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@@5 |inv#0@@1| |b#4| ($Box DatatypeTypeType (|#_module.List.Cons| |x#1@@0| |xs#2|))))) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@@5 |stp#0@@1| |b#4| |x#1@@0| |b'#1@@0|)))) (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@@5 |inv#0@@1| |b'#1@@0| ($Box DatatypeTypeType |xs#2|))))))
 :qid |Foldinglegacydfy.155:10|
 :skolemid |723|
 :pattern ( ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@@5 |stp#0@@1| |b#4| |x#1@@0| |b'#1@@0|)) (|#_module.List.Cons| |x#1@@0| |xs#2|))
)))) (forall ((|b#2@@1| T@U) (|a#1@@1| T@U) ) (!  (=> (and ($IsBox |b#2@@1| _module._default.FoldL_Property$B) ($IsBox |a#1@@1| _module._default.FoldL_Property$A)) (U_2_bool ($Unbox boolType (Apply3 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B TBool $Heap@@5 |stp#0@@1| |b#2@@1| |a#1@@1| (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@@5 |f#0@@13| |b#2@@1| |a#1@@1|)))))
 :qid |Foldinglegacydfy.165:19|
 :skolemid |724|
 :pattern ( (Apply2 _module._default.FoldL_Property$B _module._default.FoldL_Property$A _module._default.FoldL_Property$B $Heap@@5 |f#0@@13| |b#2@@1| |a#1@@1|))
))) (and (U_2_bool ($Unbox boolType (Apply2 _module._default.FoldL_Property$B (Tclass._module.List _module._default.FoldL_Property$A) TBool $Heap@@5 |inv#0@@1| |b#0@@6| ($Box DatatypeTypeType |xs#0@@6|)))) (= (ControlFlow 0 28) 27)))) anon0_correct)))))
