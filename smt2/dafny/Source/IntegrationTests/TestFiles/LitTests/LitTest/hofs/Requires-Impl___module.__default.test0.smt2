...
(let ((anon3_Then_correct  (=> (Requires1 TInt TInt $Heap |_module.__default.ref1#Handle| ($Box intType (int_2_U |a#0|))) (=> (and (and ($IsAlloc intType (int_2_U |a#0|) TInt $Heap) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.valid#canCall| |a#0|)) (or (_module.__default.valid |a#0|) (> |a#0| 0))))))
