...
(declare-fun |_module.__default.succ#requires| (Int) Bool)
...
(declare-fun _module.__default.succ (Int) Int)
(declare-fun |_module.__default.succ#canCall| (Int) Bool)
(declare-fun LitInt (Int) Int)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun $OneHeap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |Set#Equal| (T@U T@U) Bool)
(declare-fun |_module.__default.succ#Handle| () T@U)
...
(assert (distinct TBool TInt TagBool TagInt TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1|)
)
...
(assert (forall ((|x#0| Int) ) (! (= (|_module.__default.succ#requires| |x#0|) (> |x#0| 0))
 :qid |Simpledfy.52:15|
 :skolemid |540|
 :pattern ( (|_module.__default.succ#requires| |x#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|_module.__default.succ#canCall| |x#0@@0|) (and (< 0 $FunctionContextHeight) (> |x#0@@0| 0))) (= (_module.__default.succ |x#0@@0|) (+ |x#0@@0| 1)))
 :qid |Simpledfy.52:15|
 :skolemid |541|
 :pattern ( (_module.__default.succ |x#0@@0|))
))))
...
(assert (forall (($heap@@3 T@U) (|$fh$0x#0@@3| Int) ) (! (= (_module.__default.succ |$fh$0x#0@@3|) (U_2_int ($Unbox intType (Apply1 TInt TInt $heap@@3 |_module.__default.succ#Handle| ($Box intType (int_2_U |$fh$0x#0@@3|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |549|
 :pattern ( (_module.__default.succ |$fh$0x#0@@3|) ($IsGoodHeap $heap@@3))
)))
...
(assert (forall (($heap@@4 T@U) (|$fh$0x#0@@4| T@U) ) (! (= (Requires1 TInt TInt $heap@@4 |_module.__default.succ#Handle| |$fh$0x#0@@4|) (|_module.__default.succ#requires| (U_2_int ($Unbox intType |$fh$0x#0@@4|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |547|
 :pattern ( (Requires1 TInt TInt $heap@@4 |_module.__default.succ#Handle| |$fh$0x#0@@4|))
)))
...
(assert (forall ((|#$T0@@3| T@U) (|#$R@@3| T@U) ($self@@3 T@U) ($heap@@5 T@U) (|$fh$0x#0@@5| T@U) ) (! (= (Requires1 |#$T0@@3| TBool $heap@@5 (|Requires1#Handle| |#$T0@@3| |#$R@@3| $self@@3) |$fh$0x#0@@5|) true)
 :qid |unknown.0:0|
 :skolemid |573|
 :pattern ( (Requires1 |#$T0@@3| TBool $heap@@5 (|Requires1#Handle| |#$T0@@3| |#$R@@3| $self@@3) |$fh$0x#0@@5|))
)))
...
(assert (forall (($bx@@1 T@U) ($heap@@6 T@U) (|$fh$0x#0@@6| T@U) ) (! (= (|Set#IsMember| (Reads1 TInt TInt $heap@@6 |_module.__default.succ#Handle| |$fh$0x#0@@6|) $bx@@1) false)
 :qid |unknown.0:0|
 :skolemid |548|
 :pattern ( (|Set#IsMember| (Reads1 TInt TInt $heap@@6 |_module.__default.succ#Handle| |$fh$0x#0@@6|) $bx@@1))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@1| Int) ) (!  (=> (or (|_module.__default.succ#canCall| (LitInt |x#0@@1|)) (and (< 0 $FunctionContextHeight) (U_2_bool (Lit boolType (bool_2_U (> |x#0@@1| 0)))))) (= (_module.__default.succ (LitInt |x#0@@1|)) (LitInt (+ |x#0@@1| 1))))
 :qid |Simpledfy.52:15|
 :weight 3
 :skolemid |542|
 :pattern ( (_module.__default.succ (LitInt |x#0@@1|)))
))))
...
(assert (forall (($heap@@7 T@U) (|$fh$0x#0@@7| T@U) ) (! (= (Apply1 TInt TInt $heap@@7 |_module.__default.succ#Handle| |$fh$0x#0@@7|) ($Box intType (int_2_U (_module.__default.succ (U_2_int ($Unbox intType |$fh$0x#0@@7|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |546|
 :pattern ( (Apply1 TInt TInt $heap@@7 |_module.__default.succ#Handle| |$fh$0x#0@@7|))
)))
(assert (forall ((|#$T0@@5| T@U) (|#$R@@5| T@U) ($self@@4 T@U) ($heap@@8 T@U) (|$fh$0x#0@@8| T@U) ) (! (= (Reads1 |#$T0@@5| |#$R@@5| $heap@@8 $self@@4 |$fh$0x#0@@8|) ($Unbox SetType (Apply1 |#$T0@@5| (TSet Tclass._System.object?) $heap@@8 (|Reads1#Handle| |#$T0@@5| |#$R@@5| $self@@4) |$fh$0x#0@@8|)))
 :qid |unknown.0:0|
 :skolemid |580|
 :pattern ( (Reads1 |#$T0@@5| |#$R@@5| $heap@@8 $self@@4 |$fh$0x#0@@8|))
)))
...
(assert (forall ((|#$T0@@6| T@U) (|#$R@@6| T@U) ($self@@5 T@U) ($heap@@9 T@U) (|$fh$0x#0@@9| T@U) ) (! (= (Requires1 |#$T0@@6| (TSet Tclass._System.object?) $heap@@9 (|Reads1#Handle| |#$T0@@6| |#$R@@6| $self@@5) |$fh$0x#0@@9|) (Requires1 |#$T0@@6| |#$R@@6| $heap@@9 $self@@5 |$fh$0x#0@@9|))
 :qid |unknown.0:0|
 :skolemid |578|
 :pattern ( (Requires1 |#$T0@@6| (TSet Tclass._System.object?) $heap@@9 (|Reads1#Handle| |#$T0@@6| |#$R@@6| $self@@5) |$fh$0x#0@@9|))
)))
...
(assert (forall ((v@@2 T@U) (t0@@5 T@U) (h@@2 T@U) ) (! (= ($IsAlloc SetType v@@2 (TSet t0@@5) h@@2) (forall ((bx@@6 T@U) ) (!  (=> (|Set#IsMember| v@@2 bx@@6) ($IsAllocBox bx@@6 t0@@5 h@@2))
...
(assert (forall ((|#$T0@@7| T@U) (|#$R@@7| T@U) ) (! (= (Tclass._System.___hFunc1_0 (Tclass._System.___hFunc1 |#$T0@@7| |#$R@@7|)) |#$T0@@7|)
 :qid |unknown.0:0|
 :skolemid |367|
 :pattern ( (Tclass._System.___hFunc1 |#$T0@@7| |#$R@@7|))
)))
(assert (forall ((|#$T0@@8| T@U) (|#$R@@8| T@U) ) (! (= (Tclass._System.___hFunc1_1 (Tclass._System.___hFunc1 |#$T0@@8| |#$R@@8|)) |#$R@@8|)
 :qid |unknown.0:0|
 :skolemid |368|
 :pattern ( (Tclass._System.___hFunc1 |#$T0@@8| |#$R@@8|))
)))
(assert (forall ((|#$T0@@9| T@U) (|#$R@@9| T@U) ) (! (= (Tclass._System.___hPartialFunc1_0 (Tclass._System.___hPartialFunc1 |#$T0@@9| |#$R@@9|)) |#$T0@@9|)
 :qid |unknown.0:0|
 :skolemid |398|
 :pattern ( (Tclass._System.___hPartialFunc1 |#$T0@@9| |#$R@@9|))
)))
(assert (forall ((|#$T0@@10| T@U) (|#$R@@10| T@U) ) (! (= (Tclass._System.___hPartialFunc1_1 (Tclass._System.___hPartialFunc1 |#$T0@@10| |#$R@@10|)) |#$R@@10|)
 :qid |unknown.0:0|
 :skolemid |399|
...
(assert (forall ((|#$T0@@11| T@U) (|#$R@@11| T@U) (|f#0@@0| T@U) ) (! (= ($Is HandleTypeType |f#0@@0| (Tclass._System.___hPartialFunc1 |#$T0@@11| |#$R@@11|))  (and ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 |#$T0@@11| |#$R@@11|)) (forall ((|x0#0| T@U) ) (!  (=> ($IsBox |x0#0| |#$T0@@11|) (|Set#Equal| (Reads1 |#$T0@@11| |#$R@@11| $OneHeap |f#0@@0| |x0#0|) |Set#Empty|))
 :qid |unknown.0:0|
 :skolemid |401|
))))
 :qid |unknown.0:0|
 :skolemid |402|
 :pattern ( ($Is HandleTypeType |f#0@@0| (Tclass._System.___hPartialFunc1 |#$T0@@11| |#$R@@11|)))
)))
...
(assert (forall ((|#$T0@@12| T@U) (|#$R@@12| T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._System.___hFunc1 |#$T0@@12| |#$R@@12|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@7)) bx@@7) ($Is HandleTypeType ($Unbox HandleTypeType bx@@7) (Tclass._System.___hFunc1 |#$T0@@12| |#$R@@12|))))
 :qid |unknown.0:0|
 :skolemid |369|
 :pattern ( ($IsBox bx@@7 (Tclass._System.___hFunc1 |#$T0@@12| |#$R@@12|)))
)))
(assert (forall ((|#$T0@@13| T@U) (|#$R@@13| T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._System.___hPartialFunc1 |#$T0@@13| |#$R@@13|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@8)) bx@@8) ($Is HandleTypeType ($Unbox HandleTypeType bx@@8) (Tclass._System.___hPartialFunc1 |#$T0@@13| |#$R@@13|))))
 :qid |unknown.0:0|
 :skolemid |400|
 :pattern ( ($IsBox bx@@8 (Tclass._System.___hPartialFunc1 |#$T0@@13| |#$R@@13|)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#30| |l#0| |l#1| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@1) |l#2|)))) |l#3|))
...
(assert (forall ((|#$T0@@15| T@U) (|#$R@@15| T@U) ) (!  (and (= (Tag (Tclass._System.___hPartialFunc1 |#$T0@@15| |#$R@@15|)) Tagclass._System.___hPartialFunc1) (= (TagFamily (Tclass._System.___hPartialFunc1 |#$T0@@15| |#$R@@15|)) |tytagFamily$_#PartialFunc1|))
 :qid |unknown.0:0|
 :skolemid |397|
...
(assert (forall ((|#$T0@@16| T@U) (|#$R@@16| T@U) ($self@@6 T@U) ($heap@@10 T@U) (|$fh$0x#0@@10| T@U) ) (! (= (Apply1 |#$T0@@16| (TSet Tclass._System.object?) $heap@@10 (|Reads1#Handle| |#$T0@@16| |#$R@@16| $self@@6) |$fh$0x#0@@10|) ($Box SetType (Reads1 |#$T0@@16| |#$R@@16| $heap@@10 $self@@6 |$fh$0x#0@@10|)))
 :qid |unknown.0:0|
 :skolemid |577|
 :pattern ( (Apply1 |#$T0@@16| (TSet Tclass._System.object?) $heap@@10 (|Reads1#Handle| |#$T0@@16| |#$R@@16| $self@@6) |$fh$0x#0@@10|))
)))
...
(declare-fun |suc#0@0| () T@U)
(declare-fun |##x#0@0| () Int)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |suc#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Main2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#30| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |suc#0@0| |_module.__default.succ#Handle|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (Requires1 TInt TInt $Heap |suc#0@0| ($Box intType (int_2_U (LitInt 3))))) (=> (Requires1 TInt TInt $Heap |suc#0@0| ($Box intType (int_2_U (LitInt 3)))) (=> (and (= |##x#0@0| (LitInt 3)) ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (> |##x#0@0| 0)) (=> (and (|_module.__default.succ#canCall| (LitInt 3)) (|_module.__default.succ#canCall| (LitInt 3))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |suc#0@0| ($Box intType (int_2_U (LitInt 3)))))) (LitInt (_module.__default.succ (LitInt 3))))) (=> (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |suc#0@0| ($Box intType (int_2_U (LitInt 3)))))) (LitInt (_module.__default.succ (LitInt 3)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 TInt TInt $Heap |suc#0@0| ($Box intType (int_2_U (LitInt (- 0 1)))))) (=> (Requires1 TInt TInt $Heap |suc#0@0| ($Box intType (int_2_U (LitInt (- 0 1))))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |suc#0@0| ($Box intType (int_2_U (LitInt (- 0 1))))))) (LitInt 0))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |suc#0| (Tclass._System.___hPartialFunc1 TInt TInt)) ($IsAlloc HandleTypeType |suc#0| (Tclass._System.___hPartialFunc1 TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct))))
