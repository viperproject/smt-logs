...
(let ((anon509_Else_correct  (=> (forall ((|$l#0_5_0_0_3_9#x#0| T@U) ) (! (|_module.__default.Sum#canCall| |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#0_5_0_0_3_9#x#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |unknown.0:0|
 :skolemid |640|
)) (=> (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (=> (and (and (and (forall ((|$l#15#x#0| T@U) ) (! (|_module.__default.Sum#canCall| |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#15#x#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |unknown.0:0|
 :skolemid |554|
...
(let ((anon536_Else_correct  (=> (and (forall ((|$l#0_5_30#x#0| T@U) ) (! (|_module.__default.Sum#canCall| |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#0_5_30#x#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |unknown.0:0|
 :skolemid |646|
)) (= |f##0_5_0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#57| |n#0@@3| TInt TInt TInt |g#0| (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false)))) ($LS $LZ))))) (and (=> (= (ControlFlow 0 244) 243) anon540_Then_correct) (=> (= (ControlFlow 0 244) 235) anon540_Else_correct)))))
...
(let ((anon578_Else_correct  (=> (and (forall ((|$l#0_3_68#w#0| T@U) ) (! (|_module.__default.Sum#canCall| |n'#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#43| TInt TInt TInt |g#0| ($Box intType |$l#0_3_68#w#0|)) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))))
 :qid |unknown.0:0|
 :skolemid |622|
