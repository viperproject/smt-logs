...
(declare-fun ReadsAll.__default.B (T@U T@U) Int)
(declare-fun |ReadsAll.__default.B#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0| T@U) ) (!  (=> (or (|ReadsAll.__default.B#canCall| $Heap |f#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TInt))) (forall ((|x#2| Int) ) (! (Requires1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |x#2|)))
 :qid |ReadsReadsdfy.122:21|
 :skolemid |2051|
 :pattern ( (Requires1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |x#2|))))
))))) (= (ReadsAll.__default.B $Heap |f#0|) (+ (+ (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 0)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 1))))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 2)))))))))
 :qid |ReadsReadsdfy.120:12|
 :skolemid |2053|
 :pattern ( (ReadsAll.__default.B $Heap |f#0|) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$ReadsAll.__default.B)
