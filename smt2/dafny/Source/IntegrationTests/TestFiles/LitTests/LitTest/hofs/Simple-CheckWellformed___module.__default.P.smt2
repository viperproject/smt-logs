...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.P$A T@U) (_module._default.P$B T@U) ($Heap T@U) (|f#0| T@U) (|x#0| T@U) ) (!  (=> (or (|_module.__default.P#canCall| _module._default.P$A _module._default.P$B $Heap |f#0| |x#0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 _module._default.P$A _module._default.P$B)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 _module._default.P$A _module._default.P$B) $Heap))) (and ($IsBox |x#0| _module._default.P$A) ($IsAllocBox |x#0| _module._default.P$A $Heap))) (Requires1 _module._default.P$A _module._default.P$B $Heap |f#0| |x#0|)))) ($IsBox (_module.__default.P _module._default.P$A _module._default.P$B $Heap |f#0| |x#0|) _module._default.P$B))
 :qid |unknown.0:0|
 :skolemid |568|
 :pattern ( (_module.__default.P _module._default.P$A _module._default.P$B $Heap |f#0| |x#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.P$A@@0 T@U) (_module._default.P$B@@0 T@U) ($Heap@@0 T@U) (|f#0@@0| T@U) (|x#0@@0| T@U) ) (!  (=> (or (|_module.__default.P#canCall| _module._default.P$A@@0 _module._default.P$B@@0 $Heap@@0 |f#0@@0| |x#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) (and ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 _module._default.P$A@@0 _module._default.P$B@@0)) ($IsAlloc HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 _module._default.P$A@@0 _module._default.P$B@@0) $Heap@@0))) (and ($IsBox |x#0@@0| _module._default.P$A@@0) ($IsAllocBox |x#0@@0| _module._default.P$A@@0 $Heap@@0))) (Requires1 _module._default.P$A@@0 _module._default.P$B@@0 $Heap@@0 |f#0@@0| |x#0@@0|)))) ($IsAllocBox (_module.__default.P _module._default.P$A@@0 _module._default.P$B@@0 $Heap@@0 |f#0@@0| |x#0@@0|) _module._default.P$B@@0 $Heap@@0))
 :qid |unknown.0:0|
 :skolemid |569|
 :pattern ( ($IsAllocBox (_module.__default.P _module._default.P$A@@0 _module._default.P$B@@0 $Heap@@0 |f#0@@0| |x#0@@0|) _module._default.P$B@@0 $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.P$A@@1 T@U) (_module._default.P$B@@1 T@U) ($Heap@@1 T@U) (|f#0@@1| T@U) (|x#0@@1| T@U) ) (!  (=> (or (|_module.__default.P#canCall| _module._default.P$A@@1 _module._default.P$B@@1 $Heap@@1 |f#0@@1| |x#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 _module._default.P$A@@1 _module._default.P$B@@1))) ($IsBox |x#0@@1| _module._default.P$A@@1)) (Requires1 _module._default.P$A@@1 _module._default.P$B@@1 $Heap@@1 |f#0@@1| |x#0@@1|)))) (= (_module.__default.P _module._default.P$A@@1 _module._default.P$B@@1 $Heap@@1 |f#0@@1| |x#0@@1|) (Apply1 _module._default.P$A@@1 _module._default.P$B@@1 $Heap@@1 |f#0@@1| |x#0@@1|)))
 :qid |unknown.0:0|
 :skolemid |571|
 :pattern ( (_module.__default.P _module._default.P$A@@1 _module._default.P$B@@1 $Heap@@1 |f#0@@1| |x#0@@1|) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((_module._default.P$A@@2 T@U) (_module._default.P$B@@2 T@U) ($heap@@5 T@U) (|$fh$0x#0@@5| T@U) (|$fh$0x#1| T@U) ) (! (= (_module.__default.P _module._default.P$A@@2 _module._default.P$B@@2 $heap@@5 |$fh$0x#0@@5| |$fh$0x#1|) (Apply2 (Tclass._System.___hFunc1 _module._default.P$A@@2 _module._default.P$B@@2) _module._default.P$A@@2 _module._default.P$B@@2 $heap@@5 (|_module.__default.P#Handle| _module._default.P$A@@2 _module._default.P$B@@2) ($Box HandleTypeType |$fh$0x#0@@5|) |$fh$0x#1|))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( (_module.__default.P _module._default.P$A@@2 _module._default.P$B@@2 $heap@@5 |$fh$0x#0@@5| |$fh$0x#1|))
)))
(assert (forall ((|#$T0@@5| T@U) (|#$R@@5| T@U) ($self@@5 T@U) ($heap@@6 T@U) (|$fh$0x#0@@6| T@U) ) (! (= (Requires1 |#$T0@@5| (TSet Tclass._System.object?) $heap@@6 (|Reads1#Handle| |#$T0@@5| |#$R@@5| $self@@5) |$fh$0x#0@@6|) (Requires1 |#$T0@@5| |#$R@@5| $heap@@6 $self@@5 |$fh$0x#0@@6|))
 :qid |unknown.0:0|
 :skolemid |578|
 :pattern ( (Requires1 |#$T0@@5| (TSet Tclass._System.object?) $heap@@6 (|Reads1#Handle| |#$T0@@5| |#$R@@5| $self@@5) |$fh$0x#0@@6|))
)))
...
(assert (forall ((_module._default.P$A@@3 T@U) (_module._default.P$B@@3 T@U) ($heap@@7 T@U) (|$fh$0x#0@@7| T@U) (|$fh$0x#1@@0| T@U) ) (! (= (Apply2 (Tclass._System.___hFunc1 _module._default.P$A@@3 _module._default.P$B@@3) _module._default.P$A@@3 _module._default.P$B@@3 $heap@@7 (|_module.__default.P#Handle| _module._default.P$A@@3 _module._default.P$B@@3) |$fh$0x#0@@7| |$fh$0x#1@@0|) (_module.__default.P _module._default.P$A@@3 _module._default.P$B@@3 $heap@@7 ($Unbox HandleTypeType |$fh$0x#0@@7|) |$fh$0x#1@@0|))
 :qid |unknown.0:0|
 :skolemid |583|
 :pattern ( (Apply2 (Tclass._System.___hFunc1 _module._default.P$A@@3 _module._default.P$B@@3) _module._default.P$A@@3 _module._default.P$B@@3 $heap@@7 (|_module.__default.P#Handle| _module._default.P$A@@3 _module._default.P$B@@3) |$fh$0x#0@@7| |$fh$0x#1@@0|))
)))
...
(assert (forall ((|#$T0@@10| T@U) (|#$R@@10| T@U) ($self@@6 T@U) ($heap@@8 T@U) (|$fh$0x#0@@8| T@U) ) (! (= (Apply1 |#$T0@@10| (TSet Tclass._System.object?) $heap@@8 (|Reads1#Handle| |#$T0@@10| |#$R@@10| $self@@6) |$fh$0x#0@@8|) ($Box SetType (Reads1 |#$T0@@10| |#$R@@10| $heap@@8 $self@@6 |$fh$0x#0@@8|)))
 :qid |unknown.0:0|
 :skolemid |577|
 :pattern ( (Apply1 |#$T0@@10| (TSet Tclass._System.object?) $heap@@8 (|Reads1#Handle| |#$T0@@10| |#$R@@10| $self@@6) |$fh$0x#0@@8|))
)))
...
(declare-fun _module._default.P$A@@4 () T@U)
(declare-fun _module._default.P$B@@4 () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 _module._default.P$A@@4 _module._default.P$B@@4 $Heap@@2 |f#0@@2| |x#0@@2|)) (=> (Requires1 _module._default.P$A@@4 _module._default.P$B@@4 $Heap@@2 |f#0@@2| |x#0@@2|) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@2) alloc)))) (|Set#IsMember| (Reads1 _module._default.P$A@@4 _module._default.P$B@@4 $Heap@@2 |f#0@@2| |x#0@@2|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |Simpledfy.81:3|
 :skolemid |582|
))) (= (_module.__default.P _module._default.P$A@@4 _module._default.P$B@@4 $Heap@@2 |f#0@@2| |x#0@@2|) (Apply1 _module._default.P$A@@4 _module._default.P$B@@4 $Heap@@2 |f#0@@2| |x#0@@2|))) (and ($IsBox (_module.__default.P _module._default.P$A@@4 _module._default.P$B@@4 $Heap@@2 |f#0@@2| |x#0@@2|) _module._default.P$B@@4) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#2@0|)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#130| null $Heap@@2 alloc (Reads1 _module._default.P$A@@4 _module._default.P$B@@4 $Heap@@2 |f#0@@2| |x#0@@2|))) (and (=> (= (ControlFlow 0 5) (- 0 13)) true) (and (=> (= (ControlFlow 0 5) (- 0 12)) (Requires1 _module._default.P$A@@4 TBool $Heap@@2 (|Requires1#Handle| _module._default.P$A@@4 _module._default.P$B@@4 |f#0@@2|) |x#0@@2|)) (=> (Requires1 _module._default.P$A@@4 TBool $Heap@@2 (|Requires1#Handle| _module._default.P$A@@4 _module._default.P$B@@4 |f#0@@2|) |x#0@@2|) (=> (and (= |b$reqreads#0@0| (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@3) alloc)))) (|Set#IsMember| (Reads1 _module._default.P$A@@4 TBool $Heap@@2 (|Requires1#Handle| _module._default.P$A@@4 _module._default.P$B@@4 |f#0@@2|) |x#0@@2|) ($Box refType $o@@3))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@3 $f@@1)))
 :qid |Simpledfy.79:12|
 :skolemid |576|
))) (Requires1 _module._default.P$A@@4 _module._default.P$B@@4 $Heap@@2 |f#0@@2| |x#0@@2|)) (and (=> (= (ControlFlow 0 5) (- 0 11)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 5) (- 0 10)) true) (and (=> (= (ControlFlow 0 5) (- 0 9)) (Requires1 _module._default.P$A@@4 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| _module._default.P$A@@4 _module._default.P$B@@4 |f#0@@2|) |x#0@@2|)) (=> (Requires1 _module._default.P$A@@4 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| _module._default.P$A@@4 _module._default.P$B@@4 |f#0@@2|) |x#0@@2|) (=> (= |b$reqreads#1@0| (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@4) alloc)))) (|Set#IsMember| (Reads1 _module._default.P$A@@4 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| _module._default.P$A@@4 _module._default.P$B@@4 |f#0@@2|) |x#0@@2|) ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@2)))
 :qid |Simpledfy.78:9|
 :skolemid |581|
))) (and (=> (= (ControlFlow 0 5) (- 0 8)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 5) (- 0 7)) true) (and (=> (= (ControlFlow 0 5) (- 0 6)) (Requires1 _module._default.P$A@@4 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| _module._default.P$A@@4 _module._default.P$B@@4 |f#0@@2|) |x#0@@2|)) (=> (Requires1 _module._default.P$A@@4 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| _module._default.P$A@@4 _module._default.P$B@@4 |f#0@@2|) |x#0@@2|) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is HandleTypeType |f#0@@2| (Tclass._System.___hFunc1 _module._default.P$A@@4 _module._default.P$B@@4)) ($IsBox |x#0@@2| _module._default.P$A@@4)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 5))) anon0_correct))))
