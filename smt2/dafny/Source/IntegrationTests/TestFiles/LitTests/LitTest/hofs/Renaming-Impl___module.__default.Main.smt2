...
(declare-fun |lambda#145| (T@U T@U T@U Int Int) T@U)
...
(declare-fun |lambda#140| (T@U T@U T@U Real) T@U)
...
(assert (distinct TBool TInt TReal TagBool TagInt TagReal TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1|)
)
...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Int) (|l#4| Int) (|$l#2#heap#0| T@U) (|$l#2#b#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#145| |l#0@@0| |l#1| |l#2| |l#3| |l#4|) |$l#2#heap#0| |$l#2#b#0|) ($Box intType (int_2_U (ite (U_2_bool ($Unbox boolType (Apply1 |l#0@@0| |l#1| |$l#2#heap#0| ($Unbox HandleTypeType |$l#2#b#0|) |l#2|))) |l#3| |l#4|))))
 :qid |DafnyPreludebpl.21:1|
 :skolemid |511|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#145| |l#0@@0| |l#1| |l#2| |l#3| |l#4|) |$l#2#heap#0| |$l#2#b#0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Real) (|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#140| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) |$l#0#heap#0@@0| |$l#0#x#0@@0|) ($Box boolType (bool_2_U (<= (U_2_real ($Unbox realType (Apply1 |l#0@@3| |l#1@@0| |$l#0#heap#0@@0| ($Unbox HandleTypeType |$l#0#x#0@@0|) |l#2@@0|))) |l#3@@0|))))
 :qid |DafnyPreludebpl.30:1|
 :skolemid |510|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#140| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) |$l#0#heap#0@@0| |$l#0#x#0@@0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@1| T@U) (|l#2@@1| T@U) (|l#3@@1| Bool) ($o@@2 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#61| |l#0@@4| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@2 $f@@0))  (=> (and (or (not (= $o@@2 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@1| $o@@2) |l#2@@1|)))) |l#3@@1|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |505|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#61| |l#0@@4| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@2 $f@@0))
)))
...
(assert (forall ((|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#0| |$l#0#heap#0@@1| |$l#0#x#0@@1|) ($Box boolType ($Unbox boolType |$l#0#x#0@@1|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |499|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#0| |$l#0#heap#0@@1| |$l#0#x#0@@1|))
)))
...
(assert (forall ((|l#0@@5| T@U) (|$l#0#heap#0@@2| T@U) (|$l#0#x#0@@2| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@5|) |$l#0#heap#0@@2| |$l#0#x#0@@2|) |l#0@@5|)
 :qid |Renamingdfy.4:17|
 :skolemid |502|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@5|) |$l#0#heap#0@@2| |$l#0#x#0@@2|))
)))
...
(let ((anon16_Else_correct  (=> (and (not (and ($Is HandleTypeType |x#0@0| (Tclass._System.___hTotalFunc1 TReal TReal)) ($IsAlloc HandleTypeType |x#0@0| (Tclass._System.___hTotalFunc1 TReal TReal) |$lambdaHeap#0@0|))) (= (ControlFlow 0 18) 16)) anon3_correct)))
(let ((anon16_Then_correct  (=> (and ($Is HandleTypeType |x#0@0| (Tclass._System.___hTotalFunc1 TReal TReal)) ($IsAlloc HandleTypeType |x#0@0| (Tclass._System.___hTotalFunc1 TReal TReal) |$lambdaHeap#0@0|)) (=> (and (and (= |$_Frame#l0@0| (|lambda#61| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (<= (U_2_real ($Unbox realType (Apply1 TReal TReal $Heap@0 |x#0@0| ($Box realType (real_2_U (LitReal 25.0)))))) (LitReal 25.0)))) (and ($Is boolType (bool_2_U |lambdaResult#0|) TBool) (= (ControlFlow 0 17) 16))) anon3_correct))))
(let ((anon15_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 19) 17) anon16_Then_correct) (=> (= (ControlFlow 0 19) 18) anon16_Else_correct)))))
(let ((anon9_correct true))
(let ((anon19_Else_correct  (=> (and (and (not (U_2_bool ($Unbox boolType (Apply1 TBool TBool |$lambdaHeap#1@0| |b#0@0| ($Box boolType (Lit boolType (bool_2_U true))))))) (= |lambdaResult#1| (LitInt 11))) (and ($Is intType (int_2_U |lambdaResult#1|) TInt) (= (ControlFlow 0 10) 7))) anon9_correct)))
(let ((anon19_Then_correct  (=> (and (and (U_2_bool ($Unbox boolType (Apply1 TBool TBool |$lambdaHeap#1@0| |b#0@0| ($Box boolType (Lit boolType (bool_2_U true)))))) (= |lambdaResult#1| (LitInt 10))) (and ($Is intType (int_2_U |lambdaResult#1|) TInt) (= (ControlFlow 0 9) 7))) anon9_correct)))
(let ((anon18_Then_correct  (=> (and (and ($Is HandleTypeType |b#0@0| (Tclass._System.___hTotalFunc1 TBool TBool)) ($IsAlloc HandleTypeType |b#0@0| (Tclass._System.___hTotalFunc1 TBool TBool) |$lambdaHeap#1@0|)) (= |$_Frame#l1@0| (|lambda#61| null |$lambdaHeap#1@0| alloc false))) (and (=> (= (ControlFlow 0 11) 9) anon19_Then_correct) (=> (= (ControlFlow 0 11) 10) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (and ($Is HandleTypeType |b#0@0| (Tclass._System.___hTotalFunc1 TBool TBool)) ($IsAlloc HandleTypeType |b#0@0| (Tclass._System.___hTotalFunc1 TBool TBool) |$lambdaHeap#1@0|))) (= (ControlFlow 0 8) 7)) anon9_correct)))
(let ((anon17_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap@1 |$lambdaHeap#1@0|) ($HeapSucc $Heap@1 |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 12) 11) anon18_Then_correct) (=> (= (ControlFlow 0 12) 8) anon18_Else_correct)))))
(let ((anon21_Else_correct true))
(let ((anon21_Then_correct true))
(let ((anon20_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2@0|) (or (= $Heap@1 |$lambdaHeap#2@0|) ($HeapSucc $Heap@1 |$lambdaHeap#2@0|))) (and (=> (= (ControlFlow 0 4) 2) anon21_Then_correct) (=> (= (ControlFlow 0 4) 3) anon21_Else_correct)))))
(let ((anon20_Else_correct true))
(let ((anon17_Else_correct  (=> (and (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#145| TBool TBool ($Box boolType (Lit boolType (bool_2_U true))) 10 11) (|lambda#1| (Tclass._System.___hTotalFunc1 TBool TBool)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt) $Heap@1)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (Requires1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $Heap@1 |f#0@0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))) (=> (and (and (Requires1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $Heap@1 |f#0@0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))) (|_module.__default.OnId#canCall| $Heap@1 |f#0@0|)) (and (|_module.__default.OnId#canCall| $Heap@1 |f#0@0|) (= |x#1@0| (_module.__default.OnId $Heap@1 |f#0@0|)))) (and (=> (= (ControlFlow 0 5) 4) anon20_Then_correct) (=> (= (ControlFlow 0 5) 1) anon20_Else_correct)))))))
(let ((anon15_Else_correct  (=> (= |p#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#140| TReal TReal ($Box realType (real_2_U (LitReal 25.0))) (LitReal 25.0)) (|lambda#1| (Tclass._System.___hTotalFunc1 TReal TReal)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (Requires1 (Tclass._System.___hTotalFunc1 TReal TReal) TBool $Heap@0 |p#0@0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#78| (|lambda#1| TReal) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))) (=> (Requires1 (Tclass._System.___hTotalFunc1 TReal TReal) TBool $Heap@0 |p#0@0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#78| (|lambda#1| TReal) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (U_2_bool ($Unbox boolType (Apply1 (Tclass._System.___hTotalFunc1 TReal TReal) TBool $Heap@0 |p#0@0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#78| (|lambda#1| TReal) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))) (=> (U_2_bool ($Unbox boolType (Apply1 (Tclass._System.___hTotalFunc1 TReal TReal) TBool $Heap@0 |p#0@0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#78| (|lambda#1| TReal) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (forall (($o@@3 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@3) alloc)))) (= (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@3) (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@3)))
 :qid |Renamingdfy.17:8|
 :skolemid |492|
 :pattern ( (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@3))
)) ($HeapSucc $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 13) 12) anon17_Then_correct) (=> (= (ControlFlow 0 13) 5) anon17_Else_correct))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#61| null $Heap@@0 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $o@@4) alloc)))) (= (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@4) (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $o@@4)))
 :qid |Renamingdfy.10:8|
 :skolemid |487|
 :pattern ( (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap@@0 $Heap@0))) (and (=> (= (ControlFlow 0 20) 19) anon15_Then_correct) (=> (= (ControlFlow 0 20) 13) anon15_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is HandleTypeType |p#0| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 TReal TReal) TBool)) ($IsAlloc HandleTypeType |p#0| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 TReal TReal) TBool) $Heap@@0)) true) (=> (and (and (and ($Is HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt)) ($IsAlloc HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt) $Heap@@0)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 21) 20))) anon0_correct)))))
