...
(declare-fun |##x0#0_0@0| () Int)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.HeapSucc2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon6_Else_correct  (=> (|Set#IsMember| (Reads1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0)))) ($Box refType |c#0@@1|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (Requires1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0)))) (=> (= (ControlFlow 0 6) (- 0 5)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0)))))) |init#0@0|)))))))
(let ((anon6_Then_correct  (=> (not (|Set#IsMember| (Reads1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0)))) ($Box refType |c#0@@1|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0)))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0)))))) |init#0@0|)))))))
(let ((anon5_Then_correct  (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 12)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 11)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.u))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.C.u)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (=> (and (= |$rhs#0_0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.u))) 1)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |c#0@@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.u ($Box intType (int_2_U |$rhs#0_0@0|)))))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsAllocBox ($Box HandleTypeType |k#0|) (Tclass._System.___hFunc1 TInt TInt) $Heap@0)) (and (= |##x0#0_0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##x0#0_0@0|) TInt $Heap@0))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (Requires1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TInt $Heap@0 |k#0| ($Box intType (int_2_U (LitInt 0)))) (and (=> (= (ControlFlow 0 8) 3) anon6_Then_correct) (=> (= (ControlFlow 0 8) 6) anon6_Else_correct)))))))))))))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#7| null $Heap alloc |c#0@@1|)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (Requires1 TInt TInt $Heap |k#0| ($Box intType (int_2_U (LitInt 0))))) (=> (Requires1 TInt TInt $Heap |k#0| ($Box intType (int_2_U (LitInt 0)))) (=> (= |init#0@0| (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |k#0| ($Box intType (int_2_U (LitInt 0))))))) (and (=> (= (ControlFlow 0 13) 8) anon5_Then_correct) (=> (= (ControlFlow 0 13) 1) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |k#0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |k#0| (Tclass._System.___hFunc1 TInt TInt) $Heap))) (=> (and (and (and ($Is refType |c#0@@1| Tclass._module.C?) ($IsAlloc refType |c#0@@1| Tclass._module.C? $Heap)) (= 0 $FunctionContextHeight)) (and (Requires1 TInt TInt $Heap |k#0| ($Box intType (int_2_U (LitInt 0)))) (= (ControlFlow 0 15) 13))) anon0_correct))))
