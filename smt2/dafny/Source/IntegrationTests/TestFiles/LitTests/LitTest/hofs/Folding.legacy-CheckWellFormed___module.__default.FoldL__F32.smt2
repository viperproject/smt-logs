...
(declare-fun |_module.__default.F32#Handle| () T@U)
...
(declare-fun |_module.__default.F32#requires| (Int Int) Bool)
(declare-fun |$IsA#_module.List| (T@U) Bool)
(declare-fun _module.__default.F32 (Int Int) Int)
(declare-fun |_module.__default.F32#canCall| (Int Int) Bool)
...
(assert (forall (($bx T@U) ($heap T@U) (|$fh$0x#0| T@U) (|$fh$0x#1| T@U) ) (! (= (|Set#IsMember| (Reads2 TInt TInt TInt $heap |_module.__default.F32#Handle| |$fh$0x#0| |$fh$0x#1|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |741|
 :pattern ( (|Set#IsMember| (Reads2 TInt TInt TInt $heap |_module.__default.F32#Handle| |$fh$0x#0| |$fh$0x#1|) $bx))
)))
...
(assert (forall ((|b#0@@4| Int) (|a#0| Int) ) (! (= (|_module.__default.F32#requires| |b#0@@4| |a#0|) true)
 :qid |Foldinglegacydfy.220:14|
 :skolemid |736|
 :pattern ( (|_module.__default.F32#requires| |b#0@@4| |a#0|))
)))
...
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) (|$fh$0x#1@@0| T@U) ) (! (= (Requires2 TInt TInt TInt $heap@@0 |_module.__default.F32#Handle| |$fh$0x#0@@0| |$fh$0x#1@@0|) (|_module.__default.F32#requires| (U_2_int ($Unbox intType |$fh$0x#0@@0|)) (U_2_int ($Unbox intType |$fh$0x#1@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |740|
 :pattern ( (Requires2 TInt TInt TInt $heap@@0 |_module.__default.F32#Handle| |$fh$0x#0@@0| |$fh$0x#1@@0|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|b#0@@5| Int) (|a#0@@0| Int) ) (!  (=> (or (|_module.__default.F32#canCall| (LitInt |b#0@@5|) (LitInt |a#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.F32 (LitInt |b#0@@5|) (LitInt |a#0@@0|)) (LitInt (+ (Mul (LitInt 3) (LitInt |b#0@@5|)) (Mul (LitInt 2) (LitInt |a#0@@0|))))))
 :qid |Foldinglegacydfy.220:14|
 :weight 3
 :skolemid |738|
 :pattern ( (_module.__default.F32 (LitInt |b#0@@5|) (LitInt |a#0@@0|)))
))))
...
(assert (forall ((|#$T0@@16| T@U) (|#$T1@@16| T@U) (|#$R@@16| T@U) (|f#0@@6| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@6| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@1) ($IsAlloc HandleTypeType |f#0@@6| (Tclass._System.___hFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@1))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@6| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@1))
)))
(assert (forall ((|#$T0@@17| T@U) (|#$T1@@17| T@U) (|#$R@@17| T@U) (|f#0@@7| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@2) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@2))
 :qid |unknown.0:0|
 :skolemid |527|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@2))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|b#0@@6| Int) (|a#0@@1| Int) ) (!  (=> (or (|_module.__default.F32#canCall| |b#0@@6| |a#0@@1|) (< 0 $FunctionContextHeight)) (= (_module.__default.F32 |b#0@@6| |a#0@@1|) (+ (Mul (LitInt 3) |b#0@@6|) (Mul (LitInt 2) |a#0@@1|))))
 :qid |Foldinglegacydfy.220:14|
 :skolemid |737|
 :pattern ( (_module.__default.F32 |b#0@@6| |a#0@@1|))
))))
...
(assert (forall (($heap@@1 T@U) (|$fh$0x#0@@1| Int) (|$fh$0x#1@@1| Int) ) (! (= (_module.__default.F32 |$fh$0x#0@@1| |$fh$0x#1@@1|) (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $heap@@1 |_module.__default.F32#Handle| ($Box intType (int_2_U |$fh$0x#0@@1|)) ($Box intType (int_2_U |$fh$0x#1@@1|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |742|
 :pattern ( (_module.__default.F32 |$fh$0x#0@@1| |$fh$0x#1@@1|) ($IsGoodHeap $heap@@1))
)))
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) (|$fh$0x#1@@2| T@U) ) (! (= (Apply2 TInt TInt TInt $heap@@2 |_module.__default.F32#Handle| |$fh$0x#0@@2| |$fh$0x#1@@2|) ($Box intType (int_2_U (_module.__default.F32 (U_2_int ($Unbox intType |$fh$0x#0@@2|)) (U_2_int ($Unbox intType |$fh$0x#1@@2|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |739|
 :pattern ( (Apply2 TInt TInt TInt $heap@@2 |_module.__default.F32#Handle| |$fh$0x#0@@2| |$fh$0x#1@@2|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.foldl$A@@4 T@U) (_module._default.foldl$B@@4 T@U) ($ly@@4 T@U) ($Heap@@2 T@U) (|f#0@@8| T@U) (|b#0@@7| T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.foldl#canCall| _module._default.foldl$A@@4 _module._default.foldl$B@@4 |f#0@@8| |b#0@@7| (Lit DatatypeTypeType |xs#0@@4|)) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@2) ($Is HandleTypeType |f#0@@8| (Tclass._System.___hTotalFunc2 _module._default.foldl$B@@4 _module._default.foldl$A@@4 _module._default.foldl$B@@4))) ($IsBox |b#0@@7| _module._default.foldl$B@@4)) ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.foldl$A@@4))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@4|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List._h3 (Lit DatatypeTypeType |xs#0@@4|)))))
(let ((|head#3| (Lit BoxType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@4|)))))
(|_module.__default.foldl#canCall| _module._default.foldl$A@@4 _module._default.foldl$B@@4 |f#0@@8| (Apply2 _module._default.foldl$B@@4 _module._default.foldl$A@@4 _module._default.foldl$B@@4 $Heap@@2 |f#0@@8| |b#0@@7| |head#3|) |tail#3|)))) (= (_module.__default.foldl _module._default.foldl$A@@4 _module._default.foldl$B@@4 ($LS $ly@@4) |f#0@@8| |b#0@@7| (Lit DatatypeTypeType |xs#0@@4|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@4|)) |b#0@@7| (let ((|tail#2| (Lit DatatypeTypeType (_module.List._h3 (Lit DatatypeTypeType |xs#0@@4|)))))
(let ((|head#2| (Lit BoxType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@4|)))))
(_module.__default.foldl _module._default.foldl$A@@4 _module._default.foldl$B@@4 ($LS $ly@@4) |f#0@@8| (Apply2 _module._default.foldl$B@@4 _module._default.foldl$A@@4 _module._default.foldl$B@@4 $Heap@@2 |f#0@@8| |b#0@@7| |head#2|) |tail#2|)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |707|
 :pattern ( (_module.__default.foldl _module._default.foldl$A@@4 _module._default.foldl$B@@4 ($LS $ly@@4) |f#0@@8| |b#0@@7| (Lit DatatypeTypeType |xs#0@@4|)) ($IsGoodHeap $Heap@@2))
))))
...
(declare-fun |b#0@@8| () Int)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |##f#0@0| () T@U)
(declare-fun |xs#0@@5| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.FoldL__F32)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (= (Mod |b#0@@8| (LitInt 2)) (LitInt 0)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@3 $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (= |##f#0@0| |_module.__default.F32#Handle|) ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@0)) (=> (and (and ($IsAlloc intType (int_2_U |b#0@@8|) TInt $Heap@0) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@0)) (and (|_module.__default.foldl#canCall| TInt TInt |_module.__default.F32#Handle| ($Box intType (int_2_U |b#0@@8|)) |xs#0@@5|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= (LitInt 2) 0)) (not true)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3)) (|$IsA#_module.List| |xs#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
