...
(declare-fun List._default.Concat$A@@4 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$List.__default.Concat)
...
(let ((anon9_Else_correct  (=> (or (not (= |xs#0@@4| (|#List.M.Cons| |_mcc#0#0| |_mcc#1#0|))) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (and (= |xs#0@@4| (|#List.M.Cons| |_mcc#0#0| |_mcc#1#0|)) ($IsBox |_mcc#0#0| List._default.Concat$A@@4)) (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass.List.M List._default.Concat$A@@4)) (= |let#0#0#0| |_mcc#1#0|))) (=> (and (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass.List.M List._default.Concat$A@@4)) (= |xs#Z#0@0| |let#0#0#0|)) (and (= |let#1#0#0| |_mcc#0#0|) ($IsBox |let#1#0#0| List._default.Concat$A@@4))) (and (and (= |x#Z#0@0| |let#1#0#0|) ($IsAlloc DatatypeTypeType |xs#Z#0@0| (Tclass.List.M List._default.Concat$A@@4) $Heap@@0)) (and ($IsAlloc DatatypeTypeType |ys#0@@4| (Tclass.List.M List._default.Concat$A@@4) $Heap@@0) (= (ControlFlow 0 3) (- 0 2))))) (or (< (DtRank |xs#Z#0@0|) (DtRank |xs#0@@4|)) (and (= (DtRank |xs#Z#0@0|) (DtRank |xs#0@@4|)) (< (DtRank |ys#0@@4|) (DtRank |ys#0@@4|))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |xs#0@@4| (Tclass.List.M List._default.Concat$A@@4)) ($Is DatatypeTypeType |ys#0@@4| (Tclass.List.M List._default.Concat$A@@4))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
