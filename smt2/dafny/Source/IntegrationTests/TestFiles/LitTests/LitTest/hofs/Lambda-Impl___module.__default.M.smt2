...
(assert (forall ((t0@@10 T@U) (t1@@6 T@U) (h0 T@U) (h1 T@U) (f@@3 T@U) (bx0@@2 T@U) ) (!  (=> (and (and (and ($HeapSucc h0 h1) (and ($IsGoodHeap h0) ($IsGoodHeap h1))) (and ($IsBox bx0@@2 t0@@10) ($Is HandleTypeType f@@3 (Tclass._System.___hFunc1 t0@@10 t1@@6)))) (forall ((o@@1 T@U) (fld T@U) )  (=> (and (or (not (= o@@1 null)) (not true)) (|Set#IsMember| (Reads1 t0@@10 t1@@6 h0 f@@3 bx0@@2) ($Box refType o@@1))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0 o@@1) fld) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1 o@@1) fld))))) (= (Requires1 t0@@10 t1@@6 h0 f@@3 bx0@@2) (Requires1 t0@@10 t1@@6 h1 f@@3 bx0@@2)))
 :pattern ( ($HeapSucc h0 h1) (Requires1 t0@@10 t1@@6 h1 f@@3 bx0@@2))
)))
(assert (forall ((t0@@11 T@U) (t1@@7 T@U) (h0@@0 T@U) (h1@@0 T@U) (f@@4 T@U) (bx0@@3 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@0 h1@@0) (and ($IsGoodHeap h0@@0) ($IsGoodHeap h1@@0))) (and ($IsBox bx0@@3 t0@@11) ($Is HandleTypeType f@@4 (Tclass._System.___hFunc1 t0@@11 t1@@7)))) (forall ((o@@2 T@U) (fld@@0 T@U) )  (=> (and (or (not (= o@@2 null)) (not true)) (|Set#IsMember| (Reads1 t0@@11 t1@@7 h1@@0 f@@4 bx0@@3) ($Box refType o@@2))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@0 o@@2) fld@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@0 o@@2) fld@@0))))) (= (Requires1 t0@@11 t1@@7 h0@@0 f@@4 bx0@@3) (Requires1 t0@@11 t1@@7 h1@@0 f@@4 bx0@@3)))
...
(assert (forall ((t0@@14 T@U) (t1@@9 T@U) (h0@@1 T@U) (h1@@1 T@U) (f@@6 T@U) (bx0@@5 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@1 h1@@1) (and ($IsGoodHeap h0@@1) ($IsGoodHeap h1@@1))) (and ($IsBox bx0@@5 t0@@14) ($Is HandleTypeType f@@6 (Tclass._System.___hFunc1 t0@@14 t1@@9)))) (forall ((o@@3 T@U) (fld@@1 T@U) )  (=> (and (or (not (= o@@3 null)) (not true)) (|Set#IsMember| (Reads1 t0@@14 t1@@9 h0@@1 f@@6 bx0@@5) ($Box refType o@@3))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@1 o@@3) fld@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@1 o@@3) fld@@1))))) (= (Reads1 t0@@14 t1@@9 h0@@1 f@@6 bx0@@5) (Reads1 t0@@14 t1@@9 h1@@1 f@@6 bx0@@5)))
 :pattern ( ($HeapSucc h0@@1 h1@@1) (Reads1 t0@@14 t1@@9 h1@@1 f@@6 bx0@@5))
)))
(assert (forall ((t0@@15 T@U) (t1@@10 T@U) (h0@@2 T@U) (h1@@2 T@U) (f@@7 T@U) (bx0@@6 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@2 h1@@2) (and ($IsGoodHeap h0@@2) ($IsGoodHeap h1@@2))) (and ($IsBox bx0@@6 t0@@15) ($Is HandleTypeType f@@7 (Tclass._System.___hFunc1 t0@@15 t1@@10)))) (forall ((o@@4 T@U) (fld@@2 T@U) )  (=> (and (or (not (= o@@4 null)) (not true)) (|Set#IsMember| (Reads1 t0@@15 t1@@10 h1@@2 f@@7 bx0@@6) ($Box refType o@@4))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@2 o@@4) fld@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@2 o@@4) fld@@2))))) (= (Reads1 t0@@15 t1@@10 h0@@2 f@@7 bx0@@6) (Reads1 t0@@15 t1@@10 h1@@2 f@@7 bx0@@6)))
 :pattern ( ($HeapSucc h0@@2 h1@@2) (Reads1 t0@@15 t1@@10 h1@@2 f@@7 bx0@@6))
)))
(assert (forall ((t0@@16 T@U) (t1@@11 T@U) (h0@@3 T@U) (h1@@3 T@U) (f@@8 T@U) (bx0@@7 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@3 h1@@3) (and ($IsGoodHeap h0@@3) ($IsGoodHeap h1@@3))) (and ($IsBox bx0@@7 t0@@16) ($Is HandleTypeType f@@8 (Tclass._System.___hFunc1 t0@@16 t1@@11)))) (forall ((o@@5 T@U) (fld@@3 T@U) )  (=> (and (or (not (= o@@5 null)) (not true)) (|Set#IsMember| (Reads1 t0@@16 t1@@11 h0@@3 f@@8 bx0@@7) ($Box refType o@@5))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@3 o@@5) fld@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@3 o@@5) fld@@3))))) (= (Apply1 t0@@16 t1@@11 h0@@3 f@@8 bx0@@7) (Apply1 t0@@16 t1@@11 h1@@3 f@@8 bx0@@7)))
 :pattern ( ($HeapSucc h0@@3 h1@@3) (Apply1 t0@@16 t1@@11 h1@@3 f@@8 bx0@@7))
)))
(assert (forall ((t0@@17 T@U) (t1@@12 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@9 T@U) (bx0@@8 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) (and ($IsBox bx0@@8 t0@@17) ($Is HandleTypeType f@@9 (Tclass._System.___hFunc1 t0@@17 t1@@12)))) (forall ((o@@6 T@U) (fld@@4 T@U) )  (=> (and (or (not (= o@@6 null)) (not true)) (|Set#IsMember| (Reads1 t0@@17 t1@@12 h1@@4 f@@9 bx0@@8) ($Box refType o@@6))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@4 o@@6) fld@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@4 o@@6) fld@@4))))) (= (Apply1 t0@@17 t1@@12 h0@@4 f@@9 bx0@@8) (Apply1 t0@@17 t1@@12 h1@@4 f@@9 bx0@@8)))
...
(assert (forall ((t0@@31 T@U) (h0@@7 T@U) (h1@@7 T@U) (f@@20 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@7 h1@@7) (and ($IsGoodHeap h0@@7) ($IsGoodHeap h1@@7))) ($Is HandleTypeType f@@20 (Tclass._System.___hFunc0 t0@@31))) (forall ((o@@9 T@U) (fld@@7 T@U) )  (=> (and (or (not (= o@@9 null)) (not true)) (|Set#IsMember| (Reads0 t0@@31 h0@@7 f@@20) ($Box refType o@@9))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@7 o@@9) fld@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@7 o@@9) fld@@7))))) (= (Reads0 t0@@31 h0@@7 f@@20) (Reads0 t0@@31 h1@@7 f@@20)))
 :pattern ( ($HeapSucc h0@@7 h1@@7) (Reads0 t0@@31 h1@@7 f@@20))
)))
(assert (forall ((t0@@32 T@U) (h0@@8 T@U) (h1@@8 T@U) (f@@21 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@8 h1@@8) (and ($IsGoodHeap h0@@8) ($IsGoodHeap h1@@8))) ($Is HandleTypeType f@@21 (Tclass._System.___hFunc0 t0@@32))) (forall ((o@@10 T@U) (fld@@8 T@U) )  (=> (and (or (not (= o@@10 null)) (not true)) (|Set#IsMember| (Reads0 t0@@32 h1@@8 f@@21) ($Box refType o@@10))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@8 o@@10) fld@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@8 o@@10) fld@@8))))) (= (Reads0 t0@@32 h0@@8 f@@21) (Reads0 t0@@32 h1@@8 f@@21)))
 :pattern ( ($HeapSucc h0@@8 h1@@8) (Reads0 t0@@32 h1@@8 f@@21))
)))
(assert (forall ((t0@@33 T@U) (h0@@9 T@U) (h1@@9 T@U) (f@@22 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@9 h1@@9) (and ($IsGoodHeap h0@@9) ($IsGoodHeap h1@@9))) ($Is HandleTypeType f@@22 (Tclass._System.___hFunc0 t0@@33))) (forall ((o@@11 T@U) (fld@@9 T@U) )  (=> (and (or (not (= o@@11 null)) (not true)) (|Set#IsMember| (Reads0 t0@@33 h0@@9 f@@22) ($Box refType o@@11))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@9 o@@11) fld@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@9 o@@11) fld@@9))))) (= (Apply0 t0@@33 h0@@9 f@@22) (Apply0 t0@@33 h1@@9 f@@22)))
 :pattern ( ($HeapSucc h0@@9 h1@@9) (Apply0 t0@@33 h1@@9 f@@22))
)))
(assert (forall ((t0@@34 T@U) (h0@@10 T@U) (h1@@10 T@U) (f@@23 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@10 h1@@10) (and ($IsGoodHeap h0@@10) ($IsGoodHeap h1@@10))) ($Is HandleTypeType f@@23 (Tclass._System.___hFunc0 t0@@34))) (forall ((o@@12 T@U) (fld@@10 T@U) )  (=> (and (or (not (= o@@12 null)) (not true)) (|Set#IsMember| (Reads0 t0@@34 h1@@10 f@@23) ($Box refType o@@12))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@10 o@@12) fld@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@10 o@@12) fld@@10))))) (= (Apply0 t0@@34 h0@@10 f@@23) (Apply0 t0@@34 h1@@10 f@@23)))
