...
(let ((anon3_Then_correct  (=> (Requires1 TInt TInt $Heap |_module.__default.ref1#Handle| ($Box intType (int_2_U |a#0|))) (=> (and ($IsAlloc intType (int_2_U |a#0|) TInt $Heap) (|_module.__default.valid#canCall| |a#0|)) (=> (and (and (|_module.__default.valid#canCall| |a#0|) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.valid#canCall| |a#0|)) (or (_module.__default.valid |a#0|) (> |a#0| 0)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (and ($IsAllocBox ($Box HandleTypeType |_module.__default.ref1#Handle|) (Tclass._System.___hFunc1 TInt TInt) $Heap) ($IsAlloc intType (int_2_U |a#0|) TInt $Heap)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 4))) anon0_correct)))
