...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.FoldR__F23)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@3 $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |##f#0@0| |_module.__default.F23#Handle|) (=> (and ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@0) (= |##b#0@0| (LitInt 0))) (=> (and (and ($IsAlloc intType (int_2_U |##b#0@0|) TInt $Heap@0) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@0)) (and (|_module.__default.foldr#canCall| TInt TInt |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= (LitInt 2) 0)) (not true)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3)) (|$IsA#_module.List| |xs#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
