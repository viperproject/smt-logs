...
(set-info :boogie-vc-id CheckWellFormed$$List.__default.RightIdentity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@7 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@7 $Heap@0)) (and ($IsAlloc DatatypeTypeType |m#0@@4| (Tclass.List.M List._default.RightIdentity$A) $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= 1 $FunctionContextHeight)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and ($Is DatatypeTypeType |m#0@@4| (Tclass.List.M List._default.RightIdentity$A)) ($IsAlloc DatatypeTypeType |m#0@@4| (Tclass.List.M List._default.RightIdentity$A) $Heap@@7)) (|$IsA#List.M| |m#0@@4|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
