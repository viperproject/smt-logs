...
(set-info :boogie-vc-id Impl$$_module.__default.FoldL__Use__Direct__lambda_split3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3)) (|$IsA#_module.List| |xs#0@@5|)) (=> (and (and (and (and (and ($Is HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc2 TInt TInt TInt)) ($IsAlloc HandleTypeType |f#0@@9| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3)) true) (and (= 2 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)))) (and (and (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#10| (Handle2 (|lambda#6| (LitInt 3) (LitInt 2)) (|lambda#7| TInt TInt) (|lambda#9| (SetRef_to_SetBox (|lambda#8| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |f#0@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3)) (and (= |##b#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##b#0@0|) TInt $Heap@@3)))) (and (and (and ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3) (|_module.__default.foldl#canCall| TInt TInt |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|)) (and (|_module.__default.foldl#canCall| TInt TInt |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|) (= |r#0@0| (U_2_int ($Unbox intType (_module.__default.foldl TInt TInt ($LS $LZ) |f#0@0| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|)))))) (and (and ($Is DatatypeTypeType |ys#0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3)) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= (LitInt 2) 0)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
