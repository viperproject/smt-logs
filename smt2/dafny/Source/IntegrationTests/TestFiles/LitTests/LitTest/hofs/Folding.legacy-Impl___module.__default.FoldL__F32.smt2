...
(set-info :boogie-vc-id Impl$$_module.__default.FoldL__F32)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (|$IsA#_module.List| |xs#0@@5|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@3 $Heap@0)) (and (forall ((|$ih#xs0#0| T@U) (|$ih#b0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#xs0#0| (Tclass._module.List TInt)) (= (Mod (U_2_int |$ih#b0#0|) (LitInt 2)) (LitInt 0))) (or (< (DtRank |$ih#xs0#0|) (DtRank |xs#0@@5|)) (and (= (DtRank |$ih#xs0#0|) (DtRank |xs#0@@5|)) (and (<= 0 (U_2_int |$ih#b0#0|)) (< (U_2_int |$ih#b0#0|) |b#0@@8|))))) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldl TInt TInt ($LS $LZ) |_module.__default.F32#Handle| ($Box intType |$ih#b0#0|) |$ih#xs0#0|))) (LitInt 2)) (LitInt 0)))
 :qid |Foldinglegacydfy.225:17|
 :skolemid |743|
 :pattern ( ($Unbox intType (_module.__default.foldl TInt TInt ($LS $LZ) |_module.__default.F32#Handle| ($Box intType |$ih#b0#0|) |$ih#xs0#0|)))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldl TInt TInt ($LS ($LS $LZ)) |_module.__default.F32#Handle| ($Box intType (int_2_U |b#0@@8|)) |xs#0@@5|))) (LitInt 2)) (LitInt 0))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3)) (|$IsA#_module.List| |xs#0@@5|)) (= 2 $FunctionContextHeight)) (and (= (Mod |b#0@@8| (LitInt 2)) (LitInt 0)) (= (ControlFlow 0 3) 2))) anon0_correct))))
