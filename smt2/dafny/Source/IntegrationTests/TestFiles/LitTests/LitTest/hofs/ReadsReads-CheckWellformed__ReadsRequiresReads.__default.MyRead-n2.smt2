...
(declare-fun ReadsRequiresReads.__default.MyReadsOk3 (T@U T@U T@U T@U T@U) T@U)
(declare-fun |ReadsRequiresReads.__default.MyReadsOk3#canCall| (T@U T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyReadsOk3$A T@U) (ReadsRequiresReads._default.MyReadsOk3$B T@U) ($Heap T@U) (|f#0| T@U) (|a#0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsOk3#canCall| ReadsRequiresReads._default.MyReadsOk3$A ReadsRequiresReads._default.MyReadsOk3$B $Heap |f#0| |a#0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsOk3$A ReadsRequiresReads._default.MyReadsOk3$B)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsOk3$A ReadsRequiresReads._default.MyReadsOk3$B) $Heap))) (and ($IsBox |a#0| ReadsRequiresReads._default.MyReadsOk3$A) ($IsAllocBox |a#0| ReadsRequiresReads._default.MyReadsOk3$A $Heap))) (Requires1 ReadsRequiresReads._default.MyReadsOk3$A ReadsRequiresReads._default.MyReadsOk3$B $Heap |f#0| |a#0|)))) ($Is SetType (ReadsRequiresReads.__default.MyReadsOk3 ReadsRequiresReads._default.MyReadsOk3$A ReadsRequiresReads._default.MyReadsOk3$B $Heap |f#0| |a#0|) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |662|
 :pattern ( (ReadsRequiresReads.__default.MyReadsOk3 ReadsRequiresReads._default.MyReadsOk3$A ReadsRequiresReads._default.MyReadsOk3$B $Heap |f#0| |a#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyReadsOk3$A@@0 T@U) (ReadsRequiresReads._default.MyReadsOk3$B@@0 T@U) ($Heap@@0 T@U) (|f#0@@0| T@U) (|a#0@@0| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsOk3#canCall| ReadsRequiresReads._default.MyReadsOk3$A@@0 ReadsRequiresReads._default.MyReadsOk3$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsOk3$A@@0 ReadsRequiresReads._default.MyReadsOk3$B@@0))) ($IsBox |a#0@@0| ReadsRequiresReads._default.MyReadsOk3$A@@0)) (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@0 ReadsRequiresReads._default.MyReadsOk3$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|)))) (and true (= (ReadsRequiresReads.__default.MyReadsOk3 ReadsRequiresReads._default.MyReadsOk3$A@@0 ReadsRequiresReads._default.MyReadsOk3$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) (Reads1 ReadsRequiresReads._default.MyReadsOk3$A@@0 ReadsRequiresReads._default.MyReadsOk3$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |665|
 :pattern ( (ReadsRequiresReads.__default.MyReadsOk3 ReadsRequiresReads._default.MyReadsOk3$A@@0 ReadsRequiresReads._default.MyReadsOk3$B@@0 $Heap@@0 |f#0@@0| |a#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((ReadsRequiresReads._default.MyReadsOk3$A@@1 T@U) (ReadsRequiresReads._default.MyReadsOk3$B@@1 T@U) ($Heap@@1 T@U) (|f#0@@1| T@U) (|a#0@@1| T@U) ) (!  (=> (or (|ReadsRequiresReads.__default.MyReadsOk3#canCall| ReadsRequiresReads._default.MyReadsOk3$A@@1 ReadsRequiresReads._default.MyReadsOk3$B@@1 $Heap@@1 |f#0@@1| |a#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (and ($Is HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsOk3$A@@1 ReadsRequiresReads._default.MyReadsOk3$B@@1)) ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsOk3$A@@1 ReadsRequiresReads._default.MyReadsOk3$B@@1) $Heap@@1))) (and ($IsBox |a#0@@1| ReadsRequiresReads._default.MyReadsOk3$A@@1) ($IsAllocBox |a#0@@1| ReadsRequiresReads._default.MyReadsOk3$A@@1 $Heap@@1))) (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@1 ReadsRequiresReads._default.MyReadsOk3$B@@1 $Heap@@1 |f#0@@1| |a#0@@1|)))) ($IsAlloc SetType (ReadsRequiresReads.__default.MyReadsOk3 ReadsRequiresReads._default.MyReadsOk3$A@@1 ReadsRequiresReads._default.MyReadsOk3$B@@1 $Heap@@1 |f#0@@1| |a#0@@1|) (TSet Tclass._System.object?) $Heap@@1))
 :qid |unknown.0:0|
 :skolemid |663|
 :pattern ( ($IsAlloc SetType (ReadsRequiresReads.__default.MyReadsOk3 ReadsRequiresReads._default.MyReadsOk3$A@@1 ReadsRequiresReads._default.MyReadsOk3$B@@1 $Heap@@1 |f#0@@1| |a#0@@1|) (TSet Tclass._System.object?) $Heap@@1))
))))
...
(declare-fun ReadsRequiresReads._default.MyReadsOk3$A@@2 () T@U)
(declare-fun ReadsRequiresReads._default.MyReadsOk3$B@@2 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$ReadsRequiresReads.__default.MyReadsOk3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon5_Else_correct  (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@2|) (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2) $Heap@@2) ($IsAllocBox |a#0@@2| ReadsRequiresReads._default.MyReadsOk3$A@@2 $Heap@@2)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 $Heap@@2 |f#0@@2| |a#0@@2|)) (=> (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 $Heap@@2 |f#0@@2| |a#0@@2|) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@2) alloc)))) (|Set#IsMember| (Reads1 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 $Heap@@2 |f#0@@2| |a#0@@2|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@0)))
 :qid |ReadsReadsdfy.23:7|
 :skolemid |672|
))) (= (ReadsRequiresReads.__default.MyReadsOk3 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 $Heap@@2 |f#0@@2| |a#0@@2|) (Reads1 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 $Heap@@2 |f#0@@2| |a#0@@2|))) (and ($Is SetType (ReadsRequiresReads.__default.MyReadsOk3 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 $Heap@@2 |f#0@@2| |a#0@@2|) (TSet Tclass._System.object?)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#2@0|))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc (Reads1 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 $Heap@@2 |f#0@@2| |a#0@@2|))) (and (=> (= (ControlFlow 0 5) (- 0 13)) true) (and (=> (= (ControlFlow 0 5) (- 0 12)) (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 TBool $Heap@@2 (|Requires1#Handle| ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 |f#0@@2|) |a#0@@2|)) (=> (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 TBool $Heap@@2 (|Requires1#Handle| ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 |f#0@@2|) |a#0@@2|) (=> (and (= |b$reqreads#0@0| (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@3) alloc)))) (|Set#IsMember| (Reads1 ReadsRequiresReads._default.MyReadsOk3$A@@2 TBool $Heap@@2 (|Requires1#Handle| ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 |f#0@@2|) |a#0@@2|) ($Box refType $o@@3))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@3 $f@@1)))
 :qid |ReadsReadsdfy.20:14|
 :skolemid |670|
))) (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 $Heap@@2 |f#0@@2| |a#0@@2|)) (and (=> (= (ControlFlow 0 5) (- 0 11)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 5) (- 0 10)) true) (and (=> (= (ControlFlow 0 5) (- 0 9)) (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 |f#0@@2|) |a#0@@2|)) (=> (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 |f#0@@2|) |a#0@@2|) (=> (= |b$reqreads#1@0| (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@4) alloc)))) (|Set#IsMember| (Reads1 ReadsRequiresReads._default.MyReadsOk3$A@@2 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 |f#0@@2|) |a#0@@2|) ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@2)))
 :qid |ReadsReadsdfy.21:11|
 :skolemid |671|
))) (and (=> (= (ControlFlow 0 5) (- 0 8)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 5) (- 0 7)) true) (and (=> (= (ControlFlow 0 5) (- 0 6)) (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 |f#0@@2|) |a#0@@2|)) (=> (Requires1 ReadsRequiresReads._default.MyReadsOk3$A@@2 (TSet Tclass._System.object?) $Heap@@2 (|Reads1#Handle| ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2 |f#0@@2|) |a#0@@2|) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is HandleTypeType |f#0@@2| (Tclass._System.___hFunc1 ReadsRequiresReads._default.MyReadsOk3$A@@2 ReadsRequiresReads._default.MyReadsOk3$B@@2)) ($IsBox |a#0@@2| ReadsRequiresReads._default.MyReadsOk3$A@@2)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 5))) anon0_correct))))
