...
(declare-fun Requires.__default.g2 (T@U Int) Int)
(declare-fun $LS (T@U) T@U)
(declare-fun |Requires.__default.g2#canCall| (Int) Bool)
(declare-fun |Requires.__default.h#canCall| (Int) Bool)
(declare-fun Requires.__default.h (T@U Int) Int)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun |Requires.__default.g2#Handle| (T@U) T@U)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun Requires1 (T@U T@U T@U T@U T@U) Bool)
(declare-fun |Requires.__default.g2#requires| (T@U Int) Bool)
(declare-fun $LZ () T@U)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|x#0| Int) ) (!  (=> (or (|Requires.__default.g2#canCall| (LitInt |x#0|)) (< 1 $FunctionContextHeight)) (and (|Requires.__default.h#canCall| (LitInt |x#0|)) (= (Requires.__default.g2 ($LS $ly) (LitInt |x#0|)) (LitInt (Requires.__default.h ($LS $ly) (LitInt |x#0|))))))
 :qid |Nakeddfy.30:18|
 :weight 3
 :skolemid |1118|
 :pattern ( (Requires.__default.g2 ($LS $ly) (LitInt |x#0|)))
))))
(assert (forall (($ly@@0 T@U) ($heap T@U) (|$fh$0x#0| Int) ) (! (= (Requires.__default.g2 $ly@@0 |$fh$0x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $heap (|Requires.__default.g2#Handle| $ly@@0) ($Box intType (int_2_U |$fh$0x#0|))))))
 :qid |unknown.0:0|
 :skolemid |1123|
 :pattern ( (Requires.__default.g2 $ly@@0 |$fh$0x#0|) ($IsGoodHeap $heap))
)))
...
(assert (forall (($ly@@1 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 TInt TInt $heap@@0 (|Requires.__default.g2#Handle| $ly@@1) |$fh$0x#0@@0|) (|Requires.__default.g2#requires| $ly@@1 (U_2_int ($Unbox intType |$fh$0x#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |1121|
 :pattern ( (Requires1 TInt TInt $heap@@0 (|Requires.__default.g2#Handle| $ly@@1) |$fh$0x#0@@0|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap T@U) (|x#0@@0| Int) ) (!  (=> (or (|Requires.__default.h#canCall| |x#0@@0|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (not (Requires1 TInt TInt $Heap (|Requires.__default.g2#Handle| ($LS $LZ)) ($Box intType (int_2_U |x#0@@0|))))))) (= (Requires.__default.h ($LS $ly@@2) |x#0@@0|) |x#0@@0|))
 :qid |Nakeddfy.31:18|
 :skolemid |1129|
 :pattern ( (Requires.__default.h ($LS $ly@@2) |x#0@@0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($ly@@3 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (Apply1 TInt TInt $heap@@1 (|Requires.__default.g2#Handle| $ly@@3) |$fh$0x#0@@1|) ($Box intType (int_2_U (Requires.__default.g2 $ly@@3 (U_2_int ($Unbox intType |$fh$0x#0@@1|))))))
 :qid |unknown.0:0|
 :skolemid |1120|
 :pattern ( (Apply1 TInt TInt $heap@@1 (|Requires.__default.g2#Handle| $ly@@3) |$fh$0x#0@@1|))
)))
...
(assert (forall (($ly@@4 T@U) (|x#0@@1| Int) ) (! (= (|Requires.__default.g2#requires| $ly@@4 |x#0@@1|) true)
 :qid |Nakeddfy.30:18|
 :skolemid |1116|
 :pattern ( (|Requires.__default.g2#requires| $ly@@4 |x#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@5 T@U) ($Heap@@0 T@U) (|x#0@@2| Int) ) (!  (=> (or (|Requires.__default.h#canCall| (LitInt |x#0@@2|)) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (not (Requires1 TInt TInt $Heap@@0 (|Requires.__default.g2#Handle| ($LS $LZ)) ($Box intType (int_2_U (LitInt |x#0@@2|)))))))) (= (Requires.__default.h ($LS $ly@@5) (LitInt |x#0@@2|)) (LitInt |x#0@@2|)))
 :qid |Nakeddfy.31:18|
 :weight 3
 :skolemid |1130|
 :pattern ( (Requires.__default.h ($LS $ly@@5) (LitInt |x#0@@2|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($ly@@6 T@U) (|x#0@@3| Int) ) (! (= (Requires.__default.g2 ($LS $ly@@6) |x#0@@3|) (Requires.__default.g2 $ly@@6 |x#0@@3|))
 :qid |Nakeddfy.30:18|
 :skolemid |1113|
 :pattern ( (Requires.__default.g2 ($LS $ly@@6) |x#0@@3|))
)))
(assert (forall (($ly@@7 T@U) (|x#0@@4| Int) ) (! (= (Requires.__default.h ($LS $ly@@7) |x#0@@4|) (Requires.__default.h $ly@@7 |x#0@@4|))
 :qid |Nakeddfy.31:18|
 :skolemid |1125|
 :pattern ( (Requires.__default.h ($LS $ly@@7) |x#0@@4|))
)))
...
(assert (forall (($ly@@8 T@U) ) (! (= (|Requires.__default.g2#Handle| ($LS $ly@@8)) (|Requires.__default.g2#Handle| $ly@@8))
 :qid |Nakeddfy.30:18|
 :skolemid |1119|
 :pattern ( (|Requires.__default.g2#Handle| ($LS $ly@@8)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@9 T@U) (|x#0@@5| Int) ) (!  (=> (or (|Requires.__default.g2#canCall| |x#0@@5|) (< 1 $FunctionContextHeight)) (and (|Requires.__default.h#canCall| |x#0@@5|) (= (Requires.__default.g2 ($LS $ly@@9) |x#0@@5|) (Requires.__default.h $ly@@9 |x#0@@5|))))
 :qid |Nakeddfy.30:18|
 :skolemid |1117|
 :pattern ( (Requires.__default.g2 ($LS $ly@@9) |x#0@@5|))
))))
(assert (forall (($bx T@U) ($ly@@10 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (|Set#IsMember| (Reads1 TInt TInt $heap@@2 (|Requires.__default.g2#Handle| $ly@@10) |$fh$0x#0@@2|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |1122|
 :pattern ( (|Set#IsMember| (Reads1 TInt TInt $heap@@2 (|Requires.__default.g2#Handle| $ly@@10) |$fh$0x#0@@2|) $bx))
)))
...
(set-info :boogie-vc-id CheckWellformed$$Requires.__default.h)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (and (and ($IsAllocBox ($Box HandleTypeType (|Requires.__default.g2#Handle| ($LS $LZ))) (Tclass._System.___hFunc1 TInt TInt) $Heap@@1) ($IsAlloc intType (int_2_U |x#0@@6|) TInt $Heap@@1)) (and (= |b$reqreads#0@0| (forall (($o@@0 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@0) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@1 (|Requires.__default.g2#Handle| ($LS $LZ)) ($Box intType (int_2_U |x#0@@6|))) ($Box refType $o@@0))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@0 $f@@0)))
 :qid |Nakeddfy.32:18|
 :skolemid |1131|
))) (not (Requires1 TInt TInt $Heap@@1 (|Requires.__default.g2#Handle| ($LS $LZ)) ($Box intType (int_2_U |x#0@@6|)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 3))) anon0_correct)))
