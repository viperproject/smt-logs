...
(declare-fun _module.__default.CheckReadsTot (T@U Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.CheckReadsTot#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0| T@U) (|x#0| Int) ) (!  (=> (or (|_module.__default.CheckReadsTot#canCall| |f#0| |x#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.CheckReadsTot |f#0| |x#0|) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |x#0|)))))))
 :qid |ArrowTypeOptimizationsdfy.19:16|
 :skolemid |541|
 :pattern ( (_module.__default.CheckReadsTot |f#0| |x#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|f#0@@0| T@U) (|x#0@@0| Int) ) (!  (=> (or (|_module.__default.CheckReadsTot#canCall| |f#0@@0| (LitInt |x#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.CheckReadsTot |f#0@@0| (LitInt |x#0@@0|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt |x#0@@0|))))))))
 :qid |ArrowTypeOptimizationsdfy.19:16|
 :weight 3
 :skolemid |542|
 :pattern ( (_module.__default.CheckReadsTot |f#0@@0| (LitInt |x#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|f#0@@3| T@U) (|x#0@@1| Int) ) (!  (=> (or (|_module.__default.CheckReadsTot#canCall| (Lit HandleTypeType |f#0@@3|) (LitInt |x#0@@1|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt))))) (= (_module.__default.CheckReadsTot (Lit HandleTypeType |f#0@@3|) (LitInt |x#0@@1|)) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@1 (Lit HandleTypeType |f#0@@3|) ($Box intType (int_2_U (LitInt |x#0@@1|))))))))
 :qid |ArrowTypeOptimizationsdfy.19:16|
 :weight 3
 :skolemid |543|
 :pattern ( (_module.__default.CheckReadsTot (Lit HandleTypeType |f#0@@3|) (LitInt |x#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.CheckReadsTot)
