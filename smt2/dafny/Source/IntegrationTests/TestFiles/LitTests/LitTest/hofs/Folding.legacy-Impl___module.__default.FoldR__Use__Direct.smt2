...
(declare-fun |_module.__default.F23#Handle| () T@U)
...
(declare-fun |_module.__default.F23#requires| (Int Int) Bool)
(declare-fun |$IsA#_module.List| (T@U) Bool)
(declare-fun _module.__default.F23 (Int Int) Int)
(declare-fun |_module.__default.F23#canCall| (Int Int) Bool)
...
(assert (distinct TInt TagInt alloc Tagclass._System.___hFunc2 Tagclass._System.___hPartialFunc2 Tagclass._System.___hTotalFunc2 Tagclass._module.List |##_module.List.Nil| |##_module.List.Cons| |tytagFamily$_#Func2| |tytagFamily$_#PartialFunc2| |tytagFamily$_#TotalFunc2| tytagFamily$List)
)
(assert (forall (($bx T@U) ($heap T@U) (|$fh$0x#0| T@U) (|$fh$0x#1| T@U) ) (! (= (|Set#IsMember| (Reads2 TInt TInt TInt $heap |_module.__default.F23#Handle| |$fh$0x#0| |$fh$0x#1|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |675|
 :pattern ( (|Set#IsMember| (Reads2 TInt TInt TInt $heap |_module.__default.F23#Handle| |$fh$0x#0| |$fh$0x#1|) $bx))
)))
...
(assert (forall ((|a#0| Int) (|b#0@@4| Int) ) (! (= (|_module.__default.F23#requires| |a#0| |b#0@@4|) true)
 :qid |Foldinglegacydfy.97:14|
 :skolemid |670|
 :pattern ( (|_module.__default.F23#requires| |a#0| |b#0@@4|))
)))
...
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) (|$fh$0x#1@@0| T@U) ) (! (= (Requires2 TInt TInt TInt $heap@@0 |_module.__default.F23#Handle| |$fh$0x#0@@0| |$fh$0x#1@@0|) (|_module.__default.F23#requires| (U_2_int ($Unbox intType |$fh$0x#0@@0|)) (U_2_int ($Unbox intType |$fh$0x#1@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |674|
 :pattern ( (Requires2 TInt TInt TInt $heap@@0 |_module.__default.F23#Handle| |$fh$0x#0@@0| |$fh$0x#1@@0|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|a#0@@0| Int) (|b#0@@5| Int) ) (!  (=> (or (|_module.__default.F23#canCall| (LitInt |a#0@@0|) (LitInt |b#0@@5|)) (< 0 $FunctionContextHeight)) (= (_module.__default.F23 (LitInt |a#0@@0|) (LitInt |b#0@@5|)) (LitInt (+ (Mul (LitInt 2) (LitInt |a#0@@0|)) (Mul (LitInt 3) (LitInt |b#0@@5|))))))
 :qid |Foldinglegacydfy.97:14|
 :weight 3
 :skolemid |672|
 :pattern ( (_module.__default.F23 (LitInt |a#0@@0|) (LitInt |b#0@@5|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.foldr$A@@4 T@U) (_module._default.foldr$B@@4 T@U) ($ly@@4 T@U) ($Heap@@2 T@U) (|f#0@@6| T@U) (|b#0@@6| T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.foldr#canCall| _module._default.foldr$A@@4 _module._default.foldr$B@@4 (Lit HandleTypeType |f#0@@6|) (Lit BoxType |b#0@@6|) (Lit DatatypeTypeType |xs#0@@4|)) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@2) ($Is HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc2 _module._default.foldr$A@@4 _module._default.foldr$B@@4 _module._default.foldr$B@@4))) ($IsBox |b#0@@6| _module._default.foldr$B@@4)) ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.foldr$A@@4))))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@4|)))))) (let ((|tail#5| (Lit DatatypeTypeType (_module.List._h3 (Lit DatatypeTypeType |xs#0@@4|)))))
(|_module.__default.foldr#canCall| _module._default.foldr$A@@4 _module._default.foldr$B@@4 (Lit HandleTypeType |f#0@@6|) (Lit BoxType |b#0@@6|) |tail#5|))) (= (_module.__default.foldr _module._default.foldr$A@@4 _module._default.foldr$B@@4 ($LS $ly@@4) (Lit HandleTypeType |f#0@@6|) (Lit BoxType |b#0@@6|) (Lit DatatypeTypeType |xs#0@@4|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@4|)) |b#0@@6| (let ((|tail#4| (Lit DatatypeTypeType (_module.List._h3 (Lit DatatypeTypeType |xs#0@@4|)))))
(let ((|head#4| (Lit BoxType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@4|)))))
(Apply2 _module._default.foldr$A@@4 _module._default.foldr$B@@4 _module._default.foldr$B@@4 $Heap@@2 (Lit HandleTypeType |f#0@@6|) |head#4| (Lit BoxType (_module.__default.foldr _module._default.foldr$A@@4 _module._default.foldr$B@@4 ($LS $ly@@4) (Lit HandleTypeType |f#0@@6|) (Lit BoxType |b#0@@6|) |tail#4|)))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |637|
 :pattern ( (_module.__default.foldr _module._default.foldr$A@@4 _module._default.foldr$B@@4 ($LS $ly@@4) (Lit HandleTypeType |f#0@@6|) (Lit BoxType |b#0@@6|) (Lit DatatypeTypeType |xs#0@@4|)) ($IsGoodHeap $Heap@@2))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|a#0@@1| Int) (|b#0@@7| Int) ) (!  (=> (or (|_module.__default.F23#canCall| |a#0@@1| |b#0@@7|) (< 0 $FunctionContextHeight)) (= (_module.__default.F23 |a#0@@1| |b#0@@7|) (+ (Mul (LitInt 2) |a#0@@1|) (Mul (LitInt 3) |b#0@@7|))))
 :qid |Foldinglegacydfy.97:14|
 :skolemid |671|
 :pattern ( (_module.__default.F23 |a#0@@1| |b#0@@7|))
))))
...
(assert (forall (($heap@@1 T@U) (|$fh$0x#0@@1| Int) (|$fh$0x#1@@1| Int) ) (! (= (_module.__default.F23 |$fh$0x#0@@1| |$fh$0x#1@@1|) (U_2_int ($Unbox intType (Apply2 TInt TInt TInt $heap@@1 |_module.__default.F23#Handle| ($Box intType (int_2_U |$fh$0x#0@@1|)) ($Box intType (int_2_U |$fh$0x#1@@1|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |676|
 :pattern ( (_module.__default.F23 |$fh$0x#0@@1| |$fh$0x#1@@1|) ($IsGoodHeap $heap@@1))
)))
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) (|$fh$0x#1@@2| T@U) ) (! (= (Apply2 TInt TInt TInt $heap@@2 |_module.__default.F23#Handle| |$fh$0x#0@@2| |$fh$0x#1@@2|) ($Box intType (int_2_U (_module.__default.F23 (U_2_int ($Unbox intType |$fh$0x#0@@2|)) (U_2_int ($Unbox intType |$fh$0x#1@@2|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |673|
 :pattern ( (Apply2 TInt TInt TInt $heap@@2 |_module.__default.F23#Handle| |$fh$0x#0@@2| |$fh$0x#1@@2|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.FoldR__Use__Direct)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon2_correct  (=> (forall ((|ys#1| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1| (Tclass._module.List TInt)) (|_module.__default.foldr#canCall| TInt TInt |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |ys#1|))
 :qid |Foldinglegacydfy.115:17|
 :skolemid |681|
 :pattern ( ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |_module.__default.F23#Handle| ($Box intType (int_2_U 0)) |ys#1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|ys#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1@@0| (Tclass._module.List TInt)) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS ($LS $LZ)) |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |ys#1@@0|))) (LitInt 2)) (LitInt 0)))
 :qid |Foldinglegacydfy.115:17|
 :skolemid |682|
 :pattern ( ($Unbox intType (_module.__default.foldr TInt TInt ($LS ($LS $LZ)) |_module.__default.F23#Handle| ($Box intType (int_2_U 0)) |ys#1@@0|)))
))) (=> (forall ((|ys#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |ys#1@@1| (Tclass._module.List TInt)) (= (Mod (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |ys#1@@1|))) (LitInt 2)) (LitInt 0)))
 :qid |Foldinglegacydfy.115:17|
 :skolemid |684|
 :pattern ( ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |_module.__default.F23#Handle| ($Box intType (int_2_U 0)) |ys#1@@1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (Mod |r#0@0| (LitInt 2)) (LitInt 0)))))))))
(let ((anon3_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |ys#0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3))) (= (ControlFlow 0 8) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and ($Is DatatypeTypeType |ys#0@0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (= |##f#1@0| |_module.__default.F23#Handle|) ($IsAlloc HandleTypeType |##f#1@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3)) (=> (and (and (= |##b#1@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##b#1@0|) TInt $Heap@@3)) (and ($IsAlloc DatatypeTypeType |ys#0@0| (Tclass._module.List TInt) $Heap@@3) (|_module.__default.foldr#canCall| TInt TInt |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |ys#0@0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 5) 2) anon2_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (and (and (= |##f#0@0| |_module.__default.F23#Handle|) ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hTotalFunc2 TInt TInt TInt) $Heap@@3)) (and (= |##b#0@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##b#0@0|) TInt $Heap@@3))) (and (and ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3) (|_module.__default.foldr#canCall| TInt TInt |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|)) (and (|_module.__default.foldr#canCall| TInt TInt |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|) (= |r#0@0| (U_2_int ($Unbox intType (_module.__default.foldr TInt TInt ($LS $LZ) |_module.__default.F23#Handle| ($Box intType (int_2_U (LitInt 0))) |xs#0@@5|))))))) (and (=> (= (ControlFlow 0 9) 5) anon3_Then_correct) (=> (= (ControlFlow 0 9) 8) anon3_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and ($Is DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0@@5| (Tclass._module.List TInt) $Heap@@3)) (|$IsA#_module.List| |xs#0@@5|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 9))) anon0_correct))))
