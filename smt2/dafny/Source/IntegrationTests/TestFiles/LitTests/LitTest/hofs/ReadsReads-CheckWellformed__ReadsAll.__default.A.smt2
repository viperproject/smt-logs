...
(declare-fun ReadsAll.__default.A (T@U T@U) Int)
(declare-fun |ReadsAll.__default.A#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0| T@U) ) (!  (=> (or (|ReadsAll.__default.A#canCall| $Heap |f#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TInt))) (forall ((|x#2| Int) ) (! (Requires1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |x#2|)))
 :qid |ReadsReadsdfy.115:21|
 :skolemid |2036|
 :pattern ( (Requires1 TInt TInt $Heap |f#0| ($Box intType (int_2_U |x#2|))))
))))) (= (ReadsAll.__default.A $Heap |f#0|) (+ (+ (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 0)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 1))))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#0| ($Box intType (int_2_U (LitInt 2)))))))))
 :qid |ReadsReadsdfy.113:18|
 :skolemid |2038|
 :pattern ( (ReadsAll.__default.A $Heap |f#0|) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$ReadsAll.__default.A)
...
(assert (not
 ...
 :qid |ReadsReadsdfy.117:19|
 :skolemid |2045|
))) (=> (and (= (ReadsAll.__default.A $Heap@@0 |f#0@@0|) (+ (+ (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 0)))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 1))))))) (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U (LitInt 2)))))))) ($Is intType (int_2_U (ReadsAll.__default.A $Heap@@0 |f#0@@0|)) TInt)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#2@0|) (=> |b$reqreads#2@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#3@0|) (=> |b$reqreads#3@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#4@0|)))))))))))))))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (=> (not (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#5@0|))) ($Box refType |o#2@0|))) (and (=> (= (ControlFlow 0 11) 1) anon15_Then_correct) (=> (= (ControlFlow 0 11) 3) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#5@0|))) ($Box refType |o#2@0|)) (and (=> (= (ControlFlow 0 10) 1) anon15_Then_correct) (=> (= (ControlFlow 0 10) 3) anon15_Else_correct)))))
(let ((anon13_Then_correct  (=> (and (and ($Is refType |o#2@0| Tclass._System.object?) ($IsAlloc refType |o#2@0| Tclass._System.object? $Heap@@0)) (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TInt) $Heap@@0) ($IsAlloc intType (int_2_U |x#5@0|) TInt $Heap@@0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#5@0|)))) (=> (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#5@0|))) (and (=> (= (ControlFlow 0 12) 10) anon14_Then_correct) (=> (= (ControlFlow 0 12) 11) anon14_Else_correct)))))))
(let ((anon13_Else_correct  (=> (not (and ($Is refType |o#2@0| Tclass._System.object?) ($IsAlloc refType |o#2@0| Tclass._System.object? $Heap@@0))) (and (=> (= (ControlFlow 0 9) 1) anon15_Then_correct) (=> (= (ControlFlow 0 9) 3) anon15_Else_correct)))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 14) 12) anon13_Then_correct) (=> (= (ControlFlow 0 14) 9) anon13_Else_correct))))))
(let ((anon12_Else_correct  (=> (not (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#4@0|))) ($Box refType |o#1@0|))) (=> (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 18) 14)) anon4_correct))))
(let ((anon12_Then_correct  (=> (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#4@0|))) ($Box refType |o#1@0|)) (=> (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 17) 14)) anon4_correct))))
(let ((anon11_Then_correct  (=> (and (and ($Is refType |o#1@0| Tclass._System.object?) ($IsAlloc refType |o#1@0| Tclass._System.object? $Heap@@0)) (and ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TInt) $Heap@@0) ($IsAlloc intType (int_2_U |x#4@0|) TInt $Heap@@0))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#4@0|)))) (=> (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#4@0|))) (=> (= |b$reqreads#1@0| (forall (($o@@5 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@5) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#4@0|))) ($Box refType $o@@5))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@5 $f@@3)))
 :qid |ReadsReadsdfy.114:28|
 :skolemid |2042|
))) (and (=> (= (ControlFlow 0 19) 17) anon12_Then_correct) (=> (= (ControlFlow 0 19) 18) anon12_Else_correct))))))))
(let ((anon11_Else_correct  (=> (not (and ($Is refType |o#1@0| Tclass._System.object?) ($IsAlloc refType |o#1@0| Tclass._System.object? $Heap@@0))) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 16) 14)) anon4_correct))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc Tclass._System.object? TInt TInt $Heap@@0 |f#0@@0| TInt TInt $Heap@@0 |f#0@@0|)) ($IsAllocBox ($Box HandleTypeType |f#0@@0|) (Tclass._System.___hFunc1 TInt TInt) $Heap@@0)) (=> (and (and ($IsAlloc intType (int_2_U |x#3@0|) TInt $Heap@@0) (= |b$reqreads#0@0| (forall (($o@@6 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@6) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#3@0|))) ($Box refType $o@@6))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@6 $f@@4)))
 :qid |ReadsReadsdfy.115:28|
 :skolemid |2040|
)))) (and (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType (int_2_U |x#3@0|))) (forall ((|x#1| T@U) ) (! (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType |x#1|))
 :qid |ReadsReadsdfy.115:21|
 :skolemid |2041|
 :pattern ( (Requires1 TInt TInt $Heap@@0 |f#0@@0| ($Box intType |x#1|)))
)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 21) 19) anon11_Then_correct) (=> (= (ControlFlow 0 21) 16) anon11_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hFunc1 TInt TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 23) 21))) anon0_correct)))
