...
(declare-fun |lambda#86| (T@U T@U) T@U)
...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc2 Tagclass._System.___hPartialFunc2 Tagclass._System.___hTotalFunc2 Tagclass._module.Expr Tagclass._module.List |##_module.List.Nil| |##_module.List.Cons| |##_module.Expr.Add| |##_module.Expr.Mul| |##_module.Expr.Lit| tytagFamily$object |tytagFamily$_#Func2| |tytagFamily$_#PartialFunc2| |tytagFamily$_#TotalFunc2| tytagFamily$Expr tytagFamily$List)
)
...
(assert  (and (and (and (and (and (and (forall ((t0@@0 T@T) (t1@@0 T@T) (t2 T@T) (t3 T@T) (val@@1 T@U) (m@@1 T@U) (x0@@1 T@U) (x1 T@U) (x2 T@U) ) (! (= (MapType1Select t0@@0 t1@@0 t2 t3 (MapType1Store t0@@0 t1@@0 t2 t3 m@@1 x0@@1 x1 x2 val@@1) x0@@1 x1 x2) val@@1)
 ...
 :weight 0
)))) (forall ((arg0@@2 T@T) (arg1 T@T) ) (! (= (Ctor (MapType0Type arg0@@2 arg1)) 7)
...
(assert (forall ((|l#0@@1| T@U) (|$l#0#heap#0| T@U) (|$l#0#x#0| T@U) (|$l#0#y#0| T@U) ) (! (= (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#85| |l#0@@1|) |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|) ($Box DatatypeTypeType (|#_module.Expr.Add| (|#_module.List.Cons| |$l#0#x#0| (|#_module.List.Cons| |$l#0#y#0| |l#0@@1|)))))
 :qid |Folddfy.25:41|
 :skolemid |687|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#85| |l#0@@1|) |$l#0#heap#0| |$l#0#x#0| |$l#0#y#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|l#1@@1| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) (|$l#0#y#0@@0| T@U) ) (! (= (U_2_bool (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType boolType (|lambda#86| |l#0@@2| |l#1@@1|) |$l#0#heap#0@@0| |$l#0#x#0@@0| |$l#0#y#0@@0|))  (and ($IsBox |$l#0#x#0@@0| |l#0@@2|) ($IsBox |$l#0#y#0@@0| |l#1@@1|)))
 :qid |Folddfy.5:10|
 :skolemid |688|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType boolType (|lambda#86| |l#0@@2| |l#1@@1|) |$l#0#heap#0@@0| |$l#0#x#0@@0| |$l#0#y#0@@0|))
)))
(assert (forall ((|#$T0| T@U) (|#$T1| T@U) (|#$R| T@U) (|f#0@@0| T@U) ) (! (= ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc2 |#$T0| |#$T1| |#$R|))  (and ($Is HandleTypeType |f#0@@0| (Tclass._System.___hPartialFunc2 |#$T0| |#$T1| |#$R|)) (forall ((|x0#0| T@U) (|x1#0| T@U) ) (!  (=> (and ($IsBox |x0#0| |#$T0|) ($IsBox |x1#0| |#$T1|)) (Requires2 |#$T0| |#$T1| |#$R| $OneHeap |f#0@@0| |x0#0| |x1#0|))
 :qid |unknown.0:0|
 :skolemid |525|
))))
 :qid |unknown.0:0|
 :skolemid |526|
 :pattern ( ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc2 |#$T0| |#$T1| |#$R|)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Fold$A@@0 T@U) (_module._default.Fold$B@@0 T@U) ($ly@@0 T@U) ($Heap@@0 T@U) (|xs#0@@0| T@U) (|unit#0@@0| T@U) (|f#0@@1| T@U) ) (!  (=> (or (|_module.__default.Fold#canCall| _module._default.Fold$A@@0 _module._default.Fold$B@@0 |xs#0@@0| |unit#0@@0| |f#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@0) ($Is DatatypeTypeType |xs#0@@0| (Tclass._module.List _module._default.Fold$A@@0))) ($IsBox |unit#0@@0| _module._default.Fold$B@@0)) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc2 _module._default.Fold$A@@0 _module._default.Fold$B@@0 _module._default.Fold$B@@0))) (forall ((|x#1| T@U) (|y#1| T@U) ) (!  (=> (and ($IsBox |x#1| _module._default.Fold$A@@0) ($IsBox |y#1| _module._default.Fold$B@@0)) (=> (< (BoxRank |x#1|) (DtRank |xs#0@@0|)) (Requires2 _module._default.Fold$A@@0 _module._default.Fold$B@@0 _module._default.Fold$B@@0 $Heap@@0 |f#0@@1| |x#1| |y#1|)))
 :qid |Folddfy.16:19|
 :skolemid |609|
 :pattern ( (Requires2 _module._default.Fold$A@@0 _module._default.Fold$B@@0 _module._default.Fold$B@@0 $Heap@@0 |f#0@@1| |x#1| |y#1|))
))))) (and (=> (not (_module.List.Nil_q |xs#0@@0|)) (let ((|xs#2| (_module.List._h1 |xs#0@@0|)))
(|_module.__default.Fold#canCall| _module._default.Fold$A@@0 _module._default.Fold$B@@0 |xs#2| |unit#0@@0| |f#0@@1|))) (= (_module.__default.Fold _module._default.Fold$A@@0 _module._default.Fold$B@@0 ($LS $ly@@0) |xs#0@@0| |unit#0@@0| |f#0@@1|) (ite (_module.List.Nil_q |xs#0@@0|) |unit#0@@0| (let ((|xs#1| (_module.List._h1 |xs#0@@0|)))
(let ((|x#2| (_module.List._h0 |xs#0@@0|)))
(Apply2 _module._default.Fold$A@@0 _module._default.Fold$B@@0 _module._default.Fold$B@@0 $Heap@@0 |f#0@@1| |x#2| (_module.__default.Fold _module._default.Fold$A@@0 _module._default.Fold$B@@0 $ly@@0 |xs#1| |unit#0@@0| |f#0@@1|))))))))
 :qid |unknown.0:0|
 :skolemid |611|
 :pattern ( (_module.__default.Fold _module._default.Fold$A@@0 _module._default.Fold$B@@0 ($LS $ly@@0) |xs#0@@0| |unit#0@@0| |f#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0@@3| T@U) (|$l#3#heap#0| T@U) (|$l#3#e#0| T@U) (|$l#3#v#0| T@U) ) (! (= (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#0| |l#0@@3|) |$l#3#heap#0| |$l#3#e#0| |$l#3#v#0|) ($Box intType (int_2_U (+ (_module.__default.Eval |l#0@@3| ($Unbox DatatypeTypeType |$l#3#e#0|)) (U_2_int ($Unbox intType |$l#3#v#0|))))))
 :qid |unknown.0:0|
 :skolemid |679|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#0| |l#0@@3|) |$l#3#heap#0| |$l#3#e#0| |$l#3#v#0|))
)))
...
(assert (forall ((t0@@1 T@U) (t1@@1 T@U) (t2@@0 T@U) (heap T@U) (h@@0 T@U) (r T@U) (rd T@U) (bx0 T@U) (bx1 T@U) (bx@@2 T@U) ) (! (= (|Set#IsMember| (Reads2 t0@@1 t1@@1 t2@@0 heap (Handle2 h@@0 r rd) bx0 bx1) bx@@2) (|Set#IsMember| (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType SetType rd heap bx0 bx1) bx@@2))
 :qid |unknown.0:0|
 :skolemid |486|
...
(assert (forall ((_module._default.Fold$A@@1 T@U) (_module._default.Fold$B@@1 T@U) ($ly@@1 T@U) (|xs#0@@1| T@U) (|unit#0@@1| T@U) (|f#0@@3| T@U) ) (! (= (_module.__default.Fold _module._default.Fold$A@@1 _module._default.Fold$B@@1 ($LS $ly@@1) |xs#0@@1| |unit#0@@1| |f#0@@3|) (_module.__default.Fold _module._default.Fold$A@@1 _module._default.Fold$B@@1 $ly@@1 |xs#0@@1| |unit#0@@1| |f#0@@3|))
 :qid |unknown.0:0|
 :skolemid |605|
 :pattern ( (_module.__default.Fold _module._default.Fold$A@@1 _module._default.Fold$B@@1 ($LS $ly@@1) |xs#0@@1| |unit#0@@1| |f#0@@3|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Fold$A@@2 T@U) (_module._default.Fold$B@@2 T@U) ($ly@@2 T@U) ($Heap@@1 T@U) (|xs#0@@2| T@U) (|unit#0@@2| T@U) (|f#0@@4| T@U) ) (!  (=> (or (|_module.__default.Fold#canCall| _module._default.Fold$A@@2 _module._default.Fold$B@@2 (Lit DatatypeTypeType |xs#0@@2|) (Lit BoxType |unit#0@@2|) (Lit HandleTypeType |f#0@@4|)) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@1) ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.Fold$A@@2))) ($IsBox |unit#0@@2| _module._default.Fold$B@@2)) ($Is HandleTypeType |f#0@@4| (Tclass._System.___hPartialFunc2 _module._default.Fold$A@@2 _module._default.Fold$B@@2 _module._default.Fold$B@@2))) (forall ((|x#7| T@U) (|y#3| T@U) ) (!  (=> (and ($IsBox |x#7| _module._default.Fold$A@@2) ($IsBox |y#3| _module._default.Fold$B@@2)) (=> (< (BoxRank |x#7|) (DtRank |xs#0@@2|)) (Requires2 _module._default.Fold$A@@2 _module._default.Fold$B@@2 _module._default.Fold$B@@2 $Heap@@1 (Lit HandleTypeType |f#0@@4|) |x#7| |y#3|)))
 :qid |Folddfy.16:19|
 :skolemid |614|
 :pattern ( (Requires2 _module._default.Fold$A@@2 _module._default.Fold$B@@2 _module._default.Fold$B@@2 $Heap@@1 |f#0@@4| |x#7| |y#3|))
...
(|_module.__default.Fold#canCall| _module._default.Fold$A@@2 _module._default.Fold$B@@2 |xs#6| (Lit BoxType |unit#0@@2|) (Lit HandleTypeType |f#0@@4|)))) (= (_module.__default.Fold _module._default.Fold$A@@2 _module._default.Fold$B@@2 ($LS $ly@@2) (Lit DatatypeTypeType |xs#0@@2|) (Lit BoxType |unit#0@@2|) (Lit HandleTypeType |f#0@@4|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |unit#0@@2| (let ((|xs#5| (Lit DatatypeTypeType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|x#8| (Lit BoxType (_module.List._h0 (Lit DatatypeTypeType |xs#0@@2|)))))
(Apply2 _module._default.Fold$A@@2 _module._default.Fold$B@@2 _module._default.Fold$B@@2 $Heap@@1 (Lit HandleTypeType |f#0@@4|) |x#8| (Lit BoxType (_module.__default.Fold _module._default.Fold$A@@2 _module._default.Fold$B@@2 ($LS $ly@@2) |xs#5| (Lit BoxType |unit#0@@2|) (Lit HandleTypeType |f#0@@4|))))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |615|
 :pattern ( (_module.__default.Fold _module._default.Fold$A@@2 _module._default.Fold$B@@2 ($LS $ly@@2) (Lit DatatypeTypeType |xs#0@@2|) (Lit BoxType |unit#0@@2|) (Lit HandleTypeType |f#0@@4|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass._module.Expr) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@8)) bx@@8) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@8) Tclass._module.Expr)))
 :qid |unknown.0:0|
 :skolemid |583|
 :pattern ( ($IsBox bx@@8 Tclass._module.Expr))
)))
...
(assert (forall ((|l#0@@4| Bool) (|$l#3#o#0| T@U) ) (! (= (U_2_bool (MapType0Select refType boolType (|lambda#2| |l#0@@4|) |$l#3#o#0|)) |l#0@@4|)
 :qid |unknown.0:0|
 :skolemid |681|
 :pattern ( (MapType0Select refType boolType (|lambda#2| |l#0@@4|) |$l#3#o#0|))
)))
(assert (forall ((|l#0@@5| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#89| |l#0@@5|) |$l#0#ly#0|) |l#0@@5|)
 :qid |Folddfy.25:14|
 :skolemid |689|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#89| |l#0@@5|) |$l#0#ly#0|))
)))
...
(assert (forall ((|l#0@@6| T@U) (|l#1@@2| T@U) (|l#2| Int) (|$l#3#heap#0@@0| T@U) (|$l#3#e#0@@0| T@U) (|$l#3#v#0@@0| T@U) ) (! (= (U_2_bool (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType boolType (|lambda#1| |l#0@@6| |l#1@@2| |l#2|) |$l#3#heap#0@@0| |$l#3#e#0@@0| |$l#3#v#0@@0|))  (and (and ($IsBox |$l#3#e#0@@0| |l#0@@6|) ($IsBox |$l#3#v#0@@0| |l#1@@2|)) (< (DtRank ($Unbox DatatypeTypeType |$l#3#e#0@@0|)) |l#2|)))
 :qid |Folddfy.5:10|
 :skolemid |680|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType boolType (|lambda#1| |l#0@@6| |l#1@@2| |l#2|) |$l#3#heap#0@@0| |$l#3#e#0@@0| |$l#3#v#0@@0|))
)))
...
(assert (forall ((|l#0@@7| T@U) (|$l#5#heap#0| T@U) (|$l#5#e#0| T@U) (|$l#5#v#0| T@U) ) (! (= (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#5| |l#0@@7|) |$l#5#heap#0| |$l#5#e#0| |$l#5#v#0|) ($Box intType (int_2_U (Mul (_module.__default.Eval |l#0@@7| ($Unbox DatatypeTypeType |$l#5#e#0|)) (U_2_int ($Unbox intType |$l#5#v#0|))))))
 :qid |unknown.0:0|
 :skolemid |684|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#5| |l#0@@7|) |$l#5#heap#0| |$l#5#e#0| |$l#5#v#0|))
)))
...
(assert (forall ((|l#0@@8| T@U) (|$l#3#heap#0@@1| T@U) (|$l#3#e#0@@1| T@U) (|$l#3#v#0@@1| T@U) ) (! (= (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType SetType (|lambda#3| |l#0@@8|) |$l#3#heap#0@@1| |$l#3#e#0@@1| |$l#3#v#0@@1|) |l#0@@8|)
 :qid |Folddfy.10:33|
 :skolemid |682|
 :pattern ( (MapType1Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType BoxType SetType (|lambda#3| |l#0@@8|) |$l#3#heap#0@@1| |$l#3#e#0@@1| |$l#3#v#0@@1|))
)))
...
(assert (forall ((|l#0@@9| T@U) (|l#1@@3| T@U) (|l#2@@0| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType2Select refType FieldType boolType (|lambda#40| |l#0@@9| |l#1@@3| |l#2@@0| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@9|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@3| $o@@1) |l#2@@0|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |686|
 :pattern ( (MapType2Select refType FieldType boolType (|lambda#40| |l#0@@9| |l#1@@3| |l#2@@0| |l#3|) $o@@1 $f))
)))
(assert (forall ((|#$T0@@16| T@U) (|#$T1@@16| T@U) (|#$R@@16| T@U) (|f#0@@5| T@U) ($h@@3 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@5| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@3) ($IsAlloc HandleTypeType |f#0@@5| (Tclass._System.___hFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@3))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@5| (Tclass._System.___hPartialFunc2 |#$T0@@16| |#$T1@@16| |#$R@@16|) $h@@3))
)))
(assert (forall ((|#$T0@@17| T@U) (|#$T1@@17| T@U) (|#$R@@17| T@U) (|f#0@@6| T@U) ($h@@4 T@U) ) (! (= ($IsAlloc HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@4) ($IsAlloc HandleTypeType |f#0@@6| (Tclass._System.___hPartialFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@4))
 :qid |unknown.0:0|
 :skolemid |527|
 :pattern ( ($IsAlloc HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc2 |#$T0@@17| |#$T1@@17| |#$R@@17|) $h@@4))
)))
(assert (forall ((d@@11 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_module.Expr.Lit_q d@@11) ($IsAlloc DatatypeTypeType d@@11 Tclass._module.Expr $h@@5))) ($IsAlloc intType (int_2_U (_module.Expr._h4 d@@11)) TInt $h@@5))
 :qid |unknown.0:0|
 :skolemid |669|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Expr._h4 d@@11)) TInt $h@@5))
)))
...
(assert (forall ((_module.List$A@@6 T@U) (bx@@15 T@U) ) (!  (=> ($IsBox bx@@15 (Tclass._module.List _module.List$A@@6)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@15)) bx@@15) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@15) (Tclass._module.List _module.List$A@@6))))
 :qid |unknown.0:0|
 :skolemid |594|
 :pattern ( ($IsBox bx@@15 (Tclass._module.List _module.List$A@@6)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.Fold$A@@3 T@U) (_module._default.Fold$B@@3 T@U) ($ly@@5 T@U) ($Heap@@2 T@U) (|xs#0@@3| T@U) (|unit#0@@3| T@U) (|f#0@@7| T@U) ) (!  (=> (or (|_module.__default.Fold#canCall| _module._default.Fold$A@@3 _module._default.Fold$B@@3 |xs#0@@3| |unit#0@@3| |f#0@@7|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@2) (and ($Is DatatypeTypeType |xs#0@@3| (Tclass._module.List _module._default.Fold$A@@3)) ($IsAlloc DatatypeTypeType |xs#0@@3| (Tclass._module.List _module._default.Fold$A@@3) $Heap@@2))) (and ($IsBox |unit#0@@3| _module._default.Fold$B@@3) ($IsAllocBox |unit#0@@3| _module._default.Fold$B@@3 $Heap@@2))) (and ($Is HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc2 _module._default.Fold$A@@3 _module._default.Fold$B@@3 _module._default.Fold$B@@3)) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hPartialFunc2 _module._default.Fold$A@@3 _module._default.Fold$B@@3 _module._default.Fold$B@@3) $Heap@@2))) (forall ((|x#0| T@U) (|y#0| T@U) ) (!  (=> (and ($IsBox |x#0| _module._default.Fold$A@@3) ($IsBox |y#0| _module._default.Fold$B@@3)) (=> (< (BoxRank |x#0|) (DtRank |xs#0@@3|)) (Requires2 _module._default.Fold$A@@3 _module._default.Fold$B@@3 _module._default.Fold$B@@3 $Heap@@2 |f#0@@7| |x#0| |y#0|)))
 :qid |Folddfy.16:19|
 :skolemid |607|
 :pattern ( (Requires2 _module._default.Fold$A@@3 _module._default.Fold$B@@3 _module._default.Fold$B@@3 $Heap@@2 |f#0@@7| |x#0| |y#0|))
))))) ($IsBox (_module.__default.Fold _module._default.Fold$A@@3 _module._default.Fold$B@@3 $ly@@5 |xs#0@@3| |unit#0@@3| |f#0@@7|) _module._default.Fold$B@@3))
 :qid |unknown.0:0|
 :skolemid |608|
 :pattern ( (_module.__default.Fold _module._default.Fold$A@@3 _module._default.Fold$B@@3 $ly@@5 |xs#0@@3| |unit#0@@3| |f#0@@7|) ($IsGoodHeap $Heap@@2))
))))
(assert (forall ((d@@14 T@U) (_module.List$A@@7 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_module.List.Cons_q d@@14) ($IsAlloc DatatypeTypeType d@@14 (Tclass._module.List _module.List$A@@7) $h@@6))) ($IsAlloc DatatypeTypeType (_module.List._h1 d@@14) (Tclass._module.List _module.List$A@@7) $h@@6))
 :qid |unknown.0:0|
 :skolemid |635|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h1 d@@14) (Tclass._module.List _module.List$A@@7) $h@@6))
)))
(assert (forall ((d@@15 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d@@15 Tclass._module.Expr)) ($IsAlloc DatatypeTypeType d@@15 Tclass._module.Expr $h@@7))
 :qid |unknown.0:0|
 :skolemid |672|
 :pattern ( ($IsAlloc DatatypeTypeType d@@15 Tclass._module.Expr $h@@7))
)))
...
(assert (forall ((d@@16 T@U) ($h@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (_module.Expr.Add_q d@@16) ($IsAlloc DatatypeTypeType d@@16 Tclass._module.Expr $h@@8))) ($IsAlloc DatatypeTypeType (_module.Expr._h2 d@@16) (Tclass._module.List Tclass._module.Expr) $h@@8))
 :qid |unknown.0:0|
 :skolemid |651|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expr._h2 d@@16) (Tclass._module.List Tclass._module.Expr) $h@@8))
)))
(assert (forall ((d@@17 T@U) ($h@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (_module.Expr.Mul_q d@@17) ($IsAlloc DatatypeTypeType d@@17 Tclass._module.Expr $h@@9))) ($IsAlloc DatatypeTypeType (_module.Expr._h3 d@@17) (Tclass._module.List Tclass._module.Expr) $h@@9))
 :qid |unknown.0:0|
 :skolemid |660|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Expr._h3 d@@17) (Tclass._module.List Tclass._module.Expr) $h@@9))
)))
...
(assert (forall ((_module.List$A@@8 T@U) (|a#6#0#0@@0| T@U) (|a#6#1#0@@0| T@U) ($h@@10 T@U) ) (!  (=> ($IsGoodHeap $h@@10) (= ($IsAlloc DatatypeTypeType (|#_module.List.Cons| |a#6#0#0@@0| |a#6#1#0@@0|) (Tclass._module.List _module.List$A@@8) $h@@10)  (and ($IsAllocBox |a#6#0#0@@0| _module.List$A@@8 $h@@10) ($IsAlloc DatatypeTypeType |a#6#1#0@@0| (Tclass._module.List _module.List$A@@8) $h@@10))))
 :qid |unknown.0:0|
 :skolemid |633|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.List.Cons| |a#6#0#0@@0| |a#6#1#0@@0|) (Tclass._module.List _module.List$A@@8) $h@@10))
)))
...
(declare-fun |add#0@0| () T@U)
(declare-fun |##e#0@0| () T@U)
(declare-fun |two#0@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |two#0| () T@U)
(declare-fun |add#0| () T@U)
...
(let ((anon6_Else_correct  (=> (and (not (and (and ($Is DatatypeTypeType |x#0@0| Tclass._module.Expr) ($IsAlloc DatatypeTypeType |x#0@0| Tclass._module.Expr |$lambdaHeap#0@0|)) (and ($Is DatatypeTypeType |y#0@0| Tclass._module.Expr) ($IsAlloc DatatypeTypeType |y#0@0| Tclass._module.Expr |$lambdaHeap#0@0|)))) (= (ControlFlow 0 5) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |x#0@0| Tclass._module.Expr) ($IsAlloc DatatypeTypeType |x#0@0| Tclass._module.Expr |$lambdaHeap#0@0|)) (and ($Is DatatypeTypeType |y#0@0| Tclass._module.Expr) ($IsAlloc DatatypeTypeType |y#0@0| Tclass._module.Expr |$lambdaHeap#0@0|))) (and (and (= |$_Frame#l0@0| (|lambda#40| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (|#_module.Expr.Add| (|#_module.List.Cons| ($Box DatatypeTypeType |x#0@0|) (|#_module.List.Cons| ($Box DatatypeTypeType |y#0@0|) (Lit DatatypeTypeType |#_module.List.Nil|)))))) (and ($Is DatatypeTypeType |lambdaResult#0| Tclass._module.Expr) (= (ControlFlow 0 4) 3)))) anon3_correct)))
(let ((anon5_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@3 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@3 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 6) 4) anon6_Then_correct) (=> (= (ControlFlow 0 6) 5) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= |add#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#89| (Handle2 (|lambda#85| (Lit DatatypeTypeType |#_module.List.Nil|)) (|lambda#86| Tclass._module.Expr Tclass._module.Expr) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (= |##e#0@0| ($Unbox DatatypeTypeType (Apply2 Tclass._module.Expr Tclass._module.Expr Tclass._module.Expr $Heap@@3 |add#0@0| ($Box DatatypeTypeType |two#0@0|) ($Box DatatypeTypeType |two#0@0|))))) (=> (and (and ($IsAlloc DatatypeTypeType |##e#0@0| Tclass._module.Expr $Heap@@3) (|_module.__default.Eval#canCall| ($Unbox DatatypeTypeType (Apply2 Tclass._module.Expr Tclass._module.Expr Tclass._module.Expr $Heap@@3 |add#0@0| ($Box DatatypeTypeType |two#0@0|) ($Box DatatypeTypeType |two#0@0|))))) (and (|_module.__default.Eval#canCall| ($Unbox DatatypeTypeType (Apply2 Tclass._module.Expr Tclass._module.Expr Tclass._module.Expr $Heap@@3 |add#0@0| ($Box DatatypeTypeType |two#0@0|) ($Box DatatypeTypeType |two#0@0|)))) (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.Eval ($LS ($LS $LZ)) ($Unbox DatatypeTypeType (Apply2 Tclass._module.Expr Tclass._module.Expr Tclass._module.Expr $Heap@@3 |add#0@0| ($Box DatatypeTypeType |two#0@0|) ($Box DatatypeTypeType |two#0@0|)))) (LitInt 4))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#40| null $Heap@@3 alloc false)) (= |two#0@0| (Lit DatatypeTypeType (|#_module.Expr.Lit| (LitInt 2))))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and ($Is DatatypeTypeType |two#0| Tclass._module.Expr) ($IsAlloc DatatypeTypeType |two#0| Tclass._module.Expr $Heap@@3)) true) (=> (and (and (and ($Is HandleTypeType |add#0| (Tclass._System.___hTotalFunc2 Tclass._module.Expr Tclass._module.Expr Tclass._module.Expr)) ($IsAlloc HandleTypeType |add#0| (Tclass._System.___hTotalFunc2 Tclass._module.Expr Tclass._module.Expr Tclass._module.Expr) $Heap@@3)) true) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))))
