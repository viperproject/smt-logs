...
(set-info :boogie-vc-id Impl$$FuncCollectionRegressions.__default.P0)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and ($Is refType |c#0@@1| Tclass.FuncCollectionRegressions.C) ($IsAlloc refType |c#0@@1| Tclass.FuncCollectionRegressions.C $Heap@@3)) (and (= 3 $FunctionContextHeight) (not (|Set#IsMember| FuncCollectionRegressions.__default.A0 ($Box refType |c#0@@1|))))) (and (and (not (U_2_bool (MapType0Select BoxType boolType FuncCollectionRegressions.__default.A1 ($Box refType |c#0@@1|)))) (not (|Seq#Contains| FuncCollectionRegressions.__default.A2 ($Box refType |c#0@@1|)))) (and (not (> (|MultiSet#Multiplicity| FuncCollectionRegressions.__default.A3 ($Box refType |c#0@@1|)) 0)) (= (ControlFlow 0 6) 2)))) anon0_correct))))
