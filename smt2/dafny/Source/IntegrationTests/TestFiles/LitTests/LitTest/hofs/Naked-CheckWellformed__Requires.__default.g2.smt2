...
(declare-fun Requires.__default.D (Int) Int)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun |Requires.__default.D#canCall| (Int) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$Requires.__default.g2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (=> ($IsAlloc intType (int_2_U |x#0@@6|) TInt $Heap@@1) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (Requires1 TInt TInt $Heap@@1 (|Requires.__default.g2#Handle| ($LS ($LS $LZ))) ($Box intType (int_2_U |x#0@@6|))))) (=> (not (Requires1 TInt TInt $Heap@@1 (|Requires.__default.g2#Handle| ($LS $LZ)) ($Box intType (int_2_U |x#0@@6|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 (Requires.__default.D |x#0@@6|)) (= |x#0@@6| (Requires.__default.D |x#0@@6|)))) (=> (or (<= 0 (Requires.__default.D |x#0@@6|)) (= |x#0@@6| (Requires.__default.D |x#0@@6|))) (=> (= (ControlFlow 0 3) (- 0 2)) (< |x#0@@6| (Requires.__default.D |x#0@@6|))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and ($IsAlloc intType (int_2_U |x#0@@6|) TInt $Heap@@1) (|Requires.__default.D#canCall| |x#0@@6|)) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
