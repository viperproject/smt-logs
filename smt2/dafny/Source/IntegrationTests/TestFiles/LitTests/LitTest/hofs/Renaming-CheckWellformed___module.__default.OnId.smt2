...
(declare-fun _module.__default.OnId (T@U T@U) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.OnId#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|f#0| T@U) ) (!  (=> (or (|_module.__default.OnId#canCall| $Heap |f#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |f#0| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt))) (Requires1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $Heap |f#0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))) (= (_module.__default.OnId $Heap |f#0|) (U_2_int ($Unbox intType (Apply1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $Heap |f#0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))))))
 :qid |Renamingdfy.3:10|
 :skolemid |483|
 :pattern ( (_module.__default.OnId $Heap |f#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($h0 T@U) ($h1 T@U) (|f#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.OnId#canCall| $h0 |f#0@@0|) ($Is HandleTypeType |f#0@@0| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (|Set#IsMember| (Reads1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $h0 |f#0@@0| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))) ($Box refType $o@@0))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@0) $f) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@0) $f)))
 :qid |unknown.0:0|
 :skolemid |479|
)) (= (_module.__default.OnId $h0 |f#0@@0|) (_module.__default.OnId $h1 |f#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |480|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.__default.OnId $h1 |f#0@@0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@2 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#61| |l#0@@2| |l#1| |l#2| |l#3|) $o@@2 $f@@0))  (=> (and (or (not (= $o@@2 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@2) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |505|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#61| |l#0@@2| |l#1| |l#2| |l#3|) $o@@2 $f@@0))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| T@U) ($o@@3 T@U) ($f@@1 T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#20| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@3 $f@@1))  (=> (and (or (not (= $o@@3 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@3) |l#2@@0|)))) (|Set#IsMember| |l#3@@0| ($Box refType $o@@3))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |504|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#20| |l#0@@3| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@3 $f@@1))
)))
...
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0@@1|) |l#0@@4|)
 :qid |Renamingdfy.4:17|
 :skolemid |502|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#x#0@@1|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.OnId)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon22_Else_correct true))
(let ((anon22_Then_correct true))
(let ((anon21_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 19) 17) anon22_Then_correct) (=> (= (ControlFlow 0 19) 18) anon22_Else_correct)))))
(let ((anon24_Else_correct true))
(let ((anon24_Then_correct true))
(let ((anon23_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap@@0 |$lambdaHeap#1@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 14) 12) anon24_Then_correct) (=> (= (ControlFlow 0 14) 13) anon24_Else_correct)))))
(let ((anon26_Else_correct true))
(let ((anon26_Then_correct true))
(let ((anon25_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2@0|) (or (= $Heap@@0 |$lambdaHeap#2@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#2@0|))) (and (=> (= (ControlFlow 0 9) 7) anon26_Then_correct) (=> (= (ControlFlow 0 9) 8) anon26_Else_correct)))))
(let ((anon29_Else_correct true))
(let ((anon29_Then_correct true))
(let ((anon28_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#3@0|) (or (= $Heap@@0 |$lambdaHeap#3@0|) ($HeapSucc $Heap@@0 |$lambdaHeap#3@0|))) (and (=> (= (ControlFlow 0 5) 3) anon29_Then_correct) (=> (= (ControlFlow 0 5) 4) anon29_Else_correct)))))
(let ((anon28_Else_correct true))
(let ((anon27_Then_correct true))
(let ((anon25_Else_correct  (=> (and (= |##x0#2@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |##x0#2@0| (Tclass._System.___hTotalFunc1 TBool TBool) $Heap@@0)) (and (and (=> (= (ControlFlow 0 6) 1) anon27_Then_correct) (=> (= (ControlFlow 0 6) 5) anon28_Then_correct)) (=> (= (ControlFlow 0 6) 2) anon28_Else_correct)))))
(let ((anon23_Else_correct  (=> (= |##x0#1@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##x0#1@0| (Tclass._System.___hTotalFunc1 TBool TBool) $Heap@@0) (= |b$reqreads#1@0| (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $o@@4) alloc)))) (|Set#IsMember| (Reads1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $Heap@@0 |f#0@@5| ($Box HandleTypeType |##x0#1@0|)) ($Box refType $o@@4))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@2)))
 :qid |Renamingdfy.4:11|
 :skolemid |485|
)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (=> ($IsAllocBox ($Box HandleTypeType |f#0@@5|) (Tclass._System.___hFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt) $Heap@@0) (and (=> (= (ControlFlow 0 10) 9) anon25_Then_correct) (=> (= (ControlFlow 0 10) 6) anon25_Else_correct)))))))))
(let ((anon21_Else_correct  (=> (and (and (= |##x0#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |##x0#0@0| (Tclass._System.___hTotalFunc1 TBool TBool) $Heap@@0)) (and (= |b$reqreads#0@0| (forall (($o@@5 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@0 $o@@5) alloc)))) (|Set#IsMember| (Reads1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $Heap@@0 |f#0@@5| ($Box HandleTypeType |##x0#0@0|)) ($Box refType $o@@5))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@5 $f@@3)))
 :qid |Renamingdfy.5:14|
 :skolemid |484|
))) (Requires1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $Heap@@0 |f#0@@5| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))) (and (=> (= (ControlFlow 0 15) (- 0 16)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> ($IsAllocBox ($Box HandleTypeType |f#0@@5|) (Tclass._System.___hFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt) $Heap@@0) (and (=> (= (ControlFlow 0 15) 14) anon23_Then_correct) (=> (= (ControlFlow 0 15) 10) anon23_Else_correct))))))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#20| null $Heap@@0 alloc (Reads1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt $Heap@@0 |f#0@@5| ($Box HandleTypeType (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))) ($IsAllocBox ($Box HandleTypeType |f#0@@5|) (Tclass._System.___hFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt) $Heap@@0)) (and (=> (= (ControlFlow 0 20) 19) anon21_Then_correct) (=> (= (ControlFlow 0 20) 15) anon21_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) ($Is HandleTypeType |f#0@@5| (Tclass._System.___hTotalFunc1 (Tclass._System.___hTotalFunc1 TBool TBool) TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 21) 20))) anon0_correct)))
