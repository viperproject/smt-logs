...
(let ((anon3_Then_correct  (=> (_module.__default.valid |a#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> ($IsAllocBox ($Box HandleTypeType |_module.__default.ref1#Handle|) (Tclass._System.___hFunc1 TInt TInt) $Heap) (=> (and ($IsAlloc intType (int_2_U |a#0|) TInt $Heap) (= (ControlFlow 0 2) (- 0 1))) (Requires1 TInt TInt $Heap |_module.__default.ref1#Handle| ($Box intType (int_2_U |a#0|))))))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc intType (int_2_U |a#0|) TInt $Heap)) (and (|_module.__default.valid#canCall| |a#0|) (|_module.__default.valid#canCall| |a#0|))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
