...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split170)
...
))))) (and ($IsGoodHeap $Heap@22) ($IsHeapAnchor $Heap@22)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@21 |universe#0|) (=> (_module.Universe.globalInv $Heap@21 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@19 $Heap@21 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@21 |universe#0|) (and (_module.Universe.globalInv $Heap@21 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@21 |universe#0|) (forall ((|o#17@@5| T@U) ) (!  (=> (and ($Is refType |o#17@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@5|))) (_module.Object.inv $Heap@21 |o#17@@5|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))) (and (= $Heap@21 $Heap@22) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
