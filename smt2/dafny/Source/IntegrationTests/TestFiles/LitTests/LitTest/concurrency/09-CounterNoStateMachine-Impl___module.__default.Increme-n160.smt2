...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split149)
...
)) ($HeapSucc $Heap@19 $Heap@20)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@19))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
