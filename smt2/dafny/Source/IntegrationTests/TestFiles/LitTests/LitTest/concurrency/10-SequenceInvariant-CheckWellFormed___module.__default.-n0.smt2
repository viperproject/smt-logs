...
(assert (forall (($o@@11 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@11 Tclass._module.IncreasingCounter? $heap@@1) ($IsAlloc refType $o@@11 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |2414|
 :pattern ( ($IsAlloc refType $o@@11 Tclass._module.IncreasingCounter? $heap@@1))
)))
(assert (forall (($o@@12 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@12 Tclass._module.Integer? $heap@@2) ($IsAlloc refType $o@@12 Tclass._module.OwnedObject? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |2418|
 :pattern ( ($IsAlloc refType $o@@12 Tclass._module.Integer? $heap@@2))
)))
...
(assert (forall (($o@@13 T@U) ) (!  (=> ($Is refType $o@@13 Tclass._module.Thread?) ($Is refType $o@@13 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |2405|
 :pattern ( ($Is refType $o@@13 Tclass._module.Thread?))
)))
...
(assert (forall (($o@@15 T@U) ) (!  (=> ($Is refType $o@@15 Tclass._module.IncreasingCounter?) ($Is refType $o@@15 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2413|
 :pattern ( ($Is refType $o@@15 Tclass._module.IncreasingCounter?))
)))
...
(assert (forall (($o@@16 T@U) ) (!  (=> ($Is refType $o@@16 Tclass._module.Integer?) ($Is refType $o@@16 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2417|
 :pattern ( ($Is refType $o@@16 Tclass._module.Integer?))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Incrementer_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap))) (and (and ($Is refType |running#0| Tclass._module.Thread) ($IsAlloc refType |running#0| Tclass._module.Thread $Heap)) (and ($Is refType |counter#0| Tclass._module.IncreasingCounter) ($IsAlloc refType |counter#0| Tclass._module.IncreasingCounter $Heap)))) (and (and (and ($Is refType |remaining#0| Tclass._module.Integer) ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap)) (= 18 $FunctionContextHeight)) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |universe#0|) _module.Universe.content)))) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |universe#0| null)) (not true)))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
