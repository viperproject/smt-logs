...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.Thread))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f T@U) )  (=> (and (or (not (= $o@@6 null)) (not true)) (or (= $o@@6 this@@0) (= $o@@6 (_module.Object.universe this@@0)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@6) $f)))) (= (_module.Thread.baseFieldsInv $h0 this@@0) (_module.Thread.baseFieldsInv $h1 this@@0))))
...
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@15 T@U) ($f@@3 T@U) ) true)) (=> (forall (($o@@16 T@U) ($f@@4 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@17 T@U) ($f@@5 T@U) ) true)) (=> (forall (($o@@18 T@U) ($f@@6 T@U) ) true) (=> (and (and (_module.Thread.baseFieldsInv current$Heap this@@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.Thread.baseFieldsInv#canCall| current$Heap this@@1)) (or (_module.Thread.baseFieldsInv current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))))))
