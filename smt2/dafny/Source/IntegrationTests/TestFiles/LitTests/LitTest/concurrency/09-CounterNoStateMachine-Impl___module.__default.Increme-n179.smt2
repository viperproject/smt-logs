...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split168)
...
))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|))) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (=> |$w$loop#0@0| (= (+ |i#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.Integer.value)))) (LitInt 10)))))) (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> |defass#initial_value#0_0@0| (and ($Is refType |initial_value#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value#0_0@0| Tclass._module.ConstantInteger $Heap@4)))) (and (and (=> |defass#claim1#0_0@0| (and ($Is refType |claim1#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim1#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@4))) (=> |defass#initial_value_plus_one#0_0@0| (and ($Is refType |initial_value_plus_one#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value_plus_one#0_0@0| Tclass._module.ConstantInteger $Heap@4)))) (and (=> |defass#claim2#0_0@0| (and ($Is refType |claim2#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim2#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@4))) (=> |defass#final_value#0_0@0| (and ($Is refType |final_value#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |final_value#0_0@0| Tclass._module.ConstantInteger $Heap@4)))))))))) (and (and (and (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (=> |$w$loop#0@0| (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalInv $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|))) (and (= (_module.Object.universe |o#16@@0|) |universe#0|) (or (not (= |o#16@@0| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |532|
...
))))) (and ($IsGoodHeap $Heap@16) ($IsHeapAnchor $Heap@16)))))))) (and (and (and (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (=> (_module.Universe.globalInv $Heap@15 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@13 $Heap@15 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (and (_module.Universe.globalInv $Heap@15 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#17@@3| T@U) ) (!  (=> (and ($Is refType |o#17@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@3|))) (_module.Object.inv $Heap@15 |o#17@@3|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))))) (and (and (and (and ($IsGoodHeap $Heap@17) ($IsHeapAnchor $Heap@17)) (and (or (not (= call4formal@this@0@@0 null)) (not true)) (and ($Is refType call4formal@this@0@@0 Tclass._module.ConstantInteger) ($IsAlloc refType call4formal@this@0@@0 Tclass._module.ConstantInteger $Heap@17)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@17 call4formal@this@0@@0) (=> (_module.Object.objectGlobalInv $Heap@17 call4formal@this@0@@0) (|_module.Universe.globalInv2#canCall| $Heap@16 $Heap@17 |universe#0|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@17 call4formal@this@0@@0) (and (_module.Object.objectGlobalInv $Heap@17 call4formal@this@0@@0) (and (_module.Object.baseInv $Heap@17 call4formal@this@0@@0) (_module.Universe.globalInv $Heap@17 (_module.Object.universe call4formal@this@0@@0))))))) (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@16 $Heap@17 |universe#0|) (and (_module.Universe.globalInv2 $Heap@16 $Heap@17 |universe#0|) (and true (forall ((|o#8@@4| T@U) ) (!  (=> (and ($Is refType |o#8@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|)) (_module.Object.inv2 $Heap@16 $Heap@17 |o#8@@4|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |2895|
...
))))) (= (_module.Object.universe call4formal@this@0@@0) |universe#0|)) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call4formal@this@0@@0) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call4formal@this@0@@0) _module.ConstantInteger.value))) |value##0_1@1|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@0)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call4formal@this@0@@0) alloc))))))))) (and (and (and (and (and (forall (($o@@141 T@U) ) (!  (=> (and (or (not (= $o@@141 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@141) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 $o@@141) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@141)) (= $o@@141 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.608:3|
 :skolemid |2896|
...
))))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |counter#0|)))))) (and (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType call4formal@this@0@@0)) (>= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |counter#0|) _module.IncreasingCounter.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call4formal@this@0@@0) _module.ConstantInteger.value))))) (and ($IsGoodHeap $Heap@20) ($IsHeapAnchor $Heap@20))) (and (and (or (not (= call5formal@this@0@@0 null)) (not true)) (and ($Is refType call5formal@this@0@@0 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType call5formal@this@0@@0 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@20))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@20 call5formal@this@0@@0) (=> (_module.Object.objectGlobalInv $Heap@20 call5formal@this@0@@0) (|_module.Universe.globalInv2#canCall| $Heap@19 $Heap@20 |universe#0|))))) (and (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@20 call5formal@this@0@@0) (and (_module.Object.objectGlobalInv $Heap@20 call5formal@this@0@@0) (and (_module.Object.baseInv $Heap@20 call5formal@this@0@@0) (_module.Universe.globalInv $Heap@20 (_module.Object.universe call5formal@this@0@@0))))) (and (|_module.Universe.globalInv2#canCall| $Heap@19 $Heap@20 |universe#0|) (and (_module.Universe.globalInv2 $Heap@19 $Heap@20 |universe#0|) (and true (forall ((|o#8@@6| T@U) ) (!  (=> (and ($Is refType |o#8@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@6|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@6|)) (_module.Object.inv2 $Heap@19 $Heap@20 |o#8@@6|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |3167|
...
)))))) (and (and (= (_module.Object.universe call5formal@this@0@@0) |universe#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.OwnedObject.owner)) |running#0@@3|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.ClaimIncreasingCounterGreaterThanConstant.counter)) |counter#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.ClaimIncreasingCounterGreaterThanConstant.constant)) call4formal@this@0@@0)))))) (and (and (and (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0@@0)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call5formal@this@0@@0) alloc))))) (and (forall (($o@@148 T@U) ) (!  (=> (and (or (not (= $o@@148 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@148) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@148) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@148)) (= $o@@148 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.657:3|
 :skolemid |3168|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@148))
)) ($HeapSucc $Heap@19 $Heap@20))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@19)) (and ($IsGoodHeap $Heap@21) ($IsHeapAnchor $Heap@21)))) (and (and (and (forall ((|o#1@@24| T@U) ) (!  (=> ($Is refType |o#1@@24| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@24|)) (=> (=> ($Is refType |o#1@@24| Tclass._module.OwnedObject) (and (forall (($o@@149 T@U) ($f@@95 T@U) ) (!  (=> (or (not (= $o@@149 null)) (not true)) (=> (= $o@@149 |o#1@@24|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@149) $f@@95) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@149) $f@@95))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
