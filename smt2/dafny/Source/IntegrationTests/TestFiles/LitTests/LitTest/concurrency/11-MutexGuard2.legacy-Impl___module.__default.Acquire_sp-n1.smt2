...
))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |mutex#0|)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@87 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall (($o@@105 T@U) ($f@@61 T@U) ) (!  (=> (and (and (or (not (= $o@@105 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 $o@@105) alloc)))) (or (= $o@@105 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType $o@@105)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@105 $f@@61)))
 :qid |_11MutexGuard2legacydfy.606:24|
 :skolemid |518|
))) (=> (forall (($o@@106 T@U) ($f@@62 T@U) ) (!  (=> (and (and (or (not (= $o@@106 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 $o@@106) alloc)))) (or (= $o@@106 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType $o@@106)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@106 $f@@62)))
 :qid |_11MutexGuard2legacydfy.606:24|
 :skolemid |518|
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.globalInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalInv $Heap@@87 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@87 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalInv $Heap@@87 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@87 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Universe.globalInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalInv $Heap@@87 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@87 |universe#0|) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@13|))) (and (and (and (= (_module.Object.universe |o#0@@13|) |universe#0|) (or (not (= |o#0@@13| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@87 |o#0@@13|)) (_module.Object.triggerAxioms $Heap@@87 |o#0@@13|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |874|
...
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalInv $Heap@@87 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@87 |universe#0|) (forall ((|o#0@@14| T@U) ) (!  (=> (and ($Is refType |o#0@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|))) (and (and (and (= (_module.Object.universe |o#0@@14|) |universe#0|) (or (not (= |o#0@@14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@87 |o#0@@14|)) (_module.Object.triggerAxioms $Heap@@87 |o#0@@14|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |874|
 :pattern ( (_module.Object.triggerAxioms $Heap@@87 |o#0@@14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@87 |o#0@@14|))
 :pattern ( (_module.Object.universe |o#0@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Universe.globalInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalInv $Heap@@87 |universe#0|) (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@2|))) (_module.Object.inv $Heap@@87 |o#1@@2|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |876|
...
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalInv $Heap@@87 |universe#0|) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@3|))) (_module.Object.inv $Heap@@87 |o#1@@3|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |876|
 :pattern ( (_module.Object.inv $Heap@@87 |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@3|)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))))))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
