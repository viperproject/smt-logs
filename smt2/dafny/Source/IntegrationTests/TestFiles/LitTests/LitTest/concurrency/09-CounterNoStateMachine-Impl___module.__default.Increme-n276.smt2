...
))))) (= $Heap@31 $Heap@32)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))) (forall (($o@@177 T@U) ($f@@119 T@U) ) (!  (=> (and (and (or (not (= $o@@177 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 $o@@177) alloc)))) (or (= $o@@177 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType $o@@177)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@177 $f@@119)))
