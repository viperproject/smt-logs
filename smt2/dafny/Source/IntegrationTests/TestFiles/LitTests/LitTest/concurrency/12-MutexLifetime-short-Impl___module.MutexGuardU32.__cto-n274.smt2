...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split43)
...
)))) (and (and ($HeapSucc $Heap@4 $Heap@5) (or (not (= call5formal@this@0 null)) (not true))) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Lifetime.elements)) (= (ControlFlow 0 2) (- 0 1))))))))) (or (not (= call5formal@this@0 null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
