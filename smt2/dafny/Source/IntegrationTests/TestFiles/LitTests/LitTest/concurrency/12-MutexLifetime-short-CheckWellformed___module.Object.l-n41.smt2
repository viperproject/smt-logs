...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@18 this@@21) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Thread) ($IsAlloc refType this@@21 Tclass._module.Thread $Heap@@18)))))) (=> (_module.Thread.localInv $Heap@@18 this@@21) (_module.Object.objectGlobalBaseInv $Heap@@18 this@@21)))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1518|
 :pattern ( (_module.Thread.localInv $Heap@@18 this@@21))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@19 this@@22) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Lifetime) ($IsAlloc refType this@@22 Tclass._module.Lifetime $Heap@@19)))))) (=> (_module.Lifetime.localInv $Heap@@19 this@@22) (_module.Object.objectGlobalBaseInv $Heap@@19 this@@22)))
 :qid |_12MutexLifetimeshortdfy.578:19|
 :skolemid |1968|
 :pattern ( (_module.Lifetime.localInv $Heap@@19 this@@22))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@23) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.OwnedObject) ($IsAlloc refType this@@23 Tclass._module.OwnedObject $Heap@@20)))))) (=> (_module.OwnedObject.localInv $Heap@@20 this@@23) (_module.Object.objectGlobalBaseInv $Heap@@20 this@@23)))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localInv $Heap@@20 this@@23))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@24 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@21 this@@24) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.Object) ($IsAlloc refType this@@24 Tclass._module.Object $Heap@@21)))))) (=> (_module.Object.localInv $Heap@@21 this@@24) (_module.Object.objectGlobalBaseInv $Heap@@21 this@@24)))
 :qid |_12MutexLifetimeshortdfy.350:19|
 :skolemid |1428|
 :pattern ( (_module.Object.localInv $Heap@@21 this@@24))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@25 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@25)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@25)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :weight 3
 :skolemid |1499|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@25)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@26 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@26)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@26 null)) (not true)) ($Is refType this@@26 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@26)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :weight 3
 :skolemid |1766|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@26)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@27 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@27)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@27 null)) (not true)) ($Is refType this@@27 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@27)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :weight 3
 :skolemid |1944|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@27)))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@22 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@22 this@@28) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Lifetime) ($IsAlloc refType this@@28 Tclass._module.Lifetime $Heap@@22)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@22 this@@28) (=> (_module.Object.objectGlobalBaseInv $Heap@@22 this@@28) (=> (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#0@@1|))) (= (_module.OwnedObject.lifetime |o#0@@1|) this@@28))
 :qid |_12MutexLifetimeshortdfy.580:16|
 :skolemid |1983|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#0@@1|)))
)) (and (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#1|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@22 |o#1|) (|_module.Lifetime.alive#canCall| $Heap@@22 this@@28))))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1976|
 :pattern ( (_module.OwnedObject.alive $Heap@@22 |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#1|)))
)) (=> (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#1@@0|))) (= (_module.OwnedObject.alive $Heap@@22 |o#1@@0|) (_module.Lifetime.alive $Heap@@22 this@@28)))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1982|
 :pattern ( (_module.OwnedObject.alive $Heap@@22 |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#1@@0|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@22 this@@28) (=> (_module.Lifetime.alive $Heap@@22 this@@28) (forall ((|l#0@@0| T@U) ) (!  (=> ($Is refType |l#0@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@22 |l#0@@0|)))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1977|
 :pattern ( (_module.Lifetime.alive $Heap@@22 |l#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@22 this@@28) (forall ((|l#0@@1| T@U) ) (!  (=> (and ($Is refType |l#0@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|))) (_module.Lifetime.alive $Heap@@22 |l#0@@1|))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1981|
 :pattern ( (_module.Lifetime.alive $Heap@@22 |l#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@22 this@@28) (=> (not (_module.Lifetime.alive $Heap@@22 this@@28)) (forall ((|l#1@@0| T@U) ) (!  (=> ($Is refType |l#1@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@22 |l#1@@0|)))
 :qid |_12MutexLifetimeshortdfy.584:29|
 :skolemid |1978|
 :pattern ( (_module.Lifetime.alive $Heap@@22 |l#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@22 this@@28)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@22 this@@28) (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#0@@2|))) (= (_module.OwnedObject.lifetime |o#0@@2|) this@@28))
 :qid |_12MutexLifetimeshortdfy.580:16|
 :skolemid |1970|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#0@@2|)))
))) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#1@@1|))) (= (_module.OwnedObject.alive $Heap@@22 |o#1@@1|) (_module.Lifetime.alive $Heap@@22 this@@28)))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1971|
 :pattern ( (_module.OwnedObject.alive $Heap@@22 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.elements)) ($Box refType |o#1@@1|)))
))) (=> (_module.Lifetime.alive $Heap@@22 this@@28) (forall ((|l#0@@2| T@U) ) (!  (=> (and ($Is refType |l#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|))) (_module.Lifetime.alive $Heap@@22 |l#0@@2|))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1972|
 :pattern ( (_module.Lifetime.alive $Heap@@22 |l#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@22 this@@28)) (forall ((|l#1@@1| T@U) ) (!  (=> (and ($Is refType |l#1@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|))) (not (_module.Lifetime.alive $Heap@@22 |l#1@@1|)))
 :qid |_12MutexLifetimeshortdfy.584:29|
 :skolemid |1973|
 :pattern ( (_module.Lifetime.alive $Heap@@22 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
)))) (forall ((|l#2@@0| T@U) ) (!  (=> (and ($Is refType |l#2@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 |l#2@@0|) _module.Lifetime.mightPointFrom)) ($Box refType this@@28)))
 :qid |_12MutexLifetimeshortdfy.585:16|
 :skolemid |1974|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 |l#2@@0|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@28)))
 :qid |_12MutexLifetimeshortdfy.586:16|
 :skolemid |1975|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 |l#3@@0|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@28) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimeshortdfy.578:19|
 :skolemid |1984|
 :pattern ( (_module.Lifetime.localInv $Heap@@22 this@@28) ($IsGoodHeap $Heap@@22))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@29 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@29) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@29 null)) (not true)) ($Is refType this@@29 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@29) (_module.Thread.objectClassKind this@@29)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1500|
 :pattern ( (_module.Object.objectClassKind this@@29) ($Is refType this@@29 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@29) (_module.Thread.objectClassKind this@@29))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@30 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@30) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@30 null)) (not true)) ($Is refType this@@30 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@30) (_module.OwnedObject.objectClassKind this@@30)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1767|
 :pattern ( (_module.Object.objectClassKind this@@30) ($Is refType this@@30 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@30) (_module.OwnedObject.objectClassKind this@@30))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@31 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@31) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@31 null)) (not true)) ($Is refType this@@31 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@31) (_module.Lifetime.objectClassKind this@@31)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1945|
 :pattern ( (_module.Object.objectClassKind this@@31) ($Is refType this@@31 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@31) (_module.Lifetime.objectClassKind this@@31))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@32 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@32) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@32 null)) (not true)) ($Is refType this@@32 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@32) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :skolemid |1496|
 :pattern ( (_module.Thread.objectClassKind this@@32))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@33 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@33) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@33 null)) (not true)) ($Is refType this@@33 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@33) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :skolemid |1763|
 :pattern ( (_module.OwnedObject.objectClassKind this@@33))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@34 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@34) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@34 null)) (not true)) ($Is refType this@@34 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@34) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :skolemid |1941|
 :pattern ( (_module.Lifetime.objectClassKind this@@34))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@35 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@35) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@35) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1418|
 :pattern ( (_module.Object.objectClassKind this@@35))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@23 this@@36) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Thread) ($IsAlloc refType this@@36 Tclass._module.Thread $Heap@@23)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@23 this@@36)) (= (_module.Thread.localInv $Heap@@23 this@@36)  (and true (_module.Object.objectGlobalBaseInv $Heap@@23 this@@36)))))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1520|
 :pattern ( (_module.Thread.localInv $Heap@@23 this@@36) ($IsGoodHeap $Heap@@23))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@24 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@24 this@@37) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@24) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.OwnedObject) ($IsAlloc refType this@@37 Tclass._module.OwnedObject $Heap@@24)))))) (= (_module.OwnedObject.alive $Heap@@24 this@@37)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 this@@37) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.421:19|
 :skolemid |1762|
 :pattern ( (_module.OwnedObject.alive $Heap@@24 this@@37) ($IsGoodHeap $Heap@@24))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@25 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@25 this@@38) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@25) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.Lifetime) ($IsAlloc refType this@@38 Tclass._module.Lifetime $Heap@@25)))))) (= (_module.Lifetime.alive $Heap@@25 this@@38)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@38) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.551:19|
 :skolemid |1920|
 :pattern ( (_module.Lifetime.alive $Heap@@25 this@@38) ($IsGoodHeap $Heap@@25))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@26 T@U) (this@@39 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@26 this@@39) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@26) (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.Lifetime) ($IsAlloc refType this@@39 Tclass._module.Lifetime $Heap@@26)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@26 this@@39)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@39) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@39)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@39) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@39) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@39)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@39) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@39)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@39) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@39)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.563:19|
 :skolemid |1951|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@26 this@@39) ($IsGoodHeap $Heap@@26))
))))
(push 1)
...
(let ((anon8_Else_correct  (=> (and (=> (_module.Object.localInv $Heap@@27 this@@40) (_module.Object.objectGlobalBaseInv $Heap@@27 this@@40)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($IsAllocBox ($Box refType this@@40) Tclass._module.Object? $Heap@@27) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (= this@@40 this@@40) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@40 this@@40) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@40 this@@40) (|_module.Object.localInv#canCall| $Heap@@27 this@@40)) (_module.Object.localInv $Heap@@27 this@@40)) (=> (and (and ($IsAllocBox ($Box refType this@@40) Tclass._module.Object? $Heap@@27) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@27 this@@40)) (and (_module.Object.objectGlobalBaseInv $Heap@@27 this@@40) (= (ControlFlow 0 3) 2))) anon5_correct)))))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#59| null $Heap@@27 alloc $Heap@@27 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Else_correct) (=> (= (ControlFlow 0 6) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@27) ($IsHeapAnchor $Heap@@27)) (=> (and (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.Object) ($IsAlloc refType this@@40 Tclass._module.Object $Heap@@27))) (and (= 12 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
