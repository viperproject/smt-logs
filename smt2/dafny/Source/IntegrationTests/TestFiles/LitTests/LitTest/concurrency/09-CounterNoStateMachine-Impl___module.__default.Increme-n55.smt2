...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split44)
...
))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)))) (and (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|)))))) (= (+ |i#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.Integer.value)))) (LitInt 10))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
