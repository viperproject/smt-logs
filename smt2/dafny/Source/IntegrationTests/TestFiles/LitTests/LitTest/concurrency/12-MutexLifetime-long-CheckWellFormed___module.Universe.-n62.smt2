...
(assert (distinct TagSet alloc allocName Tagclass._System.nat Tagclass._module.Universe Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Thread Tagclass._module.Object? Tagclass._module.Lifetime Tagclass._module.Thread? Tagclass._module.Lifetime? class._module.Universe? class._module.Lifetime? tytagFamily$nat tytagFamily$Universe tytagFamily$Object tytagFamily$Thread tytagFamily$Lifetime field$content field$mightPointFrom field$mightPointTo)
)
(assert (= (FDim alloc) 0))
...
(assert (not
 ...
 :qid |_12MutexLifetimelongdfy.218:21|
 :skolemid |1663|
