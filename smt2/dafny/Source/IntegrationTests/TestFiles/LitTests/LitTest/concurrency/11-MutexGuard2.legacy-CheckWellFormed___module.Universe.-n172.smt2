...
(assert (forall (($prevHeap@@6 T@U) ($h0@@3 T@U) ($h1@@3 T@U) (this@@15 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Universe) ($IsAlloc refType this@@15 Tclass._module.Universe $h0@@3)))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@7 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@7) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@7) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@7) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |661|
)) (= (_module.Universe.globalInv2 $prevHeap@@6 $h0@@3 this@@15) (_module.Universe.globalInv2 $prevHeap@@6 $h1@@3 this@@15))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |662|
 :pattern ( ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3) (_module.Universe.globalInv2 $prevHeap@@6 $h1@@3 this@@15))
)))
(assert (forall (($prevHeap@@7 T@U) ($h0@@4 T@U) ($h1@@4 T@U) (this@@16 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.Universe) ($IsAlloc refType this@@16 Tclass._module.Universe $h0@@4)))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@8 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@8) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@8) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@8) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |672|
)) (= (_module.Universe.baseLegalTransitionsSequence $prevHeap@@7 $h0@@4 this@@16) (_module.Universe.baseLegalTransitionsSequence $prevHeap@@7 $h1@@4 this@@16))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |673|
 :pattern ( ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4) (_module.Universe.baseLegalTransitionsSequence $prevHeap@@7 $h1@@4 this@@16))
)))
(assert (forall (($prevHeap@@8 T@U) ($h0@@5 T@U) ($h1@@5 T@U) (this@@17 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Object) ($IsAlloc refType this@@17 Tclass._module.Object $h0@@5)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@9 T@U) ($f@@7 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@9) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@9) $f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@9) $f@@7)))
 :qid |unknown.0:0|
 :skolemid |1145|
)) (= (_module.Object.localInv2 $prevHeap@@8 $h0@@5 this@@17) (_module.Object.localInv2 $prevHeap@@8 $h1@@5 this@@17))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1146|
 :pattern ( ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5) (_module.Object.localInv2 $prevHeap@@8 $h1@@5 this@@17))
)))
(assert (forall (($prevHeap@@9 T@U) ($h0@@6 T@U) ($h1@@6 T@U) (this@@18 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Object) ($IsAlloc refType this@@18 Tclass._module.Object $h0@@6)))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@10 T@U) ($f@@8 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@10) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@10) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@10) $f@@8)))
 :qid |unknown.0:0|
 :skolemid |1153|
)) (= (_module.Object.sequenceInv2 $prevHeap@@9 $h0@@6 this@@18) (_module.Object.sequenceInv2 $prevHeap@@9 $h1@@6 this@@18))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1154|
 :pattern ( ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6) (_module.Object.sequenceInv2 $prevHeap@@9 $h1@@6 this@@18))
)))
(assert (forall (($prevHeap@@10 T@U) ($h0@@7 T@U) ($h1@@7 T@U) (this@@19 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Object) ($IsAlloc refType this@@19 Tclass._module.Object $h0@@7)))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@11 T@U) ($f@@9 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@11) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@11) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@11) $f@@9)))
 :qid |unknown.0:0|
 :skolemid |1157|
)) (= (_module.Object.inv2 $prevHeap@@10 $h0@@7 this@@19) (_module.Object.inv2 $prevHeap@@10 $h1@@7 this@@19))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1158|
 :pattern ( ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7) (_module.Object.inv2 $prevHeap@@10 $h1@@7 this@@19))
)))
(assert (forall (($prevHeap@@11 T@U) ($h0@@8 T@U) ($h1@@8 T@U) (this@@20 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Thread) ($IsAlloc refType this@@20 Tclass._module.Thread $h0@@8)))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@12 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@12) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@12) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@12) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |1250|
)) (= (_module.Thread.localInv2 $prevHeap@@11 $h0@@8 this@@20) (_module.Thread.localInv2 $prevHeap@@11 $h1@@8 this@@20))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1251|
 :pattern ( ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8) (_module.Thread.localInv2 $prevHeap@@11 $h1@@8 this@@20))
)))
(assert (forall (($prevHeap@@12 T@U) ($h0@@9 T@U) ($h1@@9 T@U) (this@@21 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@9) ($IsGoodHeap $h1@@9)) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Thread) ($IsAlloc refType this@@21 Tclass._module.Thread $h0@@9)))) (and ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9))) (=> (forall (($o@@13 T@U) ($f@@11 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@13) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@13) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@9 $o@@13) $f@@11)))
 :qid |unknown.0:0|
 :skolemid |1257|
)) (= (_module.Thread.sequenceInv2 $prevHeap@@12 $h0@@9 this@@21) (_module.Thread.sequenceInv2 $prevHeap@@12 $h1@@9 this@@21))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1258|
 :pattern ( ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9) (_module.Thread.sequenceInv2 $prevHeap@@12 $h1@@9 this@@21))
)))
(assert (forall (($prevHeap@@13 T@U) ($h0@@10 T@U) ($h1@@10 T@U) (this@@22 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Thread) ($IsAlloc refType this@@22 Tclass._module.Thread $h0@@10)))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@14 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@14) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@14) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@14) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |1264|
)) (= (_module.Thread.inv2 $prevHeap@@13 $h0@@10 this@@22) (_module.Thread.inv2 $prevHeap@@13 $h1@@10 this@@22))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1265|
 :pattern ( ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10) (_module.Thread.inv2 $prevHeap@@13 $h1@@10 this@@22))
)))
(assert (forall (($prevHeap@@14 T@U) ($h0@@11 T@U) ($h1@@11 T@U) (this@@23 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.OwnedObject) ($IsAlloc refType this@@23 Tclass._module.OwnedObject $h0@@11)))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@15 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@15) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@15) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@15) $f@@13)))
 :qid |unknown.0:0|
 :skolemid |1552|
)) (= (_module.OwnedObject.localInv2 $prevHeap@@14 $h0@@11 this@@23) (_module.OwnedObject.localInv2 $prevHeap@@14 $h1@@11 this@@23))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1553|
 :pattern ( ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11) (_module.OwnedObject.localInv2 $prevHeap@@14 $h1@@11 this@@23))
)))
(assert (forall (($prevHeap@@15 T@U) ($h0@@12 T@U) ($h1@@12 T@U) (this@@24 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.OwnedObject) ($IsAlloc refType this@@24 Tclass._module.OwnedObject $h0@@12)))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@16 T@U) ($f@@14 T@U) ) (!  (=> (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@16) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@16) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@16) $f@@14)))
 :qid |unknown.0:0|
 :skolemid |1560|
)) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@15 $h0@@12 this@@24) (_module.OwnedObject.sequenceInv2 $prevHeap@@15 $h1@@12 this@@24))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1561|
 :pattern ( ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12) (_module.OwnedObject.sequenceInv2 $prevHeap@@15 $h1@@12 this@@24))
)))
(assert (forall (($prevHeap@@16 T@U) ($h0@@13 T@U) ($h1@@13 T@U) (this@@25 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@13) ($IsGoodHeap $h1@@13)) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.OwnedObject) ($IsAlloc refType this@@25 Tclass._module.OwnedObject $h0@@13)))) (and ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13))) (=> (forall (($o@@17 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@17) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@17) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@13 $o@@17) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |1569|
)) (= (_module.OwnedObject.inv2 $prevHeap@@16 $h0@@13 this@@25) (_module.OwnedObject.inv2 $prevHeap@@16 $h1@@13 this@@25))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1570|
 :pattern ( ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13) (_module.OwnedObject.inv2 $prevHeap@@16 $h1@@13 this@@25))
)))
(assert (forall (($prevHeap@@17 T@U) ($h0@@14 T@U) ($h1@@14 T@U) (this@@26 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@14) ($IsGoodHeap $h1@@14)) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.OwnedObject) ($IsAlloc refType this@@26 Tclass._module.OwnedObject $h0@@14)))) (and ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14))) (=> (forall (($o@@18 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@18) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@18) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@14 $o@@18) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |1616|
)) (= (_module.OwnedObject.localUserInv2 $prevHeap@@17 $h0@@14 this@@26) (_module.OwnedObject.localUserInv2 $prevHeap@@17 $h1@@14 this@@26))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1617|
 :pattern ( ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14) (_module.OwnedObject.localUserInv2 $prevHeap@@17 $h1@@14 this@@26))
)))
(assert (forall (($prevHeap@@18 T@U) ($h0@@15 T@U) ($h1@@15 T@U) (this@@27 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@15) ($IsGoodHeap $h1@@15)) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.OwnedObject) ($IsAlloc refType this@@27 Tclass._module.OwnedObject $h0@@15)))) (and ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15))) (=> (forall (($o@@19 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@19) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@19) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@15 $o@@19) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |1624|
)) (= (_module.OwnedObject.userInv2 $prevHeap@@18 $h0@@15 this@@27) (_module.OwnedObject.userInv2 $prevHeap@@18 $h1@@15 this@@27))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1625|
 :pattern ( ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15) (_module.OwnedObject.userInv2 $prevHeap@@18 $h1@@15 this@@27))
)))
(assert (forall (($o@@20 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@20 Tclass._module.Universe? $h@@6)  (or (= $o@@20 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@20) alloc)))))
 :qid |unknown.0:0|
 :skolemid |622|
 :pattern ( ($IsAlloc refType $o@@20 Tclass._module.Universe? $h@@6))
)))
(assert (forall (($o@@21 T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType $o@@21 Tclass._module.Object? $h@@7)  (or (= $o@@21 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@21) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1064|
 :pattern ( ($IsAlloc refType $o@@21 Tclass._module.Object? $h@@7))
)))
(assert (forall (($o@@22 T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType $o@@22 Tclass._module.Thread? $h@@8)  (or (= $o@@22 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@22) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1205|
 :pattern ( ($IsAlloc refType $o@@22 Tclass._module.Thread? $h@@8))
)))
(assert (forall (($o@@23 T@U) ($h@@9 T@U) ) (! (= ($IsAlloc refType $o@@23 Tclass._module.OwnedObject? $h@@9)  (or (= $o@@23 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@23) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1493|
 :pattern ( ($IsAlloc refType $o@@23 Tclass._module.OwnedObject? $h@@9))
)))
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($prevHeap@@19 T@U) ($Heap@@12 T@U) (this@@29 T@U) (|running#0@@2| T@U) ) (!  (=> (or (|_module.Universe.legalTransition#canCall| $prevHeap@@19 $Heap@@12 this@@29 |running#0@@2|) (and (< 14 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@19) ($IsGoodHeap $Heap@@12)) ($HeapSucc $prevHeap@@19 $Heap@@12)) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Universe) ($IsAlloc refType this@@29 Tclass._module.Universe $prevHeap@@19)))) ($Is refType |running#0@@2| Tclass._module.Thread)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@19 $Heap@@12 this@@29 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (=> (_module.Universe.legalTransitionsSequence $prevHeap@@19 $Heap@@12 this@@29 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (and (|_module.Universe.globalInv#canCall| $prevHeap@@19 this@@29) (=> (_module.Universe.globalInv $prevHeap@@19 this@@29) (and (forall ((|o#0@@6| T@U) ) (!  (=> ($Is refType |o#0@@6| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#0@@6|)) (and (=> (not (forall (($o@@24 T@U) ($f@@18 T@U) ) (!  (=> (or (not (= $o@@24 null)) (not true)) (=> (= $o@@24 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@24) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 $o@@24) $f@@18))))
...
))) (|_module.Object.inv#canCall| $Heap@@12 |o#0@@6|)) (=> (or (forall (($o@@25 T@U) ($f@@19 T@U) ) (!  (=> (or (not (= $o@@25 null)) (not true)) (=> (= $o@@25 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@25) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 $o@@25) $f@@19))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |726|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@25) $f@@19))
)) (_module.Object.inv $Heap@@12 |o#0@@6|)) (=> (not (forall (($o@@26 T@U) ($f@@20 T@U) ) (!  (=> (or (not (= $o@@26 null)) (not true)) (=> (= $o@@26 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@26) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 $o@@26) $f@@20))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |725|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@26) $f@@20))
))) (|_module.Object.inv2#canCall| $prevHeap@@19 $Heap@@12 |o#0@@6|))))))
 :qid |_11MutexGuard2legacydfy.77:16|
 :skolemid |727|
 :pattern ( (_module.Object.inv2 $prevHeap@@19 $Heap@@12 |o#0@@6|))
 :pattern ( (_module.Object.inv $Heap@@12 |o#0@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#0@@6|)))
)) (=> (forall ((|o#0@@7| T@U) ) (!  (=> (and ($Is refType |o#0@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#0@@7|))) (and (or (forall (($o@@27 T@U) ($f@@21 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 |o#0@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@27) $f@@21) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 $o@@27) $f@@21))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |729|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@27) $f@@21))
)) (_module.Object.inv $Heap@@12 |o#0@@7|)) (or (forall (($o@@28 T@U) ($f@@22 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 |o#0@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@28) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 $o@@28) $f@@22))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |730|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@28) $f@@22))
)) (_module.Object.inv2 $prevHeap@@19 $Heap@@12 |o#0@@7|))))
 :qid |_11MutexGuard2legacydfy.77:16|
 :skolemid |731|
 :pattern ( (_module.Object.inv2 $prevHeap@@19 $Heap@@12 |o#0@@7|))
 :pattern ( (_module.Object.inv $Heap@@12 |o#0@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#0@@7|)))
)) (forall ((|o#1@@0| T@U) ) (!  (=> ($Is refType |o#1@@0| Tclass._module.Object) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@29) _module.Universe.content)) ($Box refType |o#1@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#1@@0|)))) (|_module.Object.inv#canCall| $Heap@@12 |o#1@@0|)))
 :qid |_11MutexGuard2legacydfy.79:16|
 :skolemid |728|
 :pattern ( (_module.Object.inv $Heap@@12 |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#1@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@29) _module.Universe.content)) ($Box refType |o#1@@0|)))
)))))))) (= (_module.Universe.legalTransition $prevHeap@@19 $Heap@@12 this@@29 |running#0@@2|)  (and (and (and (_module.Universe.legalTransitionsSequence $prevHeap@@19 $Heap@@12 this@@29 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (_module.Universe.globalInv $prevHeap@@19 this@@29)) (forall ((|o#0@@8| T@U) ) (!  (=> (and ($Is refType |o#0@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#0@@8|))) (and (or (forall (($o@@29 T@U) ($f@@23 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 |o#0@@8|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@29) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 $o@@29) $f@@23))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |720|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@29) $f@@23))
)) (_module.Object.inv $Heap@@12 |o#0@@8|)) (or (forall (($o@@30 T@U) ($f@@24 T@U) ) (!  (=> (or (not (= $o@@30 null)) (not true)) (=> (= $o@@30 |o#0@@8|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@30) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 $o@@30) $f@@24))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |721|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@30) $f@@24))
)) (_module.Object.inv2 $prevHeap@@19 $Heap@@12 |o#0@@8|))))
 :qid |_11MutexGuard2legacydfy.77:16|
 :skolemid |722|
 :pattern ( (_module.Object.inv2 $prevHeap@@19 $Heap@@12 |o#0@@8|))
 :pattern ( (_module.Object.inv $Heap@@12 |o#0@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#0@@8|)))
))) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@29) _module.Universe.content)) ($Box refType |o#1@@1|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#1@@1|))))) (_module.Object.inv $Heap@@12 |o#1@@1|))
 :qid |_11MutexGuard2legacydfy.79:16|
 :skolemid |723|
 :pattern ( (_module.Object.inv $Heap@@12 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@29) _module.Universe.content)) ($Box refType |o#1@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@29) _module.Universe.content)) ($Box refType |o#1@@1|)))
))))))
 :qid |_11MutexGuard2legacydfy.73:22|
 :skolemid |732|
 :pattern ( (_module.Universe.legalTransition $prevHeap@@19 $Heap@@12 this@@29 |running#0@@2|) ($IsGoodHeap $Heap@@12))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@13 this@@30) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Thread) ($IsAlloc refType this@@30 Tclass._module.Thread $Heap@@13)))))) (= (_module.Thread.baseFieldsInv $Heap@@13 this@@30) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.260:19|
 :skolemid |1216|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@13 this@@30) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@20 T@U) ($Heap@@14 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@20 $Heap@@14 this@@31) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@20) ($IsGoodHeap $Heap@@14)) ($HeapSucc $prevHeap@@20 $Heap@@14)) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Thread) ($IsAlloc refType this@@31 Tclass._module.Thread $prevHeap@@20)))))) (and (and (|_module.Thread.localInv2#canCall| $prevHeap@@20 $Heap@@14 this@@31) (=> (_module.Thread.localInv2 $prevHeap@@20 $Heap@@14 this@@31) (|_module.Thread.sequenceInv2#canCall| $prevHeap@@20 $Heap@@14 this@@31))) (= (_module.Thread.inv2 $prevHeap@@20 $Heap@@14 this@@31)  (and (_module.Thread.localInv2 $prevHeap@@20 $Heap@@14 this@@31) (_module.Thread.sequenceInv2 $prevHeap@@20 $Heap@@14 this@@31)))))
 :qid |_11MutexGuard2legacydfy.278:22|
 :skolemid |1268|
 :pattern ( (_module.Thread.inv2 $prevHeap@@20 $Heap@@14 this@@31) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@21 T@U) ($Heap@@15 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@21 $Heap@@15 this@@32) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@21) ($IsGoodHeap $Heap@@15)) ($HeapSucc $prevHeap@@21 $Heap@@15)) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.Thread) ($IsAlloc refType this@@32 Tclass._module.Thread $prevHeap@@21)))))) (=> (_module.Thread.inv2 $prevHeap@@21 $Heap@@15 this@@32) (and (_module.Thread.localInv2 $prevHeap@@21 $Heap@@15 this@@32) (_module.Thread.sequenceInv2 $prevHeap@@21 $Heap@@15 this@@32))))
 :qid |_11MutexGuard2legacydfy.278:22|
 :skolemid |1266|
 :pattern ( (_module.Thread.inv2 $prevHeap@@21 $Heap@@15 this@@32))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($prevHeap@@22 T@U) ($Heap@@16 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.OwnedObject.inv2#canCall| $prevHeap@@22 $Heap@@16 this@@33) (and (< 10 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@22) ($IsGoodHeap $Heap@@16)) ($HeapSucc $prevHeap@@22 $Heap@@16)) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.OwnedObject) ($IsAlloc refType this@@33 Tclass._module.OwnedObject $prevHeap@@22)))))) (=> (_module.OwnedObject.inv2 $prevHeap@@22 $Heap@@16 this@@33) (and (_module.OwnedObject.localInv2 $prevHeap@@22 $Heap@@16 this@@33) (_module.OwnedObject.sequenceInv2 $prevHeap@@22 $Heap@@16 this@@33))))
 :qid |_11MutexGuard2legacydfy.371:22|
 :skolemid |1571|
 :pattern ( (_module.OwnedObject.inv2 $prevHeap@@22 $Heap@@16 this@@33))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($prevHeap@@23 T@U) ($Heap@@17 T@U) (this@@34 T@U) ) (!  (=> (or (|_module.Object.inv2#canCall| $prevHeap@@23 $Heap@@17 this@@34) (and (< 11 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@23) ($IsGoodHeap $Heap@@17)) ($HeapSucc $prevHeap@@23 $Heap@@17)) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.Object) ($IsAlloc refType this@@34 Tclass._module.Object $prevHeap@@23)))))) (=> (_module.Object.inv2 $prevHeap@@23 $Heap@@17 this@@34) (and (_module.Object.localInv2 $prevHeap@@23 $Heap@@17 this@@34) (_module.Object.sequenceInv2 $prevHeap@@23 $Heap@@17 this@@34))))
 :qid |_11MutexGuard2legacydfy.251:22|
 :skolemid |1159|
 :pattern ( (_module.Object.inv2 $prevHeap@@23 $Heap@@17 this@@34))
))))
(assert ($IsGhostField alloc))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@35 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@18 this@@35) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.OwnedObject) ($IsAlloc refType this@@35 Tclass._module.OwnedObject $Heap@@18)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@18 this@@35) (=> (_module.Object.objectGlobalBaseInv $Heap@@18 this@@35) (|_module.OwnedObject.localUserInv#canCall| $Heap@@18 this@@35))) (= (_module.OwnedObject.localInv $Heap@@18 this@@35)  (and (_module.Object.objectGlobalBaseInv $Heap@@18 this@@35) (_module.OwnedObject.localUserInv $Heap@@18 this@@35)))))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1530|
 :pattern ( (_module.OwnedObject.localInv $Heap@@18 this@@35) ($IsGoodHeap $Heap@@18))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@19 this@@36) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.OwnedObject) ($IsAlloc refType this@@36 Tclass._module.OwnedObject $Heap@@19)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@19 this@@36) (=> (_module.OwnedObject.localInv $Heap@@19 this@@36) (|_module.OwnedObject.userInv#canCall| $Heap@@19 this@@36))) (= (_module.OwnedObject.inv $Heap@@19 this@@36)  (and (_module.OwnedObject.localInv $Heap@@19 this@@36) (_module.OwnedObject.userInv $Heap@@19 this@@36)))))
 :qid |_11MutexGuard2legacydfy.340:19|
 :skolemid |1543|
 :pattern ( (_module.OwnedObject.inv $Heap@@19 this@@36) ($IsGoodHeap $Heap@@19))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@24 T@U) ($Heap@@20 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@24 $Heap@@20 this@@37) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@37 null)) (not true)) ($Is refType this@@37 Tclass._module.Thread)))) (= (_module.Object.localInv2 $prevHeap@@24 $Heap@@20 this@@37) (_module.Thread.localInv2 $prevHeap@@24 $Heap@@20 this@@37)))
 :qid |_11MutexGuard2legacydfy.248:22|
 :skolemid |1255|
 :pattern ( (_module.Object.localInv2 $prevHeap@@24 $Heap@@20 this@@37) ($Is refType this@@37 Tclass._module.Thread) ($IsGoodHeap $Heap@@20))
 :pattern ( (_module.Object.localInv2 $prevHeap@@24 $Heap@@20 this@@37) (_module.Thread.localInv2 $prevHeap@@24 $Heap@@20 this@@37) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@25 T@U) ($Heap@@21 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@25 $Heap@@21 this@@38) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@38 null)) (not true)) ($Is refType this@@38 Tclass._module.Thread)))) (= (_module.Object.sequenceInv2 $prevHeap@@25 $Heap@@21 this@@38) (_module.Thread.sequenceInv2 $prevHeap@@25 $Heap@@21 this@@38)))
 :qid |_11MutexGuard2legacydfy.250:22|
 :skolemid |1262|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@25 $Heap@@21 this@@38) ($Is refType this@@38 Tclass._module.Thread) ($IsGoodHeap $Heap@@21))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@25 $Heap@@21 this@@38) (_module.Thread.sequenceInv2 $prevHeap@@25 $Heap@@21 this@@38) ($IsGoodHeap $Heap@@21))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@26 T@U) ($Heap@@22 T@U) (this@@39 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@26 $Heap@@22 this@@39) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@39 null)) (not true)) ($Is refType this@@39 Tclass._module.Thread)))) (= (_module.Object.inv2 $prevHeap@@26 $Heap@@22 this@@39) (_module.Thread.inv2 $prevHeap@@26 $Heap@@22 this@@39)))
 :qid |_11MutexGuard2legacydfy.251:22|
 :skolemid |1269|
 :pattern ( (_module.Object.inv2 $prevHeap@@26 $Heap@@22 this@@39) ($Is refType this@@39 Tclass._module.Thread) ($IsGoodHeap $Heap@@22))
 :pattern ( (_module.Object.inv2 $prevHeap@@26 $Heap@@22 this@@39) (_module.Thread.inv2 $prevHeap@@26 $Heap@@22 this@@39) ($IsGoodHeap $Heap@@22))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@27 T@U) ($Heap@@23 T@U) (this@@40 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@27 $Heap@@23 this@@40) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.OwnedObject)))) (= (_module.Object.localInv2 $prevHeap@@27 $Heap@@23 this@@40) (_module.OwnedObject.localInv2 $prevHeap@@27 $Heap@@23 this@@40)))
 :qid |_11MutexGuard2legacydfy.248:22|
 :skolemid |1557|
 :pattern ( (_module.Object.localInv2 $prevHeap@@27 $Heap@@23 this@@40) ($Is refType this@@40 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@23))
 :pattern ( (_module.Object.localInv2 $prevHeap@@27 $Heap@@23 this@@40) (_module.OwnedObject.localInv2 $prevHeap@@27 $Heap@@23 this@@40) ($IsGoodHeap $Heap@@23))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@28 T@U) ($Heap@@24 T@U) (this@@41 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@28 $Heap@@24 this@@41) (and (< 3 $FunctionContextHeight) (and (or (not (= this@@41 null)) (not true)) ($Is refType this@@41 Tclass._module.OwnedObject)))) (= (_module.Object.sequenceInv2 $prevHeap@@28 $Heap@@24 this@@41) (_module.OwnedObject.sequenceInv2 $prevHeap@@28 $Heap@@24 this@@41)))
 :qid |_11MutexGuard2legacydfy.250:22|
 :skolemid |1565|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@28 $Heap@@24 this@@41) ($Is refType this@@41 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@24))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@28 $Heap@@24 this@@41) (_module.OwnedObject.sequenceInv2 $prevHeap@@28 $Heap@@24 this@@41) ($IsGoodHeap $Heap@@24))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($prevHeap@@29 T@U) ($Heap@@25 T@U) (this@@42 T@U) ) (!  (=> (or (|_module.OwnedObject.inv2#canCall| $prevHeap@@29 $Heap@@25 this@@42) (and (< 10 $FunctionContextHeight) (and (or (not (= this@@42 null)) (not true)) ($Is refType this@@42 Tclass._module.OwnedObject)))) (= (_module.Object.inv2 $prevHeap@@29 $Heap@@25 this@@42) (_module.OwnedObject.inv2 $prevHeap@@29 $Heap@@25 this@@42)))
 :qid |_11MutexGuard2legacydfy.251:22|
 :skolemid |1574|
 :pattern ( (_module.Object.inv2 $prevHeap@@29 $Heap@@25 this@@42) ($Is refType this@@42 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@25))
 :pattern ( (_module.Object.inv2 $prevHeap@@29 $Heap@@25 this@@42) (_module.OwnedObject.inv2 $prevHeap@@29 $Heap@@25 this@@42) ($IsGoodHeap $Heap@@25))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@30 T@U) ($Heap@@26 T@U) (this@@43 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@30 $Heap@@26 this@@43) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@30) ($IsGoodHeap $Heap@@26)) ($HeapSucc $prevHeap@@30 $Heap@@26)) (and (or (not (= this@@43 null)) (not true)) (and ($Is refType this@@43 Tclass._module.Thread) ($IsAlloc refType this@@43 Tclass._module.Thread $prevHeap@@30)))))) (= (_module.Thread.localInv2 $prevHeap@@30 $Heap@@26 this@@43) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.272:22|
 :skolemid |1254|
 :pattern ( (_module.Thread.localInv2 $prevHeap@@30 $Heap@@26 this@@43) ($IsGoodHeap $Heap@@26))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@31 T@U) ($Heap@@27 T@U) (this@@44 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@31 $Heap@@27 this@@44) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@31) ($IsGoodHeap $Heap@@27)) ($HeapSucc $prevHeap@@31 $Heap@@27)) (and (or (not (= this@@44 null)) (not true)) (and ($Is refType this@@44 Tclass._module.Thread) ($IsAlloc refType this@@44 Tclass._module.Thread $prevHeap@@31)))))) (= (_module.Thread.sequenceInv2 $prevHeap@@31 $Heap@@27 this@@44) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.275:22|
 :skolemid |1261|
 :pattern ( (_module.Thread.sequenceInv2 $prevHeap@@31 $Heap@@27 this@@44) ($IsGoodHeap $Heap@@27))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@32 T@U) ($Heap@@28 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@32 $Heap@@28 this@@45) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@32) ($IsGoodHeap $Heap@@28)) ($HeapSucc $prevHeap@@32 $Heap@@28)) (and (or (not (= this@@45 null)) (not true)) (and ($Is refType this@@45 Tclass._module.OwnedObject) ($IsAlloc refType this@@45 Tclass._module.OwnedObject $prevHeap@@32)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.localUserInv2#canCall| $prevHeap@@32 $Heap@@28 this@@45)) (= (_module.OwnedObject.localInv2 $prevHeap@@32 $Heap@@28 this@@45)  (and true (_module.OwnedObject.localUserInv2 $prevHeap@@32 $Heap@@28 this@@45)))))
 :qid |_11MutexGuard2legacydfy.345:22|
 :skolemid |1556|
 :pattern ( (_module.OwnedObject.localInv2 $prevHeap@@32 $Heap@@28 this@@45) ($IsGoodHeap $Heap@@28))
))))
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@46 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@46 null)) (not true)) ($Is refType this@@46 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@35 T@U) ($f@@25 T@U) ) (!  (=> (and (or (not (= $o@@35 null)) (not true)) (or (= $o@@35 this@@46) (= $o@@35 (_module.Object.universe this@@46)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@35) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@35) $f@@25)))
 :qid |unknown.0:0|
 :skolemid |1133|
)) (= (_module.Object.baseFieldsInv $h0@@16 this@@46) (_module.Object.baseFieldsInv $h1@@16 this@@46))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1134|
 :pattern ( ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16) (_module.Object.baseFieldsInv $h1@@16 this@@46))
)))
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@47 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@47 null)) (not true)) ($Is refType this@@47 Tclass._module.Thread))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@36 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@36 null)) (not true)) (or (= $o@@36 this@@47) (= $o@@36 (_module.Object.universe this@@47)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@36) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@36) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |1212|
)) (= (_module.Thread.baseFieldsInv $h0@@17 this@@47) (_module.Thread.baseFieldsInv $h1@@17 this@@47))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1213|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.Thread.baseFieldsInv $h1@@17 this@@47))
)))
(assert (forall (($h0@@18 T@U) ($h1@@18 T@U) (this@@48 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@48 null)) (not true)) ($Is refType this@@48 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@37 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@37 null)) (not true)) (or (= $o@@37 this@@48) (= $o@@37 (_module.Object.universe this@@48)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@37) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@37) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |1504|
)) (= (_module.OwnedObject.baseFieldsInv $h0@@18 this@@48) (_module.OwnedObject.baseFieldsInv $h1@@18 this@@48))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1505|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.OwnedObject.baseFieldsInv $h1@@18 this@@48))
)))
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@49 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@49 null)) (not true)) ($Is refType this@@49 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@38 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@38 null)) (not true)) (or (= $o@@38 this@@49) (= $o@@38 (_module.Object.universe this@@49)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@38) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@38) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |1602|
)) (= (_module.OwnedObject.baseUserFieldsInv $h0@@19 this@@49) (_module.OwnedObject.baseUserFieldsInv $h1@@19 this@@49))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1603|
 :pattern ( ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19) (_module.OwnedObject.baseUserFieldsInv $h1@@19 this@@49))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@33 T@U) ($Heap@@29 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@33 $Heap@@29 this@@50) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@33) ($IsGoodHeap $Heap@@29)) ($HeapSucc $prevHeap@@33 $Heap@@29)) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.OwnedObject) ($IsAlloc refType this@@50 Tclass._module.OwnedObject $prevHeap@@33)))))) (and (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@50) _module.OwnedObject.nonvolatileVersion)))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@50) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@33 $Heap@@29 this@@50))) (=> (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@50) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@33 $Heap@@29 this@@50))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.owner))))
(|_module.OwnedObject.volatileOwns#canCall| |oldOwner#0|)))))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@33 $Heap@@29 this@@50)  (and (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@50) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@50) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@33 $Heap@@29 this@@50)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#0@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@50) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@50) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_11MutexGuard2legacydfy.349:22|
 :skolemid |1564|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@33 $Heap@@29 this@@50) ($IsGoodHeap $Heap@@29))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@30 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@30 this@@51) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@30) (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.Object) ($IsAlloc refType this@@51 Tclass._module.Object $Heap@@30)))))) (_module.Object.triggerAxioms $Heap@@30 this@@51))
 :qid |_11MutexGuard2legacydfy.210:19|
 :skolemid |1089|
 :pattern ( (_module.Object.triggerAxioms $Heap@@30 this@@51))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@31 T@U) (this@@52 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@31 this@@52) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@31) (and (or (not (= this@@52 null)) (not true)) (and ($Is refType this@@52 Tclass._module.Thread) ($IsAlloc refType this@@52 Tclass._module.Thread $Heap@@31)))))) (=> (_module.Thread.localInv $Heap@@31 this@@52) (_module.Object.objectGlobalBaseInv $Heap@@31 this@@52)))
 :qid |_11MutexGuard2legacydfy.265:19|
 :skolemid |1228|
 :pattern ( (_module.Thread.localInv $Heap@@31 this@@52))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@32 T@U) (this@@53 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@32 this@@53) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@32) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.OwnedObject) ($IsAlloc refType this@@53 Tclass._module.OwnedObject $Heap@@32)))))) (=> (_module.OwnedObject.localInv $Heap@@32 this@@53) (_module.Object.objectGlobalBaseInv $Heap@@32 this@@53)))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1528|
 :pattern ( (_module.OwnedObject.localInv $Heap@@32 this@@53))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@33 T@U) (this@@54 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@33 this@@54) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@33) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.Object) ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@33)))))) (=> (_module.Object.localInv $Heap@@33 this@@54) (_module.Object.objectGlobalBaseInv $Heap@@33 this@@54)))
 :qid |_11MutexGuard2legacydfy.247:19|
 :skolemid |1141|
 :pattern ( (_module.Object.localInv $Heap@@33 this@@54))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@55 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@34 this@@55) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@55 null)) (not true)) (and ($Is refType this@@55 Tclass._module.Thread) ($IsAlloc refType this@@55 Tclass._module.Thread $Heap@@34)))))) (=> (_module.Thread.inv $Heap@@34 this@@55) (_module.Thread.localInv $Heap@@34 this@@55)))
 :qid |_11MutexGuard2legacydfy.268:19|
 :skolemid |1240|
 :pattern ( (_module.Thread.inv $Heap@@34 this@@55))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@35 T@U) (this@@56 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@35 this@@56) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@35) (and (or (not (= this@@56 null)) (not true)) (and ($Is refType this@@56 Tclass._module.OwnedObject) ($IsAlloc refType this@@56 Tclass._module.OwnedObject $Heap@@35)))))) (=> (_module.OwnedObject.userInv $Heap@@35 this@@56) (_module.OwnedObject.localUserInv $Heap@@35 this@@56)))
 :qid |_11MutexGuard2legacydfy.409:19|
 :skolemid |1622|
 :pattern ( (_module.OwnedObject.userInv $Heap@@35 this@@56))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@36 T@U) (this@@57 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@36 this@@57) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@36) (and (or (not (= this@@57 null)) (not true)) (and ($Is refType this@@57 Tclass._module.OwnedObject) ($IsAlloc refType this@@57 Tclass._module.OwnedObject $Heap@@36)))))) (=> (_module.OwnedObject.inv $Heap@@36 this@@57) (_module.OwnedObject.localInv $Heap@@36 this@@57)))
 :qid |_11MutexGuard2legacydfy.340:19|
 :skolemid |1541|
 :pattern ( (_module.OwnedObject.inv $Heap@@36 this@@57))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@37 T@U) (this@@58 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@37 this@@58) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@37) (and (or (not (= this@@58 null)) (not true)) (and ($Is refType this@@58 Tclass._module.Object) ($IsAlloc refType this@@58 Tclass._module.Object $Heap@@37)))))) (=> (_module.Object.inv $Heap@@37 this@@58) (_module.Object.localInv $Heap@@37 this@@58)))
 :qid |_11MutexGuard2legacydfy.249:19|
 :skolemid |1151|
 :pattern ( (_module.Object.inv $Heap@@37 this@@58))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@34 T@U) ($Heap@@38 T@U) (this@@59 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@34 $Heap@@38 this@@59) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@34) ($IsGoodHeap $Heap@@38)) ($HeapSucc $prevHeap@@34 $Heap@@38)) (and (or (not (= this@@59 null)) (not true)) (and ($Is refType this@@59 Tclass._module.OwnedObject) ($IsAlloc refType this@@59 Tclass._module.OwnedObject $prevHeap@@34)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@34 this@@59) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@38 this@@59) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@34 $Heap@@38 this@@59)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@34 $Heap@@38 this@@59)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@34 this@@59) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@38 this@@59) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@34 $Heap@@38 this@@59)))))
 :qid |_11MutexGuard2legacydfy.331:22|
 :skolemid |1524|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@34 $Heap@@38 this@@59) ($IsGoodHeap $Heap@@38))
))))
...
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@60 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@60 null)) (not true)) ($Is refType this@@60 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@40 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@40 null)) (not true)) (= $o@@40 this@@60)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@40) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@40) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |1087|
)) (= (_module.Object.triggerAxioms $h0@@20 this@@60) (_module.Object.triggerAxioms $h1@@20 this@@60))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1088|
 :pattern ( ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20) (_module.Object.triggerAxioms $h1@@20 this@@60))
)))
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@61 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@61 null)) (not true)) ($Is refType this@@61 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@41 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@41 null)) (not true)) (or (= $o@@41 this@@61) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 this@@61) _module.Universe.content)) ($Box refType $o@@41)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@41) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@41) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |625|
)) (= (_module.Universe.globalBaseInv $h0@@21 this@@61) (_module.Universe.globalBaseInv $h1@@21 this@@61))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |626|
 :pattern ( ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21) (_module.Universe.globalBaseInv $h1@@21 this@@61))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@42 T@U) ($f@@31 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#22| |l#0| |l#1| |l#2| |l#3|) $o@@42 $f@@31))  (=> (and (or (not (= $o@@42 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@42) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2457|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#22| |l#0| |l#1| |l#2| |l#3|) $o@@42 $f@@31))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#22| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@77) Tclass._module.Universe? current$Heap) ($IsAlloc refType |running#0@@3| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@77 Tclass._module.Universe $Heap@@44)) (=> ($IsAlloc refType this@@77 Tclass._module.Universe $Heap@@44) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@44)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@44) (=> (|_module.Universe.legalTransition#canCall| $Heap@@44 current$Heap this@@77 |running#0@@3|) (=> (and (_module.Universe.legalTransition $Heap@@44 current$Heap this@@77 |running#0@@3|) ($IsAllocBox ($Box refType this@@77) Tclass._module.Universe? current$Heap)) (=> (and (and (|_module.Universe.globalInv#canCall| current$Heap this@@77) (_module.Universe.globalInv current$Heap this@@77)) (and ($IsAllocBox ($Box refType this@@77) Tclass._module.Universe? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@77 Tclass._module.Universe $Heap@@44))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@44) ($IsHeapAnchor $Heap@@44)) (and (or (not (= this@@77 null)) (not true)) (and ($Is refType this@@77 Tclass._module.Universe) ($IsAlloc refType this@@77 Tclass._module.Universe previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap)) (= 18 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@44) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
