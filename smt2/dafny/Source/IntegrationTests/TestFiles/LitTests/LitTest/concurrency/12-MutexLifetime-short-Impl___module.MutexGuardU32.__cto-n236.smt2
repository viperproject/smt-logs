...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split5)
...
))))) (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0|)) ($Box refType |running#0|)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content))) (= (ControlFlow 0 2) (- 0 1))))))) (|Set#Subset| |mightPointTo##0@0| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
