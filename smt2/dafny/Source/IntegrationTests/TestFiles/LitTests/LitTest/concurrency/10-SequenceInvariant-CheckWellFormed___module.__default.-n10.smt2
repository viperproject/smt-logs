...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@14 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Universe) ($IsAlloc refType this@@14 Tclass._module.Universe $h0)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))) (= (_module.Universe.baseLegalTransitionsSequence $prevHeap@@0 $h0 this@@14) (_module.Universe.baseLegalTransitionsSequence $prevHeap@@0 $h1 this@@14))))
...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@24 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@17 T@U) ($f@@1 T@U) )  (=> (and (or (not (= $o@@17 null)) (not true)) (or (= $o@@17 this@@24) (= $o@@17 (_module.Object.universe this@@24)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@17) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@17) $f@@1)))) (= (_module.Object.baseFieldsInv $h0@@0 this@@24) (_module.Object.baseFieldsInv $h1@@0 this@@24))))
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.Object.baseFieldsInv $h1@@0 this@@24))
)))
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (this@@25 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.Thread))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@18 T@U) ($f@@2 T@U) )  (=> (and (or (not (= $o@@18 null)) (not true)) (or (= $o@@18 this@@25) (= $o@@18 (_module.Object.universe this@@25)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@18) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@18) $f@@2)))) (= (_module.Thread.baseFieldsInv $h0@@1 this@@25) (_module.Thread.baseFieldsInv $h1@@1 this@@25))))
 :pattern ( ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1) (_module.Thread.baseFieldsInv $h1@@1 this@@25))
)))
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@26 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@26 null)) (not true)) ($Is refType this@@26 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@19 T@U) ($f@@3 T@U) )  (=> (and (or (not (= $o@@19 null)) (not true)) (or (= $o@@19 this@@26) (= $o@@19 (_module.Object.universe this@@26)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@19) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@19) $f@@3)))) (= (_module.OwnedObject.baseFieldsInv $h0@@2 this@@26) (_module.OwnedObject.baseFieldsInv $h1@@2 this@@26))))
 :pattern ( ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2) (_module.OwnedObject.baseFieldsInv $h1@@2 this@@26))
)))
(assert (forall (($h0@@3 T@U) ($h1@@3 T@U) (this@@27 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@27 null)) (not true)) ($Is refType this@@27 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@20 T@U) ($f@@4 T@U) )  (=> (and (or (not (= $o@@20 null)) (not true)) (or (= $o@@20 this@@27) (= $o@@20 (_module.Object.universe this@@27)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@20) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@20) $f@@4)))) (= (_module.OwnedObject.baseUserFieldsInv $h0@@3 this@@27) (_module.OwnedObject.baseUserFieldsInv $h1@@3 this@@27))))
 :pattern ( ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3) (_module.OwnedObject.baseUserFieldsInv $h1@@3 this@@27))
)))
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@28 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@28 null)) (not true)) ($Is refType this@@28 Tclass._module.IncreasingCounter))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@21 T@U) ($f@@5 T@U) )  (=> (and (or (not (= $o@@21 null)) (not true)) (or (= $o@@21 this@@28) (= $o@@21 (_module.Object.universe this@@28)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@21) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@21) $f@@5)))) (= (_module.IncreasingCounter.baseUserFieldsInv $h0@@4 this@@28) (_module.IncreasingCounter.baseUserFieldsInv $h1@@4 this@@28))))
 :pattern ( ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4) (_module.IncreasingCounter.baseUserFieldsInv $h1@@4 this@@28))
)))
(assert (forall (($h0@@5 T@U) ($h1@@5 T@U) (this@@29 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@29 null)) (not true)) ($Is refType this@@29 Tclass._module.Integer))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@22 T@U) ($f@@6 T@U) )  (=> (and (or (not (= $o@@22 null)) (not true)) (or (= $o@@22 this@@29) (= $o@@22 (_module.Object.universe this@@29)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@22) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@22) $f@@6)))) (= (_module.Integer.baseUserFieldsInv $h0@@5 this@@29) (_module.Integer.baseUserFieldsInv $h1@@5 this@@29))))
...
(assert (forall (($h0@@6 T@U) ($h1@@6 T@U) (this@@40 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@23 T@U) ($f@@7 T@U) )  (=> (and (or (not (= $o@@23 null)) (not true)) (= $o@@23 this@@40)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@23) $f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@23) $f@@7)))) (= (_module.Object.triggerAxioms $h0@@6 this@@40) (_module.Object.triggerAxioms $h1@@6 this@@40))))
...
(assert (forall (($h0@@7 T@U) ($h1@@7 T@U) (this@@41 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@41 null)) (not true)) ($Is refType this@@41 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@25 T@U) ($f@@8 T@U) )  (=> (and (or (not (= $o@@25 null)) (not true)) (or (= $o@@25 this@@41) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 this@@41) _module.Universe.content)) ($Box refType $o@@25)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@25) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@25) $f@@8)))) (= (_module.Universe.globalBaseInv $h0@@7 this@@41) (_module.Universe.globalBaseInv $h1@@7 this@@41))))
