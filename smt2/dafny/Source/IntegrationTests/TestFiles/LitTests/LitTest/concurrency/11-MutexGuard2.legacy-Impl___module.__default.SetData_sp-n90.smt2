...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split74)
...
))) (and ($HeapSucc $Heap@5 $Heap@6) (= |a#0@0| |b#0@0|))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@6)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@6) (= (ControlFlow 0 2) (- 0 1)))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@6))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
