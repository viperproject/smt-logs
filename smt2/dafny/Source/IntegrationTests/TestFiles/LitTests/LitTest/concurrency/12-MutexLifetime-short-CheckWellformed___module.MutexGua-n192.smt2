...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.OwnedU32.objectUserFields#canCall| $Heap@@16 this@@22) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.OwnedU32)))) (= (_module.OwnedObject.objectUserFields $Heap@@16 this@@22) (_module.OwnedU32.objectUserFields $Heap@@16 this@@22)))
 :qid |_12MutexLifetimeshortdfy.518:18|
 :skolemid |2376|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@16 this@@22) ($Is refType this@@22 Tclass._module.OwnedU32) ($IsGoodHeap $Heap@@16))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@16 this@@22) (_module.OwnedU32.objectUserFields $Heap@@16 this@@22) ($IsGoodHeap $Heap@@16))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@17 this@@23) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.Mutex)))) (= (_module.OwnedObject.objectUserFields $Heap@@17 this@@23) (_module.Mutex.objectUserFields $Heap@@17 this@@23)))
 :qid |_12MutexLifetimeshortdfy.518:18|
 :skolemid |2925|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@17 this@@23) ($Is refType this@@23 Tclass._module.Mutex) ($IsGoodHeap $Heap@@17))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@17 this@@23) (_module.Mutex.objectUserFields $Heap@@17 this@@23) ($IsGoodHeap $Heap@@17))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@24 T@U) ) (!  (=> (or (|_module.MutexGuardU32.objectUserFields#canCall| $Heap@@18 this@@24) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.objectUserFields $Heap@@18 this@@24) (_module.MutexGuardU32.objectUserFields $Heap@@18 this@@24)))
 :qid |_12MutexLifetimeshortdfy.518:18|
 :skolemid |3217|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@18 this@@24) ($Is refType this@@24 Tclass._module.MutexGuardU32) ($IsGoodHeap $Heap@@18))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@18 this@@24) (_module.MutexGuardU32.objectUserFields $Heap@@18 this@@24) ($IsGoodHeap $Heap@@18))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) ($Heap@@19 T@U) (this@@25 T@U) (|a#0@@6| T@U) (|x#0@@5| T@U) (|b#0@@6| T@U) ) (!  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.Universe))) ($Is refType |a#0@@6| Tclass._module.Lifetime)) ($Is refType |x#0@@5| Tclass._module.Lifetime)) ($Is refType |b#0@@6| Tclass._module.Lifetime)) (exists ((|_k#0@@3| Int) ) (!  (and (<= (LitInt 0) |_k#0@@3|) (_module.Universe.outlivesThrough_h ($LS $ly@@6) $Heap@@19 this@@25 |_k#0@@3| |a#0@@6| |x#0@@5| |b#0@@6|))
 :qid |_12MutexLifetimeshortdfy.165:19|
 :skolemid |1246|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $ly@@6) $Heap@@19 this@@25 |_k#0@@3| |a#0@@6| |x#0@@5| |b#0@@6|))
))) (_module.Universe.outlivesThrough ($LS $ly@@6) $Heap@@19 this@@25 |a#0@@6| |x#0@@5| |b#0@@6|))
 :qid |_12MutexLifetimeshortdfy.165:19|
 :skolemid |1248|
 :pattern ( (_module.Universe.outlivesThrough ($LS $ly@@6) $Heap@@19 this@@25 |a#0@@6| |x#0@@5| |b#0@@6|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@26 T@U) ) (!  (=> (or (|_module.OwnedU32.localUserInv#canCall| $Heap@@20 this@@26) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.OwnedU32) ($IsAlloc refType this@@26 Tclass._module.OwnedU32 $Heap@@20)))))) (= (_module.OwnedU32.localUserInv $Heap@@20 this@@26) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimeshortdfy.644:19|
 :skolemid |2389|
 :pattern ( (_module.OwnedU32.localUserInv $Heap@@20 this@@26) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@21 this@@27) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Thread) ($IsAlloc refType this@@27 Tclass._module.Thread $Heap@@21)))))) (= (_module.Thread.baseFieldsInv $Heap@@21 this@@27) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimeshortdfy.363:19|
 :skolemid |1506|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@21 this@@27) ($IsGoodHeap $Heap@@21))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@7 T@U) ($Heap@@22 T@U) (this@@28 T@U) (|a#0@@7| T@U) (|b#0@@7| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@28 null)) (not true)) ($Is refType this@@28 Tclass._module.Universe))) ($Is refType |a#0@@7| Tclass._module.Lifetime)) ($Is refType |b#0@@7| Tclass._module.Lifetime)) (exists ((|_k#0@@4| Int) ) (!  (and (<= (LitInt 0) |_k#0@@4|) (_module.Universe.outlives_h ($LS $ly@@7) $Heap@@22 this@@28 |_k#0@@4| |a#0@@7| |b#0@@7|))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1222|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@7) $Heap@@22 this@@28 |_k#0@@4| |a#0@@7| |b#0@@7|))
))) (_module.Universe.outlives ($LS $ly@@7) $Heap@@22 this@@28 |a#0@@7| |b#0@@7|))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1224|
 :pattern ( (_module.Universe.outlives ($LS $ly@@7) $Heap@@22 this@@28 |a#0@@7| |b#0@@7|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@23 this@@29) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Object) ($IsAlloc refType this@@29 Tclass._module.Object $Heap@@23)))))) (and (|_module.Object.nonAliasing#canCall| $Heap@@23 this@@29) (= (_module.Object.triggerAxioms $Heap@@23 this@@29) (_module.Object.nonAliasing $Heap@@23 this@@29))))
 :qid |_12MutexLifetimeshortdfy.314:19|
 :skolemid |1376|
 :pattern ( (_module.Object.triggerAxioms $Heap@@23 this@@29) ($IsGoodHeap $Heap@@23))
))))
...
(assert (forall (($ly@@8 T@U) ($Heap@@24 T@U) (this@@30 T@U) (|_k#0@@5| Int) (|a#0@@8| T@U) (|x#0@@6| T@U) (|b#0@@8| T@U) ) (! (= (_module.Universe.outlivesThrough_h ($LS $ly@@8) $Heap@@24 this@@30 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|) (_module.Universe.outlivesThrough_h $ly@@8 $Heap@@24 this@@30 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|))
 :qid |_12MutexLifetimeshortdfy.165:19|
 :skolemid |1252|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $ly@@8) $Heap@@24 this@@30 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@18 T@U) ($f@@5 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#59| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@18 $f@@5))  (=> (and (or (not (= $o@@18 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@18) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@18) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3521|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#59| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@18 $f@@5))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@5 T@U) ($Heap@@25 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.Mutex.localUserInv2#canCall| $prevHeap@@5 $Heap@@25 this@@31) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@5) ($IsGoodHeap $Heap@@25)) ($HeapSucc $prevHeap@@5 $Heap@@25)) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Mutex) ($IsAlloc refType this@@31 Tclass._module.Mutex $prevHeap@@5)))))) (= (_module.Mutex.localUserInv2 $prevHeap@@5 $Heap@@25 this@@31)  (and true (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@5 this@@31) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@31) _module.Mutex.data))))))
 :qid |_12MutexLifetimeshortdfy.789:22|
 :skolemid |2959|
 :pattern ( (_module.Mutex.localUserInv2 $prevHeap@@5 $Heap@@25 this@@31) ($IsGoodHeap $Heap@@25))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@6 T@U) ($Heap@@26 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv2#canCall| $prevHeap@@6 $Heap@@26 this@@32) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@6) ($IsGoodHeap $Heap@@26)) ($HeapSucc $prevHeap@@6 $Heap@@26)) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@32 Tclass._module.MutexGuardU32 $prevHeap@@6)))))) (= (_module.MutexGuardU32.localUserInv2 $prevHeap@@6 $Heap@@26 this@@32)  (and true (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@6 this@@32) _module.MutexGuardU32.mutex)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@32) _module.MutexGuardU32.mutex))))))
 :qid |_12MutexLifetimeshortdfy.873:22|
 :skolemid |3251|
 :pattern ( (_module.MutexGuardU32.localUserInv2 $prevHeap@@6 $Heap@@26 this@@32) ($IsGoodHeap $Heap@@26))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@27 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@27 this@@33) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@27) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.OwnedObject) ($IsAlloc refType this@@33 Tclass._module.OwnedObject $Heap@@27)))))) (and (|_module.OwnedObject.objectUserFields#canCall| $Heap@@27 this@@33) (= (_module.OwnedObject.objectFields $Heap@@27 this@@33) (|Set#Union| (|Set#Union| (_module.OwnedObject.objectUserFields $Heap@@27 this@@33) (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@33)))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 this@@33) _module.OwnedObject.owner)) null) |Set#Empty| (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 this@@33) _module.OwnedObject.owner)))))))
 :qid |_12MutexLifetimeshortdfy.426:18|
 :skolemid |1774|
 :pattern ( (_module.OwnedObject.objectFields $Heap@@27 this@@33) ($IsGoodHeap $Heap@@27))
))))
...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($prevHeap@@7 T@U) ($Heap@@28 T@U) (this@@34 T@U) ) (!  (=> (or (|_module.MutexGuardU32.userInv2#canCall| $prevHeap@@7 $Heap@@28 this@@34) (and (< 12 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@7) ($IsGoodHeap $Heap@@28)) ($HeapSucc $prevHeap@@7 $Heap@@28)) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@34 Tclass._module.MutexGuardU32 $prevHeap@@7)))))) (and (and (|_module.MutexGuardU32.localUserInv2#canCall| $prevHeap@@7 $Heap@@28 this@@34) (=> (_module.MutexGuardU32.localUserInv2 $prevHeap@@7 $Heap@@28 this@@34) (and (|_module.OwnedObject.localInv2#canCall| $prevHeap@@7 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@34) _module.MutexGuardU32.mutex))) (=> (_module.OwnedObject.localInv2 $prevHeap@@7 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@34) _module.MutexGuardU32.mutex))) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@34) _module.OwnedObject.owner)) null) (|_module.OwnedObject.localInv#canCall| $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@34) _module.MutexGuardU32.mutex)))))))) (= (_module.MutexGuardU32.userInv2 $prevHeap@@7 $Heap@@28 this@@34)  (and (and (_module.MutexGuardU32.localUserInv2 $prevHeap@@7 $Heap@@28 this@@34) (_module.OwnedObject.localInv2 $prevHeap@@7 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@34) _module.MutexGuardU32.mutex)))) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@34) _module.OwnedObject.owner)) null) (_module.OwnedObject.localInv $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@34) _module.MutexGuardU32.mutex))))))))
 :qid |_12MutexLifetimeshortdfy.876:22|
 :skolemid |3258|
 :pattern ( (_module.MutexGuardU32.userInv2 $prevHeap@@7 $Heap@@28 this@@34) ($IsGoodHeap $Heap@@28))
))))
(assert (forall (($ly@@9 T@U) ($h0@@5 T@U) ($h1@@5 T@U) (this@@35 T@U) (|_k#0@@6| Int) (|a#0@@9| T@U) (|b#0@@9| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.Universe))) (or (|_module.Universe.outlives_h#canCall| $h0@@5 this@@35 |_k#0@@6| |a#0@@9| |b#0@@9|) (and (and (<= (LitInt 0) |_k#0@@6|) ($Is refType |a#0@@9| Tclass._module.Lifetime)) ($Is refType |b#0@@9| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@24 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (or (or (= $o@@24 this@@35) (and (and ($Is refType $o@@24 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 this@@35) _module.Universe.content)) ($Box refType $o@@24))) (= $f@@6 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@24 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 this@@35) _module.Universe.content)) ($Box refType $o@@24))) (= $f@@6 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@24) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@24) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |1232|
)) (= (_module.Universe.outlives_h $ly@@9 $h0@@5 this@@35 |_k#0@@6| |a#0@@9| |b#0@@9|) (_module.Universe.outlives_h $ly@@9 $h1@@5 this@@35 |_k#0@@6| |a#0@@9| |b#0@@9|))))
 :qid |unknown.0:0|
 :skolemid |1233|
 :pattern ( ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5) (_module.Universe.outlives_h $ly@@9 $h1@@5 this@@35 |_k#0@@6| |a#0@@9| |b#0@@9|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@10 T@U) ($Heap@@29 T@U) (this@@36 T@U) (|_k#0@@7| Int) (|a#0@@10| T@U) (|b#0@@10| T@U) ) (!  (=> (or (|_module.Universe.outlives_h#canCall| $Heap@@29 this@@36 |_k#0@@7| |a#0@@10| |b#0@@10|) (and (< 2 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Universe) ($IsAlloc refType this@@36 Tclass._module.Universe $Heap@@29)))) (<= (LitInt 0) |_k#0@@7|)) ($Is refType |a#0@@10| Tclass._module.Lifetime)) ($Is refType |b#0@@10| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@36) _module.Universe.content)) ($Box refType |a#0@@10|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@36) _module.Universe.content)) ($Box refType |b#0@@10|)))))) (and (=> (< 0 |_k#0@@7|) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 |b#0@@10|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@10|))) (forall ((|x#3| T@U) ) (!  (=> ($Is refType |x#3| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@36) _module.Universe.content)) ($Box refType |x#3|)) (|_module.Universe.outlivesThrough_h#canCall| $Heap@@29 this@@36 (- |_k#0@@7| 1) |a#0@@10| |x#3| |b#0@@10|)))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |1237|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@29 this@@36 (- |_k#0@@7| 1) |a#0@@10| |x#3| |b#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@36) _module.Universe.content)) ($Box refType |x#3|)))
)))) (= (_module.Universe.outlives_h ($LS $ly@@10) $Heap@@29 this@@36 |_k#0@@7| |a#0@@10| |b#0@@10|)  (and (< 0 |_k#0@@7|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 |b#0@@10|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@10|)) (exists ((|x#3@@0| T@U) ) (!  (and (and ($Is refType |x#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@36) _module.Universe.content)) ($Box refType |x#3@@0|))) (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@29 this@@36 (- |_k#0@@7| 1) |a#0@@10| |x#3@@0| |b#0@@10|))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |1236|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@29 this@@36 (- |_k#0@@7| 1) |a#0@@10| |x#3@@0| |b#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@36) _module.Universe.content)) ($Box refType |x#3@@0|)))
)))))))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1238|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@10) $Heap@@29 this@@36 |_k#0@@7| |a#0@@10| |b#0@@10|) ($IsGoodHeap $Heap@@29))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@30 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@30 this@@37) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@30) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@37 Tclass._module.MutexGuardU32 $Heap@@30)))))) (and (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@37))) ($Box refType (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@37)) _module.Universe.content))) (|_module.Universe.outlives#canCall| $Heap@@30 (_module.Object.universe this@@37) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))) (_module.OwnedObject.lifetime this@@37))) (= (_module.MutexGuardU32.localUserInv $Heap@@30 this@@37)  (and (and (and (and (and (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@37))) ($Box refType (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@37)) _module.Universe.content))) (_module.Universe.outlives ($LS $LZ) $Heap@@30 (_module.Object.universe this@@37) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))) (_module.OwnedObject.lifetime this@@37))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))) _module.OwnedObject.owner)) null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))) _module.Mutex.locked)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@37)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@@37)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.mutex))) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@37) _module.MutexGuardU32.data)))))))
 :qid |_12MutexLifetimeshortdfy.857:19|
 :skolemid |3230|
 :pattern ( (_module.MutexGuardU32.localUserInv $Heap@@30 this@@37) ($IsGoodHeap $Heap@@30))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@31 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@31 this@@38) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@31) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.Mutex) ($IsAlloc refType this@@38 Tclass._module.Mutex $Heap@@31)))))) (= (_module.Mutex.objectUserFields $Heap@@31 this@@38) (let ((|r#0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@38) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@38) _module.Mutex.data)))))
|r#0|)))
 :qid |_12MutexLifetimeshortdfy.763:18|
 :skolemid |2924|
 :pattern ( (_module.Mutex.objectUserFields $Heap@@31 this@@38) ($IsGoodHeap $Heap@@31))
))))
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@54 T@U) (this@@70 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@54 this@@70) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@54) (and (or (not (= this@@70 null)) (not true)) (and ($Is refType this@@70 Tclass._module.OwnedObject) ($IsAlloc refType this@@70 Tclass._module.OwnedObject $Heap@@54)))))) (=> (_module.OwnedObject.localInv $Heap@@54 this@@70) (_module.Object.objectGlobalBaseInv $Heap@@54 this@@70)))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localInv $Heap@@54 this@@70))
))))
...
(assert (forall (($ly@@14 T@U) ($h0@@12 T@U) ($h1@@12 T@U) (this@@71 T@U) (|_k#0@@9| Int) (|a#0@@14| T@U) (|x#0@@9| T@U) (|b#0@@14| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@71 null)) (not true)) ($Is refType this@@71 Tclass._module.Universe))) (or (|_module.Universe.outlivesThrough_h#canCall| $h0@@12 this@@71 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (and (and (and (<= (LitInt 0) |_k#0@@9|) ($Is refType |a#0@@14| Tclass._module.Lifetime)) ($Is refType |x#0@@9| Tclass._module.Lifetime)) ($Is refType |b#0@@14| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@53 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@53 null)) (not true)) (or (or (= $o@@53 this@@71) (and (and ($Is refType $o@@53 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 this@@71) _module.Universe.content)) ($Box refType $o@@53))) (= $f@@13 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@53 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 this@@71) _module.Universe.content)) ($Box refType $o@@53))) (= $f@@13 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@53) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@53) $f@@13)))
 :qid |unknown.0:0|
 :skolemid |1254|
)) (= (_module.Universe.outlivesThrough_h $ly@@14 $h0@@12 this@@71 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (_module.Universe.outlivesThrough_h $ly@@14 $h1@@12 this@@71 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|))))
 :qid |unknown.0:0|
 :skolemid |1255|
 :pattern ( ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12) (_module.Universe.outlivesThrough_h $ly@@14 $h1@@12 this@@71 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|))
)))
...
(assert (forall (($ly@@15 T@U) ($h0@@13 T@U) ($h1@@13 T@U) (this@@72 T@U) (|a#0@@15| T@U) (|b#0@@15| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@13) ($IsGoodHeap $h1@@13)) (and (or (not (= this@@72 null)) (not true)) ($Is refType this@@72 Tclass._module.Universe))) (or (|_module.Universe.outlives#canCall| $h0@@13 this@@72 |a#0@@15| |b#0@@15|) (and ($Is refType |a#0@@15| Tclass._module.Lifetime) ($Is refType |b#0@@15| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13))) (=> (forall (($o@@54 T@U) ($f@@14 T@U) ) (!  (=> (and (or (not (= $o@@54 null)) (not true)) (or (or (= $o@@54 this@@72) (and (and ($Is refType $o@@54 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 this@@72) _module.Universe.content)) ($Box refType $o@@54))) (= $f@@14 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@54 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 this@@72) _module.Universe.content)) ($Box refType $o@@54))) (= $f@@14 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@54) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@13 $o@@54) $f@@14)))
 :qid |unknown.0:0|
 :skolemid |1215|
)) (= (_module.Universe.outlives $ly@@15 $h0@@13 this@@72 |a#0@@15| |b#0@@15|) (_module.Universe.outlives $ly@@15 $h1@@13 this@@72 |a#0@@15| |b#0@@15|))))
 :qid |unknown.0:0|
 :skolemid |1216|
 :pattern ( ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13) (_module.Universe.outlives $ly@@15 $h1@@13 this@@72 |a#0@@15| |b#0@@15|))
)))
...
(assert (forall (($h0@@14 T@U) ($h1@@14 T@U) (this@@73 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@14) ($IsGoodHeap $h1@@14)) (and (or (not (= this@@73 null)) (not true)) ($Is refType this@@73 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14))) (=> (forall (($o@@55 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@55 null)) (not true)) (= $o@@55 this@@73)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@55) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@14 $o@@55) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |1364|
)) (= (_module.Object.nonAliasing $h0@@14 this@@73) (_module.Object.nonAliasing $h1@@14 this@@73))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1365|
 :pattern ( ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14) (_module.Object.nonAliasing $h1@@14 this@@73))
)))
(assert (forall (($h0@@15 T@U) ($h1@@15 T@U) (this@@74 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@15) ($IsGoodHeap $h1@@15)) (and (or (not (= this@@74 null)) (not true)) ($Is refType this@@74 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15))) (=> (forall (($o@@56 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@56 null)) (not true)) (= $o@@56 this@@74)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@56) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@15 $o@@56) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |1372|
)) (= (_module.Object.triggerAxioms $h0@@15 this@@74) (_module.Object.triggerAxioms $h1@@15 this@@74))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1373|
 :pattern ( ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15) (_module.Object.triggerAxioms $h1@@15 this@@74))
)))
...
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@78 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@78 null)) (not true)) ($Is refType this@@78 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@58 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@58 null)) (not true)) (or (= $o@@58 this@@78) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 this@@78) _module.Universe.content)) ($Box refType $o@@58)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@58) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@58) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |818|
)) (= (_module.Universe.globalBaseInv $h0@@16 this@@78) (_module.Universe.globalBaseInv $h1@@16 this@@78))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |819|
 :pattern ( ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16) (_module.Universe.globalBaseInv $h1@@16 this@@78))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@16 T@U) ($Heap@@55 T@U) (this@@79 T@U) (|a#0@@16| T@U) (|b#0@@16| T@U) (|_k#0@@10| Int) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@55) (and (or (not (= this@@79 null)) (not true)) ($Is refType this@@79 Tclass._module.Universe))) ($Is refType |a#0@@16| Tclass._module.Lifetime)) ($Is refType |b#0@@16| Tclass._module.Lifetime)) (= |_k#0@@10| 0)) (not (_module.Universe.outlives_h $ly@@16 $Heap@@55 this@@79 |_k#0@@10| |a#0@@16| |b#0@@16|)))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1225|
 :pattern ( (_module.Universe.outlives_h $ly@@16 $Heap@@55 this@@79 |_k#0@@10| |a#0@@16| |b#0@@16|))
))))
...
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@80 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@80 null)) (not true)) ($Is refType this@@80 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@59 T@U) ($f@@18 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (= $o@@59 this@@80)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@59) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@59) $f@@18)))
 :qid |unknown.0:0|
 :skolemid |1769|
)) (= (_module.OwnedObject.objectFields $h0@@17 this@@80) (_module.OwnedObject.objectFields $h1@@17 this@@80))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1770|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.OwnedObject.objectFields $h1@@17 this@@80))
)))
(assert (forall (($h0@@18 T@U) ($h1@@18 T@U) (this@@81 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@81 null)) (not true)) ($Is refType this@@81 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@60 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@60 null)) (not true)) (= $o@@60 this@@81)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@60) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@60) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |1874|
)) (= (_module.OwnedObject.objectUserFields $h0@@18 this@@81) (_module.OwnedObject.objectUserFields $h1@@18 this@@81))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1875|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.OwnedObject.objectUserFields $h1@@18 this@@81))
)))
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@82 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@82 null)) (not true)) ($Is refType this@@82 Tclass._module.OwnedU32))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@61 T@U) ($f@@20 T@U) ) (!  (=> (and (or (not (= $o@@61 null)) (not true)) (= $o@@61 this@@82)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@61) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@61) $f@@20)))
 :qid |unknown.0:0|
 :skolemid |2370|
)) (= (_module.OwnedU32.objectUserFields $h0@@19 this@@82) (_module.OwnedU32.objectUserFields $h1@@19 this@@82))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2371|
 :pattern ( ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19) (_module.OwnedU32.objectUserFields $h1@@19 this@@82))
)))
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@83 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@83 null)) (not true)) ($Is refType this@@83 Tclass._module.Mutex))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@62 T@U) ($f@@21 T@U) ) (!  (=> (and (or (not (= $o@@62 null)) (not true)) (= $o@@62 this@@83)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@62) $f@@21) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@62) $f@@21)))
 :qid |unknown.0:0|
 :skolemid |2919|
)) (= (_module.Mutex.objectUserFields $h0@@20 this@@83) (_module.Mutex.objectUserFields $h1@@20 this@@83))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2920|
 :pattern ( ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20) (_module.Mutex.objectUserFields $h1@@20 this@@83))
)))
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@84 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@84 null)) (not true)) ($Is refType this@@84 Tclass._module.MutexGuardU32))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@63 T@U) ($f@@22 T@U) ) (!  (=> (and (or (not (= $o@@63 null)) (not true)) (= $o@@63 this@@84)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@63) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@63) $f@@22)))
 :qid |unknown.0:0|
 :skolemid |3211|
)) (= (_module.MutexGuardU32.objectUserFields $h0@@21 this@@84) (_module.MutexGuardU32.objectUserFields $h1@@21 this@@84))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3212|
 :pattern ( ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21) (_module.MutexGuardU32.objectUserFields $h1@@21 this@@84))
)))
...
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@85 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@85 null)) (not true)) (and ($Is refType this@@85 Tclass._module.Object) ($IsAlloc refType this@@85 Tclass._module.Object $h0@@22)))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@65 T@U) ($f@@23 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@65) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@65) $f@@23)))
 :qid |unknown.0:0|
 :skolemid |1344|
)) (= (_module.Object.objectGlobalBaseInv $h0@@22 this@@85) (_module.Object.objectGlobalBaseInv $h1@@22 this@@85))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1345|
 :pattern ( ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22) (_module.Object.objectGlobalBaseInv $h1@@22 this@@85))
)))
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@86 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@86 null)) (not true)) (and ($Is refType this@@86 Tclass._module.OwnedObject) ($IsAlloc refType this@@86 Tclass._module.OwnedObject $h0@@23)))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@66 T@U) ($f@@24 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@66) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@66) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@66) $f@@24)))
 :qid |unknown.0:0|
 :skolemid |1797|
)) (= (_module.OwnedObject.localInv $h0@@23 this@@86) (_module.OwnedObject.localInv $h1@@23 this@@86))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1798|
 :pattern ( ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23) (_module.OwnedObject.localInv $h1@@23 this@@86))
)))
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@87 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@87 null)) (not true)) (and ($Is refType this@@87 Tclass._module.OwnedObject) ($IsAlloc refType this@@87 Tclass._module.OwnedObject $h0@@24)))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@67 T@U) ($f@@25 T@U) ) (!  (=> (and (or (not (= $o@@67 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@67) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@67) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@67) $f@@25)))
 :qid |unknown.0:0|
 :skolemid |1883|
)) (= (_module.OwnedObject.localUserInv $h0@@24 this@@87) (_module.OwnedObject.localUserInv $h1@@24 this@@87))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1884|
 :pattern ( ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24) (_module.OwnedObject.localUserInv $h1@@24 this@@87))
)))
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@88 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@88 null)) (not true)) (and ($Is refType this@@88 Tclass._module.OwnedU32) ($IsAlloc refType this@@88 Tclass._module.OwnedU32 $h0@@25)))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@68 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@68 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@68) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@68) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@68) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |2385|
)) (= (_module.OwnedU32.localUserInv $h0@@25 this@@88) (_module.OwnedU32.localUserInv $h1@@25 this@@88))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2386|
 :pattern ( ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25) (_module.OwnedU32.localUserInv $h1@@25 this@@88))
)))
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@89 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@89 null)) (not true)) (and ($Is refType this@@89 Tclass._module.Mutex) ($IsAlloc refType this@@89 Tclass._module.Mutex $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@69 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@69 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@69) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@69) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@69) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |2934|
)) (= (_module.Mutex.localUserInv $h0@@26 this@@89) (_module.Mutex.localUserInv $h1@@26 this@@89))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2935|
 :pattern ( ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26) (_module.Mutex.localUserInv $h1@@26 this@@89))
)))
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@90 Tclass._module.MutexGuardU32 $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@70 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@70 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@70) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@70) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@70) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |3226|
)) (= (_module.MutexGuardU32.localUserInv $h0@@27 this@@90) (_module.MutexGuardU32.localUserInv $h1@@27 this@@90))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3227|
 :pattern ( ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27) (_module.MutexGuardU32.localUserInv $h1@@27 this@@90))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@91 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@91) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@91 null)) (not true)) ($Is refType this@@91 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@91) (_module.Thread.objectClassKind this@@91)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1500|
 :pattern ( (_module.Object.objectClassKind this@@91) ($Is refType this@@91 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@91) (_module.Thread.objectClassKind this@@91))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@92 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@92) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@92 null)) (not true)) ($Is refType this@@92 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@92) (_module.OwnedObject.objectClassKind this@@92)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1767|
 :pattern ( (_module.Object.objectClassKind this@@92) ($Is refType this@@92 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@92) (_module.OwnedObject.objectClassKind this@@92))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@93 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@93) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@93 null)) (not true)) ($Is refType this@@93 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@93) (_module.Lifetime.objectClassKind this@@93)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1945|
 :pattern ( (_module.Object.objectClassKind this@@93) ($Is refType this@@93 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@93) (_module.Lifetime.objectClassKind this@@93))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@94 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@94) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@94 null)) (not true)) ($Is refType this@@94 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@94) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :skolemid |1496|
 :pattern ( (_module.Thread.objectClassKind this@@94))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@95 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@95) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@95 null)) (not true)) ($Is refType this@@95 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@95) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :skolemid |1763|
 :pattern ( (_module.OwnedObject.objectClassKind this@@95))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@96 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@96) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@96 null)) (not true)) ($Is refType this@@96 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@96) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :skolemid |1941|
 :pattern ( (_module.Lifetime.objectClassKind this@@96))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@97 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@97) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@97 null)) (not true)) ($Is refType this@@97 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@97) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1418|
 :pattern ( (_module.Object.objectClassKind this@@97))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($prevHeap@@13 T@U) ($Heap@@56 T@U) (this@@98 T@U) ) (!  (=> (or (|_module.MutexGuardU32.userInv2#canCall| $prevHeap@@13 $Heap@@56 this@@98) (and (< 12 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@13) ($IsGoodHeap $Heap@@56)) ($HeapSucc $prevHeap@@13 $Heap@@56)) (and (or (not (= this@@98 null)) (not true)) (and ($Is refType this@@98 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@98 Tclass._module.MutexGuardU32 $prevHeap@@13)))))) (=> (_module.MutexGuardU32.userInv2 $prevHeap@@13 $Heap@@56 this@@98) (_module.MutexGuardU32.localUserInv2 $prevHeap@@13 $Heap@@56 this@@98)))
 :qid |_12MutexLifetimeshortdfy.876:22|
 :skolemid |3256|
 :pattern ( (_module.MutexGuardU32.userInv2 $prevHeap@@13 $Heap@@56 this@@98))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@57 T@U) (this@@99 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@57 this@@99) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@57) (and (or (not (= this@@99 null)) (not true)) (and ($Is refType this@@99 Tclass._module.Lifetime) ($IsAlloc refType this@@99 Tclass._module.Lifetime $Heap@@57)))))) (= (_module.Lifetime.alive $Heap@@57 this@@99)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@57 this@@99) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.551:19|
 :skolemid |1920|
 :pattern ( (_module.Lifetime.alive $Heap@@57 this@@99) ($IsGoodHeap $Heap@@57))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@58 T@U) (this@@100 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@58 this@@100) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@58) (and (or (not (= this@@100 null)) (not true)) (and ($Is refType this@@100 Tclass._module.Lifetime) ($IsAlloc refType this@@100 Tclass._module.Lifetime $Heap@@58)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@58 this@@100)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 this@@100) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 this@@100) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 this@@100) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@100)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 this@@100) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@100)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 this@@100) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@100)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.563:19|
 :skolemid |1951|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@58 this@@100) ($IsGoodHeap $Heap@@58))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (=> (_module.MutexGuardU32.userInv2 previous$Heap current$Heap this@@101) (=> (|_module.MutexGuardU32.localUserInv2#canCall| previous$Heap current$Heap this@@101) (or (_module.MutexGuardU32.localUserInv2 previous$Heap current$Heap this@@101) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.MutexGuardU32.userInv2 previous$Heap current$Heap this@@101) (=> (|_module.MutexGuardU32.localUserInv2#canCall| previous$Heap current$Heap this@@101) (or (_module.MutexGuardU32.localUserInv2 previous$Heap current$Heap this@@101) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 8) (- 0 7)) (=> (_module.MutexGuardU32.userInv2 previous$Heap current$Heap this@@101) (=> (|_module.MutexGuardU32.localUserInv2#canCall| previous$Heap current$Heap this@@101) (or (_module.MutexGuardU32.localUserInv2 previous$Heap current$Heap this@@101) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@101) _module.MutexGuardU32.mutex)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)))))))))))
(let ((anon11_correct  (=> (= (_module.MutexGuardU32.userInv2 $Heap@@59 current$Heap this@@101)  (and (and (_module.MutexGuardU32.localUserInv2 $Heap@@59 current$Heap this@@101) (_module.OwnedObject.localInv2 $Heap@@59 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)))) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.OwnedObject.owner)) null) (_module.OwnedObject.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)))))) (=> (and (and (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@59 current$Heap this@@101) (=> (_module.MutexGuardU32.localUserInv2 $Heap@@59 current$Heap this@@101) (and (|_module.OwnedObject.localInv2#canCall| $Heap@@59 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex))) (=> (_module.OwnedObject.localInv2 $Heap@@59 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex))) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.OwnedObject.owner)) null) (|_module.OwnedObject.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)))))))) ($Is boolType (bool_2_U (_module.MutexGuardU32.userInv2 $Heap@@59 current$Heap this@@101)) TBool)) (and (=> (= (ControlFlow 0 10) (- 0 16)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 10) (- 0 15)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 10) (- 0 14)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (and (=> (= (ControlFlow 0 10) (- 0 13)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (and (=> (= (ControlFlow 0 10) (- 0 12)) |b$reqreads#4@1|) (=> |b$reqreads#4@1| (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#5@1|) (=> |b$reqreads#5@1| (=> (= (ControlFlow 0 10) 8) GeneratedUnifiedExit_correct)))))))))))))))))
(let ((anon17_Else_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.OwnedObject.owner)) null)) (not true)) (=> (and (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= |b$reqreads#4@1| true)) (and (= |b$reqreads#5@1| true) (= (ControlFlow 0 20) 10))) anon11_correct))))
(let ((anon17_Then_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.OwnedObject.owner)) null) (= |b$reqreads#4@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@101 _module.MutexGuardU32.mutex)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)) null)) (not true)) (=> ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex) Tclass._module.OwnedObject? current$Heap) (=> (and (= |b$reqreads#5@0| (forall (($o@@83 T@U) ($f@@29 T@U) ) (!  (=> (and (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@83) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@83) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@83 $f@@29)))
 :qid |_12MutexLifetimeshortdfy.880:33|
 :skolemid |3262|
))) (|_module.OwnedObject.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)))) (=> (and (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= |b$reqreads#4@1| |b$reqreads#4@0|)) (and (= |b$reqreads#5@1| |b$reqreads#5@0|) (= (ControlFlow 0 18) 10))) anon11_correct))))))))
(let ((anon16_Then_correct  (=> (and (and (_module.MutexGuardU32.localUserInv2 $Heap@@59 current$Heap this@@101) (_module.OwnedObject.localInv2 $Heap@@59 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)))) (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@101 _module.OwnedObject.owner)))) (and (=> (= (ControlFlow 0 21) 18) anon17_Then_correct) (=> (= (ControlFlow 0 21) 20) anon17_Else_correct)))))
...
(let ((anon15_Else_correct  (=> (not (_module.MutexGuardU32.localUserInv2 $Heap@@59 current$Heap this@@101)) (=> (and (= |b$reqreads#1@1| true) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 25) 21) anon16_Then_correct) (=> (= (ControlFlow 0 25) 17) anon16_Else_correct))))))
(let ((anon15_Then_correct  (=> (and (_module.MutexGuardU32.localUserInv2 $Heap@@59 current$Heap this@@101) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@101 _module.MutexGuardU32.mutex)))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)) null)) (not true)) (=> ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex) Tclass._module.OwnedObject? current$Heap) (and (=> (= (ControlFlow 0 22) (- 0 23)) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)) Tclass._module.Mutex $Heap@@59)) (=> ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)) Tclass._module.Mutex $Heap@@59) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@84 T@U) ($f@@30 T@U) ) (!  (=> (and (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@84) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@84) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@84 $f@@30)))
 :qid |_12MutexLifetimeshortdfy.878:14|
 :skolemid |3261|
))) (|_module.OwnedObject.localInv2#canCall| $Heap@@59 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@101) _module.MutexGuardU32.mutex)))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@1| |b$reqreads#2@0|))) (and (=> (= (ControlFlow 0 22) 21) anon16_Then_correct) (=> (= (ControlFlow 0 22) 17) anon16_Else_correct)))))))))))
(let ((anon13_Else_correct  (=> ($IsAllocBox ($Box refType this@@101) Tclass._module.MutexGuardU32? current$Heap) (and (=> (= (ControlFlow 0 26) (- 0 27)) ($IsAlloc refType this@@101 Tclass._module.MutexGuardU32 $Heap@@59)) (=> ($IsAlloc refType this@@101 Tclass._module.MutexGuardU32 $Heap@@59) (=> (and (= |b$reqreads#0@0| (forall (($o@@85 T@U) ($f@@31 T@U) ) (!  (=> (and (and (or (not (= $o@@85 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@85) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@85) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@85 $f@@31)))
 :qid |_12MutexLifetimeshortdfy.877:8|
 :skolemid |3260|
))) (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@59 current$Heap this@@101)) (and (=> (= (ControlFlow 0 26) 22) anon15_Then_correct) (=> (= (ControlFlow 0 26) 25) anon15_Else_correct))))))))
(let ((anon5_correct true))
(let ((anon14_Else_correct  (=> (and (=> (_module.MutexGuardU32.userInv2 $Heap@@59 current$Heap this@@101) (_module.MutexGuardU32.localUserInv2 $Heap@@59 current$Heap this@@101)) (= (ControlFlow 0 6) 1)) anon5_correct)))
(let ((anon14_Then_correct  (=> ($IsAllocBox ($Box refType this@@101) Tclass._module.MutexGuardU32? current$Heap) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType this@@101 Tclass._module.MutexGuardU32 $Heap@@59)) (=> ($IsAlloc refType this@@101 Tclass._module.MutexGuardU32 $Heap@@59) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (= this@@101 this@@101) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@101 this@@101) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (or (= this@@101 this@@101) (|_module.MutexGuardU32.userInv2#canCall| $Heap@@59 current$Heap this@@101)) (=> (and (_module.MutexGuardU32.userInv2 $Heap@@59 current$Heap this@@101) ($IsAllocBox ($Box refType this@@101) Tclass._module.MutexGuardU32? current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@101 Tclass._module.MutexGuardU32 $Heap@@59)) (=> ($IsAlloc refType this@@101 Tclass._module.MutexGuardU32 $Heap@@59) (=> (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@59 current$Heap this@@101) (=> (and (_module.MutexGuardU32.localUserInv2 $Heap@@59 current$Heap this@@101) (= (ControlFlow 0 2) 1)) anon5_correct)))))))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#59| null current$Heap alloc current$Heap alloc)) (and (and (=> (= (ControlFlow 0 28) 26) anon13_Else_correct) (=> (= (ControlFlow 0 28) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 28) 6) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@59) ($IsHeapAnchor $Heap@@59)) (=> (and (and (and (or (not (= this@@101 null)) (not true)) (and ($Is refType this@@101 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@101 Tclass._module.MutexGuardU32 previous$Heap))) (= 12 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@59) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 29) 28))) anon0_correct))))
