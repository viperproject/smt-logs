...
(set-info :boogie-vc-id CheckWellFormed$$_module.Universe.proveUnchangedNonvolatileFields)
...
(let ((anon5_Else_correct  (=> (and (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@2) _module.Universe.content)) ($Box refType |o#0@0|)) (forall (($o@@14 T@U) ($f@@2 T@U) ) (!  (=> (or (not (= $o@@14 null)) (not true)) (=> (= $o@@14 |o#0@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@14) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@14) $f@@2))))
...
))) (_module.OwnedObject.unchangedNonvolatileFields $Heap@@0 current$Heap |o#0@0|)) (= (ControlFlow 0 7) 1)) anon4_correct)))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType this@@2 Tclass._module.Universe $Heap@@0)) (=> ($IsAlloc refType this@@2 Tclass._module.Universe $Heap@@0) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@2) _module.Universe.content)) ($Box refType |o#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType |o#0@0| Tclass._module.OwnedObject $Heap@@0)) (=> ($IsAlloc refType |o#0@0| Tclass._module.OwnedObject $Heap@@0) (=> (forall (($o@@15 T@U) ($f@@3 T@U) ) (!  (=> (or (not (= $o@@15 null)) (not true)) (=> (= $o@@15 |o#0@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@15) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@15) $f@@3))))
 :qid |_08CounterNoTerminationdfy.65:58|
 :skolemid |599|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@15) $f@@3))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |o#0@0| null)) (not true))) (=> (or (not (= |o#0@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |o#0@0|) Tclass._module.OwnedObject? current$Heap) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |o#0@0| Tclass._module.OwnedObject $Heap@@0)) (=> ($IsAlloc refType |o#0@0| Tclass._module.OwnedObject $Heap@@0) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $Heap@@0 current$Heap |o#0@0|) (=> (and (_module.OwnedObject.unchangedNonvolatileFields $Heap@@0 current$Heap |o#0@0|) (= (ControlFlow 0 2) 1)) anon4_correct)))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and ($Is refType |o#0@0| Tclass._module.OwnedObject) ($IsAlloc refType |o#0@0| Tclass._module.OwnedObject current$Heap)) (and (=> (= (ControlFlow 0 8) 2) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct))))))
