...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split136)
...
))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 call5formal@this@0) alloc)))) (forall (($o@@140 T@U) ) (!  (=> (and (or (not (= $o@@140 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@140) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@140) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@140)) (or (= $o@@140 |universe#0|) (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@140)))))
 :qid |_12MutexLifetimeshortdfy.609:3|
 :skolemid |2311|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@140))
)))) (and (and (forall (($o@@141 T@U) ($f@@82 T@U) ) (!  (=> (and (or (not (= $o@@141 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@141) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@141) $f@@82) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@141) $f@@82)) (or (= $o@@141 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@141)) (= $f@@82 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimeshortdfy.609:3|
 :skolemid |2312|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@141) $f@@82))
