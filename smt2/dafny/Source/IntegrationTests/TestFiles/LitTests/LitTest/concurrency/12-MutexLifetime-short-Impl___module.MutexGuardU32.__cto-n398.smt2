...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split167)
...
)))))) (and (and ($IsGoodHeap $Heap@12) ($IsHeapAnchor $Heap@12)) (and (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (=> (_module.Universe.globalInv $Heap@11 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@3 $Heap@11 |universe#0|))))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (and (_module.Universe.globalInv $Heap@11 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@11 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@11 |o#10|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1024|
...
(let ((anon0_correct  (=> (and (and (and (and (and (and ($IsGoodHeap $Heap@@132) ($IsHeapAnchor $Heap@@132)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@132))) (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@132)) (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@132)))) (and (and (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@132)) (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@132))) (and (and (=> |defass#lifetime#0| (and ($Is refType |lifetime#0| Tclass._module.Lifetime) ($IsAlloc refType |lifetime#0| Tclass._module.Lifetime $Heap@@132))) true) (= 23 $FunctionContextHeight)))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@132 |universe#0|) (and (_module.Universe.globalInv $Heap@@132 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@132 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@@132 |o#10@@0|))
...
))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (=> (_module.Universe.globalInv $Heap@1 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@@132 $Heap@1 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (and (_module.Universe.globalInv $Heap@1 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (forall ((|o#10@@1| T@U) ) (!  (=> (and ($Is refType |o#10@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@1|))) (_module.Object.inv $Heap@1 |o#10@@1|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1024|
 :pattern ( (_module.Object.inv $Heap@1 |o#10@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@1|)))
))))))))) (and (and (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@@132 $Heap@1 |universe#0|) (and (_module.Universe.globalInv2 $Heap@@132 $Heap@1 |universe#0|) (forall ((|o#11@@1| T@U) ) (!  (=> (and ($Is refType |o#11@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@1|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@1|)) (_module.Object.inv2 $Heap@@132 $Heap@1 |o#11@@1|)))
 :qid |_12MutexLifetimeshortdfy.33:12|
 :skolemid |1026|
 :pattern ( (_module.Object.inv2 $Heap@@132 $Heap@1 |o#11@@1|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@1|)))
