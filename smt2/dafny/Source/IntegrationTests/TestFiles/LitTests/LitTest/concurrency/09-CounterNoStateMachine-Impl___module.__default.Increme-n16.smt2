...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@44) ($IsHeapAnchor $Heap@@44)) (=> (and (and (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@44)) (and ($Is refType |running#0| Tclass._module.Thread) ($IsAlloc refType |running#0| Tclass._module.Thread $Heap@@44))) (and (and ($Is refType |counter#0| Tclass._module.IncreasingCounter) ($IsAlloc refType |counter#0| Tclass._module.IncreasingCounter $Heap@@44)) (and ($Is refType |remaining#0| Tclass._module.Integer) ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap@@44)))) (and (and (and (=> |defass#initial_value#0_0| (and ($Is refType |initial_value#0_0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value#0_0| Tclass._module.ConstantInteger $Heap@@44))) true) (and (=> |defass#claim1#0_0| (and ($Is refType |claim1#0_0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim1#0_0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@44))) true)) (and (and (=> |defass#initial_value_plus_one#0_0| (and ($Is refType |initial_value_plus_one#0_0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value_plus_one#0_0| Tclass._module.ConstantInteger $Heap@@44))) true) (and (=> |defass#claim2#0_0| (and ($Is refType |claim2#0_0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim2#0_0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@44))) true)))) (=> (and (and (and (and (and (=> |defass#final_value#0_0| (and ($Is refType |final_value#0_0| Tclass._module.ConstantInteger) ($IsAlloc refType |final_value#0_0| Tclass._module.ConstantInteger $Heap@@44))) true) (= 14 $FunctionContextHeight)) (and (|_module.Universe.globalInv#canCall| $Heap@@44 |universe#0|) (and (_module.Universe.globalInv $Heap@@44 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@44 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@@44 |o#10|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |513|
...
)))))) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |running#0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |counter#0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |remaining#0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |remaining#0|) _module.OwnedObject.owner)) |running#0|)))) (and (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |remaining#0|) _module.Integer.value))) (LitInt 10)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@44 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content))))) (and (or (not (= |universe#0| null)) (not true)) (forall (($o@@44 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@44 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 $o@@44) alloc)))) (or (= $o@@44 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType $o@@44)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@44 $f@@0)))
...
)))))) (=> (|_module.Universe.globalInv#canCall| $Heap@@44 |universe#0|) (or (_module.Universe.globalInv $Heap@@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@44 |universe#0|) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@1|))) (_module.Object.triggerAxioms $Heap@@44 |o#1@@1|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |894|
 :pattern ( (_module.Object.triggerAxioms $Heap@@44 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@1|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@@44 |universe#0|) (or (_module.Universe.globalInv $Heap@@44 |universe#0|) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |o#2|))) (_module.Object.inv $Heap@@44 |o#2|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |897|
 :pattern ( (_module.Object.inv $Heap@@44 |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |o#2|)))
