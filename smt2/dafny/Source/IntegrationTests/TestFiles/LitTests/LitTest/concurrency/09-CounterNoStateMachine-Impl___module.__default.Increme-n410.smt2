...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split399)
...
))))) (= $Heap@6 $Heap@7)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))) (forall (($o@@130 T@U) ($f@@80 T@U) ) (!  (=> (and (and (or (not (= $o@@130 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@130) alloc)))) (or (= $o@@130 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType $o@@130)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@130 $f@@80)))
