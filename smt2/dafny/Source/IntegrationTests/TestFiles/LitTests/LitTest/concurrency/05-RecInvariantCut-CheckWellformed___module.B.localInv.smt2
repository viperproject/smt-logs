...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.B.localInv#canCall| $Heap@@0 this@@0) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.B) ($IsAlloc refType this@@0 Tclass._module.B $Heap@@0)))))) (and (|_module.Object.baseInv#canCall| $Heap@@0 this@@0) (= (_module.B.localInv $Heap@@0 this@@0)  (and (and (_module.Object.baseInv $Heap@@0 this@@0) (= (_module.Object.universe this@@0) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.B.a))))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.B.valid))) (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.B.a))) _module.A.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.B.a))) _module.A.b)) this@@0)))))))
 :qid |_05RecInvariantCutdfy.149:19|
 :skolemid |878|
 :pattern ( (_module.B.localInv $Heap@@0 this@@0) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.B.localInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon9_correct  (=> (= (_module.B.localInv $Heap@@3 this@@2)  (and (and (_module.Object.baseInv $Heap@@3 this@@2) (= (_module.Object.universe this@@2) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a))))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.valid))) (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a))) _module.A.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a))) _module.A.b)) this@@2))))) (=> (and (|_module.Object.baseInv#canCall| $Heap@@3 this@@2) ($Is boolType (bool_2_U (_module.B.localInv $Heap@@3 this@@2)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 9)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 8)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 3) (- 0 7)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (and (=> (= (ControlFlow 0 3) (- 0 6)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#4@1|) (=> |b$reqreads#4@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#5@1|) (=> |b$reqreads#5@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#6@1|)))))))))))))))))
(let ((anon15_Else_correct  (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a))) _module.A.valid)))) (=> (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= |b$reqreads#3@1| |b$reqreads#3@0|)) (=> (and (and (= |b$reqreads#4@1| |b$reqreads#4@0|) (= |b$reqreads#5@1| true)) (and (= |b$reqreads#6@1| true) (= (ControlFlow 0 14) 3))) anon9_correct)))))
(let ((anon15_Then_correct  (=> (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a))) _module.A.valid))) (= |b$reqreads#5@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.B.a)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)) null)) (not true)) (=> (= |b$reqreads#6@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)) _module.A.b))) (=> (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= |b$reqreads#3@1| |b$reqreads#3@0|)) (=> (and (and (= |b$reqreads#4@1| |b$reqreads#4@0|) (= |b$reqreads#5@1| |b$reqreads#5@0|)) (and (= |b$reqreads#6@1| |b$reqreads#6@0|) (= (ControlFlow 0 12) 3))) anon9_correct))))))))
(let ((anon14_Then_correct  (=> (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.valid))) (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.B.a)))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)) null)) (not true)) (=> (= |b$reqreads#4@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)) _module.A.valid))) (and (=> (= (ControlFlow 0 15) 12) anon15_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct))))))))
(let ((anon14_Else_correct  (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.valid)))) (=> (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= |b$reqreads#3@1| true)) (=> (and (and (= |b$reqreads#4@1| true) (= |b$reqreads#5@1| true)) (and (= |b$reqreads#6@1| true) (= (ControlFlow 0 11) 3))) anon9_correct)))))
(let ((anon13_Then_correct  (=> (and (and (_module.Object.baseInv $Heap@@3 this@@2) (= (_module.Object.universe this@@2) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a))))) (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.B.valid)))) (and (=> (= (ControlFlow 0 17) 15) anon14_Then_correct) (=> (= (ControlFlow 0 17) 11) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (not (and (_module.Object.baseInv $Heap@@3 this@@2) (= (_module.Object.universe this@@2) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)))))) (=> (and (= |b$reqreads#2@1| true) (= |b$reqreads#3@1| true)) (=> (and (and (= |b$reqreads#4@1| true) (= |b$reqreads#5@1| true)) (and (= |b$reqreads#6@1| true) (= (ControlFlow 0 10) 3))) anon9_correct)))))
(let ((anon12_Else_correct  (=> (and (not (_module.Object.baseInv $Heap@@3 this@@2)) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 20) 17) anon13_Then_correct) (=> (= (ControlFlow 0 20) 10) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (and (_module.Object.baseInv $Heap@@3 this@@2) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.B.a)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@2) _module.B.a)) null)) (not true)) (=> (= |b$reqreads#1@1| |b$reqreads#1@0|) (and (=> (= (ControlFlow 0 18) 17) anon13_Then_correct) (=> (= (ControlFlow 0 18) 10) anon13_Else_correct))))))))
(let ((anon11_Else_correct  (=> ($IsAllocBox ($Box refType this@@2) Tclass._module.Object? $Heap@@3) (=> (and (= |b$reqreads#0@0| (forall (($o@@26 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@26) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@26) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@26 $f@@0)))
 :qid |_05RecInvariantCutdfy.150:8|
 :skolemid |879|
))) (|_module.Object.baseInv#canCall| $Heap@@3 this@@2)) (and (=> (= (ControlFlow 0 21) 18) anon12_Then_correct) (=> (= (ControlFlow 0 21) 20) anon12_Else_correct))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap@@3 alloc $Heap@@3 alloc)) (and (=> (= (ControlFlow 0 22) 1) anon11_Then_correct) (=> (= (ControlFlow 0 22) 21) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.B) ($IsAlloc refType this@@2 Tclass._module.B $Heap@@3))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 23) 22))) anon0_correct))))
