...
(set-info :boogie-vc-id Impl$$_module.OutlivesClaim.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#57| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 26)) (or (not (= (_module.Object.universe this@@168) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@168) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 25)) ($IsAlloc refType (_module.Object.universe this@@168) Tclass._module.Universe $Heap@@98)) (=> ($IsAlloc refType (_module.Object.universe this@@168) Tclass._module.Universe $Heap@@98) (=> (and (= call0formal@previous$Heap@0 $Heap@@98) (= call2formal@this@0 (_module.Object.universe this@@168))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap call2formal@this@0) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap call2formal@this@0) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (forall ((|l#1@@2| T@U) ) (!  (=> (and ($Is refType |l#1@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |l#1@@2|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |l#1@@2|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |l#1@@2|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |l#1@@2|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |l#1@@2|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimeshortdfy.200:21|
 :skolemid |1295|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |l#1@@2|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |l#1@@2|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |l#1@@2|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |l#1@@2|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |l#1@@2|)))
))) (=> (forall ((|l#1@@3| T@U) ) (!  (=> (and ($Is refType |l#1@@3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |l#1@@3|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |l#1@@3|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |l#1@@3|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |l#1@@3|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |l#1@@3|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimeshortdfy.200:21|
 :skolemid |1295|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |l#1@@3|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |l#1@@3|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |l#1@@3|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |l#1@@3|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |l#1@@3|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall ((|a#1| T@U) (|b#1| T@U) ) (!  (=> (and ($Is refType |a#1| Tclass._module.Lifetime) ($Is refType |b#1| Tclass._module.Lifetime)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |a#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |b#1|))) (and (|_module.Universe.outlives#canCall| call0formal@previous$Heap@0 call2formal@this@0 |a#1| |b#1|) (=> (_module.Universe.outlives ($LS $LZ) call0formal@previous$Heap@0 call2formal@this@0 |a#1| |b#1|) (|_module.Universe.outlives#canCall| current$Heap call2formal@this@0 |a#1| |b#1|)))))
 :qid |_12MutexLifetimeshortdfy.201:20|
 :skolemid |1296|
 :pattern ( (_module.Universe.outlives ($LS $LZ) current$Heap call2formal@this@0 |a#1| |b#1|))
 :pattern ( (_module.Universe.outlives ($LS $LZ) call0formal@previous$Heap@0 call2formal@this@0 |a#1| |b#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |b#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |a#1|)))
))) (and (forall ((|a#1@@0| T@U) (|b#1@@0| T@U) ) (!  (=> (and (and ($Is refType |a#1@@0| Tclass._module.Lifetime) ($Is refType |b#1@@0| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |a#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |b#1@@0|)))) (=> (_module.Universe.outlives ($LS $LZ) call0formal@previous$Heap@0 call2formal@this@0 |a#1@@0| |b#1@@0|) (_module.Universe.outlives ($LS $LZ) current$Heap call2formal@this@0 |a#1@@0| |b#1@@0|)))
 :qid |_12MutexLifetimeshortdfy.201:20|
 :skolemid |1298|
 :pattern ( (_module.Universe.outlives ($LS $LZ) current$Heap call2formal@this@0 |a#1@@0| |b#1@@0|))
 :pattern ( (_module.Universe.outlives ($LS $LZ) call0formal@previous$Heap@0 call2formal@this@0 |a#1@@0| |b#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |b#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |a#1@@0|)))
)) (= current$Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@168) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@168) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@168))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@168)))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion)))))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion)))) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion)))) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@168) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@168) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@168) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@168))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@168) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@168)))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#1|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion)))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@168) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#1@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.nonvolatileVersion))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@168))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@168)))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (let ((|currOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1|) Tclass._module.Object? previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@168) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@168) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)))) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (let ((|currOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1@@0|) Tclass._module.Object? previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@168) (or (_module.Object.objectGlobalBaseInv current$Heap this@@168) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@168)) _module.Universe.content)) ($Box refType this@@168))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@168) (or (_module.Object.objectGlobalBaseInv current$Heap this@@168) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@168)) _module.Universe.content)) ($Box refType this@@168)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@168) (or (_module.Object.objectGlobalBaseInv current$Heap this@@168) (_module.Object.baseFieldsInv current$Heap this@@168)))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@168) (or (_module.Object.objectGlobalBaseInv current$Heap this@@168) (_module.Object.baseFieldsInv current$Heap this@@168))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@168) (or (_module.Object.objectGlobalBaseInv current$Heap this@@168) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@168)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@168)) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@168) (or (_module.Object.objectGlobalBaseInv current$Heap this@@168) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@168)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@168)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@168) (or (_module.Object.objectGlobalBaseInv current$Heap this@@168) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@168)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@168)) (forall ((|o#28| T@U) ) (!  (=> (and ($Is refType |o#28| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@168)) _module.Universe.content)) ($Box refType |o#28|))) (and (and (and (= (_module.Object.universe |o#28|) (_module.Object.universe this@@168)) (or (not (= |o#28| (_module.Object.universe this@@168))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#28|)) (_module.Object.triggerAxioms current$Heap |o#28|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2817|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@168)) _module.Universe.content)) ($Box refType |o#28|)))
))))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@168) (or (_module.Object.objectGlobalBaseInv current$Heap this@@168) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@168)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@168)) (forall ((|o#28@@0| T@U) ) (!  (=> (and ($Is refType |o#28@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@168)) _module.Universe.content)) ($Box refType |o#28@@0|))) (and (and (and (= (_module.Object.universe |o#28@@0|) (_module.Object.universe this@@168)) (or (not (= |o#28@@0| (_module.Object.universe this@@168))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#28@@0|)) (_module.Object.triggerAxioms current$Heap |o#28@@0|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2817|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@168)) _module.Universe.content)) ($Box refType |o#28@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.OwnedObject.lifetime this@@168)) _module.Lifetime.elements)) ($Box refType this@@168))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.OwnedObject.lifetime this@@168)) _module.Lifetime.elements)) ($Box refType this@@168)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (_module.Lifetime.alive current$Heap (_module.OwnedObject.lifetime this@@168)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (_module.Lifetime.alive current$Heap (_module.OwnedObject.lifetime this@@168)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv current$Heap this@@168))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@168) (or (_module.OwnedObject.localInv current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv current$Heap this@@168)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@168) (or (_module.OwnedObject.inv current$Heap this@@168) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@168) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv current$Heap this@@168))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@98) ($IsHeapAnchor $Heap@@98)) (and (or (not (= this@@168 null)) (not true)) (and ($Is refType this@@168 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@168 Tclass._module.OutlivesClaim previous$Heap)))) (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 19 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap@@98) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (and (and (|_module.Object.goodPreAndLegalChanges#canCall| previous$Heap current$Heap this@@168 |running#0@@5|) (and (_module.Object.goodPreAndLegalChanges previous$Heap current$Heap this@@168 |running#0@@5|) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@168)) _module.Universe.content)) ($Box refType this@@168)) (forall (($o@@108 T@U) ($f@@66 T@U) ) (!  (=> (or (not (= $o@@108 null)) (not true)) (=> (= $o@@108 this@@168) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@108) $f@@66) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@108) $f@@66))))
 :qid |_12MutexLifetimeshortdfy.342:8|
 :skolemid |2816|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@108) $f@@66))
))) (_module.Universe.legalTransition previous$Heap current$Heap (_module.Object.universe this@@168) |running#0@@5|)))) (= (ControlFlow 0 27) 2)))) anon0_correct)))
