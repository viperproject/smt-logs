...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split358)
...
))))) (forall (($o@@186 T@U) ) (!  (=> (and (or (not (= $o@@186 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@186) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@186) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@186)) (or (= $o@@186 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType $o@@186)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@186))
))) (and ($HeapSucc $Heap@38 $Heap@39) (= (ControlFlow 0 2) (- 0 1))))))))))) (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
