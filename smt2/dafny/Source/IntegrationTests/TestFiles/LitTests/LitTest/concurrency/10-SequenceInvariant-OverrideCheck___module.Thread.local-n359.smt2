...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@4 this@@4) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Universe) ($IsAlloc refType this@@4 Tclass._module.Universe $Heap@@4)))))) (and (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.Universe.content)) ($Box refType |o#0|)) (=> (= (_module.Object.universe |o#0|) this@@4) (=> (or (not (= |o#0| this@@4)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@4 |o#0|) (=> (_module.Object.baseFieldsInv $Heap@@4 |o#0|) (|_module.Object.triggerAxioms#canCall| $Heap@@4 |o#0|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@4 |o#0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@4 |o#0|))
 :pattern ( (_module.Object.universe |o#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.Universe.content)) ($Box refType |o#0|)))
)) (= (_module.Universe.globalBaseInv $Heap@@4 this@@4) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.Universe.content)) ($Box refType |o#0@@0|))) (and (and (and (= (_module.Object.universe |o#0@@0|) this@@4) (or (not (= |o#0@@0| this@@4)) (not true))) (_module.Object.baseFieldsInv $Heap@@4 |o#0@@0|)) (_module.Object.triggerAxioms $Heap@@4 |o#0@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.Universe.content)) ($Box refType |o#0@@0|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@4 this@@4) ($IsGoodHeap $Heap@@4))
))))
...
(set-info :boogie-vc-id OverrideCheck$$_module.Thread.localInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= Thread_$_ReadsFrame@0 (|lambda#4| null $Heap@@9 alloc $Heap@@9 alloc)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc))))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1210|
))) (=> (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@19) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@19) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@19) alloc))))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1210|
)) (=> (=> (_module.Thread.localInv $Heap@@9 this@@9) (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (_module.Thread.localInv $Heap@@9 this@@9) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (or (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Object.universe this@@9)) _module.Universe.content)) ($Box refType this@@9)))))) (=> (=> (_module.Thread.localInv $Heap@@9 this@@9) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (or (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Object.universe this@@9)) _module.Universe.content)) ($Box refType this@@9))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.Thread.localInv $Heap@@9 this@@9) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (or (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (_module.Object.baseFieldsInv $Heap@@9 this@@9))))) (=> (=> (_module.Thread.localInv $Heap@@9 this@@9) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (or (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (_module.Object.baseFieldsInv $Heap@@9 this@@9)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.Thread.localInv $Heap@@9 this@@9) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (or (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@9 (_module.Object.universe this@@9)) (or (_module.Universe.globalBaseInv $Heap@@9 (_module.Object.universe this@@9)) (forall ((|o#1| T@U) ) (!  (=> (and ($Is refType |o#1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Object.universe this@@9)) _module.Universe.content)) ($Box refType |o#1|))) (and (and (and (= (_module.Object.universe |o#1|) (_module.Object.universe this@@9)) (or (not (= |o#1| (_module.Object.universe this@@9))) (not true))) (_module.Object.baseFieldsInv $Heap@@9 |o#1|)) (_module.Object.triggerAxioms $Heap@@9 |o#1|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |1211|
 :pattern ( (_module.Object.triggerAxioms $Heap@@9 |o#1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@9 |o#1|))
 :pattern ( (_module.Object.universe |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Object.universe this@@9)) _module.Universe.content)) ($Box refType |o#1|)))
))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (=> (and (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.Thread) ($IsAlloc refType this@@9 Tclass._module.Thread $Heap@@9))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
