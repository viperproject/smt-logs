...
(assert (forall ((|c#0@@4| T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType |c#0@@4| Tclass._module.Mutex $h@@8) ($IsAlloc refType |c#0@@4| Tclass._module.Mutex? $h@@8))
 :qid |unknown.0:0|
 :skolemid |3197|
 :pattern ( ($IsAlloc refType |c#0@@4| Tclass._module.Mutex $h@@8))
 :pattern ( ($IsAlloc refType |c#0@@4| Tclass._module.Mutex? $h@@8))
)))
...
(assert (forall (($o@@3 T@U) ($h@@9 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.Universe? $h@@9)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@9 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |815|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.Universe? $h@@9))
)))
(assert (forall (($o@@4 T@U) ($h@@10 T@U) ) (! (= ($IsAlloc refType $o@@4 Tclass._module.Object? $h@@10)  (or (= $o@@4 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@10 $o@@4) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1341|
 :pattern ( ($IsAlloc refType $o@@4 Tclass._module.Object? $h@@10))
)))
(assert (forall (($o@@5 T@U) ($h@@11 T@U) ) (! (= ($IsAlloc refType $o@@5 Tclass._module.Thread? $h@@11)  (or (= $o@@5 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@11 $o@@5) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1495|
 :pattern ( ($IsAlloc refType $o@@5 Tclass._module.Thread? $h@@11))
)))
(assert (forall (($o@@6 T@U) ($h@@12 T@U) ) (! (= ($IsAlloc refType $o@@6 Tclass._module.OwnedObject? $h@@12)  (or (= $o@@6 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@12 $o@@6) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1751|
 :pattern ( ($IsAlloc refType $o@@6 Tclass._module.OwnedObject? $h@@12))
)))
(assert (forall (($o@@7 T@U) ($h@@13 T@U) ) (! (= ($IsAlloc refType $o@@7 Tclass._module.Lifetime? $h@@13)  (or (= $o@@7 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@13 $o@@7) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1902|
 :pattern ( ($IsAlloc refType $o@@7 Tclass._module.Lifetime? $h@@13))
)))
(assert (forall (($o@@8 T@U) ($h@@14 T@U) ) (! (= ($IsAlloc refType $o@@8 Tclass._module.Mutex? $h@@14)  (or (= $o@@8 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@14 $o@@8) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2904|
 :pattern ( ($IsAlloc refType $o@@8 Tclass._module.Mutex? $h@@14))
)))
...
(assert (forall (($h@@15 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass._module.Lifetime?))) ($Is refType ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@15 $o@@9) _module.Lifetime.owner)) Tclass._module.Thread?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1903|
 :pattern ( ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@15 $o@@9) _module.Lifetime.owner)))
)))
...
(assert (forall ((|c#0@@10| T@U) ) (! (= ($Is refType |c#0@@10| Tclass._module.Mutex)  (and ($Is refType |c#0@@10| Tclass._module.Mutex?) (or (not (= |c#0@@10| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |3196|
 :pattern ( ($Is refType |c#0@@10| Tclass._module.Mutex))
 :pattern ( ($Is refType |c#0@@10| Tclass._module.Mutex?))
)))
(assert (forall (($h@@16 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass._module.Lifetime?))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@16 $o@@10) alloc)))) ($IsAlloc refType ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@16 $o@@10) _module.Lifetime.owner)) Tclass._module.Thread? $h@@16))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1904|
 :pattern ( ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@16 $o@@10) _module.Lifetime.owner)))
)))
...
(assert (forall (($o@@14 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@14 Tclass._module.Mutex? $heap@@2) ($IsAlloc refType $o@@14 Tclass._module.OwnedObject? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |3512|
 :pattern ( ($IsAlloc refType $o@@14 Tclass._module.Mutex? $heap@@2))
)))
...
(assert (forall (($h@@17 T@U) ($o@@22 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@22 null)) (not true)) ($Is refType $o@@22 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@17 $o@@22) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@17 $o@@22) _module.Universe.content)) (TSet Tclass._module.Object) $h@@17))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |817|
 :pattern ( ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@17 $o@@22) _module.Universe.content)))
)))
(assert (forall (($h@@18 T@U) ($o@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@23 null)) (not true)) ($Is refType $o@@23 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@18 $o@@23) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |816|
 :pattern ( ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@18 $o@@23) _module.Universe.content)))
)))
(push 1)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.MutexGuardU32.__ctor_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap)) (and ($Is refType |running#0| Tclass._module.Thread) ($IsAlloc refType |running#0| Tclass._module.Thread $Heap))) (and (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap)) (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap)))) (and (and (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap)) (= 23 $FunctionContextHeight)) (and (= $_ModifiesFrame@0 (|lambda#250| null $Heap alloc |universe#0| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |universe#0|) _module.Universe.content)) Tclass._module.Lifetime ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |universe#0|) _module.Universe.content)) $Heap _module.Lifetime.owner |running#0| |scope#0| |mutexScope#0|)) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |universe#0| null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
