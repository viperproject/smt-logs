...
(set-info :boogie-vc-id Impl$$_module.__default.Acquire_split2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@133) ($IsHeapAnchor $Heap@@133)) (=> (and (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@133)) (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@133))) (and (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@133)) (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@133)))) (=> (and (and (and (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@133)) (=> |defass#guard#0| (and ($Is refType |guard#0| Tclass._module.MutexGuardU32) ($IsAlloc refType |guard#0| Tclass._module.MutexGuardU32 $Heap@@133)))) (and (and (=> |defass#callScope#0| (and ($Is refType |callScope#0| Tclass._module.Lifetime) ($IsAlloc refType |callScope#0| Tclass._module.Lifetime $Heap@@133))) true) (= 24 $FunctionContextHeight))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@133 |universe#0|) (and (_module.Universe.globalInv $Heap@@133 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@133 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@@133 |o#10|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |848|
 :pattern ( (_module.Object.inv $Heap@@133 |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#10|)))
...
))))) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@133 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))) (forall (($o@@139 T@U) ($f@@81 T@U) ) (!  (=> (and (and (or (not (= $o@@139 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 $o@@139) alloc)))) (or (= $o@@139 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType $o@@139)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@139 $f@@81)))
 :qid |_12MutexLifetimelongdfy.976:26|
 :skolemid |872|
))))) (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalInv $Heap@@133 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@133 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalInv $Heap@@133 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@133 |universe#0|) (forall ((|o#0@@19| T@U) ) (!  (=> (and ($Is refType |o#0@@19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@19|))) (and (and (and (= (_module.Object.universe |o#0@@19|) |universe#0|) (or (not (= |o#0@@19| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@133 |o#0@@19|)) (_module.Object.triggerAxioms $Heap@@133 |o#0@@19|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@@133 |o#0@@19|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@133 |o#0@@19|))
 :pattern ( (_module.Object.universe |o#0@@19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@19|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalInv $Heap@@133 |universe#0|) (forall ((|o#1@@6| T@U) ) (!  (=> (and ($Is refType |o#1@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@6|))) (_module.Object.inv $Heap@@133 |o#1@@6|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
 :pattern ( (_module.Object.inv $Heap@@133 |o#1@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@6|)))
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.Universe.globalInv#canCall| $Heap@0 |universe#0|)))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@0 |universe#0|) (and (_module.Universe.globalInv $Heap@0 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3|))) (_module.Object.inv $Heap@0 |o#3|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |760|
...
))))) (|_module.Universe.globalSequenceInv2#canCall| $Heap@@133 $Heap@0 |universe#0|)) (and (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@@133 $Heap@0 |universe#0|) (and (_module.Universe.globalSequenceInv2 $Heap@@133 $Heap@0 |universe#0|) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#4|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#4|)) (_module.Object.sequenceInv2 $Heap@@133 $Heap@0 |o#4|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |762|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@133 $Heap@0 |o#4|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)))
))) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#9|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#9|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#9|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#9|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@133)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#9|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#9|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |775|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#9|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#9|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#9|)))
))) (forall ((|l#0@@9| T@U) ) (!  (=> (and ($Is refType |l#0@@9| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@9|))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#0@@9|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#0@@9|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@133)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@133 $Heap@0 |l#0@@9|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |776|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@133 $Heap@0 |l#0@@9|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#0@@9|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@9|)))
))))) (forall ((|a#1| T@U) (|b#1| T@U) ) (!  (=> (and ($Is refType |a#1| Tclass._module.Lifetime) ($Is refType |b#1| Tclass._module.Lifetime)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |a#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |b#1|))) (and (|_module.Universe.outlives#canCall| $Heap@@133 |universe#0| |a#1| |b#1|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@@133 |universe#0| |a#1| |b#1|) (|_module.Universe.outlives#canCall| $Heap@0 |universe#0| |a#1| |b#1|)))))
 :qid |_12MutexLifetimelongdfy.285:18|
 :skolemid |777|
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1| |b#1|))
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@@133 |universe#0| |a#1| |b#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |b#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |a#1|)))
))) (and (forall ((|a#1@@0| T@U) (|b#1@@0| T@U) ) (!  (=> (and (and ($Is refType |a#1@@0| Tclass._module.Lifetime) ($Is refType |b#1@@0| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@0|)))) (=> (_module.Universe.outlives ($LS $LZ) $Heap@@133 |universe#0| |a#1@@0| |b#1@@0|) (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1@@0| |b#1@@0|)))
 :qid |_12MutexLifetimelongdfy.285:18|
 :skolemid |779|
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1@@0| |b#1@@0|))
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@@133 |universe#0| |a#1@@0| |b#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@0|)))
)) (forall (($o@@141 T@U) ) (!  (=> (and (or (not (= $o@@141 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 $o@@141) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@141) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 $o@@141)) (or (= $o@@141 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType $o@@141)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@141))
)))))) (and (and (and (and (and ($HeapSucc $Heap@@133 $Heap@0) (or (not (= |universe#0| null)) (not true))) (and (= |running##0@0| (Lit SetType |Set#Empty|)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@0))) (and (and ($IsAlloc SetType (Lit SetType |Set#Empty|) (TSet Tclass._module.Thread) $Heap@0) ($IsAlloc SetType |running##0@0| (TSet Tclass._module.Thread) $Heap@0)) (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (forall ((|o#0@@20| T@U) ) (!  (=> (and ($Is refType |o#0@@20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@20|))) (and (and (and (= (_module.Object.universe |o#0@@20|) |universe#0|) (or (not (= |o#0@@20| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@0 |o#0@@20|)) (_module.Object.triggerAxioms $Heap@0 |o#0@@20|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1316|
 :pattern ( (_module.Object.triggerAxioms $Heap@0 |o#0@@20|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@0 |o#0@@20|))
 :pattern ( (_module.Object.universe |o#0@@20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@20|)))
))))))))))) (and (and (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (forall ((|o#1@@7| T@U) ) (!  (=> (and ($Is refType |o#1@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@7|))) (and (and (and (= (_module.Object.universe |o#1@@7|) |universe#0|) (or (not (= |o#1@@7| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@0 |o#1@@7|)) (_module.Object.triggerAxioms $Heap@0 |o#1@@7|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1318|
 :pattern ( (_module.Object.triggerAxioms $Heap@0 |o#1@@7|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@0 |o#1@@7|))
...
))))))))) (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@0 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@0 |universe#0|) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#2|)))) (not ($IsAllocBox ($Box refType |o#2|) Tclass._module.Object $Heap@0)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1320|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#2|)))
)))))))) (and (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (|Set#Subset| |running##0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))) (or (forall (($o@@142 T@U) ($f@@83 T@U) ) (!  (=> (or (not (= $o@@142 null)) (not true)) (=> (= $o@@142 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@142) $f@@83) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@142) $f@@83))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1322|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@142) $f@@83))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))
))))) (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| |running##0@0| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@0)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |1324|
...
)))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| |running##0@0|) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| |running##0@0|) (forall ((|l#0@@10| T@U) ) (!  (=> (and ($Is refType |l#0@@10| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@10|))) (=> (and (not (|Set#IsMember| |running##0@0| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@10|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@10|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@0)) (_module.Lifetime.unchangedNonvolatileFields $Heap@0 $Heap@0 |l#0@@10|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1325|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@0 $Heap@0 |l#0@@10|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#0@@10|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@10|)))
)))))))) (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@0 |universe#0|)) (and (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@0 |universe#0|) (and (_module.Universe.globalSequenceInv2 $Heap@0 $Heap@0 |universe#0|) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#5|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#5|)) (_module.Object.sequenceInv2 $Heap@0 $Heap@0 |o#5|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |1331|
 :pattern ( (_module.Object.sequenceInv2 $Heap@0 $Heap@0 |o#5|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#5|)))
)))) (= $Heap@0 $Heap@1))) (and (and (and (or (not (= |universe#0| null)) (not true)) (forall (($o@@143 T@U) ($f@@84 T@U) ) (!  (=> (and (and (or (not (= $o@@143 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@143) alloc)))) (or (= $o@@143 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType $o@@143)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@143 $f@@84)))
 :qid |_12MutexLifetimelongdfy.980:3|
 :skolemid |874|
))) (and (= |$Frame$loop#0@0| (|lambda#0| null $Heap@1 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)))) (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalInv $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalInv $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (forall ((|o#18| T@U) ) (!  (=> (and ($Is refType |o#18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#18|))) (and (and (and (= (_module.Object.universe |o#18|) |universe#0|) (or (not (= |o#18| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@1 |o#18|)) (_module.Object.triggerAxioms $Heap@1 |o#18|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |875|
 :pattern ( (_module.Object.triggerAxioms $Heap@1 |o#18|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@1 |o#18|))
...
))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalInv $Heap@1 |universe#0|) (forall ((|o#19| T@U) ) (!  (=> (and ($Is refType |o#19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#19|))) (_module.Object.inv $Heap@1 |o#19|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |877|
 :pattern ( (_module.Object.inv $Heap@1 |o#19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#19|)))
)))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (forall ((|o#20| T@U) ) (!  (=> (and ($Is refType |o#20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#20|))) (and (and (and (= (_module.Object.universe |o#20|) |universe#0|) (or (not (= |o#20| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@0 |o#20|)) (_module.Object.triggerAxioms $Heap@0 |o#20|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |879|
 :pattern ( (_module.Object.triggerAxioms $Heap@0 |o#20|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@0 |o#20|))
 :pattern ( (_module.Object.universe |o#20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#20|)))
))))))))))))))))) (and (and (and (and (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (forall ((|o#21| T@U) ) (!  (=> (and ($Is refType |o#21| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#21|))) (and (and (and (= (_module.Object.universe |o#21|) |universe#0|) (or (not (= |o#21| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@1 |o#21|)) (_module.Object.triggerAxioms $Heap@1 |o#21|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |881|
 :pattern ( (_module.Object.triggerAxioms $Heap@1 |o#21|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@1 |o#21|))
 :pattern ( (_module.Object.universe |o#21|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#21|)))
)))))))))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)))))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 |universe#0|) (forall ((|o#22| T@U) ) (!  (=> (and ($Is refType |o#22| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#22|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#22|)))) (not ($IsAllocBox ($Box refType |o#22|) Tclass._module.Object $Heap@0)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |883|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#22|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#22|)))
))))))))))) (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (forall ((|o#23| T@U) ) (!  (=> (and ($Is refType |o#23| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#23|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#23|)))) (or (forall (($o@@144 T@U) ($f@@85 T@U) ) (!  (=> (or (not (= $o@@144 null)) (not true)) (=> (= $o@@144 |o#23|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@144) $f@@85) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@144) $f@@85))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |885|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@144) $f@@85))
)) (_module.Object.sequenceInv2 $Heap@0 $Heap@1 |o#23|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |886|
 :pattern ( (_module.Object.sequenceInv2 $Heap@0 $Heap@1 |o#23|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#23|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#23|)))
)))))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (forall ((|o#24| T@U) ) (!  (=> (and ($Is refType |o#24| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#24|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@0)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#24|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |887|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#24|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#24|)))
))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@1 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (forall ((|l#2@@2| T@U) ) (!  (=> (and ($Is refType |l#2@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#2@@2|))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#2@@2|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#2@@2|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@0)) (_module.Lifetime.unchangedNonvolatileFields $Heap@0 $Heap@1 |l#2@@2|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |888|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@0 $Heap@1 |l#2@@2|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#2@@2|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#2@@2|)))
)))))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@1 |universe#0|) (or (_module.Universe.globalSequenceInv2 $Heap@0 $Heap@1 |universe#0|) (forall ((|o#25| T@U) ) (!  (=> (and ($Is refType |o#25| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#25|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#25|)) (_module.Object.sequenceInv2 $Heap@0 $Heap@1 |o#25|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |893|
 :pattern ( (_module.Object.sequenceInv2 $Heap@0 $Heap@1 |o#25|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#25|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#25|)))
))))) (=> |$w$loop#0@0| (=> (|_module.Lifetime.unused#canCall| $Heap@1 |scope#0|) (or (_module.Lifetime.unused $Heap@1 |scope#0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |scope#0|) _module.Lifetime.mightPointFrom)) |Set#Empty|))))) (and (=> |$w$loop#0@0| (=> (|_module.Lifetime.unused#canCall| $Heap@1 |scope#0|) (or (_module.Lifetime.unused $Heap@1 |scope#0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |scope#0|) _module.Lifetime.elements)) |Set#Empty|)))) (=> |$w$loop#0@0| (=> (|_module.Lifetime.alive#canCall| $Heap@1 |scope#0|) (or (_module.Lifetime.alive $Heap@1 |scope#0|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |scope#0|) _module.Lifetime.owner)) null)) (not true))))))) (and (and (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |scope#0|) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |mutexScope#0|) _module.Lifetime.owner)))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |mutexScope#0|) _module.Lifetime.owner)) |running#0@@3|))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))))) (and (and (and (and (not false) (=> |$w$loop#0@0| (and (|_module.Universe.globalInv#canCall| $Heap@2 |universe#0|) (=> (_module.Universe.globalInv $Heap@2 |universe#0|) (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalInv $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalInv $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (forall ((|o#18@@0| T@U) ) (!  (=> (and ($Is refType |o#18@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@0|))) (and (and (and (= (_module.Object.universe |o#18@@0|) |universe#0|) (or (not (= |o#18@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#18@@0|)) (_module.Object.triggerAxioms $Heap@2 |o#18@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |875|
...
))))))))) (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalInv $Heap@2 |universe#0|) (forall ((|o#19@@0| T@U) ) (!  (=> (and ($Is refType |o#19@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|))) (_module.Object.inv $Heap@2 |o#19@@0|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |877|
 :pattern ( (_module.Object.inv $Heap@2 |o#19@@0|))
...
))))) (=> |$w$loop#0@0| (and (|_module.Universe.globalInv#canCall| $Heap@2 |universe#0|) (and (_module.Universe.globalInv $Heap@2 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (forall ((|o#19@@1| T@U) ) (!  (=> (and ($Is refType |o#19@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@1|))) (_module.Object.inv $Heap@2 |o#19@@1|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |878|
 :pattern ( (_module.Object.inv $Heap@2 |o#19@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@1|)))
))))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (forall ((|o#20@@0| T@U) ) (!  (=> (and ($Is refType |o#20@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#20@@0|))) (and (and (and (= (_module.Object.universe |o#20@@0|) |universe#0|) (or (not (= |o#20@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@0 |o#20@@0|)) (_module.Object.triggerAxioms $Heap@0 |o#20@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |879|
 :pattern ( (_module.Object.triggerAxioms $Heap@0 |o#20@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@0 |o#20@@0|))
 :pattern ( (_module.Object.universe |o#20@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#20@@0|)))
)))))))))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (forall ((|o#21@@0| T@U) ) (!  (=> (and ($Is refType |o#21@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#21@@0|))) (and (and (and (= (_module.Object.universe |o#21@@0|) |universe#0|) (or (not (= |o#21@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#21@@0|)) (_module.Object.triggerAxioms $Heap@2 |o#21@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |881|
 :pattern ( (_module.Object.triggerAxioms $Heap@2 |o#21@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@2 |o#21@@0|))
 :pattern ( (_module.Object.universe |o#21@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#21@@0|)))
)))))))))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@2 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)))))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@2 |universe#0|) (forall ((|o#22@@0| T@U) ) (!  (=> (and ($Is refType |o#22@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#22@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#22@@0|)))) (not ($IsAllocBox ($Box refType |o#22@@0|) Tclass._module.Object $Heap@0)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |883|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#22@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#22@@0|)))
))))))))))) (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (forall ((|o#23@@0| T@U) ) (!  (=> (and ($Is refType |o#23@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#23@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#23@@0|)))) (or (forall (($o@@145 T@U) ($f@@86 T@U) ) (!  (=> (or (not (= $o@@145 null)) (not true)) (=> (= $o@@145 |o#23@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@145) $f@@86) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@145) $f@@86))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |885|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@145) $f@@86))
)) (_module.Object.sequenceInv2 $Heap@0 $Heap@2 |o#23@@0|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |886|
 :pattern ( (_module.Object.sequenceInv2 $Heap@0 $Heap@2 |o#23@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#23@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#23@@0|)))
)))))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (forall ((|o#24@@0| T@U) ) (!  (=> (and ($Is refType |o#24@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#24@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24@@0|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@0)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |o#24@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |887|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |o#24@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#24@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#24@@0|)))
))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))))) (forall ((|l#2@@3| T@U) ) (!  (=> (and ($Is refType |l#2@@3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#2@@3|))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#2@@3|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#2@@3|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@0)) (_module.Lifetime.unchangedNonvolatileFields $Heap@0 $Heap@2 |l#2@@3|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |888|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@0 $Heap@2 |l#2@@3|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#2@@3|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#2@@3|)))
)))))))))))) (and (and (and (and (and (=> |$w$loop#0@0| (and (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@0 $Heap@2 |universe#0|) (and (_module.Universe.legalTransitionsSequenceAnyThread $Heap@0 $Heap@2 |universe#0|) (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))))))) (=> |$w$loop#0@0| (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@2 |universe#0|))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.globalSequenceInv2 $Heap@0 $Heap@2 |universe#0|) (forall ((|o#25@@0| T@U) ) (!  (=> (and ($Is refType |o#25@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#25@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#25@@0|)) (_module.Object.sequenceInv2 $Heap@0 $Heap@2 |o#25@@0|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |893|
 :pattern ( (_module.Object.sequenceInv2 $Heap@0 $Heap@2 |o#25@@0|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#25@@0|)))
))))) (=> |$w$loop#0@0| (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@2 |universe#0|) (and (_module.Universe.globalSequenceInv2 $Heap@0 $Heap@2 |universe#0|) (forall ((|o#25@@1| T@U) ) (!  (=> (and ($Is refType |o#25@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#25@@1|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#25@@1|)) (_module.Object.sequenceInv2 $Heap@0 $Heap@2 |o#25@@1|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |894|
 :pattern ( (_module.Object.sequenceInv2 $Heap@0 $Heap@2 |o#25@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#25@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#25@@1|)))
))))))) (and (and (=> |$w$loop#0@0| (and (|_module.Lifetime.unused#canCall| $Heap@2 |scope#0|) (=> (_module.Lifetime.unused $Heap@2 |scope#0|) (|_module.Lifetime.alive#canCall| $Heap@2 |scope#0|)))) (=> |$w$loop#0@0| (=> (|_module.Lifetime.unused#canCall| $Heap@2 |scope#0|) (or (_module.Lifetime.unused $Heap@2 |scope#0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |scope#0|) _module.Lifetime.mightPointFrom)) |Set#Empty|))))) (and (=> |$w$loop#0@0| (=> (|_module.Lifetime.unused#canCall| $Heap@2 |scope#0|) (or (_module.Lifetime.unused $Heap@2 |scope#0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |scope#0|) _module.Lifetime.elements)) |Set#Empty|)))) (=> |$w$loop#0@0| (and (|_module.Lifetime.unused#canCall| $Heap@2 |scope#0|) (and (_module.Lifetime.unused $Heap@2 |scope#0|) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |scope#0|) _module.Lifetime.mightPointFrom)) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |scope#0|) _module.Lifetime.elements)) |Set#Empty|)))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.Lifetime.alive#canCall| $Heap@2 |scope#0|) (or (_module.Lifetime.alive $Heap@2 |scope#0|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |scope#0|) _module.Lifetime.owner)) null)) (not true))))) (=> |$w$loop#0@0| (and (|_module.Lifetime.alive#canCall| $Heap@2 |scope#0|) (and (_module.Lifetime.alive $Heap@2 |scope#0|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |scope#0|) _module.Lifetime.owner)) null)) (not true)))))) (and (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |scope#0|) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |mutexScope#0|) _module.Lifetime.owner)))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |mutexScope#0|) _module.Lifetime.owner)) |running#0@@3|)))) (and (and (forall (($o@@146 T@U) ) (!  (=> (and (or (not (= $o@@146 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 $o@@146) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@146) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@146)) (or (= $o@@146 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType $o@@146)))))
 :qid |_12MutexLifetimelongdfy.980:3|
 :skolemid |895|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@146))
)) ($HeapSucc $Heap@1 $Heap@2)) (and (forall (($o@@147 T@U) ($f@@87 T@U) ) (!  (=> (and (or (not (= $o@@147 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@147) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@147) $f@@87) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@147) $f@@87)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@147 $f@@87))))
 :qid |_12MutexLifetimelongdfy.980:3|
 :skolemid |896|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@147) $f@@87))
)) |$w$loop#0@0|)))) (and (and (and (and (or (not (= |mutex#0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |mutex#0|) _module.Mutex.locked))))) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@0))) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content))) (forall ((|l#1@@4| T@U) ) (!  (=> (and ($Is refType |l#1@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@4|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@4|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |l#1@@4|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@4|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |l#1@@4|) _module.Lifetime.mightPointTo)))))
...
))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)))) (and (and (and (forall ((|a#1@@1| T@U) (|b#1@@1| T@U) ) (!  (=> (and ($Is refType |a#1@@1| Tclass._module.Lifetime) ($Is refType |b#1@@1| Tclass._module.Lifetime)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@1|))) (and (|_module.Universe.outlives#canCall| $Heap@0 |universe#0| |a#1@@1| |b#1@@1|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1@@1| |b#1@@1|) (|_module.Universe.outlives#canCall| $Heap@2 |universe#0| |a#1@@1| |b#1@@1|)))))
...
))) (and (= $Heap@2 $Heap@3) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@3))) (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@0) (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@3 |universe#0|)) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@3 |universe#0|) (_module.Universe.globalSequenceInv2 $Heap@0 $Heap@3 |universe#0|)))))))) (and (=> (= (ControlFlow 0 2) (- 0 35)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (= |mightPointTo##0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |scope#0|))) (and (=> (= (ControlFlow 0 2) (- 0 34)) (forall (($o@@148 T@U) ($f@@88 T@U) ) (!  (=> (and (and (or (not (= $o@@148 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@148) alloc)))) (or (= $o@@148 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@148)) (= $f@@88 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@148 $f@@88)))
 :qid |_12MutexLifetimelongdfy.1006:20|
 :skolemid |905|
))) (=> (forall (($o@@149 T@U) ($f@@89 T@U) ) (!  (=> (and (and (or (not (= $o@@149 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@149) alloc)))) (or (= $o@@149 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@149)) (= $f@@89 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@149 $f@@89)))
 :qid |_12MutexLifetimelongdfy.1006:20|
 :skolemid |905|
)) (=> (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass._module.Lifetime) ($IsAlloc refType call5formal@this Tclass._module.Lifetime $Heap@@133))) (and (=> (= (ControlFlow 0 2) (- 0 33)) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 32)) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#0@@21| T@U) ) (!  (=> (and ($Is refType |o#0@@21| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@21|))) (and (and (and (= (_module.Object.universe |o#0@@21|) |universe#0|) (or (not (= |o#0@@21| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#0@@21|)) (_module.Object.triggerAxioms $Heap@3 |o#0@@21|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2625|
 :pattern ( (_module.Object.triggerAxioms $Heap@3 |o#0@@21|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@3 |o#0@@21|))
 :pattern ( (_module.Object.universe |o#0@@21|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@21|)))
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#0@@22| T@U) ) (!  (=> (and ($Is refType |o#0@@22| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@22|))) (and (and (and (= (_module.Object.universe |o#0@@22|) |universe#0|) (or (not (= |o#0@@22| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#0@@22|)) (_module.Object.triggerAxioms $Heap@3 |o#0@@22|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2625|
 :pattern ( (_module.Object.triggerAxioms $Heap@3 |o#0@@22|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@3 |o#0@@22|))
 :pattern ( (_module.Object.universe |o#0@@22|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@22|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (forall ((|o#1@@8| T@U) ) (!  (=> (and ($Is refType |o#1@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@8|))) (_module.Object.inv $Heap@3 |o#1@@8|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |2627|
 :pattern ( (_module.Object.inv $Heap@3 |o#1@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@8|)))
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (|Set#Subset| |mightPointTo##0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| |mightPointTo##0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (forall ((|l#1@@5| T@U) ) (!  (=> (and ($Is refType |l#1@@5| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@5|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@5|) _module.Lifetime.owner)) |running#0@@3|))
 :qid |_12MutexLifetimelongdfy.612:21|
 :skolemid |2629|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@5|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@5|)))
))) (=> (forall ((|l#1@@6| T@U) ) (!  (=> (and ($Is refType |l#1@@6| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@6|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@6|) _module.Lifetime.owner)) |running#0@@3|))
 :qid |_12MutexLifetimelongdfy.612:21|
 :skolemid |2629|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@6|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@6|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (or (not (= call5formal@this@0 null)) (not true)) (and ($Is refType call5formal@this@0 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@0 Tclass._module.Lifetime $Heap@4)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@4 call5formal@this@0) (=> (_module.Object.objectGlobalInv $Heap@4 call5formal@this@0) (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@4 |universe#0| |running#0@@3|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@4 call5formal@this@0) (and (_module.Object.objectGlobalInv $Heap@4 call5formal@this@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe call5formal@this@0)) _module.Universe.content)) ($Box refType call5formal@this@0)) (_module.Universe.globalInv $Heap@4 (_module.Object.universe call5formal@this@0))))))) (=> (and (and (and (and (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@4 |universe#0| |running#0@@3|) (and (_module.Universe.legalTransition $Heap@3 $Heap@4 |universe#0| |running#0@@3|) (and (and (and (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@4 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@3 |universe#0|)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#11|))) (and (or (forall (($o@@150 T@U) ($f@@90 T@U) ) (!  (=> (or (not (= $o@@150 null)) (not true)) (=> (= $o@@150 |o#11|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@150) $f@@90) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@150) $f@@90))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2656|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@150) $f@@90))
)) (_module.Object.inv $Heap@4 |o#11|)) (or (forall (($o@@151 T@U) ($f@@91 T@U) ) (!  (=> (or (not (= $o@@151 null)) (not true)) (=> (= $o@@151 |o#11|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@151) $f@@91) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@151) $f@@91))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2657|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@151) $f@@91))
)) (_module.Object.inv2 $Heap@3 $Heap@4 |o#11|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |2658|
 :pattern ( (_module.Object.inv2 $Heap@3 $Heap@4 |o#11|))
 :pattern ( (_module.Object.inv $Heap@4 |o#11|))
...
))) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#12|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#12|))))) (_module.Object.inv $Heap@4 |o#12|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |2659|
...
))))) (= (_module.Object.universe call5formal@this@0) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call5formal@this@0) _module.Lifetime.elements)) |Set#Empty|))) (and (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call5formal@this@0) _module.Lifetime.mightPointTo)) |mightPointTo##0@0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call5formal@this@0) _module.Lifetime.mightPointFrom)) |Set#Empty|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (forall ((|l#3@@1| T@U) ) (!  (=> (and ($Is refType |l#3@@1| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#3@@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))))
 :qid |_12MutexLifetimelongdfy.618:20|
 :skolemid |2660|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#3@@1|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#3@@1|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#3@@1|)))
)))) (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call5formal@this@0) alloc)))) (forall (($o@@152 T@U) ) (!  (=> (and (or (not (= $o@@152 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@152) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@152) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@152)) (or (= $o@@152 |universe#0|) (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@152)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2661|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@152))
))) (and (forall (($o@@153 T@U) ($f@@92 T@U) ) (!  (=> (and (or (not (= $o@@153 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@153) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@153) $f@@92) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@153) $f@@92)) (or (= $o@@153 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@153)) (= $f@@92 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2662|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@153) $f@@92))
)) ($HeapSucc $Heap@3 $Heap@4))))) (and (=> (= (ControlFlow 0 2) (- 0 27)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 26)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3) (and (=> (= (ControlFlow 0 2) (- 0 25)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (forall ((|l#1@@7| T@U) ) (!  (=> (and ($Is refType |l#1@@7| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@7|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@7|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@7|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@7|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@7|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@7|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@7|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@7|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@7|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@7|)))
))) (=> (forall ((|l#1@@8| T@U) ) (!  (=> (and ($Is refType |l#1@@8| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@8|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@8|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@8|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@8|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@8|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@8|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@8|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@8|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@8|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@8|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (forall ((|a#1@@3| T@U) (|b#1@@3| T@U) ) (!  (=> (and ($Is refType |a#1@@3| Tclass._module.Lifetime) ($Is refType |b#1@@3| Tclass._module.Lifetime)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@3|))) (and (|_module.Universe.outlives#canCall| $Heap@3 |universe#0| |a#1@@3| |b#1@@3|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@3 |universe#0| |a#1@@3| |b#1@@3|) (|_module.Universe.outlives#canCall| $Heap@4 |universe#0| |a#1@@3| |b#1@@3|)))))
 :qid |_12MutexLifetimelongdfy.202:20|
 :skolemid |1651|
...
)) (= $Heap@4 $Heap@5))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 22)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3) (and (=> (= (ControlFlow 0 2) (- 0 21)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3) (and (=> (= (ControlFlow 0 2) (- 0 20)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#0@@23| T@U) ) (!  (=> (and ($Is refType |o#0@@23| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@23|))) (and (and (and (= (_module.Object.universe |o#0@@23|) |universe#0|) (or (not (= |o#0@@23| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#0@@23|)) (_module.Object.triggerAxioms $Heap@3 |o#0@@23|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1350|
 :pattern ( (_module.Object.triggerAxioms $Heap@3 |o#0@@23|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@3 |o#0@@23|))
 :pattern ( (_module.Object.universe |o#0@@23|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@23|)))
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#0@@24| T@U) ) (!  (=> (and ($Is refType |o#0@@24| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@24|))) (and (and (and (= (_module.Object.universe |o#0@@24|) |universe#0|) (or (not (= |o#0@@24| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#0@@24|)) (_module.Object.triggerAxioms $Heap@3 |o#0@@24|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1350|
 :pattern ( (_module.Object.triggerAxioms $Heap@3 |o#0@@24|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@3 |o#0@@24|))
 :pattern ( (_module.Object.universe |o#0@@24|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@24|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@5 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@5 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@5 |universe#0|) (forall ((|o#1@@10| T@U) ) (!  (=> (and ($Is refType |o#1@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@10|))) (and (and (and (= (_module.Object.universe |o#1@@10|) |universe#0|) (or (not (= |o#1@@10| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@5 |o#1@@10|)) (_module.Object.triggerAxioms $Heap@5 |o#1@@10|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@5 |o#1@@10|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@5 |o#1@@10|))
 :pattern ( (_module.Object.universe |o#1@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@10|)))
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@5 |universe#0|) (forall ((|o#1@@11| T@U) ) (!  (=> (and ($Is refType |o#1@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@11|))) (and (and (and (= (_module.Object.universe |o#1@@11|) |universe#0|) (or (not (= |o#1@@11| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@5 |o#1@@11|)) (_module.Object.triggerAxioms $Heap@5 |o#1@@11|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@5 |o#1@@11|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@5 |o#1@@11|))
...
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|)))) (not ($IsAllocBox ($Box refType |o#2@@0|) Tclass._module.Object $Heap@3)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1354|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|)))
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@5 |universe#0|) (forall ((|o#2@@1| T@U) ) (!  (=> (and ($Is refType |o#2@@1| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@1|)))) (not ($IsAllocBox ($Box refType |o#2@@1|) Tclass._module.Object $Heap@3)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1354|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@1|)))
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@1| T@U) ) (!  (=> (and ($Is refType |o#3@@1| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|)))) (or (forall (($o@@154 T@U) ($f@@93 T@U) ) (!  (=> (or (not (= $o@@154 null)) (not true)) (=> (= $o@@154 |o#3@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@154) $f@@93) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@154) $f@@93))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1356|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@154) $f@@93))
)) (_module.Object.sequenceInv2 $Heap@3 $Heap@5 |o#3@@1|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |1357|
 :pattern ( (_module.Object.sequenceInv2 $Heap@3 $Heap@5 |o#3@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|)))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@2| T@U) ) (!  (=> (and ($Is refType |o#3@@2| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@2|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@2|)))) (or (forall (($o@@155 T@U) ($f@@94 T@U) ) (!  (=> (or (not (= $o@@155 null)) (not true)) (=> (= $o@@155 |o#3@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@155) $f@@94) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@155) $f@@94))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1356|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@155) $f@@94))
)) (_module.Object.sequenceInv2 $Heap@3 $Heap@5 |o#3@@2|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |1357|
 :pattern ( (_module.Object.sequenceInv2 $Heap@3 $Heap@5 |o#3@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@2|)))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4@@1| T@U) ) (!  (=> (and ($Is refType |o#4@@1| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@1|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@3)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#4@@1|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |1358|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#4@@1|) _module.OwnedObject.nonvolatileVersion)))
 ...
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.owner)))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#0@@11| T@U) ) (!  (=> (and ($Is refType |l#0@@11| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@11|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@11|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@11|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@3)) (_module.Lifetime.unchangedNonvolatileFields $Heap@3 $Heap@5 |l#0@@11|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1359|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@3 $Heap@5 |l#0@@11|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@11|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@11|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#0@@12| T@U) ) (!  (=> (and ($Is refType |l#0@@12| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@12|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@12|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@12|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@3)) (_module.Lifetime.unchangedNonvolatileFields $Heap@3 $Heap@5 |l#0@@12|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1359|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@3 $Heap@5 |l#0@@12|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@12|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@12|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@0|))) (and (and (and (= (_module.Object.universe |o#5@@0|) |universe#0|) (or (not (= |o#5@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#5@@0|)) (_module.Object.triggerAxioms $Heap@3 |o#5@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1364|
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#5@@1| T@U) ) (!  (=> (and ($Is refType |o#5@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@1|))) (and (and (and (= (_module.Object.universe |o#5@@1|) |universe#0|) (or (not (= |o#5@@1| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#5@@1|)) (_module.Object.triggerAxioms $Heap@3 |o#5@@1|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1364|
 :pattern ( (_module.Object.triggerAxioms $Heap@3 |o#5@@1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@3 |o#5@@1|))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#7|))) (and (or (forall (($o@@156 T@U) ($f@@95 T@U) ) (!  (=> (or (not (= $o@@156 null)) (not true)) (=> (= $o@@156 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@156) $f@@95) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@156) $f@@95))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@156) $f@@95))
)) (_module.Object.inv $Heap@5 |o#7|)) (or (forall (($o@@157 T@U) ($f@@96 T@U) ) (!  (=> (or (not (= $o@@157 null)) (not true)) (=> (= $o@@157 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@157) $f@@96) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@157) $f@@96))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@157) $f@@96))
)) (_module.Object.inv2 $Heap@3 $Heap@5 |o#7|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |1370|
 :pattern ( (_module.Object.inv2 $Heap@3 $Heap@5 |o#7|))
 :pattern ( (_module.Object.inv $Heap@5 |o#7|))
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (or (forall (($o@@158 T@U) ($f@@97 T@U) ) (!  (=> (or (not (= $o@@158 null)) (not true)) (=> (= $o@@158 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@158) $f@@97) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@158) $f@@97))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@158) $f@@97))
)) (_module.Object.inv $Heap@5 |o#7@@0|)) (or (forall (($o@@159 T@U) ($f@@98 T@U) ) (!  (=> (or (not (= $o@@159 null)) (not true)) (=> (= $o@@159 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@159) $f@@98) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@159) $f@@98))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@159) $f@@98))
)) (_module.Object.inv2 $Heap@3 $Heap@5 |o#7@@0|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |1370|
 :pattern ( (_module.Object.inv2 $Heap@3 $Heap@5 |o#7@@0|))
 :pattern ( (_module.Object.inv $Heap@5 |o#7@@0|))
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@0|))))) (_module.Object.inv $Heap@5 |o#8@@0|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |1371|
 :pattern ( (_module.Object.inv $Heap@5 |o#8@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@0|)))
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@5 |universe#0| |running#0@@3|) (forall ((|o#8@@1| T@U) ) (!  (=> (and ($Is refType |o#8@@1| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@1|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@1|))))) (_module.Object.inv $Heap@5 |o#8@@1|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |1371|
 :pattern ( (_module.Object.inv $Heap@5 |o#8@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@1|)))
)))) (=> (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (=> (and (and (and (|_module.Universe.globalInv#canCall| $Heap@5 |universe#0|) (=> (_module.Universe.globalInv $Heap@5 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@3 $Heap@5 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@5 |universe#0|) (and (_module.Universe.globalInv $Heap@5 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@5 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@5 |o#10@@0|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1379|
 :pattern ( (_module.Object.inv $Heap@5 |o#10@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|)))
)))))) (and (and (|_module.Universe.globalInv2#canCall| $Heap@3 $Heap@5 |universe#0|) (and (_module.Universe.globalInv2 $Heap@3 $Heap@5 |universe#0|) (forall ((|o#11@@0| T@U) ) (!  (=> (and ($Is refType |o#11@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@0|)) (_module.Object.inv2 $Heap@3 $Heap@5 |o#11@@0|)))
 :qid |_12MutexLifetimelongdfy.34:12|
 :skolemid |1381|
 :pattern ( (_module.Object.inv2 $Heap@3 $Heap@5 |o#11@@0|))
...
)))) (= $Heap@5 $Heap@6))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |universe#0| null)) (not true))) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@6) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3) (=> (|_module.Universe.globalSequenceInv2#canCall| $Heap@3 $Heap@6 |universe#0|) (=> (and (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@3 $Heap@6 |universe#0|) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalSequenceInv2#canCall| $Heap@3 $Heap@6 |universe#0|)) (or (_module.Universe.globalSequenceInv2 $Heap@3 $Heap@6 |universe#0|) (forall ((|o#27| T@U) ) (!  (=> (and ($Is refType |o#27| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#27|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#27|)) (_module.Object.sequenceInv2 $Heap@3 $Heap@6 |o#27|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |908|
 :pattern ( (_module.Object.sequenceInv2 $Heap@3 $Heap@6 |o#27|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#27|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#27|)))
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
anon0_correct))
))
(check-sat)
