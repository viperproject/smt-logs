...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split152)
...
)) (= $Heap@13 $Heap@14))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@12)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@12) (= (ControlFlow 0 2) (- 0 1))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@12)))))))
...
(let ((anon0_correct  (=> (and (and (and (and (and (and ($IsGoodHeap $Heap@@132) ($IsHeapAnchor $Heap@@132)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@132))) (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@132)) (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@132)))) (and (and (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@132)) (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@132))) (and (and (=> |defass#lifetime#0| (and ($Is refType |lifetime#0| Tclass._module.Lifetime) ($IsAlloc refType |lifetime#0| Tclass._module.Lifetime $Heap@@132))) true) (= 23 $FunctionContextHeight)))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@132 |universe#0|) (and (_module.Universe.globalInv $Heap@@132 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@132 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@@132 |o#10@@0|))
 ...
 :skolemid |3464|
)))) (and (and (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@222)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@222)) (U_2_bool (Lit boolType (bool_2_U true))))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@222)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@222)) (forall ((|o#0@@18| T@U) ) (!  (=> (and ($Is refType |o#0@@18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@222)) _module.Universe.content)) ($Box refType |o#0@@18|))) (and (and (and (= (_module.Object.universe |o#0@@18|) (_module.Object.universe this@@222)) (or (not (= |o#0@@18| (_module.Object.universe this@@222))) (not true))) (_module.Object.baseFieldsInv $Heap@4 |o#0@@18|)) (_module.Object.triggerAxioms $Heap@4 |o#0@@18|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1380|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@222)) _module.Universe.content)) ($Box refType |o#0@@18|)))
