...
(set-info :boogie-vc-id CheckWellformed$$_module.Universe.outlives)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon14_correct  (=> (= (_module.Universe.outlives ($LS $LZ) $Heap@@13 this@@13 |a#0@@13| |b#0@@13|)  (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |b#0@@13|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@13|)) (exists ((|x#2| T@U) ) (!  (and (and ($Is refType |x#2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#2|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@13 this@@13 |a#0@@13| |x#2| |b#0@@13|))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |1228|
 :pattern ( (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@13 this@@13 |a#0@@13| |x#2| |b#0@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#2|)))
)))) (=> (and (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |b#0@@13|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@13|))) (forall ((|x#2@@0| T@U) ) (!  (=> ($Is refType |x#2@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#2@@0|)) (|_module.Universe.outlivesThrough#canCall| $Heap@@13 this@@13 |a#0@@13| |x#2@@0| |b#0@@13|)))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |1229|
 :pattern ( (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@13 this@@13 |a#0@@13| |x#2@@0| |b#0@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#2@@0|)))
))) ($Is boolType (bool_2_U (_module.Universe.outlives ($LS $LZ) $Heap@@13 this@@13 |a#0@@13| |b#0@@13|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#4@0|) (=> |b$reqreads#4@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#5@2|) (=> |b$reqreads#5@2| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#6@2|)))))))))
(let ((anon13_correct  (=> (= |b$reqreads#6@2| |b$reqreads#6@1|) (=> (and (= |b$reqreads#5@2| |b$reqreads#5@1|) (= (ControlFlow 0 7) 3)) anon14_correct))))
(let ((anon23_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#1@0|))) (= |b$reqreads#5@1| |b$reqreads#5@0|)) (and (= |b$reqreads#6@1| true) (= (ControlFlow 0 13) 7))) anon13_correct)))
(let ((anon23_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#1@0|)) (=> (and (and ($IsAllocBox ($Box refType this@@13) Tclass._module.Universe? $Heap@@13) ($IsAlloc refType |a#0@@13| Tclass._module.Lifetime $Heap@@13)) (and ($IsAlloc refType |x#1@0| Tclass._module.Lifetime $Heap@@13) ($IsAlloc refType |b#0@@13| Tclass._module.Lifetime $Heap@@13))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |a#0@@13|))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#1@0|))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |b#0@@13|))) (=> (and (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |a#0@@13|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#1@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |b#0@@13|))) (= |b$reqreads#6@0| (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@14) alloc)))) (or (or (= $o@@14 this@@13) (and (and ($Is refType $o@@14 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType $o@@14))) (= $f@@0 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@14 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType $o@@14))) (= $f@@0 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.162:66|
 :skolemid |1226|
)))) (and (and (|_module.Universe.outlivesThrough#canCall| $Heap@@13 this@@13 |a#0@@13| |x#1@0| |b#0@@13|) (= |b$reqreads#5@1| |b$reqreads#5@0|)) (and (= |b$reqreads#6@1| |b$reqreads#6@0|) (= (ControlFlow 0 9) 7)))) anon13_correct))))))))
(let ((anon22_Then_correct  (=> (and (and ($Is refType |x#1@0| Tclass._module.Lifetime) ($IsAlloc refType |x#1@0| Tclass._module.Lifetime $Heap@@13)) (= |b$reqreads#5@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@13 _module.Universe.content)))) (and (=> (= (ControlFlow 0 14) 9) anon23_Then_correct) (=> (= (ControlFlow 0 14) 13) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (and (and (not (and ($Is refType |x#1@0| Tclass._module.Lifetime) ($IsAlloc refType |x#1@0| Tclass._module.Lifetime $Heap@@13))) (= |b$reqreads#5@1| true)) (and (= |b$reqreads#6@1| true) (= (ControlFlow 0 8) 7))) anon13_correct)))
(let ((anon21_Then_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |b#0@@13|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@13|))) (and (=> (= (ControlFlow 0 15) 14) anon22_Then_correct) (=> (= (ControlFlow 0 15) 8) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |b#0@@13|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@13|)) (= |b$reqreads#6@2| true)) (and (= |b$reqreads#5@2| true) (= (ControlFlow 0 6) 3))) anon14_correct)))
(let ((anon20_Else_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (= |b#0@@13| null)) (not true))) (=> (or (not (= |b#0@@13| null)) (not true)) (=> (= |b$reqreads#4@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |b#0@@13| _module.Lifetime.mightPointTo))) (and (=> (= (ControlFlow 0 16) 15) anon21_Then_correct) (=> (= (ControlFlow 0 16) 6) anon21_Else_correct)))))))
(let ((anon20_Then_correct true))
(let ((anon7_correct  (and (=> (= (ControlFlow 0 18) (- 0 20)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (and (=> (= (ControlFlow 0 18) (- 0 19)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (and (=> (= (ControlFlow 0 18) 1) anon20_Then_correct) (=> (= (ControlFlow 0 18) 16) anon20_Else_correct))))))))
(let ((anon19_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |l#1@0|))) (=> (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= (ControlFlow 0 23) 18)) anon7_correct))))
(let ((anon19_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |l#1@0|)) (=> (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= (ControlFlow 0 22) 18)) anon7_correct))))
(let ((anon18_Then_correct  (=> (and (and ($Is refType |l#1@0| Tclass._module.Lifetime) ($IsAlloc refType |l#1@0| Tclass._module.Lifetime $Heap@@13)) (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@13 _module.Universe.content)))) (and (=> (= (ControlFlow 0 24) 22) anon19_Then_correct) (=> (= (ControlFlow 0 24) 23) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not (and ($Is refType |l#1@0| Tclass._module.Lifetime) ($IsAlloc refType |l#1@0| Tclass._module.Lifetime $Heap@@13))) (=> (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 21) 18)) anon7_correct))))
(let ((anon17_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |l#0@0|))) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (=> (= (ControlFlow 0 27) 24) anon18_Then_correct) (=> (= (ControlFlow 0 27) 21) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |l#0@0|)) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (=> (= (ControlFlow 0 26) 24) anon18_Then_correct) (=> (= (ControlFlow 0 26) 21) anon18_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (and ($Is refType |l#0@0| Tclass._module.Lifetime) ($IsAlloc refType |l#0@0| Tclass._module.Lifetime $Heap@@13)) (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@13 _module.Universe.content)))) (and (=> (= (ControlFlow 0 28) 26) anon17_Then_correct) (=> (= (ControlFlow 0 28) 27) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and ($Is refType |l#0@0| Tclass._module.Lifetime) ($IsAlloc refType |l#0@0| Tclass._module.Lifetime $Heap@@13))) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 25) 24) anon18_Then_correct) (=> (= (ControlFlow 0 25) 21) anon18_Else_correct)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#89| null $Heap@@13 alloc this@@13 Tclass._module.Lifetime ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) _module.Lifetime.mightPointTo Tclass._module.Lifetime ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) _module.Lifetime.mightPointFrom)) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@13 _module.Universe.content))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |a#0@@13|))) (and (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@13 _module.Universe.content))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |b#0@@13|)))) (and (=> (= (ControlFlow 0 29) (- 0 31)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 29) (- 0 30)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 29) 28) anon16_Then_correct) (=> (= (ControlFlow 0 29) 25) anon16_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Universe) ($IsAlloc refType this@@13 Tclass._module.Universe $Heap@@13)))) (and (and ($Is refType |a#0@@13| Tclass._module.Lifetime) ($Is refType |b#0@@13| Tclass._module.Lifetime)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 32) 29)))) anon0_correct)))
