...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((anon10_correct  (=> (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 (_module.Object.universe this@@53)) (=> (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 (_module.Object.universe this@@53)) (forall ((|o#7| T@U) ) (!  (=> ($Is refType |o#7| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#7|)) (|_module.Object.sequenceInv2#canCall| $Heap@0 $Heap@1 |o#7|)))
 :qid |_11MutexGuard2legacydfy.295:66|
 :skolemid |1418|
...
(let ((anon5_correct  (=> (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@30 $Heap@0 (_module.Object.universe this@@53)) (=> (_module.Universe.baseLegalTransitionsSequence $Heap@@30 $Heap@0 (_module.Object.universe this@@53)) (forall ((|o#5| T@U) ) (!  (=> ($Is refType |o#5| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#5|)) (|_module.Object.sequenceInv2#canCall| $Heap@@30 $Heap@0 |o#5|)))
 :qid |_11MutexGuard2legacydfy.292:62|
 :skolemid |1415|
...
)))) (and (=> (= (ControlFlow 0 14) (- 0 20)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@53) null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 19)) (forall (($o@@43 T@U) ($f@@23 T@U) ) (!  (=> (and (and (or (not (= $o@@43 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@43) alloc)))) (or (= $o@@43 (_module.Object.universe this@@53)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType $o@@43)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@43 $f@@23)))
 :qid |_11MutexGuard2legacydfy.294:19|
 :skolemid |1417|
...
(let ((anon13_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#4@0|))) (= (ControlFlow 0 26) 14)) anon5_correct)))
(let ((anon13_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#4@0|)) (and (=> (= (ControlFlow 0 23) (- 0 25)) (or (not (= |o#4@0| null)) (not true))) (=> ($IsAllocBox ($Box refType |o#4@0|) Tclass._module.Object? $Heap@0) (and (=> (= (ControlFlow 0 23) (- 0 24)) ($IsAlloc refType |o#4@0| Tclass._module.Object $Heap@@30)) (=> ($IsAlloc refType |o#4@0| Tclass._module.Object $Heap@@30) (=> (and (|_module.Object.sequenceInv2#canCall| $Heap@@30 $Heap@0 |o#4@0|) (= (ControlFlow 0 23) 14)) anon5_correct))))))))
(let ((anon12_Then_correct  (=> (and ($Is refType |o#4@0| Tclass._module.Object) ($IsAlloc refType |o#4@0| Tclass._module.Object $Heap@0)) (and (=> (= (ControlFlow 0 27) (- 0 30)) ($IsAlloc refType this@@53 Tclass._module.Thread $Heap@@30)) (=> ($IsAlloc refType this@@53 Tclass._module.Thread $Heap@@30) (and (=> (= (ControlFlow 0 27) (- 0 29)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (and (=> (= (ControlFlow 0 27) (- 0 28)) ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@30)) (=> ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@30) (and (=> (= (ControlFlow 0 27) 23) anon13_Then_correct) (=> (= (ControlFlow 0 27) 26) anon13_Else_correct))))))))))
(let ((anon12_Else_correct  (=> (and (not (and ($Is refType |o#4@0| Tclass._module.Object) ($IsAlloc refType |o#4@0| Tclass._module.Object $Heap@0))) (= (ControlFlow 0 22) 14)) anon5_correct)))
(let ((anon11_Then_correct  (=> (_module.Universe.baseLegalTransitionsSequence $Heap@@30 $Heap@0 (_module.Object.universe this@@53)) (and (=> (= (ControlFlow 0 31) 27) anon12_Then_correct) (=> (= (ControlFlow 0 31) 22) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not (_module.Universe.baseLegalTransitionsSequence $Heap@@30 $Heap@0 (_module.Object.universe this@@53))) (= (ControlFlow 0 21) 14)) anon5_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@30 alloc (_module.Object.universe this@@53) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)))) (and (=> (= (ControlFlow 0 32) (- 0 38)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@53) null)) (not true)) (and (=> (= (ControlFlow 0 32) (- 0 37)) (forall (($o@@46 T@U) ($f@@25 T@U) ) (!  (=> (and (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 $o@@46) alloc)))) (or (= $o@@46 (_module.Object.universe this@@53)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType $o@@46)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@46 $f@@25)))
 :qid |_11MutexGuard2legacydfy.291:19|
 :skolemid |1414|
...
)) ($HeapSucc $Heap@@30 $Heap@0)))) (and (=> (= (ControlFlow 0 32) (- 0 34)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@53)) Tclass._module.Universe? $Heap@0) (and (=> (= (ControlFlow 0 32) (- 0 33)) ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@30)) (=> ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@30) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@30 $Heap@0 (_module.Object.universe this@@53)) (and (=> (= (ControlFlow 0 32) 31) anon11_Then_correct) (=> (= (ControlFlow 0 32) 21) anon11_Else_correct)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@30) ($IsHeapAnchor $Heap@@30)) (=> (and (and (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Thread) ($IsAlloc refType this@@53 Tclass._module.Thread $Heap@@30))) (= 15 $FunctionContextHeight)) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@@30 this@@53) (and (_module.Object.objectGlobalInv $Heap@@30 this@@53) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType this@@53)) (_module.Universe.globalInv $Heap@@30 (_module.Object.universe this@@53))))) (= (ControlFlow 0 39) 32))) anon0_correct))))
