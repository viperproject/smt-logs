...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split178)
...
))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 call5formal@this@0) alloc)))) (forall (($o@@145 T@U) ) (!  (=> (and (or (not (= $o@@145 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@145) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@145) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@145)) (or (= $o@@145 |universe#0|) (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@145)))))
 :qid |_12MutexLifetimeshortdfy.609:3|
 :skolemid |2311|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@145))
)))) (and (and (forall (($o@@146 T@U) ($f@@87 T@U) ) (!  (=> (and (or (not (= $o@@146 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@146) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@146) $f@@87) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@146) $f@@87)) (or (= $o@@146 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@146)) (= $f@@87 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimeshortdfy.609:3|
 :skolemid |2312|
...
))))))))) (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@@132 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@132 $Heap@1 |universe#0| |running#0@@3|) (forall ((|o#7@@1| T@U) ) (!  (=> (and ($Is refType |o#7@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@1|))) (and (or (forall (($o@@148 T@U) ($f@@89 T@U) ) (!  (=> (or (not (= $o@@148 null)) (not true)) (=> (= $o@@148 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@148) $f@@89) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@148) $f@@89))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1013|
