...
(assert (forall (($prevHeap@@3 T@U) ($h0@@2 T@U) ($h1@@2 T@U) (this@@4 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.Remaining))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@2 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 this@@4)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@2) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@2) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |1888|
)) (= (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@3 $h0@@2 this@@4) (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@3 $h1@@2 this@@4))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1890|
 :pattern ( ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2) (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@3 $h1@@2 this@@4))
)))
...
(assert (forall (($o@@4 T@U) ) (! (= ($Is refType $o@@4 Tclass._module.Remaining?)  (or (= $o@@4 null) (= (dtype $o@@4) Tclass._module.Remaining?)))
 :qid |unknown.0:0|
 :skolemid |1884|
 :pattern ( ($Is refType $o@@4 Tclass._module.Remaining?))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.Remaining.baseUserInv#canCall| $Heap@@2 this@@8) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.Remaining)))) (= (_module.OwnedObject.baseUserInv $Heap@@2 this@@8) (_module.Remaining.baseUserInv $Heap@@2 this@@8)))
 :qid |_07CounterThreadOwnershipdfy.384:19|
 :skolemid |1908|
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@2 this@@8) ($Is refType this@@8 Tclass._module.Remaining) ($IsGoodHeap $Heap@@2))
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@2 this@@8) (_module.Remaining.baseUserInv $Heap@@2 this@@8) ($IsGoodHeap $Heap@@2))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.Remaining.localUserInv#canCall| $Heap@@3 this@@9) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.Remaining)))) (= (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.Remaining.localUserInv $Heap@@3 this@@9)))
 :qid |_07CounterThreadOwnershipdfy.385:19|
 :skolemid |1915|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) ($Is refType this@@9 Tclass._module.Remaining) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.Remaining.localUserInv $Heap@@3 this@@9) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.Remaining.userInv#canCall| $Heap@@4 this@@10) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.Remaining)))) (= (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.Remaining.userInv $Heap@@4 this@@10)))
 :qid |_07CounterThreadOwnershipdfy.387:19|
 :skolemid |1922|
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) ($Is refType this@@10 Tclass._module.Remaining) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.Remaining.userInv $Heap@@4 this@@10) ($IsGoodHeap $Heap@@4))
))))
...
(assert (forall (($prevHeap@@18 T@U) ($h0@@17 T@U) ($h1@@17 T@U) (this@@27 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Remaining) ($IsAlloc refType this@@27 Tclass._module.Remaining $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@20 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@20) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@20) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@20) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |1925|
)) (= (_module.Remaining.localUserInv2 $prevHeap@@18 $h0@@17 this@@27) (_module.Remaining.localUserInv2 $prevHeap@@18 $h1@@17 this@@27))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1926|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.Remaining.localUserInv2 $prevHeap@@18 $h1@@17 this@@27))
)))
(assert (forall (($prevHeap@@19 T@U) ($h0@@18 T@U) ($h1@@18 T@U) (this@@28 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Remaining) ($IsAlloc refType this@@28 Tclass._module.Remaining $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@21 T@U) ($f@@18 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@21) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@21) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@21) $f@@18)))
 :qid |unknown.0:0|
 :skolemid |1932|
)) (= (_module.Remaining.userInv2 $prevHeap@@19 $h0@@18 this@@28) (_module.Remaining.userInv2 $prevHeap@@19 $h1@@18 this@@28))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1933|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.Remaining.userInv2 $prevHeap@@19 $h1@@18 this@@28))
)))
...
(assert (forall (($o@@26 T@U) ($h@@12 T@U) ) (! (= ($IsAlloc refType $o@@26 Tclass._module.Remaining? $h@@12)  (or (= $o@@26 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@26) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1885|
 :pattern ( ($IsAlloc refType $o@@26 Tclass._module.Remaining? $h@@12))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Remaining.baseUserInv#canCall| $Heap@@9 this@@29) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Remaining) ($IsAlloc refType this@@29 Tclass._module.Remaining $Heap@@9)))))) (= (_module.Remaining.baseUserInv $Heap@@9 this@@29) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.551:19|
 :skolemid |1907|
 :pattern ( (_module.Remaining.baseUserInv $Heap@@9 this@@29) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Remaining.localUserInv#canCall| $Heap@@10 this@@30) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Remaining) ($IsAlloc refType this@@30 Tclass._module.Remaining $Heap@@10)))))) (= (_module.Remaining.localUserInv $Heap@@10 this@@30) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.555:19|
 :skolemid |1914|
 :pattern ( (_module.Remaining.localUserInv $Heap@@10 this@@30) ($IsGoodHeap $Heap@@10))
))))
...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($prevHeap@@24 T@U) ($Heap@@15 T@U) (this@@35 T@U) (|running#0@@2| T@U) ) (!  (=> (or (|_module.Universe.legalTransition#canCall| $prevHeap@@24 $Heap@@15 this@@35 |running#0@@2|) (and (< 10 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@24) ($IsGoodHeap $Heap@@15)) ($HeapSucc $prevHeap@@24 $Heap@@15)) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.Universe) ($IsAlloc refType this@@35 Tclass._module.Universe $prevHeap@@24)))) ($Is refType |running#0@@2| Tclass._module.Thread)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@24 $Heap@@15 this@@35 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (=> (_module.Universe.legalTransitionsSequence $prevHeap@@24 $Heap@@15 this@@35 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (and (|_module.Universe.globalInv#canCall| $prevHeap@@24 this@@35) (=> (_module.Universe.globalInv $prevHeap@@24 this@@35) (and (|_module.Universe.globalBaseInv#canCall| $Heap@@15 this@@35) (=> (_module.Universe.globalBaseInv $Heap@@15 this@@35) (and (forall ((|o#0@@2| T@U) ) (!  (=> ($Is refType |o#0@@2| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#0@@2|)) (and (=> (not (forall (($o@@27 T@U) ($f@@19 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 |o#0@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@27) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 $o@@27) $f@@19))))
...
))) (|_module.Object.inv#canCall| $Heap@@15 |o#0@@2|)) (=> (or (forall (($o@@28 T@U) ($f@@20 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 |o#0@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@28) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 $o@@28) $f@@20))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |573|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@28) $f@@20))
)) (_module.Object.inv $Heap@@15 |o#0@@2|)) (=> (not (forall (($o@@29 T@U) ($f@@21 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 |o#0@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@29) $f@@21) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 $o@@29) $f@@21))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |572|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@29) $f@@21))
))) (|_module.Object.inv2#canCall| $prevHeap@@24 $Heap@@15 |o#0@@2|))))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |574|
 :pattern ( (_module.Object.inv2 $prevHeap@@24 $Heap@@15 |o#0@@2|))
 :pattern ( (_module.Object.inv $Heap@@15 |o#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#0@@2|)))
)) (=> (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#0@@3|))) (and (or (forall (($o@@30 T@U) ($f@@22 T@U) ) (!  (=> (or (not (= $o@@30 null)) (not true)) (=> (= $o@@30 |o#0@@3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@30) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 $o@@30) $f@@22))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |576|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@30) $f@@22))
)) (_module.Object.inv $Heap@@15 |o#0@@3|)) (or (forall (($o@@31 T@U) ($f@@23 T@U) ) (!  (=> (or (not (= $o@@31 null)) (not true)) (=> (= $o@@31 |o#0@@3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@31) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 $o@@31) $f@@23))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |577|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@31) $f@@23))
)) (_module.Object.inv2 $prevHeap@@24 $Heap@@15 |o#0@@3|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |578|
 :pattern ( (_module.Object.inv2 $prevHeap@@24 $Heap@@15 |o#0@@3|))
 :pattern ( (_module.Object.inv $Heap@@15 |o#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#0@@3|)))
)) (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.Object) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@35) _module.Universe.content)) ($Box refType |o#1|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#1|)))) (|_module.Object.inv#canCall| $Heap@@15 |o#1|)))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |575|
 :pattern ( (_module.Object.inv $Heap@@15 |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#1|)))
...
)))))))))) (= (_module.Universe.legalTransition $prevHeap@@24 $Heap@@15 this@@35 |running#0@@2|)  (and (and (and (and (_module.Universe.legalTransitionsSequence $prevHeap@@24 $Heap@@15 this@@35 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (_module.Universe.globalInv $prevHeap@@24 this@@35)) (_module.Universe.globalBaseInv $Heap@@15 this@@35)) (forall ((|o#0@@4| T@U) ) (!  (=> (and ($Is refType |o#0@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#0@@4|))) (and (or (forall (($o@@32 T@U) ($f@@24 T@U) ) (!  (=> (or (not (= $o@@32 null)) (not true)) (=> (= $o@@32 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@32) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 $o@@32) $f@@24))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |567|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@32) $f@@24))
)) (_module.Object.inv $Heap@@15 |o#0@@4|)) (or (forall (($o@@33 T@U) ($f@@25 T@U) ) (!  (=> (or (not (= $o@@33 null)) (not true)) (=> (= $o@@33 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@33) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 $o@@33) $f@@25))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |568|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@33) $f@@25))
)) (_module.Object.inv2 $prevHeap@@24 $Heap@@15 |o#0@@4|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |569|
 :pattern ( (_module.Object.inv2 $prevHeap@@24 $Heap@@15 |o#0@@4|))
 :pattern ( (_module.Object.inv $Heap@@15 |o#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#0@@4|)))
))) (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@35) _module.Universe.content)) ($Box refType |o#1@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#1@@0|))))) (_module.Object.inv $Heap@@15 |o#1@@0|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |570|
 :pattern ( (_module.Object.inv $Heap@@15 |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@35) _module.Universe.content)) ($Box refType |o#1@@0|)))
 ...
 :skolemid |579|
 :pattern ( (_module.Universe.legalTransition $prevHeap@@24 $Heap@@15 this@@35 |running#0@@2|) ($IsGoodHeap $Heap@@15))
))))
(assert (forall (($h@@13 T@U) ($o@@34 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@34 null)) (not true)) (= (dtype $o@@34) Tclass._module.Remaining?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@34) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@34) _module.Remaining.value)) TInt $h@@13))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1887|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@34) _module.Remaining.value)))
)))
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@16 this@@36) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.OwnedObject) ($IsAlloc refType this@@36 Tclass._module.OwnedObject $Heap@@16)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@16 this@@36) (=> (_module.OwnedObject.localInv $Heap@@16 this@@36) (|_module.OwnedObject.userInv#canCall| $Heap@@16 this@@36))) (= (_module.OwnedObject.inv $Heap@@16 this@@36)  (and (_module.OwnedObject.localInv $Heap@@16 this@@36) (_module.OwnedObject.userInv $Heap@@16 this@@36)))))
 :qid |_07CounterThreadOwnershipdfy.333:19|
 :skolemid |1313|
 :pattern ( (_module.OwnedObject.inv $Heap@@16 this@@36) ($IsGoodHeap $Heap@@16))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@25 T@U) ($Heap@@17 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.Remaining.unchangedNonvolatileUserFields#canCall| $prevHeap@@25 $Heap@@17 this@@37) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@25) ($IsGoodHeap $Heap@@17)) ($HeapSucc $prevHeap@@25 $Heap@@17)) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.Remaining) ($IsAlloc refType this@@37 Tclass._module.Remaining $prevHeap@@25)))))) (= (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@25 $Heap@@17 this@@37)  (and true (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@25 this@@37) _module.Remaining.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@37) _module.Remaining.value)))))))
 :qid |_07CounterThreadOwnershipdfy.546:22|
 :skolemid |1893|
 :pattern ( (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@25 $Heap@@17 this@@37) ($IsGoodHeap $Heap@@17))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@28 T@U) ($Heap@@20 T@U) (this@@40 T@U) ) (!  (=> (or (|_module.Remaining.unchangedNonvolatileUserFields#canCall| $prevHeap@@28 $Heap@@20 this@@40) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.Remaining)))) (= (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@28 $Heap@@20 this@@40) (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@28 $Heap@@20 this@@40)))
 :qid |_07CounterThreadOwnershipdfy.383:22|
 :skolemid |1894|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@28 $Heap@@20 this@@40) ($Is refType this@@40 Tclass._module.Remaining) ($IsGoodHeap $Heap@@20))
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@28 $Heap@@20 this@@40) (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@28 $Heap@@20 this@@40) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@29 T@U) ($Heap@@21 T@U) (this@@41 T@U) ) (!  (=> (or (|_module.Remaining.localUserInv2#canCall| $prevHeap@@29 $Heap@@21 this@@41) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@41 null)) (not true)) ($Is refType this@@41 Tclass._module.Remaining)))) (= (_module.OwnedObject.localUserInv2 $prevHeap@@29 $Heap@@21 this@@41) (_module.Remaining.localUserInv2 $prevHeap@@29 $Heap@@21 this@@41)))
 :qid |_07CounterThreadOwnershipdfy.386:22|
 :skolemid |1930|
 :pattern ( (_module.OwnedObject.localUserInv2 $prevHeap@@29 $Heap@@21 this@@41) ($Is refType this@@41 Tclass._module.Remaining) ($IsGoodHeap $Heap@@21))
 :pattern ( (_module.OwnedObject.localUserInv2 $prevHeap@@29 $Heap@@21 this@@41) (_module.Remaining.localUserInv2 $prevHeap@@29 $Heap@@21 this@@41) ($IsGoodHeap $Heap@@21))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@31 T@U) ($Heap@@23 T@U) (this@@43 T@U) ) (!  (=> (or (|_module.Remaining.userInv2#canCall| $prevHeap@@31 $Heap@@23 this@@43) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@43 null)) (not true)) ($Is refType this@@43 Tclass._module.Remaining)))) (= (_module.OwnedObject.userInv2 $prevHeap@@31 $Heap@@23 this@@43) (_module.Remaining.userInv2 $prevHeap@@31 $Heap@@23 this@@43)))
 :qid |_07CounterThreadOwnershipdfy.388:22|
 :skolemid |1937|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@31 $Heap@@23 this@@43) ($Is refType this@@43 Tclass._module.Remaining) ($IsGoodHeap $Heap@@23))
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@31 $Heap@@23 this@@43) (_module.Remaining.userInv2 $prevHeap@@31 $Heap@@23 this@@43) ($IsGoodHeap $Heap@@23))
))))
...
(assert (forall ((|c#0@@8| T@U) ) (! (= ($Is refType |c#0@@8| Tclass._module.Remaining)  (and ($Is refType |c#0@@8| Tclass._module.Remaining?) (or (not (= |c#0@@8| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |2119|
 :pattern ( ($Is refType |c#0@@8| Tclass._module.Remaining))
 :pattern ( ($Is refType |c#0@@8| Tclass._module.Remaining?))
)))
...
(assert (forall (($o@@39 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@39 Tclass._module.Remaining? $heap@@1) ($IsAlloc refType $o@@39 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |3535|
 :pattern ( ($IsAlloc refType $o@@39 Tclass._module.Remaining? $heap@@1))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@37 T@U) ($Heap@@30 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.Remaining.userInv2#canCall| $prevHeap@@37 $Heap@@30 this@@50) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@37) ($IsGoodHeap $Heap@@30)) ($HeapSucc $prevHeap@@37 $Heap@@30)) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.Remaining) ($IsAlloc refType this@@50 Tclass._module.Remaining $prevHeap@@37)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Remaining.localUserInv2#canCall| $prevHeap@@37 $Heap@@30 this@@50)) (= (_module.Remaining.userInv2 $prevHeap@@37 $Heap@@30 this@@50)  (and true (_module.Remaining.localUserInv2 $prevHeap@@37 $Heap@@30 this@@50)))))
 :qid |_07CounterThreadOwnershipdfy.565:22|
 :skolemid |1936|
 :pattern ( (_module.Remaining.userInv2 $prevHeap@@37 $Heap@@30 this@@50) ($IsGoodHeap $Heap@@30))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@38 T@U) ($Heap@@31 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@38 $Heap@@31 this@@51) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@38) ($IsGoodHeap $Heap@@31)) ($HeapSucc $prevHeap@@38 $Heap@@31)) (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.OwnedObject) ($IsAlloc refType this@@51 Tclass._module.OwnedObject $prevHeap@@38)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.localUserInv2#canCall| $prevHeap@@38 $Heap@@31 this@@51)) (= (_module.OwnedObject.localInv2 $prevHeap@@38 $Heap@@31 this@@51)  (and true (_module.OwnedObject.localUserInv2 $prevHeap@@38 $Heap@@31 this@@51)))))
 :qid |_07CounterThreadOwnershipdfy.338:22|
 :skolemid |1326|
 :pattern ( (_module.OwnedObject.localInv2 $prevHeap@@38 $Heap@@31 this@@51) ($IsGoodHeap $Heap@@31))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@39 T@U) ($Heap@@32 T@U) (this@@52 T@U) ) (!  (=> (or (|_module.Remaining.localUserInv2#canCall| $prevHeap@@39 $Heap@@32 this@@52) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@39) ($IsGoodHeap $Heap@@32)) ($HeapSucc $prevHeap@@39 $Heap@@32)) (and (or (not (= this@@52 null)) (not true)) (and ($Is refType this@@52 Tclass._module.Remaining) ($IsAlloc refType this@@52 Tclass._module.Remaining $prevHeap@@39)))))) (= (_module.Remaining.localUserInv2 $prevHeap@@39 $Heap@@32 this@@52) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.562:22|
 :skolemid |1929|
 :pattern ( (_module.Remaining.localUserInv2 $prevHeap@@39 $Heap@@32 this@@52) ($IsGoodHeap $Heap@@32))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@54 T@U) ) (!  (=> (or (|_module.Remaining.userInv#canCall| $Heap@@34 this@@54) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.Remaining) ($IsAlloc refType this@@54 Tclass._module.Remaining $Heap@@34)))))) (=> (_module.Remaining.userInv $Heap@@34 this@@54) (_module.Remaining.localUserInv $Heap@@34 this@@54)))
 :qid |_07CounterThreadOwnershipdfy.558:19|
 :skolemid |1919|
 :pattern ( (_module.Remaining.userInv $Heap@@34 this@@54))
))))
...
(assert (forall (($h@@16 T@U) ($o@@43 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@43 null)) (not true)) (= (dtype $o@@43) Tclass._module.Remaining?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@43) _module.Remaining.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1886|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@43) _module.Remaining.value)))
)))
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@73 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@73 null)) (not true)) (and ($Is refType this@@73 Tclass._module.Remaining) ($IsAlloc refType this@@73 Tclass._module.Remaining $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@58 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@58) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@58) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@58) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1903|
)) (= (_module.Remaining.baseUserInv $h0@@31 this@@73) (_module.Remaining.baseUserInv $h1@@31 this@@73))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1904|
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.Remaining.baseUserInv $h1@@31 this@@73))
)))
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@74 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.Remaining) ($IsAlloc refType this@@74 Tclass._module.Remaining $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@59 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@59) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@59) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@59) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1910|
)) (= (_module.Remaining.localUserInv $h0@@32 this@@74) (_module.Remaining.localUserInv $h1@@32 this@@74))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1911|
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.Remaining.localUserInv $h1@@32 this@@74))
)))
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@75 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@75 null)) (not true)) (and ($Is refType this@@75 Tclass._module.Remaining) ($IsAlloc refType this@@75 Tclass._module.Remaining $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@60 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@60 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@60) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@60) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@60) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1917|
)) (= (_module.Remaining.userInv $h0@@33 this@@75) (_module.Remaining.userInv $h1@@33 this@@75))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1918|
 :pattern ( ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33) (_module.Remaining.userInv $h1@@33 this@@75))
)))
...
(assert (forall (($o@@63 T@U) ) (!  (=> ($Is refType $o@@63 Tclass._module.Remaining?) ($Is refType $o@@63 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3534|
 :pattern ( ($Is refType $o@@63 Tclass._module.Remaining?))
)))
(assert (forall ((bx@@19 T@U) ) (!  (=> ($IsBox bx@@19 Tclass._module.Remaining?) ($IsBox bx@@19 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3532|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@43 T@U) ($Heap@@42 T@U) (this@@77 T@U) ) (!  (=> (or (|_module.Remaining.userInv2#canCall| $prevHeap@@43 $Heap@@42 this@@77) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@43) ($IsGoodHeap $Heap@@42)) ($HeapSucc $prevHeap@@43 $Heap@@42)) (and (or (not (= this@@77 null)) (not true)) (and ($Is refType this@@77 Tclass._module.Remaining) ($IsAlloc refType this@@77 Tclass._module.Remaining $prevHeap@@43)))))) (=> (_module.Remaining.userInv2 $prevHeap@@43 $Heap@@42 this@@77) (_module.Remaining.localUserInv2 $prevHeap@@43 $Heap@@42 this@@77)))
 :qid |_07CounterThreadOwnershipdfy.565:22|
 :skolemid |1934|
 :pattern ( (_module.Remaining.userInv2 $prevHeap@@43 $Heap@@42 this@@77))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@44 T@U) (this@@79 T@U) ) (!  (=> (or (|_module.Remaining.userInv#canCall| $Heap@@44 this@@79) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@44) (and (or (not (= this@@79 null)) (not true)) (and ($Is refType this@@79 Tclass._module.Remaining) ($IsAlloc refType this@@79 Tclass._module.Remaining $Heap@@44)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Remaining.localUserInv#canCall| $Heap@@44 this@@79)) (= (_module.Remaining.userInv $Heap@@44 this@@79)  (and true (_module.Remaining.localUserInv $Heap@@44 this@@79)))))
 :qid |_07CounterThreadOwnershipdfy.558:19|
 :skolemid |1921|
 :pattern ( (_module.Remaining.userInv $Heap@@44 this@@79) ($IsGoodHeap $Heap@@44))
))))
...
(set-info :boogie-vc-id Impl$$_module.Remaining.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@84) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@84) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@84) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@84)))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@84) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@84))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@84) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@84) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@84) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@84) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@84) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@84) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@84))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@84) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@84) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@84)))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@84) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.nonvolatileVersion)))) (forall ((|o#47| T@U) ) (!  (=> (and ($Is refType |o#47| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#47|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47|) _module.OwnedObject.owner)) this@@84))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47|) _module.OwnedObject.owner)) this@@84)))
 :qid |_07CounterThreadOwnershipdfy.349:18|
 :skolemid |2054|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#47|)))
)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@84) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.nonvolatileVersion)))) (forall ((|o#47@@0| T@U) ) (!  (=> (and ($Is refType |o#47@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#47@@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47@@0|) _module.OwnedObject.owner)) this@@84))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47@@0|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47@@0|) _module.OwnedObject.owner)) this@@84)))
 :qid |_07CounterThreadOwnershipdfy.349:18|
 :skolemid |2054|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#47@@0|)))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@84) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner))))
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.nonvolatileVersion)))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@84) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner))))
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.nonvolatileVersion))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@84)))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@84))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))) (not true)) (let ((|currOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1|) Tclass._module.Object previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@84) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@84) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@84) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))) (not true)) (let ((|currOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1@@0|) Tclass._module.Object previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (=> (|_module.Object.baseInv#canCall| current$Heap this@@84) (or (_module.Object.baseInv current$Heap this@@84) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType this@@84))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (=> (|_module.Object.baseInv#canCall| current$Heap this@@84) (or (_module.Object.baseInv current$Heap this@@84) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType this@@84)))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (=> (|_module.Object.baseInv#canCall| current$Heap this@@84) (or (_module.Object.baseInv current$Heap this@@84) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@84)) (forall ((|o#48| T@U) ) (!  (=> (and ($Is refType |o#48| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#48|))) (and (= (_module.Object.universe |o#48|) (_module.Object.universe this@@84)) (or (not (= |o#48| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2056|
 :pattern ( (_module.Object.universe |o#48|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#48|)))
))))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (=> (|_module.Object.baseInv#canCall| current$Heap this@@84) (or (_module.Object.baseInv current$Heap this@@84) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@84)) (forall ((|o#48@@0| T@U) ) (!  (=> (and ($Is refType |o#48@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#48@@0|))) (and (= (_module.Object.universe |o#48@@0|) (_module.Object.universe this@@84)) (or (not (= |o#48@@0| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2056|
 :pattern ( (_module.Object.universe |o#48@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#48@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@84) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (_module.OwnedObject.baseUserInv current$Heap this@@84)))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (_module.OwnedObject.baseUserInv current$Heap this@@84))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (_module.OwnedObject.localUserInv current$Heap this@@84)))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@84) (or (_module.OwnedObject.localInv current$Heap this@@84) (_module.OwnedObject.localUserInv current$Heap this@@84))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@84) (or (_module.OwnedObject.inv current$Heap this@@84) (_module.OwnedObject.userInv current$Heap this@@84)))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@49) ($IsHeapAnchor $Heap@@49)) (and (or (not (= this@@84 null)) (not true)) (and ($Is refType this@@84 Tclass._module.Remaining) ($IsAlloc refType this@@84 Tclass._module.Remaining previous$Heap)))) (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap@@49) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (and (and (|_module.Object.goodPreAndLegalChanges#canCall| previous$Heap current$Heap this@@84 |running#0@@5|) (and (_module.Object.goodPreAndLegalChanges previous$Heap current$Heap this@@84 |running#0@@5|) (and (and (and (and (_module.Object.baseInv previous$Heap this@@84) (_module.Universe.globalInv previous$Heap (_module.Object.universe this@@84))) (_module.Object.baseInv current$Heap this@@84)) (forall (($o@@70 T@U) ($f@@44 T@U) ) (!  (=> (or (not (= $o@@70 null)) (not true)) (=> (= $o@@70 this@@84) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@70) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@70) $f@@44))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |2053|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@70) $f@@44))
))) (_module.Universe.legalTransition previous$Heap current$Heap (_module.Object.universe this@@84) |running#0@@5|)))) (= (ControlFlow 0 19) 2)))) anon0_correct)))
