...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split2)
...
)))))) (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |running#0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType |mutex#0|))) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@44 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)))) (or (not (= |universe#0| null)) (not true)))) (and (and (forall (($o@@40 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@40 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 $o@@40) alloc)))) (or (= $o@@40 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 |universe#0|) _module.Universe.content)) ($Box refType $o@@40)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@40 $f@@0)))
 :qid |_11MutexGuard2legacydfy.659:24|
 :skolemid |569|
)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalInv#canCall| $Heap@@44 |universe#0|)))) (or (_module.Universe.globalInv $Heap@@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@44 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
