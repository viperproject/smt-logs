...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@14 this@@17) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.OwnedObject) ($IsAlloc refType this@@17 Tclass._module.OwnedObject $Heap@@14)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@14 this@@17) (=> (_module.Object.objectGlobalBaseInv $Heap@@14 this@@17) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 (_module.OwnedObject.lifetime this@@17)) _module.Lifetime.elements)) ($Box refType this@@17)) (and (|_module.Lifetime.alive#canCall| $Heap@@14 (_module.OwnedObject.lifetime this@@17)) (=> (=> (_module.Lifetime.alive $Heap@@14 (_module.OwnedObject.lifetime this@@17)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@17) _module.OwnedObject.owner)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@17) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.localUserInv#canCall| $Heap@@14 this@@17))))))) (= (_module.OwnedObject.localInv $Heap@@14 this@@17)  (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@14 this@@17) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 (_module.OwnedObject.lifetime this@@17)) _module.Lifetime.elements)) ($Box refType this@@17))) (=> (_module.Lifetime.alive $Heap@@14 (_module.OwnedObject.lifetime this@@17)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@17) _module.OwnedObject.owner)) null)) (not true)))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@17) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv $Heap@@14 this@@17))))))
 :qid |_12MutexLifetimelongdfy.443:19|
 :skolemid |2153|
 :pattern ( (_module.OwnedObject.localInv $Heap@@14 this@@17) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@15 this@@28) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Lifetime) ($IsAlloc refType this@@28 Tclass._module.Lifetime $Heap@@15)))))) (= (_module.Lifetime.alive $Heap@@15 this@@28)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@28) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@15 this@@28) ($IsGoodHeap $Heap@@15))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@16 this@@29) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Lifetime) ($IsAlloc refType this@@29 Tclass._module.Lifetime $Heap@@16)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@16 this@@29)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@29) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 (_module.Object.universe this@@29)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@29) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@29) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 (_module.Object.universe this@@29)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@29) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 (_module.Object.universe this@@29)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@29) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 (_module.Object.universe this@@29)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@16 this@@29) ($IsGoodHeap $Heap@@16))
))))
(push 1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= OwnedObject_$_ReadsFrame@0 (|lambda#96| null $Heap@@17 alloc $Heap@@17 alloc)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@32) alloc))))
 :qid |_12MutexLifetimelongdfy.443:19|
 :skolemid |2158|
))) (=> (forall (($o@@33 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@33) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@33) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@33) alloc))))
 :qid |_12MutexLifetimelongdfy.443:19|
 :skolemid |2158|
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (_module.OwnedObject.localInv $Heap@@17 this@@30) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@17 this@@30) (or (_module.Object.objectGlobalBaseInv $Heap@@17 this@@30) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@30)) _module.Universe.content)) ($Box refType this@@30)))))) (=> (=> (_module.OwnedObject.localInv $Heap@@17 this@@30) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@17 this@@30) (or (_module.Object.objectGlobalBaseInv $Heap@@17 this@@30) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@30)) _module.Universe.content)) ($Box refType this@@30))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (_module.OwnedObject.localInv $Heap@@17 this@@30) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@17 this@@30) (or (_module.Object.objectGlobalBaseInv $Heap@@17 this@@30) (_module.Object.baseFieldsInv $Heap@@17 this@@30))))) (=> (=> (_module.OwnedObject.localInv $Heap@@17 this@@30) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@17 this@@30) (or (_module.Object.objectGlobalBaseInv $Heap@@17 this@@30) (_module.Object.baseFieldsInv $Heap@@17 this@@30)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.OwnedObject.localInv $Heap@@17 this@@30) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@17 this@@30) (or (_module.Object.objectGlobalBaseInv $Heap@@17 this@@30) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@30)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@30)) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (=> (_module.OwnedObject.localInv $Heap@@17 this@@30) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@17 this@@30) (or (_module.Object.objectGlobalBaseInv $Heap@@17 this@@30) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@30)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@30)) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.OwnedObject.localInv $Heap@@17 this@@30) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@17 this@@30) (or (_module.Object.objectGlobalBaseInv $Heap@@17 this@@30) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@30)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@30)) (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@30)) _module.Universe.content)) ($Box refType |o#0@@1|))) (and (and (and (= (_module.Object.universe |o#0@@1|) (_module.Object.universe this@@30)) (or (not (= |o#0@@1| (_module.Object.universe this@@30))) (not true))) (_module.Object.baseFieldsInv $Heap@@17 |o#0@@1|)) (_module.Object.triggerAxioms $Heap@@17 |o#0@@1|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2159|
 :pattern ( (_module.Object.triggerAxioms $Heap@@17 |o#0@@1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@17 |o#0@@1|))
 :pattern ( (_module.Object.universe |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@30)) _module.Universe.content)) ($Box refType |o#0@@1|)))
)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@17) ($IsHeapAnchor $Heap@@17)) (=> (and (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.OwnedObject) ($IsAlloc refType this@@30 Tclass._module.OwnedObject $Heap@@17))) (and (= 11 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct))))
