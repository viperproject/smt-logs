...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@5 this@@5) (and (< 10 $FunctionContextHeight) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Thread)))) (= (_module.Object.inv $Heap@@5 this@@5) (_module.Thread.inv $Heap@@5 this@@5)))
...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@6 this@@6) (and (< 10 $FunctionContextHeight) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Lifetime)))) (= (_module.Object.inv $Heap@@6 this@@6) (_module.Lifetime.inv $Heap@@6 this@@6)))
 :qid |_12MutexLifetimeshortdfy.352:19|
 :skolemid |2038|
 :pattern ( (_module.Object.inv $Heap@@6 this@@6) ($Is refType this@@6 Tclass._module.Lifetime) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.Object.inv $Heap@@6 this@@6) (_module.Lifetime.inv $Heap@@6 this@@6) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@7 this@@7) (and (< 11 $FunctionContextHeight) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.OwnedObject)))) (= (_module.Object.localInv $Heap@@7 this@@7) (_module.OwnedObject.localInv $Heap@@7 this@@7)))
 :qid |_12MutexLifetimeshortdfy.350:19|
 :skolemid |1802|
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@8 this@@8) (and (< 14 $FunctionContextHeight) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@8 this@@8) (_module.OwnedObject.inv $Heap@@8 this@@8)))
 :qid |_12MutexLifetimeshortdfy.352:19|
 :skolemid |1816|
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.Object) ($IsAlloc refType this@@9 Tclass._module.Object $Heap@@9)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Object.universe this@@9)) _module.Universe.content)) ($Box refType this@@9)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@9 this@@9) (=> (_module.Object.baseFieldsInv $Heap@@9 this@@9) (|_module.Universe.globalBaseInv#canCall| $Heap@@9 (_module.Object.universe this@@9))))) (= (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Object.universe this@@9)) _module.Universe.content)) ($Box refType this@@9)) (_module.Object.baseFieldsInv $Heap@@9 this@@9)) (_module.Universe.globalBaseInv $Heap@@9 (_module.Object.universe this@@9))))))
 :qid |_12MutexLifetimeshortdfy.301:19|
 :skolemid |1348|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) ($IsGoodHeap $Heap@@9))
))))
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@10 this@@10) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.OwnedObject) ($IsAlloc refType this@@10 Tclass._module.OwnedObject $Heap@@10)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@10 this@@10) (=> (_module.OwnedObject.localInv $Heap@@10 this@@10) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 this@@10) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.userInv#canCall| $Heap@@10 this@@10)))) (= (_module.OwnedObject.inv $Heap@@10 this@@10)  (and (_module.OwnedObject.localInv $Heap@@10 this@@10) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 this@@10) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv $Heap@@10 this@@10))))))
 :qid |_12MutexLifetimeshortdfy.448:19|
 :skolemid |1815|
 :pattern ( (_module.OwnedObject.inv $Heap@@10 this@@10) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@11 this@@11) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Thread) ($IsAlloc refType this@@11 Tclass._module.Thread $Heap@@11)))))) (= (_module.Thread.baseFieldsInv $Heap@@11 this@@11) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimeshortdfy.363:19|
 :skolemid |1506|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@11 this@@11) ($IsGoodHeap $Heap@@11))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@12 this@@12) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Object) ($IsAlloc refType this@@12 Tclass._module.Object $Heap@@12)))))) (and (|_module.Object.nonAliasing#canCall| $Heap@@12 this@@12) (= (_module.Object.triggerAxioms $Heap@@12 this@@12) (_module.Object.nonAliasing $Heap@@12 this@@12))))
 :qid |_12MutexLifetimeshortdfy.314:19|
 :skolemid |1376|
 :pattern ( (_module.Object.triggerAxioms $Heap@@12 this@@12) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@13 this@@13) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Lifetime) ($IsAlloc refType this@@13 Tclass._module.Lifetime $Heap@@13)))))) (and (|_module.Lifetime.localInv#canCall| $Heap@@13 this@@13) (= (_module.Lifetime.inv $Heap@@13 this@@13) (_module.Lifetime.localInv $Heap@@13 this@@13))))
 :qid |_12MutexLifetimeshortdfy.588:19|
 :skolemid |2037|
 :pattern ( (_module.Lifetime.inv $Heap@@13 this@@13) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@14 this@@14) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.OwnedObject) ($IsAlloc refType this@@14 Tclass._module.OwnedObject $Heap@@14)))))) (and (|_module.OwnedObject.objectUserFields#canCall| $Heap@@14 this@@14) (= (_module.OwnedObject.objectFields $Heap@@14 this@@14) (|Set#Union| (|Set#Union| (_module.OwnedObject.objectUserFields $Heap@@14 this@@14) (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@14)))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@14) _module.OwnedObject.owner)) null) |Set#Empty| (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@14) _module.OwnedObject.owner)))))))
 :qid |_12MutexLifetimeshortdfy.426:18|
 :skolemid |1774|
 :pattern ( (_module.OwnedObject.objectFields $Heap@@14 this@@14) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.OwnedObject.objectUserFields#canCall| $Heap@@15 this@@15) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.OwnedObject) ($IsAlloc refType this@@15 Tclass._module.OwnedObject $Heap@@15)))))) ($Is SetType (_module.OwnedObject.objectUserFields $Heap@@15 this@@15) (TSet Tclass._module.Object)))
 :qid |_12MutexLifetimeshortdfy.518:18|
 :skolemid |1876|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@15 this@@15))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@16 this@@16) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.OwnedObject) ($IsAlloc refType this@@16 Tclass._module.OwnedObject $Heap@@16)))))) ($Is SetType (_module.OwnedObject.objectFields $Heap@@16 this@@16) (TSet Tclass._module.Object)))
 :qid |_12MutexLifetimeshortdfy.426:18|
 :skolemid |1771|
 :pattern ( (_module.OwnedObject.objectFields $Heap@@16 this@@16))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@17 this@@17) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.OwnedObject) ($IsAlloc refType this@@17 Tclass._module.OwnedObject $Heap@@17)))))) (and (|_module.OwnedObject.objectFields#canCall| $Heap@@17 this@@17) (= (_module.OwnedObject.baseFieldsInv $Heap@@17 this@@17) (|Set#Subset| (_module.OwnedObject.objectFields $Heap@@17 this@@17) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@17)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.432:19|
 :skolemid |1780|
 :pattern ( (_module.OwnedObject.baseFieldsInv $Heap@@17 this@@17) ($IsGoodHeap $Heap@@17))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Object.nonAliasing#canCall| $Heap@@18 this@@18) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Object) ($IsAlloc refType this@@18 Tclass._module.Object $Heap@@18)))))) (and (and (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@18)) (|_module.Object.objectClassKind#canCall| this@@18)) (=> (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@18) |#_module.ObjectClassKind.Thread|) ($Is refType this@@18 Tclass._module.Thread)) (and (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@18)) (|_module.Object.objectClassKind#canCall| this@@18)) (=> (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@18) |#_module.ObjectClassKind.OwnedObject|) ($Is refType this@@18 Tclass._module.OwnedObject)) (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@18)) (|_module.Object.objectClassKind#canCall| this@@18)))))) (= (_module.Object.nonAliasing $Heap@@18 this@@18)  (and (and (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@18) |#_module.ObjectClassKind.Thread|) ($Is refType this@@18 Tclass._module.Thread)) (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@18) |#_module.ObjectClassKind.OwnedObject|) ($Is refType this@@18 Tclass._module.OwnedObject))) (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@18) |#_module.ObjectClassKind.Lifetime|) ($Is refType this@@18 Tclass._module.Lifetime))))))
 :qid |_12MutexLifetimeshortdfy.309:19|
 :skolemid |1368|
 :pattern ( (_module.Object.nonAliasing $Heap@@18 this@@18) ($IsGoodHeap $Heap@@18))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@19 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@19) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@19 null)) (not true)) ($Is refType this@@19 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind this@@19) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :skolemid |1498|
 :pattern ( (_module.Thread.objectClassKind this@@19))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@20 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@20) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@20 null)) (not true)) ($Is refType this@@20 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind this@@20) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :skolemid |1765|
 :pattern ( (_module.OwnedObject.objectClassKind this@@20))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@21 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@21) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind this@@21) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :skolemid |1943|
 :pattern ( (_module.Lifetime.objectClassKind this@@21))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.OwnedObject.objectUserFields#canCall| $Heap@@19 this@@22) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@19) (or (not (= this@@22 null)) (not true))) ($IsAlloc refType this@@22 Tclass._module.OwnedObject $Heap@@19)))) ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@19 this@@22) (TSet Tclass._module.Object) $Heap@@19))
 :qid |_12MutexLifetimeshortdfy.518:18|
 :skolemid |1877|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@19 this@@22) (TSet Tclass._module.Object) $Heap@@19))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@20 this@@23) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@20) (or (not (= this@@23 null)) (not true))) ($IsAlloc refType this@@23 Tclass._module.OwnedObject $Heap@@20)))) ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@20 this@@23) (TSet Tclass._module.Object) $Heap@@20))
 :qid |_12MutexLifetimeshortdfy.426:18|
 :skolemid |1772|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@20 this@@23) (TSet Tclass._module.Object) $Heap@@20))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@24 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@21 this@@24) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.Object) ($IsAlloc refType this@@24 Tclass._module.Object $Heap@@21)))))) (_module.Object.triggerAxioms $Heap@@21 this@@24))
 :qid |_12MutexLifetimeshortdfy.314:19|
 :skolemid |1374|
 :pattern ( (_module.Object.triggerAxioms $Heap@@21 this@@24))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@22 T@U) (this@@25 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@22 this@@25) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.OwnedObject) ($IsAlloc refType this@@25 Tclass._module.OwnedObject $Heap@@22)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@22 this@@25) (=> (_module.Object.objectGlobalBaseInv $Heap@@22 this@@25) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 (_module.OwnedObject.lifetime this@@25)) _module.Lifetime.elements)) ($Box refType this@@25)) (and (|_module.Lifetime.alive#canCall| $Heap@@22 (_module.OwnedObject.lifetime this@@25)) (=> (=> (_module.Lifetime.alive $Heap@@22 (_module.OwnedObject.lifetime this@@25)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@25) _module.OwnedObject.owner)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@25) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.localUserInv#canCall| $Heap@@22 this@@25))))))) (= (_module.OwnedObject.localInv $Heap@@22 this@@25)  (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@22 this@@25) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 (_module.OwnedObject.lifetime this@@25)) _module.Lifetime.elements)) ($Box refType this@@25))) (=> (_module.Lifetime.alive $Heap@@22 (_module.OwnedObject.lifetime this@@25)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@25) _module.OwnedObject.owner)) null)) (not true)))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@25) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv $Heap@@22 this@@25))))))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1801|
 :pattern ( (_module.OwnedObject.localInv $Heap@@22 this@@25) ($IsGoodHeap $Heap@@22))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@26 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@23 this@@26) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.Thread) ($IsAlloc refType this@@26 Tclass._module.Thread $Heap@@23)))))) (=> (_module.Thread.localInv $Heap@@23 this@@26) (_module.Object.objectGlobalBaseInv $Heap@@23 this@@26)))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1518|
 :pattern ( (_module.Thread.localInv $Heap@@23 this@@26))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@24 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@24 this@@27) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@24) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Lifetime) ($IsAlloc refType this@@27 Tclass._module.Lifetime $Heap@@24)))))) (=> (_module.Lifetime.localInv $Heap@@24 this@@27) (_module.Object.objectGlobalBaseInv $Heap@@24 this@@27)))
 :qid |_12MutexLifetimeshortdfy.578:19|
 :skolemid |1968|
 :pattern ( (_module.Lifetime.localInv $Heap@@24 this@@27))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@25 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@25 this@@28) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@25) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Thread) ($IsAlloc refType this@@28 Tclass._module.Thread $Heap@@25)))))) (=> (_module.Thread.inv $Heap@@25 this@@28) (_module.Thread.localInv $Heap@@25 this@@28)))
 :qid |_12MutexLifetimeshortdfy.371:19|
 :skolemid |1530|
 :pattern ( (_module.Thread.inv $Heap@@25 this@@28))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@26 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@26 this@@29) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@26) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Lifetime) ($IsAlloc refType this@@29 Tclass._module.Lifetime $Heap@@26)))))) (=> (_module.Lifetime.inv $Heap@@26 this@@29) (_module.Lifetime.localInv $Heap@@26 this@@29)))
 :qid |_12MutexLifetimeshortdfy.588:19|
 :skolemid |2035|
 :pattern ( (_module.Lifetime.inv $Heap@@26 this@@29))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@27 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@27 this@@30) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@27) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.OwnedObject) ($IsAlloc refType this@@30 Tclass._module.OwnedObject $Heap@@27)))))) (=> (_module.OwnedObject.localInv $Heap@@27 this@@30) (_module.Object.objectGlobalBaseInv $Heap@@27 this@@30)))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localInv $Heap@@27 this@@30))
))))
...
))))))))))) (= (_module.Lifetime.localInv $Heap@@32 this@@38)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@32 this@@38) (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@32 this@@38) _module.Lifetime.elements)) ($Box refType |o#0@@2|))) (= (_module.OwnedObject.lifetime |o#0@@2|) this@@38))
 :qid |_12MutexLifetimeshortdfy.580:16|
 :skolemid |1970|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@32 this@@38) _module.Lifetime.elements)) ($Box refType |o#0@@2|)))
...
(let ((anon8_Else_correct  (=> (and (=> (_module.Object.inv $Heap@@38 this@@51) (_module.Object.localInv $Heap@@38 this@@51)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($IsAllocBox ($Box refType this@@51) Tclass._module.Object? $Heap@@38) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (= this@@51 this@@51) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@51 this@@51) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@51 this@@51) (|_module.Object.inv#canCall| $Heap@@38 this@@51)) (_module.Object.inv $Heap@@38 this@@51)) (=> (and (and ($IsAllocBox ($Box refType this@@51) Tclass._module.Object? $Heap@@38) (|_module.Object.localInv#canCall| $Heap@@38 this@@51)) (and (_module.Object.localInv $Heap@@38 this@@51) (= (ControlFlow 0 3) 2))) anon5_correct)))))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#59| null $Heap@@38 alloc $Heap@@38 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Else_correct) (=> (= (ControlFlow 0 6) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@38) ($IsHeapAnchor $Heap@@38)) (=> (and (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.Object) ($IsAlloc refType this@@51 Tclass._module.Object $Heap@@38))) (and (= 15 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
