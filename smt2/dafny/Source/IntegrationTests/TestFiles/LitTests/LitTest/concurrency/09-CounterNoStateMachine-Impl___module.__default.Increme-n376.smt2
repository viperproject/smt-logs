...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split365)
...
))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|))) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (=> |$w$loop#0@0| (= (+ |i#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.Integer.value)))) (LitInt 10)))))) (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> |defass#initial_value#0_0@0| (and ($Is refType |initial_value#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value#0_0@0| Tclass._module.ConstantInteger $Heap@4)))) (and (and (=> |defass#claim1#0_0@0| (and ($Is refType |claim1#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim1#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@4))) (=> |defass#initial_value_plus_one#0_0@0| (and ($Is refType |initial_value_plus_one#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value_plus_one#0_0@0| Tclass._module.ConstantInteger $Heap@4)))) (and (=> |defass#claim2#0_0@0| (and ($Is refType |claim2#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim2#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@4))) (=> |defass#final_value#0_0@0| (and ($Is refType |final_value#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |final_value#0_0@0| Tclass._module.ConstantInteger $Heap@4)))))))))) (=> (and (and (and (and (and (and (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (=> |$w$loop#0@0| (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalInv $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|))) (and (= (_module.Object.universe |o#16@@0|) |universe#0|) (or (not (= |o#16@@0| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |532|
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@29 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))) (and (and (and ($IsGoodHeap $Heap@30) ($IsHeapAnchor $Heap@30)) (|_module.Universe.globalInv#canCall| $Heap@30 |universe#0|)) (and (and (|_module.Universe.globalInv#canCall| $Heap@30 |universe#0|) (and (_module.Universe.globalInv $Heap@30 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@30 |universe#0|) (forall ((|o#5@@11| T@U) ) (!  (=> (and ($Is refType |o#5@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@30 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@11|))) (_module.Object.inv $Heap@30 |o#5@@11|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |904|
...
))))) (and ($IsGoodHeap $Heap@32) ($IsHeapAnchor $Heap@32))) (and (and (|_module.Universe.globalInv#canCall| $Heap@31 |universe#0|) (=> (_module.Universe.globalInv $Heap@31 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@30 $Heap@31 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@31 |universe#0|) (and (_module.Universe.globalInv $Heap@31 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@31 |universe#0|) (forall ((|o#17@@8| T@U) ) (!  (=> (and ($Is refType |o#17@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@31 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@8|))) (_module.Object.inv $Heap@31 |o#17@@8|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))) (= $Heap@31 $Heap@32)) (and (or (not (= |universe#0| null)) (not true)) (forall (($o@@177 T@U) ($f@@119 T@U) ) (!  (=> (and (and (or (not (= $o@@177 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 $o@@177) alloc)))) (or (= $o@@177 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType $o@@177)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@177 $f@@119)))
 :qid |_09CounterNoStateMachinedfy.775:26|
 :skolemid |571|
))))) (and (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@32 |universe#0|) (or (_module.Universe.globalInv $Heap@32 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@32 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@32 |universe#0|) (forall ((|o#0@@31| T@U) ) (!  (=> (and ($Is refType |o#0@@31| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@31|))) (and (= (_module.Object.universe |o#0@@31|) |universe#0|) (or (not (= |o#0@@31| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |893|
 :pattern ( (_module.Object.universe |o#0@@31|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@31|)))
)))))) (=> (|_module.Universe.globalInv#canCall| $Heap@32 |universe#0|) (or (_module.Universe.globalInv $Heap@32 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@32 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@32 |universe#0|) (forall ((|o#1@@40| T@U) ) (!  (=> (and ($Is refType |o#1@@40| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@40|))) (_module.Object.triggerAxioms $Heap@32 |o#1@@40|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |894|
 :pattern ( (_module.Object.triggerAxioms $Heap@32 |o#1@@40|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@40|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@32 |universe#0|) (or (_module.Universe.globalInv $Heap@32 |universe#0|) (forall ((|o#2@@18| T@U) ) (!  (=> (and ($Is refType |o#2@@18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@18|))) (_module.Object.inv $Heap@32 |o#2@@18|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |897|
 :pattern ( (_module.Object.inv $Heap@32 |o#2@@18|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@18|)))
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (and ($IsGoodHeap $Heap@33) ($IsHeapAnchor $Heap@33)) (|_module.Universe.globalInv#canCall| $Heap@33 |universe#0|))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@33 |universe#0|) (and (_module.Universe.globalInv $Heap@33 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@33 |universe#0|) (forall ((|o#5@@13| T@U) ) (!  (=> (and ($Is refType |o#5@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@13|))) (_module.Object.inv $Heap@33 |o#5@@13|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |904|
 :pattern ( (_module.Object.inv $Heap@33 |o#5@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@13|)))
))))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@32 $Heap@33 |universe#0| (|Set#FromBoogieMap| (|lambda#14| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) |running#0@@3|)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@32 $Heap@33 |universe#0| (|Set#FromBoogieMap| (|lambda#14| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) |running#0@@3|))) (and (_module.Universe.legalTransitionsSequence $Heap@32 $Heap@33 |universe#0| (|Set#FromBoogieMap| (|lambda#14| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) |running#0@@3|))) (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@32 $Heap@33 |universe#0|) (_module.Universe.globalBaseInv $Heap@32 |universe#0|)) (_module.Universe.globalBaseInv $Heap@33 |universe#0|)) (forall ((|o#12@@13| T@U) ) (!  (=> (and ($Is refType |o#12@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@13|))) (_module.Object.transitiveInv2 $Heap@32 $Heap@33 |o#12@@13|))
 :qid |_09CounterNoStateMachinedfy.74:16|
 :skolemid |921|
 :pattern ( (_module.Object.transitiveInv2 $Heap@32 $Heap@33 |o#12@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@13|)))
))) (forall ((|o#13@@13| T@U) ) (!  (=> (and ($Is refType |o#13@@13| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@13|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |o#13@@13|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#14| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |o#13@@13|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |o#13@@13|) _module.OwnedObject.owner) Tclass._module.Object $Heap@32)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |o#13@@13|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#13@@13|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.77:16|
 :skolemid |922|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#13@@13|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |o#13@@13|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |o#13@@13|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@13|)))
))))) (and (forall (($o@@178 T@U) ) (!  (=> (and (or (not (= $o@@178 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 $o@@178) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@178) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 $o@@178)) (or (= $o@@178 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType $o@@178)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@178))
)) ($HeapSucc $Heap@32 $Heap@33)))))))) (and (and (and (and (and (and (and (U_2_bool (Lit boolType (bool_2_U false))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)) (and ($IsAllocBox ($Box refType |running#0@@3|) Tclass._module.Object? $Heap@33) (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|))) (and (and (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|) (_module.Object.triggerAxioms $Heap@33 |running#0@@3|)) (and (or (not (= |remaining#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |remaining#0| _module.Integer.value))))) (and (and (and (or (not (= |remaining#0| null)) (not true)) (= |$rhs#0_6@1| (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.Integer.value))) 1))) (and (= $Heap@34 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.Integer.value ($Box intType (int_2_U |$rhs#0_6@1|))))) ($IsGoodHeap $Heap@34))) (and (and (or (not (= |remaining#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |remaining#0| _module.OwnedObject.nonvolatileVersion))) (and (or (not (= |remaining#0| null)) (not true)) (= |last##0_0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 |remaining#0|) _module.OwnedObject.nonvolatileVersion)))))))) (and (and (and (and ($IsGoodHeap $Heap@35) ($IsHeapAnchor $Heap@35)) (> |call2formal@res#0@0| |last##0_0@1|)) (and (forall (($o@@179 T@U) ) (!  (=> (and (or (not (= $o@@179 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 $o@@179) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 $o@@179) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 $o@@179)))
 :qid |_09CounterNoStateMachinedfy.450:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 $o@@179))
)) ($HeapSucc $Heap@34 $Heap@35))) (and (and (= $Heap@36 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0|) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|))))) ($IsGoodHeap $Heap@36)) (and ($IsAllocBox ($Box refType |remaining#0|) Tclass._module.OwnedObject? $Heap@36) ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap@33))))) (and (and (and (and (and (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|) (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|)) (and (_module.OwnedObject.inv2 $Heap@33 $Heap@36 |remaining#0|) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@36))) (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|)) (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|) (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@36 |universe#0|)))) (and (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)) (and ($IsGoodHeap $Heap@37) ($IsHeapAnchor $Heap@37))) (and (and (forall ((|o#1@@41| T@U) ) (!  (=> ($Is refType |o#1@@41| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@41|)) (=> (=> ($Is refType |o#1@@41| Tclass._module.OwnedObject) (and (forall (($o@@180 T@U) ($f@@120 T@U) ) (!  (=> (or (not (= $o@@180 null)) (not true)) (=> (= $o@@180 |o#1@@41|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 $o@@180) $f@@120) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@180) $f@@120))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 $o@@180) $f@@120))
)) (forall ((|x#2@@15| T@U) ) (!  (=> (and ($Is refType |x#2@@15| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 (_module.Object.universe |o#1@@41|)) _module.Universe.content)) ($Box refType |x#2@@15|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |x#2@@15|) _module.OwnedObject.owner)) |o#1@@41|))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |x#2@@15|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |x#2@@15|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |x#2@@15|) _module.OwnedObject.owner)) |o#1@@41|)))
 :qid |_09CounterNoStateMachinedfy.155:20|
 :skolemid |1007|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |x#2@@15|) _module.OwnedObject.owner)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |x#2@@15|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |x#2@@15|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |x#2@@15|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 (_module.Object.universe |o#1@@41|)) _module.Universe.content)) ($Box refType |x#2@@15|)))
)))) (|_module.Object.transitiveInv2#canCall| $Heap@33 $Heap@36 |o#1@@41|))))
 :qid |_09CounterNoStateMachinedfy.152:20|
 :skolemid |1008|
 :pattern ( (_module.Object.transitiveInv2 $Heap@33 $Heap@36 |o#1@@41|))
 :pattern ( (_module.Object.universe |o#1@@41|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@41|)))
)) (forall ((|o#1@@42| T@U) ) (!  (=> (and ($Is refType |o#1@@42| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@42|))) (=> (=> ($Is refType |o#1@@42| Tclass._module.OwnedObject) (and (forall (($o@@181 T@U) ($f@@121 T@U) ) (!  (=> (or (not (= $o@@181 null)) (not true)) (=> (= $o@@181 |o#1@@42|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 $o@@181) $f@@121) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@181) $f@@121))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1009|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 $o@@181) $f@@121))
)) (forall ((|x#2@@16| T@U) ) (!  (=> (and ($Is refType |x#2@@16| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 (_module.Object.universe |o#1@@42|)) _module.Universe.content)) ($Box refType |x#2@@16|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |x#2@@16|) _module.OwnedObject.owner)) |o#1@@42|))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |x#2@@16|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |x#2@@16|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |x#2@@16|) _module.OwnedObject.owner)) |o#1@@42|)))
 :qid |_09CounterNoStateMachinedfy.155:20|
 :skolemid |1010|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |x#2@@16|) _module.OwnedObject.owner)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |x#2@@16|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |x#2@@16|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |x#2@@16|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 (_module.Object.universe |o#1@@42|)) _module.Universe.content)) ($Box refType |x#2@@16|)))
)))) (_module.Object.transitiveInv2 $Heap@33 $Heap@36 |o#1@@42|)))
 :qid |_09CounterNoStateMachinedfy.152:20|
 :skolemid |1011|
 :pattern ( (_module.Object.transitiveInv2 $Heap@33 $Heap@36 |o#1@@42|))
 :pattern ( (_module.Object.universe |o#1@@42|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@42|)))
))) (and (= $Heap@36 $Heap@37) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37))))) (and (and (and (and (= |##running#0_0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) ($IsAlloc SetType |##running#0_0@1| (TSet Tclass._module.Thread) $Heap@37)) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (TSet Tclass._module.Thread) $Heap@33))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)))) (and (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37)))) (and (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@37) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33) (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|))) (and (and (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33))))))) (and (and (and (and (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33)) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@37 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@37 |universe#0|) (forall ((|o#0@@32| T@U) ) (!  (=> (and ($Is refType |o#0@@32| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|)))) (not ($IsAllocBox ($Box refType |o#0@@32|) Tclass._module.Object $Heap@33)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |771|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|)))
)))))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@37 |universe#0|) (forall ((|o#1@@43| T@U) ) (!  (=> (and ($Is refType |o#1@@43| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@43|))) (or (forall (($o@@182 T@U) ($f@@122 T@U) ) (!  (=> (or (not (= $o@@182 null)) (not true)) (=> (= $o@@182 |o#1@@43|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 $o@@182) $f@@122) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@182) $f@@122))))
 :qid |_09CounterNoStateMachinedfy.60:54|
 :skolemid |772|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 $o@@182) $f@@122))
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#1@@43|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |o#1@@43|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.60:16|
 :skolemid |773|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |o#1@@43|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#1@@43|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@43|)))
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@33 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@33 |universe#0|) (forall ((|o#2@@19| T@U) ) (!  (=> (and ($Is refType |o#2@@19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@19|))) (and (= (_module.Object.universe |o#2@@19|) |universe#0|) (or (not (= |o#2@@19| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |777|
 :pattern ( (_module.Object.universe |o#2@@19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@19|)))
))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@33 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@33 |universe#0|) (forall ((|o#3@@7| T@U) ) (!  (=> (and ($Is refType |o#3@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@7|))) (_module.Object.triggerAxioms $Heap@33 |o#3@@7|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |778|
 :pattern ( (_module.Object.triggerAxioms $Heap@33 |o#3@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@7|)))
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@37 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@37 |universe#0|) (forall ((|o#4@@7| T@U) ) (!  (=> (and ($Is refType |o#4@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@7|))) (and (= (_module.Object.universe |o#4@@7|) |universe#0|) (or (not (= |o#4@@7| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |781|
 :pattern ( (_module.Object.universe |o#4@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@7|)))
))))))))))) (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@37 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@37 |universe#0|) (forall ((|o#5@@14| T@U) ) (!  (=> (and ($Is refType |o#5@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@14|))) (_module.Object.triggerAxioms $Heap@37 |o#5@@14|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |782|
 :pattern ( (_module.Object.triggerAxioms $Heap@37 |o#5@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@14|)))
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#6@@7| T@U) ) (!  (=> (and ($Is refType |o#6@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@7|))) (_module.Object.transitiveInv2 $Heap@33 $Heap@37 |o#6@@7|))
 :qid |_09CounterNoStateMachinedfy.74:16|
 :skolemid |785|
 :pattern ( (_module.Object.transitiveInv2 $Heap@33 $Heap@37 |o#6@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@7|)))
))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#7@@7| T@U) ) (!  (=> (and ($Is refType |o#7@@7| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@7|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#7@@7|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#7@@7|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#7@@7|) _module.OwnedObject.owner) Tclass._module.Object $Heap@33)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#7@@7|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |o#7@@7|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.77:16|
 :skolemid |786|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |o#7@@7|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#7@@7|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#7@@7|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@7|)))
)))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@33 |universe#0|) (or (_module.Universe.globalInv $Heap@33 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@33 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@33 |universe#0|) (forall ((|o#8@@12| T@U) ) (!  (=> (and ($Is refType |o#8@@12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@12|))) (and (= (_module.Object.universe |o#8@@12|) |universe#0|) (or (not (= |o#8@@12| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |789|
 :pattern ( (_module.Object.universe |o#8@@12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@12|)))
)))))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@33 |universe#0|) (or (_module.Universe.globalInv $Heap@33 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@33 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@33 |universe#0|) (forall ((|o#9@@7| T@U) ) (!  (=> (and ($Is refType |o#9@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@7|))) (_module.Object.triggerAxioms $Heap@33 |o#9@@7|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |790|
 :pattern ( (_module.Object.triggerAxioms $Heap@33 |o#9@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@7|)))
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@33 |universe#0|) (or (_module.Universe.globalInv $Heap@33 |universe#0|) (forall ((|o#10@@8| T@U) ) (!  (=> (and ($Is refType |o#10@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@8|))) (_module.Object.inv $Heap@33 |o#10@@8|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |793|
 :pattern ( (_module.Object.inv $Heap@33 |o#10@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@8|)))
))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@37 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@37 |universe#0|) (forall ((|o#11@@7| T@U) ) (!  (=> (and ($Is refType |o#11@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@7|))) (and (= (_module.Object.universe |o#11@@7|) |universe#0|) (or (not (= |o#11@@7| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |795|
 :pattern ( (_module.Object.universe |o#11@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@7|)))
)))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@37 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@37 |universe#0|) (forall ((|o#12@@14| T@U) ) (!  (=> (and ($Is refType |o#12@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@14|))) (_module.Object.triggerAxioms $Heap@37 |o#12@@14|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |796|
 :pattern ( (_module.Object.triggerAxioms $Heap@37 |o#12@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@14|)))
)))))))))) (and (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (forall ((|o#13@@14| T@U) ) (!  (=> (and ($Is refType |o#13@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@14|))) (and (or (forall (($o@@183 T@U) ($f@@123 T@U) ) (!  (=> (or (not (= $o@@183 null)) (not true)) (=> (= $o@@183 |o#13@@14|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 $o@@183) $f@@123) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@183) $f@@123))))
 :qid |_09CounterNoStateMachinedfy.91:49|
 :skolemid |799|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 $o@@183) $f@@123))
)) (_module.Object.inv $Heap@37 |o#13@@14|)) (or (forall (($o@@184 T@U) ($f@@124 T@U) ) (!  (=> (or (not (= $o@@184 null)) (not true)) (=> (= $o@@184 |o#13@@14|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 $o@@184) $f@@124) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@184) $f@@124))))
 :qid |_09CounterNoStateMachinedfy.91:49|
 :skolemid |800|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 $o@@184) $f@@124))
)) (_module.Object.inv2 $Heap@33 $Heap@37 |o#13@@14|))))
 :qid |_09CounterNoStateMachinedfy.91:16|
 :skolemid |801|
 :pattern ( (_module.Object.inv2 $Heap@33 $Heap@37 |o#13@@14|))
 :pattern ( (_module.Object.inv $Heap@37 |o#13@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@14|)))
)))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (forall ((|o#14@@7| T@U) ) (!  (=> (and ($Is refType |o#14@@7| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@7|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@7|))))) (_module.Object.inv $Heap@37 |o#14@@7|))
 :qid |_09CounterNoStateMachinedfy.93:16|
 :skolemid |802|
 :pattern ( (_module.Object.inv $Heap@37 |o#14@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@7|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@7|)))
))))) (and ($IsGoodHeap $Heap@38) ($IsHeapAnchor $Heap@38))) (and (and (|_module.Universe.globalInv#canCall| $Heap@37 |universe#0|) (=> (_module.Universe.globalInv $Heap@37 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@33 $Heap@37 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@37 |universe#0|) (and (_module.Universe.globalInv $Heap@37 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@37 |universe#0|) (forall ((|o#17@@9| T@U) ) (!  (=> (and ($Is refType |o#17@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@9|))) (_module.Object.inv $Heap@37 |o#17@@9|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
 :pattern ( (_module.Object.inv $Heap@37 |o#17@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@9|)))
))))))) (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@33 $Heap@37 |universe#0|) (and (_module.Universe.globalInv2 $Heap@33 $Heap@37 |universe#0|) (and true (forall ((|o#18@@10| T@U) ) (!  (=> (and ($Is refType |o#18@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@10|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@10|)) (_module.Object.inv2 $Heap@33 $Heap@37 |o#18@@10|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |814|
 :pattern ( (_module.Object.inv2 $Heap@33 $Heap@37 |o#18@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@10|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@10|)))
))))) (= $Heap@37 $Heap@38)) (and (or (not (= |universe#0| null)) (not true)) (forall (($o@@185 T@U) ($f@@125 T@U) ) (!  (=> (and (and (or (not (= $o@@185 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@185) alloc)))) (or (= $o@@185 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType $o@@185)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@185 $f@@125)))
 :qid |_09CounterNoStateMachinedfy.791:26|
 :skolemid |639|
)))))) (and (and (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@38 |universe#0|) (or (_module.Universe.globalInv $Heap@38 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@38 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@38 |universe#0|) (forall ((|o#0@@33| T@U) ) (!  (=> (and ($Is refType |o#0@@33| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@33|))) (and (= (_module.Object.universe |o#0@@33|) |universe#0|) (or (not (= |o#0@@33| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |893|
 :pattern ( (_module.Object.universe |o#0@@33|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@33|)))
)))))) (=> (|_module.Universe.globalInv#canCall| $Heap@38 |universe#0|) (or (_module.Universe.globalInv $Heap@38 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@38 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@38 |universe#0|) (forall ((|o#1@@44| T@U) ) (!  (=> (and ($Is refType |o#1@@44| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@44|))) (_module.Object.triggerAxioms $Heap@38 |o#1@@44|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |894|
 :pattern ( (_module.Object.triggerAxioms $Heap@38 |o#1@@44|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@44|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@38 |universe#0|) (or (_module.Universe.globalInv $Heap@38 |universe#0|) (forall ((|o#2@@20| T@U) ) (!  (=> (and ($Is refType |o#2@@20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@20|))) (_module.Object.inv $Heap@38 |o#2@@20|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |897|
 :pattern ( (_module.Object.inv $Heap@38 |o#2@@20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@20|)))
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (and ($IsGoodHeap $Heap@39) ($IsHeapAnchor $Heap@39)) (|_module.Universe.globalInv#canCall| $Heap@39 |universe#0|))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@39 |universe#0|) (and (_module.Universe.globalInv $Heap@39 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@39 |universe#0|) (forall ((|o#5@@15| T@U) ) (!  (=> (and ($Is refType |o#5@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@15|))) (_module.Object.inv $Heap@39 |o#5@@15|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |904|
 :pattern ( (_module.Object.inv $Heap@39 |o#5@@15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@15|)))
))))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@38 $Heap@39 |universe#0| (|Set#FromBoogieMap| (|lambda#14| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) |running#0@@3|)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@38 $Heap@39 |universe#0| (|Set#FromBoogieMap| (|lambda#14| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) |running#0@@3|))) (and (_module.Universe.legalTransitionsSequence $Heap@38 $Heap@39 |universe#0| (|Set#FromBoogieMap| (|lambda#14| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) |running#0@@3|))) (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@38 $Heap@39 |universe#0|) (_module.Universe.globalBaseInv $Heap@38 |universe#0|)) (_module.Universe.globalBaseInv $Heap@39 |universe#0|)) (forall ((|o#12@@15| T@U) ) (!  (=> (and ($Is refType |o#12@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@15|))) (_module.Object.transitiveInv2 $Heap@38 $Heap@39 |o#12@@15|))
 :qid |_09CounterNoStateMachinedfy.74:16|
 :skolemid |921|
 :pattern ( (_module.Object.transitiveInv2 $Heap@38 $Heap@39 |o#12@@15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@15|)))
))) (forall ((|o#13@@15| T@U) ) (!  (=> (and ($Is refType |o#13@@15| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@15|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |o#13@@15|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#14| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |o#13@@15|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |o#13@@15|) _module.OwnedObject.owner) Tclass._module.Object $Heap@38)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |o#13@@15|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |o#13@@15|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.77:16|
 :skolemid |922|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |o#13@@15|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |o#13@@15|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |o#13@@15|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@15|)))
))))) (and (forall (($o@@186 T@U) ) (!  (=> (and (or (not (= $o@@186 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@186) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@186) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@186)) (or (= $o@@186 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType $o@@186)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@186))
)) ($HeapSucc $Heap@38 $Heap@39))))) (and (and (and (and (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|)) (< (- 10 |i#0@2|) |$decr$loop#00@1|)) (and (|_module.Universe.globalInv#canCall| $Heap@39 |universe#0|) (=> (_module.Universe.globalInv $Heap@39 |universe#0|) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@39 |universe#0|)))) (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@39 |universe#0|) (or (_module.Universe.globalInv $Heap@39 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@39 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@39 |universe#0|) (forall ((|o#16@@1| T@U) ) (!  (=> (and ($Is refType |o#16@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@1|))) (and (= (_module.Object.universe |o#16@@1|) |universe#0|) (or (not (= |o#16@@1| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |532|
 :pattern ( (_module.Object.universe |o#16@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@1|)))
))))))) (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@39 |universe#0|) (or (_module.Universe.globalInv $Heap@39 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@39 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@39 |universe#0|) (forall ((|o#17@@10| T@U) ) (!  (=> (and ($Is refType |o#17@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@10|))) (_module.Object.triggerAxioms $Heap@39 |o#17@@10|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |533|
 :pattern ( (_module.Object.triggerAxioms $Heap@39 |o#17@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@10|)))
)))))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@39 |universe#0|) (or (_module.Universe.globalInv $Heap@39 |universe#0|) (forall ((|o#18@@11| T@U) ) (!  (=> (and ($Is refType |o#18@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@11|))) (_module.Object.inv $Heap@39 |o#18@@11|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |536|
 :pattern ( (_module.Object.inv $Heap@39 |o#18@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@11|)))
))))) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@39 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@39 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content))))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@39 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@39 |universe#0|) (forall ((|o#19@@2| T@U) ) (!  (=> (and ($Is refType |o#19@@2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@2|)))) (not ($IsAllocBox ($Box refType |o#19@@2|) Tclass._module.Object $Heap@3)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |538|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@2|)))
))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@39 |universe#0|))))))))) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@39 |universe#0|) (forall ((|o#20@@2| T@U) ) (!  (=> (and ($Is refType |o#20@@2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#20@@2|))) (or (forall (($o@@187 T@U) ($f@@126 T@U) ) (!  (=> (or (not (= $o@@187 null)) (not true)) (=> (= $o@@187 |o#20@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@187) $f@@126) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@187) $f@@126))))
 :qid |_09CounterNoStateMachinedfy.60:54|
 :skolemid |539|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@187) $f@@126))
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#20@@2|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |o#20@@2|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.60:16|
 :skolemid |540|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |o#20@@2|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#20@@2|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#20@@2|)))
)))))))))
anon0_correct))
))
(check-sat)
