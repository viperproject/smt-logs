...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split287)
...
))) (and ($HeapSucc $Heap@34 $Heap@35) (= $Heap@36 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0|) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|)))))))) (and (and (and ($IsGoodHeap $Heap@36) ($IsAllocBox ($Box refType |remaining#0|) Tclass._module.OwnedObject? $Heap@36)) (and ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap@33) (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|))) (and (and (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|) (= (ControlFlow 0 2) (- 0 1))) (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|))))))))) (or (_module.OwnedObject.inv2 $Heap@33 $Heap@36 |remaining#0|) (=> (|_module.OwnedObject.transitiveInv2#canCall| $Heap@33 $Heap@36 |remaining#0|) (or (_module.OwnedObject.transitiveInv2 $Heap@33 $Heap@36 |remaining#0|) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |remaining#0|) _module.OwnedObject.nonvolatileVersion)))) (forall ((|o#0_0| T@U) ) (!  (=> (and ($Is refType |o#0_0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 (_module.Object.universe |remaining#0|)) _module.Universe.content)) ($Box refType |o#0_0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_0|) _module.OwnedObject.owner)) |remaining#0|))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |o#0_0|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |o#0_0|) _module.OwnedObject.owner)) |remaining#0|)))
 :qid |_09CounterNoStateMachinedfy.373:18|
 :skolemid |575|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |o#0_0|) _module.OwnedObject.owner)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |o#0_0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 (_module.Object.universe |remaining#0|)) _module.Universe.content)) ($Box refType |o#0_0|)))
))))))))))))
anon0_correct))
))
(check-sat)
