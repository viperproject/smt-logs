...
(set-info :boogie-vc-id OverrideCheck$$_module.EmptyType.ProveUnchangedNonvolatileUserFields)
...
(assert (not
 ...
 :qid |_07CounterThreadOwnershipdfy.427:18|
 :skolemid |1423|
 ...
 :qid |_07CounterThreadOwnershipdfy.427:18|
 :skolemid |1424|
)) (=> (and (and (_module.EmptyType.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.EmptyType.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1)) (or (_module.EmptyType.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))
