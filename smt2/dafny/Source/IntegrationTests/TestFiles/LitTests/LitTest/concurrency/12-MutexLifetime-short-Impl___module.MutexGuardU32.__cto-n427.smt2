...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split196)
...
)))) (and (and (= $Heap@10 $Heap@11) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11)) (and (= |##a#2@0| (_module.OwnedObject.lifetime |mutex#0|)) ($IsAlloc refType |##a#2@0| Tclass._module.Lifetime $Heap@11)))) (and (and (and ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@11) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|)) (and (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11))) (and (and ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@11) (= |##b#3@0| (_module.OwnedObject.lifetime this@@222))) (and ($IsAlloc refType |##b#3@0| Tclass._module.Lifetime $Heap@11) (= (ControlFlow 0 2) (- 0 1))))))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |mutexScope#0|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
