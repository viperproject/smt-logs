...
)) ($HeapSucc $Heap@34 $Heap@35))) (and (and (and (= $Heap@36 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0|) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|))))) ($IsGoodHeap $Heap@36)) (and ($IsAllocBox ($Box refType |remaining#0|) Tclass._module.OwnedObject? $Heap@36) ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap@33))) (and (and (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|) (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|)) (and (_module.OwnedObject.inv2 $Heap@33 $Heap@36 |remaining#0|) (= (ControlFlow 0 2) (- 0 1))))))))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
