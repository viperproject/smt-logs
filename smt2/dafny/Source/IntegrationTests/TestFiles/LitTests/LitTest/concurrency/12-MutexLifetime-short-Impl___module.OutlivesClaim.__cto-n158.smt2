...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@53 T@U) ($Heap@@86 T@U) (this@@122 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@53 $Heap@@86 this@@122) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@53) ($IsGoodHeap $Heap@@86)) ($HeapSucc $prevHeap@@53 $Heap@@86)) (and (or (not (= this@@122 null)) (not true)) (and ($Is refType this@@122 Tclass._module.OwnedObject) ($IsAlloc refType this@@122 Tclass._module.OwnedObject $prevHeap@@53)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@53 this@@122) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@86 this@@122) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@53 $Heap@@86 this@@122)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@53 $Heap@@86 this@@122)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@53 this@@122) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@86 this@@122) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@53 $Heap@@86 this@@122)))))
 :qid |_12MutexLifetimeshortdfy.437:22|
 :skolemid |1795|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@53 $Heap@@86 this@@122) ($IsGoodHeap $Heap@@86))
))))
...
(assert (forall (($ly@@15 T@U) ($h0@@32 T@U) ($h1@@32 T@U) (this@@123 T@U) (|a#0@@15| T@U) (|b#0@@15| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@123 null)) (not true)) ($Is refType this@@123 Tclass._module.Universe))) (or (|_module.Universe.outlives#canCall| $h0@@32 this@@123 |a#0@@15| |b#0@@15|) (and ($Is refType |a#0@@15| Tclass._module.Lifetime) ($Is refType |b#0@@15| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@73 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (or (or (= $o@@73 this@@123) (and (and ($Is refType $o@@73 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 this@@123) _module.Universe.content)) ($Box refType $o@@73))) (= $f@@43 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@73 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 this@@123) _module.Universe.content)) ($Box refType $o@@73))) (= $f@@43 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@73) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@73) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1215|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@124 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@124 null)) (not true)) ($Is refType this@@124 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@75 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (= $o@@75 this@@124)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@75) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@75) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1364|
...
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@125 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@125 null)) (not true)) ($Is refType this@@125 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@76 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (= $o@@76 this@@125)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@76) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@76) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1372|
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@87 T@U) (this@@130 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@87 this@@130) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@87) (and (or (not (= this@@130 null)) (not true)) (and ($Is refType this@@130 Tclass._module.Lifetime) ($IsAlloc refType this@@130 Tclass._module.Lifetime $Heap@@87)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@87 this@@130) (=> (_module.Object.objectGlobalBaseInv $Heap@@87 this@@130) (=> (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.elements)) ($Box refType |o#0@@10|))) (= (_module.OwnedObject.lifetime |o#0@@10|) this@@130))
...
))) (and (|_module.Lifetime.alive#canCall| $Heap@@87 this@@130) (=> (not (_module.Lifetime.alive $Heap@@87 this@@130)) (forall ((|l#1@@0| T@U) ) (!  (=> ($Is refType |l#1@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@87 |l#1@@0|)))
...
))) (=> (_module.Lifetime.alive $Heap@@87 this@@130) (forall ((|l#0@@4| T@U) ) (!  (=> (and ($Is refType |l#0@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|))) (_module.Lifetime.alive $Heap@@87 |l#0@@4|))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1972|
 :pattern ( (_module.Lifetime.alive $Heap@@87 |l#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@87 this@@130)) (forall ((|l#1@@1| T@U) ) (!  (=> (and ($Is refType |l#1@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|))) (not (_module.Lifetime.alive $Heap@@87 |l#1@@1|)))
 :qid |_12MutexLifetimeshortdfy.584:29|
 :skolemid |1973|
 :pattern ( (_module.Lifetime.alive $Heap@@87 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
)))) (forall ((|l#2@@0| T@U) ) (!  (=> (and ($Is refType |l#2@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |l#2@@0|) _module.Lifetime.mightPointFrom)) ($Box refType this@@130)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@130)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@130) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimeshortdfy.578:19|
 :skolemid |1984|
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@132 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@132 null)) (not true)) ($Is refType this@@132 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@78 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (= $o@@78 this@@132)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@78) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@78) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |1769|
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@133 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@133 null)) (not true)) ($Is refType this@@133 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@79 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (= $o@@79 this@@133)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@79) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@79) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |1874|
...
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@134 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@134 null)) (not true)) ($Is refType this@@134 Tclass._module.OutlivesClaim))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@80 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (= $o@@80 this@@134)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@80) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@80) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |2624|
...
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@135 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@135 null)) (not true)) (and ($Is refType this@@135 Tclass._module.Universe) ($IsAlloc refType this@@135 Tclass._module.Universe $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@82 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@82) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@82) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@82) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |830|
...
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@137 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@137 null)) (not true)) (and ($Is refType this@@137 Tclass._module.Object) ($IsAlloc refType this@@137 Tclass._module.Object $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@84 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@84) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@84) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |1351|
)) (= (_module.Object.objectGlobalInv $h0@@41 this@@137) (_module.Object.objectGlobalInv $h1@@41 this@@137))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1352|
 :pattern ( ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41) (_module.Object.objectGlobalInv $h1@@41 this@@137))
)))
...
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@140 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@140 null)) (not true)) (and ($Is refType this@@140 Tclass._module.Thread) ($IsAlloc refType this@@140 Tclass._module.Thread $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@87 T@U) ($f@@55 T@U) ) (!  (=> (and (or (not (= $o@@87 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@87) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@87) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@87) $f@@55)))
 :qid |unknown.0:0|
 :skolemid |1516|
)) (= (_module.Thread.localInv $h0@@44 this@@140) (_module.Thread.localInv $h1@@44 this@@140))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1517|
 :pattern ( ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44) (_module.Thread.localInv $h1@@44 this@@140))
)))
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@141 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@141 null)) (not true)) (and ($Is refType this@@141 Tclass._module.Thread) ($IsAlloc refType this@@141 Tclass._module.Thread $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@88 T@U) ($f@@56 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@88) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@88) $f@@56)))
 :qid |unknown.0:0|
 :skolemid |1528|
)) (= (_module.Thread.inv $h0@@45 this@@141) (_module.Thread.inv $h1@@45 this@@141))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1529|
 :pattern ( ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45) (_module.Thread.inv $h1@@45 this@@141))
)))
(assert (forall (($h0@@46 T@U) ($h1@@46 T@U) (this@@142 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@46) ($IsGoodHeap $h1@@46)) (and (or (not (= this@@142 null)) (not true)) (and ($Is refType this@@142 Tclass._module.OwnedObject) ($IsAlloc refType this@@142 Tclass._module.OwnedObject $h0@@46)))) (and ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46))) (=> (forall (($o@@89 T@U) ($f@@57 T@U) ) (!  (=> (and (or (not (= $o@@89 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@89) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@89) $f@@57) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@46 $o@@89) $f@@57)))
 :qid |unknown.0:0|
 :skolemid |1797|
)) (= (_module.OwnedObject.localInv $h0@@46 this@@142) (_module.OwnedObject.localInv $h1@@46 this@@142))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1798|
 :pattern ( ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46) (_module.OwnedObject.localInv $h1@@46 this@@142))
)))
(assert (forall (($h0@@47 T@U) ($h1@@47 T@U) (this@@143 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@47) ($IsGoodHeap $h1@@47)) (and (or (not (= this@@143 null)) (not true)) (and ($Is refType this@@143 Tclass._module.OwnedObject) ($IsAlloc refType this@@143 Tclass._module.OwnedObject $h0@@47)))) (and ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47))) (=> (forall (($o@@90 T@U) ($f@@58 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@90) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@47 $o@@90) $f@@58)))
 :qid |unknown.0:0|
 :skolemid |1811|
)) (= (_module.OwnedObject.inv $h0@@47 this@@143) (_module.OwnedObject.inv $h1@@47 this@@143))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1812|
 :pattern ( ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47) (_module.OwnedObject.inv $h1@@47 this@@143))
)))
(assert (forall (($h0@@48 T@U) ($h1@@48 T@U) (this@@144 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@48) ($IsGoodHeap $h1@@48)) (and (or (not (= this@@144 null)) (not true)) (and ($Is refType this@@144 Tclass._module.OwnedObject) ($IsAlloc refType this@@144 Tclass._module.OwnedObject $h0@@48)))) (and ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48))) (=> (forall (($o@@91 T@U) ($f@@59 T@U) ) (!  (=> (and (or (not (= $o@@91 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@91) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@91) $f@@59) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@48 $o@@91) $f@@59)))
 :qid |unknown.0:0|
 :skolemid |1883|
)) (= (_module.OwnedObject.localUserInv $h0@@48 this@@144) (_module.OwnedObject.localUserInv $h1@@48 this@@144))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1884|
 :pattern ( ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48) (_module.OwnedObject.localUserInv $h1@@48 this@@144))
)))
(assert (forall (($h0@@49 T@U) ($h1@@49 T@U) (this@@145 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@49) ($IsGoodHeap $h1@@49)) (and (or (not (= this@@145 null)) (not true)) (and ($Is refType this@@145 Tclass._module.OwnedObject) ($IsAlloc refType this@@145 Tclass._module.OwnedObject $h0@@49)))) (and ($IsHeapAnchor $h0@@49) ($HeapSucc $h0@@49 $h1@@49))) (=> (forall (($o@@92 T@U) ($f@@60 T@U) ) (!  (=> (and (or (not (= $o@@92 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@49 $o@@92) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@49 $o@@92) $f@@60) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@49 $o@@92) $f@@60)))
 :qid |unknown.0:0|
 :skolemid |1891|
)) (= (_module.OwnedObject.userInv $h0@@49 this@@145) (_module.OwnedObject.userInv $h1@@49 this@@145))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1892|
 :pattern ( ($IsHeapAnchor $h0@@49) ($HeapSucc $h0@@49 $h1@@49) (_module.OwnedObject.userInv $h1@@49 this@@145))
)))
(assert (forall (($h0@@50 T@U) ($h1@@50 T@U) (this@@146 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@50) ($IsGoodHeap $h1@@50)) (and (or (not (= this@@146 null)) (not true)) (and ($Is refType this@@146 Tclass._module.Lifetime) ($IsAlloc refType this@@146 Tclass._module.Lifetime $h0@@50)))) (and ($IsHeapAnchor $h0@@50) ($HeapSucc $h0@@50 $h1@@50))) (=> (forall (($o@@93 T@U) ($f@@61 T@U) ) (!  (=> (and (or (not (= $o@@93 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@50 $o@@93) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@50 $o@@93) $f@@61) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@50 $o@@93) $f@@61)))
 :qid |unknown.0:0|
 :skolemid |1966|
)) (= (_module.Lifetime.localInv $h0@@50 this@@146) (_module.Lifetime.localInv $h1@@50 this@@146))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1967|
 :pattern ( ($IsHeapAnchor $h0@@50) ($HeapSucc $h0@@50 $h1@@50) (_module.Lifetime.localInv $h1@@50 this@@146))
)))
(assert (forall (($h0@@51 T@U) ($h1@@51 T@U) (this@@147 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@51) ($IsGoodHeap $h1@@51)) (and (or (not (= this@@147 null)) (not true)) (and ($Is refType this@@147 Tclass._module.Lifetime) ($IsAlloc refType this@@147 Tclass._module.Lifetime $h0@@51)))) (and ($IsHeapAnchor $h0@@51) ($HeapSucc $h0@@51 $h1@@51))) (=> (forall (($o@@94 T@U) ($f@@62 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@51 $o@@94) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@51 $o@@94) $f@@62) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@51 $o@@94) $f@@62)))
 :qid |unknown.0:0|
 :skolemid |2033|
)) (= (_module.Lifetime.inv $h0@@51 this@@147) (_module.Lifetime.inv $h1@@51 this@@147))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2034|
 :pattern ( ($IsHeapAnchor $h0@@51) ($HeapSucc $h0@@51 $h1@@51) (_module.Lifetime.inv $h1@@51 this@@147))
)))
(assert (forall (($h0@@52 T@U) ($h1@@52 T@U) (this@@148 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@52) ($IsGoodHeap $h1@@52)) (and (or (not (= this@@148 null)) (not true)) (and ($Is refType this@@148 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@148 Tclass._module.OutlivesClaim $h0@@52)))) (and ($IsHeapAnchor $h0@@52) ($HeapSucc $h0@@52 $h1@@52))) (=> (forall (($o@@95 T@U) ($f@@63 T@U) ) (!  (=> (and (or (not (= $o@@95 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@52 $o@@95) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@52 $o@@95) $f@@63) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@52 $o@@95) $f@@63)))
 :qid |unknown.0:0|
 :skolemid |2639|
)) (= (_module.OutlivesClaim.localUserInv $h0@@52 this@@148) (_module.OutlivesClaim.localUserInv $h1@@52 this@@148))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2640|
 :pattern ( ($IsHeapAnchor $h0@@52) ($HeapSucc $h0@@52 $h1@@52) (_module.OutlivesClaim.localUserInv $h1@@52 this@@148))
)))
(assert (forall (($h0@@53 T@U) ($h1@@53 T@U) (this@@149 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@53) ($IsGoodHeap $h1@@53)) (and (or (not (= this@@149 null)) (not true)) (and ($Is refType this@@149 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@149 Tclass._module.OutlivesClaim $h0@@53)))) (and ($IsHeapAnchor $h0@@53) ($HeapSucc $h0@@53 $h1@@53))) (=> (forall (($o@@96 T@U) ($f@@64 T@U) ) (!  (=> (and (or (not (= $o@@96 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@53 $o@@96) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@53 $o@@96) $f@@64) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@53 $o@@96) $f@@64)))
 :qid |unknown.0:0|
 :skolemid |2648|
)) (= (_module.OutlivesClaim.userInv $h0@@53 this@@149) (_module.OutlivesClaim.userInv $h1@@53 this@@149))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2649|
 :pattern ( ($IsHeapAnchor $h0@@53) ($HeapSucc $h0@@53 $h1@@53) (_module.OutlivesClaim.userInv $h1@@53 this@@149))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@150 T@U) ) (!  (=> (or (|_module.OutlivesClaim.volatileOwns#canCall| this@@150) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@150 null)) (not true)) ($Is refType this@@150 Tclass._module.OutlivesClaim)))) (= (_module.OutlivesClaim.volatileOwns this@@150) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimeshortdfy.686:19|
 :skolemid |2620|
 :pattern ( (_module.OutlivesClaim.volatileOwns this@@150))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@151 T@U) ) (!  (=> (or (|_module.OutlivesClaim.volatileOwns#canCall| this@@151) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@151 null)) (not true)) ($Is refType this@@151 Tclass._module.OutlivesClaim)))) (= (_module.OwnedObject.volatileOwns this@@151) (_module.OutlivesClaim.volatileOwns this@@151)))
 :qid |_12MutexLifetimeshortdfy.517:19|
 :skolemid |2622|
 :pattern ( (_module.OwnedObject.volatileOwns this@@151) ($Is refType this@@151 Tclass._module.OutlivesClaim))
 :pattern ( (_module.OwnedObject.volatileOwns this@@151) (_module.OutlivesClaim.volatileOwns this@@151))
))))
...
(assert  (=> (<= 16 $FunctionContextHeight) (forall (($prevHeap@@54 T@U) ($Heap@@89 T@U) (this@@155 T@U) ) (!  (=> (or (|_module.Universe.globalInv2#canCall| $prevHeap@@54 $Heap@@89 this@@155) (and (< 16 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@54) ($IsGoodHeap $Heap@@89)) ($HeapSucc $prevHeap@@54 $Heap@@89)) (and (or (not (= this@@155 null)) (not true)) (and ($Is refType this@@155 Tclass._module.Universe) ($IsAlloc refType this@@155 Tclass._module.Universe $prevHeap@@54)))))) (and (forall ((|o#0@@12| T@U) ) (!  (=> ($Is refType |o#0@@12| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@155) _module.Universe.content)) ($Box refType |o#0@@12|)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@89 this@@155) _module.Universe.content)) ($Box refType |o#0@@12|)) (|_module.Object.inv2#canCall| $prevHeap@@54 $Heap@@89 |o#0@@12|))))
 :qid |_12MutexLifetimeshortdfy.33:12|
 :skolemid |858|
 :pattern ( (_module.Object.inv2 $prevHeap@@54 $Heap@@89 |o#0@@12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@89 this@@155) _module.Universe.content)) ($Box refType |o#0@@12|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@155) _module.Universe.content)) ($Box refType |o#0@@12|)))
)) (= (_module.Universe.globalInv2 $prevHeap@@54 $Heap@@89 this@@155) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@155) _module.Universe.content)) ($Box refType |o#0@@13|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@89 this@@155) _module.Universe.content)) ($Box refType |o#0@@13|)) (_module.Object.inv2 $prevHeap@@54 $Heap@@89 |o#0@@13|)))
 :qid |_12MutexLifetimeshortdfy.33:12|
 :skolemid |857|
 :pattern ( (_module.Object.inv2 $prevHeap@@54 $Heap@@89 |o#0@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@89 this@@155) _module.Universe.content)) ($Box refType |o#0@@13|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@155) _module.Universe.content)) ($Box refType |o#0@@13|)))
)))))
 :qid |_12MutexLifetimeshortdfy.32:22|
 :skolemid |859|
 :pattern ( (_module.Universe.globalInv2 $prevHeap@@54 $Heap@@89 this@@155) ($IsGoodHeap $Heap@@89))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@156 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@156) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@156 null)) (not true)) ($Is refType this@@156 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@156) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :skolemid |1496|
 :pattern ( (_module.Thread.objectClassKind this@@156))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@157 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@157) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@157 null)) (not true)) ($Is refType this@@157 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@157) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :skolemid |1763|
 :pattern ( (_module.OwnedObject.objectClassKind this@@157))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@158 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@158) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@158 null)) (not true)) ($Is refType this@@158 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@158) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :skolemid |1941|
 :pattern ( (_module.Lifetime.objectClassKind this@@158))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@159 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@159) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@159 null)) (not true)) ($Is refType this@@159 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@159) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1418|
 :pattern ( (_module.Object.objectClassKind this@@159))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@55 T@U) ($Heap@@90 T@U) (this@@160 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv2#canCall| $prevHeap@@55 $Heap@@90 this@@160) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@55) ($IsGoodHeap $Heap@@90)) ($HeapSucc $prevHeap@@55 $Heap@@90)) (and (or (not (= this@@160 null)) (not true)) (and ($Is refType this@@160 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@160 Tclass._module.OutlivesClaim $prevHeap@@55)))))) (=> (_module.OutlivesClaim.userInv2 $prevHeap@@55 $Heap@@90 this@@160) (_module.OutlivesClaim.localUserInv2 $prevHeap@@55 $Heap@@90 this@@160)))
 :qid |_12MutexLifetimeshortdfy.699:22|
 :skolemid |2673|
 :pattern ( (_module.OutlivesClaim.userInv2 $prevHeap@@55 $Heap@@90 this@@160))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($prevHeap@@56 T@U) ($Heap@@91 T@U) (this@@161 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv2#canCall| $prevHeap@@56 $Heap@@91 this@@161) (and (< 13 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@56) ($IsGoodHeap $Heap@@91)) ($HeapSucc $prevHeap@@56 $Heap@@91)) (and (or (not (= this@@161 null)) (not true)) (and ($Is refType this@@161 Tclass._module.OwnedObject) ($IsAlloc refType this@@161 Tclass._module.OwnedObject $prevHeap@@56)))))) (=> (_module.OwnedObject.userInv2 $prevHeap@@56 $Heap@@91 this@@161) (_module.OwnedObject.localUserInv2 $prevHeap@@56 $Heap@@91 this@@161)))
 :qid |_12MutexLifetimeshortdfy.523:22|
 :skolemid |1897|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@56 $Heap@@91 this@@161))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@92 T@U) (this@@162 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@92 this@@162) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@92) (and (or (not (= this@@162 null)) (not true)) (and ($Is refType this@@162 Tclass._module.Thread) ($IsAlloc refType this@@162 Tclass._module.Thread $Heap@@92)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@92 this@@162)) (= (_module.Thread.localInv $Heap@@92 this@@162)  (and true (_module.Object.objectGlobalBaseInv $Heap@@92 this@@162)))))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1520|
 :pattern ( (_module.Thread.localInv $Heap@@92 this@@162) ($IsGoodHeap $Heap@@92))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@93 T@U) (this@@163 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@93 this@@163) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@93) (and (or (not (= this@@163 null)) (not true)) (and ($Is refType this@@163 Tclass._module.Thread) ($IsAlloc refType this@@163 Tclass._module.Thread $Heap@@93)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@93 this@@163)) (= (_module.Thread.inv $Heap@@93 this@@163)  (and true (_module.Thread.localInv $Heap@@93 this@@163)))))
 :qid |_12MutexLifetimeshortdfy.371:19|
 :skolemid |1532|
 :pattern ( (_module.Thread.inv $Heap@@93 this@@163) ($IsGoodHeap $Heap@@93))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@164 T@U) ) (!  (=> (or (|_module.OutlivesClaim.volatileOwns#canCall| (Lit refType this@@164)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@164 null)) (not true)) ($Is refType this@@164 Tclass._module.OutlivesClaim)))) (= (_module.OutlivesClaim.volatileOwns (Lit refType this@@164)) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimeshortdfy.686:19|
 :weight 3
 :skolemid |2621|
 :pattern ( (_module.OutlivesClaim.volatileOwns (Lit refType this@@164)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@94 T@U) (this@@165 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@94 this@@165) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@94) (and (or (not (= this@@165 null)) (not true)) (and ($Is refType this@@165 Tclass._module.OwnedObject) ($IsAlloc refType this@@165 Tclass._module.OwnedObject $Heap@@94)))))) (= (_module.OwnedObject.alive $Heap@@94 this@@165)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@165) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.421:19|
 :skolemid |1762|
 :pattern ( (_module.OwnedObject.alive $Heap@@94 this@@165) ($IsGoodHeap $Heap@@94))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@95 T@U) (this@@166 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@95 this@@166) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@95) (and (or (not (= this@@166 null)) (not true)) (and ($Is refType this@@166 Tclass._module.Lifetime) ($IsAlloc refType this@@166 Tclass._module.Lifetime $Heap@@95)))))) (= (_module.Lifetime.alive $Heap@@95 this@@166)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.551:19|
 :skolemid |1920|
 :pattern ( (_module.Lifetime.alive $Heap@@95 this@@166) ($IsGoodHeap $Heap@@95))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@96 T@U) (this@@167 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@96 this@@167) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@96) (and (or (not (= this@@167 null)) (not true)) (and ($Is refType this@@167 Tclass._module.Lifetime) ($IsAlloc refType this@@167 Tclass._module.Lifetime $Heap@@96)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@96 this@@167)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 this@@167) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@167)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 this@@167) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 this@@167) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@167)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 this@@167) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@167)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 this@@167) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@167)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.563:19|
 :skolemid |1951|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@96 this@@167) ($IsGoodHeap $Heap@@96))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@57 T@U) ($Heap@@97 T@U) (this@@168 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@57 $Heap@@97 this@@168) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@57) ($IsGoodHeap $Heap@@97)) ($HeapSucc $prevHeap@@57 $Heap@@97)) (and (or (not (= this@@168 null)) (not true)) (and ($Is refType this@@168 Tclass._module.OwnedObject) ($IsAlloc refType this@@168 Tclass._module.OwnedObject $prevHeap@@57)))))) (and (=> (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 this@@168) _module.OwnedObject.owner)) null)) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 this@@168) _module.OwnedObject.nonvolatileVersion)))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 this@@168) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@57 $Heap@@97 this@@168))) (=> (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 this@@168) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@57 $Heap@@97 this@@168))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.owner))))
(|_module.OwnedObject.volatileOwns#canCall| |oldOwner#0|))))))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@57 $Heap@@97 this@@168)  (and (and (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 this@@168) _module.OwnedObject.owner)) null)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 this@@168) _module.OwnedObject.nonvolatileVersion))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 this@@168) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@57 $Heap@@97 this@@168)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#0@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@168) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 this@@168) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_12MutexLifetimeshortdfy.457:22|
 :skolemid |1836|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@57 $Heap@@97 this@@168) ($IsGoodHeap $Heap@@97))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@58 T@U) ($Heap@@98 T@U) (this@@169 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv2#canCall| $prevHeap@@58 $Heap@@98 this@@169) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@58) ($IsGoodHeap $Heap@@98)) ($HeapSucc $prevHeap@@58 $Heap@@98)) (and (or (not (= this@@169 null)) (not true)) (and ($Is refType this@@169 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@169 Tclass._module.OutlivesClaim $prevHeap@@58)))))) (and (|_module.OutlivesClaim.localUserInv2#canCall| $prevHeap@@58 $Heap@@98 this@@169) (= (_module.OutlivesClaim.userInv2 $prevHeap@@58 $Heap@@98 this@@169) (_module.OutlivesClaim.localUserInv2 $prevHeap@@58 $Heap@@98 this@@169))))
 :qid |_12MutexLifetimeshortdfy.699:22|
 :skolemid |2675|
 :pattern ( (_module.OutlivesClaim.userInv2 $prevHeap@@58 $Heap@@98 this@@169) ($IsGoodHeap $Heap@@98))
))))
...
(set-info :boogie-vc-id Impl$$_module.OutlivesClaim.__ctor_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@99) ($IsHeapAnchor $Heap@@99)) (=> (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@99)) (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@99))) (=> (and (and (and (and (and ($Is refType |target#0| Tclass._module.Lifetime) ($IsAlloc refType |target#0| Tclass._module.Lifetime $Heap@@99)) (and ($Is refType |source#0| Tclass._module.Lifetime) ($IsAlloc refType |source#0| Tclass._module.Lifetime $Heap@@99))) (and (and (=> |defass#lifetime#0| (and ($Is refType |lifetime#0| Tclass._module.Lifetime) ($IsAlloc refType |lifetime#0| Tclass._module.Lifetime $Heap@@99))) true) (= 23 $FunctionContextHeight))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@99 |universe#0|) (and (_module.Universe.globalInv $Heap@@99 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@@99 |o#10|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |2870|
 :pattern ( (_module.Object.inv $Heap@@99 |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#10|)))
))))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |target#0|)) ($Box refType |source#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |target#0|) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |source#0|) _module.Lifetime.owner))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |source#0|) _module.Lifetime.owner)) |running#0@@3|)))) (and (and (and (and (|_module.Universe.outlives#canCall| $Heap@@99 |universe#0| |target#0| |source#0|) (and (_module.Universe.outlives ($LS $LZ) $Heap@@99 |universe#0| |target#0| |source#0|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |source#0|) _module.Lifetime.mightPointTo)) ($Box refType |target#0|)) (exists ((|x#1| T@U) ) (!  (and (and ($Is refType |x#1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |x#1|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@99 |universe#0| |target#0| |x#1| |source#0|))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |2872|
 :pattern ( (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@99 |universe#0| |target#0| |x#1| |source#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |x#1|)))
))))) (= $_ModifiesFrame@0 (|lambda#213| null $Heap@@99 alloc |universe#0| |target#0| _module.Lifetime.mightPointFrom |source#0| _module.Lifetime.mightPointFrom))) (and (= |mightPointTo##0@0| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |target#0|)) ($Box refType |source#0|))) (forall (($o@@107 T@U) ($f@@65 T@U) ) (!  (=> (and (and (or (not (= $o@@107 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@107) alloc)))) (or (= $o@@107 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@107)) (= $f@@65 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@107 $f@@65)))
 :qid |_12MutexLifetimeshortdfy.735:21|
 :skolemid |2893|
)))) (and (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass._module.Lifetime) ($IsAlloc refType call5formal@this Tclass._module.Lifetime $Heap@@99))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalInv $Heap@@99 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalInv $Heap@@99 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (forall ((|o#0@@14| T@U) ) (!  (=> (and ($Is refType |o#0@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|))) (and (and (and (= (_module.Object.universe |o#0@@14|) |universe#0|) (or (not (= |o#0@@14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@99 |o#0@@14|)) (_module.Object.triggerAxioms $Heap@@99 |o#0@@14|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2275|
 :pattern ( (_module.Object.triggerAxioms $Heap@@99 |o#0@@14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@99 |o#0@@14|))
 :pattern ( (_module.Object.universe |o#0@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|)))
)))))))))) (=> (and (and (and (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalInv $Heap@@99 |universe#0|) (forall ((|o#1@@6| T@U) ) (!  (=> (and ($Is refType |o#1@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@6|))) (_module.Object.inv $Heap@@99 |o#1@@6|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |2277|
 :pattern ( (_module.Object.inv $Heap@@99 |o#1@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@6|)))
)))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)))) (and (|Set#Subset| |mightPointTo##0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content))) (forall ((|l#1@@2| T@U) ) (!  (=> (and ($Is refType |l#1@@2| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@2|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@2|) _module.Lifetime.owner)) |running#0@@3|))
 :qid |_12MutexLifetimeshortdfy.611:21|
 :skolemid |2279|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@2|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@2|)))
)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (or (not (= call5formal@this@0 null)) (not true)) (and ($Is refType call5formal@this@0 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@0 Tclass._module.Lifetime $Heap@0))))) (and (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 call5formal@this@0) (=> (_module.Object.objectGlobalInv $Heap@0 call5formal@this@0) (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@0 |universe#0| |running#0@@3|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 call5formal@this@0) (and (_module.Object.objectGlobalInv $Heap@0 call5formal@this@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe call5formal@this@0)) _module.Universe.content)) ($Box refType call5formal@this@0)) (_module.Universe.globalInv $Heap@0 (_module.Object.universe call5formal@this@0)))))) (and (and (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@0 |universe#0| |running#0@@3|) (and (_module.Universe.legalTransition $Heap@@99 $Heap@0 |universe#0| |running#0@@3|) (and (and (and (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@@99 |universe#0|)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#11|))) (and (or (forall (($o@@108 T@U) ($f@@66 T@U) ) (!  (=> (or (not (= $o@@108 null)) (not true)) (=> (= $o@@108 |o#11|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@108) $f@@66) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@108) $f@@66))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |2306|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@108) $f@@66))
)) (_module.Object.inv $Heap@0 |o#11|)) (or (forall (($o@@109 T@U) ($f@@67 T@U) ) (!  (=> (or (not (= $o@@109 null)) (not true)) (=> (= $o@@109 |o#11|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@109) $f@@67) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@109) $f@@67))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |2307|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@109) $f@@67))
)) (_module.Object.inv2 $Heap@@99 $Heap@0 |o#11|))))
 :qid |_12MutexLifetimeshortdfy.82:16|
 :skolemid |2308|
 :pattern ( (_module.Object.inv2 $Heap@@99 $Heap@0 |o#11|))
 :pattern ( (_module.Object.inv $Heap@0 |o#11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#11|)))
))) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#12|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#12|))))) (_module.Object.inv $Heap@0 |o#12|))
 :qid |_12MutexLifetimeshortdfy.84:16|
 :skolemid |2309|
 :pattern ( (_module.Object.inv $Heap@0 |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#12|)))
...
))))) (= (_module.Object.universe call5formal@this@0) |universe#0|)))) (and (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.elements)) |Set#Empty|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.mightPointTo)) |mightPointTo##0@0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.mightPointFrom)) |Set#Empty|))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (forall ((|l#3@@1| T@U) ) (!  (=> (and ($Is refType |l#3@@1| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#3@@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))))
 :qid |_12MutexLifetimeshortdfy.617:20|
 :skolemid |2310|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#3@@1|) _module.Lifetime.mightPointFrom)))
...
))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 call5formal@this@0) alloc)))) (forall (($o@@110 T@U) ) (!  (=> (and (or (not (= $o@@110 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@110) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@110) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@110)) (or (= $o@@110 |universe#0|) (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@110)))))
 :qid |_12MutexLifetimeshortdfy.609:3|
 :skolemid |2311|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@110))
))))) (and (and (and (forall (($o@@111 T@U) ($f@@68 T@U) ) (!  (=> (and (or (not (= $o@@111 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@111) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111) $f@@68) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@111) $f@@68)) (or (= $o@@111 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@111)) (= $f@@68 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimeshortdfy.609:3|
 :skolemid |2312|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111) $f@@68))
)) ($HeapSucc $Heap@@99 $Heap@0)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@99))) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))) (forall ((|l#1@@3| T@U) ) (!  (=> (and ($Is refType |l#1@@3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@3|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@3|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@3|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@3|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@3|) _module.Lifetime.mightPointTo)))))
 ...
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@3|) _module.Lifetime.mightPointTo)))
 ...
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@3|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@3|)))
))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))))) (and (and (and (and (and (forall ((|a#1| T@U) (|b#1| T@U) ) (!  (=> (and ($Is refType |a#1| Tclass._module.Lifetime) ($Is refType |b#1| Tclass._module.Lifetime)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |a#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |b#1|))) (and (|_module.Universe.outlives#canCall| $Heap@@99 |universe#0| |a#1| |b#1|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@@99 |universe#0| |a#1| |b#1|) (|_module.Universe.outlives#canCall| $Heap@0 |universe#0| |a#1| |b#1|)))))
 :qid |_12MutexLifetimeshortdfy.201:20|
 :skolemid |1296|
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1| |b#1|))
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@@99 |universe#0| |a#1| |b#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |b#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |a#1|)))
)) (forall ((|a#1@@0| T@U) (|b#1@@0| T@U) ) (!  (=> (and (and ($Is refType |a#1@@0| Tclass._module.Lifetime) ($Is refType |b#1@@0| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@0|)))) (=> (_module.Universe.outlives ($LS $LZ) $Heap@@99 |universe#0| |a#1@@0| |b#1@@0|) (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1@@0| |b#1@@0|)))
 :qid |_12MutexLifetimeshortdfy.201:20|
 :skolemid |1298|
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1@@0| |b#1@@0|))
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@@99 |universe#0| |a#1@@0| |b#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@0|)))
))) (and (= $Heap@0 $Heap@1) (or (not (= |universe#0| null)) (not true)))) (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@99) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@99)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@99) (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))) (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (forall ((|o#0@@15| T@U) ) (!  (=> (and ($Is refType |o#0@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@15|))) (and (and (and (= (_module.Object.universe |o#0@@15|) |universe#0|) (or (not (= |o#0@@15| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@99 |o#0@@15|)) (_module.Object.triggerAxioms $Heap@@99 |o#0@@15|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |995|
 :pattern ( (_module.Object.triggerAxioms $Heap@@99 |o#0@@15|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@99 |o#0@@15|))
 :pattern ( (_module.Object.universe |o#0@@15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@15|)))
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (forall ((|o#1@@7| T@U) ) (!  (=> (and ($Is refType |o#1@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@7|))) (and (and (and (= (_module.Object.universe |o#1@@7|) |universe#0|) (or (not (= |o#1@@7| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@1 |o#1@@7|)) (_module.Object.triggerAxioms $Heap@1 |o#1@@7|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |997|
...
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@1 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content))))))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@1 |universe#0|) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#2|)))) (not ($IsAllocBox ($Box refType |o#2|) Tclass._module.Object $Heap@@99)))
 :qid |_12MutexLifetimeshortdfy.44:16|
 :skolemid |999|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#2|)))
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#3|)))) (or (forall (($o@@112 T@U) ($f@@69 T@U) ) (!  (=> (or (not (= $o@@112 null)) (not true)) (=> (= $o@@112 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@112) $f@@69) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@112) $f@@69))))
 :qid |_12MutexLifetimeshortdfy.59:65|
 :skolemid |1001|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@112) $f@@69))
)) (_module.Object.sequenceInv2 $Heap@@99 $Heap@1 |o#3|)))
 :qid |_12MutexLifetimeshortdfy.59:16|
 :skolemid |1002|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@99 $Heap@1 |o#3|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#3|)))
)))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#4|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#4|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#4|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#4|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@99)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#4|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#4|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimeshortdfy.62:16|
 :skolemid |1003|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#4|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#4|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#4|)))
)))))))))) (and (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#0@@5| T@U) ) (!  (=> (and ($Is refType |l#0@@5| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@5|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#0@@5|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#0@@5|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@99)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@99 $Heap@1 |l#0@@5|)))
 :qid |_12MutexLifetimeshortdfy.68:16|
 :skolemid |1004|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@99 $Heap@1 |l#0@@5|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#0@@5|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@5|)))
)))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalInv $Heap@@99 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalInv $Heap@@99 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#5|))) (and (and (and (= (_module.Object.universe |o#5|) |universe#0|) (or (not (= |o#5| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@99 |o#5|)) (_module.Object.triggerAxioms $Heap@@99 |o#5|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1009|
 :pattern ( (_module.Object.triggerAxioms $Heap@@99 |o#5|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@99 |o#5|))
 :pattern ( (_module.Object.universe |o#5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#5|)))
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalInv $Heap@@99 |universe#0|) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#6|))) (_module.Object.inv $Heap@@99 |o#6|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1011|
 :pattern ( (_module.Object.inv $Heap@@99 |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#6|)))
)))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#7|))) (and (or (forall (($o@@113 T@U) ($f@@70 T@U) ) (!  (=> (or (not (= $o@@113 null)) (not true)) (=> (= $o@@113 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@113) $f@@70) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@113) $f@@70))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1013|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@113) $f@@70))
)) (_module.Object.inv $Heap@1 |o#7|)) (or (forall (($o@@114 T@U) ($f@@71 T@U) ) (!  (=> (or (not (= $o@@114 null)) (not true)) (=> (= $o@@114 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@114) $f@@71) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@114) $f@@71))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1014|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@114) $f@@71))
)) (_module.Object.inv2 $Heap@@99 $Heap@1 |o#7|))))
 :qid |_12MutexLifetimeshortdfy.82:16|
 :skolemid |1015|
 :pattern ( (_module.Object.inv2 $Heap@@99 $Heap@1 |o#7|))
 :pattern ( (_module.Object.inv $Heap@1 |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#7|)))
)))) (=> (|_module.Universe.legalTransition#canCall| $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@99 $Heap@1 |universe#0| |running#0@@3|) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#8|))))) (_module.Object.inv $Heap@1 |o#8|))
 :qid |_12MutexLifetimeshortdfy.84:16|
 :skolemid |1016|
 :pattern ( (_module.Object.inv $Heap@1 |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)))
...
))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (=> (_module.Universe.globalInv $Heap@1 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@@99 $Heap@1 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (and (_module.Universe.globalInv $Heap@1 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@1 |o#10@@0|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1024|
...
)))))) (and (and (|_module.Universe.globalInv2#canCall| $Heap@@99 $Heap@1 |universe#0|) (and (_module.Universe.globalInv2 $Heap@@99 $Heap@1 |universe#0|) (forall ((|o#11@@0| T@U) ) (!  (=> (and ($Is refType |o#11@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@0|)) (_module.Object.inv2 $Heap@@99 $Heap@1 |o#11@@0|)))
 :qid |_12MutexLifetimeshortdfy.33:12|
 :skolemid |1026|
 :pattern ( (_module.Object.inv2 $Heap@@99 $Heap@1 |o#11@@0|))
...
)) (= $Heap@2 $Heap@3))) (and (=> (= (ControlFlow 0 2) (- 0 36)) true) (and (=> (= (ControlFlow 0 2) (- 0 35)) true) (and (=> (= (ControlFlow 0 2) (- 0 34)) true) (and (=> (= (ControlFlow 0 2) (- 0 33)) true) (and (=> (= (ControlFlow 0 2) (- 0 32)) true) (=> (and (and (or (not (= this@@170 null)) (not true)) ($Is refType this@@170 Tclass._module.OutlivesClaim?)) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@170) alloc)))) (= (_module.OwnedObject.lifetime this@@170) call5formal@this@0))) (=> (and (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@170) _module.OwnedObject.nonvolatileVersion))) this.nonvolatileVersion) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@170) _module.OwnedObject.owner)) |running#0@@3|)) (and (= (_module.Object.universe this@@170) |universe#0|) (= (_module.OutlivesClaim.target this@@170) |target#0|))) (and (and (= (_module.OutlivesClaim.source this@@170) |source#0|) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@170 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@170) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (forall (($o@@115 T@U) ($f@@72 T@U) ) (!  (=> (and (and (or (not (= $o@@115 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@115) alloc)))) (= $o@@115 (_module.Object.universe this@@170))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@115 $f@@72)))
 :qid |_12MutexLifetimeshortdfy.749:9|
 :skolemid |2897|
))) (=> (forall (($o@@116 T@U) ($f@@73 T@U) ) (!  (=> (and (and (or (not (= $o@@116 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@116) alloc)))) (= $o@@116 (_module.Object.universe this@@170))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@116 $f@@73)))
 :qid |_12MutexLifetimeshortdfy.749:9|
 :skolemid |2897|
)) (and (=> (= (ControlFlow 0 2) (- 0 30)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@170)) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@170)) (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@170)) (forall ((|o#0@@18| T@U) ) (!  (=> (and ($Is refType |o#0@@18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#0@@18|))) (and (and (and (= (_module.Object.universe |o#0@@18|) (_module.Object.universe this@@170)) (or (not (= |o#0@@18| (_module.Object.universe this@@170))) (not true))) (_module.Object.baseFieldsInv $Heap@4 |o#0@@18|)) (_module.Object.triggerAxioms $Heap@4 |o#0@@18|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1380|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#0@@18|)))
))))) (=> (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@170)) (forall ((|o#0@@19| T@U) ) (!  (=> (and ($Is refType |o#0@@19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#0@@19|))) (and (and (and (= (_module.Object.universe |o#0@@19|) (_module.Object.universe this@@170)) (or (not (= |o#0@@19| (_module.Object.universe this@@170))) (not true))) (_module.Object.baseFieldsInv $Heap@4 |o#0@@19|)) (_module.Object.triggerAxioms $Heap@4 |o#0@@19|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1380|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#0@@19|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (_module.Object.baseFieldsInv $Heap@4 this@@170)) (=> (_module.Object.baseFieldsInv $Heap@4 this@@170) (and (=> (= (ControlFlow 0 2) (- 0 27)) (or (not (= this@@170 (_module.Object.universe this@@170))) (not true))) (=> (or (not (= this@@170 (_module.Object.universe this@@170))) (not true)) (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@5 this@@170)) (=> (and (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@5 this@@170) (and (_module.Object.objectGlobalBaseInv $Heap@5 this@@170) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType this@@170)) (_module.Object.baseFieldsInv $Heap@5 this@@170)) (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@170))))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@170)) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@170)) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@170))))) (and (forall (($o@@117 T@U) ) (!  (=> (and (or (not (= $o@@117 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@117) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@117) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@117)) (= $o@@117 (_module.Object.universe this@@170))))
 :qid |_12MutexLifetimeshortdfy.320:10|
 :skolemid |1384|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@117))
)) ($HeapSucc $Heap@4 $Heap@5))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (or (not (= call5formal@this@0 null)) (not true))) (=> (or (not (= call5formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 25)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Lifetime.elements))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Lifetime.elements)) (=> (= |$rhs#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@170))) (=> (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 call5formal@this@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call5formal@this@0) _module.Lifetime.elements ($Box SetType |$rhs#1@0|)))) ($IsGoodHeap $Heap@6)) (and (=> (= (ControlFlow 0 2) (- 0 24)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 23)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3) (and (=> (= (ControlFlow 0 2) (- 0 22)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (forall ((|l#1@@4| T@U) ) (!  (=> (and ($Is refType |l#1@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@4|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@4|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |l#1@@4|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@4|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |l#1@@4|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimeshortdfy.200:21|
 :skolemid |1295|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |l#1@@4|) _module.Lifetime.mightPointTo)))
 ...
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |l#1@@4|) _module.Lifetime.mightPointFrom)))
 ...
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |l#1@@5|) _module.Lifetime.mightPointFrom)))
...
)) (=> (and (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (forall ((|a#1@@3| T@U) (|b#1@@3| T@U) ) (!  (=> (and ($Is refType |a#1@@3| Tclass._module.Lifetime) ($Is refType |b#1@@3| Tclass._module.Lifetime)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@3|))) (and (|_module.Universe.outlives#canCall| $Heap@3 |universe#0| |a#1@@3| |b#1@@3|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@3 |universe#0| |a#1@@3| |b#1@@3|) (|_module.Universe.outlives#canCall| $Heap@6 |universe#0| |a#1@@3| |b#1@@3|)))))
 :qid |_12MutexLifetimeshortdfy.201:20|
 :skolemid |1296|
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@6 |universe#0| |a#1@@3| |b#1@@3|))
...
)) (= $Heap@6 $Heap@7))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 19)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3) (and (=> (= (ControlFlow 0 2) (- 0 18)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3) (and (=> (= (ControlFlow 0 2) (- 0 17)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#0@@20| T@U) ) (!  (=> (and ($Is refType |o#0@@20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@20|))) (and (and (and (= (_module.Object.universe |o#0@@20|) |universe#0|) (or (not (= |o#0@@20| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#0@@20|)) (_module.Object.triggerAxioms $Heap@3 |o#0@@20|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |995|
 :pattern ( (_module.Object.triggerAxioms $Heap@3 |o#0@@20|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@3 |o#0@@20|))
 :pattern ( (_module.Object.universe |o#0@@20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@20|)))
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#0@@21| T@U) ) (!  (=> (and ($Is refType |o#0@@21| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@21|))) (and (and (and (= (_module.Object.universe |o#0@@21|) |universe#0|) (or (not (= |o#0@@21| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#0@@21|)) (_module.Object.triggerAxioms $Heap@3 |o#0@@21|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |995|
...
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (forall ((|o#1@@10| T@U) ) (!  (=> (and ($Is refType |o#1@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@10|))) (and (and (and (= (_module.Object.universe |o#1@@10|) |universe#0|) (or (not (= |o#1@@10| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@7 |o#1@@10|)) (_module.Object.triggerAxioms $Heap@7 |o#1@@10|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |997|
 :pattern ( (_module.Object.triggerAxioms $Heap@7 |o#1@@10|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@7 |o#1@@10|))
...
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (forall ((|o#1@@11| T@U) ) (!  (=> (and ($Is refType |o#1@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@11|))) (and (and (and (= (_module.Object.universe |o#1@@11|) |universe#0|) (or (not (= |o#1@@11| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@7 |o#1@@11|)) (_module.Object.triggerAxioms $Heap@7 |o#1@@11|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |997|
 :pattern ( (_module.Object.triggerAxioms $Heap@7 |o#1@@11|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@7 |o#1@@11|))
 :pattern ( (_module.Object.universe |o#1@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@11|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|)))) (not ($IsAllocBox ($Box refType |o#2@@0|) Tclass._module.Object $Heap@3)))
 :qid |_12MutexLifetimeshortdfy.44:16|
 :skolemid |999|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|)))
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (forall ((|o#2@@1| T@U) ) (!  (=> (and ($Is refType |o#2@@1| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@1|)))) (not ($IsAllocBox ($Box refType |o#2@@1|) Tclass._module.Object $Heap@3)))
 :qid |_12MutexLifetimeshortdfy.44:16|
 :skolemid |999|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@1|)))
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))) (or (forall (($o@@118 T@U) ($f@@74 T@U) ) (!  (=> (or (not (= $o@@118 null)) (not true)) (=> (= $o@@118 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@118) $f@@74) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@118) $f@@74))))
 :qid |_12MutexLifetimeshortdfy.59:65|
 :skolemid |1001|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@118) $f@@74))
)) (_module.Object.sequenceInv2 $Heap@3 $Heap@7 |o#3@@0|)))
 :qid |_12MutexLifetimeshortdfy.59:16|
 :skolemid |1002|
 :pattern ( (_module.Object.sequenceInv2 $Heap@3 $Heap@7 |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@1| T@U) ) (!  (=> (and ($Is refType |o#3@@1| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|)))) (or (forall (($o@@119 T@U) ($f@@75 T@U) ) (!  (=> (or (not (= $o@@119 null)) (not true)) (=> (= $o@@119 |o#3@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@119) $f@@75) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@119) $f@@75))))
 :qid |_12MutexLifetimeshortdfy.59:65|
 :skolemid |1001|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@119) $f@@75))
)) (_module.Object.sequenceInv2 $Heap@3 $Heap@7 |o#3@@1|)))
 :qid |_12MutexLifetimeshortdfy.59:16|
 :skolemid |1002|
 :pattern ( (_module.Object.sequenceInv2 $Heap@3 $Heap@7 |o#3@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|)))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@0|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@3)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimeshortdfy.62:16|
 :skolemid |1003|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |o#4@@0|) _module.OwnedObject.nonvolatileVersion)))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4@@1| T@U) ) (!  (=> (and ($Is refType |o#4@@1| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@1|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@3)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#4@@1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |o#4@@1|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimeshortdfy.62:16|
 :skolemid |1003|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |o#4@@1|) _module.OwnedObject.nonvolatileVersion)))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#0@@6| T@U) ) (!  (=> (and ($Is refType |l#0@@6| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@6|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@6|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@6|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@3)) (_module.Lifetime.unchangedNonvolatileFields $Heap@3 $Heap@7 |l#0@@6|)))
 :qid |_12MutexLifetimeshortdfy.68:16|
 :skolemid |1004|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@3 $Heap@7 |l#0@@6|))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#0@@7| T@U) ) (!  (=> (and ($Is refType |l#0@@7| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@7|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@7|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@7|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@3)) (_module.Lifetime.unchangedNonvolatileFields $Heap@3 $Heap@7 |l#0@@7|)))
 :qid |_12MutexLifetimeshortdfy.68:16|
 :skolemid |1004|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@3 $Heap@7 |l#0@@7|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#0@@7|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@7|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@0|))) (and (and (and (= (_module.Object.universe |o#5@@0|) |universe#0|) (or (not (= |o#5@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#5@@0|)) (_module.Object.triggerAxioms $Heap@3 |o#5@@0|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1009|
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (forall ((|o#6@@1| T@U) ) (!  (=> (and ($Is refType |o#6@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@1|))) (_module.Object.inv $Heap@3 |o#6@@1|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1011|
 :pattern ( (_module.Object.inv $Heap@3 |o#6@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@1|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (or (forall (($o@@120 T@U) ($f@@76 T@U) ) (!  (=> (or (not (= $o@@120 null)) (not true)) (=> (= $o@@120 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@120) $f@@76) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@120) $f@@76))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1013|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@120) $f@@76))
)) (_module.Object.inv $Heap@7 |o#7@@0|)) (or (forall (($o@@121 T@U) ($f@@77 T@U) ) (!  (=> (or (not (= $o@@121 null)) (not true)) (=> (= $o@@121 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@121) $f@@77) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@121) $f@@77))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1014|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@121) $f@@77))
)) (_module.Object.inv2 $Heap@3 $Heap@7 |o#7@@0|))))
 :qid |_12MutexLifetimeshortdfy.82:16|
 :skolemid |1015|
 :pattern ( (_module.Object.inv2 $Heap@3 $Heap@7 |o#7@@0|))
 :pattern ( (_module.Object.inv $Heap@7 |o#7@@0|))
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (forall ((|o#7@@1| T@U) ) (!  (=> (and ($Is refType |o#7@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@1|))) (and (or (forall (($o@@122 T@U) ($f@@78 T@U) ) (!  (=> (or (not (= $o@@122 null)) (not true)) (=> (= $o@@122 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@122) $f@@78) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@122) $f@@78))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1013|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@122) $f@@78))
)) (_module.Object.inv $Heap@7 |o#7@@1|)) (or (forall (($o@@123 T@U) ($f@@79 T@U) ) (!  (=> (or (not (= $o@@123 null)) (not true)) (=> (= $o@@123 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@123) $f@@79) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@123) $f@@79))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1014|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@123) $f@@79))
)) (_module.Object.inv2 $Heap@3 $Heap@7 |o#7@@1|))))
 :qid |_12MutexLifetimeshortdfy.82:16|
 :skolemid |1015|
 :pattern ( (_module.Object.inv2 $Heap@3 $Heap@7 |o#7@@1|))
 :pattern ( (_module.Object.inv $Heap@7 |o#7@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@1|)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@0|))))) (_module.Object.inv $Heap@7 |o#8@@0|))
 :qid |_12MutexLifetimeshortdfy.84:16|
 :skolemid |1016|
 :pattern ( (_module.Object.inv $Heap@7 |o#8@@0|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@0|)))
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
anon0_correct))
))
(check-sat)
