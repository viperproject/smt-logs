...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@3 T@U) ($f@@2 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#59| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@3 $f@@2))  (=> (and (or (not (= $o@@3 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@3) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3521|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#59| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@3 $f@@2))
)))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($prevHeap@@2 T@U) ($Heap T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Object.inv2#canCall| $prevHeap@@2 $Heap this@@2) (and (< 15 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@2) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@2 $Heap)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Object) ($IsAlloc refType this@@2 Tclass._module.Object $prevHeap@@2)))))) (=> (_module.Object.inv2 $prevHeap@@2 $Heap this@@2) (and (_module.Object.localInv2 $prevHeap@@2 $Heap this@@2) (_module.Object.sequenceInv2 $prevHeap@@2 $Heap this@@2))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#59| null current$Heap alloc current$Heap alloc)) (and (and (=> (= (ControlFlow 0 9) 1) anon7_Else_correct) (=> (= (ControlFlow 0 9) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Object) ($IsAlloc refType this@@3 Tclass._module.Object previous$Heap))) (= 15 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 10) 9))) anon0_correct))))
