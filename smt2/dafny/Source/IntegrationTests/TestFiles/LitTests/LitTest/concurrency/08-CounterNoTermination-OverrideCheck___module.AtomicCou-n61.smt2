...
(assert (forall (($prevHeap T@U) ($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.AtomicCounter))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o T@U) ($f T@U) )  (=> (and (or (not (= $o null)) (not true)) (= $o this)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o) $f)))) (= (_module.AtomicCounter.unchangedNonvolatileUserFields $prevHeap $h0 this) (_module.AtomicCounter.unchangedNonvolatileUserFields $prevHeap $h1 this))))
...
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@13 T@U) ($f@@3 T@U) ) true)) (=> (forall (($o@@14 T@U) ($f@@4 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@15 T@U) ($f@@5 T@U) ) true)) (=> (forall (($o@@16 T@U) ($f@@6 T@U) ) true) (=> (and (and (_module.AtomicCounter.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.AtomicCounter.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1)) (or (_module.AtomicCounter.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))
