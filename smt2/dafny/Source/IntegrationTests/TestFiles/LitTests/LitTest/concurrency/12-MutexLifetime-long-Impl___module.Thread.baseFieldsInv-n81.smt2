...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#57| null current$Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Thread.baseFieldsInv#canCall| current$Heap this@@1)) (or (_module.Thread.baseFieldsInv current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))
