...
(assert (distinct TBool TagBool alloc Tagclass._module.Object Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? tytagFamily$Object tytagFamily$OwnedObject)
)
...
(let ((anon8_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@2) Tclass._module.OwnedObject? current$Heap)) (and (=> (= (ControlFlow 0 4) (- 0 5)) ($IsAlloc refType this@@2 Tclass._module.OwnedObject $Heap@@0)) (=> ($IsAlloc refType this@@2 Tclass._module.OwnedObject $Heap@@0) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@8 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@8) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@8) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@2)))
 :qid |_10SequenceInvariantdfy.335:8|
 :skolemid |1488|
