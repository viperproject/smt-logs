...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split95)
...
))))) (and (and (forall (($o@@130 T@U) ) (!  (=> (and (or (not (= $o@@130 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@130) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@130) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@130)) (or (= $o@@130 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType $o@@130)))))
 :qid |_11MutexGuard2legacydfy.109:10|
 :skolemid |896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@130))
)) ($HeapSucc $Heap@7 $Heap@8)) (and (or (not (= |call4formal@guard#0@0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex)) null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
