...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split93)
...
)) (= $Heap@14 $Heap@15)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@13)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
