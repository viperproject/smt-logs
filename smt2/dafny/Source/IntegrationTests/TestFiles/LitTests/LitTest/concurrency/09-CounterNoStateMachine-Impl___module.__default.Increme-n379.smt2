...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split368)
...
))))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@39 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@39 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)))))) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@39 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@39 |universe#0|) (forall ((|o#19@@2| T@U) ) (!  (=> (and ($Is refType |o#19@@2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@2|)))) (not ($IsAllocBox ($Box refType |o#19@@2|) Tclass._module.Object $Heap@3)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |538|
...
))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)))) (and (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|)) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))))))))) (= (+ |i#0@2| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |remaining#0|) _module.Integer.value)))) (LitInt 10))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
