...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split182)
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))) (and ($IsGoodHeap $Heap@24) ($IsHeapAnchor $Heap@24))))) (and (and (and (and (or (not (= call4formal@this@0@@1 null)) (not true)) (and ($Is refType call4formal@this@0@@1 Tclass._module.ConstantInteger) ($IsAlloc refType call4formal@this@0@@1 Tclass._module.ConstantInteger $Heap@24))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@24 call4formal@this@0@@1) (=> (_module.Object.objectGlobalInv $Heap@24 call4formal@this@0@@1) (|_module.Universe.globalInv2#canCall| $Heap@23 $Heap@24 |universe#0|)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@24 call4formal@this@0@@1) (and (_module.Object.objectGlobalInv $Heap@24 call4formal@this@0@@1) (and (_module.Object.baseInv $Heap@24 call4formal@this@0@@1) (_module.Universe.globalInv $Heap@24 (_module.Object.universe call4formal@this@0@@1))))) (and (|_module.Universe.globalInv2#canCall| $Heap@23 $Heap@24 |universe#0|) (and (_module.Universe.globalInv2 $Heap@23 $Heap@24 |universe#0|) (and true (forall ((|o#8@@8| T@U) ) (!  (=> (and ($Is refType |o#8@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|)) (_module.Object.inv2 $Heap@23 $Heap@24 |o#8@@8|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |2895|
...
))))))) (and (and (and (= (_module.Object.universe call4formal@this@0@@1) |universe#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 call4formal@this@0@@1) _module.OwnedObject.owner)) |running#0@@3|)) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 call4formal@this@0@@1) _module.ConstantInteger.value))) |value##0_2@1|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@1)))))) (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 call4formal@this@0@@1) alloc)))) (forall (($o@@157 T@U) ) (!  (=> (and (or (not (= $o@@157 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@157) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@157) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@157)) (= $o@@157 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.608:3|
 :skolemid |2896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@157))
))) (and ($HeapSucc $Heap@23 $Heap@24) (= (ControlFlow 0 2) (- 0 1))))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
