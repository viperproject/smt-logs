...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split377)
...
))) (and (and ($HeapSucc $Heap@4 $Heap@5) (= |i#0@1| (LitInt 10))) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@5))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
