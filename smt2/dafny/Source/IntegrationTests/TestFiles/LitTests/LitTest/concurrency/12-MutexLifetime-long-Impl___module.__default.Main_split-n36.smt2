...
(set-info :boogie-vc-id Impl$$_module.__default.Main_split10)
...
))) (and (forall (($o@@147 T@U) ) (!  (=> (and (or (not (= $o@@147 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@147) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@40 $o@@147) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@147)) (or (= $o@@147 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType $o@@147)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@40 $o@@147))
)) ($HeapSucc $Heap@39 $Heap@40))) (and (and ($IsAllocBox ($Box refType |scope#0|) Tclass._module.Lifetime? $Heap@40) (|_module.Lifetime.unused#canCall| $Heap@40 |scope#0|)) (and (|_module.Lifetime.unused#canCall| $Heap@40 |scope#0|) (_module.Lifetime.unused $Heap@40 |scope#0|))))) (and (and (and (and ($IsAllocBox ($Box refType |scope#0|) Tclass._module.Lifetime? $Heap@40) (|_module.Lifetime.deallocable#canCall| $Heap@40 |scope#0|)) (and (|_module.Lifetime.deallocable#canCall| $Heap@40 |scope#0|) (_module.Lifetime.deallocable $Heap@40 |scope#0|))) (and (and (or (not (= |scope#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |scope#0| _module.Lifetime.owner))) (and (= $Heap@41 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@40 |scope#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@40 |scope#0|) _module.Lifetime.owner ($Box refType null)))) ($IsGoodHeap $Heap@41)))) (and (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@40)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@40 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@41 |universe#0|) _module.Universe.content))) (forall ((|l#1@@5| T@U) ) (!  (=> (and ($Is refType |l#1@@5| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@40 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@5|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@40 |l#1@@5|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@41 |l#1@@5|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@40 |l#1@@5|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@41 |l#1@@5|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
...
)))))) (and (and ($IsGoodHeap $Heap@43) ($IsHeapAnchor $Heap@43)) (and (|_module.Universe.globalInv#canCall| $Heap@42 |universe#0|) (=> (_module.Universe.globalInv $Heap@42 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@40 $Heap@42 |universe#0|))))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@42 |universe#0|) (and (_module.Universe.globalInv $Heap@42 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@42 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@42 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@42 |o#10@@0|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1379|
...
)) (forall (($o@@153 T@U) ) (!  (=> (and (or (not (= $o@@153 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@43 $o@@153) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 $o@@153) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@43 $o@@153)) (or (= $o@@153 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@43 |universe#0|) _module.Universe.content)) ($Box refType $o@@153)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 $o@@153))
))) (and ($HeapSucc $Heap@43 $Heap@44) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@44))) (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@133) (|_module.Universe.globalSequenceInv2#canCall| $Heap@@133 $Heap@44 |universe#0|)) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@@133 $Heap@44 |universe#0|) (_module.Universe.globalSequenceInv2 $Heap@@133 $Heap@44 |universe#0|)))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Universe.globalInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalInv $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@44 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalInv $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@44 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Universe.globalInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalInv $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@44 |universe#0|) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#12|))) (and (and (and (= (_module.Object.universe |o#12|) |universe#0|) (or (not (= |o#12| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@44 |o#12|)) (_module.Object.triggerAxioms $Heap@44 |o#12|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1086|
 :pattern ( (_module.Object.triggerAxioms $Heap@44 |o#12|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@44 |o#12|))
 :pattern ( (_module.Object.universe |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#12|)))
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalInv $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@44 |universe#0|) (forall ((|o#12@@0| T@U) ) (!  (=> (and ($Is refType |o#12@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@0|))) (and (and (and (= (_module.Object.universe |o#12@@0|) |universe#0|) (or (not (= |o#12@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@44 |o#12@@0|)) (_module.Object.triggerAxioms $Heap@44 |o#12@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1086|
 :pattern ( (_module.Object.triggerAxioms $Heap@44 |o#12@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@44 |o#12@@0|))
 :pattern ( (_module.Object.universe |o#12@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Universe.globalInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalInv $Heap@44 |universe#0|) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#13|))) (_module.Object.inv $Heap@44 |o#13|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1088|
 :pattern ( (_module.Object.inv $Heap@44 |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#13|)))
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalInv $Heap@44 |universe#0|) (forall ((|o#13@@0| T@U) ) (!  (=> (and ($Is refType |o#13@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@0|))) (_module.Object.inv $Heap@44 |o#13@@0|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1088|
 :pattern ( (_module.Object.inv $Heap@44 |o#13@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@133 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@133 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@133 |universe#0|) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#14|))) (and (and (and (= (_module.Object.universe |o#14|) |universe#0|) (or (not (= |o#14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@133 |o#14|)) (_module.Object.triggerAxioms $Heap@@133 |o#14|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1090|
 :pattern ( (_module.Object.triggerAxioms $Heap@@133 |o#14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@133 |o#14|))
 :pattern ( (_module.Object.universe |o#14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#14|)))
))))))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@133 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@133 |universe#0|) (forall ((|o#14@@0| T@U) ) (!  (=> (and ($Is refType |o#14@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@0|))) (and (and (and (= (_module.Object.universe |o#14@@0|) |universe#0|) (or (not (= |o#14@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@133 |o#14@@0|)) (_module.Object.triggerAxioms $Heap@@133 |o#14@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1090|
 :pattern ( (_module.Object.triggerAxioms $Heap@@133 |o#14@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@133 |o#14@@0|))
 :pattern ( (_module.Object.universe |o#14@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@44 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@44 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@44 |universe#0|) (forall ((|o#15| T@U) ) (!  (=> (and ($Is refType |o#15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#15|))) (and (and (and (= (_module.Object.universe |o#15|) |universe#0|) (or (not (= |o#15| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@44 |o#15|)) (_module.Object.triggerAxioms $Heap@44 |o#15|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1092|
 :pattern ( (_module.Object.triggerAxioms $Heap@44 |o#15|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@44 |o#15|))
 :pattern ( (_module.Object.universe |o#15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#15|)))
))))))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@44 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@44 |universe#0|) (forall ((|o#15@@0| T@U) ) (!  (=> (and ($Is refType |o#15@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#15@@0|))) (and (and (and (= (_module.Object.universe |o#15@@0|) |universe#0|) (or (not (= |o#15@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@44 |o#15@@0|)) (_module.Object.triggerAxioms $Heap@44 |o#15@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1092|
 :pattern ( (_module.Object.triggerAxioms $Heap@44 |o#15@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@44 |o#15@@0|))
 :pattern ( (_module.Object.universe |o#15@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#15@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)))))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#16|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#16|)))) (not ($IsAllocBox ($Box refType |o#16|) Tclass._module.Object $Heap@@133)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1094|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#16|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#16|)))
))))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@133 $Heap@44 |universe#0|) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|)))) (not ($IsAllocBox ($Box refType |o#16@@0|) Tclass._module.Object $Heap@@133)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1094|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (forall ((|o#17| T@U) ) (!  (=> (and ($Is refType |o#17| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)))) (or (forall (($o@@154 T@U) ($f@@93 T@U) ) (!  (=> (or (not (= $o@@154 null)) (not true)) (=> (= $o@@154 |o#17|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 $o@@154) $f@@93) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 $o@@154) $f@@93))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1096|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 $o@@154) $f@@93))
)) (_module.Object.sequenceInv2 $Heap@@133 $Heap@44 |o#17|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |1097|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@133 $Heap@44 |o#17|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)))
))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (forall ((|o#17@@0| T@U) ) (!  (=> (and ($Is refType |o#17@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)))) (or (forall (($o@@155 T@U) ($f@@94 T@U) ) (!  (=> (or (not (= $o@@155 null)) (not true)) (=> (= $o@@155 |o#17@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 $o@@155) $f@@94) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 $o@@155) $f@@94))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1096|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 $o@@155) $f@@94))
)) (_module.Object.sequenceInv2 $Heap@@133 $Heap@44 |o#17@@0|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |1097|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@133 $Heap@44 |o#17@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (forall ((|o#18| T@U) ) (!  (=> (and ($Is refType |o#18| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#18|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@133)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |o#18|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |1098|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |o#18|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#18|)))
))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (forall ((|o#18@@0| T@U) ) (!  (=> (and ($Is refType |o#18@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18@@0|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@133)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |o#18@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |1098|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |o#18@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |o#18@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (forall ((|l#1@@6| T@U) ) (!  (=> (and ($Is refType |l#1@@6| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@6|))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#1@@6|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#1@@6|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@133)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@133 $Heap@44 |l#1@@6|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1099|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@133 $Heap@44 |l#1@@6|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#1@@6|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@6|)))
))))))) (=> (=> (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.legalTransitionsSequenceAnyThread $Heap@@133 $Heap@44 |universe#0|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (or (_module.Universe.legalTransitionsSequence $Heap@@133 $Heap@44 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content))))) (forall ((|l#1@@7| T@U) ) (!  (=> (and ($Is refType |l#1@@7| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@7|))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#1@@7|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#1@@7|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@133)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@133 $Heap@44 |l#1@@7|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1099|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@133 $Heap@44 |l#1@@7|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |l#1@@7|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@7|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Universe.globalSequenceInv2#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.globalSequenceInv2 $Heap@@133 $Heap@44 |universe#0|) (forall ((|o#19| T@U) ) (!  (=> (and ($Is refType |o#19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#19|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#19|)) (_module.Object.sequenceInv2 $Heap@@133 $Heap@44 |o#19|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |1104|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@133 $Heap@44 |o#19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#19|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#19|)))
))))) (=> (=> (|_module.Universe.globalSequenceInv2#canCall| $Heap@@133 $Heap@44 |universe#0|) (or (_module.Universe.globalSequenceInv2 $Heap@@133 $Heap@44 |universe#0|) (forall ((|o#19@@0| T@U) ) (!  (=> (and ($Is refType |o#19@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|)) (_module.Object.sequenceInv2 $Heap@@133 $Heap@44 |o#19@@0|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |1104|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@133 $Heap@44 |o#19@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@44 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (not (_module.Lifetime.alive $Heap@44 |scope#0|))))))))))))))))))))))))))))))))))))))))))
(let ((anon32_Else_correct  (=> (and (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#4@0|)) (not (or (or (= call5formal@this@0 call5formal@this@0@@0) (= call5formal@this@0 call5formal@this@0@@1)) (= call5formal@this@0 (_module.OwnedObject.lifetime |call6formal@guard#0@0|)))))) (= (ControlFlow 0 20) 2)) anon20_correct)))
(let ((anon32_Then_correct  (=> (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#4@0|)) (not (or (or (= call5formal@this@0 call5formal@this@0@@0) (= call5formal@this@0 call5formal@this@0@@1)) (= call5formal@this@0 (_module.OwnedObject.lifetime |call6formal@guard#0@0|))))) ($IsAllocBox ($Box refType |l#4@0|) Tclass._module.Lifetime? $Heap@27)) (and (|_module.Lifetime.alive#canCall| $Heap@27 |l#4@0|) (= (ControlFlow 0 19) 2))) anon20_correct)))
(let ((anon31_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#4@0|))) (and (=> (= (ControlFlow 0 22) 19) anon32_Then_correct) (=> (= (ControlFlow 0 22) 20) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#4@0|)) (and (=> (= (ControlFlow 0 21) 19) anon32_Then_correct) (=> (= (ControlFlow 0 21) 20) anon32_Else_correct)))))
(let ((anon30_Then_correct  (=> (and ($Is refType |l#4@0| Tclass._module.Lifetime) ($IsAlloc refType |l#4@0| Tclass._module.Lifetime $Heap@27)) (and (=> (= (ControlFlow 0 23) 21) anon31_Then_correct) (=> (= (ControlFlow 0 23) 22) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (not (and ($Is refType |l#4@0| Tclass._module.Lifetime) ($IsAlloc refType |l#4@0| Tclass._module.Lifetime $Heap@27))) (= (ControlFlow 0 18) 2)) anon20_correct)))
(let ((anon15_correct  (=> (and (|_module.Lifetime.alive#canCall| $Heap@27 call5formal@this@0@@0) (=> (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@0)) (and (|_module.Lifetime.alive#canCall| $Heap@27 call5formal@this@0@@1) (=> (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@1)) (|_module.Lifetime.alive#canCall| $Heap@27 (_module.OwnedObject.lifetime |call6formal@guard#0@0|)))))) (=> (and (and (and (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@0)) (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@1))) (_module.Lifetime.alive $Heap@27 (_module.OwnedObject.lifetime |call6formal@guard#0@0|))) (and (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0@@0)) ($Box refType call5formal@this@0@@1)) ($Box refType (_module.OwnedObject.lifetime |call6formal@guard#0@0|))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call5formal@this@0) _module.Lifetime.mightPointFrom))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call5formal@this@0) _module.Lifetime.elements)) |Set#Empty|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (U_2_bool (Lit boolType (bool_2_U false)))))) (and (=> (= (ControlFlow 0 24) 23) anon30_Then_correct) (=> (= (ControlFlow 0 24) 18) anon30_Else_correct))))))
(let ((anon29_Else_correct  (=> (and (not (and (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@0)) (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@1)))) (= (ControlFlow 0 26) 24)) anon15_correct)))
(let ((anon29_Then_correct  (=> (and (and (and (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@0)) (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@1))) ($IsAllocBox ($Box refType (_module.OwnedObject.lifetime |call6formal@guard#0@0|)) Tclass._module.Lifetime? $Heap@27)) (and (|_module.Lifetime.alive#canCall| $Heap@27 (_module.OwnedObject.lifetime |call6formal@guard#0@0|)) (= (ControlFlow 0 25) 24))) anon15_correct)))
(let ((anon28_Else_correct  (=> (_module.Lifetime.alive $Heap@27 call5formal@this@0@@0) (and (=> (= (ControlFlow 0 28) 25) anon29_Then_correct) (=> (= (ControlFlow 0 28) 26) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> (not (_module.Lifetime.alive $Heap@27 call5formal@this@0@@0)) (=> (and ($IsAllocBox ($Box refType call5formal@this@0@@1) Tclass._module.Lifetime? $Heap@27) (|_module.Lifetime.alive#canCall| $Heap@27 call5formal@this@0@@1)) (and (=> (= (ControlFlow 0 27) 25) anon29_Then_correct) (=> (= (ControlFlow 0 27) 26) anon29_Else_correct))))))
(let ((anon11_correct  (=> (and (= |running##13@0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@24)) (=> (and (and ($IsAlloc SetType (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)))) (TSet Tclass._module.Thread) $Heap@24) ($IsAlloc SetType |running##13@0| (TSet Tclass._module.Thread) $Heap@24)) (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@24 $Heap@26 |universe#0| |running##13@0|) (or (_module.Universe.legalTransitionsSequence $Heap@24 $Heap@26 |universe#0| |running##13@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@24 $Heap@26 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@24 $Heap@26 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@24 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@24 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@24 $Heap@26 |universe#0| |running##13@0|) (or (_module.Universe.legalTransitionsSequence $Heap@24 $Heap@26 |universe#0| |running##13@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@24 $Heap@26 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@24 $Heap@26 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@24 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@24 |universe#0|) (forall ((|o#0@@24| T@U) ) (!  (=> (and ($Is refType |o#0@@24| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@24|))) (and (and (and (= (_module.Object.universe |o#0@@24|) |universe#0|) (or (not (= |o#0@@24| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@24 |o#0@@24|)) (_module.Object.triggerAxioms $Heap@24 |o#0@@24|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1316|
 :pattern ( (_module.Object.triggerAxioms $Heap@24 |o#0@@24|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@24 |o#0@@24|))
 :pattern ( (_module.Object.universe |o#0@@24|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@24|)))
)))))))))) (=> (and (and (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@24 $Heap@26 |universe#0| |running##13@0|) (or (_module.Universe.legalTransitionsSequence $Heap@24 $Heap@26 |universe#0| |running##13@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@24 $Heap@26 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@24 $Heap@26 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@26 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@26 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@24 $Heap@26 |universe#0| |running##13@0|) (or (_module.Universe.legalTransitionsSequence $Heap@24 $Heap@26 |universe#0| |running##13@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@24 $Heap@26 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@24 $Heap@26 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@26 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@26 |universe#0|) (forall ((|o#1@@11| T@U) ) (!  (=> (and ($Is refType |o#1@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@26 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@11|))) (and (and (and (= (_module.Object.universe |o#1@@11|) |universe#0|) (or (not (= |o#1@@11| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@26 |o#1@@11|)) (_module.Object.triggerAxioms $Heap@26 |o#1@@11|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1318|
 :pattern ( (_module.Object.triggerAxioms $Heap@26 |o#1@@11|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@26 |o#1@@11|))
 :pattern ( (_module.Object.universe |o#1@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@26 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@11|)))
...
)))) (= $Heap@26 $Heap@27))) (and (and (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@27) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@24)) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@24 $Heap@27 |universe#0|) (|_module.Universe.globalSequenceInv2#canCall| $Heap@24 $Heap@27 |universe#0|))) (and (and (_module.Universe.globalSequenceInv2 $Heap@24 $Heap@27 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (and ($IsAllocBox ($Box refType call5formal@this@0@@0) Tclass._module.Lifetime? $Heap@27) (|_module.Lifetime.alive#canCall| $Heap@27 call5formal@this@0@@0))))) (and (=> (= (ControlFlow 0 29) 27) anon28_Then_correct) (=> (= (ControlFlow 0 29) 28) anon28_Else_correct))))))))
(let ((anon27_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |t#2@0|))) (= (ControlFlow 0 32) 29)) anon11_correct)))
(let ((anon27_Then_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |t#2@0|)) (= (ControlFlow 0 31) 29)) anon11_correct)))
(let ((anon26_Then_correct  (=> (and (and ($Is refType |t#2@0| Tclass._module.Thread) ($IsAlloc refType |t#2@0| Tclass._module.Thread $Heap@26)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@24))) (and (=> (= (ControlFlow 0 33) 31) anon27_Then_correct) (=> (= (ControlFlow 0 33) 32) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not (and ($Is refType |t#2@0| Tclass._module.Thread) ($IsAlloc refType |t#2@0| Tclass._module.Thread $Heap@26))) (= (ControlFlow 0 30) 29)) anon11_correct)))
...
)) (forall (($o@@157 T@U) ($f@@96 T@U) ) (!  (=> (and (and (or (not (= $o@@157 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@157) alloc)))) (or (= $o@@157 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType $o@@157)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@157 $f@@96)))
 :qid |_12MutexLifetimelongdfy.1265:26|
 :skolemid |1140|
))) (=> (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@19 |universe#0|) (or (_module.Universe.globalInv $Heap@19 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@19 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@19 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@19 |universe#0|) (or (_module.Universe.globalInv $Heap@19 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@19 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@19 |universe#0|) (forall ((|o#0@@25| T@U) ) (!  (=> (and ($Is refType |o#0@@25| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@25|))) (and (and (and (= (_module.Object.universe |o#0@@25|) |universe#0|) (or (not (= |o#0@@25| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@19 |o#0@@25|)) (_module.Object.triggerAxioms $Heap@19 |o#0@@25|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@19 |o#0@@25|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@19 |o#0@@25|))
 :pattern ( (_module.Object.universe |o#0@@25|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@25|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@19 |universe#0|) (or (_module.Universe.globalInv $Heap@19 |universe#0|) (forall ((|o#1@@12| T@U) ) (!  (=> (and ($Is refType |o#1@@12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@12|))) (_module.Object.inv $Heap@19 |o#1@@12|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
 :pattern ( (_module.Object.inv $Heap@19 |o#1@@12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@12|)))
...
)))))) (=> (and (and (and (and (and (forall (($o@@159 T@U) ) (!  (=> (and (or (not (= $o@@159 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@159) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@159) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@159)) (or (= $o@@159 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType $o@@159)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@159))
)) ($HeapSucc $Heap@19 $Heap@20)) (and (= |mightPointTo##2@0| (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0))) (forall (($o@@160 T@U) ($f@@98 T@U) ) (!  (=> (and (and (or (not (= $o@@160 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@160) alloc)))) (or (= $o@@160 |universe#0|) (and (|Set#IsMember| |mightPointTo##2@0| ($Box refType $o@@160)) (= $f@@98 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@160 $f@@98)))
 :qid |_12MutexLifetimelongdfy.1268:21|
 :skolemid |1141|
)))) (and (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass._module.Lifetime) ($IsAlloc refType call5formal@this Tclass._module.Lifetime $Heap@@133))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@20 |universe#0|) (or (_module.Universe.globalInv $Heap@20 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@20 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@20 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@20 |universe#0|) (or (_module.Universe.globalInv $Heap@20 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@20 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@20 |universe#0|) (forall ((|o#0@@26| T@U) ) (!  (=> (and ($Is refType |o#0@@26| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@26|))) (and (and (and (= (_module.Object.universe |o#0@@26|) |universe#0|) (or (not (= |o#0@@26| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@20 |o#0@@26|)) (_module.Object.triggerAxioms $Heap@20 |o#0@@26|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2625|
 :pattern ( (_module.Object.triggerAxioms $Heap@20 |o#0@@26|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@20 |o#0@@26|))
 :pattern ( (_module.Object.universe |o#0@@26|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@26|)))
))))))))) (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@20 |universe#0|) (or (_module.Universe.globalInv $Heap@20 |universe#0|) (forall ((|o#1@@13| T@U) ) (!  (=> (and ($Is refType |o#1@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@13|))) (_module.Object.inv $Heap@20 |o#1@@13|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |2627|
 :pattern ( (_module.Object.inv $Heap@20 |o#1@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@13|)))
)))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)))) (and (|Set#Subset| |mightPointTo##2@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content))) (forall ((|l#1@@8| T@U) ) (!  (=> (and ($Is refType |l#1@@8| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##2@0| ($Box refType |l#1@@8|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |l#1@@8|) _module.Lifetime.owner)) |running#0@@3|))
 :qid |_12MutexLifetimelongdfy.612:21|
 :skolemid |2629|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |l#1@@8|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| |mightPointTo##2@0| ($Box refType |l#1@@8|)))
)))) (and (and ($IsGoodHeap $Heap@21) ($IsHeapAnchor $Heap@21)) (and (or (not (= call5formal@this@0@@1 null)) (not true)) (and ($Is refType call5formal@this@0@@1 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@0@@1 Tclass._module.Lifetime $Heap@21)))))) (and (and (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@21 call5formal@this@0@@1) (=> (_module.Object.objectGlobalInv $Heap@21 call5formal@this@0@@1) (|_module.Universe.legalTransition#canCall| $Heap@20 $Heap@21 |universe#0| |running#0@@3|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@21 call5formal@this@0@@1) (and (_module.Object.objectGlobalInv $Heap@21 call5formal@this@0@@1) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 (_module.Object.universe call5formal@this@0@@1)) _module.Universe.content)) ($Box refType call5formal@this@0@@1)) (_module.Universe.globalInv $Heap@21 (_module.Object.universe call5formal@this@0@@1)))))) (and (and (|_module.Universe.legalTransition#canCall| $Heap@20 $Heap@21 |universe#0| |running#0@@3|) (and (_module.Universe.legalTransition $Heap@20 $Heap@21 |universe#0| |running#0@@3|) (and (and (and (_module.Universe.legalTransitionsSequence $Heap@20 $Heap@21 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@20 |universe#0|)) (forall ((|o#11@@1| T@U) ) (!  (=> (and ($Is refType |o#11@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@1|))) (and (or (forall (($o@@161 T@U) ($f@@99 T@U) ) (!  (=> (or (not (= $o@@161 null)) (not true)) (=> (= $o@@161 |o#11@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 $o@@161) $f@@99) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@161) $f@@99))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2656|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 $o@@161) $f@@99))
)) (_module.Object.inv $Heap@21 |o#11@@1|)) (or (forall (($o@@162 T@U) ($f@@100 T@U) ) (!  (=> (or (not (= $o@@162 null)) (not true)) (=> (= $o@@162 |o#11@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 $o@@162) $f@@100) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@162) $f@@100))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2657|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 $o@@162) $f@@100))
...
))) (forall ((|o#12@@1| T@U) ) (!  (=> (and ($Is refType |o#12@@1| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@1|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@1|))))) (_module.Object.inv $Heap@21 |o#12@@1|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |2659|
 :pattern ( (_module.Object.inv $Heap@21 |o#12@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@1|)))
...
))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@1) alloc)))) (forall (($o@@163 T@U) ) (!  (=> (and (or (not (= $o@@163 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@163) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 $o@@163) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@163)) (or (= $o@@163 |universe#0|) (|Set#IsMember| |mightPointTo##2@0| ($Box refType $o@@163)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2661|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 $o@@163))
))))))) (=> (and (and (and (and (and (and (and (forall (($o@@164 T@U) ($f@@101 T@U) ) (!  (=> (and (or (not (= $o@@164 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@164) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 $o@@164) $f@@101) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@164) $f@@101)) (or (= $o@@164 |universe#0|) (and (|Set#IsMember| |mightPointTo##2@0| ($Box refType $o@@164)) (= $f@@101 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2662|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 $o@@164) $f@@101))
)) ($HeapSucc $Heap@20 $Heap@21)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@20))) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 |universe#0|) _module.Universe.content))) (forall ((|l#1@@9| T@U) ) (!  (=> (and ($Is refType |l#1@@9| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@9|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |l#1@@9|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 |l#1@@9|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |l#1@@9|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 |l#1@@9|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 |l#1@@9|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |l#1@@9|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@21 |l#1@@9|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |l#1@@9|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@9|)))
...
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@20 $Heap@22 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@20 $Heap@22 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@20 $Heap@22 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@20 $Heap@22 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@20 $Heap@22 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@20 $Heap@22 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@22 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@22 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@20 $Heap@22 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@20 $Heap@22 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@20 $Heap@22 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@20 $Heap@22 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@20 $Heap@22 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@20 $Heap@22 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@22 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@22 |universe#0|) (forall ((|o#1@@14| T@U) ) (!  (=> (and ($Is refType |o#1@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@14|))) (and (and (and (= (_module.Object.universe |o#1@@14|) |universe#0|) (or (not (= |o#1@@14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@22 |o#1@@14|)) (_module.Object.triggerAxioms $Heap@22 |o#1@@14|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@22 |o#1@@14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@22 |o#1@@14|))
 :pattern ( (_module.Object.universe |o#1@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@14|)))
...
)))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@20 $Heap@22 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@20 $Heap@22 |universe#0| |running#0@@3|) (forall ((|o#7@@1| T@U) ) (!  (=> (and ($Is refType |o#7@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@1|))) (and (or (forall (($o@@166 T@U) ($f@@103 T@U) ) (!  (=> (or (not (= $o@@166 null)) (not true)) (=> (= $o@@166 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 $o@@166) $f@@103) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@166) $f@@103))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 $o@@166) $f@@103))
)) (_module.Object.inv $Heap@22 |o#7@@1|)) (or (forall (($o@@167 T@U) ($f@@104 T@U) ) (!  (=> (or (not (= $o@@167 null)) (not true)) (=> (= $o@@167 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 $o@@167) $f@@104) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@167) $f@@104))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 $o@@167) $f@@104))
...
)))) (= $Heap@22 $Heap@23))) (and (and (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@23) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@20)) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@20 $Heap@23 |universe#0|) (|_module.Universe.globalSequenceInv2#canCall| $Heap@20 $Heap@23 |universe#0|))) (and (and (_module.Universe.globalSequenceInv2 $Heap@20 $Heap@23 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0@@0)) ($Box refType call5formal@this@0@@1)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 call5formal@this@0) _module.Lifetime.mightPointFrom))) (forall (($o@@168 T@U) ($f@@105 T@U) ) (!  (=> (and (and (or (not (= $o@@168 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@168) alloc)))) (or (= $o@@168 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType $o@@168)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@168 $f@@105)))
 :qid |_12MutexLifetimelongdfy.1276:26|
 :skolemid |1146|
)))))) (and (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@23 |universe#0|) (or (_module.Universe.globalInv $Heap@23 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@23 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@23 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@23 |universe#0|) (or (_module.Universe.globalInv $Heap@23 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@23 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@23 |universe#0|) (forall ((|o#0@@28| T@U) ) (!  (=> (and ($Is refType |o#0@@28| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@28|))) (and (and (and (= (_module.Object.universe |o#0@@28|) |universe#0|) (or (not (= |o#0@@28| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@23 |o#0@@28|)) (_module.Object.triggerAxioms $Heap@23 |o#0@@28|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@23 |o#0@@28|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@23 |o#0@@28|))
 :pattern ( (_module.Object.universe |o#0@@28|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@28|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@23 |universe#0|) (or (_module.Universe.globalInv $Heap@23 |universe#0|) (forall ((|o#1@@15| T@U) ) (!  (=> (and ($Is refType |o#1@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@15|))) (_module.Object.inv $Heap@23 |o#1@@15|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
 :pattern ( (_module.Object.inv $Heap@23 |o#1@@15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@15|)))
...
)) (forall (($o@@170 T@U) ) (!  (=> (and (or (not (= $o@@170 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@170) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@170) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@170)) (or (= $o@@170 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType $o@@170)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@170))
))) (and ($HeapSucc $Heap@23 $Heap@24) (forall (($o@@171 T@U) ($f@@107 T@U) ) (!  (=> (and (and (or (not (= $o@@171 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@171) alloc)))) (or (= $o@@171 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType $o@@171)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@171 $f@@107)))
 :qid |_12MutexLifetimelongdfy.1279:23|
 :skolemid |1147|
))))) (and (and (and ($Is refType |call6formal@guard#0| Tclass._module.MutexGuardU32) ($IsAlloc refType |call6formal@guard#0| Tclass._module.MutexGuardU32 $Heap@@133)) (=> (|_module.Universe.globalInv#canCall| $Heap@24 |universe#0|) (or (_module.Universe.globalInv $Heap@24 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@24 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@24 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@24 |universe#0|) (or (_module.Universe.globalInv $Heap@24 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@24 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@24 |universe#0|) (forall ((|o#0@@29| T@U) ) (!  (=> (and ($Is refType |o#0@@29| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@29|))) (and (and (and (= (_module.Object.universe |o#0@@29|) |universe#0|) (or (not (= |o#0@@29| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@24 |o#0@@29|)) (_module.Object.triggerAxioms $Heap@24 |o#0@@29|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |818|
 :pattern ( (_module.Object.triggerAxioms $Heap@24 |o#0@@29|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@24 |o#0@@29|))
 :pattern ( (_module.Object.universe |o#0@@29|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@29|)))
)))))) (=> (|_module.Universe.globalInv#canCall| $Heap@24 |universe#0|) (or (_module.Universe.globalInv $Heap@24 |universe#0|) (forall ((|o#1@@16| T@U) ) (!  (=> (and ($Is refType |o#1@@16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@16|))) (_module.Object.inv $Heap@24 |o#1@@16|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |820|
 :pattern ( (_module.Object.inv $Heap@24 |o#1@@16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@16|)))
...
))) (and (= $Heap@25 $Heap@26) (or (not (= |universe#0| null)) (not true))))))))) (and (=> (= (ControlFlow 0 34) 33) anon26_Then_correct) (=> (= (ControlFlow 0 34) 30) anon26_Else_correct))))))))))
(let ((anon25_Else_correct  (=> (and (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#2@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#2@0|))))) (= (ControlFlow 0 37) 34)) anon8_correct)))
(let ((anon25_Then_correct  (=> (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#2@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#2@0|)))) ($IsAllocBox ($Box refType |l#2@0|) Tclass._module.Lifetime? $Heap@19)) (and (|_module.Lifetime.alive#canCall| $Heap@19 |l#2@0|) (= (ControlFlow 0 36) 34))) anon8_correct)))
(let ((anon24_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#2@0|))) (and (=> (= (ControlFlow 0 39) 36) anon25_Then_correct) (=> (= (ControlFlow 0 39) 37) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#2@0|)) ($IsAlloc refType call5formal@this@0 Tclass._module.Lifetime $Heap@16)) (and (=> (= (ControlFlow 0 38) 36) anon25_Then_correct) (=> (= (ControlFlow 0 38) 37) anon25_Else_correct)))))
(let ((anon23_Then_correct  (=> (and ($Is refType |l#2@0| Tclass._module.Lifetime) ($IsAlloc refType |l#2@0| Tclass._module.Lifetime $Heap@19)) (and (=> (= (ControlFlow 0 40) 38) anon24_Then_correct) (=> (= (ControlFlow 0 40) 39) anon24_Else_correct)))))
(let ((anon23_Else_correct  (=> (and (not (and ($Is refType |l#2@0| Tclass._module.Lifetime) ($IsAlloc refType |l#2@0| Tclass._module.Lifetime $Heap@19))) (= (ControlFlow 0 35) 34)) anon8_correct)))
(let ((anon3_correct  (=> (and (= |running##9@0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@16)) (=> (and (and ($IsAlloc SetType (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)))) (TSet Tclass._module.Thread) $Heap@16) ($IsAlloc SetType |running##9@0| (TSet Tclass._module.Thread) $Heap@16)) (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@16 $Heap@18 |universe#0| |running##9@0|) (or (_module.Universe.legalTransitionsSequence $Heap@16 $Heap@18 |universe#0| |running##9@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@16 $Heap@18 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@16 $Heap@18 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@16 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@16 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@16 $Heap@18 |universe#0| |running##9@0|) (or (_module.Universe.legalTransitionsSequence $Heap@16 $Heap@18 |universe#0| |running##9@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@16 $Heap@18 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@16 $Heap@18 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@16 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@16 |universe#0|) (forall ((|o#0@@30| T@U) ) (!  (=> (and ($Is refType |o#0@@30| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@30|))) (and (and (and (= (_module.Object.universe |o#0@@30|) |universe#0|) (or (not (= |o#0@@30| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@16 |o#0@@30|)) (_module.Object.triggerAxioms $Heap@16 |o#0@@30|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1316|
 :pattern ( (_module.Object.triggerAxioms $Heap@16 |o#0@@30|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@16 |o#0@@30|))
 :pattern ( (_module.Object.universe |o#0@@30|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@30|)))
)))))))))) (=> (and (and (and (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@16 $Heap@18 |universe#0| |running##9@0|) (or (_module.Universe.legalTransitionsSequence $Heap@16 $Heap@18 |universe#0| |running##9@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@16 $Heap@18 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@16 $Heap@18 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@18 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@18 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@16 $Heap@18 |universe#0| |running##9@0|) (or (_module.Universe.legalTransitionsSequence $Heap@16 $Heap@18 |universe#0| |running##9@0|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@16 $Heap@18 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@16 $Heap@18 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@18 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@18 |universe#0|) (forall ((|o#1@@17| T@U) ) (!  (=> (and ($Is refType |o#1@@17| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@18 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@17|))) (and (and (and (= (_module.Object.universe |o#1@@17|) |universe#0|) (or (not (= |o#1@@17| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@18 |o#1@@17|)) (_module.Object.triggerAxioms $Heap@18 |o#1@@17|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1318|
 :pattern ( (_module.Object.triggerAxioms $Heap@18 |o#1@@17|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@18 |o#1@@17|))
 :pattern ( (_module.Object.universe |o#1@@17|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@18 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@17|)))
...
))))) (and (and (and (= $Heap@18 $Heap@19) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@19)) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@16) (|_module.Universe.globalSequenceInv2#canCall| $Heap@16 $Heap@19 |universe#0|))) (and (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@16 $Heap@19 |universe#0|) (_module.Universe.globalSequenceInv2 $Heap@16 $Heap@19 |universe#0|)) (and (U_2_bool (Lit boolType (bool_2_U true))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0@@0)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call5formal@this@0) _module.Lifetime.mightPointFrom))))))) (and (=> (= (ControlFlow 0 41) 40) anon23_Then_correct) (=> (= (ControlFlow 0 41) 35) anon23_Else_correct))))))))
(let ((anon22_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |t#0@0|))) (= (ControlFlow 0 44) 41)) anon3_correct)))
(let ((anon22_Then_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |t#0@0|)) (= (ControlFlow 0 43) 41)) anon3_correct)))
(let ((anon21_Then_correct  (=> (and (and ($Is refType |t#0@0| Tclass._module.Thread) ($IsAlloc refType |t#0@0| Tclass._module.Thread $Heap@18)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@16))) (and (=> (= (ControlFlow 0 45) 43) anon22_Then_correct) (=> (= (ControlFlow 0 45) 44) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (not (and ($Is refType |t#0@0| Tclass._module.Thread) ($IsAlloc refType |t#0@0| Tclass._module.Thread $Heap@18))) (= (ControlFlow 0 42) 41)) anon3_correct)))
...
))) (and (forall (($o@@176 T@U) ) (!  (=> (and (or (not (= $o@@176 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 $o@@176) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@176) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 $o@@176)) (or (= $o@@176 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType $o@@176)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@176))
)) ($HeapSucc $Heap@@133 $Heap@0))))) (=> (and (and (and (and (and (and (= |value##0@0| (LitInt 0)) (forall (($o@@177 T@U) ($f@@111 T@U) ) (!  (=> (and (and (or (not (= $o@@177 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@177) alloc)))) (= $o@@177 |universe#0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@177 $f@@111)))
 :qid |_12MutexLifetimelongdfy.1214:15|
 :skolemid |1108|
))) (and (or (not (= call4formal@this null)) (not true)) (and ($Is refType call4formal@this Tclass._module.OwnedU32) ($IsAlloc refType call4formal@this Tclass._module.OwnedU32 $Heap@@133)))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalInv $Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalInv $Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (forall ((|o#0@@32| T@U) ) (!  (=> (and ($Is refType |o#0@@32| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|))) (and (and (and (= (_module.Object.universe |o#0@@32|) |universe#0|) (or (not (= |o#0@@32| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@0 |o#0@@32|)) (_module.Object.triggerAxioms $Heap@0 |o#0@@32|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2905|
 :pattern ( (_module.Object.triggerAxioms $Heap@0 |o#0@@32|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@0 |o#0@@32|))
 :pattern ( (_module.Object.universe |o#0@@32|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalInv $Heap@0 |universe#0|) (forall ((|o#1@@19| T@U) ) (!  (=> (and ($Is refType |o#1@@19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@19|))) (_module.Object.inv $Heap@0 |o#1@@19|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |2907|
 :pattern ( (_module.Object.inv $Heap@0 |o#1@@19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@19|)))
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))) (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (or (not (= call4formal@this@0@@0 null)) (not true)) (and ($Is refType call4formal@this@0@@0 Tclass._module.OwnedU32) ($IsAlloc refType call4formal@this@0@@0 Tclass._module.OwnedU32 $Heap@1)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@1 call4formal@this@0@@0) (=> (_module.Object.objectGlobalInv $Heap@1 call4formal@this@0@@0) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@1 call4formal@this@0@@0) (and (_module.Object.objectGlobalInv $Heap@1 call4formal@this@0@@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe call4formal@this@0@@0)) _module.Universe.content)) ($Box refType call4formal@this@0@@0)) (_module.Universe.globalInv $Heap@1 (_module.Object.universe call4formal@this@0@@0)))))))) (and (and (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (and (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 |universe#0|) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) (forall ((|o#7@@2| T@U) ) (!  (=> (and ($Is refType |o#7@@2| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@2|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@2|)))) (or (forall (($o@@178 T@U) ($f@@112 T@U) ) (!  (=> (or (not (= $o@@178 null)) (not true)) (=> (= $o@@178 |o#7@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@178) $f@@112) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@178) $f@@112))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |2923|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@178) $f@@112))
...
))))) (and (= (_module.Object.universe call4formal@this@0@@0) |universe#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0@@0) _module.OwnedObject.owner)) |running#0@@3|))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call4formal@this@0@@0) _module.OwnedU32.value))) |value##0@0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.OwnedObject.lifetime call4formal@this@0@@0)) _module.Lifetime.owner)) |running#0@@3|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@0)) ($Box refType (_module.OwnedObject.lifetime call4formal@this@0@@0))))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.OwnedObject.lifetime call4formal@this@0@@0)) _module.Lifetime.mightPointFrom)) |Set#Empty|)))) (and (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.OwnedObject.lifetime call4formal@this@0@@0)) _module.Lifetime.elements)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0@@0) alloc))))) (and (forall (($o@@179 T@U) ) (!  (=> (and (or (not (= $o@@179 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@179) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@179) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@179)) (= $o@@179 |universe#0|)))
 :qid |_12MutexLifetimelongdfy.653:3|
 :skolemid |2927|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@179))
)) ($HeapSucc $Heap@0 $Heap@1))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@0)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content))) (forall ((|l#1@@11| T@U) ) (!  (=> (and ($Is refType |l#1@@11| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@11|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@11|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#1@@11|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@11|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#1@@11|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#1@@11|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@11|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |l#1@@11|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@11|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@11|)))
...
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@0 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@0 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (forall ((|o#1@@20| T@U) ) (!  (=> (and ($Is refType |o#1@@20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@20|))) (and (and (and (= (_module.Object.universe |o#1@@20|) |universe#0|) (or (not (= |o#1@@20| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#1@@20|)) (_module.Object.triggerAxioms $Heap@2 |o#1@@20|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@2 |o#1@@20|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@2 |o#1@@20|))
 :pattern ( (_module.Object.universe |o#1@@20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@20|)))
...
))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@0 $Heap@2 |universe#0| |running#0@@3|) (forall ((|o#7@@3| T@U) ) (!  (=> (and ($Is refType |o#7@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@3|))) (and (or (forall (($o@@181 T@U) ($f@@114 T@U) ) (!  (=> (or (not (= $o@@181 null)) (not true)) (=> (= $o@@181 |o#7@@3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@181) $f@@114) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@181) $f@@114))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@181) $f@@114))
)) (_module.Object.inv $Heap@2 |o#7@@3|)) (or (forall (($o@@182 T@U) ($f@@115 T@U) ) (!  (=> (or (not (= $o@@182 null)) (not true)) (=> (= $o@@182 |o#7@@3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@182) $f@@115) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@182) $f@@115))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@182) $f@@115))
...
))))))))) (=> (and (and (and (and (and (and (and (= $Heap@2 $Heap@3) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@3)) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@0) (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@3 |universe#0|))) (and (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@3 |universe#0|) (_module.Universe.globalSequenceInv2 $Heap@0 $Heap@3 |universe#0|)) (and (U_2_bool (Lit boolType (bool_2_U true))) (forall (($o@@183 T@U) ($f@@116 T@U) ) (!  (=> (and (and (or (not (= $o@@183 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@183) alloc)))) (or (= $o@@183 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType $o@@183)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@183 $f@@116)))
 :qid |_12MutexLifetimelongdfy.1220:26|
 :skolemid |1113|
))))) (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#0@@34| T@U) ) (!  (=> (and ($Is refType |o#0@@34| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@34|))) (and (and (and (= (_module.Object.universe |o#0@@34|) |universe#0|) (or (not (= |o#0@@34| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#0@@34|)) (_module.Object.triggerAxioms $Heap@3 |o#0@@34|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@3 |o#0@@34|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@3 |o#0@@34|))
 :pattern ( (_module.Object.universe |o#0@@34|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@34|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (forall ((|o#1@@21| T@U) ) (!  (=> (and ($Is refType |o#1@@21| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@21|))) (_module.Object.inv $Heap@3 |o#1@@21|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
 :pattern ( (_module.Object.inv $Heap@3 |o#1@@21|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@21|)))
...
)) (forall (($o@@185 T@U) ) (!  (=> (and (or (not (= $o@@185 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@185) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@185) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@185)) (or (= $o@@185 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType $o@@185)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@185))
))) (and ($HeapSucc $Heap@3 $Heap@4) (forall (($o@@186 T@U) ($f@@118 T@U) ) (!  (=> (and (and (or (not (= $o@@186 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@186) alloc)))) (or (or (= $o@@186 |universe#0|) (= $o@@186 call4formal@this@0@@0)) (and (= $o@@186 (_module.OwnedObject.lifetime call4formal@this@0@@0)) (= $f@@118 _module.Lifetime.elements)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@186 $f@@118)))
 :qid |_12MutexLifetimelongdfy.1223:16|
 :skolemid |1114|
))))))) (and (and (and (and (and (or (not (= call4formal@this@@0 null)) (not true)) (and ($Is refType call4formal@this@@0 Tclass._module.Mutex) ($IsAlloc refType call4formal@this@@0 Tclass._module.Mutex $Heap@@133))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalInv $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalInv $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#0@@35| T@U) ) (!  (=> (and ($Is refType |o#0@@35| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@35|))) (and (and (and (= (_module.Object.universe |o#0@@35|) |universe#0|) (or (not (= |o#0@@35| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@4 |o#0@@35|)) (_module.Object.triggerAxioms $Heap@4 |o#0@@35|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |3464|
 :pattern ( (_module.Object.triggerAxioms $Heap@4 |o#0@@35|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@4 |o#0@@35|))
 :pattern ( (_module.Object.universe |o#0@@35|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@35|)))
)))))))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalInv $Heap@4 |universe#0|) (forall ((|o#1@@22| T@U) ) (!  (=> (and ($Is refType |o#1@@22| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@22|))) (_module.Object.inv $Heap@4 |o#1@@22|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |3466|
 :pattern ( (_module.Object.inv $Heap@4 |o#1@@22|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@22|)))
)))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType call4formal@this@0@@0)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call4formal@this@0@@0) _module.OwnedObject.owner)) |running#0@@3|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.OwnedObject.lifetime call4formal@this@0@@0)) _module.Lifetime.owner)) |running#0@@3|)))) (and (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (or (not (= call4formal@this@0 null)) (not true)) (and ($Is refType call4formal@this@0 Tclass._module.Mutex) ($IsAlloc refType call4formal@this@0 Tclass._module.Mutex $Heap@5)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@5 call4formal@this@0) (=> (_module.Object.objectGlobalInv $Heap@5 call4formal@this@0) (|_module.Universe.legalTransition#canCall| $Heap@4 $Heap@5 |universe#0| |running#0@@3|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@5 call4formal@this@0) (and (_module.Object.objectGlobalInv $Heap@5 call4formal@this@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe call4formal@this@0)) _module.Universe.content)) ($Box refType call4formal@this@0)) (_module.Universe.globalInv $Heap@5 (_module.Object.universe call4formal@this@0)))))))) (and (and (and (and (|_module.Universe.legalTransition#canCall| $Heap@4 $Heap@5 |universe#0| |running#0@@3|) (and (_module.Universe.legalTransition $Heap@4 $Heap@5 |universe#0| |running#0@@3|) (and (and (and (_module.Universe.legalTransitionsSequence $Heap@4 $Heap@5 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@4 |universe#0|)) (forall ((|o#11@@5| T@U) ) (!  (=> (and ($Is refType |o#11@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@5|))) (and (or (forall (($o@@187 T@U) ($f@@119 T@U) ) (!  (=> (or (not (= $o@@187 null)) (not true)) (=> (= $o@@187 |o#11@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@187) $f@@119) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@187) $f@@119))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |3494|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@187) $f@@119))
)) (_module.Object.inv $Heap@5 |o#11@@5|)) (or (forall (($o@@188 T@U) ($f@@120 T@U) ) (!  (=> (or (not (= $o@@188 null)) (not true)) (=> (= $o@@188 |o#11@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@188) $f@@120) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@188) $f@@120))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |3495|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@188) $f@@120))
...
))) (forall ((|o#12@@2| T@U) ) (!  (=> (and ($Is refType |o#12@@2| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@2|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@2|))))) (_module.Object.inv $Heap@5 |o#12@@2|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |3497|
 :pattern ( (_module.Object.inv $Heap@5 |o#12@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@2|)))
))))) (= (_module.Object.universe call4formal@this@0) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call4formal@this@0) _module.OwnedObject.owner)) |running#0@@3|) (= (_module.OwnedObject.lifetime call4formal@this@0) (_module.OwnedObject.lifetime call4formal@this@0@@0)))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call4formal@this@0) _module.Mutex.data)) call4formal@this@0@@0) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call4formal@this@0) _module.Mutex.locked))))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.OwnedObject.lifetime call4formal@this@0@@0)) _module.Lifetime.elements)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.OwnedObject.lifetime call4formal@this@0@@0)) _module.Lifetime.elements)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0))))))))) (and (and (and (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call4formal@this@0) alloc)))) (forall (($o@@189 T@U) ) (!  (=> (and (or (not (= $o@@189 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@189) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@189) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@189)) (or (or (= $o@@189 |universe#0|) (= $o@@189 call4formal@this@0@@0)) (= $o@@189 (_module.OwnedObject.lifetime call4formal@this@0@@0)))))
 :qid |_12MutexLifetimelongdfy.811:3|
 :skolemid |3498|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@189))
))) (and (forall (($o@@190 T@U) ($f@@121 T@U) ) (!  (=> (and (or (not (= $o@@190 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@190) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@190) $f@@121) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@190) $f@@121)) (or (or (= $o@@190 |universe#0|) (= $o@@190 call4formal@this@0@@0)) (and (= $o@@190 (_module.OwnedObject.lifetime call4formal@this@0@@0)) (= $f@@121 _module.Lifetime.elements)))))
 :qid |_12MutexLifetimelongdfy.811:3|
 :skolemid |3499|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@190) $f@@121))
)) ($HeapSucc $Heap@4 $Heap@5))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@4)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content))) (forall ((|l#1@@12| T@U) ) (!  (=> (and ($Is refType |l#1@@12| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@12|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@12|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |l#1@@12|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@12|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |l#1@@12|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |l#1@@12|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@12|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |l#1@@12|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#1@@12|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@12|)))
...
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@4 $Heap@6 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@4 $Heap@6 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@4 $Heap@6 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@4 $Heap@6 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@6 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@6 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@6 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@6 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@4 $Heap@6 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@4 $Heap@6 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@4 $Heap@6 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@4 $Heap@6 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@6 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@6 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@6 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@6 |universe#0|) (forall ((|o#1@@23| T@U) ) (!  (=> (and ($Is refType |o#1@@23| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@23|))) (and (and (and (= (_module.Object.universe |o#1@@23|) |universe#0|) (or (not (= |o#1@@23| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@6 |o#1@@23|)) (_module.Object.triggerAxioms $Heap@6 |o#1@@23|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@6 |o#1@@23|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@6 |o#1@@23|))
 :pattern ( (_module.Object.universe |o#1@@23|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@23|)))
...
))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@4 $Heap@6 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@4 $Heap@6 |universe#0| |running#0@@3|) (forall ((|o#7@@4| T@U) ) (!  (=> (and ($Is refType |o#7@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@4|))) (and (or (forall (($o@@192 T@U) ($f@@123 T@U) ) (!  (=> (or (not (= $o@@192 null)) (not true)) (=> (= $o@@192 |o#7@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@192) $f@@123) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@192) $f@@123))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@192) $f@@123))
)) (_module.Object.inv $Heap@6 |o#7@@4|)) (or (forall (($o@@193 T@U) ($f@@124 T@U) ) (!  (=> (or (not (= $o@@193 null)) (not true)) (=> (= $o@@193 |o#7@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@193) $f@@124) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@193) $f@@124))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@193) $f@@124))
...
)))))) (and (and (and (= $Heap@6 $Heap@7) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@7)) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@4) (|_module.Universe.globalSequenceInv2#canCall| $Heap@4 $Heap@7 |universe#0|))) (and (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@4 $Heap@7 |universe#0|) (_module.Universe.globalSequenceInv2 $Heap@4 $Heap@7 |universe#0|)) (and (U_2_bool (Lit boolType (bool_2_U true))) (forall (($o@@194 T@U) ($f@@125 T@U) ) (!  (=> (and (and (or (not (= $o@@194 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@194) alloc)))) (or (= $o@@194 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType $o@@194)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@194 $f@@125)))
 :qid |_12MutexLifetimelongdfy.1229:26|
 :skolemid |1119|
)))))) (and (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalInv $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalInv $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (forall ((|o#0@@37| T@U) ) (!  (=> (and ($Is refType |o#0@@37| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@37|))) (and (and (and (= (_module.Object.universe |o#0@@37|) |universe#0|) (or (not (= |o#0@@37| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@7 |o#0@@37|)) (_module.Object.triggerAxioms $Heap@7 |o#0@@37|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@7 |o#0@@37|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@7 |o#0@@37|))
 :pattern ( (_module.Object.universe |o#0@@37|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@37|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalInv $Heap@7 |universe#0|) (forall ((|o#1@@24| T@U) ) (!  (=> (and ($Is refType |o#1@@24| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@24|))) (_module.Object.inv $Heap@7 |o#1@@24|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
 :pattern ( (_module.Object.inv $Heap@7 |o#1@@24|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@24|)))
...
)) (forall (($o@@196 T@U) ) (!  (=> (and (or (not (= $o@@196 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@196) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@196) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@196)) (or (= $o@@196 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType $o@@196)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@196))
)))) (and (and (and ($HeapSucc $Heap@7 $Heap@8) (or (not (= call4formal@this@0 null)) (not true))) (and (= |mightPointTo##0@0| (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime call4formal@this@0)))) (forall (($o@@197 T@U) ($f@@127 T@U) ) (!  (=> (and (and (or (not (= $o@@197 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@197) alloc)))) (or (= $o@@197 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@197)) (= $f@@127 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@197 $f@@127)))
 :qid |_12MutexLifetimelongdfy.1234:21|
 :skolemid |1120|
)))) (and (and (or (not (= call5formal@this@@0 null)) (not true)) (and ($Is refType call5formal@this@@0 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@@0 Tclass._module.Lifetime $Heap@@133))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalInv $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalInv $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (forall ((|o#0@@38| T@U) ) (!  (=> (and ($Is refType |o#0@@38| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@38|))) (and (and (and (= (_module.Object.universe |o#0@@38|) |universe#0|) (or (not (= |o#0@@38| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@8 |o#0@@38|)) (_module.Object.triggerAxioms $Heap@8 |o#0@@38|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2625|
 :pattern ( (_module.Object.triggerAxioms $Heap@8 |o#0@@38|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@8 |o#0@@38|))
 :pattern ( (_module.Object.universe |o#0@@38|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@38|)))
)))))))))) (and (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalInv $Heap@8 |universe#0|) (forall ((|o#1@@25| T@U) ) (!  (=> (and ($Is refType |o#1@@25| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@25|))) (_module.Object.inv $Heap@8 |o#1@@25|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |2627|
 :pattern ( (_module.Object.inv $Heap@8 |o#1@@25|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@25|)))
)))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)))) (and (|Set#Subset| |mightPointTo##0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content))) (forall ((|l#1@@13| T@U) ) (!  (=> (and ($Is refType |l#1@@13| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@13|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |l#1@@13|) _module.Lifetime.owner)) |running#0@@3|))
 :qid |_12MutexLifetimelongdfy.612:21|
 :skolemid |2629|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |l#1@@13|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@13|)))
)))) (and (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (and (or (not (= call5formal@this@0 null)) (not true)) (and ($Is refType call5formal@this@0 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@0 Tclass._module.Lifetime $Heap@9))))) (and (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@9 call5formal@this@0) (=> (_module.Object.objectGlobalInv $Heap@9 call5formal@this@0) (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@9 |universe#0| |running#0@@3|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@9 call5formal@this@0) (and (_module.Object.objectGlobalInv $Heap@9 call5formal@this@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe call5formal@this@0)) _module.Universe.content)) ($Box refType call5formal@this@0)) (_module.Universe.globalInv $Heap@9 (_module.Object.universe call5formal@this@0)))))) (and (and (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@9 |universe#0| |running#0@@3|) (and (_module.Universe.legalTransition $Heap@8 $Heap@9 |universe#0| |running#0@@3|) (and (and (and (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@9 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@8 |universe#0|)) (forall ((|o#11@@7| T@U) ) (!  (=> (and ($Is refType |o#11@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@7|))) (and (or (forall (($o@@198 T@U) ($f@@128 T@U) ) (!  (=> (or (not (= $o@@198 null)) (not true)) (=> (= $o@@198 |o#11@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@198) $f@@128) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@198) $f@@128))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2656|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@198) $f@@128))
)) (_module.Object.inv $Heap@9 |o#11@@7|)) (or (forall (($o@@199 T@U) ($f@@129 T@U) ) (!  (=> (or (not (= $o@@199 null)) (not true)) (=> (= $o@@199 |o#11@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@199) $f@@129) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@199) $f@@129))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2657|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@199) $f@@129))
...
))) (forall ((|o#12@@3| T@U) ) (!  (=> (and ($Is refType |o#12@@3| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@3|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@3|))))) (_module.Object.inv $Heap@9 |o#12@@3|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |2659|
 :pattern ( (_module.Object.inv $Heap@9 |o#12@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@3|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@3|)))
...
))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 call5formal@this@0) alloc)))) (forall (($o@@200 T@U) ) (!  (=> (and (or (not (= $o@@200 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@200) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@200) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@200)) (or (= $o@@200 |universe#0|) (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@200)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2661|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@200))
))))) (and (and (and (forall (($o@@201 T@U) ($f@@130 T@U) ) (!  (=> (and (or (not (= $o@@201 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@201) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@201) $f@@130) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@201) $f@@130)) (or (= $o@@201 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@201)) (= $f@@130 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2662|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@201) $f@@130))
)) ($HeapSucc $Heap@8 $Heap@9)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@8))) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content))) (forall ((|l#1@@14| T@U) ) (!  (=> (and ($Is refType |l#1@@14| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@14|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |l#1@@14|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |l#1@@14|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |l#1@@14|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |l#1@@14|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |l#1@@14|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |l#1@@14|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |l#1@@14|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |l#1@@14|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@14|)))
...
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@10 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@10 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@10 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@10 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@10 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@10 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@10 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@10 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@10 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@10 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@10 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@10 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (forall ((|o#1@@26| T@U) ) (!  (=> (and ($Is refType |o#1@@26| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@26|))) (and (and (and (= (_module.Object.universe |o#1@@26|) |universe#0|) (or (not (= |o#1@@26| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@10 |o#1@@26|)) (_module.Object.triggerAxioms $Heap@10 |o#1@@26|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@10 |o#1@@26|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@10 |o#1@@26|))
 :pattern ( (_module.Object.universe |o#1@@26|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@26|)))
...
)))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@10 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@10 |universe#0| |running#0@@3|) (forall ((|o#7@@5| T@U) ) (!  (=> (and ($Is refType |o#7@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@5|))) (and (or (forall (($o@@203 T@U) ($f@@132 T@U) ) (!  (=> (or (not (= $o@@203 null)) (not true)) (=> (= $o@@203 |o#7@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@203) $f@@132) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@203) $f@@132))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@203) $f@@132))
)) (_module.Object.inv $Heap@10 |o#7@@5|)) (or (forall (($o@@204 T@U) ($f@@133 T@U) ) (!  (=> (or (not (= $o@@204 null)) (not true)) (=> (= $o@@204 |o#7@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@204) $f@@133) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@204) $f@@133))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@204) $f@@133))
...
)))) (= $Heap@10 $Heap@11)))) (and (and (and (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@8)) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@8 $Heap@11 |universe#0|) (|_module.Universe.globalSequenceInv2#canCall| $Heap@8 $Heap@11 |universe#0|))) (and (and (_module.Universe.globalSequenceInv2 $Heap@8 $Heap@11 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 call5formal@this@0) _module.Lifetime.mightPointFrom)) |Set#Empty|) (forall (($o@@205 T@U) ($f@@134 T@U) ) (!  (=> (and (and (or (not (= $o@@205 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 $o@@205) alloc)))) (or (= $o@@205 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType $o@@205)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@205 $f@@134)))
 :qid |_12MutexLifetimelongdfy.1241:26|
 :skolemid |1125|
))))) (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (or (_module.Universe.globalInv $Heap@11 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@11 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@11 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (or (_module.Universe.globalInv $Heap@11 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@11 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@11 |universe#0|) (forall ((|o#0@@40| T@U) ) (!  (=> (and ($Is refType |o#0@@40| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@40|))) (and (and (and (= (_module.Object.universe |o#0@@40|) |universe#0|) (or (not (= |o#0@@40| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@11 |o#0@@40|)) (_module.Object.triggerAxioms $Heap@11 |o#0@@40|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@11 |o#0@@40|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@11 |o#0@@40|))
 :pattern ( (_module.Object.universe |o#0@@40|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@40|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (or (_module.Universe.globalInv $Heap@11 |universe#0|) (forall ((|o#1@@27| T@U) ) (!  (=> (and ($Is refType |o#1@@27| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@27|))) (_module.Object.inv $Heap@11 |o#1@@27|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
 :pattern ( (_module.Object.inv $Heap@11 |o#1@@27|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@27|)))
...
)))) (and (and (forall (($o@@207 T@U) ) (!  (=> (and (or (not (= $o@@207 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 $o@@207) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@207) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 $o@@207)) (or (= $o@@207 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType $o@@207)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@207))
)) ($HeapSucc $Heap@11 $Heap@12)) (and (= |mightPointTo##1@0| (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0))) (forall (($o@@208 T@U) ($f@@136 T@U) ) (!  (=> (and (and (or (not (= $o@@208 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@208) alloc)))) (or (= $o@@208 |universe#0|) (and (|Set#IsMember| |mightPointTo##1@0| ($Box refType $o@@208)) (= $f@@136 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@208 $f@@136)))
 :qid |_12MutexLifetimelongdfy.1244:21|
 :skolemid |1126|
)))))) (and (and (and (and (or (not (= call5formal@this@@1 null)) (not true)) (and ($Is refType call5formal@this@@1 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@@1 Tclass._module.Lifetime $Heap@@133))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalInv $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@12 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalInv $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@12 |universe#0|) (forall ((|o#0@@41| T@U) ) (!  (=> (and ($Is refType |o#0@@41| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@41|))) (and (and (and (= (_module.Object.universe |o#0@@41|) |universe#0|) (or (not (= |o#0@@41| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@12 |o#0@@41|)) (_module.Object.triggerAxioms $Heap@12 |o#0@@41|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2625|
 :pattern ( (_module.Object.triggerAxioms $Heap@12 |o#0@@41|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@12 |o#0@@41|))
 :pattern ( (_module.Object.universe |o#0@@41|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@41|)))
)))))))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalInv $Heap@12 |universe#0|) (forall ((|o#1@@28| T@U) ) (!  (=> (and ($Is refType |o#1@@28| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@28|))) (_module.Object.inv $Heap@12 |o#1@@28|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |2627|
 :pattern ( (_module.Object.inv $Heap@12 |o#1@@28|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@28|)))
)))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)))) (and (|Set#Subset| |mightPointTo##1@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content))) (forall ((|l#1@@15| T@U) ) (!  (=> (and ($Is refType |l#1@@15| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##1@0| ($Box refType |l#1@@15|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |l#1@@15|) _module.Lifetime.owner)) |running#0@@3|))
 :qid |_12MutexLifetimelongdfy.612:21|
 :skolemid |2629|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |l#1@@15|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| |mightPointTo##1@0| ($Box refType |l#1@@15|)))
))))) (and (and (and ($IsGoodHeap $Heap@13) ($IsHeapAnchor $Heap@13)) (and (or (not (= call5formal@this@0@@0 null)) (not true)) (and ($Is refType call5formal@this@0@@0 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@0@@0 Tclass._module.Lifetime $Heap@13)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@13 call5formal@this@0@@0) (=> (_module.Object.objectGlobalInv $Heap@13 call5formal@this@0@@0) (|_module.Universe.legalTransition#canCall| $Heap@12 $Heap@13 |universe#0| |running#0@@3|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@13 call5formal@this@0@@0) (and (_module.Object.objectGlobalInv $Heap@13 call5formal@this@0@@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 (_module.Object.universe call5formal@this@0@@0)) _module.Universe.content)) ($Box refType call5formal@this@0@@0)) (_module.Universe.globalInv $Heap@13 (_module.Object.universe call5formal@this@0@@0))))))))))) (and (and (and (and (and (and (and (|_module.Universe.legalTransition#canCall| $Heap@12 $Heap@13 |universe#0| |running#0@@3|) (and (_module.Universe.legalTransition $Heap@12 $Heap@13 |universe#0| |running#0@@3|) (and (and (and (_module.Universe.legalTransitionsSequence $Heap@12 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@12 |universe#0|)) (forall ((|o#11@@9| T@U) ) (!  (=> (and ($Is refType |o#11@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@9|))) (and (or (forall (($o@@209 T@U) ($f@@137 T@U) ) (!  (=> (or (not (= $o@@209 null)) (not true)) (=> (= $o@@209 |o#11@@9|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@209) $f@@137) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@209) $f@@137))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2656|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@209) $f@@137))
)) (_module.Object.inv $Heap@13 |o#11@@9|)) (or (forall (($o@@210 T@U) ($f@@138 T@U) ) (!  (=> (or (not (= $o@@210 null)) (not true)) (=> (= $o@@210 |o#11@@9|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@210) $f@@138) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@210) $f@@138))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2657|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@210) $f@@138))
...
))) (forall ((|o#12@@4| T@U) ) (!  (=> (and ($Is refType |o#12@@4| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@4|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@4|))))) (_module.Object.inv $Heap@13 |o#12@@4|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |2659|
 :pattern ( (_module.Object.inv $Heap@13 |o#12@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@4|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@4|)))
...
))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 call5formal@this@0@@0) alloc)))) (forall (($o@@211 T@U) ) (!  (=> (and (or (not (= $o@@211 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@211) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@211) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@211)) (or (= $o@@211 |universe#0|) (|Set#IsMember| |mightPointTo##1@0| ($Box refType $o@@211)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2661|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@211))
)))) (and (and (forall (($o@@212 T@U) ($f@@139 T@U) ) (!  (=> (and (or (not (= $o@@212 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@212) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@212) $f@@139) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@212) $f@@139)) (or (= $o@@212 |universe#0|) (and (|Set#IsMember| |mightPointTo##1@0| ($Box refType $o@@212)) (= $f@@139 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2662|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@212) $f@@139))
)) ($HeapSucc $Heap@12 $Heap@13)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@12))))) (and (and (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content))) (forall ((|l#1@@16| T@U) ) (!  (=> (and ($Is refType |l#1@@16| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@16|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |l#1@@16|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |l#1@@16|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |l#1@@16|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |l#1@@16|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |l#1@@16|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |l#1@@16|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |l#1@@16|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |l#1@@16|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@16|)))
...
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@12 $Heap@14 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@12 $Heap@14 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@12 $Heap@14 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@12 $Heap@14 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@12 $Heap@14 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@12 $Heap@14 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@14 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@14 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@12 $Heap@14 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@12 $Heap@14 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@12 $Heap@14 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@12 $Heap@14 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@12 $Heap@14 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@12 $Heap@14 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@14 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@14 |universe#0|) (forall ((|o#1@@29| T@U) ) (!  (=> (and ($Is refType |o#1@@29| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@29|))) (and (and (and (= (_module.Object.universe |o#1@@29|) |universe#0|) (or (not (= |o#1@@29| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@14 |o#1@@29|)) (_module.Object.triggerAxioms $Heap@14 |o#1@@29|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@14 |o#1@@29|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@14 |o#1@@29|))
 :pattern ( (_module.Object.universe |o#1@@29|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@29|)))
...
))))))))) (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@12 $Heap@14 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@12 $Heap@14 |universe#0| |running#0@@3|) (forall ((|o#7@@6| T@U) ) (!  (=> (and ($Is refType |o#7@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@6|))) (and (or (forall (($o@@214 T@U) ($f@@141 T@U) ) (!  (=> (or (not (= $o@@214 null)) (not true)) (=> (= $o@@214 |o#7@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@214) $f@@141) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@214) $f@@141))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@214) $f@@141))
)) (_module.Object.inv $Heap@14 |o#7@@6|)) (or (forall (($o@@215 T@U) ($f@@142 T@U) ) (!  (=> (or (not (= $o@@215 null)) (not true)) (=> (= $o@@215 |o#7@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@215) $f@@142) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@215) $f@@142))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@215) $f@@142))
...
)))) (= $Heap@14 $Heap@15)) (and (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@15) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@12)) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@12 $Heap@15 |universe#0|) (|_module.Universe.globalSequenceInv2#canCall| $Heap@12 $Heap@15 |universe#0|)))) (and (and (and (_module.Universe.globalSequenceInv2 $Heap@12 $Heap@15 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 call5formal@this@0) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0@@0))) (forall (($o@@216 T@U) ($f@@143 T@U) ) (!  (=> (and (and (or (not (= $o@@216 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 $o@@216) alloc)))) (or (= $o@@216 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType $o@@216)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@216 $f@@143)))
 :qid |_12MutexLifetimelongdfy.1251:26|
 :skolemid |1131|
)))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalInv $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalInv $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#0@@43| T@U) ) (!  (=> (and ($Is refType |o#0@@43| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@43|))) (and (and (and (= (_module.Object.universe |o#0@@43|) |universe#0|) (or (not (= |o#0@@43| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@15 |o#0@@43|)) (_module.Object.triggerAxioms $Heap@15 |o#0@@43|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@15 |o#0@@43|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@15 |o#0@@43|))
 :pattern ( (_module.Object.universe |o#0@@43|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@43|)))
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalInv $Heap@15 |universe#0|) (forall ((|o#1@@30| T@U) ) (!  (=> (and ($Is refType |o#1@@30| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@30|))) (_module.Object.inv $Heap@15 |o#1@@30|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
 :pattern ( (_module.Object.inv $Heap@15 |o#1@@30|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@30|)))
...
))) (and (forall (($o@@218 T@U) ) (!  (=> (and (or (not (= $o@@218 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 $o@@218) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@218) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 $o@@218)) (or (= $o@@218 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType $o@@218)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@218))
)) ($HeapSucc $Heap@15 $Heap@16))) (and (and (forall (($o@@219 T@U) ($f@@145 T@U) ) (!  (=> (and (and (or (not (= $o@@219 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@219) alloc)))) (or (= $o@@219 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType $o@@219)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@219 $f@@145)))
 :qid |_12MutexLifetimelongdfy.1256:10|
 :skolemid |1132|
)) (=> (|_module.Universe.globalInv#canCall| $Heap@16 |universe#0|) (or (_module.Universe.globalInv $Heap@16 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@16 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@16 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@16 |universe#0|) (or (_module.Universe.globalInv $Heap@16 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@16 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@16 |universe#0|) (forall ((|o#0@@44| T@U) ) (!  (=> (and ($Is refType |o#0@@44| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@44|))) (and (and (and (= (_module.Object.universe |o#0@@44|) |universe#0|) (or (not (= |o#0@@44| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@16 |o#0@@44|)) (_module.Object.triggerAxioms $Heap@16 |o#0@@44|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |927|
 :pattern ( (_module.Object.triggerAxioms $Heap@16 |o#0@@44|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@16 |o#0@@44|))
 :pattern ( (_module.Object.universe |o#0@@44|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@44|)))
)))))) (=> (|_module.Universe.globalInv#canCall| $Heap@16 |universe#0|) (or (_module.Universe.globalInv $Heap@16 |universe#0|) (forall ((|o#1@@31| T@U) ) (!  (=> (and ($Is refType |o#1@@31| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@31|))) (_module.Object.inv $Heap@16 |o#1@@31|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |929|
 :pattern ( (_module.Object.inv $Heap@16 |o#1@@31|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@31|)))
...
))))) (and (|_module.Universe.legalTransitionsSequenceAnyThread#canCall| $Heap@16 $Heap@17 |universe#0|) (and (_module.Universe.legalTransitionsSequenceAnyThread $Heap@16 $Heap@17 |universe#0|) (_module.Universe.legalTransitionsSequence $Heap@16 $Heap@17 |universe#0| (|Set#FromBoogieMap| (|lambda#55| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content))))))))) (and (and (and (forall ((|l#1@@17| T@U) ) (!  (=> ($Is refType |l#1@@17| Tclass._module.Lifetime) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@17|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@17|)))) (|_module.Lifetime.alive#canCall| $Heap@17 |l#1@@17|)))
 :qid |_12MutexLifetimelongdfy.1066:18|
 :skolemid |953|
 :pattern ( (_module.Lifetime.alive $Heap@17 |l#1@@17|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@17|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@17|)))
)) (forall ((|l#1@@18| T@U) ) (!  (=> (and ($Is refType |l#1@@18| Tclass._module.Lifetime) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@18|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@18|))))) (not (_module.Lifetime.alive $Heap@17 |l#1@@18|)))
 :qid |_12MutexLifetimelongdfy.1066:18|
 :skolemid |954|
 :pattern ( (_module.Lifetime.alive $Heap@17 |l#1@@18|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@18|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call5formal@this@0) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@18|)))
))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call5formal@this@0) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call5formal@this@0) _module.Lifetime.elements))))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 (_module.OwnedObject.lifetime call4formal@this@0)) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 (_module.OwnedObject.lifetime call4formal@this@0)) _module.Lifetime.mightPointFrom))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 (_module.OwnedObject.lifetime call4formal@this@0)) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 (_module.OwnedObject.lifetime call4formal@this@0)) _module.Lifetime.elements)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 (_module.OwnedObject.lifetime call4formal@this@0)) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 (_module.OwnedObject.lifetime call4formal@this@0)) _module.Lifetime.owner))) (|_module.Lifetime.alive#canCall| $Heap@17 call5formal@this@0))))) (and (and (and (and (|_module.Lifetime.alive#canCall| $Heap@17 call5formal@this@0) (and (_module.Lifetime.alive $Heap@17 call5formal@this@0) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call5formal@this@0) _module.Lifetime.owner)) null)) (not true)))) (and (|_module.Lifetime.alive#canCall| $Heap@17 call5formal@this@0@@0) (not (_module.Lifetime.alive $Heap@17 call5formal@this@0@@0)))) (and (and (forall (($o@@220 T@U) ) (!  (=> (and (or (not (= $o@@220 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@220) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 $o@@220) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@220)) (or (= $o@@220 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType $o@@220)))))
 :qid |_12MutexLifetimelongdfy.1059:8|
 :skolemid |955|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 $o@@220))
)) ($HeapSucc $Heap@16 $Heap@17)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@16)))) (and (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |universe#0|) _module.Universe.content))) (forall ((|l#1@@19| T@U) ) (!  (=> (and ($Is refType |l#1@@19| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@19|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |l#1@@19|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |l#1@@19|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |l#1@@19|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |l#1@@19|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |l#1@@19|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |l#1@@19|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |l#1@@19|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |l#1@@19|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@19|)))
...
))) (and (= $Heap@17 $Heap@18) (or (not (= |universe#0| null)) (not true)))))))))) (and (=> (= (ControlFlow 0 46) 45) anon21_Then_correct) (=> (= (ControlFlow 0 46) 42) anon21_Else_correct)))))))))))
anon0_correct)))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
