...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@7 alloc this@@14 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)))) ($IsAllocBox ($Box refType this@@14) Tclass._module.Universe? $Heap@@7)) (and (|_module.Universe.globalBaseInv#canCall| $Heap@@7 this@@14) (_module.Universe.globalBaseInv $Heap@@7 this@@14))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@25) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@25)) (or (= $o@@25 this@@14) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType $o@@25)))))
 :qid |_10SequenceInvariantdfy.92:10|
 :skolemid |825|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25))
))) (and ($HeapSucc $Heap@@7 $Heap@0) ($IsAllocBox ($Box refType this@@14) Tclass._module.Universe? $Heap@0))) (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@0 this@@14) (_module.Universe.globalBaseInv $Heap@0 this@@14)) (and ($IsAllocBox ($Box refType this@@14) Tclass._module.Universe? $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Universe) ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
