...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@6 this@@6) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Object) ($IsAlloc refType this@@6 Tclass._module.Object $Heap@@6)))))) (= (_module.Object.triggerAxioms $Heap@@6 this@@6)  (and (or ($Is refType this@@6 Tclass._module.OwnedObject) ($Is refType this@@6 Tclass._module.Thread)) (not (and ($Is refType this@@6 Tclass._module.OwnedObject) ($Is refType this@@6 Tclass._module.Thread))))))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1066|
...
(set-info :boogie-vc-id CheckWellformed$$_module.Object.objectGlobalBaseInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct  (=> (= (_module.Object.objectGlobalBaseInv $Heap@@7 this@@7)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType this@@7)) (_module.Object.baseFieldsInv $Heap@@7 this@@7)) (_module.Universe.globalBaseInv $Heap@@7 (_module.Object.universe this@@7)))) (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType this@@7)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@7 this@@7) (=> (_module.Object.baseFieldsInv $Heap@@7 this@@7) (|_module.Universe.globalBaseInv#canCall| $Heap@@7 (_module.Object.universe this@@7))))) ($Is boolType (bool_2_U (_module.Object.objectGlobalBaseInv $Heap@@7 this@@7)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))))
(let ((anon11_Else_correct  (=> (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType this@@7)) (_module.Object.baseFieldsInv $Heap@@7 this@@7))) (=> (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 8) 3)) anon7_correct))))
(let ((anon11_Then_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType this@@7)) (_module.Object.baseFieldsInv $Heap@@7 this@@7)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= (_module.Object.universe this@@7) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@7) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@7)) Tclass._module.Universe? $Heap@@7) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@18) alloc)))) (or (= $o@@18 (_module.Object.universe this@@7)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType $o@@18)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_10SequenceInvariantdfy.196:107|
 :skolemid |1048|
))) (|_module.Universe.globalBaseInv#canCall| $Heap@@7 (_module.Object.universe this@@7))) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon7_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType this@@7))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 10) 6) anon11_Then_correct) (=> (= (ControlFlow 0 10) 8) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType this@@7)) (=> (and (and ($IsAllocBox ($Box refType this@@7) Tclass._module.Object? $Heap@@7) (= |b$reqreads#1@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@19) alloc)))) (or (= $o@@19 this@@7) (= $o@@19 (_module.Object.universe this@@7)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_10SequenceInvariantdfy.196:79|
 :skolemid |1047|
)))) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@7 this@@7) (= |b$reqreads#1@1| |b$reqreads#1@0|))) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= (_module.Object.universe this@@7) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@7) null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 (_module.Object.universe this@@7) _module.Universe.content))) (and (=> (= (ControlFlow 0 11) 9) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@7 alloc $Heap@@7 alloc)) (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 11) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Object) ($IsAlloc refType this@@7 Tclass._module.Object $Heap@@7))) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
