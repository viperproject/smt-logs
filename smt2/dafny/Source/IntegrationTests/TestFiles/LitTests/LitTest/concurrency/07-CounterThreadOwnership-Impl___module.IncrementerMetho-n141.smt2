...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.AtomicCounter.baseUserInv#canCall| $Heap@@3 this@@11) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.AtomicCounter)))) (= (_module.OwnedObject.baseUserInv $Heap@@3 this@@11) (_module.AtomicCounter.baseUserInv $Heap@@3 this@@11)))
 :qid |_07CounterThreadOwnershipdfy.384:19|
 :skolemid |1670|
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@3 this@@11) ($Is refType this@@11 Tclass._module.AtomicCounter) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@3 this@@11) (_module.AtomicCounter.baseUserInv $Heap@@3 this@@11) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.AtomicCounter.localUserInv#canCall| $Heap@@4 this@@12) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@12 null)) (not true)) ($Is refType this@@12 Tclass._module.AtomicCounter)))) (= (_module.OwnedObject.localUserInv $Heap@@4 this@@12) (_module.AtomicCounter.localUserInv $Heap@@4 this@@12)))
 :qid |_07CounterThreadOwnershipdfy.385:19|
 :skolemid |1677|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@4 this@@12) ($Is refType this@@12 Tclass._module.AtomicCounter) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@4 this@@12) (_module.AtomicCounter.localUserInv $Heap@@4 this@@12) ($IsGoodHeap $Heap@@4))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.Remaining.baseUserInv#canCall| $Heap@@5 this@@13) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@13 null)) (not true)) ($Is refType this@@13 Tclass._module.Remaining)))) (= (_module.OwnedObject.baseUserInv $Heap@@5 this@@13) (_module.Remaining.baseUserInv $Heap@@5 this@@13)))
 :qid |_07CounterThreadOwnershipdfy.384:19|
 :skolemid |1908|
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@5 this@@13) ($Is refType this@@13 Tclass._module.Remaining) ($IsGoodHeap $Heap@@5))
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@5 this@@13) (_module.Remaining.baseUserInv $Heap@@5 this@@13) ($IsGoodHeap $Heap@@5))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Remaining.localUserInv#canCall| $Heap@@6 this@@14) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.Remaining)))) (= (_module.OwnedObject.localUserInv $Heap@@6 this@@14) (_module.Remaining.localUserInv $Heap@@6 this@@14)))
 :qid |_07CounterThreadOwnershipdfy.385:19|
 :skolemid |1915|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@6 this@@14) ($Is refType this@@14 Tclass._module.Remaining) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@6 this@@14) (_module.Remaining.localUserInv $Heap@@6 this@@14) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.IncrementerMethod.localUserInv#canCall| $Heap@@7 this@@15) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@15 null)) (not true)) ($Is refType this@@15 Tclass._module.IncrementerMethod)))) (= (_module.OwnedObject.localUserInv $Heap@@7 this@@15) (_module.IncrementerMethod.localUserInv $Heap@@7 this@@15)))
 :qid |_07CounterThreadOwnershipdfy.385:19|
 :skolemid |2163|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@7 this@@15) ($Is refType this@@15 Tclass._module.IncrementerMethod) ($IsGoodHeap $Heap@@7))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@7 this@@15) (_module.IncrementerMethod.localUserInv $Heap@@7 this@@15) ($IsGoodHeap $Heap@@7))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.AtomicCounter.userInv#canCall| $Heap@@8 this@@16) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@16 null)) (not true)) ($Is refType this@@16 Tclass._module.AtomicCounter)))) (= (_module.OwnedObject.userInv $Heap@@8 this@@16) (_module.AtomicCounter.userInv $Heap@@8 this@@16)))
 :qid |_07CounterThreadOwnershipdfy.387:19|
 :skolemid |1684|
 :pattern ( (_module.OwnedObject.userInv $Heap@@8 this@@16) ($Is refType this@@16 Tclass._module.AtomicCounter) ($IsGoodHeap $Heap@@8))
 :pattern ( (_module.OwnedObject.userInv $Heap@@8 this@@16) (_module.AtomicCounter.userInv $Heap@@8 this@@16) ($IsGoodHeap $Heap@@8))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Remaining.userInv#canCall| $Heap@@9 this@@17) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@17 null)) (not true)) ($Is refType this@@17 Tclass._module.Remaining)))) (= (_module.OwnedObject.userInv $Heap@@9 this@@17) (_module.Remaining.userInv $Heap@@9 this@@17)))
 :qid |_07CounterThreadOwnershipdfy.387:19|
 :skolemid |1922|
 :pattern ( (_module.OwnedObject.userInv $Heap@@9 this@@17) ($Is refType this@@17 Tclass._module.Remaining) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.OwnedObject.userInv $Heap@@9 this@@17) (_module.Remaining.userInv $Heap@@9 this@@17) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.IncrementerMethod.baseUserInv#canCall| $Heap@@10 this@@18) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@18 null)) (not true)) ($Is refType this@@18 Tclass._module.IncrementerMethod)))) (= (_module.OwnedObject.baseUserInv $Heap@@10 this@@18) (_module.IncrementerMethod.baseUserInv $Heap@@10 this@@18)))
 :qid |_07CounterThreadOwnershipdfy.384:19|
 :skolemid |2156|
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@10 this@@18) ($Is refType this@@18 Tclass._module.IncrementerMethod) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@10 this@@18) (_module.IncrementerMethod.baseUserInv $Heap@@10 this@@18) ($IsGoodHeap $Heap@@10))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.IncrementerMethod.userInv#canCall| $Heap@@14 this@@22) (and (< 5 $FunctionContextHeight) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.IncrementerMethod)))) (= (_module.OwnedObject.userInv $Heap@@14 this@@22) (_module.IncrementerMethod.userInv $Heap@@14 this@@22)))
 :qid |_07CounterThreadOwnershipdfy.387:19|
 :skolemid |2170|
 :pattern ( (_module.OwnedObject.userInv $Heap@@14 this@@22) ($Is refType this@@22 Tclass._module.IncrementerMethod) ($IsGoodHeap $Heap@@14))
 :pattern ( (_module.OwnedObject.userInv $Heap@@14 this@@22) (_module.IncrementerMethod.userInv $Heap@@14 this@@22) ($IsGoodHeap $Heap@@14))
))))
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@15 this@@23) (and (< 7 $FunctionContextHeight) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@15 this@@23) (_module.OwnedObject.inv $Heap@@15 this@@23)))
 :qid |_07CounterThreadOwnershipdfy.273:19|
 :skolemid |1314|
 :pattern ( (_module.Object.inv $Heap@@15 this@@23) ($Is refType this@@23 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@15))
 :pattern ( (_module.Object.inv $Heap@@15 this@@23) (_module.OwnedObject.inv $Heap@@15 this@@23) ($IsGoodHeap $Heap@@15))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@24 T@U) ) (!  (=> (or (|_module.IncrementerMethod.userInv#canCall| $Heap@@16 this@@24) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@24 Tclass._module.IncrementerMethod $Heap@@16)))))) (and (and (|_module.IncrementerMethod.localUserInv#canCall| $Heap@@16 this@@24) (=> (_module.IncrementerMethod.localUserInv $Heap@@16 this@@24) (and (|_module.OwnedObject.localInv#canCall| $Heap@@16 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@24) _module.IncrementerMethod.counter))) (=> (_module.OwnedObject.localInv $Heap@@16 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@24) _module.IncrementerMethod.counter))) (|_module.OwnedObject.localInv#canCall| $Heap@@16 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@24) _module.IncrementerMethod.remaining))))))) (= (_module.IncrementerMethod.userInv $Heap@@16 this@@24)  (and (and (_module.IncrementerMethod.localUserInv $Heap@@16 this@@24) (_module.OwnedObject.localInv $Heap@@16 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@24) _module.IncrementerMethod.counter)))) (_module.OwnedObject.localInv $Heap@@16 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 this@@24) _module.IncrementerMethod.remaining)))))))
 :qid |_07CounterThreadOwnershipdfy.670:19|
 :skolemid |2169|
 :pattern ( (_module.IncrementerMethod.userInv $Heap@@16 this@@24) ($IsGoodHeap $Heap@@16))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@8 T@U) ($Heap@@17 T@U) (this@@25 T@U) ) (!  (=> (or (|_module.IncrementerMethod.localUserInv2#canCall| $prevHeap@@8 $Heap@@17 this@@25) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@8) ($IsGoodHeap $Heap@@17)) ($HeapSucc $prevHeap@@8 $Heap@@17)) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@25 Tclass._module.IncrementerMethod $prevHeap@@8)))))) (= (_module.IncrementerMethod.localUserInv2 $prevHeap@@8 $Heap@@17 this@@25)  (and (and (and (and (and (and (and (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.OwnedObject.owner))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.counter)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.counter)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.remaining)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.remaining)))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 3))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.i)))))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 3)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 4))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.i)))))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 4)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 5))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.i)))))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 5)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 6))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.i)))))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 6)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 7))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.i)))))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 7)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 8))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.i)))))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 8)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 2))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.i)))))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 8)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.programCounter))) (LitInt 9))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@25) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@25) _module.IncrementerMethod.i))))))))
 :qid |_07CounterThreadOwnershipdfy.676:22|
 :skolemid |2179|
 :pattern ( (_module.IncrementerMethod.localUserInv2 $prevHeap@@8 $Heap@@17 this@@25) ($IsGoodHeap $Heap@@17))
))))
...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($prevHeap@@32 T@U) ($Heap@@27 T@U) (this@@53 T@U) (|running#0@@2| T@U) ) (!  (=> (or (|_module.Universe.legalTransition#canCall| $prevHeap@@32 $Heap@@27 this@@53 |running#0@@2|) (and (< 10 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@32) ($IsGoodHeap $Heap@@27)) ($HeapSucc $prevHeap@@32 $Heap@@27)) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Universe) ($IsAlloc refType this@@53 Tclass._module.Universe $prevHeap@@32)))) ($Is refType |running#0@@2| Tclass._module.Thread)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@32 $Heap@@27 this@@53 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (=> (_module.Universe.legalTransitionsSequence $prevHeap@@32 $Heap@@27 this@@53 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (and (|_module.Universe.globalInv#canCall| $prevHeap@@32 this@@53) (=> (_module.Universe.globalInv $prevHeap@@32 this@@53) (and (|_module.Universe.globalBaseInv#canCall| $Heap@@27 this@@53) (=> (_module.Universe.globalBaseInv $Heap@@27 this@@53) (and (forall ((|o#0@@2| T@U) ) (!  (=> ($Is refType |o#0@@2| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@32 this@@53) _module.Universe.content)) ($Box refType |o#0@@2|)) (and (=> (not (forall (($o@@37 T@U) ($f@@25 T@U) ) (!  (=> (or (not (= $o@@37 null)) (not true)) (=> (= $o@@37 |o#0@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 $o@@37) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@32 $o@@37) $f@@25))))
 ...
 :skolemid |579|
 :pattern ( (_module.Universe.legalTransition $prevHeap@@32 $Heap@@27 this@@53 |running#0@@2|) ($IsGoodHeap $Heap@@27))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@49 T@U) ($Heap@@46 T@U) (this@@72 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@49 $Heap@@46 this@@72) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@49) ($IsGoodHeap $Heap@@46)) ($HeapSucc $prevHeap@@49 $Heap@@46)) (and (or (not (= this@@72 null)) (not true)) (and ($Is refType this@@72 Tclass._module.Thread) ($IsAlloc refType this@@72 Tclass._module.Thread $prevHeap@@49)))))) (= (_module.Thread.localInv2 $prevHeap@@49 $Heap@@46 this@@72) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_07CounterThreadOwnershipdfy.291:22|
 :skolemid |1108|
 :pattern ( (_module.Thread.localInv2 $prevHeap@@49 $Heap@@46 this@@72) ($IsGoodHeap $Heap@@46))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@50 T@U) ($Heap@@47 T@U) (this@@73 T@U) ) (!  (=> (or (|_module.Thread.transitiveInv2#canCall| $prevHeap@@50 $Heap@@47 this@@73) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@50) ($IsGoodHeap $Heap@@47)) ($HeapSucc $prevHeap@@50 $Heap@@47)) (and (or (not (= this@@73 null)) (not true)) (and ($Is refType this@@73 Tclass._module.Thread) ($IsAlloc refType this@@73 Tclass._module.Thread $prevHeap@@50)))))) (= (_module.Thread.transitiveInv2 $prevHeap@@50 $Heap@@47 this@@73) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_07CounterThreadOwnershipdfy.294:22|
 :skolemid |1115|
 :pattern ( (_module.Thread.transitiveInv2 $prevHeap@@50 $Heap@@47 this@@73) ($IsGoodHeap $Heap@@47))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@51 T@U) ($Heap@@48 T@U) (this@@74 T@U) ) (!  (=> (or (|_module.AtomicCounter.unchangedNonvolatileUserFields#canCall| $prevHeap@@51 $Heap@@48 this@@74) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@51) ($IsGoodHeap $Heap@@48)) ($HeapSucc $prevHeap@@51 $Heap@@48)) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.AtomicCounter) ($IsAlloc refType this@@74 Tclass._module.AtomicCounter $prevHeap@@51)))))) (= (_module.AtomicCounter.unchangedNonvolatileUserFields $prevHeap@@51 $Heap@@48 this@@74) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_07CounterThreadOwnershipdfy.485:22|
 :skolemid |1655|
 :pattern ( (_module.AtomicCounter.unchangedNonvolatileUserFields $prevHeap@@51 $Heap@@48 this@@74) ($IsGoodHeap $Heap@@48))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@52 T@U) ($Heap@@49 T@U) (this@@75 T@U) ) (!  (=> (or (|_module.AtomicCounter.userInv2#canCall| $prevHeap@@52 $Heap@@49 this@@75) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@52) ($IsGoodHeap $Heap@@49)) ($HeapSucc $prevHeap@@52 $Heap@@49)) (and (or (not (= this@@75 null)) (not true)) (and ($Is refType this@@75 Tclass._module.AtomicCounter) ($IsAlloc refType this@@75 Tclass._module.AtomicCounter $prevHeap@@52)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.AtomicCounter.localUserInv2#canCall| $prevHeap@@52 $Heap@@49 this@@75)) (= (_module.AtomicCounter.userInv2 $prevHeap@@52 $Heap@@49 this@@75)  (and true (_module.AtomicCounter.localUserInv2 $prevHeap@@52 $Heap@@49 this@@75)))))
 :qid |_07CounterThreadOwnershipdfy.504:22|
 :skolemid |1698|
 :pattern ( (_module.AtomicCounter.userInv2 $prevHeap@@52 $Heap@@49 this@@75) ($IsGoodHeap $Heap@@49))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@53 T@U) ($Heap@@50 T@U) (this@@76 T@U) ) (!  (=> (or (|_module.Remaining.userInv2#canCall| $prevHeap@@53 $Heap@@50 this@@76) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@53) ($IsGoodHeap $Heap@@50)) ($HeapSucc $prevHeap@@53 $Heap@@50)) (and (or (not (= this@@76 null)) (not true)) (and ($Is refType this@@76 Tclass._module.Remaining) ($IsAlloc refType this@@76 Tclass._module.Remaining $prevHeap@@53)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Remaining.localUserInv2#canCall| $prevHeap@@53 $Heap@@50 this@@76)) (= (_module.Remaining.userInv2 $prevHeap@@53 $Heap@@50 this@@76)  (and true (_module.Remaining.localUserInv2 $prevHeap@@53 $Heap@@50 this@@76)))))
 :qid |_07CounterThreadOwnershipdfy.565:22|
 :skolemid |1936|
 :pattern ( (_module.Remaining.userInv2 $prevHeap@@53 $Heap@@50 this@@76) ($IsGoodHeap $Heap@@50))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@54 T@U) ($Heap@@51 T@U) (this@@77 T@U) ) (!  (=> (or (|_module.IncrementerMethod.userInv2#canCall| $prevHeap@@54 $Heap@@51 this@@77) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@54) ($IsGoodHeap $Heap@@51)) ($HeapSucc $prevHeap@@54 $Heap@@51)) (and (or (not (= this@@77 null)) (not true)) (and ($Is refType this@@77 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@77 Tclass._module.IncrementerMethod $prevHeap@@54)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.IncrementerMethod.localUserInv2#canCall| $prevHeap@@54 $Heap@@51 this@@77)) (= (_module.IncrementerMethod.userInv2 $prevHeap@@54 $Heap@@51 this@@77)  (and true (_module.IncrementerMethod.localUserInv2 $prevHeap@@54 $Heap@@51 this@@77)))))
 :qid |_07CounterThreadOwnershipdfy.689:22|
 :skolemid |2186|
 :pattern ( (_module.IncrementerMethod.userInv2 $prevHeap@@54 $Heap@@51 this@@77) ($IsGoodHeap $Heap@@51))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@55 T@U) ($Heap@@52 T@U) (this@@78 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@55 $Heap@@52 this@@78) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@55) ($IsGoodHeap $Heap@@52)) ($HeapSucc $prevHeap@@55 $Heap@@52)) (and (or (not (= this@@78 null)) (not true)) (and ($Is refType this@@78 Tclass._module.OwnedObject) ($IsAlloc refType this@@78 Tclass._module.OwnedObject $prevHeap@@55)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.localUserInv2#canCall| $prevHeap@@55 $Heap@@52 this@@78)) (= (_module.OwnedObject.localInv2 $prevHeap@@55 $Heap@@52 this@@78)  (and true (_module.OwnedObject.localUserInv2 $prevHeap@@55 $Heap@@52 this@@78)))))
 :qid |_07CounterThreadOwnershipdfy.338:22|
 :skolemid |1326|
 :pattern ( (_module.OwnedObject.localInv2 $prevHeap@@55 $Heap@@52 this@@78) ($IsGoodHeap $Heap@@52))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@56 T@U) ($Heap@@53 T@U) (this@@79 T@U) ) (!  (=> (or (|_module.Remaining.localUserInv2#canCall| $prevHeap@@56 $Heap@@53 this@@79) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@56) ($IsGoodHeap $Heap@@53)) ($HeapSucc $prevHeap@@56 $Heap@@53)) (and (or (not (= this@@79 null)) (not true)) (and ($Is refType this@@79 Tclass._module.Remaining) ($IsAlloc refType this@@79 Tclass._module.Remaining $prevHeap@@56)))))) (= (_module.Remaining.localUserInv2 $prevHeap@@56 $Heap@@53 this@@79) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.562:22|
 :skolemid |1929|
 :pattern ( (_module.Remaining.localUserInv2 $prevHeap@@56 $Heap@@53 this@@79) ($IsGoodHeap $Heap@@53))
))))
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($prevHeap@@57 T@U) ($Heap@@54 T@U) (this@@80 T@U) (|running#0@@3| T@U) ) (!  (=> (or (|_module.Object.goodPreAndLegalChanges#canCall| $prevHeap@@57 $Heap@@54 this@@80 |running#0@@3|) (and (< 11 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@57) ($IsGoodHeap $Heap@@54)) ($HeapSucc $prevHeap@@57 $Heap@@54)) (and (or (not (= this@@80 null)) (not true)) (and ($Is refType this@@80 Tclass._module.Object) ($IsAlloc refType this@@80 Tclass._module.Object $prevHeap@@57)))) ($Is refType |running#0@@3| Tclass._module.Thread)))) (and (and (and (|_module.Object.baseInv#canCall| $prevHeap@@57 this@@80) (=> (_module.Object.baseInv $prevHeap@@57 this@@80) (|_module.Universe.globalInv#canCall| $prevHeap@@57 (_module.Object.universe this@@80)))) (=> (and (_module.Object.baseInv $prevHeap@@57 this@@80) (_module.Universe.globalInv $prevHeap@@57 (_module.Object.universe this@@80))) (and (|_module.Object.baseInv#canCall| $Heap@@54 this@@80) (=> (_module.Object.baseInv $Heap@@54 this@@80) (=> (forall (($o@@61 T@U) ($f@@32 T@U) ) (!  (=> (or (not (= $o@@61 null)) (not true)) (=> (= $o@@61 this@@80) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@54 $o@@61) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 $o@@61) $f@@32))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |992|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@54 $o@@61) $f@@32))
)) (|_module.Universe.legalTransition#canCall| $prevHeap@@57 $Heap@@54 (_module.Object.universe this@@80) |running#0@@3|)))))) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@57 $Heap@@54 this@@80 |running#0@@3|)  (and (and (and (and (_module.Object.baseInv $prevHeap@@57 this@@80) (_module.Universe.globalInv $prevHeap@@57 (_module.Object.universe this@@80))) (_module.Object.baseInv $Heap@@54 this@@80)) (forall (($o@@62 T@U) ($f@@33 T@U) ) (!  (=> (or (not (= $o@@62 null)) (not true)) (=> (= $o@@62 this@@80) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@54 $o@@62) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 $o@@62) $f@@33))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |991|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@54 $o@@62) $f@@33))
))) (_module.Universe.legalTransition $prevHeap@@57 $Heap@@54 (_module.Object.universe this@@80) |running#0@@3|)))))
 :qid |_07CounterThreadOwnershipdfy.257:22|
 :skolemid |993|
 :pattern ( (_module.Object.goodPreAndLegalChanges $prevHeap@@57 $Heap@@54 this@@80 |running#0@@3|) ($IsGoodHeap $Heap@@54))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@58 T@U) ($Heap@@63 T@U) (this@@89 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@58 $Heap@@63 this@@89) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@58) ($IsGoodHeap $Heap@@63)) ($HeapSucc $prevHeap@@58 $Heap@@63)) (and (or (not (= this@@89 null)) (not true)) (and ($Is refType this@@89 Tclass._module.OwnedObject) ($IsAlloc refType this@@89 Tclass._module.OwnedObject $prevHeap@@58)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@58 this@@89) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@63 this@@89) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@58 $Heap@@63 this@@89)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@58 $Heap@@63 this@@89)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@58 this@@89) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@63 this@@89) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@58 $Heap@@63 this@@89)))))
 :qid |_07CounterThreadOwnershipdfy.375:22|
 :skolemid |1375|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@58 $Heap@@63 this@@89) ($IsGoodHeap $Heap@@63))
))))
...
(assert (forall (($h@@30 T@U) ($o@@63 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@30) (and (or (not (= $o@@63 null)) (not true)) ($Is refType $o@@63 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@63) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@63) _module.OwnedObject.nonvolatileVersion)) TInt $h@@30))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1290|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@63) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h@@31 T@U) ($o@@64 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (or (not (= $o@@64 null)) (not true)) (= (dtype $o@@64) Tclass._module.AtomicCounter?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@64) _module.AtomicCounter.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1648|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@64) _module.AtomicCounter.value)))
)))
(assert (forall (($h@@32 T@U) ($o@@65 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (or (not (= $o@@65 null)) (not true)) (= (dtype $o@@65) Tclass._module.Remaining?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@65) _module.Remaining.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1886|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@65) _module.Remaining.value)))
)))
(assert (forall (($h@@33 T@U) ($o@@66 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (or (not (= $o@@66 null)) (not true)) (= (dtype $o@@66) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@66) _module.IncrementerMethod.programCounter)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2124|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@66) _module.IncrementerMethod.programCounter)))
)))
(assert (forall (($h@@34 T@U) ($o@@67 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (or (not (= $o@@67 null)) (not true)) (= (dtype $o@@67) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@67) _module.IncrementerMethod.initial__value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2130|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@67) _module.IncrementerMethod.initial__value)))
)))
(assert (forall (($h@@35 T@U) ($o@@68 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (or (not (= $o@@68 null)) (not true)) (= (dtype $o@@68) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@68) _module.IncrementerMethod.final__value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2132|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@68) _module.IncrementerMethod.final__value)))
)))
(assert (forall (($h@@36 T@U) ($o@@69 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (or (not (= $o@@69 null)) (not true)) (= (dtype $o@@69) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@69) _module.IncrementerMethod.i)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2134|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@69) _module.IncrementerMethod.i)))
)))
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@90 null)) (not true)) ($Is refType this@@90 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@70 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@70 null)) (not true)) (or (= $o@@70 this@@90) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 this@@90) _module.Universe.content)) ($Box refType $o@@70)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@70) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@70) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |494|
)) (= (_module.Universe.globalBaseInv $h0@@25 this@@90) (_module.Universe.globalBaseInv $h1@@25 this@@90))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |495|
 :pattern ( ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25) (_module.Universe.globalBaseInv $h1@@25 this@@90))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@71 T@U) ($f@@35 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@71 $f@@35))  (=> (and (or (not (= $o@@71 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@71) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3540|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@71 $f@@35))
)))
(assert (forall (($h@@37 T@U) ($o@@72 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@37) (and (or (not (= $o@@72 null)) (not true)) ($Is refType $o@@72 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@72) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@72) _module.OwnedObject.owner)) Tclass._module.Object $h@@37))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1292|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@72) _module.OwnedObject.owner)))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@64 T@U) (this@@91 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@64 this@@91) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@64) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.OwnedObject) ($IsAlloc refType this@@91 Tclass._module.OwnedObject $Heap@@64)))))) (and (and (|_module.Object.baseInv#canCall| $Heap@@64 this@@91) (=> (_module.Object.baseInv $Heap@@64 this@@91) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@64 (_module.Object.universe this@@91)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@64 this@@91) _module.OwnedObject.owner)) (and (|_module.OwnedObject.baseUserInv#canCall| $Heap@@64 this@@91) (=> (_module.OwnedObject.baseUserInv $Heap@@64 this@@91) (|_module.OwnedObject.localUserInv#canCall| $Heap@@64 this@@91)))))) (= (_module.OwnedObject.localInv $Heap@@64 this@@91)  (and (and (and (_module.Object.baseInv $Heap@@64 this@@91) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@64 (_module.Object.universe this@@91)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@64 this@@91) _module.OwnedObject.owner))) (_module.OwnedObject.baseUserInv $Heap@@64 this@@91)) (_module.OwnedObject.localUserInv $Heap@@64 this@@91)))))
 :qid |_07CounterThreadOwnershipdfy.327:19|
 :skolemid |1303|
 :pattern ( (_module.OwnedObject.localInv $Heap@@64 this@@91) ($IsGoodHeap $Heap@@64))
))))
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@92 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@92 null)) (not true)) (and ($Is refType this@@92 Tclass._module.Universe) ($IsAlloc refType this@@92 Tclass._module.Universe $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@73 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@73) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@73) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@73) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |502|
)) (= (_module.Universe.globalInv $h0@@26 this@@92) (_module.Universe.globalInv $h1@@26 this@@92))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |503|
 :pattern ( ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26) (_module.Universe.globalInv $h1@@26 this@@92))
)))
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@93 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.Object) ($IsAlloc refType this@@93 Tclass._module.Object $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@74 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@74) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@74) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@74) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |967|
)) (= (_module.Object.baseInv $h0@@27 this@@93) (_module.Object.baseInv $h1@@27 this@@93))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |968|
 :pattern ( ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27) (_module.Object.baseInv $h1@@27 this@@93))
)))
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@94 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@94 null)) (not true)) (and ($Is refType this@@94 Tclass._module.Object) ($IsAlloc refType this@@94 Tclass._module.Object $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@75 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@75) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@75) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@75) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1017|
)) (= (_module.Object.localInv $h0@@28 this@@94) (_module.Object.localInv $h1@@28 this@@94))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1018|
 :pattern ( ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28) (_module.Object.localInv $h1@@28 this@@94))
)))
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@95 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@95 null)) (not true)) (and ($Is refType this@@95 Tclass._module.Object) ($IsAlloc refType this@@95 Tclass._module.Object $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@76 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@76) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@76) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@76) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1025|
)) (= (_module.Object.inv $h0@@29 this@@95) (_module.Object.inv $h1@@29 this@@95))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1026|
 :pattern ( ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29) (_module.Object.inv $h1@@29 this@@95))
)))
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@96 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@96 null)) (not true)) (and ($Is refType this@@96 Tclass._module.Thread) ($IsAlloc refType this@@96 Tclass._module.Thread $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@77 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@77 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@77) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@77) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@77) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1084|
)) (= (_module.Thread.localInv $h0@@30 this@@96) (_module.Thread.localInv $h1@@30 this@@96))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1085|
 :pattern ( ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30) (_module.Thread.localInv $h1@@30 this@@96))
)))
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@97 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.Thread) ($IsAlloc refType this@@97 Tclass._module.Thread $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@78 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@78) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@78) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@78) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1092|
)) (= (_module.Thread.inv $h0@@31 this@@97) (_module.Thread.inv $h1@@31 this@@97))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1093|
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.Thread.inv $h1@@31 this@@97))
)))
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@98 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@98 null)) (not true)) (and ($Is refType this@@98 Tclass._module.OwnedObject) ($IsAlloc refType this@@98 Tclass._module.OwnedObject $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@79 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@79) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@79) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@79) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1299|
)) (= (_module.OwnedObject.localInv $h0@@32 this@@98) (_module.OwnedObject.localInv $h1@@32 this@@98))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1300|
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.OwnedObject.localInv $h1@@32 this@@98))
)))
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@99 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@99 null)) (not true)) (and ($Is refType this@@99 Tclass._module.OwnedObject) ($IsAlloc refType this@@99 Tclass._module.OwnedObject $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@80 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@80) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@80) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@80) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1309|
)) (= (_module.OwnedObject.inv $h0@@33 this@@99) (_module.OwnedObject.inv $h1@@33 this@@99))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1310|
 :pattern ( ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33) (_module.OwnedObject.inv $h1@@33 this@@99))
)))
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@100 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@100 null)) (not true)) (and ($Is refType this@@100 Tclass._module.OwnedObject) ($IsAlloc refType this@@100 Tclass._module.OwnedObject $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@81 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@81) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@81) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@81) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1385|
)) (= (_module.OwnedObject.baseUserInv $h0@@34 this@@100) (_module.OwnedObject.baseUserInv $h1@@34 this@@100))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1386|
 :pattern ( ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34) (_module.OwnedObject.baseUserInv $h1@@34 this@@100))
)))
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@101 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@101 null)) (not true)) (and ($Is refType this@@101 Tclass._module.OwnedObject) ($IsAlloc refType this@@101 Tclass._module.OwnedObject $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@82 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@82) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@82) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@82) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1389|
)) (= (_module.OwnedObject.localUserInv $h0@@35 this@@101) (_module.OwnedObject.localUserInv $h1@@35 this@@101))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1390|
 :pattern ( ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35) (_module.OwnedObject.localUserInv $h1@@35 this@@101))
)))
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@102 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@102 null)) (not true)) (and ($Is refType this@@102 Tclass._module.OwnedObject) ($IsAlloc refType this@@102 Tclass._module.OwnedObject $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@83 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@83) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@83) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@83) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |1397|
)) (= (_module.OwnedObject.userInv $h0@@36 this@@102) (_module.OwnedObject.userInv $h1@@36 this@@102))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1398|
 :pattern ( ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36) (_module.OwnedObject.userInv $h1@@36 this@@102))
)))
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@103 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@103 null)) (not true)) (and ($Is refType this@@103 Tclass._module.AtomicCounter) ($IsAlloc refType this@@103 Tclass._module.AtomicCounter $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@84 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@84) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@84) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |1665|
)) (= (_module.AtomicCounter.baseUserInv $h0@@37 this@@103) (_module.AtomicCounter.baseUserInv $h1@@37 this@@103))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1666|
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.AtomicCounter.baseUserInv $h1@@37 this@@103))
)))
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@104 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@104 null)) (not true)) (and ($Is refType this@@104 Tclass._module.AtomicCounter) ($IsAlloc refType this@@104 Tclass._module.AtomicCounter $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@85 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@85 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@85) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@85) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@85) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |1672|
)) (= (_module.AtomicCounter.localUserInv $h0@@38 this@@104) (_module.AtomicCounter.localUserInv $h1@@38 this@@104))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1673|
 :pattern ( ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38) (_module.AtomicCounter.localUserInv $h1@@38 this@@104))
)))
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@105 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@105 null)) (not true)) (and ($Is refType this@@105 Tclass._module.AtomicCounter) ($IsAlloc refType this@@105 Tclass._module.AtomicCounter $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@86 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@86 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@86) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@86) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@86) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |1679|
)) (= (_module.AtomicCounter.userInv $h0@@39 this@@105) (_module.AtomicCounter.userInv $h1@@39 this@@105))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1680|
 :pattern ( ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39) (_module.AtomicCounter.userInv $h1@@39 this@@105))
)))
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@106 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@106 null)) (not true)) (and ($Is refType this@@106 Tclass._module.Remaining) ($IsAlloc refType this@@106 Tclass._module.Remaining $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@87 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@87 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@87) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@87) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@87) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |1903|
)) (= (_module.Remaining.baseUserInv $h0@@40 this@@106) (_module.Remaining.baseUserInv $h1@@40 this@@106))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1904|
 :pattern ( ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40) (_module.Remaining.baseUserInv $h1@@40 this@@106))
)))
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@107 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@107 null)) (not true)) (and ($Is refType this@@107 Tclass._module.Remaining) ($IsAlloc refType this@@107 Tclass._module.Remaining $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@88 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@88) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@88) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |1910|
)) (= (_module.Remaining.localUserInv $h0@@41 this@@107) (_module.Remaining.localUserInv $h1@@41 this@@107))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1911|
 :pattern ( ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41) (_module.Remaining.localUserInv $h1@@41 this@@107))
)))
(assert (forall (($h0@@42 T@U) ($h1@@42 T@U) (this@@108 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@42) ($IsGoodHeap $h1@@42)) (and (or (not (= this@@108 null)) (not true)) (and ($Is refType this@@108 Tclass._module.Remaining) ($IsAlloc refType this@@108 Tclass._module.Remaining $h0@@42)))) (and ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42))) (=> (forall (($o@@89 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@89 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@89) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@89) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@42 $o@@89) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |1917|
)) (= (_module.Remaining.userInv $h0@@42 this@@108) (_module.Remaining.userInv $h1@@42 this@@108))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1918|
 :pattern ( ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42) (_module.Remaining.userInv $h1@@42 this@@108))
)))
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@109 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@109 null)) (not true)) (and ($Is refType this@@109 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@109 Tclass._module.IncrementerMethod $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@90 T@U) ($f@@53 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@90) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@90) $f@@53)))
 :qid |unknown.0:0|
 :skolemid |2151|
)) (= (_module.IncrementerMethod.baseUserInv $h0@@43 this@@109) (_module.IncrementerMethod.baseUserInv $h1@@43 this@@109))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2152|
 :pattern ( ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43) (_module.IncrementerMethod.baseUserInv $h1@@43 this@@109))
)))
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@110 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@110 null)) (not true)) (and ($Is refType this@@110 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@110 Tclass._module.IncrementerMethod $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@91 T@U) ($f@@54 T@U) ) (!  (=> (and (or (not (= $o@@91 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@91) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@91) $f@@54) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@91) $f@@54)))
 :qid |unknown.0:0|
 :skolemid |2158|
)) (= (_module.IncrementerMethod.localUserInv $h0@@44 this@@110) (_module.IncrementerMethod.localUserInv $h1@@44 this@@110))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2159|
 :pattern ( ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44) (_module.IncrementerMethod.localUserInv $h1@@44 this@@110))
)))
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@111 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@111 null)) (not true)) (and ($Is refType this@@111 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@111 Tclass._module.IncrementerMethod $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@92 T@U) ($f@@55 T@U) ) (!  (=> (and (or (not (= $o@@92 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@92) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@92) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@92) $f@@55)))
 :qid |unknown.0:0|
 :skolemid |2165|
)) (= (_module.IncrementerMethod.userInv $h0@@45 this@@111) (_module.IncrementerMethod.userInv $h1@@45 this@@111))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2166|
 :pattern ( ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45) (_module.IncrementerMethod.userInv $h1@@45 this@@111))
)))
...
(assert (forall (($o@@95 T@U) ) (!  (=> ($Is refType $o@@95 Tclass._module.AtomicCounter?) ($Is refType $o@@95 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3530|
 :pattern ( ($Is refType $o@@95 Tclass._module.AtomicCounter?))
)))
...
(assert (forall (($o@@96 T@U) ) (!  (=> ($Is refType $o@@96 Tclass._module.Remaining?) ($Is refType $o@@96 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3534|
 :pattern ( ($Is refType $o@@96 Tclass._module.Remaining?))
)))
...
(assert (forall (($o@@97 T@U) ) (!  (=> ($Is refType $o@@97 Tclass._module.IncrementerMethod?) ($Is refType $o@@97 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3538|
 :pattern ( ($Is refType $o@@97 Tclass._module.IncrementerMethod?))
)))
...
(assert (= (Tag Tclass._module.IncrementerMethod) Tagclass._module.IncrementerMethod))
(assert (= (TagFamily Tclass._module.IncrementerMethod) tytagFamily$IncrementerMethod))
(assert (forall (($h@@38 T@U) ($o@@98 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (or (not (= $o@@98 null)) (not true)) ($Is refType $o@@98 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@98) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1291|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@98) _module.OwnedObject.owner)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@59 T@U) ($Heap@@65 T@U) (this@@112 T@U) ) (!  (=> (or (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $prevHeap@@59 $Heap@@65 this@@112) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@59) ($IsGoodHeap $Heap@@65)) ($HeapSucc $prevHeap@@59 $Heap@@65)) (and (or (not (= this@@112 null)) (not true)) (and ($Is refType this@@112 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@112 Tclass._module.IncrementerMethod $prevHeap@@59)))))) (= (_module.IncrementerMethod.unchangedNonvolatileUserFields $prevHeap@@59 $Heap@@65 this@@112)  (and (and (and (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@59 this@@112) _module.IncrementerMethod.programCounter))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@65 this@@112) _module.IncrementerMethod.programCounter)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@59 this@@112) _module.IncrementerMethod.counter)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@65 this@@112) _module.IncrementerMethod.counter)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@59 this@@112) _module.IncrementerMethod.remaining)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@65 this@@112) _module.IncrementerMethod.remaining)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@59 this@@112) _module.IncrementerMethod.initial__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@65 this@@112) _module.IncrementerMethod.initial__value))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@59 this@@112) _module.IncrementerMethod.final__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@65 this@@112) _module.IncrementerMethod.final__value))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@59 this@@112) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@65 this@@112) _module.IncrementerMethod.i)))))))
 :qid |_07CounterThreadOwnershipdfy.640:22|
 :skolemid |2141|
 :pattern ( (_module.IncrementerMethod.unchangedNonvolatileUserFields $prevHeap@@59 $Heap@@65 this@@112) ($IsGoodHeap $Heap@@65))
))))
...
(assert (forall (($h@@39 T@U) ($o@@102 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@39) (and (or (not (= $o@@102 null)) (not true)) ($Is refType $o@@102 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@102) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@102) _module.Universe.content)) (TSet Tclass._module.Object) $h@@39))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@102) _module.Universe.content)))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@60 T@U) ($Heap@@66 T@U) (this@@113 T@U) ) (!  (=> (or (|_module.OwnedObject.transitiveInv2#canCall| $prevHeap@@60 $Heap@@66 this@@113) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@60) ($IsGoodHeap $Heap@@66)) ($HeapSucc $prevHeap@@60 $Heap@@66)) (and (or (not (= this@@113 null)) (not true)) (and ($Is refType this@@113 Tclass._module.OwnedObject) ($IsAlloc refType this@@113 Tclass._module.OwnedObject $prevHeap@@60)))))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 this@@113) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@66 this@@113) _module.OwnedObject.nonvolatileVersion)))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@60 $Heap@@66 this@@113)) (= (_module.OwnedObject.transitiveInv2 $prevHeap@@60 $Heap@@66 this@@113)  (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 this@@113) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@66 this@@113) _module.OwnedObject.nonvolatileVersion)))) (and (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@60 $Heap@@66 this@@113) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 (_module.Object.universe this@@113)) _module.Universe.content)) ($Box refType |o#0@@5|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 |o#0@@5|) _module.OwnedObject.owner)) this@@113))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 |o#0@@5|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@66 |o#0@@5|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@66 |o#0@@5|) _module.OwnedObject.owner)) this@@113)))
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 |o#0@@5|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 |o#0@@5|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 (_module.Object.universe this@@113)) _module.Universe.content)) ($Box refType |o#0@@5|)))
 ...
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@66 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@60 this@@113) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@66 this@@113) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_07CounterThreadOwnershipdfy.343:22|
 :skolemid |1336|
 :pattern ( (_module.OwnedObject.transitiveInv2 $prevHeap@@60 $Heap@@66 this@@113) ($IsGoodHeap $Heap@@66))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@61 T@U) ($Heap@@67 T@U) (this@@114 T@U) ) (!  (=> (or (|_module.AtomicCounter.userInv2#canCall| $prevHeap@@61 $Heap@@67 this@@114) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@61) ($IsGoodHeap $Heap@@67)) ($HeapSucc $prevHeap@@61 $Heap@@67)) (and (or (not (= this@@114 null)) (not true)) (and ($Is refType this@@114 Tclass._module.AtomicCounter) ($IsAlloc refType this@@114 Tclass._module.AtomicCounter $prevHeap@@61)))))) (=> (_module.AtomicCounter.userInv2 $prevHeap@@61 $Heap@@67 this@@114) (_module.AtomicCounter.localUserInv2 $prevHeap@@61 $Heap@@67 this@@114)))
 :qid |_07CounterThreadOwnershipdfy.504:22|
 :skolemid |1696|
 :pattern ( (_module.AtomicCounter.userInv2 $prevHeap@@61 $Heap@@67 this@@114))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@62 T@U) ($Heap@@68 T@U) (this@@115 T@U) ) (!  (=> (or (|_module.Remaining.userInv2#canCall| $prevHeap@@62 $Heap@@68 this@@115) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@62) ($IsGoodHeap $Heap@@68)) ($HeapSucc $prevHeap@@62 $Heap@@68)) (and (or (not (= this@@115 null)) (not true)) (and ($Is refType this@@115 Tclass._module.Remaining) ($IsAlloc refType this@@115 Tclass._module.Remaining $prevHeap@@62)))))) (=> (_module.Remaining.userInv2 $prevHeap@@62 $Heap@@68 this@@115) (_module.Remaining.localUserInv2 $prevHeap@@62 $Heap@@68 this@@115)))
 :qid |_07CounterThreadOwnershipdfy.565:22|
 :skolemid |1934|
 :pattern ( (_module.Remaining.userInv2 $prevHeap@@62 $Heap@@68 this@@115))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@63 T@U) ($Heap@@69 T@U) (this@@116 T@U) ) (!  (=> (or (|_module.IncrementerMethod.userInv2#canCall| $prevHeap@@63 $Heap@@69 this@@116) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@63) ($IsGoodHeap $Heap@@69)) ($HeapSucc $prevHeap@@63 $Heap@@69)) (and (or (not (= this@@116 null)) (not true)) (and ($Is refType this@@116 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@116 Tclass._module.IncrementerMethod $prevHeap@@63)))))) (=> (_module.IncrementerMethod.userInv2 $prevHeap@@63 $Heap@@69 this@@116) (_module.IncrementerMethod.localUserInv2 $prevHeap@@63 $Heap@@69 this@@116)))
 :qid |_07CounterThreadOwnershipdfy.689:22|
 :skolemid |2184|
 :pattern ( (_module.IncrementerMethod.userInv2 $prevHeap@@63 $Heap@@69 this@@116))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@64 T@U) ($Heap@@70 T@U) (this@@117 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv2#canCall| $prevHeap@@64 $Heap@@70 this@@117) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@64) ($IsGoodHeap $Heap@@70)) ($HeapSucc $prevHeap@@64 $Heap@@70)) (and (or (not (= this@@117 null)) (not true)) (and ($Is refType this@@117 Tclass._module.OwnedObject) ($IsAlloc refType this@@117 Tclass._module.OwnedObject $prevHeap@@64)))))) (=> (_module.OwnedObject.userInv2 $prevHeap@@64 $Heap@@70 this@@117) (_module.OwnedObject.localUserInv2 $prevHeap@@64 $Heap@@70 this@@117)))
 :qid |_07CounterThreadOwnershipdfy.388:22|
 :skolemid |1403|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@64 $Heap@@70 this@@117))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@71 T@U) (this@@118 T@U) ) (!  (=> (or (|_module.AtomicCounter.userInv#canCall| $Heap@@71 this@@118) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@71) (and (or (not (= this@@118 null)) (not true)) (and ($Is refType this@@118 Tclass._module.AtomicCounter) ($IsAlloc refType this@@118 Tclass._module.AtomicCounter $Heap@@71)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.AtomicCounter.localUserInv#canCall| $Heap@@71 this@@118)) (= (_module.AtomicCounter.userInv $Heap@@71 this@@118)  (and true (_module.AtomicCounter.localUserInv $Heap@@71 this@@118)))))
 :qid |_07CounterThreadOwnershipdfy.497:19|
 :skolemid |1683|
 :pattern ( (_module.AtomicCounter.userInv $Heap@@71 this@@118) ($IsGoodHeap $Heap@@71))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@72 T@U) (this@@119 T@U) ) (!  (=> (or (|_module.Remaining.userInv#canCall| $Heap@@72 this@@119) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@72) (and (or (not (= this@@119 null)) (not true)) (and ($Is refType this@@119 Tclass._module.Remaining) ($IsAlloc refType this@@119 Tclass._module.Remaining $Heap@@72)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Remaining.localUserInv#canCall| $Heap@@72 this@@119)) (= (_module.Remaining.userInv $Heap@@72 this@@119)  (and true (_module.Remaining.localUserInv $Heap@@72 this@@119)))))
 :qid |_07CounterThreadOwnershipdfy.558:19|
 :skolemid |1921|
 :pattern ( (_module.Remaining.userInv $Heap@@72 this@@119) ($IsGoodHeap $Heap@@72))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@73 T@U) (this@@120 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@73 this@@120) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@73) (and (or (not (= this@@120 null)) (not true)) (and ($Is refType this@@120 Tclass._module.Thread) ($IsAlloc refType this@@120 Tclass._module.Thread $Heap@@73)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.baseInv#canCall| $Heap@@73 this@@120)) (= (_module.Thread.localInv $Heap@@73 this@@120)  (and true (_module.Object.baseInv $Heap@@73 this@@120)))))
 :qid |_07CounterThreadOwnershipdfy.284:19|
 :skolemid |1088|
 :pattern ( (_module.Thread.localInv $Heap@@73 this@@120) ($IsGoodHeap $Heap@@73))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@74 T@U) (this@@121 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@74 this@@121) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@74) (and (or (not (= this@@121 null)) (not true)) (and ($Is refType this@@121 Tclass._module.Thread) ($IsAlloc refType this@@121 Tclass._module.Thread $Heap@@74)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@74 this@@121)) (= (_module.Thread.inv $Heap@@74 this@@121)  (and true (_module.Thread.localInv $Heap@@74 this@@121)))))
 :qid |_07CounterThreadOwnershipdfy.287:19|
 :skolemid |1096|
 :pattern ( (_module.Thread.inv $Heap@@74 this@@121) ($IsGoodHeap $Heap@@74))
))))
(assert (forall (($h@@40 T@U) ($o@@103 T@U) ) (!  (=> (and ($IsGoodHeap $h@@40) (and (or (not (= $o@@103 null)) (not true)) ($Is refType $o@@103 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@40 $o@@103) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |492|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@40 $o@@103) _module.Universe.content)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@65 T@U) ($Heap@@75 T@U) (this@@122 T@U) ) (!  (=> (or (|_module.Universe.baseLegalTransitionsSequence#canCall| $prevHeap@@65 $Heap@@75 this@@122) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@65) ($IsGoodHeap $Heap@@75)) ($HeapSucc $prevHeap@@65 $Heap@@75)) (and (or (not (= this@@122 null)) (not true)) (and ($Is refType this@@122 Tclass._module.Universe) ($IsAlloc refType this@@122 Tclass._module.Universe $prevHeap@@65)))))) (= (_module.Universe.baseLegalTransitionsSequence $prevHeap@@65 $Heap@@75 this@@122)  (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@65 this@@122) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@75 this@@122) _module.Universe.content))) (forall ((|o#0@@6| T@U) ) (!  (=> (and ($Is refType |o#0@@6| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@65 this@@122) _module.Universe.content)) ($Box refType |o#0@@6|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@75 this@@122) _module.Universe.content)) ($Box refType |o#0@@6|)))) (not ($IsAllocBox ($Box refType |o#0@@6|) Tclass._module.Object $prevHeap@@65)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |534|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@75 this@@122) _module.Universe.content)) ($Box refType |o#0@@6|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@65 this@@122) _module.Universe.content)) ($Box refType |o#0@@6|)))
))) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@65 this@@122) _module.Universe.content)) ($Box refType |o#1@@1|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@65 |o#1@@1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@75 |o#1@@1|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |535|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@75 |o#1@@1|) _module.OwnedObject.nonvolatileVersion)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@65 this@@122) _module.Universe.content)) ($Box refType |o#1@@1|)))
)))))
 :qid |_07CounterThreadOwnershipdfy.51:22|
 :skolemid |537|
 :pattern ( (_module.Universe.baseLegalTransitionsSequence $prevHeap@@65 $Heap@@75 this@@122) ($IsGoodHeap $Heap@@75))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($prevHeap@@66 T@U) ($Heap@@76 T@U) (this@@123 T@U) (|running#0@@4| T@U) ) (!  (=> (or (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@66 $Heap@@76 this@@123 |running#0@@4|) (and (< 5 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@66) ($IsGoodHeap $Heap@@76)) ($HeapSucc $prevHeap@@66 $Heap@@76)) (and (or (not (= this@@123 null)) (not true)) (and ($Is refType this@@123 Tclass._module.Universe) ($IsAlloc refType this@@123 Tclass._module.Universe $prevHeap@@66)))) ($Is SetType |running#0@@4| (TSet Tclass._module.Thread))))) (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $prevHeap@@66 $Heap@@76 this@@123) (=> (_module.Universe.baseLegalTransitionsSequence $prevHeap@@66 $Heap@@76 this@@123) (and (|_module.Universe.globalBaseInv#canCall| $prevHeap@@66 this@@123) (=> (_module.Universe.globalBaseInv $prevHeap@@66 this@@123) (and (|_module.Universe.globalBaseInv#canCall| $Heap@@76 this@@123) (=> (_module.Universe.globalBaseInv $Heap@@76 this@@123) (forall ((|o#0@@7| T@U) ) (!  (=> ($Is refType |o#0@@7| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 this@@123) _module.Universe.content)) ($Box refType |o#0@@7|)) (|_module.Object.transitiveInv2#canCall| $prevHeap@@66 $Heap@@76 |o#0@@7|)))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |550|
 :pattern ( (_module.Object.transitiveInv2 $prevHeap@@66 $Heap@@76 |o#0@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 this@@123) _module.Universe.content)) ($Box refType |o#0@@7|)))
)))))))) (= (_module.Universe.legalTransitionsSequence $prevHeap@@66 $Heap@@76 this@@123 |running#0@@4|)  (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $prevHeap@@66 $Heap@@76 this@@123) (_module.Universe.globalBaseInv $prevHeap@@66 this@@123)) (_module.Universe.globalBaseInv $Heap@@76 this@@123)) (forall ((|o#0@@8| T@U) ) (!  (=> (and ($Is refType |o#0@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 this@@123) _module.Universe.content)) ($Box refType |o#0@@8|))) (_module.Object.transitiveInv2 $prevHeap@@66 $Heap@@76 |o#0@@8|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |548|
 :pattern ( (_module.Object.transitiveInv2 $prevHeap@@66 $Heap@@76 |o#0@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 this@@123) _module.Universe.content)) ($Box refType |o#0@@8|)))
))) (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 this@@123) _module.Universe.content)) ($Box refType |o#1@@2|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 |o#1@@2|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| |running#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 |o#1@@2|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 |o#1@@2|) _module.OwnedObject.owner) Tclass._module.Object $prevHeap@@66)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 |o#1@@2|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@76 |o#1@@2|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |549|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@76 |o#1@@2|) _module.OwnedObject.nonvolatileVersion)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@66 this@@123) _module.Universe.content)) ($Box refType |o#1@@2|)))
))))))
 :qid |_07CounterThreadOwnershipdfy.67:22|
 :skolemid |552|
 :pattern ( (_module.Universe.legalTransitionsSequence $prevHeap@@66 $Heap@@76 this@@123 |running#0@@4|) ($IsGoodHeap $Heap@@76))
))))
...
(declare-fun this@@124 () T@U)
(declare-fun $Heap@@77 () T@U)
(declare-fun |running#0@@5| () T@U)
(set-info :boogie-vc-id Impl$$_module.IncrementerMethod.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@124) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@124) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@124) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@124)))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@124) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@124))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@124) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@124) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@124) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@124) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@124) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@124) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@124))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@124) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@124) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@124)))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@124) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.nonvolatileVersion)))) (forall ((|o#47| T@U) ) (!  (=> (and ($Is refType |o#47| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#47|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47|) _module.OwnedObject.owner)) this@@124))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47|) _module.OwnedObject.owner)) this@@124)))
 :qid |_07CounterThreadOwnershipdfy.349:18|
 :skolemid |2304|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47|) _module.OwnedObject.owner)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#47|)))
)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@124) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.nonvolatileVersion)))) (forall ((|o#47@@0| T@U) ) (!  (=> (and ($Is refType |o#47@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#47@@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47@@0|) _module.OwnedObject.owner)) this@@124))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47@@0|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47@@0|) _module.OwnedObject.owner)) this@@124)))
 :qid |_07CounterThreadOwnershipdfy.349:18|
 :skolemid |2304|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47@@0|) _module.OwnedObject.owner)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#47@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |o#47@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#47@@0|)))
))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@124) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner))))
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.nonvolatileVersion)))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (|_module.OwnedObject.transitiveInv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.transitiveInv2 previous$Heap current$Heap this@@124) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner))))
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.nonvolatileVersion))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@124)))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@124))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))) (not true)) (let ((|currOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1|) Tclass._module.Object previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@124) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@124) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@124) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))) (not true)) (let ((|currOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1@@0|) Tclass._module.Object previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (=> (|_module.Object.baseInv#canCall| current$Heap this@@124) (or (_module.Object.baseInv current$Heap this@@124) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType this@@124))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (=> (|_module.Object.baseInv#canCall| current$Heap this@@124) (or (_module.Object.baseInv current$Heap this@@124) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType this@@124)))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (=> (|_module.Object.baseInv#canCall| current$Heap this@@124) (or (_module.Object.baseInv current$Heap this@@124) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@124)) (forall ((|o#48| T@U) ) (!  (=> (and ($Is refType |o#48| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#48|))) (and (= (_module.Object.universe |o#48|) (_module.Object.universe this@@124)) (or (not (= |o#48| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2306|
 :pattern ( (_module.Object.universe |o#48|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#48|)))
))))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (=> (|_module.Object.baseInv#canCall| current$Heap this@@124) (or (_module.Object.baseInv current$Heap this@@124) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@124)) (forall ((|o#48@@0| T@U) ) (!  (=> (and ($Is refType |o#48@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#48@@0|))) (and (= (_module.Object.universe |o#48@@0|) (_module.Object.universe this@@124)) (or (not (= |o#48@@0| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2306|
 :pattern ( (_module.Object.universe |o#48@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#48@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@124) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (_module.OwnedObject.baseUserInv current$Heap this@@124)))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (_module.OwnedObject.baseUserInv current$Heap this@@124))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (_module.OwnedObject.localUserInv current$Heap this@@124)))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@124) (or (_module.OwnedObject.localInv current$Heap this@@124) (_module.OwnedObject.localUserInv current$Heap this@@124))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@124) (or (_module.OwnedObject.inv current$Heap this@@124) (_module.OwnedObject.userInv current$Heap this@@124)))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@77) ($IsHeapAnchor $Heap@@77)) (and (or (not (= this@@124 null)) (not true)) (and ($Is refType this@@124 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@124 Tclass._module.IncrementerMethod previous$Heap)))) (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap@@77) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (and (and (|_module.Object.goodPreAndLegalChanges#canCall| previous$Heap current$Heap this@@124 |running#0@@5|) (and (_module.Object.goodPreAndLegalChanges previous$Heap current$Heap this@@124 |running#0@@5|) (and (and (and (and (_module.Object.baseInv previous$Heap this@@124) (_module.Universe.globalInv previous$Heap (_module.Object.universe this@@124))) (_module.Object.baseInv current$Heap this@@124)) (forall (($o@@104 T@U) ($f@@56 T@U) ) (!  (=> (or (not (= $o@@104 null)) (not true)) (=> (= $o@@104 this@@124) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@104) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@104) $f@@56))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |2303|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@104) $f@@56))
))) (_module.Universe.legalTransition previous$Heap current$Heap (_module.Object.universe this@@124) |running#0@@5|)))) (= (ControlFlow 0 19) 2)))) anon0_correct)))
