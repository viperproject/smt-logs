...
(declare-fun |call2formal@res#0@0@@0| () Int)
(declare-fun $Heap@13 () T@U)
(declare-fun $Heap@14 () T@U)
(declare-fun $Heap@15 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split138)
...
(assert (not
 ...
 :qid |_11MutexGuard2legacydfy.670:24|
 :skolemid |573|
...
)))) (and (forall (($o@@130 T@U) ) (!  (=> (and (or (not (= $o@@130 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@130) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@130) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@130)) (or (= $o@@130 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType $o@@130)))))
 :qid |_11MutexGuard2legacydfy.109:10|
 :skolemid |896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@130))
)) ($HeapSucc $Heap@7 $Heap@8)))))))) (and (and (and (and (and (and (and (or (not (= |call4formal@guard#0@0| null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex)) null)) (not true))) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data)) _module.OwnedU32.value)))) (and (and (= |$rhs#0@0| (LitInt 42)) (= $Heap@9 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data)) (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedU32.value ($Box intType (int_2_U |$rhs#0@0|)))))) (and ($IsGoodHeap $Heap@9) (or (not (= |call4formal@guard#0@0| null)) (not true))))) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex)) null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true))) (and (= $obj0@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $obj0@0 _module.OwnedObject.nonvolatileVersion)))) (and (and (or (not (= |call4formal@guard#0@0| null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex)) null)) (not true))) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true)) (= |last##0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.nonvolatileVersion)))))))) (and (and (and (and ($IsGoodHeap $Heap@10) ($IsHeapAnchor $Heap@10)) (> |call2formal@res#0@0| |last##0@0|)) (and (forall (($o@@131 T@U) ) (!  (=> (and (or (not (= $o@@131 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@131) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@131) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@131)))
 :qid |_11MutexGuard2legacydfy.425:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@131))
)) ($HeapSucc $Heap@9 $Heap@10))) (and (and (= $Heap@11 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@10 $obj0@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $obj0@0) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|))))) ($IsGoodHeap $Heap@11)) (and (or (not (= |call4formal@guard#0@0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |call4formal@guard#0@0| _module.OwnedObject.nonvolatileVersion)))))) (and (and (and (and (and (or (not (= |call4formal@guard#0@0| null)) (not true)) (= |last##1@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |call4formal@guard#0@0|) _module.OwnedObject.nonvolatileVersion))))) (and ($IsGoodHeap $Heap@12) ($IsHeapAnchor $Heap@12))) (and (and (> |call2formal@res#0@0@@0| |last##1@0|) (forall (($o@@132 T@U) ) (!  (=> (and (or (not (= $o@@132 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 $o@@132) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@132) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 $o@@132)))
 :qid |_11MutexGuard2legacydfy.425:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@132))
))) (and ($HeapSucc $Heap@11 $Heap@12) (= $Heap@13 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@12 |call4formal@guard#0@0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |call4formal@guard#0@0|) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0@@0|)))))))) (and (and (and ($IsGoodHeap $Heap@13) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@8) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@8))) (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@8) (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@13 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@13 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (forall ((|o#0@@22| T@U) ) (!  (=> (and ($Is refType |o#0@@22| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@22|))) (and (and (and (= (_module.Object.universe |o#0@@22|) |universe#0|) (or (not (= |o#0@@22| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@8 |o#0@@22|)) (_module.Object.triggerAxioms $Heap@8 |o#0@@22|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |788|
 :pattern ( (_module.Object.triggerAxioms $Heap@8 |o#0@@22|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@8 |o#0@@22|))
 :pattern ( (_module.Object.universe |o#0@@22|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@22|)))
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@13 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@13 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@13 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))) (and (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@13 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@13 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@13 |universe#0|) (forall ((|o#1@@11| T@U) ) (!  (=> (and ($Is refType |o#1@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@11|))) (and (and (and (= (_module.Object.universe |o#1@@11|) |universe#0|) (or (not (= |o#1@@11| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@13 |o#1@@11|)) (_module.Object.triggerAxioms $Heap@13 |o#1@@11|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |790|
...
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@13 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@13 |universe#0|) (forall ((|o#2@@2| T@U) ) (!  (=> (and ($Is refType |o#2@@2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@2|)))) (not ($IsAllocBox ($Box refType |o#2@@2|) Tclass._module.Object $Heap@8)))
 :qid |_11MutexGuard2legacydfy.45:16|
 :skolemid |792|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@2|)))
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@8| T@U) ) (!  (=> (and ($Is refType |o#3@@8| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@8|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@8|)))) (or (forall (($o@@133 T@U) ($f@@81 T@U) ) (!  (=> (or (not (= $o@@133 null)) (not true)) (=> (= $o@@133 |o#3@@8|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@133) $f@@81) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@133) $f@@81))))
 :qid |_11MutexGuard2legacydfy.57:65|
 :skolemid |794|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@133) $f@@81))
)) (_module.Object.sequenceInv2 $Heap@8 $Heap@13 |o#3@@8|)))
 :qid |_11MutexGuard2legacydfy.57:16|
 :skolemid |795|
 :pattern ( (_module.Object.sequenceInv2 $Heap@8 $Heap@13 |o#3@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@8|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@8|)))
)))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4@@2| T@U) ) (!  (=> (and ($Is refType |o#4@@2| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@2|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#4@@2|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#4@@2|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#4@@2|) _module.OwnedObject.owner) Tclass._module.Object $Heap@8)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#4@@2|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |o#4@@2|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_11MutexGuard2legacydfy.60:16|
 :skolemid |796|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |o#4@@2|) _module.OwnedObject.nonvolatileVersion)))
 ...
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#4@@2|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@2|)))
)))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalInv $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalInv $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (forall ((|o#5@@2| T@U) ) (!  (=> (and ($Is refType |o#5@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@2|))) (and (and (and (= (_module.Object.universe |o#5@@2|) |universe#0|) (or (not (= |o#5@@2| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@8 |o#5@@2|)) (_module.Object.triggerAxioms $Heap@8 |o#5@@2|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |800|
 :pattern ( (_module.Object.triggerAxioms $Heap@8 |o#5@@2|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@8 |o#5@@2|))
 :pattern ( (_module.Object.universe |o#5@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@2|)))
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalInv $Heap@8 |universe#0|) (forall ((|o#6@@3| T@U) ) (!  (=> (and ($Is refType |o#6@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@3|))) (_module.Object.inv $Heap@8 |o#6@@3|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |802|
 :pattern ( (_module.Object.inv $Heap@8 |o#6@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@3|)))
))))))))) (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (forall ((|o#7@@7| T@U) ) (!  (=> (and ($Is refType |o#7@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@7|))) (and (or (forall (($o@@134 T@U) ($f@@82 T@U) ) (!  (=> (or (not (= $o@@134 null)) (not true)) (=> (= $o@@134 |o#7@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@134) $f@@82) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@134) $f@@82))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |804|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@134) $f@@82))
)) (_module.Object.inv $Heap@13 |o#7@@7|)) (or (forall (($o@@135 T@U) ($f@@83 T@U) ) (!  (=> (or (not (= $o@@135 null)) (not true)) (=> (= $o@@135 |o#7@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@135) $f@@83) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@135) $f@@83))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |805|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@135) $f@@83))
)) (_module.Object.inv2 $Heap@8 $Heap@13 |o#7@@7|))))
 :qid |_11MutexGuard2legacydfy.77:16|
 :skolemid |806|
 :pattern ( (_module.Object.inv2 $Heap@8 $Heap@13 |o#7@@7|))
 :pattern ( (_module.Object.inv $Heap@13 |o#7@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@7|)))
)))) (=> (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (forall ((|o#8@@8| T@U) ) (!  (=> (and ($Is refType |o#8@@8| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|))))) (_module.Object.inv $Heap@13 |o#8@@8|))
 :qid |_11MutexGuard2legacydfy.79:16|
 :skolemid |807|
 :pattern ( (_module.Object.inv $Heap@13 |o#8@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|)))
))))) (and ($IsGoodHeap $Heap@14) ($IsHeapAnchor $Heap@14))) (and (and (|_module.Universe.globalInv#canCall| $Heap@13 |universe#0|) (=> (_module.Universe.globalInv $Heap@13 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@8 $Heap@13 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@13 |universe#0|) (and (_module.Universe.globalInv $Heap@13 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@13 |universe#0|) (forall ((|o#10@@2| T@U) ) (!  (=> (and ($Is refType |o#10@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@2|))) (_module.Object.inv $Heap@13 |o#10@@2|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |815|
...
)))))))))) (and (and (and (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@8 $Heap@13 |universe#0|) (and (_module.Universe.globalInv2 $Heap@8 $Heap@13 |universe#0|) (forall ((|o#11@@2| T@U) ) (!  (=> (and ($Is refType |o#11@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@2|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@2|)) (_module.Object.inv2 $Heap@8 $Heap@13 |o#11@@2|)))
 :qid |_11MutexGuard2legacydfy.33:12|
 :skolemid |817|
 :pattern ( (_module.Object.inv2 $Heap@8 $Heap@13 |o#11@@2|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@2|)))
)))) (= $Heap@13 $Heap@14)) (and (or (not (= |universe#0| null)) (not true)) (forall (($o@@136 T@U) ($f@@84 T@U) ) (!  (=> (and (and (or (not (= $o@@136 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@136) alloc)))) (or (= $o@@136 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType $o@@136)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@136 $f@@84)))
 :qid |_11MutexGuard2legacydfy.690:24|
 :skolemid |581|
)))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@14 |universe#0|) (or (_module.Universe.globalInv $Heap@14 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@14 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@14 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@14 |universe#0|) (or (_module.Universe.globalInv $Heap@14 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@14 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@14 |universe#0|) (forall ((|o#0@@23| T@U) ) (!  (=> (and ($Is refType |o#0@@23| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@23|))) (and (and (and (= (_module.Object.universe |o#0@@23|) |universe#0|) (or (not (= |o#0@@23| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@14 |o#0@@23|)) (_module.Object.triggerAxioms $Heap@14 |o#0@@23|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |874|
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))) (and (and (and ($IsGoodHeap $Heap@15) ($IsHeapAnchor $Heap@15)) (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|)) (and (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (and (_module.Universe.globalInv $Heap@15 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#3@@9| T@U) ) (!  (=> (and ($Is refType |o#3@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@9|))) (_module.Object.inv $Heap@15 |o#3@@9|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |881|
 :pattern ( (_module.Object.inv $Heap@15 |o#3@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@9|)))
))))) (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@14 $Heap@15 |universe#0| (|Set#FromBoogieMap| (|lambda#29| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) |running#0@@3|))) (=> (_module.Universe.legalTransitionsSequence $Heap@14 $Heap@15 |universe#0| (|Set#FromBoogieMap| (|lambda#29| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) |running#0@@3|))) (|_module.Universe.globalSequenceInv2#canCall| $Heap@14 $Heap@15 |universe#0|)))))) (and (and (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@14 $Heap@15 |universe#0| (|Set#FromBoogieMap| (|lambda#29| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) |running#0@@3|))) (and (_module.Universe.legalTransitionsSequence $Heap@14 $Heap@15 |universe#0| (|Set#FromBoogieMap| (|lambda#29| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) |running#0@@3|))) (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@14 $Heap@15 |universe#0|) (forall ((|o#7@@8| T@U) ) (!  (=> (and ($Is refType |o#7@@8| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@8|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@8|)))) (or (forall (($o@@137 T@U) ($f@@85 T@U) ) (!  (=> (or (not (= $o@@137 null)) (not true)) (=> (= $o@@137 |o#7@@8|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 $o@@137) $f@@85) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@137) $f@@85))))
 :qid |_11MutexGuard2legacydfy.57:65|
 :skolemid |891|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 $o@@137) $f@@85))
)) (_module.Object.sequenceInv2 $Heap@14 $Heap@15 |o#7@@8|)))
 :qid |_11MutexGuard2legacydfy.57:16|
 :skolemid |892|
 :pattern ( (_module.Object.sequenceInv2 $Heap@14 $Heap@15 |o#7@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@8|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@8|)))
))) (forall ((|o#8@@9| T@U) ) (!  (=> (and ($Is refType |o#8@@9| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@9|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |o#8@@9|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#29| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |o#8@@9|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |o#8@@9|) _module.OwnedObject.owner) Tclass._module.Object $Heap@14)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |o#8@@9|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |o#8@@9|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_11MutexGuard2legacydfy.60:16|
 :skolemid |893|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |o#8@@9|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |o#8@@9|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |o#8@@9|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@9|)))
))))) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@14 $Heap@15 |universe#0|) (and (_module.Universe.globalSequenceInv2 $Heap@14 $Heap@15 |universe#0|) (forall ((|o#9@@4| T@U) ) (!  (=> (and ($Is refType |o#9@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@4|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@4|)) (_module.Object.sequenceInv2 $Heap@14 $Heap@15 |o#9@@4|)))
 :qid |_11MutexGuard2legacydfy.28:12|
 :skolemid |895|
 :pattern ( (_module.Object.sequenceInv2 $Heap@14 $Heap@15 |o#9@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@4|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@4|)))
))))) (and (and (forall (($o@@138 T@U) ) (!  (=> (and (or (not (= $o@@138 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@138) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 $o@@138) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@138)) (or (= $o@@138 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType $o@@138)))))
 :qid |_11MutexGuard2legacydfy.109:10|
 :skolemid |896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 $o@@138))
)) ($HeapSucc $Heap@14 $Heap@15)) (and (=> (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalInv $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalInv $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#9@@5| T@U) ) (!  (=> (and ($Is refType |o#9@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@5|))) (and (and (and (= (_module.Object.universe |o#9@@5|) |universe#0|) (or (not (= |o#9@@5| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@15 |o#9@@5|)) (_module.Object.triggerAxioms $Heap@15 |o#9@@5|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |558|
 :pattern ( (_module.Object.triggerAxioms $Heap@15 |o#9@@5|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@15 |o#9@@5|))
 :pattern ( (_module.Object.universe |o#9@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@5|)))
))))))))) (and (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalInv $Heap@15 |universe#0|) (forall ((|o#10@@3| T@U) ) (!  (=> (and ($Is refType |o#10@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@3|))) (_module.Object.inv $Heap@15 |o#10@@3|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |560|
...
)))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@87 $Heap@15 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@87 $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@87 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@87 $Heap@15 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@87 $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@87 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@87 |universe#0|) (forall ((|o#11@@3| T@U) ) (!  (=> (and ($Is refType |o#11@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@3|))) (and (and (and (= (_module.Object.universe |o#11@@3|) |universe#0|) (or (not (= |o#11@@3| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@87 |o#11@@3|)) (_module.Object.triggerAxioms $Heap@@87 |o#11@@3|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |562|
 :pattern ( (_module.Object.triggerAxioms $Heap@@87 |o#11@@3|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@87 |o#11@@3|))
 :pattern ( (_module.Object.universe |o#11@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@3|)))
)))))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@87 $Heap@15 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@87 $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (and (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@87 $Heap@15 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@87 $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#12|))) (and (and (and (= (_module.Object.universe |o#12|) |universe#0|) (or (not (= |o#12| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@15 |o#12|)) (_module.Object.triggerAxioms $Heap@15 |o#12|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |564|
 :pattern ( (_module.Object.triggerAxioms $Heap@15 |o#12|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@15 |o#12|))
 :pattern ( (_module.Object.universe |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#12|)))
)))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@87 $Heap@15 |universe#0|)))))))) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@87 $Heap@15 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
