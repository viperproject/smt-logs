...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= MutexGuardU32_$_ReadsFrame@0 (|lambda#96| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@83 T@U) ($f@@29 T@U) )  (=> (and (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@83) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@83) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@83) alloc)))))) (=> (forall (($o@@84 T@U) ($f@@30 T@U) )  (=> (and (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@84) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@84) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@84) alloc))))) (=> (=> (_module.MutexGuardU32.userInv2 $Heap@@58 current$Heap this@@100) (_module.MutexGuardU32.localUserInv2 $Heap@@58 current$Heap this@@100)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.MutexGuardU32.userInv2 $Heap@@58 current$Heap this@@100) (=> (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@58 current$Heap this@@100) (or (_module.MutexGuardU32.localUserInv2 $Heap@@58 current$Heap this@@100) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.MutexGuardU32.userInv2 $Heap@@58 current$Heap this@@100) (=> (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@58 current$Heap this@@100) (or (_module.MutexGuardU32.localUserInv2 $Heap@@58 current$Heap this@@100) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.MutexGuardU32.userInv2 $Heap@@58 current$Heap this@@100) (=> (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@58 current$Heap this@@100) (or (_module.MutexGuardU32.localUserInv2 $Heap@@58 current$Heap this@@100) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 this@@100) _module.MutexGuardU32.mutex)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.MutexGuardU32.mutex)))))))))))))))))
