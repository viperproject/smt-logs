...
)))))) (and (and ($IsGoodHeap $Heap@16) ($IsHeapAnchor $Heap@16)) (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (=> (_module.Universe.globalInv $Heap@15 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@13 $Heap@15 |universe#0|)))))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (and (_module.Universe.globalInv $Heap@15 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#17@@3| T@U) ) (!  (=> (and ($Is refType |o#17@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@3|))) (_module.Object.inv $Heap@15 |o#17@@3|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
