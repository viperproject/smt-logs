...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@43) ($IsHeapAnchor $Heap@@43)) (and (or (not (= this@@73 null)) (not true)) (and ($Is refType this@@73 Tclass._module.EmptyType) ($IsAlloc refType this@@73 Tclass._module.EmptyType previous$Heap)))) (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap@@43) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap)) (and (and (|_module.Object.goodPreAndLegalChanges#canCall| previous$Heap current$Heap this@@73 |running#0@@3|) (and (_module.Object.goodPreAndLegalChanges previous$Heap current$Heap this@@73 |running#0@@3|) (and (and (and (and (_module.Object.baseInv previous$Heap this@@73) (_module.Universe.globalInv previous$Heap (_module.Object.universe this@@73))) (_module.Object.baseInv current$Heap this@@73)) (forall (($o@@67 T@U) ($f@@39 T@U) ) (!  (=> (or (not (= $o@@67 null)) (not true)) (=> (= $o@@67 this@@73) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@67) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@67) $f@@39))))
 :qid |_08CounterNoTerminationdfy.107:8|
 :skolemid |1213|
