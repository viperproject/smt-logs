...
(assert (forall (($prevHeap@@1 T@U) ($h0@@1 T@U) ($h1@@1 T@U) (this@@7 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Universe) ($IsAlloc refType this@@7 Tclass._module.Universe $h0@@1)))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@3) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@3) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@3) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |520|
)) (= (_module.Universe.globalInv2 $prevHeap@@1 $h0@@1 this@@7) (_module.Universe.globalInv2 $prevHeap@@1 $h1@@1 this@@7))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |521|
 :pattern ( ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1) (_module.Universe.globalInv2 $prevHeap@@1 $h1@@1 this@@7))
)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($prevHeap@@17 T@U) ($Heap@@13 T@U) (this@@26 T@U) (|running#0@@1| T@U) ) (!  (=> (or (|_module.Universe.multipleLegalTransitions#canCall| $prevHeap@@17 $Heap@@13 this@@26 |running#0@@1|) (and (< 8 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@17) ($IsGoodHeap $Heap@@13)) ($HeapSucc $prevHeap@@17 $Heap@@13)) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.Universe) ($IsAlloc refType this@@26 Tclass._module.Universe $prevHeap@@17)))) ($Is SetType |running#0@@1| (TSet Tclass._module.Thread))))) (and (and (|_module.Universe.globalInv#canCall| $prevHeap@@17 this@@26) (=> (_module.Universe.globalInv $prevHeap@@17 this@@26) (and (|_module.Universe.globalBaseInv#canCall| $Heap@@13 this@@26) (=> (_module.Universe.globalBaseInv $Heap@@13 this@@26) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@26) _module.Universe.content))) (=> (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Box refType |o#0@@2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@26) _module.Universe.content)) ($Box refType |o#0@@2|)))) (not ($IsAllocBox ($Box refType |o#0@@2|) Tclass._module.Object $prevHeap@@17)))
...
)))))))))) (= (_module.Universe.multipleLegalTransitions $prevHeap@@17 $Heap@@13 this@@26 |running#0@@1|)  (and (and (and (and (and (and (and (_module.Universe.globalInv $prevHeap@@17 this@@26) (_module.Universe.globalBaseInv $Heap@@13 this@@26)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@26) _module.Universe.content)))) (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Box refType |o#0@@3|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@26) _module.Universe.content)) ($Box refType |o#0@@3|)))) (not ($IsAllocBox ($Box refType |o#0@@3|) Tclass._module.Object $prevHeap@@17)))
 :qid |_06ThreadOwnershipdfy.36:16|
 :skolemid |535|
...
))) (forall ((|t#0| T@U) ) (!  (=> (and ($Is refType |t#0| Tclass._module.Thread) (|Set#IsMember| |running#0@@1| ($Box refType |t#0|))) (and (= (_module.Object.universe |t#0|) this@@26) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Box refType |t#0|))))
...
))) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Box refType |o#3|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 |o#3|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (not (|Set#IsMember| |running#0@@1| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 |o#3|) _module.OwnedObject.owner))) (forall (($o@@27 T@U) ($f@@15 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@27) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 $o@@27) $f@@15))))
 ...
 :skolemid |550|
 :pattern ( (_module.Universe.multipleLegalTransitions $prevHeap@@17 $Heap@@13 this@@26 |running#0@@1|) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@17 this@@30) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Object) ($IsAlloc refType this@@30 Tclass._module.Object $Heap@@17)))))) (=> (_module.Object.inv $Heap@@17 this@@30) (_module.Object.localInv $Heap@@17 this@@30)))
 :qid |_06ThreadOwnershipdfy.114:19|
 :skolemid |800|
 :pattern ( (_module.Object.inv $Heap@@17 this@@30))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@18 this@@31) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.OwnedObject) ($IsAlloc refType this@@31 Tclass._module.OwnedObject $Heap@@18)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@18 this@@31) (=> (_module.OwnedObject.localInv $Heap@@18 this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 this@@31) _module.OwnedObject.closed))) (|_module.OwnedObject.userInv#canCall| $Heap@@18 this@@31)))) (= (_module.OwnedObject.inv $Heap@@18 this@@31)  (and (_module.OwnedObject.localInv $Heap@@18 this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 this@@31) _module.OwnedObject.closed))) (_module.OwnedObject.userInv $Heap@@18 this@@31))))))
 :qid |_06ThreadOwnershipdfy.137:19|
 :skolemid |886|
 :pattern ( (_module.OwnedObject.inv $Heap@@18 this@@31) ($IsGoodHeap $Heap@@18))
))))
...
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@32 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@32 null)) (not true)) ($Is refType this@@32 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@29 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (or (= $o@@29 this@@32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 this@@32) _module.Universe.content)) ($Box refType $o@@29)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@29) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@29) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |492|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@30 T@U) ($f@@17 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@30 $f@@17))  (=> (and (or (not (= $o@@30 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@30) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2084|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@30 $f@@17))
)))
(assert (forall (($h@@15 T@U) ($o@@31 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@31 null)) (not true)) ($Is refType $o@@31 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@31) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@31) _module.OwnedObject.owner)) Tclass._module.Object $h@@15))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |869|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@31) _module.OwnedObject.owner)))
)))
(assert (forall (($h0@@13 T@U) ($h1@@13 T@U) (this@@33 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@13) ($IsGoodHeap $h1@@13)) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.Universe) ($IsAlloc refType this@@33 Tclass._module.Universe $h0@@13)))) (and ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13))) (=> (forall (($o@@32 T@U) ($f@@18 T@U) ) (!  (=> (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@32) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@32) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@13 $o@@32) $f@@18)))
 :qid |unknown.0:0|
 :skolemid |507|
)) (= (_module.Universe.globalInv $h0@@13 this@@33) (_module.Universe.globalInv $h1@@13 this@@33))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |508|
 :pattern ( ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13) (_module.Universe.globalInv $h1@@13 this@@33))
)))
(assert (forall (($h0@@14 T@U) ($h1@@14 T@U) (this@@34 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@14) ($IsGoodHeap $h1@@14)) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.Object) ($IsAlloc refType this@@34 Tclass._module.Object $h0@@14)))) (and ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14))) (=> (forall (($o@@33 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@33) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@33) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@14 $o@@33) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |734|
)) (= (_module.Object.baseInv $h0@@14 this@@34) (_module.Object.baseInv $h1@@14 this@@34))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |735|
 :pattern ( ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14) (_module.Object.baseInv $h1@@14 this@@34))
)))
(assert (forall (($h0@@15 T@U) ($h1@@15 T@U) (this@@35 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@15) ($IsGoodHeap $h1@@15)) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.Object) ($IsAlloc refType this@@35 Tclass._module.Object $h0@@15)))) (and ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15))) (=> (forall (($o@@34 T@U) ($f@@20 T@U) ) (!  (=> (and (or (not (= $o@@34 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@34) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@34) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@15 $o@@34) $f@@20)))
 :qid |unknown.0:0|
 :skolemid |790|
)) (= (_module.Object.localInv $h0@@15 this@@35) (_module.Object.localInv $h1@@15 this@@35))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |791|
 :pattern ( ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15) (_module.Object.localInv $h1@@15 this@@35))
)))
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@36 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Object) ($IsAlloc refType this@@36 Tclass._module.Object $h0@@16)))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@35 T@U) ($f@@21 T@U) ) (!  (=> (and (or (not (= $o@@35 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@35) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@35) $f@@21) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@35) $f@@21)))
 :qid |unknown.0:0|
 :skolemid |798|
)) (= (_module.Object.inv $h0@@16 this@@36) (_module.Object.inv $h1@@16 this@@36))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |799|
 :pattern ( ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16) (_module.Object.inv $h1@@16 this@@36))
)))
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@37 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.OwnedObject) ($IsAlloc refType this@@37 Tclass._module.OwnedObject $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@36 T@U) ($f@@22 T@U) ) (!  (=> (and (or (not (= $o@@36 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@36) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@36) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@36) $f@@22)))
 :qid |unknown.0:0|
 :skolemid |872|
)) (= (_module.OwnedObject.localInv $h0@@17 this@@37) (_module.OwnedObject.localInv $h1@@17 this@@37))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |873|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.OwnedObject.localInv $h1@@17 this@@37))
)))
(assert (forall (($h0@@18 T@U) ($h1@@18 T@U) (this@@38 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.OwnedObject) ($IsAlloc refType this@@38 Tclass._module.OwnedObject $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@37 T@U) ($f@@23 T@U) ) (!  (=> (and (or (not (= $o@@37 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@37) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@37) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@37) $f@@23)))
 :qid |unknown.0:0|
 :skolemid |882|
)) (= (_module.OwnedObject.inv $h0@@18 this@@38) (_module.OwnedObject.inv $h1@@18 this@@38))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |883|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.OwnedObject.inv $h1@@18 this@@38))
)))
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@39 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.OwnedObject) ($IsAlloc refType this@@39 Tclass._module.OwnedObject $h0@@19)))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@38 T@U) ($f@@24 T@U) ) (!  (=> (and (or (not (= $o@@38 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@38) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@38) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@38) $f@@24)))
 :qid |unknown.0:0|
 :skolemid |938|
)) (= (_module.OwnedObject.baseUserInv $h0@@19 this@@39) (_module.OwnedObject.baseUserInv $h1@@19 this@@39))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |939|
 :pattern ( ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19) (_module.OwnedObject.baseUserInv $h1@@19 this@@39))
)))
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@40 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.OwnedObject) ($IsAlloc refType this@@40 Tclass._module.OwnedObject $h0@@20)))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@39 T@U) ($f@@25 T@U) ) (!  (=> (and (or (not (= $o@@39 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@39) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@39) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@39) $f@@25)))
 :qid |unknown.0:0|
 :skolemid |942|
)) (= (_module.OwnedObject.localUserInv $h0@@20 this@@40) (_module.OwnedObject.localUserInv $h1@@20 this@@40))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |943|
 :pattern ( ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20) (_module.OwnedObject.localUserInv $h1@@20 this@@40))
)))
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@41 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@41 null)) (not true)) (and ($Is refType this@@41 Tclass._module.OwnedObject) ($IsAlloc refType this@@41 Tclass._module.OwnedObject $h0@@21)))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@40 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@40 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@40) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@40) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@40) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |950|
)) (= (_module.OwnedObject.userInv $h0@@21 this@@41) (_module.OwnedObject.userInv $h1@@21 this@@41))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |951|
 :pattern ( ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21) (_module.OwnedObject.userInv $h1@@21 this@@41))
)))
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@42 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@42 null)) (not true)) (and ($Is refType this@@42 Tclass._module.Thread) ($IsAlloc refType this@@42 Tclass._module.Thread $h0@@22)))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@41 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@41 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@41) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@41) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@41) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |963|
)) (= (_module.Thread.localInv $h0@@22 this@@42) (_module.Thread.localInv $h1@@22 this@@42))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |964|
 :pattern ( ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22) (_module.Thread.localInv $h1@@22 this@@42))
)))
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@43 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@43 null)) (not true)) (and ($Is refType this@@43 Tclass._module.Thread) ($IsAlloc refType this@@43 Tclass._module.Thread $h0@@23)))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@42 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@42 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@42) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@42) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@42) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |971|
)) (= (_module.Thread.inv $h0@@23 this@@43) (_module.Thread.inv $h1@@23 this@@43))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |972|
 :pattern ( ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23) (_module.Thread.inv $h1@@23 this@@43))
)))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($prevHeap@@18 T@U) ($Heap@@19 T@U) (this@@44 T@U) (|running#0@@2| T@U) ) (!  (=> (or (|_module.Universe.legalTransition#canCall| $prevHeap@@18 $Heap@@19 this@@44 |running#0@@2|) (and (< 9 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@18) ($IsGoodHeap $Heap@@19)) ($HeapSucc $prevHeap@@18 $Heap@@19)) (and (or (not (= this@@44 null)) (not true)) (and ($Is refType this@@44 Tclass._module.Universe) ($IsAlloc refType this@@44 Tclass._module.Universe $prevHeap@@18)))) ($Is refType |running#0@@2| Tclass._module.Thread)))) (and (and (|_module.Universe.multipleLegalTransitions#canCall| $prevHeap@@18 $Heap@@19 this@@44 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (=> (_module.Universe.multipleLegalTransitions $prevHeap@@18 $Heap@@19 this@@44 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (forall ((|o#0@@4| T@U) ) (!  (=> ($Is refType |o#0@@4| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@44) _module.Universe.content)) ($Box refType |o#0@@4|)) (=> (not (forall (($o@@43 T@U) ($f@@29 T@U) ) (!  (=> (or (not (= $o@@43 null)) (not true)) (=> (= $o@@43 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 $o@@43) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 $o@@43) $f@@29))))
...
))) (|_module.Object.inv2#canCall| $prevHeap@@18 $Heap@@19 |o#0@@4|))))
 :qid |_06ThreadOwnershipdfy.48:16|
 :skolemid |599|
 :pattern ( (_module.Object.inv2 $prevHeap@@18 $Heap@@19 |o#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@44) _module.Universe.content)) ($Box refType |o#0@@4|)))
)))) (= (_module.Universe.legalTransition $prevHeap@@18 $Heap@@19 this@@44 |running#0@@2|)  (and (_module.Universe.multipleLegalTransitions $prevHeap@@18 $Heap@@19 this@@44 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@44) _module.Universe.content)) ($Box refType |o#0@@5|))) (or (forall (($o@@44 T@U) ($f@@30 T@U) ) (!  (=> (or (not (= $o@@44 null)) (not true)) (=> (= $o@@44 |o#0@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 $o@@44) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 $o@@44) $f@@30))))
 :qid |_06ThreadOwnershipdfy.48:49|
 :skolemid |596|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 $o@@44) $f@@30))
)) (_module.Object.inv2 $prevHeap@@18 $Heap@@19 |o#0@@5|)))
 :qid |_06ThreadOwnershipdfy.48:16|
 :skolemid |597|
 :pattern ( (_module.Object.inv2 $prevHeap@@18 $Heap@@19 |o#0@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@44) _module.Universe.content)) ($Box refType |o#0@@5|)))
))))))
 :qid |_06ThreadOwnershipdfy.45:22|
 :skolemid |600|
 :pattern ( (_module.Universe.legalTransition $prevHeap@@18 $Heap@@19 this@@44 |running#0@@2|) ($IsGoodHeap $Heap@@19))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($prevHeap@@19 T@U) ($Heap@@20 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.Universe.globalInv2#canCall| $prevHeap@@19 $Heap@@20 this@@45) (and (< 8 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@19) ($IsGoodHeap $Heap@@20)) ($HeapSucc $prevHeap@@19 $Heap@@20)) (and (or (not (= this@@45 null)) (not true)) (and ($Is refType this@@45 Tclass._module.Universe) ($IsAlloc refType this@@45 Tclass._module.Universe $prevHeap@@19)))))) (and (forall ((|o#0@@6| T@U) ) (!  (=> ($Is refType |o#0@@6| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@45) _module.Universe.content)) ($Box refType |o#0@@6|)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@45) _module.Universe.content)) ($Box refType |o#0@@6|)) (|_module.Object.inv2#canCall| $prevHeap@@19 $Heap@@20 |o#0@@6|))))
 :qid |_06ThreadOwnershipdfy.28:12|
 :skolemid |525|
 :pattern ( (_module.Object.inv2 $prevHeap@@19 $Heap@@20 |o#0@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@45) _module.Universe.content)) ($Box refType |o#0@@6|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@45) _module.Universe.content)) ($Box refType |o#0@@6|)))
)) (= (_module.Universe.globalInv2 $prevHeap@@19 $Heap@@20 this@@45) (forall ((|o#0@@7| T@U) ) (!  (=> (and ($Is refType |o#0@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@45) _module.Universe.content)) ($Box refType |o#0@@7|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@45) _module.Universe.content)) ($Box refType |o#0@@7|)) (_module.Object.inv2 $prevHeap@@19 $Heap@@20 |o#0@@7|)))
 :qid |_06ThreadOwnershipdfy.28:12|
 :skolemid |524|
 :pattern ( (_module.Object.inv2 $prevHeap@@19 $Heap@@20 |o#0@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@45) _module.Universe.content)) ($Box refType |o#0@@7|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@45) _module.Universe.content)) ($Box refType |o#0@@7|)))
)))))
 :qid |_06ThreadOwnershipdfy.27:22|
 :skolemid |526|
 :pattern ( (_module.Universe.globalInv2 $prevHeap@@19 $Heap@@20 this@@45) ($IsGoodHeap $Heap@@20))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@54) Tclass._module.Universe? current$Heap) ($IsAlloc refType |running#0@@3| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@54 Tclass._module.Universe $Heap@@29)) (=> ($IsAlloc refType this@@54 Tclass._module.Universe $Heap@@29) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@29)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@29) (=> (|_module.Universe.legalTransition#canCall| $Heap@@29 current$Heap this@@54 |running#0@@3|) (=> (and (_module.Universe.legalTransition $Heap@@29 current$Heap this@@54 |running#0@@3|) ($IsAllocBox ($Box refType this@@54) Tclass._module.Universe? current$Heap)) (=> (and (and (|_module.Universe.globalInv#canCall| current$Heap this@@54) (_module.Universe.globalInv current$Heap this@@54)) (and ($IsAllocBox ($Box refType this@@54) Tclass._module.Universe? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@54 Tclass._module.Universe $Heap@@29))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@29) ($IsHeapAnchor $Heap@@29)) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.Universe) ($IsAlloc refType this@@54 Tclass._module.Universe previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap)) (= 13 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@29) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
