...
(set-info :boogie-vc-id OverrideCheck$$_module.AtomicCounter.userFieldsOwnedBy)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (|Set#Equal| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (or (not (= |owner#0| null)) (not true)) (or (not (= |owner#0| null)) (not true)))))) (=> (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (|Set#Equal| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (or (not (= |owner#0| null)) (not true)) (or (not (= |owner#0| null)) (not true))))) (=> (and (= AtomicCounter_$_ReadsFrame@0 (|lambda#3| null $Heap alloc $Heap alloc)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10) alloc))))
 :qid |_06ThreadOwnershipdfy.296:19|
 :skolemid |1468|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.AtomicCounter) ($IsAlloc refType this Tclass._module.AtomicCounter $Heap))) ($Is refType |owner#0| Tclass._module.Object)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
