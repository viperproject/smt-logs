...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@4 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Universe) ($IsAlloc refType this@@4 Tclass._module.Universe $h0)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@8 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@8) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@8) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@8) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |526|
)) (= (_module.Universe.legalTransition $prevHeap@@0 $h0 this@@4) (_module.Universe.legalTransition $prevHeap@@0 $h1 this@@4))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |527|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.Universe.legalTransition $prevHeap@@0 $h1 this@@4))
)))
(assert (forall (($prevHeap@@1 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this@@5 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.Object) ($IsAlloc refType this@@5 Tclass._module.Object $h0@@0)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@9 T@U) ($f@@7 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@9) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@9) $f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@9) $f@@7)))
 :qid |unknown.0:0|
 :skolemid |633|
)) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@1 $h0@@0 this@@5) (_module.Object.goodPreAndLegalChanges $prevHeap@@1 $h1@@0 this@@5))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |634|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.Object.goodPreAndLegalChanges $prevHeap@@1 $h1@@0 this@@5))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.A.inv#canCall| $Heap@@14 this@@28) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.A) ($IsAlloc refType this@@28 Tclass._module.A $Heap@@14)))))) (and (and (|_module.A.localInv#canCall| $Heap@@14 this@@28) (=> (_module.A.localInv $Heap@@14 this@@28) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@28) _module.A.valid))) (|_module.B.localInv#canCall| $Heap@@14 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@28) _module.A.b)))))) (= (_module.A.inv $Heap@@14 this@@28)  (and (_module.A.localInv $Heap@@14 this@@28) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@28) _module.A.valid))) (_module.B.localInv $Heap@@14 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@28) _module.A.b))))))))
 :qid |_05RecInvariantCutdfy.97:19|
 :skolemid |708|
 :pattern ( (_module.A.inv $Heap@@14 this@@28) ($IsGoodHeap $Heap@@14))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.B.inv#canCall| $Heap@@15 this@@29) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.B) ($IsAlloc refType this@@29 Tclass._module.B $Heap@@15)))))) (and (and (|_module.B.localInv#canCall| $Heap@@15 this@@29) (=> (_module.B.localInv $Heap@@15 this@@29) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@29) _module.B.valid))) (|_module.A.inv#canCall| $Heap@@15 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@29) _module.B.a)))))) (= (_module.B.inv $Heap@@15 this@@29)  (and (_module.B.localInv $Heap@@15 this@@29) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@29) _module.B.valid))) (_module.A.inv $Heap@@15 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@29) _module.B.a))))))))
 :qid |_05RecInvariantCutdfy.145:19|
 :skolemid |869|
 :pattern ( (_module.B.inv $Heap@@15 this@@29) ($IsGoodHeap $Heap@@15))
))))
...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($prevHeap@@13 T@U) ($Heap@@16 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Object.goodPreAndLegalChanges#canCall| $prevHeap@@13 $Heap@@16 this@@30) (and (< 10 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@13) ($IsGoodHeap $Heap@@16)) ($HeapSucc $prevHeap@@13 $Heap@@16)) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Object) ($IsAlloc refType this@@30 Tclass._module.Object $prevHeap@@13)))))) (and (and (and (|_module.Object.baseInv#canCall| $prevHeap@@13 this@@30) (=> (_module.Object.baseInv $prevHeap@@13 this@@30) (|_module.Universe.globalInv#canCall| $prevHeap@@13 (_module.Object.universe this@@30)))) (=> (and (_module.Object.baseInv $prevHeap@@13 this@@30) (_module.Universe.globalInv $prevHeap@@13 (_module.Object.universe this@@30))) (and (|_module.Object.baseInv#canCall| $Heap@@16 this@@30) (=> (_module.Object.baseInv $Heap@@16 this@@30) (=> (forall (($o@@47 T@U) ($f@@21 T@U) ) (!  (=> (or (not (= $o@@47 null)) (not true)) (=> (= $o@@47 this@@30) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 $o@@47) $f@@21) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@13 $o@@47) $f@@21))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |638|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 $o@@47) $f@@21))
)) (|_module.Universe.legalTransition#canCall| $prevHeap@@13 $Heap@@16 (_module.Object.universe this@@30))))))) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@13 $Heap@@16 this@@30)  (and (and (and (and (_module.Object.baseInv $prevHeap@@13 this@@30) (_module.Universe.globalInv $prevHeap@@13 (_module.Object.universe this@@30))) (_module.Object.baseInv $Heap@@16 this@@30)) (forall (($o@@48 T@U) ($f@@22 T@U) ) (!  (=> (or (not (= $o@@48 null)) (not true)) (=> (= $o@@48 this@@30) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 $o@@48) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@13 $o@@48) $f@@22))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |637|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 $o@@48) $f@@22))
))) (_module.Universe.legalTransition $prevHeap@@13 $Heap@@16 (_module.Object.universe this@@30))))))
 :qid |_05RecInvariantCutdfy.74:22|
 :skolemid |639|
 :pattern ( (_module.Object.goodPreAndLegalChanges $prevHeap@@13 $Heap@@16 this@@30) ($IsGoodHeap $Heap@@16))
))))
...
(set-info :boogie-vc-id OverrideCheck$$_module.A.adm)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon0_correct  (=> (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (and (=> (= (ControlFlow 0 2) (- 0 33)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| $Heap@@17 this@@31) (or (_module.Object.baseInv $Heap@@17 this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| $Heap@@17 this@@31) (or (_module.Object.baseInv $Heap@@17 this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31)))))) (and (=> (= (ControlFlow 0 2) (- 0 32)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| $Heap@@17 this@@31) (or (_module.Object.baseInv $Heap@@17 this@@31) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#0@@10|))) (and (= (_module.Object.universe |o#0@@10|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#0@@10|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |734|
 :pattern ( (_module.__default.upCast |o#0@@10|))
 :pattern ( (_module.Object.universe |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#0@@10|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| $Heap@@17 this@@31) (or (_module.Object.baseInv $Heap@@17 this@@31) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#0@@11| T@U) ) (!  (=> (and ($Is refType |o#0@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#0@@11|))) (and (= (_module.Object.universe |o#0@@11|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#0@@11|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |734|
 :pattern ( (_module.__default.upCast |o#0@@11|))
 :pattern ( (_module.Object.universe |o#0@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#0@@11|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.globalInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalInv $Heap@@17 (_module.Object.universe this@@31)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#1@@1|))) (and (= (_module.Object.universe |o#1@@1|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#1@@1|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |736|
 :pattern ( (_module.__default.upCast |o#1@@1|))
 :pattern ( (_module.Object.universe |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#1@@1|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.globalInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalInv $Heap@@17 (_module.Object.universe this@@31)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#1@@2|))) (and (= (_module.Object.universe |o#1@@2|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#1@@2|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |736|
 :pattern ( (_module.__default.upCast |o#1@@2|))
 :pattern ( (_module.Object.universe |o#1@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#1@@2|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.globalInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#2|))) (_module.Object.inv $Heap@@17 |o#2|))
 :qid |_05RecInvariantCutdfy.25:31|
 :skolemid |738|
 :pattern ( (_module.Object.inv $Heap@@17 |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#2|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.globalInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#2@@0|))) (_module.Object.inv $Heap@@17 |o#2@@0|))
 :qid |_05RecInvariantCutdfy.25:31|
 :skolemid |738|
 :pattern ( (_module.Object.inv $Heap@@17 |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| current$Heap this@@31) (or (_module.Object.baseInv current$Heap this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| current$Heap this@@31) (or (_module.Object.baseInv current$Heap this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31)))))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| current$Heap this@@31) (or (_module.Object.baseInv current$Heap this@@31) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@31)) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#3|))) (and (= (_module.Object.universe |o#3|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#3|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |740|
 :pattern ( (_module.__default.upCast |o#3|))
 :pattern ( (_module.Object.universe |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| current$Heap this@@31) (or (_module.Object.baseInv current$Heap this@@31) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@31)) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#3@@0|))) (and (= (_module.Object.universe |o#3@@0|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#3@@0|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |740|
 :pattern ( (_module.__default.upCast |o#3@@0|))
 :pattern ( (_module.Object.universe |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 27)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (forall (($o@@49 T@U) ($f@@23 T@U) ) (!  (=> (or (not (= $o@@49 null)) (not true)) (=> (= $o@@49 this@@31) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@49) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@49) $f@@23))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |742|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@49) $f@@23))
))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (forall (($o@@50 T@U) ($f@@24 T@U) ) (!  (=> (or (not (= $o@@50 null)) (not true)) (=> (= $o@@50 this@@31) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@50) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@50) $f@@24))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |742|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@50) $f@@24))
)))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (=> (|_module.Universe.globalInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalInv $Heap@@17 (_module.Object.universe this@@31)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#4|))) (and (= (_module.Object.universe |o#4|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#4|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |743|
 :pattern ( (_module.__default.upCast |o#4|))
 :pattern ( (_module.Object.universe |o#4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#4|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (=> (|_module.Universe.globalInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalInv $Heap@@17 (_module.Object.universe this@@31)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#4@@0|))) (and (= (_module.Object.universe |o#4@@0|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#4@@0|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |743|
 :pattern ( (_module.__default.upCast |o#4@@0|))
 :pattern ( (_module.Object.universe |o#4@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (=> (|_module.Universe.globalInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#5|))) (_module.Object.inv $Heap@@17 |o#5|))
 :qid |_05RecInvariantCutdfy.25:31|
 :skolemid |745|
 :pattern ( (_module.Object.inv $Heap@@17 |o#5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#5|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (=> (|_module.Universe.globalInv#canCall| $Heap@@17 (_module.Object.universe this@@31)) (or (_module.Universe.globalInv $Heap@@17 (_module.Object.universe this@@31)) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#5@@0|))) (_module.Object.inv $Heap@@17 |o#5@@0|))
 :qid |_05RecInvariantCutdfy.25:31|
 :skolemid |745|
 :pattern ( (_module.Object.inv $Heap@@17 |o#5@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#5@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@31)) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#6|))) (and (= (_module.Object.universe |o#6|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#6|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |747|
 :pattern ( (_module.__default.upCast |o#6|))
 :pattern ( (_module.Object.universe |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#6|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@31)) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#6@@0|))) (and (= (_module.Object.universe |o#6@@0|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#6@@0|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |747|
 :pattern ( (_module.__default.upCast |o#6@@0|))
 :pattern ( (_module.Object.universe |o#6@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#6@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#7|))) (and (or (forall (($o@@51 T@U) ($f@@25 T@U) ) (!  (=> (or (not (= $o@@51 null)) (not true)) (=> (= $o@@51 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@51) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@51) $f@@25))))
 :qid |_05RecInvariantCutdfy.39:49|
 :skolemid |749|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@51) $f@@25))
)) (_module.Object.inv2 $Heap@@17 current$Heap |o#7|)) (or (forall (($o@@52 T@U) ($f@@26 T@U) ) (!  (=> (or (not (= $o@@52 null)) (not true)) (=> (= $o@@52 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@52) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@52) $f@@26))))
 :qid |_05RecInvariantCutdfy.39:49|
 :skolemid |750|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@52) $f@@26))
)) (_module.Object.inv current$Heap |o#7|))))
 :qid |_05RecInvariantCutdfy.39:16|
 :skolemid |751|
 :pattern ( (_module.Object.inv current$Heap |o#7|))
 :pattern ( (_module.Object.inv2 $Heap@@17 current$Heap |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#7|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (or (forall (($o@@53 T@U) ($f@@27 T@U) ) (!  (=> (or (not (= $o@@53 null)) (not true)) (=> (= $o@@53 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@53) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@53) $f@@27))))
 :qid |_05RecInvariantCutdfy.39:49|
 :skolemid |749|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@53) $f@@27))
)) (_module.Object.inv2 $Heap@@17 current$Heap |o#7@@0|)) (or (forall (($o@@54 T@U) ($f@@28 T@U) ) (!  (=> (or (not (= $o@@54 null)) (not true)) (=> (= $o@@54 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@54) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 $o@@54) $f@@28))))
 :qid |_05RecInvariantCutdfy.39:49|
 :skolemid |750|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@54) $f@@28))
)) (_module.Object.inv current$Heap |o#7@@0|))))
 :qid |_05RecInvariantCutdfy.39:16|
 :skolemid |751|
 :pattern ( (_module.Object.inv current$Heap |o#7@@0|))
 :pattern ( (_module.Object.inv2 $Heap@@17 current$Heap |o#7@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#7@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#8|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#8|))))) (_module.Object.inv current$Heap |o#8|))
 :qid |_05RecInvariantCutdfy.41:16|
 :skolemid |752|
 :pattern ( (_module.Object.inv current$Heap |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#8|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#8|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (or (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31) (=> (|_module.Universe.legalTransition#canCall| $Heap@@17 current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.legalTransition $Heap@@17 current$Heap (_module.Object.universe this@@31)) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#8@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#8@@0|))))) (_module.Object.inv current$Heap |o#8@@0|))
 :qid |_05RecInvariantCutdfy.41:16|
 :skolemid |752|
 :pattern ( (_module.Object.inv current$Heap |o#8@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#8@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#8@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) true) (and (=> (= (ControlFlow 0 2) (- 0 19)) (forall (($o@@55 T@U) ($f@@29 T@U) ) (! true
 :qid |_05RecInvariantCutdfy.123:18|
 :skolemid |758|
))) (=> (forall (($o@@56 T@U) ($f@@30 T@U) ) (! true
 :qid |_05RecInvariantCutdfy.123:18|
 :skolemid |758|
)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (forall (($o@@57 T@U) ($f@@31 T@U) ) (! true
 :qid |_05RecInvariantCutdfy.123:18|
 :skolemid |759|
))) (=> (forall (($o@@58 T@U) ($f@@32 T@U) ) (! true
 :qid |_05RecInvariantCutdfy.123:18|
 :skolemid |759|
)) (=> (and (_module.A.inv2 $Heap@@17 current$Heap this@@31) (_module.A.inv current$Heap this@@31)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (|_module.A.localInv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.localInv2 $Heap@@17 current$Heap this@@31) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (|_module.A.localInv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.localInv2 $Heap@@17 current$Heap this@@31) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (|_module.A.localInv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.localInv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))))))))) (=> (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (|_module.A.localInv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.localInv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid)))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (|_module.A.localInv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.localInv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.b)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))))))))) (=> (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (|_module.A.localInv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.localInv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.b)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (=> (|_module.B.localInv2#canCall| $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv2 $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (=> (|_module.B.localInv2#canCall| $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv2 $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (=> (|_module.B.localInv2#canCall| $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv2 $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.b))) _module.B.valid))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.valid)))))))))) (=> (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (=> (|_module.B.localInv2#canCall| $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv2 $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.b))) _module.B.valid))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.valid))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (=> (|_module.B.localInv2#canCall| $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv2 $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.b))) _module.B.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.b))) _module.B.a)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a)))))))))) (=> (=> (|_module.A.inv2#canCall| $Heap@@17 current$Heap this@@31) (or (_module.A.inv2 $Heap@@17 current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.valid))) (=> (|_module.B.localInv2#canCall| $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv2 $Heap@@17 current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.b))) _module.B.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.A.b))) _module.B.a)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a))))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| current$Heap this@@31) (or (_module.Object.baseInv current$Heap this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31))))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| current$Heap this@@31) (or (_module.Object.baseInv current$Heap this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31)))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| current$Heap this@@31) (or (_module.Object.baseInv current$Heap this@@31) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@31)) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#9|))) (and (= (_module.Object.universe |o#9|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#9|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |760|
 :pattern ( (_module.__default.upCast |o#9|))
 :pattern ( (_module.Object.universe |o#9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#9|)))
))))))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (=> (|_module.Object.baseInv#canCall| current$Heap this@@31) (or (_module.Object.baseInv current$Heap this@@31) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@31)) (forall ((|o#9@@0| T@U) ) (!  (=> (and ($Is refType |o#9@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#9@@0|))) (and (= (_module.Object.universe |o#9@@0|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#9@@0|) (_module.Object.universe this@@31))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |760|
 :pattern ( (_module.__default.upCast |o#9@@0|))
 :pattern ( (_module.Object.universe |o#9@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#9@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (= (_module.Object.universe this@@31) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (= (_module.Object.universe this@@31) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.valid))))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.valid)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a)) this@@31))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (|_module.A.localInv#canCall| current$Heap this@@31) (or (_module.A.localInv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a)) this@@31)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (|_module.Object.baseInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.Object.baseInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (|_module.Object.baseInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.Object.baseInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (|_module.Object.baseInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.Object.baseInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) _module.Universe.content)) ($Box refType |o#10|))) (and (= (_module.Object.universe |o#10|) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) (or (not (= (_module.__default.upCast |o#10|) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |762|
 :pattern ( (_module.__default.upCast |o#10|))
 :pattern ( (_module.Object.universe |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) _module.Universe.content)) ($Box refType |o#10|)))
)))))))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (|_module.Object.baseInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.Object.baseInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) _module.Universe.content)) ($Box refType |o#10@@0|))) (and (= (_module.Object.universe |o#10@@0|) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) (or (not (= (_module.__default.upCast |o#10@@0|) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))))) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |762|
 :pattern ( (_module.__default.upCast |o#10@@0|))
 :pattern ( (_module.Object.universe |o#10@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))) _module.Universe.content)) ($Box refType |o#10@@0|)))
))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (= (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a)))))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (= (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.valid))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a))) _module.A.valid)))))))))) (=> (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.valid))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a))) _module.A.valid))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.A.inv#canCall| current$Heap this@@31) (or (_module.A.inv current$Heap this@@31) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.valid))) (=> (|_module.B.localInv#canCall| current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (or (_module.B.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.valid))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b))) _module.B.a))) _module.A.b)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@31) _module.A.b)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@17) ($IsHeapAnchor $Heap@@17)) (=> (and (and (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.A) ($IsAlloc refType this@@31 Tclass._module.A previous$Heap))) (= 11 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@17) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 34) 2))) anon0_correct))))
