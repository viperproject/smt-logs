...
))))) (= $Heap@1 $Heap@2)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))) (forall (($o@@115 T@U) ($f@@68 T@U) ) (!  (=> (and (and (or (not (= $o@@115 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@115) alloc)))) (or (= $o@@115 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType $o@@115)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@115 $f@@68)))
