...
))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@3 |universe#0|)))))) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@3 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
