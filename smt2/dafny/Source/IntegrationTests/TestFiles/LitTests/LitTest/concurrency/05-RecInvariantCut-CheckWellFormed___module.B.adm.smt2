...
(set-info :boogie-vc-id CheckWellFormed$$_module.B.adm)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#4| null current$Heap alloc false)) ($IsAllocBox ($Box refType this@@31) Tclass._module.Object? current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@31 Tclass._module.B $Heap@@17)) (=> ($IsAlloc refType this@@31 Tclass._module.B $Heap@@17) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31)) (and ($IsAllocBox ($Box refType this@@31) Tclass._module.B? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@31 Tclass._module.B $Heap@@17)))))))
