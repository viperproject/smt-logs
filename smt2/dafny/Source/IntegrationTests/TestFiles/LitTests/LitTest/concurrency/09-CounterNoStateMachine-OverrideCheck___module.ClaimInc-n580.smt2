...
(assert (forall (($h@@29 T@U) ($o@@64 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@64 null)) (not true)) ($Is refType $o@@64 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@64) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@64) _module.OwnedObject.owner)) Tclass._module.Object $h@@29))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1691|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@64) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@93 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.Universe) ($IsAlloc refType this@@93 Tclass._module.Universe $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@65 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@65) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@65) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |665|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@94 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@94 null)) (not true)) (and ($Is refType this@@94 Tclass._module.Object) ($IsAlloc refType this@@94 Tclass._module.Object $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@66 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@66) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@66) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@66) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1251|
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@95 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@95 null)) (not true)) (and ($Is refType this@@95 Tclass._module.Object) ($IsAlloc refType this@@95 Tclass._module.Object $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@67 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@67 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@67) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@67) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@67) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1314|
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@96 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@96 null)) (not true)) (and ($Is refType this@@96 Tclass._module.Object) ($IsAlloc refType this@@96 Tclass._module.Object $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@68 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@68 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@68) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@68) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@68) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1322|
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@97 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.Thread) ($IsAlloc refType this@@97 Tclass._module.Thread $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@69 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@69 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@69) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@69) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@69) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1397|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@99 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@99 null)) (not true)) (and ($Is refType this@@99 Tclass._module.OwnedObject) ($IsAlloc refType this@@99 Tclass._module.OwnedObject $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@71 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@71 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@71) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@71) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@71) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1704|
...
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@100 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@100 null)) (not true)) (and ($Is refType this@@100 Tclass._module.OwnedObject) ($IsAlloc refType this@@100 Tclass._module.OwnedObject $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@72 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@72 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@72) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@72) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@72) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1714|
...
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@101 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@101 null)) (not true)) (and ($Is refType this@@101 Tclass._module.OwnedObject) ($IsAlloc refType this@@101 Tclass._module.OwnedObject $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@73 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@73) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@73) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@73) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1818|
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@102 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@102 null)) (not true)) (and ($Is refType this@@102 Tclass._module.OwnedObject) ($IsAlloc refType this@@102 Tclass._module.OwnedObject $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@74 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@74) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@74) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@74) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1822|
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@103 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@103 null)) (not true)) (and ($Is refType this@@103 Tclass._module.OwnedObject) ($IsAlloc refType this@@103 Tclass._module.OwnedObject $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@75 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@75) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@75) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@75) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |1830|
...
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@104 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@104 null)) (not true)) (and ($Is refType this@@104 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@104 Tclass._module.IncreasingCounter $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@76 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@76) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@76) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@76) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |2130|
...
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@105 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@105 null)) (not true)) (and ($Is refType this@@105 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@105 Tclass._module.IncreasingCounter $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@77 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@77 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@77) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@77) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@77) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |2137|
...
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@106 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@106 null)) (not true)) (and ($Is refType this@@106 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@106 Tclass._module.IncreasingCounter $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@78 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@78) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@78) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@78) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |2144|
...
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@107 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@107 null)) (not true)) (and ($Is refType this@@107 Tclass._module.ConstantInteger) ($IsAlloc refType this@@107 Tclass._module.ConstantInteger $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@79 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@79) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@79) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@79) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |2670|
...
(assert (forall (($h0@@42 T@U) ($h1@@42 T@U) (this@@108 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@42) ($IsGoodHeap $h1@@42)) (and (or (not (= this@@108 null)) (not true)) (and ($Is refType this@@108 Tclass._module.ConstantInteger) ($IsAlloc refType this@@108 Tclass._module.ConstantInteger $h0@@42)))) (and ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42))) (=> (forall (($o@@80 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@80) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@80) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@42 $o@@80) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |2677|
...
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@109 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@109 null)) (not true)) (and ($Is refType this@@109 Tclass._module.ConstantInteger) ($IsAlloc refType this@@109 Tclass._module.ConstantInteger $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@81 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@81) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@81) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@81) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |2684|
...
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@110 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@110 null)) (not true)) (and ($Is refType this@@110 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@110 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@82 T@U) ($f@@53 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@82) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@82) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@82) $f@@53)))
 :qid |unknown.0:0|
 :skolemid |2942|
...
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@111 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@111 null)) (not true)) (and ($Is refType this@@111 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@111 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@83 T@U) ($f@@54 T@U) ) (!  (=> (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@83) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@83) $f@@54) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@83) $f@@54)))
 :qid |unknown.0:0|
 :skolemid |2949|
...
(assert (forall (($h0@@46 T@U) ($h1@@46 T@U) (this@@112 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@46) ($IsGoodHeap $h1@@46)) (and (or (not (= this@@112 null)) (not true)) (and ($Is refType this@@112 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@112 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $h0@@46)))) (and ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46))) (=> (forall (($o@@84 T@U) ($f@@55 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@84) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@46 $o@@84) $f@@55)))
 :qid |unknown.0:0|
 :skolemid |2956|
...
(assert (forall (($o@@85 T@U) ) (!  (=> ($Is refType $o@@85 Tclass._module.Thread?) ($Is refType $o@@85 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |3195|
 :pattern ( ($Is refType $o@@85 Tclass._module.Thread?))
)))
...
(assert (forall (($o@@86 T@U) ) (!  (=> ($Is refType $o@@86 Tclass._module.OwnedObject?) ($Is refType $o@@86 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |3199|
...
(assert (forall (($o@@87 T@U) ) (!  (=> ($Is refType $o@@87 Tclass._module.IncreasingCounter?) ($Is refType $o@@87 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3207|
 :pattern ( ($Is refType $o@@87 Tclass._module.IncreasingCounter?))
)))
...
(assert (forall (($o@@88 T@U) ) (!  (=> ($Is refType $o@@88 Tclass._module.ConstantInteger?) ($Is refType $o@@88 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3215|
 :pattern ( ($Is refType $o@@88 Tclass._module.ConstantInteger?))
)))
...
(assert (forall (($o@@89 T@U) ) (!  (=> ($Is refType $o@@89 Tclass._module.ClaimIncreasingCounterGreaterThanConstant?) ($Is refType $o@@89 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3219|
 :pattern ( ($Is refType $o@@89 Tclass._module.ClaimIncreasingCounterGreaterThanConstant?))
)))
...
(assert (= (Tag Tclass._module.ClaimIncreasingCounterGreaterThanConstant?) Tagclass._module.ClaimIncreasingCounterGreaterThanConstant?))
(assert (= (TagFamily Tclass._module.ClaimIncreasingCounterGreaterThanConstant?) tytagFamily$ClaimIncreasingCounterGreaterThanConstant))
(assert (forall (($h@@30 T@U) ($o@@90 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (or (not (= $o@@90 null)) (not true)) ($Is refType $o@@90 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@90) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1690|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@90) _module.OwnedObject.owner)))
)))
(assert (forall (($o@@91 T@U) ) (! (= ($Is refType $o@@91 Tclass._module.Universe?)  (or (= $o@@91 null) (implements$_module.Universe (dtype $o@@91))))
 :qid |unknown.0:0|
 :skolemid |644|
 :pattern ( ($Is refType $o@@91 Tclass._module.Universe?))
)))
(assert (forall (($o@@92 T@U) ) (! (= ($Is refType $o@@92 Tclass._module.Object?)  (or (= $o@@92 null) (implements$_module.Object (dtype $o@@92))))
 :qid |unknown.0:0|
 :skolemid |1247|
 :pattern ( ($Is refType $o@@92 Tclass._module.Object?))
)))
(assert (forall (($o@@93 T@U) ) (! (= ($Is refType $o@@93 Tclass._module.OwnedObject?)  (or (= $o@@93 null) (implements$_module.OwnedObject (dtype $o@@93))))
 :qid |unknown.0:0|
 :skolemid |1686|
 :pattern ( ($Is refType $o@@93 Tclass._module.OwnedObject?))
)))
(assert (forall (($h@@31 T@U) ($o@@94 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@31) (and (or (not (= $o@@94 null)) (not true)) ($Is refType $o@@94 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@94) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@94) _module.Universe.content)) (TSet Tclass._module.Object) $h@@31))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |647|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@94) _module.Universe.content)))
)))
...
(assert (forall (($h@@32 T@U) ($o@@95 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (or (not (= $o@@95 null)) (not true)) ($Is refType $o@@95 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@95) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |646|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@95) _module.Universe.content)))
)))
...
))) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@65 this@@125) _module.Universe.content)) ($Box refType |o#1@@3|))) (or (forall (($o@@96 T@U) ($f@@56 T@U) ) (!  (=> (or (not (= $o@@96 null)) (not true)) (=> (= $o@@96 |o#1@@3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 $o@@96) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@65 $o@@96) $f@@56))))
 :qid |_09CounterNoStateMachinedfy.60:54|
 :skolemid |693|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 $o@@96) $f@@56))
...
(set-info :boogie-vc-id OverrideCheck$$_module.ClaimIncreasingCounterGreaterThanConstant.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon0_correct  (=> (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 32)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@79 this@@127) (or (_module.Object.baseInv $Heap@@79 this@@127) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType this@@127))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@79 this@@127) (or (_module.Object.baseInv $Heap@@79 this@@127) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType this@@127)))))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@79 this@@127) (or (_module.Object.baseInv $Heap@@79 this@@127) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#0@@10|))) (and (= (_module.Object.universe |o#0@@10|) (_module.Object.universe this@@127)) (or (not (= |o#0@@10| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |2979|
 :pattern ( (_module.Object.universe |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#0@@10|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@79 this@@127) (or (_module.Object.baseInv $Heap@@79 this@@127) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#0@@11| T@U) ) (!  (=> (and ($Is refType |o#0@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#0@@11|))) (and (= (_module.Object.universe |o#0@@11|) (_module.Object.universe this@@127)) (or (not (= |o#0@@11| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |2979|
 :pattern ( (_module.Object.universe |o#0@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#0@@11|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@79 this@@127) (or (_module.Object.baseInv $Heap@@79 this@@127) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#1@@5| T@U) ) (!  (=> (and ($Is refType |o#1@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#1@@5|))) (_module.Object.triggerAxioms $Heap@@79 |o#1@@5|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |2980|
 :pattern ( (_module.Object.triggerAxioms $Heap@@79 |o#1@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#1@@5|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@79 this@@127) (or (_module.Object.baseInv $Heap@@79 this@@127) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#1@@6| T@U) ) (!  (=> (and ($Is refType |o#1@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#1@@6|))) (_module.Object.triggerAxioms $Heap@@79 |o#1@@6|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |2980|
 :pattern ( (_module.Object.triggerAxioms $Heap@@79 |o#1@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#1@@6|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#2|))) (and (= (_module.Object.universe |o#2|) (_module.Object.universe this@@127)) (or (not (= |o#2| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |2983|
 :pattern ( (_module.Object.universe |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#2|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#2@@0|))) (and (= (_module.Object.universe |o#2@@0|) (_module.Object.universe this@@127)) (or (not (= |o#2@@0| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |2983|
 :pattern ( (_module.Object.universe |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#3|))) (_module.Object.triggerAxioms $Heap@@79 |o#3|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |2984|
 :pattern ( (_module.Object.triggerAxioms $Heap@@79 |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#3@@0|))) (_module.Object.triggerAxioms $Heap@@79 |o#3@@0|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |2984|
 :pattern ( (_module.Object.triggerAxioms $Heap@@79 |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 27)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#4|))) (_module.Object.inv $Heap@@79 |o#4|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |2987|
 :pattern ( (_module.Object.inv $Heap@@79 |o#4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#4|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#4@@0|))) (_module.Object.inv $Heap@@79 |o#4@@0|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |2987|
 :pattern ( (_module.Object.inv $Heap@@79 |o#4@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@127) (or (_module.Object.baseInv current$Heap this@@127) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType this@@127))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@127) (or (_module.Object.baseInv current$Heap this@@127) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType this@@127)))))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@127) (or (_module.Object.baseInv current$Heap this@@127) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#5|))) (and (= (_module.Object.universe |o#5|) (_module.Object.universe this@@127)) (or (not (= |o#5| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |2989|
 :pattern ( (_module.Object.universe |o#5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#5|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@127) (or (_module.Object.baseInv current$Heap this@@127) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#5@@0|))) (and (= (_module.Object.universe |o#5@@0|) (_module.Object.universe this@@127)) (or (not (= |o#5@@0| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |2989|
 :pattern ( (_module.Object.universe |o#5@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#5@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@127) (or (_module.Object.baseInv current$Heap this@@127) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#6|))) (_module.Object.triggerAxioms current$Heap |o#6|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |2990|
 :pattern ( (_module.Object.triggerAxioms current$Heap |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#6|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@127) (or (_module.Object.baseInv current$Heap this@@127) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#6@@0|))) (_module.Object.triggerAxioms current$Heap |o#6@@0|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |2990|
 :pattern ( (_module.Object.triggerAxioms current$Heap |o#6@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#6@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (forall (($o@@97 T@U) ($f@@57 T@U) ) (!  (=> (or (not (= $o@@97 null)) (not true)) (=> (= $o@@97 this@@127) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@97) $f@@57) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 $o@@97) $f@@57))))
 :qid |_09CounterNoStateMachinedfy.259:8|
 :skolemid |2993|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@97) $f@@57))
))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (forall (($o@@98 T@U) ($f@@58 T@U) ) (!  (=> (or (not (= $o@@98 null)) (not true)) (=> (= $o@@98 this@@127) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@98) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 $o@@98) $f@@58))))
 :qid |_09CounterNoStateMachinedfy.259:8|
 :skolemid |2993|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@98) $f@@58))
)))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127)) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#7|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#7|)))) (not ($IsAllocBox ($Box refType |o#7|) Tclass._module.Object $Heap@@79)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |2994|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#7|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#7|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127)) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#7@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#7@@0|)))) (not ($IsAllocBox ($Box refType |o#7@@0|) Tclass._module.Object $Heap@@79)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |2994|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#7@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#7@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127)) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#8|))) (or (forall (($o@@99 T@U) ($f@@59 T@U) ) (!  (=> (or (not (= $o@@99 null)) (not true)) (=> (= $o@@99 |o#8|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@99) $f@@59) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 $o@@99) $f@@59))))
 :qid |_09CounterNoStateMachinedfy.60:54|
 :skolemid |2995|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@99) $f@@59))
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#8|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#8|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.60:16|
 :skolemid |2996|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#8|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#8|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127)) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#8@@0|))) (or (forall (($o@@100 T@U) ($f@@60 T@U) ) (!  (=> (or (not (= $o@@100 null)) (not true)) (=> (= $o@@100 |o#8@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@100) $f@@60) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 $o@@100) $f@@60))))
 :qid |_09CounterNoStateMachinedfy.60:54|
 :skolemid |2995|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@100) $f@@60))
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#8@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#8@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.60:16|
 :skolemid |2996|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#8@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#8@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#9|))) (and (= (_module.Object.universe |o#9|) (_module.Object.universe this@@127)) (or (not (= |o#9| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3000|
 :pattern ( (_module.Object.universe |o#9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#9|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#9@@0| T@U) ) (!  (=> (and ($Is refType |o#9@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#9@@0|))) (and (= (_module.Object.universe |o#9@@0|) (_module.Object.universe this@@127)) (or (not (= |o#9@@0| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3000|
 :pattern ( (_module.Object.universe |o#9@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#9@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.triggerAxioms $Heap@@79 |o#10|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |3001|
 :pattern ( (_module.Object.triggerAxioms $Heap@@79 |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#10|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.triggerAxioms $Heap@@79 |o#10@@0|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |3001|
 :pattern ( (_module.Object.triggerAxioms $Heap@@79 |o#10@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#10@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#11|))) (and (= (_module.Object.universe |o#11|) (_module.Object.universe this@@127)) (or (not (= |o#11| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3004|
 :pattern ( (_module.Object.universe |o#11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#11|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#11@@0| T@U) ) (!  (=> (and ($Is refType |o#11@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#11@@0|))) (and (= (_module.Object.universe |o#11@@0|) (_module.Object.universe this@@127)) (or (not (= |o#11@@0| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3004|
 :pattern ( (_module.Object.universe |o#11@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#11@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#12|))) (_module.Object.triggerAxioms current$Heap |o#12|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |3005|
 :pattern ( (_module.Object.triggerAxioms current$Heap |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#12|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#12@@0| T@U) ) (!  (=> (and ($Is refType |o#12@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#12@@0|))) (_module.Object.triggerAxioms current$Heap |o#12@@0|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |3005|
 :pattern ( (_module.Object.triggerAxioms current$Heap |o#12@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#12@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#13|))) (_module.Object.transitiveInv2 $Heap@@79 current$Heap |o#13|))
 :qid |_09CounterNoStateMachinedfy.74:16|
 :skolemid |3008|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@79 current$Heap |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#13|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#13@@0| T@U) ) (!  (=> (and ($Is refType |o#13@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#13@@0|))) (_module.Object.transitiveInv2 $Heap@@79 current$Heap |o#13@@0|))
 :qid |_09CounterNoStateMachinedfy.74:16|
 :skolemid |3008|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@79 current$Heap |o#13@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#13@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#14|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@79)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#14|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.77:16|
 :skolemid |3009|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#14|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@79 current$Heap (_module.Object.universe this@@127) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#14@@0| T@U) ) (!  (=> (and ($Is refType |o#14@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#14@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14@@0|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@79)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#14@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.77:16|
 :skolemid |3009|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 |o#14@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#14@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#15| T@U) ) (!  (=> (and ($Is refType |o#15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#15|))) (and (= (_module.Object.universe |o#15|) (_module.Object.universe this@@127)) (or (not (= |o#15| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3012|
 :pattern ( (_module.Object.universe |o#15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#15|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#15@@0| T@U) ) (!  (=> (and ($Is refType |o#15@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#15@@0|))) (and (= (_module.Object.universe |o#15@@0|) (_module.Object.universe this@@127)) (or (not (= |o#15@@0| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3012|
 :pattern ( (_module.Object.universe |o#15@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#15@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#16|))) (_module.Object.triggerAxioms $Heap@@79 |o#16|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |3013|
 :pattern ( (_module.Object.triggerAxioms $Heap@@79 |o#16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#16|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#16@@0|))) (_module.Object.triggerAxioms $Heap@@79 |o#16@@0|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |3013|
 :pattern ( (_module.Object.triggerAxioms $Heap@@79 |o#16@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#16@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#17| T@U) ) (!  (=> (and ($Is refType |o#17| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#17|))) (_module.Object.inv $Heap@@79 |o#17|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |3016|
 :pattern ( (_module.Object.inv $Heap@@79 |o#17|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#17|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@79 (_module.Object.universe this@@127)) (or (_module.Universe.globalInv $Heap@@79 (_module.Object.universe this@@127)) (forall ((|o#17@@0| T@U) ) (!  (=> (and ($Is refType |o#17@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#17@@0|))) (_module.Object.inv $Heap@@79 |o#17@@0|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |3016|
 :pattern ( (_module.Object.inv $Heap@@79 |o#17@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#17@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#18| T@U) ) (!  (=> (and ($Is refType |o#18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#18|))) (and (= (_module.Object.universe |o#18|) (_module.Object.universe this@@127)) (or (not (= |o#18| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3018|
 :pattern ( (_module.Object.universe |o#18|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#18|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#18@@0| T@U) ) (!  (=> (and ($Is refType |o#18@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#18@@0|))) (and (= (_module.Object.universe |o#18@@0|) (_module.Object.universe this@@127)) (or (not (= |o#18@@0| (_module.Object.universe this@@127))) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3018|
 :pattern ( (_module.Object.universe |o#18@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#18@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#19| T@U) ) (!  (=> (and ($Is refType |o#19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#19|))) (_module.Object.triggerAxioms current$Heap |o#19|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |3019|
 :pattern ( (_module.Object.triggerAxioms current$Heap |o#19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#19|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@127)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@127)) (forall ((|o#19@@0| T@U) ) (!  (=> (and ($Is refType |o#19@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#19@@0|))) (_module.Object.triggerAxioms current$Heap |o#19@@0|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |3019|
 :pattern ( (_module.Object.triggerAxioms current$Heap |o#19@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#19@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (forall ((|o#20| T@U) ) (!  (=> (and ($Is refType |o#20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#20|))) (and (or (forall (($o@@101 T@U) ($f@@61 T@U) ) (!  (=> (or (not (= $o@@101 null)) (not true)) (=> (= $o@@101 |o#20|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@101) $f@@61) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 $o@@101) $f@@61))))
 :qid |_09CounterNoStateMachinedfy.91:49|
 :skolemid |3022|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@101) $f@@61))
)) (_module.Object.inv current$Heap |o#20|)) (or (forall (($o@@102 T@U) ($f@@62 T@U) ) (!  (=> (or (not (= $o@@102 null)) (not true)) (=> (= $o@@102 |o#20|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@102) $f@@62) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 $o@@102) $f@@62))))
 :qid |_09CounterNoStateMachinedfy.91:49|
 :skolemid |3023|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@102) $f@@62))
)) (_module.Object.inv2 $Heap@@79 current$Heap |o#20|))))
 :qid |_09CounterNoStateMachinedfy.91:16|
 :skolemid |3024|
 :pattern ( (_module.Object.inv2 $Heap@@79 current$Heap |o#20|))
 :pattern ( (_module.Object.inv current$Heap |o#20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#20|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (forall ((|o#20@@0| T@U) ) (!  (=> (and ($Is refType |o#20@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#20@@0|))) (and (or (forall (($o@@103 T@U) ($f@@63 T@U) ) (!  (=> (or (not (= $o@@103 null)) (not true)) (=> (= $o@@103 |o#20@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@103) $f@@63) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 $o@@103) $f@@63))))
 :qid |_09CounterNoStateMachinedfy.91:49|
 :skolemid |3022|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@103) $f@@63))
)) (_module.Object.inv current$Heap |o#20@@0|)) (or (forall (($o@@104 T@U) ($f@@64 T@U) ) (!  (=> (or (not (= $o@@104 null)) (not true)) (=> (= $o@@104 |o#20@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@104) $f@@64) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 $o@@104) $f@@64))))
 :qid |_09CounterNoStateMachinedfy.91:49|
 :skolemid |3023|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@104) $f@@64))
)) (_module.Object.inv2 $Heap@@79 current$Heap |o#20@@0|))))
 :qid |_09CounterNoStateMachinedfy.91:16|
 :skolemid |3024|
 :pattern ( (_module.Object.inv2 $Heap@@79 current$Heap |o#20@@0|))
 :pattern ( (_module.Object.inv current$Heap |o#20@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#20@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (forall ((|o#21| T@U) ) (!  (=> (and ($Is refType |o#21| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#21|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#21|))))) (_module.Object.inv current$Heap |o#21|))
 :qid |_09CounterNoStateMachinedfy.93:16|
 :skolemid |3025|
 :pattern ( (_module.Object.inv current$Heap |o#21|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#21|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#21|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@79 current$Heap this@@127 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@79 current$Heap this@@127 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@79 current$Heap (_module.Object.universe this@@127) |running#0@@5|) (forall ((|o#21@@0| T@U) ) (!  (=> (and ($Is refType |o#21@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#21@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#21@@0|))))) (_module.Object.inv current$Heap |o#21@@0|))
 :qid |_09CounterNoStateMachinedfy.93:16|
 :skolemid |3025|
 :pattern ( (_module.Object.inv current$Heap |o#21@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#21@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@127)) _module.Universe.content)) ($Box refType |o#21@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true)))) (=> (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@105 T@U) ($f@@65 T@U) ) (! true
 :qid |_09CounterNoStateMachinedfy.655:18|
 :skolemid |3031|
))) (=> (forall (($o@@106 T@U) ($f@@66 T@U) ) (! true
 :qid |_09CounterNoStateMachinedfy.655:18|
 :skolemid |3031|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@107 T@U) ($f@@67 T@U) ) (! true
 :qid |_09CounterNoStateMachinedfy.655:18|
 :skolemid |3032|
))) (=> (forall (($o@@108 T@U) ($f@@68 T@U) ) (! true
 :qid |_09CounterNoStateMachinedfy.655:18|
 :skolemid |3032|
)) (=> (and (_module.OwnedObject.inv2 $Heap@@79 current$Heap this@@127) (_module.OwnedObject.inv current$Heap this@@127)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Object.inv2 $Heap@@79 current$Heap this@@127)) (=> (_module.Object.inv2 $Heap@@79 current$Heap this@@127) (=> (= (ControlFlow 0 2) (- 0 1)) (_module.Object.inv current$Heap this@@127))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@79) ($IsHeapAnchor $Heap@@79)) (and (or (not (= this@@127 null)) (not true)) (and ($Is refType this@@127 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@127 Tclass._module.ClaimIncreasingCounterGreaterThanConstant previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 10 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@79) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 33) 2)))) anon0_correct))))
