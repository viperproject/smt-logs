...
(assert (distinct alloc Tagclass._module.Object Tagclass._module.OwnedObject Tagclass._module.Object? Tagclass._module.OwnedObject? Tagclass._module.OwnedU32? Tagclass._module.OwnedU32 tytagFamily$Object tytagFamily$OwnedObject tytagFamily$OwnedU32)
)
...
(assert (forall (($o@@2 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.OwnedU32? $h@@4)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2360|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.OwnedU32? $h@@4))
)))
...
(assert (forall (($o@@5 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@5 Tclass._module.OwnedU32? $heap@@0) ($IsAlloc refType $o@@5 Tclass._module.OwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |3504|
 :pattern ( ($IsAlloc refType $o@@5 Tclass._module.OwnedU32? $heap@@0))
)))
...
(assert (forall (($o@@7 T@U) ) (!  (=> ($Is refType $o@@7 Tclass._module.OwnedU32?) ($Is refType $o@@7 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3503|
...
(set-info :boogie-vc-id OverrideCheck$$_module.OwnedU32.localUserInv2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (and (= OwnedU32_$_ReadsFrame@0 (|lambda#59| null current$Heap alloc current$Heap alloc)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@10) alloc))))
 :qid |_12MutexLifetimeshortdfy.646:22|
 :skolemid |2406|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.OwnedU32) ($IsAlloc refType this Tclass._module.OwnedU32 current$Heap@@0))) (= 0 $FunctionContextHeight)) (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap@@0) ($IsGoodHeap current$Heap@@0))) (= (ControlFlow 0 4) 2))) anon0_correct))))
