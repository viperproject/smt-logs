...
(set-info :boogie-vc-id Impl$$_module.__default.BuildBAux)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (|_module.__default.B_h#canCall| |k#0| |x#0@@9|) (or (_module.__default.B_h ($LS $LZ) |k#0| |x#0@@9|) (=> (< 0 (|ORD#Offset| |k#0|)) (_module.__default.A_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) |x#0@@9|))))) (=> (=> (|_module.__default.B_h#canCall| |k#0| |x#0@@9|) (or (_module.__default.B_h ($LS $LZ) |k#0| |x#0@@9|) (=> (< 0 (|ORD#Offset| |k#0|)) (_module.__default.A_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) |x#0@@9|)))) (=> (= (ControlFlow 0 4) (- 0 3)) (=> (|_module.__default.B_h#canCall| |k#0| |x#0@@9|) (or (_module.__default.B_h ($LS $LZ) |k#0| |x#0@@9|) (=> (= (LitInt 0) (|ORD#Offset| |k#0|)) (forall ((|_k'#1@@3| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@3| |k#0|) (_module.__default.B_h ($LS ($LS $LZ)) |_k'#1@@3| |x#0@@9|))
 :qid |_04LeastGreatestdfy.49:20|
 :skolemid |687|
 :pattern ( (_module.__default.B_h ($LS ($LS $LZ)) |_k'#1@@3| |x#0@@9|))
))))))))))
(let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|j#0_1| T@U) ) (!  (=> (|ORD#Less| |j#0_1| |k#0|) (_module.__default.A_h ($LS $LZ) |j#0_1| |x#0@@9|))
 :qid |_04LeastGreatestdfy.62:10|
 :skolemid |692|
 :pattern ( (_module.__default.A_h ($LS $LZ) |j#0_1| |x#0@@9|))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#k0#0| T@U) (|$ih#x0#0| T@U) ) (!  (=> (and (and ($Is refType |$ih#x0#0| Tclass._module.Object) (U_2_bool (Lit boolType (bool_2_U true)))) (or (|ORD#Less| |$ih#k0#0| |k#0|) (and (= |$ih#k0#0| |k#0|) (and (= |$ih#x0#0| null) (or (not (= |x#0@@9| null)) (not true)))))) (_module.__default.B_h ($LS $LZ) |$ih#k0#0| |$ih#x0#0|))
 :qid |_04LeastGreatestdfy.61:17|
 :skolemid |690|
 :pattern ( (_module.__default.B_h ($LS $LZ) |$ih#k0#0| |$ih#x0#0|))
