...
(declare-fun |lambda#164| (T@U T@U T@U T@U T@U T@U T@U T@U T@U) T@U)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|$y#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#13| |l#0| |l#1| |l#2|) |$y#1|))  (and ($IsBox |$y#1| |l#0|) (and (|Set#IsMember| |l#1| |$y#1|) (or (not (= ($Unbox refType |$y#1|) |l#2|)) (not true)))))
 :qid |_07CounterThreadOwnershipdfy.280:7|
 :skolemid |3543|
 :pattern ( (MapType0Select BoxType boolType (|lambda#13| |l#0| |l#1| |l#2|) |$y#1|))
)))
...
(assert (forall (($h@@26 T@U) ($o@@52 T@U) ) (!  (=> (and ($IsGoodHeap $h@@26) (and (or (not (= $o@@52 null)) (not true)) (= (dtype $o@@52) Tclass._module.IncrementerMethod?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@52) _module.IncrementerMethod.counter)) Tclass._module.AtomicCounter))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2126|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@52) _module.IncrementerMethod.counter)))
)))
(assert (forall (($h@@27 T@U) ($o@@53 T@U) ) (!  (=> (and ($IsGoodHeap $h@@27) (and (or (not (= $o@@53 null)) (not true)) (= (dtype $o@@53) Tclass._module.IncrementerMethod?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@53) _module.IncrementerMethod.remaining)) Tclass._module.Remaining))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2128|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@53) _module.IncrementerMethod.remaining)))
)))
...
(assert (forall ((bx@@18 T@U) ) (!  (=> ($IsBox bx@@18 Tclass._module.Remaining) (and (= ($Box refType ($Unbox refType bx@@18)) bx@@18) ($Is refType ($Unbox refType bx@@18) Tclass._module.Remaining)))
 :qid |unknown.0:0|
 :skolemid |1889|
 :pattern ( ($IsBox bx@@18 Tclass._module.Remaining))
)))
...
(assert (forall ((bx@@20 T@U) ) (!  (=> ($IsBox bx@@20 Tclass._module.IncrementerMethod) (and (= ($Box refType ($Unbox refType bx@@20)) bx@@20) ($Is refType ($Unbox refType bx@@20) Tclass._module.IncrementerMethod)))
 :qid |unknown.0:0|
 :skolemid |2137|
 :pattern ( ($IsBox bx@@20 Tclass._module.IncrementerMethod))
)))
...
(assert (forall (($h@@28 T@U) ($o@@54 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@28) (and (or (not (= $o@@54 null)) (not true)) (= (dtype $o@@54) Tclass._module.IncrementerMethod?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@54) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@54) _module.IncrementerMethod.counter)) Tclass._module.AtomicCounter $h@@28))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2127|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@54) _module.IncrementerMethod.counter)))
)))
(assert (forall (($h@@29 T@U) ($o@@55 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@55 null)) (not true)) (= (dtype $o@@55) Tclass._module.IncrementerMethod?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@55) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@55) _module.IncrementerMethod.remaining)) Tclass._module.Remaining $h@@29))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2129|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@55) _module.IncrementerMethod.remaining)))
)))
...
(assert (forall (($o@@56 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@56 Tclass._module.Thread? $heap) ($IsAlloc refType $o@@56 Tclass._module.Object? $heap))
 :qid |unknown.0:0|
 :skolemid |3519|
 :pattern ( ($IsAlloc refType $o@@56 Tclass._module.Thread? $heap))
)))
(assert (forall (($o@@57 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@57 Tclass._module.OwnedObject? $heap@@0) ($IsAlloc refType $o@@57 Tclass._module.Object? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |3523|
 :pattern ( ($IsAlloc refType $o@@57 Tclass._module.OwnedObject? $heap@@0))
)))
(assert (forall (($o@@58 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@58 Tclass._module.AtomicCounter? $heap@@1) ($IsAlloc refType $o@@58 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |3531|
 :pattern ( ($IsAlloc refType $o@@58 Tclass._module.AtomicCounter? $heap@@1))
)))
(assert (forall (($o@@59 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@59 Tclass._module.Remaining? $heap@@2) ($IsAlloc refType $o@@59 Tclass._module.OwnedObject? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |3535|
 :pattern ( ($IsAlloc refType $o@@59 Tclass._module.Remaining? $heap@@2))
)))
(assert (forall (($o@@60 T@U) ($heap@@3 T@U) ) (!  (=> ($IsAlloc refType $o@@60 Tclass._module.IncrementerMethod? $heap@@3) ($IsAlloc refType $o@@60 Tclass._module.OwnedObject? $heap@@3))
 :qid |unknown.0:0|
 :skolemid |3539|
 :pattern ( ($IsAlloc refType $o@@60 Tclass._module.IncrementerMethod? $heap@@3))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) ($o@@61 T@U) ($f@@32 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#164| |l#0@@0| |l#1@@0| |l#2@@0| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8|) $o@@61 $f@@32))  (=> (and (or (not (= $o@@61 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@61) |l#2@@0|)))) (or (or (or (or (or (= $o@@61 |l#3|) (|Set#IsMember| |l#4| ($Box refType $o@@61))) (= $o@@61 |l#5|)) (= $o@@61 |l#6|)) (= $o@@61 |l#7|)) (= $o@@61 |l#8|))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3546|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#164| |l#0@@0| |l#1@@0| |l#2@@0| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8|) $o@@61 $f@@32))
)))
...
(assert (forall ((v@@3 T@U) (t0@@2 T@U) (h@@3 T@U) ) (! (= ($IsAlloc SetType v@@3 (TSet t0@@2) h@@3) (forall ((bx@@22 T@U) ) (!  (=> (|Set#IsMember| v@@3 bx@@22) ($IsAllocBox bx@@22 t0@@2 h@@3))
...
(assert (forall ((bx@@24 T@U) ) (!  (=> ($IsBox bx@@24 Tclass._module.Thread?) ($IsBox bx@@24 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |3516|
 :pattern ( ($IsBox bx@@24 Tclass._module.Thread?))
)))
...
(assert (forall ((bx@@26 T@U) ) (!  (=> ($IsBox bx@@26 Tclass._module.AtomicCounter?) ($IsBox bx@@26 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3528|
 :pattern ( ($IsBox bx@@26 Tclass._module.AtomicCounter?))
)))
...
(assert (forall ((bx@@27 T@U) ) (!  (=> ($IsBox bx@@27 Tclass._module.Remaining?) ($IsBox bx@@27 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3532|
 :pattern ( ($IsBox bx@@27 Tclass._module.Remaining?))
)))
...
(assert (forall ((bx@@28 T@U) ) (!  (=> ($IsBox bx@@28 Tclass._module.IncrementerMethod?) ($IsBox bx@@28 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3536|
 :pattern ( ($IsBox bx@@28 Tclass._module.IncrementerMethod?))
)))
...
(declare-fun call0formal@this@0@@1 () T@U)
(declare-fun $Heap@2 () T@U)
(declare-fun $Heap@3 () T@U)
(declare-fun call0formal@this@0@@2 () T@U)
(set-info :boogie-vc-id Impl$$_module.IncrementerMethod.Run)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 108) (let ((anon9_correct  (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (=> (and (and (and (_module.Object.objectGlobalInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9)))) (and (=> (= (ControlFlow 0 50) (- 0 51)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (and ($IsAllocBox ($Box refType (_module.Object.universe this@@126)) Tclass._module.Universe? $Heap@5) (= (ControlFlow 0 50) (- 0 49))) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@4)))))))
(let ((anon18_Else_correct  (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (ControlFlow 0 54) 50)) anon9_correct)))
(let ((anon18_Then_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2))) (not true)) (= (ControlFlow 0 53) 50)) anon9_correct)))
(let ((anon17_Then_correct  (=> (and (and (_module.Object.objectGlobalInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (and (=> (= (ControlFlow 0 55) 53) anon18_Then_correct) (=> (= (ControlFlow 0 55) 54) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and (and (_module.Object.objectGlobalInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.OwnedObject.owner)) |running#0@@3|))) (= (ControlFlow 0 52) 50)) anon9_correct)))
(let ((anon16_Else_correct  (=> (not (and (_module.Object.objectGlobalInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (=> (= (ControlFlow 0 57) 55) anon17_Then_correct) (=> (= (ControlFlow 0 57) 52) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (_module.Object.objectGlobalInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (and (=> (= (ControlFlow 0 56) 55) anon17_Then_correct) (=> (= (ControlFlow 0 56) 52) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (not (_module.Object.objectGlobalInv $Heap@5 this@@126)) (and (=> (= (ControlFlow 0 60) 56) anon16_Then_correct) (=> (= (ControlFlow 0 60) 57) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (_module.Object.objectGlobalInv $Heap@5 this@@126) (and (=> (= (ControlFlow 0 58) (- 0 59)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (and (=> (= (ControlFlow 0 58) 56) anon16_Then_correct) (=> (= (ControlFlow 0 58) 57) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> (not |$w$loop#0@0|) (=> (and ($IsAllocBox ($Box refType this@@126) Tclass._module.Object? $Heap@5) (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126)) (and (=> (= (ControlFlow 0 61) 58) anon15_Then_correct) (=> (= (ControlFlow 0 61) 60) anon15_Else_correct))))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 22) (- 0 26)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@10 this@@126) (or (_module.Object.objectGlobalInv $Heap@10 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@10 this@@126) (or (_module.Object.baseInv $Heap@10 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@10 this@@126) (or (_module.Object.objectGlobalInv $Heap@10 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@10 this@@126) (or (_module.Object.baseInv $Heap@10 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))) (and (=> (= (ControlFlow 0 22) (- 0 25)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@10 this@@126) (or (_module.Object.objectGlobalInv $Heap@10 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@10 this@@126) (or (_module.Object.baseInv $Heap@10 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@10 (_module.Object.universe this@@126)) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#9|))) (and (= (_module.Object.universe |o#9|) (_module.Object.universe this@@126)) (or (not (= |o#9| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2390|
 :pattern ( (_module.Object.universe |o#9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#9|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@10 this@@126) (or (_module.Object.objectGlobalInv $Heap@10 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@10 this@@126) (or (_module.Object.baseInv $Heap@10 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@10 (_module.Object.universe this@@126)) (forall ((|o#9@@0| T@U) ) (!  (=> (and ($Is refType |o#9@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#9@@0|))) (and (= (_module.Object.universe |o#9@@0|) (_module.Object.universe this@@126)) (or (not (= |o#9@@0| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2390|
 :pattern ( (_module.Object.universe |o#9@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#9@@0|)))
)))))))) (and (=> (= (ControlFlow 0 22) (- 0 24)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@10 this@@126) (or (_module.Object.objectGlobalInv $Heap@10 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@10 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@10 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@10 (_module.Object.universe this@@126)) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#10|))) (and (= (_module.Object.universe |o#10|) (_module.Object.universe this@@126)) (or (not (= |o#10| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2392|
 :pattern ( (_module.Object.universe |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#10|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@10 this@@126) (or (_module.Object.objectGlobalInv $Heap@10 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@10 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@10 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@10 (_module.Object.universe this@@126)) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#10@@0|))) (and (= (_module.Object.universe |o#10@@0|) (_module.Object.universe this@@126)) (or (not (= |o#10@@0| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2392|
 :pattern ( (_module.Object.universe |o#10@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#10@@0|)))
)))))))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@10 this@@126) (or (_module.Object.objectGlobalInv $Heap@10 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@10 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@10 (_module.Object.universe this@@126)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#11|))) (_module.Object.inv $Heap@10 |o#11|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2394|
 :pattern ( (_module.Object.inv $Heap@10 |o#11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#11|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@10 this@@126) (or (_module.Object.objectGlobalInv $Heap@10 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@10 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@10 (_module.Object.universe this@@126)) (forall ((|o#11@@0| T@U) ) (!  (=> (and ($Is refType |o#11@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#11@@0|))) (_module.Object.inv $Heap@10 |o#11@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2394|
 :pattern ( (_module.Object.inv $Heap@10 |o#11@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#11@@0|)))
)))))) (=> (= (ControlFlow 0 22) (- 0 21)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10)))))))))))))
(let ((anon19_Then_correct  (=> (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2))) (not true)) (and (=> (= (ControlFlow 0 27) (- 0 47)) (forall (($o@@103 T@U) ($f@@55 T@U) ) (!  (=> (and (and (or (not (= $o@@103 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@103) alloc)))) (= $o@@103 this@@126)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@103 $f@@55)))
 :qid |_07CounterThreadOwnershipdfy.761:15|
 :skolemid |2416|
))) (=> (forall (($o@@104 T@U) ($f@@56 T@U) ) (!  (=> (and (and (or (not (= $o@@104 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@104) alloc)))) (= $o@@104 this@@126)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@104 $f@@56)))
 :qid |_07CounterThreadOwnershipdfy.761:15|
 :skolemid |2416|
)) (and (=> (= (ControlFlow 0 27) (- 0 46)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))) (and (=> (= (ControlFlow 0 27) (- 0 45)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#0@@12| T@U) ) (!  (=> (and ($Is refType |o#0@@12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@12|))) (and (= (_module.Object.universe |o#0@@12|) (_module.Object.universe this@@126)) (or (not (= |o#0@@12| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3326|
 :pattern ( (_module.Object.universe |o#0@@12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@12|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@13|))) (and (= (_module.Object.universe |o#0@@13|) (_module.Object.universe this@@126)) (or (not (= |o#0@@13| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3326|
 :pattern ( (_module.Object.universe |o#0@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@13|)))
)))))))) (and (=> (= (ControlFlow 0 27) (- 0 44)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@3|))) (and (= (_module.Object.universe |o#1@@3|) (_module.Object.universe this@@126)) (or (not (= |o#1@@3| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3328|
 :pattern ( (_module.Object.universe |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@3|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@4|))) (and (= (_module.Object.universe |o#1@@4|) (_module.Object.universe this@@126)) (or (not (= |o#1@@4| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3328|
 :pattern ( (_module.Object.universe |o#1@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@4|)))
)))))))) (and (=> (= (ControlFlow 0 27) (- 0 43)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2|))) (_module.Object.inv $Heap@5 |o#2|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |3330|
 :pattern ( (_module.Object.inv $Heap@5 |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@0|))) (_module.Object.inv $Heap@5 |o#2@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |3330|
 :pattern ( (_module.Object.inv $Heap@5 |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))) (and (=> (= (ControlFlow 0 27) (- 0 42)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (and (=> (= (ControlFlow 0 27) (- 0 41)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (and (=> (= (ControlFlow 0 27) (- 0 40)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9)) (=> (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (=> (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@6 this@@126) (=> (_module.Object.objectGlobalInv $Heap@6 this@@126) (|_module.Universe.globalInv2#canCall| $Heap@5 $Heap@6 (_module.Object.universe this@@126)))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@6 this@@126) (and (_module.Object.objectGlobalInv $Heap@6 this@@126) (and (_module.Object.baseInv $Heap@6 this@@126) (_module.Universe.globalInv $Heap@6 (_module.Object.universe this@@126)))))) (=> (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@5 $Heap@6 (_module.Object.universe this@@126)) (and (_module.Universe.globalInv2 $Heap@5 $Heap@6 (_module.Object.universe this@@126)) (and (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6|)) (_module.Object.inv2 $Heap@5 $Heap@6 |o#6|)))
 :qid |_07CounterThreadOwnershipdfy.44:16|
 :skolemid |3343|
 :pattern ( (_module.Object.inv2 $Heap@5 $Heap@6 |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6|)))
)) (_module.Universe.baseLegalTransitionsSequence $Heap@5 $Heap@6 (_module.Object.universe this@@126))))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10)) (|_module.Universe.legalTransition#canCall| $Heap@5 $Heap@6 (_module.Object.universe this@@126) |running#0@@3|))) (and (and (|_module.Universe.legalTransition#canCall| $Heap@5 $Heap@6 (_module.Object.universe this@@126) |running#0@@3|) (and (_module.Universe.legalTransition $Heap@5 $Heap@6 (_module.Object.universe this@@126) |running#0@@3|) (and (and (and (and (_module.Universe.legalTransitionsSequence $Heap@5 $Heap@6 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126))) (_module.Universe.globalBaseInv $Heap@6 (_module.Object.universe this@@126))) (forall ((|o#18| T@U) ) (!  (=> (and ($Is refType |o#18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#18|))) (and (or (forall (($o@@105 T@U) ($f@@57 T@U) ) (!  (=> (or (not (= $o@@105 null)) (not true)) (=> (= $o@@105 |o#18|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@105) $f@@57) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@105) $f@@57))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |3366|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@105) $f@@57))
)) (_module.Object.inv $Heap@6 |o#18|)) (or (forall (($o@@106 T@U) ($f@@58 T@U) ) (!  (=> (or (not (= $o@@106 null)) (not true)) (=> (= $o@@106 |o#18|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@106) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@106) $f@@58))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |3367|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@106) $f@@58))
)) (_module.Object.inv2 $Heap@5 $Heap@6 |o#18|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |3368|
 :pattern ( (_module.Object.inv2 $Heap@5 $Heap@6 |o#18|))
 :pattern ( (_module.Object.inv $Heap@6 |o#18|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#18|)))
))) (forall ((|o#19| T@U) ) (!  (=> (and ($Is refType |o#19| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19|))))) (_module.Object.inv $Heap@6 |o#19|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |3369|
 :pattern ( (_module.Object.inv $Heap@6 |o#19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19|)))
))))) (and (forall (($o@@107 T@U) ) (!  (=> (and (or (not (= $o@@107 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@107) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@107) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@107)) (= $o@@107 this@@126)))
 :qid |_07CounterThreadOwnershipdfy.923:10|
 :skolemid |3370|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@107))
)) ($HeapSucc $Heap@5 $Heap@6)))) (and (=> (= (ControlFlow 0 27) (- 0 39)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (and (=> (= (ControlFlow 0 27) (- 0 38)) (forall (($o@@108 T@U) ($f@@59 T@U) ) (!  (=> (and (and (or (not (= $o@@108 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@108) alloc)))) (or (= $o@@108 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@108)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@108 $f@@59)))
 :qid |_07CounterThreadOwnershipdfy.762:26|
 :skolemid |2417|
))) (=> (forall (($o@@109 T@U) ($f@@60 T@U) ) (!  (=> (and (and (or (not (= $o@@109 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@109) alloc)))) (or (= $o@@109 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@109)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@109 $f@@60)))
 :qid |_07CounterThreadOwnershipdfy.762:26|
 :skolemid |2417|
)) (=> (= call0formal@this@0 (_module.Object.universe this@@126)) (and (=> (= (ControlFlow 0 27) (- 0 37)) (=> (|_module.Universe.globalInv#canCall| $Heap@6 call0formal@this@0) (or (_module.Universe.globalInv $Heap@6 call0formal@this@0) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@6 call0formal@this@0) (or (_module.Universe.globalBaseInv $Heap@6 call0formal@this@0) (forall ((|o#0@@14| T@U) ) (!  (=> (and ($Is refType |o#0@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#0@@14|))) (and (= (_module.Object.universe |o#0@@14|) call0formal@this@0) (or (not (= |o#0@@14| call0formal@this@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |700|
 :pattern ( (_module.Object.universe |o#0@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#0@@14|)))
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@6 call0formal@this@0) (or (_module.Universe.globalInv $Heap@6 call0formal@this@0) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@6 call0formal@this@0) (or (_module.Universe.globalBaseInv $Heap@6 call0formal@this@0) (forall ((|o#0@@15| T@U) ) (!  (=> (and ($Is refType |o#0@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#0@@15|))) (and (= (_module.Object.universe |o#0@@15|) call0formal@this@0) (or (not (= |o#0@@15| call0formal@this@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |700|
 :pattern ( (_module.Object.universe |o#0@@15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#0@@15|)))
)))))) (and (=> (= (ControlFlow 0 27) (- 0 36)) (=> (|_module.Universe.globalInv#canCall| $Heap@6 call0formal@this@0) (or (_module.Universe.globalInv $Heap@6 call0formal@this@0) (forall ((|o#1@@5| T@U) ) (!  (=> (and ($Is refType |o#1@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#1@@5|))) (_module.Object.inv $Heap@6 |o#1@@5|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |702|
 :pattern ( (_module.Object.inv $Heap@6 |o#1@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#1@@5|)))
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@6 call0formal@this@0) (or (_module.Universe.globalInv $Heap@6 call0formal@this@0) (forall ((|o#1@@6| T@U) ) (!  (=> (and ($Is refType |o#1@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#1@@6|))) (_module.Object.inv $Heap@6 |o#1@@6|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |702|
 :pattern ( (_module.Object.inv $Heap@6 |o#1@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#1@@6|)))
)))) (and (=> (= (ControlFlow 0 27) (- 0 35)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |running#0@@3|)) (=> (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (|_module.Universe.globalInv#canCall| $Heap@7 call0formal@this@0)) (=> (and (and (and (|_module.Universe.globalInv#canCall| $Heap@7 call0formal@this@0) (and (_module.Universe.globalInv $Heap@7 call0formal@this@0) (and (_module.Universe.globalBaseInv $Heap@7 call0formal@this@0) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 call0formal@this@0) _module.Universe.content)) ($Box refType |o#3|))) (_module.Object.inv $Heap@7 |o#3|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |707|
 :pattern ( (_module.Object.inv $Heap@7 |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 call0formal@this@0) _module.Universe.content)) ($Box refType |o#3|)))
))))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@6 $Heap@7 call0formal@this@0 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) |running#0@@3|)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@6 $Heap@7 call0formal@this@0 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) |running#0@@3|))) (and (_module.Universe.legalTransitionsSequence $Heap@6 $Heap@7 call0formal@this@0 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) |running#0@@3|))) (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@6 $Heap@7 call0formal@this@0) (_module.Universe.globalBaseInv $Heap@6 call0formal@this@0)) (_module.Universe.globalBaseInv $Heap@7 call0formal@this@0)) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#8|))) (_module.Object.transitiveInv2 $Heap@6 $Heap@7 |o#8|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |718|
 :pattern ( (_module.Object.transitiveInv2 $Heap@6 $Heap@7 |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#8|)))
))) (forall ((|o#9@@1| T@U) ) (!  (=> (and ($Is refType |o#9@@1| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#9@@1|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |o#9@@1|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |o#9@@1|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |o#9@@1|) _module.OwnedObject.owner) Tclass._module.Object $Heap@6)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |o#9@@1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |o#9@@1|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |719|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |o#9@@1|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |o#9@@1|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |o#9@@1|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType |o#9@@1|)))
))))) (and (forall (($o@@110 T@U) ) (!  (=> (and (or (not (= $o@@110 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@110) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@110) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@110)) (or (= $o@@110 call0formal@this@0) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call0formal@this@0) _module.Universe.content)) ($Box refType $o@@110)))))
 :qid |_07CounterThreadOwnershipdfy.115:10|
 :skolemid |720|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@110))
)) ($HeapSucc $Heap@6 $Heap@7)))) (and (=> (= (ControlFlow 0 27) (- 0 34)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@7 this@@126) (or (_module.Object.objectGlobalInv $Heap@7 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@7 this@@126) (or (_module.Object.baseInv $Heap@7 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@7 this@@126) (or (_module.Object.objectGlobalInv $Heap@7 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@7 this@@126) (or (_module.Object.baseInv $Heap@7 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))) (and (=> (= (ControlFlow 0 27) (- 0 33)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@7 this@@126) (or (_module.Object.objectGlobalInv $Heap@7 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@7 this@@126) (or (_module.Object.baseInv $Heap@7 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@7 (_module.Object.universe this@@126)) (forall ((|o#0@@16| T@U) ) (!  (=> (and ($Is refType |o#0@@16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@16|))) (and (= (_module.Object.universe |o#0@@16|) (_module.Object.universe this@@126)) (or (not (= |o#0@@16| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3421|
 :pattern ( (_module.Object.universe |o#0@@16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@16|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@7 this@@126) (or (_module.Object.objectGlobalInv $Heap@7 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@7 this@@126) (or (_module.Object.baseInv $Heap@7 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@7 (_module.Object.universe this@@126)) (forall ((|o#0@@17| T@U) ) (!  (=> (and ($Is refType |o#0@@17| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@17|))) (and (= (_module.Object.universe |o#0@@17|) (_module.Object.universe this@@126)) (or (not (= |o#0@@17| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3421|
 :pattern ( (_module.Object.universe |o#0@@17|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@17|)))
)))))))) (and (=> (= (ControlFlow 0 27) (- 0 32)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@7 this@@126) (or (_module.Object.objectGlobalInv $Heap@7 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@7 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@7 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@7 (_module.Object.universe this@@126)) (forall ((|o#1@@7| T@U) ) (!  (=> (and ($Is refType |o#1@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@7|))) (and (= (_module.Object.universe |o#1@@7|) (_module.Object.universe this@@126)) (or (not (= |o#1@@7| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3423|
 :pattern ( (_module.Object.universe |o#1@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@7|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@7 this@@126) (or (_module.Object.objectGlobalInv $Heap@7 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@7 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@7 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@7 (_module.Object.universe this@@126)) (forall ((|o#1@@8| T@U) ) (!  (=> (and ($Is refType |o#1@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@8|))) (and (= (_module.Object.universe |o#1@@8|) (_module.Object.universe this@@126)) (or (not (= |o#1@@8| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3423|
 :pattern ( (_module.Object.universe |o#1@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@8|)))
)))))))) (and (=> (= (ControlFlow 0 27) (- 0 31)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@7 this@@126) (or (_module.Object.objectGlobalInv $Heap@7 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@7 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@7 (_module.Object.universe this@@126)) (forall ((|o#2@@1| T@U) ) (!  (=> (and ($Is refType |o#2@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@1|))) (_module.Object.inv $Heap@7 |o#2@@1|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |3425|
 :pattern ( (_module.Object.inv $Heap@7 |o#2@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@1|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@7 this@@126) (or (_module.Object.objectGlobalInv $Heap@7 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@7 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@7 (_module.Object.universe this@@126)) (forall ((|o#2@@2| T@U) ) (!  (=> (and ($Is refType |o#2@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@2|))) (_module.Object.inv $Heap@7 |o#2@@2|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |3425|
 :pattern ( (_module.Object.inv $Heap@7 |o#2@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@2|)))
)))))) (and (=> (= (ControlFlow 0 27) (- 0 30)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (and (=> (= (ControlFlow 0 27) (- 0 29)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (and (=> (= (ControlFlow 0 27) (- 0 28)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10)) (=> (and (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@126) (=> (_module.Object.objectGlobalInv $Heap@8 this@@126) (|_module.Universe.globalInv2#canCall| $Heap@7 $Heap@8 (_module.Object.universe this@@126))))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@126) (and (_module.Object.objectGlobalInv $Heap@8 this@@126) (and (_module.Object.baseInv $Heap@8 this@@126) (_module.Universe.globalInv $Heap@8 (_module.Object.universe this@@126))))) (and (|_module.Universe.globalInv2#canCall| $Heap@7 $Heap@8 (_module.Object.universe this@@126)) (and (_module.Universe.globalInv2 $Heap@7 $Heap@8 (_module.Object.universe this@@126)) (and (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@0|)) (_module.Object.inv2 $Heap@7 $Heap@8 |o#6@@0|)))
 :qid |_07CounterThreadOwnershipdfy.44:16|
 :skolemid |3438|
 :pattern ( (_module.Object.inv2 $Heap@7 $Heap@8 |o#6@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@0|)))
)) (_module.Universe.baseLegalTransitionsSequence $Heap@7 $Heap@8 (_module.Object.universe this@@126))))))) (and (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10)) (|_module.Universe.legalTransition#canCall| $Heap@7 $Heap@8 (_module.Object.universe this@@126) |running#0@@3|)) (and (|_module.Universe.legalTransition#canCall| $Heap@7 $Heap@8 (_module.Object.universe this@@126) |running#0@@3|) (and (_module.Universe.legalTransition $Heap@7 $Heap@8 (_module.Object.universe this@@126) |running#0@@3|) (and (and (and (and (_module.Universe.legalTransitionsSequence $Heap@7 $Heap@8 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@7 (_module.Object.universe this@@126))) (_module.Universe.globalBaseInv $Heap@8 (_module.Object.universe this@@126))) (forall ((|o#18@@0| T@U) ) (!  (=> (and ($Is refType |o#18@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#18@@0|))) (and (or (forall (($o@@111 T@U) ($f@@61 T@U) ) (!  (=> (or (not (= $o@@111 null)) (not true)) (=> (= $o@@111 |o#18@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@111) $f@@61) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@111) $f@@61))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |3461|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@111) $f@@61))
)) (_module.Object.inv $Heap@8 |o#18@@0|)) (or (forall (($o@@112 T@U) ($f@@62 T@U) ) (!  (=> (or (not (= $o@@112 null)) (not true)) (=> (= $o@@112 |o#18@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@112) $f@@62) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@112) $f@@62))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |3462|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@112) $f@@62))
)) (_module.Object.inv2 $Heap@7 $Heap@8 |o#18@@0|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |3463|
 :pattern ( (_module.Object.inv2 $Heap@7 $Heap@8 |o#18@@0|))
 :pattern ( (_module.Object.inv $Heap@8 |o#18@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#18@@0|)))
))) (forall ((|o#19@@0| T@U) ) (!  (=> (and ($Is refType |o#19@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@0|))))) (_module.Object.inv $Heap@8 |o#19@@0|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |3464|
 :pattern ( (_module.Object.inv $Heap@8 |o#19@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@0|)))
)))))) (and (and (forall (($o@@113 T@U) ) (!  (=> (and (or (not (= $o@@113 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@113) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@113) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@113)))
 :qid |_07CounterThreadOwnershipdfy.937:10|
 :skolemid |3465|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@113))
)) ($HeapSucc $Heap@7 $Heap@8)) (and (= $Heap@10 $Heap@8) (= (ControlFlow 0 27) 22))))) GeneratedUnifiedExit_correct))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon19_Else_correct  (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (and (=> (= (ControlFlow 0 3) (- 0 20)) (forall (($o@@114 T@U) ($f@@63 T@U) ) (!  (=> (and (and (or (not (= $o@@114 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@114) alloc)))) (or (or (or (or (or (= $o@@114 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@114))) (= $o@@114 |running#0@@3|)) (= $o@@114 this@@126)) (= $o@@114 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.counter)))) (= $o@@114 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.remaining))))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@114 $f@@63)))
 :qid |_07CounterThreadOwnershipdfy.758:18|
 :skolemid |2415|
))) (=> (forall (($o@@115 T@U) ($f@@64 T@U) ) (!  (=> (and (and (or (not (= $o@@115 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@115) alloc)))) (or (or (or (or (or (= $o@@115 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@115))) (= $o@@115 |running#0@@3|)) (= $o@@115 this@@126)) (= $o@@115 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.counter)))) (= $o@@115 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.remaining))))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@115 $f@@64)))
 :qid |_07CounterThreadOwnershipdfy.758:18|
 :skolemid |2415|
)) (and (=> (= (ControlFlow 0 3) (- 0 19)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))) (and (=> (= (ControlFlow 0 3) (- 0 18)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#0@@18| T@U) ) (!  (=> (and ($Is refType |o#0@@18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@18|))) (and (= (_module.Object.universe |o#0@@18|) (_module.Object.universe this@@126)) (or (not (= |o#0@@18| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2420|
 :pattern ( (_module.Object.universe |o#0@@18|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@18|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#0@@19| T@U) ) (!  (=> (and ($Is refType |o#0@@19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@19|))) (and (= (_module.Object.universe |o#0@@19|) (_module.Object.universe this@@126)) (or (not (= |o#0@@19| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2420|
 :pattern ( (_module.Object.universe |o#0@@19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@19|)))
)))))))) (and (=> (= (ControlFlow 0 3) (- 0 17)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#1@@9| T@U) ) (!  (=> (and ($Is refType |o#1@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@9|))) (and (= (_module.Object.universe |o#1@@9|) (_module.Object.universe this@@126)) (or (not (= |o#1@@9| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2422|
 :pattern ( (_module.Object.universe |o#1@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@9|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#1@@10| T@U) ) (!  (=> (and ($Is refType |o#1@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@10|))) (and (= (_module.Object.universe |o#1@@10|) (_module.Object.universe this@@126)) (or (not (= |o#1@@10| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2422|
 :pattern ( (_module.Object.universe |o#1@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@10|)))
)))))))) (and (=> (= (ControlFlow 0 3) (- 0 16)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#2@@3| T@U) ) (!  (=> (and ($Is refType |o#2@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@3|))) (_module.Object.inv $Heap@5 |o#2@@3|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2424|
 :pattern ( (_module.Object.inv $Heap@5 |o#2@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@3|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#2@@4| T@U) ) (!  (=> (and ($Is refType |o#2@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@4|))) (_module.Object.inv $Heap@5 |o#2@@4|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2424|
 :pattern ( (_module.Object.inv $Heap@5 |o#2@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@4|)))
)))))) (and (=> (= (ControlFlow 0 3) (- 0 15)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (and (=> (= (ControlFlow 0 3) (- 0 14)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (and (=> (= (ControlFlow 0 3) (- 0 13)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (=> (and (and (and (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126)) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (and (_module.Object.objectGlobalInv $Heap@9 this@@126) (and (_module.Object.baseInv $Heap@9 this@@126) (_module.Universe.globalInv $Heap@9 (_module.Object.universe this@@126))))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.OwnedObject.owner)) |running#0@@3|))) (and (and (and (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9))) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@5 $Heap@9 (_module.Object.universe this@@126))) (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@5 $Heap@9 (_module.Object.universe this@@126)) (and (_module.Universe.baseLegalTransitionsSequence $Heap@5 $Heap@9 (_module.Object.universe this@@126)) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content))) (forall ((|o#6@@1| T@U) ) (!  (=> (and ($Is refType |o#6@@1| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@1|)))) (not ($IsAllocBox ($Box refType |o#6@@1|) Tclass._module.Object $Heap@5)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2434|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@1|)))
))) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#7|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#7|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |o#7|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |2435|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |o#7|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#7|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#7|)))
)))))) (and (and (forall (($o@@116 T@U) ) (!  (=> (and (or (not (= $o@@116 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@116) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@116) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@116)) (or (or (or (or (or (= $o@@116 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@116))) (= $o@@116 |running#0@@3|)) (= $o@@116 this@@126)) (= $o@@116 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.counter)))) (= $o@@116 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.remaining))))))
 :qid |_07CounterThreadOwnershipdfy.767:10|
 :skolemid |2436|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@116))
)) ($HeapSucc $Heap@5 $Heap@9)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (=> (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (=> (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9))) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@9 (_module.Object.universe this@@126)))))))))) (and (=> (= (ControlFlow 0 3) (- 0 12)) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (or (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@9 this@@126) (or (_module.Object.baseInv $Heap@9 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (or (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@9 this@@126) (or (_module.Object.baseInv $Heap@9 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (and (=> (= (ControlFlow 0 3) (- 0 11)) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (or (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@9 this@@126) (or (_module.Object.baseInv $Heap@9 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12|))) (and (= (_module.Object.universe |o#12|) (_module.Object.universe this@@126)) (or (not (= |o#12| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2403|
 :pattern ( (_module.Object.universe |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12|)))
)))))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (or (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@9 this@@126) (or (_module.Object.baseInv $Heap@9 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#12@@0| T@U) ) (!  (=> (and ($Is refType |o#12@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12@@0|))) (and (= (_module.Object.universe |o#12@@0|) (_module.Object.universe this@@126)) (or (not (= |o#12@@0| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2403|
 :pattern ( (_module.Object.universe |o#12@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12@@0|)))
))))))))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (or (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@9 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13|))) (and (= (_module.Object.universe |o#13|) (_module.Object.universe this@@126)) (or (not (= |o#13| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2405|
 :pattern ( (_module.Object.universe |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13|)))
)))))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (or (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@9 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#13@@0| T@U) ) (!  (=> (and ($Is refType |o#13@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13@@0|))) (and (= (_module.Object.universe |o#13@@0|) (_module.Object.universe this@@126)) (or (not (= |o#13@@0| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2405|
 :pattern ( (_module.Object.universe |o#13@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13@@0|)))
))))))))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (or (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14|))) (_module.Object.inv $Heap@9 |o#14|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2407|
 :pattern ( (_module.Object.inv $Heap@9 |o#14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14|)))
)))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@9 this@@126) (or (_module.Object.objectGlobalInv $Heap@9 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#14@@0| T@U) ) (!  (=> (and ($Is refType |o#14@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14@@0|))) (_module.Object.inv $Heap@9 |o#14@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2407|
 :pattern ( (_module.Object.inv $Heap@9 |o#14@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14@@0|)))
))))))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (=> |$w$loop#0@0| (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)))) (=> (=> |$w$loop#0@0| (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.OwnedObject.owner)) |running#0@@3|))) (=> (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> |$w$loop#0@0| (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9))))) (=> (=> |$w$loop#0@0| (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#15| T@U) ) (!  (=> (and ($Is refType |o#15| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15|)))) (not ($IsAllocBox ($Box refType |o#15|) Tclass._module.Object $Heap@4)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2409|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15|)))
)))))) (=> (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#15@@0| T@U) ) (!  (=> (and ($Is refType |o#15@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@0|)))) (not ($IsAllocBox ($Box refType |o#15@@0|) Tclass._module.Object $Heap@4)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2409|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@0|)))
))))) (=> (= (ControlFlow 0 3) (- 0 2)) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@9 (_module.Object.universe this@@126)) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |o#16|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |2410|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |o#16|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16|)))
))))))))))))))))))))))))))))))))))))))))))))
(let ((anon14_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 48) 27) anon19_Then_correct) (=> (= (ControlFlow 0 48) 3) anon19_Else_correct)))))
(let ((anon13_LoopBody_correct  (and (=> (= (ControlFlow 0 62) 61) anon14_Then_correct) (=> (= (ControlFlow 0 62) 48) anon14_Else_correct))))
(let ((anon13_LoopDone_correct true))
(let ((anon13_LoopHead_correct  (=> (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (not false) (=> |$w$loop#0@0| (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126)))) (=> (and (and (and (and (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#12@@1| T@U) ) (!  (=> (and ($Is refType |o#12@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12@@1|))) (and (= (_module.Object.universe |o#12@@1|) (_module.Object.universe this@@126)) (or (not (= |o#12@@1| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2403|
 :pattern ( (_module.Object.universe |o#12@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12@@1|)))
)))))))))) (and (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#13@@1| T@U) ) (!  (=> (and ($Is refType |o#13@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13@@1|))) (and (= (_module.Object.universe |o#13@@1|) (_module.Object.universe this@@126)) (or (not (= |o#13@@1| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2405|
 :pattern ( (_module.Object.universe |o#13@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13@@1|)))
))))))))) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#14@@1| T@U) ) (!  (=> (and ($Is refType |o#14@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14@@1|))) (_module.Object.inv $Heap@5 |o#14@@1|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2407|
 :pattern ( (_module.Object.inv $Heap@5 |o#14@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14@@1|)))
))))))))) (and (and (=> |$w$loop#0@0| (and (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (and (_module.Object.objectGlobalInv $Heap@5 this@@126) (and (_module.Object.baseInv $Heap@5 this@@126) (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)))))) (=> |$w$loop#0@0| (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (=> |$w$loop#0@0| (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9))))))) (and (and (and (=> |$w$loop#0@0| (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@5 (_module.Object.universe this@@126))) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@5 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content))))))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#15@@1| T@U) ) (!  (=> (and ($Is refType |o#15@@1| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@1|)))) (not ($IsAllocBox ($Box refType |o#15@@1|) Tclass._module.Object $Heap@4)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2409|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@1|)))
))))) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16@@0|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#16@@0|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |2410|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#16@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16@@0|)))
))))))) (and (and (=> |$w$loop#0@0| (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@5 (_module.Object.universe this@@126)) (and (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@5 (_module.Object.universe this@@126)) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content))) (forall ((|o#15@@2| T@U) ) (!  (=> (and ($Is refType |o#15@@2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@2|)))) (not ($IsAllocBox ($Box refType |o#15@@2|) Tclass._module.Object $Heap@4)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2411|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@2|)))
))) (forall ((|o#16@@1| T@U) ) (!  (=> (and ($Is refType |o#16@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16@@1|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#16@@1|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |2412|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#16@@1|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@1|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16@@1|)))
)))))) (forall (($o@@117 T@U) ) (!  (=> (and (or (not (= $o@@117 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@117) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@117) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@117)) (or (or (or (or (or (= $o@@117 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@117))) (= $o@@117 |running#0@@3|)) (= $o@@117 this@@126)) (= $o@@117 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.counter)))) (= $o@@117 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.remaining))))))
 :qid |_07CounterThreadOwnershipdfy.748:5|
 :skolemid |2413|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@117))
))) (and ($HeapSucc $Heap@4 $Heap@5) (forall (($o@@118 T@U) ($f@@65 T@U) ) (!  (=> (and (or (not (= $o@@118 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@118) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@118) $f@@65) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@118) $f@@65)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@118 $f@@65))))
 :qid |_07CounterThreadOwnershipdfy.748:5|
 :skolemid |2414|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@118) $f@@65))
)))))) (and (=> (= (ControlFlow 0 63) 1) anon13_LoopDone_correct) (=> (= (ControlFlow 0 63) 62) anon13_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#164| null $Heap@@78 alloc (_module.Object.universe this@@126) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) |running#0@@3| this@@126 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.counter)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.remaining)))) (and (=> (= (ControlFlow 0 64) (- 0 107)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (and (=> (= (ControlFlow 0 64) (- 0 106)) (forall (($o@@119 T@U) ($f@@66 T@U) ) (!  (=> (and (and (or (not (= $o@@119 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@119) alloc)))) (or (= $o@@119 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@119)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@119 $f@@66)))
 :qid |_07CounterThreadOwnershipdfy.739:26|
 :skolemid |2397|
))) (=> (forall (($o@@120 T@U) ($f@@67 T@U) ) (!  (=> (and (and (or (not (= $o@@120 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@120) alloc)))) (or (= $o@@120 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@120)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@120 $f@@67)))
 :qid |_07CounterThreadOwnershipdfy.739:26|
 :skolemid |2397|
)) (=> (= call0formal@this@0@@0 (_module.Object.universe this@@126)) (and (=> (= (ControlFlow 0 64) (- 0 105)) (=> (|_module.Universe.globalInv#canCall| $Heap@@78 call0formal@this@0@@0) (or (_module.Universe.globalInv $Heap@@78 call0formal@this@0@@0) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@78 call0formal@this@0@@0) (or (_module.Universe.globalBaseInv $Heap@@78 call0formal@this@0@@0) (forall ((|o#0@@20| T@U) ) (!  (=> (and ($Is refType |o#0@@20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@20|))) (and (= (_module.Object.universe |o#0@@20|) call0formal@this@0@@0) (or (not (= |o#0@@20| call0formal@this@0@@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |700|
 :pattern ( (_module.Object.universe |o#0@@20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@20|)))
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@78 call0formal@this@0@@0) (or (_module.Universe.globalInv $Heap@@78 call0formal@this@0@@0) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@78 call0formal@this@0@@0) (or (_module.Universe.globalBaseInv $Heap@@78 call0formal@this@0@@0) (forall ((|o#0@@21| T@U) ) (!  (=> (and ($Is refType |o#0@@21| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@21|))) (and (= (_module.Object.universe |o#0@@21|) call0formal@this@0@@0) (or (not (= |o#0@@21| call0formal@this@0@@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |700|
 :pattern ( (_module.Object.universe |o#0@@21|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@21|)))
)))))) (and (=> (= (ControlFlow 0 64) (- 0 104)) (=> (|_module.Universe.globalInv#canCall| $Heap@@78 call0formal@this@0@@0) (or (_module.Universe.globalInv $Heap@@78 call0formal@this@0@@0) (forall ((|o#1@@11| T@U) ) (!  (=> (and ($Is refType |o#1@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#1@@11|))) (_module.Object.inv $Heap@@78 |o#1@@11|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |702|
 :pattern ( (_module.Object.inv $Heap@@78 |o#1@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#1@@11|)))
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@78 call0formal@this@0@@0) (or (_module.Universe.globalInv $Heap@@78 call0formal@this@0@@0) (forall ((|o#1@@12| T@U) ) (!  (=> (and ($Is refType |o#1@@12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#1@@12|))) (_module.Object.inv $Heap@@78 |o#1@@12|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |702|
 :pattern ( (_module.Object.inv $Heap@@78 |o#1@@12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#1@@12|)))
)))) (and (=> (= (ControlFlow 0 64) (- 0 103)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |running#0@@3|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.Universe.globalInv#canCall| $Heap@0 call0formal@this@0@@0)) (=> (and (and (and (|_module.Universe.globalInv#canCall| $Heap@0 call0formal@this@0@@0) (and (_module.Universe.globalInv $Heap@0 call0formal@this@0@@0) (and (_module.Universe.globalBaseInv $Heap@0 call0formal@this@0@@0) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#3@@0|))) (_module.Object.inv $Heap@0 |o#3@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |707|
 :pattern ( (_module.Object.inv $Heap@0 |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#3@@0|)))
))))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@0 call0formal@this@0@@0 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) |running#0@@3|)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@0 call0formal@this@0@@0 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) |running#0@@3|))) (and (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@0 call0formal@this@0@@0 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) |running#0@@3|))) (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@0 call0formal@this@0@@0) (_module.Universe.globalBaseInv $Heap@@78 call0formal@this@0@@0)) (_module.Universe.globalBaseInv $Heap@0 call0formal@this@0@@0)) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#8@@0|))) (_module.Object.transitiveInv2 $Heap@@78 $Heap@0 |o#8@@0|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |718|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@78 $Heap@0 |o#8@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#8@@0|)))
))) (forall ((|o#9@@2| T@U) ) (!  (=> (and ($Is refType |o#9@@2| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#9@@2|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#9@@2|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#9@@2|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#9@@2|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@78)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#9@@2|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#9@@2|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |719|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#9@@2|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#9@@2|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#9@@2|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#9@@2|)))
))))) (and (forall (($o@@121 T@U) ) (!  (=> (and (or (not (= $o@@121 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@121) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@121) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@121)) (or (= $o@@121 call0formal@this@0@@0) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 call0formal@this@0@@0) _module.Universe.content)) ($Box refType $o@@121)))))
 :qid |_07CounterThreadOwnershipdfy.115:10|
 :skolemid |720|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@121))
)) ($HeapSucc $Heap@@78 $Heap@0)))) (and (=> (= (ControlFlow 0 64) (- 0 102)) (forall (($o@@122 T@U) ($f@@68 T@U) ) (!  (=> (and (and (or (not (= $o@@122 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@122) alloc)))) (= $o@@122 this@@126)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@122 $f@@68)))
 :qid |_07CounterThreadOwnershipdfy.741:15|
 :skolemid |2398|
))) (=> (forall (($o@@123 T@U) ($f@@69 T@U) ) (!  (=> (and (and (or (not (= $o@@123 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@123) alloc)))) (= $o@@123 this@@126)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@123 $f@@69)))
 :qid |_07CounterThreadOwnershipdfy.741:15|
 :skolemid |2398|
)) (and (=> (= (ControlFlow 0 64) (- 0 101)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (or (_module.Object.objectGlobalInv $Heap@0 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@0 this@@126) (or (_module.Object.baseInv $Heap@0 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (or (_module.Object.objectGlobalInv $Heap@0 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@0 this@@126) (or (_module.Object.baseInv $Heap@0 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))) (and (=> (= (ControlFlow 0 64) (- 0 100)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (or (_module.Object.objectGlobalInv $Heap@0 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@0 this@@126) (or (_module.Object.baseInv $Heap@0 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@0 (_module.Object.universe this@@126)) (forall ((|o#0@@22| T@U) ) (!  (=> (and ($Is refType |o#0@@22| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@22|))) (and (= (_module.Object.universe |o#0@@22|) (_module.Object.universe this@@126)) (or (not (= |o#0@@22| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2470|
 :pattern ( (_module.Object.universe |o#0@@22|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@22|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (or (_module.Object.objectGlobalInv $Heap@0 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@0 this@@126) (or (_module.Object.baseInv $Heap@0 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@0 (_module.Object.universe this@@126)) (forall ((|o#0@@23| T@U) ) (!  (=> (and ($Is refType |o#0@@23| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@23|))) (and (= (_module.Object.universe |o#0@@23|) (_module.Object.universe this@@126)) (or (not (= |o#0@@23| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2470|
 :pattern ( (_module.Object.universe |o#0@@23|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@23|)))
)))))))) (and (=> (= (ControlFlow 0 64) (- 0 99)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (or (_module.Object.objectGlobalInv $Heap@0 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@0 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@0 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@0 (_module.Object.universe this@@126)) (forall ((|o#1@@13| T@U) ) (!  (=> (and ($Is refType |o#1@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@13|))) (and (= (_module.Object.universe |o#1@@13|) (_module.Object.universe this@@126)) (or (not (= |o#1@@13| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2472|
 :pattern ( (_module.Object.universe |o#1@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@13|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (or (_module.Object.objectGlobalInv $Heap@0 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@0 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@0 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@0 (_module.Object.universe this@@126)) (forall ((|o#1@@14| T@U) ) (!  (=> (and ($Is refType |o#1@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@14|))) (and (= (_module.Object.universe |o#1@@14|) (_module.Object.universe this@@126)) (or (not (= |o#1@@14| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2472|
 :pattern ( (_module.Object.universe |o#1@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@14|)))
)))))))) (and (=> (= (ControlFlow 0 64) (- 0 98)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (or (_module.Object.objectGlobalInv $Heap@0 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@0 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@0 (_module.Object.universe this@@126)) (forall ((|o#2@@5| T@U) ) (!  (=> (and ($Is refType |o#2@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@5|))) (_module.Object.inv $Heap@0 |o#2@@5|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2474|
 :pattern ( (_module.Object.inv $Heap@0 |o#2@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@5|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (or (_module.Object.objectGlobalInv $Heap@0 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@0 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@0 (_module.Object.universe this@@126)) (forall ((|o#2@@6| T@U) ) (!  (=> (and ($Is refType |o#2@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@6|))) (_module.Object.inv $Heap@0 |o#2@@6|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2474|
 :pattern ( (_module.Object.inv $Heap@0 |o#2@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@6|)))
)))))) (and (=> (= (ControlFlow 0 64) (- 0 97)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (and (=> (= (ControlFlow 0 64) (- 0 96)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (and (=> (= (ControlFlow 0 64) (- 0 95)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 0))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 0)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@1 this@@126) (=> (_module.Object.objectGlobalInv $Heap@1 this@@126) (|_module.Universe.globalInv2#canCall| $Heap@0 $Heap@1 (_module.Object.universe this@@126)))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@1 this@@126) (and (_module.Object.objectGlobalInv $Heap@1 this@@126) (and (_module.Object.baseInv $Heap@1 this@@126) (_module.Universe.globalInv $Heap@1 (_module.Object.universe this@@126)))))) (=> (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@0 $Heap@1 (_module.Object.universe this@@126)) (and (_module.Universe.globalInv2 $Heap@0 $Heap@1 (_module.Object.universe this@@126)) (and (forall ((|o#6@@2| T@U) ) (!  (=> (and ($Is refType |o#6@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@2|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@2|)) (_module.Object.inv2 $Heap@0 $Heap@1 |o#6@@2|)))
 :qid |_07CounterThreadOwnershipdfy.44:16|
 :skolemid |2487|
 :pattern ( (_module.Object.inv2 $Heap@0 $Heap@1 |o#6@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@2|)))
)) (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 (_module.Object.universe this@@126))))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 1)) (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@1 (_module.Object.universe this@@126) |running#0@@3|))) (and (and (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@1 (_module.Object.universe this@@126) |running#0@@3|) (and (_module.Universe.legalTransition $Heap@0 $Heap@1 (_module.Object.universe this@@126) |running#0@@3|) (and (and (and (and (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@1 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@0 (_module.Object.universe this@@126))) (_module.Universe.globalBaseInv $Heap@1 (_module.Object.universe this@@126))) (forall ((|o#18@@1| T@U) ) (!  (=> (and ($Is refType |o#18@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#18@@1|))) (and (or (forall (($o@@124 T@U) ($f@@70 T@U) ) (!  (=> (or (not (= $o@@124 null)) (not true)) (=> (= $o@@124 |o#18@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@124) $f@@70) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@124) $f@@70))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |2510|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@124) $f@@70))
)) (_module.Object.inv $Heap@1 |o#18@@1|)) (or (forall (($o@@125 T@U) ($f@@71 T@U) ) (!  (=> (or (not (= $o@@125 null)) (not true)) (=> (= $o@@125 |o#18@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@125) $f@@71) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@125) $f@@71))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |2511|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@125) $f@@71))
)) (_module.Object.inv2 $Heap@0 $Heap@1 |o#18@@1|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |2512|
 :pattern ( (_module.Object.inv2 $Heap@0 $Heap@1 |o#18@@1|))
 :pattern ( (_module.Object.inv $Heap@1 |o#18@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#18@@1|)))
))) (forall ((|o#19@@1| T@U) ) (!  (=> (and ($Is refType |o#19@@1| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@1|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@1|))))) (_module.Object.inv $Heap@1 |o#19@@1|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |2513|
 :pattern ( (_module.Object.inv $Heap@1 |o#19@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@1|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@1|)))
))))) (and (forall (($o@@126 T@U) ) (!  (=> (and (or (not (= $o@@126 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@126) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@126) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@126)) (= $o@@126 this@@126)))
 :qid |_07CounterThreadOwnershipdfy.798:10|
 :skolemid |2514|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@126))
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 64) (- 0 94)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (and (=> (= (ControlFlow 0 64) (- 0 93)) (forall (($o@@127 T@U) ($f@@72 T@U) ) (!  (=> (and (and (or (not (= $o@@127 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@127) alloc)))) (or (= $o@@127 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@127)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@127 $f@@72)))
 :qid |_07CounterThreadOwnershipdfy.742:26|
 :skolemid |2399|
))) (=> (forall (($o@@128 T@U) ($f@@73 T@U) ) (!  (=> (and (and (or (not (= $o@@128 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@128) alloc)))) (or (= $o@@128 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@128)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@128 $f@@73)))
 :qid |_07CounterThreadOwnershipdfy.742:26|
 :skolemid |2399|
)) (=> (= call0formal@this@0@@1 (_module.Object.universe this@@126)) (and (=> (= (ControlFlow 0 64) (- 0 92)) (=> (|_module.Universe.globalInv#canCall| $Heap@1 call0formal@this@0@@1) (or (_module.Universe.globalInv $Heap@1 call0formal@this@0@@1) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 call0formal@this@0@@1) (or (_module.Universe.globalBaseInv $Heap@1 call0formal@this@0@@1) (forall ((|o#0@@24| T@U) ) (!  (=> (and ($Is refType |o#0@@24| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#0@@24|))) (and (= (_module.Object.universe |o#0@@24|) call0formal@this@0@@1) (or (not (= |o#0@@24| call0formal@this@0@@1)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |700|
 :pattern ( (_module.Object.universe |o#0@@24|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#0@@24|)))
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@1 call0formal@this@0@@1) (or (_module.Universe.globalInv $Heap@1 call0formal@this@0@@1) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 call0formal@this@0@@1) (or (_module.Universe.globalBaseInv $Heap@1 call0formal@this@0@@1) (forall ((|o#0@@25| T@U) ) (!  (=> (and ($Is refType |o#0@@25| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#0@@25|))) (and (= (_module.Object.universe |o#0@@25|) call0formal@this@0@@1) (or (not (= |o#0@@25| call0formal@this@0@@1)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |700|
 :pattern ( (_module.Object.universe |o#0@@25|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#0@@25|)))
)))))) (and (=> (= (ControlFlow 0 64) (- 0 91)) (=> (|_module.Universe.globalInv#canCall| $Heap@1 call0formal@this@0@@1) (or (_module.Universe.globalInv $Heap@1 call0formal@this@0@@1) (forall ((|o#1@@15| T@U) ) (!  (=> (and ($Is refType |o#1@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#1@@15|))) (_module.Object.inv $Heap@1 |o#1@@15|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |702|
 :pattern ( (_module.Object.inv $Heap@1 |o#1@@15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#1@@15|)))
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@1 call0formal@this@0@@1) (or (_module.Universe.globalInv $Heap@1 call0formal@this@0@@1) (forall ((|o#1@@16| T@U) ) (!  (=> (and ($Is refType |o#1@@16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#1@@16|))) (_module.Object.inv $Heap@1 |o#1@@16|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |702|
 :pattern ( (_module.Object.inv $Heap@1 |o#1@@16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#1@@16|)))
)))) (and (=> (= (ControlFlow 0 64) (- 0 90)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |running#0@@3|)) (=> (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|_module.Universe.globalInv#canCall| $Heap@2 call0formal@this@0@@1)) (=> (and (and (and (|_module.Universe.globalInv#canCall| $Heap@2 call0formal@this@0@@1) (and (_module.Universe.globalInv $Heap@2 call0formal@this@0@@1) (and (_module.Universe.globalBaseInv $Heap@2 call0formal@this@0@@1) (forall ((|o#3@@1| T@U) ) (!  (=> (and ($Is refType |o#3@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#3@@1|))) (_module.Object.inv $Heap@2 |o#3@@1|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |707|
 :pattern ( (_module.Object.inv $Heap@2 |o#3@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#3@@1|)))
))))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@1 $Heap@2 call0formal@this@0@@1 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) |running#0@@3|)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@1 $Heap@2 call0formal@this@0@@1 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) |running#0@@3|))) (and (_module.Universe.legalTransitionsSequence $Heap@1 $Heap@2 call0formal@this@0@@1 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) |running#0@@3|))) (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@1 $Heap@2 call0formal@this@0@@1) (_module.Universe.globalBaseInv $Heap@1 call0formal@this@0@@1)) (_module.Universe.globalBaseInv $Heap@2 call0formal@this@0@@1)) (forall ((|o#8@@1| T@U) ) (!  (=> (and ($Is refType |o#8@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#8@@1|))) (_module.Object.transitiveInv2 $Heap@1 $Heap@2 |o#8@@1|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |718|
 :pattern ( (_module.Object.transitiveInv2 $Heap@1 $Heap@2 |o#8@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#8@@1|)))
))) (forall ((|o#9@@3| T@U) ) (!  (=> (and ($Is refType |o#9@@3| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#9@@3|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#9@@3|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#9@@3|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#9@@3|) _module.OwnedObject.owner) Tclass._module.Object $Heap@1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#9@@3|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |o#9@@3|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |719|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |o#9@@3|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#9@@3|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#9@@3|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType |o#9@@3|)))
))))) (and (forall (($o@@129 T@U) ) (!  (=> (and (or (not (= $o@@129 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@129) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@129) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@129)) (or (= $o@@129 call0formal@this@0@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0@@1) _module.Universe.content)) ($Box refType $o@@129)))))
 :qid |_07CounterThreadOwnershipdfy.115:10|
 :skolemid |720|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@129))
)) ($HeapSucc $Heap@1 $Heap@2)))) (and (=> (= (ControlFlow 0 64) (- 0 89)) (forall (($o@@130 T@U) ($f@@74 T@U) ) (!  (=> (and (and (or (not (= $o@@130 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@130) alloc)))) (= $o@@130 this@@126)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@130 $f@@74)))
 :qid |_07CounterThreadOwnershipdfy.744:15|
 :skolemid |2400|
))) (=> (forall (($o@@131 T@U) ($f@@75 T@U) ) (!  (=> (and (and (or (not (= $o@@131 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@131) alloc)))) (= $o@@131 this@@126)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@131 $f@@75)))
 :qid |_07CounterThreadOwnershipdfy.744:15|
 :skolemid |2400|
)) (and (=> (= (ControlFlow 0 64) (- 0 88)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@126) (or (_module.Object.objectGlobalInv $Heap@2 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@2 this@@126) (or (_module.Object.baseInv $Heap@2 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@126) (or (_module.Object.objectGlobalInv $Heap@2 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@2 this@@126) (or (_module.Object.baseInv $Heap@2 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))) (and (=> (= (ControlFlow 0 64) (- 0 87)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@126) (or (_module.Object.objectGlobalInv $Heap@2 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@2 this@@126) (or (_module.Object.baseInv $Heap@2 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@126)) (forall ((|o#0@@26| T@U) ) (!  (=> (and ($Is refType |o#0@@26| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@26|))) (and (= (_module.Object.universe |o#0@@26|) (_module.Object.universe this@@126)) (or (not (= |o#0@@26| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2565|
 :pattern ( (_module.Object.universe |o#0@@26|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@26|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@126) (or (_module.Object.objectGlobalInv $Heap@2 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@2 this@@126) (or (_module.Object.baseInv $Heap@2 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@126)) (forall ((|o#0@@27| T@U) ) (!  (=> (and ($Is refType |o#0@@27| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@27|))) (and (= (_module.Object.universe |o#0@@27|) (_module.Object.universe this@@126)) (or (not (= |o#0@@27| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2565|
 :pattern ( (_module.Object.universe |o#0@@27|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#0@@27|)))
)))))))) (and (=> (= (ControlFlow 0 64) (- 0 86)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@126) (or (_module.Object.objectGlobalInv $Heap@2 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@126)) (forall ((|o#1@@17| T@U) ) (!  (=> (and ($Is refType |o#1@@17| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@17|))) (and (= (_module.Object.universe |o#1@@17|) (_module.Object.universe this@@126)) (or (not (= |o#1@@17| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2567|
 :pattern ( (_module.Object.universe |o#1@@17|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@17|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@126) (or (_module.Object.objectGlobalInv $Heap@2 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@126)) (forall ((|o#1@@18| T@U) ) (!  (=> (and ($Is refType |o#1@@18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@18|))) (and (= (_module.Object.universe |o#1@@18|) (_module.Object.universe this@@126)) (or (not (= |o#1@@18| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2567|
 :pattern ( (_module.Object.universe |o#1@@18|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#1@@18|)))
)))))))) (and (=> (= (ControlFlow 0 64) (- 0 85)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@126) (or (_module.Object.objectGlobalInv $Heap@2 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@126)) (forall ((|o#2@@7| T@U) ) (!  (=> (and ($Is refType |o#2@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@7|))) (_module.Object.inv $Heap@2 |o#2@@7|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2569|
 :pattern ( (_module.Object.inv $Heap@2 |o#2@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@7|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@126) (or (_module.Object.objectGlobalInv $Heap@2 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@126)) (forall ((|o#2@@8| T@U) ) (!  (=> (and ($Is refType |o#2@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@8|))) (_module.Object.inv $Heap@2 |o#2@@8|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2569|
 :pattern ( (_module.Object.inv $Heap@2 |o#2@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#2@@8|)))
)))))) (and (=> (= (ControlFlow 0 64) (- 0 84)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (and (=> (= (ControlFlow 0 64) (- 0 83)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (and (=> (= (ControlFlow 0 64) (- 0 82)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 1))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 1)) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@126) (=> (_module.Object.objectGlobalInv $Heap@3 this@@126) (|_module.Universe.globalInv2#canCall| $Heap@2 $Heap@3 (_module.Object.universe this@@126)))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@126) (and (_module.Object.objectGlobalInv $Heap@3 this@@126) (and (_module.Object.baseInv $Heap@3 this@@126) (_module.Universe.globalInv $Heap@3 (_module.Object.universe this@@126)))))) (=> (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@2 $Heap@3 (_module.Object.universe this@@126)) (and (_module.Universe.globalInv2 $Heap@2 $Heap@3 (_module.Object.universe this@@126)) (and (forall ((|o#6@@3| T@U) ) (!  (=> (and ($Is refType |o#6@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@3|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@3|)) (_module.Object.inv2 $Heap@2 $Heap@3 |o#6@@3|)))
 :qid |_07CounterThreadOwnershipdfy.44:16|
 :skolemid |2582|
 :pattern ( (_module.Object.inv2 $Heap@2 $Heap@3 |o#6@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@3|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#6@@3|)))
)) (_module.Universe.baseLegalTransitionsSequence $Heap@2 $Heap@3 (_module.Object.universe this@@126))))) (and (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9))) (|_module.Universe.legalTransition#canCall| $Heap@2 $Heap@3 (_module.Object.universe this@@126) |running#0@@3|))) (and (and (|_module.Universe.legalTransition#canCall| $Heap@2 $Heap@3 (_module.Object.universe this@@126) |running#0@@3|) (and (_module.Universe.legalTransition $Heap@2 $Heap@3 (_module.Object.universe this@@126) |running#0@@3|) (and (and (and (and (_module.Universe.legalTransitionsSequence $Heap@2 $Heap@3 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@126))) (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@126))) (forall ((|o#18@@2| T@U) ) (!  (=> (and ($Is refType |o#18@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#18@@2|))) (and (or (forall (($o@@132 T@U) ($f@@76 T@U) ) (!  (=> (or (not (= $o@@132 null)) (not true)) (=> (= $o@@132 |o#18@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@132) $f@@76) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@132) $f@@76))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |2605|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@132) $f@@76))
)) (_module.Object.inv $Heap@3 |o#18@@2|)) (or (forall (($o@@133 T@U) ($f@@77 T@U) ) (!  (=> (or (not (= $o@@133 null)) (not true)) (=> (= $o@@133 |o#18@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@133) $f@@77) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@133) $f@@77))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |2606|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@133) $f@@77))
)) (_module.Object.inv2 $Heap@2 $Heap@3 |o#18@@2|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |2607|
 :pattern ( (_module.Object.inv2 $Heap@2 $Heap@3 |o#18@@2|))
 :pattern ( (_module.Object.inv $Heap@3 |o#18@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#18@@2|)))
))) (forall ((|o#19@@2| T@U) ) (!  (=> (and ($Is refType |o#19@@2| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@2|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@2|))))) (_module.Object.inv $Heap@3 |o#19@@2|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |2608|
 :pattern ( (_module.Object.inv $Heap@3 |o#19@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#19@@2|)))
))))) (and (forall (($o@@134 T@U) ) (!  (=> (and (or (not (= $o@@134 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@134) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@134) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@134)) (= $o@@134 this@@126)))
 :qid |_07CounterThreadOwnershipdfy.812:10|
 :skolemid |2609|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@134))
)) ($HeapSucc $Heap@2 $Heap@3)))) (and (=> (= (ControlFlow 0 64) (- 0 81)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (and (=> (= (ControlFlow 0 64) (- 0 80)) (forall (($o@@135 T@U) ($f@@78 T@U) ) (!  (=> (and (and (or (not (= $o@@135 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@135) alloc)))) (or (= $o@@135 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@135)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@135 $f@@78)))
 :qid |_07CounterThreadOwnershipdfy.745:26|
 :skolemid |2401|
))) (=> (forall (($o@@136 T@U) ($f@@79 T@U) ) (!  (=> (and (and (or (not (= $o@@136 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@136) alloc)))) (or (= $o@@136 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@136)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@136 $f@@79)))
 :qid |_07CounterThreadOwnershipdfy.745:26|
 :skolemid |2401|
)) (=> (= call0formal@this@0@@2 (_module.Object.universe this@@126)) (and (=> (= (ControlFlow 0 64) (- 0 79)) (=> (|_module.Universe.globalInv#canCall| $Heap@3 call0formal@this@0@@2) (or (_module.Universe.globalInv $Heap@3 call0formal@this@0@@2) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 call0formal@this@0@@2) (or (_module.Universe.globalBaseInv $Heap@3 call0formal@this@0@@2) (forall ((|o#0@@28| T@U) ) (!  (=> (and ($Is refType |o#0@@28| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#0@@28|))) (and (= (_module.Object.universe |o#0@@28|) call0formal@this@0@@2) (or (not (= |o#0@@28| call0formal@this@0@@2)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |700|
 :pattern ( (_module.Object.universe |o#0@@28|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#0@@28|)))
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@3 call0formal@this@0@@2) (or (_module.Universe.globalInv $Heap@3 call0formal@this@0@@2) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 call0formal@this@0@@2) (or (_module.Universe.globalBaseInv $Heap@3 call0formal@this@0@@2) (forall ((|o#0@@29| T@U) ) (!  (=> (and ($Is refType |o#0@@29| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#0@@29|))) (and (= (_module.Object.universe |o#0@@29|) call0formal@this@0@@2) (or (not (= |o#0@@29| call0formal@this@0@@2)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |700|
 :pattern ( (_module.Object.universe |o#0@@29|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#0@@29|)))
)))))) (and (=> (= (ControlFlow 0 64) (- 0 78)) (=> (|_module.Universe.globalInv#canCall| $Heap@3 call0formal@this@0@@2) (or (_module.Universe.globalInv $Heap@3 call0formal@this@0@@2) (forall ((|o#1@@19| T@U) ) (!  (=> (and ($Is refType |o#1@@19| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#1@@19|))) (_module.Object.inv $Heap@3 |o#1@@19|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |702|
 :pattern ( (_module.Object.inv $Heap@3 |o#1@@19|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#1@@19|)))
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@3 call0formal@this@0@@2) (or (_module.Universe.globalInv $Heap@3 call0formal@this@0@@2) (forall ((|o#1@@20| T@U) ) (!  (=> (and ($Is refType |o#1@@20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#1@@20|))) (_module.Object.inv $Heap@3 |o#1@@20|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |702|
 :pattern ( (_module.Object.inv $Heap@3 |o#1@@20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#1@@20|)))
)))) (and (=> (= (ControlFlow 0 64) (- 0 77)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |running#0@@3|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |running#0@@3|)) (=> (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (|_module.Universe.globalInv#canCall| $Heap@4 call0formal@this@0@@2)) (=> (and (and (and (|_module.Universe.globalInv#canCall| $Heap@4 call0formal@this@0@@2) (and (_module.Universe.globalInv $Heap@4 call0formal@this@0@@2) (and (_module.Universe.globalBaseInv $Heap@4 call0formal@this@0@@2) (forall ((|o#3@@2| T@U) ) (!  (=> (and ($Is refType |o#3@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#3@@2|))) (_module.Object.inv $Heap@4 |o#3@@2|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |707|
 :pattern ( (_module.Object.inv $Heap@4 |o#3@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#3@@2|)))
))))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@4 call0formal@this@0@@2 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) |running#0@@3|)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@4 call0formal@this@0@@2 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) |running#0@@3|))) (and (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@4 call0formal@this@0@@2 (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) |running#0@@3|))) (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@4 call0formal@this@0@@2) (_module.Universe.globalBaseInv $Heap@3 call0formal@this@0@@2)) (_module.Universe.globalBaseInv $Heap@4 call0formal@this@0@@2)) (forall ((|o#8@@2| T@U) ) (!  (=> (and ($Is refType |o#8@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#8@@2|))) (_module.Object.transitiveInv2 $Heap@3 $Heap@4 |o#8@@2|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |718|
 :pattern ( (_module.Object.transitiveInv2 $Heap@3 $Heap@4 |o#8@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#8@@2|)))
))) (forall ((|o#9@@4| T@U) ) (!  (=> (and ($Is refType |o#9@@4| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#9@@4|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#9@@4|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#13| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#9@@4|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#9@@4|) _module.OwnedObject.owner) Tclass._module.Object $Heap@3)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#9@@4|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#9@@4|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |719|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#9@@4|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#9@@4|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#9@@4|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType |o#9@@4|)))
))))) (and (forall (($o@@137 T@U) ) (!  (=> (and (or (not (= $o@@137 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@137) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@137) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@137)) (or (= $o@@137 call0formal@this@0@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call0formal@this@0@@2) _module.Universe.content)) ($Box refType $o@@137)))))
 :qid |_07CounterThreadOwnershipdfy.115:10|
 :skolemid |720|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@137))
)) ($HeapSucc $Heap@3 $Heap@4)))) (and (=> (= (ControlFlow 0 64) (- 0 76)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (and (=> (= (ControlFlow 0 64) (- 0 75)) (forall (($o@@138 T@U) ($f@@80 T@U) ) (!  (=> (and (and (or (not (= $o@@138 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@138) alloc)))) (or (or (or (or (or (= $o@@138 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@138))) (= $o@@138 |running#0@@3|)) (= $o@@138 this@@126)) (= $o@@138 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.counter)))) (= $o@@138 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.remaining))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@138 $f@@80)))
 :qid |_07CounterThreadOwnershipdfy.748:5|
 :skolemid |2402|
))) (=> (forall (($o@@139 T@U) ($f@@81 T@U) ) (!  (=> (and (and (or (not (= $o@@139 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@139) alloc)))) (or (or (or (or (or (= $o@@139 (_module.Object.universe this@@126)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType $o@@139))) (= $o@@139 |running#0@@3|)) (= $o@@139 this@@126)) (= $o@@139 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.counter)))) (= $o@@139 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.remaining))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@139 $f@@81)))
 :qid |_07CounterThreadOwnershipdfy.748:5|
 :skolemid |2402|
)) (=> (= |$Frame$loop#0@0| (|lambda#164| null $Heap@4 alloc (_module.Object.universe this@@126) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) |running#0@@3| this@@126 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.counter)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.remaining)))) (and (=> (= (ControlFlow 0 64) (- 0 74)) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@4 this@@126) (or (_module.Object.objectGlobalInv $Heap@4 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@4 this@@126) (or (_module.Object.baseInv $Heap@4 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@4 this@@126) (or (_module.Object.objectGlobalInv $Heap@4 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@4 this@@126) (or (_module.Object.baseInv $Heap@4 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (and (=> (= (ControlFlow 0 64) (- 0 73)) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@4 this@@126) (or (_module.Object.objectGlobalInv $Heap@4 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@4 this@@126) (or (_module.Object.baseInv $Heap@4 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#12@@2| T@U) ) (!  (=> (and ($Is refType |o#12@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12@@2|))) (and (= (_module.Object.universe |o#12@@2|) (_module.Object.universe this@@126)) (or (not (= |o#12@@2| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2403|
 :pattern ( (_module.Object.universe |o#12@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12@@2|)))
)))))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@4 this@@126) (or (_module.Object.objectGlobalInv $Heap@4 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@4 this@@126) (or (_module.Object.baseInv $Heap@4 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#12@@3| T@U) ) (!  (=> (and ($Is refType |o#12@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12@@3|))) (and (= (_module.Object.universe |o#12@@3|) (_module.Object.universe this@@126)) (or (not (= |o#12@@3| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2403|
 :pattern ( (_module.Object.universe |o#12@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#12@@3|)))
))))))))) (and (=> (= (ControlFlow 0 64) (- 0 72)) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@4 this@@126) (or (_module.Object.objectGlobalInv $Heap@4 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@4 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#13@@2| T@U) ) (!  (=> (and ($Is refType |o#13@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13@@2|))) (and (= (_module.Object.universe |o#13@@2|) (_module.Object.universe this@@126)) (or (not (= |o#13@@2| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2405|
 :pattern ( (_module.Object.universe |o#13@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13@@2|)))
)))))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@4 this@@126) (or (_module.Object.objectGlobalInv $Heap@4 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@4 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#13@@3| T@U) ) (!  (=> (and ($Is refType |o#13@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13@@3|))) (and (= (_module.Object.universe |o#13@@3|) (_module.Object.universe this@@126)) (or (not (= |o#13@@3| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2405|
 :pattern ( (_module.Object.universe |o#13@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#13@@3|)))
))))))))) (and (=> (= (ControlFlow 0 64) (- 0 71)) (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@4 this@@126) (or (_module.Object.objectGlobalInv $Heap@4 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#14@@2| T@U) ) (!  (=> (and ($Is refType |o#14@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14@@2|))) (_module.Object.inv $Heap@4 |o#14@@2|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2407|
 :pattern ( (_module.Object.inv $Heap@4 |o#14@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14@@2|)))
)))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Object.objectGlobalInv#canCall| $Heap@4 this@@126) (or (_module.Object.objectGlobalInv $Heap@4 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#14@@3| T@U) ) (!  (=> (and ($Is refType |o#14@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14@@3|))) (_module.Object.inv $Heap@4 |o#14@@3|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2407|
 :pattern ( (_module.Object.inv $Heap@4 |o#14@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#14@@3|)))
))))))) (and (=> (= (ControlFlow 0 64) (- 0 70)) (=> |$w$loop#0@0| (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)))) (=> (=> |$w$loop#0@0| (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|))) (and (=> (= (ControlFlow 0 64) (- 0 69)) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.OwnedObject.owner)) |running#0@@3|))) (=> (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (and (=> (= (ControlFlow 0 64) (- 0 68)) (=> |$w$loop#0@0| (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9))))) (=> (=> |$w$loop#0@0| (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9)))) (and (=> (= (ControlFlow 0 64) (- 0 67)) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content))))))) (=> (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)))))) (and (=> (= (ControlFlow 0 64) (- 0 66)) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#15@@3| T@U) ) (!  (=> (and ($Is refType |o#15@@3| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@3|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@3|)))) (not ($IsAllocBox ($Box refType |o#15@@3|) Tclass._module.Object $Heap@4)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2409|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@3|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@3|)))
)))))) (=> (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#15@@4| T@U) ) (!  (=> (and ($Is refType |o#15@@4| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@4|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@4|)))) (not ($IsAllocBox ($Box refType |o#15@@4|) Tclass._module.Object $Heap@4)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2409|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@4|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#15@@4|)))
))))) (and (=> (= (ControlFlow 0 64) (- 0 65)) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#16@@2| T@U) ) (!  (=> (and ($Is refType |o#16@@2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16@@2|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@2|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@2|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |2410|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@2|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@2|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16@@2|)))
)))))) (=> (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@4 (_module.Object.universe this@@126)) (forall ((|o#16@@3| T@U) ) (!  (=> (and ($Is refType |o#16@@3| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16@@3|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@3|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@3|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |2410|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@3|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#16@@3|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#16@@3|)))
))))) (=> (= (ControlFlow 0 64) 63) anon13_LoopHead_correct))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@78) ($IsHeapAnchor $Heap@@78)) (and (or (not (= this@@126 null)) (not true)) (and ($Is refType this@@126 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@126 Tclass._module.IncrementerMethod $Heap@@78)))) (=> (and (and (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@78)) (= 17 $FunctionContextHeight)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@@78 this@@126) (and (_module.Object.objectGlobalInv $Heap@@78 this@@126) (and (_module.Object.baseInv $Heap@@78 this@@126) (_module.Universe.globalInv $Heap@@78 (_module.Object.universe this@@126)))))) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.OwnedObject.owner)) |running#0@@3|)) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 0)) (= (ControlFlow 0 108) 64)))) anon0_correct))))
