...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split64)
...
)) (= $Heap@10 $Heap@11))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@4)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@4) (= (ControlFlow 0 2) (- 0 1))))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@4))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
