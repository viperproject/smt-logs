...
(set-info :boogie-vc-id CheckWellformed$$_module.O.i0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon5_correct  (=> (= (_module.O.i0 $Heap@@2 this@@6)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.O.s this@@6)) _module.S.obs)) ($Box refType this@@6)) (_module.S.i0 $Heap@@2 (_module.O.s this@@6)))) (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.O.s this@@6)) _module.S.obs)) ($Box refType this@@6)) (|_module.S.i0#canCall| $Heap@@2 (_module.O.s this@@6))) ($Is boolType (bool_2_U (_module.O.i0 $Heap@@2 this@@6)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@1|)))))))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.O.s this@@6)) _module.S.obs)) ($Box refType this@@6))) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 7) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.O.s this@@6)) _module.S.obs)) ($Box refType this@@6)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (_module.O.s this@@6) null)) (not true))) (=> (or (not (= (_module.O.s this@@6) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.O.s this@@6)) Tclass._module.S? $Heap@@2) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@10) alloc)))) (or (= $o@@10 (_module.O.s this@@6)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.O.s this@@6)) _module.S.obs)) ($Box refType $o@@10)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@10 $f@@0)))
 :qid |_01InnerOuterdfy.49:53|
 :skolemid |625|
))) (|_module.S.i0#canCall| $Heap@@2 (_module.O.s this@@6))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 5) 3))) anon5_correct)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= (_module.O.s this@@6) null)) (not true))) (=> (or (not (= (_module.O.s this@@6) null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 (_module.O.s this@@6) _module.S.obs))) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.O) ($IsAlloc refType this@@6 Tclass._module.O $Heap@@2))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
