...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@3 this@@3) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.Thread)))) (= (_module.Object.localInv $Heap@@3 this@@3) (_module.Thread.localInv $Heap@@3 this@@3)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@4 this@@4) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.OwnedObject)))) (= (_module.Object.localInv $Heap@@4 this@@4) (_module.OwnedObject.localInv $Heap@@4 this@@4)))
 :qid |_11MutexGuard2legacydfy.247:19|
 :skolemid |1531|
 :pattern ( (_module.Object.localInv $Heap@@4 this@@4) ($Is refType this@@4 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.Object.localInv $Heap@@4 this@@4) (_module.OwnedObject.localInv $Heap@@4 this@@4) ($IsGoodHeap $Heap@@4))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@5 this@@5) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Thread)))) (= (_module.Object.inv $Heap@@5 this@@5) (_module.Thread.inv $Heap@@5 this@@5)))
 :qid |_11MutexGuard2legacydfy.249:19|
 :skolemid |1243|
 :pattern ( (_module.Object.inv $Heap@@5 this@@5) ($Is refType this@@5 Tclass._module.Thread) ($IsGoodHeap $Heap@@5))
 :pattern ( (_module.Object.inv $Heap@@5 this@@5) (_module.Thread.inv $Heap@@5 this@@5) ($IsGoodHeap $Heap@@5))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@6 this@@6) (and (< 11 $FunctionContextHeight) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@6 this@@6) (_module.OwnedObject.inv $Heap@@6 this@@6)))
 :qid |_11MutexGuard2legacydfy.249:19|
 :skolemid |1544|
 :pattern ( (_module.Object.inv $Heap@@6 this@@6) ($Is refType this@@6 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.Object.inv $Heap@@6 this@@6) (_module.OwnedObject.inv $Heap@@6 this@@6) ($IsGoodHeap $Heap@@6))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@7 this@@7) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Object) ($IsAlloc refType this@@7 Tclass._module.Object $Heap@@7)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType this@@7)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@7 this@@7) (=> (_module.Object.baseFieldsInv $Heap@@7 this@@7) (|_module.Universe.globalBaseInv#canCall| $Heap@@7 (_module.Object.universe this@@7))))) (= (_module.Object.objectGlobalBaseInv $Heap@@7 this@@7)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 (_module.Object.universe this@@7)) _module.Universe.content)) ($Box refType this@@7)) (_module.Object.baseFieldsInv $Heap@@7 this@@7)) (_module.Universe.globalBaseInv $Heap@@7 (_module.Object.universe this@@7))))))
 :qid |_11MutexGuard2legacydfy.202:19|
 :skolemid |1071|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@7 this@@7) ($IsGoodHeap $Heap@@7))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@8 this@@8) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@8) (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.Thread) ($IsAlloc refType this@@8 Tclass._module.Thread $Heap@@8)))))) (= (_module.Thread.baseFieldsInv $Heap@@8 this@@8) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.260:19|
 :skolemid |1216|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@8 this@@8) ($IsGoodHeap $Heap@@8))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@9 this@@9) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.OwnedObject) ($IsAlloc refType this@@9 Tclass._module.OwnedObject $Heap@@9)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (=> (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (|_module.OwnedObject.localUserInv#canCall| $Heap@@9 this@@9))) (= (_module.OwnedObject.localInv $Heap@@9 this@@9)  (and (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (_module.OwnedObject.localUserInv $Heap@@9 this@@9)))))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1530|
 :pattern ( (_module.OwnedObject.localInv $Heap@@9 this@@9) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@10 this@@10) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.OwnedObject) ($IsAlloc refType this@@10 Tclass._module.OwnedObject $Heap@@10)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@10 this@@10) (=> (_module.OwnedObject.localInv $Heap@@10 this@@10) (|_module.OwnedObject.userInv#canCall| $Heap@@10 this@@10))) (= (_module.OwnedObject.inv $Heap@@10 this@@10)  (and (_module.OwnedObject.localInv $Heap@@10 this@@10) (_module.OwnedObject.userInv $Heap@@10 this@@10)))))
 :qid |_11MutexGuard2legacydfy.340:19|
 :skolemid |1543|
 :pattern ( (_module.OwnedObject.inv $Heap@@10 this@@10) ($IsGoodHeap $Heap@@10))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@11 this@@11) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Object) ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@11)))))) (_module.Object.triggerAxioms $Heap@@11 this@@11))
 :qid |_11MutexGuard2legacydfy.210:19|
 :skolemid |1089|
 :pattern ( (_module.Object.triggerAxioms $Heap@@11 this@@11))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@12 this@@12) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Thread) ($IsAlloc refType this@@12 Tclass._module.Thread $Heap@@12)))))) (=> (_module.Thread.localInv $Heap@@12 this@@12) (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12)))
 :qid |_11MutexGuard2legacydfy.265:19|
 :skolemid |1228|
 :pattern ( (_module.Thread.localInv $Heap@@12 this@@12))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@13 this@@13) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.OwnedObject) ($IsAlloc refType this@@13 Tclass._module.OwnedObject $Heap@@13)))))) (=> (_module.OwnedObject.localInv $Heap@@13 this@@13) (_module.Object.objectGlobalBaseInv $Heap@@13 this@@13)))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1528|
 :pattern ( (_module.OwnedObject.localInv $Heap@@13 this@@13))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@14 this@@14) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Object) ($IsAlloc refType this@@14 Tclass._module.Object $Heap@@14)))))) (=> (_module.Object.localInv $Heap@@14 this@@14) (_module.Object.objectGlobalBaseInv $Heap@@14 this@@14)))
 :qid |_11MutexGuard2legacydfy.247:19|
 :skolemid |1141|
 :pattern ( (_module.Object.localInv $Heap@@14 this@@14))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@15 this@@15) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Thread) ($IsAlloc refType this@@15 Tclass._module.Thread $Heap@@15)))))) (=> (_module.Thread.inv $Heap@@15 this@@15) (_module.Thread.localInv $Heap@@15 this@@15)))
 :qid |_11MutexGuard2legacydfy.268:19|
 :skolemid |1240|
 :pattern ( (_module.Thread.inv $Heap@@15 this@@15))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@16 this@@16) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.OwnedObject) ($IsAlloc refType this@@16 Tclass._module.OwnedObject $Heap@@16)))))) (=> (_module.OwnedObject.userInv $Heap@@16 this@@16) (_module.OwnedObject.localUserInv $Heap@@16 this@@16)))
 :qid |_11MutexGuard2legacydfy.409:19|
 :skolemid |1622|
 :pattern ( (_module.OwnedObject.userInv $Heap@@16 this@@16))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@17 this@@17) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.OwnedObject) ($IsAlloc refType this@@17 Tclass._module.OwnedObject $Heap@@17)))))) (=> (_module.OwnedObject.inv $Heap@@17 this@@17) (_module.OwnedObject.localInv $Heap@@17 this@@17)))
 :qid |_11MutexGuard2legacydfy.340:19|
 :skolemid |1541|
 :pattern ( (_module.OwnedObject.inv $Heap@@17 this@@17))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@18 this@@18) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Object) ($IsAlloc refType this@@18 Tclass._module.Object $Heap@@18)))))) (=> (_module.Object.inv $Heap@@18 this@@18) (_module.Object.localInv $Heap@@18 this@@18)))
 :qid |_11MutexGuard2legacydfy.249:19|
 :skolemid |1151|
 :pattern ( (_module.Object.inv $Heap@@18 this@@18))
))))
...
(assert (forall ((bx@@12 T@U) ) (!  (=> ($IsBox bx@@12 Tclass._module.Thread?) ($IsBox bx@@12 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |2434|
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@19 this@@19) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Thread) ($IsAlloc refType this@@19 Tclass._module.Thread $Heap@@19)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@19)) (= (_module.Thread.localInv $Heap@@19 this@@19)  (and true (_module.Object.objectGlobalBaseInv $Heap@@19 this@@19)))))
 :qid |_11MutexGuard2legacydfy.265:19|
 :skolemid |1230|
 :pattern ( (_module.Thread.localInv $Heap@@19 this@@19) ($IsGoodHeap $Heap@@19))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@20 this@@20) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Thread) ($IsAlloc refType this@@20 Tclass._module.Thread $Heap@@20)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@20 this@@20)) (= (_module.Thread.inv $Heap@@20 this@@20)  (and true (_module.Thread.localInv $Heap@@20 this@@20)))))
 :qid |_11MutexGuard2legacydfy.268:19|
 :skolemid |1242|
 :pattern ( (_module.Thread.inv $Heap@@20 this@@20) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@21 this@@21) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Object) ($IsAlloc refType this@@21 Tclass._module.Object $Heap@@21)))))) (= (_module.Object.triggerAxioms $Heap@@21 this@@21)  (and (or ($Is refType this@@21 Tclass._module.OwnedObject) ($Is refType this@@21 Tclass._module.Thread)) (not (and ($Is refType this@@21 Tclass._module.OwnedObject) ($Is refType this@@21 Tclass._module.Thread))))))
 :qid |_11MutexGuard2legacydfy.210:19|
 :skolemid |1091|
 :pattern ( (_module.Object.triggerAxioms $Heap@@21 this@@21) ($IsGoodHeap $Heap@@21))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Object.inv)
...
(let ((anon8_Else_correct  (=> (and (=> (_module.Object.inv $Heap@@22 this@@22) (_module.Object.localInv $Heap@@22 this@@22)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($IsAllocBox ($Box refType this@@22) Tclass._module.Object? $Heap@@22) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (= this@@22 this@@22) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@22 this@@22) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@22 this@@22) (|_module.Object.inv#canCall| $Heap@@22 this@@22)) (_module.Object.inv $Heap@@22 this@@22)) (=> (and (and ($IsAllocBox ($Box refType this@@22) Tclass._module.Object? $Heap@@22) (|_module.Object.localInv#canCall| $Heap@@22 this@@22)) (and (_module.Object.localInv $Heap@@22 this@@22) (= (ControlFlow 0 3) 2))) anon5_correct)))))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#8| null $Heap@@22 alloc $Heap@@22 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Else_correct) (=> (= (ControlFlow 0 6) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@22) ($IsHeapAnchor $Heap@@22)) (=> (and (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Object) ($IsAlloc refType this@@22 Tclass._module.Object $Heap@@22))) (and (= 12 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
