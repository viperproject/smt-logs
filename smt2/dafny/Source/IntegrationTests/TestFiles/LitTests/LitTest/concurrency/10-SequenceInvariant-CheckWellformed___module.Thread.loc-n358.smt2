...
(let ((anon8_correct  (=> (= (_module.Thread.localInv $Heap@@9 this@@9)  (and true (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9))) (=> (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9)) ($Is boolType (bool_2_U (_module.Thread.localInv $Heap@@9 this@@9)) TBool)) (and (=> (= (ControlFlow 0 9) (- 0 10)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 9) 6) GeneratedUnifiedExit_correct)))))))
...
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@9) Tclass._module.Object? $Heap@@9)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_10SequenceInvariantdfy.260:8|
 :skolemid |1209|
))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 11) 9))) anon8_correct))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@9 alloc $Heap@@9 alloc)) (and (and (and (=> (= (ControlFlow 0 13) 11) anon12_Then_correct) (=> (= (ControlFlow 0 13) 12) anon12_Else_correct)) (=> (= (ControlFlow 0 13) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 13) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (=> (and (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.Thread) ($IsAlloc refType this@@9 Tclass._module.Thread $Heap@@9))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
