...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.ConstantInteger) ($IsAlloc refType this@@90 Tclass._module.ConstantInteger $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@66 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@66) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@66) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@66) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |2012|
...
(assert (forall (($o@@69 T@U) ) (!  (=> ($Is refType $o@@69 Tclass._module.ConstantInteger?) ($Is refType $o@@69 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2421|
 :pattern ( ($Is refType $o@@69 Tclass._module.ConstantInteger?))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.ConstantInteger.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#10| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@97) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@97 Tclass._module.ConstantInteger $Heap@@58)) (=> ($IsAlloc refType this@@97 Tclass._module.ConstantInteger $Heap@@58) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@58)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@58) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@97) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@97 Tclass._module.ConstantInteger $Heap@@58))))))))))
