...
(set-info :boogie-vc-id Impl$$_module.IncrementerMethod.Statement9)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 44) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#52| null $Heap@@78 alloc this@@126)) (and (=> (= (ControlFlow 0 2) (- 0 43)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.i))) (LitInt 10))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.i))) (LitInt 10)) (and (=> (= (ControlFlow 0 2) (- 0 42)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@126 _module.IncrementerMethod.programCounter))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@126 _module.IncrementerMethod.programCounter)) (=> (= |$rhs#0@0| (LitInt 10)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.programCounter ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 41)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@126 _module.OwnedObject.nonvolatileVersion))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@126 _module.OwnedObject.nonvolatileVersion)) (=> (= |last##0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.OwnedObject.nonvolatileVersion)))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (> |call2formal@res#0@0| |last##0@0|)) (and (and (forall (($o@@103 T@U) ) (!  (=> (and (or (not (= $o@@103 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@103) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@103) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@103)))
 :qid |_07CounterThreadOwnershipdfy.406:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@103))
)) ($HeapSucc $Heap@0 $Heap@1)) (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 this@@126 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@126) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|))))) ($IsGoodHeap $Heap@2)))) (and (=> (= (ControlFlow 0 2) (- 0 40)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 39)) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78)) (=> ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78) (=> (and (= call0formal@previous$Heap@0 $Heap@@78) (= call2formal@this@0 (_module.Object.universe this@@126))) (=> (and (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (forall ((|o#1@@3| T@U) ) (!  (=> ($Is refType |o#1@@3| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#1@@3|)) (=> (=> ($Is refType |o#1@@3| Tclass._module.OwnedObject) (and (forall (($o@@104 T@U) ($f@@55 T@U) ) (!  (=> (or (not (= $o@@104 null)) (not true)) (=> (= $o@@104 |o#1@@3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@104) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@104) $f@@55))))
 :qid |_07CounterThreadOwnershipdfy.153:12|
 :skolemid |785|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@104) $f@@55))
...
)))) (|_module.Object.transitiveInv2#canCall| call0formal@previous$Heap@0 $Heap@2 |o#1@@3|))))
 :qid |_07CounterThreadOwnershipdfy.151:20|
 :skolemid |787|
 :pattern ( (_module.Object.transitiveInv2 call0formal@previous$Heap@0 $Heap@2 |o#1@@3|))
...
))) (and (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#1@@4|))) (=> (=> ($Is refType |o#1@@4| Tclass._module.OwnedObject) (and (forall (($o@@105 T@U) ($f@@56 T@U) ) (!  (=> (or (not (= $o@@105 null)) (not true)) (=> (= $o@@105 |o#1@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@105) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@105) $f@@56))))
 :qid |_07CounterThreadOwnershipdfy.153:12|
 :skolemid |788|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@105) $f@@56))
)) (forall ((|x#2@@0| T@U) ) (!  (=> (and ($Is refType |x#2@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 (_module.Object.universe |o#1@@4|)) _module.Universe.content)) ($Box refType |x#2@@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |x#2@@0|) _module.OwnedObject.owner)) |o#1@@4|))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |x#2@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |x#2@@0|) _module.OwnedObject.nonvolatileVersion)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |x#2@@0|) _module.OwnedObject.owner)) |o#1@@4|)))
 :qid |_07CounterThreadOwnershipdfy.154:20|
 :skolemid |789|
...
)))) (_module.Object.transitiveInv2 call0formal@previous$Heap@0 $Heap@2 |o#1@@4|)))
 :qid |_07CounterThreadOwnershipdfy.151:20|
 :skolemid |790|
 :pattern ( (_module.Object.transitiveInv2 call0formal@previous$Heap@0 $Heap@2 |o#1@@4|))
...
)) (= $Heap@2 $Heap@3))) (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (not ($Is refType |running#0@@3| Tclass._module.OwnedObject)) (= $Heap@3 $Heap@4)))) (and (=> (= (ControlFlow 0 2) (- 0 38)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 37)) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78)) (=> ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78) (and (=> (= (ControlFlow 0 2) (- 0 36)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@78)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@78) (=> (and (= call0formal@previous$Heap@0@@0 $Heap@@78) (= call2formal@this@0@@0 (_module.Object.universe this@@126))) (and (=> (= (ControlFlow 0 2) (- 0 35)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread call0formal@previous$Heap@0@@0)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread call0formal@previous$Heap@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 34)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (or (_module.Universe.baseLegalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (or (_module.Universe.baseLegalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 33)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (or (_module.Universe.baseLegalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (forall ((|o#0@@12| T@U) ) (!  (=> (and ($Is refType |o#0@@12| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@12|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@12|)))) (not ($IsAllocBox ($Box refType |o#0@@12|) Tclass._module.Object call0formal@previous$Heap@0@@0)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |606|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@12|)))
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (or (_module.Universe.baseLegalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@13|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@13|)))) (not ($IsAllocBox ($Box refType |o#0@@13|) Tclass._module.Object call0formal@previous$Heap@0@@0)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |606|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#0@@13|)))
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 32)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (or (_module.Universe.baseLegalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (forall ((|o#1@@5| T@U) ) (!  (=> (and ($Is refType |o#1@@5| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#1@@5|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 |o#1@@5|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#1@@5|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |607|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#1@@5|) _module.OwnedObject.nonvolatileVersion)))
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (or (_module.Universe.baseLegalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (forall ((|o#1@@6| T@U) ) (!  (=> (and ($Is refType |o#1@@6| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#1@@6|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 |o#1@@6|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#1@@6|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |607|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#1@@6|) _module.OwnedObject.nonvolatileVersion)))
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| call0formal@previous$Heap@0@@0 call2formal@this@0@@0) (or (_module.Universe.globalBaseInv call0formal@previous$Heap@0@@0 call2formal@this@0@@0) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#2|))) (and (= (_module.Object.universe |o#2|) call2formal@this@0@@0) (or (not (= |o#2| call2formal@this@0@@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |610|
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 call2formal@this@0@@0) (or (_module.Universe.globalBaseInv $Heap@4 call2formal@this@0@@0) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#3|))) (and (= (_module.Object.universe |o#3|) call2formal@this@0@@0) (or (not (= |o#3| call2formal@this@0@@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |612|
 :pattern ( (_module.Object.universe |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#3|)))
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 call2formal@this@0@@0) (or (_module.Universe.globalBaseInv $Heap@4 call2formal@this@0@@0) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#3@@0|))) (and (= (_module.Object.universe |o#3@@0|) call2formal@this@0@@0) (or (not (= |o#3@@0| call2formal@this@0@@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |612|
 :pattern ( (_module.Object.universe |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#4|))) (_module.Object.transitiveInv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#4|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |614|
 :pattern ( (_module.Object.transitiveInv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#4|))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#4@@0|))) (_module.Object.transitiveInv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#4@@0|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |614|
 :pattern ( (_module.Object.transitiveInv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#4@@0|))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 call2formal@this@0@@0) (or (_module.Universe.globalBaseInv $Heap@4 call2formal@this@0@@0) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#8|))) (and (= (_module.Object.universe |o#8|) call2formal@this@0@@0) (or (not (= |o#8| call2formal@this@0@@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |622|
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 call2formal@this@0@@0) (or (_module.Universe.globalBaseInv $Heap@4 call2formal@this@0@@0) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#8@@0|))) (and (= (_module.Object.universe |o#8@@0|) call2formal@this@0@@0) (or (not (= |o#8@@0| call2formal@this@0@@0)) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |622|
 :pattern ( (_module.Object.universe |o#8@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#8@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#9|))) (and (or (forall (($o@@106 T@U) ($f@@57 T@U) ) (!  (=> (or (not (= $o@@106 null)) (not true)) (=> (= $o@@106 |o#9|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@106) $f@@57) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 $o@@106) $f@@57))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |624|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@106) $f@@57))
)) (_module.Object.inv $Heap@4 |o#9|)) (or (forall (($o@@107 T@U) ($f@@58 T@U) ) (!  (=> (or (not (= $o@@107 null)) (not true)) (=> (= $o@@107 |o#9|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@107) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 $o@@107) $f@@58))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |625|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@107) $f@@58))
)) (_module.Object.inv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#9|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |626|
 :pattern ( (_module.Object.inv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#9|))
 :pattern ( (_module.Object.inv $Heap@4 |o#9|))
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (forall ((|o#9@@0| T@U) ) (!  (=> (and ($Is refType |o#9@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#9@@0|))) (and (or (forall (($o@@108 T@U) ($f@@59 T@U) ) (!  (=> (or (not (= $o@@108 null)) (not true)) (=> (= $o@@108 |o#9@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@108) $f@@59) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 $o@@108) $f@@59))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |624|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@108) $f@@59))
)) (_module.Object.inv $Heap@4 |o#9@@0|)) (or (forall (($o@@109 T@U) ($f@@60 T@U) ) (!  (=> (or (not (= $o@@109 null)) (not true)) (=> (= $o@@109 |o#9@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@109) $f@@60) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 $o@@109) $f@@60))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |625|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@109) $f@@60))
)) (_module.Object.inv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#9@@0|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |626|
 :pattern ( (_module.Object.inv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#9@@0|))
 :pattern ( (_module.Object.inv $Heap@4 |o#9@@0|))
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#10|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#10|))))) (_module.Object.inv $Heap@4 |o#10|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |627|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#10|)))
))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0 |running#0@@3|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#10@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#10@@0|))))) (_module.Object.inv $Heap@4 |o#10@@0|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |627|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#10@@0|)))
)))) (=> (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (=> (and (and (and (|_module.Universe.globalInv#canCall| $Heap@4 call2formal@this@0@@0) (=> (_module.Universe.globalInv $Heap@4 call2formal@this@0@@0) (|_module.Universe.globalInv2#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0))) (and (|_module.Universe.globalInv#canCall| $Heap@4 call2formal@this@0@@0) (and (_module.Universe.globalInv $Heap@4 call2formal@this@0@@0) (and (_module.Universe.globalBaseInv $Heap@4 call2formal@this@0@@0) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#12|))) (_module.Object.inv $Heap@4 |o#12|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |635|
 :pattern ( (_module.Object.inv $Heap@4 |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#12|)))
)))))) (and (and (|_module.Universe.globalInv2#canCall| call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (and (_module.Universe.globalInv2 call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0) (and (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#13|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#13|)) (_module.Object.inv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#13|)))
 :qid |_07CounterThreadOwnershipdfy.44:16|
 :skolemid |641|
 :pattern ( (_module.Object.inv2 call0formal@previous$Heap@0@@0 $Heap@4 |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call2formal@this@0@@0) _module.Universe.content)) ($Box refType |o#13|)))
...
)) (_module.Universe.baseLegalTransitionsSequence call0formal@previous$Heap@0@@0 $Heap@4 call2formal@this@0@@0)))) (= $Heap@4 $Heap@5))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType this@@126)))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#23| T@U) ) (!  (=> (and ($Is refType |o#23| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#23|))) (and (= (_module.Object.universe |o#23|) (_module.Object.universe this@@126)) (or (not (= |o#23| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3377|
 :pattern ( (_module.Object.universe |o#23|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#23|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Object.baseInv#canCall| $Heap@5 this@@126) (or (_module.Object.baseInv $Heap@5 this@@126) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#23@@0| T@U) ) (!  (=> (and ($Is refType |o#23@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#23@@0|))) (and (= (_module.Object.universe |o#23@@0|) (_module.Object.universe this@@126)) (or (not (= |o#23@@0| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3377|
 :pattern ( (_module.Object.universe |o#23@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#23@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#24| T@U) ) (!  (=> (and ($Is refType |o#24| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#24|))) (and (= (_module.Object.universe |o#24|) (_module.Object.universe this@@126)) (or (not (= |o#24| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3379|
 :pattern ( (_module.Object.universe |o#24|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#24|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#24@@0| T@U) ) (!  (=> (and ($Is refType |o#24@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#24@@0|))) (and (= (_module.Object.universe |o#24@@0|) (_module.Object.universe this@@126)) (or (not (= |o#24@@0| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3379|
 :pattern ( (_module.Object.universe |o#24@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#24@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#25| T@U) ) (!  (=> (and ($Is refType |o#25| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#25|))) (_module.Object.inv $Heap@5 |o#25|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |3381|
 :pattern ( (_module.Object.inv $Heap@5 |o#25|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#25|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@5 this@@126) (or (_module.Object.objectGlobalInv $Heap@5 this@@126) (=> (|_module.Universe.globalInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#25@@0| T@U) ) (!  (=> (and ($Is refType |o#25@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#25@@0|))) (_module.Object.inv $Heap@5 |o#25@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |3381|
 :pattern ( (_module.Object.inv $Heap@5 |o#25@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#25@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv2 $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#26| T@U) ) (!  (=> (and ($Is refType |o#26| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#26|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#26|)) (_module.Object.inv2 $Heap@@78 $Heap@5 |o#26|)))
 :qid |_07CounterThreadOwnershipdfy.44:16|
 :skolemid |3383|
 :pattern ( (_module.Object.inv2 $Heap@@78 $Heap@5 |o#26|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#26|)))
...
))))) (=> (=> (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv2 $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#26@@0| T@U) ) (!  (=> (and ($Is refType |o#26@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#26@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#26@@0|)) (_module.Object.inv2 $Heap@@78 $Heap@5 |o#26@@0|)))
 :qid |_07CounterThreadOwnershipdfy.44:16|
 :skolemid |3383|
 :pattern ( (_module.Object.inv2 $Heap@@78 $Heap@5 |o#26@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#26@@0|)))
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv2 $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)))))))) (=> (=> (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv2 $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv2 $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#27| T@U) ) (!  (=> (and ($Is refType |o#27| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#27|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#27|)))) (not ($IsAllocBox ($Box refType |o#27|) Tclass._module.Object $Heap@@78)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |3384|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#27|)))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv2 $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#28| T@U) ) (!  (=> (and ($Is refType |o#28| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#28|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#28|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#28|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |3385|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#28|) _module.OwnedObject.nonvolatileVersion)))
...
))))))) (=> (=> (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalInv2 $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#28@@0| T@U) ) (!  (=> (and ($Is refType |o#28@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#28@@0|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#28@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#28@@0|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |3385|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#28@@0|) _module.OwnedObject.nonvolatileVersion)))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#29| T@U) ) (!  (=> (and ($Is refType |o#29| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#29|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#29|)))) (not ($IsAllocBox ($Box refType |o#29|) Tclass._module.Object $Heap@@78)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |3389|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#29|)))
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#29@@0| T@U) ) (!  (=> (and ($Is refType |o#29@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#29@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#29@@0|)))) (not ($IsAllocBox ($Box refType |o#29@@0|) Tclass._module.Object $Heap@@78)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |3389|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#29@@0|)))
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#30| T@U) ) (!  (=> (and ($Is refType |o#30| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#30|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#30|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#30|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |3390|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#30|) _module.OwnedObject.nonvolatileVersion)))
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#30@@0| T@U) ) (!  (=> (and ($Is refType |o#30@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#30@@0|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#30@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#30@@0|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |3390|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#30@@0|) _module.OwnedObject.nonvolatileVersion)))
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#32| T@U) ) (!  (=> (and ($Is refType |o#32| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#32|))) (and (= (_module.Object.universe |o#32|) (_module.Object.universe this@@126)) (or (not (= |o#32| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3395|
 :pattern ( (_module.Object.universe |o#32|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#32|)))
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#32@@0| T@U) ) (!  (=> (and ($Is refType |o#32@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#32@@0|))) (and (= (_module.Object.universe |o#32@@0|) (_module.Object.universe this@@126)) (or (not (= |o#32@@0| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3395|
 :pattern ( (_module.Object.universe |o#32@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#32@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#33| T@U) ) (!  (=> (and ($Is refType |o#33| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#33|))) (_module.Object.transitiveInv2 $Heap@@78 $Heap@5 |o#33|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |3397|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@78 $Heap@5 |o#33|))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#33@@0| T@U) ) (!  (=> (and ($Is refType |o#33@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#33@@0|))) (_module.Object.transitiveInv2 $Heap@@78 $Heap@5 |o#33@@0|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |3397|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@78 $Heap@5 |o#33@@0|))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#34| T@U) ) (!  (=> (and ($Is refType |o#34| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#34|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#34|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#34|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#34|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@78)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#34|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#34|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |3398|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#34|) _module.OwnedObject.nonvolatileVersion)))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@78 $Heap@5 (_module.Object.universe this@@126) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#34@@0| T@U) ) (!  (=> (and ($Is refType |o#34@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#34@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#34@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#34@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#34@@0|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@78)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 |o#34@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#34@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |3398|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |o#34@@0|) _module.OwnedObject.nonvolatileVersion)))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#37| T@U) ) (!  (=> (and ($Is refType |o#37| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#37|))) (and (= (_module.Object.universe |o#37|) (_module.Object.universe this@@126)) (or (not (= |o#37| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3405|
 :pattern ( (_module.Object.universe |o#37|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#37|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 (_module.Object.universe this@@126)) (or (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@126)) (forall ((|o#37@@0| T@U) ) (!  (=> (and ($Is refType |o#37@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#37@@0|))) (and (= (_module.Object.universe |o#37@@0|) (_module.Object.universe this@@126)) (or (not (= |o#37@@0| (_module.Object.universe this@@126))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |3405|
 :pattern ( (_module.Object.universe |o#37@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#37@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (forall ((|o#38| T@U) ) (!  (=> (and ($Is refType |o#38| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#38|))) (and (or (forall (($o@@110 T@U) ($f@@61 T@U) ) (!  (=> (or (not (= $o@@110 null)) (not true)) (=> (= $o@@110 |o#38|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@110) $f@@61) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@110) $f@@61))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |3407|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@110) $f@@61))
)) (_module.Object.inv $Heap@5 |o#38|)) (or (forall (($o@@111 T@U) ($f@@62 T@U) ) (!  (=> (or (not (= $o@@111 null)) (not true)) (=> (= $o@@111 |o#38|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@111) $f@@62) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@111) $f@@62))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |3408|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@111) $f@@62))
)) (_module.Object.inv2 $Heap@@78 $Heap@5 |o#38|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |3409|
 :pattern ( (_module.Object.inv2 $Heap@@78 $Heap@5 |o#38|))
 :pattern ( (_module.Object.inv $Heap@5 |o#38|))
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (forall ((|o#38@@0| T@U) ) (!  (=> (and ($Is refType |o#38@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#38@@0|))) (and (or (forall (($o@@112 T@U) ($f@@63 T@U) ) (!  (=> (or (not (= $o@@112 null)) (not true)) (=> (= $o@@112 |o#38@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@112) $f@@63) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@112) $f@@63))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |3407|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@112) $f@@63))
)) (_module.Object.inv $Heap@5 |o#38@@0|)) (or (forall (($o@@113 T@U) ($f@@64 T@U) ) (!  (=> (or (not (= $o@@113 null)) (not true)) (=> (= $o@@113 |o#38@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@113) $f@@64) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@113) $f@@64))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |3408|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@113) $f@@64))
)) (_module.Object.inv2 $Heap@@78 $Heap@5 |o#38@@0|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |3409|
 :pattern ( (_module.Object.inv2 $Heap@@78 $Heap@5 |o#38@@0|))
 :pattern ( (_module.Object.inv $Heap@5 |o#38@@0|))
...
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@78 $Heap@5 (_module.Object.universe this@@126) |running#0@@3|) (forall ((|o#39| T@U) ) (!  (=> (and ($Is refType |o#39| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#39|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |o#39|))))) (_module.Object.inv $Heap@5 |o#39|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |3410|
 :pattern ( (_module.Object.inv $Heap@5 |o#39|))
