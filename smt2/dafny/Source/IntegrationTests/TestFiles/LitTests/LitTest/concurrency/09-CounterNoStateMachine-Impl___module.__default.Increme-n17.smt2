...
)) ($HeapSucc $Heap@@59 $Heap@0)) (and (= |i#0@0| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1)))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
