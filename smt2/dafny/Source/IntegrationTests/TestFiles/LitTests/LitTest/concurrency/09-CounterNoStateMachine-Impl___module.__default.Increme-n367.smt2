...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split356)
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))) (and (and (and ($IsGoodHeap $Heap@33) ($IsHeapAnchor $Heap@33)) (|_module.Universe.globalInv#canCall| $Heap@33 |universe#0|)) (and (and (|_module.Universe.globalInv#canCall| $Heap@33 |universe#0|) (and (_module.Universe.globalInv $Heap@33 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@33 |universe#0|) (forall ((|o#5@@13| T@U) ) (!  (=> (and ($Is refType |o#5@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@13|))) (_module.Object.inv $Heap@33 |o#5@@13|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |904|
...
)) ($HeapSucc $Heap@32 $Heap@33))) (and (and (U_2_bool (Lit boolType (bool_2_U false))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)) (and ($IsAllocBox ($Box refType |running#0@@3|) Tclass._module.Object? $Heap@33) (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|)))) (and (and (and (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|) (_module.Object.triggerAxioms $Heap@33 |running#0@@3|)) (and (or (not (= |remaining#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |remaining#0| _module.Integer.value)))) (and (and (or (not (= |remaining#0| null)) (not true)) (= |$rhs#0_6@1| (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.Integer.value))) 1))) (and (= $Heap@34 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.Integer.value ($Box intType (int_2_U |$rhs#0_6@1|))))) ($IsGoodHeap $Heap@34))))) (and (and (and (and (or (not (= |remaining#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |remaining#0| _module.OwnedObject.nonvolatileVersion))) (and (or (not (= |remaining#0| null)) (not true)) (= |last##0_0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 |remaining#0|) _module.OwnedObject.nonvolatileVersion)))))) (and (and ($IsGoodHeap $Heap@35) ($IsHeapAnchor $Heap@35)) (> |call2formal@res#0@0| |last##0_0@1|))) (and (and (and (forall (($o@@179 T@U) ) (!  (=> (and (or (not (= $o@@179 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 $o@@179) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 $o@@179) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 $o@@179)))
 :qid |_09CounterNoStateMachinedfy.450:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 $o@@179))
)) ($HeapSucc $Heap@34 $Heap@35)) (and (= $Heap@36 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0|) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|))))) ($IsGoodHeap $Heap@36))) (and (and ($IsAllocBox ($Box refType |remaining#0|) Tclass._module.OwnedObject? $Heap@36) ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap@33)) (and (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|) (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|))))))) (and (and (and (and (and (and (_module.OwnedObject.inv2 $Heap@33 $Heap@36 |remaining#0|) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@36)) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|))) (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|) (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@36 |universe#0|)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)))) (and (and (and ($IsGoodHeap $Heap@37) ($IsHeapAnchor $Heap@37)) (and (forall ((|o#1@@41| T@U) ) (!  (=> ($Is refType |o#1@@41| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@41|)) (=> (=> ($Is refType |o#1@@41| Tclass._module.OwnedObject) (and (forall (($o@@180 T@U) ($f@@120 T@U) ) (!  (=> (or (not (= $o@@180 null)) (not true)) (=> (= $o@@180 |o#1@@41|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 $o@@180) $f@@120) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@180) $f@@120))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
...
)))) (and (and (= $Heap@36 $Heap@37) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37)) (and (= |##running#0_0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) ($IsAlloc SetType |##running#0_0@1| (TSet Tclass._module.Thread) $Heap@37))))) (and (and (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (TSet Tclass._module.Thread) $Heap@33)) (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))))) (and (and (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@37) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)))) (and (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33) (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|)) (and (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33)))))) (and (and (and (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@37 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@37 |universe#0|) (forall ((|o#0@@32| T@U) ) (!  (=> (and ($Is refType |o#0@@32| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|)))) (not ($IsAllocBox ($Box refType |o#0@@32|) Tclass._module.Object $Heap@33)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |771|
...
)))))))) (and (and (and (and ($IsGoodHeap $Heap@38) ($IsHeapAnchor $Heap@38)) (and (|_module.Universe.globalInv#canCall| $Heap@37 |universe#0|) (=> (_module.Universe.globalInv $Heap@37 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@33 $Heap@37 |universe#0|)))) (and (and (|_module.Universe.globalInv#canCall| $Heap@37 |universe#0|) (and (_module.Universe.globalInv $Heap@37 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@37 |universe#0|) (forall ((|o#17@@9| T@U) ) (!  (=> (and ($Is refType |o#17@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@9|))) (_module.Object.inv $Heap@37 |o#17@@9|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))))) (and (and (and (= $Heap@37 $Heap@38) (or (not (= |universe#0| null)) (not true))) (and (forall (($o@@185 T@U) ($f@@125 T@U) ) (!  (=> (and (and (or (not (= $o@@185 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@185) alloc)))) (or (= $o@@185 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType $o@@185)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@185 $f@@125)))
