...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split145)
...
)))) (= $Heap@11 $Heap@12)) (and (U_2_bool (Lit boolType (bool_2_U true))) (or (not (= |scope#0| null)) (not true)))) (and (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |scope#0| _module.Lifetime.owner)) (= $Heap@13 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@12 |scope#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |scope#0|) _module.Lifetime.owner ($Box refType null))))) (and ($IsGoodHeap $Heap@13) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= |universe#0| null)) (not true))))))))
