...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split93)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon2_correct  (=> (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222)))) (=> (and (and (and (and (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222))) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11)) (and (= |##a#4@0| (_module.OwnedObject.lifetime |mutex#0|)) ($IsAlloc refType |##a#4@0| Tclass._module.Lifetime $Heap@11))) (and (and (= |##b#4@0| (_module.OwnedObject.lifetime this@@222)) ($IsAlloc refType |##b#4@0| Tclass._module.Lifetime $Heap@11)) (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222))))) (and (and (and (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) ($IsAllocBox ($Box refType call5formal@this@0) Tclass._module.Lifetime? $Heap@11)) (and (|_module.Lifetime.alive#canCall| $Heap@11 call5formal@this@0) (|_module.Lifetime.alive#canCall| $Heap@11 call5formal@this@0))) (and (and (_module.Lifetime.alive $Heap@11 call5formal@this@0) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |mutex#0|) _module.OwnedObject.owner)) null)) (not true))) (and ($IsAllocBox ($Box refType this@@222) Tclass._module.MutexGuardU32? $Heap@11) (|_module.MutexGuardU32.localUserInv#canCall| $Heap@11 this@@222)))) (and (and (and (|_module.MutexGuardU32.localUserInv#canCall| $Heap@11 this@@222) (_module.MutexGuardU32.localUserInv $Heap@11 this@@222)) (and ($IsAllocBox ($Box refType this@@222) Tclass._module.MutexGuardU32? $Heap@11) (|_module.MutexGuardU32.userInv#canCall| $Heap@11 this@@222))) (and (and (|_module.MutexGuardU32.userInv#canCall| $Heap@11 this@@222) (= (ControlFlow 0 2) (- 0 1))) (|_module.MutexGuardU32.userInv#canCall| $Heap@11 this@@222))))) (or (_module.MutexGuardU32.userInv $Heap@11 this@@222) (=> (|_module.OwnedObject.localInv#canCall| $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) (or (_module.OwnedObject.localInv $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex)))) _module.Lifetime.elements)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex)))))))))
