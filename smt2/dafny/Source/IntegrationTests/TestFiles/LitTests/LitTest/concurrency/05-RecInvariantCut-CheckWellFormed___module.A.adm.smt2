...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@34 T@U) ($f@@14 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3|) $o@@34 $f@@14))  (=> (and (or (not (= $o@@34 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@34) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1031|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3|) $o@@34 $f@@14))
)))
(assert (forall (($h0@@7 T@U) ($h1@@7 T@U) (this@@19 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Universe) ($IsAlloc refType this@@19 Tclass._module.Universe $h0@@7)))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@35 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@35 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@35) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@35) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@35) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |502|
...
(assert (forall (($h0@@8 T@U) ($h1@@8 T@U) (this@@20 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Object) ($IsAlloc refType this@@20 Tclass._module.Object $h0@@8)))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@36 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@36 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@36) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@36) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@36) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |616|
...
(assert (forall (($h0@@9 T@U) ($h1@@9 T@U) (this@@21 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@9) ($IsGoodHeap $h1@@9)) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Object) ($IsAlloc refType this@@21 Tclass._module.Object $h0@@9)))) (and ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9))) (=> (forall (($o@@37 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@37 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@37) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@37) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@9 $o@@37) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |661|
...
(assert (forall (($h0@@10 T@U) ($h1@@10 T@U) (this@@22 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.A) ($IsAlloc refType this@@22 Tclass._module.A $h0@@10)))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@38 T@U) ($f@@18 T@U) ) (!  (=> (and (or (not (= $o@@38 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@38) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@38) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@38) $f@@18)))
 :qid |unknown.0:0|
 :skolemid |703|
...
(assert (forall (($h0@@11 T@U) ($h1@@11 T@U) (this@@23 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.A) ($IsAlloc refType this@@23 Tclass._module.A $h0@@11)))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@39 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@39 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@39) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@39) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@39) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |714|
...
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@24 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.B) ($IsAlloc refType this@@24 Tclass._module.B $h0@@12)))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@40 T@U) ($f@@20 T@U) ) (!  (=> (and (or (not (= $o@@40 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@40) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@40) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@40) $f@@20)))
 :qid |unknown.0:0|
 :skolemid |865|
...
(assert (forall (($o@@42 T@U) ) (!  (=> ($Is refType $o@@42 Tclass._module.A?) ($Is refType $o@@42 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |1023|
 :pattern ( ($Is refType $o@@42 Tclass._module.A?))
)))
...
(assert (forall (($o@@43 T@U) ) (!  (=> ($Is refType $o@@43 Tclass._module.B?) ($Is refType $o@@43 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |1027|
 :pattern ( ($Is refType $o@@43 Tclass._module.B?))
)))
...
(assert (forall (($h@@20 T@U) ($o@@46 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@46 null)) (not true)) ($Is refType $o@@46 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@46) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@46) _module.Universe.content)) (TSet Tclass._module.Object) $h@@20))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |489|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@46) _module.Universe.content)))
)))
...
)) (|_module.Universe.legalTransition#canCall| $prevHeap@@13 $Heap@@16 (_module.Object.universe this@@30))))))) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@13 $Heap@@16 this@@30)  (and (and (and (and (_module.Object.baseInv $prevHeap@@13 this@@30) (_module.Universe.globalInv $prevHeap@@13 (_module.Object.universe this@@30))) (_module.Object.baseInv $Heap@@16 this@@30)) (forall (($o@@49 T@U) ($f@@23 T@U) ) (!  (=> (or (not (= $o@@49 null)) (not true)) (=> (= $o@@49 this@@30) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 $o@@49) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@13 $o@@49) $f@@23))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |637|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 $o@@49) $f@@23))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.A.adm)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#4| null current$Heap alloc false)) ($IsAllocBox ($Box refType this@@31) Tclass._module.Object? current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@31 Tclass._module.A $Heap@@17)) (=> ($IsAlloc refType this@@31 Tclass._module.A $Heap@@17) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@17 current$Heap this@@31) (_module.Object.goodPreAndLegalChanges $Heap@@17 current$Heap this@@31)) (and ($IsAllocBox ($Box refType this@@31) Tclass._module.A? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@31 Tclass._module.A $Heap@@17)))))))
