...
(set-info :boogie-vc-id Impl$$_module.EmptyType.admissibility)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@49) ($IsHeapAnchor $Heap@@49)) (and (or (not (= this@@84 null)) (not true)) (and ($Is refType this@@84 Tclass._module.EmptyType) ($IsAlloc refType this@@84 Tclass._module.EmptyType previous$Heap)))) (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap@@49) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (and (and (|_module.Object.goodPreAndLegalChanges#canCall| previous$Heap current$Heap this@@84 |running#0@@5|) (and (_module.Object.goodPreAndLegalChanges previous$Heap current$Heap this@@84 |running#0@@5|) (and (and (and (and (_module.Object.baseInv previous$Heap this@@84) (_module.Universe.globalInv previous$Heap (_module.Object.universe this@@84))) (_module.Object.baseInv current$Heap this@@84)) (forall (($o@@68 T@U) ($f@@44 T@U) ) (!  (=> (or (not (= $o@@68 null)) (not true)) (=> (= $o@@68 this@@84) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@68) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@68) $f@@44))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |1577|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@68) $f@@44))
