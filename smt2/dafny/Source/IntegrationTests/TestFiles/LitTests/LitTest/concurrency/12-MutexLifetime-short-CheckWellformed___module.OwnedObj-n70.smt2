...
(assert (distinct TagSet alloc allocName Tagclass._module.Object Tagclass._module.OwnedObject Tagclass._module.Object? Tagclass._module.Lifetime Tagclass._module.Lifetime? class._module.OwnedObject? Tagclass._module.OwnedObject? tytagFamily$Object tytagFamily$OwnedObject tytagFamily$Lifetime field$owner)
)
(assert (= (FDim alloc) 0))
...
(let ((anon8_Else_correct  (=> (and (and ($IsAllocBox ($Box refType this@@4) Tclass._module.OwnedObject? $Heap@@4) (= |b$reqreads#0@0| (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@14) alloc)))) (= $o@@14 this@@4)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.427:5|
 :skolemid |1775|
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#103| null $Heap@@4 alloc this@@4)) (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))
