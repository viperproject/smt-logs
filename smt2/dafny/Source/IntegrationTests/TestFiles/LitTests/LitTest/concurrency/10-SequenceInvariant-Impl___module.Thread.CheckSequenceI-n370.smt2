...
(assert (forall (($prevHeap@@2 T@U) ($h0@@1 T@U) ($h1@@1 T@U) (this@@10 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.Universe) ($IsAlloc refType this@@10 Tclass._module.Universe $h0@@1)))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@3 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@3) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@3) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@3) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |654|
)) (= (_module.Universe.baseLegalTransitionsSequence $prevHeap@@2 $h0@@1 this@@10) (_module.Universe.baseLegalTransitionsSequence $prevHeap@@2 $h1@@1 this@@10))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |655|
 :pattern ( ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1) (_module.Universe.baseLegalTransitionsSequence $prevHeap@@2 $h1@@1 this@@10))
)))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@8 this@@14) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@8) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Object) ($IsAlloc refType this@@14 Tclass._module.Object $Heap@@8)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 (_module.Object.universe this@@14)) _module.Universe.content)) ($Box refType this@@14)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@8 this@@14) (=> (_module.Object.baseFieldsInv $Heap@@8 this@@14) (|_module.Universe.globalBaseInv#canCall| $Heap@@8 (_module.Object.universe this@@14))))) (= (_module.Object.objectGlobalBaseInv $Heap@@8 this@@14)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 (_module.Object.universe this@@14)) _module.Universe.content)) ($Box refType this@@14)) (_module.Object.baseFieldsInv $Heap@@8 this@@14)) (_module.Universe.globalBaseInv $Heap@@8 (_module.Object.universe this@@14))))))
 :qid |_10SequenceInvariantdfy.196:19|
 :skolemid |1046|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@8 this@@14) ($IsGoodHeap $Heap@@8))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@9 this@@15) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Thread) ($IsAlloc refType this@@15 Tclass._module.Thread $Heap@@9)))))) (= (_module.Thread.baseFieldsInv $Heap@@9 this@@15) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.254:19|
 :skolemid |1191|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@9 this@@15) ($IsGoodHeap $Heap@@9))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@10 this@@16) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.OwnedObject) ($IsAlloc refType this@@16 Tclass._module.OwnedObject $Heap@@10)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@10 this@@16) (=> (_module.Object.objectGlobalBaseInv $Heap@@10 this@@16) (|_module.OwnedObject.localUserInv#canCall| $Heap@@10 this@@16))) (= (_module.OwnedObject.localInv $Heap@@10 this@@16)  (and (_module.Object.objectGlobalBaseInv $Heap@@10 this@@16) (_module.OwnedObject.localUserInv $Heap@@10 this@@16)))))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1460|
 :pattern ( (_module.OwnedObject.localInv $Heap@@10 this@@16) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@11 this@@17) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.OwnedObject) ($IsAlloc refType this@@17 Tclass._module.OwnedObject $Heap@@11)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@11 this@@17) (=> (_module.OwnedObject.localInv $Heap@@11 this@@17) (|_module.OwnedObject.userInv#canCall| $Heap@@11 this@@17))) (= (_module.OwnedObject.inv $Heap@@11 this@@17)  (and (_module.OwnedObject.localInv $Heap@@11 this@@17) (_module.OwnedObject.userInv $Heap@@11 this@@17)))))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1473|
 :pattern ( (_module.OwnedObject.inv $Heap@@11 this@@17) ($IsGoodHeap $Heap@@11))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@6 T@U) ($Heap@@12 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@6 $Heap@@12 this@@18) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@18 null)) (not true)) ($Is refType this@@18 Tclass._module.Thread)))) (= (_module.Object.sequenceInv2 $prevHeap@@6 $Heap@@12 this@@18) (_module.Thread.sequenceInv2 $prevHeap@@6 $Heap@@12 this@@18)))
 :qid |_10SequenceInvariantdfy.244:22|
 :skolemid |1237|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@6 $Heap@@12 this@@18) ($Is refType this@@18 Tclass._module.Thread) ($IsGoodHeap $Heap@@12))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@6 $Heap@@12 this@@18) (_module.Thread.sequenceInv2 $prevHeap@@6 $Heap@@12 this@@18) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@7 T@U) ($Heap@@13 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@7 $Heap@@13 this@@19) (and (< 3 $FunctionContextHeight) (and (or (not (= this@@19 null)) (not true)) ($Is refType this@@19 Tclass._module.OwnedObject)))) (= (_module.Object.sequenceInv2 $prevHeap@@7 $Heap@@13 this@@19) (_module.OwnedObject.sequenceInv2 $prevHeap@@7 $Heap@@13 this@@19)))
 :qid |_10SequenceInvariantdfy.244:22|
 :skolemid |1495|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@7 $Heap@@13 this@@19) ($Is refType this@@19 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@13))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@7 $Heap@@13 this@@19) (_module.OwnedObject.sequenceInv2 $prevHeap@@7 $Heap@@13 this@@19) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@14 this@@20) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Universe) ($IsAlloc refType this@@20 Tclass._module.Universe $Heap@@14)))))) (and (forall ((|o#0@@2| T@U) ) (!  (=> ($Is refType |o#0@@2| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@20) _module.Universe.content)) ($Box refType |o#0@@2|)) (=> (= (_module.Object.universe |o#0@@2|) this@@20) (=> (or (not (= |o#0@@2| this@@20)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@14 |o#0@@2|) (=> (_module.Object.baseFieldsInv $Heap@@14 |o#0@@2|) (|_module.Object.triggerAxioms#canCall| $Heap@@14 |o#0@@2|)))))))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@20) _module.Universe.content)) ($Box refType |o#0@@2|)))
)) (= (_module.Universe.globalBaseInv $Heap@@14 this@@20) (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@20) _module.Universe.content)) ($Box refType |o#0@@3|))) (and (and (and (= (_module.Object.universe |o#0@@3|) this@@20) (or (not (= |o#0@@3| this@@20)) (not true))) (_module.Object.baseFieldsInv $Heap@@14 |o#0@@3|)) (_module.Object.triggerAxioms $Heap@@14 |o#0@@3|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@20) _module.Universe.content)) ($Box refType |o#0@@3|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@14 this@@20) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@17 this@@27) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Object) ($IsAlloc refType this@@27 Tclass._module.Object $Heap@@17)))))) (_module.Object.triggerAxioms $Heap@@17 this@@27))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1064|
 :pattern ( (_module.Object.triggerAxioms $Heap@@17 this@@27))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@18 this@@28) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.OwnedObject) ($IsAlloc refType this@@28 Tclass._module.OwnedObject $Heap@@18)))))) (=> (_module.OwnedObject.userInv $Heap@@18 this@@28) (_module.OwnedObject.localUserInv $Heap@@18 this@@28)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1549|
 :pattern ( (_module.OwnedObject.userInv $Heap@@18 this@@28))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@23 this@@33) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.OwnedObject) ($IsAlloc refType this@@33 Tclass._module.OwnedObject $Heap@@23)))))) (=> (_module.OwnedObject.inv $Heap@@23 this@@33) (_module.OwnedObject.localInv $Heap@@23 this@@33)))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1471|
 :pattern ( (_module.OwnedObject.inv $Heap@@23 this@@33))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@24 T@U) (this@@34 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@24 this@@34) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@24) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.Object) ($IsAlloc refType this@@34 Tclass._module.Object $Heap@@24)))))) (=> (_module.Object.inv $Heap@@24 this@@34) (_module.Object.localInv $Heap@@24 this@@34)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1126|
 :pattern ( (_module.Object.inv $Heap@@24 this@@34))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@9 T@U) ($Heap@@25 T@U) (this@@35 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@9 $Heap@@25 this@@35) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@9) ($IsGoodHeap $Heap@@25)) ($HeapSucc $prevHeap@@9 $Heap@@25)) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.OwnedObject) ($IsAlloc refType this@@35 Tclass._module.OwnedObject $prevHeap@@9)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@9 this@@35) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@35) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@9 $Heap@@25 this@@35)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@9 $Heap@@25 this@@35)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@9 this@@35) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@35) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@9 $Heap@@25 this@@35)))))
 :qid |_10SequenceInvariantdfy.312:22|
 :skolemid |1438|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@9 $Heap@@25 this@@35) ($IsGoodHeap $Heap@@25))
))))
...
(assert (forall (($h0@@9 T@U) ($h1@@9 T@U) (this@@36 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@9) ($IsGoodHeap $h1@@9)) (and (or (not (= this@@36 null)) (not true)) ($Is refType this@@36 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9))) (=> (forall (($o@@21 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (= $o@@21 this@@36)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@21) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@9 $o@@21) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |1062|
)) (= (_module.Object.triggerAxioms $h0@@9 this@@36) (_module.Object.triggerAxioms $h1@@9 this@@36))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1063|
 :pattern ( ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9) (_module.Object.triggerAxioms $h1@@9 this@@36))
)))
(assert (forall (($h0@@10 T@U) ($h1@@10 T@U) (this@@37 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@37 null)) (not true)) ($Is refType this@@37 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@22 T@U) ($f@@11 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (or (= $o@@22 this@@37) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 this@@37) _module.Universe.content)) ($Box refType $o@@22)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@22) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@22) $f@@11)))
 :qid |unknown.0:0|
 :skolemid |608|
)) (= (_module.Universe.globalBaseInv $h0@@10 this@@37) (_module.Universe.globalBaseInv $h1@@10 this@@37))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |609|
 :pattern ( ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10) (_module.Universe.globalBaseInv $h1@@10 this@@37))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@10 T@U) ($Heap@@26 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@10 $Heap@@26 this@@38) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@10) ($IsGoodHeap $Heap@@26)) ($HeapSucc $prevHeap@@10 $Heap@@26)) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.OwnedObject) ($IsAlloc refType this@@38 Tclass._module.OwnedObject $prevHeap@@10)))))) (and (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@38) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@38) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@10 $Heap@@26 this@@38)))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@10 $Heap@@26 this@@38)  (and (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@38) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@38) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@10 $Heap@@26 this@@38)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@38) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@38) _module.OwnedObject.owner))))
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@38) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_10SequenceInvariantdfy.338:22|
 :skolemid |1494|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@10 $Heap@@26 this@@38) ($IsGoodHeap $Heap@@26))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon10_correct  (=> (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 (_module.Object.universe this@@53)) (=> (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 (_module.Object.universe this@@53)) (forall ((|o#7| T@U) ) (!  (=> ($Is refType |o#7| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#7|)) (|_module.Object.sequenceInv2#canCall| $Heap@0 $Heap@1 |o#7|)))
 :qid |_10SequenceInvariantdfy.289:66|
 :skolemid |1393|
...
))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Thread.sequenceInv2#canCall| $Heap@@30 $Heap@1 this@@53)) (or (_module.Thread.sequenceInv2 $Heap@@30 $Heap@1 this@@53) (U_2_bool (Lit boolType (bool_2_U true))))))))
(let ((anon16_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#6@0|))) (= (ControlFlow 0 8) 2)) anon10_correct)))
(let ((anon16_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#6@0|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (not (= |o#6@0| null)) (not true))) (=> ($IsAllocBox ($Box refType |o#6@0|) Tclass._module.Object? $Heap@1) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($IsAlloc refType |o#6@0| Tclass._module.Object $Heap@0)) (=> ($IsAlloc refType |o#6@0| Tclass._module.Object $Heap@0) (=> (and (|_module.Object.sequenceInv2#canCall| $Heap@0 $Heap@1 |o#6@0|) (= (ControlFlow 0 5) 2)) anon10_correct))))))))
(let ((anon15_Then_correct  (=> (and ($Is refType |o#6@0| Tclass._module.Object) ($IsAlloc refType |o#6@0| Tclass._module.Object $Heap@1)) (and (=> (= (ControlFlow 0 9) (- 0 12)) ($IsAlloc refType this@@53 Tclass._module.Thread $Heap@0)) (=> ($IsAlloc refType this@@53 Tclass._module.Thread $Heap@0) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (and (=> (= (ControlFlow 0 9) (- 0 10)) ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@0)) (=> ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@0) (and (=> (= (ControlFlow 0 9) 5) anon16_Then_correct) (=> (= (ControlFlow 0 9) 8) anon16_Else_correct))))))))))
...
(let ((anon14_Then_correct  (=> (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 (_module.Object.universe this@@53)) (and (=> (= (ControlFlow 0 13) 9) anon15_Then_correct) (=> (= (ControlFlow 0 13) 4) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (not (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 (_module.Object.universe this@@53))) (= (ControlFlow 0 3) 2)) anon10_correct)))
(let ((anon5_correct  (=> (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@30 $Heap@0 (_module.Object.universe this@@53)) (=> (_module.Universe.baseLegalTransitionsSequence $Heap@@30 $Heap@0 (_module.Object.universe this@@53)) (forall ((|o#5| T@U) ) (!  (=> ($Is refType |o#5| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#5|)) (|_module.Object.sequenceInv2#canCall| $Heap@@30 $Heap@0 |o#5|)))
 :qid |_10SequenceInvariantdfy.286:62|
 :skolemid |1390|
...
)))) (and (=> (= (ControlFlow 0 14) (- 0 19)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@53) null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 18)) (forall (($o@@43 T@U) ($f@@23 T@U) ) (!  (=> (and (and (or (not (= $o@@43 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@43) alloc)))) (or (= $o@@43 (_module.Object.universe this@@53)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType $o@@43)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@43 $f@@23)))
 :qid |_10SequenceInvariantdfy.288:19|
 :skolemid |1392|
...
)))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@1 call0formal@this@0) (=> (_module.Universe.globalBaseInv $Heap@1 call0formal@this@0) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 call0formal@this@0))) (and (|_module.Universe.globalBaseInv#canCall| $Heap@1 call0formal@this@0) (and (_module.Universe.globalBaseInv $Heap@1 call0formal@this@0) (forall ((|o#1| T@U) ) (!  (=> (and ($Is refType |o#1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call0formal@this@0) _module.Universe.content)) ($Box refType |o#1|))) (and (and (and (= (_module.Object.universe |o#1|) call0formal@this@0) (or (not (= |o#1| call0formal@this@0)) (not true))) (_module.Object.baseFieldsInv $Heap@1 |o#1|)) (_module.Object.triggerAxioms $Heap@1 |o#1|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |829|
...
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@53)) Tclass._module.Universe? $Heap@1) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@0)) (=> ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@0) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 (_module.Object.universe this@@53)) (and (=> (= (ControlFlow 0 14) 13) anon14_Then_correct) (=> (= (ControlFlow 0 14) 3) anon14_Else_correct)))))))))))))))))))
(let ((anon13_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#4@0|))) (= (ControlFlow 0 25) 14)) anon5_correct)))
(let ((anon13_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType |o#4@0|)) (and (=> (= (ControlFlow 0 22) (- 0 24)) (or (not (= |o#4@0| null)) (not true))) (=> ($IsAllocBox ($Box refType |o#4@0|) Tclass._module.Object? $Heap@0) (and (=> (= (ControlFlow 0 22) (- 0 23)) ($IsAlloc refType |o#4@0| Tclass._module.Object $Heap@@30)) (=> ($IsAlloc refType |o#4@0| Tclass._module.Object $Heap@@30) (=> (and (|_module.Object.sequenceInv2#canCall| $Heap@@30 $Heap@0 |o#4@0|) (= (ControlFlow 0 22) 14)) anon5_correct))))))))
(let ((anon12_Then_correct  (=> (and ($Is refType |o#4@0| Tclass._module.Object) ($IsAlloc refType |o#4@0| Tclass._module.Object $Heap@0)) (and (=> (= (ControlFlow 0 26) (- 0 29)) ($IsAlloc refType this@@53 Tclass._module.Thread $Heap@@30)) (=> ($IsAlloc refType this@@53 Tclass._module.Thread $Heap@@30) (and (=> (= (ControlFlow 0 26) (- 0 28)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (and (=> (= (ControlFlow 0 26) (- 0 27)) ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@30)) (=> ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@30) (and (=> (= (ControlFlow 0 26) 22) anon13_Then_correct) (=> (= (ControlFlow 0 26) 25) anon13_Else_correct))))))))))
...
(let ((anon11_Then_correct  (=> (_module.Universe.baseLegalTransitionsSequence $Heap@@30 $Heap@0 (_module.Object.universe this@@53)) (and (=> (= (ControlFlow 0 30) 26) anon12_Then_correct) (=> (= (ControlFlow 0 30) 21) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (not (_module.Universe.baseLegalTransitionsSequence $Heap@@30 $Heap@0 (_module.Object.universe this@@53))) (= (ControlFlow 0 20) 14)) anon5_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@30 alloc (_module.Object.universe this@@53) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)))) (and (=> (= (ControlFlow 0 31) (- 0 36)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@53) null)) (not true)) (and (=> (= (ControlFlow 0 31) (- 0 35)) (forall (($o@@46 T@U) ($f@@25 T@U) ) (!  (=> (and (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 $o@@46) alloc)))) (or (= $o@@46 (_module.Object.universe this@@53)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType $o@@46)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@46 $f@@25)))
 :qid |_10SequenceInvariantdfy.285:19|
 :skolemid |1389|
...
)))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@0 call0formal@this@0@@0) (=> (_module.Universe.globalBaseInv $Heap@0 call0formal@this@0@@0) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@30 $Heap@0 call0formal@this@0@@0))) (and (|_module.Universe.globalBaseInv#canCall| $Heap@0 call0formal@this@0@@0) (and (_module.Universe.globalBaseInv $Heap@0 call0formal@this@0@@0) (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0@@0) _module.Universe.content)) ($Box refType |o#1@@0|))) (and (and (and (= (_module.Object.universe |o#1@@0|) call0formal@this@0@@0) (or (not (= |o#1@@0| call0formal@this@0@@0)) (not true))) (_module.Object.baseFieldsInv $Heap@0 |o#1@@0|)) (_module.Object.triggerAxioms $Heap@0 |o#1@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |829|
...
)) ($HeapSucc $Heap@@30 $Heap@0)))) (and (=> (= (ControlFlow 0 31) (- 0 33)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@53)) Tclass._module.Universe? $Heap@0) (and (=> (= (ControlFlow 0 31) (- 0 32)) ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@30)) (=> ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@30) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@30 $Heap@0 (_module.Object.universe this@@53)) (and (=> (= (ControlFlow 0 31) 30) anon11_Then_correct) (=> (= (ControlFlow 0 31) 20) anon11_Else_correct)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@30) ($IsHeapAnchor $Heap@@30)) (=> (and (and (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Thread) ($IsAlloc refType this@@53 Tclass._module.Thread $Heap@@30))) (= 13 $FunctionContextHeight)) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@@30 this@@53) (and (_module.Object.objectGlobalInv $Heap@@30 this@@53) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType this@@53)) (_module.Universe.globalInv $Heap@@30 (_module.Object.universe this@@53))))) (= (ControlFlow 0 37) 31))) anon0_correct))))
