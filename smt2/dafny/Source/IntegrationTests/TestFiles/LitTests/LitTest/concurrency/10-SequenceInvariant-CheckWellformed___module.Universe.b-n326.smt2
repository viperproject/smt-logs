...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@5 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@5 $f@@0))  (=> (and (or (not (= $o@@5 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@5) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2428|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@5 $f@@0))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon14_correct  (=> (= (_module.Universe.baseLegalTransitionsSequence $Heap@@7 current$Heap this@@14)  (and (and (and (_module.Universe.globalBaseInv $Heap@@7 this@@14) (_module.Universe.globalBaseInv current$Heap this@@14)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.Universe.content)))) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType |o#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.Universe.content)) ($Box refType |o#2|)))) (not ($IsAllocBox ($Box refType |o#2|) Tclass._module.Object $Heap@@7)))
 :qid |_10SequenceInvariantdfy.43:16|
 :skolemid |662|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.Universe.content)) ($Box refType |o#2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType |o#2|)))
)))) (=> (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@@7 this@@14) (=> (_module.Universe.globalBaseInv $Heap@@7 this@@14) (|_module.Universe.globalBaseInv#canCall| current$Heap this@@14))) ($Is boolType (bool_2_U (_module.Universe.baseLegalTransitionsSequence $Heap@@7 current$Heap this@@14)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@3|)))))))))
(let ((anon13_correct  (=> (and (= |b$reqreads#2@3| |b$reqreads#2@2|) (= (ControlFlow 0 7) 3)) anon14_correct)))
(let ((anon22_Else_correct  (=> (not (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType |o#1@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.Universe.content)) ($Box refType |o#1@0|)))) (=> (and (= |b$reqreads#2@2| |b$reqreads#2@1|) (= (ControlFlow 0 10) 7)) anon13_correct))))
(let ((anon22_Then_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType |o#1@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.Universe.content)) ($Box refType |o#1@0|))) (and (= |b$reqreads#2@2| |b$reqreads#2@1|) (= (ControlFlow 0 9) 7))) anon13_correct)))
(let ((anon21_Else_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType |o#1@0|)) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 12) 9) anon22_Then_correct) (=> (= (ControlFlow 0 12) 10) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType |o#1@0|))) (=> (and (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@14 _module.Universe.content))) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (=> (= (ControlFlow 0 11) 9) anon22_Then_correct) (=> (= (ControlFlow 0 11) 10) anon22_Else_correct))))))
(let ((anon20_Then_correct  (=> (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object current$Heap)) (and (=> (= (ControlFlow 0 13) (- 0 14)) ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7)) (=> ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7) (and (=> (= (ControlFlow 0 13) 11) anon21_Then_correct) (=> (= (ControlFlow 0 13) 12) anon21_Else_correct)))))))
...
(let ((anon19_Then_correct  (=> (and (and (_module.Universe.globalBaseInv $Heap@@7 this@@14) (_module.Universe.globalBaseInv current$Heap this@@14)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.Universe.content)))) (and (=> (= (ControlFlow 0 15) 13) anon20_Then_correct) (=> (= (ControlFlow 0 15) 8) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (not (and (and (_module.Universe.globalBaseInv $Heap@@7 this@@14) (_module.Universe.globalBaseInv current$Heap this@@14)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.Universe.content))))) (=> (and (= |b$reqreads#2@3| true) (= (ControlFlow 0 6) 3)) anon14_correct))))
(let ((anon18_Else_correct  (=> (and (not (and (_module.Universe.globalBaseInv $Heap@@7 this@@14) (_module.Universe.globalBaseInv current$Heap this@@14))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 18) 15) anon19_Then_correct) (=> (= (ControlFlow 0 18) 6) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (_module.Universe.globalBaseInv $Heap@@7 this@@14) (_module.Universe.globalBaseInv current$Heap this@@14)) (and (=> (= (ControlFlow 0 16) (- 0 17)) ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7)) (=> ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7) (=> (and (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@14 _module.Universe.content))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 16) 15) anon19_Then_correct) (=> (= (ControlFlow 0 16) 6) anon19_Else_correct))))))))
(let ((anon17_Else_correct  (=> (and (not (_module.Universe.globalBaseInv $Heap@@7 this@@14)) (= |b$reqreads#0@1| true)) (and (=> (= (ControlFlow 0 20) 16) anon18_Then_correct) (=> (= (ControlFlow 0 20) 18) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (_module.Universe.globalBaseInv $Heap@@7 this@@14) (=> (and (and ($IsAllocBox ($Box refType this@@14) Tclass._module.Universe? current$Heap) (= |b$reqreads#0@0| (forall (($o@@25 T@U) ($f@@7 T@U) ) (!  (=> (and (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@25) alloc)))) (or (= $o@@25 this@@14) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.Universe.content)) ($Box refType $o@@25)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@25 $f@@7)))
 :qid |_10SequenceInvariantdfy.37:8|
 :skolemid |660|
)))) (and (|_module.Universe.globalBaseInv#canCall| current$Heap this@@14) (= |b$reqreads#0@1| |b$reqreads#0@0|))) (and (=> (= (ControlFlow 0 19) 16) anon18_Then_correct) (=> (= (ControlFlow 0 19) 18) anon18_Else_correct))))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7)) (=> ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@7 this@@14) (and (=> (= (ControlFlow 0 21) 19) anon17_Then_correct) (=> (= (ControlFlow 0 21) 20) anon17_Else_correct)))))))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 23) 1) anon16_Then_correct) (=> (= (ControlFlow 0 23) 21) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Universe) ($IsAlloc refType this@@14 Tclass._module.Universe previous$Heap))) (= 7 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@7) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 24) 23))) anon0_correct))))
