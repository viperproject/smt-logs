...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@17 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@17)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@17 null)) (not true)) ($Is refType this@@17 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@17)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimelongdfy.362:18|
 :weight 3
 :skolemid |1854|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@17)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@18 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@18)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@18 null)) (not true)) ($Is refType this@@18 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@18)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimelongdfy.425:18|
 :weight 3
 :skolemid |2118|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@18)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@19 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@19)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@19 null)) (not true)) ($Is refType this@@19 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@19)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimelongdfy.562:18|
 :weight 3
 :skolemid |2294|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@19)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@20 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@20) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@20 null)) (not true)) ($Is refType this@@20 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@20) (_module.Thread.objectClassKind this@@20)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1855|
 :pattern ( (_module.Object.objectClassKind this@@20) ($Is refType this@@20 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@20) (_module.Thread.objectClassKind this@@20))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@21 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@21) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@21) (_module.OwnedObject.objectClassKind this@@21)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2119|
 :pattern ( (_module.Object.objectClassKind this@@21) ($Is refType this@@21 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@21) (_module.OwnedObject.objectClassKind this@@21))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@22 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@22) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@22) (_module.Lifetime.objectClassKind this@@22)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2295|
 :pattern ( (_module.Object.objectClassKind this@@22) ($Is refType this@@22 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@22) (_module.Lifetime.objectClassKind this@@22))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@23 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@23) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@23) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1851|
 :pattern ( (_module.Thread.objectClassKind this@@23))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@24 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@24) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@24) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2115|
 :pattern ( (_module.OwnedObject.objectClassKind this@@24))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@25 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@25) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@25) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2291|
 :pattern ( (_module.Lifetime.objectClassKind this@@25))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@26 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@26) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@26 null)) (not true)) ($Is refType this@@26 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@26) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1773|
 :pattern ( (_module.Object.objectClassKind this@@26))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@14 this@@27) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Thread) ($IsAlloc refType this@@27 Tclass._module.Thread $Heap@@14)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@14 this@@27)) (= (_module.Thread.localInv $Heap@@14 this@@27)  (and true (_module.Object.objectGlobalBaseInv $Heap@@14 this@@27)))))
 :qid |_12MutexLifetimelongdfy.369:19|
 :skolemid |1875|
 :pattern ( (_module.Thread.localInv $Heap@@14 this@@27) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@15 this@@28) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Lifetime) ($IsAlloc refType this@@28 Tclass._module.Lifetime $Heap@@15)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@15 this@@28)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@28) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@28) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@28) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@28) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@28) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@15 this@@28) ($IsGoodHeap $Heap@@15))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_correct  (=> (and (and (= (_module.Thread.localInv $Heap@@16 this@@29)  (and true (_module.Object.objectGlobalBaseInv $Heap@@16 this@@29))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@16 this@@29))) (and ($Is boolType (bool_2_U (_module.Thread.localInv $Heap@@16 this@@29)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@1|)))
(let ((anon8_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 5) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@29) Tclass._module.Object? $Heap@@16)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@16 $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@0)))
 :qid |_12MutexLifetimelongdfy.370:8|
 :skolemid |1877|
))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@16 this@@29)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3))) anon5_correct))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#96| null $Heap@@16 alloc $Heap@@16 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 4) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@16) ($IsHeapAnchor $Heap@@16)) (=> (and (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Thread) ($IsAlloc refType this@@29 Tclass._module.Thread $Heap@@16))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
