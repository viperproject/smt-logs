...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split415)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon13_Then_correct  (=> (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|) (<= (LitInt 0) |i#0@1|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |remaining#0| null)) (not true)))))
(let ((anon12_Else_correct  (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)) (not true)) (= (ControlFlow 0 4) 2)) anon13_Then_correct)))
(let ((anon12_Then_correct  (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|) (= (ControlFlow 0 3) 2)) anon13_Then_correct)))
...
)))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)))))) (and (and (and (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (= (+ |i#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.Integer.value)))) (LitInt 10)))) (and (forall (($o@@121 T@U) ) (!  (=> (and (or (not (= $o@@121 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 $o@@121) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@121) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@121)) (or (= $o@@121 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 |universe#0|) _module.Universe.content)) ($Box refType $o@@121)))))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |544|
...
)) (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|)) (and (not |$w$loop#0@0|) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@4)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|)) (and (_module.Universe.globalInv $Heap@4 |universe#0|) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@4))) (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@4 |universe#0|)) (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@4 |universe#0|) (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@4 |universe#0|)))))))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct)))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
