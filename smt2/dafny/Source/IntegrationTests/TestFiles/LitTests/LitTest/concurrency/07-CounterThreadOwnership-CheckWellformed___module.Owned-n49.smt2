...
(let ((anon14_Then_correct  (=> (and (and (and (and (_module.Object.baseInv $Heap@@2 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.Object.universe this@@2)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.OwnedObject.owner))) (_module.OwnedObject.baseUserInv $Heap@@2 this@@2)) ($IsAllocBox ($Box refType this@@2) Tclass._module.OwnedObject? $Heap@@2)) (and (and (= |b$reqreads#4@0| (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@14) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@14) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@0)))
 :qid |_07CounterThreadOwnershipdfy.331:8|
 :skolemid |1307|
))) (|_module.OwnedObject.localUserInv#canCall| $Heap@@2 this@@2)) (and (= |b$reqreads#4@1| |b$reqreads#4@0|) (= (ControlFlow 0 8) 3)))) anon9_correct)))
...
(let ((anon13_Then_correct  (=> (and (_module.Object.baseInv $Heap@@2 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.Object.universe this@@2)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.OwnedObject.owner))) (=> (and (and ($IsAllocBox ($Box refType this@@2) Tclass._module.OwnedObject? $Heap@@2) (= |b$reqreads#3@0| (forall (($o@@15 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@15) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@15) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@15 $f@@1)))
 :qid |_07CounterThreadOwnershipdfy.330:8|
 :skolemid |1306|
)))) (and (|_module.OwnedObject.baseUserInv#canCall| $Heap@@2 this@@2) (= |b$reqreads#3@1| |b$reqreads#3@0|))) (and (=> (= (ControlFlow 0 10) 8) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct))))))
...
(let ((anon11_Else_correct  (=> ($IsAllocBox ($Box refType this@@2) Tclass._module.Object? $Heap@@2) (=> (and (= |b$reqreads#0@0| (forall (($o@@16 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@16) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@16) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@16 $f@@2)))
 :qid |_07CounterThreadOwnershipdfy.328:8|
 :skolemid |1305|
))) (|_module.Object.baseInv#canCall| $Heap@@2 this@@2)) (and (=> (= (ControlFlow 0 15) 12) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct))))))
