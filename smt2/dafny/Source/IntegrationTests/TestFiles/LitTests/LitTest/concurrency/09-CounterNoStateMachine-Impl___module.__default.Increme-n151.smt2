...
))))) (and (= $Heap@18 $Heap@19) (= (ControlFlow 0 2) (- 0 1)))))))))) (forall (($o@@147 T@U) ($f@@94 T@U) ) (!  (=> (and (and (or (not (= $o@@147 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@147) alloc)))) (= $o@@147 |universe#0|)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@147 $f@@94)))
