...
(assert (not
 ...
 :skolemid |3460|
))))) (and (and (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass._module.Lifetime) ($IsAlloc refType call5formal@this Tclass._module.Lifetime $Heap@@81))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|)))) (or (_module.Universe.globalInv $Heap@@81 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@81 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
