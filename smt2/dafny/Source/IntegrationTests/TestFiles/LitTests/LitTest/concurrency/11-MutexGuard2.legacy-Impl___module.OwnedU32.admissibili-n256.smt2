...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@53 T@U) ($f@@37 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#22| |l#0| |l#1| |l#2| |l#3|) $o@@53 $f@@37))  (=> (and (or (not (= $o@@53 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@53) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2457|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#22| |l#0| |l#1| |l#2| |l#3|) $o@@53 $f@@37))
)))
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.OwnedU32) ($IsAlloc refType this@@90 Tclass._module.OwnedU32 $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@66 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@66) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@66) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@66) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |1669|
...
(assert (forall (($o@@69 T@U) ) (!  (=> ($Is refType $o@@69 Tclass._module.OwnedU32?) ($Is refType $o@@69 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2444|
 :pattern ( ($Is refType $o@@69 Tclass._module.OwnedU32?))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#22| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@100) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@100) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@100) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@100)))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@100) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@100))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion)))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion)))) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion)))) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@100) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@100) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@100) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@100))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@100) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@100)))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#1|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion)))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@100) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#1@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.nonvolatileVersion))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@100)))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@100))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))) (not true)) (let ((|currOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1|) Tclass._module.Object previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@100) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@100) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@100) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))) (not true)) (let ((|currOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1@@0|) Tclass._module.Object previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@100) _module.OwnedObject.owner)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@100) (or (_module.Object.objectGlobalBaseInv current$Heap this@@100) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType this@@100))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@100) (or (_module.Object.objectGlobalBaseInv current$Heap this@@100) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType this@@100)))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@100) (or (_module.Object.objectGlobalBaseInv current$Heap this@@100) (_module.Object.baseFieldsInv current$Heap this@@100)))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@100) (or (_module.Object.objectGlobalBaseInv current$Heap this@@100) (_module.Object.baseFieldsInv current$Heap this@@100))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@100) (or (_module.Object.objectGlobalBaseInv current$Heap this@@100) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@100) (or (_module.Object.objectGlobalBaseInv current$Heap this@@100) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@100) (or (_module.Object.objectGlobalBaseInv current$Heap this@@100) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#28| T@U) ) (!  (=> (and ($Is refType |o#28| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#28|))) (and (and (and (= (_module.Object.universe |o#28|) (_module.Object.universe this@@100)) (or (not (= |o#28| (_module.Object.universe this@@100))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#28|)) (_module.Object.triggerAxioms current$Heap |o#28|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1818|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#28|)))
))))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@100) (or (_module.Object.objectGlobalBaseInv current$Heap this@@100) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#28@@0| T@U) ) (!  (=> (and ($Is refType |o#28@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#28@@0|))) (and (and (and (= (_module.Object.universe |o#28@@0|) (_module.Object.universe this@@100)) (or (not (= |o#28@@0| (_module.Object.universe this@@100))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#28@@0|)) (_module.Object.triggerAxioms current$Heap |o#28@@0|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1818|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#28@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (_module.OwnedObject.localUserInv current$Heap this@@100)))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@100) (or (_module.OwnedObject.localInv current$Heap this@@100) (_module.OwnedObject.localUserInv current$Heap this@@100))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@100) (or (_module.OwnedObject.inv current$Heap this@@100) (_module.OwnedObject.userInv current$Heap this@@100)))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@58) ($IsHeapAnchor $Heap@@58)) (and (or (not (= this@@100 null)) (not true)) (and ($Is refType this@@100 Tclass._module.OwnedU32) ($IsAlloc refType this@@100 Tclass._module.OwnedU32 previous$Heap)))) (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 16 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap@@58) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (and (and (|_module.Object.goodPreAndLegalChanges#canCall| previous$Heap current$Heap this@@100 |running#0@@5|) (and (_module.Object.goodPreAndLegalChanges previous$Heap current$Heap this@@100 |running#0@@5|) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType this@@100)) (forall (($o@@76 T@U) ($f@@50 T@U) ) (!  (=> (or (not (= $o@@76 null)) (not true)) (=> (= $o@@76 this@@100) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@76) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@76) $f@@50))))
 :qid |_11MutexGuard2legacydfy.239:8|
 :skolemid |1817|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@76) $f@@50))
))) (_module.Universe.legalTransition previous$Heap current$Heap (_module.Object.universe this@@100) |running#0@@5|)))) (= (ControlFlow 0 20) 2)))) anon0_correct)))
