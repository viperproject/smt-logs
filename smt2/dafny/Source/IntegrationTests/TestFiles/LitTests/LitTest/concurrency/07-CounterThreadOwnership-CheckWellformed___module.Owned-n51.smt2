...
(let ((anon12_Then_correct  (=> (and (_module.OwnedObject.localInv $Heap@@5 this@@5) ($IsAllocBox ($Box refType this@@5) Tclass._module.OwnedObject? $Heap@@5)) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@14) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@14) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@0)))
 :qid |_07CounterThreadOwnershipdfy.335:8|
 :skolemid |1318|
))) (|_module.OwnedObject.userInv#canCall| $Heap@@5 this@@5)) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 14) 11))) anon8_correct))))
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@5) Tclass._module.OwnedObject? $Heap@@5) (=> (and (= |b$reqreads#0@0| (forall (($o@@15 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@15) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@15) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@15 $f@@1)))
 :qid |_07CounterThreadOwnershipdfy.334:8|
 :skolemid |1317|
))) (|_module.OwnedObject.localInv#canCall| $Heap@@5 this@@5)) (and (=> (= (ControlFlow 0 16) 14) anon12_Then_correct) (=> (= (ControlFlow 0 16) 15) anon12_Else_correct))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null $Heap@@5 alloc $Heap@@5 alloc)) (and (and (=> (= (ControlFlow 0 17) 16) anon10_Else_correct) (=> (= (ControlFlow 0 17) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 17) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.OwnedObject) ($IsAlloc refType this@@5 Tclass._module.OwnedObject $Heap@@5))) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 18) 17))) anon0_correct))))
