...
(assert (forall (($o@@9 T@U) ($h@@5 T@U) ) (! (= ($IsAlloc refType $o@@9 Tclass._module.OwnedObject? $h@@5)  (or (= $o@@9 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@9) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1493|
 :pattern ( ($IsAlloc refType $o@@9 Tclass._module.OwnedObject? $h@@5))
)))
(assert (forall (($o@@10 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@10 Tclass._module.OwnedU32? $h@@6)  (or (= $o@@10 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@10) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1632|
 :pattern ( ($IsAlloc refType $o@@10 Tclass._module.OwnedU32? $h@@6))
)))
(assert (forall (($o@@11 T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType $o@@11 Tclass._module.Mutex? $h@@7)  (or (= $o@@11 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@11) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1893|
 :pattern ( ($IsAlloc refType $o@@11 Tclass._module.Mutex? $h@@7))
)))
(assert (forall (($o@@12 T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType $o@@12 Tclass._module.MutexGuardU32? $h@@8)  (or (= $o@@12 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@12) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2167|
 :pattern ( ($IsAlloc refType $o@@12 Tclass._module.MutexGuardU32? $h@@8))
)))
...
(assert (forall (($h@@9 T@U) ($o@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass._module.Mutex?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@14) _module.Mutex.data)) Tclass._module.OwnedU32))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1894|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@14) _module.Mutex.data)))
)))
(assert (forall (($h@@10 T@U) ($o@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) Tclass._module.MutexGuardU32?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@15) _module.MutexGuardU32.mutex)) Tclass._module.Mutex))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2168|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@15) _module.MutexGuardU32.mutex)))
)))
...
(assert (forall (($h@@11 T@U) ($o@@16 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass._module.Mutex?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@16) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@16) _module.Mutex.data)) Tclass._module.OwnedU32 $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1895|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@16) _module.Mutex.data)))
)))
(assert (forall (($h@@12 T@U) ($o@@17 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) Tclass._module.MutexGuardU32?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@17) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@17) _module.MutexGuardU32.mutex)) Tclass._module.Mutex $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2169|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@17) _module.MutexGuardU32.mutex)))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= MutexGuardU32_$_ReadsFrame@0 (|lambda#8| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@28 T@U) ($f@@6 T@U) ) (!  (=> (and (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) alloc))))
 :qid |_11MutexGuard2legacydfy.563:22|
 :skolemid |2230|
))) (=> (forall (($o@@29 T@U) ($f@@7 T@U) ) (!  (=> (and (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) alloc))))
 :qid |_11MutexGuard2legacydfy.563:22|
 :skolemid |2230|
)) (=> (=> (_module.MutexGuardU32.userInv2 $Heap@@8 current$Heap this@@14) (_module.MutexGuardU32.localUserInv2 $Heap@@8 current$Heap this@@14)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.MutexGuardU32.userInv2 $Heap@@8 current$Heap this@@14) (=> (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@8 current$Heap this@@14) (or (_module.MutexGuardU32.localUserInv2 $Heap@@8 current$Heap this@@14) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.MutexGuardU32.userInv2 $Heap@@8 current$Heap this@@14) (=> (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@8 current$Heap this@@14) (or (_module.MutexGuardU32.localUserInv2 $Heap@@8 current$Heap this@@14) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.MutexGuardU32.userInv2 $Heap@@8 current$Heap this@@14) (=> (|_module.MutexGuardU32.localUserInv2#canCall| $Heap@@8 current$Heap this@@14) (or (_module.MutexGuardU32.localUserInv2 $Heap@@8 current$Heap this@@14) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@14) _module.MutexGuardU32.mutex)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@14) _module.MutexGuardU32.mutex)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@8) ($IsHeapAnchor $Heap@@8)) (=> (and (and (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@14 Tclass._module.MutexGuardU32 current$Heap@@0))) (= 3 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@8) (and ($HeapSucc previous$Heap current$Heap@@0) ($IsGoodHeap current$Heap@@0))) (= (ControlFlow 0 6) 2))) anon0_correct))))
