...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@29 T@U) (this@@41 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@29 this@@41) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@41 null)) (not true)) (and ($Is refType this@@41 Tclass._module.Mutex) ($IsAlloc refType this@@41 Tclass._module.Mutex $Heap@@29)))))) (= (_module.Mutex.objectUserFields $Heap@@29 this@@41) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@41) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@41) _module.Mutex.data)))))
 :qid |_12MutexLifetimelongdfy.764:18|
 :skolemid |3271|
 :pattern ( (_module.Mutex.objectUserFields $Heap@@29 this@@41) ($IsGoodHeap $Heap@@29))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@30 T@U) (this@@42 T@U) ) (!  (=> (or (|_module.OwnedU32.objectUserFields#canCall| $Heap@@30 this@@42) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@42 null)) (not true)) ($Is refType this@@42 Tclass._module.OwnedU32)))) (= (_module.OwnedObject.objectUserFields $Heap@@30 this@@42) (_module.OwnedU32.objectUserFields $Heap@@30 this@@42)))
 :qid |_12MutexLifetimelongdfy.519:18|
 :skolemid |2725|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@30 this@@42) ($Is refType this@@42 Tclass._module.OwnedU32) ($IsGoodHeap $Heap@@30))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@30 this@@42) (_module.OwnedU32.objectUserFields $Heap@@30 this@@42) ($IsGoodHeap $Heap@@30))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@31 T@U) (this@@43 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@31 this@@43) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@43 null)) (not true)) ($Is refType this@@43 Tclass._module.Mutex)))) (= (_module.OwnedObject.objectUserFields $Heap@@31 this@@43) (_module.Mutex.objectUserFields $Heap@@31 this@@43)))
 :qid |_12MutexLifetimelongdfy.519:18|
 :skolemid |3272|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@31 this@@43) ($Is refType this@@43 Tclass._module.Mutex) ($IsGoodHeap $Heap@@31))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@31 this@@43) (_module.Mutex.objectUserFields $Heap@@31 this@@43) ($IsGoodHeap $Heap@@31))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@32 T@U) (this@@44 T@U) ) (!  (=> (or (|_module.MutexGuardU32.objectUserFields#canCall| $Heap@@32 this@@44) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@44 null)) (not true)) ($Is refType this@@44 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.objectUserFields $Heap@@32 this@@44) (_module.MutexGuardU32.objectUserFields $Heap@@32 this@@44)))
 :qid |_12MutexLifetimelongdfy.519:18|
 :skolemid |3563|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@32 this@@44) ($Is refType this@@44 Tclass._module.MutexGuardU32) ($IsGoodHeap $Heap@@32))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@32 this@@44) (_module.MutexGuardU32.objectUserFields $Heap@@32 this@@44) ($IsGoodHeap $Heap@@32))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) ($Heap@@33 T@U) (this@@45 T@U) (|a#0@@6| T@U) (|x#0@@5| T@U) (|b#0@@6| T@U) ) (!  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@33) (and (or (not (= this@@45 null)) (not true)) ($Is refType this@@45 Tclass._module.Universe))) ($Is refType |a#0@@6| Tclass._module.Lifetime)) ($Is refType |x#0@@5| Tclass._module.Lifetime)) ($Is refType |b#0@@6| Tclass._module.Lifetime)) (exists ((|_k#0@@3| Int) ) (!  (and (<= (LitInt 0) |_k#0@@3|) (_module.Universe.outlivesThrough_h ($LS $ly@@6) $Heap@@33 this@@45 |_k#0@@3| |a#0@@6| |x#0@@5| |b#0@@6|))
 :qid |_12MutexLifetimelongdfy.166:19|
 :skolemid |1601|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $ly@@6) $Heap@@33 this@@45 |_k#0@@3| |a#0@@6| |x#0@@5| |b#0@@6|))
))) (_module.Universe.outlivesThrough ($LS $ly@@6) $Heap@@33 this@@45 |a#0@@6| |x#0@@5| |b#0@@6|))
 :qid |_12MutexLifetimelongdfy.166:19|
 :skolemid |1603|
 :pattern ( (_module.Universe.outlivesThrough ($LS $ly@@6) $Heap@@33 this@@45 |a#0@@6| |x#0@@5| |b#0@@6|))
))))
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@46 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@34 this@@46) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@46 null)) (not true)) (and ($Is refType this@@46 Tclass._module.OwnedObject) ($IsAlloc refType this@@46 Tclass._module.OwnedObject $Heap@@34)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@34 this@@46) (=> (_module.OwnedObject.localInv $Heap@@34 this@@46) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@46) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.userInv#canCall| $Heap@@34 this@@46)))) (= (_module.OwnedObject.inv $Heap@@34 this@@46)  (and (_module.OwnedObject.localInv $Heap@@34 this@@46) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@46) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv $Heap@@34 this@@46))))))
 :qid |_12MutexLifetimelongdfy.449:19|
 :skolemid |2165|
 :pattern ( (_module.OwnedObject.inv $Heap@@34 this@@46) ($IsGoodHeap $Heap@@34))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@35 T@U) (this@@47 T@U) ) (!  (=> (or (|_module.OwnedU32.localUserInv#canCall| $Heap@@35 this@@47) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@35) (and (or (not (= this@@47 null)) (not true)) (and ($Is refType this@@47 Tclass._module.OwnedU32) ($IsAlloc refType this@@47 Tclass._module.OwnedU32 $Heap@@35)))))) (= (_module.OwnedU32.localUserInv $Heap@@35 this@@47) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.645:19|
 :skolemid |2738|
 :pattern ( (_module.OwnedU32.localUserInv $Heap@@35 this@@47) ($IsGoodHeap $Heap@@35))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@36 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@36 this@@48) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@36) (and (or (not (= this@@48 null)) (not true)) (and ($Is refType this@@48 Tclass._module.Thread) ($IsAlloc refType this@@48 Tclass._module.Thread $Heap@@36)))))) (= (_module.Thread.baseFieldsInv $Heap@@36 this@@48) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.364:19|
 :skolemid |1861|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@36 this@@48) ($IsGoodHeap $Heap@@36))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@7 T@U) ($Heap@@37 T@U) (this@@49 T@U) (|a#0@@7| T@U) (|b#0@@7| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@37) (and (or (not (= this@@49 null)) (not true)) ($Is refType this@@49 Tclass._module.Universe))) ($Is refType |a#0@@7| Tclass._module.Lifetime)) ($Is refType |b#0@@7| Tclass._module.Lifetime)) (exists ((|_k#0@@4| Int) ) (!  (and (<= (LitInt 0) |_k#0@@4|) (_module.Universe.outlives_h ($LS $ly@@7) $Heap@@37 this@@49 |_k#0@@4| |a#0@@7| |b#0@@7|))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1577|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@7) $Heap@@37 this@@49 |_k#0@@4| |a#0@@7| |b#0@@7|))
))) (_module.Universe.outlives ($LS $ly@@7) $Heap@@37 this@@49 |a#0@@7| |b#0@@7|))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1579|
 :pattern ( (_module.Universe.outlives ($LS $ly@@7) $Heap@@37 this@@49 |a#0@@7| |b#0@@7|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@38 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.OwnedU32.userInv#canCall| $Heap@@38 this@@50) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@38) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.OwnedU32) ($IsAlloc refType this@@50 Tclass._module.OwnedU32 $Heap@@38)))))) (and (|_module.OwnedU32.localUserInv#canCall| $Heap@@38 this@@50) (= (_module.OwnedU32.userInv $Heap@@38 this@@50) (_module.OwnedU32.localUserInv $Heap@@38 this@@50))))
 :qid |_12MutexLifetimelongdfy.646:19|
 :skolemid |2745|
 :pattern ( (_module.OwnedU32.userInv $Heap@@38 this@@50) ($IsGoodHeap $Heap@@38))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@39 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@39 this@@51) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@39) (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.Object) ($IsAlloc refType this@@51 Tclass._module.Object $Heap@@39)))))) (and (|_module.Object.nonAliasing#canCall| $Heap@@39 this@@51) (= (_module.Object.triggerAxioms $Heap@@39 this@@51) (_module.Object.nonAliasing $Heap@@39 this@@51))))
 :qid |_12MutexLifetimelongdfy.315:19|
 :skolemid |1731|
 :pattern ( (_module.Object.triggerAxioms $Heap@@39 this@@51) ($IsGoodHeap $Heap@@39))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@40 T@U) (this@@52 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@40 this@@52) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@40) (and (or (not (= this@@52 null)) (not true)) (and ($Is refType this@@52 Tclass._module.Lifetime) ($IsAlloc refType this@@52 Tclass._module.Lifetime $Heap@@40)))))) (and (|_module.Lifetime.localInv#canCall| $Heap@@40 this@@52) (= (_module.Lifetime.inv $Heap@@40 this@@52) (_module.Lifetime.localInv $Heap@@40 this@@52))))
 :qid |_12MutexLifetimelongdfy.589:19|
 :skolemid |2387|
 :pattern ( (_module.Lifetime.inv $Heap@@40 this@@52) ($IsGoodHeap $Heap@@40))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@13 T@U) ($Heap@@41 T@U) (this@@53 T@U) ) (!  (=> (or (|_module.Lifetime.sequenceInv2#canCall| $prevHeap@@13 $Heap@@41 this@@53) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@13) ($IsGoodHeap $Heap@@41)) ($HeapSucc $prevHeap@@13 $Heap@@41)) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Lifetime) ($IsAlloc refType this@@53 Tclass._module.Lifetime $prevHeap@@13)))))) (and (and (|_module.Lifetime.alive#canCall| $prevHeap@@13 this@@53) (=> (not (_module.Lifetime.alive $prevHeap@@13 this@@53)) (|_module.Lifetime.alive#canCall| $Heap@@41 this@@53))) (= (_module.Lifetime.sequenceInv2 $prevHeap@@13 $Heap@@41 this@@53)  (and (and (and (and (=> (not (_module.Lifetime.alive $prevHeap@@13 this@@53)) (not (_module.Lifetime.alive $Heap@@41 this@@53))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@41 this@@53) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@41 this@@53) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@13 this@@53) _module.Lifetime.owner))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@13 this@@53) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@41 this@@53) _module.Lifetime.elements)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@13 this@@53) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@41 this@@53) _module.Lifetime.mightPointTo)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@13 this@@53) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@41 this@@53) _module.Lifetime.mightPointFrom)))))))
 :qid |_12MutexLifetimelongdfy.591:22|
 :skolemid |2423|
 :pattern ( (_module.Lifetime.sequenceInv2 $prevHeap@@13 $Heap@@41 this@@53) ($IsGoodHeap $Heap@@41))
))))
(assert (forall (($ly@@8 T@U) ($Heap@@42 T@U) (this@@54 T@U) (|_k#0@@5| Int) (|a#0@@8| T@U) (|x#0@@6| T@U) (|b#0@@8| T@U) ) (! (= (_module.Universe.outlivesThrough_h ($LS $ly@@8) $Heap@@42 this@@54 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|) (_module.Universe.outlivesThrough_h $ly@@8 $Heap@@42 this@@54 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|))
 :qid |_12MutexLifetimelongdfy.166:19|
 :skolemid |1607|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $ly@@8) $Heap@@42 this@@54 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@14 T@U) ($Heap@@43 T@U) (this@@55 T@U) ) (!  (=> (or (|_module.OwnedU32.unchangedNonvolatileUserFields#canCall| $prevHeap@@14 $Heap@@43 this@@55) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@14) ($IsGoodHeap $Heap@@43)) ($HeapSucc $prevHeap@@14 $Heap@@43)) (and (or (not (= this@@55 null)) (not true)) (and ($Is refType this@@55 Tclass._module.OwnedU32) ($IsAlloc refType this@@55 Tclass._module.OwnedU32 $prevHeap@@14)))))) (= (_module.OwnedU32.unchangedNonvolatileUserFields $prevHeap@@14 $Heap@@43 this@@55)  (and true (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 this@@55) _module.OwnedU32.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@43 this@@55) _module.OwnedU32.value)))))))
 :qid |_12MutexLifetimelongdfy.641:22|
 :skolemid |2731|
 :pattern ( (_module.OwnedU32.unchangedNonvolatileUserFields $prevHeap@@14 $Heap@@43 this@@55) ($IsGoodHeap $Heap@@43))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@44 T@U) (this@@56 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@44 this@@56) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@44) (and (or (not (= this@@56 null)) (not true)) (and ($Is refType this@@56 Tclass._module.OwnedObject) ($IsAlloc refType this@@56 Tclass._module.OwnedObject $Heap@@44)))))) (and (|_module.OwnedObject.objectUserFields#canCall| $Heap@@44 this@@56) (= (_module.OwnedObject.objectFields $Heap@@44 this@@56) (|Set#Union| (|Set#Union| (_module.OwnedObject.objectUserFields $Heap@@44 this@@56) (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@56)))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 this@@56) _module.OwnedObject.owner)) null) |Set#Empty| (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@44 this@@56) _module.OwnedObject.owner)))))))
 :qid |_12MutexLifetimelongdfy.427:18|
 :skolemid |2126|
 :pattern ( (_module.OwnedObject.objectFields $Heap@@44 this@@56) ($IsGoodHeap $Heap@@44))
))))
...
(assert (forall (($ly@@9 T@U) ($h0@@11 T@U) ($h1@@11 T@U) (this@@57 T@U) (|_k#0@@6| Int) (|a#0@@9| T@U) (|b#0@@9| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@57 null)) (not true)) ($Is refType this@@57 Tclass._module.Universe))) (or (|_module.Universe.outlives_h#canCall| $h0@@11 this@@57 |_k#0@@6| |a#0@@9| |b#0@@9|) (and (and (<= (LitInt 0) |_k#0@@6|) ($Is refType |a#0@@9| Tclass._module.Lifetime)) ($Is refType |b#0@@9| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@32 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@32 null)) (not true)) (or (or (= $o@@32 this@@57) (and (and ($Is refType $o@@32 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 this@@57) _module.Universe.content)) ($Box refType $o@@32))) (= $f@@12 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@32 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 this@@57) _module.Universe.content)) ($Box refType $o@@32))) (= $f@@12 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@32) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@32) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |1587|
)) (= (_module.Universe.outlives_h $ly@@9 $h0@@11 this@@57 |_k#0@@6| |a#0@@9| |b#0@@9|) (_module.Universe.outlives_h $ly@@9 $h1@@11 this@@57 |_k#0@@6| |a#0@@9| |b#0@@9|))))
 :qid |unknown.0:0|
 :skolemid |1588|
 :pattern ( ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11) (_module.Universe.outlives_h $ly@@9 $h1@@11 this@@57 |_k#0@@6| |a#0@@9| |b#0@@9|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@10 T@U) ($Heap@@45 T@U) (this@@58 T@U) (|_k#0@@7| Int) (|a#0@@10| T@U) (|b#0@@10| T@U) ) (!  (=> (or (|_module.Universe.outlives_h#canCall| $Heap@@45 this@@58 |_k#0@@7| |a#0@@10| |b#0@@10|) (and (< 2 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $Heap@@45) (and (or (not (= this@@58 null)) (not true)) (and ($Is refType this@@58 Tclass._module.Universe) ($IsAlloc refType this@@58 Tclass._module.Universe $Heap@@45)))) (<= (LitInt 0) |_k#0@@7|)) ($Is refType |a#0@@10| Tclass._module.Lifetime)) ($Is refType |b#0@@10| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 this@@58) _module.Universe.content)) ($Box refType |a#0@@10|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 this@@58) _module.Universe.content)) ($Box refType |b#0@@10|)))))) (and (=> (< 0 |_k#0@@7|) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |b#0@@10|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@10|))) (forall ((|x#3| T@U) ) (!  (=> ($Is refType |x#3| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 this@@58) _module.Universe.content)) ($Box refType |x#3|)) (|_module.Universe.outlivesThrough_h#canCall| $Heap@@45 this@@58 (- |_k#0@@7| 1) |a#0@@10| |x#3| |b#0@@10|)))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |1592|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@45 this@@58 (- |_k#0@@7| 1) |a#0@@10| |x#3| |b#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 this@@58) _module.Universe.content)) ($Box refType |x#3|)))
)))) (= (_module.Universe.outlives_h ($LS $ly@@10) $Heap@@45 this@@58 |_k#0@@7| |a#0@@10| |b#0@@10|)  (and (< 0 |_k#0@@7|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |b#0@@10|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@10|)) (exists ((|x#3@@0| T@U) ) (!  (and (and ($Is refType |x#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 this@@58) _module.Universe.content)) ($Box refType |x#3@@0|))) (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@45 this@@58 (- |_k#0@@7| 1) |a#0@@10| |x#3@@0| |b#0@@10|))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |1591|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@45 this@@58 (- |_k#0@@7| 1) |a#0@@10| |x#3@@0| |b#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 this@@58) _module.Universe.content)) ($Box refType |x#3@@0|)))
)))))))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1593|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@10) $Heap@@45 this@@58 |_k#0@@7| |a#0@@10| |b#0@@10|) ($IsGoodHeap $Heap@@45))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@46 T@U) (this@@59 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@46 this@@59) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@46) (and (or (not (= this@@59 null)) (not true)) (and ($Is refType this@@59 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@59 Tclass._module.MutexGuardU32 $Heap@@46)))))) (and (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@59))) ($Box refType (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 (_module.Object.universe this@@59)) _module.Universe.content))) (|_module.Universe.outlives#canCall| $Heap@@46 (_module.Object.universe this@@59) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))) (_module.OwnedObject.lifetime this@@59))) (= (_module.MutexGuardU32.localUserInv $Heap@@46 this@@59)  (and (and (and (and (and (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@59))) ($Box refType (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 (_module.Object.universe this@@59)) _module.Universe.content))) (_module.Universe.outlives ($LS $LZ) $Heap@@46 (_module.Object.universe this@@59) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))) (_module.OwnedObject.lifetime this@@59))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))) _module.OwnedObject.owner)) null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))) _module.Mutex.locked)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@59)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@@59)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.mutex))) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@59) _module.MutexGuardU32.data)))))))
 :qid |_12MutexLifetimelongdfy.858:19|
 :skolemid |3576|
 :pattern ( (_module.MutexGuardU32.localUserInv $Heap@@46 this@@59) ($IsGoodHeap $Heap@@46))
))))
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@60 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@60 null)) (not true)) ($Is refType this@@60 Tclass._module.Lifetime))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@33 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@33 null)) (not true)) (or (and (= $o@@33 this@@60) (= $f@@13 _module.Lifetime.mightPointFrom)) (and (= $o@@33 this@@60) (= $f@@13 _module.Lifetime.elements)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@33) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@33) $f@@13)))
 :qid |unknown.0:0|
 :skolemid |2261|
)) (= (_module.Lifetime.unused $h0@@12 this@@60) (_module.Lifetime.unused $h1@@12 this@@60))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2262|
 :pattern ( ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12) (_module.Lifetime.unused $h1@@12 this@@60))
)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@77 T@U) (this@@101 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@77 this@@101) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@77) (and (or (not (= this@@101 null)) (not true)) (and ($Is refType this@@101 Tclass._module.Lifetime) ($IsAlloc refType this@@101 Tclass._module.Lifetime $Heap@@77)))))) (=> (_module.Lifetime.localInv $Heap@@77 this@@101) (_module.Object.objectGlobalBaseInv $Heap@@77 this@@101)))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2318|
 :pattern ( (_module.Lifetime.localInv $Heap@@77 this@@101))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@78 T@U) (this@@102 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@78 this@@102) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@78) (and (or (not (= this@@102 null)) (not true)) (and ($Is refType this@@102 Tclass._module.Thread) ($IsAlloc refType this@@102 Tclass._module.Thread $Heap@@78)))))) (=> (_module.Thread.inv $Heap@@78 this@@102) (_module.Thread.localInv $Heap@@78 this@@102)))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1883|
 :pattern ( (_module.Thread.inv $Heap@@78 this@@102))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@79 T@U) (this@@103 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@79 this@@103) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@79) (and (or (not (= this@@103 null)) (not true)) (and ($Is refType this@@103 Tclass._module.Lifetime) ($IsAlloc refType this@@103 Tclass._module.Lifetime $Heap@@79)))))) (=> (_module.Lifetime.inv $Heap@@79 this@@103) (_module.Lifetime.localInv $Heap@@79 this@@103)))
 :qid |_12MutexLifetimelongdfy.589:19|
 :skolemid |2385|
 :pattern ( (_module.Lifetime.inv $Heap@@79 this@@103))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@80 T@U) (this@@104 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@80 this@@104) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@80) (and (or (not (= this@@104 null)) (not true)) (and ($Is refType this@@104 Tclass._module.Object) ($IsAlloc refType this@@104 Tclass._module.Object $Heap@@80)))))) (=> (_module.Object.localInv $Heap@@80 this@@104) (_module.Object.objectGlobalBaseInv $Heap@@80 this@@104)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |1783|
 :pattern ( (_module.Object.localInv $Heap@@80 this@@104))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@81 T@U) (this@@105 T@U) ) (!  (=> (or (|_module.Mutex.userInv#canCall| $Heap@@81 this@@105) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@81) (and (or (not (= this@@105 null)) (not true)) (and ($Is refType this@@105 Tclass._module.Mutex) ($IsAlloc refType this@@105 Tclass._module.Mutex $Heap@@81)))))) (=> (_module.Mutex.userInv $Heap@@81 this@@105) (_module.Mutex.localUserInv $Heap@@81 this@@105)))
 :qid |_12MutexLifetimelongdfy.786:19|
 :skolemid |3290|
 :pattern ( (_module.Mutex.userInv $Heap@@81 this@@105))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@82 T@U) (this@@106 T@U) ) (!  (=> (or (|_module.MutexGuardU32.userInv#canCall| $Heap@@82 this@@106) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@82) (and (or (not (= this@@106 null)) (not true)) (and ($Is refType this@@106 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@106 Tclass._module.MutexGuardU32 $Heap@@82)))))) (=> (_module.MutexGuardU32.userInv $Heap@@82 this@@106) (_module.MutexGuardU32.localUserInv $Heap@@82 this@@106)))
 :qid |_12MutexLifetimelongdfy.870:19|
 :skolemid |3582|
 :pattern ( (_module.MutexGuardU32.userInv $Heap@@82 this@@106))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@83 T@U) (this@@107 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@83 this@@107) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@83) (and (or (not (= this@@107 null)) (not true)) (and ($Is refType this@@107 Tclass._module.OwnedObject) ($IsAlloc refType this@@107 Tclass._module.OwnedObject $Heap@@83)))))) (=> (_module.OwnedObject.userInv $Heap@@83 this@@107) (_module.OwnedObject.localUserInv $Heap@@83 this@@107)))
 :qid |_12MutexLifetimelongdfy.523:19|
 :skolemid |2243|
 :pattern ( (_module.OwnedObject.userInv $Heap@@83 this@@107))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@84 T@U) (this@@108 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@84 this@@108) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@84) (and (or (not (= this@@108 null)) (not true)) (and ($Is refType this@@108 Tclass._module.OwnedObject) ($IsAlloc refType this@@108 Tclass._module.OwnedObject $Heap@@84)))))) (=> (_module.OwnedObject.inv $Heap@@84 this@@108) (_module.OwnedObject.localInv $Heap@@84 this@@108)))
 :qid |_12MutexLifetimelongdfy.449:19|
 :skolemid |2163|
 :pattern ( (_module.OwnedObject.inv $Heap@@84 this@@108))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($Heap@@85 T@U) (this@@109 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@85 this@@109) (and (< 15 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@85) (and (or (not (= this@@109 null)) (not true)) (and ($Is refType this@@109 Tclass._module.Object) ($IsAlloc refType this@@109 Tclass._module.Object $Heap@@85)))))) (=> (_module.Object.inv $Heap@@85 this@@109) (_module.Object.localInv $Heap@@85 this@@109)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |1793|
 :pattern ( (_module.Object.inv $Heap@@85 this@@109))
))))
...
(assert (forall (($ly@@14 T@U) ($h0@@20 T@U) ($h1@@20 T@U) (this@@110 T@U) (|_k#0@@9| Int) (|a#0@@14| T@U) (|x#0@@9| T@U) (|b#0@@14| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@110 null)) (not true)) ($Is refType this@@110 Tclass._module.Universe))) (or (|_module.Universe.outlivesThrough_h#canCall| $h0@@20 this@@110 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (and (and (and (<= (LitInt 0) |_k#0@@9|) ($Is refType |a#0@@14| Tclass._module.Lifetime)) ($Is refType |x#0@@9| Tclass._module.Lifetime)) ($Is refType |b#0@@14| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@66 T@U) ($f@@24 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (or (or (= $o@@66 this@@110) (and (and ($Is refType $o@@66 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 this@@110) _module.Universe.content)) ($Box refType $o@@66))) (= $f@@24 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@66 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 this@@110) _module.Universe.content)) ($Box refType $o@@66))) (= $f@@24 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@66) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@66) $f@@24)))
 :qid |unknown.0:0|
 :skolemid |1609|
)) (= (_module.Universe.outlivesThrough_h $ly@@14 $h0@@20 this@@110 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (_module.Universe.outlivesThrough_h $ly@@14 $h1@@20 this@@110 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|))))
 :qid |unknown.0:0|
 :skolemid |1610|
 :pattern ( ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20) (_module.Universe.outlivesThrough_h $ly@@14 $h1@@20 this@@110 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@24 T@U) ($Heap@@86 T@U) (this@@111 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@24 $Heap@@86 this@@111) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@24) ($IsGoodHeap $Heap@@86)) ($HeapSucc $prevHeap@@24 $Heap@@86)) (and (or (not (= this@@111 null)) (not true)) (and ($Is refType this@@111 Tclass._module.OwnedObject) ($IsAlloc refType this@@111 Tclass._module.OwnedObject $prevHeap@@24)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@111) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@86 this@@111) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@24 $Heap@@86 this@@111)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@24 $Heap@@86 this@@111)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@111) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@86 this@@111) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@24 $Heap@@86 this@@111)))))
 :qid |_12MutexLifetimelongdfy.438:22|
 :skolemid |2147|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@24 $Heap@@86 this@@111) ($IsGoodHeap $Heap@@86))
))))
...
(assert (forall (($ly@@15 T@U) ($h0@@21 T@U) ($h1@@21 T@U) (this@@112 T@U) (|a#0@@15| T@U) (|b#0@@15| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@112 null)) (not true)) ($Is refType this@@112 Tclass._module.Universe))) (or (|_module.Universe.outlives#canCall| $h0@@21 this@@112 |a#0@@15| |b#0@@15|) (and ($Is refType |a#0@@15| Tclass._module.Lifetime) ($Is refType |b#0@@15| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@67 T@U) ($f@@25 T@U) ) (!  (=> (and (or (not (= $o@@67 null)) (not true)) (or (or (= $o@@67 this@@112) (and (and ($Is refType $o@@67 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 this@@112) _module.Universe.content)) ($Box refType $o@@67))) (= $f@@25 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@67 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 this@@112) _module.Universe.content)) ($Box refType $o@@67))) (= $f@@25 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@67) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@67) $f@@25)))
 :qid |unknown.0:0|
 :skolemid |1570|
)) (= (_module.Universe.outlives $ly@@15 $h0@@21 this@@112 |a#0@@15| |b#0@@15|) (_module.Universe.outlives $ly@@15 $h1@@21 this@@112 |a#0@@15| |b#0@@15|))))
 :qid |unknown.0:0|
 :skolemid |1571|
 :pattern ( ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21) (_module.Universe.outlives $ly@@15 $h1@@21 this@@112 |a#0@@15| |b#0@@15|))
)))
...
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@113 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@113 null)) (not true)) ($Is refType this@@113 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@69 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@69 null)) (not true)) (= $o@@69 this@@113)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@69) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@69) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |1719|
)) (= (_module.Object.nonAliasing $h0@@22 this@@113) (_module.Object.nonAliasing $h1@@22 this@@113))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1720|
 :pattern ( ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22) (_module.Object.nonAliasing $h1@@22 this@@113))
)))
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@114 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@114 null)) (not true)) ($Is refType this@@114 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@70 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@70 null)) (not true)) (= $o@@70 this@@114)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@70) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@70) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |1727|
)) (= (_module.Object.triggerAxioms $h0@@23 this@@114) (_module.Object.triggerAxioms $h1@@23 this@@114))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1728|
 :pattern ( ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23) (_module.Object.triggerAxioms $h1@@23 this@@114))
)))
...
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@118 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@118 null)) (not true)) ($Is refType this@@118 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@73 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (or (= $o@@73 this@@118) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 this@@118) _module.Universe.content)) ($Box refType $o@@73)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@73) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@73) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |1174|
)) (= (_module.Universe.globalBaseInv $h0@@24 this@@118) (_module.Universe.globalBaseInv $h1@@24 this@@118))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1175|
 :pattern ( ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24) (_module.Universe.globalBaseInv $h1@@24 this@@118))
)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@87 T@U) (this@@119 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@87 this@@119) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@87) (and (or (not (= this@@119 null)) (not true)) (and ($Is refType this@@119 Tclass._module.Lifetime) ($IsAlloc refType this@@119 Tclass._module.Lifetime $Heap@@87)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@87 this@@119) (=> (_module.Object.objectGlobalBaseInv $Heap@@87 this@@119) (=> (forall ((|o#0@@7| T@U) ) (!  (=> (and ($Is refType |o#0@@7| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#0@@7|))) (= (_module.OwnedObject.lifetime |o#0@@7|) this@@119))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2333|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#0@@7|)))
)) (and (forall ((|o#1@@1| T@U) ) (!  (=> ($Is refType |o#1@@1| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#1@@1|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@87 |o#1@@1|) (|_module.Lifetime.alive#canCall| $Heap@@87 this@@119))))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2326|
 :pattern ( (_module.OwnedObject.alive $Heap@@87 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#1@@1|)))
)) (=> (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#1@@2|))) (= (_module.OwnedObject.alive $Heap@@87 |o#1@@2|) (_module.Lifetime.alive $Heap@@87 this@@119)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2332|
 :pattern ( (_module.OwnedObject.alive $Heap@@87 |o#1@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#1@@2|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@87 this@@119) (=> (_module.Lifetime.alive $Heap@@87 this@@119) (forall ((|l#0@@2| T@U) ) (!  (=> ($Is refType |l#0@@2| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)) (|_module.Lifetime.alive#canCall| $Heap@@87 |l#0@@2|)))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2327|
 :pattern ( (_module.Lifetime.alive $Heap@@87 |l#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@87 this@@119) (forall ((|l#0@@3| T@U) ) (!  (=> (and ($Is refType |l#0@@3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@3|))) (_module.Lifetime.alive $Heap@@87 |l#0@@3|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2331|
 :pattern ( (_module.Lifetime.alive $Heap@@87 |l#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@3|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@87 this@@119) (=> (not (_module.Lifetime.alive $Heap@@87 this@@119)) (forall ((|l#1@@0| T@U) ) (!  (=> ($Is refType |l#1@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@87 |l#1@@0|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2328|
 :pattern ( (_module.Lifetime.alive $Heap@@87 |l#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@87 this@@119)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@87 this@@119) (forall ((|o#0@@8| T@U) ) (!  (=> (and ($Is refType |o#0@@8| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#0@@8|))) (= (_module.OwnedObject.lifetime |o#0@@8|) this@@119))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2320|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#0@@8|)))
))) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#1@@3|))) (= (_module.OwnedObject.alive $Heap@@87 |o#1@@3|) (_module.Lifetime.alive $Heap@@87 this@@119)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2321|
 :pattern ( (_module.OwnedObject.alive $Heap@@87 |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.elements)) ($Box refType |o#1@@3|)))
))) (=> (_module.Lifetime.alive $Heap@@87 this@@119) (forall ((|l#0@@4| T@U) ) (!  (=> (and ($Is refType |l#0@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|))) (_module.Lifetime.alive $Heap@@87 |l#0@@4|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2322|
 :pattern ( (_module.Lifetime.alive $Heap@@87 |l#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@87 this@@119)) (forall ((|l#1@@1| T@U) ) (!  (=> (and ($Is refType |l#1@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|))) (not (_module.Lifetime.alive $Heap@@87 |l#1@@1|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2323|
 :pattern ( (_module.Lifetime.alive $Heap@@87 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
)))) (forall ((|l#2@@0| T@U) ) (!  (=> (and ($Is refType |l#2@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |l#2@@0|) _module.Lifetime.mightPointFrom)) ($Box refType this@@119)))
 :qid |_12MutexLifetimelongdfy.586:16|
 :skolemid |2324|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |l#2@@0|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@119)))
 :qid |_12MutexLifetimelongdfy.587:16|
 :skolemid |2325|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |l#3@@0|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@119) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2334|
 :pattern ( (_module.Lifetime.localInv $Heap@@87 this@@119) ($IsGoodHeap $Heap@@87))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@16 T@U) ($Heap@@88 T@U) (this@@120 T@U) (|a#0@@16| T@U) (|b#0@@16| T@U) (|_k#0@@10| Int) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@88) (and (or (not (= this@@120 null)) (not true)) ($Is refType this@@120 Tclass._module.Universe))) ($Is refType |a#0@@16| Tclass._module.Lifetime)) ($Is refType |b#0@@16| Tclass._module.Lifetime)) (= |_k#0@@10| 0)) (not (_module.Universe.outlives_h $ly@@16 $Heap@@88 this@@120 |_k#0@@10| |a#0@@16| |b#0@@16|)))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1580|
 :pattern ( (_module.Universe.outlives_h $ly@@16 $Heap@@88 this@@120 |_k#0@@10| |a#0@@16| |b#0@@16|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@25 T@U) ($Heap@@89 T@U) (this@@121 T@U) ) (!  (=> (or (|_module.MutexGuardU32.unchangedNonvolatileUserFields#canCall| $prevHeap@@25 $Heap@@89 this@@121) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@25) ($IsGoodHeap $Heap@@89)) ($HeapSucc $prevHeap@@25 $Heap@@89)) (and (or (not (= this@@121 null)) (not true)) (and ($Is refType this@@121 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@121 Tclass._module.MutexGuardU32 $prevHeap@@25)))))) (= (_module.MutexGuardU32.unchangedNonvolatileUserFields $prevHeap@@25 $Heap@@89 this@@121)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@25 this@@121) _module.MutexGuardU32.mutex)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@89 this@@121) _module.MutexGuardU32.mutex))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@25 this@@121) _module.MutexGuardU32.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@89 this@@121) _module.MutexGuardU32.data))))))
 :qid |_12MutexLifetimelongdfy.853:22|
 :skolemid |3569|
 :pattern ( (_module.MutexGuardU32.unchangedNonvolatileUserFields $prevHeap@@25 $Heap@@89 this@@121) ($IsGoodHeap $Heap@@89))
))))
...
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@122 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@122 null)) (not true)) ($Is refType this@@122 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@74 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (= $o@@74 this@@122)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@74) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@74) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |2121|
)) (= (_module.OwnedObject.objectFields $h0@@25 this@@122) (_module.OwnedObject.objectFields $h1@@25 this@@122))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2122|
 :pattern ( ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25) (_module.OwnedObject.objectFields $h1@@25 this@@122))
)))
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@123 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@123 null)) (not true)) ($Is refType this@@123 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@75 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (= $o@@75 this@@123)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@75) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@75) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |2224|
)) (= (_module.OwnedObject.objectUserFields $h0@@26 this@@123) (_module.OwnedObject.objectUserFields $h1@@26 this@@123))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2225|
 :pattern ( ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26) (_module.OwnedObject.objectUserFields $h1@@26 this@@123))
)))
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@124 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@124 null)) (not true)) ($Is refType this@@124 Tclass._module.OwnedU32))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@76 T@U) ($f@@31 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (= $o@@76 this@@124)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@76) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@76) $f@@31)))
 :qid |unknown.0:0|
 :skolemid |2719|
)) (= (_module.OwnedU32.objectUserFields $h0@@27 this@@124) (_module.OwnedU32.objectUserFields $h1@@27 this@@124))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2720|
 :pattern ( ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27) (_module.OwnedU32.objectUserFields $h1@@27 this@@124))
)))
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@125 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@125 null)) (not true)) ($Is refType this@@125 Tclass._module.Mutex))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@77 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@77 null)) (not true)) (= $o@@77 this@@125)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@77) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@77) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |3266|
)) (= (_module.Mutex.objectUserFields $h0@@28 this@@125) (_module.Mutex.objectUserFields $h1@@28 this@@125))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3267|
 :pattern ( ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28) (_module.Mutex.objectUserFields $h1@@28 this@@125))
)))
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@126 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@126 null)) (not true)) ($Is refType this@@126 Tclass._module.MutexGuardU32))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@78 T@U) ($f@@33 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (= $o@@78 this@@126)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@78) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@78) $f@@33)))
 :qid |unknown.0:0|
 :skolemid |3557|
)) (= (_module.MutexGuardU32.objectUserFields $h0@@29 this@@126) (_module.MutexGuardU32.objectUserFields $h1@@29 this@@126))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3558|
 :pattern ( ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29) (_module.MutexGuardU32.objectUserFields $h1@@29 this@@126))
)))
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@127 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@127 null)) (not true)) (and ($Is refType this@@127 Tclass._module.Universe) ($IsAlloc refType this@@127 Tclass._module.Universe $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@80 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@80) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@80) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@80) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |1186|
)) (= (_module.Universe.globalInv $h0@@30 this@@127) (_module.Universe.globalInv $h1@@30 this@@127))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1187|
 :pattern ( ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30) (_module.Universe.globalInv $h1@@30 this@@127))
)))
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@128 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@128 null)) (not true)) (and ($Is refType this@@128 Tclass._module.Object) ($IsAlloc refType this@@128 Tclass._module.Object $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@81 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@81) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@81) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@81) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |1699|
)) (= (_module.Object.objectGlobalBaseInv $h0@@31 this@@128) (_module.Object.objectGlobalBaseInv $h1@@31 this@@128))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1700|
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.Object.objectGlobalBaseInv $h1@@31 this@@128))
)))
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@129 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@129 null)) (not true)) (and ($Is refType this@@129 Tclass._module.Object) ($IsAlloc refType this@@129 Tclass._module.Object $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@82 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@82) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@82) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@82) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |1706|
)) (= (_module.Object.objectGlobalInv $h0@@32 this@@129) (_module.Object.objectGlobalInv $h1@@32 this@@129))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1707|
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.Object.objectGlobalInv $h1@@32 this@@129))
)))
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@130 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@130 null)) (not true)) (and ($Is refType this@@130 Tclass._module.Object) ($IsAlloc refType this@@130 Tclass._module.Object $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@83 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@83) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@83) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@83) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1781|
)) (= (_module.Object.localInv $h0@@33 this@@130) (_module.Object.localInv $h1@@33 this@@130))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1782|
 :pattern ( ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33) (_module.Object.localInv $h1@@33 this@@130))
)))
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@131 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@131 null)) (not true)) (and ($Is refType this@@131 Tclass._module.Object) ($IsAlloc refType this@@131 Tclass._module.Object $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@84 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@84) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@84) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1791|
)) (= (_module.Object.inv $h0@@34 this@@131) (_module.Object.inv $h1@@34 this@@131))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1792|
 :pattern ( ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34) (_module.Object.inv $h1@@34 this@@131))
)))
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@132 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@132 null)) (not true)) (and ($Is refType this@@132 Tclass._module.Thread) ($IsAlloc refType this@@132 Tclass._module.Thread $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@85 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@85 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@85) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@85) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@85) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1871|
)) (= (_module.Thread.localInv $h0@@35 this@@132) (_module.Thread.localInv $h1@@35 this@@132))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1872|
 :pattern ( ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35) (_module.Thread.localInv $h1@@35 this@@132))
)))
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@133 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@133 null)) (not true)) (and ($Is refType this@@133 Tclass._module.Thread) ($IsAlloc refType this@@133 Tclass._module.Thread $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@86 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@86 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@86) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@86) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@86) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1881|
)) (= (_module.Thread.inv $h0@@36 this@@133) (_module.Thread.inv $h1@@36 this@@133))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1882|
 :pattern ( ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36) (_module.Thread.inv $h1@@36 this@@133))
)))
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@134 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@134 null)) (not true)) (and ($Is refType this@@134 Tclass._module.OwnedObject) ($IsAlloc refType this@@134 Tclass._module.OwnedObject $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@87 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@87 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@87) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@87) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@87) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |2149|
)) (= (_module.OwnedObject.localInv $h0@@37 this@@134) (_module.OwnedObject.localInv $h1@@37 this@@134))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2150|
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.OwnedObject.localInv $h1@@37 this@@134))
)))
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@135 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@135 null)) (not true)) (and ($Is refType this@@135 Tclass._module.OwnedObject) ($IsAlloc refType this@@135 Tclass._module.OwnedObject $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@88 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@88) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@88) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |2161|
)) (= (_module.OwnedObject.inv $h0@@38 this@@135) (_module.OwnedObject.inv $h1@@38 this@@135))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2162|
 :pattern ( ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38) (_module.OwnedObject.inv $h1@@38 this@@135))
)))
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@136 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@136 null)) (not true)) (and ($Is refType this@@136 Tclass._module.OwnedObject) ($IsAlloc refType this@@136 Tclass._module.OwnedObject $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@89 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@89 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@89) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@89) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@89) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |2233|
)) (= (_module.OwnedObject.localUserInv $h0@@39 this@@136) (_module.OwnedObject.localUserInv $h1@@39 this@@136))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2234|
 :pattern ( ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39) (_module.OwnedObject.localUserInv $h1@@39 this@@136))
)))
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@137 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@137 null)) (not true)) (and ($Is refType this@@137 Tclass._module.OwnedObject) ($IsAlloc refType this@@137 Tclass._module.OwnedObject $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@90 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@90) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@90) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |2241|
)) (= (_module.OwnedObject.userInv $h0@@40 this@@137) (_module.OwnedObject.userInv $h1@@40 this@@137))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2242|
 :pattern ( ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40) (_module.OwnedObject.userInv $h1@@40 this@@137))
)))
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@138 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@138 null)) (not true)) (and ($Is refType this@@138 Tclass._module.Lifetime) ($IsAlloc refType this@@138 Tclass._module.Lifetime $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@91 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@91 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@91) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@91) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@91) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |2316|
)) (= (_module.Lifetime.localInv $h0@@41 this@@138) (_module.Lifetime.localInv $h1@@41 this@@138))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2317|
 :pattern ( ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41) (_module.Lifetime.localInv $h1@@41 this@@138))
)))
(assert (forall (($h0@@42 T@U) ($h1@@42 T@U) (this@@139 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@42) ($IsGoodHeap $h1@@42)) (and (or (not (= this@@139 null)) (not true)) (and ($Is refType this@@139 Tclass._module.Lifetime) ($IsAlloc refType this@@139 Tclass._module.Lifetime $h0@@42)))) (and ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42))) (=> (forall (($o@@92 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@92 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@92) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@92) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@42 $o@@92) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |2383|
)) (= (_module.Lifetime.inv $h0@@42 this@@139) (_module.Lifetime.inv $h1@@42 this@@139))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2384|
 :pattern ( ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42) (_module.Lifetime.inv $h1@@42 this@@139))
)))
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@140 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@140 null)) (not true)) (and ($Is refType this@@140 Tclass._module.OwnedU32) ($IsAlloc refType this@@140 Tclass._module.OwnedU32 $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@93 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@93 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@93) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@93) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@93) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |2734|
)) (= (_module.OwnedU32.localUserInv $h0@@43 this@@140) (_module.OwnedU32.localUserInv $h1@@43 this@@140))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2735|
 :pattern ( ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43) (_module.OwnedU32.localUserInv $h1@@43 this@@140))
)))
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@141 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@141 null)) (not true)) (and ($Is refType this@@141 Tclass._module.OwnedU32) ($IsAlloc refType this@@141 Tclass._module.OwnedU32 $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@94 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@94) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@94) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@94) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |2741|
)) (= (_module.OwnedU32.userInv $h0@@44 this@@141) (_module.OwnedU32.userInv $h1@@44 this@@141))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2742|
 :pattern ( ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44) (_module.OwnedU32.userInv $h1@@44 this@@141))
)))
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@142 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@142 null)) (not true)) (and ($Is refType this@@142 Tclass._module.Mutex) ($IsAlloc refType this@@142 Tclass._module.Mutex $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@95 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@95 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@95) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@95) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@95) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |3281|
)) (= (_module.Mutex.localUserInv $h0@@45 this@@142) (_module.Mutex.localUserInv $h1@@45 this@@142))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3282|
 :pattern ( ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45) (_module.Mutex.localUserInv $h1@@45 this@@142))
)))
(assert (forall (($h0@@46 T@U) ($h1@@46 T@U) (this@@143 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@46) ($IsGoodHeap $h1@@46)) (and (or (not (= this@@143 null)) (not true)) (and ($Is refType this@@143 Tclass._module.Mutex) ($IsAlloc refType this@@143 Tclass._module.Mutex $h0@@46)))) (and ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46))) (=> (forall (($o@@96 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@96 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@96) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@96) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@46 $o@@96) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |3288|
)) (= (_module.Mutex.userInv $h0@@46 this@@143) (_module.Mutex.userInv $h1@@46 this@@143))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3289|
 :pattern ( ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46) (_module.Mutex.userInv $h1@@46 this@@143))
)))
(assert (forall (($h0@@47 T@U) ($h1@@47 T@U) (this@@144 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@47) ($IsGoodHeap $h1@@47)) (and (or (not (= this@@144 null)) (not true)) (and ($Is refType this@@144 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@144 Tclass._module.MutexGuardU32 $h0@@47)))) (and ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47))) (=> (forall (($o@@97 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@97 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@97) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@97) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@47 $o@@97) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |3572|
)) (= (_module.MutexGuardU32.localUserInv $h0@@47 this@@144) (_module.MutexGuardU32.localUserInv $h1@@47 this@@144))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3573|
 :pattern ( ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47) (_module.MutexGuardU32.localUserInv $h1@@47 this@@144))
)))
(assert (forall (($h0@@48 T@U) ($h1@@48 T@U) (this@@145 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@48) ($IsGoodHeap $h1@@48)) (and (or (not (= this@@145 null)) (not true)) (and ($Is refType this@@145 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@145 Tclass._module.MutexGuardU32 $h0@@48)))) (and ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48))) (=> (forall (($o@@98 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@98 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@98) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@98) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@48 $o@@98) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |3580|
)) (= (_module.MutexGuardU32.userInv $h0@@48 this@@145) (_module.MutexGuardU32.userInv $h1@@48 this@@145))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3581|
 :pattern ( ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48) (_module.MutexGuardU32.userInv $h1@@48 this@@145))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@146 T@U) ) (!  (=> (or (|_module.OwnedU32.volatileOwns#canCall| this@@146) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@146 null)) (not true)) ($Is refType this@@146 Tclass._module.OwnedU32)))) (= (_module.OwnedU32.volatileOwns this@@146) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimelongdfy.638:19|
 :skolemid |2715|
 :pattern ( (_module.OwnedU32.volatileOwns this@@146))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@147 T@U) ) (!  (=> (or (|_module.MutexGuardU32.volatileOwns#canCall| this@@147) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@147 null)) (not true)) ($Is refType this@@147 Tclass._module.MutexGuardU32)))) (= (_module.MutexGuardU32.volatileOwns this@@147) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimelongdfy.848:19|
 :skolemid |3553|
 :pattern ( (_module.MutexGuardU32.volatileOwns this@@147))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@148 T@U) ) (!  (=> (or (|_module.OwnedU32.volatileOwns#canCall| this@@148) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@148 null)) (not true)) ($Is refType this@@148 Tclass._module.OwnedU32)))) (= (_module.OwnedObject.volatileOwns this@@148) (_module.OwnedU32.volatileOwns this@@148)))
 :qid |_12MutexLifetimelongdfy.518:19|
 :skolemid |2717|
 :pattern ( (_module.OwnedObject.volatileOwns this@@148) ($Is refType this@@148 Tclass._module.OwnedU32))
 :pattern ( (_module.OwnedObject.volatileOwns this@@148) (_module.OwnedU32.volatileOwns this@@148))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@149 T@U) ) (!  (=> (or (|_module.Mutex.volatileOwns#canCall| this@@149) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@149 null)) (not true)) ($Is refType this@@149 Tclass._module.Mutex)))) (= (_module.Mutex.volatileOwns this@@149) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.763:19|
 :skolemid |3262|
 :pattern ( (_module.Mutex.volatileOwns this@@149))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@150 T@U) ) (!  (=> (or (|_module.Mutex.volatileOwns#canCall| this@@150) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@150 null)) (not true)) ($Is refType this@@150 Tclass._module.Mutex)))) (= (_module.OwnedObject.volatileOwns this@@150) (_module.Mutex.volatileOwns this@@150)))
 :qid |_12MutexLifetimelongdfy.518:19|
 :skolemid |3264|
 :pattern ( (_module.OwnedObject.volatileOwns this@@150) ($Is refType this@@150 Tclass._module.Mutex))
 :pattern ( (_module.OwnedObject.volatileOwns this@@150) (_module.Mutex.volatileOwns this@@150))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@151 T@U) ) (!  (=> (or (|_module.MutexGuardU32.volatileOwns#canCall| this@@151) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@151 null)) (not true)) ($Is refType this@@151 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.volatileOwns this@@151) (_module.MutexGuardU32.volatileOwns this@@151)))
 :qid |_12MutexLifetimelongdfy.518:19|
 :skolemid |3555|
 :pattern ( (_module.OwnedObject.volatileOwns this@@151) ($Is refType this@@151 Tclass._module.MutexGuardU32))
 :pattern ( (_module.OwnedObject.volatileOwns this@@151) (_module.MutexGuardU32.volatileOwns this@@151))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@152 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@152) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@152 null)) (not true)) ($Is refType this@@152 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@152) (_module.Thread.objectClassKind this@@152)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1855|
 :pattern ( (_module.Object.objectClassKind this@@152) ($Is refType this@@152 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@152) (_module.Thread.objectClassKind this@@152))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@153 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@153) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@153 null)) (not true)) ($Is refType this@@153 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@153) (_module.OwnedObject.objectClassKind this@@153)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2119|
 :pattern ( (_module.Object.objectClassKind this@@153) ($Is refType this@@153 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@153) (_module.OwnedObject.objectClassKind this@@153))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@154 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@154) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@154 null)) (not true)) ($Is refType this@@154 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@154) (_module.Lifetime.objectClassKind this@@154)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2295|
 :pattern ( (_module.Object.objectClassKind this@@154) ($Is refType this@@154 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@154) (_module.Lifetime.objectClassKind this@@154))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@155 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@155) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@155 null)) (not true)) ($Is refType this@@155 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@155) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1851|
 :pattern ( (_module.Thread.objectClassKind this@@155))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@156 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@156) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@156 null)) (not true)) ($Is refType this@@156 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@156) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2115|
 :pattern ( (_module.OwnedObject.objectClassKind this@@156))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@157 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@157) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@157 null)) (not true)) ($Is refType this@@157 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@157) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2291|
 :pattern ( (_module.Lifetime.objectClassKind this@@157))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@158 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@158) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@158 null)) (not true)) ($Is refType this@@158 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@158) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1773|
 :pattern ( (_module.Object.objectClassKind this@@158))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@90 T@U) (this@@159 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@90 this@@159) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@90) (and (or (not (= this@@159 null)) (not true)) (and ($Is refType this@@159 Tclass._module.Thread) ($IsAlloc refType this@@159 Tclass._module.Thread $Heap@@90)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@90 this@@159)) (= (_module.Thread.localInv $Heap@@90 this@@159)  (and true (_module.Object.objectGlobalBaseInv $Heap@@90 this@@159)))))
 :qid |_12MutexLifetimelongdfy.369:19|
 :skolemid |1875|
 :pattern ( (_module.Thread.localInv $Heap@@90 this@@159) ($IsGoodHeap $Heap@@90))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@91 T@U) (this@@160 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@91 this@@160) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@91) (and (or (not (= this@@160 null)) (not true)) (and ($Is refType this@@160 Tclass._module.Thread) ($IsAlloc refType this@@160 Tclass._module.Thread $Heap@@91)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@91 this@@160)) (= (_module.Thread.inv $Heap@@91 this@@160)  (and true (_module.Thread.localInv $Heap@@91 this@@160)))))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1885|
 :pattern ( (_module.Thread.inv $Heap@@91 this@@160) ($IsGoodHeap $Heap@@91))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@161 T@U) ) (!  (=> (or (|_module.OwnedU32.volatileOwns#canCall| (Lit refType this@@161)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@161 null)) (not true)) ($Is refType this@@161 Tclass._module.OwnedU32)))) (= (_module.OwnedU32.volatileOwns (Lit refType this@@161)) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimelongdfy.638:19|
 :weight 3
 :skolemid |2716|
 :pattern ( (_module.OwnedU32.volatileOwns (Lit refType this@@161)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@162 T@U) ) (!  (=> (or (|_module.MutexGuardU32.volatileOwns#canCall| (Lit refType this@@162)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@162 null)) (not true)) ($Is refType this@@162 Tclass._module.MutexGuardU32)))) (= (_module.MutexGuardU32.volatileOwns (Lit refType this@@162)) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimelongdfy.848:19|
 :weight 3
 :skolemid |3554|
 :pattern ( (_module.MutexGuardU32.volatileOwns (Lit refType this@@162)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@163 T@U) ) (!  (=> (or (|_module.Mutex.volatileOwns#canCall| (Lit refType this@@163)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@163 null)) (not true)) ($Is refType this@@163 Tclass._module.Mutex)))) (= (_module.Mutex.volatileOwns (Lit refType this@@163)) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.763:19|
 :weight 3
 :skolemid |3263|
 :pattern ( (_module.Mutex.volatileOwns (Lit refType this@@163)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@92 T@U) (this@@164 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@92 this@@164) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@92) (and (or (not (= this@@164 null)) (not true)) (and ($Is refType this@@164 Tclass._module.OwnedObject) ($IsAlloc refType this@@164 Tclass._module.OwnedObject $Heap@@92)))))) (= (_module.OwnedObject.alive $Heap@@92 this@@164)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@92 this@@164) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.422:19|
 :skolemid |2114|
 :pattern ( (_module.OwnedObject.alive $Heap@@92 this@@164) ($IsGoodHeap $Heap@@92))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@93 T@U) (this@@165 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@93 this@@165) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@93) (and (or (not (= this@@165 null)) (not true)) (and ($Is refType this@@165 Tclass._module.Lifetime) ($IsAlloc refType this@@165 Tclass._module.Lifetime $Heap@@93)))))) (= (_module.Lifetime.alive $Heap@@93 this@@165)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 this@@165) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@93 this@@165) ($IsGoodHeap $Heap@@93))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@94 T@U) (this@@166 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@94 this@@166) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@94) (and (or (not (= this@@166 null)) (not true)) (and ($Is refType this@@166 Tclass._module.Lifetime) ($IsAlloc refType this@@166 Tclass._module.Lifetime $Heap@@94)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@94 this@@166)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@166) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 (_module.Object.universe this@@166)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@166) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@166) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 (_module.Object.universe this@@166)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@166) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 (_module.Object.universe this@@166)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@166) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 (_module.Object.universe this@@166)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@94 this@@166) ($IsGoodHeap $Heap@@94))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@26 T@U) ($Heap@@95 T@U) (this@@167 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@26 $Heap@@95 this@@167) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@26) ($IsGoodHeap $Heap@@95)) ($HeapSucc $prevHeap@@26 $Heap@@95)) (and (or (not (= this@@167 null)) (not true)) (and ($Is refType this@@167 Tclass._module.OwnedObject) ($IsAlloc refType this@@167 Tclass._module.OwnedObject $prevHeap@@26)))))) (and (=> (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@167) _module.OwnedObject.owner)) null)) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@167) _module.OwnedObject.nonvolatileVersion)))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@167) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@26 $Heap@@95 this@@167))) (=> (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@167) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@26 $Heap@@95 this@@167))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.owner))))
(|_module.OwnedObject.volatileOwns#canCall| |oldOwner#0|))))))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@26 $Heap@@95 this@@167)  (and (and (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@167) _module.OwnedObject.owner)) null)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@167) _module.OwnedObject.nonvolatileVersion))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@167) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@26 $Heap@@95 this@@167)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#0@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@167) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@167) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_12MutexLifetimelongdfy.458:22|
 :skolemid |2186|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@26 $Heap@@95 this@@167) ($IsGoodHeap $Heap@@95))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.MutexGuardU32.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 40) (let ((anon6_correct  (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@111 T@U) ) (!  (=> (and (or (not (= $o@@111 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@111) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@111)) (or (= $o@@111 |universe#0|) (or (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType $o@@111)) (not (and ($Is refType $o@@111 Tclass._module.Lifetime) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType $o@@111)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@111) _module.Lifetime.owner)) |running#0@@1|))))) (or (= $o@@111 |scope#0|) (= $o@@111 |mutexScope#0|))))))
 :qid |_12MutexLifetimelongdfy.890:3|
 :skolemid |3751|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111))
)) ($HeapSucc $Heap@@96 $Heap@0))) (=> (and (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass._module.MutexGuardU32) ($IsAlloc refType this@0 Tclass._module.MutexGuardU32 $Heap@0))) ($IsAllocBox ($Box refType this@0) Tclass._module.Object? $Heap@0)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@0) (_module.Object.objectGlobalInv $Heap@0 this@0))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@0) (=> (and (= |##running#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|))) ($IsAlloc SetType |##running#0@0| (TSet Tclass._module.Thread) $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 15)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@96)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@96) (and (=> (= (ControlFlow 0 2) (- 0 14)) ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|)) (TSet Tclass._module.Thread) $Heap@@96)) (=> ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|)) (TSet Tclass._module.Thread) $Heap@@96) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|))) (=> (and (and (_module.Universe.legalTransitionsSequence $Heap@@96 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|))) (= (_module.Object.universe this@0) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.OwnedObject.owner)) |running#0@@1|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex)) |mutex#0|))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (or (not (= |mutex#0| null)) (not true))) (=> (or (not (= |mutex#0| null)) (not true)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |mutex#0|) _module.Mutex.data))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex)) null)) (not true)) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex))) _module.Mutex.locked))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex)) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@0) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true))) (=> (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true)) (=> (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.OwnedObject.lifetime this@0)) _module.Lifetime.mightPointFrom)) |Set#Empty|) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true))) (=> (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true)) (=> (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.OwnedObject.lifetime this@0)) _module.Lifetime.elements)) (|Set#UnionOne| |Set#Empty| ($Box refType this@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true))) (=> (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.OwnedObject.lifetime this@0)) _module.Lifetime.owner)) |running#0@@1|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |mutexScope#0| null)) (not true))) (=> (or (not (= |mutexScope#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |mutexScope#0| null)) (not true))) (=> (or (not (= |mutexScope#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@96)) (=> ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@96) (=> (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |mutexScope#0|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |mutexScope#0|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@0))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this@0)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |scope#0| null)) (not true))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon9_Else_correct  (=> (and (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |l#0@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |l#0@0|) _module.Lifetime.owner)) |running#0@@1|))) (= (ControlFlow 0 19) 2)) anon6_correct)))
(let ((anon9_Then_correct  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |l#0@0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |l#0@0|) _module.Lifetime.owner)) |running#0@@1|)) (= (ControlFlow 0 18) 2)) anon6_correct)))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |l#0@0|))) (and (=> (= (ControlFlow 0 22) 18) anon9_Then_correct) (=> (= (ControlFlow 0 22) 19) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |l#0@0|)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= |l#0@0| null)) (not true))) (=> (or (not (= |l#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 20) 18) anon9_Then_correct) (=> (= (ControlFlow 0 20) 19) anon9_Else_correct)))))))
(let ((anon7_Then_correct  (=> (and ($Is refType |l#0@0| Tclass._module.Lifetime) ($IsAlloc refType |l#0@0| Tclass._module.Lifetime $Heap@@96)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 23) 20) anon8_Then_correct) (=> (= (ControlFlow 0 23) 22) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (and (not (and ($Is refType |l#0@0| Tclass._module.Lifetime) ($IsAlloc refType |l#0@0| Tclass._module.Lifetime $Heap@@96))) (= (ControlFlow 0 17) 2)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#287| null $Heap@@96 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) Tclass._module.Lifetime ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) $Heap@@96 _module.Lifetime.owner |running#0@@1| |scope#0| |mutexScope#0|)) (and (=> (= (ControlFlow 0 25) (- 0 39)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@96) (=> (and (|_module.Universe.globalInv#canCall| $Heap@@96 |universe#0|) (_module.Universe.globalInv $Heap@@96 |universe#0|)) (and (=> (= (ControlFlow 0 25) (- 0 38)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|)) ($Box refType |scope#0|)) ($Box refType |mutex#0|)) ($Box refType |mutexScope#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 25) (- 0 37)) (or (not (= |scope#0| null)) (not true))) (=> (or (not (= |scope#0| null)) (not true)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |scope#0|) _module.Lifetime.owner)) |running#0@@1|) (and (=> (= (ControlFlow 0 25) (- 0 36)) (or (not (= |mutexScope#0| null)) (not true))) (=> (or (not (= |mutexScope#0| null)) (not true)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |mutexScope#0|) _module.Lifetime.owner)) |running#0@@1|) (or (not (= |scope#0| |mutexScope#0|)) (not true))) (and (=> (= (ControlFlow 0 25) (- 0 35)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@96) (and (=> (= (ControlFlow 0 25) (- 0 34)) (or (not (= |mutex#0| null)) (not true))) (=> (or (not (= |mutex#0| null)) (not true)) (=> (= |##a#0@0| (_module.OwnedObject.lifetime |mutex#0|)) (=> (and ($IsAlloc refType |##a#0@0| Tclass._module.Lifetime $Heap@@96) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@96)) (and (=> (= (ControlFlow 0 25) (- 0 33)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |##a#0@0|))) (and (=> (= (ControlFlow 0 25) (- 0 32)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |mutexScope#0|))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |##a#0@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |mutexScope#0|))) (and (|_module.Universe.outlives#canCall| $Heap@@96 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@@96 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|))) (and (=> (= (ControlFlow 0 25) (- 0 31)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@96) (=> (and ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@96) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@96)) (and (=> (= (ControlFlow 0 25) (- 0 30)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |mutexScope#0|))) (and (=> (= (ControlFlow 0 25) (- 0 29)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |scope#0|))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |mutexScope#0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |universe#0|) _module.Universe.content)) ($Box refType |scope#0|))) (and (|_module.Universe.outlives#canCall| $Heap@@96 |universe#0| |mutexScope#0| |scope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@@96 |universe#0| |mutexScope#0| |scope#0|))) (and (=> (= (ControlFlow 0 25) (- 0 28)) (or (not (= |scope#0| null)) (not true))) (=> (or (not (= |scope#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |scope#0|) Tclass._module.Lifetime? $Heap@@96) (=> (and (|_module.Lifetime.unused#canCall| $Heap@@96 |scope#0|) (_module.Lifetime.unused $Heap@@96 |scope#0|)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (or (not (= |mutex#0| null)) (not true))) (=> (or (not (= |mutex#0| null)) (not true)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |mutex#0|) _module.Mutex.locked)))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 25) 23) anon7_Then_correct) (=> (= (ControlFlow 0 25) 17) anon7_Else_correct))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@96) ($IsHeapAnchor $Heap@@96)) (=> (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@96)) (and ($Is refType |running#0@@1| Tclass._module.Thread) ($IsAlloc refType |running#0@@1| Tclass._module.Thread $Heap@@96))) (=> (and (and (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@96)) (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@96))) (and (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@96)) (and (= 23 $FunctionContextHeight) (= (ControlFlow 0 40) 25)))) anon0_correct)))))
