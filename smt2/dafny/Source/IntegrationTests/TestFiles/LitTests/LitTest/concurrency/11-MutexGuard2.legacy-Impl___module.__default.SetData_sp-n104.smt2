...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split88)
...
(assert (not
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@6|)))
))))) (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@6 |universe#0|) (=> (_module.Universe.globalInv $Heap@6 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@6 $Heap@6 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@6 |universe#0|) (and (_module.Universe.globalInv $Heap@6 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@6 |universe#0|) (forall ((|o#10@@1| T@U) ) (!  (=> (and ($Is refType |o#10@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@1|))) (_module.Object.inv $Heap@6 |o#10@@1|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |815|
