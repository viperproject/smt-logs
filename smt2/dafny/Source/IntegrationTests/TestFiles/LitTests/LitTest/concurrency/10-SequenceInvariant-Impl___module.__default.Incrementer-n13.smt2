...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Universe.globalInv#canCall| $Heap@@1 this@@1) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Universe) ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@1)))))) (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@@1 this@@1) (=> (_module.Universe.globalBaseInv $Heap@@1 this@@1) (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Universe.content)) ($Box refType |o#0|)) (|_module.Object.inv#canCall| $Heap@@1 |o#0|)))
...
)))) (= (_module.Universe.globalInv $Heap@@1 this@@1)  (and (_module.Universe.globalBaseInv $Heap@@1 this@@1) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Universe.content)) ($Box refType |o#0@@0|))) (_module.Object.inv $Heap@@1 |o#0@@0|))
 :qid |_10SequenceInvariantdfy.22:32|
 :skolemid |624|
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.ConstantInteger.localUserInv#canCall| $Heap@@4 this@@4) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.ConstantInteger)))) (= (_module.OwnedObject.localUserInv $Heap@@4 this@@4) (_module.ConstantInteger.localUserInv $Heap@@4 this@@4)))
 :qid |_10SequenceInvariantdfy.395:19|
 :skolemid |2010|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@4 this@@4) ($Is refType this@@4 Tclass._module.ConstantInteger) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@4 this@@4) (_module.ConstantInteger.localUserInv $Heap@@4 this@@4) ($IsGoodHeap $Heap@@4))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv#canCall| $Heap@@5 this@@5) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.ClaimIncreasingCounterGreaterThanConstant)))) (= (_module.OwnedObject.localUserInv $Heap@@5 this@@5) (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@5 this@@5)))
 :qid |_10SequenceInvariantdfy.395:19|
 :skolemid |2223|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@5 this@@5) ($Is refType this@@5 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsGoodHeap $Heap@@5))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@5 this@@5) (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@5 this@@5) ($IsGoodHeap $Heap@@5))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.IncreasingCounter.userInv#canCall| $Heap@@6 this@@6) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.IncreasingCounter)))) (= (_module.OwnedObject.userInv $Heap@@6 this@@6) (_module.IncreasingCounter.userInv $Heap@@6 this@@6)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1595|
 :pattern ( (_module.OwnedObject.userInv $Heap@@6 this@@6) ($Is refType this@@6 Tclass._module.IncreasingCounter) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.OwnedObject.userInv $Heap@@6 this@@6) (_module.IncreasingCounter.userInv $Heap@@6 this@@6) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.Integer.userInv#canCall| $Heap@@7 this@@7) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.Integer)))) (= (_module.OwnedObject.userInv $Heap@@7 this@@7) (_module.Integer.userInv $Heap@@7 this@@7)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1806|
 :pattern ( (_module.OwnedObject.userInv $Heap@@7 this@@7) ($Is refType this@@7 Tclass._module.Integer) ($IsGoodHeap $Heap@@7))
 :pattern ( (_module.OwnedObject.userInv $Heap@@7 this@@7) (_module.Integer.userInv $Heap@@7 this@@7) ($IsGoodHeap $Heap@@7))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.ConstantInteger.userInv#canCall| $Heap@@8 this@@8) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.ConstantInteger)))) (= (_module.OwnedObject.userInv $Heap@@8 this@@8) (_module.ConstantInteger.userInv $Heap@@8 this@@8)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |2017|
 :pattern ( (_module.OwnedObject.userInv $Heap@@8 this@@8) ($Is refType this@@8 Tclass._module.ConstantInteger) ($IsGoodHeap $Heap@@8))
 :pattern ( (_module.OwnedObject.userInv $Heap@@8 this@@8) (_module.ConstantInteger.userInv $Heap@@8 this@@8) ($IsGoodHeap $Heap@@8))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.ClaimIncreasingCounterGreaterThanConstant.userInv#canCall| $Heap@@9 this@@9) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.ClaimIncreasingCounterGreaterThanConstant)))) (= (_module.OwnedObject.userInv $Heap@@9 this@@9) (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@9 this@@9)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |2230|
 :pattern ( (_module.OwnedObject.userInv $Heap@@9 this@@9) ($Is refType this@@9 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.OwnedObject.userInv $Heap@@9 this@@9) (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@9 this@@9) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@10 this@@10) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.Thread)))) (= (_module.Object.baseFieldsInv $Heap@@10 this@@10) (_module.Thread.baseFieldsInv $Heap@@10 this@@10)))
 :qid |_10SequenceInvariantdfy.239:19|
 :skolemid |1192|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@10 this@@10) ($Is refType this@@10 Tclass._module.Thread) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@10 this@@10) (_module.Thread.baseFieldsInv $Heap@@10 this@@10) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.IncreasingCounter.baseUserFieldsInv#canCall| $Heap@@11 this@@11) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.IncreasingCounter)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@11 this@@11) (_module.IncreasingCounter.baseUserFieldsInv $Heap@@11 this@@11)))
 :qid |_10SequenceInvariantdfy.392:19|
 :skolemid |1567|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@11 this@@11) ($Is refType this@@11 Tclass._module.IncreasingCounter) ($IsGoodHeap $Heap@@11))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@11 this@@11) (_module.IncreasingCounter.baseUserFieldsInv $Heap@@11 this@@11) ($IsGoodHeap $Heap@@11))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Integer.baseUserFieldsInv#canCall| $Heap@@12 this@@12) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@12 null)) (not true)) ($Is refType this@@12 Tclass._module.Integer)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@12 this@@12) (_module.Integer.baseUserFieldsInv $Heap@@12 this@@12)))
 :qid |_10SequenceInvariantdfy.392:19|
 :skolemid |1778|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@12 this@@12) ($Is refType this@@12 Tclass._module.Integer) ($IsGoodHeap $Heap@@12))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@12 this@@12) (_module.Integer.baseUserFieldsInv $Heap@@12 this@@12) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.ConstantInteger.baseUserFieldsInv#canCall| $Heap@@13 this@@13) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@13 null)) (not true)) ($Is refType this@@13 Tclass._module.ConstantInteger)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@13 this@@13) (_module.ConstantInteger.baseUserFieldsInv $Heap@@13 this@@13)))
 :qid |_10SequenceInvariantdfy.392:19|
 :skolemid |1989|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@13 this@@13) ($Is refType this@@13 Tclass._module.ConstantInteger) ($IsGoodHeap $Heap@@13))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@13 this@@13) (_module.ConstantInteger.baseUserFieldsInv $Heap@@13 this@@13) ($IsGoodHeap $Heap@@13))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv#canCall| $Heap@@14 this@@14) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.ClaimIncreasingCounterGreaterThanConstant)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@14 this@@14) (_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv $Heap@@14 this@@14)))
 :qid |_10SequenceInvariantdfy.392:19|
 :skolemid |2202|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@14 this@@14) ($Is refType this@@14 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsGoodHeap $Heap@@14))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@14 this@@14) (_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv $Heap@@14 this@@14) ($IsGoodHeap $Heap@@14))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@15 this@@15) (and (< 4 $FunctionContextHeight) (and (or (not (= this@@15 null)) (not true)) ($Is refType this@@15 Tclass._module.OwnedObject)))) (= (_module.Object.baseFieldsInv $Heap@@15 this@@15) (_module.OwnedObject.baseFieldsInv $Heap@@15 this@@15)))
 :qid |_10SequenceInvariantdfy.239:19|
 :skolemid |1445|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@15 this@@15) ($Is refType this@@15 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@15))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@15 this@@15) (_module.OwnedObject.baseFieldsInv $Heap@@15 this@@15) ($IsGoodHeap $Heap@@15))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@16 this@@16) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@16 null)) (not true)) ($Is refType this@@16 Tclass._module.Thread)))) (= (_module.Object.localInv $Heap@@16 this@@16) (_module.Thread.localInv $Heap@@16 this@@16)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1206|
 :pattern ( (_module.Object.localInv $Heap@@16 this@@16) ($Is refType this@@16 Tclass._module.Thread) ($IsGoodHeap $Heap@@16))
 :pattern ( (_module.Object.localInv $Heap@@16 this@@16) (_module.Thread.localInv $Heap@@16 this@@16) ($IsGoodHeap $Heap@@16))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@17 this@@17) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@17 null)) (not true)) ($Is refType this@@17 Tclass._module.OwnedObject)))) (= (_module.Object.localInv $Heap@@17 this@@17) (_module.OwnedObject.localInv $Heap@@17 this@@17)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1461|
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@18 this@@18) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@18 null)) (not true)) ($Is refType this@@18 Tclass._module.Thread)))) (= (_module.Object.inv $Heap@@18 this@@18) (_module.Thread.inv $Heap@@18 this@@18)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1218|
 :pattern ( (_module.Object.inv $Heap@@18 this@@18) ($Is refType this@@18 Tclass._module.Thread) ($IsGoodHeap $Heap@@18))
 :pattern ( (_module.Object.inv $Heap@@18 this@@18) (_module.Thread.inv $Heap@@18 this@@18) ($IsGoodHeap $Heap@@18))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@19 this@@19) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@19 null)) (not true)) ($Is refType this@@19 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@19 this@@19) (_module.OwnedObject.inv $Heap@@19 this@@19)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1474|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@21 this@@21) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Thread) ($IsAlloc refType this@@21 Tclass._module.Thread $Heap@@21)))))) (= (_module.Thread.baseFieldsInv $Heap@@21 this@@21) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.254:19|
 :skolemid |1191|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@21 this@@21) ($IsGoodHeap $Heap@@21))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@22 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.IncreasingCounter.baseUserFieldsInv#canCall| $Heap@@22 this@@22) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@22 Tclass._module.IncreasingCounter $Heap@@22)))))) (= (_module.IncreasingCounter.baseUserFieldsInv $Heap@@22 this@@22) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.419:19|
 :skolemid |1566|
 :pattern ( (_module.IncreasingCounter.baseUserFieldsInv $Heap@@22 this@@22) ($IsGoodHeap $Heap@@22))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.Integer.baseUserFieldsInv#canCall| $Heap@@23 this@@23) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Integer) ($IsAlloc refType this@@23 Tclass._module.Integer $Heap@@23)))))) (= (_module.Integer.baseUserFieldsInv $Heap@@23 this@@23) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.461:19|
 :skolemid |1777|
 :pattern ( (_module.Integer.baseUserFieldsInv $Heap@@23 this@@23) ($IsGoodHeap $Heap@@23))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@24 T@U) (this@@24 T@U) ) (!  (=> (or (|_module.ConstantInteger.baseUserFieldsInv#canCall| $Heap@@24 this@@24) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@24) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.ConstantInteger) ($IsAlloc refType this@@24 Tclass._module.ConstantInteger $Heap@@24)))))) (= (_module.ConstantInteger.baseUserFieldsInv $Heap@@24 this@@24) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.505:19|
 :skolemid |1988|
 :pattern ( (_module.ConstantInteger.baseUserFieldsInv $Heap@@24 this@@24) ($IsGoodHeap $Heap@@24))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@25 T@U) (this@@25 T@U) ) (!  (=> (or (|_module.IncreasingCounter.localUserInv#canCall| $Heap@@25 this@@25) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@25) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@25 Tclass._module.IncreasingCounter $Heap@@25)))))) (= (_module.IncreasingCounter.localUserInv $Heap@@25 this@@25) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_10SequenceInvariantdfy.424:19|
 :skolemid |1587|
 :pattern ( (_module.IncreasingCounter.localUserInv $Heap@@25 this@@25) ($IsGoodHeap $Heap@@25))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@26 T@U) (this@@26 T@U) ) (!  (=> (or (|_module.Integer.localUserInv#canCall| $Heap@@26 this@@26) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@26) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.Integer) ($IsAlloc refType this@@26 Tclass._module.Integer $Heap@@26)))))) (= (_module.Integer.localUserInv $Heap@@26 this@@26) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_10SequenceInvariantdfy.468:19|
 :skolemid |1798|
 :pattern ( (_module.Integer.localUserInv $Heap@@26 this@@26) ($IsGoodHeap $Heap@@26))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@27 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.ConstantInteger.localUserInv#canCall| $Heap@@27 this@@27) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@27) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.ConstantInteger) ($IsAlloc refType this@@27 Tclass._module.ConstantInteger $Heap@@27)))))) (= (_module.ConstantInteger.localUserInv $Heap@@27 this@@27) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_10SequenceInvariantdfy.512:19|
 :skolemid |2009|
 :pattern ( (_module.ConstantInteger.localUserInv $Heap@@27 this@@27) ($IsGoodHeap $Heap@@27))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@28 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@28 this@@28) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@28) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.OwnedObject) ($IsAlloc refType this@@28 Tclass._module.OwnedObject $Heap@@28)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@28 this@@28) (=> (_module.Object.objectGlobalBaseInv $Heap@@28 this@@28) (|_module.OwnedObject.localUserInv#canCall| $Heap@@28 this@@28))) (= (_module.OwnedObject.localInv $Heap@@28 this@@28)  (and (_module.Object.objectGlobalBaseInv $Heap@@28 this@@28) (_module.OwnedObject.localUserInv $Heap@@28 this@@28)))))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1460|
 :pattern ( (_module.OwnedObject.localInv $Heap@@28 this@@28) ($IsGoodHeap $Heap@@28))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@29 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@29 this@@29) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.OwnedObject) ($IsAlloc refType this@@29 Tclass._module.OwnedObject $Heap@@29)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@29 this@@29) (=> (_module.OwnedObject.localInv $Heap@@29 this@@29) (|_module.OwnedObject.userInv#canCall| $Heap@@29 this@@29))) (= (_module.OwnedObject.inv $Heap@@29 this@@29)  (and (_module.OwnedObject.localInv $Heap@@29 this@@29) (_module.OwnedObject.userInv $Heap@@29 this@@29)))))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1473|
 :pattern ( (_module.OwnedObject.inv $Heap@@29 this@@29) ($IsGoodHeap $Heap@@29))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@30 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@30 this@@30) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@30) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Universe) ($IsAlloc refType this@@30 Tclass._module.Universe $Heap@@30)))))) (and (forall ((|o#0@@1| T@U) ) (!  (=> ($Is refType |o#0@@1| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Universe.content)) ($Box refType |o#0@@1|)) (=> (= (_module.Object.universe |o#0@@1|) this@@30) (=> (or (not (= |o#0@@1| this@@30)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@30 |o#0@@1|) (=> (_module.Object.baseFieldsInv $Heap@@30 |o#0@@1|) (|_module.Object.triggerAxioms#canCall| $Heap@@30 |o#0@@1|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@30 |o#0@@1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@30 |o#0@@1|))
 :pattern ( (_module.Object.universe |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Universe.content)) ($Box refType |o#0@@1|)))
)) (= (_module.Universe.globalBaseInv $Heap@@30 this@@30) (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Universe.content)) ($Box refType |o#0@@2|))) (and (and (and (= (_module.Object.universe |o#0@@2|) this@@30) (or (not (= |o#0@@2| this@@30)) (not true))) (_module.Object.baseFieldsInv $Heap@@30 |o#0@@2|)) (_module.Object.triggerAxioms $Heap@@30 |o#0@@2|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 :pattern ( (_module.Object.triggerAxioms $Heap@@30 |o#0@@2|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@30 |o#0@@2|))
 :pattern ( (_module.Object.universe |o#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Universe.content)) ($Box refType |o#0@@2|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@30 this@@30) ($IsGoodHeap $Heap@@30))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@31 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@31 this@@31) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@31) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Object) ($IsAlloc refType this@@31 Tclass._module.Object $Heap@@31)))))) (_module.Object.triggerAxioms $Heap@@31 this@@31))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1064|
 :pattern ( (_module.Object.triggerAxioms $Heap@@31 this@@31))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@32 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.IncreasingCounter.userInv#canCall| $Heap@@32 this@@32) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@32) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@32 Tclass._module.IncreasingCounter $Heap@@32)))))) (=> (_module.IncreasingCounter.userInv $Heap@@32 this@@32) (_module.IncreasingCounter.localUserInv $Heap@@32 this@@32)))
 :qid |_10SequenceInvariantdfy.427:19|
 :skolemid |1592|
 :pattern ( (_module.IncreasingCounter.userInv $Heap@@32 this@@32))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@33 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.Integer.userInv#canCall| $Heap@@33 this@@33) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@33) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.Integer) ($IsAlloc refType this@@33 Tclass._module.Integer $Heap@@33)))))) (=> (_module.Integer.userInv $Heap@@33 this@@33) (_module.Integer.localUserInv $Heap@@33 this@@33)))
 :qid |_10SequenceInvariantdfy.471:19|
 :skolemid |1803|
 :pattern ( (_module.Integer.userInv $Heap@@33 this@@33))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@34 T@U) ) (!  (=> (or (|_module.ConstantInteger.userInv#canCall| $Heap@@34 this@@34) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.ConstantInteger) ($IsAlloc refType this@@34 Tclass._module.ConstantInteger $Heap@@34)))))) (=> (_module.ConstantInteger.userInv $Heap@@34 this@@34) (_module.ConstantInteger.localUserInv $Heap@@34 this@@34)))
 :qid |_10SequenceInvariantdfy.515:19|
 :skolemid |2014|
 :pattern ( (_module.ConstantInteger.userInv $Heap@@34 this@@34))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@35 T@U) (this@@35 T@U) ) (!  (=> (or (|_module.ClaimIncreasingCounterGreaterThanConstant.userInv#canCall| $Heap@@35 this@@35) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@35) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@35 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@35)))))) (=> (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@35 this@@35) (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@35 this@@35)))
 :qid |_10SequenceInvariantdfy.563:19|
 :skolemid |2227|
 :pattern ( (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@35 this@@35))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@36 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@36 this@@36) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@36) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.OwnedObject) ($IsAlloc refType this@@36 Tclass._module.OwnedObject $Heap@@36)))))) (=> (_module.OwnedObject.userInv $Heap@@36 this@@36) (_module.OwnedObject.localUserInv $Heap@@36 this@@36)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1549|
 :pattern ( (_module.OwnedObject.userInv $Heap@@36 this@@36))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@37 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@37 this@@37) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@37) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.Thread) ($IsAlloc refType this@@37 Tclass._module.Thread $Heap@@37)))))) (=> (_module.Thread.localInv $Heap@@37 this@@37) (_module.Object.objectGlobalBaseInv $Heap@@37 this@@37)))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1203|
 :pattern ( (_module.Thread.localInv $Heap@@37 this@@37))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@38 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@38 this@@38) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@38) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.OwnedObject) ($IsAlloc refType this@@38 Tclass._module.OwnedObject $Heap@@38)))))) (=> (_module.OwnedObject.localInv $Heap@@38 this@@38) (_module.Object.objectGlobalBaseInv $Heap@@38 this@@38)))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1458|
 :pattern ( (_module.OwnedObject.localInv $Heap@@38 this@@38))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@39 T@U) (this@@39 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@39 this@@39) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@39) (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.Object) ($IsAlloc refType this@@39 Tclass._module.Object $Heap@@39)))))) (=> (_module.Object.localInv $Heap@@39 this@@39) (_module.Object.objectGlobalBaseInv $Heap@@39 this@@39)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1116|
 :pattern ( (_module.Object.localInv $Heap@@39 this@@39))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@40 T@U) (this@@40 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@40 this@@40) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@40) (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.Thread) ($IsAlloc refType this@@40 Tclass._module.Thread $Heap@@40)))))) (=> (_module.Thread.inv $Heap@@40 this@@40) (_module.Thread.localInv $Heap@@40 this@@40)))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1215|
 :pattern ( (_module.Thread.inv $Heap@@40 this@@40))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@41 T@U) (this@@41 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@41 this@@41) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@41) (and (or (not (= this@@41 null)) (not true)) (and ($Is refType this@@41 Tclass._module.OwnedObject) ($IsAlloc refType this@@41 Tclass._module.OwnedObject $Heap@@41)))))) (=> (_module.OwnedObject.inv $Heap@@41 this@@41) (_module.OwnedObject.localInv $Heap@@41 this@@41)))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1471|
 :pattern ( (_module.OwnedObject.inv $Heap@@41 this@@41))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@42 T@U) (this@@42 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@42 this@@42) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@42) (and (or (not (= this@@42 null)) (not true)) (and ($Is refType this@@42 Tclass._module.Object) ($IsAlloc refType this@@42 Tclass._module.Object $Heap@@42)))))) (=> (_module.Object.inv $Heap@@42 this@@42) (_module.Object.localInv $Heap@@42 this@@42)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1126|
 :pattern ( (_module.Object.inv $Heap@@42 this@@42))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@43 T@U) (this@@43 T@U) ) (!  (=> (or (|_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv#canCall| $Heap@@43 this@@43) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@43) (and (or (not (= this@@43 null)) (not true)) (and ($Is refType this@@43 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@43 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@43)))))) (= (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@43 this@@43)  (and true (>= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@43 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@43 this@@43) _module.ClaimIncreasingCounterGreaterThanConstant.counter))) _module.IncreasingCounter.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@43 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@43 this@@43) _module.ClaimIncreasingCounterGreaterThanConstant.constant))) _module.ConstantInteger.value)))))))
 :qid |_10SequenceInvariantdfy.560:19|
 :skolemid |2222|
 :pattern ( (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@43 this@@43) ($IsGoodHeap $Heap@@43))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@44 T@U) (this@@44 T@U) ) (!  (=> (or (|_module.IncreasingCounter.userInv#canCall| $Heap@@44 this@@44) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@44) (and (or (not (= this@@44 null)) (not true)) (and ($Is refType this@@44 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@44 Tclass._module.IncreasingCounter $Heap@@44)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.IncreasingCounter.localUserInv#canCall| $Heap@@44 this@@44)) (= (_module.IncreasingCounter.userInv $Heap@@44 this@@44)  (and true (_module.IncreasingCounter.localUserInv $Heap@@44 this@@44)))))
 :qid |_10SequenceInvariantdfy.427:19|
 :skolemid |1594|
 :pattern ( (_module.IncreasingCounter.userInv $Heap@@44 this@@44) ($IsGoodHeap $Heap@@44))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@45 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.Integer.userInv#canCall| $Heap@@45 this@@45) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@45) (and (or (not (= this@@45 null)) (not true)) (and ($Is refType this@@45 Tclass._module.Integer) ($IsAlloc refType this@@45 Tclass._module.Integer $Heap@@45)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Integer.localUserInv#canCall| $Heap@@45 this@@45)) (= (_module.Integer.userInv $Heap@@45 this@@45)  (and true (_module.Integer.localUserInv $Heap@@45 this@@45)))))
 :qid |_10SequenceInvariantdfy.471:19|
 :skolemid |1805|
 :pattern ( (_module.Integer.userInv $Heap@@45 this@@45) ($IsGoodHeap $Heap@@45))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@46 T@U) (this@@46 T@U) ) (!  (=> (or (|_module.ConstantInteger.userInv#canCall| $Heap@@46 this@@46) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@46) (and (or (not (= this@@46 null)) (not true)) (and ($Is refType this@@46 Tclass._module.ConstantInteger) ($IsAlloc refType this@@46 Tclass._module.ConstantInteger $Heap@@46)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.ConstantInteger.localUserInv#canCall| $Heap@@46 this@@46)) (= (_module.ConstantInteger.userInv $Heap@@46 this@@46)  (and true (_module.ConstantInteger.localUserInv $Heap@@46 this@@46)))))
 :qid |_10SequenceInvariantdfy.515:19|
 :skolemid |2016|
 :pattern ( (_module.ConstantInteger.userInv $Heap@@46 this@@46) ($IsGoodHeap $Heap@@46))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@47 T@U) (this@@47 T@U) ) (!  (=> (or (|_module.ClaimIncreasingCounterGreaterThanConstant.userInv#canCall| $Heap@@47 this@@47) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@47) (and (or (not (= this@@47 null)) (not true)) (and ($Is refType this@@47 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@47 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@47)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv#canCall| $Heap@@47 this@@47)) (= (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@47 this@@47)  (and true (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@47 this@@47)))))
 :qid |_10SequenceInvariantdfy.563:19|
 :skolemid |2229|
 :pattern ( (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@47 this@@47) ($IsGoodHeap $Heap@@47))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@48 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@48 this@@48) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@48) (and (or (not (= this@@48 null)) (not true)) (and ($Is refType this@@48 Tclass._module.Thread) ($IsAlloc refType this@@48 Tclass._module.Thread $Heap@@48)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@48 this@@48)) (= (_module.Thread.localInv $Heap@@48 this@@48)  (and true (_module.Object.objectGlobalBaseInv $Heap@@48 this@@48)))))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1205|
 :pattern ( (_module.Thread.localInv $Heap@@48 this@@48) ($IsGoodHeap $Heap@@48))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@49 T@U) (this@@49 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@49 this@@49) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@49) (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.Thread) ($IsAlloc refType this@@49 Tclass._module.Thread $Heap@@49)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@49 this@@49)) (= (_module.Thread.inv $Heap@@49 this@@49)  (and true (_module.Thread.localInv $Heap@@49 this@@49)))))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1217|
 :pattern ( (_module.Thread.inv $Heap@@49 this@@49) ($IsGoodHeap $Heap@@49))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@50 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@50 this@@50) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@50) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.Object) ($IsAlloc refType this@@50 Tclass._module.Object $Heap@@50)))))) (= (_module.Object.triggerAxioms $Heap@@50 this@@50)  (and (or ($Is refType this@@50 Tclass._module.OwnedObject) ($Is refType this@@50 Tclass._module.Thread)) (not (and ($Is refType this@@50 Tclass._module.OwnedObject) ($Is refType this@@50 Tclass._module.Thread))))))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1066|
 :pattern ( (_module.Object.triggerAxioms $Heap@@50 this@@50) ($IsGoodHeap $Heap@@50))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@51) ($IsHeapAnchor $Heap@@51)) (=> (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@51)) (and ($Is refType |running#0| Tclass._module.Thread) ($IsAlloc refType |running#0| Tclass._module.Thread $Heap@@51))) (=> (and (and (and (and (and ($Is refType |counter#0| Tclass._module.IncreasingCounter) ($IsAlloc refType |counter#0| Tclass._module.IncreasingCounter $Heap@@51)) (and ($Is refType |remaining#0| Tclass._module.Integer) ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap@@51))) (and (and (=> |defass#initial_value#0_0| (and ($Is refType |initial_value#0_0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value#0_0| Tclass._module.ConstantInteger $Heap@@51))) true) (and (=> |defass#claim1#0_0| (and ($Is refType |claim1#0_0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim1#0_0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@51))) true))) (and (and (and (=> |defass#initial_value_plus_one#0_0| (and ($Is refType |initial_value_plus_one#0_0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value_plus_one#0_0| Tclass._module.ConstantInteger $Heap@@51))) true) (and (=> |defass#claim2#0_0| (and ($Is refType |claim2#0_0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim2#0_0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@51))) true)) (and (and (=> |defass#final_value#0_0| (and ($Is refType |final_value#0_0| Tclass._module.ConstantInteger) ($IsAlloc refType |final_value#0_0| Tclass._module.ConstantInteger $Heap@@51))) true) (= 18 $FunctionContextHeight)))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@51 |universe#0|) (and (_module.Universe.globalInv $Heap@@51 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@51 |universe#0|) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |o#8|))) (_module.Object.inv $Heap@@51 |o#8|))
 :qid |_10SequenceInvariantdfy.22:32|
 :skolemid |506|
 :pattern ( (_module.Object.inv $Heap@@51 |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)))
))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |running#0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |counter#0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |remaining#0|)))) (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |remaining#0|) _module.OwnedObject.owner)) |running#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |remaining#0|) _module.Integer.value))) (LitInt 10))) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@51 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)))) (or (not (= |universe#0| null)) (not true)))) (and (and (forall (($o@@44 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@44 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 $o@@44) alloc)))) (or (= $o@@44 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType $o@@44)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@44 $f@@0)))
 :qid |_10SequenceInvariantdfy.624:24|
 :skolemid |518|
)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalInv#canCall| $Heap@@51 |universe#0|))))) (or (_module.Universe.globalInv $Heap@@51 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@51 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@51 |universe#0|) (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@3|))) (and (and (and (= (_module.Object.universe |o#0@@3|) |universe#0|) (or (not (= |o#0@@3| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@51 |o#0@@3|)) (_module.Object.triggerAxioms $Heap@@51 |o#0@@3|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |849|
 :pattern ( (_module.Object.triggerAxioms $Heap@@51 |o#0@@3|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@51 |o#0@@3|))
 :pattern ( (_module.Object.universe |o#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@3|)))
))))))))))
anon0_correct))
))
(check-sat)
