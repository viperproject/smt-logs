...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@33 T@U) ($f@@25 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#69| |l#0| |l#1| |l#2| |l#3|) $o@@33 $f@@25))  (=> (and (or (not (= $o@@33 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@33) |l#2|)))) (= $o@@33 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2459|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#69| |l#0| |l#1| |l#2| |l#3|) $o@@33 $f@@25))
)))
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@26 T@U) (this@@43 T@U) ) (!  (=> (or (|_module.Object.objectGlobalInv#canCall| $Heap@@26 this@@43) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@26) (and (or (not (= this@@43 null)) (not true)) (and ($Is refType this@@43 Tclass._module.Object) ($IsAlloc refType this@@43 Tclass._module.Object $Heap@@26)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@43)) _module.Universe.content)) ($Box refType this@@43)) (|_module.Universe.globalInv#canCall| $Heap@@26 (_module.Object.universe this@@43))) (= (_module.Object.objectGlobalInv $Heap@@26 this@@43)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@43)) _module.Universe.content)) ($Box refType this@@43)) (_module.Universe.globalInv $Heap@@26 (_module.Object.universe this@@43))))))
 :qid |_11MutexGuard2legacydfy.205:19|
 :skolemid |1078|
 :pattern ( (_module.Object.objectGlobalInv $Heap@@26 this@@43) ($IsGoodHeap $Heap@@26))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@30 T@U) ($Heap@@27 T@U) (this@@44 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@30 $Heap@@27 this@@44) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@30) ($IsGoodHeap $Heap@@27)) ($HeapSucc $prevHeap@@30 $Heap@@27)) (and (or (not (= this@@44 null)) (not true)) (and ($Is refType this@@44 Tclass._module.Thread) ($IsAlloc refType this@@44 Tclass._module.Thread $prevHeap@@30)))))) (= (_module.Thread.localInv2 $prevHeap@@30 $Heap@@27 this@@44) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.272:22|
 :skolemid |1254|
 :pattern ( (_module.Thread.localInv2 $prevHeap@@30 $Heap@@27 this@@44) ($IsGoodHeap $Heap@@27))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@31 T@U) ($Heap@@28 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@31 $Heap@@28 this@@45) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@31) ($IsGoodHeap $Heap@@28)) ($HeapSucc $prevHeap@@31 $Heap@@28)) (and (or (not (= this@@45 null)) (not true)) (and ($Is refType this@@45 Tclass._module.Thread) ($IsAlloc refType this@@45 Tclass._module.Thread $prevHeap@@31)))))) (= (_module.Thread.sequenceInv2 $prevHeap@@31 $Heap@@28 this@@45) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.275:22|
 :skolemid |1261|
 :pattern ( (_module.Thread.sequenceInv2 $prevHeap@@31 $Heap@@28 this@@45) ($IsGoodHeap $Heap@@28))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@32 T@U) ($Heap@@29 T@U) (this@@46 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@32 $Heap@@29 this@@46) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@32) ($IsGoodHeap $Heap@@29)) ($HeapSucc $prevHeap@@32 $Heap@@29)) (and (or (not (= this@@46 null)) (not true)) (and ($Is refType this@@46 Tclass._module.OwnedObject) ($IsAlloc refType this@@46 Tclass._module.OwnedObject $prevHeap@@32)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.localUserInv2#canCall| $prevHeap@@32 $Heap@@29 this@@46)) (= (_module.OwnedObject.localInv2 $prevHeap@@32 $Heap@@29 this@@46)  (and true (_module.OwnedObject.localUserInv2 $prevHeap@@32 $Heap@@29 this@@46)))))
 :qid |_11MutexGuard2legacydfy.345:22|
 :skolemid |1556|
 :pattern ( (_module.OwnedObject.localInv2 $prevHeap@@32 $Heap@@29 this@@46) ($IsGoodHeap $Heap@@29))
))))
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@47 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@47 null)) (not true)) ($Is refType this@@47 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@36 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@36 null)) (not true)) (or (= $o@@36 this@@47) (= $o@@36 (_module.Object.universe this@@47)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@36) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@36) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |1133|
...
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@48 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@48 null)) (not true)) ($Is refType this@@48 Tclass._module.Thread))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@37 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@37 null)) (not true)) (or (= $o@@37 this@@48) (= $o@@37 (_module.Object.universe this@@48)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@37) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@37) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |1212|
...
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@50 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@50 null)) (not true)) ($Is refType this@@50 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@39 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@39 null)) (not true)) (or (= $o@@39 this@@50) (= $o@@39 (_module.Object.universe this@@50)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@39) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@39) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |1602|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@33 T@U) ($Heap@@30 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@33 $Heap@@30 this@@51) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@33) ($IsGoodHeap $Heap@@30)) ($HeapSucc $prevHeap@@33 $Heap@@30)) (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.OwnedObject) ($IsAlloc refType this@@51 Tclass._module.OwnedObject $prevHeap@@33)))))) (and (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@51) _module.OwnedObject.nonvolatileVersion)))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@51) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@33 $Heap@@30 this@@51))) (=> (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@51) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@33 $Heap@@30 this@@51))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.owner))))
(|_module.OwnedObject.volatileOwns#canCall| |oldOwner#0|)))))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@33 $Heap@@30 this@@51)  (and (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@51) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@51) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@33 $Heap@@30 this@@51)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#0@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@33 this@@51) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@51) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_11MutexGuard2legacydfy.349:22|
 :skolemid |1564|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@33 $Heap@@30 this@@51) ($IsGoodHeap $Heap@@30))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@34 T@U) ($Heap@@39 T@U) (this@@60 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@34 $Heap@@39 this@@60) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@34) ($IsGoodHeap $Heap@@39)) ($HeapSucc $prevHeap@@34 $Heap@@39)) (and (or (not (= this@@60 null)) (not true)) (and ($Is refType this@@60 Tclass._module.OwnedObject) ($IsAlloc refType this@@60 Tclass._module.OwnedObject $prevHeap@@34)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@34 this@@60) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@60) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@34 $Heap@@39 this@@60)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@34 $Heap@@39 this@@60)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@34 this@@60) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@60) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@34 $Heap@@39 this@@60)))))
 :qid |_11MutexGuard2legacydfy.331:22|
 :skolemid |1524|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@34 $Heap@@39 this@@60) ($IsGoodHeap $Heap@@39))
))))
...
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@61 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@61 null)) (not true)) ($Is refType this@@61 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@41 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@41 null)) (not true)) (= $o@@41 this@@61)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@41) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@41) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |1087|
...
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@62 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@62 null)) (not true)) ($Is refType this@@62 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@42 T@U) ($f@@31 T@U) ) (!  (=> (and (or (not (= $o@@42 null)) (not true)) (or (= $o@@42 this@@62) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 this@@62) _module.Universe.content)) ($Box refType $o@@42)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@42) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@42) $f@@31)))
 :qid |unknown.0:0|
 :skolemid |625|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 42) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#69| null $Heap@@45 alloc |universe#0|)) (and (=> (= (ControlFlow 0 2) (- 0 41)) true) (=> (and (and (and (or (not (= this@@79 null)) (not true)) ($Is refType this@@79 Tclass._module.Thread?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 this@@79) alloc))))) (and (and (= (_module.Object.universe this@@79) |universe#0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@45 this@@79 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 this@@79) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 40)) (forall (($o@@63 T@U) ($f@@43 T@U) ) (!  (=> (and (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@63) alloc)))) (= $o@@63 (_module.Object.universe this@@79))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@63 $f@@43)))
 :qid |_11MutexGuard2legacydfy.306:9|
 :skolemid |1487|
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| call0formal@previous$Heap@0 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence call0formal@previous$Heap@0 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))) (or (forall (($o@@67 T@U) ($f@@46 T@U) ) (!  (=> (or (not (= $o@@67 null)) (not true)) (=> (= $o@@67 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@67) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@67) $f@@46))))
 :qid |_11MutexGuard2legacydfy.57:65|
 :skolemid |794|
...
)))) (= $Heap@1 $Heap@2))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@79) (or (_module.Object.objectGlobalInv $Heap@2 this@@79) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType this@@79))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@79) (or (_module.Object.objectGlobalInv $Heap@2 this@@79) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType this@@79)))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@79) (or (_module.Object.objectGlobalInv $Heap@2 this@@79) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@79)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@79)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@79) (or (_module.Object.objectGlobalInv $Heap@2 this@@79) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@79)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@79)) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@79) (or (_module.Object.objectGlobalInv $Heap@2 this@@79) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@79)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@79)) (forall ((|o#15| T@U) ) (!  (=> (and ($Is refType |o#15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType |o#15|))) (and (and (and (= (_module.Object.universe |o#15|) (_module.Object.universe this@@79)) (or (not (= |o#15| (_module.Object.universe this@@79))) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#15|)) (_module.Object.triggerAxioms $Heap@2 |o#15|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1458|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType |o#15|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@79) (or (_module.Object.objectGlobalInv $Heap@2 this@@79) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@79)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@79)) (forall ((|o#15@@0| T@U) ) (!  (=> (and ($Is refType |o#15@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType |o#15@@0|))) (and (and (and (= (_module.Object.universe |o#15@@0|) (_module.Object.universe this@@79)) (or (not (= |o#15@@0| (_module.Object.universe this@@79))) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#15@@0|)) (_module.Object.triggerAxioms $Heap@2 |o#15@@0|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1458|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType |o#15@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@79) (or (_module.Object.objectGlobalInv $Heap@2 this@@79) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@79)) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType |o#16|))) (_module.Object.inv $Heap@2 |o#16|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |1460|
 :pattern ( (_module.Object.inv $Heap@2 |o#16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType |o#16|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@2 this@@79) (or (_module.Object.objectGlobalInv $Heap@2 this@@79) (=> (|_module.Universe.globalInv#canCall| $Heap@2 (_module.Object.universe this@@79)) (or (_module.Universe.globalInv $Heap@2 (_module.Object.universe this@@79)) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType |o#16@@0|))) (_module.Object.inv $Heap@2 |o#16@@0|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |1460|
 :pattern ( (_module.Object.inv $Heap@2 |o#16@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@79)) _module.Universe.content)) ($Box refType |o#16@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (forall ((|o#17| T@U) ) (!  (=> (and ($Is refType |o#17| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#17|))) (and (and (and (= (_module.Object.universe |o#17|) |universe#0|) (or (not (= |o#17| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@45 |o#17|)) (_module.Object.triggerAxioms $Heap@@45 |o#17|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1462|
 :pattern ( (_module.Object.triggerAxioms $Heap@@45 |o#17|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@45 |o#17|))
 :pattern ( (_module.Object.universe |o#17|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)))
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (forall ((|o#17@@0| T@U) ) (!  (=> (and ($Is refType |o#17@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|))) (and (and (and (= (_module.Object.universe |o#17@@0|) |universe#0|) (or (not (= |o#17@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@45 |o#17@@0|)) (_module.Object.triggerAxioms $Heap@@45 |o#17@@0|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1462|
 :pattern ( (_module.Object.triggerAxioms $Heap@@45 |o#17@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@45 |o#17@@0|))
 :pattern ( (_module.Object.universe |o#17@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (forall ((|o#18| T@U) ) (!  (=> (and ($Is refType |o#18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#18|))) (and (and (and (= (_module.Object.universe |o#18|) |universe#0|) (or (not (= |o#18| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#18|)) (_module.Object.triggerAxioms $Heap@2 |o#18|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1464|
...
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (forall ((|o#19| T@U) ) (!  (=> (and ($Is refType |o#19| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#19|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#19|)))) (not ($IsAllocBox ($Box refType |o#19|) Tclass._module.Object $Heap@@45)))
 :qid |_11MutexGuard2legacydfy.45:16|
 :skolemid |1466|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#19|)))
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@45 $Heap@2 |universe#0|) (forall ((|o#19@@0| T@U) ) (!  (=> (and ($Is refType |o#19@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|)))) (not ($IsAllocBox ($Box refType |o#19@@0|) Tclass._module.Object $Heap@@45)))
 :qid |_11MutexGuard2legacydfy.45:16|
 :skolemid |1466|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#20| T@U) ) (!  (=> (and ($Is refType |o#20| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#20|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#20|)))) (or (forall (($o@@72 T@U) ($f@@51 T@U) ) (!  (=> (or (not (= $o@@72 null)) (not true)) (=> (= $o@@72 |o#20|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@72) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 $o@@72) $f@@51))))
 :qid |_11MutexGuard2legacydfy.57:65|
 :skolemid |1468|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@72) $f@@51))
)) (_module.Object.sequenceInv2 $Heap@@45 $Heap@2 |o#20|)))
 :qid |_11MutexGuard2legacydfy.57:16|
 :skolemid |1469|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@45 $Heap@2 |o#20|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#20|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#20@@0| T@U) ) (!  (=> (and ($Is refType |o#20@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#20@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#20@@0|)))) (or (forall (($o@@73 T@U) ($f@@52 T@U) ) (!  (=> (or (not (= $o@@73 null)) (not true)) (=> (= $o@@73 |o#20@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@73) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 $o@@73) $f@@52))))
 :qid |_11MutexGuard2legacydfy.57:65|
 :skolemid |1468|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@73) $f@@52))
)) (_module.Object.sequenceInv2 $Heap@@45 $Heap@2 |o#20@@0|)))
 :qid |_11MutexGuard2legacydfy.57:16|
 :skolemid |1469|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@45 $Heap@2 |o#20@@0|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#20@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#21| T@U) ) (!  (=> (and ($Is refType |o#21| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#21|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@45)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |o#21|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_11MutexGuard2legacydfy.60:16|
 :skolemid |1470|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#21|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@45 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#21@@0| T@U) ) (!  (=> (and ($Is refType |o#21@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#21@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21@@0|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@45)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |o#21@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_11MutexGuard2legacydfy.60:16|
 :skolemid |1470|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |o#21@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#21@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalInv $Heap@@45 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalInv $Heap@@45 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalInv $Heap@@45 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (forall ((|o#22| T@U) ) (!  (=> (and ($Is refType |o#22| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#22|))) (and (and (and (= (_module.Object.universe |o#22|) |universe#0|) (or (not (= |o#22| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@45 |o#22|)) (_module.Object.triggerAxioms $Heap@@45 |o#22|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1474|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#22|)))
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalInv $Heap@@45 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (forall ((|o#22@@0| T@U) ) (!  (=> (and ($Is refType |o#22@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#22@@0|))) (and (and (and (= (_module.Object.universe |o#22@@0|) |universe#0|) (or (not (= |o#22@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@45 |o#22@@0|)) (_module.Object.triggerAxioms $Heap@@45 |o#22@@0|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |1474|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#22@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalInv $Heap@@45 |universe#0|) (forall ((|o#23| T@U) ) (!  (=> (and ($Is refType |o#23| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#23|))) (_module.Object.inv $Heap@@45 |o#23|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |1476|
 :pattern ( (_module.Object.inv $Heap@@45 |o#23|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#23|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@45 |universe#0|) (or (_module.Universe.globalInv $Heap@@45 |universe#0|) (forall ((|o#23@@0| T@U) ) (!  (=> (and ($Is refType |o#23@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#23@@0|))) (_module.Object.inv $Heap@@45 |o#23@@0|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |1476|
 :pattern ( (_module.Object.inv $Heap@@45 |o#23@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#23@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (forall ((|o#24| T@U) ) (!  (=> (and ($Is refType |o#24| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#24|))) (and (or (forall (($o@@74 T@U) ($f@@53 T@U) ) (!  (=> (or (not (= $o@@74 null)) (not true)) (=> (= $o@@74 |o#24|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@74) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 $o@@74) $f@@53))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |1478|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@74) $f@@53))
)) (_module.Object.inv $Heap@2 |o#24|)) (or (forall (($o@@75 T@U) ($f@@54 T@U) ) (!  (=> (or (not (= $o@@75 null)) (not true)) (=> (= $o@@75 |o#24|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@75) $f@@54) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 $o@@75) $f@@54))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |1479|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@75) $f@@54))
)) (_module.Object.inv2 $Heap@@45 $Heap@2 |o#24|))))
 :qid |_11MutexGuard2legacydfy.77:16|
 :skolemid |1480|
 :pattern ( (_module.Object.inv2 $Heap@@45 $Heap@2 |o#24|))
 :pattern ( (_module.Object.inv $Heap@2 |o#24|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#24|)))
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (forall ((|o#24@@0| T@U) ) (!  (=> (and ($Is refType |o#24@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#24@@0|))) (and (or (forall (($o@@76 T@U) ($f@@55 T@U) ) (!  (=> (or (not (= $o@@76 null)) (not true)) (=> (= $o@@76 |o#24@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@76) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 $o@@76) $f@@55))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |1478|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@76) $f@@55))
)) (_module.Object.inv $Heap@2 |o#24@@0|)) (or (forall (($o@@77 T@U) ($f@@56 T@U) ) (!  (=> (or (not (= $o@@77 null)) (not true)) (=> (= $o@@77 |o#24@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@77) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 $o@@77) $f@@56))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |1479|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@77) $f@@56))
)) (_module.Object.inv2 $Heap@@45 $Heap@2 |o#24@@0|))))
 :qid |_11MutexGuard2legacydfy.77:16|
 :skolemid |1480|
 :pattern ( (_module.Object.inv2 $Heap@@45 $Heap@2 |o#24@@0|))
 :pattern ( (_module.Object.inv $Heap@2 |o#24@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#24@@0|)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@45 $Heap@2 |universe#0| |running#0@@3|) (forall ((|o#25| T@U) ) (!  (=> (and ($Is refType |o#25| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#25|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#25|))))) (_module.Object.inv $Heap@2 |o#25|))
 :qid |_11MutexGuard2legacydfy.79:16|
 :skolemid |1481|
 :pattern ( (_module.Object.inv $Heap@2 |o#25|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#25|)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@45) ($IsHeapAnchor $Heap@@45)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@45))) (=> (and (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@45)) (= 19 $FunctionContextHeight)) (and (and (|_module.Universe.globalInv#canCall| $Heap@@45 |universe#0|) (and (_module.Universe.globalInv $Heap@@45 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@45 |universe#0|) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#14|))) (_module.Object.inv $Heap@@45 |o#14|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |1457|
 :pattern ( (_module.Object.inv $Heap@@45 |o#14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |o#14|)))
))))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@45 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)) (= (ControlFlow 0 42) 2)))) anon0_correct))))
