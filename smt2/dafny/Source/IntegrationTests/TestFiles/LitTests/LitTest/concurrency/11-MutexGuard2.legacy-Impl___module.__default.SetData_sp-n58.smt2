...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split42)
...
(assert (not
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@2|)))
)))))))) (and (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (|_module.Universe.globalInv#canCall| $Heap@2 |universe#0|) (=> (_module.Universe.globalInv $Heap@2 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@2 $Heap@2 |universe#0|)))) (and (and (|_module.Universe.globalInv#canCall| $Heap@2 |universe#0|) (and (_module.Universe.globalInv $Heap@2 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@2 |o#10|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |815|
