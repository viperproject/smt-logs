...
(declare-fun |lambda#250| (T@U T@U T@U T@U T@U T@U T@U T@U) T@U)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.OutlivesClaim.objectUserFields#canCall| $Heap@@1 this@@2) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@2 Tclass._module.OutlivesClaim $Heap@@1)))))) (= (_module.OutlivesClaim.objectUserFields $Heap@@1 this@@2) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OutlivesClaim.source this@@2))) ($Box refType (_module.OutlivesClaim.target this@@2)))))
 :qid |_12MutexLifetimelongdfy.688:18|
 :skolemid |2978|
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@6 T@U) ($Heap@@6 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Lifetime.unchangedNonvolatileFields#canCall| $prevHeap@@6 $Heap@@6 this@@12) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@6) ($IsGoodHeap $Heap@@6)) ($HeapSucc $prevHeap@@6 $Heap@@6)) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Lifetime) ($IsAlloc refType this@@12 Tclass._module.Lifetime $prevHeap@@6)))))) (= (_module.Lifetime.unchangedNonvolatileFields $prevHeap@@6 $Heap@@6 this@@12)  (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@6 this@@12) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@12) _module.Lifetime.owner))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@6 this@@12) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@12) _module.Lifetime.elements)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@6 this@@12) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@12) _module.Lifetime.mightPointTo)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@6 this@@12) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@12) _module.Lifetime.mightPointFrom))))))
 :qid |_12MutexLifetimelongdfy.572:22|
 :skolemid |2315|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $prevHeap@@6 $Heap@@6 this@@12) ($IsGoodHeap $Heap@@6))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@7 this@@13) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@13 null)) (not true)) ($Is refType this@@13 Tclass._module.Thread)))) (= (_module.Object.baseFieldsInv $Heap@@7 this@@13) (_module.Thread.baseFieldsInv $Heap@@7 this@@13)))
 :qid |_12MutexLifetimelongdfy.349:19|
 :skolemid |1862|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 this@@13) ($Is refType this@@13 Tclass._module.Thread) ($IsGoodHeap $Heap@@7))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 this@@13) (_module.Thread.baseFieldsInv $Heap@@7 this@@13) ($IsGoodHeap $Heap@@7))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@8 this@@14) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.Lifetime)))) (= (_module.Object.baseFieldsInv $Heap@@8 this@@14) (_module.Lifetime.baseFieldsInv $Heap@@8 this@@14)))
 :qid |_12MutexLifetimelongdfy.349:19|
 :skolemid |2302|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@8 this@@14) ($Is refType this@@14 Tclass._module.Lifetime) ($IsGoodHeap $Heap@@8))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@8 this@@14) (_module.Lifetime.baseFieldsInv $Heap@@8 this@@14) ($IsGoodHeap $Heap@@8))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@9 this@@15) (and (< 5 $FunctionContextHeight) (and (or (not (= this@@15 null)) (not true)) ($Is refType this@@15 Tclass._module.OwnedObject)))) (= (_module.Object.baseFieldsInv $Heap@@9 this@@15) (_module.OwnedObject.baseFieldsInv $Heap@@9 this@@15)))
 :qid |_12MutexLifetimelongdfy.349:19|
 :skolemid |2133|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@9 this@@15) ($Is refType this@@15 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@9 this@@15) (_module.OwnedObject.baseFieldsInv $Heap@@9 this@@15) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@10 this@@16) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@16 null)) (not true)) ($Is refType this@@16 Tclass._module.Thread)))) (= (_module.Object.localInv $Heap@@10 this@@16) (_module.Thread.localInv $Heap@@10 this@@16)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |1876|
 :pattern ( (_module.Object.localInv $Heap@@10 this@@16) ($Is refType this@@16 Tclass._module.Thread) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.Object.localInv $Heap@@10 this@@16) (_module.Thread.localInv $Heap@@10 this@@16) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@11 this@@17) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@17 null)) (not true)) ($Is refType this@@17 Tclass._module.Lifetime)))) (= (_module.Object.localInv $Heap@@11 this@@17) (_module.Lifetime.localInv $Heap@@11 this@@17)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |2335|
 :pattern ( (_module.Object.localInv $Heap@@11 this@@17) ($Is refType this@@17 Tclass._module.Lifetime) ($IsGoodHeap $Heap@@11))
 :pattern ( (_module.Object.localInv $Heap@@11 this@@17) (_module.Lifetime.localInv $Heap@@11 this@@17) ($IsGoodHeap $Heap@@11))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.OutlivesClaim.localUserInv#canCall| $Heap@@12 this@@18) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@18 null)) (not true)) ($Is refType this@@18 Tclass._module.OutlivesClaim)))) (= (_module.OwnedObject.localUserInv $Heap@@12 this@@18) (_module.OutlivesClaim.localUserInv $Heap@@12 this@@18)))
 :qid |_12MutexLifetimelongdfy.521:19|
 :skolemid |2993|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@12 this@@18) ($Is refType this@@18 Tclass._module.OutlivesClaim) ($IsGoodHeap $Heap@@12))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@12 this@@18) (_module.OutlivesClaim.localUserInv $Heap@@12 this@@18) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@13 this@@19) (and (< 10 $FunctionContextHeight) (and (or (not (= this@@19 null)) (not true)) ($Is refType this@@19 Tclass._module.Thread)))) (= (_module.Object.inv $Heap@@13 this@@19) (_module.Thread.inv $Heap@@13 this@@19)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |1886|
 :pattern ( (_module.Object.inv $Heap@@13 this@@19) ($Is refType this@@19 Tclass._module.Thread) ($IsGoodHeap $Heap@@13))
 :pattern ( (_module.Object.inv $Heap@@13 this@@19) (_module.Thread.inv $Heap@@13 this@@19) ($IsGoodHeap $Heap@@13))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@14 this@@20) (and (< 10 $FunctionContextHeight) (and (or (not (= this@@20 null)) (not true)) ($Is refType this@@20 Tclass._module.Lifetime)))) (= (_module.Object.inv $Heap@@14 this@@20) (_module.Lifetime.inv $Heap@@14 this@@20)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |2388|
 :pattern ( (_module.Object.inv $Heap@@14 this@@20) ($Is refType this@@20 Tclass._module.Lifetime) ($IsGoodHeap $Heap@@14))
 :pattern ( (_module.Object.inv $Heap@@14 this@@20) (_module.Lifetime.inv $Heap@@14 this@@20) ($IsGoodHeap $Heap@@14))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv#canCall| $Heap@@15 this@@21) (and (< 10 $FunctionContextHeight) (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.OutlivesClaim)))) (= (_module.OwnedObject.userInv $Heap@@15 this@@21) (_module.OutlivesClaim.userInv $Heap@@15 this@@21)))
 :qid |_12MutexLifetimelongdfy.523:19|
 :skolemid |3002|
 :pattern ( (_module.OwnedObject.userInv $Heap@@15 this@@21) ($Is refType this@@21 Tclass._module.OutlivesClaim) ($IsGoodHeap $Heap@@15))
 :pattern ( (_module.OwnedObject.userInv $Heap@@15 this@@21) (_module.OutlivesClaim.userInv $Heap@@15 this@@21) ($IsGoodHeap $Heap@@15))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@16 this@@22) (and (< 11 $FunctionContextHeight) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.OwnedObject)))) (= (_module.Object.localInv $Heap@@16 this@@22) (_module.OwnedObject.localInv $Heap@@16 this@@22)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |2154|
...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@17 this@@23) (and (< 14 $FunctionContextHeight) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@17 this@@23) (_module.OwnedObject.inv $Heap@@17 this@@23)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |2166|
 :pattern ( (_module.Object.inv $Heap@@17 this@@23) ($Is refType this@@23 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@17))
 :pattern ( (_module.Object.inv $Heap@@17 this@@23) (_module.OwnedObject.inv $Heap@@17 this@@23) ($IsGoodHeap $Heap@@17))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@18 T@U) (this@@24 T@U) (|a#0@@2| T@U) (|b#0@@2| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.Universe))) ($Is refType |a#0@@2| Tclass._module.Lifetime)) ($Is refType |b#0@@2| Tclass._module.Lifetime)) (_module.Universe.outlives ($LS $ly@@2) $Heap@@18 this@@24 |a#0@@2| |b#0@@2|)) (exists ((|_k#0@@0| Int) ) (!  (and (<= (LitInt 0) |_k#0@@0|) (_module.Universe.outlives_h ($LS $ly@@2) $Heap@@18 this@@24 |_k#0@@0| |a#0@@2| |b#0@@2|))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1577|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@2) $Heap@@18 this@@24 |_k#0@@0| |a#0@@2| |b#0@@2|))
)))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1578|
 :pattern ( (_module.Universe.outlives ($LS $ly@@2) $Heap@@18 this@@24 |a#0@@2| |b#0@@2|))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@25 T@U) ) (!  (=> (or (|_module.OutlivesClaim.localUserInv#canCall| $Heap@@19 this@@25) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@25 Tclass._module.OutlivesClaim $Heap@@19)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@25) (=> (_module.Object.objectGlobalBaseInv $Heap@@19 this@@25) (|_module.Universe.outlives#canCall| $Heap@@19 (_module.Object.universe this@@25) (_module.OutlivesClaim.target this@@25) (_module.OutlivesClaim.source this@@25)))) (= (_module.OutlivesClaim.localUserInv $Heap@@19 this@@25)  (and (_module.Object.objectGlobalBaseInv $Heap@@19 this@@25) (_module.Universe.outlives ($LS $LZ) $Heap@@19 (_module.Object.universe this@@25) (_module.OutlivesClaim.target this@@25) (_module.OutlivesClaim.source this@@25))))))
 :qid |_12MutexLifetimelongdfy.694:19|
 :skolemid |2992|
 :pattern ( (_module.OutlivesClaim.localUserInv $Heap@@19 this@@25) ($IsGoodHeap $Heap@@19))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) ($Heap@@20 T@U) (this@@26 T@U) (|a#0@@3| T@U) (|b#0@@3| T@U) ) (!  (=> (or (|_module.Universe.outlives#canCall| $Heap@@20 this@@26 |a#0@@3| |b#0@@3|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.Universe) ($IsAlloc refType this@@26 Tclass._module.Universe $Heap@@20)))) ($Is refType |a#0@@3| Tclass._module.Lifetime)) ($Is refType |b#0@@3| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@26) _module.Universe.content)) ($Box refType |a#0@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@26) _module.Universe.content)) ($Box refType |b#0@@3|)))))) (and (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 |b#0@@3|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@3|))) (forall ((|x#0@@1| T@U) ) (!  (=> ($Is refType |x#0@@1| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@26) _module.Universe.content)) ($Box refType |x#0@@1|)) (|_module.Universe.outlivesThrough#canCall| $Heap@@20 this@@26 |a#0@@3| |x#0@@1| |b#0@@3|)))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |1575|
 :pattern ( (_module.Universe.outlivesThrough $ly@@3 $Heap@@20 this@@26 |a#0@@3| |x#0@@1| |b#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@26) _module.Universe.content)) ($Box refType |x#0@@1|)))
))) (= (_module.Universe.outlives ($LS $ly@@3) $Heap@@20 this@@26 |a#0@@3| |b#0@@3|)  (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 |b#0@@3|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@3|)) (exists ((|x#0@@2| T@U) ) (!  (and (and ($Is refType |x#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@26) _module.Universe.content)) ($Box refType |x#0@@2|))) (_module.Universe.outlivesThrough $ly@@3 $Heap@@20 this@@26 |a#0@@3| |x#0@@2| |b#0@@3|))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |1574|
 :pattern ( (_module.Universe.outlivesThrough $ly@@3 $Heap@@20 this@@26 |a#0@@3| |x#0@@2| |b#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@26) _module.Universe.content)) ($Box refType |x#0@@2|)))
))))))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1576|
 :pattern ( (_module.Universe.outlives ($LS $ly@@3) $Heap@@20 this@@26 |a#0@@3| |b#0@@3|) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@4 T@U) ($Heap@@21 T@U) (this@@27 T@U) (|_k#0@@1| Int) (|a#0@@4| T@U) (|x#0@@3| T@U) (|b#0@@4| T@U) ) (!  (=> (or (|_module.Universe.outlivesThrough_h#canCall| $Heap@@21 this@@27 |_k#0@@1| |a#0@@4| |x#0@@3| |b#0@@4|) (and (< 2 $FunctionContextHeight) (and (and (and (and (and (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Universe) ($IsAlloc refType this@@27 Tclass._module.Universe $Heap@@21)))) (<= (LitInt 0) |_k#0@@1|)) ($Is refType |a#0@@4| Tclass._module.Lifetime)) ($Is refType |x#0@@3| Tclass._module.Lifetime)) ($Is refType |b#0@@4| Tclass._module.Lifetime)) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@27) _module.Universe.content)) ($Box refType |a#0@@4|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@27) _module.Universe.content)) ($Box refType |x#0@@3|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@27) _module.Universe.content)) ($Box refType |b#0@@4|)))))) (and (=> (< 0 |_k#0@@1|) (=> (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |a#0@@4|) _module.Lifetime.mightPointFrom)) ($Box refType |x#0@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |b#0@@4|) _module.Lifetime.mightPointTo)) ($Box refType |x#0@@3|))) (and (|_module.Universe.outlives_h#canCall| $Heap@@21 this@@27 (- |_k#0@@1| 1) |a#0@@4| |x#0@@3|) (=> (_module.Universe.outlives_h ($LS $LZ) $Heap@@21 this@@27 (- |_k#0@@1| 1) |a#0@@4| |x#0@@3|) (|_module.Universe.outlives_h#canCall| $Heap@@21 this@@27 (- |_k#0@@1| 1) |x#0@@3| |b#0@@4|))))) (= (_module.Universe.outlivesThrough_h ($LS $ly@@4) $Heap@@21 this@@27 |_k#0@@1| |a#0@@4| |x#0@@3| |b#0@@4|)  (and (< 0 |_k#0@@1|) (and (and (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |a#0@@4|) _module.Lifetime.mightPointFrom)) ($Box refType |x#0@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |b#0@@4|) _module.Lifetime.mightPointTo)) ($Box refType |x#0@@3|))) (_module.Universe.outlives_h ($LS $LZ) $Heap@@21 this@@27 (- |_k#0@@1| 1) |a#0@@4| |x#0@@3|)) (_module.Universe.outlives_h ($LS $LZ) $Heap@@21 this@@27 (- |_k#0@@1| 1) |x#0@@3| |b#0@@4|))))))
 :qid |_12MutexLifetimelongdfy.166:19|
 :skolemid |1613|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $ly@@4) $Heap@@21 this@@27 |_k#0@@1| |a#0@@4| |x#0@@3| |b#0@@4|) ($IsGoodHeap $Heap@@21))
))))
(assert (forall (($prevHeap@@7 T@U) ($h0@@5 T@U) ($h1@@5 T@U) (this@@28 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Universe) ($IsAlloc refType this@@28 Tclass._module.Universe $h0@@5)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@13 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@13) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@13) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@13) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |1209|
)) (= (_module.Universe.globalInv2 $prevHeap@@7 $h0@@5 this@@28) (_module.Universe.globalInv2 $prevHeap@@7 $h1@@5 this@@28))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1210|
 :pattern ( ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5) (_module.Universe.globalInv2 $prevHeap@@7 $h1@@5 this@@28))
)))
...
(assert  (=> (<= 17 $FunctionContextHeight) (forall (($prevHeap@@25 T@U) ($Heap@@25 T@U) (this@@49 T@U) (|running#0@@1| T@U) ) (!  (=> (or (|_module.Universe.legalTransition#canCall| $prevHeap@@25 $Heap@@25 this@@49 |running#0@@1|) (and (< 17 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@25) ($IsGoodHeap $Heap@@25)) ($HeapSucc $prevHeap@@25 $Heap@@25)) (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.Universe) ($IsAlloc refType this@@49 Tclass._module.Universe $prevHeap@@25)))) ($Is refType |running#0@@1| Tclass._module.Thread)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@25 $Heap@@25 this@@49 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|))) (=> (_module.Universe.legalTransitionsSequence $prevHeap@@25 $Heap@@25 this@@49 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|))) (and (|_module.Universe.globalInv#canCall| $prevHeap@@25 this@@49) (=> (_module.Universe.globalInv $prevHeap@@25 this@@49) (and (forall ((|o#0@@4| T@U) ) (!  (=> ($Is refType |o#0@@4| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@25 this@@49) _module.Universe.content)) ($Box refType |o#0@@4|)) (and (=> (not (forall (($o@@37 T@U) ($f@@23 T@U) ) (!  (=> (or (not (= $o@@37 null)) (not true)) (=> (= $o@@37 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 $o@@37) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@25 $o@@37) $f@@23))))
 ...
 :skolemid |1290|
 :pattern ( (_module.Universe.legalTransition $prevHeap@@25 $Heap@@25 this@@49 |running#0@@1|) ($IsGoodHeap $Heap@@25))
))))
...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@58 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv#canCall| $Heap@@34 this@@58) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@58 null)) (not true)) (and ($Is refType this@@58 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@58 Tclass._module.OutlivesClaim $Heap@@34)))))) (and (|_module.OutlivesClaim.localUserInv#canCall| $Heap@@34 this@@58) (= (_module.OutlivesClaim.userInv $Heap@@34 this@@58) (_module.OutlivesClaim.localUserInv $Heap@@34 this@@58))))
 :qid |_12MutexLifetimelongdfy.698:19|
 :skolemid |3001|
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($prevHeap@@47 T@U) ($Heap@@57 T@U) (this@@82 T@U) (|running#0@@2| T@U) ) (!  (=> (or (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@47 $Heap@@57 this@@82 |running#0@@2|) (and (< 9 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@47) ($IsGoodHeap $Heap@@57)) ($HeapSucc $prevHeap@@47 $Heap@@57)) (and (or (not (= this@@82 null)) (not true)) (and ($Is refType this@@82 Tclass._module.Universe) ($IsAlloc refType this@@82 Tclass._module.Universe $prevHeap@@47)))) ($Is SetType |running#0@@2| (TSet Tclass._module.Thread))))) (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $prevHeap@@47 $Heap@@57 this@@82) (=> (_module.Universe.baseLegalTransitionsSequence $prevHeap@@47 $Heap@@57 this@@82) (=> (|Set#Subset| |running#0@@2| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 this@@82) _module.Universe.content))) (and (forall ((|o#0@@7| T@U) ) (!  (=> ($Is refType |o#0@@7| Tclass._module.Object) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 this@@82) _module.Universe.content)) ($Box refType |o#0@@7|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@57 this@@82) _module.Universe.content)) ($Box refType |o#0@@7|))) (=> (not (forall (($o@@50 T@U) ($f@@31 T@U) ) (!  (=> (or (not (= $o@@50 null)) (not true)) (=> (= $o@@50 |o#0@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@57 $o@@50) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 $o@@50) $f@@31))))
...
)) (=> (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 this@@82) _module.Universe.content)) ($Box refType |o#1@@1|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 |o#1@@1|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| |running#0@@2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 |o#1@@1|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 |o#1@@1|) _module.OwnedObject.owner) Tclass._module.Object? $prevHeap@@47)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 |o#1@@1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@57 |o#1@@1|) _module.OwnedObject.nonvolatileVersion))))))
...
)) (forall ((|l#0| T@U) ) (!  (=> ($Is refType |l#0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 this@@82) _module.Universe.content)) ($Box refType |l#0|)) (=> (not (|Set#IsMember| |running#0@@2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 |l#0|) _module.Lifetime.owner))) (=> ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 |l#0|) _module.Lifetime.owner) Tclass._module.Thread? $prevHeap@@47) (|_module.Lifetime.unchangedNonvolatileFields#canCall| $prevHeap@@47 $Heap@@57 |l#0|)))))
...
))) (forall ((|l#0@@0| T@U) ) (!  (=> (and ($Is refType |l#0@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 this@@82) _module.Universe.content)) ($Box refType |l#0@@0|))) (=> (and (not (|Set#IsMember| |running#0@@2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 |l#0@@0|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@47 |l#0@@0|) _module.Lifetime.owner) Tclass._module.Thread? $prevHeap@@47)) (_module.Lifetime.unchangedNonvolatileFields $prevHeap@@47 $Heap@@57 |l#0@@0|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1236|
 ...
 :skolemid |1243|
 :pattern ( (_module.Universe.legalTransitionsSequence $prevHeap@@47 $Heap@@57 this@@82 |running#0@@2|) ($IsGoodHeap $Heap@@57))
))))
...
(assert  (=> (<= 17 $FunctionContextHeight) (forall (($Heap@@61 T@U) (this@@86 T@U) ) (!  (=> (or (|_module.Object.objectGlobalInv#canCall| $Heap@@61 this@@86) (and (< 17 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@61) (and (or (not (= this@@86 null)) (not true)) (and ($Is refType this@@86 Tclass._module.Object) ($IsAlloc refType this@@86 Tclass._module.Object $Heap@@61)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@86)) _module.Universe.content)) ($Box refType this@@86)) (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@86))) (= (_module.Object.objectGlobalInv $Heap@@61 this@@86)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@86)) _module.Universe.content)) ($Box refType this@@86)) (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@86))))))
 :qid |_12MutexLifetimelongdfy.305:19|
 :skolemid |1710|
 :pattern ( (_module.Object.objectGlobalInv $Heap@@61 this@@86) ($IsGoodHeap $Heap@@61))
))))
...
(assert (forall (($h@@25 T@U) ($o@@61 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@25) (and (or (not (= $o@@61 null)) (not true)) (= (dtype $o@@61) Tclass._module.Lifetime?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@61) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@61) _module.Lifetime.elements)) (TSet Tclass._module.OwnedObject) $h@@25))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2256|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@25 $o@@61) _module.Lifetime.elements)))
)))
(assert (forall (($h@@26 T@U) ($o@@62 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@26) (and (or (not (= $o@@62 null)) (not true)) (= (dtype $o@@62) Tclass._module.Lifetime?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@62) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@62) _module.Lifetime.mightPointTo)) (TSet Tclass._module.Lifetime) $h@@26))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2258|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@26 $o@@62) _module.Lifetime.mightPointTo)))
)))
(assert (forall (($h@@27 T@U) ($o@@63 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@27) (and (or (not (= $o@@63 null)) (not true)) (= (dtype $o@@63) Tclass._module.Lifetime?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@63) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@63) _module.Lifetime.mightPointFrom)) (TSet Tclass._module.Lifetime) $h@@27))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2260|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@63) _module.Lifetime.mightPointFrom)))
)))
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@87 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@87 null)) (not true)) ($Is refType this@@87 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@64 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@64 null)) (not true)) (and (= $o@@64 this@@87) (= $f@@34 _module.OwnedObject.owner))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@64) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@64) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |2110|
...
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@88 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@88 null)) (not true)) ($Is refType this@@88 Tclass._module.Lifetime))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@65 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (and (= $o@@65 this@@88) (= $f@@35 _module.Lifetime.owner))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@65) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@65) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |2266|
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@48 T@U) ($Heap@@62 T@U) (this@@89 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@48 $Heap@@62 this@@89) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@48) ($IsGoodHeap $Heap@@62)) ($HeapSucc $prevHeap@@48 $Heap@@62)) (and (or (not (= this@@89 null)) (not true)) (and ($Is refType this@@89 Tclass._module.Thread) ($IsAlloc refType this@@89 Tclass._module.Thread $prevHeap@@48)))))) (= (_module.Thread.localInv2 $prevHeap@@48 $Heap@@62 this@@89) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.376:22|
 :skolemid |1897|
 :pattern ( (_module.Thread.localInv2 $prevHeap@@48 $Heap@@62 this@@89) ($IsGoodHeap $Heap@@62))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@49 T@U) ($Heap@@63 T@U) (this@@90 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@49 $Heap@@63 this@@90) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@49) ($IsGoodHeap $Heap@@63)) ($HeapSucc $prevHeap@@49 $Heap@@63)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.Thread) ($IsAlloc refType this@@90 Tclass._module.Thread $prevHeap@@49)))))) (= (_module.Thread.sequenceInv2 $prevHeap@@49 $Heap@@63 this@@90) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.379:22|
 :skolemid |1904|
 :pattern ( (_module.Thread.sequenceInv2 $prevHeap@@49 $Heap@@63 this@@90) ($IsGoodHeap $Heap@@63))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@50 T@U) ($Heap@@64 T@U) (this@@91 T@U) ) (!  (=> (or (|_module.Lifetime.localInv2#canCall| $prevHeap@@50 $Heap@@64 this@@91) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@50) ($IsGoodHeap $Heap@@64)) ($HeapSucc $prevHeap@@50 $Heap@@64)) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.Lifetime) ($IsAlloc refType this@@91 Tclass._module.Lifetime $prevHeap@@50)))))) (= (_module.Lifetime.localInv2 $prevHeap@@50 $Heap@@64 this@@91) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.603:22|
 :skolemid |2431|
 :pattern ( (_module.Lifetime.localInv2 $prevHeap@@50 $Heap@@64 this@@91) ($IsGoodHeap $Heap@@64))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@51 T@U) ($Heap@@65 T@U) (this@@92 T@U) ) (!  (=> (or (|_module.OutlivesClaim.unchangedNonvolatileUserFields#canCall| $prevHeap@@51 $Heap@@65 this@@92) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@51) ($IsGoodHeap $Heap@@65)) ($HeapSucc $prevHeap@@51 $Heap@@65)) (and (or (not (= this@@92 null)) (not true)) (and ($Is refType this@@92 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@92 Tclass._module.OutlivesClaim $prevHeap@@51)))))) (= (_module.OutlivesClaim.unchangedNonvolatileUserFields $prevHeap@@51 $Heap@@65 this@@92) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.690:22|
 :skolemid |2985|
 :pattern ( (_module.OutlivesClaim.unchangedNonvolatileUserFields $prevHeap@@51 $Heap@@65 this@@92) ($IsGoodHeap $Heap@@65))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@52 T@U) ($Heap@@66 T@U) (this@@93 T@U) ) (!  (=> (or (|_module.OutlivesClaim.localUserInv2#canCall| $prevHeap@@52 $Heap@@66 this@@93) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@52) ($IsGoodHeap $Heap@@66)) ($HeapSucc $prevHeap@@52 $Heap@@66)) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@93 Tclass._module.OutlivesClaim $prevHeap@@52)))))) (= (_module.OutlivesClaim.localUserInv2 $prevHeap@@52 $Heap@@66 this@@93) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_12MutexLifetimelongdfy.699:22|
 :skolemid |3017|
 :pattern ( (_module.OutlivesClaim.localUserInv2 $prevHeap@@52 $Heap@@66 this@@93) ($IsGoodHeap $Heap@@66))
))))
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@94 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@94 null)) (not true)) ($Is refType this@@94 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@66 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (or (= $o@@66 this@@94) (= $o@@66 (_module.Object.universe this@@94)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@66) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@66) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |1775|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@95 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@95 null)) (not true)) ($Is refType this@@95 Tclass._module.Thread))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@67 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@67 null)) (not true)) (or (= $o@@67 this@@95) (= $o@@67 (_module.Object.universe this@@95)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@67) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@67) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1857|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@96 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@96 null)) (not true)) ($Is refType this@@96 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@68 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@68 null)) (not true)) (or (= $o@@68 this@@96) (= $o@@68 (_module.Object.universe this@@96)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@68) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@68) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |2128|
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@97 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@97 null)) (not true)) ($Is refType this@@97 Tclass._module.Lifetime))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@69 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@69 null)) (not true)) (or (= $o@@69 this@@97) (= $o@@69 (_module.Object.universe this@@97)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@69) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@69) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |2297|
...
(assert (forall ((|l#0@@1| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) ($o@@70 T@U) ($f@@40 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#250| |l#0@@1| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7|) $o@@70 $f@@40))  (=> (and (or (not (= $o@@70 |l#0@@1|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@70) |l#2|)))) (or (or (= $o@@70 |l#3|) (and (= $o@@70 |l#4|) (= $f@@40 |l#5|))) (and (= $o@@70 |l#6|) (= $f@@40 |l#7|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3875|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#250| |l#0@@1| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7|) $o@@70 $f@@40))
)))
(assert (forall (($ly@@13 T@U) ($h0@@30 T@U) ($h1@@30 T@U) (this@@110 T@U) (|a#0@@13| T@U) (|x#0@@8| T@U) (|b#0@@13| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@110 null)) (not true)) ($Is refType this@@110 Tclass._module.Universe))) (or (|_module.Universe.outlivesThrough#canCall| $h0@@30 this@@110 |a#0@@13| |x#0@@8| |b#0@@13|) (and (and ($Is refType |a#0@@13| Tclass._module.Lifetime) ($Is refType |x#0@@8| Tclass._module.Lifetime)) ($Is refType |b#0@@13| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@71 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@71 null)) (not true)) (or (or (= $o@@71 this@@110) (and (and ($Is refType $o@@71 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 this@@110) _module.Universe.content)) ($Box refType $o@@71))) (= $f@@41 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@71 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 this@@110) _module.Universe.content)) ($Box refType $o@@71))) (= $f@@41 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@71) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@71) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1596|
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@76 T@U) (this@@111 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@76 this@@111) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@76) (and (or (not (= this@@111 null)) (not true)) (and ($Is refType this@@111 Tclass._module.Lifetime) ($IsAlloc refType this@@111 Tclass._module.Lifetime $Heap@@76)))))) (=> (_module.Lifetime.localInv $Heap@@76 this@@111) (_module.Object.objectGlobalBaseInv $Heap@@76 this@@111)))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2318|
 :pattern ( (_module.Lifetime.localInv $Heap@@76 this@@111))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@77 T@U) (this@@112 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@77 this@@112) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@77) (and (or (not (= this@@112 null)) (not true)) (and ($Is refType this@@112 Tclass._module.Thread) ($IsAlloc refType this@@112 Tclass._module.Thread $Heap@@77)))))) (=> (_module.Thread.inv $Heap@@77 this@@112) (_module.Thread.localInv $Heap@@77 this@@112)))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1883|
 :pattern ( (_module.Thread.inv $Heap@@77 this@@112))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@78 T@U) (this@@113 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@78 this@@113) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@78) (and (or (not (= this@@113 null)) (not true)) (and ($Is refType this@@113 Tclass._module.Lifetime) ($IsAlloc refType this@@113 Tclass._module.Lifetime $Heap@@78)))))) (=> (_module.Lifetime.inv $Heap@@78 this@@113) (_module.Lifetime.localInv $Heap@@78 this@@113)))
 :qid |_12MutexLifetimelongdfy.589:19|
 :skolemid |2385|
 :pattern ( (_module.Lifetime.inv $Heap@@78 this@@113))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@79 T@U) (this@@114 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv#canCall| $Heap@@79 this@@114) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@79) (and (or (not (= this@@114 null)) (not true)) (and ($Is refType this@@114 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@114 Tclass._module.OutlivesClaim $Heap@@79)))))) (=> (_module.OutlivesClaim.userInv $Heap@@79 this@@114) (_module.OutlivesClaim.localUserInv $Heap@@79 this@@114)))
 :qid |_12MutexLifetimelongdfy.698:19|
 :skolemid |2999|
 :pattern ( (_module.OutlivesClaim.userInv $Heap@@79 this@@114))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@80 T@U) (this@@115 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@80 this@@115) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@80) (and (or (not (= this@@115 null)) (not true)) (and ($Is refType this@@115 Tclass._module.Object) ($IsAlloc refType this@@115 Tclass._module.Object $Heap@@80)))))) (=> (_module.Object.localInv $Heap@@80 this@@115) (_module.Object.objectGlobalBaseInv $Heap@@80 this@@115)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |1783|
 :pattern ( (_module.Object.localInv $Heap@@80 this@@115))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@81 T@U) (this@@116 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@81 this@@116) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@81) (and (or (not (= this@@116 null)) (not true)) (and ($Is refType this@@116 Tclass._module.OwnedObject) ($IsAlloc refType this@@116 Tclass._module.OwnedObject $Heap@@81)))))) (=> (_module.OwnedObject.userInv $Heap@@81 this@@116) (_module.OwnedObject.localUserInv $Heap@@81 this@@116)))
 :qid |_12MutexLifetimelongdfy.523:19|
 :skolemid |2243|
 :pattern ( (_module.OwnedObject.userInv $Heap@@81 this@@116))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@82 T@U) (this@@117 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@82 this@@117) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@82) (and (or (not (= this@@117 null)) (not true)) (and ($Is refType this@@117 Tclass._module.OwnedObject) ($IsAlloc refType this@@117 Tclass._module.OwnedObject $Heap@@82)))))) (=> (_module.OwnedObject.inv $Heap@@82 this@@117) (_module.OwnedObject.localInv $Heap@@82 this@@117)))
 :qid |_12MutexLifetimelongdfy.449:19|
 :skolemid |2163|
 :pattern ( (_module.OwnedObject.inv $Heap@@82 this@@117))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($Heap@@83 T@U) (this@@118 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@83 this@@118) (and (< 15 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@83) (and (or (not (= this@@118 null)) (not true)) (and ($Is refType this@@118 Tclass._module.Object) ($IsAlloc refType this@@118 Tclass._module.Object $Heap@@83)))))) (=> (_module.Object.inv $Heap@@83 this@@118) (_module.Object.localInv $Heap@@83 this@@118)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |1793|
 :pattern ( (_module.Object.inv $Heap@@83 this@@118))
))))
...
(assert (forall (($ly@@14 T@U) ($h0@@31 T@U) ($h1@@31 T@U) (this@@119 T@U) (|_k#0@@9| Int) (|a#0@@14| T@U) (|x#0@@9| T@U) (|b#0@@14| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@119 null)) (not true)) ($Is refType this@@119 Tclass._module.Universe))) (or (|_module.Universe.outlivesThrough_h#canCall| $h0@@31 this@@119 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (and (and (and (<= (LitInt 0) |_k#0@@9|) ($Is refType |a#0@@14| Tclass._module.Lifetime)) ($Is refType |x#0@@9| Tclass._module.Lifetime)) ($Is refType |b#0@@14| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@72 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@72 null)) (not true)) (or (or (= $o@@72 this@@119) (and (and ($Is refType $o@@72 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 this@@119) _module.Universe.content)) ($Box refType $o@@72))) (= $f@@42 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@72 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 this@@119) _module.Universe.content)) ($Box refType $o@@72))) (= $f@@42 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@72) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@72) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1609|
)) (= (_module.Universe.outlivesThrough_h $ly@@14 $h0@@31 this@@119 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (_module.Universe.outlivesThrough_h $ly@@14 $h1@@31 this@@119 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|))))
 :qid |unknown.0:0|
 :skolemid |1610|
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.Universe.outlivesThrough_h $ly@@14 $h1@@31 this@@119 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@53 T@U) ($Heap@@84 T@U) (this@@120 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@53 $Heap@@84 this@@120) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@53) ($IsGoodHeap $Heap@@84)) ($HeapSucc $prevHeap@@53 $Heap@@84)) (and (or (not (= this@@120 null)) (not true)) (and ($Is refType this@@120 Tclass._module.OwnedObject) ($IsAlloc refType this@@120 Tclass._module.OwnedObject $prevHeap@@53)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@53 this@@120) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@84 this@@120) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@53 $Heap@@84 this@@120)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@53 $Heap@@84 this@@120)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@53 this@@120) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@84 this@@120) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@53 $Heap@@84 this@@120)))))
 :qid |_12MutexLifetimelongdfy.438:22|
 :skolemid |2147|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@53 $Heap@@84 this@@120) ($IsGoodHeap $Heap@@84))
))))
...
(assert (forall (($ly@@15 T@U) ($h0@@32 T@U) ($h1@@32 T@U) (this@@121 T@U) (|a#0@@15| T@U) (|b#0@@15| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@121 null)) (not true)) ($Is refType this@@121 Tclass._module.Universe))) (or (|_module.Universe.outlives#canCall| $h0@@32 this@@121 |a#0@@15| |b#0@@15|) (and ($Is refType |a#0@@15| Tclass._module.Lifetime) ($Is refType |b#0@@15| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@73 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (or (or (= $o@@73 this@@121) (and (and ($Is refType $o@@73 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 this@@121) _module.Universe.content)) ($Box refType $o@@73))) (= $f@@43 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@73 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 this@@121) _module.Universe.content)) ($Box refType $o@@73))) (= $f@@43 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@73) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@73) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1570|
)) (= (_module.Universe.outlives $ly@@15 $h0@@32 this@@121 |a#0@@15| |b#0@@15|) (_module.Universe.outlives $ly@@15 $h1@@32 this@@121 |a#0@@15| |b#0@@15|))))
 :qid |unknown.0:0|
 :skolemid |1571|
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.Universe.outlives $ly@@15 $h1@@32 this@@121 |a#0@@15| |b#0@@15|))
)))
(assert (forall (($h@@28 T@U) ($o@@74 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@28) (and (or (not (= $o@@74 null)) (not true)) ($Is refType $o@@74 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@74) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@74) _module.OwnedObject.nonvolatileVersion)) TInt $h@@28))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2105|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@74) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@122 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@122 null)) (not true)) ($Is refType this@@122 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@75 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (= $o@@75 this@@122)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@75) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@75) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1719|
)) (= (_module.Object.nonAliasing $h0@@33 this@@122) (_module.Object.nonAliasing $h1@@33 this@@122))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1720|
 :pattern ( ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33) (_module.Object.nonAliasing $h1@@33 this@@122))
)))
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@123 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@123 null)) (not true)) ($Is refType this@@123 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@76 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (= $o@@76 this@@123)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@76) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@76) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1727|
)) (= (_module.Object.triggerAxioms $h0@@34 this@@123) (_module.Object.triggerAxioms $h1@@34 this@@123))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1728|
 :pattern ( ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34) (_module.Object.triggerAxioms $h1@@34 this@@123))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@124 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@124)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@124 null)) (not true)) ($Is refType this@@124 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@124)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimelongdfy.362:18|
 :weight 3
 :skolemid |1854|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@124)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@125 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@125)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@125 null)) (not true)) ($Is refType this@@125 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@125)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimelongdfy.425:18|
 :weight 3
 :skolemid |2118|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@125)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@126 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@126)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@126 null)) (not true)) ($Is refType this@@126 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@126)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimelongdfy.562:18|
 :weight 3
 :skolemid |2294|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@126)))
))))
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@127 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@127 null)) (not true)) ($Is refType this@@127 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@77 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@77 null)) (not true)) (or (= $o@@77 this@@127) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 this@@127) _module.Universe.content)) ($Box refType $o@@77)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@77) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@77) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |1174|
)) (= (_module.Universe.globalBaseInv $h0@@35 this@@127) (_module.Universe.globalBaseInv $h1@@35 this@@127))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1175|
 :pattern ( ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35) (_module.Universe.globalBaseInv $h1@@35 this@@127))
)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@85 T@U) (this@@128 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@85 this@@128) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@85) (and (or (not (= this@@128 null)) (not true)) (and ($Is refType this@@128 Tclass._module.Lifetime) ($IsAlloc refType this@@128 Tclass._module.Lifetime $Heap@@85)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@85 this@@128) (=> (_module.Object.objectGlobalBaseInv $Heap@@85 this@@128) (=> (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#0@@10|))) (= (_module.OwnedObject.lifetime |o#0@@10|) this@@128))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2333|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#0@@10|)))
)) (and (forall ((|o#1@@3| T@U) ) (!  (=> ($Is refType |o#1@@3| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#1@@3|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@85 |o#1@@3|) (|_module.Lifetime.alive#canCall| $Heap@@85 this@@128))))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2326|
 :pattern ( (_module.OwnedObject.alive $Heap@@85 |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#1@@3|)))
)) (=> (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#1@@4|))) (= (_module.OwnedObject.alive $Heap@@85 |o#1@@4|) (_module.Lifetime.alive $Heap@@85 this@@128)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2332|
 :pattern ( (_module.OwnedObject.alive $Heap@@85 |o#1@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#1@@4|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@85 this@@128) (=> (_module.Lifetime.alive $Heap@@85 this@@128) (forall ((|l#0@@2| T@U) ) (!  (=> ($Is refType |l#0@@2| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)) (|_module.Lifetime.alive#canCall| $Heap@@85 |l#0@@2|)))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2327|
 :pattern ( (_module.Lifetime.alive $Heap@@85 |l#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@85 this@@128) (forall ((|l#0@@3| T@U) ) (!  (=> (and ($Is refType |l#0@@3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@3|))) (_module.Lifetime.alive $Heap@@85 |l#0@@3|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2331|
 :pattern ( (_module.Lifetime.alive $Heap@@85 |l#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@3|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@85 this@@128) (=> (not (_module.Lifetime.alive $Heap@@85 this@@128)) (forall ((|l#1@@0| T@U) ) (!  (=> ($Is refType |l#1@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@85 |l#1@@0|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2328|
 :pattern ( (_module.Lifetime.alive $Heap@@85 |l#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@85 this@@128)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@85 this@@128) (forall ((|o#0@@11| T@U) ) (!  (=> (and ($Is refType |o#0@@11| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#0@@11|))) (= (_module.OwnedObject.lifetime |o#0@@11|) this@@128))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2320|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#0@@11|)))
))) (forall ((|o#1@@5| T@U) ) (!  (=> (and ($Is refType |o#1@@5| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#1@@5|))) (= (_module.OwnedObject.alive $Heap@@85 |o#1@@5|) (_module.Lifetime.alive $Heap@@85 this@@128)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2321|
 :pattern ( (_module.OwnedObject.alive $Heap@@85 |o#1@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.elements)) ($Box refType |o#1@@5|)))
))) (=> (_module.Lifetime.alive $Heap@@85 this@@128) (forall ((|l#0@@4| T@U) ) (!  (=> (and ($Is refType |l#0@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|))) (_module.Lifetime.alive $Heap@@85 |l#0@@4|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2322|
 :pattern ( (_module.Lifetime.alive $Heap@@85 |l#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@85 this@@128)) (forall ((|l#1@@1| T@U) ) (!  (=> (and ($Is refType |l#1@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|))) (not (_module.Lifetime.alive $Heap@@85 |l#1@@1|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2323|
 :pattern ( (_module.Lifetime.alive $Heap@@85 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
)))) (forall ((|l#2@@0| T@U) ) (!  (=> (and ($Is refType |l#2@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 |l#2@@0|) _module.Lifetime.mightPointFrom)) ($Box refType this@@128)))
 :qid |_12MutexLifetimelongdfy.586:16|
 :skolemid |2324|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 |l#2@@0|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@128)))
 :qid |_12MutexLifetimelongdfy.587:16|
 :skolemid |2325|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 |l#3@@0|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2334|
 :pattern ( (_module.Lifetime.localInv $Heap@@85 this@@128) ($IsGoodHeap $Heap@@85))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@16 T@U) ($Heap@@86 T@U) (this@@129 T@U) (|a#0@@16| T@U) (|b#0@@16| T@U) (|_k#0@@10| Int) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@86) (and (or (not (= this@@129 null)) (not true)) ($Is refType this@@129 Tclass._module.Universe))) ($Is refType |a#0@@16| Tclass._module.Lifetime)) ($Is refType |b#0@@16| Tclass._module.Lifetime)) (= |_k#0@@10| 0)) (not (_module.Universe.outlives_h $ly@@16 $Heap@@86 this@@129 |_k#0@@10| |a#0@@16| |b#0@@16|)))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1580|
 :pattern ( (_module.Universe.outlives_h $ly@@16 $Heap@@86 this@@129 |_k#0@@10| |a#0@@16| |b#0@@16|))
))))
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@130 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@130 null)) (not true)) ($Is refType this@@130 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@78 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (= $o@@78 this@@130)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@78) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@78) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |2121|
)) (= (_module.OwnedObject.objectFields $h0@@36 this@@130) (_module.OwnedObject.objectFields $h1@@36 this@@130))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2122|
 :pattern ( ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36) (_module.OwnedObject.objectFields $h1@@36 this@@130))
)))
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@131 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@131 null)) (not true)) ($Is refType this@@131 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@79 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (= $o@@79 this@@131)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@79) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@79) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |2224|
)) (= (_module.OwnedObject.objectUserFields $h0@@37 this@@131) (_module.OwnedObject.objectUserFields $h1@@37 this@@131))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2225|
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.OwnedObject.objectUserFields $h1@@37 this@@131))
)))
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@132 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@132 null)) (not true)) ($Is refType this@@132 Tclass._module.OutlivesClaim))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@80 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (= $o@@80 this@@132)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@80) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@80) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |2973|
)) (= (_module.OutlivesClaim.objectUserFields $h0@@38 this@@132) (_module.OutlivesClaim.objectUserFields $h1@@38 this@@132))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2974|
 :pattern ( ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38) (_module.OutlivesClaim.objectUserFields $h1@@38 this@@132))
)))
(assert (forall (($h@@29 T@U) ($o@@81 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@81 null)) (not true)) ($Is refType $o@@81 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@81) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@81) _module.OwnedObject.owner)) Tclass._module.Object? $h@@29))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2107|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@81) _module.OwnedObject.owner)))
)))
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@133 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@133 null)) (not true)) (and ($Is refType this@@133 Tclass._module.Universe) ($IsAlloc refType this@@133 Tclass._module.Universe $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@82 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@82) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@82) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@82) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |1186|
)) (= (_module.Universe.globalInv $h0@@39 this@@133) (_module.Universe.globalInv $h1@@39 this@@133))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1187|
 :pattern ( ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39) (_module.Universe.globalInv $h1@@39 this@@133))
)))
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@134 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@134 null)) (not true)) (and ($Is refType this@@134 Tclass._module.Object) ($IsAlloc refType this@@134 Tclass._module.Object $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@83 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@83) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@83) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@83) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |1699|
)) (= (_module.Object.objectGlobalBaseInv $h0@@40 this@@134) (_module.Object.objectGlobalBaseInv $h1@@40 this@@134))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1700|
 :pattern ( ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40) (_module.Object.objectGlobalBaseInv $h1@@40 this@@134))
)))
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@135 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@135 null)) (not true)) (and ($Is refType this@@135 Tclass._module.Object) ($IsAlloc refType this@@135 Tclass._module.Object $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@84 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@84) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@84) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |1706|
)) (= (_module.Object.objectGlobalInv $h0@@41 this@@135) (_module.Object.objectGlobalInv $h1@@41 this@@135))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1707|
 :pattern ( ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41) (_module.Object.objectGlobalInv $h1@@41 this@@135))
)))
(assert (forall (($h0@@42 T@U) ($h1@@42 T@U) (this@@136 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@42) ($IsGoodHeap $h1@@42)) (and (or (not (= this@@136 null)) (not true)) (and ($Is refType this@@136 Tclass._module.Object) ($IsAlloc refType this@@136 Tclass._module.Object $h0@@42)))) (and ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42))) (=> (forall (($o@@85 T@U) ($f@@53 T@U) ) (!  (=> (and (or (not (= $o@@85 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@85) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@85) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@42 $o@@85) $f@@53)))
 :qid |unknown.0:0|
 :skolemid |1781|
)) (= (_module.Object.localInv $h0@@42 this@@136) (_module.Object.localInv $h1@@42 this@@136))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1782|
 :pattern ( ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42) (_module.Object.localInv $h1@@42 this@@136))
)))
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@137 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@137 null)) (not true)) (and ($Is refType this@@137 Tclass._module.Object) ($IsAlloc refType this@@137 Tclass._module.Object $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@86 T@U) ($f@@54 T@U) ) (!  (=> (and (or (not (= $o@@86 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@86) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@86) $f@@54) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@86) $f@@54)))
 :qid |unknown.0:0|
 :skolemid |1791|
)) (= (_module.Object.inv $h0@@43 this@@137) (_module.Object.inv $h1@@43 this@@137))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1792|
 :pattern ( ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43) (_module.Object.inv $h1@@43 this@@137))
)))
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@138 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@138 null)) (not true)) (and ($Is refType this@@138 Tclass._module.Thread) ($IsAlloc refType this@@138 Tclass._module.Thread $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@87 T@U) ($f@@55 T@U) ) (!  (=> (and (or (not (= $o@@87 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@87) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@87) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@87) $f@@55)))
 :qid |unknown.0:0|
 :skolemid |1871|
)) (= (_module.Thread.localInv $h0@@44 this@@138) (_module.Thread.localInv $h1@@44 this@@138))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1872|
 :pattern ( ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44) (_module.Thread.localInv $h1@@44 this@@138))
)))
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@139 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@139 null)) (not true)) (and ($Is refType this@@139 Tclass._module.Thread) ($IsAlloc refType this@@139 Tclass._module.Thread $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@88 T@U) ($f@@56 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@88) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@88) $f@@56)))
 :qid |unknown.0:0|
 :skolemid |1881|
)) (= (_module.Thread.inv $h0@@45 this@@139) (_module.Thread.inv $h1@@45 this@@139))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1882|
 :pattern ( ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45) (_module.Thread.inv $h1@@45 this@@139))
)))
(assert (forall (($h0@@46 T@U) ($h1@@46 T@U) (this@@140 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@46) ($IsGoodHeap $h1@@46)) (and (or (not (= this@@140 null)) (not true)) (and ($Is refType this@@140 Tclass._module.OwnedObject) ($IsAlloc refType this@@140 Tclass._module.OwnedObject $h0@@46)))) (and ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46))) (=> (forall (($o@@89 T@U) ($f@@57 T@U) ) (!  (=> (and (or (not (= $o@@89 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@89) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@89) $f@@57) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@46 $o@@89) $f@@57)))
 :qid |unknown.0:0|
 :skolemid |2149|
)) (= (_module.OwnedObject.localInv $h0@@46 this@@140) (_module.OwnedObject.localInv $h1@@46 this@@140))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2150|
 :pattern ( ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46) (_module.OwnedObject.localInv $h1@@46 this@@140))
)))
(assert (forall (($h0@@47 T@U) ($h1@@47 T@U) (this@@141 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@47) ($IsGoodHeap $h1@@47)) (and (or (not (= this@@141 null)) (not true)) (and ($Is refType this@@141 Tclass._module.OwnedObject) ($IsAlloc refType this@@141 Tclass._module.OwnedObject $h0@@47)))) (and ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47))) (=> (forall (($o@@90 T@U) ($f@@58 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@90) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@47 $o@@90) $f@@58)))
 :qid |unknown.0:0|
 :skolemid |2161|
)) (= (_module.OwnedObject.inv $h0@@47 this@@141) (_module.OwnedObject.inv $h1@@47 this@@141))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2162|
 :pattern ( ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47) (_module.OwnedObject.inv $h1@@47 this@@141))
)))
(assert (forall (($h0@@48 T@U) ($h1@@48 T@U) (this@@142 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@48) ($IsGoodHeap $h1@@48)) (and (or (not (= this@@142 null)) (not true)) (and ($Is refType this@@142 Tclass._module.OwnedObject) ($IsAlloc refType this@@142 Tclass._module.OwnedObject $h0@@48)))) (and ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48))) (=> (forall (($o@@91 T@U) ($f@@59 T@U) ) (!  (=> (and (or (not (= $o@@91 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@91) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@91) $f@@59) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@48 $o@@91) $f@@59)))
 :qid |unknown.0:0|
 :skolemid |2233|
)) (= (_module.OwnedObject.localUserInv $h0@@48 this@@142) (_module.OwnedObject.localUserInv $h1@@48 this@@142))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2234|
 :pattern ( ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48) (_module.OwnedObject.localUserInv $h1@@48 this@@142))
)))
(assert (forall (($h0@@49 T@U) ($h1@@49 T@U) (this@@143 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@49) ($IsGoodHeap $h1@@49)) (and (or (not (= this@@143 null)) (not true)) (and ($Is refType this@@143 Tclass._module.OwnedObject) ($IsAlloc refType this@@143 Tclass._module.OwnedObject $h0@@49)))) (and ($IsHeapAnchor $h0@@49) ($HeapSucc $h0@@49 $h1@@49))) (=> (forall (($o@@92 T@U) ($f@@60 T@U) ) (!  (=> (and (or (not (= $o@@92 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@49 $o@@92) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@49 $o@@92) $f@@60) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@49 $o@@92) $f@@60)))
 :qid |unknown.0:0|
 :skolemid |2241|
)) (= (_module.OwnedObject.userInv $h0@@49 this@@143) (_module.OwnedObject.userInv $h1@@49 this@@143))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2242|
 :pattern ( ($IsHeapAnchor $h0@@49) ($HeapSucc $h0@@49 $h1@@49) (_module.OwnedObject.userInv $h1@@49 this@@143))
)))
(assert (forall (($h0@@50 T@U) ($h1@@50 T@U) (this@@144 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@50) ($IsGoodHeap $h1@@50)) (and (or (not (= this@@144 null)) (not true)) (and ($Is refType this@@144 Tclass._module.Lifetime) ($IsAlloc refType this@@144 Tclass._module.Lifetime $h0@@50)))) (and ($IsHeapAnchor $h0@@50) ($HeapSucc $h0@@50 $h1@@50))) (=> (forall (($o@@93 T@U) ($f@@61 T@U) ) (!  (=> (and (or (not (= $o@@93 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@50 $o@@93) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@50 $o@@93) $f@@61) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@50 $o@@93) $f@@61)))
 :qid |unknown.0:0|
 :skolemid |2316|
)) (= (_module.Lifetime.localInv $h0@@50 this@@144) (_module.Lifetime.localInv $h1@@50 this@@144))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2317|
 :pattern ( ($IsHeapAnchor $h0@@50) ($HeapSucc $h0@@50 $h1@@50) (_module.Lifetime.localInv $h1@@50 this@@144))
)))
(assert (forall (($h0@@51 T@U) ($h1@@51 T@U) (this@@145 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@51) ($IsGoodHeap $h1@@51)) (and (or (not (= this@@145 null)) (not true)) (and ($Is refType this@@145 Tclass._module.Lifetime) ($IsAlloc refType this@@145 Tclass._module.Lifetime $h0@@51)))) (and ($IsHeapAnchor $h0@@51) ($HeapSucc $h0@@51 $h1@@51))) (=> (forall (($o@@94 T@U) ($f@@62 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@51 $o@@94) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@51 $o@@94) $f@@62) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@51 $o@@94) $f@@62)))
 :qid |unknown.0:0|
 :skolemid |2383|
)) (= (_module.Lifetime.inv $h0@@51 this@@145) (_module.Lifetime.inv $h1@@51 this@@145))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2384|
 :pattern ( ($IsHeapAnchor $h0@@51) ($HeapSucc $h0@@51 $h1@@51) (_module.Lifetime.inv $h1@@51 this@@145))
)))
(assert (forall (($h0@@52 T@U) ($h1@@52 T@U) (this@@146 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@52) ($IsGoodHeap $h1@@52)) (and (or (not (= this@@146 null)) (not true)) (and ($Is refType this@@146 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@146 Tclass._module.OutlivesClaim $h0@@52)))) (and ($IsHeapAnchor $h0@@52) ($HeapSucc $h0@@52 $h1@@52))) (=> (forall (($o@@95 T@U) ($f@@63 T@U) ) (!  (=> (and (or (not (= $o@@95 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@52 $o@@95) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@52 $o@@95) $f@@63) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@52 $o@@95) $f@@63)))
 :qid |unknown.0:0|
 :skolemid |2988|
)) (= (_module.OutlivesClaim.localUserInv $h0@@52 this@@146) (_module.OutlivesClaim.localUserInv $h1@@52 this@@146))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2989|
 :pattern ( ($IsHeapAnchor $h0@@52) ($HeapSucc $h0@@52 $h1@@52) (_module.OutlivesClaim.localUserInv $h1@@52 this@@146))
)))
(assert (forall (($h0@@53 T@U) ($h1@@53 T@U) (this@@147 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@53) ($IsGoodHeap $h1@@53)) (and (or (not (= this@@147 null)) (not true)) (and ($Is refType this@@147 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@147 Tclass._module.OutlivesClaim $h0@@53)))) (and ($IsHeapAnchor $h0@@53) ($HeapSucc $h0@@53 $h1@@53))) (=> (forall (($o@@96 T@U) ($f@@64 T@U) ) (!  (=> (and (or (not (= $o@@96 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@53 $o@@96) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@53 $o@@96) $f@@64) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@53 $o@@96) $f@@64)))
 :qid |unknown.0:0|
 :skolemid |2997|
)) (= (_module.OutlivesClaim.userInv $h0@@53 this@@147) (_module.OutlivesClaim.userInv $h1@@53 this@@147))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2998|
 :pattern ( ($IsHeapAnchor $h0@@53) ($HeapSucc $h0@@53 $h1@@53) (_module.OutlivesClaim.userInv $h1@@53 this@@147))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@148 T@U) ) (!  (=> (or (|_module.OutlivesClaim.volatileOwns#canCall| this@@148) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@148 null)) (not true)) ($Is refType this@@148 Tclass._module.OutlivesClaim)))) (= (_module.OutlivesClaim.volatileOwns this@@148) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimelongdfy.687:19|
 :skolemid |2969|
 :pattern ( (_module.OutlivesClaim.volatileOwns this@@148))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@149 T@U) ) (!  (=> (or (|_module.OutlivesClaim.volatileOwns#canCall| this@@149) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@149 null)) (not true)) ($Is refType this@@149 Tclass._module.OutlivesClaim)))) (= (_module.OwnedObject.volatileOwns this@@149) (_module.OutlivesClaim.volatileOwns this@@149)))
 :qid |_12MutexLifetimelongdfy.518:19|
 :skolemid |2971|
 :pattern ( (_module.OwnedObject.volatileOwns this@@149) ($Is refType this@@149 Tclass._module.OutlivesClaim))
 :pattern ( (_module.OwnedObject.volatileOwns this@@149) (_module.OutlivesClaim.volatileOwns this@@149))
))))
...
(assert (forall (($o@@97 T@U) ) (!  (=> ($Is refType $o@@97 Tclass._module.Thread?) ($Is refType $o@@97 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |3837|
 :pattern ( ($Is refType $o@@97 Tclass._module.Thread?))
)))
...
(assert (forall (($o@@98 T@U) ) (!  (=> ($Is refType $o@@98 Tclass._module.OwnedObject?) ($Is refType $o@@98 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |3841|
 :pattern ( ($Is refType $o@@98 Tclass._module.OwnedObject?))
)))
...
(assert (forall (($o@@99 T@U) ) (!  (=> ($Is refType $o@@99 Tclass._module.Lifetime?) ($Is refType $o@@99 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |3845|
 :pattern ( ($Is refType $o@@99 Tclass._module.Lifetime?))
)))
...
(assert (forall (($o@@100 T@U) ) (!  (=> ($Is refType $o@@100 Tclass._module.OutlivesClaim?) ($Is refType $o@@100 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3853|
 :pattern ( ($Is refType $o@@100 Tclass._module.OutlivesClaim?))
)))
...
(assert (= (Tag Tclass._module.OutlivesClaim) Tagclass._module.OutlivesClaim))
(assert (= (TagFamily Tclass._module.OutlivesClaim) tytagFamily$OutlivesClaim))
(assert (forall (($h@@31 T@U) ($o@@101 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (or (not (= $o@@101 null)) (not true)) ($Is refType $o@@101 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@101) _module.OwnedObject.owner)) Tclass._module.Object?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2106|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@101) _module.OwnedObject.owner)))
)))
...
(assert (forall (($o@@102 T@U) ) (! (= ($Is refType $o@@102 Tclass._module.Universe?)  (or (= $o@@102 null) (implements$_module.Universe (dtype $o@@102))))
 :qid |unknown.0:0|
 :skolemid |1170|
 :pattern ( ($Is refType $o@@102 Tclass._module.Universe?))
)))
(assert (forall (($o@@103 T@U) ) (! (= ($Is refType $o@@103 Tclass._module.Object?)  (or (= $o@@103 null) (implements$_module.Object (dtype $o@@103))))
 :qid |unknown.0:0|
 :skolemid |1695|
 :pattern ( ($Is refType $o@@103 Tclass._module.Object?))
)))
(assert (forall (($o@@104 T@U) ) (! (= ($Is refType $o@@104 Tclass._module.OwnedObject?)  (or (= $o@@104 null) (implements$_module.OwnedObject (dtype $o@@104))))
 :qid |unknown.0:0|
 :skolemid |2102|
 :pattern ( ($Is refType $o@@104 Tclass._module.OwnedObject?))
)))
(assert (forall (($h@@32 T@U) ($o@@105 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@32) (and (or (not (= $o@@105 null)) (not true)) ($Is refType $o@@105 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@105) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@105) _module.Universe.content)) (TSet Tclass._module.Object) $h@@32))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1173|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@105) _module.Universe.content)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@150 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@150) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@150 null)) (not true)) ($Is refType this@@150 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@150) (_module.Thread.objectClassKind this@@150)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1855|
 :pattern ( (_module.Object.objectClassKind this@@150) ($Is refType this@@150 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@150) (_module.Thread.objectClassKind this@@150))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@151 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@151) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@151 null)) (not true)) ($Is refType this@@151 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@151) (_module.OwnedObject.objectClassKind this@@151)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2119|
 :pattern ( (_module.Object.objectClassKind this@@151) ($Is refType this@@151 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@151) (_module.OwnedObject.objectClassKind this@@151))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@152 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@152) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@152 null)) (not true)) ($Is refType this@@152 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@152) (_module.Lifetime.objectClassKind this@@152)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2295|
 :pattern ( (_module.Object.objectClassKind this@@152) ($Is refType this@@152 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@152) (_module.Lifetime.objectClassKind this@@152))
))))
(assert  (=> (<= 16 $FunctionContextHeight) (forall (($prevHeap@@54 T@U) ($Heap@@87 T@U) (this@@153 T@U) ) (!  (=> (or (|_module.Universe.globalInv2#canCall| $prevHeap@@54 $Heap@@87 this@@153) (and (< 16 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@54) ($IsGoodHeap $Heap@@87)) ($HeapSucc $prevHeap@@54 $Heap@@87)) (and (or (not (= this@@153 null)) (not true)) (and ($Is refType this@@153 Tclass._module.Universe) ($IsAlloc refType this@@153 Tclass._module.Universe $prevHeap@@54)))))) (and (forall ((|o#0@@12| T@U) ) (!  (=> ($Is refType |o#0@@12| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@153) _module.Universe.content)) ($Box refType |o#0@@12|)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@153) _module.Universe.content)) ($Box refType |o#0@@12|)) (|_module.Object.inv2#canCall| $prevHeap@@54 $Heap@@87 |o#0@@12|))))
 :qid |_12MutexLifetimelongdfy.34:12|
 :skolemid |1214|
 :pattern ( (_module.Object.inv2 $prevHeap@@54 $Heap@@87 |o#0@@12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@153) _module.Universe.content)) ($Box refType |o#0@@12|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@153) _module.Universe.content)) ($Box refType |o#0@@12|)))
)) (= (_module.Universe.globalInv2 $prevHeap@@54 $Heap@@87 this@@153) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@153) _module.Universe.content)) ($Box refType |o#0@@13|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@153) _module.Universe.content)) ($Box refType |o#0@@13|)) (_module.Object.inv2 $prevHeap@@54 $Heap@@87 |o#0@@13|)))
 :qid |_12MutexLifetimelongdfy.34:12|
 :skolemid |1213|
 :pattern ( (_module.Object.inv2 $prevHeap@@54 $Heap@@87 |o#0@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 this@@153) _module.Universe.content)) ($Box refType |o#0@@13|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@153) _module.Universe.content)) ($Box refType |o#0@@13|)))
)))))
 :qid |_12MutexLifetimelongdfy.33:22|
 :skolemid |1215|
 :pattern ( (_module.Universe.globalInv2 $prevHeap@@54 $Heap@@87 this@@153) ($IsGoodHeap $Heap@@87))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@55 T@U) ($Heap@@88 T@U) (this@@158 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv2#canCall| $prevHeap@@55 $Heap@@88 this@@158) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@55) ($IsGoodHeap $Heap@@88)) ($HeapSucc $prevHeap@@55 $Heap@@88)) (and (or (not (= this@@158 null)) (not true)) (and ($Is refType this@@158 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@158 Tclass._module.OutlivesClaim $prevHeap@@55)))))) (=> (_module.OutlivesClaim.userInv2 $prevHeap@@55 $Heap@@88 this@@158) (_module.OutlivesClaim.localUserInv2 $prevHeap@@55 $Heap@@88 this@@158)))
 :qid |_12MutexLifetimelongdfy.700:22|
 :skolemid |3022|
 :pattern ( (_module.OutlivesClaim.userInv2 $prevHeap@@55 $Heap@@88 this@@158))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($prevHeap@@56 T@U) ($Heap@@89 T@U) (this@@159 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv2#canCall| $prevHeap@@56 $Heap@@89 this@@159) (and (< 13 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@56) ($IsGoodHeap $Heap@@89)) ($HeapSucc $prevHeap@@56 $Heap@@89)) (and (or (not (= this@@159 null)) (not true)) (and ($Is refType this@@159 Tclass._module.OwnedObject) ($IsAlloc refType this@@159 Tclass._module.OwnedObject $prevHeap@@56)))))) (=> (_module.OwnedObject.userInv2 $prevHeap@@56 $Heap@@89 this@@159) (_module.OwnedObject.localUserInv2 $prevHeap@@56 $Heap@@89 this@@159)))
 :qid |_12MutexLifetimelongdfy.524:22|
 :skolemid |2247|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@56 $Heap@@89 this@@159))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@90 T@U) (this@@160 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@90 this@@160) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@90) (and (or (not (= this@@160 null)) (not true)) (and ($Is refType this@@160 Tclass._module.Thread) ($IsAlloc refType this@@160 Tclass._module.Thread $Heap@@90)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@90 this@@160)) (= (_module.Thread.localInv $Heap@@90 this@@160)  (and true (_module.Object.objectGlobalBaseInv $Heap@@90 this@@160)))))
 :qid |_12MutexLifetimelongdfy.369:19|
 :skolemid |1875|
 :pattern ( (_module.Thread.localInv $Heap@@90 this@@160) ($IsGoodHeap $Heap@@90))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@91 T@U) (this@@161 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@91 this@@161) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@91) (and (or (not (= this@@161 null)) (not true)) (and ($Is refType this@@161 Tclass._module.Thread) ($IsAlloc refType this@@161 Tclass._module.Thread $Heap@@91)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@91 this@@161)) (= (_module.Thread.inv $Heap@@91 this@@161)  (and true (_module.Thread.localInv $Heap@@91 this@@161)))))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1885|
 :pattern ( (_module.Thread.inv $Heap@@91 this@@161) ($IsGoodHeap $Heap@@91))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@92 T@U) (this@@163 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@92 this@@163) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@92) (and (or (not (= this@@163 null)) (not true)) (and ($Is refType this@@163 Tclass._module.OwnedObject) ($IsAlloc refType this@@163 Tclass._module.OwnedObject $Heap@@92)))))) (= (_module.OwnedObject.alive $Heap@@92 this@@163)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@92 this@@163) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.422:19|
 :skolemid |2114|
 :pattern ( (_module.OwnedObject.alive $Heap@@92 this@@163) ($IsGoodHeap $Heap@@92))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@93 T@U) (this@@164 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@93 this@@164) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@93) (and (or (not (= this@@164 null)) (not true)) (and ($Is refType this@@164 Tclass._module.Lifetime) ($IsAlloc refType this@@164 Tclass._module.Lifetime $Heap@@93)))))) (= (_module.Lifetime.alive $Heap@@93 this@@164)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 this@@164) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@93 this@@164) ($IsGoodHeap $Heap@@93))
))))
(assert (forall (($h@@33 T@U) ($o@@106 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (or (not (= $o@@106 null)) (not true)) ($Is refType $o@@106 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@106) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1172|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@106) _module.Universe.content)))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@94 T@U) (this@@165 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@94 this@@165) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@94) (and (or (not (= this@@165 null)) (not true)) (and ($Is refType this@@165 Tclass._module.Lifetime) ($IsAlloc refType this@@165 Tclass._module.Lifetime $Heap@@94)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@94 this@@165)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@165) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 (_module.Object.universe this@@165)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@165) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@165) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 (_module.Object.universe this@@165)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@165) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 (_module.Object.universe this@@165)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@165) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 (_module.Object.universe this@@165)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@94 this@@165) ($IsGoodHeap $Heap@@94))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@57 T@U) ($Heap@@95 T@U) (this@@166 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@57 $Heap@@95 this@@166) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@57) ($IsGoodHeap $Heap@@95)) ($HeapSucc $prevHeap@@57 $Heap@@95)) (and (or (not (= this@@166 null)) (not true)) (and ($Is refType this@@166 Tclass._module.OwnedObject) ($IsAlloc refType this@@166 Tclass._module.OwnedObject $prevHeap@@57)))))) (and (=> (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.OwnedObject.owner)) null)) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.OwnedObject.nonvolatileVersion)))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@57 $Heap@@95 this@@166))) (=> (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@57 $Heap@@95 this@@166))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.owner))))
(|_module.OwnedObject.volatileOwns#canCall| |oldOwner#0|))))))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@57 $Heap@@95 this@@166)  (and (and (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.OwnedObject.owner)) null)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.OwnedObject.nonvolatileVersion))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@57 $Heap@@95 this@@166)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#0@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@166) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@95 this@@166) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_12MutexLifetimelongdfy.458:22|
 :skolemid |2186|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@57 $Heap@@95 this@@166) ($IsGoodHeap $Heap@@95))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@58 T@U) ($Heap@@96 T@U) (this@@167 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv2#canCall| $prevHeap@@58 $Heap@@96 this@@167) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@58) ($IsGoodHeap $Heap@@96)) ($HeapSucc $prevHeap@@58 $Heap@@96)) (and (or (not (= this@@167 null)) (not true)) (and ($Is refType this@@167 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@167 Tclass._module.OutlivesClaim $prevHeap@@58)))))) (and (|_module.OutlivesClaim.localUserInv2#canCall| $prevHeap@@58 $Heap@@96 this@@167) (= (_module.OutlivesClaim.userInv2 $prevHeap@@58 $Heap@@96 this@@167) (_module.OutlivesClaim.localUserInv2 $prevHeap@@58 $Heap@@96 this@@167))))
 :qid |_12MutexLifetimelongdfy.700:22|
 :skolemid |3024|
 :pattern ( (_module.OutlivesClaim.userInv2 $prevHeap@@58 $Heap@@96 this@@167) ($IsGoodHeap $Heap@@96))
))))
...
(set-info :boogie-vc-id Impl$$_module.OutlivesClaim.__ctor_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@97) ($IsHeapAnchor $Heap@@97)) (=> (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@97)) (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@97))) (=> (and (and (and ($Is refType |target#0| Tclass._module.Lifetime) ($IsAlloc refType |target#0| Tclass._module.Lifetime $Heap@@97)) (and ($Is refType |source#0| Tclass._module.Lifetime) ($IsAlloc refType |source#0| Tclass._module.Lifetime $Heap@@97))) (and (and (=> |defass#lifetime#0| (and ($Is refType |lifetime#0| Tclass._module.Lifetime) ($IsAlloc refType |lifetime#0| Tclass._module.Lifetime $Heap@@97))) true) (= 23 $FunctionContextHeight))) (=> (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (and (_module.Universe.globalInv $Heap@@97 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@@97 |o#10|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |3219|
 :pattern ( (_module.Object.inv $Heap@@97 |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#10|)))
))))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |target#0|)) ($Box refType |source#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |target#0|) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |source#0|) _module.Lifetime.owner))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |source#0|) _module.Lifetime.owner)) |running#0@@3|))) (and (and (|_module.Universe.outlives#canCall| $Heap@@97 |universe#0| |target#0| |source#0|) (and (_module.Universe.outlives ($LS $LZ) $Heap@@97 |universe#0| |target#0| |source#0|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |source#0|) _module.Lifetime.mightPointTo)) ($Box refType |target#0|)) (exists ((|x#1| T@U) ) (!  (and (and ($Is refType |x#1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |x#1|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@97 |universe#0| |target#0| |x#1| |source#0|))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |3221|
 :pattern ( (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@97 |universe#0| |target#0| |x#1| |source#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |x#1|)))
))))) (and (= $_ModifiesFrame@0 (|lambda#250| null $Heap@@97 alloc |universe#0| |target#0| _module.Lifetime.mightPointFrom |source#0| _module.Lifetime.mightPointFrom)) (= |mightPointTo##0@0| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |target#0|)) ($Box refType |source#0|)))))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (forall (($o@@107 T@U) ($f@@65 T@U) ) (!  (=> (and (and (or (not (= $o@@107 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@107) alloc)))) (or (= $o@@107 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@107)) (= $f@@65 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@107 $f@@65)))
 :qid |_12MutexLifetimelongdfy.736:21|
 :skolemid |3242|
))) (=> (forall (($o@@108 T@U) ($f@@66 T@U) ) (!  (=> (and (and (or (not (= $o@@108 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@108) alloc)))) (or (= $o@@108 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@108)) (= $f@@66 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@108 $f@@66)))
 :qid |_12MutexLifetimelongdfy.736:21|
 :skolemid |3242|
)) (=> (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass._module.Lifetime) ($IsAlloc refType call5formal@this Tclass._module.Lifetime $Heap@@97))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (forall ((|o#0@@14| T@U) ) (!  (=> (and ($Is refType |o#0@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|))) (and (and (and (= (_module.Object.universe |o#0@@14|) |universe#0|) (or (not (= |o#0@@14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@97 |o#0@@14|)) (_module.Object.triggerAxioms $Heap@@97 |o#0@@14|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2625|
 :pattern ( (_module.Object.triggerAxioms $Heap@@97 |o#0@@14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@97 |o#0@@14|))
 :pattern ( (_module.Object.universe |o#0@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|)))
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (forall ((|o#0@@15| T@U) ) (!  (=> (and ($Is refType |o#0@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@15|))) (and (and (and (= (_module.Object.universe |o#0@@15|) |universe#0|) (or (not (= |o#0@@15| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@97 |o#0@@15|)) (_module.Object.triggerAxioms $Heap@@97 |o#0@@15|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2625|
 :pattern ( (_module.Object.triggerAxioms $Heap@@97 |o#0@@15|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@97 |o#0@@15|))
 :pattern ( (_module.Object.universe |o#0@@15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@15|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (forall ((|o#1@@6| T@U) ) (!  (=> (and ($Is refType |o#1@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@6|))) (_module.Object.inv $Heap@@97 |o#1@@6|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |2627|
 :pattern ( (_module.Object.inv $Heap@@97 |o#1@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@6|)))
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (forall ((|o#1@@7| T@U) ) (!  (=> (and ($Is refType |o#1@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@7|))) (_module.Object.inv $Heap@@97 |o#1@@7|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |2627|
 :pattern ( (_module.Object.inv $Heap@@97 |o#1@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@7|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 27)) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (|Set#Subset| |mightPointTo##0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| |mightPointTo##0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (forall ((|l#1@@2| T@U) ) (!  (=> (and ($Is refType |l#1@@2| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@2|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@2|) _module.Lifetime.owner)) |running#0@@3|))
 :qid |_12MutexLifetimelongdfy.612:21|
 :skolemid |2629|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@2|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@2|)))
))) (=> (forall ((|l#1@@3| T@U) ) (!  (=> (and ($Is refType |l#1@@3| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@3|))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@3|) _module.Lifetime.owner)) |running#0@@3|))
 :qid |_12MutexLifetimelongdfy.612:21|
 :skolemid |2629|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@3|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@3|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (or (not (= call5formal@this@0 null)) (not true)) (and ($Is refType call5formal@this@0 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@0 Tclass._module.Lifetime $Heap@0)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 call5formal@this@0) (=> (_module.Object.objectGlobalInv $Heap@0 call5formal@this@0) (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@0 |universe#0| |running#0@@3|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 call5formal@this@0) (and (_module.Object.objectGlobalInv $Heap@0 call5formal@this@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe call5formal@this@0)) _module.Universe.content)) ($Box refType call5formal@this@0)) (_module.Universe.globalInv $Heap@0 (_module.Object.universe call5formal@this@0))))))) (=> (and (and (and (and (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@0 |universe#0| |running#0@@3|) (and (_module.Universe.legalTransition $Heap@@97 $Heap@0 |universe#0| |running#0@@3|) (and (and (and (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@@97 |universe#0|)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#11|))) (and (or (forall (($o@@109 T@U) ($f@@67 T@U) ) (!  (=> (or (not (= $o@@109 null)) (not true)) (=> (= $o@@109 |o#11|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@109) $f@@67) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@109) $f@@67))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2656|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@109) $f@@67))
)) (_module.Object.inv $Heap@0 |o#11|)) (or (forall (($o@@110 T@U) ($f@@68 T@U) ) (!  (=> (or (not (= $o@@110 null)) (not true)) (=> (= $o@@110 |o#11|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@110) $f@@68) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@110) $f@@68))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |2657|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@110) $f@@68))
)) (_module.Object.inv2 $Heap@@97 $Heap@0 |o#11|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |2658|
 :pattern ( (_module.Object.inv2 $Heap@@97 $Heap@0 |o#11|))
 :pattern ( (_module.Object.inv $Heap@0 |o#11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#11|)))
))) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#12|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#12|))))) (_module.Object.inv $Heap@0 |o#12|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |2659|
 :pattern ( (_module.Object.inv $Heap@0 |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#12|)))
...
))))) (= (_module.Object.universe call5formal@this@0) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.elements)) |Set#Empty|))) (and (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.mightPointTo)) |mightPointTo##0@0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.mightPointFrom)) |Set#Empty|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (forall ((|l#3@@1| T@U) ) (!  (=> (and ($Is refType |l#3@@1| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#3@@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))))
 :qid |_12MutexLifetimelongdfy.618:20|
 :skolemid |2660|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#3@@1|) _module.Lifetime.mightPointFrom)))
...
)))) (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 call5formal@this@0) alloc)))) (forall (($o@@111 T@U) ) (!  (=> (and (or (not (= $o@@111 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@111) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@111)) (or (= $o@@111 |universe#0|) (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@111)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2661|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111))
))) (and (forall (($o@@112 T@U) ($f@@69 T@U) ) (!  (=> (and (or (not (= $o@@112 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@112) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@112) $f@@69) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@112) $f@@69)) (or (= $o@@112 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@112)) (= $f@@69 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimelongdfy.610:3|
 :skolemid |2662|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@112) $f@@69))
)) ($HeapSucc $Heap@@97 $Heap@0))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 23)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@97)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@97) (and (=> (= (ControlFlow 0 2) (- 0 22)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (forall ((|l#1@@4| T@U) ) (!  (=> (and ($Is refType |l#1@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@4|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@4|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@4|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@4|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@4|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@4|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@4|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@4|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@4|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@4|)))
))) (=> (forall ((|l#1@@5| T@U) ) (!  (=> (and ($Is refType |l#1@@5| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@5|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@5|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@5|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@5|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@5|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@5|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@5|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@5|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#1@@5|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@5|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (forall ((|a#1| T@U) (|b#1| T@U) ) (!  (=> (and ($Is refType |a#1| Tclass._module.Lifetime) ($Is refType |b#1| Tclass._module.Lifetime)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |a#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |b#1|))) (and (|_module.Universe.outlives#canCall| $Heap@@97 |universe#0| |a#1| |b#1|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@@97 |universe#0| |a#1| |b#1|) (|_module.Universe.outlives#canCall| $Heap@0 |universe#0| |a#1| |b#1|)))))
 :qid |_12MutexLifetimelongdfy.202:20|
 :skolemid |1651|
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1| |b#1|))
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@@97 |universe#0| |a#1| |b#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |b#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |a#1|)))
))) (and (forall ((|a#1@@0| T@U) (|b#1@@0| T@U) ) (!  (=> (and (and ($Is refType |a#1@@0| Tclass._module.Lifetime) ($Is refType |b#1@@0| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@0|)))) (=> (_module.Universe.outlives ($LS $LZ) $Heap@@97 |universe#0| |a#1@@0| |b#1@@0|) (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1@@0| |b#1@@0|)))
 :qid |_12MutexLifetimelongdfy.202:20|
 :skolemid |1653|
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#1@@0| |b#1@@0|))
 :pattern ( (_module.Universe.outlives ($LS $LZ) $Heap@@97 |universe#0| |a#1@@0| |b#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@0|)))
)) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 19)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@97)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@97) (and (=> (= (ControlFlow 0 2) (- 0 18)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@97)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@97) (and (=> (= (ControlFlow 0 2) (- 0 17)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@97)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@97) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (forall ((|o#0@@16| T@U) ) (!  (=> (and ($Is refType |o#0@@16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@16|))) (and (and (and (= (_module.Object.universe |o#0@@16|) |universe#0|) (or (not (= |o#0@@16| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@97 |o#0@@16|)) (_module.Object.triggerAxioms $Heap@@97 |o#0@@16|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1350|
 :pattern ( (_module.Object.triggerAxioms $Heap@@97 |o#0@@16|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@97 |o#0@@16|))
 :pattern ( (_module.Object.universe |o#0@@16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@16|)))
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (forall ((|o#0@@17| T@U) ) (!  (=> (and ($Is refType |o#0@@17| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@17|))) (and (and (and (= (_module.Object.universe |o#0@@17|) |universe#0|) (or (not (= |o#0@@17| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@97 |o#0@@17|)) (_module.Object.triggerAxioms $Heap@@97 |o#0@@17|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1350|
 :pattern ( (_module.Object.triggerAxioms $Heap@@97 |o#0@@17|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@97 |o#0@@17|))
 :pattern ( (_module.Object.universe |o#0@@17|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@17|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (forall ((|o#1@@8| T@U) ) (!  (=> (and ($Is refType |o#1@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@8|))) (and (and (and (= (_module.Object.universe |o#1@@8|) |universe#0|) (or (not (= |o#1@@8| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@1 |o#1@@8|)) (_module.Object.triggerAxioms $Heap@1 |o#1@@8|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@1 |o#1@@8|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@1 |o#1@@8|))
 :pattern ( (_module.Object.universe |o#1@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@8|)))
...
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#2|)))) (not ($IsAllocBox ($Box refType |o#2|) Tclass._module.Object $Heap@@97)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1354|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#2|)))
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@97 $Heap@1 |universe#0|) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|)))) (not ($IsAllocBox ($Box refType |o#2@@0|) Tclass._module.Object $Heap@@97)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1354|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#3|)))) (or (forall (($o@@113 T@U) ($f@@70 T@U) ) (!  (=> (or (not (= $o@@113 null)) (not true)) (=> (= $o@@113 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@113) $f@@70) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@113) $f@@70))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1356|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@113) $f@@70))
)) (_module.Object.sequenceInv2 $Heap@@97 $Heap@1 |o#3|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |1357|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@97 $Heap@1 |o#3|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#3|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))) (or (forall (($o@@114 T@U) ($f@@71 T@U) ) (!  (=> (or (not (= $o@@114 null)) (not true)) (=> (= $o@@114 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@114) $f@@71) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@114) $f@@71))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1356|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@114) $f@@71))
)) (_module.Object.sequenceInv2 $Heap@@97 $Heap@1 |o#3@@0|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |1357|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@97 $Heap@1 |o#3@@0|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#4|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@97)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#4|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |1358|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#4|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4@@0|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@97)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |1358|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |o#4@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#0@@5| T@U) ) (!  (=> (and ($Is refType |l#0@@5| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@5|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#0@@5|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#0@@5|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@97)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@97 $Heap@1 |l#0@@5|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1359|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@97 $Heap@1 |l#0@@5|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#0@@5|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@5|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@97 $Heap@1 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#0@@6| T@U) ) (!  (=> (and ($Is refType |l#0@@6| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@6|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#0@@6|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#0@@6|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@97)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@97 $Heap@1 |l#0@@6|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1359|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@97 $Heap@1 |l#0@@6|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |l#0@@6|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@6|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#5|))) (and (and (and (= (_module.Object.universe |o#5|) |universe#0|) (or (not (= |o#5| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@97 |o#5|)) (_module.Object.triggerAxioms $Heap@@97 |o#5|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1364|
 :pattern ( (_module.Object.triggerAxioms $Heap@@97 |o#5|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@97 |o#5|))
 :pattern ( (_module.Object.universe |o#5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#5|)))
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@97 |universe#0|) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@0|))) (and (and (and (= (_module.Object.universe |o#5@@0|) |universe#0|) (or (not (= |o#5@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@97 |o#5@@0|)) (_module.Object.triggerAxioms $Heap@@97 |o#5@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1364|
 :pattern ( (_module.Object.triggerAxioms $Heap@@97 |o#5@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@97 |o#5@@0|))
 :pattern ( (_module.Object.universe |o#5@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#6|))) (_module.Object.inv $Heap@@97 |o#6|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1366|
 :pattern ( (_module.Object.inv $Heap@@97 |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#6|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@@97 |universe#0|) (or (_module.Universe.globalInv $Heap@@97 |universe#0|) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@0|))) (_module.Object.inv $Heap@@97 |o#6@@0|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1366|
 :pattern ( (_module.Object.inv $Heap@@97 |o#6@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#7|))) (and (or (forall (($o@@115 T@U) ($f@@72 T@U) ) (!  (=> (or (not (= $o@@115 null)) (not true)) (=> (= $o@@115 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@115) $f@@72) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@115) $f@@72))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@115) $f@@72))
)) (_module.Object.inv $Heap@1 |o#7|)) (or (forall (($o@@116 T@U) ($f@@73 T@U) ) (!  (=> (or (not (= $o@@116 null)) (not true)) (=> (= $o@@116 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@116) $f@@73) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@116) $f@@73))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@116) $f@@73))
)) (_module.Object.inv2 $Heap@@97 $Heap@1 |o#7|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |1370|
 :pattern ( (_module.Object.inv2 $Heap@@97 $Heap@1 |o#7|))
 :pattern ( (_module.Object.inv $Heap@1 |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#7|)))
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (or (forall (($o@@117 T@U) ($f@@74 T@U) ) (!  (=> (or (not (= $o@@117 null)) (not true)) (=> (= $o@@117 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@117) $f@@74) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@117) $f@@74))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@117) $f@@74))
)) (_module.Object.inv $Heap@1 |o#7@@0|)) (or (forall (($o@@118 T@U) ($f@@75 T@U) ) (!  (=> (or (not (= $o@@118 null)) (not true)) (=> (= $o@@118 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@118) $f@@75) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 $o@@118) $f@@75))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@118) $f@@75))
)) (_module.Object.inv2 $Heap@@97 $Heap@1 |o#7@@0|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |1370|
 :pattern ( (_module.Object.inv2 $Heap@@97 $Heap@1 |o#7@@0|))
 :pattern ( (_module.Object.inv $Heap@1 |o#7@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@0|)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Universe.legalTransition#canCall| $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@@97 $Heap@1 |universe#0| |running#0@@3|) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#8|))))) (_module.Object.inv $Heap@1 |o#8|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |1371|
 :pattern ( (_module.Object.inv $Heap@1 |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@97 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)))
