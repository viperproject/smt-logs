...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@5 this@@5) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@5) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.OwnedObject) ($IsAlloc refType this@@5 Tclass._module.OwnedObject $Heap@@5)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@5 this@@5) (=> (_module.Object.objectGlobalBaseInv $Heap@@5 this@@5) (|_module.OwnedObject.localUserInv#canCall| $Heap@@5 this@@5))) (= (_module.OwnedObject.localInv $Heap@@5 this@@5)  (and (_module.Object.objectGlobalBaseInv $Heap@@5 this@@5) (_module.OwnedObject.localUserInv $Heap@@5 this@@5)))))
...
(set-info :boogie-vc-id OverrideCheck$$_module.OwnedObject.localInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= OwnedObject_$_ReadsFrame@0 (|lambda#8| null $Heap@@9 alloc $Heap@@9 alloc)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc))))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1536|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (=> (and (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.OwnedObject) ($IsAlloc refType this@@9 Tclass._module.OwnedObject $Heap@@9))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct))))
