...
(assert (forall (($o@@3 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.AtomicCounter? $h@@6)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1647|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.AtomicCounter? $h@@6))
)))
...
(assert (forall (($o@@8 T@U) ) (!  (=> ($Is refType $o@@8 Tclass._module.AtomicCounter?) ($Is refType $o@@8 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3530|
 :pattern ( ($Is refType $o@@8 Tclass._module.AtomicCounter?))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.AtomicCounter.ProveUnchangedNonvolatileUserFields)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@1 Tclass._module.AtomicCounter $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass._module.AtomicCounter $Heap@@0) (=> (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@11 null)) (not true)) (=> (= $o@@11 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@11) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@11) $f@@1))))
 :qid |_07CounterThreadOwnershipdfy.488:65|
 :skolemid |1658|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@11) $f@@1))
)) (=> (and ($IsAllocBox ($Box refType this@@1) Tclass._module.AtomicCounter? current$Heap) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@1 Tclass._module.AtomicCounter $Heap@@0))))))))
