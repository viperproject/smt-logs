...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split171)
...
))))) (= $Heap@21 $Heap@22)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))))) (forall (($o@@154 T@U) ($f@@100 T@U) ) (!  (=> (and (and (or (not (= $o@@154 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 $o@@154) alloc)))) (or (= $o@@154 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 |universe#0|) _module.Universe.content)) ($Box refType $o@@154)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@154 $f@@100)))
