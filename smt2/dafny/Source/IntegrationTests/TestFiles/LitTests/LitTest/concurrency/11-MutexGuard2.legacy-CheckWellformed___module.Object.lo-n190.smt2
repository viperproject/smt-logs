...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@6 this@@6) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Thread) ($IsAlloc refType this@@6 Tclass._module.Thread $Heap@@6)))))) (= (_module.Thread.baseFieldsInv $Heap@@6 this@@6) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.260:19|
 :skolemid |1216|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@6 this@@6) ($IsGoodHeap $Heap@@6))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@7 this@@7) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.OwnedObject) ($IsAlloc refType this@@7 Tclass._module.OwnedObject $Heap@@7)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@7 this@@7) (=> (_module.Object.objectGlobalBaseInv $Heap@@7 this@@7) (|_module.OwnedObject.localUserInv#canCall| $Heap@@7 this@@7))) (= (_module.OwnedObject.localInv $Heap@@7 this@@7)  (and (_module.Object.objectGlobalBaseInv $Heap@@7 this@@7) (_module.OwnedObject.localUserInv $Heap@@7 this@@7)))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#8| null $Heap@@14 alloc $Heap@@14 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Else_correct) (=> (= (ControlFlow 0 6) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
