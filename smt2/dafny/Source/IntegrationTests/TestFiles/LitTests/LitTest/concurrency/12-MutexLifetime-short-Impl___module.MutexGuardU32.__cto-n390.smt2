...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split159)
...
)))))) (and (and ($IsGoodHeap $Heap@12) ($IsHeapAnchor $Heap@12)) (and (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (=> (_module.Universe.globalInv $Heap@11 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@3 $Heap@11 |universe#0|))))))) (and (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (and (_module.Universe.globalInv $Heap@11 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@11 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@11 |o#10|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1024|
...
)))))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.legalTransition#canCall| $Heap@12 $Heap@14 |universe#0| |running#0@@3|)))))) (or (_module.Universe.legalTransition $Heap@12 $Heap@14 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@12 $Heap@14 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@12 $Heap@14 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content))))))))))))
