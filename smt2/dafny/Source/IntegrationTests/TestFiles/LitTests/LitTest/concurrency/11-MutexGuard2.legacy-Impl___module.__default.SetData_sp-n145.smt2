...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split129)
...
)))))))) (and (and (and (and ($IsGoodHeap $Heap@14) ($IsHeapAnchor $Heap@14)) (and (|_module.Universe.globalInv#canCall| $Heap@13 |universe#0|) (=> (_module.Universe.globalInv $Heap@13 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@8 $Heap@13 |universe#0|)))) (and (and (|_module.Universe.globalInv#canCall| $Heap@13 |universe#0|) (and (_module.Universe.globalInv $Heap@13 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@13 |universe#0|) (forall ((|o#10@@2| T@U) ) (!  (=> (and ($Is refType |o#10@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@2|))) (_module.Object.inv $Heap@13 |o#10@@2|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |815|
