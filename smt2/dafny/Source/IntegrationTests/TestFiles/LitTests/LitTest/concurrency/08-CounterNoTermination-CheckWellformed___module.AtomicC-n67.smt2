...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@0 T@U) ($Heap T@U) (this@@0 T@U) ) (!  (=> (or (|_module.AtomicCounter.localUserInv2#canCall| $prevHeap@@0 $Heap this@@0) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@0) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@0 $Heap)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.AtomicCounter) ($IsAlloc refType this@@0 Tclass._module.AtomicCounter $prevHeap@@0)))))) (= (_module.AtomicCounter.localUserInv2 $prevHeap@@0 $Heap this@@0) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@0 this@@0) _module.AtomicCounter.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.AtomicCounter.value))))))
 :qid |_08CounterNoTerminationdfy.306:22|
 :skolemid |1301|
 :pattern ( (_module.AtomicCounter.localUserInv2 $prevHeap@@0 $Heap this@@0) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.AtomicCounter.localUserInv2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType this@@1 Tclass._module.AtomicCounter $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass._module.AtomicCounter $Heap@@0) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.AtomicCounter.value))) (= (_module.AtomicCounter.localUserInv2 $Heap@@0 current$Heap this@@1) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.AtomicCounter.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.AtomicCounter.value)))))) (and ($Is boolType (bool_2_U (_module.AtomicCounter.localUserInv2 $Heap@@0 current$Heap this@@1)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))
