...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split312)
...
)) (= $Heap@36 $Heap@37)) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37) (= |##running#0_0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)))))) (and (and (and ($IsAlloc SetType |##running#0_0@1| (TSet Tclass._module.Thread) $Heap@37) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)) (and ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (TSet Tclass._module.Thread) $Heap@33) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))))))))))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#0_10| T@U) ) (!  (=> (and ($Is refType |o#0_10| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0_10|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_10|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_10|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_10|) _module.OwnedObject.owner) Tclass._module.Object $Heap@33)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_10|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |o#0_10|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.77:16|
 :skolemid |599|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |o#0_10|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_10|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_10|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0_10|)))
)))))))))
anon0_correct))
))
(check-sat)
