...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split184)
...
))))) (and (= (_module.Object.universe this@@222) |universe#0|) (= (ControlFlow 0 2) (- 0 1)))))))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 this@@222) _module.OwnedObject.owner)) |running#0@@3|))))))))
