...
(assert (distinct TagSet alloc allocName Tagclass._module.Universe class._module.Universe? Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? tytagFamily$Universe tytagFamily$Object field$content)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((v@@3 T@U) (t0@@2 T@U) (h@@4 T@U) ) (! (= ($IsAlloc SetType v@@3 (TSet t0@@2) h@@4) (forall ((bx@@5 T@U) ) (!  (=> (|Set#IsMember| v@@3 bx@@5) ($IsAllocBox bx@@5 t0@@2 h@@4))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#11| null $Heap@@1 alloc (_module.Object.universe this@@3))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= (_module.Object.universe this@@3) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@3) null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType (_module.Object.universe this@@3)) Tclass._module.Universe? $Heap@@1) (|_module.Universe.globalBaseInv#canCall| $Heap@@1 (_module.Object.universe this@@3))) (and (_module.Universe.globalBaseInv $Heap@@1 (_module.Object.universe this@@3)) (or (not (= this@@3 (_module.Object.universe this@@3))) (not true)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@10 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@10) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@10)) (= $o@@10 (_module.Object.universe this@@3))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Object) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@1))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 9) 2))) anon0_correct))))
