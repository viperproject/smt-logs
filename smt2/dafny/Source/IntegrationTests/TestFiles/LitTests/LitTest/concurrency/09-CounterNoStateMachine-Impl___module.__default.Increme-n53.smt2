...
))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
