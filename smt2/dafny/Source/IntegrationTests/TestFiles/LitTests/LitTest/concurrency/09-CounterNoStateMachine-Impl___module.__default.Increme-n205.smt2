...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split194)
...
))))) (= (_module.Object.universe call4formal@this@0@@1) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 call4formal@this@0@@1) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 call4formal@this@0@@1) _module.ConstantInteger.value))) |value##0_2@1|))) (and (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@1)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 call4formal@this@0@@1) alloc))))) (and (forall (($o@@157 T@U) ) (!  (=> (and (or (not (= $o@@157 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@157) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@157) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@157)) (= $o@@157 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.608:3|
 :skolemid |2896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@157))
)) ($HeapSucc $Heap@23 $Heap@24))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@23)) (and ($IsGoodHeap $Heap@25) ($IsHeapAnchor $Heap@25))))) (and (and (and (and (forall ((|o#1@@29| T@U) ) (!  (=> ($Is refType |o#1@@29| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@29|)) (=> (=> ($Is refType |o#1@@29| Tclass._module.OwnedObject) (and (forall (($o@@158 T@U) ($f@@102 T@U) ) (!  (=> (or (not (= $o@@158 null)) (not true)) (=> (= $o@@158 |o#1@@29|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@158) $f@@102) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@158) $f@@102))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
