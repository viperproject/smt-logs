...
(set-info :boogie-vc-id CheckWellFormed$$_module.MutexGuardU32.__ctor_split23)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@111 T@U) ) (!  (=> (and (or (not (= $o@@111 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@98 $o@@111) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@98 $o@@111)) (or (= $o@@111 |universe#0|) (or (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@98 |universe#0|) _module.Universe.content)) ($Box refType $o@@111)) (not (and ($Is refType $o@@111 Tclass._module.Lifetime) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@98 |universe#0|) _module.Universe.content)) ($Box refType $o@@111)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@98 $o@@111) _module.Lifetime.owner)) |running#0@@1|))))) (or (= $o@@111 |scope#0|) (= $o@@111 |mutexScope#0|))))))
 :qid |_12MutexLifetimeshortdfy.889:3|
 :skolemid |3405|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111))
)) ($HeapSucc $Heap@@98 $Heap@0))) (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass._module.MutexGuardU32) ($IsAlloc refType this@0 Tclass._module.MutexGuardU32 $Heap@0))) (and ($IsAllocBox ($Box refType this@0) Tclass._module.Object? $Heap@0) (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@0)))) (and (and (and (_module.Object.objectGlobalInv $Heap@0 this@0) (or (not (= |universe#0| null)) (not true))) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@0) (= |##running#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|))))) (and (and ($IsAlloc SetType |##running#0@0| (TSet Tclass._module.Thread) $Heap@0) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@98)) (and ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|)) (TSet Tclass._module.Thread) $Heap@@98) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@98 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|))))))) (and (and (and (and (_module.Universe.legalTransitionsSequence $Heap@@98 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@1|))) (= (_module.Object.universe this@0) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.OwnedObject.owner)) |running#0@@1|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex)) |mutex#0|))) (and (and (or (not (= |mutex#0| null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |mutex#0|) _module.Mutex.data)))) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex)) null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex))) _module.Mutex.locked)))))) (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex)) null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@0) (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true)))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.OwnedObject.lifetime this@0)) _module.Lifetime.mightPointFrom)) |Set#Empty|) (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.OwnedObject.lifetime this@0)) _module.Lifetime.elements)) (|Set#UnionOne| |Set#Empty| ($Box refType this@0))) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= (_module.OwnedObject.lifetime this@0) null)) (not true)))))
