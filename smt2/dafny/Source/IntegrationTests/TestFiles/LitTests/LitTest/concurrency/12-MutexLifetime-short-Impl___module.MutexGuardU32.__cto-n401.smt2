...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split170)
...
))))))))) (and (and (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@@132 $Heap@1 |universe#0|) (and (_module.Universe.globalInv2 $Heap@@132 $Heap@1 |universe#0|) (forall ((|o#11@@2| T@U) ) (!  (=> (and ($Is refType |o#11@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@2|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@2|)) (_module.Object.inv2 $Heap@@132 $Heap@1 |o#11@@2|)))
 :qid |_12MutexLifetimeshortdfy.33:12|
 :skolemid |1026|
 :pattern ( (_module.Object.inv2 $Heap@@132 $Heap@1 |o#11@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@2|)))
