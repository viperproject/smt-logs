...
))))) (and (forall (($o@@90 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@67 $o@@90) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@90) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@67 $o@@90)) (or (= $o@@90 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@67 |universe#0|) _module.Universe.content)) ($Box refType $o@@90)))))
 :qid |_10SequenceInvariantdfy.103:10|
 :skolemid |871|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@90))
)) ($HeapSucc $Heap@@67 $Heap@0))) (and (and (= |i#0@0| (LitInt 0)) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@0) (= (ControlFlow 0 2) (- 0 1))))))) ($IsAlloc refType |running#0@@1| Tclass._module.Thread $Heap@0))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
