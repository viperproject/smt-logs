...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@14 this@@27) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Lifetime) ($IsAlloc refType this@@27 Tclass._module.Lifetime $Heap@@14)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@14 this@@27)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 (_module.Object.universe this@@27)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 (_module.Object.universe this@@27)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 (_module.Object.universe this@@27)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 (_module.Object.universe this@@27)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.563:19|
 :skolemid |1951|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@14 this@@27) ($IsGoodHeap $Heap@@14))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct  (=> (= (_module.Object.objectGlobalBaseInv $Heap@@15 this@@28)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)) ($Box refType this@@28)) (_module.Object.baseFieldsInv $Heap@@15 this@@28)) (_module.Universe.globalBaseInv $Heap@@15 (_module.Object.universe this@@28)))) (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)) ($Box refType this@@28)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@15 this@@28) (=> (_module.Object.baseFieldsInv $Heap@@15 this@@28) (|_module.Universe.globalBaseInv#canCall| $Heap@@15 (_module.Object.universe this@@28))))) ($Is boolType (bool_2_U (_module.Object.objectGlobalBaseInv $Heap@@15 this@@28)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))))
(let ((anon11_Else_correct  (=> (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)) ($Box refType this@@28)) (_module.Object.baseFieldsInv $Heap@@15 this@@28))) (=> (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 8) 3)) anon7_correct))))
(let ((anon11_Then_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)) ($Box refType this@@28)) (_module.Object.baseFieldsInv $Heap@@15 this@@28)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= (_module.Object.universe this@@28) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@28) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@28)) Tclass._module.Universe? $Heap@@15) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@32) alloc)))) (or (= $o@@32 (_module.Object.universe this@@28)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)) ($Box refType $o@@32)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.301:107|
 :skolemid |1350|
))) (|_module.Universe.globalBaseInv#canCall| $Heap@@15 (_module.Object.universe this@@28))) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon7_correct)))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)) ($Box refType this@@28))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 10) 6) anon11_Then_correct) (=> (= (ControlFlow 0 10) 8) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@28)) _module.Universe.content)) ($Box refType this@@28)) (=> (and (and ($IsAllocBox ($Box refType this@@28) Tclass._module.Object? $Heap@@15) (= |b$reqreads#1@0| (forall (($o@@33 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@33) alloc)))) (or (= $o@@33 this@@28) (= $o@@33 (_module.Object.universe this@@28)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@33 $f@@1)))
 :qid |_12MutexLifetimeshortdfy.301:79|
 :skolemid |1349|
)))) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@15 this@@28) (= |b$reqreads#1@1| |b$reqreads#1@0|))) (and (=> (= (ControlFlow 0 9) 6) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct))))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= (_module.Object.universe this@@28) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@28) null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 (_module.Object.universe this@@28) _module.Universe.content))) (and (=> (= (ControlFlow 0 11) 9) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#59| null $Heap@@15 alloc $Heap@@15 alloc)) (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 11) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@15) ($IsHeapAnchor $Heap@@15)) (=> (and (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Object) ($IsAlloc refType this@@28 Tclass._module.Object $Heap@@15))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
