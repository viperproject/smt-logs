...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split151)
...
)))) (and (and (= $Heap@13 $Heap@14) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@12) (= (ControlFlow 0 2) (- 0 1)))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@12))))))
