...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split150)
...
)) (= $Heap@13 $Heap@14)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@12))))))
