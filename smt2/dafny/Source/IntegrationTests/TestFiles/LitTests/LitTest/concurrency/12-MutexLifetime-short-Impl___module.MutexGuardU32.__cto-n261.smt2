...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split30)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@132) ($IsHeapAnchor $Heap@@132)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@132))) (=> (and (and (and (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@132)) (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@132))) (and (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@132)) (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@132)))) (and (and (and (=> |defass#lifetime#0| (and ($Is refType |lifetime#0| Tclass._module.Lifetime) ($IsAlloc refType |lifetime#0| Tclass._module.Lifetime $Heap@@132))) true) (= 23 $FunctionContextHeight)) (and (and (|_module.Universe.globalInv#canCall| $Heap@@132 |universe#0|) (and (_module.Universe.globalInv $Heap@@132 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@132 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@@132 |o#10|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |3436|
...
))))) (and (|_module.Lifetime.unused#canCall| $Heap@@132 |scope#0|) (and (_module.Lifetime.unused $Heap@@132 |scope#0|) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |scope#0|) _module.Lifetime.mightPointFrom)) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |scope#0|) _module.Lifetime.elements)) |Set#Empty|)))))) (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |mutex#0|) _module.Mutex.locked)))) (= $_ModifiesFrame@0 (|lambda#250| null $Heap@@132 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) Tclass._module.Lifetime ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) $Heap@@132 _module.Lifetime.owner |running#0@@3| |scope#0| |mutexScope#0|))) (and (= |mightPointTo##0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |mutexScope#0|))) (forall (($o@@136 T@U) ($f@@78 T@U) ) (!  (=> (and (and (or (not (= $o@@136 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@136) alloc)))) (or (= $o@@136 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@136)) (= $f@@78 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@136 $f@@78)))
...
)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (or (not (= call5formal@this@0 null)) (not true)) (and ($Is refType call5formal@this@0 Tclass._module.Lifetime) ($IsAlloc refType call5formal@this@0 Tclass._module.Lifetime $Heap@0))))) (and (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 call5formal@this@0) (=> (_module.Object.objectGlobalInv $Heap@0 call5formal@this@0) (|_module.Universe.legalTransition#canCall| $Heap@@132 $Heap@0 |universe#0| |running#0@@3|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 call5formal@this@0) (and (_module.Object.objectGlobalInv $Heap@0 call5formal@this@0) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe call5formal@this@0)) _module.Universe.content)) ($Box refType call5formal@this@0)) (_module.Universe.globalInv $Heap@0 (_module.Object.universe call5formal@this@0)))))) (and (and (|_module.Universe.legalTransition#canCall| $Heap@@132 $Heap@0 |universe#0| |running#0@@3|) (and (_module.Universe.legalTransition $Heap@@132 $Heap@0 |universe#0| |running#0@@3|) (and (and (and (_module.Universe.legalTransitionsSequence $Heap@@132 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.globalInv $Heap@@132 |universe#0|)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#11|))) (and (or (forall (($o@@137 T@U) ($f@@79 T@U) ) (!  (=> (or (not (= $o@@137 null)) (not true)) (=> (= $o@@137 |o#11|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@137) $f@@79) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 $o@@137) $f@@79))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |2306|
...
))))) (= (_module.Object.universe call5formal@this@0) |universe#0|)))) (and (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.elements)) |Set#Empty|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.mightPointTo)) |mightPointTo##0@0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.mightPointFrom)) |Set#Empty|))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (forall ((|l#3@@1| T@U) ) (!  (=> (and ($Is refType |l#3@@1| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#3@@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))))
...
))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (=> (_module.Universe.globalInv $Heap@1 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@@132 $Heap@1 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (and (_module.Universe.globalInv $Heap@1 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@1 |o#10@@0|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1024|
...
)))) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 2) (- 0 1)))))))) (U_2_bool (Lit boolType (bool_2_U true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
