...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split8)
...
))) (and ($HeapSucc $Heap@@67 $Heap@0) (= |i#0@0| (LitInt 0)))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@0)) (and ($IsAlloc refType |running#0@@1| Tclass._module.Thread $Heap@0) (= (ControlFlow 0 2) (- 0 1))))))) ($IsAlloc refType |running#0@@1| Tclass._module.Thread $Heap@0))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
