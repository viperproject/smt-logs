...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split366)
...
))))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|))))))))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
