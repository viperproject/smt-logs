...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split116)
...
)))))))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.legalTransition#canCall| $Heap@8 $Heap@13 |universe#0| |running#0@@3|))))))) (or (_module.Universe.legalTransition $Heap@8 $Heap@13 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@8 $Heap@13 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@8 $Heap@13 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@8 $Heap@13 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)))))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
