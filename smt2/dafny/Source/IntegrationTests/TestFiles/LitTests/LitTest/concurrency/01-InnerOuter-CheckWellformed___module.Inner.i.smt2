...
(assert (distinct TBool TagBool TagSet alloc allocName Tagclass._System.object? Tagclass._System.object class._module.S? Tagclass._module.S? Tagclass._module.O Tagclass._module.S Tagclass._module.O? Tagclass._module.Inner? Tagclass._module.Inner tytagFamily$object tytagFamily$S tytagFamily$O tytagFamily$Inner field$obs)
)
...
(assert  (=> (< 1 $FunctionContextHeight) (forall (($h@@8 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@5 null)) (not true)) ($Is refType $o@@5 Tclass._module.O?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@5) alloc)))) ($IsAlloc refType (_module.O.s $o@@5) Tclass._module.S $h@@8))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |619|
 :pattern ( (_module.O.s $o@@5) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@5) alloc)))
))))
(assert  (=> (< 1 $FunctionContextHeight) (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) ($Is refType $o@@6 Tclass._module.O?)) ($Is refType (_module.O.s $o@@6) Tclass._module.S))
 :qid |unknown.0:0|
 :skolemid |618|
 :pattern ( (_module.O.s $o@@6))
))))
...
(assert (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 Tclass._module.Inner?) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) Tclass._module.Inner?)))
 :qid |unknown.0:0|
 :skolemid |699|
 :pattern ( ($IsBox bx@@7 Tclass._module.Inner?))
)))
...
(assert (forall (($o@@9 T@U) ) (!  (=> ($Is refType $o@@9 Tclass._module.Inner?) ($Is refType $o@@9 Tclass._module.O?))
 :qid |unknown.0:0|
 :skolemid |957|
 :pattern ( ($Is refType $o@@9 Tclass._module.Inner?))
)))
...
(assert (forall (($h@@9 T@U) ($o@@12 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@12 null)) (not true)) ($Is refType $o@@12 Tclass._module.S?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@12) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@12) _module.S.obs)) (TSet Tclass._module.O) $h@@9))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |484|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@12) _module.S.obs)))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@5 T@U) (|o#0@@5| T@U) ) (!  (=> (or (|_module.S.upCast#canCall| this@@5 (Lit refType |o#0@@5|)) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.S)) ($Is refType |o#0@@5| Tclass._System.object)))) (= (_module.S.upCast this@@5 (Lit refType |o#0@@5|)) (Lit refType |o#0@@5|)))
 :qid |_01InnerOuterdfy.12:18|
 :weight 3
 :skolemid |490|
 :pattern ( (_module.S.upCast this@@5 (Lit refType |o#0@@5|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Inner.i#canCall| $Heap@@2 this@@6) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Inner) ($IsAlloc refType this@@6 Tclass._module.Inner $Heap@@2)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.O.i0#canCall| $Heap@@2 this@@6)) (= (_module.Inner.i $Heap@@2 this@@6)  (and true (_module.O.i0 $Heap@@2 this@@6)))))
 :qid |_01InnerOuterdfy.80:19|
 :skolemid |709|
 :pattern ( (_module.Inner.i $Heap@@2 this@@6) ($IsGoodHeap $Heap@@2))
))))
(assert (forall (($h@@10 T@U) ($o@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@13 null)) (not true)) ($Is refType $o@@13 Tclass._module.S?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@13) _module.S.obs)) (TSet Tclass._module.O)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |483|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@13) _module.S.obs)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Inner.i)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_correct  (=> (and (and (= (_module.Inner.i $Heap@@3 this@@7)  (and true (_module.O.i0 $Heap@@3 this@@7))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.O.i0#canCall| $Heap@@3 this@@7))) (and ($Is boolType (bool_2_U (_module.Inner.i $Heap@@3 this@@7)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@1|)))
(let ((anon8_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 5) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@7) Tclass._module.O? $Heap@@3)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@14) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@14) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@0)))
 :qid |_01InnerOuterdfy.81:8|
 :skolemid |711|
))) (|_module.O.i0#canCall| $Heap@@3 this@@7)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3))) anon5_correct))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Inner) ($IsAlloc refType this@@7 Tclass._module.Inner $Heap@@3))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
