...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split37)
...
)) (= $Heap@2 $Heap@3)) (and (or (not (= |mutex#0| null)) (not true)) (= this.data@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |mutex#0|) _module.Mutex.data))))))) (and (and (and (and (or (not (= this@@222 null)) (not true)) ($Is refType this@@222 Tclass._module.MutexGuardU32?)) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@222) alloc)))) (= (_module.OwnedObject.lifetime this@@222) call5formal@this@0))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@222) _module.OwnedObject.nonvolatileVersion))) this.nonvolatileVersion) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@222) _module.OwnedObject.owner)) |running#0@@3|)) (and (= (_module.Object.universe this@@222) |universe#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@222) _module.MutexGuardU32.mutex)) |mutex#0|)))) (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@222) _module.MutexGuardU32.data)) this.data@0) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@222 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@222) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))) (and (and (forall (($o@@144 T@U) ($f@@85 T@U) ) (!  (=> (and (and (or (not (= $o@@144 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@144) alloc)))) (= $o@@144 (_module.Object.universe this@@222))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@144 $f@@85)))
 :qid |_12MutexLifetimeshortdfy.924:9|
 :skolemid |3464|
)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@222)))))))) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@222)) (U_2_bool (Lit boolType (bool_2_U true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
