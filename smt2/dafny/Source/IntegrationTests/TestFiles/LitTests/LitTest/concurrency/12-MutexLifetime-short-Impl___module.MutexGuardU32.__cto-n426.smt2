...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split195)
...
))))) (and (and (and (= $Heap@10 $Heap@11) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11)) (and (= |##a#2@0| (_module.OwnedObject.lifetime |mutex#0|)) ($IsAlloc refType |##a#2@0| Tclass._module.Lifetime $Heap@11))) (and (and ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@11) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|)) (and (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (= (ControlFlow 0 2) (- 0 1))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
