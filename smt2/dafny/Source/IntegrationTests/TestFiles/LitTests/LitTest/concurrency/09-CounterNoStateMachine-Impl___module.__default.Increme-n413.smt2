...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split402)
...
)))))))) (and (and (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (and (|_module.Universe.globalInv#canCall| $Heap@6 |universe#0|) (=> (_module.Universe.globalInv $Heap@6 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@5 $Heap@6 |universe#0|)))) (and (and (|_module.Universe.globalInv#canCall| $Heap@6 |universe#0|) (and (_module.Universe.globalInv $Heap@6 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@6 |universe#0|) (forall ((|o#17@@2| T@U) ) (!  (=> (and ($Is refType |o#17@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@2|))) (_module.Object.inv $Heap@6 |o#17@@2|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))))) (and (and (and (= $Heap@6 $Heap@7) (or (not (= |universe#0| null)) (not true))) (and (forall (($o@@130 T@U) ($f@@80 T@U) ) (!  (=> (and (and (or (not (= $o@@130 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@130) alloc)))) (or (= $o@@130 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType $o@@130)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@130 $f@@80)))
