...
)) ($HeapSucc $Heap@16 $Heap@17)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@16))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
