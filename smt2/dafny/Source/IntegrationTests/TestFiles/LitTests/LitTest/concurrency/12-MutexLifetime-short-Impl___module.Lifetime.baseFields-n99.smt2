...
(assert (forall (($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.Lifetime))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@19 T@U) ($f T@U) )  (=> (and (or (not (= $o@@19 null)) (not true)) (or (= $o@@19 this) (= $o@@19 (_module.Object.universe this)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@19) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@19) $f)))) (= (_module.Lifetime.baseFieldsInv $h0 this) (_module.Lifetime.baseFieldsInv $h1 this))))
