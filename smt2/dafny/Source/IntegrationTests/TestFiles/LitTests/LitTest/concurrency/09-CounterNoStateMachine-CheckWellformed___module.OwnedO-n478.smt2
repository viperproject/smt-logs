...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@3 this@@3) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Object) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@3)))))) (= (_module.Object.triggerAxioms $Heap@@3 this@@3)  (and (or ($Is refType this@@3 Tclass._module.OwnedObject) ($Is refType this@@3 Tclass._module.Thread)) (not (and ($Is refType this@@3 Tclass._module.OwnedObject) ($Is refType this@@3 Tclass._module.Thread))))))
 :qid |_09CounterNoStateMachinedfy.269:19|
 :skolemid |1311|
 :pattern ( (_module.Object.triggerAxioms $Heap@@3 this@@3) ($IsGoodHeap $Heap@@3))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon9_correct  (=> (= (_module.OwnedObject.localInv $Heap@@4 this@@4)  (and (and (and (_module.Object.baseInv $Heap@@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.OwnedObject.owner))) (_module.OwnedObject.baseUserInv $Heap@@4 this@@4)) (_module.OwnedObject.localUserInv $Heap@@4 this@@4))) (=> (and (and (|_module.Object.baseInv#canCall| $Heap@@4 this@@4) (=> (_module.Object.baseInv $Heap@@4 this@@4) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.OwnedObject.owner)) (and (|_module.OwnedObject.baseUserInv#canCall| $Heap@@4 this@@4) (=> (_module.OwnedObject.baseUserInv $Heap@@4 this@@4) (|_module.OwnedObject.localUserInv#canCall| $Heap@@4 this@@4)))))) ($Is boolType (bool_2_U (_module.OwnedObject.localInv $Heap@@4 this@@4)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 7)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 6)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#4@1|)))))))))))))
(let ((anon14_Else_correct  (=> (not (and (and (_module.Object.baseInv $Heap@@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.OwnedObject.owner))) (_module.OwnedObject.baseUserInv $Heap@@4 this@@4))) (=> (and (= |b$reqreads#4@1| true) (= (ControlFlow 0 9) 3)) anon9_correct))))
(let ((anon14_Then_correct  (=> (and (and (and (and (_module.Object.baseInv $Heap@@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.OwnedObject.owner))) (_module.OwnedObject.baseUserInv $Heap@@4 this@@4)) ($IsAllocBox ($Box refType this@@4) Tclass._module.OwnedObject? $Heap@@4)) (and (and (= |b$reqreads#4@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_09CounterNoStateMachinedfy.354:8|
 :skolemid |1712|
))) (|_module.OwnedObject.localUserInv#canCall| $Heap@@4 this@@4)) (and (= |b$reqreads#4@1| |b$reqreads#4@0|) (= (ControlFlow 0 8) 3)))) anon9_correct)))
(let ((anon13_Else_correct  (=> (and (not (and (_module.Object.baseInv $Heap@@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.OwnedObject.owner)))) (= |b$reqreads#3@1| true)) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 9) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (and (_module.Object.baseInv $Heap@@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.OwnedObject.owner))) (=> (and (and ($IsAllocBox ($Box refType this@@4) Tclass._module.OwnedObject? $Heap@@4) (= |b$reqreads#3@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@19) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@19) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_09CounterNoStateMachinedfy.353:8|
 :skolemid |1711|
)))) (and (|_module.OwnedObject.baseUserInv#canCall| $Heap@@4 this@@4) (= |b$reqreads#3@1| |b$reqreads#3@0|))) (and (=> (= (ControlFlow 0 10) 8) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct))))))
(let ((anon12_Else_correct  (=> (not (_module.Object.baseInv $Heap@@4 this@@4)) (=> (and (= |b$reqreads#1@1| true) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 14) 10) anon13_Then_correct) (=> (= (ControlFlow 0 14) 11) anon13_Else_correct))))))
(let ((anon12_Then_correct  (=> (and (_module.Object.baseInv $Heap@@4 this@@4) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@4 _module.OwnedObject.owner)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= (_module.Object.universe this@@4) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@4) null)) (not true)) (=> (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 (_module.Object.universe this@@4) _module.Universe.content))) (=> (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (=> (= (ControlFlow 0 12) 10) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))))))
(let ((anon11_Else_correct  (=> ($IsAllocBox ($Box refType this@@4) Tclass._module.Object? $Heap@@4) (=> (and (= |b$reqreads#0@0| (forall (($o@@20 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@20) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@20) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@20 $f@@2)))
 :qid |_09CounterNoStateMachinedfy.351:8|
 :skolemid |1710|
))) (|_module.Object.baseInv#canCall| $Heap@@4 this@@4)) (and (=> (= (ControlFlow 0 15) 12) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct))))))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@4 alloc $Heap@@4 alloc)) (and (=> (= (ControlFlow 0 16) 1) anon11_Then_correct) (=> (= (ControlFlow 0 16) 15) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.OwnedObject) ($IsAlloc refType this@@4 Tclass._module.OwnedObject $Heap@@4))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
