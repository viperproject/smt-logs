...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@69 T@U) ($f@@33 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@69 $f@@33))  (=> (and (or (not (= $o@@69 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@69) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3540|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@69 $f@@33))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.IncrementerMethod.Statement10)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@78 alloc false)) ($IsAllocBox ($Box refType this@@126) Tclass._module.Object? $Heap@@78)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@@78 this@@126) (_module.Object.objectGlobalInv $Heap@@78 this@@126))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@103 T@U) ) (!  (=> (and (or (not (= $o@@103 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@103) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@103) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@103)))
 :qid |_07CounterThreadOwnershipdfy.937:10|
 :skolemid |3420|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@103))
))) (and (and ($HeapSucc $Heap@@78 $Heap@0) ($IsAllocBox ($Box refType this@@126) Tclass._module.Object? $Heap@0)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (_module.Object.objectGlobalInv $Heap@0 this@@126)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@126)) Tclass._module.Universe? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78)) (=> ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78) (=> (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@0 (_module.Object.universe this@@126)) (=> (and (_module.Universe.globalInv2 $Heap@@78 $Heap@0 (_module.Object.universe this@@126)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 10))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> (and ($IsAllocBox ($Box refType (_module.Object.universe this@@126)) Tclass._module.Universe? $Heap@0) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78)) (=> ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@78))))))))))))))))))))))
