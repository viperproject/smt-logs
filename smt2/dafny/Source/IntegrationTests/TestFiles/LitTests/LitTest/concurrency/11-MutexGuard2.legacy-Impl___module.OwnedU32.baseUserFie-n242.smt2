...
(set-info :boogie-vc-id Impl$$_module.OwnedU32.baseUserFieldsInvMonotonicity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#22| null current$Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.OwnedU32.baseUserFieldsInv#canCall| current$Heap this@@1)) (or (_module.OwnedU32.baseUserFieldsInv current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.OwnedU32) ($IsAlloc refType this@@1 Tclass._module.OwnedU32 previous$Heap))) (= 3 $FunctionContextHeight)) (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and (and (|_module.OwnedU32.baseUserFieldsInv#canCall| previous$Heap this@@1) (and (_module.OwnedU32.baseUserFieldsInv previous$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))) (and (forall (($o@@17 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@17 null)) (not true)) (=> (= $o@@17 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@17) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@17) $f@@1))))
 :qid |_11MutexGuard2legacydfy.441:132|
 :skolemid |1654|
