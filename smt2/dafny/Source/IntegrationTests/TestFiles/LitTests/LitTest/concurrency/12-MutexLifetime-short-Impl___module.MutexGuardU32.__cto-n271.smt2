...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split40)
...
))))) (and (_module.Object.baseFieldsInv $Heap@4 this@@222) (= (ControlFlow 0 2) (- 0 1)))))))) (or (not (= this@@222 (_module.Object.universe this@@222))) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
