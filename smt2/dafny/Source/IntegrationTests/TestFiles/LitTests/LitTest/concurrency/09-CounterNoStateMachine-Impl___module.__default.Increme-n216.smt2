...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split205)
...
))))) (= $Heap@25 $Heap@26)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))))) (forall (($o@@163 T@U) ($f@@107 T@U) ) (!  (=> (and (and (or (not (= $o@@163 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@26 $o@@163) alloc)))) (or (= $o@@163 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@26 |universe#0|) _module.Universe.content)) ($Box refType $o@@163)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@163 $f@@107)))
