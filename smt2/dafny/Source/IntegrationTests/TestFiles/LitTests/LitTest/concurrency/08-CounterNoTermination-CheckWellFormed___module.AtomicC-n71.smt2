...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@73) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@3| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@73 Tclass._module.AtomicCounter $Heap@@43)) (=> ($IsAlloc refType this@@73 Tclass._module.AtomicCounter $Heap@@43) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@43)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@43) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@43 current$Heap this@@73 |running#0@@3|) (_module.Object.goodPreAndLegalChanges $Heap@@43 current$Heap this@@73 |running#0@@3|)) (and ($IsAllocBox ($Box refType this@@73) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@73 Tclass._module.AtomicCounter $Heap@@43))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@43) ($IsHeapAnchor $Heap@@43)) (and (or (not (= this@@73 null)) (not true)) (and ($Is refType this@@73 Tclass._module.AtomicCounter) ($IsAlloc refType this@@73 Tclass._module.AtomicCounter previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@43) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
