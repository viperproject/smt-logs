...
))) (and (and ($HeapSucc $Heap@29 $Heap@30) (= |i#0@2| (+ |i#0@1| 1))) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@30))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
