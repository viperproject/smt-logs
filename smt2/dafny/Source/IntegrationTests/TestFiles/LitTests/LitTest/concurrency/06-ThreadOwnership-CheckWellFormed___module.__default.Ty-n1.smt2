...
(assert (distinct TagSet alloc allocName Tagclass._module.Universe Tagclass._module.NonOwnedObject Tagclass._module.OwnedObject class._module.Universe? Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.NonOwnedObject? Tagclass._module.OwnedObject? tytagFamily$Universe tytagFamily$NonOwnedObject tytagFamily$OwnedObject tytagFamily$Object field$content)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($o T@U) ($h@@5 T@U) ) (! (= ($IsAlloc refType $o Tclass._module.Universe? $h@@5)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($IsAlloc refType $o Tclass._module.Universe? $h@@5))
)))
(assert (forall (($o@@0 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass._module.Object? $h@@6)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |731|
 :pattern ( ($IsAlloc refType $o@@0 Tclass._module.Object? $h@@6))
)))
(assert (forall (($o@@1 T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.NonOwnedObject? $h@@7)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |856|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.NonOwnedObject? $h@@7))
)))
(assert (forall (($o@@2 T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.OwnedObject? $h@@8)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |867|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.OwnedObject? $h@@8))
)))
...
(assert (forall (($o@@3 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@3 Tclass._module.NonOwnedObject? $heap) ($IsAlloc refType $o@@3 Tclass._module.Object? $heap))
 :qid |unknown.0:0|
 :skolemid |2063|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.NonOwnedObject? $heap))
)))
(assert (forall (($o@@4 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@4 Tclass._module.OwnedObject? $heap@@0) ($IsAlloc refType $o@@4 Tclass._module.Object? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |2067|
 :pattern ( ($IsAlloc refType $o@@4 Tclass._module.OwnedObject? $heap@@0))
)))
...
(assert (forall (($o@@10 T@U) ) (! (= ($Is refType $o@@10 Tclass._module.NonOwnedObject?)  (or (= $o@@10 null) (implements$_module.NonOwnedObject (dtype $o@@10))))
 :qid |unknown.0:0|
 :skolemid |855|
 :pattern ( ($Is refType $o@@10 Tclass._module.NonOwnedObject?))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TypingAxiom2)
...
(let ((anon5_Else_correct  (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|)) (or (not (= |a#0| |b#0@0|)) (not true))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|)) (=> (and (or (not (= |a#0| |b#0@0|)) (not true)) (= (ControlFlow 0 2) 1)) anon4_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($Is refType |b#0@0| Tclass._module.OwnedObject) ($IsAlloc refType |b#0@0| Tclass._module.OwnedObject $Heap@0))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap))) (and (and ($Is refType |a#0| Tclass._module.NonOwnedObject) ($IsAlloc refType |a#0| Tclass._module.NonOwnedObject $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
