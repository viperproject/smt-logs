...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.invB)
...
(assert (not
 ...
 :qid |_04LeastGreatestdfy.80:3|
 :skolemid |727|
))))) (and (and (|_module.__default.invA#canCall| $Heap@@13 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |self#0@@13|) _module.TraitB.a))) (= (_module.__default.invB ($LS $LZ) $Heap@@13 |self#0@@13|) (_module.__default.invA ($LS $LZ) $Heap@@13 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |self#0@@13|) _module.TraitB.a))))) (and (|_module.__default.invA#canCall| $Heap@@13 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |self#0@@13|) _module.TraitB.a))) ($Is boolType (bool_2_U (_module.__default.invB ($LS $LZ) $Heap@@13 |self#0@@13|)) TBool)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@0|))))))))
