...
(assert (distinct TBool TagBool TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Thread Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? class._module.Universe? Tagclass._module.Thread? class._module.OwnedObject? tytagFamily$Universe tytagFamily$Thread tytagFamily$Object tytagFamily$OwnedObject field$content field$owner)
)
(assert (= (FDim alloc) 0))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@4 this@@4) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.OwnedObject) ($IsAlloc refType this@@4 Tclass._module.OwnedObject $Heap@@4)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@4 this@@4) (=> (_module.Object.objectGlobalBaseInv $Heap@@4 this@@4) (|_module.OwnedObject.localUserInv#canCall| $Heap@@4 this@@4))) (= (_module.OwnedObject.localInv $Heap@@4 this@@4)  (and (_module.Object.objectGlobalBaseInv $Heap@@4 this@@4) (_module.OwnedObject.localUserInv $Heap@@4 this@@4)))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@5 this@@5) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@5) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.Universe) ($IsAlloc refType this@@5 Tclass._module.Universe $Heap@@5)))))) (and (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Universe.content)) ($Box refType |o#0|)) (=> (= (_module.Object.universe |o#0|) this@@5) (=> (or (not (= |o#0| this@@5)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@5 |o#0|) (=> (_module.Object.baseFieldsInv $Heap@@5 |o#0|) (|_module.Object.triggerAxioms#canCall| $Heap@@5 |o#0|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@5 |o#0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@5 |o#0|))
 :pattern ( (_module.Object.universe |o#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Universe.content)) ($Box refType |o#0|)))
)) (= (_module.Universe.globalBaseInv $Heap@@5 this@@5) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Universe.content)) ($Box refType |o#0@@0|))) (and (and (and (= (_module.Object.universe |o#0@@0|) this@@5) (or (not (= |o#0@@0| this@@5)) (not true))) (_module.Object.baseFieldsInv $Heap@@5 |o#0@@0|)) (_module.Object.triggerAxioms $Heap@@5 |o#0@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 :pattern ( (_module.Object.triggerAxioms $Heap@@5 |o#0@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@5 |o#0@@0|))
 :pattern ( (_module.Object.universe |o#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@5) _module.Universe.content)) ($Box refType |o#0@@0|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@5 this@@5) ($IsGoodHeap $Heap@@5))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@6 this@@6) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Object) ($IsAlloc refType this@@6 Tclass._module.Object $Heap@@6)))))) (_module.Object.triggerAxioms $Heap@@6 this@@6))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1064|
 :pattern ( (_module.Object.triggerAxioms $Heap@@6 this@@6))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@7 this@@7) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.OwnedObject) ($IsAlloc refType this@@7 Tclass._module.OwnedObject $Heap@@7)))))) (=> (_module.OwnedObject.localInv $Heap@@7 this@@7) (_module.Object.objectGlobalBaseInv $Heap@@7 this@@7)))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1458|
 :pattern ( (_module.OwnedObject.localInv $Heap@@7 this@@7))
))))
...
(let ((anon8_correct  (=> (= (_module.OwnedObject.localInv $Heap@@9 this@@9)  (and (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (_module.OwnedObject.localUserInv $Heap@@9 this@@9))) (=> (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (=> (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (|_module.OwnedObject.localUserInv#canCall| $Heap@@9 this@@9))) ($Is boolType (bool_2_U (_module.OwnedObject.localInv $Heap@@9 this@@9)) TBool)) (and (=> (= (ControlFlow 0 9) (- 0 11)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 9) (- 0 10)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 9) 6) GeneratedUnifiedExit_correct)))))))))
(let ((anon12_Else_correct  (=> (not (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9)) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 13) 9)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) ($IsAllocBox ($Box refType this@@9) Tclass._module.OwnedObject? $Heap@@9)) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_10SequenceInvariantdfy.327:8|
 :skolemid |1465|
))) (|_module.OwnedObject.localUserInv#canCall| $Heap@@9 this@@9)) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 12) 9))) anon8_correct))))
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@9) Tclass._module.Object? $Heap@@9) (=> (and (= |b$reqreads#0@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@19) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@19) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_10SequenceInvariantdfy.326:8|
 :skolemid |1464|
))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9)) (and (=> (= (ControlFlow 0 14) 12) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct))))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (and (=> (_module.OwnedObject.localInv $Heap@@9 this@@9) (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon11_Then_correct  (=> ($IsAllocBox ($Box refType this@@9) Tclass._module.OwnedObject? $Heap@@9) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@9 this@@9) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@9 this@@9) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@9 this@@9) (|_module.OwnedObject.localInv#canCall| $Heap@@9 this@@9)) (_module.OwnedObject.localInv $Heap@@9 this@@9)) (=> (and (and ($IsAllocBox ($Box refType this@@9) Tclass._module.Object? $Heap@@9) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9)) (and (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@9 alloc $Heap@@9 alloc)) (and (and (=> (= (ControlFlow 0 15) 14) anon10_Else_correct) (=> (= (ControlFlow 0 15) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 15) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (=> (and (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.OwnedObject) ($IsAlloc refType this@@9 Tclass._module.OwnedObject $Heap@@9))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
