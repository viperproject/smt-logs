...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split380)
...
)))) (and (and (= $Heap@5 $Heap@6) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@5) (= (ControlFlow 0 2) (- 0 1)))))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@5))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
