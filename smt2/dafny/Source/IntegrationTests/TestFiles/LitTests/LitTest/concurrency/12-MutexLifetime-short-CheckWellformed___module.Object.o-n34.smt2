...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@25 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@25 this@@28) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@25) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Thread) ($IsAlloc refType this@@28 Tclass._module.Thread $Heap@@25)))))) (=> (_module.Thread.localInv $Heap@@25 this@@28) (_module.Object.objectGlobalBaseInv $Heap@@25 this@@28)))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1518|
 :pattern ( (_module.Thread.localInv $Heap@@25 this@@28))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@26 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@26 this@@29) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@26) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Lifetime) ($IsAlloc refType this@@29 Tclass._module.Lifetime $Heap@@26)))))) (=> (_module.Lifetime.localInv $Heap@@26 this@@29) (_module.Object.objectGlobalBaseInv $Heap@@26 this@@29)))
 :qid |_12MutexLifetimeshortdfy.578:19|
 :skolemid |1968|
 :pattern ( (_module.Lifetime.localInv $Heap@@26 this@@29))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@27 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@27 this@@30) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@27) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Thread) ($IsAlloc refType this@@30 Tclass._module.Thread $Heap@@27)))))) (=> (_module.Thread.inv $Heap@@27 this@@30) (_module.Thread.localInv $Heap@@27 this@@30)))
 :qid |_12MutexLifetimeshortdfy.371:19|
 :skolemid |1530|
 :pattern ( (_module.Thread.inv $Heap@@27 this@@30))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@28 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@28 this@@31) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@28) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Lifetime) ($IsAlloc refType this@@31 Tclass._module.Lifetime $Heap@@28)))))) (=> (_module.Lifetime.inv $Heap@@28 this@@31) (_module.Lifetime.localInv $Heap@@28 this@@31)))
 :qid |_12MutexLifetimeshortdfy.588:19|
 :skolemid |2035|
 :pattern ( (_module.Lifetime.inv $Heap@@28 this@@31))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@29 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@29 this@@32) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.OwnedObject) ($IsAlloc refType this@@32 Tclass._module.OwnedObject $Heap@@29)))))) (=> (_module.OwnedObject.localInv $Heap@@29 this@@32) (_module.Object.objectGlobalBaseInv $Heap@@29 this@@32)))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localInv $Heap@@29 this@@32))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@30 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@30 this@@33) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@30) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.Object) ($IsAlloc refType this@@33 Tclass._module.Object $Heap@@30)))))) (=> (_module.Object.localInv $Heap@@30 this@@33) (_module.Object.objectGlobalBaseInv $Heap@@30 this@@33)))
 :qid |_12MutexLifetimeshortdfy.350:19|
 :skolemid |1428|
 :pattern ( (_module.Object.localInv $Heap@@30 this@@33))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@31 T@U) (this@@34 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@31 this@@34) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@31) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.OwnedObject) ($IsAlloc refType this@@34 Tclass._module.OwnedObject $Heap@@31)))))) (=> (_module.OwnedObject.userInv $Heap@@31 this@@34) (_module.OwnedObject.localUserInv $Heap@@31 this@@34)))
 :qid |_12MutexLifetimeshortdfy.522:19|
 :skolemid |1893|
 :pattern ( (_module.OwnedObject.userInv $Heap@@31 this@@34))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@32 T@U) (this@@35 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@32 this@@35) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@32) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.OwnedObject) ($IsAlloc refType this@@35 Tclass._module.OwnedObject $Heap@@32)))))) (=> (_module.OwnedObject.inv $Heap@@32 this@@35) (_module.OwnedObject.localInv $Heap@@32 this@@35)))
 :qid |_12MutexLifetimeshortdfy.448:19|
 :skolemid |1813|
 :pattern ( (_module.OwnedObject.inv $Heap@@32 this@@35))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($Heap@@33 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@33 this@@36) (and (< 15 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@33) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Object) ($IsAlloc refType this@@36 Tclass._module.Object $Heap@@33)))))) (=> (_module.Object.inv $Heap@@33 this@@36) (_module.Object.localInv $Heap@@33 this@@36)))
 :qid |_12MutexLifetimeshortdfy.352:19|
 :skolemid |1438|
 :pattern ( (_module.Object.inv $Heap@@33 this@@36))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@40 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@34 this@@40) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.Lifetime) ($IsAlloc refType this@@40 Tclass._module.Lifetime $Heap@@34)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@34 this@@40) (=> (_module.Object.objectGlobalBaseInv $Heap@@34 this@@40) (=> (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#0@@3|))) (= (_module.OwnedObject.lifetime |o#0@@3|) this@@40))
 :qid |_12MutexLifetimeshortdfy.580:16|
 :skolemid |1983|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#0@@3|)))
)) (and (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#1|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@34 |o#1|) (|_module.Lifetime.alive#canCall| $Heap@@34 this@@40))))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1976|
 :pattern ( (_module.OwnedObject.alive $Heap@@34 |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#1|)))
)) (=> (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#1@@0|))) (= (_module.OwnedObject.alive $Heap@@34 |o#1@@0|) (_module.Lifetime.alive $Heap@@34 this@@40)))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1982|
 :pattern ( (_module.OwnedObject.alive $Heap@@34 |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#1@@0|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@34 this@@40) (=> (_module.Lifetime.alive $Heap@@34 this@@40) (forall ((|l#0@@0| T@U) ) (!  (=> ($Is refType |l#0@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@34 |l#0@@0|)))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1977|
 :pattern ( (_module.Lifetime.alive $Heap@@34 |l#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@34 this@@40) (forall ((|l#0@@1| T@U) ) (!  (=> (and ($Is refType |l#0@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|))) (_module.Lifetime.alive $Heap@@34 |l#0@@1|))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1981|
 :pattern ( (_module.Lifetime.alive $Heap@@34 |l#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@34 this@@40) (=> (not (_module.Lifetime.alive $Heap@@34 this@@40)) (forall ((|l#1@@0| T@U) ) (!  (=> ($Is refType |l#1@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@34 |l#1@@0|)))
 :qid |_12MutexLifetimeshortdfy.584:29|
 :skolemid |1978|
 :pattern ( (_module.Lifetime.alive $Heap@@34 |l#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@34 this@@40)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@34 this@@40) (forall ((|o#0@@4| T@U) ) (!  (=> (and ($Is refType |o#0@@4| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#0@@4|))) (= (_module.OwnedObject.lifetime |o#0@@4|) this@@40))
 :qid |_12MutexLifetimeshortdfy.580:16|
 :skolemid |1970|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#0@@4|)))
))) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#1@@1|))) (= (_module.OwnedObject.alive $Heap@@34 |o#1@@1|) (_module.Lifetime.alive $Heap@@34 this@@40)))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1971|
 :pattern ( (_module.OwnedObject.alive $Heap@@34 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.elements)) ($Box refType |o#1@@1|)))
))) (=> (_module.Lifetime.alive $Heap@@34 this@@40) (forall ((|l#0@@2| T@U) ) (!  (=> (and ($Is refType |l#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|))) (_module.Lifetime.alive $Heap@@34 |l#0@@2|))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1972|
 :pattern ( (_module.Lifetime.alive $Heap@@34 |l#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@34 this@@40)) (forall ((|l#1@@1| T@U) ) (!  (=> (and ($Is refType |l#1@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|))) (not (_module.Lifetime.alive $Heap@@34 |l#1@@1|)))
 :qid |_12MutexLifetimeshortdfy.584:29|
 :skolemid |1973|
 :pattern ( (_module.Lifetime.alive $Heap@@34 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
)))) (forall ((|l#2@@0| T@U) ) (!  (=> (and ($Is refType |l#2@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 |l#2@@0|) _module.Lifetime.mightPointFrom)) ($Box refType this@@40)))
 :qid |_12MutexLifetimeshortdfy.585:16|
 :skolemid |1974|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 |l#2@@0|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@40)))
 :qid |_12MutexLifetimeshortdfy.586:16|
 :skolemid |1975|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 |l#3@@0|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@40) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimeshortdfy.578:19|
 :skolemid |1984|
 :pattern ( (_module.Lifetime.localInv $Heap@@34 this@@40) ($IsGoodHeap $Heap@@34))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@35 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@35 this@@48) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@35) (and (or (not (= this@@48 null)) (not true)) (and ($Is refType this@@48 Tclass._module.Thread) ($IsAlloc refType this@@48 Tclass._module.Thread $Heap@@35)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@35 this@@48)) (= (_module.Thread.localInv $Heap@@35 this@@48)  (and true (_module.Object.objectGlobalBaseInv $Heap@@35 this@@48)))))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1520|
 :pattern ( (_module.Thread.localInv $Heap@@35 this@@48) ($IsGoodHeap $Heap@@35))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@36 T@U) (this@@49 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@36 this@@49) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@36) (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.Thread) ($IsAlloc refType this@@49 Tclass._module.Thread $Heap@@36)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@36 this@@49)) (= (_module.Thread.inv $Heap@@36 this@@49)  (and true (_module.Thread.localInv $Heap@@36 this@@49)))))
 :qid |_12MutexLifetimeshortdfy.371:19|
 :skolemid |1532|
 :pattern ( (_module.Thread.inv $Heap@@36 this@@49) ($IsGoodHeap $Heap@@36))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@37 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@37 this@@50) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@37) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.OwnedObject) ($IsAlloc refType this@@50 Tclass._module.OwnedObject $Heap@@37)))))) (= (_module.OwnedObject.alive $Heap@@37 this@@50)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@50) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.421:19|
 :skolemid |1762|
 :pattern ( (_module.OwnedObject.alive $Heap@@37 this@@50) ($IsGoodHeap $Heap@@37))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@38 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@38 this@@51) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@38) (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.Lifetime) ($IsAlloc refType this@@51 Tclass._module.Lifetime $Heap@@38)))))) (= (_module.Lifetime.alive $Heap@@38 this@@51)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@38 this@@51) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.551:19|
 :skolemid |1920|
 :pattern ( (_module.Lifetime.alive $Heap@@38 this@@51) ($IsGoodHeap $Heap@@38))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@39 T@U) (this@@52 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@39 this@@52) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@39) (and (or (not (= this@@52 null)) (not true)) (and ($Is refType this@@52 Tclass._module.Lifetime) ($IsAlloc refType this@@52 Tclass._module.Lifetime $Heap@@39)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@39 this@@52)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@52) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 (_module.Object.universe this@@52)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@52) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@52) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 (_module.Object.universe this@@52)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@52) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 (_module.Object.universe this@@52)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@52) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 (_module.Object.universe this@@52)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.563:19|
 :skolemid |1951|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@39 this@@52) ($IsGoodHeap $Heap@@39))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon5_correct  (=> (= (_module.Object.objectGlobalInv $Heap@@40 this@@53)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@40 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType this@@53)) (_module.Universe.globalInv $Heap@@40 (_module.Object.universe this@@53)))) (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@40 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType this@@53)) (|_module.Universe.globalInv#canCall| $Heap@@40 (_module.Object.universe this@@53))) ($Is boolType (bool_2_U (_module.Object.objectGlobalInv $Heap@@40 this@@53)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@1|)))))))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@40 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType this@@53))) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 7) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@40 (_module.Object.universe this@@53)) _module.Universe.content)) ($Box refType this@@53)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@53) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@53)) Tclass._module.Universe? $Heap@@40) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@40 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@40 $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.304:84|
 :skolemid |1356|
))) (|_module.Universe.globalInv#canCall| $Heap@@40 (_module.Object.universe this@@53))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 5) 3))) anon5_correct)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@53) null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 (_module.Object.universe this@@53) _module.Universe.content))) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#59| null $Heap@@40 alloc $Heap@@40 alloc)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@40) ($IsHeapAnchor $Heap@@40)) (=> (and (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Object) ($IsAlloc refType this@@53 Tclass._module.Object $Heap@@40))) (and (= 17 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
