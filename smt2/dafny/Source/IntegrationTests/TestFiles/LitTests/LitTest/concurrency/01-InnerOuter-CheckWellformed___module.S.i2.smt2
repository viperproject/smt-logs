...
(assert (forall (($prevHeap T@U) ($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.S) ($IsAlloc refType this Tclass._module.S $h0)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o T@U) ($f T@U) ) (!  (=> (and (or (not (= $o null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o) $f)))
 ...
 :skolemid |517|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.S.i2 $prevHeap $h1 this))
)))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@1 T@U) ($Heap T@U) (this@@1 T@U) ) (!  (=> (or (|_module.S.i2#canCall| $prevHeap@@1 $Heap this@@1) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@1) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@1 $Heap)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.S) ($IsAlloc refType this@@1 Tclass._module.S $prevHeap@@1)))))) (and (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.O) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@1 this@@1) _module.S.obs)) ($Box refType |o#0|)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@1) _module.S.obs)) ($Box refType |o#0|)) (|_module.O.i2#canCall| $prevHeap@@1 $Heap |o#0|))))
 :qid |_01InnerOuterdfy.24:44|
 :skolemid |521|
 :pattern ( (_module.O.i2 $prevHeap@@1 $Heap |o#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@1) _module.S.obs)) ($Box refType |o#0|)))
...
)) (= (_module.S.i2 $prevHeap@@1 $Heap this@@1) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.O) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@1 this@@1) _module.S.obs)) ($Box refType |o#0@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@1) _module.S.obs)) ($Box refType |o#0@@0|)) (_module.O.i2 $prevHeap@@1 $Heap |o#0@@0|)))
 :qid |_01InnerOuterdfy.24:44|
 :skolemid |520|
 :pattern ( (_module.O.i2 $prevHeap@@1 $Heap |o#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@1) _module.S.obs)) ($Box refType |o#0@@0|)))
 ...
 :skolemid |522|
 :pattern ( (_module.S.i2 $prevHeap@@1 $Heap this@@1) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.S.i2)
...
))) (=> (and (forall ((|o#2@@0| T@U) ) (!  (=> ($Is refType |o#2@@0| Tclass._module.O) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@2) _module.S.obs)) ($Box refType |o#2@@0|)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@2) _module.S.obs)) ($Box refType |o#2@@0|)) (|_module.O.i2#canCall| $Heap@@0 current$Heap |o#2@@0|))))
 :qid |_01InnerOuterdfy.24:44|
 :skolemid |526|
...
)) ($Is boolType (bool_2_U (_module.S.i2 $Heap@@0 current$Heap this@@2)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@1|)))))))
(let ((anon12_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@2) _module.S.obs)) ($Box refType |o#1@0|))) (= |b$reqreads#0@1| |b$reqreads#0@0|)) (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 10) 3))) anon7_correct)))
(let ((anon12_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@2) _module.S.obs)) ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.O? current$Heap) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($IsAlloc refType |o#1@0| Tclass._module.O $Heap@@0)) (=> ($IsAlloc refType |o#1@0| Tclass._module.O $Heap@@0) (=> (= |b$reqreads#1@0| (forall (($o@@8 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@8) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@8) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@2)))
 :qid |_01InnerOuterdfy.24:82|
 :skolemid |523|
))) (=> (and (and (|_module.O.i2#canCall| $Heap@@0 current$Heap |o#1@0|) (= |b$reqreads#0@1| |b$reqreads#0@0|)) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 7) 3))) anon7_correct))))))))))
(let ((anon11_Then_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@2) _module.S.obs)) ($Box refType |o#1@0|)) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.S.obs)))) (and (=> (= (ControlFlow 0 11) 7) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@2) _module.S.obs)) ($Box refType |o#1@0|))) (= |b$reqreads#0@1| true)) (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 6) 3))) anon7_correct)))
(let ((anon10_Then_correct  (=> (and ($Is refType |o#1@0| Tclass._module.O) ($IsAlloc refType |o#1@0| Tclass._module.O current$Heap)) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($IsAlloc refType this@@2 Tclass._module.S $Heap@@0)) (=> ($IsAlloc refType this@@2 Tclass._module.S $Heap@@0) (and (=> (= (ControlFlow 0 12) 11) anon11_Then_correct) (=> (= (ControlFlow 0 12) 6) anon11_Else_correct)))))))
(let ((anon10_Else_correct  (=> (and (and (not (and ($Is refType |o#1@0| Tclass._module.O) ($IsAlloc refType |o#1@0| Tclass._module.O current$Heap))) (= |b$reqreads#0@1| true)) (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 5) 3))) anon7_correct)))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null current$Heap alloc current$Heap alloc)) (and (and (=> (= (ControlFlow 0 14) 1) anon9_Then_correct) (=> (= (ControlFlow 0 14) 12) anon10_Then_correct)) (=> (= (ControlFlow 0 14) 5) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.S) ($IsAlloc refType this@@2 Tclass._module.S previous$Heap))) (= 3 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 15) 14))) anon0_correct))))
