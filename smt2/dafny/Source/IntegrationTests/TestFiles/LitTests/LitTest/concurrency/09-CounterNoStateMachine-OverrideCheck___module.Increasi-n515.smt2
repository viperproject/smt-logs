...
(set-info :boogie-vc-id OverrideCheck$$_module.IncreasingCounter.ProveUnchangedNonvolatileUserFields)
...
(assert (not
 ...
 :qid |_09CounterNoStateMachinedfy.496:18|
 :skolemid |2126|
 ...
 :qid |_09CounterNoStateMachinedfy.496:18|
 :skolemid |2127|
)) (=> (and (and (_module.IncreasingCounter.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.IncreasingCounter.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1)) (or (_module.IncreasingCounter.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))
