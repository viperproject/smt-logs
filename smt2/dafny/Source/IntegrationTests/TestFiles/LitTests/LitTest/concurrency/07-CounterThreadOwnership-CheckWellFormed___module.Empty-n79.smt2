...
(assert (distinct TInt TagInt TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Thread Tagclass._module.OwnedObject Tagclass._module.Object class._module.Universe? Tagclass._module.Universe? Tagclass._module.Object? Tagclass._module.Thread? class._module.OwnedObject? Tagclass._module.OwnedObject? Tagclass._module.EmptyType? Tagclass._module.EmptyType tytagFamily$Universe tytagFamily$Thread tytagFamily$OwnedObject tytagFamily$Object tytagFamily$EmptyType field$content field$nonvolatileVersion field$owner)
)
...
(assert (forall (($prevHeap@@3 T@U) ($h0@@2 T@U) ($h1@@2 T@U) (this@@4 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.EmptyType))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@2 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 this@@4)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@2) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@2) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |1412|
)) (= (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@3 $h0@@2 this@@4) (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@3 $h1@@2 this@@4))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1414|
 :pattern ( ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2) (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@3 $h1@@2 this@@4))
)))
...
(assert (forall ((bx@@1 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsAllocBox bx@@1 Tclass._module.EmptyType? $h@@2) ($IsGoodHeap $h@@2)) ($IsAllocBox bx@@1 Tclass._module.OwnedObject? $h@@2))
 :qid |unknown.0:0|
 :skolemid |3525|
 :pattern ( ($IsAllocBox bx@@1 Tclass._module.EmptyType? $h@@2))
)))
...
(assert (forall ((|c#0@@3| T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType |c#0@@3| Tclass._module.EmptyType $h@@7) ($IsAlloc refType |c#0@@3| Tclass._module.EmptyType? $h@@7))
 :qid |unknown.0:0|
 :skolemid |1644|
 :pattern ( ($IsAlloc refType |c#0@@3| Tclass._module.EmptyType $h@@7))
 :pattern ( ($IsAlloc refType |c#0@@3| Tclass._module.EmptyType? $h@@7))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.EmptyType.baseUserInv#canCall| $Heap@@2 this@@8) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.EmptyType)))) (= (_module.OwnedObject.baseUserInv $Heap@@2 this@@8) (_module.EmptyType.baseUserInv $Heap@@2 this@@8)))
 :qid |_07CounterThreadOwnershipdfy.384:19|
 :skolemid |1432|
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@2 this@@8) ($Is refType this@@8 Tclass._module.EmptyType) ($IsGoodHeap $Heap@@2))
 :pattern ( (_module.OwnedObject.baseUserInv $Heap@@2 this@@8) (_module.EmptyType.baseUserInv $Heap@@2 this@@8) ($IsGoodHeap $Heap@@2))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.EmptyType.localUserInv#canCall| $Heap@@3 this@@9) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.EmptyType)))) (= (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.EmptyType.localUserInv $Heap@@3 this@@9)))
 :qid |_07CounterThreadOwnershipdfy.385:19|
 :skolemid |1439|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) ($Is refType this@@9 Tclass._module.EmptyType) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.EmptyType.localUserInv $Heap@@3 this@@9) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.EmptyType.userInv#canCall| $Heap@@4 this@@10) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.EmptyType)))) (= (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.EmptyType.userInv $Heap@@4 this@@10)))
 :qid |_07CounterThreadOwnershipdfy.387:19|
 :skolemid |1446|
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) ($Is refType this@@10 Tclass._module.EmptyType) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.EmptyType.userInv $Heap@@4 this@@10) ($IsGoodHeap $Heap@@4))
))))
...
(assert (forall (($prevHeap@@18 T@U) ($h0@@17 T@U) ($h1@@17 T@U) (this@@27 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.EmptyType) ($IsAlloc refType this@@27 Tclass._module.EmptyType $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@20 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@20) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@20) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@20) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |1449|
)) (= (_module.EmptyType.localUserInv2 $prevHeap@@18 $h0@@17 this@@27) (_module.EmptyType.localUserInv2 $prevHeap@@18 $h1@@17 this@@27))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1450|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.EmptyType.localUserInv2 $prevHeap@@18 $h1@@17 this@@27))
)))
(assert (forall (($prevHeap@@19 T@U) ($h0@@18 T@U) ($h1@@18 T@U) (this@@28 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.EmptyType) ($IsAlloc refType this@@28 Tclass._module.EmptyType $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@21 T@U) ($f@@18 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@21) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@21) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@21) $f@@18)))
 :qid |unknown.0:0|
 :skolemid |1456|
)) (= (_module.EmptyType.userInv2 $prevHeap@@19 $h0@@18 this@@28) (_module.EmptyType.userInv2 $prevHeap@@19 $h1@@18 this@@28))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1457|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.EmptyType.userInv2 $prevHeap@@19 $h1@@18 this@@28))
)))
...
(assert (forall (($o@@26 T@U) ($h@@12 T@U) ) (! (= ($IsAlloc refType $o@@26 Tclass._module.EmptyType? $h@@12)  (or (= $o@@26 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@26) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1411|
 :pattern ( ($IsAlloc refType $o@@26 Tclass._module.EmptyType? $h@@12))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.EmptyType.baseUserInv#canCall| $Heap@@9 this@@29) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.EmptyType) ($IsAlloc refType this@@29 Tclass._module.EmptyType $Heap@@9)))))) (= (_module.EmptyType.baseUserInv $Heap@@9 this@@29) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.429:19|
 :skolemid |1431|
 :pattern ( (_module.EmptyType.baseUserInv $Heap@@9 this@@29) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.EmptyType.localUserInv#canCall| $Heap@@10 this@@30) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.EmptyType) ($IsAlloc refType this@@30 Tclass._module.EmptyType $Heap@@10)))))) (= (_module.EmptyType.localUserInv $Heap@@10 this@@30) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.433:19|
 :skolemid |1438|
 :pattern ( (_module.EmptyType.localUserInv $Heap@@10 this@@30) ($IsGoodHeap $Heap@@10))
))))
...
(assert  (=> (< 1 $FunctionContextHeight) (forall (($h@@13 T@U) ($o@@34 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@34 null)) (not true)) ($Is refType $o@@34 Tclass._module.Object?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@34) alloc)))) ($IsAlloc refType (_module.Object.universe $o@@34) Tclass._module.Universe $h@@13))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |966|
 :pattern ( (_module.Object.universe $o@@34) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@34) alloc)))
))))
(assert  (=> (< 1 $FunctionContextHeight) (forall (($o@@35 T@U) ) (!  (=> (and (or (not (= $o@@35 null)) (not true)) ($Is refType $o@@35 Tclass._module.Object?)) ($Is refType (_module.Object.universe $o@@35) Tclass._module.Universe))
 :qid |unknown.0:0|
 :skolemid |965|
 :pattern ( (_module.Object.universe $o@@35))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@25 T@U) ($Heap@@17 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@25 $Heap@@17 this@@37) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@37 null)) (not true)) ($Is refType this@@37 Tclass._module.Thread)))) (= (_module.Object.localInv2 $prevHeap@@25 $Heap@@17 this@@37) (_module.Thread.localInv2 $prevHeap@@25 $Heap@@17 this@@37)))
 :qid |_07CounterThreadOwnershipdfy.272:22|
 :skolemid |1109|
 :pattern ( (_module.Object.localInv2 $prevHeap@@25 $Heap@@17 this@@37) ($Is refType this@@37 Tclass._module.Thread) ($IsGoodHeap $Heap@@17))
 :pattern ( (_module.Object.localInv2 $prevHeap@@25 $Heap@@17 this@@37) (_module.Thread.localInv2 $prevHeap@@25 $Heap@@17 this@@37) ($IsGoodHeap $Heap@@17))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@26 T@U) ($Heap@@18 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.Thread.transitiveInv2#canCall| $prevHeap@@26 $Heap@@18 this@@38) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@38 null)) (not true)) ($Is refType this@@38 Tclass._module.Thread)))) (= (_module.Object.transitiveInv2 $prevHeap@@26 $Heap@@18 this@@38) (_module.Thread.transitiveInv2 $prevHeap@@26 $Heap@@18 this@@38)))
 :qid |_07CounterThreadOwnershipdfy.274:22|
 :skolemid |1116|
 :pattern ( (_module.Object.transitiveInv2 $prevHeap@@26 $Heap@@18 this@@38) ($Is refType this@@38 Tclass._module.Thread) ($IsGoodHeap $Heap@@18))
 :pattern ( (_module.Object.transitiveInv2 $prevHeap@@26 $Heap@@18 this@@38) (_module.Thread.transitiveInv2 $prevHeap@@26 $Heap@@18 this@@38) ($IsGoodHeap $Heap@@18))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@27 T@U) ($Heap@@19 T@U) (this@@39 T@U) ) (!  (=> (or (|_module.EmptyType.unchangedNonvolatileUserFields#canCall| $prevHeap@@27 $Heap@@19 this@@39) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@39 null)) (not true)) ($Is refType this@@39 Tclass._module.EmptyType)))) (= (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@27 $Heap@@19 this@@39) (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@27 $Heap@@19 this@@39)))
 :qid |_07CounterThreadOwnershipdfy.383:22|
 :skolemid |1418|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@27 $Heap@@19 this@@39) ($Is refType this@@39 Tclass._module.EmptyType) ($IsGoodHeap $Heap@@19))
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@27 $Heap@@19 this@@39) (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@27 $Heap@@19 this@@39) ($IsGoodHeap $Heap@@19))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@28 T@U) ($Heap@@20 T@U) (this@@40 T@U) ) (!  (=> (or (|_module.EmptyType.localUserInv2#canCall| $prevHeap@@28 $Heap@@20 this@@40) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.EmptyType)))) (= (_module.OwnedObject.localUserInv2 $prevHeap@@28 $Heap@@20 this@@40) (_module.EmptyType.localUserInv2 $prevHeap@@28 $Heap@@20 this@@40)))
 :qid |_07CounterThreadOwnershipdfy.386:22|
 :skolemid |1454|
 :pattern ( (_module.OwnedObject.localUserInv2 $prevHeap@@28 $Heap@@20 this@@40) ($Is refType this@@40 Tclass._module.EmptyType) ($IsGoodHeap $Heap@@20))
 :pattern ( (_module.OwnedObject.localUserInv2 $prevHeap@@28 $Heap@@20 this@@40) (_module.EmptyType.localUserInv2 $prevHeap@@28 $Heap@@20 this@@40) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@29 T@U) ($Heap@@21 T@U) (this@@41 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@29 $Heap@@21 this@@41) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@41 null)) (not true)) ($Is refType this@@41 Tclass._module.Thread)))) (= (_module.Object.inv2 $prevHeap@@29 $Heap@@21 this@@41) (_module.Thread.inv2 $prevHeap@@29 $Heap@@21 this@@41)))
 :qid |_07CounterThreadOwnershipdfy.275:22|
 :skolemid |1123|
 :pattern ( (_module.Object.inv2 $prevHeap@@29 $Heap@@21 this@@41) ($Is refType this@@41 Tclass._module.Thread) ($IsGoodHeap $Heap@@21))
 :pattern ( (_module.Object.inv2 $prevHeap@@29 $Heap@@21 this@@41) (_module.Thread.inv2 $prevHeap@@29 $Heap@@21 this@@41) ($IsGoodHeap $Heap@@21))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@30 T@U) ($Heap@@22 T@U) (this@@42 T@U) ) (!  (=> (or (|_module.EmptyType.userInv2#canCall| $prevHeap@@30 $Heap@@22 this@@42) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@42 null)) (not true)) ($Is refType this@@42 Tclass._module.EmptyType)))) (= (_module.OwnedObject.userInv2 $prevHeap@@30 $Heap@@22 this@@42) (_module.EmptyType.userInv2 $prevHeap@@30 $Heap@@22 this@@42)))
 :qid |_07CounterThreadOwnershipdfy.388:22|
 :skolemid |1461|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@30 $Heap@@22 this@@42) ($Is refType this@@42 Tclass._module.EmptyType) ($IsGoodHeap $Heap@@22))
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@30 $Heap@@22 this@@42) (_module.EmptyType.userInv2 $prevHeap@@30 $Heap@@22 this@@42) ($IsGoodHeap $Heap@@22))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@31 T@U) ($Heap@@23 T@U) (this@@43 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@31 $Heap@@23 this@@43) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@43 null)) (not true)) ($Is refType this@@43 Tclass._module.OwnedObject)))) (= (_module.Object.localInv2 $prevHeap@@31 $Heap@@23 this@@43) (_module.OwnedObject.localInv2 $prevHeap@@31 $Heap@@23 this@@43)))
 :qid |_07CounterThreadOwnershipdfy.272:22|
 :skolemid |1327|
 :pattern ( (_module.Object.localInv2 $prevHeap@@31 $Heap@@23 this@@43) ($Is refType this@@43 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@23))
 :pattern ( (_module.Object.localInv2 $prevHeap@@31 $Heap@@23 this@@43) (_module.OwnedObject.localInv2 $prevHeap@@31 $Heap@@23 this@@43) ($IsGoodHeap $Heap@@23))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@32 T@U) ($Heap@@24 T@U) (this@@44 T@U) ) (!  (=> (or (|_module.OwnedObject.transitiveInv2#canCall| $prevHeap@@32 $Heap@@24 this@@44) (and (< 3 $FunctionContextHeight) (and (or (not (= this@@44 null)) (not true)) ($Is refType this@@44 Tclass._module.OwnedObject)))) (= (_module.Object.transitiveInv2 $prevHeap@@32 $Heap@@24 this@@44) (_module.OwnedObject.transitiveInv2 $prevHeap@@32 $Heap@@24 this@@44)))
 :qid |_07CounterThreadOwnershipdfy.274:22|
 :skolemid |1337|
 :pattern ( (_module.Object.transitiveInv2 $prevHeap@@32 $Heap@@24 this@@44) ($Is refType this@@44 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@24))
 :pattern ( (_module.Object.transitiveInv2 $prevHeap@@32 $Heap@@24 this@@44) (_module.OwnedObject.transitiveInv2 $prevHeap@@32 $Heap@@24 this@@44) ($IsGoodHeap $Heap@@24))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($prevHeap@@33 T@U) ($Heap@@25 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.OwnedObject.inv2#canCall| $prevHeap@@33 $Heap@@25 this@@45) (and (< 6 $FunctionContextHeight) (and (or (not (= this@@45 null)) (not true)) ($Is refType this@@45 Tclass._module.OwnedObject)))) (= (_module.Object.inv2 $prevHeap@@33 $Heap@@25 this@@45) (_module.OwnedObject.inv2 $prevHeap@@33 $Heap@@25 this@@45)))
 :qid |_07CounterThreadOwnershipdfy.275:22|
 :skolemid |1349|
 :pattern ( (_module.Object.inv2 $prevHeap@@33 $Heap@@25 this@@45) ($Is refType this@@45 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@25))
 :pattern ( (_module.Object.inv2 $prevHeap@@33 $Heap@@25 this@@45) (_module.OwnedObject.inv2 $prevHeap@@33 $Heap@@25 this@@45) ($IsGoodHeap $Heap@@25))
))))
...
(assert (forall ((bx@@12 T@U) ) (!  (=> ($IsBox bx@@12 Tclass._module.EmptyType?) (and (= ($Box refType ($Unbox refType bx@@12)) bx@@12) ($Is refType ($Unbox refType bx@@12) Tclass._module.EmptyType?)))
 :qid |unknown.0:0|
 :skolemid |1409|
 :pattern ( ($IsBox bx@@12 Tclass._module.EmptyType?))
)))
(assert (forall ((bx@@13 T@U) ) (!  (=> ($IsBox bx@@13 Tclass._module.EmptyType) (and (= ($Box refType ($Unbox refType bx@@13)) bx@@13) ($Is refType ($Unbox refType bx@@13) Tclass._module.EmptyType)))
 :qid |unknown.0:0|
 :skolemid |1413|
 :pattern ( ($IsBox bx@@13 Tclass._module.EmptyType))
)))
...
(assert (forall ((|c#0@@8| T@U) ) (! (= ($Is refType |c#0@@8| Tclass._module.EmptyType)  (and ($Is refType |c#0@@8| Tclass._module.EmptyType?) (or (not (= |c#0@@8| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |1643|
 :pattern ( ($Is refType |c#0@@8| Tclass._module.EmptyType))
 :pattern ( ($Is refType |c#0@@8| Tclass._module.EmptyType?))
)))
...
(assert (forall (($o@@36 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@36 Tclass._module.Thread? $heap) ($IsAlloc refType $o@@36 Tclass._module.Object? $heap))
 :qid |unknown.0:0|
 :skolemid |3519|
 :pattern ( ($IsAlloc refType $o@@36 Tclass._module.Thread? $heap))
)))
(assert (forall (($o@@37 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@37 Tclass._module.OwnedObject? $heap@@0) ($IsAlloc refType $o@@37 Tclass._module.Object? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |3523|
 :pattern ( ($IsAlloc refType $o@@37 Tclass._module.OwnedObject? $heap@@0))
)))
(assert (forall (($o@@38 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@38 Tclass._module.EmptyType? $heap@@1) ($IsAlloc refType $o@@38 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |3527|
 :pattern ( ($IsAlloc refType $o@@38 Tclass._module.EmptyType? $heap@@1))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@34 T@U) ($Heap@@27 T@U) (this@@47 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@34 $Heap@@27 this@@47) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@34) ($IsGoodHeap $Heap@@27)) ($HeapSucc $prevHeap@@34 $Heap@@27)) (and (or (not (= this@@47 null)) (not true)) (and ($Is refType this@@47 Tclass._module.Thread) ($IsAlloc refType this@@47 Tclass._module.Thread $prevHeap@@34)))))) (= (_module.Thread.localInv2 $prevHeap@@34 $Heap@@27 this@@47) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_07CounterThreadOwnershipdfy.291:22|
 :skolemid |1108|
 :pattern ( (_module.Thread.localInv2 $prevHeap@@34 $Heap@@27 this@@47) ($IsGoodHeap $Heap@@27))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@35 T@U) ($Heap@@28 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.Thread.transitiveInv2#canCall| $prevHeap@@35 $Heap@@28 this@@48) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@35) ($IsGoodHeap $Heap@@28)) ($HeapSucc $prevHeap@@35 $Heap@@28)) (and (or (not (= this@@48 null)) (not true)) (and ($Is refType this@@48 Tclass._module.Thread) ($IsAlloc refType this@@48 Tclass._module.Thread $prevHeap@@35)))))) (= (_module.Thread.transitiveInv2 $prevHeap@@35 $Heap@@28 this@@48) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_07CounterThreadOwnershipdfy.294:22|
 :skolemid |1115|
 :pattern ( (_module.Thread.transitiveInv2 $prevHeap@@35 $Heap@@28 this@@48) ($IsGoodHeap $Heap@@28))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@36 T@U) ($Heap@@29 T@U) (this@@49 T@U) ) (!  (=> (or (|_module.EmptyType.unchangedNonvolatileUserFields#canCall| $prevHeap@@36 $Heap@@29 this@@49) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@36) ($IsGoodHeap $Heap@@29)) ($HeapSucc $prevHeap@@36 $Heap@@29)) (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.EmptyType) ($IsAlloc refType this@@49 Tclass._module.EmptyType $prevHeap@@36)))))) (= (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@36 $Heap@@29 this@@49) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_07CounterThreadOwnershipdfy.424:22|
 :skolemid |1417|
 :pattern ( (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@36 $Heap@@29 this@@49) ($IsGoodHeap $Heap@@29))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@37 T@U) ($Heap@@30 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.EmptyType.userInv2#canCall| $prevHeap@@37 $Heap@@30 this@@50) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@37) ($IsGoodHeap $Heap@@30)) ($HeapSucc $prevHeap@@37 $Heap@@30)) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.EmptyType) ($IsAlloc refType this@@50 Tclass._module.EmptyType $prevHeap@@37)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.EmptyType.localUserInv2#canCall| $prevHeap@@37 $Heap@@30 this@@50)) (= (_module.EmptyType.userInv2 $prevHeap@@37 $Heap@@30 this@@50)  (and true (_module.EmptyType.localUserInv2 $prevHeap@@37 $Heap@@30 this@@50)))))
 :qid |_07CounterThreadOwnershipdfy.443:22|
 :skolemid |1460|
 :pattern ( (_module.EmptyType.userInv2 $prevHeap@@37 $Heap@@30 this@@50) ($IsGoodHeap $Heap@@30))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@39 T@U) ($Heap@@32 T@U) (this@@52 T@U) ) (!  (=> (or (|_module.EmptyType.localUserInv2#canCall| $prevHeap@@39 $Heap@@32 this@@52) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@39) ($IsGoodHeap $Heap@@32)) ($HeapSucc $prevHeap@@39 $Heap@@32)) (and (or (not (= this@@52 null)) (not true)) (and ($Is refType this@@52 Tclass._module.EmptyType) ($IsAlloc refType this@@52 Tclass._module.EmptyType $prevHeap@@39)))))) (= (_module.EmptyType.localUserInv2 $prevHeap@@39 $Heap@@32 this@@52) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.440:22|
 :skolemid |1453|
 :pattern ( (_module.EmptyType.localUserInv2 $prevHeap@@39 $Heap@@32 this@@52) ($IsGoodHeap $Heap@@32))
))))
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($prevHeap@@40 T@U) ($Heap@@33 T@U) (this@@53 T@U) (|running#0@@3| T@U) ) (!  (=> (or (|_module.Object.goodPreAndLegalChanges#canCall| $prevHeap@@40 $Heap@@33 this@@53 |running#0@@3|) (and (< 11 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@40) ($IsGoodHeap $Heap@@33)) ($HeapSucc $prevHeap@@40 $Heap@@33)) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Object) ($IsAlloc refType this@@53 Tclass._module.Object $prevHeap@@40)))) ($Is refType |running#0@@3| Tclass._module.Thread)))) (and (and (and (|_module.Object.baseInv#canCall| $prevHeap@@40 this@@53) (=> (_module.Object.baseInv $prevHeap@@40 this@@53) (|_module.Universe.globalInv#canCall| $prevHeap@@40 (_module.Object.universe this@@53)))) (=> (and (_module.Object.baseInv $prevHeap@@40 this@@53) (_module.Universe.globalInv $prevHeap@@40 (_module.Object.universe this@@53))) (and (|_module.Object.baseInv#canCall| $Heap@@33 this@@53) (=> (_module.Object.baseInv $Heap@@33 this@@53) (=> (forall (($o@@39 T@U) ($f@@26 T@U) ) (!  (=> (or (not (= $o@@39 null)) (not true)) (=> (= $o@@39 this@@53) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 $o@@39) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@40 $o@@39) $f@@26))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |992|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 $o@@39) $f@@26))
)) (|_module.Universe.legalTransition#canCall| $prevHeap@@40 $Heap@@33 (_module.Object.universe this@@53) |running#0@@3|)))))) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@40 $Heap@@33 this@@53 |running#0@@3|)  (and (and (and (and (_module.Object.baseInv $prevHeap@@40 this@@53) (_module.Universe.globalInv $prevHeap@@40 (_module.Object.universe this@@53))) (_module.Object.baseInv $Heap@@33 this@@53)) (forall (($o@@40 T@U) ($f@@27 T@U) ) (!  (=> (or (not (= $o@@40 null)) (not true)) (=> (= $o@@40 this@@53) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 $o@@40) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@40 $o@@40) $f@@27))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |991|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 $o@@40) $f@@27))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@54 T@U) ) (!  (=> (or (|_module.EmptyType.userInv#canCall| $Heap@@34 this@@54) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.EmptyType) ($IsAlloc refType this@@54 Tclass._module.EmptyType $Heap@@34)))))) (=> (_module.EmptyType.userInv $Heap@@34 this@@54) (_module.EmptyType.localUserInv $Heap@@34 this@@54)))
 :qid |_07CounterThreadOwnershipdfy.436:19|
 :skolemid |1443|
 :pattern ( (_module.EmptyType.userInv $Heap@@34 this@@54))
))))
...
(assert (forall (($h@@14 T@U) ($o@@41 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@41 null)) (not true)) ($Is refType $o@@41 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@41) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@41) _module.OwnedObject.nonvolatileVersion)) TInt $h@@14))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1290|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@41) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@60 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@60 null)) (not true)) ($Is refType this@@60 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@42 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@42 null)) (not true)) (or (= $o@@42 this@@60) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 this@@60) _module.Universe.content)) ($Box refType $o@@42)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@42) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@42) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |494|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@43 T@U) ($f@@29 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@43 $f@@29))  (=> (and (or (not (= $o@@43 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@43) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3540|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@43 $f@@29))
)))
(assert (forall (($h@@15 T@U) ($o@@44 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@44 null)) (not true)) ($Is refType $o@@44 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@44) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@44) _module.OwnedObject.owner)) Tclass._module.Object $h@@15))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1292|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@44) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@62 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@62 null)) (not true)) (and ($Is refType this@@62 Tclass._module.Universe) ($IsAlloc refType this@@62 Tclass._module.Universe $h0@@20)))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@45 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@45 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@45) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@45) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@45) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |502|
...
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@63 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@63 null)) (not true)) (and ($Is refType this@@63 Tclass._module.Object) ($IsAlloc refType this@@63 Tclass._module.Object $h0@@21)))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@46 T@U) ($f@@31 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@46) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@46) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@46) $f@@31)))
 :qid |unknown.0:0|
 :skolemid |967|
...
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@64 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@64 null)) (not true)) (and ($Is refType this@@64 Tclass._module.Object) ($IsAlloc refType this@@64 Tclass._module.Object $h0@@22)))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@47 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@47 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@47) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@47) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@47) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |1017|
...
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@65 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@65 null)) (not true)) (and ($Is refType this@@65 Tclass._module.Object) ($IsAlloc refType this@@65 Tclass._module.Object $h0@@23)))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@48 T@U) ($f@@33 T@U) ) (!  (=> (and (or (not (= $o@@48 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@48) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@48) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@48) $f@@33)))
 :qid |unknown.0:0|
 :skolemid |1025|
...
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@66 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@66 null)) (not true)) (and ($Is refType this@@66 Tclass._module.Thread) ($IsAlloc refType this@@66 Tclass._module.Thread $h0@@24)))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@49 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@49 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@49) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@49) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@49) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |1084|
...
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@67 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@67 null)) (not true)) (and ($Is refType this@@67 Tclass._module.Thread) ($IsAlloc refType this@@67 Tclass._module.Thread $h0@@25)))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@50 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@50 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@50) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@50) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@50) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |1092|
...
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@68 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@68 null)) (not true)) (and ($Is refType this@@68 Tclass._module.OwnedObject) ($IsAlloc refType this@@68 Tclass._module.OwnedObject $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@51 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@51 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@51) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@51) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@51) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |1299|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@69 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@69 null)) (not true)) (and ($Is refType this@@69 Tclass._module.OwnedObject) ($IsAlloc refType this@@69 Tclass._module.OwnedObject $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@52 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@52 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@52) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@52) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@52) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1309|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@70 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@70 null)) (not true)) (and ($Is refType this@@70 Tclass._module.OwnedObject) ($IsAlloc refType this@@70 Tclass._module.OwnedObject $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@53 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@53 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@53) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@53) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@53) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1385|
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@71 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@71 null)) (not true)) (and ($Is refType this@@71 Tclass._module.OwnedObject) ($IsAlloc refType this@@71 Tclass._module.OwnedObject $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@54 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@54) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@54) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@54) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1389|
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@72 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@72 null)) (not true)) (and ($Is refType this@@72 Tclass._module.OwnedObject) ($IsAlloc refType this@@72 Tclass._module.OwnedObject $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@55 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@55 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@55) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@55) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@55) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1397|
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@73 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@73 null)) (not true)) (and ($Is refType this@@73 Tclass._module.EmptyType) ($IsAlloc refType this@@73 Tclass._module.EmptyType $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@56 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@56 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@56) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@56) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@56) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1427|
)) (= (_module.EmptyType.baseUserInv $h0@@31 this@@73) (_module.EmptyType.baseUserInv $h1@@31 this@@73))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1428|
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.EmptyType.baseUserInv $h1@@31 this@@73))
)))
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@74 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.EmptyType) ($IsAlloc refType this@@74 Tclass._module.EmptyType $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@57 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@57 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@57) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@57) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@57) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1434|
)) (= (_module.EmptyType.localUserInv $h0@@32 this@@74) (_module.EmptyType.localUserInv $h1@@32 this@@74))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1435|
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.EmptyType.localUserInv $h1@@32 this@@74))
)))
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@75 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@75 null)) (not true)) (and ($Is refType this@@75 Tclass._module.EmptyType) ($IsAlloc refType this@@75 Tclass._module.EmptyType $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@58 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@58) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@58) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@58) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1441|
)) (= (_module.EmptyType.userInv $h0@@33 this@@75) (_module.EmptyType.userInv $h1@@33 this@@75))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1442|
 :pattern ( ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33) (_module.EmptyType.userInv $h1@@33 this@@75))
)))
...
(assert (forall (($o@@59 T@U) ) (!  (=> ($Is refType $o@@59 Tclass._module.Thread?) ($Is refType $o@@59 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |3518|
 :pattern ( ($Is refType $o@@59 Tclass._module.Thread?))
)))
...
(assert (forall (($o@@61 T@U) ) (!  (=> ($Is refType $o@@61 Tclass._module.EmptyType?) ($Is refType $o@@61 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3526|
 :pattern ( ($Is refType $o@@61 Tclass._module.EmptyType?))
)))
(assert (forall ((bx@@19 T@U) ) (!  (=> ($IsBox bx@@19 Tclass._module.EmptyType?) ($IsBox bx@@19 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3524|
 :pattern ( ($IsBox bx@@19 Tclass._module.EmptyType?))
)))
...
(assert (= (Tag Tclass._module.EmptyType) Tagclass._module.EmptyType))
(assert (= (TagFamily Tclass._module.EmptyType) tytagFamily$EmptyType))
(assert (forall (($h@@16 T@U) ($o@@62 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@62 null)) (not true)) ($Is refType $o@@62 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@62) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1291|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@62) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h@@17 T@U) ($o@@66 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@66 null)) (not true)) ($Is refType $o@@66 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@66) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@66) _module.Universe.content)) (TSet Tclass._module.Object) $h@@17))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@66) _module.Universe.content)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@43 T@U) ($Heap@@42 T@U) (this@@77 T@U) ) (!  (=> (or (|_module.EmptyType.userInv2#canCall| $prevHeap@@43 $Heap@@42 this@@77) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@43) ($IsGoodHeap $Heap@@42)) ($HeapSucc $prevHeap@@43 $Heap@@42)) (and (or (not (= this@@77 null)) (not true)) (and ($Is refType this@@77 Tclass._module.EmptyType) ($IsAlloc refType this@@77 Tclass._module.EmptyType $prevHeap@@43)))))) (=> (_module.EmptyType.userInv2 $prevHeap@@43 $Heap@@42 this@@77) (_module.EmptyType.localUserInv2 $prevHeap@@43 $Heap@@42 this@@77)))
 :qid |_07CounterThreadOwnershipdfy.443:22|
 :skolemid |1458|
 :pattern ( (_module.EmptyType.userInv2 $prevHeap@@43 $Heap@@42 this@@77))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@44 T@U) (this@@79 T@U) ) (!  (=> (or (|_module.EmptyType.userInv#canCall| $Heap@@44 this@@79) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@44) (and (or (not (= this@@79 null)) (not true)) (and ($Is refType this@@79 Tclass._module.EmptyType) ($IsAlloc refType this@@79 Tclass._module.EmptyType $Heap@@44)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.EmptyType.localUserInv#canCall| $Heap@@44 this@@79)) (= (_module.EmptyType.userInv $Heap@@44 this@@79)  (and true (_module.EmptyType.localUserInv $Heap@@44 this@@79)))))
 :qid |_07CounterThreadOwnershipdfy.436:19|
 :skolemid |1445|
 :pattern ( (_module.EmptyType.userInv $Heap@@44 this@@79) ($IsGoodHeap $Heap@@44))
))))
...
(assert (forall (($h@@18 T@U) ($o@@67 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@67 null)) (not true)) ($Is refType $o@@67 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@67) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |492|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@67) _module.Universe.content)))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@84) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@84 Tclass._module.EmptyType $Heap@@49)) (=> ($IsAlloc refType this@@84 Tclass._module.EmptyType $Heap@@49) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@49)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@49) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@84) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@84 Tclass._module.EmptyType $Heap@@49))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@49) ($IsHeapAnchor $Heap@@49)) (and (or (not (= this@@84 null)) (not true)) (and ($Is refType this@@84 Tclass._module.EmptyType) ($IsAlloc refType this@@84 Tclass._module.EmptyType previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@49) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
