...
(assert (forall (($h@@13 T@U) ($o@@12 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass._module.IncrementerMethod?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@12) _module.IncrementerMethod.counter)) Tclass._module.AtomicCounter))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1648|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@12) _module.IncrementerMethod.counter)))
)))
(assert (forall (($h@@14 T@U) ($o@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass._module.IncrementerMethod?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@13) _module.IncrementerMethod.remaining)) Tclass._module.Remaining))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1650|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@13) _module.IncrementerMethod.remaining)))
)))
...
(assert (forall (($h@@15 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass._module.IncrementerMethod?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@14) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@14) _module.IncrementerMethod.counter)) Tclass._module.AtomicCounter $h@@15))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1649|
...
(assert (forall (($h@@16 T@U) ($o@@15 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) Tclass._module.IncrementerMethod?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@15) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@15) _module.IncrementerMethod.remaining)) Tclass._module.Remaining $h@@16))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1651|
...
(assert (forall (($h@@17 T@U) ($o@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) _module.IncrementerMethod.programCounter)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1646|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@20) _module.IncrementerMethod.programCounter)))
)))
(assert (forall (($h@@18 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@21 null)) (not true)) (= (dtype $o@@21) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) _module.IncrementerMethod.initial__value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1652|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@21) _module.IncrementerMethod.initial__value)))
)))
(assert (forall (($h@@19 T@U) ($o@@22 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@22 null)) (not true)) (= (dtype $o@@22) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@22) _module.IncrementerMethod.final__value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1654|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@22) _module.IncrementerMethod.final__value)))
)))
(assert (forall (($h@@20 T@U) ($o@@23 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@23 null)) (not true)) (= (dtype $o@@23) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@23) _module.IncrementerMethod.i)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1656|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@23) _module.IncrementerMethod.i)))
)))
...
(assert (forall (($o@@25 T@U) ) (!  (=> ($Is refType $o@@25 Tclass._module.AtomicCounter?) ($Is refType $o@@25 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2263|
 :pattern ( ($Is refType $o@@25 Tclass._module.AtomicCounter?))
)))
(assert (forall (($o@@26 T@U) ) (!  (=> ($Is refType $o@@26 Tclass._module.Remaining?) ($Is refType $o@@26 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2267|
 :pattern ( ($Is refType $o@@26 Tclass._module.Remaining?))
)))
(assert (forall (($o@@27 T@U) ) (!  (=> ($Is refType $o@@27 Tclass._module.IncrementerMethod?) ($Is refType $o@@27 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2271|
 :pattern ( ($Is refType $o@@27 Tclass._module.IncrementerMethod?))
)))
...
(set-info :boogie-vc-id OverrideCheck$$_module.IncrementerMethod.proveUnchangedNonvolatileUserFields)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon0_correct  (=> (forall (($o@@30 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@30 null)) (not true)) (=> (= $o@@30 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@30) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@30) $f@@0))))
 :qid |_08CounterNoTerminationdfy.219:65|
 :skolemid |1667|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@30) $f@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (forall (($o@@31 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@31 null)) (not true)) (=> (= $o@@31 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@31) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@31) $f@@1))))
 :qid |_08CounterNoTerminationdfy.424:65|
 :skolemid |1668|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@31) $f@@1))
))) (=> (forall (($o@@32 T@U) ($f@@2 T@U) ) (!  (=> (or (not (= $o@@32 null)) (not true)) (=> (= $o@@32 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@32) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@32) $f@@2))))
 :qid |_08CounterNoTerminationdfy.424:65|
 :skolemid |1668|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@32) $f@@2))
)) (and (=> (= (ControlFlow 0 2) (- 0 10)) true) (and (=> (= (ControlFlow 0 2) (- 0 9)) (forall (($o@@33 T@U) ($f@@3 T@U) ) (! true
 :qid |_08CounterNoTerminationdfy.424:18|
 :skolemid |1669|
))) (=> (forall (($o@@34 T@U) ($f@@4 T@U) ) (! true
 :qid |_08CounterNoTerminationdfy.424:18|
 :skolemid |1669|
)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (forall (($o@@35 T@U) ($f@@5 T@U) ) (! true
 :qid |_08CounterNoTerminationdfy.424:18|
 :skolemid |1670|
))) (=> (forall (($o@@36 T@U) ($f@@6 T@U) ) (! true
 :qid |_08CounterNoTerminationdfy.424:18|
 :skolemid |1670|
)) (=> (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.programCounter))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.programCounter))))))) (=> (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.programCounter))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.programCounter)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.counter)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.counter)))))) (=> (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.counter)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.counter))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.remaining)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.remaining)))))) (=> (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.remaining)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.remaining))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.initial__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.initial__value))))))) (=> (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.initial__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.initial__value)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.final__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.final__value))))))) (=> (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.final__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.final__value)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.IncrementerMethod.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.IncrementerMethod.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.IncrementerMethod.i))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.IncrementerMethod.i))))))))))))))))))))))))))))
