...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@10 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#140| |l#0| |l#1| |l#2| |l#3|) $o@@10 $f))  (=> (and (or (not (= $o@@10 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@10) |l#2|)))) (= $o@@10 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3869|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#140| |l#0| |l#1| |l#2| |l#3|) $o@@10 $f))
)))
...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@9 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.Object))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@22 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (or (= $o@@22 this@@9) (= $o@@22 (_module.Object.universe this@@9)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@22) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@22) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |1775|
)) (= (_module.Object.baseFieldsInv $h0 this@@9) (_module.Object.baseFieldsInv $h1 this@@9))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1776|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.Object.baseFieldsInv $h1 this@@9))
)))
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@10 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.Thread))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@23 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (or (= $o@@23 this@@10) (= $o@@23 (_module.Object.universe this@@10)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@23) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@23) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |1857|
)) (= (_module.Thread.baseFieldsInv $h0@@0 this@@10) (_module.Thread.baseFieldsInv $h1@@0 this@@10))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1858|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.Thread.baseFieldsInv $h1@@0 this@@10))
)))
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (this@@11 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@24 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (or (= $o@@24 this@@11) (= $o@@24 (_module.Object.universe this@@11)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@24) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@24) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |2128|
)) (= (_module.OwnedObject.baseFieldsInv $h0@@1 this@@11) (_module.OwnedObject.baseFieldsInv $h1@@1 this@@11))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2129|
 :pattern ( ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1) (_module.OwnedObject.baseFieldsInv $h1@@1 this@@11))
)))
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@12 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@12 null)) (not true)) ($Is refType this@@12 Tclass._module.Lifetime))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@25 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (or (= $o@@25 this@@12) (= $o@@25 (_module.Object.universe this@@12)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@25) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@25) $f@@3)))
 :qid |unknown.0:0|
 :skolemid |2297|
)) (= (_module.Lifetime.baseFieldsInv $h0@@2 this@@12) (_module.Lifetime.baseFieldsInv $h1@@2 this@@12))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2298|
 :pattern ( ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2) (_module.Lifetime.baseFieldsInv $h1@@2 this@@12))
)))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@9 this@@13) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.OwnedObject) ($IsAlloc refType this@@13 Tclass._module.OwnedObject $Heap@@9)))))) (and (|_module.OwnedObject.objectFields#canCall| $Heap@@9 this@@13) (= (_module.OwnedObject.baseFieldsInv $Heap@@9 this@@13) (|Set#Subset| (_module.OwnedObject.objectFields $Heap@@9 this@@13) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Object.universe this@@13)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.433:19|
 :skolemid |2132|
 :pattern ( (_module.OwnedObject.baseFieldsInv $Heap@@9 this@@13) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Object.nonAliasing#canCall| $Heap@@10 this@@14) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Object) ($IsAlloc refType this@@14 Tclass._module.Object $Heap@@10)))))) (and (and (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@14)) (|_module.Object.objectClassKind#canCall| this@@14)) (=> (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@14) |#_module.ObjectClassKind.Thread|) ($Is refType this@@14 Tclass._module.Thread)) (and (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@14)) (|_module.Object.objectClassKind#canCall| this@@14)) (=> (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@14) |#_module.ObjectClassKind.OwnedObject|) ($Is refType this@@14 Tclass._module.OwnedObject)) (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@14)) (|_module.Object.objectClassKind#canCall| this@@14)))))) (= (_module.Object.nonAliasing $Heap@@10 this@@14)  (and (and (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@14) |#_module.ObjectClassKind.Thread|) ($Is refType this@@14 Tclass._module.Thread)) (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@14) |#_module.ObjectClassKind.OwnedObject|) ($Is refType this@@14 Tclass._module.OwnedObject))) (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@14) |#_module.ObjectClassKind.Lifetime|) ($Is refType this@@14 Tclass._module.Lifetime))))))
 :qid |_12MutexLifetimelongdfy.310:19|
 :skolemid |1723|
 :pattern ( (_module.Object.nonAliasing $Heap@@10 this@@14) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@15 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@15) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@15 null)) (not true)) ($Is refType this@@15 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind this@@15) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1853|
 :pattern ( (_module.Thread.objectClassKind this@@15))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@16 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@16) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@16 null)) (not true)) ($Is refType this@@16 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind this@@16) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2117|
 :pattern ( (_module.OwnedObject.objectClassKind this@@16))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@17 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@17) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@17 null)) (not true)) ($Is refType this@@17 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind this@@17) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2293|
 :pattern ( (_module.Lifetime.objectClassKind this@@17))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.OwnedObject.objectUserFields#canCall| $Heap@@11 this@@18) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@11) (or (not (= this@@18 null)) (not true))) ($IsAlloc refType this@@18 Tclass._module.OwnedObject $Heap@@11)))) ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@11 this@@18) (TSet Tclass._module.Object) $Heap@@11))
 :qid |_12MutexLifetimelongdfy.519:18|
 :skolemid |2227|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@11 this@@18) (TSet Tclass._module.Object) $Heap@@11))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@12 this@@19) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@12) (or (not (= this@@19 null)) (not true))) ($IsAlloc refType this@@19 Tclass._module.OwnedObject $Heap@@12)))) ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@12 this@@19) (TSet Tclass._module.Object) $Heap@@12))
 :qid |_12MutexLifetimelongdfy.427:18|
 :skolemid |2124|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@12 this@@19) (TSet Tclass._module.Object) $Heap@@12))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@13 this@@20) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Object) ($IsAlloc refType this@@20 Tclass._module.Object $Heap@@13)))))) (_module.Object.triggerAxioms $Heap@@13 this@@20))
 :qid |_12MutexLifetimelongdfy.315:19|
 :skolemid |1729|
...
(assert (forall (($h0@@3 T@U) ($h1@@3 T@U) (this@@21 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@26 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (= $o@@26 this@@21)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@26) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@26) $f@@4)))
 :qid |unknown.0:0|
 :skolemid |1719|
)) (= (_module.Object.nonAliasing $h0@@3 this@@21) (_module.Object.nonAliasing $h1@@3 this@@21))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1720|
 :pattern ( ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3) (_module.Object.nonAliasing $h1@@3 this@@21))
)))
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@22 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@27 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@27 null)) (not true)) (= $o@@27 this@@22)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@27) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@27) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |1727|
)) (= (_module.Object.triggerAxioms $h0@@4 this@@22) (_module.Object.triggerAxioms $h1@@4 this@@22))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1728|
 :pattern ( ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4) (_module.Object.triggerAxioms $h1@@4 this@@22))
)))
...
(assert (forall (($h0@@5 T@U) ($h1@@5 T@U) (this@@26 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@26 null)) (not true)) ($Is refType this@@26 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@28 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (or (= $o@@28 this@@26) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 this@@26) _module.Universe.content)) ($Box refType $o@@28)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@28) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@28) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |1174|
)) (= (_module.Universe.globalBaseInv $h0@@5 this@@26) (_module.Universe.globalBaseInv $h1@@5 this@@26))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1175|
 :pattern ( ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5) (_module.Universe.globalBaseInv $h1@@5 this@@26))
)))
...
(assert (forall (($h0@@6 T@U) ($h1@@6 T@U) (this@@27 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@27 null)) (not true)) ($Is refType this@@27 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@29 T@U) ($f@@7 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (= $o@@29 this@@27)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@29) $f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@29) $f@@7)))
 :qid |unknown.0:0|
 :skolemid |2121|
)) (= (_module.OwnedObject.objectFields $h0@@6 this@@27) (_module.OwnedObject.objectFields $h1@@6 this@@27))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2122|
 :pattern ( ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6) (_module.OwnedObject.objectFields $h1@@6 this@@27))
)))
(assert (forall (($h0@@7 T@U) ($h1@@7 T@U) (this@@28 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@28 null)) (not true)) ($Is refType this@@28 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@30 T@U) ($f@@8 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (= $o@@30 this@@28)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@30) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@30) $f@@8)))
 :qid |unknown.0:0|
 :skolemid |2224|
)) (= (_module.OwnedObject.objectUserFields $h0@@7 this@@28) (_module.OwnedObject.objectUserFields $h1@@7 this@@28))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2225|
 :pattern ( ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7) (_module.OwnedObject.objectUserFields $h1@@7 this@@28))
)))
(assert (forall (($h@@22 T@U) ($o@@31 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@22) (and (or (not (= $o@@31 null)) (not true)) ($Is refType $o@@31 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@31) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@31) _module.OwnedObject.owner)) Tclass._module.Object? $h@@22))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2107|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@22 $o@@31) _module.OwnedObject.owner)))
)))
(assert (forall (($h0@@8 T@U) ($h1@@8 T@U) (this@@29 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Object) ($IsAlloc refType this@@29 Tclass._module.Object $h0@@8)))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@32 T@U) ($f@@9 T@U) ) (!  (=> (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@32) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@32) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@32) $f@@9)))
 :qid |unknown.0:0|
 :skolemid |1699|
)) (= (_module.Object.objectGlobalBaseInv $h0@@8 this@@29) (_module.Object.objectGlobalBaseInv $h1@@8 this@@29))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1700|
 :pattern ( ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8) (_module.Object.objectGlobalBaseInv $h1@@8 this@@29))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 16)) (or (not (= |o#0_0@0| null)) (not true))) (=> (or (not (= |o#0_0@0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 15)) ($IsAlloc refType |o#0_0@0| Tclass._module.Object $Heap@@15)) (=> ($IsAlloc refType |o#0_0@0| Tclass._module.Object $Heap@@15) (=> (= call0formal@previous$Heap@0 $Heap@@15) (and (=> (= (ControlFlow 0 11) (- 0 14)) (_module.Object.baseFieldsInv call0formal@previous$Heap@0 |o#0_0@0|)) (=> (_module.Object.baseFieldsInv call0formal@previous$Heap@0 |o#0_0@0|) (and (=> (= (ControlFlow 0 11) (- 0 13)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 (_module.Object.universe |o#0_0@0|)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe |o#0_0@0|)) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 (_module.Object.universe |o#0_0@0|)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe |o#0_0@0|)) _module.Universe.content))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (forall (($o@@42 T@U) ($f@@10 T@U) ) (!  (=> (or (not (= $o@@42 null)) (not true)) (=> (= $o@@42 |o#0_0@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@42) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@42) $f@@10))))
 :qid |_12MutexLifetimelongdfy.350:124|
 :skolemid |1780|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@42) $f@@10))
))) (=> (forall (($o@@43 T@U) ($f@@11 T@U) ) (!  (=> (or (not (= $o@@43 null)) (not true)) (=> (= $o@@43 |o#0_0@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@43) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@43) $f@@11))))
 :qid |_12MutexLifetimelongdfy.350:124|
 :skolemid |1780|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@43) $f@@11))
)) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (|_module.Object.baseFieldsInv#canCall| $Heap@0 |o#0_0@0|) (_module.Object.baseFieldsInv $Heap@0 |o#0_0@0|)) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 11) (- 0 10)))) (_module.Object.baseFieldsInv $Heap@1 |o#0_0@0|))))))))))))))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (or (not (= |o#0_0@0| null)) (not true)))))
(let ((anon5_Then_correct  (=> ($Is refType |o#0_0@0| Tclass._module.Object) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= (_module.Object.universe this@@38) null)) (not true))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#0_0@0|)) (and (=> (= (ControlFlow 0 17) 9) anon6_Then_correct) (=> (= (ControlFlow 0 17) 11) anon6_Else_correct)))))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@2 this@@38) (or (_module.Object.objectGlobalBaseInv $Heap@2 this@@38) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType this@@38))))) (=> (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@2 this@@38) (or (_module.Object.objectGlobalBaseInv $Heap@2 this@@38) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType this@@38)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@2 this@@38) (or (_module.Object.objectGlobalBaseInv $Heap@2 this@@38) (_module.Object.baseFieldsInv $Heap@2 this@@38)))) (=> (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@2 this@@38) (or (_module.Object.objectGlobalBaseInv $Heap@2 this@@38) (_module.Object.baseFieldsInv $Heap@2 this@@38))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@2 this@@38) (or (_module.Object.objectGlobalBaseInv $Heap@2 this@@38) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@38)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@38)) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@2 this@@38) (or (_module.Object.objectGlobalBaseInv $Heap@2 this@@38) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@38)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@38)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@2 this@@38) (or (_module.Object.objectGlobalBaseInv $Heap@2 this@@38) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@38)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@38)) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#3|))) (and (and (and (= (_module.Object.universe |o#3|) (_module.Object.universe this@@38)) (or (not (= |o#3| (_module.Object.universe this@@38))) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#3|)) (_module.Object.triggerAxioms $Heap@2 |o#3|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1742|
 :pattern ( (_module.Object.triggerAxioms $Heap@2 |o#3|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@2 |o#3|))
 :pattern ( (_module.Object.universe |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#3|)))
))))))) (=> (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@2 this@@38) (or (_module.Object.objectGlobalBaseInv $Heap@2 this@@38) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 (_module.Object.universe this@@38)) (or (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@38)) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#3@@0|))) (and (and (and (= (_module.Object.universe |o#3@@0|) (_module.Object.universe this@@38)) (or (not (= |o#3@@0| (_module.Object.universe this@@38))) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#3@@0|)) (_module.Object.triggerAxioms $Heap@2 |o#3@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1742|
 :pattern ( (_module.Object.triggerAxioms $Heap@2 |o#3@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@2 |o#3@@0|))
 :pattern ( (_module.Object.universe |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@38)) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@38)) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@38)))))))))))))))
(let ((anon5_Else_correct  (=> (forall ((|o#0_1| T@U) ) (!  (=> (and ($Is refType |o#0_1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#0_1|))) (_module.Object.baseFieldsInv $Heap@0 |o#0_1|))
 :qid |_12MutexLifetimelongdfy.327:12|
 :skolemid |1746|
 :pattern ( (_module.Object.baseFieldsInv $Heap@0 |o#0_1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#0_1|)))
)) (=> (and (= $Heap@2 $Heap@0) (= (ControlFlow 0 7) 2)) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#140| null $Heap@@15 alloc (_module.Object.universe this@@38))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (or (not (= (_module.Object.universe this@@38) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@38) null)) (not true)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 (_module.Object.universe this@@38) _module.Universe.content))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 (_module.Object.universe this@@38) _module.Universe.content)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (not (= (_module.Object.universe this@@38) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@38) null)) (not true)) (=> (= |$rhs#0@0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@38)) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@38)))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@38) (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@38)) _module.Universe.content ($Box SetType |$rhs#0@0|)))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 19) 17) anon5_Then_correct) (=> (= (ControlFlow 0 19) 7) anon5_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@15) ($IsHeapAnchor $Heap@@15)) (=> (and (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.Object) ($IsAlloc refType this@@38 Tclass._module.Object $Heap@@15))) (= 9 $FunctionContextHeight)) (=> (and (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@@15 (_module.Object.universe this@@38)) (and (_module.Universe.globalBaseInv $Heap@@15 (_module.Object.universe this@@38)) (and true (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#2|))) (and (and (and (= (_module.Object.universe |o#2|) (_module.Object.universe this@@38)) (or (not (= |o#2| (_module.Object.universe this@@38))) (not true))) (_module.Object.baseFieldsInv $Heap@@15 |o#2|)) (_module.Object.triggerAxioms $Heap@@15 |o#2|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1741|
 :pattern ( (_module.Object.triggerAxioms $Heap@@15 |o#2|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@15 |o#2|))
 :pattern ( (_module.Object.universe |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.Object.universe this@@38)) _module.Universe.content)) ($Box refType |o#2|)))
))))) (_module.Object.baseFieldsInv $Heap@@15 this@@38)) (and (or (not (= this@@38 (_module.Object.universe this@@38))) (not true)) (= (ControlFlow 0 23) 19))) anon0_correct)))))
