...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@1 this@@1) (and (< 4 $FunctionContextHeight) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.OwnedObject)))) (= (_module.Object.baseFieldsInv $Heap@@1 this@@1) (_module.OwnedObject.baseFieldsInv $Heap@@1 this@@1)))
 :qid |_10SequenceInvariantdfy.239:19|
 :skolemid |1445|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@1 this@@1) ($Is refType this@@1 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@1))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@1 this@@1) (_module.OwnedObject.baseFieldsInv $Heap@@1 this@@1) ($IsGoodHeap $Heap@@1))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@2 this@@2) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.Thread)))) (= (_module.Object.localInv $Heap@@2 this@@2) (_module.Thread.localInv $Heap@@2 this@@2)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@3 this@@3) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.OwnedObject)))) (= (_module.Object.localInv $Heap@@3 this@@3) (_module.OwnedObject.localInv $Heap@@3 this@@3)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1461|
 :pattern ( (_module.Object.localInv $Heap@@3 this@@3) ($Is refType this@@3 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.Object.localInv $Heap@@3 this@@3) (_module.OwnedObject.localInv $Heap@@3 this@@3) ($IsGoodHeap $Heap@@3))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@4 this@@4) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Object) ($IsAlloc refType this@@4 Tclass._module.Object $Heap@@4)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType this@@4)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@4 this@@4) (=> (_module.Object.baseFieldsInv $Heap@@4 this@@4) (|_module.Universe.globalBaseInv#canCall| $Heap@@4 (_module.Object.universe this@@4))))) (= (_module.Object.objectGlobalBaseInv $Heap@@4 this@@4)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType this@@4)) (_module.Object.baseFieldsInv $Heap@@4 this@@4)) (_module.Universe.globalBaseInv $Heap@@4 (_module.Object.universe this@@4))))))
 :qid |_10SequenceInvariantdfy.196:19|
 :skolemid |1046|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@4 this@@4) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@5 this@@5) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@5) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.Thread) ($IsAlloc refType this@@5 Tclass._module.Thread $Heap@@5)))))) (= (_module.Thread.baseFieldsInv $Heap@@5 this@@5) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.254:19|
 :skolemid |1191|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@5 this@@5) ($IsGoodHeap $Heap@@5))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@6 this@@6) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.OwnedObject) ($IsAlloc refType this@@6 Tclass._module.OwnedObject $Heap@@6)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@6 this@@6) (=> (_module.Object.objectGlobalBaseInv $Heap@@6 this@@6) (|_module.OwnedObject.localUserInv#canCall| $Heap@@6 this@@6))) (= (_module.OwnedObject.localInv $Heap@@6 this@@6)  (and (_module.Object.objectGlobalBaseInv $Heap@@6 this@@6) (_module.OwnedObject.localUserInv $Heap@@6 this@@6)))))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1460|
 :pattern ( (_module.OwnedObject.localInv $Heap@@6 this@@6) ($IsGoodHeap $Heap@@6))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@7 this@@7) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Universe) ($IsAlloc refType this@@7 Tclass._module.Universe $Heap@@7)))))) (and (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@7) _module.Universe.content)) ($Box refType |o#0|)) (=> (= (_module.Object.universe |o#0|) this@@7) (=> (or (not (= |o#0| this@@7)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@7 |o#0|) (=> (_module.Object.baseFieldsInv $Heap@@7 |o#0|) (|_module.Object.triggerAxioms#canCall| $Heap@@7 |o#0|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@7 |o#0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 |o#0|))
 :pattern ( (_module.Object.universe |o#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@7) _module.Universe.content)) ($Box refType |o#0|)))
)) (= (_module.Universe.globalBaseInv $Heap@@7 this@@7) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@7) _module.Universe.content)) ($Box refType |o#0@@0|))) (and (and (and (= (_module.Object.universe |o#0@@0|) this@@7) (or (not (= |o#0@@0| this@@7)) (not true))) (_module.Object.baseFieldsInv $Heap@@7 |o#0@@0|)) (_module.Object.triggerAxioms $Heap@@7 |o#0@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 :pattern ( (_module.Object.triggerAxioms $Heap@@7 |o#0@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 |o#0@@0|))
 :pattern ( (_module.Object.universe |o#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@7) _module.Universe.content)) ($Box refType |o#0@@0|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@7 this@@7) ($IsGoodHeap $Heap@@7))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@9 this@@9) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.Thread) ($IsAlloc refType this@@9 Tclass._module.Thread $Heap@@9)))))) (=> (_module.Thread.localInv $Heap@@9 this@@9) (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9)))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1203|
 :pattern ( (_module.Thread.localInv $Heap@@9 this@@9))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@10 this@@10) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.OwnedObject) ($IsAlloc refType this@@10 Tclass._module.OwnedObject $Heap@@10)))))) (=> (_module.OwnedObject.localInv $Heap@@10 this@@10) (_module.Object.objectGlobalBaseInv $Heap@@10 this@@10)))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1458|
 :pattern ( (_module.OwnedObject.localInv $Heap@@10 this@@10))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@11 this@@11) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Object) ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@11)))))) (=> (_module.Object.localInv $Heap@@11 this@@11) (_module.Object.objectGlobalBaseInv $Heap@@11 this@@11)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1116|
 :pattern ( (_module.Object.localInv $Heap@@11 this@@11))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@12 this@@12) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Thread) ($IsAlloc refType this@@12 Tclass._module.Thread $Heap@@12)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@12 this@@12)) (= (_module.Thread.localInv $Heap@@12 this@@12)  (and true (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12)))))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1205|
 :pattern ( (_module.Thread.localInv $Heap@@12 this@@12) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@13 this@@13) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Object) ($IsAlloc refType this@@13 Tclass._module.Object $Heap@@13)))))) (= (_module.Object.triggerAxioms $Heap@@13 this@@13)  (and (or ($Is refType this@@13 Tclass._module.OwnedObject) ($Is refType this@@13 Tclass._module.Thread)) (not (and ($Is refType this@@13 Tclass._module.OwnedObject) ($Is refType this@@13 Tclass._module.Thread))))))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1066|
...
(let ((anon8_Else_correct  (=> (and (=> (_module.Object.localInv $Heap@@14 this@@14) (_module.Object.objectGlobalBaseInv $Heap@@14 this@@14)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($IsAllocBox ($Box refType this@@14) Tclass._module.Object? $Heap@@14) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (= this@@14 this@@14) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@14 this@@14) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@14 this@@14) (|_module.Object.localInv#canCall| $Heap@@14 this@@14)) (_module.Object.localInv $Heap@@14 this@@14)) (=> (and (and ($IsAllocBox ($Box refType this@@14) Tclass._module.Object? $Heap@@14) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@14 this@@14)) (and (_module.Object.objectGlobalBaseInv $Heap@@14 this@@14) (= (ControlFlow 0 3) 2))) anon5_correct)))))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@14 alloc $Heap@@14 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Else_correct) (=> (= (ControlFlow 0 6) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@14) ($IsHeapAnchor $Heap@@14)) (=> (and (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Object) ($IsAlloc refType this@@14 Tclass._module.Object $Heap@@14))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
