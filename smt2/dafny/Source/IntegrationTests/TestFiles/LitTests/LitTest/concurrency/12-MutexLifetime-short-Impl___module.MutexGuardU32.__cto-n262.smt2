...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split31)
...
)))) (= $Heap@1 $Heap@2)) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
