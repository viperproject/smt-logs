...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#57| |l#0| |l#1| |l#2| |l#3|) $o $f))  (=> (and (or (not (= $o |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3520|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#57| |l#0| |l#1| |l#2| |l#3|) $o $f))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Bump)
...
(let ((anon4_Then_correct  (=> ($IsAlloc intType (int_2_U |last#0@@0|) TInt $Heap) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 |last#0@@0|) (= |last#0@@0| |last#0@@0|))) (=> (or (<= 0 |last#0@@0|) (= |last#0@@0| |last#0@@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (= |last#0@@0| |last#0@@0|) (< |last#0@@0| |last#0@@0|))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#57| null $Heap alloc false)) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))
