...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@45 T@U) (this@@66 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@45 this@@66) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@45) (and (or (not (= this@@66 null)) (not true)) (and ($Is refType this@@66 Tclass._module.Lifetime) ($IsAlloc refType this@@66 Tclass._module.Lifetime $Heap@@45)))))) (=> (_module.Lifetime.localInv $Heap@@45 this@@66) (_module.Object.objectGlobalBaseInv $Heap@@45 this@@66)))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2318|
 :pattern ( (_module.Lifetime.localInv $Heap@@45 this@@66))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@46 T@U) (this@@67 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@46 this@@67) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@46) (and (or (not (= this@@67 null)) (not true)) (and ($Is refType this@@67 Tclass._module.Thread) ($IsAlloc refType this@@67 Tclass._module.Thread $Heap@@46)))))) (=> (_module.Thread.inv $Heap@@46 this@@67) (_module.Thread.localInv $Heap@@46 this@@67)))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1883|
 :pattern ( (_module.Thread.inv $Heap@@46 this@@67))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@47 T@U) (this@@68 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@47 this@@68) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@47) (and (or (not (= this@@68 null)) (not true)) (and ($Is refType this@@68 Tclass._module.Lifetime) ($IsAlloc refType this@@68 Tclass._module.Lifetime $Heap@@47)))))) (=> (_module.Lifetime.inv $Heap@@47 this@@68) (_module.Lifetime.localInv $Heap@@47 this@@68)))
 :qid |_12MutexLifetimelongdfy.589:19|
 :skolemid |2385|
 :pattern ( (_module.Lifetime.inv $Heap@@47 this@@68))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@48 T@U) (this@@69 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@48 this@@69) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@48) (and (or (not (= this@@69 null)) (not true)) (and ($Is refType this@@69 Tclass._module.Object) ($IsAlloc refType this@@69 Tclass._module.Object $Heap@@48)))))) (=> (_module.Object.localInv $Heap@@48 this@@69) (_module.Object.objectGlobalBaseInv $Heap@@48 this@@69)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |1783|
 :pattern ( (_module.Object.localInv $Heap@@48 this@@69))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@49 T@U) (this@@70 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@49 this@@70) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@49) (and (or (not (= this@@70 null)) (not true)) (and ($Is refType this@@70 Tclass._module.OwnedObject) ($IsAlloc refType this@@70 Tclass._module.OwnedObject $Heap@@49)))))) (=> (_module.OwnedObject.userInv $Heap@@49 this@@70) (_module.OwnedObject.localUserInv $Heap@@49 this@@70)))
 :qid |_12MutexLifetimelongdfy.523:19|
 :skolemid |2243|
 :pattern ( (_module.OwnedObject.userInv $Heap@@49 this@@70))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@50 T@U) (this@@71 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@50 this@@71) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@50) (and (or (not (= this@@71 null)) (not true)) (and ($Is refType this@@71 Tclass._module.OwnedObject) ($IsAlloc refType this@@71 Tclass._module.OwnedObject $Heap@@50)))))) (=> (_module.OwnedObject.inv $Heap@@50 this@@71) (_module.OwnedObject.localInv $Heap@@50 this@@71)))
 :qid |_12MutexLifetimelongdfy.449:19|
 :skolemid |2163|
 :pattern ( (_module.OwnedObject.inv $Heap@@50 this@@71))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($Heap@@51 T@U) (this@@72 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@51 this@@72) (and (< 15 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@51) (and (or (not (= this@@72 null)) (not true)) (and ($Is refType this@@72 Tclass._module.Object) ($IsAlloc refType this@@72 Tclass._module.Object $Heap@@51)))))) (=> (_module.Object.inv $Heap@@51 this@@72) (_module.Object.localInv $Heap@@51 this@@72)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |1793|
 :pattern ( (_module.Object.inv $Heap@@51 this@@72))
))))
...
(assert (forall (($ly@@14 T@U) ($h0@@17 T@U) ($h1@@17 T@U) (this@@73 T@U) (|_k#0@@9| Int) (|a#0@@14| T@U) (|x#0@@9| T@U) (|b#0@@14| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@73 null)) (not true)) ($Is refType this@@73 Tclass._module.Universe))) (or (|_module.Universe.outlivesThrough_h#canCall| $h0@@17 this@@73 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (and (and (and (<= (LitInt 0) |_k#0@@9|) ($Is refType |a#0@@14| Tclass._module.Lifetime)) ($Is refType |x#0@@9| Tclass._module.Lifetime)) ($Is refType |b#0@@14| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@44 T@U) ($f@@21 T@U) ) (!  (=> (and (or (not (= $o@@44 null)) (not true)) (or (or (= $o@@44 this@@73) (and (and ($Is refType $o@@44 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 this@@73) _module.Universe.content)) ($Box refType $o@@44))) (= $f@@21 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@44 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 this@@73) _module.Universe.content)) ($Box refType $o@@44))) (= $f@@21 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@44) $f@@21) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@44) $f@@21)))
 :qid |unknown.0:0|
 :skolemid |1609|
)) (= (_module.Universe.outlivesThrough_h $ly@@14 $h0@@17 this@@73 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (_module.Universe.outlivesThrough_h $ly@@14 $h1@@17 this@@73 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|))))
 :qid |unknown.0:0|
 :skolemid |1610|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.Universe.outlivesThrough_h $ly@@14 $h1@@17 this@@73 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@17 T@U) ($Heap@@52 T@U) (this@@74 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@17 $Heap@@52 this@@74) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@17) ($IsGoodHeap $Heap@@52)) ($HeapSucc $prevHeap@@17 $Heap@@52)) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.OwnedObject) ($IsAlloc refType this@@74 Tclass._module.OwnedObject $prevHeap@@17)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@74) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@74) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@17 $Heap@@52 this@@74)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@17 $Heap@@52 this@@74)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@74) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@74) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@17 $Heap@@52 this@@74)))))
 :qid |_12MutexLifetimelongdfy.438:22|
 :skolemid |2147|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@17 $Heap@@52 this@@74) ($IsGoodHeap $Heap@@52))
))))
...
(assert (forall (($ly@@15 T@U) ($h0@@18 T@U) ($h1@@18 T@U) (this@@75 T@U) (|a#0@@15| T@U) (|b#0@@15| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@75 null)) (not true)) ($Is refType this@@75 Tclass._module.Universe))) (or (|_module.Universe.outlives#canCall| $h0@@18 this@@75 |a#0@@15| |b#0@@15|) (and ($Is refType |a#0@@15| Tclass._module.Lifetime) ($Is refType |b#0@@15| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@45 T@U) ($f@@22 T@U) ) (!  (=> (and (or (not (= $o@@45 null)) (not true)) (or (or (= $o@@45 this@@75) (and (and ($Is refType $o@@45 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 this@@75) _module.Universe.content)) ($Box refType $o@@45))) (= $f@@22 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@45 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 this@@75) _module.Universe.content)) ($Box refType $o@@45))) (= $f@@22 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@45) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@45) $f@@22)))
 :qid |unknown.0:0|
 :skolemid |1570|
)) (= (_module.Universe.outlives $ly@@15 $h0@@18 this@@75 |a#0@@15| |b#0@@15|) (_module.Universe.outlives $ly@@15 $h1@@18 this@@75 |a#0@@15| |b#0@@15|))))
 :qid |unknown.0:0|
 :skolemid |1571|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.Universe.outlives $ly@@15 $h1@@18 this@@75 |a#0@@15| |b#0@@15|))
)))
...
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@76 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@76 null)) (not true)) ($Is refType this@@76 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@47 T@U) ($f@@23 T@U) ) (!  (=> (and (or (not (= $o@@47 null)) (not true)) (= $o@@47 this@@76)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@47) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@47) $f@@23)))
 :qid |unknown.0:0|
 :skolemid |1719|
)) (= (_module.Object.nonAliasing $h0@@19 this@@76) (_module.Object.nonAliasing $h1@@19 this@@76))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1720|
 :pattern ( ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19) (_module.Object.nonAliasing $h1@@19 this@@76))
)))
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@77 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@77 null)) (not true)) ($Is refType this@@77 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@48 T@U) ($f@@24 T@U) ) (!  (=> (and (or (not (= $o@@48 null)) (not true)) (= $o@@48 this@@77)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@48) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@48) $f@@24)))
 :qid |unknown.0:0|
 :skolemid |1727|
)) (= (_module.Object.triggerAxioms $h0@@20 this@@77) (_module.Object.triggerAxioms $h1@@20 this@@77))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1728|
 :pattern ( ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20) (_module.Object.triggerAxioms $h1@@20 this@@77))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@78 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@78)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@78 null)) (not true)) ($Is refType this@@78 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@78)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimelongdfy.362:18|
 :weight 3
 :skolemid |1854|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@78)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@79 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@79)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@79 null)) (not true)) ($Is refType this@@79 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@79)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimelongdfy.425:18|
 :weight 3
 :skolemid |2118|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@79)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@80 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@80)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@80 null)) (not true)) ($Is refType this@@80 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@80)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimelongdfy.562:18|
 :weight 3
 :skolemid |2294|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@80)))
))))
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@81 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@81 null)) (not true)) ($Is refType this@@81 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@49 T@U) ($f@@25 T@U) ) (!  (=> (and (or (not (= $o@@49 null)) (not true)) (or (= $o@@49 this@@81) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 this@@81) _module.Universe.content)) ($Box refType $o@@49)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@49) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@49) $f@@25)))
 :qid |unknown.0:0|
 :skolemid |1174|
)) (= (_module.Universe.globalBaseInv $h0@@21 this@@81) (_module.Universe.globalBaseInv $h1@@21 this@@81))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1175|
 :pattern ( ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21) (_module.Universe.globalBaseInv $h1@@21 this@@81))
)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@53 T@U) (this@@82 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@53 this@@82) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@53) (and (or (not (= this@@82 null)) (not true)) (and ($Is refType this@@82 Tclass._module.Lifetime) ($IsAlloc refType this@@82 Tclass._module.Lifetime $Heap@@53)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@53 this@@82) (=> (_module.Object.objectGlobalBaseInv $Heap@@53 this@@82) (=> (forall ((|o#0@@7| T@U) ) (!  (=> (and ($Is refType |o#0@@7| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#0@@7|))) (= (_module.OwnedObject.lifetime |o#0@@7|) this@@82))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2333|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#0@@7|)))
)) (and (forall ((|o#1@@1| T@U) ) (!  (=> ($Is refType |o#1@@1| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#1@@1|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@53 |o#1@@1|) (|_module.Lifetime.alive#canCall| $Heap@@53 this@@82))))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2326|
 :pattern ( (_module.OwnedObject.alive $Heap@@53 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#1@@1|)))
)) (=> (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#1@@2|))) (= (_module.OwnedObject.alive $Heap@@53 |o#1@@2|) (_module.Lifetime.alive $Heap@@53 this@@82)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2332|
 :pattern ( (_module.OwnedObject.alive $Heap@@53 |o#1@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#1@@2|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@53 this@@82) (=> (_module.Lifetime.alive $Heap@@53 this@@82) (forall ((|l#0@@4| T@U) ) (!  (=> ($Is refType |l#0@@4| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|)) (|_module.Lifetime.alive#canCall| $Heap@@53 |l#0@@4|)))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2327|
 :pattern ( (_module.Lifetime.alive $Heap@@53 |l#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@53 this@@82) (forall ((|l#0@@5| T@U) ) (!  (=> (and ($Is refType |l#0@@5| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@5|))) (_module.Lifetime.alive $Heap@@53 |l#0@@5|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2331|
 :pattern ( (_module.Lifetime.alive $Heap@@53 |l#0@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@5|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@53 this@@82) (=> (not (_module.Lifetime.alive $Heap@@53 this@@82)) (forall ((|l#1@@2| T@U) ) (!  (=> ($Is refType |l#1@@2| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@2|)) (|_module.Lifetime.alive#canCall| $Heap@@53 |l#1@@2|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2328|
 :pattern ( (_module.Lifetime.alive $Heap@@53 |l#1@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@2|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@53 this@@82)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@53 this@@82) (forall ((|o#0@@8| T@U) ) (!  (=> (and ($Is refType |o#0@@8| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#0@@8|))) (= (_module.OwnedObject.lifetime |o#0@@8|) this@@82))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2320|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#0@@8|)))
))) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#1@@3|))) (= (_module.OwnedObject.alive $Heap@@53 |o#1@@3|) (_module.Lifetime.alive $Heap@@53 this@@82)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2321|
 :pattern ( (_module.OwnedObject.alive $Heap@@53 |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.elements)) ($Box refType |o#1@@3|)))
))) (=> (_module.Lifetime.alive $Heap@@53 this@@82) (forall ((|l#0@@6| T@U) ) (!  (=> (and ($Is refType |l#0@@6| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@6|))) (_module.Lifetime.alive $Heap@@53 |l#0@@6|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2322|
 :pattern ( (_module.Lifetime.alive $Heap@@53 |l#0@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@6|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@53 this@@82)) (forall ((|l#1@@3| T@U) ) (!  (=> (and ($Is refType |l#1@@3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@3|))) (not (_module.Lifetime.alive $Heap@@53 |l#1@@3|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2323|
 :pattern ( (_module.Lifetime.alive $Heap@@53 |l#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@3|)))
)))) (forall ((|l#2@@1| T@U) ) (!  (=> (and ($Is refType |l#2@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 |l#2@@1|) _module.Lifetime.mightPointFrom)) ($Box refType this@@82)))
 :qid |_12MutexLifetimelongdfy.586:16|
 :skolemid |2324|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 |l#2@@1|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@1|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@82)))
 :qid |_12MutexLifetimelongdfy.587:16|
 :skolemid |2325|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 |l#3@@0|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2334|
 :pattern ( (_module.Lifetime.localInv $Heap@@53 this@@82) ($IsGoodHeap $Heap@@53))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@16 T@U) ($Heap@@54 T@U) (this@@83 T@U) (|a#0@@16| T@U) (|b#0@@16| T@U) (|_k#0@@10| Int) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@54) (and (or (not (= this@@83 null)) (not true)) ($Is refType this@@83 Tclass._module.Universe))) ($Is refType |a#0@@16| Tclass._module.Lifetime)) ($Is refType |b#0@@16| Tclass._module.Lifetime)) (= |_k#0@@10| 0)) (not (_module.Universe.outlives_h $ly@@16 $Heap@@54 this@@83 |_k#0@@10| |a#0@@16| |b#0@@16|)))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1580|
 :pattern ( (_module.Universe.outlives_h $ly@@16 $Heap@@54 this@@83 |_k#0@@10| |a#0@@16| |b#0@@16|))
))))
...
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@84 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@84 null)) (not true)) ($Is refType this@@84 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@50 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@50 null)) (not true)) (= $o@@50 this@@84)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@50) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@50) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |2121|
)) (= (_module.OwnedObject.objectFields $h0@@22 this@@84) (_module.OwnedObject.objectFields $h1@@22 this@@84))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2122|
 :pattern ( ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22) (_module.OwnedObject.objectFields $h1@@22 this@@84))
)))
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@85 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@85 null)) (not true)) ($Is refType this@@85 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@51 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@51 null)) (not true)) (= $o@@51 this@@85)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@51) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@51) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |2224|
)) (= (_module.OwnedObject.objectUserFields $h0@@23 this@@85) (_module.OwnedObject.objectUserFields $h1@@23 this@@85))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2225|
 :pattern ( ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23) (_module.OwnedObject.objectUserFields $h1@@23 this@@85))
)))
...
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@86 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@86 null)) (not true)) (and ($Is refType this@@86 Tclass._module.Universe) ($IsAlloc refType this@@86 Tclass._module.Universe $h0@@24)))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@53 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@53 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@53) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@53) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@53) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |1186|
)) (= (_module.Universe.globalInv $h0@@24 this@@86) (_module.Universe.globalInv $h1@@24 this@@86))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1187|
 :pattern ( ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24) (_module.Universe.globalInv $h1@@24 this@@86))
)))
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@87 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@87 null)) (not true)) (and ($Is refType this@@87 Tclass._module.Object) ($IsAlloc refType this@@87 Tclass._module.Object $h0@@25)))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@54 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@54) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@54) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@54) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |1699|
)) (= (_module.Object.objectGlobalBaseInv $h0@@25 this@@87) (_module.Object.objectGlobalBaseInv $h1@@25 this@@87))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1700|
 :pattern ( ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25) (_module.Object.objectGlobalBaseInv $h1@@25 this@@87))
)))
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@88 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@88 null)) (not true)) (and ($Is refType this@@88 Tclass._module.Object) ($IsAlloc refType this@@88 Tclass._module.Object $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@55 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@55 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@55) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@55) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@55) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |1781|
)) (= (_module.Object.localInv $h0@@26 this@@88) (_module.Object.localInv $h1@@26 this@@88))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1782|
 :pattern ( ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26) (_module.Object.localInv $h1@@26 this@@88))
)))
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@89 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@89 null)) (not true)) (and ($Is refType this@@89 Tclass._module.Object) ($IsAlloc refType this@@89 Tclass._module.Object $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@56 T@U) ($f@@31 T@U) ) (!  (=> (and (or (not (= $o@@56 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@56) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@56) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@56) $f@@31)))
 :qid |unknown.0:0|
 :skolemid |1791|
)) (= (_module.Object.inv $h0@@27 this@@89) (_module.Object.inv $h1@@27 this@@89))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1792|
 :pattern ( ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27) (_module.Object.inv $h1@@27 this@@89))
)))
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.Thread) ($IsAlloc refType this@@90 Tclass._module.Thread $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@57 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@57 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@57) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@57) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@57) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |1871|
)) (= (_module.Thread.localInv $h0@@28 this@@90) (_module.Thread.localInv $h1@@28 this@@90))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1872|
 :pattern ( ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28) (_module.Thread.localInv $h1@@28 this@@90))
)))
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@91 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.Thread) ($IsAlloc refType this@@91 Tclass._module.Thread $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@58 T@U) ($f@@33 T@U) ) (!  (=> (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@58) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@58) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@58) $f@@33)))
 :qid |unknown.0:0|
 :skolemid |1881|
)) (= (_module.Thread.inv $h0@@29 this@@91) (_module.Thread.inv $h1@@29 this@@91))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1882|
 :pattern ( ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29) (_module.Thread.inv $h1@@29 this@@91))
)))
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@92 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@92 null)) (not true)) (and ($Is refType this@@92 Tclass._module.OwnedObject) ($IsAlloc refType this@@92 Tclass._module.OwnedObject $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@59 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@59) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@59) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@59) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |2149|
)) (= (_module.OwnedObject.localInv $h0@@30 this@@92) (_module.OwnedObject.localInv $h1@@30 this@@92))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2150|
 :pattern ( ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30) (_module.OwnedObject.localInv $h1@@30 this@@92))
)))
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@93 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.OwnedObject) ($IsAlloc refType this@@93 Tclass._module.OwnedObject $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@60 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@60 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@60) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@60) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@60) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |2161|
)) (= (_module.OwnedObject.inv $h0@@31 this@@93) (_module.OwnedObject.inv $h1@@31 this@@93))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2162|
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.OwnedObject.inv $h1@@31 this@@93))
)))
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@94 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@94 null)) (not true)) (and ($Is refType this@@94 Tclass._module.OwnedObject) ($IsAlloc refType this@@94 Tclass._module.OwnedObject $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@61 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@61 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@61) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@61) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@61) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |2233|
)) (= (_module.OwnedObject.localUserInv $h0@@32 this@@94) (_module.OwnedObject.localUserInv $h1@@32 this@@94))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2234|
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.OwnedObject.localUserInv $h1@@32 this@@94))
)))
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@95 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@95 null)) (not true)) (and ($Is refType this@@95 Tclass._module.OwnedObject) ($IsAlloc refType this@@95 Tclass._module.OwnedObject $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@62 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@62 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@62) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@62) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@62) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |2241|
)) (= (_module.OwnedObject.userInv $h0@@33 this@@95) (_module.OwnedObject.userInv $h1@@33 this@@95))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2242|
 :pattern ( ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33) (_module.OwnedObject.userInv $h1@@33 this@@95))
)))
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@96 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@96 null)) (not true)) (and ($Is refType this@@96 Tclass._module.Lifetime) ($IsAlloc refType this@@96 Tclass._module.Lifetime $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@63 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@63) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@63) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@63) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |2316|
)) (= (_module.Lifetime.localInv $h0@@34 this@@96) (_module.Lifetime.localInv $h1@@34 this@@96))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2317|
 :pattern ( ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34) (_module.Lifetime.localInv $h1@@34 this@@96))
)))
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@97 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.Lifetime) ($IsAlloc refType this@@97 Tclass._module.Lifetime $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@64 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@64) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@64) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@64) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |2383|
)) (= (_module.Lifetime.inv $h0@@35 this@@97) (_module.Lifetime.inv $h1@@35 this@@97))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2384|
 :pattern ( ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35) (_module.Lifetime.inv $h1@@35 this@@97))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($prevHeap@@18 T@U) ($Heap@@55 T@U) (this@@101 T@U) ) (!  (=> (or (|_module.Universe.globalSequenceInv2#canCall| $prevHeap@@18 $Heap@@55 this@@101) (and (< 5 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@18) ($IsGoodHeap $Heap@@55)) ($HeapSucc $prevHeap@@18 $Heap@@55)) (and (or (not (= this@@101 null)) (not true)) (and ($Is refType this@@101 Tclass._module.Universe) ($IsAlloc refType this@@101 Tclass._module.Universe $prevHeap@@18)))))) (and (forall ((|o#0@@9| T@U) ) (!  (=> ($Is refType |o#0@@9| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@101) _module.Universe.content)) ($Box refType |o#0@@9|)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@55 this@@101) _module.Universe.content)) ($Box refType |o#0@@9|)) (|_module.Object.sequenceInv2#canCall| $prevHeap@@18 $Heap@@55 |o#0@@9|))))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |1203|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@18 $Heap@@55 |o#0@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@55 this@@101) _module.Universe.content)) ($Box refType |o#0@@9|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@101) _module.Universe.content)) ($Box refType |o#0@@9|)))
)) (= (_module.Universe.globalSequenceInv2 $prevHeap@@18 $Heap@@55 this@@101) (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@101) _module.Universe.content)) ($Box refType |o#0@@10|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@55 this@@101) _module.Universe.content)) ($Box refType |o#0@@10|)) (_module.Object.sequenceInv2 $prevHeap@@18 $Heap@@55 |o#0@@10|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |1202|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@18 $Heap@@55 |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@55 this@@101) _module.Universe.content)) ($Box refType |o#0@@10|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@101) _module.Universe.content)) ($Box refType |o#0@@10|)))
)))))
 :qid |_12MutexLifetimelongdfy.28:22|
 :skolemid |1204|
 :pattern ( (_module.Universe.globalSequenceInv2 $prevHeap@@18 $Heap@@55 this@@101) ($IsGoodHeap $Heap@@55))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@102 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@102) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@102 null)) (not true)) ($Is refType this@@102 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@102) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1851|
 :pattern ( (_module.Thread.objectClassKind this@@102))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@103 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@103) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@103 null)) (not true)) ($Is refType this@@103 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@103) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2115|
 :pattern ( (_module.OwnedObject.objectClassKind this@@103))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@104 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@104) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@104 null)) (not true)) ($Is refType this@@104 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@104) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2291|
 :pattern ( (_module.Lifetime.objectClassKind this@@104))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@105 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@105) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@105 null)) (not true)) ($Is refType this@@105 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@105) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1773|
 :pattern ( (_module.Object.objectClassKind this@@105))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@56 T@U) (this@@106 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@56 this@@106) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@56) (and (or (not (= this@@106 null)) (not true)) (and ($Is refType this@@106 Tclass._module.Thread) ($IsAlloc refType this@@106 Tclass._module.Thread $Heap@@56)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@56 this@@106)) (= (_module.Thread.localInv $Heap@@56 this@@106)  (and true (_module.Object.objectGlobalBaseInv $Heap@@56 this@@106)))))
 :qid |_12MutexLifetimelongdfy.369:19|
 :skolemid |1875|
 :pattern ( (_module.Thread.localInv $Heap@@56 this@@106) ($IsGoodHeap $Heap@@56))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@57 T@U) (this@@107 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@57 this@@107) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@57) (and (or (not (= this@@107 null)) (not true)) (and ($Is refType this@@107 Tclass._module.Thread) ($IsAlloc refType this@@107 Tclass._module.Thread $Heap@@57)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@57 this@@107)) (= (_module.Thread.inv $Heap@@57 this@@107)  (and true (_module.Thread.localInv $Heap@@57 this@@107)))))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1885|
 :pattern ( (_module.Thread.inv $Heap@@57 this@@107) ($IsGoodHeap $Heap@@57))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@58 T@U) (this@@108 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@58 this@@108) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@58) (and (or (not (= this@@108 null)) (not true)) (and ($Is refType this@@108 Tclass._module.OwnedObject) ($IsAlloc refType this@@108 Tclass._module.OwnedObject $Heap@@58)))))) (= (_module.OwnedObject.alive $Heap@@58 this@@108)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 this@@108) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.422:19|
 :skolemid |2114|
 :pattern ( (_module.OwnedObject.alive $Heap@@58 this@@108) ($IsGoodHeap $Heap@@58))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@59 T@U) (this@@109 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@59 this@@109) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@59) (and (or (not (= this@@109 null)) (not true)) (and ($Is refType this@@109 Tclass._module.Lifetime) ($IsAlloc refType this@@109 Tclass._module.Lifetime $Heap@@59)))))) (= (_module.Lifetime.alive $Heap@@59 this@@109)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@59 this@@109) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@59 this@@109) ($IsGoodHeap $Heap@@59))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@60 T@U) (this@@110 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@60 this@@110) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@60) (and (or (not (= this@@110 null)) (not true)) (and ($Is refType this@@110 Tclass._module.Lifetime) ($IsAlloc refType this@@110 Tclass._module.Lifetime $Heap@@60)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@60 this@@110)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 this@@110) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 (_module.Object.universe this@@110)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 this@@110) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 this@@110) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 (_module.Object.universe this@@110)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 this@@110) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 (_module.Object.universe this@@110)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 this@@110) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@60 (_module.Object.universe this@@110)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@60 this@@110) ($IsGoodHeap $Heap@@60))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@19 T@U) ($Heap@@61 T@U) (this@@111 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@19 $Heap@@61 this@@111) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@19) ($IsGoodHeap $Heap@@61)) ($HeapSucc $prevHeap@@19 $Heap@@61)) (and (or (not (= this@@111 null)) (not true)) (and ($Is refType this@@111 Tclass._module.OwnedObject) ($IsAlloc refType this@@111 Tclass._module.OwnedObject $prevHeap@@19)))))) (and (=> (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 this@@111) _module.OwnedObject.owner)) null)) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 this@@111) _module.OwnedObject.nonvolatileVersion)))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 this@@111) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@19 $Heap@@61 this@@111))) (=> (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 this@@111) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@19 $Heap@@61 this@@111))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.owner))))
(|_module.OwnedObject.volatileOwns#canCall| |oldOwner#0|))))))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@19 $Heap@@61 this@@111)  (and (and (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 this@@111) _module.OwnedObject.owner)) null)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 this@@111) _module.OwnedObject.nonvolatileVersion))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 this@@111) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@19 $Heap@@61 this@@111)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#0@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@111) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 this@@111) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_12MutexLifetimelongdfy.458:22|
 :skolemid |2186|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@19 $Heap@@61 this@@111) ($IsGoodHeap $Heap@@61))
))))
...
(assert (not
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.globalSequenceInv2#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.globalSequenceInv2 $Heap@@62 $Heap@2 |universe#0|) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#14|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#14|)) (_module.Object.sequenceInv2 $Heap@@62 $Heap@2 |o#14|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |789|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@62 $Heap@2 |o#14|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#14|)))
))))) (=> (=> (|_module.Universe.globalSequenceInv2#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.globalSequenceInv2 $Heap@@62 $Heap@2 |universe#0|) (forall ((|o#14@@0| T@U) ) (!  (=> (and ($Is refType |o#14@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@0|)) (_module.Object.sequenceInv2 $Heap@@62 $Heap@2 |o#14@@0|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |789|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@62 $Heap@2 |o#14@@0|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (forall ((|o#15| T@U) ) (!  (=> (and ($Is refType |o#15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#15|))) (and (and (and (= (_module.Object.universe |o#15|) |universe#0|) (or (not (= |o#15| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@62 |o#15|)) (_module.Object.triggerAxioms $Heap@@62 |o#15|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |791|
 :pattern ( (_module.Object.triggerAxioms $Heap@@62 |o#15|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@62 |o#15|))
 :pattern ( (_module.Object.universe |o#15|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#15|)))
))))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (forall ((|o#15@@0| T@U) ) (!  (=> (and ($Is refType |o#15@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#15@@0|))) (and (and (and (= (_module.Object.universe |o#15@@0|) |universe#0|) (or (not (= |o#15@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@62 |o#15@@0|)) (_module.Object.triggerAxioms $Heap@@62 |o#15@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |791|
 :pattern ( (_module.Object.triggerAxioms $Heap@@62 |o#15@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@62 |o#15@@0|))
 :pattern ( (_module.Object.universe |o#15@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#15@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@2 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@2 |universe#0|) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#16|))) (and (and (and (= (_module.Object.universe |o#16|) |universe#0|) (or (not (= |o#16| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@2 |o#16|)) (_module.Object.triggerAxioms $Heap@2 |o#16|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |793|
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (forall ((|o#17| T@U) ) (!  (=> (and ($Is refType |o#17| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#17|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)))) (not ($IsAllocBox ($Box refType |o#17|) Tclass._module.Object $Heap@@62)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |795|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)))
))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@2 |universe#0|) (forall ((|o#17@@0| T@U) ) (!  (=> (and ($Is refType |o#17@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)))) (not ($IsAllocBox ($Box refType |o#17@@0|) Tclass._module.Object $Heap@@62)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |795|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (forall ((|o#18| T@U) ) (!  (=> (and ($Is refType |o#18| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#18|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#18|)))) (or (forall (($o@@76 T@U) ($f@@42 T@U) ) (!  (=> (or (not (= $o@@76 null)) (not true)) (=> (= $o@@76 |o#18|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@76) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@76) $f@@42))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |797|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@76) $f@@42))
)) (_module.Object.sequenceInv2 $Heap@@62 $Heap@2 |o#18|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |798|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@62 $Heap@2 |o#18|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#18|)))
))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (forall ((|o#18@@0| T@U) ) (!  (=> (and ($Is refType |o#18@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@0|)))) (or (forall (($o@@77 T@U) ($f@@43 T@U) ) (!  (=> (or (not (= $o@@77 null)) (not true)) (=> (= $o@@77 |o#18@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@77) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@77) $f@@43))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |797|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@77) $f@@43))
)) (_module.Object.sequenceInv2 $Heap@@62 $Heap@2 |o#18@@0|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |798|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@62 $Heap@2 |o#18@@0|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (forall ((|o#19| T@U) ) (!  (=> (and ($Is refType |o#19| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#19|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@62)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |o#19|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |799|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#19|)))
))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (forall ((|o#19@@0| T@U) ) (!  (=> (and ($Is refType |o#19@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19@@0|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@62)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |o#19@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |799|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#19@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (forall ((|l#1@@4| T@U) ) (!  (=> (and ($Is refType |l#1@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@4|))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#1@@4|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#1@@4|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@62)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@62 $Heap@2 |l#1@@4|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |800|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@62 $Heap@2 |l#1@@4|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#1@@4|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@4|)))
))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (or (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@2 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (forall ((|l#1@@5| T@U) ) (!  (=> (and ($Is refType |l#1@@5| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@5|))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#1@@5|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#1@@5|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@62)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@62 $Heap@2 |l#1@@5|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |800|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@62 $Heap@2 |l#1@@5|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#1@@5|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@5|)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|a#1| T@U) (|b#1| T@U) ) (!  (=> (and (and ($Is refType |a#1| Tclass._module.Lifetime) ($Is refType |b#1| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |a#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |b#1|)))) (=> (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@@62 |universe#0| |a#1| |b#1|) (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@2 |universe#0| |a#1| |b#1|)))
 :qid |_12MutexLifetimelongdfy.285:18|
 :skolemid |806|
 :pattern ( (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@2 |universe#0| |a#1| |b#1|))
 :pattern ( (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@@62 |universe#0| |a#1| |b#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |b#1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |a#1|)))
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((anon5_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |t#2@0|))) (= (ControlFlow 0 32) 2)) anon3_correct)))
(let ((anon5_Then_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |t#2@0|)) (= (ControlFlow 0 31) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and ($Is refType |t#2@0| Tclass._module.Thread) ($IsAlloc refType |t#2@0| Tclass._module.Thread $Heap@1)) (and (=> (= (ControlFlow 0 33) (- 0 35)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 33) (- 0 34)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62) (and (=> (= (ControlFlow 0 33) 31) anon5_Then_correct) (=> (= (ControlFlow 0 33) 32) anon5_Else_correct)))))))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@62 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)))) (and (=> (= (ControlFlow 0 36) (- 0 46)) (forall (($o@@78 T@U) ($f@@44 T@U) ) (!  (=> (and (and (or (not (= $o@@78 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@78) alloc)))) (or (= $o@@78 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType $o@@78)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@78 $f@@44)))
 :qid |_12MutexLifetimelongdfy.287:15|
 :skolemid |809|
))) (=> (forall (($o@@79 T@U) ($f@@45 T@U) ) (!  (=> (and (and (or (not (= $o@@79 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@79) alloc)))) (or (= $o@@79 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType $o@@79)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@79 $f@@45)))
 :qid |_12MutexLifetimelongdfy.287:15|
 :skolemid |809|
)) (and (=> (= (ControlFlow 0 36) (- 0 45)) (=> (|_module.Universe.globalInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalInv $Heap@@62 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalInv $Heap@@62 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 36) (- 0 44)) (=> (|_module.Universe.globalInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalInv $Heap@@62 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@13|))) (and (and (and (= (_module.Object.universe |o#0@@13|) |universe#0|) (or (not (= |o#0@@13| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@62 |o#0@@13|)) (_module.Object.triggerAxioms $Heap@@62 |o#0@@13|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |666|
 :pattern ( (_module.Object.triggerAxioms $Heap@@62 |o#0@@13|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@62 |o#0@@13|))
 :pattern ( (_module.Object.universe |o#0@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@13|)))
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalInv $Heap@@62 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (forall ((|o#0@@14| T@U) ) (!  (=> (and ($Is refType |o#0@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|))) (and (and (and (= (_module.Object.universe |o#0@@14|) |universe#0|) (or (not (= |o#0@@14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@62 |o#0@@14|)) (_module.Object.triggerAxioms $Heap@@62 |o#0@@14|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |666|
 :pattern ( (_module.Object.triggerAxioms $Heap@@62 |o#0@@14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@62 |o#0@@14|))
 :pattern ( (_module.Object.universe |o#0@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|)))
)))))) (and (=> (= (ControlFlow 0 36) (- 0 43)) (=> (|_module.Universe.globalInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalInv $Heap@@62 |universe#0|) (forall ((|o#1@@6| T@U) ) (!  (=> (and ($Is refType |o#1@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@6|))) (_module.Object.inv $Heap@@62 |o#1@@6|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |668|
 :pattern ( (_module.Object.inv $Heap@@62 |o#1@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@6|)))
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@62 |universe#0|) (or (_module.Universe.globalInv $Heap@@62 |universe#0|) (forall ((|o#1@@7| T@U) ) (!  (=> (and ($Is refType |o#1@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@7|))) (_module.Object.inv $Heap@@62 |o#1@@7|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |668|
 :pattern ( (_module.Object.inv $Heap@@62 |o#1@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@7|)))
)))) (and (=> (= (ControlFlow 0 36) (- 0 42)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |preempting#0|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |preempting#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.Universe.globalInv#canCall| $Heap@0 |universe#0|)) (=> (and (and (and (|_module.Universe.globalInv#canCall| $Heap@0 |universe#0|) (and (_module.Universe.globalInv $Heap@0 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (forall ((|o#3@@1| T@U) ) (!  (=> (and ($Is refType |o#3@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|))) (_module.Object.inv $Heap@0 |o#3@@1|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |673|
...
))))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@0 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@0 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (and (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@0 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (and (and (and (and (_module.Universe.baseLegalTransitionsSequence $Heap@@62 $Heap@0 |universe#0|) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)))) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#7|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#7|)))) (or (forall (($o@@80 T@U) ($f@@46 T@U) ) (!  (=> (or (not (= $o@@80 null)) (not true)) (=> (= $o@@80 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@80) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@80) $f@@46))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |688|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@80) $f@@46))
)) (_module.Object.sequenceInv2 $Heap@@62 $Heap@0 |o#7|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |689|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@62 $Heap@0 |o#7|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#7|)))
))) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#8|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#8|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#8|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@62)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#8|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#8|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |690|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#8|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |o#8|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)))
))) (forall ((|l#0@@9| T@U) ) (!  (=> (and ($Is refType |l#0@@9| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@9|))) (=> (and (not (|Set#IsMember| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#0@@9|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#0@@9|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@62)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@62 $Heap@0 |l#0@@9|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |691|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@62 $Heap@0 |l#0@@9|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |l#0@@9|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@9|)))
))))) (and (forall (($o@@81 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@81) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@81) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@81)) (or (= $o@@81 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType $o@@81)))))
 :qid |_12MutexLifetimelongdfy.242:8|
 :skolemid |692|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@81))
)) ($HeapSucc $Heap@@62 $Heap@0)))) (and (=> (= (ControlFlow 0 36) (- 0 41)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 36) (- 0 40)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62) (=> (= call0formal@previous$Heap@0@@0 $Heap@@62) (and (=> (= (ControlFlow 0 36) (- 0 39)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 36) (- 0 38)) (forall ((|l#1@@6| T@U) ) (!  (=> (and ($Is refType |l#1@@6| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@6|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 |l#1@@6|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@6|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0@@0 |l#1@@6|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@6|) _module.Lifetime.mightPointTo)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@62) ($IsHeapAnchor $Heap@@62)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62))) (=> (and (and (and ($Is refType |preempting#0| Tclass._module.Thread) ($IsAlloc refType |preempting#0| Tclass._module.Thread $Heap@@62)) (= 23 $FunctionContextHeight)) (and (and (|_module.Universe.globalInv#canCall| $Heap@@62 |universe#0|) (and (_module.Universe.globalInv $Heap@@62 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@62 |universe#0|) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#11|))) (_module.Object.inv $Heap@@62 |o#11|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |784|
 :pattern ( (_module.Object.inv $Heap@@62 |o#11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |o#11|)))
))))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |preempting#0|)) (= (ControlFlow 0 47) 36)))) anon0_correct))))
