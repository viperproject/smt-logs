...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split120)
...
))))) (= (_module.Object.universe call4formal@this@0@@0) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call4formal@this@0@@0) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call4formal@this@0@@0) _module.ConstantInteger.value))) |value##0_1@1|))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@0)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call4formal@this@0@@0) alloc))))) (and (forall (($o@@141 T@U) ) (!  (=> (and (or (not (= $o@@141 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@141) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 $o@@141) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@141)) (= $o@@141 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.608:3|
 :skolemid |2896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 $o@@141))
)) ($HeapSucc $Heap@16 $Heap@17)))) (and (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@16)) (and ($IsGoodHeap $Heap@18) ($IsHeapAnchor $Heap@18))) (and (and (forall ((|o#1@@20| T@U) ) (!  (=> ($Is refType |o#1@@20| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@20|)) (=> (=> ($Is refType |o#1@@20| Tclass._module.OwnedObject) (and (forall (($o@@142 T@U) ($f@@89 T@U) ) (!  (=> (or (not (= $o@@142 null)) (not true)) (=> (= $o@@142 |o#1@@20|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 $o@@142) $f@@89) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@142) $f@@89))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
...
))) (and (= $Heap@17 $Heap@18) (= (ControlFlow 0 2) (- 0 1))))))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
