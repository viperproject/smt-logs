...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Object.objectGlobalInv#canCall| $Heap@@12 this@@12) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Object) ($IsAlloc refType this@@12 Tclass._module.Object $Heap@@12)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType this@@12)) (|_module.Universe.globalInv#canCall| $Heap@@12 (_module.Object.universe this@@12))) (= (_module.Object.objectGlobalInv $Heap@@12 this@@12)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType this@@12)) (_module.Universe.globalInv $Heap@@12 (_module.Object.universe this@@12))))))
 :qid |_10SequenceInvariantdfy.199:19|
 :skolemid |1053|
 :pattern ( (_module.Object.objectGlobalInv $Heap@@12 this@@12) ($IsGoodHeap $Heap@@12))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@14 this@@14) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.OwnedObject) ($IsAlloc refType this@@14 Tclass._module.OwnedObject $Heap@@14)))))) (=> (_module.OwnedObject.userInv $Heap@@14 this@@14) (_module.OwnedObject.localUserInv $Heap@@14 this@@14)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1549|
 :pattern ( (_module.OwnedObject.userInv $Heap@@14 this@@14))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@15 this@@15) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Thread) ($IsAlloc refType this@@15 Tclass._module.Thread $Heap@@15)))))) (=> (_module.Thread.localInv $Heap@@15 this@@15) (_module.Object.objectGlobalBaseInv $Heap@@15 this@@15)))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1203|
 :pattern ( (_module.Thread.localInv $Heap@@15 this@@15))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@16 this@@16) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.OwnedObject) ($IsAlloc refType this@@16 Tclass._module.OwnedObject $Heap@@16)))))) (=> (_module.OwnedObject.localInv $Heap@@16 this@@16) (_module.Object.objectGlobalBaseInv $Heap@@16 this@@16)))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1458|
 :pattern ( (_module.OwnedObject.localInv $Heap@@16 this@@16))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@17 this@@17) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Object) ($IsAlloc refType this@@17 Tclass._module.Object $Heap@@17)))))) (=> (_module.Object.localInv $Heap@@17 this@@17) (_module.Object.objectGlobalBaseInv $Heap@@17 this@@17)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1116|
 :pattern ( (_module.Object.localInv $Heap@@17 this@@17))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@18 this@@18) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Thread) ($IsAlloc refType this@@18 Tclass._module.Thread $Heap@@18)))))) (=> (_module.Thread.inv $Heap@@18 this@@18) (_module.Thread.localInv $Heap@@18 this@@18)))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1215|
 :pattern ( (_module.Thread.inv $Heap@@18 this@@18))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@19 this@@19) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.OwnedObject) ($IsAlloc refType this@@19 Tclass._module.OwnedObject $Heap@@19)))))) (=> (_module.OwnedObject.inv $Heap@@19 this@@19) (_module.OwnedObject.localInv $Heap@@19 this@@19)))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1471|
 :pattern ( (_module.OwnedObject.inv $Heap@@19 this@@19))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@20 this@@20) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Object) ($IsAlloc refType this@@20 Tclass._module.Object $Heap@@20)))))) (=> (_module.Object.inv $Heap@@20 this@@20) (_module.Object.localInv $Heap@@20 this@@20)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1126|
 :pattern ( (_module.Object.inv $Heap@@20 this@@20))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@21 this@@21) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Thread) ($IsAlloc refType this@@21 Tclass._module.Thread $Heap@@21)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@21)) (= (_module.Thread.localInv $Heap@@21 this@@21)  (and true (_module.Object.objectGlobalBaseInv $Heap@@21 this@@21)))))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1205|
 :pattern ( (_module.Thread.localInv $Heap@@21 this@@21) ($IsGoodHeap $Heap@@21))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@22 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@22 this@@22) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Thread) ($IsAlloc refType this@@22 Tclass._module.Thread $Heap@@22)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@22 this@@22)) (= (_module.Thread.inv $Heap@@22 this@@22)  (and true (_module.Thread.localInv $Heap@@22 this@@22)))))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1217|
 :pattern ( (_module.Thread.inv $Heap@@22 this@@22) ($IsGoodHeap $Heap@@22))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@23 this@@23) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Object) ($IsAlloc refType this@@23 Tclass._module.Object $Heap@@23)))))) (= (_module.Object.triggerAxioms $Heap@@23 this@@23)  (and (or ($Is refType this@@23 Tclass._module.OwnedObject) ($Is refType this@@23 Tclass._module.Thread)) (not (and ($Is refType this@@23 Tclass._module.OwnedObject) ($Is refType this@@23 Tclass._module.Thread))))))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1066|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon5_correct  (=> (= (_module.Object.objectGlobalInv $Heap@@24 this@@24)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 (_module.Object.universe this@@24)) _module.Universe.content)) ($Box refType this@@24)) (_module.Universe.globalInv $Heap@@24 (_module.Object.universe this@@24)))) (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 (_module.Object.universe this@@24)) _module.Universe.content)) ($Box refType this@@24)) (|_module.Universe.globalInv#canCall| $Heap@@24 (_module.Object.universe this@@24))) ($Is boolType (bool_2_U (_module.Object.objectGlobalInv $Heap@@24 this@@24)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@1|)))))))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 (_module.Object.universe this@@24)) _module.Universe.content)) ($Box refType this@@24))) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 7) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 (_module.Object.universe this@@24)) _module.Universe.content)) ($Box refType this@@24)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (_module.Object.universe this@@24) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@24) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@24)) Tclass._module.Universe? $Heap@@24) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_10SequenceInvariantdfy.199:84|
 :skolemid |1054|
))) (|_module.Universe.globalInv#canCall| $Heap@@24 (_module.Object.universe this@@24))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 5) 3))) anon5_correct)))))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= (_module.Object.universe this@@24) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@24) null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 (_module.Object.universe this@@24) _module.Universe.content))) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@24 alloc $Heap@@24 alloc)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@24) ($IsHeapAnchor $Heap@@24)) (=> (and (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.Object) ($IsAlloc refType this@@24 Tclass._module.Object $Heap@@24))) (and (= 12 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
