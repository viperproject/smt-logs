...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split71)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon2_correct  (=> (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222)))) (=> (and (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222))) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11)) (=> (and (and (and (= |##a#4@0| (_module.OwnedObject.lifetime |mutex#0|)) ($IsAlloc refType |##a#4@0| Tclass._module.Lifetime $Heap@11)) (and (= |##b#4@0| (_module.OwnedObject.lifetime this@@222)) ($IsAlloc refType |##b#4@0| Tclass._module.Lifetime $Heap@11))) (and (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222))) (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= call5formal@this@0 null)) (not true)))))))
