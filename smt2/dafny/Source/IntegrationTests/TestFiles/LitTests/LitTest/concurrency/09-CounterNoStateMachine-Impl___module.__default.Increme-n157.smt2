...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |counter#0|)) (= (ControlFlow 0 2) (- 0 1)))))))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType call4formal@this@0@@0))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
