...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($Is refType |a#0@0| Tclass._module.NonOwnedObject) ($IsAlloc refType |a#0@0| Tclass._module.NonOwnedObject $Heap@0)) (and ($Is refType |b#0@0| Tclass._module.OwnedObject) ($IsAlloc refType |b#0@0| Tclass._module.OwnedObject $Heap@0)))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
