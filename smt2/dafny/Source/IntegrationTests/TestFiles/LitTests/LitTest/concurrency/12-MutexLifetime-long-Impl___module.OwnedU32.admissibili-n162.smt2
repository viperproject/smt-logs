...
(assert (forall (($prevHeap@@4 T@U) ($h0@@3 T@U) ($h1@@3 T@U) (this@@5 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.OwnedU32))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@3 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 this@@5)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@3) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@3) $f@@3)))
 :qid |unknown.0:0|
 :skolemid |2727|
)) (= (_module.OwnedU32.unchangedNonvolatileUserFields $prevHeap@@4 $h0@@3 this@@5) (_module.OwnedU32.unchangedNonvolatileUserFields $prevHeap@@4 $h1@@3 this@@5))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2728|
...
(assert (forall (($prevHeap@@5 T@U) ($h0@@4 T@U) ($h1@@4 T@U) (this@@8 T@U) (|running#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.Universe) ($IsAlloc refType this@@8 Tclass._module.Universe $h0@@4)))) (or (|_module.Universe.legalTransition#canCall| $prevHeap@@5 $h0@@4 this@@8 |running#0@@0|) (and ($Is refType |running#0@@0| Tclass._module.Thread) ($IsAlloc refType |running#0@@0| Tclass._module.Thread $h0@@4)))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@7 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@7) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@7) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@7) $f@@4)))
 :qid |unknown.0:0|
 :skolemid |1274|
)) (= (_module.Universe.legalTransition $prevHeap@@5 $h0@@4 this@@8 |running#0@@0|) (_module.Universe.legalTransition $prevHeap@@5 $h1@@4 this@@8 |running#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1275|
...
(assert (forall (($prevHeap@@6 T@U) ($h0@@5 T@U) ($h1@@5 T@U) (this@@9 T@U) (|running#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.Object) ($IsAlloc refType this@@9 Tclass._module.Object $h0@@5)))) (or (|_module.Object.goodPreAndLegalChanges#canCall| $prevHeap@@6 $h0@@5 this@@9 |running#0@@1|) (and ($Is refType |running#0@@1| Tclass._module.Thread) ($IsAlloc refType |running#0@@1| Tclass._module.Thread $h0@@5)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@8 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@8) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@8) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@8) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |1760|
)) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@6 $h0@@5 this@@9 |running#0@@1|) (_module.Object.goodPreAndLegalChanges $prevHeap@@6 $h1@@5 this@@9 |running#0@@1|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1761|
...
(assert (forall (($prevHeap@@8 T@U) ($h0@@6 T@U) ($h1@@6 T@U) (this@@22 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Universe) ($IsAlloc refType this@@22 Tclass._module.Universe $h0@@6)))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@10 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@10) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@10) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@10) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |1220|
)) (= (_module.Universe.baseLegalTransitionsSequence $prevHeap@@8 $h0@@6 this@@22) (_module.Universe.baseLegalTransitionsSequence $prevHeap@@8 $h1@@6 this@@22))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1221|
...
(assert (forall (($prevHeap@@9 T@U) ($h0@@7 T@U) ($h1@@7 T@U) (this@@23 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Object) ($IsAlloc refType this@@23 Tclass._module.Object $h0@@7)))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@11 T@U) ($f@@7 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@11) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@11) $f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@11) $f@@7)))
 :qid |unknown.0:0|
 :skolemid |1787|
)) (= (_module.Object.localInv2 $prevHeap@@9 $h0@@7 this@@23) (_module.Object.localInv2 $prevHeap@@9 $h1@@7 this@@23))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1788|
 :pattern ( ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7) (_module.Object.localInv2 $prevHeap@@9 $h1@@7 this@@23))
)))
(assert (forall (($prevHeap@@10 T@U) ($h0@@8 T@U) ($h1@@8 T@U) (this@@24 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.Object) ($IsAlloc refType this@@24 Tclass._module.Object $h0@@8)))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@12 T@U) ($f@@8 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@12) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@12) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@12) $f@@8)))
 :qid |unknown.0:0|
 :skolemid |1795|
)) (= (_module.Object.sequenceInv2 $prevHeap@@10 $h0@@8 this@@24) (_module.Object.sequenceInv2 $prevHeap@@10 $h1@@8 this@@24))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1796|
...
(assert (forall (($prevHeap@@11 T@U) ($h0@@9 T@U) ($h1@@9 T@U) (this@@25 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@9) ($IsGoodHeap $h1@@9)) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.Object) ($IsAlloc refType this@@25 Tclass._module.Object $h0@@9)))) (and ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9))) (=> (forall (($o@@13 T@U) ($f@@9 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@13) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@13) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@9 $o@@13) $f@@9)))
 :qid |unknown.0:0|
 :skolemid |1799|
)) (= (_module.Object.inv2 $prevHeap@@11 $h0@@9 this@@25) (_module.Object.inv2 $prevHeap@@11 $h1@@9 this@@25))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1800|
 :pattern ( ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9) (_module.Object.inv2 $prevHeap@@11 $h1@@9 this@@25))
)))
(assert (forall (($prevHeap@@12 T@U) ($h0@@10 T@U) ($h1@@10 T@U) (this@@26 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.Thread) ($IsAlloc refType this@@26 Tclass._module.Thread $h0@@10)))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@14 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@14) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@14) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@14) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |1893|
)) (= (_module.Thread.localInv2 $prevHeap@@12 $h0@@10 this@@26) (_module.Thread.localInv2 $prevHeap@@12 $h1@@10 this@@26))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1894|
 :pattern ( ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10) (_module.Thread.localInv2 $prevHeap@@12 $h1@@10 this@@26))
)))
(assert (forall (($prevHeap@@13 T@U) ($h0@@11 T@U) ($h1@@11 T@U) (this@@27 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Thread) ($IsAlloc refType this@@27 Tclass._module.Thread $h0@@11)))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@15 T@U) ($f@@11 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@15) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@15) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@15) $f@@11)))
 :qid |unknown.0:0|
 :skolemid |1900|
)) (= (_module.Thread.sequenceInv2 $prevHeap@@13 $h0@@11 this@@27) (_module.Thread.sequenceInv2 $prevHeap@@13 $h1@@11 this@@27))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1901|
...
(assert (forall (($prevHeap@@14 T@U) ($h0@@12 T@U) ($h1@@12 T@U) (this@@28 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Thread) ($IsAlloc refType this@@28 Tclass._module.Thread $h0@@12)))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@16 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@16) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@16) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@16) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |1907|
)) (= (_module.Thread.inv2 $prevHeap@@14 $h0@@12 this@@28) (_module.Thread.inv2 $prevHeap@@14 $h1@@12 this@@28))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1908|
...
(assert (forall (($prevHeap@@15 T@U) ($h0@@13 T@U) ($h1@@13 T@U) (this@@29 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@13) ($IsGoodHeap $h1@@13)) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.OwnedObject) ($IsAlloc refType this@@29 Tclass._module.OwnedObject $h0@@13)))) (and ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13))) (=> (forall (($o@@17 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@17) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@17) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@13 $o@@17) $f@@13)))
 :qid |unknown.0:0|
 :skolemid |2174|
)) (= (_module.OwnedObject.localInv2 $prevHeap@@15 $h0@@13 this@@29) (_module.OwnedObject.localInv2 $prevHeap@@15 $h1@@13 this@@29))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2175|
 :pattern ( ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13) (_module.OwnedObject.localInv2 $prevHeap@@15 $h1@@13 this@@29))
)))
(assert (forall (($prevHeap@@16 T@U) ($h0@@14 T@U) ($h1@@14 T@U) (this@@30 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@14) ($IsGoodHeap $h1@@14)) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.OwnedObject) ($IsAlloc refType this@@30 Tclass._module.OwnedObject $h0@@14)))) (and ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14))) (=> (forall (($o@@18 T@U) ($f@@14 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@18) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@18) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@14 $o@@18) $f@@14)))
 :qid |unknown.0:0|
 :skolemid |2182|
)) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@16 $h0@@14 this@@30) (_module.OwnedObject.sequenceInv2 $prevHeap@@16 $h1@@14 this@@30))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2183|
...
(assert (forall (($prevHeap@@17 T@U) ($h0@@15 T@U) ($h1@@15 T@U) (this@@31 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@15) ($IsGoodHeap $h1@@15)) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.OwnedObject) ($IsAlloc refType this@@31 Tclass._module.OwnedObject $h0@@15)))) (and ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15))) (=> (forall (($o@@19 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@19) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@19) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@15 $o@@19) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |2191|
)) (= (_module.OwnedObject.inv2 $prevHeap@@17 $h0@@15 this@@31) (_module.OwnedObject.inv2 $prevHeap@@17 $h1@@15 this@@31))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2192|
 :pattern ( ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15) (_module.OwnedObject.inv2 $prevHeap@@17 $h1@@15 this@@31))
)))
(assert (forall (($prevHeap@@18 T@U) ($h0@@16 T@U) ($h1@@16 T@U) (this@@32 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.OwnedObject) ($IsAlloc refType this@@32 Tclass._module.OwnedObject $h0@@16)))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@20 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@20) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@20) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@20) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |2237|
)) (= (_module.OwnedObject.localUserInv2 $prevHeap@@18 $h0@@16 this@@32) (_module.OwnedObject.localUserInv2 $prevHeap@@18 $h1@@16 this@@32))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2238|
 :pattern ( ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16) (_module.OwnedObject.localUserInv2 $prevHeap@@18 $h1@@16 this@@32))
)))
(assert (forall (($prevHeap@@19 T@U) ($h0@@17 T@U) ($h1@@17 T@U) (this@@33 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.OwnedObject) ($IsAlloc refType this@@33 Tclass._module.OwnedObject $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@21 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@21) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@21) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@21) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |2245|
)) (= (_module.OwnedObject.userInv2 $prevHeap@@19 $h0@@17 this@@33) (_module.OwnedObject.userInv2 $prevHeap@@19 $h1@@17 this@@33))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2246|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.OwnedObject.userInv2 $prevHeap@@19 $h1@@17 this@@33))
)))
(assert (forall (($prevHeap@@20 T@U) ($h0@@18 T@U) ($h1@@18 T@U) (this@@34 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.Lifetime) ($IsAlloc refType this@@34 Tclass._module.Lifetime $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@22 T@U) ($f@@18 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@22) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@22) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@22) $f@@18)))
 :qid |unknown.0:0|
 :skolemid |2419|
)) (= (_module.Lifetime.sequenceInv2 $prevHeap@@20 $h0@@18 this@@34) (_module.Lifetime.sequenceInv2 $prevHeap@@20 $h1@@18 this@@34))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2420|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.Lifetime.sequenceInv2 $prevHeap@@20 $h1@@18 this@@34))
)))
(assert (forall (($prevHeap@@21 T@U) ($h0@@19 T@U) ($h1@@19 T@U) (this@@35 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.Lifetime) ($IsAlloc refType this@@35 Tclass._module.Lifetime $h0@@19)))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@23 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@23) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@23) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@23) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |2427|
)) (= (_module.Lifetime.localInv2 $prevHeap@@21 $h0@@19 this@@35) (_module.Lifetime.localInv2 $prevHeap@@21 $h1@@19 this@@35))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2428|
 :pattern ( ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19) (_module.Lifetime.localInv2 $prevHeap@@21 $h1@@19 this@@35))
)))
(assert (forall (($prevHeap@@22 T@U) ($h0@@20 T@U) ($h1@@20 T@U) (this@@36 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Lifetime) ($IsAlloc refType this@@36 Tclass._module.Lifetime $h0@@20)))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@24 T@U) ($f@@20 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@24) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@24) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@24) $f@@20)))
 :qid |unknown.0:0|
 :skolemid |2434|
)) (= (_module.Lifetime.inv2 $prevHeap@@22 $h0@@20 this@@36) (_module.Lifetime.inv2 $prevHeap@@22 $h1@@20 this@@36))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2435|
...
(assert (forall (($prevHeap@@24 T@U) ($h0@@22 T@U) ($h1@@22 T@U) (this@@38 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.OwnedU32) ($IsAlloc refType this@@38 Tclass._module.OwnedU32 $h0@@22)))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@26 T@U) ($f@@22 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@26) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@26) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@26) $f@@22)))
 :qid |unknown.0:0|
 :skolemid |2756|
)) (= (_module.OwnedU32.userInv2 $prevHeap@@24 $h0@@22 this@@38) (_module.OwnedU32.userInv2 $prevHeap@@24 $h1@@22 this@@38))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2757|
...
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@76 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@76 null)) (not true)) ($Is refType this@@76 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@62 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@62 null)) (not true)) (and (= $o@@62 this@@76) (= $f@@35 _module.OwnedObject.owner))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@62) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@62) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |2110|
)) (= (_module.OwnedObject.alive $h0@@23 this@@76) (_module.OwnedObject.alive $h1@@23 this@@76))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2111|
 :pattern ( ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23) (_module.OwnedObject.alive $h1@@23 this@@76))
)))
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@77 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@77 null)) (not true)) ($Is refType this@@77 Tclass._module.Lifetime))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@63 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@63 null)) (not true)) (and (= $o@@63 this@@77) (= $f@@36 _module.Lifetime.owner))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@63) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@63) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |2266|
)) (= (_module.Lifetime.alive $h0@@24 this@@77) (_module.Lifetime.alive $h1@@24 this@@77))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2267|
...
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@82 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@82 null)) (not true)) ($Is refType this@@82 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@64 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@64 null)) (not true)) (or (= $o@@64 this@@82) (= $o@@64 (_module.Object.universe this@@82)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@64) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@64) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1775|
)) (= (_module.Object.baseFieldsInv $h0@@25 this@@82) (_module.Object.baseFieldsInv $h1@@25 this@@82))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1776|
 :pattern ( ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25) (_module.Object.baseFieldsInv $h1@@25 this@@82))
)))
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@83 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@83 null)) (not true)) ($Is refType this@@83 Tclass._module.Thread))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@65 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (or (= $o@@65 this@@83) (= $o@@65 (_module.Object.universe this@@83)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@65) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@65) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1857|
)) (= (_module.Thread.baseFieldsInv $h0@@26 this@@83) (_module.Thread.baseFieldsInv $h1@@26 this@@83))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1858|
 :pattern ( ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26) (_module.Thread.baseFieldsInv $h1@@26 this@@83))
)))
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@84 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@84 null)) (not true)) ($Is refType this@@84 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@66 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (or (= $o@@66 this@@84) (= $o@@66 (_module.Object.universe this@@84)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@66) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@66) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |2128|
)) (= (_module.OwnedObject.baseFieldsInv $h0@@27 this@@84) (_module.OwnedObject.baseFieldsInv $h1@@27 this@@84))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2129|
 :pattern ( ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27) (_module.OwnedObject.baseFieldsInv $h1@@27 this@@84))
)))
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@85 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@85 null)) (not true)) ($Is refType this@@85 Tclass._module.Lifetime))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@67 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@67 null)) (not true)) (or (= $o@@67 this@@85) (= $o@@67 (_module.Object.universe this@@85)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@67) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@67) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |2297|
)) (= (_module.Lifetime.baseFieldsInv $h0@@28 this@@85) (_module.Lifetime.baseFieldsInv $h1@@28 this@@85))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2298|
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@64 T@U) (this@@97 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@64 this@@97) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@64) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.Lifetime) ($IsAlloc refType this@@97 Tclass._module.Lifetime $Heap@@64)))))) (=> (_module.Lifetime.localInv $Heap@@64 this@@97) (_module.Object.objectGlobalBaseInv $Heap@@64 this@@97)))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2318|
 :pattern ( (_module.Lifetime.localInv $Heap@@64 this@@97))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@65 T@U) (this@@98 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@65 this@@98) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@65) (and (or (not (= this@@98 null)) (not true)) (and ($Is refType this@@98 Tclass._module.Thread) ($IsAlloc refType this@@98 Tclass._module.Thread $Heap@@65)))))) (=> (_module.Thread.inv $Heap@@65 this@@98) (_module.Thread.localInv $Heap@@65 this@@98)))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1883|
 :pattern ( (_module.Thread.inv $Heap@@65 this@@98))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@66 T@U) (this@@99 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@66 this@@99) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@66) (and (or (not (= this@@99 null)) (not true)) (and ($Is refType this@@99 Tclass._module.Lifetime) ($IsAlloc refType this@@99 Tclass._module.Lifetime $Heap@@66)))))) (=> (_module.Lifetime.inv $Heap@@66 this@@99) (_module.Lifetime.localInv $Heap@@66 this@@99)))
 :qid |_12MutexLifetimelongdfy.589:19|
 :skolemid |2385|
 :pattern ( (_module.Lifetime.inv $Heap@@66 this@@99))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@67 T@U) (this@@100 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@67 this@@100) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@67) (and (or (not (= this@@100 null)) (not true)) (and ($Is refType this@@100 Tclass._module.Object) ($IsAlloc refType this@@100 Tclass._module.Object $Heap@@67)))))) (=> (_module.Object.localInv $Heap@@67 this@@100) (_module.Object.objectGlobalBaseInv $Heap@@67 this@@100)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |1783|
 :pattern ( (_module.Object.localInv $Heap@@67 this@@100))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@68 T@U) (this@@101 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@68 this@@101) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@68) (and (or (not (= this@@101 null)) (not true)) (and ($Is refType this@@101 Tclass._module.OwnedObject) ($IsAlloc refType this@@101 Tclass._module.OwnedObject $Heap@@68)))))) (=> (_module.OwnedObject.userInv $Heap@@68 this@@101) (_module.OwnedObject.localUserInv $Heap@@68 this@@101)))
 :qid |_12MutexLifetimelongdfy.523:19|
 :skolemid |2243|
 :pattern ( (_module.OwnedObject.userInv $Heap@@68 this@@101))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@69 T@U) (this@@102 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@69 this@@102) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@69) (and (or (not (= this@@102 null)) (not true)) (and ($Is refType this@@102 Tclass._module.OwnedObject) ($IsAlloc refType this@@102 Tclass._module.OwnedObject $Heap@@69)))))) (=> (_module.OwnedObject.inv $Heap@@69 this@@102) (_module.OwnedObject.localInv $Heap@@69 this@@102)))
 :qid |_12MutexLifetimelongdfy.449:19|
 :skolemid |2163|
 :pattern ( (_module.OwnedObject.inv $Heap@@69 this@@102))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($Heap@@70 T@U) (this@@103 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@70 this@@103) (and (< 15 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@70) (and (or (not (= this@@103 null)) (not true)) (and ($Is refType this@@103 Tclass._module.Object) ($IsAlloc refType this@@103 Tclass._module.Object $Heap@@70)))))) (=> (_module.Object.inv $Heap@@70 this@@103) (_module.Object.localInv $Heap@@70 this@@103)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |1793|
 :pattern ( (_module.Object.inv $Heap@@70 this@@103))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@54 T@U) ($Heap@@71 T@U) (this@@104 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@54 $Heap@@71 this@@104) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@54) ($IsGoodHeap $Heap@@71)) ($HeapSucc $prevHeap@@54 $Heap@@71)) (and (or (not (= this@@104 null)) (not true)) (and ($Is refType this@@104 Tclass._module.OwnedObject) ($IsAlloc refType this@@104 Tclass._module.OwnedObject $prevHeap@@54)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@104) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@104) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@54 $Heap@@71 this@@104)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@54 $Heap@@71 this@@104)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@104) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@104) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@54 $Heap@@71 this@@104)))))
 :qid |_12MutexLifetimelongdfy.438:22|
 :skolemid |2147|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@54 $Heap@@71 this@@104) ($IsGoodHeap $Heap@@71))
))))
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@105 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@105 null)) (not true)) ($Is refType this@@105 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@69 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@69 null)) (not true)) (= $o@@69 this@@105)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@69) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@69) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1719|
)) (= (_module.Object.nonAliasing $h0@@29 this@@105) (_module.Object.nonAliasing $h1@@29 this@@105))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1720|
 :pattern ( ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29) (_module.Object.nonAliasing $h1@@29 this@@105))
)))
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@106 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@106 null)) (not true)) ($Is refType this@@106 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@70 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@70 null)) (not true)) (= $o@@70 this@@106)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@70) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@70) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1727|
)) (= (_module.Object.triggerAxioms $h0@@30 this@@106) (_module.Object.triggerAxioms $h1@@30 this@@106))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1728|
 :pattern ( ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30) (_module.Object.triggerAxioms $h1@@30 this@@106))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@107 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@107)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@107 null)) (not true)) ($Is refType this@@107 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@107)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimelongdfy.362:18|
 :weight 3
 :skolemid |1854|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@107)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@108 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@108)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@108 null)) (not true)) ($Is refType this@@108 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@108)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimelongdfy.425:18|
 :weight 3
 :skolemid |2118|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@108)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@109 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@109)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@109 null)) (not true)) ($Is refType this@@109 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@109)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimelongdfy.562:18|
 :weight 3
 :skolemid |2294|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@109)))
))))
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@110 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@110 null)) (not true)) ($Is refType this@@110 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@72 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@72 null)) (not true)) (or (= $o@@72 this@@110) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 this@@110) _module.Universe.content)) ($Box refType $o@@72)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@72) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@72) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1174|
)) (= (_module.Universe.globalBaseInv $h0@@31 this@@110) (_module.Universe.globalBaseInv $h1@@31 this@@110))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1175|
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.Universe.globalBaseInv $h1@@31 this@@110))
)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@72 T@U) (this@@111 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@72 this@@111) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@72) (and (or (not (= this@@111 null)) (not true)) (and ($Is refType this@@111 Tclass._module.Lifetime) ($IsAlloc refType this@@111 Tclass._module.Lifetime $Heap@@72)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@72 this@@111) (=> (_module.Object.objectGlobalBaseInv $Heap@@72 this@@111) (=> (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#0@@10|))) (= (_module.OwnedObject.lifetime |o#0@@10|) this@@111))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2333|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#0@@10|)))
)) (and (forall ((|o#1@@3| T@U) ) (!  (=> ($Is refType |o#1@@3| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#1@@3|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@72 |o#1@@3|) (|_module.Lifetime.alive#canCall| $Heap@@72 this@@111))))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2326|
 :pattern ( (_module.OwnedObject.alive $Heap@@72 |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#1@@3|)))
)) (=> (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#1@@4|))) (= (_module.OwnedObject.alive $Heap@@72 |o#1@@4|) (_module.Lifetime.alive $Heap@@72 this@@111)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2332|
 :pattern ( (_module.OwnedObject.alive $Heap@@72 |o#1@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#1@@4|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@72 this@@111) (=> (_module.Lifetime.alive $Heap@@72 this@@111) (forall ((|l#0@@1| T@U) ) (!  (=> ($Is refType |l#0@@1| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)) (|_module.Lifetime.alive#canCall| $Heap@@72 |l#0@@1|)))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2327|
 :pattern ( (_module.Lifetime.alive $Heap@@72 |l#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@72 this@@111) (forall ((|l#0@@2| T@U) ) (!  (=> (and ($Is refType |l#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|))) (_module.Lifetime.alive $Heap@@72 |l#0@@2|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2331|
 :pattern ( (_module.Lifetime.alive $Heap@@72 |l#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@72 this@@111) (=> (not (_module.Lifetime.alive $Heap@@72 this@@111)) (forall ((|l#1| T@U) ) (!  (=> ($Is refType |l#1| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointFrom)) ($Box refType |l#1|)) (|_module.Lifetime.alive#canCall| $Heap@@72 |l#1|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2328|
 :pattern ( (_module.Lifetime.alive $Heap@@72 |l#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointFrom)) ($Box refType |l#1|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@72 this@@111)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@72 this@@111) (forall ((|o#0@@11| T@U) ) (!  (=> (and ($Is refType |o#0@@11| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#0@@11|))) (= (_module.OwnedObject.lifetime |o#0@@11|) this@@111))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2320|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#0@@11|)))
))) (forall ((|o#1@@5| T@U) ) (!  (=> (and ($Is refType |o#1@@5| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#1@@5|))) (= (_module.OwnedObject.alive $Heap@@72 |o#1@@5|) (_module.Lifetime.alive $Heap@@72 this@@111)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2321|
 :pattern ( (_module.OwnedObject.alive $Heap@@72 |o#1@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.elements)) ($Box refType |o#1@@5|)))
))) (=> (_module.Lifetime.alive $Heap@@72 this@@111) (forall ((|l#0@@3| T@U) ) (!  (=> (and ($Is refType |l#0@@3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@3|))) (_module.Lifetime.alive $Heap@@72 |l#0@@3|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2322|
 :pattern ( (_module.Lifetime.alive $Heap@@72 |l#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@3|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@72 this@@111)) (forall ((|l#1@@0| T@U) ) (!  (=> (and ($Is refType |l#1@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|))) (not (_module.Lifetime.alive $Heap@@72 |l#1@@0|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2323|
 :pattern ( (_module.Lifetime.alive $Heap@@72 |l#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)))
)))) (forall ((|l#2| T@U) ) (!  (=> (and ($Is refType |l#2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointTo)) ($Box refType |l#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 |l#2|) _module.Lifetime.mightPointFrom)) ($Box refType this@@111)))
 :qid |_12MutexLifetimelongdfy.586:16|
 :skolemid |2324|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 |l#2|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointTo)) ($Box refType |l#2|)))
))) (forall ((|l#3| T@U) ) (!  (=> (and ($Is refType |l#3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointFrom)) ($Box refType |l#3|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 |l#3|) _module.Lifetime.mightPointTo)) ($Box refType this@@111)))
 :qid |_12MutexLifetimelongdfy.587:16|
 :skolemid |2325|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 |l#3|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@72 this@@111) _module.Lifetime.mightPointFrom)) ($Box refType |l#3|)))
))))))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2334|
 :pattern ( (_module.Lifetime.localInv $Heap@@72 this@@111) ($IsGoodHeap $Heap@@72))
))))
...
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@112 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@112 null)) (not true)) ($Is refType this@@112 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@74 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (= $o@@74 this@@112)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@74) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@74) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |2121|
)) (= (_module.OwnedObject.objectFields $h0@@32 this@@112) (_module.OwnedObject.objectFields $h1@@32 this@@112))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2122|
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.OwnedObject.objectFields $h1@@32 this@@112))
)))
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@113 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@113 null)) (not true)) ($Is refType this@@113 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@75 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (= $o@@75 this@@113)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@75) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@75) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |2224|
)) (= (_module.OwnedObject.objectUserFields $h0@@33 this@@113) (_module.OwnedObject.objectUserFields $h1@@33 this@@113))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2225|
 :pattern ( ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33) (_module.OwnedObject.objectUserFields $h1@@33 this@@113))
)))
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@114 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@114 null)) (not true)) ($Is refType this@@114 Tclass._module.OwnedU32))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@76 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (= $o@@76 this@@114)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@76) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@76) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |2719|
)) (= (_module.OwnedU32.objectUserFields $h0@@34 this@@114) (_module.OwnedU32.objectUserFields $h1@@34 this@@114))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2720|
 :pattern ( ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34) (_module.OwnedU32.objectUserFields $h1@@34 this@@114))
)))
...
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@115 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@115 null)) (not true)) (and ($Is refType this@@115 Tclass._module.Universe) ($IsAlloc refType this@@115 Tclass._module.Universe $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@78 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@78) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@78) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@78) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |1186|
)) (= (_module.Universe.globalInv $h0@@35 this@@115) (_module.Universe.globalInv $h1@@35 this@@115))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1187|
 :pattern ( ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35) (_module.Universe.globalInv $h1@@35 this@@115))
)))
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@116 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@116 null)) (not true)) (and ($Is refType this@@116 Tclass._module.Object) ($IsAlloc refType this@@116 Tclass._module.Object $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@79 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@79) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@79) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@79) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |1699|
)) (= (_module.Object.objectGlobalBaseInv $h0@@36 this@@116) (_module.Object.objectGlobalBaseInv $h1@@36 this@@116))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1700|
 :pattern ( ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36) (_module.Object.objectGlobalBaseInv $h1@@36 this@@116))
)))
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@117 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@117 null)) (not true)) (and ($Is refType this@@117 Tclass._module.Object) ($IsAlloc refType this@@117 Tclass._module.Object $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@80 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@80) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@80) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@80) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |1781|
)) (= (_module.Object.localInv $h0@@37 this@@117) (_module.Object.localInv $h1@@37 this@@117))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1782|
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.Object.localInv $h1@@37 this@@117))
)))
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@118 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@118 null)) (not true)) (and ($Is refType this@@118 Tclass._module.Object) ($IsAlloc refType this@@118 Tclass._module.Object $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@81 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@81) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@81) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@81) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |1791|
)) (= (_module.Object.inv $h0@@38 this@@118) (_module.Object.inv $h1@@38 this@@118))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1792|
 :pattern ( ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38) (_module.Object.inv $h1@@38 this@@118))
)))
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@119 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@119 null)) (not true)) (and ($Is refType this@@119 Tclass._module.Thread) ($IsAlloc refType this@@119 Tclass._module.Thread $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@82 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@82) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@82) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@82) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |1871|
)) (= (_module.Thread.localInv $h0@@39 this@@119) (_module.Thread.localInv $h1@@39 this@@119))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1872|
 :pattern ( ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39) (_module.Thread.localInv $h1@@39 this@@119))
)))
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@120 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@120 null)) (not true)) (and ($Is refType this@@120 Tclass._module.Thread) ($IsAlloc refType this@@120 Tclass._module.Thread $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@83 T@U) ($f@@53 T@U) ) (!  (=> (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@83) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@83) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@83) $f@@53)))
 :qid |unknown.0:0|
 :skolemid |1881|
)) (= (_module.Thread.inv $h0@@40 this@@120) (_module.Thread.inv $h1@@40 this@@120))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1882|
 :pattern ( ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40) (_module.Thread.inv $h1@@40 this@@120))
)))
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@121 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@121 null)) (not true)) (and ($Is refType this@@121 Tclass._module.OwnedObject) ($IsAlloc refType this@@121 Tclass._module.OwnedObject $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@84 T@U) ($f@@54 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@84) $f@@54) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@84) $f@@54)))
 :qid |unknown.0:0|
 :skolemid |2149|
)) (= (_module.OwnedObject.localInv $h0@@41 this@@121) (_module.OwnedObject.localInv $h1@@41 this@@121))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2150|
 :pattern ( ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41) (_module.OwnedObject.localInv $h1@@41 this@@121))
)))
(assert (forall (($h0@@42 T@U) ($h1@@42 T@U) (this@@122 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@42) ($IsGoodHeap $h1@@42)) (and (or (not (= this@@122 null)) (not true)) (and ($Is refType this@@122 Tclass._module.OwnedObject) ($IsAlloc refType this@@122 Tclass._module.OwnedObject $h0@@42)))) (and ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42))) (=> (forall (($o@@85 T@U) ($f@@55 T@U) ) (!  (=> (and (or (not (= $o@@85 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@85) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@85) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@42 $o@@85) $f@@55)))
 :qid |unknown.0:0|
 :skolemid |2161|
)) (= (_module.OwnedObject.inv $h0@@42 this@@122) (_module.OwnedObject.inv $h1@@42 this@@122))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2162|
 :pattern ( ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42) (_module.OwnedObject.inv $h1@@42 this@@122))
)))
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@123 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@123 null)) (not true)) (and ($Is refType this@@123 Tclass._module.OwnedObject) ($IsAlloc refType this@@123 Tclass._module.OwnedObject $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@86 T@U) ($f@@56 T@U) ) (!  (=> (and (or (not (= $o@@86 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@86) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@86) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@86) $f@@56)))
 :qid |unknown.0:0|
 :skolemid |2233|
)) (= (_module.OwnedObject.localUserInv $h0@@43 this@@123) (_module.OwnedObject.localUserInv $h1@@43 this@@123))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2234|
 :pattern ( ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43) (_module.OwnedObject.localUserInv $h1@@43 this@@123))
)))
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@124 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@124 null)) (not true)) (and ($Is refType this@@124 Tclass._module.OwnedObject) ($IsAlloc refType this@@124 Tclass._module.OwnedObject $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@87 T@U) ($f@@57 T@U) ) (!  (=> (and (or (not (= $o@@87 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@87) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@87) $f@@57) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@87) $f@@57)))
 :qid |unknown.0:0|
 :skolemid |2241|
)) (= (_module.OwnedObject.userInv $h0@@44 this@@124) (_module.OwnedObject.userInv $h1@@44 this@@124))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2242|
 :pattern ( ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44) (_module.OwnedObject.userInv $h1@@44 this@@124))
)))
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@125 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@125 null)) (not true)) (and ($Is refType this@@125 Tclass._module.Lifetime) ($IsAlloc refType this@@125 Tclass._module.Lifetime $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@88 T@U) ($f@@58 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@88) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@88) $f@@58)))
 :qid |unknown.0:0|
 :skolemid |2316|
)) (= (_module.Lifetime.localInv $h0@@45 this@@125) (_module.Lifetime.localInv $h1@@45 this@@125))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2317|
 :pattern ( ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45) (_module.Lifetime.localInv $h1@@45 this@@125))
)))
(assert (forall (($h0@@46 T@U) ($h1@@46 T@U) (this@@126 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@46) ($IsGoodHeap $h1@@46)) (and (or (not (= this@@126 null)) (not true)) (and ($Is refType this@@126 Tclass._module.Lifetime) ($IsAlloc refType this@@126 Tclass._module.Lifetime $h0@@46)))) (and ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46))) (=> (forall (($o@@89 T@U) ($f@@59 T@U) ) (!  (=> (and (or (not (= $o@@89 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@89) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@89) $f@@59) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@46 $o@@89) $f@@59)))
 :qid |unknown.0:0|
 :skolemid |2383|
)) (= (_module.Lifetime.inv $h0@@46 this@@126) (_module.Lifetime.inv $h1@@46 this@@126))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2384|
 :pattern ( ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46) (_module.Lifetime.inv $h1@@46 this@@126))
)))
(assert (forall (($h0@@47 T@U) ($h1@@47 T@U) (this@@127 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@47) ($IsGoodHeap $h1@@47)) (and (or (not (= this@@127 null)) (not true)) (and ($Is refType this@@127 Tclass._module.OwnedU32) ($IsAlloc refType this@@127 Tclass._module.OwnedU32 $h0@@47)))) (and ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47))) (=> (forall (($o@@90 T@U) ($f@@60 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@90) $f@@60) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@47 $o@@90) $f@@60)))
 :qid |unknown.0:0|
 :skolemid |2734|
)) (= (_module.OwnedU32.localUserInv $h0@@47 this@@127) (_module.OwnedU32.localUserInv $h1@@47 this@@127))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2735|
 :pattern ( ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47) (_module.OwnedU32.localUserInv $h1@@47 this@@127))
)))
(assert (forall (($h0@@48 T@U) ($h1@@48 T@U) (this@@128 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@48) ($IsGoodHeap $h1@@48)) (and (or (not (= this@@128 null)) (not true)) (and ($Is refType this@@128 Tclass._module.OwnedU32) ($IsAlloc refType this@@128 Tclass._module.OwnedU32 $h0@@48)))) (and ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48))) (=> (forall (($o@@91 T@U) ($f@@61 T@U) ) (!  (=> (and (or (not (= $o@@91 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@91) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@91) $f@@61) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@48 $o@@91) $f@@61)))
 :qid |unknown.0:0|
 :skolemid |2741|
)) (= (_module.OwnedU32.userInv $h0@@48 this@@128) (_module.OwnedU32.userInv $h1@@48 this@@128))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2742|
 :pattern ( ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48) (_module.OwnedU32.userInv $h1@@48 this@@128))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@131 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@131) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@131 null)) (not true)) ($Is refType this@@131 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@131) (_module.Thread.objectClassKind this@@131)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1855|
 :pattern ( (_module.Object.objectClassKind this@@131) ($Is refType this@@131 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@131) (_module.Thread.objectClassKind this@@131))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@132 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@132) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@132 null)) (not true)) ($Is refType this@@132 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@132) (_module.OwnedObject.objectClassKind this@@132)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2119|
 :pattern ( (_module.Object.objectClassKind this@@132) ($Is refType this@@132 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@132) (_module.OwnedObject.objectClassKind this@@132))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@133 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@133) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@133 null)) (not true)) ($Is refType this@@133 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@133) (_module.Lifetime.objectClassKind this@@133)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2295|
 :pattern ( (_module.Object.objectClassKind this@@133) ($Is refType this@@133 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@133) (_module.Lifetime.objectClassKind this@@133))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@134 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@134) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@134 null)) (not true)) ($Is refType this@@134 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@134) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1851|
 :pattern ( (_module.Thread.objectClassKind this@@134))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@135 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@135) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@135 null)) (not true)) ($Is refType this@@135 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@135) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2115|
 :pattern ( (_module.OwnedObject.objectClassKind this@@135))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@136 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@136) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@136 null)) (not true)) ($Is refType this@@136 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@136) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2291|
 :pattern ( (_module.Lifetime.objectClassKind this@@136))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@137 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@137) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@137 null)) (not true)) ($Is refType this@@137 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@137) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1773|
 :pattern ( (_module.Object.objectClassKind this@@137))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@55 T@U) ($Heap@@73 T@U) (this@@138 T@U) ) (!  (=> (or (|_module.OwnedU32.userInv2#canCall| $prevHeap@@55 $Heap@@73 this@@138) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@55) ($IsGoodHeap $Heap@@73)) ($HeapSucc $prevHeap@@55 $Heap@@73)) (and (or (not (= this@@138 null)) (not true)) (and ($Is refType this@@138 Tclass._module.OwnedU32) ($IsAlloc refType this@@138 Tclass._module.OwnedU32 $prevHeap@@55)))))) (=> (_module.OwnedU32.userInv2 $prevHeap@@55 $Heap@@73 this@@138) (_module.OwnedU32.localUserInv2 $prevHeap@@55 $Heap@@73 this@@138)))
 :qid |_12MutexLifetimelongdfy.648:22|
 :skolemid |2758|
 :pattern ( (_module.OwnedU32.userInv2 $prevHeap@@55 $Heap@@73 this@@138))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($prevHeap@@56 T@U) ($Heap@@74 T@U) (this@@139 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv2#canCall| $prevHeap@@56 $Heap@@74 this@@139) (and (< 13 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@56) ($IsGoodHeap $Heap@@74)) ($HeapSucc $prevHeap@@56 $Heap@@74)) (and (or (not (= this@@139 null)) (not true)) (and ($Is refType this@@139 Tclass._module.OwnedObject) ($IsAlloc refType this@@139 Tclass._module.OwnedObject $prevHeap@@56)))))) (=> (_module.OwnedObject.userInv2 $prevHeap@@56 $Heap@@74 this@@139) (_module.OwnedObject.localUserInv2 $prevHeap@@56 $Heap@@74 this@@139)))
 :qid |_12MutexLifetimelongdfy.524:22|
 :skolemid |2247|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@56 $Heap@@74 this@@139))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@75 T@U) (this@@140 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@75 this@@140) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@75) (and (or (not (= this@@140 null)) (not true)) (and ($Is refType this@@140 Tclass._module.Thread) ($IsAlloc refType this@@140 Tclass._module.Thread $Heap@@75)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@75 this@@140)) (= (_module.Thread.localInv $Heap@@75 this@@140)  (and true (_module.Object.objectGlobalBaseInv $Heap@@75 this@@140)))))
 :qid |_12MutexLifetimelongdfy.369:19|
 :skolemid |1875|
 :pattern ( (_module.Thread.localInv $Heap@@75 this@@140) ($IsGoodHeap $Heap@@75))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@76 T@U) (this@@141 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@76 this@@141) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@76) (and (or (not (= this@@141 null)) (not true)) (and ($Is refType this@@141 Tclass._module.Thread) ($IsAlloc refType this@@141 Tclass._module.Thread $Heap@@76)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@76 this@@141)) (= (_module.Thread.inv $Heap@@76 this@@141)  (and true (_module.Thread.localInv $Heap@@76 this@@141)))))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1885|
 :pattern ( (_module.Thread.inv $Heap@@76 this@@141) ($IsGoodHeap $Heap@@76))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@142 T@U) ) (!  (=> (or (|_module.OwnedU32.volatileOwns#canCall| (Lit refType this@@142)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@142 null)) (not true)) ($Is refType this@@142 Tclass._module.OwnedU32)))) (= (_module.OwnedU32.volatileOwns (Lit refType this@@142)) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimelongdfy.638:19|
 :weight 3
 :skolemid |2716|
 :pattern ( (_module.OwnedU32.volatileOwns (Lit refType this@@142)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@77 T@U) (this@@143 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@77 this@@143) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@77) (and (or (not (= this@@143 null)) (not true)) (and ($Is refType this@@143 Tclass._module.OwnedObject) ($IsAlloc refType this@@143 Tclass._module.OwnedObject $Heap@@77)))))) (= (_module.OwnedObject.alive $Heap@@77 this@@143)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 this@@143) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.422:19|
 :skolemid |2114|
 :pattern ( (_module.OwnedObject.alive $Heap@@77 this@@143) ($IsGoodHeap $Heap@@77))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@78 T@U) (this@@144 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@78 this@@144) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@78) (and (or (not (= this@@144 null)) (not true)) (and ($Is refType this@@144 Tclass._module.Lifetime) ($IsAlloc refType this@@144 Tclass._module.Lifetime $Heap@@78)))))) (= (_module.Lifetime.alive $Heap@@78 this@@144)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@144) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@78 this@@144) ($IsGoodHeap $Heap@@78))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@79 T@U) (this@@145 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@79 this@@145) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@79) (and (or (not (= this@@145 null)) (not true)) (and ($Is refType this@@145 Tclass._module.Lifetime) ($IsAlloc refType this@@145 Tclass._module.Lifetime $Heap@@79)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@79 this@@145)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 this@@145) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@145)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 this@@145) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 this@@145) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@145)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 this@@145) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@145)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 this@@145) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@79 (_module.Object.universe this@@145)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@79 this@@145) ($IsGoodHeap $Heap@@79))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@57 T@U) ($Heap@@80 T@U) (this@@146 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@57 $Heap@@80 this@@146) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@57) ($IsGoodHeap $Heap@@80)) ($HeapSucc $prevHeap@@57 $Heap@@80)) (and (or (not (= this@@146 null)) (not true)) (and ($Is refType this@@146 Tclass._module.OwnedObject) ($IsAlloc refType this@@146 Tclass._module.OwnedObject $prevHeap@@57)))))) (and (=> (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 this@@146) _module.OwnedObject.owner)) null)) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 this@@146) _module.OwnedObject.nonvolatileVersion)))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 this@@146) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@57 $Heap@@80 this@@146))) (=> (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 this@@146) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@57 $Heap@@80 this@@146))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.owner))))
(|_module.OwnedObject.volatileOwns#canCall| |oldOwner#0|))))))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@57 $Heap@@80 this@@146)  (and (and (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 this@@146) _module.OwnedObject.owner)) null)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 this@@146) _module.OwnedObject.nonvolatileVersion))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 this@@146) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@57 $Heap@@80 this@@146)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#0@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@146) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@80 this@@146) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_12MutexLifetimelongdfy.458:22|
 :skolemid |2186|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@57 $Heap@@80 this@@146) ($IsGoodHeap $Heap@@80))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@58 T@U) ($Heap@@81 T@U) (this@@147 T@U) ) (!  (=> (or (|_module.OwnedU32.userInv2#canCall| $prevHeap@@58 $Heap@@81 this@@147) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@58) ($IsGoodHeap $Heap@@81)) ($HeapSucc $prevHeap@@58 $Heap@@81)) (and (or (not (= this@@147 null)) (not true)) (and ($Is refType this@@147 Tclass._module.OwnedU32) ($IsAlloc refType this@@147 Tclass._module.OwnedU32 $prevHeap@@58)))))) (and (|_module.OwnedU32.localUserInv2#canCall| $prevHeap@@58 $Heap@@81 this@@147) (= (_module.OwnedU32.userInv2 $prevHeap@@58 $Heap@@81 this@@147) (_module.OwnedU32.localUserInv2 $prevHeap@@58 $Heap@@81 this@@147))))
 :qid |_12MutexLifetimelongdfy.648:22|
 :skolemid |2760|
 :pattern ( (_module.OwnedU32.userInv2 $prevHeap@@58 $Heap@@81 this@@147) ($IsGoodHeap $Heap@@81))
))))
...
(declare-fun this@@148 () T@U)
(declare-fun $Heap@@82 () T@U)
(declare-fun |running#0@@5| () T@U)
(set-info :boogie-vc-id Impl$$_module.OwnedU32.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#57| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@148) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@148) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@148))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.localInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.localInv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv2 previous$Heap current$Heap this@@148)))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion)))))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion)))) (U_2_bool (Lit boolType (bool_2_U true))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion)))) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@148) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@148) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@148) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@148))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion)))) (=> (|_module.OwnedObject.unchangedNonvolatileFields#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.unchangedNonvolatileFields previous$Heap current$Heap this@@148) (_module.OwnedObject.unchangedNonvolatileUserFields previous$Heap current$Heap this@@148)))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#1|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion)))))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (|_module.OwnedObject.sequenceInv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.sequenceInv2 previous$Heap current$Heap this@@148) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#1@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |oldOwner#1@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.nonvolatileVersion))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@148))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv2 previous$Heap current$Heap this@@148)))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))) (not true)) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.Object.localInv current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (let ((|currOwner#1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1|) Tclass._module.Object? previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))))))))) (=> (=> (|_module.OwnedObject.inv2#canCall| previous$Heap current$Heap this@@148) (or (_module.OwnedObject.inv2 previous$Heap current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@148) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)))) (not true)) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (let ((|currOwner#1@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner))))
 (=> ($IsAllocBox ($Box refType |currOwner#1@@0|) Tclass._module.Object? previous$Heap) (_module.Object.localInv2 previous$Heap current$Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@148) (or (_module.Object.objectGlobalBaseInv current$Heap this@@148) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@148)) _module.Universe.content)) ($Box refType this@@148))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@148) (or (_module.Object.objectGlobalBaseInv current$Heap this@@148) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@148)) _module.Universe.content)) ($Box refType this@@148)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@148) (or (_module.Object.objectGlobalBaseInv current$Heap this@@148) (_module.Object.baseFieldsInv current$Heap this@@148)))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@148) (or (_module.Object.objectGlobalBaseInv current$Heap this@@148) (_module.Object.baseFieldsInv current$Heap this@@148))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@148) (or (_module.Object.objectGlobalBaseInv current$Heap this@@148) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@148)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@148)) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@148) (or (_module.Object.objectGlobalBaseInv current$Heap this@@148) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@148)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@148)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@148) (or (_module.Object.objectGlobalBaseInv current$Heap this@@148) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@148)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@148)) (forall ((|o#28| T@U) ) (!  (=> (and ($Is refType |o#28| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@148)) _module.Universe.content)) ($Box refType |o#28|))) (and (and (and (= (_module.Object.universe |o#28|) (_module.Object.universe this@@148)) (or (not (= |o#28| (_module.Object.universe this@@148))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#28|)) (_module.Object.triggerAxioms current$Heap |o#28|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2902|
 :pattern ( (_module.Object.triggerAxioms current$Heap |o#28|))
 :pattern ( (_module.Object.baseFieldsInv current$Heap |o#28|))
 :pattern ( (_module.Object.universe |o#28|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@148)) _module.Universe.content)) ($Box refType |o#28|)))
))))))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (|_module.Object.objectGlobalBaseInv#canCall| current$Heap this@@148) (or (_module.Object.objectGlobalBaseInv current$Heap this@@148) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@148)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@148)) (forall ((|o#28@@0| T@U) ) (!  (=> (and ($Is refType |o#28@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@148)) _module.Universe.content)) ($Box refType |o#28@@0|))) (and (and (and (= (_module.Object.universe |o#28@@0|) (_module.Object.universe this@@148)) (or (not (= |o#28@@0| (_module.Object.universe this@@148))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#28@@0|)) (_module.Object.triggerAxioms current$Heap |o#28@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2902|
 :pattern ( (_module.Object.triggerAxioms current$Heap |o#28@@0|))
 :pattern ( (_module.Object.baseFieldsInv current$Heap |o#28@@0|))
 :pattern ( (_module.Object.universe |o#28@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@148)) _module.Universe.content)) ($Box refType |o#28@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.OwnedObject.lifetime this@@148)) _module.Lifetime.elements)) ($Box refType this@@148))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.OwnedObject.lifetime this@@148)) _module.Lifetime.elements)) ($Box refType this@@148)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (_module.Lifetime.alive current$Heap (_module.OwnedObject.lifetime this@@148)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (_module.Lifetime.alive current$Heap (_module.OwnedObject.lifetime this@@148)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv current$Heap this@@148))))))) (=> (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (|_module.OwnedObject.localInv#canCall| current$Heap this@@148) (or (_module.OwnedObject.localInv current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv current$Heap this@@148)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.OwnedObject.inv#canCall| current$Heap this@@148) (or (_module.OwnedObject.inv current$Heap this@@148) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@148) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv current$Heap this@@148))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@82) ($IsHeapAnchor $Heap@@82)) (and (or (not (= this@@148 null)) (not true)) (and ($Is refType this@@148 Tclass._module.OwnedU32) ($IsAlloc refType this@@148 Tclass._module.OwnedU32 previous$Heap)))) (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 19 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap@@82) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (and (and (|_module.Object.goodPreAndLegalChanges#canCall| previous$Heap current$Heap this@@148 |running#0@@5|) (and (_module.Object.goodPreAndLegalChanges previous$Heap current$Heap this@@148 |running#0@@5|) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@148)) _module.Universe.content)) ($Box refType this@@148)) (forall (($o@@102 T@U) ($f@@62 T@U) ) (!  (=> (or (not (= $o@@102 null)) (not true)) (=> (= $o@@102 this@@148) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@102) $f@@62) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@102) $f@@62))))
 :qid |_12MutexLifetimelongdfy.343:8|
 :skolemid |2901|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@102) $f@@62))
))) (_module.Universe.legalTransition previous$Heap current$Heap (_module.Object.universe this@@148) |running#0@@5|)))) (= (ControlFlow 0 23) 2)))) anon0_correct)))
