...
(assert (distinct TInt TagInt TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Thread Tagclass._module.Integer Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? class._module.Universe? Tagclass._module.Thread? class._module.OwnedObject? class._module.Integer? Tagclass._module.Integer? tytagFamily$Universe tytagFamily$Thread tytagFamily$Integer tytagFamily$Object tytagFamily$OwnedObject field$content field$owner field$value field$nonvolatileVersion)
)
...
(assert (forall (($prevHeap@@4 T@U) ($h0@@2 T@U) ($h1@@2 T@U) (this@@5 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Integer))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@2 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 this@@5)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@2) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@2) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |1787|
)) (= (_module.Integer.unchangedNonvolatileUserFields $prevHeap@@4 $h0@@2 this@@5) (_module.Integer.unchangedNonvolatileUserFields $prevHeap@@4 $h1@@2 this@@5))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1788|
 :pattern ( ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2) (_module.Integer.unchangedNonvolatileUserFields $prevHeap@@4 $h1@@2 this@@5))
)))
...
(assert (forall (($o@@4 T@U) ) (! (= ($Is refType $o@@4 Tclass._module.Integer?)  (or (= $o@@4 null) (= (dtype $o@@4) Tclass._module.Integer?)))
 :qid |unknown.0:0|
 :skolemid |1769|
...
(assert (forall ((bx@@1 T@U) ($h@@2 T@U) ) (!  (=> (and ($IsAllocBox bx@@1 Tclass._module.Integer? $h@@2) ($IsGoodHeap $h@@2)) ($IsAllocBox bx@@1 Tclass._module.OwnedObject? $h@@2))
 :qid |unknown.0:0|
 :skolemid |2416|
 :pattern ( ($IsAllocBox bx@@1 Tclass._module.Integer? $h@@2))
)))
...
(assert (forall ((|c#0@@3| T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType |c#0@@3| Tclass._module.Integer $h@@7) ($IsAlloc refType |c#0@@3| Tclass._module.Integer? $h@@7))
 :qid |unknown.0:0|
 :skolemid |1978|
 :pattern ( ($IsAlloc refType |c#0@@3| Tclass._module.Integer $h@@7))
 :pattern ( ($IsAlloc refType |c#0@@3| Tclass._module.Integer? $h@@7))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.Integer.localUserInv#canCall| $Heap@@3 this@@9) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.Integer)))) (= (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.Integer.localUserInv $Heap@@3 this@@9)))
 :qid |_10SequenceInvariantdfy.395:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) ($Is refType this@@9 Tclass._module.Integer) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.Integer.localUserInv $Heap@@3 this@@9) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.Integer.userInv#canCall| $Heap@@4 this@@10) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.Integer)))) (= (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.Integer.userInv $Heap@@4 this@@10)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1806|
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) ($Is refType this@@10 Tclass._module.Integer) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.Integer.userInv $Heap@@4 this@@10) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Integer.baseUserFieldsInv#canCall| $Heap@@6 this@@12) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@12 null)) (not true)) ($Is refType this@@12 Tclass._module.Integer)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) (_module.Integer.baseUserFieldsInv $Heap@@6 this@@12)))
 :qid |_10SequenceInvariantdfy.392:19|
 :skolemid |1778|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) ($Is refType this@@12 Tclass._module.Integer) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) (_module.Integer.baseUserFieldsInv $Heap@@6 this@@12) ($IsGoodHeap $Heap@@6))
))))
...
(assert (forall (($prevHeap@@19 T@U) ($h0@@17 T@U) ($h1@@17 T@U) (this@@30 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Integer) ($IsAlloc refType this@@30 Tclass._module.Integer $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@20 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@20) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@20) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@20) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |1809|
)) (= (_module.Integer.localUserInv2 $prevHeap@@19 $h0@@17 this@@30) (_module.Integer.localUserInv2 $prevHeap@@19 $h1@@17 this@@30))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1810|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.Integer.localUserInv2 $prevHeap@@19 $h1@@17 this@@30))
)))
(assert (forall (($prevHeap@@20 T@U) ($h0@@18 T@U) ($h1@@18 T@U) (this@@31 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Integer) ($IsAlloc refType this@@31 Tclass._module.Integer $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@21 T@U) ($f@@18 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@21) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@21) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@21) $f@@18)))
 :qid |unknown.0:0|
 :skolemid |1816|
)) (= (_module.Integer.userInv2 $prevHeap@@20 $h0@@18 this@@31) (_module.Integer.userInv2 $prevHeap@@20 $h1@@18 this@@31))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1817|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.Integer.userInv2 $prevHeap@@20 $h1@@18 this@@31))
)))
...
(assert (forall (($o@@26 T@U) ($h@@12 T@U) ) (! (= ($IsAlloc refType $o@@26 Tclass._module.Integer? $h@@12)  (or (= $o@@26 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@26) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1770|
 :pattern ( ($IsAlloc refType $o@@26 Tclass._module.Integer? $h@@12))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@35 T@U) ) (!  (=> (or (|_module.Integer.baseUserFieldsInv#canCall| $Heap@@15 this@@35) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.Integer) ($IsAlloc refType this@@35 Tclass._module.Integer $Heap@@15)))))) (= (_module.Integer.baseUserFieldsInv $Heap@@15 this@@35) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.461:19|
 :skolemid |1777|
 :pattern ( (_module.Integer.baseUserFieldsInv $Heap@@15 this@@35) ($IsGoodHeap $Heap@@15))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.Integer.localUserInv#canCall| $Heap@@16 this@@36) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Integer) ($IsAlloc refType this@@36 Tclass._module.Integer $Heap@@16)))))) (= (_module.Integer.localUserInv $Heap@@16 this@@36) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_10SequenceInvariantdfy.468:19|
 :skolemid |1798|
 :pattern ( (_module.Integer.localUserInv $Heap@@16 this@@36) ($IsGoodHeap $Heap@@16))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@26 T@U) ($Heap@@21 T@U) (this@@41 T@U) ) (!  (=> (or (|_module.Integer.unchangedNonvolatileUserFields#canCall| $prevHeap@@26 $Heap@@21 this@@41) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@26) ($IsGoodHeap $Heap@@21)) ($HeapSucc $prevHeap@@26 $Heap@@21)) (and (or (not (= this@@41 null)) (not true)) (and ($Is refType this@@41 Tclass._module.Integer) ($IsAlloc refType this@@41 Tclass._module.Integer $prevHeap@@26)))))) (= (_module.Integer.unchangedNonvolatileUserFields $prevHeap@@26 $Heap@@21 this@@41) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@26 this@@41) _module.Integer.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@41) _module.Integer.value))))))
 :qid |_10SequenceInvariantdfy.464:22|
 :skolemid |1791|
 :pattern ( (_module.Integer.unchangedNonvolatileUserFields $prevHeap@@26 $Heap@@21 this@@41) ($IsGoodHeap $Heap@@21))
))))
(assert (forall (($h@@13 T@U) ($o@@34 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@34 null)) (not true)) (= (dtype $o@@34) Tclass._module.Integer?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@34) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@34) _module.Integer.value)) TInt $h@@13))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1772|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@34) _module.Integer.value)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@27 T@U) ($Heap@@24 T@U) (this@@44 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@27 $Heap@@24 this@@44) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@44 null)) (not true)) ($Is refType this@@44 Tclass._module.Thread)))) (= (_module.Object.localInv2 $prevHeap@@27 $Heap@@24 this@@44) (_module.Thread.localInv2 $prevHeap@@27 $Heap@@24 this@@44)))
 :qid |_10SequenceInvariantdfy.242:22|
 :skolemid |1230|
 :pattern ( (_module.Object.localInv2 $prevHeap@@27 $Heap@@24 this@@44) ($Is refType this@@44 Tclass._module.Thread) ($IsGoodHeap $Heap@@24))
 :pattern ( (_module.Object.localInv2 $prevHeap@@27 $Heap@@24 this@@44) (_module.Thread.localInv2 $prevHeap@@27 $Heap@@24 this@@44) ($IsGoodHeap $Heap@@24))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@28 T@U) ($Heap@@25 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@28 $Heap@@25 this@@45) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@45 null)) (not true)) ($Is refType this@@45 Tclass._module.Thread)))) (= (_module.Object.sequenceInv2 $prevHeap@@28 $Heap@@25 this@@45) (_module.Thread.sequenceInv2 $prevHeap@@28 $Heap@@25 this@@45)))
 :qid |_10SequenceInvariantdfy.244:22|
 :skolemid |1237|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@28 $Heap@@25 this@@45) ($Is refType this@@45 Tclass._module.Thread) ($IsGoodHeap $Heap@@25))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@28 $Heap@@25 this@@45) (_module.Thread.sequenceInv2 $prevHeap@@28 $Heap@@25 this@@45) ($IsGoodHeap $Heap@@25))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@29 T@U) ($Heap@@26 T@U) (this@@46 T@U) ) (!  (=> (or (|_module.Integer.unchangedNonvolatileUserFields#canCall| $prevHeap@@29 $Heap@@26 this@@46) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@46 null)) (not true)) ($Is refType this@@46 Tclass._module.Integer)))) (= (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@29 $Heap@@26 this@@46) (_module.Integer.unchangedNonvolatileUserFields $prevHeap@@29 $Heap@@26 this@@46)))
 :qid |_10SequenceInvariantdfy.394:22|
 :skolemid |1792|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@29 $Heap@@26 this@@46) ($Is refType this@@46 Tclass._module.Integer) ($IsGoodHeap $Heap@@26))
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@29 $Heap@@26 this@@46) (_module.Integer.unchangedNonvolatileUserFields $prevHeap@@29 $Heap@@26 this@@46) ($IsGoodHeap $Heap@@26))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@30 T@U) ($Heap@@27 T@U) (this@@47 T@U) ) (!  (=> (or (|_module.Integer.localUserInv2#canCall| $prevHeap@@30 $Heap@@27 this@@47) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@47 null)) (not true)) ($Is refType this@@47 Tclass._module.Integer)))) (= (_module.OwnedObject.localUserInv2 $prevHeap@@30 $Heap@@27 this@@47) (_module.Integer.localUserInv2 $prevHeap@@30 $Heap@@27 this@@47)))
 :qid |_10SequenceInvariantdfy.396:22|
 :skolemid |1814|
 :pattern ( (_module.OwnedObject.localUserInv2 $prevHeap@@30 $Heap@@27 this@@47) ($Is refType this@@47 Tclass._module.Integer) ($IsGoodHeap $Heap@@27))
 :pattern ( (_module.OwnedObject.localUserInv2 $prevHeap@@30 $Heap@@27 this@@47) (_module.Integer.localUserInv2 $prevHeap@@30 $Heap@@27 this@@47) ($IsGoodHeap $Heap@@27))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@31 T@U) ($Heap@@28 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@31 $Heap@@28 this@@48) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@48 null)) (not true)) ($Is refType this@@48 Tclass._module.Thread)))) (= (_module.Object.inv2 $prevHeap@@31 $Heap@@28 this@@48) (_module.Thread.inv2 $prevHeap@@31 $Heap@@28 this@@48)))
 :qid |_10SequenceInvariantdfy.245:22|
 :skolemid |1244|
 :pattern ( (_module.Object.inv2 $prevHeap@@31 $Heap@@28 this@@48) ($Is refType this@@48 Tclass._module.Thread) ($IsGoodHeap $Heap@@28))
 :pattern ( (_module.Object.inv2 $prevHeap@@31 $Heap@@28 this@@48) (_module.Thread.inv2 $prevHeap@@31 $Heap@@28 this@@48) ($IsGoodHeap $Heap@@28))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@32 T@U) ($Heap@@29 T@U) (this@@49 T@U) ) (!  (=> (or (|_module.Integer.userInv2#canCall| $prevHeap@@32 $Heap@@29 this@@49) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@49 null)) (not true)) ($Is refType this@@49 Tclass._module.Integer)))) (= (_module.OwnedObject.userInv2 $prevHeap@@32 $Heap@@29 this@@49) (_module.Integer.userInv2 $prevHeap@@32 $Heap@@29 this@@49)))
 :qid |_10SequenceInvariantdfy.398:22|
 :skolemid |1821|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@32 $Heap@@29 this@@49) ($Is refType this@@49 Tclass._module.Integer) ($IsGoodHeap $Heap@@29))
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@32 $Heap@@29 this@@49) (_module.Integer.userInv2 $prevHeap@@32 $Heap@@29 this@@49) ($IsGoodHeap $Heap@@29))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@33 T@U) ($Heap@@30 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@33 $Heap@@30 this@@50) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@50 null)) (not true)) ($Is refType this@@50 Tclass._module.OwnedObject)))) (= (_module.Object.localInv2 $prevHeap@@33 $Heap@@30 this@@50) (_module.OwnedObject.localInv2 $prevHeap@@33 $Heap@@30 this@@50)))
 :qid |_10SequenceInvariantdfy.242:22|
 :skolemid |1487|
 :pattern ( (_module.Object.localInv2 $prevHeap@@33 $Heap@@30 this@@50) ($Is refType this@@50 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@30))
 :pattern ( (_module.Object.localInv2 $prevHeap@@33 $Heap@@30 this@@50) (_module.OwnedObject.localInv2 $prevHeap@@33 $Heap@@30 this@@50) ($IsGoodHeap $Heap@@30))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@34 T@U) ($Heap@@31 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@34 $Heap@@31 this@@51) (and (< 3 $FunctionContextHeight) (and (or (not (= this@@51 null)) (not true)) ($Is refType this@@51 Tclass._module.OwnedObject)))) (= (_module.Object.sequenceInv2 $prevHeap@@34 $Heap@@31 this@@51) (_module.OwnedObject.sequenceInv2 $prevHeap@@34 $Heap@@31 this@@51)))
 :qid |_10SequenceInvariantdfy.244:22|
 :skolemid |1495|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@34 $Heap@@31 this@@51) ($Is refType this@@51 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@31))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@34 $Heap@@31 this@@51) (_module.OwnedObject.sequenceInv2 $prevHeap@@34 $Heap@@31 this@@51) ($IsGoodHeap $Heap@@31))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($prevHeap@@35 T@U) ($Heap@@32 T@U) (this@@52 T@U) ) (!  (=> (or (|_module.OwnedObject.inv2#canCall| $prevHeap@@35 $Heap@@32 this@@52) (and (< 10 $FunctionContextHeight) (and (or (not (= this@@52 null)) (not true)) ($Is refType this@@52 Tclass._module.OwnedObject)))) (= (_module.Object.inv2 $prevHeap@@35 $Heap@@32 this@@52) (_module.OwnedObject.inv2 $prevHeap@@35 $Heap@@32 this@@52)))
 :qid |_10SequenceInvariantdfy.245:22|
 :skolemid |1503|
 :pattern ( (_module.Object.inv2 $prevHeap@@35 $Heap@@32 this@@52) ($Is refType this@@52 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@32))
 :pattern ( (_module.Object.inv2 $prevHeap@@35 $Heap@@32 this@@52) (_module.OwnedObject.inv2 $prevHeap@@35 $Heap@@32 this@@52) ($IsGoodHeap $Heap@@32))
))))
...
(assert (forall ((bx@@13 T@U) ) (!  (=> ($IsBox bx@@13 Tclass._module.Integer?) (and (= ($Box refType ($Unbox refType bx@@13)) bx@@13) ($Is refType ($Unbox refType bx@@13) Tclass._module.Integer?)))
 :qid |unknown.0:0|
 :skolemid |1768|
 :pattern ( ($IsBox bx@@13 Tclass._module.Integer?))
)))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@33 T@U) (this@@53 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@33 this@@53) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@33) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Universe) ($IsAlloc refType this@@53 Tclass._module.Universe $Heap@@33)))))) (and (forall ((|o#0@@5| T@U) ) (!  (=> ($Is refType |o#0@@5| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 this@@53) _module.Universe.content)) ($Box refType |o#0@@5|)) (=> (= (_module.Object.universe |o#0@@5|) this@@53) (=> (or (not (= |o#0@@5| this@@53)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@33 |o#0@@5|) (=> (_module.Object.baseFieldsInv $Heap@@33 |o#0@@5|) (|_module.Object.triggerAxioms#canCall| $Heap@@33 |o#0@@5|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@33 |o#0@@5|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@33 |o#0@@5|))
 :pattern ( (_module.Object.universe |o#0@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 this@@53) _module.Universe.content)) ($Box refType |o#0@@5|)))
)) (= (_module.Universe.globalBaseInv $Heap@@33 this@@53) (forall ((|o#0@@6| T@U) ) (!  (=> (and ($Is refType |o#0@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 this@@53) _module.Universe.content)) ($Box refType |o#0@@6|))) (and (and (and (= (_module.Object.universe |o#0@@6|) this@@53) (or (not (= |o#0@@6| this@@53)) (not true))) (_module.Object.baseFieldsInv $Heap@@33 |o#0@@6|)) (_module.Object.triggerAxioms $Heap@@33 |o#0@@6|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 :pattern ( (_module.Object.triggerAxioms $Heap@@33 |o#0@@6|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@33 |o#0@@6|))
 :pattern ( (_module.Object.universe |o#0@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 this@@53) _module.Universe.content)) ($Box refType |o#0@@6|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@33 this@@53) ($IsGoodHeap $Heap@@33))
))))
...
(assert (forall ((|c#0@@8| T@U) ) (! (= ($Is refType |c#0@@8| Tclass._module.Integer)  (and ($Is refType |c#0@@8| Tclass._module.Integer?) (or (not (= |c#0@@8| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |1977|
 :pattern ( ($Is refType |c#0@@8| Tclass._module.Integer))
 :pattern ( ($Is refType |c#0@@8| Tclass._module.Integer?))
)))
...
(assert (forall (($o@@39 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@39 Tclass._module.Integer? $heap@@1) ($IsAlloc refType $o@@39 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |2418|
 :pattern ( ($IsAlloc refType $o@@39 Tclass._module.Integer? $heap@@1))
)))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($prevHeap@@36 T@U) ($Heap@@34 T@U) (this@@54 T@U) (|running#0@@3| T@U) ) (!  (=> (or (|_module.Object.goodPreAndLegalChanges#canCall| $prevHeap@@36 $Heap@@34 this@@54 |running#0@@3|) (and (< 13 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@36) ($IsGoodHeap $Heap@@34)) ($HeapSucc $prevHeap@@36 $Heap@@34)) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.Object) ($IsAlloc refType this@@54 Tclass._module.Object $prevHeap@@36)))) ($Is refType |running#0@@3| Tclass._module.Thread)))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@36 (_module.Object.universe this@@54)) _module.Universe.content)) ($Box refType this@@54)) (=> (forall (($o@@40 T@U) ($f@@26 T@U) ) (!  (=> (or (not (= $o@@40 null)) (not true)) (=> (= $o@@40 this@@54) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 $o@@40) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@36 $o@@40) $f@@26))))
...
)) (|_module.Universe.legalTransition#canCall| $prevHeap@@36 $Heap@@34 (_module.Object.universe this@@54) |running#0@@3|))) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@36 $Heap@@34 this@@54 |running#0@@3|)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@36 (_module.Object.universe this@@54)) _module.Universe.content)) ($Box refType this@@54)) (forall (($o@@41 T@U) ($f@@27 T@U) ) (!  (=> (or (not (= $o@@41 null)) (not true)) (=> (= $o@@41 this@@54) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 $o@@41) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@36 $o@@41) $f@@27))))
 :qid |_10SequenceInvariantdfy.233:8|
 :skolemid |1097|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 $o@@41) $f@@27))
))) (_module.Universe.legalTransition $prevHeap@@36 $Heap@@34 (_module.Object.universe this@@54) |running#0@@3|)))))
 :qid |_10SequenceInvariantdfy.231:22|
 :skolemid |1099|
 :pattern ( (_module.Object.goodPreAndLegalChanges $prevHeap@@36 $Heap@@34 this@@54 |running#0@@3|) ($IsGoodHeap $Heap@@34))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@37 T@U) ($Heap@@35 T@U) (this@@55 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@37 $Heap@@35 this@@55) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@37) ($IsGoodHeap $Heap@@35)) ($HeapSucc $prevHeap@@37 $Heap@@35)) (and (or (not (= this@@55 null)) (not true)) (and ($Is refType this@@55 Tclass._module.Thread) ($IsAlloc refType this@@55 Tclass._module.Thread $prevHeap@@37)))))) (= (_module.Thread.localInv2 $prevHeap@@37 $Heap@@35 this@@55) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.266:22|
 :skolemid |1229|
 :pattern ( (_module.Thread.localInv2 $prevHeap@@37 $Heap@@35 this@@55) ($IsGoodHeap $Heap@@35))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@38 T@U) ($Heap@@36 T@U) (this@@56 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@38 $Heap@@36 this@@56) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@38) ($IsGoodHeap $Heap@@36)) ($HeapSucc $prevHeap@@38 $Heap@@36)) (and (or (not (= this@@56 null)) (not true)) (and ($Is refType this@@56 Tclass._module.Thread) ($IsAlloc refType this@@56 Tclass._module.Thread $prevHeap@@38)))))) (= (_module.Thread.sequenceInv2 $prevHeap@@38 $Heap@@36 this@@56) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.269:22|
 :skolemid |1236|
 :pattern ( (_module.Thread.sequenceInv2 $prevHeap@@38 $Heap@@36 this@@56) ($IsGoodHeap $Heap@@36))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@39 T@U) ($Heap@@37 T@U) (this@@57 T@U) ) (!  (=> (or (|_module.Integer.userInv2#canCall| $prevHeap@@39 $Heap@@37 this@@57) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@39) ($IsGoodHeap $Heap@@37)) ($HeapSucc $prevHeap@@39 $Heap@@37)) (and (or (not (= this@@57 null)) (not true)) (and ($Is refType this@@57 Tclass._module.Integer) ($IsAlloc refType this@@57 Tclass._module.Integer $prevHeap@@39)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Integer.localUserInv2#canCall| $prevHeap@@39 $Heap@@37 this@@57)) (= (_module.Integer.userInv2 $prevHeap@@39 $Heap@@37 this@@57)  (and true (_module.Integer.localUserInv2 $prevHeap@@39 $Heap@@37 this@@57)))))
 :qid |_10SequenceInvariantdfy.478:22|
 :skolemid |1820|
 :pattern ( (_module.Integer.userInv2 $prevHeap@@39 $Heap@@37 this@@57) ($IsGoodHeap $Heap@@37))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@40 T@U) ($Heap@@38 T@U) (this@@58 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@40 $Heap@@38 this@@58) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@40) ($IsGoodHeap $Heap@@38)) ($HeapSucc $prevHeap@@40 $Heap@@38)) (and (or (not (= this@@58 null)) (not true)) (and ($Is refType this@@58 Tclass._module.OwnedObject) ($IsAlloc refType this@@58 Tclass._module.OwnedObject $prevHeap@@40)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.localUserInv2#canCall| $prevHeap@@40 $Heap@@38 this@@58)) (= (_module.OwnedObject.localInv2 $prevHeap@@40 $Heap@@38 this@@58)  (and true (_module.OwnedObject.localUserInv2 $prevHeap@@40 $Heap@@38 this@@58)))))
 :qid |_10SequenceInvariantdfy.334:22|
 :skolemid |1486|
 :pattern ( (_module.OwnedObject.localInv2 $prevHeap@@40 $Heap@@38 this@@58) ($IsGoodHeap $Heap@@38))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@41 T@U) ($Heap@@39 T@U) (this@@59 T@U) ) (!  (=> (or (|_module.Integer.localUserInv2#canCall| $prevHeap@@41 $Heap@@39 this@@59) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@41) ($IsGoodHeap $Heap@@39)) ($HeapSucc $prevHeap@@41 $Heap@@39)) (and (or (not (= this@@59 null)) (not true)) (and ($Is refType this@@59 Tclass._module.Integer) ($IsAlloc refType this@@59 Tclass._module.Integer $prevHeap@@41)))))) (= (_module.Integer.localUserInv2 $prevHeap@@41 $Heap@@39 this@@59) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_10SequenceInvariantdfy.475:22|
 :skolemid |1813|
 :pattern ( (_module.Integer.localUserInv2 $prevHeap@@41 $Heap@@39 this@@59) ($IsGoodHeap $Heap@@39))
))))
...
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@64 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@64 null)) (not true)) ($Is refType this@@64 Tclass._module.Integer))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@46 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (or (= $o@@46 this@@64) (= $o@@46 (_module.Object.universe this@@64)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@46) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@46) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |1773|
)) (= (_module.Integer.baseUserFieldsInv $h0@@23 this@@64) (_module.Integer.baseUserFieldsInv $h1@@23 this@@64))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1774|
 :pattern ( ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23) (_module.Integer.baseUserFieldsInv $h1@@23 this@@64))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@41 T@U) (this@@66 T@U) ) (!  (=> (or (|_module.Integer.userInv#canCall| $Heap@@41 this@@66) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@41) (and (or (not (= this@@66 null)) (not true)) (and ($Is refType this@@66 Tclass._module.Integer) ($IsAlloc refType this@@66 Tclass._module.Integer $Heap@@41)))))) (=> (_module.Integer.userInv $Heap@@41 this@@66) (_module.Integer.localUserInv $Heap@@41 this@@66)))
 :qid |_10SequenceInvariantdfy.471:19|
 :skolemid |1803|
 :pattern ( (_module.Integer.userInv $Heap@@41 this@@66))
))))
...
(assert (forall (($h@@16 T@U) ($o@@49 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@49 null)) (not true)) (= (dtype $o@@49) Tclass._module.Integer?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@49) _module.Integer.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1771|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@49) _module.Integer.value)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@53 T@U) ($f@@37 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#10| |l#0| |l#1| |l#2| |l#3|) $o@@53 $f@@37))  (=> (and (or (not (= $o@@53 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@53) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2429|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#10| |l#0| |l#1| |l#2| |l#3|) $o@@53 $f@@37))
)))
(assert (forall (($h@@17 T@U) ($o@@54 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@54 null)) (not true)) ($Is refType $o@@54 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@54) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@54) _module.OwnedObject.owner)) Tclass._module.Object $h@@17))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1427|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@54) _module.OwnedObject.owner)))
)))
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@79 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@79 null)) (not true)) (and ($Is refType this@@79 Tclass._module.Universe) ($IsAlloc refType this@@79 Tclass._module.Universe $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@55 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@55 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@55) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@55) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@55) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |620|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@80 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@80 null)) (not true)) (and ($Is refType this@@80 Tclass._module.Object) ($IsAlloc refType this@@80 Tclass._module.Object $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@56 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@56 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@56) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@56) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@56) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1042|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@81 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@81 null)) (not true)) (and ($Is refType this@@81 Tclass._module.Object) ($IsAlloc refType this@@81 Tclass._module.Object $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@57 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@57 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@57) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@57) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@57) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1114|
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@82 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@82 null)) (not true)) (and ($Is refType this@@82 Tclass._module.Object) ($IsAlloc refType this@@82 Tclass._module.Object $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@58 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@58) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@58) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@58) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1124|
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@83 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@83 null)) (not true)) (and ($Is refType this@@83 Tclass._module.Thread) ($IsAlloc refType this@@83 Tclass._module.Thread $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@59 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@59) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@59) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@59) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1201|
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@84 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@84 null)) (not true)) (and ($Is refType this@@84 Tclass._module.Thread) ($IsAlloc refType this@@84 Tclass._module.Thread $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@60 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@60 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@60) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@60) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@60) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1213|
...
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@85 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@85 null)) (not true)) (and ($Is refType this@@85 Tclass._module.OwnedObject) ($IsAlloc refType this@@85 Tclass._module.OwnedObject $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@61 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@61 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@61) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@61) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@61) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1456|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@86 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@86 null)) (not true)) (and ($Is refType this@@86 Tclass._module.OwnedObject) ($IsAlloc refType this@@86 Tclass._module.OwnedObject $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@62 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@62 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@62) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@62) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@62) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1469|
...
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@87 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@87 null)) (not true)) (and ($Is refType this@@87 Tclass._module.OwnedObject) ($IsAlloc refType this@@87 Tclass._module.OwnedObject $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@63 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@63) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@63) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@63) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |1539|
...
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@88 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@88 null)) (not true)) (and ($Is refType this@@88 Tclass._module.OwnedObject) ($IsAlloc refType this@@88 Tclass._module.OwnedObject $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@64 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@64) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@64) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@64) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |1547|
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@89 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@89 null)) (not true)) (and ($Is refType this@@89 Tclass._module.Integer) ($IsAlloc refType this@@89 Tclass._module.Integer $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@65 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@65) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@65) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |1794|
)) (= (_module.Integer.localUserInv $h0@@36 this@@89) (_module.Integer.localUserInv $h1@@36 this@@89))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1795|
 :pattern ( ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36) (_module.Integer.localUserInv $h1@@36 this@@89))
)))
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.Integer) ($IsAlloc refType this@@90 Tclass._module.Integer $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@66 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@66) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@66) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@66) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |1801|
)) (= (_module.Integer.userInv $h0@@37 this@@90) (_module.Integer.userInv $h1@@37 this@@90))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1802|
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.Integer.userInv $h1@@37 this@@90))
)))
...
(assert (forall (($o@@69 T@U) ) (!  (=> ($Is refType $o@@69 Tclass._module.Integer?) ($Is refType $o@@69 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2417|
 :pattern ( ($Is refType $o@@69 Tclass._module.Integer?))
)))
(assert (forall ((bx@@19 T@U) ) (!  (=> ($IsBox bx@@19 Tclass._module.Integer?) ($IsBox bx@@19 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2415|
...
(assert (= (Tag Tclass._module.Integer?) Tagclass._module.Integer?))
(assert (= (TagFamily Tclass._module.Integer?) tytagFamily$Integer))
(assert (forall (($h@@18 T@U) ($o@@70 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@70 null)) (not true)) ($Is refType $o@@70 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@70) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1426|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@70) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h@@19 T@U) ($o@@74 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@74 null)) (not true)) ($Is refType $o@@74 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@74) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@74) _module.Universe.content)) (TSet Tclass._module.Object) $h@@19))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |607|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@74) _module.Universe.content)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@45 T@U) ($Heap@@52 T@U) (this@@91 T@U) ) (!  (=> (or (|_module.Integer.userInv2#canCall| $prevHeap@@45 $Heap@@52 this@@91) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@45) ($IsGoodHeap $Heap@@52)) ($HeapSucc $prevHeap@@45 $Heap@@52)) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.Integer) ($IsAlloc refType this@@91 Tclass._module.Integer $prevHeap@@45)))))) (=> (_module.Integer.userInv2 $prevHeap@@45 $Heap@@52 this@@91) (_module.Integer.localUserInv2 $prevHeap@@45 $Heap@@52 this@@91)))
 :qid |_10SequenceInvariantdfy.478:22|
 :skolemid |1818|
 :pattern ( (_module.Integer.userInv2 $prevHeap@@45 $Heap@@52 this@@91))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@54 T@U) (this@@93 T@U) ) (!  (=> (or (|_module.Integer.userInv#canCall| $Heap@@54 this@@93) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@54) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.Integer) ($IsAlloc refType this@@93 Tclass._module.Integer $Heap@@54)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Integer.localUserInv#canCall| $Heap@@54 this@@93)) (= (_module.Integer.userInv $Heap@@54 this@@93)  (and true (_module.Integer.localUserInv $Heap@@54 this@@93)))))
 :qid |_10SequenceInvariantdfy.471:19|
 :skolemid |1805|
 :pattern ( (_module.Integer.userInv $Heap@@54 this@@93) ($IsGoodHeap $Heap@@54))
))))
...
(assert (forall (($h@@20 T@U) ($o@@75 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (or (not (= $o@@75 null)) (not true)) ($Is refType $o@@75 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@75) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |606|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@20 $o@@75) _module.Universe.content)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Integer.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#10| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@97) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@97 Tclass._module.Integer $Heap@@58)) (=> ($IsAlloc refType this@@97 Tclass._module.Integer $Heap@@58) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@58)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@58) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@97) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@97 Tclass._module.Integer $Heap@@58))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@58) ($IsHeapAnchor $Heap@@58)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.Integer) ($IsAlloc refType this@@97 Tclass._module.Integer previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 14 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@58) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
