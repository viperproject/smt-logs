...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split162)
...
))))) (and (= (_module.Object.universe call5formal@this@0@@0) |universe#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.OwnedObject.owner)) |running#0@@3|))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.ClaimIncreasingCounterGreaterThanConstant.counter)) |counter#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.ClaimIncreasingCounterGreaterThanConstant.constant)) call4formal@this@0@@0)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0@@0)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call5formal@this@0@@0) alloc))))))) (and (and (and (forall (($o@@148 T@U) ) (!  (=> (and (or (not (= $o@@148 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@148) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@148) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@148)) (= $o@@148 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.657:3|
 :skolemid |3168|
