...
))))) (forall (($o@@164 T@U) ) (!  (=> (and (or (not (= $o@@164 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@26 $o@@164) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 $o@@164) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@26 $o@@164)) (or (= $o@@164 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@26 |universe#0|) _module.Universe.content)) ($Box refType $o@@164)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 $o@@164))
))) (and ($HeapSucc $Heap@26 $Heap@27) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= call4formal@this@0@@1 null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
