...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split387)
...
))))))))))) (and (and (and (and (and (and (=> |$w$loop#0@0| (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@4 |universe#0|) (and (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@4 |universe#0|) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content))) (forall ((|o#19@@1| T@U) ) (!  (=> (and ($Is refType |o#19@@1| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@1|)))) (not ($IsAllocBox ($Box refType |o#19@@1|) Tclass._module.Object $Heap@3)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |541|
