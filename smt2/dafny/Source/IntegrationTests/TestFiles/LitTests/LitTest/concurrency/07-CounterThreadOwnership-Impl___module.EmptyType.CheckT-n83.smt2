...
(assert (forall (($o@@10 T@U) ($h@@9 T@U) ) (! (= ($IsAlloc refType $o@@10 Tclass._module.EmptyType? $h@@9)  (or (= $o@@10 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@10) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1411|
 :pattern ( ($IsAlloc refType $o@@10 Tclass._module.EmptyType? $h@@9))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.EmptyType.baseUserInv#canCall| $Heap@@6 this@@12) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.EmptyType) ($IsAlloc refType this@@12 Tclass._module.EmptyType $Heap@@6)))))) (= (_module.EmptyType.baseUserInv $Heap@@6 this@@12) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.429:19|
 :skolemid |1431|
 :pattern ( (_module.EmptyType.baseUserInv $Heap@@6 this@@12) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.EmptyType.localUserInv#canCall| $Heap@@7 this@@13) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.EmptyType) ($IsAlloc refType this@@13 Tclass._module.EmptyType $Heap@@7)))))) (= (_module.EmptyType.localUserInv $Heap@@7 this@@13) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.433:19|
 :skolemid |1438|
 :pattern ( (_module.EmptyType.localUserInv $Heap@@7 this@@13) ($IsGoodHeap $Heap@@7))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@5 T@U) ($Heap@@9 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.EmptyType.unchangedNonvolatileUserFields#canCall| $prevHeap@@5 $Heap@@9 this@@15) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@15 null)) (not true)) ($Is refType this@@15 Tclass._module.EmptyType)))) (= (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@5 $Heap@@9 this@@15) (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@5 $Heap@@9 this@@15)))
 :qid |_07CounterThreadOwnershipdfy.383:22|
 :skolemid |1418|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@5 $Heap@@9 this@@15) ($Is refType this@@15 Tclass._module.EmptyType) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@5 $Heap@@9 this@@15) (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@5 $Heap@@9 this@@15) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@6 T@U) ($Heap@@10 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.OwnedObject.transitiveInv2#canCall| $prevHeap@@6 $Heap@@10 this@@16) (and (< 3 $FunctionContextHeight) (and (or (not (= this@@16 null)) (not true)) ($Is refType this@@16 Tclass._module.OwnedObject)))) (= (_module.Object.transitiveInv2 $prevHeap@@6 $Heap@@10 this@@16) (_module.OwnedObject.transitiveInv2 $prevHeap@@6 $Heap@@10 this@@16)))
 :qid |_07CounterThreadOwnershipdfy.274:22|
 :skolemid |1337|
 :pattern ( (_module.Object.transitiveInv2 $prevHeap@@6 $Heap@@10 this@@16) ($Is refType this@@16 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.Object.transitiveInv2 $prevHeap@@6 $Heap@@10 this@@16) (_module.OwnedObject.transitiveInv2 $prevHeap@@6 $Heap@@10 this@@16) ($IsGoodHeap $Heap@@10))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Object.baseInv#canCall| $Heap@@11 this@@17) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Object) ($IsAlloc refType this@@17 Tclass._module.Object $Heap@@11)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 (_module.Object.universe this@@17)) _module.Universe.content)) ($Box refType this@@17)) (|_module.Universe.globalBaseInv#canCall| $Heap@@11 (_module.Object.universe this@@17))) (= (_module.Object.baseInv $Heap@@11 this@@17)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 (_module.Object.universe this@@17)) _module.Universe.content)) ($Box refType this@@17)) (_module.Universe.globalBaseInv $Heap@@11 (_module.Object.universe this@@17))))))
 :qid |_07CounterThreadOwnershipdfy.243:19|
 :skolemid |971|
 :pattern ( (_module.Object.baseInv $Heap@@11 this@@17) ($IsGoodHeap $Heap@@11))
))))
...
(assert (forall (($o@@15 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@15 Tclass._module.EmptyType? $heap@@0) ($IsAlloc refType $o@@15 Tclass._module.OwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |3527|
 :pattern ( ($IsAlloc refType $o@@15 Tclass._module.EmptyType? $heap@@0))
)))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Object.objectGlobalInv#canCall| $Heap@@12 this@@18) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Object) ($IsAlloc refType this@@18 Tclass._module.Object $Heap@@12)))))) (and (and (|_module.Object.baseInv#canCall| $Heap@@12 this@@18) (=> (_module.Object.baseInv $Heap@@12 this@@18) (|_module.Universe.globalInv#canCall| $Heap@@12 (_module.Object.universe this@@18)))) (= (_module.Object.objectGlobalInv $Heap@@12 this@@18)  (and (_module.Object.baseInv $Heap@@12 this@@18) (_module.Universe.globalInv $Heap@@12 (_module.Object.universe this@@18))))))
 :qid |_07CounterThreadOwnershipdfy.264:19|
 :skolemid |1005|
 :pattern ( (_module.Object.objectGlobalInv $Heap@@12 this@@18) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@7 T@U) ($Heap@@13 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.EmptyType.unchangedNonvolatileUserFields#canCall| $prevHeap@@7 $Heap@@13 this@@19) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@7) ($IsGoodHeap $Heap@@13)) ($HeapSucc $prevHeap@@7 $Heap@@13)) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.EmptyType) ($IsAlloc refType this@@19 Tclass._module.EmptyType $prevHeap@@7)))))) (= (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@7 $Heap@@13 this@@19) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_07CounterThreadOwnershipdfy.424:22|
 :skolemid |1417|
 :pattern ( (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@7 $Heap@@13 this@@19) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.EmptyType.userInv#canCall| $Heap@@14 this@@20) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.EmptyType) ($IsAlloc refType this@@20 Tclass._module.EmptyType $Heap@@14)))))) (=> (_module.EmptyType.userInv $Heap@@14 this@@20) (_module.EmptyType.localUserInv $Heap@@14 this@@20)))
 :qid |_07CounterThreadOwnershipdfy.436:19|
 :skolemid |1443|
 :pattern ( (_module.EmptyType.userInv $Heap@@14 this@@20))
))))
...
(assert (forall (($h0@@5 T@U) ($h1@@5 T@U) (this@@25 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@17 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (or (= $o@@17 this@@25) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 this@@25) _module.Universe.content)) ($Box refType $o@@17)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@17) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@17) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |494|
...
(assert (forall (($h@@12 T@U) ($o@@18 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@18 null)) (not true)) ($Is refType $o@@18 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@18) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@18) _module.OwnedObject.owner)) Tclass._module.Object $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1292|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@18) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h0@@11 T@U) ($h1@@11 T@U) (this@@32 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.OwnedObject) ($IsAlloc refType this@@32 Tclass._module.OwnedObject $h0@@11)))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@24 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@24) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@24) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@24) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |1299|
...
(assert (forall (($h0@@14 T@U) ($h1@@14 T@U) (this@@35 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@14) ($IsGoodHeap $h1@@14)) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.OwnedObject) ($IsAlloc refType this@@35 Tclass._module.OwnedObject $h0@@14)))) (and ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14))) (=> (forall (($o@@27 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@27) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@27) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@14 $o@@27) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |1389|
...
(assert (forall (($h0@@15 T@U) ($h1@@15 T@U) (this@@36 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@15) ($IsGoodHeap $h1@@15)) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.OwnedObject) ($IsAlloc refType this@@36 Tclass._module.OwnedObject $h0@@15)))) (and ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15))) (=> (forall (($o@@28 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@28) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@28) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@15 $o@@28) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |1397|
...
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@37 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.EmptyType) ($IsAlloc refType this@@37 Tclass._module.EmptyType $h0@@16)))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@29 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@29) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@29) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@29) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |1427|
)) (= (_module.EmptyType.baseUserInv $h0@@16 this@@37) (_module.EmptyType.baseUserInv $h1@@16 this@@37))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1428|
 :pattern ( ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16) (_module.EmptyType.baseUserInv $h1@@16 this@@37))
)))
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@38 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.EmptyType) ($IsAlloc refType this@@38 Tclass._module.EmptyType $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@30 T@U) ($f@@18 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@30) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@30) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@30) $f@@18)))
 :qid |unknown.0:0|
 :skolemid |1434|
)) (= (_module.EmptyType.localUserInv $h0@@17 this@@38) (_module.EmptyType.localUserInv $h1@@17 this@@38))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1435|
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.EmptyType.localUserInv $h1@@17 this@@38))
)))
(assert (forall (($h0@@18 T@U) ($h1@@18 T@U) (this@@39 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.EmptyType) ($IsAlloc refType this@@39 Tclass._module.EmptyType $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@31 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@31) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@31) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@31) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |1441|
)) (= (_module.EmptyType.userInv $h0@@18 this@@39) (_module.EmptyType.userInv $h1@@18 this@@39))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1442|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.EmptyType.userInv $h1@@18 this@@39))
)))
...
(assert (forall (($o@@33 T@U) ) (!  (=> ($Is refType $o@@33 Tclass._module.EmptyType?) ($Is refType $o@@33 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3526|
 :pattern ( ($Is refType $o@@33 Tclass._module.EmptyType?))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@41 T@U) ) (!  (=> (or (|_module.EmptyType.userInv#canCall| $Heap@@21 this@@41) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@41 null)) (not true)) (and ($Is refType this@@41 Tclass._module.EmptyType) ($IsAlloc refType this@@41 Tclass._module.EmptyType $Heap@@21)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.EmptyType.localUserInv#canCall| $Heap@@21 this@@41)) (= (_module.EmptyType.userInv $Heap@@21 this@@41)  (and true (_module.EmptyType.localUserInv $Heap@@21 this@@41)))))
 :qid |_07CounterThreadOwnershipdfy.436:19|
 :skolemid |1445|
 :pattern ( (_module.EmptyType.userInv $Heap@@21 this@@41) ($IsGoodHeap $Heap@@21))
))))
...
(set-info :boogie-vc-id Impl$$_module.EmptyType.CheckTransitiveInv2)
...
(let ((anon2_correct  (=> (and (and (|_module.OwnedObject.transitiveInv2#canCall| $Heap@@23 $Heap@0 this@@43) (=> (_module.OwnedObject.transitiveInv2 $Heap@@23 $Heap@0 this@@43) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@23 $Heap@0 (_module.Object.universe this@@43)))) (and (_module.OwnedObject.transitiveInv2 $Heap@@23 $Heap@0 this@@43) (_module.Universe.baseLegalTransitionsSequence $Heap@@23 $Heap@0 (_module.Object.universe this@@43)))) (and (=> (= (ControlFlow 0 12) (- 0 16)) (or (not (= (_module.Object.universe this@@43) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@43) null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 15)) (forall (($o@@42 T@U) ($f@@22 T@U) ) (!  (=> (and (and (or (not (= $o@@42 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@42) alloc)))) (or (= $o@@42 (_module.Object.universe this@@43)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@43)) _module.Universe.content)) ($Box refType $o@@42)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@42 $f@@22)))
 :qid |_07CounterThreadOwnershipdfy.458:19|
 :skolemid |1602|
))) (=> (forall (($o@@43 T@U) ($f@@23 T@U) ) (!  (=> (and (and (or (not (= $o@@43 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@43) alloc)))) (or (= $o@@43 (_module.Object.universe this@@43)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.Object.universe this@@43)) _module.Universe.content)) ($Box refType $o@@43)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@43 $f@@23)))
 :qid |_07CounterThreadOwnershipdfy.458:19|
 :skolemid |1602|
...
))))) (forall (($o@@44 T@U) ) (!  (=> (and (or (not (= $o@@44 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@44) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@44) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@44)) (or (= $o@@44 call0formal@this@0) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call0formal@this@0) _module.Universe.content)) ($Box refType $o@@44)))))
 :qid |_07CounterThreadOwnershipdfy.104:10|
 :skolemid |689|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@44))
))) (and ($HeapSucc $Heap@0 $Heap@1) ($IsAllocBox ($Box refType this@@43) Tclass._module.OwnedObject? $Heap@1))) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($IsAlloc refType this@@43 Tclass._module.EmptyType $Heap@0)) (=> ($IsAlloc refType this@@43 Tclass._module.EmptyType $Heap@0) (=> (|_module.OwnedObject.transitiveInv2#canCall| $Heap@0 $Heap@1 this@@43) (and (=> (= (ControlFlow 0 12) 8) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct))))))))))))))))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@23 alloc (_module.Object.universe this@@43) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 (_module.Object.universe this@@43)) _module.Universe.content)))) (and (=> (= (ControlFlow 0 21) (- 0 25)) (or (not (= (_module.Object.universe this@@43) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@43) null)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall (($o@@45 T@U) ($f@@24 T@U) ) (!  (=> (and (and (or (not (= $o@@45 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@45) alloc)))) (or (= $o@@45 (_module.Object.universe this@@43)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 (_module.Object.universe this@@43)) _module.Universe.content)) ($Box refType $o@@45)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@45 $f@@24)))
 :qid |_07CounterThreadOwnershipdfy.455:19|
 :skolemid |1601|
))) (=> (forall (($o@@46 T@U) ($f@@25 T@U) ) (!  (=> (and (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@46) alloc)))) (or (= $o@@46 (_module.Object.universe this@@43)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 (_module.Object.universe this@@43)) _module.Universe.content)) ($Box refType $o@@46)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@46 $f@@25)))
 :qid |_07CounterThreadOwnershipdfy.455:19|
 :skolemid |1601|
...
))))) (forall (($o@@47 T@U) ) (!  (=> (and (or (not (= $o@@47 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@47) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@47) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@47)) (or (= $o@@47 call0formal@this@0@@0) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 call0formal@this@0@@0) _module.Universe.content)) ($Box refType $o@@47)))))
 :qid |_07CounterThreadOwnershipdfy.104:10|
 :skolemid |689|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@47))
))) (and ($HeapSucc $Heap@@23 $Heap@0) ($IsAllocBox ($Box refType this@@43) Tclass._module.OwnedObject? $Heap@0))) (and (=> (= (ControlFlow 0 21) (- 0 22)) ($IsAlloc refType this@@43 Tclass._module.EmptyType $Heap@@23)) (=> ($IsAlloc refType this@@43 Tclass._module.EmptyType $Heap@@23) (=> (|_module.OwnedObject.transitiveInv2#canCall| $Heap@@23 $Heap@0 this@@43) (and (=> (= (ControlFlow 0 21) 17) anon5_Then_correct) (=> (= (ControlFlow 0 21) 20) anon5_Else_correct))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@23) ($IsHeapAnchor $Heap@@23)) (=> (and (and (and (or (not (= this@@43 null)) (not true)) (and ($Is refType this@@43 Tclass._module.EmptyType) ($IsAlloc refType this@@43 Tclass._module.EmptyType $Heap@@23))) (= 11 $FunctionContextHeight)) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@@23 this@@43) (and (_module.Object.objectGlobalInv $Heap@@23 this@@43) (and (_module.Object.baseInv $Heap@@23 this@@43) (_module.Universe.globalInv $Heap@@23 (_module.Object.universe this@@43))))) (= (ControlFlow 0 26) 21))) anon0_correct))))
