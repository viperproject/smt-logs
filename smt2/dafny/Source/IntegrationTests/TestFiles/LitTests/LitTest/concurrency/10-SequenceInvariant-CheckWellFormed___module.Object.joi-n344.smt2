...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#57| null $Heap@@7 alloc (_module.Object.universe this@@14))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= (_module.Object.universe this@@14) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@14) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@14)) Tclass._module.Universe? $Heap@@7) (=> (and (|_module.Universe.globalBaseInv#canCall| $Heap@@7 (_module.Object.universe this@@14)) (_module.Universe.globalBaseInv $Heap@@7 (_module.Object.universe this@@14))) (=> (and (and ($IsAllocBox ($Box refType this@@14) Tclass._module.Object? $Heap@@7) (|_module.Object.baseFieldsInv#canCall| $Heap@@7 this@@14)) (and (_module.Object.baseFieldsInv $Heap@@7 this@@14) (or (not (= this@@14 (_module.Object.universe this@@14))) (not true)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@25) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@25)) (= $o@@25 (_module.Object.universe this@@14))))
