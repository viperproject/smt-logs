...
(set-info :boogie-vc-id CheckWellformed$$_module.Object.globalInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_correct  (=> (= (_module.Object.globalInv $Heap@@4 this@@3)  (and (_module.Object.baseInv $Heap@@4 this@@3) (_module.Universe.globalInv $Heap@@4 (_module.Object.universe this@@3)))) (=> (and (and (|_module.Object.baseInv#canCall| $Heap@@4 this@@3) (=> (_module.Object.baseInv $Heap@@4 this@@3) (|_module.Universe.globalInv#canCall| $Heap@@4 (_module.Object.universe this@@3)))) ($Is boolType (bool_2_U (_module.Object.globalInv $Heap@@4 this@@3)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@1|)))))))
(let ((anon8_Else_correct  (=> (not (_module.Object.baseInv $Heap@@4 this@@3)) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 7) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (_module.Object.baseInv $Heap@@4 this@@3) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (_module.Object.universe this@@3) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@3) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@3)) Tclass._module.Universe? $Heap@@4) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@10) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@10 $f@@0)))
 :qid |_05RecInvariantCutdfy.82:63|
 :skolemid |653|
))) (|_module.Universe.globalInv#canCall| $Heap@@4 (_module.Object.universe this@@3))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 5) 3))) anon5_correct)))))))
(let ((anon7_Else_correct  (=> ($IsAllocBox ($Box refType this@@3) Tclass._module.Object? $Heap@@4) (=> (and (= |b$reqreads#0@0| (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@11) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@11) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@11 $f@@1)))
 :qid |_05RecInvariantCutdfy.82:41|
 :skolemid |652|
))) (|_module.Object.baseInv#canCall| $Heap@@4 this@@3)) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Object) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@4))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
