...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split412)
...
)) (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|)) (and (not |$w$loop#0@0|) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@4))) (and (and (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|)) (and (_module.Universe.globalInv $Heap@4 |universe#0|) (= (ControlFlow 0 2) (- 0 1))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
