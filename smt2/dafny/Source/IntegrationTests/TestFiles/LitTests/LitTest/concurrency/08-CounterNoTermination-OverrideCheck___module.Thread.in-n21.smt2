...
(assert (forall (($o@@2 T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.NonOwnedObject? $h@@7)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |776|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.NonOwnedObject? $h@@7))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@4 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#3| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@4 $f))  (=> (and (or (not (= $o@@4 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@4) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@4) |l#4|)))))
...
(assert (forall ((bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 Tclass._module.NonOwnedObject) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) Tclass._module.NonOwnedObject)))
 :qid |unknown.0:0|
 :skolemid |482|
 :pattern ( ($IsBox bx@@3 Tclass._module.NonOwnedObject))
)))
...
(assert (forall (($o@@7 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@7 Tclass._module.NonOwnedObject? $heap) ($IsAlloc refType $o@@7 Tclass._module.Object? $heap))
 :qid |unknown.0:0|
 :skolemid |2248|
 :pattern ( ($IsAlloc refType $o@@7 Tclass._module.NonOwnedObject? $heap))
)))
(assert (forall (($o@@8 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@8 Tclass._module.Thread? $heap@@0) ($IsAlloc refType $o@@8 Tclass._module.NonOwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |2252|
 :pattern ( ($IsAlloc refType $o@@8 Tclass._module.Thread? $heap@@0))
)))
...
(assert (forall (($o@@9 T@U) ) (!  (=> ($Is refType $o@@9 Tclass._module.NonOwnedObject?) ($Is refType $o@@9 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |2247|
 :pattern ( ($Is refType $o@@9 Tclass._module.NonOwnedObject?))
)))
(assert (forall ((bx@@12 T@U) ) (!  (=> ($IsBox bx@@12 Tclass._module.NonOwnedObject?) ($IsBox bx@@12 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |2245|
 :pattern ( ($IsBox bx@@12 Tclass._module.NonOwnedObject?))
)))
(assert (forall (($o@@10 T@U) ) (!  (=> ($Is refType $o@@10 Tclass._module.Thread?) ($Is refType $o@@10 Tclass._module.NonOwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2251|
 :pattern ( ($Is refType $o@@10 Tclass._module.Thread?))
)))
(assert (forall ((bx@@13 T@U) ) (!  (=> ($IsBox bx@@13 Tclass._module.Thread?) ($IsBox bx@@13 Tclass._module.NonOwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2249|
...
(assert (forall (($o@@13 T@U) ) (! (= ($Is refType $o@@13 Tclass._module.NonOwnedObject?)  (or (= $o@@13 null) (implements$_module.NonOwnedObject (dtype $o@@13))))
 :qid |unknown.0:0|
 :skolemid |775|
 :pattern ( ($Is refType $o@@13 Tclass._module.NonOwnedObject?))
)))
(assert (forall (($h@@10 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@14 null)) (not true)) ($Is refType $o@@14 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@14) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@14) _module.Universe.content)) (TSet Tclass._module.Object) $h@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
...
(assert (forall (($h@@11 T@U) ($o@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@15 null)) (not true)) ($Is refType $o@@15 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@15) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |492|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@15) _module.Universe.content)))
)))
(push 1)
...
(set-info :boogie-vc-id OverrideCheck$$_module.Thread.inv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= Thread_$_ReadsFrame@0 (|lambda#3| null $Heap@@4 alloc $Heap@@4 alloc)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@16 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@16) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@16) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@16) alloc))))
 :qid |_08CounterNoTerminationdfy.137:19|
 :skolemid |805|
))) (=> (forall (($o@@17 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@17 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@17) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@17) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@17) alloc))))
 :qid |_08CounterNoTerminationdfy.137:19|
 :skolemid |805|
)) (=> (=> (_module.Thread.inv $Heap@@4 this@@4) (_module.Thread.localInv $Heap@@4 this@@4)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (_module.Thread.inv $Heap@@4 this@@4) (=> (|_module.Thread.localInv#canCall| $Heap@@4 this@@4) (or (_module.Thread.localInv $Heap@@4 this@@4) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.Thread.inv $Heap@@4 this@@4) (=> (|_module.Thread.localInv#canCall| $Heap@@4 this@@4) (or (_module.Thread.localInv $Heap@@4 this@@4) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.Thread.inv $Heap@@4 this@@4) (=> (|_module.Thread.localInv#canCall| $Heap@@4 this@@4) (or (_module.Thread.localInv $Heap@@4 this@@4) (=> (|_module.Object.baseInv#canCall| $Heap@@4 this@@4) (or (_module.Object.baseInv $Heap@@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType this@@4)))))))) (=> (=> (_module.Thread.inv $Heap@@4 this@@4) (=> (|_module.Thread.localInv#canCall| $Heap@@4 this@@4) (or (_module.Thread.localInv $Heap@@4 this@@4) (=> (|_module.Object.baseInv#canCall| $Heap@@4 this@@4) (or (_module.Object.baseInv $Heap@@4 this@@4) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType this@@4))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.Thread.inv $Heap@@4 this@@4) (=> (|_module.Thread.localInv#canCall| $Heap@@4 this@@4) (or (_module.Thread.localInv $Heap@@4 this@@4) (=> (|_module.Object.baseInv#canCall| $Heap@@4 this@@4) (or (_module.Object.baseInv $Heap@@4 this@@4) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@4 (_module.Object.universe this@@4)) (or (_module.Universe.globalBaseInv $Heap@@4 (_module.Object.universe this@@4)) (forall ((|o#1| T@U) ) (!  (=> (and ($Is refType |o#1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType |o#1|))) (and (= (_module.Object.universe |o#1|) (_module.Object.universe this@@4)) (or (not (= |o#1| (_module.Object.universe this@@4))) (not true))))
 :qid |_08CounterNoTerminationdfy.34:12|
 :skolemid |806|
 :pattern ( (_module.Object.universe |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType |o#1|)))
))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Thread) ($IsAlloc refType this@@4 Tclass._module.Thread $Heap@@4))) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
