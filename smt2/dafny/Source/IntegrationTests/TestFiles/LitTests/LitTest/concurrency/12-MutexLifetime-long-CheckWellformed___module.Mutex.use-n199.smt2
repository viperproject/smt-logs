...
(assert (forall ((|c#0@@1| T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType |c#0@@1| Tclass._module.OwnedU32 $h@@4) ($IsAlloc refType |c#0@@1| Tclass._module.OwnedU32? $h@@4))
 :qid |unknown.0:0|
 :skolemid |2958|
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.OwnedU32 $h@@4))
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.OwnedU32? $h@@4))
)))
(assert (forall ((|c#0@@2| T@U) ($h@@5 T@U) ) (! (= ($IsAlloc refType |c#0@@2| Tclass._module.Mutex $h@@5) ($IsAlloc refType |c#0@@2| Tclass._module.Mutex? $h@@5))
 :qid |unknown.0:0|
 :skolemid |3544|
 :pattern ( ($IsAlloc refType |c#0@@2| Tclass._module.Mutex $h@@5))
 :pattern ( ($IsAlloc refType |c#0@@2| Tclass._module.Mutex? $h@@5))
)))
...
(assert (forall (($o@@3 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.Object? $h@@6)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1696|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.Object? $h@@6))
)))
(assert (forall (($o@@4 T@U) ($h@@7 T@U) ) (! (= ($IsAlloc refType $o@@4 Tclass._module.OwnedObject? $h@@7)  (or (= $o@@4 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@4) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2103|
 :pattern ( ($IsAlloc refType $o@@4 Tclass._module.OwnedObject? $h@@7))
)))
(assert (forall (($o@@5 T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType $o@@5 Tclass._module.OwnedU32? $h@@8)  (or (= $o@@5 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@5) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2710|
 :pattern ( ($IsAlloc refType $o@@5 Tclass._module.OwnedU32? $h@@8))
)))
(assert (forall (($o@@6 T@U) ($h@@9 T@U) ) (! (= ($IsAlloc refType $o@@6 Tclass._module.Mutex? $h@@9)  (or (= $o@@6 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@6) alloc)))))
 :qid |unknown.0:0|
 :skolemid |3253|
 :pattern ( ($IsAlloc refType $o@@6 Tclass._module.Mutex? $h@@9))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@7 T@U) ($f@@1 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#96| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@7 $f@@1))  (=> (and (or (not (= $o@@7 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@7) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@7) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3867|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#96| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@7 $f@@1))
)))
...
(assert (forall (($h@@10 T@U) ($o@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass._module.Mutex?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@8) _module.Mutex.data)) Tclass._module.OwnedU32))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3254|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@8) _module.Mutex.data)))
)))
...
(assert (forall (($h@@11 T@U) ($o@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass._module.Mutex?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@9) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@9) _module.Mutex.data)) Tclass._module.OwnedU32 $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |3255|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@9) _module.Mutex.data)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Mutex.userInv2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (=> (_module.Mutex.userInv2 previous$Heap current$Heap this@@4) (=> (|_module.Mutex.localUserInv2#canCall| previous$Heap current$Heap this@@4) (or (_module.Mutex.localUserInv2 previous$Heap current$Heap this@@4) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.Mutex.userInv2 previous$Heap current$Heap this@@4) (=> (|_module.Mutex.localUserInv2#canCall| previous$Heap current$Heap this@@4) (or (_module.Mutex.localUserInv2 previous$Heap current$Heap this@@4) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 8) (- 0 7)) (=> (_module.Mutex.userInv2 previous$Heap current$Heap this@@4) (=> (|_module.Mutex.localUserInv2#canCall| previous$Heap current$Heap this@@4) (or (_module.Mutex.localUserInv2 previous$Heap current$Heap this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@4) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@4) _module.Mutex.data)))))))))))
(let ((anon8_correct  (=> (= (_module.Mutex.userInv2 $Heap@@2 current$Heap this@@4)  (and true (_module.Mutex.localUserInv2 $Heap@@2 current$Heap this@@4))) (=> (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Mutex.localUserInv2#canCall| $Heap@@2 current$Heap this@@4)) ($Is boolType (bool_2_U (_module.Mutex.userInv2 $Heap@@2 current$Heap this@@4)) TBool)) (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 10) 8) GeneratedUnifiedExit_correct)))))))
...
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@4) Tclass._module.Mutex? current$Heap)) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($IsAlloc refType this@@4 Tclass._module.Mutex $Heap@@2)) (=> ($IsAlloc refType this@@4 Tclass._module.Mutex $Heap@@2) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@18 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@2)))
 :qid |_12MutexLifetimelongdfy.794:8|
 :skolemid |3315|
))) (|_module.Mutex.localUserInv2#canCall| $Heap@@2 current$Heap this@@4)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 12) 10))) anon8_correct))))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (and (=> (_module.Mutex.userInv2 $Heap@@2 current$Heap this@@4) (_module.Mutex.localUserInv2 $Heap@@2 current$Heap this@@4)) (= (ControlFlow 0 6) 1)) anon5_correct)))
(let ((anon11_Then_correct  (=> ($IsAllocBox ($Box refType this@@4) Tclass._module.Mutex? current$Heap) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType this@@4 Tclass._module.Mutex $Heap@@2)) (=> ($IsAlloc refType this@@4 Tclass._module.Mutex $Heap@@2) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (= this@@4 this@@4) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@4 this@@4) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (or (= this@@4 this@@4) (|_module.Mutex.userInv2#canCall| $Heap@@2 current$Heap this@@4)) (=> (and (_module.Mutex.userInv2 $Heap@@2 current$Heap this@@4) ($IsAllocBox ($Box refType this@@4) Tclass._module.Mutex? current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@4 Tclass._module.Mutex $Heap@@2)) (=> ($IsAlloc refType this@@4 Tclass._module.Mutex $Heap@@2) (=> (|_module.Mutex.localUserInv2#canCall| $Heap@@2 current$Heap this@@4) (=> (and (_module.Mutex.localUserInv2 $Heap@@2 current$Heap this@@4) (= (ControlFlow 0 2) 1)) anon5_correct)))))))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#96| null current$Heap alloc current$Heap alloc)) (and (and (and (=> (= (ControlFlow 0 15) 12) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)) (=> (= (ControlFlow 0 15) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 15) 6) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Mutex) ($IsAlloc refType this@@4 Tclass._module.Mutex previous$Heap))) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@2) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 16) 15))) anon0_correct))))
