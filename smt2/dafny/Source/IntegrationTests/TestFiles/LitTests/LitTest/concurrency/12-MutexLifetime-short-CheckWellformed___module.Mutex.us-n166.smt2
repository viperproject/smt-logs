...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Mutex.userInv#canCall| $Heap@@3 this@@3) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Mutex) ($IsAlloc refType this@@3 Tclass._module.Mutex $Heap@@3)))))) (and (and (|_module.Mutex.localUserInv#canCall| $Heap@@3 this@@3) (=> (_module.Mutex.localUserInv $Heap@@3 this@@3) (forall ((|g#0| T@U) ) (!  (=> ($Is refType |g#0| Tclass._module.MutexGuardU32) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.guards)) ($Box refType |g#0|)) (|_module.OwnedObject.localInv#canCall| $Heap@@3 |g#0|)))
 :qid |_12MutexLifetimeshortdfy.787:16|
 :skolemid |2946|
 :pattern ( (_module.OwnedObject.localInv $Heap@@3 |g#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.guards)) ($Box refType |g#0|)))
)))) (= (_module.Mutex.userInv $Heap@@3 this@@3)  (and (_module.Mutex.localUserInv $Heap@@3 this@@3) (forall ((|g#0@@0| T@U) ) (!  (=> (and ($Is refType |g#0@@0| Tclass._module.MutexGuardU32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.guards)) ($Box refType |g#0@@0|))) (_module.OwnedObject.localInv $Heap@@3 |g#0@@0|))
 :qid |_12MutexLifetimeshortdfy.787:16|
 :skolemid |2945|
 :pattern ( (_module.OwnedObject.localInv $Heap@@3 |g#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.guards)) ($Box refType |g#0@@0|)))
))))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@7 this@@7) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.Lifetime)))) (= (_module.Object.baseFieldsInv $Heap@@7 this@@7) (_module.Lifetime.baseFieldsInv $Heap@@7 this@@7)))
 :qid |_12MutexLifetimeshortdfy.348:19|
 :skolemid |1952|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 this@@7) ($Is refType this@@7 Tclass._module.Lifetime) ($IsGoodHeap $Heap@@7))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 this@@7) (_module.Lifetime.baseFieldsInv $Heap@@7 this@@7) ($IsGoodHeap $Heap@@7))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.Mutex.localUserInv#canCall| $Heap@@8 this@@8) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.Mutex)))) (= (_module.OwnedObject.localUserInv $Heap@@8 this@@8) (_module.Mutex.localUserInv $Heap@@8 this@@8)))
 :qid |_12MutexLifetimeshortdfy.520:19|
 :skolemid |2939|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@9 this@@9) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.localUserInv $Heap@@9 this@@9) (_module.MutexGuardU32.localUserInv $Heap@@9 this@@9)))
 :qid |_12MutexLifetimeshortdfy.520:19|
 :skolemid |3231|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@9 this@@9) ($Is refType this@@9 Tclass._module.MutexGuardU32) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@9 this@@9) (_module.MutexGuardU32.localUserInv $Heap@@9 this@@9) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@10 this@@10) (and (< 5 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.OwnedObject)))) (= (_module.Object.baseFieldsInv $Heap@@10 this@@10) (_module.OwnedObject.baseFieldsInv $Heap@@10 this@@10)))
 :qid |_12MutexLifetimeshortdfy.348:19|
 :skolemid |1781|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@10 this@@10) ($Is refType this@@10 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@10 this@@10) (_module.OwnedObject.baseFieldsInv $Heap@@10 this@@10) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@11 T@U) (this@@11 T@U) (|a#0@@2| T@U) (|b#0@@2| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.Universe))) ($Is refType |a#0@@2| Tclass._module.Lifetime)) ($Is refType |b#0@@2| Tclass._module.Lifetime)) (_module.Universe.outlives ($LS $ly@@2) $Heap@@11 this@@11 |a#0@@2| |b#0@@2|)) (exists ((|_k#0@@0| Int) ) (!  (and (<= (LitInt 0) |_k#0@@0|) (_module.Universe.outlives_h ($LS $ly@@2) $Heap@@11 this@@11 |_k#0@@0| |a#0@@2| |b#0@@2|))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1222|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@2) $Heap@@11 this@@11 |_k#0@@0| |a#0@@2| |b#0@@2|))
)))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1223|
 :pattern ( (_module.Universe.outlives ($LS $ly@@2) $Heap@@11 this@@11 |a#0@@2| |b#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) ($Heap@@12 T@U) (this@@12 T@U) (|a#0@@3| T@U) (|b#0@@3| T@U) ) (!  (=> (or (|_module.Universe.outlives#canCall| $Heap@@12 this@@12 |a#0@@3| |b#0@@3|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Universe) ($IsAlloc refType this@@12 Tclass._module.Universe $Heap@@12)))) ($Is refType |a#0@@3| Tclass._module.Lifetime)) ($Is refType |b#0@@3| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@12) _module.Universe.content)) ($Box refType |a#0@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@12) _module.Universe.content)) ($Box refType |b#0@@3|)))))) (and (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 |b#0@@3|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@3|))) (forall ((|x#0@@1| T@U) ) (!  (=> ($Is refType |x#0@@1| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@12) _module.Universe.content)) ($Box refType |x#0@@1|)) (|_module.Universe.outlivesThrough#canCall| $Heap@@12 this@@12 |a#0@@3| |x#0@@1| |b#0@@3|)))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |1220|
 :pattern ( (_module.Universe.outlivesThrough $ly@@3 $Heap@@12 this@@12 |a#0@@3| |x#0@@1| |b#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@12) _module.Universe.content)) ($Box refType |x#0@@1|)))
))) (= (_module.Universe.outlives ($LS $ly@@3) $Heap@@12 this@@12 |a#0@@3| |b#0@@3|)  (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 |b#0@@3|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@3|)) (exists ((|x#0@@2| T@U) ) (!  (and (and ($Is refType |x#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@12) _module.Universe.content)) ($Box refType |x#0@@2|))) (_module.Universe.outlivesThrough $ly@@3 $Heap@@12 this@@12 |a#0@@3| |x#0@@2| |b#0@@3|))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |1219|
 :pattern ( (_module.Universe.outlivesThrough $ly@@3 $Heap@@12 this@@12 |a#0@@3| |x#0@@2| |b#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@12) _module.Universe.content)) ($Box refType |x#0@@2|)))
))))))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1221|
 :pattern ( (_module.Universe.outlives ($LS $ly@@3) $Heap@@12 this@@12 |a#0@@3| |b#0@@3|) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@4 T@U) ($Heap@@13 T@U) (this@@13 T@U) (|_k#0@@1| Int) (|a#0@@4| T@U) (|x#0@@3| T@U) (|b#0@@4| T@U) ) (!  (=> (or (|_module.Universe.outlivesThrough_h#canCall| $Heap@@13 this@@13 |_k#0@@1| |a#0@@4| |x#0@@3| |b#0@@4|) (and (< 2 $FunctionContextHeight) (and (and (and (and (and (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Universe) ($IsAlloc refType this@@13 Tclass._module.Universe $Heap@@13)))) (<= (LitInt 0) |_k#0@@1|)) ($Is refType |a#0@@4| Tclass._module.Lifetime)) ($Is refType |x#0@@3| Tclass._module.Lifetime)) ($Is refType |b#0@@4| Tclass._module.Lifetime)) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |a#0@@4|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |x#0@@3|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@13) _module.Universe.content)) ($Box refType |b#0@@4|)))))) (and (=> (< 0 |_k#0@@1|) (=> (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |a#0@@4|) _module.Lifetime.mightPointFrom)) ($Box refType |x#0@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |b#0@@4|) _module.Lifetime.mightPointTo)) ($Box refType |x#0@@3|))) (and (|_module.Universe.outlives_h#canCall| $Heap@@13 this@@13 (- |_k#0@@1| 1) |a#0@@4| |x#0@@3|) (=> (_module.Universe.outlives_h ($LS $LZ) $Heap@@13 this@@13 (- |_k#0@@1| 1) |a#0@@4| |x#0@@3|) (|_module.Universe.outlives_h#canCall| $Heap@@13 this@@13 (- |_k#0@@1| 1) |x#0@@3| |b#0@@4|))))) (= (_module.Universe.outlivesThrough_h ($LS $ly@@4) $Heap@@13 this@@13 |_k#0@@1| |a#0@@4| |x#0@@3| |b#0@@4|)  (and (< 0 |_k#0@@1|) (and (and (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |a#0@@4|) _module.Lifetime.mightPointFrom)) ($Box refType |x#0@@3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |b#0@@4|) _module.Lifetime.mightPointTo)) ($Box refType |x#0@@3|))) (_module.Universe.outlives_h ($LS $LZ) $Heap@@13 this@@13 (- |_k#0@@1| 1) |a#0@@4| |x#0@@3|)) (_module.Universe.outlives_h ($LS $LZ) $Heap@@13 this@@13 (- |_k#0@@1| 1) |x#0@@3| |b#0@@4|))))))
 :qid |_12MutexLifetimeshortdfy.165:19|
 :skolemid |1258|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $ly@@4) $Heap@@13 this@@13 |_k#0@@1| |a#0@@4| |x#0@@3| |b#0@@4|) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@14 this@@14) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Object) ($IsAlloc refType this@@14 Tclass._module.Object $Heap@@14)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 (_module.Object.universe this@@14)) _module.Universe.content)) ($Box refType this@@14)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@14 this@@14) (=> (_module.Object.baseFieldsInv $Heap@@14 this@@14) (|_module.Universe.globalBaseInv#canCall| $Heap@@14 (_module.Object.universe this@@14))))) (= (_module.Object.objectGlobalBaseInv $Heap@@14 this@@14)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 (_module.Object.universe this@@14)) _module.Universe.content)) ($Box refType this@@14)) (_module.Object.baseFieldsInv $Heap@@14 this@@14)) (_module.Universe.globalBaseInv $Heap@@14 (_module.Object.universe this@@14))))))
 :qid |_12MutexLifetimeshortdfy.301:19|
 :skolemid |1348|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@14 this@@14) ($IsGoodHeap $Heap@@14))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.MutexGuardU32.objectUserFields#canCall| $Heap@@15 this@@15) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@15 Tclass._module.MutexGuardU32 $Heap@@15)))))) (= (_module.MutexGuardU32.objectUserFields $Heap@@15 this@@15) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@15) _module.MutexGuardU32.mutex)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@15) _module.MutexGuardU32.data))))
 :qid |_12MutexLifetimeshortdfy.848:18|
 :skolemid |3216|
 :pattern ( (_module.MutexGuardU32.objectUserFields $Heap@@15 this@@15) ($IsGoodHeap $Heap@@15))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@5 T@U) ($Heap@@16 T@U) (this@@16 T@U) (|a#0@@5| T@U) (|x#0@@4| T@U) (|b#0@@5| T@U) (|_k#0@@2| Int) ) (!  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@16 null)) (not true)) ($Is refType this@@16 Tclass._module.Universe))) ($Is refType |a#0@@5| Tclass._module.Lifetime)) ($Is refType |x#0@@4| Tclass._module.Lifetime)) ($Is refType |b#0@@5| Tclass._module.Lifetime)) (= |_k#0@@2| 0)) (not (_module.Universe.outlivesThrough_h $ly@@5 $Heap@@16 this@@16 |_k#0@@2| |a#0@@5| |x#0@@4| |b#0@@5|)))
 :qid |_12MutexLifetimeshortdfy.165:19|
 :skolemid |1249|
 :pattern ( (_module.Universe.outlivesThrough_h $ly@@5 $Heap@@16 this@@16 |_k#0@@2| |a#0@@5| |x#0@@4| |b#0@@5|))
))))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@12 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#59| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@12 $f))  (=> (and (or (not (= $o@@12 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@12) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@12) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3521|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#59| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@12 $f))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@29 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@29 this@@29) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Mutex) ($IsAlloc refType this@@29 Tclass._module.Mutex $Heap@@29)))))) (= (_module.Mutex.objectUserFields $Heap@@29 this@@29) (let ((|r#0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.Mutex.data)))))
|r#0|)))
 :qid |_12MutexLifetimeshortdfy.763:18|
 :skolemid |2924|
 :pattern ( (_module.Mutex.objectUserFields $Heap@@29 this@@29) ($IsGoodHeap $Heap@@29))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@30 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Mutex.localUserInv#canCall| $Heap@@30 this@@30) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@30) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Mutex) ($IsAlloc refType this@@30 Tclass._module.Mutex $Heap@@30)))))) (= (_module.Mutex.localUserInv $Heap@@30 this@@30)  (and (and (= (_module.OwnedObject.lifetime this@@30) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Mutex.data)))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Mutex.locked))) (and ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32) (let ((|mutexGuard#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Mutex.data))) _module.OwnedObject.owner))))
 (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |mutexGuard#0|) _module.OwnedObject.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |mutexGuard#0|) _module.MutexGuardU32.mutex)) this@@30)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType |mutexGuard#0|)))))))) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Mutex.locked)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Mutex.data))) _module.OwnedObject.owner)) this@@30) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@30) _module.Mutex.guards)) |Set#Empty|))))))
 :qid |_12MutexLifetimeshortdfy.769:19|
 :skolemid |2938|
 :pattern ( (_module.Mutex.localUserInv $Heap@@30 this@@30) ($IsGoodHeap $Heap@@30))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@31 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.OwnedU32.objectUserFields#canCall| $Heap@@31 this@@31) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@31) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.OwnedU32) ($IsAlloc refType this@@31 Tclass._module.OwnedU32 $Heap@@31)))))) ($Is SetType (_module.OwnedU32.objectUserFields $Heap@@31 this@@31) (TSet Tclass._module.Object)))
 :qid |_12MutexLifetimeshortdfy.638:18|
 :skolemid |2372|
 :pattern ( (_module.OwnedU32.objectUserFields $Heap@@31 this@@31))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@32 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@32 this@@32) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@32) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.Mutex) ($IsAlloc refType this@@32 Tclass._module.Mutex $Heap@@32)))))) ($Is SetType (_module.Mutex.objectUserFields $Heap@@32 this@@32) (TSet Tclass._module.Object)))
 :qid |_12MutexLifetimeshortdfy.763:18|
 :skolemid |2921|
 :pattern ( (_module.Mutex.objectUserFields $Heap@@32 this@@32))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@33 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.MutexGuardU32.objectUserFields#canCall| $Heap@@33 this@@33) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@33) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@33 Tclass._module.MutexGuardU32 $Heap@@33)))))) ($Is SetType (_module.MutexGuardU32.objectUserFields $Heap@@33 this@@33) (TSet Tclass._module.Object)))
 :qid |_12MutexLifetimeshortdfy.848:18|
 :skolemid |3213|
 :pattern ( (_module.MutexGuardU32.objectUserFields $Heap@@33 this@@33))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@36 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@36 this@@36) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@36) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.OwnedObject) ($IsAlloc refType this@@36 Tclass._module.OwnedObject $Heap@@36)))))) (and (|_module.OwnedObject.objectFields#canCall| $Heap@@36 this@@36) (= (_module.OwnedObject.baseFieldsInv $Heap@@36 this@@36) (|Set#Subset| (_module.OwnedObject.objectFields $Heap@@36 this@@36) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 (_module.Object.universe this@@36)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.432:19|
 :skolemid |1780|
 :pattern ( (_module.OwnedObject.baseFieldsInv $Heap@@36 this@@36) ($IsGoodHeap $Heap@@36))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@37 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.Object.nonAliasing#canCall| $Heap@@37 this@@37) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@37) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.Object) ($IsAlloc refType this@@37 Tclass._module.Object $Heap@@37)))))) (and (and (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@37)) (|_module.Object.objectClassKind#canCall| this@@37)) (=> (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@37) |#_module.ObjectClassKind.Thread|) ($Is refType this@@37 Tclass._module.Thread)) (and (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@37)) (|_module.Object.objectClassKind#canCall| this@@37)) (=> (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@37) |#_module.ObjectClassKind.OwnedObject|) ($Is refType this@@37 Tclass._module.OwnedObject)) (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@37)) (|_module.Object.objectClassKind#canCall| this@@37)))))) (= (_module.Object.nonAliasing $Heap@@37 this@@37)  (and (and (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@37) |#_module.ObjectClassKind.Thread|) ($Is refType this@@37 Tclass._module.Thread)) (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@37) |#_module.ObjectClassKind.OwnedObject|) ($Is refType this@@37 Tclass._module.OwnedObject))) (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@37) |#_module.ObjectClassKind.Lifetime|) ($Is refType this@@37 Tclass._module.Lifetime))))))
 :qid |_12MutexLifetimeshortdfy.309:19|
 :skolemid |1368|
 :pattern ( (_module.Object.nonAliasing $Heap@@37 this@@37) ($IsGoodHeap $Heap@@37))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@38 T@U) (this@@41 T@U) ) (!  (=> (or (|_module.OwnedU32.objectUserFields#canCall| $Heap@@38 this@@41) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@38) (or (not (= this@@41 null)) (not true))) ($IsAlloc refType this@@41 Tclass._module.OwnedU32 $Heap@@38)))) ($IsAlloc SetType (_module.OwnedU32.objectUserFields $Heap@@38 this@@41) (TSet Tclass._module.Object) $Heap@@38))
 :qid |_12MutexLifetimeshortdfy.638:18|
 :skolemid |2373|
 :pattern ( ($IsAlloc SetType (_module.OwnedU32.objectUserFields $Heap@@38 this@@41) (TSet Tclass._module.Object) $Heap@@38))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@39 T@U) (this@@42 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@39 this@@42) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@39) (or (not (= this@@42 null)) (not true))) ($IsAlloc refType this@@42 Tclass._module.Mutex $Heap@@39)))) ($IsAlloc SetType (_module.Mutex.objectUserFields $Heap@@39 this@@42) (TSet Tclass._module.Object) $Heap@@39))
 :qid |_12MutexLifetimeshortdfy.763:18|
 :skolemid |2922|
 :pattern ( ($IsAlloc SetType (_module.Mutex.objectUserFields $Heap@@39 this@@42) (TSet Tclass._module.Object) $Heap@@39))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@40 T@U) (this@@43 T@U) ) (!  (=> (or (|_module.MutexGuardU32.objectUserFields#canCall| $Heap@@40 this@@43) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@40) (or (not (= this@@43 null)) (not true))) ($IsAlloc refType this@@43 Tclass._module.MutexGuardU32 $Heap@@40)))) ($IsAlloc SetType (_module.MutexGuardU32.objectUserFields $Heap@@40 this@@43) (TSet Tclass._module.Object) $Heap@@40))
 :qid |_12MutexLifetimeshortdfy.848:18|
 :skolemid |3214|
 :pattern ( ($IsAlloc SetType (_module.MutexGuardU32.objectUserFields $Heap@@40 this@@43) (TSet Tclass._module.Object) $Heap@@40))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@41 T@U) (this@@44 T@U) ) (!  (=> (or (|_module.OwnedObject.objectUserFields#canCall| $Heap@@41 this@@44) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@41) (or (not (= this@@44 null)) (not true))) ($IsAlloc refType this@@44 Tclass._module.OwnedObject $Heap@@41)))) ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@41 this@@44) (TSet Tclass._module.Object) $Heap@@41))
 :qid |_12MutexLifetimeshortdfy.518:18|
 :skolemid |1877|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@41 this@@44) (TSet Tclass._module.Object) $Heap@@41))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@42 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@42 this@@45) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@42) (or (not (= this@@45 null)) (not true))) ($IsAlloc refType this@@45 Tclass._module.OwnedObject $Heap@@42)))) ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@42 this@@45) (TSet Tclass._module.Object) $Heap@@42))
 :qid |_12MutexLifetimeshortdfy.426:18|
 :skolemid |1772|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@42 this@@45) (TSet Tclass._module.Object) $Heap@@42))
))))
(assert (forall (($ly@@10 T@U) ($Heap@@43 T@U) (this@@46 T@U) (|_k#0@@7| Int) (|a#0@@10| T@U) (|b#0@@10| T@U) ) (! (= (_module.Universe.outlives_h ($LS $ly@@10) $Heap@@43 this@@46 |_k#0@@7| |a#0@@10| |b#0@@10|) (_module.Universe.outlives_h $ly@@10 $Heap@@43 this@@46 |_k#0@@7| |a#0@@10| |b#0@@10|))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1230|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@10) $Heap@@43 this@@46 |_k#0@@7| |a#0@@10| |b#0@@10|))
)))
(assert (forall (($ly@@11 T@U) ($Heap@@44 T@U) (this@@47 T@U) (|a#0@@11| T@U) (|x#0@@7| T@U) (|b#0@@11| T@U) ) (! (= (_module.Universe.outlivesThrough ($LS $ly@@11) $Heap@@44 this@@47 |a#0@@11| |x#0@@7| |b#0@@11|) (_module.Universe.outlivesThrough $ly@@11 $Heap@@44 this@@47 |a#0@@11| |x#0@@7| |b#0@@11|))
 :qid |_12MutexLifetimeshortdfy.165:19|
 :skolemid |1239|
 :pattern ( (_module.Universe.outlivesThrough ($LS $ly@@11) $Heap@@44 this@@47 |a#0@@11| |x#0@@7| |b#0@@11|))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@45 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@45 this@@48) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@45) (and (or (not (= this@@48 null)) (not true)) (and ($Is refType this@@48 Tclass._module.Object) ($IsAlloc refType this@@48 Tclass._module.Object $Heap@@45)))))) (_module.Object.triggerAxioms $Heap@@45 this@@48))
 :qid |_12MutexLifetimeshortdfy.314:19|
 :skolemid |1374|
 :pattern ( (_module.Object.triggerAxioms $Heap@@45 this@@48))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@46 T@U) (this@@49 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@46 this@@49) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@46) (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.OwnedObject) ($IsAlloc refType this@@49 Tclass._module.OwnedObject $Heap@@46)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@46 this@@49) (=> (_module.Object.objectGlobalBaseInv $Heap@@46 this@@49) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 (_module.OwnedObject.lifetime this@@49)) _module.Lifetime.elements)) ($Box refType this@@49)) (and (|_module.Lifetime.alive#canCall| $Heap@@46 (_module.OwnedObject.lifetime this@@49)) (=> (=> (_module.Lifetime.alive $Heap@@46 (_module.OwnedObject.lifetime this@@49)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@49) _module.OwnedObject.owner)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@49) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.localUserInv#canCall| $Heap@@46 this@@49))))))) (= (_module.OwnedObject.localInv $Heap@@46 this@@49)  (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@46 this@@49) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 (_module.OwnedObject.lifetime this@@49)) _module.Lifetime.elements)) ($Box refType this@@49))) (=> (_module.Lifetime.alive $Heap@@46 (_module.OwnedObject.lifetime this@@49)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@49) _module.OwnedObject.owner)) null)) (not true)))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@46 this@@49) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv $Heap@@46 this@@49))))))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1801|
 :pattern ( (_module.OwnedObject.localInv $Heap@@46 this@@49) ($IsGoodHeap $Heap@@46))
))))
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@47 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@47 this@@50) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@47) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.OwnedObject) ($IsAlloc refType this@@50 Tclass._module.OwnedObject $Heap@@47)))))) (=> (_module.OwnedObject.localInv $Heap@@47 this@@50) (_module.Object.objectGlobalBaseInv $Heap@@47 this@@50)))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localInv $Heap@@47 this@@50))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@48 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.Mutex.userInv#canCall| $Heap@@48 this@@51) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@48) (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.Mutex) ($IsAlloc refType this@@51 Tclass._module.Mutex $Heap@@48)))))) (=> (_module.Mutex.userInv $Heap@@48 this@@51) (_module.Mutex.localUserInv $Heap@@48 this@@51)))
 :qid |_12MutexLifetimeshortdfy.785:19|
 :skolemid |2943|
 :pattern ( (_module.Mutex.userInv $Heap@@48 this@@51))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@52 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@52)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@52 null)) (not true)) ($Is refType this@@52 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@52)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :weight 3
 :skolemid |1499|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@52)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@53 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@53)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@53 null)) (not true)) ($Is refType this@@53 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@53)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :weight 3
 :skolemid |1766|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@53)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@54 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@54)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@54 null)) (not true)) ($Is refType this@@54 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@54)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :weight 3
 :skolemid |1944|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@54)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@12 T@U) ($Heap@@49 T@U) (this@@55 T@U) (|a#0@@12| T@U) (|b#0@@12| T@U) (|_k#0@@8| Int) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@49) (and (or (not (= this@@55 null)) (not true)) ($Is refType this@@55 Tclass._module.Universe))) ($Is refType |a#0@@12| Tclass._module.Lifetime)) ($Is refType |b#0@@12| Tclass._module.Lifetime)) (= |_k#0@@8| 0)) (not (_module.Universe.outlives_h $ly@@12 $Heap@@49 this@@55 |_k#0@@8| |a#0@@12| |b#0@@12|)))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1225|
 :pattern ( (_module.Universe.outlives_h $ly@@12 $Heap@@49 this@@55 |_k#0@@8| |a#0@@12| |b#0@@12|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@56 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@56) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@56 null)) (not true)) ($Is refType this@@56 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@56) (_module.Thread.objectClassKind this@@56)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1500|
 :pattern ( (_module.Object.objectClassKind this@@56) ($Is refType this@@56 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@56) (_module.Thread.objectClassKind this@@56))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@57 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@57) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@57 null)) (not true)) ($Is refType this@@57 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@57) (_module.OwnedObject.objectClassKind this@@57)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1767|
 :pattern ( (_module.Object.objectClassKind this@@57) ($Is refType this@@57 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@57) (_module.OwnedObject.objectClassKind this@@57))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@58 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@58) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@58 null)) (not true)) ($Is refType this@@58 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@58) (_module.Lifetime.objectClassKind this@@58)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1945|
 :pattern ( (_module.Object.objectClassKind this@@58) ($Is refType this@@58 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@58) (_module.Lifetime.objectClassKind this@@58))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@59 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@59) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@59 null)) (not true)) ($Is refType this@@59 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@59) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :skolemid |1496|
 :pattern ( (_module.Thread.objectClassKind this@@59))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@60 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@60) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@60 null)) (not true)) ($Is refType this@@60 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@60) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :skolemid |1763|
 :pattern ( (_module.OwnedObject.objectClassKind this@@60))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@61 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@61) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@61 null)) (not true)) ($Is refType this@@61 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@61) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :skolemid |1941|
 :pattern ( (_module.Lifetime.objectClassKind this@@61))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@62 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@62) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@62 null)) (not true)) ($Is refType this@@62 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@62) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1418|
 :pattern ( (_module.Object.objectClassKind this@@62))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@50 T@U) (this@@63 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@50 this@@63) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@50) (and (or (not (= this@@63 null)) (not true)) (and ($Is refType this@@63 Tclass._module.Lifetime) ($IsAlloc refType this@@63 Tclass._module.Lifetime $Heap@@50)))))) (= (_module.Lifetime.alive $Heap@@50 this@@63)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@50 this@@63) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.551:19|
 :skolemid |1920|
 :pattern ( (_module.Lifetime.alive $Heap@@50 this@@63) ($IsGoodHeap $Heap@@50))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@51 T@U) (this@@64 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@51 this@@64) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@51) (and (or (not (= this@@64 null)) (not true)) (and ($Is refType this@@64 Tclass._module.Lifetime) ($IsAlloc refType this@@64 Tclass._module.Lifetime $Heap@@51)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@51 this@@64)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 (_module.Object.universe this@@64)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 (_module.Object.universe this@@64)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 (_module.Object.universe this@@64)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 (_module.Object.universe this@@64)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.563:19|
 :skolemid |1951|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@51 this@@64) ($IsGoodHeap $Heap@@51))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Mutex.userInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 6) (- 0 12)) (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (= (_module.OwnedObject.lifetime this@@65) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data)))))))) (=> (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (= (_module.OwnedObject.lifetime this@@65) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))))))) (and (=> (= (ControlFlow 0 6) (- 0 11)) (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32)))))) (=> (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32))))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked))) (let ((|mutexGuard#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner))))
 (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 |mutexGuard#0@@0|) _module.OwnedObject.owner)) null)) (not true)))))))) (=> (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked))) (let ((|mutexGuard#0@@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner))))
 (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 |mutexGuard#0@@1|) _module.OwnedObject.owner)) null)) (not true))))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked))) (let ((|mutexGuard#0@@2| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner))))
(= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 |mutexGuard#0@@2|) _module.MutexGuardU32.mutex)) this@@65))))))) (=> (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked))) (let ((|mutexGuard#0@@3| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner))))
(= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 |mutexGuard#0@@3|) _module.MutexGuardU32.mutex)) this@@65)))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked))) (let ((|mutexGuard#0@@4| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner))))
(|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType |mutexGuard#0@@4|))))))))) (=> (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked))) (let ((|mutexGuard#0@@5| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner))))
(|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType |mutexGuard#0@@5|)))))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner)) this@@65)))))) (=> (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.data))) _module.OwnedObject.owner)) this@@65))))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.Mutex.userInv $Heap@@52 this@@65) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (or (_module.Mutex.localUserInv $Heap@@52 this@@65) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.locked)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) |Set#Empty|))))))))))))))))))))
(let ((anon11_correct  (=> (= (_module.Mutex.userInv $Heap@@52 this@@65)  (and (_module.Mutex.localUserInv $Heap@@52 this@@65) (forall ((|g#2| T@U) ) (!  (=> (and ($Is refType |g#2| Tclass._module.MutexGuardU32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) ($Box refType |g#2|))) (_module.OwnedObject.localInv $Heap@@52 |g#2|))
 :qid |_12MutexLifetimeshortdfy.787:16|
 :skolemid |2952|
 :pattern ( (_module.OwnedObject.localInv $Heap@@52 |g#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) ($Box refType |g#2|)))
)))) (=> (and (and (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65) (=> (_module.Mutex.localUserInv $Heap@@52 this@@65) (forall ((|g#2@@0| T@U) ) (!  (=> ($Is refType |g#2@@0| Tclass._module.MutexGuardU32) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) ($Box refType |g#2@@0|)) (|_module.OwnedObject.localInv#canCall| $Heap@@52 |g#2@@0|)))
 :qid |_12MutexLifetimeshortdfy.787:16|
 :skolemid |2953|
 :pattern ( (_module.OwnedObject.localInv $Heap@@52 |g#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) ($Box refType |g#2@@0|)))
)))) ($Is boolType (bool_2_U (_module.Mutex.userInv $Heap@@52 this@@65)) TBool)) (and (=> (= (ControlFlow 0 13) (- 0 16)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 13) (- 0 15)) |b$reqreads#1@2|) (=> |b$reqreads#1@2| (and (=> (= (ControlFlow 0 13) (- 0 14)) |b$reqreads#2@2|) (=> |b$reqreads#2@2| (=> (= (ControlFlow 0 13) 6) GeneratedUnifiedExit_correct)))))))))))
(let ((anon10_correct  (=> (= |b$reqreads#2@2| |b$reqreads#2@1|) (=> (and (= |b$reqreads#1@2| |b$reqreads#1@1|) (= (ControlFlow 0 18) 13)) anon11_correct))))
(let ((anon17_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) ($Box refType |g#1@0|))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 22) 18))) anon10_correct)))
(let ((anon17_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 this@@65) _module.Mutex.guards)) ($Box refType |g#1@0|)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= |g#1@0| null)) (not true))) (=> (or (not (= |g#1@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |g#1@0|) Tclass._module.OwnedObject? $Heap@@52) (= |b$reqreads#2@0| (forall (($o@@54 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 $o@@54) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 $o@@54) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@54 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.787:52|
 :skolemid |2950|
)))) (=> (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@52 |g#1@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 20) 18))) anon10_correct)))))))
(let ((anon16_Then_correct  (=> (and (and ($Is refType |g#1@0| Tclass._module.MutexGuardU32) ($IsAlloc refType |g#1@0| Tclass._module.MutexGuardU32 $Heap@@52)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@65 _module.Mutex.guards)))) (and (=> (= (ControlFlow 0 23) 20) anon17_Then_correct) (=> (= (ControlFlow 0 23) 22) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (and (not (and ($Is refType |g#1@0| Tclass._module.MutexGuardU32) ($IsAlloc refType |g#1@0| Tclass._module.MutexGuardU32 $Heap@@52))) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 19) 18))) anon10_correct)))
(let ((anon15_Then_correct  (=> (_module.Mutex.localUserInv $Heap@@52 this@@65) (and (=> (= (ControlFlow 0 24) 23) anon16_Then_correct) (=> (= (ControlFlow 0 24) 19) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not (_module.Mutex.localUserInv $Heap@@52 this@@65)) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#1@2| true) (= (ControlFlow 0 17) 13))) anon11_correct)))
(let ((anon13_Else_correct  (=> ($IsAllocBox ($Box refType this@@65) Tclass._module.Mutex? $Heap@@52) (=> (and (= |b$reqreads#0@0| (forall (($o@@55 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@55 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 $o@@55) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@52 $o@@55) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@55 $f@@1)))
 :qid |_12MutexLifetimeshortdfy.786:8|
 :skolemid |2949|
))) (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65)) (and (=> (= (ControlFlow 0 25) 24) anon15_Then_correct) (=> (= (ControlFlow 0 25) 17) anon15_Else_correct))))))
(let ((anon5_correct true))
(let ((anon14_Else_correct  (=> (and (=> (_module.Mutex.userInv $Heap@@52 this@@65) (_module.Mutex.localUserInv $Heap@@52 this@@65)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon14_Then_correct  (=> ($IsAllocBox ($Box refType this@@65) Tclass._module.Mutex? $Heap@@52) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@65 this@@65) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@65 this@@65) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@65 this@@65) (|_module.Mutex.userInv#canCall| $Heap@@52 this@@65)) (_module.Mutex.userInv $Heap@@52 this@@65)) (=> (and (and ($IsAllocBox ($Box refType this@@65) Tclass._module.Mutex? $Heap@@52) (|_module.Mutex.localUserInv#canCall| $Heap@@52 this@@65)) (and (_module.Mutex.localUserInv $Heap@@52 this@@65) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#59| null $Heap@@52 alloc $Heap@@52 alloc)) (and (and (=> (= (ControlFlow 0 26) 25) anon13_Else_correct) (=> (= (ControlFlow 0 26) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 26) 4) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@52) ($IsHeapAnchor $Heap@@52)) (=> (and (and (or (not (= this@@65 null)) (not true)) (and ($Is refType this@@65 Tclass._module.Mutex) ($IsAlloc refType this@@65 Tclass._module.Mutex $Heap@@52))) (and (= 12 $FunctionContextHeight) (= (ControlFlow 0 27) 26))) anon0_correct))))
