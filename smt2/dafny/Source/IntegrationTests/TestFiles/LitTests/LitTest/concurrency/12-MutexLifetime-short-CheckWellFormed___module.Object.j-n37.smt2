...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@10 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#103| |l#0| |l#1| |l#2| |l#3|) $o@@10 $f))  (=> (and (or (not (= $o@@10 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@10) |l#2|)))) (= $o@@10 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3523|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#103| |l#0| |l#1| |l#2| |l#3|) $o@@10 $f))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#103| null $Heap@@15 alloc (_module.Object.universe this@@38))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= (_module.Object.universe this@@38) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@38) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@38)) Tclass._module.Universe? $Heap@@15) (=> (and (|_module.Universe.globalBaseInv#canCall| $Heap@@15 (_module.Object.universe this@@38)) (_module.Universe.globalBaseInv $Heap@@15 (_module.Object.universe this@@38))) (=> (and (and ($IsAllocBox ($Box refType this@@38) Tclass._module.Object? $Heap@@15) (|_module.Object.baseFieldsInv#canCall| $Heap@@15 this@@38)) (and (_module.Object.baseFieldsInv $Heap@@15 this@@38) (or (not (= this@@38 (_module.Object.universe this@@38))) (not true)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@42 T@U) ) (!  (=> (and (or (not (= $o@@42 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@42) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@42) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 $o@@42)) (= $o@@42 (_module.Object.universe this@@38))))
 :qid |_12MutexLifetimeshortdfy.320:10|
 :skolemid |1379|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@42))
))) (and (and ($HeapSucc $Heap@@15 $Heap@0) ($IsAllocBox ($Box refType this@@38) Tclass._module.Object? $Heap@0)) (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@0 this@@38) (_module.Object.objectGlobalBaseInv $Heap@0 this@@38)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= (_module.Object.universe this@@38) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@38) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@38 Tclass._module.Object $Heap@@15)) (=> ($IsAlloc refType this@@38 Tclass._module.Object $Heap@@15) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (_module.Object.universe this@@38) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@38) null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType (_module.Object.universe this@@38) Tclass._module.Universe $Heap@@15)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@15) ($IsHeapAnchor $Heap@@15)) (=> (and (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.Object) ($IsAlloc refType this@@38 Tclass._module.Object $Heap@@15))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
