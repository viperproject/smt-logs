...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split90)
...
(assert (not
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@1|)))
)))) (and (= $Heap@6 $Heap@7) (or (not (= |universe#0| null)) (not true)))) (and (and (forall (($o@@128 T@U) ($f@@79 T@U) ) (!  (=> (and (and (or (not (= $o@@128 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@128) alloc)))) (or (= $o@@128 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType $o@@128)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@128 $f@@79)))
 :qid |_11MutexGuard2legacydfy.682:24|
 :skolemid |577|
)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalInv#canCall| $Heap@7 |universe#0|)))))))) (or (_module.Universe.globalInv $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
