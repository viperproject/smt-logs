...
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@19 T@U) ($f@@3 T@U) ) true)) (=> (forall (($o@@20 T@U) ($f@@4 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@21 T@U) ($f@@5 T@U) ) true)) (=> (forall (($o@@22 T@U) ($f@@6 T@U) ) true) (=> (and (and (_module.Integer.baseUserFieldsInv current$Heap this@@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.Integer.baseUserFieldsInv#canCall| current$Heap this@@1)) (or (_module.Integer.baseUserFieldsInv current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))))))
