...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split130)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon2_correct  (=> (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222)))) (=> (and (and (and (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222))) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11)) (and (= |##a#4@0| (_module.OwnedObject.lifetime |mutex#0|)) ($IsAlloc refType |##a#4@0| Tclass._module.Lifetime $Heap@11))) (and (and (and (= |##b#4@0| (_module.OwnedObject.lifetime this@@222)) ($IsAlloc refType |##b#4@0| Tclass._module.Lifetime $Heap@11)) (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)))) (and (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) ($IsAllocBox ($Box refType call5formal@this@0) Tclass._module.Lifetime? $Heap@11)) (and (|_module.Lifetime.alive#canCall| $Heap@11 call5formal@this@0) (|_module.Lifetime.alive#canCall| $Heap@11 call5formal@this@0))))) (=> (and (and (and (and (and (_module.Lifetime.alive $Heap@11 call5formal@this@0) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |mutex#0|) _module.OwnedObject.owner)) null)) (not true))) (and ($IsAllocBox ($Box refType this@@222) Tclass._module.MutexGuardU32? $Heap@11) (|_module.MutexGuardU32.localUserInv#canCall| $Heap@11 this@@222))) (and (and (|_module.MutexGuardU32.localUserInv#canCall| $Heap@11 this@@222) (_module.MutexGuardU32.localUserInv $Heap@11 this@@222)) (and ($IsAllocBox ($Box refType this@@222) Tclass._module.MutexGuardU32? $Heap@11) (|_module.MutexGuardU32.userInv#canCall| $Heap@11 this@@222)))) (and (and (and (|_module.MutexGuardU32.userInv#canCall| $Heap@11 this@@222) (_module.MutexGuardU32.userInv $Heap@11 this@@222)) (and ($IsAllocBox ($Box refType this@@222) Tclass._module.OwnedObject? $Heap@11) (|_module.OwnedObject.inv#canCall| $Heap@11 this@@222))) (and (and (|_module.OwnedObject.inv#canCall| $Heap@11 this@@222) (_module.OwnedObject.inv $Heap@11 this@@222)) (and ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex) Tclass._module.OwnedObject? $Heap@11) (|_module.OwnedObject.inv#canCall| $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))))))) (and (and (and (and (|_module.OwnedObject.inv#canCall| $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) (_module.OwnedObject.inv $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex)))) (and ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) _module.Mutex.data) Tclass._module.OwnedObject? $Heap@11) (|_module.OwnedObject.inv#canCall| $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) _module.Mutex.data))))) (and (and (|_module.OwnedObject.inv#canCall| $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) _module.Mutex.data))) (_module.OwnedObject.inv $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) _module.Mutex.data)))) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3)))) (and (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@3)) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@11 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@11 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@11 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@11 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@11 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@11 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@11 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@11 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@11 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@11 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@11 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@11 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#0@@14| T@U) ) (!  (=> (and ($Is refType |o#0@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|))) (and (and (and (= (_module.Object.universe |o#0@@14|) |universe#0|) (or (not (= |o#0@@14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@3 |o#0@@14|)) (_module.Object.triggerAxioms $Heap@3 |o#0@@14|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |995|
