...
(let ((anon8_correct  (=> (= (_module.Thread.inv $Heap@@11 this@@11)  (and true (_module.Thread.localInv $Heap@@11 this@@11))) (=> (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@11 this@@11)) ($Is boolType (bool_2_U (_module.Thread.inv $Heap@@11 this@@11)) TBool)) (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 10) 6) GeneratedUnifiedExit_correct)))))))
...
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@11) Tclass._module.Thread? $Heap@@11)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_10SequenceInvariantdfy.263:8|
 :skolemid |1221|
))) (|_module.Thread.localInv#canCall| $Heap@@11 this@@11)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 12) 10))) anon8_correct))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@11 alloc $Heap@@11 alloc)) (and (and (and (=> (= (ControlFlow 0 14) 12) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)) (=> (= (ControlFlow 0 14) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 14) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@11) ($IsHeapAnchor $Heap@@11)) (=> (and (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Thread) ($IsAlloc refType this@@11 Tclass._module.Thread $Heap@@11))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct))))
