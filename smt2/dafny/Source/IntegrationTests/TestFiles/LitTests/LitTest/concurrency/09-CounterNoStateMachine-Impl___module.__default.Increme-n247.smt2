...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split236)
...
))))) (and ($IsGoodHeap $Heap@29) ($IsHeapAnchor $Heap@29)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@28 |universe#0|) (=> (_module.Universe.globalInv $Heap@28 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@27 $Heap@28 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@28 |universe#0|) (and (_module.Universe.globalInv $Heap@28 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@28 |universe#0|) (forall ((|o#17@@7| T@U) ) (!  (=> (and ($Is refType |o#17@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@28 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@7|))) (_module.Object.inv $Heap@28 |o#17@@7|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))) (and (= $Heap@28 $Heap@29) (= (ControlFlow 0 2) (- 0 1))))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
