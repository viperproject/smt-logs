...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split61)
...
)) (= $Heap@10 $Heap@11)) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11) (= (ControlFlow 0 2) (- 0 1))))))))) (or (not (= |mutex#0| null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
