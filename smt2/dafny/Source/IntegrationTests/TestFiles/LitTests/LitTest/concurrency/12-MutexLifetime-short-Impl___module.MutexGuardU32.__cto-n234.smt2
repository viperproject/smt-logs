...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@49 T@U) (this@@49 T@U) ) (!  (=> (or (|_module.Lifetime.unused#canCall| $Heap@@49 this@@49) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@49) (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.Lifetime) ($IsAlloc refType this@@49 Tclass._module.Lifetime $Heap@@49)))))) (= (_module.Lifetime.unused $Heap@@49 this@@49)  (and (|Set#Equal| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@49 this@@49) _module.Lifetime.mightPointFrom)) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@49 this@@49) _module.Lifetime.elements)) |Set#Empty|))))
 :qid |_12MutexLifetimeshortdfy.547:19|
 :skolemid |1915|
 :pattern ( (_module.Lifetime.unused $Heap@@49 this@@49) ($IsGoodHeap $Heap@@49))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@50 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@50 this@@50) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@50) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.OwnedObject) ($IsAlloc refType this@@50 Tclass._module.OwnedObject $Heap@@50)))))) (and (|_module.OwnedObject.objectFields#canCall| $Heap@@50 this@@50) (= (_module.OwnedObject.baseFieldsInv $Heap@@50 this@@50) (|Set#Subset| (_module.OwnedObject.objectFields $Heap@@50 this@@50) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@50 (_module.Object.universe this@@50)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.432:19|
 :skolemid |1780|
 :pattern ( (_module.OwnedObject.baseFieldsInv $Heap@@50 this@@50) ($IsGoodHeap $Heap@@50))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@51 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.Object.nonAliasing#canCall| $Heap@@51 this@@51) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@51) (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.Object) ($IsAlloc refType this@@51 Tclass._module.Object $Heap@@51)))))) (and (and (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@51)) (|_module.Object.objectClassKind#canCall| this@@51)) (=> (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@51) |#_module.ObjectClassKind.Thread|) ($Is refType this@@51 Tclass._module.Thread)) (and (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@51)) (|_module.Object.objectClassKind#canCall| this@@51)) (=> (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@51) |#_module.ObjectClassKind.OwnedObject|) ($Is refType this@@51 Tclass._module.OwnedObject)) (and (|$IsA#_module.ObjectClassKind| (_module.Object.objectClassKind this@@51)) (|_module.Object.objectClassKind#canCall| this@@51)))))) (= (_module.Object.nonAliasing $Heap@@51 this@@51)  (and (and (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@51) |#_module.ObjectClassKind.Thread|) ($Is refType this@@51 Tclass._module.Thread)) (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@51) |#_module.ObjectClassKind.OwnedObject|) ($Is refType this@@51 Tclass._module.OwnedObject))) (= (|_module.ObjectClassKind#Equal| (_module.Object.objectClassKind this@@51) |#_module.ObjectClassKind.Lifetime|) ($Is refType this@@51 Tclass._module.Lifetime))))))
 :qid |_12MutexLifetimeshortdfy.309:19|
 :skolemid |1368|
 :pattern ( (_module.Object.nonAliasing $Heap@@51 this@@51) ($IsGoodHeap $Heap@@51))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@52 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@52) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@52 null)) (not true)) ($Is refType this@@52 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind this@@52) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :skolemid |1498|
 :pattern ( (_module.Thread.objectClassKind this@@52))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@53 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@53) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@53 null)) (not true)) ($Is refType this@@53 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind this@@53) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :skolemid |1765|
 :pattern ( (_module.OwnedObject.objectClassKind this@@53))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@54 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@54) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@54 null)) (not true)) ($Is refType this@@54 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind this@@54) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@52 T@U) (this@@55 T@U) ) (!  (=> (or (|_module.OwnedU32.objectUserFields#canCall| $Heap@@52 this@@55) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@52) (or (not (= this@@55 null)) (not true))) ($IsAlloc refType this@@55 Tclass._module.OwnedU32 $Heap@@52)))) ($IsAlloc SetType (_module.OwnedU32.objectUserFields $Heap@@52 this@@55) (TSet Tclass._module.Object) $Heap@@52))
 :qid |_12MutexLifetimeshortdfy.638:18|
 :skolemid |2373|
 :pattern ( ($IsAlloc SetType (_module.OwnedU32.objectUserFields $Heap@@52 this@@55) (TSet Tclass._module.Object) $Heap@@52))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@53 T@U) (this@@56 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@53 this@@56) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@53) (or (not (= this@@56 null)) (not true))) ($IsAlloc refType this@@56 Tclass._module.Mutex $Heap@@53)))) ($IsAlloc SetType (_module.Mutex.objectUserFields $Heap@@53 this@@56) (TSet Tclass._module.Object) $Heap@@53))
 :qid |_12MutexLifetimeshortdfy.763:18|
 :skolemid |2922|
 :pattern ( ($IsAlloc SetType (_module.Mutex.objectUserFields $Heap@@53 this@@56) (TSet Tclass._module.Object) $Heap@@53))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@54 T@U) (this@@57 T@U) ) (!  (=> (or (|_module.MutexGuardU32.objectUserFields#canCall| $Heap@@54 this@@57) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@54) (or (not (= this@@57 null)) (not true))) ($IsAlloc refType this@@57 Tclass._module.MutexGuardU32 $Heap@@54)))) ($IsAlloc SetType (_module.MutexGuardU32.objectUserFields $Heap@@54 this@@57) (TSet Tclass._module.Object) $Heap@@54))
 :qid |_12MutexLifetimeshortdfy.848:18|
 :skolemid |3214|
 :pattern ( ($IsAlloc SetType (_module.MutexGuardU32.objectUserFields $Heap@@54 this@@57) (TSet Tclass._module.Object) $Heap@@54))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@55 T@U) (this@@58 T@U) ) (!  (=> (or (|_module.OwnedObject.objectUserFields#canCall| $Heap@@55 this@@58) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@55) (or (not (= this@@58 null)) (not true))) ($IsAlloc refType this@@58 Tclass._module.OwnedObject $Heap@@55)))) ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@55 this@@58) (TSet Tclass._module.Object) $Heap@@55))
 :qid |_12MutexLifetimeshortdfy.518:18|
 :skolemid |1877|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@55 this@@58) (TSet Tclass._module.Object) $Heap@@55))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@56 T@U) (this@@59 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@56 this@@59) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@56) (or (not (= this@@59 null)) (not true))) ($IsAlloc refType this@@59 Tclass._module.OwnedObject $Heap@@56)))) ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@56 this@@59) (TSet Tclass._module.Object) $Heap@@56))
 :qid |_12MutexLifetimeshortdfy.426:18|
 :skolemid |1772|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@56 this@@59) (TSet Tclass._module.Object) $Heap@@56))
))))
(assert (forall (($ly@@10 T@U) ($Heap@@57 T@U) (this@@60 T@U) (|_k#0@@7| Int) (|a#0@@10| T@U) (|b#0@@10| T@U) ) (! (= (_module.Universe.outlives_h ($LS $ly@@10) $Heap@@57 this@@60 |_k#0@@7| |a#0@@10| |b#0@@10|) (_module.Universe.outlives_h $ly@@10 $Heap@@57 this@@60 |_k#0@@7| |a#0@@10| |b#0@@10|))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1230|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@10) $Heap@@57 this@@60 |_k#0@@7| |a#0@@10| |b#0@@10|))
)))
(assert (forall (($ly@@11 T@U) ($Heap@@58 T@U) (this@@61 T@U) (|a#0@@11| T@U) (|x#0@@7| T@U) (|b#0@@11| T@U) ) (! (= (_module.Universe.outlivesThrough ($LS $ly@@11) $Heap@@58 this@@61 |a#0@@11| |x#0@@7| |b#0@@11|) (_module.Universe.outlivesThrough $ly@@11 $Heap@@58 this@@61 |a#0@@11| |x#0@@7| |b#0@@11|))
 :qid |_12MutexLifetimeshortdfy.165:19|
 :skolemid |1239|
 :pattern ( (_module.Universe.outlivesThrough ($LS $ly@@11) $Heap@@58 this@@61 |a#0@@11| |x#0@@7| |b#0@@11|))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@59 T@U) (this@@62 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@59 this@@62) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@59) (and (or (not (= this@@62 null)) (not true)) (and ($Is refType this@@62 Tclass._module.Object) ($IsAlloc refType this@@62 Tclass._module.Object $Heap@@59)))))) (_module.Object.triggerAxioms $Heap@@59 this@@62))
 :qid |_12MutexLifetimeshortdfy.314:19|
 :skolemid |1374|
 :pattern ( (_module.Object.triggerAxioms $Heap@@59 this@@62))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@60 T@U) (this@@63 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@60 this@@63) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@60) (and (or (not (= this@@63 null)) (not true)) (and ($Is refType this@@63 Tclass._module.OwnedObject) ($IsAlloc refType this@@63 Tclass._module.OwnedObject $Heap@@60)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@60 this@@63) (=> (_module.Object.objectGlobalBaseInv $Heap@@60 this@@63) (=> (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@60 (_module.OwnedObject.lifetime this@@63)) _module.Lifetime.elements)) ($Box refType this@@63)) (and (|_module.Lifetime.alive#canCall| $Heap@@60 (_module.OwnedObject.lifetime this@@63)) (=> (=> (_module.Lifetime.alive $Heap@@60 (_module.OwnedObject.lifetime this@@63)) (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@60 this@@63) _module.OwnedObject.owner)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@60 this@@63) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.localUserInv#canCall| $Heap@@60 this@@63))))))) (= (_module.OwnedObject.localInv $Heap@@60 this@@63)  (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@60 this@@63) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@60 (_module.OwnedObject.lifetime this@@63)) _module.Lifetime.elements)) ($Box refType this@@63))) (=> (_module.Lifetime.alive $Heap@@60 (_module.OwnedObject.lifetime this@@63)) (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@60 this@@63) _module.OwnedObject.owner)) null)) (not true)))) (=> (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@60 this@@63) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv $Heap@@60 this@@63))))))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1801|
 :pattern ( (_module.OwnedObject.localInv $Heap@@60 this@@63) ($IsGoodHeap $Heap@@60))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@61 T@U) (this@@64 T@U) ) (!  (=> (or (|_module.MutexGuardU32.userInv#canCall| $Heap@@61 this@@64) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@61) (and (or (not (= this@@64 null)) (not true)) (and ($Is refType this@@64 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@64 Tclass._module.MutexGuardU32 $Heap@@61)))))) (and (and (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@61 this@@64) (=> (_module.MutexGuardU32.localUserInv $Heap@@61 this@@64) (|_module.OwnedObject.localInv#canCall| $Heap@@61 ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@61 this@@64) _module.MutexGuardU32.mutex))))) (= (_module.MutexGuardU32.userInv $Heap@@61 this@@64)  (and (_module.MutexGuardU32.localUserInv $Heap@@61 this@@64) (_module.OwnedObject.localInv $Heap@@61 ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@61 this@@64) _module.MutexGuardU32.mutex)))))))
 :qid |_12MutexLifetimeshortdfy.869:19|
 :skolemid |3238|
 :pattern ( (_module.MutexGuardU32.userInv $Heap@@61 this@@64) ($IsGoodHeap $Heap@@61))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@62 T@U) (this@@65 T@U) ) (!  (=> (or (|_module.OwnedU32.userInv#canCall| $Heap@@62 this@@65) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@62) (and (or (not (= this@@65 null)) (not true)) (and ($Is refType this@@65 Tclass._module.OwnedU32) ($IsAlloc refType this@@65 Tclass._module.OwnedU32 $Heap@@62)))))) (=> (_module.OwnedU32.userInv $Heap@@62 this@@65) (_module.OwnedU32.localUserInv $Heap@@62 this@@65)))
 :qid |_12MutexLifetimeshortdfy.645:19|
 :skolemid |2394|
 :pattern ( (_module.OwnedU32.userInv $Heap@@62 this@@65))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@63 T@U) (this@@66 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@63 this@@66) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@63) (and (or (not (= this@@66 null)) (not true)) (and ($Is refType this@@66 Tclass._module.Thread) ($IsAlloc refType this@@66 Tclass._module.Thread $Heap@@63)))))) (=> (_module.Thread.localInv $Heap@@63 this@@66) (_module.Object.objectGlobalBaseInv $Heap@@63 this@@66)))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1518|
 :pattern ( (_module.Thread.localInv $Heap@@63 this@@66))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@64 T@U) (this@@67 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@64 this@@67) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@64) (and (or (not (= this@@67 null)) (not true)) (and ($Is refType this@@67 Tclass._module.Lifetime) ($IsAlloc refType this@@67 Tclass._module.Lifetime $Heap@@64)))))) (=> (_module.Lifetime.localInv $Heap@@64 this@@67) (_module.Object.objectGlobalBaseInv $Heap@@64 this@@67)))
 :qid |_12MutexLifetimeshortdfy.578:19|
 :skolemid |1968|
 :pattern ( (_module.Lifetime.localInv $Heap@@64 this@@67))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@65 T@U) (this@@68 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@65 this@@68) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@65) (and (or (not (= this@@68 null)) (not true)) (and ($Is refType this@@68 Tclass._module.Thread) ($IsAlloc refType this@@68 Tclass._module.Thread $Heap@@65)))))) (=> (_module.Thread.inv $Heap@@65 this@@68) (_module.Thread.localInv $Heap@@65 this@@68)))
 :qid |_12MutexLifetimeshortdfy.371:19|
 :skolemid |1530|
 :pattern ( (_module.Thread.inv $Heap@@65 this@@68))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@66 T@U) (this@@69 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@66 this@@69) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@66) (and (or (not (= this@@69 null)) (not true)) (and ($Is refType this@@69 Tclass._module.Lifetime) ($IsAlloc refType this@@69 Tclass._module.Lifetime $Heap@@66)))))) (=> (_module.Lifetime.inv $Heap@@66 this@@69) (_module.Lifetime.localInv $Heap@@66 this@@69)))
 :qid |_12MutexLifetimeshortdfy.588:19|
 :skolemid |2035|
 :pattern ( (_module.Lifetime.inv $Heap@@66 this@@69))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@67 T@U) (this@@70 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@67 this@@70) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@67) (and (or (not (= this@@70 null)) (not true)) (and ($Is refType this@@70 Tclass._module.OwnedObject) ($IsAlloc refType this@@70 Tclass._module.OwnedObject $Heap@@67)))))) (=> (_module.OwnedObject.localInv $Heap@@67 this@@70) (_module.Object.objectGlobalBaseInv $Heap@@67 this@@70)))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localInv $Heap@@67 this@@70))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@68 T@U) (this@@71 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@68 this@@71) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@68) (and (or (not (= this@@71 null)) (not true)) (and ($Is refType this@@71 Tclass._module.Object) ($IsAlloc refType this@@71 Tclass._module.Object $Heap@@68)))))) (=> (_module.Object.localInv $Heap@@68 this@@71) (_module.Object.objectGlobalBaseInv $Heap@@68 this@@71)))
 :qid |_12MutexLifetimeshortdfy.350:19|
 :skolemid |1428|
 :pattern ( (_module.Object.localInv $Heap@@68 this@@71))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@69 T@U) (this@@72 T@U) ) (!  (=> (or (|_module.Mutex.userInv#canCall| $Heap@@69 this@@72) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@69) (and (or (not (= this@@72 null)) (not true)) (and ($Is refType this@@72 Tclass._module.Mutex) ($IsAlloc refType this@@72 Tclass._module.Mutex $Heap@@69)))))) (=> (_module.Mutex.userInv $Heap@@69 this@@72) (_module.Mutex.localUserInv $Heap@@69 this@@72)))
 :qid |_12MutexLifetimeshortdfy.785:19|
 :skolemid |2943|
 :pattern ( (_module.Mutex.userInv $Heap@@69 this@@72))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@70 T@U) (this@@73 T@U) ) (!  (=> (or (|_module.MutexGuardU32.userInv#canCall| $Heap@@70 this@@73) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@70) (and (or (not (= this@@73 null)) (not true)) (and ($Is refType this@@73 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@73 Tclass._module.MutexGuardU32 $Heap@@70)))))) (=> (_module.MutexGuardU32.userInv $Heap@@70 this@@73) (_module.MutexGuardU32.localUserInv $Heap@@70 this@@73)))
 :qid |_12MutexLifetimeshortdfy.869:19|
 :skolemid |3236|
 :pattern ( (_module.MutexGuardU32.userInv $Heap@@70 this@@73))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@71 T@U) (this@@74 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@71 this@@74) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@71) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.OwnedObject) ($IsAlloc refType this@@74 Tclass._module.OwnedObject $Heap@@71)))))) (=> (_module.OwnedObject.userInv $Heap@@71 this@@74) (_module.OwnedObject.localUserInv $Heap@@71 this@@74)))
 :qid |_12MutexLifetimeshortdfy.522:19|
 :skolemid |1893|
 :pattern ( (_module.OwnedObject.userInv $Heap@@71 this@@74))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@72 T@U) (this@@75 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@72 this@@75) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@72) (and (or (not (= this@@75 null)) (not true)) (and ($Is refType this@@75 Tclass._module.OwnedObject) ($IsAlloc refType this@@75 Tclass._module.OwnedObject $Heap@@72)))))) (=> (_module.OwnedObject.inv $Heap@@72 this@@75) (_module.OwnedObject.localInv $Heap@@72 this@@75)))
 :qid |_12MutexLifetimeshortdfy.448:19|
 :skolemid |1813|
 :pattern ( (_module.OwnedObject.inv $Heap@@72 this@@75))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($Heap@@73 T@U) (this@@76 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@73 this@@76) (and (< 15 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@73) (and (or (not (= this@@76 null)) (not true)) (and ($Is refType this@@76 Tclass._module.Object) ($IsAlloc refType this@@76 Tclass._module.Object $Heap@@73)))))) (=> (_module.Object.inv $Heap@@73 this@@76) (_module.Object.localInv $Heap@@73 this@@76)))
 :qid |_12MutexLifetimeshortdfy.352:19|
 :skolemid |1438|
 :pattern ( (_module.Object.inv $Heap@@73 this@@76))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@77 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@77)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@77 null)) (not true)) ($Is refType this@@77 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@77)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :weight 3
 :skolemid |1499|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@77)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@78 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@78)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@78 null)) (not true)) ($Is refType this@@78 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@78)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :weight 3
 :skolemid |1766|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@78)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@79 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@79)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@79 null)) (not true)) ($Is refType this@@79 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@79)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :weight 3
 :skolemid |1944|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@79)))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@74 T@U) (this@@80 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@74 this@@80) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@74) (and (or (not (= this@@80 null)) (not true)) (and ($Is refType this@@80 Tclass._module.Lifetime) ($IsAlloc refType this@@80 Tclass._module.Lifetime $Heap@@74)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@74 this@@80) (=> (_module.Object.objectGlobalBaseInv $Heap@@74 this@@80) (=> (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#0@@3|))) (= (_module.OwnedObject.lifetime |o#0@@3|) this@@80))
 :qid |_12MutexLifetimeshortdfy.580:16|
 :skolemid |1983|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#0@@3|)))
)) (and (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#1|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@74 |o#1|) (|_module.Lifetime.alive#canCall| $Heap@@74 this@@80))))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1976|
 :pattern ( (_module.OwnedObject.alive $Heap@@74 |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#1|)))
)) (=> (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#1@@0|))) (= (_module.OwnedObject.alive $Heap@@74 |o#1@@0|) (_module.Lifetime.alive $Heap@@74 this@@80)))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1982|
 :pattern ( (_module.OwnedObject.alive $Heap@@74 |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#1@@0|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@74 this@@80) (=> (_module.Lifetime.alive $Heap@@74 this@@80) (forall ((|l#0@@0| T@U) ) (!  (=> ($Is refType |l#0@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@74 |l#0@@0|)))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1977|
 :pattern ( (_module.Lifetime.alive $Heap@@74 |l#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@74 this@@80) (forall ((|l#0@@1| T@U) ) (!  (=> (and ($Is refType |l#0@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|))) (_module.Lifetime.alive $Heap@@74 |l#0@@1|))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1981|
 :pattern ( (_module.Lifetime.alive $Heap@@74 |l#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@74 this@@80) (=> (not (_module.Lifetime.alive $Heap@@74 this@@80)) (forall ((|l#1@@0| T@U) ) (!  (=> ($Is refType |l#1@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@74 |l#1@@0|)))
 :qid |_12MutexLifetimeshortdfy.584:29|
 :skolemid |1978|
 :pattern ( (_module.Lifetime.alive $Heap@@74 |l#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@74 this@@80)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@74 this@@80) (forall ((|o#0@@4| T@U) ) (!  (=> (and ($Is refType |o#0@@4| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#0@@4|))) (= (_module.OwnedObject.lifetime |o#0@@4|) this@@80))
 :qid |_12MutexLifetimeshortdfy.580:16|
 :skolemid |1970|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#0@@4|)))
))) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#1@@1|))) (= (_module.OwnedObject.alive $Heap@@74 |o#1@@1|) (_module.Lifetime.alive $Heap@@74 this@@80)))
 :qid |_12MutexLifetimeshortdfy.582:16|
 :skolemid |1971|
 :pattern ( (_module.OwnedObject.alive $Heap@@74 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.elements)) ($Box refType |o#1@@1|)))
))) (=> (_module.Lifetime.alive $Heap@@74 this@@80) (forall ((|l#0@@2| T@U) ) (!  (=> (and ($Is refType |l#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|))) (_module.Lifetime.alive $Heap@@74 |l#0@@2|))
 :qid |_12MutexLifetimeshortdfy.583:28|
 :skolemid |1972|
 :pattern ( (_module.Lifetime.alive $Heap@@74 |l#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@74 this@@80)) (forall ((|l#1@@1| T@U) ) (!  (=> (and ($Is refType |l#1@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|))) (not (_module.Lifetime.alive $Heap@@74 |l#1@@1|)))
 :qid |_12MutexLifetimeshortdfy.584:29|
 :skolemid |1973|
 :pattern ( (_module.Lifetime.alive $Heap@@74 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
)))) (forall ((|l#2@@0| T@U) ) (!  (=> (and ($Is refType |l#2@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 |l#2@@0|) _module.Lifetime.mightPointFrom)) ($Box refType this@@80)))
 :qid |_12MutexLifetimeshortdfy.585:16|
 :skolemid |1974|
 :pattern ( ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 |l#2@@0|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@80)))
 :qid |_12MutexLifetimeshortdfy.586:16|
 :skolemid |1975|
 :pattern ( ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 |l#3@@0|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@74 this@@80) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimeshortdfy.578:19|
 :skolemid |1984|
 :pattern ( (_module.Lifetime.localInv $Heap@@74 this@@80) ($IsGoodHeap $Heap@@74))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@12 T@U) ($Heap@@75 T@U) (this@@81 T@U) (|a#0@@12| T@U) (|b#0@@12| T@U) (|_k#0@@8| Int) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@75) (and (or (not (= this@@81 null)) (not true)) ($Is refType this@@81 Tclass._module.Universe))) ($Is refType |a#0@@12| Tclass._module.Lifetime)) ($Is refType |b#0@@12| Tclass._module.Lifetime)) (= |_k#0@@8| 0)) (not (_module.Universe.outlives_h $ly@@12 $Heap@@75 this@@81 |_k#0@@8| |a#0@@12| |b#0@@12|)))
 :qid |_12MutexLifetimeshortdfy.158:19|
 :skolemid |1225|
 :pattern ( (_module.Universe.outlives_h $ly@@12 $Heap@@75 this@@81 |_k#0@@8| |a#0@@12| |b#0@@12|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@82 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@82) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@82 null)) (not true)) ($Is refType this@@82 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@82) (_module.Thread.objectClassKind this@@82)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1500|
 :pattern ( (_module.Object.objectClassKind this@@82) ($Is refType this@@82 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@82) (_module.Thread.objectClassKind this@@82))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@83 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@83) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@83 null)) (not true)) ($Is refType this@@83 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@83) (_module.OwnedObject.objectClassKind this@@83)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1767|
 :pattern ( (_module.Object.objectClassKind this@@83) ($Is refType this@@83 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@83) (_module.OwnedObject.objectClassKind this@@83))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@84 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@84) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@84 null)) (not true)) ($Is refType this@@84 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@84) (_module.Lifetime.objectClassKind this@@84)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1945|
 :pattern ( (_module.Object.objectClassKind this@@84) ($Is refType this@@84 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@84) (_module.Lifetime.objectClassKind this@@84))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@85 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@85) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@85 null)) (not true)) ($Is refType this@@85 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@85) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :skolemid |1496|
 :pattern ( (_module.Thread.objectClassKind this@@85))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@86 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@86) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@86 null)) (not true)) ($Is refType this@@86 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@86) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :skolemid |1763|
 :pattern ( (_module.OwnedObject.objectClassKind this@@86))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@87 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@87) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@87 null)) (not true)) ($Is refType this@@87 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@87) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :skolemid |1941|
 :pattern ( (_module.Lifetime.objectClassKind this@@87))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@88 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@88) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@88 null)) (not true)) ($Is refType this@@88 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@88) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1418|
 :pattern ( (_module.Object.objectClassKind this@@88))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@76 T@U) (this@@89 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@76 this@@89) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@76) (and (or (not (= this@@89 null)) (not true)) (and ($Is refType this@@89 Tclass._module.Thread) ($IsAlloc refType this@@89 Tclass._module.Thread $Heap@@76)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@76 this@@89)) (= (_module.Thread.localInv $Heap@@76 this@@89)  (and true (_module.Object.objectGlobalBaseInv $Heap@@76 this@@89)))))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1520|
 :pattern ( (_module.Thread.localInv $Heap@@76 this@@89) ($IsGoodHeap $Heap@@76))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@77 T@U) (this@@90 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@77 this@@90) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@77) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.Thread) ($IsAlloc refType this@@90 Tclass._module.Thread $Heap@@77)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@77 this@@90)) (= (_module.Thread.inv $Heap@@77 this@@90)  (and true (_module.Thread.localInv $Heap@@77 this@@90)))))
 :qid |_12MutexLifetimeshortdfy.371:19|
 :skolemid |1532|
 :pattern ( (_module.Thread.inv $Heap@@77 this@@90) ($IsGoodHeap $Heap@@77))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@78 T@U) (this@@91 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@78 this@@91) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@78) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.OwnedObject) ($IsAlloc refType this@@91 Tclass._module.OwnedObject $Heap@@78)))))) (= (_module.OwnedObject.alive $Heap@@78 this@@91)  (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@78 this@@91) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.421:19|
 :skolemid |1762|
 :pattern ( (_module.OwnedObject.alive $Heap@@78 this@@91) ($IsGoodHeap $Heap@@78))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@79 T@U) (this@@92 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@79 this@@92) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@79) (and (or (not (= this@@92 null)) (not true)) (and ($Is refType this@@92 Tclass._module.Lifetime) ($IsAlloc refType this@@92 Tclass._module.Lifetime $Heap@@79)))))) (= (_module.Lifetime.alive $Heap@@79 this@@92)  (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@79 this@@92) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimeshortdfy.551:19|
 :skolemid |1920|
 :pattern ( (_module.Lifetime.alive $Heap@@79 this@@92) ($IsGoodHeap $Heap@@79))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@80 T@U) (this@@93 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@80 this@@93) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@80) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.Lifetime) ($IsAlloc refType this@@93 Tclass._module.Lifetime $Heap@@80)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@80 this@@93)  (and (and (and (=> (or (not (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 this@@93) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 (_module.Object.universe this@@93)) _module.Universe.content)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 this@@93) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 this@@93) _module.Lifetime.elements)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 (_module.Object.universe this@@93)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 this@@93) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 (_module.Object.universe this@@93)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 this@@93) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@80 (_module.Object.universe this@@93)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.563:19|
 :skolemid |1951|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@80 this@@93) ($IsGoodHeap $Heap@@80))
))))
...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and ($IsGoodHeap $Heap@@81) ($IsHeapAnchor $Heap@@81)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@81))) (and (and ($Is refType |running#0| Tclass._module.Thread) ($IsAlloc refType |running#0| Tclass._module.Thread $Heap@@81)) (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@81)))) (=> (and (and (and (and (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@81)) (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@81))) (and (and (=> |defass#lifetime#0| (and ($Is refType |lifetime#0| Tclass._module.Lifetime) ($IsAlloc refType |lifetime#0| Tclass._module.Lifetime $Heap@@81))) true) (= 23 $FunctionContextHeight))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|) (and (_module.Universe.globalInv $Heap@@81 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@81 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@@81 |o#10|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |3436|
 :pattern ( (_module.Object.inv $Heap@@81 |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |o#10|)))
))))) (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0|)) ($Box refType |scope#0|)) ($Box refType |mutex#0|)) ($Box refType |mutexScope#0|)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content))) (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |scope#0|) _module.Lifetime.owner)) |running#0|))) (and (and (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |mutexScope#0|) _module.Lifetime.owner)) |running#0|) (or (not (= |scope#0| |mutexScope#0|)) (not true))) (and (|_module.Universe.outlives#canCall| $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (and (_module.Universe.outlives ($LS $LZ) $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (or (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |mutexScope#0|) _module.Lifetime.mightPointTo)) ($Box refType (_module.OwnedObject.lifetime |mutex#0|))) (exists ((|x#2| T@U) ) (!  (and (and ($Is refType |x#2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |x#2|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |x#2| |mutexScope#0|))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |3438|
 :pattern ( (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |x#2| |mutexScope#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |x#2|)))
)))))))) (and (and (and (and (|_module.Universe.outlives#canCall| $Heap@@81 |universe#0| |mutexScope#0| |scope#0|) (and (_module.Universe.outlives ($LS $LZ) $Heap@@81 |universe#0| |mutexScope#0| |scope#0|) (or (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |scope#0|) _module.Lifetime.mightPointTo)) ($Box refType |mutexScope#0|)) (exists ((|x#3@@1| T@U) ) (!  (and (and ($Is refType |x#3@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |x#3@@1|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@81 |universe#0| |mutexScope#0| |x#3@@1| |scope#0|))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |3440|
 :pattern ( (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@81 |universe#0| |mutexScope#0| |x#3@@1| |scope#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |x#3@@1|)))
))))) (and (|_module.Lifetime.unused#canCall| $Heap@@81 |scope#0|) (and (_module.Lifetime.unused $Heap@@81 |scope#0|) (and (|Set#Equal| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |scope#0|) _module.Lifetime.mightPointFrom)) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |scope#0|) _module.Lifetime.elements)) |Set#Empty|))))) (and (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |mutex#0|) _module.Mutex.locked)))) (= $_ModifiesFrame@0 (|lambda#250| null $Heap@@81 alloc |universe#0| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) Tclass._module.Lifetime ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) $Heap@@81 _module.Lifetime.owner |running#0| |scope#0| |mutexScope#0|))) (and (= |mightPointTo##0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |mutexScope#0|))) (forall (($o@@54 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 $o@@54) alloc)))) (or (= $o@@54 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@54)) (= $f@@0 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $o@@54 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.910:21|
 :skolemid |3460|
))))) (and (and (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass._module.Lifetime) ($IsAlloc refType call5formal@this Tclass._module.Lifetime $Heap@@81))) (=> (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalInv $Heap@@81 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@81 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalInv $Heap@@81 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@81 |universe#0|) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@5|))) (and (and (and (= (_module.Object.universe |o#0@@5|) |universe#0|) (or (not (= |o#0@@5| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@81 |o#0@@5|)) (_module.Object.triggerAxioms $Heap@@81 |o#0@@5|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2275|
 :pattern ( (_module.Object.triggerAxioms $Heap@@81 |o#0@@5|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@81 |o#0@@5|))
 :pattern ( (_module.Object.universe |o#0@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@5|)))
)))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|))))) (or (_module.Universe.globalInv $Heap@@81 |universe#0|) (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@2|))) (_module.Object.inv $Heap@@81 |o#1@@2|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |2277|
 :pattern ( (_module.Object.inv $Heap@@81 |o#1@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@2|)))
)))))))
anon0_correct))
))
(check-sat)
