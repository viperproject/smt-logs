...
(assert (forall (($h@@29 T@U) ($o@@40 T@U) ) (!  (=> (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@40 null)) (not true)) (= (dtype $o@@40) Tclass._module.IncrementerMethod?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@40) _module.IncrementerMethod.counter)) Tclass._module.AtomicCounter))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1648|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@40) _module.IncrementerMethod.counter)))
)))
(assert (forall (($h@@30 T@U) ($o@@41 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (or (not (= $o@@41 null)) (not true)) (= (dtype $o@@41) Tclass._module.IncrementerMethod?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@41) _module.IncrementerMethod.remaining)) Tclass._module.Remaining))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1650|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@41) _module.IncrementerMethod.remaining)))
)))
...
(assert (forall (($h@@31 T@U) ($o@@42 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@31) (and (or (not (= $o@@42 null)) (not true)) (= (dtype $o@@42) Tclass._module.IncrementerMethod?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@42) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@42) _module.IncrementerMethod.counter)) Tclass._module.AtomicCounter $h@@31))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1649|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@42) _module.IncrementerMethod.counter)))
)))
(assert (forall (($h@@32 T@U) ($o@@43 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@32) (and (or (not (= $o@@43 null)) (not true)) (= (dtype $o@@43) Tclass._module.IncrementerMethod?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@43) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@43) _module.IncrementerMethod.remaining)) Tclass._module.Remaining $h@@32))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1651|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@43) _module.IncrementerMethod.remaining)))
)))
...
(assert (forall (($o@@44 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@44 Tclass._module.NonOwnedObject? $heap) ($IsAlloc refType $o@@44 Tclass._module.Object? $heap))
 :qid |unknown.0:0|
 :skolemid |2248|
 :pattern ( ($IsAlloc refType $o@@44 Tclass._module.NonOwnedObject? $heap))
)))
(assert (forall (($o@@45 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@45 Tclass._module.Thread? $heap@@0) ($IsAlloc refType $o@@45 Tclass._module.NonOwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |2252|
 :pattern ( ($IsAlloc refType $o@@45 Tclass._module.Thread? $heap@@0))
)))
(assert (forall (($o@@46 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@46 Tclass._module.OwnedObject? $heap@@1) ($IsAlloc refType $o@@46 Tclass._module.Object? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |2256|
 :pattern ( ($IsAlloc refType $o@@46 Tclass._module.OwnedObject? $heap@@1))
)))
(assert (forall (($o@@47 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@47 Tclass._module.AtomicCounter? $heap@@2) ($IsAlloc refType $o@@47 Tclass._module.OwnedObject? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |2264|
 :pattern ( ($IsAlloc refType $o@@47 Tclass._module.AtomicCounter? $heap@@2))
)))
(assert (forall (($o@@48 T@U) ($heap@@3 T@U) ) (!  (=> ($IsAlloc refType $o@@48 Tclass._module.Remaining? $heap@@3) ($IsAlloc refType $o@@48 Tclass._module.OwnedObject? $heap@@3))
 :qid |unknown.0:0|
 :skolemid |2268|
 :pattern ( ($IsAlloc refType $o@@48 Tclass._module.Remaining? $heap@@3))
)))
(assert (forall (($o@@49 T@U) ($heap@@4 T@U) ) (!  (=> ($IsAlloc refType $o@@49 Tclass._module.IncrementerMethod? $heap@@4) ($IsAlloc refType $o@@49 Tclass._module.OwnedObject? $heap@@4))
 :qid |unknown.0:0|
 :skolemid |2272|
 :pattern ( ($IsAlloc refType $o@@49 Tclass._module.IncrementerMethod? $heap@@4))
)))
...
(assert (forall (($h@@33 T@U) ($o@@50 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@33) (and (or (not (= $o@@50 null)) (not true)) ($Is refType $o@@50 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@50) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@50) _module.OwnedObject.nonvolatileVersion)) TInt $h@@33))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |961|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@50) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h@@34 T@U) ($o@@51 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (or (not (= $o@@51 null)) (not true)) (= (dtype $o@@51) Tclass._module.AtomicCounter?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@51) _module.AtomicCounter.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1258|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@51) _module.AtomicCounter.value)))
)))
(assert (forall (($h@@35 T@U) ($o@@52 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (or (not (= $o@@52 null)) (not true)) (= (dtype $o@@52) Tclass._module.Remaining?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@52) _module.Remaining.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1452|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@52) _module.Remaining.value)))
)))
(assert (forall (($h@@36 T@U) ($o@@53 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (or (not (= $o@@53 null)) (not true)) (= (dtype $o@@53) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@53) _module.IncrementerMethod.programCounter)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1646|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@53) _module.IncrementerMethod.programCounter)))
)))
(assert (forall (($h@@37 T@U) ($o@@54 T@U) ) (!  (=> (and ($IsGoodHeap $h@@37) (and (or (not (= $o@@54 null)) (not true)) (= (dtype $o@@54) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@54) _module.IncrementerMethod.initial__value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1652|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@54) _module.IncrementerMethod.initial__value)))
)))
(assert (forall (($h@@38 T@U) ($o@@55 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (or (not (= $o@@55 null)) (not true)) (= (dtype $o@@55) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@55) _module.IncrementerMethod.final__value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1654|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@55) _module.IncrementerMethod.final__value)))
)))
(assert (forall (($h@@39 T@U) ($o@@56 T@U) ) (!  (=> (and ($IsGoodHeap $h@@39) (and (or (not (= $o@@56 null)) (not true)) (= (dtype $o@@56) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@56) _module.IncrementerMethod.i)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1656|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@56) _module.IncrementerMethod.i)))
)))
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@76 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@76 null)) (not true)) ($Is refType this@@76 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@57 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@57 null)) (not true)) (or (= $o@@57 this@@76) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 this@@76) _module.Universe.content)) ($Box refType $o@@57)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@57) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@57) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |494|
...
(assert (forall (($h@@40 T@U) ($o@@58 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@40) (and (or (not (= $o@@58 null)) (not true)) ($Is refType $o@@58 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@40 $o@@58) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@40 $o@@58) _module.OwnedObject.owner)) Tclass._module.Object $h@@40))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |963|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@40 $o@@58) _module.OwnedObject.owner)))
)))
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@78 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@78 null)) (not true)) (and ($Is refType this@@78 Tclass._module.Universe) ($IsAlloc refType this@@78 Tclass._module.Universe $h0@@20)))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@59 T@U) ($f@@20 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@59) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@59) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@59) $f@@20)))
 :qid |unknown.0:0|
 :skolemid |502|
...
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@79 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@79 null)) (not true)) (and ($Is refType this@@79 Tclass._module.Object) ($IsAlloc refType this@@79 Tclass._module.Object $h0@@21)))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@60 T@U) ($f@@21 T@U) ) (!  (=> (and (or (not (= $o@@60 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@60) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@60) $f@@21) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@60) $f@@21)))
 :qid |unknown.0:0|
 :skolemid |676|
...
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@80 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@80 null)) (not true)) (and ($Is refType this@@80 Tclass._module.Object) ($IsAlloc refType this@@80 Tclass._module.Object $h0@@22)))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@61 T@U) ($f@@22 T@U) ) (!  (=> (and (or (not (= $o@@61 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@61) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@61) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@61) $f@@22)))
 :qid |unknown.0:0|
 :skolemid |710|
...
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@81 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@81 null)) (not true)) (and ($Is refType this@@81 Tclass._module.Object) ($IsAlloc refType this@@81 Tclass._module.Object $h0@@23)))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@62 T@U) ($f@@23 T@U) ) (!  (=> (and (or (not (= $o@@62 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@62) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@62) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@62) $f@@23)))
 :qid |unknown.0:0|
 :skolemid |724|
...
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@82 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@82 null)) (not true)) (and ($Is refType this@@82 Tclass._module.Object) ($IsAlloc refType this@@82 Tclass._module.Object $h0@@24)))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@63 T@U) ($f@@24 T@U) ) (!  (=> (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@63) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@63) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@63) $f@@24)))
 :qid |unknown.0:0|
 :skolemid |732|
...
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@83 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@83 null)) (not true)) (and ($Is refType this@@83 Tclass._module.Thread) ($IsAlloc refType this@@83 Tclass._module.Thread $h0@@25)))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@64 T@U) ($f@@25 T@U) ) (!  (=> (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@64) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@64) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@64) $f@@25)))
 :qid |unknown.0:0|
 :skolemid |788|
...
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@84 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@84 null)) (not true)) (and ($Is refType this@@84 Tclass._module.Thread) ($IsAlloc refType this@@84 Tclass._module.Thread $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@65 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@65) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@65) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |796|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@85 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@85 null)) (not true)) (and ($Is refType this@@85 Tclass._module.OwnedObject) ($IsAlloc refType this@@85 Tclass._module.OwnedObject $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@66 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@66) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@66) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@66) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |964|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@86 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@86 null)) (not true)) (and ($Is refType this@@86 Tclass._module.OwnedObject) ($IsAlloc refType this@@86 Tclass._module.OwnedObject $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@67 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@67 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@67) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@67) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@67) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |974|
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@87 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@87 null)) (not true)) (and ($Is refType this@@87 Tclass._module.OwnedObject) ($IsAlloc refType this@@87 Tclass._module.OwnedObject $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@68 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@68 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@68) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@68) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@68) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |1041|
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@88 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@88 null)) (not true)) (and ($Is refType this@@88 Tclass._module.OwnedObject) ($IsAlloc refType this@@88 Tclass._module.OwnedObject $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@69 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@69 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@69) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@69) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@69) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |1045|
...
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.AtomicCounter) ($IsAlloc refType this@@90 Tclass._module.AtomicCounter $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@71 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@71 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@71) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@71) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@71) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |1275|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@91 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.AtomicCounter) ($IsAlloc refType this@@91 Tclass._module.AtomicCounter $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@72 T@U) ($f@@33 T@U) ) (!  (=> (and (or (not (= $o@@72 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@72) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@72) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@72) $f@@33)))
 :qid |unknown.0:0|
 :skolemid |1282|
...
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@92 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@92 null)) (not true)) (and ($Is refType this@@92 Tclass._module.AtomicCounter) ($IsAlloc refType this@@92 Tclass._module.AtomicCounter $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@73 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@73) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@73) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@73) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |1289|
...
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@93 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.Remaining) ($IsAlloc refType this@@93 Tclass._module.Remaining $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@74 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@74) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@74) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@74) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |1469|
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@94 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@94 null)) (not true)) (and ($Is refType this@@94 Tclass._module.Remaining) ($IsAlloc refType this@@94 Tclass._module.Remaining $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@75 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@75) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@75) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@75) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |1476|
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@95 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@95 null)) (not true)) (and ($Is refType this@@95 Tclass._module.Remaining) ($IsAlloc refType this@@95 Tclass._module.Remaining $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@76 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@76) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@76) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@76) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1483|
...
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@96 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@96 null)) (not true)) (and ($Is refType this@@96 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@96 Tclass._module.IncrementerMethod $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@77 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@77 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@77) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@77) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@77) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1673|
...
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@97 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@97 Tclass._module.IncrementerMethod $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@78 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@78) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@78) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@78) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1680|
...
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@98 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@98 null)) (not true)) (and ($Is refType this@@98 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@98 Tclass._module.IncrementerMethod $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@79 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@79) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@79) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@79) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1687|
...
(assert (forall (($o@@80 T@U) ) (!  (=> ($Is refType $o@@80 Tclass._module.NonOwnedObject?) ($Is refType $o@@80 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |2247|
 :pattern ( ($Is refType $o@@80 Tclass._module.NonOwnedObject?))
)))
...
(assert (forall (($o@@81 T@U) ) (!  (=> ($Is refType $o@@81 Tclass._module.Thread?) ($Is refType $o@@81 Tclass._module.NonOwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2251|
...
(assert (forall (($o@@83 T@U) ) (!  (=> ($Is refType $o@@83 Tclass._module.AtomicCounter?) ($Is refType $o@@83 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2263|
 :pattern ( ($Is refType $o@@83 Tclass._module.AtomicCounter?))
)))
...
(assert (forall (($o@@84 T@U) ) (!  (=> ($Is refType $o@@84 Tclass._module.Remaining?) ($Is refType $o@@84 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2267|
 :pattern ( ($Is refType $o@@84 Tclass._module.Remaining?))
)))
...
(assert (forall (($o@@85 T@U) ) (!  (=> ($Is refType $o@@85 Tclass._module.IncrementerMethod?) ($Is refType $o@@85 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2271|
 :pattern ( ($Is refType $o@@85 Tclass._module.IncrementerMethod?))
)))
...
(assert (= (Tag Tclass._module.IncrementerMethod) Tagclass._module.IncrementerMethod))
(assert (= (TagFamily Tclass._module.IncrementerMethod) tytagFamily$IncrementerMethod))
(assert (forall (($h@@41 T@U) ($o@@86 T@U) ) (!  (=> (and ($IsGoodHeap $h@@41) (and (or (not (= $o@@86 null)) (not true)) ($Is refType $o@@86 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@41 $o@@86) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |962|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@41 $o@@86) _module.OwnedObject.owner)))
)))
...
(assert (forall (($o@@89 T@U) ) (! (= ($Is refType $o@@89 Tclass._module.NonOwnedObject?)  (or (= $o@@89 null) (implements$_module.NonOwnedObject (dtype $o@@89))))
 :qid |unknown.0:0|
 :skolemid |775|
...
(assert (forall (($h@@42 T@U) ($o@@91 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@42) (and (or (not (= $o@@91 null)) (not true)) ($Is refType $o@@91 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@42 $o@@91) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@42 $o@@91) _module.Universe.content)) (TSet Tclass._module.Object) $h@@42))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@42 $o@@91) _module.Universe.content)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@92 T@U) ($f@@41 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#106| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@92 $f@@41))  (=> (and (or (not (= $o@@92 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@92) |l#2|)))) (or (= $o@@92 |l#3|) (= $o@@92 |l#4|))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2277|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#106| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@92 $f@@41))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#106| null $Heap@@71 alloc this@@113 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.IncrementerMethod.remaining)))) ($IsAllocBox ($Box refType this@@113) Tclass._module.Object? $Heap@@71)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@@71 this@@113) (_module.Object.objectGlobalInv $Heap@@71 this@@113))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |running#0| null)) (not true))) (=> (or (not (= |running#0| null)) (not true)) (=> (= (_module.Object.universe |running#0|) (_module.Object.universe this@@113)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (_module.Object.universe this@@113) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@113) null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 (_module.Object.universe this@@113)) _module.Universe.content)) ($Box refType |running#0|)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.OwnedObject.owner)) |running#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.IncrementerMethod.programCounter))) (LitInt 7))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@94 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 $o@@94) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@94) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 $o@@94)) (or (= $o@@94 this@@113) (= $o@@94 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.IncrementerMethod.remaining))))))
 :qid |_08CounterNoTerminationdfy.585:10|
 :skolemid |2103|
