...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split186)
...
)))) (and (and (= $Heap@24 $Heap@25) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@23) (= (ControlFlow 0 2) (- 0 1)))))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@23)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
