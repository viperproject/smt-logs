...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split142)
...
)))) (and (= $Heap@11 $Heap@12) (= (ControlFlow 0 2) (- 0 1)))))))) (U_2_bool (Lit boolType (bool_2_U true)))))))
