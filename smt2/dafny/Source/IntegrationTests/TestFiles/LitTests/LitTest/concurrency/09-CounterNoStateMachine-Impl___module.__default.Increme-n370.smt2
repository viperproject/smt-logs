...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split359)
...
)) ($HeapSucc $Heap@38 $Heap@39)) (and (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|)) (= (ControlFlow 0 2) (- 0 1))))))))))) (< (- 10 |i#0@2|) |$decr$loop#00@1|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
