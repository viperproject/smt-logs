...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@12 T@U) ($f@@9 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@12 $f@@9))  (=> (and (or (not (= $o@@12 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@12) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@12) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1030|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@12 $f@@9))
)))
...
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@6 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@16 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@16 null)) (not true)) (or (= $o@@16 this@@6) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 this@@6) _module.Universe.content)) ($Box refType $o@@16)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@16) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@16) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |490|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon11_correct  (=> (= (_module.Object.goodPreAndLegalChanges $Heap@@5 current$Heap this@@11)  (and (and (and (and (_module.Object.baseInv $Heap@@5 this@@11) (_module.Universe.globalInv $Heap@@5 (_module.Object.universe this@@11))) (_module.Object.baseInv current$Heap this@@11)) (forall (($o@@26 T@U) ($f@@16 T@U) ) (!  (=> (or (not (= $o@@26 null)) (not true)) (=> (= $o@@26 this@@11) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@26) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@26) $f@@16))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |645|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@26) $f@@16))
))) (_module.Universe.legalTransition $Heap@@5 current$Heap (_module.Object.universe this@@11)))) (=> (and (and (and (|_module.Object.baseInv#canCall| $Heap@@5 this@@11) (=> (_module.Object.baseInv $Heap@@5 this@@11) (|_module.Universe.globalInv#canCall| $Heap@@5 (_module.Object.universe this@@11)))) (=> (and (_module.Object.baseInv $Heap@@5 this@@11) (_module.Universe.globalInv $Heap@@5 (_module.Object.universe this@@11))) (and (|_module.Object.baseInv#canCall| current$Heap this@@11) (=> (_module.Object.baseInv current$Heap this@@11) (=> (forall (($o@@27 T@U) ($f@@17 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 this@@11) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@27) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@27) $f@@17))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |646|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@27) $f@@17))
)) (|_module.Universe.legalTransition#canCall| $Heap@@5 current$Heap (_module.Object.universe this@@11))))))) ($Is boolType (bool_2_U (_module.Object.goodPreAndLegalChanges $Heap@@5 current$Heap this@@11)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))))
(let ((anon17_Else_correct  (=> (not (and (and (and (_module.Object.baseInv $Heap@@5 this@@11) (_module.Universe.globalInv $Heap@@5 (_module.Object.universe this@@11))) (_module.Object.baseInv current$Heap this@@11)) (forall (($o@@28 T@U) ($f@@18 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 this@@11) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@28) $f@@18))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |643|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) $f@@18))
)))) (=> (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 9) 3)) anon11_correct))))
(let ((anon17_Then_correct  (=> (and (and (and (_module.Object.baseInv $Heap@@5 this@@11) (_module.Universe.globalInv $Heap@@5 (_module.Object.universe this@@11))) (_module.Object.baseInv current$Heap this@@11)) (forall (($o@@29 T@U) ($f@@19 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 this@@11) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@29) $f@@19))))
 :qid |_05RecInvariantCutdfy.77:8|
 :skolemid |643|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@19))
))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= (_module.Object.universe this@@11) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@11) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@11)) Tclass._module.Universe? current$Heap) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType (_module.Object.universe this@@11) Tclass._module.Universe $Heap@@5)) (=> ($IsAlloc refType (_module.Object.universe this@@11) Tclass._module.Universe $Heap@@5) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@30 T@U) ($f@@20 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@30) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@30) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@30 $f@@20)))
 :qid |_05RecInvariantCutdfy.78:17|
 :skolemid |642|
))) (|_module.Universe.legalTransition#canCall| $Heap@@5 current$Heap (_module.Object.universe this@@11))) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon11_correct)))))))))
(let ((anon16_Else_correct  (=> (and (not (and (and (_module.Object.baseInv $Heap@@5 this@@11) (_module.Universe.globalInv $Heap@@5 (_module.Object.universe this@@11))) (_module.Object.baseInv current$Heap this@@11))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 12) 6) anon17_Then_correct) (=> (= (ControlFlow 0 12) 9) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (and (_module.Object.baseInv $Heap@@5 this@@11) (_module.Universe.globalInv $Heap@@5 (_module.Object.universe this@@11))) (_module.Object.baseInv current$Heap this@@11)) (and (=> (= (ControlFlow 0 10) (- 0 11)) ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@5)) (=> ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@5) (=> (and (= |b$reqreads#1@0| (forall (($o@@31 T@U) ($f@@21 T@U) ) (!  (=> (and (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@31) alloc)))) (= $o@@31 this@@11)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@31 $f@@21)))
 :qid |_05RecInvariantCutdfy.77:18|
 :skolemid |641|
))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 10) 6) anon17_Then_correct) (=> (= (ControlFlow 0 10) 9) anon17_Else_correct))))))))
(let ((anon15_Else_correct  (=> (and (not (and (_module.Object.baseInv $Heap@@5 this@@11) (_module.Universe.globalInv $Heap@@5 (_module.Object.universe this@@11)))) (= |b$reqreads#0@1| true)) (and (=> (= (ControlFlow 0 14) 10) anon16_Then_correct) (=> (= (ControlFlow 0 14) 12) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (_module.Object.baseInv $Heap@@5 this@@11) (_module.Universe.globalInv $Heap@@5 (_module.Object.universe this@@11))) (=> (and (and ($IsAllocBox ($Box refType this@@11) Tclass._module.Object? current$Heap) (= |b$reqreads#0@0| (forall (($o@@32 T@U) ($f@@22 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@22)))
 :qid |_05RecInvariantCutdfy.76:8|
 :skolemid |640|
)))) (and (|_module.Object.baseInv#canCall| current$Heap this@@11) (= |b$reqreads#0@1| |b$reqreads#0@0|))) (and (=> (= (ControlFlow 0 13) 10) anon16_Then_correct) (=> (= (ControlFlow 0 13) 12) anon16_Else_correct))))))
(let ((anon14_Else_correct  (=> (not (_module.Object.baseInv $Heap@@5 this@@11)) (and (=> (= (ControlFlow 0 19) 13) anon15_Then_correct) (=> (= (ControlFlow 0 19) 14) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (_module.Object.baseInv $Heap@@5 this@@11) (and (=> (= (ControlFlow 0 15) (- 0 18)) ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@5)) (=> ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@5) (and (=> (= (ControlFlow 0 15) (- 0 17)) (or (not (= (_module.Object.universe this@@11) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@11) null)) (not true)) (and (=> (= (ControlFlow 0 15) (- 0 16)) ($IsAlloc refType (_module.Object.universe this@@11) Tclass._module.Universe $Heap@@5)) (=> ($IsAlloc refType (_module.Object.universe this@@11) Tclass._module.Universe $Heap@@5) (=> (|_module.Universe.globalInv#canCall| $Heap@@5 (_module.Object.universe this@@11)) (and (=> (= (ControlFlow 0 15) 13) anon15_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct))))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@5)) (=> ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@5) (=> (|_module.Object.baseInv#canCall| $Heap@@5 this@@11) (and (=> (= (ControlFlow 0 20) 15) anon14_Then_correct) (=> (= (ControlFlow 0 20) 19) anon14_Else_correct)))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 22) 1) anon13_Then_correct) (=> (= (ControlFlow 0 22) 20) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Object) ($IsAlloc refType this@@11 Tclass._module.Object previous$Heap))) (= 10 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@5) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 23) 22))) anon0_correct))))
