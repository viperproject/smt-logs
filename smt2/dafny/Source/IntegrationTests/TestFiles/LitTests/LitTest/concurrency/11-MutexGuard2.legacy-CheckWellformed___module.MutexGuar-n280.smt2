...
(set-info :boogie-vc-id CheckWellformed$$_module.MutexGuardU32.baseUserFieldsInv)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@0 Tclass._module.MutexGuardU32 $Heap@@0))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
