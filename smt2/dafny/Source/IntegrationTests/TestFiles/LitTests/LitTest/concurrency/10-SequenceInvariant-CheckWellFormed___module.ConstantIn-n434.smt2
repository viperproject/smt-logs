...
(assert (distinct TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.ConstantInteger Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? class._module.Universe? Tagclass._module.ConstantInteger? tytagFamily$Universe tytagFamily$Object tytagFamily$ConstantInteger tytagFamily$OwnedObject field$content)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|c#0@@2| T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType |c#0@@2| Tclass._module.ConstantInteger $h@@4) ($IsAlloc refType |c#0@@2| Tclass._module.ConstantInteger? $h@@4))
 :qid |unknown.0:0|
 :skolemid |2189|
 :pattern ( ($IsAlloc refType |c#0@@2| Tclass._module.ConstantInteger $h@@4))
 :pattern ( ($IsAlloc refType |c#0@@2| Tclass._module.ConstantInteger? $h@@4))
)))
...
(assert (forall (($o@@3 T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.ConstantInteger? $h@@8)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1981|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.ConstantInteger? $h@@8))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.ConstantInteger.baseUserFieldsInv#canCall| $Heap this) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.ConstantInteger) ($IsAlloc refType this Tclass._module.ConstantInteger $Heap)))))) (= (_module.ConstantInteger.baseUserFieldsInv $Heap this) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.505:19|
 :skolemid |1988|
 :pattern ( (_module.ConstantInteger.baseUserFieldsInv $Heap this) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 Tclass._module.ConstantInteger) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) Tclass._module.ConstantInteger)))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( ($IsBox bx@@6 Tclass._module.ConstantInteger))
)))
...
(assert (forall ((bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 Tclass._module.ConstantInteger?) (and (= ($Box refType ($Unbox refType bx@@10)) bx@@10) ($Is refType ($Unbox refType bx@@10) Tclass._module.ConstantInteger?)))
 :qid |unknown.0:0|
 :skolemid |1979|
 :pattern ( ($IsBox bx@@10 Tclass._module.ConstantInteger?))
)))
...
(assert (forall ((|c#0@@6| T@U) ) (! (= ($Is refType |c#0@@6| Tclass._module.ConstantInteger)  (and ($Is refType |c#0@@6| Tclass._module.ConstantInteger?) (or (not (= |c#0@@6| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |2188|
 :pattern ( ($Is refType |c#0@@6| Tclass._module.ConstantInteger))
 :pattern ( ($Is refType |c#0@@6| Tclass._module.ConstantInteger?))
)))
...
(assert (forall (($o@@7 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@7 Tclass._module.ConstantInteger? $heap@@0) ($IsAlloc refType $o@@7 Tclass._module.OwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |2422|
 :pattern ( ($IsAlloc refType $o@@7 Tclass._module.ConstantInteger? $heap@@0))
)))
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.ConstantInteger))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@8 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (or (= $o@@8 this@@0) (= $o@@8 (_module.Object.universe this@@0)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@8) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@8) $f)))
 :qid |unknown.0:0|
 :skolemid |1984|
)) (= (_module.ConstantInteger.baseUserFieldsInv $h0 this@@0) (_module.ConstantInteger.baseUserFieldsInv $h1 this@@0))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1985|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.ConstantInteger.baseUserFieldsInv $h1 this@@0))
)))
...
(assert (forall ((bx@@14 T@U) ) (!  (=> ($IsBox bx@@14 Tclass._module.ConstantInteger?) ($IsBox bx@@14 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2419|
...
(set-info :boogie-vc-id CheckWellFormed$$_module.ConstantInteger.baseUserFieldsInvMonotonicity)
