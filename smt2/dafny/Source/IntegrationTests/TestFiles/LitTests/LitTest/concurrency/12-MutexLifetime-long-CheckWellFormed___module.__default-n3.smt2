...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@17 T@U) ($f@@9 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0| |l#3| |l#4|) $o@@17 $f@@9))  (=> (and (or (not (= $o@@17 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@17) |l#2@@0|)))) (or (= $o@@17 |l#3|) (|Set#IsMember| |l#4| ($Box refType $o@@17)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3863|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0| |l#3| |l#4|) $o@@17 $f@@9))
)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($prevHeap@@15 T@U) ($Heap@@33 T@U) (this@@44 T@U) (|running#0@@0| T@U) ) (!  (=> (or (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@15 $Heap@@33 this@@44 |running#0@@0|) (and (< 9 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@15) ($IsGoodHeap $Heap@@33)) ($HeapSucc $prevHeap@@15 $Heap@@33)) (and (or (not (= this@@44 null)) (not true)) (and ($Is refType this@@44 Tclass._module.Universe) ($IsAlloc refType this@@44 Tclass._module.Universe $prevHeap@@15)))) ($Is SetType |running#0@@0| (TSet Tclass._module.Thread))))) (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $prevHeap@@15 $Heap@@33 this@@44) (=> (_module.Universe.baseLegalTransitionsSequence $prevHeap@@15 $Heap@@33 this@@44) (=> (|Set#Subset| |running#0@@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 this@@44) _module.Universe.content))) (and (forall ((|o#0@@4| T@U) ) (!  (=> ($Is refType |o#0@@4| Tclass._module.Object) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 this@@44) _module.Universe.content)) ($Box refType |o#0@@4|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 this@@44) _module.Universe.content)) ($Box refType |o#0@@4|))) (=> (not (forall (($o@@24 T@U) ($f@@11 T@U) ) (!  (=> (or (not (= $o@@24 null)) (not true)) (=> (= $o@@24 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 $o@@24) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 $o@@24) $f@@11))))
...
)) (forall ((|l#0@@1| T@U) ) (!  (=> ($Is refType |l#0@@1| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 this@@44) _module.Universe.content)) ($Box refType |l#0@@1|)) (=> (not (|Set#IsMember| |running#0@@0| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 |l#0@@1|) _module.Lifetime.owner))) (=> ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 |l#0@@1|) _module.Lifetime.owner) Tclass._module.Thread? $prevHeap@@15) (|_module.Lifetime.unchangedNonvolatileFields#canCall| $prevHeap@@15 $Heap@@33 |l#0@@1|)))))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1239|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $prevHeap@@15 $Heap@@33 |l#0@@1|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 this@@44) _module.Universe.content)) ($Box refType |l#0@@1|)))
...
))) (forall ((|l#0@@2| T@U) ) (!  (=> (and ($Is refType |l#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 this@@44) _module.Universe.content)) ($Box refType |l#0@@2|))) (=> (and (not (|Set#IsMember| |running#0@@0| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 |l#0@@2|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@15 |l#0@@2|) _module.Lifetime.owner) Tclass._module.Thread? $prevHeap@@15)) (_module.Lifetime.unchangedNonvolatileFields $prevHeap@@15 $Heap@@33 |l#0@@2|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1236|
...
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@53 this@@82) (=> (_module.Lifetime.alive $Heap@@53 this@@82) (forall ((|l#0@@3| T@U) ) (!  (=> ($Is refType |l#0@@3| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@3|)) (|_module.Lifetime.alive#canCall| $Heap@@53 |l#0@@3|)))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2327|
 :pattern ( (_module.Lifetime.alive $Heap@@53 |l#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@3|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@53 this@@82) (forall ((|l#0@@4| T@U) ) (!  (=> (and ($Is refType |l#0@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@4|))) (_module.Lifetime.alive $Heap@@53 |l#0@@4|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2331|
...
))) (and (|_module.Lifetime.alive#canCall| $Heap@@53 this@@82) (=> (not (_module.Lifetime.alive $Heap@@53 this@@82)) (forall ((|l#1@@1| T@U) ) (!  (=> ($Is refType |l#1@@1| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)) (|_module.Lifetime.alive#canCall| $Heap@@53 |l#1@@1|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2328|
 :pattern ( (_module.Lifetime.alive $Heap@@53 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
...
)))) (=> (not (_module.Lifetime.alive $Heap@@53 this@@82)) (forall ((|l#1@@2| T@U) ) (!  (=> (and ($Is refType |l#1@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@53 this@@82) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@2|))) (not (_module.Lifetime.alive $Heap@@53 |l#1@@2|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2323|
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.InterferenceWithFraming)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon11_correct true))
(let ((anon16_Else_correct  (=> (and (=> (_module.Universe.outlives ($LS $LZ) $Heap@@62 |universe#0| |a#0@0| |b#0@0|) (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#0@0| |b#0@0|)) (= (ControlFlow 0 13) 1)) anon11_correct)))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 12)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 11)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62) (and (=> (= (ControlFlow 0 3) (- 0 10)) ($IsAlloc refType |a#0@0| Tclass._module.Lifetime $Heap@@62)) (=> ($IsAlloc refType |a#0@0| Tclass._module.Lifetime $Heap@@62) (and (=> (= (ControlFlow 0 3) (- 0 9)) ($IsAlloc refType |b#0@0| Tclass._module.Lifetime $Heap@@62)) (=> ($IsAlloc refType |b#0@0| Tclass._module.Lifetime $Heap@@62) (and (=> (= (ControlFlow 0 3) (- 0 8)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |a#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|))) (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |a#0@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|))) (and (|_module.Universe.outlives#canCall| $Heap@@62 |universe#0| |a#0@0| |b#0@0|) (_module.Universe.outlives ($LS $LZ) $Heap@@62 |universe#0| |a#0@0| |b#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@0) (=> (and ($IsAlloc refType |a#0@0| Tclass._module.Lifetime $Heap@0) ($IsAlloc refType |b#0@0| Tclass._module.Lifetime $Heap@0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |a#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|))) (=> (and (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |a#0@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|))) (|_module.Universe.outlives#canCall| $Heap@0 |universe#0| |a#0@0| |b#0@0|)) (and (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#0@0| |b#0@0|) (= (ControlFlow 0 3) 1))) anon11_correct))))))))))))))))))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 14) (- 0 18)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 17)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |a#0@0|)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|)) (and (=> (= (ControlFlow 0 14) 3) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct))))))))))))))
(let ((anon15_Else_correct  (=> (and (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |a#0@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|))) (=> (_module.Universe.outlives ($LS $LZ) $Heap@@62 |universe#0| |a#0@0| |b#0@0|) (_module.Universe.outlives ($LS $LZ) $Heap@0 |universe#0| |a#0@0| |b#0@0|))) (= (ControlFlow 0 2) 1)) anon11_correct)))
(let ((anon6_correct  (=> (and (= |##running#0@0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) ($IsAlloc SetType |##running#0@0| (TSet Tclass._module.Thread) $Heap@0)) (and (=> (= (ControlFlow 0 19) (- 0 21)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62) (and (=> (= (ControlFlow 0 19) (- 0 20)) ($IsAlloc SetType (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) (TSet Tclass._module.Thread) $Heap@@62)) (=> ($IsAlloc SetType (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)) (TSet Tclass._module.Thread) $Heap@@62) (=> (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@62 $Heap@0 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|))) (_module.Universe.legalTransitionsSequence $Heap@@62 $Heap@0 |universe#0| (|Set#FromBoogieMap| (|lambda#3| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) |preempting#0|)))) (=> (and (and ($Is refType |a#0@0| Tclass._module.Lifetime) ($IsAlloc refType |a#0@0| Tclass._module.Lifetime $Heap@0)) (and ($Is refType |b#0@0| Tclass._module.Lifetime) ($IsAlloc refType |b#0@0| Tclass._module.Lifetime $Heap@0))) (and (=> (= (ControlFlow 0 19) 14) anon15_Then_correct) (=> (= (ControlFlow 0 19) 2) anon15_Else_correct)))))))))))
(let ((anon14_Else_correct  (=> (and (not (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |t#0@0|)) (or (not (= |t#0@0| |preempting#0|)) (not true)))) (= (ControlFlow 0 24) 19)) anon6_correct)))
(let ((anon14_Then_correct  (=> (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |t#0@0|)) (or (not (= |t#0@0| |preempting#0|)) (not true))) (= (ControlFlow 0 23) 19)) anon6_correct)))
(let ((anon13_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |t#0@0|))) (and (=> (= (ControlFlow 0 26) 23) anon14_Then_correct) (=> (= (ControlFlow 0 26) 24) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |t#0@0|)) (and (=> (= (ControlFlow 0 25) 23) anon14_Then_correct) (=> (= (ControlFlow 0 25) 24) anon14_Else_correct)))))
(let ((anon12_Then_correct  (=> (and ($Is refType |t#0@0| Tclass._module.Thread) ($IsAlloc refType |t#0@0| Tclass._module.Thread $Heap@0)) (and (=> (= (ControlFlow 0 27) (- 0 29)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 27) (- 0 28)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62) (and (=> (= (ControlFlow 0 27) 25) anon13_Then_correct) (=> (= (ControlFlow 0 27) 26) anon13_Else_correct)))))))))
(let ((anon12_Else_correct  (=> (and (not (and ($Is refType |t#0@0| Tclass._module.Thread) ($IsAlloc refType |t#0@0| Tclass._module.Thread $Heap@0))) (= (ControlFlow 0 22) 19)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@62 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)))) (and (=> (= (ControlFlow 0 30) (- 0 37)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@62) (=> (and (|_module.Universe.globalInv#canCall| $Heap@@62 |universe#0|) (_module.Universe.globalInv $Heap@@62 |universe#0|)) (and (=> (= (ControlFlow 0 30) (- 0 36)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType |preempting#0|)) (and (=> (= (ControlFlow 0 30) (- 0 35)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@74 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@74) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@74) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 $o@@74)) (or (= $o@@74 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@62 |universe#0|) _module.Universe.content)) ($Box refType $o@@74)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |751|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@74))
)) ($HeapSucc $Heap@@62 $Heap@0))) (and (=> (= (ControlFlow 0 30) (- 0 34)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@0) (=> (and (|_module.Universe.globalInv#canCall| $Heap@0 |universe#0|) (_module.Universe.globalInv $Heap@0 |universe#0|)) (and (=> (= (ControlFlow 0 30) (- 0 33)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@0) (and (=> (= (ControlFlow 0 30) (- 0 32)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62) (=> (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@@62 $Heap@0 |universe#0|) (_module.Universe.globalSequenceInv2 $Heap@@62 $Heap@0 |universe#0|)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@0) (and (=> (= (ControlFlow 0 30) 27) anon12_Then_correct) (=> (= (ControlFlow 0 30) 22) anon12_Else_correct))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@62) ($IsHeapAnchor $Heap@@62)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@62))) (and (and ($Is refType |preempting#0| Tclass._module.Thread) ($IsAlloc refType |preempting#0| Tclass._module.Thread $Heap@@62)) (and (= 23 $FunctionContextHeight) (= (ControlFlow 0 38) 30)))) anon0_correct)))
