...
(assert (forall (($o@@9 T@U) ) (!  (=> ($Is refType $o@@9 Tclass._module.Remaining?) ($Is refType $o@@9 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3534|
 :pattern ( ($Is refType $o@@9 Tclass._module.Remaining?))
)))
...
(set-info :boogie-vc-id OverrideCheck$$_module.Remaining.ProveUnchangedNonvolatileUserFields)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (forall (($o@@12 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@12 null)) (not true)) (=> (= $o@@12 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@12) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@12) $f@@0))))
...
)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall (($o@@13 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@13 null)) (not true)) (=> (= $o@@13 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@13) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@13) $f@@1))))
...
)) (and (=> (= (ControlFlow 0 2) (- 0 6)) true) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@15 T@U) ($f@@3 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.549:18|
 :skolemid |1899|
))) (=> (forall (($o@@16 T@U) ($f@@4 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.549:18|
 :skolemid |1899|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@17 T@U) ($f@@5 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.549:18|
 :skolemid |1900|
))) (=> (forall (($o@@18 T@U) ($f@@6 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.549:18|
 :skolemid |1900|
)) (=> (_module.Remaining.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Remaining.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.Remaining.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (=> (|_module.Remaining.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.Remaining.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Remaining.unchangedNonvolatileUserFields#canCall| $Heap@@0 current$Heap this@@1) (or (_module.Remaining.unchangedNonvolatileUserFields $Heap@@0 current$Heap this@@1) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Remaining.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Remaining.value))))))))))))))))))))
