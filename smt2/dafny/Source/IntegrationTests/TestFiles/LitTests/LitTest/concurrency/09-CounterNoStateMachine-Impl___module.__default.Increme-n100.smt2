...
))) (and (and ($HeapSucc $Heap@12 $Heap@13) (or (not (= |counter#0| null)) (not true))) (and (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |counter#0| _module.IncreasingCounter.value)) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= |counter#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
