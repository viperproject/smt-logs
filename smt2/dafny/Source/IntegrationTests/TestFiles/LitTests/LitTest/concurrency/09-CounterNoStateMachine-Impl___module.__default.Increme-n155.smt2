...
(declare-fun call5formal@this@@0 () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split144)
...
)) ($HeapSucc $Heap@3 $Heap@4))))) (and (and (and (and (forall (($o@@123 T@U) ($f@@74 T@U) ) (!  (=> (and (or (not (= $o@@123 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@123) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@123) $f@@74) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@123) $f@@74)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@123 $f@@74))))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |545|
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (and ($IsGoodHeap $Heap@17) ($IsHeapAnchor $Heap@17)) (and (or (not (= call4formal@this@0@@0 null)) (not true)) (and ($Is refType call4formal@this@0@@0 Tclass._module.ConstantInteger) ($IsAlloc refType call4formal@this@0@@0 Tclass._module.ConstantInteger $Heap@17)))))))) (and (and (and (and (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@17 call4formal@this@0@@0) (=> (_module.Object.objectGlobalInv $Heap@17 call4formal@this@0@@0) (|_module.Universe.globalInv2#canCall| $Heap@16 $Heap@17 |universe#0|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@17 call4formal@this@0@@0) (and (_module.Object.objectGlobalInv $Heap@17 call4formal@this@0@@0) (and (_module.Object.baseInv $Heap@17 call4formal@this@0@@0) (_module.Universe.globalInv $Heap@17 (_module.Object.universe call4formal@this@0@@0)))))) (and (and (|_module.Universe.globalInv2#canCall| $Heap@16 $Heap@17 |universe#0|) (and (_module.Universe.globalInv2 $Heap@16 $Heap@17 |universe#0|) (and true (forall ((|o#8@@4| T@U) ) (!  (=> (and ($Is refType |o#8@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|)) (_module.Object.inv2 $Heap@16 $Heap@17 |o#8@@4|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |2895|
...
)))) (= (ControlFlow 0 2) (- 0 1)))))))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
