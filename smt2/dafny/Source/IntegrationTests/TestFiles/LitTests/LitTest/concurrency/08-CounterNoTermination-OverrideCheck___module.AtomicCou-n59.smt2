...
(set-info :boogie-vc-id OverrideCheck$$_module.AtomicCounter.unchangedNonvolatileUserFields)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this)) (|Set#UnionOne| |Set#Empty| ($Box refType this)))) (=> (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this)) (|Set#UnionOne| |Set#Empty| ($Box refType this))) (=> (and (= AtomicCounter_$_ReadsFrame@0 (|lambda#11| null current$Heap alloc this)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@10) alloc)))) (= $o@@10 this)) (= $o@@10 this))
 :qid |_08CounterNoTerminationdfy.290:22|
 :skolemid |1267|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.AtomicCounter) ($IsAlloc refType this Tclass._module.AtomicCounter current$Heap@@0))) (= 0 $FunctionContextHeight)) (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap@@0) ($IsGoodHeap current$Heap@@0))) (= (ControlFlow 0 4) 2))) anon0_correct))))
