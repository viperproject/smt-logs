...
(set-info :boogie-vc-id OverrideCheck$$_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInvMonotonicity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (and (and (_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv $Heap@@0 this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))) (forall (($o@@28 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@28) $f@@0))))
...
))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv#canCall| $Heap@@0 this@@1) (or (_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv $Heap@@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.ClaimIncreasingCounterGreaterThanConstant.counter))))) (=> (=> (|_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv#canCall| $Heap@@0 this@@1) (or (_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv $Heap@@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.ClaimIncreasingCounterGreaterThanConstant.counter)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv#canCall| $Heap@@0 this@@1) (or (_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv $Heap@@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.ClaimIncreasingCounterGreaterThanConstant.constant))))) (=> (=> (|_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv#canCall| $Heap@@0 this@@1) (or (_module.ClaimIncreasingCounterGreaterThanConstant.baseUserFieldsInv $Heap@@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.ClaimIncreasingCounterGreaterThanConstant.constant)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall (($o@@29 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@29) $f@@1))))
 ...
 :qid |_10SequenceInvariantdfy.554:18|
 :skolemid |2207|
