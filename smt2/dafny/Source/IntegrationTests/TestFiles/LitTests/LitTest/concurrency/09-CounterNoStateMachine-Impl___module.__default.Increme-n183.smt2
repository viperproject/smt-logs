...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split172)
...
))))) (and ($IsGoodHeap $Heap@16) ($IsHeapAnchor $Heap@16))))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (=> (_module.Universe.globalInv $Heap@15 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@13 $Heap@15 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (and (_module.Universe.globalInv $Heap@15 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#17@@3| T@U) ) (!  (=> (and ($Is refType |o#17@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@3|))) (_module.Object.inv $Heap@15 |o#17@@3|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))) (= (_module.Object.universe call4formal@this@0@@0) |universe#0|)) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call4formal@this@0@@0) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 call4formal@this@0@@0) _module.ConstantInteger.value))) |value##0_1@1|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@0)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 call4formal@this@0@@0) alloc)))))))) (and (and (and (and (forall (($o@@141 T@U) ) (!  (=> (and (or (not (= $o@@141 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@141) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 $o@@141) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 $o@@141)) (= $o@@141 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.608:3|
 :skolemid |2896|
...
))))) (and (= (_module.Object.universe call5formal@this@0@@0) |universe#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.OwnedObject.owner)) |running#0@@3|))))) (and (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.ClaimIncreasingCounterGreaterThanConstant.counter)) |counter#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 call5formal@this@0@@0) _module.ClaimIncreasingCounterGreaterThanConstant.constant)) call4formal@this@0@@0)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0@@0)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 call5formal@this@0@@0) alloc)))))) (and (and (forall (($o@@148 T@U) ) (!  (=> (and (or (not (= $o@@148 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@148) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@148) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@148)) (= $o@@148 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.657:3|
 :skolemid |3168|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@148))
)) ($HeapSucc $Heap@19 $Heap@20)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@19)))) (and (and (and ($IsGoodHeap $Heap@21) ($IsHeapAnchor $Heap@21)) (forall ((|o#1@@24| T@U) ) (!  (=> ($Is refType |o#1@@24| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@24|)) (=> (=> ($Is refType |o#1@@24| Tclass._module.OwnedObject) (and (forall (($o@@149 T@U) ($f@@95 T@U) ) (!  (=> (or (not (= $o@@149 null)) (not true)) (=> (= $o@@149 |o#1@@24|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@20 $o@@149) $f@@95) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@19 $o@@149) $f@@95))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
...
))))) (and (= $Heap@21 $Heap@22) (or (not (= |universe#0| null)) (not true)))) (and (and (forall (($o@@154 T@U) ($f@@100 T@U) ) (!  (=> (and (and (or (not (= $o@@154 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 $o@@154) alloc)))) (or (= $o@@154 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@22 |universe#0|) _module.Universe.content)) ($Box refType $o@@154)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@154 $f@@100)))
