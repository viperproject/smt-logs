...
(set-info :boogie-vc-id OverrideCheck$$_module.IncreasingCounter.baseUserFieldsInvMonotonicity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (and (and (_module.IncreasingCounter.baseUserFieldsInv $Heap@@0 this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))) (forall (($o@@16 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@16 null)) (not true)) (=> (= $o@@16 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@16) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@16) $f@@0))))
 ...
 :qid |_10SequenceInvariantdfy.420:18|
 :skolemid |1572|
 ...
 :qid |_10SequenceInvariantdfy.420:18|
 :skolemid |1573|
)) (=> (and (and (_module.IncreasingCounter.baseUserFieldsInv current$Heap this@@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.IncreasingCounter.baseUserFieldsInv#canCall| current$Heap this@@1)) (or (_module.IncreasingCounter.baseUserFieldsInv current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@1 Tclass._module.IncreasingCounter previous$Heap))) (= 3 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 9) 2))) anon0_correct))))
