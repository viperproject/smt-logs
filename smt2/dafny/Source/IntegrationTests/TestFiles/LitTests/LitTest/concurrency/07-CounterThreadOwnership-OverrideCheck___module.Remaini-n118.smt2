...
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@62 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@62 null)) (not true)) (and ($Is refType this@@62 Tclass._module.Universe) ($IsAlloc refType this@@62 Tclass._module.Universe $h0@@20)))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@46 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@46) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@46) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@46) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |502|
...
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@63 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@63 null)) (not true)) (and ($Is refType this@@63 Tclass._module.Object) ($IsAlloc refType this@@63 Tclass._module.Object $h0@@21)))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@47 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@47 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@47) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@47) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@47) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |967|
...
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@66 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@66 null)) (not true)) (and ($Is refType this@@66 Tclass._module.Thread) ($IsAlloc refType this@@66 Tclass._module.Thread $h0@@24)))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@50 T@U) ($f@@33 T@U) ) (!  (=> (and (or (not (= $o@@50 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@50) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@50) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@50) $f@@33)))
 :qid |unknown.0:0|
 :skolemid |1084|
...
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@67 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@67 null)) (not true)) (and ($Is refType this@@67 Tclass._module.Thread) ($IsAlloc refType this@@67 Tclass._module.Thread $h0@@25)))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@51 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@51 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@51) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@51) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@51) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |1092|
...
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@68 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@68 null)) (not true)) (and ($Is refType this@@68 Tclass._module.OwnedObject) ($IsAlloc refType this@@68 Tclass._module.OwnedObject $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@52 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@52 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@52) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@52) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@52) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |1299|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@69 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@69 null)) (not true)) (and ($Is refType this@@69 Tclass._module.OwnedObject) ($IsAlloc refType this@@69 Tclass._module.OwnedObject $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@53 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@53 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@53) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@53) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@53) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |1309|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@70 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@70 null)) (not true)) (and ($Is refType this@@70 Tclass._module.OwnedObject) ($IsAlloc refType this@@70 Tclass._module.OwnedObject $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@54 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@54) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@54) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@54) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1385|
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@72 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@72 null)) (not true)) (and ($Is refType this@@72 Tclass._module.OwnedObject) ($IsAlloc refType this@@72 Tclass._module.OwnedObject $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@56 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@56 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@56) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@56) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@56) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1397|
...
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@74 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.Remaining) ($IsAlloc refType this@@74 Tclass._module.Remaining $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@58 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@58) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@58) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@58) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1910|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@75 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@75 null)) (not true)) (and ($Is refType this@@75 Tclass._module.Remaining) ($IsAlloc refType this@@75 Tclass._module.Remaining $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@59 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@59) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@59) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@59) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1917|
...
(set-info :boogie-vc-id OverrideCheck$$_module.Remaining.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon0_correct  (=> (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@49 this@@84) (or (_module.Object.baseInv $Heap@@49 this@@84) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType this@@84))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@49 this@@84) (or (_module.Object.baseInv $Heap@@49 this@@84) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType this@@84)))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@49 this@@84) (or (_module.Object.baseInv $Heap@@49 this@@84) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#0@@9| T@U) ) (!  (=> (and ($Is refType |o#0@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#0@@9|))) (and (= (_module.Object.universe |o#0@@9|) (_module.Object.universe this@@84)) (or (not (= |o#0@@9| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1940|
 :pattern ( (_module.Object.universe |o#0@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#0@@9|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@49 this@@84) (or (_module.Object.baseInv $Heap@@49 this@@84) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#0@@10|))) (and (= (_module.Object.universe |o#0@@10|) (_module.Object.universe this@@84)) (or (not (= |o#0@@10| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1940|
 :pattern ( (_module.Object.universe |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#0@@10|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalInv $Heap@@49 (_module.Object.universe this@@84)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#1@@3|))) (and (= (_module.Object.universe |o#1@@3|) (_module.Object.universe this@@84)) (or (not (= |o#1@@3| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1942|
 :pattern ( (_module.Object.universe |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#1@@3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalInv $Heap@@49 (_module.Object.universe this@@84)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#1@@4|))) (and (= (_module.Object.universe |o#1@@4|) (_module.Object.universe this@@84)) (or (not (= |o#1@@4| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1942|
 :pattern ( (_module.Object.universe |o#1@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#1@@4|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#2|))) (_module.Object.inv $Heap@@49 |o#2|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |1944|
 :pattern ( (_module.Object.inv $Heap@@49 |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#2|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#2@@0|))) (_module.Object.inv $Heap@@49 |o#2@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |1944|
 :pattern ( (_module.Object.inv $Heap@@49 |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@84) (or (_module.Object.baseInv current$Heap this@@84) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType this@@84))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@84) (or (_module.Object.baseInv current$Heap this@@84) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType this@@84)))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@84) (or (_module.Object.baseInv current$Heap this@@84) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@84)) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#3|))) (and (= (_module.Object.universe |o#3|) (_module.Object.universe this@@84)) (or (not (= |o#3| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1946|
 :pattern ( (_module.Object.universe |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@84) (or (_module.Object.baseInv current$Heap this@@84) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@84)) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#3@@0|))) (and (= (_module.Object.universe |o#3@@0|) (_module.Object.universe this@@84)) (or (not (= |o#3@@0| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1946|
 :pattern ( (_module.Object.universe |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (forall (($o@@69 T@U) ($f@@43 T@U) ) (!  (=> (or (not (= $o@@69 null)) (not true)) (=> (= $o@@69 this@@84) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@69) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 $o@@69) $f@@43))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |1948|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@69) $f@@43))
))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (forall (($o@@70 T@U) ($f@@44 T@U) ) (!  (=> (or (not (= $o@@70 null)) (not true)) (=> (= $o@@70 this@@84) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@70) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 $o@@70) $f@@44))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |1948|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@70) $f@@44))
)))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84)) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#4|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#4|)))) (not ($IsAllocBox ($Box refType |o#4|) Tclass._module.Object $Heap@@49)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |1949|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#4|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#4|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84)) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#4@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#4@@0|)))) (not ($IsAllocBox ($Box refType |o#4@@0|) Tclass._module.Object $Heap@@49)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |1949|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#4@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84)) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#5|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#5|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#5|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |1950|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#5|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#5|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84)) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#5@@0|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#5@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#5@@0|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |1950|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#5@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#5@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#6|))) (and (= (_module.Object.universe |o#6|) (_module.Object.universe this@@84)) (or (not (= |o#6| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1953|
 :pattern ( (_module.Object.universe |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#6|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#6@@0|))) (and (= (_module.Object.universe |o#6@@0|) (_module.Object.universe this@@84)) (or (not (= |o#6@@0| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1953|
 :pattern ( (_module.Object.universe |o#6@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#6@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@84)) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#7|))) (and (= (_module.Object.universe |o#7|) (_module.Object.universe this@@84)) (or (not (= |o#7| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1955|
 :pattern ( (_module.Object.universe |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#7|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@84)) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (= (_module.Object.universe |o#7@@0|) (_module.Object.universe this@@84)) (or (not (= |o#7@@0| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1955|
 :pattern ( (_module.Object.universe |o#7@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#7@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#8|))) (_module.Object.transitiveInv2 $Heap@@49 current$Heap |o#8|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |1957|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@49 current$Heap |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#8|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#8@@0|))) (_module.Object.transitiveInv2 $Heap@@49 current$Heap |o#8@@0|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |1957|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@49 current$Heap |o#8@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#8@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#9|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@49)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#9|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |1958|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#9|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@49 current$Heap (_module.Object.universe this@@84) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#9@@0| T@U) ) (!  (=> (and ($Is refType |o#9@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#9@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9@@0|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@49)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#9@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |1958|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 |o#9@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#9@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalInv $Heap@@49 (_module.Object.universe this@@84)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#10|))) (and (= (_module.Object.universe |o#10|) (_module.Object.universe this@@84)) (or (not (= |o#10| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1961|
 :pattern ( (_module.Object.universe |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#10|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalInv $Heap@@49 (_module.Object.universe this@@84)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#10@@0|))) (and (= (_module.Object.universe |o#10@@0|) (_module.Object.universe this@@84)) (or (not (= |o#10@@0| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1961|
 :pattern ( (_module.Object.universe |o#10@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#10@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#11|))) (_module.Object.inv $Heap@@49 |o#11|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |1963|
 :pattern ( (_module.Object.inv $Heap@@49 |o#11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#11|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@49 (_module.Object.universe this@@84)) (or (_module.Universe.globalInv $Heap@@49 (_module.Object.universe this@@84)) (forall ((|o#11@@0| T@U) ) (!  (=> (and ($Is refType |o#11@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#11@@0|))) (_module.Object.inv $Heap@@49 |o#11@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |1963|
 :pattern ( (_module.Object.inv $Heap@@49 |o#11@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#11@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@84)) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#12|))) (and (= (_module.Object.universe |o#12|) (_module.Object.universe this@@84)) (or (not (= |o#12| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1965|
 :pattern ( (_module.Object.universe |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#12|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@84)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@84)) (forall ((|o#12@@0| T@U) ) (!  (=> (and ($Is refType |o#12@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#12@@0|))) (and (= (_module.Object.universe |o#12@@0|) (_module.Object.universe this@@84)) (or (not (= |o#12@@0| (_module.Object.universe this@@84))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |1965|
 :pattern ( (_module.Object.universe |o#12@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#12@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#13|))) (and (or (forall (($o@@71 T@U) ($f@@45 T@U) ) (!  (=> (or (not (= $o@@71 null)) (not true)) (=> (= $o@@71 |o#13|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@71) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 $o@@71) $f@@45))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |1967|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@71) $f@@45))
)) (_module.Object.inv current$Heap |o#13|)) (or (forall (($o@@72 T@U) ($f@@46 T@U) ) (!  (=> (or (not (= $o@@72 null)) (not true)) (=> (= $o@@72 |o#13|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@72) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 $o@@72) $f@@46))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |1968|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@72) $f@@46))
)) (_module.Object.inv2 $Heap@@49 current$Heap |o#13|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |1969|
 :pattern ( (_module.Object.inv2 $Heap@@49 current$Heap |o#13|))
 :pattern ( (_module.Object.inv current$Heap |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#13|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (forall ((|o#13@@0| T@U) ) (!  (=> (and ($Is refType |o#13@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#13@@0|))) (and (or (forall (($o@@73 T@U) ($f@@47 T@U) ) (!  (=> (or (not (= $o@@73 null)) (not true)) (=> (= $o@@73 |o#13@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@73) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 $o@@73) $f@@47))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |1967|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@73) $f@@47))
)) (_module.Object.inv current$Heap |o#13@@0|)) (or (forall (($o@@74 T@U) ($f@@48 T@U) ) (!  (=> (or (not (= $o@@74 null)) (not true)) (=> (= $o@@74 |o#13@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@74) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 $o@@74) $f@@48))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |1968|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@74) $f@@48))
)) (_module.Object.inv2 $Heap@@49 current$Heap |o#13@@0|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |1969|
 :pattern ( (_module.Object.inv2 $Heap@@49 current$Heap |o#13@@0|))
 :pattern ( (_module.Object.inv current$Heap |o#13@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#13@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#14|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#14|))))) (_module.Object.inv current$Heap |o#14|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |1970|
 :pattern ( (_module.Object.inv current$Heap |o#14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#14|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#14|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@49 current$Heap (_module.Object.universe this@@84) |running#0@@5|) (forall ((|o#14@@0| T@U) ) (!  (=> (and ($Is refType |o#14@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#14@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#14@@0|))))) (_module.Object.inv current$Heap |o#14@@0|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |1970|
 :pattern ( (_module.Object.inv current$Heap |o#14@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#14@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@84)) _module.Universe.content)) ($Box refType |o#14@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true)))) (=> (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@75 T@U) ($f@@49 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.569:18|
 :skolemid |1976|
))) (=> (forall (($o@@76 T@U) ($f@@50 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.569:18|
 :skolemid |1976|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@77 T@U) ($f@@51 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.569:18|
 :skolemid |1977|
))) (=> (forall (($o@@78 T@U) ($f@@52 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.569:18|
 :skolemid |1977|
)) (=> (and (_module.OwnedObject.inv2 $Heap@@49 current$Heap this@@84) (_module.OwnedObject.inv current$Heap this@@84)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Object.inv2 $Heap@@49 current$Heap this@@84)) (=> (_module.Object.inv2 $Heap@@49 current$Heap this@@84) (=> (= (ControlFlow 0 2) (- 0 1)) (_module.Object.inv current$Heap this@@84))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@49) ($IsHeapAnchor $Heap@@49)) (and (or (not (= this@@84 null)) (not true)) (and ($Is refType this@@84 Tclass._module.Remaining) ($IsAlloc refType this@@84 Tclass._module.Remaining previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@49) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 26) 2)))) anon0_correct))))
