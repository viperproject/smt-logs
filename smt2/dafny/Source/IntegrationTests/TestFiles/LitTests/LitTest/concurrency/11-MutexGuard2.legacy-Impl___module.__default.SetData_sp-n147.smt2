...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split131)
...
))) (and (and ($HeapSucc $Heap@14 $Heap@15) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|))))))) (or (_module.Universe.globalInv $Heap@15 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@15 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
