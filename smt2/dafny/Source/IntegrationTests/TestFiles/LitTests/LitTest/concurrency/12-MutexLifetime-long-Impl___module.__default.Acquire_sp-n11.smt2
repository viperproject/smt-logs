...
(set-info :boogie-vc-id Impl$$_module.__default.Acquire_split4)
...
))))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |scope#0|)) ($Box refType |mutex#0|)) ($Box refType |mutexScope#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |scope#0|) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |mutexScope#0|) _module.Lifetime.owner))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |mutexScope#0|) _module.Lifetime.owner)) |running#0@@3|)))) (and (and (and (and (|_module.Lifetime.unused#canCall| $Heap@@133 |scope#0|) (and (_module.Lifetime.unused $Heap@@133 |scope#0|) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |scope#0|) _module.Lifetime.mightPointFrom)) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |scope#0|) _module.Lifetime.elements)) |Set#Empty|)))) (or (not (= |scope#0| |mutexScope#0|)) (not true))) (and (|_module.Universe.outlives#canCall| $Heap@@133 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (and (_module.Universe.outlives ($LS $LZ) $Heap@@133 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |mutexScope#0|) _module.Lifetime.mightPointTo)) ($Box refType (_module.OwnedObject.lifetime |mutex#0|))) (exists ((|x#2| T@U) ) (!  (and (and ($Is refType |x#2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@133 |universe#0|) _module.Universe.content)) ($Box refType |x#2|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@133 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |x#2| |mutexScope#0|))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |850|
...
)) (= $Heap@2 $Heap@3))))) (and (and (and (and (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@3) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@0)) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@3 |universe#0|) (|_module.Universe.globalSequenceInv2#canCall| $Heap@0 $Heap@3 |universe#0|))) (and (and (_module.Universe.globalSequenceInv2 $Heap@0 $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (and (= |mightPointTo##0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |scope#0|))) (forall (($o@@148 T@U) ($f@@88 T@U) ) (!  (=> (and (and (or (not (= $o@@148 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@148) alloc)))) (or (= $o@@148 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@148)) (= $f@@88 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@148 $f@@88)))
...
))))) (= (_module.Object.universe call5formal@this@0) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call5formal@this@0) _module.Lifetime.elements)) |Set#Empty|))))))) (and (and (and (and (and (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call5formal@this@0) _module.Lifetime.mightPointTo)) |mightPointTo##0@0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call5formal@this@0) _module.Lifetime.mightPointFrom)) |Set#Empty|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (forall ((|l#3@@1| T@U) ) (!  (=> (and ($Is refType |l#3@@1| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#3@@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))))
...
)))) (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call5formal@this@0) alloc)))) (forall (($o@@151 T@U) ) (!  (=> (and (or (not (= $o@@151 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@151) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@151) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@151)) (or (= $o@@151 |universe#0|) (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@151)))))
...
)))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType call5formal@this@0)) ($Box refType |mutex#0|)) ($Box refType |mutexScope#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |mutexScope#0|) _module.Lifetime.owner)) |running#0@@3|))) (and (and (or (not (= call5formal@this@0 |mutexScope#0|)) (not true)) (=> (|_module.Universe.outlives#canCall| $Heap@6 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (or (_module.Universe.outlives ($LS $LZ) $Heap@6 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |mutexScope#0|) _module.Lifetime.mightPointTo)) ($Box refType (_module.OwnedObject.lifetime |mutex#0|))) (exists ((|x#0@@10| T@U) ) (!  (and (and ($Is refType |x#0@@10| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |x#0@@10|))) (_module.Universe.outlivesThrough ($LS ($LS $LZ)) $Heap@6 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |x#0@@10| |mutexScope#0|))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |3756|
...
)))) (and (= $Heap@8 $Heap@9) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@9))) (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@6) (|_module.Universe.globalSequenceInv2#canCall| $Heap@6 $Heap@9 |universe#0|)) (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@6 $Heap@9 |universe#0|) (_module.Universe.globalSequenceInv2 $Heap@6 $Heap@9 |universe#0|))))))))) (and (=> (= (ControlFlow 0 2) (- 0 38)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 2) (- 0 37)) (forall (($o@@160 T@U) ($f@@98 T@U) ) (!  (=> (and (and (or (not (= $o@@160 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@160) alloc)))) (or (= $o@@160 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType $o@@160)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@160 $f@@98)))
 :qid |_12MutexLifetimelongdfy.1022:26|
 :skolemid |915|
))) (=> (forall (($o@@161 T@U) ($f@@99 T@U) ) (!  (=> (and (and (or (not (= $o@@161 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@161) alloc)))) (or (= $o@@161 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType $o@@161)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@161 $f@@99)))
 :qid |_12MutexLifetimelongdfy.1022:26|
 :skolemid |915|
)) (and (=> (= (ControlFlow 0 2) (- 0 36)) (=> (|_module.Universe.globalInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalInv $Heap@9 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@9 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalInv $Heap@9 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@9 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 35)) (=> (|_module.Universe.globalInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalInv $Heap@9 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@9 |universe#0|) (forall ((|o#0@@25| T@U) ) (!  (=> (and ($Is refType |o#0@@25| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@25|))) (and (and (and (= (_module.Object.universe |o#0@@25|) |universe#0|) (or (not (= |o#0@@25| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@9 |o#0@@25|)) (_module.Object.triggerAxioms $Heap@9 |o#0@@25|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
...
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalInv $Heap@9 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@9 |universe#0|) (forall ((|o#0@@26| T@U) ) (!  (=> (and ($Is refType |o#0@@26| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@26|))) (and (and (and (= (_module.Object.universe |o#0@@26|) |universe#0|) (or (not (= |o#0@@26| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@9 |o#0@@26|)) (_module.Object.triggerAxioms $Heap@9 |o#0@@26|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@9 |o#0@@26|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@9 |o#0@@26|))
 :pattern ( (_module.Object.universe |o#0@@26|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@26|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 34)) (=> (|_module.Universe.globalInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalInv $Heap@9 |universe#0|) (forall ((|o#1@@12| T@U) ) (!  (=> (and ($Is refType |o#1@@12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@12|))) (_module.Object.inv $Heap@9 |o#1@@12|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
...
))) (and (forall (($o@@163 T@U) ) (!  (=> (and (or (not (= $o@@163 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@163) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@163) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@163)) (or (= $o@@163 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType $o@@163)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@163))
)) ($HeapSucc $Heap@9 $Heap@10)))) (and (=> (= (ControlFlow 0 2) (- 0 32)) (or (not (= |scope#0| null)) (not true))) (=> ($IsAllocBox ($Box refType |scope#0|) Tclass._module.Lifetime? $Heap@10) (=> (and (|_module.Lifetime.deallocable#canCall| $Heap@10 |scope#0|) (|_module.Lifetime.deallocable#canCall| $Heap@10 |scope#0|)) (and (=> (= (ControlFlow 0 2) (- 0 31)) (=> (|_module.Lifetime.deallocable#canCall| $Heap@10 |scope#0|) (or (_module.Lifetime.deallocable $Heap@10 |scope#0|) (forall ((|o#29| T@U) ) (!  (=> (and ($Is refType |o#29| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |scope#0|) _module.Lifetime.elements)) ($Box refType |o#29|))) (not (_module.OwnedObject.alive $Heap@10 |o#29|)))
 :qid |_12MutexLifetimelongdfy.557:16|
 :skolemid |916|
 :pattern ( (_module.OwnedObject.alive $Heap@10 |o#29|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |scope#0|) _module.Lifetime.elements)) ($Box refType |o#29|)))
))))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (=> (|_module.Lifetime.deallocable#canCall| $Heap@10 |scope#0|) (or (_module.Lifetime.deallocable $Heap@10 |scope#0|) (forall ((|l#3@@2| T@U) ) (!  (=> (and ($Is refType |l#3@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |scope#0|) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@2|))) (not (_module.Lifetime.alive $Heap@10 |l#3@@2|)))
 :qid |_12MutexLifetimelongdfy.558:16|
 :skolemid |917|
 :pattern ( (_module.Lifetime.alive $Heap@10 |l#3@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |scope#0|) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@2|)))
))))) (=> (_module.Lifetime.deallocable $Heap@10 |scope#0|) (and (=> (= (ControlFlow 0 2) (- 0 29)) (or (not (= |scope#0| null)) (not true))) (=> (or (not (= |scope#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 28)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |scope#0| _module.Lifetime.owner))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |scope#0| _module.Lifetime.owner)) (=> (and (= $Heap@11 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@10 |scope#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |scope#0|) _module.Lifetime.owner ($Box refType null)))) ($IsGoodHeap $Heap@11)) (and (=> (= (ControlFlow 0 2) (- 0 27)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 26)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@10)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@10) (and (=> (= (ControlFlow 0 2) (- 0 25)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (forall ((|l#1@@9| T@U) ) (!  (=> (and ($Is refType |l#1@@9| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@9|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#1@@9|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |l#1@@9|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#1@@9|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |l#1@@9|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
...
))) (=> (forall ((|l#1@@10| T@U) ) (!  (=> (and ($Is refType |l#1@@10| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@10|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#1@@10|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |l#1@@10|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#1@@10|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |l#1@@10|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |l#1@@10|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#1@@10|) _module.Lifetime.mightPointTo)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |l#1@@10|) _module.Lifetime.mightPointFrom)))
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#1@@10|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@10|)))
)) (=> (and (and (and ($IsGoodHeap $Heap@12) ($IsHeapAnchor $Heap@12)) (forall ((|a#1@@9| T@U) (|b#1@@9| T@U) ) (!  (=> (and ($Is refType |a#1@@9| Tclass._module.Lifetime) ($Is refType |b#1@@9| Tclass._module.Lifetime)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |a#1@@9|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |b#1@@9|))) (and (|_module.Universe.outlives#canCall| $Heap@10 |universe#0| |a#1@@9| |b#1@@9|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@10 |universe#0| |a#1@@9| |b#1@@9|) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| |a#1@@9| |b#1@@9|)))))
 :qid |_12MutexLifetimelongdfy.202:20|
 :skolemid |1651|
...
)) (= $Heap@11 $Heap@12))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 22)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@10)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@10) (and (=> (= (ControlFlow 0 2) (- 0 21)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@10)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@10) (and (=> (= (ControlFlow 0 2) (- 0 20)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@10)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@10) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (forall ((|o#0@@27| T@U) ) (!  (=> (and ($Is refType |o#0@@27| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@27|))) (and (and (and (= (_module.Object.universe |o#0@@27|) |universe#0|) (or (not (= |o#0@@27| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@10 |o#0@@27|)) (_module.Object.triggerAxioms $Heap@10 |o#0@@27|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1350|
 :pattern ( (_module.Object.triggerAxioms $Heap@10 |o#0@@27|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@10 |o#0@@27|))
 :pattern ( (_module.Object.universe |o#0@@27|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@27|)))
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (forall ((|o#0@@28| T@U) ) (!  (=> (and ($Is refType |o#0@@28| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@28|))) (and (and (and (= (_module.Object.universe |o#0@@28|) |universe#0|) (or (not (= |o#0@@28| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@10 |o#0@@28|)) (_module.Object.triggerAxioms $Heap@10 |o#0@@28|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1350|
 :pattern ( (_module.Object.triggerAxioms $Heap@10 |o#0@@28|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@10 |o#0@@28|))
 :pattern ( (_module.Object.universe |o#0@@28|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@28|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@12 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@12 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@12 |universe#0|) (forall ((|o#1@@14| T@U) ) (!  (=> (and ($Is refType |o#1@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@14|))) (and (and (and (= (_module.Object.universe |o#1@@14|) |universe#0|) (or (not (= |o#1@@14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@12 |o#1@@14|)) (_module.Object.triggerAxioms $Heap@12 |o#1@@14|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@12 |o#1@@14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@12 |o#1@@14|))
 :pattern ( (_module.Object.universe |o#1@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@14|)))
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@12 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@12 |universe#0|) (forall ((|o#1@@15| T@U) ) (!  (=> (and ($Is refType |o#1@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@15|))) (and (and (and (= (_module.Object.universe |o#1@@15|) |universe#0|) (or (not (= |o#1@@15| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@12 |o#1@@15|)) (_module.Object.triggerAxioms $Heap@12 |o#1@@15|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1352|
 :pattern ( (_module.Object.triggerAxioms $Heap@12 |o#1@@15|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@12 |o#1@@15|))
...
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (forall ((|o#2@@2| T@U) ) (!  (=> (and ($Is refType |o#2@@2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@2|)))) (not ($IsAllocBox ($Box refType |o#2@@2|) Tclass._module.Object $Heap@10)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1354|
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@10 $Heap@12 |universe#0|) (forall ((|o#2@@3| T@U) ) (!  (=> (and ($Is refType |o#2@@3| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@3|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@3|)))) (not ($IsAllocBox ($Box refType |o#2@@3|) Tclass._module.Object $Heap@10)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |1354|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@3|)))
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@4| T@U) ) (!  (=> (and ($Is refType |o#3@@4| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@4|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@4|)))) (or (forall (($o@@164 T@U) ($f@@101 T@U) ) (!  (=> (or (not (= $o@@164 null)) (not true)) (=> (= $o@@164 |o#3@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@164) $f@@101) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@164) $f@@101))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1356|
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@5| T@U) ) (!  (=> (and ($Is refType |o#3@@5| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@5|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@5|)))) (or (forall (($o@@165 T@U) ($f@@102 T@U) ) (!  (=> (or (not (= $o@@165 null)) (not true)) (=> (= $o@@165 |o#3@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@165) $f@@102) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@165) $f@@102))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |1356|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@165) $f@@102))
)) (_module.Object.sequenceInv2 $Heap@10 $Heap@12 |o#3@@5|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |1357|
 :pattern ( (_module.Object.sequenceInv2 $Heap@10 $Heap@12 |o#3@@5|))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4@@5| T@U) ) (!  (=> (and ($Is refType |o#4@@5| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@5|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |o#4@@5|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |o#4@@5|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |o#4@@5|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@10)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |o#4@@5|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |o#4@@5|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |1358|
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@10 $Heap@12 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#0@@15| T@U) ) (!  (=> (and ($Is refType |l#0@@15| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@15|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#0@@15|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#0@@15|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@10)) (_module.Lifetime.unchangedNonvolatileFields $Heap@10 $Heap@12 |l#0@@15|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |1359|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@10 $Heap@12 |l#0@@15|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#0@@15|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |l#0@@15|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalInv $Heap@10 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalInv $Heap@10 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalInv $Heap@10 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (forall ((|o#5@@2| T@U) ) (!  (=> (and ($Is refType |o#5@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@2|))) (and (and (and (= (_module.Object.universe |o#5@@2|) |universe#0|) (or (not (= |o#5@@2| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@10 |o#5@@2|)) (_module.Object.triggerAxioms $Heap@10 |o#5@@2|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1364|
...
))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (=> (|_module.Universe.globalInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalInv $Heap@10 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@10 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@10 |universe#0|) (forall ((|o#5@@3| T@U) ) (!  (=> (and ($Is refType |o#5@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@3|))) (and (and (and (= (_module.Object.universe |o#5@@3|) |universe#0|) (or (not (= |o#5@@3| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@10 |o#5@@3|)) (_module.Object.triggerAxioms $Heap@10 |o#5@@3|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1364|
 :pattern ( (_module.Object.triggerAxioms $Heap@10 |o#5@@3|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@10 |o#5@@3|))
 :pattern ( (_module.Object.universe |o#5@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@3|)))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (forall ((|o#7@@1| T@U) ) (!  (=> (and ($Is refType |o#7@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@1|))) (and (or (forall (($o@@166 T@U) ($f@@103 T@U) ) (!  (=> (or (not (= $o@@166 null)) (not true)) (=> (= $o@@166 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@166) $f@@103) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@166) $f@@103))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@166) $f@@103))
)) (_module.Object.inv $Heap@12 |o#7@@1|)) (or (forall (($o@@167 T@U) ($f@@104 T@U) ) (!  (=> (or (not (= $o@@167 null)) (not true)) (=> (= $o@@167 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@167) $f@@104) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@167) $f@@104))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@167) $f@@104))
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (forall ((|o#7@@2| T@U) ) (!  (=> (and ($Is refType |o#7@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@2|))) (and (or (forall (($o@@168 T@U) ($f@@105 T@U) ) (!  (=> (or (not (= $o@@168 null)) (not true)) (=> (= $o@@168 |o#7@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@168) $f@@105) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@168) $f@@105))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1368|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@168) $f@@105))
)) (_module.Object.inv $Heap@12 |o#7@@2|)) (or (forall (($o@@169 T@U) ($f@@106 T@U) ) (!  (=> (or (not (= $o@@169 null)) (not true)) (=> (= $o@@169 |o#7@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@169) $f@@106) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@169) $f@@106))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |1369|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@169) $f@@106))
)) (_module.Object.inv2 $Heap@10 $Heap@12 |o#7@@2|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |1370|
 :pattern ( (_module.Object.inv2 $Heap@10 $Heap@12 |o#7@@2|))
 :pattern ( (_module.Object.inv $Heap@12 |o#7@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@2|)))
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@10 $Heap@12 |universe#0| |running#0@@3|) (forall ((|o#8@@4| T@U) ) (!  (=> (and ($Is refType |o#8@@4| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|))))) (_module.Object.inv $Heap@12 |o#8@@4|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |1371|
 :pattern ( (_module.Object.inv $Heap@12 |o#8@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|)))
)))) (=> (and ($IsGoodHeap $Heap@13) ($IsHeapAnchor $Heap@13)) (=> (and (and (and (|_module.Universe.globalInv#canCall| $Heap@12 |universe#0|) (=> (_module.Universe.globalInv $Heap@12 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@10 $Heap@12 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@12 |universe#0|) (and (_module.Universe.globalInv $Heap@12 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@12 |universe#0|) (forall ((|o#10@@1| T@U) ) (!  (=> (and ($Is refType |o#10@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@1|))) (_module.Object.inv $Heap@12 |o#10@@1|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1379|
...
)))) (= $Heap@12 $Heap@13))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |universe#0| null)) (not true))) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@13) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@10)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@10) (=> (|_module.Universe.globalSequenceInv2#canCall| $Heap@10 $Heap@13 |universe#0|) (=> (and (and (|_module.Universe.globalSequenceInv2#canCall| $Heap@10 $Heap@13 |universe#0|) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalSequenceInv2#canCall| $Heap@10 $Heap@13 |universe#0|)) (or (_module.Universe.globalSequenceInv2 $Heap@10 $Heap@13 |universe#0|) (forall ((|o#30| T@U) ) (!  (=> (and ($Is refType |o#30| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#30|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#30|)) (_module.Object.sequenceInv2 $Heap@10 $Heap@13 |o#30|)))
 :qid |_12MutexLifetimelongdfy.29:12|
 :skolemid |922|
 :pattern ( (_module.Object.sequenceInv2 $Heap@10 $Heap@13 |o#30|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#30|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |o#30|)))
)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
anon0_correct))
))
(check-sat)
