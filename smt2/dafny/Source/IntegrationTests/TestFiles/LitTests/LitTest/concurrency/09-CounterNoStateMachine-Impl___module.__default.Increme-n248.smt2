...
))))) (= $Heap@28 $Heap@29)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))))) (forall (($o@@170 T@U) ($f@@113 T@U) ) (!  (=> (and (and (or (not (= $o@@170 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@29 $o@@170) alloc)))) (or (= $o@@170 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@29 |universe#0|) _module.Universe.content)) ($Box refType $o@@170)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@170 $f@@113)))
