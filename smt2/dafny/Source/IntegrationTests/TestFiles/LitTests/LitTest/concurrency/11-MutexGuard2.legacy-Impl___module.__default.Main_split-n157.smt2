...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@88) ($IsHeapAnchor $Heap@@88)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@88))) (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@88)) (and (=> |defass#data#0| (and ($Is refType |data#0| Tclass._module.OwnedU32) ($IsAlloc refType |data#0| Tclass._module.OwnedU32 $Heap@@88))) true))) (and (and (and (=> |defass#mutex#0| (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@88))) true) (= 22 $FunctionContextHeight)) (and (and (|_module.Universe.globalInv#canCall| $Heap@@88 |universe#0|) (and (_module.Universe.globalInv $Heap@@88 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@88 |universe#0|) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |o#8|))) (_module.Object.inv $Heap@@88 |o#8|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |601|
...
))))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)) (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@88 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall (($o@@106 T@U) ($f@@62 T@U) ) (!  (=> (and (and (or (not (= $o@@106 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 $o@@106) alloc)))) (or (= $o@@106 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType $o@@106)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@106 $f@@62)))
 :qid |_11MutexGuard2legacydfy.707:24|
 :skolemid |613|
))) (=> (forall (($o@@107 T@U) ($f@@63 T@U) ) (!  (=> (and (and (or (not (= $o@@107 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 $o@@107) alloc)))) (or (= $o@@107 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType $o@@107)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@107 $f@@63)))
 :qid |_11MutexGuard2legacydfy.707:24|
 :skolemid |613|
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.globalInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalInv $Heap@@88 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@88 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalInv $Heap@@88 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@88 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Universe.globalInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalInv $Heap@@88 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@88 |universe#0|) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@13|))) (and (and (and (= (_module.Object.universe |o#0@@13|) |universe#0|) (or (not (= |o#0@@13| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@88 |o#0@@13|)) (_module.Object.triggerAxioms $Heap@@88 |o#0@@13|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |874|
...
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalInv $Heap@@88 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@88 |universe#0|) (forall ((|o#0@@14| T@U) ) (!  (=> (and ($Is refType |o#0@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|))) (and (and (and (= (_module.Object.universe |o#0@@14|) |universe#0|) (or (not (= |o#0@@14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@88 |o#0@@14|)) (_module.Object.triggerAxioms $Heap@@88 |o#0@@14|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |874|
 :pattern ( (_module.Object.triggerAxioms $Heap@@88 |o#0@@14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@88 |o#0@@14|))
 :pattern ( (_module.Object.universe |o#0@@14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Universe.globalInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalInv $Heap@@88 |universe#0|) (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@2|))) (_module.Object.inv $Heap@@88 |o#1@@2|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |876|
...
))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@@88 |universe#0|) (or (_module.Universe.globalInv $Heap@@88 |universe#0|) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@3|))) (_module.Object.inv $Heap@@88 |o#1@@3|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |876|
 :pattern ( (_module.Object.inv $Heap@@88 |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@3|)))
)))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@88 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
