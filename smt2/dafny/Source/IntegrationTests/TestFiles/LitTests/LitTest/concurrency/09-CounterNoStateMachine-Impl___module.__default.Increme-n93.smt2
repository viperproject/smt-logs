...
))))) (= $Heap@11 $Heap@12)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))) (forall (($o@@133 T@U) ($f@@82 T@U) ) (!  (=> (and (and (or (not (= $o@@133 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@133) alloc)))) (or (= $o@@133 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType $o@@133)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@133 $f@@82)))
