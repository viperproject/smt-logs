...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split121)
...
))))))))) (=> (and (and (and (and (and (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@1 |universe#0|) (and (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@1 |universe#0|) (and (and (and (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (_module.Universe.globalBaseInv $Heap@1 |universe#0|)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)))) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#6|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#6|)))) (not ($IsAllocBox ($Box refType |o#6|) Tclass._module.Object $Heap@0)))
 :qid |_11MutexGuard2legacydfy.45:16|
 :skolemid |501|
