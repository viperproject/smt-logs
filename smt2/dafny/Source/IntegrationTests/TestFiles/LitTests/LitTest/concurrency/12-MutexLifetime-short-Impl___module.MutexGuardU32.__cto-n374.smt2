...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split143)
...
)))) (= $Heap@11 $Heap@12)) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= |scope#0| null)) (not true)))))))
