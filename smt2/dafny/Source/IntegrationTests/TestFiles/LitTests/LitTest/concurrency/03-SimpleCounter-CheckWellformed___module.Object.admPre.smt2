...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@2 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Universe) ($IsAlloc refType this@@2 Tclass._module.Universe $h0)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@1 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@1) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@1) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@1) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |526|
)) (= (_module.Universe.legal0 $prevHeap@@0 $h0 this@@2) (_module.Universe.legal0 $prevHeap@@0 $h1 this@@2))))
...
(assert (forall (($prevHeap@@1 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this@@3 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Universe) ($IsAlloc refType this@@3 Tclass._module.Universe $h0@@0)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@2 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@2) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@2) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@2) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |552|
)) (= (_module.Universe.legal1 $prevHeap@@1 $h0@@0 this@@3) (_module.Universe.legal1 $prevHeap@@1 $h1@@0 this@@3))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |553|
...
(assert (forall (($prevHeap@@2 T@U) ($h0@@1 T@U) ($h1@@1 T@U) (this@@4 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Universe) ($IsAlloc refType this@@4 Tclass._module.Universe $h0@@1)))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@3 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@3) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@3) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@3) $f@@3)))
 :qid |unknown.0:0|
 :skolemid |563|
)) (= (_module.Universe.legal $prevHeap@@2 $h0@@1 this@@4) (_module.Universe.legal $prevHeap@@2 $h1@@1 this@@4))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |564|
...
(assert (forall (($prevHeap@@3 T@U) ($h0@@2 T@U) ($h1@@2 T@U) (this@@5 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.Object) ($IsAlloc refType this@@5 Tclass._module.Object $h0@@2)))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@4 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@4) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@4) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@4) $f@@4)))
 :qid |unknown.0:0|
 :skolemid |636|
)) (= (_module.Object.admPre $prevHeap@@3 $h0@@2 this@@5) (_module.Object.admPre $prevHeap@@3 $h1@@2 this@@5))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |637|
...
(assert (forall (($prevHeap@@4 T@U) ($h0@@3 T@U) ($h1@@3 T@U) (this@@6 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Object) ($IsAlloc refType this@@6 Tclass._module.Object $h0@@3)))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@5 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@5) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@5) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@5) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |668|
)) (= (_module.Object.i2 $prevHeap@@4 $h0@@3 this@@6) (_module.Object.i2 $prevHeap@@4 $h1@@3 this@@6))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |669|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@9 T@U) ($f@@6 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@9 $f@@6))  (=> (and (or (not (= $o@@9 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@9) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@9) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1119|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@9 $f@@6))
)))
...
))) (|_module.Object.i2#canCall| $prevHeap@@7 $Heap@@5 |o#0@@6|)) (=> (or (forall (($o@@13 T@U) ($f@@8 T@U) ) (!  (=> (or (not (= $o@@13 null)) (not true)) (=> (= $o@@13 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@13) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@7 $o@@13) $f@@8))))
 :qid |_03SimpleCounterdfy.44:45|
 :skolemid |535|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@13) $f@@8))
)) (_module.Object.i2 $prevHeap@@7 $Heap@@5 |o#0@@6|)) (=> (not (forall (($o@@14 T@U) ($f@@9 T@U) ) (!  (=> (or (not (= $o@@14 null)) (not true)) (=> (= $o@@14 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@14) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@7 $o@@14) $f@@9))))
 :qid |_03SimpleCounterdfy.44:45|
 :skolemid |534|
...
)) (_module.Object.i2 $prevHeap@@7 $Heap@@5 |o#0@@7|)) (or (forall (($o@@16 T@U) ($f@@11 T@U) ) (!  (=> (or (not (= $o@@16 null)) (not true)) (=> (= $o@@16 |o#0@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@16) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@7 $o@@16) $f@@11))))
 :qid |_03SimpleCounterdfy.44:45|
 :skolemid |531|
...
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@11 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@18 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (or (= $o@@18 this@@11) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@11) _module.Universe.content)) ($Box refType $o@@18)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@18) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@18) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |490|
)) (= (_module.Universe.i0 $h0@@4 this@@11) (_module.Universe.i0 $h1@@4 this@@11))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |492|
...
(assert (forall (($h0@@5 T@U) ($h1@@5 T@U) (this@@12 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Universe) ($IsAlloc refType this@@12 Tclass._module.Universe $h0@@5)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@19 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@19) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@19) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@19) $f@@13)))
 :qid |unknown.0:0|
 :skolemid |502|
)) (= (_module.Universe.i $h0@@5 this@@12) (_module.Universe.i $h1@@5 this@@12))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |503|
...
(assert (forall (($h0@@6 T@U) ($h1@@6 T@U) (this@@13 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Object) ($IsAlloc refType this@@13 Tclass._module.Object $h0@@6)))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@20 T@U) ($f@@14 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@20) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@20) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@20) $f@@14)))
 :qid |unknown.0:0|
 :skolemid |619|
)) (= (_module.Object.i0 $h0@@6 this@@13) (_module.Object.i0 $h1@@6 this@@13))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |620|
...
(assert (forall (($h0@@7 T@U) ($h1@@7 T@U) (this@@14 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Object) ($IsAlloc refType this@@14 Tclass._module.Object $h0@@7)))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@21 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@21) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@21) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@21) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |664|
)) (= (_module.Object.i $h0@@7 this@@14) (_module.Object.i $h1@@7 this@@14))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |665|
...
(set-info :boogie-vc-id CheckWellformed$$_module.Object.admPre)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon10_correct  (=> (= (_module.Object.admPre $Heap@@7 current$Heap this@@15)  (and (and (and (_module.Object.i0 current$Heap this@@15) (and (_module.Object.i0 $Heap@@7 this@@15) (_module.Universe.i $Heap@@7 (_module.Object.universe this@@15)))) (forall (($o@@26 T@U) ($f@@16 T@U) ) (!  (=> (or (not (= $o@@26 null)) (not true)) (=> (= $o@@26 this@@15) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@26) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@26) $f@@16))))
 :qid |_03SimpleCounterdfy.87:78|
 :skolemid |648|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@26) $f@@16))
))) (_module.Universe.legal $Heap@@7 current$Heap (_module.Object.universe this@@15)))) (=> (and (and (|_module.Object.i0#canCall| current$Heap this@@15) (=> (_module.Object.i0 current$Heap this@@15) (and (and (|_module.Object.i0#canCall| $Heap@@7 this@@15) (=> (_module.Object.i0 $Heap@@7 this@@15) (|_module.Universe.i#canCall| $Heap@@7 (_module.Object.universe this@@15)))) (=> (and (_module.Object.i0 $Heap@@7 this@@15) (_module.Universe.i $Heap@@7 (_module.Object.universe this@@15))) (=> (forall (($o@@27 T@U) ($f@@17 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 this@@15) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@27) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@27) $f@@17))))
 :qid |_03SimpleCounterdfy.87:78|
 :skolemid |649|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@27) $f@@17))
)) (|_module.Universe.legal#canCall| $Heap@@7 current$Heap (_module.Object.universe this@@15))))))) ($Is boolType (bool_2_U (_module.Object.admPre $Heap@@7 current$Heap this@@15)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))))
(let ((anon16_Else_correct  (=> (not (and (and (_module.Object.i0 current$Heap this@@15) (and (_module.Object.i0 $Heap@@7 this@@15) (_module.Universe.i $Heap@@7 (_module.Object.universe this@@15)))) (forall (($o@@28 T@U) ($f@@18 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 this@@15) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@28) $f@@18))))
 :qid |_03SimpleCounterdfy.87:78|
 :skolemid |646|
...
(let ((anon16_Then_correct  (=> (and (and (_module.Object.i0 current$Heap this@@15) (and (_module.Object.i0 $Heap@@7 this@@15) (_module.Universe.i $Heap@@7 (_module.Object.universe this@@15)))) (forall (($o@@29 T@U) ($f@@19 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 this@@15) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@29) $f@@19))))
 :qid |_03SimpleCounterdfy.87:78|
 :skolemid |646|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@19))
))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= (_module.Object.universe this@@15) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@15) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@15)) Tclass._module.Universe? current$Heap) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType (_module.Object.universe this@@15) Tclass._module.Universe $Heap@@7)) (=> ($IsAlloc refType (_module.Object.universe this@@15) Tclass._module.Universe $Heap@@7) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@30 T@U) ($f@@20 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@30) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@30) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@30 $f@@20)))
 :qid |_03SimpleCounterdfy.87:106|
 :skolemid |645|
))) (|_module.Universe.legal#canCall| $Heap@@7 current$Heap (_module.Object.universe this@@15))) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon10_correct)))))))))
(let ((anon15_Else_correct  (=> (and (not (and (_module.Object.i0 current$Heap this@@15) (and (_module.Object.i0 $Heap@@7 this@@15) (_module.Universe.i $Heap@@7 (_module.Object.universe this@@15))))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 12) 6) anon16_Then_correct) (=> (= (ControlFlow 0 12) 9) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (_module.Object.i0 current$Heap this@@15) (and (_module.Object.i0 $Heap@@7 this@@15) (_module.Universe.i $Heap@@7 (_module.Object.universe this@@15)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@7)) (=> ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@7) (=> (and (= |b$reqreads#1@0| (forall (($o@@31 T@U) ($f@@21 T@U) ) (!  (=> (and (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@31) alloc)))) (= $o@@31 this@@15)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@31 $f@@21)))
 :qid |_03SimpleCounterdfy.87:88|
 :skolemid |644|
))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 10) 6) anon16_Then_correct) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct))))))))
(let ((anon14_Else_correct  (=> (not (_module.Object.i0 $Heap@@7 this@@15)) (and (=> (= (ControlFlow 0 18) 10) anon15_Then_correct) (=> (= (ControlFlow 0 18) 12) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (_module.Object.i0 $Heap@@7 this@@15) (and (=> (= (ControlFlow 0 14) (- 0 17)) ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@7)) (=> ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@7) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= (_module.Object.universe this@@15) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@15) null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType (_module.Object.universe this@@15) Tclass._module.Universe $Heap@@7)) (=> ($IsAlloc refType (_module.Object.universe this@@15) Tclass._module.Universe $Heap@@7) (=> (|_module.Universe.i#canCall| $Heap@@7 (_module.Object.universe this@@15)) (and (=> (= (ControlFlow 0 14) 10) anon15_Then_correct) (=> (= (ControlFlow 0 14) 12) anon15_Else_correct))))))))))))
(let ((anon13_Then_correct  (=> (_module.Object.i0 current$Heap this@@15) (and (=> (= (ControlFlow 0 19) (- 0 20)) ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@7)) (=> ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@7) (=> (|_module.Object.i0#canCall| $Heap@@7 this@@15) (and (=> (= (ControlFlow 0 19) 14) anon14_Then_correct) (=> (= (ControlFlow 0 19) 18) anon14_Else_correct))))))))
(let ((anon13_Else_correct  (=> (not (_module.Object.i0 current$Heap this@@15)) (and (=> (= (ControlFlow 0 13) 10) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon12_Else_correct  (=> ($IsAllocBox ($Box refType this@@15) Tclass._module.Object? current$Heap) (=> (and (= |b$reqreads#0@0| (forall (($o@@32 T@U) ($f@@22 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@22)))
 :qid |_03SimpleCounterdfy.87:41|
 :skolemid |643|
))) (|_module.Object.i0#canCall| current$Heap this@@15)) (and (=> (= (ControlFlow 0 21) 19) anon13_Then_correct) (=> (= (ControlFlow 0 21) 13) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 22) 1) anon12_Then_correct) (=> (= (ControlFlow 0 22) 21) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Object) ($IsAlloc refType this@@15 Tclass._module.Object previous$Heap))) (= 9 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@7) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 23) 22))) anon0_correct))))
