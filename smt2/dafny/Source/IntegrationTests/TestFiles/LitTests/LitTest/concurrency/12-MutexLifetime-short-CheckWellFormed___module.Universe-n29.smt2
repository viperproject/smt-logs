...
(assert (distinct TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.Lifetime class._module.Universe? Tagclass._module.Lifetime? class._module.Lifetime? tytagFamily$Universe tytagFamily$Object tytagFamily$Lifetime field$content field$mightPointTo field$mightPointFrom)
)
(assert (= (FDim alloc) 0))
