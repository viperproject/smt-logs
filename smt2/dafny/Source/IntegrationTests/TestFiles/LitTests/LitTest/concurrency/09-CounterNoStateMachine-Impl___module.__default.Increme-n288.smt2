...
))) (and ($HeapSucc $Heap@32 $Heap@33) (U_2_bool (Lit boolType (bool_2_U false))))) (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|) ($IsAllocBox ($Box refType |running#0@@3|) Tclass._module.Object? $Heap@33)) (and (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|) (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|))) (and (and (_module.Object.triggerAxioms $Heap@33 |running#0@@3|) (or (not (= |remaining#0| null)) (not true))) (and (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |remaining#0| _module.Integer.value)) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= |remaining#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
