...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@6 this@@6) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@6 this@@6) (_module.OwnedObject.inv $Heap@@6 this@@6)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1474|
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@11 this@@11) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Universe) ($IsAlloc refType this@@11 Tclass._module.Universe $Heap@@11)))))) (and (forall ((|o#0@@1| T@U) ) (!  (=> ($Is refType |o#0@@1| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@11) _module.Universe.content)) ($Box refType |o#0@@1|)) (=> (= (_module.Object.universe |o#0@@1|) this@@11) (=> (or (not (= |o#0@@1| this@@11)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@11 |o#0@@1|) (=> (_module.Object.baseFieldsInv $Heap@@11 |o#0@@1|) (|_module.Object.triggerAxioms#canCall| $Heap@@11 |o#0@@1|)))))))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@11) _module.Universe.content)) ($Box refType |o#0@@1|)))
)) (= (_module.Universe.globalBaseInv $Heap@@11 this@@11) (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@11) _module.Universe.content)) ($Box refType |o#0@@2|))) (and (and (and (= (_module.Object.universe |o#0@@2|) this@@11) (or (not (= |o#0@@2| this@@11)) (not true))) (_module.Object.baseFieldsInv $Heap@@11 |o#0@@2|)) (_module.Object.triggerAxioms $Heap@@11 |o#0@@2|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@11) _module.Universe.content)) ($Box refType |o#0@@2|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@11 this@@11) ($IsGoodHeap $Heap@@11))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@12 this@@12) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Object) ($IsAlloc refType this@@12 Tclass._module.Object $Heap@@12)))))) (_module.Object.triggerAxioms $Heap@@12 this@@12))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1064|
 :pattern ( (_module.Object.triggerAxioms $Heap@@12 this@@12))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@13 this@@13) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.OwnedObject) ($IsAlloc refType this@@13 Tclass._module.OwnedObject $Heap@@13)))))) (=> (_module.OwnedObject.userInv $Heap@@13 this@@13) (_module.OwnedObject.localUserInv $Heap@@13 this@@13)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1549|
 :pattern ( (_module.OwnedObject.userInv $Heap@@13 this@@13))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@14 this@@14) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Thread) ($IsAlloc refType this@@14 Tclass._module.Thread $Heap@@14)))))) (=> (_module.Thread.localInv $Heap@@14 this@@14) (_module.Object.objectGlobalBaseInv $Heap@@14 this@@14)))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1203|
 :pattern ( (_module.Thread.localInv $Heap@@14 this@@14))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@15 this@@15) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.OwnedObject) ($IsAlloc refType this@@15 Tclass._module.OwnedObject $Heap@@15)))))) (=> (_module.OwnedObject.localInv $Heap@@15 this@@15) (_module.Object.objectGlobalBaseInv $Heap@@15 this@@15)))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1458|
 :pattern ( (_module.OwnedObject.localInv $Heap@@15 this@@15))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@16 this@@16) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.Object) ($IsAlloc refType this@@16 Tclass._module.Object $Heap@@16)))))) (=> (_module.Object.localInv $Heap@@16 this@@16) (_module.Object.objectGlobalBaseInv $Heap@@16 this@@16)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1116|
 :pattern ( (_module.Object.localInv $Heap@@16 this@@16))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@17 this@@17) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Thread) ($IsAlloc refType this@@17 Tclass._module.Thread $Heap@@17)))))) (=> (_module.Thread.inv $Heap@@17 this@@17) (_module.Thread.localInv $Heap@@17 this@@17)))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1215|
 :pattern ( (_module.Thread.inv $Heap@@17 this@@17))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@18 this@@18) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.OwnedObject) ($IsAlloc refType this@@18 Tclass._module.OwnedObject $Heap@@18)))))) (=> (_module.OwnedObject.inv $Heap@@18 this@@18) (_module.OwnedObject.localInv $Heap@@18 this@@18)))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1471|
 :pattern ( (_module.OwnedObject.inv $Heap@@18 this@@18))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@19 this@@19) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Object) ($IsAlloc refType this@@19 Tclass._module.Object $Heap@@19)))))) (=> (_module.Object.inv $Heap@@19 this@@19) (_module.Object.localInv $Heap@@19 this@@19)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1126|
 :pattern ( (_module.Object.inv $Heap@@19 this@@19))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@20 this@@20) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Thread) ($IsAlloc refType this@@20 Tclass._module.Thread $Heap@@20)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@20)) (= (_module.Thread.localInv $Heap@@20 this@@20)  (and true (_module.Object.objectGlobalBaseInv $Heap@@20 this@@20)))))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1205|
 :pattern ( (_module.Thread.localInv $Heap@@20 this@@20) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@21 this@@21) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Thread) ($IsAlloc refType this@@21 Tclass._module.Thread $Heap@@21)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@21 this@@21)) (= (_module.Thread.inv $Heap@@21 this@@21)  (and true (_module.Thread.localInv $Heap@@21 this@@21)))))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1217|
 :pattern ( (_module.Thread.inv $Heap@@21 this@@21) ($IsGoodHeap $Heap@@21))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon8_correct  (=> (= (_module.Universe.globalInv $Heap@@23 this@@23)  (and (_module.Universe.globalBaseInv $Heap@@23 this@@23) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType |o#2|))) (_module.Object.inv $Heap@@23 |o#2|))
 :qid |_10SequenceInvariantdfy.22:32|
 :skolemid |630|
 :pattern ( (_module.Object.inv $Heap@@23 |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType |o#2|)))
)))) (=> (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@@23 this@@23) (=> (_module.Universe.globalBaseInv $Heap@@23 this@@23) (forall ((|o#2@@0| T@U) ) (!  (=> ($Is refType |o#2@@0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType |o#2@@0|)) (|_module.Object.inv#canCall| $Heap@@23 |o#2@@0|)))
 :qid |_10SequenceInvariantdfy.22:32|
 :skolemid |631|
 :pattern ( (_module.Object.inv $Heap@@23 |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))) ($Is boolType (bool_2_U (_module.Universe.globalInv $Heap@@23 this@@23)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@2|) (=> |b$reqreads#1@2| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@2|)))))))))
(let ((anon7_correct  (=> (= |b$reqreads#2@2| |b$reqreads#2@1|) (=> (and (= |b$reqreads#1@2| |b$reqreads#1@1|) (= (ControlFlow 0 7) 3)) anon8_correct))))
(let ((anon13_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType |o#1@0|))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 11) 7))) anon7_correct)))
(let ((anon13_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@23) (= |b$reqreads#2@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_10SequenceInvariantdfy.22:62|
 :skolemid |628|
)))) (=> (and (and (|_module.Object.inv#canCall| $Heap@@23 |o#1@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 9) 7))) anon7_correct)))))))
(let ((anon12_Then_correct  (=> (and (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@23)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@23 _module.Universe.content)))) (and (=> (= (ControlFlow 0 12) 9) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@23))) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 8) 7))) anon7_correct)))
(let ((anon11_Then_correct  (=> (_module.Universe.globalBaseInv $Heap@@23 this@@23) (and (=> (= (ControlFlow 0 13) 12) anon12_Then_correct) (=> (= (ControlFlow 0 13) 8) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (and (not (_module.Universe.globalBaseInv $Heap@@23 this@@23)) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#1@2| true) (= (ControlFlow 0 6) 3))) anon8_correct)))
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@23) Tclass._module.Universe? $Heap@@23) (=> (and (= |b$reqreads#0@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@19) alloc)))) (or (= $o@@19 this@@23) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType $o@@19)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_10SequenceInvariantdfy.22:5|
 :skolemid |627|
))) (|_module.Universe.globalBaseInv#canCall| $Heap@@23 this@@23)) (and (=> (= (ControlFlow 0 14) 13) anon11_Then_correct) (=> (= (ControlFlow 0 14) 6) anon11_Else_correct))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@23 alloc $Heap@@23 alloc)) (and (=> (= (ControlFlow 0 15) 1) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@23) ($IsHeapAnchor $Heap@@23)) (=> (and (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Universe) ($IsAlloc refType this@@23 Tclass._module.Universe $Heap@@23))) (and (= 11 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
