...
))))) (and (= (_module.Object.universe call5formal@this@0) |universe#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 call5formal@this@0) _module.OwnedObject.owner)) |running#0@@3|))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 call5formal@this@0) _module.ClaimIncreasingCounterGreaterThanConstant.counter)) |counter#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 call5formal@this@0) _module.ClaimIncreasingCounterGreaterThanConstant.constant)) call4formal@this@0)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 call5formal@this@0) alloc))))))))) (and (and (and (and (and (forall (($o@@127 T@U) ) (!  (=> (and (or (not (= $o@@127 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@127) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@127) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@127)) (= $o@@127 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.657:3|
 :skolemid |3168|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@127))
)) ($HeapSucc $Heap@9 $Heap@10)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@4))) (and (and ($IsGoodHeap $Heap@11) ($IsHeapAnchor $Heap@11)) (forall ((|o#1@@12| T@U) ) (!  (=> ($Is refType |o#1@@12| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@12|)) (=> (=> ($Is refType |o#1@@12| Tclass._module.OwnedObject) (and (forall (($o@@128 T@U) ($f@@77 T@U) ) (!  (=> (or (not (= $o@@128 null)) (not true)) (=> (= $o@@128 |o#1@@12|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@128) $f@@77) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@128) $f@@77))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
