...
(assert (forall (($h@@30 T@U) ($o@@61 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@30) (and (or (not (= $o@@61 null)) (not true)) ($Is refType $o@@61 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@61) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@61) _module.OwnedObject.nonvolatileVersion)) TInt $h@@30))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1290|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@61) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h@@31 T@U) ($o@@62 T@U) ) (!  (=> (and ($IsGoodHeap $h@@31) (and (or (not (= $o@@62 null)) (not true)) (= (dtype $o@@62) Tclass._module.AtomicCounter?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@62) _module.AtomicCounter.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1648|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@62) _module.AtomicCounter.value)))
)))
(assert (forall (($h@@32 T@U) ($o@@63 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (or (not (= $o@@63 null)) (not true)) (= (dtype $o@@63) Tclass._module.Remaining?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@63) _module.Remaining.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1886|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@63) _module.Remaining.value)))
)))
(assert (forall (($h@@33 T@U) ($o@@64 T@U) ) (!  (=> (and ($IsGoodHeap $h@@33) (and (or (not (= $o@@64 null)) (not true)) (= (dtype $o@@64) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@64) _module.IncrementerMethod.programCounter)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2124|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@64) _module.IncrementerMethod.programCounter)))
)))
(assert (forall (($h@@34 T@U) ($o@@65 T@U) ) (!  (=> (and ($IsGoodHeap $h@@34) (and (or (not (= $o@@65 null)) (not true)) (= (dtype $o@@65) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@65) _module.IncrementerMethod.initial__value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2130|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@34 $o@@65) _module.IncrementerMethod.initial__value)))
)))
(assert (forall (($h@@35 T@U) ($o@@66 T@U) ) (!  (=> (and ($IsGoodHeap $h@@35) (and (or (not (= $o@@66 null)) (not true)) (= (dtype $o@@66) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@66) _module.IncrementerMethod.final__value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2132|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@35 $o@@66) _module.IncrementerMethod.final__value)))
)))
(assert (forall (($h@@36 T@U) ($o@@67 T@U) ) (!  (=> (and ($IsGoodHeap $h@@36) (and (or (not (= $o@@67 null)) (not true)) (= (dtype $o@@67) Tclass._module.IncrementerMethod?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@67) _module.IncrementerMethod.i)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2134|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@36 $o@@67) _module.IncrementerMethod.i)))
)))
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@91 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@91 null)) (not true)) ($Is refType this@@91 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@68 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@68 null)) (not true)) (or (= $o@@68 this@@91) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 this@@91) _module.Universe.content)) ($Box refType $o@@68)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@68) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@68) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |494|
...
(assert (forall (($h@@37 T@U) ($o@@69 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@37) (and (or (not (= $o@@69 null)) (not true)) ($Is refType $o@@69 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@69) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@69) _module.OwnedObject.owner)) Tclass._module.Object $h@@37))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1292|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@69) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@93 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.Universe) ($IsAlloc refType this@@93 Tclass._module.Universe $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@70 T@U) ($f@@33 T@U) ) (!  (=> (and (or (not (= $o@@70 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@70) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@70) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@70) $f@@33)))
 :qid |unknown.0:0|
 :skolemid |502|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@94 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@94 null)) (not true)) (and ($Is refType this@@94 Tclass._module.Object) ($IsAlloc refType this@@94 Tclass._module.Object $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@71 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@71 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@71) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@71) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@71) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |967|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@95 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@95 null)) (not true)) (and ($Is refType this@@95 Tclass._module.Object) ($IsAlloc refType this@@95 Tclass._module.Object $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@72 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@72 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@72) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@72) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@72) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |1001|
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@96 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@96 null)) (not true)) (and ($Is refType this@@96 Tclass._module.Object) ($IsAlloc refType this@@96 Tclass._module.Object $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@73 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@73) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@73) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@73) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |1017|
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@97 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.Object) ($IsAlloc refType this@@97 Tclass._module.Object $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@74 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@74) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@74) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@74) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1025|
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@98 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@98 null)) (not true)) (and ($Is refType this@@98 Tclass._module.Thread) ($IsAlloc refType this@@98 Tclass._module.Thread $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@75 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@75) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@75) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@75) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1084|
...
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@99 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@99 null)) (not true)) (and ($Is refType this@@99 Tclass._module.Thread) ($IsAlloc refType this@@99 Tclass._module.Thread $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@76 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@76) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@76) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@76) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1092|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@100 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@100 null)) (not true)) (and ($Is refType this@@100 Tclass._module.OwnedObject) ($IsAlloc refType this@@100 Tclass._module.OwnedObject $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@77 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@77 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@77) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@77) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@77) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1299|
...
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@101 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@101 null)) (not true)) (and ($Is refType this@@101 Tclass._module.OwnedObject) ($IsAlloc refType this@@101 Tclass._module.OwnedObject $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@78 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@78) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@78) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@78) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1309|
...
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@102 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@102 null)) (not true)) (and ($Is refType this@@102 Tclass._module.OwnedObject) ($IsAlloc refType this@@102 Tclass._module.OwnedObject $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@79 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@79) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@79) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@79) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1385|
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@103 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@103 null)) (not true)) (and ($Is refType this@@103 Tclass._module.OwnedObject) ($IsAlloc refType this@@103 Tclass._module.OwnedObject $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@80 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@80) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@80) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@80) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1389|
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@104 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@104 null)) (not true)) (and ($Is refType this@@104 Tclass._module.OwnedObject) ($IsAlloc refType this@@104 Tclass._module.OwnedObject $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@81 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@81) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@81) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@81) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1397|
...
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@105 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@105 null)) (not true)) (and ($Is refType this@@105 Tclass._module.AtomicCounter) ($IsAlloc refType this@@105 Tclass._module.AtomicCounter $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@82 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@82) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@82) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@82) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1665|
...
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@106 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@106 null)) (not true)) (and ($Is refType this@@106 Tclass._module.AtomicCounter) ($IsAlloc refType this@@106 Tclass._module.AtomicCounter $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@83 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@83) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@83) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@83) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |1672|
...
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@107 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@107 null)) (not true)) (and ($Is refType this@@107 Tclass._module.AtomicCounter) ($IsAlloc refType this@@107 Tclass._module.AtomicCounter $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@84 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@84) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@84) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |1679|
...
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@108 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@108 null)) (not true)) (and ($Is refType this@@108 Tclass._module.Remaining) ($IsAlloc refType this@@108 Tclass._module.Remaining $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@85 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@85 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@85) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@85) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@85) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |1903|
...
(assert (forall (($h0@@42 T@U) ($h1@@42 T@U) (this@@109 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@42) ($IsGoodHeap $h1@@42)) (and (or (not (= this@@109 null)) (not true)) (and ($Is refType this@@109 Tclass._module.Remaining) ($IsAlloc refType this@@109 Tclass._module.Remaining $h0@@42)))) (and ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42))) (=> (forall (($o@@86 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@86 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@86) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@86) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@42 $o@@86) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |1910|
...
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@110 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@110 null)) (not true)) (and ($Is refType this@@110 Tclass._module.Remaining) ($IsAlloc refType this@@110 Tclass._module.Remaining $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@87 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@87 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@87) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@87) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@87) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |1917|
...
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@111 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@111 null)) (not true)) (and ($Is refType this@@111 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@111 Tclass._module.IncrementerMethod $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@88 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@88) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@88) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |2151|
...
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@112 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@112 null)) (not true)) (and ($Is refType this@@112 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@112 Tclass._module.IncrementerMethod $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@89 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@89 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@89) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@89) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@89) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |2158|
...
(assert (forall (($h0@@46 T@U) ($h1@@46 T@U) (this@@113 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@46) ($IsGoodHeap $h1@@46)) (and (or (not (= this@@113 null)) (not true)) (and ($Is refType this@@113 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@113 Tclass._module.IncrementerMethod $h0@@46)))) (and ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46))) (=> (forall (($o@@90 T@U) ($f@@53 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@90) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@46 $o@@90) $f@@53)))
 :qid |unknown.0:0|
 :skolemid |2165|
...
(assert (forall (($o@@93 T@U) ) (!  (=> ($Is refType $o@@93 Tclass._module.AtomicCounter?) ($Is refType $o@@93 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3530|
 :pattern ( ($Is refType $o@@93 Tclass._module.AtomicCounter?))
)))
...
(assert (forall (($o@@94 T@U) ) (!  (=> ($Is refType $o@@94 Tclass._module.Remaining?) ($Is refType $o@@94 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3534|
 :pattern ( ($Is refType $o@@94 Tclass._module.Remaining?))
)))
...
(assert (forall (($o@@95 T@U) ) (!  (=> ($Is refType $o@@95 Tclass._module.IncrementerMethod?) ($Is refType $o@@95 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3538|
 :pattern ( ($Is refType $o@@95 Tclass._module.IncrementerMethod?))
)))
...
(assert (= (Tag Tclass._module.IncrementerMethod) Tagclass._module.IncrementerMethod))
(assert (= (TagFamily Tclass._module.IncrementerMethod) tytagFamily$IncrementerMethod))
(assert (forall (($h@@38 T@U) ($o@@96 T@U) ) (!  (=> (and ($IsGoodHeap $h@@38) (and (or (not (= $o@@96 null)) (not true)) ($Is refType $o@@96 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@96) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1291|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@38 $o@@96) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h@@39 T@U) ($o@@100 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@39) (and (or (not (= $o@@100 null)) (not true)) ($Is refType $o@@100 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@100) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@100) _module.Universe.content)) (TSet Tclass._module.Object) $h@@39))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@39 $o@@100) _module.Universe.content)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@101 T@U) ($f@@54 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#162| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@101 $f@@54))  (=> (and (or (not (= $o@@101 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@101) |l#2|)))) (or (= $o@@101 |l#3|) (= $o@@101 |l#4|))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3545|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#162| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@101 $f@@54))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.IncrementerMethod.Statement7)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#162| null $Heap@@78 alloc this@@126 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.remaining)))) ($IsAllocBox ($Box refType this@@126) Tclass._module.Object? $Heap@@78)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@@78 this@@126) (_module.Object.objectGlobalInv $Heap@@78 this@@126))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 7))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@103 T@U) ) (!  (=> (and (or (not (= $o@@103 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@103) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@103) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@103)) (or (= $o@@103 this@@126) (= $o@@103 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.remaining))))))
 :qid |_07CounterThreadOwnershipdfy.895:10|
 :skolemid |3134|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@103))
))) (and (and ($HeapSucc $Heap@@78 $Heap@0) ($IsAllocBox ($Box refType this@@126) Tclass._module.Object? $Heap@0)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (_module.Object.objectGlobalInv $Heap@0 this@@126)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@126)) Tclass._module.Universe? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78)) (=> ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78) (=> (and (and (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@0 (_module.Object.universe this@@126)) (_module.Universe.globalInv2 $Heap@@78 $Heap@0 (_module.Object.universe this@@126))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 8)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> (and ($IsAllocBox ($Box refType (_module.Object.universe this@@126)) Tclass._module.Universe? $Heap@0) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78)) (=> ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@78)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@78) ($IsHeapAnchor $Heap@@78)) (and (or (not (= this@@126 null)) (not true)) (and ($Is refType this@@126 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@126 Tclass._module.IncrementerMethod $Heap@@78)))) (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@78)) (and (= 15 $FunctionContextHeight) (= (ControlFlow 0 8) 2)))) anon0_correct)))
