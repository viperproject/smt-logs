...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split47)
...
))) (and ($HeapSucc $Heap@3 $Heap@4) (or (not (= |call4formal@guard#0@0| null)) (not true)))) (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex)) null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true))) (and (= |b#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedU32.value)))) (= (ControlFlow 0 2) (- 0 1)))))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
