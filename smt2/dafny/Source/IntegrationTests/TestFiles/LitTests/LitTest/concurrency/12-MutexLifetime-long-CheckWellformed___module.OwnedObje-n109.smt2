...
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@16 this@@19) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.OwnedObject) ($IsAlloc refType this@@19 Tclass._module.OwnedObject $Heap@@16)))))) (=> (_module.OwnedObject.userInv $Heap@@16 this@@19) (_module.OwnedObject.localUserInv $Heap@@16 this@@19)))
 :qid |_12MutexLifetimelongdfy.523:19|
 :skolemid |2243|
 :pattern ( (_module.OwnedObject.userInv $Heap@@16 this@@19))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@17 this@@20) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.OwnedObject) ($IsAlloc refType this@@20 Tclass._module.OwnedObject $Heap@@17)))))) (=> (_module.OwnedObject.inv $Heap@@17 this@@20) (_module.OwnedObject.localInv $Heap@@17 this@@20)))
 :qid |_12MutexLifetimelongdfy.449:19|
 :skolemid |2163|
 :pattern ( (_module.OwnedObject.inv $Heap@@17 this@@20))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@21 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@21)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@21)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimelongdfy.362:18|
 :weight 3
 :skolemid |1854|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@21)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@22 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@22)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@22)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimelongdfy.425:18|
 :weight 3
 :skolemid |2118|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@22)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@23 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@23)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@23)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimelongdfy.562:18|
 :weight 3
 :skolemid |2294|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@23)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@18 this@@31) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Lifetime) ($IsAlloc refType this@@31 Tclass._module.Lifetime $Heap@@18)))))) (= (_module.Lifetime.alive $Heap@@18 this@@31)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 this@@31) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@18 this@@31) ($IsGoodHeap $Heap@@18))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@19 this@@32) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.Lifetime) ($IsAlloc refType this@@32 Tclass._module.Lifetime $Heap@@19)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@19 this@@32)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 this@@32) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 (_module.Object.universe this@@32)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 this@@32) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 this@@32) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 (_module.Object.universe this@@32)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 this@@32) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 (_module.Object.universe this@@32)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 this@@32) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 (_module.Object.universe this@@32)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@19 this@@32) ($IsGoodHeap $Heap@@19))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 6) (- 0 12)) (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@33) (or (_module.Object.objectGlobalBaseInv $Heap@@20 this@@33) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 (_module.Object.universe this@@33)) _module.Universe.content)) ($Box refType this@@33)))))))) (=> (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@33) (or (_module.Object.objectGlobalBaseInv $Heap@@20 this@@33) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 (_module.Object.universe this@@33)) _module.Universe.content)) ($Box refType this@@33))))))) (and (=> (= (ControlFlow 0 6) (- 0 11)) (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@33) (or (_module.Object.objectGlobalBaseInv $Heap@@20 this@@33) (_module.Object.baseFieldsInv $Heap@@20 this@@33))))))) (=> (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@33) (or (_module.Object.objectGlobalBaseInv $Heap@@20 this@@33) (_module.Object.baseFieldsInv $Heap@@20 this@@33)))))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@33) (or (_module.Object.objectGlobalBaseInv $Heap@@20 this@@33) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@20 (_module.Object.universe this@@33)) (or (_module.Universe.globalBaseInv $Heap@@20 (_module.Object.universe this@@33)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@33) (or (_module.Object.objectGlobalBaseInv $Heap@@20 this@@33) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@20 (_module.Object.universe this@@33)) (or (_module.Universe.globalBaseInv $Heap@@20 (_module.Object.universe this@@33)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@33) (or (_module.Object.objectGlobalBaseInv $Heap@@20 this@@33) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@20 (_module.Object.universe this@@33)) (or (_module.Universe.globalBaseInv $Heap@@20 (_module.Object.universe this@@33)) (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 (_module.Object.universe this@@33)) _module.Universe.content)) ($Box refType |o#0@@1|))) (and (and (and (= (_module.Object.universe |o#0@@1|) (_module.Object.universe this@@33)) (or (not (= |o#0@@1| (_module.Object.universe this@@33))) (not true))) (_module.Object.baseFieldsInv $Heap@@20 |o#0@@1|)) (_module.Object.triggerAxioms $Heap@@20 |o#0@@1|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2167|
 :pattern ( (_module.Object.triggerAxioms $Heap@@20 |o#0@@1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@20 |o#0@@1|))
 :pattern ( (_module.Object.universe |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 (_module.Object.universe this@@33)) _module.Universe.content)) ($Box refType |o#0@@1|)))
)))))))))) (=> (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@20 this@@33) (or (_module.Object.objectGlobalBaseInv $Heap@@20 this@@33) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@20 (_module.Object.universe this@@33)) (or (_module.Universe.globalBaseInv $Heap@@20 (_module.Object.universe this@@33)) (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 (_module.Object.universe this@@33)) _module.Universe.content)) ($Box refType |o#0@@2|))) (and (and (and (= (_module.Object.universe |o#0@@2|) (_module.Object.universe this@@33)) (or (not (= |o#0@@2| (_module.Object.universe this@@33))) (not true))) (_module.Object.baseFieldsInv $Heap@@20 |o#0@@2|)) (_module.Object.triggerAxioms $Heap@@20 |o#0@@2|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |2167|
 :pattern ( (_module.Object.triggerAxioms $Heap@@20 |o#0@@2|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@20 |o#0@@2|))
 :pattern ( (_module.Object.universe |o#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 (_module.Object.universe this@@33)) _module.Universe.content)) ($Box refType |o#0@@2|)))
))))))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 (_module.OwnedObject.lifetime this@@33)) _module.Lifetime.elements)) ($Box refType this@@33)))))) (=> (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 (_module.OwnedObject.lifetime this@@33)) _module.Lifetime.elements)) ($Box refType this@@33))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (_module.Lifetime.alive $Heap@@20 (_module.OwnedObject.lifetime this@@33)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@33) _module.OwnedObject.owner)) null)) (not true))))))) (=> (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (_module.Lifetime.alive $Heap@@20 (_module.OwnedObject.lifetime this@@33)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@33) _module.OwnedObject.owner)) null)) (not true)))))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (or (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@33) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv $Heap@@20 this@@33))))))))))))))))))))
(let ((anon9_correct  (=> (= (_module.OwnedObject.inv $Heap@@20 this@@33)  (and (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@33) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv $Heap@@20 this@@33)))) (=> (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33) (=> (_module.OwnedObject.localInv $Heap@@20 this@@33) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@33) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.userInv#canCall| $Heap@@20 this@@33)))) ($Is boolType (bool_2_U (_module.OwnedObject.inv $Heap@@20 this@@33)) TBool)) (and (=> (= (ControlFlow 0 13) (- 0 16)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 13) (- 0 15)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 13) (- 0 14)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (=> (= (ControlFlow 0 13) 6) GeneratedUnifiedExit_correct)))))))))))
(let ((anon14_Else_correct  (=> (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@33) _module.OwnedObject.owner)) null) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 19) 13))) anon9_correct)))
(let ((anon14_Then_correct  (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 this@@33) _module.OwnedObject.owner)) null)) (not true)) (=> (and ($IsAllocBox ($Box refType this@@33) Tclass._module.OwnedObject? $Heap@@20) (= |b$reqreads#2@0| (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@0)))
 :qid |_12MutexLifetimelongdfy.451:27|
 :skolemid |2170|
)))) (=> (and (and (|_module.OwnedObject.userInv#canCall| $Heap@@20 this@@33) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 18) 13))) anon9_correct)))))
(let ((anon13_Then_correct  (=> (and (_module.OwnedObject.localInv $Heap@@20 this@@33) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@33 _module.OwnedObject.owner)))) (and (=> (= (ControlFlow 0 20) 18) anon14_Then_correct) (=> (= (ControlFlow 0 20) 19) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (not (_module.OwnedObject.localInv $Heap@@20 this@@33)) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 17) 13))) anon9_correct)))
(let ((anon11_Else_correct  (=> ($IsAllocBox ($Box refType this@@33) Tclass._module.OwnedObject? $Heap@@20) (=> (and (= |b$reqreads#0@0| (forall (($o@@33 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 $o@@33) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 $o@@33) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@33 $f@@1)))
 :qid |_12MutexLifetimelongdfy.450:8|
 :skolemid |2169|
))) (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33)) (and (=> (= (ControlFlow 0 21) 20) anon13_Then_correct) (=> (= (ControlFlow 0 21) 17) anon13_Else_correct))))))
(let ((anon5_correct true))
(let ((anon12_Else_correct  (=> (and (=> (_module.OwnedObject.inv $Heap@@20 this@@33) (_module.OwnedObject.localInv $Heap@@20 this@@33)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon12_Then_correct  (=> ($IsAllocBox ($Box refType this@@33) Tclass._module.OwnedObject? $Heap@@20) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@33 this@@33) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@33 this@@33) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@33 this@@33) (|_module.OwnedObject.inv#canCall| $Heap@@20 this@@33)) (_module.OwnedObject.inv $Heap@@20 this@@33)) (=> (and (and ($IsAllocBox ($Box refType this@@33) Tclass._module.OwnedObject? $Heap@@20) (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@33)) (and (_module.OwnedObject.localInv $Heap@@20 this@@33) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#96| null $Heap@@20 alloc $Heap@@20 alloc)) (and (and (=> (= (ControlFlow 0 22) 21) anon11_Else_correct) (=> (= (ControlFlow 0 22) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 22) 4) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@20) ($IsHeapAnchor $Heap@@20)) (=> (and (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.OwnedObject) ($IsAlloc refType this@@33 Tclass._module.OwnedObject $Heap@@20))) (and (= 14 $FunctionContextHeight) (= (ControlFlow 0 23) 22))) anon0_correct))))
