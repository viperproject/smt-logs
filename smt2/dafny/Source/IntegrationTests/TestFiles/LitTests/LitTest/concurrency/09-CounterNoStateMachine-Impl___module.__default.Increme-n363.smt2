...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split352)
...
)) ($HeapSucc $Heap@34 $Heap@35)))))) (and (and (and (and (and (and (= $Heap@36 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0|) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|))))) ($IsGoodHeap $Heap@36)) (and ($IsAllocBox ($Box refType |remaining#0|) Tclass._module.OwnedObject? $Heap@36) ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap@33))) (and (and (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|) (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|)) (and (_module.OwnedObject.inv2 $Heap@33 $Heap@36 |remaining#0|) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@36)))) (and (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|)) (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|) (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@36 |universe#0|))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)) (and ($IsGoodHeap $Heap@37) ($IsHeapAnchor $Heap@37))))) (and (and (and (and (forall ((|o#1@@41| T@U) ) (!  (=> ($Is refType |o#1@@41| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@41|)) (=> (=> ($Is refType |o#1@@41| Tclass._module.OwnedObject) (and (forall (($o@@180 T@U) ($f@@120 T@U) ) (!  (=> (or (not (= $o@@180 null)) (not true)) (=> (= $o@@180 |o#1@@41|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 $o@@180) $f@@120) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@180) $f@@120))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
...
))))) (and ($IsGoodHeap $Heap@38) ($IsHeapAnchor $Heap@38)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@37 |universe#0|) (=> (_module.Universe.globalInv $Heap@37 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@33 $Heap@37 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@37 |universe#0|) (and (_module.Universe.globalInv $Heap@37 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@37 |universe#0|) (forall ((|o#17@@9| T@U) ) (!  (=> (and ($Is refType |o#17@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@9|))) (_module.Object.inv $Heap@37 |o#17@@9|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))) (and (= $Heap@37 $Heap@38) (= (ControlFlow 0 2) (- 0 1)))))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
