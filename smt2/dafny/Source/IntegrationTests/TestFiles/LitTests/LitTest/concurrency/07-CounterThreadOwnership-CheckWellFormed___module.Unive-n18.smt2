...
(assert (forall (($h0@@6 T@U) ($h1@@6 T@U) (this@@11 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@17 T@U) ($f@@6 T@U) )  (=> (and (or (not (= $o@@17 null)) (not true)) (or (= $o@@17 this@@11) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 this@@11) _module.Universe.content)) ($Box refType $o@@17)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@17) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@17) $f@@6)))) (= (_module.Universe.globalBaseInv $h0@@6 this@@11) (_module.Universe.globalBaseInv $h1@@6 this@@11))))
