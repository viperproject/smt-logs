...
(assert (forall (($h0@@6 T@U) ($h1@@6 T@U) (this@@11 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@17 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (or (= $o@@17 this@@11) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 this@@11) _module.Universe.content)) ($Box refType $o@@17)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@17) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@17) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |494|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@18 T@U) ($f@@7 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@18 $f@@7))  (=> (and (or (not (= $o@@18 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@18) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3540|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@18 $f@@7))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Universe.ProveReflexiveLegalTransitionsSequence)
...
(let ((anon4_Then_correct  (=> ($IsAllocBox ($Box refType this@@15) Tclass._module.Universe? $Heap@0) (=> (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@0 this@@15) (_module.Universe.globalBaseInv $Heap@0 this@@15)) (and ($IsAllocBox ($Box refType this@@15) Tclass._module.Universe? $Heap@0) ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@15 Tclass._module.Universe $Heap@@7)) (=> ($IsAlloc refType this@@15 Tclass._module.Universe $Heap@@7) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) $Heap@@7))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@7 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@7 $Heap@0)) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Universe) ($IsAlloc refType this@@15 Tclass._module.Universe $Heap@@7)))) (and (and ($Is SetType |running#0@@1| (TSet Tclass._module.Thread)) ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) $Heap@@7)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
