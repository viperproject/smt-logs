...
(assert (distinct TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Mutex Tagclass._module.MutexGuardU32 Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.OwnedU32 class._module.Universe? Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? Tagclass._module.OwnedU32? Tagclass._module.Mutex? class._module.MutexGuardU32? Tagclass._module.MutexGuardU32? tytagFamily$Universe tytagFamily$Mutex tytagFamily$MutexGuardU32 tytagFamily$Object tytagFamily$OwnedU32 tytagFamily$OwnedObject field$content field$mutex field$data)
)
(assert (= (FDim alloc) 0))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.MutexGuardU32.baseUserFieldsInv#canCall| $Heap this) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.MutexGuardU32) ($IsAlloc refType this Tclass._module.MutexGuardU32 $Heap)))))) (= (_module.MutexGuardU32.baseUserFieldsInv $Heap this)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap (_module.Object.universe this)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MutexGuardU32.mutex)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap (_module.Object.universe this)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MutexGuardU32.data)))))
 :qid |_11MutexGuard2legacydfy.539:19|
 :skolemid |2182|
 :pattern ( (_module.MutexGuardU32.baseUserFieldsInv $Heap this) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($h@@16 T@U) ($o@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass._module.MutexGuardU32?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@10) _module.MutexGuardU32.mutex)) Tclass._module.Mutex))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2168|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@10) _module.MutexGuardU32.mutex)))
)))
(assert (forall (($h@@17 T@U) ($o@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) Tclass._module.MutexGuardU32?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@11) _module.MutexGuardU32.data)) Tclass._module.OwnedU32))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2170|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@11) _module.MutexGuardU32.data)))
)))
...
(assert (forall (($h@@18 T@U) ($o@@12 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass._module.MutexGuardU32?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@12) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@12) _module.MutexGuardU32.mutex)) Tclass._module.Mutex $h@@18))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2169|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@12) _module.MutexGuardU32.mutex)))
)))
(assert (forall (($h@@19 T@U) ($o@@13 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@19) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass._module.MutexGuardU32?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@13) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@13) _module.MutexGuardU32.data)) Tclass._module.OwnedU32 $h@@19))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2171|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@19 $o@@13) _module.MutexGuardU32.data)))
)))
...
(assert (forall (($o@@15 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@15 Tclass._module.OwnedU32? $heap@@0) ($IsAlloc refType $o@@15 Tclass._module.OwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |2445|
 :pattern ( ($IsAlloc refType $o@@15 Tclass._module.OwnedU32? $heap@@0))
)))
(assert (forall (($o@@16 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@16 Tclass._module.Mutex? $heap@@1) ($IsAlloc refType $o@@16 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |2449|
 :pattern ( ($IsAlloc refType $o@@16 Tclass._module.Mutex? $heap@@1))
)))
(assert (forall (($o@@17 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@17 Tclass._module.MutexGuardU32? $heap@@2) ($IsAlloc refType $o@@17 Tclass._module.OwnedObject? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |2453|
 :pattern ( ($IsAlloc refType $o@@17 Tclass._module.MutexGuardU32? $heap@@2))
)))
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.MutexGuardU32))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@18 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (or (= $o@@18 this@@0) (= $o@@18 (_module.Object.universe this@@0)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@18) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@18) $f)))
 :qid |unknown.0:0|
 :skolemid |2178|
)) (= (_module.MutexGuardU32.baseUserFieldsInv $h0 this@@0) (_module.MutexGuardU32.baseUserFieldsInv $h1 this@@0))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2179|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.MutexGuardU32.baseUserFieldsInv $h1 this@@0))
)))
...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.baseUserFieldsInvMonotonicity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#22| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.MutexGuardU32.baseUserFieldsInv#canCall| current$Heap this@@1) (or (_module.MutexGuardU32.baseUserFieldsInv current$Heap this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.MutexGuardU32.mutex))))) (=> (=> (|_module.MutexGuardU32.baseUserFieldsInv#canCall| current$Heap this@@1) (or (_module.MutexGuardU32.baseUserFieldsInv current$Heap this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.MutexGuardU32.mutex)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.MutexGuardU32.baseUserFieldsInv#canCall| current$Heap this@@1) (or (_module.MutexGuardU32.baseUserFieldsInv current$Heap this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.MutexGuardU32.data))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@1 Tclass._module.MutexGuardU32 previous$Heap))) (= 3 $FunctionContextHeight)) (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and (and (|_module.MutexGuardU32.baseUserFieldsInv#canCall| previous$Heap this@@1) (and (_module.MutexGuardU32.baseUserFieldsInv previous$Heap this@@1) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@1) _module.MutexGuardU32.mutex)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@1) _module.MutexGuardU32.data))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))) (and (forall (($o@@29 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@29) $f@@1))))
 :qid |_11MutexGuard2legacydfy.543:132|
 :skolemid |2191|
