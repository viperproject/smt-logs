...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.MutexGuardU32))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@18 T@U) ($f T@U) )  (=> (and (or (not (= $o@@18 null)) (not true)) (or (= $o@@18 this@@0) (= $o@@18 (_module.Object.universe this@@0)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@18) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@18) $f)))) (= (_module.MutexGuardU32.baseUserFieldsInv $h0 this@@0) (_module.MutexGuardU32.baseUserFieldsInv $h1 this@@0))))
