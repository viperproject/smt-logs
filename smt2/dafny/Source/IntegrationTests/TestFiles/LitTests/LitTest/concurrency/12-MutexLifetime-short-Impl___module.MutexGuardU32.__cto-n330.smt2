...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split99)
...
(assert (not
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 (_module.Object.universe this@@222)) _module.Universe.content)) ($Box refType |o#19|)))
)))))))))))))
