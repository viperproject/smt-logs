...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@4 this@@4) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Object) ($IsAlloc refType this@@4 Tclass._module.Object $Heap@@4)))))) (_module.Object.triggerAxioms $Heap@@4 this@@4))
 :qid |_11MutexGuard2legacydfy.210:19|
 :skolemid |1089|
 :pattern ( (_module.Object.triggerAxioms $Heap@@4 this@@4))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon13_correct  (=> (= (_module.Universe.globalBaseInv $Heap@@6 this@@6)  (and true (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#2|))) (and (and (and (= (_module.Object.universe |o#2|) this@@6) (or (not (= |o#2| this@@6)) (not true))) (_module.Object.baseFieldsInv $Heap@@6 |o#2|)) (_module.Object.triggerAxioms $Heap@@6 |o#2|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |636|
 :pattern ( (_module.Object.triggerAxioms $Heap@@6 |o#2|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@6 |o#2|))
 :pattern ( (_module.Object.universe |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#2|)))
)))) (=> (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (forall ((|o#2@@0| T@U) ) (!  (=> ($Is refType |o#2@@0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#2@@0|)) (=> (= (_module.Object.universe |o#2@@0|) this@@6) (=> (or (not (= |o#2@@0| this@@6)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@6 |o#2@@0|) (=> (_module.Object.baseFieldsInv $Heap@@6 |o#2@@0|) (|_module.Object.triggerAxioms#canCall| $Heap@@6 |o#2@@0|)))))))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |637|
 :pattern ( (_module.Object.triggerAxioms $Heap@@6 |o#2@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@6 |o#2@@0|))
 :pattern ( (_module.Object.universe |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#2@@0|)))
))) ($Is boolType (bool_2_U (_module.Universe.globalBaseInv $Heap@@6 this@@6)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#1@2|) (=> |b$reqreads#1@2| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#2@3|) (=> |b$reqreads#2@3| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#3@2|)))))))))
...
(let ((anon21_Else_correct  (=> (not (and (and (= (_module.Object.universe |o#1@0|) this@@6) (or (not (= |o#1@0| this@@6)) (not true))) (_module.Object.baseFieldsInv $Heap@@6 |o#1@0|))) (=> (and (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@2| |b$reqreads#2@1|)) (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 12) 7))) anon12_correct))))
(let ((anon21_Then_correct  (=> (and (and (= (_module.Object.universe |o#1@0|) this@@6) (or (not (= |o#1@0| this@@6)) (not true))) (_module.Object.baseFieldsInv $Heap@@6 |o#1@0|)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@6) (=> (and (= |b$reqreads#3@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@18) alloc)))) (= $o@@18 |o#1@0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_11MutexGuard2legacydfy.18:112|
 :skolemid |634|
))) (|_module.Object.triggerAxioms#canCall| $Heap@@6 |o#1@0|)) (=> (and (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@2| |b$reqreads#2@1|)) (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= (ControlFlow 0 10) 7))) anon12_correct))))))))
(let ((anon20_Else_correct  (=> (and (not (and (= (_module.Object.universe |o#1@0|) this@@6) (or (not (= |o#1@0| this@@6)) (not true)))) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 15) 10) anon21_Then_correct) (=> (= (ControlFlow 0 15) 12) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and (= (_module.Object.universe |o#1@0|) this@@6) (or (not (= |o#1@0| this@@6)) (not true))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@6) (= |b$reqreads#2@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@19) alloc)))) (or (= $o@@19 |o#1@0|) (= $o@@19 (_module.Object.universe |o#1@0|)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_11MutexGuard2legacydfy.18:91|
 :skolemid |633|
)))) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@6 |o#1@0|) (= |b$reqreads#2@1| |b$reqreads#2@0|))) (and (=> (= (ControlFlow 0 13) 10) anon21_Then_correct) (=> (= (ControlFlow 0 13) 12) anon21_Else_correct))))))))
(let ((anon19_Else_correct  (=> (or (not (= (_module.Object.universe |o#1@0|) this@@6)) (not true)) (and (=> (= (ControlFlow 0 17) 13) anon20_Then_correct) (=> (= (ControlFlow 0 17) 15) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (= (_module.Object.universe |o#1@0|) this@@6) (and (=> (= (ControlFlow 0 16) 13) anon20_Then_correct) (=> (= (ControlFlow 0 16) 15) anon20_Else_correct)))))
(let ((anon18_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (and (=> (= (ControlFlow 0 18) 16) anon19_Then_correct) (=> (= (ControlFlow 0 18) 17) anon19_Else_correct)))))))
(let ((anon18_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#1@0|))) (=> (and (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 9) 7))) anon12_correct))))
(let ((anon17_Then_correct  (=> (and (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@6)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@6 _module.Universe.content)))) (and (=> (= (ControlFlow 0 20) 18) anon18_Then_correct) (=> (= (ControlFlow 0 20) 9) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (not (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@6))) (=> (and (and (= |b$reqreads#1@1| true) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 8) 7))) anon12_correct))))
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@6 alloc this@@6 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)))) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@6 _module.Universe.content)))) (and (=> (= (ControlFlow 0 22) (- 0 23)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (and (=> (= (ControlFlow 0 22) 1) anon15_Then_correct) (=> (= (ControlFlow 0 22) 21) anon16_Then_correct)) (=> (= (ControlFlow 0 22) 6) anon16_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Universe) ($IsAlloc refType this@@6 Tclass._module.Universe $Heap@@6))) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 24) 22))) anon0_correct))))
