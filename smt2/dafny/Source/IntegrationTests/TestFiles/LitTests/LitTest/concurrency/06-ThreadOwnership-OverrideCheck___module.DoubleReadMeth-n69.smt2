...
(set-info :boogie-vc-id OverrideCheck$$_module.DoubleReadMethod.userInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 9)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= DoubleReadMethod_$_ReadsFrame@0 (|lambda#3| null $Heap@@2 alloc $Heap@@2 alloc)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (forall (($o@@26 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@26) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@26) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@26) alloc))))
 :qid |_06ThreadOwnershipdfy.376:19|
 :skolemid |1747|
