...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split42)
...
)) ($HeapSucc $Heap@4 $Heap@5)) (and (or (not (= call5formal@this@0 null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Lifetime.elements))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
