...
(assert (forall (($o@@8 T@U) ($h@@9 T@U) ) (! (= ($IsAlloc refType $o@@8 Tclass._module.Remaining? $h@@9)  (or (= $o@@8 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@8) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1885|
 :pattern ( ($IsAlloc refType $o@@8 Tclass._module.Remaining? $h@@9))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.Remaining.baseUserInv#canCall| $Heap@@6 this@@10) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.Remaining) ($IsAlloc refType this@@10 Tclass._module.Remaining $Heap@@6)))))) (= (_module.Remaining.baseUserInv $Heap@@6 this@@10) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.551:19|
 :skolemid |1907|
 :pattern ( (_module.Remaining.baseUserInv $Heap@@6 this@@10) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Remaining.localUserInv#canCall| $Heap@@7 this@@11) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Remaining) ($IsAlloc refType this@@11 Tclass._module.Remaining $Heap@@7)))))) (= (_module.Remaining.localUserInv $Heap@@7 this@@11) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_07CounterThreadOwnershipdfy.555:19|
 :skolemid |1914|
 :pattern ( (_module.Remaining.localUserInv $Heap@@7 this@@11) ($IsGoodHeap $Heap@@7))
))))
...
(assert (forall (($h@@10 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass._module.Remaining?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@10) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@10) _module.Remaining.value)) TInt $h@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1887|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@10) _module.Remaining.value)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@3 T@U) ($Heap@@9 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.Remaining.unchangedNonvolatileUserFields#canCall| $prevHeap@@3 $Heap@@9 this@@13) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@3) ($IsGoodHeap $Heap@@9)) ($HeapSucc $prevHeap@@3 $Heap@@9)) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Remaining) ($IsAlloc refType this@@13 Tclass._module.Remaining $prevHeap@@3)))))) (= (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@3 $Heap@@9 this@@13)  (and true (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@3 this@@13) _module.Remaining.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 this@@13) _module.Remaining.value)))))))
 :qid |_07CounterThreadOwnershipdfy.546:22|
 :skolemid |1893|
 :pattern ( (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@3 $Heap@@9 this@@13) ($IsGoodHeap $Heap@@9))
))))
...
(assert  (=> (< 1 $FunctionContextHeight) (forall (($h@@11 T@U) ($o@@11 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@11 null)) (not true)) ($Is refType $o@@11 Tclass._module.Object?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@11) alloc)))) ($IsAlloc refType (_module.Object.universe $o@@11) Tclass._module.Universe $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |966|
 :pattern ( (_module.Object.universe $o@@11) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@11) alloc)))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@4 T@U) ($Heap@@10 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Remaining.unchangedNonvolatileUserFields#canCall| $prevHeap@@4 $Heap@@10 this@@14) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.Remaining)))) (= (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@4 $Heap@@10 this@@14) (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@4 $Heap@@10 this@@14)))
 :qid |_07CounterThreadOwnershipdfy.383:22|
 :skolemid |1894|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@4 $Heap@@10 this@@14) ($Is refType this@@14 Tclass._module.Remaining) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@4 $Heap@@10 this@@14) (_module.Remaining.unchangedNonvolatileUserFields $prevHeap@@4 $Heap@@10 this@@14) ($IsGoodHeap $Heap@@10))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.Object.baseInv#canCall| $Heap@@11 this@@15) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Object) ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@11)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 (_module.Object.universe this@@15)) _module.Universe.content)) ($Box refType this@@15)) (|_module.Universe.globalBaseInv#canCall| $Heap@@11 (_module.Object.universe this@@15))) (= (_module.Object.baseInv $Heap@@11 this@@15)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 (_module.Object.universe this@@15)) _module.Universe.content)) ($Box refType this@@15)) (_module.Universe.globalBaseInv $Heap@@11 (_module.Object.universe this@@15))))))
 :qid |_07CounterThreadOwnershipdfy.243:19|
 :skolemid |971|
 :pattern ( (_module.Object.baseInv $Heap@@11 this@@15) ($IsGoodHeap $Heap@@11))
))))
...
(assert (forall (($o@@14 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@14 Tclass._module.Remaining? $heap@@0) ($IsAlloc refType $o@@14 Tclass._module.OwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |3535|
 :pattern ( ($IsAlloc refType $o@@14 Tclass._module.Remaining? $heap@@0))
)))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.Object.objectGlobalInv#canCall| $Heap@@12 this@@16) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.Object) ($IsAlloc refType this@@16 Tclass._module.Object $Heap@@12)))))) (and (and (|_module.Object.baseInv#canCall| $Heap@@12 this@@16) (=> (_module.Object.baseInv $Heap@@12 this@@16) (|_module.Universe.globalInv#canCall| $Heap@@12 (_module.Object.universe this@@16)))) (= (_module.Object.objectGlobalInv $Heap@@12 this@@16)  (and (_module.Object.baseInv $Heap@@12 this@@16) (_module.Universe.globalInv $Heap@@12 (_module.Object.universe this@@16))))))
 :qid |_07CounterThreadOwnershipdfy.264:19|
 :skolemid |1005|
 :pattern ( (_module.Object.objectGlobalInv $Heap@@12 this@@16) ($IsGoodHeap $Heap@@12))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Remaining.userInv#canCall| $Heap@@13 this@@17) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Remaining) ($IsAlloc refType this@@17 Tclass._module.Remaining $Heap@@13)))))) (=> (_module.Remaining.userInv $Heap@@13 this@@17) (_module.Remaining.localUserInv $Heap@@13 this@@17)))
 :qid |_07CounterThreadOwnershipdfy.558:19|
 :skolemid |1919|
 :pattern ( (_module.Remaining.userInv $Heap@@13 this@@17))
))))
...
(assert (forall (($h@@12 T@U) ($o@@15 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@15 null)) (not true)) ($Is refType $o@@15 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@15) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@15) _module.OwnedObject.nonvolatileVersion)) TInt $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1290|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@15) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h@@13 T@U) ($o@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass._module.Remaining?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@16) _module.Remaining.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1886|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@16) _module.Remaining.value)))
)))
(assert (forall (($h0@@3 T@U) ($h1@@3 T@U) (this@@22 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@17 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (or (= $o@@17 this@@22) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 this@@22) _module.Universe.content)) ($Box refType $o@@17)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@17) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@17) $f@@4)))
 :qid |unknown.0:0|
 :skolemid |494|
...
(assert (forall (($h@@14 T@U) ($o@@18 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@18 null)) (not true)) ($Is refType $o@@18 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@18) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@18) _module.OwnedObject.owner)) Tclass._module.Object $h@@14))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1292|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@18) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@24 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.Universe) ($IsAlloc refType this@@24 Tclass._module.Universe $h0@@4)))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@19 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@19) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@19) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@19) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |502|
...
(assert (forall (($h0@@5 T@U) ($h1@@5 T@U) (this@@25 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.Object) ($IsAlloc refType this@@25 Tclass._module.Object $h0@@5)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@20 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@20) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@20) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@20) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |967|
...
(assert (forall (($h0@@11 T@U) ($h1@@11 T@U) (this@@31 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.OwnedObject) ($IsAlloc refType this@@31 Tclass._module.OwnedObject $h0@@11)))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@26 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@26) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@26) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@26) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |1385|
...
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@32 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.OwnedObject) ($IsAlloc refType this@@32 Tclass._module.OwnedObject $h0@@12)))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@27 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@27) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@27) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@27) $f@@13)))
 :qid |unknown.0:0|
 :skolemid |1389|
...
(assert (forall (($h0@@14 T@U) ($h1@@14 T@U) (this@@34 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@14) ($IsGoodHeap $h1@@14)) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.Remaining) ($IsAlloc refType this@@34 Tclass._module.Remaining $h0@@14)))) (and ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14))) (=> (forall (($o@@29 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@29) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@29) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@14 $o@@29) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |1903|
)) (= (_module.Remaining.baseUserInv $h0@@14 this@@34) (_module.Remaining.baseUserInv $h1@@14 this@@34))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1904|
 :pattern ( ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14) (_module.Remaining.baseUserInv $h1@@14 this@@34))
)))
(assert (forall (($h0@@15 T@U) ($h1@@15 T@U) (this@@35 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@15) ($IsGoodHeap $h1@@15)) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.Remaining) ($IsAlloc refType this@@35 Tclass._module.Remaining $h0@@15)))) (and ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15))) (=> (forall (($o@@30 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@30) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@30) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@15 $o@@30) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |1910|
)) (= (_module.Remaining.localUserInv $h0@@15 this@@35) (_module.Remaining.localUserInv $h1@@15 this@@35))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1911|
 :pattern ( ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15) (_module.Remaining.localUserInv $h1@@15 this@@35))
)))
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@36 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Remaining) ($IsAlloc refType this@@36 Tclass._module.Remaining $h0@@16)))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@31 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@31) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@31) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@31) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |1917|
)) (= (_module.Remaining.userInv $h0@@16 this@@36) (_module.Remaining.userInv $h1@@16 this@@36))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1918|
 :pattern ( ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16) (_module.Remaining.userInv $h1@@16 this@@36))
)))
...
(assert (forall (($o@@33 T@U) ) (!  (=> ($Is refType $o@@33 Tclass._module.Remaining?) ($Is refType $o@@33 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3534|
 :pattern ( ($Is refType $o@@33 Tclass._module.Remaining?))
)))
...
(assert (= (Tag Tclass._module.Remaining) Tagclass._module.Remaining))
(assert (= (TagFamily Tclass._module.Remaining) tytagFamily$Remaining))
(assert (forall (($h@@15 T@U) ($o@@34 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@34 null)) (not true)) ($Is refType $o@@34 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@34) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1291|
...
(assert (forall (($h@@16 T@U) ($o@@38 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@38 null)) (not true)) ($Is refType $o@@38 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@38) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@38) _module.Universe.content)) (TSet Tclass._module.Object) $h@@16))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@38) _module.Universe.content)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.Remaining.userInv#canCall| $Heap@@20 this@@38) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.Remaining) ($IsAlloc refType this@@38 Tclass._module.Remaining $Heap@@20)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Remaining.localUserInv#canCall| $Heap@@20 this@@38)) (= (_module.Remaining.userInv $Heap@@20 this@@38)  (and true (_module.Remaining.localUserInv $Heap@@20 this@@38)))))
 :qid |_07CounterThreadOwnershipdfy.558:19|
 :skolemid |1921|
 :pattern ( (_module.Remaining.userInv $Heap@@20 this@@38) ($IsGoodHeap $Heap@@20))
))))
(assert (forall (($h@@17 T@U) ($o@@39 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@39 null)) (not true)) ($Is refType $o@@39 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@39) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |492|
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Remaining.CheckTransitiveInv2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@21 alloc (_module.Object.universe this@@39) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.Object.universe this@@39)) _module.Universe.content)))) ($IsAllocBox ($Box refType this@@39) Tclass._module.Object? $Heap@@21)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@@21 this@@39) (_module.Object.objectGlobalInv $Heap@@21 this@@39))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (_module.Object.universe this@@39) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@39) null)) (not true)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@40 T@U) ) (!  (=> (and (or (not (= $o@@40 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@40) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@40) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@40)) (or (= $o@@40 (_module.Object.universe this@@39)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.Object.universe this@@39)) _module.Universe.content)) ($Box refType $o@@40)))))
 :qid |_07CounterThreadOwnershipdfy.572:10|
 :skolemid |2058|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@40))
)) ($HeapSucc $Heap@@21 $Heap@0)) (and ($IsAllocBox ($Box refType this@@39) Tclass._module.OwnedObject? $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@39 Tclass._module.Remaining $Heap@@21))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (=> (and (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.Remaining) ($IsAlloc refType this@@39 Tclass._module.Remaining $Heap@@21))) (and (= 11 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
