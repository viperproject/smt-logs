...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split67)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon2_correct  (=> (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222)))) (=> (and (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222))) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |mutex#0| null)) (not true))))))
