...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@67) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@67 Tclass._module.Thread $Heap@@37)) (=> ($IsAlloc refType this@@67 Tclass._module.Thread $Heap@@37) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@37)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@37) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@37 current$Heap this@@67 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@37 current$Heap this@@67 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@67) Tclass._module.Thread? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@67 Tclass._module.Thread $Heap@@37))))))))))
