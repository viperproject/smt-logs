...
))) (and ($HeapSucc $Heap@26 $Heap@27) (= (ControlFlow 0 2) (- 0 1)))))))))) (>= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call4formal@this@0@@1) _module.ConstantInteger.value))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call4formal@this@0) _module.ConstantInteger.value))) 1))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
