...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Object.i0#canCall| $Heap@@3 this@@3) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Object) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@3)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 (_module.Object.universe this@@3)) _module.Universe.content)) ($Box refType this@@3)) (|_module.Universe.i0#canCall| $Heap@@3 (_module.Object.universe this@@3))) (= (_module.Object.i0 $Heap@@3 this@@3)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 (_module.Object.universe this@@3)) _module.Universe.content)) ($Box refType this@@3)) (_module.Universe.i0 $Heap@@3 (_module.Object.universe this@@3))))))
 :qid |_03SimpleCounterdfy.74:19|
 :skolemid |623|
 :pattern ( (_module.Object.i0 $Heap@@3 this@@3) ($IsGoodHeap $Heap@@3))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.WorkerMethod.i#canCall| $Heap@@5 this@@4) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@5) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.WorkerMethod) ($IsAlloc refType this@@4 Tclass._module.WorkerMethod $Heap@@5)))))) (and (and (|_module.Object.i0#canCall| $Heap@@5 this@@4) (=> (_module.Object.i0 $Heap@@5 this@@4) (=> (<= (LitInt 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.next__stmt)))) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.next__stmt))) (LitInt 5)) (=> (= (_module.Object.universe this@@4) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.counter)))) (|_module.ArcAtomicIsize.i#canCall| $Heap@@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.counter)))))))) (= (_module.WorkerMethod.i $Heap@@5 this@@4)  (and (and (and (and (and (and (_module.Object.i0 $Heap@@5 this@@4) (and (<= (LitInt 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.next__stmt)))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.next__stmt))) (LitInt 5)))) (= (_module.Object.universe this@@4) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.counter))))) (_module.ArcAtomicIsize.i $Heap@@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.counter)))) (=> (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.next__stmt))) 1) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.initial__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.counter))) _module.ArcAtomicIsize.data)))))) (=> (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.next__stmt))) 2) (<= (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.initial__value))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.counter))) _module.ArcAtomicIsize.data)))))) (=> (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.next__stmt))) 3) (and (<= (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.initial__value))) 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.final__value)))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.final__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@4) _module.WorkerMethod.counter))) _module.ArcAtomicIsize.data))))))))))
 :qid |_03SimpleCounterdfy.148:19|
 :skolemid |834|
 :pattern ( (_module.WorkerMethod.i $Heap@@5 this@@4) ($IsGoodHeap $Heap@@5))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@7 alloc |universe#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@7) (=> (and (|_module.Universe.i#canCall| $Heap@@7 |universe#0|) (_module.Universe.i $Heap@@7 |universe#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |counter#0| null)) (not true))) (=> (or (not (= |counter#0| null)) (not true)) (=> (= |universe#0| (_module.Object.universe |counter#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |counter#0| null)) (not true))) (=> (or (not (= |counter#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |counter#0|) Tclass._module.ArcAtomicIsize? $Heap@@7) (=> (and (|_module.ArcAtomicIsize.i#canCall| $Heap@@7 |counter#0|) (_module.ArcAtomicIsize.i $Heap@@7 |counter#0|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@34 T@U) ) (!  (=> (and (or (not (= $o@@34 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@34) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@34) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@34)) (= $o@@34 |universe#0|)))
 :qid |_03SimpleCounterdfy.166:3|
 :skolemid |933|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@34))
)) ($HeapSucc $Heap@@7 $Heap@0))) (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass._module.WorkerMethod) ($IsAlloc refType this@0 Tclass._module.WorkerMethod $Heap@0))) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |universe#0| null)) (not true)))))))))))))))))
