...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split113)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon2_correct  (=> (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222)))) (=> (and (and (and (and (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222))) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11) (= |##a#4@0| (_module.OwnedObject.lifetime |mutex#0|)))) (and (and ($IsAlloc refType |##a#4@0| Tclass._module.Lifetime $Heap@11) (= |##b#4@0| (_module.OwnedObject.lifetime this@@222))) (and ($IsAlloc refType |##b#4@0| Tclass._module.Lifetime $Heap@11) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222))))) (and (and (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222))) (and ($IsAllocBox ($Box refType call5formal@this@0) Tclass._module.Lifetime? $Heap@11) (|_module.Lifetime.alive#canCall| $Heap@11 call5formal@this@0))) (and (and (|_module.Lifetime.alive#canCall| $Heap@11 call5formal@this@0) (_module.Lifetime.alive $Heap@11 call5formal@this@0)) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |mutex#0|) _module.OwnedObject.owner)) null)) (not true)) ($IsAllocBox ($Box refType this@@222) Tclass._module.MutexGuardU32? $Heap@11))))) (and (and (and (and (|_module.MutexGuardU32.localUserInv#canCall| $Heap@11 this@@222) (|_module.MutexGuardU32.localUserInv#canCall| $Heap@11 this@@222)) (and (_module.MutexGuardU32.localUserInv $Heap@11 this@@222) ($IsAllocBox ($Box refType this@@222) Tclass._module.MutexGuardU32? $Heap@11))) (and (and (|_module.MutexGuardU32.userInv#canCall| $Heap@11 this@@222) (|_module.MutexGuardU32.userInv#canCall| $Heap@11 this@@222)) (and (_module.MutexGuardU32.userInv $Heap@11 this@@222) ($IsAllocBox ($Box refType this@@222) Tclass._module.OwnedObject? $Heap@11)))) (and (and (and (|_module.OwnedObject.inv#canCall| $Heap@11 this@@222) (|_module.OwnedObject.inv#canCall| $Heap@11 this@@222)) (and (_module.OwnedObject.inv $Heap@11 this@@222) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex) Tclass._module.OwnedObject? $Heap@11))) (and (and (|_module.OwnedObject.inv#canCall| $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) (|_module.OwnedObject.inv#canCall| $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex)))) (and (_module.OwnedObject.inv $Heap@11 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex))) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 this@@222) _module.MutexGuardU32.mutex)) null)) (not true))))))
