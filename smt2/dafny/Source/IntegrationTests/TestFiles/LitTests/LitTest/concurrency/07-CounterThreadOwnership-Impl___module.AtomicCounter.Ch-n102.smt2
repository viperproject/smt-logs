...
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@37 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.AtomicCounter) ($IsAlloc refType this@@37 Tclass._module.AtomicCounter $h0@@16)))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@29 T@U) ($f@@17 T@U) )  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@29) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@29) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@29) $f@@17)))) (= (_module.AtomicCounter.baseUserInv $h0@@16 this@@37) (_module.AtomicCounter.baseUserInv $h1@@16 this@@37))))
 :pattern ( ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16) (_module.AtomicCounter.baseUserInv $h1@@16 this@@37))
)))
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@38 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.AtomicCounter) ($IsAlloc refType this@@38 Tclass._module.AtomicCounter $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@30 T@U) ($f@@18 T@U) )  (=> (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@30) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@30) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@30) $f@@18)))) (= (_module.AtomicCounter.localUserInv $h0@@17 this@@38) (_module.AtomicCounter.localUserInv $h1@@17 this@@38))))
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.AtomicCounter.localUserInv $h1@@17 this@@38))
)))
(assert (forall (($h0@@18 T@U) ($h1@@18 T@U) (this@@39 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.AtomicCounter) ($IsAlloc refType this@@39 Tclass._module.AtomicCounter $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@31 T@U) ($f@@19 T@U) )  (=> (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@31) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@31) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@31) $f@@19)))) (= (_module.AtomicCounter.userInv $h0@@18 this@@39) (_module.AtomicCounter.userInv $h1@@18 this@@39))))
