...
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@5 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@15 T@U) ($f@@9 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (or (= $o@@15 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 this@@5) _module.Universe.content)) ($Box refType $o@@15)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@15) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@15) $f@@9)))
 :qid |unknown.0:0|
 :skolemid |490|
)) (= (_module.Universe.globalBaseInv $h0@@2 this@@5) (_module.Universe.globalBaseInv $h1@@2 this@@5))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |492|
 :pattern ( ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2) (_module.Universe.globalBaseInv $h1@@2 this@@5))
)))
...
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@7 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Object) ($IsAlloc refType this@@7 Tclass._module.Object $h0@@4)))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@18 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@18) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@18) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@18) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |661|
)) (= (_module.Object.inv $h0@@4 this@@7) (_module.Object.inv $h1@@4 this@@7))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |662|
 :pattern ( ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4) (_module.Object.inv $h1@@4 this@@7))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($prevHeap@@3 T@U) ($Heap@@3 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.Universe.globalInv2#canCall| $prevHeap@@3 $Heap@@3 this@@8) (and (< 4 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@3) ($IsGoodHeap $Heap@@3)) ($HeapSucc $prevHeap@@3 $Heap@@3)) (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.Universe) ($IsAlloc refType this@@8 Tclass._module.Universe $prevHeap@@3)))))) (and (forall ((|o#0@@10| T@U) ) (!  (=> ($Is refType |o#0@@10| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@3 this@@8) _module.Universe.content)) ($Box refType |o#0@@10|)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@8) _module.Universe.content)) ($Box refType |o#0@@10|)) (|_module.Object.inv2#canCall| $prevHeap@@3 $Heap@@3 |o#0@@10|))))
 :qid |_05RecInvariantCutdfy.30:12|
 :skolemid |520|
 :pattern ( (_module.Object.inv2 $prevHeap@@3 $Heap@@3 |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@8) _module.Universe.content)) ($Box refType |o#0@@10|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@3 this@@8) _module.Universe.content)) ($Box refType |o#0@@10|)))
)) (= (_module.Universe.globalInv2 $prevHeap@@3 $Heap@@3 this@@8) (forall ((|o#0@@11| T@U) ) (!  (=> (and ($Is refType |o#0@@11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@3 this@@8) _module.Universe.content)) ($Box refType |o#0@@11|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@8) _module.Universe.content)) ($Box refType |o#0@@11|)) (_module.Object.inv2 $prevHeap@@3 $Heap@@3 |o#0@@11|)))
 :qid |_05RecInvariantCutdfy.30:12|
 :skolemid |519|
 :pattern ( (_module.Object.inv2 $prevHeap@@3 $Heap@@3 |o#0@@11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@8) _module.Universe.content)) ($Box refType |o#0@@11|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@3 this@@8) _module.Universe.content)) ($Box refType |o#0@@11|)))
)))))
 :qid |_05RecInvariantCutdfy.29:22|
 :skolemid |521|
 :pattern ( (_module.Universe.globalInv2 $prevHeap@@3 $Heap@@3 this@@8) ($IsGoodHeap $Heap@@3))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#4| null current$Heap alloc false)) ($IsAllocBox ($Box refType this@@9) Tclass._module.Universe? current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@9 Tclass._module.Universe $Heap@@4)) (=> ($IsAlloc refType this@@9 Tclass._module.Universe $Heap@@4) (=> (|_module.Universe.legalTransition#canCall| $Heap@@4 current$Heap this@@9) (=> (and (_module.Universe.legalTransition $Heap@@4 current$Heap this@@9) ($IsAllocBox ($Box refType this@@9) Tclass._module.Universe? current$Heap)) (=> (and (and (|_module.Universe.globalInv#canCall| current$Heap this@@9) (_module.Universe.globalInv current$Heap this@@9)) (and ($IsAllocBox ($Box refType this@@9) Tclass._module.Universe? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@9 Tclass._module.Universe $Heap@@4)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.Universe) ($IsAlloc refType this@@9 Tclass._module.Universe previous$Heap))) (= 13 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@4) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 4) 2))) anon0_correct))))
