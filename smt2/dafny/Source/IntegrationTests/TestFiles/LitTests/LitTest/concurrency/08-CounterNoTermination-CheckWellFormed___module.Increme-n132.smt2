...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@58 T@U) ($f@@20 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@58 $f@@20))  (=> (and (or (not (= $o@@58 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@58) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2273|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@58 $f@@20))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@71 alloc false)) ($IsAllocBox ($Box refType this@@113) Tclass._module.Object? $Heap@@71)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@@71 this@@113) (_module.Object.objectGlobalInv $Heap@@71 this@@113))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |running#0| null)) (not true))) (=> (or (not (= |running#0| null)) (not true)) (=> (= (_module.Object.universe |running#0|) (_module.Object.universe this@@113)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (_module.Object.universe this@@113) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@113) null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 (_module.Object.universe this@@113)) _module.Universe.content)) ($Box refType |running#0|)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.OwnedObject.owner)) |running#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.IncrementerMethod.programCounter))) (LitInt 10))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@94 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 $o@@94) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@94) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 $o@@94)))
 :qid |_08CounterNoTerminationdfy.624:10|
 :skolemid |2209|
