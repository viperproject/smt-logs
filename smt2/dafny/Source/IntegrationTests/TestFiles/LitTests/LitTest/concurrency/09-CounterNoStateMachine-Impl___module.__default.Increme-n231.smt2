...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split220)
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@26 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (and ($IsGoodHeap $Heap@27) ($IsHeapAnchor $Heap@27)) (|_module.Universe.globalInv#canCall| $Heap@27 |universe#0|))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@27 |universe#0|) (and (_module.Universe.globalInv $Heap@27 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@27 |universe#0|) (forall ((|o#5@@9| T@U) ) (!  (=> (and ($Is refType |o#5@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@9|))) (_module.Object.inv $Heap@27 |o#5@@9|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |904|
...
))))) (and (and (and (= $Heap@27 $Heap@28) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@27) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@27))) (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@27) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.legalTransition#canCall| $Heap@27 $Heap@28 |universe#0| |running#0@@3|))))))))) (or (_module.Universe.legalTransition $Heap@27 $Heap@28 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@27 $Heap@28 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@27 $Heap@28 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@27 $Heap@28 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@27 $Heap@28 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@28 |universe#0|) _module.Universe.content)))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
