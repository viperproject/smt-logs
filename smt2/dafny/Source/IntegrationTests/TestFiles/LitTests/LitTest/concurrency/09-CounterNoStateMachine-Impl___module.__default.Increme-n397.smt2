...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split386)
...
))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|))) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (=> |$w$loop#0@0| (= (+ |i#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.Integer.value)))) (LitInt 10)))))) (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> |defass#initial_value#0_0@0| (and ($Is refType |initial_value#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value#0_0@0| Tclass._module.ConstantInteger $Heap@4)))) (and (and (=> |defass#claim1#0_0@0| (and ($Is refType |claim1#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim1#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@4))) (=> |defass#initial_value_plus_one#0_0@0| (and ($Is refType |initial_value_plus_one#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value_plus_one#0_0@0| Tclass._module.ConstantInteger $Heap@4)))) (and (=> |defass#claim2#0_0@0| (and ($Is refType |claim2#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim2#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@4))) (=> |defass#final_value#0_0@0| (and ($Is refType |final_value#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |final_value#0_0@0| Tclass._module.ConstantInteger $Heap@4))))))))) (and (and (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (=> |$w$loop#0@0| (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalInv $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|))) (and (= (_module.Object.universe |o#16@@0|) |universe#0|) (or (not (= |o#16@@0| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |532|
...
))))))))) (and (and (and (and (=> |$w$loop#0@0| (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@4 |universe#0|) (and (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@4 |universe#0|) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content))) (forall ((|o#19@@1| T@U) ) (!  (=> (and ($Is refType |o#19@@1| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@1|)))) (not ($IsAllocBox ($Box refType |o#19@@1|) Tclass._module.Object $Heap@3)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |541|
