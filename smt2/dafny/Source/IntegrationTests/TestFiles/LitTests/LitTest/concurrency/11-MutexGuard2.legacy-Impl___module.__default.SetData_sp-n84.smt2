...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split68)
...
(assert (not
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|)))
)))))))) (and (and (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (and (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (=> (_module.Universe.globalInv $Heap@4 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@4 $Heap@4 |universe#0|)))) (and (and (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (and (_module.Universe.globalInv $Heap@4 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@4 |o#10@@0|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |815|
