...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@26 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@23 this@@26) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.Lifetime) ($IsAlloc refType this@@26 Tclass._module.Lifetime $Heap@@23)))))) (=> (_module.Lifetime.localInv $Heap@@23 this@@26) (_module.Object.objectGlobalBaseInv $Heap@@23 this@@26)))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2318|
 :pattern ( (_module.Lifetime.localInv $Heap@@23 this@@26))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@24 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@24 this@@27) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@24) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Thread) ($IsAlloc refType this@@27 Tclass._module.Thread $Heap@@24)))))) (=> (_module.Thread.inv $Heap@@24 this@@27) (_module.Thread.localInv $Heap@@24 this@@27)))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1883|
 :pattern ( (_module.Thread.inv $Heap@@24 this@@27))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@25 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.Lifetime.inv#canCall| $Heap@@25 this@@28) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@25) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Lifetime) ($IsAlloc refType this@@28 Tclass._module.Lifetime $Heap@@25)))))) (=> (_module.Lifetime.inv $Heap@@25 this@@28) (_module.Lifetime.localInv $Heap@@25 this@@28)))
 :qid |_12MutexLifetimelongdfy.589:19|
 :skolemid |2385|
 :pattern ( (_module.Lifetime.inv $Heap@@25 this@@28))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@26 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@26 this@@29) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@26) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Object) ($IsAlloc refType this@@29 Tclass._module.Object $Heap@@26)))))) (=> (_module.Object.localInv $Heap@@26 this@@29) (_module.Object.objectGlobalBaseInv $Heap@@26 this@@29)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |1783|
 :pattern ( (_module.Object.localInv $Heap@@26 this@@29))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@27 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@27 this@@30) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@27) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.OwnedObject) ($IsAlloc refType this@@30 Tclass._module.OwnedObject $Heap@@27)))))) (=> (_module.OwnedObject.userInv $Heap@@27 this@@30) (_module.OwnedObject.localUserInv $Heap@@27 this@@30)))
 :qid |_12MutexLifetimelongdfy.523:19|
 :skolemid |2243|
 :pattern ( (_module.OwnedObject.userInv $Heap@@27 this@@30))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@28 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@28 this@@31) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@28) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.OwnedObject) ($IsAlloc refType this@@31 Tclass._module.OwnedObject $Heap@@28)))))) (=> (_module.OwnedObject.inv $Heap@@28 this@@31) (_module.OwnedObject.localInv $Heap@@28 this@@31)))
 :qid |_12MutexLifetimelongdfy.449:19|
 :skolemid |2163|
 :pattern ( (_module.OwnedObject.inv $Heap@@28 this@@31))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($Heap@@29 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@29 this@@32) (and (< 15 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.Object) ($IsAlloc refType this@@32 Tclass._module.Object $Heap@@29)))))) (=> (_module.Object.inv $Heap@@29 this@@32) (_module.Object.localInv $Heap@@29 this@@32)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |1793|
 :pattern ( (_module.Object.inv $Heap@@29 this@@32))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@33 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@33)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@33 null)) (not true)) ($Is refType this@@33 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@33)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimelongdfy.362:18|
 :weight 3
 :skolemid |1854|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@33)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@34 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@34)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@34 null)) (not true)) ($Is refType this@@34 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@34)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimelongdfy.425:18|
 :weight 3
 :skolemid |2118|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@34)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@35 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@35)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@35)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimelongdfy.562:18|
 :weight 3
 :skolemid |2294|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@35)))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@30 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@30 this@@36) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@30) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Lifetime) ($IsAlloc refType this@@36 Tclass._module.Lifetime $Heap@@30)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@30 this@@36) (=> (_module.Object.objectGlobalBaseInv $Heap@@30 this@@36) (=> (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#0@@1|))) (= (_module.OwnedObject.lifetime |o#0@@1|) this@@36))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2333|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#0@@1|)))
)) (and (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#1|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@30 |o#1|) (|_module.Lifetime.alive#canCall| $Heap@@30 this@@36))))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2326|
 :pattern ( (_module.OwnedObject.alive $Heap@@30 |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#1|)))
)) (=> (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#1@@0|))) (= (_module.OwnedObject.alive $Heap@@30 |o#1@@0|) (_module.Lifetime.alive $Heap@@30 this@@36)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2332|
 :pattern ( (_module.OwnedObject.alive $Heap@@30 |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#1@@0|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@30 this@@36) (=> (_module.Lifetime.alive $Heap@@30 this@@36) (forall ((|l#0@@0| T@U) ) (!  (=> ($Is refType |l#0@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@30 |l#0@@0|)))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2327|
 :pattern ( (_module.Lifetime.alive $Heap@@30 |l#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@30 this@@36) (forall ((|l#0@@1| T@U) ) (!  (=> (and ($Is refType |l#0@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|))) (_module.Lifetime.alive $Heap@@30 |l#0@@1|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2331|
 :pattern ( (_module.Lifetime.alive $Heap@@30 |l#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@30 this@@36) (=> (not (_module.Lifetime.alive $Heap@@30 this@@36)) (forall ((|l#1@@0| T@U) ) (!  (=> ($Is refType |l#1@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@30 |l#1@@0|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2328|
 :pattern ( (_module.Lifetime.alive $Heap@@30 |l#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@30 this@@36)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@30 this@@36) (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#0@@2|))) (= (_module.OwnedObject.lifetime |o#0@@2|) this@@36))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2320|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#0@@2|)))
))) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#1@@1|))) (= (_module.OwnedObject.alive $Heap@@30 |o#1@@1|) (_module.Lifetime.alive $Heap@@30 this@@36)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2321|
 :pattern ( (_module.OwnedObject.alive $Heap@@30 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.elements)) ($Box refType |o#1@@1|)))
))) (=> (_module.Lifetime.alive $Heap@@30 this@@36) (forall ((|l#0@@2| T@U) ) (!  (=> (and ($Is refType |l#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|))) (_module.Lifetime.alive $Heap@@30 |l#0@@2|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2322|
 :pattern ( (_module.Lifetime.alive $Heap@@30 |l#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@30 this@@36)) (forall ((|l#1@@1| T@U) ) (!  (=> (and ($Is refType |l#1@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|))) (not (_module.Lifetime.alive $Heap@@30 |l#1@@1|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2323|
 :pattern ( (_module.Lifetime.alive $Heap@@30 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
)))) (forall ((|l#2@@0| T@U) ) (!  (=> (and ($Is refType |l#2@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |l#2@@0|) _module.Lifetime.mightPointFrom)) ($Box refType this@@36)))
 :qid |_12MutexLifetimelongdfy.586:16|
 :skolemid |2324|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |l#2@@0|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@36)))
 :qid |_12MutexLifetimelongdfy.587:16|
 :skolemid |2325|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |l#3@@0|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@36) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2334|
 :pattern ( (_module.Lifetime.localInv $Heap@@30 this@@36) ($IsGoodHeap $Heap@@30))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@37 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@37) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@37 null)) (not true)) ($Is refType this@@37 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@37) (_module.Thread.objectClassKind this@@37)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1855|
 :pattern ( (_module.Object.objectClassKind this@@37) ($Is refType this@@37 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@37) (_module.Thread.objectClassKind this@@37))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@38 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@38) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@38 null)) (not true)) ($Is refType this@@38 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@38) (_module.OwnedObject.objectClassKind this@@38)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2119|
 :pattern ( (_module.Object.objectClassKind this@@38) ($Is refType this@@38 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@38) (_module.OwnedObject.objectClassKind this@@38))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@39 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@39) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@39 null)) (not true)) ($Is refType this@@39 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@39) (_module.Lifetime.objectClassKind this@@39)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2295|
 :pattern ( (_module.Object.objectClassKind this@@39) ($Is refType this@@39 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@39) (_module.Lifetime.objectClassKind this@@39))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@40 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@40) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@40) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1851|
 :pattern ( (_module.Thread.objectClassKind this@@40))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@41 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@41) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@41 null)) (not true)) ($Is refType this@@41 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@41) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2115|
 :pattern ( (_module.OwnedObject.objectClassKind this@@41))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@42 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@42) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@42 null)) (not true)) ($Is refType this@@42 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@42) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2291|
 :pattern ( (_module.Lifetime.objectClassKind this@@42))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@43 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@43) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@43 null)) (not true)) ($Is refType this@@43 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@43) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1773|
 :pattern ( (_module.Object.objectClassKind this@@43))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@31 T@U) (this@@44 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@31 this@@44) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@31) (and (or (not (= this@@44 null)) (not true)) (and ($Is refType this@@44 Tclass._module.Thread) ($IsAlloc refType this@@44 Tclass._module.Thread $Heap@@31)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@31 this@@44)) (= (_module.Thread.localInv $Heap@@31 this@@44)  (and true (_module.Object.objectGlobalBaseInv $Heap@@31 this@@44)))))
 :qid |_12MutexLifetimelongdfy.369:19|
 :skolemid |1875|
 :pattern ( (_module.Thread.localInv $Heap@@31 this@@44) ($IsGoodHeap $Heap@@31))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@32 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@32 this@@45) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@32) (and (or (not (= this@@45 null)) (not true)) (and ($Is refType this@@45 Tclass._module.Thread) ($IsAlloc refType this@@45 Tclass._module.Thread $Heap@@32)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@32 this@@45)) (= (_module.Thread.inv $Heap@@32 this@@45)  (and true (_module.Thread.localInv $Heap@@32 this@@45)))))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1885|
 :pattern ( (_module.Thread.inv $Heap@@32 this@@45) ($IsGoodHeap $Heap@@32))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@33 T@U) (this@@46 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@33 this@@46) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@33) (and (or (not (= this@@46 null)) (not true)) (and ($Is refType this@@46 Tclass._module.OwnedObject) ($IsAlloc refType this@@46 Tclass._module.OwnedObject $Heap@@33)))))) (= (_module.OwnedObject.alive $Heap@@33 this@@46)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@33 this@@46) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.422:19|
 :skolemid |2114|
 :pattern ( (_module.OwnedObject.alive $Heap@@33 this@@46) ($IsGoodHeap $Heap@@33))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@47 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@34 this@@47) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@47 null)) (not true)) (and ($Is refType this@@47 Tclass._module.Lifetime) ($IsAlloc refType this@@47 Tclass._module.Lifetime $Heap@@34)))))) (= (_module.Lifetime.alive $Heap@@34 this@@47)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@47) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@34 this@@47) ($IsGoodHeap $Heap@@34))
))))
...
(let ((anon8_Else_correct  (=> (and (=> (_module.Object.inv $Heap@@36 this@@49) (_module.Object.localInv $Heap@@36 this@@49)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($IsAllocBox ($Box refType this@@49) Tclass._module.Object? $Heap@@36) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (= this@@49 this@@49) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@49 this@@49) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@49 this@@49) (|_module.Object.inv#canCall| $Heap@@36 this@@49)) (_module.Object.inv $Heap@@36 this@@49)) (=> (and (and ($IsAllocBox ($Box refType this@@49) Tclass._module.Object? $Heap@@36) (|_module.Object.localInv#canCall| $Heap@@36 this@@49)) (and (_module.Object.localInv $Heap@@36 this@@49) (= (ControlFlow 0 3) 2))) anon5_correct)))))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#96| null $Heap@@36 alloc $Heap@@36 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Else_correct) (=> (= (ControlFlow 0 6) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@36) ($IsHeapAnchor $Heap@@36)) (=> (and (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.Object) ($IsAlloc refType this@@49 Tclass._module.Object $Heap@@36))) (and (= 15 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
