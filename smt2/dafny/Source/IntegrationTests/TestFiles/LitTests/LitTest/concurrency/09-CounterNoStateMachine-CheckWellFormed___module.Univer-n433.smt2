...
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@46 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@46 null)) (not true)) ($Is refType this@@46 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@34 T@U) ($f@@23 T@U) ) (!  (=> (and (or (not (= $o@@34 null)) (not true)) (= $o@@34 this@@46)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@34) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@34) $f@@23)))
 :qid |unknown.0:0|
 :skolemid |1307|
...
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@47 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@47 null)) (not true)) ($Is refType this@@47 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@35 T@U) ($f@@24 T@U) ) (!  (=> (and (or (not (= $o@@35 null)) (not true)) (or (= $o@@35 this@@47) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 this@@47) _module.Universe.content)) ($Box refType $o@@35)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@35) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@35) $f@@24)))
 :qid |unknown.0:0|
 :skolemid |648|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@36 T@U) ($f@@25 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#9| |l#0| |l#1| |l#2| |l#3|) $o@@36 $f@@25))  (=> (and (or (not (= $o@@36 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@36) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3223|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#9| |l#0| |l#1| |l#2| |l#3|) $o@@36 $f@@25))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@67) Tclass._module.Universe? current$Heap) ($IsAlloc refType |running#0@@3| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@67 Tclass._module.Universe $Heap@@37)) (=> ($IsAlloc refType this@@67 Tclass._module.Universe $Heap@@37) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@37)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@37) (=> (|_module.Universe.legalTransition#canCall| $Heap@@37 current$Heap this@@67 |running#0@@3|) (=> (and (_module.Universe.legalTransition $Heap@@37 current$Heap this@@67 |running#0@@3|) ($IsAllocBox ($Box refType this@@67) Tclass._module.Universe? current$Heap)) (=> (and (and (|_module.Universe.globalInv#canCall| current$Heap this@@67) (_module.Universe.globalInv current$Heap this@@67)) (and ($IsAllocBox ($Box refType this@@67) Tclass._module.Universe? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@67 Tclass._module.Universe $Heap@@37))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@37) ($IsHeapAnchor $Heap@@37)) (and (or (not (= this@@67 null)) (not true)) (and ($Is refType this@@67 Tclass._module.Universe) ($IsAlloc refType this@@67 Tclass._module.Universe previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@37) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
