...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split95)
...
)) (= $Heap@14 $Heap@15))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@13)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@13) (= (ControlFlow 0 2) (- 0 1)))))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@13))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
