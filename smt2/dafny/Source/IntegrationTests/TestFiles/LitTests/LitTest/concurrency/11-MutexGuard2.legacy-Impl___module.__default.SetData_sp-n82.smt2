...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split66)
...
(assert (not
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@0|)))
)))) (and (= $Heap@4 $Heap@5) (or (not (= |universe#0| null)) (not true)))) (and (and (forall (($o@@122 T@U) ($f@@74 T@U) ) (!  (=> (and (and (or (not (= $o@@122 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@122) alloc)))) (or (= $o@@122 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType $o@@122)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@122 $f@@74)))
 :qid |_11MutexGuard2legacydfy.676:24|
 :skolemid |575|
)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalInv#canCall| $Heap@5 |universe#0|))))))) (or (_module.Universe.globalInv $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@5 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
