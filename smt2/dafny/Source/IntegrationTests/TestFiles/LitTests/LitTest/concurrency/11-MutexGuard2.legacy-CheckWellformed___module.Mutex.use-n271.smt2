...
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@4) Tclass._module.Mutex? current$Heap)) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($IsAlloc refType this@@4 Tclass._module.Mutex $Heap@@2)) (=> ($IsAlloc refType this@@4 Tclass._module.Mutex $Heap@@2) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@18 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@2)))
 :qid |_11MutexGuard2legacydfy.504:8|
 :skolemid |1961|
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#8| null current$Heap alloc current$Heap alloc)) (and (and (and (=> (= (ControlFlow 0 15) 12) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)) (=> (= (ControlFlow 0 15) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 15) 6) anon11_Else_correct)))))
