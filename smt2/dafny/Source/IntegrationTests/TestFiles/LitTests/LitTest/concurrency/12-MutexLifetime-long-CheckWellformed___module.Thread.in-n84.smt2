...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@14 this@@17) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Thread) ($IsAlloc refType this@@17 Tclass._module.Thread $Heap@@14)))))) (=> (_module.Thread.inv $Heap@@14 this@@17) (_module.Thread.localInv $Heap@@14 this@@17)))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1883|
 :pattern ( (_module.Thread.inv $Heap@@14 this@@17))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@21 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@21) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@21) (_module.Thread.objectClassKind this@@21)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1855|
 :pattern ( (_module.Object.objectClassKind this@@21) ($Is refType this@@21 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@21) (_module.Thread.objectClassKind this@@21))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@22 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@22) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@22) (_module.OwnedObject.objectClassKind this@@22)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2119|
 :pattern ( (_module.Object.objectClassKind this@@22) ($Is refType this@@22 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@22) (_module.OwnedObject.objectClassKind this@@22))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@23 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@23) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@23) (_module.Lifetime.objectClassKind this@@23)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2295|
 :pattern ( (_module.Object.objectClassKind this@@23) ($Is refType this@@23 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@23) (_module.Lifetime.objectClassKind this@@23))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@24 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@24) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@24) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1851|
 :pattern ( (_module.Thread.objectClassKind this@@24))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@25 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@25) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@25) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2115|
 :pattern ( (_module.OwnedObject.objectClassKind this@@25))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@26 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@26) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@26 null)) (not true)) ($Is refType this@@26 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@26) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2291|
 :pattern ( (_module.Lifetime.objectClassKind this@@26))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@27 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@27) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@27 null)) (not true)) ($Is refType this@@27 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@27) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1773|
 :pattern ( (_module.Object.objectClassKind this@@27))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@15 this@@28) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Thread) ($IsAlloc refType this@@28 Tclass._module.Thread $Heap@@15)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@15 this@@28)) (= (_module.Thread.localInv $Heap@@15 this@@28)  (and true (_module.Object.objectGlobalBaseInv $Heap@@15 this@@28)))))
 :qid |_12MutexLifetimelongdfy.369:19|
 :skolemid |1875|
 :pattern ( (_module.Thread.localInv $Heap@@15 this@@28) ($IsGoodHeap $Heap@@15))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@16 this@@29) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Thread) ($IsAlloc refType this@@29 Tclass._module.Thread $Heap@@16)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@16 this@@29)) (= (_module.Thread.inv $Heap@@16 this@@29)  (and true (_module.Thread.localInv $Heap@@16 this@@29)))))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1885|
 :pattern ( (_module.Thread.inv $Heap@@16 this@@29) ($IsGoodHeap $Heap@@16))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@17 this@@30) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Lifetime) ($IsAlloc refType this@@30 Tclass._module.Lifetime $Heap@@17)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@17 this@@30)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@30) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@30)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@30) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@30) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@30)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@30) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@30)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@30) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@30)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@17 this@@30) ($IsGoodHeap $Heap@@17))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@18 this@@31) (or (_module.Object.objectGlobalBaseInv $Heap@@18 this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31)))))))) (=> (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@18 this@@31) (or (_module.Object.objectGlobalBaseInv $Heap@@18 this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31))))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@18 this@@31) (or (_module.Object.objectGlobalBaseInv $Heap@@18 this@@31) (_module.Object.baseFieldsInv $Heap@@18 this@@31))))))) (=> (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@18 this@@31) (or (_module.Object.objectGlobalBaseInv $Heap@@18 this@@31) (_module.Object.baseFieldsInv $Heap@@18 this@@31)))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@18 this@@31) (or (_module.Object.objectGlobalBaseInv $Heap@@18 this@@31) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@18 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@18 (_module.Object.universe this@@31)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@18 this@@31) (or (_module.Object.objectGlobalBaseInv $Heap@@18 this@@31) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@18 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@18 (_module.Object.universe this@@31)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.Thread.inv $Heap@@18 this@@31) (=> (|_module.Thread.localInv#canCall| $Heap@@18 this@@31) (or (_module.Thread.localInv $Heap@@18 this@@31) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@18 this@@31) (or (_module.Object.objectGlobalBaseInv $Heap@@18 this@@31) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@18 (_module.Object.universe this@@31)) (or (_module.Universe.globalBaseInv $Heap@@18 (_module.Object.universe this@@31)) (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#0@@1|))) (and (and (and (= (_module.Object.universe |o#0@@1|) (_module.Object.universe this@@31)) (or (not (= |o#0@@1| (_module.Object.universe this@@31))) (not true))) (_module.Object.baseFieldsInv $Heap@@18 |o#0@@1|)) (_module.Object.triggerAxioms $Heap@@18 |o#0@@1|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |1887|
 :pattern ( (_module.Object.triggerAxioms $Heap@@18 |o#0@@1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@18 |o#0@@1|))
 :pattern ( (_module.Object.universe |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#0@@1|)))
))))))))))))))))))))
(let ((anon8_correct  (=> (= (_module.Thread.inv $Heap@@18 this@@31)  (and true (_module.Thread.localInv $Heap@@18 this@@31))) (=> (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@18 this@@31)) ($Is boolType (bool_2_U (_module.Thread.inv $Heap@@18 this@@31)) TBool)) (and (=> (= (ControlFlow 0 11) (- 0 12)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 11) 6) GeneratedUnifiedExit_correct)))))))
...
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@31) Tclass._module.Thread? $Heap@@18)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@0)))
 :qid |_12MutexLifetimelongdfy.373:8|
 :skolemid |1889|
))) (|_module.Thread.localInv#canCall| $Heap@@18 this@@31)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 13) 11))) anon8_correct))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (and (=> (_module.Thread.inv $Heap@@18 this@@31) (_module.Thread.localInv $Heap@@18 this@@31)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon11_Then_correct  (=> ($IsAllocBox ($Box refType this@@31) Tclass._module.Thread? $Heap@@18) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@31 this@@31) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@31 this@@31) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@31 this@@31) (|_module.Thread.inv#canCall| $Heap@@18 this@@31)) (_module.Thread.inv $Heap@@18 this@@31)) (=> (and (and ($IsAllocBox ($Box refType this@@31) Tclass._module.Thread? $Heap@@18) (|_module.Thread.localInv#canCall| $Heap@@18 this@@31)) (and (_module.Thread.localInv $Heap@@18 this@@31) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#96| null $Heap@@18 alloc $Heap@@18 alloc)) (and (and (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)) (=> (= (ControlFlow 0 15) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 15) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@18) ($IsHeapAnchor $Heap@@18)) (=> (and (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Thread) ($IsAlloc refType this@@31 Tclass._module.Thread $Heap@@18))) (and (= 10 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
