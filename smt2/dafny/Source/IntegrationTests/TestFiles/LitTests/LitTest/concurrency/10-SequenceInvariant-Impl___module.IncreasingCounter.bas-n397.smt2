...
(assert (distinct TagSet alloc allocName Tagclass._module.Universe Tagclass._module.IncreasingCounter Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? class._module.Universe? Tagclass._module.IncreasingCounter? tytagFamily$Universe tytagFamily$IncreasingCounter tytagFamily$Object tytagFamily$OwnedObject field$content)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|c#0@@2| T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType |c#0@@2| Tclass._module.IncreasingCounter $h@@4) ($IsAlloc refType |c#0@@2| Tclass._module.IncreasingCounter? $h@@4))
 :qid |unknown.0:0|
 :skolemid |1767|
 :pattern ( ($IsAlloc refType |c#0@@2| Tclass._module.IncreasingCounter $h@@4))
 :pattern ( ($IsAlloc refType |c#0@@2| Tclass._module.IncreasingCounter? $h@@4))
)))
...
(assert (forall (($o@@3 T@U) ($h@@8 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.IncreasingCounter? $h@@8)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1559|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.IncreasingCounter? $h@@8))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.IncreasingCounter.baseUserFieldsInv#canCall| $Heap this) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.IncreasingCounter) ($IsAlloc refType this Tclass._module.IncreasingCounter $Heap)))))) (= (_module.IncreasingCounter.baseUserFieldsInv $Heap this) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.419:19|
 :skolemid |1566|
 :pattern ( (_module.IncreasingCounter.baseUserFieldsInv $Heap this) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 Tclass._module.IncreasingCounter) (and (= ($Box refType ($Unbox refType bx@@4)) bx@@4) ($Is refType ($Unbox refType bx@@4) Tclass._module.IncreasingCounter)))
 :qid |unknown.0:0|
 :skolemid |483|
 :pattern ( ($IsBox bx@@4 Tclass._module.IncreasingCounter))
)))
...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.IncreasingCounter))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@8 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (or (= $o@@8 this@@0) (= $o@@8 (_module.Object.universe this@@0)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@8) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@8) $f)))
 :qid |unknown.0:0|
 :skolemid |1562|
)) (= (_module.IncreasingCounter.baseUserFieldsInv $h0 this@@0) (_module.IncreasingCounter.baseUserFieldsInv $h1 this@@0))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1563|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.IncreasingCounter.baseUserFieldsInv $h1 this@@0))
)))
...
(assert (forall ((bx@@14 T@U) ) (!  (=> ($IsBox bx@@14 Tclass._module.IncreasingCounter?) ($IsBox bx@@14 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2411|
...
(set-info :boogie-vc-id Impl$$_module.IncreasingCounter.baseUserFieldsInvMonotonicity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#10| null current$Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.IncreasingCounter.baseUserFieldsInv#canCall| current$Heap this@@1)) (or (_module.IncreasingCounter.baseUserFieldsInv current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@1 Tclass._module.IncreasingCounter previous$Heap))) (= 3 $FunctionContextHeight)) (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and (and (|_module.IncreasingCounter.baseUserFieldsInv#canCall| previous$Heap this@@1) (and (_module.IncreasingCounter.baseUserFieldsInv previous$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))) (and (forall (($o@@17 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@17 null)) (not true)) (=> (= $o@@17 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@17) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@17) $f@@1))))
 :qid |_10SequenceInvariantdfy.420:132|
 :skolemid |1575|
