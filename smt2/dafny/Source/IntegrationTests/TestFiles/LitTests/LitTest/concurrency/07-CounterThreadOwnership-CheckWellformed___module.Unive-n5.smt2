...
))) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#5|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |o#5|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#5|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |542|
...
)))) ($Is boolType (bool_2_U (_module.Universe.baseLegalTransitionsSequence $Heap@@0 current$Heap this@@1)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@3|) (=> |b$reqreads#1@3| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@2|))))))))
(let ((anon14_correct  (=> (and (= |b$reqreads#2@2| |b$reqreads#2@1|) (= (ControlFlow 0 7) 3)) anon15_correct)))
(let ((anon24_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#3@0|))) (=> (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 13) 7)) anon14_correct))))
(let ((anon24_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#3@0|)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (or (not (= |o#3@0| null)) (not true))) (=> (or (not (= |o#3@0| null)) (not true)) (and (=> (= (ControlFlow 0 9) (- 0 11)) ($IsAlloc refType |o#3@0| Tclass._module.OwnedObject $Heap@@0)) (=> ($IsAlloc refType |o#3@0| Tclass._module.OwnedObject $Heap@@0) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |o#3@0| null)) (not true))) (=> (or (not (= |o#3@0| null)) (not true)) (=> (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |o#3@0| _module.OwnedObject.nonvolatileVersion))) (=> (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 9) 7)) anon14_correct)))))))))))
(let ((anon23_Then_correct  (=> (and ($Is refType |o#3@0| Tclass._module.OwnedObject) ($IsAlloc refType |o#3@0| Tclass._module.OwnedObject current$Heap)) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@0) (and (=> (= (ControlFlow 0 14) 9) anon24_Then_correct) (=> (= (ControlFlow 0 14) 13) anon24_Else_correct)))))))
(let ((anon23_Else_correct  (=> (not (and ($Is refType |o#3@0| Tclass._module.OwnedObject) ($IsAlloc refType |o#3@0| Tclass._module.OwnedObject current$Heap))) (=> (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 8) 7)) anon14_correct))))
(let ((anon22_Then_correct  (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Universe.content))) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#4@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Universe.content)) ($Box refType |o#4@@0|)))) (not ($IsAllocBox ($Box refType |o#4@@0|) Tclass._module.Object $Heap@@0)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |538|
...
))) (and (=> (= (ControlFlow 0 16) 14) anon23_Then_correct) (=> (= (ControlFlow 0 16) 8) anon23_Else_correct)))))
(let ((anon22_Else_correct  (=> (not (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Universe.content))) (forall ((|o#4@@1| T@U) ) (!  (=> (and ($Is refType |o#4@@1| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#4@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Universe.content)) ($Box refType |o#4@@1|)))) (not ($IsAllocBox ($Box refType |o#4@@1|) Tclass._module.Object $Heap@@0)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |538|
...
)))) (=> (and (= |b$reqreads#2@2| true) (= (ControlFlow 0 6) 3)) anon15_correct))))
(let ((anon9_correct  (=> (= |b$reqreads#1@3| |b$reqreads#1@2|) (and (=> (= (ControlFlow 0 18) 16) anon22_Then_correct) (=> (= (ControlFlow 0 18) 6) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (not (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#2@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Universe.content)) ($Box refType |o#2@0|)))) (=> (and (= |b$reqreads#1@2| |b$reqreads#1@1|) (= (ControlFlow 0 21) 18)) anon9_correct))))
(let ((anon21_Then_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#2@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Universe.content)) ($Box refType |o#2@0|))) (and (= |b$reqreads#1@2| |b$reqreads#1@1|) (= (ControlFlow 0 20) 18))) anon9_correct)))
(let ((anon20_Else_correct  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#2@0|)) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 23) 20) anon21_Then_correct) (=> (= (ControlFlow 0 23) 21) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Box refType |o#2@0|))) (=> (and (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Universe.content))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 22) 20) anon21_Then_correct) (=> (= (ControlFlow 0 22) 21) anon21_Else_correct))))))
(let ((anon19_Then_correct  (=> (and ($Is refType |o#2@0| Tclass._module.Object) ($IsAlloc refType |o#2@0| Tclass._module.Object current$Heap)) (and (=> (= (ControlFlow 0 24) (- 0 25)) ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@0) (and (=> (= (ControlFlow 0 24) 22) anon20_Then_correct) (=> (= (ControlFlow 0 24) 23) anon20_Else_correct)))))))
(let ((anon19_Else_correct  (=> (not (and ($Is refType |o#2@0| Tclass._module.Object) ($IsAlloc refType |o#2@0| Tclass._module.Object current$Heap))) (=> (and (= |b$reqreads#1@2| true) (= (ControlFlow 0 19) 18)) anon9_correct))))
(let ((anon18_Then_correct  (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Universe.content))) (and (=> (= (ControlFlow 0 26) 24) anon19_Then_correct) (=> (= (ControlFlow 0 26) 19) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Universe.content)))) (= |b$reqreads#1@3| true)) (and (=> (= (ControlFlow 0 17) 16) anon22_Then_correct) (=> (= (ControlFlow 0 17) 6) anon22_Else_correct)))))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@0) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Universe.content))) (and (=> (= (ControlFlow 0 27) 26) anon18_Then_correct) (=> (= (ControlFlow 0 27) 17) anon18_Else_correct)))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 29) 1) anon17_Then_correct) (=> (= (ControlFlow 0 29) 27) anon17_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Universe) ($IsAlloc refType this@@1 Tclass._module.Universe previous$Heap))) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 30) 29))) anon0_correct))))
