...
(assert (forall (($ly@@14 T@U) ($h0@@31 T@U) ($h1@@31 T@U) (this@@119 T@U) (|_k#0@@9| Int) (|a#0@@14| T@U) (|x#0@@9| T@U) (|b#0@@14| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@119 null)) (not true)) ($Is refType this@@119 Tclass._module.Universe))) (or (|_module.Universe.outlivesThrough_h#canCall| $h0@@31 this@@119 |_k#0@@9| |a#0@@14| |x#0@@9| |b#0@@14|) (and (and (and (<= (LitInt 0) |_k#0@@9|) ($Is refType |a#0@@14| Tclass._module.Lifetime)) ($Is refType |x#0@@9| Tclass._module.Lifetime)) ($Is refType |b#0@@14| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@73 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (or (or (= $o@@73 this@@119) (and (and ($Is refType $o@@73 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 this@@119) _module.Universe.content)) ($Box refType $o@@73))) (= $f@@43 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@73 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 this@@119) _module.Universe.content)) ($Box refType $o@@73))) (= $f@@43 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@73) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@73) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1609|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@54 T@U) ($Heap@@84 T@U) (this@@120 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@54 $Heap@@84 this@@120) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@54) ($IsGoodHeap $Heap@@84)) ($HeapSucc $prevHeap@@54 $Heap@@84)) (and (or (not (= this@@120 null)) (not true)) (and ($Is refType this@@120 Tclass._module.OwnedObject) ($IsAlloc refType this@@120 Tclass._module.OwnedObject $prevHeap@@54)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@120) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@84 this@@120) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@54 $Heap@@84 this@@120)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@54 $Heap@@84 this@@120)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@54 this@@120) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@84 this@@120) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@54 $Heap@@84 this@@120)))))
 :qid |_12MutexLifetimelongdfy.438:22|
 :skolemid |2147|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@54 $Heap@@84 this@@120) ($IsGoodHeap $Heap@@84))
))))
...
(assert (forall (($ly@@15 T@U) ($h0@@32 T@U) ($h1@@32 T@U) (this@@121 T@U) (|a#0@@15| T@U) (|b#0@@15| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@121 null)) (not true)) ($Is refType this@@121 Tclass._module.Universe))) (or (|_module.Universe.outlives#canCall| $h0@@32 this@@121 |a#0@@15| |b#0@@15|) (and ($Is refType |a#0@@15| Tclass._module.Lifetime) ($Is refType |b#0@@15| Tclass._module.Lifetime)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@74 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (or (or (= $o@@74 this@@121) (and (and ($Is refType $o@@74 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 this@@121) _module.Universe.content)) ($Box refType $o@@74))) (= $f@@44 _module.Lifetime.mightPointTo))) (and (and ($Is refType $o@@74 Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 this@@121) _module.Universe.content)) ($Box refType $o@@74))) (= $f@@44 _module.Lifetime.mightPointFrom)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@74) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@74) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1570|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@122 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@122 null)) (not true)) ($Is refType this@@122 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@76 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (= $o@@76 this@@122)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@76) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@76) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1719|
...
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@123 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@123 null)) (not true)) ($Is refType this@@123 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@77 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@77 null)) (not true)) (= $o@@77 this@@123)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@77) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@77) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |1727|
...
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@127 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@127 null)) (not true)) ($Is refType this@@127 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@78 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (or (= $o@@78 this@@127) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 this@@127) _module.Universe.content)) ($Box refType $o@@78)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@78) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@78) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |1174|
...
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@85 this@@128) (=> (_module.Lifetime.alive $Heap@@85 this@@128) (forall ((|l#0@@1| T@U) ) (!  (=> ($Is refType |l#0@@1| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)) (|_module.Lifetime.alive#canCall| $Heap@@85 |l#0@@1|)))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2327|
 :pattern ( (_module.Lifetime.alive $Heap@@85 |l#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@85 this@@128) (forall ((|l#0@@2| T@U) ) (!  (=> (and ($Is refType |l#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|))) (_module.Lifetime.alive $Heap@@85 |l#0@@2|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2331|
...
))) (and (|_module.Lifetime.alive#canCall| $Heap@@85 this@@128) (=> (not (_module.Lifetime.alive $Heap@@85 this@@128)) (forall ((|l#1| T@U) ) (!  (=> ($Is refType |l#1| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#1|)) (|_module.Lifetime.alive#canCall| $Heap@@85 |l#1|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2328|
 :pattern ( (_module.Lifetime.alive $Heap@@85 |l#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#1|)))
...
)))) (=> (not (_module.Lifetime.alive $Heap@@85 this@@128)) (forall ((|l#1@@0| T@U) ) (!  (=> (and ($Is refType |l#1@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|))) (not (_module.Lifetime.alive $Heap@@85 |l#1@@0|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2323|
...
)))) (forall ((|l#2| T@U) ) (!  (=> (and ($Is refType |l#2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 |l#2|) _module.Lifetime.mightPointFrom)) ($Box refType this@@128)))
 :qid |_12MutexLifetimelongdfy.586:16|
 :skolemid |2324|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 |l#2|) _module.Lifetime.mightPointFrom)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointTo)) ($Box refType |l#2|)))
))) (forall ((|l#3| T@U) ) (!  (=> (and ($Is refType |l#3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#3|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 |l#3|) _module.Lifetime.mightPointTo)) ($Box refType this@@128)))
 :qid |_12MutexLifetimelongdfy.587:16|
 :skolemid |2325|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 |l#3|) _module.Lifetime.mightPointTo)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@85 this@@128) _module.Lifetime.mightPointFrom)) ($Box refType |l#3|)))
))))))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2334|
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@130 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@130 null)) (not true)) ($Is refType this@@130 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@79 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (= $o@@79 this@@130)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@79) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@79) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |2121|
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@131 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@131 null)) (not true)) ($Is refType this@@131 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@80 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (= $o@@80 this@@131)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@80) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@80) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |2224|
...
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@132 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@132 null)) (not true)) ($Is refType this@@132 Tclass._module.OutlivesClaim))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@81 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (= $o@@81 this@@132)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@81) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@81) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |2973|
...
(assert (forall (($h@@29 T@U) ($o@@82 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@82 null)) (not true)) ($Is refType $o@@82 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@82) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@82) _module.OwnedObject.owner)) Tclass._module.Object? $h@@29))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2107|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@82) _module.OwnedObject.owner)))
)))
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@133 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@133 null)) (not true)) (and ($Is refType this@@133 Tclass._module.Universe) ($IsAlloc refType this@@133 Tclass._module.Universe $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@83 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@83) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@83) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@83) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |1186|
...
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@134 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@134 null)) (not true)) (and ($Is refType this@@134 Tclass._module.Object) ($IsAlloc refType this@@134 Tclass._module.Object $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@84 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@84) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@84) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |1699|
...
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@135 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@135 null)) (not true)) (and ($Is refType this@@135 Tclass._module.Object) ($IsAlloc refType this@@135 Tclass._module.Object $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@85 T@U) ($f@@53 T@U) ) (!  (=> (and (or (not (= $o@@85 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@85) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@85) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@85) $f@@53)))
 :qid |unknown.0:0|
 :skolemid |1781|
)) (= (_module.Object.localInv $h0@@41 this@@135) (_module.Object.localInv $h1@@41 this@@135))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1782|
 :pattern ( ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41) (_module.Object.localInv $h1@@41 this@@135))
)))
(assert (forall (($h0@@42 T@U) ($h1@@42 T@U) (this@@136 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@42) ($IsGoodHeap $h1@@42)) (and (or (not (= this@@136 null)) (not true)) (and ($Is refType this@@136 Tclass._module.Object) ($IsAlloc refType this@@136 Tclass._module.Object $h0@@42)))) (and ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42))) (=> (forall (($o@@86 T@U) ($f@@54 T@U) ) (!  (=> (and (or (not (= $o@@86 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@86) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@86) $f@@54) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@42 $o@@86) $f@@54)))
 :qid |unknown.0:0|
 :skolemid |1791|
)) (= (_module.Object.inv $h0@@42 this@@136) (_module.Object.inv $h1@@42 this@@136))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1792|
 :pattern ( ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42) (_module.Object.inv $h1@@42 this@@136))
)))
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@137 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@137 null)) (not true)) (and ($Is refType this@@137 Tclass._module.Thread) ($IsAlloc refType this@@137 Tclass._module.Thread $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@87 T@U) ($f@@55 T@U) ) (!  (=> (and (or (not (= $o@@87 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@87) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@87) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@87) $f@@55)))
 :qid |unknown.0:0|
 :skolemid |1871|
)) (= (_module.Thread.localInv $h0@@43 this@@137) (_module.Thread.localInv $h1@@43 this@@137))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1872|
 :pattern ( ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43) (_module.Thread.localInv $h1@@43 this@@137))
)))
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@138 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@138 null)) (not true)) (and ($Is refType this@@138 Tclass._module.Thread) ($IsAlloc refType this@@138 Tclass._module.Thread $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@88 T@U) ($f@@56 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@88) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@88) $f@@56)))
 :qid |unknown.0:0|
 :skolemid |1881|
)) (= (_module.Thread.inv $h0@@44 this@@138) (_module.Thread.inv $h1@@44 this@@138))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1882|
 :pattern ( ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44) (_module.Thread.inv $h1@@44 this@@138))
)))
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@139 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@139 null)) (not true)) (and ($Is refType this@@139 Tclass._module.OwnedObject) ($IsAlloc refType this@@139 Tclass._module.OwnedObject $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@89 T@U) ($f@@57 T@U) ) (!  (=> (and (or (not (= $o@@89 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@89) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@89) $f@@57) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@89) $f@@57)))
 :qid |unknown.0:0|
 :skolemid |2149|
)) (= (_module.OwnedObject.localInv $h0@@45 this@@139) (_module.OwnedObject.localInv $h1@@45 this@@139))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2150|
 :pattern ( ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45) (_module.OwnedObject.localInv $h1@@45 this@@139))
)))
(assert (forall (($h0@@46 T@U) ($h1@@46 T@U) (this@@140 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@46) ($IsGoodHeap $h1@@46)) (and (or (not (= this@@140 null)) (not true)) (and ($Is refType this@@140 Tclass._module.OwnedObject) ($IsAlloc refType this@@140 Tclass._module.OwnedObject $h0@@46)))) (and ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46))) (=> (forall (($o@@90 T@U) ($f@@58 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@90) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@46 $o@@90) $f@@58)))
 :qid |unknown.0:0|
 :skolemid |2161|
)) (= (_module.OwnedObject.inv $h0@@46 this@@140) (_module.OwnedObject.inv $h1@@46 this@@140))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2162|
 :pattern ( ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46) (_module.OwnedObject.inv $h1@@46 this@@140))
)))
(assert (forall (($h0@@47 T@U) ($h1@@47 T@U) (this@@141 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@47) ($IsGoodHeap $h1@@47)) (and (or (not (= this@@141 null)) (not true)) (and ($Is refType this@@141 Tclass._module.OwnedObject) ($IsAlloc refType this@@141 Tclass._module.OwnedObject $h0@@47)))) (and ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47))) (=> (forall (($o@@91 T@U) ($f@@59 T@U) ) (!  (=> (and (or (not (= $o@@91 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@91) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@91) $f@@59) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@47 $o@@91) $f@@59)))
 :qid |unknown.0:0|
 :skolemid |2233|
)) (= (_module.OwnedObject.localUserInv $h0@@47 this@@141) (_module.OwnedObject.localUserInv $h1@@47 this@@141))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2234|
 :pattern ( ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47) (_module.OwnedObject.localUserInv $h1@@47 this@@141))
)))
(assert (forall (($h0@@48 T@U) ($h1@@48 T@U) (this@@142 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@48) ($IsGoodHeap $h1@@48)) (and (or (not (= this@@142 null)) (not true)) (and ($Is refType this@@142 Tclass._module.OwnedObject) ($IsAlloc refType this@@142 Tclass._module.OwnedObject $h0@@48)))) (and ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48))) (=> (forall (($o@@92 T@U) ($f@@60 T@U) ) (!  (=> (and (or (not (= $o@@92 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@92) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@48 $o@@92) $f@@60) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@48 $o@@92) $f@@60)))
 :qid |unknown.0:0|
 :skolemid |2241|
)) (= (_module.OwnedObject.userInv $h0@@48 this@@142) (_module.OwnedObject.userInv $h1@@48 this@@142))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2242|
 :pattern ( ($IsHeapAnchor $h0@@48) ($HeapSucc $h0@@48 $h1@@48) (_module.OwnedObject.userInv $h1@@48 this@@142))
)))
(assert (forall (($h0@@49 T@U) ($h1@@49 T@U) (this@@143 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@49) ($IsGoodHeap $h1@@49)) (and (or (not (= this@@143 null)) (not true)) (and ($Is refType this@@143 Tclass._module.Lifetime) ($IsAlloc refType this@@143 Tclass._module.Lifetime $h0@@49)))) (and ($IsHeapAnchor $h0@@49) ($HeapSucc $h0@@49 $h1@@49))) (=> (forall (($o@@93 T@U) ($f@@61 T@U) ) (!  (=> (and (or (not (= $o@@93 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@49 $o@@93) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@49 $o@@93) $f@@61) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@49 $o@@93) $f@@61)))
 :qid |unknown.0:0|
 :skolemid |2316|
)) (= (_module.Lifetime.localInv $h0@@49 this@@143) (_module.Lifetime.localInv $h1@@49 this@@143))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2317|
 :pattern ( ($IsHeapAnchor $h0@@49) ($HeapSucc $h0@@49 $h1@@49) (_module.Lifetime.localInv $h1@@49 this@@143))
)))
(assert (forall (($h0@@50 T@U) ($h1@@50 T@U) (this@@144 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@50) ($IsGoodHeap $h1@@50)) (and (or (not (= this@@144 null)) (not true)) (and ($Is refType this@@144 Tclass._module.Lifetime) ($IsAlloc refType this@@144 Tclass._module.Lifetime $h0@@50)))) (and ($IsHeapAnchor $h0@@50) ($HeapSucc $h0@@50 $h1@@50))) (=> (forall (($o@@94 T@U) ($f@@62 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@50 $o@@94) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@50 $o@@94) $f@@62) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@50 $o@@94) $f@@62)))
 :qid |unknown.0:0|
 :skolemid |2383|
)) (= (_module.Lifetime.inv $h0@@50 this@@144) (_module.Lifetime.inv $h1@@50 this@@144))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2384|
 :pattern ( ($IsHeapAnchor $h0@@50) ($HeapSucc $h0@@50 $h1@@50) (_module.Lifetime.inv $h1@@50 this@@144))
)))
(assert (forall (($h0@@51 T@U) ($h1@@51 T@U) (this@@145 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@51) ($IsGoodHeap $h1@@51)) (and (or (not (= this@@145 null)) (not true)) (and ($Is refType this@@145 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@145 Tclass._module.OutlivesClaim $h0@@51)))) (and ($IsHeapAnchor $h0@@51) ($HeapSucc $h0@@51 $h1@@51))) (=> (forall (($o@@95 T@U) ($f@@63 T@U) ) (!  (=> (and (or (not (= $o@@95 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@51 $o@@95) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@51 $o@@95) $f@@63) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@51 $o@@95) $f@@63)))
 :qid |unknown.0:0|
 :skolemid |2988|
)) (= (_module.OutlivesClaim.localUserInv $h0@@51 this@@145) (_module.OutlivesClaim.localUserInv $h1@@51 this@@145))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2989|
 :pattern ( ($IsHeapAnchor $h0@@51) ($HeapSucc $h0@@51 $h1@@51) (_module.OutlivesClaim.localUserInv $h1@@51 this@@145))
)))
(assert (forall (($h0@@52 T@U) ($h1@@52 T@U) (this@@146 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@52) ($IsGoodHeap $h1@@52)) (and (or (not (= this@@146 null)) (not true)) (and ($Is refType this@@146 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@146 Tclass._module.OutlivesClaim $h0@@52)))) (and ($IsHeapAnchor $h0@@52) ($HeapSucc $h0@@52 $h1@@52))) (=> (forall (($o@@96 T@U) ($f@@64 T@U) ) (!  (=> (and (or (not (= $o@@96 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@52 $o@@96) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@52 $o@@96) $f@@64) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@52 $o@@96) $f@@64)))
 :qid |unknown.0:0|
 :skolemid |2997|
)) (= (_module.OutlivesClaim.userInv $h0@@52 this@@146) (_module.OutlivesClaim.userInv $h1@@52 this@@146))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2998|
 :pattern ( ($IsHeapAnchor $h0@@52) ($HeapSucc $h0@@52 $h1@@52) (_module.OutlivesClaim.userInv $h1@@52 this@@146))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@147 T@U) ) (!  (=> (or (|_module.OutlivesClaim.volatileOwns#canCall| this@@147) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@147 null)) (not true)) ($Is refType this@@147 Tclass._module.OutlivesClaim)))) (= (_module.OutlivesClaim.volatileOwns this@@147) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimelongdfy.687:19|
 :skolemid |2969|
 :pattern ( (_module.OutlivesClaim.volatileOwns this@@147))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@148 T@U) ) (!  (=> (or (|_module.OutlivesClaim.volatileOwns#canCall| this@@148) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@148 null)) (not true)) ($Is refType this@@148 Tclass._module.OutlivesClaim)))) (= (_module.OwnedObject.volatileOwns this@@148) (_module.OutlivesClaim.volatileOwns this@@148)))
 :qid |_12MutexLifetimelongdfy.518:19|
 :skolemid |2971|
 :pattern ( (_module.OwnedObject.volatileOwns this@@148) ($Is refType this@@148 Tclass._module.OutlivesClaim))
 :pattern ( (_module.OwnedObject.volatileOwns this@@148) (_module.OutlivesClaim.volatileOwns this@@148))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@149 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@149) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@149 null)) (not true)) ($Is refType this@@149 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@149) (_module.Thread.objectClassKind this@@149)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1855|
 :pattern ( (_module.Object.objectClassKind this@@149) ($Is refType this@@149 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@149) (_module.Thread.objectClassKind this@@149))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@150 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@150) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@150 null)) (not true)) ($Is refType this@@150 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@150) (_module.OwnedObject.objectClassKind this@@150)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2119|
 :pattern ( (_module.Object.objectClassKind this@@150) ($Is refType this@@150 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@150) (_module.OwnedObject.objectClassKind this@@150))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@151 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@151) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@151 null)) (not true)) ($Is refType this@@151 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@151) (_module.Lifetime.objectClassKind this@@151)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2295|
 :pattern ( (_module.Object.objectClassKind this@@151) ($Is refType this@@151 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@151) (_module.Lifetime.objectClassKind this@@151))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@152 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@152) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@152 null)) (not true)) ($Is refType this@@152 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@152) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1851|
 :pattern ( (_module.Thread.objectClassKind this@@152))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@153 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@153) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@153 null)) (not true)) ($Is refType this@@153 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@153) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2115|
 :pattern ( (_module.OwnedObject.objectClassKind this@@153))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@154 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@154) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@154 null)) (not true)) ($Is refType this@@154 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@154) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2291|
 :pattern ( (_module.Lifetime.objectClassKind this@@154))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@155 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@155) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@155 null)) (not true)) ($Is refType this@@155 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@155) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1773|
 :pattern ( (_module.Object.objectClassKind this@@155))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@55 T@U) ($Heap@@87 T@U) (this@@156 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv2#canCall| $prevHeap@@55 $Heap@@87 this@@156) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@55) ($IsGoodHeap $Heap@@87)) ($HeapSucc $prevHeap@@55 $Heap@@87)) (and (or (not (= this@@156 null)) (not true)) (and ($Is refType this@@156 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@156 Tclass._module.OutlivesClaim $prevHeap@@55)))))) (=> (_module.OutlivesClaim.userInv2 $prevHeap@@55 $Heap@@87 this@@156) (_module.OutlivesClaim.localUserInv2 $prevHeap@@55 $Heap@@87 this@@156)))
 :qid |_12MutexLifetimelongdfy.700:22|
 :skolemid |3022|
 :pattern ( (_module.OutlivesClaim.userInv2 $prevHeap@@55 $Heap@@87 this@@156))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($prevHeap@@56 T@U) ($Heap@@88 T@U) (this@@157 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv2#canCall| $prevHeap@@56 $Heap@@88 this@@157) (and (< 13 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@56) ($IsGoodHeap $Heap@@88)) ($HeapSucc $prevHeap@@56 $Heap@@88)) (and (or (not (= this@@157 null)) (not true)) (and ($Is refType this@@157 Tclass._module.OwnedObject) ($IsAlloc refType this@@157 Tclass._module.OwnedObject $prevHeap@@56)))))) (=> (_module.OwnedObject.userInv2 $prevHeap@@56 $Heap@@88 this@@157) (_module.OwnedObject.localUserInv2 $prevHeap@@56 $Heap@@88 this@@157)))
 :qid |_12MutexLifetimelongdfy.524:22|
 :skolemid |2247|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@56 $Heap@@88 this@@157))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@160 T@U) ) (!  (=> (or (|_module.OutlivesClaim.volatileOwns#canCall| (Lit refType this@@160)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@160 null)) (not true)) ($Is refType this@@160 Tclass._module.OutlivesClaim)))) (= (_module.OutlivesClaim.volatileOwns (Lit refType this@@160)) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |_12MutexLifetimelongdfy.687:19|
 :weight 3
 :skolemid |2970|
 :pattern ( (_module.OutlivesClaim.volatileOwns (Lit refType this@@160)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@91 T@U) (this@@161 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@91 this@@161) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@91) (and (or (not (= this@@161 null)) (not true)) (and ($Is refType this@@161 Tclass._module.OwnedObject) ($IsAlloc refType this@@161 Tclass._module.OwnedObject $Heap@@91)))))) (= (_module.OwnedObject.alive $Heap@@91 this@@161)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@91 this@@161) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.422:19|
 :skolemid |2114|
 :pattern ( (_module.OwnedObject.alive $Heap@@91 this@@161) ($IsGoodHeap $Heap@@91))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@92 T@U) (this@@162 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@92 this@@162) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@92) (and (or (not (= this@@162 null)) (not true)) (and ($Is refType this@@162 Tclass._module.Lifetime) ($IsAlloc refType this@@162 Tclass._module.Lifetime $Heap@@92)))))) (= (_module.Lifetime.alive $Heap@@92 this@@162)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@92 this@@162) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@92 this@@162) ($IsGoodHeap $Heap@@92))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@93 T@U) (this@@163 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@93 this@@163) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@93) (and (or (not (= this@@163 null)) (not true)) (and ($Is refType this@@163 Tclass._module.Lifetime) ($IsAlloc refType this@@163 Tclass._module.Lifetime $Heap@@93)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@93 this@@163)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 this@@163) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 (_module.Object.universe this@@163)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 this@@163) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 this@@163) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 (_module.Object.universe this@@163)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 this@@163) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 (_module.Object.universe this@@163)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 this@@163) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 (_module.Object.universe this@@163)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@93 this@@163) ($IsGoodHeap $Heap@@93))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@57 T@U) ($Heap@@94 T@U) (this@@164 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@57 $Heap@@94 this@@164) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@57) ($IsGoodHeap $Heap@@94)) ($HeapSucc $prevHeap@@57 $Heap@@94)) (and (or (not (= this@@164 null)) (not true)) (and ($Is refType this@@164 Tclass._module.OwnedObject) ($IsAlloc refType this@@164 Tclass._module.OwnedObject $prevHeap@@57)))))) (and (=> (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@164) _module.OwnedObject.owner)) null)) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@164) _module.OwnedObject.nonvolatileVersion)))) (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@164) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@57 $Heap@@94 this@@164))) (=> (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@164) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@57 $Heap@@94 this@@164))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.owner))))
(|_module.OwnedObject.volatileOwns#canCall| |oldOwner#0|))))))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@57 $Heap@@94 this@@164)  (and (and (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.owner)) null) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@164) _module.OwnedObject.owner)) null)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@164) _module.OwnedObject.nonvolatileVersion))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@164) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@57 $Heap@@94 this@@164)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.owner))))
 (=> (and (not (_module.OwnedObject.volatileOwns |oldOwner#0@@0|)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 |oldOwner#0@@0|) _module.OwnedObject.nonvolatileVersion))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@57 this@@164) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 this@@164) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_12MutexLifetimelongdfy.458:22|
 :skolemid |2186|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@57 $Heap@@94 this@@164) ($IsGoodHeap $Heap@@94))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@58 T@U) ($Heap@@95 T@U) (this@@165 T@U) ) (!  (=> (or (|_module.OutlivesClaim.userInv2#canCall| $prevHeap@@58 $Heap@@95 this@@165) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@58) ($IsGoodHeap $Heap@@95)) ($HeapSucc $prevHeap@@58 $Heap@@95)) (and (or (not (= this@@165 null)) (not true)) (and ($Is refType this@@165 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@165 Tclass._module.OutlivesClaim $prevHeap@@58)))))) (and (|_module.OutlivesClaim.localUserInv2#canCall| $prevHeap@@58 $Heap@@95 this@@165) (= (_module.OutlivesClaim.userInv2 $prevHeap@@58 $Heap@@95 this@@165) (_module.OutlivesClaim.localUserInv2 $prevHeap@@58 $Heap@@95 this@@165))))
 :qid |_12MutexLifetimelongdfy.700:22|
 :skolemid |3024|
 :pattern ( (_module.OutlivesClaim.userInv2 $prevHeap@@58 $Heap@@95 this@@165) ($IsGoodHeap $Heap@@95))
))))
...
(declare-fun this@@166 () T@U)
(declare-fun |running#0@@5| () T@U)
(declare-fun previous$Heap () T@U)
(set-info :boogie-vc-id OverrideCheck$$_module.OutlivesClaim.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon0_correct  (=> (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType this@@166))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType this@@166)))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (forall (($o@@107 T@U) ($f@@65 T@U) ) (!  (=> (or (not (= $o@@107 null)) (not true)) (=> (= $o@@107 this@@166) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@107) $f@@65) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@107) $f@@65))))
 :qid |_12MutexLifetimelongdfy.343:8|
 :skolemid |3078|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@107) $f@@65))
))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (forall (($o@@108 T@U) ($f@@66 T@U) ) (!  (=> (or (not (= $o@@108 null)) (not true)) (=> (= $o@@108 this@@166) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@108) $f@@66) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@108) $f@@66))))
 :qid |_12MutexLifetimelongdfy.343:8|
 :skolemid |3078|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@108) $f@@66))
)))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv $Heap@@96 (_module.Object.universe this@@166)) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv $Heap@@96 (_module.Object.universe this@@166)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv $Heap@@96 (_module.Object.universe this@@166)) (forall ((|o#0@@12| T@U) ) (!  (=> (and ($Is refType |o#0@@12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#0@@12|))) (and (and (and (= (_module.Object.universe |o#0@@12|) (_module.Object.universe this@@166)) (or (not (= |o#0@@12| (_module.Object.universe this@@166))) (not true))) (_module.Object.baseFieldsInv $Heap@@96 |o#0@@12|)) (_module.Object.triggerAxioms $Heap@@96 |o#0@@12|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |3079|
 :pattern ( (_module.Object.triggerAxioms $Heap@@96 |o#0@@12|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@96 |o#0@@12|))
 :pattern ( (_module.Object.universe |o#0@@12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#0@@12|)))
))))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv $Heap@@96 (_module.Object.universe this@@166)) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#0@@13|))) (and (and (and (= (_module.Object.universe |o#0@@13|) (_module.Object.universe this@@166)) (or (not (= |o#0@@13| (_module.Object.universe this@@166))) (not true))) (_module.Object.baseFieldsInv $Heap@@96 |o#0@@13|)) (_module.Object.triggerAxioms $Heap@@96 |o#0@@13|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |3079|
 :pattern ( (_module.Object.triggerAxioms $Heap@@96 |o#0@@13|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@96 |o#0@@13|))
 :pattern ( (_module.Object.universe |o#0@@13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#0@@13|)))
)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@166)) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@166)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@166)) (forall ((|o#1@@6| T@U) ) (!  (=> (and ($Is refType |o#1@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#1@@6|))) (and (and (and (= (_module.Object.universe |o#1@@6|) (_module.Object.universe this@@166)) (or (not (= |o#1@@6| (_module.Object.universe this@@166))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#1@@6|)) (_module.Object.triggerAxioms current$Heap |o#1@@6|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |3081|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#1@@6|)))
))))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@166)) (forall ((|o#1@@7| T@U) ) (!  (=> (and ($Is refType |o#1@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#1@@7|))) (and (and (and (= (_module.Object.universe |o#1@@7|) (_module.Object.universe this@@166)) (or (not (= |o#1@@7| (_module.Object.universe this@@166))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#1@@7|)) (_module.Object.triggerAxioms current$Heap |o#1@@7|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |3081|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#1@@7|)))
)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#2|)))) (not ($IsAllocBox ($Box refType |o#2|) Tclass._module.Object $Heap@@96)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |3083|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#2|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166)) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#2@@0|)))) (not ($IsAllocBox ($Box refType |o#2@@0|) Tclass._module.Object $Heap@@96)))
 :qid |_12MutexLifetimelongdfy.45:16|
 :skolemid |3083|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#2@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#3|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#3|)))) (or (forall (($o@@109 T@U) ($f@@67 T@U) ) (!  (=> (or (not (= $o@@109 null)) (not true)) (=> (= $o@@109 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@109) $f@@67) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@109) $f@@67))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |3085|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@109) $f@@67))
)) (_module.Object.sequenceInv2 $Heap@@96 current$Heap |o#3|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |3086|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@96 current$Heap |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#3|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#3@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#3@@0|)))) (or (forall (($o@@110 T@U) ($f@@68 T@U) ) (!  (=> (or (not (= $o@@110 null)) (not true)) (=> (= $o@@110 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@110) $f@@68) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@110) $f@@68))))
 :qid |_12MutexLifetimelongdfy.60:65|
 :skolemid |3085|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@110) $f@@68))
)) (_module.Object.sequenceInv2 $Heap@@96 current$Heap |o#3@@0|)))
 :qid |_12MutexLifetimelongdfy.60:16|
 :skolemid |3086|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@96 current$Heap |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#3@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#4|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@96)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#4|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |3087|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#4|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#4@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4@@0|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@96)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#4@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimelongdfy.63:16|
 :skolemid |3087|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |o#4@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|l#0@@4| T@U) ) (!  (=> (and ($Is refType |l#0@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |l#0@@4|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |l#0@@4|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |l#0@@4|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@96)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@96 current$Heap |l#0@@4|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |3088|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@96 current$Heap |l#0@@4|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |l#0@@4|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |l#0@@4|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@96 current$Heap (_module.Object.universe this@@166) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|l#0@@5| T@U) ) (!  (=> (and ($Is refType |l#0@@5| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |l#0@@5|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |l#0@@5|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |l#0@@5|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@96)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@96 current$Heap |l#0@@5|)))
 :qid |_12MutexLifetimelongdfy.69:16|
 :skolemid |3088|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@96 current$Heap |l#0@@5|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 |l#0@@5|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |l#0@@5|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalInv $Heap@@96 (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv $Heap@@96 (_module.Object.universe this@@166)) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalInv $Heap@@96 (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv $Heap@@96 (_module.Object.universe this@@166)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalInv $Heap@@96 (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv $Heap@@96 (_module.Object.universe this@@166)) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#5|))) (and (and (and (= (_module.Object.universe |o#5|) (_module.Object.universe this@@166)) (or (not (= |o#5| (_module.Object.universe this@@166))) (not true))) (_module.Object.baseFieldsInv $Heap@@96 |o#5|)) (_module.Object.triggerAxioms $Heap@@96 |o#5|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |3093|
 :pattern ( (_module.Object.triggerAxioms $Heap@@96 |o#5|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@96 |o#5|))
 :pattern ( (_module.Object.universe |o#5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#5|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalInv $Heap@@96 (_module.Object.universe this@@166)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalBaseInv $Heap@@96 (_module.Object.universe this@@166)) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#5@@0|))) (and (and (and (= (_module.Object.universe |o#5@@0|) (_module.Object.universe this@@166)) (or (not (= |o#5@@0| (_module.Object.universe this@@166))) (not true))) (_module.Object.baseFieldsInv $Heap@@96 |o#5@@0|)) (_module.Object.triggerAxioms $Heap@@96 |o#5@@0|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |3093|
 :pattern ( (_module.Object.triggerAxioms $Heap@@96 |o#5@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@96 |o#5@@0|))
 :pattern ( (_module.Object.universe |o#5@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#5@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalInv $Heap@@96 (_module.Object.universe this@@166)) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#6|))) (_module.Object.inv $Heap@@96 |o#6|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |3095|
 :pattern ( (_module.Object.inv $Heap@@96 |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#6|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@96 (_module.Object.universe this@@166)) (or (_module.Universe.globalInv $Heap@@96 (_module.Object.universe this@@166)) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#6@@0|))) (_module.Object.inv $Heap@@96 |o#6@@0|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |3095|
 :pattern ( (_module.Object.inv $Heap@@96 |o#6@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#6@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#7|))) (and (or (forall (($o@@111 T@U) ($f@@69 T@U) ) (!  (=> (or (not (= $o@@111 null)) (not true)) (=> (= $o@@111 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@111) $f@@69) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@111) $f@@69))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |3097|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@111) $f@@69))
)) (_module.Object.inv current$Heap |o#7|)) (or (forall (($o@@112 T@U) ($f@@70 T@U) ) (!  (=> (or (not (= $o@@112 null)) (not true)) (=> (= $o@@112 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@112) $f@@70) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@112) $f@@70))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |3098|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@112) $f@@70))
)) (_module.Object.inv2 $Heap@@96 current$Heap |o#7|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |3099|
 :pattern ( (_module.Object.inv2 $Heap@@96 current$Heap |o#7|))
 :pattern ( (_module.Object.inv current$Heap |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#7|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (or (forall (($o@@113 T@U) ($f@@71 T@U) ) (!  (=> (or (not (= $o@@113 null)) (not true)) (=> (= $o@@113 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@113) $f@@71) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@113) $f@@71))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |3097|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@113) $f@@71))
)) (_module.Object.inv current$Heap |o#7@@0|)) (or (forall (($o@@114 T@U) ($f@@72 T@U) ) (!  (=> (or (not (= $o@@114 null)) (not true)) (=> (= $o@@114 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@114) $f@@72) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 $o@@114) $f@@72))))
 :qid |_12MutexLifetimelongdfy.83:49|
 :skolemid |3098|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@114) $f@@72))
)) (_module.Object.inv2 $Heap@@96 current$Heap |o#7@@0|))))
 :qid |_12MutexLifetimelongdfy.83:16|
 :skolemid |3099|
 :pattern ( (_module.Object.inv2 $Heap@@96 current$Heap |o#7@@0|))
 :pattern ( (_module.Object.inv current$Heap |o#7@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#7@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#8|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#8|))))) (_module.Object.inv current$Heap |o#8|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |3100|
 :pattern ( (_module.Object.inv current$Heap |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#8|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#8|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@96 current$Heap (_module.Object.universe this@@166) |running#0@@5|) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#8@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#8@@0|))))) (_module.Object.inv current$Heap |o#8@@0|))
 :qid |_12MutexLifetimelongdfy.85:16|
 :skolemid |3100|
 :pattern ( (_module.Object.inv current$Heap |o#8@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@96 (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#8@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@166)) _module.Universe.content)) ($Box refType |o#8@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true)))) (=> (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@115 T@U) ($f@@73 T@U) ) (! true
 :qid |_12MutexLifetimelongdfy.703:18|
 :skolemid |3106|
))) (=> (forall (($o@@116 T@U) ($f@@74 T@U) ) (! true
 :qid |_12MutexLifetimelongdfy.703:18|
 :skolemid |3106|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@117 T@U) ($f@@75 T@U) ) (! true
 :qid |_12MutexLifetimelongdfy.703:18|
 :skolemid |3107|
))) (=> (forall (($o@@118 T@U) ($f@@76 T@U) ) (! true
 :qid |_12MutexLifetimelongdfy.703:18|
 :skolemid |3107|
)) (=> (and (_module.OwnedObject.inv2 $Heap@@96 current$Heap this@@166) (_module.OwnedObject.inv current$Heap this@@166)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Object.inv2 $Heap@@96 current$Heap this@@166)) (=> (_module.Object.inv2 $Heap@@96 current$Heap this@@166) (=> (= (ControlFlow 0 2) (- 0 1)) (_module.Object.inv current$Heap this@@166))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@96) ($IsHeapAnchor $Heap@@96)) (and (or (not (= this@@166 null)) (not true)) (and ($Is refType this@@166 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@166 Tclass._module.OutlivesClaim previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 19 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@96) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 24) 2)))) anon0_correct))))
