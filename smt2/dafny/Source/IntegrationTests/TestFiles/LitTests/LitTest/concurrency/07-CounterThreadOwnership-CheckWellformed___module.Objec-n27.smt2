...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Object.objectGlobalInv#canCall| $Heap@@2 this@@2) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Object) ($IsAlloc refType this@@2 Tclass._module.Object $Heap@@2)))))) (and (and (|_module.Object.baseInv#canCall| $Heap@@2 this@@2) (=> (_module.Object.baseInv $Heap@@2 this@@2) (|_module.Universe.globalInv#canCall| $Heap@@2 (_module.Object.universe this@@2)))) (= (_module.Object.objectGlobalInv $Heap@@2 this@@2)  (and (_module.Object.baseInv $Heap@@2 this@@2) (_module.Universe.globalInv $Heap@@2 (_module.Object.universe this@@2))))))
 :qid |_07CounterThreadOwnershipdfy.264:19|
 :skolemid |1005|
 :pattern ( (_module.Object.objectGlobalInv $Heap@@2 this@@2) ($IsGoodHeap $Heap@@2))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@3 this@@3) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Object) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@3)))))) (=> (_module.Object.inv $Heap@@3 this@@3) (_module.Object.localInv $Heap@@3 this@@3)))
 :qid |_07CounterThreadOwnershipdfy.273:19|
 :skolemid |1027|
 :pattern ( (_module.Object.inv $Heap@@3 this@@3))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_correct  (=> (= (_module.Object.objectGlobalInv $Heap@@4 this@@4)  (and (_module.Object.baseInv $Heap@@4 this@@4) (_module.Universe.globalInv $Heap@@4 (_module.Object.universe this@@4)))) (=> (and (and (|_module.Object.baseInv#canCall| $Heap@@4 this@@4) (=> (_module.Object.baseInv $Heap@@4 this@@4) (|_module.Universe.globalInv#canCall| $Heap@@4 (_module.Object.universe this@@4)))) ($Is boolType (bool_2_U (_module.Object.objectGlobalInv $Heap@@4 this@@4)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@1|)))))))
(let ((anon8_Else_correct  (=> (not (_module.Object.baseInv $Heap@@4 this@@4)) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 7) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (_module.Object.baseInv $Heap@@4 this@@4) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (_module.Object.universe this@@4) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@4) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@4)) Tclass._module.Universe? $Heap@@4) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@8) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@8) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@0)))
 :qid |_07CounterThreadOwnershipdfy.264:69|
 :skolemid |1007|
))) (|_module.Universe.globalInv#canCall| $Heap@@4 (_module.Object.universe this@@4))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 5) 3))) anon5_correct)))))))
(let ((anon7_Else_correct  (=> ($IsAllocBox ($Box refType this@@4) Tclass._module.Object? $Heap@@4) (=> (and (= |b$reqreads#0@0| (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@9) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@9) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@9 $f@@1)))
 :qid |_07CounterThreadOwnershipdfy.264:47|
 :skolemid |1006|
))) (|_module.Object.baseInv#canCall| $Heap@@4 this@@4)) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null $Heap@@4 alloc $Heap@@4 alloc)) (and (=> (= (ControlFlow 0 9) 1) anon7_Then_correct) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Object) ($IsAlloc refType this@@4 Tclass._module.Object $Heap@@4))) (and (= 10 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
