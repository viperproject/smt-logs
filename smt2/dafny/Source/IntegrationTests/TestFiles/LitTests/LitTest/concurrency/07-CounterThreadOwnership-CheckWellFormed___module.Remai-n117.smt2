...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@84) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@84 Tclass._module.Remaining $Heap@@49)) (=> ($IsAlloc refType this@@84 Tclass._module.Remaining $Heap@@49) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@49)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@49) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@49 current$Heap this@@84 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@49 current$Heap this@@84 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@84) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@84 Tclass._module.Remaining $Heap@@49))))))))))
