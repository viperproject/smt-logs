...
)) (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Universe.content)) ($Box refType |o#1|)) (|_module.Object.triggerAxioms#canCall| $Heap |o#1|)))
...
))) (= (_module.Universe.globalBaseInv $Heap this)  (and (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Universe.content)) ($Box refType |o#0@@0|))) (and (= (_module.Object.universe |o#0@@0|) this) (or (not (= |o#0@@0| this)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |652|
...
)) (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Universe.content)) ($Box refType |o#1@@0|))) (_module.Object.triggerAxioms $Heap |o#1@@0|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |653|
 :pattern ( (_module.Object.triggerAxioms $Heap |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Universe.content)) ($Box refType |o#1@@0|)))
))))))
 :qid |_09CounterNoStateMachinedfy.33:19|
 :skolemid |656|
 :pattern ( (_module.Universe.globalBaseInv $Heap this) ($IsGoodHeap $Heap))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@0 this@@0) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.Object) ($IsAlloc refType this@@0 Tclass._module.Object $Heap@@0)))))) (_module.Object.triggerAxioms $Heap@@0 this@@0))
 :qid |_09CounterNoStateMachinedfy.269:19|
 :skolemid |1309|
 :pattern ( (_module.Object.triggerAxioms $Heap@@0 this@@0))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon12_correct  (=> (= (_module.Universe.globalBaseInv $Heap@@2 this@@2)  (and (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#4|))) (and (= (_module.Object.universe |o#4|) this@@2) (or (not (= |o#4| this@@2)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |661|
 :pattern ( (_module.Object.universe |o#4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#4|)))
)) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#5|))) (_module.Object.triggerAxioms $Heap@@2 |o#5|))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |662|
 :pattern ( (_module.Object.triggerAxioms $Heap@@2 |o#5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#5|)))
)))) (=> (and (=> (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#4@@0|))) (and (= (_module.Object.universe |o#4@@0|) this@@2) (or (not (= |o#4@@0| this@@2)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |664|
 :pattern ( (_module.Object.universe |o#4@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#4@@0|)))
)) (forall ((|o#5@@0| T@U) ) (!  (=> ($Is refType |o#5@@0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#5@@0|)) (|_module.Object.triggerAxioms#canCall| $Heap@@2 |o#5@@0|)))
 :qid |_09CounterNoStateMachinedfy.35:16|
 :skolemid |663|
 :pattern ( (_module.Object.triggerAxioms $Heap@@2 |o#5@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#5@@0|)))
))) ($Is boolType (bool_2_U (_module.Universe.globalBaseInv $Heap@@2 this@@2)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#2@2|) (=> |b$reqreads#2@2| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#3@2|)))))))))
(let ((anon11_correct  (=> (= |b$reqreads#3@2| |b$reqreads#3@1|) (=> (and (= |b$reqreads#2@2| |b$reqreads#2@1|) (= (ControlFlow 0 7) 3)) anon12_correct))))
(let ((anon20_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#3@0|))) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 11) 7))) anon11_correct)))
(let ((anon20_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#3@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |o#3@0| null)) (not true))) (=> (or (not (= |o#3@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |o#3@0|) Tclass._module.Object? $Heap@@2) (= |b$reqreads#3@0| (forall (($o@@16 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@16) alloc)))) (= $o@@16 |o#3@0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@16 $f@@0)))
 :qid |_09CounterNoStateMachinedfy.35:46|
 :skolemid |657|
)))) (=> (and (and (|_module.Object.triggerAxioms#canCall| $Heap@@2 |o#3@0|) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= (ControlFlow 0 9) 7))) anon11_correct)))))))
(let ((anon19_Then_correct  (=> (and (and ($Is refType |o#3@0| Tclass._module.Object) ($IsAlloc refType |o#3@0| Tclass._module.Object $Heap@@2)) (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.Universe.content)))) (and (=> (= (ControlFlow 0 12) 9) anon20_Then_correct) (=> (= (ControlFlow 0 12) 11) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (and (not (and ($Is refType |o#3@0| Tclass._module.Object) ($IsAlloc refType |o#3@0| Tclass._module.Object $Heap@@2))) (= |b$reqreads#2@1| true)) (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 8) 7))) anon11_correct)))
(let ((anon18_Then_correct  (=> (forall ((|o#4@@1| T@U) ) (!  (=> (and ($Is refType |o#4@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#4@@1|))) (and (= (_module.Object.universe |o#4@@1|) this@@2) (or (not (= |o#4@@1| this@@2)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |658|
 :pattern ( (_module.Object.universe |o#4@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#4@@1|)))
)) (and (=> (= (ControlFlow 0 13) 12) anon19_Then_correct) (=> (= (ControlFlow 0 13) 8) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (and (not (forall ((|o#4@@2| T@U) ) (!  (=> (and ($Is refType |o#4@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#4@@2|))) (and (= (_module.Object.universe |o#4@@2|) this@@2) (or (not (= |o#4@@2| this@@2)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |658|
 :pattern ( (_module.Object.universe |o#4@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#4@@2|)))
))) (= |b$reqreads#3@2| true)) (and (= |b$reqreads#2@2| true) (= (ControlFlow 0 6) 3))) anon12_correct)))
(let ((anon17_Else_correct  (=> (and (or (not (= (_module.Object.universe |o#2@0|) this@@2)) (not true)) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 17) 13) anon18_Then_correct) (=> (= (ControlFlow 0 17) 6) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (= (_module.Object.universe |o#2@0|) this@@2) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 16) 13) anon18_Then_correct) (=> (= (ControlFlow 0 16) 6) anon18_Else_correct)))))
(let ((anon16_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#2@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |o#2@0| null)) (not true))) (=> (or (not (= |o#2@0| null)) (not true)) (and (=> (= (ControlFlow 0 18) 16) anon17_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Else_correct)))))))
(let ((anon16_Else_correct  (=> (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)) ($Box refType |o#2@0|))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 15) 13) anon18_Then_correct) (=> (= (ControlFlow 0 15) 6) anon18_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (and ($Is refType |o#2@0| Tclass._module.Object) ($IsAlloc refType |o#2@0| Tclass._module.Object $Heap@@2)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.Universe.content)))) (and (=> (= (ControlFlow 0 20) 18) anon16_Then_correct) (=> (= (ControlFlow 0 20) 15) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not (and ($Is refType |o#2@0| Tclass._module.Object) ($IsAlloc refType |o#2@0| Tclass._module.Object $Heap@@2))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 14) 13) anon18_Then_correct) (=> (= (ControlFlow 0 14) 6) anon18_Else_correct)))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Universe.content)))) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.Universe.content)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (and (=> (= (ControlFlow 0 21) 1) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon15_Then_correct)) (=> (= (ControlFlow 0 21) 14) anon15_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Universe) ($IsAlloc refType this@@2 Tclass._module.Universe $Heap@@2))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 23) 21))) anon0_correct))))
