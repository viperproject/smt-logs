...
(assert (distinct TagSet alloc allocName Tagclass._System.object? Tagclass._System.object Tagclass._module.Object Tagclass._module.OwnedObject Tagclass._module.Object? Tagclass._module.OwnedObject? Tagclass._module.OwnedU32? Tagclass._module.OwnedU32 class._module.Mutex? Tagclass._module.Mutex? Tagclass._module.MutexGuardU32 Tagclass._module.Mutex Tagclass._module.MutexGuardU32? tytagFamily$object tytagFamily$Object tytagFamily$OwnedObject tytagFamily$OwnedU32 tytagFamily$Mutex tytagFamily$MutexGuardU32 field$data field$guards)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@8 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#103| |l#0| |l#1| |l#2| |l#3|) $o@@8 $f))  (=> (and (or (not (= $o@@8 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@8) |l#2|)))) (= $o@@8 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3523|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#103| |l#0| |l#1| |l#2| |l#3|) $o@@8 $f))
)))
(assert (forall (($h@@15 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass._module.Mutex?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@9) _module.Mutex.data)) Tclass._module.OwnedU32))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2905|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@9) _module.Mutex.data)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap this) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Mutex) ($IsAlloc refType this Tclass._module.Mutex $Heap)))))) (= (_module.Mutex.objectUserFields $Heap this) (let ((|r#0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Mutex.data)))))
|r#0|)))
 :qid |_12MutexLifetimeshortdfy.763:18|
 :skolemid |2924|
 :pattern ( (_module.Mutex.objectUserFields $Heap this) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@0 this@@0) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.Mutex) ($IsAlloc refType this@@0 Tclass._module.Mutex $Heap@@0)))))) ($Is SetType (_module.Mutex.objectUserFields $Heap@@0 this@@0) (TSet Tclass._module.Object)))
 :qid |_12MutexLifetimeshortdfy.763:18|
 :skolemid |2921|
 :pattern ( (_module.Mutex.objectUserFields $Heap@@0 this@@0))
))))
(assert (forall (($h@@16 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass._module.Mutex?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@10) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@10) _module.Mutex.data)) Tclass._module.OwnedU32 $h@@16))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2906|
...
(assert (forall (($o@@12 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@12 Tclass._module.OwnedU32? $heap@@0) ($IsAlloc refType $o@@12 Tclass._module.OwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |3504|
 :pattern ( ($IsAlloc refType $o@@12 Tclass._module.OwnedU32? $heap@@0))
)))
(assert (forall (($o@@13 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@13 Tclass._module.Mutex? $heap@@1) ($IsAlloc refType $o@@13 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |3512|
 :pattern ( ($IsAlloc refType $o@@13 Tclass._module.Mutex? $heap@@1))
)))
(assert (forall (($o@@14 T@U) ($heap@@2 T@U) ) (!  (=> ($IsAlloc refType $o@@14 Tclass._module.MutexGuardU32? $heap@@2) ($IsAlloc refType $o@@14 Tclass._module.OwnedObject? $heap@@2))
 :qid |unknown.0:0|
 :skolemid |3516|
 :pattern ( ($IsAlloc refType $o@@14 Tclass._module.MutexGuardU32? $heap@@2))
)))
(assert (forall (($h@@17 T@U) ($o@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) Tclass._module.Mutex?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@15) _module.Mutex.guards)) (TSet Tclass._module.MutexGuardU32)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2910|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@15) _module.Mutex.guards)))
)))
(assert (forall (($h@@18 T@U) ($o@@16 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@18) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass._module.Mutex?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@16) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@18 $o@@16) _module.Mutex.guards)) (TSet Tclass._module.MutexGuardU32) $h@@18))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2911|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@1 this@@1) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (or (not (= this@@1 null)) (not true))) ($IsAlloc refType this@@1 Tclass._module.Mutex $Heap@@1)))) ($IsAlloc SetType (_module.Mutex.objectUserFields $Heap@@1 this@@1) (TSet Tclass._module.Object) $Heap@@1))
 :qid |_12MutexLifetimeshortdfy.763:18|
 :skolemid |2922|
 :pattern ( ($IsAlloc SetType (_module.Mutex.objectUserFields $Heap@@1 this@@1) (TSet Tclass._module.Object) $Heap@@1))
))))
...
(assert (forall (($o@@19 T@U) ) (!  (=> ($Is refType $o@@19 Tclass._module.OwnedU32?) ($Is refType $o@@19 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3503|
 :pattern ( ($Is refType $o@@19 Tclass._module.OwnedU32?))
)))
...
(assert (forall (($o@@20 T@U) ) (!  (=> ($Is refType $o@@20 Tclass._module.Mutex?) ($Is refType $o@@20 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3511|
 :pattern ( ($Is refType $o@@20 Tclass._module.Mutex?))
)))
(assert (forall ((bx@@20 T@U) ) (!  (=> ($IsBox bx@@20 Tclass._module.Mutex?) ($IsBox bx@@20 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3509|
 :pattern ( ($IsBox bx@@20 Tclass._module.Mutex?))
)))
(assert (forall (($o@@21 T@U) ) (!  (=> ($Is refType $o@@21 Tclass._module.MutexGuardU32?) ($Is refType $o@@21 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3515|
 :pattern ( ($Is refType $o@@21 Tclass._module.MutexGuardU32?))
)))
(assert (forall ((bx@@21 T@U) ) (!  (=> ($IsBox bx@@21 Tclass._module.MutexGuardU32?) ($IsBox bx@@21 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |3513|
...
(set-info :boogie-vc-id CheckWellformed$$_module.Mutex.objectUserFields)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.Mutex.guards))) (=> (and (and (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@2 _module.Mutex.data))) (= |let#0#0#0| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.data))))) (and ($Is SetType |let#0#0#0| (TSet Tclass._System.object)) (= |r#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($Is SetType |r#Z#0@0| (TSet Tclass._module.Object))) (=> ($Is SetType |r#Z#0@0| (TSet Tclass._module.Object)) (=> (and (= (_module.Mutex.objectUserFields $Heap@@2 this@@2) |r#Z#0@0|) ($Is SetType (_module.Mutex.objectUserFields $Heap@@2 this@@2) (TSet Tclass._module.Object))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@0|))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#103| null $Heap@@2 alloc this@@2)) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Mutex) ($IsAlloc refType this@@2 Tclass._module.Mutex $Heap@@2))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
