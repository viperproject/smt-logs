...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split85)
...
)))))))) (and (and (and (and ($IsGoodHeap $Heap@12) ($IsHeapAnchor $Heap@12)) (and (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (=> (_module.Universe.globalInv $Heap@11 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@4 $Heap@11 |universe#0|)))) (and (and (|_module.Universe.globalInv#canCall| $Heap@11 |universe#0|) (and (_module.Universe.globalInv $Heap@11 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@11 |universe#0|) (forall ((|o#17@@2| T@U) ) (!  (=> (and ($Is refType |o#17@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@2|))) (_module.Object.inv $Heap@11 |o#17@@2|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))))) (and (and (and (= $Heap@11 $Heap@12) (or (not (= |universe#0| null)) (not true))) (and (forall (($o@@133 T@U) ($f@@82 T@U) ) (!  (=> (and (and (or (not (= $o@@133 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@133) alloc)))) (or (= $o@@133 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType $o@@133)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@133 $f@@82)))
