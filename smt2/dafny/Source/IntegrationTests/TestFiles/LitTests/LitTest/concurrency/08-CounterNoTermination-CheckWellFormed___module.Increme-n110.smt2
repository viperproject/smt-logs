...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#106| null $Heap@@71 alloc |universe#0| |remaining#0|)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@71) (=> (and (|_module.Universe.globalInv#canCall| $Heap@@71 |universe#0|) (_module.Universe.globalInv $Heap@@71 |universe#0|)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= |running#0| null)) (not true))) (=> (or (not (= |running#0| null)) (not true)) (=> (= (_module.Object.universe |running#0|) |universe#0|) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= |running#0| null)) (not true))) (=> (or (not (= |running#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |running#0|) Tclass._module.Thread? $Heap@@71) (=> (and (|_module.Thread.inv#canCall| $Heap@@71 |running#0|) (_module.Thread.inv $Heap@@71 |running#0|)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (or (not (= |counter#0| null)) (not true))) (=> (or (not (= |counter#0| null)) (not true)) (=> (= (_module.Object.universe |counter#0|) |universe#0|) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= |counter#0| null)) (not true))) (=> (or (not (= |counter#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |counter#0|) Tclass._module.OwnedObject? $Heap@@71) (=> (and (|_module.OwnedObject.inv#canCall| $Heap@@71 |counter#0|) (_module.OwnedObject.inv $Heap@@71 |counter#0|)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= |remaining#0| null)) (not true))) (=> (or (not (= |remaining#0| null)) (not true)) (=> (= (_module.Object.universe |remaining#0|) |universe#0|) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |remaining#0| null)) (not true))) (=> (or (not (= |remaining#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |remaining#0|) Tclass._module.OwnedObject? $Heap@@71) (=> (and (|_module.OwnedObject.inv#canCall| $Heap@@71 |remaining#0|) (_module.OwnedObject.inv $Heap@@71 |remaining#0|)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= |remaining#0| null)) (not true))) (=> (or (not (= |remaining#0| null)) (not true)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 |remaining#0|) _module.OwnedObject.owner)) |running#0|) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |remaining#0| null)) (not true))) (=> (or (not (= |remaining#0| null)) (not true)) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 |remaining#0|) _module.Remaining.value))) (LitInt 10)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@94 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 $o@@94) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@94) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 $o@@94)) (or (= $o@@94 |universe#0|) (= $o@@94 |remaining#0|))))
 :qid |_08CounterNoTerminationdfy.473:3|
 :skolemid |1814|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@94))
)) ($HeapSucc $Heap@@71 $Heap@0))) (=> (and (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass._module.IncrementerMethod) ($IsAlloc refType this@0 Tclass._module.IncrementerMethod $Heap@0))) ($IsAllocBox ($Box refType this@0) Tclass._module.Object? $Heap@0)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@0) (_module.Object.objectGlobalInv $Heap@0 this@0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@71)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@71) (=> (|_module.Universe.globalInv2#canCall| $Heap@@71 $Heap@0 |universe#0|) (=> (and (and (_module.Universe.globalInv2 $Heap@@71 $Heap@0 |universe#0|) (= (_module.Object.universe this@0) |universe#0|)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.IncrementerMethod.counter)) |counter#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.IncrementerMethod.remaining)) |remaining#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.IncrementerMethod.remaining)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.IncrementerMethod.remaining)) null)) (not true)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.IncrementerMethod.remaining))) _module.OwnedObject.owner)) this@0) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.IncrementerMethod.programCounter))) (LitInt 0)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.OwnedObject.owner)) |running#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@71)))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@71) ($IsHeapAnchor $Heap@@71)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@71))) (=> (and (and (and ($Is refType |running#0| Tclass._module.Thread) ($IsAlloc refType |running#0| Tclass._module.Thread $Heap@@71)) (and ($Is refType |counter#0| Tclass._module.AtomicCounter) ($IsAlloc refType |counter#0| Tclass._module.AtomicCounter $Heap@@71))) (and (and ($Is refType |remaining#0| Tclass._module.Remaining) ($IsAlloc refType |remaining#0| Tclass._module.Remaining $Heap@@71)) (and (= 15 $FunctionContextHeight) (= (ControlFlow 0 17) 2)))) anon0_correct))))
