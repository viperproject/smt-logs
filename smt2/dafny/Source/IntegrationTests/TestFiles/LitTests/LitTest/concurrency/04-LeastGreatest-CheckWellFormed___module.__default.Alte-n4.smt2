...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.AlternativeEstablishInvA)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@13 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@13 $Heap@0)) (and (and ($IsAlloc refType |self#0@@13| Tclass._module.TraitA $Heap@0) (|_module.__default.invA#canCall| $Heap@0 |self#0@@13|)) (and (_module.__default.invA ($LS $LZ) $Heap@0 |self#0@@13|) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |self#0@@13| null)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (=> (and (and ($Is refType |self#0@@13| Tclass._module.TraitA) ($IsAlloc refType |self#0@@13| Tclass._module.TraitA $Heap@@13)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
