...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.ConstantInteger.localUserInv#canCall| $Heap@@3 this@@9) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.ConstantInteger)))) (= (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.ConstantInteger.localUserInv $Heap@@3 this@@9)))
 :qid |_10SequenceInvariantdfy.395:19|
 :skolemid |2010|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) ($Is refType this@@9 Tclass._module.ConstantInteger) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.ConstantInteger.localUserInv $Heap@@3 this@@9) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.ConstantInteger.userInv#canCall| $Heap@@4 this@@10) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.ConstantInteger)))) (= (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.ConstantInteger.userInv $Heap@@4 this@@10)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |2017|
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) ($Is refType this@@10 Tclass._module.ConstantInteger) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.ConstantInteger.userInv $Heap@@4 this@@10) ($IsGoodHeap $Heap@@4))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@5 this@@11) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.Thread)))) (= (_module.Object.baseFieldsInv $Heap@@5 this@@11) (_module.Thread.baseFieldsInv $Heap@@5 this@@11)))
 :qid |_10SequenceInvariantdfy.239:19|
 :skolemid |1192|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@5 this@@11) ($Is refType this@@11 Tclass._module.Thread) ($IsGoodHeap $Heap@@5))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@5 this@@11) (_module.Thread.baseFieldsInv $Heap@@5 this@@11) ($IsGoodHeap $Heap@@5))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.ConstantInteger.baseUserFieldsInv#canCall| $Heap@@6 this@@12) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@12 null)) (not true)) ($Is refType this@@12 Tclass._module.ConstantInteger)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) (_module.ConstantInteger.baseUserFieldsInv $Heap@@6 this@@12)))
 :qid |_10SequenceInvariantdfy.392:19|
 :skolemid |1989|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) ($Is refType this@@12 Tclass._module.ConstantInteger) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) (_module.ConstantInteger.baseUserFieldsInv $Heap@@6 this@@12) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@7 this@@13) (and (< 4 $FunctionContextHeight) (and (or (not (= this@@13 null)) (not true)) ($Is refType this@@13 Tclass._module.OwnedObject)))) (= (_module.Object.baseFieldsInv $Heap@@7 this@@13) (_module.OwnedObject.baseFieldsInv $Heap@@7 this@@13)))
 :qid |_10SequenceInvariantdfy.239:19|
 :skolemid |1445|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 this@@13) ($Is refType this@@13 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@7))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 this@@13) (_module.OwnedObject.baseFieldsInv $Heap@@7 this@@13) ($IsGoodHeap $Heap@@7))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@8 this@@14) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.Thread)))) (= (_module.Object.localInv $Heap@@8 this@@14) (_module.Thread.localInv $Heap@@8 this@@14)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1206|
 :pattern ( (_module.Object.localInv $Heap@@8 this@@14) ($Is refType this@@14 Tclass._module.Thread) ($IsGoodHeap $Heap@@8))
 :pattern ( (_module.Object.localInv $Heap@@8 this@@14) (_module.Thread.localInv $Heap@@8 this@@14) ($IsGoodHeap $Heap@@8))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@9 this@@15) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@15 null)) (not true)) ($Is refType this@@15 Tclass._module.OwnedObject)))) (= (_module.Object.localInv $Heap@@9 this@@15) (_module.OwnedObject.localInv $Heap@@9 this@@15)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1461|
 :pattern ( (_module.Object.localInv $Heap@@9 this@@15) ($Is refType this@@15 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.Object.localInv $Heap@@9 this@@15) (_module.OwnedObject.localInv $Heap@@9 this@@15) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@10 this@@16) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@16 null)) (not true)) ($Is refType this@@16 Tclass._module.Thread)))) (= (_module.Object.inv $Heap@@10 this@@16) (_module.Thread.inv $Heap@@10 this@@16)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1218|
 :pattern ( (_module.Object.inv $Heap@@10 this@@16) ($Is refType this@@16 Tclass._module.Thread) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.Object.inv $Heap@@10 this@@16) (_module.Thread.inv $Heap@@10 this@@16) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@11 this@@17) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@17 null)) (not true)) ($Is refType this@@17 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@11 this@@17) (_module.OwnedObject.inv $Heap@@11 this@@17)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1474|
...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($prevHeap@@21 T@U) ($Heap@@13 T@U) (this@@33 T@U) (|running#0@@2| T@U) ) (!  (=> (or (|_module.Universe.legalTransition#canCall| $prevHeap@@21 $Heap@@13 this@@33 |running#0@@2|) (and (< 12 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@21) ($IsGoodHeap $Heap@@13)) ($HeapSucc $prevHeap@@21 $Heap@@13)) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.Universe) ($IsAlloc refType this@@33 Tclass._module.Universe $prevHeap@@21)))) ($Is refType |running#0@@2| Tclass._module.Thread)))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@21 $Heap@@13 this@@33 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (=> (_module.Universe.legalTransitionsSequence $prevHeap@@21 $Heap@@13 this@@33 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (and (|_module.Universe.globalInv#canCall| $prevHeap@@21 this@@33) (=> (_module.Universe.globalInv $prevHeap@@21 this@@33) (and (forall ((|o#0@@2| T@U) ) (!  (=> ($Is refType |o#0@@2| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@21 this@@33) _module.Universe.content)) ($Box refType |o#0@@2|)) (and (=> (not (forall (($o@@27 T@U) ($f@@19 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 |o#0@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@27) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@21 $o@@27) $f@@19))))
 ...
 :skolemid |707|
 :pattern ( (_module.Universe.legalTransition $prevHeap@@21 $Heap@@13 this@@33 |running#0@@2|) ($IsGoodHeap $Heap@@13))
))))
...
(assert (forall (($o@@39 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@39 Tclass._module.ConstantInteger? $heap@@1) ($IsAlloc refType $o@@39 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |2422|
 :pattern ( ($IsAlloc refType $o@@39 Tclass._module.ConstantInteger? $heap@@1))
)))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($prevHeap@@37 T@U) ($Heap@@35 T@U) (this@@55 T@U) (|running#0@@3| T@U) ) (!  (=> (or (|_module.Object.goodPreAndLegalChanges#canCall| $prevHeap@@37 $Heap@@35 this@@55 |running#0@@3|) (and (< 13 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@37) ($IsGoodHeap $Heap@@35)) ($HeapSucc $prevHeap@@37 $Heap@@35)) (and (or (not (= this@@55 null)) (not true)) (and ($Is refType this@@55 Tclass._module.Object) ($IsAlloc refType this@@55 Tclass._module.Object $prevHeap@@37)))) ($Is refType |running#0@@3| Tclass._module.Thread)))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@37 (_module.Object.universe this@@55)) _module.Universe.content)) ($Box refType this@@55)) (=> (forall (($o@@40 T@U) ($f@@26 T@U) ) (!  (=> (or (not (= $o@@40 null)) (not true)) (=> (= $o@@40 this@@55) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@35 $o@@40) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@37 $o@@40) $f@@26))))
 :qid |_10SequenceInvariantdfy.233:8|
 :skolemid |1098|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@35 $o@@40) $f@@26))
)) (|_module.Universe.legalTransition#canCall| $prevHeap@@37 $Heap@@35 (_module.Object.universe this@@55) |running#0@@3|))) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@37 $Heap@@35 this@@55 |running#0@@3|)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@37 (_module.Object.universe this@@55)) _module.Universe.content)) ($Box refType this@@55)) (forall (($o@@41 T@U) ($f@@27 T@U) ) (!  (=> (or (not (= $o@@41 null)) (not true)) (=> (= $o@@41 this@@55) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@35 $o@@41) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@37 $o@@41) $f@@27))))
 :qid |_10SequenceInvariantdfy.233:8|
 :skolemid |1097|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@35 $o@@41) $f@@27))
))) (_module.Universe.legalTransition $prevHeap@@37 $Heap@@35 (_module.Object.universe this@@55) |running#0@@3|)))))
 :qid |_10SequenceInvariantdfy.231:22|
 :skolemid |1099|
 :pattern ( (_module.Object.goodPreAndLegalChanges $prevHeap@@37 $Heap@@35 this@@55 |running#0@@3|) ($IsGoodHeap $Heap@@35))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@38 T@U) ($Heap@@36 T@U) (this@@56 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@38 $Heap@@36 this@@56) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@38) ($IsGoodHeap $Heap@@36)) ($HeapSucc $prevHeap@@38 $Heap@@36)) (and (or (not (= this@@56 null)) (not true)) (and ($Is refType this@@56 Tclass._module.Thread) ($IsAlloc refType this@@56 Tclass._module.Thread $prevHeap@@38)))))) (= (_module.Thread.localInv2 $prevHeap@@38 $Heap@@36 this@@56) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.266:22|
 :skolemid |1229|
 :pattern ( (_module.Thread.localInv2 $prevHeap@@38 $Heap@@36 this@@56) ($IsGoodHeap $Heap@@36))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@39 T@U) ($Heap@@37 T@U) (this@@57 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@39 $Heap@@37 this@@57) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@39) ($IsGoodHeap $Heap@@37)) ($HeapSucc $prevHeap@@39 $Heap@@37)) (and (or (not (= this@@57 null)) (not true)) (and ($Is refType this@@57 Tclass._module.Thread) ($IsAlloc refType this@@57 Tclass._module.Thread $prevHeap@@39)))))) (= (_module.Thread.sequenceInv2 $prevHeap@@39 $Heap@@37 this@@57) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.269:22|
 :skolemid |1236|
 :pattern ( (_module.Thread.sequenceInv2 $prevHeap@@39 $Heap@@37 this@@57) ($IsGoodHeap $Heap@@37))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@40 T@U) ($Heap@@38 T@U) (this@@58 T@U) ) (!  (=> (or (|_module.ConstantInteger.userInv2#canCall| $prevHeap@@40 $Heap@@38 this@@58) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@40) ($IsGoodHeap $Heap@@38)) ($HeapSucc $prevHeap@@40 $Heap@@38)) (and (or (not (= this@@58 null)) (not true)) (and ($Is refType this@@58 Tclass._module.ConstantInteger) ($IsAlloc refType this@@58 Tclass._module.ConstantInteger $prevHeap@@40)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.ConstantInteger.localUserInv2#canCall| $prevHeap@@40 $Heap@@38 this@@58)) (= (_module.ConstantInteger.userInv2 $prevHeap@@40 $Heap@@38 this@@58)  (and true (_module.ConstantInteger.localUserInv2 $prevHeap@@40 $Heap@@38 this@@58)))))
 :qid |_10SequenceInvariantdfy.522:22|
 :skolemid |2031|
 :pattern ( (_module.ConstantInteger.userInv2 $prevHeap@@40 $Heap@@38 this@@58) ($IsGoodHeap $Heap@@38))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@41 T@U) ($Heap@@39 T@U) (this@@59 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@41 $Heap@@39 this@@59) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@41) ($IsGoodHeap $Heap@@39)) ($HeapSucc $prevHeap@@41 $Heap@@39)) (and (or (not (= this@@59 null)) (not true)) (and ($Is refType this@@59 Tclass._module.OwnedObject) ($IsAlloc refType this@@59 Tclass._module.OwnedObject $prevHeap@@41)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.localUserInv2#canCall| $prevHeap@@41 $Heap@@39 this@@59)) (= (_module.OwnedObject.localInv2 $prevHeap@@41 $Heap@@39 this@@59)  (and true (_module.OwnedObject.localUserInv2 $prevHeap@@41 $Heap@@39 this@@59)))))
 :qid |_10SequenceInvariantdfy.334:22|
 :skolemid |1486|
 :pattern ( (_module.OwnedObject.localInv2 $prevHeap@@41 $Heap@@39 this@@59) ($IsGoodHeap $Heap@@39))
))))
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@60 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@60 null)) (not true)) ($Is refType this@@60 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@42 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@42 null)) (not true)) (or (= $o@@42 this@@60) (= $o@@42 (_module.Object.universe this@@60)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@42) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@42) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |1108|
...
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@61 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@61 null)) (not true)) ($Is refType this@@61 Tclass._module.Thread))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@43 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@43 null)) (not true)) (or (= $o@@43 this@@61) (= $o@@43 (_module.Object.universe this@@61)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@43) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@43) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |1187|
...
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@62 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@62 null)) (not true)) ($Is refType this@@62 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@44 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@44 null)) (not true)) (or (= $o@@44 this@@62) (= $o@@44 (_module.Object.universe this@@62)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@44) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@44) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |1440|
...
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@63 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@63 null)) (not true)) ($Is refType this@@63 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@45 T@U) ($f@@31 T@U) ) (!  (=> (and (or (not (= $o@@45 null)) (not true)) (or (= $o@@45 this@@63) (= $o@@45 (_module.Object.universe this@@63)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@45) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@45) $f@@31)))
 :qid |unknown.0:0|
 :skolemid |1529|
...
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@64 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@64 null)) (not true)) ($Is refType this@@64 Tclass._module.ConstantInteger))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@46 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (or (= $o@@46 this@@64) (= $o@@46 (_module.Object.universe this@@64)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@46) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@46) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |1984|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@42 T@U) ($Heap@@49 T@U) (this@@74 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@42 $Heap@@49 this@@74) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@42) ($IsGoodHeap $Heap@@49)) ($HeapSucc $prevHeap@@42 $Heap@@49)) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.OwnedObject) ($IsAlloc refType this@@74 Tclass._module.OwnedObject $prevHeap@@42)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@42 this@@74) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 this@@74) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@42 $Heap@@49 this@@74)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@42 $Heap@@49 this@@74)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@42 this@@74) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@49 this@@74) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@42 $Heap@@49 this@@74)))))
 :qid |_10SequenceInvariantdfy.312:22|
 :skolemid |1438|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@42 $Heap@@49 this@@74) ($IsGoodHeap $Heap@@49))
))))
...
(assert (forall (($h@@15 T@U) ($o@@47 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@15) (and (or (not (= $o@@47 null)) (not true)) ($Is refType $o@@47 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@47) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@47) _module.OwnedObject.nonvolatileVersion)) TInt $h@@15))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1425|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@15 $o@@47) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@75 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@75 null)) (not true)) ($Is refType this@@75 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@48 T@U) ($f@@33 T@U) ) (!  (=> (and (or (not (= $o@@48 null)) (not true)) (= $o@@48 this@@75)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@48) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@48) $f@@33)))
 :qid |unknown.0:0|
 :skolemid |1062|
...
(assert (forall (($h@@16 T@U) ($o@@49 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@49 null)) (not true)) (= (dtype $o@@49) Tclass._module.ConstantInteger?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@49) _module.ConstantInteger.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1982|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@49) _module.ConstantInteger.value)))
)))
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@76 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@76 null)) (not true)) ($Is refType this@@76 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@50 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@50 null)) (not true)) (or (= $o@@50 this@@76) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 this@@76) _module.Universe.content)) ($Box refType $o@@50)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@50) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@50) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |608|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@43 T@U) ($Heap@@50 T@U) (this@@77 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@43 $Heap@@50 this@@77) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@43) ($IsGoodHeap $Heap@@50)) ($HeapSucc $prevHeap@@43 $Heap@@50)) (and (or (not (= this@@77 null)) (not true)) (and ($Is refType this@@77 Tclass._module.OwnedObject) ($IsAlloc refType this@@77 Tclass._module.OwnedObject $prevHeap@@43)))))) (and (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@43 this@@77) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@50 this@@77) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@43 this@@77) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@50 this@@77) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@43 $Heap@@50 this@@77)))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@43 $Heap@@50 this@@77)  (and (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@43 this@@77) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@50 this@@77) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@43 this@@77) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@50 this@@77) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@43 $Heap@@50 this@@77)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@43 this@@77) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@43 this@@77) _module.OwnedObject.owner))))
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@43 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@50 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@43 this@@77) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@50 this@@77) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_10SequenceInvariantdfy.338:22|
 :skolemid |1494|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@43 $Heap@@50 this@@77) ($IsGoodHeap $Heap@@50))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($prevHeap@@44 T@U) ($Heap@@51 T@U) (this@@78 T@U) (|running#0@@4| T@U) ) (!  (=> (or (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@44 $Heap@@51 this@@78 |running#0@@4|) (and (< 8 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@44) ($IsGoodHeap $Heap@@51)) ($HeapSucc $prevHeap@@44 $Heap@@51)) (and (or (not (= this@@78 null)) (not true)) (and ($Is refType this@@78 Tclass._module.Universe) ($IsAlloc refType this@@78 Tclass._module.Universe $prevHeap@@44)))) ($Is SetType |running#0@@4| (TSet Tclass._module.Thread))))) (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $prevHeap@@44 $Heap@@51 this@@78) (=> (_module.Universe.baseLegalTransitionsSequence $prevHeap@@44 $Heap@@51 this@@78) (forall ((|o#0@@7| T@U) ) (!  (=> ($Is refType |o#0@@7| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 this@@78) _module.Universe.content)) ($Box refType |o#0@@7|)) (=> (not (forall (($o@@51 T@U) ($f@@35 T@U) ) (!  (=> (or (not (= $o@@51 null)) (not true)) (=> (= $o@@51 |o#0@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 $o@@51) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 $o@@51) $f@@35))))
...
))) (|_module.Object.sequenceInv2#canCall| $prevHeap@@44 $Heap@@51 |o#0@@7|))))
 :qid |_10SequenceInvariantdfy.55:16|
 :skolemid |671|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@44 $Heap@@51 |o#0@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 this@@78) _module.Universe.content)) ($Box refType |o#0@@7|)))
)))) (= (_module.Universe.legalTransitionsSequence $prevHeap@@44 $Heap@@51 this@@78 |running#0@@4|)  (and (and (_module.Universe.baseLegalTransitionsSequence $prevHeap@@44 $Heap@@51 this@@78) (forall ((|o#0@@8| T@U) ) (!  (=> (and ($Is refType |o#0@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 this@@78) _module.Universe.content)) ($Box refType |o#0@@8|))) (or (forall (($o@@52 T@U) ($f@@36 T@U) ) (!  (=> (or (not (= $o@@52 null)) (not true)) (=> (= $o@@52 |o#0@@8|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 $o@@52) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 $o@@52) $f@@36))))
 :qid |_10SequenceInvariantdfy.55:49|
 :skolemid |667|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 $o@@52) $f@@36))
)) (_module.Object.sequenceInv2 $prevHeap@@44 $Heap@@51 |o#0@@8|)))
 :qid |_10SequenceInvariantdfy.55:16|
 :skolemid |668|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@44 $Heap@@51 |o#0@@8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 this@@78) _module.Universe.content)) ($Box refType |o#0@@8|)))
))) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 this@@78) _module.Universe.content)) ($Box refType |o#1@@1|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 |o#1@@1|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| |running#0@@4| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 |o#1@@1|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 |o#1@@1|) _module.OwnedObject.owner) Tclass._module.Object $prevHeap@@44)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 |o#1@@1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |o#1@@1|) _module.OwnedObject.nonvolatileVersion))))))
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 |o#1@@1|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 |o#1@@1|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@44 this@@78) _module.Universe.content)) ($Box refType |o#1@@1|)))
))))))
 :qid |_10SequenceInvariantdfy.51:22|
 :skolemid |674|
 :pattern ( (_module.Universe.legalTransitionsSequence $prevHeap@@44 $Heap@@51 this@@78 |running#0@@4|) ($IsGoodHeap $Heap@@51))
))))
(assert (forall (($h@@17 T@U) ($o@@53 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@17) (and (or (not (= $o@@53 null)) (not true)) ($Is refType $o@@53 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@53) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@53) _module.OwnedObject.owner)) Tclass._module.Object $h@@17))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1427|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@17 $o@@53) _module.OwnedObject.owner)))
)))
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@79 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@79 null)) (not true)) (and ($Is refType this@@79 Tclass._module.Universe) ($IsAlloc refType this@@79 Tclass._module.Universe $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@54 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@54) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@54) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@54) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |620|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@80 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@80 null)) (not true)) (and ($Is refType this@@80 Tclass._module.Object) ($IsAlloc refType this@@80 Tclass._module.Object $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@55 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@55 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@55) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@55) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@55) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1042|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@81 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@81 null)) (not true)) (and ($Is refType this@@81 Tclass._module.Object) ($IsAlloc refType this@@81 Tclass._module.Object $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@56 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@56 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@56) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@56) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@56) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1114|
)) (= (_module.Object.localInv $h0@@28 this@@81) (_module.Object.localInv $h1@@28 this@@81))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1115|
 :pattern ( ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28) (_module.Object.localInv $h1@@28 this@@81))
)))
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@82 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@82 null)) (not true)) (and ($Is refType this@@82 Tclass._module.Object) ($IsAlloc refType this@@82 Tclass._module.Object $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@57 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@57 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@57) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@57) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@57) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1124|
)) (= (_module.Object.inv $h0@@29 this@@82) (_module.Object.inv $h1@@29 this@@82))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1125|
 :pattern ( ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29) (_module.Object.inv $h1@@29 this@@82))
)))
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@83 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@83 null)) (not true)) (and ($Is refType this@@83 Tclass._module.Thread) ($IsAlloc refType this@@83 Tclass._module.Thread $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@58 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@58) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@58) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@58) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1201|
)) (= (_module.Thread.localInv $h0@@30 this@@83) (_module.Thread.localInv $h1@@30 this@@83))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1202|
 :pattern ( ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30) (_module.Thread.localInv $h1@@30 this@@83))
)))
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@84 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@84 null)) (not true)) (and ($Is refType this@@84 Tclass._module.Thread) ($IsAlloc refType this@@84 Tclass._module.Thread $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@59 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@59) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@59) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@59) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1213|
)) (= (_module.Thread.inv $h0@@31 this@@84) (_module.Thread.inv $h1@@31 this@@84))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1214|
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.Thread.inv $h1@@31 this@@84))
)))
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@85 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@85 null)) (not true)) (and ($Is refType this@@85 Tclass._module.OwnedObject) ($IsAlloc refType this@@85 Tclass._module.OwnedObject $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@60 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@60 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@60) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@60) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@60) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1456|
)) (= (_module.OwnedObject.localInv $h0@@32 this@@85) (_module.OwnedObject.localInv $h1@@32 this@@85))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1457|
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.OwnedObject.localInv $h1@@32 this@@85))
)))
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@86 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@86 null)) (not true)) (and ($Is refType this@@86 Tclass._module.OwnedObject) ($IsAlloc refType this@@86 Tclass._module.OwnedObject $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@61 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@61 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@61) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@61) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@61) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1469|
)) (= (_module.OwnedObject.inv $h0@@33 this@@86) (_module.OwnedObject.inv $h1@@33 this@@86))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1470|
 :pattern ( ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33) (_module.OwnedObject.inv $h1@@33 this@@86))
)))
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@87 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@87 null)) (not true)) (and ($Is refType this@@87 Tclass._module.OwnedObject) ($IsAlloc refType this@@87 Tclass._module.OwnedObject $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@62 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@62 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@62) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@62) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@62) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1539|
)) (= (_module.OwnedObject.localUserInv $h0@@34 this@@87) (_module.OwnedObject.localUserInv $h1@@34 this@@87))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1540|
 :pattern ( ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34) (_module.OwnedObject.localUserInv $h1@@34 this@@87))
)))
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@88 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@88 null)) (not true)) (and ($Is refType this@@88 Tclass._module.OwnedObject) ($IsAlloc refType this@@88 Tclass._module.OwnedObject $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@63 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@63) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@63) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@63) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |1547|
)) (= (_module.OwnedObject.userInv $h0@@35 this@@88) (_module.OwnedObject.userInv $h1@@35 this@@88))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1548|
 :pattern ( ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35) (_module.OwnedObject.userInv $h1@@35 this@@88))
)))
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@89 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@89 null)) (not true)) (and ($Is refType this@@89 Tclass._module.ConstantInteger) ($IsAlloc refType this@@89 Tclass._module.ConstantInteger $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@64 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@64) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@64) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@64) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |2005|
)) (= (_module.ConstantInteger.localUserInv $h0@@36 this@@89) (_module.ConstantInteger.localUserInv $h1@@36 this@@89))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2006|
 :pattern ( ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36) (_module.ConstantInteger.localUserInv $h1@@36 this@@89))
)))
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.ConstantInteger) ($IsAlloc refType this@@90 Tclass._module.ConstantInteger $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@65 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@65) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@65) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |2012|
)) (= (_module.ConstantInteger.userInv $h0@@37 this@@90) (_module.ConstantInteger.userInv $h1@@37 this@@90))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2013|
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.ConstantInteger.userInv $h1@@37 this@@90))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@45 T@U) ($Heap@@52 T@U) (this@@91 T@U) ) (!  (=> (or (|_module.ConstantInteger.userInv2#canCall| $prevHeap@@45 $Heap@@52 this@@91) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@45) ($IsGoodHeap $Heap@@52)) ($HeapSucc $prevHeap@@45 $Heap@@52)) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.ConstantInteger) ($IsAlloc refType this@@91 Tclass._module.ConstantInteger $prevHeap@@45)))))) (=> (_module.ConstantInteger.userInv2 $prevHeap@@45 $Heap@@52 this@@91) (_module.ConstantInteger.localUserInv2 $prevHeap@@45 $Heap@@52 this@@91)))
 :qid |_10SequenceInvariantdfy.522:22|
 :skolemid |2029|
 :pattern ( (_module.ConstantInteger.userInv2 $prevHeap@@45 $Heap@@52 this@@91))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@46 T@U) ($Heap@@53 T@U) (this@@92 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv2#canCall| $prevHeap@@46 $Heap@@53 this@@92) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@46) ($IsGoodHeap $Heap@@53)) ($HeapSucc $prevHeap@@46 $Heap@@53)) (and (or (not (= this@@92 null)) (not true)) (and ($Is refType this@@92 Tclass._module.OwnedObject) ($IsAlloc refType this@@92 Tclass._module.OwnedObject $prevHeap@@46)))))) (=> (_module.OwnedObject.userInv2 $prevHeap@@46 $Heap@@53 this@@92) (_module.OwnedObject.localUserInv2 $prevHeap@@46 $Heap@@53 this@@92)))
 :qid |_10SequenceInvariantdfy.398:22|
 :skolemid |1553|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@46 $Heap@@53 this@@92))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@54 T@U) (this@@93 T@U) ) (!  (=> (or (|_module.ConstantInteger.userInv#canCall| $Heap@@54 this@@93) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@54) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.ConstantInteger) ($IsAlloc refType this@@93 Tclass._module.ConstantInteger $Heap@@54)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.ConstantInteger.localUserInv#canCall| $Heap@@54 this@@93)) (= (_module.ConstantInteger.userInv $Heap@@54 this@@93)  (and true (_module.ConstantInteger.localUserInv $Heap@@54 this@@93)))))
 :qid |_10SequenceInvariantdfy.515:19|
 :skolemid |2016|
 :pattern ( (_module.ConstantInteger.userInv $Heap@@54 this@@93) ($IsGoodHeap $Heap@@54))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@55 T@U) (this@@94 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@55 this@@94) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@55) (and (or (not (= this@@94 null)) (not true)) (and ($Is refType this@@94 Tclass._module.Thread) ($IsAlloc refType this@@94 Tclass._module.Thread $Heap@@55)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@55 this@@94)) (= (_module.Thread.localInv $Heap@@55 this@@94)  (and true (_module.Object.objectGlobalBaseInv $Heap@@55 this@@94)))))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1205|
 :pattern ( (_module.Thread.localInv $Heap@@55 this@@94) ($IsGoodHeap $Heap@@55))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@56 T@U) (this@@95 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@56 this@@95) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@56) (and (or (not (= this@@95 null)) (not true)) (and ($Is refType this@@95 Tclass._module.Thread) ($IsAlloc refType this@@95 Tclass._module.Thread $Heap@@56)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@56 this@@95)) (= (_module.Thread.inv $Heap@@56 this@@95)  (and true (_module.Thread.localInv $Heap@@56 this@@95)))))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1217|
 :pattern ( (_module.Thread.inv $Heap@@56 this@@95) ($IsGoodHeap $Heap@@56))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@57 T@U) (this@@96 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@57 this@@96) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@57) (and (or (not (= this@@96 null)) (not true)) (and ($Is refType this@@96 Tclass._module.Object) ($IsAlloc refType this@@96 Tclass._module.Object $Heap@@57)))))) (= (_module.Object.triggerAxioms $Heap@@57 this@@96)  (and (or ($Is refType this@@96 Tclass._module.OwnedObject) ($Is refType this@@96 Tclass._module.Thread)) (not (and ($Is refType this@@96 Tclass._module.OwnedObject) ($Is refType this@@96 Tclass._module.Thread))))))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1066|
 :pattern ( (_module.Object.triggerAxioms $Heap@@57 this@@96) ($IsGoodHeap $Heap@@57))
))))
...
(declare-fun this@@97 () T@U)
(declare-fun |running#0@@5| () T@U)
(declare-fun previous$Heap () T@U)
(set-info :boogie-vc-id OverrideCheck$$_module.ConstantInteger.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon0_correct  (=> (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType this@@97))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType this@@97)))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (forall (($o@@75 T@U) ($f@@49 T@U) ) (!  (=> (or (not (= $o@@75 null)) (not true)) (=> (= $o@@75 this@@97) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@75) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 $o@@75) $f@@49))))
 :qid |_10SequenceInvariantdfy.233:8|
 :skolemid |2079|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@75) $f@@49))
))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (forall (($o@@76 T@U) ($f@@50 T@U) ) (!  (=> (or (not (= $o@@76 null)) (not true)) (=> (= $o@@76 this@@97) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@76) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 $o@@76) $f@@50))))
 :qid |_10SequenceInvariantdfy.233:8|
 :skolemid |2079|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@76) $f@@50))
)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@58 (_module.Object.universe this@@97)) (or (_module.Universe.globalBaseInv $Heap@@58 (_module.Object.universe this@@97)) (forall ((|o#0@@9| T@U) ) (!  (=> (and ($Is refType |o#0@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#0@@9|))) (and (and (and (= (_module.Object.universe |o#0@@9|) (_module.Object.universe this@@97)) (or (not (= |o#0@@9| (_module.Object.universe this@@97))) (not true))) (_module.Object.baseFieldsInv $Heap@@58 |o#0@@9|)) (_module.Object.triggerAxioms $Heap@@58 |o#0@@9|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2080|
 :pattern ( (_module.Object.triggerAxioms $Heap@@58 |o#0@@9|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@58 |o#0@@9|))
 :pattern ( (_module.Object.universe |o#0@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#0@@9|)))
))))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@58 (_module.Object.universe this@@97)) (or (_module.Universe.globalBaseInv $Heap@@58 (_module.Object.universe this@@97)) (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#0@@10|))) (and (and (and (= (_module.Object.universe |o#0@@10|) (_module.Object.universe this@@97)) (or (not (= |o#0@@10| (_module.Object.universe this@@97))) (not true))) (_module.Object.baseFieldsInv $Heap@@58 |o#0@@10|)) (_module.Object.triggerAxioms $Heap@@58 |o#0@@10|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2080|
 :pattern ( (_module.Object.triggerAxioms $Heap@@58 |o#0@@10|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@58 |o#0@@10|))
 :pattern ( (_module.Object.universe |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#0@@10|)))
)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@97)) (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#1@@2|))) (and (and (and (= (_module.Object.universe |o#1@@2|) (_module.Object.universe this@@97)) (or (not (= |o#1@@2| (_module.Object.universe this@@97))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#1@@2|)) (_module.Object.triggerAxioms current$Heap |o#1@@2|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2082|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#1@@2|)))
))))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@97)) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#1@@3|))) (and (and (and (= (_module.Object.universe |o#1@@3|) (_module.Object.universe this@@97)) (or (not (= |o#1@@3| (_module.Object.universe this@@97))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#1@@3|)) (_module.Object.triggerAxioms current$Heap |o#1@@3|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2082|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#1@@3|)))
)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97)) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#2|)))) (not ($IsAllocBox ($Box refType |o#2|) Tclass._module.Object $Heap@@58)))
 :qid |_10SequenceInvariantdfy.43:16|
 :skolemid |2084|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#2|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97)) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#2@@0|)))) (not ($IsAllocBox ($Box refType |o#2@@0|) Tclass._module.Object $Heap@@58)))
 :qid |_10SequenceInvariantdfy.43:16|
 :skolemid |2084|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#2@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#3|))) (or (forall (($o@@77 T@U) ($f@@51 T@U) ) (!  (=> (or (not (= $o@@77 null)) (not true)) (=> (= $o@@77 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@77) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 $o@@77) $f@@51))))
 :qid |_10SequenceInvariantdfy.55:49|
 :skolemid |2086|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@77) $f@@51))
)) (_module.Object.sequenceInv2 $Heap@@58 current$Heap |o#3|)))
 :qid |_10SequenceInvariantdfy.55:16|
 :skolemid |2087|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@58 current$Heap |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#3@@0|))) (or (forall (($o@@78 T@U) ($f@@52 T@U) ) (!  (=> (or (not (= $o@@78 null)) (not true)) (=> (= $o@@78 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@78) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 $o@@78) $f@@52))))
 :qid |_10SequenceInvariantdfy.55:49|
 :skolemid |2086|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@78) $f@@52))
)) (_module.Object.sequenceInv2 $Heap@@58 current$Heap |o#3@@0|)))
 :qid |_10SequenceInvariantdfy.55:16|
 :skolemid |2087|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@58 current$Heap |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#4|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@58)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#4|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_10SequenceInvariantdfy.58:16|
 :skolemid |2088|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#4|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@58 current$Heap (_module.Object.universe this@@97) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#4@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4@@0|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@58)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#4@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_10SequenceInvariantdfy.58:16|
 :skolemid |2088|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 |o#4@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@58 (_module.Object.universe this@@97)) (or (_module.Universe.globalInv $Heap@@58 (_module.Object.universe this@@97)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@58 (_module.Object.universe this@@97)) (or (_module.Universe.globalBaseInv $Heap@@58 (_module.Object.universe this@@97)) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#5|))) (and (and (and (= (_module.Object.universe |o#5|) (_module.Object.universe this@@97)) (or (not (= |o#5| (_module.Object.universe this@@97))) (not true))) (_module.Object.baseFieldsInv $Heap@@58 |o#5|)) (_module.Object.triggerAxioms $Heap@@58 |o#5|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2092|
 :pattern ( (_module.Object.triggerAxioms $Heap@@58 |o#5|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@58 |o#5|))
 :pattern ( (_module.Object.universe |o#5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#5|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@58 (_module.Object.universe this@@97)) (or (_module.Universe.globalInv $Heap@@58 (_module.Object.universe this@@97)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@58 (_module.Object.universe this@@97)) (or (_module.Universe.globalBaseInv $Heap@@58 (_module.Object.universe this@@97)) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#5@@0|))) (and (and (and (= (_module.Object.universe |o#5@@0|) (_module.Object.universe this@@97)) (or (not (= |o#5@@0| (_module.Object.universe this@@97))) (not true))) (_module.Object.baseFieldsInv $Heap@@58 |o#5@@0|)) (_module.Object.triggerAxioms $Heap@@58 |o#5@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2092|
 :pattern ( (_module.Object.triggerAxioms $Heap@@58 |o#5@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@58 |o#5@@0|))
 :pattern ( (_module.Object.universe |o#5@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#5@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@58 (_module.Object.universe this@@97)) (or (_module.Universe.globalInv $Heap@@58 (_module.Object.universe this@@97)) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#6|))) (_module.Object.inv $Heap@@58 |o#6|))
 :qid |_10SequenceInvariantdfy.22:32|
 :skolemid |2094|
 :pattern ( (_module.Object.inv $Heap@@58 |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#6|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@58 (_module.Object.universe this@@97)) (or (_module.Universe.globalInv $Heap@@58 (_module.Object.universe this@@97)) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#6@@0|))) (_module.Object.inv $Heap@@58 |o#6@@0|))
 :qid |_10SequenceInvariantdfy.22:32|
 :skolemid |2094|
 :pattern ( (_module.Object.inv $Heap@@58 |o#6@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#6@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#7|))) (and (or (forall (($o@@79 T@U) ($f@@53 T@U) ) (!  (=> (or (not (= $o@@79 null)) (not true)) (=> (= $o@@79 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@79) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 $o@@79) $f@@53))))
 :qid |_10SequenceInvariantdfy.71:49|
 :skolemid |2096|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@79) $f@@53))
)) (_module.Object.inv current$Heap |o#7|)) (or (forall (($o@@80 T@U) ($f@@54 T@U) ) (!  (=> (or (not (= $o@@80 null)) (not true)) (=> (= $o@@80 |o#7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@80) $f@@54) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 $o@@80) $f@@54))))
 :qid |_10SequenceInvariantdfy.71:49|
 :skolemid |2097|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@80) $f@@54))
)) (_module.Object.inv2 $Heap@@58 current$Heap |o#7|))))
 :qid |_10SequenceInvariantdfy.71:16|
 :skolemid |2098|
 :pattern ( (_module.Object.inv2 $Heap@@58 current$Heap |o#7|))
 :pattern ( (_module.Object.inv current$Heap |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#7|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (or (forall (($o@@81 T@U) ($f@@55 T@U) ) (!  (=> (or (not (= $o@@81 null)) (not true)) (=> (= $o@@81 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@81) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 $o@@81) $f@@55))))
 :qid |_10SequenceInvariantdfy.71:49|
 :skolemid |2096|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@81) $f@@55))
)) (_module.Object.inv current$Heap |o#7@@0|)) (or (forall (($o@@82 T@U) ($f@@56 T@U) ) (!  (=> (or (not (= $o@@82 null)) (not true)) (=> (= $o@@82 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@82) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 $o@@82) $f@@56))))
 :qid |_10SequenceInvariantdfy.71:49|
 :skolemid |2097|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@82) $f@@56))
)) (_module.Object.inv2 $Heap@@58 current$Heap |o#7@@0|))))
 :qid |_10SequenceInvariantdfy.71:16|
 :skolemid |2098|
 :pattern ( (_module.Object.inv2 $Heap@@58 current$Heap |o#7@@0|))
 :pattern ( (_module.Object.inv current$Heap |o#7@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#7@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#8|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#8|))))) (_module.Object.inv current$Heap |o#8|))
 :qid |_10SequenceInvariantdfy.73:16|
 :skolemid |2099|
 :pattern ( (_module.Object.inv current$Heap |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#8|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#8|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@58 current$Heap (_module.Object.universe this@@97) |running#0@@5|) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#8@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#8@@0|))))) (_module.Object.inv current$Heap |o#8@@0|))
 :qid |_10SequenceInvariantdfy.73:16|
 :skolemid |2099|
 :pattern ( (_module.Object.inv current$Heap |o#8@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@58 (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#8@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@97)) _module.Universe.content)) ($Box refType |o#8@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true)))) (=> (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@83 T@U) ($f@@57 T@U) ) (! true
 :qid |_10SequenceInvariantdfy.527:18|
 :skolemid |2105|
))) (=> (forall (($o@@84 T@U) ($f@@58 T@U) ) (! true
 :qid |_10SequenceInvariantdfy.527:18|
 :skolemid |2105|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@85 T@U) ($f@@59 T@U) ) (! true
 :qid |_10SequenceInvariantdfy.527:18|
 :skolemid |2106|
))) (=> (forall (($o@@86 T@U) ($f@@60 T@U) ) (! true
 :qid |_10SequenceInvariantdfy.527:18|
 :skolemid |2106|
)) (=> (and (_module.OwnedObject.inv2 $Heap@@58 current$Heap this@@97) (_module.OwnedObject.inv current$Heap this@@97)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Object.inv2 $Heap@@58 current$Heap this@@97)) (=> (_module.Object.inv2 $Heap@@58 current$Heap this@@97) (=> (= (ControlFlow 0 2) (- 0 1)) (_module.Object.inv current$Heap this@@97))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@58) ($IsHeapAnchor $Heap@@58)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.ConstantInteger) ($IsAlloc refType this@@97 Tclass._module.ConstantInteger previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 14 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@58) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 19) 2)))) anon0_correct))))
