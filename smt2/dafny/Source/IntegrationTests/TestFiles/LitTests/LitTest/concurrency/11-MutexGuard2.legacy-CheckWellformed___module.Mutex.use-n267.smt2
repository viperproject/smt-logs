...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Mutex.localUserInv#canCall| $Heap@@3 this@@3) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Mutex) ($IsAlloc refType this@@3 Tclass._module.Mutex $Heap@@3)))))) (= (_module.Mutex.localUserInv $Heap@@3 this@@3)  (and (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.locked))) (and (and ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.data))) _module.OwnedObject.owner))) _module.MutexGuardU32.mutex)) this@@3)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.data))) _module.OwnedObject.owner))))) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.locked)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.data))) _module.OwnedObject.owner)) this@@3) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Mutex.guards)) |Set#Empty|))))))
 :qid |_11MutexGuard2legacydfy.485:19|
 :skolemid |1931|
 :pattern ( (_module.Mutex.localUserInv $Heap@@3 this@@3) ($IsGoodHeap $Heap@@3))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@5 this@@5) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.localUserInv $Heap@@5 this@@5) (_module.MutexGuardU32.localUserInv $Heap@@5 this@@5)))
 :qid |_11MutexGuard2legacydfy.407:19|
 :skolemid |2204|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@5 this@@5) ($Is refType this@@5 Tclass._module.MutexGuardU32) ($IsGoodHeap $Heap@@5))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@5 this@@5) (_module.MutexGuardU32.localUserInv $Heap@@5 this@@5) ($IsGoodHeap $Heap@@5))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Mutex.localUserInv#canCall| $Heap@@6 this@@6) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Mutex)))) (= (_module.OwnedObject.localUserInv $Heap@@6 this@@6) (_module.Mutex.localUserInv $Heap@@6 this@@6)))
 :qid |_11MutexGuard2legacydfy.407:19|
 :skolemid |1932|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@6 this@@6) ($Is refType this@@6 Tclass._module.Mutex) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@6 this@@6) (_module.Mutex.localUserInv $Heap@@6 this@@6) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@7 this@@7) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.Thread)))) (= (_module.Object.baseFieldsInv $Heap@@7 this@@7) (_module.Thread.baseFieldsInv $Heap@@7 this@@7)))
 :qid |_11MutexGuard2legacydfy.245:19|
 :skolemid |1217|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 this@@7) ($Is refType this@@7 Tclass._module.Thread) ($IsGoodHeap $Heap@@7))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@7 this@@7) (_module.Thread.baseFieldsInv $Heap@@7 this@@7) ($IsGoodHeap $Heap@@7))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.OwnedU32.baseUserFieldsInv#canCall| $Heap@@8 this@@8) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.OwnedU32)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@8 this@@8) (_module.OwnedU32.baseUserFieldsInv $Heap@@8 this@@8)))
 :qid |_11MutexGuard2legacydfy.404:19|
 :skolemid |1646|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@8 this@@8) ($Is refType this@@8 Tclass._module.OwnedU32) ($IsGoodHeap $Heap@@8))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@8 this@@8) (_module.OwnedU32.baseUserFieldsInv $Heap@@8 this@@8) ($IsGoodHeap $Heap@@8))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.Mutex.baseUserFieldsInv#canCall| $Heap@@9 this@@9) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.Mutex)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@9 this@@9) (_module.Mutex.baseUserFieldsInv $Heap@@9 this@@9)))
 :qid |_11MutexGuard2legacydfy.404:19|
 :skolemid |1911|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@9 this@@9) ($Is refType this@@9 Tclass._module.Mutex) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@9 this@@9) (_module.Mutex.baseUserFieldsInv $Heap@@9 this@@9) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.MutexGuardU32.baseUserFieldsInv#canCall| $Heap@@10 this@@10) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@10 this@@10) (_module.MutexGuardU32.baseUserFieldsInv $Heap@@10 this@@10)))
 :qid |_11MutexGuard2legacydfy.404:19|
 :skolemid |2183|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@10 this@@10) ($Is refType this@@10 Tclass._module.MutexGuardU32) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@10 this@@10) (_module.MutexGuardU32.baseUserFieldsInv $Heap@@10 this@@10) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@11 this@@11) (and (< 4 $FunctionContextHeight) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.OwnedObject)))) (= (_module.Object.baseFieldsInv $Heap@@11 this@@11) (_module.OwnedObject.baseFieldsInv $Heap@@11 this@@11)))
 :qid |_11MutexGuard2legacydfy.245:19|
 :skolemid |1509|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@11 this@@11) ($Is refType this@@11 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@11))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@11 this@@11) (_module.OwnedObject.baseFieldsInv $Heap@@11 this@@11) ($IsGoodHeap $Heap@@11))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Mutex.baseUserFieldsInv#canCall| $Heap@@12 this@@12) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Mutex) ($IsAlloc refType this@@12 Tclass._module.Mutex $Heap@@12)))))) (= (_module.Mutex.baseUserFieldsInv $Heap@@12 this@@12)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@12) _module.Mutex.data)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 this@@12) _module.Mutex.guards)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content))))))
 :qid |_11MutexGuard2legacydfy.477:19|
 :skolemid |1910|
 :pattern ( (_module.Mutex.baseUserFieldsInv $Heap@@12 this@@12) ($IsGoodHeap $Heap@@12))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.OwnedU32.localUserInv#canCall| $Heap@@14 this@@14) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.OwnedU32) ($IsAlloc refType this@@14 Tclass._module.OwnedU32 $Heap@@14)))))) (= (_module.OwnedU32.localUserInv $Heap@@14 this@@14) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.447:19|
 :skolemid |1666|
 :pattern ( (_module.OwnedU32.localUserInv $Heap@@14 this@@14) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.OwnedU32.baseUserFieldsInv#canCall| $Heap@@16 this@@16) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.OwnedU32) ($IsAlloc refType this@@16 Tclass._module.OwnedU32 $Heap@@16)))))) (= (_module.OwnedU32.baseUserFieldsInv $Heap@@16 this@@16) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.440:19|
 :skolemid |1645|
 :pattern ( (_module.OwnedU32.baseUserFieldsInv $Heap@@16 this@@16) ($IsGoodHeap $Heap@@16))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@17 this@@17) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.OwnedObject) ($IsAlloc refType this@@17 Tclass._module.OwnedObject $Heap@@17)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@17 this@@17) (=> (_module.Object.objectGlobalBaseInv $Heap@@17 this@@17) (|_module.OwnedObject.localUserInv#canCall| $Heap@@17 this@@17))) (= (_module.OwnedObject.localInv $Heap@@17 this@@17)  (and (_module.Object.objectGlobalBaseInv $Heap@@17 this@@17) (_module.OwnedObject.localUserInv $Heap@@17 this@@17)))))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1530|
 :pattern ( (_module.OwnedObject.localInv $Heap@@17 this@@17) ($IsGoodHeap $Heap@@17))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@18 this@@18) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@18 Tclass._module.MutexGuardU32 $Heap@@18)))))) (= (_module.MutexGuardU32.localUserInv $Heap@@18 this@@18)  (and (and (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 this@@18) _module.MutexGuardU32.mutex))) _module.Mutex.locked))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 this@@18) _module.MutexGuardU32.mutex))) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@18)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 this@@18) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@@18)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 this@@18) _module.MutexGuardU32.mutex))) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@18 this@@18) _module.MutexGuardU32.data))))))
 :qid |_11MutexGuard2legacydfy.550:19|
 :skolemid |2203|
 :pattern ( (_module.MutexGuardU32.localUserInv $Heap@@18 this@@18) ($IsGoodHeap $Heap@@18))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@19 this@@19) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Object) ($IsAlloc refType this@@19 Tclass._module.Object $Heap@@19)))))) (_module.Object.triggerAxioms $Heap@@19 this@@19))
 :qid |_11MutexGuard2legacydfy.210:19|
 :skolemid |1089|
 :pattern ( (_module.Object.triggerAxioms $Heap@@19 this@@19))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.Mutex.userInv#canCall| $Heap@@21 this@@21) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Mutex) ($IsAlloc refType this@@21 Tclass._module.Mutex $Heap@@21)))))) (=> (_module.Mutex.userInv $Heap@@21 this@@21) (_module.Mutex.localUserInv $Heap@@21 this@@21)))
 :qid |_11MutexGuard2legacydfy.496:19|
 :skolemid |1936|
 :pattern ( (_module.Mutex.userInv $Heap@@21 this@@21))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 25) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32)))))) (=> (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.data))) _module.OwnedObject.owner))) _module.MutexGuardU32.mutex)) this@@23)))))) (=> (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.data))) _module.OwnedObject.owner))) _module.MutexGuardU32.mutex)) this@@23))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.data))) _module.OwnedObject.owner)))))))) (=> (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.data))) _module.OwnedObject.owner))))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.data))) _module.OwnedObject.owner)) this@@23)))))) (=> (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.data))) _module.OwnedObject.owner)) this@@23))))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.Mutex.userInv $Heap@@23 this@@23) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.Mutex.localUserInv $Heap@@23 this@@23) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.locked)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) |Set#Empty|))))))))))))))))
(let ((anon11_correct  (=> (= (_module.Mutex.userInv $Heap@@23 this@@23)  (and (_module.Mutex.localUserInv $Heap@@23 this@@23) (forall ((|g#2| T@U) ) (!  (=> (and ($Is refType |g#2| Tclass._module.MutexGuardU32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) ($Box refType |g#2|))) (_module.OwnedObject.localInv $Heap@@23 |g#2|))
 :qid |_11MutexGuard2legacydfy.498:16|
 :skolemid |1945|
 :pattern ( (_module.OwnedObject.localInv $Heap@@23 |g#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) ($Box refType |g#2|)))
)))) (=> (and (and (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23) (=> (_module.Mutex.localUserInv $Heap@@23 this@@23) (forall ((|g#2@@0| T@U) ) (!  (=> ($Is refType |g#2@@0| Tclass._module.MutexGuardU32) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) ($Box refType |g#2@@0|)) (|_module.OwnedObject.localInv#canCall| $Heap@@23 |g#2@@0|)))
 :qid |_11MutexGuard2legacydfy.498:16|
 :skolemid |1946|
 :pattern ( (_module.OwnedObject.localInv $Heap@@23 |g#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) ($Box refType |g#2@@0|)))
)))) ($Is boolType (bool_2_U (_module.Mutex.userInv $Heap@@23 this@@23)) TBool)) (and (=> (= (ControlFlow 0 11) (- 0 14)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 11) (- 0 13)) |b$reqreads#1@2|) (=> |b$reqreads#1@2| (and (=> (= (ControlFlow 0 11) (- 0 12)) |b$reqreads#2@2|) (=> |b$reqreads#2@2| (=> (= (ControlFlow 0 11) 6) GeneratedUnifiedExit_correct)))))))))))
(let ((anon10_correct  (=> (= |b$reqreads#2@2| |b$reqreads#2@1|) (=> (and (= |b$reqreads#1@2| |b$reqreads#1@1|) (= (ControlFlow 0 16) 11)) anon11_correct))))
(let ((anon17_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) ($Box refType |g#1@0|))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 20) 16))) anon10_correct)))
(let ((anon17_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Mutex.guards)) ($Box refType |g#1@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |g#1@0| null)) (not true))) (=> (or (not (= |g#1@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |g#1@0|) Tclass._module.OwnedObject? $Heap@@23) (= |b$reqreads#2@0| (forall (($o@@40 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@40 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@40) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@40) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@40 $f@@0)))
 :qid |_11MutexGuard2legacydfy.498:52|
 :skolemid |1943|
)))) (=> (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@23 |g#1@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 18) 16))) anon10_correct)))))))
(let ((anon16_Then_correct  (=> (and (and ($Is refType |g#1@0| Tclass._module.MutexGuardU32) ($IsAlloc refType |g#1@0| Tclass._module.MutexGuardU32 $Heap@@23)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@23 _module.Mutex.guards)))) (and (=> (= (ControlFlow 0 21) 18) anon17_Then_correct) (=> (= (ControlFlow 0 21) 20) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (and (not (and ($Is refType |g#1@0| Tclass._module.MutexGuardU32) ($IsAlloc refType |g#1@0| Tclass._module.MutexGuardU32 $Heap@@23))) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 17) 16))) anon10_correct)))
(let ((anon15_Then_correct  (=> (_module.Mutex.localUserInv $Heap@@23 this@@23) (and (=> (= (ControlFlow 0 22) 21) anon16_Then_correct) (=> (= (ControlFlow 0 22) 17) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not (_module.Mutex.localUserInv $Heap@@23 this@@23)) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#1@2| true) (= (ControlFlow 0 15) 11))) anon11_correct)))
(let ((anon13_Else_correct  (=> ($IsAllocBox ($Box refType this@@23) Tclass._module.Mutex? $Heap@@23) (=> (and (= |b$reqreads#0@0| (forall (($o@@41 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@41 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@41) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@41) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@41 $f@@1)))
 :qid |_11MutexGuard2legacydfy.497:8|
 :skolemid |1942|
))) (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23)) (and (=> (= (ControlFlow 0 23) 22) anon15_Then_correct) (=> (= (ControlFlow 0 23) 15) anon15_Else_correct))))))
(let ((anon5_correct true))
(let ((anon14_Else_correct  (=> (and (=> (_module.Mutex.userInv $Heap@@23 this@@23) (_module.Mutex.localUserInv $Heap@@23 this@@23)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon14_Then_correct  (=> ($IsAllocBox ($Box refType this@@23) Tclass._module.Mutex? $Heap@@23) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@23 this@@23) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@23 this@@23) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@23 this@@23) (|_module.Mutex.userInv#canCall| $Heap@@23 this@@23)) (_module.Mutex.userInv $Heap@@23 this@@23)) (=> (and (and ($IsAllocBox ($Box refType this@@23) Tclass._module.Mutex? $Heap@@23) (|_module.Mutex.localUserInv#canCall| $Heap@@23 this@@23)) (and (_module.Mutex.localUserInv $Heap@@23 this@@23) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#8| null $Heap@@23 alloc $Heap@@23 alloc)) (and (and (=> (= (ControlFlow 0 24) 23) anon13_Else_correct) (=> (= (ControlFlow 0 24) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 24) 4) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@23) ($IsHeapAnchor $Heap@@23)) (=> (and (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Mutex) ($IsAlloc refType this@@23 Tclass._module.Mutex $Heap@@23))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 25) 24))) anon0_correct))))
