...
)))) (and (and (= $Heap@27 $Heap@28) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@27) (= (ControlFlow 0 2) (- 0 1)))))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@27))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
