...
)) ($HeapSucc $Heap@12 $Heap@13)) (and (or (not (= |counter#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |counter#0| _module.IncreasingCounter.value)))))) (and (and (and (and (and (or (not (= |counter#0| null)) (not true)) (= |$rhs#0_2@1| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |counter#0|) _module.IncreasingCounter.value))) 1))) (and (= $Heap@14 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@13 |counter#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |counter#0|) _module.IncreasingCounter.value ($Box intType (int_2_U |$rhs#0_2@1|))))) ($IsGoodHeap $Heap@14))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@13)) (and ($IsGoodHeap $Heap@15) ($IsHeapAnchor $Heap@15)))) (and (and (and (forall ((|o#1@@16| T@U) ) (!  (=> ($Is refType |o#1@@16| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@16|)) (=> (=> ($Is refType |o#1@@16| Tclass._module.OwnedObject) (and (forall (($o@@135 T@U) ($f@@83 T@U) ) (!  (=> (or (not (= $o@@135 null)) (not true)) (=> (= $o@@135 |o#1@@16|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@135) $f@@83) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@135) $f@@83))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
