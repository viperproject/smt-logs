...
)) (=> (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Box refType |o#1@@1|))) (or (forall (($o@@26 T@U) ($f@@14 T@U) ) (!  (=> (or (not (= $o@@26 null)) (not true)) (=> (= $o@@26 |o#1@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@26) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 $o@@26) $f@@14))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |547|
...
))) (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Box refType |o#1@@2|))) (or (forall (($o@@27 T@U) ($f@@15 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 |o#1@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@27) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 $o@@27) $f@@15))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |536|
...
))) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@26) _module.Universe.content)) ($Box refType |o#3|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 |o#3|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (not (|Set#IsMember| |running#0@@2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 |o#3|) _module.OwnedObject.owner))) (forall (($o@@28 T@U) ($f@@16 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@28) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 $o@@28) $f@@16))))
...
)) (|_module.Universe.legalTransition#canCall| $prevHeap@@18 $Heap@@14 (_module.Object.universe this@@27) |running#0@@3|)))))) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@18 $Heap@@14 this@@27 |running#0@@3|)  (and (and (and (and (_module.Object.baseInv $prevHeap@@18 this@@27) (_module.Universe.globalInv $prevHeap@@18 (_module.Object.universe this@@27))) (_module.Object.baseInv $Heap@@14 this@@27)) (forall (($o@@30 T@U) ($f@@18 T@U) ) (!  (=> (or (not (= $o@@30 null)) (not true)) (=> (= $o@@30 this@@27) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 $o@@30) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 $o@@30) $f@@18))))
 :qid |_06ThreadOwnershipdfy.101:8|
 :skolemid |766|
...
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@33 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@33 null)) (not true)) ($Is refType this@@33 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@32 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@32 null)) (not true)) (or (= $o@@32 this@@33) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 this@@33) _module.Universe.content)) ($Box refType $o@@32)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@32) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@32) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |492|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon11_correct  (=> (= (_module.Object.goodPreAndLegalChanges $Heap@@29 current$Heap this@@54 |running#0@@5|)  (and (and (and (and (_module.Object.baseInv $Heap@@29 this@@54) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@54))) (_module.Object.baseInv current$Heap this@@54)) (forall (($o@@57 T@U) ($f@@33 T@U) ) (!  (=> (or (not (= $o@@57 null)) (not true)) (=> (= $o@@57 this@@54) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@57) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 $o@@57) $f@@33))))
 :qid |_06ThreadOwnershipdfy.101:8|
 :skolemid |774|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@57) $f@@33))
))) (_module.Universe.legalTransition $Heap@@29 current$Heap (_module.Object.universe this@@54) |running#0@@5|))) (=> (and (and (and (|_module.Object.baseInv#canCall| $Heap@@29 this@@54) (=> (_module.Object.baseInv $Heap@@29 this@@54) (|_module.Universe.globalInv#canCall| $Heap@@29 (_module.Object.universe this@@54)))) (=> (and (_module.Object.baseInv $Heap@@29 this@@54) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@54))) (and (|_module.Object.baseInv#canCall| current$Heap this@@54) (=> (_module.Object.baseInv current$Heap this@@54) (=> (forall (($o@@58 T@U) ($f@@34 T@U) ) (!  (=> (or (not (= $o@@58 null)) (not true)) (=> (= $o@@58 this@@54) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@58) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 $o@@58) $f@@34))))
 :qid |_06ThreadOwnershipdfy.101:8|
 :skolemid |775|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@58) $f@@34))
)) (|_module.Universe.legalTransition#canCall| $Heap@@29 current$Heap (_module.Object.universe this@@54) |running#0@@5|)))))) ($Is boolType (bool_2_U (_module.Object.goodPreAndLegalChanges $Heap@@29 current$Heap this@@54 |running#0@@5|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))))
(let ((anon17_Else_correct  (=> (not (and (and (and (_module.Object.baseInv $Heap@@29 this@@54) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@54))) (_module.Object.baseInv current$Heap this@@54)) (forall (($o@@59 T@U) ($f@@35 T@U) ) (!  (=> (or (not (= $o@@59 null)) (not true)) (=> (= $o@@59 this@@54) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@59) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 $o@@59) $f@@35))))
 :qid |_06ThreadOwnershipdfy.101:8|
 :skolemid |772|
...
(let ((anon17_Then_correct  (=> (and (and (and (_module.Object.baseInv $Heap@@29 this@@54) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@54))) (_module.Object.baseInv current$Heap this@@54)) (forall (($o@@60 T@U) ($f@@36 T@U) ) (!  (=> (or (not (= $o@@60 null)) (not true)) (=> (= $o@@60 this@@54) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@60) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 $o@@60) $f@@36))))
 :qid |_06ThreadOwnershipdfy.101:8|
 :skolemid |772|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@60) $f@@36))
))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= (_module.Object.universe this@@54) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@54) null)) (not true)) (=> (and ($IsAllocBox ($Box refType (_module.Object.universe this@@54)) Tclass._module.Universe? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 6) (- 0 8)) ($IsAlloc refType (_module.Object.universe this@@54) Tclass._module.Universe $Heap@@29)) (=> ($IsAlloc refType (_module.Object.universe this@@54) Tclass._module.Universe $Heap@@29) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@29)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@29) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@61 T@U) ($f@@37 T@U) ) (!  (=> (and (and (or (not (= $o@@61 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@61) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@61) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@61 $f@@37)))
 :qid |_06ThreadOwnershipdfy.102:17|
 :skolemid |771|
))) (|_module.Universe.legalTransition#canCall| $Heap@@29 current$Heap (_module.Object.universe this@@54) |running#0@@5|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon11_correct)))))))))))
(let ((anon16_Else_correct  (=> (and (not (and (and (_module.Object.baseInv $Heap@@29 this@@54) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@54))) (_module.Object.baseInv current$Heap this@@54))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 13) 6) anon17_Then_correct) (=> (= (ControlFlow 0 13) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (and (_module.Object.baseInv $Heap@@29 this@@54) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@54))) (_module.Object.baseInv current$Heap this@@54)) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29)) (=> ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29) (=> (and (= |b$reqreads#1@0| (forall (($o@@62 T@U) ($f@@38 T@U) ) (!  (=> (and (and (or (not (= $o@@62 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@62) alloc)))) (= $o@@62 this@@54)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@62 $f@@38)))
 :qid |_06ThreadOwnershipdfy.101:18|
 :skolemid |770|
))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 11) 6) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct))))))))
(let ((anon15_Else_correct  (=> (and (not (and (_module.Object.baseInv $Heap@@29 this@@54) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@54)))) (= |b$reqreads#0@1| true)) (and (=> (= (ControlFlow 0 15) 11) anon16_Then_correct) (=> (= (ControlFlow 0 15) 13) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (_module.Object.baseInv $Heap@@29 this@@54) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@54))) (=> (and (and ($IsAllocBox ($Box refType this@@54) Tclass._module.Object? current$Heap) (= |b$reqreads#0@0| (forall (($o@@63 T@U) ($f@@39 T@U) ) (!  (=> (and (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@63) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@63) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@63 $f@@39)))
 :qid |_06ThreadOwnershipdfy.100:8|
 :skolemid |769|
)))) (and (|_module.Object.baseInv#canCall| current$Heap this@@54) (= |b$reqreads#0@1| |b$reqreads#0@0|))) (and (=> (= (ControlFlow 0 14) 11) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct))))))
(let ((anon14_Else_correct  (=> (not (_module.Object.baseInv $Heap@@29 this@@54)) (and (=> (= (ControlFlow 0 20) 14) anon15_Then_correct) (=> (= (ControlFlow 0 20) 15) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (_module.Object.baseInv $Heap@@29 this@@54) (and (=> (= (ControlFlow 0 16) (- 0 19)) ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29)) (=> ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29) (and (=> (= (ControlFlow 0 16) (- 0 18)) (or (not (= (_module.Object.universe this@@54) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@54) null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 17)) ($IsAlloc refType (_module.Object.universe this@@54) Tclass._module.Universe $Heap@@29)) (=> ($IsAlloc refType (_module.Object.universe this@@54) Tclass._module.Universe $Heap@@29) (=> (|_module.Universe.globalInv#canCall| $Heap@@29 (_module.Object.universe this@@54)) (and (=> (= (ControlFlow 0 16) 14) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct))))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29)) (=> ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29) (=> (|_module.Object.baseInv#canCall| $Heap@@29 this@@54) (and (=> (= (ControlFlow 0 21) 16) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@29) ($IsHeapAnchor $Heap@@29)) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.Object) ($IsAlloc refType this@@54 Tclass._module.Object previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 10 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@29) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 24) 23))) anon0_correct))))
