...
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@33 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@33 null)) (not true)) ($Is refType this@@33 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@32 T@U) ($f@@19 T@U) )  (=> (and (or (not (= $o@@32 null)) (not true)) (or (= $o@@32 this@@33) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 this@@33) _module.Universe.content)) ($Box refType $o@@32)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@32) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@32) $f@@19)))) (= (_module.Universe.globalBaseInv $h0@@12 this@@33) (_module.Universe.globalBaseInv $h1@@12 this@@33))))
