...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split72)
...
))) (and (and ($HeapSucc $Heap@5 $Heap@6) (= |a#0@0| |b#0@0|)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@6))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
