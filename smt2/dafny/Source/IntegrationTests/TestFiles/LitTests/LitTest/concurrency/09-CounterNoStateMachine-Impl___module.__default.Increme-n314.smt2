...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split303)
...
))) (and (= $Heap@36 $Heap@37) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37))) (and (and (= |##running#0_0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) ($IsAlloc SetType |##running#0_0@1| (TSet Tclass._module.Thread) $Heap@37)) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) (= (ControlFlow 0 2) (- 0 1))))))))))) ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (TSet Tclass._module.Thread) $Heap@33)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
