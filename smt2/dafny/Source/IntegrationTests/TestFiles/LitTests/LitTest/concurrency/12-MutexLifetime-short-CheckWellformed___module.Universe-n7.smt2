...
(let ((anon13_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@52) _module.Universe.content)) ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@39) (= |b$reqreads#2@0| (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.23:62|
 :skolemid |838|
)))) (=> (and (and (|_module.Object.inv#canCall| $Heap@@39 |o#1@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 9) 7))) anon7_correct)))))))
...
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@52) Tclass._module.Universe? $Heap@@39) (=> (and (= |b$reqreads#0@0| (forall (($o@@33 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 $o@@33) alloc)))) (or (= $o@@33 this@@52) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@39 this@@52) _module.Universe.content)) ($Box refType $o@@33)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@33 $f@@1)))
 :qid |_12MutexLifetimeshortdfy.23:5|
 :skolemid |837|
))) (|_module.Universe.globalBaseInv#canCall| $Heap@@39 this@@52)) (and (=> (= (ControlFlow 0 14) 13) anon11_Then_correct) (=> (= (ControlFlow 0 14) 6) anon11_Else_correct))))))
