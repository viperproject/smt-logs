...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Mutex.localUserInv#canCall| $Heap@@2 this@@2) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Mutex) ($IsAlloc refType this@@2 Tclass._module.Mutex $Heap@@2)))))) (= (_module.Mutex.localUserInv $Heap@@2 this@@2)  (and (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.locked))) (and (and ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.data))) _module.OwnedObject.owner))) _module.MutexGuardU32.mutex)) this@@2)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.data))) _module.OwnedObject.owner))))) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.locked)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.data))) _module.OwnedObject.owner)) this@@2) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.Mutex.guards)) |Set#Empty|))))))
 :qid |_11MutexGuard2legacydfy.485:19|
 :skolemid |1931|
 :pattern ( (_module.Mutex.localUserInv $Heap@@2 this@@2) ($IsGoodHeap $Heap@@2))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.OwnedU32.localUserInv#canCall| $Heap@@3 this@@3) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.OwnedU32)))) (= (_module.OwnedObject.localUserInv $Heap@@3 this@@3) (_module.OwnedU32.localUserInv $Heap@@3 this@@3)))
 :qid |_11MutexGuard2legacydfy.407:19|
 :skolemid |1667|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@3) ($Is refType this@@3 Tclass._module.OwnedU32) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@3) (_module.OwnedU32.localUserInv $Heap@@3 this@@3) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@4 this@@4) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.localUserInv $Heap@@4 this@@4) (_module.MutexGuardU32.localUserInv $Heap@@4 this@@4)))
 :qid |_11MutexGuard2legacydfy.407:19|
 :skolemid |2204|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@4 this@@4) ($Is refType this@@4 Tclass._module.MutexGuardU32) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@4 this@@4) (_module.MutexGuardU32.localUserInv $Heap@@4 this@@4) ($IsGoodHeap $Heap@@4))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.Mutex.localUserInv#canCall| $Heap@@5 this@@5) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Mutex)))) (= (_module.OwnedObject.localUserInv $Heap@@5 this@@5) (_module.Mutex.localUserInv $Heap@@5 this@@5)))
 :qid |_11MutexGuard2legacydfy.407:19|
 :skolemid |1932|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@5 this@@5) ($Is refType this@@5 Tclass._module.Mutex) ($IsGoodHeap $Heap@@5))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@5 this@@5) (_module.Mutex.localUserInv $Heap@@5 this@@5) ($IsGoodHeap $Heap@@5))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.OwnedU32.baseUserFieldsInv#canCall| $Heap@@7 this@@7) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.OwnedU32)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@7 this@@7) (_module.OwnedU32.baseUserFieldsInv $Heap@@7 this@@7)))
 :qid |_11MutexGuard2legacydfy.404:19|
 :skolemid |1646|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@7 this@@7) ($Is refType this@@7 Tclass._module.OwnedU32) ($IsGoodHeap $Heap@@7))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@7 this@@7) (_module.OwnedU32.baseUserFieldsInv $Heap@@7 this@@7) ($IsGoodHeap $Heap@@7))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.Mutex.baseUserFieldsInv#canCall| $Heap@@8 this@@8) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.Mutex)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@8 this@@8) (_module.Mutex.baseUserFieldsInv $Heap@@8 this@@8)))
 :qid |_11MutexGuard2legacydfy.404:19|
 :skolemid |1911|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@8 this@@8) ($Is refType this@@8 Tclass._module.Mutex) ($IsGoodHeap $Heap@@8))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@8 this@@8) (_module.Mutex.baseUserFieldsInv $Heap@@8 this@@8) ($IsGoodHeap $Heap@@8))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.MutexGuardU32.baseUserFieldsInv#canCall| $Heap@@9 this@@9) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@9 this@@9) (_module.MutexGuardU32.baseUserFieldsInv $Heap@@9 this@@9)))
 :qid |_11MutexGuard2legacydfy.404:19|
 :skolemid |2183|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@9 this@@9) ($Is refType this@@9 Tclass._module.MutexGuardU32) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@9 this@@9) (_module.MutexGuardU32.baseUserFieldsInv $Heap@@9 this@@9) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@10 this@@10) (and (< 4 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.OwnedObject)))) (= (_module.Object.baseFieldsInv $Heap@@10 this@@10) (_module.OwnedObject.baseFieldsInv $Heap@@10 this@@10)))
 :qid |_11MutexGuard2legacydfy.245:19|
 :skolemid |1509|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Mutex.baseUserFieldsInv#canCall| $Heap@@11 this@@11) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Mutex) ($IsAlloc refType this@@11 Tclass._module.Mutex $Heap@@11)))))) (= (_module.Mutex.baseUserFieldsInv $Heap@@11 this@@11)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 (_module.Object.universe this@@11)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@11) _module.Mutex.data)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@11) _module.Mutex.guards)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 (_module.Object.universe this@@11)) _module.Universe.content))))))
 :qid |_11MutexGuard2legacydfy.477:19|
 :skolemid |1910|
 :pattern ( (_module.Mutex.baseUserFieldsInv $Heap@@11 this@@11) ($IsGoodHeap $Heap@@11))
))))
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@12 this@@12) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Object) ($IsAlloc refType this@@12 Tclass._module.Object $Heap@@12)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType this@@12)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@12 this@@12) (=> (_module.Object.baseFieldsInv $Heap@@12 this@@12) (|_module.Universe.globalBaseInv#canCall| $Heap@@12 (_module.Object.universe this@@12))))) (= (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType this@@12)) (_module.Object.baseFieldsInv $Heap@@12 this@@12)) (_module.Universe.globalBaseInv $Heap@@12 (_module.Object.universe this@@12))))))
 :qid |_11MutexGuard2legacydfy.202:19|
 :skolemid |1071|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12) ($IsGoodHeap $Heap@@12))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.OwnedU32.localUserInv#canCall| $Heap@@13 this@@13) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.OwnedU32) ($IsAlloc refType this@@13 Tclass._module.OwnedU32 $Heap@@13)))))) (= (_module.OwnedU32.localUserInv $Heap@@13 this@@13) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.447:19|
 :skolemid |1666|
 :pattern ( (_module.OwnedU32.localUserInv $Heap@@13 this@@13) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.OwnedU32.baseUserFieldsInv#canCall| $Heap@@15 this@@15) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.OwnedU32) ($IsAlloc refType this@@15 Tclass._module.OwnedU32 $Heap@@15)))))) (= (_module.OwnedU32.baseUserFieldsInv $Heap@@15 this@@15) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_11MutexGuard2legacydfy.440:19|
 :skolemid |1645|
 :pattern ( (_module.OwnedU32.baseUserFieldsInv $Heap@@15 this@@15) ($IsGoodHeap $Heap@@15))
))))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@10 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#8| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@10 $f))  (=> (and (or (not (= $o@@10 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@10) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@10) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2455|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#8| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@10 $f))
)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@16 this@@16) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.OwnedObject) ($IsAlloc refType this@@16 Tclass._module.OwnedObject $Heap@@16)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@16 this@@16) (=> (_module.Object.objectGlobalBaseInv $Heap@@16 this@@16) (|_module.OwnedObject.localUserInv#canCall| $Heap@@16 this@@16))) (= (_module.OwnedObject.localInv $Heap@@16 this@@16)  (and (_module.Object.objectGlobalBaseInv $Heap@@16 this@@16) (_module.OwnedObject.localUserInv $Heap@@16 this@@16)))))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1530|
 :pattern ( (_module.OwnedObject.localInv $Heap@@16 this@@16) ($IsGoodHeap $Heap@@16))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@17 this@@17) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@17 Tclass._module.MutexGuardU32 $Heap@@17)))))) (= (_module.MutexGuardU32.localUserInv $Heap@@17 this@@17)  (and (and (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@17) _module.MutexGuardU32.mutex))) _module.Mutex.locked))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@17) _module.MutexGuardU32.mutex))) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@17)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@17) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@@17)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@17) _module.MutexGuardU32.mutex))) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@17) _module.MutexGuardU32.data))))))
 :qid |_11MutexGuard2legacydfy.550:19|
 :skolemid |2203|
 :pattern ( (_module.MutexGuardU32.localUserInv $Heap@@17 this@@17) ($IsGoodHeap $Heap@@17))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@18 this@@18) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Object) ($IsAlloc refType this@@18 Tclass._module.Object $Heap@@18)))))) (_module.Object.triggerAxioms $Heap@@18 this@@18))
 :qid |_11MutexGuard2legacydfy.210:19|
 :skolemid |1089|
 :pattern ( (_module.Object.triggerAxioms $Heap@@18 this@@18))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.MutexGuardU32.userInv#canCall| $Heap@@19 this@@19) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@19 Tclass._module.MutexGuardU32 $Heap@@19)))))) (and (and (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@19 this@@19) (=> (_module.MutexGuardU32.localUserInv $Heap@@19 this@@19) (|_module.OwnedObject.localInv#canCall| $Heap@@19 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 this@@19) _module.MutexGuardU32.mutex))))) (= (_module.MutexGuardU32.userInv $Heap@@19 this@@19)  (and (_module.MutexGuardU32.localUserInv $Heap@@19 this@@19) (_module.OwnedObject.localInv $Heap@@19 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 this@@19) _module.MutexGuardU32.mutex)))))))
 :qid |_11MutexGuard2legacydfy.556:19|
 :skolemid |2210|
 :pattern ( (_module.MutexGuardU32.userInv $Heap@@19 this@@19) ($IsGoodHeap $Heap@@19))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@20 this@@20) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.OwnedObject) ($IsAlloc refType this@@20 Tclass._module.OwnedObject $Heap@@20)))))) (=> (_module.OwnedObject.localInv $Heap@@20 this@@20) (_module.Object.objectGlobalBaseInv $Heap@@20 this@@20)))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1528|
 :pattern ( (_module.OwnedObject.localInv $Heap@@20 this@@20))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.MutexGuardU32.userInv#canCall| $Heap@@21 this@@21) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@21 Tclass._module.MutexGuardU32 $Heap@@21)))))) (=> (_module.MutexGuardU32.userInv $Heap@@21 this@@21) (_module.MutexGuardU32.localUserInv $Heap@@21 this@@21)))
 :qid |_11MutexGuard2legacydfy.556:19|
 :skolemid |2208|
 :pattern ( (_module.MutexGuardU32.userInv $Heap@@21 this@@21))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@22 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@22 this@@22) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Object) ($IsAlloc refType this@@22 Tclass._module.Object $Heap@@22)))))) (= (_module.Object.triggerAxioms $Heap@@22 this@@22)  (and (or ($Is refType this@@22 Tclass._module.OwnedObject) ($Is refType this@@22 Tclass._module.Thread)) (not (and ($Is refType this@@22 Tclass._module.OwnedObject) ($Is refType this@@22 Tclass._module.Thread))))))
 :qid |_11MutexGuard2legacydfy.210:19|
 :skolemid |1091|
 :pattern ( (_module.Object.triggerAxioms $Heap@@22 this@@22) ($IsGoodHeap $Heap@@22))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (_module.MutexGuardU32.userInv $Heap@@23 this@@23) (=> (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))) _module.Mutex.locked))))))) (=> (=> (_module.MutexGuardU32.userInv $Heap@@23 this@@23) (=> (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))) _module.Mutex.locked)))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (_module.MutexGuardU32.userInv $Heap@@23 this@@23) (=> (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@23))))))) (=> (=> (_module.MutexGuardU32.userInv $Heap@@23 this@@23) (=> (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@23)))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (_module.MutexGuardU32.userInv $Heap@@23 this@@23) (=> (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@@23))))) (=> (=> (_module.MutexGuardU32.userInv $Heap@@23 this@@23) (=> (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@@23)))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.MutexGuardU32.userInv $Heap@@23 this@@23) (=> (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23) (or (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.data)))))))))))))))
(let ((anon8_correct  (=> (= (_module.MutexGuardU32.userInv $Heap@@23 this@@23)  (and (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (_module.OwnedObject.localInv $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))))) (=> (and (and (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23) (=> (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (|_module.OwnedObject.localInv#canCall| $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))))) ($Is boolType (bool_2_U (_module.MutexGuardU32.userInv $Heap@@23 this@@23)) TBool)) (and (=> (= (ControlFlow 0 10) (- 0 13)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 10) (- 0 12)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (=> (= (ControlFlow 0 10) 6) GeneratedUnifiedExit_correct)))))))))))
(let ((anon12_Else_correct  (=> (and (and (not (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23)) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 16) 10))) anon8_correct)))
(let ((anon12_Then_correct  (=> (and (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@23 _module.MutexGuardU32.mutex)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex)) null)) (not true)) (=> (and ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex) Tclass._module.OwnedObject? $Heap@@23) (= |b$reqreads#2@0| (forall (($o@@40 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@40 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@40) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@40) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@40 $f@@0)))
 :qid |_11MutexGuard2legacydfy.558:14|
 :skolemid |2213|
)))) (=> (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@23 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.MutexGuardU32.mutex))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 14) 10))) anon8_correct)))))))
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@23) Tclass._module.MutexGuardU32? $Heap@@23) (=> (and (= |b$reqreads#0@0| (forall (($o@@41 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@41 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@41) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@41) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@41 $f@@1)))
 :qid |_11MutexGuard2legacydfy.557:8|
 :skolemid |2212|
))) (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23)) (and (=> (= (ControlFlow 0 17) 14) anon12_Then_correct) (=> (= (ControlFlow 0 17) 16) anon12_Else_correct))))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (and (=> (_module.MutexGuardU32.userInv $Heap@@23 this@@23) (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon11_Then_correct  (=> ($IsAllocBox ($Box refType this@@23) Tclass._module.MutexGuardU32? $Heap@@23) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@23 this@@23) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@23 this@@23) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@23 this@@23) (|_module.MutexGuardU32.userInv#canCall| $Heap@@23 this@@23)) (_module.MutexGuardU32.userInv $Heap@@23 this@@23)) (=> (and (and ($IsAllocBox ($Box refType this@@23) Tclass._module.MutexGuardU32? $Heap@@23) (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@23 this@@23)) (and (_module.MutexGuardU32.localUserInv $Heap@@23 this@@23) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#8| null $Heap@@23 alloc $Heap@@23 alloc)) (and (and (=> (= (ControlFlow 0 18) 17) anon10_Else_correct) (=> (= (ControlFlow 0 18) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 18) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@23) ($IsHeapAnchor $Heap@@23)) (=> (and (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@23 Tclass._module.MutexGuardU32 $Heap@@23))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
