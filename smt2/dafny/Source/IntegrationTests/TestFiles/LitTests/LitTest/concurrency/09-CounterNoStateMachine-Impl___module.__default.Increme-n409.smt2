...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split398)
...
)))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|))) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (= (+ |i#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.Integer.value)))) (LitInt 10)))))))) (and (and (and (and (and (and (forall (($o@@121 T@U) ) (!  (=> (and (or (not (= $o@@121 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 $o@@121) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@121) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@121)) (or (= $o@@121 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 |universe#0|) _module.Universe.content)) ($Box refType $o@@121)))))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |544|
...
))))) (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@6 |universe#0|) (=> (_module.Universe.globalInv $Heap@6 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@5 $Heap@6 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@6 |universe#0|) (and (_module.Universe.globalInv $Heap@6 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@6 |universe#0|) (forall ((|o#17@@2| T@U) ) (!  (=> (and ($Is refType |o#17@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@2|))) (_module.Object.inv $Heap@6 |o#17@@2|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))) (and (= $Heap@6 $Heap@7) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
