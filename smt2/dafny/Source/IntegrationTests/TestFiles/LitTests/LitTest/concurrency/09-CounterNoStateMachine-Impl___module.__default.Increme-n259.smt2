...
))))) (and (and (and (= $Heap@30 $Heap@31) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@30) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@30))) (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@30) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.legalTransition#canCall| $Heap@30 $Heap@31 |universe#0| |running#0@@3|)))))))))) (or (_module.Universe.legalTransition $Heap@30 $Heap@31 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@30 $Heap@31 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@30 $Heap@31 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@30 $Heap@31 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@30 $Heap@31 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@30 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@31 |universe#0|) _module.Universe.content)))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
