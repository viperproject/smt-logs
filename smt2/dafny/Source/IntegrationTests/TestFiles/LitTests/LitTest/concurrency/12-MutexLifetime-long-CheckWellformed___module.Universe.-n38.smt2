...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@27 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@27 this@@30) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@27) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Object) ($IsAlloc refType this@@30 Tclass._module.Object $Heap@@27)))))) (=> (_module.Object.localInv $Heap@@27 this@@30) (_module.Object.objectGlobalBaseInv $Heap@@27 this@@30)))
 :qid |_12MutexLifetimelongdfy.351:19|
 :skolemid |1783|
 :pattern ( (_module.Object.localInv $Heap@@27 this@@30))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@28 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@28 this@@31) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@28) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.OwnedObject) ($IsAlloc refType this@@31 Tclass._module.OwnedObject $Heap@@28)))))) (=> (_module.OwnedObject.userInv $Heap@@28 this@@31) (_module.OwnedObject.localUserInv $Heap@@28 this@@31)))
 :qid |_12MutexLifetimelongdfy.523:19|
 :skolemid |2243|
 :pattern ( (_module.OwnedObject.userInv $Heap@@28 this@@31))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@29 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@29 this@@32) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.OwnedObject) ($IsAlloc refType this@@32 Tclass._module.OwnedObject $Heap@@29)))))) (=> (_module.OwnedObject.inv $Heap@@29 this@@32) (_module.OwnedObject.localInv $Heap@@29 this@@32)))
 :qid |_12MutexLifetimelongdfy.449:19|
 :skolemid |2163|
 :pattern ( (_module.OwnedObject.inv $Heap@@29 this@@32))
))))
(assert  (=> (<= 15 $FunctionContextHeight) (forall (($Heap@@30 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@30 this@@33) (and (< 15 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@30) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.Object) ($IsAlloc refType this@@33 Tclass._module.Object $Heap@@30)))))) (=> (_module.Object.inv $Heap@@30 this@@33) (_module.Object.localInv $Heap@@30 this@@33)))
 :qid |_12MutexLifetimelongdfy.353:19|
 :skolemid |1793|
 :pattern ( (_module.Object.inv $Heap@@30 this@@33))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@34 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@34)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@34 null)) (not true)) ($Is refType this@@34 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@34)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimelongdfy.362:18|
 :weight 3
 :skolemid |1854|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@34)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@35 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@35)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@35)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimelongdfy.425:18|
 :weight 3
 :skolemid |2118|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@35)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@36 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@36)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@36 null)) (not true)) ($Is refType this@@36 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@36)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimelongdfy.562:18|
 :weight 3
 :skolemid |2294|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@36)))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@31 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.Lifetime.localInv#canCall| $Heap@@31 this@@37) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@31) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.Lifetime) ($IsAlloc refType this@@37 Tclass._module.Lifetime $Heap@@31)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@31 this@@37) (=> (_module.Object.objectGlobalBaseInv $Heap@@31 this@@37) (=> (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#0@@3|))) (= (_module.OwnedObject.lifetime |o#0@@3|) this@@37))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2333|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#0@@3|)))
)) (and (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.OwnedObject) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#1|)) (and (|_module.OwnedObject.alive#canCall| $Heap@@31 |o#1|) (|_module.Lifetime.alive#canCall| $Heap@@31 this@@37))))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2326|
 :pattern ( (_module.OwnedObject.alive $Heap@@31 |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#1|)))
)) (=> (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#1@@0|))) (= (_module.OwnedObject.alive $Heap@@31 |o#1@@0|) (_module.Lifetime.alive $Heap@@31 this@@37)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2332|
 :pattern ( (_module.OwnedObject.alive $Heap@@31 |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#1@@0|)))
)) (and (and (|_module.Lifetime.alive#canCall| $Heap@@31 this@@37) (=> (_module.Lifetime.alive $Heap@@31 this@@37) (forall ((|l#0@@0| T@U) ) (!  (=> ($Is refType |l#0@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@31 |l#0@@0|)))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2327|
 :pattern ( (_module.Lifetime.alive $Heap@@31 |l#0@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@0|)))
)))) (=> (=> (_module.Lifetime.alive $Heap@@31 this@@37) (forall ((|l#0@@1| T@U) ) (!  (=> (and ($Is refType |l#0@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|))) (_module.Lifetime.alive $Heap@@31 |l#0@@1|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2331|
 :pattern ( (_module.Lifetime.alive $Heap@@31 |l#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@1|)))
))) (and (|_module.Lifetime.alive#canCall| $Heap@@31 this@@37) (=> (not (_module.Lifetime.alive $Heap@@31 this@@37)) (forall ((|l#1@@0| T@U) ) (!  (=> ($Is refType |l#1@@0| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)) (|_module.Lifetime.alive#canCall| $Heap@@31 |l#1@@0|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2328|
 :pattern ( (_module.Lifetime.alive $Heap@@31 |l#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@0|)))
))))))))))) (= (_module.Lifetime.localInv $Heap@@31 this@@37)  (and (and (and (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@31 this@@37) (forall ((|o#0@@4| T@U) ) (!  (=> (and ($Is refType |o#0@@4| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#0@@4|))) (= (_module.OwnedObject.lifetime |o#0@@4|) this@@37))
 :qid |_12MutexLifetimelongdfy.581:16|
 :skolemid |2320|
 :pattern ( (_module.OwnedObject.lifetime |o#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#0@@4|)))
))) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#1@@1|))) (= (_module.OwnedObject.alive $Heap@@31 |o#1@@1|) (_module.Lifetime.alive $Heap@@31 this@@37)))
 :qid |_12MutexLifetimelongdfy.583:16|
 :skolemid |2321|
 :pattern ( (_module.OwnedObject.alive $Heap@@31 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.elements)) ($Box refType |o#1@@1|)))
))) (=> (_module.Lifetime.alive $Heap@@31 this@@37) (forall ((|l#0@@2| T@U) ) (!  (=> (and ($Is refType |l#0@@2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|))) (_module.Lifetime.alive $Heap@@31 |l#0@@2|))
 :qid |_12MutexLifetimelongdfy.584:28|
 :skolemid |2322|
 :pattern ( (_module.Lifetime.alive $Heap@@31 |l#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointTo)) ($Box refType |l#0@@2|)))
)))) (=> (not (_module.Lifetime.alive $Heap@@31 this@@37)) (forall ((|l#1@@1| T@U) ) (!  (=> (and ($Is refType |l#1@@1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|))) (not (_module.Lifetime.alive $Heap@@31 |l#1@@1|)))
 :qid |_12MutexLifetimelongdfy.585:29|
 :skolemid |2323|
 :pattern ( (_module.Lifetime.alive $Heap@@31 |l#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointFrom)) ($Box refType |l#1@@1|)))
)))) (forall ((|l#2@@0| T@U) ) (!  (=> (and ($Is refType |l#2@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 |l#2@@0|) _module.Lifetime.mightPointFrom)) ($Box refType this@@37)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointTo)) ($Box refType |l#2@@0|)))
))) (forall ((|l#3@@0| T@U) ) (!  (=> (and ($Is refType |l#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 |l#3@@0|) _module.Lifetime.mightPointTo)) ($Box refType this@@37)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@37) _module.Lifetime.mightPointFrom)) ($Box refType |l#3@@0|)))
))))))
 :qid |_12MutexLifetimelongdfy.579:19|
 :skolemid |2334|
 :pattern ( (_module.Lifetime.localInv $Heap@@31 this@@37) ($IsGoodHeap $Heap@@31))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@38 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@38) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@38 null)) (not true)) ($Is refType this@@38 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@38) (_module.Thread.objectClassKind this@@38)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1855|
 :pattern ( (_module.Object.objectClassKind this@@38) ($Is refType this@@38 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@38) (_module.Thread.objectClassKind this@@38))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@39 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@39) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@39 null)) (not true)) ($Is refType this@@39 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@39) (_module.OwnedObject.objectClassKind this@@39)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2119|
 :pattern ( (_module.Object.objectClassKind this@@39) ($Is refType this@@39 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@39) (_module.OwnedObject.objectClassKind this@@39))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@40 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@40) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@40) (_module.Lifetime.objectClassKind this@@40)))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |2295|
 :pattern ( (_module.Object.objectClassKind this@@40) ($Is refType this@@40 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@40) (_module.Lifetime.objectClassKind this@@40))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@41 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@41) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@41 null)) (not true)) ($Is refType this@@41 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@41) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.362:18|
 :skolemid |1851|
 :pattern ( (_module.Thread.objectClassKind this@@41))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@42 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@42) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@42 null)) (not true)) ($Is refType this@@42 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@42) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.425:18|
 :skolemid |2115|
 :pattern ( (_module.OwnedObject.objectClassKind this@@42))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@43 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@43) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@43 null)) (not true)) ($Is refType this@@43 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@43) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.562:18|
 :skolemid |2291|
 :pattern ( (_module.Lifetime.objectClassKind this@@43))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@44 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@44) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@44 null)) (not true)) ($Is refType this@@44 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@44) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimelongdfy.348:18|
 :skolemid |1773|
 :pattern ( (_module.Object.objectClassKind this@@44))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@32 T@U) (this@@45 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@32 this@@45) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@32) (and (or (not (= this@@45 null)) (not true)) (and ($Is refType this@@45 Tclass._module.Thread) ($IsAlloc refType this@@45 Tclass._module.Thread $Heap@@32)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@32 this@@45)) (= (_module.Thread.localInv $Heap@@32 this@@45)  (and true (_module.Object.objectGlobalBaseInv $Heap@@32 this@@45)))))
 :qid |_12MutexLifetimelongdfy.369:19|
 :skolemid |1875|
 :pattern ( (_module.Thread.localInv $Heap@@32 this@@45) ($IsGoodHeap $Heap@@32))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@33 T@U) (this@@46 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@33 this@@46) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@33) (and (or (not (= this@@46 null)) (not true)) (and ($Is refType this@@46 Tclass._module.Thread) ($IsAlloc refType this@@46 Tclass._module.Thread $Heap@@33)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@33 this@@46)) (= (_module.Thread.inv $Heap@@33 this@@46)  (and true (_module.Thread.localInv $Heap@@33 this@@46)))))
 :qid |_12MutexLifetimelongdfy.372:19|
 :skolemid |1885|
 :pattern ( (_module.Thread.inv $Heap@@33 this@@46) ($IsGoodHeap $Heap@@33))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@47 T@U) ) (!  (=> (or (|_module.OwnedObject.alive#canCall| $Heap@@34 this@@47) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@47 null)) (not true)) (and ($Is refType this@@47 Tclass._module.OwnedObject) ($IsAlloc refType this@@47 Tclass._module.OwnedObject $Heap@@34)))))) (= (_module.OwnedObject.alive $Heap@@34 this@@47)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@34 this@@47) _module.OwnedObject.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.422:19|
 :skolemid |2114|
 :pattern ( (_module.OwnedObject.alive $Heap@@34 this@@47) ($IsGoodHeap $Heap@@34))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@35 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@35 this@@48) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@35) (and (or (not (= this@@48 null)) (not true)) (and ($Is refType this@@48 Tclass._module.Lifetime) ($IsAlloc refType this@@48 Tclass._module.Lifetime $Heap@@35)))))) (= (_module.Lifetime.alive $Heap@@35 this@@48)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@35 this@@48) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@35 this@@48) ($IsGoodHeap $Heap@@35))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@36 T@U) (this@@49 T@U) ) (!  (=> (or (|_module.Lifetime.baseFieldsInv#canCall| $Heap@@36 this@@49) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@36) (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.Lifetime) ($IsAlloc refType this@@49 Tclass._module.Lifetime $Heap@@36)))))) (= (_module.Lifetime.baseFieldsInv $Heap@@36 this@@49)  (and (and (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 this@@49) _module.Lifetime.owner)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 (_module.Object.universe this@@49)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 this@@49) _module.Lifetime.owner))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 this@@49) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 (_module.Object.universe this@@49)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 this@@49) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 (_module.Object.universe this@@49)) _module.Universe.content)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 this@@49) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 (_module.Object.universe this@@49)) _module.Universe.content))))))
 :qid |_12MutexLifetimelongdfy.564:19|
 :skolemid |2301|
 :pattern ( (_module.Lifetime.baseFieldsInv $Heap@@36 this@@49) ($IsGoodHeap $Heap@@36))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon8_correct  (=> (= (_module.Universe.globalInv $Heap@@37 this@@50)  (and (_module.Universe.globalBaseInv $Heap@@37 this@@50) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@50) _module.Universe.content)) ($Box refType |o#2|))) (_module.Object.inv $Heap@@37 |o#2|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1196|
 :pattern ( (_module.Object.inv $Heap@@37 |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@50) _module.Universe.content)) ($Box refType |o#2|)))
)))) (=> (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@@37 this@@50) (=> (_module.Universe.globalBaseInv $Heap@@37 this@@50) (forall ((|o#2@@0| T@U) ) (!  (=> ($Is refType |o#2@@0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@50) _module.Universe.content)) ($Box refType |o#2@@0|)) (|_module.Object.inv#canCall| $Heap@@37 |o#2@@0|)))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1197|
 :pattern ( (_module.Object.inv $Heap@@37 |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@50) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))) ($Is boolType (bool_2_U (_module.Universe.globalInv $Heap@@37 this@@50)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@2|) (=> |b$reqreads#1@2| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@2|)))))))))
(let ((anon7_correct  (=> (= |b$reqreads#2@2| |b$reqreads#2@1|) (=> (and (= |b$reqreads#1@2| |b$reqreads#1@1|) (= (ControlFlow 0 7) 3)) anon8_correct))))
(let ((anon13_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@50) _module.Universe.content)) ($Box refType |o#1@0|))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 11) 7))) anon7_correct)))
(let ((anon13_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@50) _module.Universe.content)) ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@37) (= |b$reqreads#2@0| (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@0)))
 :qid |_12MutexLifetimelongdfy.24:62|
 :skolemid |1194|
)))) (=> (and (and (|_module.Object.inv#canCall| $Heap@@37 |o#1@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 9) 7))) anon7_correct)))))))
(let ((anon12_Then_correct  (=> (and (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@37)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@50 _module.Universe.content)))) (and (=> (= (ControlFlow 0 12) 9) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (and (not (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@37))) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 8) 7))) anon7_correct)))
(let ((anon11_Then_correct  (=> (_module.Universe.globalBaseInv $Heap@@37 this@@50) (and (=> (= (ControlFlow 0 13) 12) anon12_Then_correct) (=> (= (ControlFlow 0 13) 8) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (and (not (_module.Universe.globalBaseInv $Heap@@37 this@@50)) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#1@2| true) (= (ControlFlow 0 6) 3))) anon8_correct)))
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@50) Tclass._module.Universe? $Heap@@37) (=> (and (= |b$reqreads#0@0| (forall (($o@@33 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 $o@@33) alloc)))) (or (= $o@@33 this@@50) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@50) _module.Universe.content)) ($Box refType $o@@33)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@33 $f@@1)))
 :qid |_12MutexLifetimelongdfy.24:5|
 :skolemid |1193|
))) (|_module.Universe.globalBaseInv#canCall| $Heap@@37 this@@50)) (and (=> (= (ControlFlow 0 14) 13) anon11_Then_correct) (=> (= (ControlFlow 0 14) 6) anon11_Else_correct))))))
(let ((anon10_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#96| null $Heap@@37 alloc $Heap@@37 alloc)) (and (=> (= (ControlFlow 0 15) 1) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@37) ($IsHeapAnchor $Heap@@37)) (=> (and (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.Universe) ($IsAlloc refType this@@50 Tclass._module.Universe $Heap@@37))) (and (= 16 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
