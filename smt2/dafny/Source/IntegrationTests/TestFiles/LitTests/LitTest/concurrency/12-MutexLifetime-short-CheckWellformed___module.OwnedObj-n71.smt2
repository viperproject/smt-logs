...
(assert (distinct TBool TagBool TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.OwnedObject Tagclass._module.Object? Tagclass._module.Lifetime class._module.Universe? Tagclass._module.Lifetime? class._module.OwnedObject? Tagclass._module.OwnedObject? tytagFamily$Universe tytagFamily$Object tytagFamily$OwnedObject tytagFamily$Lifetime field$content field$owner)
)
(assert (= (FDim alloc) 0))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@2 this@@2) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.OwnedObject) ($IsAlloc refType this@@2 Tclass._module.OwnedObject $Heap@@2)))))) (and (|_module.OwnedObject.objectFields#canCall| $Heap@@2 this@@2) (= (_module.OwnedObject.baseFieldsInv $Heap@@2 this@@2) (|Set#Subset| (_module.OwnedObject.objectFields $Heap@@2 this@@2) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.Object.universe this@@2)) _module.Universe.content))))))
 :qid |_12MutexLifetimeshortdfy.432:19|
 :skolemid |1780|
 :pattern ( (_module.OwnedObject.baseFieldsInv $Heap@@2 this@@2) ($IsGoodHeap $Heap@@2))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.OwnedObject.objectUserFields#canCall| $Heap@@3 this@@3) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) (or (not (= this@@3 null)) (not true))) ($IsAlloc refType this@@3 Tclass._module.OwnedObject $Heap@@3)))) ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@3 this@@3) (TSet Tclass._module.Object) $Heap@@3))
 :qid |_12MutexLifetimeshortdfy.518:18|
 :skolemid |1877|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectUserFields $Heap@@3 this@@3) (TSet Tclass._module.Object) $Heap@@3))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@4 this@@4) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@4) (or (not (= this@@4 null)) (not true))) ($IsAlloc refType this@@4 Tclass._module.OwnedObject $Heap@@4)))) ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@4 this@@4) (TSet Tclass._module.Object) $Heap@@4))
 :qid |_12MutexLifetimeshortdfy.426:18|
 :skolemid |1772|
 :pattern ( ($IsAlloc SetType (_module.OwnedObject.objectFields $Heap@@4 this@@4) (TSet Tclass._module.Object) $Heap@@4))
))))
...
(assert (forall ((v@@2 T@U) (t0@@1 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SetType v@@2 (TSet t0@@1) h@@0) (forall ((bx@@11 T@U) ) (!  (=> (|Set#IsMember| v@@2 bx@@11) ($IsAllocBox bx@@11 t0@@1 h@@0))
...
(assert (forall (($h@@11 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@10 null)) (not true)) ($Is refType $o@@10 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@10) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@10) _module.OwnedObject.owner)) Tclass._module.Object? $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1755|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@10) _module.OwnedObject.owner)))
)))
...
(assert (forall (($o@@12 T@U) ) (!  (=> ($Is refType $o@@12 Tclass._module.Lifetime?) ($Is refType $o@@12 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |3499|
 :pattern ( ($Is refType $o@@12 Tclass._module.Lifetime?))
)))
...
(assert (= (Tag Tclass._module.OwnedObject?) Tagclass._module.OwnedObject?))
(assert (= (TagFamily Tclass._module.OwnedObject?) tytagFamily$OwnedObject))
(assert (forall (($h@@12 T@U) ($o@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@13 null)) (not true)) ($Is refType $o@@13 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@13) _module.OwnedObject.owner)) Tclass._module.Object?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1754|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@13) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h@@13 T@U) ($o@@17 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@17 null)) (not true)) ($Is refType $o@@17 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@17) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@17) _module.Universe.content)) (TSet Tclass._module.Object) $h@@13))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |817|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@18 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#115| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@18 $f))  (=> (and (or (not (= $o@@18 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@18) |l#2|)))) (or (= $o@@18 |l#3|) (= $o@@18 |l#4|))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3524|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#115| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@18 $f))
)))
(assert (forall (($h@@14 T@U) ($o@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@19 null)) (not true)) ($Is refType $o@@19 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@19) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |816|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@19) _module.Universe.content)))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (=> ($IsAllocBox ($Box refType this@@5) Tclass._module.OwnedObject? $Heap@@5) (=> (and (= |b$reqreads#0@0| (forall (($o@@20 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@20) alloc)))) (= $o@@20 this@@5)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@20 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.433:5|
 :skolemid |1782|
))) (|_module.OwnedObject.objectFields#canCall| $Heap@@5 this@@5)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= (_module.Object.universe this@@5) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@5) null)) (not true)) (=> (and (and (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 (_module.Object.universe this@@5) _module.Universe.content))) (= (_module.OwnedObject.baseFieldsInv $Heap@@5 this@@5) (|Set#Subset| (_module.OwnedObject.objectFields $Heap@@5 this@@5) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 (_module.Object.universe this@@5)) _module.Universe.content))))) (and (|_module.OwnedObject.objectFields#canCall| $Heap@@5 this@@5) ($Is boolType (bool_2_U (_module.OwnedObject.baseFieldsInv $Heap@@5 this@@5)) TBool))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@0|))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#115| null $Heap@@5 alloc this@@5 (_module.Object.universe this@@5))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.OwnedObject) ($IsAlloc refType this@@5 Tclass._module.OwnedObject $Heap@@5))) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
