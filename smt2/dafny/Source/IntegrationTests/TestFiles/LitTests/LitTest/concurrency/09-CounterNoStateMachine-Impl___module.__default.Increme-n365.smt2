...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split354)
...
))))) (and (= $Heap@37 $Heap@38) (or (not (= |universe#0| null)) (not true)))) (and (and (forall (($o@@185 T@U) ($f@@125 T@U) ) (!  (=> (and (and (or (not (= $o@@185 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@185) alloc)))) (or (= $o@@185 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType $o@@185)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@185 $f@@125)))
