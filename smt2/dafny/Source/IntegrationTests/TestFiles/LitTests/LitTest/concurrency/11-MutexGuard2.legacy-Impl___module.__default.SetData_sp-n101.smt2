...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split85)
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))))) (and (and (and (and (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (|_module.Universe.globalInv#canCall| $Heap@6 |universe#0|)) (and (and (|_module.Universe.globalInv#canCall| $Heap@6 |universe#0|) (and (_module.Universe.globalInv $Heap@6 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@6 |universe#0|) (forall ((|o#3@@5| T@U) ) (!  (=> (and ($Is refType |o#3@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@5|))) (_module.Object.inv $Heap@6 |o#3@@5|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |881|
