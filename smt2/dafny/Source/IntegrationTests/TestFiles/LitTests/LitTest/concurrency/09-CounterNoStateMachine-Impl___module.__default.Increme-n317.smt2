...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split306)
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (and ($IsGoodHeap $Heap@24) ($IsHeapAnchor $Heap@24)) (and (or (not (= call4formal@this@0@@1 null)) (not true)) (and ($Is refType call4formal@this@0@@1 Tclass._module.ConstantInteger) ($IsAlloc refType call4formal@this@0@@1 Tclass._module.ConstantInteger $Heap@24))))))))) (and (and (and (and (and (and (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@24 call4formal@this@0@@1) (=> (_module.Object.objectGlobalInv $Heap@24 call4formal@this@0@@1) (|_module.Universe.globalInv2#canCall| $Heap@23 $Heap@24 |universe#0|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@24 call4formal@this@0@@1) (and (_module.Object.objectGlobalInv $Heap@24 call4formal@this@0@@1) (and (_module.Object.baseInv $Heap@24 call4formal@this@0@@1) (_module.Universe.globalInv $Heap@24 (_module.Object.universe call4formal@this@0@@1)))))) (and (and (|_module.Universe.globalInv2#canCall| $Heap@23 $Heap@24 |universe#0|) (and (_module.Universe.globalInv2 $Heap@23 $Heap@24 |universe#0|) (and true (forall ((|o#8@@8| T@U) ) (!  (=> (and ($Is refType |o#8@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|)) (_module.Object.inv2 $Heap@23 $Heap@24 |o#8@@8|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |2895|
...
)) (= $Heap@36 $Heap@37)) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37) (= |##running#0_0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)))))) (and (and (and ($IsAlloc SetType |##running#0_0@1| (TSet Tclass._module.Thread) $Heap@37) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)) (and ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (TSet Tclass._module.Thread) $Heap@33) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))))))))))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@37 |universe#0|) (forall ((|o#0_4| T@U) ) (!  (=> (and ($Is refType |o#0_4| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0_4|))) (or (forall (($o@@182 T@U) ($f@@122 T@U) ) (!  (=> (or (not (= $o@@182 null)) (not true)) (=> (= $o@@182 |o#0_4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 $o@@182) $f@@122) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@182) $f@@122))))
 :qid |_09CounterNoStateMachinedfy.60:54|
 :skolemid |585|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 $o@@182) $f@@122))
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_4|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |o#0_4|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.60:16|
 :skolemid |586|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |o#0_4|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_4|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0_4|)))
)))))))))))
anon0_correct))
))
(check-sat)
