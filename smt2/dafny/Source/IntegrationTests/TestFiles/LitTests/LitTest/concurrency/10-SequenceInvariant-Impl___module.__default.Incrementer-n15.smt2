...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split4)
...
))))))) (and (=> (|_module.Universe.globalInv#canCall| $Heap@@51 |universe#0|) (or (_module.Universe.globalInv $Heap@@51 |universe#0|) (forall ((|o#1| T@U) ) (!  (=> (and ($Is refType |o#1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |o#1|))) (_module.Object.inv $Heap@@51 |o#1|))
 :qid |_10SequenceInvariantdfy.22:32|
 :skolemid |851|
 :pattern ( (_module.Object.inv $Heap@@51 |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |o#1|)))
)))) (= (ControlFlow 0 2) (- 0 1))))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |running#0|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
