...
))) (and (and ($HeapSucc $Heap@22 $Heap@23) (or (not (= |counter#0| null)) (not true))) (and (= |value##0_2@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |counter#0|) _module.IncreasingCounter.value)))) (= (ControlFlow 0 2) (- 0 1))))))))))) (forall (($o@@156 T@U) ($f@@101 T@U) ) (!  (=> (and (and (or (not (= $o@@156 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@156) alloc)))) (= $o@@156 |universe#0|)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@156 $f@@101)))
