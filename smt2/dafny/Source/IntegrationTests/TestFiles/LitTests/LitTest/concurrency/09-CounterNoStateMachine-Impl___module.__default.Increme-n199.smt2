...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split188)
...
))) (and ($HeapSucc $Heap@22 $Heap@23) (or (not (= |counter#0| null)) (not true)))) (and (and (and (= |value##0_2@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |counter#0|) _module.IncreasingCounter.value)))) (forall (($o@@156 T@U) ($f@@101 T@U) ) (!  (=> (and (and (or (not (= $o@@156 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@156) alloc)))) (= $o@@156 |universe#0|)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@156 $f@@101)))
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))))) (and (and (and (and (and ($IsGoodHeap $Heap@24) ($IsHeapAnchor $Heap@24)) (and (or (not (= call4formal@this@0@@1 null)) (not true)) (and ($Is refType call4formal@this@0@@1 Tclass._module.ConstantInteger) ($IsAlloc refType call4formal@this@0@@1 Tclass._module.ConstantInteger $Heap@24)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@24 call4formal@this@0@@1) (=> (_module.Object.objectGlobalInv $Heap@24 call4formal@this@0@@1) (|_module.Universe.globalInv2#canCall| $Heap@23 $Heap@24 |universe#0|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@24 call4formal@this@0@@1) (and (_module.Object.objectGlobalInv $Heap@24 call4formal@this@0@@1) (and (_module.Object.baseInv $Heap@24 call4formal@this@0@@1) (_module.Universe.globalInv $Heap@24 (_module.Object.universe call4formal@this@0@@1))))))) (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@23 $Heap@24 |universe#0|) (and (_module.Universe.globalInv2 $Heap@23 $Heap@24 |universe#0|) (and true (forall ((|o#8@@8| T@U) ) (!  (=> (and ($Is refType |o#8@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@8|)) (_module.Object.inv2 $Heap@23 $Heap@24 |o#8@@8|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |2895|
...
))))) (= (_module.Object.universe call4formal@this@0@@1) |universe#0|)) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 call4formal@this@0@@1) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 call4formal@this@0@@1) _module.ConstantInteger.value))) |value##0_2@1|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@1)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 call4formal@this@0@@1) alloc)))))))) (and (and (and (and (forall (($o@@157 T@U) ) (!  (=> (and (or (not (= $o@@157 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@157) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@157) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@157)) (= $o@@157 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.608:3|
 :skolemid |2896|
