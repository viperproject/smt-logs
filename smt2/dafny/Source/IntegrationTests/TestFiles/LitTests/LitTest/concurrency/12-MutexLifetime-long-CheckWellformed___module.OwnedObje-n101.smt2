...
(assert (distinct TBool TagBool TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.OwnedObject Tagclass._module.Object? Tagclass._module.Lifetime Tagclass._module.Lifetime? Tagclass._module.OwnedObject? class._module.Universe? class._module.OwnedObject? tytagFamily$Universe tytagFamily$Object tytagFamily$OwnedObject tytagFamily$Lifetime field$content field$owner)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@18 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#152| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@18 $f))  (=> (and (or (not (= $o@@18 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@18) |l#2|)))) (or (= $o@@18 |l#3|) (= $o@@18 |l#4|))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3870|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#152| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@18 $f))
)))
...
(assert (not
 ...
 :qid |_12MutexLifetimelongdfy.434:5|
 :skolemid |2134|
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#152| null $Heap@@5 alloc this@@5 (_module.Object.universe this@@5))) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct)))))
