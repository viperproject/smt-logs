...
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@4 this@@4) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.OwnedObject) ($IsAlloc refType this@@4 Tclass._module.OwnedObject $Heap@@4)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@4 this@@4) (=> (_module.OwnedObject.localInv $Heap@@4 this@@4) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.userInv#canCall| $Heap@@4 this@@4)))) (= (_module.OwnedObject.inv $Heap@@4 this@@4)  (and (_module.OwnedObject.localInv $Heap@@4 this@@4) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@4) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.userInv $Heap@@4 this@@4))))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@6 this@@6) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Object) ($IsAlloc refType this@@6 Tclass._module.Object $Heap@@6)))))) (and (|_module.Object.nonAliasing#canCall| $Heap@@6 this@@6) (= (_module.Object.triggerAxioms $Heap@@6 this@@6) (_module.Object.nonAliasing $Heap@@6 this@@6))))
 :qid |_12MutexLifetimeshortdfy.314:19|
 :skolemid |1376|
 :pattern ( (_module.Object.triggerAxioms $Heap@@6 this@@6) ($IsGoodHeap $Heap@@6))
))))
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@15 this@@18) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.OwnedObject) ($IsAlloc refType this@@18 Tclass._module.OwnedObject $Heap@@15)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@15 this@@18) (=> (_module.Object.objectGlobalBaseInv $Heap@@15 this@@18) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.OwnedObject.lifetime this@@18)) _module.Lifetime.elements)) ($Box refType this@@18)) (and (|_module.Lifetime.alive#canCall| $Heap@@15 (_module.OwnedObject.lifetime this@@18)) (=> (=> (_module.Lifetime.alive $Heap@@15 (_module.OwnedObject.lifetime this@@18)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@18) _module.OwnedObject.owner)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@18) _module.OwnedObject.owner)) null)) (not true)) (|_module.OwnedObject.localUserInv#canCall| $Heap@@15 this@@18))))))) (= (_module.OwnedObject.localInv $Heap@@15 this@@18)  (and (and (and (_module.Object.objectGlobalBaseInv $Heap@@15 this@@18) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 (_module.OwnedObject.lifetime this@@18)) _module.Lifetime.elements)) ($Box refType this@@18))) (=> (_module.Lifetime.alive $Heap@@15 (_module.OwnedObject.lifetime this@@18)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@18) _module.OwnedObject.owner)) null)) (not true)))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@15 this@@18) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv $Heap@@15 this@@18))))))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1801|
 :pattern ( (_module.OwnedObject.localInv $Heap@@15 this@@18) ($IsGoodHeap $Heap@@15))
))))
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@16 this@@19) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.OwnedObject) ($IsAlloc refType this@@19 Tclass._module.OwnedObject $Heap@@16)))))) (=> (_module.OwnedObject.localInv $Heap@@16 this@@19) (_module.Object.objectGlobalBaseInv $Heap@@16 this@@19)))
 :qid |_12MutexLifetimeshortdfy.442:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localInv $Heap@@16 this@@19))
))))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@17 this@@20) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.OwnedObject) ($IsAlloc refType this@@20 Tclass._module.OwnedObject $Heap@@17)))))) (=> (_module.OwnedObject.userInv $Heap@@17 this@@20) (_module.OwnedObject.localUserInv $Heap@@17 this@@20)))
 :qid |_12MutexLifetimeshortdfy.522:19|
 :skolemid |1893|
 :pattern ( (_module.OwnedObject.userInv $Heap@@17 this@@20))
))))
(assert  (=> (<= 14 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@18 this@@21) (and (< 14 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.OwnedObject) ($IsAlloc refType this@@21 Tclass._module.OwnedObject $Heap@@18)))))) (=> (_module.OwnedObject.inv $Heap@@18 this@@21) (_module.OwnedObject.localInv $Heap@@18 this@@21)))
 :qid |_12MutexLifetimeshortdfy.448:19|
 :skolemid |1813|
 :pattern ( (_module.OwnedObject.inv $Heap@@18 this@@21))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@22 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@22)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@22)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :weight 3
 :skolemid |1499|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@22)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@23 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@23)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@23)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :weight 3
 :skolemid |1766|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@23)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@24 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@24)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@24)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :weight 3
 :skolemid |1944|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@24)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@25 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@25) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.Thread)))) (= (_module.Object.objectClassKind this@@25) (_module.Thread.objectClassKind this@@25)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1500|
 :pattern ( (_module.Object.objectClassKind this@@25) ($Is refType this@@25 Tclass._module.Thread))
 :pattern ( (_module.Object.objectClassKind this@@25) (_module.Thread.objectClassKind this@@25))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@26 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@26) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@26 null)) (not true)) ($Is refType this@@26 Tclass._module.OwnedObject)))) (= (_module.Object.objectClassKind this@@26) (_module.OwnedObject.objectClassKind this@@26)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1767|
 :pattern ( (_module.Object.objectClassKind this@@26) ($Is refType this@@26 Tclass._module.OwnedObject))
 :pattern ( (_module.Object.objectClassKind this@@26) (_module.OwnedObject.objectClassKind this@@26))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@27 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@27) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@27 null)) (not true)) ($Is refType this@@27 Tclass._module.Lifetime)))) (= (_module.Object.objectClassKind this@@27) (_module.Lifetime.objectClassKind this@@27)))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1945|
 :pattern ( (_module.Object.objectClassKind this@@27) ($Is refType this@@27 Tclass._module.Lifetime))
 :pattern ( (_module.Object.objectClassKind this@@27) (_module.Lifetime.objectClassKind this@@27))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@28 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| this@@28) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@28 null)) (not true)) ($Is refType this@@28 Tclass._module.Thread)))) ($Is DatatypeTypeType (_module.Thread.objectClassKind this@@28) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :skolemid |1496|
 :pattern ( (_module.Thread.objectClassKind this@@28))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@29 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| this@@29) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@29 null)) (not true)) ($Is refType this@@29 Tclass._module.OwnedObject)))) ($Is DatatypeTypeType (_module.OwnedObject.objectClassKind this@@29) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :skolemid |1763|
 :pattern ( (_module.OwnedObject.objectClassKind this@@29))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@30 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| this@@30) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@30 null)) (not true)) ($Is refType this@@30 Tclass._module.Lifetime)))) ($Is DatatypeTypeType (_module.Lifetime.objectClassKind this@@30) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :skolemid |1941|
 :pattern ( (_module.Lifetime.objectClassKind this@@30))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@31 T@U) ) (!  (=> (or (|_module.Object.objectClassKind#canCall| this@@31) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@31 null)) (not true)) ($Is refType this@@31 Tclass._module.Object)))) ($Is DatatypeTypeType (_module.Object.objectClassKind this@@31) Tclass._module.ObjectClassKind))
 :qid |_12MutexLifetimeshortdfy.347:18|
 :skolemid |1418|
 :pattern ( (_module.Object.objectClassKind this@@31))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 10)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= OwnedObject_$_ReadsFrame@0 (|lambda#59| null $Heap@@21 alloc $Heap@@21 alloc)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@32) alloc))))
 :qid |_12MutexLifetimeshortdfy.448:19|
 :skolemid |1821|
 ...
 :qid |_12MutexLifetimeshortdfy.448:19|
 :skolemid |1821|
)) (=> (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (_module.OwnedObject.localInv $Heap@@21 this@@34)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@34) (or (_module.Object.objectGlobalBaseInv $Heap@@21 this@@34) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.Object.universe this@@34)) _module.Universe.content)) ($Box refType this@@34)))))))) (=> (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@34) (or (_module.Object.objectGlobalBaseInv $Heap@@21 this@@34) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.Object.universe this@@34)) _module.Universe.content)) ($Box refType this@@34))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@34) (or (_module.Object.objectGlobalBaseInv $Heap@@21 this@@34) (_module.Object.baseFieldsInv $Heap@@21 this@@34))))))) (=> (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@34) (or (_module.Object.objectGlobalBaseInv $Heap@@21 this@@34) (_module.Object.baseFieldsInv $Heap@@21 this@@34)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@34) (or (_module.Object.objectGlobalBaseInv $Heap@@21 this@@34) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@21 (_module.Object.universe this@@34)) (or (_module.Universe.globalBaseInv $Heap@@21 (_module.Object.universe this@@34)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@34) (or (_module.Object.objectGlobalBaseInv $Heap@@21 this@@34) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@21 (_module.Object.universe this@@34)) (or (_module.Universe.globalBaseInv $Heap@@21 (_module.Object.universe this@@34)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@34) (or (_module.Object.objectGlobalBaseInv $Heap@@21 this@@34) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@21 (_module.Object.universe this@@34)) (or (_module.Universe.globalBaseInv $Heap@@21 (_module.Object.universe this@@34)) (forall ((|o#1| T@U) ) (!  (=> (and ($Is refType |o#1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.Object.universe this@@34)) _module.Universe.content)) ($Box refType |o#1|))) (and (and (and (= (_module.Object.universe |o#1|) (_module.Object.universe this@@34)) (or (not (= |o#1| (_module.Object.universe this@@34))) (not true))) (_module.Object.baseFieldsInv $Heap@@21 |o#1|)) (_module.Object.triggerAxioms $Heap@@21 |o#1|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1822|
 :pattern ( (_module.Object.triggerAxioms $Heap@@21 |o#1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@21 |o#1|))
 :pattern ( (_module.Object.universe |o#1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.Object.universe this@@34)) _module.Universe.content)) ($Box refType |o#1|)))
)))))))))) (=> (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@21 this@@34) (or (_module.Object.objectGlobalBaseInv $Heap@@21 this@@34) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@21 (_module.Object.universe this@@34)) (or (_module.Universe.globalBaseInv $Heap@@21 (_module.Object.universe this@@34)) (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.Object.universe this@@34)) _module.Universe.content)) ($Box refType |o#1@@0|))) (and (and (and (= (_module.Object.universe |o#1@@0|) (_module.Object.universe this@@34)) (or (not (= |o#1@@0| (_module.Object.universe this@@34))) (not true))) (_module.Object.baseFieldsInv $Heap@@21 |o#1@@0|)) (_module.Object.triggerAxioms $Heap@@21 |o#1@@0|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1822|
 :pattern ( (_module.Object.triggerAxioms $Heap@@21 |o#1@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@21 |o#1@@0|))
 :pattern ( (_module.Object.universe |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.Object.universe this@@34)) _module.Universe.content)) ($Box refType |o#1@@0|)))
))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.OwnedObject.lifetime this@@34)) _module.Lifetime.elements)) ($Box refType this@@34)))))) (=> (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 (_module.OwnedObject.lifetime this@@34)) _module.Lifetime.elements)) ($Box refType this@@34))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (_module.Lifetime.alive $Heap@@21 (_module.OwnedObject.lifetime this@@34)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@34) _module.OwnedObject.owner)) null)) (not true))))))) (=> (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (_module.Lifetime.alive $Heap@@21 (_module.OwnedObject.lifetime this@@34)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@34) _module.OwnedObject.owner)) null)) (not true)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.OwnedObject.inv $Heap@@21 this@@34) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@21 this@@34) (or (_module.OwnedObject.localInv $Heap@@21 this@@34) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@34) _module.OwnedObject.owner)) null)) (not true)) (_module.OwnedObject.localUserInv $Heap@@21 this@@34))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (=> (and (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.OwnedObject) ($IsAlloc refType this@@34 Tclass._module.OwnedObject $Heap@@21))) (and (= 14 $FunctionContextHeight) (= (ControlFlow 0 11) 2))) anon0_correct))))
