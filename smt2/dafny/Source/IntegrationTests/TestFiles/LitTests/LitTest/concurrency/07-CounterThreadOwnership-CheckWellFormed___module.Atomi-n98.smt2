...
(assert (forall (($prevHeap@@3 T@U) ($h0@@2 T@U) ($h1@@2 T@U) (this@@4 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.AtomicCounter))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@2 T@U) ($f@@2 T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 this@@4)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@2) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@2) $f@@2)))) (= (_module.AtomicCounter.unchangedNonvolatileUserFields $prevHeap@@3 $h0@@2 this@@4) (_module.AtomicCounter.unchangedNonvolatileUserFields $prevHeap@@3 $h1@@2 this@@4))))
...
(assert (forall (($prevHeap@@18 T@U) ($h0@@17 T@U) ($h1@@17 T@U) (this@@27 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.AtomicCounter) ($IsAlloc refType this@@27 Tclass._module.AtomicCounter $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@20 T@U) ($f@@17 T@U) )  (=> (and (or (not (= $o@@20 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@20) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@20) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@20) $f@@17)))) (= (_module.AtomicCounter.localUserInv2 $prevHeap@@18 $h0@@17 this@@27) (_module.AtomicCounter.localUserInv2 $prevHeap@@18 $h1@@17 this@@27))))
 :pattern ( ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17) (_module.AtomicCounter.localUserInv2 $prevHeap@@18 $h1@@17 this@@27))
)))
(assert (forall (($prevHeap@@19 T@U) ($h0@@18 T@U) ($h1@@18 T@U) (this@@28 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.AtomicCounter) ($IsAlloc refType this@@28 Tclass._module.AtomicCounter $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@21 T@U) ($f@@18 T@U) )  (=> (and (or (not (= $o@@21 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@21) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@21) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@21) $f@@18)))) (= (_module.AtomicCounter.userInv2 $prevHeap@@19 $h0@@18 this@@28) (_module.AtomicCounter.userInv2 $prevHeap@@19 $h1@@18 this@@28))))
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@73 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@73 null)) (not true)) (and ($Is refType this@@73 Tclass._module.AtomicCounter) ($IsAlloc refType this@@73 Tclass._module.AtomicCounter $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@58 T@U) ($f@@41 T@U) )  (=> (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@58) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@58) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@58) $f@@41)))) (= (_module.AtomicCounter.baseUserInv $h0@@31 this@@73) (_module.AtomicCounter.baseUserInv $h1@@31 this@@73))))
 :pattern ( ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31) (_module.AtomicCounter.baseUserInv $h1@@31 this@@73))
)))
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@74 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.AtomicCounter) ($IsAlloc refType this@@74 Tclass._module.AtomicCounter $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@59 T@U) ($f@@42 T@U) )  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@59) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@59) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@59) $f@@42)))) (= (_module.AtomicCounter.localUserInv $h0@@32 this@@74) (_module.AtomicCounter.localUserInv $h1@@32 this@@74))))
 :pattern ( ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32) (_module.AtomicCounter.localUserInv $h1@@32 this@@74))
)))
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@75 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@75 null)) (not true)) (and ($Is refType this@@75 Tclass._module.AtomicCounter) ($IsAlloc refType this@@75 Tclass._module.AtomicCounter $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@60 T@U) ($f@@43 T@U) )  (=> (and (or (not (= $o@@60 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@60) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@60) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@60) $f@@43)))) (= (_module.AtomicCounter.userInv $h0@@33 this@@75) (_module.AtomicCounter.userInv $h1@@33 this@@75))))
