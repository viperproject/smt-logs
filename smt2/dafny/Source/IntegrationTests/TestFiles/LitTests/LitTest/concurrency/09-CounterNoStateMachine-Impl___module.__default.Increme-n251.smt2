...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split240)
...
)))))))) (and (and (and (and ($IsGoodHeap $Heap@29) ($IsHeapAnchor $Heap@29)) (and (|_module.Universe.globalInv#canCall| $Heap@28 |universe#0|) (=> (_module.Universe.globalInv $Heap@28 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@27 $Heap@28 |universe#0|)))) (and (and (|_module.Universe.globalInv#canCall| $Heap@28 |universe#0|) (and (_module.Universe.globalInv $Heap@28 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@28 |universe#0|) (forall ((|o#17@@7| T@U) ) (!  (=> (and ($Is refType |o#17@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@28 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@7|))) (_module.Object.inv $Heap@28 |o#17@@7|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))))) (and (and (and (= $Heap@28 $Heap@29) (or (not (= |universe#0| null)) (not true))) (and (forall (($o@@170 T@U) ($f@@113 T@U) ) (!  (=> (and (and (or (not (= $o@@170 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@29 $o@@170) alloc)))) (or (= $o@@170 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@29 |universe#0|) _module.Universe.content)) ($Box refType $o@@170)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@170 $f@@113)))
