...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@1 this@@1) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Thread) ($IsAlloc refType this@@1 Tclass._module.Thread $Heap@@1)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.baseInv#canCall| $Heap@@1 this@@1)) (= (_module.Thread.localInv $Heap@@1 this@@1)  (and true (_module.Object.baseInv $Heap@@1 this@@1)))))
 :qid |_07CounterThreadOwnershipdfy.284:19|
 :skolemid |1088|
 :pattern ( (_module.Thread.localInv $Heap@@1 this@@1) ($IsGoodHeap $Heap@@1))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_correct  (=> (and (and (= (_module.Thread.localInv $Heap@@2 this@@2)  (and true (_module.Object.baseInv $Heap@@2 this@@2))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.baseInv#canCall| $Heap@@2 this@@2))) (and ($Is boolType (bool_2_U (_module.Thread.localInv $Heap@@2 this@@2)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@1|)))
(let ((anon8_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 5) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@2) Tclass._module.Object? $Heap@@2)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@12 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@12) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@12) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@12 $f@@0)))
 :qid |_07CounterThreadOwnershipdfy.285:8|
 :skolemid |1090|
))) (|_module.Object.baseInv#canCall| $Heap@@2 this@@2)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3))) anon5_correct))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null $Heap@@2 alloc $Heap@@2 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 4) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Thread) ($IsAlloc refType this@@2 Tclass._module.Thread $Heap@@2))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
