...
)))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|))) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (= (+ |i#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.Integer.value)))) (LitInt 10)))))) (and (and (and (forall (($o@@122 T@U) ) (!  (=> (and (or (not (= $o@@122 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 $o@@122) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@122) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@122)) (or (= $o@@122 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@94 |universe#0|) _module.Universe.content)) ($Box refType $o@@122)))))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |544|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@122))
)) ($HeapSucc $Heap@3 $Heap@4)) (and (forall (($o@@123 T@U) ($f@@74 T@U) ) (!  (=> (and (or (not (= $o@@123 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@123) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@123) $f@@74) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@123) $f@@74)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@123 $f@@74))))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |545|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@123) $f@@74))
)) (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|))) (and (and |$w$loop#0@0| (< |i#0@1| 10)) (and (= |$decr$loop#00@1| (- 10 |i#0@1|)) (or (not (= |counter#0| null)) (not true))))))) (and (and (and (and (and (= |value##0_0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |counter#0|) _module.IncreasingCounter.value)))) (forall (($o@@124 T@U) ($f@@75 T@U) ) (!  (=> (and (and (or (not (= $o@@124 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@124) alloc)))) (= $o@@124 |universe#0|)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@124 $f@@75)))
 :qid |_09CounterNoStateMachinedfy.718:26|
 :skolemid |547|
))) (and (or (not (= call4formal@this null)) (not true)) (and ($Is refType call4formal@this Tclass._module.ConstantInteger) ($IsAlloc refType call4formal@this Tclass._module.ConstantInteger $Heap@@94)))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalInv $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#0@@15| T@U) ) (!  (=> (and ($Is refType |o#0@@15| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@15|))) (and (= (_module.Object.universe |o#0@@15|) |universe#0|) (or (not (= |o#0@@15| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |2878|
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))) (and (and (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (and (or (not (= call4formal@this@0 null)) (not true)) (and ($Is refType call4formal@this@0 Tclass._module.ConstantInteger) ($IsAlloc refType call4formal@this@0 Tclass._module.ConstantInteger $Heap@9)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@9 call4formal@this@0) (=> (_module.Object.objectGlobalInv $Heap@9 call4formal@this@0) (|_module.Universe.globalInv2#canCall| $Heap@4 $Heap@9 |universe#0|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@9 call4formal@this@0) (and (_module.Object.objectGlobalInv $Heap@9 call4formal@this@0) (and (_module.Object.baseInv $Heap@9 call4formal@this@0) (_module.Universe.globalInv $Heap@9 (_module.Object.universe call4formal@this@0)))))))) (and (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@4 $Heap@9 |universe#0|) (and (_module.Universe.globalInv2 $Heap@4 $Heap@9 |universe#0|) (and true (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@0|)) (_module.Object.inv2 $Heap@4 $Heap@9 |o#8@@0|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |2895|
...
))))) (and (= (_module.Object.universe call4formal@this@0) |universe#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 call4formal@this@0) _module.OwnedObject.owner)) |running#0@@3|))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 call4formal@this@0) _module.ConstantInteger.value))) |value##0_0@1|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0))))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call4formal@this@0) alloc)))) (forall (($o@@125 T@U) ) (!  (=> (and (or (not (= $o@@125 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@125) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@125) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@125)) (= $o@@125 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.608:3|
 :skolemid |2896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@125))
))))) (and (and (and ($HeapSucc $Heap@4 $Heap@9) (forall (($o@@126 T@U) ($f@@76 T@U) ) (!  (=> (and (and (or (not (= $o@@126 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@126) alloc)))) (= $o@@126 |universe#0|)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@126 $f@@76)))
 :qid |_09CounterNoStateMachinedfy.719:19|
 :skolemid |549|
))) (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType call5formal@this Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@94)))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalInv $Heap@9 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@9 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@9 |universe#0|) (forall ((|o#0@@16| T@U) ) (!  (=> (and ($Is refType |o#0@@16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@16|))) (and (= (_module.Object.universe |o#0@@16|) |universe#0|) (or (not (= |o#0@@16| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |3150|
...
)))) (= (ControlFlow 0 2) (- 0 1)))))))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
