...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.O.i0#canCall| $Heap@@1 this@@2) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.O) ($IsAlloc refType this@@2 Tclass._module.O $Heap@@1)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 (_module.O.s this@@2)) _module.S.obs)) ($Box refType this@@2)) (|_module.S.i0#canCall| $Heap@@1 (_module.O.s this@@2))) (= (_module.O.i0 $Heap@@1 this@@2)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 (_module.O.s this@@2)) _module.S.obs)) ($Box refType this@@2)) (_module.S.i0 $Heap@@1 (_module.O.s this@@2))))))
 :qid |_01InnerOuterdfy.49:19|
 :skolemid |624|
 :pattern ( (_module.O.i0 $Heap@@1 this@@2) ($IsGoodHeap $Heap@@1))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.O.gi#canCall| $Heap@@2 this@@3) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.O) ($IsAlloc refType this@@3 Tclass._module.O $Heap@@2)))))) (and (and (|_module.O.i0#canCall| $Heap@@2 this@@3) (=> (_module.O.i0 $Heap@@2 this@@3) (|_module.S.i#canCall| $Heap@@2 (_module.O.s this@@3)))) (= (_module.O.gi $Heap@@2 this@@3)  (and (_module.O.i0 $Heap@@2 this@@3) (_module.S.i $Heap@@2 (_module.O.s this@@3))))))
 :qid |_01InnerOuterdfy.65:19|
 :skolemid |655|
 :pattern ( (_module.O.gi $Heap@@2 this@@3) ($IsGoodHeap $Heap@@2))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@6 T@U) (|o#0@@6| T@U) ) (!  (=> (or (|_module.S.upCast#canCall| this@@6 |o#0@@6|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.S)) ($Is refType |o#0@@6| Tclass._System.object)))) ($Is refType (_module.S.upCast this@@6 |o#0@@6|) Tclass._System.object))
 :qid |_01InnerOuterdfy.12:18|
 :skolemid |486|
 :pattern ( (_module.S.upCast this@@6 |o#0@@6|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@7 T@U) (|o#0@@7| T@U) ) (!  (=> (or (|_module.S.upCast#canCall| this@@7 (Lit refType |o#0@@7|)) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.S)) ($Is refType |o#0@@7| Tclass._System.object)))) (= (_module.S.upCast this@@7 (Lit refType |o#0@@7|)) (Lit refType |o#0@@7|)))
 :qid |_01InnerOuterdfy.12:18|
 :weight 3
 :skolemid |490|
 :pattern ( (_module.S.upCast this@@7 (Lit refType |o#0@@7|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.O.gi)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_correct  (=> (= (_module.O.gi $Heap@@4 this@@8)  (and (_module.O.i0 $Heap@@4 this@@8) (_module.S.i $Heap@@4 (_module.O.s this@@8)))) (=> (and (and (|_module.O.i0#canCall| $Heap@@4 this@@8) (=> (_module.O.i0 $Heap@@4 this@@8) (|_module.S.i#canCall| $Heap@@4 (_module.O.s this@@8)))) ($Is boolType (bool_2_U (_module.O.gi $Heap@@4 this@@8)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@1|)))))))
(let ((anon8_Else_correct  (=> (not (_module.O.i0 $Heap@@4 this@@8)) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 7) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (_module.O.i0 $Heap@@4 this@@8) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (_module.O.s this@@8) null)) (not true))) (=> (or (not (= (_module.O.s this@@8) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.O.s this@@8)) Tclass._module.S? $Heap@@4) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@10) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@10 $f@@0)))
 :qid |_01InnerOuterdfy.65:44|
 :skolemid |657|
))) (|_module.S.i#canCall| $Heap@@4 (_module.O.s this@@8))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 5) 3))) anon5_correct)))))))
(let ((anon7_Else_correct  (=> ($IsAllocBox ($Box refType this@@8) Tclass._module.O? $Heap@@4) (=> (and (= |b$reqreads#0@0| (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@11) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@11) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@11 $f@@1)))
 :qid |_01InnerOuterdfy.65:34|
 :skolemid |656|
))) (|_module.O.i0#canCall| $Heap@@4 this@@8)) (and (=> (= (ControlFlow 0 8) 5) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.O) ($IsAlloc refType this@@8 Tclass._module.O $Heap@@4))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
