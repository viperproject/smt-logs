...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split242)
...
)))))) (and (and (forall (($o@@171 T@U) ) (!  (=> (and (or (not (= $o@@171 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@29 $o@@171) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@30 $o@@171) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@29 $o@@171)) (or (= $o@@171 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@29 |universe#0|) _module.Universe.content)) ($Box refType $o@@171)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@30 $o@@171))
)) ($HeapSucc $Heap@29 $Heap@30)) (and (= |i#0@2| (+ |i#0@1| 1)) (= (ControlFlow 0 2) (- 0 1))))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
