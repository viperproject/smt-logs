...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split176)
...
)))))) (and (and ($IsGoodHeap $Heap@15) ($IsHeapAnchor $Heap@15)) (and (|_module.Universe.globalInv#canCall| $Heap@14 |universe#0|) (=> (_module.Universe.globalInv $Heap@14 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@12 $Heap@14 |universe#0|)))))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@14 |universe#0|) (and (_module.Universe.globalInv $Heap@14 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@14 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@14 |o#10@@0|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1024|
