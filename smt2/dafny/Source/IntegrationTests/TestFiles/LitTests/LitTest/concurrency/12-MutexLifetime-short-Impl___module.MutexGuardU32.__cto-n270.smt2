...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split39)
...
)))) (= (ControlFlow 0 2) (- 0 1))))))))) (_module.Object.baseFieldsInv $Heap@4 this@@222))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
