...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#22| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@100) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@100 Tclass._module.OwnedU32 $Heap@@58)) (=> ($IsAlloc refType this@@100 Tclass._module.OwnedU32 $Heap@@58) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@58)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@58) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@100 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@100 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@100) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@100 Tclass._module.OwnedU32 $Heap@@58))))))))))
