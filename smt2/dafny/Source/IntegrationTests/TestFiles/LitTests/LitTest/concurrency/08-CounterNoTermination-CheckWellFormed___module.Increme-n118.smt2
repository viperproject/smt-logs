...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#106| null $Heap@@71 alloc this@@113 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.IncrementerMethod.counter)))) ($IsAllocBox ($Box refType this@@113) Tclass._module.Object? $Heap@@71)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@@71 this@@113) (_module.Object.objectGlobalInv $Heap@@71 this@@113))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |running#0| null)) (not true))) (=> (or (not (= |running#0| null)) (not true)) (=> (= (_module.Object.universe |running#0|) (_module.Object.universe this@@113)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (_module.Object.universe this@@113) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@113) null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 (_module.Object.universe this@@113)) _module.Universe.content)) ($Box refType |running#0|)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.OwnedObject.owner)) |running#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.IncrementerMethod.programCounter))) (LitInt 3))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@94 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 $o@@94) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@94) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 $o@@94)) (or (= $o@@94 this@@113) (= $o@@94 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@71 this@@113) _module.IncrementerMethod.counter))))))
 :qid |_08CounterNoTerminationdfy.533:10|
 :skolemid |1963|
