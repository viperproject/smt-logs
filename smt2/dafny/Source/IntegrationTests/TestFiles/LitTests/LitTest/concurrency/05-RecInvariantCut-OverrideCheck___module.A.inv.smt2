...
(assert (distinct alloc Tagclass._module.Object Tagclass._module.Object? Tagclass._module.A? Tagclass._module.A tytagFamily$Object tytagFamily$A)
)
...
(assert (forall (($o@@3 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@3 Tclass._module.A? $heap) ($IsAlloc refType $o@@3 Tclass._module.Object? $heap))
 :qid |unknown.0:0|
 :skolemid |1024|
...
(assert (forall (($o@@4 T@U) ) (!  (=> ($Is refType $o@@4 Tclass._module.A?) ($Is refType $o@@4 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |1023|
...
(declare-fun A_$_ReadsFrame@0 () T@U)
...
(set-info :boogie-vc-id OverrideCheck$$_module.A.inv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (and (= A_$_ReadsFrame@0 (|lambda#1| null $Heap alloc $Heap alloc)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc))))
 :qid |_05RecInvariantCutdfy.97:19|
 :skolemid |713|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A $Heap))) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
