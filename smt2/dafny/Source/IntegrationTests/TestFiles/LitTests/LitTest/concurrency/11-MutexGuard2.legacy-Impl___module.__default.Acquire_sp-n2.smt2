...
(set-info :boogie-vc-id Impl$$_module.__default.Acquire_split1)
...
(assert (not
...
))))))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@0 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@0 $Heap@0 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@0 $Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@0 |universe#0|) (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@4|))) (and (and (and (= (_module.Object.universe |o#1@@4|) |universe#0|) (or (not (= |o#1@@4| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@0 |o#1@@4|)) (_module.Object.triggerAxioms $Heap@0 |o#1@@4|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |790|
 :pattern ( (_module.Object.triggerAxioms $Heap@0 |o#1@@4|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@0 |o#1@@4|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@0 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@0 $Heap@0 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@1| T@U) ) (!  (=> (and ($Is refType |o#3@@1| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@1|)))) (or (forall (($o@@109 T@U) ($f@@64 T@U) ) (!  (=> (or (not (= $o@@109 null)) (not true)) (=> (= $o@@109 |o#3@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@109) $f@@64) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@109) $f@@64))))
 :qid |_11MutexGuard2legacydfy.57:65|
 :skolemid |794|
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@0 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@0 $Heap@0 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@0 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@0 $Heap@0 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#4@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.owner) Tclass._module.Object $Heap@0)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_11MutexGuard2legacydfy.60:16|
 :skolemid |796|
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| $Heap@0 $Heap@0 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@0 $Heap@0 |universe#0| |running#0@@3|) (forall ((|o#7@@1| T@U) ) (!  (=> (and ($Is refType |o#7@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@1|))) (and (or (forall (($o@@112 T@U) ($f@@67 T@U) ) (!  (=> (or (not (= $o@@112 null)) (not true)) (=> (= $o@@112 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@112) $f@@67) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@112) $f@@67))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |804|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@112) $f@@67))
)) (_module.Object.inv $Heap@0 |o#7@@1|)) (or (forall (($o@@113 T@U) ($f@@68 T@U) ) (!  (=> (or (not (= $o@@113 null)) (not true)) (=> (= $o@@113 |o#7@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@113) $f@@68) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@113) $f@@68))))
 :qid |_11MutexGuard2legacydfy.77:49|
 :skolemid |805|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@113) $f@@68))
)) (_module.Object.inv2 $Heap@0 $Heap@0 |o#7@@1|))))
 :qid |_11MutexGuard2legacydfy.77:16|
 :skolemid |806|
 :pattern ( (_module.Object.inv2 $Heap@0 $Heap@0 |o#7@@1|))
 :pattern ( (_module.Object.inv $Heap@0 |o#7@@1|))
