...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split96)
...
))))) (and (and (and (= $Heap@14 $Heap@15) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@13) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@13))) (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@13) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.legalTransition#canCall| $Heap@13 $Heap@15 |universe#0| |running#0@@3|))))))))) (or (_module.Universe.legalTransition $Heap@13 $Heap@15 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@13 $Heap@15 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@13 $Heap@15 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@13 $Heap@15 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@13 $Heap@15 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
