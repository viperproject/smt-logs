...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split45)
...
)) ($HeapSucc $Heap@3 $Heap@4)) (and (or (not (= |call4formal@guard#0@0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex)) null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
