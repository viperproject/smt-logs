...
(set-info :boogie-vc-id CheckWellformed$$_module.Universe.i0)
...
))) (and ($Is boolType (bool_2_U (_module.Universe.i0 $Heap@@1 this@@0)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#1@1|)))
