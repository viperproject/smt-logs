...
(set-info :boogie-vc-id Impl$$_module.OutlivesClaim.__ctor_split2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@99) ($IsHeapAnchor $Heap@@99)) (=> (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@99)) (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@99))) (=> (and (and (and (and ($Is refType |target#0| Tclass._module.Lifetime) ($IsAlloc refType |target#0| Tclass._module.Lifetime $Heap@@99)) (and ($Is refType |source#0| Tclass._module.Lifetime) ($IsAlloc refType |source#0| Tclass._module.Lifetime $Heap@@99))) (and (and (=> |defass#lifetime#0| (and ($Is refType |lifetime#0| Tclass._module.Lifetime) ($IsAlloc refType |lifetime#0| Tclass._module.Lifetime $Heap@@99))) true) (= 23 $FunctionContextHeight))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@99 |universe#0|) (and (_module.Universe.globalInv $Heap@@99 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@@99 |o#10|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |2870|
...
))))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType |target#0|)) ($Box refType |source#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |target#0|) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |source#0|) _module.Lifetime.owner))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |source#0|) _module.Lifetime.owner)) |running#0@@3|)))) (=> (and (and (and (and (and (|_module.Universe.outlives#canCall| $Heap@@99 |universe#0| |target#0| |source#0|) (and (_module.Universe.outlives ($LS $LZ) $Heap@@99 |universe#0| |target#0| |source#0|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |source#0|) _module.Lifetime.mightPointTo)) ($Box refType |target#0|)) (exists ((|x#1| T@U) ) (!  (and (and ($Is refType |x#1| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |x#1|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@99 |universe#0| |target#0| |x#1| |source#0|))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |2872|
...
))))) (= (_module.Object.universe call5formal@this@0) |universe#0|)) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.elements)) |Set#Empty|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.mightPointTo)) |mightPointTo##0@0|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call5formal@this@0) _module.Lifetime.mightPointFrom)) |Set#Empty|)))))) (=> (and (and (and (and (and (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))) (forall ((|l#3@@1| T@U) ) (!  (=> (and ($Is refType |l#3@@1| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#3@@1|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#3@@1|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType call5formal@this@0)))))
...
)))) (and (and (forall (($o@@111 T@U) ($f@@68 T@U) ) (!  (=> (and (or (not (= $o@@111 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@111) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111) $f@@68) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@111) $f@@68)) (or (= $o@@111 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@111)) (= $f@@68 _module.Lifetime.mightPointFrom)))))
 :qid |_12MutexLifetimeshortdfy.609:3|
 :skolemid |2312|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@111) $f@@68))
)) ($HeapSucc $Heap@@99 $Heap@0)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@99)))) (and (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content))) (forall ((|l#1@@3| T@U) ) (!  (=> (and ($Is refType |l#1@@3| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@3|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@3|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@3|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@3|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |l#1@@3|) _module.Lifetime.mightPointTo)))))
...
))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (=> (_module.Universe.globalInv $Heap@1 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@@99 $Heap@1 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@1 |universe#0|) (and (_module.Universe.globalInv $Heap@1 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@1 |universe#0|) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@0|))) (_module.Object.inv $Heap@1 |o#10@@0|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1024|
...
)) (= $Heap@2 $Heap@3))) (and (and (and (or (not (= this@@170 null)) (not true)) ($Is refType this@@170 Tclass._module.OutlivesClaim?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@170) alloc))))) (and (= (_module.OwnedObject.lifetime this@@170) call5formal@this@0) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@170) _module.OwnedObject.nonvolatileVersion))) this.nonvolatileVersion)))))) (and (and (and (and (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@170) _module.OwnedObject.owner)) |running#0@@3|) (= (_module.Object.universe this@@170) |universe#0|)) (and (= (_module.OutlivesClaim.target this@@170) |target#0|) (= (_module.OutlivesClaim.source this@@170) |source#0|))) (and (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 this@@170 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@170) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@4)) (and ($IsHeapAnchor $Heap@4) (forall (($o@@115 T@U) ($f@@72 T@U) ) (!  (=> (and (and (or (not (= $o@@115 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@115) alloc)))) (= $o@@115 (_module.Object.universe this@@170))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@115 $f@@72)))
 :qid |_12MutexLifetimeshortdfy.749:9|
 :skolemid |2897|
))))) (and (and (and (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@170)) (U_2_bool (Lit boolType (bool_2_U true))))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@4 (_module.Object.universe this@@170)) (forall ((|o#0@@17| T@U) ) (!  (=> (and ($Is refType |o#0@@17| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#0@@17|))) (and (and (and (= (_module.Object.universe |o#0@@17|) (_module.Object.universe this@@170)) (or (not (= |o#0@@17| (_module.Object.universe this@@170))) (not true))) (_module.Object.baseFieldsInv $Heap@4 |o#0@@17|)) (_module.Object.triggerAxioms $Heap@4 |o#0@@17|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1380|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#0@@17|)))
))))) (and (_module.Object.baseFieldsInv $Heap@4 this@@170) (or (not (= this@@170 (_module.Object.universe this@@170))) (not true)))) (and (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@5 this@@170)))) (and (and (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@5 this@@170) (and (_module.Object.objectGlobalBaseInv $Heap@5 this@@170) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType this@@170)) (_module.Object.baseFieldsInv $Heap@5 this@@170)) (_module.Universe.globalBaseInv $Heap@5 (_module.Object.universe this@@170))))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@170)) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.Object.universe this@@170)) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@170)))) (forall (($o@@116 T@U) ) (!  (=> (and (or (not (= $o@@116 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@116) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@116) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@116)) (= $o@@116 (_module.Object.universe this@@170))))
 :qid |_12MutexLifetimeshortdfy.320:10|
 :skolemid |1384|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@116))
)))) (and (and ($HeapSucc $Heap@4 $Heap@5) (or (not (= call5formal@this@0 null)) (not true))) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 call5formal@this@0 _module.Lifetime.elements)) (= |$rhs#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@170)))))) (and (and (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 call5formal@this@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call5formal@this@0) _module.Lifetime.elements ($Box SetType |$rhs#1@0|)))) ($IsGoodHeap $Heap@6)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3))) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content))) (forall ((|l#1@@4| T@U) ) (!  (=> (and ($Is refType |l#1@@4| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@4|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@4|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |l#1@@4|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |l#1@@4|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |l#1@@4|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimeshortdfy.200:21|
 :skolemid |1295|
...
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@7 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (forall ((|o#1@@9| T@U) ) (!  (=> (and ($Is refType |o#1@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@9|))) (and (and (and (= (_module.Object.universe |o#1@@9|) |universe#0|) (or (not (= |o#1@@9| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@7 |o#1@@9|)) (_module.Object.triggerAxioms $Heap@7 |o#1@@9|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |997|
 :pattern ( (_module.Object.triggerAxioms $Heap@7 |o#1@@9|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@7 |o#1@@9|))
 :pattern ( (_module.Object.universe |o#1@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@9|)))
)))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content))))))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@7 |universe#0|) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#2@@0|)))) (not ($IsAllocBox ($Box refType |o#2@@0|) Tclass._module.Object $Heap@3)))
 :qid |_12MutexLifetimeshortdfy.44:16|
 :skolemid |999|
...
)))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@3 $Heap@7 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@0|)))) (or (forall (($o@@117 T@U) ($f@@73 T@U) ) (!  (=> (or (not (= $o@@117 null)) (not true)) (=> (= $o@@117 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@117) $f@@73) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@117) $f@@73))))
 :qid |_12MutexLifetimeshortdfy.59:65|
 :skolemid |1001|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@117) $f@@73))
...
)))))))) (and (and (=> (|_module.Universe.legalTransition#canCall| $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@3 $Heap@7 |universe#0| |running#0@@3|) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (or (forall (($o@@118 T@U) ($f@@74 T@U) ) (!  (=> (or (not (= $o@@118 null)) (not true)) (=> (= $o@@118 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@118) $f@@74) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@118) $f@@74))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1013|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@118) $f@@74))
)) (_module.Object.inv $Heap@7 |o#7@@0|)) (or (forall (($o@@119 T@U) ($f@@75 T@U) ) (!  (=> (or (not (= $o@@119 null)) (not true)) (=> (= $o@@119 |o#7@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@119) $f@@75) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@119) $f@@75))))
 :qid |_12MutexLifetimeshortdfy.82:49|
 :skolemid |1014|
...
))))) (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@7 |universe#0|) (=> (_module.Universe.globalInv $Heap@7 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@3 $Heap@7 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@7 |universe#0|) (and (_module.Universe.globalInv $Heap@7 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@7 |universe#0|) (forall ((|o#10@@1| T@U) ) (!  (=> (and ($Is refType |o#10@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@1|))) (_module.Object.inv $Heap@7 |o#10@@1|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |1024|
 :pattern ( (_module.Object.inv $Heap@7 |o#10@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@1|)))
)))))) (and (and (|_module.Universe.globalInv2#canCall| $Heap@3 $Heap@7 |universe#0|) (and (_module.Universe.globalInv2 $Heap@3 $Heap@7 |universe#0|) (forall ((|o#11@@1| T@U) ) (!  (=> (and ($Is refType |o#11@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@1|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@1|)) (_module.Object.inv2 $Heap@3 $Heap@7 |o#11@@1|)))
 :qid |_12MutexLifetimeshortdfy.33:12|
 :skolemid |1026|
 :pattern ( (_module.Object.inv2 $Heap@3 $Heap@7 |o#11@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |o#11@@1|)))
...
)))) (= $Heap@7 $Heap@8))))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@170) (or (_module.Object.objectGlobalInv $Heap@8 this@@170) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType this@@170))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@170) (or (_module.Object.objectGlobalInv $Heap@8 this@@170) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType this@@170)))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@170) (or (_module.Object.objectGlobalInv $Heap@8 this@@170) (=> (|_module.Universe.globalInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalInv $Heap@8 (_module.Object.universe this@@170)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@8 (_module.Object.universe this@@170)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@170) (or (_module.Object.objectGlobalInv $Heap@8 this@@170) (=> (|_module.Universe.globalInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalInv $Heap@8 (_module.Object.universe this@@170)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@8 (_module.Object.universe this@@170)) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@170) (or (_module.Object.objectGlobalInv $Heap@8 this@@170) (=> (|_module.Universe.globalInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalInv $Heap@8 (_module.Object.universe this@@170)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@8 (_module.Object.universe this@@170)) (forall ((|o#11@@2| T@U) ) (!  (=> (and ($Is refType |o#11@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#11@@2|))) (and (and (and (= (_module.Object.universe |o#11@@2|) (_module.Object.universe this@@170)) (or (not (= |o#11@@2| (_module.Object.universe this@@170))) (not true))) (_module.Object.baseFieldsInv $Heap@8 |o#11@@2|)) (_module.Object.triggerAxioms $Heap@8 |o#11@@2|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2873|
 :pattern ( (_module.Object.triggerAxioms $Heap@8 |o#11@@2|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@8 |o#11@@2|))
 :pattern ( (_module.Object.universe |o#11@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#11@@2|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@170) (or (_module.Object.objectGlobalInv $Heap@8 this@@170) (=> (|_module.Universe.globalInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalInv $Heap@8 (_module.Object.universe this@@170)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalBaseInv $Heap@8 (_module.Object.universe this@@170)) (forall ((|o#11@@3| T@U) ) (!  (=> (and ($Is refType |o#11@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#11@@3|))) (and (and (and (= (_module.Object.universe |o#11@@3|) (_module.Object.universe this@@170)) (or (not (= |o#11@@3| (_module.Object.universe this@@170))) (not true))) (_module.Object.baseFieldsInv $Heap@8 |o#11@@3|)) (_module.Object.triggerAxioms $Heap@8 |o#11@@3|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2873|
 :pattern ( (_module.Object.triggerAxioms $Heap@8 |o#11@@3|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@8 |o#11@@3|))
 :pattern ( (_module.Object.universe |o#11@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#11@@3|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@170) (or (_module.Object.objectGlobalInv $Heap@8 this@@170) (=> (|_module.Universe.globalInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalInv $Heap@8 (_module.Object.universe this@@170)) (forall ((|o#12@@0| T@U) ) (!  (=> (and ($Is refType |o#12@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#12@@0|))) (_module.Object.inv $Heap@8 |o#12@@0|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |2875|
 :pattern ( (_module.Object.inv $Heap@8 |o#12@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#12@@0|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@8 this@@170) (or (_module.Object.objectGlobalInv $Heap@8 this@@170) (=> (|_module.Universe.globalInv#canCall| $Heap@8 (_module.Object.universe this@@170)) (or (_module.Universe.globalInv $Heap@8 (_module.Object.universe this@@170)) (forall ((|o#12@@1| T@U) ) (!  (=> (and ($Is refType |o#12@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#12@@1|))) (_module.Object.inv $Heap@8 |o#12@@1|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |2875|
 :pattern ( (_module.Object.inv $Heap@8 |o#12@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 (_module.Object.universe this@@170)) _module.Universe.content)) ($Box refType |o#12@@1|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#13|))) (and (and (and (= (_module.Object.universe |o#13|) |universe#0|) (or (not (= |o#13| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@99 |o#13|)) (_module.Object.triggerAxioms $Heap@@99 |o#13|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2877|
 :pattern ( (_module.Object.triggerAxioms $Heap@@99 |o#13|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@99 |o#13|))
 :pattern ( (_module.Object.universe |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#13|)))
))))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@99 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@99 |universe#0|) (forall ((|o#13@@0| T@U) ) (!  (=> (and ($Is refType |o#13@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@0|))) (and (and (and (= (_module.Object.universe |o#13@@0|) |universe#0|) (or (not (= |o#13@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@99 |o#13@@0|)) (_module.Object.triggerAxioms $Heap@@99 |o#13@@0|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2877|
 :pattern ( (_module.Object.triggerAxioms $Heap@@99 |o#13@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@99 |o#13@@0|))
 :pattern ( (_module.Object.universe |o#13@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#14|))) (and (and (and (= (_module.Object.universe |o#14|) |universe#0|) (or (not (= |o#14| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@8 |o#14|)) (_module.Object.triggerAxioms $Heap@8 |o#14|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2879|
 :pattern ( (_module.Object.triggerAxioms $Heap@8 |o#14|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@8 |o#14|))
 :pattern ( (_module.Object.universe |o#14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#14|)))
))))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@8 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (forall ((|o#14@@0| T@U) ) (!  (=> (and ($Is refType |o#14@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@0|))) (and (and (and (= (_module.Object.universe |o#14@@0|) |universe#0|) (or (not (= |o#14@@0| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@8 |o#14@@0|)) (_module.Object.triggerAxioms $Heap@8 |o#14@@0|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2879|
 :pattern ( (_module.Object.triggerAxioms $Heap@8 |o#14@@0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@8 |o#14@@0|))
 :pattern ( (_module.Object.universe |o#14@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#14@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (forall ((|o#15| T@U) ) (!  (=> (and ($Is refType |o#15| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#15|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#15|)))) (not ($IsAllocBox ($Box refType |o#15|) Tclass._module.Object $Heap@@99)))
 :qid |_12MutexLifetimeshortdfy.44:16|
 :skolemid |2881|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#15|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#15|)))
))))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@99 $Heap@8 |universe#0|) (forall ((|o#15@@0| T@U) ) (!  (=> (and ($Is refType |o#15@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#15@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#15@@0|)))) (not ($IsAllocBox ($Box refType |o#15@@0|) Tclass._module.Object $Heap@@99)))
 :qid |_12MutexLifetimeshortdfy.44:16|
 :skolemid |2881|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#15@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#15@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#16|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#16|)))) (or (forall (($o@@120 T@U) ($f@@76 T@U) ) (!  (=> (or (not (= $o@@120 null)) (not true)) (=> (= $o@@120 |o#16|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@120) $f@@76) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@120) $f@@76))))
 :qid |_12MutexLifetimeshortdfy.59:65|
 :skolemid |2883|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@120) $f@@76))
)) (_module.Object.sequenceInv2 $Heap@@99 $Heap@8 |o#16|)))
 :qid |_12MutexLifetimeshortdfy.59:16|
 :skolemid |2884|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@99 $Heap@8 |o#16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#16|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#16|)))
))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|)))) (or (forall (($o@@121 T@U) ($f@@77 T@U) ) (!  (=> (or (not (= $o@@121 null)) (not true)) (=> (= $o@@121 |o#16@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@121) $f@@77) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 $o@@121) $f@@77))))
 :qid |_12MutexLifetimeshortdfy.59:65|
 :skolemid |2883|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@121) $f@@77))
)) (_module.Object.sequenceInv2 $Heap@@99 $Heap@8 |o#16@@0|)))
 :qid |_12MutexLifetimeshortdfy.59:16|
 :skolemid |2884|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@99 $Heap@8 |o#16@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#17| T@U) ) (!  (=> (and ($Is refType |o#17| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@99)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#17|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimeshortdfy.62:16|
 :skolemid |2885|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#17|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#17|)))
))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#17@@0| T@U) ) (!  (=> (and ($Is refType |o#17@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17@@0|) _module.OwnedObject.owner) Tclass._module.Object? $Heap@@99)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#17@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_12MutexLifetimeshortdfy.62:16|
 :skolemid |2885|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |o#17@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |o#17@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@0|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#1@@5| T@U) ) (!  (=> (and ($Is refType |l#1@@5| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@5|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@5|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@5|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@99)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@99 $Heap@8 |l#1@@5|)))
 :qid |_12MutexLifetimeshortdfy.68:16|
 :skolemid |2886|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@99 $Heap@8 |l#1@@5|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@5|) _module.Lifetime.owner)))
...
))))) (=> (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@@99 $Heap@8 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|l#1@@6| T@U) ) (!  (=> (and ($Is refType |l#1@@6| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@6|))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@6|) _module.Lifetime.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@6|) _module.Lifetime.owner) Tclass._module.Thread? $Heap@@99)) (_module.Lifetime.unchangedNonvolatileFields $Heap@@99 $Heap@8 |l#1@@6|)))
 :qid |_12MutexLifetimeshortdfy.68:16|
 :skolemid |2886|
 :pattern ( (_module.Lifetime.unchangedNonvolatileFields $Heap@@99 $Heap@8 |l#1@@6|))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |l#1@@6|) _module.Lifetime.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@6|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (= (_module.Object.universe this@@170) |universe#0|)) (=> (= (_module.Object.universe this@@170) |universe#0|) (and (=> (= (ControlFlow 0 2) (- 0 7)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@170) _module.OwnedObject.owner)) |running#0@@3|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 this@@170) _module.OwnedObject.owner)) |running#0@@3|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (_module.OutlivesClaim.target this@@170) |target#0|)) (=> (= (_module.OutlivesClaim.target this@@170) |target#0|) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (_module.OutlivesClaim.source this@@170) |source#0|)) (=> (= (_module.OutlivesClaim.source this@@170) |source#0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this@@170)) ($Box refType (_module.OwnedObject.lifetime this@@170)))))) (=> (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |universe#0|) _module.Universe.content)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this@@170)) ($Box refType (_module.OwnedObject.lifetime this@@170))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |target#0|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |target#0|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@170)))))) (=> (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |target#0|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |target#0|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@170))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |source#0|) _module.Lifetime.mightPointFrom)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@99 |source#0|) _module.Lifetime.mightPointFrom)) (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@170)))))))))))))))))))))))))))))))))))))))))))))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
