...
(set-info :boogie-vc-id Impl$$_module.B.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#21| null $Heap@@17 alloc |universe#0| |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 23)) true) (and (=> (= (ControlFlow 0 2) (- 0 22)) true) (=> (and (and (and (and (or (not (= this@@31 null)) (not true)) ($Is refType this@@31 Tclass._module.B?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) alloc))))) (and (= (_module.Object.universe this@@31) |universe#0|) (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.B.valid))) this.valid))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.B.a)) |a#0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (forall (($o@@48 T@U) ($f@@22 T@U) ) (!  (=> (and (and (or (not (= $o@@48 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48) alloc)))) (= $o@@48 (_module.Object.universe this@@31))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@48 $f@@22)))
 :qid |_05RecInvariantCutdfy.181:9|
 :skolemid |1017|
...
)) ($HeapSuccGhost $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@31) _module.B.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@31) _module.B.a)) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@31) _module.B.a)) _module.A.b))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@31) _module.B.a)) _module.A.b)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@31) _module.B.a)) (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@31) _module.B.a))) _module.A.b ($Box refType this@@31)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@31 _module.B.valid))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@31 _module.B.valid)) (=> (= |$rhs#1@0| (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 this@@31 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@31) _module.B.valid ($Box boolType (bool_2_U |$rhs#1@0|))))) ($IsGoodHeap $Heap@3)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@31) _module.B.a)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@31) _module.B.a)) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@31) _module.B.a)) _module.A.valid))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@31) _module.B.a)) _module.A.valid)) (=> (= |$rhs#2@0| (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@31) _module.B.a)) (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 this@@31) _module.B.a))) _module.A.valid ($Box boolType (bool_2_U |$rhs#2@0|))))) ($IsGoodHeap $Heap@4)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 12)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@17)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@17) (=> (= call0formal@previous$Heap@0 $Heap@@17) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0 $Heap@4 |universe#0|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0 $Heap@4 |universe#0|) (=> (|_module.Universe.globalInv#canCall| call0formal@previous$Heap@0 |universe#0|) (or (_module.Universe.globalInv call0formal@previous$Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| call0formal@previous$Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv call0formal@previous$Heap@0 |universe#0|) (forall ((|o#0@@14| T@U) ) (!  (=> (and ($Is refType |o#0@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@14|))) (and (= (_module.Object.universe |o#0@@14|) |universe#0|) (or (not (= (_module.__default.upCast |o#0@@14|) |universe#0|)) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |568|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#11|)))
...
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@5 |universe#0|) (or (_module.Universe.globalInv $Heap@5 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@5 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@5 |universe#0|) (forall ((|o#12@@0| T@U) ) (!  (=> (and ($Is refType |o#12@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#12@@0|))) (and (= (_module.Object.universe |o#12@@0|) |universe#0|) (or (not (= (_module.__default.upCast |o#12@@0|) |universe#0|)) (not true))))
 :qid |_05RecInvariantCutdfy.20:12|
 :skolemid |1012|
...
)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Universe.globalInv#canCall| $Heap@5 |universe#0|) (or (_module.Universe.globalInv $Heap@5 |universe#0|) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#13|))) (_module.Object.inv $Heap@5 |o#13|))
 :qid |_05RecInvariantCutdfy.25:31|
 :skolemid |1014|
 :pattern ( (_module.Object.inv $Heap@5 |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |universe#0|) _module.Universe.content)) ($Box refType |o#13|)))
)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@17) ($IsHeapAnchor $Heap@@17)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@17))) (and (and ($Is refType |a#0| Tclass._module.A) ($IsAlloc refType |a#0| Tclass._module.A $Heap@@17)) (= 14 $FunctionContextHeight))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@17 |universe#0|) (and (_module.Universe.globalInv $Heap@@17 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@17 |universe#0|) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 |universe#0|) _module.Universe.content)) ($Box refType |o#8|))) (_module.Object.inv $Heap@@17 |o#8|))
 :qid |_05RecInvariantCutdfy.25:31|
 :skolemid |1005|
 :pattern ( (_module.Object.inv $Heap@@17 |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 |universe#0|) _module.Universe.content)) ($Box refType |o#8|)))
))))) (= |universe#0| (_module.Object.universe |a#0|))) (and (and (|_module.A.inv#canCall| $Heap@@17 |a#0|) (and (_module.A.inv $Heap@@17 |a#0|) (and (_module.A.localInv $Heap@@17 |a#0|) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 |a#0|) _module.A.valid))) (_module.B.localInv $Heap@@17 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 |a#0|) _module.A.b))))))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 |a#0|) _module.A.valid)))) (= (ControlFlow 0 24) 2))))) anon0_correct)))
