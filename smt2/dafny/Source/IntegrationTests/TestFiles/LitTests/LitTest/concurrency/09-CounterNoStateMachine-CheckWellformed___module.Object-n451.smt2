...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@22 T@U) ($f@@16 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@22 $f@@16))  (=> (and (or (not (= $o@@22 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@22) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@22) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3222|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@22 $f@@16))
)))
...
)) (|_module.Universe.legalTransition#canCall| $prevHeap@@31 $Heap@@23 (_module.Object.universe this@@40) |running#0@@3|)))))) (= (_module.Object.goodPreAndLegalChanges $prevHeap@@31 $Heap@@23 this@@40 |running#0@@3|)  (and (and (and (and (_module.Object.baseInv $prevHeap@@31 this@@40) (_module.Universe.globalInv $prevHeap@@31 (_module.Object.universe this@@40))) (_module.Object.baseInv $Heap@@23 this@@40)) (forall (($o@@35 T@U) ($f@@25 T@U) ) (!  (=> (or (not (= $o@@35 null)) (not true)) (=> (= $o@@35 this@@40) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@35) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@31 $o@@35) $f@@25))))
 :qid |_09CounterNoStateMachinedfy.259:8|
 :skolemid |1283|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@35) $f@@25))
...
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@46 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@46 null)) (not true)) ($Is refType this@@46 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@37 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@37 null)) (not true)) (= $o@@37 this@@46)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@37) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@37) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |1307|
...
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@47 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@47 null)) (not true)) ($Is refType this@@47 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@38 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@38 null)) (not true)) (or (= $o@@38 this@@47) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 this@@47) _module.Universe.content)) ($Box refType $o@@38)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@38) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@38) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |648|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon11_correct  (=> (= (_module.Object.goodPreAndLegalChanges $Heap@@37 current$Heap this@@67 |running#0@@5|)  (and (and (and (and (_module.Object.baseInv $Heap@@37 this@@67) (_module.Universe.globalInv $Heap@@37 (_module.Object.universe this@@67))) (_module.Object.baseInv current$Heap this@@67)) (forall (($o@@60 T@U) ($f@@40 T@U) ) (!  (=> (or (not (= $o@@60 null)) (not true)) (=> (= $o@@60 this@@67) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@60) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 $o@@60) $f@@40))))
 :qid |_09CounterNoStateMachinedfy.259:8|
 :skolemid |1291|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@60) $f@@40))
))) (_module.Universe.legalTransition $Heap@@37 current$Heap (_module.Object.universe this@@67) |running#0@@5|))) (=> (and (and (and (|_module.Object.baseInv#canCall| $Heap@@37 this@@67) (=> (_module.Object.baseInv $Heap@@37 this@@67) (|_module.Universe.globalInv#canCall| $Heap@@37 (_module.Object.universe this@@67)))) (=> (and (_module.Object.baseInv $Heap@@37 this@@67) (_module.Universe.globalInv $Heap@@37 (_module.Object.universe this@@67))) (and (|_module.Object.baseInv#canCall| current$Heap this@@67) (=> (_module.Object.baseInv current$Heap this@@67) (=> (forall (($o@@61 T@U) ($f@@41 T@U) ) (!  (=> (or (not (= $o@@61 null)) (not true)) (=> (= $o@@61 this@@67) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@61) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 $o@@61) $f@@41))))
 :qid |_09CounterNoStateMachinedfy.259:8|
 :skolemid |1292|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@61) $f@@41))
)) (|_module.Universe.legalTransition#canCall| $Heap@@37 current$Heap (_module.Object.universe this@@67) |running#0@@5|)))))) ($Is boolType (bool_2_U (_module.Object.goodPreAndLegalChanges $Heap@@37 current$Heap this@@67 |running#0@@5|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))))
(let ((anon17_Else_correct  (=> (not (and (and (and (_module.Object.baseInv $Heap@@37 this@@67) (_module.Universe.globalInv $Heap@@37 (_module.Object.universe this@@67))) (_module.Object.baseInv current$Heap this@@67)) (forall (($o@@62 T@U) ($f@@42 T@U) ) (!  (=> (or (not (= $o@@62 null)) (not true)) (=> (= $o@@62 this@@67) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@62) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 $o@@62) $f@@42))))
 :qid |_09CounterNoStateMachinedfy.259:8|
 :skolemid |1289|
...
(let ((anon17_Then_correct  (=> (and (and (and (_module.Object.baseInv $Heap@@37 this@@67) (_module.Universe.globalInv $Heap@@37 (_module.Object.universe this@@67))) (_module.Object.baseInv current$Heap this@@67)) (forall (($o@@63 T@U) ($f@@43 T@U) ) (!  (=> (or (not (= $o@@63 null)) (not true)) (=> (= $o@@63 this@@67) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@63) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 $o@@63) $f@@43))))
 :qid |_09CounterNoStateMachinedfy.259:8|
 :skolemid |1289|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@63) $f@@43))
))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= (_module.Object.universe this@@67) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@67) null)) (not true)) (=> (and ($IsAllocBox ($Box refType (_module.Object.universe this@@67)) Tclass._module.Universe? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 6) (- 0 8)) ($IsAlloc refType (_module.Object.universe this@@67) Tclass._module.Universe $Heap@@37)) (=> ($IsAlloc refType (_module.Object.universe this@@67) Tclass._module.Universe $Heap@@37) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@37)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@37) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@64 T@U) ($f@@44 T@U) ) (!  (=> (and (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@64) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@64) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@64 $f@@44)))
 :qid |_09CounterNoStateMachinedfy.260:17|
 :skolemid |1288|
))) (|_module.Universe.legalTransition#canCall| $Heap@@37 current$Heap (_module.Object.universe this@@67) |running#0@@5|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon11_correct)))))))))))
(let ((anon16_Else_correct  (=> (and (not (and (and (_module.Object.baseInv $Heap@@37 this@@67) (_module.Universe.globalInv $Heap@@37 (_module.Object.universe this@@67))) (_module.Object.baseInv current$Heap this@@67))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 13) 6) anon17_Then_correct) (=> (= (ControlFlow 0 13) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (and (_module.Object.baseInv $Heap@@37 this@@67) (_module.Universe.globalInv $Heap@@37 (_module.Object.universe this@@67))) (_module.Object.baseInv current$Heap this@@67)) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType this@@67 Tclass._module.Object $Heap@@37)) (=> ($IsAlloc refType this@@67 Tclass._module.Object $Heap@@37) (=> (and (= |b$reqreads#1@0| (forall (($o@@65 T@U) ($f@@45 T@U) ) (!  (=> (and (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@65) alloc)))) (= $o@@65 this@@67)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@65 $f@@45)))
 :qid |_09CounterNoStateMachinedfy.259:18|
 :skolemid |1287|
))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 11) 6) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct))))))))
(let ((anon15_Else_correct  (=> (and (not (and (_module.Object.baseInv $Heap@@37 this@@67) (_module.Universe.globalInv $Heap@@37 (_module.Object.universe this@@67)))) (= |b$reqreads#0@1| true)) (and (=> (= (ControlFlow 0 15) 11) anon16_Then_correct) (=> (= (ControlFlow 0 15) 13) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (_module.Object.baseInv $Heap@@37 this@@67) (_module.Universe.globalInv $Heap@@37 (_module.Object.universe this@@67))) (=> (and (and ($IsAllocBox ($Box refType this@@67) Tclass._module.Object? current$Heap) (= |b$reqreads#0@0| (forall (($o@@66 T@U) ($f@@46 T@U) ) (!  (=> (and (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@66) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@66) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@66 $f@@46)))
 :qid |_09CounterNoStateMachinedfy.258:50|
 :skolemid |1286|
)))) (and (|_module.Object.baseInv#canCall| current$Heap this@@67) (= |b$reqreads#0@1| |b$reqreads#0@0|))) (and (=> (= (ControlFlow 0 14) 11) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct))))))
(let ((anon14_Else_correct  (=> (not (_module.Object.baseInv $Heap@@37 this@@67)) (and (=> (= (ControlFlow 0 20) 14) anon15_Then_correct) (=> (= (ControlFlow 0 20) 15) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (_module.Object.baseInv $Heap@@37 this@@67) (and (=> (= (ControlFlow 0 16) (- 0 19)) ($IsAlloc refType this@@67 Tclass._module.Object $Heap@@37)) (=> ($IsAlloc refType this@@67 Tclass._module.Object $Heap@@37) (and (=> (= (ControlFlow 0 16) (- 0 18)) (or (not (= (_module.Object.universe this@@67) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@67) null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 17)) ($IsAlloc refType (_module.Object.universe this@@67) Tclass._module.Universe $Heap@@37)) (=> ($IsAlloc refType (_module.Object.universe this@@67) Tclass._module.Universe $Heap@@37) (=> (|_module.Universe.globalInv#canCall| $Heap@@37 (_module.Object.universe this@@67)) (and (=> (= (ControlFlow 0 16) 14) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct))))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) ($IsAlloc refType this@@67 Tclass._module.Object $Heap@@37)) (=> ($IsAlloc refType this@@67 Tclass._module.Object $Heap@@37) (=> (|_module.Object.baseInv#canCall| $Heap@@37 this@@67) (and (=> (= (ControlFlow 0 21) 16) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 23) 1) anon13_Then_correct) (=> (= (ControlFlow 0 23) 21) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@37) ($IsHeapAnchor $Heap@@37)) (and (or (not (= this@@67 null)) (not true)) (and ($Is refType this@@67 Tclass._module.Object) ($IsAlloc refType this@@67 Tclass._module.Object previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 9 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@37) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 24) 23))) anon0_correct))))
