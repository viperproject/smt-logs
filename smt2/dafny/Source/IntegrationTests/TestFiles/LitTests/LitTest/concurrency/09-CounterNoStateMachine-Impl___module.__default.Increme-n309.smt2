...
)) ($HeapSucc $Heap@34 $Heap@35)) (and (= $Heap@36 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0|) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|))))) ($IsGoodHeap $Heap@36))) (and (and ($IsAllocBox ($Box refType |remaining#0|) Tclass._module.OwnedObject? $Heap@36) ($IsAlloc refType |remaining#0| Tclass._module.Integer $Heap@33)) (and (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|) (|_module.OwnedObject.inv2#canCall| $Heap@33 $Heap@36 |remaining#0|)))) (and (and (and (_module.OwnedObject.inv2 $Heap@33 $Heap@36 |remaining#0|) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@36)) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|))) (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@36 |universe#0|))))))))) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@36 |universe#0|) (forall ((|o#0_2| T@U) ) (!  (=> (and ($Is refType |o#0_2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0_2|))) (or (forall (($o@@180 T@U) ($f@@120 T@U) ) (!  (=> (or (not (= $o@@180 null)) (not true)) (=> (= $o@@180 |o#0_2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 $o@@180) $f@@120) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@180) $f@@120))))
 :qid |_09CounterNoStateMachinedfy.60:54|
 :skolemid |578|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 $o@@180) $f@@120))
)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_2|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |o#0_2|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_09CounterNoStateMachinedfy.60:16|
 :skolemid |579|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@36 |o#0_2|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |o#0_2|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0_2|)))
)))))))))
anon0_correct))
))
(check-sat)
