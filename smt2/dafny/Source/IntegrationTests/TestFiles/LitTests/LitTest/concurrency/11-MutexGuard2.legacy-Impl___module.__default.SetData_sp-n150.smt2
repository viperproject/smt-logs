...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split134)
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))) (and (and ($IsGoodHeap $Heap@15) ($IsHeapAnchor $Heap@15)) (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|)))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (and (_module.Universe.globalInv $Heap@15 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#3@@9| T@U) ) (!  (=> (and ($Is refType |o#3@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@9|))) (_module.Object.inv $Heap@15 |o#3@@9|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |881|
...
)))))) (and (and (and (forall (($o@@138 T@U) ) (!  (=> (and (or (not (= $o@@138 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@138) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 $o@@138) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@138)) (or (= $o@@138 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType $o@@138)))))
 :qid |_11MutexGuard2legacydfy.109:10|
 :skolemid |896|
