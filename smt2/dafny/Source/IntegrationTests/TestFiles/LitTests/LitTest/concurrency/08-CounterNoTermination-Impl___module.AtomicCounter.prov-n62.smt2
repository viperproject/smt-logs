...
(set-info :boogie-vc-id Impl$$_module.AtomicCounter.proveUnchangedNonvolatileUserFields)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.AtomicCounter.unchangedNonvolatileUserFields#canCall| previous$Heap current$Heap this@@1)) (or (_module.AtomicCounter.unchangedNonvolatileUserFields previous$Heap current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))
