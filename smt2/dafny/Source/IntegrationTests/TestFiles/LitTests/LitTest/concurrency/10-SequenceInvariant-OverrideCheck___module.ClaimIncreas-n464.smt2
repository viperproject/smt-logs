...
(set-info :boogie-vc-id OverrideCheck$$_module.ClaimIncreasingCounterGreaterThanConstant.userInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= ClaimIncreasingCounterGreaterThanConstant_$_ReadsFrame@0 (|lambda#4| null $Heap@@2 alloc $Heap@@2 alloc)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@26 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@26) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@26) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@26) alloc))))
 :qid |_10SequenceInvariantdfy.563:19|
 :skolemid |2232|
))) (=> (forall (($o@@27 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@27) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@27) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@27) alloc))))
 :qid |_10SequenceInvariantdfy.563:19|
 :skolemid |2232|
)) (=> (=> (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@2 this@@2) (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@2 this@@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@2 this@@2) (=> (|_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv#canCall| $Heap@@2 this@@2) (or (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@2 this@@2) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@2 this@@2) (=> (|_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv#canCall| $Heap@@2 this@@2) (or (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@2 this@@2) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.ClaimIncreasingCounterGreaterThanConstant.userInv $Heap@@2 this@@2) (=> (|_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv#canCall| $Heap@@2 this@@2) (or (_module.ClaimIncreasingCounterGreaterThanConstant.localUserInv $Heap@@2 this@@2) (>= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.ClaimIncreasingCounterGreaterThanConstant.counter))) _module.IncreasingCounter.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.ClaimIncreasingCounterGreaterThanConstant.constant))) _module.ConstantInteger.value))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@2 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@2))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
