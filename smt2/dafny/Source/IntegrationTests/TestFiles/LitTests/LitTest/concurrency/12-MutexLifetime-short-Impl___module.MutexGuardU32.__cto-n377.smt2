...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split146)
...
)))))) (and (and (and (= $Heap@11 $Heap@12) (U_2_bool (Lit boolType (bool_2_U true)))) (and (or (not (= |scope#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |scope#0| _module.Lifetime.owner)))) (and (and (= $Heap@13 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@12 |scope#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |scope#0|) _module.Lifetime.owner ($Box refType null)))) ($IsGoodHeap $Heap@13)) (and (or (not (= |universe#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@12)))))
