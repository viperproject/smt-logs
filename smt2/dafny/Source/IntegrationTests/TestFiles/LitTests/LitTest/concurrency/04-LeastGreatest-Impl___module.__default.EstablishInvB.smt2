...
(set-info :boogie-vc-id Impl$$_module.__default.EstablishInvB)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (=> (|_module.__default.invB#canCall| $Heap@3 |self#0@@13|) (or (_module.__default.invB ($LS $LZ) $Heap@3 |self#0@@13|) (_module.__default.invA ($LS ($LS $LZ)) $Heap@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |self#0@@13|) _module.TraitB.a))))))))
(let ((anon3_Else_correct  (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (= $Heap@0 $Heap@2) (forall ((|k#0_1| T@U) ) (!  (=> (U_2_bool (Lit boolType (bool_2_U true))) (_module.__default.invB_h ($LS $LZ) $Heap@2 |k#0_1| |self#0@@13|))
 :qid |_04LeastGreatestdfy.98:10|
 :skolemid |751|
 :pattern ( (_module.__default.invB_h ($LS $LZ) $Heap@2 |k#0_1| |self#0@@13|))
))) (and (= $Heap@3 $Heap@2) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@13 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@13 $Heap@0) (forall ((|$ih#self0#0| T@U) ) (!  (=> (and (and ($Is refType |$ih#self0#0| Tclass._module.TraitB) (U_2_bool (Lit boolType (bool_2_U true)))) (and (= |$ih#self0#0| null) (or (not (= |self#0@@13| null)) (not true)))) (_module.__default.invB ($LS $LZ) $Heap@0 |$ih#self0#0|))
 :qid |_04LeastGreatestdfy.95:21|
 :skolemid |749|
 :pattern ( (_module.__default.invB ($LS $LZ) $Heap@0 |$ih#self0#0|))
)))) (and (=> (= (ControlFlow 0 5) 1) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (=> (and (and ($Is refType |self#0@@13| Tclass._module.TraitB) ($IsAlloc refType |self#0@@13| Tclass._module.TraitB $Heap@@13)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
