...
(assert (distinct alloc Tagclass._module.Universe Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.ConstantInteger Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? Tagclass._module.ConstantInteger? tytagFamily$Universe tytagFamily$Object tytagFamily$ConstantInteger tytagFamily$OwnedObject)
)
...
(assert (forall (($o@@9 T@U) ) (!  (=> ($Is refType $o@@9 Tclass._module.ConstantInteger?) ($Is refType $o@@9 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2421|
...
(set-info :boogie-vc-id OverrideCheck$$_module.ConstantInteger.baseUserFieldsInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))))) (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this)))) (=> (and (= ConstantInteger_$_ReadsFrame@0 (|lambda#69| null $Heap alloc this (_module.Object.universe this))) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@14) alloc)))) (or (= $o@@14 this) (= $o@@14 (_module.Object.universe this)))) (or (= $o@@14 this) (= $o@@14 (_module.Object.universe this))))
 :qid |_10SequenceInvariantdfy.505:19|
 :skolemid |1990|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.ConstantInteger) ($IsAlloc refType this Tclass._module.ConstantInteger $Heap))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
