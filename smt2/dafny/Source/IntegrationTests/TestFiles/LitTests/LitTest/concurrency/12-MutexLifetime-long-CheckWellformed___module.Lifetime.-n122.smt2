...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#171| null $Heap@@0 alloc this@@0 _module.Lifetime.owner)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= this@@0 null)) (not true))) (=> (or (not (= this@@0 null)) (not true)) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))))
