...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split413)
...
))) (and ($HeapSucc $Heap@2 $Heap@3) (or (not (= |universe#0| null)) (not true))))) (and (and (and (and (forall (($o@@117 T@U) ($f@@69 T@U) ) (!  (=> (and (and (or (not (= $o@@117 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@117) alloc)))) (or (= $o@@117 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType $o@@117)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@117 $f@@69)))
...
))))) (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|))) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (=> |$w$loop#0@0| (= (+ |i#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |remaining#0|) _module.Integer.value)))) (LitInt 10))))) (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (=> |defass#initial_value#0_0@0| (and ($Is refType |initial_value#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value#0_0@0| Tclass._module.ConstantInteger $Heap@4))))))) (and (and (and (and (and (=> |defass#claim1#0_0@0| (and ($Is refType |claim1#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim1#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@4))) (=> |defass#initial_value_plus_one#0_0@0| (and ($Is refType |initial_value_plus_one#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |initial_value_plus_one#0_0@0| Tclass._module.ConstantInteger $Heap@4)))) (and (=> |defass#claim2#0_0@0| (and ($Is refType |claim2#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType |claim2#0_0@0| Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@4))) (=> |defass#final_value#0_0@0| (and ($Is refType |final_value#0_0@0| Tclass._module.ConstantInteger) ($IsAlloc refType |final_value#0_0@0| Tclass._module.ConstantInteger $Heap@4))))) (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10))) (and (and (and (=> |$w$loop#0@0| (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|)) (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalInv $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@0|))) (and (= (_module.Object.universe |o#16@@0|) |universe#0|) (or (not (= |o#16@@0| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |532|
...
))))))) (and (and (=> |$w$loop#0@0| (and (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (and (_module.Universe.globalInv $Heap@4 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#18@@2| T@U) ) (!  (=> (and ($Is refType |o#18@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#18@@2|))) (_module.Object.inv $Heap@4 |o#18@@2|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |537|
...
)))))) (=> |$w$loop#0@0| (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@4 |universe#0|))) (and (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@4 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@4 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)))))) (=> |$w$loop#0@0| (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@4 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@4 |universe#0|) (forall ((|o#19@@0| T@U) ) (!  (=> (and ($Is refType |o#19@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@0|)))) (not ($IsAllocBox ($Box refType |o#19@@0|) Tclass._module.Object $Heap@3)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |538|
...
))))) (=> |$w$loop#0@0| (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@4 |universe#0|) (and (_module.Universe.baseLegalTransitionsSequence $Heap@3 $Heap@4 |universe#0|) (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content))) (forall ((|o#19@@1| T@U) ) (!  (=> (and ($Is refType |o#19@@1| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@1|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#19@@1|)))) (not ($IsAllocBox ($Box refType |o#19@@1|) Tclass._module.Object $Heap@3)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |541|
...
))))))) (and (=> |$w$loop#0@0| (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)))) (and (and (=> |$w$loop#0@0| (= (+ |i#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |remaining#0|) _module.Integer.value)))) (LitInt 10))) (forall (($o@@121 T@U) ) (!  (=> (and (or (not (= $o@@121 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 $o@@121) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@121) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@121)) (or (= $o@@121 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@93 |universe#0|) _module.Universe.content)) ($Box refType $o@@121)))))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |544|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@121))
))) (and ($HeapSucc $Heap@3 $Heap@4) (forall (($o@@122 T@U) ($f@@73 T@U) ) (!  (=> (and (or (not (= $o@@122 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@122) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@122) $f@@73) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@122) $f@@73)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@122 $f@@73))))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |545|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@122) $f@@73))
))))) (and (and (and (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|) (not |$w$loop#0@0|)) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@4) (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|))) (and (and (|_module.Universe.globalInv#canCall| $Heap@4 |universe#0|) (_module.Universe.globalInv $Heap@4 |universe#0|)) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@4) (= (ControlFlow 0 2) (- 0 1))))))))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@3)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
