...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon5_correct  (=> (= (_module.Object.baseInv $Heap@@2 this@@1)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.Object.universe this@@1)) _module.Universe.content)) ($Box refType this@@1)) (_module.Universe.globalBaseInv $Heap@@2 (_module.Object.universe this@@1)))) (=> (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.Object.universe this@@1)) _module.Universe.content)) ($Box refType this@@1)) (|_module.Universe.globalBaseInv#canCall| $Heap@@2 (_module.Object.universe this@@1))) ($Is boolType (bool_2_U (_module.Object.baseInv $Heap@@2 this@@1)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@1|)))))))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.Object.universe this@@1)) _module.Universe.content)) ($Box refType this@@1))) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 7) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.Object.universe this@@1)) _module.Universe.content)) ($Box refType this@@1)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (_module.Object.universe this@@1) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@1) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@1)) Tclass._module.Universe? $Heap@@2) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@10) alloc)))) (or (= $o@@10 (_module.Object.universe this@@1)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.Object.universe this@@1)) _module.Universe.content)) ($Box refType $o@@10)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@10 $f@@0)))
 :qid |_05RecInvariantCutdfy.61:76|
 :skolemid |621|
))) (|_module.Universe.globalBaseInv#canCall| $Heap@@2 (_module.Object.universe this@@1))) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 5) 3))) anon5_correct)))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap@@2 alloc $Heap@@2 alloc)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Object) ($IsAlloc refType this@@1 Tclass._module.Object $Heap@@2))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
