...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split410)
...
)))) (= (ControlFlow 0 2) (- 0 1)))))))))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@40 |remaining#0|) _module.Integer.value))) (LitInt 0)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
