...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this)) (|Set#UnionOne| |Set#Empty| ($Box refType this)))) (=> (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType this)) (|Set#UnionOne| |Set#Empty| ($Box refType this))) (=> (and (= Mutex_$_ReadsFrame@0 (|lambda#69| null current$Heap alloc this)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@10) alloc)))) (= $o@@10 this)) (= $o@@10 this))
