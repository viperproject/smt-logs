...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc this@@3 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Universe.content)))) ($IsAllocBox ($Box refType this@@3) Tclass._module.Universe? $Heap@@1)) (and (|_module.Universe.globalBaseInv#canCall| $Heap@@1 this@@3) (_module.Universe.globalBaseInv $Heap@@1 this@@3))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@16 T@U) ) (!  (=> (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@16) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@16) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@16)) (or (= $o@@16 this@@3) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Universe.content)) ($Box refType $o@@16)))))
 :qid |_07CounterThreadOwnershipdfy.104:10|
 :skolemid |680|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@16))
))) (and ($HeapSucc $Heap@@1 $Heap@0) ($IsAllocBox ($Box refType this@@3) Tclass._module.Universe? $Heap@0))) (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@0 this@@3) (_module.Universe.globalBaseInv $Heap@0 this@@3)) (and ($IsAllocBox ($Box refType this@@3) Tclass._module.Universe? $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType this@@3 Tclass._module.Universe $Heap@@1)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Universe) ($IsAlloc refType this@@3 Tclass._module.Universe $Heap@@1))) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
