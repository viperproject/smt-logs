...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| |running#0@@3| |running#0@@3|)) (=> (|Set#Subset| |running#0@@3| |running#0@@3|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@65 T@U) ($f@@27 T@U) ) true)) (=> (forall (($o@@66 T@U) ($f@@28 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@67 T@U) ($f@@29 T@U) ) true)) (=> (forall (($o@@68 T@U) ($f@@30 T@U) ) true) (=> (and (_module.OwnedObject.sequenceInv2 $Heap@@26 current$Heap this@@46) (= (ControlFlow 0 2) (- 0 1))) (_module.Object.sequenceInv2 $Heap@@26 current$Heap this@@46)))))))))))))))))))))))))))
