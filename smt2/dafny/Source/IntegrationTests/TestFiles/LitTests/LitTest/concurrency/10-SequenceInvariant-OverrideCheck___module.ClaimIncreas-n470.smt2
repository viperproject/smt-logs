...
(assert (forall (($h@@27 T@U) ($o@@49 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@27) (and (or (not (= $o@@49 null)) (not true)) ($Is refType $o@@49 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@49) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@49) _module.OwnedObject.owner)) Tclass._module.Object $h@@27))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1427|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@27 $o@@49) _module.OwnedObject.owner)))
)))
...
(assert (forall (($o@@52 T@U) ) (!  (=> ($Is refType $o@@52 Tclass._module.IncreasingCounter?) ($Is refType $o@@52 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2413|
 :pattern ( ($Is refType $o@@52 Tclass._module.IncreasingCounter?))
)))
...
(assert (forall (($o@@53 T@U) ) (!  (=> ($Is refType $o@@53 Tclass._module.ConstantInteger?) ($Is refType $o@@53 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2421|
 :pattern ( ($Is refType $o@@53 Tclass._module.ConstantInteger?))
)))
...
(assert (forall (($o@@54 T@U) ) (!  (=> ($Is refType $o@@54 Tclass._module.ClaimIncreasingCounterGreaterThanConstant?) ($Is refType $o@@54 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2425|
 :pattern ( ($Is refType $o@@54 Tclass._module.ClaimIncreasingCounterGreaterThanConstant?))
)))
...
(assert (= (Tag Tclass._module.ClaimIncreasingCounterGreaterThanConstant?) Tagclass._module.ClaimIncreasingCounterGreaterThanConstant?))
(assert (= (TagFamily Tclass._module.ClaimIncreasingCounterGreaterThanConstant?) tytagFamily$ClaimIncreasingCounterGreaterThanConstant))
(assert (forall (($h@@28 T@U) ($o@@55 T@U) ) (!  (=> (and ($IsGoodHeap $h@@28) (and (or (not (= $o@@55 null)) (not true)) ($Is refType $o@@55 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@55) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1426|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@28 $o@@55) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h@@29 T@U) ($o@@59 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@29) (and (or (not (= $o@@59 null)) (not true)) ($Is refType $o@@59 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@59) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@59) _module.Universe.content)) (TSet Tclass._module.Object) $h@@29))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |607|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@29 $o@@59) _module.Universe.content)))
)))
...
(assert (forall (($h@@30 T@U) ($o@@60 T@U) ) (!  (=> (and ($IsGoodHeap $h@@30) (and (or (not (= $o@@60 null)) (not true)) ($Is refType $o@@60 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@60) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |606|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@30 $o@@60) _module.Universe.content)))
)))
...
(set-info :boogie-vc-id OverrideCheck$$_module.ClaimIncreasingCounterGreaterThanConstant.sequenceAdmissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon0_correct  (=> (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType this@@46))))) (=> (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType this@@46)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (forall (($o@@61 T@U) ($f@@23 T@U) ) (!  (=> (or (not (= $o@@61 null)) (not true)) (=> (= $o@@61 this@@46) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@61) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 $o@@61) $f@@23))))
 :qid |_10SequenceInvariantdfy.225:8|
 :skolemid |2248|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@61) $f@@23))
))))) (=> (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (forall (($o@@62 T@U) ($f@@24 T@U) ) (!  (=> (or (not (= $o@@62 null)) (not true)) (=> (= $o@@62 this@@46) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@62) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 $o@@62) $f@@24))))
 :qid |_10SequenceInvariantdfy.225:8|
 :skolemid |2248|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@62) $f@@24))
)))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@26 (_module.Object.universe this@@46)) (or (_module.Universe.globalBaseInv $Heap@@26 (_module.Object.universe this@@46)) (forall ((|o#0@@4| T@U) ) (!  (=> (and ($Is refType |o#0@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#0@@4|))) (and (and (and (= (_module.Object.universe |o#0@@4|) (_module.Object.universe this@@46)) (or (not (= |o#0@@4| (_module.Object.universe this@@46))) (not true))) (_module.Object.baseFieldsInv $Heap@@26 |o#0@@4|)) (_module.Object.triggerAxioms $Heap@@26 |o#0@@4|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2249|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#0@@4|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@26 (_module.Object.universe this@@46)) (or (_module.Universe.globalBaseInv $Heap@@26 (_module.Object.universe this@@46)) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#0@@5|))) (and (and (and (= (_module.Object.universe |o#0@@5|) (_module.Object.universe this@@46)) (or (not (= |o#0@@5| (_module.Object.universe this@@46))) (not true))) (_module.Object.baseFieldsInv $Heap@@26 |o#0@@5|)) (_module.Object.triggerAxioms $Heap@@26 |o#0@@5|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2249|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#0@@5|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@46)) (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#1@@0|))) (and (and (and (= (_module.Object.universe |o#1@@0|) (_module.Object.universe this@@46)) (or (not (= |o#1@@0| (_module.Object.universe this@@46))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#1@@0|)) (_module.Object.triggerAxioms current$Heap |o#1@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2251|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#1@@0|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46)) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@46)) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#1@@1|))) (and (and (and (= (_module.Object.universe |o#1@@1|) (_module.Object.universe this@@46)) (or (not (= |o#1@@1| (_module.Object.universe this@@46))) (not true))) (_module.Object.baseFieldsInv current$Heap |o#1@@1|)) (_module.Object.triggerAxioms current$Heap |o#1@@1|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |2251|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#1@@1|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)))))))))) (=> (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46)) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#2|)))) (not ($IsAllocBox ($Box refType |o#2|) Tclass._module.Object $Heap@@26)))
 :qid |_10SequenceInvariantdfy.43:16|
 :skolemid |2253|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#2|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46)) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#2@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#2@@0|)))) (not ($IsAllocBox ($Box refType |o#2@@0|) Tclass._module.Object $Heap@@26)))
 :qid |_10SequenceInvariantdfy.43:16|
 :skolemid |2253|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#2@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#3|))) (or (forall (($o@@63 T@U) ($f@@25 T@U) ) (!  (=> (or (not (= $o@@63 null)) (not true)) (=> (= $o@@63 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@63) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 $o@@63) $f@@25))))
 :qid |_10SequenceInvariantdfy.55:49|
 :skolemid |2255|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@63) $f@@25))
)) (_module.Object.sequenceInv2 $Heap@@26 current$Heap |o#3|)))
 :qid |_10SequenceInvariantdfy.55:16|
 :skolemid |2256|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@26 current$Heap |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#3|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#3@@0|))) (or (forall (($o@@64 T@U) ($f@@26 T@U) ) (!  (=> (or (not (= $o@@64 null)) (not true)) (=> (= $o@@64 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@64) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 $o@@64) $f@@26))))
 :qid |_10SequenceInvariantdfy.55:49|
 :skolemid |2255|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@64) $f@@26))
)) (_module.Object.sequenceInv2 $Heap@@26 current$Heap |o#3@@0|)))
 :qid |_10SequenceInvariantdfy.55:16|
 :skolemid |2256|
 :pattern ( (_module.Object.sequenceInv2 $Heap@@26 current$Heap |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#4|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#4|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| |running#0@@3| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#4|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#4|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@26)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#4|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#4|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_10SequenceInvariantdfy.58:16|
 :skolemid |2257|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#4|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (or (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (or (_module.Universe.legalTransitionsSequence $Heap@@26 current$Heap (_module.Object.universe this@@46) |running#0@@3|) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#4@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#4@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| |running#0@@3| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#4@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#4@@0|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@26)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#4@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#4@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_10SequenceInvariantdfy.58:16|
 :skolemid |2257|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 (_module.Object.universe this@@46)) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| |running#0@@3| |running#0@@3|)) (=> (|Set#Subset| |running#0@@3| |running#0@@3|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@65 T@U) ($f@@27 T@U) ) (! true
 :qid |_10SequenceInvariantdfy.575:18|
 :skolemid |2262|
))) (=> (forall (($o@@66 T@U) ($f@@28 T@U) ) (! true
 :qid |_10SequenceInvariantdfy.575:18|
 :skolemid |2262|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@67 T@U) ($f@@29 T@U) ) (! true
 :qid |_10SequenceInvariantdfy.575:18|
 :skolemid |2263|
))) (=> (forall (($o@@68 T@U) ($f@@30 T@U) ) (! true
 :qid |_10SequenceInvariantdfy.575:18|
 :skolemid |2263|
)) (=> (and (_module.OwnedObject.sequenceInv2 $Heap@@26 current$Heap this@@46) (= (ControlFlow 0 2) (- 0 1))) (_module.Object.sequenceInv2 $Heap@@26 current$Heap this@@46)))))))))))))))))))))))))))
