...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (|Set#Subset| |running#0@@1| |moreRunning#0|)) (and ($IsAllocBox ($Box refType this@@15) Tclass._module.Universe? current$Heap) ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) current$Heap))) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType this@@15 Tclass._module.Universe $Heap@@7)) (=> ($IsAlloc refType this@@15 Tclass._module.Universe $Heap@@7) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) $Heap@@7)) (=> ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) $Heap@@7) (=> (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@7 current$Heap this@@15 |running#0@@1|) (_module.Universe.legalTransitionsSequence $Heap@@7 current$Heap this@@15 |running#0@@1|)) (and ($IsAllocBox ($Box refType this@@15) Tclass._module.Universe? current$Heap) ($IsAlloc SetType |moreRunning#0| (TSet Tclass._module.Thread) current$Heap))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@15 Tclass._module.Universe $Heap@@7)) (=> ($IsAlloc refType this@@15 Tclass._module.Universe $Heap@@7) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc SetType |moreRunning#0| (TSet Tclass._module.Thread) $Heap@@7))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Universe) ($IsAlloc refType this@@15 Tclass._module.Universe previous$Heap))) (and ($Is SetType |running#0@@1| (TSet Tclass._module.Thread)) ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) previous$Heap))) (and (and ($Is SetType |moreRunning#0| (TSet Tclass._module.Thread)) ($IsAlloc SetType |moreRunning#0| (TSet Tclass._module.Thread) previous$Heap)) (= 6 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap@@7) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) previous$Heap)) (and ($IsAlloc SetType |moreRunning#0| (TSet Tclass._module.Thread) previous$Heap) (= (ControlFlow 0 6) 2)))) anon0_correct))))
