...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#57| null current$Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.OwnedObject.baseFieldsInv#canCall| current$Heap this@@8)) (or (_module.OwnedObject.baseFieldsInv current$Heap this@@8) (|Set#Subset| (_module.OwnedObject.objectFields current$Heap this@@8) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@8)) _module.Universe.content)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@5) ($IsHeapAnchor $Heap@@5)) (=> (and (and (and (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.OwnedObject) ($IsAlloc refType this@@8 Tclass._module.OwnedObject previous$Heap))) (= 6 $FunctionContextHeight)) (and (= previous$Heap $Heap@@5) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and (and (|_module.OwnedObject.baseFieldsInv#canCall| previous$Heap this@@8) (and (_module.OwnedObject.baseFieldsInv previous$Heap this@@8) (|Set#Subset| (_module.OwnedObject.objectFields previous$Heap this@@8) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@8)) _module.Universe.content))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap (_module.Object.universe this@@8)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@8)) _module.Universe.content)))) (and (forall (($o@@23 T@U) ($f@@3 T@U) ) (!  (=> (or (not (= $o@@23 null)) (not true)) (=> (= $o@@23 this@@8) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@23) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@23) $f@@3))))
 :qid |_12MutexLifetimeshortdfy.435:124|
 :skolemid |1790|
