...
(let ((anon8_correct  (=> (= (_module.OwnedObject.localInv $Heap@@9 this@@9)  (and (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (_module.OwnedObject.localUserInv $Heap@@9 this@@9))) (=> (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9) (=> (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) (|_module.OwnedObject.localUserInv#canCall| $Heap@@9 this@@9))) ($Is boolType (bool_2_U (_module.OwnedObject.localInv $Heap@@9 this@@9)) TBool)) (and (=> (= (ControlFlow 0 10) (- 0 12)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 10) 6) GeneratedUnifiedExit_correct)))))))))
(let ((anon12_Else_correct  (=> (not (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9)) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 14) 10)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9) ($IsAllocBox ($Box refType this@@9) Tclass._module.OwnedObject? $Heap@@9)) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_11MutexGuard2legacydfy.338:8|
 :skolemid |1535|
))) (|_module.OwnedObject.localUserInv#canCall| $Heap@@9 this@@9)) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 13) 10))) anon8_correct))))
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@9) Tclass._module.Object? $Heap@@9) (=> (and (= |b$reqreads#0@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@19) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 $o@@19) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_11MutexGuard2legacydfy.337:8|
 :skolemid |1534|
))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@9 this@@9)) (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#8| null $Heap@@9 alloc $Heap@@9 alloc)) (and (and (=> (= (ControlFlow 0 16) 15) anon10_Else_correct) (=> (= (ControlFlow 0 16) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 16) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@9) ($IsHeapAnchor $Heap@@9)) (=> (and (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.OwnedObject) ($IsAlloc refType this@@9 Tclass._module.OwnedObject $Heap@@9))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
