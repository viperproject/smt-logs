...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@0 T@U) ($Heap T@U) (this@@0 T@U) ) (!  (=> (or (|_module.Lifetime.sequenceInv2#canCall| $prevHeap@@0 $Heap this@@0) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@0) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@0 $Heap)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.Lifetime) ($IsAlloc refType this@@0 Tclass._module.Lifetime $prevHeap@@0)))))) (and (and (|_module.Lifetime.alive#canCall| $prevHeap@@0 this@@0) (=> (not (_module.Lifetime.alive $prevHeap@@0 this@@0)) (|_module.Lifetime.alive#canCall| $Heap this@@0))) (= (_module.Lifetime.sequenceInv2 $prevHeap@@0 $Heap this@@0)  (and (and (and (and (=> (not (_module.Lifetime.alive $prevHeap@@0 this@@0)) (not (_module.Lifetime.alive $Heap this@@0))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@0 this@@0) _module.Lifetime.owner))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@0 this@@0) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Lifetime.elements)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@0 this@@0) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Lifetime.mightPointTo)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@0 this@@0) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.Lifetime.mightPointFrom)))))))
 :qid |_12MutexLifetimelongdfy.591:22|
 :skolemid |2423|
 :pattern ( (_module.Lifetime.sequenceInv2 $prevHeap@@0 $Heap this@@0) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@1 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.Lifetime))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@18 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (and (= $o@@18 this@@1) (= $f@@1 _module.Lifetime.owner))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@18) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@18) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |2266|
)) (= (_module.Lifetime.alive $h0@@0 this@@1) (_module.Lifetime.alive $h1@@0 this@@1))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2267|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.Lifetime.alive $h1@@0 this@@1))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Lifetime.alive#canCall| $Heap@@0 this@@2) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Lifetime) ($IsAlloc refType this@@2 Tclass._module.Lifetime $Heap@@0)))))) (= (_module.Lifetime.alive $Heap@@0 this@@2)  (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@2) _module.Lifetime.owner)) null)) (not true))))
 :qid |_12MutexLifetimelongdfy.552:19|
 :skolemid |2270|
 :pattern ( (_module.Lifetime.alive $Heap@@0 this@@2) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Lifetime.sequenceInv2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon14_correct  (=> (= (_module.Lifetime.sequenceInv2 $Heap@@1 current$Heap this@@3)  (and (and (and (and (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.owner))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.elements)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.mightPointTo)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.mightPointFrom))))) (=> (and (and (|_module.Lifetime.alive#canCall| $Heap@@1 this@@3) (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (|_module.Lifetime.alive#canCall| current$Heap this@@3))) ($Is boolType (bool_2_U (_module.Lifetime.sequenceInv2 $Heap@@1 current$Heap this@@3)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 8)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 3) (- 0 7)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 3) (- 0 6)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#4@1|) (=> |b$reqreads#4@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#5@1|)))))))))))))))
(let ((anon22_Else_correct  (=> (not (and (and (and (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.owner))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.elements)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.mightPointTo))))) (=> (and (= |b$reqreads#5@1| true) (= (ControlFlow 0 11) 3)) anon14_correct))))
(let ((anon22_Then_correct  (=> (and (and (and (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.owner))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.elements)))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.mightPointTo)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1)) (=> ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1) (=> (= |b$reqreads#5@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@3 _module.Lifetime.mightPointFrom))) (=> (and (= |b$reqreads#5@1| |b$reqreads#5@0|) (= (ControlFlow 0 9) 3)) anon14_correct)))))))
(let ((anon21_Else_correct  (=> (and (not (and (and (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.owner))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.elements))))) (= |b$reqreads#4@1| true)) (and (=> (= (ControlFlow 0 14) 9) anon22_Then_correct) (=> (= (ControlFlow 0 14) 11) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (and (and (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.owner))))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.elements)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.elements)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1)) (=> ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1) (=> (and (= |b$reqreads#4@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@3 _module.Lifetime.mightPointTo))) (= |b$reqreads#4@1| |b$reqreads#4@0|)) (and (=> (= (ControlFlow 0 12) 9) anon22_Then_correct) (=> (= (ControlFlow 0 12) 11) anon22_Else_correct))))))))
(let ((anon20_Else_correct  (=> (and (not (and (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.owner)))))) (= |b$reqreads#3@1| true)) (and (=> (= (ControlFlow 0 17) 12) anon21_Then_correct) (=> (= (ControlFlow 0 17) 14) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null)) (not true)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) _module.Lifetime.owner))))) (and (=> (= (ControlFlow 0 15) (- 0 16)) ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1)) (=> ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1) (=> (and (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@3 _module.Lifetime.elements))) (= |b$reqreads#3@1| |b$reqreads#3@0|)) (and (=> (= (ControlFlow 0 15) 12) anon21_Then_correct) (=> (= (ControlFlow 0 15) 14) anon21_Else_correct))))))))
(let ((anon19_Else_correct  (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null) (=> (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 21) 15) anon20_Then_correct) (=> (= (ControlFlow 0 21) 17) anon20_Else_correct))))))
(let ((anon19_Then_correct  (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@3) _module.Lifetime.owner)) null)) (not true)) (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@3 _module.Lifetime.owner)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1)) (=> ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1) (=> (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (=> (= (ControlFlow 0 19) 15) anon20_Then_correct) (=> (= (ControlFlow 0 19) 17) anon20_Else_correct))))))))
(let ((anon18_Then_correct  (=> (and (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3))) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@3 _module.Lifetime.owner)))) (and (=> (= (ControlFlow 0 22) 19) anon19_Then_correct) (=> (= (ControlFlow 0 22) 21) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (not (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (not (_module.Lifetime.alive current$Heap this@@3)))) (=> (and (= |b$reqreads#1@1| true) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 18) 15) anon20_Then_correct) (=> (= (ControlFlow 0 18) 17) anon20_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (_module.Lifetime.alive $Heap@@1 this@@3) (= |b$reqreads#0@1| true)) (and (=> (= (ControlFlow 0 24) 22) anon18_Then_correct) (=> (= (ControlFlow 0 24) 18) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (not (_module.Lifetime.alive $Heap@@1 this@@3)) (=> (and (and ($IsAllocBox ($Box refType this@@3) Tclass._module.Lifetime? current$Heap) (= |b$reqreads#0@0| (forall (($o@@24 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@24) alloc)))) (and (= $o@@24 this@@3) (= $f@@2 _module.Lifetime.owner))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@24 $f@@2)))
 :qid |_12MutexLifetimelongdfy.592:28|
 :skolemid |2425|
)))) (and (|_module.Lifetime.alive#canCall| current$Heap this@@3) (= |b$reqreads#0@1| |b$reqreads#0@0|))) (and (=> (= (ControlFlow 0 23) 22) anon18_Then_correct) (=> (= (ControlFlow 0 23) 18) anon18_Else_correct))))))
(let ((anon16_Else_correct  (and (=> (= (ControlFlow 0 25) (- 0 26)) ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1)) (=> ($IsAlloc refType this@@3 Tclass._module.Lifetime $Heap@@1) (=> (|_module.Lifetime.alive#canCall| $Heap@@1 this@@3) (and (=> (= (ControlFlow 0 25) 23) anon17_Then_correct) (=> (= (ControlFlow 0 25) 24) anon17_Else_correct)))))))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#96| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 27) 1) anon16_Then_correct) (=> (= (ControlFlow 0 27) 25) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Lifetime) ($IsAlloc refType this@@3 Tclass._module.Lifetime previous$Heap))) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 28) 27))) anon0_correct))))
