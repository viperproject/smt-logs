...
(assert (forall (($h@@31 T@U) ($o@@56 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@31) (and (or (not (= $o@@56 null)) (not true)) ($Is refType $o@@56 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@56) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@56) _module.OwnedObject.owner)) Tclass._module.Object $h@@31))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |869|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@31 $o@@56) _module.OwnedObject.owner)))
)))
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@70 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@70 null)) (not true)) (and ($Is refType this@@70 Tclass._module.Universe) ($IsAlloc refType this@@70 Tclass._module.Universe $h0@@21)))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@57 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@57 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@57) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@57) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@57) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |507|
...
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@71 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@71 null)) (not true)) (and ($Is refType this@@71 Tclass._module.Object) ($IsAlloc refType this@@71 Tclass._module.Object $h0@@22)))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@58 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@58 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@58) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@58) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@58) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |734|
...
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@72 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@72 null)) (not true)) (and ($Is refType this@@72 Tclass._module.Object) ($IsAlloc refType this@@72 Tclass._module.Object $h0@@23)))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@59 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@59) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@59) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@59) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |790|
...
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@73 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@73 null)) (not true)) (and ($Is refType this@@73 Tclass._module.Object) ($IsAlloc refType this@@73 Tclass._module.Object $h0@@24)))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@60 T@U) ($f@@30 T@U) ) (!  (=> (and (or (not (= $o@@60 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@60) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@60) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@60) $f@@30)))
 :qid |unknown.0:0|
 :skolemid |798|
...
(assert (forall (($h0@@25 T@U) ($h1@@25 T@U) (this@@74 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@25) ($IsGoodHeap $h1@@25)) (and (or (not (= this@@74 null)) (not true)) (and ($Is refType this@@74 Tclass._module.OwnedObject) ($IsAlloc refType this@@74 Tclass._module.OwnedObject $h0@@25)))) (and ($IsHeapAnchor $h0@@25) ($HeapSucc $h0@@25 $h1@@25))) (=> (forall (($o@@61 T@U) ($f@@31 T@U) ) (!  (=> (and (or (not (= $o@@61 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@61) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@25 $o@@61) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@25 $o@@61) $f@@31)))
 :qid |unknown.0:0|
 :skolemid |872|
...
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@75 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@75 null)) (not true)) (and ($Is refType this@@75 Tclass._module.OwnedObject) ($IsAlloc refType this@@75 Tclass._module.OwnedObject $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@62 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@62 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@62) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@62) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@62) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |882|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@76 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@76 null)) (not true)) (and ($Is refType this@@76 Tclass._module.OwnedObject) ($IsAlloc refType this@@76 Tclass._module.OwnedObject $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@63 T@U) ($f@@33 T@U) ) (!  (=> (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@63) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@63) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@63) $f@@33)))
 :qid |unknown.0:0|
 :skolemid |938|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@77 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@77 null)) (not true)) (and ($Is refType this@@77 Tclass._module.OwnedObject) ($IsAlloc refType this@@77 Tclass._module.OwnedObject $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@64 T@U) ($f@@34 T@U) ) (!  (=> (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@64) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@64) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@64) $f@@34)))
 :qid |unknown.0:0|
 :skolemid |942|
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@78 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@78 null)) (not true)) (and ($Is refType this@@78 Tclass._module.OwnedObject) ($IsAlloc refType this@@78 Tclass._module.OwnedObject $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@65 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@65) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@65) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |950|
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@79 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@79 null)) (not true)) (and ($Is refType this@@79 Tclass._module.Thread) ($IsAlloc refType this@@79 Tclass._module.Thread $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@66 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@66) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@66) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@66) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |963|
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@80 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@80 null)) (not true)) (and ($Is refType this@@80 Tclass._module.Thread) ($IsAlloc refType this@@80 Tclass._module.Thread $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@67 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@67 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@67) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@67) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@67) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |971|
...
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@81 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@81 null)) (not true)) (and ($Is refType this@@81 Tclass._module.AtomicCounter) ($IsAlloc refType this@@81 Tclass._module.AtomicCounter $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@68 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@68 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@68) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@68) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@68) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1454|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@82 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@82 null)) (not true)) (and ($Is refType this@@82 Tclass._module.AtomicCounter) ($IsAlloc refType this@@82 Tclass._module.AtomicCounter $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@69 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@69 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@69) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@69) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@69) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1476|
...
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@84 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@84 null)) (not true)) (and ($Is refType this@@84 Tclass._module.DoubleReadMethod) ($IsAlloc refType this@@84 Tclass._module.DoubleReadMethod $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@71 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@71 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@71) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@71) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@71) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1726|
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@85 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@85 null)) (not true)) (and ($Is refType this@@85 Tclass._module.DoubleReadMethod) ($IsAlloc refType this@@85 Tclass._module.DoubleReadMethod $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@72 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@72 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@72) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@72) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@72) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1733|
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@86 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@86 null)) (not true)) (and ($Is refType this@@86 Tclass._module.DoubleReadMethod) ($IsAlloc refType this@@86 Tclass._module.DoubleReadMethod $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@73 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@73) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@73) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@73) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1740|
...
)))) (= (_module.Universe.legalTransition $prevHeap@@37 $Heap@@48 this@@87 |running#0@@4|)  (and (_module.Universe.multipleLegalTransitions $prevHeap@@37 $Heap@@48 this@@87 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@4|))) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@37 this@@87) _module.Universe.content)) ($Box refType |o#0@@5|))) (or (forall (($o@@75 T@U) ($f@@45 T@U) ) (!  (=> (or (not (= $o@@75 null)) (not true)) (=> (= $o@@75 |o#0@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@48 $o@@75) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@37 $o@@75) $f@@45))))
 :qid |_06ThreadOwnershipdfy.48:49|
 :skolemid |596|
...
(assert (forall (($o@@76 T@U) ) (!  (=> ($Is refType $o@@76 Tclass._module.NonOwnedObject?) ($Is refType $o@@76 Tclass._module.Object?))
 :qid |unknown.0:0|
 :skolemid |2062|
 :pattern ( ($Is refType $o@@76 Tclass._module.NonOwnedObject?))
)))
...
(assert (forall (($o@@78 T@U) ) (!  (=> ($Is refType $o@@78 Tclass._module.Thread?) ($Is refType $o@@78 Tclass._module.NonOwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2070|
...
(assert (forall (($o@@79 T@U) ) (!  (=> ($Is refType $o@@79 Tclass._module.AtomicCounter?) ($Is refType $o@@79 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2078|
 :pattern ( ($Is refType $o@@79 Tclass._module.AtomicCounter?))
)))
...
(assert (forall (($o@@80 T@U) ) (!  (=> ($Is refType $o@@80 Tclass._module.DoubleReadMethod?) ($Is refType $o@@80 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2082|
 :pattern ( ($Is refType $o@@80 Tclass._module.DoubleReadMethod?))
)))
...
(assert (= (Tag Tclass._module.DoubleReadMethod) Tagclass._module.DoubleReadMethod))
(assert (= (TagFamily Tclass._module.DoubleReadMethod) tytagFamily$DoubleReadMethod))
(assert (forall (($h@@32 T@U) ($o@@81 T@U) ) (!  (=> (and ($IsGoodHeap $h@@32) (and (or (not (= $o@@81 null)) (not true)) ($Is refType $o@@81 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@81) _module.OwnedObject.owner)) Tclass._module.Object))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |868|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@32 $o@@81) _module.OwnedObject.owner)))
)))
...
(assert (forall (($o@@84 T@U) ) (! (= ($Is refType $o@@84 Tclass._module.NonOwnedObject?)  (or (= $o@@84 null) (implements$_module.NonOwnedObject (dtype $o@@84))))
 :qid |unknown.0:0|
 :skolemid |855|
 :pattern ( ($Is refType $o@@84 Tclass._module.NonOwnedObject?))
)))
...
(assert (forall (($h@@33 T@U) ($o@@86 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@33) (and (or (not (= $o@@86 null)) (not true)) ($Is refType $o@@86 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@86) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@86) _module.Universe.content)) (TSet Tclass._module.Object) $h@@33))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |491|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@33 $o@@86) _module.Universe.content)))
)))
...
(set-info :boogie-vc-id OverrideCheck$$_module.DoubleReadMethod.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon0_correct  (=> (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 28)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@61 this@@100) (or (_module.Object.baseInv $Heap@@61 this@@100) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType this@@100))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@61 this@@100) (or (_module.Object.baseInv $Heap@@61 this@@100) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType this@@100)))))) (and (=> (= (ControlFlow 0 2) (- 0 27)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@61 this@@100) (or (_module.Object.baseInv $Heap@@61 this@@100) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#0@@6| T@U) ) (!  (=> (and ($Is refType |o#0@@6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#0@@6|))) (and (= (_module.Object.universe |o#0@@6|) (_module.Object.universe this@@100)) (or (not (= |o#0@@6| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1763|
 :pattern ( (_module.Object.universe |o#0@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#0@@6|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@61 this@@100) (or (_module.Object.baseInv $Heap@@61 this@@100) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#0@@7| T@U) ) (!  (=> (and ($Is refType |o#0@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#0@@7|))) (and (= (_module.Object.universe |o#0@@7|) (_module.Object.universe this@@100)) (or (not (= |o#0@@7| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1763|
 :pattern ( (_module.Object.universe |o#0@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#0@@7|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@61 this@@100) (or (_module.Object.baseInv $Heap@@61 this@@100) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#1@@3|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@3|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@3|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@3|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1764|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@3|) _module.OwnedObject.closed)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@3|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#1@@3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@61 this@@100) (or (_module.Object.baseInv $Heap@@61 this@@100) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#1@@4|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@4|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@4|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@4|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1764|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@4|) _module.OwnedObject.closed)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#1@@4|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#1@@4|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#2@@1| T@U) ) (!  (=> (and ($Is refType |o#2@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#2@@1|))) (and (= (_module.Object.universe |o#2@@1|) (_module.Object.universe this@@100)) (or (not (= |o#2@@1| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1767|
 :pattern ( (_module.Object.universe |o#2@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#2@@1|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#2@@2| T@U) ) (!  (=> (and ($Is refType |o#2@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#2@@2|))) (and (= (_module.Object.universe |o#2@@2|) (_module.Object.universe this@@100)) (or (not (= |o#2@@2| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1767|
 :pattern ( (_module.Object.universe |o#2@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#2@@2|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#3@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@0|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@0|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1768|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@0|) _module.OwnedObject.closed)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#3@@0|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#3@@1| T@U) ) (!  (=> (and ($Is refType |o#3@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#3@@1|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@1|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@1|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@1|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1768|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@1|) _module.OwnedObject.closed)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#3@@1|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#3@@1|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#4|))) (_module.Object.inv $Heap@@61 |o#4|))
 :qid |_06ThreadOwnershipdfy.23:16|
 :skolemid |1771|
 :pattern ( (_module.Object.inv $Heap@@61 |o#4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#4|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#4@@0|))) (_module.Object.inv $Heap@@61 |o#4@@0|))
 :qid |_06ThreadOwnershipdfy.23:16|
 :skolemid |1771|
 :pattern ( (_module.Object.inv $Heap@@61 |o#4@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@100) (or (_module.Object.baseInv current$Heap this@@100) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType this@@100))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@100) (or (_module.Object.baseInv current$Heap this@@100) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType this@@100)))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@100) (or (_module.Object.baseInv current$Heap this@@100) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#5|))) (and (= (_module.Object.universe |o#5|) (_module.Object.universe this@@100)) (or (not (= |o#5| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1773|
 :pattern ( (_module.Object.universe |o#5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#5|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@100) (or (_module.Object.baseInv current$Heap this@@100) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#5@@0|))) (and (= (_module.Object.universe |o#5@@0|) (_module.Object.universe this@@100)) (or (not (= |o#5@@0| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1773|
 :pattern ( (_module.Object.universe |o#5@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#5@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@100) (or (_module.Object.baseInv current$Heap this@@100) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#6|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#6|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#6|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#6|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1774|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#6|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@100) (or (_module.Object.baseInv current$Heap this@@100) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#6@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#6@@0|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#6@@0|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#6@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1774|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#6@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (forall (($o@@88 T@U) ($f@@46 T@U) ) (!  (=> (or (not (= $o@@88 null)) (not true)) (=> (= $o@@88 this@@100) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@88) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 $o@@88) $f@@46))))
 :qid |_06ThreadOwnershipdfy.101:8|
 :skolemid |1777|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@88) $f@@46))
))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (forall (($o@@89 T@U) ($f@@47 T@U) ) (!  (=> (or (not (= $o@@89 null)) (not true)) (=> (= $o@@89 this@@100) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@89) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 $o@@89) $f@@47))))
 :qid |_06ThreadOwnershipdfy.101:8|
 :skolemid |1777|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@89) $f@@47))
)))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#7|))) (and (= (_module.Object.universe |o#7|) (_module.Object.universe this@@100)) (or (not (= |o#7| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1778|
 :pattern ( (_module.Object.universe |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#7|)))
))))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (= (_module.Object.universe |o#7@@0|) (_module.Object.universe this@@100)) (or (not (= |o#7@@0| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1778|
 :pattern ( (_module.Object.universe |o#7@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#7@@0|)))
)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#8|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1779|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8|) _module.OwnedObject.closed)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#8|)))
))))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#8@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8@@0|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8@@0|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1779|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8@@0|) _module.OwnedObject.closed)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#8@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#8@@0|)))
)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#9|))) (_module.Object.inv $Heap@@61 |o#9|))
 :qid |_06ThreadOwnershipdfy.23:16|
 :skolemid |1782|
 :pattern ( (_module.Object.inv $Heap@@61 |o#9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#9|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalInv#canCall| $Heap@@61 (_module.Object.universe this@@100)) (or (_module.Universe.globalInv $Heap@@61 (_module.Object.universe this@@100)) (forall ((|o#9@@0| T@U) ) (!  (=> (and ($Is refType |o#9@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#9@@0|))) (_module.Object.inv $Heap@@61 |o#9@@0|))
 :qid |_06ThreadOwnershipdfy.23:16|
 :skolemid |1782|
 :pattern ( (_module.Object.inv $Heap@@61 |o#9@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#9@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#10|))) (and (= (_module.Object.universe |o#10|) (_module.Object.universe this@@100)) (or (not (= |o#10| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1784|
 :pattern ( (_module.Object.universe |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#10|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#10@@0|))) (and (= (_module.Object.universe |o#10@@0|) (_module.Object.universe this@@100)) (or (not (= |o#10@@0| (_module.Object.universe this@@100))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1784|
 :pattern ( (_module.Object.universe |o#10@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#10@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#11|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#11|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#11|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#11|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1785|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#11|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@100)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@100)) (forall ((|o#11@@0| T@U) ) (!  (=> (and ($Is refType |o#11@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#11@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#11@@0|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#11@@0|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#11@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1785|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#11@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content))))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#12|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#12|)))) (not ($IsAllocBox ($Box refType |o#12|) Tclass._module.Object $Heap@@61)))
 :qid |_06ThreadOwnershipdfy.36:16|
 :skolemid |1788|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#12|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#12|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#12@@0| T@U) ) (!  (=> (and ($Is refType |o#12@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#12@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#12@@0|)))) (not ($IsAllocBox ($Box refType |o#12@@0|) Tclass._module.Object $Heap@@61)))
 :qid |_06ThreadOwnershipdfy.36:16|
 :skolemid |1788|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#12@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#12@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#13|))) (or (forall (($o@@90 T@U) ($f@@48 T@U) ) (!  (=> (or (not (= $o@@90 null)) (not true)) (=> (= $o@@90 |o#13|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@90) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 $o@@90) $f@@48))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |1789|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@90) $f@@48))
)) (_module.Object.inv current$Heap |o#13|)))
 :qid |_06ThreadOwnershipdfy.38:16|
 :skolemid |1790|
 :pattern ( (_module.Object.inv current$Heap |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#13|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#13@@0| T@U) ) (!  (=> (and ($Is refType |o#13@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#13@@0|))) (or (forall (($o@@91 T@U) ($f@@49 T@U) ) (!  (=> (or (not (= $o@@91 null)) (not true)) (=> (= $o@@91 |o#13@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@91) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 $o@@91) $f@@49))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |1789|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@91) $f@@49))
)) (_module.Object.inv current$Heap |o#13@@0|)))
 :qid |_06ThreadOwnershipdfy.38:16|
 :skolemid |1790|
 :pattern ( (_module.Object.inv current$Heap |o#13@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#13@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#14|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#14|))))) (_module.Object.inv current$Heap |o#14|))
 :qid |_06ThreadOwnershipdfy.40:16|
 :skolemid |1791|
 :pattern ( (_module.Object.inv current$Heap |o#14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#14|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#14|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#14@@0| T@U) ) (!  (=> (and ($Is refType |o#14@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#14@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#14@@0|))))) (_module.Object.inv current$Heap |o#14@@0|))
 :qid |_06ThreadOwnershipdfy.40:16|
 :skolemid |1791|
 :pattern ( (_module.Object.inv current$Heap |o#14@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#14@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#14@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|t#0@@0| T@U) ) (!  (=> (and ($Is refType |t#0@@0| Tclass._module.Thread) (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) ($Box refType |t#0@@0|))) (and (= (_module.Object.universe |t#0@@0|) (_module.Object.universe this@@100)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |t#0@@0|))))
 :qid |_06ThreadOwnershipdfy.42:16|
 :skolemid |1792|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |t#0@@0|)))
...
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|t#0@@1| T@U) ) (!  (=> (and ($Is refType |t#0@@1| Tclass._module.Thread) (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) ($Box refType |t#0@@1|))) (and (= (_module.Object.universe |t#0@@1|) (_module.Object.universe this@@100)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |t#0@@1|))))
 :qid |_06ThreadOwnershipdfy.42:16|
 :skolemid |1792|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |t#0@@1|)))
...
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#15| T@U) ) (!  (=> (and ($Is refType |o#15| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#15|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#15|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#15|) _module.OwnedObject.owner))) (forall (($o@@92 T@U) ($f@@50 T@U) ) (!  (=> (or (not (= $o@@92 null)) (not true)) (=> (= $o@@92 |o#15|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@92) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 $o@@92) $f@@50))))
 :qid |_06ThreadOwnershipdfy.43:119|
 :skolemid |1793|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@92) $f@@50))
))))
 :qid |_06ThreadOwnershipdfy.43:16|
 :skolemid |1794|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#15|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#15|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (=> (|_module.Universe.multipleLegalTransitions#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.multipleLegalTransitions $Heap@@61 current$Heap (_module.Object.universe this@@100) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#15@@0| T@U) ) (!  (=> (and ($Is refType |o#15@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#15@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#15@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#15@@0|) _module.OwnedObject.owner))) (forall (($o@@93 T@U) ($f@@51 T@U) ) (!  (=> (or (not (= $o@@93 null)) (not true)) (=> (= $o@@93 |o#15@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@93) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 $o@@93) $f@@51))))
 :qid |_06ThreadOwnershipdfy.43:119|
 :skolemid |1793|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@93) $f@@51))
))))
 :qid |_06ThreadOwnershipdfy.43:16|
 :skolemid |1794|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 |o#15@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#15@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#16|))) (or (forall (($o@@94 T@U) ($f@@52 T@U) ) (!  (=> (or (not (= $o@@94 null)) (not true)) (=> (= $o@@94 |o#16|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@94) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 $o@@94) $f@@52))))
 :qid |_06ThreadOwnershipdfy.48:49|
 :skolemid |1802|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@94) $f@@52))
)) (_module.Object.inv2 $Heap@@61 current$Heap |o#16|)))
 :qid |_06ThreadOwnershipdfy.48:16|
 :skolemid |1803|
 :pattern ( (_module.Object.inv2 $Heap@@61 current$Heap |o#16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#16|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@61 current$Heap this@@100 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@61 current$Heap this@@100 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@61 current$Heap (_module.Object.universe this@@100) |running#0@@5|) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#16@@0|))) (or (forall (($o@@95 T@U) ($f@@53 T@U) ) (!  (=> (or (not (= $o@@95 null)) (not true)) (=> (= $o@@95 |o#16@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@95) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 $o@@95) $f@@53))))
 :qid |_06ThreadOwnershipdfy.48:49|
 :skolemid |1802|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@95) $f@@53))
)) (_module.Object.inv2 $Heap@@61 current$Heap |o#16@@0|)))
 :qid |_06ThreadOwnershipdfy.48:16|
 :skolemid |1803|
 :pattern ( (_module.Object.inv2 $Heap@@61 current$Heap |o#16@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@61 (_module.Object.universe this@@100)) _module.Universe.content)) ($Box refType |o#16@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true)))) (=> (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@96 T@U) ($f@@54 T@U) ) (! true
 :qid |_06ThreadOwnershipdfy.387:18|
 :skolemid |1807|
))) (=> (forall (($o@@97 T@U) ($f@@55 T@U) ) (! true
 :qid |_06ThreadOwnershipdfy.387:18|
 :skolemid |1807|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@98 T@U) ($f@@56 T@U) ) (! true
 :qid |_06ThreadOwnershipdfy.387:18|
 :skolemid |1808|
))) (=> (forall (($o@@99 T@U) ($f@@57 T@U) ) (! true
 :qid |_06ThreadOwnershipdfy.387:18|
 :skolemid |1808|
)) (=> (and (_module.OwnedObject.inv2 $Heap@@61 current$Heap this@@100) (_module.OwnedObject.inv current$Heap this@@100)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Object.inv2 $Heap@@61 current$Heap this@@100)) (=> (_module.Object.inv2 $Heap@@61 current$Heap this@@100) (=> (= (ControlFlow 0 2) (- 0 1)) (_module.Object.inv current$Heap this@@100))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
