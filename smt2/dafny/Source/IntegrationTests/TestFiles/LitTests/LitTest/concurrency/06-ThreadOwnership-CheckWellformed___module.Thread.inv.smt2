...
)))))))))) (=> (=> (_module.Thread.inv $Heap@@4 this@@4) (=> (|_module.Thread.localInv#canCall| $Heap@@4 this@@4) (or (_module.Thread.localInv $Heap@@4 this@@4) (=> (|_module.Object.baseInv#canCall| $Heap@@4 this@@4) (or (_module.Object.baseInv $Heap@@4 this@@4) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@4 (_module.Object.universe this@@4)) (or (_module.Universe.globalBaseInv $Heap@@4 (_module.Object.universe this@@4)) (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType |o#0@@1|))) (and (= (_module.Object.universe |o#0@@1|) (_module.Object.universe this@@4)) (or (not (= |o#0@@1| (_module.Object.universe this@@4))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |977|
 :pattern ( (_module.Object.universe |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType |o#0@@1|)))
))))))))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.Thread.inv $Heap@@4 this@@4) (=> (|_module.Thread.localInv#canCall| $Heap@@4 this@@4) (or (_module.Thread.localInv $Heap@@4 this@@4) (=> (|_module.Object.baseInv#canCall| $Heap@@4 this@@4) (or (_module.Object.baseInv $Heap@@4 this@@4) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@4 (_module.Object.universe this@@4)) (or (_module.Universe.globalBaseInv $Heap@@4 (_module.Object.universe this@@4)) (forall ((|o#1@@0| T@U) ) (!  (=> (and ($Is refType |o#1@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType |o#1@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |o#1@@0|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |o#1@@0|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |o#1@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |978|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |o#1@@0|) _module.OwnedObject.closed)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 |o#1@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 (_module.Object.universe this@@4)) _module.Universe.content)) ($Box refType |o#1@@0|)))
))))))))))))))))))
(let ((anon8_correct  (=> (= (_module.Thread.inv $Heap@@4 this@@4)  (and true (_module.Thread.localInv $Heap@@4 this@@4))) (=> (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@4 this@@4)) ($Is boolType (bool_2_U (_module.Thread.inv $Heap@@4 this@@4)) TBool)) (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 10) 6) GeneratedUnifiedExit_correct)))))))
...
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@4) Tclass._module.Thread? $Heap@@4)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@24 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@24) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@24) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@24 $f@@0)))
 :qid |_06ThreadOwnershipdfy.211:8|
 :skolemid |981|
))) (|_module.Thread.localInv#canCall| $Heap@@4 this@@4)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 12) 10))) anon8_correct))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null $Heap@@4 alloc $Heap@@4 alloc)) (and (and (and (=> (= (ControlFlow 0 14) 12) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)) (=> (= (ControlFlow 0 14) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 14) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Thread) ($IsAlloc refType this@@4 Tclass._module.Thread $Heap@@4))) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct))))
