...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split144)
...
))))) (and (and (= $Heap@11 $Heap@12) (U_2_bool (Lit boolType (bool_2_U true)))) (and (or (not (= |scope#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1)))))))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |scope#0| _module.Lifetime.owner))))))
