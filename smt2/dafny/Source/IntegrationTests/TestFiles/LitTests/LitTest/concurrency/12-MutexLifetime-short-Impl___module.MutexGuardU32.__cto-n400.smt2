...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split169)
...
)))) (= $Heap@14 $Heap@15)) (and (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Object.objectGlobalInv#canCall| $Heap@15 this@@222)))))) (or (_module.Object.objectGlobalInv $Heap@15 this@@222) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 (_module.Object.universe this@@222)) _module.Universe.content)) ($Box refType this@@222))))))))
