...
(assert (distinct alloc Tagclass._module.Universe Tagclass._module.MutexGuardU32 Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? Tagclass._module.MutexGuardU32? tytagFamily$Universe tytagFamily$MutexGuardU32 tytagFamily$Object tytagFamily$OwnedObject)
)
...
(assert (forall (($o@@3 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.MutexGuardU32? $h@@6)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2167|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.MutexGuardU32? $h@@6))
)))
...
(assert (forall (($o@@7 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@7 Tclass._module.MutexGuardU32? $heap@@0) ($IsAlloc refType $o@@7 Tclass._module.OwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |2453|
 :pattern ( ($IsAlloc refType $o@@7 Tclass._module.MutexGuardU32? $heap@@0))
)))
...
(assert (forall (($o@@9 T@U) ) (!  (=> ($Is refType $o@@9 Tclass._module.MutexGuardU32?) ($Is refType $o@@9 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2452|
...
(set-info :boogie-vc-id OverrideCheck$$_module.MutexGuardU32.baseUserFieldsInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))))) (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this)))) (=> (and (= MutexGuardU32_$_ReadsFrame@0 (|lambda#81| null $Heap alloc this (_module.Object.universe this))) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@14) alloc)))) (or (= $o@@14 this) (= $o@@14 (_module.Object.universe this)))) (or (= $o@@14 this) (= $o@@14 (_module.Object.universe this))))
