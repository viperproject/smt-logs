...
(assert (forall (($h@@37 T@U) ($o@@71 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@37) (and (or (not (= $o@@71 null)) (not true)) ($Is refType $o@@71 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@71) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@71) _module.OwnedObject.owner)) Tclass._module.Object $h@@37))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1292|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@37 $o@@71) _module.OwnedObject.owner)))
)))
...
(assert (forall (($h0@@26 T@U) ($h1@@26 T@U) (this@@92 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@26) ($IsGoodHeap $h1@@26)) (and (or (not (= this@@92 null)) (not true)) (and ($Is refType this@@92 Tclass._module.Universe) ($IsAlloc refType this@@92 Tclass._module.Universe $h0@@26)))) (and ($IsHeapAnchor $h0@@26) ($HeapSucc $h0@@26 $h1@@26))) (=> (forall (($o@@72 T@U) ($f@@35 T@U) ) (!  (=> (and (or (not (= $o@@72 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@72) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@26 $o@@72) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@26 $o@@72) $f@@35)))
 :qid |unknown.0:0|
 :skolemid |502|
...
(assert (forall (($h0@@27 T@U) ($h1@@27 T@U) (this@@93 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@27) ($IsGoodHeap $h1@@27)) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.Object) ($IsAlloc refType this@@93 Tclass._module.Object $h0@@27)))) (and ($IsHeapAnchor $h0@@27) ($HeapSucc $h0@@27 $h1@@27))) (=> (forall (($o@@73 T@U) ($f@@36 T@U) ) (!  (=> (and (or (not (= $o@@73 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@73) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@27 $o@@73) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@27 $o@@73) $f@@36)))
 :qid |unknown.0:0|
 :skolemid |967|
...
(assert (forall (($h0@@28 T@U) ($h1@@28 T@U) (this@@94 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@28) ($IsGoodHeap $h1@@28)) (and (or (not (= this@@94 null)) (not true)) (and ($Is refType this@@94 Tclass._module.Object) ($IsAlloc refType this@@94 Tclass._module.Object $h0@@28)))) (and ($IsHeapAnchor $h0@@28) ($HeapSucc $h0@@28 $h1@@28))) (=> (forall (($o@@74 T@U) ($f@@37 T@U) ) (!  (=> (and (or (not (= $o@@74 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@74) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@28 $o@@74) $f@@37) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@28 $o@@74) $f@@37)))
 :qid |unknown.0:0|
 :skolemid |1017|
...
(assert (forall (($h0@@29 T@U) ($h1@@29 T@U) (this@@95 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@29) ($IsGoodHeap $h1@@29)) (and (or (not (= this@@95 null)) (not true)) (and ($Is refType this@@95 Tclass._module.Object) ($IsAlloc refType this@@95 Tclass._module.Object $h0@@29)))) (and ($IsHeapAnchor $h0@@29) ($HeapSucc $h0@@29 $h1@@29))) (=> (forall (($o@@75 T@U) ($f@@38 T@U) ) (!  (=> (and (or (not (= $o@@75 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@75) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@29 $o@@75) $f@@38) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@29 $o@@75) $f@@38)))
 :qid |unknown.0:0|
 :skolemid |1025|
...
(assert (forall (($h0@@30 T@U) ($h1@@30 T@U) (this@@96 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@30) ($IsGoodHeap $h1@@30)) (and (or (not (= this@@96 null)) (not true)) (and ($Is refType this@@96 Tclass._module.Thread) ($IsAlloc refType this@@96 Tclass._module.Thread $h0@@30)))) (and ($IsHeapAnchor $h0@@30) ($HeapSucc $h0@@30 $h1@@30))) (=> (forall (($o@@76 T@U) ($f@@39 T@U) ) (!  (=> (and (or (not (= $o@@76 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@76) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@30 $o@@76) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@30 $o@@76) $f@@39)))
 :qid |unknown.0:0|
 :skolemid |1084|
...
(assert (forall (($h0@@31 T@U) ($h1@@31 T@U) (this@@97 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@31) ($IsGoodHeap $h1@@31)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.Thread) ($IsAlloc refType this@@97 Tclass._module.Thread $h0@@31)))) (and ($IsHeapAnchor $h0@@31) ($HeapSucc $h0@@31 $h1@@31))) (=> (forall (($o@@77 T@U) ($f@@40 T@U) ) (!  (=> (and (or (not (= $o@@77 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@77) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@31 $o@@77) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@31 $o@@77) $f@@40)))
 :qid |unknown.0:0|
 :skolemid |1092|
...
(assert (forall (($h0@@32 T@U) ($h1@@32 T@U) (this@@98 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@32) ($IsGoodHeap $h1@@32)) (and (or (not (= this@@98 null)) (not true)) (and ($Is refType this@@98 Tclass._module.OwnedObject) ($IsAlloc refType this@@98 Tclass._module.OwnedObject $h0@@32)))) (and ($IsHeapAnchor $h0@@32) ($HeapSucc $h0@@32 $h1@@32))) (=> (forall (($o@@78 T@U) ($f@@41 T@U) ) (!  (=> (and (or (not (= $o@@78 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@78) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@32 $o@@78) $f@@41) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@32 $o@@78) $f@@41)))
 :qid |unknown.0:0|
 :skolemid |1299|
...
(assert (forall (($h0@@33 T@U) ($h1@@33 T@U) (this@@99 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@33) ($IsGoodHeap $h1@@33)) (and (or (not (= this@@99 null)) (not true)) (and ($Is refType this@@99 Tclass._module.OwnedObject) ($IsAlloc refType this@@99 Tclass._module.OwnedObject $h0@@33)))) (and ($IsHeapAnchor $h0@@33) ($HeapSucc $h0@@33 $h1@@33))) (=> (forall (($o@@79 T@U) ($f@@42 T@U) ) (!  (=> (and (or (not (= $o@@79 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@79) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@33 $o@@79) $f@@42) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@33 $o@@79) $f@@42)))
 :qid |unknown.0:0|
 :skolemid |1309|
...
(assert (forall (($h0@@34 T@U) ($h1@@34 T@U) (this@@100 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@34) ($IsGoodHeap $h1@@34)) (and (or (not (= this@@100 null)) (not true)) (and ($Is refType this@@100 Tclass._module.OwnedObject) ($IsAlloc refType this@@100 Tclass._module.OwnedObject $h0@@34)))) (and ($IsHeapAnchor $h0@@34) ($HeapSucc $h0@@34 $h1@@34))) (=> (forall (($o@@80 T@U) ($f@@43 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@80) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@34 $o@@80) $f@@43) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@34 $o@@80) $f@@43)))
 :qid |unknown.0:0|
 :skolemid |1385|
...
(assert (forall (($h0@@35 T@U) ($h1@@35 T@U) (this@@101 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@35) ($IsGoodHeap $h1@@35)) (and (or (not (= this@@101 null)) (not true)) (and ($Is refType this@@101 Tclass._module.OwnedObject) ($IsAlloc refType this@@101 Tclass._module.OwnedObject $h0@@35)))) (and ($IsHeapAnchor $h0@@35) ($HeapSucc $h0@@35 $h1@@35))) (=> (forall (($o@@81 T@U) ($f@@44 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@81) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@35 $o@@81) $f@@44) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@35 $o@@81) $f@@44)))
 :qid |unknown.0:0|
 :skolemid |1389|
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@102 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@102 null)) (not true)) (and ($Is refType this@@102 Tclass._module.OwnedObject) ($IsAlloc refType this@@102 Tclass._module.OwnedObject $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@82 T@U) ($f@@45 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@82) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@82) $f@@45) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@82) $f@@45)))
 :qid |unknown.0:0|
 :skolemid |1397|
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@103 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@103 null)) (not true)) (and ($Is refType this@@103 Tclass._module.AtomicCounter) ($IsAlloc refType this@@103 Tclass._module.AtomicCounter $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@83 T@U) ($f@@46 T@U) ) (!  (=> (and (or (not (= $o@@83 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@83) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@83) $f@@46) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@83) $f@@46)))
 :qid |unknown.0:0|
 :skolemid |1665|
...
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@104 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@104 null)) (not true)) (and ($Is refType this@@104 Tclass._module.AtomicCounter) ($IsAlloc refType this@@104 Tclass._module.AtomicCounter $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@84 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@84 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@84) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@84) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@84) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |1672|
...
(assert (forall (($h0@@39 T@U) ($h1@@39 T@U) (this@@105 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@39) ($IsGoodHeap $h1@@39)) (and (or (not (= this@@105 null)) (not true)) (and ($Is refType this@@105 Tclass._module.AtomicCounter) ($IsAlloc refType this@@105 Tclass._module.AtomicCounter $h0@@39)))) (and ($IsHeapAnchor $h0@@39) ($HeapSucc $h0@@39 $h1@@39))) (=> (forall (($o@@85 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@85 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@85) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@39 $o@@85) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@39 $o@@85) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |1679|
...
(assert (forall (($h0@@40 T@U) ($h1@@40 T@U) (this@@106 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@40) ($IsGoodHeap $h1@@40)) (and (or (not (= this@@106 null)) (not true)) (and ($Is refType this@@106 Tclass._module.Remaining) ($IsAlloc refType this@@106 Tclass._module.Remaining $h0@@40)))) (and ($IsHeapAnchor $h0@@40) ($HeapSucc $h0@@40 $h1@@40))) (=> (forall (($o@@86 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@86 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@86) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@40 $o@@86) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@40 $o@@86) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |1903|
...
(assert (forall (($h0@@41 T@U) ($h1@@41 T@U) (this@@107 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@41) ($IsGoodHeap $h1@@41)) (and (or (not (= this@@107 null)) (not true)) (and ($Is refType this@@107 Tclass._module.Remaining) ($IsAlloc refType this@@107 Tclass._module.Remaining $h0@@41)))) (and ($IsHeapAnchor $h0@@41) ($HeapSucc $h0@@41 $h1@@41))) (=> (forall (($o@@87 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@87 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@87) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@41 $o@@87) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@41 $o@@87) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |1910|
...
(assert (forall (($h0@@42 T@U) ($h1@@42 T@U) (this@@108 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@42) ($IsGoodHeap $h1@@42)) (and (or (not (= this@@108 null)) (not true)) (and ($Is refType this@@108 Tclass._module.Remaining) ($IsAlloc refType this@@108 Tclass._module.Remaining $h0@@42)))) (and ($IsHeapAnchor $h0@@42) ($HeapSucc $h0@@42 $h1@@42))) (=> (forall (($o@@88 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@42 $o@@88) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@42 $o@@88) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |1917|
...
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@109 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@109 null)) (not true)) (and ($Is refType this@@109 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@109 Tclass._module.IncrementerMethod $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@89 T@U) ($f@@52 T@U) ) (!  (=> (and (or (not (= $o@@89 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@89) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@89) $f@@52) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@89) $f@@52)))
 :qid |unknown.0:0|
 :skolemid |2151|
...
(assert (forall (($h0@@44 T@U) ($h1@@44 T@U) (this@@110 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@44) ($IsGoodHeap $h1@@44)) (and (or (not (= this@@110 null)) (not true)) (and ($Is refType this@@110 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@110 Tclass._module.IncrementerMethod $h0@@44)))) (and ($IsHeapAnchor $h0@@44) ($HeapSucc $h0@@44 $h1@@44))) (=> (forall (($o@@90 T@U) ($f@@53 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@44 $o@@90) $f@@53) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@44 $o@@90) $f@@53)))
 :qid |unknown.0:0|
 :skolemid |2158|
...
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@111 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@111 null)) (not true)) (and ($Is refType this@@111 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@111 Tclass._module.IncrementerMethod $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@91 T@U) ($f@@54 T@U) ) (!  (=> (and (or (not (= $o@@91 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@91) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@91) $f@@54) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@91) $f@@54)))
 :qid |unknown.0:0|
 :skolemid |2165|
...
(set-info :boogie-vc-id OverrideCheck$$_module.IncrementerMethod.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon0_correct  (=> (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@77 this@@124) (or (_module.Object.baseInv $Heap@@77 this@@124) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType this@@124))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@77 this@@124) (or (_module.Object.baseInv $Heap@@77 this@@124) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType this@@124)))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@77 this@@124) (or (_module.Object.baseInv $Heap@@77 this@@124) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#0@@9| T@U) ) (!  (=> (and ($Is refType |o#0@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#0@@9|))) (and (= (_module.Object.universe |o#0@@9|) (_module.Object.universe this@@124)) (or (not (= |o#0@@9| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2190|
 :pattern ( (_module.Object.universe |o#0@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#0@@9|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| $Heap@@77 this@@124) (or (_module.Object.baseInv $Heap@@77 this@@124) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#0@@10|))) (and (= (_module.Object.universe |o#0@@10|) (_module.Object.universe this@@124)) (or (not (= |o#0@@10| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2190|
 :pattern ( (_module.Object.universe |o#0@@10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#0@@10|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalInv $Heap@@77 (_module.Object.universe this@@124)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#1@@3|))) (and (= (_module.Object.universe |o#1@@3|) (_module.Object.universe this@@124)) (or (not (= |o#1@@3| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2192|
 :pattern ( (_module.Object.universe |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#1@@3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalInv $Heap@@77 (_module.Object.universe this@@124)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#1@@4|))) (and (= (_module.Object.universe |o#1@@4|) (_module.Object.universe this@@124)) (or (not (= |o#1@@4| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2192|
 :pattern ( (_module.Object.universe |o#1@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#1@@4|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#2|))) (_module.Object.inv $Heap@@77 |o#2|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2194|
 :pattern ( (_module.Object.inv $Heap@@77 |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#2|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#2@@0|))) (_module.Object.inv $Heap@@77 |o#2@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2194|
 :pattern ( (_module.Object.inv $Heap@@77 |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@124) (or (_module.Object.baseInv current$Heap this@@124) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType this@@124))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@124) (or (_module.Object.baseInv current$Heap this@@124) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType this@@124)))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@124) (or (_module.Object.baseInv current$Heap this@@124) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@124)) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#3|))) (and (= (_module.Object.universe |o#3|) (_module.Object.universe this@@124)) (or (not (= |o#3| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2196|
 :pattern ( (_module.Object.universe |o#3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#3|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Object.baseInv#canCall| current$Heap this@@124) (or (_module.Object.baseInv current$Heap this@@124) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@124)) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#3@@0|))) (and (= (_module.Object.universe |o#3@@0|) (_module.Object.universe this@@124)) (or (not (= |o#3@@0| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2196|
 :pattern ( (_module.Object.universe |o#3@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#3@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (forall (($o@@103 T@U) ($f@@55 T@U) ) (!  (=> (or (not (= $o@@103 null)) (not true)) (=> (= $o@@103 this@@124) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@103) $f@@55) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 $o@@103) $f@@55))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |2198|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@103) $f@@55))
))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (forall (($o@@104 T@U) ($f@@56 T@U) ) (!  (=> (or (not (= $o@@104 null)) (not true)) (=> (= $o@@104 this@@124) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@104) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 $o@@104) $f@@56))))
 :qid |_07CounterThreadOwnershipdfy.259:8|
 :skolemid |2198|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@104) $f@@56))
)))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124)) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#4|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#4|)))) (not ($IsAllocBox ($Box refType |o#4|) Tclass._module.Object $Heap@@77)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2199|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#4|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#4|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124)) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#4@@0|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#4@@0|)))) (not ($IsAllocBox ($Box refType |o#4@@0|) Tclass._module.Object $Heap@@77)))
 :qid |_07CounterThreadOwnershipdfy.57:16|
 :skolemid |2199|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#4@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124)) (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#5|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#5|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#5|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |2200|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#5|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#5|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124)) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#5@@0|))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#5@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#5@@0|) _module.OwnedObject.nonvolatileVersion)))))
 :qid |_07CounterThreadOwnershipdfy.59:16|
 :skolemid |2200|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#5@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#5@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#6|))) (and (= (_module.Object.universe |o#6|) (_module.Object.universe this@@124)) (or (not (= |o#6| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2203|
 :pattern ( (_module.Object.universe |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#6|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#6@@0|))) (and (= (_module.Object.universe |o#6@@0|) (_module.Object.universe this@@124)) (or (not (= |o#6@@0| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2203|
 :pattern ( (_module.Object.universe |o#6@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#6@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@124)) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#7|))) (and (= (_module.Object.universe |o#7|) (_module.Object.universe this@@124)) (or (not (= |o#7| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2205|
 :pattern ( (_module.Object.universe |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#7|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@124)) (forall ((|o#7@@0| T@U) ) (!  (=> (and ($Is refType |o#7@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#7@@0|))) (and (= (_module.Object.universe |o#7@@0|) (_module.Object.universe this@@124)) (or (not (= |o#7@@0| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2205|
 :pattern ( (_module.Object.universe |o#7@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#7@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#8| T@U) ) (!  (=> (and ($Is refType |o#8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#8|))) (_module.Object.transitiveInv2 $Heap@@77 current$Heap |o#8|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |2207|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@77 current$Heap |o#8|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#8|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#8@@0| T@U) ) (!  (=> (and ($Is refType |o#8@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#8@@0|))) (_module.Object.transitiveInv2 $Heap@@77 current$Heap |o#8@@0|))
 :qid |_07CounterThreadOwnershipdfy.73:16|
 :skolemid |2207|
 :pattern ( (_module.Object.transitiveInv2 $Heap@@77 current$Heap |o#8@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#8@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#9|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@77)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#9|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |2208|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#9|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (or (_module.Universe.legalTransitionsSequence $Heap@@77 current$Heap (_module.Object.universe this@@124) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|))) (forall ((|o#9@@0| T@U) ) (!  (=> (and ($Is refType |o#9@@0| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#9@@0|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@5|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9@@0|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9@@0|) _module.OwnedObject.owner) Tclass._module.Object $Heap@@77)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9@@0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |o#9@@0|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_07CounterThreadOwnershipdfy.76:16|
 :skolemid |2208|
 ...
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9@@0|) _module.OwnedObject.nonvolatileVersion)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 |o#9@@0|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#9@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalInv $Heap@@77 (_module.Object.universe this@@124)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#10|))) (and (= (_module.Object.universe |o#10|) (_module.Object.universe this@@124)) (or (not (= |o#10| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2211|
 :pattern ( (_module.Object.universe |o#10|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#10|)))
))))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalInv $Heap@@77 (_module.Object.universe this@@124)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#10@@0| T@U) ) (!  (=> (and ($Is refType |o#10@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#10@@0|))) (and (= (_module.Object.universe |o#10@@0|) (_module.Object.universe this@@124)) (or (not (= |o#10@@0| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2211|
 :pattern ( (_module.Object.universe |o#10@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#10@@0|)))
)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#11|))) (_module.Object.inv $Heap@@77 |o#11|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2213|
 :pattern ( (_module.Object.inv $Heap@@77 |o#11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#11|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.globalInv#canCall| $Heap@@77 (_module.Object.universe this@@124)) (or (_module.Universe.globalInv $Heap@@77 (_module.Object.universe this@@124)) (forall ((|o#11@@0| T@U) ) (!  (=> (and ($Is refType |o#11@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#11@@0|))) (_module.Object.inv $Heap@@77 |o#11@@0|))
 :qid |_07CounterThreadOwnershipdfy.39:32|
 :skolemid |2213|
 :pattern ( (_module.Object.inv $Heap@@77 |o#11@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#11@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@124)) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#12|))) (and (= (_module.Object.universe |o#12|) (_module.Object.universe this@@124)) (or (not (= |o#12| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2215|
 :pattern ( (_module.Object.universe |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#12|)))
))))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (=> (|_module.Universe.globalBaseInv#canCall| current$Heap (_module.Object.universe this@@124)) (or (_module.Universe.globalBaseInv current$Heap (_module.Object.universe this@@124)) (forall ((|o#12@@0| T@U) ) (!  (=> (and ($Is refType |o#12@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#12@@0|))) (and (= (_module.Object.universe |o#12@@0|) (_module.Object.universe this@@124)) (or (not (= |o#12@@0| (_module.Object.universe this@@124))) (not true))))
 :qid |_07CounterThreadOwnershipdfy.34:12|
 :skolemid |2215|
 :pattern ( (_module.Object.universe |o#12@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#12@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#13|))) (and (or (forall (($o@@105 T@U) ($f@@57 T@U) ) (!  (=> (or (not (= $o@@105 null)) (not true)) (=> (= $o@@105 |o#13|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@105) $f@@57) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 $o@@105) $f@@57))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |2217|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@105) $f@@57))
)) (_module.Object.inv current$Heap |o#13|)) (or (forall (($o@@106 T@U) ($f@@58 T@U) ) (!  (=> (or (not (= $o@@106 null)) (not true)) (=> (= $o@@106 |o#13|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@106) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 $o@@106) $f@@58))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |2218|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@106) $f@@58))
)) (_module.Object.inv2 $Heap@@77 current$Heap |o#13|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |2219|
 :pattern ( (_module.Object.inv2 $Heap@@77 current$Heap |o#13|))
 :pattern ( (_module.Object.inv current$Heap |o#13|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#13|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (forall ((|o#13@@0| T@U) ) (!  (=> (and ($Is refType |o#13@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#13@@0|))) (and (or (forall (($o@@107 T@U) ($f@@59 T@U) ) (!  (=> (or (not (= $o@@107 null)) (not true)) (=> (= $o@@107 |o#13@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@107) $f@@59) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 $o@@107) $f@@59))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |2217|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@107) $f@@59))
)) (_module.Object.inv current$Heap |o#13@@0|)) (or (forall (($o@@108 T@U) ($f@@60 T@U) ) (!  (=> (or (not (= $o@@108 null)) (not true)) (=> (= $o@@108 |o#13@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@108) $f@@60) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 $o@@108) $f@@60))))
 :qid |_07CounterThreadOwnershipdfy.90:49|
 :skolemid |2218|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@108) $f@@60))
)) (_module.Object.inv2 $Heap@@77 current$Heap |o#13@@0|))))
 :qid |_07CounterThreadOwnershipdfy.90:16|
 :skolemid |2219|
 :pattern ( (_module.Object.inv2 $Heap@@77 current$Heap |o#13@@0|))
 :pattern ( (_module.Object.inv current$Heap |o#13@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#13@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (forall ((|o#14| T@U) ) (!  (=> (and ($Is refType |o#14| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#14|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#14|))))) (_module.Object.inv current$Heap |o#14|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |2220|
 :pattern ( (_module.Object.inv current$Heap |o#14|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#14|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#14|)))
))))))) (=> (=> (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@77 current$Heap this@@124 |running#0@@5|) (or (_module.Object.goodPreAndLegalChanges $Heap@@77 current$Heap this@@124 |running#0@@5|) (=> (|_module.Universe.legalTransition#canCall| $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (or (_module.Universe.legalTransition $Heap@@77 current$Heap (_module.Object.universe this@@124) |running#0@@5|) (forall ((|o#14@@0| T@U) ) (!  (=> (and ($Is refType |o#14@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#14@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#14@@0|))))) (_module.Object.inv current$Heap |o#14@@0|))
 :qid |_07CounterThreadOwnershipdfy.92:16|
 :skolemid |2220|
 :pattern ( (_module.Object.inv current$Heap |o#14@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@77 (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#14@@0|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@124)) _module.Universe.content)) ($Box refType |o#14@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true)))) (=> (=> (or (not (= |running#0@@5| null)) (not true)) (or (not (= |running#0@@5| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@109 T@U) ($f@@61 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.693:18|
 :skolemid |2226|
))) (=> (forall (($o@@110 T@U) ($f@@62 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.693:18|
 :skolemid |2226|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@111 T@U) ($f@@63 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.693:18|
 :skolemid |2227|
))) (=> (forall (($o@@112 T@U) ($f@@64 T@U) ) (! true
 :qid |_07CounterThreadOwnershipdfy.693:18|
 :skolemid |2227|
)) (=> (and (_module.OwnedObject.inv2 $Heap@@77 current$Heap this@@124) (_module.OwnedObject.inv current$Heap this@@124)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Object.inv2 $Heap@@77 current$Heap this@@124)) (=> (_module.Object.inv2 $Heap@@77 current$Heap this@@124) (=> (= (ControlFlow 0 2) (- 0 1)) (_module.Object.inv current$Heap this@@124))))))))))))))))))))))))))))))))))))))))))))))))))))
