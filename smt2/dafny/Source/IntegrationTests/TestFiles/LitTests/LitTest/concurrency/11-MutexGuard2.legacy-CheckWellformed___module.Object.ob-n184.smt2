...
(assert (forall (($h0@@18 T@U) ($h1@@18 T@U) (this@@57 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@57 null)) (not true)) ($Is refType this@@57 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@30 T@U) ($f@@19 T@U) )  (=> (and (or (not (= $o@@30 null)) (not true)) (= $o@@30 this@@57)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@30) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@30) $f@@19)))) (= (_module.Object.triggerAxioms $h0@@18 this@@57) (_module.Object.triggerAxioms $h1@@18 this@@57))))
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.Object.triggerAxioms $h1@@18 this@@57))
)))
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@58 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@58 null)) (not true)) ($Is refType this@@58 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@31 T@U) ($f@@20 T@U) )  (=> (and (or (not (= $o@@31 null)) (not true)) (or (= $o@@31 this@@58) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 this@@58) _module.Universe.content)) ($Box refType $o@@31)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@31) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@31) $f@@20)))) (= (_module.Universe.globalBaseInv $h0@@19 this@@58) (_module.Universe.globalBaseInv $h1@@19 this@@58))))
