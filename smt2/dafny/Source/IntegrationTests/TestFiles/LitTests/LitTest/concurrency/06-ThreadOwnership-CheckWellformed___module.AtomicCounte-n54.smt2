...
(assert (forall (($h@@8 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass._module.AtomicCounter?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@9) _module.AtomicCounter.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1452|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@9) _module.AtomicCounter.value)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.AtomicCounter.userInv2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (=> (_module.AtomicCounter.userInv2 previous$Heap current$Heap this@@4) (=> (|_module.AtomicCounter.localUserInv2#canCall| previous$Heap current$Heap this@@4) (or (_module.AtomicCounter.localUserInv2 previous$Heap current$Heap this@@4) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap this@@4) _module.AtomicCounter.value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@4) _module.AtomicCounter.value))))))))))
(let ((anon8_correct  (=> (= (_module.AtomicCounter.userInv2 $Heap@@2 current$Heap this@@4)  (and true (_module.AtomicCounter.localUserInv2 $Heap@@2 current$Heap this@@4))) (=> (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.AtomicCounter.localUserInv2#canCall| $Heap@@2 current$Heap this@@4)) ($Is boolType (bool_2_U (_module.AtomicCounter.userInv2 $Heap@@2 current$Heap this@@4)) TBool)) (and (=> (= (ControlFlow 0 9) (- 0 10)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 9) 8) GeneratedUnifiedExit_correct)))))))
(let ((anon12_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 13) 9)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@4) Tclass._module.AtomicCounter? current$Heap)) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType this@@4 Tclass._module.AtomicCounter $Heap@@2)) (=> ($IsAlloc refType this@@4 Tclass._module.AtomicCounter $Heap@@2) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@14 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@14) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@14) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@2)))
 :qid |_06ThreadOwnershipdfy.314:8|
 :skolemid |1504|
))) (|_module.AtomicCounter.localUserInv2#canCall| $Heap@@2 current$Heap this@@4)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 11) 9))) anon8_correct))))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (and (=> (_module.AtomicCounter.userInv2 $Heap@@2 current$Heap this@@4) (_module.AtomicCounter.localUserInv2 $Heap@@2 current$Heap this@@4)) (= (ControlFlow 0 6) 1)) anon5_correct)))
(let ((anon11_Then_correct  (=> ($IsAllocBox ($Box refType this@@4) Tclass._module.AtomicCounter? current$Heap) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType this@@4 Tclass._module.AtomicCounter $Heap@@2)) (=> ($IsAlloc refType this@@4 Tclass._module.AtomicCounter $Heap@@2) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (= this@@4 this@@4) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@4 this@@4) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (or (= this@@4 this@@4) (|_module.AtomicCounter.userInv2#canCall| $Heap@@2 current$Heap this@@4)) (=> (and (_module.AtomicCounter.userInv2 $Heap@@2 current$Heap this@@4) ($IsAllocBox ($Box refType this@@4) Tclass._module.AtomicCounter? current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@4 Tclass._module.AtomicCounter $Heap@@2)) (=> ($IsAlloc refType this@@4 Tclass._module.AtomicCounter $Heap@@2) (=> (|_module.AtomicCounter.localUserInv2#canCall| $Heap@@2 current$Heap this@@4) (=> (and (_module.AtomicCounter.localUserInv2 $Heap@@2 current$Heap this@@4) (= (ControlFlow 0 2) 1)) anon5_correct)))))))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null current$Heap alloc current$Heap alloc)) (and (and (and (=> (= (ControlFlow 0 14) 11) anon12_Then_correct) (=> (= (ControlFlow 0 14) 13) anon12_Else_correct)) (=> (= (ControlFlow 0 14) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 14) 6) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.AtomicCounter) ($IsAlloc refType this@@4 Tclass._module.AtomicCounter previous$Heap))) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@2) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 15) 14))) anon0_correct))))
