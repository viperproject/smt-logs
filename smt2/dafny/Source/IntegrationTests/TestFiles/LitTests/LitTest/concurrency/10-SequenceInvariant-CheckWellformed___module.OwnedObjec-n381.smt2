...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@5 this@@5) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@5) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.OwnedObject) ($IsAlloc refType this@@5 Tclass._module.OwnedObject $Heap@@5)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@5 this@@5) (=> (_module.OwnedObject.localInv $Heap@@5 this@@5) (|_module.OwnedObject.userInv#canCall| $Heap@@5 this@@5))) (= (_module.OwnedObject.inv $Heap@@5 this@@5)  (and (_module.OwnedObject.localInv $Heap@@5 this@@5) (_module.OwnedObject.userInv $Heap@@5 this@@5)))))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1473|
 :pattern ( (_module.OwnedObject.inv $Heap@@5 this@@5) ($IsGoodHeap $Heap@@5))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@6 this@@6) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Universe) ($IsAlloc refType this@@6 Tclass._module.Universe $Heap@@6)))))) (and (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#0|)) (=> (= (_module.Object.universe |o#0|) this@@6) (=> (or (not (= |o#0| this@@6)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@6 |o#0|) (=> (_module.Object.baseFieldsInv $Heap@@6 |o#0|) (|_module.Object.triggerAxioms#canCall| $Heap@@6 |o#0|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@6 |o#0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@6 |o#0|))
 :pattern ( (_module.Object.universe |o#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#0|)))
)) (= (_module.Universe.globalBaseInv $Heap@@6 this@@6) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#0@@0|))) (and (and (and (= (_module.Object.universe |o#0@@0|) this@@6) (or (not (= |o#0@@0| this@@6)) (not true))) (_module.Object.baseFieldsInv $Heap@@6 |o#0@@0|)) (_module.Object.triggerAxioms $Heap@@6 |o#0@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#0@@0|)))
)))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@7 this@@7) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Object) ($IsAlloc refType this@@7 Tclass._module.Object $Heap@@7)))))) (_module.Object.triggerAxioms $Heap@@7 this@@7))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1064|
 :pattern ( (_module.Object.triggerAxioms $Heap@@7 this@@7))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@9 this@@9) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.OwnedObject) ($IsAlloc refType this@@9 Tclass._module.OwnedObject $Heap@@9)))))) (=> (_module.OwnedObject.localInv $Heap@@9 this@@9) (_module.Object.objectGlobalBaseInv $Heap@@9 this@@9)))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1458|
 :pattern ( (_module.OwnedObject.localInv $Heap@@9 this@@9))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@10 this@@10) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.OwnedObject) ($IsAlloc refType this@@10 Tclass._module.OwnedObject $Heap@@10)))))) (=> (_module.OwnedObject.inv $Heap@@10 this@@10) (_module.OwnedObject.localInv $Heap@@10 this@@10)))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1471|
 :pattern ( (_module.OwnedObject.inv $Heap@@10 this@@10))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@11 this@@11) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Object) ($IsAlloc refType this@@11 Tclass._module.Object $Heap@@11)))))) (= (_module.Object.triggerAxioms $Heap@@11 this@@11)  (and (or ($Is refType this@@11 Tclass._module.OwnedObject) ($Is refType this@@11 Tclass._module.Thread)) (not (and ($Is refType this@@11 Tclass._module.OwnedObject) ($Is refType this@@11 Tclass._module.Thread))))))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1066|
 :pattern ( (_module.Object.triggerAxioms $Heap@@11 this@@11) ($IsGoodHeap $Heap@@11))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.OwnedObject.inv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (_module.OwnedObject.inv $Heap@@12 this@@12) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12) (or (_module.OwnedObject.localInv $Heap@@12 this@@12) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@12 this@@12) (or (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType this@@12)))))))) (=> (=> (_module.OwnedObject.inv $Heap@@12 this@@12) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12) (or (_module.OwnedObject.localInv $Heap@@12 this@@12) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@12 this@@12) (or (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType this@@12))))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (_module.OwnedObject.inv $Heap@@12 this@@12) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12) (or (_module.OwnedObject.localInv $Heap@@12 this@@12) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@12 this@@12) (or (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12) (_module.Object.baseFieldsInv $Heap@@12 this@@12))))))) (=> (=> (_module.OwnedObject.inv $Heap@@12 this@@12) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12) (or (_module.OwnedObject.localInv $Heap@@12 this@@12) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@12 this@@12) (or (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12) (_module.Object.baseFieldsInv $Heap@@12 this@@12)))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (_module.OwnedObject.inv $Heap@@12 this@@12) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12) (or (_module.OwnedObject.localInv $Heap@@12 this@@12) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@12 this@@12) (or (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@12 (_module.Object.universe this@@12)) (or (_module.Universe.globalBaseInv $Heap@@12 (_module.Object.universe this@@12)) (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType |o#0@@1|))) (and (and (and (= (_module.Object.universe |o#0@@1|) (_module.Object.universe this@@12)) (or (not (= |o#0@@1| (_module.Object.universe this@@12))) (not true))) (_module.Object.baseFieldsInv $Heap@@12 |o#0@@1|)) (_module.Object.triggerAxioms $Heap@@12 |o#0@@1|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |1475|
 :pattern ( (_module.Object.triggerAxioms $Heap@@12 |o#0@@1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@12 |o#0@@1|))
 :pattern ( (_module.Object.universe |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType |o#0@@1|)))
)))))))))) (=> (=> (_module.OwnedObject.inv $Heap@@12 this@@12) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12) (or (_module.OwnedObject.localInv $Heap@@12 this@@12) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@12 this@@12) (or (_module.Object.objectGlobalBaseInv $Heap@@12 this@@12) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@12 (_module.Object.universe this@@12)) (or (_module.Universe.globalBaseInv $Heap@@12 (_module.Object.universe this@@12)) (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType |o#0@@2|))) (and (and (and (= (_module.Object.universe |o#0@@2|) (_module.Object.universe this@@12)) (or (not (= |o#0@@2| (_module.Object.universe this@@12))) (not true))) (_module.Object.baseFieldsInv $Heap@@12 |o#0@@2|)) (_module.Object.triggerAxioms $Heap@@12 |o#0@@2|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |1475|
 :pattern ( (_module.Object.triggerAxioms $Heap@@12 |o#0@@2|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@12 |o#0@@2|))
 :pattern ( (_module.Object.universe |o#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Object.universe this@@12)) _module.Universe.content)) ($Box refType |o#0@@2|)))
))))))))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.OwnedObject.inv $Heap@@12 this@@12) (=> (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12) (or (_module.OwnedObject.localInv $Heap@@12 this@@12) (_module.OwnedObject.localUserInv $Heap@@12 this@@12)))))))))))))
(let ((anon8_correct  (=> (= (_module.OwnedObject.inv $Heap@@12 this@@12)  (and (_module.OwnedObject.localInv $Heap@@12 this@@12) (_module.OwnedObject.userInv $Heap@@12 this@@12))) (=> (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12) (=> (_module.OwnedObject.localInv $Heap@@12 this@@12) (|_module.OwnedObject.userInv#canCall| $Heap@@12 this@@12))) ($Is boolType (bool_2_U (_module.OwnedObject.inv $Heap@@12 this@@12)) TBool)) (and (=> (= (ControlFlow 0 10) (- 0 12)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 10) 6) GeneratedUnifiedExit_correct)))))))))
(let ((anon12_Else_correct  (=> (not (_module.OwnedObject.localInv $Heap@@12 this@@12)) (=> (and (= |b$reqreads#1@1| true) (= (ControlFlow 0 14) 10)) anon8_correct))))
(let ((anon12_Then_correct  (=> (and (_module.OwnedObject.localInv $Heap@@12 this@@12) ($IsAllocBox ($Box refType this@@12) Tclass._module.OwnedObject? $Heap@@12)) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_10SequenceInvariantdfy.331:8|
 :skolemid |1478|
))) (|_module.OwnedObject.userInv#canCall| $Heap@@12 this@@12)) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 13) 10))) anon8_correct))))
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@12) Tclass._module.OwnedObject? $Heap@@12) (=> (and (= |b$reqreads#0@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@19) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@19) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_10SequenceInvariantdfy.330:8|
 :skolemid |1477|
))) (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12)) (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct))))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (and (=> (_module.OwnedObject.inv $Heap@@12 this@@12) (_module.OwnedObject.localInv $Heap@@12 this@@12)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon11_Then_correct  (=> ($IsAllocBox ($Box refType this@@12) Tclass._module.OwnedObject? $Heap@@12) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@12 this@@12) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@12 this@@12) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@12 this@@12) (|_module.OwnedObject.inv#canCall| $Heap@@12 this@@12)) (_module.OwnedObject.inv $Heap@@12 this@@12)) (=> (and (and ($IsAllocBox ($Box refType this@@12) Tclass._module.OwnedObject? $Heap@@12) (|_module.OwnedObject.localInv#canCall| $Heap@@12 this@@12)) (and (_module.OwnedObject.localInv $Heap@@12 this@@12) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@12 alloc $Heap@@12 alloc)) (and (and (=> (= (ControlFlow 0 16) 15) anon10_Else_correct) (=> (= (ControlFlow 0 16) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 16) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@12) ($IsHeapAnchor $Heap@@12)) (=> (and (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.OwnedObject) ($IsAlloc refType this@@12 Tclass._module.OwnedObject $Heap@@12))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
