...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split177)
...
)))))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@132 $Heap@15 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)))))))) (or (_module.Universe.legalTransitionsSequence $Heap@@132 $Heap@15 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@132 $Heap@15 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@132 $Heap@15 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content))))))))))))
