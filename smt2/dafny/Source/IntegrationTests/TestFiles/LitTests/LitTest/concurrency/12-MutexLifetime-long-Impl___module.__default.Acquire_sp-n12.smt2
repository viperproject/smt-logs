...
))))) (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call5formal@this@0) alloc)))) (forall (($o@@151 T@U) ) (!  (=> (and (or (not (= $o@@151 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@151) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@151) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@151)) (or (= $o@@151 |universe#0|) (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@151)))))
...
)))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) ($Box refType call5formal@this@0)) ($Box refType |mutex#0|)) ($Box refType |mutexScope#0|)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call5formal@this@0) _module.Lifetime.owner)) |running#0@@3|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |mutexScope#0|) _module.Lifetime.owner)) |running#0@@3|))))) (and (and (and (and (or (not (= call5formal@this@0 |mutexScope#0|)) (not true)) (=> (|_module.Universe.outlives#canCall| $Heap@6 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (or (_module.Universe.outlives ($LS $LZ) $Heap@6 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |mutexScope#0|) _module.Lifetime.mightPointTo)) ($Box refType (_module.OwnedObject.lifetime |mutex#0|))) (exists ((|x#0@@10| T@U) ) (!  (and (and ($Is refType |x#0@@10| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 |universe#0|) _module.Universe.content)) ($Box refType |x#0@@10|))) (_module.Universe.outlivesThrough ($LS ($LS $LZ)) $Heap@6 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |x#0@@10| |mutexScope#0|))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |3756|
...
)))) (and (and (forall (($o@@162 T@U) ) (!  (=> (and (or (not (= $o@@162 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@162) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@162) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@162)) (or (= $o@@162 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 |universe#0|) _module.Universe.content)) ($Box refType $o@@162)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 $o@@162))
)) ($HeapSucc $Heap@9 $Heap@10)) (and ($IsAllocBox ($Box refType |scope#0|) Tclass._module.Lifetime? $Heap@10) (|_module.Lifetime.deallocable#canCall| $Heap@10 |scope#0|))))) (and (and (and (and (|_module.Lifetime.deallocable#canCall| $Heap@10 |scope#0|) (_module.Lifetime.deallocable $Heap@10 |scope#0|)) (and (or (not (= |scope#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |scope#0| _module.Lifetime.owner)))) (and (and (= $Heap@11 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@10 |scope#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |scope#0|) _module.Lifetime.owner ($Box refType null)))) ($IsGoodHeap $Heap@11)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@10)))) (and (and (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content))) (forall ((|l#1@@9| T@U) ) (!  (=> (and ($Is refType |l#1@@9| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |universe#0|) _module.Universe.content)) ($Box refType |l#1@@9|))) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#1@@9|) _module.Lifetime.mightPointFrom)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |l#1@@9|) _module.Lifetime.mightPointFrom))) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@10 |l#1@@9|) _module.Lifetime.mightPointTo)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |l#1@@9|) _module.Lifetime.mightPointTo)))))
 :qid |_12MutexLifetimelongdfy.201:21|
 :skolemid |1650|
...
))))) (and ($IsGoodHeap $Heap@13) ($IsHeapAnchor $Heap@13))) (and (and (|_module.Universe.globalInv#canCall| $Heap@12 |universe#0|) (=> (_module.Universe.globalInv $Heap@12 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@10 $Heap@12 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@12 |universe#0|) (and (_module.Universe.globalInv $Heap@12 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@12 |universe#0|) (forall ((|o#10@@1| T@U) ) (!  (=> (and ($Is refType |o#10@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@1|))) (_module.Object.inv $Heap@12 |o#10@@1|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |1379|
...
))))))) (=> (=> (|_module.Universe.globalInv#canCall| $Heap@13 |universe#0|) (or (_module.Universe.globalInv $Heap@13 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@13 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@13 |universe#0|) (forall ((|o#0@@28| T@U) ) (!  (=> (and ($Is refType |o#0@@28| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@28|))) (and (and (and (= (_module.Object.universe |o#0@@28|) |universe#0|) (or (not (= |o#0@@28| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@13 |o#0@@28|)) (_module.Object.triggerAxioms $Heap@13 |o#0@@28|)))
 :qid |_12MutexLifetimelongdfy.18:16|
 :skolemid |753|
 :pattern ( (_module.Object.triggerAxioms $Heap@13 |o#0@@28|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@13 |o#0@@28|))
 :pattern ( (_module.Object.universe |o#0@@28|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@28|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.globalInv#canCall| $Heap@13 |universe#0|) (or (_module.Universe.globalInv $Heap@13 |universe#0|) (forall ((|o#1@@14| T@U) ) (!  (=> (and ($Is refType |o#1@@14| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@14|))) (_module.Object.inv $Heap@13 |o#1@@14|))
 :qid |_12MutexLifetimelongdfy.24:32|
 :skolemid |755|
...
))) (and (forall (($o@@169 T@U) ) (!  (=> (and (or (not (= $o@@169 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@169) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@169) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@169)) (or (= $o@@169 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType $o@@169)))))
 :qid |_12MutexLifetimelongdfy.279:8|
 :skolemid |780|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 $o@@169))
)) ($HeapSucc $Heap@13 $Heap@14)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |universe#0| null)) (not true))) (=> (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@14) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@133)))))))))))))))))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
