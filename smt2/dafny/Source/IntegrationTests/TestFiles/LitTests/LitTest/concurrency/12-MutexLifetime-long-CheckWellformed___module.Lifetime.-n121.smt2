...
(declare-fun |lambda#193| (T@U T@U T@U T@U T@U T@U T@U) T@U)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#193| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) (or (and (= $o@@3 |l#3|) (= $f |l#4|)) (and (= $o@@3 |l#5|) (= $f |l#6|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3872|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#193| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) $o@@3 $f))
)))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#193| null $Heap@@0 alloc this@@0 _module.Lifetime.mightPointFrom this@@0 _module.Lifetime.elements)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= this@@0 null)) (not true))) (=> (or (not (= this@@0 null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= this@@0 null)) (not true))) (=> (or (not (= this@@0 null)) (not true)) (and (=> (= (ControlFlow 0 8) 1) anon7_Then_correct) (=> (= (ControlFlow 0 8) 7) anon7_Else_correct)))))))))
