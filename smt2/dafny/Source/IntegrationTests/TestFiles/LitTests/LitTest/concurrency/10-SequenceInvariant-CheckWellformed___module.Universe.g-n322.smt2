...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@3 this@@3) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Universe) ($IsAlloc refType this@@3 Tclass._module.Universe $Heap@@3)))))) (and (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Universe.content)) ($Box refType |o#0|)) (=> (= (_module.Object.universe |o#0|) this@@3) (=> (or (not (= |o#0| this@@3)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@3 |o#0|) (=> (_module.Object.baseFieldsInv $Heap@@3 |o#0|) (|_module.Object.triggerAxioms#canCall| $Heap@@3 |o#0|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@3 |o#0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@3 |o#0|))
 :pattern ( (_module.Object.universe |o#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Universe.content)) ($Box refType |o#0|)))
)) (= (_module.Universe.globalBaseInv $Heap@@3 this@@3) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Universe.content)) ($Box refType |o#0@@0|))) (and (and (and (= (_module.Object.universe |o#0@@0|) this@@3) (or (not (= |o#0@@0| this@@3)) (not true))) (_module.Object.baseFieldsInv $Heap@@3 |o#0@@0|)) (_module.Object.triggerAxioms $Heap@@3 |o#0@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Universe.content)) ($Box refType |o#0@@0|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@3 this@@3) ($IsGoodHeap $Heap@@3))
))))
...
)) ($Is boolType (bool_2_U (_module.Universe.globalBaseInv $Heap@@6 this@@6)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#2@2|) (=> |b$reqreads#2@2| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#3@1|)))))))))
(let ((anon18_Else_correct  (=> (not (and (and (= (_module.Object.universe |o#1@0|) this@@6) (or (not (= |o#1@0| this@@6)) (not true))) (_module.Object.baseFieldsInv $Heap@@6 |o#1@0|))) (=> (and (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@2| |b$reqreads#2@1|)) (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 10) 3))) anon11_correct))))
(let ((anon18_Then_correct  (=> (and (and (= (_module.Object.universe |o#1@0|) this@@6) (or (not (= |o#1@0| this@@6)) (not true))) (_module.Object.baseFieldsInv $Heap@@6 |o#1@0|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@6) (=> (and (= |b$reqreads#3@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@18) alloc)))) (= $o@@18 |o#1@0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_10SequenceInvariantdfy.17:108|
 :skolemid |616|
))) (|_module.Object.triggerAxioms#canCall| $Heap@@6 |o#1@0|)) (=> (and (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= |b$reqreads#2@2| |b$reqreads#2@1|)) (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= (ControlFlow 0 8) 3))) anon11_correct))))))))
(let ((anon17_Else_correct  (=> (and (not (and (= (_module.Object.universe |o#1@0|) this@@6) (or (not (= |o#1@0| this@@6)) (not true)))) (= |b$reqreads#2@1| true)) (and (=> (= (ControlFlow 0 13) 8) anon18_Then_correct) (=> (= (ControlFlow 0 13) 10) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (and (= (_module.Object.universe |o#1@0|) this@@6) (or (not (= |o#1@0| this@@6)) (not true))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@6) (= |b$reqreads#2@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 $o@@19) alloc)))) (or (= $o@@19 |o#1@0|) (= $o@@19 (_module.Object.universe |o#1@0|)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_10SequenceInvariantdfy.17:87|
 :skolemid |615|
)))) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@6 |o#1@0|) (= |b$reqreads#2@1| |b$reqreads#2@0|))) (and (=> (= (ControlFlow 0 11) 8) anon18_Then_correct) (=> (= (ControlFlow 0 11) 10) anon18_Else_correct))))))))
(let ((anon16_Else_correct  (=> (or (not (= (_module.Object.universe |o#1@0|) this@@6)) (not true)) (and (=> (= (ControlFlow 0 15) 11) anon17_Then_correct) (=> (= (ControlFlow 0 15) 13) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (= (_module.Object.universe |o#1@0|) this@@6) (and (=> (= (ControlFlow 0 14) 11) anon17_Then_correct) (=> (= (ControlFlow 0 14) 13) anon17_Else_correct)))))
(let ((anon15_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)) ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (and (=> (= (ControlFlow 0 16) 14) anon16_Then_correct) (=> (= (ControlFlow 0 16) 15) anon16_Else_correct)))))))
...
(let ((anon14_Then_correct  (=> (and (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@6)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@6 _module.Universe.content)))) (and (=> (= (ControlFlow 0 18) 16) anon15_Then_correct) (=> (= (ControlFlow 0 18) 7) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (not (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@6))) (=> (and (and (= |b$reqreads#1@1| true) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 6) 3))) anon11_correct))))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@6 alloc this@@6 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@6) _module.Universe.content)))) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@6 _module.Universe.content)))) (and (=> (= (ControlFlow 0 19) (- 0 20)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (and (=> (= (ControlFlow 0 19) 1) anon13_Then_correct) (=> (= (ControlFlow 0 19) 18) anon14_Then_correct)) (=> (= (ControlFlow 0 19) 6) anon14_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@6) ($IsHeapAnchor $Heap@@6)) (=> (and (and (or (not (= this@@6 null)) (not true)) (and ($Is refType this@@6 Tclass._module.Universe) ($IsAlloc refType this@@6 Tclass._module.Universe $Heap@@6))) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 21) 19))) anon0_correct))))
