...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon8_correct  (=> (= (_module.Universe.globalInv $Heap@@2 this@@1)  (and (_module.Universe.globalBaseInv $Heap@@2 this@@1) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@1) _module.Universe.content)) ($Box refType |o#2|))) (_module.Object.inv $Heap@@2 |o#2|))
 :qid |_05RecInvariantCutdfy.25:31|
 :skolemid |513|
...
)))) (=> (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@@2 this@@1) (=> (_module.Universe.globalBaseInv $Heap@@2 this@@1) (forall ((|o#2@@0| T@U) ) (!  (=> ($Is refType |o#2@@0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@1) _module.Universe.content)) ($Box refType |o#2@@0|)) (|_module.Object.inv#canCall| $Heap@@2 |o#2@@0|)))
 :qid |_05RecInvariantCutdfy.25:31|
 :skolemid |514|
...
)))) ($Is boolType (bool_2_U (_module.Universe.globalInv $Heap@@2 this@@1)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@2|) (=> |b$reqreads#1@2| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@2|)))))))))
...
(let ((anon13_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@1) _module.Universe.content)) ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@2) (= |b$reqreads#2@0| (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@10) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@10 $f@@0)))
 :qid |_05RecInvariantCutdfy.25:61|
 :skolemid |511|
...
(let ((anon11_Then_correct  (=> (_module.Universe.globalBaseInv $Heap@@2 this@@1) (and (=> (= (ControlFlow 0 13) 12) anon12_Then_correct) (=> (= (ControlFlow 0 13) 8) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (and (not (_module.Universe.globalBaseInv $Heap@@2 this@@1)) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#1@2| true) (= (ControlFlow 0 6) 3))) anon8_correct)))
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@1) Tclass._module.Universe? $Heap@@2) (=> (and (= |b$reqreads#0@0| (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@11) alloc)))) (or (= $o@@11 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@1) _module.Universe.content)) ($Box refType $o@@11)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@11 $f@@1)))
 :qid |_05RecInvariantCutdfy.25:5|
 :skolemid |509|
))) (|_module.Universe.globalBaseInv#canCall| $Heap@@2 this@@1)) (and (=> (= (ControlFlow 0 14) 13) anon11_Then_correct) (=> (= (ControlFlow 0 14) 6) anon11_Else_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Universe) ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@2))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
