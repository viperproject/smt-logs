...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@13 T@U) ($f@@7 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0| |l#3| |l#4|) $o@@13 $f@@7))  (=> (and (or (not (= $o@@13 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@13) |l#2@@0|)))) (or (= $o@@13 |l#3|) (|Set#IsMember| |l#4| ($Box refType $o@@13)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2427|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0| |l#3| |l#4|) $o@@13 $f@@7))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct  (=> (and (= |##running#0@0| (|Set#FromBoogieMap| (|lambda#17| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@55) _module.Universe.content)) |preempting#0|))) ($IsAlloc SetType |##running#0@0| (TSet Tclass._module.Thread) $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@55 Tclass._module.Universe $Heap@@31)) (=> ($IsAlloc refType this@@55 Tclass._module.Universe $Heap@@31) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc SetType (|Set#FromBoogieMap| (|lambda#17| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@55) _module.Universe.content)) |preempting#0|)) (TSet Tclass._module.Thread) $Heap@@31)) (=> ($IsAlloc SetType (|Set#FromBoogieMap| (|lambda#17| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@55) _module.Universe.content)) |preempting#0|)) (TSet Tclass._module.Thread) $Heap@@31) (=> (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@@31 $Heap@0 this@@55 (|Set#FromBoogieMap| (|lambda#17| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@55) _module.Universe.content)) |preempting#0|))) (_module.Universe.legalTransitionsSequence $Heap@@31 $Heap@0 this@@55 (|Set#FromBoogieMap| (|lambda#17| Tclass._module.Thread ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@31 this@@55) _module.Universe.content)) |preempting#0|)))) (and ($IsAllocBox ($Box refType this@@55) Tclass._module.Universe? $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@55 Tclass._module.Universe $Heap@@31)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@31) ($IsHeapAnchor $Heap@@31)) (and (or (not (= this@@55 null)) (not true)) (and ($Is refType this@@55 Tclass._module.Universe) ($IsAlloc refType this@@55 Tclass._module.Universe $Heap@@31)))) (and (and ($Is refType |preempting#0| Tclass._module.Thread) ($IsAlloc refType |preempting#0| Tclass._module.Thread $Heap@@31)) (and (= 17 $FunctionContextHeight) (= (ControlFlow 0 13) 12)))) anon0_correct)))
