...
(assert (distinct TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? class._module.Universe? tytagFamily$Universe tytagFamily$Object tytagFamily$OwnedObject field$content)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@5 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (or (= $o@@5 this) (= $o@@5 (_module.Object.universe this)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@5) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@5) $f)))
 :qid |unknown.0:0|
 :skolemid |1529|
)) (= (_module.OwnedObject.baseUserFieldsInv $h0 this) (_module.OwnedObject.baseUserFieldsInv $h1 this))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1530|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.OwnedObject.baseUserFieldsInv $h1 this))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@6 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#10| |l#0| |l#1| |l#2| |l#3|) $o@@6 $f@@0))  (=> (and (or (not (= $o@@6 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@6) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2429|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#10| |l#0| |l#1| |l#2| |l#3|) $o@@6 $f@@0))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.OwnedObject.baseUserFieldsInvMonotonicity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#10| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($IsAlloc refType this@@0 Tclass._module.OwnedObject $Heap)) (=> ($IsAlloc refType this@@0 Tclass._module.OwnedObject $Heap) (=> (and (|_module.OwnedObject.baseUserFieldsInv#canCall| $Heap this@@0) (_module.OwnedObject.baseUserFieldsInv $Heap this@@0)) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType this@@0 Tclass._module.OwnedObject $Heap)) (=> ($IsAlloc refType this@@0 Tclass._module.OwnedObject $Heap) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= (_module.Object.universe this@@0) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@0) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType (_module.Object.universe this@@0) Tclass._module.Universe $Heap)) (=> ($IsAlloc refType (_module.Object.universe this@@0) Tclass._module.Universe $Heap) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (_module.Object.universe this@@0) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@0) null)) (not true)) (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap (_module.Object.universe this@@0)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@0)) _module.Universe.content))) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@0 Tclass._module.OwnedObject $Heap))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.OwnedObject) ($IsAlloc refType this@@0 Tclass._module.OwnedObject previous$Heap))) (= 4 $FunctionContextHeight)) (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 8) 2))) anon0_correct))))
