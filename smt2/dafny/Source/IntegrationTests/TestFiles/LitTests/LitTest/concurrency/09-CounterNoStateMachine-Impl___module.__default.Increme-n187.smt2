...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split176)
...
))) (and ($HeapSucc $Heap@22 $Heap@23) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= |counter#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
