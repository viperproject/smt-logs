...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split125)
...
))))) (and ($IsGoodHeap $Heap@14) ($IsHeapAnchor $Heap@14)))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@13 |universe#0|) (=> (_module.Universe.globalInv $Heap@13 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@8 $Heap@13 |universe#0|))) (and (|_module.Universe.globalInv#canCall| $Heap@13 |universe#0|) (and (_module.Universe.globalInv $Heap@13 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@13 |universe#0|) (forall ((|o#10@@2| T@U) ) (!  (=> (and ($Is refType |o#10@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |universe#0|) _module.Universe.content)) ($Box refType |o#10@@2|))) (_module.Object.inv $Heap@13 |o#10@@2|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |815|
...
)))) (and (= $Heap@13 $Heap@14) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
