...
(assert (forall (($prevHeap T@U) ($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.EmptyType))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o T@U) ($f T@U) ) (!  (=> (and (or (not (= $o null)) (not true)) (= $o this)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o) $f)))
 :qid |unknown.0:0|
 :skolemid |1066|
)) (= (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap $h0 this) (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap $h1 this))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1068|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap $h1 this))
)))
(assert (implements$_module.OwnedObject Tclass._module.EmptyType?))
(assert (forall (($o@@0 T@U) ) (! (= ($Is refType $o@@0 Tclass._module.EmptyType?)  (or (= $o@@0 null) (= (dtype $o@@0) Tclass._module.EmptyType?)))
 :qid |unknown.0:0|
 :skolemid |1064|
 :pattern ( ($Is refType $o@@0 Tclass._module.EmptyType?))
)))
...
(assert (forall (($o@@3 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.EmptyType? $h@@4)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1065|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.EmptyType? $h@@4))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@0 T@U) ($Heap T@U) (this@@0 T@U) ) (!  (=> (or (|_module.EmptyType.unchangedNonvolatileUserFields#canCall| $prevHeap@@0 $Heap this@@0) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@0) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@0 $Heap)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.EmptyType) ($IsAlloc refType this@@0 Tclass._module.EmptyType $prevHeap@@0)))))) (= (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@0 $Heap this@@0) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_08CounterNoTerminationdfy.244:22|
 :skolemid |1071|
 :pattern ( (_module.EmptyType.unchangedNonvolatileUserFields $prevHeap@@0 $Heap this@@0) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($o@@8 T@U) ) (!  (=> ($Is refType $o@@8 Tclass._module.EmptyType?) ($Is refType $o@@8 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2259|
 :pattern ( ($Is refType $o@@8 Tclass._module.EmptyType?))
)))
...
(set-info :boogie-vc-id Impl$$_module.EmptyType.proveUnchangedNonvolatileUserFields)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.EmptyType.unchangedNonvolatileUserFields#canCall| previous$Heap current$Heap this@@1)) (or (_module.EmptyType.unchangedNonvolatileUserFields previous$Heap current$Heap this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.EmptyType) ($IsAlloc refType this@@1 Tclass._module.EmptyType previous$Heap))) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@11 null)) (not true)) (=> (= $o@@11 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@11) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@11) $f@@1))))
 :qid |_08CounterNoTerminationdfy.247:65|
 :skolemid |1080|
