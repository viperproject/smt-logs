...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split272)
...
))) (and (and ($HeapSucc $Heap@32 $Heap@33) (U_2_bool (Lit boolType (bool_2_U false)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|) (= (ControlFlow 0 2) (- 0 1)))))))))))) (or (not (= |running#0@@3| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
