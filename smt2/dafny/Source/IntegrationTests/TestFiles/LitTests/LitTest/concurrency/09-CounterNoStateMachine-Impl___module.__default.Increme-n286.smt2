...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split275)
...
))))) (forall (($o@@178 T@U) ) (!  (=> (and (or (not (= $o@@178 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 $o@@178) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@178) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 $o@@178)) (or (= $o@@178 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType $o@@178)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 $o@@178))
)))) (and (and (and ($HeapSucc $Heap@32 $Heap@33) (U_2_bool (Lit boolType (bool_2_U false)))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|) ($IsAllocBox ($Box refType |running#0@@3|) Tclass._module.Object? $Heap@33))) (and (and (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|) (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|)) (and (_module.Object.triggerAxioms $Heap@33 |running#0@@3|) (= (ControlFlow 0 2) (- 0 1)))))))))))) (or (not (= |remaining#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
