...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split58)
...
))))) (and (and (forall (($o@@118 T@U) ) (!  (=> (and (or (not (= $o@@118 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@118) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@118) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@118)) (or (= $o@@118 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType $o@@118)))))
 :qid |_11MutexGuard2legacydfy.109:10|
 :skolemid |896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@118))
)) ($HeapSucc $Heap@3 $Heap@4)) (and (or (not (= |call4formal@guard#0@0| null)) (not true)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex)) null)) (not true)))))) (and (and (and (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true)) (= |b#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedU32.value))))) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@4))) (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@4) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@4)) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@4 $Heap@4 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@4 $Heap@4 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@4 $Heap@4 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@4 $Heap@4 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@4 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (|_module.Universe.legalTransition#canCall| $Heap@4 $Heap@4 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@4 $Heap@4 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@4 $Heap@4 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@4 $Heap@4 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@4 $Heap@4 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@4 $Heap@4 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@4 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@4 |universe#0|) (forall ((|o#0@@18| T@U) ) (!  (=> (and ($Is refType |o#0@@18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@18|))) (and (and (and (= (_module.Object.universe |o#0@@18|) |universe#0|) (or (not (= |o#0@@18| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@4 |o#0@@18|)) (_module.Object.triggerAxioms $Heap@4 |o#0@@18|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |788|
