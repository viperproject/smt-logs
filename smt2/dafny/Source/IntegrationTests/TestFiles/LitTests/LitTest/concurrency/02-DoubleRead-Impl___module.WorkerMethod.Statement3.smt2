...
(assert (forall (($prevHeap@@4 T@U) ($h0@@3 T@U) ($h1@@3 T@U) (this@@8 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.Object) ($IsAlloc refType this@@8 Tclass._module.Object $h0@@3)))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@5 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@5) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@5) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@5) $f@@3)))
 :qid |unknown.0:0|
 :skolemid |657|
)) (= (_module.Object.gi2 $prevHeap@@4 $h0@@3 this@@8) (_module.Object.gi2 $prevHeap@@4 $h1@@3 this@@8))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |658|
 :pattern ( ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3) (_module.Object.gi2 $prevHeap@@4 $h1@@3 this@@8))
)))
(assert (forall (($prevHeap@@5 T@U) ($h0@@4 T@U) ($h1@@4 T@U) (this@@9 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.Object) ($IsAlloc refType this@@9 Tclass._module.Object $h0@@4)))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@6 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@6) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@6) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@6) $f@@4)))
 :qid |unknown.0:0|
 :skolemid |668|
)) (= (_module.Object.i2 $prevHeap@@5 $h0@@4 this@@9) (_module.Object.i2 $prevHeap@@5 $h1@@4 this@@9))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |669|
 :pattern ( ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4) (_module.Object.i2 $prevHeap@@5 $h1@@4 this@@9))
)))
(assert (forall (($prevHeap@@6 T@U) ($h0@@5 T@U) ($h1@@5 T@U) (this@@10 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.ArcAtomicIsize) ($IsAlloc refType this@@10 Tclass._module.ArcAtomicIsize $h0@@5)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@7 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@7) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@7) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@7) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |712|
)) (= (_module.ArcAtomicIsize.i2 $prevHeap@@6 $h0@@5 this@@10) (_module.ArcAtomicIsize.i2 $prevHeap@@6 $h1@@5 this@@10))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |713|
 :pattern ( ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5) (_module.ArcAtomicIsize.i2 $prevHeap@@6 $h1@@5 this@@10))
)))
(assert (forall (($prevHeap@@7 T@U) ($h0@@6 T@U) ($h1@@6 T@U) (this@@11 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.WorkerMethod) ($IsAlloc refType this@@11 Tclass._module.WorkerMethod $h0@@6)))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@8 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@8) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@8) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@8) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |839|
)) (= (_module.WorkerMethod.i2 $prevHeap@@7 $h0@@6 this@@11) (_module.WorkerMethod.i2 $prevHeap@@7 $h1@@6 this@@11))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |840|
 :pattern ( ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6) (_module.WorkerMethod.i2 $prevHeap@@7 $h1@@6 this@@11))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.WorkerMethod.i#canCall| $Heap@@4 this@@12) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@4) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.WorkerMethod) ($IsAlloc refType this@@12 Tclass._module.WorkerMethod $Heap@@4)))))) (and (and (|_module.Object.i0#canCall| $Heap@@4 this@@12) (=> (_module.Object.i0 $Heap@@4 this@@12) (=> (<= (LitInt 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.next__stmt)))) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.next__stmt))) (LitInt 4)) (=> (= (_module.Object.universe this@@12) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.counter)))) (|_module.ArcAtomicIsize.i#canCall| $Heap@@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.counter)))))))) (= (_module.WorkerMethod.i $Heap@@4 this@@12)  (and (and (and (and (and (_module.Object.i0 $Heap@@4 this@@12) (and (<= (LitInt 1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.next__stmt)))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.next__stmt))) (LitInt 4)))) (= (_module.Object.universe this@@12) (_module.Object.universe ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.counter))))) (_module.ArcAtomicIsize.i $Heap@@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.counter)))) (=> (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.next__stmt))) 1) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.initial__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.counter))) _module.ArcAtomicIsize.data)))))) (=> (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.next__stmt))) 2) (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.initial__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.final__value)))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.final__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 this@@12) _module.WorkerMethod.counter))) _module.ArcAtomicIsize.data))))))))))
 :qid |_02DoubleReaddfy.146:19|
 :skolemid |834|
 :pattern ( (_module.WorkerMethod.i $Heap@@4 this@@12) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($prevHeap@@8 T@U) ($Heap@@5 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.Universe.legal#canCall| $prevHeap@@8 $Heap@@5 this@@13) (and (< 8 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@8) ($IsGoodHeap $Heap@@5)) ($HeapSucc $prevHeap@@8 $Heap@@5)) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Universe) ($IsAlloc refType this@@13 Tclass._module.Universe $prevHeap@@8)))))) (and (and (|_module.Universe.i#canCall| $prevHeap@@8 this@@13) (=> (_module.Universe.i $prevHeap@@8 this@@13) (and (|_module.Universe.i0#canCall| $Heap@@5 this@@13) (=> (_module.Universe.i0 $Heap@@5 this@@13) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@13) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@13) _module.Universe.content))) (and (|_module.Universe.legal0#canCall| $prevHeap@@8 $Heap@@5 this@@13) (=> (_module.Universe.legal0 $prevHeap@@8 $Heap@@5 this@@13) (|_module.Universe.legal1#canCall| $prevHeap@@8 $Heap@@5 this@@13)))))))) (= (_module.Universe.legal $prevHeap@@8 $Heap@@5 this@@13)  (and (and (and (and (_module.Universe.i $prevHeap@@8 this@@13) (_module.Universe.i0 $Heap@@5 this@@13)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@8 this@@13) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 this@@13) _module.Universe.content)))) (_module.Universe.legal0 $prevHeap@@8 $Heap@@5 this@@13)) (_module.Universe.legal1 $prevHeap@@8 $Heap@@5 this@@13)))))
 :qid |_02DoubleReaddfy.52:22|
 :skolemid |567|
 :pattern ( (_module.Universe.legal $prevHeap@@8 $Heap@@5 this@@13) ($IsGoodHeap $Heap@@5))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($prevHeap@@9 T@U) ($Heap@@6 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.Universe.legal1#canCall| $prevHeap@@9 $Heap@@6 this@@14) (and (< 7 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@9) ($IsGoodHeap $Heap@@6)) ($HeapSucc $prevHeap@@9 $Heap@@6)) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Universe) ($IsAlloc refType this@@14 Tclass._module.Universe $prevHeap@@9)))))) (and (forall ((|o#0@@3| T@U) ) (!  (=> ($Is refType |o#0@@3| Tclass._module.Object) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@14) _module.Universe.content)) ($Box refType |o#0@@3|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@9 this@@14) _module.Universe.content)) ($Box refType |o#0@@3|)))) (|_module.Object.i#canCall| $Heap@@6 |o#0@@3|)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@14) _module.Universe.content)) ($Box refType |o#0@@3|)))
)) (= (_module.Universe.legal1 $prevHeap@@9 $Heap@@6 this@@14) (forall ((|o#0@@4| T@U) ) (!  (=> (and ($Is refType |o#0@@4| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@14) _module.Universe.content)) ($Box refType |o#0@@4|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@9 this@@14) _module.Universe.content)) ($Box refType |o#0@@4|))))) (_module.Object.i $Heap@@6 |o#0@@4|))
 :qid |_02DoubleReaddfy.48:12|
 :skolemid |556|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@14) _module.Universe.content)) ($Box refType |o#0@@4|)))
)))))
 :qid |_02DoubleReaddfy.47:22|
 :skolemid |558|
 :pattern ( (_module.Universe.legal1 $prevHeap@@9 $Heap@@6 this@@14) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($prevHeap@@10 T@U) ($Heap@@7 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.Object.gi2#canCall| $prevHeap@@10 $Heap@@7 this@@15) (and (< 9 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@10) ($IsGoodHeap $Heap@@7)) ($HeapSucc $prevHeap@@10 $Heap@@7)) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Object) ($IsAlloc refType this@@15 Tclass._module.Object $prevHeap@@10)))) (_module.Object.gi $prevHeap@@10 this@@15)))) (and (and (|_module.Object.i0#canCall| $Heap@@7 this@@15) (=> (_module.Object.i0 $Heap@@7 this@@15) (|_module.Universe.i2#canCall| $prevHeap@@10 $Heap@@7 (_module.Object.universe this@@15)))) (= (_module.Object.gi2 $prevHeap@@10 $Heap@@7 this@@15)  (and (_module.Object.i0 $Heap@@7 this@@15) (_module.Universe.i2 $prevHeap@@10 $Heap@@7 (_module.Object.universe this@@15))))))
 :qid |_02DoubleReaddfy.92:22|
 :skolemid |661|
 :pattern ( (_module.Object.gi2 $prevHeap@@10 $Heap@@7 this@@15) ($IsGoodHeap $Heap@@7))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@11 T@U) ($Heap@@8 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.ArcAtomicIsize.i2#canCall| $prevHeap@@11 $Heap@@8 this@@16) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@11) ($IsGoodHeap $Heap@@8)) ($HeapSucc $prevHeap@@11 $Heap@@8)) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.ArcAtomicIsize) ($IsAlloc refType this@@16 Tclass._module.ArcAtomicIsize $prevHeap@@11)))))) (= (_module.ArcAtomicIsize.i2 $prevHeap@@11 $Heap@@8 this@@16)  (and true (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 this@@16) _module.ArcAtomicIsize.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@16) _module.ArcAtomicIsize.data)))))))
 :qid |_02DoubleReaddfy.109:22|
 :skolemid |716|
 :pattern ( (_module.ArcAtomicIsize.i2 $prevHeap@@11 $Heap@@8 this@@16) ($IsGoodHeap $Heap@@8))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@12 T@U) ($Heap@@9 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.ArcAtomicIsize.i2#canCall| $prevHeap@@12 $Heap@@9 this@@17) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@17 null)) (not true)) ($Is refType this@@17 Tclass._module.ArcAtomicIsize)))) (= (_module.Object.i2 $prevHeap@@12 $Heap@@9 this@@17) (_module.ArcAtomicIsize.i2 $prevHeap@@12 $Heap@@9 this@@17)))
 :qid |_02DoubleReaddfy.96:22|
 :skolemid |717|
 :pattern ( (_module.Object.i2 $prevHeap@@12 $Heap@@9 this@@17) ($Is refType this@@17 Tclass._module.ArcAtomicIsize) ($IsGoodHeap $Heap@@9))
 :pattern ( (_module.Object.i2 $prevHeap@@12 $Heap@@9 this@@17) (_module.ArcAtomicIsize.i2 $prevHeap@@12 $Heap@@9 this@@17) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@13 T@U) ($Heap@@10 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.WorkerMethod.i2#canCall| $prevHeap@@13 $Heap@@10 this@@18) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@18 null)) (not true)) ($Is refType this@@18 Tclass._module.WorkerMethod)))) (= (_module.Object.i2 $prevHeap@@13 $Heap@@10 this@@18) (_module.WorkerMethod.i2 $prevHeap@@13 $Heap@@10 this@@18)))
 :qid |_02DoubleReaddfy.96:22|
 :skolemid |844|
 :pattern ( (_module.Object.i2 $prevHeap@@13 $Heap@@10 this@@18) ($Is refType this@@18 Tclass._module.WorkerMethod) ($IsGoodHeap $Heap@@10))
 :pattern ( (_module.Object.i2 $prevHeap@@13 $Heap@@10 this@@18) (_module.WorkerMethod.i2 $prevHeap@@13 $Heap@@10 this@@18) ($IsGoodHeap $Heap@@10))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Object.i0#canCall| $Heap@@11 this@@19) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Object) ($IsAlloc refType this@@19 Tclass._module.Object $Heap@@11)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 (_module.Object.universe this@@19)) _module.Universe.content)) ($Box refType this@@19)) (|_module.Universe.i0#canCall| $Heap@@11 (_module.Object.universe this@@19))) (= (_module.Object.i0 $Heap@@11 this@@19)  (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 (_module.Object.universe this@@19)) _module.Universe.content)) ($Box refType this@@19)) (_module.Universe.i0 $Heap@@11 (_module.Object.universe this@@19))))))
 :qid |_02DoubleReaddfy.73:19|
 :skolemid |623|
 :pattern ( (_module.Object.i0 $Heap@@11 this@@19) ($IsGoodHeap $Heap@@11))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($prevHeap@@14 T@U) ($Heap@@12 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.Universe.legal0#canCall| $prevHeap@@14 $Heap@@12 this@@20) (and (< 7 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@14) ($IsGoodHeap $Heap@@12)) ($HeapSucc $prevHeap@@14 $Heap@@12)) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Universe) ($IsAlloc refType this@@20 Tclass._module.Universe $prevHeap@@14)))))) (and (forall ((|o#0@@6| T@U) ) (!  (=> ($Is refType |o#0@@6| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 this@@20) _module.Universe.content)) ($Box refType |o#0@@6|)) (and (=> (not (forall (($o@@25 T@U) ($f@@8 T@U) ) (!  (=> (or (not (= $o@@25 null)) (not true)) (=> (= $o@@25 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@25) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 $o@@25) $f@@8))))
...
))) (|_module.Object.i2#canCall| $prevHeap@@14 $Heap@@12 |o#0@@6|)) (=> (or (forall (($o@@26 T@U) ($f@@9 T@U) ) (!  (=> (or (not (= $o@@26 null)) (not true)) (=> (= $o@@26 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@26) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 $o@@26) $f@@9))))
 :qid |_02DoubleReaddfy.43:45|
 :skolemid |535|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@26) $f@@9))
)) (_module.Object.i2 $prevHeap@@14 $Heap@@12 |o#0@@6|)) (=> (not (forall (($o@@27 T@U) ($f@@10 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@27) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 $o@@27) $f@@10))))
 :qid |_02DoubleReaddfy.43:45|
 :skolemid |534|
 ...
 :pattern ( (_module.Object.i2 $prevHeap@@14 $Heap@@12 |o#0@@6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 this@@20) _module.Universe.content)) ($Box refType |o#0@@6|)))
)) (= (_module.Universe.legal0 $prevHeap@@14 $Heap@@12 this@@20) (forall ((|o#0@@7| T@U) ) (!  (=> (and ($Is refType |o#0@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 this@@20) _module.Universe.content)) ($Box refType |o#0@@7|))) (and (or (forall (($o@@28 T@U) ($f@@11 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 |o#0@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@28) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 $o@@28) $f@@11))))
 :qid |_02DoubleReaddfy.43:45|
 :skolemid |530|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@28) $f@@11))
)) (_module.Object.i2 $prevHeap@@14 $Heap@@12 |o#0@@7|)) (or (forall (($o@@29 T@U) ($f@@12 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 |o#0@@7|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@29) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 $o@@29) $f@@12))))
 :qid |_02DoubleReaddfy.43:45|
 :skolemid |531|
 ...
 :pattern ( (_module.Object.i2 $prevHeap@@14 $Heap@@12 |o#0@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@14 this@@20) _module.Universe.content)) ($Box refType |o#0@@7|)))
)))))
 :qid |_02DoubleReaddfy.42:22|
 :skolemid |537|
 :pattern ( (_module.Universe.legal0 $prevHeap@@14 $Heap@@12 this@@20) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.Object.gi#canCall| $Heap@@13 this@@21) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Object) ($IsAlloc refType this@@21 Tclass._module.Object $Heap@@13)))))) (and (and (|_module.Object.i0#canCall| $Heap@@13 this@@21) (=> (_module.Object.i0 $Heap@@13 this@@21) (|_module.Universe.i#canCall| $Heap@@13 (_module.Object.universe this@@21)))) (= (_module.Object.gi $Heap@@13 this@@21)  (and (_module.Object.i0 $Heap@@13 this@@21) (_module.Universe.i $Heap@@13 (_module.Object.universe this@@21))))))
 :qid |_02DoubleReaddfy.89:19|
 :skolemid |654|
 :pattern ( (_module.Object.gi $Heap@@13 this@@21) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@14 T@U) (|o#0@@9| T@U) ) (!  (=> (and (or (|_module.__default.upCast#canCall| |o#0@@9|) (and (< 0 $FunctionContextHeight) (and ($Is refType |o#0@@9| Tclass._System.object) ($IsAlloc refType |o#0@@9| Tclass._System.object $Heap@@14)))) ($IsGoodHeap $Heap@@14)) ($IsAlloc refType (_module.__default.upCast |o#0@@9|) Tclass._System.object $Heap@@14))
 :qid |_02DoubleReaddfy.16:16|
 :skolemid |480|
 :pattern ( ($IsAlloc refType (_module.__default.upCast |o#0@@9|) Tclass._System.object $Heap@@14))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@17 alloc this@@31)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.WorkerMethod.initial__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.WorkerMethod.final__value))))) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.WorkerMethod.initial__value))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.WorkerMethod.final__value)))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@31 _module.WorkerMethod.next__stmt))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@31 _module.WorkerMethod.next__stmt)) (=> (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.WorkerMethod.next__stmt))) 1)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@31) _module.WorkerMethod.next__stmt ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= (_module.Object.universe this@@31) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@31) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 11)) ($IsAlloc refType (_module.Object.universe this@@31) Tclass._module.Universe $Heap@@17)) (=> ($IsAlloc refType (_module.Object.universe this@@31) Tclass._module.Universe $Heap@@17) (=> (and (= call0formal@previous$Heap@0 $Heap@@17) (= call2formal@this@0 (_module.Object.universe this@@31))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (=> (|_module.Universe.i#canCall| call0formal@previous$Heap@0 call2formal@this@0) (or (_module.Universe.i call0formal@previous$Heap@0 call2formal@this@0) (=> (|_module.Universe.i0#canCall| call0formal@previous$Heap@0 call2formal@this@0) (or (_module.Universe.i0 call0formal@previous$Heap@0 call2formal@this@0) (forall ((|o#0@@13| T@U) ) (!  (=> (and ($Is refType |o#0@@13| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#0@@13|))) (and (= (_module.Object.universe |o#0@@13|) call2formal@this@0) (or (not (= (_module.__default.upCast |o#0@@13|) call2formal@this@0)) (not true))))
 :qid |_02DoubleReaddfy.28:12|
 :skolemid |571|
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (=> (|_module.Universe.i0#canCall| $Heap@0 call2formal@this@0) (or (_module.Universe.i0 $Heap@0 call2formal@this@0) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#2|))) (and (= (_module.Object.universe |o#2|) call2formal@this@0) (or (not (= (_module.__default.upCast |o#2|) call2formal@this@0)) (not true))))
 :qid |_02DoubleReaddfy.28:12|
 :skolemid |575|
 :pattern ( (_module.__default.upCast |o#2|))
 :pattern ( (_module.Object.universe |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#2|)))
))))))) (=> (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (=> (|_module.Universe.i0#canCall| $Heap@0 call2formal@this@0) (or (_module.Universe.i0 $Heap@0 call2formal@this@0) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#2@@0|))) (and (= (_module.Object.universe |o#2@@0|) call2formal@this@0) (or (not (= (_module.__default.upCast |o#2@@0|) call2formal@this@0)) (not true))))
 :qid |_02DoubleReaddfy.28:12|
 :skolemid |575|
 :pattern ( (_module.__default.upCast |o#2@@0|))
 :pattern ( (_module.Object.universe |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#2@@0|)))
)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)))))) (=> (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (=> (|_module.Universe.legal0#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal0 call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#3|))) (and (or (forall (($o@@48 T@U) ($f@@20 T@U) ) (!  (=> (or (not (= $o@@48 null)) (not true)) (=> (= $o@@48 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@48) $f@@20))))
 :qid |_02DoubleReaddfy.43:45|
 :skolemid |577|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@48) $f@@20))
)) (_module.Object.i2 call0formal@previous$Heap@0 $Heap@0 |o#3|)) (or (forall (($o@@49 T@U) ($f@@21 T@U) ) (!  (=> (or (not (= $o@@49 null)) (not true)) (=> (= $o@@49 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@49) $f@@21) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@49) $f@@21))))
 :qid |_02DoubleReaddfy.43:45|
 :skolemid |578|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@49) $f@@21))
)) (_module.Object.i $Heap@0 |o#3|))))
 :qid |_02DoubleReaddfy.43:12|
 :skolemid |579|
 :pattern ( (_module.Object.i $Heap@0 |o#3|))
 :pattern ( (_module.Object.i2 call0formal@previous$Heap@0 $Heap@0 |o#3|))
...
))))))) (=> (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (=> (|_module.Universe.legal0#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal0 call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (forall ((|o#3@@0| T@U) ) (!  (=> (and ($Is refType |o#3@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#3@@0|))) (and (or (forall (($o@@50 T@U) ($f@@22 T@U) ) (!  (=> (or (not (= $o@@50 null)) (not true)) (=> (= $o@@50 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@50) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@50) $f@@22))))
 :qid |_02DoubleReaddfy.43:45|
 :skolemid |577|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@50) $f@@22))
)) (_module.Object.i2 call0formal@previous$Heap@0 $Heap@0 |o#3@@0|)) (or (forall (($o@@51 T@U) ($f@@23 T@U) ) (!  (=> (or (not (= $o@@51 null)) (not true)) (=> (= $o@@51 |o#3@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@51) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@51) $f@@23))))
 :qid |_02DoubleReaddfy.43:45|
 :skolemid |578|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@51) $f@@23))
)) (_module.Object.i $Heap@0 |o#3@@0|))))
 :qid |_02DoubleReaddfy.43:12|
 :skolemid |579|
 :pattern ( (_module.Object.i $Heap@0 |o#3@@0|))
 :pattern ( (_module.Object.i2 call0formal@previous$Heap@0 $Heap@0 |o#3@@0|))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (=> (|_module.Universe.legal1#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal1 call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#4|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#4|))))) (_module.Object.i $Heap@0 |o#4|))
 :qid |_02DoubleReaddfy.48:12|
 :skolemid |583|
 :pattern ( (_module.Object.i $Heap@0 |o#4|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#4|)))
))))))) (=> (=> (|_module.Universe.legal#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (=> (|_module.Universe.legal1#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (or (_module.Universe.legal1 call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (forall ((|o#4@@0| T@U) ) (!  (=> (and ($Is refType |o#4@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#4@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#4@@0|))))) (_module.Object.i $Heap@0 |o#4@@0|))
 :qid |_02DoubleReaddfy.48:12|
 :skolemid |583|
 :pattern ( (_module.Object.i $Heap@0 |o#4@@0|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#4@@0|)))
)))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (|_module.Universe.i#canCall| $Heap@0 call2formal@this@0) (=> (_module.Universe.i $Heap@0 call2formal@this@0) (|_module.Universe.i2#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0))) (and (|_module.Universe.i#canCall| $Heap@0 call2formal@this@0) (and (_module.Universe.i $Heap@0 call2formal@this@0) (and (_module.Universe.i0 $Heap@0 call2formal@this@0) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#6|))) (_module.Object.i $Heap@0 |o#6|))
 :qid |_02DoubleReaddfy.33:20|
 :skolemid |588|
 :pattern ( (_module.Object.i $Heap@0 |o#6|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#6|)))
)))))) (and (and (|_module.Universe.i2#canCall| call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (and (_module.Universe.i2 call0formal@previous$Heap@0 $Heap@0 call2formal@this@0) (forall ((|o#7| T@U) ) (!  (=> (and ($Is refType |o#7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#7|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#7|)) (_module.Object.i2 call0formal@previous$Heap@0 $Heap@0 |o#7|)))
 :qid |_02DoubleReaddfy.38:12|
 :skolemid |590|
 :pattern ( (_module.Object.i2 call0formal@previous$Heap@0 $Heap@0 |o#7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call2formal@this@0) _module.Universe.content)) ($Box refType |o#7|)))
...
)))) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Object.gi2#canCall| $Heap@@17 $Heap@1 this@@31) (or (_module.Object.gi2 $Heap@@17 $Heap@1 this@@31) (=> (|_module.Object.i0#canCall| $Heap@1 this@@31) (or (_module.Object.i0 $Heap@1 this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31))))))) (=> (=> (|_module.Object.gi2#canCall| $Heap@@17 $Heap@1 this@@31) (or (_module.Object.gi2 $Heap@@17 $Heap@1 this@@31) (=> (|_module.Object.i0#canCall| $Heap@1 this@@31) (or (_module.Object.i0 $Heap@1 this@@31) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType this@@31)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Object.gi2#canCall| $Heap@@17 $Heap@1 this@@31) (or (_module.Object.gi2 $Heap@@17 $Heap@1 this@@31) (=> (|_module.Object.i0#canCall| $Heap@1 this@@31) (or (_module.Object.i0 $Heap@1 this@@31) (=> (|_module.Universe.i0#canCall| $Heap@1 (_module.Object.universe this@@31)) (or (_module.Universe.i0 $Heap@1 (_module.Object.universe this@@31)) (forall ((|o#11| T@U) ) (!  (=> (and ($Is refType |o#11| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#11|))) (and (= (_module.Object.universe |o#11|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#11|) (_module.Object.universe this@@31))) (not true))))
 :qid |_02DoubleReaddfy.28:12|
 :skolemid |1050|
 :pattern ( (_module.__default.upCast |o#11|))
 :pattern ( (_module.Object.universe |o#11|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#11|)))
))))))))) (=> (=> (|_module.Object.gi2#canCall| $Heap@@17 $Heap@1 this@@31) (or (_module.Object.gi2 $Heap@@17 $Heap@1 this@@31) (=> (|_module.Object.i0#canCall| $Heap@1 this@@31) (or (_module.Object.i0 $Heap@1 this@@31) (=> (|_module.Universe.i0#canCall| $Heap@1 (_module.Object.universe this@@31)) (or (_module.Universe.i0 $Heap@1 (_module.Object.universe this@@31)) (forall ((|o#11@@0| T@U) ) (!  (=> (and ($Is refType |o#11@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#11@@0|))) (and (= (_module.Object.universe |o#11@@0|) (_module.Object.universe this@@31)) (or (not (= (_module.__default.upCast |o#11@@0|) (_module.Object.universe this@@31))) (not true))))
 :qid |_02DoubleReaddfy.28:12|
 :skolemid |1050|
 :pattern ( (_module.__default.upCast |o#11@@0|))
 :pattern ( (_module.Object.universe |o#11@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#11@@0|)))
)))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Object.gi2#canCall| $Heap@@17 $Heap@1 this@@31) (or (_module.Object.gi2 $Heap@@17 $Heap@1 this@@31) (=> (|_module.Universe.i2#canCall| $Heap@@17 $Heap@1 (_module.Object.universe this@@31)) (or (_module.Universe.i2 $Heap@@17 $Heap@1 (_module.Object.universe this@@31)) (forall ((|o#12| T@U) ) (!  (=> (and ($Is refType |o#12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#12|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#12|)) (_module.Object.i2 $Heap@@17 $Heap@1 |o#12|)))
 :qid |_02DoubleReaddfy.38:12|
 :skolemid |1052|
 :pattern ( (_module.Object.i2 $Heap@@17 $Heap@1 |o#12|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@31)) _module.Universe.content)) ($Box refType |o#12|)))
