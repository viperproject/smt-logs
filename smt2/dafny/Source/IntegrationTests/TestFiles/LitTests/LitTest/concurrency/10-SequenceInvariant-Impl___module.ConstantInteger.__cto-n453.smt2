...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.ConstantInteger) ($IsAlloc refType this@@90 Tclass._module.ConstantInteger $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@64 T@U) ($f@@47 T@U) )  (=> (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@64) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@64) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@64) $f@@47)))) (= (_module.ConstantInteger.localUserInv $h0@@37 this@@90) (_module.ConstantInteger.localUserInv $h1@@37 this@@90))))
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.ConstantInteger.localUserInv $h1@@37 this@@90))
)))
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@91 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.ConstantInteger) ($IsAlloc refType this@@91 Tclass._module.ConstantInteger $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@65 T@U) ($f@@48 T@U) )  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@65) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@65) $f@@48)))) (= (_module.ConstantInteger.userInv $h0@@38 this@@91) (_module.ConstantInteger.userInv $h1@@38 this@@91))))
