...
(assert (distinct alloc Tagclass._module.Universe Tagclass._module.Integer Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.OwnedObject Tagclass._module.OwnedObject? Tagclass._module.Integer? tytagFamily$Universe tytagFamily$Integer tytagFamily$Object tytagFamily$OwnedObject)
)
...
(assert (forall ((|c#0@@2| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType |c#0@@2| Tclass._module.Integer $h@@2) ($IsAlloc refType |c#0@@2| Tclass._module.Integer? $h@@2))
 :qid |unknown.0:0|
 :skolemid |1978|
 :pattern ( ($IsAlloc refType |c#0@@2| Tclass._module.Integer $h@@2))
 :pattern ( ($IsAlloc refType |c#0@@2| Tclass._module.Integer? $h@@2))
)))
...
(set-info :boogie-vc-id OverrideCheck$$_module.Integer.baseUserFieldsInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))))) (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this))) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType this)) ($Box refType (_module.Object.universe this)))) (=> (and (= Integer_$_ReadsFrame@0 (|lambda#69| null $Heap alloc this (_module.Object.universe this))) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@14) alloc)))) (or (= $o@@14 this) (= $o@@14 (_module.Object.universe this)))) (or (= $o@@14 this) (= $o@@14 (_module.Object.universe this))))
 :qid |_10SequenceInvariantdfy.461:19|
 :skolemid |1779|
)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Integer) ($IsAlloc refType this Tclass._module.Integer $Heap))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
