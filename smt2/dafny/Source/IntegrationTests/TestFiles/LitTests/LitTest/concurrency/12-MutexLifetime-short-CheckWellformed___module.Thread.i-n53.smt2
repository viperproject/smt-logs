...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@14 this@@17) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Thread) ($IsAlloc refType this@@17 Tclass._module.Thread $Heap@@14)))))) (=> (_module.Thread.localInv $Heap@@14 this@@17) (_module.Object.objectGlobalBaseInv $Heap@@14 this@@17)))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1518|
 :pattern ( (_module.Thread.localInv $Heap@@14 this@@17))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@15 this@@18) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Thread) ($IsAlloc refType this@@18 Tclass._module.Thread $Heap@@15)))))) (=> (_module.Thread.inv $Heap@@15 this@@18) (_module.Thread.localInv $Heap@@15 this@@18)))
 :qid |_12MutexLifetimeshortdfy.371:19|
 :skolemid |1530|
 :pattern ( (_module.Thread.inv $Heap@@15 this@@18))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@19 T@U) ) (!  (=> (or (|_module.Thread.objectClassKind#canCall| (Lit refType this@@19)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@19 null)) (not true)) ($Is refType this@@19 Tclass._module.Thread)))) (= (_module.Thread.objectClassKind (Lit refType this@@19)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Thread|)))
 :qid |_12MutexLifetimeshortdfy.361:18|
 :weight 3
 :skolemid |1499|
 :pattern ( (_module.Thread.objectClassKind (Lit refType this@@19)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@20 T@U) ) (!  (=> (or (|_module.OwnedObject.objectClassKind#canCall| (Lit refType this@@20)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@20 null)) (not true)) ($Is refType this@@20 Tclass._module.OwnedObject)))) (= (_module.OwnedObject.objectClassKind (Lit refType this@@20)) (Lit DatatypeTypeType |#_module.ObjectClassKind.OwnedObject|)))
 :qid |_12MutexLifetimeshortdfy.424:18|
 :weight 3
 :skolemid |1766|
 :pattern ( (_module.OwnedObject.objectClassKind (Lit refType this@@20)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@21 T@U) ) (!  (=> (or (|_module.Lifetime.objectClassKind#canCall| (Lit refType this@@21)) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.Lifetime)))) (= (_module.Lifetime.objectClassKind (Lit refType this@@21)) (Lit DatatypeTypeType |#_module.ObjectClassKind.Lifetime|)))
 :qid |_12MutexLifetimeshortdfy.561:18|
 :weight 3
 :skolemid |1944|
 :pattern ( (_module.Lifetime.objectClassKind (Lit refType this@@21)))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@16 this@@29) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Thread) ($IsAlloc refType this@@29 Tclass._module.Thread $Heap@@16)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@16 this@@29)) (= (_module.Thread.localInv $Heap@@16 this@@29)  (and true (_module.Object.objectGlobalBaseInv $Heap@@16 this@@29)))))
 :qid |_12MutexLifetimeshortdfy.368:19|
 :skolemid |1520|
 :pattern ( (_module.Thread.localInv $Heap@@16 this@@29) ($IsGoodHeap $Heap@@16))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@17 this@@30) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.Thread) ($IsAlloc refType this@@30 Tclass._module.Thread $Heap@@17)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@17 this@@30)) (= (_module.Thread.inv $Heap@@17 this@@30)  (and true (_module.Thread.localInv $Heap@@17 this@@30)))))
 :qid |_12MutexLifetimeshortdfy.371:19|
 :skolemid |1532|
 :pattern ( (_module.Thread.inv $Heap@@17 this@@30) ($IsGoodHeap $Heap@@17))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@32) (or (_module.Object.objectGlobalBaseInv $Heap@@19 this@@32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 (_module.Object.universe this@@32)) _module.Universe.content)) ($Box refType this@@32)))))))) (=> (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@32) (or (_module.Object.objectGlobalBaseInv $Heap@@19 this@@32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 (_module.Object.universe this@@32)) _module.Universe.content)) ($Box refType this@@32))))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@32) (or (_module.Object.objectGlobalBaseInv $Heap@@19 this@@32) (_module.Object.baseFieldsInv $Heap@@19 this@@32))))))) (=> (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@32) (or (_module.Object.objectGlobalBaseInv $Heap@@19 this@@32) (_module.Object.baseFieldsInv $Heap@@19 this@@32)))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@32) (or (_module.Object.objectGlobalBaseInv $Heap@@19 this@@32) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@19 (_module.Object.universe this@@32)) (or (_module.Universe.globalBaseInv $Heap@@19 (_module.Object.universe this@@32)) (U_2_bool (Lit boolType (bool_2_U true))))))))))) (=> (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@32) (or (_module.Object.objectGlobalBaseInv $Heap@@19 this@@32) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@19 (_module.Object.universe this@@32)) (or (_module.Universe.globalBaseInv $Heap@@19 (_module.Object.universe this@@32)) (U_2_bool (Lit boolType (bool_2_U true)))))))))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.Thread.inv $Heap@@19 this@@32) (=> (|_module.Thread.localInv#canCall| $Heap@@19 this@@32) (or (_module.Thread.localInv $Heap@@19 this@@32) (=> (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@19 this@@32) (or (_module.Object.objectGlobalBaseInv $Heap@@19 this@@32) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@19 (_module.Object.universe this@@32)) (or (_module.Universe.globalBaseInv $Heap@@19 (_module.Object.universe this@@32)) (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 (_module.Object.universe this@@32)) _module.Universe.content)) ($Box refType |o#0@@1|))) (and (and (and (= (_module.Object.universe |o#0@@1|) (_module.Object.universe this@@32)) (or (not (= |o#0@@1| (_module.Object.universe this@@32))) (not true))) (_module.Object.baseFieldsInv $Heap@@19 |o#0@@1|)) (_module.Object.triggerAxioms $Heap@@19 |o#0@@1|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |1534|
 :pattern ( (_module.Object.triggerAxioms $Heap@@19 |o#0@@1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@19 |o#0@@1|))
 :pattern ( (_module.Object.universe |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 (_module.Object.universe this@@32)) _module.Universe.content)) ($Box refType |o#0@@1|)))
))))))))))))))))))))
(let ((anon8_correct  (=> (= (_module.Thread.inv $Heap@@19 this@@32)  (and true (_module.Thread.localInv $Heap@@19 this@@32))) (=> (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Thread.localInv#canCall| $Heap@@19 this@@32)) ($Is boolType (bool_2_U (_module.Thread.inv $Heap@@19 this@@32)) TBool)) (and (=> (= (ControlFlow 0 11) (- 0 12)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (=> (= (ControlFlow 0 11) 6) GeneratedUnifiedExit_correct)))))))
...
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@32) Tclass._module.Thread? $Heap@@19)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@32 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@19 $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.372:8|
 :skolemid |1536|
))) (|_module.Thread.localInv#canCall| $Heap@@19 this@@32)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 13) 11))) anon8_correct))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (and (=> (_module.Thread.inv $Heap@@19 this@@32) (_module.Thread.localInv $Heap@@19 this@@32)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon11_Then_correct  (=> ($IsAllocBox ($Box refType this@@32) Tclass._module.Thread? $Heap@@19) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@32 this@@32) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@32 this@@32) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@32 this@@32) (|_module.Thread.inv#canCall| $Heap@@19 this@@32)) (_module.Thread.inv $Heap@@19 this@@32)) (=> (and (and ($IsAllocBox ($Box refType this@@32) Tclass._module.Thread? $Heap@@19) (|_module.Thread.localInv#canCall| $Heap@@19 this@@32)) (and (_module.Thread.localInv $Heap@@19 this@@32) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#59| null $Heap@@19 alloc $Heap@@19 alloc)) (and (and (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)) (=> (= (ControlFlow 0 15) 2) anon11_Then_correct)) (=> (= (ControlFlow 0 15) 4) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@19) ($IsHeapAnchor $Heap@@19)) (=> (and (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.Thread) ($IsAlloc refType this@@32 Tclass._module.Thread $Heap@@19))) (and (= 10 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
