...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split381)
...
)) (= $Heap@5 $Heap@6))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@5)) (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@5) (= (ControlFlow 0 2) (- 0 1))))))))) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@5))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
