...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.Integer.localUserInv#canCall| $Heap@@3 this@@8) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.Integer)))) (= (_module.OwnedObject.localUserInv $Heap@@3 this@@8) (_module.Integer.localUserInv $Heap@@3 this@@8)))
 :qid |_10SequenceInvariantdfy.395:19|
 :skolemid |1799|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@8) ($Is refType this@@8 Tclass._module.Integer) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@8) (_module.Integer.localUserInv $Heap@@3 this@@8) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.Integer.userInv#canCall| $Heap@@4 this@@9) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.Integer)))) (= (_module.OwnedObject.userInv $Heap@@4 this@@9) (_module.Integer.userInv $Heap@@4 this@@9)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1806|
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@9) ($Is refType this@@9 Tclass._module.Integer) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@9) (_module.Integer.userInv $Heap@@4 this@@9) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.Integer.baseUserFieldsInv#canCall| $Heap@@6 this@@11) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.Integer)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@11) (_module.Integer.baseUserFieldsInv $Heap@@6 this@@11)))
 :qid |_10SequenceInvariantdfy.392:19|
 :skolemid |1778|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@11) ($Is refType this@@11 Tclass._module.Integer) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@11) (_module.Integer.baseUserFieldsInv $Heap@@6 this@@11) ($IsGoodHeap $Heap@@6))
))))
...
(assert (forall (($o@@40 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@40 Tclass._module.Integer? $heap@@1) ($IsAlloc refType $o@@40 Tclass._module.OwnedObject? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |2418|
 :pattern ( ($IsAlloc refType $o@@40 Tclass._module.Integer? $heap@@1))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@38 T@U) ($Heap@@37 T@U) (this@@57 T@U) ) (!  (=> (or (|_module.Integer.userInv2#canCall| $prevHeap@@38 $Heap@@37 this@@57) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@38) ($IsGoodHeap $Heap@@37)) ($HeapSucc $prevHeap@@38 $Heap@@37)) (and (or (not (= this@@57 null)) (not true)) (and ($Is refType this@@57 Tclass._module.Integer) ($IsAlloc refType this@@57 Tclass._module.Integer $prevHeap@@38)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Integer.localUserInv2#canCall| $prevHeap@@38 $Heap@@37 this@@57)) (= (_module.Integer.userInv2 $prevHeap@@38 $Heap@@37 this@@57)  (and true (_module.Integer.localUserInv2 $prevHeap@@38 $Heap@@37 this@@57)))))
 :qid |_10SequenceInvariantdfy.478:22|
 :skolemid |1820|
 :pattern ( (_module.Integer.userInv2 $prevHeap@@38 $Heap@@37 this@@57) ($IsGoodHeap $Heap@@37))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@39 T@U) ($Heap@@38 T@U) (this@@58 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@39 $Heap@@38 this@@58) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@39) ($IsGoodHeap $Heap@@38)) ($HeapSucc $prevHeap@@39 $Heap@@38)) (and (or (not (= this@@58 null)) (not true)) (and ($Is refType this@@58 Tclass._module.OwnedObject) ($IsAlloc refType this@@58 Tclass._module.OwnedObject $prevHeap@@39)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.localUserInv2#canCall| $prevHeap@@39 $Heap@@38 this@@58)) (= (_module.OwnedObject.localInv2 $prevHeap@@39 $Heap@@38 this@@58)  (and true (_module.OwnedObject.localUserInv2 $prevHeap@@39 $Heap@@38 this@@58)))))
 :qid |_10SequenceInvariantdfy.334:22|
 :skolemid |1486|
 :pattern ( (_module.OwnedObject.localInv2 $prevHeap@@39 $Heap@@38 this@@58) ($IsGoodHeap $Heap@@38))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@40 T@U) ($Heap@@39 T@U) (this@@59 T@U) ) (!  (=> (or (|_module.Integer.localUserInv2#canCall| $prevHeap@@40 $Heap@@39 this@@59) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@40) ($IsGoodHeap $Heap@@39)) ($HeapSucc $prevHeap@@40 $Heap@@39)) (and (or (not (= this@@59 null)) (not true)) (and ($Is refType this@@59 Tclass._module.Integer) ($IsAlloc refType this@@59 Tclass._module.Integer $prevHeap@@40)))))) (= (_module.Integer.localUserInv2 $prevHeap@@40 $Heap@@39 this@@59) (U_2_bool (Lit boolType (bool_2_U  (and true true))))))
 :qid |_10SequenceInvariantdfy.475:22|
 :skolemid |1813|
 :pattern ( (_module.Integer.localUserInv2 $prevHeap@@40 $Heap@@39 this@@59) ($IsGoodHeap $Heap@@39))
))))
...
(assert (forall (($h@@16 T@U) ($o@@48 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@48 null)) (not true)) (= (dtype $o@@48) Tclass._module.Integer?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@48) _module.Integer.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1771|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@48) _module.Integer.value)))
)))
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.Integer) ($IsAlloc refType this@@90 Tclass._module.Integer $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@64 T@U) ($f@@47 T@U) ) (!  (=> (and (or (not (= $o@@64 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@64) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@64) $f@@47) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@64) $f@@47)))
 :qid |unknown.0:0|
 :skolemid |1794|
)) (= (_module.Integer.localUserInv $h0@@37 this@@90) (_module.Integer.localUserInv $h1@@37 this@@90))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1795|
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.Integer.localUserInv $h1@@37 this@@90))
)))
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@91 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.Integer) ($IsAlloc refType this@@91 Tclass._module.Integer $h0@@38)))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@65 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@65) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@65) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |1801|
)) (= (_module.Integer.userInv $h0@@38 this@@91) (_module.Integer.userInv $h1@@38 this@@91))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1802|
 :pattern ( ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38) (_module.Integer.userInv $h1@@38 this@@91))
)))
...
(assert (forall (($o@@68 T@U) ) (!  (=> ($Is refType $o@@68 Tclass._module.Integer?) ($Is refType $o@@68 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2417|
 :pattern ( ($Is refType $o@@68 Tclass._module.Integer?))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@45 T@U) ($Heap@@53 T@U) (this@@93 T@U) ) (!  (=> (or (|_module.Integer.userInv2#canCall| $prevHeap@@45 $Heap@@53 this@@93) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@45) ($IsGoodHeap $Heap@@53)) ($HeapSucc $prevHeap@@45 $Heap@@53)) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.Integer) ($IsAlloc refType this@@93 Tclass._module.Integer $prevHeap@@45)))))) (=> (_module.Integer.userInv2 $prevHeap@@45 $Heap@@53 this@@93) (_module.Integer.localUserInv2 $prevHeap@@45 $Heap@@53 this@@93)))
 :qid |_10SequenceInvariantdfy.478:22|
 :skolemid |1818|
 :pattern ( (_module.Integer.userInv2 $prevHeap@@45 $Heap@@53 this@@93))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@55 T@U) (this@@95 T@U) ) (!  (=> (or (|_module.Integer.userInv#canCall| $Heap@@55 this@@95) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@55) (and (or (not (= this@@95 null)) (not true)) (and ($Is refType this@@95 Tclass._module.Integer) ($IsAlloc refType this@@95 Tclass._module.Integer $Heap@@55)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.Integer.localUserInv#canCall| $Heap@@55 this@@95)) (= (_module.Integer.userInv $Heap@@55 this@@95)  (and true (_module.Integer.localUserInv $Heap@@55 this@@95)))))
 :qid |_10SequenceInvariantdfy.471:19|
 :skolemid |1805|
 :pattern ( (_module.Integer.userInv $Heap@@55 this@@95) ($IsGoodHeap $Heap@@55))
))))
...
(set-info :boogie-vc-id Impl$$_module.Integer.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#57| null $Heap@@59 alloc |universe#0|)) (and (=> (= (ControlFlow 0 2) (- 0 29)) true) (and (=> (= (ControlFlow 0 2) (- 0 28)) true) (=> (and (or (not (= this@@99 null)) (not true)) ($Is refType this@@99 Tclass._module.Integer?)) (=> (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@59 this@@99) alloc)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@59 this@@99) _module.OwnedObject.nonvolatileVersion))) this.nonvolatileVersion)) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@59 this@@99) _module.OwnedObject.owner)) |running#0@@3|) (= (_module.Object.universe this@@99) |universe#0|))) (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@59 this@@99) _module.Integer.value))) |value#0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@59 this@@99 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@59 this@@99) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 27)) (forall (($o@@75 T@U) ($f@@49 T@U) ) (!  (=> (and (and (or (not (= $o@@75 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@75) alloc)))) (= $o@@75 (_module.Object.universe this@@99))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@75 $f@@49)))
 :qid |_10SequenceInvariantdfy.497:9|
 :skolemid |1975|
...
)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (_module.Object.universe this@@99) |universe#0|)) (=> (= (_module.Object.universe this@@99) |universe#0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@99) _module.OwnedObject.owner)) |running#0@@3|)) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@99) _module.OwnedObject.owner)) |running#0@@3|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@99) _module.Integer.value))) |value#0|)) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@99) _module.Integer.value))) |value#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@59 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@99)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
