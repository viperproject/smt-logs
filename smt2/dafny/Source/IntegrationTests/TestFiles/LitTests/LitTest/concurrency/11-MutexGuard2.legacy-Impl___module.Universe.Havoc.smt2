...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@2 this@@2) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.Thread)))) (= (_module.Object.baseFieldsInv $Heap@@2 this@@2) (_module.Thread.baseFieldsInv $Heap@@2 this@@2)))
 :qid |_11MutexGuard2legacydfy.245:19|
 :skolemid |1217|
 :pattern ( (_module.Object.baseFieldsInv $Heap@@2 this@@2) ($Is refType this@@2 Tclass._module.Thread) ($IsGoodHeap $Heap@@2))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@2 this@@2) (_module.Thread.baseFieldsInv $Heap@@2 this@@2) ($IsGoodHeap $Heap@@2))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@3 this@@3) (and (< 4 $FunctionContextHeight) (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.OwnedObject)))) (= (_module.Object.baseFieldsInv $Heap@@3 this@@3) (_module.OwnedObject.baseFieldsInv $Heap@@3 this@@3)))
 :qid |_11MutexGuard2legacydfy.245:19|
 :skolemid |1509|
...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@4 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Universe) ($IsAlloc refType this@@4 Tclass._module.Universe $h0)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@0 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@0) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@0) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@0) $f)))
 :qid |unknown.0:0|
 :skolemid |672|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@7 alloc this@@14 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@7 this@@14) (or (_module.Universe.globalBaseInv $Heap@@7 this@@14) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@7 this@@14) (or (_module.Universe.globalBaseInv $Heap@@7 this@@14) (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@7 this@@14) (or (_module.Universe.globalBaseInv $Heap@@7 this@@14) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType |o#6|))) (and (and (and (= (_module.Object.universe |o#6|) this@@14) (or (not (= |o#6| this@@14)) (not true))) (_module.Object.baseFieldsInv $Heap@@7 |o#6|)) (_module.Object.triggerAxioms $Heap@@7 |o#6|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |864|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Universe) ($IsAlloc refType this@@14 Tclass._module.Universe $Heap@@7))) (= 8 $FunctionContextHeight)) (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@@7 this@@14) (and (_module.Universe.globalBaseInv $Heap@@7 this@@14) (and true (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@14) _module.Universe.content)) ($Box refType |o#5|))) (and (and (and (= (_module.Object.universe |o#5|) this@@14) (or (not (= |o#5| this@@14)) (not true))) (_module.Object.baseFieldsInv $Heap@@7 |o#5|)) (_module.Object.triggerAxioms $Heap@@7 |o#5|)))
 :qid |_11MutexGuard2legacydfy.18:16|
 :skolemid |863|
