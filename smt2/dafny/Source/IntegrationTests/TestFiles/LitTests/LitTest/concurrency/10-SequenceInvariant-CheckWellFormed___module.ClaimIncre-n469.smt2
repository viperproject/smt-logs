...
(set-info :boogie-vc-id CheckWellFormed$$_module.ClaimIncreasingCounterGreaterThanConstant.sequenceAdmissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#10| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@46) Tclass._module.Object? current$Heap) ($IsAlloc SetType |running#0@@3| (TSet Tclass._module.Thread) current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@46 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@26)) (=> ($IsAlloc refType this@@46 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@26) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc SetType |running#0@@3| (TSet Tclass._module.Thread) $Heap@@26)) (=> ($IsAlloc SetType |running#0@@3| (TSet Tclass._module.Thread) $Heap@@26) (=> (and (and (|_module.Object.goodPreAndLegalChangesSequence#canCall| $Heap@@26 current$Heap this@@46 |running#0@@3|) (_module.Object.goodPreAndLegalChangesSequence $Heap@@26 current$Heap this@@46 |running#0@@3|)) (and ($IsAllocBox ($Box refType this@@46) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@46 Tclass._module.ClaimIncreasingCounterGreaterThanConstant $Heap@@26))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@26) ($IsHeapAnchor $Heap@@26)) (and (or (not (= this@@46 null)) (not true)) (and ($Is refType this@@46 Tclass._module.ClaimIncreasingCounterGreaterThanConstant) ($IsAlloc refType this@@46 Tclass._module.ClaimIncreasingCounterGreaterThanConstant previous$Heap)))) (=> (and (and (and ($Is SetType |running#0@@3| (TSet Tclass._module.Thread)) ($IsAlloc SetType |running#0@@3| (TSet Tclass._module.Thread) previous$Heap)) (= 10 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@26) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc SetType |running#0@@3| (TSet Tclass._module.Thread) previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
