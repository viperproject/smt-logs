...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split154)
...
)))))))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@@132 |universe#0|) (or (_module.Universe.globalInv $Heap@@132 |universe#0|) (forall ((|o#1@@7| T@U) ) (!  (=> (and ($Is refType |o#1@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@7|))) (_module.Object.inv $Heap@@132 |o#1@@7|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |2277|
 :pattern ( (_module.Object.inv $Heap@@132 |o#1@@7|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@132 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@7|)))
