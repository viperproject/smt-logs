...
(assert (forall (($prevHeap@@0 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.Object) ($IsAlloc refType this@@0 Tclass._module.Object $h0@@0)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@0 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@0) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@0) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@0) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |1326|
)) (= (_module.Object.transitiveInv2 $prevHeap@@0 $h0@@0 this@@0) (_module.Object.transitiveInv2 $prevHeap@@0 $h1@@0 this@@0))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1327|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.Object.transitiveInv2 $prevHeap@@0 $h1@@0 this@@0))
)))
...
(let ((anon8_Else_correct  (=> (and (=> (_module.Object.inv2 $Heap@@0 current$Heap this@@3) (and (_module.Object.localInv2 $Heap@@0 current$Heap this@@3) (_module.Object.transitiveInv2 $Heap@@0 current$Heap this@@3))) (= (ControlFlow 0 8) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($IsAllocBox ($Box refType this@@3) Tclass._module.Object? current$Heap) (and (=> (= (ControlFlow 0 3) (- 0 7)) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@0)) (=> ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (= this@@3 this@@3) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@3 this@@3) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (or (= this@@3 this@@3) (|_module.Object.inv2#canCall| $Heap@@0 current$Heap this@@3)) (=> (and (_module.Object.inv2 $Heap@@0 current$Heap this@@3) ($IsAllocBox ($Box refType this@@3) Tclass._module.Object? current$Heap)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@0)) (=> ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@0) (=> (|_module.Object.localInv2#canCall| $Heap@@0 current$Heap this@@3) (=> (and (_module.Object.localInv2 $Heap@@0 current$Heap this@@3) ($IsAllocBox ($Box refType this@@3) Tclass._module.Object? current$Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@0)) (=> ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@0) (=> (|_module.Object.transitiveInv2#canCall| $Heap@@0 current$Heap this@@3) (=> (and (_module.Object.transitiveInv2 $Heap@@0 current$Heap this@@3) (= (ControlFlow 0 3) 2)) anon5_correct)))))))))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Object) ($IsAlloc refType this@@3 Tclass._module.Object previous$Heap))) (= 7 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 10) 9))) anon0_correct))))
