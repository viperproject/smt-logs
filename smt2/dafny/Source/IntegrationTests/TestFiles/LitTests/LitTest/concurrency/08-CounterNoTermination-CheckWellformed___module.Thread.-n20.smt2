...
(assert (distinct TBool TagBool TagSet alloc allocName Tagclass._module.Universe Tagclass._module.NonOwnedObject class._module.Universe? Tagclass._module.Universe? Tagclass._module.Object Tagclass._module.Object? Tagclass._module.Thread Tagclass._module.NonOwnedObject? Tagclass._module.Thread? tytagFamily$Universe tytagFamily$NonOwnedObject tytagFamily$Object tytagFamily$Thread field$content)
)
(assert (= (FDim alloc) 0))
...
(let ((anon12_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) ($IsAllocBox ($Box refType this@@4) Tclass._module.Thread? $Heap@@4)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@16 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@16 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@16) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@16) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@16 $f@@0)))
 :qid |_08CounterNoTerminationdfy.138:8|
 :skolemid |804|
