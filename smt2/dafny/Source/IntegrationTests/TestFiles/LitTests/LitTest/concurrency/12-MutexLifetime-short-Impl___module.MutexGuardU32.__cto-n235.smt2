...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@81) ($IsHeapAnchor $Heap@@81)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@81))) (=> (and (and (and ($Is refType |running#0| Tclass._module.Thread) ($IsAlloc refType |running#0| Tclass._module.Thread $Heap@@81)) (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@81))) (and (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@81)) (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@81)))) (=> (and (and (and (and (and (=> |defass#lifetime#0| (and ($Is refType |lifetime#0| Tclass._module.Lifetime) ($IsAlloc refType |lifetime#0| Tclass._module.Lifetime $Heap@@81))) true) (= 23 $FunctionContextHeight)) (and (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|) (and (_module.Universe.globalInv $Heap@@81 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@81 |universe#0|) (forall ((|o#10| T@U) ) (!  (=> (and ($Is refType |o#10| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |o#10|))) (_module.Object.inv $Heap@@81 |o#10|))
 :qid |_12MutexLifetimeshortdfy.23:32|
 :skolemid |3436|
...
)))))) (and (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0|)) ($Box refType |scope#0|)) ($Box refType |mutex#0|)) ($Box refType |mutexScope#0|)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content))) (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |scope#0|) _module.Lifetime.owner)) |running#0|)) (and (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |mutexScope#0|) _module.Lifetime.owner)) |running#0|) (or (not (= |scope#0| |mutexScope#0|)) (not true))))) (and (and (and (and (|_module.Universe.outlives#canCall| $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (and (_module.Universe.outlives ($LS $LZ) $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (or (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |mutexScope#0|) _module.Lifetime.mightPointTo)) ($Box refType (_module.OwnedObject.lifetime |mutex#0|))) (exists ((|x#2| T@U) ) (!  (and (and ($Is refType |x#2| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |x#2|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |x#2| |mutexScope#0|))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |3438|
...
)))))) (and (and (|_module.Lifetime.unused#canCall| $Heap@@81 |scope#0|) (and (_module.Lifetime.unused $Heap@@81 |scope#0|) (and (|Set#Equal| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |scope#0|) _module.Lifetime.mightPointFrom)) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |scope#0|) _module.Lifetime.elements)) |Set#Empty|)))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |mutex#0|) _module.Mutex.locked)))) (= $_ModifiesFrame@0 (|lambda#250| null $Heap@@81 alloc |universe#0| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) Tclass._module.Lifetime ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) $Heap@@81 _module.Lifetime.owner |running#0| |scope#0| |mutexScope#0|))))) (and (and (and (= |mightPointTo##0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |mutexScope#0|))) (forall (($o@@54 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 $o@@54) alloc)))) (or (= $o@@54 |universe#0|) (and (|Set#IsMember| |mightPointTo##0@0| ($Box refType $o@@54)) (= $f@@0 _module.Lifetime.mightPointFrom)))) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $o@@54 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.910:21|
 :skolemid |3460|
))) (and (or (not (= call5formal@this null)) (not true)) (and ($Is refType call5formal@this Tclass._module.Lifetime) ($IsAlloc refType call5formal@this Tclass._module.Lifetime $Heap@@81)))) (and (and (=> (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalInv $Heap@@81 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@81 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalInv $Heap@@81 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@@81 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@@81 |universe#0|) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@5|))) (and (and (and (= (_module.Object.universe |o#0@@5|) |universe#0|) (or (not (= |o#0@@5| |universe#0|)) (not true))) (_module.Object.baseFieldsInv $Heap@@81 |o#0@@5|)) (_module.Object.triggerAxioms $Heap@@81 |o#0@@5|)))
 :qid |_12MutexLifetimeshortdfy.17:16|
 :skolemid |2275|
...
)))) (= (ControlFlow 0 2) (- 0 1))))))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0|)) ($Box refType |running#0|)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
