...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split37)
...
))))) (and (forall (($o@@116 T@U) ) (!  (=> (and (or (not (= $o@@116 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@116) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@116) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@116)) (or (= $o@@116 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType $o@@116)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@116))
)) ($HeapSucc $Heap@2 $Heap@3))) (and (and (or (not (= |universe#0| null)) (not true)) (forall (($o@@117 T@U) ($f@@69 T@U) ) (!  (=> (and (and (or (not (= $o@@117 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@117) alloc)))) (or (= $o@@117 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType $o@@117)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@117 $f@@69)))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |531|
))) (and (= |$Frame$loop#0@0| (|lambda#0| null $Heap@3 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)))) (= |$decr_init$loop#00@0| (- 10 |i#0@0|))))) (and (and (and (=> |$w$loop#0@0| (=> (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#16|))) (and (= (_module.Object.universe |o#16|) |universe#0|) (or (not (= |o#16| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |532|
