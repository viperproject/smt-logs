...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split96)
...
))) (and (and ($HeapSucc $Heap@7 $Heap@8) (or (not (= |call4formal@guard#0@0| null)) (not true))) (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex)) null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |call4formal@guard#0@0|) _module.MutexGuardU32.mutex))) _module.Mutex.data)) null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
