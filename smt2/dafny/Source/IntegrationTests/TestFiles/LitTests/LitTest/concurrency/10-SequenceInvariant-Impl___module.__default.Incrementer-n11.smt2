...
))))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |running#0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |counter#0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)) ($Box refType |remaining#0|)))) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |remaining#0|) _module.OwnedObject.owner)) |running#0|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |remaining#0|) _module.Integer.value))) (LitInt 10))) (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@51 alloc |universe#0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |universe#0|) _module.Universe.content)))) (= (ControlFlow 0 2) (- 0 1)))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
