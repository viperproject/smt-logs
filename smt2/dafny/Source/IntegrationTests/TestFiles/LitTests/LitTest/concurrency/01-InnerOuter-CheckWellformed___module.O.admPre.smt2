...
(assert  (=> (< 1 $FunctionContextHeight) (forall (($h@@5 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@10 null)) (not true)) ($Is refType $o@@10 Tclass._module.O?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@10) alloc)))) ($IsAlloc refType (_module.O.s $o@@10) Tclass._module.S $h@@5))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |619|
 :pattern ( (_module.O.s $o@@10) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@10) alloc)))
))))
(assert  (=> (< 1 $FunctionContextHeight) (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) ($Is refType $o@@11 Tclass._module.O?)) ($Is refType (_module.O.s $o@@11) Tclass._module.S))
 :qid |unknown.0:0|
 :skolemid |618|
 :pattern ( (_module.O.s $o@@11))
))))
...
))) (|_module.O.i2#canCall| $prevHeap@@7 $Heap@@5 |o#0@@6|)) (=> (or (forall (($o@@13 T@U) ($f@@8 T@U) ) (!  (=> (or (not (= $o@@13 null)) (not true)) (=> (= $o@@13 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@13) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@7 $o@@13) $f@@8))))
 :qid |_01InnerOuterdfy.27:72|
 :skolemid |536|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@13) $f@@8))
)) (_module.O.i2 $prevHeap@@7 $Heap@@5 |o#0@@6|)) (=> (not (forall (($o@@14 T@U) ($f@@9 T@U) ) (!  (=> (or (not (= $o@@14 null)) (not true)) (=> (= $o@@14 |o#0@@6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@14) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@7 $o@@14) $f@@9))))
 :qid |_01InnerOuterdfy.27:72|
 :skolemid |535|
...
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@14 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.S))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@18 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (or (= $o@@18 this@@14) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@14) _module.S.obs)) ($Box refType $o@@18)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@18) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@18) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |492|
...
(set-info :boogie-vc-id CheckWellformed$$_module.O.admPre)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon10_correct  (=> (= (_module.O.admPre $Heap@@7 current$Heap this@@20)  (and (and (and (_module.O.i0 current$Heap this@@20) (and (_module.O.i0 $Heap@@7 this@@20) (_module.S.i $Heap@@7 (_module.O.s this@@20)))) (forall (($o@@26 T@U) ($f@@16 T@U) ) (!  (=> (or (not (= $o@@26 null)) (not true)) (=> (= $o@@26 this@@20) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@26) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@26) $f@@16))))
 :qid |_01InnerOuterdfy.62:71|
 :skolemid |649|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@26) $f@@16))
))) (_module.S.legal $Heap@@7 current$Heap (_module.O.s this@@20)))) (=> (and (and (|_module.O.i0#canCall| current$Heap this@@20) (=> (_module.O.i0 current$Heap this@@20) (and (and (|_module.O.i0#canCall| $Heap@@7 this@@20) (=> (_module.O.i0 $Heap@@7 this@@20) (|_module.S.i#canCall| $Heap@@7 (_module.O.s this@@20)))) (=> (and (_module.O.i0 $Heap@@7 this@@20) (_module.S.i $Heap@@7 (_module.O.s this@@20))) (=> (forall (($o@@27 T@U) ($f@@17 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 this@@20) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@27) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@27) $f@@17))))
 :qid |_01InnerOuterdfy.62:71|
 :skolemid |650|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@27) $f@@17))
)) (|_module.S.legal#canCall| $Heap@@7 current$Heap (_module.O.s this@@20))))))) ($Is boolType (bool_2_U (_module.O.admPre $Heap@@7 current$Heap this@@20)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))))
(let ((anon16_Else_correct  (=> (not (and (and (_module.O.i0 current$Heap this@@20) (and (_module.O.i0 $Heap@@7 this@@20) (_module.S.i $Heap@@7 (_module.O.s this@@20)))) (forall (($o@@28 T@U) ($f@@18 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 this@@20) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@28) $f@@18))))
 :qid |_01InnerOuterdfy.62:71|
 :skolemid |647|
...
(let ((anon16_Then_correct  (=> (and (and (_module.O.i0 current$Heap this@@20) (and (_module.O.i0 $Heap@@7 this@@20) (_module.S.i $Heap@@7 (_module.O.s this@@20)))) (forall (($o@@29 T@U) ($f@@19 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 this@@20) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@29) $f@@19))))
 :qid |_01InnerOuterdfy.62:71|
 :skolemid |647|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@19))
))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= (_module.O.s this@@20) null)) (not true))) (=> (or (not (= (_module.O.s this@@20) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.O.s this@@20)) Tclass._module.S? current$Heap) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType (_module.O.s this@@20) Tclass._module.S $Heap@@7)) (=> ($IsAlloc refType (_module.O.s this@@20) Tclass._module.S $Heap@@7) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@30 T@U) ($f@@20 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@30) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@30) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@30 $f@@20)))
 :qid |_01InnerOuterdfy.62:92|
 :skolemid |646|
))) (|_module.S.legal#canCall| $Heap@@7 current$Heap (_module.O.s this@@20))) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon10_correct)))))))))
(let ((anon15_Else_correct  (=> (and (not (and (_module.O.i0 current$Heap this@@20) (and (_module.O.i0 $Heap@@7 this@@20) (_module.S.i $Heap@@7 (_module.O.s this@@20))))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 12) 6) anon16_Then_correct) (=> (= (ControlFlow 0 12) 9) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (_module.O.i0 current$Heap this@@20) (and (_module.O.i0 $Heap@@7 this@@20) (_module.S.i $Heap@@7 (_module.O.s this@@20)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) ($IsAlloc refType this@@20 Tclass._module.O $Heap@@7)) (=> ($IsAlloc refType this@@20 Tclass._module.O $Heap@@7) (=> (and (= |b$reqreads#1@0| (forall (($o@@31 T@U) ($f@@21 T@U) ) (!  (=> (and (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@31) alloc)))) (= $o@@31 this@@20)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@31 $f@@21)))
 :qid |_01InnerOuterdfy.62:81|
 :skolemid |645|
))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 10) 6) anon16_Then_correct) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct))))))))
(let ((anon14_Else_correct  (=> (not (_module.O.i0 $Heap@@7 this@@20)) (and (=> (= (ControlFlow 0 18) 10) anon15_Then_correct) (=> (= (ControlFlow 0 18) 12) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (_module.O.i0 $Heap@@7 this@@20) (and (=> (= (ControlFlow 0 14) (- 0 17)) ($IsAlloc refType this@@20 Tclass._module.O $Heap@@7)) (=> ($IsAlloc refType this@@20 Tclass._module.O $Heap@@7) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= (_module.O.s this@@20) null)) (not true))) (=> (or (not (= (_module.O.s this@@20) null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType (_module.O.s this@@20) Tclass._module.S $Heap@@7)) (=> ($IsAlloc refType (_module.O.s this@@20) Tclass._module.S $Heap@@7) (=> (|_module.S.i#canCall| $Heap@@7 (_module.O.s this@@20)) (and (=> (= (ControlFlow 0 14) 10) anon15_Then_correct) (=> (= (ControlFlow 0 14) 12) anon15_Else_correct))))))))))))
(let ((anon13_Then_correct  (=> (_module.O.i0 current$Heap this@@20) (and (=> (= (ControlFlow 0 19) (- 0 20)) ($IsAlloc refType this@@20 Tclass._module.O $Heap@@7)) (=> ($IsAlloc refType this@@20 Tclass._module.O $Heap@@7) (=> (|_module.O.i0#canCall| $Heap@@7 this@@20) (and (=> (= (ControlFlow 0 19) 14) anon14_Then_correct) (=> (= (ControlFlow 0 19) 18) anon14_Else_correct))))))))
(let ((anon13_Else_correct  (=> (not (_module.O.i0 current$Heap this@@20)) (and (=> (= (ControlFlow 0 13) 10) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon12_Else_correct  (=> ($IsAllocBox ($Box refType this@@20) Tclass._module.O? current$Heap) (=> (and (= |b$reqreads#0@0| (forall (($o@@32 T@U) ($f@@22 T@U) ) (!  (=> (and (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@32) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@32) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@32 $f@@22)))
 :qid |_01InnerOuterdfy.62:41|
 :skolemid |644|
))) (|_module.O.i0#canCall| current$Heap this@@20)) (and (=> (= (ControlFlow 0 21) 19) anon13_Then_correct) (=> (= (ControlFlow 0 21) 13) anon13_Else_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.O) ($IsAlloc refType this@@20 Tclass._module.O previous$Heap))) (= 9 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@7) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 23) 22))) anon0_correct))))
