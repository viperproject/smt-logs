...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split70)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon2_correct  (=> (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (=> (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222)))) (=> (and (and (_module.Universe.outlives ($LS ($LS $LZ)) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| |mutexScope#0| (_module.OwnedObject.lifetime this@@222))) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@11) (= |##a#4@0| (_module.OwnedObject.lifetime |mutex#0|)))) (=> (and (and (and ($IsAlloc refType |##a#4@0| Tclass._module.Lifetime $Heap@11) (= |##b#4@0| (_module.OwnedObject.lifetime this@@222))) (and ($IsAlloc refType |##b#4@0| Tclass._module.Lifetime $Heap@11) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)))) (and (and (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.outlives#canCall| $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)))) (or (_module.Universe.outlives ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) (_module.OwnedObject.lifetime this@@222)) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 (_module.OwnedObject.lifetime this@@222)) _module.Lifetime.mightPointTo)) ($Box refType (_module.OwnedObject.lifetime |mutex#0|))) (exists ((|x#6| T@U) ) (!  (and (and ($Is refType |x#6| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@11 |universe#0|) _module.Universe.content)) ($Box refType |x#6|))) (_module.Universe.outlivesThrough ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |x#6| (_module.OwnedObject.lifetime this@@222)))
 :qid |_12MutexLifetimeshortdfy.162:36|
 :skolemid |3470|
 :pattern ( (_module.Universe.outlivesThrough ($LS $LZ) $Heap@11 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |x#6| (_module.OwnedObject.lifetime this@@222)))
