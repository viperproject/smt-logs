...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@17 this@@17) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Mutex) ($IsAlloc refType this@@17 Tclass._module.Mutex $Heap@@17)))))) (= (_module.Mutex.objectUserFields $Heap@@17 this@@17) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@17) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@17 this@@17) _module.Mutex.data)))))
 :qid |_12MutexLifetimelongdfy.764:18|
 :skolemid |3271|
 :pattern ( (_module.Mutex.objectUserFields $Heap@@17 this@@17) ($IsGoodHeap $Heap@@17))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.OwnedU32.objectUserFields#canCall| $Heap@@18 this@@18) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@18 null)) (not true)) ($Is refType this@@18 Tclass._module.OwnedU32)))) (= (_module.OwnedObject.objectUserFields $Heap@@18 this@@18) (_module.OwnedU32.objectUserFields $Heap@@18 this@@18)))
 :qid |_12MutexLifetimelongdfy.519:18|
 :skolemid |2725|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@18 this@@18) ($Is refType this@@18 Tclass._module.OwnedU32) ($IsGoodHeap $Heap@@18))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@18 this@@18) (_module.OwnedU32.objectUserFields $Heap@@18 this@@18) ($IsGoodHeap $Heap@@18))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Mutex.objectUserFields#canCall| $Heap@@19 this@@19) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@19 null)) (not true)) ($Is refType this@@19 Tclass._module.Mutex)))) (= (_module.OwnedObject.objectUserFields $Heap@@19 this@@19) (_module.Mutex.objectUserFields $Heap@@19 this@@19)))
 :qid |_12MutexLifetimelongdfy.519:18|
 :skolemid |3272|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@19 this@@19) ($Is refType this@@19 Tclass._module.Mutex) ($IsGoodHeap $Heap@@19))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@19 this@@19) (_module.Mutex.objectUserFields $Heap@@19 this@@19) ($IsGoodHeap $Heap@@19))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.MutexGuardU32.objectUserFields#canCall| $Heap@@20 this@@20) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@20 null)) (not true)) ($Is refType this@@20 Tclass._module.MutexGuardU32)))) (= (_module.OwnedObject.objectUserFields $Heap@@20 this@@20) (_module.MutexGuardU32.objectUserFields $Heap@@20 this@@20)))
 :qid |_12MutexLifetimelongdfy.519:18|
 :skolemid |3563|
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@20 this@@20) ($Is refType this@@20 Tclass._module.MutexGuardU32) ($IsGoodHeap $Heap@@20))
 :pattern ( (_module.OwnedObject.objectUserFields $Heap@@20 this@@20) (_module.MutexGuardU32.objectUserFields $Heap@@20 this@@20) ($IsGoodHeap $Heap@@20))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@6 T@U) ($Heap@@21 T@U) (this@@21 T@U) (|a#0@@6| T@U) (|x#0@@5| T@U) (|b#0@@6| T@U) ) (!  (=> (and (and (and (and (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.Universe))) ($Is refType |a#0@@6| Tclass._module.Lifetime)) ($Is refType |x#0@@5| Tclass._module.Lifetime)) ($Is refType |b#0@@6| Tclass._module.Lifetime)) (exists ((|_k#0@@3| Int) ) (!  (and (<= (LitInt 0) |_k#0@@3|) (_module.Universe.outlivesThrough_h ($LS $ly@@6) $Heap@@21 this@@21 |_k#0@@3| |a#0@@6| |x#0@@5| |b#0@@6|))
 :qid |_12MutexLifetimelongdfy.166:19|
 :skolemid |1601|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $ly@@6) $Heap@@21 this@@21 |_k#0@@3| |a#0@@6| |x#0@@5| |b#0@@6|))
))) (_module.Universe.outlivesThrough ($LS $ly@@6) $Heap@@21 this@@21 |a#0@@6| |x#0@@5| |b#0@@6|))
 :qid |_12MutexLifetimelongdfy.166:19|
 :skolemid |1603|
 :pattern ( (_module.Universe.outlivesThrough ($LS $ly@@6) $Heap@@21 this@@21 |a#0@@6| |x#0@@5| |b#0@@6|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@7 T@U) ($Heap@@24 T@U) (this@@24 T@U) (|a#0@@7| T@U) (|b#0@@7| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $Heap@@24) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.Universe))) ($Is refType |a#0@@7| Tclass._module.Lifetime)) ($Is refType |b#0@@7| Tclass._module.Lifetime)) (exists ((|_k#0@@4| Int) ) (!  (and (<= (LitInt 0) |_k#0@@4|) (_module.Universe.outlives_h ($LS $ly@@7) $Heap@@24 this@@24 |_k#0@@4| |a#0@@7| |b#0@@7|))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1577|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@7) $Heap@@24 this@@24 |_k#0@@4| |a#0@@7| |b#0@@7|))
))) (_module.Universe.outlives ($LS $ly@@7) $Heap@@24 this@@24 |a#0@@7| |b#0@@7|))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1579|
 :pattern ( (_module.Universe.outlives ($LS $ly@@7) $Heap@@24 this@@24 |a#0@@7| |b#0@@7|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@25 T@U) (this@@25 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@25 this@@25) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@25) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.Object) ($IsAlloc refType this@@25 Tclass._module.Object $Heap@@25)))))) (and (|_module.Object.nonAliasing#canCall| $Heap@@25 this@@25) (= (_module.Object.triggerAxioms $Heap@@25 this@@25) (_module.Object.nonAliasing $Heap@@25 this@@25))))
 :qid |_12MutexLifetimelongdfy.315:19|
 :skolemid |1731|
 :pattern ( (_module.Object.triggerAxioms $Heap@@25 this@@25) ($IsGoodHeap $Heap@@25))
))))
...
(assert (forall (($ly@@8 T@U) ($Heap@@26 T@U) (this@@26 T@U) (|_k#0@@5| Int) (|a#0@@8| T@U) (|x#0@@6| T@U) (|b#0@@8| T@U) ) (! (= (_module.Universe.outlivesThrough_h ($LS $ly@@8) $Heap@@26 this@@26 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|) (_module.Universe.outlivesThrough_h $ly@@8 $Heap@@26 this@@26 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|))
 :qid |_12MutexLifetimelongdfy.166:19|
 :skolemid |1607|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $ly@@8) $Heap@@26 this@@26 |_k#0@@5| |a#0@@8| |x#0@@6| |b#0@@8|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@27 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.OwnedObject.objectFields#canCall| $Heap@@27 this@@27) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@27) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.OwnedObject) ($IsAlloc refType this@@27 Tclass._module.OwnedObject $Heap@@27)))))) (and (|_module.OwnedObject.objectUserFields#canCall| $Heap@@27 this@@27) (= (_module.OwnedObject.objectFields $Heap@@27 this@@27) (|Set#Union| (|Set#Union| (_module.OwnedObject.objectUserFields $Heap@@27 this@@27) (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@27)))) (ite (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 this@@27) _module.OwnedObject.owner)) null) |Set#Empty| (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 this@@27) _module.OwnedObject.owner)))))))
 :qid |_12MutexLifetimelongdfy.427:18|
 :skolemid |2126|
 :pattern ( (_module.OwnedObject.objectFields $Heap@@27 this@@27) ($IsGoodHeap $Heap@@27))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@9 T@U) ($Heap@@28 T@U) (this@@28 T@U) (|_k#0@@6| Int) (|a#0@@9| T@U) (|b#0@@9| T@U) ) (!  (=> (or (|_module.Universe.outlives_h#canCall| $Heap@@28 this@@28 |_k#0@@6| |a#0@@9| |b#0@@9|) (and (< 2 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $Heap@@28) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Universe) ($IsAlloc refType this@@28 Tclass._module.Universe $Heap@@28)))) (<= (LitInt 0) |_k#0@@6|)) ($Is refType |a#0@@9| Tclass._module.Lifetime)) ($Is refType |b#0@@9| Tclass._module.Lifetime)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@28) _module.Universe.content)) ($Box refType |a#0@@9|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@28) _module.Universe.content)) ($Box refType |b#0@@9|)))))) (and (=> (< 0 |_k#0@@6|) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 |b#0@@9|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@9|))) (forall ((|x#3| T@U) ) (!  (=> ($Is refType |x#3| Tclass._module.Lifetime) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@28) _module.Universe.content)) ($Box refType |x#3|)) (|_module.Universe.outlivesThrough_h#canCall| $Heap@@28 this@@28 (- |_k#0@@6| 1) |a#0@@9| |x#3| |b#0@@9|)))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |1592|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@28 this@@28 (- |_k#0@@6| 1) |a#0@@9| |x#3| |b#0@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@28) _module.Universe.content)) ($Box refType |x#3|)))
)))) (= (_module.Universe.outlives_h ($LS $ly@@9) $Heap@@28 this@@28 |_k#0@@6| |a#0@@9| |b#0@@9|)  (and (< 0 |_k#0@@6|) (or (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 |b#0@@9|) _module.Lifetime.mightPointTo)) ($Box refType |a#0@@9|)) (exists ((|x#3@@0| T@U) ) (!  (and (and ($Is refType |x#3@@0| Tclass._module.Lifetime) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@28) _module.Universe.content)) ($Box refType |x#3@@0|))) (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@28 this@@28 (- |_k#0@@6| 1) |a#0@@9| |x#3@@0| |b#0@@9|))
 :qid |_12MutexLifetimelongdfy.163:36|
 :skolemid |1591|
 :pattern ( (_module.Universe.outlivesThrough_h ($LS $LZ) $Heap@@28 this@@28 (- |_k#0@@6| 1) |a#0@@9| |x#3@@0| |b#0@@9|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@28) _module.Universe.content)) ($Box refType |x#3@@0|)))
)))))))
 :qid |_12MutexLifetimelongdfy.159:19|
 :skolemid |1593|
 :pattern ( (_module.Universe.outlives_h ($LS $ly@@9) $Heap@@28 this@@28 |_k#0@@6| |a#0@@9| |b#0@@9|) ($IsGoodHeap $Heap@@28))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@29 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.MutexGuardU32.localUserInv#canCall| $Heap@@29 this@@29) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.MutexGuardU32) ($IsAlloc refType this@@29 Tclass._module.MutexGuardU32 $Heap@@29)))))) (and (=> (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@29))) ($Box refType (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 (_module.Object.universe this@@29)) _module.Universe.content))) (|_module.Universe.outlives#canCall| $Heap@@29 (_module.Object.universe this@@29) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))) (_module.OwnedObject.lifetime this@@29))) (= (_module.MutexGuardU32.localUserInv $Heap@@29 this@@29)  (and (and (and (and (and (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType (_module.OwnedObject.lifetime this@@29))) ($Box refType (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))))) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 (_module.Object.universe this@@29)) _module.Universe.content))) (_module.Universe.outlives ($LS $LZ) $Heap@@29 (_module.Object.universe this@@29) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))) (_module.OwnedObject.lifetime this@@29))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))) _module.OwnedObject.owner)) null)) (not true))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))) _module.Mutex.locked)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@29)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))) _module.Mutex.data))) _module.OwnedObject.owner)) this@@29)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.mutex))) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 this@@29) _module.MutexGuardU32.data)))))))
 :qid |_12MutexLifetimelongdfy.858:19|
 :skolemid |3576|
 :pattern ( (_module.MutexGuardU32.localUserInv $Heap@@29 this@@29) ($IsGoodHeap $Heap@@29))
))))
...
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@47 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.Mutex.userInv#canCall| $Heap@@47 this@@50) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@47) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.Mutex) ($IsAlloc refType this@@50 Tclass._module.Mutex $Heap@@47)))))) (=> (_module.Mutex.userInv $Heap@@47 this@@50) (_module.Mutex.localUserInv $Heap@@47 this@@50)))
 :qid |_12MutexLifetimelongdfy.786:19|
 :skolemid |3290|
 :pattern ( (_module.Mutex.userInv $Heap@@47 this@@50))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 6) (- 0 12)) (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (= (_module.OwnedObject.lifetime this@@64) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data)))))))) (=> (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (= (_module.OwnedObject.lifetime this@@64) (_module.OwnedObject.lifetime ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))))))) (and (=> (= (ControlFlow 0 6) (- 0 11)) (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32)))))) (=> (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner)) Tclass._module.MutexGuardU32))))) (and (=> (= (ControlFlow 0 6) (- 0 10)) (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked))) (let ((|mutexGuard#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner))))
 (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |mutexGuard#0@@0|) _module.OwnedObject.owner)) null)) (not true)))))))) (=> (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked))) (let ((|mutexGuard#0@@1| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner))))
 (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |mutexGuard#0@@1|) _module.OwnedObject.owner)) null)) (not true))))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked))) (let ((|mutexGuard#0@@2| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner))))
(= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |mutexGuard#0@@2|) _module.MutexGuardU32.mutex)) this@@64))))))) (=> (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked))) (let ((|mutexGuard#0@@3| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner))))
(= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 |mutexGuard#0@@3|) _module.MutexGuardU32.mutex)) this@@64)))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked))) (let ((|mutexGuard#0@@4| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner))))
(|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType |mutexGuard#0@@4|))))))))) (=> (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked))) (let ((|mutexGuard#0@@5| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner))))
(|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) (|Set#UnionOne| |Set#Empty| ($Box refType |mutexGuard#0@@5|)))))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner)) this@@64)))))) (=> (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked)))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.data))) _module.OwnedObject.owner)) this@@64))))) (=> (= (ControlFlow 0 6) (- 0 5)) (=> (_module.Mutex.userInv $Heap@@51 this@@64) (=> (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (or (_module.Mutex.localUserInv $Heap@@51 this@@64) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.locked)))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) |Set#Empty|))))))))))))))))))))
(let ((anon11_correct  (=> (= (_module.Mutex.userInv $Heap@@51 this@@64)  (and (_module.Mutex.localUserInv $Heap@@51 this@@64) (forall ((|g#2| T@U) ) (!  (=> (and ($Is refType |g#2| Tclass._module.MutexGuardU32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) ($Box refType |g#2|))) (_module.OwnedObject.localInv $Heap@@51 |g#2|))
 :qid |_12MutexLifetimelongdfy.788:16|
 :skolemid |3299|
 :pattern ( (_module.OwnedObject.localInv $Heap@@51 |g#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) ($Box refType |g#2|)))
)))) (=> (and (and (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64) (=> (_module.Mutex.localUserInv $Heap@@51 this@@64) (forall ((|g#2@@0| T@U) ) (!  (=> ($Is refType |g#2@@0| Tclass._module.MutexGuardU32) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) ($Box refType |g#2@@0|)) (|_module.OwnedObject.localInv#canCall| $Heap@@51 |g#2@@0|)))
 :qid |_12MutexLifetimelongdfy.788:16|
 :skolemid |3300|
 :pattern ( (_module.OwnedObject.localInv $Heap@@51 |g#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) ($Box refType |g#2@@0|)))
)))) ($Is boolType (bool_2_U (_module.Mutex.userInv $Heap@@51 this@@64)) TBool)) (and (=> (= (ControlFlow 0 13) (- 0 16)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 13) (- 0 15)) |b$reqreads#1@2|) (=> |b$reqreads#1@2| (and (=> (= (ControlFlow 0 13) (- 0 14)) |b$reqreads#2@2|) (=> |b$reqreads#2@2| (=> (= (ControlFlow 0 13) 6) GeneratedUnifiedExit_correct)))))))))))
(let ((anon10_correct  (=> (= |b$reqreads#2@2| |b$reqreads#2@1|) (=> (and (= |b$reqreads#1@2| |b$reqreads#1@1|) (= (ControlFlow 0 18) 13)) anon11_correct))))
(let ((anon17_Else_correct  (=> (and (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) ($Box refType |g#1@0|))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 22) 18))) anon10_correct)))
(let ((anon17_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 this@@64) _module.Mutex.guards)) ($Box refType |g#1@0|)) (and (=> (= (ControlFlow 0 20) (- 0 21)) (or (not (= |g#1@0| null)) (not true))) (=> (or (not (= |g#1@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |g#1@0|) Tclass._module.OwnedObject? $Heap@@51) (= |b$reqreads#2@0| (forall (($o@@54 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 $o@@54) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 $o@@54) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@54 $f@@0)))
 :qid |_12MutexLifetimelongdfy.788:52|
 :skolemid |3297|
)))) (=> (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@51 |g#1@0|) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 20) 18))) anon10_correct)))))))
(let ((anon16_Then_correct  (=> (and (and ($Is refType |g#1@0| Tclass._module.MutexGuardU32) ($IsAlloc refType |g#1@0| Tclass._module.MutexGuardU32 $Heap@@51)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@64 _module.Mutex.guards)))) (and (=> (= (ControlFlow 0 23) 20) anon17_Then_correct) (=> (= (ControlFlow 0 23) 22) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (and (not (and ($Is refType |g#1@0| Tclass._module.MutexGuardU32) ($IsAlloc refType |g#1@0| Tclass._module.MutexGuardU32 $Heap@@51))) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 19) 18))) anon10_correct)))
(let ((anon15_Then_correct  (=> (_module.Mutex.localUserInv $Heap@@51 this@@64) (and (=> (= (ControlFlow 0 24) 23) anon16_Then_correct) (=> (= (ControlFlow 0 24) 19) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (not (_module.Mutex.localUserInv $Heap@@51 this@@64)) (= |b$reqreads#2@2| true)) (and (= |b$reqreads#1@2| true) (= (ControlFlow 0 17) 13))) anon11_correct)))
(let ((anon13_Else_correct  (=> ($IsAllocBox ($Box refType this@@64) Tclass._module.Mutex? $Heap@@51) (=> (and (= |b$reqreads#0@0| (forall (($o@@55 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@55 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 $o@@55) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@51 $o@@55) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@55 $f@@1)))
 :qid |_12MutexLifetimelongdfy.787:8|
 :skolemid |3296|
))) (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64)) (and (=> (= (ControlFlow 0 25) 24) anon15_Then_correct) (=> (= (ControlFlow 0 25) 17) anon15_Else_correct))))))
(let ((anon5_correct true))
(let ((anon14_Else_correct  (=> (and (=> (_module.Mutex.userInv $Heap@@51 this@@64) (_module.Mutex.localUserInv $Heap@@51 this@@64)) (= (ControlFlow 0 4) 1)) anon5_correct)))
(let ((anon14_Then_correct  (=> ($IsAllocBox ($Box refType this@@64) Tclass._module.Mutex? $Heap@@51) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@64 this@@64) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))))) (=> (or (= this@@64 this@@64) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (=> (and (or (= this@@64 this@@64) (|_module.Mutex.userInv#canCall| $Heap@@51 this@@64)) (_module.Mutex.userInv $Heap@@51 this@@64)) (=> (and (and ($IsAllocBox ($Box refType this@@64) Tclass._module.Mutex? $Heap@@51) (|_module.Mutex.localUserInv#canCall| $Heap@@51 this@@64)) (and (_module.Mutex.localUserInv $Heap@@51 this@@64) (= (ControlFlow 0 2) 1))) anon5_correct)))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#96| null $Heap@@51 alloc $Heap@@51 alloc)) (and (and (=> (= (ControlFlow 0 26) 25) anon13_Else_correct) (=> (= (ControlFlow 0 26) 2) anon14_Then_correct)) (=> (= (ControlFlow 0 26) 4) anon14_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@51) ($IsHeapAnchor $Heap@@51)) (=> (and (and (or (not (= this@@64 null)) (not true)) (and ($Is refType this@@64 Tclass._module.Mutex) ($IsAlloc refType this@@64 Tclass._module.Mutex $Heap@@51))) (and (= 12 $FunctionContextHeight) (= (ControlFlow 0 27) 26))) anon0_correct))))
