...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split139)
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@14 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|)))))) (and (and (and (and (and ($IsGoodHeap $Heap@15) ($IsHeapAnchor $Heap@15)) (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|)) (and (|_module.Universe.globalInv#canCall| $Heap@15 |universe#0|) (and (_module.Universe.globalInv $Heap@15 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@15 |universe#0|) (forall ((|o#3@@9| T@U) ) (!  (=> (and ($Is refType |o#3@@9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#3@@9|))) (_module.Object.inv $Heap@15 |o#3@@9|))
 :qid |_11MutexGuard2legacydfy.23:32|
 :skolemid |881|
...
)))))))) (and (and (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@87 $Heap@15 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@87 $Heap@15 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@@87 $Heap@15 |universe#0|)))))))) (or (_module.Universe.baseLegalTransitionsSequence $Heap@@87 $Heap@15 |universe#0|) (forall ((|o#13| T@U) ) (!  (=> (and ($Is refType |o#13| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#13|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#13|)))) (not ($IsAllocBox ($Box refType |o#13|) Tclass._module.Object $Heap@@87)))
 :qid |_11MutexGuard2legacydfy.45:16|
 :skolemid |566|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@15 |universe#0|) _module.Universe.content)) ($Box refType |o#13|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@87 |universe#0|) _module.Universe.content)) ($Box refType |o#13|)))
))))))))))
anon0_correct))
))
(check-sat)
