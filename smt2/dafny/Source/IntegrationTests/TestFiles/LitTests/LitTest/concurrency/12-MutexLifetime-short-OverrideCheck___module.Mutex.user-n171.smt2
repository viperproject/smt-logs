...
(assert (forall (($prevHeap@@0 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.Mutex) ($IsAlloc refType this@@0 Tclass._module.Mutex $h0@@0)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@2 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@2) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@2) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@2) $f@@0)))) (= (_module.Mutex.userInv2 $prevHeap@@0 $h0@@0 this@@0) (_module.Mutex.userInv2 $prevHeap@@0 $h1@@0 this@@0))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= Mutex_$_ReadsFrame@0 (|lambda#59| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@18 T@U) ($f@@2 T@U) )  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@18) alloc)))))) (=> (forall (($o@@19 T@U) ($f@@3 T@U) )  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@19) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@19) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@19) alloc))))) (=> (=> (_module.Mutex.userInv2 $Heap@@2 current$Heap this@@4) (_module.Mutex.localUserInv2 $Heap@@2 current$Heap this@@4)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.Mutex.userInv2 $Heap@@2 current$Heap this@@4) (=> (|_module.Mutex.localUserInv2#canCall| $Heap@@2 current$Heap this@@4) (or (_module.Mutex.localUserInv2 $Heap@@2 current$Heap this@@4) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.Mutex.userInv2 $Heap@@2 current$Heap this@@4) (=> (|_module.Mutex.localUserInv2#canCall| $Heap@@2 current$Heap this@@4) (or (_module.Mutex.localUserInv2 $Heap@@2 current$Heap this@@4) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.Mutex.userInv2 $Heap@@2 current$Heap this@@4) (=> (|_module.Mutex.localUserInv2#canCall| $Heap@@2 current$Heap this@@4) (or (_module.Mutex.localUserInv2 $Heap@@2 current$Heap this@@4) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@4) _module.Mutex.data)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@4) _module.Mutex.data)))))))))))))))))
