...
(set-info :boogie-vc-id Impl$$_module.__default.SetData_split40)
...
(assert (not
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |universe#0|) _module.Universe.content)) ($Box refType |o#11|)))
)))) (and (= $Heap@2 $Heap@3) (or (not (= |universe#0| null)) (not true)))) (and (and (forall (($o@@116 T@U) ($f@@69 T@U) ) (!  (=> (and (and (or (not (= $o@@116 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@116) alloc)))) (or (= $o@@116 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType $o@@116)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@116 $f@@69)))
 :qid |_11MutexGuard2legacydfy.670:24|
 :skolemid |573|
)) (= (ControlFlow 0 2) (- 0 1))) (|_module.Universe.globalInv#canCall| $Heap@3 |universe#0|))))))) (or (_module.Universe.globalInv $Heap@3 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@3 |universe#0|) (U_2_bool (Lit boolType (bool_2_U true)))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
