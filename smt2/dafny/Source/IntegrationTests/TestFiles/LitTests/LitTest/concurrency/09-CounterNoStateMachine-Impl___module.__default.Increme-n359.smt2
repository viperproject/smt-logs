...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split348)
...
)) (= $Heap@36 $Heap@37)) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37) (= |##running#0_0@1| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)))))))) (and (and (and (and (and ($IsAlloc SetType |##running#0_0@1| (TSet Tclass._module.Thread) $Heap@37) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33)) (and ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (TSet Tclass._module.Thread) $Heap@33) (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))))) (and (and (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)))) (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@37) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@37)))) (and (and (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33)) (and (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|))) (and (and (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (not (= |universe#0| null)) (not true))) (and ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@33) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33))))) (and (and (and (and ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@33) (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@37 |universe#0|) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)))))))))) (and (=> (|_module.Universe.legalTransition#canCall| $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition $Heap@33 $Heap@37 |universe#0| |running#0@@3|) (=> (|_module.Universe.legalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.legalTransitionsSequence $Heap@33 $Heap@37 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@33 $Heap@37 |universe#0|) (or (_module.Universe.baseLegalTransitionsSequence $Heap@33 $Heap@37 |universe#0|) (forall ((|o#0@@32| T@U) ) (!  (=> (and ($Is refType |o#0@@32| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@37 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@32|)))) (not ($IsAllocBox ($Box refType |o#0@@32|) Tclass._module.Object $Heap@33)))
 :qid |_09CounterNoStateMachinedfy.58:16|
 :skolemid |771|
