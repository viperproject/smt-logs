...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon3_correct  (=> (or (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 9))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> (and ($IsAllocBox ($Box refType (_module.Object.universe this@@126)) Tclass._module.Universe? $Heap@0) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78)) (=> ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@78))))))))))
(let ((anon4_Else_correct  (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2)) (= (ControlFlow 0 6) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 2))) (not true)) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#52| null $Heap@@78 alloc this@@126)) ($IsAllocBox ($Box refType this@@126) Tclass._module.Object? $Heap@@78)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@@78 this@@126) (_module.Object.objectGlobalInv $Heap@@78 this@@126))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 (_module.Object.universe this@@126)) _module.Universe.content)) ($Box refType |running#0@@3|)) (=> (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 this@@126) _module.IncrementerMethod.programCounter))) (LitInt 1))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@103 T@U) ) (!  (=> (and (or (not (= $o@@103 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@103) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@103) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@78 $o@@103)) (= $o@@103 this@@126)))
 :qid |_07CounterThreadOwnershipdfy.812:10|
 :skolemid |2564|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@103))
))) (and (and ($HeapSucc $Heap@@78 $Heap@0) ($IsAllocBox ($Box refType this@@126) Tclass._module.Object? $Heap@0)) (and (|_module.Object.objectGlobalInv#canCall| $Heap@0 this@@126) (_module.Object.objectGlobalInv $Heap@0 this@@126)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= (_module.Object.universe this@@126) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@126) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@126)) Tclass._module.Universe? $Heap@0) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78)) (=> ($IsAlloc refType (_module.Object.universe this@@126) Tclass._module.Universe $Heap@@78) (=> (and (|_module.Universe.globalInv2#canCall| $Heap@@78 $Heap@0 (_module.Object.universe this@@126)) (_module.Universe.globalInv2 $Heap@@78 $Heap@0 (_module.Object.universe this@@126))) (and (=> (= (ControlFlow 0 7) 5) anon4_Then_correct) (=> (= (ControlFlow 0 7) 6) anon4_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@78) ($IsHeapAnchor $Heap@@78)) (and (or (not (= this@@126 null)) (not true)) (and ($Is refType this@@126 Tclass._module.IncrementerMethod) ($IsAlloc refType this@@126 Tclass._module.IncrementerMethod $Heap@@78)))) (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@78)) (and (= 15 $FunctionContextHeight) (= (ControlFlow 0 11) 7)))) anon0_correct)))
