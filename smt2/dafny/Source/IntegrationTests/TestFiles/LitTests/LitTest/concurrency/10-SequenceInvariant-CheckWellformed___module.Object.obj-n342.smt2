...
(assert (forall (($prevHeap@@3 T@U) ($h0@@2 T@U) ($h1@@2 T@U) (this@@11 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Object) ($IsAlloc refType this@@11 Tclass._module.Object $h0@@2)))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@4) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@4) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@4) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |1055|
)) (= (_module.Object.objectGlobalInv2 $prevHeap@@3 $h0@@2 this@@11) (_module.Object.objectGlobalInv2 $prevHeap@@3 $h1@@2 this@@11))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1056|
 :pattern ( ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2) (_module.Object.objectGlobalInv2 $prevHeap@@3 $h1@@2 this@@11))
)))
...
(assert (forall (($prevHeap@@8 T@U) ($h0@@7 T@U) ($h1@@7 T@U) (this@@16 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.Thread) ($IsAlloc refType this@@16 Tclass._module.Thread $h0@@7)))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@9 T@U) ($f@@7 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@9) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@9) $f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@9) $f@@7)))
 :qid |unknown.0:0|
 :skolemid |1232|
)) (= (_module.Thread.sequenceInv2 $prevHeap@@8 $h0@@7 this@@16) (_module.Thread.sequenceInv2 $prevHeap@@8 $h1@@7 this@@16))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1233|
 :pattern ( ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7) (_module.Thread.sequenceInv2 $prevHeap@@8 $h1@@7 this@@16))
)))
(assert (forall (($prevHeap@@9 T@U) ($h0@@8 T@U) ($h1@@8 T@U) (this@@17 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.Thread) ($IsAlloc refType this@@17 Tclass._module.Thread $h0@@8)))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@10 T@U) ($f@@8 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@10) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@10) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@10) $f@@8)))
 :qid |unknown.0:0|
 :skolemid |1239|
...
(assert (forall (($prevHeap@@11 T@U) ($h0@@10 T@U) ($h1@@10 T@U) (this@@19 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.OwnedObject) ($IsAlloc refType this@@19 Tclass._module.OwnedObject $h0@@10)))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@12 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@12) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@12) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@12) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |1490|
)) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@11 $h0@@10 this@@19) (_module.OwnedObject.sequenceInv2 $prevHeap@@11 $h1@@10 this@@19))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1491|
 :pattern ( ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10) (_module.OwnedObject.sequenceInv2 $prevHeap@@11 $h1@@10 this@@19))
)))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@8 this@@23) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@8) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Object) ($IsAlloc refType this@@23 Tclass._module.Object $Heap@@8)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 (_module.Object.universe this@@23)) _module.Universe.content)) ($Box refType this@@23)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@8 this@@23) (=> (_module.Object.baseFieldsInv $Heap@@8 this@@23) (|_module.Universe.globalBaseInv#canCall| $Heap@@8 (_module.Object.universe this@@23))))) (= (_module.Object.objectGlobalBaseInv $Heap@@8 this@@23)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 (_module.Object.universe this@@23)) _module.Universe.content)) ($Box refType this@@23)) (_module.Object.baseFieldsInv $Heap@@8 this@@23)) (_module.Universe.globalBaseInv $Heap@@8 (_module.Object.universe this@@23))))))
 :qid |_10SequenceInvariantdfy.196:19|
 :skolemid |1046|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@8 this@@23) ($IsGoodHeap $Heap@@8))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@24 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@9 this@@24) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.Thread) ($IsAlloc refType this@@24 Tclass._module.Thread $Heap@@9)))))) (= (_module.Thread.baseFieldsInv $Heap@@9 this@@24) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.254:19|
 :skolemid |1191|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@9 this@@24) ($IsGoodHeap $Heap@@9))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@15 T@U) ($Heap@@10 T@U) (this@@25 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@15 $Heap@@10 this@@25) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@15) ($IsGoodHeap $Heap@@10)) ($HeapSucc $prevHeap@@15 $Heap@@10)) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.Thread) ($IsAlloc refType this@@25 Tclass._module.Thread $prevHeap@@15)))))) (and (and (|_module.Thread.localInv2#canCall| $prevHeap@@15 $Heap@@10 this@@25) (=> (_module.Thread.localInv2 $prevHeap@@15 $Heap@@10 this@@25) (|_module.Thread.sequenceInv2#canCall| $prevHeap@@15 $Heap@@10 this@@25))) (= (_module.Thread.inv2 $prevHeap@@15 $Heap@@10 this@@25)  (and (_module.Thread.localInv2 $prevHeap@@15 $Heap@@10 this@@25) (_module.Thread.sequenceInv2 $prevHeap@@15 $Heap@@10 this@@25)))))
 :qid |_10SequenceInvariantdfy.272:22|
 :skolemid |1243|
 :pattern ( (_module.Thread.inv2 $prevHeap@@15 $Heap@@10 this@@25) ($IsGoodHeap $Heap@@10))
))))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@20 T@U) ($f@@14 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@20 $f@@14))  (=> (and (or (not (= $o@@20 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@20) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@20) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2428|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@20 $f@@14))
)))
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($prevHeap@@16 T@U) ($Heap@@11 T@U) (this@@26 T@U) ) (!  (=> (or (|_module.Object.objectGlobalInv2#canCall| $prevHeap@@16 $Heap@@11 this@@26) (and (< 13 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@16) ($IsGoodHeap $Heap@@11)) ($HeapSucc $prevHeap@@16 $Heap@@11)) (and (or (not (= this@@26 null)) (not true)) (and ($Is refType this@@26 Tclass._module.Object) ($IsAlloc refType this@@26 Tclass._module.Object $prevHeap@@16)))) (_module.Object.objectGlobalInv $prevHeap@@16 this@@26)))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@11 this@@26) (=> (_module.Object.objectGlobalBaseInv $Heap@@11 this@@26) (|_module.Universe.globalInv2#canCall| $prevHeap@@16 $Heap@@11 (_module.Object.universe this@@26)))) (= (_module.Object.objectGlobalInv2 $prevHeap@@16 $Heap@@11 this@@26)  (and (_module.Object.objectGlobalBaseInv $Heap@@11 this@@26) (_module.Universe.globalInv2 $prevHeap@@16 $Heap@@11 (_module.Object.universe this@@26))))))
 :qid |_10SequenceInvariantdfy.202:22|
 :skolemid |1059|
 :pattern ( (_module.Object.objectGlobalInv2 $prevHeap@@16 $Heap@@11 this@@26) ($IsGoodHeap $Heap@@11))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@17 T@U) ($Heap@@12 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@17 $Heap@@12 this@@27) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@17) ($IsGoodHeap $Heap@@12)) ($HeapSucc $prevHeap@@17 $Heap@@12)) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Thread) ($IsAlloc refType this@@27 Tclass._module.Thread $prevHeap@@17)))))) (=> (_module.Thread.inv2 $prevHeap@@17 $Heap@@12 this@@27) (and (_module.Thread.localInv2 $prevHeap@@17 $Heap@@12 this@@27) (_module.Thread.sequenceInv2 $prevHeap@@17 $Heap@@12 this@@27))))
 :qid |_10SequenceInvariantdfy.272:22|
 :skolemid |1241|
 :pattern ( (_module.Thread.inv2 $prevHeap@@17 $Heap@@12 this@@27))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($prevHeap@@18 T@U) ($Heap@@13 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.OwnedObject.inv2#canCall| $prevHeap@@18 $Heap@@13 this@@28) (and (< 10 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@18) ($IsGoodHeap $Heap@@13)) ($HeapSucc $prevHeap@@18 $Heap@@13)) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.OwnedObject) ($IsAlloc refType this@@28 Tclass._module.OwnedObject $prevHeap@@18)))))) (=> (_module.OwnedObject.inv2 $prevHeap@@18 $Heap@@13 this@@28) (and (_module.OwnedObject.localInv2 $prevHeap@@18 $Heap@@13 this@@28) (_module.OwnedObject.sequenceInv2 $prevHeap@@18 $Heap@@13 this@@28))))
 :qid |_10SequenceInvariantdfy.360:22|
 :skolemid |1500|
 :pattern ( (_module.OwnedObject.inv2 $prevHeap@@18 $Heap@@13 this@@28))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($prevHeap@@19 T@U) ($Heap@@14 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Object.inv2#canCall| $prevHeap@@19 $Heap@@14 this@@29) (and (< 11 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@19) ($IsGoodHeap $Heap@@14)) ($HeapSucc $prevHeap@@19 $Heap@@14)) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Object) ($IsAlloc refType this@@29 Tclass._module.Object $prevHeap@@19)))))) (=> (_module.Object.inv2 $prevHeap@@19 $Heap@@14 this@@29) (and (_module.Object.localInv2 $prevHeap@@19 $Heap@@14 this@@29) (_module.Object.sequenceInv2 $prevHeap@@19 $Heap@@14 this@@29))))
 :qid |_10SequenceInvariantdfy.245:22|
 :skolemid |1134|
 :pattern ( (_module.Object.inv2 $prevHeap@@19 $Heap@@14 this@@29))
))))
(assert ($IsGhostField alloc))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@15 this@@30) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.OwnedObject) ($IsAlloc refType this@@30 Tclass._module.OwnedObject $Heap@@15)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@15 this@@30) (=> (_module.Object.objectGlobalBaseInv $Heap@@15 this@@30) (|_module.OwnedObject.localUserInv#canCall| $Heap@@15 this@@30))) (= (_module.OwnedObject.localInv $Heap@@15 this@@30)  (and (_module.Object.objectGlobalBaseInv $Heap@@15 this@@30) (_module.OwnedObject.localUserInv $Heap@@15 this@@30)))))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1460|
 :pattern ( (_module.OwnedObject.localInv $Heap@@15 this@@30) ($IsGoodHeap $Heap@@15))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@16 this@@31) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.OwnedObject) ($IsAlloc refType this@@31 Tclass._module.OwnedObject $Heap@@16)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@16 this@@31) (=> (_module.OwnedObject.localInv $Heap@@16 this@@31) (|_module.OwnedObject.userInv#canCall| $Heap@@16 this@@31))) (= (_module.OwnedObject.inv $Heap@@16 this@@31)  (and (_module.OwnedObject.localInv $Heap@@16 this@@31) (_module.OwnedObject.userInv $Heap@@16 this@@31)))))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1473|
 :pattern ( (_module.OwnedObject.inv $Heap@@16 this@@31) ($IsGoodHeap $Heap@@16))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@20 T@U) ($Heap@@17 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.Thread.localInv2#canCall| $prevHeap@@20 $Heap@@17 this@@32) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@32 null)) (not true)) ($Is refType this@@32 Tclass._module.Thread)))) (= (_module.Object.localInv2 $prevHeap@@20 $Heap@@17 this@@32) (_module.Thread.localInv2 $prevHeap@@20 $Heap@@17 this@@32)))
 :qid |_10SequenceInvariantdfy.242:22|
 :skolemid |1230|
 :pattern ( (_module.Object.localInv2 $prevHeap@@20 $Heap@@17 this@@32) ($Is refType this@@32 Tclass._module.Thread) ($IsGoodHeap $Heap@@17))
 :pattern ( (_module.Object.localInv2 $prevHeap@@20 $Heap@@17 this@@32) (_module.Thread.localInv2 $prevHeap@@20 $Heap@@17 this@@32) ($IsGoodHeap $Heap@@17))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@21 T@U) ($Heap@@18 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@21 $Heap@@18 this@@33) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@33 null)) (not true)) ($Is refType this@@33 Tclass._module.Thread)))) (= (_module.Object.sequenceInv2 $prevHeap@@21 $Heap@@18 this@@33) (_module.Thread.sequenceInv2 $prevHeap@@21 $Heap@@18 this@@33)))
 :qid |_10SequenceInvariantdfy.244:22|
 :skolemid |1237|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@21 $Heap@@18 this@@33) ($Is refType this@@33 Tclass._module.Thread) ($IsGoodHeap $Heap@@18))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@21 $Heap@@18 this@@33) (_module.Thread.sequenceInv2 $prevHeap@@21 $Heap@@18 this@@33) ($IsGoodHeap $Heap@@18))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@22 T@U) ($Heap@@19 T@U) (this@@34 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@22 $Heap@@19 this@@34) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@34 null)) (not true)) ($Is refType this@@34 Tclass._module.Thread)))) (= (_module.Object.inv2 $prevHeap@@22 $Heap@@19 this@@34) (_module.Thread.inv2 $prevHeap@@22 $Heap@@19 this@@34)))
 :qid |_10SequenceInvariantdfy.245:22|
 :skolemid |1244|
 :pattern ( (_module.Object.inv2 $prevHeap@@22 $Heap@@19 this@@34) ($Is refType this@@34 Tclass._module.Thread) ($IsGoodHeap $Heap@@19))
 :pattern ( (_module.Object.inv2 $prevHeap@@22 $Heap@@19 this@@34) (_module.Thread.inv2 $prevHeap@@22 $Heap@@19 this@@34) ($IsGoodHeap $Heap@@19))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@23 T@U) ($Heap@@20 T@U) (this@@35 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv2#canCall| $prevHeap@@23 $Heap@@20 this@@35) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.OwnedObject)))) (= (_module.Object.localInv2 $prevHeap@@23 $Heap@@20 this@@35) (_module.OwnedObject.localInv2 $prevHeap@@23 $Heap@@20 this@@35)))
 :qid |_10SequenceInvariantdfy.242:22|
 :skolemid |1487|
 :pattern ( (_module.Object.localInv2 $prevHeap@@23 $Heap@@20 this@@35) ($Is refType this@@35 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@20))
 :pattern ( (_module.Object.localInv2 $prevHeap@@23 $Heap@@20 this@@35) (_module.OwnedObject.localInv2 $prevHeap@@23 $Heap@@20 this@@35) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@24 T@U) ($Heap@@21 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@24 $Heap@@21 this@@36) (and (< 3 $FunctionContextHeight) (and (or (not (= this@@36 null)) (not true)) ($Is refType this@@36 Tclass._module.OwnedObject)))) (= (_module.Object.sequenceInv2 $prevHeap@@24 $Heap@@21 this@@36) (_module.OwnedObject.sequenceInv2 $prevHeap@@24 $Heap@@21 this@@36)))
 :qid |_10SequenceInvariantdfy.244:22|
 :skolemid |1495|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@24 $Heap@@21 this@@36) ($Is refType this@@36 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@21))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@24 $Heap@@21 this@@36) (_module.OwnedObject.sequenceInv2 $prevHeap@@24 $Heap@@21 this@@36) ($IsGoodHeap $Heap@@21))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($prevHeap@@25 T@U) ($Heap@@22 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.OwnedObject.inv2#canCall| $prevHeap@@25 $Heap@@22 this@@37) (and (< 10 $FunctionContextHeight) (and (or (not (= this@@37 null)) (not true)) ($Is refType this@@37 Tclass._module.OwnedObject)))) (= (_module.Object.inv2 $prevHeap@@25 $Heap@@22 this@@37) (_module.OwnedObject.inv2 $prevHeap@@25 $Heap@@22 this@@37)))
 :qid |_10SequenceInvariantdfy.245:22|
 :skolemid |1503|
 :pattern ( (_module.Object.inv2 $prevHeap@@25 $Heap@@22 this@@37) ($Is refType this@@37 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@22))
 :pattern ( (_module.Object.inv2 $prevHeap@@25 $Heap@@22 this@@37) (_module.OwnedObject.inv2 $prevHeap@@25 $Heap@@22 this@@37) ($IsGoodHeap $Heap@@22))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@23 this@@38) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.Universe) ($IsAlloc refType this@@38 Tclass._module.Universe $Heap@@23)))))) (and (forall ((|o#0@@1| T@U) ) (!  (=> ($Is refType |o#0@@1| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@38) _module.Universe.content)) ($Box refType |o#0@@1|)) (=> (= (_module.Object.universe |o#0@@1|) this@@38) (=> (or (not (= |o#0@@1| this@@38)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@23 |o#0@@1|) (=> (_module.Object.baseFieldsInv $Heap@@23 |o#0@@1|) (|_module.Object.triggerAxioms#canCall| $Heap@@23 |o#0@@1|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@23 |o#0@@1|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@23 |o#0@@1|))
 :pattern ( (_module.Object.universe |o#0@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@38) _module.Universe.content)) ($Box refType |o#0@@1|)))
)) (= (_module.Universe.globalBaseInv $Heap@@23 this@@38) (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@38) _module.Universe.content)) ($Box refType |o#0@@2|))) (and (and (and (= (_module.Object.universe |o#0@@2|) this@@38) (or (not (= |o#0@@2| this@@38)) (not true))) (_module.Object.baseFieldsInv $Heap@@23 |o#0@@2|)) (_module.Object.triggerAxioms $Heap@@23 |o#0@@2|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 :pattern ( (_module.Object.triggerAxioms $Heap@@23 |o#0@@2|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@23 |o#0@@2|))
 :pattern ( (_module.Object.universe |o#0@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@38) _module.Universe.content)) ($Box refType |o#0@@2|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@23 this@@38) ($IsGoodHeap $Heap@@23))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@28 T@U) (this@@47 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@28 this@@47) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@28) (and (or (not (= this@@47 null)) (not true)) (and ($Is refType this@@47 Tclass._module.Object) ($IsAlloc refType this@@47 Tclass._module.Object $Heap@@28)))))) (_module.Object.triggerAxioms $Heap@@28 this@@47))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1064|
 :pattern ( (_module.Object.triggerAxioms $Heap@@28 this@@47))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@29 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@29 this@@48) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@29) (and (or (not (= this@@48 null)) (not true)) (and ($Is refType this@@48 Tclass._module.OwnedObject) ($IsAlloc refType this@@48 Tclass._module.OwnedObject $Heap@@29)))))) (=> (_module.OwnedObject.userInv $Heap@@29 this@@48) (_module.OwnedObject.localUserInv $Heap@@29 this@@48)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1549|
 :pattern ( (_module.OwnedObject.userInv $Heap@@29 this@@48))
))))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@34 T@U) (this@@53 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@34 this@@53) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@34) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.OwnedObject) ($IsAlloc refType this@@53 Tclass._module.OwnedObject $Heap@@34)))))) (=> (_module.OwnedObject.inv $Heap@@34 this@@53) (_module.OwnedObject.localInv $Heap@@34 this@@53)))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1471|
 :pattern ( (_module.OwnedObject.inv $Heap@@34 this@@53))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@35 T@U) (this@@54 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@35 this@@54) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@35) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.Object) ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@35)))))) (=> (_module.Object.inv $Heap@@35 this@@54) (_module.Object.localInv $Heap@@35 this@@54)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1126|
 :pattern ( (_module.Object.inv $Heap@@35 this@@54))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@29 T@U) ($Heap@@36 T@U) (this@@55 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@29 $Heap@@36 this@@55) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@29) ($IsGoodHeap $Heap@@36)) ($HeapSucc $prevHeap@@29 $Heap@@36)) (and (or (not (= this@@55 null)) (not true)) (and ($Is refType this@@55 Tclass._module.OwnedObject) ($IsAlloc refType this@@55 Tclass._module.OwnedObject $prevHeap@@29)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@29 this@@55) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 this@@55) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@29 $Heap@@36 this@@55)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@29 $Heap@@36 this@@55)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@29 this@@55) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@36 this@@55) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@29 $Heap@@36 this@@55)))))
 :qid |_10SequenceInvariantdfy.312:22|
 :skolemid |1438|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@29 $Heap@@36 this@@55) ($IsGoodHeap $Heap@@36))
))))
...
(assert (forall (($h0@@18 T@U) ($h1@@18 T@U) (this@@56 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@56 null)) (not true)) ($Is refType this@@56 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@30 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (= $o@@30 this@@56)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@30) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@30) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |1062|
)) (= (_module.Object.triggerAxioms $h0@@18 this@@56) (_module.Object.triggerAxioms $h1@@18 this@@56))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1063|
 :pattern ( ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18) (_module.Object.triggerAxioms $h1@@18 this@@56))
)))
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@57 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@57 null)) (not true)) ($Is refType this@@57 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@31 T@U) ($f@@20 T@U) ) (!  (=> (and (or (not (= $o@@31 null)) (not true)) (or (= $o@@31 this@@57) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 this@@57) _module.Universe.content)) ($Box refType $o@@31)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@31) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@31) $f@@20)))
 :qid |unknown.0:0|
 :skolemid |608|
)) (= (_module.Universe.globalBaseInv $h0@@19 this@@57) (_module.Universe.globalBaseInv $h1@@19 this@@57))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |609|
 :pattern ( ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19) (_module.Universe.globalBaseInv $h1@@19 this@@57))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@30 T@U) ($Heap@@37 T@U) (this@@58 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@30 $Heap@@37 this@@58) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@30) ($IsGoodHeap $Heap@@37)) ($HeapSucc $prevHeap@@30 $Heap@@37)) (and (or (not (= this@@58 null)) (not true)) (and ($Is refType this@@58 Tclass._module.OwnedObject) ($IsAlloc refType this@@58 Tclass._module.OwnedObject $prevHeap@@30)))))) (and (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@30 this@@58) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@58) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@30 this@@58) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@58) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@30 $Heap@@37 this@@58)))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@30 $Heap@@37 this@@58)  (and (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@30 this@@58) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@58) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@30 this@@58) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@58) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@30 $Heap@@37 this@@58)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@30 this@@58) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@30 this@@58) _module.OwnedObject.owner))))
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@30 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@30 this@@58) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@37 this@@58) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_10SequenceInvariantdfy.338:22|
 :skolemid |1494|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@30 $Heap@@37 this@@58) ($IsGoodHeap $Heap@@37))
))))
...
(let ((anon8_Then_correct  (=> (_module.Object.objectGlobalBaseInv current$Heap this@@75) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (not (= (_module.Object.universe this@@75) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@75) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@75)) Tclass._module.Universe? current$Heap) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($IsAlloc refType (_module.Object.universe this@@75) Tclass._module.Universe $Heap@@43)) (=> ($IsAlloc refType (_module.Object.universe this@@75) Tclass._module.Universe $Heap@@43) (=> (and (and (= |b$reqreads#1@0| (forall (($o@@52 T@U) ($f@@32 T@U) ) (!  (=> (and (and (or (not (= $o@@52 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@52) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@52) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@52 $f@@32)))
 :qid |_10SequenceInvariantdfy.202:117|
 :skolemid |1061|
...
(let ((anon7_Else_correct  (=> ($IsAllocBox ($Box refType this@@75) Tclass._module.Object? current$Heap) (=> (and (= |b$reqreads#0@0| (forall (($o@@53 T@U) ($f@@33 T@U) ) (!  (=> (and (and (or (not (= $o@@53 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@53) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@53) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@53 $f@@33)))
 :qid |_10SequenceInvariantdfy.202:83|
 :skolemid |1060|
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null current$Heap alloc current$Heap alloc)) (and (=> (= (ControlFlow 0 10) (- 0 11)) ($IsAlloc refType this@@75 Tclass._module.Object $Heap@@43)) (=> ($IsAlloc refType this@@75 Tclass._module.Object $Heap@@43) (=> (and (|_module.Object.objectGlobalInv#canCall| $Heap@@43 this@@75) (_module.Object.objectGlobalInv $Heap@@43 this@@75)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@43) ($IsHeapAnchor $Heap@@43)) (=> (and (and (and (or (not (= this@@75 null)) (not true)) (and ($Is refType this@@75 Tclass._module.Object) ($IsAlloc refType this@@75 Tclass._module.Object previous$Heap))) (= 13 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@43) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 12) 10))) anon0_correct))))
