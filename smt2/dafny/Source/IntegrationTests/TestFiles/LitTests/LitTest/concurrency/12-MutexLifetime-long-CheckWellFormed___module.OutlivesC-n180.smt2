...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@130 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@130 null)) (not true)) ($Is refType this@@130 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@80 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@80 null)) (not true)) (= $o@@80 this@@130)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@80) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@80) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |2121|
...
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@131 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@131 null)) (not true)) ($Is refType this@@131 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@81 T@U) ($f@@50 T@U) ) (!  (=> (and (or (not (= $o@@81 null)) (not true)) (= $o@@81 this@@131)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@81) $f@@50) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@81) $f@@50)))
 :qid |unknown.0:0|
 :skolemid |2224|
...
(assert (forall (($h0@@38 T@U) ($h1@@38 T@U) (this@@132 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@38) ($IsGoodHeap $h1@@38)) (and (or (not (= this@@132 null)) (not true)) ($Is refType this@@132 Tclass._module.OutlivesClaim))) (and ($IsHeapAnchor $h0@@38) ($HeapSucc $h0@@38 $h1@@38))) (=> (forall (($o@@82 T@U) ($f@@51 T@U) ) (!  (=> (and (or (not (= $o@@82 null)) (not true)) (= $o@@82 this@@132)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@38 $o@@82) $f@@51) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@38 $o@@82) $f@@51)))
 :qid |unknown.0:0|
 :skolemid |2973|
...
(assert (forall (($h0@@43 T@U) ($h1@@43 T@U) (this@@137 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@43) ($IsGoodHeap $h1@@43)) (and (or (not (= this@@137 null)) (not true)) (and ($Is refType this@@137 Tclass._module.Thread) ($IsAlloc refType this@@137 Tclass._module.Thread $h0@@43)))) (and ($IsHeapAnchor $h0@@43) ($HeapSucc $h0@@43 $h1@@43))) (=> (forall (($o@@88 T@U) ($f@@56 T@U) ) (!  (=> (and (or (not (= $o@@88 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@88) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@43 $o@@88) $f@@56) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@43 $o@@88) $f@@56)))
 :qid |unknown.0:0|
 :skolemid |1871|
...
(assert (forall (($h0@@45 T@U) ($h1@@45 T@U) (this@@139 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@45) ($IsGoodHeap $h1@@45)) (and (or (not (= this@@139 null)) (not true)) (and ($Is refType this@@139 Tclass._module.OwnedObject) ($IsAlloc refType this@@139 Tclass._module.OwnedObject $h0@@45)))) (and ($IsHeapAnchor $h0@@45) ($HeapSucc $h0@@45 $h1@@45))) (=> (forall (($o@@90 T@U) ($f@@58 T@U) ) (!  (=> (and (or (not (= $o@@90 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@90) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@45 $o@@90) $f@@58) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@45 $o@@90) $f@@58)))
 :qid |unknown.0:0|
 :skolemid |2149|
...
(assert (forall (($h0@@46 T@U) ($h1@@46 T@U) (this@@140 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@46) ($IsGoodHeap $h1@@46)) (and (or (not (= this@@140 null)) (not true)) (and ($Is refType this@@140 Tclass._module.OwnedObject) ($IsAlloc refType this@@140 Tclass._module.OwnedObject $h0@@46)))) (and ($IsHeapAnchor $h0@@46) ($HeapSucc $h0@@46 $h1@@46))) (=> (forall (($o@@91 T@U) ($f@@59 T@U) ) (!  (=> (and (or (not (= $o@@91 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@91) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@46 $o@@91) $f@@59) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@46 $o@@91) $f@@59)))
 :qid |unknown.0:0|
 :skolemid |2161|
...
(assert (forall (($h0@@47 T@U) ($h1@@47 T@U) (this@@141 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@47) ($IsGoodHeap $h1@@47)) (and (or (not (= this@@141 null)) (not true)) (and ($Is refType this@@141 Tclass._module.OwnedObject) ($IsAlloc refType this@@141 Tclass._module.OwnedObject $h0@@47)))) (and ($IsHeapAnchor $h0@@47) ($HeapSucc $h0@@47 $h1@@47))) (=> (forall (($o@@92 T@U) ($f@@60 T@U) ) (!  (=> (and (or (not (= $o@@92 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@92) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@47 $o@@92) $f@@60) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@47 $o@@92) $f@@60)))
 :qid |unknown.0:0|
 :skolemid |2233|
...
(assert (forall (($h0@@49 T@U) ($h1@@49 T@U) (this@@143 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@49) ($IsGoodHeap $h1@@49)) (and (or (not (= this@@143 null)) (not true)) (and ($Is refType this@@143 Tclass._module.Lifetime) ($IsAlloc refType this@@143 Tclass._module.Lifetime $h0@@49)))) (and ($IsHeapAnchor $h0@@49) ($HeapSucc $h0@@49 $h1@@49))) (=> (forall (($o@@94 T@U) ($f@@62 T@U) ) (!  (=> (and (or (not (= $o@@94 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@49 $o@@94) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@49 $o@@94) $f@@62) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@49 $o@@94) $f@@62)))
 :qid |unknown.0:0|
 :skolemid |2316|
...
(assert (forall (($h0@@51 T@U) ($h1@@51 T@U) (this@@145 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@51) ($IsGoodHeap $h1@@51)) (and (or (not (= this@@145 null)) (not true)) (and ($Is refType this@@145 Tclass._module.OutlivesClaim) ($IsAlloc refType this@@145 Tclass._module.OutlivesClaim $h0@@51)))) (and ($IsHeapAnchor $h0@@51) ($HeapSucc $h0@@51 $h1@@51))) (=> (forall (($o@@96 T@U) ($f@@64 T@U) ) (!  (=> (and (or (not (= $o@@96 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@51 $o@@96) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@51 $o@@96) $f@@64) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@51 $o@@96) $f@@64)))
 :qid |unknown.0:0|
 :skolemid |2988|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#57| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@166) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@166 Tclass._module.OutlivesClaim $Heap@@96)) (=> ($IsAlloc refType this@@166 Tclass._module.OutlivesClaim $Heap@@96) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@96)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@96) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@96 current$Heap this@@166 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@96 current$Heap this@@166 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@166) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@166 Tclass._module.OutlivesClaim $Heap@@96))))))))))
