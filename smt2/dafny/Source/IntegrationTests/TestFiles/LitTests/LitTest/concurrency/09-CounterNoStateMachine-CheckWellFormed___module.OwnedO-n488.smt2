...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#9| null $Heap@@1 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@1 $Heap@0)) (and ($IsAllocBox ($Box refType this@@4) Tclass._module.OwnedObject? $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@4 Tclass._module.OwnedObject $Heap@@1)))))
