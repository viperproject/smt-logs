...
(assert (distinct TBool TagBool alloc allocName Tagclass._module.Object Tagclass._module.OwnedObject Tagclass._module.Object? Tagclass._module.OwnedObject? Tagclass._module.OwnedU32? Tagclass._module.OwnedU32 Tagclass._module.Mutex? Tagclass._module.MutexGuardU32 Tagclass._module.Mutex class._module.MutexGuardU32? Tagclass._module.MutexGuardU32? tytagFamily$Object tytagFamily$OwnedObject tytagFamily$OwnedU32 tytagFamily$Mutex tytagFamily$MutexGuardU32 field$data field$mutex)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@8 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#103| |l#0| |l#1| |l#2| |l#3|) $o@@8 $f@@0))  (=> (and (or (not (= $o@@8 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@8) |l#2|)))) (= $o@@8 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3523|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#103| |l#0| |l#1| |l#2| |l#3|) $o@@8 $f@@0))
)))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#103| null current$Heap alloc this@@1)) (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 8) anon7_Else_correct)))))
