...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split34)
...
))) (and ($HeapSucc $Heap@2 $Heap@3) (= (ControlFlow 0 2) (- 0 1)))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
