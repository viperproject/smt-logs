...
(assert (forall (($h0@@14 T@U) ($h1@@14 T@U) (this@@34 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@14) ($IsGoodHeap $h1@@14)) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.EmptyType) ($IsAlloc refType this@@34 Tclass._module.EmptyType $h0@@14)))) (and ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14))) (=> (forall (($o@@27 T@U) ($f@@15 T@U) )  (=> (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@27) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@27) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@14 $o@@27) $f@@15)))) (= (_module.EmptyType.baseUserInv $h0@@14 this@@34) (_module.EmptyType.baseUserInv $h1@@14 this@@34))))
 :pattern ( ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14) (_module.EmptyType.baseUserInv $h1@@14 this@@34))
)))
(assert (forall (($h0@@15 T@U) ($h1@@15 T@U) (this@@35 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@15) ($IsGoodHeap $h1@@15)) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.EmptyType) ($IsAlloc refType this@@35 Tclass._module.EmptyType $h0@@15)))) (and ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15))) (=> (forall (($o@@28 T@U) ($f@@16 T@U) )  (=> (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@28) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@28) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@15 $o@@28) $f@@16)))) (= (_module.EmptyType.localUserInv $h0@@15 this@@35) (_module.EmptyType.localUserInv $h1@@15 this@@35))))
 :pattern ( ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15) (_module.EmptyType.localUserInv $h1@@15 this@@35))
)))
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@36 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.EmptyType) ($IsAlloc refType this@@36 Tclass._module.EmptyType $h0@@16)))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@29 T@U) ($f@@17 T@U) )  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@29) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@29) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@29) $f@@17)))) (= (_module.EmptyType.userInv $h0@@16 this@@36) (_module.EmptyType.userInv $h1@@16 this@@36))))
