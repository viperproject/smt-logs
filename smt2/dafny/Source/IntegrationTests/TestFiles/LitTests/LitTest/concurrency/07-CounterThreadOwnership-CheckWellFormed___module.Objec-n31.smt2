...
(set-info :boogie-vc-id CheckWellFormed$$_module.Object.ProveReflexiveTransitiveInv2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and ($IsAllocBox ($Box refType this) Tclass._module.Object? $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this Tclass._module.Object $Heap)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Object) ($IsAlloc refType this Tclass._module.Object $Heap))) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
