...
(set-info :boogie-vc-id OverrideCheck$$_module.AtomicCounter.userInv)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))) (=> (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (=> (= AtomicCounter_$_ReadsFrame@0 (|lambda#3| null $Heap@@2 alloc $Heap@@2 alloc)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@10) alloc))))
 :qid |_06ThreadOwnershipdfy.306:19|
 :skolemid |1490|
 ...
 :qid |_06ThreadOwnershipdfy.306:19|
 :skolemid |1490|
)) (=> (=> (_module.AtomicCounter.userInv $Heap@@2 this@@2) (_module.AtomicCounter.localUserInv $Heap@@2 this@@2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.AtomicCounter.userInv $Heap@@2 this@@2) (=> (|_module.AtomicCounter.localUserInv#canCall| $Heap@@2 this@@2) (or (_module.AtomicCounter.localUserInv $Heap@@2 this@@2) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (_module.AtomicCounter.userInv $Heap@@2 this@@2) (=> (|_module.AtomicCounter.localUserInv#canCall| $Heap@@2 this@@2) (or (_module.AtomicCounter.localUserInv $Heap@@2 this@@2) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (_module.AtomicCounter.userInv $Heap@@2 this@@2) (=> (|_module.AtomicCounter.localUserInv#canCall| $Heap@@2 this@@2) (or (_module.AtomicCounter.localUserInv $Heap@@2 this@@2) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.AtomicCounter) ($IsAlloc refType this@@2 Tclass._module.AtomicCounter $Heap@@2))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
