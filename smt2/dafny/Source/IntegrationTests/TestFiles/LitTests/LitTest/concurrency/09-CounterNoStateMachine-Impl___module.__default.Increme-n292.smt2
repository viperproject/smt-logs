...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split281)
...
)) ($HeapSucc $Heap@32 $Heap@33)))) (and (and (and (U_2_bool (Lit boolType (bool_2_U false))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|)) (and ($IsAllocBox ($Box refType |running#0@@3|) Tclass._module.Object? $Heap@33) (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|))) (and (and (|_module.Object.triggerAxioms#canCall| $Heap@33 |running#0@@3|) (_module.Object.triggerAxioms $Heap@33 |running#0@@3|)) (and (or (not (= |remaining#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |remaining#0| _module.Integer.value)))))) (and (and (and (and (or (not (= |remaining#0| null)) (not true)) (= |$rhs#0_6@1| (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.Integer.value))) 1))) (and (= $Heap@34 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.Integer.value ($Box intType (int_2_U |$rhs#0_6@1|))))) ($IsGoodHeap $Heap@34))) (and (and (or (not (= |remaining#0| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |remaining#0| _module.OwnedObject.nonvolatileVersion))) (and (or (not (= |remaining#0| null)) (not true)) (= |last##0_0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 |remaining#0|) _module.OwnedObject.nonvolatileVersion))))))) (and (and (and ($IsGoodHeap $Heap@35) ($IsHeapAnchor $Heap@35)) (and (> |call2formal@res#0@0| |last##0_0@1|) (forall (($o@@179 T@U) ) (!  (=> (and (or (not (= $o@@179 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 $o@@179) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 $o@@179) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@34 $o@@179)))
 :qid |_09CounterNoStateMachinedfy.450:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 $o@@179))
)))) (and (and ($HeapSucc $Heap@34 $Heap@35) (= $Heap@36 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@35 |remaining#0|) _module.OwnedObject.nonvolatileVersion ($Box intType (int_2_U |call2formal@res#0@0|)))))) (and ($IsGoodHeap $Heap@36) (= (ControlFlow 0 2) (- 0 1)))))))))))) (or (not (= |remaining#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
