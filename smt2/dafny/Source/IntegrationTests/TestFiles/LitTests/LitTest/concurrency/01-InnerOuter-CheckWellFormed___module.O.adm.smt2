...
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@14 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.S))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@17 T@U) ($f@@11 T@U) )  (=> (and (or (not (= $o@@17 null)) (not true)) (or (= $o@@17 this@@14) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@14) _module.S.obs)) ($Box refType $o@@17)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@17) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@17) $f@@11)))) (= (_module.S.i0 $h0@@4 this@@14) (_module.S.i0 $h1@@4 this@@14))))
