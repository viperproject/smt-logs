...
(assert (distinct TagSet alloc allocName Tagclass._module.Universe Tagclass._module.Thread Tagclass._module.OwnedObject Tagclass._module.Object class._module.Universe? Tagclass._module.Universe? Tagclass._module.Object? Tagclass._module.Thread? Tagclass._module.OwnedObject? tytagFamily$Universe tytagFamily$Thread tytagFamily$OwnedObject tytagFamily$Object field$content)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TypingAxiom1)
...
(let ((anon5_Else_correct  (=> (and (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |a#0@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|))) (or (not (= |a#0@0| |b#0@0|)) (not true))) (= (ControlFlow 0 5) 1)) anon4_correct)))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |a#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |b#0@0|)) (=> (and (or (not (= |a#0@0| |b#0@0|)) (not true)) (= (ControlFlow 0 2) 1)) anon4_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and ($Is refType |a#0@0| Tclass._module.Thread) ($IsAlloc refType |a#0@0| Tclass._module.Thread $Heap@0)) (and ($Is refType |b#0@0| Tclass._module.OwnedObject) ($IsAlloc refType |b#0@0| Tclass._module.OwnedObject $Heap@0)))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
