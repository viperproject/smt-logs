...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split60)
...
))) (and (= $Heap@10 $Heap@11) (= (ControlFlow 0 2) (- 0 1))))))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
