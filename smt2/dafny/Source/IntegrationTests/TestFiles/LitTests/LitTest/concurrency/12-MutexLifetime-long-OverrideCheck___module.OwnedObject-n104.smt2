...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@6 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@11 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (= $o@@11 this@@6)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@11) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@11) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |2121|
...
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (this@@7 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@12 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (= $o@@12 this@@7)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@12) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@12) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |2224|
...
(assert (forall (($h@@11 T@U) ($o@@13 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@13 null)) (not true)) ($Is refType $o@@13 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) _module.OwnedObject.owner)) Tclass._module.Object? $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2107|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) _module.OwnedObject.owner)))
)))
...
(assert (= (Tag Tclass._module.OwnedObject?) Tagclass._module.OwnedObject?))
(assert (= (TagFamily Tclass._module.OwnedObject?) tytagFamily$OwnedObject))
(assert (forall (($h@@12 T@U) ($o@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@16 null)) (not true)) ($Is refType $o@@16 Tclass._module.OwnedObject?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@16) _module.OwnedObject.owner)) Tclass._module.Object?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2106|
...
(assert (forall (($h@@13 T@U) ($o@@20 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@13) (and (or (not (= $o@@20 null)) (not true)) ($Is refType $o@@20 Tclass._module.Universe?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@20) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@13 $o@@20) _module.Universe.content)) (TSet Tclass._module.Object) $h@@13))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1173|
...
(assert (forall (($h@@14 T@U) ($o@@21 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@21 null)) (not true)) ($Is refType $o@@21 Tclass._module.Universe?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@21) _module.Universe.content)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1172|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@21) _module.Universe.content)))
)))
(push 1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (and (and (_module.OwnedObject.baseFieldsInv $Heap@@5 this@@8) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 (_module.Object.universe this@@8)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@8)) _module.Universe.content)))) (forall (($o@@22 T@U) ($f@@2 T@U) ) (!  (=> (or (not (= $o@@22 null)) (not true)) (=> (= $o@@22 this@@8) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@22) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@22) $f@@2))))
 :qid |_12MutexLifetimelongdfy.350:124|
 :skolemid |2137|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@22) $f@@2))
))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@5 this@@8) (or (_module.OwnedObject.baseFieldsInv $Heap@@5 this@@8) (|Set#Subset| (_module.OwnedObject.objectFields $Heap@@5 this@@8) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 (_module.Object.universe this@@8)) _module.Universe.content)))))) (=> (=> (|_module.OwnedObject.baseFieldsInv#canCall| $Heap@@5 this@@8) (or (_module.OwnedObject.baseFieldsInv $Heap@@5 this@@8) (|Set#Subset| (_module.OwnedObject.objectFields $Heap@@5 this@@8) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 (_module.Object.universe this@@8)) _module.Universe.content))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 (_module.Object.universe this@@8)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@8)) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 (_module.Object.universe this@@8)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@8)) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (forall (($o@@23 T@U) ($f@@3 T@U) ) (!  (=> (or (not (= $o@@23 null)) (not true)) (=> (= $o@@23 this@@8) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@23) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@23) $f@@3))))
 :qid |_12MutexLifetimelongdfy.436:124|
 :skolemid |2138|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@23) $f@@3))
))) (=> (forall (($o@@24 T@U) ($f@@4 T@U) ) (!  (=> (or (not (= $o@@24 null)) (not true)) (=> (= $o@@24 this@@8) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@24) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@5 $o@@24) $f@@4))))
 :qid |_12MutexLifetimelongdfy.436:124|
 :skolemid |2138|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@24) $f@@4))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@25 T@U) ($f@@5 T@U) ) (! true
 :qid |_12MutexLifetimelongdfy.436:18|
 :skolemid |2139|
))) (=> (forall (($o@@26 T@U) ($f@@6 T@U) ) (! true
 :qid |_12MutexLifetimelongdfy.436:18|
 :skolemid |2139|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@27 T@U) ($f@@7 T@U) ) (! true
 :qid |_12MutexLifetimelongdfy.436:18|
 :skolemid |2140|
))) (=> (forall (($o@@28 T@U) ($f@@8 T@U) ) (! true
 :qid |_12MutexLifetimelongdfy.436:18|
 :skolemid |2140|
)) (=> (and (and (_module.OwnedObject.baseFieldsInv current$Heap this@@8) (= (ControlFlow 0 2) (- 0 1))) (|_module.OwnedObject.baseFieldsInv#canCall| current$Heap this@@8)) (or (_module.OwnedObject.baseFieldsInv current$Heap this@@8) (|Set#Subset| (_module.OwnedObject.objectFields current$Heap this@@8) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@8)) _module.Universe.content)))))))))))))))))))
