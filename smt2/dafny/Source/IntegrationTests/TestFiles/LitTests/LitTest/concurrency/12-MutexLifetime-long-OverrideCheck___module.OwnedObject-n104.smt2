...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@6 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@11 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@11 null)) (not true)) (= $o@@11 this@@6)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@11) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@11) $f@@0)))) (= (_module.OwnedObject.objectFields $h0@@0 this@@6) (_module.OwnedObject.objectFields $h1@@0 this@@6))))
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.OwnedObject.objectFields $h1@@0 this@@6))
)))
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (this@@7 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@12 T@U) ($f@@1 T@U) )  (=> (and (or (not (= $o@@12 null)) (not true)) (= $o@@12 this@@7)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@12) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@12) $f@@1)))) (= (_module.OwnedObject.objectUserFields $h0@@1 this@@7) (_module.OwnedObject.objectUserFields $h1@@1 this@@7))))
...
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@25 T@U) ($f@@5 T@U) ) true)) (=> (forall (($o@@26 T@U) ($f@@6 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@27 T@U) ($f@@7 T@U) ) true)) (=> (forall (($o@@28 T@U) ($f@@8 T@U) ) true) (=> (and (and (_module.OwnedObject.baseFieldsInv current$Heap this@@8) (= (ControlFlow 0 2) (- 0 1))) (|_module.OwnedObject.baseFieldsInv#canCall| current$Heap this@@8)) (or (_module.OwnedObject.baseFieldsInv current$Heap this@@8) (|Set#Subset| (_module.OwnedObject.objectFields current$Heap this@@8) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@8)) _module.Universe.content)))))))))))))))))))
