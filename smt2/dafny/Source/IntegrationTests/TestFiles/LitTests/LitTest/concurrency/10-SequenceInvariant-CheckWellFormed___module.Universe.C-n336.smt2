...
(assert (forall (($prevHeap@@3 T@U) ($h0@@2 T@U) ($h1@@2 T@U) (this@@11 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Universe) ($IsAlloc refType this@@11 Tclass._module.Universe $h0@@2)))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@4 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@4) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@4) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@4) $f@@2)))
 :qid |unknown.0:0|
 :skolemid |654|
)) (= (_module.Universe.baseLegalTransitionsSequence $prevHeap@@3 $h0@@2 this@@11) (_module.Universe.baseLegalTransitionsSequence $prevHeap@@3 $h1@@2 this@@11))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |655|
 :pattern ( ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2) (_module.Universe.baseLegalTransitionsSequence $prevHeap@@3 $h1@@2 this@@11))
)))
...
(assert (forall (($prevHeap@@5 T@U) ($h0@@4 T@U) ($h1@@4 T@U) (this@@13 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Thread) ($IsAlloc refType this@@13 Tclass._module.Thread $h0@@4)))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@6 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@6) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@6) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@6) $f@@4)))
 :qid |unknown.0:0|
 :skolemid |1232|
)) (= (_module.Thread.sequenceInv2 $prevHeap@@5 $h0@@4 this@@13) (_module.Thread.sequenceInv2 $prevHeap@@5 $h1@@4 this@@13))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1233|
 :pattern ( ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4) (_module.Thread.sequenceInv2 $prevHeap@@5 $h1@@4 this@@13))
)))
(assert (forall (($prevHeap@@6 T@U) ($h0@@5 T@U) ($h1@@5 T@U) (this@@14 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.OwnedObject) ($IsAlloc refType this@@14 Tclass._module.OwnedObject $h0@@5)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@7 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@7) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@7) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@7) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |1490|
)) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@6 $h0@@5 this@@14) (_module.OwnedObject.sequenceInv2 $prevHeap@@6 $h1@@5 this@@14))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1491|
 :pattern ( ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5) (_module.OwnedObject.sequenceInv2 $prevHeap@@6 $h1@@5 this@@14))
)))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@8 this@@15) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@8) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Object) ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@8)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 (_module.Object.universe this@@15)) _module.Universe.content)) ($Box refType this@@15)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@8 this@@15) (=> (_module.Object.baseFieldsInv $Heap@@8 this@@15) (|_module.Universe.globalBaseInv#canCall| $Heap@@8 (_module.Object.universe this@@15))))) (= (_module.Object.objectGlobalBaseInv $Heap@@8 this@@15)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 (_module.Object.universe this@@15)) _module.Universe.content)) ($Box refType this@@15)) (_module.Object.baseFieldsInv $Heap@@8 this@@15)) (_module.Universe.globalBaseInv $Heap@@8 (_module.Object.universe this@@15))))))
 :qid |_10SequenceInvariantdfy.196:19|
 :skolemid |1046|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@8 this@@15) ($IsGoodHeap $Heap@@8))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.Thread.baseFieldsInv#canCall| $Heap@@9 this@@16) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.Thread) ($IsAlloc refType this@@16 Tclass._module.Thread $Heap@@9)))))) (= (_module.Thread.baseFieldsInv $Heap@@9 this@@16) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.254:19|
 :skolemid |1191|
 :pattern ( (_module.Thread.baseFieldsInv $Heap@@9 this@@16) ($IsGoodHeap $Heap@@9))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@10 this@@17) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.OwnedObject) ($IsAlloc refType this@@17 Tclass._module.OwnedObject $Heap@@10)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@10 this@@17) (=> (_module.Object.objectGlobalBaseInv $Heap@@10 this@@17) (|_module.OwnedObject.localUserInv#canCall| $Heap@@10 this@@17))) (= (_module.OwnedObject.localInv $Heap@@10 this@@17)  (and (_module.Object.objectGlobalBaseInv $Heap@@10 this@@17) (_module.OwnedObject.localUserInv $Heap@@10 this@@17)))))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1460|
 :pattern ( (_module.OwnedObject.localInv $Heap@@10 this@@17) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@11 this@@18) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.OwnedObject) ($IsAlloc refType this@@18 Tclass._module.OwnedObject $Heap@@11)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@11 this@@18) (=> (_module.OwnedObject.localInv $Heap@@11 this@@18) (|_module.OwnedObject.userInv#canCall| $Heap@@11 this@@18))) (= (_module.OwnedObject.inv $Heap@@11 this@@18)  (and (_module.OwnedObject.localInv $Heap@@11 this@@18) (_module.OwnedObject.userInv $Heap@@11 this@@18)))))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1473|
 :pattern ( (_module.OwnedObject.inv $Heap@@11 this@@18) ($IsGoodHeap $Heap@@11))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@7 T@U) ($Heap@@12 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@7 $Heap@@12 this@@19) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@19 null)) (not true)) ($Is refType this@@19 Tclass._module.Thread)))) (= (_module.Object.sequenceInv2 $prevHeap@@7 $Heap@@12 this@@19) (_module.Thread.sequenceInv2 $prevHeap@@7 $Heap@@12 this@@19)))
 :qid |_10SequenceInvariantdfy.244:22|
 :skolemid |1237|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@7 $Heap@@12 this@@19) ($Is refType this@@19 Tclass._module.Thread) ($IsGoodHeap $Heap@@12))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@7 $Heap@@12 this@@19) (_module.Thread.sequenceInv2 $prevHeap@@7 $Heap@@12 this@@19) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@8 T@U) ($Heap@@13 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@8 $Heap@@13 this@@20) (and (< 3 $FunctionContextHeight) (and (or (not (= this@@20 null)) (not true)) ($Is refType this@@20 Tclass._module.OwnedObject)))) (= (_module.Object.sequenceInv2 $prevHeap@@8 $Heap@@13 this@@20) (_module.OwnedObject.sequenceInv2 $prevHeap@@8 $Heap@@13 this@@20)))
 :qid |_10SequenceInvariantdfy.244:22|
 :skolemid |1495|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@8 $Heap@@13 this@@20) ($Is refType this@@20 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@13))
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@8 $Heap@@13 this@@20) (_module.OwnedObject.sequenceInv2 $prevHeap@@8 $Heap@@13 this@@20) ($IsGoodHeap $Heap@@13))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@21 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@14 this@@21) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@21 null)) (not true)) (and ($Is refType this@@21 Tclass._module.Universe) ($IsAlloc refType this@@21 Tclass._module.Universe $Heap@@14)))))) (and (forall ((|o#0@@2| T@U) ) (!  (=> ($Is refType |o#0@@2| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@21) _module.Universe.content)) ($Box refType |o#0@@2|)) (=> (= (_module.Object.universe |o#0@@2|) this@@21) (=> (or (not (= |o#0@@2| this@@21)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@14 |o#0@@2|) (=> (_module.Object.baseFieldsInv $Heap@@14 |o#0@@2|) (|_module.Object.triggerAxioms#canCall| $Heap@@14 |o#0@@2|)))))))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@21) _module.Universe.content)) ($Box refType |o#0@@2|)))
)) (= (_module.Universe.globalBaseInv $Heap@@14 this@@21) (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@21) _module.Universe.content)) ($Box refType |o#0@@3|))) (and (and (and (= (_module.Object.universe |o#0@@3|) this@@21) (or (not (= |o#0@@3| this@@21)) (not true))) (_module.Object.baseFieldsInv $Heap@@14 |o#0@@3|)) (_module.Object.triggerAxioms $Heap@@14 |o#0@@3|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@21) _module.Universe.content)) ($Box refType |o#0@@3|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@14 this@@21) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@9 T@U) ($Heap@@15 T@U) (this@@22 T@U) ) (!  (=> (or (|_module.Thread.sequenceInv2#canCall| $prevHeap@@9 $Heap@@15 this@@22) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@9) ($IsGoodHeap $Heap@@15)) ($HeapSucc $prevHeap@@9 $Heap@@15)) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Thread) ($IsAlloc refType this@@22 Tclass._module.Thread $prevHeap@@9)))))) (= (_module.Thread.sequenceInv2 $prevHeap@@9 $Heap@@15 this@@22) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.269:22|
 :skolemid |1236|
 :pattern ( (_module.Thread.sequenceInv2 $prevHeap@@9 $Heap@@15 this@@22) ($IsGoodHeap $Heap@@15))
))))
(assert (forall (($h0@@6 T@U) ($h1@@6 T@U) (this@@23 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@17 T@U) ($f@@7 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (or (= $o@@17 this@@23) (= $o@@17 (_module.Object.universe this@@23)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@17) $f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@17) $f@@7)))
 :qid |unknown.0:0|
 :skolemid |1108|
)) (= (_module.Object.baseFieldsInv $h0@@6 this@@23) (_module.Object.baseFieldsInv $h1@@6 this@@23))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1109|
 :pattern ( ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6) (_module.Object.baseFieldsInv $h1@@6 this@@23))
)))
(assert (forall (($h0@@7 T@U) ($h1@@7 T@U) (this@@24 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.Thread))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@18 T@U) ($f@@8 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (or (= $o@@18 this@@24) (= $o@@18 (_module.Object.universe this@@24)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@18) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@18) $f@@8)))
 :qid |unknown.0:0|
 :skolemid |1187|
)) (= (_module.Thread.baseFieldsInv $h0@@7 this@@24) (_module.Thread.baseFieldsInv $h1@@7 this@@24))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1188|
 :pattern ( ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7) (_module.Thread.baseFieldsInv $h1@@7 this@@24))
)))
(assert (forall (($h0@@8 T@U) ($h1@@8 T@U) (this@@25 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@19 T@U) ($f@@9 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (or (= $o@@19 this@@25) (= $o@@19 (_module.Object.universe this@@25)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@19) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@19) $f@@9)))
 :qid |unknown.0:0|
 :skolemid |1440|
)) (= (_module.OwnedObject.baseFieldsInv $h0@@8 this@@25) (_module.OwnedObject.baseFieldsInv $h1@@8 this@@25))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1441|
 :pattern ( ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8) (_module.OwnedObject.baseFieldsInv $h1@@8 this@@25))
)))
(assert (forall (($h0@@9 T@U) ($h1@@9 T@U) (this@@26 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@9) ($IsGoodHeap $h1@@9)) (and (or (not (= this@@26 null)) (not true)) ($Is refType this@@26 Tclass._module.OwnedObject))) (and ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9))) (=> (forall (($o@@20 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (or (= $o@@20 this@@26) (= $o@@20 (_module.Object.universe this@@26)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@20) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@9 $o@@20) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |1529|
)) (= (_module.OwnedObject.baseUserFieldsInv $h0@@9 this@@26) (_module.OwnedObject.baseUserFieldsInv $h1@@9 this@@26))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1530|
 :pattern ( ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9) (_module.OwnedObject.baseUserFieldsInv $h1@@9 this@@26))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@27 T@U) ) (!  (=> (or (|_module.Object.triggerAxioms#canCall| $Heap@@16 this@@27) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Object) ($IsAlloc refType this@@27 Tclass._module.Object $Heap@@16)))))) (_module.Object.triggerAxioms $Heap@@16 this@@27))
 :qid |_10SequenceInvariantdfy.204:19|
 :skolemid |1064|
 :pattern ( (_module.Object.triggerAxioms $Heap@@16 this@@27))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@28 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@17 this@@28) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.OwnedObject) ($IsAlloc refType this@@28 Tclass._module.OwnedObject $Heap@@17)))))) (=> (_module.OwnedObject.userInv $Heap@@17 this@@28) (_module.OwnedObject.localUserInv $Heap@@17 this@@28)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1549|
 :pattern ( (_module.OwnedObject.userInv $Heap@@17 this@@28))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@29 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@18 this@@29) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Thread) ($IsAlloc refType this@@29 Tclass._module.Thread $Heap@@18)))))) (=> (_module.Thread.localInv $Heap@@18 this@@29) (_module.Object.objectGlobalBaseInv $Heap@@18 this@@29)))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1203|
 :pattern ( (_module.Thread.localInv $Heap@@18 this@@29))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@30 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@19 this@@30) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@30 null)) (not true)) (and ($Is refType this@@30 Tclass._module.OwnedObject) ($IsAlloc refType this@@30 Tclass._module.OwnedObject $Heap@@19)))))) (=> (_module.OwnedObject.localInv $Heap@@19 this@@30) (_module.Object.objectGlobalBaseInv $Heap@@19 this@@30)))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1458|
 :pattern ( (_module.OwnedObject.localInv $Heap@@19 this@@30))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@31 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@20 this@@31) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Object) ($IsAlloc refType this@@31 Tclass._module.Object $Heap@@20)))))) (=> (_module.Object.localInv $Heap@@20 this@@31) (_module.Object.objectGlobalBaseInv $Heap@@20 this@@31)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1116|
 :pattern ( (_module.Object.localInv $Heap@@20 this@@31))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@21 this@@32) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.Thread) ($IsAlloc refType this@@32 Tclass._module.Thread $Heap@@21)))))) (=> (_module.Thread.inv $Heap@@21 this@@32) (_module.Thread.localInv $Heap@@21 this@@32)))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1215|
 :pattern ( (_module.Thread.inv $Heap@@21 this@@32))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@22 T@U) (this@@33 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@22 this@@33) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.OwnedObject) ($IsAlloc refType this@@33 Tclass._module.OwnedObject $Heap@@22)))))) (=> (_module.OwnedObject.inv $Heap@@22 this@@33) (_module.OwnedObject.localInv $Heap@@22 this@@33)))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1471|
 :pattern ( (_module.OwnedObject.inv $Heap@@22 this@@33))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@34 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@23 this@@34) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.Object) ($IsAlloc refType this@@34 Tclass._module.Object $Heap@@23)))))) (=> (_module.Object.inv $Heap@@23 this@@34) (_module.Object.localInv $Heap@@23 this@@34)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1126|
 :pattern ( (_module.Object.inv $Heap@@23 this@@34))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@10 T@U) ($Heap@@24 T@U) (this@@35 T@U) ) (!  (=> (or (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@10 $Heap@@24 this@@35) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@10) ($IsGoodHeap $Heap@@24)) ($HeapSucc $prevHeap@@10 $Heap@@24)) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.OwnedObject) ($IsAlloc refType this@@35 Tclass._module.OwnedObject $prevHeap@@10)))))) (and (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@35) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 this@@35) _module.OwnedObject.owner))) (|_module.OwnedObject.unchangedNonvolatileUserFields#canCall| $prevHeap@@10 $Heap@@24 this@@35)) (= (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@10 $Heap@@24 this@@35)  (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@10 this@@35) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 this@@35) _module.OwnedObject.owner))) (_module.OwnedObject.unchangedNonvolatileUserFields $prevHeap@@10 $Heap@@24 this@@35)))))
 :qid |_10SequenceInvariantdfy.312:22|
 :skolemid |1438|
 :pattern ( (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@10 $Heap@@24 this@@35) ($IsGoodHeap $Heap@@24))
))))
...
(assert (forall (($h@@11 T@U) ($o@@21 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@21 null)) (not true)) ($Is refType $o@@21 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@21) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@21) _module.OwnedObject.nonvolatileVersion)) TInt $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1425|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@21) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h0@@10 T@U) ($h1@@10 T@U) (this@@36 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@36 null)) (not true)) ($Is refType this@@36 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@22 T@U) ($f@@11 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (= $o@@22 this@@36)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@22) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@22) $f@@11)))
 :qid |unknown.0:0|
 :skolemid |1062|
)) (= (_module.Object.triggerAxioms $h0@@10 this@@36) (_module.Object.triggerAxioms $h1@@10 this@@36))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1063|
 :pattern ( ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10) (_module.Object.triggerAxioms $h1@@10 this@@36))
)))
(assert (forall (($h0@@11 T@U) ($h1@@11 T@U) (this@@37 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@37 null)) (not true)) ($Is refType this@@37 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@23 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (or (= $o@@23 this@@37) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 this@@37) _module.Universe.content)) ($Box refType $o@@23)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@23) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@23) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |608|
)) (= (_module.Universe.globalBaseInv $h0@@11 this@@37) (_module.Universe.globalBaseInv $h1@@11 this@@37))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |609|
 :pattern ( ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11) (_module.Universe.globalBaseInv $h1@@11 this@@37))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($prevHeap@@11 T@U) ($Heap@@25 T@U) (this@@38 T@U) ) (!  (=> (or (|_module.OwnedObject.sequenceInv2#canCall| $prevHeap@@11 $Heap@@25 this@@38) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@11) ($IsGoodHeap $Heap@@25)) ($HeapSucc $prevHeap@@11 $Heap@@25)) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.OwnedObject) ($IsAlloc refType this@@38 Tclass._module.OwnedObject $prevHeap@@11)))))) (and (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@38) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@38) _module.OwnedObject.nonvolatileVersion)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.unchangedNonvolatileFields#canCall| $prevHeap@@11 $Heap@@25 this@@38)))) (= (_module.OwnedObject.sequenceInv2 $prevHeap@@11 $Heap@@25 this@@38)  (and (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@38) _module.OwnedObject.nonvolatileVersion)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@38) _module.OwnedObject.nonvolatileVersion)))) (and true (_module.OwnedObject.unchangedNonvolatileFields $prevHeap@@11 $Heap@@25 this@@38)))) (=> ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 this@@38) _module.OwnedObject.owner)) Tclass._module.OwnedObject) (let ((|oldOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 this@@38) _module.OwnedObject.owner))))
 (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 |oldOwner#0|) _module.OwnedObject.nonvolatileVersion)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 this@@38) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@38) _module.OwnedObject.nonvolatileVersion)))))))))))
 :qid |_10SequenceInvariantdfy.338:22|
 :skolemid |1494|
 :pattern ( (_module.OwnedObject.sequenceInv2 $prevHeap@@11 $Heap@@25 this@@38) ($IsGoodHeap $Heap@@25))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($prevHeap@@12 T@U) ($Heap@@26 T@U) (this@@39 T@U) (|running#0@@0| T@U) ) (!  (=> (or (|_module.Universe.legalTransitionsSequence#canCall| $prevHeap@@12 $Heap@@26 this@@39 |running#0@@0|) (and (< 8 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@12) ($IsGoodHeap $Heap@@26)) ($HeapSucc $prevHeap@@12 $Heap@@26)) (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.Universe) ($IsAlloc refType this@@39 Tclass._module.Universe $prevHeap@@12)))) ($Is SetType |running#0@@0| (TSet Tclass._module.Thread))))) (and (and (|_module.Universe.baseLegalTransitionsSequence#canCall| $prevHeap@@12 $Heap@@26 this@@39) (=> (_module.Universe.baseLegalTransitionsSequence $prevHeap@@12 $Heap@@26 this@@39) (forall ((|o#0@@4| T@U) ) (!  (=> ($Is refType |o#0@@4| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 this@@39) _module.Universe.content)) ($Box refType |o#0@@4|)) (=> (not (forall (($o@@24 T@U) ($f@@13 T@U) ) (!  (=> (or (not (= $o@@24 null)) (not true)) (=> (= $o@@24 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 $o@@24) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 $o@@24) $f@@13))))
 :qid |_10SequenceInvariantdfy.55:49|
 :skolemid |670|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 $o@@24) $f@@13))
))) (|_module.Object.sequenceInv2#canCall| $prevHeap@@12 $Heap@@26 |o#0@@4|))))
 :qid |_10SequenceInvariantdfy.55:16|
 :skolemid |671|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@12 $Heap@@26 |o#0@@4|))
...
)))) (= (_module.Universe.legalTransitionsSequence $prevHeap@@12 $Heap@@26 this@@39 |running#0@@0|)  (and (and (_module.Universe.baseLegalTransitionsSequence $prevHeap@@12 $Heap@@26 this@@39) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 this@@39) _module.Universe.content)) ($Box refType |o#0@@5|))) (or (forall (($o@@25 T@U) ($f@@14 T@U) ) (!  (=> (or (not (= $o@@25 null)) (not true)) (=> (= $o@@25 |o#0@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 $o@@25) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 $o@@25) $f@@14))))
 :qid |_10SequenceInvariantdfy.55:49|
 :skolemid |667|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 $o@@25) $f@@14))
)) (_module.Object.sequenceInv2 $prevHeap@@12 $Heap@@26 |o#0@@5|)))
 :qid |_10SequenceInvariantdfy.55:16|
 :skolemid |668|
 :pattern ( (_module.Object.sequenceInv2 $prevHeap@@12 $Heap@@26 |o#0@@5|))
...
))) (forall ((|o#1| T@U) ) (!  (=> (and ($Is refType |o#1| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 this@@39) _module.Universe.content)) ($Box refType |o#1|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 |o#1|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (and (not (|Set#IsMember| |running#0@@0| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 |o#1|) _module.OwnedObject.owner))) ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 |o#1|) _module.OwnedObject.owner) Tclass._module.Object $prevHeap@@12)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 |o#1|) _module.OwnedObject.nonvolatileVersion))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#1|) _module.OwnedObject.nonvolatileVersion))))))
 :qid |_10SequenceInvariantdfy.58:16|
 :skolemid |669|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |o#1|) _module.OwnedObject.nonvolatileVersion)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@12 this@@39) _module.Universe.content)) ($Box refType |o#1|)))
))))))
 :qid |_10SequenceInvariantdfy.51:22|
 :skolemid |674|
 :pattern ( (_module.Universe.legalTransitionsSequence $prevHeap@@12 $Heap@@26 this@@39 |running#0@@0|) ($IsGoodHeap $Heap@@26))
))))
...
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@40 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.Universe) ($IsAlloc refType this@@40 Tclass._module.Universe $h0@@12)))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@27 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@27) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@27) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@27) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |620|
)) (= (_module.Universe.globalInv $h0@@12 this@@40) (_module.Universe.globalInv $h1@@12 this@@40))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |621|
...
(assert (forall (($h0@@13 T@U) ($h1@@13 T@U) (this@@41 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@13) ($IsGoodHeap $h1@@13)) (and (or (not (= this@@41 null)) (not true)) (and ($Is refType this@@41 Tclass._module.Object) ($IsAlloc refType this@@41 Tclass._module.Object $h0@@13)))) (and ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13))) (=> (forall (($o@@28 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@28) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@28) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@13 $o@@28) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |1042|
)) (= (_module.Object.objectGlobalBaseInv $h0@@13 this@@41) (_module.Object.objectGlobalBaseInv $h1@@13 this@@41))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1043|
...
(assert (forall (($h0@@16 T@U) ($h1@@16 T@U) (this@@44 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@16) ($IsGoodHeap $h1@@16)) (and (or (not (= this@@44 null)) (not true)) (and ($Is refType this@@44 Tclass._module.Thread) ($IsAlloc refType this@@44 Tclass._module.Thread $h0@@16)))) (and ($IsHeapAnchor $h0@@16) ($HeapSucc $h0@@16 $h1@@16))) (=> (forall (($o@@31 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@31) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@16 $o@@31) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@16 $o@@31) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |1201|
...
(assert (not
 ...
 :qid |_10SequenceInvariantdfy.146:10|
 :skolemid |945|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@30) ($IsHeapAnchor $Heap@@30)) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Universe) ($IsAlloc refType this@@53 Tclass._module.Universe $Heap@@30)))) (and (and ($Is SetType |running#0@@1| (TSet Tclass._module.Thread)) ($IsAlloc SetType |running#0@@1| (TSet Tclass._module.Thread) $Heap@@30)) (and (= 13 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
