...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.invA)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |self#0@@13| null)) (not true))) (=> (or (not (= |self#0@@13| null)) (not true)) (=> (and (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |self#0@@13| _module.TraitA.b))) (= |##self#0@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |self#0@@13|) _module.TraitA.b)))) (and ($IsAlloc refType |##self#0@0| Tclass._module.TraitB $Heap@@13) (= |b$reqreads#1@0| (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@8) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@8) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@0)))
 :qid |_04LeastGreatestdfy.76:3|
 :skolemid |706|
))))) (and (and (|_module.__default.invB#canCall| $Heap@@13 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |self#0@@13|) _module.TraitA.b))) (= (_module.__default.invA ($LS $LZ) $Heap@@13 |self#0@@13|) (_module.__default.invB ($LS $LZ) $Heap@@13 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |self#0@@13|) _module.TraitA.b))))) (and (|_module.__default.invB#canCall| $Heap@@13 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 |self#0@@13|) _module.TraitA.b))) ($Is boolType (bool_2_U (_module.__default.invA ($LS $LZ) $Heap@@13 |self#0@@13|)) TBool)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@0|))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) ($Is refType |self#0@@13| Tclass._module.TraitA)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
