...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.IncreasingCounter.localUserInv#canCall| $Heap@@3 this@@9) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.IncreasingCounter)))) (= (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.IncreasingCounter.localUserInv $Heap@@3 this@@9)))
 :qid |_10SequenceInvariantdfy.395:19|
 :skolemid |1588|
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) ($Is refType this@@9 Tclass._module.IncreasingCounter) ($IsGoodHeap $Heap@@3))
 :pattern ( (_module.OwnedObject.localUserInv $Heap@@3 this@@9) (_module.IncreasingCounter.localUserInv $Heap@@3 this@@9) ($IsGoodHeap $Heap@@3))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.IncreasingCounter.userInv#canCall| $Heap@@4 this@@10) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.IncreasingCounter)))) (= (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.IncreasingCounter.userInv $Heap@@4 this@@10)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1595|
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) ($Is refType this@@10 Tclass._module.IncreasingCounter) ($IsGoodHeap $Heap@@4))
 :pattern ( (_module.OwnedObject.userInv $Heap@@4 this@@10) (_module.IncreasingCounter.userInv $Heap@@4 this@@10) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.IncreasingCounter.baseUserFieldsInv#canCall| $Heap@@6 this@@12) (and (< 2 $FunctionContextHeight) (and (or (not (= this@@12 null)) (not true)) ($Is refType this@@12 Tclass._module.IncreasingCounter)))) (= (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) (_module.IncreasingCounter.baseUserFieldsInv $Heap@@6 this@@12)))
 :qid |_10SequenceInvariantdfy.392:19|
 :skolemid |1567|
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) ($Is refType this@@12 Tclass._module.IncreasingCounter) ($IsGoodHeap $Heap@@6))
 :pattern ( (_module.OwnedObject.baseUserFieldsInv $Heap@@6 this@@12) (_module.IncreasingCounter.baseUserFieldsInv $Heap@@6 this@@12) ($IsGoodHeap $Heap@@6))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@39 T@U) ($Heap@@37 T@U) (this@@57 T@U) ) (!  (=> (or (|_module.IncreasingCounter.unchangedNonvolatileUserFields#canCall| $prevHeap@@39 $Heap@@37 this@@57) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@39) ($IsGoodHeap $Heap@@37)) ($HeapSucc $prevHeap@@39 $Heap@@37)) (and (or (not (= this@@57 null)) (not true)) (and ($Is refType this@@57 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@57 Tclass._module.IncreasingCounter $prevHeap@@39)))))) (= (_module.IncreasingCounter.unchangedNonvolatileUserFields $prevHeap@@39 $Heap@@37 this@@57) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |_10SequenceInvariantdfy.422:22|
 :skolemid |1580|
 :pattern ( (_module.IncreasingCounter.unchangedNonvolatileUserFields $prevHeap@@39 $Heap@@37 this@@57) ($IsGoodHeap $Heap@@37))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@40 T@U) ($Heap@@38 T@U) (this@@58 T@U) ) (!  (=> (or (|_module.IncreasingCounter.userInv2#canCall| $prevHeap@@40 $Heap@@38 this@@58) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@40) ($IsGoodHeap $Heap@@38)) ($HeapSucc $prevHeap@@40 $Heap@@38)) (and (or (not (= this@@58 null)) (not true)) (and ($Is refType this@@58 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@58 Tclass._module.IncreasingCounter $prevHeap@@40)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.IncreasingCounter.localUserInv2#canCall| $prevHeap@@40 $Heap@@38 this@@58)) (= (_module.IncreasingCounter.userInv2 $prevHeap@@40 $Heap@@38 this@@58)  (and true (_module.IncreasingCounter.localUserInv2 $prevHeap@@40 $Heap@@38 this@@58)))))
 :qid |_10SequenceInvariantdfy.434:22|
 :skolemid |1609|
 :pattern ( (_module.IncreasingCounter.userInv2 $prevHeap@@40 $Heap@@38 this@@58) ($IsGoodHeap $Heap@@38))
))))
...
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@64 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@64 null)) (not true)) ($Is refType this@@64 Tclass._module.IncreasingCounter))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@46 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@46 null)) (not true)) (or (= $o@@46 this@@64) (= $o@@46 (_module.Object.universe this@@64)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@46) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@46) $f@@32)))
 :qid |unknown.0:0|
 :skolemid |1562|
...
(assert (forall (($h@@16 T@U) ($o@@49 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (or (not (= $o@@49 null)) (not true)) (= (dtype $o@@49) Tclass._module.IncreasingCounter?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@49) _module.IncreasingCounter.value)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1560|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@16 $o@@49) _module.IncreasingCounter.value)))
)))
...
(assert (forall (($h0@@36 T@U) ($h1@@36 T@U) (this@@89 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@36) ($IsGoodHeap $h1@@36)) (and (or (not (= this@@89 null)) (not true)) (and ($Is refType this@@89 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@89 Tclass._module.IncreasingCounter $h0@@36)))) (and ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36))) (=> (forall (($o@@65 T@U) ($f@@48 T@U) ) (!  (=> (and (or (not (= $o@@65 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@65) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@36 $o@@65) $f@@48) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@36 $o@@65) $f@@48)))
 :qid |unknown.0:0|
 :skolemid |1583|
)) (= (_module.IncreasingCounter.localUserInv $h0@@36 this@@89) (_module.IncreasingCounter.localUserInv $h1@@36 this@@89))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1584|
 :pattern ( ($IsHeapAnchor $h0@@36) ($HeapSucc $h0@@36 $h1@@36) (_module.IncreasingCounter.localUserInv $h1@@36 this@@89))
)))
(assert (forall (($h0@@37 T@U) ($h1@@37 T@U) (this@@90 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@37) ($IsGoodHeap $h1@@37)) (and (or (not (= this@@90 null)) (not true)) (and ($Is refType this@@90 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@90 Tclass._module.IncreasingCounter $h0@@37)))) (and ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37))) (=> (forall (($o@@66 T@U) ($f@@49 T@U) ) (!  (=> (and (or (not (= $o@@66 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@66) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@37 $o@@66) $f@@49) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@37 $o@@66) $f@@49)))
 :qid |unknown.0:0|
 :skolemid |1590|
)) (= (_module.IncreasingCounter.userInv $h0@@37 this@@90) (_module.IncreasingCounter.userInv $h1@@37 this@@90))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1591|
 :pattern ( ($IsHeapAnchor $h0@@37) ($HeapSucc $h0@@37 $h1@@37) (_module.IncreasingCounter.userInv $h1@@37 this@@90))
)))
...
(assert (forall (($o@@69 T@U) ) (!  (=> ($Is refType $o@@69 Tclass._module.IncreasingCounter?) ($Is refType $o@@69 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2413|
 :pattern ( ($Is refType $o@@69 Tclass._module.IncreasingCounter?))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@45 T@U) ($Heap@@52 T@U) (this@@91 T@U) ) (!  (=> (or (|_module.IncreasingCounter.userInv2#canCall| $prevHeap@@45 $Heap@@52 this@@91) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@45) ($IsGoodHeap $Heap@@52)) ($HeapSucc $prevHeap@@45 $Heap@@52)) (and (or (not (= this@@91 null)) (not true)) (and ($Is refType this@@91 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@91 Tclass._module.IncreasingCounter $prevHeap@@45)))))) (=> (_module.IncreasingCounter.userInv2 $prevHeap@@45 $Heap@@52 this@@91) (_module.IncreasingCounter.localUserInv2 $prevHeap@@45 $Heap@@52 this@@91)))
 :qid |_10SequenceInvariantdfy.434:22|
 :skolemid |1607|
 :pattern ( (_module.IncreasingCounter.userInv2 $prevHeap@@45 $Heap@@52 this@@91))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@54 T@U) (this@@93 T@U) ) (!  (=> (or (|_module.IncreasingCounter.userInv#canCall| $Heap@@54 this@@93) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@54) (and (or (not (= this@@93 null)) (not true)) (and ($Is refType this@@93 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@93 Tclass._module.IncreasingCounter $Heap@@54)))))) (and (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.IncreasingCounter.localUserInv#canCall| $Heap@@54 this@@93)) (= (_module.IncreasingCounter.userInv $Heap@@54 this@@93)  (and true (_module.IncreasingCounter.localUserInv $Heap@@54 this@@93)))))
 :qid |_10SequenceInvariantdfy.427:19|
 :skolemid |1594|
 :pattern ( (_module.IncreasingCounter.userInv $Heap@@54 this@@93) ($IsGoodHeap $Heap@@54))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#10| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@97) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@97 Tclass._module.IncreasingCounter $Heap@@58)) (=> ($IsAlloc refType this@@97 Tclass._module.IncreasingCounter $Heap@@58) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@58)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@58) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@58 current$Heap this@@97 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@58 current$Heap this@@97 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@97) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@97 Tclass._module.IncreasingCounter $Heap@@58))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@58) ($IsHeapAnchor $Heap@@58)) (and (or (not (= this@@97 null)) (not true)) (and ($Is refType this@@97 Tclass._module.IncreasingCounter) ($IsAlloc refType this@@97 Tclass._module.IncreasingCounter previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 14 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@58) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
