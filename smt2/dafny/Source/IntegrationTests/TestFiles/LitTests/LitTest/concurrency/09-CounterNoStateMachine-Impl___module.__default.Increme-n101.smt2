...
))))) (forall (($o@@134 T@U) ) (!  (=> (and (or (not (= $o@@134 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@134) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@134) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@134)) (or (= $o@@134 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType $o@@134)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@134))
)))) (and (and (and ($HeapSucc $Heap@12 $Heap@13) (or (not (= |counter#0| null)) (not true))) (and (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |counter#0| _module.IncreasingCounter.value)) (or (not (= |counter#0| null)) (not true)))) (and (and (= |$rhs#0_2@1| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |counter#0|) _module.IncreasingCounter.value))) 1)) (= $Heap@14 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@13 |counter#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 |counter#0|) _module.IncreasingCounter.value ($Box intType (int_2_U |$rhs#0_2@1|)))))) (and ($IsGoodHeap $Heap@14) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
