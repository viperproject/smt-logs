...
(set-info :boogie-vc-id Impl$$_module.MutexGuardU32.__ctor_split6)
...
)))) (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0|)) ($Box refType |running#0|)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)))) (and (|Set#Subset| |mightPointTo##0@0| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content))) (= (ControlFlow 0 2) (- 0 1))))))) (forall ((|l#1@@2| T@U) ) (!  (=> (and ($Is refType |l#1@@2| Tclass._module.Lifetime) (|Set#IsMember| |mightPointTo##0@0| ($Box refType |l#1@@2|))) (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |l#1@@2|) _module.Lifetime.owner)) |running#0|))
 :qid |_12MutexLifetimeshortdfy.611:21|
 :skolemid |2279|
 :pattern ( ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |l#1@@2|) _module.Lifetime.owner)))
