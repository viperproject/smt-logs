...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@54) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29)) (=> ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@29)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@29) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@29 current$Heap this@@54 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@29 current$Heap this@@54 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@54) Tclass._module.Object? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@54 Tclass._module.Object $Heap@@29))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@29) ($IsHeapAnchor $Heap@@29)) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.Object) ($IsAlloc refType this@@54 Tclass._module.Object previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 12 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@29) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
