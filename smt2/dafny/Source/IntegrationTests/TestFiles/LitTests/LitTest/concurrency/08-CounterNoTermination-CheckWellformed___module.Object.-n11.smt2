...
(assert (forall (($h0@@11 T@U) ($h1@@11 T@U) (this@@32 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@32 null)) (not true)) ($Is refType this@@32 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@32 T@U) ($f@@19 T@U) )  (=> (and (or (not (= $o@@32 null)) (not true)) (or (= $o@@32 this@@32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 this@@32) _module.Universe.content)) ($Box refType $o@@32)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@32) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@32) $f@@19)))) (= (_module.Universe.globalBaseInv $h0@@11 this@@32) (_module.Universe.globalBaseInv $h1@@11 this@@32))))
