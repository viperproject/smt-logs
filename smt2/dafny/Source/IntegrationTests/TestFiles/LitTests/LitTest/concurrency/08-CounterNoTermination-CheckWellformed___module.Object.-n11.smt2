...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@18 T@U) ($f@@11 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#3| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@18 $f@@11))  (=> (and (or (not (= $o@@18 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@18) |l#2|)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| $o@@18) |l#4|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2275|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#3| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@18 $f@@11))
)))
...
))) (|_module.Object.inv#canCall| $Heap@@12 |o#0@@3|)) (=> (or (forall (($o@@22 T@U) ($f@@13 T@U) ) (!  (=> (or (not (= $o@@22 null)) (not true)) (=> (= $o@@22 |o#0@@3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@22) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@16 $o@@22) $f@@13))))
 :qid |_08CounterNoTerminationdfy.52:49|
 :skolemid |540|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@22) $f@@13))
)) (_module.Object.inv $Heap@@12 |o#0@@3|)) (=> (not (forall (($o@@23 T@U) ($f@@14 T@U) ) (!  (=> (or (not (= $o@@23 null)) (not true)) (=> (= $o@@23 |o#0@@3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@23) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@16 $o@@23) $f@@14))))
 :qid |_08CounterNoTerminationdfy.52:49|
 :skolemid |539|
...
)) (=> (forall ((|o#0@@4| T@U) ) (!  (=> (and ($Is refType |o#0@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@16 this@@24) _module.Universe.content)) ($Box refType |o#0@@4|))) (and (or (forall (($o@@24 T@U) ($f@@15 T@U) ) (!  (=> (or (not (= $o@@24 null)) (not true)) (=> (= $o@@24 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@24) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@16 $o@@24) $f@@15))))
 :qid |_08CounterNoTerminationdfy.52:49|
 :skolemid |546|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@24) $f@@15))
)) (_module.Object.inv $Heap@@12 |o#0@@4|)) (or (forall (($o@@25 T@U) ($f@@16 T@U) ) (!  (=> (or (not (= $o@@25 null)) (not true)) (=> (= $o@@25 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 $o@@25) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@16 $o@@25) $f@@16))))
 :qid |_08CounterNoTerminationdfy.52:49|
 :skolemid |547|
...
(assert (forall (($o@@29 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@29 Tclass._module.Thread? $heap@@0) ($IsAlloc refType $o@@29 Tclass._module.NonOwnedObject? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |2252|
 :pattern ( ($IsAlloc refType $o@@29 Tclass._module.Thread? $heap@@0))
)))
(assert (forall (($o@@30 T@U) ($heap@@1 T@U) ) (!  (=> ($IsAlloc refType $o@@30 Tclass._module.OwnedObject? $heap@@1) ($IsAlloc refType $o@@30 Tclass._module.Object? $heap@@1))
 :qid |unknown.0:0|
 :skolemid |2256|
 :pattern ( ($IsAlloc refType $o@@30 Tclass._module.OwnedObject? $heap@@1))
)))
...
(assert (forall (($h@@14 T@U) ($o@@31 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@31 null)) (not true)) ($Is refType $o@@31 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@31) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@31) _module.OwnedObject.nonvolatileVersion)) TInt $h@@14))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |961|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@31) _module.OwnedObject.nonvolatileVersion)))
)))
...
(assert (forall (($h0@@11 T@U) ($h1@@11 T@U) (this@@32 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@32 null)) (not true)) ($Is refType this@@32 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@32 T@U) ($f@@19 T@U) ) (!  (=> (and (or (not (= $o@@32 null)) (not true)) (or (= $o@@32 this@@32) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 this@@32) _module.Universe.content)) ($Box refType $o@@32)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@32) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@32) $f@@19)))
 :qid |unknown.0:0|
 :skolemid |494|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon11_correct  (=> (= (_module.Object.goodPreAndLegalChanges $Heap@@29 current$Heap this@@53 |running#0@@3|)  (and (and (and (and (_module.Object.baseInv $Heap@@29 this@@53) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@53))) (_module.Object.baseInv current$Heap this@@53)) (forall (($o@@57 T@U) ($f@@33 T@U) ) (!  (=> (or (not (= $o@@57 null)) (not true)) (=> (= $o@@57 this@@53) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@57) $f@@33) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 $o@@57) $f@@33))))
 :qid |_08CounterNoTerminationdfy.107:8|
 :skolemid |708|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@57) $f@@33))
))) (_module.Universe.legalTransition $Heap@@29 current$Heap (_module.Object.universe this@@53) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))))) (=> (and (and (and (|_module.Object.baseInv#canCall| $Heap@@29 this@@53) (=> (_module.Object.baseInv $Heap@@29 this@@53) (|_module.Universe.globalInv#canCall| $Heap@@29 (_module.Object.universe this@@53)))) (=> (and (_module.Object.baseInv $Heap@@29 this@@53) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@53))) (and (|_module.Object.baseInv#canCall| current$Heap this@@53) (=> (_module.Object.baseInv current$Heap this@@53) (=> (forall (($o@@58 T@U) ($f@@34 T@U) ) (!  (=> (or (not (= $o@@58 null)) (not true)) (=> (= $o@@58 this@@53) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@58) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 $o@@58) $f@@34))))
 :qid |_08CounterNoTerminationdfy.107:8|
 :skolemid |709|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@58) $f@@34))
)) (|_module.Universe.legalTransition#canCall| $Heap@@29 current$Heap (_module.Object.universe this@@53) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)))))))) ($Is boolType (bool_2_U (_module.Object.goodPreAndLegalChanges $Heap@@29 current$Heap this@@53 |running#0@@3|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))))
(let ((anon17_Else_correct  (=> (not (and (and (and (_module.Object.baseInv $Heap@@29 this@@53) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@53))) (_module.Object.baseInv current$Heap this@@53)) (forall (($o@@59 T@U) ($f@@35 T@U) ) (!  (=> (or (not (= $o@@59 null)) (not true)) (=> (= $o@@59 this@@53) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@59) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 $o@@59) $f@@35))))
 :qid |_08CounterNoTerminationdfy.107:8|
 :skolemid |706|
...
(let ((anon17_Then_correct  (=> (and (and (and (_module.Object.baseInv $Heap@@29 this@@53) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@53))) (_module.Object.baseInv current$Heap this@@53)) (forall (($o@@60 T@U) ($f@@36 T@U) ) (!  (=> (or (not (= $o@@60 null)) (not true)) (=> (= $o@@60 this@@53) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@60) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@29 $o@@60) $f@@36))))
 :qid |_08CounterNoTerminationdfy.107:8|
 :skolemid |706|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@60) $f@@36))
))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@53) null)) (not true)) (=> ($IsAllocBox ($Box refType (_module.Object.universe this@@53)) Tclass._module.Universe? current$Heap) (=> (and (= |##running#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) ($IsAlloc SetType |##running#0@0| (TSet Tclass._module.Thread) current$Heap)) (and (=> (= (ControlFlow 0 6) (- 0 8)) ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@29)) (=> ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@29) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (TSet Tclass._module.Thread) $Heap@@29)) (=> ($IsAlloc SetType (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)) (TSet Tclass._module.Thread) $Heap@@29) (=> (and (and (= |b$reqreads#2@0| (forall (($o@@61 T@U) ($f@@37 T@U) ) (!  (=> (and (and (or (not (= $o@@61 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@61) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@61) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@61 $f@@37)))
 :qid |_08CounterNoTerminationdfy.108:17|
 :skolemid |705|
))) (|_module.Universe.legalTransition#canCall| $Heap@@29 current$Heap (_module.Object.universe this@@53) (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|)))) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon11_correct))))))))))))
(let ((anon16_Else_correct  (=> (and (not (and (and (_module.Object.baseInv $Heap@@29 this@@53) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@53))) (_module.Object.baseInv current$Heap this@@53))) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 13) 6) anon17_Then_correct) (=> (= (ControlFlow 0 13) 10) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (and (_module.Object.baseInv $Heap@@29 this@@53) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@53))) (_module.Object.baseInv current$Heap this@@53)) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType this@@53 Tclass._module.Object $Heap@@29)) (=> ($IsAlloc refType this@@53 Tclass._module.Object $Heap@@29) (=> (and (= |b$reqreads#1@0| (forall (($o@@62 T@U) ($f@@38 T@U) ) (!  (=> (and (and (or (not (= $o@@62 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@62) alloc)))) (= $o@@62 this@@53)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@62 $f@@38)))
 :qid |_08CounterNoTerminationdfy.107:18|
 :skolemid |704|
))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 11) 6) anon17_Then_correct) (=> (= (ControlFlow 0 11) 10) anon17_Else_correct))))))))
(let ((anon15_Else_correct  (=> (and (not (and (_module.Object.baseInv $Heap@@29 this@@53) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@53)))) (= |b$reqreads#0@1| true)) (and (=> (= (ControlFlow 0 15) 11) anon16_Then_correct) (=> (= (ControlFlow 0 15) 13) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (_module.Object.baseInv $Heap@@29 this@@53) (_module.Universe.globalInv $Heap@@29 (_module.Object.universe this@@53))) (=> (and (and ($IsAllocBox ($Box refType this@@53) Tclass._module.Object? current$Heap) (= |b$reqreads#0@0| (forall (($o@@63 T@U) ($f@@39 T@U) ) (!  (=> (and (and (or (not (= $o@@63 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@63) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@63) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@63 $f@@39)))
 :qid |_08CounterNoTerminationdfy.106:8|
 :skolemid |703|
)))) (and (|_module.Object.baseInv#canCall| current$Heap this@@53) (= |b$reqreads#0@1| |b$reqreads#0@0|))) (and (=> (= (ControlFlow 0 14) 11) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct))))))
(let ((anon14_Else_correct  (=> (not (_module.Object.baseInv $Heap@@29 this@@53)) (and (=> (= (ControlFlow 0 20) 14) anon15_Then_correct) (=> (= (ControlFlow 0 20) 15) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (_module.Object.baseInv $Heap@@29 this@@53) (and (=> (= (ControlFlow 0 16) (- 0 19)) ($IsAlloc refType this@@53 Tclass._module.Object $Heap@@29)) (=> ($IsAlloc refType this@@53 Tclass._module.Object $Heap@@29) (and (=> (= (ControlFlow 0 16) (- 0 18)) (or (not (= (_module.Object.universe this@@53) null)) (not true))) (=> (or (not (= (_module.Object.universe this@@53) null)) (not true)) (and (=> (= (ControlFlow 0 16) (- 0 17)) ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@29)) (=> ($IsAlloc refType (_module.Object.universe this@@53) Tclass._module.Universe $Heap@@29) (=> (|_module.Universe.globalInv#canCall| $Heap@@29 (_module.Object.universe this@@53)) (and (=> (= (ControlFlow 0 16) 14) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct))))))))))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) ($IsAlloc refType this@@53 Tclass._module.Object $Heap@@29)) (=> ($IsAlloc refType this@@53 Tclass._module.Object $Heap@@29) (=> (|_module.Object.baseInv#canCall| $Heap@@29 this@@53) (and (=> (= (ControlFlow 0 21) 16) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@29) ($IsHeapAnchor $Heap@@29)) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Object) ($IsAlloc refType this@@53 Tclass._module.Object previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread previous$Heap)) (= 11 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@29) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 24) 23))) anon0_correct))))
