...
))) (and (and ($HeapSucc $Heap@26 $Heap@27) (>= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call4formal@this@0@@1) _module.ConstantInteger.value))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@27 call4formal@this@0) _module.ConstantInteger.value))) 1))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (ControlFlow 0 2) (- 0 1))))))))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
