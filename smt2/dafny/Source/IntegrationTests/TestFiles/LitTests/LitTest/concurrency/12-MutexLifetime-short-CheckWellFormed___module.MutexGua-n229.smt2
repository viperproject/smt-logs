...
(set-info :boogie-vc-id CheckWellFormed$$_module.MutexGuardU32.__ctor_split29)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@81) ($IsHeapAnchor $Heap@@81)) (=> (and (and (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@81)) (and ($Is refType |running#0| Tclass._module.Thread) ($IsAlloc refType |running#0| Tclass._module.Thread $Heap@@81))) (and (and ($Is refType |scope#0| Tclass._module.Lifetime) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@81)) (and ($Is refType |mutex#0| Tclass._module.Mutex) ($IsAlloc refType |mutex#0| Tclass._module.Mutex $Heap@@81)))) (=> (and (and (and (and ($Is refType |mutexScope#0| Tclass._module.Lifetime) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@81)) (= 23 $FunctionContextHeight)) (and (= $_ModifiesFrame@0 (|lambda#250| null $Heap@@81 alloc |universe#0| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) Tclass._module.Lifetime ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) $Heap@@81 _module.Lifetime.owner |running#0| |scope#0| |mutexScope#0|)) (or (not (= |universe#0| null)) (not true)))) (and (and (and ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@81) (|_module.Universe.globalInv#canCall| $Heap@@81 |universe#0|)) (and (_module.Universe.globalInv $Heap@@81 |universe#0|) (or (not (= |universe#0| null)) (not true)))) (and (and (|Set#Subset| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0|)) ($Box refType |scope#0|)) ($Box refType |mutex#0|)) ($Box refType |mutexScope#0|)) ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content))) (or (not (= |scope#0| null)) (not true))) (and (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |scope#0|) _module.Lifetime.owner)) |running#0|) (or (not (= |mutexScope#0| null)) (not true)))))) (=> (and (and (and (and (and (= ($Unbox refType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |mutexScope#0|) _module.Lifetime.owner)) |running#0|) (or (not (= |scope#0| |mutexScope#0|)) (not true))) (and (or (not (= |universe#0| null)) (not true)) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@81))) (and (and (or (not (= |mutex#0| null)) (not true)) (= |##a#0@0| (_module.OwnedObject.lifetime |mutex#0|))) (and ($IsAlloc refType |##a#0@0| Tclass._module.Lifetime $Heap@@81) ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@81)))) (and (and (and (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |##a#0@0|)) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |mutexScope#0|))) (and (|_module.Universe.outlives#canCall| $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|) (_module.Universe.outlives ($LS $LZ) $Heap@@81 |universe#0| (_module.OwnedObject.lifetime |mutex#0|) |mutexScope#0|))) (and (and (or (not (= |universe#0| null)) (not true)) ($IsAllocBox ($Box refType |universe#0|) Tclass._module.Universe? $Heap@@81)) (and ($IsAlloc refType |mutexScope#0| Tclass._module.Lifetime $Heap@@81) ($IsAlloc refType |scope#0| Tclass._module.Lifetime $Heap@@81))))) (and (and (and (and (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |mutexScope#0|)) (|Set#IsMember| ($Unbox SetType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |universe#0|) _module.Universe.content)) ($Box refType |scope#0|))) (|_module.Universe.outlives#canCall| $Heap@@81 |universe#0| |mutexScope#0| |scope#0|)) (and (and (_module.Universe.outlives ($LS $LZ) $Heap@@81 |universe#0| |mutexScope#0| |scope#0|) (or (not (= |scope#0| null)) (not true))) (and ($IsAllocBox ($Box refType |scope#0|) Tclass._module.Lifetime? $Heap@@81) (|_module.Lifetime.unused#canCall| $Heap@@81 |scope#0|)))) (and (and (and (_module.Lifetime.unused $Heap@@81 |scope#0|) (or (not (= |mutex#0| null)) (not true))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@81 |mutex#0|) _module.Mutex.locked)))) (or (not (= |universe#0| null)) (not true)))) (and (and ($Is refType |l#0@0| Tclass._module.Lifetime) ($IsAlloc refType |l#0@0| Tclass._module.Lifetime $Heap@@81)) (= (ControlFlow 0 2) (- 0 1)))))) (or (not (= |universe#0| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
