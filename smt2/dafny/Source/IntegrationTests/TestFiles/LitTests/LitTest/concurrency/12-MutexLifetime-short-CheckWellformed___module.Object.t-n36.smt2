...
(assert (distinct TBool TagBool alloc Tagclass._module.Object Tagclass._module.Thread Tagclass._module.OwnedObject Tagclass._module.Object? Tagclass._module.Lifetime Tagclass._module.Thread? Tagclass._module.Lifetime? |##_module.ObjectClassKind.Thread| Tagclass._module.ObjectClassKind |##_module.ObjectClassKind.OwnedObject| |##_module.ObjectClassKind.Lifetime| Tagclass._module.OwnedObject? tytagFamily$Object tytagFamily$Thread tytagFamily$OwnedObject tytagFamily$Lifetime tytagFamily$ObjectClassKind)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@5 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#103| |l#0| |l#1| |l#2| |l#3|) $o@@5 $f))  (=> (and (or (not (= $o@@5 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) (= $o@@5 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |3523|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#103| |l#0| |l#1| |l#2| |l#3|) $o@@5 $f))
)))
...
(let ((anon5_Else_correct  (=> ($IsAllocBox ($Box refType this@@15) Tclass._module.Object? $Heap@@2) (and (=> (= (ControlFlow 0 5) (- 0 7)) (forall (($o@@14 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@14) alloc)))) (= $o@@14 this@@15)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@0)))
 :qid |_12MutexLifetimeshortdfy.315:12|
 :skolemid |1377|
))) (=> (|_module.Object.nonAliasing#canCall| $Heap@@2 this@@15) (=> (and (and (and (|_module.Object.nonAliasing#canCall| $Heap@@2 this@@15) (_module.Object.nonAliasing $Heap@@2 this@@15)) (and ($IsAllocBox ($Box refType this@@15) Tclass._module.Object? $Heap@@2) (= |b$reqreads#0@0| (forall (($o@@15 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@15 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@15) alloc)))) (= $o@@15 this@@15)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@15 $f@@1)))
 :qid |_12MutexLifetimeshortdfy.316:5|
 :skolemid |1378|
))))) (and (and (|_module.Object.nonAliasing#canCall| $Heap@@2 this@@15) (= (_module.Object.triggerAxioms $Heap@@2 this@@15) (_module.Object.nonAliasing $Heap@@2 this@@15))) (and (|_module.Object.nonAliasing#canCall| $Heap@@2 this@@15) ($Is boolType (bool_2_U (_module.Object.triggerAxioms $Heap@@2 this@@15)) TBool)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 5) 4) GeneratedUnifiedExit_correct)))))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#103| null $Heap@@2 alloc this@@15)) (and (=> (= (ControlFlow 0 8) 2) anon5_Then_correct) (=> (= (ControlFlow 0 8) 5) anon5_Else_correct)))))
