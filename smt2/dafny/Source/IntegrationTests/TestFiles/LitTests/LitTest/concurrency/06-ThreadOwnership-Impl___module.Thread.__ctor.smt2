...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@20 T@U) ($f@@11 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#22| |l#0| |l#1| |l#2| |l#3|) $o@@20 $f@@11))  (=> (and (or (not (= $o@@20 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@20) |l#2|)))) (= $o@@20 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2089|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#22| |l#0| |l#1| |l#2| |l#3|) $o@@20 $f@@11))
)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($prevHeap@@17 T@U) ($Heap@@14 T@U) (this@@27 T@U) (|running#0@@1| T@U) ) (!  (=> (or (|_module.Universe.multipleLegalTransitions#canCall| $prevHeap@@17 $Heap@@14 this@@27 |running#0@@1|) (and (< 8 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@17) ($IsGoodHeap $Heap@@14)) ($HeapSucc $prevHeap@@17 $Heap@@14)) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Universe) ($IsAlloc refType this@@27 Tclass._module.Universe $prevHeap@@17)))) ($Is SetType |running#0@@1| (TSet Tclass._module.Thread))))) (and (and (|_module.Universe.globalInv#canCall| $prevHeap@@17 this@@27) (=> (_module.Universe.globalInv $prevHeap@@17 this@@27) (and (|_module.Universe.globalBaseInv#canCall| $Heap@@14 this@@27) (=> (_module.Universe.globalBaseInv $Heap@@14 this@@27) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Universe.content))) (=> (forall ((|o#0@@2| T@U) ) (!  (=> (and ($Is refType |o#0@@2| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#0@@2|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Universe.content)) ($Box refType |o#0@@2|)))) (not ($IsAllocBox ($Box refType |o#0@@2|) Tclass._module.Object $prevHeap@@17)))
 :qid |_06ThreadOwnershipdfy.36:16|
 :skolemid |549|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Universe.content)) ($Box refType |o#0@@2|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#0@@2|)))
)) (and (forall ((|o#1@@0| T@U) ) (!  (=> ($Is refType |o#1@@0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#1@@0|)) (=> (not (forall (($o@@25 T@U) ($f@@13 T@U) ) (!  (=> (or (not (= $o@@25 null)) (not true)) (=> (= $o@@25 |o#1@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 $o@@25) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 $o@@25) $f@@13))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |542|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 $o@@25) $f@@13))
))) (|_module.Object.inv#canCall| $Heap@@14 |o#1@@0|))))
 :qid |_06ThreadOwnershipdfy.38:16|
 :skolemid |543|
 :pattern ( (_module.Object.inv $Heap@@14 |o#1@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#1@@0|)))
)) (=> (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#1@@1|))) (or (forall (($o@@26 T@U) ($f@@14 T@U) ) (!  (=> (or (not (= $o@@26 null)) (not true)) (=> (= $o@@26 |o#1@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 $o@@26) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 $o@@26) $f@@14))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |547|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 $o@@26) $f@@14))
)) (_module.Object.inv $Heap@@14 |o#1@@1|)))
 :qid |_06ThreadOwnershipdfy.38:16|
 :skolemid |548|
 :pattern ( (_module.Object.inv $Heap@@14 |o#1@@1|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#1@@1|)))
)) (forall ((|o#2| T@U) ) (!  (=> ($Is refType |o#2| Tclass._module.Object) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Universe.content)) ($Box refType |o#2|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#2|)))) (|_module.Object.inv#canCall| $Heap@@14 |o#2|)))
 :qid |_06ThreadOwnershipdfy.40:16|
 :skolemid |544|
 :pattern ( (_module.Object.inv $Heap@@14 |o#2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#2|)))
...
)))))))))) (= (_module.Universe.multipleLegalTransitions $prevHeap@@17 $Heap@@14 this@@27 |running#0@@1|)  (and (and (and (and (and (and (and (_module.Universe.globalInv $prevHeap@@17 this@@27) (_module.Universe.globalBaseInv $Heap@@14 this@@27)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Universe.content)))) (forall ((|o#0@@3| T@U) ) (!  (=> (and ($Is refType |o#0@@3| Tclass._module.Object) (and (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#0@@3|))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Universe.content)) ($Box refType |o#0@@3|)))) (not ($IsAllocBox ($Box refType |o#0@@3|) Tclass._module.Object $prevHeap@@17)))
 :qid |_06ThreadOwnershipdfy.36:16|
 :skolemid |535|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Universe.content)) ($Box refType |o#0@@3|)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#0@@3|)))
))) (forall ((|o#1@@2| T@U) ) (!  (=> (and ($Is refType |o#1@@2| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#1@@2|))) (or (forall (($o@@27 T@U) ($f@@15 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (= $o@@27 |o#1@@2|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 $o@@27) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 $o@@27) $f@@15))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |536|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 $o@@27) $f@@15))
)) (_module.Object.inv $Heap@@14 |o#1@@2|)))
 :qid |_06ThreadOwnershipdfy.38:16|
 :skolemid |537|
 :pattern ( (_module.Object.inv $Heap@@14 |o#1@@2|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#1@@2|)))
))) (forall ((|o#2@@0| T@U) ) (!  (=> (and ($Is refType |o#2@@0| Tclass._module.Object) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 this@@27) _module.Universe.content)) ($Box refType |o#2@@0|)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#2@@0|))))) (_module.Object.inv $Heap@@14 |o#2@@0|))
 :qid |_06ThreadOwnershipdfy.40:16|
 :skolemid |538|
 :pattern ( (_module.Object.inv $Heap@@14 |o#2@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#2@@0|)))
...
))) (forall ((|t#0| T@U) ) (!  (=> (and ($Is refType |t#0| Tclass._module.Thread) (|Set#IsMember| |running#0@@1| ($Box refType |t#0|))) (and (= (_module.Object.universe |t#0|) this@@27) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |t#0|))))
 :qid |_06ThreadOwnershipdfy.42:16|
 :skolemid |539|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |t#0|)))
 :pattern ( (_module.Object.universe |t#0|))
 :pattern ( (|Set#IsMember| |running#0@@1| ($Box refType |t#0|)))
))) (forall ((|o#3| T@U) ) (!  (=> (and ($Is refType |o#3| Tclass._module.OwnedObject) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#3|)) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 |o#3|) _module.OwnedObject.owner)) Tclass._module.Thread))) (=> (not (|Set#IsMember| |running#0@@1| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 |o#3|) _module.OwnedObject.owner))) (forall (($o@@28 T@U) ($f@@16 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 |o#3|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@14 $o@@28) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 $o@@28) $f@@16))))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@17 this@@27) _module.Universe.content)) ($Box refType |o#3|)))
))))))
 :qid |_06ThreadOwnershipdfy.32:22|
 :skolemid |550|
 :pattern ( (_module.Universe.multipleLegalTransitions $prevHeap@@17 $Heap@@14 this@@27 |running#0@@1|) ($IsGoodHeap $Heap@@14))
))))
...
(assert (forall (($h@@14 T@U) ($o@@29 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@14) (and (or (not (= $o@@29 null)) (not true)) ($Is refType $o@@29 Tclass._module.OwnedObject?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@29) alloc)))) ($IsAlloc boolType ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@29) _module.OwnedObject.closed)) TBool $h@@14))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |871|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@14 $o@@29) _module.OwnedObject.closed)))
)))
...
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@33 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@33 null)) (not true)) ($Is refType this@@33 Tclass._module.Universe))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@30 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (or (= $o@@30 this@@33) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 this@@33) _module.Universe.content)) ($Box refType $o@@30)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@30) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@30) $f@@17)))
 :qid |unknown.0:0|
 :skolemid |492|
...
(assert (forall (($h0@@17 T@U) ($h1@@17 T@U) (this@@38 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@17) ($IsGoodHeap $h1@@17)) (and (or (not (= this@@38 null)) (not true)) (and ($Is refType this@@38 Tclass._module.Object) ($IsAlloc refType this@@38 Tclass._module.Object $h0@@17)))) (and ($IsHeapAnchor $h0@@17) ($HeapSucc $h0@@17 $h1@@17))) (=> (forall (($o@@36 T@U) ($f@@22 T@U) ) (!  (=> (and (or (not (= $o@@36 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@36) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@17 $o@@36) $f@@22) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@17 $o@@36) $f@@22)))
 :qid |unknown.0:0|
 :skolemid |798|
...
(assert (forall (($h0@@18 T@U) ($h1@@18 T@U) (this@@39 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@18) ($IsGoodHeap $h1@@18)) (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.OwnedObject) ($IsAlloc refType this@@39 Tclass._module.OwnedObject $h0@@18)))) (and ($IsHeapAnchor $h0@@18) ($HeapSucc $h0@@18 $h1@@18))) (=> (forall (($o@@37 T@U) ($f@@23 T@U) ) (!  (=> (and (or (not (= $o@@37 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@37) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@18 $o@@37) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@18 $o@@37) $f@@23)))
 :qid |unknown.0:0|
 :skolemid |872|
...
(assert (forall (($h0@@19 T@U) ($h1@@19 T@U) (this@@40 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@19) ($IsGoodHeap $h1@@19)) (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.OwnedObject) ($IsAlloc refType this@@40 Tclass._module.OwnedObject $h0@@19)))) (and ($IsHeapAnchor $h0@@19) ($HeapSucc $h0@@19 $h1@@19))) (=> (forall (($o@@38 T@U) ($f@@24 T@U) ) (!  (=> (and (or (not (= $o@@38 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@38) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@19 $o@@38) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@19 $o@@38) $f@@24)))
 :qid |unknown.0:0|
 :skolemid |882|
...
(assert (forall (($h0@@20 T@U) ($h1@@20 T@U) (this@@41 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@20) ($IsGoodHeap $h1@@20)) (and (or (not (= this@@41 null)) (not true)) (and ($Is refType this@@41 Tclass._module.OwnedObject) ($IsAlloc refType this@@41 Tclass._module.OwnedObject $h0@@20)))) (and ($IsHeapAnchor $h0@@20) ($HeapSucc $h0@@20 $h1@@20))) (=> (forall (($o@@39 T@U) ($f@@25 T@U) ) (!  (=> (and (or (not (= $o@@39 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@39) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@20 $o@@39) $f@@25) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@20 $o@@39) $f@@25)))
 :qid |unknown.0:0|
 :skolemid |938|
...
(assert (forall (($h0@@21 T@U) ($h1@@21 T@U) (this@@42 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@21) ($IsGoodHeap $h1@@21)) (and (or (not (= this@@42 null)) (not true)) (and ($Is refType this@@42 Tclass._module.OwnedObject) ($IsAlloc refType this@@42 Tclass._module.OwnedObject $h0@@21)))) (and ($IsHeapAnchor $h0@@21) ($HeapSucc $h0@@21 $h1@@21))) (=> (forall (($o@@40 T@U) ($f@@26 T@U) ) (!  (=> (and (or (not (= $o@@40 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@40) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@21 $o@@40) $f@@26) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@21 $o@@40) $f@@26)))
 :qid |unknown.0:0|
 :skolemid |942|
...
(assert (forall (($h0@@22 T@U) ($h1@@22 T@U) (this@@43 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@22) ($IsGoodHeap $h1@@22)) (and (or (not (= this@@43 null)) (not true)) (and ($Is refType this@@43 Tclass._module.OwnedObject) ($IsAlloc refType this@@43 Tclass._module.OwnedObject $h0@@22)))) (and ($IsHeapAnchor $h0@@22) ($HeapSucc $h0@@22 $h1@@22))) (=> (forall (($o@@41 T@U) ($f@@27 T@U) ) (!  (=> (and (or (not (= $o@@41 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@41) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@22 $o@@41) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@22 $o@@41) $f@@27)))
 :qid |unknown.0:0|
 :skolemid |950|
...
(assert (forall (($h0@@23 T@U) ($h1@@23 T@U) (this@@44 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@23) ($IsGoodHeap $h1@@23)) (and (or (not (= this@@44 null)) (not true)) (and ($Is refType this@@44 Tclass._module.Thread) ($IsAlloc refType this@@44 Tclass._module.Thread $h0@@23)))) (and ($IsHeapAnchor $h0@@23) ($HeapSucc $h0@@23 $h1@@23))) (=> (forall (($o@@42 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@42 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@42) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@23 $o@@42) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@23 $o@@42) $f@@28)))
 :qid |unknown.0:0|
 :skolemid |963|
...
(assert (forall (($h0@@24 T@U) ($h1@@24 T@U) (this@@45 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@24) ($IsGoodHeap $h1@@24)) (and (or (not (= this@@45 null)) (not true)) (and ($Is refType this@@45 Tclass._module.Thread) ($IsAlloc refType this@@45 Tclass._module.Thread $h0@@24)))) (and ($IsHeapAnchor $h0@@24) ($HeapSucc $h0@@24 $h1@@24))) (=> (forall (($o@@43 T@U) ($f@@29 T@U) ) (!  (=> (and (or (not (= $o@@43 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@43) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@24 $o@@43) $f@@29) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@24 $o@@43) $f@@29)))
 :qid |unknown.0:0|
 :skolemid |971|
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($prevHeap@@18 T@U) ($Heap@@20 T@U) (this@@46 T@U) (|running#0@@2| T@U) ) (!  (=> (or (|_module.Universe.legalTransition#canCall| $prevHeap@@18 $Heap@@20 this@@46 |running#0@@2|) (and (< 9 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@18) ($IsGoodHeap $Heap@@20)) ($HeapSucc $prevHeap@@18 $Heap@@20)) (and (or (not (= this@@46 null)) (not true)) (and ($Is refType this@@46 Tclass._module.Universe) ($IsAlloc refType this@@46 Tclass._module.Universe $prevHeap@@18)))) ($Is refType |running#0@@2| Tclass._module.Thread)))) (and (and (|_module.Universe.multipleLegalTransitions#canCall| $prevHeap@@18 $Heap@@20 this@@46 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (=> (_module.Universe.multipleLegalTransitions $prevHeap@@18 $Heap@@20 this@@46 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (forall ((|o#0@@4| T@U) ) (!  (=> ($Is refType |o#0@@4| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@46) _module.Universe.content)) ($Box refType |o#0@@4|)) (=> (not (forall (($o@@44 T@U) ($f@@30 T@U) ) (!  (=> (or (not (= $o@@44 null)) (not true)) (=> (= $o@@44 |o#0@@4|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 $o@@44) $f@@30) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 $o@@44) $f@@30))))
 :qid |_06ThreadOwnershipdfy.48:49|
 :skolemid |598|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 $o@@44) $f@@30))
))) (|_module.Object.inv2#canCall| $prevHeap@@18 $Heap@@20 |o#0@@4|))))
 :qid |_06ThreadOwnershipdfy.48:16|
 :skolemid |599|
 :pattern ( (_module.Object.inv2 $prevHeap@@18 $Heap@@20 |o#0@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@46) _module.Universe.content)) ($Box refType |o#0@@4|)))
)))) (= (_module.Universe.legalTransition $prevHeap@@18 $Heap@@20 this@@46 |running#0@@2|)  (and (_module.Universe.multipleLegalTransitions $prevHeap@@18 $Heap@@20 this@@46 (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@2|))) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@46) _module.Universe.content)) ($Box refType |o#0@@5|))) (or (forall (($o@@45 T@U) ($f@@31 T@U) ) (!  (=> (or (not (= $o@@45 null)) (not true)) (=> (= $o@@45 |o#0@@5|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 $o@@45) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 $o@@45) $f@@31))))
 :qid |_06ThreadOwnershipdfy.48:49|
 :skolemid |596|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@20 $o@@45) $f@@31))
)) (_module.Object.inv2 $prevHeap@@18 $Heap@@20 |o#0@@5|)))
 :qid |_06ThreadOwnershipdfy.48:16|
 :skolemid |597|
 :pattern ( (_module.Object.inv2 $prevHeap@@18 $Heap@@20 |o#0@@5|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@18 this@@46) _module.Universe.content)) ($Box refType |o#0@@5|)))
))))))
 :qid |_06ThreadOwnershipdfy.45:22|
 :skolemid |600|
 :pattern ( (_module.Universe.legalTransition $prevHeap@@18 $Heap@@20 this@@46 |running#0@@2|) ($IsGoodHeap $Heap@@20))
))))
...
(assert (forall (($o@@48 T@U) ) (!  (=> ($Is refType $o@@48 Tclass._module.Thread?) ($Is refType $o@@48 Tclass._module.NonOwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2070|
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($prevHeap@@19 T@U) ($Heap@@21 T@U) (this@@47 T@U) ) (!  (=> (or (|_module.Universe.globalInv2#canCall| $prevHeap@@19 $Heap@@21 this@@47) (and (< 8 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@19) ($IsGoodHeap $Heap@@21)) ($HeapSucc $prevHeap@@19 $Heap@@21)) (and (or (not (= this@@47 null)) (not true)) (and ($Is refType this@@47 Tclass._module.Universe) ($IsAlloc refType this@@47 Tclass._module.Universe $prevHeap@@19)))))) (and (forall ((|o#0@@6| T@U) ) (!  (=> ($Is refType |o#0@@6| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@47) _module.Universe.content)) ($Box refType |o#0@@6|)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@47) _module.Universe.content)) ($Box refType |o#0@@6|)) (|_module.Object.inv2#canCall| $prevHeap@@19 $Heap@@21 |o#0@@6|))))
 :qid |_06ThreadOwnershipdfy.28:12|
 :skolemid |525|
 :pattern ( (_module.Object.inv2 $prevHeap@@19 $Heap@@21 |o#0@@6|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@47) _module.Universe.content)) ($Box refType |o#0@@6|)))
)) (= (_module.Universe.globalInv2 $prevHeap@@19 $Heap@@21 this@@47) (forall ((|o#0@@7| T@U) ) (!  (=> (and ($Is refType |o#0@@7| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@47) _module.Universe.content)) ($Box refType |o#0@@7|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@47) _module.Universe.content)) ($Box refType |o#0@@7|)) (_module.Object.inv2 $prevHeap@@19 $Heap@@21 |o#0@@7|)))
 :qid |_06ThreadOwnershipdfy.28:12|
 :skolemid |524|
 :pattern ( (_module.Object.inv2 $prevHeap@@19 $Heap@@21 |o#0@@7|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@19 this@@47) _module.Universe.content)) ($Box refType |o#0@@7|)))
)))))
 :qid |_06ThreadOwnershipdfy.27:22|
 :skolemid |526|
 :pattern ( (_module.Universe.globalInv2 $prevHeap@@19 $Heap@@21 this@@47) ($IsGoodHeap $Heap@@21))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@20 T@U) ($Heap@@22 T@U) (this@@48 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@20 $Heap@@22 this@@48) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@20) ($IsGoodHeap $Heap@@22)) ($HeapSucc $prevHeap@@20 $Heap@@22)) (and (or (not (= this@@48 null)) (not true)) (and ($Is refType this@@48 Tclass._module.Thread) ($IsAlloc refType this@@48 Tclass._module.Thread $prevHeap@@20)))))) (=> (_module.Thread.inv2 $prevHeap@@20 $Heap@@22 this@@48) (_module.Thread.localInv2 $prevHeap@@20 $Heap@@22 this@@48)))
 :qid |_06ThreadOwnershipdfy.217:22|
 :skolemid |996|
 :pattern ( (_module.Thread.inv2 $prevHeap@@20 $Heap@@22 this@@48))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($prevHeap@@21 T@U) ($Heap@@23 T@U) (this@@49 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv2#canCall| $prevHeap@@21 $Heap@@23 this@@49) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@21) ($IsGoodHeap $Heap@@23)) ($HeapSucc $prevHeap@@21 $Heap@@23)) (and (or (not (= this@@49 null)) (not true)) (and ($Is refType this@@49 Tclass._module.OwnedObject) ($IsAlloc refType this@@49 Tclass._module.OwnedObject $prevHeap@@21)))))) (=> (_module.OwnedObject.userInv2 $prevHeap@@21 $Heap@@23 this@@49) (_module.OwnedObject.localUserInv2 $prevHeap@@21 $Heap@@23 this@@49)))
 :qid |_06ThreadOwnershipdfy.190:22|
 :skolemid |956|
 :pattern ( (_module.OwnedObject.userInv2 $prevHeap@@21 $Heap@@23 this@@49))
))))
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($prevHeap@@22 T@U) ($Heap@@24 T@U) (this@@50 T@U) ) (!  (=> (or (|_module.OwnedObject.inv2#canCall| $prevHeap@@22 $Heap@@24 this@@50) (and (< 6 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@22) ($IsGoodHeap $Heap@@24)) ($HeapSucc $prevHeap@@22 $Heap@@24)) (and (or (not (= this@@50 null)) (not true)) (and ($Is refType this@@50 Tclass._module.OwnedObject) ($IsAlloc refType this@@50 Tclass._module.OwnedObject $prevHeap@@22)))))) (=> (_module.OwnedObject.inv2 $prevHeap@@22 $Heap@@24 this@@50) (_module.OwnedObject.localInv2 $prevHeap@@22 $Heap@@24 this@@50)))
 :qid |_06ThreadOwnershipdfy.145:22|
 :skolemid |909|
 :pattern ( (_module.OwnedObject.inv2 $prevHeap@@22 $Heap@@24 this@@50))
))))
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($prevHeap@@23 T@U) ($Heap@@25 T@U) (this@@51 T@U) ) (!  (=> (or (|_module.Object.inv2#canCall| $prevHeap@@23 $Heap@@25 this@@51) (and (< 7 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@23) ($IsGoodHeap $Heap@@25)) ($HeapSucc $prevHeap@@23 $Heap@@25)) (and (or (not (= this@@51 null)) (not true)) (and ($Is refType this@@51 Tclass._module.Object) ($IsAlloc refType this@@51 Tclass._module.Object $prevHeap@@23)))))) (=> (_module.Object.inv2 $prevHeap@@23 $Heap@@25 this@@51) (_module.Object.localInv2 $prevHeap@@23 $Heap@@25 this@@51)))
 :qid |_06ThreadOwnershipdfy.115:22|
 :skolemid |804|
 :pattern ( (_module.Object.inv2 $prevHeap@@23 $Heap@@25 this@@51))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($prevHeap@@24 T@U) ($Heap@@28 T@U) (this@@54 T@U) ) (!  (=> (or (|_module.OwnedObject.inv2#canCall| $prevHeap@@24 $Heap@@28 this@@54) (and (< 6 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@24) ($IsGoodHeap $Heap@@28)) ($HeapSucc $prevHeap@@24 $Heap@@28)) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.OwnedObject) ($IsAlloc refType this@@54 Tclass._module.OwnedObject $prevHeap@@24)))))) (and (let ((|currOwner#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))))
 (and (|_module.OwnedObject.localInv2#canCall| $prevHeap@@24 $Heap@@28 this@@54) (=> (_module.OwnedObject.localInv2 $prevHeap@@24 $Heap@@28 this@@54) (and (|_module.OwnedObject.userInv2#canCall| $prevHeap@@24 $Heap@@28 this@@54) (=> (_module.OwnedObject.userInv2 $prevHeap@@24 $Heap@@28 this@@54) (and (=> (or (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))))) (and (|_module.OwnedObject.userFieldsUnchanged#canCall| $prevHeap@@24 $Heap@@28 this@@54) (=> (not (_module.OwnedObject.userFieldsUnchanged $prevHeap@@24 $Heap@@28 this@@54)) (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> ($IsAllocBox ($Box refType |currOwner#0|) Tclass._module.Object $prevHeap@@24) (|_module.Object.localInv2#canCall| $prevHeap@@24 $Heap@@28 |currOwner#0|)))))) (=> (=> (or (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))))) (or (_module.OwnedObject.userFieldsUnchanged $prevHeap@@24 $Heap@@28 this@@54) (and true (=> ($IsAllocBox ($Box refType |currOwner#0|) Tclass._module.Object $prevHeap@@24) (_module.Object.localInv2 $prevHeap@@24 $Heap@@28 |currOwner#0|))))) (and (=> (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))  (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))))) (=> (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))) (|_module.Object.localInv2#canCall| $prevHeap@@24 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))))) (=> (=> (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))  (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))) (_module.Object.localInv2 $prevHeap@@24 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))))) (and (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))) (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.userFieldsOwnedBy#canCall| $Heap@@28 this@@54 this@@54)))) (=> (=> (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed)))) (and true (_module.OwnedObject.userFieldsOwnedBy $Heap@@28 this@@54 this@@54))) (and (=> (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed))) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (|_module.OwnedObject.userFieldsOwnedBy#canCall| $prevHeap@@24 this@@54 this@@54)))) (=> (=> (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))))) (and true (_module.OwnedObject.userFieldsOwnedBy $prevHeap@@24 this@@54 this@@54))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner)))) (not true)) (and (|_module.Object.localInv2#canCall| $prevHeap@@24 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner))) (=> (_module.Object.localInv2 $prevHeap@@24 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner))) (and (|_module.Object.localInv#canCall| $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner))) (=> (_module.Object.localInv $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner))) (and (=> ($IsAllocBox ($Box refType |currOwner#0|) Tclass._module.Object $prevHeap@@24) (|_module.Object.localInv2#canCall| $prevHeap@@24 $Heap@@28 |currOwner#0|)) (=> (=> ($IsAllocBox ($Box refType |currOwner#0|) Tclass._module.Object $prevHeap@@24) (_module.Object.localInv2 $prevHeap@@24 $Heap@@28 |currOwner#0|)) (|_module.Object.localInv#canCall| $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))))))))))))))))))))))) (= (_module.OwnedObject.inv2 $prevHeap@@24 $Heap@@28 this@@54) (let ((|currOwner#0@@0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))))
 (and (and (and (and (and (and (_module.OwnedObject.localInv2 $prevHeap@@24 $Heap@@28 this@@54) (_module.OwnedObject.userInv2 $prevHeap@@24 $Heap@@28 this@@54)) (=> (or (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))))) (or (_module.OwnedObject.userFieldsUnchanged $prevHeap@@24 $Heap@@28 this@@54) (and true (=> ($IsAllocBox ($Box refType |currOwner#0@@0|) Tclass._module.Object $prevHeap@@24) (_module.Object.localInv2 $prevHeap@@24 $Heap@@28 |currOwner#0@@0|)))))) (=> (= (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))  (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))))) (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))) (_module.Object.localInv2 $prevHeap@@24 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner)))))) (=> (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed)))) (and true (_module.OwnedObject.userFieldsOwnedBy $Heap@@28 this@@54 this@@54)))) (=> (and (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.closed))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.closed))))) (and true (_module.OwnedObject.userFieldsOwnedBy $prevHeap@@24 this@@54 this@@54)))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner)))) (not true)) (and (and (and (_module.Object.localInv2 $prevHeap@@24 $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner))) (_module.Object.localInv $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@24 this@@54) _module.OwnedObject.owner)))) (=> ($IsAllocBox ($Box refType |currOwner#0@@0|) Tclass._module.Object $prevHeap@@24) (_module.Object.localInv2 $prevHeap@@24 $Heap@@28 |currOwner#0@@0|))) (_module.Object.localInv $Heap@@28 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@28 this@@54) _module.OwnedObject.owner))))))))))
 :qid |_06ThreadOwnershipdfy.145:22|
 :skolemid |911|
 :pattern ( (_module.OwnedObject.inv2 $prevHeap@@24 $Heap@@28 this@@54) ($IsGoodHeap $Heap@@28))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@25 T@U) ($Heap@@29 T@U) (this@@55 T@U) ) (!  (=> (or (|_module.Thread.inv2#canCall| $prevHeap@@25 $Heap@@29 this@@55) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@25) ($IsGoodHeap $Heap@@29)) ($HeapSucc $prevHeap@@25 $Heap@@29)) (and (or (not (= this@@55 null)) (not true)) (and ($Is refType this@@55 Tclass._module.Thread) ($IsAlloc refType this@@55 Tclass._module.Thread $prevHeap@@25)))))) (and (|_module.Thread.localInv2#canCall| $prevHeap@@25 $Heap@@29 this@@55) (= (_module.Thread.inv2 $prevHeap@@25 $Heap@@29 this@@55) (_module.Thread.localInv2 $prevHeap@@25 $Heap@@29 this@@55))))
 :qid |_06ThreadOwnershipdfy.217:22|
 :skolemid |998|
 :pattern ( (_module.Thread.inv2 $prevHeap@@25 $Heap@@29 this@@55) ($IsGoodHeap $Heap@@29))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#22| null $Heap@@30 alloc |universe#0|)) (and (=> (= (ControlFlow 0 2) (- 0 31)) true) (=> (and (and (or (not (= this@@56 null)) (not true)) ($Is refType this@@56 Tclass._module.Thread?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@56) alloc))))) (=> (and (and (and (= (_module.Object.universe this@@56) |universe#0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@30 this@@56 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 this@@56) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (not ($Is refType this@@56 Tclass._module.OwnedObject)) (= $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (forall (($o@@56 T@U) ($f@@32 T@U) ) (!  (=> (and (and (or (not (= $o@@56 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@56) alloc)))) (= $o@@56 (_module.Object.universe this@@56))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@56 $f@@32)))
 :qid |_06ThreadOwnershipdfy.233:9|
 :skolemid |1196|
))) (=> (forall (($o@@57 T@U) ($f@@33 T@U) ) (!  (=> (and (and (or (not (= $o@@57 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@57) alloc)))) (= $o@@57 (_module.Object.universe this@@56))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@57 $f@@33)))
 :qid |_06ThreadOwnershipdfy.233:9|
 :skolemid |1196|
)) (and (=> (= (ControlFlow 0 2) (- 0 29)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@1 (_module.Object.universe this@@56)) (forall ((|o#1@@3| T@U) ) (!  (=> (and ($Is refType |o#1@@3| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#1@@3|))) (and (= (_module.Object.universe |o#1@@3|) (_module.Object.universe this@@56)) (or (not (= |o#1@@3| (_module.Object.universe this@@56))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |742|
 :pattern ( (_module.Object.universe |o#1@@3|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#1@@3|)))
))))) (=> (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@1 (_module.Object.universe this@@56)) (forall ((|o#1@@4| T@U) ) (!  (=> (and ($Is refType |o#1@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#1@@4|))) (and (= (_module.Object.universe |o#1@@4|) (_module.Object.universe this@@56)) (or (not (= |o#1@@4| (_module.Object.universe this@@56))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |742|
 :pattern ( (_module.Object.universe |o#1@@4|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#1@@4|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 28)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@1 (_module.Object.universe this@@56)) (forall ((|o#2@@1| T@U) ) (!  (=> (and ($Is refType |o#2@@1| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#2@@1|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@1|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@1|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@1|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |743|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@1|) _module.OwnedObject.closed)))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#2@@1|)))
))))) (=> (=> (|_module.Universe.globalBaseInv#canCall| $Heap@1 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@1 (_module.Object.universe this@@56)) (forall ((|o#2@@2| T@U) ) (!  (=> (and ($Is refType |o#2@@2| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#2@@2|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@2|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@2|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@2|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |743|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@2|) _module.OwnedObject.closed)))
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#2@@2|) _module.OwnedObject.owner)))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#2@@2|)))
)))) (and (=> (= (ControlFlow 0 2) (- 0 27)) (or (not (= this@@56 (_module.Object.universe this@@56))) (not true))) (=> (or (not (= this@@56 (_module.Object.universe this@@56))) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 26)) (=> ($Is refType this@@56 Tclass._module.OwnedObject) (let ((|o#0@@8| this@@56))
(|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@8|) _module.OwnedObject.owner))))) (=> (=> ($Is refType this@@56 Tclass._module.OwnedObject) (let ((|o#0@@9| this@@56))
(|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@9|) _module.OwnedObject.owner)))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> ($Is refType this@@56 Tclass._module.OwnedObject) (let ((|o#0@@10| this@@56))
 (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@10|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@10|) _module.OwnedObject.owner)) Tclass._module.Thread))))) (=> (=> ($Is refType this@@56 Tclass._module.OwnedObject) (let ((|o#0@@11| this@@56))
 (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@11|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@11|) _module.OwnedObject.owner)) Tclass._module.Thread)))) (=> (and (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (|_module.Object.baseInv#canCall| $Heap@2 this@@56)) (and (|_module.Object.baseInv#canCall| $Heap@2 this@@56) (and (_module.Object.baseInv $Heap@2 this@@56) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType this@@56)) (_module.Universe.globalBaseInv $Heap@2 (_module.Object.universe this@@56)))))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@56)) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 (_module.Object.universe this@@56)) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@56)))) (forall (($o@@58 T@U) ($f@@34 T@U) ) (!  (=> (or (not (= $o@@58 null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType $o@@58)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@58) $f@@34) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@58) $f@@34))))
 :qid |_06ThreadOwnershipdfy.91:13|
 :skolemid |750|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@58) $f@@34))
))) (and (forall (($o@@59 T@U) ) (!  (=> (and (or (not (= $o@@59 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@59) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@59) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@59)) (= $o@@59 (_module.Object.universe this@@56))))
 :qid |_06ThreadOwnershipdfy.83:16|
 :skolemid |751|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@59))
)) ($HeapSuccGhost $Heap@1 $Heap@2)))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (or (not (= |universe#0| null)) (not true))) (=> (or (not (= |universe#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 23)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@30)) (=> ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@30) (and (=> (= (ControlFlow 0 2) (- 0 22)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@30)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@30) (=> (= call0formal@previous$Heap@0 $Heap@@30) (and (=> (= (ControlFlow 0 2) (- 0 21)) ($IsAlloc refType |running#0@@3| Tclass._module.Thread call0formal@previous$Heap@0)) (=> ($IsAlloc refType |running#0@@3| Tclass._module.Thread call0formal@previous$Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 20)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.multipleLegalTransitions#canCall| call0formal@previous$Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.multipleLegalTransitions call0formal@previous$Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (=> (|_module.Universe.globalInv#canCall| call0formal@previous$Heap@0 |universe#0|) (or (_module.Universe.globalInv call0formal@previous$Heap@0 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| call0formal@previous$Heap@0 |universe#0|) (or (_module.Universe.globalBaseInv call0formal@previous$Heap@0 |universe#0|) (forall ((|o#0@@12| T@U) ) (!  (=> (and ($Is refType |o#0@@12| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#0@@12|))) (and (= (_module.Object.universe |o#0@@12|) |universe#0|) (or (not (= |o#0@@12| |universe#0|)) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |611|
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.multipleLegalTransitions#canCall| call0formal@previous$Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.multipleLegalTransitions call0formal@previous$Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#6|))) (or (forall (($o@@60 T@U) ($f@@35 T@U) ) (!  (=> (or (not (= $o@@60 null)) (not true)) (=> (= $o@@60 |o#6|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@60) $f@@35) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@60) $f@@35))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |622|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@60) $f@@35))
...
))))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (=> (|_module.Universe.multipleLegalTransitions#canCall| call0formal@previous$Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (or (_module.Universe.multipleLegalTransitions call0formal@previous$Heap@0 $Heap@2 |universe#0| (|Set#UnionOne| |Set#Empty| ($Box refType |running#0@@3|))) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#6@@0|))) (or (forall (($o@@61 T@U) ($f@@36 T@U) ) (!  (=> (or (not (= $o@@61 null)) (not true)) (=> (= $o@@61 |o#6@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@61) $f@@36) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@61) $f@@36))))
 :qid |_06ThreadOwnershipdfy.38:49|
 :skolemid |622|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@61) $f@@36))
...
)))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (forall ((|o#9| T@U) ) (!  (=> (and ($Is refType |o#9| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#9|))) (or (forall (($o@@64 T@U) ($f@@39 T@U) ) (!  (=> (or (not (= $o@@64 null)) (not true)) (=> (= $o@@64 |o#9|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@64) $f@@39) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@64) $f@@39))))
 :qid |_06ThreadOwnershipdfy.48:49|
 :skolemid |635|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@64) $f@@39))
...
))))) (=> (=> (|_module.Universe.legalTransition#canCall| call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (or (_module.Universe.legalTransition call0formal@previous$Heap@0 $Heap@2 |universe#0| |running#0@@3|) (forall ((|o#9@@0| T@U) ) (!  (=> (and ($Is refType |o#9@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |universe#0|) _module.Universe.content)) ($Box refType |o#9@@0|))) (or (forall (($o@@65 T@U) ($f@@40 T@U) ) (!  (=> (or (not (= $o@@65 null)) (not true)) (=> (= $o@@65 |o#9@@0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@65) $f@@40) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@65) $f@@40))))
 :qid |_06ThreadOwnershipdfy.48:49|
 :skolemid |635|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@65) $f@@40))
...
)))) (= $Heap@2 $Heap@3))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Object.baseInv#canCall| $Heap@3 this@@56) (or (_module.Object.baseInv $Heap@3 this@@56) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType this@@56))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Object.baseInv#canCall| $Heap@3 this@@56) (or (_module.Object.baseInv $Heap@3 this@@56) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType this@@56)))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Object.baseInv#canCall| $Heap@3 this@@56) (or (_module.Object.baseInv $Heap@3 this@@56) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#16| T@U) ) (!  (=> (and ($Is refType |o#16| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#16|))) (and (= (_module.Object.universe |o#16|) (_module.Object.universe this@@56)) (or (not (= |o#16| (_module.Object.universe this@@56))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1182|
 :pattern ( (_module.Object.universe |o#16|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#16|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Object.baseInv#canCall| $Heap@3 this@@56) (or (_module.Object.baseInv $Heap@3 this@@56) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#16@@0| T@U) ) (!  (=> (and ($Is refType |o#16@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#16@@0|))) (and (= (_module.Object.universe |o#16@@0|) (_module.Object.universe this@@56)) (or (not (= |o#16@@0| (_module.Object.universe this@@56))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1182|
 :pattern ( (_module.Object.universe |o#16@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#16@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Object.baseInv#canCall| $Heap@3 this@@56) (or (_module.Object.baseInv $Heap@3 this@@56) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#17| T@U) ) (!  (=> (and ($Is refType |o#17| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#17|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#17|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#17|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#17|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1183|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#17|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Object.baseInv#canCall| $Heap@3 this@@56) (or (_module.Object.baseInv $Heap@3 this@@56) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#17@@0| T@U) ) (!  (=> (and ($Is refType |o#17@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#17@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#17@@0|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#17@@0|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#17@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1183|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#17@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Universe.globalInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalInv $Heap@3 (_module.Object.universe this@@56)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#18| T@U) ) (!  (=> (and ($Is refType |o#18| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#18|))) (and (= (_module.Object.universe |o#18|) (_module.Object.universe this@@56)) (or (not (= |o#18| (_module.Object.universe this@@56))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1186|
 :pattern ( (_module.Object.universe |o#18|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#18|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Universe.globalInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalInv $Heap@3 (_module.Object.universe this@@56)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#18@@0| T@U) ) (!  (=> (and ($Is refType |o#18@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#18@@0|))) (and (= (_module.Object.universe |o#18@@0|) (_module.Object.universe this@@56)) (or (not (= |o#18@@0| (_module.Object.universe this@@56))) (not true))))
 :qid |_06ThreadOwnershipdfy.16:16|
 :skolemid |1186|
 :pattern ( (_module.Object.universe |o#18@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#18@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Universe.globalInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalInv $Heap@3 (_module.Object.universe this@@56)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#19| T@U) ) (!  (=> (and ($Is refType |o#19| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#19|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#19|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#19|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#19|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1187|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#19|)))
))))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Universe.globalInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalInv $Heap@3 (_module.Object.universe this@@56)) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalBaseInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#19@@0| T@U) ) (!  (=> (and ($Is refType |o#19@@0| Tclass._module.OwnedObject) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#19@@0|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#19@@0|) _module.OwnedObject.owner)) (=> (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#19@@0|) _module.OwnedObject.closed)))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |o#19@@0|) _module.OwnedObject.owner)) Tclass._module.Thread))))
 :qid |_06ThreadOwnershipdfy.17:16|
 :skolemid |1187|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#19@@0|)))
)))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Universe.globalInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#20| T@U) ) (!  (=> (and ($Is refType |o#20| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#20|))) (_module.Object.inv $Heap@3 |o#20|))
 :qid |_06ThreadOwnershipdfy.23:16|
 :skolemid |1190|
 :pattern ( (_module.Object.inv $Heap@3 |o#20|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#20|)))
))))))) (=> (=> (|_module.Object.objectGlobalInv#canCall| $Heap@3 this@@56) (or (_module.Object.objectGlobalInv $Heap@3 this@@56) (=> (|_module.Universe.globalInv#canCall| $Heap@3 (_module.Object.universe this@@56)) (or (_module.Universe.globalInv $Heap@3 (_module.Object.universe this@@56)) (forall ((|o#20@@0| T@U) ) (!  (=> (and ($Is refType |o#20@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#20@@0|))) (_module.Object.inv $Heap@3 |o#20@@0|))
 :qid |_06ThreadOwnershipdfy.23:16|
 :skolemid |1190|
 :pattern ( (_module.Object.inv $Heap@3 |o#20@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 (_module.Object.universe this@@56)) _module.Universe.content)) ($Box refType |o#20@@0|)))
)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Universe.globalInv2#canCall| $Heap@@30 $Heap@3 |universe#0|) (or (_module.Universe.globalInv2 $Heap@@30 $Heap@3 |universe#0|) (forall ((|o#21| T@U) ) (!  (=> (and ($Is refType |o#21| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |universe#0|) _module.Universe.content)) ($Box refType |o#21|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |universe#0|) _module.Universe.content)) ($Box refType |o#21|)) (_module.Object.inv2 $Heap@@30 $Heap@3 |o#21|)))
 :qid |_06ThreadOwnershipdfy.28:12|
 :skolemid |1192|
 :pattern ( (_module.Object.inv2 $Heap@@30 $Heap@3 |o#21|))
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |universe#0|) _module.Universe.content)) ($Box refType |o#21|)))
)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@30) ($IsHeapAnchor $Heap@@30)) (and ($Is refType |universe#0| Tclass._module.Universe) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@@30))) (and (and ($Is refType |running#0@@3| Tclass._module.Thread) ($IsAlloc refType |running#0@@3| Tclass._module.Thread $Heap@@30)) (= 14 $FunctionContextHeight))) (and (and (and (|_module.Universe.globalInv#canCall| $Heap@@30 |universe#0|) (and (_module.Universe.globalInv $Heap@@30 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@@30 |universe#0|) (forall ((|o#13@@0| T@U) ) (!  (=> (and ($Is refType |o#13@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@0|))) (_module.Object.inv $Heap@@30 |o#13@@0|))
 :qid |_06ThreadOwnershipdfy.23:16|
 :skolemid |1177|
 :pattern ( (_module.Object.inv $Heap@@30 |o#13@@0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@30 |universe#0|) _module.Universe.content)) ($Box refType |o#13@@0|)))
))))) (= (_module.Object.universe |running#0@@3|) |universe#0|)) (and (and (|_module.Thread.inv#canCall| $Heap@@30 |running#0@@3|) (and (_module.Thread.inv $Heap@@30 |running#0@@3|) (and true (_module.Thread.localInv $Heap@@30 |running#0@@3|)))) (= (ControlFlow 0 32) 2)))) anon0_correct)))
