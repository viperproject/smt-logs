...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split268)
...
)))))))) (and (and (and (and ($IsGoodHeap $Heap@32) ($IsHeapAnchor $Heap@32)) (and (|_module.Universe.globalInv#canCall| $Heap@31 |universe#0|) (=> (_module.Universe.globalInv $Heap@31 |universe#0|) (|_module.Universe.globalInv2#canCall| $Heap@30 $Heap@31 |universe#0|)))) (and (and (|_module.Universe.globalInv#canCall| $Heap@31 |universe#0|) (and (_module.Universe.globalInv $Heap@31 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@31 |universe#0|) (forall ((|o#17@@8| T@U) ) (!  (=> (and ($Is refType |o#17@@8| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@31 |universe#0|) _module.Universe.content)) ($Box refType |o#17@@8|))) (_module.Object.inv $Heap@31 |o#17@@8|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |812|
...
))))))) (and (and (and (= $Heap@31 $Heap@32) (or (not (= |universe#0| null)) (not true))) (and (forall (($o@@177 T@U) ($f@@119 T@U) ) (!  (=> (and (and (or (not (= $o@@177 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 $o@@177) alloc)))) (or (= $o@@177 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@32 |universe#0|) _module.Universe.content)) ($Box refType $o@@177)))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@177 $f@@119)))
