...
)) ($HeapSucc $Heap@32 $Heap@33)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 2) (- 0 1))))))))))) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@33 |remaining#0|) _module.OwnedObject.owner)) |running#0@@3|))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
