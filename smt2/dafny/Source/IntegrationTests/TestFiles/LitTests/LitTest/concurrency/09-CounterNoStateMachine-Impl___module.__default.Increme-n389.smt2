...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split378)
...
)) (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|)))))) (and (and (and (and (and |$w$loop#0@0| (<= 10 |i#0@1|)) (and (or (not (= |universe#0| null)) (not true)) (forall (($o@@123 T@U) ($f@@74 T@U) ) (!  (=> (and (and (or (not (= $o@@123 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@123) alloc)))) (or (= $o@@123 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |universe#0|) _module.Universe.content)) ($Box refType $o@@123)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@123 $f@@74)))
...
))) (and (= $Heap@5 $Heap@6) (= (ControlFlow 0 2) (- 0 1)))))))))) (or (not (= |universe#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
