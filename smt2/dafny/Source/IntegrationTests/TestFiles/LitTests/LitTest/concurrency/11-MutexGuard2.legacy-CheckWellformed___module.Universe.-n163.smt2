...
(assert  (=> (<= 13 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Universe.globalInv#canCall| $Heap@@1 this@@1) (and (< 13 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Universe) ($IsAlloc refType this@@1 Tclass._module.Universe $Heap@@1)))))) (and (and (|_module.Universe.globalBaseInv#canCall| $Heap@@1 this@@1) (=> (_module.Universe.globalBaseInv $Heap@@1 this@@1) (forall ((|o#0@@1| T@U) ) (!  (=> ($Is refType |o#0@@1| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Universe.content)) ($Box refType |o#0@@1|)) (|_module.Object.inv#canCall| $Heap@@1 |o#0@@1|)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@4 this@@4) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.Thread)))) (= (_module.Object.localInv $Heap@@4 this@@4) (_module.Thread.localInv $Heap@@4 this@@4)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@5 this@@5) (and (< 8 $FunctionContextHeight) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.OwnedObject)))) (= (_module.Object.localInv $Heap@@5 this@@5) (_module.OwnedObject.localInv $Heap@@5 this@@5)))
 :qid |_11MutexGuard2legacydfy.247:19|
 :skolemid |1531|
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@6 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@6 this@@6) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Thread)))) (= (_module.Object.inv $Heap@@6 this@@6) (_module.Thread.inv $Heap@@6 this@@6)))
...
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@7 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@7 this@@7) (and (< 11 $FunctionContextHeight) (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@7 this@@7) (_module.OwnedObject.inv $Heap@@7 this@@7)))
 :qid |_11MutexGuard2legacydfy.249:19|
 :skolemid |1544|
 :pattern ( (_module.Object.inv $Heap@@7 this@@7) ($Is refType this@@7 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@7))
 :pattern ( (_module.Object.inv $Heap@@7 this@@7) (_module.OwnedObject.inv $Heap@@7 this@@7) ($IsGoodHeap $Heap@@7))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@8 this@@8) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@8) (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.Object) ($IsAlloc refType this@@8 Tclass._module.Object $Heap@@8)))))) (and (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 (_module.Object.universe this@@8)) _module.Universe.content)) ($Box refType this@@8)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@8 this@@8) (=> (_module.Object.baseFieldsInv $Heap@@8 this@@8) (|_module.Universe.globalBaseInv#canCall| $Heap@@8 (_module.Object.universe this@@8))))) (= (_module.Object.objectGlobalBaseInv $Heap@@8 this@@8)  (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 (_module.Object.universe this@@8)) _module.Universe.content)) ($Box refType this@@8)) (_module.Object.baseFieldsInv $Heap@@8 this@@8)) (_module.Universe.globalBaseInv $Heap@@8 (_module.Object.universe this@@8))))))
 :qid |_11MutexGuard2legacydfy.202:19|
 :skolemid |1071|
 :pattern ( (_module.Object.objectGlobalBaseInv $Heap@@8 this@@8) ($IsGoodHeap $Heap@@8))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@10 this@@10) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.OwnedObject) ($IsAlloc refType this@@10 Tclass._module.OwnedObject $Heap@@10)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@10 this@@10) (=> (_module.Object.objectGlobalBaseInv $Heap@@10 this@@10) (|_module.OwnedObject.localUserInv#canCall| $Heap@@10 this@@10))) (= (_module.OwnedObject.localInv $Heap@@10 this@@10)  (and (_module.Object.objectGlobalBaseInv $Heap@@10 this@@10) (_module.OwnedObject.localUserInv $Heap@@10 this@@10)))))
 :qid |_11MutexGuard2legacydfy.336:19|
 :skolemid |1530|
 :pattern ( (_module.OwnedObject.localInv $Heap@@10 this@@10) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@11 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@11 this@@11) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.OwnedObject) ($IsAlloc refType this@@11 Tclass._module.OwnedObject $Heap@@11)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@11 this@@11) (=> (_module.OwnedObject.localInv $Heap@@11 this@@11) (|_module.OwnedObject.userInv#canCall| $Heap@@11 this@@11))) (= (_module.OwnedObject.inv $Heap@@11 this@@11)  (and (_module.OwnedObject.localInv $Heap@@11 this@@11) (_module.OwnedObject.userInv $Heap@@11 this@@11)))))
...
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@17 this@@17) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.OwnedObject) ($IsAlloc refType this@@17 Tclass._module.OwnedObject $Heap@@17)))))) (=> (_module.OwnedObject.userInv $Heap@@17 this@@17) (_module.OwnedObject.localUserInv $Heap@@17 this@@17)))
 :qid |_11MutexGuard2legacydfy.409:19|
 :skolemid |1622|
 :pattern ( (_module.OwnedObject.userInv $Heap@@17 this@@17))
))))
(assert  (=> (<= 11 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@18 this@@18) (and (< 11 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.OwnedObject) ($IsAlloc refType this@@18 Tclass._module.OwnedObject $Heap@@18)))))) (=> (_module.OwnedObject.inv $Heap@@18 this@@18) (_module.OwnedObject.localInv $Heap@@18 this@@18)))
 :qid |_11MutexGuard2legacydfy.340:19|
 :skolemid |1541|
 :pattern ( (_module.OwnedObject.inv $Heap@@18 this@@18))
))))
(assert  (=> (<= 12 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@19 this@@19) (and (< 12 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Object) ($IsAlloc refType this@@19 Tclass._module.Object $Heap@@19)))))) (=> (_module.Object.inv $Heap@@19 this@@19) (_module.Object.localInv $Heap@@19 this@@19)))
 :qid |_11MutexGuard2legacydfy.249:19|
 :skolemid |1151|
...
(let ((anon13_Then_correct  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> (and ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@23) (= |b$reqreads#2@0| (forall (($o@@18 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@18 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@18) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@18) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@18 $f@@0)))
 :qid |_11MutexGuard2legacydfy.23:62|
 :skolemid |646|
...
(let ((anon10_Else_correct  (=> ($IsAllocBox ($Box refType this@@23) Tclass._module.Universe? $Heap@@23) (=> (and (= |b$reqreads#0@0| (forall (($o@@19 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@19 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@19) alloc)))) (or (= $o@@19 this@@23) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@23) _module.Universe.content)) ($Box refType $o@@19)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@19 $f@@1)))
 :qid |_11MutexGuard2legacydfy.23:5|
 :skolemid |645|
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#8| null $Heap@@23 alloc $Heap@@23 alloc)) (and (=> (= (ControlFlow 0 15) 1) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@23) ($IsHeapAnchor $Heap@@23)) (=> (and (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Universe) ($IsAlloc refType this@@23 Tclass._module.Universe $Heap@@23))) (and (= 13 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
