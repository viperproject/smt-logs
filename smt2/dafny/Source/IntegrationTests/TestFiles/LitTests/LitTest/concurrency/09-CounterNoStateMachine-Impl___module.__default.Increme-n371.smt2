...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split360)
...
)))))) (and (and (forall (($o@@186 T@U) ) (!  (=> (and (or (not (= $o@@186 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@186) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@186) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 $o@@186)) (or (= $o@@186 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@38 |universe#0|) _module.Universe.content)) ($Box refType $o@@186)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 $o@@186))
)) ($HeapSucc $Heap@38 $Heap@39)) (and (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|)) (< (- 10 |i#0@2|) |$decr$loop#00@1|)))) (and (and (and (and (|_module.Universe.globalInv#canCall| $Heap@39 |universe#0|) (=> (_module.Universe.globalInv $Heap@39 |universe#0|) (|_module.Universe.baseLegalTransitionsSequence#canCall| $Heap@3 $Heap@39 |universe#0|))) (= (ControlFlow 0 2) (- 0 1))) |$w$loop#0@0|) (|_module.Universe.globalInv#canCall| $Heap@39 |universe#0|)))))))) (or (_module.Universe.globalInv $Heap@39 |universe#0|) (=> (|_module.Universe.globalBaseInv#canCall| $Heap@39 |universe#0|) (or (_module.Universe.globalBaseInv $Heap@39 |universe#0|) (forall ((|o#16@@1| T@U) ) (!  (=> (and ($Is refType |o#16@@1| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@39 |universe#0|) _module.Universe.content)) ($Box refType |o#16@@1|))) (and (= (_module.Object.universe |o#16@@1|) |universe#0|) (or (not (= |o#16@@1| |universe#0|)) (not true))))
 :qid |_09CounterNoStateMachinedfy.34:16|
 :skolemid |532|
