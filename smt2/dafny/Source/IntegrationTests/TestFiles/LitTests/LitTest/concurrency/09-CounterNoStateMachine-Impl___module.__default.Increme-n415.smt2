...
(set-info :boogie-vc-id Impl$$_module.__default.Incrementer_split404)
...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))) (and (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (|_module.Universe.globalInv#canCall| $Heap@8 |universe#0|)) (and (and (|_module.Universe.globalInv#canCall| $Heap@8 |universe#0|) (and (_module.Universe.globalInv $Heap@8 |universe#0|) (and (_module.Universe.globalBaseInv $Heap@8 |universe#0|) (forall ((|o#5@@4| T@U) ) (!  (=> (and ($Is refType |o#5@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 |universe#0|) _module.Universe.content)) ($Box refType |o#5@@4|))) (_module.Object.inv $Heap@8 |o#5@@4|))
 :qid |_09CounterNoStateMachinedfy.40:32|
 :skolemid |904|
