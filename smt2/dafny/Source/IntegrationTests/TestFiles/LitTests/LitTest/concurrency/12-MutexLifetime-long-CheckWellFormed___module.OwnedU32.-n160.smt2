...
(set-info :boogie-vc-id CheckWellFormed$$_module.OwnedU32.admissibility)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#57| null current$Heap alloc false)) (=> (and ($IsAllocBox ($Box refType this@@148) Tclass._module.Object? current$Heap) ($IsAlloc refType |running#0@@5| Tclass._module.Thread current$Heap)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@148 Tclass._module.OwnedU32 $Heap@@82)) (=> ($IsAlloc refType this@@148 Tclass._module.OwnedU32 $Heap@@82) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@82)) (=> ($IsAlloc refType |running#0@@5| Tclass._module.Thread $Heap@@82) (=> (and (and (|_module.Object.goodPreAndLegalChanges#canCall| $Heap@@82 current$Heap this@@148 |running#0@@5|) (_module.Object.goodPreAndLegalChanges $Heap@@82 current$Heap this@@148 |running#0@@5|)) (and ($IsAllocBox ($Box refType this@@148) Tclass._module.OwnedObject? current$Heap) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@148 Tclass._module.OwnedU32 $Heap@@82))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@82) ($IsHeapAnchor $Heap@@82)) (and (or (not (= this@@148 null)) (not true)) (and ($Is refType this@@148 Tclass._module.OwnedU32) ($IsAlloc refType this@@148 Tclass._module.OwnedU32 previous$Heap)))) (=> (and (and (and ($Is refType |running#0@@5| Tclass._module.Thread) ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap)) (= 19 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@82) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |running#0@@5| Tclass._module.Thread previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
