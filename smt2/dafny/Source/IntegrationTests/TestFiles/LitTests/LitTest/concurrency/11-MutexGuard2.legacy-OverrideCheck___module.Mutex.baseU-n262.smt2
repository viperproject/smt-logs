...
(assert (forall (($o@@20 T@U) ) (!  (=> ($Is refType $o@@20 Tclass._module.OwnedU32?) ($Is refType $o@@20 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2444|
 :pattern ( ($Is refType $o@@20 Tclass._module.OwnedU32?))
)))
...
(assert (forall (($o@@21 T@U) ) (!  (=> ($Is refType $o@@21 Tclass._module.Mutex?) ($Is refType $o@@21 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2448|
 :pattern ( ($Is refType $o@@21 Tclass._module.Mutex?))
)))
...
(assert (forall (($o@@22 T@U) ) (!  (=> ($Is refType $o@@22 Tclass._module.MutexGuardU32?) ($Is refType $o@@22 Tclass._module.OwnedObject?))
 :qid |unknown.0:0|
 :skolemid |2452|
 :pattern ( ($Is refType $o@@22 Tclass._module.MutexGuardU32?))
)))
...
(set-info :boogie-vc-id OverrideCheck$$_module.Mutex.baseUserFieldsInvMonotonicity)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (and (and (_module.Mutex.baseUserFieldsInv $Heap@@0 this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))) (forall (($o@@28 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@28 null)) (not true)) (=> (= $o@@28 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@28) $f@@0))))
 :qid |_11MutexGuard2legacydfy.405:132|
 :skolemid |1914|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@28) $f@@0))
))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.Mutex.baseUserFieldsInv#canCall| $Heap@@0 this@@1) (or (_module.Mutex.baseUserFieldsInv $Heap@@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Mutex.data))))) (=> (=> (|_module.Mutex.baseUserFieldsInv#canCall| $Heap@@0 this@@1) (or (_module.Mutex.baseUserFieldsInv $Heap@@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Mutex.data)))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.Mutex.baseUserFieldsInv#canCall| $Heap@@0 this@@1) (or (_module.Mutex.baseUserFieldsInv $Heap@@0 this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Mutex.guards)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)))))) (=> (=> (|_module.Mutex.baseUserFieldsInv#canCall| $Heap@@0 this@@1) (or (_module.Mutex.baseUserFieldsInv $Heap@@0 this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Mutex.guards)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))) (=> (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.Object.universe this@@1)) _module.Universe.content)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall (($o@@29 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@29 null)) (not true)) (=> (= $o@@29 this@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@29) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@29) $f@@1))))
 :qid |_11MutexGuard2legacydfy.481:132|
 :skolemid |1915|
...
)) (and (=> (= (ControlFlow 0 2) (- 0 6)) true) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@31 T@U) ($f@@3 T@U) ) (! true
 :qid |_11MutexGuard2legacydfy.481:18|
 :skolemid |1916|
))) (=> (forall (($o@@32 T@U) ($f@@4 T@U) ) (! true
 :qid |_11MutexGuard2legacydfy.481:18|
 :skolemid |1916|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@33 T@U) ($f@@5 T@U) ) (! true
 :qid |_11MutexGuard2legacydfy.481:18|
 :skolemid |1917|
))) (=> (forall (($o@@34 T@U) ($f@@6 T@U) ) (! true
 :qid |_11MutexGuard2legacydfy.481:18|
 :skolemid |1917|
)) (=> (_module.Mutex.baseUserFieldsInv current$Heap this@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Mutex.baseUserFieldsInv#canCall| current$Heap this@@1) (or (_module.Mutex.baseUserFieldsInv current$Heap this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Mutex.data))))) (=> (=> (|_module.Mutex.baseUserFieldsInv#canCall| current$Heap this@@1) (or (_module.Mutex.baseUserFieldsInv current$Heap this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Mutex.data)))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Mutex.baseUserFieldsInv#canCall| current$Heap this@@1) (or (_module.Mutex.baseUserFieldsInv current$Heap this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Mutex.guards)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap (_module.Object.universe this@@1)) _module.Universe.content)))))))))))))))))))))))))
