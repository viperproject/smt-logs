...
)))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |running#0@@3|))))) (and (and (and ($IsGoodHeap $Heap@17) ($IsHeapAnchor $Heap@17)) (and (or (not (= call4formal@this@0@@0 null)) (not true)) (and ($Is refType call4formal@this@0@@0 Tclass._module.ConstantInteger) ($IsAlloc refType call4formal@this@0@@0 Tclass._module.ConstantInteger $Heap@17)))) (and (and (|_module.Object.objectGlobalInv#canCall| $Heap@17 call4formal@this@0@@0) (=> (_module.Object.objectGlobalInv $Heap@17 call4formal@this@0@@0) (|_module.Universe.globalInv2#canCall| $Heap@16 $Heap@17 |universe#0|))) (and (|_module.Object.objectGlobalInv#canCall| $Heap@17 call4formal@this@0@@0) (and (_module.Object.objectGlobalInv $Heap@17 call4formal@this@0@@0) (and (_module.Object.baseInv $Heap@17 call4formal@this@0@@0) (_module.Universe.globalInv $Heap@17 (_module.Object.universe call4formal@this@0@@0)))))))))) (and (and (and (and (and (and (|_module.Universe.globalInv2#canCall| $Heap@16 $Heap@17 |universe#0|) (and (_module.Universe.globalInv2 $Heap@16 $Heap@17 |universe#0|) (and true (forall ((|o#8@@4| T@U) ) (!  (=> (and ($Is refType |o#8@@4| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@16 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@17 |universe#0|) _module.Universe.content)) ($Box refType |o#8@@4|)) (_module.Object.inv2 $Heap@16 $Heap@17 |o#8@@4|)))
 :qid |_09CounterNoStateMachinedfy.45:16|
 :skolemid |2895|
...
))))) (= (_module.Object.universe call4formal@this@0@@1) |universe#0|)) (and (and (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 call4formal@this@0@@1) _module.OwnedObject.owner)) |running#0@@3|) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 call4formal@this@0@@1) _module.ConstantInteger.value))) |value##0_2@1|)) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 |universe#0|) _module.Universe.content)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) (|Set#UnionOne| |Set#Empty| ($Box refType call4formal@this@0@@1)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 call4formal@this@0@@1) alloc))))))) (and (and (and (forall (($o@@157 T@U) ) (!  (=> (and (or (not (= $o@@157 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@157) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@157) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@157)) (= $o@@157 |universe#0|)))
 :qid |_09CounterNoStateMachinedfy.608:3|
 :skolemid |2896|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@157))
)) ($HeapSucc $Heap@23 $Heap@24)) (and (or (not (= |universe#0| null)) (not true)) ($IsAlloc refType |universe#0| Tclass._module.Universe $Heap@23))) (and (and ($IsGoodHeap $Heap@25) ($IsHeapAnchor $Heap@25)) (and (forall ((|o#1@@29| T@U) ) (!  (=> ($Is refType |o#1@@29| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 |universe#0|) _module.Universe.content)) ($Box refType |o#1@@29|)) (=> (=> ($Is refType |o#1@@29| Tclass._module.OwnedObject) (and (forall (($o@@158 T@U) ($f@@102 T@U) ) (!  (=> (or (not (= $o@@158 null)) (not true)) (=> (= $o@@158 |o#1@@29|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@24 $o@@158) $f@@102) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@23 $o@@158) $f@@102))))
 :qid |_09CounterNoStateMachinedfy.154:12|
 :skolemid |1006|
