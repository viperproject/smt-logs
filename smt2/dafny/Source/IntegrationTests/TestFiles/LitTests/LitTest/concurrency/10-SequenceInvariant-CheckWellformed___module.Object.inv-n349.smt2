...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@4 this@@4) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.Thread)))) (= (_module.Object.inv $Heap@@4 this@@4) (_module.Thread.inv $Heap@@4 this@@4)))
...
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@5 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@5 this@@5) (and (< 9 $FunctionContextHeight) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.OwnedObject)))) (= (_module.Object.inv $Heap@@5 this@@5) (_module.OwnedObject.inv $Heap@@5 this@@5)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1474|
 :pattern ( (_module.Object.inv $Heap@@5 this@@5) ($Is refType this@@5 Tclass._module.OwnedObject) ($IsGoodHeap $Heap@@5))
 :pattern ( (_module.Object.inv $Heap@@5 this@@5) (_module.OwnedObject.inv $Heap@@5 this@@5) ($IsGoodHeap $Heap@@5))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@8 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@8 this@@8) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@8) (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.OwnedObject) ($IsAlloc refType this@@8 Tclass._module.OwnedObject $Heap@@8)))))) (and (and (|_module.Object.objectGlobalBaseInv#canCall| $Heap@@8 this@@8) (=> (_module.Object.objectGlobalBaseInv $Heap@@8 this@@8) (|_module.OwnedObject.localUserInv#canCall| $Heap@@8 this@@8))) (= (_module.OwnedObject.localInv $Heap@@8 this@@8)  (and (_module.Object.objectGlobalBaseInv $Heap@@8 this@@8) (_module.OwnedObject.localUserInv $Heap@@8 this@@8)))))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1460|
 :pattern ( (_module.OwnedObject.localInv $Heap@@8 this@@8) ($IsGoodHeap $Heap@@8))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@9 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@9 this@@9) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.OwnedObject) ($IsAlloc refType this@@9 Tclass._module.OwnedObject $Heap@@9)))))) (and (and (|_module.OwnedObject.localInv#canCall| $Heap@@9 this@@9) (=> (_module.OwnedObject.localInv $Heap@@9 this@@9) (|_module.OwnedObject.userInv#canCall| $Heap@@9 this@@9))) (= (_module.OwnedObject.inv $Heap@@9 this@@9)  (and (_module.OwnedObject.localInv $Heap@@9 this@@9) (_module.OwnedObject.userInv $Heap@@9 this@@9)))))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1473|
 :pattern ( (_module.OwnedObject.inv $Heap@@9 this@@9) ($IsGoodHeap $Heap@@9))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@10 T@U) ) (!  (=> (or (|_module.Universe.globalBaseInv#canCall| $Heap@@10 this@@10) (and (< 6 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.Universe) ($IsAlloc refType this@@10 Tclass._module.Universe $Heap@@10)))))) (and (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.Object) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 this@@10) _module.Universe.content)) ($Box refType |o#0|)) (=> (= (_module.Object.universe |o#0|) this@@10) (=> (or (not (= |o#0| this@@10)) (not true)) (and (|_module.Object.baseFieldsInv#canCall| $Heap@@10 |o#0|) (=> (_module.Object.baseFieldsInv $Heap@@10 |o#0|) (|_module.Object.triggerAxioms#canCall| $Heap@@10 |o#0|)))))))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |613|
 :pattern ( (_module.Object.triggerAxioms $Heap@@10 |o#0|))
 :pattern ( (_module.Object.baseFieldsInv $Heap@@10 |o#0|))
 :pattern ( (_module.Object.universe |o#0|))
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 this@@10) _module.Universe.content)) ($Box refType |o#0|)))
)) (= (_module.Universe.globalBaseInv $Heap@@10 this@@10) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 this@@10) _module.Universe.content)) ($Box refType |o#0@@0|))) (and (and (and (= (_module.Object.universe |o#0@@0|) this@@10) (or (not (= |o#0@@0| this@@10)) (not true))) (_module.Object.baseFieldsInv $Heap@@10 |o#0@@0|)) (_module.Object.triggerAxioms $Heap@@10 |o#0@@0|)))
 :qid |_10SequenceInvariantdfy.17:12|
 :skolemid |612|
 ...
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 this@@10) _module.Universe.content)) ($Box refType |o#0@@0|)))
)))))
 :qid |_10SequenceInvariantdfy.16:19|
 :skolemid |614|
 :pattern ( (_module.Universe.globalBaseInv $Heap@@10 this@@10) ($IsGoodHeap $Heap@@10))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@12 T@U) ) (!  (=> (or (|_module.OwnedObject.userInv#canCall| $Heap@@12 this@@12) (and (< 2 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.OwnedObject) ($IsAlloc refType this@@12 Tclass._module.OwnedObject $Heap@@12)))))) (=> (_module.OwnedObject.userInv $Heap@@12 this@@12) (_module.OwnedObject.localUserInv $Heap@@12 this@@12)))
 :qid |_10SequenceInvariantdfy.397:19|
 :skolemid |1549|
 :pattern ( (_module.OwnedObject.userInv $Heap@@12 this@@12))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@13 T@U) ) (!  (=> (or (|_module.Thread.localInv#canCall| $Heap@@13 this@@13) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Thread) ($IsAlloc refType this@@13 Tclass._module.Thread $Heap@@13)))))) (=> (_module.Thread.localInv $Heap@@13 this@@13) (_module.Object.objectGlobalBaseInv $Heap@@13 this@@13)))
 :qid |_10SequenceInvariantdfy.259:19|
 :skolemid |1203|
 :pattern ( (_module.Thread.localInv $Heap@@13 this@@13))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@14 T@U) ) (!  (=> (or (|_module.OwnedObject.localInv#canCall| $Heap@@14 this@@14) (and (< 8 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.OwnedObject) ($IsAlloc refType this@@14 Tclass._module.OwnedObject $Heap@@14)))))) (=> (_module.OwnedObject.localInv $Heap@@14 this@@14) (_module.Object.objectGlobalBaseInv $Heap@@14 this@@14)))
 :qid |_10SequenceInvariantdfy.325:19|
 :skolemid |1458|
 :pattern ( (_module.OwnedObject.localInv $Heap@@14 this@@14))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@15 T@U) ) (!  (=> (or (|_module.Object.localInv#canCall| $Heap@@15 this@@15) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Object) ($IsAlloc refType this@@15 Tclass._module.Object $Heap@@15)))))) (=> (_module.Object.localInv $Heap@@15 this@@15) (_module.Object.objectGlobalBaseInv $Heap@@15 this@@15)))
 :qid |_10SequenceInvariantdfy.241:19|
 :skolemid |1116|
 :pattern ( (_module.Object.localInv $Heap@@15 this@@15))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.Thread.inv#canCall| $Heap@@16 this@@16) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@16) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.Thread) ($IsAlloc refType this@@16 Tclass._module.Thread $Heap@@16)))))) (=> (_module.Thread.inv $Heap@@16 this@@16) (_module.Thread.localInv $Heap@@16 this@@16)))
 :qid |_10SequenceInvariantdfy.262:19|
 :skolemid |1215|
 :pattern ( (_module.Thread.inv $Heap@@16 this@@16))
))))
(assert  (=> (<= 9 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@17 T@U) ) (!  (=> (or (|_module.OwnedObject.inv#canCall| $Heap@@17 this@@17) (and (< 9 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@17 null)) (not true)) (and ($Is refType this@@17 Tclass._module.OwnedObject) ($IsAlloc refType this@@17 Tclass._module.OwnedObject $Heap@@17)))))) (=> (_module.OwnedObject.inv $Heap@@17 this@@17) (_module.OwnedObject.localInv $Heap@@17 this@@17)))
 :qid |_10SequenceInvariantdfy.329:19|
 :skolemid |1471|
 :pattern ( (_module.OwnedObject.inv $Heap@@17 this@@17))
))))
(assert  (=> (<= 10 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Object.inv#canCall| $Heap@@18 this@@18) (and (< 10 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Object) ($IsAlloc refType this@@18 Tclass._module.Object $Heap@@18)))))) (=> (_module.Object.inv $Heap@@18 this@@18) (_module.Object.localInv $Heap@@18 this@@18)))
 :qid |_10SequenceInvariantdfy.243:19|
 :skolemid |1126|
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@22 alloc $Heap@@22 alloc)) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Else_correct) (=> (= (ControlFlow 0 6) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@22) ($IsHeapAnchor $Heap@@22)) (=> (and (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Object) ($IsAlloc refType this@@22 Tclass._module.Object $Heap@@22))) (and (= 10 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
