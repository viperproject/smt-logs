...
)) ($HeapSucc $Heap@3 $Heap@4)))))) (and (and (and (and (and (and (and (forall (($o@@123 T@U) ($f@@74 T@U) ) (!  (=> (and (or (not (= $o@@123 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@123) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@123) $f@@74) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@123) $f@@74)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@123 $f@@74))))
 :qid |_09CounterNoStateMachinedfy.710:3|
 :skolemid |545|
...
)))))) (and (and (forall (($o@@134 T@U) ) (!  (=> (and (or (not (= $o@@134 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@134) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@134) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 $o@@134)) (or (= $o@@134 |universe#0|) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@12 |universe#0|) _module.Universe.content)) ($Box refType $o@@134)))))
 :qid |_09CounterNoStateMachinedfy.116:10|
 :skolemid |923|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@13 $o@@134))
)) ($HeapSucc $Heap@12 $Heap@13)) (and (or (not (= |counter#0| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))))) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |counter#0| _module.IncreasingCounter.value))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
