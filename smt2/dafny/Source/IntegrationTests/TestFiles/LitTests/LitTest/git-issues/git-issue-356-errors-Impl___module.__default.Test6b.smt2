...
(set-info :boogie-vc-id Impl$$_module.__default.Test6b)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 0 $FunctionContextHeight) (<= |r#0| (LitReal 255.0))) (and (= |r#0| (q@Real (q@Int |r#0|))) (= (ControlFlow 0 4) 2))) anon0_correct))))
