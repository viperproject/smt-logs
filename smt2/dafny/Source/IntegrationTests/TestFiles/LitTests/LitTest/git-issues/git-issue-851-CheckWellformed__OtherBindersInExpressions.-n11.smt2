...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.MapComprehension2#canCall| (< 1 $FunctionContextHeight)) (and (forall ((|a#1#0#0@@0| T@U) )  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))))) (= OtherBindersInExpressions.__default.MapComprehension2 (LitInt (Div 40 (LitInt 0))))))))
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.MapComprehension2#canCall| (< 1 $FunctionContextHeight)) (and (forall ((|a#4#0#0@@0| T@U) )  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))))) (= OtherBindersInExpressions.__default.MapComprehension2 (LitInt (Div 40 (LitInt 0))))))))
