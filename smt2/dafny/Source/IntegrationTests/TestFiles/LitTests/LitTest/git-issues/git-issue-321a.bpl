// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-321a.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-321a-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-321a.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "InitTests (correctness)"} Impl$$_module.__default.InitTests() returns ($_reverifyPost: bool)
{
  ...
  var lambdaResult#0: char;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-321a.dfy(7,10)
    assume true;
    assert {:id "id0"} 0 <= LitInt(3);
    havoc $nw;
    ...
    aa#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-321a.dfy(8,9)
    assume true;
    assume true;
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-321a.dfy(9,6)
    assume true;
    assert {:id "id3"} 0 <= Seq#Length(s#0);
    ...
    if (*)
    {
        ...
        if (true)
        {
            ...
            {
                assert {:id "id4"} 0 <= i#0 && i#0 < Seq#Length(s#0);
                assume {:id "id5"} lambdaResult#0 == $Unbox(Seq#Index(s#0, i#0)): char;
                assume true;
    ...
    assert {:id "id6"} {:subsumption 0} (forall arrayinit#0#i0#0: int :: 
    ...
    assert {:id "id7"} {:subsumption 0} (forall arrayinit#0#i0#0: int :: 
      0 <= arrayinit#0#i0#0 && arrayinit#0#i0#0 < Seq#Length(s#0)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "lowercase (well-formedness)"} CheckWellFormed$$_module.lowercase(ch#0: char)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id9"} char#ToInt(Lit(char#FromInt(97))) <= char#ToInt(ch#0)
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id10"} {:subsumption 0} char#ToInt(Lit(char#FromInt(97))) <= char#ToInt(Lit(char#FromInt(100)));
        assert {:id "id11"} {:subsumption 0} char#ToInt(Lit(char#FromInt(100))) <= char#ToInt(Lit(char#FromInt(122)));
        assume false;
    }
}
