...
(assert (distinct TChar TagChar TagSet TagSeq TagMap alloc allocName |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.Object Tagclass._module.Memory Tagclass._module.Memory? Tagclass._module.Object? class._module.Object? class._module.Memory? |tytagFamily$_tuple#2| tytagFamily$Object tytagFamily$Memory field$fields field$objects)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.fNullify_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Memory) ($IsAlloc refType this Tclass._module.Memory $Heap)))) (=> (and (and (and ($Is refType |o#0| Tclass._module.Object) ($IsAlloc refType |o#0| Tclass._module.Object $Heap)) (and ($Is SeqType |f#0| (TSeq TChar)) ($IsAlloc SeqType |f#0| (TSeq TChar) $Heap))) (and (and (= 9 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |o#0| _module.Object.fields))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Memory.objects)) ($Box refType |o#0|)) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |o#0| null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
