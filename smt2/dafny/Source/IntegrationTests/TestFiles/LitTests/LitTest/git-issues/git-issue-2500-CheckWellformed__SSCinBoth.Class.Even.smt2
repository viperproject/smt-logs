...
(set-info :boogie-vc-id CheckWellformed$$SSCinBoth.Class.Even)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (or (= |i#0@@9| (LitInt 0)) (= (= (Mod |i#0@@9| (LitInt 2)) (LitInt 0)) (SSCinBoth.Class.Odd ($LS ($LS $LZ)) this@@9 (- |i#0@@9| 1)))))))
(let ((anon8_correct  (=> (and (and (= (SSCinBoth.Class.Even ($LS $LZ) this@@9 |i#0@@9|)  (or (= |i#0@@9| (LitInt 0)) (SSCinBoth.Class.Odd ($LS $LZ) this@@9 (- |i#0@@9| 1)))) (=> (or (not (= |i#0@@9| (LitInt 0))) (not true)) (|SSCinBoth.Class.Odd#canCall| this@@9 (- |i#0@@9| 1)))) (and ($Is boolType (bool_2_U (SSCinBoth.Class.Even ($LS $LZ) this@@9 |i#0@@9|)) TBool) (= (ControlFlow 0 10) 9))) GeneratedUnifiedExit_correct)))
(let ((anon12_Else_correct  (=> (and (= |i#0@@9| (LitInt 0)) (= (ControlFlow 0 15) 10)) anon8_correct)))
(let ((anon12_Then_correct  (=> (and (or (not (= |i#0@@9| (LitInt 0))) (not true)) ($IsAllocBox ($Box refType this@@9) Tclass.SSCinBoth.Class? $Heap)) (and (=> (= (ControlFlow 0 11) (- 0 14)) ($Is intType (int_2_U (- |i#0@@9| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |i#0@@9| 1)) Tclass._System.nat) (=> (and (= |##i#1@0| (- |i#0@@9| 1)) ($IsAlloc intType (int_2_U |##i#1@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (<= 0 |i#0@@9|) (= |##i#1@0| |i#0@@9|))) (=> (or (<= 0 |i#0@@9|) (= |##i#1@0| |i#0@@9|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< |##i#1@0| |i#0@@9|)) (=> (< |##i#1@0| |i#0@@9|) (=> (and (|SSCinBoth.Class.Odd#canCall| this@@9 (- |i#0@@9| 1)) (= (ControlFlow 0 11) 10)) anon8_correct)))))))))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (or (not (= |i#0@@9| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> ($IsAllocBox ($Box refType this@@9) Tclass.SSCinBoth.Class? $Heap) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($Is intType (int_2_U (- |i#0@@9| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |i#0@@9| 1)) Tclass._System.nat) (=> (and (= |##i#0@0| (- |i#0@@9| 1)) ($IsAlloc intType (int_2_U |##i#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (<= 0 |i#0@@9|) (= |##i#0@0| |i#0@@9|))) (=> (or (<= 0 |i#0@@9|) (= |##i#0@0| |i#0@@9|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< |##i#0@0| |i#0@@9|)) (=> (< |##i#0@0| |i#0@@9|) (=> (|SSCinBoth.Class.Odd#canCall| this@@9 (- |i#0@@9| 1)) (=> (and (= (= (Mod |i#0@@9| (LitInt 2)) (LitInt 0)) (SSCinBoth.Class.Odd ($LS $LZ) this@@9 (- |i#0@@9| 1))) (= (ControlFlow 0 3) 1)) anon5_correct)))))))))))))))
