...
(assert (forall ((m@@16 T@U) ) (!  (or (= m@@16 |Map#Empty|) (exists ((k@@3 T@U) (v@@12 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@16) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@3 v@@12)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.dynNukeObject)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon4_correct  (=> (forall ((|e#1@@2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |e#1@@2| Tclass._module.Edge) (|Set#IsMember| (_module.Memory.edges $Heap@0 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects))) ($Box DatatypeTypeType |e#1@@2|))) (or (not (= (_module.Edge.f |e#1@@2|) |iso#0|)) (not true)))
 :qid |gitissue3855dfy.963:20|
 :skolemid |1337|
 :pattern ( (_module.Edge.f |e#1@@2|))
 :pattern ( (|Set#IsMember| (_module.Memory.edges $Heap@0 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects))) ($Box DatatypeTypeType |e#1@@2|)))
)) (=> (and ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? $Heap@0) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25)))))
(let ((anon5_Else_correct  (=> (and (=> (|Set#IsMember| (_module.Memory.edges $Heap@0 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects))) ($Box DatatypeTypeType |e#0@0|)) (or (not (= (_module.Edge.f |e#0@0|) |iso#0|)) (not true))) (= (ControlFlow 0 4) 2)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and (and (and ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? $Heap@0) (= |##os#2@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects)))) (and ($IsAlloc SetType |##os#2@0| (TSet Tclass._module.Object) $Heap@0) (|_module.Memory.edges#canCall| $Heap@0 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects))))) (and (and (|Set#IsMember| (_module.Memory.edges $Heap@0 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects))) ($Box DatatypeTypeType |e#0@0|)) (_module.Edge.Edge_q |e#0@0|)) (and (or (not (= (_module.Edge.f |e#0@0|) |iso#0|)) (not true)) (= (ControlFlow 0 3) 2)))) anon4_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@25 alloc |iso#0| _module.Object.fields)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@60) _module.Memory.objects)) ($Box refType |iso#0|))) (and (=> (= (ControlFlow 0 5) (- 0 12)) (or (not (= |iso#0| null)) (not true))) (=> (or (not (= |iso#0| null)) (not true)) (=> (= |##x#0@0| (_module.Region.Frozen_q (_module.Object.region |iso#0|))) (=> (and ($IsAlloc boolType (bool_2_U |##x#0@0|) TBool $Heap@@25) (|_module.__default.not#canCall| (_module.Region.Frozen_q (_module.Object.region |iso#0|)))) (=> (and (and (_module.__default.not (_module.Region.Frozen_q (_module.Object.region |iso#0|))) ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? $Heap@@25)) (and (|_module.Memory.Valid#canCall| $Heap@@25 this@@60) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@25 this@@60))) (and (=> (= (ControlFlow 0 5) (- 0 11)) (or (not (= |iso#0| null)) (not true))) (=> (or (not (= |iso#0| null)) (not true)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@28 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 $o@@28) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 $o@@28)) (= $o@@28 |iso#0|)))
 :qid |gitissue3855dfy.948:26|
 :skolemid |1334|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28))
))) (and (forall (($o@@29 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 $o@@29) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 $o@@29) $f@@16)) (and (= $o@@29 |iso#0|) (= $f@@16 _module.Object.fields))))
 :qid |gitissue3855dfy.948:26|
 :skolemid |1335|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) $f@@16))
)) ($HeapSucc $Heap@@25 $Heap@0))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (=> (|Set#IsMember| (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects)) (|Set#UnionOne| |Set#Empty| ($Box refType |iso#0|))) ($Box refType |$unchanged#x0@0|)) ($IsAlloc refType |$unchanged#x0@0| Tclass._module.Object $Heap@@25))) (=> (=> (|Set#IsMember| (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects)) (|Set#UnionOne| |Set#Empty| ($Box refType |iso#0|))) ($Box refType |$unchanged#x0@0|)) ($IsAlloc refType |$unchanged#x0@0| Tclass._module.Object $Heap@@25)) (=> (forall (($o@@30 T@U) ($f@@17 T@U) ) (!  (=> (or (not (= $o@@30 null)) (not true)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects)) ($Box refType $o@@30)) (or (not (= $o@@30 |iso#0|)) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 $o@@30) $f@@17))))
 :qid |gitissue3855dfy.960:13|
 :skolemid |1336|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) $f@@17))
)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (or (not (= |iso#0| null)) (not true))) (=> (or (not (= |iso#0| null)) (not true)) (=> (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |iso#0|) _module.Object.fields)) |Map#Empty|) (=> (and (and ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? $Heap@0) (= |##os#0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects)))) (and ($IsAlloc SetType |##os#0@0| (TSet Tclass._module.Object) $Heap@0) (|_module.Memory.edges#canCall| $Heap@0 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects))))) (and (=> (= (ControlFlow 0 5) (- 0 8)) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25)) (=> ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25) (=> (= |##os#1@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@60) _module.Memory.objects))) (and (=> (= (ControlFlow 0 5) (- 0 7)) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25)) (=> ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@60) _module.Memory.objects)) (TSet Tclass._module.Object) $Heap@@25)) (=> ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@60) _module.Memory.objects)) (TSet Tclass._module.Object) $Heap@@25) (=> (and (and (|_module.Memory.edges#canCall| $Heap@@25 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@60) _module.Memory.objects))) (|Set#Subset| (_module.Memory.edges $Heap@0 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects))) (_module.Memory.edges $Heap@@25 this@@60 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@25 this@@60) _module.Memory.objects))))) (and ($Is DatatypeTypeType |e#0@0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |e#0@0| Tclass._module.Edge $Heap@0))) (and (=> (= (ControlFlow 0 5) 3) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@25) ($IsHeapAnchor $Heap@@25)) (and (or (not (= this@@60 null)) (not true)) (and ($Is refType this@@60 Tclass._module.Memory) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25)))) (and (and ($Is refType |iso#0| Tclass._module.Object) ($IsAlloc refType |iso#0| Tclass._module.Object $Heap@@25)) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 13) 5)))) anon0_correct)))
