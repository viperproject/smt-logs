...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (= |newtype$check#0@0| (|_module.__default.PartialFnWitness#Handle| _module.Fn1$R)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((|x0#0@@1| Int) ) (|Set#Equal| (Reads1 TInt (Tclass._module.Option _module.Fn1$R) $Heap@@0 |newtype$check#0@0| ($Box intType (int_2_U |x0#0@@1|))) |Set#Empty|))) (=> (forall ((|x0#0@@2| T@U) ) (|Set#Equal| (Reads1 TInt (Tclass._module.Option _module.Fn1$R) $Heap@@0 |newtype$check#0@0| ($Box intType |x0#0@@2|)) |Set#Empty|)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((|x0#1| Int) ) (Requires1 TInt (Tclass._module.Option _module.Fn1$R) $Heap@@0 |newtype$check#0@0| ($Box intType (int_2_U |x0#1|))))) (=> (forall ((|x0#1@@0| T@U) ) (Requires1 TInt (Tclass._module.Option _module.Fn1$R) $Heap@@0 |newtype$check#0@0| ($Box intType |x0#1@@0|))) (=> (= |newtype$check#1@0| (|_module.__default.PartialFnWitness#Handle| _module.Fn1$R)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|x0#2| Int) ) (|Set#Equal| (Reads1 TInt (Tclass._module.Option _module.Fn1$R) $Heap@@0 |newtype$check#1@0| ($Box intType (int_2_U |x0#2|))) |Set#Empty|))) (=> (forall ((|x0#2@@0| T@U) ) (|Set#Equal| (Reads1 TInt (Tclass._module.Option _module.Fn1$R) $Heap@@0 |newtype$check#1@0| ($Box intType |x0#2@@0|)) |Set#Empty|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|x0#3| Int) ) (Requires1 TInt (Tclass._module.Option _module.Fn1$R) $Heap@@0 |newtype$check#1@0| ($Box intType (int_2_U |x0#3|))))) (=> (forall ((|x0#3@@0| T@U) ) (Requires1 TInt (Tclass._module.Option _module.Fn1$R) $Heap@@0 |newtype$check#1@0| ($Box intType |x0#3@@0|))) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))))))
