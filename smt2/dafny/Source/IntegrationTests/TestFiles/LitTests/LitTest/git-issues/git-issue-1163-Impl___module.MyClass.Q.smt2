...
(assert (forall ((t0@@10 T@U) (t1@@8 T@U) (h0@@3 T@U) (h1@@3 T@U) (f@@6 T@U) (bx0@@5 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@3 h1@@3) (and ($IsGoodHeap h0@@3) ($IsGoodHeap h1@@3))) (and ($IsBox bx0@@5 t0@@10) ($Is HandleTypeType f@@6 (Tclass._System.___hFunc1 t0@@10 t1@@8)))) (forall ((o@@5 T@U) (fld@@3 T@U) ) (!  (=> (and (or (not (= o@@5 null)) (not true)) (|Set#IsMember| (Reads1 t0@@10 t1@@8 h0@@3 f@@6 bx0@@5) ($Box refType o@@5))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h0@@3 o@@5) fld@@3) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h1@@3 o@@5) fld@@3)))
 :qid |unknown.0:0|
 :skolemid |381|
...
(assert (forall ((t0@@11 T@U) (t1@@9 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@7 T@U) (bx0@@6 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) (and ($IsBox bx0@@6 t0@@11) ($Is HandleTypeType f@@7 (Tclass._System.___hFunc1 t0@@11 t1@@9)))) (forall ((o@@6 T@U) (fld@@4 T@U) ) (!  (=> (and (or (not (= o@@6 null)) (not true)) (|Set#IsMember| (Reads1 t0@@11 t1@@9 h1@@4 f@@7 bx0@@6) ($Box refType o@@6))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h0@@4 o@@6) fld@@4) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h1@@4 o@@6) fld@@4)))
 :qid |unknown.0:0|
 :skolemid |383|
...
(assert (forall ((a@@3 T@U) (b@@3 T@U) (t0@@21 T@U) (t1@@17 T@U) ) (!  (=> (forall ((bx@@18 T@U) ) (!  (=> (U_2_bool (MapType1Select BoxType boolType a@@3 bx@@18)) (and ($IsBox bx@@18 t0@@21) ($IsBox (MapType1Select BoxType BoxType b@@3 bx@@18) t1@@17)))
 :qid |DafnyPreludebpl.1585:11|
 :skolemid |318|
)) ($Is IMapType (|IMap#Glue| a@@3 b@@3 (TIMap t0@@21 t1@@17)) (TIMap t0@@21 t1@@17)))
...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@3 T@U) (|c#0@@6| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.MyClass))) (or (|_module.MyClass.R#canCall| $h0 this@@3 |c#0@@6|) ($Is refType |c#0@@6| Tclass._module.MyClass))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (= $o@@6 this@@3)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@6) $f@@0) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@6) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |512|
)) (= (_module.MyClass.R $h0 this@@3 |c#0@@6|) (_module.MyClass.R $h1 this@@3 |c#0@@6|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |513|
...
(let ((anon25_Then_correct  (=> (and (and ($Is refType |p#0_0@0| Tclass._module.MyClass) ($IsAlloc refType |p#0_0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|)) (= |$_Frame#l0_0@0| (|lambda#0| null |$Heap_at_$lambdaHeap#0_0@0| alloc (_module.MyClass.R |$Heap_at_$lambdaHeap#0_0@0| this@@4 |p#0_0@0|)))) (and (=> (= (ControlFlow 0 37) (- 0 40)) ($IsAlloc refType this@@4 Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|)) (=> ($IsAlloc refType this@@4 Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|) (and (=> (= (ControlFlow 0 37) (- 0 39)) ($IsAlloc refType |p#0_0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|)) (=> ($IsAlloc refType |p#0_0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|) (=> (and (= |b$reqreads#0_0@0| (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#0_0@0| $o@@7) alloc)))) (= $o@@7 this@@4)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0_0@0| $o@@7 $f@@1)))
 :qid |gitissue1163dfy.49:45|
 :skolemid |505|
))) (|_module.MyClass.R#canCall| |$Heap_at_$lambdaHeap#0_0@0| this@@4 |p#0_0@0|)) (and (=> (= (ControlFlow 0 37) (- 0 38)) |b$reqreads#0_0@0|) (=> |b$reqreads#0_0@0| (=> (= |lambdaResult#0_0| (LitInt 5)) (=> (and ($Is intType (int_2_U |lambdaResult#0_0|) TInt) (= (ControlFlow 0 37) 36)) anon4_correct))))))))))))
...
(let ((anon19_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (and ($Is refType null Tclass._module.MyClass) (= (_module.MyClass.R $Heap@@2 this@@4 null) null)) (exists ((|p#1_1_1_0_0| T@U) ) (!  (and ($Is refType |p#1_1_1_0_0| Tclass._module.MyClass) (= (_module.MyClass.R $Heap@@2 this@@4 |p#1_1_1_0_0|) |p#1_1_1_0_0|))
 :qid |gitissue1163dfy.55:30|
 :skolemid |509|
)))) (=> (or (and ($Is refType null Tclass._module.MyClass) (= (_module.MyClass.R $Heap@@2 this@@4 null) null)) (exists ((|p#1_1_1_0_0@@0| T@U) ) (!  (and ($Is refType |p#1_1_1_0_0@@0| Tclass._module.MyClass) (= (_module.MyClass.R $Heap@@2 this@@4 |p#1_1_1_0_0@@0|) |p#1_1_1_0_0@@0|))
 :qid |gitissue1163dfy.55:30|
 :skolemid |509|
))) (=> (and (and ($Is refType |p#1_1_1_0_1@0| Tclass._module.MyClass) ($IsAlloc refType |p#1_1_1_0_1@0| Tclass._module.MyClass $Heap@@2)) (= (_module.MyClass.R $Heap@@2 this@@4 |p#1_1_1_0_1@0|) |p#1_1_1_0_1@0|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |p#1_1_1_0_1@0| null)) (not true))) (=> (or (not (= |p#1_1_1_0_1@0| null)) (not true)) (=> (= (ControlFlow 0 8) (- 0 7)) ($IsAlloc refType |p#1_1_1_0_1@0| Tclass._module.MyClass $Heap@@2)))))))))
