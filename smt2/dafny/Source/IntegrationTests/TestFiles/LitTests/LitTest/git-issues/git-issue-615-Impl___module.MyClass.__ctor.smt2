...
(assert (distinct alloc Tagclass._System.object? Tagclass._System.object Tagclass._module.MyClass? Tagclass._module.MyClass tytagFamily$object tytagFamily$MyClass)
)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |r#0| Tclass._System.object) ($IsAlloc refType |r#0| Tclass._System.object $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
