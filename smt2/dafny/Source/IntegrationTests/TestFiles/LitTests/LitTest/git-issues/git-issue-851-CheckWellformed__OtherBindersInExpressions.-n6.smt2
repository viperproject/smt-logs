...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (=> (and (and (= |let#0#0#0| (exists ((|c#3| T@U) )  (and ($IsBox |c#3| Tclass.OtherBindersInExpressions.C) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) ($Is boolType (bool_2_U |let#0#0#0|) TBool)) (and (= |b#Z#0@0| |let#0#0#0|) (= (ControlFlow 0 3) (- 0 2)))) (or (not (= (LitInt 0) 0)) (not true)))))
