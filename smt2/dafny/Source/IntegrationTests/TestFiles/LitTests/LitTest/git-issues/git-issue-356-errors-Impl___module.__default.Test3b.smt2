...
(set-info :boogie-vc-id Impl$$_module.__default.Test3b)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (>= |r#0| (LitReal 0.0)) (= (ControlFlow 0 4) 2))) anon0_correct)))
