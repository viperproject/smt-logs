...
function Regression.__default.k() : int
uses {
// _default.k: Type axiom
axiom 0 < $FunctionContextHeight ==> $Is(Regression.__default.k(), TInt);
}

// _default.k: Allocation axiom
axiom 0 < $FunctionContextHeight
   ==> (forall $h: Heap :: 
    { $IsAlloc(Regression.__default.k(), TInt, $h) } 
    $IsGoodHeap($h) ==> $IsAlloc(Regression.__default.k(), TInt, $h));

procedure {:verboseName "Regression.GoodUint32 (well-formedness)"} CheckWellFormed$$Regression.GoodUint32(i#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Regression.GoodUint32 (well-formedness)"} CheckWellFormed$$Regression.GoodUint32(i#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype GoodUint32
    ...
    if (*)
    {
        ...
        if (LitInt(0) <= i#0)
        {
            assert {:id "id101"} 0 <= LitInt(2 + 1 - 1)
               && LitInt(2 + 1 - 1)
                 < Seq#Length(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(97))), $Box(char#FromInt(98))), 
                                  $Box(char#FromInt(99))), 
                      ...
                      $Box(char#FromInt(105)))));
            if ($Unbox(Seq#Index(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(97))), $Box(char#FromInt(98))), 
                                  $Box(char#FromInt(99))), 
                                $Box(char#FromInt(114))), 
                              $Box(char#FromInt(105))), 
                            $Box(char#FromInt(109))), 
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id103"} {:subsumption 0} LitInt(0) <= LitInt(0);
...
function Tclass.Regression.GoodUint32() : Ty
uses {
// Tclass.Regression.GoodUint32 Tag
axiom Tag(Tclass.Regression.GoodUint32()) == Tagclass.Regression.GoodUint32
   && TagFamily(Tclass.Regression.GoodUint32()) == tytagFamily$GoodUint32;
}

const unique Tagclass.Regression.GoodUint32: TyTag;

// Box/unbox axiom for Tclass.Regression.GoodUint32
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.Regression.GoodUint32()) } 
  $IsBox(bx, Tclass.Regression.GoodUint32())
     ==> $Box($Unbox(bx): int) == bx
       && $Is($Unbox(bx): int, Tclass.Regression.GoodUint32()));

// $Is axiom for newtype Regression.GoodUint32
axiom (forall i#0: int :: 
  { $Is(i#0, Tclass.Regression.GoodUint32()) } 
  $Is(i#0, Tclass.Regression.GoodUint32())
     <==> LitInt(0) <= i#0
       && i#0
         < (if $Unbox(Seq#Index(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(97))), $Box(char#FromInt(98))), 
...
// $IsAlloc axiom for newtype Regression.GoodUint32
axiom (forall i#0: int, $h: Heap :: 
  { $IsAlloc(i#0, Tclass.Regression.GoodUint32(), $h) } 
  $IsAlloc(i#0, Tclass.Regression.GoodUint32(), $h));

const unique class.Regression.GoodUint32: ClassName;

procedure {:verboseName "Regression.NotUint32 (well-formedness)"} CheckWellFormed$$Regression.NotUint32(i#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Regression.NotUint32 (well-formedness)"} CheckWellFormed$$Regression.NotUint32(i#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype NotUint32
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        ...
        if (LitInt(0) <= i#0)
        {
            assert {:id "id105"} 0 <= 2 + 1 - 1 + Regression.__default.k()
               && 2 + 1 - 1 + Regression.__default.k()
                 < Seq#Length(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(97))), $Box(char#FromInt(98))), 
                                  $Box(char#FromInt(99))), 
                                $Box(char#FromInt(114))), 
                              $Box(char#FromInt(105))), 
            ...
            if ($Unbox(Seq#Index(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(97))), $Box(char#FromInt(98))), 
                        ...
                        $Box(char#FromInt(110))), 
                      $Box(char#FromInt(105)))), 
                  2 + 1 - 1 + Regression.__default.k())): char
               == Lit(char#FromInt(99)))
            {
            }
            else
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id107"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id108"} {:subsumption 0} 0
           < (if $Unbox(Seq#Index(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(97))), $Box(char#FromInt(98))), 
                                  $Box(char#FromInt(99))), 
                                $Box(char#FromInt(114))), 
                              $Box(char#FromInt(105))), 
...
function Tclass.Regression.NotUint32() : Ty
uses {
// Tclass.Regression.NotUint32 Tag
axiom Tag(Tclass.Regression.NotUint32()) == Tagclass.Regression.NotUint32
   && TagFamily(Tclass.Regression.NotUint32()) == tytagFamily$NotUint32;
}

const unique Tagclass.Regression.NotUint32: TyTag;

// Box/unbox axiom for Tclass.Regression.NotUint32
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.Regression.NotUint32()) } 
  $IsBox(bx, Tclass.Regression.NotUint32())
     ==> $Box($Unbox(bx): int) == bx
       && $Is($Unbox(bx): int, Tclass.Regression.NotUint32()));

// $Is axiom for newtype Regression.NotUint32
axiom (forall i#0: int :: 
  { $Is(i#0, Tclass.Regression.NotUint32()) } 
  $Is(i#0, Tclass.Regression.NotUint32())
     <==> LitInt(0) <= i#0
       && i#0
         < (if $Unbox(Seq#Index(Lit(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Build(Seq#Empty(): Seq, $Box(char#FromInt(97))), $Box(char#FromInt(98))), 
...
// $IsAlloc axiom for newtype Regression.NotUint32
axiom (forall i#0: int, $h: Heap :: 
  { $IsAlloc(i#0, Tclass.Regression.NotUint32(), $h) } 
  $IsAlloc(i#0, Tclass.Regression.NotUint32(), $h));

const unique class.Regression.NotUint32: ClassName;
...
const unique tytagFamily$GoodUint32: TyTagFamily;

const unique tytagFamily$NotUint32: TyTagFamily;
