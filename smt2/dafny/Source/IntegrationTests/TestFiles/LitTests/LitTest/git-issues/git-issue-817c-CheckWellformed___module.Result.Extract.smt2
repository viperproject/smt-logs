...
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) ($IsAllocBox ($Box DatatypeTypeType this@@5) (Tclass._module.Result _module.Result$T@@15) $Heap@@0)) (and (|_module.Result.IsFailure#canCall| _module.Result$T@@15 this@@5) (not (_module.Result.IsFailure _module.Result$T@@15 this@@5)))) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
