// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-286.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-286-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-286.dfy
...
axiom (forall a#16#0#0: Box :: 
  ...
  DatatypeCtorId(#_module.Option.Some(a#16#0#0)) == ##_module.Option.Some);
}
...
axiom (forall d: DatatypeType :: 
  { _module.Option.Some_q(d) } 
  _module.Option.Some_q(d)
     ==> (exists a#17#0#0: Box :: d == #_module.Option.Some(a#17#0#0)));

// Constructor $Is
axiom (forall _module.Option$T: Ty, a#18#0#0: Box :: 
  { $Is(#_module.Option.Some(a#18#0#0), Tclass._module.Option(_module.Option$T)) } 
  $Is(#_module.Option.Some(a#18#0#0), Tclass._module.Option(_module.Option$T))
     <==> $IsBox(a#18#0#0, _module.Option$T));

// Constructor $IsAlloc
axiom (forall _module.Option$T: Ty, a#18#0#0: Box, $h: Heap :: 
  { $IsAlloc(#_module.Option.Some(a#18#0#0), Tclass._module.Option(_module.Option$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Option.Some(a#18#0#0), Tclass._module.Option(_module.Option$T), $h)
       <==> $IsAllocBox(a#18#0#0, _module.Option$T, $h)));
...
axiom (forall a#19#0#0: Box :: 
  { #_module.Option.Some(Lit(a#19#0#0)) } 
  #_module.Option.Some(Lit(a#19#0#0)) == Lit(#_module.Option.Some(a#19#0#0)));

function _module.Option.t(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#20#0#0: Box :: 
  { #_module.Option.Some(a#20#0#0) } 
  _module.Option.t(#_module.Option.Some(a#20#0#0)) == a#20#0#0);

// Inductive rank
axiom (forall a#21#0#0: Box :: 
  { #_module.Option.Some(a#21#0#0) } 
  BoxRank(a#21#0#0) < DtRank(#_module.Option.Some(a#21#0#0)));
...
procedure {:verboseName "C.m (well-formedness)"} CheckWellFormed$$_module.C.m(this: ref
    ...
    x#0: DatatypeType
       where $Is(x#0, Tclass._module.Option(TBool))
         && $IsAlloc(x#0, Tclass._module.Option(TBool), $Heap)
         && $IsA#_module.Option(x#0));
...
function Tclass._module.D?(Ty) : Ty;

const unique Tagclass._module.D?: TyTag;

// Tclass._module.D? Tag
axiom (forall _module.D$T: Ty :: 
  { Tclass._module.D?(_module.D$T) } 
  Tag(Tclass._module.D?(_module.D$T)) == Tagclass._module.D?
     && TagFamily(Tclass._module.D?(_module.D$T)) == tytagFamily$D);

function Tclass._module.D?_0(Ty) : Ty;

// Tclass._module.D? injectivity 0
axiom (forall _module.D$T: Ty :: 
  { Tclass._module.D?(_module.D$T) } 
  Tclass._module.D?_0(Tclass._module.D?(_module.D$T)) == _module.D$T);

// Box/unbox axiom for Tclass._module.D?
axiom (forall _module.D$T: Ty, bx: Box :: 
  { $IsBox(bx, Tclass._module.D?(_module.D$T)) } 
  $IsBox(bx, Tclass._module.D?(_module.D$T))
     ==> $Box($Unbox(bx): ref) == bx
       && $Is($Unbox(bx): ref, Tclass._module.D?(_module.D$T)));

// $Is axiom for class D
axiom (forall _module.D$T: Ty, $o: ref :: 
  { $Is($o, Tclass._module.D?(_module.D$T)) } 
  $Is($o, Tclass._module.D?(_module.D$T))
     <==> $o == null || dtype($o) == Tclass._module.D?(_module.D$T));

// $IsAlloc axiom for class D
axiom (forall _module.D$T: Ty, $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass._module.D?(_module.D$T), $h) } 
  $IsAlloc($o, Tclass._module.D?(_module.D$T), $h)
     <==> $o == null || $Unbox(read($h, $o, alloc)): bool);
...
function Tclass._module.D_0(Ty) : Ty;

// Tclass._module.D injectivity 0
axiom (forall _module.D$T: Ty :: 
  { Tclass._module.D(_module.D$T) } 
  Tclass._module.D_0(Tclass._module.D(_module.D$T)) == _module.D$T);
...
procedure {:verboseName "D.mm (well-formedness)"} CheckWellFormed$$_module.D.mm(_module.D$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass._module.D(_module.D$T))
         && $IsAlloc(this, Tclass._module.D(_module.D$T), $Heap), 
    x#0: DatatypeType
...
procedure {:verboseName "D.mm (call)"} Call$$_module.D.mm(_module.D$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass._module.D(_module.D$T))
...
procedure {:verboseName "D.mm (correctness)"} Impl$$_module.D.mm(_module.D$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass._module.D(_module.D$T))
...
axiom (forall _module.D$T: Ty, c#0: ref :: 
  { $Is(c#0, Tclass._module.D(_module.D$T)) } 
    { $Is(c#0, Tclass._module.D?(_module.D$T)) } 
  $Is(c#0, Tclass._module.D(_module.D$T))
     <==> $Is(c#0, Tclass._module.D?(_module.D$T)) && c#0 != null);

// $IsAlloc axiom for non-null type _module.D
axiom (forall _module.D$T: Ty, c#0: ref, $h: Heap :: 
  { $IsAlloc(c#0, Tclass._module.D(_module.D$T), $h) } 
    { $IsAlloc(c#0, Tclass._module.D?(_module.D$T), $h) } 
  $IsAlloc(c#0, Tclass._module.D(_module.D$T), $h)
     <==> $IsAlloc(c#0, Tclass._module.D?(_module.D$T), $h));
