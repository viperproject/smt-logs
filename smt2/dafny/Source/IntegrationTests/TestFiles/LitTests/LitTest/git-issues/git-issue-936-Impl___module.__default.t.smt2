...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.Status.Failure_q |r#0@2|) (= |z#0@2| (LitInt 0)))) (=> (=> (_module.Status.Failure_q |r#0@2|) (= |z#0@2| (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (not (_module.Status.Failure_q |r#0@2|)) (= |z#0@2| (LitInt 42))))))))
