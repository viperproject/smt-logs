...
(set-info :boogie-vc-id Impl$$_module.__default.TestAOK)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is charType |ch#0| TChar) true)) (and (and (= 0 $FunctionContextHeight) (|ORD#IsNat| |o#0|)) (and (< (|ORD#Offset| |o#0|) 65536) (= (ControlFlow 0 4) 2)))) anon0_correct)))
