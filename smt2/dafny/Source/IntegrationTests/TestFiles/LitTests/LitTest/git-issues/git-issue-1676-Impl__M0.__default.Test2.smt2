...
(set-info :boogie-vc-id Impl$$M0.__default.Test2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (= |newtype$check#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= (LitInt 0) |newtype$check#1@0|)) (=> (<= (LitInt 0) |newtype$check#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))))))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is intType ($Unbox intType (|Seq#Index| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))) (LitInt 1))) Tclass._System.nat)) (=> ($Is intType ($Unbox intType (|Seq#Index| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))) (LitInt 1))) Tclass._System.nat) (=> (= |v#0@0| (U_2_int ($Unbox intType (|Seq#Index| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))) (LitInt 1))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |v#0@0| (LitInt (- 0 1)))) (=> (= |v#0@0| (LitInt (- 0 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (>= |v#0@0| (LitInt 0))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |v#0|) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 2))) anon0_correct))))
