...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |n#0@@3| |n#0@@3|)) (=> (<= |n#0@@3| |n#0@@3|) (=> (= P_$_ReadsFrame@0 (|lambda#0| null $Heap@@3 alloc this@@3 (ite (= |n#0@@3| (LitInt 0)) |Set#Empty| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@8 T@U) ($f@@0 T@U) )  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@8) alloc)))) (or (= $o@@8 this@@3) (|Set#IsMember| (ite (= |n#0@@3| (LitInt 0)) |Set#Empty| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1))) ($Box refType $o@@8)))) (or (= $o@@8 this@@3) (|Set#IsMember| (ite (= |n#0@@3| (LitInt 0)) |Set#Empty| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1))) ($Box refType $o@@8)))))) (=> (forall (($o@@9 T@U) ($f@@1 T@U) )  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@9) alloc)))) (or (= $o@@9 this@@3) (|Set#IsMember| (ite (= |n#0@@3| (LitInt 0)) |Set#Empty| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1))) ($Box refType $o@@9)))) (or (= $o@@9 this@@3) (|Set#IsMember| (ite (= |n#0@@3| (LitInt 0)) |Set#Empty| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1))) ($Box refType $o@@9))))) (=> (and (and (=> (> |n#0@@3| 0) (|Set#Subset| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1)) (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 |n#0@@3|))) (= (ControlFlow 0 2) (- 0 1))) (> |n#0@@3| 0)) (|Set#Subset| (_module.P.ReprFamily ($LS ($LS $LZ)) $Heap@@3 this@@3 (- |n#0@@3| 1)) (_module.P.ReprFamily ($LS ($LS $LZ)) $Heap@@3 this@@3 |n#0@@3|))))))))))
