...
(set-info :boogie-vc-id Impl$$M0.__default.Test0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon3_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@3|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@3|))) (=> (= |x##0@0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@3| (LitInt 0))))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (<= (LitInt 0) |x##0@0|) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0@3|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0@3|))) (=> (= |x##1@0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@3| (LitInt 1))))) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (<= (LitInt 0) |x##1@0|) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt (- 0 1)))) (=> (<= (LitInt 0) (LitInt (- 0 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U false))))))))))))))))
(let ((anon4_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) ($Is SeqType (|Seq#Append| |b#0@0| |a#0@0|) (TSeq Tclass._System.nat))) (=> ($Is SeqType (|Seq#Append| |b#0@0| |a#0@0|) (TSeq Tclass._System.nat)) (=> (= |s#0@2| (|Seq#Append| |b#0@0| |a#0@0|)) (=> (and (= |s#0@3| |s#0@2|) (= (ControlFlow 0 8) 2)) anon3_correct))))))
(let ((anon4_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) ($Is SeqType (|Seq#Append| |a#0@0| |b#0@0|) (TSeq Tclass._System.nat))) (=> ($Is SeqType (|Seq#Append| |a#0@0| |b#0@0|) (TSeq Tclass._System.nat)) (=> (= |s#0@1| (|Seq#Append| |a#0@0| |b#0@0|)) (=> (and (= |s#0@3| |s#0@1|) (= (ControlFlow 0 6) 2)) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 10) (- 0 11)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (and (= |a#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))))) (= |b#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))))) (and ($Is SeqType |s#0@0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |s#0@0| (TSeq Tclass._System.nat) $Heap))) (and (=> (= (ControlFlow 0 10) 6) anon4_Then_correct) (=> (= (ControlFlow 0 10) 8) anon4_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is SeqType |a#0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |a#0| (TSeq Tclass._System.nat) $Heap)) true) (and (and ($Is SeqType |b#0| (TSeq TInt)) ($IsAlloc SeqType |b#0| (TSeq TInt) $Heap)) true)) (and (and (and ($Is SeqType |s#0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |s#0| (TSeq Tclass._System.nat) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 10)))) anon0_correct))))
