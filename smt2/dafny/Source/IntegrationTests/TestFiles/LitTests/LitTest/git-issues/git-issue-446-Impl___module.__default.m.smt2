...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@0|))) (=> (=> (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (<= (LitInt 0) |i#0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |r#0@0|))) |i#0|))) (=> (=> (<= (LitInt 0) |i#0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |r#0@0|))) |i#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (<= (LitInt 0) |i#0|) (= |o#0@0| (+ |i#0| |i#0|)))) (=> (=> (<= (LitInt 0) |i#0|) (= |o#0@0| (+ |i#0| |i#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< |i#0| 0) (_module.Result.Failure_q |r#0@0|))) (=> (=> (< |i#0| 0) (_module.Result.Failure_q |r#0@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< |i#0| 0) (= |o#0@0| (+ |i#0| |i#0|))))))))))))))
(let ((anon5_Else_correct  (=> (and (<= 0 |i#0|) (= |$rhs#0@0| (|#_module.Result.Success| ($Box intType (int_2_U |i#0|))))) (=> (and (and (= |$rhs#1@0| (+ |i#0| |i#0|)) (= |r#0@0| |$rhs#0@0|)) (and (= |o#0@0| |$rhs#1@0|) (= (ControlFlow 0 8) 2))) GeneratedUnifiedExit_correct))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
