...
(set-info :boogie-vc-id CheckWellFormed$$M3.MyOrdinal)
...
(let ((anon8_Else_correct  (=> (and (not (or (= (|ORD#FromNat| 1000) |o#0|) (|ORD#Less| (|ORD#FromNat| 1000) |o#0|))) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (or (= (|ORD#FromNat| 1000) |o#0|) (|ORD#Less| (|ORD#FromNat| 1000) |o#0|)) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= (|ORD#FromNat| 1000) (|ORD#FromNat| 1001)) (|ORD#Less| (|ORD#FromNat| 1000) (|ORD#FromNat| 1001)))) (=> (= (ControlFlow 0 2) (- 0 1)) (|ORD#Less| (|ORD#FromNat| 1001) (|ORD#FromNat| 1200))))))
