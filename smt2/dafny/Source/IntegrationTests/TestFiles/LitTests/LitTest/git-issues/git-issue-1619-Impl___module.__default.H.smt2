...
(declare-fun _module._default.H$U () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (=> |defass#u#0| (and ($IsBox |u#0@0| _module._default.H$U) ($IsAllocBox |u#0@0| _module._default.H$U $Heap))) (= (ControlFlow 0 2) (- 0 1))) |defass#u#0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#u#0| (and ($IsBox |u#0| _module._default.H$U) ($IsAllocBox |u#0| _module._default.H$U $Heap))) true)) (=> (and (and (and ($IsBox |uu#0| _module._default.H$U) ($IsAllocBox |uu#0| _module._default.H$U $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
