...
(assert (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) Tclass._module.Iter?)) ($Is refType (_module.Iter.c $o@@11) Tclass._module.C?))
 :qid |unknown.0:0|
 :skolemid |551|
 :pattern ( (_module.Iter.c $o@@11))
)))
(assert (forall (($o@@12 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass._module.Iter?)) ($Is refType (_module.Iter.d $o@@12) Tclass._module.C?))
 :qid |unknown.0:0|
 :skolemid |553|
 :pattern ( (_module.Iter.d $o@@12))
)))
(assert (forall (($o@@13 T@U) ) (!  (=> (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass._module.Iter?)) ($Is refType (_module.Iter.__decreases0 $o@@13) Tclass._module.C?))
 :qid |unknown.0:0|
 :skolemid |561|
 :pattern ( (_module.Iter.__decreases0 $o@@13))
)))
(assert (forall (($o@@14 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass._module.Iter?)) ($Is refType (_module.Iter.__decreases1 $o@@14) Tclass._module.C?))
 :qid |unknown.0:0|
 :skolemid |563|
 :pattern ( (_module.Iter.__decreases1 $o@@14))
)))
...
(assert (forall (($h@@9 T@U) ($o@@15 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@15 null)) (not true)) (= (dtype $o@@15) Tclass._module.Iter?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@15) alloc)))) ($IsAlloc refType (_module.Iter.c $o@@15) Tclass._module.C? $h@@9))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |552|
 :pattern ( (_module.Iter.c $o@@15) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@15) alloc)))
)))
(assert (forall (($h@@10 T@U) ($o@@16 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@16 null)) (not true)) (= (dtype $o@@16) Tclass._module.Iter?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@16) alloc)))) ($IsAlloc refType (_module.Iter.d $o@@16) Tclass._module.C? $h@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |554|
 :pattern ( (_module.Iter.d $o@@16) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@16) alloc)))
)))
(assert (forall (($h@@11 T@U) ($o@@17 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@17 null)) (not true)) (= (dtype $o@@17) Tclass._module.Iter?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@17) alloc)))) ($IsAlloc refType (_module.Iter.__decreases0 $o@@17) Tclass._module.C? $h@@11))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |562|
 :pattern ( (_module.Iter.__decreases0 $o@@17) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@17) alloc)))
)))
(assert (forall (($h@@12 T@U) ($o@@18 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@18 null)) (not true)) (= (dtype $o@@18) Tclass._module.Iter?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@18) alloc)))) ($IsAlloc refType (_module.Iter.__decreases1 $o@@18) Tclass._module.C? $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |564|
 :pattern ( (_module.Iter.__decreases1 $o@@18) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@18) alloc)))
)))
...
(assert (= (Tag Tclass._module.Iter) Tagclass._module.Iter))
(assert (= (TagFamily Tclass._module.Iter) tytagFamily$Iter))
(assert (forall (($o@@19 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (= (dtype $o@@19) Tclass._module.Iter?)) ($Is SetType (_module.Iter.__reads $o@@19) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( (_module.Iter.__reads $o@@19))
)))
(assert (forall (($o@@20 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (= (dtype $o@@20) Tclass._module.Iter?)) ($Is SetType (_module.Iter.__modifies $o@@20) (TSet Tclass._System.object?)))
 :qid |unknown.0:0|
 :skolemid |557|
 :pattern ( (_module.Iter.__modifies $o@@20))
)))
...
(declare-fun |d#0| () T@U)
(declare-fun |_module.Iter.Valid#canCall| (T@U T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.Iter.__ctor)
...
)) ($HeapSucc $Heap $Heap@0))) (=> (and (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass._module.Iter) ($IsAlloc refType this@0 Tclass._module.Iter $Heap@0))) (= (_module.Iter.c this@0) |c#0@@5|)) (and (and (= (_module.Iter.d this@0) |d#0|) ($IsAllocBox ($Box refType this@0) Tclass._module.Iter? $Heap@0)) (and (|_module.Iter.Valid#canCall| $Heap@0 this@0) (_module.Iter.Valid $Heap@0 this@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |d#0| null)) (not true))) (=> (or (not (= |d#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType |d#0| Tclass._module.C? $Heap)) (=> ($IsAlloc refType |d#0| Tclass._module.C? $Heap) (=> (|Set#Equal| (_module.Iter.__reads this@0) (|Set#UnionOne| |Set#Empty| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |d#0|) _module.C.more))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |c#0@@5| Tclass._module.C? $Heap))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |c#0@@5| Tclass._module.C?) ($IsAlloc refType |c#0@@5| Tclass._module.C? $Heap))) (and (and ($Is refType |d#0| Tclass._module.C?) ($IsAlloc refType |d#0| Tclass._module.C? $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct)))
