...
(assert (forall ((v@@0 T@U) (t0@@0 T@U) ) (! (= ($Is MultiSetType v@@0 (TMultiSet t0@@0)) (forall ((bx T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| v@@0 bx)) ($IsBox bx t0@@0))
 :qid |DafnyPreludebpl.248:11|
 :skolemid |50|
 :pattern ( (|MultiSet#Multiplicity| v@@0 bx))
)))
...
(assert (forall ((bx@@2 T@U) (t@@2 T@U) ) (!  (=> ($IsBox bx@@2 (TMultiSet t@@2)) (and (= ($Box MultiSetType ($Unbox MultiSetType bx@@2)) bx@@2) ($Is MultiSetType ($Unbox MultiSetType bx@@2) (TMultiSet t@@2))))
 :qid |DafnyPreludebpl.201:15|
 :skolemid |34|
 :pattern ( ($IsBox bx@@2 (TMultiSet t@@2)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.multiset2)
...
(let ((anon9_Else_correct  (=> (and (=> (> (|MultiSet#Multiplicity| |s#0| ($Box intType (int_2_U |n#0@0|))) 0) (= (|MultiSet#Multiplicity| |s#0| ($Box intType (int_2_U |n#0@0|))) (LitInt 2))) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (> (|MultiSet#Multiplicity| |s#0| ($Box intType (int_2_U |n#0@0|))) 0) (=> (and (= (|MultiSet#Multiplicity| |s#0| ($Box intType (int_2_U |n#0@0|))) (LitInt 2)) (= (ControlFlow 0 4) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> ($Is MultiSetType |s#0| (TMultiSet TInt)) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|n#2| Int) ) (! true
