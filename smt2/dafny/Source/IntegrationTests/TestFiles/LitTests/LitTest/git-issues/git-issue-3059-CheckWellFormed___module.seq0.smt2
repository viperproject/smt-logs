...
(set-info :boogie-vc-id CheckWellFormed$$_module.seq0)
...
(let ((anon9_Else_correct  (=> (and (=> (|Seq#Contains| |s#0| ($Box intType (int_2_U |n#0@0|))) (= |n#0@0| (LitInt 0))) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Seq#Contains| |s#0| ($Box intType (int_2_U |n#0@0|))) (=> (and (= |n#0@0| (LitInt 0)) (= (ControlFlow 0 4) 3)) anon5_correct))))
(let ((anon8_Then_correct  (=> ($Is SeqType |s#0| (TSeq TInt)) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|n#2| Int) ) (!  (=> (|Seq#Contains| |Seq#Empty| ($Box intType (int_2_U |n#2|))) (= |n#2| (LitInt 0)))
