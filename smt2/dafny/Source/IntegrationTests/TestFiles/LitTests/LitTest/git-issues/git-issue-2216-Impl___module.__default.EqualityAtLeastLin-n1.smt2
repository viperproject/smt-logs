...
(set-info :boogie-vc-id Impl$$_module.__default.EqualityAtLeastLinear)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |s0#0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) |s#0|)) (= |s1#0@0| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) |s#0|))) (and (= |i#0#lo@0| (LitInt 0)) (= |i#0#hi@0| _module.__default.REPEAT))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= |i#0#lo@0| |i#0#hi@0|)) (=> (<= |i#0#lo@0| |i#0#hi@0|) (=> (= (ControlFlow 0 8) 7) anon6_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap))) (and (and ($Is SeqType |s0#0| (TSeq TInt)) ($IsAlloc SeqType |s0#0| (TSeq TInt) $Heap)) true)) (and (and (and ($Is SeqType |s1#0| (TSeq TInt)) ($IsAlloc SeqType |s1#0| (TSeq TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 8)))) anon0_correct)))
