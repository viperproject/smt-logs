...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass._module.ClassA Tagclass._module.Tr2? Tagclass._module.Tr2 Tagclass._module.ClassA? tytagFamily$array tytagFamily$ClassA tytagFamily$Tr2)
)
...
(assert (forall ((_System.array$arg T@U) ($o@@3 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) (Tclass._System.array? _System.array$arg))) ($Is intType (int_2_U (_System.array.Length $o@@3)) TInt))
 :qid |unknown.0:0|
 :skolemid |363|
 :pattern ( (_System.array.Length $o@@3) (Tclass._System.array? _System.array$arg))
)))
...
(assert (forall ((_module.ClassA$Q@@0 T@U) ($o@@5 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@5 (Tclass._module.ClassA? _module.ClassA$Q@@0) $h@@4)  (or (= $o@@5 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) alloc)))))
 :qid |unknown.0:0|
 :skolemid |510|
 :pattern ( ($IsAlloc refType $o@@5 (Tclass._module.ClassA? _module.ClassA$Q@@0) $h@@4))
)))
...
(assert (forall ((_module.ClassA$Q@@2 T@U) ($o@@6 T@U) ) (!  (=> ($Is refType $o@@6 (Tclass._module.ClassA? _module.ClassA$Q@@2)) ($Is refType $o@@6 (Tclass._module.Tr2? _module.ClassA$Q@@2 (Tclass._System.array (TBitvector 8)))))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($Is refType $o@@6 (Tclass._module.ClassA? _module.ClassA$Q@@2)))
)))
...
(assert (forall ((_System.array$arg@@5 T@U) ($o@@7 T@U) ) (! (= ($Is refType $o@@7 (Tclass._System.array? _System.array$arg@@5))  (or (= $o@@7 null) (= (dtype $o@@7) (Tclass._System.array? _System.array$arg@@5))))
 :qid |unknown.0:0|
 :skolemid |361|
 :pattern ( ($Is refType $o@@7 (Tclass._System.array? _System.array$arg@@5)))
)))
(assert (forall ((_module.ClassA$Q@@7 T@U) ($o@@8 T@U) ) (! (= ($Is refType $o@@8 (Tclass._module.ClassA? _module.ClassA$Q@@7))  (or (= $o@@8 null) (= (dtype $o@@8) (Tclass._module.ClassA? _module.ClassA$Q@@7))))
 :qid |unknown.0:0|
 :skolemid |509|
 :pattern ( ($Is refType $o@@8 (Tclass._module.ClassA? _module.ClassA$Q@@7)))
)))
(assert (forall ((_module.Tr2$W@@5 T@U) (_module.Tr2$Y@@5 T@U) ($o@@9 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@9 (Tclass._module.Tr2? _module.Tr2$W@@5 _module.Tr2$Y@@5) $h@@6)  (or (= $o@@9 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) alloc)))))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($IsAlloc refType $o@@9 (Tclass._module.Tr2? _module.Tr2$W@@5 _module.Tr2$Y@@5) $h@@6))
)))
...
(assert (forall ((_module.ClassA$Q@@9 T@U) ($o@@10 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@10 (Tclass._module.ClassA? _module.ClassA$Q@@9) $heap) ($IsAlloc refType $o@@10 (Tclass._module.Tr2? _module.ClassA$Q@@9 (Tclass._System.array (TBitvector 8))) $heap))
 :qid |unknown.0:0|
 :skolemid |520|
 :pattern ( ($IsAlloc refType $o@@10 (Tclass._module.ClassA? _module.ClassA$Q@@9) $heap))
)))
...
(assert (forall ((_module.Tr2$W@@10 T@U) (_module.Tr2$Y@@10 T@U) ($o@@11 T@U) ) (! (= ($Is refType $o@@11 (Tclass._module.Tr2? _module.Tr2$W@@10 _module.Tr2$Y@@10))  (or (= $o@@11 null) (implements$_module.Tr2 (dtype $o@@11) _module.Tr2$W@@10 _module.Tr2$Y@@10)))
 :qid |unknown.0:0|
 :skolemid |494|
 :pattern ( ($Is refType $o@@11 (Tclass._module.Tr2? _module.Tr2$W@@10 _module.Tr2$Y@@10)))
)))
...
(assert (forall ((_module.Tr2$W@@11 T@U) (_module.Tr2$Y@@11 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.Tr2? _module.Tr2$W@@11 _module.Tr2$Y@@11)) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) (Tclass._module.Tr2? _module.Tr2$W@@11 _module.Tr2$Y@@11))))
 :qid |unknown.0:0|
 :skolemid |493|
 :pattern ( ($IsBox bx@@3 (Tclass._module.Tr2? _module.Tr2$W@@11 _module.Tr2$Y@@11)))
)))
(assert (forall ((_module.Tr2$W@@12 T@U) (_module.Tr2$Y@@12 T@U) (bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 (Tclass._module.Tr2 _module.Tr2$W@@12 _module.Tr2$Y@@12)) (and (= ($Box refType ($Unbox refType bx@@4)) bx@@4) ($Is refType ($Unbox refType bx@@4) (Tclass._module.Tr2 _module.Tr2$W@@12 _module.Tr2$Y@@12))))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($IsBox bx@@4 (Tclass._module.Tr2 _module.Tr2$W@@12 _module.Tr2$Y@@12)))
)))
...
(assert (forall ((_module.ClassA$Q@@12 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass._module.ClassA _module.ClassA$Q@@12)) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) (Tclass._module.ClassA _module.ClassA$Q@@12))))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($IsBox bx@@8 (Tclass._module.ClassA _module.ClassA$Q@@12)))
)))
(assert (forall ((_module.ClassA$Q@@13 T@U) (bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 (Tclass._module.ClassA? _module.ClassA$Q@@13)) (and (= ($Box refType ($Unbox refType bx@@9)) bx@@9) ($Is refType ($Unbox refType bx@@9) (Tclass._module.ClassA? _module.ClassA$Q@@13))))
 :qid |unknown.0:0|
 :skolemid |508|
 :pattern ( ($IsBox bx@@9 (Tclass._module.ClassA? _module.ClassA$Q@@13)))
)))
...
(declare-fun call0formal@_module.ClassA$Q () T@U)
(declare-fun call0formal@_module.ClassA$Q@0 () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (<= 0 (LitInt 42))) (=> (<= 0 (LitInt 42)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (= (_System.array.Length $nw@0) (LitInt 42)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (or (not (= call3formal@this null)) (not true)) (and ($Is refType call3formal@this (Tclass._module.ClassA call0formal@_module.ClassA$Q)) ($IsAlloc refType call3formal@this (Tclass._module.ClassA call0formal@_module.ClassA$Q) $Heap)))) (and (and (= call0formal@_module.ClassA$Q@0 (Tclass._System.array TInt)) (= |call1formal@q#0@0| ($Box refType $nw@0))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (and (and (or (not (= call3formal@this@0 null)) (not true)) (and ($Is refType call3formal@this@0 (Tclass._module.ClassA call0formal@_module.ClassA$Q@0)) ($IsAlloc refType call3formal@this@0 (Tclass._module.ClassA call0formal@_module.ClassA$Q@0) $Heap@1))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call3formal@this@0) alloc))))) (and (forall (($o@@14 T@U) ) (!  (=> (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@14) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14)))
 :qid |gitissue731bdfy.11:3|
 :skolemid |513|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@14))
)) ($HeapSucc $Heap@0 $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) true) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= call3formal@this@0 null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= ($Unbox refType (_module.Tr2.y (Tclass._System.array TInt) (Tclass._System.array (TBitvector 8)) call3formal@this@0)) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= call3formal@this@0 null)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= ($Unbox refType (_module.Tr2.w (Tclass._System.array TInt) (Tclass._System.array (TBitvector 8)) call3formal@this@0)) null)) (not true)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) true) (and (and (=> |defass#ca#0| (and ($Is refType |ca#0| (Tclass._module.ClassA (Tclass._System.array TInt))) ($IsAlloc refType |ca#0| (Tclass._module.ClassA (Tclass._System.array TInt)) $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 9) 2)))) anon0_correct))))
