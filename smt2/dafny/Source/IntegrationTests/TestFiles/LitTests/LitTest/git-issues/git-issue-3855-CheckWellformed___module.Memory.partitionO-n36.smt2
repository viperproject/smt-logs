...
(assert (distinct TBool TagBool TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.Object Tagclass._module.Region Tagclass._module.Memory Tagclass._module.Memory? Tagclass._module.Object? |##_module.Region.Frozen| |##_module.Region.Heap| |##_module.Region.Stack| |##_module.Region.Frame| |##_module.Region.Isolate| |tytagFamily$_tuple#2| tytagFamily$Object tytagFamily$Region tytagFamily$Memory)
)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@1 T@U) (|os#0@@1| T@U) (|region#0@@0| T@U) ) (!  (=> (or (|_module.Memory.ownedBy#canCall| (Lit refType this@@1) (Lit SetType |os#0@@1|) (Lit DatatypeTypeType |region#0@@0|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.Memory)) ($Is SetType |os#0@@1| (TSet Tclass._module.Object))) ($Is DatatypeTypeType |region#0@@0| Tclass._module.Region)))) (and (forall ((|o#3| T@U) ) (!  (=> ($Is refType |o#3| Tclass._module.Object) (=> (|Set#IsMember| (Lit SetType |os#0@@1|) ($Box refType |o#3|)) (and (|$IsA#_module.Region| (_module.Object.region |o#3|)) (|$IsA#_module.Region| (Lit DatatypeTypeType |region#0@@0|)))))
 :qid |gitissue3855dfy.597:7|
 :skolemid |1175|
 :pattern ( (_module.Object.region |o#3|))
 :pattern ( (|Set#IsMember| |os#0@@1| ($Box refType |o#3|)))
)) (= (_module.Memory.ownedBy (Lit refType this@@1) (Lit SetType |os#0@@1|) (Lit DatatypeTypeType |region#0@@0|)) (|Set#FromBoogieMap| (|lambda#117| Tclass._module.Object (Lit SetType |os#0@@1|) |region#0@@0|)))))
 :qid |gitissue3855dfy.594:10|
 :weight 3
 :skolemid |1176|
 :pattern ( (_module.Memory.ownedBy (Lit refType this@@1) (Lit SetType |os#0@@1|) (Lit DatatypeTypeType |region#0@@0|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@2 T@U) (|os#0@@2| T@U) (|region#0@@1| T@U) ) (!  (=> (or (|_module.Memory.ownedBy#canCall| this@@2 |os#0@@2| |region#0@@1|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.Memory)) ($Is SetType |os#0@@2| (TSet Tclass._module.Object))) ($Is DatatypeTypeType |region#0@@1| Tclass._module.Region)))) (and (forall ((|o#1| T@U) ) (!  (=> ($Is refType |o#1| Tclass._module.Object) (=> (|Set#IsMember| |os#0@@2| ($Box refType |o#1|)) (and (|$IsA#_module.Region| (_module.Object.region |o#1|)) (|$IsA#_module.Region| |region#0@@1|))))
 :qid |gitissue3855dfy.597:7|
 :skolemid |1171|
 :pattern ( (_module.Object.region |o#1|))
 :pattern ( (|Set#IsMember| |os#0@@2| ($Box refType |o#1|)))
)) (= (_module.Memory.ownedBy this@@2 |os#0@@2| |region#0@@1|) (|Set#FromBoogieMap| (|lambda#117| Tclass._module.Object |os#0@@2| |region#0@@1|)))))
 :qid |gitissue3855dfy.594:10|
 :skolemid |1172|
 :pattern ( (_module.Memory.ownedBy this@@2 |os#0@@2| |region#0@@1|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@3 T@U) (|os#0@@3| T@U) (|region#0@@2| T@U) ) (!  (=> (or (|_module.Memory.ownedBy#canCall| this@@3 (Lit SetType |os#0@@3|) (Lit DatatypeTypeType |region#0@@2|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.Memory)) ($Is SetType |os#0@@3| (TSet Tclass._module.Object))) ($Is DatatypeTypeType |region#0@@2| Tclass._module.Region)))) (and (forall ((|o#2| T@U) ) (!  (=> ($Is refType |o#2| Tclass._module.Object) (=> (|Set#IsMember| (Lit SetType |os#0@@3|) ($Box refType |o#2|)) (and (|$IsA#_module.Region| (_module.Object.region |o#2|)) (|$IsA#_module.Region| (Lit DatatypeTypeType |region#0@@2|)))))
 :qid |gitissue3855dfy.597:7|
 :skolemid |1173|
 :pattern ( (_module.Object.region |o#2|))
 :pattern ( (|Set#IsMember| |os#0@@3| ($Box refType |o#2|)))
)) (= (_module.Memory.ownedBy this@@3 (Lit SetType |os#0@@3|) (Lit DatatypeTypeType |region#0@@2|)) (|Set#FromBoogieMap| (|lambda#117| Tclass._module.Object (Lit SetType |os#0@@3|) |region#0@@2|)))))
 :qid |gitissue3855dfy.594:10|
 :weight 3
 :skolemid |1174|
 :pattern ( (_module.Memory.ownedBy this@@3 (Lit SetType |os#0@@3|) (Lit DatatypeTypeType |region#0@@2|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@4 T@U) (|os#0@@4| T@U) ) (!  (=> (or (|_module.Memory.allRegions#canCall| this@@4 |os#0@@4|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.Memory)) ($Is SetType |os#0@@4| (TSet Tclass._module.Object))))) (and (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| |os#0@@4| ($Box refType |o#0@@0|))) (|Set#IsMember| (_module.Memory.allRegions this@@4 |os#0@@4|) ($Box DatatypeTypeType (_module.Object.region |o#0@@0|))))
 :qid |gitissue3855dfy.601:19|
 :skolemid |1180|
 :pattern ( (_module.Object.region |o#0@@0|))
 :pattern ( (|Set#IsMember| |os#0@@4| ($Box refType |o#0@@0|)))
)) ($Is SetType (_module.Memory.allRegions this@@4 |os#0@@4|) (TSet Tclass._module.Region))))
 :qid |gitissue3855dfy.600:10|
 :skolemid |1181|
 :pattern ( (_module.Memory.allRegions this@@4 |os#0@@4|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap T@U) (this@@5 T@U) (|os#0@@5| T@U) (|region#0@@3| T@U) ) (!  (=> (and (or (|_module.Memory.ownedBy#canCall| this@@5 |os#0@@5| |region#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@5 null)) (not true)) ($IsAlloc refType this@@5 Tclass._module.Memory $Heap)) (and ($Is SetType |os#0@@5| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@5| (TSet Tclass._module.Object) $Heap))) (and ($Is DatatypeTypeType |region#0@@3| Tclass._module.Region) ($IsAlloc DatatypeTypeType |region#0@@3| Tclass._module.Region $Heap))))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.Memory.ownedBy this@@5 |os#0@@5| |region#0@@3|) (TSet Tclass._module.Object) $Heap))
 :qid |gitissue3855dfy.594:10|
 :skolemid |1169|
 :pattern ( ($IsAlloc SetType (_module.Memory.ownedBy this@@5 |os#0@@5| |region#0@@3|) (TSet Tclass._module.Object) $Heap))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@6 T@U) (|os#0@@6| T@U) ) (!  (=> (or (|_module.Memory.allRegions#canCall| (Lit refType this@@6) (Lit SetType |os#0@@6|)) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Memory)) ($Is SetType |os#0@@6| (TSet Tclass._module.Object))))) (= (_module.Memory.allRegions (Lit refType this@@6) (Lit SetType |os#0@@6|)) (|Set#FromBoogieMap| (|lambda#122| Tclass._module.Object (Lit SetType |os#0@@6|) |os#0@@6|))))
 :qid |gitissue3855dfy.600:10|
 :weight 3
 :skolemid |1189|
 :pattern ( (_module.Memory.allRegions (Lit refType this@@6) (Lit SetType |os#0@@6|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@7 T@U) (|os#0@@7| T@U) ) (!  (=> (and (or (|_module.Memory.allRegions#canCall| this@@7 |os#0@@7|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@7 null)) (not true)) ($IsAlloc refType this@@7 Tclass._module.Memory $Heap@@0)) (and ($Is SetType |os#0@@7| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@7| (TSet Tclass._module.Object) $Heap@@0))))) ($IsGoodHeap $Heap@@0)) ($IsAlloc SetType (_module.Memory.allRegions this@@7 |os#0@@7|) (TSet Tclass._module.Region) $Heap@@0))
 :qid |gitissue3855dfy.600:10|
 :skolemid |1182|
 :pattern ( ($IsAlloc SetType (_module.Memory.allRegions this@@7 |os#0@@7|) (TSet Tclass._module.Region) $Heap@@0))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@8 T@U) (|os#0@@8| T@U) ) (!  (=> (and (or (|_module.Memory.partitionOfJustHeapRegions#canCall| this@@8 |os#0@@8|) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@8 null)) (not true)) ($IsAlloc refType this@@8 Tclass._module.Memory $Heap@@1)) (and ($Is SetType |os#0@@8| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@8| (TSet Tclass._module.Object) $Heap@@1))))) ($IsGoodHeap $Heap@@1)) ($IsAlloc MapType (_module.Memory.partitionOfJustHeapRegions this@@8 |os#0@@8|) (TMap Tclass._module.Region (TSet Tclass._module.Object)) $Heap@@1))
 :qid |gitissue3855dfy.625:10|
 :skolemid |1219|
 :pattern ( ($IsAlloc MapType (_module.Memory.partitionOfJustHeapRegions this@@8 |os#0@@8|) (TMap Tclass._module.Region (TSet Tclass._module.Object)) $Heap@@1))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@9 T@U) (|os#0@@9| T@U) ) (!  (=> (or (|_module.Memory.partitionOfJustHeapRegions#canCall| this@@9 |os#0@@9|) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.Memory)) ($Is SetType |os#0@@9| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.allRegions#canCall| this@@9 |os#0@@9|) (forall ((|region#0@@4| T@U) ) (!  (=> ($Is DatatypeTypeType |region#0@@4| Tclass._module.Region) (and (|_module.Memory.allRegions#canCall| this@@9 |os#0@@9|) (=> (|Set#IsMember| (_module.Memory.allRegions this@@9 |os#0@@9|) ($Box DatatypeTypeType |region#0@@4|)) (|_module.Memory.ownedBy#canCall| this@@9 |os#0@@9| |region#0@@4|))))
 :qid |gitissue3855dfy.635:7|
 :skolemid |1222|
 :pattern ( (_module.Memory.ownedBy this@@9 |os#0@@9| |region#0@@4|))
 :pattern ( (|Set#IsMember| (_module.Memory.allRegions this@@9 |os#0@@9|) ($Box DatatypeTypeType |region#0@@4|)))
))) (= (_module.Memory.partitionOfJustHeapRegions this@@9 |os#0@@9|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region (_module.Memory.allRegions this@@9 |os#0@@9|))) (|lambda#129| this@@9 |os#0@@9|) (TMap Tclass._module.Region (TSet Tclass._module.Object))))))
 :qid |gitissue3855dfy.625:10|
 :skolemid |1224|
 :pattern ( (_module.Memory.partitionOfJustHeapRegions this@@9 |os#0@@9|))
))))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@3| T@U) (|l#2@@1| T@U) (|l#3| Bool) ($o@@5 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@3| |l#2@@1| |l#3|) $o@@5 $f))  (=> (and (or (not (= $o@@5 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@3| $o@@5) |l#2@@1|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1406|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@3| |l#1@@3| |l#2@@1| |l#3|) $o@@5 $f))
)))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@4| T@U) (|l#2@@2| T@U) (|$y#0@@1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#117| |l#0@@4| |l#1@@4| |l#2@@2|) |$y#0@@1|))  (and ($IsBox |$y#0@@1| |l#0@@4|) (and (|Set#IsMember| |l#1@@4| |$y#0@@1|) (|_module.Region#Equal| (_module.Object.region ($Unbox refType |$y#0@@1|)) |l#2@@2|))))
 :qid |gitissue3855dfy.87:7|
 :skolemid |1424|
 :pattern ( (MapType0Select BoxType boolType (|lambda#117| |l#0@@4| |l#1@@4| |l#2@@2|) |$y#0@@1|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@10 T@U) (|os#0@@10| T@U) ) (!  (=> (or (|_module.Memory.partitionOfJustHeapRegions#canCall| (Lit refType this@@10) (Lit SetType |os#0@@10|)) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.Memory)) ($Is SetType |os#0@@10| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.allRegions#canCall| (Lit refType this@@10) (Lit SetType |os#0@@10|)) (forall ((|region#0@@5| T@U) ) (!  (=> ($Is DatatypeTypeType |region#0@@5| Tclass._module.Region) (and (|_module.Memory.allRegions#canCall| (Lit refType this@@10) (Lit SetType |os#0@@10|)) (=> (|Set#IsMember| (Lit SetType (_module.Memory.allRegions (Lit refType this@@10) (Lit SetType |os#0@@10|))) ($Box DatatypeTypeType |region#0@@5|)) (|_module.Memory.ownedBy#canCall| (Lit refType this@@10) (Lit SetType |os#0@@10|) |region#0@@5|))))
 :qid |gitissue3855dfy.635:7|
 :skolemid |1230|
 :pattern ( (_module.Memory.ownedBy this@@10 |os#0@@10| |region#0@@5|))
 :pattern ( (|Set#IsMember| (_module.Memory.allRegions this@@10 |os#0@@10|) ($Box DatatypeTypeType |region#0@@5|)))
))) (= (_module.Memory.partitionOfJustHeapRegions (Lit refType this@@10) (Lit SetType |os#0@@10|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region (Lit SetType (_module.Memory.allRegions (Lit refType this@@10) (Lit SetType |os#0@@10|))))) (|lambda#129| (Lit refType this@@10) (Lit SetType |os#0@@10|)) (TMap Tclass._module.Region (TSet Tclass._module.Object))))))
 :qid |gitissue3855dfy.625:10|
 :weight 3
 :skolemid |1232|
 :pattern ( (_module.Memory.partitionOfJustHeapRegions (Lit refType this@@10) (Lit SetType |os#0@@10|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@11 T@U) (|os#0@@11| T@U) ) (!  (=> (or (|_module.Memory.partitionOfJustHeapRegions#canCall| this@@11 |os#0@@11|) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@11 null)) (not true)) ($Is refType this@@11 Tclass._module.Memory)) ($Is SetType |os#0@@11| (TSet Tclass._module.Object))))) (and (and (and (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.Object) (|Set#IsMember| |os#0@@11| ($Box refType |o#0@@1|))) (=> (_module.Region.Heap_q (_module.Object.region |o#0@@1|)) (|Set#IsMember| (|Map#Domain| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType (_module.Object.region |o#0@@1|)))))
 :qid |gitissue3855dfy.626:18|
 :skolemid |1215|
 :pattern ( (_module.Object.region |o#0@@1|))
 :pattern ( (|Set#IsMember| |os#0@@11| ($Box refType |o#0@@1|)))
)) (forall ((|o#1@@1| T@U) ) (!  (=> (and ($Is refType |o#1@@1| Tclass._module.Object) (|Set#IsMember| |os#0@@11| ($Box refType |o#1@@1|))) (=> (_module.Region.Heap_q (_module.Object.region |o#1@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType (_module.Object.region |o#1@@1|)))) ($Box refType |o#1@@1|))))
 :qid |gitissue3855dfy.627:18|
 :skolemid |1216|
 :pattern ( (_module.Object.region |o#1@@1|))
 :pattern ( (|Set#IsMember| |os#0@@11| ($Box refType |o#1@@1|)))
))) (forall ((|o1#0| T@U) (|o2#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |o1#0| Tclass._module.Region) ($Is DatatypeTypeType |o2#0| Tclass._module.Region)) (and (|Set#IsMember| (_module.Memory.allRegions this@@11 |os#0@@11|) ($Box DatatypeTypeType |o1#0|)) (|Set#IsMember| (_module.Memory.allRegions this@@11 |os#0@@11|) ($Box DatatypeTypeType |o2#0|)))) (=> (and (_module.Region.Heap_q |o1#0|) (_module.Region.Heap_q |o2#0|)) (ite (|_module.Region#Equal| |o1#0| |o2#0|) (|Set#Equal| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o1#0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o2#0|)))) (|Set#Disjoint| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o1#0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o2#0|)))))))
 :qid |gitissue3855dfy.628:18|
 :skolemid |1217|
 :pattern ( ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o2#0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o1#0|))))
 :pattern ( ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o2#0|))) (_module.Region.Heap_q |o1#0|))
 :pattern ( ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o2#0|))) (|Set#IsMember| (_module.Memory.allRegions this@@11 |os#0@@11|) ($Box DatatypeTypeType |o1#0|)))
 :pattern ( ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o1#0|))) (_module.Region.Heap_q |o2#0|))
 :pattern ( ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|)) ($Box DatatypeTypeType |o1#0|))) (|Set#IsMember| (_module.Memory.allRegions this@@11 |os#0@@11|) ($Box DatatypeTypeType |o2#0|)))
 :pattern ( (_module.Region.Heap_q |o2#0|) (_module.Region.Heap_q |o1#0|))
 :pattern ( (_module.Region.Heap_q |o2#0|) (|Set#IsMember| (_module.Memory.allRegions this@@11 |os#0@@11|) ($Box DatatypeTypeType |o1#0|)))
 :pattern ( (_module.Region.Heap_q |o1#0|) (|Set#IsMember| (_module.Memory.allRegions this@@11 |os#0@@11|) ($Box DatatypeTypeType |o2#0|)))
 :pattern ( (|Set#IsMember| (_module.Memory.allRegions this@@11 |os#0@@11|) ($Box DatatypeTypeType |o2#0|)) (|Set#IsMember| (_module.Memory.allRegions this@@11 |os#0@@11|) ($Box DatatypeTypeType |o1#0|)))
))) ($Is MapType (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|) (TMap Tclass._module.Region (TSet Tclass._module.Object)))))
 :qid |gitissue3855dfy.625:10|
 :skolemid |1218|
 :pattern ( (_module.Memory.partitionOfJustHeapRegions this@@11 |os#0@@11|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@12 T@U) (|os#0@@12| T@U) ) (!  (=> (or (|_module.Memory.allRegions#canCall| this@@12 |os#0@@12|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@12 null)) (not true)) ($Is refType this@@12 Tclass._module.Memory)) ($Is SetType |os#0@@12| (TSet Tclass._module.Object))))) (= (_module.Memory.allRegions this@@12 |os#0@@12|) (|Set#FromBoogieMap| (|lambda#122| Tclass._module.Object |os#0@@12| |os#0@@12|))))
 :qid |gitissue3855dfy.600:10|
 :skolemid |1185|
 :pattern ( (_module.Memory.allRegions this@@12 |os#0@@12|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@13 T@U) (|os#0@@13| T@U) ) (!  (=> (or (|_module.Memory.partitionOfJustHeapRegions#canCall| this@@13 (Lit SetType |os#0@@13|)) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@13 null)) (not true)) ($Is refType this@@13 Tclass._module.Memory)) ($Is SetType |os#0@@13| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.allRegions#canCall| this@@13 (Lit SetType |os#0@@13|)) (forall ((|region#0@@6| T@U) ) (!  (=> ($Is DatatypeTypeType |region#0@@6| Tclass._module.Region) (and (|_module.Memory.allRegions#canCall| this@@13 (Lit SetType |os#0@@13|)) (=> (|Set#IsMember| (_module.Memory.allRegions this@@13 (Lit SetType |os#0@@13|)) ($Box DatatypeTypeType |region#0@@6|)) (|_module.Memory.ownedBy#canCall| this@@13 (Lit SetType |os#0@@13|) |region#0@@6|))))
 :qid |gitissue3855dfy.635:7|
 :skolemid |1226|
 :pattern ( (_module.Memory.ownedBy this@@13 |os#0@@13| |region#0@@6|))
 :pattern ( (|Set#IsMember| (_module.Memory.allRegions this@@13 |os#0@@13|) ($Box DatatypeTypeType |region#0@@6|)))
))) (= (_module.Memory.partitionOfJustHeapRegions this@@13 (Lit SetType |os#0@@13|)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region (_module.Memory.allRegions this@@13 (Lit SetType |os#0@@13|)))) (|lambda#129| this@@13 (Lit SetType |os#0@@13|)) (TMap Tclass._module.Region (TSet Tclass._module.Object))))))
 :qid |gitissue3855dfy.625:10|
 :weight 3
 :skolemid |1228|
 :pattern ( (_module.Memory.partitionOfJustHeapRegions this@@13 (Lit SetType |os#0@@13|)))
))))
...
(declare-fun |o#8@0| () T@U)
(declare-fun |o#7@0| () T@U)
(declare-fun |region#1@0| () T@U)
(declare-fun |let#0#0#0| () T@U)
(declare-fun |heapOnwers#Z#0@0| () T@U)
(declare-fun |o#9@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.partitionOfJustHeapRegions)
...
(let ((anon38_Else_correct  (=> (not (|_module.Region#Equal| |o1#2@0| |o2#2@0|)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType |o1#2@0|))) (=> (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType |o1#2@0|)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType |o2#2@0|))) (=> (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType |o2#2@0|)) (=> (and (|Set#Disjoint| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#2@0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#2@0|)))) (= (ControlFlow 0 21) 15)) anon21_correct))))))))
(let ((anon38_Then_correct  (=> (|_module.Region#Equal| |o1#2@0| |o2#2@0|) (and (=> (= (ControlFlow 0 18) (- 0 20)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType |o1#2@0|))) (=> (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType |o1#2@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType |o2#2@0|))) (=> (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType |o2#2@0|)) (=> (and (|Set#Equal| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#2@0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#2@0|)))) (= (ControlFlow 0 18) 15)) anon21_correct))))))))
(let ((anon16_correct  (=> (and (_module.Region.Heap_q |o1#2@0|) (_module.Region.Heap_q |o2#2@0|)) (and (=> (= (ControlFlow 0 24) 18) anon38_Then_correct) (=> (= (ControlFlow 0 24) 21) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (not (_module.Region.Heap_q |o1#2@0|)) (= (ControlFlow 0 26) 24)) anon16_correct)))
(let ((anon37_Then_correct  (=> (and (_module.Region.Heap_q |o1#2@0|) (= (ControlFlow 0 25) 24)) anon16_correct)))
(let ((anon36_Else_correct  (=> (and (=> (and (_module.Region.Heap_q |o1#2@0|) (_module.Region.Heap_q |o2#2@0|)) (ite (|_module.Region#Equal| |o1#2@0| |o2#2@0|) (|Set#Equal| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#2@0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#2@0|)))) (|Set#Disjoint| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#2@0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#2@0|)))))) (= (ControlFlow 0 17) 15)) anon21_correct)))
(let ((anon35_Then_correct  (=> (and (and (and ($IsAllocBox ($Box refType this@@14) Tclass._module.Memory? $Heap@@2) ($IsAlloc SetType |os#0@@14| (TSet Tclass._module.Object) $Heap@@2)) (and (|_module.Memory.allRegions#canCall| this@@14 |os#0@@14|) (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o1#2@0|)))) (and (and ($IsAllocBox ($Box refType this@@14) Tclass._module.Memory? $Heap@@2) ($IsAlloc SetType |os#0@@14| (TSet Tclass._module.Object) $Heap@@2)) (and (|_module.Memory.allRegions#canCall| this@@14 |os#0@@14|) (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o2#2@0|))))) (and (and (=> (= (ControlFlow 0 27) 17) anon36_Else_correct) (=> (= (ControlFlow 0 27) 25) anon37_Then_correct)) (=> (= (ControlFlow 0 27) 26) anon37_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (=> (and (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o1#2@0|)) (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o2#2@0|))) (=> (and (_module.Region.Heap_q |o1#2@0|) (_module.Region.Heap_q |o2#2@0|)) (ite (|_module.Region#Equal| |o1#2@0| |o2#2@0|) (|Set#Equal| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#2@0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#2@0|)))) (|Set#Disjoint| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#2@0|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#2@0|))))))) (= (ControlFlow 0 16) 15)) anon21_correct)))
(let ((anon12_correct  (=> (forall ((|o#6| T@U) ) (!  (=> (and ($Is refType |o#6| Tclass._module.Object) (|Set#IsMember| |os#0@@14| ($Box refType |o#6|))) (=> (_module.Region.Heap_q (_module.Object.region |o#6|)) (|Set#IsMember| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#6|)))) ($Box refType |o#6|))))
 :qid |gitissue3855dfy.627:18|
 :skolemid |1237|
 :pattern ( (_module.Object.region |o#6|))
 :pattern ( (|Set#IsMember| |os#0@@14| ($Box refType |o#6|)))
)) (=> (and (and ($Is DatatypeTypeType |o1#2@0| Tclass._module.Region) ($IsAlloc DatatypeTypeType |o1#2@0| Tclass._module.Region $Heap@@2)) (and ($Is DatatypeTypeType |o2#2@0| Tclass._module.Region) ($IsAlloc DatatypeTypeType |o2#2@0| Tclass._module.Region $Heap@@2))) (and (=> (= (ControlFlow 0 28) 27) anon35_Then_correct) (=> (= (ControlFlow 0 28) 16) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (=> (_module.Region.Heap_q (_module.Object.region |o#8@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#8@0|)))) ($Box refType |o#8@0|))) (= (ControlFlow 0 34) 28)) anon12_correct)))
(let ((anon34_Then_correct  (and (=> (= (ControlFlow 0 30) (- 0 33)) (or (not (= |o#8@0| null)) (not true))) (=> (or (not (= |o#8@0| null)) (not true)) (=> (_module.Region.Heap_q (_module.Object.region |o#8@0|)) (and (=> (= (ControlFlow 0 30) (- 0 32)) (or (not (= |o#8@0| null)) (not true))) (=> (or (not (= |o#8@0| null)) (not true)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#8@0|)))) (=> (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#8@0|))) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#8@0|)))) ($Box refType |o#8@0|)) (= (ControlFlow 0 30) 28)) anon12_correct))))))))))
(let ((anon33_Then_correct  (=> (|Set#IsMember| |os#0@@14| ($Box refType |o#8@0|)) (and (=> (= (ControlFlow 0 35) 30) anon34_Then_correct) (=> (= (ControlFlow 0 35) 34) anon34_Else_correct)))))
(let ((anon33_Else_correct  (=> (and (=> (|Set#IsMember| |os#0@@14| ($Box refType |o#8@0|)) (=> (_module.Region.Heap_q (_module.Object.region |o#8@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#8@0|)))) ($Box refType |o#8@0|)))) (= (ControlFlow 0 29) 28)) anon12_correct)))
(let ((anon7_correct  (=> (forall ((|o#5| T@U) ) (!  (=> (and ($Is refType |o#5| Tclass._module.Object) (|Set#IsMember| |os#0@@14| ($Box refType |o#5|))) (=> (_module.Region.Heap_q (_module.Object.region |o#5|)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#5|)))))
 :qid |gitissue3855dfy.626:18|
 :skolemid |1236|
 :pattern ( (_module.Object.region |o#5|))
 :pattern ( (|Set#IsMember| |os#0@@14| ($Box refType |o#5|)))
)) (=> (and ($Is refType |o#8@0| Tclass._module.Object) ($IsAlloc refType |o#8@0| Tclass._module.Object $Heap@@2)) (and (=> (= (ControlFlow 0 36) 35) anon33_Then_correct) (=> (= (ControlFlow 0 36) 29) anon33_Else_correct))))))
(let ((anon32_Else_correct  (=> (and (=> (_module.Region.Heap_q (_module.Object.region |o#7@0|)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#7@0|)))) (= (ControlFlow 0 41) 36)) anon7_correct)))
(let ((anon32_Then_correct  (and (=> (= (ControlFlow 0 38) (- 0 40)) (or (not (= |o#7@0| null)) (not true))) (=> (or (not (= |o#7@0| null)) (not true)) (=> (_module.Region.Heap_q (_module.Object.region |o#7@0|)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (or (not (= |o#7@0| null)) (not true))) (=> (or (not (= |o#7@0| null)) (not true)) (=> (and (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#7@0|))) (= (ControlFlow 0 38) 36)) anon7_correct))))))))
(let ((anon31_Then_correct  (=> (|Set#IsMember| |os#0@@14| ($Box refType |o#7@0|)) (and (=> (= (ControlFlow 0 42) 38) anon32_Then_correct) (=> (= (ControlFlow 0 42) 41) anon32_Else_correct)))))
(let ((anon31_Else_correct  (=> (and (=> (|Set#IsMember| |os#0@@14| ($Box refType |o#7@0|)) (=> (_module.Region.Heap_q (_module.Object.region |o#7@0|)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#7@0|))))) (= (ControlFlow 0 37) 36)) anon7_correct)))
(let ((anon30_Then_correct  (=> (and (and ($Is MapType (_module.Memory.partitionOfJustHeapRegions this@@14 |os#0@@14|) (TMap Tclass._module.Region (TSet Tclass._module.Object))) ($Is MapType |partition#0| (TMap Tclass._module.Region (TSet Tclass._module.Object)))) (and ($Is refType |o#7@0| Tclass._module.Object) ($IsAlloc refType |o#7@0| Tclass._module.Object $Heap@@2))) (and (=> (= (ControlFlow 0 43) 42) anon31_Then_correct) (=> (= (ControlFlow 0 43) 37) anon31_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|o#5@@0| T@U) ) (!  (=> (and ($Is refType |o#5@@0| Tclass._module.Object) (|Set#IsMember| |os#0@@14| ($Box refType |o#5@@0|))) (=> (_module.Region.Heap_q (_module.Object.region |o#5@@0|)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#5@@0|)))))
 :qid |gitissue3855dfy.626:18|
 :skolemid |1233|
 :pattern ( (_module.Object.region |o#5@@0|))
 :pattern ( (|Set#IsMember| |os#0@@14| ($Box refType |o#5@@0|)))
))) (=> (forall ((|o#5@@1| T@U) ) (!  (=> (and ($Is refType |o#5@@1| Tclass._module.Object) (|Set#IsMember| |os#0@@14| ($Box refType |o#5@@1|))) (=> (_module.Region.Heap_q (_module.Object.region |o#5@@1|)) (|Set#IsMember| (|Map#Domain| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#5@@1|)))))
 :qid |gitissue3855dfy.626:18|
 :skolemid |1233|
 :pattern ( (_module.Object.region |o#5@@1|))
 :pattern ( (|Set#IsMember| |os#0@@14| ($Box refType |o#5@@1|)))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|o#6@@0| T@U) ) (!  (=> (and ($Is refType |o#6@@0| Tclass._module.Object) (|Set#IsMember| |os#0@@14| ($Box refType |o#6@@0|))) (=> (_module.Region.Heap_q (_module.Object.region |o#6@@0|)) (|Set#IsMember| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#6@@0|)))) ($Box refType |o#6@@0|))))
 :qid |gitissue3855dfy.627:18|
 :skolemid |1234|
 :pattern ( (_module.Object.region |o#6@@0|))
 :pattern ( (|Set#IsMember| |os#0@@14| ($Box refType |o#6@@0|)))
))) (=> (forall ((|o#6@@1| T@U) ) (!  (=> (and ($Is refType |o#6@@1| Tclass._module.Object) (|Set#IsMember| |os#0@@14| ($Box refType |o#6@@1|))) (=> (_module.Region.Heap_q (_module.Object.region |o#6@@1|)) (|Set#IsMember| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType (_module.Object.region |o#6@@1|)))) ($Box refType |o#6@@1|))))
 :qid |gitissue3855dfy.627:18|
 :skolemid |1234|
 :pattern ( (_module.Object.region |o#6@@1|))
 :pattern ( (|Set#IsMember| |os#0@@14| ($Box refType |o#6@@1|)))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|o1#1| T@U) (|o2#1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |o1#1| Tclass._module.Region) ($Is DatatypeTypeType |o2#1| Tclass._module.Region)) (and (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o1#1|)) (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o2#1|)))) (=> (and (_module.Region.Heap_q |o1#1|) (_module.Region.Heap_q |o2#1|)) (ite (|_module.Region#Equal| |o1#1| |o2#1|) (|Set#Equal| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#1|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#1|)))) (|Set#Disjoint| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#1|))) ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#1|)))))))
 :qid |gitissue3855dfy.628:18|
 :skolemid |1235|
 ...
 :pattern ( ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o2#1|))) (_module.Region.Heap_q |o1#1|))
 ...
 :pattern ( ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |partition#0|) ($Box DatatypeTypeType |o1#1|))) (_module.Region.Heap_q |o2#1|))
 ...
 :pattern ( (_module.Region.Heap_q |o2#1|) (_module.Region.Heap_q |o1#1|))
 :pattern ( (_module.Region.Heap_q |o2#1|) (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o1#1|)))
 :pattern ( (_module.Region.Heap_q |o1#1|) (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o2#1|)))
...
)) ($Is MapType (_module.Memory.partitionOfJustHeapRegions this@@14 |os#0@@14|) (TMap Tclass._module.Region (TSet Tclass._module.Object)))) (and (= (_module.Memory.partitionOfJustHeapRegions this@@14 |os#0@@14|) |partition#0|) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon42_Else_correct  (=> (and (not (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |region#1@0|))) (= (ControlFlow 0 8) 5)) anon28_correct)))
(let ((anon42_Then_correct  (=> (and (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |region#1@0|)) ($IsAllocBox ($Box refType this@@14) Tclass._module.Memory? $Heap@@2)) (=> (and (and ($IsAlloc SetType |os#0@@14| (TSet Tclass._module.Object) $Heap@@2) ($IsAlloc DatatypeTypeType |region#1@0| Tclass._module.Region $Heap@@2)) (and (|_module.Memory.ownedBy#canCall| this@@14 |os#0@@14| |region#1@0|) (= (ControlFlow 0 7) 5))) anon28_correct))))
(let ((anon41_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |region#1@0| Tclass._module.Region) ($IsAlloc DatatypeTypeType |region#1@0| Tclass._module.Region $Heap@@2)) ($IsAllocBox ($Box refType this@@14) Tclass._module.Memory? $Heap@@2)) (and ($IsAlloc SetType |os#0@@14| (TSet Tclass._module.Object) $Heap@@2) (|_module.Memory.allRegions#canCall| this@@14 |os#0@@14|))) (and (=> (= (ControlFlow 0 9) 7) anon42_Then_correct) (=> (= (ControlFlow 0 9) 8) anon42_Else_correct)))))
(let ((anon41_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |region#1@0| Tclass._module.Region) ($IsAlloc DatatypeTypeType |region#1@0| Tclass._module.Region $Heap@@2))) (= (ControlFlow 0 6) 5)) anon28_correct)))
(let ((anon25_correct  (=> (and (and (= |let#0#0#0| (|Set#FromBoogieMap| (|lambda#137| Tclass._module.Region (_module.Memory.allRegions this@@14 |os#0@@14|) (_module.Memory.allRegions this@@14 |os#0@@14|)))) (|_module.Memory.allRegions#canCall| this@@14 |os#0@@14|)) (and ($Is SetType |let#0#0#0| (TSet TBool)) (= |heapOnwers#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 10) 9) anon41_Then_correct) (=> (= (ControlFlow 0 10) 6) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (not (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o#9@0|))) (= (ControlFlow 0 13) 10)) anon25_correct)))
(let ((anon40_Then_correct  (=> (and (|Set#IsMember| (_module.Memory.allRegions this@@14 |os#0@@14|) ($Box DatatypeTypeType |o#9@0|)) (= (ControlFlow 0 12) 10)) anon25_correct)))
(let ((anon39_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |o#9@0| Tclass._module.Region) ($IsAlloc DatatypeTypeType |o#9@0| Tclass._module.Region $Heap@@2)) ($IsAllocBox ($Box refType this@@14) Tclass._module.Memory? $Heap@@2)) (and ($IsAlloc SetType |os#0@@14| (TSet Tclass._module.Object) $Heap@@2) (|_module.Memory.allRegions#canCall| this@@14 |os#0@@14|))) (and (=> (= (ControlFlow 0 14) 12) anon40_Then_correct) (=> (= (ControlFlow 0 14) 13) anon40_Else_correct)))))
(let ((anon39_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |o#9@0| Tclass._module.Region) ($IsAlloc DatatypeTypeType |o#9@0| Tclass._module.Region $Heap@@2))) (= (ControlFlow 0 11) 10)) anon25_correct)))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 44) 43) anon30_Then_correct) (=> (= (ControlFlow 0 44) 14) anon39_Then_correct)) (=> (= (ControlFlow 0 44) 11) anon39_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@14 null)) (not true)) (and ($Is refType this@@14 Tclass._module.Memory) ($IsAlloc refType this@@14 Tclass._module.Memory $Heap@@2))) ($Is SetType |os#0@@14| (TSet Tclass._module.Object))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 45) 44))) anon0_correct))))
