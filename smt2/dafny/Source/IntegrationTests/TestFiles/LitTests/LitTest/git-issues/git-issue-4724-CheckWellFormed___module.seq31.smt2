...
(assert (forall ((bx T@U) (t@@2 T@U) ) (!  (=> ($IsBox bx (TSeq t@@2)) (and (= ($Box SeqType ($Unbox SeqType bx)) bx) ($Is SeqType ($Unbox SeqType bx) (TSeq t@@2))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx (TSeq t@@2)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.seq31)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (<= (|Seq#Length| (Lit SeqType |Seq#Empty|)) (LitInt 31)))))
