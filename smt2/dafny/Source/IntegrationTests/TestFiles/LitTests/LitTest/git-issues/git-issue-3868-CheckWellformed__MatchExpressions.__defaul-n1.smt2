...
(declare-fun MatchExpressions.__default.AutoAccumulator (T@U T@U Int) Int)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|o#0| T@U) (|n#0| Int) ) (!  (=> (or (|MatchExpressions.__default.AutoAccumulator#canCall| |o#0| |n#0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |o#0| Tclass.MatchExpressions.AB) (<= (LitInt 0) |n#0|)))) (and (=> (or (not (= |n#0| (LitInt 0))) (not true)) (and (=> (MatchExpressions.AB.A_q |o#0|) (|MatchExpressions.__default.AutoAccumulator#canCall| |o#0| (- |n#0| 1))) (=> (not (MatchExpressions.AB.A_q |o#0|)) (|MatchExpressions.__default.AutoAccumulator#canCall| |o#0| (- |n#0| 1))))) (= (MatchExpressions.__default.AutoAccumulator ($LS $ly) |o#0| |n#0|) (ite (= |n#0| (LitInt 0)) 6 (ite (MatchExpressions.AB.A_q |o#0|) (+ (MatchExpressions.__default.AutoAccumulator $ly |o#0| (- |n#0| 1)) 1) (+ (MatchExpressions.__default.AutoAccumulator $ly |o#0| (- |n#0| 1)) 1))))))
 :pattern ( (MatchExpressions.__default.AutoAccumulator ($LS $ly) |o#0| |n#0|))
))))
(assert (forall (($ly@@0 T@U) (|o#0@@0| T@U) (|n#0@@0| Int) ) (! (= (MatchExpressions.__default.AutoAccumulator ($LS $ly@@0) |o#0@@0| |n#0@@0|) (MatchExpressions.__default.AutoAccumulator $ly@@0 |o#0@@0| |n#0@@0|))
 :pattern ( (MatchExpressions.__default.AutoAccumulator ($LS $ly@@0) |o#0@@0| |n#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|o#0@@1| T@U) (|n#0@@1| Int) ) (!  (=> (or (|MatchExpressions.__default.AutoAccumulator#canCall| (Lit DatatypeTypeType |o#0@@1|) (LitInt |n#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |o#0@@1| Tclass.MatchExpressions.AB) (<= (LitInt 0) |n#0@@1|)))) (and (=> (or (not (= (LitInt |n#0@@1|) (LitInt 0))) (not true)) (and (=> (U_2_bool (Lit boolType (bool_2_U (MatchExpressions.AB.A_q (Lit DatatypeTypeType |o#0@@1|))))) (|MatchExpressions.__default.AutoAccumulator#canCall| (Lit DatatypeTypeType |o#0@@1|) (LitInt (- |n#0@@1| 1)))) (=> (not (U_2_bool (Lit boolType (bool_2_U (MatchExpressions.AB.A_q (Lit DatatypeTypeType |o#0@@1|)))))) (|MatchExpressions.__default.AutoAccumulator#canCall| (Lit DatatypeTypeType |o#0@@1|) (LitInt (- |n#0@@1| 1)))))) (= (MatchExpressions.__default.AutoAccumulator ($LS $ly@@1) (Lit DatatypeTypeType |o#0@@1|) (LitInt |n#0@@1|)) (ite (= (LitInt |n#0@@1|) (LitInt 0)) 6 (ite (MatchExpressions.AB.A_q (Lit DatatypeTypeType |o#0@@1|)) (+ (MatchExpressions.__default.AutoAccumulator ($LS $ly@@1) (Lit DatatypeTypeType |o#0@@1|) (LitInt (- |n#0@@1| 1))) 1) (+ (MatchExpressions.__default.AutoAccumulator ($LS $ly@@1) (Lit DatatypeTypeType |o#0@@1|) (LitInt (- |n#0@@1| 1))) 1))))))
 :weight 3
 :pattern ( (MatchExpressions.__default.AutoAccumulator ($LS $ly@@1) (Lit DatatypeTypeType |o#0@@1|) (LitInt |n#0@@1|)))
))))
