...
(let ((anon7_correct  (=> (and (forall ((|b#1| Int) )  (=> (and (and (< |b#1| 256) (or (not (= |b#1| 7)) (not true))) (<= (LitInt 0) |b#1|)) (=> (and (<= (LitInt 5) |b#1|) (< |b#1| 12)) (|Regressions.__default.P#canCall| |b#1|)))) (= |s#0@0| (|Set#FromBoogieMap| (|lambda#1| Tclass.Regressions.byte (LitInt 5) 12)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| |s#0@0| ($Box intType (int_2_U (LitInt 9))))) (=> (|Set#IsMember| |s#0@0| ($Box intType (int_2_U (LitInt 9)))) (and (=> (= (ControlFlow 0 4) 2) anon14_Then_correct) (=> (= (ControlFlow 0 4) 3) anon14_Else_correct)))))))
