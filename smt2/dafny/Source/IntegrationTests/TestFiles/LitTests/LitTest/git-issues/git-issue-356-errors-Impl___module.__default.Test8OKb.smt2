...
(set-info :boogie-vc-id Impl$$_module.__default.Test8OKb)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |newtype$check#0@0| (|char#ToInt| |n#0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 65536))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is charType |n#0| TChar)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
