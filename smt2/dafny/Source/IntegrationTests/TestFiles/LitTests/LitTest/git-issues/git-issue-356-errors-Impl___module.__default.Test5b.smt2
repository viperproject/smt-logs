...
(set-info :boogie-vc-id Impl$$_module.__default.Test5b)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (q@Real (q@Int |r#0|)) |r#0|)) (=> (= (q@Real (q@Int |r#0|)) |r#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (or (and (<= 0 (q@Int |r#0|)) (< (q@Int |r#0|) 55296)) (and (<= 57344 (q@Int |r#0|)) (< (q@Int |r#0|) 1114112)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is charType |ch#0| TChar) true)) (and (and (= 0 $FunctionContextHeight) (<= |r#0| (LitReal 65535.0))) (and (= |r#0| (q@Real (q@Int |r#0|))) (= (ControlFlow 0 4) 2)))) anon0_correct)))
