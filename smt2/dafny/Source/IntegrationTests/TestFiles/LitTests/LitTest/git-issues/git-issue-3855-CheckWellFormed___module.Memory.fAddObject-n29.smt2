...
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@30 T@U) (|os#0@@4| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@30 null)) (not true)) ($Is refType this@@30 Tclass._module.Memory))) (or (|_module.Memory.OutgoingReferencesAreInThisHeap#canCall| $h0@@4 this@@30 |os#0@@4|) ($Is SetType |os#0@@4| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@17 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (or (or (and (= $o@@17 this@@30) (= $f@@5 _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 this@@30) _module.Memory.objects)) ($Box refType $o@@17))) (|Set#IsMember| |os#0@@4| ($Box refType $o@@17)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@17) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@17) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |862|
...
(assert (forall (($h0@@9 T@U) ($h1@@9 T@U) (this@@40 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@9) ($IsGoodHeap $h1@@9)) (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9))) (=> (forall (($o@@22 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (and (= $o@@22 this@@40) (= $f@@10 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@22) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@9 $o@@22) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |750|
...
(declare-fun this@@63 () T@U)
(declare-fun |nu#0| () T@U)
(declare-fun $Heap@0 () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.fAddObject)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@27 alloc this@@63 _module.Memory.objects)) ($IsAllocBox ($Box refType this@@63) Tclass._module.Memory? $Heap@@27)) (and (|_module.Memory.Valid#canCall| $Heap@@27 this@@63) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@27 this@@63))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |nu#0| null)) (not true))) (=> (or (not (= |nu#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |nu#0|) Tclass._module.Object? $Heap@@27) (=> (and (|_module.Object.Valid#canCall| $Heap@@27 |nu#0|) (_module.Object.Valid reveal__module.Object.Valid $Heap@@27 |nu#0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |nu#0| null)) (not true))) (=> (or (not (= |nu#0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |nu#0|) Tclass._module.Object? $Heap@@27) (|_module.Object.size#canCall| $Heap@@27 |nu#0|)) (and (= (_module.Object.size $Heap@@27 |nu#0|) (LitInt 0)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 this@@63) _module.Memory.objects)) ($Box refType |nu#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= this@@63 null)) (not true))) (=> (or (not (= this@@63 null)) (not true)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@29 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 $o@@29) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 $o@@29)) (= $o@@29 this@@63)))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1019|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29))
)) (forall (($o@@30 T@U) ($f@@17 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 $o@@30) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) $f@@17) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 $o@@30) $f@@17)) (and (= $o@@30 this@@63) (= $f@@17 _module.Memory.objects))))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1020|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) $f@@17))
))) (and ($HeapSucc $Heap@@27 $Heap@0) ($IsAllocBox ($Box refType this@@63) Tclass._module.Memory? $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@63 Tclass._module.Memory $Heap@@27)) (=> ($IsAlloc refType this@@63 Tclass._module.Memory $Heap@@27) (=> (and (|_module.Memory.Valid2#canCall| $Heap@@27 $Heap@0 this@@63) (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@@27 $Heap@0 this@@63)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |nu#0| Tclass._module.Object $Heap@@27)) (=> ($IsAlloc refType |nu#0| Tclass._module.Object $Heap@@27) (=> (and (forall (($o@@31 T@U) ($f@@18 T@U) ) (!  (=> (or (not (= $o@@31 null)) (not true)) (=> (= $o@@31 |nu#0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@31) $f@@18) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 $o@@31) $f@@18))))
...
)) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@63 Tclass._module.Memory $Heap@@27)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@27) ($IsHeapAnchor $Heap@@27)) (and (or (not (= this@@63 null)) (not true)) (and ($Is refType this@@63 Tclass._module.Memory) ($IsAlloc refType this@@63 Tclass._module.Memory $Heap@@27)))) (and (and ($Is refType |nu#0| Tclass._module.Object) ($IsAlloc refType |nu#0| Tclass._module.Object $Heap@@27)) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 8) 2)))) anon0_correct)))
