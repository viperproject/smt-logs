...
(declare-fun |a10#0| () T@U)
(declare-fun |m1010#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.ArrayNullCheckRegression0)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |arr#0| (Tclass._System.array? TReal)) ($IsAlloc refType |arr#0| (Tclass._System.array? TReal) $Heap))) (=> (and (and (and ($Is refType |m#0| (Tclass._System.array2? TReal)) ($IsAlloc refType |m#0| (Tclass._System.array2? TReal) $Heap)) (and ($Is refType |a10#0| Tclass._module.Array10) ($IsAlloc refType |a10#0| Tclass._module.Array10 $Heap))) (and (and ($Is refType |m1010#0| Tclass._module.Matrix1010) ($IsAlloc refType |m1010#0| Tclass._module.Matrix1010 $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct))))
