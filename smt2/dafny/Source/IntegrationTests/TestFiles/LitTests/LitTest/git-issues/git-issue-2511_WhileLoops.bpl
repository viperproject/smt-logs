...
const unique class.WhileLoops.__default: ClassName;

procedure {:verboseName "WhileLoops.false_lemma (well-formedness)"} CheckWellFormed$$WhileLoops.__default.false__lemma();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "WhileLoops.false_lemma (call)"} Call$$WhileLoops.__default.false__lemma();
  modifies $Heap;
...
procedure {:verboseName "WhileLoops.false_lemma (correctness)"} Impl$$WhileLoops.__default.false__lemma() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "WhileLoops.false_lemma (correctness)"} Impl$$WhileLoops.__default.false__lemma() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var tmp#0: bv64;
  var $PreLoopHeap$loop#0: Heap;
  var $decr_init$loop#00: bv64;
  var $w$loop#0: bool;
  var $decr$loop#00: bv64;
  var newtype$check#0_0: int;

    // AddMethodImpl: false_lemma, Impl$$WhileLoops.__default.false__lemma
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(8,19)
    assume true;
    assume true;
    tmp#0 := Lit(1bv64);
    // ----- while statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(9,5)
    // Assume Fuel Constant
    $PreLoopHeap$loop#0 := $Heap;
    $decr_init$loop#00 := tmp#0;
    havoc $w$loop#0;
    while (true)
      ...
      free invariant (forall $o: ref, $f: Field :: 
        ...
        $o != null && $Unbox(read($PreLoopHeap$loop#0, $o, alloc)): bool
           ==> read($Heap, $o, $f) == read($PreLoopHeap$loop#0, $o, $f)
             || $_ModifiesFrame[$o, $f]);
      free invariant le_bv64(tmp#0, $decr_init$loop#00);
    {
        if (!$w$loop#0)
        {
            assume true;
        ...
        $decr$loop#00 := tmp#0;
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(12,11)
        assume true;
        newtype$check#0_0 := LitInt(1);
        assert {:id "id4"} 0 <= newtype$check#0_0 && newtype$check#0_0 < 128;
        assert {:id "id5"} le_bv7(1bv7, 64bv7);
        assume true;
        tmp#0 := RightShift_bv64(tmp#0, (0bv57 ++ 1bv7): bv64);
        pop;
        // ----- loop termination check ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(9,5)
        assert {:id "id7"} lt_bv64(tmp#0, $decr$loop#00);
    }

    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(14,5)
    assume true;
