...
(declare-fun |##a_b'#0@0| () Int)
(declare-fun |##ac_c#0@0| () T@U)
(declare-fun |_module.__default.GetSum#canCall| (Int T@U) Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is intType (int_2_U (LitInt 10)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 10)) Tclass._System.nat) (=> (and (= |##a_b'#0@0| (LitInt 10)) ($IsAlloc intType (int_2_U |##a_b'#0@0|) Tclass._System.nat $Heap)) (=> (and (and (= |##ac_c#0@0| (Lit SeqType |Seq#Empty|)) ($IsAlloc SeqType |##ac_c#0@0| (TSeq TChar) $Heap)) (and (|_module.__default.GetSum#canCall| (LitInt 10) (Lit SeqType |Seq#Empty|)) (|_module.__default.GetSum#canCall| (LitInt 10) (Lit SeqType |Seq#Empty|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |##x#0@0| (LitInt 0)) (=> (and ($IsAlloc intType (int_2_U |##x#0@0|) Tclass._System.nat $Heap) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U (LitInt 5)) Tclass._System.nat))))))))))))
