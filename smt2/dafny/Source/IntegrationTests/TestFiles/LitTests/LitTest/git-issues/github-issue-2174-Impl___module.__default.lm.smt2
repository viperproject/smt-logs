...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@97  (=> (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false)) (= (ControlFlow 0 2) (- 0 1))) (= (bvshl (concat #x0000 $generated@@92) (concat #b00000000000000000000000000 ((_ int2bv 6) $generated@@93))) (concat #x0000 (bvshl $generated@@92 (concat #b00000000000 ((_ int2bv 5) $generated@@93))))))))
(let (($generated@@98  (=> (and (and (and (and ($generated@@94 $generated@@90) ($generated@@95 $generated@@90)) (<= ($generated 0) $generated@@93)) (and (= 0 $generated@@96) (<= ($generated 0) $generated@@93))) (and (and (<= $generated@@93 ($generated (- 16 8))) (bvule #x0000 $generated@@92)) (and (bvult $generated@@92 (bvshl #x0001 (concat #b00000000000 #b01000))) (= (ControlFlow 0 3) 2)))) $generated@@97)))
$generated@@98)))
))
(check-sat)
(get-info :rlimit)
