...
(let ((anon8_Then_correct  (=> (and (= |x#0@@1| (LitInt 3)) (= (ControlFlow 0 3) (- 0 2))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (or (not (= |x#0@@1| 3)) (not true))) (and (and (=> (= (ControlFlow 0 5) 1) anon7_Then_correct) (=> (= (ControlFlow 0 5) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))
