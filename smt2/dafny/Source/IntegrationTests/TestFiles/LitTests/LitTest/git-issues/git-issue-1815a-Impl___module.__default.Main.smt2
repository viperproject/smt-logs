...
(declare-fun Tclass._module.Tr () T@U)
(declare-fun Tclass._module.Cl () T@U)
(declare-fun |#_module.Dt.Dt| (T@U Int) T@U)
...
(declare-fun _module.Dt.i (T@U) Int)
(declare-fun _module.Dt.x (T@U) T@U)
...
(assert (distinct TInt TagInt alloc Tagclass._module.Cl Tagclass._module.Tr Tagclass._module.Dt |##_module.Dt.Dt| Tagclass._module.Tr? Tagclass._module.Cl? tytagFamily$Cl tytagFamily$Tr tytagFamily$Dt)
)
...
(assert (forall ((_module.Dt$U@@0 T@U) (|a#2#0#0| T@U) (|a#2#1#0| Int) ) (! (= ($Is DatatypeTypeType (|#_module.Dt.Dt| |a#2#0#0| |a#2#1#0|) (Tclass._module.Dt _module.Dt$U@@0))  (and ($IsBox |a#2#0#0| _module.Dt$U@@0) ($Is intType (int_2_U |a#2#1#0|) TInt)))
 :qid |unknown.0:0|
 :skolemid |492|
 :pattern ( ($Is DatatypeTypeType (|#_module.Dt.Dt| |a#2#0#0| |a#2#1#0|) (Tclass._module.Dt _module.Dt$U@@0)))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (_module.Dt.Dt_q d@@1) (exists ((|a#1#0#0| T@U) (|a#1#1#0| Int) ) (! (= d@@1 (|#_module.Dt.Dt| |a#1#0#0| |a#1#1#0|))
 :qid |gitissue1815adfy.3:22|
 :skolemid |490|
)))
 :qid |unknown.0:0|
 :skolemid |491|
...
(assert (forall ((_module.Dt$U@@1 T@U) ) (!  (and (= (Tag (Tclass._module.Dt _module.Dt$U@@1)) Tagclass._module.Dt) (= (TagFamily (Tclass._module.Dt _module.Dt$U@@1)) tytagFamily$Dt))
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( (Tclass._module.Dt _module.Dt$U@@1))
)))
...
(assert (forall ((d@@2 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.Dt.Dt_q d@@2) (exists ((_module.Dt$U@@2 T@U) ) (! ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.Dt _module.Dt$U@@2) $h@@4)
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($IsAlloc DatatypeTypeType d@@2 (Tclass._module.Dt _module.Dt$U@@2) $h@@4))
)))) ($IsAlloc intType (int_2_U (_module.Dt.i d@@2)) TInt $h@@4))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( ($IsAlloc intType (int_2_U (_module.Dt.i d@@2)) TInt $h@@4))
)))
...
(assert (forall ((|a#0#0#0| T@U) (|a#0#1#0| Int) ) (! (= (DatatypeCtorId (|#_module.Dt.Dt| |a#0#0#0| |a#0#1#0|)) |##_module.Dt.Dt|)
 :qid |gitissue1815adfy.3:22|
 :skolemid |488|
 :pattern ( (|#_module.Dt.Dt| |a#0#0#0| |a#0#1#0|))
)))
(assert (forall ((|a#4#0#0| T@U) (|a#4#1#0| Int) ) (! (= (_module.Dt.x (|#_module.Dt.Dt| |a#4#0#0| |a#4#1#0|)) |a#4#0#0|)
 :qid |gitissue1815adfy.3:22|
 :skolemid |498|
 :pattern ( (|#_module.Dt.Dt| |a#4#0#0| |a#4#1#0|))
)))
(assert (forall ((|a#6#0#0| T@U) (|a#6#1#0| Int) ) (! (= (_module.Dt.i (|#_module.Dt.Dt| |a#6#0#0| |a#6#1#0|)) |a#6#1#0|)
 :qid |gitissue1815adfy.3:22|
 :skolemid |500|
 :pattern ( (|#_module.Dt.Dt| |a#6#0#0| |a#6#1#0|))
)))
(assert (forall ((_module.Dt$U@@3 T@U) ) (! (= (Tclass._module.Dt_0 (Tclass._module.Dt _module.Dt$U@@3)) _module.Dt$U@@3)
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( (Tclass._module.Dt _module.Dt$U@@3))
)))
...
(assert (forall ((|a#5#0#0| T@U) (|a#5#1#0| Int) ) (! (< (BoxRank |a#5#0#0|) (DtRank (|#_module.Dt.Dt| |a#5#0#0| |a#5#1#0|)))
 :qid |gitissue1815adfy.3:22|
 :skolemid |499|
 :pattern ( (|#_module.Dt.Dt| |a#5#0#0| |a#5#1#0|))
)))
(assert (forall ((d@@3 T@U) (_module.Dt$U@@4 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_module.Dt.Dt_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass._module.Dt _module.Dt$U@@4) $h@@5))) ($IsAllocBox (_module.Dt.x d@@3) _module.Dt$U@@4 $h@@5))
 :qid |unknown.0:0|
 :skolemid |494|
 :pattern ( ($IsAllocBox (_module.Dt.x d@@3) _module.Dt$U@@4 $h@@5))
)))
...
(assert (forall ((_module.Dt$U@@6 T@U) (|a#2#0#0@@0| T@U) (|a#2#1#0@@0| Int) ($h@@6 T@U) ) (!  (=> ($IsGoodHeap $h@@6) (= ($IsAlloc DatatypeTypeType (|#_module.Dt.Dt| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass._module.Dt _module.Dt$U@@6) $h@@6)  (and ($IsAllocBox |a#2#0#0@@0| _module.Dt$U@@6 $h@@6) ($IsAlloc intType (int_2_U |a#2#1#0@@0|) TInt $h@@6))))
 :qid |unknown.0:0|
 :skolemid |493|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Dt.Dt| |a#2#0#0@@0| |a#2#1#0@@0|) (Tclass._module.Dt _module.Dt$U@@6) $h@@6))
)))
(assert (forall ((|a#3#0#0| T@U) (|a#3#1#0| Int) ) (! (= (|#_module.Dt.Dt| (Lit BoxType |a#3#0#0|) (LitInt |a#3#1#0|)) (Lit DatatypeTypeType (|#_module.Dt.Dt| |a#3#0#0| |a#3#1#0|)))
 :qid |gitissue1815adfy.3:22|
 :skolemid |497|
 :pattern ( (|#_module.Dt.Dt| (Lit BoxType |a#3#0#0|) (LitInt |a#3#1#0|)))
)))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass._module.Cl) ($IsAlloc refType call1formal@this Tclass._module.Cl $Heap))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass._module.Cl) ($IsAlloc refType call1formal@this@0 Tclass._module.Cl $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call1formal@this@0) alloc))))) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |gitissue1815adfy.7:3|
 :skolemid |514|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 3) (- 0 5)) true) (=> (= |e#0@0| (|#_module.Dt.Dt| ($Box refType call1formal@this@0) (LitInt 1815))) (and (=> (= (ControlFlow 0 3) (- 0 4)) true) (and (=> (= (ControlFlow 0 3) 1) anon4_Then_correct) (=> (= (ControlFlow 0 3) 2) anon4_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#cl#0| (and ($Is refType |cl#0| Tclass._module.Cl) ($IsAlloc refType |cl#0| Tclass._module.Cl $Heap))) true)) (and (and (=> |defass#e#0| (and ($Is DatatypeTypeType |e#0| (Tclass._module.Dt Tclass._module.Tr)) ($IsAlloc DatatypeTypeType |e#0| (Tclass._module.Dt Tclass._module.Tr) $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 3)))) anon0_correct)))
