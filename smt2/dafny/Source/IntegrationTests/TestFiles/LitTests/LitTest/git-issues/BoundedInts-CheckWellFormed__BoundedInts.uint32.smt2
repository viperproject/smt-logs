...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U BoundedInts.__default.TWO__TO__THE__32) TInt)))
...
(set-info :boogie-vc-id CheckWellFormed$$BoundedInts.uint32)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 BoundedInts.__default.TWO__TO__THE__32)))))
