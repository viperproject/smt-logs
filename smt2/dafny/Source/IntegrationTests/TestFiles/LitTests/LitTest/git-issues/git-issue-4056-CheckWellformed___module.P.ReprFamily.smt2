...
(assert (distinct TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._module.ADT? Tagclass._module.ADT Tagclass._module.P? Tagclass._module.P tytagFamily$nat tytagFamily$object tytagFamily$ADT tytagFamily$P)
)
...
(assert (forall ((bx T@U) ($h@@0 T@U) ) (!  (=> (and ($IsAllocBox bx Tclass._module.P? $h@@0) ($IsGoodHeap $h@@0)) ($IsAllocBox bx Tclass._module.ADT? $h@@0))
 :qid |unknown.0:0|
 :skolemid |511|
 :pattern ( ($IsAllocBox bx Tclass._module.P? $h@@0))
)))
...
(assert (forall ((|c#0@@0| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.ADT $h@@2) ($IsAlloc refType |c#0@@0| Tclass._module.ADT? $h@@2))
 :qid |unknown.0:0|
 :skolemid |492|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.ADT $h@@2))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.ADT? $h@@2))
)))
(assert (forall ((|c#0@@1| T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType |c#0@@1| Tclass._module.P $h@@3) ($IsAlloc refType |c#0@@1| Tclass._module.P? $h@@3))
 :qid |unknown.0:0|
 :skolemid |509|
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.P $h@@3))
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.P? $h@@3))
)))
...
(assert (forall (($o@@1 T@U) ($h@@5 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.ADT? $h@@5)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.ADT? $h@@5))
)))
(assert (forall (($o@@2 T@U) ($h@@6 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.P? $h@@6)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.P? $h@@6))
)))
...
(assert (forall ((bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 Tclass._module.ADT) (and (= ($Box refType ($Unbox refType bx@@5)) bx@@5) ($Is refType ($Unbox refType bx@@5) Tclass._module.ADT)))
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( ($IsBox bx@@5 Tclass._module.ADT))
)))
...
(assert (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 Tclass._module.P) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) Tclass._module.P)))
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( ($IsBox bx@@7 Tclass._module.P))
)))
...
(assert (forall ((bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 Tclass._module.P?) ($IsBox bx@@10 Tclass._module.ADT?))
 :qid |unknown.0:0|
 :skolemid |510|
 :pattern ( ($IsBox bx@@10 Tclass._module.P?))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.P.ReprFamily)
...
(let ((anon13_Else_correct  (=> (and (=> (> |n#0@@3| 0) (|Set#Subset| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1)) (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 |n#0@@3|))) (= (ControlFlow 0 11) 4)) anon8_correct)))
(let ((anon13_Then_correct  (=> (> |n#0@@3| 0) (=> (and ($IsAllocBox ($Box refType this@@3) Tclass._module.P? $Heap@@3) ($IsAlloc intType (int_2_U |n#0@@3|) Tclass._System.nat $Heap@@3)) (and (=> (= (ControlFlow 0 5) (- 0 10)) (or (<= 0 |n#0@@3|) (= |n#0@@3| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |n#0@@3| |n#0@@3|)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (or (and (= this@@3 this@@3) (= |n#0@@3| |n#0@@3|)) (< |n#0@@3| |n#0@@3|))) (=> (or (and (= this@@3 this@@3) (= |n#0@@3| |n#0@@3|)) (< |n#0@@3| |n#0@@3|)) (=> (and (or (and (= this@@3 this@@3) (= |n#0@@3| |n#0@@3|)) (|_module.P.ReprFamily#canCall| $Heap@@3 this@@3 |n#0@@3|)) ($IsAllocBox ($Box refType this@@3) Tclass._module.P? $Heap@@3)) (and (=> (= (ControlFlow 0 5) (- 0 8)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (and (= |##n#2@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#2@0|) Tclass._System.nat $Heap@@3)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (<= 0 |n#0@@3|) (= |##n#2@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#2@0| |n#0@@3|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (and (= this@@3 this@@3) (= (- |n#0@@3| 1) |n#0@@3|)) (< |##n#2@0| |n#0@@3|))) (=> (or (and (= this@@3 this@@3) (= (- |n#0@@3| 1) |n#0@@3|)) (< |##n#2@0| |n#0@@3|)) (=> (or (and (= this@@3 this@@3) (= (- |n#0@@3| 1) |n#0@@3|)) (|_module.P.ReprFamily#canCall| $Heap@@3 this@@3 (- |n#0@@3| 1))) (=> (and (|Set#Subset| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1)) (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 |n#0@@3|)) (= (ControlFlow 0 5) 4)) anon8_correct))))))))))))))))))
(let ((anon12_Then_correct  (=> ($Is SetType (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 |n#0@@3|) (TSet Tclass._System.object)) (and (=> (= (ControlFlow 0 12) 5) anon13_Then_correct) (=> (= (ControlFlow 0 12) 11) anon13_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (> |n#0@@3| 0) (|Set#Subset| (_module.P.ReprFamily ($LS ($LS $LZ)) $Heap@@3 this@@3 (- |n#0@@3| 1)) (_module.P.ReprFamily ($LS ($LS $LZ)) $Heap@@3 this@@3 |n#0@@3|))))))
(let ((anon12_Else_correct  (=> (= (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 |n#0@@3|) (Lit SetType |Set#Empty|)) (=> (and ($Is SetType (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 |n#0@@3|) (TSet Tclass._System.object)) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 13) 12) anon12_Then_correct) (=> (= (ControlFlow 0 13) 3) anon12_Else_correct))))))
(let ((anon11_Else_correct  (=> (and (or (not (= |n#0@@3| (LitInt 0))) (not true)) ($IsAllocBox ($Box refType this@@3) Tclass._module.P? $Heap@@3)) (and (=> (= (ControlFlow 0 16) (- 0 19)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (= |##n#0@0| (- |n#0@@3| 1)) (=> (and ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@@3) (= |b$reqreads#0@0| (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@8) alloc)))) (or (= $o@@8 this@@3) (|Set#IsMember| (ite (= |##n#0@0| (LitInt 0)) |Set#Empty| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |##n#0@0| 1))) ($Box refType $o@@8)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@0)))
 :qid |gitissue4056dfy.15:40|
 :skolemid |506|
)))) (and (=> (= (ControlFlow 0 16) (- 0 18)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (< |##n#0@0| |n#0@@3|)) (=> (< |##n#0@0| |n#0@@3|) (=> (|_module.P.ReprFamily#canCall| $Heap@@3 this@@3 (- |n#0@@3| 1)) (=> (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 16) 13)) anon4_correct)))))))))))))
(let ((anon11_Then_correct  (=> (= |n#0@@3| (LitInt 0)) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 15) 13)) anon4_correct))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@3 alloc this@@3 (ite (= |n#0@@3| (LitInt 0)) |Set#Empty| (_module.P.ReprFamily ($LS $LZ) $Heap@@3 this@@3 (- |n#0@@3| 1))))) (and (=> (= (ControlFlow 0 20) 15) anon11_Then_correct) (=> (= (ControlFlow 0 20) 16) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.P) ($IsAlloc refType this@@3 Tclass._module.P $Heap@@3))) (<= (LitInt 0) |n#0@@3|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 21) 20))) anon0_correct))))
