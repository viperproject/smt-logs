...
(set-info :boogie-vc-id Impl$$SimpleSetContainmentTests.__default.Test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |ss##0@0| (Lit SetType |Set#Empty|))) (and (= |oo##0@0| (Lit SetType |Set#Empty|)) (= |cc##0@0| (Lit SetType |Set#Empty|)))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |gitissue697kdfy.65:10|
 :skolemid |1014|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap $Heap@0))) (and (and (= |ii##0@0| (Lit SetType |Set#Empty|)) (= |nn##0@0| (Lit SetType |Set#Empty|))) (and (= |i##0@0| (LitInt 2)) (= (ControlFlow 0 2) (- 0 1))))) ($Is intType (int_2_U (LitInt 2)) Tclass._System.nat)))))
