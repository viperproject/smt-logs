...
(let ((anon11_Else_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U false)))) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 6) 4)) anon6_correct)))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite false 30 40))))))
