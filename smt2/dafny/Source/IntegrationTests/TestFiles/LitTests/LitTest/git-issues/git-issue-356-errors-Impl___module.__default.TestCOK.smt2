...
(set-info :boogie-vc-id Impl$$_module.__default.TestCOK)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is charType |ch#0| TChar) true) (= 0 $FunctionContextHeight)) (and (< (nat_from_bv32 |b#0|) 65536) (= (ControlFlow 0 3) 2))) anon0_correct))))
