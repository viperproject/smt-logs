...
(set-info :boogie-vc-id CheckWellFormed$$SubsetTypeSubsetType.NonCompilableTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (and (|SubsetTypeSubsetType.__default.P#canCall| (LitInt 0)) (= (ControlFlow 0 3) (- 0 2))) (|SubsetTypeSubsetType.__default.P#canCall| (LitInt 0))) (or (U_2_bool (Lit boolType (bool_2_U (SubsetTypeSubsetType.__default.P (LitInt 0))))) (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 3)) (not true)))))))))
