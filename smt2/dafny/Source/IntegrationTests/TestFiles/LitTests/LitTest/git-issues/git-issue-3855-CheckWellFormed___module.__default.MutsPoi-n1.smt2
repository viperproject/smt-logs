...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MutsPointOnlyInSameRegion)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |f#0@@1| null)) (not true))) (=> (or (not (= |f#0@@1| null)) (not true)) (=> (_module.Region.Heap_q (_module.Object.region |f#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |t#0@@1| null)) (not true))) (=> (or (not (= |t#0@@1| null)) (not true)) (=> (_module.Region.Heap_q (_module.Object.region |t#0@@1|)) (=> (and (and (and ($IsAlloc refType |f#0@@1| Tclass._module.Object $Heap) ($IsAlloc refType |t#0@@1| Tclass._module.Object $Heap)) (and (|_module.__default.VeniceReferenceOK#canCall| |f#0@@1| |t#0@@1|) (_module.__default.VeniceReferenceOK |f#0@@1| |t#0@@1|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |f#0@@1| null)) (not true))) (=> (or (not (= |f#0@@1| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |t#0@@1| null)) (not true)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |f#0@@1| Tclass._module.Object) ($IsAlloc refType |f#0@@1| Tclass._module.Object $Heap))) (and (and ($Is refType |t#0@@1| Tclass._module.Object) ($IsAlloc refType |t#0@@1| Tclass._module.Object $Heap)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct)))
