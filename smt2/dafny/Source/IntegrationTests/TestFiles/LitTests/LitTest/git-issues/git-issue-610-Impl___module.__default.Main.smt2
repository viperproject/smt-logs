...
(assert (distinct alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.pos |tytagFamily$_tuple#2| tytagFamily$pos)
)
...
(let ((anon4_Else_correct  (=> (> |a#0@0| 0) (and (=> (= (ControlFlow 0 4) 2) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((anon4_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (> |x#0@0| 0)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (> |x#0@0| 0)) (=> (> |x#0@0| 0) (=> (and (and (and ($Is DatatypeTypeType |p#0@0| (Tclass._System.Tuple2 Tclass._module.pos Tclass._module.pos)) ($IsAlloc DatatypeTypeType |p#0@0| (Tclass._System.Tuple2 Tclass._module.pos Tclass._module.pos) $Heap)) (and (> |a#0@0| 0) (> |b#0@0| 0))) (and (and (= |let#0#0#0| |p#0@0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._System.Tuple2 Tclass._module.pos Tclass._module.pos))) (and (_System.Tuple2.___hMake2_q |let#0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |a#0@0|)) ($Box intType (int_2_U |b#0@0|))) |let#0#0#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (> |a#0@0| 0)) (=> (> |a#0@0| 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (> |b#0@0| 0)) (=> (> |b#0@0| 0) (and (=> (= (ControlFlow 0 5) 1) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (> |x#0| 0) true)) (=> (and (and (and ($Is DatatypeTypeType |p#0| (Tclass._System.Tuple2 Tclass._module.pos Tclass._module.pos)) ($IsAlloc DatatypeTypeType |p#0| (Tclass._System.Tuple2 Tclass._module.pos Tclass._module.pos) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 5))) anon0_correct))))
