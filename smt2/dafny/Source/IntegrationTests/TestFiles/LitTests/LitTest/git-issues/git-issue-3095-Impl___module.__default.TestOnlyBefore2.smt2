...
(set-info :boogie-vc-id Impl$$_module.__default.TestOnlyBefore2)
...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= |i#0| (LitInt 2))) (=> (>= |i#0| (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= |i#0| (LitInt 3))) (=> (>= |i#0| (LitInt 3)) (=> (and (>= |i#0| (LitInt 4)) (= (ControlFlow 0 2) (- 0 1))) (>= |i#0| (LitInt 5)))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (>= |i#0| (LitInt 1))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))
