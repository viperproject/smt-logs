...
(let ((anon6_correct  (=> (and (|A.__default.Reachable_h#canCall| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |s0#4@0|) (=> (A.__default.Reachable_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |s0#4@0|) (|A.__default.Next#canCall| |s0#4@0| |s#1|))) (and (=> (= (ControlFlow 0 6) (- 0 11)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (A.__default.Reachable_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (LitInt 0)) (A.__default.Next (LitInt 0) |s#1|))) (exists ((|$as#s00_1_0#0| Int) )  (and (A.__default.Reachable_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |$as#s00_1_0#0|) (A.__default.Next |$as#s00_1_0#0| |s#1|))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (A.__default.Reachable_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) (LitInt 0)) (A.__default.Next (LitInt 0) |s#1|))) (exists ((|$as#s00_1_0#0@@0| Int) )  (and (A.__default.Reachable_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |$as#s00_1_0#0@@0|) (A.__default.Next |$as#s00_1_0#0@@0| |s#1|)))) (=> (and (A.__default.Reachable_h ($LS $LZ) (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1)) |s0#3@0|) (A.__default.Next |s0#3@0| |s#1|)) (and (=> (= (ControlFlow 0 6) (- 0 10)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@5|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@5|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@5| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (|A.__default.Reachable_h#canCall| |_k##0@0| |s0#3@0|) (or (A.__default.Reachable_h ($LS $LZ) |_k##0@0| |s0#3@0|) (=> (< 0 (|ORD#Offset| |_k##0@0|)) (or (A.__default.Init |s0#3@0|) (exists ((|s0#1| Int) ) (!  (and (A.__default.Reachable_h ($LS ($LS $LZ)) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) |s0#1|) (A.__default.Next |s0#1| |s0#3@0|))
