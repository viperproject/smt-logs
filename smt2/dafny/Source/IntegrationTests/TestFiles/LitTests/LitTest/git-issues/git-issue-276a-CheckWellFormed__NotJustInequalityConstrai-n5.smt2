...
(set-info :boogie-vc-id CheckWellFormed$$NotJustInequalityConstraints.Byte)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (or (= (LitInt 3) (LitInt 2)) (= (LitInt 3) (LitInt 3))) (= (LitInt 3) (LitInt 5))))))
