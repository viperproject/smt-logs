...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.fNullify_split15)
...
)) ($HeapSucc $Heap@@23 $Heap@0))) (and (and (and ($IsAlloc refType this@@53 Tclass._module.Memory $Heap@@23) (forall (($o@@27 T@U) ($f@@14 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (and (= $o@@27 this@@53) (or (= $f@@14 _module.Memory.objects) (= $f@@14 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@27) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@27) $f@@14))))
...
)))) (and (and (or (not (= |o#0@@12| null)) (not true)) (or (not (= |o#0@@12| null)) (not true))) (and ($IsAlloc refType |o#0@@12| Tclass._module.Object $Heap@@23) (= |##m#0@0| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields))))))) (and (and (and (and ($IsAlloc MapType |##m#0@0| (TMap (TSeq TChar) Tclass._module.Object) $Heap@0) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@0)) (and (|_module.__default.RemoveKey#canCall| (TSeq TChar) Tclass._module.Object ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|)) (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |o#0@@12|) _module.Object.fields)) (_module.__default.RemoveKey (TSeq TChar) Tclass._module.Object reveal__module._default.RemoveKey ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|))))) (and (and ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@0) (= |##os#1@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@53) _module.Memory.objects)))) (and ($IsAlloc SetType |##os#1@0| (TSet Tclass._module.Object) $Heap@0) (|_module.Memory.edges#canCall| $Heap@0 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@53) _module.Memory.objects)))))) (and (and (and ($IsAlloc refType this@@53 Tclass._module.Memory $Heap@@23) (= |##os#2@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects)))) (and ($IsAlloc refType this@@53 Tclass._module.Memory $Heap@@23) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects)) (TSet Tclass._module.Object) $Heap@@23))) (and (and (|_module.Memory.edges#canCall| $Heap@@23 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects))) (|Set#Subset| (_module.Memory.edges $Heap@0 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@53) _module.Memory.objects))) (_module.Memory.edges $Heap@@23 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects))))) (and (or (not (= |o#0@@12| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))) ($IsAlloc refType |o#0@@12| Tclass._module.Object $Heap@@23)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
