...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let (($generated@@99 true))
(let (($generated@@100  (=> (and (< $generated@@91 ($generated 0)) (= (ControlFlow 0 7) 4)) $generated@@99)))
(let (($generated@@101  (=> (<= ($generated 0) $generated@@91) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= ($generated 15) 0)) (not true))) (=> (or (not (= ($generated 15) 0)) (not true)) (=> (= (ControlFlow 0 5) 4) $generated@@99))))))
(let (($generated@@102  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= ($generated 0) ($generated 0))) (=> (= (ControlFlow 0 2) (- 0 1)) ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 (< 0 ($generated@@85 100 ($generated 15))))))))))
(let (($generated@@103  (=> (= $generated@@92 ($generated@@29 $generated@@93 $generated@@94 $generated@@95 false)) (and (and (=> (= (ControlFlow 0 8) 2) $generated@@102) (=> (= (ControlFlow 0 8) 5) $generated@@101)) (=> (= (ControlFlow 0 8) 7) $generated@@100)))))
(let (($generated@@104  (=> (and (and ($generated@@96 $generated@@94) ($generated@@97 $generated@@94)) (and (= 0 $generated@@98) (= (ControlFlow 0 9) 8))) $generated@@103)))
$generated@@104)))))))
))
(check-sat)
(get-info :rlimit)
