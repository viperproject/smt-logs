...
(declare-fun _module.__default.ReplaceInMultiset2__Rejects (T@U) T@U)
(declare-fun |_module.__default.ReplaceInMultiset2__Rejects#canCall| (T@U) Bool)
...
(assert (forall ((|s#0| T@U) ) (! (= ($Is MultiSetType |s#0| Tclass._module.multiset2)  (and ($Is MultiSetType |s#0| (TMultiSet TInt)) (forall ((|n#1| Int) ) (!  (=> (> (|MultiSet#Multiplicity| |s#0| ($Box intType (int_2_U |n#1|))) 0) (= (|MultiSet#Multiplicity| |s#0| ($Box intType (int_2_U |n#1|))) (LitInt 2)))
 :qid |gitissue3059dfy.61:44|
 :skolemid |532|
))))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($Is MultiSetType |s#0| Tclass._module.multiset2))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.ReplaceInMultiset2__Rejects#canCall| |s#0@@0|) (and (< 1 $FunctionContextHeight) ($Is MultiSetType |s#0@@0| Tclass._module.multiset2))) (= (_module.__default.ReplaceInMultiset2__Rejects |s#0@@0|) (let ((|s'#0| (|MultiSet#UpdateMultiplicity| |s#0@@0| ($Box intType (int_2_U (LitInt 0))) (LitInt 1))))
|s'#0|)))
 :qid |gitissue3059dfy.63:43|
 :skolemid |511|
 :pattern ( (_module.__default.ReplaceInMultiset2__Rejects |s#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.ReplaceInMultiset2__Rejects#canCall| (Lit MultiSetType |s#0@@1|)) (and (< 1 $FunctionContextHeight) ($Is MultiSetType |s#0@@1| Tclass._module.multiset2))) (= (_module.__default.ReplaceInMultiset2__Rejects (Lit MultiSetType |s#0@@1|)) (let ((|s'#1| (|MultiSet#UpdateMultiplicity| (Lit MultiSetType |s#0@@1|) ($Box intType (int_2_U (LitInt 0))) (LitInt 1))))
|s'#1|)))
 :qid |gitissue3059dfy.63:43|
 :weight 3
 :skolemid |512|
 :pattern ( (_module.__default.ReplaceInMultiset2__Rejects (Lit MultiSetType |s#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@2| T@U) ) (!  (=> (or (|_module.__default.ReplaceInMultiset2__Rejects#canCall| |s#0@@2|) (and (< 1 $FunctionContextHeight) ($Is MultiSetType |s#0@@2| Tclass._module.multiset2))) (and (U_2_bool (Lit boolType (bool_2_U false))) ($Is MultiSetType (_module.__default.ReplaceInMultiset2__Rejects |s#0@@2|) Tclass._module.multiset2)))
 :qid |gitissue3059dfy.63:43|
 :skolemid |509|
 :pattern ( (_module.__default.ReplaceInMultiset2__Rejects |s#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ReplaceInMultiset2__Rejects)
...
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (=> (= |let#0#0#0| (|MultiSet#UpdateMultiplicity| |s#0@@3| ($Box intType (int_2_U (LitInt 0))) (LitInt 1))) (=> (and ($Is MultiSetType |let#0#0#0| (TMultiSet TInt)) (= |s'#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (not (= (|MultiSet#Multiplicity| |s'#Z#0@0| ($Box intType (int_2_U (LitInt 0)))) 2)) (not true))) (=> (or (not (= (|MultiSet#Multiplicity| |s'#Z#0@0| ($Box intType (int_2_U (LitInt 0)))) 2)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) ($Is MultiSetType |s'#Z#0@0| Tclass._module.multiset2)) (=> ($Is MultiSetType |s'#Z#0@0| Tclass._module.multiset2) (=> (= (_module.__default.ReplaceInMultiset2__Rejects |s#0@@3|) |s'#Z#0@0|) (=> (and ($Is MultiSetType (_module.__default.ReplaceInMultiset2__Rejects |s#0@@3|) Tclass._module.multiset2) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 1) anon5_Then_correct) (=> (= (ControlFlow 0 8) 4) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is MultiSetType |s#0@@3| Tclass._module.multiset2)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
