...
(declare-fun |lambda#30| (T@U T@U T@U T@U T@U T@U) T@U)
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@2| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) ($o@@7 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#30| |l#0@@2| |l#1@@2| |l#2| |l#3| |l#4| |l#5|) $o@@7 $f))  (=> (and (or (not (= $o@@7 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@2| $o@@7) |l#2|)))) (or (and (= $o@@7 |l#3|) (= $f |l#4|)) (|Set#IsMember| |l#5| ($Box refType $o@@7)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1410|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#30| |l#0@@2| |l#1@@2| |l#2| |l#3| |l#4| |l#5|) $o@@7 $f))
)))
...
(assert (forall ((|l#0@@7| T@U) (|l#1@@7| T@U) (|l#2@@3| T@U) (|l#3@@1| T@U) (|l#4@@0| T@U) (|l#5@@0| T@U) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|$y#0@@3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@1| |l#4@@0| |l#5@@0| |l#6| |l#7| |l#8| |l#9| |l#10|) |$y#0@@3|)) (exists ((|o#0@@10| T@U) (|n#0@@1| T@U) ) (!  (and (and (and ($Is refType |o#0@@10| |l#0@@7|) ($Is SeqType |n#0@@1| |l#1@@7|)) (and (|Set#IsMember| |l#2@@3| ($Box refType |o#0@@10|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3@@1| |o#0@@10|) |l#4@@0|))) ($Box SeqType |n#0@@1|)))) (= |$y#0@@3| ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@10| |n#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#5@@0| |o#0@@10|) |l#6|))) ($Box SeqType |n#0@@1|)))))))
 ...
 :qid |gitissue3855dfy.87:7|
 :skolemid |1416|
 :pattern ( (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@1| |l#4@@0| |l#5@@0| |l#6| |l#7| |l#8| |l#9| |l#10|) |$y#0@@3|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.Valid)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (=> (= (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 this@@40)  (and (and (_module.Memory.ObjectsAreValid $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)))) (_module.Memory.wholeEnchilada $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))))) (=> (and (and (|_module.Memory.ObjectsAreValid#canCall| $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (=> (_module.Memory.ObjectsAreValid $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (and (|_module.Memory.OutgoingReferencesAreInThisHeap#canCall| $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (=> (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (|_module.Memory.wholeEnchilada#canCall| $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))))))) ($Is boolType (bool_2_U (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 this@@40)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 8)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 3) (- 0 7)) |b$reqreads#2@0|) (=> |b$reqreads#2@0| (and (=> (= (ControlFlow 0 3) (- 0 6)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#4@1|) (=> |b$reqreads#4@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#5@1|) (=> |b$reqreads#5@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#6@1|)))))))))))))))
(let ((anon11_Else_correct  (=> (and (and (not (and (_module.Memory.ObjectsAreValid $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))))) (= |b$reqreads#5@1| true)) (and (= |b$reqreads#6@1| true) (= (ControlFlow 0 10) 3))) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and (_module.Memory.ObjectsAreValid $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)))) ($IsAllocBox ($Box refType this@@40) Tclass._module.Memory? $Heap@@21)) (=> (and (and (and (= |b$reqreads#5@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@40 _module.Memory.objects))) (= |##os#2@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)))) (and ($IsAlloc SetType |##os#2@0| (TSet Tclass._module.Object) $Heap@@21) (= |b$reqreads#6@0| (forall (($o@@12 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@12) alloc)))) (|Set#IsMember| |##os#2@0| ($Box refType $o@@12))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@12 $f@@0)))
 :qid |gitissue3855dfy.180:6|
 :skolemid |839|
))))) (and (and (|_module.Memory.wholeEnchilada#canCall| $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (= |b$reqreads#5@1| |b$reqreads#5@0|)) (and (= |b$reqreads#6@1| |b$reqreads#6@0|) (= (ControlFlow 0 9) 3)))) anon7_correct))))
(let ((anon10_Else_correct  (=> (not (_module.Memory.ObjectsAreValid $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)))) (=> (and (= |b$reqreads#3@1| true) (= |b$reqreads#4@1| true)) (and (=> (= (ControlFlow 0 12) 9) anon11_Then_correct) (=> (= (ControlFlow 0 12) 10) anon11_Else_correct))))))
(let ((anon10_Then_correct  (=> (_module.Memory.ObjectsAreValid $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) (=> (and (and (and ($IsAllocBox ($Box refType this@@40) Tclass._module.Memory? $Heap@@21) (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@40 _module.Memory.objects)))) (and (= |##os#1@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) ($IsAlloc SetType |##os#1@0| (TSet Tclass._module.Object) $Heap@@21))) (and (and (= |b$reqreads#4@0| (forall (($o@@13 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@13) alloc)))) (or (or (and (= $o@@13 this@@40) (= $f@@1 _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)) ($Box refType $o@@13))) (|Set#IsMember| |##os#1@0| ($Box refType $o@@13)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@13 $f@@1)))
 :qid |gitissue3855dfy.178:6|
 :skolemid |838|
))) (|_module.Memory.OutgoingReferencesAreInThisHeap#canCall| $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)))) (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= |b$reqreads#4@1| |b$reqreads#4@0|)))) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> (and ($IsAllocBox ($Box refType this@@40) Tclass._module.Memory? $Heap@@21) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@40 _module.Memory.objects)))) (=> (and (and (= |##os#0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) ($IsAlloc SetType |##os#0@0| (TSet Tclass._module.Object) $Heap@@21)) (and (= |b$reqreads#2@0| (forall (($o@@14 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@14) alloc)))) (|Set#IsMember| |##os#0@0| ($Box refType $o@@14))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@14 $f@@2)))
 :qid |gitissue3855dfy.176:6|
 :skolemid |837|
))) (|_module.Memory.ObjectsAreValid#canCall| $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))))) (and (=> (= (ControlFlow 0 13) 11) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#30| null $Heap@@21 alloc this@@40 _module.Memory.objects ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= this@@40 null)) (not true))) (=> (or (not (= this@@40 null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@40 _module.Memory.objects))) (and (=> (= (ControlFlow 0 14) (- 0 15)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 14) 1) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (=> (and (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.Memory) ($IsAlloc refType this@@40 Tclass._module.Memory $Heap@@21))) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 17) 14))) anon0_correct))))
