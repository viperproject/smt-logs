...
(declare-fun Tclass._module.Id () T@U)
...
(assert ($AlwaysAllocated Tclass._module.Id))
...
(assert (forall ((a@@5 T@U) (b@@2 T@U) ) (! (= (|Set#Subset| a@@5 b@@2) (forall ((o@@1 T@U) ) (!  (=> (|Set#IsMember| a@@5 o@@1) (|Set#IsMember| b@@2 o@@1))
...
(assert (forall ((v@@3 T@U) (t0@@2 T@U) (h@@1 T@U) ) (! (= ($IsAlloc SetType v@@3 (TSet t0@@2) h@@1) (forall ((bx@@3 T@U) ) (!  (=> (|Set#IsMember| v@@3 bx@@3) ($IsAllocBox bx@@3 t0@@2 h@@1))
...
(assert (forall ((v@@4 T@U) (t0@@3 T@U) (t1@@1 T@U) (h@@2 T@U) ) (! (= ($IsAlloc MapType v@@4 (TMap t0@@3 t1@@1) h@@2) (forall ((bx@@4 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@4) bx@@4) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@4) bx@@4) t1@@1 h@@2) ($IsAllocBox bx@@4 t0@@3 h@@2)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (|Set#Subset| ($Unbox SetType |$w#0|) |l#1|)))
 :qid |unknown.0:0|
 :skolemid |484|
...
(assert (forall ((v@@8 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (! (= ($Is MapType v@@8 (TMap t0@@5 t1@@3)) (forall ((bx@@8 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@8) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@8) t1@@3) ($IsBox bx@@8 t0@@5)))
...
(assert (forall ((|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType |lambda#2| |$w#0@@0|) ($Box intType (int_2_U (_module.__default.F ($Unbox SetType |$w#0@@0|)))))
 :qid |gitissue1158dfy.11:12|
 :skolemid |485|
 :pattern ( (MapType0Select BoxType BoxType |lambda#2| |$w#0@@0|))
)))
...
(assert (forall ((m@@10 T@U) ) (!  (or (= m@@10 |Map#Empty|) (exists ((k@@0 T@U) (v@@10 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@10) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@10)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon12_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (|Set#Subset| |i#0_0_0@0| |X#0@0|)  (or (|Set#Equal| |i#0_0_0@0| |Set#Empty|) (|Set#Equal| |i#0_0_0@0| |X#0@0|)))) (=> (= (|Set#Subset| |i#0_0_0@0| |X#0@0|)  (or (|Set#Equal| |i#0_0_0@0| |Set#Empty|) (|Set#Equal| |i#0_0_0@0| |X#0@0|))) (=> (= (ControlFlow 0 11) (- 0 10)) (= (|Set#Subset| |i#0_0_0@0| |X#0@0|) (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box SetType |i#0_0_0@0|))))))))
(let ((anon25_Else_correct  (=> (and (|Set#Equal| |i#0_0_0@0| |Set#Empty|) (= (ControlFlow 0 14) 11)) anon12_correct)))
(let ((anon25_Then_correct  (=> (and (not (|Set#Equal| |i#0_0_0@0| |Set#Empty|)) (= (ControlFlow 0 13) 11)) anon12_correct)))
(let ((anon24_Then_correct  (and (=> (= (ControlFlow 0 15) 13) anon25_Then_correct) (=> (= (ControlFlow 0 15) 14) anon25_Else_correct))))
(let ((anon24_Else_correct  (=> (and (= (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box SetType |i#0_0_0@0|)) (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box SetType |i#0_0_0@0|))) (= (ControlFlow 0 9) (- 0 8))) (= (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box SetType |i#0_0_0@0|)) (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box SetType |i#0_0_0@0|))))))
(let ((anon23_Then_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (= (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box SetType |i#0_0_0@0|)) (|Set#Subset| |i#0_0_0@0| |X#0@0|)))))
(let ((anon22_Then_correct true))
(let ((anon21_Then_correct true))
(let ((anon20_Then_correct  (=> ($Is SetType |i#0_0_0@0| (TSet Tclass._module.Id)) (and (and (and (and (=> (= (ControlFlow 0 16) 4) anon21_Then_correct) (=> (= (ControlFlow 0 16) 5) anon22_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon23_Then_correct)) (=> (= (ControlFlow 0 16) 15) anon24_Then_correct)) (=> (= (ControlFlow 0 16) 9) anon24_Else_correct)))))
(let ((anon20_Else_correct  (=> (and (forall ((|i#0_0_1| T@U) ) (!  (=> (and ($Is SetType |i#0_0_1| (TSet Tclass._module.Id)) (U_2_bool (Lit boolType (bool_2_U true)))) (= (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box SetType |i#0_0_1|)) (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box SetType |i#0_0_1|))))
 :qid |gitissue1158dfy.15:12|
 :skolemid |482|
 :pattern ( (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box SetType |i#0_0_1|)))
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box SetType |i#0_0_1|)))
)) (= (ControlFlow 0 3) (- 0 2))) (|Set#Equal| (|Map#Domain| |a#0@0|) (|Map#Domain| |b#0@0|)))))
(let ((anon19_Else_correct true))
(let ((anon3_correct  (=> (forall ((|i#1| T@U) ) (!  (=> ($Is SetType |i#1| (TSet Tclass._module.Id)) (=> (|Set#Subset| |i#1| |X#0@0|) (|_module.__default.F#canCall| |i#1|)))
 :qid |gitissue1158dfy.11:16|
 :skolemid |481|
 :pattern ( (_module.__default.F |i#1|))
 :pattern ( (|Set#Subset| |i#1| |X#0@0|))
)) (=> (and (= |a#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#1| (TSet Tclass._module.Id) |X#0@0|)) |lambda#2| (TMap (TSet Tclass._module.Id) TInt))) (= |##s#1@0| (Lit SetType |Set#Empty|))) (=> (and (and (and ($IsAlloc SetType |##s#1@0| (TSet Tclass._module.Id) $Heap) (|_module.__default.F#canCall| (Lit SetType |Set#Empty|))) (and ($IsAlloc SetType |X#0@0| (TSet Tclass._module.Id) $Heap) (|_module.__default.F#canCall| |X#0@0|))) (and (and (|_module.__default.F#canCall| (Lit SetType |Set#Empty|)) (|_module.__default.F#canCall| |X#0@0|)) (= |b#0@0| (|Map#Build| (|Map#Build| |Map#Empty| ($Box SetType (Lit SetType |Set#Empty|)) ($Box intType (int_2_U (_module.__default.F (Lit SetType |Set#Empty|))))) ($Box SetType |X#0@0|) ($Box intType (int_2_U (_module.__default.F |X#0@0|))))))) (and (and (=> (= (ControlFlow 0 17) 1) anon19_Else_correct) (=> (= (ControlFlow 0 17) 16) anon20_Then_correct)) (=> (= (ControlFlow 0 17) 3) anon20_Else_correct)))))))
(let ((anon18_Else_correct  (=> (and (not (|Set#Subset| |i#0@0| |X#0@0|)) (= (ControlFlow 0 20) 17)) anon3_correct)))
(let ((anon18_Then_correct  (=> (and (and (|Set#Subset| |i#0@0| |X#0@0|) ($IsAlloc SetType |i#0@0| (TSet Tclass._module.Id) $Heap)) (and (|_module.__default.F#canCall| |i#0@0|) (= (ControlFlow 0 19) 17))) anon3_correct)))
(let ((anon17_Then_correct  (=> (and ($Is SetType |i#0@0| (TSet Tclass._module.Id)) ($IsAlloc SetType |i#0@0| (TSet Tclass._module.Id) $Heap)) (and (=> (= (ControlFlow 0 21) 19) anon18_Then_correct) (=> (= (ControlFlow 0 21) 20) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (and ($Is SetType |i#0@0| (TSet Tclass._module.Id)) ($IsAlloc SetType |i#0@0| (TSet Tclass._module.Id) $Heap))) (= (ControlFlow 0 18) 17)) anon3_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |X#0@0| (|Set#UnionOne| |Set#Empty| |x#0|))) (and (=> (= (ControlFlow 0 22) 21) anon17_Then_correct) (=> (= (ControlFlow 0 22) 18) anon17_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |x#0| Tclass._module.Id) ($IsAllocBox |x#0| Tclass._module.Id $Heap))) (=> (and (and (and (and ($Is SetType |X#0| (TSet Tclass._module.Id)) ($IsAlloc SetType |X#0| (TSet Tclass._module.Id) $Heap)) true) (and (and ($Is MapType |a#0| (TMap (TSet Tclass._module.Id) TInt)) ($IsAlloc MapType |a#0| (TMap (TSet Tclass._module.Id) TInt) $Heap)) true)) (and (and (and ($Is MapType |b#0| (TMap (TSet Tclass._module.Id) TInt)) ($IsAlloc MapType |b#0| (TMap (TSet Tclass._module.Id) TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 23) 22)))) anon0_correct))))
