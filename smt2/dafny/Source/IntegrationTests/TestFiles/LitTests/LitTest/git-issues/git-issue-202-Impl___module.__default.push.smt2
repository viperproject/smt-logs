...
(assert (forall ((v@@1 T@U) (t@@1 T@U) (h T@U) (T@@0 T@T) ) (! (= ($IsAllocBox ($Box T@@0 v@@1) t@@1 h) ($IsAlloc T@@0 v@@1 t@@1 h))
 :qid |DafnyPreludebpl.217:18|
 :skolemid |39|
 :pattern ( ($IsAllocBox ($Box T@@0 v@@1) t@@1 h))
)))
...
(assert (forall ((v@@3 T@U) (t@@2 T@U) (T@@1 T@T) ) (! (= ($IsBox ($Box T@@1 v@@3) t@@2) ($Is T@@1 v@@3 t@@2))
 :qid |DafnyPreludebpl.214:18|
 :skolemid |38|
 :pattern ( ($IsBox ($Box T@@1 v@@3) t@@2))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.push)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |new_sequence#0@0| (|Seq#Append| |sequence#0| (|Seq#Build| |Seq#Empty| |element#0|))) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Equal| |sequence#0| (|Seq#Take| |new_sequence#0@0| (- (|Seq#Length| |new_sequence#0@0|) 1)))))))
