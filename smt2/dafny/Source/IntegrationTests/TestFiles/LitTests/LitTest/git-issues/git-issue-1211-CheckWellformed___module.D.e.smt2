...
(assert (forall ((t0@@6 T@U) (t1@@4 T@U) (h0 T@U) (h1 T@U) (f@@3 T@U) (bx0@@1 T@U) ) (!  (=> (and (and (and ($HeapSucc h0 h1) (and ($IsGoodHeap h0) ($IsGoodHeap h1))) (and ($IsBox bx0@@1 t0@@6) ($Is HandleTypeType f@@3 (Tclass._System.___hFunc1 t0@@6 t1@@4)))) (forall ((o@@1 T@U) (fld T@U) ) (!  (=> (and (or (not (= o@@1 null)) (not true)) (|Set#IsMember| (Reads1 t0@@6 t1@@4 h0 f@@3 bx0@@1) ($Box refType o@@1))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0 o@@1) fld) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1 o@@1) fld)))
 :qid |unknown.0:0|
 :skolemid |377|
))) (= (Requires1 t0@@6 t1@@4 h0 f@@3 bx0@@1) (Requires1 t0@@6 t1@@4 h1 f@@3 bx0@@1)))
 :qid |unknown.0:0|
 :skolemid |378|
 :pattern ( ($HeapSucc h0 h1) (Requires1 t0@@6 t1@@4 h1 f@@3 bx0@@1))
)))
(assert (forall ((t0@@7 T@U) (t1@@5 T@U) (h0@@0 T@U) (h1@@0 T@U) (f@@4 T@U) (bx0@@2 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@0 h1@@0) (and ($IsGoodHeap h0@@0) ($IsGoodHeap h1@@0))) (and ($IsBox bx0@@2 t0@@7) ($Is HandleTypeType f@@4 (Tclass._System.___hFunc1 t0@@7 t1@@5)))) (forall ((o@@2 T@U) (fld@@0 T@U) ) (!  (=> (and (or (not (= o@@2 null)) (not true)) (|Set#IsMember| (Reads1 t0@@7 t1@@5 h1@@0 f@@4 bx0@@2) ($Box refType o@@2))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@0 o@@2) fld@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@0 o@@2) fld@@0)))
 :qid |unknown.0:0|
 :skolemid |379|
))) (= (Requires1 t0@@7 t1@@5 h0@@0 f@@4 bx0@@2) (Requires1 t0@@7 t1@@5 h1@@0 f@@4 bx0@@2)))
 :qid |unknown.0:0|
 :skolemid |380|
...
(assert (forall ((t0@@9 T@U) (t1@@6 T@U) (h0@@1 T@U) (h1@@1 T@U) (f@@6 T@U) (bx0@@3 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@1 h1@@1) (and ($IsGoodHeap h0@@1) ($IsGoodHeap h1@@1))) (and ($IsBox bx0@@3 t0@@9) ($Is HandleTypeType f@@6 (Tclass._System.___hFunc1 t0@@9 t1@@6)))) (forall ((o@@3 T@U) (fld@@1 T@U) ) (!  (=> (and (or (not (= o@@3 null)) (not true)) (|Set#IsMember| (Reads1 t0@@9 t1@@6 h0@@1 f@@6 bx0@@3) ($Box refType o@@3))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@1 o@@3) fld@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@1 o@@3) fld@@1)))
 :qid |unknown.0:0|
 :skolemid |373|
))) (= (Reads1 t0@@9 t1@@6 h0@@1 f@@6 bx0@@3) (Reads1 t0@@9 t1@@6 h1@@1 f@@6 bx0@@3)))
 :qid |unknown.0:0|
 :skolemid |374|
...
(assert (forall ((t0@@10 T@U) (t1@@7 T@U) (h0@@2 T@U) (h1@@2 T@U) (f@@7 T@U) (bx0@@4 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@2 h1@@2) (and ($IsGoodHeap h0@@2) ($IsGoodHeap h1@@2))) (and ($IsBox bx0@@4 t0@@10) ($Is HandleTypeType f@@7 (Tclass._System.___hFunc1 t0@@10 t1@@7)))) (forall ((o@@4 T@U) (fld@@2 T@U) ) (!  (=> (and (or (not (= o@@4 null)) (not true)) (|Set#IsMember| (Reads1 t0@@10 t1@@7 h1@@2 f@@7 bx0@@4) ($Box refType o@@4))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@2 o@@4) fld@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@2 o@@4) fld@@2)))
 :qid |unknown.0:0|
 :skolemid |375|
))) (= (Reads1 t0@@10 t1@@7 h0@@2 f@@7 bx0@@4) (Reads1 t0@@10 t1@@7 h1@@2 f@@7 bx0@@4)))
 :qid |unknown.0:0|
 :skolemid |376|
...
(assert (forall ((t0@@11 T@U) (t1@@8 T@U) (h0@@3 T@U) (h1@@3 T@U) (f@@8 T@U) (bx0@@5 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@3 h1@@3) (and ($IsGoodHeap h0@@3) ($IsGoodHeap h1@@3))) (and ($IsBox bx0@@5 t0@@11) ($Is HandleTypeType f@@8 (Tclass._System.___hFunc1 t0@@11 t1@@8)))) (forall ((o@@5 T@U) (fld@@3 T@U) ) (!  (=> (and (or (not (= o@@5 null)) (not true)) (|Set#IsMember| (Reads1 t0@@11 t1@@8 h0@@3 f@@8 bx0@@5) ($Box refType o@@5))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@3 o@@5) fld@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@3 o@@5) fld@@3)))
 :qid |unknown.0:0|
 :skolemid |381|
))) (= (Apply1 t0@@11 t1@@8 h0@@3 f@@8 bx0@@5) (Apply1 t0@@11 t1@@8 h1@@3 f@@8 bx0@@5)))
 :qid |unknown.0:0|
 :skolemid |382|
 :pattern ( ($HeapSucc h0@@3 h1@@3) (Apply1 t0@@11 t1@@8 h1@@3 f@@8 bx0@@5))
)))
(assert (forall ((t0@@12 T@U) (t1@@9 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@9 T@U) (bx0@@6 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) (and ($IsBox bx0@@6 t0@@12) ($Is HandleTypeType f@@9 (Tclass._System.___hFunc1 t0@@12 t1@@9)))) (forall ((o@@6 T@U) (fld@@4 T@U) ) (!  (=> (and (or (not (= o@@6 null)) (not true)) (|Set#IsMember| (Reads1 t0@@12 t1@@9 h1@@4 f@@9 bx0@@6) ($Box refType o@@6))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@4 o@@6) fld@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@4 o@@6) fld@@4)))
 :qid |unknown.0:0|
 :skolemid |383|
))) (= (Apply1 t0@@12 t1@@9 h0@@4 f@@9 bx0@@6) (Apply1 t0@@12 t1@@9 h1@@4 f@@9 bx0@@6)))
 :qid |unknown.0:0|
 :skolemid |384|
...
(assert (forall ((t0@@17 T@U) (h0@@5 T@U) (h1@@5 T@U) (f@@13 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@5 h1@@5) (and ($IsGoodHeap h0@@5) ($IsGoodHeap h1@@5))) ($Is HandleTypeType f@@13 (Tclass._System.___hFunc0 t0@@17))) (forall ((o@@7 T@U) (fld@@5 T@U) ) (!  (=> (and (or (not (= o@@7 null)) (not true)) (|Set#IsMember| (Reads0 t0@@17 h0@@5 f@@13) ($Box refType o@@7))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@5 o@@7) fld@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@5 o@@7) fld@@5)))
 :qid |unknown.0:0|
 :skolemid |421|
))) (= (Requires0 t0@@17 h0@@5 f@@13) (Requires0 t0@@17 h1@@5 f@@13)))
 :qid |unknown.0:0|
 :skolemid |422|
 :pattern ( ($HeapSucc h0@@5 h1@@5) (Requires0 t0@@17 h1@@5 f@@13))
)))
(assert (forall ((t0@@18 T@U) (h0@@6 T@U) (h1@@6 T@U) (f@@14 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@6 h1@@6) (and ($IsGoodHeap h0@@6) ($IsGoodHeap h1@@6))) ($Is HandleTypeType f@@14 (Tclass._System.___hFunc0 t0@@18))) (forall ((o@@8 T@U) (fld@@6 T@U) ) (!  (=> (and (or (not (= o@@8 null)) (not true)) (|Set#IsMember| (Reads0 t0@@18 h1@@6 f@@14) ($Box refType o@@8))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@6 o@@8) fld@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@6 o@@8) fld@@6)))
 :qid |unknown.0:0|
 :skolemid |423|
))) (= (Requires0 t0@@18 h0@@6 f@@14) (Requires0 t0@@18 h1@@6 f@@14)))
 :qid |unknown.0:0|
 :skolemid |424|
...
(assert (forall ((t0@@21 T@U) (h0@@7 T@U) (h1@@7 T@U) (f@@15 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@7 h1@@7) (and ($IsGoodHeap h0@@7) ($IsGoodHeap h1@@7))) ($Is HandleTypeType f@@15 (Tclass._System.___hFunc0 t0@@21))) (forall ((o@@9 T@U) (fld@@7 T@U) ) (!  (=> (and (or (not (= o@@9 null)) (not true)) (|Set#IsMember| (Reads0 t0@@21 h0@@7 f@@15) ($Box refType o@@9))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@7 o@@9) fld@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@7 o@@9) fld@@7)))
 :qid |unknown.0:0|
 :skolemid |417|
))) (= (Reads0 t0@@21 h0@@7 f@@15) (Reads0 t0@@21 h1@@7 f@@15)))
 :qid |unknown.0:0|
 :skolemid |418|
 :pattern ( ($HeapSucc h0@@7 h1@@7) (Reads0 t0@@21 h1@@7 f@@15))
)))
(assert (forall ((t0@@22 T@U) (h0@@8 T@U) (h1@@8 T@U) (f@@16 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@8 h1@@8) (and ($IsGoodHeap h0@@8) ($IsGoodHeap h1@@8))) ($Is HandleTypeType f@@16 (Tclass._System.___hFunc0 t0@@22))) (forall ((o@@10 T@U) (fld@@8 T@U) ) (!  (=> (and (or (not (= o@@10 null)) (not true)) (|Set#IsMember| (Reads0 t0@@22 h1@@8 f@@16) ($Box refType o@@10))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@8 o@@10) fld@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@8 o@@10) fld@@8)))
 :qid |unknown.0:0|
 :skolemid |419|
))) (= (Reads0 t0@@22 h0@@8 f@@16) (Reads0 t0@@22 h1@@8 f@@16)))
 :qid |unknown.0:0|
 :skolemid |420|
 :pattern ( ($HeapSucc h0@@8 h1@@8) (Reads0 t0@@22 h1@@8 f@@16))
)))
(assert (forall ((t0@@23 T@U) (h0@@9 T@U) (h1@@9 T@U) (f@@17 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@9 h1@@9) (and ($IsGoodHeap h0@@9) ($IsGoodHeap h1@@9))) ($Is HandleTypeType f@@17 (Tclass._System.___hFunc0 t0@@23))) (forall ((o@@11 T@U) (fld@@9 T@U) ) (!  (=> (and (or (not (= o@@11 null)) (not true)) (|Set#IsMember| (Reads0 t0@@23 h0@@9 f@@17) ($Box refType o@@11))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@9 o@@11) fld@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@9 o@@11) fld@@9)))
 :qid |unknown.0:0|
 :skolemid |425|
))) (= (Apply0 t0@@23 h0@@9 f@@17) (Apply0 t0@@23 h1@@9 f@@17)))
 :qid |unknown.0:0|
 :skolemid |426|
...
(assert (forall ((t0@@24 T@U) (h0@@10 T@U) (h1@@10 T@U) (f@@18 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@10 h1@@10) (and ($IsGoodHeap h0@@10) ($IsGoodHeap h1@@10))) ($Is HandleTypeType f@@18 (Tclass._System.___hFunc0 t0@@24))) (forall ((o@@12 T@U) (fld@@10 T@U) ) (!  (=> (and (or (not (= o@@12 null)) (not true)) (|Set#IsMember| (Reads0 t0@@24 h1@@10 f@@18) ($Box refType o@@12))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@10 o@@12) fld@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@10 o@@12) fld@@10)))
 :qid |unknown.0:0|
 :skolemid |427|
))) (= (Apply0 t0@@24 h0@@10 f@@18) (Apply0 t0@@24 h1@@10 f@@18)))
 :qid |unknown.0:0|
 :skolemid |428|
...
(set-info :boogie-vc-id CheckWellformed$$_module.D.e)
