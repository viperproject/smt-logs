...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0|) |$l#0#heap#0| |$l#0#i#0|) ($Box charType ($Unbox charType (|Seq#Index| |l#0| (U_2_int ($Unbox intType |$l#0#i#0|))))))
 :qid |gitissue321adfy.8:7|
 :skolemid |489|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0|) |$l#0#heap#0| |$l#0#i#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1| Int) (|l#2| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0@@2| |l#1| |l#2|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))  (and ($IsBox |$l#0#i#0@@0| |l#0@@2|) (and (<= |l#1| (U_2_int ($Unbox intType |$l#0#i#0@@0|))) (< (U_2_int ($Unbox intType |$l#0#i#0@@0|)) |l#2|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |490|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0@@2| |l#1| |l#2|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
...
(let ((anon8_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 12) 11) anon9_Then_correct) (=> (= (ControlFlow 0 12) 4) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? Tclass._module.lowercase))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) alloc)))) (= (_System.array.Length $nw@1) (|Seq#Length| |s#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (|Seq#Length| |s#0@0|))) (Requires1 TInt TChar $Heap@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| |s#0@0|) (|lambda#2| TInt (LitInt 0) (|Seq#Length| |s#0@0|)) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |gitissue321adfy.9:9|
 :skolemid |483|
))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (|Seq#Length| |s#0@0|))) ($Is charType ($Unbox charType (Apply1 TInt TChar $Heap@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| |s#0@0|) (|lambda#2| TInt (LitInt 0) (|Seq#Length| |s#0@0|)) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))) Tclass._module.lowercase))
 :qid |gitissue321adfy.9:9|
 :skolemid |484|
)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass._module.lowercase))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 3)))) (and (and (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)) (and ($IsHeapAnchor $Heap@0) (= |s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 104))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 108))) ($Box charType (|char#FromInt| 111)))))))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (<= 0 (|Seq#Length| |s#0@0|))) (=> (<= 0 (|Seq#Length| |s#0@0|)) (and (=> (= (ControlFlow 0 13) 12) anon8_Then_correct) (=> (= (ControlFlow 0 13) 2) anon8_Else_correct))))))))))
