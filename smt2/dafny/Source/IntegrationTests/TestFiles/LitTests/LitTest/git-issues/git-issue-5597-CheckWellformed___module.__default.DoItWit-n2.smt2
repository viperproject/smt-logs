...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|numbers#0| T@U) ) (!  (=> (or (|_module.__default.DoItWithOptimizedLet#canCall| |numbers#0|) (and (< 1 $FunctionContextHeight) (and ($Is SetType |numbers#0| (TSet Tclass._module.Number)) (= (|Set#Card| |numbers#0|) (LitInt 0))))) ($Is SetType (_module.__default.DoItWithOptimizedLet |numbers#0|) (TSet Tclass._module.Integer)))
 :qid |gitissue5597dfy.44:31|
 :skolemid |493|
 :pattern ( (_module.__default.DoItWithOptimizedLet |numbers#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|numbers#0@@0| T@U) ) (!  (=> (or (|_module.__default.DoItWithOptimizedLet#canCall| |numbers#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is SetType |numbers#0@@0| (TSet Tclass._module.Number)) (= (|Set#Card| |numbers#0@@0|) (LitInt 0))))) (= (_module.__default.DoItWithOptimizedLet |numbers#0@@0|) (let ((|integers22#0| |numbers#0@@0|))
|integers22#0|)))
 :qid |gitissue5597dfy.44:31|
 :skolemid |496|
 :pattern ( (_module.__default.DoItWithOptimizedLet |numbers#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|numbers#0@@1| T@U) ) (!  (=> (or (|_module.__default.DoItWithOptimizedLet#canCall| (Lit SetType |numbers#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is SetType |numbers#0@@1| (TSet Tclass._module.Number)) (= (|Set#Card| (Lit SetType |numbers#0@@1|)) (LitInt 0))))) (= (_module.__default.DoItWithOptimizedLet (Lit SetType |numbers#0@@1|)) (let ((|integers22#1| (Lit SetType |numbers#0@@1|)))
|integers22#1|)))
 :qid |gitissue5597dfy.44:31|
 :weight 3
 :skolemid |497|
 :pattern ( (_module.__default.DoItWithOptimizedLet (Lit SetType |numbers#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|numbers#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.DoItWithOptimizedLet#canCall| |numbers#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($Is SetType |numbers#0@@2| (TSet Tclass._module.Number)) ($IsAlloc SetType |numbers#0@@2| (TSet Tclass._module.Number) $Heap)) (= (|Set#Card| |numbers#0@@2|) (LitInt 0))))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.__default.DoItWithOptimizedLet |numbers#0@@2|) (TSet Tclass._module.Integer) $Heap))
 :qid |gitissue5597dfy.44:10|
 :skolemid |494|
 :pattern ( ($IsAlloc SetType (_module.__default.DoItWithOptimizedLet |numbers#0@@2|) (TSet Tclass._module.Integer) $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.DoItWithOptimizedLet)
