...
(declare-fun Tagclass._System.array () T@U)
(declare-fun Tagclass._module.Basic () T@U)
(declare-fun Tagclass._module.Basic? () T@U)
...
(declare-fun Tclass._module.Basic? () T@U)
...
(assert (distinct TInt TagInt alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.array? Tagclass._System.array Tagclass._module.Basic Tagclass._module.Basic? tytagFamily$object tytagFamily$array tytagFamily$Basic)
)
...
(assert (forall (($o T@U) ) (! (= ($Is refType $o Tclass._module.Basic?)  (or (= $o null) (= (dtype $o) Tclass._module.Basic?)))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( ($Is refType $o Tclass._module.Basic?))
)))
...
(assert (forall ((|c#0@@1| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0@@1| Tclass._module.Basic $h@@1) ($IsAlloc refType |c#0@@1| Tclass._module.Basic? $h@@1))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.Basic $h@@1))
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.Basic? $h@@1))
)))
...
(assert (forall (($o@@2 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.Basic? $h@@4)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.Basic? $h@@4))
)))
...
(assert (forall ((|c#0@@4| T@U) ) (! (= ($Is refType |c#0@@4| Tclass._module.Basic)  (and ($Is refType |c#0@@4| Tclass._module.Basic?) (or (not (= |c#0@@4| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( ($Is refType |c#0@@4| Tclass._module.Basic))
 :pattern ( ($Is refType |c#0@@4| Tclass._module.Basic?))
)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (= (Tag Tclass._module.Basic) Tagclass._module.Basic))
(assert (= (TagFamily Tclass._module.Basic) tytagFamily$Basic))
(assert (= (Tag Tclass._module.Basic?) Tagclass._module.Basic?))
(assert (= (TagFamily Tclass._module.Basic?) tytagFamily$Basic))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (= (ControlFlow 0 5) (- 0 4)) (not ($Is refType $nw@0 (Tclass._System.array TInt)))))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) (not ($Is refType $nw@0 Tclass._module.Basic))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#obj#0| (and ($Is refType |obj#0| Tclass._System.object) ($IsAlloc refType |obj#0| Tclass._System.object $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
