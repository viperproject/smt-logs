...
(let ((anon60_Else_correct  (=> (and (not (and (<= (LitInt 0) |x#6@0|) (<= |x#6@0| (|Seq#Length| |nums#0@@2|)))) (= (ControlFlow 0 54) 52)) anon17_correct)))
(let ((anon60_Then_correct  (=> (and (and (<= (LitInt 0) |x#6@0|) (<= |x#6@0| (|Seq#Length| |nums#0@@2|))) (= (ControlFlow 0 53) 52)) anon17_correct)))
(let ((anon59_Else_correct  (=> (< |x#6@0| (LitInt 0)) (and (=> (= (ControlFlow 0 56) 53) anon60_Then_correct) (=> (= (ControlFlow 0 56) 54) anon60_Else_correct)))))
(let ((anon59_Then_correct  (=> (<= (LitInt 0) |x#6@0|) (and (=> (= (ControlFlow 0 55) 53) anon60_Then_correct) (=> (= (ControlFlow 0 55) 54) anon60_Else_correct)))))
(let ((anon58_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#23| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 57) 55) anon59_Then_correct) (=> (= (ControlFlow 0 57) 56) anon59_Else_correct)))))
(let ((anon58_Else_correct true))
(let ((anon57_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 58) 57) anon58_Then_correct) (=> (= (ControlFlow 0 58) 51) anon58_Else_correct)))))
(let ((anon69_Else_correct  (=> (= (ControlFlow 0 32) (- 0 31)) (= |y#0_0_0@0| |x#0_0@0|))))
(let ((anon69_Then_correct true))
(let ((anon68_Then_correct  (=> (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |y#0_0_0@0|))))) (and (=> (= (ControlFlow 0 33) 30) anon69_Then_correct) (=> (= (ControlFlow 0 33) 32) anon69_Else_correct)))))
(let ((anon72_Else_correct true))
(let ((anon41_correct  (=> (= (ControlFlow 0 21) (- 0 20)) (exists ((|x#8| T@U) ) (!  (and (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType |x#8|)))) (forall ((|y#1| Int) ) (!  (=> (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |y#1|))))) (= |y#1| (U_2_int |x#8|)))
 :qid |gitissue897dfy.9:37|
 :skolemid |492|
 :pattern ( ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |y#1|)))))
)))
 :qid |gitissue897dfy.9:17|
 :skolemid |493|
 :pattern ( ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType |x#8|))))
)))))
(let ((anon73_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |y#0@0|)))))) (= (ControlFlow 0 25) 21)) anon41_correct)))
(let ((anon73_Then_correct  (=> (and (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |y#0@0|))))) (= (ControlFlow 0 24) 21)) anon41_correct)))
(let ((anon72_Then_correct  (and (=> (= (ControlFlow 0 26) 24) anon73_Then_correct) (=> (= (ControlFlow 0 26) 25) anon73_Else_correct))))
(let ((anon71_Then_correct  (=> (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |x#7@0|))))) (and (=> (= (ControlFlow 0 27) 26) anon72_Then_correct) (=> (= (ControlFlow 0 27) 23) anon72_Else_correct)))))
(let ((anon71_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |x#7@0|)))))) (= (ControlFlow 0 22) 21)) anon41_correct)))
(let ((anon70_Then_correct  (and (=> (= (ControlFlow 0 28) 27) anon71_Then_correct) (=> (= (ControlFlow 0 28) 22) anon71_Else_correct))))
(let ((anon70_Else_correct true))
(let ((anon68_Else_correct  (=> (forall ((|y#0_0_1| T@U) ) (!  (=> (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType |y#0_0_1|)))) (= (U_2_int |y#0_0_1|) |x#0_0@0|))
 :qid |gitissue897dfy.16:12|
 :skolemid |489|
 :pattern ( ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType |y#0_0_1|))))
)) (and (=> (= (ControlFlow 0 29) 28) anon70_Then_correct) (=> (= (ControlFlow 0 29) 19) anon70_Else_correct)))))
(let ((anon67_Then_correct  (and (=> (= (ControlFlow 0 34) (- 0 36)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |missing#0_0@0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#x0_0#0_0| T@U) ) (! (|Set#IsMember| |missing#0_0@0| ($Box intType |$as#x0_0#0_0|))
 :qid |gitissue897dfy.14:9|
 :skolemid |488|
 ...
 :qid |gitissue897dfy.14:9|
 :skolemid |488|
))) (=> (|Set#IsMember| |missing#0_0@0| ($Box intType (int_2_U |x#0_0@0|))) (and (=> (= (ControlFlow 0 34) (- 0 35)) (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |x#0_0@0|)))))) (=> (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |x#0_0@0|))))) (and (=> (= (ControlFlow 0 34) 33) anon68_Then_correct) (=> (= (ControlFlow 0 34) 29) anon68_Else_correct)))))))))
(let ((anon67_Else_correct true))
(let ((anon28_correct  (=> (= |missing#0_0@0| (|Set#Difference| |range#0_0@0| (|Set#FromBoogieMap| (|lambda#0| TInt |nums#0@@2|)))) (and (=> (= (ControlFlow 0 37) (- 0 38)) (= (|Set#Card| |missing#0_0@0|) (LitInt 1))) (=> (= (|Set#Card| |missing#0_0@0|) (LitInt 1)) (and (=> (= (ControlFlow 0 37) 34) anon67_Then_correct) (=> (= (ControlFlow 0 37) 18) anon67_Else_correct)))))))
(let ((anon66_Else_correct  (=> (and (not (|Seq#Contains| |nums#0@@2| ($Box intType (int_2_U |i#0_2@0|)))) (= (ControlFlow 0 40) 37)) anon28_correct)))
(let ((anon66_Then_correct  (=> (and (|Seq#Contains| |nums#0@@2| ($Box intType (int_2_U |i#0_2@0|))) (= (ControlFlow 0 39) 37)) anon28_correct)))
(let ((anon65_Then_correct  (and (=> (= (ControlFlow 0 41) 39) anon66_Then_correct) (=> (= (ControlFlow 0 41) 40) anon66_Else_correct))))
(let ((anon65_Else_correct true))
(let ((anon25_correct  (=> (= |range#0_0@0| (|Set#FromBoogieMap| (|lambda#30| TInt (LitInt 0) (|Seq#Length| |nums#0@@2|)))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (= (|Set#Card| |range#0_0@0|) (+ (|Seq#Length| |nums#0@@2|) 1))) (=> (= (|Set#Card| |range#0_0@0|) (+ (|Seq#Length| |nums#0@@2|) 1)) (and (=> (= (ControlFlow 0 42) 41) anon65_Then_correct) (=> (= (ControlFlow 0 42) 17) anon65_Else_correct)))))))
(let ((anon64_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0_0@0|) (<= |i#0_0@0| (|Seq#Length| |nums#0@@2|)))) (= (ControlFlow 0 45) 42)) anon25_correct)))
(let ((anon64_Then_correct  (=> (and (and (<= (LitInt 0) |i#0_0@0|) (<= |i#0_0@0| (|Seq#Length| |nums#0@@2|))) (= (ControlFlow 0 44) 42)) anon25_correct)))
(let ((anon63_Else_correct  (=> (< |i#0_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 47) 44) anon64_Then_correct) (=> (= (ControlFlow 0 47) 45) anon64_Else_correct)))))
(let ((anon63_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 46) 44) anon64_Then_correct) (=> (= (ControlFlow 0 46) 45) anon64_Else_correct)))))
(let ((anon62_Then_correct  (and (=> (= (ControlFlow 0 48) 46) anon63_Then_correct) (=> (= (ControlFlow 0 48) 47) anon63_Else_correct))))
(let ((anon62_Else_correct true))
(let ((anon61_Then_correct  (and (=> (= (ControlFlow 0 49) 48) anon62_Then_correct) (=> (= (ControlFlow 0 49) 16) anon62_Else_correct))))
(let ((anon76_Else_correct true))
(let ((anon78_Else_correct true))
(let ((anon78_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U (LitInt 0))))))) (exists ((|x#11| T@U) ) (! (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType |x#11|))))
 :qid |gitissue897dfy.18:7|
 :skolemid |498|
...
(let ((anon48_correct  (=> (exists ((|x#8@@0| Int) ) (!  (and (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |x#8@@0|))))) (forall ((|y#1@@0| T@U) ) (!  (=> (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType |y#1@@0|)))) (= (U_2_int |y#1@@0|) |x#8@@0|))
 :qid |gitissue897dfy.9:37|
 :skolemid |496|
...
)) (and (=> (= (ControlFlow 0 8) 5) anon78_Then_correct) (=> (= (ControlFlow 0 8) 7) anon78_Else_correct)))))
(let ((anon77_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |y#2@0|)))))) (= (ControlFlow 0 12) 8)) anon48_correct)))
(let ((anon77_Then_correct  (=> (and (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |y#2@0|))))) (= (ControlFlow 0 11) 8)) anon48_correct)))
(let ((anon76_Then_correct  (and (=> (= (ControlFlow 0 13) 11) anon77_Then_correct) (=> (= (ControlFlow 0 13) 12) anon77_Else_correct))))
(let ((anon75_Then_correct  (=> (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |x#9@0|))))) (and (=> (= (ControlFlow 0 14) 13) anon76_Then_correct) (=> (= (ControlFlow 0 14) 10) anon76_Else_correct)))))
(let ((anon75_Else_correct  (=> (and (not (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType (int_2_U |x#9@0|)))))) (= (ControlFlow 0 9) 8)) anon48_correct)))
(let ((anon74_Then_correct  (and (=> (= (ControlFlow 0 15) 14) anon75_Then_correct) (=> (= (ControlFlow 0 15) 9) anon75_Else_correct))))
(let ((anon74_Else_correct true))
(let ((anon57_Else_correct  (=> (= |let#0#0#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| (LitInt 0) (|Seq#Length| |nums#0@@2|) |nums#0@@2|) (|lambda#3| TInt) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ)))) (=> (and ($Is HandleTypeType |let#0#0#0| (Tclass._System.___hTotalFunc1 TInt TBool)) (= |p#Z#0@0| |let#0#0#0|)) (and (and (=> (= (ControlFlow 0 50) 49) anon61_Then_correct) (=> (= (ControlFlow 0 50) 15) anon74_Then_correct)) (=> (= (ControlFlow 0 50) 3) anon74_Else_correct))))))
...
)) (and (and (=> (= (ControlFlow 0 59) 2) anon56_Then_correct) (=> (= (ControlFlow 0 59) 58) anon57_Then_correct)) (=> (= (ControlFlow 0 59) 50) anon57_Else_correct)))))
(let ((anon7_correct  (=> (and (and (<= (LitInt 0) |x#5@0|) (<= |x#5@0| (|Seq#Length| |nums#0@@2|))) (= (ControlFlow 0 61) 59)) anon9_correct)))
(let ((anon55_Else_correct  (=> (and (< |x#5@0| (LitInt 0)) (= (ControlFlow 0 63) 61)) anon7_correct)))
(let ((anon55_Then_correct  (=> (and (<= (LitInt 0) |x#5@0|) (= (ControlFlow 0 62) 61)) anon7_correct)))
(let ((anon54_Then_correct  (=> (|Seq#Contains| |nums#0@@2| ($Box intType (int_2_U |x#5@0|))) (and (=> (= (ControlFlow 0 64) 62) anon55_Then_correct) (=> (= (ControlFlow 0 64) 63) anon55_Else_correct)))))
(let ((anon54_Else_correct  (=> (and (=> (|Seq#Contains| |nums#0@@2| ($Box intType (int_2_U |x#5@0|))) (and (<= (LitInt 0) |x#5@0|) (<= |x#5@0| (|Seq#Length| |nums#0@@2|)))) (= (ControlFlow 0 60) 59)) anon9_correct)))
(let ((anon4_correct  (=> (= (|Set#Card| (|Set#FromBoogieMap| (|lambda#0| TInt |nums#0@@2|))) (|Seq#Length| |nums#0@@2|)) (and (=> (= (ControlFlow 0 65) 64) anon54_Then_correct) (=> (= (ControlFlow 0 65) 60) anon54_Else_correct)))))
(let ((anon53_Else_correct  (=> (and (not (|Seq#Contains| |nums#0@@2| ($Box intType (int_2_U |i#0@0|)))) (= (ControlFlow 0 67) 65)) anon4_correct)))
(let ((anon53_Then_correct  (=> (and (|Seq#Contains| |nums#0@@2| ($Box intType (int_2_U |i#0@0|))) (= (ControlFlow 0 66) 65)) anon4_correct)))
(let ((anon52_Then_correct  (and (=> (= (ControlFlow 0 68) 66) anon53_Then_correct) (=> (= (ControlFlow 0 68) 67) anon53_Else_correct))))
(let ((anon52_Else_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#23| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 69) 68) anon52_Then_correct) (=> (= (ControlFlow 0 69) 1) anon52_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is SeqType |nums#0@@2| (TSeq Tclass._System.nat))) (and (and ($Is SetType |range#0_0| (TSet TInt)) ($IsAlloc SetType |range#0_0| (TSet TInt) $Heap@@1)) true)) (and (and (and ($Is SetType |missing#0_0| (TSet TInt)) ($IsAlloc SetType |missing#0_0| (TSet TInt) $Heap@@1)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 70) 69)))) anon0_correct)))
