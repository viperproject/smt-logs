...
(declare-fun Tagclass._System.object () T@U)
(declare-fun Tagclass._module.EmptyQ () T@U)
(declare-fun tytagFamily$object () T@U)
(declare-fun tytagFamily$EmptyQ () T@U)
...
(declare-fun Tclass._module.EmptyQ () T@U)
...
(assert (distinct alloc Tagclass._System.object? Tagclass._System.object Tagclass._module.EmptyQ tytagFamily$object tytagFamily$EmptyQ)
)
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (= (Tag Tclass._module.EmptyQ) Tagclass._module.EmptyQ))
(assert (= (TagFamily Tclass._module.EmptyQ) tytagFamily$EmptyQ))
(assert (forall ((|x#0| T@U) ) (! (= ($Is refType |x#0| Tclass._module.EmptyQ)  (and ($Is refType |x#0| Tclass._System.object?) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( ($Is refType |x#0| Tclass._module.EmptyQ))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.xq)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) ($Is refType null Tclass._module.EmptyQ))))
