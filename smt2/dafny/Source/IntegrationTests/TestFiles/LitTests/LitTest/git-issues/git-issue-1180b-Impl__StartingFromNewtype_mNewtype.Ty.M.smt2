...
(declare-fun |r#0| () Int)
(set-info :boogie-vc-id Impl$$StartingFromNewtype_mNewtype.Ty.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |r#0@0| (StartingFromNewtype_mNewtype.Ty.c this)) (= (ControlFlow 0 2) (- 0 1))) (= |r#0@0| |x#0@@1|)))))
