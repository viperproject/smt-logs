...
(declare-fun _module.__default.Sum (T@U Int Int) T@U)
...
(declare-fun |lambda#14| (Bool Int T@U T@U Int Int Int T@U T@U) T@U)
...
(declare-fun |lambda#0| (Bool Int T@U T@U T@U Int) T@U)
(declare-fun $HeapSucc (T@U T@U) Bool)
(declare-fun $OneHeap () T@U)
(declare-fun |Set#Equal| (T@U T@U) Bool)
(declare-fun |lambda#4| (Bool Int T@U T@U Int Int Int T@U T@U) T@U)
...
(assert (distinct TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 tytagFamily$nat tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1|)
)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#pos#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0|) |$l#0#heap#0| |$l#0#pos#0|)) ($IsBox |$l#0#pos#0| |l#0|))
 :qid |unknown.0:0|
 :skolemid |540|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0|) |$l#0#heap#0| |$l#0#pos#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) ($Heap T@U) (|remaining#0| Int) (|n#0| Int) ) (!  (=> (or (|_module.__default.Sum#canCall| (LitInt |remaining#0|) (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (<= (LitInt 0) |remaining#0|)) (<= (LitInt 0) |n#0|)) (= (LitInt |remaining#0|) (LitInt |n#0|))))) (and (=> (or (not (= (LitInt |n#0|) (LitInt 0))) (not true)) (|_module.__default.Sum#canCall| (LitInt (- |remaining#0| 1)) (LitInt (- |n#0| 1)))) (= (_module.__default.Sum ($LS $ly) (LitInt |remaining#0|) (LitInt |n#0|)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#14| (= (LitInt |n#0|) (LitInt 0)) 0 Tclass._System.nat Tclass._System.nat (LitInt (- |remaining#0| 1)) (LitInt (- |n#0| 1)) 1 (|lambda#1| Tclass._System.nat) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) ($LS $ly))))))
 :qid |gitissue2852dfy.7:10|
 :weight 3
 :skolemid |534|
 :pattern ( (_module.__default.Sum ($LS $ly) (LitInt |remaining#0|) (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((|l#0@@0| Bool) (|l#1| Int) (|l#2| T@U) (|l#3| T@U) (|l#4| Int) (|l#5| Int) (|l#6| Int) (|l#7| T@U) (|l#8| T@U) (|$l#4#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#14| |l#0@@0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8|) |$l#4#ly#0|) (Handle1 (|lambda#0| |l#0@@0| |l#1| |l#2| |l#3| (Lit HandleTypeType (_module.__default.Sum |$l#4#ly#0| |l#4| |l#5|)) |l#6|) |l#7| |l#8|))
 :qid |gitissue2852dfy.15:24|
 :skolemid |544|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#14| |l#0@@0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8|) |$l#4#ly#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) ($Heap@@0 T@U) (|remaining#0@@0| Int) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.Sum#canCall| |remaining#0@@0| |n#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) (<= (LitInt 0) |remaining#0@@0|)) (<= (LitInt 0) |n#0@@0|)) (= |remaining#0@@0| |n#0@@0|)))) (and (=> (or (not (= |n#0@@0| (LitInt 0))) (not true)) (|_module.__default.Sum#canCall| (- |remaining#0@@0| 1) (- |n#0@@0| 1))) (= (_module.__default.Sum ($LS $ly@@0) |remaining#0@@0| |n#0@@0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (= |n#0@@0| (LitInt 0)) 0 Tclass._System.nat Tclass._System.nat (- |remaining#0@@0| 1) (- |n#0@@0| 1) 1 (|lambda#1| Tclass._System.nat) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) $ly@@0)))))
 :qid |gitissue2852dfy.7:10|
 :skolemid |532|
 :pattern ( (_module.__default.Sum ($LS $ly@@0) |remaining#0@@0| |n#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($ly@@1 T@U) (|remaining#0@@1| Int) (|n#0@@1| Int) ) (! (= (_module.__default.Sum ($LS $ly@@1) |remaining#0@@1| |n#0@@1|) (_module.__default.Sum $ly@@1 |remaining#0@@1| |n#0@@1|))
 :qid |gitissue2852dfy.7:10|
 :skolemid |528|
 :pattern ( (_module.__default.Sum ($LS $ly@@1) |remaining#0@@1| |n#0@@1|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@1 T@U) (|remaining#0@@2| Int) (|n#0@@2| Int) ) (!  (=> (or (|_module.__default.Sum#canCall| (LitInt |remaining#0@@2|) |n#0@@2|) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (<= (LitInt 0) |remaining#0@@2|)) (<= (LitInt 0) |n#0@@2|)) (= (LitInt |remaining#0@@2|) |n#0@@2|)))) (and (=> (or (not (= |n#0@@2| (LitInt 0))) (not true)) (|_module.__default.Sum#canCall| (LitInt (- |remaining#0@@2| 1)) (- |n#0@@2| 1))) (= (_module.__default.Sum ($LS $ly@@2) (LitInt |remaining#0@@2|) |n#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (= |n#0@@2| (LitInt 0)) 0 Tclass._System.nat Tclass._System.nat (LitInt (- |remaining#0@@2| 1)) (- |n#0@@2| 1) 1 (|lambda#1| Tclass._System.nat) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false)))) ($LS $ly@@2))))))
 :qid |gitissue2852dfy.7:10|
 :weight 3
 :skolemid |533|
 :pattern ( (_module.__default.Sum ($LS $ly@@2) (LitInt |remaining#0@@2|) |n#0@@2|) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((|l#0@@2| Bool) (|l#1@@0| Int) (|l#2@@0| T@U) (|l#3@@0| T@U) (|l#4@@0| Int) (|l#5@@0| Int) (|l#6@@0| Int) (|l#7@@0| T@U) (|l#8@@0| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@2| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0| |l#5@@0| |l#6@@0| |l#7@@0| |l#8@@0|) |$l#0#ly#0|) (Handle1 (|lambda#0| |l#0@@2| |l#1@@0| |l#2@@0| |l#3@@0| (_module.__default.Sum |$l#0#ly#0| |l#4@@0| |l#5@@0|) |l#6@@0|) |l#7@@0| |l#8@@0|))
 :qid |gitissue2852dfy.15:24|
 :skolemid |543|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@2| |l#1@@0| |l#2@@0| |l#3@@0| |l#4@@0| |l#5@@0| |l#6@@0| |l#7@@0| |l#8@@0|) |$l#0#ly#0|))
)))
(assert (forall ((|l#0@@3| T@U) (|l#1@@1| T@U) (|l#2@@1| T@U) (|l#3@@1| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#15| |l#0@@3| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@1| $o@@1) |l#2@@1|)))) |l#3@@1|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |545|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#15| |l#0@@3| |l#1@@1| |l#2@@1| |l#3@@1|) $o@@1 $f))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@3 T@U) (|remaining#0@@3| Int) (|n#0@@3| Int) ) (!  (=> (or (|_module.__default.Sum#canCall| |remaining#0@@3| |n#0@@3|) (and (< 0 $FunctionContextHeight) (and (and (<= (LitInt 0) |remaining#0@@3|) (<= (LitInt 0) |n#0@@3|)) (= |remaining#0@@3| |n#0@@3|)))) ($Is HandleTypeType (_module.__default.Sum $ly@@3 |remaining#0@@3| |n#0@@3|) (Tclass._System.___hTotalFunc1 Tclass._System.nat Tclass._System.nat)))
 :qid |gitissue2852dfy.7:10|
 :skolemid |530|
 :pattern ( (_module.__default.Sum $ly@@3 |remaining#0@@3| |n#0@@3|))
))))
(assert (forall ((|l#0@@4| Bool) (|l#1@@2| Int) (|l#2@@2| T@U) (|l#3@@2| T@U) (|l#4@@1| T@U) (|l#5@@1| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#pos#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@4| |l#1@@2| |l#2@@2| |l#3@@2| |l#4@@1| |l#5@@1|) |$l#0#heap#0@@0| |$l#0#pos#0@@0|) ($Box intType (int_2_U (let ((|x#0@@1| (ite |l#0@@4| |l#1@@2| (+ (U_2_int ($Unbox intType (Apply1 |l#2@@2| |l#3@@2| |$l#0#heap#0@@0| |l#4@@1| ($Box intType (int_2_U (+ (U_2_int ($Unbox intType |$l#0#pos#0@@0|)) |l#5@@1|)))))) (U_2_int ($Unbox intType |$l#0#pos#0@@0|))))))
|x#0@@1|))))
 :qid |gitissue2852dfy.15:24|
 :skolemid |539|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@4| |l#1@@2| |l#2@@2| |l#3@@2| |l#4@@1| |l#5@@1|) |$l#0#heap#0@@0| |$l#0#pos#0@@0|))
)))
(assert (forall ((|l#0@@5| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#pos#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@5|) |$l#0#heap#0@@1| |$l#0#pos#0@@1|) |l#0@@5|)
 :qid |gitissue2852dfy.14:3|
 :skolemid |542|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@5|) |$l#0#heap#0@@1| |$l#0#pos#0@@1|))
)))
(push 1)
...
(let ((anon8_correct  (=> (and (and (= |x#Z#0@0| |let#0#0#0|) (= |lambdaResult#0| |x#Z#0@0|)) (and ($Is intType (int_2_U |lambdaResult#0|) Tclass._System.nat) (= (ControlFlow 0 5) 3))) anon9_correct)))
(let ((anon15_Else_correct  (=> (or (not (= |n#0@@4| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 15)) ($Is intType (int_2_U (- |remaining#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |remaining#0@@4| 1)) Tclass._System.nat) (=> (and (= |##remaining#0@0| (- |remaining#0@@4| 1)) ($IsAlloc intType (int_2_U |##remaining#0@0|) Tclass._System.nat |$lambdaHeap#0@0|)) (and (=> (= (ControlFlow 0 8) (- 0 14)) ($Is intType (int_2_U (- |n#0@@4| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@4| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@4| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat |$lambdaHeap#0@0|)) (and (=> (= (ControlFlow 0 8) (- 0 13)) (= |##remaining#0@0| |##n#0@0|)) (=> (= |##remaining#0@0| |##n#0@0|) (and (=> (= (ControlFlow 0 8) (- 0 12)) (or (<= 0 |remaining#0@@4|) (= |##remaining#0@0| |remaining#0@@4|))) (=> (or (<= 0 |remaining#0@@4|) (= |##remaining#0@0| |remaining#0@@4|)) (and (=> (= (ControlFlow 0 8) (- 0 11)) (< |##remaining#0@0| |remaining#0@@4|)) (=> (< |##remaining#0@0| |remaining#0@@4|) (=> (|_module.__default.Sum#canCall| (- |remaining#0@@4| 1) (- |n#0@@4| 1)) (and (=> (= (ControlFlow 0 8) (- 0 10)) ($Is intType (int_2_U (+ |pos#0@0| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |pos#0@0| 1)) Tclass._System.nat) (and (=> (= (ControlFlow 0 8) (- 0 9)) ($Is intType (int_2_U (+ (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass._System.nat |$lambdaHeap#0@0| (_module.__default.Sum ($LS $LZ) (- |remaining#0@@4| 1) (- |n#0@@4| 1)) ($Box intType (int_2_U (+ |pos#0@0| 1)))))) |pos#0@0|)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass._System.nat |$lambdaHeap#0@0| (_module.__default.Sum ($LS $LZ) (- |remaining#0@@4| 1) (- |n#0@@4| 1)) ($Box intType (int_2_U (+ |pos#0@0| 1)))))) |pos#0@0|)) Tclass._System.nat) (=> (and (and (= |let#0#0#0| (+ (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass._System.nat |$lambdaHeap#0@0| (_module.__default.Sum ($LS $LZ) (- |remaining#0@@4| 1) (- |n#0@@4| 1)) ($Box intType (int_2_U (+ |pos#0@0| 1)))))) |pos#0@0|)) (|_module.__default.Sum#canCall| (- |remaining#0@@4| 1) (- |n#0@@4| 1))) (and ($Is intType (int_2_U |let#0#0#0|) Tclass._System.nat) (= (ControlFlow 0 8) 5))) anon8_correct)))))))))))))))))))))
(let ((anon15_Then_correct  (=> (= |n#0@@4| (LitInt 0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |let#0#0#0| (LitInt 0)) (=> (and ($Is intType (int_2_U |let#0#0#0|) Tclass._System.nat) (= (ControlFlow 0 6) 5)) anon8_correct)))))))
(let ((anon14_Then_correct  (=> (and (<= (LitInt 0) |pos#0@0|) (= |$_Frame#l0@0| (|lambda#15| null |$lambdaHeap#0@0| alloc false))) (and (=> (= (ControlFlow 0 16) 6) anon15_Then_correct) (=> (= (ControlFlow 0 16) 8) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (< |pos#0@0| (LitInt 0)) (= (ControlFlow 0 4) 3)) anon9_correct)))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 17) 16) anon14_Then_correct) (=> (= (ControlFlow 0 17) 4) anon14_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#15| null $Heap@@2 alloc false)) (= |remaining#0@@4| |n#0@@4|)) (and (and (=> (= (ControlFlow 0 18) 1) anon12_Then_correct) (=> (= (ControlFlow 0 18) 17) anon13_Then_correct)) (=> (= (ControlFlow 0 18) 2) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (<= (LitInt 0) |remaining#0@@4|) (<= (LitInt 0) |n#0@@4|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
