...
(declare-fun |OtherBindersInExpressions.__default.Forall0#canCall| () Bool)
(declare-fun OtherBindersInExpressions.__default.Forall0 () Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.Forall0#canCall| (< 0 $FunctionContextHeight)) (= OtherBindersInExpressions.__default.Forall0 (LitInt 40)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.Forall0#canCall| (< 0 $FunctionContextHeight)) (= OtherBindersInExpressions.__default.Forall0 (LitInt 40)))))
...
(set-info :boogie-vc-id CheckWellformed$$OtherBindersInExpressions.__default.Forall0)
...
(let ((anon8_Else_correct  (=> (and (not (and ($IsBox |c#2@0| Tclass.OtherBindersInExpressions.C) ($IsAllocBox |c#2@0| Tclass.OtherBindersInExpressions.C $Heap))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> (and ($IsBox |c#2@0| Tclass.OtherBindersInExpressions.C) ($IsAllocBox |c#2@0| Tclass.OtherBindersInExpressions.C $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
