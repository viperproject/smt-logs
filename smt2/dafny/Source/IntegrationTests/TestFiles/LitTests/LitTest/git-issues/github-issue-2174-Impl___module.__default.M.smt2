...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let (($generated@@151 true))
(let (($generated@@152  (=> (= $generated@@143 ($generated@@66 64)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 $generated@@143) (< $generated@@143 256))) (=> (and (<= 0 $generated@@143) (< $generated@@143 256)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (bvule ((_ int2bv 8) $generated@@143) #x80)) (=> (= $generated@@144 ($generated@@66 64)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 $generated@@144) (< $generated@@144 256))) (=> (and (<= 0 $generated@@144) (< $generated@@144 256)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bvule #x40 #x80)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (bvshl $generated@@138 (concat #x000000000000000000000000000000 ((_ int2bv 8) $generated@@143))) (bvshl $generated@@138 (concat #x000000000000000000000000000000 #x40))))))))))))))
(let (($generated@@153  (=> (= $generated@@145 ($generated@@82 $generated@@146 $generated@@147 $generated@@148 false)) (and (=> (= (ControlFlow 0 8) 2) $generated@@152) (=> (= (ControlFlow 0 8) 7) $generated@@151)))))
(let (($generated@@154  (=> (and (and (and ($generated@@149 $generated@@147) ($generated@@150 $generated@@147)) (<= ($generated@@66 0) $generated@@143)) (and (= 1 $generated@@139) (= (ControlFlow 0 9) 8))) $generated@@153)))
$generated@@154)))))
))
(check-sat)
(get-info :rlimit)
