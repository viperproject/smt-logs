...
(set-info :boogie-vc-id CheckWellFormed$$_module.CompilableNaturalCell)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (_module.Cell.Cell_q (Lit DatatypeTypeType (|#_module.Cell.Cell| (LitInt 0)))) (= (ControlFlow 0 3) (- 0 2))) (>= (LitInt (_module.Cell.x (Lit DatatypeTypeType (|#_module.Cell.Cell| (LitInt 0))))) (LitInt 0)))))
