...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x##0@0| (LitInt 1))) (and (= |p##0@0| (Lit MultiSetType |MultiSet#Empty|)) (= (ControlFlow 0 2) (- 0 1)))) (> (|MultiSet#Multiplicity| |p##0@0| ($Box intType (int_2_U |x##0@0|))) 0))))
