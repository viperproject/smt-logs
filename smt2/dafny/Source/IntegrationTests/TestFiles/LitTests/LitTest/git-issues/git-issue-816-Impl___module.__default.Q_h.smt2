...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@111 true))
(let (($generated@@112  (=> (and (< 0 ($generated@@30 $generated@@102)) (= (ControlFlow 0 2) (- 0 1))) (= $generated@@103 ($generated@@19 17)))))
(let (($generated@@113  (=> (= $generated@@104 ($generated@@42 $generated@@105 $generated@@106 $generated@@107 false)) (and (=> (= (ControlFlow 0 4) 2) $generated@@112) (=> (= (ControlFlow 0 4) 3) $generated@@111)))))
(let (($generated@@114  (=> (and (and ($generated@@108 $generated@@106) ($generated@@109 $generated@@106)) (and (= 1 $generated@@110) (= (ControlFlow 0 5) 4))) $generated@@113)))
$generated@@114)))))
))
(check-sat)
