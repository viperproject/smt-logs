...
(declare-fun _module._default.GimmieOne$W () T@U)
(declare-fun |defass#c#0| () Bool)
(declare-fun |c#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.GimmieOne)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|))) (=> (and (= |c#0@0| (|Seq#Index| |s#0| (LitInt 0))) (= (ControlFlow 0 2) (- 0 1))) true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |s#0| (TSeq _module._default.GimmieOne$W)) ($IsAlloc SeqType |s#0| (TSeq _module._default.GimmieOne$W) $Heap))) (and (and (=> |defass#c#0| (and ($IsBox |c#0| _module._default.GimmieOne$W) ($IsAllocBox |c#0| _module._default.GimmieOne$W $Heap))) (= 0 $FunctionContextHeight)) (and (not (|Seq#Equal| |s#0| |Seq#Empty|)) (= (ControlFlow 0 4) 2)))) anon0_correct)))
