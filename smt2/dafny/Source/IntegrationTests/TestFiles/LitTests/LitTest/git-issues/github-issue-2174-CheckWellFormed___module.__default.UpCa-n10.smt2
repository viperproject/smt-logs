...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.UpCastRShiftMasking)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_correct  (=> (and (<= (LitInt 0) |idx#0|) (<= |idx#0| (LitInt 64))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |idx#0|) (< |idx#0| 256))) (=> (and (<= 0 |idx#0|) (< |idx#0| 256)) (=> (= (ControlFlow 0 2) (- 0 1)) (bvule ((_ int2bv 8) |idx#0|) #x80))))))))
(let ((anon4_Else_correct  (=> (and (< |idx#0| (LitInt 0)) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (<= (LitInt 0) |idx#0|) (= (ControlFlow 0 4) 2)) anon3_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |idx#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
