...
(set-info :boogie-vc-id Impl$$_module.__default.MatchCaseParsing)
...
(let ((anon20_Then_correct  (=> (and (and (= |_mcc#1#2_0@0| (LitInt (- 0 10))) (_System.Tuple2.___hMake2_q |p#0|)) (and (_System.Tuple2.___hMake2_q |p#0|) (= (ControlFlow 0 6) (- 0 5)))) (= (U_2_int ($Unbox intType (_System.Tuple2._1 |p#0|))) (LitInt (- 0 10))))))
(let ((anon19_Else_correct  (=> (or (not (= |_mcc#1#2_0@0| (LitInt 10))) (not true)) (and (=> (= (ControlFlow 0 8) 6) anon20_Then_correct) (=> (= (ControlFlow 0 8) 7) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (and (and (= |_mcc#1#2_0@0| (LitInt 10)) (_System.Tuple2.___hMake2_q |p#0|)) (and (_System.Tuple2.___hMake2_q |p#0|) (= (ControlFlow 0 4) (- 0 3)))) (= (U_2_int ($Unbox intType (_System.Tuple2._1 |p#0|))) (LitInt 10)))))
(let ((anon18_Then_correct  (=> (= |_mcc#0#2_0@0| (LitInt 10)) (and (=> (= (ControlFlow 0 9) 4) anon19_Then_correct) (=> (= (ControlFlow 0 9) 8) anon19_Else_correct)))))
(let ((anon18_Else_correct true))
(let ((anon17_Then_correct  (=> (= |p#0| (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |_mcc#0#2_0@0|)) ($Box intType (int_2_U |_mcc#1#2_0@0|)))) (and (=> (= (ControlFlow 0 10) 9) anon18_Then_correct) (=> (= (ControlFlow 0 10) 2) anon18_Else_correct)))))
(let ((anon17_Else_correct true))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (= |y#0@5| (LitInt 2))) (=> (= |y#0@5| (LitInt 2)) (and (=> (= (ControlFlow 0 11) 10) anon17_Then_correct) (=> (= (ControlFlow 0 11) 1) anon17_Else_correct))))))
(let ((anon5_correct  (=> (and (= |y#0@5| |y#0@4|) (= (ControlFlow 0 14) 11)) anon6_correct)))
(let ((anon16_Else_correct  (=> (and (and (or (not (= |x#0| (LitInt (- 0 1)))) (not true)) (= |y#0@3| (LitInt 2))) (and (= |y#0@4| |y#0@3|) (= (ControlFlow 0 16) 14))) anon5_correct)))
(let ((anon16_Then_correct  (=> (and (and (= |x#0| (LitInt (- 0 1))) (= |y#0@2| (+ 3 |x#0|))) (and (= |y#0@4| |y#0@2|) (= (ControlFlow 0 15) 14))) anon5_correct)))
(let ((anon15_Else_correct  (=> (or (not (= |x#0| (LitInt 2))) (not true)) (and (=> (= (ControlFlow 0 17) 15) anon16_Then_correct) (=> (= (ControlFlow 0 17) 16) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (and (= |x#0| (LitInt 2)) (= |y#0@1| (+ |x#0| |y#0@0|))) (and (= |y#0@5| |y#0@1|) (= (ControlFlow 0 13) 11))) anon6_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |y#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 18) 13) anon15_Then_correct) (=> (= (ControlFlow 0 18) 17) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |p#0| (Tclass._System.Tuple2 TInt TInt)) ($IsAlloc DatatypeTypeType |p#0| (Tclass._System.Tuple2 TInt TInt) $Heap)) (|$IsA#_System.Tuple2| |p#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
