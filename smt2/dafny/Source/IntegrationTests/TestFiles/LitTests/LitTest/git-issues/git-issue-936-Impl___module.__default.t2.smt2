...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|_module.Status.PropagateFailure#canCall| this) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this Tclass._module.Status))) (= (_module.Status.PropagateFailure this) this))
 :qid |gitissue936dfy.7:12|
 :skolemid |543|
 :pattern ( (_module.Status.PropagateFailure this))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@1 T@U) ) (!  (=> (or (|_module.Status.PropagateFailure#canCall| this@@1) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this@@1 Tclass._module.Status))) ($Is DatatypeTypeType (_module.Status.PropagateFailure this@@1) Tclass._module.Status))
 :qid |gitissue936dfy.7:12|
 :skolemid |541|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@2 T@U) ) (!  (=> (or (|_module.Status.PropagateFailure#canCall| (Lit DatatypeTypeType this@@2)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this@@2 Tclass._module.Status))) (= (_module.Status.PropagateFailure (Lit DatatypeTypeType this@@2)) (Lit DatatypeTypeType this@@2)))
 :qid |gitissue936dfy.7:12|
 :weight 3
 :skolemid |544|
 :pattern ( (_module.Status.PropagateFailure (Lit DatatypeTypeType this@@2)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (_module.Status.Failure_q |r#0@2|))) (=> (not (_module.Status.Failure_q |r#0@2|)) (=> (= (ControlFlow 0 2) (- 0 1)) (= |z#0@2| (LitInt 42)))))))
(let ((anon5_Else_correct  (=> (not (_module.Status.IsFailure |call2formal@r#0@0|)) (=> (and (and (= |z#0@1| (LitInt 42)) (= |r#0@2| |r#0@0|)) (and (= |z#0@2| |z#0@1|) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon5_Then_correct  (=> (and (and (and (_module.Status.IsFailure |call2formal@r#0@0|) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) Tclass._module.Status $Heap@0)) (and (|_module.Status.PropagateFailure#canCall| |call2formal@r#0@0|) (|_module.Status.PropagateFailure#canCall| |call2formal@r#0@0|))) (and (and (= |r#0@1| (_module.Status.PropagateFailure |call2formal@r#0@0|)) (= |r#0@2| |r#0@1|)) (and (= |z#0@2| |z#0@0|) (= (ControlFlow 0 4) 2)))) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |r#0@0| (Lit DatatypeTypeType |#_module.Status.Success|)) (= |z#0@0| (LitInt 0))) (=> (and (and (and ($Is DatatypeTypeType |valueOrError0#0@0| Tclass._module.Status) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| Tclass._module.Status $Heap)) (= |i##0@0| (LitInt 1))) (and (and ($Is DatatypeTypeType |call2formal@r#0| Tclass._module.Status) ($IsAlloc DatatypeTypeType |call2formal@r#0| Tclass._module.Status $Heap)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (=> (and (and (and (and ($Is DatatypeTypeType |call2formal@r#0@0| Tclass._module.Status) ($IsAlloc DatatypeTypeType |call2formal@r#0@0| Tclass._module.Status $Heap@0)) (=> (= |i##0@0| (LitInt 1)) (not (_module.Status.Failure_q |call2formal@r#0@0|)))) (and (=> (= |i##0@0| (LitInt 2)) (_module.Status.Failure_q |call2formal@r#0@0|)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |gitissue936dfy.10:8|
 :skolemid |481|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)))) (and (and ($HeapSucc $Heap $Heap@0) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) Tclass._module.Status $Heap@0)) (and (|_module.Status.IsFailure#canCall| |call2formal@r#0@0|) (|_module.Status.IsFailure#canCall| |call2formal@r#0@0|)))) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is DatatypeTypeType |r#0| Tclass._module.Status) ($IsAlloc DatatypeTypeType |r#0| Tclass._module.Status $Heap))) (=> (and (and (and ($Is DatatypeTypeType |valueOrError0#0| Tclass._module.Status) ($IsAlloc DatatypeTypeType |valueOrError0#0| Tclass._module.Status $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
