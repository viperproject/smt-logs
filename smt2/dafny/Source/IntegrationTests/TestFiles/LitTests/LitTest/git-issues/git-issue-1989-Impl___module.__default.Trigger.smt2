...
(set-info :boogie-vc-id Impl$$_module.__default.Trigger)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|s#1| T@U) ) (!  (=> ($Is SeqType |s#1| (TSeq TInt)) (= (_module.__default.P |s#1|) (_module.__default.P |s#1|)))
 :qid |gitissue1989dfy.67:18|
 :skolemid |1129|
 :pattern ( (_module.__default.P |s#1|))
 :pattern ( (_module.__default.P |s#1|))
))) (=> (forall ((|s#1@@0| T@U) ) (!  (=> ($Is SeqType |s#1@@0| (TSeq TInt)) (= (_module.__default.P |s#1@@0|) (_module.__default.P |s#1@@0|)))
 :qid |gitissue1989dfy.67:18|
 :skolemid |1129|
 :pattern ( (_module.__default.P |s#1@@0|))
 :pattern ( (_module.__default.P |s#1@@0|))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|s#3| T@U) ) (!  (=> ($Is SeqType |s#3| (TSeq TInt)) (= (_module.__default.P |s#3|) (_module.__default.P |s#3|)))
 :qid |gitissue1989dfy.70:18|
 :skolemid |1131|
 :pattern ( (_module.__default.P |s#3|))
))))))))
