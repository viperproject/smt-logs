// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868b.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868b-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868b.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "WoahThat'sDeep (well-formedness)"} CheckWellformed$$_module.__default.WoahThat_ksDeep(o#0: DatatypeType, x#0: Seq)
{
  ...
  var let#11#0#0: Seq;
    ...
    else
    {
        ...
        {
            havoc x1#Z#0;
            assume {:id "id3"} let#1#0#0 == x#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, TSeq(TChar));
            assume {:id "id4"} x1#Z#0 == let#1#0#0;
            havoc x2#Z#0;
            assume {:id "id5"} let#2#0#0 == x1#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, TSeq(TChar));
            assume {:id "id6"} x2#Z#0 == let#2#0#0;
            havoc x3#Z#0;
            assume {:id "id7"} let#3#0#0 == x2#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#3#0#0, TSeq(TChar));
            assume {:id "id8"} x3#Z#0 == let#3#0#0;
            havoc x4#Z#0;
            assume {:id "id9"} let#4#0#0 == x3#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#4#0#0, TSeq(TChar));
            assume {:id "id10"} x4#Z#0 == let#4#0#0;
            havoc x5#Z#0;
            assume {:id "id11"} let#5#0#0 == x4#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#5#0#0, TSeq(TChar));
            assume {:id "id12"} x5#Z#0 == let#5#0#0;
            havoc x6#Z#0;
            assume {:id "id13"} let#6#0#0 == x5#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#6#0#0, TSeq(TChar));
            assume {:id "id14"} x6#Z#0 == let#6#0#0;
            havoc x7#Z#0;
            assume {:id "id15"} let#7#0#0 == x6#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#7#0#0, TSeq(TChar));
            assume {:id "id16"} x7#Z#0 == let#7#0#0;
            havoc x8#Z#0;
            assume {:id "id17"} let#8#0#0 == x7#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#8#0#0, TSeq(TChar));
            assume {:id "id18"} x8#Z#0 == let#8#0#0;
            havoc x9#Z#0;
            assume {:id "id19"} let#9#0#0 == x8#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#9#0#0, TSeq(TChar));
            assume {:id "id20"} x9#Z#0 == let#9#0#0;
            havoc x10#Z#0;
            assume {:id "id21"} let#10#0#0 == x9#Z#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#10#0#0, TSeq(TChar));
            assume {:id "id22"} x10#Z#0 == let#10#0#0;
            assume {:id "id23"} let#0#0#0 == #_module.Option.Some($Box(x10#Z#0));
            assume true;
            // CheckWellformedWithResult: any expression
        ...
        assume {:id "id24"} valueOrError0#Z#0 == let#0#0#0;
        ...
        if (_module.Option.IsFailure(TSeq(TChar), valueOrError0#Z#0))
        {
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(valueOrError0#Z#0), Tclass._module.Option(TSeq(TChar)), $Heap);
            assert {:id "id25"} {:subsumption 0} _module.Option.None_q(valueOrError0#Z#0);
            ...
            assume {:id "id26"} _module.__default.WoahThat_ksDeep(o#0, x#0)
        ...
        else
        {
            ...
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(valueOrError0#Z#0), Tclass._module.Option(TSeq(TChar)), $Heap);
            assert {:id "id27"} {:subsumption 0} _module.Option.Some_q(valueOrError0#Z#0);
            assume _module.Option.Some_q(valueOrError0#Z#0);
            assume _module.Option.Extract#canCall(TSeq(TChar), valueOrError0#Z#0);
            assume {:id "id28"} let#11#0#0
               == $Unbox(_module.Option.Extract(TSeq(TChar), valueOrError0#Z#0)): Seq;
            assume _module.Option.Extract#canCall(TSeq(TChar), valueOrError0#Z#0);
            // CheckWellformedWithResult: any expression
            assume $Is(let#11#0#0, TSeq(TChar));
            assume {:id "id29"} r#Z#0 == let#11#0#0;
            assume {:id "id30"} _module.__default.WoahThat_ksDeep(o#0, x#0) == #_module.Option.Some($Box(r#Z#0));
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.WoahThat_ksDeep(o#0, x#0), Tclass._module.Option(TSeq(TChar)));
            return;
...
axiom (forall a#12#0#0: Box :: 
  { #_module.Option.Some(a#12#0#0) } 
  DatatypeCtorId(#_module.Option.Some(a#12#0#0)) == ##_module.Option.Some);
}
...
axiom (forall d: DatatypeType :: 
  { _module.Option.Some_q(d) } 
  _module.Option.Some_q(d)
     ==> (exists a#13#0#0: Box :: d == #_module.Option.Some(a#13#0#0)));

// Constructor $Is
axiom (forall _module.Option$T: Ty, a#14#0#0: Box :: 
  { $Is(#_module.Option.Some(a#14#0#0), Tclass._module.Option(_module.Option$T)) } 
  $Is(#_module.Option.Some(a#14#0#0), Tclass._module.Option(_module.Option$T))
     <==> $IsBox(a#14#0#0, _module.Option$T));

// Constructor $IsAlloc
axiom (forall _module.Option$T: Ty, a#14#0#0: Box, $h: Heap :: 
  { $IsAlloc(#_module.Option.Some(a#14#0#0), Tclass._module.Option(_module.Option$T), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Option.Some(a#14#0#0), Tclass._module.Option(_module.Option$T), $h)
       <==> $IsAllocBox(a#14#0#0, _module.Option$T, $h)));
...
axiom (forall a#15#0#0: Box :: 
  { #_module.Option.Some(Lit(a#15#0#0)) } 
  #_module.Option.Some(Lit(a#15#0#0)) == Lit(#_module.Option.Some(a#15#0#0)));

function _module.Option.value(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#16#0#0: Box :: 
  { #_module.Option.Some(a#16#0#0) } 
  _module.Option.value(#_module.Option.Some(a#16#0#0)) == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box :: 
  { #_module.Option.Some(a#17#0#0) } 
  BoxRank(a#17#0#0) < DtRank(#_module.Option.Some(a#17#0#0)));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Option.Extract (well-formedness)"} CheckWellformed$$_module.Option.Extract(_module.Option$T: Ty, this: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id66"} _module.Option.Some_q(this);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assert {:id "id67"} _module.Option.Some_q(this);
        assume {:id "id68"} _module.Option.Extract(_module.Option$T, this) == _module.Option.value(this);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $IsBox(_module.Option.Extract(_module.Option$T, this), _module.Option$T);
        return;
