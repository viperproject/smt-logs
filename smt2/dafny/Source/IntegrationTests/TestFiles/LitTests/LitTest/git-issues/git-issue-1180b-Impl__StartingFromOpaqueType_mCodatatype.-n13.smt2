...
(assert (distinct alloc Tagclass._System.nat Tagclass.StartingFromOpaqueType_mCodatatype.Ty tytagFamily$nat tytagFamily$Ty)
)
...
(assert (forall ((d T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) ($Is DatatypeTypeType d Tclass.StartingFromOpaqueType_mCodatatype.Ty)) ($IsAlloc DatatypeTypeType d Tclass.StartingFromOpaqueType_mCodatatype.Ty $h@@1))
 :qid |unknown.0:0|
 :skolemid |1980|
 :pattern ( ($IsAlloc DatatypeTypeType d Tclass.StartingFromOpaqueType_mCodatatype.Ty $h@@1))
)))
...
(declare-fun |r#0| () Int)
(set-info :boogie-vc-id Impl$$StartingFromOpaqueType_mCodatatype.Ty.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |r#0@0| (StartingFromOpaqueType_mCodatatype.Ty.c this)) (= (ControlFlow 0 2) (- 0 1))) (= |r#0@0| |x#0@@1|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType this Tclass.StartingFromOpaqueType_mCodatatype.Ty) ($IsAlloc DatatypeTypeType this Tclass.StartingFromOpaqueType_mCodatatype.Ty $Heap)) (<= (LitInt 0) |x#0@@1|)) (and (and (<= (LitInt 0) |r#0|) (= 1 $FunctionContextHeight)) (and (or (not (= |x#0@@1| 9)) (not true)) (= (ControlFlow 0 3) 2)))) anon0_correct))))
