// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-580.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-580-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-580.dfy
...
axiom (forall $o: ref :: 
  ...
  $Is($o, Tclass._module.B?()) <==> $o == null || implements$_module.B(dtype($o)));
...
function implements$_module.B(ty: Ty) : bool;
...
axiom implements$_module.A(Tclass._module.C?());
axiom implements$_module.B(Tclass._module.C?());
}
...
procedure {:verboseName "C.Foo (well-formedness)"} CheckWellFormed$$_module.C.Foo(this: ref
       where this != null
         && 
...
procedure {:verboseName "C.Foo (call)"} Call$$_module.C.Foo(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.C())
         && $IsAlloc(this, Tclass._module.C(), $Heap));
...
procedure {:verboseName "C.Foo (correctness)"} Impl$$_module.C.Foo(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.C())
         && $IsAlloc(this, Tclass._module.C(), $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "C.Foo (correctness)"} Impl$$_module.C.Foo(this: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Foo, Impl$$_module.C.Foo
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-580.dfy(8,5)
    assume true;
...
axiom (forall $o: ref :: 
  { $Is($o, Tclass._module.C?()) } 
  $Is($o, Tclass._module.C?()) ==> $Is($o, Tclass._module.A?()));

axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass._module.C?()) } 
  $IsBox(bx, Tclass._module.C?()) ==> $IsBox(bx, Tclass._module.A?()));
...
axiom (forall $o: ref :: 
  { $Is($o, Tclass._module.C?()) } 
  $Is($o, Tclass._module.C?()) ==> $Is($o, Tclass._module.B?()));

axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass._module.C?()) } 
  $IsBox(bx, Tclass._module.C?()) ==> $IsBox(bx, Tclass._module.B?()));
