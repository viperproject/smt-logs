...
(declare-fun Tagclass.ConcreteModule.Status () T@U)
(declare-fun |##ConcreteModule.Status.Success| () T@U)
(declare-fun |##ConcreteModule.Status.Failure| () T@U)
...
(declare-fun Tclass.ConcreteModule.Status () T@U)
...
(declare-fun ConcreteModule.Status.PropagateFailure (T@U) T@U)
(declare-fun |ConcreteModule.Status.PropagateFailure#canCall| (T@U) Bool)
(declare-fun ConcreteModule.Status.IsFailure (T@U) Bool)
(declare-fun |#ConcreteModule.Status.Failure| (Int) T@U)
(declare-fun ConcreteModule.Status.error (T@U) Int)
(declare-fun ConcreteModule.Status.Success_q (T@U) Bool)
(declare-fun ConcreteModule.Status.Failure_q (T@U) Bool)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun $IsAllocBox (T@U T@U T@U) Bool)
(declare-fun |ConcreteModule.Status.IsFailure#canCall| (T@U) Bool)
...
(declare-fun |m#0| () Int)
(declare-fun |valueOrError1#0_1_0@0| () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun |call1formal@r#0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun null () T@U)
(declare-fun |call1formal@r#0@0@@0| () T@U)
(declare-fun |newtype$check#0_0@0| () Int)
(declare-fun |n#0| () Int)
(declare-fun |valueOrError0#0_0@0| () T@U)
(declare-fun |call1formal@r#0@@0| () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun |newtype$check#0@0| () Int)
(declare-fun |r#0| () T@U)
(declare-fun |valueOrError0#0_0| () T@U)
(declare-fun |valueOrError1#0_1_0| () T@U)
(set-info :boogie-vc-id Impl$$ConcreteModule.__default.execute__external__method)
...
(let ((anon14_Then_correct  (=> (ConcreteModule.Status.IsFailure |call1formal@r#0@0|) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) Tclass.ConcreteModule.Status $Heap@1) (= (ControlFlow 0 6) (- 0 5))) (|ConcreteModule.Status.IsFailure#canCall| |call1formal@r#0@0|)) (or (ConcreteModule.Status.IsFailure |call1formal@r#0@0|) (ConcreteModule.Status.Failure_q |call1formal@r#0@0|))))))
(let ((anon13_Then_correct  (=> (= |m#0| (LitInt 1)) (=> (and ($Is DatatypeTypeType |valueOrError1#0_1_0@0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |valueOrError1#0_1_0@0| Tclass.ConcreteModule.Status $Heap@0)) (=> (and (and ($Is DatatypeTypeType |call1formal@r#0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |call1formal@r#0| Tclass.ConcreteModule.Status $Heap)) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (=> (and (and (and ($Is DatatypeTypeType |call1formal@r#0@0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |call1formal@r#0@0| Tclass.ConcreteModule.Status $Heap@1)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0)))
 :qid |gitissue1665dfy.44:10|
 :skolemid |486|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0))
))) (and (and ($HeapSucc $Heap@0 $Heap@1) ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) Tclass.ConcreteModule.Status $Heap@1)) (and (|ConcreteModule.Status.IsFailure#canCall| |call1formal@r#0@0|) (|ConcreteModule.Status.IsFailure#canCall| |call1formal@r#0@0|)))) (and (=> (= (ControlFlow 0 8) 6) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon14_Else_correct))))))))
(let ((anon13_Else_correct true))
(let ((anon12_Else_correct  (=> (and (not (ConcreteModule.Status.IsFailure |call1formal@r#0@0@@0|)) (= |newtype$check#0_0@0| (LitInt 1))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= (LitInt 0) |newtype$check#0_0@0|)) (=> (<= (LitInt 0) |newtype$check#0_0@0|) (and (=> (= (ControlFlow 0 9) 8) anon13_Then_correct) (=> (= (ControlFlow 0 9) 4) anon13_Else_correct)))))))
(let ((anon12_Then_correct  (=> (ConcreteModule.Status.IsFailure |call1formal@r#0@0@@0|) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0@@0|) Tclass.ConcreteModule.Status $Heap@0) (= (ControlFlow 0 3) (- 0 2))) (|ConcreteModule.Status.IsFailure#canCall| |call1formal@r#0@0@@0|)) (or (ConcreteModule.Status.IsFailure |call1formal@r#0@0@@0|) (ConcreteModule.Status.Failure_q |call1formal@r#0@0@@0|))))))
(let ((anon11_Then_correct  (=> (= |n#0| (LitInt 0)) (=> (and ($Is DatatypeTypeType |valueOrError0#0_0@0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |valueOrError0#0_0@0| Tclass.ConcreteModule.Status $Heap)) (=> (and (and ($Is DatatypeTypeType |call1formal@r#0@@0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |call1formal@r#0@@0| Tclass.ConcreteModule.Status $Heap)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and ($Is DatatypeTypeType |call1formal@r#0@0@@0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |call1formal@r#0@0@@0| Tclass.ConcreteModule.Status $Heap@0)) (forall (($o@@1 T@U) ) (!  (=> (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@1) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@1) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@1)))
 :qid |gitissue1665dfy.44:10|
 :skolemid |486|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@1))
))) (and (and ($HeapSucc $Heap $Heap@0) ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0@@0|) Tclass.ConcreteModule.Status $Heap@0)) (and (|ConcreteModule.Status.IsFailure#canCall| |call1formal@r#0@0@@0|) (|ConcreteModule.Status.IsFailure#canCall| |call1formal@r#0@0@@0|)))) (and (=> (= (ControlFlow 0 11) 3) anon12_Then_correct) (=> (= (ControlFlow 0 11) 9) anon12_Else_correct))))))))
(let ((anon11_Else_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (and (=> (= (ControlFlow 0 12) 11) anon11_Then_correct) (=> (= (ControlFlow 0 12) 1) anon11_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (<= (LitInt 0) |n#0|) (<= (LitInt 0) |m#0|)) (and ($Is DatatypeTypeType |r#0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |r#0| Tclass.ConcreteModule.Status $Heap))) (and (and ($Is DatatypeTypeType |valueOrError0#0_0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |valueOrError0#0_0| Tclass.ConcreteModule.Status $Heap)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError1#0_1_0| Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType |valueOrError1#0_1_0| Tclass.ConcreteModule.Status $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 14) 12)))) anon0_correct))))
