...
(assert (distinct alloc Tagclass._module.Gen |##_module.Gen.Create| tytagFamily$Gen)
)
...
(assert (forall ((_module.Gen$X@@1 T@U) (|a#7#0#0| T@U) ($h T@U) ) (!  (=> ($IsGoodHeap $h) (= ($IsAlloc DatatypeTypeType (|#_module.Gen.Create| |a#7#0#0|) (Tclass._module.Gen _module.Gen$X@@1) $h) ($IsAllocBox |a#7#0#0| _module.Gen$X@@1 $h)))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Gen.Create| |a#7#0#0|) (Tclass._module.Gen _module.Gen$X@@1) $h))
)))
...
(assert (forall ((d@@3 T@U) (_module.Gen$X@@4 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Gen.Create_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass._module.Gen _module.Gen$X@@4) $h@@0))) ($IsAllocBox (_module.Gen.x d@@3) _module.Gen$X@@4 $h@@0))
 :qid |unknown.0:0|
 :skolemid |538|
 :pattern ( ($IsAllocBox (_module.Gen.x d@@3) _module.Gen$X@@4 $h@@0))
)))
...
(assert (forall ((_module.Gen$X@@5 T@U) (bx T@U) ) (!  (=> ($IsBox bx (Tclass._module.Gen _module.Gen$X@@5)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx)) bx) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx) (Tclass._module.Gen _module.Gen$X@@5))))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( ($IsBox bx (Tclass._module.Gen _module.Gen$X@@5)))
)))
...
(declare-fun _module._default.GetXX$X () T@U)
(declare-fun $Heap () T@U)
(declare-fun |ux#0_0@0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.GetXX)
...
(let ((anon4_Then_correct  (=> (= |g#0| (|#_module.Gen.Create| |_mcc#0#0_0@0|)) (=> (and (and (and ($IsBox |_mcc#0#0_0@0| _module._default.GetXX$X) ($IsAllocBox |_mcc#0#0_0@0| _module._default.GetXX$X $Heap)) (and ($IsBox |ux#0_0@0| _module._default.GetXX$X) ($IsAllocBox |ux#0_0@0| _module._default.GetXX$X $Heap))) (and (and (= |let#0_0#0#0| |_mcc#0#0_0@0|) ($IsBox |let#0_0#0#0| _module._default.GetXX$X)) (and (= |ux#0_0@0| |let#0_0#0#0|) (= (ControlFlow 0 2) (- 0 1))))) true))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 4) 2) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |g#0| (Tclass._module.Gen _module._default.GetXX$X)) ($IsAlloc DatatypeTypeType |g#0| (Tclass._module.Gen _module._default.GetXX$X) $Heap)) (|$IsA#_module.Gen| |g#0|)) (=> |defass#m#0| (and ($IsBox |m#0| _module._default.GetXX$X) ($IsAllocBox |m#0| _module._default.GetXX$X $Heap)))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 4))) anon0_correct))))
