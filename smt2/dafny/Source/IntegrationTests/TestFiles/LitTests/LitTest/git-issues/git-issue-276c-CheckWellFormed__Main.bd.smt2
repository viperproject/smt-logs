...
(set-info :boogie-vc-id CheckWellFormed$$Main.bd)
...
(let ((anon11_Else_correct  (=> (and (not (and (<= (|Seq#Length| Main.__default.s) (|Seq#Length| Main.__default.s)) (|Seq#SameUntil| Main.__default.s Main.__default.s (|Seq#Length| Main.__default.s)))) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (and (<= (|Seq#Length| Main.__default.s) (|Seq#Length| Main.__default.s)) (|Seq#SameUntil| Main.__default.s Main.__default.s (|Seq#Length| Main.__default.s))) (= (ControlFlow 0 6) 4)) anon6_correct)))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite  (and (<= (|Seq#Length| Main.__default.s) (|Seq#Length| Main.__default.s)) (|Seq#SameUntil| Main.__default.s Main.__default.s (|Seq#Length| Main.__default.s))) 30 40))))))
