...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.EnsureRevealPreconditionForComparisonWithFunction)
...
(let ((anon5_Else_correct  (=> (>= |i#0@@2| (LitInt 0)) (=> (and (and (= (_module.__default.EnsureRevealPreconditionForComparisonWithFunction |i#0@@2|) |i#0@@2|) ($Is intType (int_2_U (_module.__default.EnsureRevealPreconditionForComparisonWithFunction |i#0@@2|)) TInt)) (and (= (_module.__default.EnsureRevealPreconditionForComparisonWithFunction |i#0@@2|) |r#0|) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct))))
