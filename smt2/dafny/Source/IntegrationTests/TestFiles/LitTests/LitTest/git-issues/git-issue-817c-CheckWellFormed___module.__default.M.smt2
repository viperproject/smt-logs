...
(let ((anon5_Else_correct  (=> (and (=> (_module.Result.Success_q |r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) (LitInt 200))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (_module.Result.Success_q |r#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Result.Success_q |r#0@0|)) (=> (_module.Result.Success_q |r#0@0|) (=> (and (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) (LitInt 200)) (= (ControlFlow 0 2) 1)) anon4_correct))))))
...
)) ($HeapSucc $Heap $Heap@0)) (and ($Is DatatypeTypeType |r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0@0| (Tclass._module.Result TInt) $Heap@0))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
