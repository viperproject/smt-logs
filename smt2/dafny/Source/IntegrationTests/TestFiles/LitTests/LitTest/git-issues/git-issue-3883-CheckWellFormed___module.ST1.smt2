...
(assert (forall ((t@@0 T@U) (u@@1 T@U) ) (! (= (Inv0_TMap (TMap t@@0 u@@1)) t@@0)
 :qid |DafnyPreludebpl.57:15|
 :skolemid |650|
 :pattern ( (TMap t@@0 u@@1))
)))
(assert (forall ((t@@1 T@U) (u@@2 T@U) ) (! (= (Inv1_TMap (TMap t@@1 u@@2)) u@@2)
 :qid |DafnyPreludebpl.58:15|
 :skolemid |651|
 :pattern ( (TMap t@@1 u@@2))
)))
(assert (forall ((t@@2 T@U) (u@@3 T@U) ) (! (= (Tag (TMap t@@2 u@@3)) TagMap)
...
(assert (forall ((bx@@0 T@U) (s T@U) (t@@5 T@U) ) (!  (=> ($IsBox bx@@0 (TMap s t@@5)) (and (= ($Box MapType ($Unbox MapType bx@@0)) bx@@0) ($Is MapType ($Unbox MapType bx@@0) (TMap s t@@5))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |677|
 :pattern ( ($IsBox bx@@0 (TMap s t@@5)))
)))
(assert (forall ((|_System._tuple#2$T0@@2| T@U) (|_System._tuple#2$T1@@2| T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._System.Tuple2 |_System._tuple#2$T0@@2| |_System._tuple#2$T1@@2|)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) (Tclass._System.Tuple2 |_System._tuple#2$T0@@2| |_System._tuple#2$T1@@2|))))
 :qid |unknown.0:0|
 :skolemid |1100|
 :pattern ( ($IsBox bx@@1 (Tclass._System.Tuple2 |_System._tuple#2$T0@@2| |_System._tuple#2$T1@@2|)))
)))
(assert  (and (and (and (and (and (and (forall ((t0@@1 T@T) (t1@@0 T@T) (t2 T@T) (val@@1 T@U) (m@@3 T@U) (x0@@1 T@U) (x1 T@U) ) (! (= (MapType1Select t0@@1 t1@@0 t2 (MapType1Store t0@@1 t1@@0 t2 m@@3 x0@@1 x1 val@@1) x0@@1 x1) val@@1)
...
(assert (forall ((m@@9 T@U) (v@@2 T@U) ) (! (= (|Set#IsMember| (|Map#Values| m@@9) v@@2) (exists ((u@@5 T@U) ) (!  (and (|Set#IsMember| (|Map#Domain| m@@9) u@@5) (= v@@2 (MapType0Select BoxType BoxType (|Map#Elements| m@@9) u@@5)))
...
(assert (forall ((v@@3 T@U) (t0@@2 T@U) (t1@@1 T@U) ) (! (= ($Is MapType v@@3 (TMap t0@@2 t1@@1)) (forall ((bx@@3 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@3) bx@@3) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@3) bx@@3) t1@@1) ($IsBox bx@@3 t0@@2)))
...
(assert (forall ((m@@10 T@U) ) (!  (or (= m@@10 |Map#Empty|) (exists ((k@@0 T@U) (v@@4 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@10) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@4)))
...
(declare-fun _module.ST1$T () T@U)
(declare-fun _module.ST1$U () T@U)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.ST1)
...
(let ((anon9_Else_correct  (=> (and (not (let ((|m#0| (Lit MapType |Map#Empty|)))
(|Map#Equal| |m#0| |Map#Empty|))) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (and (let ((|m#0@@0| (Lit MapType |Map#Empty|)))
(|Map#Equal| |m#0@@0| |Map#Empty|)) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon8_Then_correct  (=> (= |let#0#0#0| (Lit MapType |Map#Empty|)) (=> (and ($Is MapType |let#0#0#0| (TMap _module.ST1$T _module.ST1$U)) (= |m#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 6) 4) anon9_Then_correct) (=> (= (ControlFlow 0 6) 5) anon9_Else_correct))))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (<= (ite (let ((|m#1| (Lit MapType |Map#Empty|)))
(|Map#Equal| |m#1| |Map#Empty|)) 0 8) (LitInt 0)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 6) anon8_Then_correct) (=> (= (ControlFlow 0 7) 2) anon10_Then_correct)))))
