...
(set-info :boogie-vc-id CheckWellformed$$Digit.__default.BASE)
...
(let ((anon4_Then_correct  (=> (and (<= (LitInt 0) Digit.__default.BASE) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U true))))))
