...
(declare-fun |call3formal@possible#0@0| () Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon13_Else_correct  (=> (and |call3formal@possible#0@0| (= |i#0@2| (- |i#0@1| 1))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (<= 0 |$decr$loop#00@1|) (= (- |i#0@2| 0) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |i#0@2| 0) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< (- |i#0@2| 0) |$decr$loop#00@1|)) (=> (< (- |i#0@2| 0) |$decr$loop#00@1|) (=> (= (ControlFlow 0 6) (- 0 5)) (=> |$w$loop#0@0| (>= |i#0@2| (LitInt 0)))))))))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (=> (and (> |i#0@1| 0) (= |$decr$loop#00@1| (- |i#0@1| 0))) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0)))
 :qid |gitissue2608dfy.3:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0))
)) ($HeapSucc $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 9) 4) anon13_Then_correct) (=> (= (ControlFlow 0 9) 6) anon13_Else_correct))))))
...
(let ((anon10_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (=> |$w$loop#0@0| (>= |i#0@1| (LitInt 0)))) (and (and (forall (($o@@1 T@U) ) (!  (=> (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@1) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@1) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@1)))
 :qid |gitissue2608dfy.17:3|
 :skolemid |485|
...
)) (<= (- |i#0@1| 0) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 12) 1) anon10_LoopDone_correct) (=> (= (ControlFlow 0 12) 11) anon10_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |i#0@0| (LitInt 10))) (and (= |k#0@0| (LitInt 27)) (= |$decr_init$loop#00@0| (- |i#0@0| 0)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (=> |$w$loop#0@0| (>= |i#0@0| (LitInt 0)))) (=> (=> |$w$loop#0@0| (>= |i#0@0| (LitInt 0))) (=> (= (ControlFlow 0 13) 12) anon10_LoopHead_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 15) 13))) anon0_correct)))
