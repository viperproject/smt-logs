...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let (($generated@@96 true))
(let (($generated@@97  (=> (and (not ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4  (=> false true))))) (= (ControlFlow 0 7) 4)) $generated@@96)))
(let (($generated@@98  (=> (and ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4  (=> false true)))) (= (ControlFlow 0 6) 4)) $generated@@96)))
(let (($generated@@99  (=> (not ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 false)))) (and (=> (= (ControlFlow 0 9) 6) $generated@@98) (=> (= (ControlFlow 0 9) 7) $generated@@97)))))
(let (($generated@@100  (=> ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 false))) (and (=> (= (ControlFlow 0 8) 6) $generated@@98) (=> (= (ControlFlow 0 8) 7) $generated@@97)))))
(let (($generated@@101  (=> (<= ($generated 0) $generated@@88) (and (=> (= (ControlFlow 0 10) 8) $generated@@100) (=> (= (ControlFlow 0 10) 9) $generated@@99)))))
(let (($generated@@102  (=> (and (< $generated@@88 ($generated 0)) (= (ControlFlow 0 5) 4)) $generated@@96)))
(let (($generated@@103  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= ($generated 0) ($generated 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite  (=> false true) 30 40))))))
(let (($generated@@104  (=> (= $generated@@89 ($generated@@29 $generated@@90 $generated@@91 $generated@@92 false)) (and (and (=> (= (ControlFlow 0 11) 2) $generated@@103) (=> (= (ControlFlow 0 11) 10) $generated@@101)) (=> (= (ControlFlow 0 11) 5) $generated@@102)))))
(let (($generated@@105  (=> (and (and ($generated@@93 $generated@@91) ($generated@@94 $generated@@91)) (and (= 0 $generated@@95) (= (ControlFlow 0 12) 11))) $generated@@104)))
$generated@@105)))))))))))
))
(check-sat)
(get-info :rlimit)
