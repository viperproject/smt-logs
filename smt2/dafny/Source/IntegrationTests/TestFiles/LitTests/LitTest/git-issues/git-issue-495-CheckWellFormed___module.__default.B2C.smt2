...
(assert (distinct alloc Tagclass._module.Gen Tagclass._module.IntB |##_module.Gen.Create| tytagFamily$Gen tytagFamily$IntB)
)
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass._module.IntB) (and (= ($Box intType ($Unbox intType bx@@0)) bx@@0) ($Is intType ($Unbox intType bx@@0) Tclass._module.IntB)))
 :qid |unknown.0:0|
 :skolemid |506|
 :pattern ( ($IsBox bx@@0 Tclass._module.IntB))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.B2C)
