...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0| T@U) ) (!  (=> (or (|_module.__default.Q#canCall| |s#0|) (and (< 1 $FunctionContextHeight) ($Is SeqType |s#0| (TSeq TInt)))) (and (forall ((|i#0| Int) ) (!  (=> (and (<= (LitInt 0) |i#0|) (< |i#0| (|Seq#Length| |s#0|))) (and (|_module.__default.P1#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0|)))) (=> (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0|)))) (|_module.__default.P2#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0|)))))))
 :qid |gitissue2211dfy.8:10|
 :skolemid |486|
 :pattern ( ($Unbox intType (|Seq#Index| |s#0| |i#0|)))
)) (= (_module.__default.Q |s#0|) (forall ((|i#0@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (|Seq#Length| |s#0|))) (and (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0@@0|)))) (_module.__default.P2 (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0@@0|))))))
 :qid |gitissue2211dfy.8:10|
 :skolemid |485|
 :pattern ( ($Unbox intType (|Seq#Index| |s#0| |i#0@@0|)))
)))))
 :qid |gitissue2211dfy.7:13|
 :skolemid |487|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.Q#canCall| (Lit SeqType |s#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is SeqType |s#0@@0| (TSeq TInt)))) (and (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| (Lit SeqType |s#0@@0|)))) (and (|_module.__default.P1#canCall| (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1|)))) (=> (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1|)))) (|_module.__default.P2#canCall| (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1|)))))))
 :qid |gitissue2211dfy.8:10|
 :skolemid |489|
 :pattern ( ($Unbox intType (|Seq#Index| |s#0@@0| |i#1|)))
)) (= (_module.__default.Q (Lit SeqType |s#0@@0|)) (forall ((|i#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (|Seq#Length| (Lit SeqType |s#0@@0|)))) (and (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1@@0|)))) (_module.__default.P2 (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1@@0|))))))
 :qid |gitissue2211dfy.8:10|
 :skolemid |488|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.Q#canCall| |s#0@@1|)) (or (_module.__default.Q |s#0@@1|) (forall ((|i#3| Int) ) (!  (=> (and (<= (LitInt 0) |i#3|) (< |i#3| (|Seq#Length| |s#0@@1|))) (and (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#3|)))) (_module.__default.P2 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#3|))))))
 :qid |gitissue2211dfy.8:10|
 :skolemid |503|
 :pattern ( ($Unbox intType (|Seq#Index| |s#0@@1| |i#3|)))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0@@1| (TSeq TInt)) ($IsAlloc SeqType |s#0@@1| (TSeq TInt) $Heap)) (= 2 $FunctionContextHeight)) (and (forall ((|i#1@@1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1@@1|) (< |i#1@@1| (|Seq#Length| |s#0@@1|))) (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#1@@1|)))))
 :qid |gitissue2211dfy.14:19|
 :skolemid |502|
 :pattern ( ($Unbox intType (|Seq#Index| |s#0@@1| |i#1@@1|)))
