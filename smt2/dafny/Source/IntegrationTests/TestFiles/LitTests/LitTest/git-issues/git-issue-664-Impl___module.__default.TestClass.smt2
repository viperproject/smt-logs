...
(declare-fun |_module.C.F#canCall| () Bool)
(declare-fun _module.C.F () Int)
...
(declare-fun |_module.C.F#Handle| () T@U)
(declare-fun Div (Int Int) Int)
(declare-fun Tclass._System.___hFunc0_0 (T@U) T@U)
(declare-fun Tclass._System.___hPartialFunc0_0 (T@U) T@U)
(declare-fun Tclass._System.___hTotalFunc0_0 (T@U) T@U)
(declare-fun |_module.C.F#requires| () Bool)
...
(assert (distinct TInt TagInt alloc Tagclass._System.___hFunc0 Tagclass._System.___hPartialFunc0 Tagclass._System.___hTotalFunc0 Tagclass._module.C Tagclass._module.C? |tytagFamily$_#Func0| |tytagFamily$_#PartialFunc0| |tytagFamily$_#TotalFunc0| tytagFamily$C)
)
...
(assert (forall ((|c#0| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0| Tclass._module.C $h@@1) ($IsAlloc refType |c#0| Tclass._module.C? $h@@1))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.C $h@@1))
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.C? $h@@1))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.C.F#canCall| (< 0 $FunctionContextHeight)) (= _module.C.F (LitInt 5)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.C.F#canCall| (< 0 $FunctionContextHeight)) (= _module.C.F (LitInt 5)))))
(assert (forall (($o@@0 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass._module.C? $h@@2)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($IsAlloc refType $o@@0 Tclass._module.C? $h@@2))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@3 T@U) ) (!  (=> ($IsGoodHeap $h@@3) ($IsAlloc intType (int_2_U _module.C.X) TInt $h@@3))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |491|
 :pattern ( ($IsAlloc intType (int_2_U _module.C.X) TInt $h@@3))
))))
...
(assert (forall (($heap T@U) ) (! (= _module.C.F (U_2_int ($Unbox intType (Apply0 TInt $heap |_module.C.F#Handle|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |486|
 :pattern ( _module.C.F ($IsGoodHeap $heap))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U _module.C.X) TInt)))
...
(assert (forall (($heap@@0 T@U) ) (! (= (Requires0 TInt $heap@@0 |_module.C.F#Handle|) |_module.C.F#requires|)
 :qid |DafnyPreludebpl.593:12|
 :skolemid |484|
 :pattern ( (Requires0 TInt $heap@@0 |_module.C.F#Handle|))
)))
...
(assert (forall (($heap@@1 T@U) ) (! (= (Apply0 TInt $heap@@1 |_module.C.F#Handle|) ($Box intType (int_2_U _module.C.F)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |483|
 :pattern ( (Apply0 TInt $heap@@1 |_module.C.F#Handle|))
)))
(assert (= |_module.C.F#requires| true))
...
(assert (forall (($bx T@U) ($heap@@2 T@U) ) (! (= (|Set#IsMember| (Reads0 TInt $heap@@2 |_module.C.F#Handle|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( (|Set#IsMember| (Reads0 TInt $heap@@2 |_module.C.F#Handle|) $bx))
)))
(push 1)
...
(set-info :boogie-vc-id Impl$$_module.__default.TestClass)
...
(let ((anon19_Else_correct  (=> (and (or (not (= (LitInt (Div 5 (LitInt 0))) (LitInt 1))) (not true)) (= (ControlFlow 0 21) 19)) anon4_correct)))
(let ((anon19_Then_correct  (=> (and (= (LitInt (Div 5 (LitInt 0))) (LitInt 1)) (= (ControlFlow 0 20) 19)) anon4_correct)))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 22) (- 0 23)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (and (=> (= (ControlFlow 0 22) 20) anon19_Then_correct) (=> (= (ControlFlow 0 22) 21) anon19_Else_correct))))))
(let ((anon8_correct true))
(let ((anon21_Else_correct  (=> (and (or (not (= (LitInt (Div 5 (LitInt 0))) (LitInt 2))) (not true)) (= (ControlFlow 0 16) 14)) anon8_correct)))
(let ((anon21_Then_correct  (=> (and (= (LitInt (Div 5 (LitInt 0))) (LitInt 2)) (= (ControlFlow 0 15) 14)) anon8_correct)))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (and (=> (= (ControlFlow 0 17) 15) anon21_Then_correct) (=> (= (ControlFlow 0 17) 16) anon21_Else_correct))))))
(let ((anon12_correct true))
(let ((anon23_Else_correct  (=> (and (or (not (= (LitInt (Div 5 (LitInt 0))) (LitInt 3))) (not true)) (= (ControlFlow 0 11) 9)) anon12_correct)))
(let ((anon23_Then_correct  (=> (and (= (LitInt (Div 5 (LitInt 0))) (LitInt 3)) (= (ControlFlow 0 10) 9)) anon12_correct)))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (and (=> (= (ControlFlow 0 12) 10) anon23_Then_correct) (=> (= (ControlFlow 0 12) 11) anon23_Else_correct))))))
(let ((anon16_correct true))
(let ((anon25_Else_correct  (=> (and (or (not (= (LitInt (Div 5 (LitInt 0))) (LitInt 4))) (not true)) (= (ControlFlow 0 5) 3)) anon16_correct)))
(let ((anon25_Then_correct  (=> (and (= (LitInt (Div 5 (LitInt 0))) (LitInt 4)) (= (ControlFlow 0 4) 3)) anon16_correct)))
(let ((anon24_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon25_Then_correct) (=> (= (ControlFlow 0 6) 5) anon25_Else_correct))))))))
(let ((anon24_Else_correct  (=> (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (=> (= (ControlFlow 0 24) 22) anon18_Then_correct) (=> (= (ControlFlow 0 24) 17) anon20_Then_correct)) (=> (= (ControlFlow 0 24) 12) anon22_Then_correct)) (=> (= (ControlFlow 0 24) 6) anon24_Then_correct)) (=> (= (ControlFlow 0 24) 2) anon24_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |c#0@@1| Tclass._module.C) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap))) (=> (and (and (and ($Is HandleTypeType |f#0_0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |f#0_0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 25) 24))) anon0_correct))))
