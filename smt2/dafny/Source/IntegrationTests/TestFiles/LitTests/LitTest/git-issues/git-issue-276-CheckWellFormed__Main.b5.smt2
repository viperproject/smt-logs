...
(let ((anon11_Else_correct  (=> (and (or (not (= (LitInt 1) (LitInt 2))) (not true)) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (= (LitInt 1) (LitInt 2)) (= (ControlFlow 0 6) 4)) anon6_correct)))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite (= (LitInt 1) (LitInt 2)) 20 42))))))
