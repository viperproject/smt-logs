...
(declare-fun Tagclass.M3.MyInt () T@U)
...
(declare-fun Tclass.M3.MyInt () T@U)
...
(assert (distinct TInt TagInt TagMultiSet alloc Tagclass.M3.MyInt tytagFamily$MyInt)
)
(assert (= (Tag TInt) TagInt))
(assert (forall ((|i#0| T@U) ($h T@U) ) (! ($IsAlloc intType |i#0| Tclass.M3.MyInt $h)
 :qid |unknown.0:0|
 :skolemid |2038|
 :pattern ( ($IsAlloc intType |i#0| Tclass.M3.MyInt $h))
)))
...
(assert (forall ((|i#0@@0| T@U) ) (! (= ($Is intType |i#0@@0| Tclass.M3.MyInt) (< (U_2_int |i#0@@0|) 17))
 :qid |unknown.0:0|
 :skolemid |2037|
 :pattern ( ($Is intType |i#0@@0| Tclass.M3.MyInt))
)))
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass.M3.MyInt) (and (= ($Box intType ($Unbox intType bx)) bx) ($Is intType ($Unbox intType bx) Tclass.M3.MyInt)))
 :qid |unknown.0:0|
 :skolemid |2010|
 :pattern ( ($IsBox bx Tclass.M3.MyInt))
)))
...
(assert (= (Tag Tclass.M3.MyInt) Tagclass.M3.MyInt))
(assert (= (TagFamily Tclass.M3.MyInt) tytagFamily$MyInt))
...
(set-info :boogie-vc-id Impl$$M3.__default.TestInt)
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is MultiSetType (|MultiSet#Union| |s1#0@0| |s0#0@0|) (TMultiSet Tclass.M3.MyInt)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is MultiSetType (|MultiSet#Union| |s0#0@0| |s1#0@0|) (TMultiSet Tclass.M3.MyInt)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (< |x1#0| 17)) (and (and ($Is MultiSetType |s0#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |s0#0| (TMultiSet TInt) $Heap)) true)) (=> (and (and (and (and (and ($Is MultiSetType |s1#0| (TMultiSet Tclass.M3.MyInt)) ($IsAlloc MultiSetType |s1#0| (TMultiSet Tclass.M3.MyInt) $Heap)) true) (and (and ($Is MultiSetType |a#0_0| (TMultiSet TInt)) ($IsAlloc MultiSetType |a#0_0| (TMultiSet TInt) $Heap)) true)) (and (and (and ($Is MultiSetType |a#1_0| (TMultiSet TInt)) ($IsAlloc MultiSetType |a#1_0| (TMultiSet TInt) $Heap)) true) (and (and ($Is MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyInt)) ($IsAlloc MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyInt) $Heap)) true))) (and (and (and (and ($Is MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyInt)) ($IsAlloc MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyInt) $Heap)) true) (and (and ($Is MultiSetType |a#4_0| (TMultiSet TInt)) ($IsAlloc MultiSetType |a#4_0| (TMultiSet TInt) $Heap)) true)) (and (and (and ($Is MultiSetType |a#5_0| (TMultiSet TInt)) ($IsAlloc MultiSetType |a#5_0| (TMultiSet TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))))) anon0_correct))))
