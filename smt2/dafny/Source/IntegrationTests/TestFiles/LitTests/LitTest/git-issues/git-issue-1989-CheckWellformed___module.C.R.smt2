...
(assert (distinct TInt TagInt alloc allocName Tagclass._module.C class._module.C? Tagclass._module.C? tytagFamily$C field$x)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id CheckWellformed$$_module.C.R)
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#3| null $Heap alloc this)) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this _module.C.x)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) 1) anon4_Then_correct) (=> (= (ControlFlow 0 3) 2) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 3))) anon0_correct))))
