...
(assert (distinct TBool TagBool TagSet alloc allocName Tagclass._module.Object Tagclass._module.Memory Tagclass._module.Memory? Tagclass._module.Object? class._module.Memory? tytagFamily$Object tytagFamily$Memory field$objects)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@3 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.Memory?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) _module.Memory.objects)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |826|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) _module.Memory.objects)))
)))
(assert (forall (($h@@4 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.Memory?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) _module.Memory.objects)) (TSet Tclass._module.Object) $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |827|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) _module.Memory.objects)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap T@U) ($Heap T@U) (this T@U) ) (!  (=> (or (|_module.Memory.HeapObjectsAreMonotonic#canCall| $prevHeap $Heap this) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Memory) ($IsAlloc refType this Tclass._module.Memory $prevHeap)))))) (= (_module.Memory.HeapObjectsAreMonotonic $prevHeap $Heap this) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap this) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Memory.objects)))))
 :qid |gitissue3855dfy.220:22|
 :skolemid |877|
 :pattern ( (_module.Memory.HeapObjectsAreMonotonic $prevHeap $Heap this) ($IsGoodHeap $Heap))
))))
...
(assert (= (Tag Tclass._module.Object?) Tagclass._module.Object?))
(assert (= (TagFamily Tclass._module.Object?) tytagFamily$Object))
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.Memory))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (and (= $o@@6 this@@0) (= $f@@0 _module.Memory.objects))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@6) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |873|
)) (= (_module.Memory.HeapObjectsAreMonotonic $prevHeap@@0 $h0 this@@0) (_module.Memory.HeapObjectsAreMonotonic $prevHeap@@0 $h1 this@@0))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |874|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.Memory.HeapObjectsAreMonotonic $prevHeap@@0 $h1 this@@0))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.HeapObjectsAreMonotonic)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType this@@1 Tclass._module.Memory $Heap@@0)) (=> ($IsAlloc refType this@@1 Tclass._module.Memory $Heap@@0) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Memory.objects))) (= (_module.Memory.HeapObjectsAreMonotonic $Heap@@0 current$Heap this@@1) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@1) _module.Memory.objects))))) (and ($Is boolType (bool_2_U (_module.Memory.HeapObjectsAreMonotonic $Heap@@0 current$Heap this@@1)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null current$Heap alloc this@@1 _module.Memory.objects)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= this@@1 null)) (not true))) (=> (or (not (= this@@1 null)) (not true)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Memory) ($IsAlloc refType this@@1 Tclass._module.Memory previous$Heap))) (= 0 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 7) 5))) anon0_correct))))
