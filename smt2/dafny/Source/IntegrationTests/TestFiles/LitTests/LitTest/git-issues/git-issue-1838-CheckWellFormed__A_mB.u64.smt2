...
(set-info :boogie-vc-id CheckWellFormed$$A_mB.u64)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitInt 0) (LitInt 18446744073709551615))))))
