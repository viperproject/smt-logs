...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 |##_module.D.A| Tagclass._module.D tytagFamily$nat tytagFamily$object tytagFamily$array |tytagFamily$_#Func1| tytagFamily$D)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|$l#0_0#heap#0| T@U) (|$l#0_0#i#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0|) |$l#0_0#heap#0| |$l#0_0#i#0|)) ($IsBox |$l#0_0#i#0| |l#0|))
 :qid |unknown.0:0|
 :skolemid |497|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0|) |$l#0_0#heap#0| |$l#0_0#i#0|))
)))
...
(assert (forall ((|l#0@@0| Bool) (|$l#0_0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#3| |l#0@@0|) |$l#0_0#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |498|
 :pattern ( (MapType1Select refType boolType (|lambda#3| |l#0@@0|) |$l#0_0#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#0_0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@1|) |$l#0_0#ly#0|) |l#0@@1|)
 :qid |gitissue3987dfy.9:39|
 :skolemid |500|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@1|) |$l#0_0#ly#0|))
)))
...
(assert (forall ((|$l#0_0#heap#0@@0| T@U) (|$l#0_0#i#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#1| |$l#0_0#heap#0@@0| |$l#0_0#i#0@@0|) ($Box intType ($Unbox intType |$l#0_0#i#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |496|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#1| |$l#0_0#heap#0@@0| |$l#0_0#i#0@@0|))
)))
...
(assert (forall ((d T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) ($Is DatatypeTypeType d Tclass._module.D)) ($IsAlloc DatatypeTypeType d Tclass._module.D $h@@7))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($IsAlloc DatatypeTypeType d Tclass._module.D $h@@7))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0_0#heap#0@@1| T@U) (|$l#0_0#i#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@3|) |$l#0_0#heap#0@@1| |$l#0_0#i#0@@1|) |l#0@@3|)
 :qid |gitissue3987dfy.9:39|
 :skolemid |499|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@3|) |$l#0_0#heap#0@@1| |$l#0_0#i#0@@1|))
)))
...
(let ((anon14_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 16) 14)) anon4_correct)))
(let ((anon14_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (=> (and (and (= |$_Frame#l0_0@0| (|lambda#0| null |$lambdaHeap#0_0@0| alloc false)) (= |lambdaResult#0_0| |i#0_0@0|)) (and ($Is intType (int_2_U |lambdaResult#0_0|) Tclass._System.nat) (= (ControlFlow 0 15) 14))) anon4_correct))))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0_0@0|) (or (= $Heap |$lambdaHeap#0_0@0|) ($HeapSucc $Heap |$lambdaHeap#0_0@0|))) (and (=> (= (ControlFlow 0 17) 15) anon14_Then_correct) (=> (= (ControlFlow 0 17) 16) anon14_Else_correct)))))
(let ((anon8_correct  (=> (and (<= (LitInt 0) |i#0_0_0@0|) (< |i#0_0_0@0| (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 |i#0_0_0@0|) (< |i#0_0_0@0| (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#0_0_0@0|)))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#0_0_0@0|))) (=> (and (and (<= (LitInt 0) |i#0_0_1@0|) (< |i#0_0_1@0| (_System.array.Length $nw@0))) (and (or (not (= |i#0_0_0@0| |i#0_0_1@0|)) (not true)) (= (ControlFlow 0 4) (- 0 3)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField |i#0_0_0@0|) (IndexField |i#0_0_1@0|))) (not true))) (= |i#0_0_0@0| |i#0_0_1@0|)))))))))))
(let ((anon16_Else_correct  (=> (and (< |i#0_0_0@0| (LitInt 0)) (= (ControlFlow 0 10) 4)) anon8_correct)))
(let ((anon16_Then_correct  (=> (<= (LitInt 0) |i#0_0_0@0|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= $nw@0 null)) (not true))) (=> (= (ControlFlow 0 8) 4) anon8_correct)))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 11) 8) anon16_Then_correct) (=> (= (ControlFlow 0 11) 10) anon16_Else_correct))))
(let ((anon15_Else_correct true))
(let ((anon13_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass._System.nat))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 1)))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (forall ((|arrayinit#0_0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0_0#i0#0|) (< |arrayinit#0_0#i0#0| (LitInt 1))) (Requires1 Tclass._System.nat Tclass._System.nat $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0_0#i0#0|))))
 :qid |gitissue3987dfy.9:28|
 :skolemid |482|
))) (=> (and (and (forall ((|arrayinit#0_0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0_0#i0#0@@0|) (< |arrayinit#0_0#i0#0@@0| (LitInt 1))) (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0_0#i0#0@@0|)))) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass._System.nat $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 |lambda#1| (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0_0#i0#0@@0|)))))))
 :qid |gitissue3987dfy.9:28|
 :skolemid |483|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0_0#i0#0@@0|)))
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 12) 11) anon15_Then_correct) (=> (= (ControlFlow 0 12) 2) anon15_Else_correct)))))))
(let ((anon12_Then_correct  (=> (= (Lit DatatypeTypeType |#_module.D.A|) |#_module.D.A|) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (and (=> (= (ControlFlow 0 18) 17) anon13_Then_correct) (=> (= (ControlFlow 0 18) 12) anon13_Else_correct)))))))
(let ((anon12_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 20) 18) anon12_Then_correct) (=> (= (ControlFlow 0 20) 1) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0_0| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |a#0_0| (Tclass._System.array Tclass._System.nat) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 21) 20))) anon0_correct))))
