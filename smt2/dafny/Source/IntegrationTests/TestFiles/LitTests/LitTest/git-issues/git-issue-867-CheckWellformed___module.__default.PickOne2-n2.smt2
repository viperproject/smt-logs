...
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |s#0@@1| ($Box intType (int_2_U (LitInt 0))))) (exists ((|u#3| T@U) ) (|Set#IsMember| |s#0@@1| ($Box intType |u#3|))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |s#0@@1| ($Box intType (int_2_U (LitInt 0))))) (exists ((|u#3@@0| Int) ) (|Set#IsMember| |s#0@@1| ($Box intType (int_2_U |u#3@@0|))))) (=> (and (|Set#IsMember| |s#0@@1| ($Box intType (int_2_U |u#2@0|))) (|Set#IsMember| |s#0@@1| ($Box intType (int_2_U |u#4@0|)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= |u#2@0| |u#4@0|)) (=> (= |u#2@0| |u#4@0|) (=> (and (and (|$let#9$canCall| |s#0@@1|) (= |w#4@0| (LitInt 10))) (and (|$let#9$canCall| |s#0@@1|) (= (ControlFlow 0 4) (- 0 3)))) (= (let ((|u#5| (|$let#9_u| |s#0@@1|)))
|u#5|) (let ((|u#6| (|$let#9_u| |s#0@@1|)))
|u#6|))))))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (and ($Is intType (int_2_U (LitInt 10)) TInt) (= (LitInt 10) (LitInt 10))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (LitInt 0) (LitInt 10))) (exists ((|w#3| Int) ) (= |w#3| (LitInt 10)))))) (=> (or (and ($Is intType (int_2_U (LitInt 10)) TInt) (= (LitInt 10) (LitInt 10))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (LitInt 0) (LitInt 10))) (exists ((|w#3@@0| Int) ) (= |w#3@@0| (LitInt 10))))) (=> (= |w#2@0| (LitInt 10)) (and (=> (= (ControlFlow 0 8) 4) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))))
