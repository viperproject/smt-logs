...
(let ((anon10_Else_correct  (=> (and (and (not (_module.Result.IsFailure TInt |call2formal@r#0@0|)) (= |r#0@2| (Lit DatatypeTypeType (|#_module.Result.Success| ($Box intType (int_2_U (LitInt 0))))))) (and (= |r#0@3| |r#0@2|) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct)))
(let ((anon10_Then_correct  (=> (and (_module.Result.IsFailure TInt |call2formal@r#0@0|) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (_module.Result.Failure_q |call2formal@r#0@0|)) (=> (and (_module.Result.Failure_q |call2formal@r#0@0|) (|_module.Result.PropagateFailure#canCall| TInt TInt |call2formal@r#0@0|)) (=> (and (and (|_module.Result.PropagateFailure#canCall| TInt TInt |call2formal@r#0@0|) (= |r#0@1| (_module.Result.PropagateFailure TInt TInt |call2formal@r#0@0|))) (and (= |r#0@3| |r#0@1|) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))))
(let ((anon9_Else_correct  (=> (not (_module.Result.IsFailure TInt |call2formal@r#0@0@@0|)) (=> (and (and (and (and (and ($Is DatatypeTypeType |valueOrError1#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError1#0@0| (Tclass._module.Result TInt) $Heap@0)) (= |i##1@0| (LitInt (- 0 1)))) (and ($Is DatatypeTypeType |call2formal@r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0| (Tclass._module.Result TInt) $Heap@@0))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and ($Is DatatypeTypeType |call2formal@r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0@0| (Tclass._module.Result TInt) $Heap@1)))) (and (and (and (=> (<= (LitInt 0) |i##1@0|) (_module.Result.Success_q |call2formal@r#0@0|)) (=> (<= (LitInt 0) |i##1@0|) (= (U_2_int ($Unbox intType (_module.Result.value |call2formal@r#0@0|))) |i##1@0|))) (and (=> (< |i##1@0| 0) (_module.Result.Failure_q |call2formal@r#0@0|)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0)))
 :qid |gitissue446bdfy.43:8|
 :skolemid |496|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0))
)))) (and (and ($HeapSucc $Heap@0 $Heap@1) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1)) (and (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0|) (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0|))))) (and (=> (= (ControlFlow 0 8) 5) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct))))))
(let ((anon9_Then_correct  (=> (and (_module.Result.IsFailure TInt |call2formal@r#0@0@@0|) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.Result.Failure_q |call2formal@r#0@0@@0|)) (=> (and (_module.Result.Failure_q |call2formal@r#0@0@@0|) (|_module.Result.PropagateFailure#canCall| TInt TInt |call2formal@r#0@0@@0|)) (=> (and (and (|_module.Result.PropagateFailure#canCall| TInt TInt |call2formal@r#0@0@@0|) (= |r#0@0| (_module.Result.PropagateFailure TInt TInt |call2formal@r#0@0@@0|))) (and (= |r#0@3| |r#0@0|) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and (and (and (and ($Is DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt) $Heap@@0)) (= |i##0@0| (LitInt 1))) (and ($Is DatatypeTypeType |call2formal@r#0@@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0@@0| (Tclass._module.Result TInt) $Heap@@0))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($Is DatatypeTypeType |call2formal@r#0@0@@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0@0@@0| (Tclass._module.Result TInt) $Heap@0)))) (and (and (and (=> (<= (LitInt 0) |i##0@0|) (_module.Result.Success_q |call2formal@r#0@0@@0|)) (=> (<= (LitInt 0) |i##0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |call2formal@r#0@0@@0|))) |i##0@0|))) (and (=> (< |i##0@0| 0) (_module.Result.Failure_q |call2formal@r#0@0@@0|)) (forall (($o@@1 T@U) ) (!  (=> (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@1) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@1) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@1)))
 :qid |gitissue446bdfy.43:8|
 :skolemid |496|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@1))
)))) (and (and ($HeapSucc $Heap@@0 $Heap@0) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@0)) (and (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0@@0|) (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0@@0|))))) (and (=> (= (ControlFlow 0 9) 3) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct))))))
