...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let (($generated@@99  (=> (and (and (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false)) (<= $generated@@92 ($generated 128))) (and (<= $generated@@93 ($generated 128)) (<= (+ $generated@@92 $generated@@93) ($generated 128)))) (and (and ($generated@@94 $generated@@95) ($generated@@96 $generated@@95)) (= $generated@@90 $generated@@95))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 $generated@@92) (< $generated@@92 256))) (=> (and (<= 0 $generated@@92) (< $generated@@92 256)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (bvule ((_ int2bv 8) $generated@@92) #x80)) (=> (bvule ((_ int2bv 8) $generated@@92) #x80) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 $generated@@93) (< $generated@@93 256))) (=> (and (<= 0 $generated@@93) (< $generated@@93 256)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bvule ((_ int2bv 8) $generated@@93) #x80)) (=> (bvule ((_ int2bv 8) $generated@@93) #x80) (=> (= $generated@@97 (+ $generated@@92 $generated@@93)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 $generated@@97) (< $generated@@97 256))) (=> (and (<= 0 $generated@@97) (< $generated@@97 256)) (=> (= (ControlFlow 0 2) (- 0 1)) (bvule ((_ int2bv 8) (+ $generated@@92 $generated@@93)) #x80))))))))))))))))
(let (($generated@@100  (=> (and ($generated@@94 $generated@@90) ($generated@@96 $generated@@90)) (=> (and (and (<= ($generated 0) $generated@@92) (<= ($generated 0) $generated@@93)) (and (= 0 $generated@@98) (= (ControlFlow 0 8) 2))) $generated@@99))))
$generated@@100)))
))
(check-sat)
(get-info :rlimit)
