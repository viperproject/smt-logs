...
(declare-fun |_module.__default.Foo0#canCall| () Bool)
(declare-fun _module.__default.Foo0 () T@U)
...
(assert (distinct TBool TagBool alloc Tagclass._module.Option |##_module.Option.Some| |##_module.Option.None| tytagFamily$Option)
)
...
(assert  (=> (<= 2 $FunctionContextHeight) (=> (or |_module.__default.Foo0#canCall| (< 2 $FunctionContextHeight)) ($Is DatatypeTypeType _module.__default.Foo0 (Tclass._module.Option TBool)))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (=> (or |_module.__default.Foo0#canCall| (< 2 $FunctionContextHeight)) (and (let ((|valueOrError0#0| (Lit DatatypeTypeType |#_module.Option.None|)))
 (and (and (|_module.Option.IsFailure#canCall| (Tclass._module.Option TBool) |valueOrError0#0|) (=> (_module.Option.IsFailure (Tclass._module.Option TBool) |valueOrError0#0|) (|_module.Option.PropagateFailure#canCall| (Tclass._module.Option TBool) TBool |valueOrError0#0|))) (=> (not (_module.Option.IsFailure (Tclass._module.Option TBool) |valueOrError0#0|)) (|_module.Option.Extract#canCall| (Tclass._module.Option TBool) |valueOrError0#0|)))) (= _module.__default.Foo0 (let ((|valueOrError0#0@@0| (Lit DatatypeTypeType |#_module.Option.None|)))
(ite (_module.Option.IsFailure (Tclass._module.Option TBool) |valueOrError0#0@@0|) (_module.Option.PropagateFailure (Tclass._module.Option TBool) TBool |valueOrError0#0@@0|) (Lit DatatypeTypeType |#_module.Option.None|))))))))
(assert  (=> (<= 2 $FunctionContextHeight) (=> (or |_module.__default.Foo0#canCall| (< 2 $FunctionContextHeight)) (and (let ((|valueOrError0#1| (Lit DatatypeTypeType |#_module.Option.None|)))
 (and (and (|_module.Option.IsFailure#canCall| (Tclass._module.Option TBool) |valueOrError0#1|) (=> (_module.Option.IsFailure (Tclass._module.Option TBool) |valueOrError0#1|) (|_module.Option.PropagateFailure#canCall| (Tclass._module.Option TBool) TBool |valueOrError0#1|))) (=> (not (_module.Option.IsFailure (Tclass._module.Option TBool) |valueOrError0#1|)) (|_module.Option.Extract#canCall| (Tclass._module.Option TBool) |valueOrError0#1|)))) (= _module.__default.Foo0 (let ((|valueOrError0#1@@0| (Lit DatatypeTypeType |#_module.Option.None|)))
(ite (_module.Option.IsFailure (Tclass._module.Option TBool) |valueOrError0#1@@0|) (_module.Option.PropagateFailure (Tclass._module.Option TBool) TBool |valueOrError0#1@@0|) (Lit DatatypeTypeType |#_module.Option.None|))))))))
...
(assert (forall ((_module.Option$T@@15 T@U) (bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 (Tclass._module.Option _module.Option$T@@15)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@0)) bx@@0) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@0) (Tclass._module.Option _module.Option$T@@15))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsBox bx@@0 (Tclass._module.Option _module.Option$T@@15)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Foo0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon8_Else_correct  (=> (not (_module.Option.IsFailure (Tclass._module.Option TBool) |valueOrError0#Z#0@0|)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |valueOrError0#Z#0@0|) (Tclass._module.Option (Tclass._module.Option TBool)) $Heap@@1) (= (ControlFlow 0 5) (- 0 4))) (_module.Option.Some_q |valueOrError0#Z#0@0|)))))
(let ((anon8_Then_correct  (=> (_module.Option.IsFailure (Tclass._module.Option TBool) |valueOrError0#Z#0@0|) (=> (and ($IsAllocBox ($Box DatatypeTypeType |valueOrError0#Z#0@0|) (Tclass._module.Option (Tclass._module.Option TBool)) $Heap@@1) (= (ControlFlow 0 3) (- 0 2))) (_module.Option.None_q |valueOrError0#Z#0@0|)))))
(let ((anon7_Else_correct  (=> (= |let#0#0#0| (Lit DatatypeTypeType |#_module.Option.None|)) (=> (and (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Option (Tclass._module.Option TBool))) (= |valueOrError0#Z#0@0| |let#0#0#0|)) (and ($IsAllocBox ($Box DatatypeTypeType |valueOrError0#Z#0@0|) (Tclass._module.Option (Tclass._module.Option TBool)) $Heap@@1) (|_module.Option.IsFailure#canCall| (Tclass._module.Option TBool) |valueOrError0#Z#0@0|))) (and (=> (= (ControlFlow 0 6) 3) anon8_Then_correct) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct))))))
