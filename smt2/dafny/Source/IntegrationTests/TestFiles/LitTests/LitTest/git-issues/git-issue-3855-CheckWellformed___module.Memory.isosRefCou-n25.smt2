...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (this@@3 T@U) (|os#0| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap this@@3 |os#0|) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (or (not (= this@@3 null)) (not true))) ($IsAlloc refType this@@3 Tclass._module.Memory $Heap)) (and ($Is SetType |os#0| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0| (TSet Tclass._module.Object) $Heap))))) ($IsAlloc SetType (_module.Memory.edges $Heap this@@3 |os#0|) (TSet Tclass._module.Edge) $Heap))
 :qid |gitissue3855dfy.256:12|
 :skolemid |918|
 :pattern ( ($IsAlloc SetType (_module.Memory.edges $Heap this@@3 |os#0|) (TSet Tclass._module.Edge) $Heap))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@4 T@U) (|os#0@@0| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@0 this@@4 |os#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) (or (not (= this@@4 null)) (not true))) ($IsAlloc refType this@@4 Tclass._module.Memory $Heap@@0)) (and ($Is SetType |os#0@@0| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@0| (TSet Tclass._module.Object) $Heap@@0))))) ($IsAlloc SetType (_module.Memory.justTheIsos $Heap@@0 this@@4 |os#0@@0|) (TSet Tclass._module.Object) $Heap@@0))
 :qid |gitissue3855dfy.235:12|
 :skolemid |891|
 :pattern ( ($IsAlloc SetType (_module.Memory.justTheIsos $Heap@@0 this@@4 |os#0@@0|) (TSet Tclass._module.Object) $Heap@@0))
))))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|$y#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#41| |l#0@@0| |l#1@@0| |l#2|) |$y#0@@0|))  (and ($IsBox |$y#0@@0| |l#0@@0|) (and (|Set#IsMember| |l#1@@0| |$y#0@@0|) (= (_module.Edge.t ($Unbox DatatypeTypeType |$y#0@@0|)) |l#2|))))
 :qid |gitissue3855dfy.149:10|
 :skolemid |1415|
 :pattern ( (MapType0Select BoxType boolType (|lambda#41| |l#0@@0| |l#1@@0| |l#2|) |$y#0@@0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@5 T@U) (|t#0@@3| T@U) (|edges#0@@3| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| (Lit refType this@@5) (Lit refType |t#0@@3|) (Lit SetType |edges#0@@3|)) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Memory)) ($Is refType |t#0@@3| Tclass._module.Object)) ($Is SetType |edges#0@@3| (TSet Tclass._module.Edge))))) (and (forall ((|e#2| T@U) ) (!  (=> ($Is DatatypeTypeType |e#2| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@3|) ($Box DatatypeTypeType |e#2|)) (_module.Edge.Edge_q |e#2|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |905|
 :pattern ( (_module.Edge.t |e#2|))
 :pattern ( (|Set#IsMember| |edges#0@@3| ($Box DatatypeTypeType |e#2|)))
)) (= (_module.Memory.incomingEdges (Lit refType this@@5) (Lit refType |t#0@@3|) (Lit SetType |edges#0@@3|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge (Lit SetType |edges#0@@3|) (Lit refType |t#0@@3|))))))
 :qid |gitissue3855dfy.245:12|
 :weight 3
 :skolemid |906|
 :pattern ( (_module.Memory.incomingEdges (Lit refType this@@5) (Lit refType |t#0@@3|) (Lit SetType |edges#0@@3|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@6 T@U) (|t#0@@4| T@U) (|edges#0@@4| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@6 |t#0@@4| |edges#0@@4|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Memory)) ($Is refType |t#0@@4| Tclass._module.Object)) ($Is SetType |edges#0@@4| (TSet Tclass._module.Edge))))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0| Tclass._module.Edge) (=> (|Set#IsMember| |edges#0@@4| ($Box DatatypeTypeType |e#0|)) (_module.Edge.Edge_q |e#0|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |901|
 :pattern ( (_module.Edge.t |e#0|))
 :pattern ( (|Set#IsMember| |edges#0@@4| ($Box DatatypeTypeType |e#0|)))
)) (= (_module.Memory.incomingEdges this@@6 |t#0@@4| |edges#0@@4|) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge |edges#0@@4| |t#0@@4|)))))
 :qid |gitissue3855dfy.245:12|
 :skolemid |902|
 :pattern ( (_module.Memory.incomingEdges this@@6 |t#0@@4| |edges#0@@4|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@7 T@U) (|os#0@@1| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@1 this@@7 |os#0@@1|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Memory) ($IsAlloc refType this@@7 Tclass._module.Memory $Heap@@1)))) (and ($Is SetType |os#0@@1| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@1| (TSet Tclass._module.Object) $Heap@@1))))) (and (and (forall ((|edge#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |edge#0| Tclass._module.Edge) (|Set#IsMember| (_module.Memory.edges $Heap@@1 this@@7 |os#0@@1|) ($Box DatatypeTypeType |edge#0|))) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|))) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|)))) (_module.Edge.t |edge#0|))))
 :qid |gitissue3855dfy.258:20|
 :skolemid |916|
 :pattern ( (_module.Edge.t |edge#0|))
 :pattern ( (_module.Edge.f |edge#0|))
 :pattern ( (_module.Edge.n |edge#0|))
 :pattern ( (|Set#IsMember| (_module.Memory.edges $Heap@@1 this@@7 |os#0@@1|) ($Box DatatypeTypeType |edge#0|)))
)) (=> (|Set#Equal| |os#0@@1| |Set#Empty|) (|Set#Equal| (_module.Memory.edges $Heap@@1 this@@7 |os#0@@1|) |Set#Empty|))) ($Is SetType (_module.Memory.edges $Heap@@1 this@@7 |os#0@@1|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |917|
 :pattern ( (_module.Memory.edges $Heap@@1 this@@7 |os#0@@1|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@8 T@U) (|os#0@@2| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@2 this@@8 |os#0@@2|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.Memory) ($IsAlloc refType this@@8 Tclass._module.Memory $Heap@@2)))) ($Is SetType |os#0@@2| (TSet Tclass._module.Object))))) (= (_module.Memory.justTheIsos $Heap@@2 this@@8 |os#0@@2|) (|Set#FromBoogieMap| (|lambda#38| Tclass._module.Object |os#0@@2|))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |893|
 :pattern ( (_module.Memory.justTheIsos $Heap@@2 this@@8 |os#0@@2|) ($IsGoodHeap $Heap@@2))
))))
...
(assert (forall ((v@@2 T@U) (t0@@1 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SetType v@@2 (TSet t0@@1) h@@0) (forall ((bx@@9 T@U) ) (!  (=> (|Set#IsMember| v@@2 bx@@9) ($IsAllocBox bx@@9 t0@@1 h@@0))
...
(assert (forall ((v@@4 T@U) (t0@@3 T@U) (t1@@0 T@U) (h@@2 T@U) ) (! (= ($IsAlloc MapType v@@4 (TMap t0@@3 t1@@0) h@@2) (forall ((bx@@10 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@4) bx@@10) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@4) bx@@10) t1@@0 h@@2) ($IsAllocBox bx@@10 t0@@3 h@@2)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@9 T@U) (|t#0@@5| T@U) (|edges#0@@5| T@U) ) (!  (=> (and (or (|_module.Memory.incomingEdges#canCall| this@@9 |t#0@@5| |edges#0@@5|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@9 null)) (not true)) ($IsAlloc refType this@@9 Tclass._module.Memory $Heap@@3)) (and ($Is refType |t#0@@5| Tclass._module.Object) ($IsAlloc refType |t#0@@5| Tclass._module.Object $Heap@@3))) (and ($Is SetType |edges#0@@5| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@5| (TSet Tclass._module.Edge) $Heap@@3))))) ($IsGoodHeap $Heap@@3)) ($IsAlloc SetType (_module.Memory.incomingEdges this@@9 |t#0@@5| |edges#0@@5|) (TSet Tclass._module.Edge) $Heap@@3))
 :qid |gitissue3855dfy.245:12|
 :skolemid |899|
 :pattern ( ($IsAlloc SetType (_module.Memory.incomingEdges this@@9 |t#0@@5| |edges#0@@5|) (TSet Tclass._module.Edge) $Heap@@3))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@10 T@U) (|t#0@@6| T@U) (|edges#0@@6| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@10 (Lit refType |t#0@@6|) (Lit SetType |edges#0@@6|)) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.Memory)) ($Is refType |t#0@@6| Tclass._module.Object)) ($Is SetType |edges#0@@6| (TSet Tclass._module.Edge))))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@6|) ($Box DatatypeTypeType |e#1|)) (_module.Edge.Edge_q |e#1|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |903|
 :pattern ( (_module.Edge.t |e#1|))
 :pattern ( (|Set#IsMember| |edges#0@@6| ($Box DatatypeTypeType |e#1|)))
)) (= (_module.Memory.incomingEdges this@@10 (Lit refType |t#0@@6|) (Lit SetType |edges#0@@6|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge (Lit SetType |edges#0@@6|) (Lit refType |t#0@@6|))))))
 :qid |gitissue3855dfy.245:12|
 :weight 3
 :skolemid |904|
 :pattern ( (_module.Memory.incomingEdges this@@10 (Lit refType |t#0@@6|) (Lit SetType |edges#0@@6|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@11 T@U) (|os#0@@3| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@4 this@@11 |os#0@@3|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@4) (and (or (not (= this@@11 null)) (not true)) (and ($Is refType this@@11 Tclass._module.Memory) ($IsAlloc refType this@@11 Tclass._module.Memory $Heap@@4)))) (and ($Is SetType |os#0@@3| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@3| (TSet Tclass._module.Object) $Heap@@4))))) (and (and (and (forall ((|r#0| T@U) ) (!  (=> (and ($Is refType |r#0| Tclass._module.Object) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@4 this@@11 |os#0@@3|) ($Box refType |r#0|))) (_module.Region.Isolate_q (_module.Object.region |r#0|)))
 :qid |gitissue3855dfy.237:20|
 :skolemid |888|
 :pattern ( (_module.Object.region |r#0|))
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@4 this@@11 |os#0@@3|) ($Box refType |r#0|)))
)) (forall ((|o#0| T@U) ) (!  (=> (and ($Is refType |o#0| Tclass._module.Object) (|Set#IsMember| |os#0@@3| ($Box refType |o#0|))) (=> (_module.Region.Isolate_q (_module.Object.region |o#0|)) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@4 this@@11 |os#0@@3|) ($Box refType |o#0|))))
 :qid |gitissue3855dfy.238:20|
 :skolemid |889|
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@4 this@@11 |os#0@@3|) ($Box refType |o#0|)))
 :pattern ( (_module.Object.region |o#0|))
 :pattern ( (|Set#IsMember| |os#0@@3| ($Box refType |o#0|)))
))) (=> (|Set#Equal| |os#0@@3| |Set#Empty|) (|Set#Equal| (_module.Memory.justTheIsos $Heap@@4 this@@11 |os#0@@3|) |Set#Empty|))) ($Is SetType (_module.Memory.justTheIsos $Heap@@4 this@@11 |os#0@@3|) (TSet Tclass._module.Object))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |890|
 :pattern ( (_module.Memory.justTheIsos $Heap@@4 this@@11 |os#0@@3|))
))))
(assert (forall ((bx@@11 T@U) (s@@2 T@U) (t@@8 T@U) ) (!  (=> ($IsBox bx@@11 (TMap s@@2 t@@8)) (and (= ($Box MapType ($Unbox MapType bx@@11)) bx@@11) ($Is MapType ($Unbox MapType bx@@11) (TMap s@@2 t@@8))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@11 (TMap s@@2 t@@8)))
)))
...
(assert (forall ((bx@@13 T@U) (t@@9 T@U) ) (!  (=> ($IsBox bx@@13 (TSet t@@9)) (and (= ($Box SetType ($Unbox SetType bx@@13)) bx@@13) ($Is SetType ($Unbox SetType bx@@13) (TSet t@@9))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |32|
 :pattern ( ($IsBox bx@@13 (TSet t@@9)))
)))
(assert (forall ((bx@@14 T@U) (t@@10 T@U) ) (!  (=> ($IsBox bx@@14 (TSeq t@@10)) (and (= ($Box SeqType ($Unbox SeqType bx@@14)) bx@@14) ($Is SeqType ($Unbox SeqType bx@@14) (TSeq t@@10))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx@@14 (TSeq t@@10)))
)))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@12 T@U) (|os#0@@4| T@U) ) (!  (=> (or (|_module.Memory.isosRefCountZeroOrOne#canCall| $Heap@@5 this@@12 |os#0@@4|) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@5) (and (or (not (= this@@12 null)) (not true)) (and ($Is refType this@@12 Tclass._module.Memory) ($IsAlloc refType this@@12 Tclass._module.Memory $Heap@@5)))) ($Is SetType |os#0@@4| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@5 this@@12 |os#0@@4|) (let ((|edges#0@@7| (_module.Memory.edges $Heap@@5 this@@12 |os#0@@4|)))
 (and (|_module.Memory.justTheIsos#canCall| $Heap@@5 this@@12 |os#0@@4|) (let ((|isos#0| (_module.Memory.justTheIsos $Heap@@5 this@@12 |os#0@@4|)))
(forall ((|i#0| T@U) ) (!  (=> ($Is refType |i#0| Tclass._module.Object) (=> (|Set#IsMember| |isos#0| ($Box refType |i#0|)) (|_module.Memory.refCountEdges#canCall| this@@12 |i#0| |edges#0@@7|)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |983|
 :pattern ( (_module.Memory.refCountEdges this@@12 |i#0| |edges#0@@7|))
 :pattern ( (|Set#IsMember| |isos#0| ($Box refType |i#0|)))
)))))) (= (_module.Memory.isosRefCountZeroOrOne $Heap@@5 this@@12 |os#0@@4|) (let ((|edges#0@@8| (_module.Memory.edges $Heap@@5 this@@12 |os#0@@4|)))
(let ((|isos#0@@0| (_module.Memory.justTheIsos $Heap@@5 this@@12 |os#0@@4|)))
(forall ((|i#0@@0| T@U) ) (!  (=> (and ($Is refType |i#0@@0| Tclass._module.Object) (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|))) (<= (_module.Memory.refCountEdges this@@12 |i#0@@0| |edges#0@@8|) (LitInt 1)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |982|
 :pattern ( (_module.Memory.refCountEdges this@@12 |i#0@@0| |edges#0@@8|))
 :pattern ( (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|)))
)))))))
 :qid |gitissue3855dfy.315:13|
 :skolemid |984|
 :pattern ( (_module.Memory.isosRefCountZeroOrOne $Heap@@5 this@@12 |os#0@@4|) ($IsGoodHeap $Heap@@5))
))))
(assert (forall ((v@@7 T@U) (t0@@4 T@U) (t1@@1 T@U) ) (! (= ($Is MapType v@@7 (TMap t0@@4 t1@@1)) (forall ((bx@@15 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@15) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@15) t1@@1) ($IsBox bx@@15 t0@@4)))
...
(assert (forall ((d@@16 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) (and (_module.Edge.Edge_q d@@16) ($IsAlloc DatatypeTypeType d@@16 Tclass._module.Edge $h@@13))) ($IsAlloc SeqType (_module.Edge.n d@@16) (TSeq TChar) $h@@13))
 :qid |unknown.0:0|
 :skolemid |812|
 :pattern ( ($IsAlloc SeqType (_module.Edge.n d@@16) (TSeq TChar) $h@@13))
)))
(assert (forall ((d@@17 T@U) ) (!  (=> ($Is DatatypeTypeType d@@17 Tclass._module.Region) (or (or (or (or (_module.Region.Frozen_q d@@17) (_module.Region.Heap_q d@@17)) (_module.Region.Stack_q d@@17)) (_module.Region.Frame_q d@@17)) (_module.Region.Isolate_q d@@17)))
 :qid |unknown.0:0|
 :skolemid |731|
 :pattern ( (_module.Region.Isolate_q d@@17) ($Is DatatypeTypeType d@@17 Tclass._module.Region))
 :pattern ( (_module.Region.Frame_q d@@17) ($Is DatatypeTypeType d@@17 Tclass._module.Region))
 :pattern ( (_module.Region.Stack_q d@@17) ($Is DatatypeTypeType d@@17 Tclass._module.Region))
 :pattern ( (_module.Region.Heap_q d@@17) ($Is DatatypeTypeType d@@17 Tclass._module.Region))
 :pattern ( (_module.Region.Frozen_q d@@17) ($Is DatatypeTypeType d@@17 Tclass._module.Region))
)))
...
(assert (forall ((d@@18 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_System.Tuple2.___hMake2_q d@@18) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@18 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@14)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@18 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@14))
)))) ($IsAllocBox (_System.Tuple2._0 d@@18) |_System._tuple#2$T0@@6| $h@@14))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@18) |_System._tuple#2$T0@@6| $h@@14))
)))
(assert (forall ((d@@19 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_System.Tuple2.___hMake2_q d@@19) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@19 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@15)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@19 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@15))
)))) ($IsAllocBox (_System.Tuple2._1 d@@19) |_System._tuple#2$T1@@7| $h@@15))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@19) |_System._tuple#2$T1@@7| $h@@15))
)))
(assert (forall ((|l#0@@1| T@U) (|l#1@@1| T@U) (|l#2@@0| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|$y#0@@1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#47| |l#0@@1| |l#1@@1| |l#2@@0| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10|) |$y#0@@1|)) (exists ((|o#0@@0| T@U) (|n#0| T@U) ) (!  (and (and (and ($Is refType |o#0@@0| |l#0@@1|) ($Is SeqType |n#0| |l#1@@1|)) (and (|Set#IsMember| |l#2@@0| ($Box refType |o#0@@0|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3| |o#0@@0|) |l#4|))) ($Box SeqType |n#0|)))) (= |$y#0@@1| ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@0| |n#0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#5| |o#0@@0|) |l#6|))) ($Box SeqType |n#0|)))))))
 :qid |gitissue3855dfy.261:10|
 :skolemid |920|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#9| |o#0@@0|) |l#10|))) ($Box SeqType |n#0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#7| |o#0@@0|) |l#8|))) ($Box SeqType |n#0|)))
)))
 :qid |gitissue3855dfy.87:7|
 :skolemid |1416|
 :pattern ( (MapType0Select BoxType boolType (|lambda#47| |l#0@@1| |l#1@@1| |l#2@@0| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10|) |$y#0@@1|))
)))
(assert (forall ((d@@20 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.Region.Heap_q d@@20) ($IsAlloc DatatypeTypeType d@@20 Tclass._module.Region $h@@16))) ($IsAlloc refType (_module.Region.region d@@20) Tclass._module.Object $h@@16))
 :qid |unknown.0:0|
 :skolemid |706|
 :pattern ( ($IsAlloc refType (_module.Region.region d@@20) Tclass._module.Object $h@@16))
)))
(assert (forall ((d@@21 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.Region.Stack_q d@@21) ($IsAlloc DatatypeTypeType d@@21 Tclass._module.Region $h@@17))) ($IsAlloc refType (_module.Region.region d@@21) Tclass._module.Object $h@@17))
 :qid |unknown.0:0|
 :skolemid |715|
 :pattern ( ($IsAlloc refType (_module.Region.region d@@21) Tclass._module.Object $h@@17))
)))
(assert (forall ((d@@22 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Region.Frame_q d@@22) ($IsAlloc DatatypeTypeType d@@22 Tclass._module.Region $h@@18))) ($IsAlloc refType (_module.Region.prev d@@22) Tclass._module.Object $h@@18))
 :qid |unknown.0:0|
 :skolemid |724|
 :pattern ( ($IsAlloc refType (_module.Region.prev d@@22) Tclass._module.Object $h@@18))
)))
(assert (forall ((d@@23 T@U) ($h@@19 T@U) ) (!  (=> (and ($IsGoodHeap $h@@19) (and (_module.Edge.Edge_q d@@23) ($IsAlloc DatatypeTypeType d@@23 Tclass._module.Edge $h@@19))) ($IsAlloc refType (_module.Edge.f d@@23) Tclass._module.Object $h@@19))
 :qid |unknown.0:0|
 :skolemid |811|
 :pattern ( ($IsAlloc refType (_module.Edge.f d@@23) Tclass._module.Object $h@@19))
)))
(assert (forall ((d@@24 T@U) ($h@@20 T@U) ) (!  (=> (and ($IsGoodHeap $h@@20) (and (_module.Edge.Edge_q d@@24) ($IsAlloc DatatypeTypeType d@@24 Tclass._module.Edge $h@@20))) ($IsAlloc refType (_module.Edge.t d@@24) Tclass._module.Object $h@@20))
 :qid |unknown.0:0|
 :skolemid |813|
 :pattern ( ($IsAlloc refType (_module.Edge.t d@@24) Tclass._module.Object $h@@20))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@13 T@U) (|os#0@@5| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@6 this@@13 |os#0@@5|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@13 null)) (not true)) (and ($Is refType this@@13 Tclass._module.Memory) ($IsAlloc refType this@@13 Tclass._module.Memory $Heap@@6)))) ($Is SetType |os#0@@5| (TSet Tclass._module.Object))))) (= (_module.Memory.edges $Heap@@6 this@@13 |os#0@@5|) (|Set#FromBoogieMap| (|lambda#47| Tclass._module.Object (TSeq TChar) |os#0@@5| $Heap@@6 _module.Object.fields $Heap@@6 _module.Object.fields $Heap@@6 _module.Object.fields $Heap@@6 _module.Object.fields))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |921|
 :pattern ( (_module.Memory.edges $Heap@@6 this@@13 |os#0@@5|) ($IsGoodHeap $Heap@@6))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@14 T@U) (|t#0@@7| T@U) (|edges#0@@9| T@U) ) (!  (=> (or (|_module.Memory.refCountEdges#canCall| this@@14 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@9|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.Memory)) ($Is refType |t#0@@7| Tclass._module.Object)) ($Is SetType |edges#0@@9| (TSet Tclass._module.Edge))))) (and (|_module.Memory.incomingEdges#canCall| this@@14 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@9|)) (= (_module.Memory.refCountEdges this@@14 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@9|)) (|Set#Card| (_module.Memory.incomingEdges this@@14 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@9|))))))
 :qid |gitissue3855dfy.251:12|
 :weight 3
 :skolemid |911|
 :pattern ( (_module.Memory.refCountEdges this@@14 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@9|)))
))))
...
(assert  (and (forall ((t0@@5 T@T) (t1@@2 T@T) (t2 T@T) (val@@1 T@U) (m@@11 T@U) (x0@@1 T@U) (x1 T@U) ) (! (= (MapType1Select t0@@5 t1@@2 t2 (MapType1Store t0@@5 t1@@2 t2 m@@11 x0@@1 x1 val@@1) x0@@1 x1) val@@1)
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@2| T@U) (|l#2@@1| T@U) (|l#3@@0| T@U) ($o@@7 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#34| |l#0@@2| |l#1@@2| |l#2@@1| |l#3@@0|) $o@@7 $f))  (=> (and (or (not (= $o@@7 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@2| $o@@7) |l#2@@1|)))) (|Set#IsMember| |l#3@@0| ($Box refType $o@@7))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1412|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#34| |l#0@@2| |l#1@@2| |l#2@@1| |l#3@@0|) $o@@7 $f))
)))
...
(declare-fun |os#0@@6| () T@U)
(declare-fun |edges#Z#0@0| () T@U)
(declare-fun |isos#Z#0@0| () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun |b$reqreads#1@0| () Bool)
(declare-fun |i#1@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun |let#0#0#0| () T@U)
(declare-fun |let#1#0#0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.isosRefCountZeroOrOne)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon6_correct  (=> (= (_module.Memory.isosRefCountZeroOrOne $Heap@@7 this@@15 |os#0@@6|) (forall ((|i#2| T@U) ) (!  (=> (and ($Is refType |i#2| Tclass._module.Object) (|Set#IsMember| |isos#Z#0@0| ($Box refType |i#2|))) (<= (_module.Memory.refCountEdges this@@15 |i#2| |edges#Z#0@0|) (LitInt 1)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |989|
 :pattern ( (_module.Memory.refCountEdges this@@15 |i#2| |edges#Z#0@0|))
 :pattern ( (|Set#IsMember| |isos#Z#0@0| ($Box refType |i#2|)))
))) (=> (and (forall ((|i#2@@0| T@U) ) (!  (=> ($Is refType |i#2@@0| Tclass._module.Object) (=> (|Set#IsMember| |isos#Z#0@0| ($Box refType |i#2@@0|)) (|_module.Memory.refCountEdges#canCall| this@@15 |i#2@@0| |edges#Z#0@0|)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |990|
 :pattern ( (_module.Memory.refCountEdges this@@15 |i#2@@0| |edges#Z#0@0|))
 :pattern ( (|Set#IsMember| |isos#Z#0@0| ($Box refType |i#2@@0|)))
)) ($Is boolType (bool_2_U (_module.Memory.isosRefCountZeroOrOne $Heap@@7 this@@15 |os#0@@6|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@0|)))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| |isos#Z#0@0| ($Box refType |i#1@0|))) (= (ControlFlow 0 7) 3)) anon6_correct)))
(let ((anon10_Then_correct  (=> (and (|Set#IsMember| |isos#Z#0@0| ($Box refType |i#1@0|)) ($IsAllocBox ($Box refType this@@15) Tclass._module.Memory? $Heap@@7)) (=> (and (and ($IsAlloc refType |i#1@0| Tclass._module.Object $Heap@@7) ($IsAlloc SetType |edges#Z#0@0| (TSet Tclass._module.Edge) $Heap@@7)) (and (|_module.Memory.refCountEdges#canCall| this@@15 |i#1@0| |edges#Z#0@0|) (= (ControlFlow 0 6) 3))) anon6_correct))))
(let ((anon9_Then_correct  (=> (and ($Is refType |i#1@0| Tclass._module.Object) ($IsAlloc refType |i#1@0| Tclass._module.Object $Heap@@7)) (and (=> (= (ControlFlow 0 8) 6) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not (and ($Is refType |i#1@0| Tclass._module.Object) ($IsAlloc refType |i#1@0| Tclass._module.Object $Heap@@7))) (= (ControlFlow 0 5) 3)) anon6_correct)))
(let ((anon8_Else_correct  (=> (and (and (and (and ($IsAllocBox ($Box refType this@@15) Tclass._module.Memory? $Heap@@7) ($IsAlloc SetType |os#0@@6| (TSet Tclass._module.Object) $Heap@@7)) (and (= |b$reqreads#0@0| (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@8) alloc)))) (|Set#IsMember| |os#0@@6| ($Box refType $o@@8))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@0)))
 :qid |gitissue3855dfy.318:18|
 :skolemid |985|
))) (|_module.Memory.edges#canCall| $Heap@@7 this@@15 |os#0@@6|))) (and (and (= |let#0#0#0| (_module.Memory.edges $Heap@@7 this@@15 |os#0@@6|)) (|_module.Memory.edges#canCall| $Heap@@7 this@@15 |os#0@@6|)) (and ($Is SetType |let#0#0#0| (TSet Tclass._module.Edge)) (= |edges#Z#0@0| |let#0#0#0|)))) (and (and (and ($IsAllocBox ($Box refType this@@15) Tclass._module.Memory? $Heap@@7) ($IsAlloc SetType |os#0@@6| (TSet Tclass._module.Object) $Heap@@7)) (and (= |b$reqreads#1@0| (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 $o@@9) alloc)))) (|Set#IsMember| |os#0@@6| ($Box refType $o@@9))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@9 $f@@1)))
 :qid |gitissue3855dfy.319:17|
 :skolemid |986|
))) (|_module.Memory.justTheIsos#canCall| $Heap@@7 this@@15 |os#0@@6|))) (and (and (= |let#1#0#0| (_module.Memory.justTheIsos $Heap@@7 this@@15 |os#0@@6|)) (|_module.Memory.justTheIsos#canCall| $Heap@@7 this@@15 |os#0@@6|)) (and ($Is SetType |let#1#0#0| (TSet Tclass._module.Object)) (= |isos#Z#0@0| |let#1#0#0|))))) (and (=> (= (ControlFlow 0 9) 8) anon9_Then_correct) (=> (= (ControlFlow 0 9) 5) anon9_Else_correct)))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#34| null $Heap@@7 alloc |os#0@@6|)) (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@7) ($IsHeapAnchor $Heap@@7)) (=> (and (and (and (or (not (= this@@15 null)) (not true)) (and ($Is refType this@@15 Tclass._module.Memory) ($IsAlloc refType this@@15 Tclass._module.Memory $Heap@@7))) ($Is SetType |os#0@@6| (TSet Tclass._module.Object))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
