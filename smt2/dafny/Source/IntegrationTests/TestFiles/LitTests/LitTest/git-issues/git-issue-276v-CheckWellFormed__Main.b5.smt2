...
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |x#0|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= Main.__default.a #x00)) (not true))) (=> (or (not (= Main.__default.a #x00)) (not true)) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (nat_from_bv8 (bvurem Main.__default.b Main.__default.a)))))))
