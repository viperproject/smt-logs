...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let (($generated@@111 true))
(let (($generated@@112  (=> (and (< $generated@@104 ($generated@@24 0)) (= (ControlFlow 0 7) 4)) $generated@@111)))
(let (($generated@@113  (=> (<= ($generated@@24 0) $generated@@104) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= $generated@@39 #x00)) (not true))) (=> (or (not (= $generated@@39 #x00)) (not true)) (=> (= (ControlFlow 0 5) 4) $generated@@111))))))
(let (($generated@@114  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= ($generated@@24 0) ($generated@@24 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 ($generated@@33 (bvurem $generated@@40 $generated@@39)))))))
(let (($generated@@115  (=> (= $generated@@105 ($generated@@44 $generated@@106 $generated@@107 $generated@@108 false)) (and (and (=> (= (ControlFlow 0 8) 2) $generated@@114) (=> (= (ControlFlow 0 8) 5) $generated@@113)) (=> (= (ControlFlow 0 8) 7) $generated@@112)))))
(let (($generated@@116  (=> (and (and ($generated@@109 $generated@@107) ($generated@@110 $generated@@107)) (and (= 1 $generated@@100) (= (ControlFlow 0 9) 8))) $generated@@115)))
$generated@@116)))))))
))
(check-sat)
(get-info :rlimit)
