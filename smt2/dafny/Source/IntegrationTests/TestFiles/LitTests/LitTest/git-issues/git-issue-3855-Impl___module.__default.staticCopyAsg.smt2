...
(set-info :boogie-vc-id Impl$$_module.__default.staticCopyAsg)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@26 alloc |frame#0| _module.Object.fields)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@26 $Heap@0) reveal__module.Memory.Valid)) (=> (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and reveal__module.Object.Valid (= call0formal@previous$Heap@0 $Heap@@26))) (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (= $Heap@1 $Heap@2) reveal__module.Memory.Valid2))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= |memory#0| null)) (not true))) (=> (or (not (= |memory#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (forall (($o@@29 T@U) ($f@@17 T@U) ) (!  (=> (and (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@29) alloc)))) (or (and (= $o@@29 |frame#0|) (= $f@@17 _module.Object.fields)) (and (= $o@@29 |frame#0|) (= $f@@17 _module.Object.fields)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@29 $f@@17)))
 :qid |gitissue3855dfy.1081:28|
 :skolemid |621|
))) (=> (forall (($o@@30 T@U) ($f@@18 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@30) alloc)))) (or (and (= $o@@30 |frame#0|) (= $f@@18 _module.Object.fields)) (and (= $o@@30 |frame#0|) (= $f@@18 _module.Object.fields)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@30 $f@@18)))
 :qid |gitissue3855dfy.1081:28|
 :skolemid |621|
)) (=> (and ($Is DatatypeTypeType |call6formal@r#0| Tclass._module.Status) ($IsAlloc DatatypeTypeType |call6formal@r#0| Tclass._module.Status $Heap@@26)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (not (|Seq#Equal| |t#0@@12| |f#0@@3|))) (=> (not (|Seq#Equal| |t#0@@12| |f#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |memory#0|) _module.Memory.objects)) ($Box refType |frame#0|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |memory#0|) _module.Memory.objects)) ($Box refType |frame#0|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |memory#0|) _module.Memory.objects)) ($Box refType |frame#0|))) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |memory#0|) _module.Memory.objects)) ($Box refType |frame#0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@2 |memory#0|)) (=> (_module.Memory.Valid reveal__module.Memory.Valid $Heap@2 |memory#0|) (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (and (and ($Is DatatypeTypeType |call6formal@r#0@0| Tclass._module.Status) ($IsAlloc DatatypeTypeType |call6formal@r#0@0| Tclass._module.Status $Heap@3)) (forall (($o@@31 T@U) ($f@@19 T@U) ) (!  (=> (or (not (= $o@@31 null)) (not true)) (=> (and (= $o@@31 |memory#0|) (or (= $f@@19 _module.Memory.objects) (= $f@@19 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@31) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@31) $f@@19))))
 :qid |gitissue3855dfy.916:13|
 :skolemid |1323|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@31) $f@@19))
))) (and (and (=> (_module.Status.Success_q |call6formal@r#0@0|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|))) (=> (_module.Status.Success_q |call6formal@r#0@0|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@3|)))) (and (=> (_module.Status.Success_q |call6formal@r#0@0|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@3|))) (=> (_module.Status.Success_q |call6formal@r#0@0|) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|))) ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@3|)))))))) (and (and (and (=> (_module.Status.Success_q |call6formal@r#0@0|) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|))) ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@3|))))) (|_module.Memory.betterCopyDynamicCheck#canCall| $Heap@2 |memory#0| |frame#0| |t#0@@12| |frame#0| |f#0@@3|)) (and (= (_module.Status.Success_q |call6formal@r#0@0|) (_module.Memory.betterCopyDynamicCheck $Heap@2 |memory#0| |frame#0| |t#0@@12| |frame#0| |f#0@@3|)) (|_module.Memory.Valid2#canCall| $Heap@2 $Heap@3 |memory#0|))) (and (and (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@2 $Heap@3 |memory#0|) (forall (($o@@32 T@U) ) (!  (=> (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@32) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@32) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@32)) (or (= $o@@32 |frame#0|) (= $o@@32 |frame#0|))))
 :qid |gitissue3855dfy.896:10|
 :skolemid |1324|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@32))
))) (and (forall (($o@@33 T@U) ($f@@20 T@U) ) (!  (=> (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@33) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@33) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@33) $f@@20)) (or (and (= $o@@33 |frame#0|) (= $f@@20 _module.Object.fields)) (and (= $o@@33 |frame#0|) (= $f@@20 _module.Object.fields)))))
 :qid |gitissue3855dfy.896:10|
 :skolemid |1325|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@33) $f@@20))
)) ($HeapSucc $Heap@2 $Heap@3))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (_module.Status.Success_q |call6formal@r#0@0|)) (=> (_module.Status.Success_q |call6formal@r#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@3|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|)) (=> (= (ControlFlow 0 2) (- 0 1)) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|))) ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@3|)))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@26) ($IsHeapAnchor $Heap@@26)) (=> (and (and (and ($Is SeqType |t#0@@12| (TSeq TChar)) ($IsAlloc SeqType |t#0@@12| (TSeq TChar) $Heap@@26)) (and ($Is SeqType |f#0@@3| (TSeq TChar)) ($IsAlloc SeqType |f#0@@3| (TSeq TChar) $Heap@@26))) (and (and ($Is refType |frame#0| Tclass._module.Object) ($IsAlloc refType |frame#0| Tclass._module.Object $Heap@@26)) (and ($Is refType |memory#0| Tclass._module.Memory) ($IsAlloc refType |memory#0| Tclass._module.Memory $Heap@@26)))) (=> (and (and (and (and (and ($Is DatatypeTypeType |r#0@@4| Tclass._module.Status) ($IsAlloc DatatypeTypeType |r#0@@4| Tclass._module.Status $Heap@@26)) true) (and (= 11 $FunctionContextHeight) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |memory#0|) _module.Memory.objects)) ($Box refType |frame#0|)))) (and (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@3|)) (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|))) (and (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@3|)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@26 |memory#0|)))) (and (and (and (not (|Seq#Equal| |t#0@@12| |f#0@@3|)) (|_module.Mode#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@3|))))) (and (|_module.__default.not#canCall| (_module.Mode.Iso_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@3|))))) (and (_module.__default.not (_module.Mode.Iso_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@3|))))) (not (_module.Mode.Iso_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@3|)))))))) (and (and (|_module.__default.not#canCall| (_module.Region.Frozen_q (_module.Object.region |frame#0|))) (and (_module.__default.not (_module.Region.Frozen_q (_module.Object.region |frame#0|))) (not (_module.Region.Frozen_q (_module.Object.region |frame#0|))))) (= (ControlFlow 0 12) 2)))) anon0_correct)))))
