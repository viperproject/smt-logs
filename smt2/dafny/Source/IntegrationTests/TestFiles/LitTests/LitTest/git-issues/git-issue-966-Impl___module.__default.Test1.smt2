...
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |d#0@0| (Lit DatatypeTypeType (|#_module.DT.Create| (LitInt 2))))) (and (= |x#0@0| (_module.DT.c |d#0@0|)) (= |y#0@0| _module.DT.b))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |f#0@0| (|_module.DT.F#Handle| |d#0@0|)) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |d#0| Tclass._module.DT) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.DT $Heap)) true) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 9))) anon0_correct)))))
