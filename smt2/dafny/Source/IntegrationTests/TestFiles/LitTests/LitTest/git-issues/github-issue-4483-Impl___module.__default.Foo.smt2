...
(declare-fun _module.__default.TWO__TO__THE__64 () Int)
...
(assert (distinct TInt TagInt TagSeq alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.uint64 |tytagFamily$_tuple#2| tytagFamily$uint64)
)
(assert (= (Tag TInt) TagInt))
(assert (forall ((|x#0| T@U) ($h T@U) ) (! ($IsAlloc intType |x#0| Tclass._module.uint64 $h)
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( ($IsAlloc intType |x#0| Tclass._module.uint64 $h))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@1 T@U) ) (!  (=> ($IsGoodHeap $h@@1) ($IsAlloc intType (int_2_U _module.__default.TWO__TO__THE__64) TInt $h@@1))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |479|
 :pattern ( ($IsAlloc intType (int_2_U _module.__default.TWO__TO__THE__64) TInt $h@@1))
))))
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass._module.uint64) (and (= ($Box intType ($Unbox intType bx@@0)) bx@@0) ($Is intType ($Unbox intType bx@@0) Tclass._module.uint64)))
 :qid |unknown.0:0|
 :skolemid |480|
 :pattern ( ($IsBox bx@@0 Tclass._module.uint64))
)))
...
(assert (forall ((|x#0@@0| T@U) ) (! (= ($Is intType |x#0@@0| Tclass._module.uint64)  (and (<= (LitInt 0) (U_2_int |x#0@@0|)) (< (U_2_int |x#0@@0|) _module.__default.TWO__TO__THE__64)))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( ($Is intType |x#0@@0| Tclass._module.uint64))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U _module.__default.TWO__TO__THE__64) TInt)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 3))))))) (and (<= (LitInt 0) |foo#0@0|) (< |foo#0@0| _module.__default.TWO__TO__THE__64))) (and (and (<= (LitInt 0) |length#0@0|) (< |length#0@0| _module.__default.TWO__TO__THE__64)) (= |newtype$check#0@0| (LitInt 0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| _module.__default.TWO__TO__THE__64))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| _module.__default.TWO__TO__THE__64)) (=> (= |newtype$check#1@0| (|Seq#Length| |s#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| _module.__default.TWO__TO__THE__64))) (=> (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| _module.__default.TWO__TO__THE__64)) (=> (and (= |newtype$check#2@0| (|Seq#Length| |s#0@0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (LitInt 0) |newtype$check#2@0|) (< |newtype$check#2@0| _module.__default.TWO__TO__THE__64)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is DatatypeTypeType |tuple#0| (Tclass._System.Tuple2 Tclass._module.uint64 Tclass._module.uint64)) ($IsAlloc DatatypeTypeType |tuple#0| (Tclass._System.Tuple2 Tclass._module.uint64 Tclass._module.uint64) $Heap))) (=> (and (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
