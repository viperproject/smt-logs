...
(declare-fun implements$_module.B (T@U) Bool)
...
(assert (distinct alloc Tagclass._module.A? Tagclass._module.A Tagclass._module.B? Tagclass._module.B Tagclass._module.C? Tagclass._module.C tytagFamily$A tytagFamily$B tytagFamily$C)
)
(assert (implements$_module.A Tclass._module.C?))
(assert (implements$_module.B Tclass._module.C?))
...
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.B $h@@0) ($IsAlloc refType |c#0@@0| Tclass._module.B? $h@@0))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.B $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.B? $h@@0))
)))
...
(assert (forall (($o@@1 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.B? $h@@3)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.B? $h@@3))
)))
...
(assert (forall ((|c#0@@3| T@U) ) (! (= ($Is refType |c#0@@3| Tclass._module.B)  (and ($Is refType |c#0@@3| Tclass._module.B?) (or (not (= |c#0@@3| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( ($Is refType |c#0@@3| Tclass._module.B))
 :pattern ( ($Is refType |c#0@@3| Tclass._module.B?))
)))
...
(assert (forall (($o@@3 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@3 Tclass._module.C? $heap) ($IsAlloc refType $o@@3 Tclass._module.A? $heap))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.C? $heap))
)))
(assert (forall (($o@@4 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@4 Tclass._module.C? $heap@@0) ($IsAlloc refType $o@@4 Tclass._module.B? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |507|
 :pattern ( ($IsAlloc refType $o@@4 Tclass._module.C? $heap@@0))
)))
...
(assert (forall (($o@@6 T@U) ) (!  (=> ($Is refType $o@@6 Tclass._module.C?) ($Is refType $o@@6 Tclass._module.A?))
 :qid |unknown.0:0|
 :skolemid |502|
 :pattern ( ($Is refType $o@@6 Tclass._module.C?))
)))
(assert (forall (($o@@7 T@U) ) (!  (=> ($Is refType $o@@7 Tclass._module.C?) ($Is refType $o@@7 Tclass._module.B?))
 :qid |unknown.0:0|
 :skolemid |506|
 :pattern ( ($Is refType $o@@7 Tclass._module.C?))
)))
...
(assert (= (Tag Tclass._module.C) Tagclass._module.C))
(assert (= (TagFamily Tclass._module.C) tytagFamily$C))
(assert (forall (($o@@8 T@U) ) (! (= ($Is refType $o@@8 Tclass._module.A?)  (or (= $o@@8 null) (implements$_module.A (dtype $o@@8))))
 :qid |unknown.0:0|
 :skolemid |480|
 :pattern ( ($Is refType $o@@8 Tclass._module.A?))
)))
(assert (forall (($o@@9 T@U) ) (! (= ($Is refType $o@@9 Tclass._module.B?)  (or (= $o@@9 null) (implements$_module.B (dtype $o@@9))))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( ($Is refType $o@@9 Tclass._module.B?))
)))
...
(set-info :boogie-vc-id Impl$$_module.C.Foo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U false))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
