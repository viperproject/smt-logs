...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.OnlyIMMsOKOutOfImms)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@21 alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |h#0| null)) (not true))) (=> (or (not (= |h#0| null)) (not true)) (=> ($IsAllocBox ($Box refType |h#0|) Tclass._module.Memory? $Heap@@21) (=> (and (|_module.Memory.Valid#canCall| $Heap@@21 |h#0|) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 |h#0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |h#0| null)) (not true))) (=> (or (not (= |h#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |h#0|) _module.Memory.objects)) ($Box refType |i#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |h#0| null)) (not true))) (=> (or (not (= |h#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |h#0|) _module.Memory.objects)) ($Box refType |j#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |i#0@@1| null)) (not true))) (=> (or (not (= |i#0@@1| null)) (not true)) (=> ($IsAllocBox ($Box refType |i#0@@1|) Tclass._module.Object? $Heap@@21) (=> (and (|_module.Object.outgoing#canCall| $Heap@@21 |i#0@@1|) (|Set#IsMember| (_module.Object.outgoing $Heap@@21 |i#0@@1|) ($Box refType |j#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |i#0@@1| null)) (not true))) (=> (or (not (= |i#0@@1| null)) (not true)) (=> (_module.Region.Frozen_q (_module.Object.region |i#0@@1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@21 $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |j#0| null)) (not true)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (=> (and (and (and ($Is refType |h#0| Tclass._module.Memory) ($IsAlloc refType |h#0| Tclass._module.Memory $Heap@@21)) (and ($Is refType |i#0@@1| Tclass._module.Object) ($IsAlloc refType |i#0@@1| Tclass._module.Object $Heap@@21))) (and (and ($Is refType |j#0| Tclass._module.Object) ($IsAlloc refType |j#0| Tclass._module.Object $Heap@@21)) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 8) 2)))) anon0_correct))))
