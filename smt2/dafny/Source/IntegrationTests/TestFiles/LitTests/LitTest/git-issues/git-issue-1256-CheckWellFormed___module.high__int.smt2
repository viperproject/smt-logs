...
(set-info :boogie-vc-id CheckWellFormed$$_module.high__int)
...
(let ((anon8_Else_correct  (=> (and (< |t#0| (LitInt 1000)) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 1000) |t#0|) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 1000) (LitInt 1000))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< 1000 2000))))))))
