...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |a1#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 42)))))) (= |a2#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 42))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Seq#Equal| |a1#0@0| |a2#0@0|)) (=> (|Seq#Equal| |a1#0@0| |a2#0@0|) (and (=> (= (ControlFlow 0 3) 1) anon2_Then_correct) (=> (= (ControlFlow 0 3) 2) anon2_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |a1#0| (TSeq TInt)) ($IsAlloc SeqType |a1#0| (TSeq TInt) $Heap)) true) (=> (and (and (and ($Is SeqType |a2#0| (TSeq TInt)) ($IsAlloc SeqType |a2#0| (TSeq TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 3))) anon0_correct)))))
