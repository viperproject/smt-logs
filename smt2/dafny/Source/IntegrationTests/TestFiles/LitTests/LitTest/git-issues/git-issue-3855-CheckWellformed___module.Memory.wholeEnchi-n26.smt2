...
(declare-fun _module.Memory.wholeEnchiladaNEW (T@U T@U T@U) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.Memory.wholeEnchiladaNEW#canCall| (T@U T@U T@U) Bool)
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|os#0| T@U) ) (!  (=> (or (|_module.Memory.wholeEnchiladaNEW#canCall| $Heap this |os#0|) (and (< 7 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Memory) ($IsAlloc refType this Tclass._module.Memory $Heap)))) ($Is SetType |os#0| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.allRegions#canCall| this |os#0|) (and (|_module.Memory.edges#canCall| $Heap this |os#0|) (|_module.Memory.wholeEnchilada#canCall| $Heap this |os#0|))) (= (_module.Memory.wholeEnchiladaNEW $Heap this |os#0|) (_module.Memory.wholeEnchilada $Heap this |os#0|))))
 :qid |gitissue3855dfy.324:13|
 :skolemid |995|
 :pattern ( (_module.Memory.wholeEnchiladaNEW $Heap this |os#0|) ($IsGoodHeap $Heap))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@0 T@U) (|t#0| T@U) (|edges#0| T@U) ) (!  (=> (or (|_module.Memory.refCountEdges#canCall| this@@0 |t#0| |edges#0|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.Memory)) ($Is refType |t#0| Tclass._module.Object)) ($Is SetType |edges#0| (TSet Tclass._module.Edge))))) (and (|_module.Memory.incomingEdges#canCall| this@@0 |t#0| |edges#0|) (= (_module.Memory.refCountEdges this@@0 |t#0| |edges#0|) (|Set#Card| (_module.Memory.incomingEdges this@@0 |t#0| |edges#0|)))))
 :qid |gitissue3855dfy.251:12|
 :skolemid |910|
 :pattern ( (_module.Memory.refCountEdges this@@0 |t#0| |edges#0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@1 T@U) (|edges#0@@0| T@U) ) (!  (=> (or (|_module.Memory.justHeapExternalEdges#canCall| this@@1 |edges#0@@0|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.Memory)) ($Is SetType |edges#0@@0| (TSet Tclass._module.Edge))))) (and (forall ((|e#0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0| Tclass._module.Edge) (=> (|Set#IsMember| |edges#0@@0| ($Box DatatypeTypeType |e#0|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#0|))) (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#0|)))) (and (_module.Edge.Edge_q |e#0|) (_module.Edge.Edge_q |e#0|))) (=> (not (|_module.Region#Equal| (_module.Object.region (_module.Edge.f |e#0|)) (_module.Object.region (_module.Edge.t |e#0|)))) (_module.Edge.Edge_q |e#0|)))))
...
)) (= (_module.Memory.justHeapExternalEdges this@@1 |edges#0@@0|) (|Set#FromBoogieMap| (|lambda#76| Tclass._module.Edge |edges#0@@0|)))))
 :qid |gitissue3855dfy.345:12|
 :skolemid |1013|
 :pattern ( (_module.Memory.justHeapExternalEdges this@@1 |edges#0@@0|))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@2 T@U) (|os#0@@0| T@U) ) (!  (=> (or (|_module.Memory.wholeEnchilada#canCall| $Heap@@0 this@@2 |os#0@@0|) (and (< 6 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Memory) ($IsAlloc refType this@@2 Tclass._module.Memory $Heap@@0)))) ($Is SetType |os#0@@0| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.isosRefCountZeroOrOne#canCall| $Heap@@0 this@@2 |os#0@@0|) (=> (_module.Memory.isosRefCountZeroOrOne $Heap@@0 this@@2 |os#0@@0|) (|_module.Memory.heapExternalsZeroOrOne#canCall| $Heap@@0 this@@2 |os#0@@0|))) (= (_module.Memory.wholeEnchilada $Heap@@0 this@@2 |os#0@@0|)  (and (_module.Memory.isosRefCountZeroOrOne $Heap@@0 this@@2 |os#0@@0|) (_module.Memory.heapExternalsZeroOrOne $Heap@@0 this@@2 |os#0@@0|)))))
 :qid |gitissue3855dfy.265:13|
 :skolemid |930|
 :pattern ( (_module.Memory.wholeEnchilada $Heap@@0 this@@2 |os#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@3 T@U) (|t#0@@0| T@U) (|edges#0@@1| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@3 |t#0@@0| |edges#0@@1|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.Memory)) ($Is refType |t#0@@0| Tclass._module.Object)) ($Is SetType |edges#0@@1| (TSet Tclass._module.Edge))))) (and (|Set#Subset| (_module.Memory.incomingEdges this@@3 |t#0@@0| |edges#0@@1|) |edges#0@@1|) ($Is SetType (_module.Memory.incomingEdges this@@3 |t#0@@0| |edges#0@@1|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.245:12|
 :skolemid |898|
 :pattern ( (_module.Memory.incomingEdges this@@3 |t#0@@0| |edges#0@@1|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@4 T@U) (|o#0| T@U) (|edges#0@@2| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| this@@4 |o#0| |edges#0@@2|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0| Tclass._module.Region)) ($Is SetType |edges#0@@2| (TSet Tclass._module.Edge))))) (and (|Set#Subset| (_module.Memory.externalEdges this@@4 |o#0| |edges#0@@2|) |edges#0@@2|) ($Is SetType (_module.Memory.externalEdges this@@4 |o#0| |edges#0@@2|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.336:12|
 :skolemid |999|
 :pattern ( (_module.Memory.externalEdges this@@4 |o#0| |edges#0@@2|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@5 T@U) (|t#0@@1| T@U) (|edges#0@@3| T@U) ) (!  (=> (or (|_module.Memory.refCountEdges#canCall| this@@5 |t#0@@1| |edges#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Memory)) ($Is refType |t#0@@1| Tclass._module.Object)) ($Is SetType |edges#0@@3| (TSet Tclass._module.Edge))))) (<= (LitInt 0) (_module.Memory.refCountEdges this@@5 |t#0@@1| |edges#0@@3|)))
 :qid |gitissue3855dfy.251:12|
 :skolemid |908|
 :pattern ( (_module.Memory.refCountEdges this@@5 |t#0@@1| |edges#0@@3|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@6 T@U) (|edges#0@@4| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@6 (Lit SetType |edges#0@@4|)) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Memory)) ($Is SetType |edges#0@@4| (TSet Tclass._module.Edge))))) (and (and (|_module.Memory.justHeapExternalEdges#canCall| this@@6 (Lit SetType |edges#0@@4|)) (let ((|heapExternalEdges#1| (_module.Memory.justHeapExternalEdges this@@6 (Lit SetType |edges#0@@4|))))
...
(forall ((|r#0| T@U) ) (!  (=> ($Is DatatypeTypeType |r#0| Tclass._module.Region) (=> (|Set#IsMember| |allRelevantHeapRegions#1| ($Box DatatypeTypeType |r#0|)) (|_module.Memory.externalEdges#canCall| this@@6 |r#0| |heapExternalEdges#1|)))
 :qid |gitissue3855dfy.285:11|
 :skolemid |951|
 :pattern ( (_module.Memory.externalEdges this@@6 |r#0| |heapExternalEdges#1|))
 :pattern ( (|Set#IsMember| |allRelevantHeapRegions#1| ($Box DatatypeTypeType |r#0|)))
)))))) (= (_module.Memory.heapExternalsZeroOrOneEdges this@@6 (Lit SetType |edges#0@@4|)) (let ((|heapExternalEdges#1@@0| (_module.Memory.justHeapExternalEdges this@@6 (Lit SetType |edges#0@@4|))))
...
(let ((|heapExternalEdgesPartitionedByRegion#1| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region |allRelevantHeapRegions#1@@0|)) (|lambda#55| this@@6 |heapExternalEdges#1@@0|) (TMap Tclass._module.Region (TSet Tclass._module.Edge)))))
(forall ((|hr#1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |hr#1| Tclass._module.Region) (|Set#IsMember| (|Map#Domain| |heapExternalEdgesPartitionedByRegion#1|) ($Box DatatypeTypeType |hr#1|))) (<= (|Set#Card| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |heapExternalEdgesPartitionedByRegion#1|) ($Box DatatypeTypeType |hr#1|)))) (LitInt 1)))
 ...
 :weight 3
 :skolemid |953|
 :pattern ( (_module.Memory.heapExternalsZeroOrOneEdges this@@6 (Lit SetType |edges#0@@4|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@7 T@U) (|os#0@@1| T@U) ) (!  (=> (or (|_module.Memory.allRegions#canCall| this@@7 (Lit SetType |os#0@@1|)) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@7 null)) (not true)) ($Is refType this@@7 Tclass._module.Memory)) ($Is SetType |os#0@@1| (TSet Tclass._module.Object))))) (= (_module.Memory.allRegions this@@7 (Lit SetType |os#0@@1|)) (|Set#FromBoogieMap| (|lambda#122| Tclass._module.Object (Lit SetType |os#0@@1|) |os#0@@1|))))
 :qid |gitissue3855dfy.600:10|
 :weight 3
 :skolemid |1187|
 :pattern ( (_module.Memory.allRegions this@@7 (Lit SetType |os#0@@1|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@9 T@U) (|edges#0@@6| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| (Lit refType this@@9) (Lit SetType |edges#0@@6|)) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@9 null)) (not true)) ($Is refType this@@9 Tclass._module.Memory)) ($Is SetType |edges#0@@6| (TSet Tclass._module.Edge))))) (and (and (|_module.Memory.justHeapExternalEdges#canCall| (Lit refType this@@9) (Lit SetType |edges#0@@6|)) (let ((|heapExternalEdges#2| (Lit SetType (_module.Memory.justHeapExternalEdges (Lit refType this@@9) (Lit SetType |edges#0@@6|)))))
...
(forall ((|r#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |r#0@@0| Tclass._module.Region) (=> (|Set#IsMember| |allRelevantHeapRegions#2| ($Box DatatypeTypeType |r#0@@0|)) (|_module.Memory.externalEdges#canCall| (Lit refType this@@9) |r#0@@0| |heapExternalEdges#2|)))
 :qid |gitissue3855dfy.285:11|
 :skolemid |957|
 :pattern ( (_module.Memory.externalEdges this@@9 |r#0@@0| |heapExternalEdges#2|))
 :pattern ( (|Set#IsMember| |allRelevantHeapRegions#2| ($Box DatatypeTypeType |r#0@@0|)))
)))))) (= (_module.Memory.heapExternalsZeroOrOneEdges (Lit refType this@@9) (Lit SetType |edges#0@@6|)) (let ((|heapExternalEdges#2@@0| (Lit SetType (_module.Memory.justHeapExternalEdges (Lit refType this@@9) (Lit SetType |edges#0@@6|)))))
...
(let ((|heapExternalEdgesPartitionedByRegion#2| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region |allRelevantHeapRegions#2@@0|)) (|lambda#55| (Lit refType this@@9) |heapExternalEdges#2@@0|) (TMap Tclass._module.Region (TSet Tclass._module.Edge)))))
(forall ((|hr#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |hr#2| Tclass._module.Region) (|Set#IsMember| (|Map#Domain| |heapExternalEdgesPartitionedByRegion#2|) ($Box DatatypeTypeType |hr#2|))) (<= (|Set#Card| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |heapExternalEdgesPartitionedByRegion#2|) ($Box DatatypeTypeType |hr#2|)))) (LitInt 1)))
 ...
 :weight 3
 :skolemid |959|
 :pattern ( (_module.Memory.heapExternalsZeroOrOneEdges (Lit refType this@@9) (Lit SetType |edges#0@@6|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@10 T@U) (|t#0@@2| T@U) (|edges#0@@7| T@U) ) (!  (=> (or (|_module.Memory.refCountEdges#canCall| (Lit refType this@@10) (Lit refType |t#0@@2|) (Lit SetType |edges#0@@7|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@10 null)) (not true)) ($Is refType this@@10 Tclass._module.Memory)) ($Is refType |t#0@@2| Tclass._module.Object)) ($Is SetType |edges#0@@7| (TSet Tclass._module.Edge))))) (and (|_module.Memory.incomingEdges#canCall| (Lit refType this@@10) (Lit refType |t#0@@2|) (Lit SetType |edges#0@@7|)) (= (_module.Memory.refCountEdges (Lit refType this@@10) (Lit refType |t#0@@2|) (Lit SetType |edges#0@@7|)) (|Set#Card| (Lit SetType (_module.Memory.incomingEdges (Lit refType this@@10) (Lit refType |t#0@@2|) (Lit SetType |edges#0@@7|)))))))
 :qid |gitissue3855dfy.251:12|
 :weight 3
 :skolemid |912|
 :pattern ( (_module.Memory.refCountEdges (Lit refType this@@10) (Lit refType |t#0@@2|) (Lit SetType |edges#0@@7|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@11 T@U) (|os#0@@2| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@1 this@@11 |os#0@@2|) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (or (not (= this@@11 null)) (not true))) ($IsAlloc refType this@@11 Tclass._module.Memory $Heap@@1)) (and ($Is SetType |os#0@@2| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@2| (TSet Tclass._module.Object) $Heap@@1))))) ($IsAlloc SetType (_module.Memory.edges $Heap@@1 this@@11 |os#0@@2|) (TSet Tclass._module.Edge) $Heap@@1))
 :qid |gitissue3855dfy.256:12|
 :skolemid |918|
 :pattern ( ($IsAlloc SetType (_module.Memory.edges $Heap@@1 this@@11 |os#0@@2|) (TSet Tclass._module.Edge) $Heap@@1))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@12 T@U) (|os#0@@3| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@2 this@@12 |os#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@2) (or (not (= this@@12 null)) (not true))) ($IsAlloc refType this@@12 Tclass._module.Memory $Heap@@2)) (and ($Is SetType |os#0@@3| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@3| (TSet Tclass._module.Object) $Heap@@2))))) ($IsAlloc SetType (_module.Memory.justTheIsos $Heap@@2 this@@12 |os#0@@3|) (TSet Tclass._module.Object) $Heap@@2))
 :qid |gitissue3855dfy.235:12|
 :skolemid |891|
 :pattern ( ($IsAlloc SetType (_module.Memory.justTheIsos $Heap@@2 this@@12 |os#0@@3|) (TSet Tclass._module.Object) $Heap@@2))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@13 T@U) (|o#0@@0| T@U) (|edges#0@@8| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| this@@13 |o#0@@0| |edges#0@@8|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@13 null)) (not true)) ($Is refType this@@13 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@0| Tclass._module.Region)) ($Is SetType |edges#0@@8| (TSet Tclass._module.Edge))))) (and (forall ((|e#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@0| Tclass._module.Edge) (=> (|Set#IsMember| |edges#0@@8| ($Box DatatypeTypeType |e#0@@0|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#0@@0|))) (|$IsA#_module.Region| |o#0@@0|)) (_module.Edge.Edge_q |e#0@@0|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#0@@0|)) |o#0@@0|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#0@@0|))) (|$IsA#_module.Region| |o#0@@0|)) (_module.Edge.Edge_q |e#0@@0|))))))
...
)) (= (_module.Memory.externalEdges this@@13 |o#0@@0| |edges#0@@8|) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge |edges#0@@8| |o#0@@0| |o#0@@0|)))))
 :qid |gitissue3855dfy.336:12|
 :skolemid |1003|
 :pattern ( (_module.Memory.externalEdges this@@13 |o#0@@0| |edges#0@@8|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@14 T@U) (|edges#0@@9| T@U) ) (!  (=> (or (|_module.Memory.justHeapExternalEdges#canCall| this@@14 |edges#0@@9|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@14 null)) (not true)) ($Is refType this@@14 Tclass._module.Memory)) ($Is SetType |edges#0@@9| (TSet Tclass._module.Edge))))) (and (|Set#Subset| (_module.Memory.justHeapExternalEdges this@@14 |edges#0@@9|) |edges#0@@9|) ($Is SetType (_module.Memory.justHeapExternalEdges this@@14 |edges#0@@9|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.345:12|
 :skolemid |1009|
 :pattern ( (_module.Memory.justHeapExternalEdges this@@14 |edges#0@@9|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@15 T@U) (|os#0@@4| T@U) ) (!  (=> (or (|_module.Memory.allRegions#canCall| this@@15 |os#0@@4|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@15 null)) (not true)) ($Is refType this@@15 Tclass._module.Memory)) ($Is SetType |os#0@@4| (TSet Tclass._module.Object))))) (and (forall ((|o#0@@1| T@U) ) (!  (=> (and ($Is refType |o#0@@1| Tclass._module.Object) (|Set#IsMember| |os#0@@4| ($Box refType |o#0@@1|))) (|Set#IsMember| (_module.Memory.allRegions this@@15 |os#0@@4|) ($Box DatatypeTypeType (_module.Object.region |o#0@@1|))))
 :qid |gitissue3855dfy.601:19|
 :skolemid |1180|
 :pattern ( (_module.Object.region |o#0@@1|))
 :pattern ( (|Set#IsMember| |os#0@@4| ($Box refType |o#0@@1|)))
)) ($Is SetType (_module.Memory.allRegions this@@15 |os#0@@4|) (TSet Tclass._module.Region))))
 :qid |gitissue3855dfy.600:10|
 :skolemid |1181|
 :pattern ( (_module.Memory.allRegions this@@15 |os#0@@4|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@16 T@U) (|t#0@@3| T@U) (|edges#0@@10| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| (Lit refType this@@16) (Lit refType |t#0@@3|) (Lit SetType |edges#0@@10|)) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@16 null)) (not true)) ($Is refType this@@16 Tclass._module.Memory)) ($Is refType |t#0@@3| Tclass._module.Object)) ($Is SetType |edges#0@@10| (TSet Tclass._module.Edge))))) (and (forall ((|e#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#2@@0| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@10|) ($Box DatatypeTypeType |e#2@@0|)) (_module.Edge.Edge_q |e#2@@0|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |905|
 :pattern ( (_module.Edge.t |e#2@@0|))
 :pattern ( (|Set#IsMember| |edges#0@@10| ($Box DatatypeTypeType |e#2@@0|)))
)) (= (_module.Memory.incomingEdges (Lit refType this@@16) (Lit refType |t#0@@3|) (Lit SetType |edges#0@@10|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge (Lit SetType |edges#0@@10|) (Lit refType |t#0@@3|))))))
 :qid |gitissue3855dfy.245:12|
 :weight 3
 :skolemid |906|
 :pattern ( (_module.Memory.incomingEdges (Lit refType this@@16) (Lit refType |t#0@@3|) (Lit SetType |edges#0@@10|)))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@17 T@U) (|t#0@@4| T@U) (|edges#0@@11| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@17 |t#0@@4| |edges#0@@11|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@17 null)) (not true)) ($Is refType this@@17 Tclass._module.Memory)) ($Is refType |t#0@@4| Tclass._module.Object)) ($Is SetType |edges#0@@11| (TSet Tclass._module.Edge))))) (and (forall ((|e#0@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@1| Tclass._module.Edge) (=> (|Set#IsMember| |edges#0@@11| ($Box DatatypeTypeType |e#0@@1|)) (_module.Edge.Edge_q |e#0@@1|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |901|
 :pattern ( (_module.Edge.t |e#0@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@11| ($Box DatatypeTypeType |e#0@@1|)))
)) (= (_module.Memory.incomingEdges this@@17 |t#0@@4| |edges#0@@11|) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge |edges#0@@11| |t#0@@4|)))))
 :qid |gitissue3855dfy.245:12|
 :skolemid |902|
 :pattern ( (_module.Memory.incomingEdges this@@17 |t#0@@4| |edges#0@@11|))
))))
(assert (forall ((|l#0@@3| T@U) (|l#1@@3| T@U) (|l#2@@0| T@U) (|$y#0@@2| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#122| |l#0@@3| |l#1@@3| |l#2@@0|) |$y#0@@2|)) (exists ((|o#1| T@U) ) (!  (and (and ($Is refType |o#1| |l#0@@3|) (|Set#IsMember| |l#1@@3| ($Box refType |o#1|))) (= |$y#0@@2| ($Box DatatypeTypeType (_module.Object.region |o#1|))))
 :qid |gitissue3855dfy.603:7|
 :skolemid |1184|
 :pattern ( (_module.Object.region |o#1|))
 :pattern ( (|Set#IsMember| |l#2@@0| ($Box refType |o#1|)))
)))
 :qid |gitissue3855dfy.87:7|
 :skolemid |1425|
 :pattern ( (MapType0Select BoxType boolType (|lambda#122| |l#0@@3| |l#1@@3| |l#2@@0|) |$y#0@@2|))
)))
(assert (forall ((|l#0@@4| T@U) (|l#1@@4| T@U) (|l#2@@1| T@U) (|l#3| T@U) (|$y#0@@3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#71| |l#0@@4| |l#1@@4| |l#2@@1| |l#3|) |$y#0@@3|))  (and ($IsBox |$y#0@@3| |l#0@@4|) (and (|Set#IsMember| |l#1@@4| |$y#0@@3|) (and (|_module.Region#Equal| (_module.Object.region (_module.Edge.t ($Unbox DatatypeTypeType |$y#0@@3|))) |l#2@@1|) (not (|_module.Region#Equal| (_module.Object.region (_module.Edge.f ($Unbox DatatypeTypeType |$y#0@@3|))) |l#3|))))))
 :qid |gitissue3855dfy.149:10|
 :skolemid |1420|
 :pattern ( (MapType0Select BoxType boolType (|lambda#71| |l#0@@4| |l#1@@4| |l#2@@1| |l#3|) |$y#0@@3|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@18 T@U) (|os#0@@5| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@3 this@@18 |os#0@@5|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Memory) ($IsAlloc refType this@@18 Tclass._module.Memory $Heap@@3)))) (and ($Is SetType |os#0@@5| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@5| (TSet Tclass._module.Object) $Heap@@3))))) (and (and (forall ((|edge#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |edge#0| Tclass._module.Edge) (|Set#IsMember| (_module.Memory.edges $Heap@@3 this@@18 |os#0@@5|) ($Box DatatypeTypeType |edge#0|))) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|))) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|)))) (_module.Edge.t |edge#0|))))
 :qid |gitissue3855dfy.258:20|
 :skolemid |916|
 :pattern ( (_module.Edge.t |edge#0|))
 :pattern ( (_module.Edge.f |edge#0|))
 :pattern ( (_module.Edge.n |edge#0|))
 :pattern ( (|Set#IsMember| (_module.Memory.edges $Heap@@3 this@@18 |os#0@@5|) ($Box DatatypeTypeType |edge#0|)))
)) (=> (|Set#Equal| |os#0@@5| |Set#Empty|) (|Set#Equal| (_module.Memory.edges $Heap@@3 this@@18 |os#0@@5|) |Set#Empty|))) ($Is SetType (_module.Memory.edges $Heap@@3 this@@18 |os#0@@5|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |917|
 :pattern ( (_module.Memory.edges $Heap@@3 this@@18 |os#0@@5|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@19 T@U) (|os#0@@6| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@4 this@@19 |os#0@@6|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@4) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Memory) ($IsAlloc refType this@@19 Tclass._module.Memory $Heap@@4)))) ($Is SetType |os#0@@6| (TSet Tclass._module.Object))))) (= (_module.Memory.justTheIsos $Heap@@4 this@@19 |os#0@@6|) (|Set#FromBoogieMap| (|lambda#38| Tclass._module.Object |os#0@@6|))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |893|
 :pattern ( (_module.Memory.justTheIsos $Heap@@4 this@@19 |os#0@@6|) ($IsGoodHeap $Heap@@4))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@20 T@U) (|os#0@@7| T@U) ) (!  (=> (or (|_module.Memory.allRegions#canCall| (Lit refType this@@20) (Lit SetType |os#0@@7|)) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@20 null)) (not true)) ($Is refType this@@20 Tclass._module.Memory)) ($Is SetType |os#0@@7| (TSet Tclass._module.Object))))) (= (_module.Memory.allRegions (Lit refType this@@20) (Lit SetType |os#0@@7|)) (|Set#FromBoogieMap| (|lambda#122| Tclass._module.Object (Lit SetType |os#0@@7|) |os#0@@7|))))
 :qid |gitissue3855dfy.600:10|
 :weight 3
 :skolemid |1189|
 :pattern ( (_module.Memory.allRegions (Lit refType this@@20) (Lit SetType |os#0@@7|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@21 T@U) (|edges#0@@12| T@U) ) (!  (=> (and (or (|_module.Memory.justHeapExternalEdges#canCall| this@@21 |edges#0@@12|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@21 null)) (not true)) ($IsAlloc refType this@@21 Tclass._module.Memory $Heap@@5)) (and ($Is SetType |edges#0@@12| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@12| (TSet Tclass._module.Edge) $Heap@@5))))) ($IsGoodHeap $Heap@@5)) ($IsAlloc SetType (_module.Memory.justHeapExternalEdges this@@21 |edges#0@@12|) (TSet Tclass._module.Edge) $Heap@@5))
 :qid |gitissue3855dfy.345:12|
 :skolemid |1010|
 :pattern ( ($IsAlloc SetType (_module.Memory.justHeapExternalEdges this@@21 |edges#0@@12|) (TSet Tclass._module.Edge) $Heap@@5))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@22 T@U) (|os#0@@8| T@U) ) (!  (=> (and (or (|_module.Memory.allRegions#canCall| this@@22 |os#0@@8|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@22 null)) (not true)) ($IsAlloc refType this@@22 Tclass._module.Memory $Heap@@6)) (and ($Is SetType |os#0@@8| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@8| (TSet Tclass._module.Object) $Heap@@6))))) ($IsGoodHeap $Heap@@6)) ($IsAlloc SetType (_module.Memory.allRegions this@@22 |os#0@@8|) (TSet Tclass._module.Region) $Heap@@6))
 :qid |gitissue3855dfy.600:10|
 :skolemid |1182|
 :pattern ( ($IsAlloc SetType (_module.Memory.allRegions this@@22 |os#0@@8|) (TSet Tclass._module.Region) $Heap@@6))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@23 T@U) (|os#0@@9| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOne#canCall| $Heap@@7 this@@23 |os#0@@9|) (and (< 5 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Memory) ($IsAlloc refType this@@23 Tclass._module.Memory $Heap@@7)))) ($Is SetType |os#0@@9| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@7 this@@23 |os#0@@9|) (let ((|edges#0@@13| (_module.Memory.edges $Heap@@7 this@@23 |os#0@@9|)))
(|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@23 |edges#0@@13|))) (= (_module.Memory.heapExternalsZeroOrOne $Heap@@7 this@@23 |os#0@@9|) (let ((|edges#0@@14| (_module.Memory.edges $Heap@@7 this@@23 |os#0@@9|)))
(_module.Memory.heapExternalsZeroOrOneEdges this@@23 |edges#0@@14|)))))
 :qid |gitissue3855dfy.273:13|
 :skolemid |937|
 :pattern ( (_module.Memory.heapExternalsZeroOrOne $Heap@@7 this@@23 |os#0@@9|) ($IsGoodHeap $Heap@@7))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@24 T@U) (|t#0@@5| T@U) (|edges#0@@15| T@U) ) (!  (=> (and (or (|_module.Memory.incomingEdges#canCall| this@@24 |t#0@@5| |edges#0@@15|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@24 null)) (not true)) ($IsAlloc refType this@@24 Tclass._module.Memory $Heap@@8)) (and ($Is refType |t#0@@5| Tclass._module.Object) ($IsAlloc refType |t#0@@5| Tclass._module.Object $Heap@@8))) (and ($Is SetType |edges#0@@15| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@15| (TSet Tclass._module.Edge) $Heap@@8))))) ($IsGoodHeap $Heap@@8)) ($IsAlloc SetType (_module.Memory.incomingEdges this@@24 |t#0@@5| |edges#0@@15|) (TSet Tclass._module.Edge) $Heap@@8))
 :qid |gitissue3855dfy.245:12|
 :skolemid |899|
 :pattern ( ($IsAlloc SetType (_module.Memory.incomingEdges this@@24 |t#0@@5| |edges#0@@15|) (TSet Tclass._module.Edge) $Heap@@8))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@25 T@U) (|o#0@@2| T@U) (|edges#0@@16| T@U) ) (!  (=> (and (or (|_module.Memory.externalEdges#canCall| this@@25 |o#0@@2| |edges#0@@16|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@25 null)) (not true)) ($IsAlloc refType this@@25 Tclass._module.Memory $Heap@@9)) (and ($Is DatatypeTypeType |o#0@@2| Tclass._module.Region) ($IsAlloc DatatypeTypeType |o#0@@2| Tclass._module.Region $Heap@@9))) (and ($Is SetType |edges#0@@16| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@16| (TSet Tclass._module.Edge) $Heap@@9))))) ($IsGoodHeap $Heap@@9)) ($IsAlloc SetType (_module.Memory.externalEdges this@@25 |o#0@@2| |edges#0@@16|) (TSet Tclass._module.Edge) $Heap@@9))
 :qid |gitissue3855dfy.336:12|
 :skolemid |1000|
 :pattern ( ($IsAlloc SetType (_module.Memory.externalEdges this@@25 |o#0@@2| |edges#0@@16|) (TSet Tclass._module.Edge) $Heap@@9))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@26 T@U) (|t#0@@6| T@U) (|edges#0@@17| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@26 (Lit refType |t#0@@6|) (Lit SetType |edges#0@@17|)) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@26 null)) (not true)) ($Is refType this@@26 Tclass._module.Memory)) ($Is refType |t#0@@6| Tclass._module.Object)) ($Is SetType |edges#0@@17| (TSet Tclass._module.Edge))))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@17|) ($Box DatatypeTypeType |e#1|)) (_module.Edge.Edge_q |e#1|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |903|
 :pattern ( (_module.Edge.t |e#1|))
 :pattern ( (|Set#IsMember| |edges#0@@17| ($Box DatatypeTypeType |e#1|)))
)) (= (_module.Memory.incomingEdges this@@26 (Lit refType |t#0@@6|) (Lit SetType |edges#0@@17|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge (Lit SetType |edges#0@@17|) (Lit refType |t#0@@6|))))))
 :qid |gitissue3855dfy.245:12|
 :weight 3
 :skolemid |904|
 :pattern ( (_module.Memory.incomingEdges this@@26 (Lit refType |t#0@@6|) (Lit SetType |edges#0@@17|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@27 T@U) (|edges#0@@18| T@U) ) (!  (=> (or (|_module.Memory.justHeapExternalEdges#canCall| this@@27 (Lit SetType |edges#0@@18|)) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@27 null)) (not true)) ($Is refType this@@27 Tclass._module.Memory)) ($Is SetType |edges#0@@18| (TSet Tclass._module.Edge))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@18|) ($Box DatatypeTypeType |e#1@@0|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#1@@0|))) (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#1@@0|)))) (and (_module.Edge.Edge_q |e#1@@0|) (_module.Edge.Edge_q |e#1@@0|))) (=> (not (|_module.Region#Equal| (_module.Object.region (_module.Edge.f |e#1@@0|)) (_module.Object.region (_module.Edge.t |e#1@@0|)))) (_module.Edge.Edge_q |e#1@@0|)))))
 :qid |gitissue3855dfy.348:9|
 :skolemid |1014|
 :pattern ( (_module.Edge.t |e#1@@0|))
 :pattern ( (_module.Edge.f |e#1@@0|))
 :pattern ( (|Set#IsMember| |edges#0@@18| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (_module.Memory.justHeapExternalEdges this@@27 (Lit SetType |edges#0@@18|)) (|Set#FromBoogieMap| (|lambda#76| Tclass._module.Edge (Lit SetType |edges#0@@18|))))))
 :qid |gitissue3855dfy.345:12|
 :weight 3
 :skolemid |1015|
 :pattern ( (_module.Memory.justHeapExternalEdges this@@27 (Lit SetType |edges#0@@18|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@28 T@U) (|o#0@@3| T@U) (|edges#0@@19| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| (Lit refType this@@28) (Lit DatatypeTypeType |o#0@@3|) (Lit SetType |edges#0@@19|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@28 null)) (not true)) ($Is refType this@@28 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@3| Tclass._module.Region)) ($Is SetType |edges#0@@19| (TSet Tclass._module.Edge))))) (and (forall ((|e#2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#2@@1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@19|) ($Box DatatypeTypeType |e#2@@1|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#2@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@3|))) (_module.Edge.Edge_q |e#2@@1|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#2@@1|)) |o#0@@3|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#2@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@3|))) (_module.Edge.Edge_q |e#2@@1|))))))
 :qid |gitissue3855dfy.339:9|
 :skolemid |1006|
 :pattern ( (_module.Edge.f |e#2@@1|))
 :pattern ( (_module.Edge.t |e#2@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@19| ($Box DatatypeTypeType |e#2@@1|)))
)) (= (_module.Memory.externalEdges (Lit refType this@@28) (Lit DatatypeTypeType |o#0@@3|) (Lit SetType |edges#0@@19|)) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge (Lit SetType |edges#0@@19|) |o#0@@3| |o#0@@3|)))))
 :qid |gitissue3855dfy.336:12|
 :weight 3
 :skolemid |1007|
 :pattern ( (_module.Memory.externalEdges (Lit refType this@@28) (Lit DatatypeTypeType |o#0@@3|) (Lit SetType |edges#0@@19|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@29 T@U) (|os#0@@10| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@10 this@@29 |os#0@@10|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@29 null)) (not true)) (and ($Is refType this@@29 Tclass._module.Memory) ($IsAlloc refType this@@29 Tclass._module.Memory $Heap@@10)))) (and ($Is SetType |os#0@@10| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@10| (TSet Tclass._module.Object) $Heap@@10))))) (and (and (and (forall ((|r#0@@1| T@U) ) (!  (=> (and ($Is refType |r#0@@1| Tclass._module.Object) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@10 this@@29 |os#0@@10|) ($Box refType |r#0@@1|))) (_module.Region.Isolate_q (_module.Object.region |r#0@@1|)))
 :qid |gitissue3855dfy.237:20|
 :skolemid |888|
 :pattern ( (_module.Object.region |r#0@@1|))
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@10 this@@29 |os#0@@10|) ($Box refType |r#0@@1|)))
)) (forall ((|o#0@@4| T@U) ) (!  (=> (and ($Is refType |o#0@@4| Tclass._module.Object) (|Set#IsMember| |os#0@@10| ($Box refType |o#0@@4|))) (=> (_module.Region.Isolate_q (_module.Object.region |o#0@@4|)) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@10 this@@29 |os#0@@10|) ($Box refType |o#0@@4|))))
 :qid |gitissue3855dfy.238:20|
 :skolemid |889|
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@10 this@@29 |os#0@@10|) ($Box refType |o#0@@4|)))
 :pattern ( (_module.Object.region |o#0@@4|))
 :pattern ( (|Set#IsMember| |os#0@@10| ($Box refType |o#0@@4|)))
))) (=> (|Set#Equal| |os#0@@10| |Set#Empty|) (|Set#Equal| (_module.Memory.justTheIsos $Heap@@10 this@@29 |os#0@@10|) |Set#Empty|))) ($Is SetType (_module.Memory.justTheIsos $Heap@@10 this@@29 |os#0@@10|) (TSet Tclass._module.Object))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |890|
 :pattern ( (_module.Memory.justTheIsos $Heap@@10 this@@29 |os#0@@10|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@30 T@U) (|edges#0@@20| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@30 |edges#0@@20|) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@30 null)) (not true)) ($Is refType this@@30 Tclass._module.Memory)) ($Is SetType |edges#0@@20| (TSet Tclass._module.Edge))))) (and (and (|_module.Memory.justHeapExternalEdges#canCall| this@@30 |edges#0@@20|) (let ((|heapExternalEdges#0| (_module.Memory.justHeapExternalEdges this@@30 |edges#0@@20|)))
...
(forall ((|r#0@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |r#0@@2| Tclass._module.Region) (=> (|Set#IsMember| |allRelevantHeapRegions#0| ($Box DatatypeTypeType |r#0@@2|)) (|_module.Memory.externalEdges#canCall| this@@30 |r#0@@2| |heapExternalEdges#0|)))
 :qid |gitissue3855dfy.285:11|
 :skolemid |945|
 :pattern ( (_module.Memory.externalEdges this@@30 |r#0@@2| |heapExternalEdges#0|))
 :pattern ( (|Set#IsMember| |allRelevantHeapRegions#0| ($Box DatatypeTypeType |r#0@@2|)))
)))))) (= (_module.Memory.heapExternalsZeroOrOneEdges this@@30 |edges#0@@20|) (let ((|heapExternalEdges#0@@0| (_module.Memory.justHeapExternalEdges this@@30 |edges#0@@20|)))
...
(let ((|heapExternalEdgesPartitionedByRegion#0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region |allRelevantHeapRegions#0@@0|)) (|lambda#55| this@@30 |heapExternalEdges#0@@0|) (TMap Tclass._module.Region (TSet Tclass._module.Edge)))))
(forall ((|hr#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |hr#0| Tclass._module.Region) (|Set#IsMember| (|Map#Domain| |heapExternalEdgesPartitionedByRegion#0|) ($Box DatatypeTypeType |hr#0|))) (<= (|Set#Card| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |heapExternalEdgesPartitionedByRegion#0|) ($Box DatatypeTypeType |hr#0|)))) (LitInt 1)))
 ...
 :qid |gitissue3855dfy.280:13|
 :skolemid |947|
 :pattern ( (_module.Memory.heapExternalsZeroOrOneEdges this@@30 |edges#0@@20|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@31 T@U) (|os#0@@11| T@U) ) (!  (=> (or (|_module.Memory.isosRefCountZeroOrOne#canCall| $Heap@@11 this@@31 |os#0@@11|) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Memory) ($IsAlloc refType this@@31 Tclass._module.Memory $Heap@@11)))) ($Is SetType |os#0@@11| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@11 this@@31 |os#0@@11|) (let ((|edges#0@@21| (_module.Memory.edges $Heap@@11 this@@31 |os#0@@11|)))
 (and (|_module.Memory.justTheIsos#canCall| $Heap@@11 this@@31 |os#0@@11|) (let ((|isos#0| (_module.Memory.justTheIsos $Heap@@11 this@@31 |os#0@@11|)))
(forall ((|i#0| T@U) ) (!  (=> ($Is refType |i#0| Tclass._module.Object) (=> (|Set#IsMember| |isos#0| ($Box refType |i#0|)) (|_module.Memory.refCountEdges#canCall| this@@31 |i#0| |edges#0@@21|)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |983|
 :pattern ( (_module.Memory.refCountEdges this@@31 |i#0| |edges#0@@21|))
 :pattern ( (|Set#IsMember| |isos#0| ($Box refType |i#0|)))
)))))) (= (_module.Memory.isosRefCountZeroOrOne $Heap@@11 this@@31 |os#0@@11|) (let ((|edges#0@@22| (_module.Memory.edges $Heap@@11 this@@31 |os#0@@11|)))
(let ((|isos#0@@0| (_module.Memory.justTheIsos $Heap@@11 this@@31 |os#0@@11|)))
(forall ((|i#0@@0| T@U) ) (!  (=> (and ($Is refType |i#0@@0| Tclass._module.Object) (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|))) (<= (_module.Memory.refCountEdges this@@31 |i#0@@0| |edges#0@@22|) (LitInt 1)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |982|
 :pattern ( (_module.Memory.refCountEdges this@@31 |i#0@@0| |edges#0@@22|))
 :pattern ( (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|)))
)))))))
 :qid |gitissue3855dfy.315:13|
 :skolemid |984|
 :pattern ( (_module.Memory.isosRefCountZeroOrOne $Heap@@11 this@@31 |os#0@@11|) ($IsGoodHeap $Heap@@11))
))))
...
(assert (forall ((|l#0@@7| T@U) (|l#1@@7| T@U) (|l#2@@3| T@U) (|l#3@@0| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|$y#0@@4| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@0| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10|) |$y#0@@4|)) (exists ((|o#0@@5| T@U) (|n#0| T@U) ) (!  (and (and (and ($Is refType |o#0@@5| |l#0@@7|) ($Is SeqType |n#0| |l#1@@7|)) (and (|Set#IsMember| |l#2@@3| ($Box refType |o#0@@5|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3@@0| |o#0@@5|) |l#4|))) ($Box SeqType |n#0|)))) (= |$y#0@@4| ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@5| |n#0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#5| |o#0@@5|) |l#6|))) ($Box SeqType |n#0|)))))))
 :qid |gitissue3855dfy.261:10|
 :skolemid |920|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#9| |o#0@@5|) |l#10|))) ($Box SeqType |n#0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#7| |o#0@@5|) |l#8|))) ($Box SeqType |n#0|)))
)))
 :qid |gitissue3855dfy.87:7|
 :skolemid |1416|
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@32 T@U) (|os#0@@12| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@12 this@@32 |os#0@@12|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.Memory) ($IsAlloc refType this@@32 Tclass._module.Memory $Heap@@12)))) ($Is SetType |os#0@@12| (TSet Tclass._module.Object))))) (= (_module.Memory.edges $Heap@@12 this@@32 |os#0@@12|) (|Set#FromBoogieMap| (|lambda#47| Tclass._module.Object (TSeq TChar) |os#0@@12| $Heap@@12 _module.Object.fields $Heap@@12 _module.Object.fields $Heap@@12 _module.Object.fields $Heap@@12 _module.Object.fields))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |921|
 :pattern ( (_module.Memory.edges $Heap@@12 this@@32 |os#0@@12|) ($IsGoodHeap $Heap@@12))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@33 T@U) (|t#0@@7| T@U) (|edges#0@@23| T@U) ) (!  (=> (or (|_module.Memory.refCountEdges#canCall| this@@33 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@23|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@33 null)) (not true)) ($Is refType this@@33 Tclass._module.Memory)) ($Is refType |t#0@@7| Tclass._module.Object)) ($Is SetType |edges#0@@23| (TSet Tclass._module.Edge))))) (and (|_module.Memory.incomingEdges#canCall| this@@33 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@23|)) (= (_module.Memory.refCountEdges this@@33 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@23|)) (|Set#Card| (_module.Memory.incomingEdges this@@33 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@23|))))))
 :qid |gitissue3855dfy.251:12|
 :weight 3
 :skolemid |911|
 :pattern ( (_module.Memory.refCountEdges this@@33 (Lit refType |t#0@@7|) (Lit SetType |edges#0@@23|)))
))))
...
(assert (forall ((|l#0@@8| T@U) (|l#1@@8| T@U) (|l#2@@4| T@U) (|l#3@@1| T@U) ($o@@7 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#34| |l#0@@8| |l#1@@8| |l#2@@4| |l#3@@1|) $o@@7 $f))  (=> (and (or (not (= $o@@7 |l#0@@8|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@8| $o@@7) |l#2@@4|)))) (|Set#IsMember| |l#3@@1| ($Box refType $o@@7))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1412|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#34| |l#0@@8| |l#1@@8| |l#2@@4| |l#3@@1|) $o@@7 $f))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@34 T@U) (|o#0@@6| T@U) (|edges#0@@24| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| this@@34 (Lit DatatypeTypeType |o#0@@6|) (Lit SetType |edges#0@@24|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@34 null)) (not true)) ($Is refType this@@34 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@6| Tclass._module.Region)) ($Is SetType |edges#0@@24| (TSet Tclass._module.Edge))))) (and (forall ((|e#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@24|) ($Box DatatypeTypeType |e#1@@1|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#1@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@6|))) (_module.Edge.Edge_q |e#1@@1|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#1@@1|)) |o#0@@6|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#1@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@6|))) (_module.Edge.Edge_q |e#1@@1|))))))
 :qid |gitissue3855dfy.339:9|
 :skolemid |1004|
 :pattern ( (_module.Edge.f |e#1@@1|))
 :pattern ( (_module.Edge.t |e#1@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@24| ($Box DatatypeTypeType |e#1@@1|)))
)) (= (_module.Memory.externalEdges this@@34 (Lit DatatypeTypeType |o#0@@6|) (Lit SetType |edges#0@@24|)) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge (Lit SetType |edges#0@@24|) |o#0@@6| |o#0@@6|)))))
 :qid |gitissue3855dfy.336:12|
 :weight 3
 :skolemid |1005|
 :pattern ( (_module.Memory.externalEdges this@@34 (Lit DatatypeTypeType |o#0@@6|) (Lit SetType |edges#0@@24|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@35 T@U) (|os#0@@13| T@U) ) (!  (=> (or (|_module.Memory.allRegions#canCall| this@@35 |os#0@@13|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.Memory)) ($Is SetType |os#0@@13| (TSet Tclass._module.Object))))) (= (_module.Memory.allRegions this@@35 |os#0@@13|) (|Set#FromBoogieMap| (|lambda#122| Tclass._module.Object |os#0@@13| |os#0@@13|))))
 :qid |gitissue3855dfy.600:10|
 :skolemid |1185|
 :pattern ( (_module.Memory.allRegions this@@35 |os#0@@13|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.wholeEnchiladaNEW)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (and ($IsAllocBox ($Box refType this@@36) Tclass._module.Memory? $Heap@@13) ($IsAlloc SetType |os#0@@14| (TSet Tclass._module.Object) $Heap@@13)) (=> (and (and (|_module.Memory.allRegions#canCall| this@@36 |os#0@@14|) (= |let#0#0#0| (_module.Memory.allRegions this@@36 |os#0@@14|))) (and (|_module.Memory.allRegions#canCall| this@@36 |os#0@@14|) ($Is SetType |let#0#0#0| (TSet Tclass._module.Region)))) (=> (and (and (and (and (= |ns#Z#0@0| |let#0#0#0|) ($IsAllocBox ($Box refType this@@36) Tclass._module.Memory? $Heap@@13)) (and ($IsAlloc SetType |os#0@@14| (TSet Tclass._module.Object) $Heap@@13) (= |b$reqreads#0@0| (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@8) alloc)))) (|Set#IsMember| |os#0@@14| ($Box refType $o@@8))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@0)))
 :qid |gitissue3855dfy.328:15|
 :skolemid |997|
))))) (and (and (|_module.Memory.edges#canCall| $Heap@@13 this@@36 |os#0@@14|) (= |let#1#0#0| (_module.Memory.edges $Heap@@13 this@@36 |os#0@@14|))) (and (|_module.Memory.edges#canCall| $Heap@@13 this@@36 |os#0@@14|) ($Is SetType |let#1#0#0| (TSet Tclass._module.Edge))))) (and (and (and (= |es#Z#0@0| |let#1#0#0|) ($IsAllocBox ($Box refType this@@36) Tclass._module.Memory? $Heap@@13)) (and ($IsAlloc SetType |os#0@@14| (TSet Tclass._module.Object) $Heap@@13) (= |b$reqreads#1@0| (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 $o@@9) alloc)))) (|Set#IsMember| |os#0@@14| ($Box refType $o@@9))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@9 $f@@1)))
 :qid |gitissue3855dfy.330:5|
 :skolemid |998|
))))) (and (and (|_module.Memory.wholeEnchilada#canCall| $Heap@@13 this@@36 |os#0@@14|) (= (_module.Memory.wholeEnchiladaNEW $Heap@@13 this@@36 |os#0@@14|) (_module.Memory.wholeEnchilada $Heap@@13 this@@36 |os#0@@14|))) (and (|_module.Memory.wholeEnchilada#canCall| $Heap@@13 this@@36 |os#0@@14|) ($Is boolType (bool_2_U (_module.Memory.wholeEnchiladaNEW $Heap@@13 this@@36 |os#0@@14|)) TBool))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@0|))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#34| null $Heap@@13 alloc |os#0@@14|)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@13) ($IsHeapAnchor $Heap@@13)) (=> (and (and (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Memory) ($IsAlloc refType this@@36 Tclass._module.Memory $Heap@@13))) ($Is SetType |os#0@@14| (TSet Tclass._module.Object))) (and (= 7 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
