...
(assert (distinct TInt TagInt alloc Tagclass._System.nat Tagclass._module.Gen |##_module.Gen.Create| tytagFamily$nat tytagFamily$Gen)
)
...
(set-info :boogie-vc-id Impl$$_module.__default.GetXInt)
...
(let ((anon3_Then_correct  (=> (= |g#0| (|#_module.Gen.Create| ($Box intType (int_2_U |_mcc#0#0_0@0|)))) (=> (and (<= (LitInt 0) |un#0_0@0|) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U |_mcc#0#0_0@0|) Tclass._System.nat)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |g#0| (Tclass._module.Gen TInt)) ($IsAlloc DatatypeTypeType |g#0| (Tclass._module.Gen TInt) $Heap)) (|$IsA#_module.Gen| |g#0|)) (<= (LitInt 0) |m#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
