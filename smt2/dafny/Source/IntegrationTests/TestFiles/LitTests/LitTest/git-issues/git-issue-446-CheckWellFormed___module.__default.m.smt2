...
(let ((anon7_Else_correct  (=> (=> (<= (LitInt 0) |i#0|) (and (and (_module.Result.Success_q |r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |r#0@0|))) |i#0|)) (= |o#0@0| (+ |i#0| |i#0|)))) (and (=> (= (ControlFlow 0 5) 1) anon8_Then_correct) (=> (= (ControlFlow 0 5) 2) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (<= (LitInt 0) |i#0|) (=> (and (_module.Result.Success_q |r#0@0|) ($IsAllocBox ($Box DatatypeTypeType |r#0@0|) (Tclass._module.Result TInt) $Heap@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.Result.Success_q |r#0@0|)) (=> (and (and (_module.Result.Success_q |r#0@0|) (|_module.Result.Extract#canCall| TInt |r#0@0|)) (and (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |r#0@0|))) |i#0|) (= |o#0@0| (+ |i#0| |i#0|)))) (and (=> (= (ControlFlow 0 3) 1) anon8_Then_correct) (=> (= (ControlFlow 0 3) 2) anon8_Else_correct))))))))
