...
(declare-fun _module.__default.RecoverType (T@U T@U) T@U)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun BoxType () T@T)
(declare-fun |_module.__default.RecoverType#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.RecoverType$T T@U) (|a#0| T@U) ) (!  (=> (or (|_module.__default.RecoverType#canCall| _module._default.RecoverType$T (Lit BoxType |a#0|)) (and (< 0 $FunctionContextHeight) ($IsBox |a#0| _module._default.RecoverType$T))) (= (_module.__default.RecoverType _module._default.RecoverType$T (Lit BoxType |a#0|)) (Lit BoxType |a#0|)))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |501|
 :pattern ( (_module.__default.RecoverType _module._default.RecoverType$T (Lit BoxType |a#0|)))
))))
(assert  (and (and (= (Ctor MapType) 4) (forall ((t0 T@T) (t1 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0 t1 (MapType0Store t0 t1 m x0 val) x0) val)
...
(assert (forall ((|m#0@@0| T@U) ($h T@U) ) (! (= ($IsAlloc MapType |m#0@@0| Tclass._module.map0 $h) ($IsAlloc MapType |m#0@@0| (TMap TInt TInt) $h))
 :qid |unknown.0:0|
 :skolemid |528|
 :pattern ( ($IsAlloc MapType |m#0@@0| Tclass._module.map0 $h))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.RecoverType$T@@0 T@U) (|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.RecoverType#canCall| _module._default.RecoverType$T@@0 |a#0@@0|) (and (< 0 $FunctionContextHeight) ($IsBox |a#0@@0| _module._default.RecoverType$T@@0))) ($IsBox (_module.__default.RecoverType _module._default.RecoverType$T@@0 |a#0@@0|) _module._default.RecoverType$T@@0))
 :qid |unknown.0:0|
 :skolemid |497|
 :pattern ( (_module.__default.RecoverType _module._default.RecoverType$T@@0 |a#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module._default.RecoverType$T@@1 T@U) (|a#0@@1| T@U) ) (!  (=> (or (|_module.__default.RecoverType#canCall| _module._default.RecoverType$T@@1 |a#0@@1|) (and (< 0 $FunctionContextHeight) ($IsBox |a#0@@1| _module._default.RecoverType$T@@1))) (= (_module.__default.RecoverType _module._default.RecoverType$T@@1 |a#0@@1|) |a#0@@1|))
 :qid |unknown.0:0|
 :skolemid |500|
 :pattern ( (_module.__default.RecoverType _module._default.RecoverType$T@@1 |a#0@@1|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.RecoverType$T@@2 T@U) (|a#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.RecoverType#canCall| _module._default.RecoverType$T@@2 |a#0@@2|) (and (< 0 $FunctionContextHeight) (and ($IsBox |a#0@@2| _module._default.RecoverType$T@@2) ($IsAllocBox |a#0@@2| _module._default.RecoverType$T@@2 $Heap)))) ($IsGoodHeap $Heap)) ($IsAllocBox (_module.__default.RecoverType _module._default.RecoverType$T@@2 |a#0@@2|) _module._default.RecoverType$T@@2 $Heap))
 :qid |gitissue3059dfy.36:16|
 :skolemid |498|
 :pattern ( ($IsAllocBox (_module.__default.RecoverType _module._default.RecoverType$T@@2 |a#0@@2|) _module._default.RecoverType$T@@2 $Heap))
))))
...
(declare-fun |u#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.AddInMap0__Proxy__Rejects)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and ($Is MapType |m#0@0| (TMap TInt TInt)) ($IsAlloc MapType |m#0@0| (TMap TInt TInt) $Heap@@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is MapType (|Map#Build| |m#0@0| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 7)))) Tclass._module.map0)) (=> ($Is MapType (|Map#Build| |m#0@0| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 7)))) Tclass._module.map0) (=> (and (= |r#0@0| (|Map#Build| |m#0@0| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 7))))) ($IsAlloc MapType |r#0@0| Tclass._module.map0 $Heap@@0)) (=> (and (and (|_module.__default.RecoverType#canCall| Tclass._module.map0 ($Box MapType |r#0@0|)) (|_module.__default.RecoverType#canCall| Tclass._module.map0 ($Box MapType |r#0@0|))) (and (= |u#0@0| ($Unbox MapType (_module.__default.RecoverType Tclass._module.map0 ($Box MapType |r#0@0|)))) (= (ControlFlow 0 2) (- 0 1)))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and ($Is MapType |r#0| Tclass._module.map0) ($IsAlloc MapType |r#0| Tclass._module.map0 $Heap@@0))) (and (and ($Is MapType |m#0@@1| (TMap TInt TInt)) ($IsAlloc MapType |m#0@@1| (TMap TInt TInt) $Heap@@0)) true)) (and (and (and ($Is MapType |u#0| Tclass._module.map0) ($IsAlloc MapType |u#0| Tclass._module.map0 $Heap@@0)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
