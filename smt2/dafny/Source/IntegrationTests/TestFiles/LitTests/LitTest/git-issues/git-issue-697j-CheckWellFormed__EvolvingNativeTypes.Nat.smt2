...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@95  (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= ($generated 0) ($generated 0))) (=> (= (ControlFlow 0 3) (- 0 2)) ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4  (or (not (= 0 1)) (not true)))))))))
