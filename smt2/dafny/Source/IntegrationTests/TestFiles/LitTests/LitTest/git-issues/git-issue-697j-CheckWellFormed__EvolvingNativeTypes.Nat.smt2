...
(set-info :boogie-vc-id CheckWellFormed$$EvolvingNativeTypes.Nat)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 1)) (not true)))))))))
