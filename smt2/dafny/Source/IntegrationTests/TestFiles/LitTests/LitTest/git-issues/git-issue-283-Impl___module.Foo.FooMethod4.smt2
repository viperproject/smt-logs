...
(assert (distinct TChar TagChar TagSeq alloc Tagclass._module.Foo |##_module.Result.Success| Tagclass._module.Result |##_module.Result.Failure| Tagclass._module.C Tagclass._module.Foo? tytagFamily$Foo tytagFamily$Result tytagFamily$C)
)
...
(assert (forall ((d@@8 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) ($Is DatatypeTypeType d@@8 Tclass._module.C)) ($IsAlloc DatatypeTypeType d@@8 Tclass._module.C $h@@5))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( ($IsAlloc DatatypeTypeType d@@8 Tclass._module.C $h@@5))
)))
...
(set-info :boogie-vc-id Impl$$_module.Foo.FooMethod4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> (_module.Result.Success_q |r#0|) (U_2_bool (Lit boolType (bool_2_U true))))) (=> (=> (_module.Result.Success_q |r#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (= (ControlFlow 0 4) (- 0 3)) (=> (not (_module.Result.Success_q |r#0|)) (U_2_bool (Lit boolType (bool_2_U true)))))))))
(let ((anon8_Else_correct  (=> (and (= |x#0@3| (LitInt 1)) (= (ControlFlow 0 6) 4)) GeneratedUnifiedExit_correct)))
(let ((anon8_Then_correct true))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (> |x#0@3| 0)) (=> (> |x#0@3| 0) (and (=> (= (ControlFlow 0 7) 2) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (= |r#0| (|#_module.Result.Failure| |_mcc#1#0_0@0|)) (=> (and ($Is SeqType |_mcc#1#0_0@0| (TSeq TChar)) ($IsAlloc SeqType |_mcc#1#0_0@0| (TSeq TChar) $Heap)) (=> (and (and (and ($Is SeqType |e#0_0@0| (TSeq TChar)) ($IsAlloc SeqType |e#0_0@0| (TSeq TChar) $Heap)) (and (= |let#0_0#0#0| |_mcc#1#0_0@0|) ($Is SeqType |let#0_0#0#0| (TSeq TChar)))) (and (and (= |e#0_0@0| |let#0_0#0#0|) (= |x#0@2| (LitInt 2))) (and (= |x#0@3| |x#0@2|) (= (ControlFlow 0 10) 7)))) anon4_correct)))))
(let ((anon6_Then_correct  (=> (= |r#0| (|#_module.Result.Success| ($Box DatatypeTypeType |_mcc#0#1_0@0|))) (=> (and ($Is DatatypeTypeType |_mcc#0#1_0@0| Tclass._module.C) ($IsAlloc DatatypeTypeType |_mcc#0#1_0@0| Tclass._module.C $Heap)) (=> (and (and (and ($Is DatatypeTypeType |C2#1_0@0| Tclass._module.C) ($IsAlloc DatatypeTypeType |C2#1_0@0| Tclass._module.C $Heap)) (and (= |let#1_0#0#0| |_mcc#0#1_0@0|) ($Is DatatypeTypeType |let#1_0#0#0| Tclass._module.C))) (and (and (= |C2#1_0@0| |let#1_0#0#0|) (= |x#0@1| (LitInt 1))) (and (= |x#0@3| |x#0@1|) (= (ControlFlow 0 9) 7)))) anon4_correct)))))
(let ((anon7_Else_correct true))
(let ((anon6_Else_correct  (=> (or (not (= |r#0| (|#_module.Result.Success| ($Box DatatypeTypeType |_mcc#0#1_0@0|)))) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon7_Then_correct) (=> (= (ControlFlow 0 11) 1) anon7_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 12) 9) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Foo) ($IsAlloc refType this Tclass._module.Foo $Heap)))) (=> (and (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result Tclass._module.C)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result Tclass._module.C) $Heap)) (|$IsA#_module.Result| |r#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
