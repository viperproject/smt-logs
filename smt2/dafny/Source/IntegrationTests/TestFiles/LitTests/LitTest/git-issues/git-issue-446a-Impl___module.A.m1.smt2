...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@2|))) (=> (=> (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@2|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (<= (LitInt 0) |i#0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@2|))) |i#0|))) (=> (=> (<= (LitInt 0) |i#0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@2|))) |i#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< |i#0| 0) (_module.Result.Failure_q |r#0@2|)))))))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 5) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A $Heap)))) (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
