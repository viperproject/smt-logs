...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.UpCastLShiftMasking)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon3_correct  (=> (and (<= (LitInt 0) |idx#0|) (<= |idx#0| (LitInt 64))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (= |newtype$check#0@0| (LitInt 64)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 256))) (=> (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 256)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (bvule #x40 #x80)) (=> (bvule #x40 #x80) (=> (= |newtype$check#1@0| (LitInt 64)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 |newtype$check#1@0|) (< |newtype$check#1@0| 256))) (=> (and (<= 0 |newtype$check#1@0|) (< |newtype$check#1@0| 256)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bvule #x40 #x80)) (=> (bvule #x40 #x80) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |idx#0|) (< |idx#0| 256))) (=> (and (<= 0 |idx#0|) (< |idx#0| 256)) (=> (= (ControlFlow 0 2) (- 0 1)) (bvule ((_ int2bv 8) |idx#0|) #x80)))))))))))))))))
(let ((anon4_Else_correct  (=> (and (< |idx#0| (LitInt 0)) (= (ControlFlow 0 9) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (<= (LitInt 0) |idx#0|) (= (ControlFlow 0 8) 2)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 10) 8) anon4_Then_correct) (=> (= (ControlFlow 0 10) 9) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |idx#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
