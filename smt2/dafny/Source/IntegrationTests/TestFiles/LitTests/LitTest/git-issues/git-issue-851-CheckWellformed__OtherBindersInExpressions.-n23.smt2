...
(declare-fun |OtherBindersInExpressions.__default.Lambda#canCall| () Bool)
(declare-fun OtherBindersInExpressions.__default.Lambda () Int)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#c#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#42| |l#0|) |$l#0#heap#0| |$l#0#c#0|)) ($IsBox |$l#0#c#0| |l#0|))
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#42| |l#0|) |$l#0#heap#0| |$l#0#c#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.Lambda#canCall| (< 1 $FunctionContextHeight)) (= OtherBindersInExpressions.__default.Lambda (LitInt (Div 40 (LitInt 0)))))))
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.Lambda#canCall| (< 1 $FunctionContextHeight)) (= OtherBindersInExpressions.__default.Lambda (LitInt (Div 40 (LitInt 0)))))))
...
(assert (forall ((|l#0@@0| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#43| |l#0@@0|) |$l#0#o#0|)) |l#0@@0|)
 :pattern ( (MapType1Select refType boolType (|lambda#43| |l#0@@0|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#45| |l#0@@1|) |$l#0#ly#0|) |l#0@@1|)
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#45| |l#0@@1|) |$l#0#ly#0|))
)))
...
(assert (forall ((ty T@U) ) (!  (=> ($AlwaysAllocated ty) (forall ((h@@8 T@U) (v@@3 T@U) ) (!  (=> ($IsBox v@@3 ty) ($IsAllocBox v@@3 ty h@@8))
 :pattern ( ($IsAllocBox v@@3 ty h@@8))
)))
 :pattern ( ($AlwaysAllocated ty))
)))
(assert (forall ((v@@4 T@U) (t0@@15 T@U) (h@@9 T@U) ) (! (= ($IsAlloc SetType v@@4 (TSet t0@@15) h@@9) (forall ((bx@@9 T@U) ) (!  (=> (|Set#IsMember| v@@4 bx@@9) ($IsAllocBox bx@@9 t0@@15 h@@9))
 :pattern ( (|Set#IsMember| v@@4 bx@@9))
)))
 :pattern ( ($IsAlloc SetType v@@4 (TSet t0@@15) h@@9))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#c#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#41| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#c#0@@0|) |l#0@@3|)
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#41| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#c#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#c#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#44| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#c#0@@1|) |l#0@@4|)
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#44| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#c#0@@1|))
)))
...
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |c#0@0| Tclass.OtherBindersInExpressions.C) ($IsAllocBox |c#0@0| Tclass.OtherBindersInExpressions.C |$lambdaHeap#0@0|))) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (and (and ($IsBox |c#0@0| Tclass.OtherBindersInExpressions.C) ($IsAllocBox |c#0@0| Tclass.OtherBindersInExpressions.C |$lambdaHeap#0@0|)) (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= $Heap $Heap@0)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (=> (= |lambdaResult#0| (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))) (=> (and ($Is boolType (bool_2_U |lambdaResult#0|) TBool) (= (ControlFlow 0 5) 4)) anon6_correct)))))))
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 8) 5) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (and (= |let#0#0#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#45| (Handle1 (|lambda#41| ($Box boolType (bool_2_U (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) (|lambda#42| Tclass.OtherBindersInExpressions.C) (|lambda#44| (SetRef_to_SetBox (|lambda#43| false))))) ($LS $LZ)))) ($Is HandleTypeType |let#0#0#0| (Tclass._System.___hTotalFunc1 Tclass.OtherBindersInExpressions.C TBool))) (and (= |f#Z#0@0| |let#0#0#0|) (= (ControlFlow 0 3) (- 0 2)))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 9) 1) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 9) 3) anon10_Else_correct)))))
