...
procedure {:verboseName "ByteDefinition.byte (well-formedness)"} CheckWellFormed$$ByteDefinition.byte(i#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ByteDefinition.byte (well-formedness)"} CheckWellFormed$$ByteDefinition.byte(i#0: int)
{
