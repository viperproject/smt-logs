...
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |x#0|) (= |newtype$check#0@0| (|char#ToInt| Main.__default.c))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 256))) (=> (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 256)) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (nat_from_bv8 ((_ int2bv 8) (|char#ToInt| Main.__default.c))))))))
