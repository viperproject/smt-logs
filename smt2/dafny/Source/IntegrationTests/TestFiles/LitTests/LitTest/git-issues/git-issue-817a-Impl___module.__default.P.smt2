...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 38) (let ((anon5_Else_correct  (=> (not (_module.Result.IsFailure TInt |call3formal@r#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 21)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 20)) (and (<= 0 |idx0#0@0|) (< |idx0#0@0| (_System.array.Length $nw@0)))) (=> (and (<= 0 |idx0#0@0|) (< |idx0#0@0| (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 4) (- 0 19)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |idx0#0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |idx0#0@0|))) (=> ($IsAllocBox ($Box DatatypeTypeType |call3formal@r#0@0|) (Tclass._module.Result TInt) $Heap@5) (and (=> (= (ControlFlow 0 4) (- 0 18)) (not (_module.Result.IsFailure TInt |call3formal@r#0@0|))) (=> (and (not (_module.Result.IsFailure TInt |call3formal@r#0@0|)) (|_module.Result.Extract#canCall| TInt |call3formal@r#0@0|)) (=> (and (and (|_module.Result.Extract#canCall| TInt |call3formal@r#0@0|) (= |$rhs#3@0| (U_2_int ($Unbox intType (_module.Result.Extract TInt |call3formal@r#0@0|))))) (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@0) (IndexField |idx0#0@0|) ($Box intType (int_2_U |$rhs#3@0|))))) ($IsGoodHeap $Heap@6))) (and (=> (= (ControlFlow 0 4) (- 0 17)) (or (not (= $nw@0 null)) (not true))) (and (=> (= (ControlFlow 0 4) (- 0 16)) (= (_System.array.Length $nw@0) (LitInt 10))) (=> (= (_System.array.Length $nw@0) (LitInt 10)) (and (=> (= (ControlFlow 0 4) (- 0 15)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 14)) (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 4) (- 0 13)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@0) (IndexField (LitInt 7))))) (LitInt 200))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@0) (IndexField (LitInt 7))))) (LitInt 200)) (and (=> (= (ControlFlow 0 4) (- 0 12)) true) (and (=> (= (ControlFlow 0 4) (- 0 11)) (or (not (= $nw@1 null)) (not true))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@1) _module.Cell.data))) (LitInt 9))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $nw@1) _module.Cell.data))) (LitInt 9)) (and (=> (= (ControlFlow 0 4) (- 0 9)) true) (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (not (= $nw@1 null)) (not true))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (= (ControlFlow 0 4) (- 0 3)) (and (<= 0 (LitInt 9)) (< (LitInt 9) (_System.array.Length $nw@0))))))))))))))))))))))))))))))))))))
(let ((anon5_Then_correct  (=> (_module.Result.IsFailure TInt |call3formal@r#0@0|) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |call3formal@r#0@0|) (Tclass._module.Result TInt) $Heap@5) (= (ControlFlow 0 2) (- 0 1))) (|_module.Result.IsFailure#canCall| TInt |call3formal@r#0@0|)) (or (_module.Result.IsFailure TInt |call3formal@r#0@0|) (_module.Result.Failure_q |call3formal@r#0@0|))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 22) (- 0 37)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 10)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 22) (- 0 36)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 35)) (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 22) (- 0 34)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 7))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 7)))) (=> (= |$rhs#0@0| (LitInt 321)) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) (IndexField (LitInt 7)) ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 22) (- 0 33)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 32)) (and (<= 0 (LitInt 9)) (< (LitInt 9) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 9)) (< (LitInt 9) (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 22) (- 0 31)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 9))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (LitInt 9)))) (=> (= |$rhs#1@0| (LitInt 142)) (=> (and (and (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (IndexField (LitInt 9)) ($Box intType (int_2_U |$rhs#1@0|))))) ($IsGoodHeap $Heap@2)) (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 Tclass._module.Cell?))) (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@1) alloc)))) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)))) (and (=> (= (ControlFlow 0 22) (- 0 30)) true) (and (=> (= (ControlFlow 0 22) (- 0 29)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 28)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@1 _module.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@1 _module.Cell.data)) (=> (= |$rhs#2@0| (LitInt 7)) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@1) _module.Cell.data ($Box intType (int_2_U |$rhs#2@0|))))) ($IsGoodHeap $Heap@4)) (and (=> (= (ControlFlow 0 22) (- 0 27)) true) (and (=> (= (ControlFlow 0 22) (- 0 26)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (=> (= |idx0#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@1) _module.Cell.data)))) (=> (and ($Is DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt) $Heap@4)) (and (=> (= (ControlFlow 0 22) (- 0 25)) true) (and (=> (= (ControlFlow 0 22) (- 0 24)) (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@10) alloc)))) (or (= $o@@10 $nw@0) (= $o@@10 $nw@1))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@10 $f@@0)))
 :qid |gitissue817adfy.33:17|
 :skolemid |490|
))) (=> (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@11) alloc)))) (or (= $o@@11 $nw@0) (= $o@@11 $nw@1))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@11 $f@@1)))
 :qid |gitissue817adfy.33:17|
 :skolemid |490|
)) (=> (and ($Is DatatypeTypeType |call3formal@r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call3formal@r#0| (Tclass._module.Result TInt) $Heap@@1)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (= (_System.array.Length $nw@0) (LitInt 10))) (=> (= (_System.array.Length $nw@0) (LitInt 10)) (=> (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5)) (=> (and (and (and (and ($Is DatatypeTypeType |call3formal@r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call3formal@r#0@0| (Tclass._module.Result TInt) $Heap@5)) (=> (_module.Result.Success_q |call3formal@r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |call3formal@r#0@0|))) (LitInt 200)))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@1) _module.Cell.data))) (LitInt 9)) (forall (($o@@12 T@U) ) (!  (=> (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@12) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@12) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@12)) (or (= $o@@12 $nw@0) (= $o@@12 $nw@1))))
 :qid |gitissue817adfy.13:8|
 :skolemid |484|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@12))
)))) (and (and ($HeapSucc $Heap@4 $Heap@5) ($IsAllocBox ($Box DatatypeTypeType |call3formal@r#0@0|) (Tclass._module.Result TInt) $Heap@5)) (and (|_module.Result.IsFailure#canCall| TInt |call3formal@r#0@0|) (|_module.Result.IsFailure#canCall| TInt |call3formal@r#0@0|)))) (and (=> (= (ControlFlow 0 22) 2) anon5_Then_correct) (=> (= (ControlFlow 0 22) 4) anon5_Else_correct))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@1))) (=> (and (and (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap@@1)) true) (and (=> |defass#c#0| (and ($Is refType |c#0@@3| Tclass._module.Cell) ($IsAlloc refType |c#0@@3| Tclass._module.Cell $Heap@@1))) true)) (and (and ($Is refType |recv0#0| (Tclass._System.array TInt)) ($IsAlloc refType |recv0#0| (Tclass._System.array TInt) $Heap@@1)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 38) 22)))) anon0_correct))))
