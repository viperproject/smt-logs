...
(declare-fun |lambda#49| (T@U T@U T@U T@U) T@U)
(declare-fun MapType1Store (T@T T@T T@T T@U T@U T@U T@U) T@U)
(declare-fun SetRef_to_SetBox (T@U) T@U)
(declare-fun |lambda#2| (Bool) T@U)
(declare-fun |lambda#4| (T@U) T@U)
(declare-fun |lambda#51| (Bool) T@U)
(declare-fun |lambda#53| (T@U) T@U)
...
(declare-fun |lambda#50| (Int T@U T@U Int Int Int) T@U)
...
(assert (distinct TInt TagInt TagSet alloc allocName Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc0 Tagclass._module.C Tagclass._module.C? class._module.C? tytagFamily$object |tytagFamily$_#Func0| tytagFamily$C field$x)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#49| |l#0| |l#1| |l#2| |l#3|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) (= $o@@3 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |521|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#49| |l#0| |l#1| |l#2| |l#3|) $o@@3 $f))
)))
...
(assert (forall ((|l#0@@0| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType0Select refType boolType (|lambda#2| |l#0@@0|) |$l#0#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |517|
 :pattern ( (MapType0Select refType boolType (|lambda#2| |l#0@@0|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@1|) |$l#0#ly#0|) |l#0@@1|)
 :qid |gitissue405dfy.4:26|
 :skolemid |519|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@1|) |$l#0#ly#0|))
)))
(assert (forall ((|l#0@@2| Bool) (|$l#0#heap#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#51| |l#0@@2|) |$l#0#heap#0|)) |l#0@@2|)
 :qid |unknown.0:0|
 :skolemid |523|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#51| |l#0@@2|) |$l#0#heap#0|))
)))
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#53| |l#0@@3|) |$l#0#heap#0@@0|) |l#0@@3|)
 :qid |gitissue405dfy.19:10|
 :skolemid |524|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#53| |l#0@@3|) |$l#0#heap#0@@0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@6 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#5| |l#0@@4| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@6 $f@@0))  (=> (and (or (not (= $o@@6 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@6) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |520|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#5| |l#0@@4| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@6 $f@@0))
)))
(assert (forall ((|l#0@@5| Int) (|l#1@@1| T@U) (|l#2@@1| T@U) (|l#3@@1| Int) (|l#4| Int) (|l#5| Int) (|$l#0#heap#0@@1| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#50| |l#0@@5| |l#1@@1| |l#2@@1| |l#3@@1| |l#4| |l#5|) |$l#0#heap#0@@1|) ($Box intType (int_2_U (ite (= (Div |l#0@@5| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |$l#0#heap#0@@1| |l#1@@1|) |l#2@@1|)))) |l#3@@1|) |l#4| |l#5|))))
 :qid |unknown.0:0|
 :skolemid |522|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#50| |l#0@@5| |l#1@@1| |l#2@@1| |l#3@@1| |l#4| |l#5|) |$l#0#heap#0@@1|))
)))
...
(assert (forall ((h@@8 T@U) (r@@2 T@U) (f@@11 T@U) (x@@7 T@U) ) (!  (=> ($IsGoodHeap (MapType0Store refType (MapType0Type FieldType BoxType) h@@8 r@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@8 r@@2) f@@11 x@@7))) ($HeapSucc h@@8 (MapType0Store refType (MapType0Type FieldType BoxType) h@@8 r@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@8 r@@2) f@@11 x@@7))))
 :qid |DafnyPreludebpl.603:15|
 :skolemid |116|
 :pattern ( (MapType0Store refType (MapType0Type FieldType BoxType) h@@8 r@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@8 r@@2) f@@11 x@@7)))
)))
...
(let ((anon9_Else_correct  (=> (and (and (or (not (= (Div 5 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |$lambdaHeap#0@0| this) _module.C.x)))) (LitInt 1))) (not true)) (= |lambdaResult#0| (LitInt 3))) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 8) 6))) anon5_correct)))
(let ((anon9_Then_correct  (=> (and (and (= (Div 5 (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |$lambdaHeap#0@0| this) _module.C.x)))) (LitInt 1)) (= |lambdaResult#0| (LitInt 2))) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 7) 6))) anon5_correct)))
(let ((anon8_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#5| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (U_2_bool (MapType1Select refType FieldType boolType |$_Frame#l0@0| this _module.C.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType |$_Frame#l0@0| this _module.C.x)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |$lambdaHeap#0@0| this) _module.C.x))) 0)) (not true))) (=> (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |$lambdaHeap#0@0| this) _module.C.x))) 0)) (not true)) (and (=> (= (ControlFlow 0 9) 7) anon9_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Else_correct)))))))))
(let ((anon8_Else_correct true))
(let ((anon7_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 12) 9) anon8_Then_correct) (=> (= (ControlFlow 0 12) 5) anon8_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (Requires0 TInt $Heap@2 |f#0@1|))))
(let ((anon7_Else_correct  (=> (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle0 (|lambda#50| 5 this _module.C.x (LitInt 1) 2 3) (|lambda#51| true) (|lambda#53| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.C.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.C.x)) (=> (and (= |$rhs#1@0| (LitInt 0)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.C.x ($Box intType (int_2_U |$rhs#1@0|)))))) (=> (and (and ($IsGoodHeap $Heap@1) (= |f#0@1| |f#0@0|)) (and (= $Heap@2 $Heap@1) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#49| null $Heap alloc this)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.C.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.C.x)) (=> (= |$rhs#0@0| (LitInt 5)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap this (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.C.x ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 13) 12) anon7_Then_correct) (=> (= (ControlFlow 0 13) 3) anon7_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap)))) (and (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc0 TInt)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc0 TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 15) 13)))) anon0_correct)))
