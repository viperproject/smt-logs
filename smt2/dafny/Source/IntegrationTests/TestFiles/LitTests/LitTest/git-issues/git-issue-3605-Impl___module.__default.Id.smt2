...
(set-info :boogie-vc-id Impl$$_module.__default.Id)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |s#0| (TSet Tclass._module.C)) ($IsAlloc SetType |s#0| (TSet Tclass._module.C) $Heap))) (and (and ($Is SetType |r#0| (TSet Tclass._module.C)) ($IsAlloc SetType |r#0| (TSet Tclass._module.C) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
