...
(declare-fun Tagclass.M3.NewTypeInt () T@U)
(declare-fun Tagclass.M3.MyNewTypeInt () T@U)
(declare-fun tytagFamily$NewTypeInt () T@U)
(declare-fun tytagFamily$MyNewTypeInt () T@U)
...
(declare-fun Tclass.M3.NewTypeInt () T@U)
(declare-fun Tclass.M3.MyNewTypeInt () T@U)
...
(assert (distinct TagMultiSet alloc Tagclass.M3.NewTypeInt Tagclass.M3.MyNewTypeInt tytagFamily$NewTypeInt tytagFamily$MyNewTypeInt)
)
(assert (forall ((|i#0| T@U) ($h T@U) ) (! ($IsAlloc intType |i#0| Tclass.M3.NewTypeInt $h)
 :qid |unknown.0:0|
 :skolemid |2042|
 :pattern ( ($IsAlloc intType |i#0| Tclass.M3.NewTypeInt $h))
)))
(assert (forall ((|n#0| T@U) ($h@@0 T@U) ) (! ($IsAlloc intType |n#0| Tclass.M3.MyNewTypeInt $h@@0)
 :qid |unknown.0:0|
 :skolemid |2046|
 :pattern ( ($IsAlloc intType |n#0| Tclass.M3.MyNewTypeInt $h@@0))
)))
...
(assert (forall ((|n#0@@0| T@U) ) (! (= ($Is intType |n#0@@0| Tclass.M3.MyNewTypeInt)  (and (and (<= (LitInt 0) (U_2_int |n#0@@0|)) (< (U_2_int |n#0@@0|) 100)) (<= (LitInt 2) (U_2_int |n#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |2045|
 :pattern ( ($Is intType |n#0@@0| Tclass.M3.MyNewTypeInt))
)))
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass.M3.NewTypeInt) (and (= ($Box intType ($Unbox intType bx)) bx) ($Is intType ($Unbox intType bx) Tclass.M3.NewTypeInt)))
 :qid |unknown.0:0|
 :skolemid |2018|
 :pattern ( ($IsBox bx Tclass.M3.NewTypeInt))
)))
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.M3.MyNewTypeInt) (and (= ($Box intType ($Unbox intType bx@@0)) bx@@0) ($Is intType ($Unbox intType bx@@0) Tclass.M3.MyNewTypeInt)))
 :qid |unknown.0:0|
 :skolemid |2019|
 :pattern ( ($IsBox bx@@0 Tclass.M3.MyNewTypeInt))
)))
...
(assert (= (Tag Tclass.M3.NewTypeInt) Tagclass.M3.NewTypeInt))
(assert (= (TagFamily Tclass.M3.NewTypeInt) tytagFamily$NewTypeInt))
(assert (= (Tag Tclass.M3.MyNewTypeInt) Tagclass.M3.MyNewTypeInt))
(assert (= (TagFamily Tclass.M3.MyNewTypeInt) tytagFamily$MyNewTypeInt))
(assert (forall ((|i#0@@0| T@U) ) (! (= ($Is intType |i#0@@0| Tclass.M3.NewTypeInt)  (and (<= (LitInt 0) (U_2_int |i#0@@0|)) (< (U_2_int |i#0@@0|) 100)))
 :qid |unknown.0:0|
 :skolemid |2041|
 :pattern ( ($Is intType |i#0@@0| Tclass.M3.NewTypeInt))
)))
...
(set-info :boogie-vc-id Impl$$M3.__default.TestMyNewTypeInt)
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is MultiSetType (|MultiSet#Union| |s1#0@0| |s0#0@0|) (TMultiSet Tclass.M3.MyNewTypeInt)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is MultiSetType (|MultiSet#Union| |s0#0@0| |s1#0@0|) (TMultiSet Tclass.M3.MyNewTypeInt)))))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |s0#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U |x0#0|)))) (= |s1#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U |x1#0|))))) (and (and (and (and (and (and (=> (= (ControlFlow 0 11) 1) anon8_Then_correct) (=> (= (ControlFlow 0 11) 2) anon9_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 8) anon13_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon13_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 0) |x0#0|) (< |x0#0| 100))) (=> (and (and (and (<= (LitInt 0) |x1#0|) (< |x1#0| 100)) (<= (LitInt 2) |x1#0|)) (and (and ($Is MultiSetType |s0#0| (TMultiSet Tclass.M3.NewTypeInt)) ($IsAlloc MultiSetType |s0#0| (TMultiSet Tclass.M3.NewTypeInt) $Heap)) true)) (=> (and (and (and (and (and ($Is MultiSetType |s1#0| (TMultiSet Tclass.M3.MyNewTypeInt)) ($IsAlloc MultiSetType |s1#0| (TMultiSet Tclass.M3.MyNewTypeInt) $Heap)) true) (and (and ($Is MultiSetType |a#0_0| (TMultiSet Tclass.M3.NewTypeInt)) ($IsAlloc MultiSetType |a#0_0| (TMultiSet Tclass.M3.NewTypeInt) $Heap)) true)) (and (and (and ($Is MultiSetType |a#1_0| (TMultiSet Tclass.M3.NewTypeInt)) ($IsAlloc MultiSetType |a#1_0| (TMultiSet Tclass.M3.NewTypeInt) $Heap)) true) (and (and ($Is MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyNewTypeInt)) ($IsAlloc MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyNewTypeInt) $Heap)) true))) (and (and (and (and ($Is MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyNewTypeInt)) ($IsAlloc MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyNewTypeInt) $Heap)) true) (and (and ($Is MultiSetType |a#4_0| (TMultiSet Tclass.M3.NewTypeInt)) ($IsAlloc MultiSetType |a#4_0| (TMultiSet Tclass.M3.NewTypeInt) $Heap)) true)) (and (and (and ($Is MultiSetType |a#5_0| (TMultiSet Tclass.M3.NewTypeInt)) ($IsAlloc MultiSetType |a#5_0| (TMultiSet Tclass.M3.NewTypeInt) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 12) 11))))) anon0_correct)))))
