...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (and (< 1 (|Seq#Length| |args#0|)) (= (ControlFlow 0 3) (- 0 2))) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |args#0|))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |args#0| (TSeq (TSeq TChar))) ($IsAlloc SeqType |args#0| (TSeq (TSeq TChar)) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
