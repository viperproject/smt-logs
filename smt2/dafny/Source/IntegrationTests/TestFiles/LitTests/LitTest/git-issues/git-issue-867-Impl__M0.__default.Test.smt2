...
(assert (forall ((a@@19 T@U) (b@@15 T@U) ) (! (= (|Set#Equal| a@@19 b@@15) (forall ((o@@5 T@U) ) (! (= (|Set#IsMember| a@@19 o@@5) (|Set#IsMember| b@@15 o@@5))
...
(assert (forall ((a@@20 T@U) (x@@17 T@U) ) (!  (=> (not (|Set#IsMember| a@@20 x@@17)) (= (|Set#Card| (|Set#UnionOne| a@@20 x@@17)) (+ (|Set#Card| a@@20) 1)))
 :qid |DafnyPreludebpl.698:15|
 :skolemid |132|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@20 x@@17)))
)))
...
(declare-fun |c#0| () T@U)
(declare-fun |d#0| () T@U)
(set-info :boogie-vc-id Impl$$M0.__default.Test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (= |s#0@0| (Lit SetType (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 3)))))) (= |t#0@0| (Lit SetType (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#Equal| |s#0@0| |t#0@0|)) (=> (|Set#Equal| |s#0@0| |t#0@0|) (=> (and (and (and ($IsAlloc SetType |s#0@0| (TSet TInt) $Heap@@2) (|M0.__default.fSetToSeq#canCall| TInt |s#0@0|)) (and (|M0.__default.fSetToSeq#canCall| TInt |s#0@0|) (= |a#0@0| (M0.__default.fSetToSeq TInt ($LS $LZ) |s#0@0|)))) (and (and ($IsAlloc SetType |t#0@0| (TSet TInt) $Heap@@2) (|M0.__default.fSetToSeq#canCall| TInt |t#0@0|)) (and (|M0.__default.fSetToSeq#canCall| TInt |t#0@0|) (= |b#0@0| (M0.__default.fSetToSeq TInt ($LS $LZ) |t#0@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| |a#0@0| |b#0@0|)) (=> (|Seq#Equal| |a#0@0| |b#0@0|) (=> (= |c#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 3)))))) (=> (and (= |d#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))))) (= (ControlFlow 0 2) (- 0 1))) (not (|Seq#Equal| |c#0@0| |d#0@0|)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap@@2)) true) (=> (and (and (and ($Is SetType |t#0@@6| (TSet TInt)) ($IsAlloc SetType |t#0@@6| (TSet TInt) $Heap@@2)) true) (and (and ($Is SeqType |a#0| (TSeq TInt)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap@@2)) true)) (=> (and (and (and (and ($Is SeqType |b#0| (TSeq TInt)) ($IsAlloc SeqType |b#0| (TSeq TInt) $Heap@@2)) true) (and (and ($Is SeqType |c#0| (TSeq TInt)) ($IsAlloc SeqType |c#0| (TSeq TInt) $Heap@@2)) true)) (and (and (and ($Is SeqType |d#0| (TSeq TInt)) ($IsAlloc SeqType |d#0| (TSeq TInt) $Heap@@2)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))))
