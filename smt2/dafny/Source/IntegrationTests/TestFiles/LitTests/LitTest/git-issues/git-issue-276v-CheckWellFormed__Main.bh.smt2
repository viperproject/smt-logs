...
(declare-fun Main.__default.b () (_ BitVec 8))
...
(assert (forall ((v@@0 T@U) ) (! ($Is bv8Type v@@0 (TBitvector 8))
 :qid |unknown.0:0|
 :skolemid |344|
 :pattern ( ($Is bv8Type v@@0 (TBitvector 8)))
)))
...
(assert (= Main.__default.b (U_2_bv8 (Lit bv8Type (bv8_2_U #x25)))))
...
(assert  (=> (< 0 $FunctionContextHeight) ($Is bv8Type (bv8_2_U Main.__default.b) (TBitvector 8))))
...
(set-info :boogie-vc-id CheckWellFormed$$Main.bh)
...
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |x#0|) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= (LitInt 1) 8)) (=> (<= (LitInt 1) 8) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (nat_from_bv8 (bvlshr Main.__default.b #x01)))))))
