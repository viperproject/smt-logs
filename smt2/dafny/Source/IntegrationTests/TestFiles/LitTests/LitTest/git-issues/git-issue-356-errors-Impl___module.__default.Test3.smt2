...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (= (q@Real (q@Int |r#0|)) |r#0|) (= (ControlFlow 0 4) 2))) anon0_correct)))
