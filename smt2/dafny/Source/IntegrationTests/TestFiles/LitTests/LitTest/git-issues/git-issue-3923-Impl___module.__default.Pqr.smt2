...
(declare-fun |_v7#1_0@0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Pqr)
...
(let ((anon4_Then_correct  (=> (= |fruit#0| (|#_module.Fruit.Apple| |_mcc#0#1_0@0|)) (=> (and (<= (LitInt 0) |_v7#1_0@0|) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U |_mcc#0#1_0@0|) Tclass._System.nat)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |fruit#0| Tclass._module.Fruit) ($IsAlloc DatatypeTypeType |fruit#0| Tclass._module.Fruit $Heap)) (|$IsA#_module.Fruit| |fruit#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
