...
(set-info :boogie-vc-id CheckWellformed$$SSCinClass.Class.Odd)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 9) (- 0 8)) (or (= |i#0@@8| (LitInt 0)) (= (= (Mod |i#0@@8| (LitInt 2)) (LitInt 1)) (SSCinClass.Class.Even ($LS ($LS $LZ)) this@@8 (- |i#0@@8| 1)))))))
(let ((anon8_correct  (=> (and (and (= (SSCinClass.Class.Odd ($LS $LZ) this@@8 |i#0@@8|)  (and (or (not (= |i#0@@8| 0)) (not true)) (SSCinClass.Class.Even ($LS $LZ) this@@8 (- |i#0@@8| 1)))) (=> (or (not (= |i#0@@8| 0)) (not true)) (|SSCinClass.Class.Even#canCall| this@@8 (- |i#0@@8| 1)))) (and ($Is boolType (bool_2_U (SSCinClass.Class.Odd ($LS $LZ) this@@8 |i#0@@8|)) TBool) (= (ControlFlow 0 10) 9))) GeneratedUnifiedExit_correct)))
(let ((anon12_Else_correct  (=> (and (= |i#0@@8| 0) (= (ControlFlow 0 15) 10)) anon8_correct)))
(let ((anon12_Then_correct  (=> (and (or (not (= |i#0@@8| 0)) (not true)) ($IsAllocBox ($Box refType this@@8) Tclass.SSCinClass.Class? $Heap)) (and (=> (= (ControlFlow 0 11) (- 0 14)) ($Is intType (int_2_U (- |i#0@@8| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |i#0@@8| 1)) Tclass._System.nat) (=> (and (= |##i#1@0| (- |i#0@@8| 1)) ($IsAlloc intType (int_2_U |##i#1@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (<= 0 |i#0@@8|) (= |##i#1@0| |i#0@@8|))) (=> (or (<= 0 |i#0@@8|) (= |##i#1@0| |i#0@@8|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< |##i#1@0| |i#0@@8|)) (=> (< |##i#1@0| |i#0@@8|) (=> (and (|SSCinClass.Class.Even#canCall| this@@8 (- |i#0@@8| 1)) (= (ControlFlow 0 11) 10)) anon8_correct)))))))))))
(let ((anon5_correct true))
(let ((anon11_Else_correct  (=> (or (not (= |i#0@@8| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> ($IsAllocBox ($Box refType this@@8) Tclass.SSCinClass.Class? $Heap) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($Is intType (int_2_U (- |i#0@@8| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |i#0@@8| 1)) Tclass._System.nat) (=> (and (= |##i#0@0| (- |i#0@@8| 1)) ($IsAlloc intType (int_2_U |##i#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (<= 0 |i#0@@8|) (= |##i#0@0| |i#0@@8|))) (=> (or (<= 0 |i#0@@8|) (= |##i#0@0| |i#0@@8|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< |##i#0@0| |i#0@@8|)) (=> (< |##i#0@0| |i#0@@8|) (=> (|SSCinClass.Class.Even#canCall| this@@8 (- |i#0@@8| 1)) (=> (and (= (= (Mod |i#0@@8| (LitInt 2)) (LitInt 1)) (SSCinClass.Class.Even ($LS $LZ) this@@8 (- |i#0@@8| 1))) (= (ControlFlow 0 3) 1)) anon5_correct)))))))))))))))
(let ((anon11_Then_correct  (=> (and (= |i#0@@8| (LitInt 0)) (= (ControlFlow 0 2) 1)) anon5_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass.SSCinClass.Class) ($IsAlloc refType this@@8 Tclass.SSCinClass.Class $Heap))) (<= (LitInt 0) |i#0@@8|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
