...
(let (($generated@@97  (=> (and (not ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 (= true  (not false)))))) (= (ControlFlow 0 7) 4)) $generated@@96)))
(let (($generated@@98  (=> (and ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 (= true  (not false))))) (= (ControlFlow 0 6) 4)) $generated@@96)))
...
(let (($generated@@101  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= ($generated 0) ($generated 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite (= true  (not false)) 30 40))))))
