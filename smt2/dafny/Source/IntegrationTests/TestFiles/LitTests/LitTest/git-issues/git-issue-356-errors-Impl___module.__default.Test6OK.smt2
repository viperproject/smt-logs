...
(set-info :boogie-vc-id Impl$$_module.__default.Test6OK)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (and (< 0.0 |r#0|) (<= |r#0| (LitReal 255.0))) (and (= |r#0| (q@Real (q@Int |r#0|))) (= (ControlFlow 0 4) 2)))) anon0_correct)))
