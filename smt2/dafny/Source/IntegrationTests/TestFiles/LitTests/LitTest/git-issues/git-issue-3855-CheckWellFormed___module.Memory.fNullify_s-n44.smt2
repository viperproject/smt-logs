...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.fNullify_split7)
...
)) (= (ControlFlow 0 2) (- 0 1))) (|Set#IsMember| (|Set#Difference| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@53) _module.Memory.objects)) (|Set#UnionOne| |Set#Empty| ($Box refType |o#0@@12|))) ($Box refType |$unchanged#x0@0|)))))) ($IsAlloc refType |$unchanged#x0@0| Tclass._module.Object $Heap@@21))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
