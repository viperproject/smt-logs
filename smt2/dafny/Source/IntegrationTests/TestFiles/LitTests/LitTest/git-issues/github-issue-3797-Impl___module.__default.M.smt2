...
(assert (distinct alloc Tagclass._module.D |##_module.D.A| |##_module.D.B| tytagFamily$D)
)
...
(let ((anon6_Then_correct  (=> (and (= |x#0| |#_module.D.B|) (= |newtype$check#0_0@0| (LitInt 13))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= (LitInt 0) |newtype$check#0_0@0|) (< |newtype$check#0_0@0| 65536))) (=> (and (<= (LitInt 0) |newtype$check#0_0@0|) (< |newtype$check#0_0@0| 65536)) (=> (and (= |r#0@1| (LitInt 13)) (= (ControlFlow 0 5) 2)) anon4_correct))))))
(let ((anon5_Then_correct  (=> (and (= |x#0| |#_module.D.A|) (= |newtype$check#1_0@0| (LitInt 12))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= (LitInt 0) |newtype$check#1_0@0|) (< |newtype$check#1_0@0| 65536))) (=> (and (<= (LitInt 0) |newtype$check#1_0@0|) (< |newtype$check#1_0@0| 65536)) (=> (and (= |r#0@0| (LitInt 12)) (= (ControlFlow 0 3) 2)) anon4_correct))))))
(let ((anon6_Else_correct true))
(let ((anon5_Else_correct  (=> (or (not (= |x#0| |#_module.D.A|)) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon6_Then_correct) (=> (= (ControlFlow 0 7) 1) anon6_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 5))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 65536))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 65536)) (=> (= |v#0@0| (LitInt 5)) (and (=> (= (ControlFlow 0 8) 3) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |x#0| Tclass._module.D) ($IsAlloc DatatypeTypeType |x#0| Tclass._module.D $Heap)) (|$IsA#_module.D| |x#0|)) (and (and (<= (LitInt 0) |u#0|) (< |u#0| 65536)) (and (<= (LitInt 0) |r#0|) (< |r#0| 65536)))) (and (and (and (<= (LitInt 0) |v#0|) (< |v#0| 65536)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 8)))) anon0_correct))))
