...
(let ((anon5_correct  (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (and ($Is refType null Tclass.ExampleA.C) (U_2_bool (Lit boolType (bool_2_U true)))) (exists ((|c#3| T@U) )  (and ($Is refType |c#3| Tclass.ExampleA.C) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (or (and ($Is refType null Tclass.ExampleA.C) (U_2_bool (Lit boolType (bool_2_U true)))) (exists ((|c#3@@0| T@U) )  (and ($Is refType |c#3@@0| Tclass.ExampleA.C) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (and ($Is refType |c#2@0| Tclass.ExampleA.C) ($IsAlloc refType |c#2@0| Tclass.ExampleA.C $Heap@@1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |c#2@0| null)) (not true))) (=> (or (not (= |c#2@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |c#2@0|) Tclass.ExampleA.C? $Heap@@1) (=> (and (|ExampleA.C.F#canCall| |c#2@0|) |$let#0$canCall|) (=> (and (and (= ExampleA.__default.BadGhost (ExampleA.C.F |c#2@0|)) (|ExampleA.C.F#canCall| |c#2@0|)) (and ($Is boolType (bool_2_U ExampleA.__default.BadGhost) TBool) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct))))))))))
