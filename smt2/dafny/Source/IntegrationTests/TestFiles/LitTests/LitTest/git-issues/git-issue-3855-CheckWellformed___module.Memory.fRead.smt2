...
(declare-fun _module.Memory.fRead (T@U T@U T@U T@U) T@U)
(declare-fun |_module.Memory.fRead#canCall| (T@U T@U T@U T@U) Bool)
...
(declare-fun |lambda#90| (T@U T@U T@U T@U T@U T@U T@U T@U T@U T@U T@U T@U T@U) T@U)
...
(assert  (and (and (and (and (and (and (and (and (= (Ctor SeqType) 6) (forall ((t0 T@T) (t1 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0 t1 (MapType0Store t0 t1 m x0 val) x0) val)
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) (|o#0@@2| T@U) (|n#0| T@U) ) (!  (=> (or (|_module.Memory.fRead#canCall| $Heap@@0 this@@0 |o#0@@2| |n#0|) (and (< 8 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.Memory) ($IsAlloc refType this@@0 Tclass._module.Memory $Heap@@0)))) ($Is refType |o#0@@2| Tclass._module.Object)) ($Is SeqType |n#0| (TSeq TChar))) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Memory.objects)) ($Box refType |o#0@@2|)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@0 this@@0)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |o#0@@2|) _module.Object.fields))) ($Box SeqType |n#0|)))))) (= (_module.Memory.fRead $Heap@@0 this@@0 |o#0@@2| |n#0|) ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |o#0@@2|) _module.Object.fields))) ($Box SeqType |n#0|)))))
 :qid |gitissue3855dfy.408:12|
 :skolemid |1058|
 :pattern ( (_module.Memory.fRead $Heap@@0 this@@0 |o#0@@2| |n#0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 7 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Memory.Valid#canCall| $Heap@@1 this@@2) (and (< 7 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Memory) ($IsAlloc refType this@@2 Tclass._module.Memory $Heap@@1)))))) (and (and (|_module.Memory.ObjectsAreValid#canCall| $Heap@@1 this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Memory.objects))) (=> (_module.Memory.ObjectsAreValid $Heap@@1 this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Memory.objects))) (and (|_module.Memory.OutgoingReferencesAreInThisHeap#canCall| $Heap@@1 this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Memory.objects))) (=> (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@1 this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Memory.objects))) (|_module.Memory.wholeEnchilada#canCall| $Heap@@1 this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Memory.objects))))))) (= (_module.Memory.Valid true $Heap@@1 this@@2)  (and (and (_module.Memory.ObjectsAreValid $Heap@@1 this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Memory.objects))) (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@1 this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Memory.objects)))) (_module.Memory.wholeEnchilada $Heap@@1 this@@2 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Memory.objects)))))))
 :qid |gitissue3855dfy.173:40|
 :skolemid |836|
 :pattern ( (_module.Memory.Valid true $Heap@@1 this@@2) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 6 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@4 T@U) (|os#0@@0| T@U) ) (!  (=> (or (|_module.Memory.wholeEnchilada#canCall| $Heap@@2 this@@4 |os#0@@0|) (and (< 6 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Memory) ($IsAlloc refType this@@4 Tclass._module.Memory $Heap@@2)))) ($Is SetType |os#0@@0| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.isosRefCountZeroOrOne#canCall| $Heap@@2 this@@4 |os#0@@0|) (=> (_module.Memory.isosRefCountZeroOrOne $Heap@@2 this@@4 |os#0@@0|) (|_module.Memory.heapExternalsZeroOrOne#canCall| $Heap@@2 this@@4 |os#0@@0|))) (= (_module.Memory.wholeEnchilada $Heap@@2 this@@4 |os#0@@0|)  (and (_module.Memory.isosRefCountZeroOrOne $Heap@@2 this@@4 |os#0@@0|) (_module.Memory.heapExternalsZeroOrOne $Heap@@2 this@@4 |os#0@@0|)))))
 :qid |gitissue3855dfy.265:13|
 :skolemid |930|
 :pattern ( (_module.Memory.wholeEnchilada $Heap@@2 this@@4 |os#0@@0|) ($IsGoodHeap $Heap@@2))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@6 T@U) (|o#0@@3| T@U) (|edges#0@@2| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| this@@6 |o#0@@3| |edges#0@@2|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@3| Tclass._module.Region)) ($Is SetType |edges#0@@2| (TSet Tclass._module.Edge))))) (and (|Set#Subset| (_module.Memory.externalEdges this@@6 |o#0@@3| |edges#0@@2|) |edges#0@@2|) ($Is SetType (_module.Memory.externalEdges this@@6 |o#0@@3| |edges#0@@2|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.336:12|
 :skolemid |999|
 :pattern ( (_module.Memory.externalEdges this@@6 |o#0@@3| |edges#0@@2|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@10 T@U) (|os#0@@1| T@U) ) (!  (=> (or (|_module.Memory.OutgoingReferencesAreInThisHeap#canCall| $Heap@@3 this@@10 |os#0@@1|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@10 null)) (not true)) (and ($Is refType this@@10 Tclass._module.Memory) ($IsAlloc refType this@@10 Tclass._module.Memory $Heap@@3)))) ($Is SetType |os#0@@1| (TSet Tclass._module.Object))))) (and (forall ((|o#0@@4| T@U) ) (!  (=> ($Is refType |o#0@@4| Tclass._module.Object) (=> (|Set#IsMember| |os#0@@1| ($Box refType |o#0@@4|)) (|_module.Object.outgoing#canCall| $Heap@@3 |o#0@@4|)))
 :qid |gitissue3855dfy.215:14|
 :skolemid |867|
 :pattern ( (_module.Object.outgoing $Heap@@3 |o#0@@4|))
 :pattern ( (|Set#IsMember| |os#0@@1| ($Box refType |o#0@@4|)))
)) (= (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@3 this@@10 |os#0@@1|) (forall ((|o#0@@5| T@U) ) (!  (=> (and ($Is refType |o#0@@5| Tclass._module.Object) (|Set#IsMember| |os#0@@1| ($Box refType |o#0@@5|))) (|Set#Subset| (_module.Object.outgoing $Heap@@3 |o#0@@5|) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@10) _module.Memory.objects))))
 :qid |gitissue3855dfy.215:14|
 :skolemid |866|
 :pattern ( (_module.Object.outgoing $Heap@@3 |o#0@@5|))
 :pattern ( (|Set#IsMember| |os#0@@1| ($Box refType |o#0@@5|)))
)))))
 :qid |gitissue3855dfy.210:13|
 :skolemid |868|
 :pattern ( (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@3 this@@10 |os#0@@1|) ($IsGoodHeap $Heap@@3))
))))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|l#11| T@U) (|l#12| T@U) ($o@@7 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#90| |l#0@@1| |l#1@@1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10| |l#11| |l#12|) $o@@7 $f))  (=> (and (or (not (= $o@@7 |l#0@@1|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@1| $o@@7) |l#2|)))) (or (or (or (or (or (and (= $o@@7 |l#3|) (= $f |l#4|)) (|Set#IsMember| |l#5| ($Box refType $o@@7))) (and (= $o@@7 |l#6|) (= $f |l#7|))) (and (= $o@@7 |l#8|) (= $f |l#9|))) (|Set#IsMember| |l#10| ($Box refType $o@@7))) (and (= $o@@7 |l#11|) (= $f |l#12|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1423|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#90| |l#0@@1| |l#1@@1| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10| |l#11| |l#12|) $o@@7 $f))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@4 T@U) (this@@13 T@U) (|os#0@@2| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@4 this@@13 |os#0@@2|) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@4) (or (not (= this@@13 null)) (not true))) ($IsAlloc refType this@@13 Tclass._module.Memory $Heap@@4)) (and ($Is SetType |os#0@@2| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@2| (TSet Tclass._module.Object) $Heap@@4))))) ($IsAlloc SetType (_module.Memory.edges $Heap@@4 this@@13 |os#0@@2|) (TSet Tclass._module.Edge) $Heap@@4))
 :qid |gitissue3855dfy.256:12|
 :skolemid |918|
 :pattern ( ($IsAlloc SetType (_module.Memory.edges $Heap@@4 this@@13 |os#0@@2|) (TSet Tclass._module.Edge) $Heap@@4))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@5 T@U) (this@@14 T@U) (|os#0@@3| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@5 this@@14 |os#0@@3|) (and (< 3 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@5) (or (not (= this@@14 null)) (not true))) ($IsAlloc refType this@@14 Tclass._module.Memory $Heap@@5)) (and ($Is SetType |os#0@@3| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@3| (TSet Tclass._module.Object) $Heap@@5))))) ($IsAlloc SetType (_module.Memory.justTheIsos $Heap@@5 this@@14 |os#0@@3|) (TSet Tclass._module.Object) $Heap@@5))
 :qid |gitissue3855dfy.235:12|
 :skolemid |891|
 :pattern ( ($IsAlloc SetType (_module.Memory.justTheIsos $Heap@@5 this@@14 |os#0@@3|) (TSet Tclass._module.Object) $Heap@@5))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@15 T@U) (|o#0@@6| T@U) (|edges#0@@8| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| this@@15 |o#0@@6| |edges#0@@8|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@15 null)) (not true)) ($Is refType this@@15 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@6| Tclass._module.Region)) ($Is SetType |edges#0@@8| (TSet Tclass._module.Edge))))) (and (forall ((|e#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@0| Tclass._module.Edge) (=> (|Set#IsMember| |edges#0@@8| ($Box DatatypeTypeType |e#0@@0|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#0@@0|))) (|$IsA#_module.Region| |o#0@@6|)) (_module.Edge.Edge_q |e#0@@0|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#0@@0|)) |o#0@@6|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#0@@0|))) (|$IsA#_module.Region| |o#0@@6|)) (_module.Edge.Edge_q |e#0@@0|))))))
...
)) (= (_module.Memory.externalEdges this@@15 |o#0@@6| |edges#0@@8|) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge |edges#0@@8| |o#0@@6| |o#0@@6|)))))
 :qid |gitissue3855dfy.336:12|
 :skolemid |1003|
 :pattern ( (_module.Memory.externalEdges this@@15 |o#0@@6| |edges#0@@8|))
))))
(assert (forall ((|l#0@@3| T@U) (|l#1@@3| T@U) (|l#2@@0| T@U) (|$y#0@@1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#41| |l#0@@3| |l#1@@3| |l#2@@0|) |$y#0@@1|))  (and ($IsBox |$y#0@@1| |l#0@@3|) (and (|Set#IsMember| |l#1@@3| |$y#0@@1|) (= (_module.Edge.t ($Unbox DatatypeTypeType |$y#0@@1|)) |l#2@@0|))))
 :qid |gitissue3855dfy.149:10|
 :skolemid |1415|
 :pattern ( (MapType0Select BoxType boolType (|lambda#41| |l#0@@3| |l#1@@3| |l#2@@0|) |$y#0@@1|))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@6 T@U) (this@@16 T@U) ) (!  (=> (or (|_module.Object.AllFieldsContentsConsistentWithTheirDeclaration#canCall| $Heap@@6 this@@16) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@6) (and (or (not (= this@@16 null)) (not true)) (and ($Is refType this@@16 Tclass._module.Object) ($IsAlloc refType this@@16 Tclass._module.Object $Heap@@6)))) (_module.Object.AllFieldsAreDeclared $Heap@@6 this@@16)))) (and (forall ((|n#0@@0| T@U) ) (!  (=> ($Is SeqType |n#0@@0| (TSeq TChar)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@16) _module.Object.fields))) ($Box SeqType |n#0@@0|)) (|_module.__default.AssignmentCompatible#canCall| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@16) _module.Object.fields))) ($Box SeqType |n#0@@0|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@16)) ($Box SeqType |n#0@@0|))))))
 ...
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@16) _module.Object.fields))) ($Box SeqType |n#0@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@16) _module.Object.fields))) ($Box SeqType |n#0@@0|)))
)) (= (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@6 this@@16) (forall ((|n#0@@1| T@U) ) (!  (=> (and ($Is SeqType |n#0@@1| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@16) _module.Object.fields))) ($Box SeqType |n#0@@1|))) (_module.__default.AssignmentCompatible ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@16) _module.Object.fields))) ($Box SeqType |n#0@@1|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@16)) ($Box SeqType |n#0@@1|)))))
 :qid |gitissue3855dfy.128:14|
 :skolemid |783|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@16)) ($Box SeqType |n#0@@1|))))
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@16) _module.Object.fields))) ($Box SeqType |n#0@@1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@6 this@@16) _module.Object.fields))) ($Box SeqType |n#0@@1|)))
)))))
 :qid |gitissue3855dfy.124:13|
 :skolemid |785|
 :pattern ( (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@6 this@@16) ($IsGoodHeap $Heap@@6))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@18 T@U) ) (!  (=> (or (|_module.Object.outgoing#canCall| $Heap@@7 this@@18) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Object) ($IsAlloc refType this@@18 Tclass._module.Object $Heap@@7)))))) ($Is SetType (_module.Object.outgoing $Heap@@7 this@@18) (TSet Tclass._module.Object)))
 :qid |gitissue3855dfy.106:12|
 :skolemid |752|
 :pattern ( (_module.Object.outgoing $Heap@@7 this@@18))
))))
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@19 T@U) (|o#0@@8| T@U) (|n#0@@2| T@U) ) (!  (=> (or (|_module.Memory.fRead#canCall| $Heap@@8 this@@19 |o#0@@8| |n#0@@2|) (and (< 8 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@8) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Memory) ($IsAlloc refType this@@19 Tclass._module.Memory $Heap@@8)))) (and ($Is refType |o#0@@8| Tclass._module.Object) ($IsAlloc refType |o#0@@8| Tclass._module.Object $Heap@@8))) (and ($Is SeqType |n#0@@2| (TSeq TChar)) ($IsAlloc SeqType |n#0@@2| (TSeq TChar) $Heap@@8))) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@19) _module.Memory.objects)) ($Box refType |o#0@@8|)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@8 this@@19)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 |o#0@@8|) _module.Object.fields))) ($Box SeqType |n#0@@2|)))))) ($Is refType (_module.Memory.fRead $Heap@@8 this@@19 |o#0@@8| |n#0@@2|) Tclass._module.Object))
 :qid |gitissue3855dfy.408:12|
 :skolemid |1055|
 :pattern ( (_module.Memory.fRead $Heap@@8 this@@19 |o#0@@8| |n#0@@2|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@20 T@U) ) (!  (=> (or (|_module.Object.outgoing#canCall| $Heap@@9 this@@20) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@20 null)) (not true)) (and ($Is refType this@@20 Tclass._module.Object) ($IsAlloc refType this@@20 Tclass._module.Object $Heap@@9)))))) (= (_module.Object.outgoing $Heap@@9 this@@20) (|Map#Values| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 this@@20) _module.Object.fields)))))
 :qid |gitissue3855dfy.106:12|
 :skolemid |755|
 :pattern ( (_module.Object.outgoing $Heap@@9 this@@20) ($IsGoodHeap $Heap@@9))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@21 T@U) (|t#0@@6| T@U) (|edges#0@@10| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| (Lit refType this@@21) (Lit refType |t#0@@6|) (Lit SetType |edges#0@@10|)) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@21 null)) (not true)) ($Is refType this@@21 Tclass._module.Memory)) ($Is refType |t#0@@6| Tclass._module.Object)) ($Is SetType |edges#0@@10| (TSet Tclass._module.Edge))))) (and (forall ((|e#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#2@@0| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@10|) ($Box DatatypeTypeType |e#2@@0|)) (_module.Edge.Edge_q |e#2@@0|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |905|
 :pattern ( (_module.Edge.t |e#2@@0|))
 :pattern ( (|Set#IsMember| |edges#0@@10| ($Box DatatypeTypeType |e#2@@0|)))
)) (= (_module.Memory.incomingEdges (Lit refType this@@21) (Lit refType |t#0@@6|) (Lit SetType |edges#0@@10|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge (Lit SetType |edges#0@@10|) (Lit refType |t#0@@6|))))))
 :qid |gitissue3855dfy.245:12|
 :weight 3
 :skolemid |906|
 :pattern ( (_module.Memory.incomingEdges (Lit refType this@@21) (Lit refType |t#0@@6|) (Lit SetType |edges#0@@10|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@22 T@U) (|t#0@@7| T@U) (|edges#0@@11| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@22 |t#0@@7| |edges#0@@11|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.Memory)) ($Is refType |t#0@@7| Tclass._module.Object)) ($Is SetType |edges#0@@11| (TSet Tclass._module.Edge))))) (and (forall ((|e#0@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#0@@1| Tclass._module.Edge) (=> (|Set#IsMember| |edges#0@@11| ($Box DatatypeTypeType |e#0@@1|)) (_module.Edge.Edge_q |e#0@@1|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |901|
 :pattern ( (_module.Edge.t |e#0@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@11| ($Box DatatypeTypeType |e#0@@1|)))
)) (= (_module.Memory.incomingEdges this@@22 |t#0@@7| |edges#0@@11|) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge |edges#0@@11| |t#0@@7|)))))
 :qid |gitissue3855dfy.245:12|
 :skolemid |902|
 :pattern ( (_module.Memory.incomingEdges this@@22 |t#0@@7| |edges#0@@11|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@23 T@U) (|os#0@@4| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@10 this@@23 |os#0@@4|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Memory) ($IsAlloc refType this@@23 Tclass._module.Memory $Heap@@10)))) (and ($Is SetType |os#0@@4| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@4| (TSet Tclass._module.Object) $Heap@@10))))) (and (and (forall ((|edge#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |edge#0| Tclass._module.Edge) (|Set#IsMember| (_module.Memory.edges $Heap@@10 this@@23 |os#0@@4|) ($Box DatatypeTypeType |edge#0|))) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|))) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|)))) (_module.Edge.t |edge#0|))))
 :qid |gitissue3855dfy.258:20|
 :skolemid |916|
 :pattern ( (_module.Edge.t |edge#0|))
 :pattern ( (_module.Edge.f |edge#0|))
 :pattern ( (_module.Edge.n |edge#0|))
 :pattern ( (|Set#IsMember| (_module.Memory.edges $Heap@@10 this@@23 |os#0@@4|) ($Box DatatypeTypeType |edge#0|)))
)) (=> (|Set#Equal| |os#0@@4| |Set#Empty|) (|Set#Equal| (_module.Memory.edges $Heap@@10 this@@23 |os#0@@4|) |Set#Empty|))) ($Is SetType (_module.Memory.edges $Heap@@10 this@@23 |os#0@@4|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |917|
 :pattern ( (_module.Memory.edges $Heap@@10 this@@23 |os#0@@4|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@24 T@U) ) (!  (=> (or (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@11 this@@24) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.Object) ($IsAlloc refType this@@24 Tclass._module.Object $Heap@@11)))))) (= (_module.Object.AllFieldsAreDeclared $Heap@@11 this@@24) (|Set#Subset| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@11 this@@24) _module.Object.fields))) (|Map#Domain| (_module.Object.fieldModes this@@24)))))
 :qid |gitissue3855dfy.120:13|
 :skolemid |778|
 :pattern ( (_module.Object.AllFieldsAreDeclared $Heap@@11 this@@24) ($IsGoodHeap $Heap@@11))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@25 T@U) (|os#0@@5| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@12 this@@25 |os#0@@5|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@25 null)) (not true)) (and ($Is refType this@@25 Tclass._module.Memory) ($IsAlloc refType this@@25 Tclass._module.Memory $Heap@@12)))) ($Is SetType |os#0@@5| (TSet Tclass._module.Object))))) (= (_module.Memory.justTheIsos $Heap@@12 this@@25 |os#0@@5|) (|Set#FromBoogieMap| (|lambda#38| Tclass._module.Object |os#0@@5|))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |893|
 :pattern ( (_module.Memory.justTheIsos $Heap@@12 this@@25 |os#0@@5|) ($IsGoodHeap $Heap@@12))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@26 T@U) ) (!  (=> (or (|_module.Object.outgoing#canCall| $Heap@@13 this@@26) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@13) (or (not (= this@@26 null)) (not true))) ($IsAlloc refType this@@26 Tclass._module.Object $Heap@@13)))) ($IsAlloc SetType (_module.Object.outgoing $Heap@@13 this@@26) (TSet Tclass._module.Object) $Heap@@13))
 :qid |gitissue3855dfy.106:12|
 :skolemid |753|
 :pattern ( ($IsAlloc SetType (_module.Object.outgoing $Heap@@13 this@@26) (TSet Tclass._module.Object) $Heap@@13))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@27 T@U) (|edges#0@@12| T@U) ) (!  (=> (and (or (|_module.Memory.justHeapExternalEdges#canCall| this@@27 |edges#0@@12|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@27 null)) (not true)) ($IsAlloc refType this@@27 Tclass._module.Memory $Heap@@14)) (and ($Is SetType |edges#0@@12| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@12| (TSet Tclass._module.Edge) $Heap@@14))))) ($IsGoodHeap $Heap@@14)) ($IsAlloc SetType (_module.Memory.justHeapExternalEdges this@@27 |edges#0@@12|) (TSet Tclass._module.Edge) $Heap@@14))
 :qid |gitissue3855dfy.345:12|
 :skolemid |1010|
 :pattern ( ($IsAlloc SetType (_module.Memory.justHeapExternalEdges this@@27 |edges#0@@12|) (TSet Tclass._module.Edge) $Heap@@14))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@28 T@U) (|os#0@@6| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOne#canCall| $Heap@@15 this@@28 |os#0@@6|) (and (< 5 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@15) (and (or (not (= this@@28 null)) (not true)) (and ($Is refType this@@28 Tclass._module.Memory) ($IsAlloc refType this@@28 Tclass._module.Memory $Heap@@15)))) ($Is SetType |os#0@@6| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@15 this@@28 |os#0@@6|) (let ((|edges#0@@13| (_module.Memory.edges $Heap@@15 this@@28 |os#0@@6|)))
(|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@28 |edges#0@@13|))) (= (_module.Memory.heapExternalsZeroOrOne $Heap@@15 this@@28 |os#0@@6|) (let ((|edges#0@@14| (_module.Memory.edges $Heap@@15 this@@28 |os#0@@6|)))
(_module.Memory.heapExternalsZeroOrOneEdges this@@28 |edges#0@@14|)))))
 :qid |gitissue3855dfy.273:13|
 :skolemid |937|
 :pattern ( (_module.Memory.heapExternalsZeroOrOne $Heap@@15 this@@28 |os#0@@6|) ($IsGoodHeap $Heap@@15))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@29 T@U) (|t#0@@8| T@U) (|edges#0@@15| T@U) ) (!  (=> (and (or (|_module.Memory.incomingEdges#canCall| this@@29 |t#0@@8| |edges#0@@15|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@29 null)) (not true)) ($IsAlloc refType this@@29 Tclass._module.Memory $Heap@@16)) (and ($Is refType |t#0@@8| Tclass._module.Object) ($IsAlloc refType |t#0@@8| Tclass._module.Object $Heap@@16))) (and ($Is SetType |edges#0@@15| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@15| (TSet Tclass._module.Edge) $Heap@@16))))) ($IsGoodHeap $Heap@@16)) ($IsAlloc SetType (_module.Memory.incomingEdges this@@29 |t#0@@8| |edges#0@@15|) (TSet Tclass._module.Edge) $Heap@@16))
 :qid |gitissue3855dfy.245:12|
 :skolemid |899|
 :pattern ( ($IsAlloc SetType (_module.Memory.incomingEdges this@@29 |t#0@@8| |edges#0@@15|) (TSet Tclass._module.Edge) $Heap@@16))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@30 T@U) (|o#0@@9| T@U) (|edges#0@@16| T@U) ) (!  (=> (and (or (|_module.Memory.externalEdges#canCall| this@@30 |o#0@@9| |edges#0@@16|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@30 null)) (not true)) ($IsAlloc refType this@@30 Tclass._module.Memory $Heap@@17)) (and ($Is DatatypeTypeType |o#0@@9| Tclass._module.Region) ($IsAlloc DatatypeTypeType |o#0@@9| Tclass._module.Region $Heap@@17))) (and ($Is SetType |edges#0@@16| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@16| (TSet Tclass._module.Edge) $Heap@@17))))) ($IsGoodHeap $Heap@@17)) ($IsAlloc SetType (_module.Memory.externalEdges this@@30 |o#0@@9| |edges#0@@16|) (TSet Tclass._module.Edge) $Heap@@17))
 :qid |gitissue3855dfy.336:12|
 :skolemid |1000|
 :pattern ( ($IsAlloc SetType (_module.Memory.externalEdges this@@30 |o#0@@9| |edges#0@@16|) (TSet Tclass._module.Edge) $Heap@@17))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@31 T@U) (|t#0@@9| T@U) (|edges#0@@17| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@31 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@31 null)) (not true)) ($Is refType this@@31 Tclass._module.Memory)) ($Is refType |t#0@@9| Tclass._module.Object)) ($Is SetType |edges#0@@17| (TSet Tclass._module.Edge))))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@17|) ($Box DatatypeTypeType |e#1|)) (_module.Edge.Edge_q |e#1|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |903|
 :pattern ( (_module.Edge.t |e#1|))
 :pattern ( (|Set#IsMember| |edges#0@@17| ($Box DatatypeTypeType |e#1|)))
)) (= (_module.Memory.incomingEdges this@@31 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge (Lit SetType |edges#0@@17|) (Lit refType |t#0@@9|))))))
 :qid |gitissue3855dfy.245:12|
 :weight 3
 :skolemid |904|
 :pattern ( (_module.Memory.incomingEdges this@@31 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@32 T@U) (|edges#0@@18| T@U) ) (!  (=> (or (|_module.Memory.justHeapExternalEdges#canCall| this@@32 (Lit SetType |edges#0@@18|)) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@32 null)) (not true)) ($Is refType this@@32 Tclass._module.Memory)) ($Is SetType |edges#0@@18| (TSet Tclass._module.Edge))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@18|) ($Box DatatypeTypeType |e#1@@0|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#1@@0|))) (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#1@@0|)))) (and (_module.Edge.Edge_q |e#1@@0|) (_module.Edge.Edge_q |e#1@@0|))) (=> (not (|_module.Region#Equal| (_module.Object.region (_module.Edge.f |e#1@@0|)) (_module.Object.region (_module.Edge.t |e#1@@0|)))) (_module.Edge.Edge_q |e#1@@0|)))))
 :qid |gitissue3855dfy.348:9|
 :skolemid |1014|
 :pattern ( (_module.Edge.t |e#1@@0|))
 :pattern ( (_module.Edge.f |e#1@@0|))
 :pattern ( (|Set#IsMember| |edges#0@@18| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (_module.Memory.justHeapExternalEdges this@@32 (Lit SetType |edges#0@@18|)) (|Set#FromBoogieMap| (|lambda#76| Tclass._module.Edge (Lit SetType |edges#0@@18|))))))
 :qid |gitissue3855dfy.345:12|
 :weight 3
 :skolemid |1015|
 :pattern ( (_module.Memory.justHeapExternalEdges this@@32 (Lit SetType |edges#0@@18|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@33 T@U) (|o#0@@10| T@U) (|edges#0@@19| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| (Lit refType this@@33) (Lit DatatypeTypeType |o#0@@10|) (Lit SetType |edges#0@@19|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@33 null)) (not true)) ($Is refType this@@33 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@10| Tclass._module.Region)) ($Is SetType |edges#0@@19| (TSet Tclass._module.Edge))))) (and (forall ((|e#2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#2@@1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@19|) ($Box DatatypeTypeType |e#2@@1|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#2@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@10|))) (_module.Edge.Edge_q |e#2@@1|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#2@@1|)) |o#0@@10|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#2@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@10|))) (_module.Edge.Edge_q |e#2@@1|))))))
 :qid |gitissue3855dfy.339:9|
 :skolemid |1006|
 :pattern ( (_module.Edge.f |e#2@@1|))
 :pattern ( (_module.Edge.t |e#2@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@19| ($Box DatatypeTypeType |e#2@@1|)))
)) (= (_module.Memory.externalEdges (Lit refType this@@33) (Lit DatatypeTypeType |o#0@@10|) (Lit SetType |edges#0@@19|)) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge (Lit SetType |edges#0@@19|) |o#0@@10| |o#0@@10|)))))
 :qid |gitissue3855dfy.336:12|
 :weight 3
 :skolemid |1007|
 :pattern ( (_module.Memory.externalEdges (Lit refType this@@33) (Lit DatatypeTypeType |o#0@@10|) (Lit SetType |edges#0@@19|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@34 T@U) (|os#0@@7| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@18 this@@34 |os#0@@7|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@34 null)) (not true)) (and ($Is refType this@@34 Tclass._module.Memory) ($IsAlloc refType this@@34 Tclass._module.Memory $Heap@@18)))) (and ($Is SetType |os#0@@7| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@7| (TSet Tclass._module.Object) $Heap@@18))))) (and (and (and (forall ((|r#0@@2| T@U) ) (!  (=> (and ($Is refType |r#0@@2| Tclass._module.Object) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@18 this@@34 |os#0@@7|) ($Box refType |r#0@@2|))) (_module.Region.Isolate_q (_module.Object.region |r#0@@2|)))
 :qid |gitissue3855dfy.237:20|
 :skolemid |888|
 :pattern ( (_module.Object.region |r#0@@2|))
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@18 this@@34 |os#0@@7|) ($Box refType |r#0@@2|)))
)) (forall ((|o#0@@11| T@U) ) (!  (=> (and ($Is refType |o#0@@11| Tclass._module.Object) (|Set#IsMember| |os#0@@7| ($Box refType |o#0@@11|))) (=> (_module.Region.Isolate_q (_module.Object.region |o#0@@11|)) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@18 this@@34 |os#0@@7|) ($Box refType |o#0@@11|))))
 :qid |gitissue3855dfy.238:20|
 :skolemid |889|
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@18 this@@34 |os#0@@7|) ($Box refType |o#0@@11|)))
 :pattern ( (_module.Object.region |o#0@@11|))
 :pattern ( (|Set#IsMember| |os#0@@7| ($Box refType |o#0@@11|)))
))) (=> (|Set#Equal| |os#0@@7| |Set#Empty|) (|Set#Equal| (_module.Memory.justTheIsos $Heap@@18 this@@34 |os#0@@7|) |Set#Empty|))) ($Is SetType (_module.Memory.justTheIsos $Heap@@18 this@@34 |os#0@@7|) (TSet Tclass._module.Object))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |890|
 :pattern ( (_module.Memory.justTheIsos $Heap@@18 this@@34 |os#0@@7|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@35 T@U) (|edges#0@@20| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@35 |edges#0@@20|) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.Memory)) ($Is SetType |edges#0@@20| (TSet Tclass._module.Edge))))) (and (and (|_module.Memory.justHeapExternalEdges#canCall| this@@35 |edges#0@@20|) (let ((|heapExternalEdges#0| (_module.Memory.justHeapExternalEdges this@@35 |edges#0@@20|)))
...
(forall ((|r#0@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |r#0@@3| Tclass._module.Region) (=> (|Set#IsMember| |allRelevantHeapRegions#0| ($Box DatatypeTypeType |r#0@@3|)) (|_module.Memory.externalEdges#canCall| this@@35 |r#0@@3| |heapExternalEdges#0|)))
 :qid |gitissue3855dfy.285:11|
 :skolemid |945|
 :pattern ( (_module.Memory.externalEdges this@@35 |r#0@@3| |heapExternalEdges#0|))
 :pattern ( (|Set#IsMember| |allRelevantHeapRegions#0| ($Box DatatypeTypeType |r#0@@3|)))
)))))) (= (_module.Memory.heapExternalsZeroOrOneEdges this@@35 |edges#0@@20|) (let ((|heapExternalEdges#0@@0| (_module.Memory.justHeapExternalEdges this@@35 |edges#0@@20|)))
...
(let ((|heapExternalEdgesPartitionedByRegion#0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region |allRelevantHeapRegions#0@@0|)) (|lambda#55| this@@35 |heapExternalEdges#0@@0|) (TMap Tclass._module.Region (TSet Tclass._module.Edge)))))
(forall ((|hr#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |hr#0| Tclass._module.Region) (|Set#IsMember| (|Map#Domain| |heapExternalEdgesPartitionedByRegion#0|) ($Box DatatypeTypeType |hr#0|))) (<= (|Set#Card| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |heapExternalEdgesPartitionedByRegion#0|) ($Box DatatypeTypeType |hr#0|)))) (LitInt 1)))
 ...
 :qid |gitissue3855dfy.280:13|
 :skolemid |947|
 :pattern ( (_module.Memory.heapExternalsZeroOrOneEdges this@@35 |edges#0@@20|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@36 T@U) (|os#0@@8| T@U) ) (!  (=> (or (|_module.Memory.isosRefCountZeroOrOne#canCall| $Heap@@19 this@@36 |os#0@@8|) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Memory) ($IsAlloc refType this@@36 Tclass._module.Memory $Heap@@19)))) ($Is SetType |os#0@@8| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@19 this@@36 |os#0@@8|) (let ((|edges#0@@21| (_module.Memory.edges $Heap@@19 this@@36 |os#0@@8|)))
 (and (|_module.Memory.justTheIsos#canCall| $Heap@@19 this@@36 |os#0@@8|) (let ((|isos#0| (_module.Memory.justTheIsos $Heap@@19 this@@36 |os#0@@8|)))
(forall ((|i#0| T@U) ) (!  (=> ($Is refType |i#0| Tclass._module.Object) (=> (|Set#IsMember| |isos#0| ($Box refType |i#0|)) (|_module.Memory.refCountEdges#canCall| this@@36 |i#0| |edges#0@@21|)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |983|
 :pattern ( (_module.Memory.refCountEdges this@@36 |i#0| |edges#0@@21|))
 :pattern ( (|Set#IsMember| |isos#0| ($Box refType |i#0|)))
)))))) (= (_module.Memory.isosRefCountZeroOrOne $Heap@@19 this@@36 |os#0@@8|) (let ((|edges#0@@22| (_module.Memory.edges $Heap@@19 this@@36 |os#0@@8|)))
(let ((|isos#0@@0| (_module.Memory.justTheIsos $Heap@@19 this@@36 |os#0@@8|)))
(forall ((|i#0@@0| T@U) ) (!  (=> (and ($Is refType |i#0@@0| Tclass._module.Object) (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|))) (<= (_module.Memory.refCountEdges this@@36 |i#0@@0| |edges#0@@22|) (LitInt 1)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |982|
 :pattern ( (_module.Memory.refCountEdges this@@36 |i#0@@0| |edges#0@@22|))
 :pattern ( (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|)))
)))))))
 :qid |gitissue3855dfy.315:13|
 :skolemid |984|
 :pattern ( (_module.Memory.isosRefCountZeroOrOne $Heap@@19 this@@36 |os#0@@8|) ($IsGoodHeap $Heap@@19))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@37 T@U) ) (!  (=> (or (|_module.Object.Valid#canCall| $Heap@@20 this@@37) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.Object) ($IsAlloc refType this@@37 Tclass._module.Object $Heap@@20)))))) (and (and (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@20 this@@37) (=> (_module.Object.AllFieldsAreDeclared $Heap@@20 this@@37) (and (|_module.Object.AllFieldsContentsConsistentWithTheirDeclaration#canCall| $Heap@@20 this@@37) (=> (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@20 this@@37) (|_module.Object.AllOutgoingReferencesAreVenice#canCall| $Heap@@20 this@@37))))) (= (_module.Object.Valid true $Heap@@20 this@@37)  (and (and (_module.Object.AllFieldsAreDeclared $Heap@@20 this@@37) (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@20 this@@37)) (_module.Object.AllOutgoingReferencesAreVenice $Heap@@20 this@@37)))))
 :qid |gitissue3855dfy.110:23|
 :skolemid |770|
 :pattern ( (_module.Object.Valid true $Heap@@20 this@@37) ($IsGoodHeap $Heap@@20))
))))
...
(assert (forall ((|l#0@@7| T@U) (|l#1@@7| T@U) (|l#2@@3| T@U) (|l#3@@1| T@U) (|l#4@@0| T@U) (|l#5@@0| T@U) (|l#6@@0| T@U) (|l#7@@0| T@U) (|l#8@@0| T@U) (|l#9@@0| T@U) (|l#10@@0| T@U) (|$y#0@@3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@1| |l#4@@0| |l#5@@0| |l#6@@0| |l#7@@0| |l#8@@0| |l#9@@0| |l#10@@0|) |$y#0@@3|)) (exists ((|o#0@@12| T@U) (|n#0@@3| T@U) ) (!  (and (and (and ($Is refType |o#0@@12| |l#0@@7|) ($Is SeqType |n#0@@3| |l#1@@7|)) (and (|Set#IsMember| |l#2@@3| ($Box refType |o#0@@12|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3@@1| |o#0@@12|) |l#4@@0|))) ($Box SeqType |n#0@@3|)))) (= |$y#0@@3| ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@12| |n#0@@3| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#5@@0| |o#0@@12|) |l#6@@0|))) ($Box SeqType |n#0@@3|)))))))
 :qid |gitissue3855dfy.261:10|
 :skolemid |920|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#9@@0| |o#0@@12|) |l#10@@0|))) ($Box SeqType |n#0@@3|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#7@@0| |o#0@@12|) |l#8@@0|))) ($Box SeqType |n#0@@3|)))
)))
 :qid |gitissue3855dfy.87:7|
 :skolemid |1416|
 :pattern ( (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@1| |l#4@@0| |l#5@@0| |l#6@@0| |l#7@@0| |l#8@@0| |l#9@@0| |l#10@@0|) |$y#0@@3|))
)))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@38 T@U) (|o#0@@13| T@U) (|n#0@@4| T@U) ) (!  (=> (or (|_module.Memory.fRead#canCall| $Heap@@21 this@@38 |o#0@@13| |n#0@@4|) (and (< 8 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $Heap@@21) (or (not (= this@@38 null)) (not true))) ($IsAlloc refType this@@38 Tclass._module.Memory $Heap@@21)) (and ($Is refType |o#0@@13| Tclass._module.Object) ($IsAlloc refType |o#0@@13| Tclass._module.Object $Heap@@21))) (and ($Is SeqType |n#0@@4| (TSeq TChar)) ($IsAlloc SeqType |n#0@@4| (TSeq TChar) $Heap@@21))) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@38) _module.Memory.objects)) ($Box refType |o#0@@13|)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 this@@38)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |o#0@@13|) _module.Object.fields))) ($Box SeqType |n#0@@4|)))))) ($IsAlloc refType (_module.Memory.fRead $Heap@@21 this@@38 |o#0@@13| |n#0@@4|) Tclass._module.Object $Heap@@21))
 :qid |gitissue3855dfy.408:12|
 :skolemid |1056|
 :pattern ( ($IsAlloc refType (_module.Memory.fRead $Heap@@21 this@@38 |o#0@@13| |n#0@@4|) Tclass._module.Object $Heap@@21))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@22 T@U) (this@@39 T@U) (|os#0@@9| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@22 this@@39 |os#0@@9|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@39 null)) (not true)) (and ($Is refType this@@39 Tclass._module.Memory) ($IsAlloc refType this@@39 Tclass._module.Memory $Heap@@22)))) ($Is SetType |os#0@@9| (TSet Tclass._module.Object))))) (= (_module.Memory.edges $Heap@@22 this@@39 |os#0@@9|) (|Set#FromBoogieMap| (|lambda#47| Tclass._module.Object (TSeq TChar) |os#0@@9| $Heap@@22 _module.Object.fields $Heap@@22 _module.Object.fields $Heap@@22 _module.Object.fields $Heap@@22 _module.Object.fields))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |921|
 :pattern ( (_module.Memory.edges $Heap@@22 this@@39 |os#0@@9|) ($IsGoodHeap $Heap@@22))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@40 T@U) (|t#0@@11| T@U) (|edges#0@@23| T@U) ) (!  (=> (or (|_module.Memory.refCountEdges#canCall| this@@40 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.Memory)) ($Is refType |t#0@@11| Tclass._module.Object)) ($Is SetType |edges#0@@23| (TSet Tclass._module.Edge))))) (and (|_module.Memory.incomingEdges#canCall| this@@40 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (= (_module.Memory.refCountEdges this@@40 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (|Set#Card| (_module.Memory.incomingEdges this@@40 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|))))))
 :qid |gitissue3855dfy.251:12|
 :weight 3
 :skolemid |911|
 :pattern ( (_module.Memory.refCountEdges this@@40 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@42 T@U) ) (!  (=> (or (|_module.Object.AllOutgoingReferencesAreVenice#canCall| $Heap@@23 this@@42) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@42 null)) (not true)) (and ($Is refType this@@42 Tclass._module.Object) ($IsAlloc refType this@@42 Tclass._module.Object $Heap@@23)))))) (and (forall ((|n#0@@5| T@U) ) (!  (=> ($Is SeqType |n#0@@5| (TSeq TChar)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@42) _module.Object.fields))) ($Box SeqType |n#0@@5|)) (|_module.__default.VeniceReferenceOK#canCall| this@@42 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@42) _module.Object.fields))) ($Box SeqType |n#0@@5|))))))
 :qid |gitissue3855dfy.134:16|
 :skolemid |796|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@42) _module.Object.fields))) ($Box SeqType |n#0@@5|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@42) _module.Object.fields))) ($Box SeqType |n#0@@5|)))
)) (= (_module.Object.AllOutgoingReferencesAreVenice $Heap@@23 this@@42) (forall ((|n#0@@6| T@U) ) (!  (=> (and ($Is SeqType |n#0@@6| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@42) _module.Object.fields))) ($Box SeqType |n#0@@6|))) (_module.__default.VeniceReferenceOK this@@42 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@42) _module.Object.fields))) ($Box SeqType |n#0@@6|)))))
 :qid |gitissue3855dfy.134:16|
 :skolemid |795|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@42) _module.Object.fields))) ($Box SeqType |n#0@@6|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@42) _module.Object.fields))) ($Box SeqType |n#0@@6|)))
)))))
 :qid |gitissue3855dfy.131:13|
 :skolemid |797|
 :pattern ( (_module.Object.AllOutgoingReferencesAreVenice $Heap@@23 this@@42) ($IsGoodHeap $Heap@@23))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.fRead)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |o#0@@15| null)) (not true))) (=> (or (not (= |o#0@@15| null)) (not true)) (=> (= |b$reqreads#5@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |o#0@@15| _module.Object.fields))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 |o#0@@15|) _module.Object.fields))) ($Box SeqType |n#0@@7|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 |o#0@@15|) _module.Object.fields))) ($Box SeqType |n#0@@7|)) (=> (and (and (= (_module.Memory.fRead $Heap@@24 this@@43 |o#0@@15| |n#0@@7|) ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 |o#0@@15|) _module.Object.fields))) ($Box SeqType |n#0@@7|)))) ($Is refType (_module.Memory.fRead $Heap@@24 this@@43 |o#0@@15| |n#0@@7|) Tclass._module.Object)) (and (= (_module.Memory.fRead $Heap@@24 this@@43 |o#0@@15| |n#0@@7|) |r#0@@4|) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#5@0|))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#90| null $Heap@@24 alloc this@@43 _module.Memory.objects ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 this@@43) _module.Memory.objects)) |o#0@@15| _module.Object.fields this@@43 _module.Memory.objects ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 this@@43) _module.Memory.objects)) |o#0@@15| _module.Object.fields)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@43 _module.Memory.objects))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 this@@43) _module.Memory.objects)) ($Box refType |o#0@@15|))) (=> (and (and ($IsAllocBox ($Box refType this@@43) Tclass._module.Memory? $Heap@@24) (= |b$reqreads#1@0| (forall (($o@@12 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 $o@@12) alloc)))) (or (and (= $o@@12 this@@43) (= $f@@0 _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 this@@43) _module.Memory.objects)) ($Box refType $o@@12)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@12 $f@@0)))
 :qid |gitissue3855dfy.410:14|
 :skolemid |1059|
)))) (and (|_module.Memory.Valid#canCall| $Heap@@24 this@@43) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@24 this@@43))) (and (=> (= (ControlFlow 0 6) (- 0 16)) (or (not (= |o#0@@15| null)) (not true))) (=> (or (not (= |o#0@@15| null)) (not true)) (=> (and (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |o#0@@15| _module.Object.fields))) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@24 |o#0@@15|) _module.Object.fields))) ($Box SeqType |n#0@@7|))) (and (=> (= (ControlFlow 0 6) (- 0 15)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 6) (- 0 14)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 6) (- 0 13)) |b$reqreads#2@0|) (=> |b$reqreads#2@0| (and (=> (= (ControlFlow 0 6) (- 0 12)) (or (not (= this@@43 null)) (not true))) (=> (or (not (= this@@43 null)) (not true)) (=> (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@43 _module.Memory.objects))) (and (=> (= (ControlFlow 0 6) (- 0 11)) (or (not (= |o#0@@15| null)) (not true))) (=> (or (not (= |o#0@@15| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 10)) (or (not (= this@@43 null)) (not true))) (=> (or (not (= this@@43 null)) (not true)) (=> (= |b$reqreads#4@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@43 _module.Memory.objects))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= |o#0@@15| null)) (not true))) (=> (or (not (= |o#0@@15| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 8)) |b$reqreads#3@0|) (=> |b$reqreads#3@0| (and (=> (= (ControlFlow 0 6) (- 0 7)) |b$reqreads#4@0|) (=> |b$reqreads#4@0| (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@24) ($IsHeapAnchor $Heap@@24)) (and (or (not (= this@@43 null)) (not true)) (and ($Is refType this@@43 Tclass._module.Memory) ($IsAlloc refType this@@43 Tclass._module.Memory $Heap@@24)))) (and (and ($Is refType |o#0@@15| Tclass._module.Object) ($Is SeqType |n#0@@7| (TSeq TChar))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 17) 6)))) anon0_correct)))
