...
(declare-fun Tagclass._System.object () T@U)
(declare-fun Tagclass.ConstInClass.UninstantiableClass () T@U)
(declare-fun Tagclass.ConstInClass.ReallyEmpty () T@U)
(declare-fun Tagclass.ConstInClass.UninstantiableClass? () T@U)
...
(declare-fun ConstInClass.UninstantiableClass.x (T@U) Int)
(declare-fun null () T@U)
(declare-fun dtype (T@U) T@U)
(declare-fun Tclass.ConstInClass.UninstantiableClass? () T@U)
(declare-fun $Is (T@T T@U T@U) Bool)
(declare-fun Tclass.ConstInClass.ReallyEmpty () T@U)
...
(assert (= (Tag Tclass.ConstInClass.ReallyEmpty) Tagclass.ConstInClass.ReallyEmpty))
(assert (= (TagFamily Tclass.ConstInClass.ReallyEmpty) tytagFamily$ReallyEmpty))
(assert (= (Tag Tclass.ConstInClass.UninstantiableClass?) Tagclass.ConstInClass.UninstantiableClass?))
(assert (= (TagFamily Tclass.ConstInClass.UninstantiableClass?) tytagFamily$UninstantiableClass))
...
(let ((anon3_Else_correct  (=> (and (not ($Is refType |o#0| Tclass.ConstInClass.UninstantiableClass)) (= (ControlFlow 0 9) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> ($Is refType |o#0| Tclass.ConstInClass.UninstantiableClass) (and (=> (= (ControlFlow 0 3) (- 0 8)) ($Is refType |o#0| Tclass.ConstInClass.UninstantiableClass)) (=> ($Is refType |o#0| Tclass.ConstInClass.UninstantiableClass) (and (=> (= (ControlFlow 0 3) (- 0 7)) true) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |o#0| null)) (not true))) (=> (or (not (= |o#0| null)) (not true)) (=> (= |newtype$check#0_2@0| (ConstInClass.UninstantiableClass.x |o#0|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= |newtype$check#0_3@0| (ConstInClass.UninstantiableClass.x |o#0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (and (= |r#0_0@0| (ConstInClass.UninstantiableClass.x |o#0|)) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))))))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |o#0| Tclass._System.object) ($IsAlloc refType |o#0| Tclass._System.object $Heap)) (and (=> |defass#u#0_0| (and ($Is refType |u#0_0| Tclass.ConstInClass.UninstantiableClass) ($IsAlloc refType |u#0_0| Tclass.ConstInClass.UninstantiableClass $Heap))) true)) (and (and (=> |defass#r#0_0| (U_2_bool (Lit boolType (bool_2_U false)))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct))))
