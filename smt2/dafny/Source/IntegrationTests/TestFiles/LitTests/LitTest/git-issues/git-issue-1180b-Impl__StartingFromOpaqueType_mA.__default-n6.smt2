...
(set-info :boogie-vc-id Impl$$StartingFromOpaqueType_mA.__default.Caller)
...
(let ((anon3_Then_correct  (=> (or (not (= |c#0@0| 9)) (not true)) (=> (and (= |x##0_0@0| (StartingFromOpaqueType_mA.Ty.c |t#0|)) (<= (LitInt 0) |call3formal@r#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |x##0_0@0| 9)) (not true))) (=> (or (not (= |x##0_0@0| 9)) (not true)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (<= (LitInt 0) |call3formal@r#0@0|) (= |call3formal@r#0@0| |x##0_0@0|))) (and (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |gitissue1180bdfy.13:14|
 :skolemid |488|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
)) ($HeapSucc $Heap $Heap@0)) (and ($IsAllocBox |t#0| Tclass.StartingFromOpaqueType_mA.Ty $Heap@0) (= |newtype$check#0_0@0| (Mul (LitInt 2) |c#0@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (LitInt 0) |newtype$check#0_0@0|)) (=> (<= (LitInt 0) |newtype$check#0_0@0|) (=> (and (= |##x#0_0@0| (Mul (LitInt 2) |c#0@0|)) ($IsAlloc intType (int_2_U |##x#0_0@0|) Tclass._System.nat $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |##x#0_0@0| 7)) (not true))) (=> (or (not (= |##x#0_0@0| 7)) (not true)) (=> (and (and (|StartingFromOpaqueType_mA.Ty.F#canCall| |t#0| (Mul (LitInt 2) |c#0@0|)) (|StartingFromOpaqueType_mA.Ty.F#canCall| |t#0| (Mul (LitInt 2) |c#0@0|))) (and (= |u#0_0@0| (StartingFromOpaqueType_mA.Ty.F |t#0| (Mul (LitInt 2) |c#0@0|))) (= (ControlFlow 0 2) (- 0 1)))) (= |call3formal@r#0@0| |u#0_0@0|))))))))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |c#0@0| (StartingFromOpaqueType_mA.Ty.c |t#0|))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |t#0| Tclass.StartingFromOpaqueType_mA.Ty) ($IsAllocBox |t#0| Tclass.StartingFromOpaqueType_mA.Ty $Heap))) (=> (and (and (and (<= (LitInt 0) |c#0|) true) (and (<= (LitInt 0) |r#0_0|) true)) (and (and (<= (LitInt 0) |u#0_0|) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct))))
