...
))) (= (Ctor bv128Type) 3)) (forall ((arg0@@2 (_ BitVec 128)) ) (! (= (U_2_bv128 (bv128_2_U arg0@@2)) arg0@@2)
 :pattern ( (bv128_2_U arg0@@2))
))) (forall ((x@@2 T@U) ) (! (= (bv128_2_U (U_2_bv128 x@@2)) x@@2)
 :pattern ( (U_2_bv128 x@@2))
))))
...
(assert  (and (and (= (Ctor bv6Type) 5) (forall ((arg0@@4 (_ BitVec 6)) ) (! (= (U_2_bv6 (bv6_2_U arg0@@4)) arg0@@4)
 :pattern ( (bv6_2_U arg0@@4))
))) (forall ((x@@4 T@U) ) (! (= (bv6_2_U (U_2_bv6 x@@4)) x@@4)
 :pattern ( (U_2_bv6 x@@4))
))))
(assert (forall ((v@@1 T@U) ) (! ($Is bv6Type v@@1 (TBitvector 6))
 :pattern ( ($Is bv6Type v@@1 (TBitvector 6)))
)))
(assert  (and (and (= (Ctor bv7Type) 6) (forall ((arg0@@5 (_ BitVec 7)) ) (! (= (U_2_bv7 (bv7_2_U arg0@@5)) arg0@@5)
...
(assert  (and (and (= (Ctor bv8Type) 7) (forall ((arg0@@6 (_ BitVec 8)) ) (! (= (U_2_bv8 (bv8_2_U arg0@@6)) arg0@@6)
 :pattern ( (bv8_2_U arg0@@6))
...
(assert  (and (and (= (Ctor bv16Type) 8) (forall ((arg0@@7 (_ BitVec 16)) ) (! (= (U_2_bv16 (bv16_2_U arg0@@7)) arg0@@7)
 :pattern ( (bv16_2_U arg0@@7))
))) (forall ((x@@7 T@U) ) (! (= (bv16_2_U (U_2_bv16 x@@7)) x@@7)
 :pattern ( (U_2_bv16 x@@7))
))))
(assert (forall ((v@@4 T@U) ) (! ($Is bv16Type v@@4 (TBitvector 16))
 :pattern ( ($Is bv16Type v@@4 (TBitvector 16)))
)))
(assert  (and (and (= (Ctor bv32Type) 9) (forall ((arg0@@8 (_ BitVec 32)) ) (! (= (U_2_bv32 (bv32_2_U arg0@@8)) arg0@@8)
 :pattern ( (bv32_2_U arg0@@8))
))) (forall ((x@@8 T@U) ) (! (= (bv32_2_U (U_2_bv32 x@@8)) x@@8)
 :pattern ( (U_2_bv32 x@@8))
))))
(assert (forall ((v@@5 T@U) ) (! ($Is bv32Type v@@5 (TBitvector 32))
 :pattern ( ($Is bv32Type v@@5 (TBitvector 32)))
)))
(assert  (and (and (= (Ctor bv64Type) 10) (forall ((arg0@@9 (_ BitVec 64)) ) (! (= (U_2_bv64 (bv64_2_U arg0@@9)) arg0@@9)
 :pattern ( (bv64_2_U arg0@@9))
