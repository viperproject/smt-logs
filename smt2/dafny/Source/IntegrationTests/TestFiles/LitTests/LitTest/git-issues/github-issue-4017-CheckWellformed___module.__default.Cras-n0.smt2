...
(declare-fun _module.__default.Crash (Int) T@U)
(declare-fun |_module.__default.Crash#canCall| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|e#0| Int) ) (!  (=> (or (|_module.__default.Crash#canCall| |e#0|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |e#0|))) ($Is SeqType (_module.__default.Crash |e#0|) (TSeq TChar)))
 :qid |githubissue4017dfy.4:16|
 :skolemid |479|
 :pattern ( (_module.__default.Crash |e#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|e#0@@0| Int) ) (!  (=> (or (|_module.__default.Crash#canCall| |e#0@@0|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |e#0@@0|))) (= (_module.__default.Crash |e#0@@0|) (Lit SeqType |Seq#Empty|)))
 :qid |githubissue4017dfy.4:16|
 :skolemid |481|
 :pattern ( (_module.__default.Crash |e#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|e#0@@1| Int) ) (!  (=> (or (|_module.__default.Crash#canCall| (LitInt |e#0@@1|)) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |e#0@@1|))) (= (_module.__default.Crash (LitInt |e#0@@1|)) (Lit SeqType |Seq#Empty|)))
 :qid |githubissue4017dfy.4:16|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.Crash (LitInt |e#0@@1|)))
))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |e#0@@2|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct)))
