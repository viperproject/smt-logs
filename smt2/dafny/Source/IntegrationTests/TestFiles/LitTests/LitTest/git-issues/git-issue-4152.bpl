// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var newtype$check#9: int;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy(4,14)
    assume true;
    assume true;
    a#0 := Lit(255bv8);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy(5,15)
    assume true;
    assume true;
    b#0 := Lit(65535bv16);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy(6,15)
    assume true;
    assume true;
    c#0 := Lit(4294967295bv32);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy(7,15)
    assume true;
    assume true;
    d#0 := Lit(18446744073709551615bv64);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy(8,16)
    assume true;
    assume true;
    e#0 := Lit(340282366920938463463374607431768211455bv128);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy(9,3)
    assume true;
    assume true;
    assume true;
    assume true;
    ...
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy(10,3)
    newtype$check#0 := a#0;
    assert {:id "id5"} LitInt(0) <= nat_from_bv8(newtype$check#0);
    newtype$check#1 := nat_from_bv8(a#0);
    assert {:id "id6"} LitInt(0) <= newtype$check#1;
    assume true;
    assume true;
    newtype$check#2 := b#0;
    assert {:id "id7"} LitInt(0) <= nat_from_bv16(newtype$check#2);
    newtype$check#3 := nat_from_bv16(b#0);
    assert {:id "id8"} LitInt(0) <= newtype$check#3;
    assume true;
    assume true;
    newtype$check#4 := c#0;
    assert {:id "id9"} LitInt(0) <= nat_from_bv32(newtype$check#4);
    newtype$check#5 := nat_from_bv32(c#0);
    assert {:id "id10"} LitInt(0) <= newtype$check#5;
    assume true;
    assume true;
    newtype$check#6 := d#0;
    assert {:id "id11"} LitInt(0) <= nat_from_bv64(newtype$check#6);
    newtype$check#7 := nat_from_bv64(d#0);
    assert {:id "id12"} LitInt(0) <= newtype$check#7;
    assume true;
    assume true;
    newtype$check#8 := e#0;
    assert {:id "id13"} LitInt(0) <= nat_from_bv128(newtype$check#8);
    newtype$check#9 := nat_from_bv128(e#0);
    assert {:id "id14"} LitInt(0) <= newtype$check#9;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-4152.dfy(11,3)
    assume true;
    assume true;
    assume true;
    assume true;
