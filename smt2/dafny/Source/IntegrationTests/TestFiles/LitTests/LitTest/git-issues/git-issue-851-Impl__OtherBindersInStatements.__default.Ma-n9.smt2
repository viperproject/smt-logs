...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon7_correct  (=> (forall ((|a#1#0#0@@0| T@U) )  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))))) (=> (and (= |b#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#14| TBool TBool $Heap (U_2_bool (Lit boolType (bool_2_U true))) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))) (|lambda#9| ($Box intType (int_2_U (LitInt 20)))) (TMap TBool TInt))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true))))))
