...
(assert (forall ((|x#0@@6| T@U) ) (! (= ($Is intType |x#0@@6| Tclass.NewtypeSubsetType.NonCompilableTestInt32)  (and (and (<= (LitInt (- 0 2147483648)) (U_2_int |x#0@@6|)) (< (U_2_int |x#0@@6|) 2147483648)) (NewtypeSubsetType.__default.P (U_2_int |x#0@@6|))))
 :pattern ( ($Is intType |x#0@@6| Tclass.NewtypeSubsetType.NonCompilableTestInt32))
)))
(assert (forall ((|x#0@@7| T@U) ) (! (= ($Is intType |x#0@@7| Tclass.NewtypeSubsetType.Type2)  (and (and (<= (LitInt (- 0 2147483648)) (U_2_int |x#0@@7|)) (< (U_2_int |x#0@@7|) 2147483648)) (NewtypeSubsetType.__default.P (U_2_int |x#0@@7|))))
 :pattern ( ($Is intType |x#0@@7| Tclass.NewtypeSubsetType.Type2))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@8| Int) ) (!  (=> (or (|NewtypeSubsetType.__default.P#canCall| |x#0@@8|) (< 0 $FunctionContextHeight)) (= (NewtypeSubsetType.__default.P |x#0@@8|)  (or (not (= |x#0@@8| 3)) (not true))))
 :pattern ( (NewtypeSubsetType.__default.P |x#0@@8|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@9| Int) ) (!  (=> (or (|NewtypeSubsetType.__default.Q#canCall| |x#0@@9|) (< 0 $FunctionContextHeight)) (= (NewtypeSubsetType.__default.Q |x#0@@9|)  (or (not (= |x#0@@9| 5)) (not true))))
 :pattern ( (NewtypeSubsetType.__default.Q |x#0@@9|))
))))
(assert (forall ((x@@4 T@U) (T@@0 T@T) ) (! (= ($Box T@@0 ($Unbox T@@0 x@@4)) x@@4)
 :pattern ( ($Unbox T@@0 x@@4))
)))
(assert (forall ((|x#0@@10| T@U) ) (! (= ($Is intType |x#0@@10| Tclass.NewtypeSubsetType.Type6)  (and (and (NewtypeSubsetType.__default.Q (U_2_int |x#0@@10|)) (< (U_2_int |x#0@@10|) 8)) (<= (LitInt 0) (U_2_int |x#0@@10|))))
 :pattern ( ($Is intType |x#0@@10| Tclass.NewtypeSubsetType.Type6))
)))
(assert (forall ((|x#0@@11| T@U) ) (! (= ($Is intType |x#0@@11| Tclass.NewtypeSubsetType.CompilableTest)  (and (NewtypeSubsetType.__default.Q (U_2_int |x#0@@11|)) (< (U_2_int |x#0@@11|) 8)))
 :pattern ( ($Is intType |x#0@@11| Tclass.NewtypeSubsetType.CompilableTest))
)))
(assert (forall ((|x#0@@12| T@U) ) (! (= ($Is intType |x#0@@12| Tclass.NewtypeSubsetType.Type4)  (and (NewtypeSubsetType.__default.Q (U_2_int |x#0@@12|)) (< (U_2_int |x#0@@12|) 8)))
 :pattern ( ($Is intType |x#0@@12| Tclass.NewtypeSubsetType.Type4))
)))
