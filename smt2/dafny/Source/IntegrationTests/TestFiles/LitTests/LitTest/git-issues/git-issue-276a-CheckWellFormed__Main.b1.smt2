...
(set-info :boogie-vc-id CheckWellFormed$$Main.b1)
...
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |x#0|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (LitInt (- 2 2)) 0)) (not true))) (=> (or (not (= (LitInt (- 2 2)) 0)) (not true)) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< 0 (Div 3 (LitInt (- 2 2)))))))))))
