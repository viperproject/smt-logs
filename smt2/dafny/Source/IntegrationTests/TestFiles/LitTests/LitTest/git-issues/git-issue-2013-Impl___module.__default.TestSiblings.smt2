...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (Lit DatatypeTypeType (|#_module.Dt.Dt| ($Box intType (int_2_U (LitInt 10))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) ($Is DatatypeTypeType |a#0@0| (Tclass._module.Dt Tclass._System.nat))) (=> ($Is DatatypeTypeType |a#0@0| (Tclass._module.Dt Tclass._System.nat)) (and (=> (= (ControlFlow 0 2) (- 0 8)) ($Is DatatypeTypeType |a#0@0| (Tclass._module.Dt Tclass._module.Even))) (=> ($Is DatatypeTypeType |a#0@0| (Tclass._module.Dt Tclass._module.Even)) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($Is intType (int_2_U (LitInt 11)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 11)) Tclass._System.nat) (=> (= |b#0@0| (Lit DatatypeTypeType (|#_module.Dt.Dt| ($Box intType (int_2_U (LitInt 11)))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($Is intType (int_2_U (LitInt 12)) Tclass._module.Even)) (=> ($Is intType (int_2_U (LitInt 12)) Tclass._module.Even) (=> (= |c#0@0| (Lit DatatypeTypeType (|#_module.Dt.Dt| ($Box intType (int_2_U (LitInt 12)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($Is intType (int_2_U (LitInt 20)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 20)) Tclass._System.nat) (=> (= |b#0@1| (Lit DatatypeTypeType (|#_module.Dt.Dt| ($Box intType (int_2_U (LitInt 20)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is DatatypeTypeType |b#0@1| (Tclass._module.Dt Tclass._module.Even))) (=> ($Is DatatypeTypeType |b#0@1| (Tclass._module.Dt Tclass._module.Even)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (LitInt 30)) Tclass._module.Even)) (=> ($Is intType (int_2_U (LitInt 30)) Tclass._module.Even) (=> (and (= |c#0@1| (Lit DatatypeTypeType (|#_module.Dt.Dt| ($Box intType (int_2_U (LitInt 30)))))) (= (ControlFlow 0 2) (- 0 1))) ($Is DatatypeTypeType |c#0@1| (Tclass._module.Dt Tclass._System.nat)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |a#0| (Tclass._module.Dt TInt)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.Dt TInt) $Heap)) true) (and (and ($Is DatatypeTypeType |b#0| (Tclass._module.Dt Tclass._System.nat)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.Dt Tclass._System.nat) $Heap)) true)) (and (and (and ($Is DatatypeTypeType |c#0| (Tclass._module.Dt Tclass._module.Even)) ($IsAlloc DatatypeTypeType |c#0| (Tclass._module.Dt Tclass._module.Even) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 2)))) anon0_correct))))
