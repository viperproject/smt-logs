...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let (($generated@@99  (=> (= $generated@@88 ($generated 0)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (not (= $generated@@88 7)) (not true))) (=> (or (not (= $generated@@88 7)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 (< 0 256))))) (=> (= (ControlFlow 0 5) (- 0 4)) (<= ($generated 0) ($generated 0)))))))))
(let (($generated@@100  (=> (and (or (not (= $generated@@89 7)) (not true)) (= $generated@@90 ($generated 256))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= $generated@@90 7)) (not true))) (=> (or (not (= $generated@@90 7)) (not true)) (=> (< $generated@@89 256) (=> (and (= $generated@@91 ($generated 0)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@91 7)) (not true)))))))))
(let (($generated@@101  (=> (= $generated@@92 ($generated@@29 $generated@@93 $generated@@94 $generated@@95 false)) (and (=> (= (ControlFlow 0 8) 2) $generated@@100) (=> (= (ControlFlow 0 8) 5) $generated@@99)))))
(let (($generated@@102  (=> (and (and ($generated@@96 $generated@@94) ($generated@@97 $generated@@94)) (and (= 1 $generated@@98) (= (ControlFlow 0 9) 8))) $generated@@101)))
$generated@@102)))))
))
(check-sat)
(get-info :rlimit)
