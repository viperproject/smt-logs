...
(assert (forall ((|l#0| T@U) (|$l#1#heap#0| T@U) (|$l#1#_v0#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#5| |l#0|) |$l#1#heap#0| |$l#1#_v0#0|)) ($IsBox |$l#1#_v0#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |504|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#5| |l#0|) |$l#1#heap#0| |$l#1#_v0#0|))
)))
...
(assert (forall ((|l#0@@0| Bool) (|$l#1#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#6| |l#0@@0|) |$l#1#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |505|
 :pattern ( (MapType1Select refType boolType (|lambda#6| |l#0@@0|) |$l#1#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#1#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#8| |l#0@@1|) |$l#1#ly#0|) |l#0@@1|)
 :qid |gitissue2216dfy.28:28|
 :skolemid |507|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#8| |l#0@@1|) |$l#1#ly#0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#1#heap#0@@0| T@U) (|$l#1#_v0#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#4| |l#0@@3|) |$l#1#heap#0@@0| |$l#1#_v0#0@@0|) |l#0@@3|)
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#4| |l#0@@3|) |$l#1#heap#0@@0| |$l#1#_v0#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#1#heap#0@@1| T@U) (|$l#1#_v0#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@4|) |$l#1#heap#0@@1| |$l#1#_v0#0@@1|) |l#0@@4|)
 :qid |gitissue2216dfy.28:28|
 :skolemid |506|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#7| |l#0@@4|) |$l#1#heap#0@@1| |$l#1#_v0#0@@1|))
)))
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (LitInt 10000000))) (Requires1 TInt TInt $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |gitissue2216dfy.28:12|
 :skolemid |498|
)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= 0 (LitInt 10000000))) (=> (<= 0 (LitInt 10000000)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 2) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 6))) anon0_correct))))
