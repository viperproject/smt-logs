...
(assert (distinct alloc Tagclass.ExampleA.C Tagclass.ExampleA.C? tytagFamily$C)
)
...
(assert (forall ((|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| Tclass.ExampleA.C)  (and ($Is refType |c#0@@0| Tclass.ExampleA.C?) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |493|
 :pattern ( ($Is refType |c#0@@0| Tclass.ExampleA.C))
 :pattern ( ($Is refType |c#0@@0| Tclass.ExampleA.C?))
)))
...
(set-info :boogie-vc-id CheckWellformed$$ExampleA.C.F)
