...
(assert (distinct alloc Tagclass.ConstInClass.UninstantiableClass Tagclass.ConstInClass.ReallyEmpty Tagclass.ConstInClass.UninstantiableClass? tytagFamily$UninstantiableClass tytagFamily$ReallyEmpty)
)
...
(assert (forall ((|c#0| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0| Tclass.ConstInClass.UninstantiableClass $h@@1) ($IsAlloc refType |c#0| Tclass.ConstInClass.UninstantiableClass? $h@@1))
 :qid |unknown.0:0|
 :skolemid |1485|
 :pattern ( ($IsAlloc refType |c#0| Tclass.ConstInClass.UninstantiableClass $h@@1))
 :pattern ( ($IsAlloc refType |c#0| Tclass.ConstInClass.UninstantiableClass? $h@@1))
)))
(assert (forall (($o@@2 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass.ConstInClass.UninstantiableClass? $h@@2)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1478|
 :pattern ( ($IsAlloc refType $o@@2 Tclass.ConstInClass.UninstantiableClass? $h@@2))
)))
...
(assert (forall ((|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| Tclass.ConstInClass.UninstantiableClass)  (and ($Is refType |c#0@@0| Tclass.ConstInClass.UninstantiableClass?) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |1484|
 :pattern ( ($Is refType |c#0@@0| Tclass.ConstInClass.UninstantiableClass))
 :pattern ( ($Is refType |c#0@@0| Tclass.ConstInClass.UninstantiableClass?))
)))
...
(set-info :boogie-vc-id Impl$$ConstInClass.UninstantiableClass.__ctor)
