...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.staticCopyAsg)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@21 alloc |frame#0| _module.Object.fields)) (and (=> (= (ControlFlow 0 2) (- 0 21)) (or (not (= |memory#0| null)) (not true))) (=> (or (not (= |memory#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |memory#0|) _module.Memory.objects)) ($Box refType |frame#0|)) (and (=> (= (ControlFlow 0 2) (- 0 20)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 19)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (or (not (= |memory#0| null)) (not true))) (=> (or (not (= |memory#0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |memory#0|) Tclass._module.Memory? $Heap@@21) (|_module.Memory.Valid#canCall| $Heap@@21 |memory#0|)) (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 |memory#0|) (not (|Seq#Equal| |t#0@@12| |f#0@@1|)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|))) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|))) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|)) (=> (|_module.Mode#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|)))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|))) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|)) (=> (and (and (= |##x#0@0| (_module.Mode.Iso_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|))))) ($IsAlloc boolType (bool_2_U |##x#0@0|) TBool $Heap@@21)) (and (|_module.__default.not#canCall| (_module.Mode.Iso_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|))))) (_module.__default.not (_module.Mode.Iso_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (and (and (= |##x#1@0| (_module.Region.Frozen_q (_module.Object.region |frame#0|))) ($IsAlloc boolType (bool_2_U |##x#1@0|) TBool $Heap@@21)) (and (|_module.__default.not#canCall| (_module.Region.Frozen_q (_module.Object.region |frame#0|))) (_module.__default.not (_module.Region.Frozen_q (_module.Object.region |frame#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@25) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@25)) (= $o@@25 |frame#0|)))
 :qid |gitissue3855dfy.1058:8|
 :skolemid |612|
...
)) ($HeapSucc $Heap@@21 $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |frame#0| Tclass._module.Object $Heap@@21)) (=> ($IsAlloc refType |frame#0| Tclass._module.Object $Heap@@21) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))))))))))))))))))))))))))))))))))))))))))))))))))))
