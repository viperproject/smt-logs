...
(assert (distinct TInt TagInt TagSet alloc allocName Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 class._module.MyClass? Tagclass._module.MyClass? Tagclass._module.MyClass tytagFamily$object |tytagFamily$_#Func1| tytagFamily$MyClass field$y)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0| T@U) (|$l#1_1_1_0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#3| |l#0|) |$l#1_1_1_0#o#0|)) (= |$l#1_1_1_0#o#0| |l#0|))
 :qid |gitissue1163dfy.27:43|
 :skolemid |523|
 :pattern ( (MapType1Select refType boolType (|lambda#3| |l#0|) |$l#1_1_1_0#o#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| Int) (|$l#0#heap#0| T@U) (|$l#0#p#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#27| |l#0@@0| |l#1| |l#2|) |$l#0#heap#0| |$l#0#p#0|))  (and ($IsBox |$l#0#p#0| |l#0@@0|) (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$l#0#heap#0| ($Unbox refType |$l#0#p#0|)) |l#1|))) |l#2|)))
 :qid |gitissue1163dfy.10:7|
 :skolemid |527|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#27| |l#0@@0| |l#1| |l#2|) |$l#0#heap#0| |$l#0#p#0|))
)))
...
(assert (forall (($h@@3 T@U) ($o@@2 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass._module.MyClass?))) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@2) alloc)))) ($IsAlloc intType ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@2) _module.MyClass.y)) TInt $h@@3))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |490|
 :pattern ( ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@2) _module.MyClass.y)))
)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| T@U) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@1| |l#1@@0| |l#2@@0| |l#3|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0@@1|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@3) |l#2@@0|)))) (= $o@@3 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |520|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@1| |l#1@@0| |l#2@@0| |l#3|) $o@@3 $f))
)))
...
(assert (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 Tclass._module.MyClass?) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) Tclass._module.MyClass?)))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( ($IsBox bx@@7 Tclass._module.MyClass?))
)))
...
(assert (forall ((|l#0@@2| T@U) (|$l#1_1_1_0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@2|) |$l#1_1_1_0#ly#0|) |l#0@@2|)
 :qid |gitissue1163dfy.27:26|
 :skolemid |525|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@2|) |$l#1_1_1_0#ly#0|))
)))
...
(assert (forall (($h@@4 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.MyClass?))) ($Is intType ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@5) _module.MyClass.y)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |489|
 :pattern ( ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@4 $o@@5) _module.MyClass.y)))
)))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#p#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType |lambda#29| |$l#0#heap#0@@0| |$l#0#p#0@@0|) (SetRef_to_SetBox (|lambda#3| ($Unbox refType |$l#0#p#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |528|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType |lambda#29| |$l#0#heap#0@@0| |$l#0#p#0@@0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#p#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#26| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#p#0@@1|) |l#0@@3|)
 :qid |unknown.0:0|
 :skolemid |526|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#26| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#p#0@@1|))
)))
...
(declare-fun |$Heap_at_$lambdaHeap#0@0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.MyClass.O)
...
(let ((anon8_Else_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#0@0| |p#0@0|) _module.MyClass.y))) (LitInt 10))) (not true)) (= (ControlFlow 0 9) 2)) anon4_correct)))
(let ((anon8_Then_correct  (=> (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#0@0| |p#0@0|) _module.MyClass.y))) (LitInt 10)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (not (= |p#0@0| null)) (not true))) (and (=> (= (ControlFlow 0 4) (- 0 7)) ($IsAlloc refType |p#0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0@0|)) (=> ($IsAlloc refType |p#0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0@0|) (and (=> (= (ControlFlow 0 4) (- 0 6)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| |p#0@0| _module.MyClass.y))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#0@0| |p#0@0|) _module.MyClass.y))) (LitInt 10))) (=> (= (U_2_int ($Unbox intType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#0@0| |p#0@0|) _module.MyClass.y))) (LitInt 10)) (=> (= |lambdaResult#0| (LitInt 5)) (=> (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 4) 2)) anon4_correct)))))))))))
(let ((anon7_Then_correct  (=> (and (and ($Is refType |p#0@0| Tclass._module.MyClass) ($IsAlloc refType |p#0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0@0|)) (= |$_Frame#l0@0| (|lambda#0| null |$Heap_at_$lambdaHeap#0@0| alloc |p#0@0|))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (or (not (= |p#0@0| null)) (not true))) (=> (or (not (= |p#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 12)) ($IsAlloc refType |p#0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0@0|)) (=> ($IsAlloc refType |p#0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0@0|) (and (=> (= (ControlFlow 0 10) (- 0 11)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| |p#0@0| _module.MyClass.y))) (=> (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| |p#0@0| _module.MyClass.y)) (and (=> (= (ControlFlow 0 10) 4) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))))))))
(let ((anon7_Else_correct  (=> (and (not (and ($Is refType |p#0@0| Tclass._module.MyClass) ($IsAlloc refType |p#0@0| Tclass._module.MyClass |$Heap_at_$lambdaHeap#0@0|))) (= (ControlFlow 0 3) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (and ($IsGoodHeap |$Heap_at_$lambdaHeap#0@0|) (or (= $Heap@0 |$Heap_at_$lambdaHeap#0@0|) ($HeapSucc $Heap@0 |$Heap_at_$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 14) 10) anon7_Then_correct) (=> (= (ControlFlow 0 14) 3) anon7_Else_correct)))))
(let ((anon6_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc this)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 this _module.MyClass.y))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 this _module.MyClass.y)) (=> (= |$rhs#0@0| (LitInt 8)) (=> (and (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap this (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap this) _module.MyClass.y ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 15) 14) anon6_Then_correct) (=> (= (ControlFlow 0 15) 1) anon6_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.MyClass) ($IsAlloc refType this Tclass._module.MyClass $Heap)))) (=> (and (and (and ($Is HandleTypeType |h#0| (Tclass._System.___hFunc1 Tclass._module.MyClass TInt)) ($IsAlloc HandleTypeType |h#0| (Tclass._System.___hFunc1 Tclass._module.MyClass TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 15))) anon0_correct))))
