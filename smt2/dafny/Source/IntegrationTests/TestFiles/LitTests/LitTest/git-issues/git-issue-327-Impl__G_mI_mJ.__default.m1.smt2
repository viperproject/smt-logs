...
(declare-fun G_mH_mZ.__default.z () Int)
...
(assert ($Is intType (int_2_U G_mH_mZ.__default.z) TInt))
(assert (forall ((x@@5 T@U) (T@@1 T@T) ) (! (= ($Unbox T@@1 ($Box T@@1 x@@5)) x@@5)
 :qid |DafnyPreludebpl.167:18|
 :skolemid |1950|
 :pattern ( ($Box T@@1 x@@5))
)))
(assert (= G_mH_mZ.__default.z (LitInt 52)))
...
(set-info :boogie-vc-id Impl$$G_mI_mJ.__default.m1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= G_mH_mZ.__default.z (LitInt 52)))))
