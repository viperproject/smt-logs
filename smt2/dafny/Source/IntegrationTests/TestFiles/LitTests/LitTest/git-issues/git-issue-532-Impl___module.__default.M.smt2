...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon9_correct  (and (=> (= (ControlFlow 0 3) (- 0 10)) (or (and ($Is refType null Tclass._module.C) (|Set#IsMember| |s#0@0| ($Box refType null))) (exists ((|$as#c1_0#1_0| T@U) )  (and ($Is refType |$as#c1_0#1_0| Tclass._module.C) (|Set#IsMember| |s#0@0| ($Box refType |$as#c1_0#1_0|)))))) (=> (or (and ($Is refType null Tclass._module.C) (|Set#IsMember| |s#0@0| ($Box refType null))) (exists ((|$as#c1_0#1_0@@0| T@U) )  (and ($Is refType |$as#c1_0#1_0@@0| Tclass._module.C) (|Set#IsMember| |s#0@0| ($Box refType |$as#c1_0#1_0@@0|))))) (=> (and (=> true (and ($Is refType |c#1_0@0| Tclass._module.C) ($IsAlloc refType |c#1_0@0| Tclass._module.C $Heap))) (|Set#IsMember| |s#0@0| ($Box refType |c#1_0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 9)) true) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= |c#1_0@0| null)) (not true))) (and (=> (= (ControlFlow 0 3) (- 0 7)) true) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |c#1_0@0| null)) (not true))) (=> (or (not (= |c#1_0@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#1_0@0| _module.C.y))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#1_0@0| _module.C.y)) (and (=> (= (ControlFlow 0 3) (- 0 4)) true) (=> (= (ControlFlow 0 3) (- 0 2)) (or (not (= |c#1_0@0| null)) (not true))))))))))))))))
