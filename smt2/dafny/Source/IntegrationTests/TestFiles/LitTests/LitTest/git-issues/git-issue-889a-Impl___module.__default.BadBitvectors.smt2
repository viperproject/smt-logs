...
(set-info :boogie-vc-id Impl$$_module.__default.BadBitvectors)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |v#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U (bvsub #x00 #x01))))) (= (ControlFlow 0 2) (- 0 1))) (= |v#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x01))))))))
