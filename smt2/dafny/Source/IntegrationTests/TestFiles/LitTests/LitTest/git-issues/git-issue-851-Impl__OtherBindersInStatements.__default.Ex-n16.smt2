...
(set-info :boogie-vc-id Impl$$OtherBindersInStatements.__default.Exists)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (= |b#0@0| (exists ((|c#0@@3| T@U) ) (!  (and (and ($Is refType |c#0@@3| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@@3| Tclass.OtherBindersInStatements.C $Heap)) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))
 :qid |gitissue851dfy.156:21|
 :skolemid |2956|
