...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Result.Failure_q |r#0@2|)) (=> (_module.Result.Failure_q |r#0@2|) (=> (= (ControlFlow 0 2) (- 0 1)) (= |out#0@0| (LitInt (- 0 2))))))))
(let ((anon13_Else_correct  (=> (and (not (_module.Result.IsFailure TInt |call2formal@r#0@0|)) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (_module.Result.Success_q |call2formal@r#0@0|)) (=> (and (and (and (_module.Result.Success_q |call2formal@r#0@0|) (|_module.Result.Extract#canCall| TInt |call2formal@r#0@0|)) (and (|_module.Result.Extract#canCall| TInt |call2formal@r#0@0|) (= |rr#0@1| (U_2_int ($Unbox intType (_module.Result.Extract TInt |call2formal@r#0@0|)))))) (and (and (= |$rhs#0@0| (|#_module.Result.Success| ($Box intType (int_2_U |call3formal@o#0@0|)))) (= |r#0@2| |$rhs#0@0|)) (and (= |out#0@0| |call3formal@o#0@0@@0|) (= (ControlFlow 0 8) 2)))) GeneratedUnifiedExit_correct)))))
(let ((anon13_Then_correct  (=> (and (_module.Result.IsFailure TInt |call2formal@r#0@0|) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (_module.Result.Failure_q |call2formal@r#0@0|)) (=> (_module.Result.Failure_q |call2formal@r#0@0|) (=> (and (|_module.Result.PropagateFailure#canCall| TInt TInt |call2formal@r#0@0|) (|_module.Result.PropagateFailure#canCall| TInt TInt |call2formal@r#0@0|)) (=> (and (and (= |r#0@1| (_module.Result.PropagateFailure TInt TInt |call2formal@r#0@0|)) (= |r#0@2| |r#0@1|)) (and (= |out#0@0| |call3formal@o#0@0@@0|) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (= |t#0@0| (LitInt 1))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= |call3formal@o#0@0| (LitInt 2))) (=> (and (= |t#0@0| (LitInt 1)) (= |call3formal@o#0@0| (LitInt 2))) (=> (and (and (and ($Is DatatypeTypeType |valueOrError1#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError1#0@0| (Tclass._module.Result TInt) $Heap@0)) (= |i##1@0| (LitInt (- 0 1)))) (and (and ($Is DatatypeTypeType |call2formal@r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0| (Tclass._module.Result TInt) $Heap@@1)) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (=> (and (and (and (and ($Is DatatypeTypeType |call2formal@r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0@0| (Tclass._module.Result TInt) $Heap@1)) (=> (<= (LitInt 0) |i##1@0|) (=> (_module.Result.Success_q |call2formal@r#0@0|) (|_module.Result.Extract#canCall| TInt |call2formal@r#0@0|)))) (and (=> (<= (LitInt 0) |i##1@0|) (_module.Result.Success_q |call2formal@r#0@0|)) (=> (<= (LitInt 0) |i##1@0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |call2formal@r#0@0|))) |i##1@0|)))) (and (and (and (=> (<= (LitInt 0) |i##1@0|) (= |call3formal@o#0@0@@0| (+ |i##1@0| |i##1@0|))) (=> (< |i##1@0| 0) (_module.Result.Failure_q |call2formal@r#0@0|))) (and (=> (< |i##1@0| 0) (= |call3formal@o#0@0@@0| (+ |i##1@0| |i##1@0|))) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0)))
 :qid |gitissue446dfy.41:8|
 :skolemid |493|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@0))
)))) (and (and ($HeapSucc $Heap@0 $Heap@1) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1)) (and (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0|) (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0|))))) (and (=> (= (ControlFlow 0 10) 6) anon13_Then_correct) (=> (= (ControlFlow 0 10) 8) anon13_Else_correct)))))))))
(let ((anon12_Else_correct  (=> (and (or (not (= |t#0@0| (LitInt 1))) (not true)) (= (ControlFlow 0 14) 10)) anon6_correct)))
(let ((anon12_Then_correct  (=> (and (= |t#0@0| (LitInt 1)) (= (ControlFlow 0 13) 10)) anon6_correct)))
(let ((anon11_Else_correct  (=> (and (not (_module.Result.IsFailure TInt |call2formal@r#0@0@@0|)) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@0)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (_module.Result.Success_q |call2formal@r#0@0@@0|)) (=> (and (and (_module.Result.Success_q |call2formal@r#0@0@@0|) (|_module.Result.Extract#canCall| TInt |call2formal@r#0@0@@0|)) (and (|_module.Result.Extract#canCall| TInt |call2formal@r#0@0@@0|) (= |t#0@0| (U_2_int ($Unbox intType (_module.Result.Extract TInt |call2formal@r#0@0@@0|)))))) (and (=> (= (ControlFlow 0 15) 13) anon12_Then_correct) (=> (= (ControlFlow 0 15) 14) anon12_Else_correct)))))))
(let ((anon11_Then_correct  (=> (and (_module.Result.IsFailure TInt |call2formal@r#0@0@@0|) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (_module.Result.Failure_q |call2formal@r#0@0@@0|)) (=> (_module.Result.Failure_q |call2formal@r#0@0@@0|) (=> (and (|_module.Result.PropagateFailure#canCall| TInt TInt |call2formal@r#0@0@@0|) (|_module.Result.PropagateFailure#canCall| TInt TInt |call2formal@r#0@0@@0|)) (=> (and (and (= |r#0@0| (_module.Result.PropagateFailure TInt TInt |call2formal@r#0@0@@0|)) (= |r#0@2| |r#0@0|)) (and (= |out#0@0| |out#0|) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and ($Is DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt) $Heap@@1)) (= |i##0@0| (LitInt 1))) (and (and ($Is DatatypeTypeType |call2formal@r#0@@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0@@0| (Tclass._module.Result TInt) $Heap@@1)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (=> (and (and (and (and ($Is DatatypeTypeType |call2formal@r#0@0@@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0@0@@0| (Tclass._module.Result TInt) $Heap@0)) (=> (<= (LitInt 0) |i##0@0|) (=> (_module.Result.Success_q |call2formal@r#0@0@@0|) (|_module.Result.Extract#canCall| TInt |call2formal@r#0@0@@0|)))) (and (=> (<= (LitInt 0) |i##0@0|) (_module.Result.Success_q |call2formal@r#0@0@@0|)) (=> (<= (LitInt 0) |i##0@0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |call2formal@r#0@0@@0|))) |i##0@0|)))) (and (and (and (=> (<= (LitInt 0) |i##0@0|) (= |call3formal@o#0@0| (+ |i##0@0| |i##0@0|))) (=> (< |i##0@0| 0) (_module.Result.Failure_q |call2formal@r#0@0@@0|))) (and (=> (< |i##0@0| 0) (= |call3formal@o#0@0| (+ |i##0@0| |i##0@0|))) (forall (($o@@1 T@U) ) (!  (=> (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@1) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@1) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@1)))
 :qid |gitissue446dfy.41:8|
 :skolemid |493|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@1))
)))) (and (and ($HeapSucc $Heap@@1 $Heap@0) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@0)) (and (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0@@0|) (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0@@0|))))) (and (=> (= (ControlFlow 0 17) 4) anon11_Then_correct) (=> (= (ControlFlow 0 17) 15) anon11_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@1))) (and (and ($Is DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt) $Heap@@1)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError1#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError1#0| (Tclass._module.Result TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 18) 17)))) anon0_correct)))
