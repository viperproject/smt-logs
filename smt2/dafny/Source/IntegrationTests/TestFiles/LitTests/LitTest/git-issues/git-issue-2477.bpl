// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2477.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2477-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2477.dfy
...
// function declaration for _module.T.P
function _module.T.P($heap: Heap, this: ref) : bool;

function _module.T.P#canCall($heap: Heap, this: ref) : bool;
...
// frame axiom for _module.T.P
axiom (forall $h0: Heap, $h1: Heap, this: ref :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), _module.T.P($h1, this) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && 
      this != null
    ...
    (forall $o: ref, $f: Field :: 
     ...
     ==> _module.T.P($h0, this) == _module.T.P($h1, this));

function _module.T.P#requires(Heap, ref) : bool;

// #requires axiom for _module.T.P
axiom (forall $Heap: Heap, this: ref :: 
  { _module.T.P#requires($Heap, this), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap)
       && 
      this != null
       && 
     ...
     ==> _module.T.P#requires($Heap, this) == true);

procedure {:verboseName "T.P (well-formedness)"} CheckWellformed$$_module.T.P(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.T())
         && $IsAlloc(this, Tclass._module.T(), $Heap));
...
function _module.C.P(this: ref) : bool
uses {
// definition axiom for _module.C.P (revealed)
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall this: ref :: 
    { _module.C.P(this) } 
    _module.C.P#canCall(this)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass._module.C()))
       ==> _module.C.P(this) == Lit(true));
// definition axiom for _module.C.P for all literals (revealed)
axiom {:id "id1"} 0 <= $FunctionContextHeight
   ==> (forall this: ref :: 
    {:weight 3} { _module.C.P(Lit(this)) } 
    _module.C.P#canCall(Lit(this))
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass._module.C()))
       ==> _module.C.P(Lit(this)) == Lit(true));
}

function _module.C.P#canCall(this: ref) : bool;
...
function _module.C.P#requires(ref) : bool;

// #requires axiom for _module.C.P
axiom (forall this: ref :: 
  { _module.C.P#requires(this) } 
  this != null && $Is(this, Tclass._module.C())
     ==> _module.C.P#requires(this) == true);

// override axiom for _module.T.P in class _module.C
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, this: ref :: 
    { _module.T.P($Heap, this), $Is(this, Tclass._module.C()), $IsGoodHeap($Heap) } 
      { _module.T.P($Heap, this), _module.C.P(this), $IsGoodHeap($Heap) } 
    _module.C.P#canCall(this)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass._module.C()))
       ==> _module.T.P($Heap, this) == _module.C.P(this));

procedure {:verboseName "C.P (well-formedness)"} CheckWellformed$$_module.C.P(this: ref
       where this != null
         && 
...
procedure {:verboseName "C.P (override check)"} OverrideCheck$$_module.C.P(this: ref
       where this != null
         && 
        $Is(this, Tclass._module.C())
         && $IsAlloc(this, Tclass._module.C(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "C.P (override check)"} OverrideCheck$$_module.C.P(this: ref)
{
