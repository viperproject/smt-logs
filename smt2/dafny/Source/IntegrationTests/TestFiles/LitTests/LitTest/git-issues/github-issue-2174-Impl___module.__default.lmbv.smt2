...
(declare-fun $generated@@84 () (_ BitVec 16))
(declare-fun $generated@@85 () (_ BitVec 32))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@89  (=> (and (= $generated@@80 ($generated@@24 $generated@@81 $generated@@82 $generated@@83 false)) (= (ControlFlow 0 2) (- 0 1))) (= (bvshl (concat #x0000 $generated@@84) (concat #b00000000000000000000000000 ((_ extract 5 0) $generated@@85))) (concat #x0000 (bvshl $generated@@84 (concat #b00000000000 ((_ extract 4 0) $generated@@85))))))))
(let (($generated@@90  (=> (and (and (and ($generated@@86 $generated@@82) ($generated@@87 $generated@@82)) (and (= 0 $generated@@88) (bvule #x00000000 $generated@@85))) (and (and (bvule $generated@@85 #x00000008) (bvule #x0000 $generated@@84)) (and (bvult $generated@@84 (bvshl #x0001 (concat #b00000000000 #b01000))) (= (ControlFlow 0 3) 2)))) $generated@@89)))
$generated@@90)))
))
(check-sat)
(get-info :rlimit)
