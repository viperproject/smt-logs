...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon6_correct  (=> (and (and (and (= |##n#1@0| (ite (< |n#0@@5| 0) 0 |n#0@@5|)) ($IsAlloc intType (int_2_U |##n#1@0|) Tclass._System.nat $Heap@0)) (and (|_module.__default.ToNumber#canCall| (ite (< |n#0@@5| 0) 0 |n#0@@5|)) (= |##num#0@0| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))))) (and (and ($IsAlloc DatatypeTypeType |##num#0@0| Tclass._module.Number $Heap@0) (|_module.__default.GreatestManualNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|)))) (and (|_module.__default.ToNumber#canCall| (ite (< |n#0@@5| 0) 0 |n#0@@5|)) (|_module.__default.GreatestManualNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.GreatestManualNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (or (_module.__default.GreatestManualNat ($LS $LZ) |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (=> (= |k#0@@4| (LitInt 0)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.GreatestManualNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (or (_module.__default.GreatestManualNat ($LS $LZ) |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (=> (or (not (= |k#0@@4| (LitInt 0))) (not true)) (=> (_module.Number.Succ_q (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (let ((|prev#0@@0| (_module.Number.prev (_module.__default.ToNumber ($LS ($LS $LZ)) (ite (< |n#0@@5| 0) 0 |n#0@@5|)))))
(_module.__default.GreatestManualNat ($LS ($LS $LZ)) (- |k#0@@4| 1) |prev#0@@0|))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.GreatestManualNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (or (_module.__default.GreatestManualNat ($LS $LZ) |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (=> (or (not (= |k#0@@4| (LitInt 0))) (not true)) (=> (not (_module.Number.Succ_q (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|)))) (U_2_bool (Lit boolType (bool_2_U true)))))))))))))
(let ((anon8_Else_correct  (=> (<= 0 |n#0@@5|) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($Is intType (int_2_U |n#0@@5|) Tclass._System.nat)) (=> ($Is intType (int_2_U |n#0@@5|) Tclass._System.nat) (=> (= (ControlFlow 0 7) 2) anon6_correct))))))
(let ((anon8_Then_correct  (=> (< |n#0@@5| 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= (ControlFlow 0 5) 2) anon6_correct))))))
...
(_module.__default.GreatestManualNat ($LS $LZ) (- |k#0@@4| 1) |prev#3@@1|)) true)))) (|_module.__default.RicochetNat#canCall| |k#0@@4| |num##0@0|)) (and (and (|_module.__default.RicochetNat#canCall| |k#0@@4| |num##0@0|) (and (_module.__default.RicochetNat |k#0@@4| |num##0@0|) (_module.__default.GreatestPredNat_h ($LS $LZ) |k#0@@4| |num##0@0|))) (and (= $Heap $Heap@0) ($IsAlloc intType (int_2_U |k#0@@4|) Tclass._System.nat $Heap@0))))) (and (=> (= (ControlFlow 0 9) 5) anon8_Then_correct) (=> (= (ControlFlow 0 9) 7) anon8_Else_correct)))))))
(let ((anon7_Else_correct  (=> (<= 0 |n#0@@5|) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($Is intType (int_2_U |n#0@@5|) Tclass._System.nat)) (=> ($Is intType (int_2_U |n#0@@5|) Tclass._System.nat) (=> (= (ControlFlow 0 12) 9) anon3_correct))))))
(let ((anon7_Then_correct  (=> (< |n#0@@5| 0) (and (=> (= (ControlFlow 0 10) (- 0 11)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= (ControlFlow 0 10) 9) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 14) 10) anon7_Then_correct) (=> (= (ControlFlow 0 14) 12) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |k#0@@4|)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct)))
