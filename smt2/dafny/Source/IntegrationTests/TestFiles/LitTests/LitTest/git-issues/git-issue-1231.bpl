// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1231.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1231-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1231.dfy
...
// Constructor function declaration
function #_module.Dt.Dt(int) : DatatypeType;

const unique ##_module.Dt.Dt: DtCtorId
uses {
// Constructor identifier
axiom (forall a#12#0#0: int :: 
  { #_module.Dt.Dt(a#12#0#0) } 
  DatatypeCtorId(#_module.Dt.Dt(a#12#0#0)) == ##_module.Dt.Dt);
}
...
axiom (forall d: DatatypeType :: 
  { _module.Dt.Dt_q(d) } 
  _module.Dt.Dt_q(d) ==> (exists a#13#0#0: int :: d == #_module.Dt.Dt(a#13#0#0)));
...
axiom (forall a#14#0#0: int :: 
  { $Is(#_module.Dt.Dt(a#14#0#0), Tclass._module.Dt()) } 
  $Is(#_module.Dt.Dt(a#14#0#0), Tclass._module.Dt()) <==> $Is(a#14#0#0, TInt));
...
axiom (forall a#15#0#0: int :: 
  { #_module.Dt.Dt(LitInt(a#15#0#0)) } 
  #_module.Dt.Dt(LitInt(a#15#0#0)) == Lit(#_module.Dt.Dt(a#15#0#0)));

function _module.Dt.x(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#16#0#0: int :: 
  { #_module.Dt.Dt(a#16#0#0) } 
  _module.Dt.x(#_module.Dt.Dt(a#16#0#0)) == a#16#0#0);
...
axiom (forall a: DatatypeType, b: DatatypeType :: 
  ...
  _module.Dt#Equal(a, b) <==> _module.Dt.x(a) == _module.Dt.x(b));
...
procedure {:verboseName "Dt.DatatypeTest (well-formedness)"} {:timeLimit 50} CheckWellFormed$$_module.Dt.DatatypeTest(this: DatatypeType
...
procedure {:verboseName "Dt.DatatypeTest (call)"} {:timeLimit 50} Call$$_module.Dt.DatatypeTest(this: DatatypeType
       where $Is(this, Tclass._module.Dt()) && $IsAlloc(this, Tclass._module.Dt(), $Heap), 
    y#0: int);
  modifies $Heap;
...
procedure {:verboseName "Dt.DatatypeTest (correctness)"} {:timeLimit 50} Impl$$_module.Dt.DatatypeTest(this: DatatypeType
       where $Is(this, Tclass._module.Dt()) && $IsAlloc(this, Tclass._module.Dt(), $Heap), 
    y#0: int)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Dt.DatatypeTest (correctness)"} {:timeLimit 50} Impl$$_module.Dt.DatatypeTest(this: DatatypeType, y#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var z#0: int;

    // AddMethodImpl: DatatypeTest, Impl$$_module.Dt.DatatypeTest
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1231.dfy(7,11)
    assume true;
    assume true;
    z#0 := y#0;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1231.dfy(8,5)
    assume true;
    assert {:id "id1"} z#0 == y#0;
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Even (well-formedness)"} CheckWellFormed$$_module.Even(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id3"} Mod(x#0, LitInt(2)) == LitInt(0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id4"} LitInt(Mod(0, LitInt(2))) == LitInt(0);
        assume false;
    }
}
...
procedure {:verboseName "Even.NewtypeTest (well-formedness)"} {:timeLimit 40} CheckWellFormed$$_module.Even.NewtypeTest(this: int where Mod(this, LitInt(2)) == LitInt(0), y#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Even.NewtypeTest (call)"} {:timeLimit 40} Call$$_module.Even.NewtypeTest(this: int where Mod(this, LitInt(2)) == LitInt(0), y#0: int);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "Even.NewtypeTest (correctness)"} {:timeLimit 40} Impl$$_module.Even.NewtypeTest(this: int where Mod(this, LitInt(2)) == LitInt(0), y#0: int)
   returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Even.NewtypeTest (correctness)"} {:timeLimit 40} Impl$$_module.Even.NewtypeTest(this: int, y#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: NewtypeTest, Impl$$_module.Even.NewtypeTest
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1231.dfy(15,5)
    assume true;
    assert {:id "id5"} y#0 == y#0;
}
...
axiom (forall a#0#0#0: Box, a#0#1#0: DatatypeType :: 
  { #_module.Stream.More(a#0#0#0, a#0#1#0) } 
  DatatypeCtorId(#_module.Stream.More(a#0#0#0, a#0#1#0)) == ##_module.Stream.More);
}
...
axiom (forall d: DatatypeType :: 
  ...
  _module.Stream.More_q(d)
     ==> (exists a#1#0#0: Box, a#1#1#0: DatatypeType :: 
      d == #_module.Stream.More(a#1#0#0, a#1#1#0)));
...
axiom (forall _module.Stream$T: Ty, a#2#0#0: Box, a#2#1#0: DatatypeType :: 
  { $Is(#_module.Stream.More(a#2#0#0, a#2#1#0), Tclass._module.Stream(_module.Stream$T)) } 
  $Is(#_module.Stream.More(a#2#0#0, a#2#1#0), Tclass._module.Stream(_module.Stream$T))
...
axiom (forall _module.Stream$T: Ty, a#2#0#0: Box, a#2#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#_module.Stream.More(a#2#0#0, a#2#1#0), 
      Tclass._module.Stream(_module.Stream$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Stream.More(a#2#0#0, a#2#1#0), 
...
// Destructor $IsAlloc
axiom (forall d: DatatypeType, _module.Stream$T: Ty, $h: Heap :: 
  { $IsAlloc(_module.Stream.rest(d), Tclass._module.Stream(_module.Stream$T), $h) } 
  $IsGoodHeap($h)
       && 
      _module.Stream.More_q(d)
       && $IsAlloc(d, Tclass._module.Stream(_module.Stream$T), $h)
...
axiom (forall a#3#0#0: Box, a#3#1#0: DatatypeType :: 
  { #_module.Stream.More(a#3#0#0, a#3#1#0) } 
  _module.Stream.head(#_module.Stream.More(a#3#0#0, a#3#1#0)) == a#3#0#0);

function _module.Stream.rest(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#4#0#0: Box, a#4#1#0: DatatypeType :: 
  { #_module.Stream.More(a#4#0#0, a#4#1#0) } 
  _module.Stream.rest(#_module.Stream.More(a#4#0#0, a#4#1#0)) == a#4#1#0);
...
axiom (forall _module.Stream$T: Ty, d: DatatypeType :: 
  { _module.Stream.More_q(d), $Is(d, Tclass._module.Stream(_module.Stream$T)) } 
  $Is(d, Tclass._module.Stream(_module.Stream$T)) ==> _module.Stream.More_q(d));
         ...
         && (_module.Stream.More_q(d0) && _module.Stream.More_q(d1)
           ==> _module.Stream.head(d0) == _module.Stream.head(d1)
             && $Eq#_module.Stream(_module.Stream$T#l, 
              _module.Stream$T#r, 
              ly, 
              _module.Stream.rest(d0), 
              _module.Stream.rest(d1)))));
...
procedure {:verboseName "Stream.CodatatypeTest (well-formedness)"} {:timeLimit 30} CheckWellFormed$$_module.Stream.CodatatypeTest(_module.Stream$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass._module.Stream(_module.Stream$T))
         && $IsAlloc(this, Tclass._module.Stream(_module.Stream$T), $Heap), 
    y#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "Stream.CodatatypeTest (call)"} {:timeLimit 30} Call$$_module.Stream.CodatatypeTest(_module.Stream$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass._module.Stream(_module.Stream$T))
         && $IsAlloc(this, Tclass._module.Stream(_module.Stream$T), $Heap), 
    y#0: int);
...
procedure {:verboseName "Stream.CodatatypeTest (correctness)"} {:timeLimit 30} Impl$$_module.Stream.CodatatypeTest(_module.Stream$T: Ty, 
    this: DatatypeType
       where $Is(this, Tclass._module.Stream(_module.Stream$T))
         && $IsAlloc(this, Tclass._module.Stream(_module.Stream$T), $Heap), 
    y#0: int)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Stream.CodatatypeTest (correctness)"} {:timeLimit 30} Impl$$_module.Stream.CodatatypeTest(_module.Stream$T: Ty, this: DatatypeType, y#0: int)
   returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: CodatatypeTest, Impl$$_module.Stream.CodatatypeTest
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1231.dfy(22,5)
    assume true;
    assert {:id "id6"} y#0 == y#0;
}
