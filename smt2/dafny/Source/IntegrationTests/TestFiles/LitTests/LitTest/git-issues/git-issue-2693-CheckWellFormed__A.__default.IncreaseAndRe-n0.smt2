...
(set-info :boogie-vc-id CheckWellFormed$$A.__default.IncreaseAndReturn)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc |c#0@@1|)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)) (= $o@@4 |c#0@@1|)))
 :qid |gitissue2693dfy.43:10|
 :skolemid |488|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0)) (and ($Is refType |r#0@0| Tclass.A.EvenGood__OddBad) ($IsAlloc refType |r#0@0| Tclass.A.EvenGood__OddBad $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#0@@1| Tclass.A.EvenGood__OddBad $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass.A.EvenGood__OddBad $Heap) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |c#0@@1| null)) (not true))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |c#0@@1| Tclass.A.EvenGood__OddBad) ($IsAlloc refType |c#0@@1| Tclass.A.EvenGood__OddBad $Heap))) (and (and ($Is refType |r#0| Tclass.A.EvenGood__OddBad) ($IsAlloc refType |r#0| Tclass.A.EvenGood__OddBad $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))
