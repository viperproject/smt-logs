...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@31 T@U) (|os#0@@5| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@12 this@@31 |os#0@@5|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@12) (and (or (not (= this@@31 null)) (not true)) (and ($Is refType this@@31 Tclass._module.Memory) ($IsAlloc refType this@@31 Tclass._module.Memory $Heap@@12)))) (and ($Is SetType |os#0@@5| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@5| (TSet Tclass._module.Object) $Heap@@12))))) (and (and (forall ((|edge#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |edge#0| Tclass._module.Edge) (|Set#IsMember| (_module.Memory.edges $Heap@@12 this@@31 |os#0@@5|) ($Box DatatypeTypeType |edge#0|))) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|))) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@12 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|)))) (_module.Edge.t |edge#0|))))
 :qid |gitissue3855dfy.258:20|
 :skolemid |916|
 :pattern ( (_module.Edge.t |edge#0|))
 :pattern ( (_module.Edge.f |edge#0|))
 :pattern ( (_module.Edge.n |edge#0|))
 :pattern ( (|Set#IsMember| (_module.Memory.edges $Heap@@12 this@@31 |os#0@@5|) ($Box DatatypeTypeType |edge#0|)))
)) (=> (|Set#Equal| |os#0@@5| |Set#Empty|) (|Set#Equal| (_module.Memory.edges $Heap@@12 this@@31 |os#0@@5|) |Set#Empty|))) ($Is SetType (_module.Memory.edges $Heap@@12 this@@31 |os#0@@5|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |917|
 :pattern ( (_module.Memory.edges $Heap@@12 this@@31 |os#0@@5|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@32 T@U) ) (!  (=> (or (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@13 this@@32) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@13) (and (or (not (= this@@32 null)) (not true)) (and ($Is refType this@@32 Tclass._module.Object) ($IsAlloc refType this@@32 Tclass._module.Object $Heap@@13)))))) (= (_module.Object.AllFieldsAreDeclared $Heap@@13 this@@32) (|Set#Subset| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@13 this@@32) _module.Object.fields))) (|Map#Domain| (_module.Object.fieldModes this@@32)))))
 :qid |gitissue3855dfy.120:13|
 :skolemid |778|
 :pattern ( (_module.Object.AllFieldsAreDeclared $Heap@@13 this@@32) ($IsGoodHeap $Heap@@13))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@33 T@U) (|os#0@@6| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@14 this@@33 |os#0@@6|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.Memory) ($IsAlloc refType this@@33 Tclass._module.Memory $Heap@@14)))) ($Is SetType |os#0@@6| (TSet Tclass._module.Object))))) (= (_module.Memory.justTheIsos $Heap@@14 this@@33 |os#0@@6|) (|Set#FromBoogieMap| (|lambda#38| Tclass._module.Object |os#0@@6|))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |893|
 :pattern ( (_module.Memory.justTheIsos $Heap@@14 this@@33 |os#0@@6|) ($IsGoodHeap $Heap@@14))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@34 T@U) ) (!  (=> (or (|_module.Object.outgoing#canCall| $Heap@@15 this@@34) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@15) (or (not (= this@@34 null)) (not true))) ($IsAlloc refType this@@34 Tclass._module.Object $Heap@@15)))) ($IsAlloc SetType (_module.Object.outgoing $Heap@@15 this@@34) (TSet Tclass._module.Object) $Heap@@15))
 :qid |gitissue3855dfy.106:12|
 :skolemid |753|
 :pattern ( ($IsAlloc SetType (_module.Object.outgoing $Heap@@15 this@@34) (TSet Tclass._module.Object) $Heap@@15))
))))
...
(assert (forall (($h0@@5 T@U) ($h1@@5 T@U) (this@@35 T@U) (|os#0@@7| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.Memory))) (or (|_module.Memory.ObjectsAreValid#canCall| $h0@@5 this@@35 |os#0@@7|) ($Is SetType |os#0@@7| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@17 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (|Set#IsMember| |os#0@@7| ($Box refType $o@@17))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@17) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@17) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |851|
)) (= (_module.Memory.ObjectsAreValid $h0@@5 this@@35 |os#0@@7|) (_module.Memory.ObjectsAreValid $h1@@5 this@@35 |os#0@@7|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |852|
 :pattern ( ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5) (_module.Memory.ObjectsAreValid $h1@@5 this@@35 |os#0@@7|))
)))
(assert (forall (($h0@@6 T@U) ($h1@@6 T@U) (this@@36 T@U) (|os#0@@8| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@6) ($IsGoodHeap $h1@@6)) (and (or (not (= this@@36 null)) (not true)) ($Is refType this@@36 Tclass._module.Memory))) (or (|_module.Memory.wholeEnchilada#canCall| $h0@@6 this@@36 |os#0@@8|) ($Is SetType |os#0@@8| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6))) (=> (forall (($o@@18 T@U) ($f@@6 T@U) ) (!  (=> (and (or (not (= $o@@18 null)) (not true)) (|Set#IsMember| |os#0@@8| ($Box refType $o@@18))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@6 $o@@18) $f@@6) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@6 $o@@18) $f@@6)))
 :qid |unknown.0:0|
 :skolemid |926|
)) (= (_module.Memory.wholeEnchilada $h0@@6 this@@36 |os#0@@8|) (_module.Memory.wholeEnchilada $h1@@6 this@@36 |os#0@@8|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |927|
 :pattern ( ($IsHeapAnchor $h0@@6) ($HeapSucc $h0@@6 $h1@@6) (_module.Memory.wholeEnchilada $h1@@6 this@@36 |os#0@@8|))
)))
(assert (forall (($h0@@7 T@U) ($h1@@7 T@U) (this@@37 T@U) (|os#0@@9| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@7) ($IsGoodHeap $h1@@7)) (and (or (not (= this@@37 null)) (not true)) ($Is refType this@@37 Tclass._module.Memory))) (or (|_module.Memory.heapExternalsZeroOrOne#canCall| $h0@@7 this@@37 |os#0@@9|) ($Is SetType |os#0@@9| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7))) (=> (forall (($o@@19 T@U) ($f@@7 T@U) ) (!  (=> (and (or (not (= $o@@19 null)) (not true)) (|Set#IsMember| |os#0@@9| ($Box refType $o@@19))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@7 $o@@19) $f@@7) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@7 $o@@19) $f@@7)))
 :qid |unknown.0:0|
 :skolemid |933|
)) (= (_module.Memory.heapExternalsZeroOrOne $h0@@7 this@@37 |os#0@@9|) (_module.Memory.heapExternalsZeroOrOne $h1@@7 this@@37 |os#0@@9|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |934|
 :pattern ( ($IsHeapAnchor $h0@@7) ($HeapSucc $h0@@7 $h1@@7) (_module.Memory.heapExternalsZeroOrOne $h1@@7 this@@37 |os#0@@9|))
)))
(assert (forall (($h0@@8 T@U) ($h1@@8 T@U) (this@@38 T@U) (|os#0@@10| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@38 null)) (not true)) ($Is refType this@@38 Tclass._module.Memory))) (or (|_module.Memory.isosRefCountZeroOrOne#canCall| $h0@@8 this@@38 |os#0@@10|) ($Is SetType |os#0@@10| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@20 T@U) ($f@@8 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (|Set#IsMember| |os#0@@10| ($Box refType $o@@20))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@20) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@20) $f@@8)))
 :qid |unknown.0:0|
 :skolemid |978|
)) (= (_module.Memory.isosRefCountZeroOrOne $h0@@8 this@@38 |os#0@@10|) (_module.Memory.isosRefCountZeroOrOne $h1@@8 this@@38 |os#0@@10|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |979|
 :pattern ( ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8) (_module.Memory.isosRefCountZeroOrOne $h1@@8 this@@38 |os#0@@10|))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@39 T@U) (|edges#0@@12| T@U) ) (!  (=> (and (or (|_module.Memory.justHeapExternalEdges#canCall| this@@39 |edges#0@@12|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@39 null)) (not true)) ($IsAlloc refType this@@39 Tclass._module.Memory $Heap@@16)) (and ($Is SetType |edges#0@@12| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@12| (TSet Tclass._module.Edge) $Heap@@16))))) ($IsGoodHeap $Heap@@16)) ($IsAlloc SetType (_module.Memory.justHeapExternalEdges this@@39 |edges#0@@12|) (TSet Tclass._module.Edge) $Heap@@16))
 :qid |gitissue3855dfy.345:12|
 :skolemid |1010|
 :pattern ( ($IsAlloc SetType (_module.Memory.justHeapExternalEdges this@@39 |edges#0@@12|) (TSet Tclass._module.Edge) $Heap@@16))
))))
...
(assert (forall (($h0@@9 T@U) ($h1@@9 T@U) (this@@40 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@9) ($IsGoodHeap $h1@@9)) (and (or (not (= this@@40 null)) (not true)) ($Is refType this@@40 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9))) (=> (forall (($o@@21 T@U) ($f@@9 T@U) ) (!  (=> (and (or (not (= $o@@21 null)) (not true)) (and (= $o@@21 this@@40) (= $f@@9 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@21) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@9 $o@@21) $f@@9)))
 :qid |unknown.0:0|
 :skolemid |750|
)) (= (_module.Object.outgoing $h0@@9 this@@40) (_module.Object.outgoing $h1@@9 this@@40))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |751|
 :pattern ( ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9) (_module.Object.outgoing $h1@@9 this@@40))
)))
(assert (forall (($h0@@10 T@U) ($h1@@10 T@U) (this@@41 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@41 null)) (not true)) ($Is refType this@@41 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@22 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (and (= $o@@22 this@@41) (= $f@@10 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@22) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@22) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |760|
)) (= (_module.Object.size $h0@@10 this@@41) (_module.Object.size $h1@@10 this@@41))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |761|
 :pattern ( ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10) (_module.Object.size $h1@@10 this@@41))
)))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@42 T@U) (|os#0@@11| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOne#canCall| $Heap@@17 this@@42 |os#0@@11|) (and (< 5 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@42 null)) (not true)) (and ($Is refType this@@42 Tclass._module.Memory) ($IsAlloc refType this@@42 Tclass._module.Memory $Heap@@17)))) ($Is SetType |os#0@@11| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@17 this@@42 |os#0@@11|) (let ((|edges#0@@13| (_module.Memory.edges $Heap@@17 this@@42 |os#0@@11|)))
(|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@42 |edges#0@@13|))) (= (_module.Memory.heapExternalsZeroOrOne $Heap@@17 this@@42 |os#0@@11|) (let ((|edges#0@@14| (_module.Memory.edges $Heap@@17 this@@42 |os#0@@11|)))
(_module.Memory.heapExternalsZeroOrOneEdges this@@42 |edges#0@@14|)))))
 :qid |gitissue3855dfy.273:13|
 :skolemid |937|
 :pattern ( (_module.Memory.heapExternalsZeroOrOne $Heap@@17 this@@42 |os#0@@11|) ($IsGoodHeap $Heap@@17))
))))
...
(assert (forall (($h0@@11 T@U) ($h1@@11 T@U) (this@@43 T@U) (|os#0@@12| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@43 null)) (not true)) ($Is refType this@@43 Tclass._module.Memory))) (or (|_module.Memory.justTheIsos#canCall| $h0@@11 this@@43 |os#0@@12|) ($Is SetType |os#0@@12| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@23 T@U) ($f@@11 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (|Set#IsMember| |os#0@@12| ($Box refType $o@@23))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@23) $f@@11) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@23) $f@@11)))
 :qid |unknown.0:0|
 :skolemid |886|
)) (= (_module.Memory.justTheIsos $h0@@11 this@@43 |os#0@@12|) (_module.Memory.justTheIsos $h1@@11 this@@43 |os#0@@12|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |887|
 :pattern ( ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11) (_module.Memory.justTheIsos $h1@@11 this@@43 |os#0@@12|))
)))
(assert (forall (($h0@@12 T@U) ($h1@@12 T@U) (this@@44 T@U) (|os#0@@13| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@12) ($IsGoodHeap $h1@@12)) (and (or (not (= this@@44 null)) (not true)) ($Is refType this@@44 Tclass._module.Memory))) (or (|_module.Memory.edges#canCall| $h0@@12 this@@44 |os#0@@13|) ($Is SetType |os#0@@13| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12))) (=> (forall (($o@@24 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (|Set#IsMember| |os#0@@13| ($Box refType $o@@24))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@12 $o@@24) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@12 $o@@24) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |914|
)) (= (_module.Memory.edges $h0@@12 this@@44 |os#0@@13|) (_module.Memory.edges $h1@@12 this@@44 |os#0@@13|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |915|
 :pattern ( ($IsHeapAnchor $h0@@12) ($HeapSucc $h0@@12 $h1@@12) (_module.Memory.edges $h1@@12 this@@44 |os#0@@13|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@45 T@U) (|t#0@@8| T@U) (|edges#0@@15| T@U) ) (!  (=> (and (or (|_module.Memory.incomingEdges#canCall| this@@45 |t#0@@8| |edges#0@@15|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@45 null)) (not true)) ($IsAlloc refType this@@45 Tclass._module.Memory $Heap@@18)) (and ($Is refType |t#0@@8| Tclass._module.Object) ($IsAlloc refType |t#0@@8| Tclass._module.Object $Heap@@18))) (and ($Is SetType |edges#0@@15| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@15| (TSet Tclass._module.Edge) $Heap@@18))))) ($IsGoodHeap $Heap@@18)) ($IsAlloc SetType (_module.Memory.incomingEdges this@@45 |t#0@@8| |edges#0@@15|) (TSet Tclass._module.Edge) $Heap@@18))
 :qid |gitissue3855dfy.245:12|
 :skolemid |899|
 :pattern ( ($IsAlloc SetType (_module.Memory.incomingEdges this@@45 |t#0@@8| |edges#0@@15|) (TSet Tclass._module.Edge) $Heap@@18))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@46 T@U) (|o#0@@8| T@U) (|edges#0@@16| T@U) ) (!  (=> (and (or (|_module.Memory.externalEdges#canCall| this@@46 |o#0@@8| |edges#0@@16|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@46 null)) (not true)) ($IsAlloc refType this@@46 Tclass._module.Memory $Heap@@19)) (and ($Is DatatypeTypeType |o#0@@8| Tclass._module.Region) ($IsAlloc DatatypeTypeType |o#0@@8| Tclass._module.Region $Heap@@19))) (and ($Is SetType |edges#0@@16| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@16| (TSet Tclass._module.Edge) $Heap@@19))))) ($IsGoodHeap $Heap@@19)) ($IsAlloc SetType (_module.Memory.externalEdges this@@46 |o#0@@8| |edges#0@@16|) (TSet Tclass._module.Edge) $Heap@@19))
 :qid |gitissue3855dfy.336:12|
 :skolemid |1000|
 :pattern ( ($IsAlloc SetType (_module.Memory.externalEdges this@@46 |o#0@@8| |edges#0@@16|) (TSet Tclass._module.Edge) $Heap@@19))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@47 T@U) (|t#0@@9| T@U) (|edges#0@@17| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@47 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@47 null)) (not true)) ($Is refType this@@47 Tclass._module.Memory)) ($Is refType |t#0@@9| Tclass._module.Object)) ($Is SetType |edges#0@@17| (TSet Tclass._module.Edge))))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@17|) ($Box DatatypeTypeType |e#1|)) (_module.Edge.Edge_q |e#1|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |903|
 :pattern ( (_module.Edge.t |e#1|))
 :pattern ( (|Set#IsMember| |edges#0@@17| ($Box DatatypeTypeType |e#1|)))
)) (= (_module.Memory.incomingEdges this@@47 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge (Lit SetType |edges#0@@17|) (Lit refType |t#0@@9|))))))
 :qid |gitissue3855dfy.245:12|
 :weight 3
 :skolemid |904|
 :pattern ( (_module.Memory.incomingEdges this@@47 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@48 T@U) (|edges#0@@18| T@U) ) (!  (=> (or (|_module.Memory.justHeapExternalEdges#canCall| this@@48 (Lit SetType |edges#0@@18|)) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@48 null)) (not true)) ($Is refType this@@48 Tclass._module.Memory)) ($Is SetType |edges#0@@18| (TSet Tclass._module.Edge))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@18|) ($Box DatatypeTypeType |e#1@@0|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#1@@0|))) (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#1@@0|)))) (and (_module.Edge.Edge_q |e#1@@0|) (_module.Edge.Edge_q |e#1@@0|))) (=> (not (|_module.Region#Equal| (_module.Object.region (_module.Edge.f |e#1@@0|)) (_module.Object.region (_module.Edge.t |e#1@@0|)))) (_module.Edge.Edge_q |e#1@@0|)))))
 :qid |gitissue3855dfy.348:9|
 :skolemid |1014|
 :pattern ( (_module.Edge.t |e#1@@0|))
 :pattern ( (_module.Edge.f |e#1@@0|))
 :pattern ( (|Set#IsMember| |edges#0@@18| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (_module.Memory.justHeapExternalEdges this@@48 (Lit SetType |edges#0@@18|)) (|Set#FromBoogieMap| (|lambda#76| Tclass._module.Edge (Lit SetType |edges#0@@18|))))))
 :qid |gitissue3855dfy.345:12|
 :weight 3
 :skolemid |1015|
 :pattern ( (_module.Memory.justHeapExternalEdges this@@48 (Lit SetType |edges#0@@18|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@49 T@U) (|o#0@@9| T@U) (|edges#0@@19| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| (Lit refType this@@49) (Lit DatatypeTypeType |o#0@@9|) (Lit SetType |edges#0@@19|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@49 null)) (not true)) ($Is refType this@@49 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@9| Tclass._module.Region)) ($Is SetType |edges#0@@19| (TSet Tclass._module.Edge))))) (and (forall ((|e#2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#2@@1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@19|) ($Box DatatypeTypeType |e#2@@1|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#2@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@9|))) (_module.Edge.Edge_q |e#2@@1|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#2@@1|)) |o#0@@9|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#2@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@9|))) (_module.Edge.Edge_q |e#2@@1|))))))
 :qid |gitissue3855dfy.339:9|
 :skolemid |1006|
 :pattern ( (_module.Edge.f |e#2@@1|))
 :pattern ( (_module.Edge.t |e#2@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@19| ($Box DatatypeTypeType |e#2@@1|)))
)) (= (_module.Memory.externalEdges (Lit refType this@@49) (Lit DatatypeTypeType |o#0@@9|) (Lit SetType |edges#0@@19|)) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge (Lit SetType |edges#0@@19|) |o#0@@9| |o#0@@9|)))))
 :qid |gitissue3855dfy.336:12|
 :weight 3
 :skolemid |1007|
 :pattern ( (_module.Memory.externalEdges (Lit refType this@@49) (Lit DatatypeTypeType |o#0@@9|) (Lit SetType |edges#0@@19|)))
))))
...
(assert (forall (($prevHeap@@2 T@U) ($h0@@13 T@U) ($h1@@13 T@U) (this@@50 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@13) ($IsGoodHeap $h1@@13)) (and (or (not (= this@@50 null)) (not true)) ($Is refType this@@50 Tclass._module.Memory))) (and ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13))) (=> (forall (($o@@25 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (or (or (and (= $o@@25 this@@50) (= $f@@13 _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 this@@50) _module.Memory.objects)) ($Box refType $o@@25))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 this@@50) _module.Memory.objects)) ($Box refType $o@@25)) (= $f@@13 _module.Object.fields)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@13 $o@@25) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@13 $o@@25) $f@@13)))
 :qid |unknown.0:0|
 :skolemid |878|
)) (= (_module.Memory.AllImmutablesAreImmutable $prevHeap@@2 $h0@@13 this@@50) (_module.Memory.AllImmutablesAreImmutable $prevHeap@@2 $h1@@13 this@@50))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |879|
 :pattern ( ($IsHeapAnchor $h0@@13) ($HeapSucc $h0@@13 $h1@@13) (_module.Memory.AllImmutablesAreImmutable $prevHeap@@2 $h1@@13 this@@50))
)))
...
)) (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.Object) (|Set#IsMember| |os#0@@14| ($Box refType |o#0@@10|))) (=> (_module.Region.Isolate_q (_module.Object.region |o#0@@10|)) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@20 this@@51 |os#0@@14|) ($Box refType |o#0@@10|))))
 :qid |gitissue3855dfy.238:20|
 :skolemid |889|
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@20 this@@51 |os#0@@14|) ($Box refType |o#0@@10|)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($prevHeap@@3 T@U) ($Heap@@21 T@U) (this@@52 T@U) ) (!  (=> (or (|_module.Memory.HeapObjectsAreMonotonic#canCall| $prevHeap@@3 $Heap@@21 this@@52) (and (< 0 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@3) ($IsGoodHeap $Heap@@21)) ($HeapSucc $prevHeap@@3 $Heap@@21)) (and (or (not (= this@@52 null)) (not true)) (and ($Is refType this@@52 Tclass._module.Memory) ($IsAlloc refType this@@52 Tclass._module.Memory $prevHeap@@3)))))) (= (_module.Memory.HeapObjectsAreMonotonic $prevHeap@@3 $Heap@@21 this@@52) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@3 this@@52) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@52) _module.Memory.objects)))))
 :qid |gitissue3855dfy.220:22|
 :skolemid |877|
 :pattern ( (_module.Memory.HeapObjectsAreMonotonic $prevHeap@@3 $Heap@@21 this@@52) ($IsGoodHeap $Heap@@21))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@22 T@U) (this@@54 T@U) (|os#0@@15| T@U) ) (!  (=> (or (|_module.Memory.isosRefCountZeroOrOne#canCall| $Heap@@22 this@@54 |os#0@@15|) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@22) (and (or (not (= this@@54 null)) (not true)) (and ($Is refType this@@54 Tclass._module.Memory) ($IsAlloc refType this@@54 Tclass._module.Memory $Heap@@22)))) ($Is SetType |os#0@@15| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@22 this@@54 |os#0@@15|) (let ((|edges#0@@21| (_module.Memory.edges $Heap@@22 this@@54 |os#0@@15|)))
 (and (|_module.Memory.justTheIsos#canCall| $Heap@@22 this@@54 |os#0@@15|) (let ((|isos#0| (_module.Memory.justTheIsos $Heap@@22 this@@54 |os#0@@15|)))
...
)))))) (= (_module.Memory.isosRefCountZeroOrOne $Heap@@22 this@@54 |os#0@@15|) (let ((|edges#0@@22| (_module.Memory.edges $Heap@@22 this@@54 |os#0@@15|)))
(let ((|isos#0@@0| (_module.Memory.justTheIsos $Heap@@22 this@@54 |os#0@@15|)))
(forall ((|i#0@@0| T@U) ) (!  (=> (and ($Is refType |i#0@@0| Tclass._module.Object) (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|))) (<= (_module.Memory.refCountEdges this@@54 |i#0@@0| |edges#0@@22|) (LitInt 1)))
 ...
 :skolemid |984|
 :pattern ( (_module.Memory.isosRefCountZeroOrOne $Heap@@22 this@@54 |os#0@@15|) ($IsGoodHeap $Heap@@22))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@23 T@U) (this@@55 T@U) ) (!  (=> (or (|_module.Object.Valid#canCall| $Heap@@23 this@@55) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@23) (and (or (not (= this@@55 null)) (not true)) (and ($Is refType this@@55 Tclass._module.Object) ($IsAlloc refType this@@55 Tclass._module.Object $Heap@@23)))))) (and (and (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@23 this@@55) (=> (_module.Object.AllFieldsAreDeclared $Heap@@23 this@@55) (and (|_module.Object.AllFieldsContentsConsistentWithTheirDeclaration#canCall| $Heap@@23 this@@55) (=> (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@23 this@@55) (|_module.Object.AllOutgoingReferencesAreVenice#canCall| $Heap@@23 this@@55))))) (= (_module.Object.Valid true $Heap@@23 this@@55)  (and (and (_module.Object.AllFieldsAreDeclared $Heap@@23 this@@55) (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@23 this@@55)) (_module.Object.AllOutgoingReferencesAreVenice $Heap@@23 this@@55)))))
 :qid |gitissue3855dfy.110:23|
 :skolemid |770|
 :pattern ( (_module.Object.Valid true $Heap@@23 this@@55) ($IsGoodHeap $Heap@@23))
))))
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($reveal@@1 Bool) ($prevHeap@@4 T@U) ($Heap@@24 T@U) (this@@56 T@U) ) (!  (=> (or (|_module.Memory.Valid2#canCall| $prevHeap@@4 $Heap@@24 this@@56) (and (< 8 $FunctionContextHeight) (and (and (and ($IsGoodHeap $prevHeap@@4) ($IsGoodHeap $Heap@@24)) ($HeapSucc $prevHeap@@4 $Heap@@24)) (and (or (not (= this@@56 null)) (not true)) (and ($Is refType this@@56 Tclass._module.Memory) ($IsAlloc refType this@@56 Tclass._module.Memory $prevHeap@@4)))))) (=> (_module.Memory.Valid2 reveal__module.Memory.Valid2 $prevHeap@@4 $Heap@@24 this@@56) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@24 this@@56)))
 :qid |gitissue3855dfy.192:51|
 :skolemid |844|
 :pattern ( (_module.Memory.Valid2 $reveal@@1 $prevHeap@@4 $Heap@@24 this@@56))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@25 T@U) (this@@57 T@U) (|os#0@@16| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@25 this@@57 |os#0@@16|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@25) (and (or (not (= this@@57 null)) (not true)) (and ($Is refType this@@57 Tclass._module.Memory) ($IsAlloc refType this@@57 Tclass._module.Memory $Heap@@25)))) ($Is SetType |os#0@@16| (TSet Tclass._module.Object))))) (= (_module.Memory.edges $Heap@@25 this@@57 |os#0@@16|) (|Set#FromBoogieMap| (|lambda#47| Tclass._module.Object (TSeq TChar) |os#0@@16| $Heap@@25 _module.Object.fields $Heap@@25 _module.Object.fields $Heap@@25 _module.Object.fields $Heap@@25 _module.Object.fields))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |921|
 :pattern ( (_module.Memory.edges $Heap@@25 this@@57 |os#0@@16|) ($IsGoodHeap $Heap@@25))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@58 T@U) (|t#0@@11| T@U) (|edges#0@@23| T@U) ) (!  (=> (or (|_module.Memory.refCountEdges#canCall| this@@58 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@58 null)) (not true)) ($Is refType this@@58 Tclass._module.Memory)) ($Is refType |t#0@@11| Tclass._module.Object)) ($Is SetType |edges#0@@23| (TSet Tclass._module.Edge))))) (and (|_module.Memory.incomingEdges#canCall| this@@58 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (= (_module.Memory.refCountEdges this@@58 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (|Set#Card| (_module.Memory.incomingEdges this@@58 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|))))))
 :qid |gitissue3855dfy.251:12|
 :weight 3
 :skolemid |911|
 :pattern ( (_module.Memory.refCountEdges this@@58 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)))
))))
...
(assert (forall (($reveal@@2 Bool) ($h0@@14 T@U) ($h1@@14 T@U) (this@@59 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@14) ($IsGoodHeap $h1@@14)) (and (or (not (= this@@59 null)) (not true)) ($Is refType this@@59 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14))) (=> (forall (($o@@27 T@U) ($f@@15 T@U) ) (!  (=> (and (or (not (= $o@@27 null)) (not true)) (and (= $o@@27 this@@59) (= $f@@15 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@14 $o@@27) $f@@15) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@14 $o@@27) $f@@15)))
 :qid |unknown.0:0|
 :skolemid |766|
)) (= (_module.Object.Valid $reveal@@2 $h0@@14 this@@59) (_module.Object.Valid $reveal@@2 $h1@@14 this@@59))))
 :qid |unknown.0:0|
 :skolemid |767|
 :pattern ( ($IsHeapAnchor $h0@@14) ($HeapSucc $h0@@14 $h1@@14) (_module.Object.Valid $reveal@@2 $h1@@14 this@@59))
)))
(assert (forall (($prevHeap@@5 T@U) ($h0@@15 T@U) ($h1@@15 T@U) (this@@60 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@15) ($IsGoodHeap $h1@@15)) (and (or (not (= this@@60 null)) (not true)) ($Is refType this@@60 Tclass._module.Memory))) (and ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15))) (=> (forall (($o@@28 T@U) ($f@@16 T@U) ) (!  (=> (and (or (not (= $o@@28 null)) (not true)) (and (= $o@@28 this@@60) (= $f@@16 _module.Memory.objects))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@15 $o@@28) $f@@16) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@15 $o@@28) $f@@16)))
 :qid |unknown.0:0|
 :skolemid |873|
)) (= (_module.Memory.HeapObjectsAreMonotonic $prevHeap@@5 $h0@@15 this@@60) (_module.Memory.HeapObjectsAreMonotonic $prevHeap@@5 $h1@@15 this@@60))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |874|
 :pattern ( ($IsHeapAnchor $h0@@15) ($HeapSucc $h0@@15 $h1@@15) (_module.Memory.HeapObjectsAreMonotonic $prevHeap@@5 $h1@@15 this@@60))
)))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@61 T@U) (|o#0@@12| T@U) (|edges#0@@24| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| this@@61 (Lit DatatypeTypeType |o#0@@12|) (Lit SetType |edges#0@@24|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@61 null)) (not true)) ($Is refType this@@61 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@12| Tclass._module.Region)) ($Is SetType |edges#0@@24| (TSet Tclass._module.Edge))))) (and (forall ((|e#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@24|) ($Box DatatypeTypeType |e#1@@1|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#1@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@12|))) (_module.Edge.Edge_q |e#1@@1|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#1@@1|)) |o#0@@12|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#1@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@12|))) (_module.Edge.Edge_q |e#1@@1|))))))
 :qid |gitissue3855dfy.339:9|
 :skolemid |1004|
 :pattern ( (_module.Edge.f |e#1@@1|))
 :pattern ( (_module.Edge.t |e#1@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@24| ($Box DatatypeTypeType |e#1@@1|)))
)) (= (_module.Memory.externalEdges this@@61 (Lit DatatypeTypeType |o#0@@12|) (Lit SetType |edges#0@@24|)) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge (Lit SetType |edges#0@@24|) |o#0@@12| |o#0@@12|)))))
 :qid |gitissue3855dfy.336:12|
 :weight 3
 :skolemid |1005|
 :pattern ( (_module.Memory.externalEdges this@@61 (Lit DatatypeTypeType |o#0@@12|) (Lit SetType |edges#0@@24|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@26 T@U) (this@@62 T@U) ) (!  (=> (or (|_module.Object.AllOutgoingReferencesAreVenice#canCall| $Heap@@26 this@@62) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@26) (and (or (not (= this@@62 null)) (not true)) (and ($Is refType this@@62 Tclass._module.Object) ($IsAlloc refType this@@62 Tclass._module.Object $Heap@@26)))))) (and (forall ((|n#0@@2| T@U) ) (!  (=> ($Is SeqType |n#0@@2| (TSeq TChar)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@62) _module.Object.fields))) ($Box SeqType |n#0@@2|)) (|_module.__default.VeniceReferenceOK#canCall| this@@62 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@62) _module.Object.fields))) ($Box SeqType |n#0@@2|))))))
 :qid |gitissue3855dfy.134:16|
 :skolemid |796|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@62) _module.Object.fields))) ($Box SeqType |n#0@@2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@62) _module.Object.fields))) ($Box SeqType |n#0@@2|)))
)) (= (_module.Object.AllOutgoingReferencesAreVenice $Heap@@26 this@@62) (forall ((|n#0@@3| T@U) ) (!  (=> (and ($Is SeqType |n#0@@3| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@62) _module.Object.fields))) ($Box SeqType |n#0@@3|))) (_module.__default.VeniceReferenceOK this@@62 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@62) _module.Object.fields))) ($Box SeqType |n#0@@3|)))))
 :qid |gitissue3855dfy.134:16|
 :skolemid |795|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@62) _module.Object.fields))) ($Box SeqType |n#0@@3|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@26 this@@62) _module.Object.fields))) ($Box SeqType |n#0@@3|)))
)))))
 :qid |gitissue3855dfy.131:13|
 :skolemid |797|
 :pattern ( (_module.Object.AllOutgoingReferencesAreVenice $Heap@@26 this@@62) ($IsGoodHeap $Heap@@26))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 162) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@27 alloc false)) (=> (and (and (and (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass._module.Memory) ($IsAlloc refType call1formal@this Tclass._module.Memory $Heap@@27))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass._module.Memory) ($IsAlloc refType call1formal@this@0 Tclass._module.Memory $Heap@0))) (and (|_module.Memory.Valid#canCall| $Heap@0 call1formal@this@0) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@0 call1formal@this@0)))) (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 call1formal@this@0) alloc))))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call1formal@this@0) _module.Memory.objects)) |Set#Empty|) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 call1formal@this@0) alloc)))))) (and (and (forall (($o@@29 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 $o@@29) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@27 $o@@29)))
 :qid |gitissue3855dfy.163:3|
 :skolemid |829|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29))
)) ($HeapSucc $Heap@@27 $Heap@0)) (and (= |k##0@0| (Lit DatatypeTypeType |#_module.Region.Isolate|)) (= |ks##0@0| (Lit MapType |Map#Empty|)))))) (and (and (and (and (or (not (= call3formal@this null)) (not true)) (and ($Is refType call3formal@this Tclass._module.Object) ($IsAlloc refType call3formal@this Tclass._module.Object $Heap@@27))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and (or (not (= call3formal@this@0 null)) (not true)) (and ($Is refType call3formal@this@0 Tclass._module.Object) ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@1))) (and (|$IsA#_module.Region| (_module.Object.region call3formal@this@0)) (|$IsA#_module.Region| |k##0@0|)))) (and (and (and (|_module.Region#Equal| (_module.Object.region call3formal@this@0) |k##0@0|) (|Map#Equal| (_module.Object.fieldModes call3formal@this@0) |ks##0@0|)) (and (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0) _module.Object.fields)) |Map#Empty|) (|_module.Object.Valid#canCall| $Heap@1 call3formal@this@0))) (and (and (_module.Object.Valid reveal__module.Object.Valid $Heap@1 call3formal@this@0) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call3formal@this@0) alloc))))) (and (forall (($o@@30 T@U) ) (!  (=> (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@30) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30)))
 :qid |gitissue3855dfy.93:3|
 :skolemid |747|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@30))
)) ($HeapSucc $Heap@0 $Heap@1)))))) (and (=> (= (ControlFlow 0 2) (- 0 161)) true) (=> (and (= |k##1@0| (|#_module.Region.Heap| call3formal@this@0)) (= |ks##1@0| (Lit MapType |Map#Empty|))) (=> (and (and (or (not (= call3formal@this@@0 null)) (not true)) (and ($Is refType call3formal@this@@0 Tclass._module.Object) ($IsAlloc refType call3formal@this@@0 Tclass._module.Object $Heap@@27))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (=> (and (and (and (and (or (not (= call3formal@this@0@@0 null)) (not true)) (and ($Is refType call3formal@this@0@@0 Tclass._module.Object) ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@2))) (and (|$IsA#_module.Region| (_module.Object.region call3formal@this@0@@0)) (|$IsA#_module.Region| |k##1@0|))) (and (and (|_module.Region#Equal| (_module.Object.region call3formal@this@0@@0) |k##1@0|) (|Map#Equal| (_module.Object.fieldModes call3formal@this@0@@0) |ks##1@0|)) (and (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@0) _module.Object.fields)) |Map#Empty|) (|_module.Object.Valid#canCall| $Heap@2 call3formal@this@0@@0)))) (and (and (and (_module.Object.Valid reveal__module.Object.Valid $Heap@2 call3formal@this@0@@0) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 call3formal@this@0@@0) alloc))))) (and (forall (($o@@31 T@U) ) (!  (=> (and (or (not (= $o@@31 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@31) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@31) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@31)))
 :qid |gitissue3855dfy.93:3|
 :skolemid |747|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@31))
)) ($HeapSucc $Heap@1 $Heap@2))) (and (and (= |k##2@0| (Lit DatatypeTypeType |#_module.Region.Frozen|)) (= |ks##2@0| (Lit MapType |Map#Empty|))) (and (or (not (= call3formal@this@@1 null)) (not true)) (and ($Is refType call3formal@this@@1 Tclass._module.Object) ($IsAlloc refType call3formal@this@@1 Tclass._module.Object $Heap@@27)))))) (=> (and (and (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (and (or (not (= call3formal@this@0@@1 null)) (not true)) (and ($Is refType call3formal@this@0@@1 Tclass._module.Object) ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@3)))) (and (and (|$IsA#_module.Region| (_module.Object.region call3formal@this@0@@1)) (|$IsA#_module.Region| |k##2@0|)) (and (|_module.Region#Equal| (_module.Object.region call3formal@this@0@@1) |k##2@0|) (|Map#Equal| (_module.Object.fieldModes call3formal@this@0@@1) |ks##2@0|)))) (and (and (and (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call3formal@this@0@@1) _module.Object.fields)) |Map#Empty|) (|_module.Object.Valid#canCall| $Heap@3 call3formal@this@0@@1)) (and (_module.Object.Valid reveal__module.Object.Valid $Heap@3 call3formal@this@0@@1) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 call3formal@this@0@@1) alloc)))))) (and (and (forall (($o@@32 T@U) ) (!  (=> (and (or (not (= $o@@32 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@32) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@32) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@32)))
 :qid |gitissue3855dfy.93:3|
 :skolemid |747|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@32))
)) ($HeapSucc $Heap@2 $Heap@3)) (and (= |k##3@0| (Lit DatatypeTypeType |#_module.Region.Isolate|)) (= |ks##3@0| (Lit MapType |Map#Empty|)))))) (and (and (and (and (or (not (= call3formal@this@@2 null)) (not true)) (and ($Is refType call3formal@this@@2 Tclass._module.Object) ($IsAlloc refType call3formal@this@@2 Tclass._module.Object $Heap@@27))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))) (and (and (or (not (= call3formal@this@0@@2 null)) (not true)) (and ($Is refType call3formal@this@0@@2 Tclass._module.Object) ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@4))) (and (|$IsA#_module.Region| (_module.Object.region call3formal@this@0@@2)) (|$IsA#_module.Region| |k##3@0|)))) (and (and (and (|_module.Region#Equal| (_module.Object.region call3formal@this@0@@2) |k##3@0|) (|Map#Equal| (_module.Object.fieldModes call3formal@this@0@@2) |ks##3@0|)) (and (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call3formal@this@0@@2) _module.Object.fields)) |Map#Empty|) (|_module.Object.Valid#canCall| $Heap@4 call3formal@this@0@@2))) (and (and (_module.Object.Valid reveal__module.Object.Valid $Heap@4 call3formal@this@0@@2) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call3formal@this@0@@2) alloc))))) (and (forall (($o@@33 T@U) ) (!  (=> (and (or (not (= $o@@33 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@33) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@33) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@33)))
 :qid |gitissue3855dfy.93:3|
 :skolemid |747|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@33))
)) ($HeapSucc $Heap@3 $Heap@4)))))) (and (=> (= (ControlFlow 0 2) (- 0 160)) true) (=> (and (= |k##4@0| (|#_module.Region.Heap| call3formal@this@0@@2)) (= |ks##4@0| (Lit MapType |Map#Empty|))) (=> (and (and (and (and (or (not (= call3formal@this@@3 null)) (not true)) (and ($Is refType call3formal@this@@3 Tclass._module.Object) ($IsAlloc refType call3formal@this@@3 Tclass._module.Object $Heap@@27))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))) (and (and (or (not (= call3formal@this@0@@3 null)) (not true)) (and ($Is refType call3formal@this@0@@3 Tclass._module.Object) ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@5))) (and (|$IsA#_module.Region| (_module.Object.region call3formal@this@0@@3)) (|$IsA#_module.Region| |k##4@0|)))) (and (and (and (|_module.Region#Equal| (_module.Object.region call3formal@this@0@@3) |k##4@0|) (|Map#Equal| (_module.Object.fieldModes call3formal@this@0@@3) |ks##4@0|)) (and (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call3formal@this@0@@3) _module.Object.fields)) |Map#Empty|) (|_module.Object.Valid#canCall| $Heap@5 call3formal@this@0@@3))) (and (and (_module.Object.Valid reveal__module.Object.Valid $Heap@5 call3formal@this@0@@3) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call3formal@this@0@@3) alloc))))) (and (forall (($o@@34 T@U) ) (!  (=> (and (or (not (= $o@@34 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@34) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@34) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@34)))
 :qid |gitissue3855dfy.93:3|
 :skolemid |747|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@34))
)) ($HeapSucc $Heap@4 $Heap@5))))) (and (=> (= (ControlFlow 0 2) (- 0 159)) true) (and (=> (= (ControlFlow 0 2) (- 0 158)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 157)) true) (and (=> (= (ControlFlow 0 2) (- 0 156)) (forall (($o@@35 T@U) ($f@@17 T@U) ) (!  (=> (and (and (or (not (= $o@@35 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@35) alloc)))) (and (= $o@@35 call1formal@this@0) (= $f@@17 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@35 $f@@17)))
 :qid |gitissue3855dfy.1268:20|
 :skolemid |662|
))) (=> (forall (($o@@36 T@U) ($f@@18 T@U) ) (!  (=> (and (and (or (not (= $o@@36 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@36) alloc)))) (and (= $o@@36 call1formal@this@0) (= $f@@18 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@36 $f@@18)))
 :qid |gitissue3855dfy.1268:20|
 :skolemid |662|
)) (and (=> (= (ControlFlow 0 2) (- 0 155)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@5 call1formal@this@0)) (=> (_module.Memory.Valid reveal__module.Memory.Valid $Heap@5 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 154)) (_module.Object.Valid reveal__module.Object.Valid $Heap@5 call3formal@this@0)) (=> (_module.Object.Valid reveal__module.Object.Valid $Heap@5 call3formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 153)) (= (_module.Object.size $Heap@5 call3formal@this@0) (LitInt 0))) (=> (= (_module.Object.size $Heap@5 call3formal@this@0) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 152)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Memory.objects)) ($Box refType call3formal@this@0)))) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Memory.objects)) ($Box refType call3formal@this@0))) (=> (and (and (and (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (|_module.Memory.Valid2#canCall| $Heap@5 $Heap@6 call1formal@this@0)) (and (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@5 $Heap@6 call1formal@this@0) (forall (($o@@37 T@U) ($f@@19 T@U) ) (!  (=> (or (not (= $o@@37 null)) (not true)) (=> (= $o@@37 call3formal@this@0) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@37) $f@@19) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@37) $f@@19))))
 :qid |gitissue3855dfy.372:13|
 :skolemid |1022|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@37) $f@@19))
)))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Memory.objects)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 call1formal@this@0) _module.Memory.objects)) (|Set#UnionOne| |Set#Empty| ($Box refType call3formal@this@0)))) (forall (($o@@38 T@U) ) (!  (=> (and (or (not (= $o@@38 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@38) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@38) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@38)) (= $o@@38 call1formal@this@0)))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1023|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@38))
))) (and (forall (($o@@39 T@U) ($f@@20 T@U) ) (!  (=> (and (or (not (= $o@@39 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@39) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@39) $f@@20) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@39) $f@@20)) (and (= $o@@39 call1formal@this@0) (= $f@@20 _module.Memory.objects))))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1024|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@39) $f@@20))
)) ($HeapSucc $Heap@5 $Heap@6)))) (and (=> (= (ControlFlow 0 2) (- 0 151)) true) (and (=> (= (ControlFlow 0 2) (- 0 150)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 149)) true) (and (=> (= (ControlFlow 0 2) (- 0 148)) (forall (($o@@40 T@U) ($f@@21 T@U) ) (!  (=> (and (and (or (not (= $o@@40 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@40) alloc)))) (and (= $o@@40 call1formal@this@0) (= $f@@21 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@40 $f@@21)))
 :qid |gitissue3855dfy.1269:20|
 :skolemid |663|
))) (=> (forall (($o@@41 T@U) ($f@@22 T@U) ) (!  (=> (and (and (or (not (= $o@@41 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@41) alloc)))) (and (= $o@@41 call1formal@this@0) (= $f@@22 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@41 $f@@22)))
 :qid |gitissue3855dfy.1269:20|
 :skolemid |663|
)) (and (=> (= (ControlFlow 0 2) (- 0 147)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@6 call1formal@this@0)) (=> (_module.Memory.Valid reveal__module.Memory.Valid $Heap@6 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 146)) (_module.Object.Valid reveal__module.Object.Valid $Heap@6 call3formal@this@0@@0)) (=> (_module.Object.Valid reveal__module.Object.Valid $Heap@6 call3formal@this@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 145)) (= (_module.Object.size $Heap@6 call3formal@this@0@@0) (LitInt 0))) (=> (= (_module.Object.size $Heap@6 call3formal@this@0@@0) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 144)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Memory.objects)) ($Box refType call3formal@this@0@@0)))) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Memory.objects)) ($Box refType call3formal@this@0@@0))) (=> (and (and (and (and ($IsGoodHeap $Heap@7) ($IsHeapAnchor $Heap@7)) (|_module.Memory.Valid2#canCall| $Heap@6 $Heap@7 call1formal@this@0)) (and (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@6 $Heap@7 call1formal@this@0) (forall (($o@@42 T@U) ($f@@23 T@U) ) (!  (=> (or (not (= $o@@42 null)) (not true)) (=> (= $o@@42 call3formal@this@0@@0) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@42) $f@@23) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@42) $f@@23))))
 :qid |gitissue3855dfy.372:13|
 :skolemid |1022|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@42) $f@@23))
)))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 call1formal@this@0) _module.Memory.objects)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 call1formal@this@0) _module.Memory.objects)) (|Set#UnionOne| |Set#Empty| ($Box refType call3formal@this@0@@0)))) (forall (($o@@43 T@U) ) (!  (=> (and (or (not (= $o@@43 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@43) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@43) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@43)) (= $o@@43 call1formal@this@0)))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1023|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@43))
))) (and (forall (($o@@44 T@U) ($f@@24 T@U) ) (!  (=> (and (or (not (= $o@@44 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@44) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@44) $f@@24) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@44) $f@@24)) (and (= $o@@44 call1formal@this@0) (= $f@@24 _module.Memory.objects))))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1024|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@44) $f@@24))
)) ($HeapSucc $Heap@6 $Heap@7)))) (and (=> (= (ControlFlow 0 2) (- 0 143)) true) (and (=> (= (ControlFlow 0 2) (- 0 142)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 141)) true) (and (=> (= (ControlFlow 0 2) (- 0 140)) (forall (($o@@45 T@U) ($f@@25 T@U) ) (!  (=> (and (and (or (not (= $o@@45 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@45) alloc)))) (and (= $o@@45 call1formal@this@0) (= $f@@25 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@45 $f@@25)))
 :qid |gitissue3855dfy.1270:20|
 :skolemid |664|
))) (=> (forall (($o@@46 T@U) ($f@@26 T@U) ) (!  (=> (and (and (or (not (= $o@@46 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@46) alloc)))) (and (= $o@@46 call1formal@this@0) (= $f@@26 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@46 $f@@26)))
 :qid |gitissue3855dfy.1270:20|
 :skolemid |664|
)) (and (=> (= (ControlFlow 0 2) (- 0 139)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@7 call1formal@this@0)) (=> (_module.Memory.Valid reveal__module.Memory.Valid $Heap@7 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 138)) (_module.Object.Valid reveal__module.Object.Valid $Heap@7 call3formal@this@0@@1)) (=> (_module.Object.Valid reveal__module.Object.Valid $Heap@7 call3formal@this@0@@1) (and (=> (= (ControlFlow 0 2) (- 0 137)) (= (_module.Object.size $Heap@7 call3formal@this@0@@1) (LitInt 0))) (=> (= (_module.Object.size $Heap@7 call3formal@this@0@@1) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 136)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 call1formal@this@0) _module.Memory.objects)) ($Box refType call3formal@this@0@@1)))) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 call1formal@this@0) _module.Memory.objects)) ($Box refType call3formal@this@0@@1))) (=> (and (and (and (and ($IsGoodHeap $Heap@8) ($IsHeapAnchor $Heap@8)) (|_module.Memory.Valid2#canCall| $Heap@7 $Heap@8 call1formal@this@0)) (and (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@7 $Heap@8 call1formal@this@0) (forall (($o@@47 T@U) ($f@@27 T@U) ) (!  (=> (or (not (= $o@@47 null)) (not true)) (=> (= $o@@47 call3formal@this@0@@1) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@47) $f@@27) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@47) $f@@27))))
 :qid |gitissue3855dfy.372:13|
 :skolemid |1022|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@47) $f@@27))
)))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 call1formal@this@0) _module.Memory.objects)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 call1formal@this@0) _module.Memory.objects)) (|Set#UnionOne| |Set#Empty| ($Box refType call3formal@this@0@@1)))) (forall (($o@@48 T@U) ) (!  (=> (and (or (not (= $o@@48 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@48) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@48) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@48)) (= $o@@48 call1formal@this@0)))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1023|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@48))
))) (and (forall (($o@@49 T@U) ($f@@28 T@U) ) (!  (=> (and (or (not (= $o@@49 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@49) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@49) $f@@28) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@7 $o@@49) $f@@28)) (and (= $o@@49 call1formal@this@0) (= $f@@28 _module.Memory.objects))))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1024|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@49) $f@@28))
)) ($HeapSucc $Heap@7 $Heap@8)))) (and (=> (= (ControlFlow 0 2) (- 0 135)) true) (and (=> (= (ControlFlow 0 2) (- 0 134)) (or (not (= call1formal@this@0 null)) (not true))) (=> (or (not (= call1formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 133)) true) (and (=> (= (ControlFlow 0 2) (- 0 132)) (forall (($o@@50 T@U) ($f@@29 T@U) ) (!  (=> (and (and (or (not (= $o@@50 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@50) alloc)))) (and (= $o@@50 call1formal@this@0) (= $f@@29 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@50 $f@@29)))
 :qid |gitissue3855dfy.1271:20|
 :skolemid |665|
))) (=> (forall (($o@@51 T@U) ($f@@30 T@U) ) (!  (=> (and (and (or (not (= $o@@51 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@51) alloc)))) (and (= $o@@51 call1formal@this@0) (= $f@@30 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@51 $f@@30)))
 :qid |gitissue3855dfy.1271:20|
 :skolemid |665|
)) (and (=> (= (ControlFlow 0 2) (- 0 131)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@8 call1formal@this@0)) (=> (_module.Memory.Valid reveal__module.Memory.Valid $Heap@8 call1formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 130)) (_module.Object.Valid reveal__module.Object.Valid $Heap@8 call3formal@this@0@@2)) (=> (_module.Object.Valid reveal__module.Object.Valid $Heap@8 call3formal@this@0@@2) (and (=> (= (ControlFlow 0 2) (- 0 129)) (= (_module.Object.size $Heap@8 call3formal@this@0@@2) (LitInt 0))) (=> (= (_module.Object.size $Heap@8 call3formal@this@0@@2) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 128)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 call1formal@this@0) _module.Memory.objects)) ($Box refType call3formal@this@0@@2)))) (=> (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 call1formal@this@0) _module.Memory.objects)) ($Box refType call3formal@this@0@@2))) (=> (and (and (and (and ($IsGoodHeap $Heap@9) ($IsHeapAnchor $Heap@9)) (|_module.Memory.Valid2#canCall| $Heap@8 $Heap@9 call1formal@this@0)) (and (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@8 $Heap@9 call1formal@this@0) (forall (($o@@52 T@U) ($f@@31 T@U) ) (!  (=> (or (not (= $o@@52 null)) (not true)) (=> (= $o@@52 call3formal@this@0@@2) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@52) $f@@31) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@52) $f@@31))))
 :qid |gitissue3855dfy.372:13|
 :skolemid |1022|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@52) $f@@31))
)))) (and (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 call1formal@this@0) _module.Memory.objects)) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 call1formal@this@0) _module.Memory.objects)) (|Set#UnionOne| |Set#Empty| ($Box refType call3formal@this@0@@2)))) (forall (($o@@53 T@U) ) (!  (=> (and (or (not (= $o@@53 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@53) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@53) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@53)) (= $o@@53 call1formal@this@0)))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1023|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@53))
))) (and (forall (($o@@54 T@U) ($f@@32 T@U) ) (!  (=> (and (or (not (= $o@@54 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@54) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@54) $f@@32) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@8 $o@@54) $f@@32)) (and (= $o@@54 call1formal@this@0) (= $f@@32 _module.Memory.objects))))
 :qid |gitissue3855dfy.365:10|
 :skolemid |1024|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@9 $o@@54) $f@@32))
)) ($HeapSucc $Heap@8 $Heap@9)))) (and (=> (= (ControlFlow 0 2) (- 0 127)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 126)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0)) (and (=> (= (ControlFlow 0 2) (- 0 125)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 124)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0)) (_module.Region.region (_module.Object.region call3formal@this@0)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 123)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0)) call3formal@this@0))))))))) (and (=> (= (ControlFlow 0 2) (- 0 122)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 121)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 120)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@0)) (and (=> (= (ControlFlow 0 2) (- 0 119)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@0) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@0)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 118)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@0))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@0)) (_module.Region.region (_module.Object.region call3formal@this@0)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 117)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@0)) call3formal@this@0))))))))) (and (=> (= (ControlFlow 0 2) (- 0 116)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 115)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 114)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@1) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@1)) (and (=> (= (ControlFlow 0 2) (- 0 113)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@1) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 112)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) (_module.Region.region (_module.Object.region call3formal@this@0)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 111)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) call3formal@this@0))))))))) (and (=> (= (ControlFlow 0 2) (- 0 110)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@1) (and (=> (= (ControlFlow 0 2) (- 0 109)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 108)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@2) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@2)) (and (=> (= (ControlFlow 0 2) (- 0 107)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@2) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 106)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@2)) (_module.Region.region (_module.Object.region call3formal@this@0)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 105)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@2)) call3formal@this@0))))))))) (and (=> (= (ControlFlow 0 2) (- 0 104)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@2) (and (=> (= (ControlFlow 0 2) (- 0 103)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 102)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@3) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0 call3formal@this@0@@3)) (and (=> (= (ControlFlow 0 2) (- 0 101)) (not (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@3))) (=> (not (_module.__default.VeniceReferenceOK call3formal@this@0 call3formal@this@0@@3)) (and (=> (= (ControlFlow 0 2) (- 0 100)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 99)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0)) (and (=> (= (ControlFlow 0 2) (- 0 98)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 97)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0)) (_module.Region.region (_module.Object.region call3formal@this@0@@0)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 96)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0)) call3formal@this@0@@0))))))))) (and (=> (= (ControlFlow 0 2) (- 0 95)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 94)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 93)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@0)) (and (=> (= (ControlFlow 0 2) (- 0 92)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@0) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@0)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 91)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@0))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@0)) (_module.Region.region (_module.Object.region call3formal@this@0@@0)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 90)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@0)) call3formal@this@0@@0))))))))) (and (=> (= (ControlFlow 0 2) (- 0 89)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@0) (and (=> (= (ControlFlow 0 2) (- 0 88)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 87)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@1) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@1)) (and (=> (= (ControlFlow 0 2) (- 0 86)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@1) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 85)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) (_module.Region.region (_module.Object.region call3formal@this@0@@0)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 84)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) call3formal@this@0@@0))))))))) (and (=> (= (ControlFlow 0 2) (- 0 83)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@1) (and (=> (= (ControlFlow 0 2) (- 0 82)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 81)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@2) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@2)) (and (=> (= (ControlFlow 0 2) (- 0 80)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@2) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 79)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@2)) (_module.Region.region (_module.Object.region call3formal@this@0@@0)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 78)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@2)) call3formal@this@0@@0))))))))) (and (=> (= (ControlFlow 0 2) (- 0 77)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@0))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@0))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@2) (and (=> (= (ControlFlow 0 2) (- 0 76)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 75)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@3) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@0 call3formal@this@0@@3)) (and (=> (= (ControlFlow 0 2) (- 0 74)) (not (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@3))) (=> (not (_module.__default.VeniceReferenceOK call3formal@this@0@@0 call3formal@this@0@@3)) (and (=> (= (ControlFlow 0 2) (- 0 73)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 72)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0)) (and (=> (= (ControlFlow 0 2) (- 0 71)) (not (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0))) (=> (not (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0)) (and (=> (= (ControlFlow 0 2) (- 0 70)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 69)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@0)) (and (=> (= (ControlFlow 0 2) (- 0 68)) (not (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@0))) (=> (not (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@0)) (and (=> (= (ControlFlow 0 2) (- 0 67)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 66)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@1) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@1)) (and (=> (= (ControlFlow 0 2) (- 0 65)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@1) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 64)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) (_module.Region.region (_module.Object.region call3formal@this@0@@1)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 63)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) call3formal@this@0@@1))))))))) (and (=> (= (ControlFlow 0 2) (- 0 62)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@1) (and (=> (= (ControlFlow 0 2) (- 0 61)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 60)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@2) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@2)) (and (=> (= (ControlFlow 0 2) (- 0 59)) (not (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@2))) (=> (not (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@2)) (and (=> (= (ControlFlow 0 2) (- 0 58)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 57)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@3) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@1 call3formal@this@0@@3)) (and (=> (= (ControlFlow 0 2) (- 0 56)) (not (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@3))) (=> (not (_module.__default.VeniceReferenceOK call3formal@this@0@@1 call3formal@this@0@@3)) (and (=> (= (ControlFlow 0 2) (- 0 55)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 54)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0)) (and (=> (= (ControlFlow 0 2) (- 0 53)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 52)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0)) (_module.Region.region (_module.Object.region call3formal@this@0@@2)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 51)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0)) call3formal@this@0@@2))))))))) (and (=> (= (ControlFlow 0 2) (- 0 50)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 49)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 48)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@0)) (and (=> (= (ControlFlow 0 2) (- 0 47)) (not (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@0))) (=> (not (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@0)) (and (=> (= (ControlFlow 0 2) (- 0 46)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 45)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@1) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@1)) (and (=> (= (ControlFlow 0 2) (- 0 44)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@1) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 43)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) (_module.Region.region (_module.Object.region call3formal@this@0@@2)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 42)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) call3formal@this@0@@2))))))))) (and (=> (= (ControlFlow 0 2) (- 0 41)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@1) (and (=> (= (ControlFlow 0 2) (- 0 40)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 39)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@2) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@2)) (and (=> (= (ControlFlow 0 2) (- 0 38)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@2) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 37)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@2)) (_module.Region.region (_module.Object.region call3formal@this@0@@2)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 36)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@2)) call3formal@this@0@@2))))))))) (and (=> (= (ControlFlow 0 2) (- 0 35)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@2) (and (=> (= (ControlFlow 0 2) (- 0 34)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 33)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@3) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@3)) (and (=> (= (ControlFlow 0 2) (- 0 32)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@3) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@3) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@3)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 31)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@3) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@3) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@3))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@3)) (_module.Region.region (_module.Object.region call3formal@this@0@@2)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 30)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@3) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@3) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@3))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@3)) call3formal@this@0@@2))))))))) (and (=> (= (ControlFlow 0 2) (- 0 29)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@2 call3formal@this@0@@3) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@3) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@3))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@2 call3formal@this@0@@3) (and (=> (= (ControlFlow 0 2) (- 0 28)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 27)) true) (=> ($IsAlloc refType call3formal@this@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0)) (and (=> (= (ControlFlow 0 2) (- 0 26)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0)) (_module.Region.region (_module.Object.region call3formal@this@0@@3)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0)) (= (_module.Region.region (_module.Object.region call3formal@this@0)) call3formal@this@0@@3))))))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0) (and (=> (= (ControlFlow 0 2) (- 0 22)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 21)) true) (=> ($IsAlloc refType call3formal@this@0@@0 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@0) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@0)) (and (=> (= (ControlFlow 0 2) (- 0 20)) (not (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@0))) (=> (not (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@0)) (and (=> (= (ControlFlow 0 2) (- 0 19)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 18)) true) (=> ($IsAlloc refType call3formal@this@0@@1 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@1) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@1)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@1) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) (_module.Region.region (_module.Object.region call3formal@this@0@@3)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@1)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@1)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@1)) call3formal@this@0@@3))))))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@1) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@1) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@1))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@1) (and (=> (= (ControlFlow 0 2) (- 0 13)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 12)) true) (=> ($IsAlloc refType call3formal@this@0@@2 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@2) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@2)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@2) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@2)) (_module.Region.region (_module.Object.region call3formal@this@0@@3)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@2)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@2)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@2)) call3formal@this@0@@3))))))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@2) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@2) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@2))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3))) (U_2_bool (Lit boolType (bool_2_U false))))))))) (=> (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@2) (and (=> (= (ControlFlow 0 2) (- 0 7)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (and (=> (= (ControlFlow 0 2) (- 0 6)) true) (=> ($IsAlloc refType call3formal@this@0@@3 Tclass._module.Object $Heap@9) (=> (and (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@3) (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@3)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@3) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@3) (=> (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@3)) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@3) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@3) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@3))) (=> (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@3)) (_module.Region.region (_module.Object.region call3formal@this@0@@3)))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@3) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@3) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@3))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3))) (=> (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3)) (or (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3)) (and (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3)) (= (_module.Region.region (_module.Object.region call3formal@this@0@@3)) call3formal@this@0@@3))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.VeniceReferenceOK#canCall| call3formal@this@0@@3 call3formal@this@0@@3) (or (_module.__default.VeniceReferenceOK call3formal@this@0@@3 call3formal@this@0@@3) (=> (not (_module.Region.Frozen_q (_module.Object.region call3formal@this@0@@3))) (=> (not (_module.Region.Heap_q (_module.Object.region call3formal@this@0@@3))) (=> (not (_module.Region.Isolate_q (_module.Object.region call3formal@this@0@@3))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@27) ($IsHeapAnchor $Heap@@27)) (and (=> |defass#memory#0| (and ($Is refType |memory#0| Tclass._module.Memory) ($IsAlloc refType |memory#0| Tclass._module.Memory $Heap@@27))) true)) (and (and (=> |defass#i1#0| (and ($Is refType |i1#0| Tclass._module.Object) ($IsAlloc refType |i1#0| Tclass._module.Object $Heap@@27))) true) (and (=> |defass#m1#0| (and ($Is refType |m1#0| Tclass._module.Object) ($IsAlloc refType |m1#0| Tclass._module.Object $Heap@@27))) true))) (and (and (and (=> |defass#x1#0| (and ($Is refType |x1#0| Tclass._module.Object) ($IsAlloc refType |x1#0| Tclass._module.Object $Heap@@27))) true) (and (=> |defass#i2#0| (and ($Is refType |i2#0| Tclass._module.Object) ($IsAlloc refType |i2#0| Tclass._module.Object $Heap@@27))) true)) (and (and (=> |defass#m2#0| (and ($Is refType |m2#0| Tclass._module.Object) ($IsAlloc refType |m2#0| Tclass._module.Object $Heap@@27))) true) (and (= 10 $FunctionContextHeight) (= (ControlFlow 0 162) 2))))) anon0_correct)))
