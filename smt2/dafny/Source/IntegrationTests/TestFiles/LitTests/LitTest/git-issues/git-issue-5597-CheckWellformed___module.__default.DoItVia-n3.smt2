...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|numbers#0| T@U) ) (!  (=> (or (|_module.__default.DoItViaFunctionBodyResult#canCall| |numbers#0|) (and (< 1 $FunctionContextHeight) (and ($Is SetType |numbers#0| (TSet Tclass._module.Number)) (= (|Set#Card| |numbers#0|) (LitInt 0))))) (= (_module.__default.DoItViaFunctionBodyResult |numbers#0|) |numbers#0|))
 :qid |gitissue5597dfy.51:36|
 :skolemid |501|
 :pattern ( (_module.__default.DoItViaFunctionBodyResult |numbers#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|numbers#0@@0| T@U) ) (!  (=> (or (|_module.__default.DoItViaFunctionBodyResult#canCall| |numbers#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is SetType |numbers#0@@0| (TSet Tclass._module.Number)) (= (|Set#Card| |numbers#0@@0|) (LitInt 0))))) ($Is SetType (_module.__default.DoItViaFunctionBodyResult |numbers#0@@0|) (TSet Tclass._module.Integer)))
 :qid |gitissue5597dfy.51:36|
 :skolemid |498|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|numbers#0@@1| T@U) ) (!  (=> (or (|_module.__default.DoItViaFunctionBodyResult#canCall| (Lit SetType |numbers#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is SetType |numbers#0@@1| (TSet Tclass._module.Number)) (= (|Set#Card| (Lit SetType |numbers#0@@1|)) (LitInt 0))))) (= (_module.__default.DoItViaFunctionBodyResult (Lit SetType |numbers#0@@1|)) (Lit SetType |numbers#0@@1|)))
 :qid |gitissue5597dfy.51:36|
 :weight 3
 :skolemid |502|
 :pattern ( (_module.__default.DoItViaFunctionBodyResult (Lit SetType |numbers#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|numbers#0@@2| T@U) ) (!  (=> (and (or (|_module.__default.DoItViaFunctionBodyResult#canCall| |numbers#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($Is SetType |numbers#0@@2| (TSet Tclass._module.Number)) ($IsAlloc SetType |numbers#0@@2| (TSet Tclass._module.Number) $Heap)) (= (|Set#Card| |numbers#0@@2|) (LitInt 0))))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.__default.DoItViaFunctionBodyResult |numbers#0@@2|) (TSet Tclass._module.Integer) $Heap))
 :qid |gitissue5597dfy.51:10|
 :skolemid |499|
 :pattern ( ($IsAlloc SetType (_module.__default.DoItViaFunctionBodyResult |numbers#0@@2|) (TSet Tclass._module.Integer) $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.DoItViaFunctionBodyResult)
