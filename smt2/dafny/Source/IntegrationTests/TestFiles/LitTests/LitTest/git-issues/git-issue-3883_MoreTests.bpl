...
procedure {:verboseName "MoreTests.Placebo (correctness)"} Impl$$MoreTests.__default.Placebo() returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "MoreTests.BMyTypeWrapper (well-formedness)"} CheckWellFormed$$MoreTests.BMyTypeWrapper(MoreTests.BMyTypeWrapper$T: Ty, x#0: DatatypeType);
...
axiom (forall a#0#0#0: DatatypeType :: 
  { #MoreTests.BD.BD(a#0#0#0) } 
  DatatypeCtorId(#MoreTests.BD.BD(a#0#0#0)) == ##MoreTests.BD.BD);
}
...
axiom (forall d: DatatypeType :: 
  { MoreTests.BD.BD_q(d) } 
  MoreTests.BD.BD_q(d)
     ==> (exists a#1#0#0: DatatypeType :: d == #MoreTests.BD.BD(a#1#0#0)));
...
axiom (forall a#2#0#0: DatatypeType :: 
  { $Is(#MoreTests.BD.BD(a#2#0#0), Tclass.MoreTests.BD()) } 
  $Is(#MoreTests.BD.BD(a#2#0#0), Tclass.MoreTests.BD())
     <==> $Is(a#2#0#0, Tclass.MoreTests.BMyTypeWrapper(TInt)));
...
axiom (forall a#3#0#0: DatatypeType :: 
  { #MoreTests.BD.BD(Lit(a#3#0#0)) } 
  #MoreTests.BD.BD(Lit(a#3#0#0)) == Lit(#MoreTests.BD.BD(a#3#0#0)));

function MoreTests.BD._h3(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#4#0#0: DatatypeType :: 
  { #MoreTests.BD.BD(a#4#0#0) } 
  MoreTests.BD._h3(#MoreTests.BD.BD(a#4#0#0)) == a#4#0#0);

// Inductive rank
axiom (forall a#5#0#0: DatatypeType :: 
  { #MoreTests.BD.BD(a#5#0#0) } 
  DtRank(a#5#0#0) < DtRank(#MoreTests.BD.BD(a#5#0#0)));
...
axiom (forall a#6#0#0: Box :: 
  { #MoreTests.XSingle.XPlop(a#6#0#0) } 
  DatatypeCtorId(#MoreTests.XSingle.XPlop(a#6#0#0)) == ##MoreTests.XSingle.XPlop);
}
...
axiom (forall d: DatatypeType :: 
  { MoreTests.XSingle.XPlop_q(d) } 
  MoreTests.XSingle.XPlop_q(d)
     ==> (exists a#7#0#0: Box :: d == #MoreTests.XSingle.XPlop(a#7#0#0)));

// Constructor $Is
axiom (forall MoreTests.XSingle$X: Ty, a#8#0#0: Box :: 
  { $Is(#MoreTests.XSingle.XPlop(a#8#0#0), Tclass.MoreTests.XSingle(MoreTests.XSingle$X)) } 
  $Is(#MoreTests.XSingle.XPlop(a#8#0#0), Tclass.MoreTests.XSingle(MoreTests.XSingle$X))
     <==> $IsBox(a#8#0#0, MoreTests.XSingle$X));

// Constructor $IsAlloc
axiom (forall MoreTests.XSingle$X: Ty, a#8#0#0: Box, $h: Heap :: 
  { $IsAlloc(#MoreTests.XSingle.XPlop(a#8#0#0), 
      Tclass.MoreTests.XSingle(MoreTests.XSingle$X), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#MoreTests.XSingle.XPlop(a#8#0#0), 
        Tclass.MoreTests.XSingle(MoreTests.XSingle$X), 
        $h)
       <==> $IsAllocBox(a#8#0#0, MoreTests.XSingle$X, $h)));
...
axiom (forall a#9#0#0: Box :: 
  { #MoreTests.XSingle.XPlop(Lit(a#9#0#0)) } 
  #MoreTests.XSingle.XPlop(Lit(a#9#0#0)) == Lit(#MoreTests.XSingle.XPlop(a#9#0#0)));

function MoreTests.XSingle._h4(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#10#0#0: Box :: 
  { #MoreTests.XSingle.XPlop(a#10#0#0) } 
  MoreTests.XSingle._h4(#MoreTests.XSingle.XPlop(a#10#0#0)) == a#10#0#0);

// Inductive rank
axiom (forall a#11#0#0: Box :: 
  { #MoreTests.XSingle.XPlop(a#11#0#0) } 
  BoxRank(a#11#0#0) < DtRank(#MoreTests.XSingle.XPlop(a#11#0#0)));
...
procedure {:verboseName "MoreTests.XMyTypeWrapper (well-formedness)"} CheckWellFormed$$MoreTests.XMyTypeWrapper(MoreTests.XMyTypeWrapper$T: Ty, x#0: DatatypeType);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
// Constructor identifier
axiom (forall a#0#0#0: DatatypeType :: 
  { #MoreTests.XD.XD(a#0#0#0) } 
  DatatypeCtorId(#MoreTests.XD.XD(a#0#0#0)) == ##MoreTests.XD.XD);
}
...
axiom (forall d: DatatypeType :: 
  { MoreTests.XD.XD_q(d) } 
  MoreTests.XD.XD_q(d)
     ==> (exists a#1#0#0: DatatypeType :: d == #MoreTests.XD.XD(a#1#0#0)));

// Constructor $Is
axiom (forall a#2#0#0: DatatypeType :: 
  { $Is(#MoreTests.XD.XD(a#2#0#0), Tclass.MoreTests.XD()) } 
  $Is(#MoreTests.XD.XD(a#2#0#0), Tclass.MoreTests.XD())
     <==> $Is(a#2#0#0, Tclass.MoreTests.XMyTypeWrapper(TInt)));
...
// Constructor literal
axiom (forall a#3#0#0: DatatypeType :: 
  { #MoreTests.XD.XD(Lit(a#3#0#0)) } 
  #MoreTests.XD.XD(Lit(a#3#0#0)) == Lit(#MoreTests.XD.XD(a#3#0#0)));

function MoreTests.XD._h5(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#4#0#0: DatatypeType :: 
  { #MoreTests.XD.XD(a#4#0#0) } 
  MoreTests.XD._h5(#MoreTests.XD.XD(a#4#0#0)) == a#4#0#0);

// Inductive rank
axiom (forall a#5#0#0: DatatypeType :: 
  { #MoreTests.XD.XD(a#5#0#0) } 
  DtRank(a#5#0#0) < DtRank(#MoreTests.XD.XD(a#5#0#0)));
...
axiom (forall a#6#0#0: int :: 
  { #MoreTests.IntCell.IntCell(a#6#0#0) } 
  DatatypeCtorId(#MoreTests.IntCell.IntCell(a#6#0#0))
...
axiom (forall d: DatatypeType :: 
  { MoreTests.IntCell.IntCell_q(d) } 
  MoreTests.IntCell.IntCell_q(d)
     ==> (exists a#7#0#0: int :: d == #MoreTests.IntCell.IntCell(a#7#0#0)));
...
axiom (forall a#8#0#0: int :: 
  { $Is(#MoreTests.IntCell.IntCell(a#8#0#0), Tclass.MoreTests.IntCell()) } 
  $Is(#MoreTests.IntCell.IntCell(a#8#0#0), Tclass.MoreTests.IntCell())
     <==> $Is(a#8#0#0, TInt));
...
axiom (forall a#9#0#0: int :: 
  { #MoreTests.IntCell.IntCell(LitInt(a#9#0#0)) } 
  #MoreTests.IntCell.IntCell(LitInt(a#9#0#0))
     == Lit(#MoreTests.IntCell.IntCell(a#9#0#0)));

function MoreTests.IntCell._h6(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#10#0#0: int :: 
  { #MoreTests.IntCell.IntCell(a#10#0#0) } 
  MoreTests.IntCell._h6(#MoreTests.IntCell.IntCell(a#10#0#0)) == a#10#0#0);
...
procedure {:verboseName "MoreTests.ConstrainedIntCell (well-formedness)"} CheckWellFormed$$MoreTests.ConstrainedIntCell(c#0: DatatypeType);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
// Constructor identifier
axiom (forall a#0#0#0: DatatypeType :: 
  { #MoreTests.WrappedInt.WrappedInt(a#0#0#0) } 
  DatatypeCtorId(#MoreTests.WrappedInt.WrappedInt(a#0#0#0))
...
axiom (forall d: DatatypeType :: 
  { MoreTests.WrappedInt.WrappedInt_q(d) } 
  MoreTests.WrappedInt.WrappedInt_q(d)
     ==> (exists a#1#0#0: DatatypeType :: d == #MoreTests.WrappedInt.WrappedInt(a#1#0#0)));
...
// Constructor $Is
axiom (forall a#2#0#0: DatatypeType :: 
  { $Is(#MoreTests.WrappedInt.WrappedInt(a#2#0#0), Tclass.MoreTests.WrappedInt()) } 
  $Is(#MoreTests.WrappedInt.WrappedInt(a#2#0#0), Tclass.MoreTests.WrappedInt())
     <==> $Is(a#2#0#0, Tclass.MoreTests.ConstrainedIntCell()));
...
// Constructor literal
axiom (forall a#3#0#0: DatatypeType :: 
  { #MoreTests.WrappedInt.WrappedInt(Lit(a#3#0#0)) } 
  #MoreTests.WrappedInt.WrappedInt(Lit(a#3#0#0))
     == Lit(#MoreTests.WrappedInt.WrappedInt(a#3#0#0)));

function MoreTests.WrappedInt._h7(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#4#0#0: DatatypeType :: 
  { #MoreTests.WrappedInt.WrappedInt(a#4#0#0) } 
  MoreTests.WrappedInt._h7(#MoreTests.WrappedInt.WrappedInt(a#4#0#0)) == a#4#0#0);

// Inductive rank
axiom (forall a#5#0#0: DatatypeType :: 
  { #MoreTests.WrappedInt.WrappedInt(a#5#0#0) } 
  DtRank(a#5#0#0) < DtRank(#MoreTests.WrappedInt.WrappedInt(a#5#0#0)));
...
procedure {:verboseName "MoreTests.MyTypeAroundInt (well-formedness)"} CheckWellFormed$$MoreTests.MyTypeAroundInt(MoreTests.MyTypeAroundInt$T: Ty, x#0: DatatypeType);
...
axiom (forall a#0#0#0: Box :: 
  { #MoreTests.UCell.UCell(a#0#0#0) } 
  DatatypeCtorId(#MoreTests.UCell.UCell(a#0#0#0)) == ##MoreTests.UCell.UCell);
}
...
axiom (forall d: DatatypeType :: 
  { MoreTests.UCell.UCell_q(d) } 
  MoreTests.UCell.UCell_q(d)
     ==> (exists a#1#0#0: Box :: d == #MoreTests.UCell.UCell(a#1#0#0)));
...
// Constructor $Is
axiom (forall MoreTests.UCell$U: Ty, a#2#0#0: Box :: 
  { $Is(#MoreTests.UCell.UCell(a#2#0#0), Tclass.MoreTests.UCell(MoreTests.UCell$U)) } 
  $Is(#MoreTests.UCell.UCell(a#2#0#0), Tclass.MoreTests.UCell(MoreTests.UCell$U))
     <==> $IsBox(a#2#0#0, MoreTests.UCell$U));

// Constructor $IsAlloc
axiom (forall MoreTests.UCell$U: Ty, a#2#0#0: Box, $h: Heap :: 
  { $IsAlloc(#MoreTests.UCell.UCell(a#2#0#0), Tclass.MoreTests.UCell(MoreTests.UCell$U), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#MoreTests.UCell.UCell(a#2#0#0), Tclass.MoreTests.UCell(MoreTests.UCell$U), $h)
       <==> $IsAllocBox(a#2#0#0, MoreTests.UCell$U, $h)));
...
axiom (forall a#3#0#0: Box :: 
  { #MoreTests.UCell.UCell(Lit(a#3#0#0)) } 
  #MoreTests.UCell.UCell(Lit(a#3#0#0)) == Lit(#MoreTests.UCell.UCell(a#3#0#0)));

function MoreTests.UCell._h8(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#4#0#0: Box :: 
  { #MoreTests.UCell.UCell(a#4#0#0) } 
  MoreTests.UCell._h8(#MoreTests.UCell.UCell(a#4#0#0)) == a#4#0#0);

// Inductive rank
axiom (forall a#5#0#0: Box :: 
  { #MoreTests.UCell.UCell(a#5#0#0) } 
  BoxRank(a#5#0#0) < DtRank(#MoreTests.UCell.UCell(a#5#0#0)));
...
procedure {:verboseName "MoreTests.ConstrainedUCell (well-formedness)"} CheckWellFormed$$MoreTests.ConstrainedUCell(MoreTests.ConstrainedUCell$U: Ty, u#0: DatatypeType);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
// Constructor identifier
axiom (forall a#0#0#0: DatatypeType :: 
  { #MoreTests.WrappedU.WrappedU(a#0#0#0) } 
  DatatypeCtorId(#MoreTests.WrappedU.WrappedU(a#0#0#0))
...
axiom (forall d: DatatypeType :: 
  { MoreTests.WrappedU.WrappedU_q(d) } 
  MoreTests.WrappedU.WrappedU_q(d)
     ==> (exists a#1#0#0: DatatypeType :: d == #MoreTests.WrappedU.WrappedU(a#1#0#0)));
...
// Constructor $Is
axiom (forall MoreTests.WrappedU$U: Ty, a#2#0#0: DatatypeType :: 
  { $Is(#MoreTests.WrappedU.WrappedU(a#2#0#0), 
      Tclass.MoreTests.WrappedU(MoreTests.WrappedU$U)) } 
  $Is(#MoreTests.WrappedU.WrappedU(a#2#0#0), 
      Tclass.MoreTests.WrappedU(MoreTests.WrappedU$U))
     <==> $Is(a#2#0#0, Tclass.MoreTests.ConstrainedUCell(MoreTests.WrappedU$U)));

// Constructor $IsAlloc
axiom (forall MoreTests.WrappedU$U: Ty, a#2#0#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#MoreTests.WrappedU.WrappedU(a#2#0#0), 
      Tclass.MoreTests.WrappedU(MoreTests.WrappedU$U), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#MoreTests.WrappedU.WrappedU(a#2#0#0), 
        Tclass.MoreTests.WrappedU(MoreTests.WrappedU$U), 
        $h)
       <==> $IsAlloc(a#2#0#0, Tclass.MoreTests.ConstrainedUCell(MoreTests.WrappedU$U), $h)));
...
// Constructor literal
axiom (forall a#3#0#0: DatatypeType :: 
  { #MoreTests.WrappedU.WrappedU(Lit(a#3#0#0)) } 
  #MoreTests.WrappedU.WrappedU(Lit(a#3#0#0))
     == Lit(#MoreTests.WrappedU.WrappedU(a#3#0#0)));

function MoreTests.WrappedU._h9(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#4#0#0: DatatypeType :: 
  { #MoreTests.WrappedU.WrappedU(a#4#0#0) } 
  MoreTests.WrappedU._h9(#MoreTests.WrappedU.WrappedU(a#4#0#0)) == a#4#0#0);

// Inductive rank
axiom (forall a#5#0#0: DatatypeType :: 
  { #MoreTests.WrappedU.WrappedU(a#5#0#0) } 
  DtRank(a#5#0#0) < DtRank(#MoreTests.WrappedU.WrappedU(a#5#0#0)));
...
procedure {:verboseName "MoreTests.MyTypeAroundU (well-formedness)"} CheckWellFormed$$MoreTests.MyTypeAroundU(MoreTests.MyTypeAroundU$U: Ty, x#0: DatatypeType);
  free requires 4 == $FunctionContextHeight;
  modifies $Heap;
