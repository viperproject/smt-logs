...
(set-info :boogie-vc-id Impl$$_module.Memory.fNullify_split4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.Memory) ($IsAlloc refType this@@40 Tclass._module.Memory $Heap@@21)))) (=> (and (and (and ($Is refType |o#0@@12| Tclass._module.Object) ($IsAlloc refType |o#0@@12| Tclass._module.Object $Heap@@21)) (and ($Is SeqType |f#0@@1| (TSeq TChar)) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@@21))) (and (and ($Is SetType |xedges#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |xedges#0| (TSet Tclass._module.Edge) $Heap@@21)) true)) (=> (and (and (and (and ($Is SetType |xisos#0| (TSet Tclass._module.Object)) ($IsAlloc SetType |xisos#0| (TSet Tclass._module.Object) $Heap@@21)) true) (and (=> |defass#nedge#0| (and ($Is DatatypeTypeType |nedge#0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |nedge#0| Tclass._module.Edge $Heap@@21))) true)) (and (and (and ($Is SetType |zedges#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |zedges#0| (TSet Tclass._module.Edge) $Heap@@21)) true) (and (= 9 $FunctionContextHeight) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)) ($Box refType |o#0@@12|))))) (=> (and (and (and (and (and (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |o#0@@12|)) ($Box SeqType |f#0@@1|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|))) (and (|Set#IsMember| (_module.Memory.edges $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@12| |f#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))) (not (_module.Region.Frozen_q (_module.Object.region |o#0@@12|))))) (and (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 this@@40) (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@21 alloc |o#0@@12| _module.Object.fields))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (and (and (= $Heap@@21 $Heap@0) reveal__module.Memory.Valid) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and (= $Heap@0 $Heap@1) reveal__module.Object.Valid) (and ($IsAllocBox ($Box refType this@@40) Tclass._module.Memory? $Heap@1) (= |##os#4@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects))))))) (and (and (and (and ($IsAlloc SetType |##os#4@0| (TSet Tclass._module.Object) $Heap@1) (|_module.Memory.edges#canCall| $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects)))) (and (|_module.Memory.edges#canCall| $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects))) (= |xedges#0@0| (_module.Memory.edges $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects)))))) (and (and ($IsAllocBox ($Box refType this@@40) Tclass._module.Memory? $Heap@1) (= |##os#5@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects)))) (and ($IsAlloc SetType |##os#5@0| (TSet Tclass._module.Object) $Heap@1) (|_module.Memory.justTheIsos#canCall| $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects)))))) (and (and (and (|_module.Memory.justTheIsos#canCall| $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects))) (= |xisos#0@0| (_module.Memory.justTheIsos $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects))))) (and (or (not (= |o#0@@12| null)) (not true)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))) (and (and (= |nedge#0@0| (|#_module.Edge.Edge| |o#0@@12| |f#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|))))) (or (not (= |o#0@@12| null)) (not true))) (and (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |o#0@@12| _module.Object.fields)) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= |o#0@@12| null)) (not true))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
