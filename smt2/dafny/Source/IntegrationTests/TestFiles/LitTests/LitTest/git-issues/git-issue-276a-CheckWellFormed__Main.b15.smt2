...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let (($generated@@100 true))
(let (($generated@@101  (=> (and (< $generated@@90 ($generated 0)) (= (ControlFlow 0 9) 4)) $generated@@100)))
(let (($generated@@102  (=> (and (<= ($generated 0) $generated@@90) (= $generated@@91 ($generated 10))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (and (<= 0 $generated@@91) (< $generated@@91 256))) (=> (and (<= 0 $generated@@91) (< $generated@@91 256)) (=> (= $generated@@92 ($generated 0)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 $generated@@92) (< $generated@@92 256))) (=> (and (<= 0 $generated@@92) (< $generated@@92 256)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= #x00 #x00)) (not true))) (=> (or (not (= #x00 #x00)) (not true)) (=> (= (ControlFlow 0 5) 4) $generated@@100)))))))))))
(let (($generated@@103  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= ($generated 0) ($generated 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 ($generated@@24 (bvudiv #x0a #x00)))))))
(let (($generated@@104  (=> (= $generated@@93 ($generated@@31 $generated@@94 $generated@@95 $generated@@96 false)) (and (and (=> (= (ControlFlow 0 10) 2) $generated@@103) (=> (= (ControlFlow 0 10) 5) $generated@@102)) (=> (= (ControlFlow 0 10) 9) $generated@@101)))))
(let (($generated@@105  (=> (and (and ($generated@@97 $generated@@95) ($generated@@98 $generated@@95)) (and (= 0 $generated@@99) (= (ControlFlow 0 11) 10))) $generated@@104)))
$generated@@105)))))))
))
(check-sat)
