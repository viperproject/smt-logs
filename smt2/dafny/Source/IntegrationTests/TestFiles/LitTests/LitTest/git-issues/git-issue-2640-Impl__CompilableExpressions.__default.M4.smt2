...
(declare-fun |y#0| () Int)
(set-info :boogie-vc-id Impl$$CompilableExpressions.__default.M4)
...
(let ((anon10_Then_correct  (=> (and ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap) (|CompilableExpressions.__default.P#canCall| |x#0@0|)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#1| Int) ) (! (CompilableExpressions.__default.P |x#1|)
 :qid |gitissue2640dfy.45:16|
 :skolemid |502|
 ...
 :qid |gitissue2640dfy.45:16|
 :skolemid |502|
))) (=> (CompilableExpressions.__default.P |x#0@0|) (=> (and (|CompilableExpressions.__default.P#canCall| |x#2@0|) (CompilableExpressions.__default.P |x#2@0|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= |x#0@0| |x#2@0|)) (=> (= |x#0@0| |x#2@0|) (=> (and |$let#4$canCall| |$let#4$canCall|) (and (=> (= (ControlFlow 0 6) 4) anon11_Then_correct) (=> (= (ControlFlow 0 6) 5) anon11_Else_correct))))))))))))
