...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon5_Else_correct  (=> (not (_module.Result.IsFailure TInt |call1formal@r#0@0|)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) (Tclass._module.Result TInt) $Heap@4) (= (ControlFlow 0 4) (- 0 3))) (not (_module.Result.IsFailure TInt |call1formal@r#0@0|))))))
