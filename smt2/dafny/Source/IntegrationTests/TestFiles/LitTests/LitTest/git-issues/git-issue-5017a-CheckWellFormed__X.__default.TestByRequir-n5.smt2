...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this T@U) (|x#0| T@U) ) (!  (=> (or (|X.B.Valid#canCall| (Lit refType this) (U_2_bool (Lit boolType |x#0|))) (and (< 0 $FunctionContextHeight) (and (or (not (= this null)) (not true)) ($Is refType this Tclass.X.B)))) (= (X.B.Valid true (Lit refType this) (U_2_bool (Lit boolType |x#0|))) (U_2_bool (Lit boolType |x#0|))))
 :qid |gitissue5017adfy.33:28|
 :weight 3
 :skolemid |1012|
 :pattern ( (X.B.Valid true (Lit refType this) (U_2_bool (Lit boolType |x#0|))))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) (|x#0@@0| Bool) ) (!  (=> (or (|X.B.Valid#canCall| this@@0 |x#0@@0|) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.X.B)))) (= (X.B.Valid true this@@0 |x#0@@0|) |x#0@@0|))
 :qid |gitissue5017adfy.33:28|
 :skolemid |1010|
 :pattern ( (X.B.Valid true this@@0 |x#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@1 T@U) (|x#0@@1| T@U) ) (!  (=> (or (|X.B.Valid#canCall| this@@1 (U_2_bool (Lit boolType |x#0@@1|))) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass.X.B)))) (= (X.B.Valid true this@@1 (U_2_bool (Lit boolType |x#0@@1|))) (U_2_bool (Lit boolType |x#0@@1|))))
 :qid |gitissue5017adfy.33:28|
 :weight 3
 :skolemid |1011|
 :pattern ( (X.B.Valid true this@@1 (U_2_bool (Lit boolType |x#0@@1|))))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$X.__default.TestByRequires)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |b#0| Tclass.X.B) ($IsAlloc refType |b#0| Tclass.X.B $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
