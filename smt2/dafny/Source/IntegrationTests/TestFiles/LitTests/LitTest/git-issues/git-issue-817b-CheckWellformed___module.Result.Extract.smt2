...
(assert (distinct TChar TagChar TagSeq alloc Tagclass._module.Result |##_module.Result.Failure| |##_module.Result.Success| tytagFamily$Result)
)
...
(assert (forall ((_module.Result$T@@2 T@U) (|a#9#0#0| T@U) ($h T@U) ) (!  (=> ($IsGoodHeap $h) (= ($IsAlloc DatatypeTypeType (|#_module.Result.Success| |a#9#0#0|) (Tclass._module.Result _module.Result$T@@2) $h) ($IsAllocBox |a#9#0#0| _module.Result$T@@2 $h)))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Result.Success| |a#9#0#0|) (Tclass._module.Result _module.Result$T@@2) $h))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module.Result$T@@3 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Result.Extract#canCall| _module.Result$T@@3 this@@1) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@1 (Tclass._module.Result _module.Result$T@@3)) (not (_module.Result.IsFailure _module.Result$T@@3 this@@1))))) (= (_module.Result.Extract _module.Result$T@@3 this@@1) (_module.Result.value this@@1)))
 :qid |unknown.0:0|
 :skolemid |535|
 :pattern ( (_module.Result.Extract _module.Result$T@@3 this@@1))
))))
...
(assert (forall ((_module.Result$T@@5 T@U) (|a#2#0#0| T@U) ($h@@1 T@U) ) (!  (=> ($IsGoodHeap $h@@1) (= ($IsAlloc DatatypeTypeType (|#_module.Result.Failure| |a#2#0#0|) (Tclass._module.Result _module.Result$T@@5) $h@@1) ($IsAlloc SeqType |a#2#0#0| (TSeq TChar) $h@@1)))
 :qid |unknown.0:0|
 :skolemid |500|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Result.Failure| |a#2#0#0|) (Tclass._module.Result _module.Result$T@@5) $h@@1))
)))
(assert (forall ((_module.Result$T@@6 T@U) (d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 (Tclass._module.Result _module.Result$T@@6)) (or (_module.Result.Failure_q d@@4) (_module.Result.Success_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |518|
...
(assert (forall ((_module.Result$T@@8 T@U) (|a#9#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.Result.Success| |a#9#0#0@@0|) (Tclass._module.Result _module.Result$T@@8)) ($IsBox |a#9#0#0@@0| _module.Result$T@@8))
 :qid |unknown.0:0|
 :skolemid |511|
 :pattern ( ($Is DatatypeTypeType (|#_module.Result.Success| |a#9#0#0@@0|) (Tclass._module.Result _module.Result$T@@8)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module.Result$T@@9 T@U) (this@@2 T@U) ) (!  (=> (and (or (|_module.Result.Extract#canCall| _module.Result$T@@9 this@@2) (and (< 1 $FunctionContextHeight) (and ($IsAlloc DatatypeTypeType this@@2 (Tclass._module.Result _module.Result$T@@9) $Heap) (not (_module.Result.IsFailure _module.Result$T@@9 this@@2))))) ($IsGoodHeap $Heap)) ($IsAllocBox (_module.Result.Extract _module.Result$T@@9 this@@2) _module.Result$T@@9 $Heap))
 :qid |gitissue817bdfy.7:12|
 :skolemid |533|
 :pattern ( ($IsAllocBox (_module.Result.Extract _module.Result$T@@9 this@@2) _module.Result$T@@9 $Heap))
))))
...
(assert (forall ((_module.Result$T@@11 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._module.Result _module.Result$T@@11)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) (Tclass._module.Result _module.Result$T@@11))))
 :qid |unknown.0:0|
 :skolemid |482|
 :pattern ( ($IsBox bx@@1 (Tclass._module.Result _module.Result$T@@11)))
)))
(assert (forall ((_module.Result$T@@12 T@U) (|a#2#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.Result.Failure| |a#2#0#0@@0|) (Tclass._module.Result _module.Result$T@@12)) ($Is SeqType |a#2#0#0@@0| (TSeq TChar)))
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( ($Is DatatypeTypeType (|#_module.Result.Failure| |a#2#0#0@@0|) (Tclass._module.Result _module.Result$T@@12)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module.Result$T@@13 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Result.Extract#canCall| _module.Result$T@@13 this@@3) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@3 (Tclass._module.Result _module.Result$T@@13)) (not (_module.Result.IsFailure _module.Result$T@@13 this@@3))))) ($IsBox (_module.Result.Extract _module.Result$T@@13 this@@3) _module.Result$T@@13))
 :qid |unknown.0:0|
 :skolemid |532|
 :pattern ( (_module.Result.Extract _module.Result$T@@13 this@@3))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.Result$T@@14 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.Result.IsFailure#canCall| _module.Result$T@@14 this@@4) (and (< 0 $FunctionContextHeight) ($Is DatatypeTypeType this@@4 (Tclass._module.Result _module.Result$T@@14)))) (= (_module.Result.IsFailure _module.Result$T@@14 this@@4) (_module.Result.Failure_q this@@4)))
 :qid |unknown.0:0|
 :skolemid |524|
 :pattern ( (_module.Result.IsFailure _module.Result$T@@14 this@@4))
))))
...
(declare-fun _module.Result$T@@15 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.Result.Extract)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (_module.Result.Success_q this@@5))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#2| null $Heap@@0 alloc false)) ($IsAllocBox ($Box DatatypeTypeType this@@5) (Tclass._module.Result _module.Result$T@@15) $Heap@@0)) (and (|_module.Result.IsFailure#canCall| _module.Result$T@@15 this@@5) (not (_module.Result.IsFailure _module.Result$T@@15 this@@5)))) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType this@@5 (Tclass._module.Result _module.Result$T@@15)) ($IsAlloc DatatypeTypeType this@@5 (Tclass._module.Result _module.Result$T@@15) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
