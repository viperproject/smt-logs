...
(assert (forall (($h0 T@U) ($h1 T@U) (|a#0@@1| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Test.__default.arrSet#canCall| $h0 |a#0@@1|) ($Is refType |a#0@@1| (Tclass._System.array Tclass.Test.C)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@4 T@U) ($f T@U) )  (=> (and (or (not (= $o@@4 null)) (not true)) (= $o@@4 |a#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@4) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@4) $f)))) (= (Test.__default.arrSet $h0 |a#0@@1|) (Test.__default.arrSet $h1 |a#0@@1|))))
