...
(assert (forall (($h0 T@U) ($h1 T@U) (|a#0@@1| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Test.__default.arrSet#canCall| $h0 |a#0@@1|) ($Is refType |a#0@@1| (Tclass._System.array Tclass.Test.C)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@4 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (= $o@@4 |a#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@4) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@4) $f)))
 :qid |unknown.0:0|
 :skolemid |546|
)) (= (Test.__default.arrSet $h0 |a#0@@1|) (Test.__default.arrSet $h1 |a#0@@1|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |548|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (Test.__default.arrSet $h1 |a#0@@1|))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|a#0@@2| T@U) ) (!  (=> (or (|Test.__default.arrSet#canCall| $Heap@@1 |a#0@@2|) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and ($Is refType |a#0@@2| (Tclass._System.array Tclass.Test.C)) ($IsAlloc refType |a#0@@2| (Tclass._System.array Tclass.Test.C) $Heap@@1))))) ($Is SetType (Test.__default.arrSet $Heap@@1 |a#0@@2|) (TSet Tclass._System.object)))
 :qid |gitissue1989dfy.10:18|
 :skolemid |549|
 :pattern ( (Test.__default.arrSet $Heap@@1 |a#0@@2|))
))))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@6 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@6 $f@@0))  (=> (and (or (not (= $o@@6 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@6) |l#2|)))) (= $o@@6 |l#3|)))
...
(assert (forall ((bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 Tclass.Test.C?) (and (= ($Box refType ($Unbox refType bx@@5)) bx@@5) ($Is refType ($Unbox refType bx@@5) Tclass.Test.C?)))
 :qid |unknown.0:0|
 :skolemid |559|
 :pattern ( ($IsBox bx@@5 Tclass.Test.C?))
)))
...
(declare-fun |x#0| () T@U)
(set-info :boogie-vc-id Impl$$Test.__default.test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@2 alloc |a#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |i#0@@0|) (< |i#0@@0| (_System.array.Length |a#0@@3|)))) (=> (and (<= 0 |i#0@@0|) (< |i#0@@0| (_System.array.Length |a#0@@3|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0@@3| (IndexField |i#0@@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0@@3| (IndexField |i#0@@0|))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@2 |a#0@@3| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |a#0@@3|) (IndexField |i#0@@0|) ($Box refType |x#0|)))) ($IsGoodHeap $Heap@0)) (=> (and (and (and ($IsAlloc refType |a#0@@3| (Tclass._System.array Tclass.Test.C) $Heap@0) (|Test.__default.arrSet#canCall| $Heap@0 |a#0@@3|)) (and ($IsAlloc refType |a#0@@3| (Tclass._System.array Tclass.Test.C) $Heap@0) (|Test.__default.arrSet#canCall| $Heap@0 |a#0@@3|))) (and (and (|Test.__default.arrSet#canCall| $Heap@0 |a#0@@3|) (|Test.__default.arrSet#canCall| $Heap@0 |a#0@@3|)) (= (ControlFlow 0 2) (- 0 1)))) (|Set#Equal| (Test.__default.arrSet $Heap@0 |a#0@@3|) (Test.__default.arrSet $Heap@0 |a#0@@3|)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($Is refType |a#0@@3| (Tclass._System.array Tclass.Test.C)) ($IsAlloc refType |a#0@@3| (Tclass._System.array Tclass.Test.C) $Heap@@2))) (=> (and (and (and ($Is refType |x#0| Tclass.Test.C) ($IsAlloc refType |x#0| Tclass.Test.C $Heap@@2)) (= 2 $FunctionContextHeight)) (and (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (_System.array.Length |a#0@@3|))) (and (not (|Set#IsMember| (Test.__default.arrSet $Heap@@2 |a#0@@3|) ($Box refType |x#0|))) (= (ControlFlow 0 6) 2)))) anon0_correct))))
