...
(assert (distinct TInt TagInt TagSet TagSeq alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass.DafnyNaCl.GF64__Any__Limb Tagclass.BoundedInts.int64 tytagFamily$object |tytagFamily$_#Func1| tytagFamily$GF64_Any_Limb tytagFamily$int64)
)
...
(assert (forall ((bx@@10 T@U) (t@@4 T@U) ) (!  (=> ($IsBox bx@@10 (TSet t@@4)) (and (= ($Box SetType ($Unbox SetType bx@@10)) bx@@10) ($Is SetType ($Unbox SetType bx@@10) (TSet t@@4))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |32|
 :pattern ( ($IsBox bx@@10 (TSet t@@4)))
)))
(assert (= (Ctor SeqType) 10))
(assert (forall ((bx@@11 T@U) (t@@5 T@U) ) (!  (=> ($IsBox bx@@11 (TSeq t@@5)) (and (= ($Box SeqType ($Unbox SeqType bx@@11)) bx@@11) ($Is SeqType ($Unbox SeqType bx@@11) (TSeq t@@5))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx@@11 (TSeq t@@5)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$DafnyNaCl.GF64)
...
(let ((anon12_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (=> (and (= |newtype$check#0@0| (LitInt 0)) (= (ControlFlow 0 8) (- 0 7))) (and (<= (LitInt (- 0 9223372036854775808)) |newtype$check#0@0|) (< |newtype$check#0@0| 9223372036854775808))))))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 10) 8) anon12_Then_correct) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| DafnyNaCl.__default.NGFD)) (Requires1 TInt Tclass.BoundedInts.int64 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |gitissue2927dfy.31:47|
 :skolemid |494|
))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| DafnyNaCl.__default.NGFD)) (forall (($o@@1 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt Tclass.BoundedInts.int64 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@1))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@0)))
 :qid |gitissue2927dfy.31:47|
 :skolemid |495|
)))
 :qid |gitissue2927dfy.31:47|
 ...
 :qid |gitissue2927dfy.31:47|
 :skolemid |496|
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0@@2| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@2|) (< |seqinit#0#i0#0@@2| DafnyNaCl.__default.NGFD)) ($Is intType ($Unbox intType (Apply1 TInt Tclass.BoundedInts.int64 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@2|)))) Tclass.DafnyNaCl.GF64__Any__Limb))
 :qid |gitissue2927dfy.31:47|
 :skolemid |497|
))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (|Seq#Length| (|Seq#Create| Tclass.BoundedInts.int64 $Heap DafnyNaCl.__default.NGFD (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))))) DafnyNaCl.__default.NGFD))))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= 0 DafnyNaCl.__default.NGFD)) (=> (<= 0 DafnyNaCl.__default.NGFD) (and (=> (= (ControlFlow 0 11) 10) anon11_Then_correct) (=> (= (ControlFlow 0 11) 3) anon11_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 13) 1) anon9_Then_correct) (=> (= (ControlFlow 0 13) 11) anon10_Then_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 5 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct)))
