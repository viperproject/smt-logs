...
(let ((anon11_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((|seqinit#0#i0#0| Int) )  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| DafnyNaCl.__default.NGFD)) (Requires1 TInt Tclass.BoundedInts.int64 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|)))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|seqinit#0#i0#0@@0| Int) )  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| DafnyNaCl.__default.NGFD)) (forall (($o@@1 T@U) ($f@@0 T@U) )  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt Tclass.BoundedInts.int64 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@1))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@0))))))) (=> (forall ((|seqinit#0#i0#0@@1| T@U) )  (=> (and (<= 0 (U_2_int |seqinit#0#i0#0@@1|)) (< (U_2_int |seqinit#0#i0#0@@1|) DafnyNaCl.__default.NGFD)) (forall (($o@@2 T@U) ($f@@1 T@U) )  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $o@@2) alloc)))) (|Set#IsMember| (Reads1 TInt Tclass.BoundedInts.int64 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType |seqinit#0#i0#0@@1|)) ($Box refType $o@@2))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@1)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0@@2| Int) )  (=> (and (<= 0 |seqinit#0#i0#0@@2|) (< |seqinit#0#i0#0@@2| DafnyNaCl.__default.NGFD)) ($Is intType ($Unbox intType (Apply1 TInt Tclass.BoundedInts.int64 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@2|)))) Tclass.DafnyNaCl.GF64__Any__Limb)))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (|Seq#Length| (|Seq#Create| Tclass.BoundedInts.int64 $Heap DafnyNaCl.__default.NGFD (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#8| (Handle1 (|lambda#4| ($Box intType (int_2_U (LitInt 0)))) (|lambda#5| TInt) (|lambda#7| (SetRef_to_SetBox (|lambda#6| false))))) ($LS $LZ))))) DafnyNaCl.__default.NGFD))))))))
