...
(set-info :boogie-vc-id Impl$$_module.Memory.fNullify_split10)
...
)) (= (ControlFlow 0 2) (- 0 1)))))))) (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#0@@12|) _module.Object.fields)) (_module.__default.RemoveKey (TSeq TChar) Tclass._module.Object reveal__module._default.RemoveKey ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|)))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
