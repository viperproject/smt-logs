...
(declare-fun _module.__default.FromAtoB (T@U) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.FromAtoB#canCall| (T@U) Bool)
...
(assert  (and (= (Ctor SeqType) 8) (= (Ctor HandleTypeType) 9)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| T@U) ) (!  (=> (or (|_module.__default.FromAtoB#canCall| |a#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is SeqType |a#0| (TSeq TInt))))) (= (_module.__default.FromAtoB |a#0|) (|Seq#Create| TInt $Heap (|Seq#Length| |a#0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0|) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))
 :qid |gitissue334dfy.4:10|
 :skolemid |481|
 :pattern ( (_module.__default.FromAtoB |a#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((|l#0@@0| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@0|) |$l#0#heap#0@@0| |$l#0#i#0@@0|) ($Box intType ($Unbox intType (|Seq#Index| |l#0@@0| (U_2_int ($Unbox intType |$l#0#i#0@@0|))))))
 :qid |gitissue334dfy.4:19|
 :skolemid |493|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@0|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.FromAtoB#canCall| (Lit SeqType |a#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is SeqType |a#0@@0| (TSeq TInt))))) (= (_module.__default.FromAtoB (Lit SeqType |a#0@@0|)) (|Seq#Create| TInt $Heap@@0 (|Seq#Length| (Lit SeqType |a#0@@0|)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| (Lit SeqType |a#0@@0|)) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))
 :qid |gitissue334dfy.4:10|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.FromAtoB (Lit SeqType |a#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0@@3| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@3| |l#1| |l#2| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@0) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |498|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@3| |l#1| |l#2| |l#3|) $o@@0 $f))
)))
...
(assert (forall ((bx@@8 T@U) (t@@4 T@U) ) (!  (=> ($IsBox bx@@8 (TSet t@@4)) (and (= ($Box SetType ($Unbox SetType bx@@8)) bx@@8) ($Is SetType ($Unbox SetType bx@@8) (TSet t@@4))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |32|
 :pattern ( ($IsBox bx@@8 (TSet t@@4)))
)))
(assert (forall ((bx@@9 T@U) (t@@5 T@U) ) (!  (=> ($IsBox bx@@9 (TSeq t@@5)) (and (= ($Box SeqType ($Unbox SeqType bx@@9)) bx@@9) ($Is SeqType ($Unbox SeqType bx@@9) (TSeq t@@5))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx@@9 (TSeq t@@5)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|a#0@@1| T@U) ) (!  (=> (or (|_module.__default.FromAtoB#canCall| |a#0@@1|) (and (< 0 $FunctionContextHeight) ($Is SeqType |a#0@@1| (TSeq TInt)))) ($Is SeqType (_module.__default.FromAtoB |a#0@@1|) (TSeq TInt)))
 :qid |gitissue334dfy.4:19|
 :skolemid |479|
 :pattern ( (_module.__default.FromAtoB |a#0@@1|))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.FromAtoB)
...
(let ((anon11_Then_correct  (=> (and (= |$_Frame#l0@0| (|lambda#10| null |$lambdaHeap#0@0| alloc false)) (= (ControlFlow 0 6) (- 0 5))) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0@@2|))))))
(let ((anon10_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (|Seq#Length| |a#0@@2|))) (Requires1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@2|) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |gitissue334dfy.6:3|
 :skolemid |483|
))) (=> (and (and (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| (|Seq#Length| |a#0@@2|))) (forall (($o@@1 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@1 $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@2|) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@1))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@0)))
 :qid |gitissue334dfy.6:3|
 :skolemid |484|
)))
 :qid |gitissue334dfy.6:3|
 :skolemid |485|
))) (= (_module.__default.FromAtoB |a#0@@2|) (|Seq#Create| TInt $Heap@@1 (|Seq#Length| |a#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@2|) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))) (and ($Is SeqType (_module.__default.FromAtoB |a#0@@2|) (TSeq TInt)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (<= 0 (|Seq#Length| |a#0@@2|))) (=> (<= 0 (|Seq#Length| |a#0@@2|)) (and (=> (= (ControlFlow 0 9) 8) anon10_Then_correct) (=> (= (ControlFlow 0 9) 3) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#10| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is SeqType |a#0@@2| (TSeq TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct)))
