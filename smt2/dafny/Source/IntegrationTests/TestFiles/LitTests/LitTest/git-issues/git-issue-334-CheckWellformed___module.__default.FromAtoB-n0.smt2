...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) )  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (|Seq#Length| |a#0@@2|))) (Requires1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@2|) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|)))))) (=> (and (and (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) )  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| (|Seq#Length| |a#0@@2|))) (forall (($o@@1 T@U) ($f@@0 T@U) )  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@1 $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@2|) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@1))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@0))))))) (= (_module.__default.FromAtoB |a#0@@2|) (|Seq#Create| TInt $Heap@@1 (|Seq#Length| |a#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@2|) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))) (and ($Is SeqType (_module.__default.FromAtoB |a#0@@2|) (TSeq TInt)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
