...
(set-info :boogie-vc-id Impl$$TypeCasts.__default.M3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon3_Else_correct  (=> (or (not (= |x#0@@0| (LitInt 3))) (not true)) (=> (and (<= (LitInt 0) |_v3#1_0@0|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U |x#0@@0|) Tclass._System.nat)))))
