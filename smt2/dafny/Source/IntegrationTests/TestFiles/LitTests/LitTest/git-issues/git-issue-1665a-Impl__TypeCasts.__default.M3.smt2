...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@104  (=> (or (not (= $generated@@96 ($generated@@18 3))) (not true)) (=> (and (<= ($generated@@18 0) $generated@@97) (= (ControlFlow 0 3) (- 0 2))) ($generated@@27 $generated@@4 ($generated@@8 $generated@@96) $generated@@28)))))
(let (($generated@@105 true))
(let (($generated@@106  (=> (= $generated@@98 ($generated@@35 $generated@@99 $generated@@100 $generated false)) (and (=> (= (ControlFlow 0 4) 1) $generated@@105) (=> (= (ControlFlow 0 4) 3) $generated@@104)))))
