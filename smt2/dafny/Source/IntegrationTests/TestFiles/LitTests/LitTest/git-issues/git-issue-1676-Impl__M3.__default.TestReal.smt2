...
(declare-fun Tagclass.M3.MyReal () T@U)
(declare-fun tytagFamily$MyReal () T@U)
...
(declare-fun Tclass.M3.MyReal () T@U)
...
(assert (distinct TReal TagReal TagMultiSet alloc Tagclass.M3.MyReal tytagFamily$MyReal)
)
(assert (= (Tag TReal) TagReal))
(assert (forall ((|r#0| T@U) ($h T@U) ) (! ($IsAlloc realType |r#0| Tclass.M3.MyReal $h)
 :qid |unknown.0:0|
 :skolemid |2040|
 :pattern ( ($IsAlloc realType |r#0| Tclass.M3.MyReal $h))
)))
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass.M3.MyReal) (and (= ($Box realType ($Unbox realType bx)) bx) ($Is realType ($Unbox realType bx) Tclass.M3.MyReal)))
 :qid |unknown.0:0|
 :skolemid |2014|
 :pattern ( ($IsBox bx Tclass.M3.MyReal))
)))
(assert (forall ((|r#0@@0| T@U) ) (! (= ($Is realType |r#0@@0| Tclass.M3.MyReal)  (or (= (U_2_real |r#0@@0|) (LitReal 3.14)) (= (U_2_real |r#0@@0|) (LitReal 1.618))))
 :qid |unknown.0:0|
 :skolemid |2039|
 :pattern ( ($Is realType |r#0@@0| Tclass.M3.MyReal))
)))
...
(assert (= (Tag Tclass.M3.MyReal) Tagclass.M3.MyReal))
(assert (= (TagFamily Tclass.M3.MyReal) tytagFamily$MyReal))
...
(set-info :boogie-vc-id Impl$$M3.__default.TestReal)
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is MultiSetType (|MultiSet#Union| |s1#0@0| |s0#0@0|) (TMultiSet Tclass.M3.MyReal)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is MultiSetType (|MultiSet#Union| |s0#0@0| |s1#0@0|) (TMultiSet Tclass.M3.MyReal)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (or (= |x1#0| (LitReal 3.14)) (= |x1#0| (LitReal 1.618)))) (and (and ($Is MultiSetType |s0#0| (TMultiSet TReal)) ($IsAlloc MultiSetType |s0#0| (TMultiSet TReal) $Heap)) true)) (=> (and (and (and (and (and ($Is MultiSetType |s1#0| (TMultiSet Tclass.M3.MyReal)) ($IsAlloc MultiSetType |s1#0| (TMultiSet Tclass.M3.MyReal) $Heap)) true) (and (and ($Is MultiSetType |a#0_0| (TMultiSet TReal)) ($IsAlloc MultiSetType |a#0_0| (TMultiSet TReal) $Heap)) true)) (and (and (and ($Is MultiSetType |a#1_0| (TMultiSet TReal)) ($IsAlloc MultiSetType |a#1_0| (TMultiSet TReal) $Heap)) true) (and (and ($Is MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyReal)) ($IsAlloc MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyReal) $Heap)) true))) (and (and (and (and ($Is MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyReal)) ($IsAlloc MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyReal) $Heap)) true) (and (and ($Is MultiSetType |a#4_0| (TMultiSet TReal)) ($IsAlloc MultiSetType |a#4_0| (TMultiSet TReal) $Heap)) true)) (and (and (and ($Is MultiSetType |a#5_0| (TMultiSet TReal)) ($IsAlloc MultiSetType |a#5_0| (TMultiSet TReal) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))))) anon0_correct))))
