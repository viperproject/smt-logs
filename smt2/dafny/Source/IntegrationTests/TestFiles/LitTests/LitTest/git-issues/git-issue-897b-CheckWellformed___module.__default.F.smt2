...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) ) (!  (=> (or |_module.__default.F#canCall| (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap))) (= _module.__default.F (LitInt 5)))
 :qid |gitissue897bdfy.4:16|
 :skolemid |480|
 :pattern ( _module.__default.F ($IsGoodHeap $Heap))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) ) (!  (=> (or |_module.__default.F#canCall| (and (< 0 $FunctionContextHeight) ($IsGoodHeap $Heap@@0))) (= _module.__default.F (LitInt 5)))
 :qid |gitissue897bdfy.4:16|
 :weight 3
 :skolemid |481|
 :pattern ( _module.__default.F ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#x#0@@0|) |l#0@@3|)
 :qid |gitissue897bdfy.5:17|
 :skolemid |483|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#x#0@@0|))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon16_Else_correct true))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 9) 7) anon16_Then_correct) (=> (= (ControlFlow 0 9) 8) anon16_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (forall ((|y#0_0_1| T@U) ) (!  (=> (U_2_bool ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType |y#0_0_1|)))) (U_2_bool (Lit boolType (bool_2_U true))))
 :qid |gitissue897bdfy.7:12|
 :skolemid |482|
 :pattern ( ($Unbox boolType (Apply1 TInt TBool $Heap@@1 |p#Z#0@0| ($Box intType |y#0_0_1|))))
)) (= (ControlFlow 0 5) (- 0 4))) (U_2_bool (Lit boolType (bool_2_U true))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct true))
(let ((anon15_Else_correct  (=> (= |let#0#0#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#1| TInt) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (=> (and ($Is HandleTypeType |let#0#0#0| (Tclass._System.___hTotalFunc1 TInt TBool)) (= |p#Z#0@0| |let#0#0#0|)) (and (and (=> (= (ControlFlow 0 6) 2) anon17_Else_correct) (=> (= (ControlFlow 0 6) 3) anon18_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon18_Else_correct))))))
(let ((anon14_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#10| null $Heap@@1 alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon15_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon15_Else_correct)))))
