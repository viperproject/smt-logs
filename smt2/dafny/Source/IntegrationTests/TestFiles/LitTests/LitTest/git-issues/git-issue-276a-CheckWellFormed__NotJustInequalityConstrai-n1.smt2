...
(set-info :boogie-vc-id CheckWellFormed$$NotJustInequalityConstraints.Just8)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (LitInt 8) (LitInt 8))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (LitInt 8) (LitInt 8))))))
