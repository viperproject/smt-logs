...
(declare-fun _module.Fn0$R () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun |newtype$check#1@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellFormed$$_module.Fn0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (= |newtype$check#0@0| (|_module.__default.PartialFnWitness#Handle| _module.Fn0$R)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (forall ((|x0#0@@1| Int) ) (! (|Set#Equal| (Reads1 TInt (Tclass._module.Option _module.Fn0$R) $Heap@@0 |newtype$check#0@0| ($Box intType (int_2_U |x0#0@@1|))) |Set#Empty|)
 :qid |unknown.0:0|
 :skolemid |1255|
))) (=> (forall ((|x0#0@@2| T@U) ) (! (|Set#Equal| (Reads1 TInt (Tclass._module.Option _module.Fn0$R) $Heap@@0 |newtype$check#0@0| ($Box intType |x0#0@@2|)) |Set#Empty|)
 :qid |unknown.0:0|
 :skolemid |1255|
)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (forall ((|x0#1| Int) ) (! (Requires1 TInt (Tclass._module.Option _module.Fn0$R) $Heap@@0 |newtype$check#0@0| ($Box intType (int_2_U |x0#1|)))
 :qid |unknown.0:0|
 :skolemid |1256|
))) (=> (forall ((|x0#1@@0| T@U) ) (! (Requires1 TInt (Tclass._module.Option _module.Fn0$R) $Heap@@0 |newtype$check#0@0| ($Box intType |x0#1@@0|))
 :qid |unknown.0:0|
 :skolemid |1256|
)) (=> (= |newtype$check#1@0| (|_module.__default.PartialFnWitness#Handle| _module.Fn0$R)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|x0#2| Int) ) (! (|Set#Equal| (Reads1 TInt (Tclass._module.Option _module.Fn0$R) $Heap@@0 |newtype$check#1@0| ($Box intType (int_2_U |x0#2|))) |Set#Empty|)
 :qid |unknown.0:0|
 :skolemid |1257|
))) (=> (forall ((|x0#2@@0| T@U) ) (! (|Set#Equal| (Reads1 TInt (Tclass._module.Option _module.Fn0$R) $Heap@@0 |newtype$check#1@0| ($Box intType |x0#2@@0|)) |Set#Empty|)
 :qid |unknown.0:0|
 :skolemid |1257|
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|x0#3| Int) ) (! (Requires1 TInt (Tclass._module.Option _module.Fn0$R) $Heap@@0 |newtype$check#1@0| ($Box intType (int_2_U |x0#3|)))
 :qid |unknown.0:0|
 :skolemid |1258|
))) (=> (forall ((|x0#3@@0| T@U) ) (! (Requires1 TInt (Tclass._module.Option _module.Fn0$R) $Heap@@0 |newtype$check#1@0| ($Box intType |x0#3@@0|))
 :qid |unknown.0:0|
 :skolemid |1258|
