...
(assert (distinct TInt TagInt alloc Tagclass._System.array2? Tagclass._System.array2 Tagclass._module.D? Tagclass._module.D tytagFamily$array2 tytagFamily$D)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((_System.array2$arg@@8 T@U) ($h@@4 T@U) ($o@@7 T@U) ($i0@@0 Int) ($i1@@0 Int) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) (Tclass._System.array2? _System.array2$arg@@8)))) (and (and (<= 0 $i0@@0) (< $i0@@0 (_System.array2.Length0 $o@@7))) (and (<= 0 $i1@@0) (< $i1@@0 (_System.array2.Length1 $o@@7))))) ($IsBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@7) (MultiIndexField (IndexField $i0@@0) $i1@@0)) _System.array2$arg@@8))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@7) (MultiIndexField (IndexField $i0@@0) $i1@@0)) (Tclass._System.array2? _System.array2$arg@@8))
)))
...
(assert (forall ((_System.array2$arg@@11 T@U) ($h@@5 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) (Tclass._System.array2? _System.array2$arg@@11)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@8) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length0 $o@@8)) TInt $h@@5))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( (_System.array2.Length0 $o@@8) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@8) alloc)) (Tclass._System.array2? _System.array2$arg@@11))
)))
(assert (forall ((_System.array2$arg@@12 T@U) ($h@@6 T@U) ($o@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) (Tclass._System.array2? _System.array2$arg@@12)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) alloc)))) ($IsAlloc intType (int_2_U (_System.array2.Length1 $o@@9)) TInt $h@@6))
 :qid |unknown.0:0|
 :skolemid |491|
 :pattern ( (_System.array2.Length1 $o@@9) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) alloc)) (Tclass._System.array2? _System.array2$arg@@12))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MultiArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |m#0|)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (< |i#0| (_System.array2.Length0 |m#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (< |j#0| (_System.array2.Length1 |m#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |m#0| (Tclass._System.array2 Tclass._module.D?)) ($IsAlloc refType |m#0| (Tclass._System.array2 Tclass._module.D?) $Heap))) (and (and (<= (LitInt 0) |i#0|) (<= (LitInt 0) |j#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct)))
