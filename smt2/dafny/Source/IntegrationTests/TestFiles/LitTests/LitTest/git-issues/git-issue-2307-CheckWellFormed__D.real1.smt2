...
(set-info :boogie-vc-id CheckWellFormed$$D.real1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (= |newtype$check#0@0| (LitReal 0.0)) (= (ControlFlow 0 3) (- 0 2))) (U_2_bool (Lit boolType (bool_2_U true))))))
