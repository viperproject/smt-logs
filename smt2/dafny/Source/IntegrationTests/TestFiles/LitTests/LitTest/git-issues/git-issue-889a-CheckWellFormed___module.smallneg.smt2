...
(set-info :boogie-vc-id CheckWellFormed$$_module.smallneg)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitReal (- 0.0 1.0)) (LitReal 0.0))) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitReal 0.0) (LitReal 0.0))))))
