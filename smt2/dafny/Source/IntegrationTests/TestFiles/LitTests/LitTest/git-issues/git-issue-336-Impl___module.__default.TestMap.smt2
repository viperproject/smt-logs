...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$w#2| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1|) |$w#2|))  (and ($IsBox |$w#2| |l#0|) (|Set#IsMember| |l#1| |$w#2|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |490|
 :pattern ( (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1|) |$w#2|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|$w#2@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#2| |l#0@@0|) |$w#2@@0|) (_System.Tuple2._0 ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType |l#0@@0| |$w#2@@0|))))
 :qid |gitissue336dfy.6:35|
 :skolemid |491|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#2| |l#0@@0|) |$w#2@@0|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestMap)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (and (and (forall ((|k#2| T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType |k#2|)) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType |k#2|)))))
 :qid |gitissue336dfy.6:15|
 :skolemid |479|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType |k#2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType |k#2|)))
)) (forall ((|k#3| T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType |k#3|)) (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType |k#3|)))))
 :qid |gitissue336dfy.8:15|
 :skolemid |480|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType |k#3|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType |k#3|)))
))) (= (ControlFlow 0 4) (- 0 3))) (|Map#Equal| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#1| TInt (|Map#Domain| |a#0|))) (|lambda#2| (|Map#Elements| |a#0|)) (TMap TInt TInt)) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#1| TInt (|Map#Domain| |a#0|))) (|lambda#2| (|Map#Elements| |a#0|)) (TMap TInt TInt))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |k#1@0|)))) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |k#1@0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |k#1@0|)))) (=> (and (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U |k#1@0|))))) (= (ControlFlow 0 5) 4)) anon6_correct)))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 8) 5) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct))))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |k#0@0|)))) (and (=> (= (ControlFlow 0 11) 8) anon9_Then_correct) (=> (= (ControlFlow 0 11) 2) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |k#0@0|))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |k#0@0|)))) (=> (_System.Tuple2.___hMake2_q ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U |k#0@0|))))) (and (=> (= (ControlFlow 0 9) 8) anon9_Then_correct) (=> (= (ControlFlow 0 9) 2) anon9_Else_correct)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |a#0| (TMap TInt (Tclass._System.Tuple2 TInt TInt))) ($IsAlloc MapType |a#0| (TMap TInt (Tclass._System.Tuple2 TInt TInt)) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
