...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|True.B.Valid#canCall| this) (and (< 0 $FunctionContextHeight) (and (or (not (= this null)) (not true)) ($Is refType this Tclass.True.B)))) (= (True.B.Valid true this) (U_2_bool (Lit boolType (bool_2_U true)))))
 :pattern ( (True.B.Valid true this))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|True.B.Valid#canCall| (Lit refType this@@0)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.True.B)))) (= (True.B.Valid true (Lit refType this@@0)) (U_2_bool (Lit boolType (bool_2_U true)))))
 :weight 3
 :pattern ( (True.B.Valid true (Lit refType this@@0)))
))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |b#0| Tclass.True.B) ($IsAlloc refType |b#0| Tclass.True.B $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
