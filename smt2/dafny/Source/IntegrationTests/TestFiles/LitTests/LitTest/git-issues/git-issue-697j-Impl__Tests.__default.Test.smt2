...
(let ((anon44_correct  (=> (= |b0#0@2| (forall ((|l0#0| Int) )  (=> (and (Tests.__default.P |l0#0|) (and (<= (LitInt 2) |l0#0|) (< |l0#0| 5))) (or (not (= |l0#0| 3)) (not true))))) (and (=> (= (ControlFlow 0 26) 24) anon84_Then_correct) (=> (= (ControlFlow 0 26) 20) anon84_Else_correct)))))
...
(let ((anon23_correct  (=> (= |b0#0@1| (forall ((|k0#0| Int) )  (=> (and (Tests.__default.P |k0#0|) (and (<= (LitInt 2) |k0#0|) (< |k0#0| 5))) (or (not (= |k0#0| 3)) (not true))))) (and (=> (= (ControlFlow 0 62) 61) anon71_Then_correct) (=> (= (ControlFlow 0 62) 58) anon71_Else_correct)))))
