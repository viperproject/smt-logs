...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module.Result$T@@14 T@U) (this@@4 T@U) ) (!  (=> (or (|_module.Result.Extract#canCall| _module.Result$T@@14 this@@4) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@4 (Tclass._module.Result _module.Result$T@@14)) (not (_module.Result.IsFailure _module.Result$T@@14 this@@4))))) (and (= (_module.Result.Extract _module.Result$T@@14 this@@4) (_module.Result.value this@@4)) ($IsBox (_module.Result.Extract _module.Result$T@@14 this@@4) _module.Result$T@@14)))
 :qid |unknown.0:0|
 :skolemid |604|
 :pattern ( (_module.Result.Extract _module.Result$T@@14 this@@4))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= |t#0| (_module.Result.value this@@5)))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (_module.Result.Success_q this@@5)) (=> (_module.Result.Success_q this@@5) (=> (and (and (= (_module.Result.Extract _module.Result$T@@15 this@@5) (_module.Result.value this@@5)) ($IsBox (_module.Result.Extract _module.Result$T@@15 this@@5) _module.Result$T@@15)) (and (= (_module.Result.Extract _module.Result$T@@15 this@@5) |t#0|) (= (ControlFlow 0 5) 4))) GeneratedUnifiedExit_correct)))))
(let ((anon5_Then_correct  (=> ($IsBox (_module.Result.Extract _module.Result$T@@15 this@@5) _module.Result$T@@15) (=> (and ($IsBox |t#0| _module.Result$T@@15) (= (ControlFlow 0 2) (- 0 1))) (_module.Result.Success_q this@@5)))))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) ($IsAllocBox ($Box DatatypeTypeType this@@5) (Tclass._module.Result _module.Result$T@@15) $Heap@@0)) (and (|_module.Result.IsFailure#canCall| _module.Result$T@@15 this@@5) (not (_module.Result.IsFailure _module.Result$T@@15 this@@5)))) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType this@@5 (Tclass._module.Result _module.Result$T@@15)) ($IsAlloc DatatypeTypeType this@@5 (Tclass._module.Result _module.Result$T@@15) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
