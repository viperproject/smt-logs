...
(set-info :boogie-vc-id Impl$$_module.Memory.fNullify_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.Memory) ($IsAlloc refType this@@40 Tclass._module.Memory $Heap@@21)))) (=> (and (and (and (and (and (and ($Is refType |o#0@@12| Tclass._module.Object) ($IsAlloc refType |o#0@@12| Tclass._module.Object $Heap@@21)) (and ($Is SeqType |f#0@@1| (TSeq TChar)) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@@21))) (and (and ($Is SetType |xedges#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |xedges#0| (TSet Tclass._module.Edge) $Heap@@21)) true)) (and (and (and ($Is SetType |xisos#0| (TSet Tclass._module.Object)) ($IsAlloc SetType |xisos#0| (TSet Tclass._module.Object) $Heap@@21)) true) (and (=> |defass#nedge#0| (and ($Is DatatypeTypeType |nedge#0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |nedge#0| Tclass._module.Edge $Heap@@21))) true))) (and (and (and (and ($Is SetType |zedges#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |zedges#0| (TSet Tclass._module.Edge) $Heap@@21)) true) (and (and (= 9 $FunctionContextHeight) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects)) ($Box refType |o#0@@12|))) (and (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |o#0@@12|)) ($Box SeqType |f#0@@1|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|))))) (and (and (and (|Set#IsMember| (_module.Memory.edges $Heap@@21 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Memory.objects))) ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@12| |f#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))) (not (_module.Region.Frozen_q (_module.Object.region |o#0@@12|)))) (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 this@@40) (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@21 alloc |o#0@@12| _module.Object.fields)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@21 $Heap@0) reveal__module.Memory.Valid))))) (and (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and reveal__module.Object.Valid ($IsAllocBox ($Box refType this@@40) Tclass._module.Memory? $Heap@1))) (and (and (= |##os#4@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects))) ($IsAlloc SetType |##os#4@0| (TSet Tclass._module.Object) $Heap@1)) (and (|_module.Memory.edges#canCall| $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects))) (|_module.Memory.edges#canCall| $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects)))))) (and (and (and (= |xedges#0@0| (_module.Memory.edges $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects)))) ($IsAllocBox ($Box refType this@@40) Tclass._module.Memory? $Heap@1)) (and (= |##os#5@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects))) ($IsAlloc SetType |##os#5@0| (TSet Tclass._module.Object) $Heap@1))) (and (and (|_module.Memory.justTheIsos#canCall| $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects))) (|_module.Memory.justTheIsos#canCall| $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects)))) (and (= |xisos#0@0| (_module.Memory.justTheIsos $Heap@1 this@@40 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@40) _module.Memory.objects)))) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= |o#0@@12| null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
