...
(set-info :boogie-vc-id Impl$$Absy.__default.Foo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |x#0@0| (LitInt 1)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (Div 2 (LitInt 0))) (LitInt 1))))))
