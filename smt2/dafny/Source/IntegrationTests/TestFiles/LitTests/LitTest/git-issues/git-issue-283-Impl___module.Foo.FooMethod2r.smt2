...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon19_Else_correct true))
...
(let ((anon25_Else_correct  (=> (and (or (or (= |x#5@3| (LitReal 0.0)) (= |x#5@3| (LitReal 1.0))) (= |x#5@3| (LitReal 3.0))) (= (ControlFlow 0 7) 4)) GeneratedUnifiedExit_correct)))
(let ((anon25_Then_correct true))
(let ((anon15_correct  (and (=> (= (ControlFlow 0 8) 2) anon25_Then_correct) (=> (= (ControlFlow 0 8) 7) anon25_Else_correct))))
(let ((anon24_Else_correct  (=> (and (or (= |x#5@3| (LitReal 0.0)) (= |x#5@3| (LitReal 1.0))) (= (ControlFlow 0 10) 8)) anon15_correct)))
(let ((anon24_Then_correct  (=> (and (not (or (= |x#5@3| (LitReal 0.0)) (= |x#5@3| (LitReal 1.0)))) (= (ControlFlow 0 9) 8)) anon15_correct)))
(let ((anon23_Else_correct  (=> (= |x#5@3| (LitReal 0.0)) (and (=> (= (ControlFlow 0 12) 9) anon24_Then_correct) (=> (= (ControlFlow 0 12) 10) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (or (not (= |x#5@3| (LitReal 0.0))) (not true)) (and (=> (= (ControlFlow 0 11) 9) anon24_Then_correct) (=> (= (ControlFlow 0 11) 10) anon24_Else_correct)))))
(let ((anon11_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (or (= |x#5@3| (LitReal 0.0)) (= |x#5@3| (LitReal 1.0))) (= |x#5@3| (LitReal 3.0)))) (=> (or (or (= |x#5@3| (LitReal 0.0)) (= |x#5@3| (LitReal 1.0))) (= |x#5@3| (LitReal 3.0))) (and (=> (= (ControlFlow 0 13) 11) anon23_Then_correct) (=> (= (ControlFlow 0 13) 12) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (or (= |x#5@3| (LitReal 0.0)) (= |x#5@3| (LitReal 1.0))) (= (ControlFlow 0 16) 13)) anon11_correct)))
(let ((anon22_Then_correct  (=> (and (not (or (= |x#5@3| (LitReal 0.0)) (= |x#5@3| (LitReal 1.0)))) (= (ControlFlow 0 15) 13)) anon11_correct)))
(let ((anon21_Else_correct  (=> (= |x#5@3| (LitReal 0.0)) (and (=> (= (ControlFlow 0 18) 15) anon22_Then_correct) (=> (= (ControlFlow 0 18) 16) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (or (not (= |x#5@3| (LitReal 0.0))) (not true)) (and (=> (= (ControlFlow 0 17) 15) anon22_Then_correct) (=> (= (ControlFlow 0 17) 16) anon22_Else_correct)))))
(let ((anon19_Then_correct  (=> (and (= |_mcc#0#1_0@0| (|#_module.C.C2| |_mcc#1#1_0_0@0|)) (= |let#1_0_0#0#0| |_mcc#1#1_0_0@0|)) (=> (and (and ($Is intType (int_2_U |let#1_0_0#0#0|) TInt) (= |x#1_0_0@0| |let#1_0_0#0#0|)) (and (= |x#1_0_0@1| (LitInt 2)) (= |x#5@3| |x#5@0|))) (and (=> (= (ControlFlow 0 22) 17) anon21_Then_correct) (=> (= (ControlFlow 0 22) 18) anon21_Else_correct))))))
(let ((anon18_Else_correct  (=> (or (not (= |_mcc#0#1_0@0| |#_module.C.C1|)) (not true)) (and (=> (= (ControlFlow 0 24) 22) anon19_Then_correct) (=> (= (ControlFlow 0 24) 23) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (= |_mcc#0#1_0@0| |#_module.C.C1|) (=> (and (= |x#5@2| (LitReal 1.0)) (= |x#5@3| |x#5@2|)) (and (=> (= (ControlFlow 0 21) 17) anon21_Then_correct) (=> (= (ControlFlow 0 21) 18) anon21_Else_correct))))))
(let ((anon17_Then_correct  (=> (= |r#0| (|#_module.Result.Success| ($Box DatatypeTypeType |_mcc#0#1_0@0|))) (=> (and ($Is DatatypeTypeType |_mcc#0#1_0@0| Tclass._module.C) ($IsAlloc DatatypeTypeType |_mcc#0#1_0@0| Tclass._module.C $Heap)) (and (=> (= (ControlFlow 0 25) 21) anon18_Then_correct) (=> (= (ControlFlow 0 25) 24) anon18_Else_correct))))))
(let ((anon20_Then_correct  (=> (= |r#0| (|#_module.Result.Failure| |_mcc#2#0_0@0|)) (=> (and ($Is SeqType |_mcc#2#0_0@0| (TSeq TChar)) ($IsAlloc SeqType |_mcc#2#0_0@0| (TSeq TChar) $Heap)) (=> (and (and (and ($Is SeqType |e#0_0@0| (TSeq TChar)) ($IsAlloc SeqType |e#0_0@0| (TSeq TChar) $Heap)) (= |let#0_0#0#0| |_mcc#2#0_0@0|)) (and (and ($Is SeqType |let#0_0#0#0| (TSeq TChar)) (= |e#0_0@0| |let#0_0#0#0|)) (and (= |x#5@1| (LitReal 3.0)) (= |x#5@3| |x#5@1|)))) (and (=> (= (ControlFlow 0 19) 17) anon21_Then_correct) (=> (= (ControlFlow 0 19) 18) anon21_Else_correct)))))))
(let ((anon20_Else_correct true))
(let ((anon17_Else_correct  (=> (or (not (= |r#0| (|#_module.Result.Success| ($Box DatatypeTypeType |_mcc#0#1_0@0|)))) (not true)) (and (=> (= (ControlFlow 0 20) 19) anon20_Then_correct) (=> (= (ControlFlow 0 20) 1) anon20_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x#5@0| (LitReal 0.0))) (and (=> (= (ControlFlow 0 26) 25) anon17_Then_correct) (=> (= (ControlFlow 0 26) 20) anon17_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Foo) ($IsAlloc refType this Tclass._module.Foo $Heap)))) (=> (and (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result Tclass._module.C)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result Tclass._module.C) $Heap)) (|$IsA#_module.Result| |r#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 27) 26))) anon0_correct))))
