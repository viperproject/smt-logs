...
(set-info :boogie-vc-id Impl$$_module.__default.GetNext)
...
(let ((anon7_Else_correct  (=> (and (or (not (= (Mod |i#0| (LitInt 2)) (LitInt 0))) (not true)) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon7_Then_correct  (=> (= (Mod |i#0| (LitInt 2)) (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))))
(let ((anon6_Else_correct  (=> (and (or (not (= |i#0| (LitInt 1))) (not true)) (= |possible#0@1| (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 6) 3) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 1) anon6_Then_correct) (=> (= (ControlFlow 0 8) 6) anon6_Else_correct)))))
