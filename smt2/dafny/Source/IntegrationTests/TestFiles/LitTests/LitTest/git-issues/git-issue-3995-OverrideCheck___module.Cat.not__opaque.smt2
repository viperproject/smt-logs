...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let (($generated@@131  (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= $generated@@126 ($generated@@85 $generated@@27 $generated@@127 $generated false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($generated@@132 T@U) ($generated@@133 T@U) ) true)))))
(let (($generated@@134  (=> (and ($generated@@128 $generated@@127) ($generated@@129 $generated@@127)) (=> (and (and (or (not (= $generated@@130 $generated@@27)) (not true)) (and ($generated@@28 $generated@@25 $generated@@130 $generated@@29) ($generated@@36 $generated@@25 $generated@@130 $generated@@29 $generated@@127))) (and (= 0 $generated@@22) (= (ControlFlow 0 4) 2))) $generated@@131))))
$generated@@134)))
))
(check-sat)
(get-info :rlimit)
