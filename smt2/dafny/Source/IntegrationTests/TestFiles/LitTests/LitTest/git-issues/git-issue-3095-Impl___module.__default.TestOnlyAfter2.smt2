...
(set-info :boogie-vc-id Impl$$_module.__default.TestOnlyAfter2)
...
(let ((anon3_Then_correct  (=> (>= |i#0| (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= |i#0| (LitInt 3))) (=> (>= |i#0| (LitInt 3)) (=> (= (ControlFlow 0 2) (- 0 1)) (>= |i#0| (LitInt 4))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (>= |i#0| (LitInt 1))) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))
