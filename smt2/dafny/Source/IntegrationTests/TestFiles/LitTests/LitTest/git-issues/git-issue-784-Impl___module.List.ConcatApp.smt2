...
(assert (forall ((_module.List$T@@7 T@U) (d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@7)) (or (_module.List.Nil_q d@@4) (_module.List.Cons_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( (_module.List.Cons_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@7)))
 :pattern ( (_module.List.Nil_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@7)))
)))
...
(assert (forall ((d@@5 T@U) (_module.List$T@@11 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.List _module.List$T@@11) $h@@0))) ($IsAllocBox (_module.List._h0 d@@5) _module.List$T@@11 $h@@0))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( ($IsAllocBox (_module.List._h0 d@@5) _module.List$T@@11 $h@@0))
)))
...
(assert (forall ((d@@7 T@U) (_module.List$T@@16 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.List.Cons_q d@@7) ($IsAlloc DatatypeTypeType d@@7 (Tclass._module.List _module.List$T@@16) $h@@1))) ($IsAlloc DatatypeTypeType (_module.List._h1 d@@7) (Tclass._module.List _module.List$T@@16) $h@@1))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h1 d@@7) (Tclass._module.List _module.List$T@@16) $h@@1))
)))
...
(declare-fun _module.List.ConcatApp$T () T@U)
...
(declare-fun $Heap@@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.List.ConcatApp)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|_module.List#Equal| (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS ($LS $LZ)) (_module.List.App (Tclass._module.List _module.List.ConcatApp$T) ($LS ($LS $LZ)) |l1#0| |l2#0|)) (_module.List.App _module.List.ConcatApp$T ($LS ($LS $LZ)) (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS ($LS $LZ)) |l1#0|) (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS ($LS $LZ)) |l2#0|))))))
(let ((anon5_Then_correct  (=> (= |l1#0| (|#_module.List.Cons| ($Box DatatypeTypeType |_mcc#0#0_0@0|) |_mcc#1#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#0#0_0@0| (Tclass._module.List _module.List.ConcatApp$T)) ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T)))) (=> (and (and (and ($Is DatatypeTypeType |xs#0_0@0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T))) ($IsAlloc DatatypeTypeType |xs#0_0@0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T)) $Heap@0)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T))) (= |xs#0_0@0| |let#0_0#0#0|))) (=> (and (and (and (and (and ($Is DatatypeTypeType |x#0_0@0| (Tclass._module.List _module.List.ConcatApp$T)) ($IsAlloc DatatypeTypeType |x#0_0@0| (Tclass._module.List _module.List.ConcatApp$T) $Heap@0)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and (and ($Is DatatypeTypeType |let#0_1#0#0| (Tclass._module.List _module.List.ConcatApp$T)) (= |x#0_0@0| |let#0_1#0#0|)) (and ($IsAlloc DatatypeTypeType |xs#0_0@0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T)) $Heap@0) (|_module.List.Concat#canCall| _module.List$T@@19 _module.List.ConcatApp$T |xs#0_0@0|)))) (and (and (and (|_module.List.Concat#canCall| _module.List$T@@19 _module.List.ConcatApp$T |xs#0_0@0|) (= |m##0_0@0| (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS $LZ) |xs#0_0@0|))) (and ($IsAlloc DatatypeTypeType |l2#0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T)) $Heap@0) (|_module.List.Concat#canCall| _module.List$T@@19 _module.List.ConcatApp$T |l2#0|))) (and (and (|_module.List.Concat#canCall| _module.List$T@@19 _module.List.ConcatApp$T |l2#0|) (= |n##0_0@0| (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS $LZ) |l2#0|))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))))) (and (and (and (and (|$IsA#_module.List| (_module.List.App _module.List.ConcatApp$T ($LS $LZ) (_module.List.App _module.List.ConcatApp$T ($LS $LZ) |x#0_0@0| |m##0_0@0|) |n##0_0@0|)) (|$IsA#_module.List| (_module.List.App _module.List.ConcatApp$T ($LS $LZ) |x#0_0@0| (_module.List.App _module.List.ConcatApp$T ($LS $LZ) |m##0_0@0| |n##0_0@0|)))) (and (and (|_module.List.App#canCall| _module.List.ConcatApp$T |x#0_0@0| |m##0_0@0|) (|_module.List.App#canCall| _module.List.ConcatApp$T (_module.List.App _module.List.ConcatApp$T ($LS $LZ) |x#0_0@0| |m##0_0@0|) |n##0_0@0|)) (and (|_module.List.App#canCall| _module.List.ConcatApp$T |m##0_0@0| |n##0_0@0|) (|_module.List.App#canCall| _module.List.ConcatApp$T |x#0_0@0| (_module.List.App _module.List.ConcatApp$T ($LS $LZ) |m##0_0@0| |n##0_0@0|))))) (|_module.List#Equal| (_module.List.App _module.List.ConcatApp$T ($LS ($LS $LZ)) (_module.List.App _module.List.ConcatApp$T ($LS ($LS $LZ)) |x#0_0@0| |m##0_0@0|) |n##0_0@0|) (_module.List.App _module.List.ConcatApp$T ($LS ($LS $LZ)) |x#0_0@0| (_module.List.App _module.List.ConcatApp$T ($LS ($LS $LZ)) |m##0_0@0| |n##0_0@0|)))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 5) 3)))) GeneratedUnifiedExit_correct))))))
(let ((anon4_Then_correct  (=> (and (= |l1#0| |#_module.List.Nil|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |l1#0| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 1) anon5_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (|$IsA#_module.List| |l1#0|) (|$IsA#_module.List| |l2#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) (forall ((|$ih#l10#0| T@U) (|$ih#l20#0| T@U) ) (!  (=> (and (and (and ($Is DatatypeTypeType |$ih#l10#0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T))) ($Is DatatypeTypeType |$ih#l20#0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T)))) (U_2_bool (Lit boolType (bool_2_U true)))) (or (< (DtRank |$ih#l10#0|) (DtRank |l1#0|)) (and (= (DtRank |$ih#l10#0|) (DtRank |l1#0|)) (< (DtRank |$ih#l20#0|) (DtRank |l2#0|))))) (|_module.List#Equal| (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS $LZ) (_module.List.App (Tclass._module.List _module.List.ConcatApp$T) ($LS $LZ) |$ih#l10#0| |$ih#l20#0|)) (_module.List.App _module.List.ConcatApp$T ($LS $LZ) (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS $LZ) |$ih#l10#0|) (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS $LZ) |$ih#l20#0|))))
 :qid |gitissue784dfy.20:29|
 :skolemid |525|
 :pattern ( (_module.List.App _module.List.ConcatApp$T ($LS $LZ) (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS $LZ) |$ih#l10#0|) (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS $LZ) |$ih#l20#0|)))
 :pattern ( (_module.List.Concat _module.List$T@@19 _module.List.ConcatApp$T ($LS $LZ) (_module.List.App (Tclass._module.List _module.List.ConcatApp$T) ($LS $LZ) |$ih#l10#0| |$ih#l20#0|)))
)))) (and (=> (= (ControlFlow 0 7) 4) anon4_Then_correct) (=> (= (ControlFlow 0 7) 6) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is DatatypeTypeType |l1#0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T))) ($IsAlloc DatatypeTypeType |l1#0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T)) $Heap@@1)) (|$IsA#_module.List| |l1#0|)) (=> (and (and (and ($Is DatatypeTypeType |l2#0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T))) ($IsAlloc DatatypeTypeType |l2#0| (Tclass._module.List (Tclass._module.List _module.List.ConcatApp$T)) $Heap@@1)) (|$IsA#_module.List| |l2#0|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))))
