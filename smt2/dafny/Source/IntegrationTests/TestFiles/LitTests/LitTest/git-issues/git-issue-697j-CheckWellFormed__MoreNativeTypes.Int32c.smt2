...
(set-info :boogie-vc-id CheckWellFormed$$MoreNativeTypes.Int32c)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Then_correct  (=> (= |newtype$check#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= (LitInt (- 0 2147483648)) |newtype$check#1@0|)) (=> (<= (LitInt (- 0 2147483648)) |newtype$check#1@0|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< |newtype$check#1@0| 2147483648)) (=> (< |newtype$check#1@0| 2147483648) (=> (= (ControlFlow 0 5) (- 0 4)) (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 3)) (not true)))))))))))))
(let ((anon5_Then_correct  (=> (and (and (<= (LitInt (- 0 2147483648)) |x#0|) (< |x#0| 2147483648)) (= |newtype$check#0@0| (LitInt 3))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt (- 0 2147483648)) |newtype$check#0@0|)) (=> (<= (LitInt (- 0 2147483648)) |newtype$check#0@0|) (=> (= (ControlFlow 0 2) (- 0 1)) (< |newtype$check#0@0| 2147483648)))))))
