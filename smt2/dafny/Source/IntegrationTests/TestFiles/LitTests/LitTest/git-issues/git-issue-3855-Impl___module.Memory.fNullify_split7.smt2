...
(set-info :boogie-vc-id Impl$$_module.Memory.fNullify_split7)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@23) ($IsHeapAnchor $Heap@@23)) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Memory) ($IsAlloc refType this@@53 Tclass._module.Memory $Heap@@23)))) (=> (and (and (and ($Is refType |o#0@@12| Tclass._module.Object) ($IsAlloc refType |o#0@@12| Tclass._module.Object $Heap@@23)) (and ($Is SeqType |f#0@@1| (TSeq TChar)) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@@23))) (and (and ($Is SetType |xedges#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |xedges#0| (TSet Tclass._module.Edge) $Heap@@23)) true)) (=> (and (and (and (and (and ($Is SetType |xisos#0| (TSet Tclass._module.Object)) ($IsAlloc SetType |xisos#0| (TSet Tclass._module.Object) $Heap@@23)) true) (and (=> |defass#nedge#0| (and ($Is DatatypeTypeType |nedge#0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |nedge#0| Tclass._module.Edge $Heap@@23))) true)) (and (and ($Is SetType |zedges#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |zedges#0| (TSet Tclass._module.Edge) $Heap@@23)) true)) (and (and (and (= 9 $FunctionContextHeight) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects)) ($Box refType |o#0@@12|))) (and (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |o#0@@12|)) ($Box SeqType |f#0@@1|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))) (and (and (|Set#IsMember| (_module.Memory.edges $Heap@@23 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects))) ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@12| |f#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))) (not (_module.Region.Frozen_q (_module.Object.region |o#0@@12|)))) (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@23 this@@53) (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@23 alloc |o#0@@12| _module.Object.fields)))))) (=> (and (and (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@23 $Heap@0) reveal__module.Memory.Valid)) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1))) (and (and (and reveal__module.Object.Valid ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@1)) (and (= |##os#4@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))) ($IsAlloc SetType |##os#4@0| (TSet Tclass._module.Object) $Heap@1))) (and (and (|_module.Memory.edges#canCall| $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))) (|_module.Memory.edges#canCall| $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects)))) (and (= |xedges#0@0| (_module.Memory.edges $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects)))) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@1))))) (and (and (and (and (= |##os#5@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))) ($IsAlloc SetType |##os#5@0| (TSet Tclass._module.Object) $Heap@1)) (and (|_module.Memory.justTheIsos#canCall| $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))) (|_module.Memory.justTheIsos#canCall| $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))))) (and (and (= |xisos#0@0| (_module.Memory.justTheIsos $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects)))) (or (not (= |o#0@@12| null)) (not true))) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)) (= |nedge#0@0| (|#_module.Edge.Edge| |o#0@@12| |f#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))))) (and (and (and (or (not (= |o#0@@12| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |o#0@@12| _module.Object.fields))) (and (or (not (= |o#0@@12| null)) (not true)) (= |##m#1@0| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields))))) (and (and ($IsAlloc MapType |##m#1@0| (TMap (TSeq TChar) Tclass._module.Object) $Heap@1) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@1)) (and (|_module.__default.RemoveKey#canCall| (TSeq TChar) Tclass._module.Object ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|)) (|_module.__default.RemoveKey#canCall| (TSeq TChar) Tclass._module.Object ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|))))))) (and (and (and (and (and (= |$rhs#0@0| (_module.__default.RemoveKey (TSeq TChar) Tclass._module.Object reveal__module._default.RemoveKey ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|))) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields ($Box MapType |$rhs#0@0|))))) (and ($IsGoodHeap $Heap@2) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@2))) (and (and (= |##os#6@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@53) _module.Memory.objects))) ($IsAlloc SetType |##os#6@0| (TSet Tclass._module.Object) $Heap@2)) (and (|_module.Memory.edges#canCall| $Heap@2 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@53) _module.Memory.objects))) (|_module.Memory.edges#canCall| $Heap@2 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@53) _module.Memory.objects)))))) (and (and (and (= |zedges#0@0| (_module.Memory.edges $Heap@2 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@53) _module.Memory.objects)))) (|Set#Subset| |zedges#0@0| |xedges#0@0|)) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3))) (and (and (forall ((|i#1| T@U) ) (!  (=> ($Is refType |i#1| Tclass._module.Object) (=> (|Set#IsMember| |xisos#0@0| ($Box refType |i#1|)) (and (|_module.Memory.refCountEdges#canCall| this@@53 |i#1| |xedges#0@0|) (|_module.Memory.refCountEdges#canCall| this@@53 |i#1| |zedges#0@0|))))
...
))) (and (= $Heap@2 $Heap@3) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3))))) (and (and (and (and ($IsAlloc SetType |xedges#0@0| (TSet Tclass._module.Edge) $Heap@3) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |xedges#0@0|)) (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |xedges#0@0|) (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |xedges#0@0|))) (and (and ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3) ($IsAlloc SetType |zedges#0@0| (TSet Tclass._module.Edge) $Heap@3)) (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|)))) (and (and (and (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |zedges#0@0|) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3)) (and ($IsAlloc SetType |zedges#0@0| (TSet Tclass._module.Edge) $Heap@3) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|))) (and (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|) (= (ControlFlow 0 2) (- 0 1))) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|)))))) (or (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |zedges#0@0|) (let ((|heapExternalEdges#1@@1| (_module.Memory.justHeapExternalEdges this@@53 |zedges#0@0|)))
...
(let ((|heapExternalEdgesPartitionedByRegion#1@@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region |allRelevantHeapRegions#1@@1|)) (|lambda#55| this@@53 |heapExternalEdges#1@@1|) (TMap Tclass._module.Region (TSet Tclass._module.Edge)))))
