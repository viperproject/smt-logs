...
(assert (distinct TInt TagInt alloc allocName Tagclass._module.Cell Tagclass._module.Result Tagclass._module.Cell? class._module.Cell? tytagFamily$Cell tytagFamily$Result field$data)
)
(assert (= (FDim alloc) 0))
...
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is DatatypeTypeType |r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0@0| (Tclass._module.Result TInt) $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |c#0@@1| null)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |c#0@@1| Tclass._module.Cell) ($IsAlloc refType |c#0@@1| Tclass._module.Cell $Heap))) (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
