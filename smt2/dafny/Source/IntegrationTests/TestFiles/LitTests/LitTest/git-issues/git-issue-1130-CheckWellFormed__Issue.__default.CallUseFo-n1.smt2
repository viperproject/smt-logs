...
(set-info :boogie-vc-id CheckWellFormed$$Issue.__default.CallUseFoo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc (Issue.Foo.Repr Issue._default.CallUseFoo$T |t#0|))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |t#0| null)) (not true)))))
