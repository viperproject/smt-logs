...
(set-info :boogie-vc-id CheckWellFormed$$DafnyNaCl.__default.R2256)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= DafnyNaCl.__default.P 0)) (not true)))))
