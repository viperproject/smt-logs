...
(assert (distinct TBool TReal TagBool TagReal alloc Tagclass._module.Gen Tagclass._module.IntB Tagclass._module.IntC Tagclass._module.GenSub |##_module.Gen.Create| tytagFamily$Gen tytagFamily$IntB tytagFamily$IntC tytagFamily$GenSub)
)
...
(assert (forall ((_module.GenSub$Y@@5 T@U) (_module.GenSub$L@@5 T@U) (_module.GenSub$V@@5 T@U) (|g#0@@0| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc DatatypeTypeType |g#0@@0| (Tclass._module.GenSub _module.GenSub$Y@@5 _module.GenSub$L@@5 _module.GenSub$V@@5) $h@@1) ($IsAlloc DatatypeTypeType |g#0@@0| (Tclass._module.Gen _module.GenSub$L@@5) $h@@1))
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( ($IsAlloc DatatypeTypeType |g#0@@0| (Tclass._module.GenSub _module.GenSub$Y@@5 _module.GenSub$L@@5 _module.GenSub$V@@5) $h@@1))
)))
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.IntC) (and (= ($Box intType ($Unbox intType bx@@1)) bx@@1) ($Is intType ($Unbox intType bx@@1) Tclass._module.IntC)))
 :qid |unknown.0:0|
 :skolemid |510|
 :pattern ( ($IsBox bx@@1 Tclass._module.IntC))
)))
(assert (forall ((_module.Gen$X@@1 T@U) (|a#7#0#0| T@U) ($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) (= ($IsAlloc DatatypeTypeType (|#_module.Gen.Create| |a#7#0#0|) (Tclass._module.Gen _module.Gen$X@@1) $h@@2) ($IsAllocBox |a#7#0#0| _module.Gen$X@@1 $h@@2)))
 :qid |unknown.0:0|
 :skolemid |537|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Gen.Create| |a#7#0#0|) (Tclass._module.Gen _module.Gen$X@@1) $h@@2))
)))
...
(assert (forall ((d@@3 T@U) (_module.Gen$X@@4 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (_module.Gen.Create_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass._module.Gen _module.Gen$X@@4) $h@@3))) ($IsAllocBox (_module.Gen.x d@@3) _module.Gen$X@@4 $h@@3))
 :qid |unknown.0:0|
 :skolemid |538|
 :pattern ( ($IsAllocBox (_module.Gen.x d@@3) _module.Gen$X@@4 $h@@3))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.B2C_k)
...
(let ((anon6_Then_correct  (=> (and (= |g#0@@1| (|#_module.Gen.Create| ($Box intType (int_2_U |_mcc#0#0_0_0@0|)))) (= (Mod |_mcc#0#0_0_0@0| (LitInt 2)) (LitInt 0))) (=> (and (and (= (Mod |u#0_0_0@0| (LitInt 2)) (LitInt 0)) (<= (LitInt 0) |u#0_0_0@0|)) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U |_mcc#0#0_0_0@0|) Tclass._module.IntC)))))
(let ((anon5_Then_correct  (=> (= (U_2_int ($Unbox intType (_module.Gen.x |g#0@@1|))) |m#0|) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (_module.Gen.Create_q |g#0@@1|) (_module.Gen.Create_q |g#0@@1|)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 1) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |g#0@@1| (Tclass._module.GenSub TBool Tclass._module.IntB TReal)) ($IsAlloc DatatypeTypeType |g#0@@1| (Tclass._module.GenSub TBool Tclass._module.IntB TReal) $Heap)) (|$IsA#_module.Gen| |g#0@@1|)) (U_2_bool (Lit boolType (bool_2_U true)))) (and (and (and (= (Mod |y#0| (LitInt 2)) (LitInt 0)) (<= (LitInt 0) |y#0|)) (= 3 $FunctionContextHeight)) (and (=> (< |m#0| 0) (= (Mod |m#0| (LitInt 2)) (LitInt 1))) (= (ControlFlow 0 7) 6)))) anon0_correct))))
