...
(assert (distinct TChar TInt TagChar TagInt TagSeq alloc allocName Tagclass._module.Cell Tagclass._module.Result Tagclass._module.Cell? |##_module.Result.Failure| |##_module.Result.Success| class._module.Cell? tytagFamily$Cell tytagFamily$Result field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((_module.Result$T@@0 T@U) (|a#9#0#0| T@U) ($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) (= ($IsAlloc DatatypeTypeType (|#_module.Result.Success| |a#9#0#0|) (Tclass._module.Result _module.Result$T@@0) $h@@2) ($IsAllocBox |a#9#0#0| _module.Result$T@@0 $h@@2)))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Result.Success| |a#9#0#0|) (Tclass._module.Result _module.Result$T@@0) $h@@2))
)))
...
(assert (forall ((_module.Result$T@@2 T@U) (|a#2#0#0| T@U) ($h@@4 T@U) ) (!  (=> ($IsGoodHeap $h@@4) (= ($IsAlloc DatatypeTypeType (|#_module.Result.Failure| |a#2#0#0|) (Tclass._module.Result _module.Result$T@@2) $h@@4) ($IsAlloc SeqType |a#2#0#0| (TSeq TChar) $h@@4)))
 :qid |unknown.0:0|
 :skolemid |500|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Result.Failure| |a#2#0#0|) (Tclass._module.Result _module.Result$T@@2) $h@@4))
)))
...
(assert (forall (($h@@5 T@U) ($o@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass._module.Cell?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@3) _module.Cell.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |540|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@3) _module.Cell.data)))
)))
...
(assert (forall ((d@@5 T@U) (_module.Result$T@@6 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_module.Result.Success_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.Result _module.Result$T@@6) $h@@6))) ($IsAllocBox (_module.Result.value d@@5) _module.Result$T@@6 $h@@6))
 :qid |unknown.0:0|
 :skolemid |513|
 :pattern ( ($IsAllocBox (_module.Result.value d@@5) _module.Result$T@@6 $h@@6))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |c#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| _module.Cell.data)) (=> (= |$rhs#0@0| (LitInt 7)) (=> (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |c#0@@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.Cell.data ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (= |r#0@0| (Lit DatatypeTypeType (|#_module.Result.Success| ($Box intType (int_2_U (LitInt 200)))))) (= (ControlFlow 0 2) (- 0 1)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) _module.Cell.data))) (LitInt 7)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |c#0@@1| Tclass._module.Cell) ($IsAlloc refType |c#0@@1| Tclass._module.Cell $Heap))) (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))
