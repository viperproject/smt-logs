...
(declare-fun $generated@@93 () (_ BitVec 16))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@97  (=> (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false)) (= (ControlFlow 0 2) (- 0 1))) (let (($generated@@98 ((_ int2bv 32) $generated@@92)))
(= (bvshl (concat #x0000 $generated@@93) (concat #b00000000000000000000000000 ((_ extract 5 0) $generated@@98))) (concat #x0000 (bvshl $generated@@93 (concat #b00000000000 ((_ extract 4 0) $generated@@98)))))))))
(let (($generated@@99  (=> (and (and ($generated@@94 $generated@@90) ($generated@@95 $generated@@90)) (<= ($generated 0) $generated@@92)) (=> (and (and (and (= 0 $generated@@96) (<= ($generated 0) $generated@@92)) (and (<= $generated@@92 ($generated 8)) (bvule #x00000000 ((_ int2bv 32) $generated@@92)))) (and (and (bvule ((_ int2bv 32) $generated@@92) #x00000008) (bvule #x0000 $generated@@93)) (and (bvult $generated@@93 (bvshl #x0001 (concat #b00000000000 #b01000))) (= (ControlFlow 0 3) 2)))) $generated@@97))))
$generated@@99)))
))
(check-sat)
(get-info :rlimit)
