...
(set-info :boogie-vc-id Impl$$_module.__default.ModifiesClauses)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#41| null $Heap alloc |S#0| |T#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |p#0| null)) (not true))) (=> (or (not (= |p#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |p#0| _module.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |p#0| _module.Cell.data)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |p#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |p#0|) _module.Cell.data ($Box intType (int_2_U |n#0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |q#0| null)) (not true))) (=> (or (not (= |q#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |q#0| _module.Cell.data)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |S#0| (TSet Tclass._System.object)) ($IsAlloc SetType |S#0| (TSet Tclass._System.object) $Heap)) (and ($Is SetType |T#0| (TSet Tclass._System.object)) ($IsAlloc SetType |T#0| (TSet Tclass._System.object) $Heap))) (=> (and (and (and ($Is refType |p#0| Tclass._module.Cell) ($IsAlloc refType |p#0| Tclass._module.Cell $Heap)) (and ($Is refType |q#0| Tclass._module.Cell) ($IsAlloc refType |q#0| Tclass._module.Cell $Heap))) (and (and (= 1 $FunctionContextHeight) (|Set#IsMember| (|Set#Union| |S#0| |T#0|) ($Box refType |p#0|))) (and (|Set#IsMember| |S#0| ($Box refType |q#0|)) (= (ControlFlow 0 6) 2)))) anon0_correct)))))
