...
(declare-fun _module.__default.Loop (T@U T@U) T@U)
(declare-fun $LS (T@U) T@U)
(declare-fun |_module.__default.Loop#canCall| (T@U) Bool)
...
(assert (distinct TBool TagBool TagSet TagSeq alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 |##_System._tuple#0._#Make0| Tagclass._System.Tuple0 tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| |tytagFamily$_tuple#0|)
)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#e#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0|) |$l#0#heap#0| |$l#0#e#0|)) ($IsBox |$l#0#e#0| |l#0|))
 :qid |DafnyPreludebpl.21:1|
 :skolemid |490|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0|) |$l#0#heap#0| |$l#0#e#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.Loop#canCall| |xs#0|) (and (< 0 $FunctionContextHeight) ($Is SeqType |xs#0| (TSeq Tclass._System.Tuple0)))) (and (=> (or (not (= (|Seq#Length| |xs#0|) (LitInt 0))) (not true)) (|_module.__default.Loop#canCall| (|Seq#Drop| |xs#0| (LitInt 1)))) (= (_module.__default.Loop ($LS $ly) |xs#0|) (ite (= (|Seq#Length| |xs#0|) (LitInt 0)) |#_System._tuple#0._#Make0| (_module.__default.Loop $ly (|Seq#Drop| |xs#0| (LitInt 1)))))))
 :qid |gitissue5523dfy.3:10|
 :skolemid |483|
 :pattern ( (_module.__default.Loop ($LS $ly) |xs#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.Loop#canCall| |xs#0@@0|) (and (< 0 $FunctionContextHeight) ($Is SeqType |xs#0@@0| (TSeq Tclass._System.Tuple0)))) ($Is DatatypeTypeType (_module.__default.Loop $ly@@0 |xs#0@@0|) Tclass._System.Tuple0))
 :qid |gitissue5523dfy.3:10|
 :skolemid |481|
 :pattern ( (_module.__default.Loop $ly@@0 |xs#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (! (= (_module.__default.Loop ($LS $ly@@1) |xs#0@@1|) (_module.__default.Loop $ly@@1 |xs#0@@1|))
 :qid |gitissue5523dfy.3:10|
 :skolemid |479|
 :pattern ( (_module.__default.Loop ($LS $ly@@1) |xs#0@@1|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@2| |l#1| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1| $o@@1) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |494|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@2| |l#1| |l#2| |l#3|) $o@@1 $f))
)))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#e#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#0| |$l#0#heap#0@@0| |$l#0#e#0@@0|) ($Box boolType ($Unbox boolType |$l#0#e#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |489|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#0| |$l#0#heap#0@@0| |$l#0#e#0@@0|))
)))
...
(assert (forall ((d@@2 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) ($Is DatatypeTypeType d@@2 Tclass._System.Tuple0)) ($IsAlloc DatatypeTypeType d@@2 Tclass._System.Tuple0 $h@@3))
 :qid |unknown.0:0|
 :skolemid |474|
 :pattern ( ($IsAlloc DatatypeTypeType d@@2 Tclass._System.Tuple0 $h@@3))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.Loop#canCall| (Lit SeqType |xs#0@@2|)) (and (< 0 $FunctionContextHeight) ($Is SeqType |xs#0@@2| (TSeq Tclass._System.Tuple0)))) (and (=> (or (not (= (|Seq#Length| (Lit SeqType |xs#0@@2|)) (LitInt 0))) (not true)) (|_module.__default.Loop#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |xs#0@@2|) (LitInt 1))))) (= (_module.__default.Loop ($LS $ly@@2) (Lit SeqType |xs#0@@2|)) (ite (= (|Seq#Length| (Lit SeqType |xs#0@@2|)) (LitInt 0)) |#_System._tuple#0._#Make0| (Lit DatatypeTypeType (_module.__default.Loop ($LS $ly@@2) (Lit SeqType (|Seq#Drop| (Lit SeqType |xs#0@@2|) (LitInt 1)))))))))
 :qid |gitissue5523dfy.3:10|
 :weight 3
 :skolemid |484|
 :pattern ( (_module.__default.Loop ($LS $ly@@2) (Lit SeqType |xs#0@@2|)))
))))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#e#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#e#0@@1|) |l#0@@3|)
 :qid |gitissue5523dfy.8:28|
 :skolemid |492|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#3| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#e#0@@1|))
)))
...
(declare-fun $LZ () T@U)
(declare-fun |_v0#Z#0@0| () T@U)
(declare-fun |xs#0@@3| () T@U)
(declare-fun |##xs#0@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Loop)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon14_Else_correct true))
(let ((anon14_Then_correct true))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 8) 6) anon14_Then_correct) (=> (= (ControlFlow 0 8) 7) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (= |let#0#0#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 |lambda#0| (|lambda#1| TBool) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))) (=> (and ($Is HandleTypeType |let#0#0#0| (Tclass._System.___hTotalFunc1 TBool TBool)) (= |_v0#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |xs#0@@3|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |xs#0@@3|))) (=> (= |##xs#0@0| (|Seq#Drop| |xs#0@@3| (LitInt 1))) (=> (and ($IsAlloc SeqType |##xs#0@0| (TSeq Tclass._System.Tuple0) $Heap) (= (ControlFlow 0 4) (- 0 3))) (< (|Seq#Rank| |##xs#0@0|) (|Seq#Rank| |xs#0@@3|))))))))))
(let ((anon12_Else_correct  (=> (or (not (= (|Seq#Length| |xs#0@@3|) (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 9) 8) anon13_Then_correct) (=> (= (ControlFlow 0 9) 4) anon13_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#10| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon11_Then_correct) (=> (= (ControlFlow 0 10) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is SeqType |xs#0@@3| (TSeq Tclass._System.Tuple0))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
