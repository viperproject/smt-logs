...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.mutsPointIntoSameRegionOrImmOrIso)
...
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |t#0@@3| null)) (not true))) (=> (or (not (= |t#0@@3| null)) (not true)) (=> (_module.Region.Heap_q (_module.Object.region |t#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |t#0@@3| null)) (not true))) (=> (or (not (= |t#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (_module.Region.Heap_q (_module.Object.region |t#0@@3|)) (_module.Region.Stack_q (_module.Object.region |t#0@@3|)))) (=> (or (_module.Region.Heap_q (_module.Object.region |t#0@@3|)) (_module.Region.Stack_q (_module.Object.region |t#0@@3|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |f#0@@1| null)) (not true))) (=> (or (not (= |f#0@@1| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (_module.Region.Heap_q (_module.Object.region |f#0@@1|)) (_module.Region.Stack_q (_module.Object.region |f#0@@1|)))))))))))))))
(let ((anon10_Else_correct  (=> (not (_module.Region.Heap_q (_module.Object.region |t#0@@3|))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |t#0@@3| null)) (not true))) (=> (or (not (= |t#0@@3| null)) (not true)) (=> (_module.Region.Frozen_q (_module.Object.region |t#0@@3|)) (and (=> (= (ControlFlow 0 12) 2) anon11_Then_correct) (=> (= (ControlFlow 0 12) 7) anon11_Else_correct))))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |t#0@@3| null)) (not true))) (=> (or (not (= |t#0@@3| null)) (not true)) (=> (_module.Region.Heap_q (_module.Object.region |t#0@@3|)) (and (=> (= (ControlFlow 0 10) 2) anon11_Then_correct) (=> (= (ControlFlow 0 10) 7) anon11_Else_correct)))))))
(let ((anon9_Else_correct  (=> (not (or (_module.Region.Heap_q (_module.Object.region |t#0@@3|)) (_module.Region.Frozen_q (_module.Object.region |t#0@@3|)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |t#0@@3| null)) (not true))) (=> (or (not (= |t#0@@3| null)) (not true)) (=> (_module.Region.Isolate_q (_module.Object.region |t#0@@3|)) (and (=> (= (ControlFlow 0 8) 2) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (and (=> (= (ControlFlow 0 14) (- 0 17)) (or (not (= |f#0@@1| null)) (not true))) (=> (or (not (= |f#0@@1| null)) (not true)) (=> ($IsAllocBox ($Box refType |f#0@@1|) Tclass._module.Object? $Heap@@3) (=> (and (|_module.Object.Valid#canCall| $Heap@@3 |f#0@@1|) (_module.Object.Valid reveal__module.Object.Valid $Heap@@3 |f#0@@1|)) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= |t#0@@3| null)) (not true))) (=> (or (not (= |t#0@@3| null)) (not true)) (=> ($IsAllocBox ($Box refType |t#0@@3|) Tclass._module.Object? $Heap@@3) (=> (and (|_module.Object.Valid#canCall| $Heap@@3 |t#0@@3|) (_module.Object.Valid reveal__module.Object.Valid $Heap@@3 |t#0@@3|)) (=> (and (and ($IsAlloc refType |f#0@@1| Tclass._module.Object $Heap@@3) ($IsAlloc refType |t#0@@3| Tclass._module.Object $Heap@@3)) (and (|_module.__default.VeniceReferenceOK#canCall| |f#0@@1| |t#0@@3|) (_module.__default.VeniceReferenceOK |f#0@@1| |t#0@@3|))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |f#0@@1| null)) (not true))) (=> (or (not (= |f#0@@1| null)) (not true)) (=> (_module.Region.Heap_q (_module.Object.region |f#0@@1|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@3 $Heap@0)) (and (and (=> (= (ControlFlow 0 14) 8) anon9_Else_correct) (=> (= (ControlFlow 0 14) 10) anon10_Then_correct)) (=> (= (ControlFlow 0 14) 12) anon10_Else_correct))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Memory) ($IsAlloc refType this@@3 Tclass._module.Memory $Heap@@3))) (and ($Is refType |f#0@@1| Tclass._module.Object) ($IsAlloc refType |f#0@@1| Tclass._module.Object $Heap@@3))) (and (and ($Is refType |t#0@@3| Tclass._module.Object) ($IsAlloc refType |t#0@@3| Tclass._module.Object $Heap@@3)) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 18) 14)))) anon0_correct))))
