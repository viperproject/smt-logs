...
(assert (distinct alloc Tagclass._module.Trait Tagclass._module.Class? Tagclass._module.Class Tagclass._module.Trait? Tagclass._module.ClassB? Tagclass._module.ClassB tytagFamily$Trait tytagFamily$Class tytagFamily$ClassB)
)
(assert (implements$_module.Trait Tclass._module.Class?))
(assert (implements$_module.Trait Tclass._module.ClassB?))
...
(assert (forall ((|c#0| T@U) ($h T@U) ) (! (= ($IsAlloc refType |c#0| Tclass._module.Trait $h) ($IsAlloc refType |c#0| Tclass._module.Trait? $h))
 :qid |unknown.0:0|
 :skolemid |587|
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.Trait $h))
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.Trait? $h))
)))
...
(assert (forall (($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.Trait? $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |585|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.Trait? $h@@2))
)))
(assert (forall (($o@@2 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.Class? $h@@3)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |589|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.Class? $h@@3))
)))
...
(assert (forall ((|c#0@@2| T@U) ) (! (= ($Is refType |c#0@@2| Tclass._module.Trait)  (and ($Is refType |c#0@@2| Tclass._module.Trait?) (or (not (= |c#0@@2| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |586|
 :pattern ( ($Is refType |c#0@@2| Tclass._module.Trait))
 :pattern ( ($Is refType |c#0@@2| Tclass._module.Trait?))
)))
(assert (forall ((|c#0@@3| T@U) ) (! (= ($Is refType |c#0@@3| Tclass._module.Class)  (and ($Is refType |c#0@@3| Tclass._module.Class?) (or (not (= |c#0@@3| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |590|
 :pattern ( ($Is refType |c#0@@3| Tclass._module.Class))
 :pattern ( ($Is refType |c#0@@3| Tclass._module.Class?))
)))
...
(assert (forall (($o@@4 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@4 Tclass._module.Class? $heap) ($IsAlloc refType $o@@4 Tclass._module.Trait? $heap))
 :qid |unknown.0:0|
 :skolemid |605|
 :pattern ( ($IsAlloc refType $o@@4 Tclass._module.Class? $heap))
)))
(assert (forall (($o@@5 T@U) ($heap@@0 T@U) ) (!  (=> ($IsAlloc refType $o@@5 Tclass._module.ClassB? $heap@@0) ($IsAlloc refType $o@@5 Tclass._module.Trait? $heap@@0))
 :qid |unknown.0:0|
 :skolemid |609|
 :pattern ( ($IsAlloc refType $o@@5 Tclass._module.ClassB? $heap@@0))
)))
...
(assert (forall (($o@@7 T@U) ) (!  (=> ($Is refType $o@@7 Tclass._module.Class?) ($Is refType $o@@7 Tclass._module.Trait?))
 :qid |unknown.0:0|
 :skolemid |604|
 :pattern ( ($Is refType $o@@7 Tclass._module.Class?))
)))
(assert (forall (($o@@8 T@U) ) (!  (=> ($Is refType $o@@8 Tclass._module.ClassB?) ($Is refType $o@@8 Tclass._module.Trait?))
 :qid |unknown.0:0|
 :skolemid |608|
...
(assert (= (Tag Tclass._module.ClassB) Tagclass._module.ClassB))
(assert (= (TagFamily Tclass._module.ClassB) tytagFamily$ClassB))
(assert (forall (($o@@9 T@U) ) (! (= ($Is refType $o@@9 Tclass._module.Trait?)  (or (= $o@@9 null) (implements$_module.Trait (dtype $o@@9))))
 :qid |unknown.0:0|
 :skolemid |584|
 :pattern ( ($Is refType $o@@9 Tclass._module.Trait?))
)))
(push 1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.ClassB?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) ($Is refType $nw@0 Tclass._module.Class))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#t#0| (and ($Is refType |t#0| Tclass._module.Trait) ($IsAlloc refType |t#0| Tclass._module.Trait $Heap))) true)) (and (and (=> |defass#c#0| (and ($Is refType |c#0@@5| Tclass._module.Class) ($IsAlloc refType |c#0@@5| Tclass._module.Class $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
