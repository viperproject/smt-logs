...
(declare-fun |call3formal@i#0@0| () Int)
(declare-fun |r#0| () T@U)
(declare-fun |valueOrError0#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.Cell.P0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_Else_correct  (=> (not (_module.Result.IsFailure TInt |call2formal@r#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 _module.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 _module.Cell.data)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1) (= (ControlFlow 0 4) (- 0 3))) (not (_module.Result.IsFailure TInt |call2formal@r#0@0|))))))))
(let ((anon5_Then_correct  (=> (_module.Result.IsFailure TInt |call2formal@r#0@0|) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0|)) (or (_module.Result.IsFailure TInt |call2formal@r#0@0|) (_module.Result.Failure_q |call2formal@r#0@0|))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#11| null $Heap@@1 alloc this@@9)) (=> (and ($Is DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt) $Heap@@1)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= this@@9 this@@9)) (not true))) (=> (or (not (= this@@9 this@@9)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 _module.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 _module.Cell.data)) (=> (and (and ($Is DatatypeTypeType |call2formal@r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0| (Tclass._module.Result TInt) $Heap@@1)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (and ($Is DatatypeTypeType |call2formal@r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call2formal@r#0@0| (Tclass._module.Result TInt) $Heap@0)) (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@4)))
 :qid |gitissue817cdfy.14:10|
 :skolemid |570|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
))) (and ($HeapSucc $Heap@@1 $Heap@0) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 this@@9 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@9) _module.Cell.data ($Box intType (int_2_U |call3formal@i#0@0|))))))) (and (and ($IsGoodHeap $Heap@1) ($IsAllocBox ($Box DatatypeTypeType |call2formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1)) (and (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0|) (|_module.Result.IsFailure#canCall| TInt |call2formal@r#0@0|)))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 4) anon5_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.Cell) ($IsAlloc refType this@@9 Tclass._module.Cell $Heap@@1))) (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@1))) (=> (and (and (and ($Is DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 9) 6))) anon0_correct)))))
