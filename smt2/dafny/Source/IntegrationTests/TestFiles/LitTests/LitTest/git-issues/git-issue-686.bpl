// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-686.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-686-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-686.dfy
...
function _module.__default.Foo(c#0: DatatypeType) : int
uses {
// definition axiom for _module.__default.Foo (revealed)
axiom {:id "id0"} 1 <= $FunctionContextHeight
   ==> (forall c#0: DatatypeType :: 
    { _module.__default.Foo(c#0) } 
    _module.__default.Foo#canCall(c#0)
         || (1 < $FunctionContextHeight && $Is(c#0, Tclass._module.Color()))
       ==> _module.__default.Foo(c#0) == (if _module.Color.Blue_q(c#0) then 4 else 6));
// definition axiom for _module.__default.Foo for all literals (revealed)
axiom {:id "id1"} 1 <= $FunctionContextHeight
   ==> (forall c#0: DatatypeType :: 
    {:weight 3} { _module.__default.Foo(Lit(c#0)) } 
    _module.__default.Foo#canCall(Lit(c#0))
         || (1 < $FunctionContextHeight && $Is(c#0, Tclass._module.Color()))
       ==> _module.__default.Foo(Lit(c#0))
         == (if _module.Color.Blue_q(Lit(c#0)) then 4 else 6));
}

function _module.__default.Foo#canCall(c#0: DatatypeType) : bool;
...
axiom (forall c#0: DatatypeType :: 
  { _module.__default.Foo#requires(c#0) } 
  $Is(c#0, Tclass._module.Color()) ==> _module.__default.Foo#requires(c#0) == true);

procedure {:verboseName "Foo (well-formedness)"} CheckWellformed$$_module.__default.Foo(c#0: DatatypeType where $Is(c#0, Tclass._module.Color()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Moo (well-formedness)"} CheckWellFormed$$_module.__default.Moo(c#0: DatatypeType
...
procedure {:verboseName "Moo (call)"} Call$$_module.__default.Moo(c#0: DatatypeType
       where $Is(c#0, Tclass._module.Color())
         && $IsAlloc(c#0, Tclass._module.Color(), $Heap)
         && $IsA#_module.Color(c#0))
   returns (x#0: int);
...
procedure {:verboseName "Moo (correctness)"} Impl$$_module.__default.Moo(c#0: DatatypeType
       where $Is(c#0, Tclass._module.Color())
         && $IsAlloc(c#0, Tclass._module.Color(), $Heap)
         && $IsA#_module.Color(c#0))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var ##c#0: DatatypeType;
    ...
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-686.dfy(21,15)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    c##0 := Lit(#_module.Color.Red());
    call {:id "id4"} $rhs##0 := Call$$_module.__default.Moo(c##0);
    // TrCallStmt: After ProcessCallStmt
    x#0 := $rhs##0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-686.dfy(22,3)
    ##c#0 := Lit(#_module.Color.Red());
    // assume allocatedness for argument to function
    assume $IsAlloc(##c#0, Tclass._module.Color(), $Heap);
    assume _module.__default.Foo#canCall(Lit(#_module.Color.Red()));
    assume _module.__default.Foo#canCall(Lit(#_module.Color.Red()));
    assume true;
    assume true;
    assume true;
...
axiom (forall d: DatatypeType :: 
  { $IsA#_module.Color(d) } 
  $IsA#_module.Color(d) ==> _module.Color.Blue_q(d) || _module.Color.Red_q(d));
...
axiom (forall d: DatatypeType :: 
  ...
  $Is(d, Tclass._module.Color())
     ==> _module.Color.Blue_q(d) || _module.Color.Red_q(d));
