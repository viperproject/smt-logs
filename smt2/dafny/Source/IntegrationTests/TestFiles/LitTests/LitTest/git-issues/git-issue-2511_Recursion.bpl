// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy
...
procedure {:verboseName "Recursion.Infloop (well-formedness)"} CheckWellFormed$$Recursion.__default.Infloop(b#0: bv8);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Recursion.Infloop (call)"} Call$$Recursion.__default.Infloop(b#0: bv8);
  // user-defined preconditions
  requires {:id "id11"} b#0 == Lit(3bv8);
  modifies $Heap;
...
procedure {:verboseName "Recursion.Infloop (correctness)"} Impl$$Recursion.__default.Infloop(b#0: bv8) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id13"} b#0 == Lit(3bv8);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Recursion.Infloop (correctness)"} Impl$$Recursion.__default.Infloop(b#0: bv8) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var b##0: bv8;

    // AddMethodImpl: Infloop, Impl$$Recursion.__default.Infloop
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(24,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    b##0 := add_bv8(b#0, 1bv8);
    assert {:id "id15"} le_bv8(b##0, b#0);
    call {:id "id16"} Call$$Recursion.__default.Infloop_k(b##0);
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "Recursion.Infloop' (well-formedness)"} CheckWellFormed$$Recursion.__default.Infloop_k(b#0: bv8);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Recursion.Infloop' (call)"} Call$$Recursion.__default.Infloop_k(b#0: bv8);
  // user-defined preconditions
  requires {:id "id19"} b#0 == Lit(4bv8);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
...
procedure {:verboseName "Recursion.Infloop' (correctness)"} Impl$$Recursion.__default.Infloop_k(b#0: bv8) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id21"} b#0 == Lit(4bv8);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Recursion.Infloop' (correctness)"} Impl$$Recursion.__default.Infloop_k(b#0: bv8) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var b##0: bv8;

    // AddMethodImpl: Infloop', Impl$$Recursion.__default.Infloop_k
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(32,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    b##0 := sub_bv8(b#0, 1bv8);
    assert {:id "id23"} lt_bv8(b##0, b#0);
    call {:id "id24"} Call$$Recursion.__default.Infloop(b##0);
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "Recursion.Boom (well-formedness)"} CheckWellFormed$$Recursion.__default.Boom();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Recursion.Boom (call)"} Call$$Recursion.__default.Boom();
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
...
procedure {:verboseName "Recursion.Boom (correctness)"} Impl$$Recursion.__default.Boom() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Recursion.Boom (correctness)"} Impl$$Recursion.__default.Boom() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var b##0: bv8;

    // AddMethodImpl: Boom, Impl$$Recursion.__default.Boom
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(38,12)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    b##0 := Lit(3bv8);
    call {:id "id28"} Call$$Recursion.__default.Infloop(b##0);
    // TrCallStmt: After ProcessCallStmt
}
