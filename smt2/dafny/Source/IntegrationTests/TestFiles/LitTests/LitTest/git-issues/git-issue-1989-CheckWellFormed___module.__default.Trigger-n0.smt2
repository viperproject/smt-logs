...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Trigger)
...
(assert (not
 ...
 :qid |gitissue1989dfy.63:8|
 :skolemid |1120|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is SeqType |s#0@0| (TSeq TInt)) ($IsAlloc SeqType |s#0@0| (TSeq TInt) $Heap@0)) (and ($IsAlloc SeqType |s#0@0| (TSeq TInt) $Heap@0) (|_module.__default.P#canCall| |s#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc SeqType |s#0@0| (TSeq TInt) $Heap)) (=> ($IsAlloc SeqType |s#0@0| (TSeq TInt) $Heap) (=> (|_module.__default.P#canCall| |s#0@0|) (=> (and (= (_module.__default.P |s#0@0|) (_module.__default.P |s#0@0|)) (forall ((|s#1| T@U) ) (!  (=> ($Is SeqType |s#1| (TSeq TInt)) (= (_module.__default.P |s#1|) (_module.__default.P |s#1|)))
 :qid |gitissue1989dfy.67:18|
 :skolemid |1121|
 :pattern ( (_module.__default.P |s#1|))
 :pattern ( (_module.__default.P |s#1|))
))) (=> (and (and (and ($Is SeqType |s#2@0| (TSeq TInt)) ($IsAlloc SeqType |s#2@0| (TSeq TInt) $Heap@0)) ($IsAlloc SeqType |s#2@0| (TSeq TInt) $Heap@0)) (and (|_module.__default.P#canCall| |s#2@0|) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc SeqType |s#2@0| (TSeq TInt) $Heap))))))))))
