...
(declare-fun A_mAA_mAAA.__default.aaa () Int)
...
(assert ($Is intType (int_2_U A_mAA_mAAA.__default.aaa) TInt))
(assert (forall ((x@@5 T@U) (T@@1 T@T) ) (! (= ($Unbox T@@1 ($Box T@@1 x@@5)) x@@5)
 :qid |DafnyPreludebpl.167:18|
 :skolemid |1950|
 :pattern ( ($Box T@@1 x@@5))
)))
(assert (= A_mAA_mAAA.__default.aaa (LitInt 50)))
...
(set-info :boogie-vc-id Impl$$G_mI_mJ.__default.m3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= A_mAA_mAAA.__default.aaa (LitInt 50)))))
