...
(declare-fun |aa##0_0@0| () T@U)
(declare-fun |bb#0| () T@U)
(declare-fun |bb##0_0@0| () T@U)
(declare-fun call0formal@_module.Memory.BiggerIsBigger$T@0 () T@U)
(declare-fun $Heap@0 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.Memory.RefCountIsMonotonic)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 41) (let ((anon34_Else_correct  (=> ($IsAllocBox ($Box refType this@@8) Tclass._module.Memory? $Heap@@0) (=> (and (and ($IsAlloc refType |i#0_0@0| Tclass._module.Object $Heap@@0) ($IsAlloc SetType |aa#0| (TSet Tclass._module.Edge) $Heap@@0)) (and (|_module.Memory.incomingEdges#canCall| this@@8 |i#0_0@0| |aa#0|) (|_module.Memory.incomingEdges#canCall| this@@8 |i#0_0@0| |aa#0|))) (=> (and (and (and (= |aa##0_0@0| (_module.Memory.incomingEdges this@@8 |i#0_0@0| |aa#0|)) ($IsAllocBox ($Box refType this@@8) Tclass._module.Memory? $Heap@@0)) (and ($IsAlloc refType |i#0_0@0| Tclass._module.Object $Heap@@0) ($IsAlloc SetType |bb#0| (TSet Tclass._module.Edge) $Heap@@0))) (and (and (|_module.Memory.incomingEdges#canCall| this@@8 |i#0_0@0| |bb#0|) (|_module.Memory.incomingEdges#canCall| this@@8 |i#0_0@0| |bb#0|)) (and (= |bb##0_0@0| (_module.Memory.incomingEdges this@@8 |i#0_0@0| |bb#0|)) (= call0formal@_module.Memory.BiggerIsBigger$T@0 Tclass._module.Edge)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (|Set#Subset| |bb##0_0@0| |aa##0_0@0|)) (=> (|Set#Subset| |bb##0_0@0| |aa##0_0@0|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (>= (|Set#Card| |aa##0_0@0|) (|Set#Card| |bb##0_0@0|))) (and (= $Heap@@0 $Heap@0) (= (ControlFlow 0 18) (- 0 17)))) (>= (|Set#Card| (_module.Memory.incomingEdges this@@8 |i#0_0@0| |aa#0|)) (|Set#Card| (_module.Memory.incomingEdges this@@8 |i#0_0@0| |bb#0|)))))))))))
(let ((anon34_Then_correct true))
(let ((anon33_Then_correct  (=> (and ($Is refType |i#0_0@0| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#0_0@0|))) (and (=> (= (ControlFlow 0 20) 16) anon34_Then_correct) (=> (= (ControlFlow 0 20) 18) anon34_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#1| T@U) ) (!  (=> (and ($Is refType |i#1| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#1|))) (>= (_module.Memory.refCountEdges this@@8 |i#1| |aa#0|) (_module.Memory.refCountEdges this@@8 |i#1| |bb#0|)))
...
(let ((anon24_correct  (=> (forall ((|i#7| T@U) ) (!  (=> ($Is refType |i#7| Tclass._module.Object) (=> (|Set#IsMember| |oo#0| ($Box refType |i#7|)) (and (|_module.Memory.refCountEdges#canCall| this@@8 |i#7| |aa#0|) (|_module.Memory.refCountEdges#canCall| this@@8 |i#7| |bb#0|))))
 :qid |gitissue3855dfy.563:21|
 :skolemid |1164|
...
)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|i#7@@0| T@U) ) (!  (=> (and ($Is refType |i#7@@0| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#7@@0|))) (>= (_module.Memory.refCountEdges this@@8 |i#7@@0| |aa#0|) (_module.Memory.refCountEdges this@@8 |i#7@@0| |bb#0|)))
 :qid |gitissue3855dfy.563:21|
 :skolemid |1166|
...
))) (=> (forall ((|i#7@@1| T@U) ) (!  (=> (and ($Is refType |i#7@@1| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#7@@1|))) (>= (_module.Memory.refCountEdges this@@8 |i#7@@1| |aa#0|) (_module.Memory.refCountEdges this@@8 |i#7@@1| |bb#0|)))
 :qid |gitissue3855dfy.563:21|
 :skolemid |1166|
...
(let ((anon38_Else_correct  (=> (and (not (|Set#IsMember| |oo#0| ($Box refType |i#6@0|))) (= (ControlFlow 0 7) 3)) anon24_correct)))
(let ((anon38_Then_correct  (=> (and (|Set#IsMember| |oo#0| ($Box refType |i#6@0|)) ($IsAllocBox ($Box refType this@@8) Tclass._module.Memory? $Heap@@0)) (=> (and (and (and ($IsAlloc refType |i#6@0| Tclass._module.Object $Heap@@0) ($IsAlloc SetType |aa#0| (TSet Tclass._module.Edge) $Heap@@0)) (and (|_module.Memory.refCountEdges#canCall| this@@8 |i#6@0| |aa#0|) ($IsAllocBox ($Box refType this@@8) Tclass._module.Memory? $Heap@@0))) (and (and ($IsAlloc refType |i#6@0| Tclass._module.Object $Heap@@0) ($IsAlloc SetType |bb#0| (TSet Tclass._module.Edge) $Heap@@0)) (and (|_module.Memory.refCountEdges#canCall| this@@8 |i#6@0| |bb#0|) (= (ControlFlow 0 6) 3)))) anon24_correct))))
(let ((anon37_Then_correct  (=> (and ($Is refType |i#6@0| Tclass._module.Object) ($IsAlloc refType |i#6@0| Tclass._module.Object $Heap@@0)) (and (=> (= (ControlFlow 0 8) 6) anon38_Then_correct) (=> (= (ControlFlow 0 8) 7) anon38_Else_correct)))))
(let ((anon37_Else_correct  (=> (and (not (and ($Is refType |i#6@0| Tclass._module.Object) ($IsAlloc refType |i#6@0| Tclass._module.Object $Heap@@0))) (= (ControlFlow 0 5) 3)) anon24_correct)))
(let ((anon21_correct  (=> (forall ((|i#5| T@U) ) (!  (=> ($Is refType |i#5| Tclass._module.Object) (=> (|Set#IsMember| |oo#0| ($Box refType |i#5|)) (and (|_module.Memory.incomingEdges#canCall| this@@8 |i#5| |aa#0|) (|_module.Memory.incomingEdges#canCall| this@@8 |i#5| |bb#0|))))
 :qid |gitissue3855dfy.561:21|
 :skolemid |1161|
...
)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (forall ((|i#5@@0| T@U) ) (!  (=> (and ($Is refType |i#5@@0| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#5@@0|))) (>= (|Set#Card| (_module.Memory.incomingEdges this@@8 |i#5@@0| |aa#0|)) (|Set#Card| (_module.Memory.incomingEdges this@@8 |i#5@@0| |bb#0|))))
 :qid |gitissue3855dfy.561:21|
 :skolemid |1163|
...
))) (=> (forall ((|i#5@@1| T@U) ) (!  (=> (and ($Is refType |i#5@@1| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#5@@1|))) (>= (|Set#Card| (_module.Memory.incomingEdges this@@8 |i#5@@1| |aa#0|)) (|Set#Card| (_module.Memory.incomingEdges this@@8 |i#5@@1| |bb#0|))))
 :qid |gitissue3855dfy.561:21|
 :skolemid |1163|
...
)) (and (=> (= (ControlFlow 0 9) 8) anon37_Then_correct) (=> (= (ControlFlow 0 9) 5) anon37_Else_correct)))))))
(let ((anon36_Else_correct  (=> (and (not (|Set#IsMember| |oo#0| ($Box refType |i#4@0|))) (= (ControlFlow 0 13) 9)) anon21_correct)))
(let ((anon36_Then_correct  (=> (and (|Set#IsMember| |oo#0| ($Box refType |i#4@0|)) ($IsAllocBox ($Box refType this@@8) Tclass._module.Memory? $Heap@@0)) (=> (and (and (and ($IsAlloc refType |i#4@0| Tclass._module.Object $Heap@@0) ($IsAlloc SetType |aa#0| (TSet Tclass._module.Edge) $Heap@@0)) (and (|_module.Memory.incomingEdges#canCall| this@@8 |i#4@0| |aa#0|) ($IsAllocBox ($Box refType this@@8) Tclass._module.Memory? $Heap@@0))) (and (and ($IsAlloc refType |i#4@0| Tclass._module.Object $Heap@@0) ($IsAlloc SetType |bb#0| (TSet Tclass._module.Edge) $Heap@@0)) (and (|_module.Memory.incomingEdges#canCall| this@@8 |i#4@0| |bb#0|) (= (ControlFlow 0 12) 9)))) anon21_correct))))
(let ((anon35_Then_correct  (=> (and ($Is refType |i#4@0| Tclass._module.Object) ($IsAlloc refType |i#4@0| Tclass._module.Object $Heap@@0)) (and (=> (= (ControlFlow 0 14) 12) anon36_Then_correct) (=> (= (ControlFlow 0 14) 13) anon36_Else_correct)))))
(let ((anon35_Else_correct  (=> (and (not (and ($Is refType |i#4@0| Tclass._module.Object) ($IsAlloc refType |i#4@0| Tclass._module.Object $Heap@@0))) (= (ControlFlow 0 11) 9)) anon21_correct)))
(let ((anon33_Else_correct  (=> (forall ((|i#0_1| T@U) ) (!  (=> (and ($Is refType |i#0_1| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#0_1|))) (>= (|Set#Card| (_module.Memory.incomingEdges this@@8 |i#0_1| |aa#0|)) (|Set#Card| (_module.Memory.incomingEdges this@@8 |i#0_1| |bb#0|))))
 :qid |gitissue3855dfy.556:14|
 :skolemid |1160|
 :pattern ( (_module.Memory.incomingEdges this@@8 |i#0_1| |bb#0|))
 :pattern ( (_module.Memory.incomingEdges this@@8 |i#0_1| |aa#0|))
 :pattern ( (|Set#IsMember| |oo#0| ($Box refType |i#0_1|)))
)) (and (=> (= (ControlFlow 0 15) 14) anon35_Then_correct) (=> (= (ControlFlow 0 15) 11) anon35_Else_correct)))))
(let ((anon13_correct  (=> (forall ((|i#3| T@U) ) (!  (=> ($Is refType |i#3| Tclass._module.Object) (=> (|Set#IsMember| |oo#0| ($Box refType |i#3|)) (and (forall ((|e#2@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#2@@0| Tclass._module.Edge) (=> (|Set#IsMember| |aa#0| ($Box DatatypeTypeType |e#2@@0|)) (_module.Edge.Edge_q |e#2@@0|)))
 :qid |gitissue3855dfy.554:18|
 :skolemid |1154|
 :pattern ( (_module.Edge.t |e#2@@0|))
 :pattern ( (|Set#IsMember| |aa#0| ($Box DatatypeTypeType |e#2@@0|)))
)) (forall ((|e#3| T@U) ) (!  (=> ($Is DatatypeTypeType |e#3| Tclass._module.Edge) (=> (|Set#IsMember| |bb#0| ($Box DatatypeTypeType |e#3|)) (_module.Edge.Edge_q |e#3|)))
 :qid |gitissue3855dfy.554:46|
 :skolemid |1155|
 :pattern ( (_module.Edge.t |e#3|))
 :pattern ( (|Set#IsMember| |bb#0| ($Box DatatypeTypeType |e#3|)))
)))))
 :qid |gitissue3855dfy.553:21|
 :skolemid |1156|
 :pattern ( (|Set#IsMember| |oo#0| ($Box refType |i#3|)))
)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((|i#3@@0| T@U) ) (!  (=> (and ($Is refType |i#3@@0| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#3@@0|))) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge |bb#0| |i#3@@0|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge |aa#0| |i#3@@0|))))
 :qid |gitissue3855dfy.553:21|
 :skolemid |1158|
 :pattern ( (|Set#IsMember| |oo#0| ($Box refType |i#3@@0|)))
))) (=> (forall ((|i#3@@1| T@U) ) (!  (=> (and ($Is refType |i#3@@1| Tclass._module.Object) (|Set#IsMember| |oo#0| ($Box refType |i#3@@1|))) (|Set#Subset| (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge |bb#0| |i#3@@1|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge |aa#0| |i#3@@1|))))
 :qid |gitissue3855dfy.553:21|
 :skolemid |1158|
 :pattern ( (|Set#IsMember| |oo#0| ($Box refType |i#3@@1|)))
)) (and (=> (= (ControlFlow 0 21) 20) anon33_Then_correct) (=> (= (ControlFlow 0 21) 15) anon33_Else_correct)))))))
(let ((anon32_Else_correct  (=> (and (not (and (|Set#IsMember| |bb#0| ($Box DatatypeTypeType |e#1@0|)) (= (_module.Edge.t |e#1@0|) |i#2@0|))) (= (ControlFlow 0 27) 21)) anon13_correct)))
(let ((anon32_Then_correct  (=> (and (and (|Set#IsMember| |bb#0| ($Box DatatypeTypeType |e#1@0|)) (= (_module.Edge.t |e#1@0|) |i#2@0|)) (= (ControlFlow 0 26) 21)) anon13_correct)))
(let ((anon31_Else_correct  (=> (not (|Set#IsMember| |bb#0| ($Box DatatypeTypeType |e#1@0|))) (and (=> (= (ControlFlow 0 29) 26) anon32_Then_correct) (=> (= (ControlFlow 0 29) 27) anon32_Else_correct)))))
(let ((anon31_Then_correct  (=> (and (|Set#IsMember| |bb#0| ($Box DatatypeTypeType |e#1@0|)) (_module.Edge.Edge_q |e#1@0|)) (and (=> (= (ControlFlow 0 28) 26) anon32_Then_correct) (=> (= (ControlFlow 0 28) 27) anon32_Else_correct)))))
(let ((anon30_Then_correct  (=> (and ($Is DatatypeTypeType |e#1@0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |e#1@0| Tclass._module.Edge $Heap@@0)) (and (=> (= (ControlFlow 0 30) 28) anon31_Then_correct) (=> (= (ControlFlow 0 30) 29) anon31_Else_correct)))))
(let ((anon30_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |e#1@0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |e#1@0| Tclass._module.Edge $Heap@@0))) (= (ControlFlow 0 25) 21)) anon13_correct)))
(let ((anon29_Else_correct  (=> (not (and (|Set#IsMember| |aa#0| ($Box DatatypeTypeType |e#0@0|)) (= (_module.Edge.t |e#0@0|) |i#2@0|))) (and (=> (= (ControlFlow 0 33) 30) anon30_Then_correct) (=> (= (ControlFlow 0 33) 25) anon30_Else_correct)))))
(let ((anon29_Then_correct  (=> (and (|Set#IsMember| |aa#0| ($Box DatatypeTypeType |e#0@0|)) (= (_module.Edge.t |e#0@0|) |i#2@0|)) (and (=> (= (ControlFlow 0 32) 30) anon30_Then_correct) (=> (= (ControlFlow 0 32) 25) anon30_Else_correct)))))
(let ((anon28_Else_correct  (=> (not (|Set#IsMember| |aa#0| ($Box DatatypeTypeType |e#0@0|))) (and (=> (= (ControlFlow 0 35) 32) anon29_Then_correct) (=> (= (ControlFlow 0 35) 33) anon29_Else_correct)))))
(let ((anon28_Then_correct  (=> (and (|Set#IsMember| |aa#0| ($Box DatatypeTypeType |e#0@0|)) (_module.Edge.Edge_q |e#0@0|)) (and (=> (= (ControlFlow 0 34) 32) anon29_Then_correct) (=> (= (ControlFlow 0 34) 33) anon29_Else_correct)))))
(let ((anon27_Then_correct  (=> (and ($Is DatatypeTypeType |e#0@0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |e#0@0| Tclass._module.Edge $Heap@@0)) (and (=> (= (ControlFlow 0 36) 34) anon28_Then_correct) (=> (= (ControlFlow 0 36) 35) anon28_Else_correct)))))
(let ((anon27_Else_correct  (=> (not (and ($Is DatatypeTypeType |e#0@0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |e#0@0| Tclass._module.Edge $Heap@@0))) (and (=> (= (ControlFlow 0 31) 30) anon30_Then_correct) (=> (= (ControlFlow 0 31) 25) anon30_Else_correct)))))
(let ((anon26_Then_correct  (=> (|Set#IsMember| |oo#0| ($Box refType |i#2@0|)) (and (=> (= (ControlFlow 0 37) 36) anon27_Then_correct) (=> (= (ControlFlow 0 37) 31) anon27_Else_correct)))))
(let ((anon26_Else_correct  (=> (and (not (|Set#IsMember| |oo#0| ($Box refType |i#2@0|))) (= (ControlFlow 0 24) 21)) anon13_correct)))
(let ((anon25_Then_correct  (=> (and ($Is refType |i#2@0| Tclass._module.Object) ($IsAlloc refType |i#2@0| Tclass._module.Object $Heap@@0)) (and (=> (= (ControlFlow 0 38) 37) anon26_Then_correct) (=> (= (ControlFlow 0 38) 24) anon26_Else_correct)))))
(let ((anon25_Else_correct  (=> (and (not (and ($Is refType |i#2@0| Tclass._module.Object) ($IsAlloc refType |i#2@0| Tclass._module.Object $Heap@@0))) (= (ControlFlow 0 23) 21)) anon13_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 39) (- 0 40)) (|Set#Subset| |bb#0| |aa#0|)) (=> (|Set#Subset| |bb#0| |aa#0|) (and (=> (= (ControlFlow 0 39) 38) anon25_Then_correct) (=> (= (ControlFlow 0 39) 23) anon25_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@8 null)) (not true)) (and ($Is refType this@@8 Tclass._module.Memory) ($IsAlloc refType this@@8 Tclass._module.Memory $Heap@@0)))) (and (and ($Is SetType |oo#0| (TSet Tclass._module.Object)) ($IsAlloc SetType |oo#0| (TSet Tclass._module.Object) $Heap@@0)) (and ($Is SetType |aa#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |aa#0| (TSet Tclass._module.Edge) $Heap@@0)))) (and (and (and ($Is SetType |bb#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |bb#0| (TSet Tclass._module.Edge) $Heap@@0)) (= 4 $FunctionContextHeight)) (and (|Set#Subset| |bb#0| |aa#0|) (= (ControlFlow 0 41) 39)))) anon0_correct)))
