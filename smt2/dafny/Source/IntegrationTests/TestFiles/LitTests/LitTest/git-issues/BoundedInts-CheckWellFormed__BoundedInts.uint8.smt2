...
(declare-fun BoundedInts.__default.TWO__TO__THE__8 () Int)
...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U BoundedInts.__default.TWO__TO__THE__8) TInt)))
(assert (forall ((x@@5 T@U) (T@@1 T@T) ) (! (= ($Unbox T@@1 ($Box T@@1 x@@5)) x@@5)
 :qid |DafnyPreludebpl.167:18|
 :skolemid |25|
 :pattern ( ($Box T@@1 x@@5))
)))
(assert (= BoundedInts.__default.TWO__TO__THE__8 (LitInt 256)))
...
(set-info :boogie-vc-id CheckWellFormed$$BoundedInts.uint8)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 BoundedInts.__default.TWO__TO__THE__8)))))
