...
(assert (distinct TBool TagBool alloc Tagclass._module.Object Tagclass._module.Region Tagclass._module.Object? |##_module.Region.Frozen| |##_module.Region.Heap| |##_module.Region.Stack| |##_module.Region.Frame| |##_module.Region.Isolate| tytagFamily$Object tytagFamily$Region)
)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.VeniceReferenceOK)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon9_correct true))
(let ((anon21_Else_correct  (=> (and (not (_module.Region.Heap_q (_module.Object.region |t#0@@1|))) (= (ControlFlow 0 23) 16)) anon9_correct)))
(let ((anon21_Then_correct  (=> (_module.Region.Heap_q (_module.Object.region |t#0@@1|)) (and (=> (= (ControlFlow 0 18) (- 0 22)) (or (not (= |t#0@@1| null)) (not true))) (=> (or (not (= |t#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 18) (- 0 21)) (or (_module.Region.Heap_q (_module.Object.region |t#0@@1|)) (_module.Region.Stack_q (_module.Object.region |t#0@@1|)))) (=> (or (_module.Region.Heap_q (_module.Object.region |t#0@@1|)) (_module.Region.Stack_q (_module.Object.region |t#0@@1|))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (or (not (= |f#0@@1| null)) (not true))) (=> (or (not (= |f#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (_module.Region.Heap_q (_module.Object.region |f#0@@1|)) (_module.Region.Stack_q (_module.Object.region |f#0@@1|)))) (=> (or (_module.Region.Heap_q (_module.Object.region |f#0@@1|)) (_module.Region.Stack_q (_module.Object.region |f#0@@1|))) (=> (= (ControlFlow 0 18) 16) anon9_correct))))))))))))
(let ((anon20_Then_correct  (=> (not (_module.Region.Isolate_q (_module.Object.region |t#0@@1|))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (or (not (= |t#0@@1| null)) (not true))) (=> (or (not (= |t#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 24) 18) anon21_Then_correct) (=> (= (ControlFlow 0 24) 23) anon21_Else_correct)))))))
(let ((anon20_Else_correct  (=> (and (_module.Region.Isolate_q (_module.Object.region |t#0@@1|)) (= (ControlFlow 0 17) 16)) anon9_correct)))
(let ((anon19_Then_correct  (=> (_module.Region.Heap_q (_module.Object.region |f#0@@1|)) (and (=> (= (ControlFlow 0 26) (- 0 27)) (or (not (= |t#0@@1| null)) (not true))) (=> (or (not (= |t#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 26) 24) anon20_Then_correct) (=> (= (ControlFlow 0 26) 17) anon20_Else_correct)))))))
(let ((anon14_correct true))
(let ((anon24_Else_correct  (=> (and (not (_module.Region.Heap_q (_module.Object.region |t#0@@1|))) (= (ControlFlow 0 9) 4)) anon14_correct)))
(let ((anon24_Then_correct  (=> (_module.Region.Heap_q (_module.Object.region |t#0@@1|)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= |t#0@@1| null)) (not true))) (=> (or (not (= |t#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (_module.Region.Heap_q (_module.Object.region |t#0@@1|)) (_module.Region.Stack_q (_module.Object.region |t#0@@1|)))) (=> (or (_module.Region.Heap_q (_module.Object.region |t#0@@1|)) (_module.Region.Stack_q (_module.Object.region |t#0@@1|))) (=> (= (ControlFlow 0 6) 4) anon14_correct))))))))
(let ((anon23_Then_correct  (=> (not (_module.Region.Isolate_q (_module.Object.region |t#0@@1|))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |t#0@@1| null)) (not true))) (=> (or (not (= |t#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 10) 6) anon24_Then_correct) (=> (= (ControlFlow 0 10) 9) anon24_Else_correct)))))))
(let ((anon23_Else_correct  (=> (and (_module.Region.Isolate_q (_module.Object.region |t#0@@1|)) (= (ControlFlow 0 5) 4)) anon14_correct)))
(let ((anon22_Then_correct  (=> (_module.Region.Isolate_q (_module.Object.region |f#0@@1|)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |t#0@@1| null)) (not true))) (=> (or (not (= |t#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 12) 10) anon23_Then_correct) (=> (= (ControlFlow 0 12) 5) anon23_Else_correct)))))))
(let ((anon22_Else_correct true))
(let ((anon19_Else_correct  (=> (not (_module.Region.Heap_q (_module.Object.region |f#0@@1|))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |f#0@@1| null)) (not true))) (=> (or (not (= |f#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 14) 12) anon22_Then_correct) (=> (= (ControlFlow 0 14) 3) anon22_Else_correct)))))))
(let ((anon18_Else_correct  (=> (not (_module.Region.Frozen_q (_module.Object.region |t#0@@1|))) (and (=> (= (ControlFlow 0 28) (- 0 29)) (or (not (= |f#0@@1| null)) (not true))) (=> (or (not (= |f#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 28) 26) anon19_Then_correct) (=> (= (ControlFlow 0 28) 14) anon19_Else_correct)))))))
(let ((anon18_Then_correct true))
(let ((anon17_Else_correct  (and (=> (= (ControlFlow 0 30) (- 0 31)) (or (not (= |t#0@@1| null)) (not true))) (=> (or (not (= |t#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 30) 2) anon18_Then_correct) (=> (= (ControlFlow 0 30) 28) anon18_Else_correct))))))
(let ((anon17_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 32) 1) anon17_Then_correct) (=> (= (ControlFlow 0 32) 30) anon17_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |f#0@@1| Tclass._module.Object) ($Is refType |t#0@@1| Tclass._module.Object)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 33) 32))) anon0_correct))))
