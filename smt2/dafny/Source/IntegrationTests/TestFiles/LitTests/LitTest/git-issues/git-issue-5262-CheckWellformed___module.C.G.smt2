...
(declare-fun _module.C.G (T@U) Int)
...
(assert (distinct TInt TagInt alloc allocName Tagclass._module.C class._module.C? Tagclass._module.C? tytagFamily$C field$data)
)
(assert (= (FDim alloc) 0))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.C.G#canCall| this) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap)))))) (= (_module.C.G this) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap (let ((|th#0| this))
|th#0|)) _module.C.data)))))
 :qid |gitissue5262dfy.13:12|
 :skolemid |498|
 :pattern ( (_module.C.G this) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.C.G#canCall| (Lit refType this@@0)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.C) ($IsAlloc refType this@@0 Tclass._module.C $Heap@@0)))))) (= (_module.C.G (Lit refType this@@0)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (let ((|th#1| (Lit refType this@@0)))
|th#1|)) _module.C.data)))))
 :qid |gitissue5262dfy.13:12|
 :weight 3
 :skolemid |499|
 :pattern ( (_module.C.G (Lit refType this@@0)) ($IsGoodHeap $Heap@@0))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (= |let#0#0#0| this@@1) (=> (and ($Is refType |let#0#0#0| Tclass._module.C) (= |th#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= (let ((|th#2| this@@1))
|th#2|) null)) (not true))) (=> (or (not (= (let ((|th#2@@0| this@@1))
|th#2@@0|) null)) (not true)) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 (let ((|th#2@@1| this@@1))
|th#2@@1|) _module.C.data))) (= (_module.C.G this@@1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 (let ((|th#2@@2| this@@1))
|th#2@@2|)) _module.C.data))))) (and ($Is intType (int_2_U (_module.C.G this@@1)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.C) ($IsAlloc refType this@@1 Tclass._module.C $Heap@@1))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
