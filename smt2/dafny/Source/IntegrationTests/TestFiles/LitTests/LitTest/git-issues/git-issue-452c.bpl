// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-452c.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-452c-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-452c.dfy
...
axiom 1 <= $FunctionContextHeight
   ==> 
  _module.__default.TwinPrimes#canCall() || 1 < $FunctionContextHeight
   ==> $Is(_module.__default.TwinPrimes(), Tclass._module.Record());
...
axiom {:id "id0"} 1 <= $FunctionContextHeight
  ...
  _module.__default.TwinPrimes#canCall() || 1 < $FunctionContextHeight
   ==> _module.__default.TwinPrimes()
     == Lit(#_module.Record.Record(LitInt(41), LitInt(43)));
...
// Destructor $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(_module.Record.a(d), TInt, $h) } 
  $IsGoodHeap($h)
       && 
      _module.Record.Record_q(d)
...
// Destructor $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(_module.Record.b(d), TInt, $h) } 
  $IsGoodHeap($h)
       && 
      _module.Record.Record_q(d)
       && $IsAlloc(d, Tclass._module.Record(), $h)
...
function _module.Record.a(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#4#0#0: int, a#4#1#0: int :: 
  { #_module.Record.Record(a#4#0#0, a#4#1#0) } 
  _module.Record.a(#_module.Record.Record(a#4#0#0, a#4#1#0)) == a#4#0#0);

function _module.Record.b(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#5#0#0: int, a#5#1#0: int :: 
  { #_module.Record.Record(a#5#0#0, a#5#1#0) } 
  _module.Record.b(#_module.Record.Record(a#5#0#0, a#5#1#0)) == a#5#1#0);
...
axiom (forall a: DatatypeType, b: DatatypeType :: 
  ...
  _module.Record#Equal(a, b)
     <==> _module.Record.a(a) == _module.Record.a(b)
       && _module.Record.b(a) == _module.Record.b(b));
