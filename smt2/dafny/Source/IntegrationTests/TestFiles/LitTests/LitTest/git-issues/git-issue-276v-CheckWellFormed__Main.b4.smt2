...
(set-info :boogie-vc-id CheckWellFormed$$Main.b4)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (nat_from_bv8 (bvadd (bvsub #x00 Main.__default.a) Main.__default.b)))))))
