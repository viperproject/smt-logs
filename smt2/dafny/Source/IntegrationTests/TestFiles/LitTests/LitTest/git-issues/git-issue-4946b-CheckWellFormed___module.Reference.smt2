...
(declare-fun Tagclass._System.object () T@U)
(declare-fun Tagclass._module.ReferenceTrait? () T@U)
(declare-fun Tagclass._module.ReferenceTrait () T@U)
(declare-fun tytagFamily$object () T@U)
(declare-fun tytagFamily$ReferenceTrait () T@U)
...
(declare-fun Tclass._module.ReferenceTrait () T@U)
(declare-fun Tclass._module.ReferenceTrait? () T@U)
...
(declare-fun implements$_module.ReferenceTrait (T@U) Bool)
...
(assert (distinct alloc Tagclass._System.object? Tagclass._System.object Tagclass._module.ReferenceTrait? Tagclass._module.ReferenceTrait tytagFamily$object tytagFamily$ReferenceTrait)
)
...
(assert (forall ((|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| Tclass._module.ReferenceTrait)  (and ($Is refType |c#0@@0| Tclass._module.ReferenceTrait?) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( ($Is refType |c#0@@0| Tclass._module.ReferenceTrait))
 :pattern ( ($Is refType |c#0@@0| Tclass._module.ReferenceTrait?))
)))
...
(assert (forall (($o@@1 T@U) ) (!  (=> ($Is refType $o@@1 Tclass._module.ReferenceTrait?) ($Is refType $o@@1 Tclass._System.object?))
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( ($Is refType $o@@1 Tclass._module.ReferenceTrait?))
)))
(assert (= (Tag Tclass._System.object?) Tagclass._System.object?))
(assert (= (TagFamily Tclass._System.object?) tytagFamily$object))
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (= (Tag Tclass._module.ReferenceTrait?) Tagclass._module.ReferenceTrait?))
(assert (= (TagFamily Tclass._module.ReferenceTrait?) tytagFamily$ReferenceTrait))
(assert (= (Tag Tclass._module.ReferenceTrait) Tagclass._module.ReferenceTrait))
(assert (= (TagFamily Tclass._module.ReferenceTrait) tytagFamily$ReferenceTrait))
(assert (forall (($o@@2 T@U) ) (! (= ($Is refType $o@@2 Tclass._module.ReferenceTrait?)  (or (= $o@@2 null) (implements$_module.ReferenceTrait (dtype $o@@2))))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( ($Is refType $o@@2 Tclass._module.ReferenceTrait?))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Reference)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) ($Is refType null Tclass._module.ReferenceTrait)) (=> ($Is refType null Tclass._module.ReferenceTrait) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U true))))))))
