...
(set-info :boogie-vc-id Impl$$_module.__default.Bug)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |zero#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 |zero#0@0|)) (=> (<= 0 |zero#0@0|) (=> (= (ControlFlow 0 2) (- 0 1)) (= |zero#0@0| 0)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
