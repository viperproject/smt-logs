...
(assert (distinct TChar TInt TagChar TagInt TagSeq alloc allocName Tagclass._module.Result |##_module.Result.Failure| |##_module.Result.Success| class._module.C? Tagclass._module.C? Tagclass._module.C tytagFamily$Result tytagFamily$C field$x)
)
...
(assert (forall (($h@@5 T@U) ($o@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass._module.C?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@3) _module.C.x)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |623|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@3) _module.C.x)))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (=> (not (_module.Result.IsFailure TInt |r#0@0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 _module.C.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@9 _module.C.x)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |r#0@0|) (Tclass._module.Result TInt) $Heap@@1) (= (ControlFlow 0 4) (- 0 3))) (not (_module.Result.IsFailure TInt |r#0@0|))))))))
(let ((anon5_Then_correct  (=> (_module.Result.IsFailure TInt |r#0@0|) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |r#0@0|) (Tclass._module.Result TInt) $Heap@@1) (= (ControlFlow 0 2) (- 0 1))) (|_module.Result.IsFailure#canCall| TInt |r#0@0|)) (or (_module.Result.IsFailure TInt |r#0@0|) (_module.Result.Failure_q |r#0@0|))))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#6| null $Heap@@1 alloc this@@9)) (= |r#0@0| (Lit DatatypeTypeType (|#_module.Result.Success| ($Box intType (int_2_U (LitInt 100))))))) (and ($Is DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt) $Heap@@1))) (and (and (= |$rhs#1@0| (LitInt 100)) ($IsAllocBox ($Box DatatypeTypeType |r#0@0|) (Tclass._module.Result TInt) $Heap@@1)) (and (|_module.Result.IsFailure#canCall| TInt |r#0@0|) (|_module.Result.IsFailure#canCall| TInt |r#0@0|)))) (and (=> (= (ControlFlow 0 6) 2) anon5_Then_correct) (=> (= (ControlFlow 0 6) 4) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (and (or (not (= this@@9 null)) (not true)) (and ($Is refType this@@9 Tclass._module.C) ($IsAlloc refType this@@9 Tclass._module.C $Heap@@1))) (and ($Is DatatypeTypeType |rr#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |rr#0| (Tclass._module.Result TInt) $Heap@@1))) (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@1)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct))))
