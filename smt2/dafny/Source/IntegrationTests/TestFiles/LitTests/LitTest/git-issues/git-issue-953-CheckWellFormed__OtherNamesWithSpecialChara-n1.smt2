...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@98  (=> (= (ControlFlow 0 4) (- 0 3)) (= ($generated ($generated@@85 0 ($generated 3))) ($generated 0)))))
(let (($generated@@99  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= ($generated 3) 0)) (not true)))))
