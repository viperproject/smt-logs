...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let (($generated@@108 true))
(let (($generated@@109  (=> (and (< $generated@@102 ($generated@@19 0)) (= (ControlFlow 0 7) 4)) $generated@@108)))
(let (($generated@@110  (=> (<= ($generated@@19 0) $generated@@102) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= ($generated@@19 2) 0)) (not true))) (=> (or (not (= ($generated@@19 2) 0)) (not true)) (=> (= (ControlFlow 0 5) 4) $generated@@108))))))
(let (($generated@@111  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= ($generated@@19 0) ($generated@@19 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 ($generated@@28 ($generated@@95 $generated@@33 ($generated@@19 2)) ($generated@@19 2)))))))
(let (($generated@@112  (=> (= $generated@@103 ($generated@@39 $generated@@104 $generated@@105 $generated@@1 false)) (and (and (=> (= (ControlFlow 0 8) 2) $generated@@111) (=> (= (ControlFlow 0 8) 5) $generated@@110)) (=> (= (ControlFlow 0 8) 7) $generated@@109)))))
(let (($generated@@113  (=> (and (and ($generated@@106 $generated@@105) ($generated@@107 $generated@@105)) (and (= 1 $generated@@31) (= (ControlFlow 0 9) 8))) $generated@@112)))
$generated@@113)))))))
))
(check-sat)
(get-info :rlimit)
