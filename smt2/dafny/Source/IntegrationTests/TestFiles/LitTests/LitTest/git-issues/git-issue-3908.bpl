// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3908.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3908-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3908.dfy
...
procedure {:verboseName "UnexpectedError (well-formedness)"} CheckWellFormed$$_module.__default.UnexpectedError(_module._default.UnexpectedError$G: Ty, 
    l#0: DatatypeType
       where $Is(l#0, Tclass._module.List(_module._default.UnexpectedError$G))
         && $IsAlloc(l#0, Tclass._module.List(_module._default.UnexpectedError$G), $Heap)
...
procedure {:verboseName "UnexpectedError (call)"} Call$$_module.__default.UnexpectedError(_module._default.UnexpectedError$G: Ty, 
    l#0: DatatypeType
       where $Is(l#0, Tclass._module.List(_module._default.UnexpectedError$G))
         && $IsAlloc(l#0, Tclass._module.List(_module._default.UnexpectedError$G), $Heap)
         && $IsA#_module.List(l#0));
...
procedure {:verboseName "UnexpectedError (correctness)"} Impl$$_module.__default.UnexpectedError(_module._default.UnexpectedError$G: Ty, 
    l#0: DatatypeType
       where $Is(l#0, Tclass._module.List(_module._default.UnexpectedError$G))
         && $IsAlloc(l#0, Tclass._module.List(_module._default.UnexpectedError$G), $Heap)
         && $IsA#_module.List(l#0))
...
procedure {:verboseName "UnexpectedDuplicateName (well-formedness)"} CheckWellFormed$$_module.__default.UnexpectedDuplicateName(_module._default.UnexpectedDuplicateName$G: Ty, 
    l#0: DatatypeType
       where $Is(l#0, Tclass._module.List(_module._default.UnexpectedDuplicateName$G))
         && $IsAlloc(l#0, Tclass._module.List(_module._default.UnexpectedDuplicateName$G), $Heap)
         && $IsA#_module.List(l#0));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "UnexpectedDuplicateName (call)"} Call$$_module.__default.UnexpectedDuplicateName(_module._default.UnexpectedDuplicateName$G: Ty, 
    l#0: DatatypeType
       where $Is(l#0, Tclass._module.List(_module._default.UnexpectedDuplicateName$G))
         && $IsAlloc(l#0, Tclass._module.List(_module._default.UnexpectedDuplicateName$G), $Heap)
         && $IsA#_module.List(l#0));
...
procedure {:verboseName "UnexpectedDuplicateName (correctness)"} Impl$$_module.__default.UnexpectedDuplicateName(_module._default.UnexpectedDuplicateName$G: Ty, 
    l#0: DatatypeType
       where $Is(l#0, Tclass._module.List(_module._default.UnexpectedDuplicateName$G))
         && $IsAlloc(l#0, Tclass._module.List(_module._default.UnexpectedDuplicateName$G), $Heap)
         && $IsA#_module.List(l#0))
...
// function declaration for _module._default.UnexpectedErrorInFunction
function _module.__default.UnexpectedErrorInFunction(_module._default.UnexpectedErrorInFunction$G: Ty, l#0: DatatypeType) : int
uses {
// definition axiom for _module.__default.UnexpectedErrorInFunction (revealed)
axiom {:id "id9"} 1 <= $FunctionContextHeight
   ==> (forall _module._default.UnexpectedErrorInFunction$G: Ty, l#0: DatatypeType :: 
    { _module.__default.UnexpectedErrorInFunction(_module._default.UnexpectedErrorInFunction$G, l#0) } 
    _module.__default.UnexpectedErrorInFunction#canCall(_module._default.UnexpectedErrorInFunction$G, l#0)
         || (1 < $FunctionContextHeight
           && $Is(l#0, Tclass._module.List(_module._default.UnexpectedErrorInFunction$G)))
       ==> _module.__default.UnexpectedErrorInFunction(_module._default.UnexpectedErrorInFunction$G, l#0)
         == (var x0#0 := LitReal(314e-2); 
          (if _module.List.Nil_q(l#0)
             then 11
             else (var y#0 := _module.List._h1(l#0); 
              (var x#0 := _module.List._h0(l#0); (var a#0 := x0#0; LitInt(10)))))));
// definition axiom for _module.__default.UnexpectedErrorInFunction for all literals (revealed)
axiom {:id "id10"} 1 <= $FunctionContextHeight
   ==> (forall _module._default.UnexpectedErrorInFunction$G: Ty, l#0: DatatypeType :: 
    {:weight 3} { _module.__default.UnexpectedErrorInFunction(_module._default.UnexpectedErrorInFunction$G, Lit(l#0)) } 
    _module.__default.UnexpectedErrorInFunction#canCall(_module._default.UnexpectedErrorInFunction$G, Lit(l#0))
         || (1 < $FunctionContextHeight
           && $Is(l#0, Tclass._module.List(_module._default.UnexpectedErrorInFunction$G)))
       ==> _module.__default.UnexpectedErrorInFunction(_module._default.UnexpectedErrorInFunction$G, Lit(l#0))
         == (var x0#1 := LitReal(314e-2); 
          (if _module.List.Nil_q(Lit(l#0))
             then 11
             else (var y#2 := Lit(_module.List._h1(Lit(l#0))); 
              (var x#2 := Lit(_module.List._h0(Lit(l#0))); (var a#2 := x0#1; LitInt(10)))))));
}

function _module.__default.UnexpectedErrorInFunction#canCall(_module._default.UnexpectedErrorInFunction$G: Ty, l#0: DatatypeType) : bool;

function _module.__default.UnexpectedErrorInFunction#requires(Ty, DatatypeType) : bool;

// #requires axiom for _module.__default.UnexpectedErrorInFunction
axiom (forall _module._default.UnexpectedErrorInFunction$G: Ty, l#0: DatatypeType :: 
  { _module.__default.UnexpectedErrorInFunction#requires(_module._default.UnexpectedErrorInFunction$G, l#0) } 
  $Is(l#0, Tclass._module.List(_module._default.UnexpectedErrorInFunction$G))
     ==> _module.__default.UnexpectedErrorInFunction#requires(_module._default.UnexpectedErrorInFunction$G, l#0)
       == true);

procedure {:verboseName "UnexpectedErrorInFunction (well-formedness)"} CheckWellformed$$_module.__default.UnexpectedErrorInFunction(_module._default.UnexpectedErrorInFunction$G: Ty, 
    l#0: DatatypeType
       where $Is(l#0, Tclass._module.List(_module._default.UnexpectedErrorInFunction$G)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
