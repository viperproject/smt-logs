// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-403.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-403-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-403.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var newtype$check#2: int;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-403.dfy(9,18)
    assume true;
    newtype$check#0 := LitInt(140);
    assert {:id "id0"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 256;
    assume true;
    u8#0 := LitInt(140);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-403.dfy(10,19)
    assume true;
    newtype$check#1 := u8#0;
    assert {:id "id2"} LitInt(-2147483648) <= newtype$check#1 && newtype$check#1 < 2147483648;
    newtype$check#2 := u8#0;
    assert {:id "id3"} LitInt(-2147483648) <= newtype$check#2 && newtype$check#2 < 2147483648;
    assume true;
    i32#0 := u8#0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-403.dfy(11,3)
    assume true;
    assume true;
    assume true;
    assume true;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "int32 (well-formedness)"} CheckWellFormed$$_module.int32(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id8"} LitInt(-2147483648) <= x#0 && x#0 < 2147483648;
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of newtype witness, and that it satisfies the constraint
        assume true;
        assert {:id "id9"} {:subsumption 0} LitInt(-2147483648) <= LitInt(0);
        assert {:id "id10"} {:subsumption 0} Lit(0 < 2147483648);
        assume false;
    }
}
