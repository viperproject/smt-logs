...
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U _module.__default.c) TInt)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= _module.__default.c (LitInt 5))) (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (= _module.__default.c (LitInt 5))))))
