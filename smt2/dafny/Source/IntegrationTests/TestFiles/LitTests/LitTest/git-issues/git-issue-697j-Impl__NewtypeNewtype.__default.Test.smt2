...
(assert (forall ((|x#0@@3| T@U) ) (! (= ($Is intType |x#0@@3| Tclass.NewtypeNewtype.Type2)  (and (and (<= (LitInt (- 0 2147483648)) (U_2_int |x#0@@3|)) (< (U_2_int |x#0@@3|) 2147483648)) (NewtypeNewtype.__default.P (U_2_int |x#0@@3|))))
 :pattern ( ($Is intType |x#0@@3| Tclass.NewtypeNewtype.Type2))
)))
(assert (forall ((|c0#0| T@U) ) (! (= ($Is intType |c0#0| Tclass.NewtypeNewtype.Type3)  (and (and (<= (LitInt (- 0 2147483648)) (U_2_int |c0#0|)) (< (U_2_int |c0#0|) 2147483648)) (NewtypeNewtype.__default.P (U_2_int |c0#0|))))
 :pattern ( ($Is intType |c0#0| Tclass.NewtypeNewtype.Type3))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@4| Int) ) (!  (=> (or (|NewtypeNewtype.__default.P#canCall| |x#0@@4|) (< 0 $FunctionContextHeight)) (= (NewtypeNewtype.__default.P |x#0@@4|)  (or (not (= |x#0@@4| 3)) (not true))))
 :pattern ( (NewtypeNewtype.__default.P |x#0@@4|))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@5| Int) ) (!  (=> (or (|NewtypeNewtype.__default.Q#canCall| |x#0@@5|) (< 0 $FunctionContextHeight)) (= (NewtypeNewtype.__default.Q |x#0@@5|)  (or (not (= |x#0@@5| 5)) (not true))))
 :pattern ( (NewtypeNewtype.__default.Q |x#0@@5|))
))))
(assert (forall ((x@@4 T@U) (T@@0 T@T) ) (! (= ($Box T@@0 ($Unbox T@@0 x@@4)) x@@4)
 :pattern ( ($Unbox T@@0 x@@4))
)))
(assert (forall ((|x#0@@6| T@U) ) (! (= ($Is intType |x#0@@6| Tclass.NewtypeNewtype.Type6)  (and (and (NewtypeNewtype.__default.Q (U_2_int |x#0@@6|)) (< (U_2_int |x#0@@6|) 8)) (<= (LitInt 0) (U_2_int |x#0@@6|))))
 :pattern ( ($Is intType |x#0@@6| Tclass.NewtypeNewtype.Type6))
)))
(assert (forall ((|x#0@@7| T@U) ) (! (= ($Is intType |x#0@@7| Tclass.NewtypeNewtype.Type4)  (and (NewtypeNewtype.__default.Q (U_2_int |x#0@@7|)) (< (U_2_int |x#0@@7|) 8)))
 :pattern ( ($Is intType |x#0@@7| Tclass.NewtypeNewtype.Type4))
)))
(assert (forall ((|c0#0@@0| T@U) ) (! (= ($Is intType |c0#0@@0| Tclass.NewtypeNewtype.Type5)  (and (NewtypeNewtype.__default.Q (U_2_int |c0#0@@0|)) (< (U_2_int |c0#0@@0|) 8)))
 :pattern ( ($Is intType |c0#0@@0| Tclass.NewtypeNewtype.Type5))
)))
