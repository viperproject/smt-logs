...
(set-info :boogie-vc-id CheckWellFormed$$_module.Tx)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitInt 0) (LitInt 100))))))
