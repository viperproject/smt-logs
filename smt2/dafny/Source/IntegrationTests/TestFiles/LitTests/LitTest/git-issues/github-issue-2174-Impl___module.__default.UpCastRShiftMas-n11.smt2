...
(set-info :boogie-vc-id Impl$$_module.__default.UpCastRShiftMasking)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (concat #x0000000000000000 |v#0|) (bvand (concat #x0000000000000000 |v#0|) (bvlshr _module.__default.Ones (concat #x000000000000000000000000000000 ((_ int2bv 8) |idx#0|))))))))
