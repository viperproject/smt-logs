...
(set-info :boogie-vc-id Impl$$_module.__default.FR)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($Is DatatypeTypeType |r#0| (Tclass._module.FResult TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.FResult TInt) $Heap@@1))) (and (and ($Is DatatypeTypeType |r#1| (Tclass._module.FResult TInt)) ($IsAlloc DatatypeTypeType |r#1| (Tclass._module.FResult TInt) $Heap@@1)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError0#0| (Tclass._module.FResult TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0| (Tclass._module.FResult TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
