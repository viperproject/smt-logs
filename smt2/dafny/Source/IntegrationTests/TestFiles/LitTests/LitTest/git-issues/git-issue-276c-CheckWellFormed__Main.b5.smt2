...
(let ((anon11_Else_correct  (=> (and (or (not (= (Lit charType (|char#FromInt| 97)) Main.__default.c)) (not true)) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (= (Lit charType (|char#FromInt| 97)) Main.__default.c) (= (ControlFlow 0 6) 4)) anon6_correct)))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite (= (Lit charType (|char#FromInt| 97)) Main.__default.c) 30 40))))))
