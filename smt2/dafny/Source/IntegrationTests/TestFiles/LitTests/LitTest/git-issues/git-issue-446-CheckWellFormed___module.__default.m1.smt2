...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.Result$T@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.Result.Extract#canCall| _module.Result$T@@0 this@@0) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@0 (Tclass._module.Result _module.Result$T@@0)) (_module.Result.Success_q this@@0)))) ($IsBox (_module.Result.Extract _module.Result$T@@0 this@@0) _module.Result$T@@0))
 :qid |unknown.0:0|
 :skolemid |539|
 :pattern ( (_module.Result.Extract _module.Result$T@@0 this@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.Result$T@@2 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Result.Extract#canCall| _module.Result$T@@2 (Lit DatatypeTypeType this@@1)) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@1 (Tclass._module.Result _module.Result$T@@2)) (U_2_bool (Lit boolType (bool_2_U (_module.Result.Success_q (Lit DatatypeTypeType this@@1)))))))) (= (_module.Result.Extract _module.Result$T@@2 (Lit DatatypeTypeType this@@1)) (Lit BoxType (_module.Result.value (Lit DatatypeTypeType this@@1)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |543|
 :pattern ( (_module.Result.Extract _module.Result$T@@2 (Lit DatatypeTypeType this@@1)))
))))
...
(assert (forall ((_module.Result$T@@10 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.Result _module.Result$T@@10)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) (Tclass._module.Result _module.Result$T@@10))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsBox bx@@3 (Tclass._module.Result _module.Result$T@@10)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.Result$T@@12 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Result.Extract#canCall| _module.Result$T@@12 this@@2) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@2 (Tclass._module.Result _module.Result$T@@12)) (_module.Result.Success_q this@@2)))) (= (_module.Result.Extract _module.Result$T@@12 this@@2) (_module.Result.value this@@2)))
 :qid |unknown.0:0|
 :skolemid |542|
 :pattern ( (_module.Result.Extract _module.Result$T@@12 this@@2))
))))
(push 1)
...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.m1)
...
(let ((anon7_Else_correct  (=> (=> (<= (LitInt 0) |i#0|) (and (_module.Result.Success_q |r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |r#0@0|))) |i#0|))) (and (=> (= (ControlFlow 0 5) 1) anon8_Then_correct) (=> (= (ControlFlow 0 5) 2) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (<= (LitInt 0) |i#0|) (=> (and (_module.Result.Success_q |r#0@0|) ($IsAllocBox ($Box DatatypeTypeType |r#0@0|) (Tclass._module.Result TInt) $Heap@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.Result.Success_q |r#0@0|)) (=> (_module.Result.Success_q |r#0@0|) (=> (and (|_module.Result.Extract#canCall| TInt |r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |r#0@0|))) |i#0|)) (and (=> (= (ControlFlow 0 3) 1) anon8_Then_correct) (=> (= (ControlFlow 0 3) 2) anon8_Else_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@0)))
 :qid |gitissue446dfy.49:8|
 :skolemid |495|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap@@0 $Heap@0)) (and ($Is DatatypeTypeType |r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0@0| (Tclass._module.Result TInt) $Heap@0))) (and (=> (= (ControlFlow 0 6) 3) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
