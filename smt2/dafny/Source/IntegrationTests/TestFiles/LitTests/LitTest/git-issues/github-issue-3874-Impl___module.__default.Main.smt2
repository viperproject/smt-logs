...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (and ($Is boolType (Lit boolType (bool_2_U true)) TBool) (> (|MultiSet#Multiplicity| |s#0@1| ($Box boolType (Lit boolType (bool_2_U true)))) 0)) (or (and ($Is boolType (Lit boolType (bool_2_U false)) TBool) (> (|MultiSet#Multiplicity| |s#0@1| ($Box boolType (Lit boolType (bool_2_U false)))) 0)) (exists ((|$as#x0_0#0_0| T@U) ) (> (|MultiSet#Multiplicity| |s#0@1| ($Box boolType |$as#x0_0#0_0|)) 0))))) (=> (or (and ($Is boolType (Lit boolType (bool_2_U true)) TBool) (> (|MultiSet#Multiplicity| |s#0@1| ($Box boolType (Lit boolType (bool_2_U true)))) 0)) (or (and ($Is boolType (Lit boolType (bool_2_U false)) TBool) (> (|MultiSet#Multiplicity| |s#0@1| ($Box boolType (Lit boolType (bool_2_U false)))) 0)) (exists ((|$as#x0_0#0_0@@0| Bool) ) (> (|MultiSet#Multiplicity| |s#0@1| ($Box boolType (bool_2_U |$as#x0_0#0_0@@0|))) 0)))) (=> (> (|MultiSet#Multiplicity| |s#0@1| ($Box boolType (bool_2_U |x#0_0@1|))) 0) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= 0 (LitInt 0))) (=> (<= 0 (LitInt 0)) (=> (and (= |s#0@2| (|MultiSet#UpdateMultiplicity| |s#0@1| ($Box boolType (bool_2_U |x#0_0@1|)) (LitInt 0))) (= (ControlFlow 0 5) (- 0 4))) (and (|MultiSet#Subset| |s#0@2| |s#0@1|) (not (|MultiSet#Equal| |s#0@2| |s#0@1|)))))))))))
