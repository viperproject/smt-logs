...
(set-info :boogie-vc-id Impl$$_module.A.StatementsInGhostMethod)
...
(let ((anon10_Else_correct  (=> (= |b#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 8) 6) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 5) (- 0 4))) (U_2_bool (Lit boolType (bool_2_U true))))))
(let ((anon9_Else_correct  (=> (= (LitInt 100) (LitInt 100)) (and (=> (= (ControlFlow 0 9) 5) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 3) (- 0 2))) (= (LitInt 100) (LitInt 100)))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (U_2_bool (Lit boolType (bool_2_U false)))) (and (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 3) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
