...
(assert (forall ((a@@6 T@U) (b@@6 T@U) (t0@@0 T@U) (t1@@0 T@U) ) (!  (=> (forall ((bx T@U) )  (=> (|Set#IsMember| a@@6 bx) (and ($IsBox bx t0@@0) ($IsBox (MapType0Select BoxType BoxType b@@6 bx) t1@@0)))) ($Is MapType (|Map#Glue| a@@6 b@@6 (TMap t0@@0 t1@@0)) (TMap t0@@0 t1@@0)))
