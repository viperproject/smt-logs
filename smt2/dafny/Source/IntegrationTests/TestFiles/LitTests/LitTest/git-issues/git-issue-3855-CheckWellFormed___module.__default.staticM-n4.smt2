...
(assert (forall ((a@@4 T@U) (b@@4 T@U) ) (! (= (|_module.Mode#Equal| a@@4 b@@4) (= a@@4 b@@4))
 :qid |unknown.0:0|
 :skolemid |696|
 :pattern ( (|_module.Mode#Equal| a@@4 b@@4))
)))
(assert (forall ((a@@5 T@U) (b@@5 T@U) ) (! (= (|_module.Region#Equal| a@@5 b@@5) (= a@@5 b@@5))
 :qid |unknown.0:0|
 :skolemid |737|
 :pattern ( (|_module.Region#Equal| a@@5 b@@5))
)))
...
(assert (forall ((a@@6 T@U) (b@@6 T@U) (t0@@0 T@U) (t1@@0 T@U) ) (!  (=> (forall ((bx T@U) ) (!  (=> (|Set#IsMember| a@@6 bx) (and ($IsBox bx t0@@0) ($IsBox (MapType0Select BoxType BoxType b@@6 bx) t1@@0)))
...
(assert (forall ((a@@7 T@U) (b@@7 T@U) ) (! (= (|Set#Subset| a@@7 b@@7) (forall ((o@@1 T@U) ) (!  (=> (|Set#IsMember| a@@7 o@@1) (|Set#IsMember| b@@7 o@@1))
...
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (!  (=> (and (_module.Mode.Imm_q a@@11) (_module.Mode.Imm_q b@@11)) (|_module.Mode#Equal| a@@11 b@@11))
 :qid |unknown.0:0|
 :skolemid |691|
 :pattern ( (|_module.Mode#Equal| a@@11 b@@11) (_module.Mode.Imm_q a@@11))
 :pattern ( (|_module.Mode#Equal| a@@11 b@@11) (_module.Mode.Imm_q b@@11))
)))
(assert (forall ((a@@12 T@U) (b@@12 T@U) ) (!  (=> (and (_module.Mode.Iso_q a@@12) (_module.Mode.Iso_q b@@12)) (|_module.Mode#Equal| a@@12 b@@12))
 :qid |unknown.0:0|
 :skolemid |692|
 :pattern ( (|_module.Mode#Equal| a@@12 b@@12) (_module.Mode.Iso_q a@@12))
 :pattern ( (|_module.Mode#Equal| a@@12 b@@12) (_module.Mode.Iso_q b@@12))
)))
(assert (forall ((a@@13 T@U) (b@@13 T@U) ) (!  (=> (and (_module.Mode.Mut_q a@@13) (_module.Mode.Mut_q b@@13)) (|_module.Mode#Equal| a@@13 b@@13))
 :qid |unknown.0:0|
 :skolemid |693|
 :pattern ( (|_module.Mode#Equal| a@@13 b@@13) (_module.Mode.Mut_q a@@13))
 :pattern ( (|_module.Mode#Equal| a@@13 b@@13) (_module.Mode.Mut_q b@@13))
)))
(assert (forall ((a@@14 T@U) (b@@14 T@U) ) (!  (=> (and (_module.Mode.Tmp_q a@@14) (_module.Mode.Tmp_q b@@14)) (|_module.Mode#Equal| a@@14 b@@14))
 :qid |unknown.0:0|
 :skolemid |694|
 :pattern ( (|_module.Mode#Equal| a@@14 b@@14) (_module.Mode.Tmp_q a@@14))
 :pattern ( (|_module.Mode#Equal| a@@14 b@@14) (_module.Mode.Tmp_q b@@14))
)))
(assert (forall ((a@@15 T@U) (b@@15 T@U) ) (!  (=> (and (_module.Mode.Sus_q a@@15) (_module.Mode.Sus_q b@@15)) (|_module.Mode#Equal| a@@15 b@@15))
 :qid |unknown.0:0|
 :skolemid |695|
 :pattern ( (|_module.Mode#Equal| a@@15 b@@15) (_module.Mode.Sus_q a@@15))
 :pattern ( (|_module.Mode#Equal| a@@15 b@@15) (_module.Mode.Sus_q b@@15))
)))
(assert (forall ((a@@16 T@U) (b@@16 T@U) ) (!  (=> (and (_module.Region.Frozen_q a@@16) (_module.Region.Frozen_q b@@16)) (|_module.Region#Equal| a@@16 b@@16))
 :qid |unknown.0:0|
 :skolemid |732|
 :pattern ( (|_module.Region#Equal| a@@16 b@@16) (_module.Region.Frozen_q a@@16))
 :pattern ( (|_module.Region#Equal| a@@16 b@@16) (_module.Region.Frozen_q b@@16))
)))
(assert (forall ((a@@17 T@U) (b@@17 T@U) ) (!  (=> (and (_module.Region.Isolate_q a@@17) (_module.Region.Isolate_q b@@17)) (|_module.Region#Equal| a@@17 b@@17))
 :qid |unknown.0:0|
 :skolemid |736|
 :pattern ( (|_module.Region#Equal| a@@17 b@@17) (_module.Region.Isolate_q a@@17))
 :pattern ( (|_module.Region#Equal| a@@17 b@@17) (_module.Region.Isolate_q b@@17))
)))
(assert (forall ((v@@3 T@U) (t0@@3 T@U) (h@@3 T@U) ) (! (= ($IsAlloc SetType v@@3 (TSet t0@@3) h@@3) (forall ((bx@@12 T@U) ) (!  (=> (|Set#IsMember| v@@3 bx@@12) ($IsAllocBox bx@@12 t0@@3 h@@3))
...
(assert (forall ((v@@5 T@U) (t0@@5 T@U) (t1@@2 T@U) (h@@5 T@U) ) (! (= ($IsAlloc MapType v@@5 (TMap t0@@5 t1@@2) h@@5) (forall ((bx@@13 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@5) bx@@13) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@5) bx@@13) t1@@2 h@@5) ($IsAllocBox bx@@13 t0@@5 h@@5)))
 :qid |DafnyPreludebpl.318:19|
 :skolemid |75|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@5) bx@@13))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@5) bx@@13))
)))
...
(assert (forall ((bx@@14 T@U) (s@@2 T@U) (t@@12 T@U) ) (!  (=> ($IsBox bx@@14 (TMap s@@2 t@@12)) (and (= ($Box MapType ($Unbox MapType bx@@14)) bx@@14) ($Is MapType ($Unbox MapType bx@@14) (TMap s@@2 t@@12))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@14 (TMap s@@2 t@@12)))
)))
...
(assert (forall ((bx@@16 T@U) (t@@13 T@U) ) (!  (=> ($IsBox bx@@16 (TSet t@@13)) (and (= ($Box SetType ($Unbox SetType bx@@16)) bx@@16) ($Is SetType ($Unbox SetType bx@@16) (TSet t@@13))))
 :qid |DafnyPreludebpl.195:15|
 :skolemid |32|
 :pattern ( ($IsBox bx@@16 (TSet t@@13)))
)))
(assert (forall ((bx@@17 T@U) (t@@14 T@U) ) (!  (=> ($IsBox bx@@17 (TSeq t@@14)) (and (= ($Box SeqType ($Unbox SeqType bx@@17)) bx@@17) ($Is SeqType ($Unbox SeqType bx@@17) (TSeq t@@14))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |35|
 :pattern ( ($IsBox bx@@17 (TSeq t@@14)))
)))
...
(assert (forall ((v@@8 T@U) (t0@@6 T@U) (t1@@3 T@U) ) (! (= ($Is MapType v@@8 (TMap t0@@6 t1@@3)) (forall ((bx@@18 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@18) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@18) t1@@3) ($IsBox bx@@18 t0@@6)))
...
(assert (forall ((a@@18 T@U) (b@@18 T@U) ) (! (= (|Set#Equal| a@@18 b@@18) (forall ((o@@2 T@U) ) (! (= (|Set#IsMember| a@@18 o@@2) (|Set#IsMember| b@@18 o@@2))
 :qid |DafnyPreludebpl.783:19|
 :skolemid |148|
 :pattern ( (|Set#IsMember| a@@18 o@@2))
 :pattern ( (|Set#IsMember| b@@18 o@@2))
)))
...
(assert (forall ((v@@11 T@U) (t0@@7 T@U) ) (! (= ($Is SeqType v@@11 (TSeq t0@@7)) (forall ((i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| v@@11))) ($IsBox (|Seq#Index| v@@11 i@@1) t0@@7))
...
(assert (forall ((m@@14 T@U) ) (!  (or (= m@@14 |Map#Empty|) (exists ((k@@3 T@U) (v@@12 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@14) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@3 v@@12)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.staticMoveAsg)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@21 alloc |frame#0| _module.Object.fields)) (and (=> (= (ControlFlow 0 2) (- 0 19)) (or (not (= |memory#0| null)) (not true))) (=> (or (not (= |memory#0| null)) (not true)) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |memory#0|) _module.Memory.objects)) ($Box refType |frame#0|)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 17)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|)) (and (=> (= (ControlFlow 0 2) (- 0 16)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= |memory#0| null)) (not true))) (=> (or (not (= |memory#0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |memory#0|) Tclass._module.Memory? $Heap@@21) (|_module.Memory.Valid#canCall| $Heap@@21 |memory#0|)) (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 |memory#0|) (not (|Seq#Equal| |t#0@@12| |f#0@@1|)))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|))) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 11)) (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|))) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|)) (=> (|_module.Mode#Equal| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |t#0@@12|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes |frame#0|)) ($Box SeqType |f#0@@1|)))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (and (and (= |##x#0@0| (_module.Region.Frozen_q (_module.Object.region |frame#0|))) ($IsAlloc boolType (bool_2_U |##x#0@0|) TBool $Heap@@21)) (and (|_module.__default.not#canCall| (_module.Region.Frozen_q (_module.Object.region |frame#0|))) (_module.__default.not (_module.Region.Frozen_q (_module.Object.region |frame#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@25) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@25)) (= $o@@25 |frame#0|)))
 :qid |gitissue3855dfy.1023:8|
 :skolemid |602|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25))
))) (and (forall (($o@@26 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@26) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@26) $f@@13)) (and (= $o@@26 |frame#0|) (= $f@@13 _module.Object.fields))))
 :qid |gitissue3855dfy.1023:8|
 :skolemid |603|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) $f@@13))
)) ($HeapSucc $Heap@@21 $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (=> (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@1|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |frame#0|) _module.Object.fields))) ($Box SeqType |t#0@@12|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |frame#0| null)) (not true))) (=> (or (not (= |frame#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |frame#0| Tclass._module.Object $Heap@@21)) (=> ($IsAlloc refType |frame#0| Tclass._module.Object $Heap@@21) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |frame#0|) _module.Object.fields))) ($Box SeqType |f#0@@1|))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (and ($Is SeqType |t#0@@12| (TSeq TChar)) ($IsAlloc SeqType |t#0@@12| (TSeq TChar) $Heap@@21))) (=> (and (and (and ($Is SeqType |f#0@@1| (TSeq TChar)) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@@21)) (and ($Is refType |frame#0| Tclass._module.Object) ($IsAlloc refType |frame#0| Tclass._module.Object $Heap@@21))) (and (and ($Is refType |memory#0| Tclass._module.Memory) ($IsAlloc refType |memory#0| Tclass._module.Memory $Heap@@21)) (and (= 11 $FunctionContextHeight) (= (ControlFlow 0 20) 2)))) anon0_correct))))
