...
(assert (distinct TInt TagInt TagSet TagSeq alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._module.uint8 tytagFamily$object |tytagFamily$_#Func1| tytagFamily$uint8)
)
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) ($IsAlloc intType (int_2_U _module.__default.TWO__TO__THE__8) TInt $h@@2))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |479|
 :pattern ( ($IsAlloc intType (int_2_U _module.__default.TWO__TO__THE__8) TInt $h@@2))
))))
...
(assert (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 Tclass._module.uint8) (and (= ($Box intType ($Unbox intType bx@@7)) bx@@7) ($Is intType ($Unbox intType bx@@7) Tclass._module.uint8)))
 :qid |unknown.0:0|
 :skolemid |483|
 :pattern ( ($IsBox bx@@7 Tclass._module.uint8))
)))
...
(assert (forall ((|x#0@@0| T@U) ) (! (= ($Is intType |x#0@@0| Tclass._module.uint8)  (and (<= (LitInt 0) (U_2_int |x#0@@0|)) (< (U_2_int |x#0@@0|) _module.__default.TWO__TO__THE__8)))
 :qid |unknown.0:0|
 :skolemid |485|
...
(let ((anon6_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (=> (and (= |newtype$check#1@0| (LitInt 0)) (= (ControlFlow 0 4) (- 0 3))) (and (<= (LitInt 0) |newtype$check#1@0|) (< |newtype$check#1@0| _module.__default.TWO__TO__THE__8))))))
...
(let ((anon5_Else_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |i#0@0|)) (Requires1 TInt Tclass._module.uint8 $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box intType (int_2_U (LitInt 0)))) (|lambda#2| TInt) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |gitissue5065dfy.8:24|
 :skolemid |484|
)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 10))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| _module.__default.TWO__TO__THE__8))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| _module.__default.TWO__TO__THE__8)) (=> (= |i#0@0| (LitInt 10)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= 0 |i#0@0|)) (=> (<= 0 |i#0@0|) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |i#0|) (< |i#0| _module.__default.TWO__TO__THE__8)) true) (=> (and (and (and ($Is SeqType |s#0| (TSeq Tclass._module.uint8)) ($IsAlloc SeqType |s#0| (TSeq Tclass._module.uint8) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 7))) anon0_correct)))))
