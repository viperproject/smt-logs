...
(set-info :boogie-vc-id CheckWellFormed$$M3.MyChar)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (Lit charType (|char#FromInt| 68)) (Lit charType (|char#FromInt| 68))))))
