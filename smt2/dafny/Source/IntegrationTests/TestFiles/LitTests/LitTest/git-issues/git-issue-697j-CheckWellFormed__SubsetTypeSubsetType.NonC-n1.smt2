...
(set-info :boogie-vc-id CheckWellFormed$$SubsetTypeSubsetType.NonCompilableTestInt32)
...
(let ((anon9_Then_correct  (=> (=> (<= (LitInt (- 0 2147483648)) (LitInt 0)) (=> (U_2_bool (Lit boolType (bool_2_U (< 0 2147483648)))) (|SubsetTypeSubsetType.__default.P#canCall| (LitInt 0)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (LitInt (- 0 2147483648)) (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (Lit boolType (bool_2_U (< 0 2147483648))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|SubsetTypeSubsetType.__default.P#canCall| (LitInt 0)) (or (U_2_bool (Lit boolType (bool_2_U (SubsetTypeSubsetType.__default.P (LitInt 0))))) (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 3)) (not true)))))))))))))
