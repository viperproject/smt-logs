...
(declare-fun |a#0| () T@U)
(set-info :boogie-vc-id Impl$$StayOpaque.__default.TestByReveal)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |b#0| Tclass.StayOpaque.B) ($IsAlloc refType |b#0| Tclass.StayOpaque.B $Heap))) (and (and (=> |defass#a#0| (and ($Is refType |a#0| Tclass.StayOpaque.A) ($IsAlloc refType |a#0| Tclass.StayOpaque.A $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
