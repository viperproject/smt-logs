...
(declare-fun Example2.__default.F (Int) T@U)
(declare-fun |Example2.__default.F#canCall| (Int) Bool)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|v#0| Int) ) (!  (=> (or (|Example2.__default.F#canCall| |v#0|) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |v#0|))) ($IsBox (Example2.__default.F |v#0|) Tclass.Example2.R))
 :qid |gitissue1958dfy.55:20|
 :skolemid |1650|
 :pattern ( (Example2.__default.F |v#0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|v#0@@0| Int) ) (!  (=> (or (|Example2.__default.F#canCall| |v#0@@0|) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |v#0@@0|))) (and (|Example2.__default.Ctor#canCall| |v#0@@0|) (= (Example2.__default.F |v#0@@0|) (let ((|o#0| (Example2.__default.Ctor |v#0@@0|)))
|o#0|))))
 :qid |gitissue1958dfy.55:20|
 :skolemid |1652|
 :pattern ( (Example2.__default.F |v#0@@0|))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|v#0@@1| Int) ) (!  (=> (or (|Example2.__default.F#canCall| (LitInt |v#0@@1|)) (and (< 3 $FunctionContextHeight) (<= (LitInt 0) |v#0@@1|))) (and (|Example2.__default.Ctor#canCall| (LitInt |v#0@@1|)) (= (Example2.__default.F (LitInt |v#0@@1|)) (let ((|o#1| (Lit BoxType (Example2.__default.Ctor (LitInt |v#0@@1|)))))
|o#1|))))
 :qid |gitissue1958dfy.55:20|
 :weight 3
 :skolemid |1653|
 :pattern ( (Example2.__default.F (LitInt |v#0@@1|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Example2.__default.F)
