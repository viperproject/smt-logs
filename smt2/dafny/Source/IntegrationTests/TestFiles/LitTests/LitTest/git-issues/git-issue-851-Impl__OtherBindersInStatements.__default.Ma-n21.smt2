...
(declare-fun |lambda#14| (T@U T@U T@U Bool Bool) T@U)
...
(assert (distinct TBool TInt TagBool TagInt TagSet TagMap alloc Tagclass._System.object? Tagclass._System.object |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.OtherBindersInStatements.C Tagclass.OtherBindersInStatements.C? tytagFamily$object |tytagFamily$_tuple#2| tytagFamily$C)
)
...
(assert (forall ((bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 Tclass.OtherBindersInStatements.C?) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) Tclass.OtherBindersInStatements.C?)))
 :qid |unknown.0:0|
 :skolemid |2992|
 :pattern ( ($IsBox bx@@6 Tclass.OtherBindersInStatements.C?))
)))
...
(assert (forall ((|l#0| T@U) (|$w#0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#9| |l#0|) |$w#0|) |l#0|)
 :qid |gitissue851dfy.174:14|
 :skolemid |4124|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#9| |l#0|) |$w#0|))
)))
...
(assert (forall ((v@@3 T@U) (t0@@3 T@U) (t1@@1 T@U) (h@@1 T@U) ) (! (= ($IsAlloc MapType v@@3 (TMap t0@@3 t1@@1) h@@1) (forall ((bx@@10 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@3) bx@@10) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@3) bx@@10) t1@@1 h@@1) ($IsAllocBox bx@@10 t0@@3 h@@1)))
 :qid |DafnyPreludebpl.318:19|
 :skolemid |2538|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@3) bx@@10))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@3) bx@@10))
)))
...
(assert (forall ((bx@@11 T@U) (s T@U) (t@@8 T@U) ) (!  (=> ($IsBox bx@@11 (TMap s t@@8)) (and (= ($Box MapType ($Unbox MapType bx@@11)) bx@@11) ($Is MapType ($Unbox MapType bx@@11) (TMap s t@@8))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |2499|
 :pattern ( ($IsBox bx@@11 (TMap s t@@8)))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1| |l#2| |l#3|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |4121|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1| |l#2| |l#3|) $o@@3 $f))
)))
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) (|l#4| Bool) (|$w#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#14| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4|) |$w#0@@0|))  (and (and ($IsBox |$w#0@@0| |l#0@@1|) ($IsAllocBox |$w#0@@0| |l#1@@0| |l#2@@0|)) (exists ((|a#0#0#0@@0| T@U) ) (!  (and |l#3@@0| (= (U_2_bool ($Unbox boolType |$w#0@@0|)) |l#4|))
 :qid |gitissue851dfy.186:18|
 :skolemid |2978|
))))
 :qid |DafnyPreludebpl.21:1|
 :skolemid |4125|
 :pattern ( (MapType0Select BoxType boolType (|lambda#14| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4|) |$w#0@@0|))
)))
...
(assert (forall ((bx@@14 T@U) ) (!  (=> ($IsBox bx@@14 Tclass.OtherBindersInStatements.C?) ($IsBox bx@@14 Tclass._System.object?))
 :qid |unknown.0:0|
 :skolemid |2997|
 :pattern ( ($IsBox bx@@14 Tclass.OtherBindersInStatements.C?))
)))
...
(set-info :boogie-vc-id Impl$$OtherBindersInStatements.__default.MapComprehension2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon7_correct  (=> (forall ((|a#1#0#0@@0| T@U) ) (!  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))))
 :qid |gitissue851dfy.186:18|
 :skolemid |2980|
)) (=> (and (= |b#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#14| TBool TBool $Heap (U_2_bool (Lit boolType (bool_2_U true))) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))) (|lambda#9| ($Box intType (int_2_U (LitInt 20)))) (TMap TBool TInt))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true))))))
(let ((anon11_Else_correct  (=> (and (not (and (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 6) 2)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (= (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))  (not (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))) (= (LitInt 20) (LitInt 20)))) (=> (or (= (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))  (not (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))) (= (LitInt 20) (LitInt 20))) (=> (= (ControlFlow 0 4) 2) anon7_correct))))))
(let ((anon10_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 8) 4) anon11_Then_correct) (=> (= (ControlFlow 0 8) 6) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 7) 4) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 12) 7) anon10_Then_correct) (=> (= (ControlFlow 0 12) 8) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (and (=> (= (ControlFlow 0 9) 7) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct))))))))))
(let ((anon8_Then_correct  (=> (and (and ($Is refType |c#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@0| Tclass.OtherBindersInStatements.C $Heap)) (and ($Is refType |c#prime#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#prime#0@0| Tclass.OtherBindersInStatements.C $Heap))) (and (=> (= (ControlFlow 0 13) 9) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (not (and ($Is refType |c#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@0| Tclass.OtherBindersInStatements.C $Heap))) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 14) 13) anon8_Then_correct) (=> (= (ControlFlow 0 14) 3) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |b#0| (TMap TBool TInt)) ($IsAlloc MapType |b#0| (TMap TBool TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct))))
