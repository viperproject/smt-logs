...
(set-info :boogie-vc-id Impl$$StartingFromOpaqueType_mOpaqueType.__default.Caller)
...
(let ((anon3_Then_correct  (=> (and (and (or (not (= |c#0@0| 9)) (not true)) (= |x##0_0@0| (StartingFromOpaqueType_mOpaqueType.Ty.c |t#0|))) (and (<= (LitInt 0) |call3formal@r#0|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |x##0_0@0| 9)) (not true)))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |c#0@0| (StartingFromOpaqueType_mOpaqueType.Ty.c |t#0|))) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |t#0| Tclass.StartingFromOpaqueType_mOpaqueType.Ty) ($IsAllocBox |t#0| Tclass.StartingFromOpaqueType_mOpaqueType.Ty $Heap))) (=> (and (and (and (<= (LitInt 0) |c#0|) true) (and (<= (LitInt 0) |r#0_0|) true)) (and (and (<= (LitInt 0) |u#0_0|) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 4)))) anon0_correct))))
