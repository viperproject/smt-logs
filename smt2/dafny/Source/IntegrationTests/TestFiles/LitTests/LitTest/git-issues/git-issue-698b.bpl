// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-698b.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-698b-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-698b.dfy
...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    _module.__default.F#canCall(x#0) || (0 < $FunctionContextHeight && x#0 != 3)
       ==> _module.__default.F(x#0)
         == (if x#0 == LitInt(3) then Div(1, LitInt(0)) else 100));
   ...
   ==> (forall x#0: int :: 
    ...
    _module.__default.F#canCall(LitInt(x#0))
       ...
       ==> _module.__default.F(LitInt(x#0))
         == (if LitInt(x#0) == LitInt(3) then Div(1, LitInt(0)) else 100));
}
  ...
  var $_ReadsFrame: [ref,Field]bool;
    ...
    else
    {
        ...
        if (x#0 == LitInt(3))
        {
            ...
            assume {:id "id4"} _module.__default.F(x#0) == LitInt(Div(1, LitInt(0)));
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.F(x#0), TInt);
            return;
        }
        else
        {
            assume {:id "id5"} _module.__default.F(x#0) == LitInt(100);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.F(x#0), TInt);
            return;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var ##x#0: int;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-698b.dfy(12,9)
    assume true;
    // Begin Comprehension WF check
    havoc n#1;
    if (LitInt(0) <= n#1 && n#1 < 100 && n#1 != 3)
    {
        ##x#0 := n#1;
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assert {:id "id6"} {:subsumption 0} ##x#0 != 3;
        assume ##x#0 != 3;
        assume _module.__default.F#canCall(n#1);
    }

    // End Comprehension WF check
    assume (forall n#0: int :: 
      { _module.__default.F(n#0) } 
      LitInt(0) <= n#0 && n#0 < 100 && n#0 != 3 ==> _module.__default.F#canCall(n#0));
    b#0 := !(exists n#0: int :: 
      { _module.__default.F(n#0) } 
      LitInt(0) <= n#0 && n#0 < 100 && n#0 != 3 && _module.__default.F(n#0) != 100);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-698b.dfy(13,3)
    assume true;
    assert {:id "id8"} b#0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-698b.dfy(14,3)
    assume true;
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Small (well-formedness)"} CheckWellFormed$$_module.Small(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    // AddWellformednessCheck for subset type Small
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        ...
        assume {:id "id9"} LitInt(0) <= x#0 && x#0 < 100;
        assume {:id "id10"} x#0 != 3;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id12"} {:subsumption 0} Lit(0 < 100);
        assert {:id "id13"} {:subsumption 0} Lit(0 != 3);
        assume false;
    }
}
...
// $Is axiom for subset type _module.Small
axiom (forall x#0: int :: 
  { $Is(x#0, Tclass._module.Small()) } 
  $Is(x#0, Tclass._module.Small()) <==> LitInt(0) <= x#0 && x#0 < 100 && x#0 != 3);

// $IsAlloc axiom for subset type _module.Small
axiom (forall x#0: int, $h: Heap :: 
