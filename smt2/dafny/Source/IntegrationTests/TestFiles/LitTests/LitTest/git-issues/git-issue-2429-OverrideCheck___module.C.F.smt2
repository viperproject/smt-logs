...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= _module.T$A@@9 Tclass._System.object) (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|)))) (=> (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) (=> (|_module.__default.P#canCall| Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) 3 4) (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) 3 4))) (=> (<= (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) 3 4) (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) 3 4)) (=> (= C_$_ReadsFrame@0 (|lambda#1| null $Heap@@0 alloc (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@8 T@U) ($f@@0 T@U) )  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@8) alloc)))) (|Set#IsMember| (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) ($Box refType $o@@8))) (|Set#IsMember| (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) ($Box refType $o@@8))))) (=> (forall (($o@@9 T@U) ($f@@1 T@U) )  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9) alloc)))) (|Set#IsMember| (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) ($Box refType $o@@9))) (|Set#IsMember| (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) ($Box refType $o@@9)))) (=> (and (and (=> (= (_module.C.F $Heap@@0 this@@0 |a#0@@0|) (LitInt 5)) (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|)))) (= (ControlFlow 0 2) (- 0 1))) (= (_module.C.F $Heap@@0 this@@0 |a#0@@0|) (LitInt 5))) (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|)))))))))))))))
