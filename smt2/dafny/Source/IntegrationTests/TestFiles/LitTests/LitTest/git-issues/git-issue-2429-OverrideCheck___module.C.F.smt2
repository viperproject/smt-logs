...
(declare-fun _module.C.F (T@U T@U T@U) Int)
(declare-fun |_module.C.F#canCall| (T@U T@U T@U) Bool)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|a#0| T@U) ) (!  (=> (or (|_module.C.F#canCall| $Heap this |a#0|) (and (< 2 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap)))) (and ($Is refType |a#0| Tclass._System.object) ($IsAlloc refType |a#0| Tclass._System.object $Heap))) (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|)))))) (=> (= (_module.C.F $Heap this |a#0|) (LitInt 5)) (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|)))))
 :qid |gitissue2429dfy.29:18|
 :skolemid |512|
 :pattern ( (_module.C.F $Heap this |a#0|))
))))
...
(assert (forall ((v@@4 T@U) (t0@@0 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SeqType v@@4 (TSeq t0@@0) h@@0) (forall ((i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| v@@4))) ($IsAllocBox (|Seq#Index| v@@4 i@@1) t0@@0 h@@0))
...
(assert (forall ((_module.T$A@@7 T@U) (bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 (Tclass._module.T? _module.T$A@@7)) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) (Tclass._module.T? _module.T$A@@7))))
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( ($IsBox bx@@6 (Tclass._module.T? _module.T$A@@7)))
)))
(assert (forall ((_module.T$A@@8 T@U) (bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (Tclass._module.T _module.T$A@@8)) (and (= ($Box refType ($Unbox refType bx@@7)) bx@@7) ($Is refType ($Unbox refType bx@@7) (Tclass._module.T _module.T$A@@8))))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($IsBox bx@@7 (Tclass._module.T _module.T$A@@8)))
)))
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass._module.C?) ($IsBox bx@@8 (Tclass._module.T? Tclass._System.object)))
 :qid |unknown.0:0|
 :skolemid |520|
...
(declare-fun _module.T$A@@9 () T@U)
(declare-fun |a#0@@0| () T@U)
(declare-fun |_module.__default.P#canCall| (T@U T@U) Bool)
(declare-fun C_$_ReadsFrame@0 () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun this@@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id OverrideCheck$$_module.C.F)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= _module.T$A@@9 Tclass._System.object) (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|)))) (=> (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) (=> (|_module.__default.P#canCall| Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) 3 4) (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) 3 4))) (=> (<= (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) 3 4) (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) 3 4)) (=> (= C_$_ReadsFrame@0 (|lambda#1| null $Heap@@0 alloc (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@8) alloc)))) (|Set#IsMember| (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) ($Box refType $o@@8))) (|Set#IsMember| (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) ($Box refType $o@@8)))
 :qid |gitissue2429dfy.29:18|
 :skolemid |517|
))) (=> (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@9) alloc)))) (|Set#IsMember| (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) ($Box refType $o@@9))) (|Set#IsMember| (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) ($Box refType $o@@9)))
 :qid |gitissue2429dfy.29:18|
 :skolemid |517|
)) (=> (and (and (=> (= (_module.C.F $Heap@@0 this@@0 |a#0@@0|) (LitInt 5)) (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|)))) (= (ControlFlow 0 2) (- 0 1))) (= (_module.C.F $Heap@@0 this@@0 |a#0@@0|) (LitInt 5))) (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0@@0|)) (LitInt 0) ($Box refType |a#0@@0|)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.C) ($IsAlloc refType this@@0 Tclass._module.C $Heap@@0))) ($Is refType |a#0@@0| Tclass._System.object)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
