...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (ConcreteModule.Status.Failure_q this@@4))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAllocBox ($Box DatatypeTypeType this@@4) Tclass.ConcreteModule.Status $Heap)) (and (|ConcreteModule.Status.IsFailure#canCall| this@@4) (ConcreteModule.Status.IsFailure this@@4))) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType this@@4 Tclass.ConcreteModule.Status) ($IsAlloc DatatypeTypeType this@@4 Tclass.ConcreteModule.Status $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
