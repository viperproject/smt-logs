...
(declare-fun $generated@@88 () (_ BitVec 16))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let (($generated@@99  (=> (and (bvule #x0000 $generated@@88) (bvult $generated@@88 (bvshl #x0001 (concat #b00000000000 #b01000)))) (=> (and (and ($generated@@89 $generated@@90) ($generated@@91 $generated@@90)) (= $generated@@92 $generated@@90)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 $generated@@93) (< $generated@@93 64))) (=> (and (<= 0 $generated@@93) (< $generated@@93 64)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bvule ((_ int2bv 6) $generated@@93) #b100000)) (=> (bvule ((_ int2bv 6) $generated@@93) #b100000) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 $generated@@93) (< $generated@@93 32))) (=> (and (<= 0 $generated@@93) (< $generated@@93 32)) (=> (= (ControlFlow 0 2) (- 0 1)) (bvule ((_ int2bv 5) $generated@@93) #b10000))))))))))))
(let (($generated@@100  (=> (and (not (bvule #x0000 $generated@@88)) (= (ControlFlow 0 9) 2)) $generated@@99)))
(let (($generated@@101  (=> (and (bvule #x0000 $generated@@88) (= $generated@@94 ($generated 8))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (and (<= 0 $generated@@94) (< $generated@@94 32))) (=> (and (<= 0 $generated@@94) (< $generated@@94 32)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (bvule #b01000 #b10000)) (=> (bvule #b01000 #b10000) (=> (= (ControlFlow 0 6) 2) $generated@@99))))))))
(let (($generated@@102  (=> (and (<= ($generated 0) $generated@@93) (<= $generated@@93 ($generated (- 16 8)))) (and (=> (= (ControlFlow 0 10) 6) $generated@@101) (=> (= (ControlFlow 0 10) 9) $generated@@100)))))
(let (($generated@@103  (=> (and (< $generated@@93 ($generated 0)) (= (ControlFlow 0 12) 10)) $generated@@102)))
(let (($generated@@104  (=> (and (<= ($generated 0) $generated@@93) (= (ControlFlow 0 11) 10)) $generated@@102)))
(let (($generated@@105  (=> (= $generated@@95 ($generated@@29 $generated@@96 $generated@@92 $generated@@97 false)) (and (=> (= (ControlFlow 0 13) 11) $generated@@104) (=> (= (ControlFlow 0 13) 12) $generated@@103)))))
(let (($generated@@106  (=> (and (and (and ($generated@@89 $generated@@92) ($generated@@91 $generated@@92)) (<= ($generated 0) $generated@@93)) (and (= 0 $generated@@98) (= (ControlFlow 0 14) 13))) $generated@@105)))
$generated@@106)))))))))
))
(check-sat)
(get-info :rlimit)
