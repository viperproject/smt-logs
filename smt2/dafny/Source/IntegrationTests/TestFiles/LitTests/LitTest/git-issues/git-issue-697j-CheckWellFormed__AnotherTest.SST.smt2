...
(declare-fun AnotherTest.__default.P (T@U) Bool)
(declare-fun |AnotherTest.__default.P#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|s#0| T@U) ) (!  (=> (or (|AnotherTest.__default.P#canCall| |s#0|) (and (< 0 $FunctionContextHeight) ($Is SeqType |s#0| (TSeq TInt)))) (= (AnotherTest.__default.P |s#0|) (<= (|Seq#Length| |s#0|) (LitInt 1))))
 :qid |gitissue697jdfy.74:15|
 :skolemid |1006|
 :pattern ( (AnotherTest.__default.P |s#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|AnotherTest.__default.P#canCall| (Lit SeqType |s#0@@0|)) (and (< 0 $FunctionContextHeight) ($Is SeqType |s#0@@0| (TSeq TInt)))) (= (AnotherTest.__default.P (Lit SeqType |s#0@@0|)) (<= (|Seq#Length| (Lit SeqType |s#0@@0|)) (LitInt 1))))
 :qid |gitissue697jdfy.74:15|
 :weight 3
 :skolemid |1007|
 :pattern ( (AnotherTest.__default.P (Lit SeqType |s#0@@0|)))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$AnotherTest.SST)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (and (|AnotherTest.__default.P#canCall| (Lit SeqType |Seq#Empty|)) (= (ControlFlow 0 3) (- 0 2))) (|AnotherTest.__default.P#canCall| (Lit SeqType |Seq#Empty|))) (or (U_2_bool (Lit boolType (bool_2_U (AnotherTest.__default.P (Lit SeqType |Seq#Empty|))))) (<= (|Seq#Length| (Lit SeqType |Seq#Empty|)) (LitInt 1))))))
