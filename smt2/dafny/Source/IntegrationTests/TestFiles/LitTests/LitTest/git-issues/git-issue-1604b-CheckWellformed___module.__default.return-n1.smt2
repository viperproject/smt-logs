...
(assert (distinct TInt TagInt alloc Tagclass._module.CompilableOrdinalCell Tagclass._module.Cell |##_module.Cell.Cell| Tagclass._module.CompilableNaturalCell tytagFamily$CompilableOrdinalCell tytagFamily$Cell tytagFamily$CompilableNaturalCell)
)
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|c#0| T@U) ) (!  (=> (or (|_module.__default.returnsOneIfCompilableOrdinalCell#canCall| |c#0|) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |c#0| Tclass._module.CompilableOrdinalCell))) (and (_module.Cell.Cell_q |c#0|) (= (_module.__default.returnsOneIfCompilableOrdinalCell |c#0|) (ite (<= (_module.Cell.x |c#0|) (LitInt 0)) (Div 1 (LitInt 0)) 1))))
 :qid |gitissue1604bdfy.18:44|
 :skolemid |486|
 :pattern ( (_module.__default.returnsOneIfCompilableOrdinalCell |c#0|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|c#0@@0| T@U) ) (!  (=> (or (|_module.__default.returnsOneIfCompilableOrdinalCell#canCall| (Lit DatatypeTypeType |c#0@@0|)) (and (< 3 $FunctionContextHeight) ($Is DatatypeTypeType |c#0@@0| Tclass._module.CompilableOrdinalCell))) (and (_module.Cell.Cell_q (Lit DatatypeTypeType |c#0@@0|)) (= (_module.__default.returnsOneIfCompilableOrdinalCell (Lit DatatypeTypeType |c#0@@0|)) (ite (<= (LitInt (_module.Cell.x (Lit DatatypeTypeType |c#0@@0|))) (LitInt 0)) (Div 1 (LitInt 0)) 1))))
 :qid |gitissue1604bdfy.18:44|
 :weight 3
 :skolemid |487|
 :pattern ( (_module.__default.returnsOneIfCompilableOrdinalCell (Lit DatatypeTypeType |c#0@@0|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.returnsOneIfCompilableOrdinalCell)
...
(let ((anon8_Then_correct  (=> (and (<= (_module.Cell.x |c#0@@1|) (LitInt 0)) (= (ControlFlow 0 3) (- 0 2))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon7_Else_correct  (=> (_module.Cell.Cell_q |c#0@@1|) (and (=> (= (ControlFlow 0 5) 3) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |c#0@@1| Tclass._module.CompilableOrdinalCell)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
