...
(set-info :boogie-vc-id Impl$$_module.__default.Test5c)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is charType |ch#0| TChar) true)) (and (and (= 0 $FunctionContextHeight) (<= (LitReal 0.0) |r#0|)) (and (<= |r#0| (LitReal 65535.0)) (= (ControlFlow 0 4) 2)))) anon0_correct)))
