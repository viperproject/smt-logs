...
axiom {:id "id57"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    SubsetTypeSubsetType.__default.P#canCall(x#0) || 0 < $FunctionContextHeight
...
axiom {:id "id58"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    SubsetTypeSubsetType.__default.P#canCall(LitInt(x#0))
...
procedure {:verboseName "SubsetTypeSubsetType.P (well-formedness)"} CheckWellformed$$SubsetTypeSubsetType.__default.P(x#0: int);
...
axiom {:id "id60"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    SubsetTypeSubsetType.__default.Q#canCall(x#0) || 0 < $FunctionContextHeight
...
axiom {:id "id61"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    SubsetTypeSubsetType.__default.Q#canCall(LitInt(x#0))
         || 0 < $FunctionContextHeight
...
procedure {:verboseName "SubsetTypeSubsetType.Q (well-formedness)"} CheckWellformed$$SubsetTypeSubsetType.__default.Q(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "SubsetTypeSubsetType.NonCompilableTest (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.NonCompilableTest(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SubsetTypeSubsetType.NonCompilableTest (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.NonCompilableTest(x#0: int)
{
  ...
  var ##x#0: int;
    ...
    if (*)
    {
        ...
        assume SubsetTypeSubsetType.__default.P#canCall(x#0);
        assume {:id "id70"} SubsetTypeSubsetType.__default.P(x#0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume SubsetTypeSubsetType.__default.P#canCall(LitInt(0));
        assert {:id "id71"} {:subsumption 0} SubsetTypeSubsetType.__default.P#canCall(LitInt(0))
           ==> Lit(SubsetTypeSubsetType.__default.P(LitInt(0))) || Lit(0 != 3);
        assume false;
    }
}
...
procedure {:verboseName "SubsetTypeSubsetType.NonCompilableTestInt32 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.NonCompilableTestInt32(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SubsetTypeSubsetType.NonCompilableTestInt32 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.NonCompilableTestInt32(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##x#0: int;
    ...
    if (*)
    {
        ...
        assume {:id "id72"} LitInt(-2147483648) <= x#0 && x#0 < 2147483648;
        ##x#0 := x#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assume SubsetTypeSubsetType.__default.P#canCall(x#0);
        assume {:id "id73"} SubsetTypeSubsetType.__default.P(x#0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume LitInt(-2147483648) <= LitInt(0)
           ==> 
          Lit(0 < 2147483648)
           ==> SubsetTypeSubsetType.__default.P#canCall(LitInt(0));
        assert {:id "id74"} {:subsumption 0} LitInt(-2147483648) <= LitInt(0);
        assert {:id "id75"} {:subsumption 0} Lit(0 < 2147483648);
        assert {:id "id76"} {:subsumption 0} SubsetTypeSubsetType.__default.P#canCall(LitInt(0))
           ==> Lit(SubsetTypeSubsetType.__default.P(LitInt(0))) || Lit(0 != 3);
        assume false;
    }
}
...
procedure {:verboseName "SubsetTypeSubsetType.Type0 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.Type0(x#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SubsetTypeSubsetType.Type0 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.Type0(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;


    // AddWellformednessCheck for subset type Type0
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of subset type constraint
        assume SubsetTypeSubsetType.__default.P(x#0);
        assume {:id "id77"} true;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id78"} SubsetTypeSubsetType.__default.P(newtype$check#0);
        assume true;
        assert {:id "id79"} Lit(true);
        assume false;
    }
}
...
procedure {:verboseName "SubsetTypeSubsetType.Type2 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.Type2(x#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SubsetTypeSubsetType.Type2 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.Type2(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;


    // AddWellformednessCheck for subset type Type2
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        newtype$check#0 := LitInt(0);
        assert {:id "id81"} LitInt(-2147483648) <= newtype$check#0
           && newtype$check#0 < 2147483648
           && SubsetTypeSubsetType.__default.P(newtype$check#0);
        assume true;
        assert {:id "id82"} Lit(true);
        assume false;
    }
}
...
procedure {:verboseName "SubsetTypeSubsetType.CompilableTest (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.CompilableTest(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SubsetTypeSubsetType.CompilableTest (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.CompilableTest(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##x#0: int;
    ...
    if (*)
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assume SubsetTypeSubsetType.__default.Q#canCall(x#0);
        assume {:id "id83"} SubsetTypeSubsetType.__default.Q(x#0);
        assume {:id "id84"} x#0 < 8;
        assume false;
    }
    ...
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        assume SubsetTypeSubsetType.__default.Q#canCall(LitInt(0));
        assert {:id "id85"} {:subsumption 0} SubsetTypeSubsetType.__default.Q#canCall(LitInt(0))
           ==> Lit(SubsetTypeSubsetType.__default.Q(LitInt(0))) || Lit(0 != 5);
        assert {:id "id86"} {:subsumption 0} Lit(0 < 8);
        assume false;
    }
}
...
procedure {:verboseName "SubsetTypeSubsetType.Type4 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.Type4(x#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SubsetTypeSubsetType.Type4 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.Type4(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;


    // AddWellformednessCheck for subset type Type4
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of subset type constraint
        assume SubsetTypeSubsetType.__default.Q(x#0) && x#0 < 8;
        assume {:id "id87"} true;
        assume false;
    }
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        newtype$check#0 := LitInt(0);
        assert {:id "id88"} SubsetTypeSubsetType.__default.Q(newtype$check#0) && newtype$check#0 < 8;
        assume true;
        assert {:id "id89"} Lit(true);
        assume false;
    }
}
...
procedure {:verboseName "SubsetTypeSubsetType.Type6 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.Type6(x#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SubsetTypeSubsetType.Type6 (well-formedness)"} CheckWellFormed$$SubsetTypeSubsetType.Type6(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;


    // AddWellformednessCheck for subset type Type6
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
    ...
    if (*)
    {
        // check well-formedness of subset type witness, and that it satisfies the constraint
        newtype$check#0 := LitInt(0);
        assert {:id "id91"} SubsetTypeSubsetType.__default.Q(newtype$check#0) && newtype$check#0 < 8;
        assume true;
        assert {:id "id92"} LitInt(0) <= LitInt(0);
        assume false;
    }
}
