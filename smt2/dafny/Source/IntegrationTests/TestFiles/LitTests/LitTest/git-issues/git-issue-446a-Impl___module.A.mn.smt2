...
(declare-fun |call4formal@o#0@0| () Int)
(declare-fun |call3formal@r#0@0@@0| () T@U)
(declare-fun |call4formal@o#0@0@@0| () Int)
...
(set-info :boogie-vc-id Impl$$_module.A.mn)
...
(let ((anon10_Else_correct  (=> (and (not (_module.Result.IsFailure TInt |call3formal@r#0@0|)) (= |$rhs#0@0| (Lit DatatypeTypeType (|#_module.Result.Success| ($Box intType (int_2_U (LitInt 0))))))) (=> (and (and (= |$rhs#1@0| (LitInt 4)) (= |out#0@0| |$rhs#1@0|)) (and (= |r#0@2| |$rhs#0@0|) (= (ControlFlow 0 8) 2))) GeneratedUnifiedExit_correct))))
(let ((anon10_Then_correct  (=> (and (_module.Result.IsFailure TInt |call3formal@r#0@0|) ($IsAllocBox ($Box DatatypeTypeType |call3formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (_module.Result.Failure_q |call3formal@r#0@0|)) (=> (_module.Result.Failure_q |call3formal@r#0@0|) (=> (and (|_module.Result.PropagateFailure#canCall| TInt TInt |call3formal@r#0@0|) (|_module.Result.PropagateFailure#canCall| TInt TInt |call3formal@r#0@0|)) (=> (and (and (= |r#0@1| (_module.Result.PropagateFailure TInt TInt |call3formal@r#0@0|)) (= |out#0@0| |call4formal@o#0@0|)) (and (= |r#0@2| |r#0@1|) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon9_Else_correct  (=> (not (_module.Result.IsFailure TInt |call3formal@r#0@0@@0|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= |call4formal@o#0@0@@0| (LitInt 3))) (=> (= |call4formal@o#0@0@@0| (LitInt 3)) (=> (and (and ($Is DatatypeTypeType |valueOrError1#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError1#0@0| (Tclass._module.Result TInt) $Heap@0)) (= |i##1@0| (LitInt (- 0 1)))) (=> (and (and (and (and ($Is DatatypeTypeType |call3formal@r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call3formal@r#0| (Tclass._module.Result TInt) $Heap@@0)) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (and ($Is DatatypeTypeType |call3formal@r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call3formal@r#0@0| (Tclass._module.Result TInt) $Heap@1)) (and (=> (<= (LitInt 0) |i##1@0|) (_module.Result.Success_q |call3formal@r#0@0|)) (=> (<= (LitInt 0) |i##1@0|) (= (U_2_int ($Unbox intType (_module.Result.value |call3formal@r#0@0|))) |i##1@0|))))) (and (and (and (=> (<= (LitInt 0) |i##1@0|) (= |call4formal@o#0@0| (+ (+ |i##1@0| |i##1@0|) |i##1@0|))) (=> (< |i##1@0| 0) (_module.Result.Failure_q |call3formal@r#0@0|))) (and (=> (< |i##1@0| 0) (= |call4formal@o#0@0| (+ |i##1@0| |i##1@0|))) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2)))
 :qid |gitissue446adfy.34:10|
 :skolemid |538|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@2))
)))) (and (and ($HeapSucc $Heap@0 $Heap@1) ($IsAllocBox ($Box DatatypeTypeType |call3formal@r#0@0|) (Tclass._module.Result TInt) $Heap@1)) (and (|_module.Result.IsFailure#canCall| TInt |call3formal@r#0@0|) (|_module.Result.IsFailure#canCall| TInt |call3formal@r#0@0|))))) (and (=> (= (ControlFlow 0 9) 6) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))))))
(let ((anon9_Then_correct  (=> (and (_module.Result.IsFailure TInt |call3formal@r#0@0@@0|) ($IsAllocBox ($Box DatatypeTypeType |call3formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (_module.Result.Failure_q |call3formal@r#0@0@@0|)) (=> (_module.Result.Failure_q |call3formal@r#0@0@@0|) (=> (and (|_module.Result.PropagateFailure#canCall| TInt TInt |call3formal@r#0@0@@0|) (|_module.Result.PropagateFailure#canCall| TInt TInt |call3formal@r#0@0@@0|)) (=> (and (and (= |r#0@0| (_module.Result.PropagateFailure TInt TInt |call3formal@r#0@0@@0|)) (= |out#0@0| |out#0|)) (and (= |r#0@2| |r#0@0|) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and (and ($Is DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt) $Heap@@0)) (= |i##0@0| (LitInt 1))) (=> (and (and (and (and ($Is DatatypeTypeType |call3formal@r#0@@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call3formal@r#0@@0| (Tclass._module.Result TInt) $Heap@@0)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and ($Is DatatypeTypeType |call3formal@r#0@0@@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call3formal@r#0@0@@0| (Tclass._module.Result TInt) $Heap@0)) (and (=> (<= (LitInt 0) |i##0@0|) (_module.Result.Success_q |call3formal@r#0@0@@0|)) (=> (<= (LitInt 0) |i##0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |call3formal@r#0@0@@0|))) |i##0@0|))))) (and (and (and (=> (<= (LitInt 0) |i##0@0|) (= |call4formal@o#0@0@@0| (+ (+ |i##0@0| |i##0@0|) |i##0@0|))) (=> (< |i##0@0| 0) (_module.Result.Failure_q |call3formal@r#0@0@@0|))) (and (=> (< |i##0@0| 0) (= |call4formal@o#0@0@@0| (+ |i##0@0| |i##0@0|))) (forall (($o@@3 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@3) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@3) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@3)))
 :qid |gitissue446adfy.34:10|
 :skolemid |538|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@3))
)))) (and (and ($HeapSucc $Heap@@0 $Heap@0) ($IsAllocBox ($Box DatatypeTypeType |call3formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@0)) (and (|_module.Result.IsFailure#canCall| TInt |call3formal@r#0@0@@0|) (|_module.Result.IsFailure#canCall| TInt |call3formal@r#0@0@@0|))))) (and (=> (= (ControlFlow 0 11) 4) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon9_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.A) ($IsAlloc refType this@@5 Tclass._module.A $Heap@@0))) (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@0))) (and (and ($Is DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt) $Heap@@0)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError1#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError1#0| (Tclass._module.Result TInt) $Heap@@0)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 12) 11)))) anon0_correct))))
