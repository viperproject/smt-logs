...
(set-info :boogie-vc-id CheckWellFormed$$Main.b12)
...
(let ((anon11_Else_correct  (=> (and (< (LitReal 3.0) (LitReal 3.0)) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (<= (LitReal 3.0) (LitReal 3.0)) (= (ControlFlow 0 6) 4)) anon6_correct)))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite (<= (LitReal 3.0) (LitReal 3.0)) 35 40))))))
