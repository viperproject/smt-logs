...
(declare-fun FunctionResultType.__default.Search4 (T@U T@U T@U) T@U)
(declare-fun |FunctionResultType.__default.Search4#canCall| (T@U T@U T@U) Bool)
...
(declare-fun FunctionResultType._default.Search4$T@@3 () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon5_correct true))
(let ((anon15_Else_correct  (=> (and (=> (and (FunctionResultType.Option.Some_q |o#0|) (< (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|))) (|Seq#Length| |s#0@@3|))) (= (|Seq#Index| |s#0@@3| (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|)))) |x#0@@3|)) (= (ControlFlow 0 16) 11)) anon5_correct)))
(let ((anon15_Then_correct  (=> (FunctionResultType.Option.Some_q |o#0|) (and (=> (= (ControlFlow 0 12) (- 0 15)) (FunctionResultType.Option.Some_q |o#0|)) (=> (FunctionResultType.Option.Some_q |o#0|) (=> (< (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|))) (|Seq#Length| |s#0@@3|)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (FunctionResultType.Option.Some_q |o#0|)) (=> (FunctionResultType.Option.Some_q |o#0|) (and (=> (= (ControlFlow 0 12) (- 0 13)) (and (<= 0 (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|)))) (< (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|))) (|Seq#Length| |s#0@@3|)))) (=> (and (<= 0 (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|)))) (< (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|))) (|Seq#Length| |s#0@@3|))) (=> (and (= (|Seq#Index| |s#0@@3| (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|)))) |x#0@@3|) (= (ControlFlow 0 12) 11)) anon5_correct)))))))))))
(let ((anon14_Then_correct  (=> (and ($Is DatatypeTypeType (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Tclass.FunctionResultType.Option TInt)) ($Is DatatypeTypeType |o#0| (Tclass.FunctionResultType.Option TInt))) (and (=> (= (ControlFlow 0 17) 12) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (and (FunctionResultType.Option.Some_q |o#0|) (< (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|))) (|Seq#Length| |s#0@@3|))) (= (|Seq#Index| |s#0@@3| (U_2_int ($Unbox intType (FunctionResultType.Option.value |o#0|)))) |x#0@@3|)))))
(let ((anon18_Else_correct  (=> (or (not (= (|Seq#Index| |s#0@@3| (LitInt 2)) |x#0@@3|)) (not true)) (=> (and (and (= (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Lit DatatypeTypeType |#FunctionResultType.Option.None|)) ($Is DatatypeTypeType (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Tclass.FunctionResultType.Option TInt))) (and (= (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) |o#0|) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct))))
(let ((anon18_Then_correct  (=> (= (|Seq#Index| |s#0@@3| (LitInt 2)) |x#0@@3|) (=> (and (and (= (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Lit DatatypeTypeType (|#FunctionResultType.Option.Some| ($Box intType (int_2_U (LitInt 2)))))) ($Is DatatypeTypeType (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Tclass.FunctionResultType.Option TInt))) (and (= (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) |o#0|) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct))))
(let ((anon17_Else_correct  (=> (or (not (= (|Seq#Index| |s#0@@3| (LitInt 9)) |x#0@@3|)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |s#0@@3|)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (|Seq#Length| |s#0@@3|))) (and (=> (= (ControlFlow 0 7) 5) anon18_Then_correct) (=> (= (ControlFlow 0 7) 6) anon18_Else_correct)))))))
(let ((anon17_Then_correct  (=> (= (|Seq#Index| |s#0@@3| (LitInt 9)) |x#0@@3|) (=> (and (and (= (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Lit DatatypeTypeType (|#FunctionResultType.Option.Some| ($Box intType (int_2_U (LitInt 9)))))) ($Is DatatypeTypeType (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Tclass.FunctionResultType.Option TInt))) (and (= (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) |o#0|) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct))))
(let ((anon16_Else_correct  (=> (<= 12 (|Seq#Length| |s#0@@3|)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 (LitInt 9)) (< (LitInt 9) (|Seq#Length| |s#0@@3|)))) (=> (and (<= 0 (LitInt 9)) (< (LitInt 9) (|Seq#Length| |s#0@@3|))) (and (=> (= (ControlFlow 0 9) 4) anon17_Then_correct) (=> (= (ControlFlow 0 9) 7) anon17_Else_correct)))))))
(let ((anon16_Then_correct  (=> (< (|Seq#Length| |s#0@@3|) 12) (=> (and (and (= (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Lit DatatypeTypeType |#FunctionResultType.Option.None|)) ($Is DatatypeTypeType (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) (Tclass.FunctionResultType.Option TInt))) (and (= (FunctionResultType.__default.Search4 FunctionResultType._default.Search4$T@@3 |s#0@@3| |x#0@@3|) |o#0|) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 18) 17) anon14_Then_correct) (=> (= (ControlFlow 0 18) 3) anon16_Then_correct)) (=> (= (ControlFlow 0 18) 9) anon16_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |s#0@@3| (TSeq FunctionResultType._default.Search4$T@@3)) ($IsBox |x#0@@3| FunctionResultType._default.Search4$T@@3)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
