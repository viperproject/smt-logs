...
(set-info :boogie-vc-id CheckWellFormed$$ValueType.Value)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (<= (|Seq#Length| (Lit SeqType |Seq#Empty|)) (LitInt 10)))))
