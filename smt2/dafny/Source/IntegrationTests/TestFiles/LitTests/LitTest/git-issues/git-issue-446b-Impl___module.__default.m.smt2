...
(assert (forall ((_module.Result$T@@0 T@U) (|a#2#0#0| T@U) ($h T@U) ) (!  (=> ($IsGoodHeap $h) (= ($IsAlloc DatatypeTypeType (|#_module.Result.Success| |a#2#0#0|) (Tclass._module.Result _module.Result$T@@0) $h) ($IsAllocBox |a#2#0#0| _module.Result$T@@0 $h)))
 :qid |unknown.0:0|
 :skolemid |515|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Result.Success| |a#2#0#0|) (Tclass._module.Result _module.Result$T@@0) $h))
)))
...
(assert (forall ((_module.Result$T@@2 T@U) (|a#8#0#0| T@U) ($h@@1 T@U) ) (!  (=> ($IsGoodHeap $h@@1) (= ($IsAlloc DatatypeTypeType (|#_module.Result.Failure| |a#8#0#0|) (Tclass._module.Result _module.Result$T@@2) $h@@1) ($IsAlloc SeqType |a#8#0#0| (TSeq TChar) $h@@1)))
 :qid |unknown.0:0|
 :skolemid |525|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Result.Failure| |a#8#0#0|) (Tclass._module.Result _module.Result$T@@2) $h@@1))
)))
...
(assert (forall ((_module.Result$T@@7 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.Result _module.Result$T@@7)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) (Tclass._module.Result _module.Result$T@@7))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsBox bx@@3 (Tclass._module.Result _module.Result$T@@7)))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@0|))) (=> (=> (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (<= (LitInt 0) |i#0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) |i#0|))) (=> (=> (<= (LitInt 0) |i#0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) |i#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (<= (LitInt 0) |i#0|) (= |o#0@0| (+ (+ |i#0| |i#0|) |i#0|)))) (=> (=> (<= (LitInt 0) |i#0|) (= |o#0@0| (+ (+ |i#0| |i#0|) |i#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (< |i#0| 0) (_module.Result.Failure_q |r#0@0|))) (=> (=> (< |i#0| 0) (_module.Result.Failure_q |r#0@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< |i#0| 0) (= |o#0@0| (+ |i#0| |i#0|))))))))))))))
(let ((anon5_Else_correct  (=> (and (<= 0 |i#0|) (= |$rhs#0@0| (|#_module.Result.Success| ($Box intType (int_2_U |i#0|))))) (=> (and (and (= |$rhs#1@0| (+ (+ |i#0| |i#0|) |i#0|)) (= |r#0@0| |$rhs#0@0|)) (and (= |o#0@0| |$rhs#1@0|) (= (ControlFlow 0 8) 2))) GeneratedUnifiedExit_correct))))
(let ((anon5_Then_correct  (=> (and (< |i#0| 0) (= |$rhs#0_0@0| (Lit DatatypeTypeType (|#_module.Result.Failure| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 103))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 116))) ($Box charType (|char#FromInt| 105))) ($Box charType (|char#FromInt| 118))) ($Box charType (|char#FromInt| 101)))))))) (=> (and (and (= |$rhs#0_1@0| (+ |i#0| |i#0|)) (= |r#0@0| |$rhs#0_0@0|)) (and (= |o#0@0| |$rhs#0_1@0|) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
