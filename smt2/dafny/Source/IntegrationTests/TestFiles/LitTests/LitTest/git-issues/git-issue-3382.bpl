// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3382.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3382-@PROC@.smt2 /normalizeNames:0 /emitDebugInformation:1 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3382.dfy
...
function _module.__default.F(x#0: DatatypeType) : int
uses {
...
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: DatatypeType :: 
    ...
    _module.__default.F#canCall(x#0)
         || (1 < $FunctionContextHeight && $Is(x#0, Tclass._module.D()))
       ==> LitInt(0) <= _module.__default.F(x#0) && _module.__default.F(x#0) < 65536);
...
axiom {:id "id0"} 1 <= $FunctionContextHeight
   ==> (forall x#0: DatatypeType :: 
    ...
    _module.__default.F#canCall(x#0)
         || (1 < $FunctionContextHeight && $Is(x#0, Tclass._module.D()))
       ==> _module.__default.F(x#0) == (if _module.D.A_q(x#0) then 12 else 13));
// definition axiom for _module.__default.F for all literals (revealed)
axiom {:id "id1"} 1 <= $FunctionContextHeight
   ==> (forall x#0: DatatypeType :: 
    {:weight 3} { _module.__default.F(Lit(x#0)) } 
    _module.__default.F#canCall(Lit(x#0))
         || (1 < $FunctionContextHeight && $Is(x#0, Tclass._module.D()))
       ==> _module.__default.F(Lit(x#0)) == (if _module.D.A_q(Lit(x#0)) then 12 else 13));
}
...
axiom (forall x#0: DatatypeType :: 
  ...
  $Is(x#0, Tclass._module.D()) ==> _module.__default.F#requires(x#0) == true);

procedure {:verboseName "F (well-formedness)"} CheckWellformed$$_module.__default.F(x#0: DatatypeType where $Is(x#0, Tclass._module.D()));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "F (well-formedness)"} CheckWellformed$$_module.__default.F(x#0: DatatypeType)
{
  ...
  var newtype$check#1: int;
    ...
    if (*)
    {
        ...
        assume LitInt(0) <= _module.__default.F(x#0) && _module.__default.F(x#0) < 65536;
        assume false;
    }
    else
    {
        ...
        if (x#0 == #_module.D.A())
        {
            ...
            assert {:id "id4"} LitInt(0) <= newtype$check#1 && newtype$check#1 < 65536;
            assume {:id "id5"} _module.__default.F(x#0) == LitInt(12);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.F(x#0), Tclass._module.uint16());
            return;
        }
        else if (x#0 == #_module.D.B())
        {
            newtype$check#0 := LitInt(13);
            assert {:id "id2"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 65536;
            assume {:id "id3"} _module.__default.F(x#0) == LitInt(13);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(_module.__default.F(x#0), Tclass._module.uint16());
            return;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "uint16 (well-formedness)"} CheckWellFormed$$_module.uint16(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id6"} LitInt(0) <= x#0 && x#0 < 65536;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id7"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id8"} {:subsumption 0} Lit(0 < 65536);
        assume false;
    }
}
