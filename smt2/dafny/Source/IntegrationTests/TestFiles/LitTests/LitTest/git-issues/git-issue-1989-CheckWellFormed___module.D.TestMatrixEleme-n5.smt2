...
(assert (distinct TInt TReal TagInt TagReal alloc Tagclass._System.array2? Tagclass._System.array2 Tagclass._module.D Tagclass._module.D? tytagFamily$array2 tytagFamily$D)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.D.TestMatrixElements)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 25)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (< |i#0| (_System.array2.Length0 |m#0|)) (and (=> (= (ControlFlow 0 2) (- 0 24)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (< |j#0| (_System.array2.Length1 |m#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@10 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10)))
 :qid |gitissue1989dfy.120:10|
 :skolemid |1221|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 22)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 21)) ($IsAlloc refType |m#0| (Tclass._System.array2 TReal) $Heap)) (=> ($IsAlloc refType |m#0| (Tclass._System.array2 TReal) $Heap) (=> (= (_System.array2.Length0 |m#0|) (_System.array2.Length1 |m#0|)) (and (=> (= (ControlFlow 0 2) (- 0 20)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 19)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 16)) ($IsAlloc refType |m#0| (Tclass._System.array2 TReal) $Heap)) (=> ($IsAlloc refType |m#0| (Tclass._System.array2 TReal) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 15)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|))) (=> (= (U_2_real ($Unbox realType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0|) (MultiIndexField (IndexField |i#0|) |j#0|)))) (U_2_real ($Unbox realType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField |i#0|) |j#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|))) (=> (= (U_2_real ($Unbox realType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0|) (MultiIndexField (IndexField |i#0|) |j#0|)))) (U_2_real ($Unbox realType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#0|) (MultiIndexField (IndexField |i#0|) |j#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 |m#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 |m#0|)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.D) ($IsAlloc refType this Tclass._module.D $Heap))) (and (<= (LitInt 0) |i#0|) (<= (LitInt 0) |j#0|))) (and (and ($Is refType |m#0| (Tclass._System.array2 TReal)) ($IsAlloc refType |m#0| (Tclass._System.array2 TReal) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 26) 2)))) anon0_correct))))
