...
(declare-fun |r#0| () Int)
(set-info :boogie-vc-id Impl$$StartingFromDatatype_mDatatype.Ty.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |r#0@0| (StartingFromDatatype_mDatatype.Ty.c this)) (= (ControlFlow 0 2) (- 0 1))) (= |r#0@0| |x#0@@1|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType this Tclass.StartingFromDatatype_mDatatype.Ty) ($IsAlloc DatatypeTypeType this Tclass.StartingFromDatatype_mDatatype.Ty $Heap)) (<= (LitInt 0) |x#0@@1|)) (and (and (<= (LitInt 0) |r#0|) (= 1 $FunctionContextHeight)) (and (or (not (= |x#0@@1| 9)) (not true)) (= (ControlFlow 0 3) 2)))) anon0_correct))))
