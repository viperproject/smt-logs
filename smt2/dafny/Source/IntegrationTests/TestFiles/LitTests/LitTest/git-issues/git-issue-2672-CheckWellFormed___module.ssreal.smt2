...
(set-info :boogie-vc-id CheckWellFormed$$_module.ssreal)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Then_correct  (=> (= |newtype$check#2@0| (LitReal 0.0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (> |newtype$check#2@0| (q@Real (LitInt (- 0 4))))) (=> (> |newtype$check#2@0| (q@Real (LitInt (- 0 4)))) (=> (= (ControlFlow 0 5) (- 0 4)) (> 0.0 (q@Real (LitInt (- 0 3))))))))))
(let ((anon5_Then_correct  (=> (and (> |r#0| (q@Real (LitInt (- 0 4)))) (= |newtype$check#0@0| (LitInt (- 0 3)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (> (q@Real |newtype$check#0@0|) (q@Real (LitInt (- 0 4))))) (=> (> (q@Real |newtype$check#0@0|) (q@Real (LitInt (- 0 4)))) (=> (and (= |newtype$check#1@0| (q@Real (LitInt (- 0 3)))) (= (ControlFlow 0 2) (- 0 1))) (> |newtype$check#1@0| (q@Real (LitInt (- 0 4))))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 2) anon5_Then_correct) (=> (= (ControlFlow 0 7) 5) anon6_Then_correct)))))
