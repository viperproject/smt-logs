...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@98 true))
(let (($generated@@99 true))
(let (($generated@@100  (=> (= $generated@@91 ($generated@@32 $generated@@92 $generated@@93 $generated@@94 false)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= ($generated 23) 0)) (not true))) (=> (or (not (= ($generated 23) 0)) (not true)) (and (=> (= (ControlFlow 0 3) 1) $generated@@99) (=> (= (ControlFlow 0 3) 2) $generated@@98)))))))
(let (($generated@@101  (=> (and (and ($generated@@95 $generated@@93) ($generated@@96 $generated@@93)) (and (= 0 $generated@@97) (= (ControlFlow 0 5) 3))) $generated@@100)))
$generated@@101)))))
))
(check-sat)
(get-info :rlimit)
