...
(set-info :boogie-vc-id Impl$$M0.__default.Test1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |newtype$check#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (= |newtype$check#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= (LitInt 0) |newtype$check#1@0|)) (=> (<= (LitInt 0) |newtype$check#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))))))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType ($Unbox intType (|Seq#Index| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))) (LitInt 1))) Tclass._System.nat)) (=> ($Is intType ($Unbox intType (|Seq#Index| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))) (LitInt 1))) Tclass._System.nat) (=> (= |x##0@0| (U_2_int ($Unbox intType (|Seq#Index| (|Seq#Append| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))) (LitInt 1))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (<= (LitInt 0) |x##0@0|)) (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))))))
