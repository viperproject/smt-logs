...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var s#0: DatatypeType
     where defass#s#0
       ==> $Is(s#0, Tclass._module.Stream(TBool))
         && $IsAlloc(s#0, Tclass._module.Stream(TBool), $Heap);
  var f#1_0_0: int;
  var w##1_1_0_0: ref;
  var u#1_1_1_0_0: int;
    ...
    havoc s#0 /* where defass#s#0
       ==> $Is(s#0, Tclass._module.Stream(TBool))
         && $IsAlloc(s#0, Tclass._module.Stream(TBool), $Heap) */;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(18,3)
    assert {:id "id0"} defass#s#0;
    assume _module.Stream.More_q(s#0);
    assume _module.Stream.More_q(s#0);
    assume true;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(19,3)
    if (*)
    {
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(21,8)
        // TrCallStmt: Before ProcessCallStmt
        assert {:id "id1"} defass#c#0;
        assume true;
        assert {:id "id2"} c#0 != null;
        call {:id "id3"} Call$$_module.C.M(c#0);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(22,10)
        if (*)
        {
            // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(23,11)
            assume true;
            assert {:id "id4"} defass#c#0;
            assert {:id "id5"} c#0 != null;
            // assume allocatedness for receiver argument to function
            assume $IsAllocBox($Box(c#0), Tclass._module.C?(), $Heap);
            assume _module.C.F#canCall(c#0);
            assume _module.C.F#canCall(c#0);
            f#1_0_0 := _module.C.F(c#0);
        }
        else
        {
            // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(24,10)
            if (*)
            {
                // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(25,6)
                // TrCallStmt: Before ProcessCallStmt
                assert {:id "id7"} defass#c#0;
                assume true;
                // ProcessCallStmt: CheckSubrange
                w##1_1_0_0 := c#0;
                call {:id "id8"} Call$$_module.__default.P(w##1_1_0_0);
                // TrCallStmt: After ProcessCallStmt
            }
            else
            {
                // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(26,10)
                if (*)
                {
                    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(27,11)
                    assume true;
                    assert {:id "id9"} defass#c#0;
                    assert {:id "id10"} c#0 != null;
                    assume true;
                    u#1_1_1_0_0 := $Unbox(read($Heap, c#0, _module.C.u)): int;
                }
                else
                {
                    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(29,19)
                    // TrCallStmt: Before ProcessCallStmt
                    call {:id "id12"} Call$$_module.__default.RegressionTest();
                    // TrCallStmt: After ProcessCallStmt
                }
            }
        }
...
procedure {:verboseName "P (well-formedness)"} CheckWellFormed$$_module.__default.P(w#0: ref
       where $Is(w#0, Tclass._module.C()) && $IsAlloc(w#0, Tclass._module.C(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "P (call)"} Call$$_module.__default.P(w#0: ref
       where $Is(w#0, Tclass._module.C()) && $IsAlloc(w#0, Tclass._module.C(), $Heap));
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "P (correctness)"} Impl$$_module.__default.P(w#0: ref
       where $Is(w#0, Tclass._module.C()) && $IsAlloc(w#0, Tclass._module.C(), $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "P (correctness)"} Impl$$_module.__default.P(w#0: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(34,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    assert {:id "id13"} w#0 != null;
    call {:id "id14"} Call$$_module.C.M(w#0);
    // TrCallStmt: After ProcessCallStmt
}



procedure {:verboseName "RegressionTest (well-formedness)"} CheckWellFormed$$_module.__default.RegressionTest();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "RegressionTest (call)"} Call$$_module.__default.RegressionTest();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "RegressionTest (correctness)"} Impl$$_module.__default.RegressionTest() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "RegressionTest (correctness)"} Impl$$_module.__default.RegressionTest() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#c#0: bool;
  var c#0: ref
    ...
    // AddMethodImpl: RegressionTest, Impl$$_module.__default.RegressionTest
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    havoc c#0 /* where defass#c#0
       ==> $Is(c#0, Tclass._module.C()) && $IsAlloc(c#0, Tclass._module.C(), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-448.dfy(40,33)
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id15"} LitInt(0) != 0;
    if (Lit(Div(3, LitInt(0)) < 7))
    {
    ...
    assume true;
    assert {:id "id18"} (if Div(3, LitInt(0)) < 7 then c#0 else c#0) != null;
    call {:id "id19"} Call$$_module.C.M((if Div(3, LitInt(0)) < 7 then c#0 else c#0));
    // TrCallStmt: After ProcessCallStmt
}
...
axiom (forall _module.Stream$G: Ty, a#2#0#0: Box, a#2#1#0: DatatypeType :: 
  { $Is(#_module.Stream.More(a#2#0#0, a#2#1#0), Tclass._module.Stream(_module.Stream$G)) } 
  $Is(#_module.Stream.More(a#2#0#0, a#2#1#0), Tclass._module.Stream(_module.Stream$G))
     <==> $IsBox(a#2#0#0, _module.Stream$G) && $Is(a#2#1#0, Tclass._module.Stream(TInt)));
  ...
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_module.Stream.More(a#2#0#0, a#2#1#0), 
       ...
       <==> $IsAllocBox(a#2#0#0, _module.Stream$G, $h)
         && $IsAlloc(a#2#1#0, Tclass._module.Stream(TInt), $h)));

// Destructor $IsAlloc
axiom (forall d: DatatypeType, _module.Stream$G: Ty, $h: Heap :: 
  { $IsAllocBox(_module.Stream.x(d), _module.Stream$G, $h) } 
  $IsGoodHeap($h)
       && 
      _module.Stream.More_q(d)
...
// Destructor $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(_module.Stream.tail(d), Tclass._module.Stream(TInt), $h) } 
  $IsGoodHeap($h)
       && 
      _module.Stream.More_q(d)
       && (exists _module.Stream$G: Ty :: 
        { $IsAlloc(d, Tclass._module.Stream(_module.Stream$G), $h) } 
        $IsAlloc(d, Tclass._module.Stream(_module.Stream$G), $h))
     ==> $IsAlloc(_module.Stream.tail(d), Tclass._module.Stream(TInt), $h));

function _module.Stream.x(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#3#0#0: Box, a#3#1#0: DatatypeType :: 
  { #_module.Stream.More(a#3#0#0, a#3#1#0) } 
  _module.Stream.x(#_module.Stream.More(a#3#0#0, a#3#1#0)) == a#3#0#0);
...
axiom (forall a#4#0#0: Box, a#4#1#0: DatatypeType :: 
  ...
  _module.Stream.tail(#_module.Stream.More(a#4#0#0, a#4#1#0)) == a#4#1#0);
...
axiom (forall _module.Stream$G: Ty, d: DatatypeType :: 
  { _module.Stream.More_q(d), $Is(d, Tclass._module.Stream(_module.Stream$G)) } 
  $Is(d, Tclass._module.Stream(_module.Stream$G)) ==> _module.Stream.More_q(d));
     ...
     ==> ($Eq#_module.Stream(_module.Stream$G#l, _module.Stream$G#r, $LS(ly), d0, d1)
       <==> _module.Stream.More_q(d0)
         ...
         && (_module.Stream.More_q(d0) && _module.Stream.More_q(d1)
           ==> _module.Stream.x(d0) == _module.Stream.x(d1)
             && $Eq#_module.Stream(TInt, TInt, ly, _module.Stream.tail(d0), _module.Stream.tail(d1)))));
