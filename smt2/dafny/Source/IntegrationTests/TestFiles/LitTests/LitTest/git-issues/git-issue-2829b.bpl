// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2829b.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2829b-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2829b.dfy
...
procedure {:verboseName "RepeatAux (well-formedness)"} CheckWellFormed$$_module.__default.RepeatAux();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "RepeatAux (call)"} Call$$_module.__default.RepeatAux();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "RepeatAux (correctness)"} Impl$$_module.__default.RepeatAux() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "RepeatAux2 (well-formedness)"} CheckWellFormed$$_module.__default.RepeatAux2(_module._default.RepeatAux2$A: Ty);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "RepeatAux2 (call)"} Call$$_module.__default.RepeatAux2(_module._default.RepeatAux2$A: Ty);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "RepeatAux2 (correctness)"} Impl$$_module.__default.RepeatAux2(_module._default.RepeatAux2$A: Ty) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
