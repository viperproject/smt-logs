...
(assert (distinct TBool TInt TagBool TagInt TagSeq alloc Tagclass._System.array? Tagclass._System.array tytagFamily$array)
)
(assert (= (FDim alloc) 0))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TBool))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 1)))) (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)) (and ($IsHeapAnchor $Heap@0) (= |ars#0@0| (|Seq#Build| |Seq#Empty| ($Box refType $nw@0)))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (=> (and (and (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? TBool))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc))))) (and (and (= (_System.array.Length $nw@1) (LitInt 1)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (and (and (= |ars'#0@0| (|Seq#Build| |Seq#Empty| ($Box refType $nw@1))) (= call0formal@_module._default.Test$X@0 (TSeq (Tclass._System.array TBool)))) (and (= |call1formal@a#0@0| ($Box SeqType |ars#0@0|)) (= |call2formal@b#0@0| ($Box SeqType |ars'#0@0|)))) (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6)))
 :qid |gitissue4141dfy.3:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6))
)) ($HeapSucc $Heap@1 $Heap@2))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ars#0@0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ars#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= ($Unbox refType (|Seq#Index| |ars#0@0| (LitInt 0))) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |ars#0@0| (LitInt 0))) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length ($Unbox refType (|Seq#Index| |ars#0@0| (LitInt 0))))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length ($Unbox refType (|Seq#Index| |ars#0@0| (LitInt 0)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (|Seq#Index| |ars#0@0| (LitInt 0))) (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (|Seq#Index| |ars#0@0| (LitInt 0))) (IndexField (LitInt 0)))) (=> (and (= |$rhs#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |ars#0@0| (LitInt 0))) (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 ($Unbox refType (|Seq#Index| |ars#0@0| (LitInt 0)))) (IndexField (LitInt 0)) ($Box boolType (bool_2_U |$rhs#0@0|)))))) (=> (and (and (and ($IsGoodHeap $Heap@3) (= call0formal@_module._default.Test$X@0@@0 (TSeq (Tclass._System.array TBool)))) (and (= |call1formal@a#0@0@@0| ($Box SeqType |ars#0@0|)) (= |call2formal@b#0@0@@0| ($Box SeqType |ars'#0@0|)))) (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@7)))
 :qid |gitissue4141dfy.3:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@7))
)) ($HeapSucc $Heap@3 $Heap@4)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ars'#0@0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ars'#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= ($Unbox refType (|Seq#Index| |ars'#0@0| (LitInt 0))) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |ars'#0@0| (LitInt 0))) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length ($Unbox refType (|Seq#Index| |ars'#0@0| (LitInt 0))))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length ($Unbox refType (|Seq#Index| |ars'#0@0| (LitInt 0)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (|Seq#Index| |ars'#0@0| (LitInt 0))) (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (|Seq#Index| |ars'#0@0| (LitInt 0))) (IndexField (LitInt 0)))) (=> (and (= |$rhs#1@0| (U_2_bool (Lit boolType (bool_2_U true)))) (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (|Seq#Index| |ars'#0@0| (LitInt 0))) (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 ($Unbox refType (|Seq#Index| |ars'#0@0| (LitInt 0)))) (IndexField (LitInt 0)) ($Box boolType (bool_2_U |$rhs#1@0|)))))) (=> (and (and (and ($IsGoodHeap $Heap@5) (= call0formal@_module._default.Test$X@0@@1 (TSeq (Tclass._System.array TBool)))) (and (= |call1formal@a#0@0@@1| ($Box SeqType |ars#0@0|)) (= |call2formal@b#0@0@@1| ($Box SeqType |ars'#0@0|)))) (and (and ($IsGoodHeap $Heap@6) ($IsHeapAnchor $Heap@6)) (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@8) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@8)))
 :qid |gitissue4141dfy.3:8|
 :skolemid |480|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@6 $o@@8))
)) ($HeapSucc $Heap@5 $Heap@6)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ars#0@0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ars#0@0|))) (=> (and (= |a##3@0| (|Seq#Build| |Seq#Empty| (|Seq#Index| |ars#0@0| (LitInt 0)))) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |ars#0@0|)))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is refType |a#0| (Tclass._System.array TBool)) ($IsAlloc refType |a#0| (Tclass._System.array TBool) $Heap)) true) (and (and ($Is SeqType |ars#0| (TSeq (Tclass._System.array TBool))) ($IsAlloc SeqType |ars#0| (TSeq (Tclass._System.array TBool)) $Heap)) true)) (and (and (and ($Is SeqType |ars'#0| (TSeq (Tclass._System.array TBool))) ($IsAlloc SeqType |ars'#0| (TSeq (Tclass._System.array TBool)) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 2)))) anon0_correct))))
