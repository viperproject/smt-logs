...
(let ((anon17_Then_correct  (=> (and ($IsAlloc intType (int_2_U |x#1_0@0|) TInt $Heap) (|CompilableExpressions.__default.P#canCall| |x#1_0@0|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#0| Int) ) (CompilableExpressions.__default.P |x#0|)))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#0@@0| Int) ) (CompilableExpressions.__default.P |x#0@@0|))) (=> (and (and (CompilableExpressions.__default.P |x#1_0@0|) (|CompilableExpressions.__default.P#canCall| |x#1_1@0|)) (and (CompilableExpressions.__default.P |x#1_1@0|) (= (ControlFlow 0 8) (- 0 7)))) (= |x#1_0@0| |x#1_1@0|)))))))
