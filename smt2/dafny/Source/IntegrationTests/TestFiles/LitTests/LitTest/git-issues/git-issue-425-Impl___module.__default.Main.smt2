...
(assert (distinct alloc Tagclass._module.Color |##_module.Color.Red| |##_module.Color.Blue| tytagFamily$Color)
)
...
(assert (forall ((d T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) ($Is DatatypeTypeType d Tclass._module.Color)) ($IsAlloc DatatypeTypeType d Tclass._module.Color $h))
 :qid |unknown.0:0|
 :skolemid |492|
 :pattern ( ($IsAlloc DatatypeTypeType d Tclass._module.Color $h))
)))
