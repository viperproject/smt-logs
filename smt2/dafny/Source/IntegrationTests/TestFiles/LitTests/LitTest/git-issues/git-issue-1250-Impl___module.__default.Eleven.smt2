...
(assert (forall (($ly@@4 T@U) (|n#0@@3| Int) (|f#0@@0| T@U) ) (! (= (_module.__default.Sum ($LS $ly@@4) |n#0@@3| |f#0@@0|) (_module.__default.Sum $ly@@4 |n#0@@3| |f#0@@0|))
 :qid |gitissue1250dfy.20:16|
 :skolemid |538|
 :pattern ( (_module.__default.Sum ($LS $ly@@4) |n#0@@3| |f#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@5 T@U) ($Heap@@0 T@U) (|n#0@@4| Int) (|f#0@@1| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| (LitInt |n#0@@4|) |f#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (<= (LitInt 0) |n#0@@4|)) ($Is HandleTypeType |f#0@@1| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt))))) (and (=> (or (not (= (LitInt |n#0@@4|) (LitInt 0))) (not true)) (|_module.__default.Sum#canCall| (LitInt (- |n#0@@4| 1)) |f#0@@1|)) (= (_module.__default.Sum ($LS $ly@@5) (LitInt |n#0@@4|) |f#0@@1|) (+ (U_2_int ($Unbox intType (Apply1 Tclass._System.nat TInt $Heap@@0 |f#0@@1| ($Box intType (int_2_U (LitInt |n#0@@4|)))))) (ite (= (LitInt |n#0@@4|) (LitInt 0)) 0 (_module.__default.Sum ($LS $ly@@5) (LitInt (- |n#0@@4| 1)) |f#0@@1|))))))
 :qid |gitissue1250dfy.20:16|
 :weight 3
 :skolemid |543|
 :pattern ( (_module.__default.Sum ($LS $ly@@5) (LitInt |n#0@@4|) |f#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|#$T0@@5| T@U) (|#$R@@5| T@U) (|f#0@@2| T@U) ) (! (= ($Is HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc1 |#$T0@@5| |#$R@@5|))  (and ($Is HandleTypeType |f#0@@2| (Tclass._System.___hPartialFunc1 |#$T0@@5| |#$R@@5|)) (forall ((|x0#0| T@U) ) (!  (=> ($IsBox |x0#0| |#$T0@@5|) (Requires1 |#$T0@@5| |#$R@@5| $OneHeap |f#0@@2| |x0#0|))
 :qid |unknown.0:0|
 :skolemid |408|
))))
 :qid |unknown.0:0|
 :skolemid |409|
 :pattern ( ($Is HandleTypeType |f#0@@2| (Tclass._System.___hTotalFunc1 |#$T0@@5| |#$R@@5|)))
)))
(assert (forall ((|#$T0@@6| T@U) (|#$R@@6| T@U) (|f#0@@3| T@U) ) (! (= ($Is HandleTypeType |f#0@@3| (Tclass._System.___hPartialFunc1 |#$T0@@6| |#$R@@6|))  (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hFunc1 |#$T0@@6| |#$R@@6|)) (forall ((|x0#0@@0| T@U) ) (!  (=> ($IsBox |x0#0@@0| |#$T0@@6|) (|Set#Equal| (Reads1 |#$T0@@6| |#$R@@6| $OneHeap |f#0@@3| |x0#0@@0|) |Set#Empty|))
 :qid |unknown.0:0|
 :skolemid |401|
))))
 :qid |unknown.0:0|
 :skolemid |402|
 :pattern ( ($Is HandleTypeType |f#0@@3| (Tclass._System.___hPartialFunc1 |#$T0@@6| |#$R@@6|)))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@11 T@U) ($Heap@@1 T@U) (|n#0@@6| Int) (|f#0@@4| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| (LitInt |n#0@@6|) (Lit HandleTypeType |f#0@@4|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (<= (LitInt 0) |n#0@@6|)) ($Is HandleTypeType |f#0@@4| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt))))) (and (=> (or (not (= (LitInt |n#0@@6|) (LitInt 0))) (not true)) (|_module.__default.Sum#canCall| (LitInt (- |n#0@@6| 1)) (Lit HandleTypeType |f#0@@4|))) (= (_module.__default.Sum ($LS $ly@@11) (LitInt |n#0@@6|) (Lit HandleTypeType |f#0@@4|)) (+ (U_2_int ($Unbox intType (Apply1 Tclass._System.nat TInt $Heap@@1 (Lit HandleTypeType |f#0@@4|) ($Box intType (int_2_U (LitInt |n#0@@6|)))))) (ite (= (LitInt |n#0@@6|) (LitInt 0)) 0 (_module.__default.Sum ($LS $ly@@11) (LitInt (- |n#0@@6| 1)) (Lit HandleTypeType |f#0@@4|)))))))
 :qid |gitissue1250dfy.20:16|
 :weight 3
 :skolemid |544|
 :pattern ( (_module.__default.Sum ($LS $ly@@11) (LitInt |n#0@@6|) (Lit HandleTypeType |f#0@@4|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.Eleven)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (_module.__default.Sum ($LS ($LS $LZ)) (LitInt 9) (|_module.__default.Fib#Handle| ($LS ($LS $LZ)))) (LitInt (Mul (LitInt 11) (LitInt (_module.__default.Fib ($LS ($LS $LZ)) (LitInt 6)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
