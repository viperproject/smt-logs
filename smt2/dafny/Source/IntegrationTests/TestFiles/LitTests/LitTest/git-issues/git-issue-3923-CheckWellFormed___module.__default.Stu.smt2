...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Stu)
...
(let ((anon5_Else_correct  (=> (and (=> (_module.Fruit.Apple_q |fruit#0|) (<= (LitInt 0) (_module.Fruit.u |fruit#0|))) (= (ControlFlow 0 4) 1)) anon4_correct)))
(let ((anon5_Then_correct  (=> (_module.Fruit.Apple_q |fruit#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Fruit.Apple_q |fruit#0|)) (=> (_module.Fruit.Apple_q |fruit#0|) (=> (and (<= (LitInt 0) (_module.Fruit.u |fruit#0|)) (= (ControlFlow 0 2) 1)) anon4_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |fruit#0| Tclass._module.Fruit) ($IsAlloc DatatypeTypeType |fruit#0| Tclass._module.Fruit $Heap)) (|$IsA#_module.Fruit| |fruit#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
