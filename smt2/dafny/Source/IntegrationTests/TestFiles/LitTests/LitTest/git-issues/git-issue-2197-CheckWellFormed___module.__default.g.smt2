...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon4_correct  (=> (and (and (<= (LitInt 0) |y#0@0|) (< |y#0@0| (|Seq#Length| |test#0|))) (= (ControlFlow 0 3) (- 0 2))) (and (<= 0 |y#0@0|) (< |y#0@0| (|Seq#Length| |test#0|))))))
(let ((anon7_Else_correct  (=> (and (< |y#0@0| (LitInt 0)) (= (ControlFlow 0 5) 3)) anon4_correct)))
(let ((anon7_Then_correct  (=> (and (<= (LitInt 0) |y#0@0|) (= (ControlFlow 0 4) 3)) anon4_correct)))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |gitissue2197dfy.15:8|
 :skolemid |486|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap $Heap@0))) (and (and (=> (= (ControlFlow 0 6) 1) anon6_Else_correct) (=> (= (ControlFlow 0 6) 4) anon7_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |test#0| (TSeq TBool)) ($IsAlloc SeqType |test#0| (TSeq TBool) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
