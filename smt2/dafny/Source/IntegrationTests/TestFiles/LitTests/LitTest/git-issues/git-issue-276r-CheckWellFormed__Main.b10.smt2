...
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |x#0|) (= |newtype$check#0@0| (LitReal 30.0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= (q@Real (q@Int |newtype$check#0@0|)) |newtype$check#0@0|)) (=> (= (q@Real (q@Int |newtype$check#0@0|)) |newtype$check#0@0|) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (q@Int (LitReal 30.0)))))))
