...
(set-info :boogie-vc-id CheckWellFormed$$M0.__default.M0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($Is refType |c#0@0| Tclass.M0.Cell) ($IsAlloc refType |c#0@0| Tclass.M0.Cell $Heap)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |c#0@0| null)) (not true))))))
