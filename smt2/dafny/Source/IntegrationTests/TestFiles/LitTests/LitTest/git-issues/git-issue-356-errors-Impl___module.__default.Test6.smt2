...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (q@Real (q@Int |r#0|)) |r#0|)) (=> (= (q@Real (q@Int |r#0|)) |r#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (q@Int |r#0|)) (< (q@Int |r#0|) 256))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 0 $FunctionContextHeight) (<= (LitReal 0.0) |r#0|)) (and (= |r#0| (q@Real (q@Int |r#0|))) (= (ControlFlow 0 4) 2))) anon0_correct))))
