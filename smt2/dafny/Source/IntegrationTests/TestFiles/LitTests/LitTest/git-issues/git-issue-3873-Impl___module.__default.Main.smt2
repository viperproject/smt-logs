...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (and ($Is refType null (Tclass._System.array Tclass._System.Tuple0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType null))) (exists ((|$as#v0#0| T@U) )  (and ($Is refType |$as#v0#0| (Tclass._System.array Tclass._System.Tuple0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType |$as#v0#0|)))))) (=> (or (and ($Is refType null (Tclass._System.array Tclass._System.Tuple0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType null))) (exists ((|$as#v0#0@@0| T@U) )  (and ($Is refType |$as#v0#0@@0| (Tclass._System.array Tclass._System.Tuple0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType |$as#v0#0@@0|))))) (=> (and (and ($Is refType |v#0@0| (Tclass._System.array Tclass._System.Tuple0)) ($IsAlloc refType |v#0@0| (Tclass._System.array Tclass._System.Tuple0) $Heap@0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType |v#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |v#0@0| null)) (not true))) (=> (or (not (= |v#0@0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |v#0@0|)))))))))))
