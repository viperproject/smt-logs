...
(assert (distinct TInt TagInt TagSet TagMap alloc Tagclass._System.array? Tagclass._System.array |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 |##_System._tuple#0._#Make0| Tagclass._System.Tuple0 tytagFamily$array |tytagFamily$_tuple#2| |tytagFamily$_tuple#0|)
)
...
(assert (forall ((v@@8 T@U) (t0@@4 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@8 (TMap t0@@4 t1@@2)) (forall ((bx@@10 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@8) bx@@10) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@8) bx@@10) t1@@2) ($IsBox bx@@10 t0@@4)))
...
(assert (forall ((d@@4 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_System.Tuple2.___hMake2_q d@@4) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@4 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@4)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@4 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@4))
)))) ($IsAllocBox (_System.Tuple2._0 d@@4) |_System._tuple#2$T0@@6| $h@@4))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@4) |_System._tuple#2$T0@@6| $h@@4))
)))
(assert (forall ((d@@5 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_System.Tuple2.___hMake2_q d@@5) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@5 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@5)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@5))
)))) ($IsAllocBox (_System.Tuple2._1 d@@5) |_System._tuple#2$T1@@7| $h@@5))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@5) |_System._tuple#2$T1@@7| $h@@5))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (and ($Is refType null (Tclass._System.array Tclass._System.Tuple0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType null))) (exists ((|$as#v0#0| T@U) ) (!  (and ($Is refType |$as#v0#0| (Tclass._System.array Tclass._System.Tuple0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType |$as#v0#0|)))
 :qid |gitissue3873dfy.6:7|
 :skolemid |482|
)))) (=> (or (and ($Is refType null (Tclass._System.array Tclass._System.Tuple0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType null))) (exists ((|$as#v0#0@@0| T@U) ) (!  (and ($Is refType |$as#v0#0@@0| (Tclass._System.array Tclass._System.Tuple0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType |$as#v0#0@@0|)))
 :qid |gitissue3873dfy.6:7|
 :skolemid |482|
))) (=> (and (and ($Is refType |v#0@0| (Tclass._System.array Tclass._System.Tuple0)) ($IsAlloc refType |v#0@0| (Tclass._System.array Tclass._System.Tuple0) $Heap@0)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box refType |v#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |v#0@0| null)) (not true))) (=> (or (not (= |v#0@0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |v#0@0|)))))))))))
(let ((anon3_Else_correct  (=> (and (not (and ($Is refType |v#1@0| (Tclass._System.array Tclass._System.Tuple0)) ($IsAlloc refType |v#1@0| (Tclass._System.array Tclass._System.Tuple0) $Heap@0))) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and ($Is refType |v#1@0| (Tclass._System.array Tclass._System.Tuple0)) ($IsAlloc refType |v#1@0| (Tclass._System.array Tclass._System.Tuple0) $Heap@0)) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (<= 0 (LitInt 1))) (=> (<= 0 (LitInt 1)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass._System.Tuple0))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 1)))) (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)) (and ($IsHeapAnchor $Heap@0) (= |m#0@0| (|Map#Build| |Map#Empty| ($Box refType $nw@0) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_System._tuple#0._#Make0|))))))) (and (=> (= (ControlFlow 0 7) 5) anon3_Then_correct) (=> (= (ControlFlow 0 7) 6) anon3_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is refType |a#0| (Tclass._System.array Tclass._System.Tuple0)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._System.Tuple0) $Heap)) true) (and (and ($Is MapType |m#0| (TMap (Tclass._System.array Tclass._System.Tuple0) Tclass._System.Tuple0)) ($IsAlloc MapType |m#0| (TMap (Tclass._System.array Tclass._System.Tuple0) Tclass._System.Tuple0) $Heap)) true)) (and (and (and ($Is refType |v#0| (Tclass._System.array Tclass._System.Tuple0)) ($IsAlloc refType |v#0| (Tclass._System.array Tclass._System.Tuple0) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 7)))) anon0_correct))))
