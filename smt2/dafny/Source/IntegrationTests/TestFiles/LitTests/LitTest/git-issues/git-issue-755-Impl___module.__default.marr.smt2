...
(declare-fun |rev#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.marr)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon9_correct  (=> (and (<= (LitInt 0) |i#1_0@0|) (< |i#1_0@0| (_System.array.Length |s#0|))) (and (=> (= (ControlFlow 0 11) (- 0 17)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 16)) (and (<= 0 |i#1_0@0|) (< |i#1_0@0| (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 11) (- 0 15)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#1_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |i#1_0@0|))) (and (=> (= (ControlFlow 0 11) (- 0 14)) (or (not (= |s#0| null)) (not true))) (=> (or (not (= |s#0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= |s#0| null)) (not true))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (and (<= 0 (- (- (_System.array.Length |s#0|) |i#1_0@0|) 1)) (< (- (- (_System.array.Length |s#0|) |i#1_0@0|) 1) (_System.array.Length |s#0|)))) (=> (and (and (<= (LitInt 0) |i#1_1@0|) (< |i#1_1@0| (_System.array.Length |s#0|))) (and (or (not (= |i#1_0@0| |i#1_1@0|)) (not true)) (= (ControlFlow 0 11) (- 0 10)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField |i#1_0@0|) (IndexField |i#1_1@0|))) (not true))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |s#0|) (IndexField (- (- (_System.array.Length |s#0|) |i#1_0@0|) 1))))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |s#0|) (IndexField (- (- (_System.array.Length |s#0|) |i#1_1@0|) 1))))))))))))))))))))
(let ((anon15_Else_correct  (=> (and (< |i#1_0@0| (LitInt 0)) (= (ControlFlow 0 20) 11)) anon9_correct)))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#1_0@0|) (and (=> (= (ControlFlow 0 18) (- 0 19)) (or (not (= |s#0| null)) (not true))) (=> (= (ControlFlow 0 18) 11) anon9_correct)))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 21) 18) anon15_Then_correct) (=> (= (ControlFlow 0 21) 20) anon15_Else_correct))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct  (=> (<= (_System.array.Length |s#0|) |i#0@1|) (and (=> (= (ControlFlow 0 22) (- 0 24)) (or (not (= |s#0| null)) (not true))) (=> (or (not (= |s#0| null)) (not true)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (<= 0 (_System.array.Length |s#0|))) (=> (<= 0 (_System.array.Length |s#0|)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (_System.array.Length |s#0|)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 22) 21) anon14_Then_correct) (=> (= (ControlFlow 0 22) 9) anon14_Else_correct))))))))))
(let ((anon13_Else_correct  (=> (and (< |i#0@1| (_System.array.Length |s#0|)) (= |$decr$loop#00@1| (- (_System.array.Length |s#0|) |i#0@1|))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= |s#0| null)) (not true))) (=> (or (not (= |s#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |s#0|)))) (=> (and (<= 0 |i#0@1|) (< |i#0@1| (_System.array.Length |s#0|))) (=> (and (= |sum#0@2| (+ |sum#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |s#0|) (IndexField |i#0@1|)))))) (= |i#0@2| (+ |i#0@1| 1))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- (_System.array.Length |s#0|) |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- (_System.array.Length |s#0|) |i#0@2|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- (_System.array.Length |s#0|) |i#0@2|) |$decr$loop#00@1|))))))))))))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 25) (- 0 26)) (or (not (= |s#0| null)) (not true))) (=> (or (not (= |s#0| null)) (not true)) (and (=> (= (ControlFlow 0 25) 22) anon13_Then_correct) (=> (= (ControlFlow 0 25) 5) anon13_Else_correct)))))))
(let ((anon12_Then_correct  (=> (and (not |$w$loop#0@0|) (= (ControlFlow 0 3) (- 0 2))) (or (not (= |s#0| null)) (not true)))))
(let ((anon11_LoopBody_correct  (and (=> (= (ControlFlow 0 27) 3) anon12_Then_correct) (=> (= (ControlFlow 0 27) 25) anon12_Else_correct))))
(let ((anon11_LoopDone_correct true))
(let ((anon11_LoopHead_correct  (=> (and (not false) (<= 0 |i#0@1|)) (=> (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |gitissue755dfy.60:3|
 :skolemid |507|
...
)) (<= (- (_System.array.Length |s#0|) |i#0@1|) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 28) 1) anon11_LoopDone_correct) (=> (= (ControlFlow 0 28) 27) anon11_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |i#0@0| (LitInt 0)) (= |sum#0@0| (LitInt 0))) (and (= |$decr_init$loop#00@0| (- (_System.array.Length |s#0|) |i#0@0|)) (= (ControlFlow 0 29) 28))) anon11_LoopHead_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |s#0| (Tclass._System.array TInt)) ($IsAlloc refType |s#0| (Tclass._System.array TInt) $Heap))) (=> (and (and (and ($Is refType |rev#0| (Tclass._System.array TInt)) ($IsAlloc refType |rev#0| (Tclass._System.array TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 30) 29))) anon0_correct))))
