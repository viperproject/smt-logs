...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#c#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#21| |l#0|) |$l#0#heap#0| |$l#0#c#0|)) ($IsBox |$l#0#c#0| |l#0|))
 :qid |gitissue851dfy.137:9|
 :skolemid |4128|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#21| |l#0|) |$l#0#heap#0| |$l#0#c#0|))
)))
...
(assert (forall ((bx@@2 T@U) ($h T@U) ) (!  (=> (and ($IsAllocBox bx@@2 Tclass.OtherBindersInStatements.C? $h) ($IsGoodHeap $h)) ($IsAllocBox bx@@2 Tclass._System.object? $h))
 :qid |unknown.0:0|
 :skolemid |2998|
 :pattern ( ($IsAllocBox bx@@2 Tclass.OtherBindersInStatements.C? $h))
)))
...
(assert (forall (($o@@0 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass.OtherBindersInStatements.C? $h@@3)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h@@3 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2994|
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass.OtherBindersInStatements.C) (and (= ($Box refType ($Unbox refType bx@@8)) bx@@8) ($Is refType ($Unbox refType bx@@8) Tclass.OtherBindersInStatements.C)))
 :qid |unknown.0:0|
 :skolemid |2950|
 :pattern ( ($IsBox bx@@8 Tclass.OtherBindersInStatements.C))
)))
(assert (forall ((bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 Tclass.OtherBindersInStatements.C?) (and (= ($Box refType ($Unbox refType bx@@9)) bx@@9) ($Is refType ($Unbox refType bx@@9) Tclass.OtherBindersInStatements.C?)))
 :qid |unknown.0:0|
 :skolemid |2992|
...
(assert (forall ((|l#0@@0| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#22| |l#0@@0|) |$l#0#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |4129|
 :pattern ( (MapType1Select refType boolType (|lambda#22| |l#0@@0|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#24| |l#0@@1|) |$l#0#ly#0|) |l#0@@1|)
 :qid |gitissue851dfy.198:14|
 :skolemid |4131|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#24| |l#0@@1|) |$l#0#ly#0|))
)))
...
(assert (forall ((bx@@16 T@U) ) (!  (=> ($IsBox bx@@16 Tclass.OtherBindersInStatements.C?) ($IsBox bx@@16 Tclass._System.object?))
 :qid |unknown.0:0|
 :skolemid |2997|
 :pattern ( ($IsBox bx@@16 Tclass.OtherBindersInStatements.C?))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#c#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#20| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#c#0@@0|) |l#0@@3|)
 :qid |gitissue851dfy.198:40|
 :skolemid |4127|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#20| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#c#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#c#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#23| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#c#0@@1|) |l#0@@4|)
 :qid |gitissue851dfy.198:14|
 :skolemid |4130|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#23| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#c#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$OtherBindersInStatements.__default.Lambda)
...
(let ((anon6_Else_correct  (=> (and (not (and ($Is refType |c#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@0| Tclass.OtherBindersInStatements.C |$lambdaHeap#0@0|))) (= (ControlFlow 0 7) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and (and ($Is refType |c#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@0| Tclass.OtherBindersInStatements.C |$lambdaHeap#0@0|)) (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (=> (= |lambdaResult#0| (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))) (=> (and ($Is boolType (bool_2_U |lambdaResult#0|) TBool) (= (ControlFlow 0 4) 3)) anon3_correct))))))))))
(let ((anon5_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 8) 4) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#24| (Handle1 (|lambda#20| ($Box boolType (bool_2_U (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) (|lambda#21| Tclass.OtherBindersInStatements.C) (|lambda#23| (SetRef_to_SetBox (|lambda#22| false))))) ($LS $LZ)))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 9) 8) anon5_Then_correct) (=> (= (ControlFlow 0 9) 2) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass.OtherBindersInStatements.C TBool)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass.OtherBindersInStatements.C TBool) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
