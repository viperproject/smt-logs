...
(set-info :boogie-vc-id Impl$$M.__default.LemmaEmpty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc false)) (=> (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 2) (- 0 1))) (= (|Set#Card| (M.__default.ToSet reveal_M._default.ToSet |xs#0@@2|)) (LitInt 0))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |xs#0@@2| (TSeq TInt)) ($IsAlloc SeqType |xs#0@@2| (TSeq TInt) $Heap)) (= 1 $FunctionContextHeight)) (and (|Seq#Equal| |xs#0@@2| |Seq#Empty|) (= (ControlFlow 0 3) 2))) anon0_correct))))
