...
(declare-fun Main.__default.a () (_ BitVec 8))
...
(assert (= Main.__default.a (U_2_bv8 (Lit bv8Type (bv8_2_U #x14)))))
...
(assert  (=> (< 0 $FunctionContextHeight) ($Is bv8Type (bv8_2_U Main.__default.a) (TBitvector 8))))
...
(set-info :boogie-vc-id CheckWellFormed$$Main.ba)
...
(let ((anon11_Else_correct  (=> (and (not (bvult Main.__default.a Main.__default.b)) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (bvult Main.__default.a Main.__default.b) (= (ControlFlow 0 6) 4)) anon6_correct)))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite (bvult Main.__default.a Main.__default.b) 24 56))))))
