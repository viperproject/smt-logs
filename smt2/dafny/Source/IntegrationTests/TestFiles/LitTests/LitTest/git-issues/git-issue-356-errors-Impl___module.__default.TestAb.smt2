...
(set-info :boogie-vc-id Impl$$_module.__default.TestAb)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|ORD#IsNat| |o#0|)) (=> (|ORD#IsNat| |o#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (< (|ORD#Offset| |o#0|) 65536)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is charType |ch#0| TChar) true) (= 0 $FunctionContextHeight)) (and (|ORD#IsNat| |o#0|) (= (ControlFlow 0 4) 2))) anon0_correct))))
