// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5065.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5065-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5065.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var i#0: int where LitInt(0) <= i#0 && i#0 < _module.__default.TWO__TO__THE__8();
  ...
  var newtype$check#1: int;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5065.dfy(7,16)
    assume true;
    ...
    assume true;
    i#0 := LitInt(10);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5065.dfy(8,21)
    assume true;
    assert {:id "id2"} 0 <= i#0;
    ...
    if (*)
    {
        ...
        if (true)
        {
            ...
            assert {:id "id3"} LitInt(0) <= newtype$check#1
               && newtype$check#1 < _module.__default.TWO__TO__THE__8();
            assume {:id "id4"} lambdaResult#0 == LitInt(0);
            assume true;
    ...
    assert {:id "id5"} {:subsumption 0} (forall seqinit#0#i0#0: int :: 
      0 <= seqinit#0#i0#0 && seqinit#0#i0#0 < i#0
         ==> Requires1(TInt, 
          Tclass._module.uint8(), 
          $Heap, 
          ...
          $Box(seqinit#0#i0#0)));
    assume true;
    s#0 := Seq#Create(Tclass._module.uint8(), 
      $Heap, 
      i#0, 
      Lit(AtLayer((lambda $l#0#ly#0: LayerType :: 
            Handle1((lambda $l#0#heap#0: Heap, $l#0#_v0#0: Box :: $Box(LitInt(0))), 
          ...
          $LS($LZ))));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5065.dfy(9,3)
    assume true;
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "uint8 (well-formedness)"} CheckWellFormed$$_module.uint8(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id7"} LitInt(0) <= x#0 && x#0 < _module.__default.TWO__TO__THE__8();
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id9"} {:subsumption 0} 0 < _module.__default.TWO__TO__THE__8();
        assume false;
    }
}
