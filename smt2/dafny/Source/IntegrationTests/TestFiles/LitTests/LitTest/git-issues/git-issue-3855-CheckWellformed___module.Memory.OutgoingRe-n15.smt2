...
(declare-fun |lambda#35| (T@U T@U T@U T@U T@U T@U T@U) T@U)
...
(assert (distinct TBool TChar TagBool TagChar TagSet TagSeq TagMap alloc allocName |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass._module.Object Tagclass._module.Memory Tagclass._module.Memory? Tagclass._module.Object? class._module.Object? class._module.Memory? |tytagFamily$_tuple#2| tytagFamily$Object tytagFamily$Memory field$fields field$objects)
)
(assert (= (FDim alloc) 0))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|os#0| T@U) ) (!  (=> (or (|_module.Memory.OutgoingReferencesAreInThisHeap#canCall| $Heap this |os#0|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Memory) ($IsAlloc refType this Tclass._module.Memory $Heap)))) ($Is SetType |os#0| (TSet Tclass._module.Object))))) (and (forall ((|o#0| T@U) ) (!  (=> ($Is refType |o#0| Tclass._module.Object) (=> (|Set#IsMember| |os#0| ($Box refType |o#0|)) (|_module.Object.outgoing#canCall| $Heap |o#0|)))
 :qid |gitissue3855dfy.215:14|
 :skolemid |867|
 :pattern ( (_module.Object.outgoing $Heap |o#0|))
 :pattern ( (|Set#IsMember| |os#0| ($Box refType |o#0|)))
)) (= (_module.Memory.OutgoingReferencesAreInThisHeap $Heap this |os#0|) (forall ((|o#0@@0| T@U) ) (!  (=> (and ($Is refType |o#0@@0| Tclass._module.Object) (|Set#IsMember| |os#0| ($Box refType |o#0@@0|))) (|Set#Subset| (_module.Object.outgoing $Heap |o#0@@0|) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Memory.objects))))
 :qid |gitissue3855dfy.215:14|
 :skolemid |866|
 :pattern ( (_module.Object.outgoing $Heap |o#0@@0|))
 :pattern ( (|Set#IsMember| |os#0| ($Box refType |o#0@@0|)))
)))))
 :qid |gitissue3855dfy.210:13|
 :skolemid |868|
 :pattern ( (_module.Memory.OutgoingReferencesAreInThisHeap $Heap this |os#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#35| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) (or (or (and (= $o@@3 |l#3|) (= $f |l#4|)) (|Set#IsMember| |l#5| ($Box refType $o@@3))) (|Set#IsMember| |l#6| ($Box refType $o@@3)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1413|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#35| |l#0| |l#1| |l#2| |l#3| |l#4| |l#5| |l#6|) $o@@3 $f))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Object.outgoing#canCall| $Heap@@1 this@@1) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Object) ($IsAlloc refType this@@1 Tclass._module.Object $Heap@@1)))))) (= (_module.Object.outgoing $Heap@@1 this@@1) (|Map#Values| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields)))))
 :qid |gitissue3855dfy.106:12|
 :skolemid |755|
 :pattern ( (_module.Object.outgoing $Heap@@1 this@@1) ($IsGoodHeap $Heap@@1))
))))
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.Memory?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.Memory.objects)) (TSet Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |826|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.Memory.objects)))
)))
(assert (forall (($h@@5 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.Memory?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) _module.Memory.objects)) (TSet Tclass._module.Object) $h@@5))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |827|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) _module.Memory.objects)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Object.outgoing#canCall| $Heap@@2 this@@2) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@2) (or (not (= this@@2 null)) (not true))) ($IsAlloc refType this@@2 Tclass._module.Object $Heap@@2)))) ($IsAlloc SetType (_module.Object.outgoing $Heap@@2 this@@2) (TSet Tclass._module.Object) $Heap@@2))
 :qid |gitissue3855dfy.106:12|
 :skolemid |753|
 :pattern ( ($IsAlloc SetType (_module.Object.outgoing $Heap@@2 this@@2) (TSet Tclass._module.Object) $Heap@@2))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.OutgoingReferencesAreInThisHeap)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct  (=> (= (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@3 this@@3 |os#0@@0|) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| |os#0@@0| ($Box refType |o#2|))) (|Set#Subset| (_module.Object.outgoing $Heap@@3 |o#2|) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Memory.objects))))
 :qid |gitissue3855dfy.215:14|
 :skolemid |871|
 :pattern ( (_module.Object.outgoing $Heap@@3 |o#2|))
 :pattern ( (|Set#IsMember| |os#0@@0| ($Box refType |o#2|)))
))) (=> (and (forall ((|o#2@@0| T@U) ) (!  (=> ($Is refType |o#2@@0| Tclass._module.Object) (=> (|Set#IsMember| |os#0@@0| ($Box refType |o#2@@0|)) (|_module.Object.outgoing#canCall| $Heap@@3 |o#2@@0|)))
 :qid |gitissue3855dfy.215:14|
 :skolemid |872|
 :pattern ( (_module.Object.outgoing $Heap@@3 |o#2@@0|))
 :pattern ( (|Set#IsMember| |os#0@@0| ($Box refType |o#2@@0|)))
)) ($Is boolType (bool_2_U (_module.Memory.OutgoingReferencesAreInThisHeap $Heap@@3 this@@3 |os#0@@0|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))
(let ((anon10_Else_correct  (=> (and (and (not (|Set#IsMember| |os#0@@0| ($Box refType |o#1@0|))) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 8) 3))) anon6_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| |os#0@@0| ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@3) (=> (and (= |b$reqreads#1@0| (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@8) alloc)))) (and (= $o@@8 |o#1@0|) (= $f@@0 _module.Object.fields))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@0)))
 :qid |gitissue3855dfy.215:27|
 :skolemid |869|
))) (|_module.Object.outgoing#canCall| $Heap@@3 |o#1@0|)) (=> (and (and (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@3 _module.Memory.objects))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon6_correct))))))))
(let ((anon9_Then_correct  (=> (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@3)) (and (=> (= (ControlFlow 0 9) 6) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (and (not (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@3))) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 5) 3))) anon6_correct)))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#35| null $Heap@@3 alloc this@@3 _module.Memory.objects ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Memory.objects)) |os#0@@0|)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (not (= this@@3 null)) (not true))) (=> (or (not (= this@@3 null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@3 _module.Memory.objects))) (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (and (=> (= (ControlFlow 0 10) 1) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 5) anon9_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Memory) ($IsAlloc refType this@@3 Tclass._module.Memory $Heap@@3))) ($Is SetType |os#0@@0| (TSet Tclass._module.Object))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 13) 10))) anon0_correct))))
