...
(declare-fun Tagclass.M3.MyBv10 () T@U)
(declare-fun tytagFamily$MyBv10 () T@U)
...
(declare-fun Tclass.M3.MyBv10 () T@U)
...
(assert (distinct TagMultiSet alloc Tagclass.M3.MyBv10 tytagFamily$MyBv10)
)
...
(assert  (and (and (= (Ctor bv10Type) 3) (forall ((arg0@@2 (_ BitVec 10)) ) (! (= (U_2_bv10 (bv10_2_U arg0@@2)) arg0@@2)
...
(assert (forall ((v@@0 T@U) (heap T@U) ) (! ($IsAlloc bv10Type v@@0 (TBitvector 10) heap)
 :qid |unknown.0:0|
 :skolemid |1861|
 :pattern ( ($IsAlloc bv10Type v@@0 (TBitvector 10) heap))
)))
(assert (forall ((|v#0| T@U) ($h T@U) ) (! ($IsAlloc bv10Type |v#0| Tclass.M3.MyBv10 $h)
 :qid |unknown.0:0|
 :skolemid |2050|
 :pattern ( ($IsAlloc bv10Type |v#0| Tclass.M3.MyBv10 $h))
)))
...
(assert (forall ((v@@2 T@U) ) (! ($Is bv10Type v@@2 (TBitvector 10))
 :qid |unknown.0:0|
 :skolemid |1860|
 :pattern ( ($Is bv10Type v@@2 (TBitvector 10)))
)))
(assert (= (Ctor MultiSetType) 4))
(assert (forall ((v@@3 T@U) (t0 T@U) ) (!  (=> ($Is MultiSetType v@@3 (TMultiSet t0)) ($IsGoodMultiSet v@@3))
 :qid |DafnyPreludebpl.250:15|
 :skolemid |1568|
 :pattern ( ($Is MultiSetType v@@3 (TMultiSet t0)))
)))
...
(assert (forall ((|v#0@@0| T@U) ) (! (= ($Is bv10Type |v#0@@0| Tclass.M3.MyBv10)  (or (not (= (U_2_bv10 |v#0@@0|) #b0000000111)) (not true)))
 :qid |unknown.0:0|
 :skolemid |2049|
 :pattern ( ($Is bv10Type |v#0@@0| Tclass.M3.MyBv10))
)))
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass.M3.MyBv10) (and (= ($Box bv10Type ($Unbox bv10Type bx)) bx) ($Is bv10Type ($Unbox bv10Type bx) Tclass.M3.MyBv10)))
 :qid |unknown.0:0|
 :skolemid |2028|
 :pattern ( ($IsBox bx Tclass.M3.MyBv10))
)))
(assert (forall ((v@@5 T@U) (t0@@0 T@U) ) (! (= ($Is MultiSetType v@@5 (TMultiSet t0@@0)) (forall ((bx@@0 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| v@@5 bx@@0)) ($IsBox bx@@0 t0@@0))
 :qid |DafnyPreludebpl.248:11|
 :skolemid |1566|
 :pattern ( (|MultiSet#Multiplicity| v@@5 bx@@0))
)))
 :qid |DafnyPreludebpl.246:15|
 :skolemid |1567|
 :pattern ( ($Is MultiSetType v@@5 (TMultiSet t0@@0)))
)))
...
(assert  (and (and (and (and (and (and (and (and (and (forall ((t0@@1 T@T) (t1 T@T) (t2 T@T) (val T@U) (m T@U) (x0 T@U) (x1 T@U) ) (! (= (MapType0Select t0@@1 t1 t2 (MapType0Store t0@@1 t1 t2 m x0 x1 val) x0 x1) val)
 ...
 :weight 0
))) (= (Ctor BoxType) 7)) (forall ((arg0@@3 T@T) (arg1 T@T) ) (! (= (Ctor (MapType1Type arg0@@3 arg1)) 8)
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (TBitvector 0)) (and (= ($Box intType ($Unbox intType bx@@2)) bx@@2) ($Is intType ($Unbox intType bx@@2) (TBitvector 0))))
 :qid |DafnyPreludebpl.191:15|
 :skolemid |1547|
 :pattern ( ($IsBox bx@@2 (TBitvector 0)))
)))
...
(assert (forall ((bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 (TBitvector 10)) (and (= ($Box bv10Type ($Unbox bv10Type bx@@4)) bx@@4) ($Is bv10Type ($Unbox bv10Type bx@@4) (TBitvector 10))))
 :qid |unknown.0:0|
 :skolemid |1859|
 :pattern ( ($IsBox bx@@4 (TBitvector 10)))
)))
(assert (= (Tag Tclass.M3.MyBv10) Tagclass.M3.MyBv10))
(assert (= (TagFamily Tclass.M3.MyBv10) tytagFamily$MyBv10))
(assert (forall ((x@@10 T@U) (T@@4 T@T) ) (! (= ($Box T@@4 (Lit T@@4 x@@10)) (Lit BoxType ($Box T@@4 x@@10)))
 :qid |DafnyPreludebpl.103:18|
 :skolemid |1532|
 :pattern ( ($Box T@@4 (Lit T@@4 x@@10)))
)))
(assert (forall ((a@@4 T@U) (x@@11 T@U) (y@@0 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| a@@4 y@@0)) (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@4 x@@11) y@@0)))
 :qid |DafnyPreludebpl.973:15|
 :skolemid |1710|
 :pattern ( (|MultiSet#UnionOne| a@@4 x@@11) (|MultiSet#Multiplicity| a@@4 y@@0))
)))
(assert (forall ((a@@5 T@U) (x@@12 T@U) (o@@1 T@U) ) (! (= (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@5 x@@12) o@@1))  (or (= o@@1 x@@12) (< 0 (|MultiSet#Multiplicity| a@@5 o@@1))))
 :qid |DafnyPreludebpl.963:15|
 :skolemid |1708|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@5 x@@12) o@@1))
)))
(assert (forall ((v@@7 T@U) (t0@@3 T@U) (h@@1 T@U) ) (! (= ($IsAlloc MultiSetType v@@7 (TMultiSet t0@@3) h@@1) (forall ((bx@@5 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| v@@7 bx@@5)) ($IsAllocBox bx@@5 t0@@3 h@@1))
 :qid |DafnyPreludebpl.307:11|
 :skolemid |1587|
 :pattern ( (|MultiSet#Multiplicity| v@@7 bx@@5))
)))
 :qid |DafnyPreludebpl.305:15|
 :skolemid |1588|
 :pattern ( ($IsAlloc MultiSetType v@@7 (TMultiSet t0@@3) h@@1))
)))
(push 1)
...
(declare-fun |x0#0| () (_ BitVec 10))
(declare-fun |x1#0| () (_ BitVec 10))
...
(set-info :boogie-vc-id Impl$$M3.__default.TestBv10)
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is MultiSetType (|MultiSet#Union| |s1#0@0| |s0#0@0|) (TMultiSet Tclass.M3.MyBv10)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is MultiSetType (|MultiSet#Union| |s0#0@0| |s1#0@0|) (TMultiSet Tclass.M3.MyBv10)))))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |s0#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box bv10Type (bv10_2_U |x0#0|)))) (= |s1#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box bv10Type (bv10_2_U |x1#0|))))) (and (and (and (and (and (and (=> (= (ControlFlow 0 11) 1) anon8_Then_correct) (=> (= (ControlFlow 0 11) 2) anon9_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 8) anon13_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon13_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (or (not (= |x1#0| #b0000000111)) (not true))) (and (and ($Is MultiSetType |s0#0| (TMultiSet (TBitvector 10))) ($IsAlloc MultiSetType |s0#0| (TMultiSet (TBitvector 10)) $Heap)) true)) (=> (and (and (and (and (and ($Is MultiSetType |s1#0| (TMultiSet Tclass.M3.MyBv10)) ($IsAlloc MultiSetType |s1#0| (TMultiSet Tclass.M3.MyBv10) $Heap)) true) (and (and ($Is MultiSetType |a#0_0| (TMultiSet (TBitvector 10))) ($IsAlloc MultiSetType |a#0_0| (TMultiSet (TBitvector 10)) $Heap)) true)) (and (and (and ($Is MultiSetType |a#1_0| (TMultiSet (TBitvector 10))) ($IsAlloc MultiSetType |a#1_0| (TMultiSet (TBitvector 10)) $Heap)) true) (and (and ($Is MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyBv10)) ($IsAlloc MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyBv10) $Heap)) true))) (and (and (and (and ($Is MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyBv10)) ($IsAlloc MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyBv10) $Heap)) true) (and (and ($Is MultiSetType |a#4_0| (TMultiSet (TBitvector 10))) ($IsAlloc MultiSetType |a#4_0| (TMultiSet (TBitvector 10)) $Heap)) true)) (and (and (and ($Is MultiSetType |a#5_0| (TMultiSet (TBitvector 10))) ($IsAlloc MultiSetType |a#5_0| (TMultiSet (TBitvector 10)) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))))) anon0_correct))))
