...
(declare-fun M.Tr.True_k (T@U) Bool)
(declare-fun |M.Tr.True_k#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|M.Tr.True_k#canCall| this) (and (< 0 $FunctionContextHeight) (and (or (not (= this null)) (not true)) ($Is refType this Tclass.M.Tr)))) (M.Tr.True_k this))
 :qid |gitissue2500dfy.10:15|
 :skolemid |545|
 :pattern ( (M.Tr.True_k this))
))))
...
(set-info :boogie-vc-id CheckWellformed$$M.Tr.True_k)
...
(let ((anon4_Then_correct  (=> (and ($IsAllocBox ($Box refType this@@0) Tclass.M.Tr? $Heap) (= (ControlFlow 0 2) (- 0 1))) (= this@@0 this@@0))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.M.Tr) ($IsAlloc refType this@@0 Tclass.M.Tr $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
