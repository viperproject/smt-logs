...
(assert (distinct TChar TagChar TagSeq alloc |##_module.Result.Success| Tagclass._module.Result |##_module.Result.Failure| Tagclass._module.Foo? Tagclass._module.Foo tytagFamily$Result tytagFamily$Foo)
)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Foo.FooMethod3)
...
(let ((anon7_Then_correct  (=> (and (= |r#0@0| (|#_module.Result.Failure| |_mcc#1#0|)) ($Is SeqType |_mcc#1#0| (TSeq TChar))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= |_mcc#1#0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 115))) ($Box charType (|char#FromInt| 100)))))) (=> (= |_mcc#1#0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 115))) ($Box charType (|char#FromInt| 100))))) (=> (= (ControlFlow 0 4) 2) anon5_correct))))))
(let ((anon6_Then_correct  (=> (= |r#0@0| (|#_module.Result.Success| ($Box SeqType |_mcc#0#0|))) (=> (and ($Is SeqType |_mcc#0#0| (TSeq TChar)) (= (ControlFlow 0 3) 2)) anon5_correct))))
(let ((anon7_Else_correct true))
(let ((anon6_Else_correct  (=> (or (not (= |r#0@0| (|#_module.Result.Success| ($Box SeqType |_mcc#0#0|)))) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon7_Then_correct) (=> (= (ControlFlow 0 6) 1) anon7_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |gitissue283cdfy.25:10|
 :skolemid |537|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
)) ($HeapSucc $Heap $Heap@0)) (and ($Is DatatypeTypeType |r#0@0| (Tclass._module.Result (TSeq TChar))) ($IsAlloc DatatypeTypeType |r#0@0| (Tclass._module.Result (TSeq TChar)) $Heap@0))) (and (=> (= (ControlFlow 0 7) 3) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Foo) ($IsAlloc refType this Tclass._module.Foo $Heap)))) (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result (TSeq TChar))) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result (TSeq TChar)) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
