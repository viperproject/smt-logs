...
(set-info :boogie-vc-id Impl$$_module.__default.GoodBitvectors)
...
(let ((anon5_Then_correct  (=> (and (= |v#0@1| (U_2_bv8 (Lit bv8Type (bv8_2_U (bvadd #xc8 #x64))))) (= (ControlFlow 0 4) (- 0 3))) (= |v#0@1| (U_2_bv8 (Lit bv8Type (bv8_2_U #x2c)))))))
(let ((anon4_Then_correct  (=> (and (= |v#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U (bvsub #x00 #x03))))) (= (ControlFlow 0 2) (- 0 1))) (= |v#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U #xfd)))))))
