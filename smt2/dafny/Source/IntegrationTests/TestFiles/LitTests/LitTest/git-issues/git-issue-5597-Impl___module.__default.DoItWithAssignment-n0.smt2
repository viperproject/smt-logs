...
(declare-fun |integers00#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.DoItWithAssignment)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) ($Is SetType |numbers#0| (TSet Tclass._module.Integer)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |numbers#0| (TSet Tclass._module.Number)) ($IsAlloc SetType |numbers#0| (TSet Tclass._module.Number) $Heap))) (=> (and (and (and ($Is SetType |integers00#0| (TSet Tclass._module.Integer)) ($IsAlloc SetType |integers00#0| (TSet Tclass._module.Integer) $Heap)) (= 1 $FunctionContextHeight)) (and (= (|Set#Card| |numbers#0|) (LitInt 0)) (= (ControlFlow 0 3) 2))) anon0_correct))))
