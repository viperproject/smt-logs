...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.fNullify_split9)
...
)))) (and (and (and (forall (($o@@26 T@U) ($f@@13 T@U) ) (!  (=> (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@26) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@26) $f@@13)) (and (= $o@@26 |o#0@@12|) (= $f@@13 _module.Object.fields))))
 :qid |gitissue3855dfy.639:57|
 :skolemid |1246|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) $f@@13))
)) ($HeapSucc $Heap@@21 $Heap@0)) (and ($IsAlloc refType this@@53 Tclass._module.Memory $Heap@@21) (forall (($o@@27 T@U) ($f@@14 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (and (= $o@@27 this@@53) (or (= $f@@14 _module.Memory.objects) (= $f@@14 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@27) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@27) $f@@14))))
...
))) (and (or (not (= |o#0@@12| null)) (not true)) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= |o#0@@12| null)) (not true))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
