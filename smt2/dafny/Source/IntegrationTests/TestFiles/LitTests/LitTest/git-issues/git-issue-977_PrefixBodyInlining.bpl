...
axiom {:id "id0"} 1 <= $FunctionContextHeight
   ==> (forall r#0: int :: 
    ...
    PrefixBodyInlining.__default.AAA#canCall(r#0)
         || (1 < $FunctionContextHeight && LitInt(0) <= r#0)
...
axiom 2 <= $FunctionContextHeight
   ==> (forall r#0: int, _k#0: Box :: 
    { PrefixBodyInlining.__default.AAA_h(_k#0, r#0) } 
    LitInt(0) <= r#0 && _k#0 == ORD#FromNat(0)
       ==> PrefixBodyInlining.__default.AAA_h(_k#0, r#0));

procedure {:verboseName "PrefixBodyInlining.AAA (well-formedness)"} CheckWellformed$$PrefixBodyInlining.__default.AAA(r#0: int where LitInt(0) <= r#0);
...
axiom {:id "id2"} 2 <= $FunctionContextHeight
   ==> (forall _k#0: Box, r#0: int :: 
    { PrefixBodyInlining.__default.AAA_h(_k#0, r#0) } 
    PrefixBodyInlining.__default.AAA_h#canCall(_k#0, r#0)
         || (2 < $FunctionContextHeight && LitInt(0) <= r#0)
       ==> (0 < ORD#Offset(_k#0) ==> PrefixBodyInlining.__default.BBB#canCall(r#0))
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#0: Box :: 
            { PrefixBodyInlining.__default.AAA_h(_k'#0, r#0) } 
            ORD#Less(_k'#0, _k#0) ==> PrefixBodyInlining.__default.AAA_h#canCall(_k'#0, r#0)))
         && PrefixBodyInlining.__default.AAA_h(_k#0, r#0)
           == ((0 < ORD#Offset(_k#0) ==> PrefixBodyInlining.__default.BBB(r#0))
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (forall _k'#0: Box :: 
                { PrefixBodyInlining.__default.AAA_h(_k'#0, r#0) } 
                ORD#Less(_k'#0, _k#0) ==> PrefixBodyInlining.__default.AAA_h(_k'#0, r#0)))));
...
axiom {:id "id3"} 2 <= $FunctionContextHeight
   ==> (forall _k#0: Box, r#0: int :: 
    ...
    PrefixBodyInlining.__default.AAA_h#canCall(Lit(_k#0), r#0)
         || (2 < $FunctionContextHeight && LitInt(0) <= r#0)
       ==> (0 < ORD#Offset(_k#0) ==> PrefixBodyInlining.__default.BBB#canCall(r#0))
         && (
          (0 < ORD#Offset(_k#0)
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#1: Box :: 
            { PrefixBodyInlining.__default.AAA_h(_k'#1, r#0) } 
            ORD#Less(_k'#1, _k#0) ==> PrefixBodyInlining.__default.AAA_h#canCall(_k'#1, r#0)))
         && PrefixBodyInlining.__default.AAA_h(Lit(_k#0), r#0)
           == ((0 < ORD#Offset(_k#0) ==> PrefixBodyInlining.__default.BBB(r#0))
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (forall _k'#1: Box :: 
                { PrefixBodyInlining.__default.AAA_h(_k'#1, r#0) } 
                ORD#Less(_k'#1, _k#0) ==> PrefixBodyInlining.__default.AAA_h(_k'#1, r#0)))));
    ...
    PrefixBodyInlining.__default.AAA_h#canCall(Lit(_k#0), LitInt(r#0))
       ...
       ==> (0 < ORD#Offset(_k#0) ==> PrefixBodyInlining.__default.BBB#canCall(LitInt(r#0)))
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
            { PrefixBodyInlining.__default.AAA_h(_k'#2, r#0) } 
            ORD#Less(_k'#2, _k#0) ==> PrefixBodyInlining.__default.AAA_h#canCall(_k'#2, r#0)))
         && PrefixBodyInlining.__default.AAA_h(Lit(_k#0), LitInt(r#0))
           == ((0 < ORD#Offset(_k#0) ==> PrefixBodyInlining.__default.BBB(LitInt(r#0)))
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (forall _k'#2: Box :: 
                { PrefixBodyInlining.__default.AAA_h(_k'#2, r#0) } 
                ORD#Less(_k'#2, _k#0) ==> PrefixBodyInlining.__default.AAA_h(_k'#2, r#0)))));
}
...
// 3rd prefix predicate axiom
axiom 1 <= $FunctionContextHeight
   ==> (forall s#0: int, _k#0: Box :: 
    { PrefixBodyInlining.__default.BBB_h(_k#0, s#0) } 
    LitInt(0) <= s#0 && _k#0 == ORD#FromNat(0)
       ==> PrefixBodyInlining.__default.BBB_h(_k#0, s#0));

procedure {:verboseName "PrefixBodyInlining.BBB (well-formedness)"} CheckWellformed$$PrefixBodyInlining.__default.BBB(s#0: int where LitInt(0) <= s#0);
...
procedure {:verboseName "PrefixBodyInlining.P (well-formedness)"} CheckWellFormed$$PrefixBodyInlining.__default.P(k#0: Box, n#0: int);
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "PrefixBodyInlining.P (call)"} Call$$PrefixBodyInlining.__default.P(k#0: Box, n#0: int);
  // user-defined preconditions
  requires {:id "id7"} (forall t#1: int :: 
    { PrefixBodyInlining.__default.AAA_h(k#0, t#1) } 
    LitInt(0) <= t#1 ==> PrefixBodyInlining.__default.AAA_h(k#0, t#1));
  modifies $Heap;
  // frame condition
...
procedure {:verboseName "PrefixBodyInlining.P (correctness)"} Impl$$PrefixBodyInlining.__default.P(k#0: Box, n#0: int) returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id8"} (forall t#1: int :: 
    { PrefixBodyInlining.__default.AAA_h(k#0, t#1) } 
    LitInt(0) <= t#1 ==> PrefixBodyInlining.__default.AAA_h(k#0, t#1));
  modifies $Heap;
  // frame condition
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrefixBodyInlining.P (correctness)"} Impl$$PrefixBodyInlining.__default.P(k#0: Box, n#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var ##_k#1: Box;
  var ##r#1: int;

    // AddMethodImpl: P, Impl$$PrefixBodyInlining.__default.P
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-977.dfy(220,5)
    ##_k#1 := k#0;
    ...
    ##r#1 := (if n#0 < 0 then 0 else n#0);
    // assume allocatedness for argument to function
    assume $IsAlloc(##r#1, Tclass._System.nat(), $Heap);
    assume PrefixBodyInlining.__default.AAA_h#canCall(k#0, (if n#0 < 0 then 0 else n#0));
    assume PrefixBodyInlining.__default.AAA_h#canCall(k#0, (if n#0 < 0 then 0 else n#0));
    assert {:id "id11"} {:subsumption 0} PrefixBodyInlining.__default.AAA_h#canCall(k#0, (if n#0 < 0 then 0 else n#0))
       ==> PrefixBodyInlining.__default.AAA_h(k#0, (if n#0 < 0 then 0 else n#0));
    assume {:id "id12"} PrefixBodyInlining.__default.AAA_h(k#0, (if n#0 < 0 then 0 else n#0));
}
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int :: 
    ...
    PrefixBodyInlining.__default.UpIList#canCall(n#0) || 1 < $FunctionContextHeight
...
procedure {:verboseName "PrefixBodyInlining.UpIList (well-formedness)"} CheckWellformed$$PrefixBodyInlining.__default.UpIList(n#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id15"} 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, s#0: DatatypeType :: 
    ...
    PrefixBodyInlining.__default.Pos#canCall(s#0)
         || (1 < $FunctionContextHeight && $Is(s#0, Tclass.PrefixBodyInlining.IList()))
...
procedure {:verboseName "PrefixBodyInlining.Pos (well-formedness)"} CheckWellformed$$PrefixBodyInlining.__default.Pos(s#0: DatatypeType where $Is(s#0, Tclass.PrefixBodyInlining.IList()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id17"} 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, _k#0: Box, s#0: DatatypeType :: 
    ...
    PrefixBodyInlining.__default.Pos_h#canCall(_k#0, s#0)
         || (2 < $FunctionContextHeight && $Is(s#0, Tclass.PrefixBodyInlining.IList()))
       ==> (0 < ORD#Offset(_k#0)
           ==> PrefixBodyInlining.IList.ICons_q(s#0)
             && (PrefixBodyInlining.IList.head(s#0) > 0
               ==> PrefixBodyInlining.IList.ICons_q(s#0)
         ...
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#0: Box :: 
            { PrefixBodyInlining.__default.Pos_h($ly, _k'#0, s#0) } 
            ORD#Less(_k'#0, _k#0) ==> PrefixBodyInlining.__default.Pos_h#canCall(_k'#0, s#0)))
         && PrefixBodyInlining.__default.Pos_h($LS($ly), _k#0, s#0)
           == ((0 < ORD#Offset(_k#0)
               ==> PrefixBodyInlining.IList.head(s#0) > 0
                 && PrefixBodyInlining.__default.Pos_h($ly, ORD#Minus(_k#0, ORD#FromNat(1)), PrefixBodyInlining.IList.tail(s#0)))
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (forall _k'#0: Box :: 
                { PrefixBodyInlining.__default.Pos_h($ly, _k'#0, s#0) } 
                ORD#Less(_k'#0, _k#0) ==> PrefixBodyInlining.__default.Pos_h($ly, _k'#0, s#0)))));
    ...
    PrefixBodyInlining.__default.Pos_h#canCall(Lit(_k#0), s#0)
       ...
       ==> (0 < ORD#Offset(_k#0)
         ...
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#1: Box :: 
            { PrefixBodyInlining.__default.Pos_h($LS($ly), _k'#1, s#0) } 
            ORD#Less(_k'#1, _k#0) ==> PrefixBodyInlining.__default.Pos_h#canCall(_k'#1, s#0)))
    ...
    PrefixBodyInlining.__default.Pos_h#canCall(Lit(_k#0), Lit(s#0))
       ...
       ==> (0 < ORD#Offset(_k#0)
         ...
         && (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
            { PrefixBodyInlining.__default.Pos_h($LS($ly), _k'#2, s#0) } 
            ORD#Less(_k'#2, _k#0) ==> PrefixBodyInlining.__default.Pos_h#canCall(_k'#2, s#0)))
...
procedure {:verboseName "PrefixBodyInlining.Theorem2 (well-formedness)"} CheckWellFormed$$PrefixBodyInlining.__default.Theorem2(n#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "PrefixBodyInlining.Theorem2 (call)"} Call$$PrefixBodyInlining.__default.Theorem2(n#0: int);
  // user-defined preconditions
  requires {:id "id22"} LitInt(1) <= n#0;
  modifies $Heap;
  // user-defined postconditions
  free ensures PrefixBodyInlining.__default.UpIList#canCall(n#0)
     && PrefixBodyInlining.__default.Pos#canCall(PrefixBodyInlining.__default.UpIList($LS($LZ), n#0));
  free ensures {:id "id23"} PrefixBodyInlining.__default.Pos#canCall(PrefixBodyInlining.__default.UpIList($LS($LZ), n#0))
     && 
    PrefixBodyInlining.__default.Pos($LS($LZ), PrefixBodyInlining.__default.UpIList($LS($LZ), n#0))
     && 
    PrefixBodyInlining.IList.head(PrefixBodyInlining.__default.UpIList($LS($LZ), n#0))
       > 0
     && PrefixBodyInlining.__default.Pos($LS($LZ), 
      PrefixBodyInlining.IList.tail(PrefixBodyInlining.__default.UpIList($LS($LZ), n#0)));
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "PrefixBodyInlining.Theorem2# (co-call)"} CoCall$$PrefixBodyInlining.__default.Theorem2_h(_k#0: Box, n#1: int);
  // user-defined preconditions
  requires {:id "id24"} LitInt(1) <= n#1;
  modifies $Heap;
  // user-defined postconditions
  free ensures PrefixBodyInlining.__default.UpIList#canCall(n#1)
     && PrefixBodyInlining.__default.Pos_h#canCall(_k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1));
  free ensures {:id "id25"} PrefixBodyInlining.__default.Pos_h#canCall(_k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
     && 
    PrefixBodyInlining.__default.Pos_h($LS($LZ), _k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
     && 
    (0 < ORD#Offset(_k#0)
       ==> PrefixBodyInlining.IList.head(PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
           > 0
         && PrefixBodyInlining.__default.Pos_h($LS($LZ), 
          ORD#Minus(_k#0, ORD#FromNat(1)), 
          PrefixBodyInlining.IList.tail(PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))))
     && (LitInt(0) == ORD#Offset(_k#0)
       ==> (forall _k'#0: Box :: 
        { PrefixBodyInlining.__default.Pos_h($LS($LZ), _k'#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1)) } 
        ORD#Less(_k'#0, _k#0)
...
procedure {:verboseName "PrefixBodyInlining.Theorem2# (correctness)"} Impl$$PrefixBodyInlining.__default.Theorem2_h(_k#0: Box, n#1: int) returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id26"} LitInt(1) <= n#1;
  modifies $Heap;
  // user-defined postconditions
  free ensures PrefixBodyInlining.__default.UpIList#canCall(n#1)
     && PrefixBodyInlining.__default.Pos_h#canCall(_k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1));
  ensures {:id "id27"} PrefixBodyInlining.__default.Pos_h#canCall(_k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
     ==> PrefixBodyInlining.__default.Pos_h($LS($LZ), _k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
       || (0 < ORD#Offset(_k#0)
         ==> PrefixBodyInlining.IList.head(PrefixBodyInlining.__default.UpIList($LS($LS($LZ)), n#1))
           > 0);
  ensures {:id "id28"} PrefixBodyInlining.__default.Pos_h#canCall(_k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
     ==> PrefixBodyInlining.__default.Pos_h($LS($LZ), _k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
       || (0 < ORD#Offset(_k#0)
         ==> PrefixBodyInlining.__default.Pos_h($LS($LS($LZ)), 
          ORD#Minus(_k#0, ORD#FromNat(1)), 
          PrefixBodyInlining.IList.tail(PrefixBodyInlining.__default.UpIList($LS($LS($LZ)), n#1))));
  ensures {:id "id29"} PrefixBodyInlining.__default.Pos_h#canCall(_k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
     ==> PrefixBodyInlining.__default.Pos_h($LS($LZ), _k#0, PrefixBodyInlining.__default.UpIList($LS($LZ), n#1))
       || (LitInt(0) == ORD#Offset(_k#0)
         ==> (forall _k'#1: Box :: 
          { PrefixBodyInlining.__default.Pos_h($LS($LS($LZ)), _k'#1, PrefixBodyInlining.__default.UpIList($LS($LS($LZ)), n#1)) } 
          ORD#Less(_k'#1, _k#0)
             ==> PrefixBodyInlining.__default.Pos_h($LS($LS($LZ)), _k'#1, PrefixBodyInlining.__default.UpIList($LS($LS($LZ)), n#1))));
  // frame condition
  free ensures old($Heap) == $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "PrefixBodyInlining.Theorem2# (correctness)"} Impl$$PrefixBodyInlining.__default.Theorem2_h(_k#0: Box, n#1: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var _k##0: Box;
  var n##0: int;
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    // AddMethodImpl: Theorem2#, Impl$$PrefixBodyInlining.__default.Theorem2_h
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-977.dfy(240,3)
    assume true;
    if (0 < ORD#Offset(_k#0))
    {
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-977.dfy(241,13)
        // TrCallStmt: Before ProcessCallStmt
        assert {:id "id30"} ORD#IsNat(Lit(ORD#FromNat(1)));
        assert {:id "id31"} ORD#Offset(Lit(ORD#FromNat(1))) <= ORD#Offset(_k#0);
        assume true;
        ...
        // ProcessCallStmt: CheckSubrange
        n##0 := n#1 + 1;
        call {:id "id32"} CoCall$$PrefixBodyInlining.__default.Theorem2_h(_k##0, n##0);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-977.dfy(240,3)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#2: Box, n#2: int :: 
          { PrefixBodyInlining.__default.UpIList($LS($LZ), n#2), ORD#Less(_k'#2, _k#0) } 
          ORD#Less(_k'#2, _k#0) && LitInt(1) <= n#2
             ==> PrefixBodyInlining.__default.Pos_h($LS($LZ), _k'#2, PrefixBodyInlining.__default.UpIList($LS($LZ), n#2)));
    }
}
