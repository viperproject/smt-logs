...
(assert ($Is intType (int_2_U B.__default.a) TInt))
...
(set-info :boogie-vc-id Impl$$D.__default.m)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= B.__default.a (LitInt 10)))))
