...
(assert (distinct TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass.OtherBindersInStatements.C Tagclass.OtherBindersInStatements.C? tytagFamily$object tytagFamily$C)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3|) |$y#0|))  (and (and ($IsBox |$y#0| |l#0|) ($IsAllocBox |$y#0| |l#1| |l#2|)) |l#3|))
 :pattern ( (MapType0Select BoxType boolType (|lambda#4| |l#0| |l#1| |l#2| |l#3|) |$y#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@3) |l#2@@0|)))) |l#3@@0|))
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@3 $f))
)))
...
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 Tclass.OtherBindersInStatements.C?) ($IsBox bx@@8 Tclass._System.object?))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct  (=> (and (= |b#0@0| (|Set#FromBoogieMap| (|lambda#4| Tclass.OtherBindersInStatements.C Tclass.OtherBindersInStatements.C $Heap (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SetType |b#0| (TSet Tclass.OtherBindersInStatements.C)) ($IsAlloc SetType |b#0| (TSet Tclass.OtherBindersInStatements.C) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
