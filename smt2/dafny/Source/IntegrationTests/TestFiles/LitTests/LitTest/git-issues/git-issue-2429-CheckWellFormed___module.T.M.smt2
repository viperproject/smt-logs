...
(assert (distinct TagSeq alloc Tagclass._module.T? Tagclass._module.T tytagFamily$T)
)
...
(assert (forall ((_module.T$A@@0 T@U) ($o T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o (Tclass._module.T? _module.T$A@@0) $h@@0)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |487|
 :pattern ( ($IsAlloc refType $o (Tclass._module.T? _module.T$A@@0) $h@@0))
)))
...
(assert (forall ((_module.T$A@@1 T@U) (|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| (Tclass._module.T _module.T$A@@1))  (and ($Is refType |c#0@@0| (Tclass._module.T? _module.T$A@@1)) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( ($Is refType |c#0@@0| (Tclass._module.T _module.T$A@@1)))
 :pattern ( ($Is refType |c#0@@0| (Tclass._module.T? _module.T$A@@1)))
)))
...
(assert (forall ((_module.T$A@@6 T@U) ($o@@0 T@U) ) (! (= ($Is refType $o@@0 (Tclass._module.T? _module.T$A@@6))  (or (= $o@@0 null) (implements$_module.T (dtype $o@@0) _module.T$A@@6)))
 :qid |unknown.0:0|
 :skolemid |486|
 :pattern ( ($Is refType $o@@0 (Tclass._module.T? _module.T$A@@6)))
)))
...
(assert (forall ((_module.T$A@@7 T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass._module.T? _module.T$A@@7)) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) (Tclass._module.T? _module.T$A@@7))))
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( ($IsBox bx@@2 (Tclass._module.T? _module.T$A@@7)))
)))
(assert (forall ((_module.T$A@@8 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.T _module.T$A@@8)) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) (Tclass._module.T _module.T$A@@8))))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($IsBox bx@@3 (Tclass._module.T _module.T$A@@8)))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@1) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@1))))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.T.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon7_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)) (|Set#IsMember| (ite (_module.__default.P _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this))) ($Box refType $o@@2))))
 :qid |gitissue2429dfy.7:10|
 :skolemid |491|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
))) (and ($HeapSucc $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| |a#0|)))))))
(let ((anon9_Else_correct  (=> (and (not (_module.__default.P _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|))) (= (ControlFlow 0 4) 2)) anon7_correct)))
(let ((anon9_Then_correct  (=> (and (_module.__default.P _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)) (= (ControlFlow 0 3) 2)) anon7_correct)))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| |a#0|))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| |a#0|)))) (=> (= |##s#2@0| (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)) (=> (and ($IsAlloc SeqType |##s#2@0| (TSeq _module.T$A@@9) $Heap) (|_module.__default.P#canCall| _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|))) (and (=> (= (ControlFlow 0 5) 3) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))))
(let ((anon8_Else_correct  (=> (and (not (_module.__default.P _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|))) (= (ControlFlow 0 8) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (_module.__default.P _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)) (= (ControlFlow 0 7) 5)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc (ite (_module.__default.P _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| |a#0|))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| |a#0|)))) (=> (and (and (= |##s#0@0| (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)) ($IsAlloc SeqType |##s#0@0| (TSeq _module.T$A@@9) $Heap)) (and (|_module.__default.Q#canCall| _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)) (_module.__default.Q _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| |a#0|))))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| |a#0|)))) (=> (= |##s#1@0| (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|)) (=> (and ($IsAlloc SeqType |##s#1@0| (TSeq _module.T$A@@9) $Heap) (|_module.__default.P#canCall| _module.T$A@@9 (|Seq#Update| (|Seq#Build| |Seq#Empty| |a#0|) (LitInt 0) |a#0|))) (and (=> (= (ControlFlow 0 9) 7) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.T _module.T$A@@9)) ($IsAlloc refType this (Tclass._module.T _module.T$A@@9) $Heap)))) (and (and ($IsBox |a#0| _module.T$A@@9) ($IsAllocBox |a#0| _module.T$A@@9 $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 12) 9)))) anon0_correct)))
