...
(assert (forall ((v@@7 T@U) (t0@@1 T@U) ) (! (= ($Is SeqType v@@7 (TSeq t0@@1)) (forall ((i@@3 Int) ) (!  (=> (and (<= 0 i@@3) (< i@@3 (|Seq#Length| v@@7))) ($IsBox (|Seq#Index| v@@7 i@@3) t0@@1))
 ...
 :skolemid |54|
 :pattern ( ($Is SeqType v@@7 (TSeq t0@@1)))
)))
(push 1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (and (= _module.T$A@@9 Tclass._System.object) (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|)))) (=> (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) (=> (|_module.__default.P#canCall| Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) 3 2) (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) 3 4))) (=> (<= (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) 3 2) (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) 3 4)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@7 T@U) ($f T@U) ) (! true
 :qid |gitissue2429dfy.24:10|
 :skolemid |506|
))) (=> (forall (($o@@8 T@U) ($f@@0 T@U) ) (! true
 :qid |gitissue2429dfy.24:10|
 :skolemid |506|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9) alloc)))) (|Set#IsMember| (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this))) ($Box refType $o@@9))) (|Set#IsMember| (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this))) ($Box refType $o@@9)))
 :qid |gitissue2429dfy.24:10|
 :skolemid |507|
))) (=> (forall (($o@@10 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10) alloc)))) (|Set#IsMember| (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this))) ($Box refType $o@@10))) (|Set#IsMember| (ite (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this))) ($Box refType $o@@10)))
 :qid |gitissue2429dfy.24:10|
 :skolemid |507|
)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@11) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@11)) (|Set#IsMember| (ite (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType this))) ($Box refType $o@@11))))
 :qid |gitissue2429dfy.24:10|
 :skolemid |508|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@11))
)) ($HeapSucc $Heap $Heap@0)) (and (_module.__default.Q Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|))) (= (ControlFlow 0 2) (- 0 1)))) (_module.__default.P Tclass._System.object (|Seq#Update| (|Seq#Build| |Seq#Empty| ($Box refType |a#0|)) (LitInt 0) ($Box refType |a#0|)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap)))) (and (and ($Is refType |a#0| Tclass._System.object) ($IsAlloc refType |a#0| Tclass._System.object $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct)))
