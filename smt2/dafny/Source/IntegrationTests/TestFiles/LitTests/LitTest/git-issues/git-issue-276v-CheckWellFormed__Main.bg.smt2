...
(set-info :boogie-vc-id CheckWellFormed$$Main.bg)
...
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |x#0|) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= 0 (LitInt 4))) (=> (<= 0 (LitInt 4)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= (LitInt 4) 8)) (=> (<= (LitInt 4) 8) (=> (= (ControlFlow 0 5) 4) anon4_correct))))))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (nat_from_bv8 (bvshl Main.__default.a #x04)))))))
