...
(set-info :boogie-vc-id CheckWellformed$$_module.Cl.ActuallyTrue)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (_module.Cl.ActuallyTrue this@@2))))
(let ((anon5_Else_correct  (=> (= (_module.Cl.ActuallyTrue this@@2) (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and ($Is boolType (bool_2_U (_module.Cl.ActuallyTrue this@@2)) TBool) (= (ControlFlow 0 5) 4)) GeneratedUnifiedExit_correct))))
