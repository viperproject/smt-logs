...
(set-info :boogie-vc-id Impl$$M2.__default.Test1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($Is intType (int_2_U (LitInt 1)) Tclass.M2.int1)) (=> ($Is intType (int_2_U (LitInt 1)) Tclass.M2.int1) (=> (= |s1#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is intType (int_2_U (LitInt 0)) Tclass.M2.int0)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass.M2.int0) (=> (= |s0#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is SeqType (|Seq#Append| |s1#0@0| |s0#0@0|) (TSeq Tclass.M2.int1))) (=> ($Is SeqType (|Seq#Append| |s1#0@0| |s0#0@0|) (TSeq Tclass.M2.int1)) (=> (and (= |s1or0#0@0| (|Seq#Append| |s1#0@0| |s0#0@0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s1or0#0@0|)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is SeqType |s1#0| (TSeq Tclass.M2.int1)) ($IsAlloc SeqType |s1#0| (TSeq Tclass.M2.int1) $Heap)) true) (and (and ($Is SeqType |s0#0| (TSeq Tclass.M2.int0)) ($IsAlloc SeqType |s0#0| (TSeq Tclass.M2.int0) $Heap)) true)) (and (and (and ($Is SeqType |s1or0#0| (TSeq Tclass.M2.int1)) ($IsAlloc SeqType |s1or0#0| (TSeq Tclass.M2.int1) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
