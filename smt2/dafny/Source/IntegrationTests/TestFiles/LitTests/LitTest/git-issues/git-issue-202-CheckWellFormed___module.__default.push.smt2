...
(declare-fun |new_sequence#0@0| () T@U)
(declare-fun _module._default.push$T () T@U)
(declare-fun |sequence#0| () T@U)
(declare-fun |element#0| () T@U)
(declare-fun |new_sequence#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.push)
...
(assert (not
 ...
 :qid |gitissue202dfy.4:8|
 :skolemid |479|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is SeqType |new_sequence#0@0| (TSeq _module._default.push$T)) ($IsAlloc SeqType |new_sequence#0@0| (TSeq _module._default.push$T) $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (and (<= 0 (- (|Seq#Length| |new_sequence#0@0|) 1)) (<= (- (|Seq#Length| |new_sequence#0@0|) 1) (|Seq#Length| |new_sequence#0@0|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |sequence#0| (TSeq _module._default.push$T)) ($IsAlloc SeqType |sequence#0| (TSeq _module._default.push$T) $Heap)) (and ($IsBox |element#0| _module._default.push$T) ($IsAllocBox |element#0| _module._default.push$T $Heap))) (and (and ($Is SeqType |new_sequence#0| (TSeq _module._default.push$T)) ($IsAlloc SeqType |new_sequence#0| (TSeq _module._default.push$T) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
