...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (Div |n#0_0@0| (LitInt 0)) (Div |n#0_0@0| (LitInt 0)))) (=> (= (Div |n#0_0@0| (LitInt 0)) (Div |n#0_0@0| (LitInt 0))) (=> (= (ControlFlow 0 11) (- 0 10)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#0|))))))))))))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 9)) (or (not (= (LitInt 0) 0)) (not true))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (or (not (= (LitInt 0) 0)) (not true))) (=> (= (Div |n#0_0@0| (LitInt 0)) (Div |n#0_0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 4) (- 0 3)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|))))))))))))))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |n#0_0@0|) (< |n#0_0@0| 100)) (and (=> (= (ControlFlow 0 14) 4) anon10_Then_correct) (=> (= (ControlFlow 0 14) 11) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (< |n#0_0@0| (LitInt 0)) (= (ControlFlow 0 16) 14)) anon3_correct)))
(let ((anon9_Then_correct  (=> (and (<= (LitInt 0) |n#0_0@0|) (= (ControlFlow 0 15) 14)) anon3_correct)))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 17) 15) anon9_Then_correct) (=> (= (ControlFlow 0 17) 16) anon9_Else_correct))))
(let ((anon8_Else_correct  (=> (and (forall ((|n#0_1| Int) ) (!  (=> (and (<= (LitInt 0) |n#0_1|) (< |n#0_1| 100)) (and (= (Div |n#0_1| (LitInt 0)) (Div |n#0_1| (LitInt 0))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |j#0|)))))))
 :qid |gitissue2605dfy.5:10|
 :skolemid |482|
 :pattern ( (Div |n#0_1| 0))
)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U false))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 18) 17) anon8_Then_correct) (=> (= (ControlFlow 0 18) 2) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
