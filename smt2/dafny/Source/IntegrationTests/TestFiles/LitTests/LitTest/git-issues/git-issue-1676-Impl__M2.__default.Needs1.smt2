...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@96  (=> (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@92 0)) (not true)))))
(let (($generated@@97  (=> (and (and (and ($generated@@93 $generated@@90) ($generated@@94 $generated@@90)) (= $generated@@92 ($generated 1))) (and (= 1 $generated@@95) (= (ControlFlow 0 3) 2))) $generated@@96)))
$generated@@97)))
))
(check-sat)
(get-info :rlimit)
