...
(let ((anon11_Else_correct  (=> (and (< (|char#ToInt| Main.__default.c) (|char#ToInt| (Lit charType (|char#FromInt| 97)))) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (<= (|char#ToInt| (Lit charType (|char#FromInt| 97))) (|char#ToInt| Main.__default.c)) (= (ControlFlow 0 6) 4)) anon6_correct)))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite (<= (|char#ToInt| (Lit charType (|char#FromInt| 97))) (|char#ToInt| Main.__default.c)) 30 40))))))
