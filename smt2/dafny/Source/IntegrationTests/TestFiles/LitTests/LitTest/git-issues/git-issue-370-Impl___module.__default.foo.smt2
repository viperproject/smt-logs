...
(assert (forall ((d@@4 T@U) ) (!  (=> (_module.S.S_q d@@4) (exists ((|a#6#0#0| Int) (|a#6#1#0| Int) (|a#6#2#0| Int) (|a#6#3#0| Int) (|a#6#4#0| Int) (|a#6#5#0| Int) ) (! (= d@@4 (|#_module.S.S| |a#6#0#0| |a#6#1#0| |a#6#2#0| |a#6#3#0| |a#6#4#0| |a#6#5#0|))
 :qid |gitissue370dfy.14:16|
 :skolemid |514|
)))
 :qid |unknown.0:0|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) reveal__module._default.GetT)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (let ((|t#0@@4| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.WellFormed#canCall| |t#0@@4|) (or (_module.__default.WellFormed |t#0@@4|) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (let ((|t#0@@5| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.WellFormed#canCall| |t#0@@5|) (or (_module.__default.WellFormed |t#0@@5|) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (let ((|t#0@@6| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.WellFormed#canCall| |t#0@@6|) (or (_module.__default.WellFormed |t#0@@6|) (_module.__default.a |t#0@@6|))))) (=> (let ((|t#0@@7| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.WellFormed#canCall| |t#0@@7|) (or (_module.__default.WellFormed |t#0@@7|) (_module.__default.a |t#0@@7|)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (let ((|t#0@@8| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@8|)) (or (_module.__default.Good (_module.__default.Func |t#0@@8|)) (= (_module.S.u (_module.__default.Func |t#0@@8|)) (LitInt 5)))))) (=> (let ((|t#0@@9| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@9|)) (or (_module.__default.Good (_module.__default.Func |t#0@@9|)) (= (_module.S.u (_module.__default.Func |t#0@@9|)) (LitInt 5))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (let ((|t#0@@10| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@10|)) (or (_module.__default.Good (_module.__default.Func |t#0@@10|)) (= (_module.S.v (_module.__default.Func |t#0@@10|)) (LitInt 5)))))) (=> (let ((|t#0@@11| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@11|)) (or (_module.__default.Good (_module.__default.Func |t#0@@11|)) (= (_module.S.v (_module.__default.Func |t#0@@11|)) (LitInt 5))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (let ((|t#0@@12| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@12|)) (or (_module.__default.Good (_module.__default.Func |t#0@@12|)) (= (_module.S.w (_module.__default.Func |t#0@@12|)) (LitInt 5)))))) (=> (let ((|t#0@@13| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@13|)) (or (_module.__default.Good (_module.__default.Func |t#0@@13|)) (= (_module.S.w (_module.__default.Func |t#0@@13|)) (LitInt 5))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (let ((|t#0@@14| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@14|)) (or (_module.__default.Good (_module.__default.Func |t#0@@14|)) (= (_module.S.x (_module.__default.Func |t#0@@14|)) (LitInt 5)))))) (=> (let ((|t#0@@15| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@15|)) (or (_module.__default.Good (_module.__default.Func |t#0@@15|)) (= (_module.S.x (_module.__default.Func |t#0@@15|)) (LitInt 5))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (let ((|t#0@@16| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@16|)) (or (_module.__default.Good (_module.__default.Func |t#0@@16|)) (= (_module.S.y (_module.__default.Func |t#0@@16|)) (LitInt 5)))))) (=> (let ((|t#0@@17| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@17|)) (or (_module.__default.Good (_module.__default.Func |t#0@@17|)) (= (_module.S.y (_module.__default.Func |t#0@@17|)) (LitInt 5))))) (=> (= (ControlFlow 0 2) (- 0 1)) (let ((|t#0@@18| (_module.__default.GetT reveal__module._default.GetT)))
 (=> (|_module.__default.Good#canCall| (_module.__default.Func |t#0@@18|)) (or (_module.__default.Good (_module.__default.Func |t#0@@18|)) (= (_module.S.z (_module.__default.Func |t#0@@18|)) (LitInt 5))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 10) 2))) anon0_correct)))
