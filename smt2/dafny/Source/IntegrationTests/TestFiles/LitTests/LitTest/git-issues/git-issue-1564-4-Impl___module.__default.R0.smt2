...
(declare-fun |_module.__default.R0#canCall| () Bool)
(declare-fun _module.__default.R0 () Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.R0#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.R0 (U_2_bool (Lit boolType (bool_2_U true)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.R0#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.R0 (U_2_bool (Lit boolType (bool_2_U true)))))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |#result#0@0| (U_2_bool (Lit boolType (bool_2_U true))))) (and |_module.__default.R0#canCall| (= (ControlFlow 0 2) (- 0 1)))) (= |#result#0@0| (U_2_bool (Lit boolType (bool_2_U _module.__default.R0)))))))
