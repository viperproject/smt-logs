...
(let ((anon11_Then_correct  (=> (and ($IsAlloc intType (int_2_U |x#0_0@0|) TInt $Heap) (|CompilableExpressions.__default.P#canCall| |x#0_0@0|)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#0_1| Int) ) (CompilableExpressions.__default.P |x#0_1|)))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#0_1@@0| Int) ) (CompilableExpressions.__default.P |x#0_1@@0|))) (=> (CompilableExpressions.__default.P |x#0_0@0|) (=> (and (|CompilableExpressions.__default.P#canCall| |x#0_2@0|) (CompilableExpressions.__default.P |x#0_2@0|)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= |x#0_0@0| |x#0_2@0|)) (=> (= |x#0_0@0| |x#0_2@0|) (=> |$let#8$canCall| (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))))))))
