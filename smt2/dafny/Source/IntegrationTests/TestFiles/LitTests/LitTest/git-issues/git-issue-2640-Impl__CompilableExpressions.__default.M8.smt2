...
(assert  (=> |$let#8$canCall| (CompilableExpressions.__default.P |$let#8_x|)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@2 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#8| |l#0| |l#1| |l#2| |l#3|) $o@@2 $f))  (=> (and (or (not (= $o@@2 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@2) |l#2|)))) (= $o@@2 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |561|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#8| |l#0| |l#1| |l#2| |l#3|) $o@@2 $f))
)))
...
(declare-fun |y#0| () Int)
(set-info :boogie-vc-id Impl$$CompilableExpressions.__default.M8)
...
(let ((anon7_correct  (=> (=> (<= (LitInt 0) |i#0_0@0|) |$let#8$canCall|) (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (ite (= (let ((|x#0_3| |$let#8_x|))
|x#0_3|) (LitInt 0)) (_System.array.Length |a#0|) 0))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |i#0_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |i#0_0@0|))) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (ite (= (let ((|x#0_4| |$let#8_x|))
|x#0_4|) (LitInt 0)) (_System.array.Length |a#0|) 0))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 3) (- 0 2)))) (or (or (or (not (= |a#0| |a#0|)) (not true)) (or (not (= (IndexField |i#0_0@0|) (IndexField |i#0_1@0|))) (not true))) (= (LitInt 0) (LitInt 0)))))))))))))
(let ((anon12_Else_correct  (=> (and (or (not (= (let ((|x#0_3@@0| |$let#8_x|))
|x#0_3@@0|) (LitInt 0))) (not true)) (= (ControlFlow 0 11) 3)) anon7_correct)))
(let ((anon12_Then_correct  (=> (= (let ((|x#0_3@@1| |$let#8_x|))
|x#0_3@@1|) (LitInt 0)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 9) 3) anon7_correct)))))
(let ((anon11_Then_correct  (=> (and ($IsAlloc intType (int_2_U |x#0_0@0|) TInt $Heap) (|CompilableExpressions.__default.P#canCall| |x#0_0@0|)) (and (=> (= (ControlFlow 0 12) (- 0 14)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#0_1| Int) ) (! (CompilableExpressions.__default.P |x#0_1|)
 :qid |gitissue2640dfy.82:33|
 :skolemid |524|
)))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#0_1@@0| Int) ) (! (CompilableExpressions.__default.P |x#0_1@@0|)
 :qid |gitissue2640dfy.82:33|
 :skolemid |524|
))) (=> (CompilableExpressions.__default.P |x#0_0@0|) (=> (and (|CompilableExpressions.__default.P#canCall| |x#0_2@0|) (CompilableExpressions.__default.P |x#0_2@0|)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (= |x#0_0@0| |x#0_2@0|)) (=> (= |x#0_0@0| |x#0_2@0|) (=> |$let#8$canCall| (and (=> (= (ControlFlow 0 12) 9) anon12_Then_correct) (=> (= (ControlFlow 0 12) 11) anon12_Else_correct))))))))))))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 15) 12) anon11_Then_correct) (=> (= (ControlFlow 0 15) 8) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 7) 3)) anon7_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 16) 15) anon10_Then_correct) (=> (= (ControlFlow 0 16) 7) anon10_Else_correct))))
(let ((anon9_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#8| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 17) 16) anon9_Then_correct) (=> (= (ControlFlow 0 17) 1) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (= 1 $FunctionContextHeight)) (and (CompilableExpressions.__default.P |y#0|) (= (ControlFlow 0 18) 17))) anon0_correct))))
