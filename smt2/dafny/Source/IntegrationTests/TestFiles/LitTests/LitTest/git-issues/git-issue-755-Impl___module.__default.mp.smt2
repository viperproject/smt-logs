...
(assert (forall ((m@@13 T@U) ) (!  (or (= m@@13 |Map#Empty|) (exists ((k@@3 T@U) (v@@9 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@13) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@3 v@@9)))
...
(declare-fun |items#0@1| () T@U)
(declare-fun |item#0_0@1| () T@U)
(declare-fun $Heap () T@U)
(declare-fun |items#0@2| () T@U)
(declare-fun |$decr$loop#00@1| () Int)
(declare-fun |item#0_1@1| () T@U)
(declare-fun |$w$loop#0@0| () Bool)
(declare-fun |item#0_0@0| () T@U)
(declare-fun null () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun |$decr_init$loop#00@0| () Int)
(declare-fun |items#0@0| () T@U)
(declare-fun |m#0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |items#0| () T@U)
(declare-fun |item#0_0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (exists ((|$as#item0_0#0_0| T@U) ) (!  (and ($Is DatatypeTypeType |$as#item0_0#0_0| (Tclass._System.Tuple2 TInt TInt)) (|Set#IsMember| |items#0@1| ($Box DatatypeTypeType |$as#item0_0#0_0|)))
 :qid |gitissue755dfy.33:9|
 :skolemid |495|
))) (=> (exists ((|$as#item0_0#0_0@@0| T@U) ) (!  (and ($Is DatatypeTypeType |$as#item0_0#0_0@@0| (Tclass._System.Tuple2 TInt TInt)) (|Set#IsMember| |items#0@1| ($Box DatatypeTypeType |$as#item0_0#0_0@@0|)))
 :qid |gitissue755dfy.33:9|
 :skolemid |495|
)) (=> (and (and (and ($Is DatatypeTypeType |item#0_0@1| (Tclass._System.Tuple2 TInt TInt)) ($IsAlloc DatatypeTypeType |item#0_0@1| (Tclass._System.Tuple2 TInt TInt) $Heap)) (and (|Set#IsMember| |items#0@1| ($Box DatatypeTypeType |item#0_0@1|)) (= |items#0@2| (|Set#Difference| |items#0@1| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType |item#0_0@1|)))))) (and (and (_System.Tuple2.___hMake2_q |item#0_0@1|) (_System.Tuple2.___hMake2_q |item#0_0@1|)) (and (_System.Tuple2.___hMake2_q |item#0_0@1|) (_System.Tuple2.___hMake2_q |item#0_0@1|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| |items#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| |items#0@2|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (|Set#Card| |items#0@2|) |$decr$loop#00@1|)))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |item#0_1@1| (Tclass._System.Tuple2 TInt TInt)) ($IsAlloc DatatypeTypeType |item#0_1@1| (Tclass._System.Tuple2 TInt TInt) $Heap))) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($Is DatatypeTypeType |item#0_1@1| (Tclass._System.Tuple2 TInt TInt)) ($IsAlloc DatatypeTypeType |item#0_1@1| (Tclass._System.Tuple2 TInt TInt) $Heap)) (= (ControlFlow 0 8) 5)) anon7_correct)))
(let ((anon10_Else_correct  (=> (and (not (|Set#Equal| |items#0@1| |Set#Empty|)) (= |$decr$loop#00@1| (|Set#Card| |items#0@1|))) (and (=> (= (ControlFlow 0 10) 8) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
...
(let ((anon8_LoopHead_correct  (=> (and ($Is DatatypeTypeType |item#0_0@0| (Tclass._System.Tuple2 TInt TInt)) ($IsAlloc DatatypeTypeType |item#0_0@0| (Tclass._System.Tuple2 TInt TInt) $Heap)) (=> (and (and (and ($Is SetType |items#0@1| (TSet (Tclass._System.Tuple2 TInt TInt))) ($IsAlloc SetType |items#0@1| (TSet (Tclass._System.Tuple2 TInt TInt)) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |gitissue755dfy.30:3|
 :skolemid |493|
...
)) (<= (|Set#Card| |items#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 13) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 13) 12) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |items#0@0| (|Map#Items| |m#0|))) (and (= |$decr_init$loop#00@0| (|Set#Card| |items#0@0|)) (= (ControlFlow 0 14) 13))) anon8_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |m#0| (TMap TInt TInt)) ($IsAlloc MapType |m#0| (TMap TInt TInt) $Heap))) (and (and ($Is SetType |items#0| (TSet (Tclass._System.Tuple2 TInt TInt))) ($IsAlloc SetType |items#0| (TSet (Tclass._System.Tuple2 TInt TInt)) $Heap)) true)) (and (and (and ($Is DatatypeTypeType |item#0_0| (Tclass._System.Tuple2 TInt TInt)) ($IsAlloc DatatypeTypeType |item#0_0| (Tclass._System.Tuple2 TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 15) 14)))) anon0_correct)))
