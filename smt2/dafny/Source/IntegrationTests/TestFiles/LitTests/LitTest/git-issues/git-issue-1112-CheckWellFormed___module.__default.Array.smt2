...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass._module.D? Tagclass._module.D tytagFamily$array tytagFamily$D)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Array)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |arr#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |arr#0| null)) (not true))) (=> (or (not (= |arr#0| null)) (not true)) (=> (< |i#0| (_System.array.Length |arr#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |arr#0| null)) (not true))) (=> (or (not (= |arr#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 |i#0|) (< |i#0| (_System.array.Length |arr#0|))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |arr#0| (Tclass._System.array Tclass._module.D?)) ($IsAlloc refType |arr#0| (Tclass._System.array Tclass._module.D?) $Heap)) (<= (LitInt 0) |i#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
