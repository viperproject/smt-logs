...
(assert (distinct alloc Tagclass._System.object? Tagclass._System.object Tagclass.OtherBindersInStatements.C Tagclass.OtherBindersInStatements.C? tytagFamily$object tytagFamily$C)
)
...
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass.OtherBindersInStatements.C $h@@0) ($IsAlloc refType |c#0@@0| Tclass.OtherBindersInStatements.C? $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.OtherBindersInStatements.C $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.OtherBindersInStatements.C? $h@@0))
)))
...
(assert (forall (($o@@0 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass.OtherBindersInStatements.C? $h@@2)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@0) alloc)))))
 :pattern ( ($IsAlloc refType $o@@0 Tclass.OtherBindersInStatements.C? $h@@2))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (and (= |b#0@0| (exists ((|c#0@@3| T@U) )  (and (and ($Is refType |c#0@@3| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@@3| Tclass.OtherBindersInStatements.C $Heap)) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon3_Else_correct  (=> (and (not (and ($Is refType |c#1@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#1@0| Tclass.OtherBindersInStatements.C $Heap))) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and ($Is refType |c#1@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#1@0| Tclass.OtherBindersInStatements.C $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |c#1@0| null)) (not true))) (=> (or (not (= |c#1@0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (=> (= (ControlFlow 0 3) 2) anon2_correct)))))))))
