         ...
         == Set#FromBoogieMap((lambda $y#0: Box :: 
            (exists i#0: int :: 
              ...
              LitInt(0) <= i#0
                 ...
                 && $y#0 == read($Heap, a#0, IndexField(i#0))))));
}
...
procedure {:verboseName "Test.arrSet (well-formedness)"} CheckWellformed$$Test.__default.arrSet(a#0: ref where $Is(a#0, Tclass._System.array(Tclass.Test.C())));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Test.arrSet (well-formedness)"} CheckWellformed$$Test.__default.arrSet(a#0: ref)
{
  ...
  var b$reqreads#0: bool;
    ...
    if (*)
    {
        ...
        assume $Is(Test.__default.arrSet($Heap, a#0), TSet(Tclass._System.object()));
        assume false;
    }
    else
    {
        ...
        if (true)
        {
            ...
            if (LitInt(0) <= i#1 && i#1 < _System.array.Length(a#0))
            {
                ...
                assert {:id "id3"} 0 <= i#1 && i#1 < _System.array.Length(a#0);
                b$reqreads#0 := $_ReadsFrame[a#0, IndexField(i#1)];
            }
        }

        // End Comprehension WF check
        assume {:id "id4"} Test.__default.arrSet($Heap, a#0)
           == Set#FromBoogieMap((lambda $y#2: Box :: 
              (exists i#2: int :: 
                { $Unbox(read($Heap, a#0, IndexField(i#2))): ref } 
                LitInt(0) <= i#2
                   && i#2 < _System.array.Length(a#0)
                   && $y#2 == read($Heap, a#0, IndexField(i#2)))));
        assume true;
...
procedure {:verboseName "Test.test (well-formedness)"} CheckWellFormed$$Test.__default.test(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass.Test.C()))
         && $IsAlloc(a#0, Tclass._System.array(Tclass.Test.C()), $Heap), 
    i#0: int, 
    x#0: ref
       where $Is(x#0, Tclass.Test.C()) && $IsAlloc(x#0, Tclass.Test.C(), $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Test.test (well-formedness)"} CheckWellFormed$$Test.__default.test(a#0: ref, i#0: int, x#0: ref)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var ##a#0: ref;


    // AddMethodImpl: test, CheckWellFormed$$Test.__default.test
    ...
    assume {:id "id7"} LitInt(0) <= i#0 && i#0 < _System.array.Length(a#0);
    ##a#0 := a#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#0, Tclass._System.array(Tclass.Test.C()), $Heap);
    assume Test.__default.arrSet#canCall($Heap, a#0);
    assume {:id "id8"} !Set#IsMember(Test.__default.arrSet($Heap, a#0), $Box(x#0));
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
...
procedure {:verboseName "Test.test (call)"} Call$$Test.__default.test(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass.Test.C()))
         && $IsAlloc(a#0, Tclass._System.array(Tclass.Test.C()), $Heap), 
    i#0: int, 
    x#0: ref
  ...
  requires {:id "id9"} LitInt(0) <= i#0;
  requires {:id "id10"} i#0 < _System.array.Length(a#0);
  requires {:id "id11"} !Set#IsMember(Test.__default.arrSet($Heap, a#0), $Box(x#0));
  modifies $Heap;
...
procedure {:verboseName "Test.test (correctness)"} Impl$$Test.__default.test(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass.Test.C()))
         && $IsAlloc(a#0, Tclass._System.array(Tclass.Test.C()), $Heap), 
    i#0: int, 
    x#0: ref
  ...
  free requires 2 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id12"} LitInt(0) <= i#0;
  requires {:id "id13"} i#0 < _System.array.Length(a#0);
  requires {:id "id14"} !Set#IsMember(Test.__default.arrSet($Heap, a#0), $Box(x#0));
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Test.test (correctness)"} Impl$$Test.__default.test(a#0: ref, i#0: int, x#0: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $rhs#0: ref;
  var ##a#1: ref;
  var ##a#2: ref;
    ...
    // AddMethodImpl: test, Impl$$Test.__default.test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> $o == a#0);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1989.dfy(21,10)
    assert {:id "id15"} a#0 != null;
    assert {:id "id16"} 0 <= i#0 && i#0 < _System.array.Length(a#0);
    assume true;
    assert {:id "id17"} $_ModifiesFrame[a#0, IndexField(i#0)];
    assume true;
    $rhs#0 := x#0;
    $Heap := update($Heap, a#0, IndexField(i#0), $Box($rhs#0));
    assume $IsGoodHeap($Heap);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-1989.dfy(22,5)
    ##a#1 := a#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#1, Tclass._System.array(Tclass.Test.C()), $Heap);
    assume Test.__default.arrSet#canCall($Heap, a#0);
    ##a#2 := a#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##a#2, Tclass._System.array(Tclass.Test.C()), $Heap);
    assume Test.__default.arrSet#canCall($Heap, a#0);
    assume Test.__default.arrSet#canCall($Heap, a#0)
       && Test.__default.arrSet#canCall($Heap, a#0);
    assert {:id "id20"} Set#Equal(Test.__default.arrSet($Heap, a#0), Test.__default.arrSet($Heap, a#0));
}
