...
(declare-fun |val#0| () (_ BitVec 16))
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $Heap () T@U)
(declare-fun |idx#0| () Int)
(declare-fun |let#0#0#0| () (_ BitVec 32))
(declare-fun |idx32#Z#0@0| () (_ BitVec 32))
(declare-fun |newtype$check#2@0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun alloc () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.lmnat_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon7_correct  (=> (and (bvule #x0000 |val#0|) (bvult |val#0| (bvshl #x0001 (concat #b00000000000 #b01000)))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 |idx#0|) (< |idx#0| 4294967296))) (=> (and (<= 0 |idx#0|) (< |idx#0| 4294967296)) (=> (= |let#0#0#0| ((_ int2bv 32) |idx#0|)) (=> (and ($Is bv32Type (bv32_2_U |let#0#0#0|) (TBitvector 32)) (= |idx32#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (bvult |idx32#Z#0@0| #x00000040)) (=> (bvult |idx32#Z#0@0| #x00000040) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bvule ((_ extract 5 0) |idx32#Z#0@0|) #b100000)) (=> (bvule ((_ extract 5 0) |idx32#Z#0@0|) #b100000) (and (=> (= (ControlFlow 0 2) (- 0 3)) (bvult |idx32#Z#0@0| #x00000020)) (=> (bvult |idx32#Z#0@0| #x00000020) (=> (= (ControlFlow 0 2) (- 0 1)) (bvule ((_ extract 4 0) |idx32#Z#0@0|) #b10000))))))))))))))))
(let ((anon10_Else_correct  (=> (and (not (bvule #x0000 |val#0|)) (= (ControlFlow 0 10) 2)) anon7_correct)))
(let ((anon10_Then_correct  (=> (and (bvule #x0000 |val#0|) (= |newtype$check#2@0| (LitInt 8))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (and (<= 0 |newtype$check#2@0|) (< |newtype$check#2@0| 32))) (=> (and (<= 0 |newtype$check#2@0|) (< |newtype$check#2@0| 32)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (bvule #b01000 #b10000)) (=> (bvule #b01000 #b10000) (=> (= (ControlFlow 0 7) 2) anon7_correct))))))))
(let ((anon5_correct  (=> (and (bvule #x00000000 ((_ int2bv 32) |idx#0|)) (bvule ((_ int2bv 32) |idx#0|) #x00000008)) (and (=> (= (ControlFlow 0 11) 7) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (not (bvule #x00000000 ((_ int2bv 32) |idx#0|))) (= (ControlFlow 0 14) 11)) anon5_correct)))
(let ((anon9_Then_correct  (=> (bvule #x00000000 ((_ int2bv 32) |idx#0|)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (and (<= 0 |idx#0|) (< |idx#0| 4294967296))) (=> (and (<= 0 |idx#0|) (< |idx#0| 4294967296)) (=> (= (ControlFlow 0 12) 11) anon5_correct))))))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |idx#0|) (<= |idx#0| (LitInt 8))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (and (<= 0 |idx#0|) (< |idx#0| 4294967296))) (=> (and (<= 0 |idx#0|) (< |idx#0| 4294967296)) (and (=> (= (ControlFlow 0 15) 12) anon9_Then_correct) (=> (= (ControlFlow 0 15) 14) anon9_Else_correct)))))))
(let ((anon8_Else_correct  (=> (and (< |idx#0| (LitInt 0)) (= (ControlFlow 0 18) 15)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |idx#0|) (= (ControlFlow 0 17) 15)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 19) 17) anon8_Then_correct) (=> (= (ControlFlow 0 19) 18) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |idx#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct)))
