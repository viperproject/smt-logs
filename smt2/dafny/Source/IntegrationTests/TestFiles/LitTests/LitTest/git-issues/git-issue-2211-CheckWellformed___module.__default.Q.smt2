...
(let ((anon15_Else_correct  (=> (and (not (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#2@0|))))) (= (ControlFlow 0 7) 3)) anon9_correct)))
(let ((anon15_Then_correct  (=> (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#2@0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |s#0@@1|)))) (=> (and (<= 0 |i#2@0|) (< |i#2@0| (|Seq#Length| |s#0@@1|))) (=> (and (and (= |##a#1@0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#2@0|)))) ($IsAlloc intType (int_2_U |##a#1@0|) TInt $Heap)) (and (|_module.__default.P2#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#2@0|)))) (= (ControlFlow 0 5) 3))) anon9_correct))))))
