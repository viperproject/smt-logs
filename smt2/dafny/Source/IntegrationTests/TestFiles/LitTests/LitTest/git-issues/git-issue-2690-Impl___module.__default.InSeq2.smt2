...
(assert (distinct TBool TagBool TagSet TagSeq alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 tytagFamily$object |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1|)
)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|$l#0#heap#0| T@U) (|$l#0#t#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#15| |l#0| |l#1|) |$l#0#heap#0| |$l#0#t#0|))  (and ($IsBox |$l#0#t#0| |l#0|) (let ((|b#0| (|Seq#Contains| |l#1| |$l#0#t#0|)))
|b#0|)))
 :qid |unknown.0:0|
 :skolemid |508|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#15| |l#0| |l#1|) |$l#0#heap#0| |$l#0#t#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@2| |l#1@@0| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@1) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |500|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@2| |l#1@@0| |l#2| |l#3|) $o@@1 $f))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#t#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#t#0@@0|) |l#0@@3|)
 :qid |gitissue2690dfy.8:20|
 :skolemid |504|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#t#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#2#heap#0| T@U) (|$l#2#t#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#6| |l#0@@4|) |$l#2#heap#0| |$l#2#t#0|) |l#0@@4|)
 :qid |gitissue2690dfy.9:29|
 :skolemid |506|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#6| |l#0@@4|) |$l#2#heap#0| |$l#2#t#0|))
)))
...
(declare-fun _module._default.InSeq2$T () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.InSeq2)
...
(let ((anon8_Else_correct  (=> (and (not (let ((|b#1| (|Seq#Contains| |ts#0| |t#2@0|)))
|b#1|)) (= (ControlFlow 0 7) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (and (let ((|b#1@@0| (|Seq#Contains| |ts#0| |t#2@0|)))
|b#1@@0|) (= |lambdaResult#0| (U_2_bool (Lit boolType (bool_2_U true))))) (and ($Is boolType (bool_2_U |lambdaResult#0|) TBool) (= (ControlFlow 0 6) 4))) anon4_correct)))
(let ((anon7_Then_correct  (=> (and ($IsBox |t#2@0| _module._default.InSeq2$T) ($IsAllocBox |t#2@0| _module._default.InSeq2$T |$lambdaHeap#0@0|)) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |let#0#0#0| (|Seq#Contains| |ts#0| |t#2@0|))) (and ($Is boolType (bool_2_U |let#0#0#0|) TBool) (= |b#Z#0@0| |let#0#0#0|))) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct))))))
(let ((anon7_Else_correct  (=> (and (not (and ($IsBox |t#2@0| _module._default.InSeq2$T) ($IsAllocBox |t#2@0| _module._default.InSeq2$T |$lambdaHeap#0@0|))) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon6_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 9) 8) anon7_Then_correct) (=> (= (ControlFlow 0 9) 5) anon7_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|t#1| T@U) ) (!  (=> (and ($IsBox |t#1| _module._default.InSeq2$T) (|Seq#Contains| |ts#0| |t#1|)) (Requires1 _module._default.InSeq2$T TBool $Heap |f#0@1| |t#1|))
 :qid |gitissue2690dfy.13:18|
 :skolemid |493|
 :pattern ( (Requires1 _module._default.InSeq2$T TBool $Heap |f#0@1| |t#1|))
 :pattern ( (|Seq#Contains| |ts#0| |t#1|))
)))))
(let ((anon6_Else_correct  (=> (= |f#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#6| ($Box boolType (Lit boolType (bool_2_U true)))) (|lambda#15| _module._default.InSeq2$T |ts#0|) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (=> (and (= |f#0@1| |f#0@0|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 10) 9) anon6_Then_correct) (=> (= (ControlFlow 0 10) 3) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |ts#0| (TSeq _module._default.InSeq2$T)) ($IsAlloc SeqType |ts#0| (TSeq _module._default.InSeq2$T) $Heap))) (and (and ($Is HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc1 _module._default.InSeq2$T TBool)) ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc1 _module._default.InSeq2$T TBool) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct)))
