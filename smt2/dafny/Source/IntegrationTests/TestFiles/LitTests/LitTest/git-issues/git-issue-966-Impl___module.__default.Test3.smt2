...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon4_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (= |x#0@0| (LitInt 40))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |y#0@0| (LitInt 30))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (Apply0 TInt $Heap |f#0@0|))) (LitInt 92)))))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |x#0@0| (_module.DT.c (Lit DatatypeTypeType |#_module.DT.Make|))) (= |y#0@0| _module.DT.b)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |f#0@0| (|_module.DT.F#Handle| (Lit DatatypeTypeType |#_module.DT.Make|))) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct)))))))))
