...
(assert (forall ((d@@3 T@U) ) (!  (=> (|$IsA#M.D| d@@3) (or (M.D.D__1_q d@@3) (M.D.D__2_q d@@3)))
 :qid |unknown.0:0|
 :skolemid |500|
 :pattern ( (|$IsA#M.D| d@@3))
)))
...
(assert (forall ((d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 Tclass.M.D) (or (M.D.D__1_q d@@4) (M.D.D__2_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |501|
 :pattern ( (M.D.D__2_q d@@4) ($Is DatatypeTypeType d@@4 Tclass.M.D))
 :pattern ( (M.D.D__1_q d@@4) ($Is DatatypeTypeType d@@4 Tclass.M.D))
)))
...
(assert (forall ((d@@5 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (M.D.D__1_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass.M.D $h))) ($IsAlloc boolType (bool_2_U (M.D.a d@@5)) TBool $h))
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( ($IsAlloc boolType (bool_2_U (M.D.a d@@5)) TBool $h))
)))
(assert (forall ((d@@6 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (M.D.D__2_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass.M.D $h@@0))) ($IsAlloc boolType (bool_2_U (M.D.b d@@6)) TBool $h@@0))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( ($IsAlloc boolType (bool_2_U (M.D.b d@@6)) TBool $h@@0))
)))
(assert (forall ((d@@7 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) ($Is DatatypeTypeType d@@7 Tclass.M.D)) ($IsAlloc DatatypeTypeType d@@7 Tclass.M.D $h@@1))
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( ($IsAlloc DatatypeTypeType d@@7 Tclass.M.D $h@@1))
)))
...
(set-info :boogie-vc-id Impl$$M.__default.DoIt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (not (M.D.D__1_q |d#0|)) (= (ControlFlow 0 4) (- 0 3))) (M.D.D__2_q |d#0|))))
(let ((anon3_Then_correct  (=> (and (M.D.D__1_q |d#0|) (= (ControlFlow 0 2) (- 0 1))) (M.D.D__1_q |d#0|))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |d#0| Tclass.M.D) ($IsAlloc DatatypeTypeType |d#0| Tclass.M.D $Heap)) (|$IsA#M.D| |d#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
