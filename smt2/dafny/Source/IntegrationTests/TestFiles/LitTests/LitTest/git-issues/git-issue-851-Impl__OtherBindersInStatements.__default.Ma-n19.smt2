...
(assert (distinct TInt TagInt TagSet TagMap alloc Tagclass._System.object? Tagclass._System.object |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.OtherBindersInStatements.C Tagclass.OtherBindersInStatements.C? tytagFamily$object |tytagFamily$_tuple#2| tytagFamily$C)
)
...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#4| |l#0@@0| |l#1| |l#2| |l#3|) |$y#0|))  (and (and ($IsBox |$y#0| |l#0@@0|) ($IsAllocBox |$y#0| |l#1| |l#2|)) |l#3|))
 :qid |gitissue851dfy.137:9|
 :skolemid |4122|
 :pattern ( (MapType0Select BoxType boolType (|lambda#4| |l#0@@0| |l#1| |l#2| |l#3|) |$y#0|))
)))
...
(assert (forall ((v@@3 T@U) (t0@@3 T@U) (t1@@1 T@U) (h@@1 T@U) ) (! (= ($IsAlloc MapType v@@3 (TMap t0@@3 t1@@1) h@@1) (forall ((bx@@9 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@3) bx@@9) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@3) bx@@9) t1@@1 h@@1) ($IsAllocBox bx@@9 t0@@3 h@@1)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0@@1|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@3) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |4121|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@3 $f))
)))
...
(assert (forall ((bx@@13 T@U) ) (!  (=> ($IsBox bx@@13 Tclass.OtherBindersInStatements.C?) ($IsBox bx@@13 Tclass._System.object?))
 :qid |unknown.0:0|
 :skolemid |2997|
 :pattern ( ($IsBox bx@@13 Tclass.OtherBindersInStatements.C?))
)))
(assert (forall ((v@@6 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (! (= ($Is MapType v@@6 (TMap t0@@5 t1@@3)) (forall ((bx@@14 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@6) bx@@14) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@6) bx@@14) t1@@3) ($IsBox bx@@14 t0@@5)))
 :qid |DafnyPreludebpl.261:19|
 :skolemid |2518|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@6) bx@@14))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@6) bx@@14))
)))
...
(set-info :boogie-vc-id Impl$$OtherBindersInStatements.__default.MapComprehension0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct  (=> (and (= |b#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#4| Tclass.OtherBindersInStatements.C Tclass.OtherBindersInStatements.C $Heap (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))) (|lambda#9| ($Box intType (int_2_U (LitInt 102)))) (TMap Tclass.OtherBindersInStatements.C TInt))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon5_Else_correct  (=> (and (or (not (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))) (not true)) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon5_Then_correct  (=> (and (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and ($Is refType |c#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@0| Tclass.OtherBindersInStatements.C $Heap)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct))))))))))
(let ((anon4_Else_correct  (=> (and (not (and ($Is refType |c#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@0| Tclass.OtherBindersInStatements.C $Heap))) (= (ControlFlow 0 3) 2)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 9) 6) anon4_Then_correct) (=> (= (ControlFlow 0 9) 3) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |b#0| (TMap Tclass.OtherBindersInStatements.C TInt)) ($IsAlloc MapType |b#0| (TMap Tclass.OtherBindersInStatements.C TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
