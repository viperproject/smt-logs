...
const unique class.Traits.__default: ClassName;

const unique class.Traits.T?: ClassName;

function Tclass.Traits.T?() : Ty
uses {
// Tclass.Traits.T? Tag
axiom Tag(Tclass.Traits.T?()) == Tagclass.Traits.T?
   && TagFamily(Tclass.Traits.T?()) == tytagFamily$T;
}

const unique Tagclass.Traits.T?: TyTag;

// Box/unbox axiom for Tclass.Traits.T?
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.Traits.T?()) } 
  $IsBox(bx, Tclass.Traits.T?())
     ==> $Box($Unbox(bx): ref) == bx && $Is($Unbox(bx): ref, Tclass.Traits.T?()));

// $Is axiom for trait T
axiom (forall $o: ref :: 
  { $Is($o, Tclass.Traits.T?()) } 
  $Is($o, Tclass.Traits.T?()) <==> $o == null || implements$Traits.T(dtype($o)));

// $IsAlloc axiom for trait T
axiom (forall $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass.Traits.T?(), $h) } 
  $IsAlloc($o, Tclass.Traits.T?(), $h)
     <==> $o == null || $Unbox(read($h, $o, alloc)): bool);

function implements$Traits.T(ty: Ty) : bool;
...
procedure {:verboseName "Traits.T.Infloop (well-formedness)"} CheckWellFormed$$Traits.T.Infloop(this: ref
       where this != null
         && 
        $Is(this, Tclass.Traits.T())
         && $IsAlloc(this, Tclass.Traits.T(), $Heap), 
    b#0: bv8);
...
procedure {:verboseName "Traits.T.Infloop (call)"} Call$$Traits.T.Infloop(this: ref
       where this != null
         && 
        $Is(this, Tclass.Traits.T())
         && $IsAlloc(this, Tclass.Traits.T(), $Heap), 
  ...
  requires {:id "id31"} b#0 == Lit(3bv8);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id32"} Lit(false);
...
// $Is axiom for non-null type Traits.T
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass.Traits.T()) } { $Is(c#0, Tclass.Traits.T?()) } 
  $Is(c#0, Tclass.Traits.T()) <==> $Is(c#0, Tclass.Traits.T?()) && c#0 != null);

// $IsAlloc axiom for non-null type Traits.T
axiom (forall c#0: ref, $h: Heap :: 
  { $IsAlloc(c#0, Tclass.Traits.T(), $h) } 
    { $IsAlloc(c#0, Tclass.Traits.T?(), $h) } 
  $IsAlloc(c#0, Tclass.Traits.T(), $h) <==> $IsAlloc(c#0, Tclass.Traits.T?(), $h));

const unique class.Traits.C?: ClassName;

function Tclass.Traits.C?() : Ty
uses {
// Tclass.Traits.C? Tag
axiom Tag(Tclass.Traits.C?()) == Tagclass.Traits.C?
   && TagFamily(Tclass.Traits.C?()) == tytagFamily$C;
axiom implements$Traits.T(Tclass.Traits.C?());
}

const unique Tagclass.Traits.C?: TyTag;

// Box/unbox axiom for Tclass.Traits.C?
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.Traits.C?()) } 
  $IsBox(bx, Tclass.Traits.C?())
     ==> $Box($Unbox(bx): ref) == bx && $Is($Unbox(bx): ref, Tclass.Traits.C?()));

// $Is axiom for class C
axiom (forall $o: ref :: 
  { $Is($o, Tclass.Traits.C?()) } 
  $Is($o, Tclass.Traits.C?()) <==> $o == null || dtype($o) == Tclass.Traits.C?());

// $IsAlloc axiom for class C
axiom (forall $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass.Traits.C?(), $h) } 
  $IsAlloc($o, Tclass.Traits.C?(), $h)
     <==> $o == null || $Unbox(read($h, $o, alloc)): bool);
...
procedure {:verboseName "Traits.C.Infloop (well-formedness)"} CheckWellFormed$$Traits.C.Infloop(this: ref
       where this != null
         && 
        $Is(this, Tclass.Traits.C())
         && $IsAlloc(this, Tclass.Traits.C(), $Heap), 
    b#0: bv8);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "Traits.C.Infloop (override check)"} OverrideCheck$$Traits.C.Infloop(this: ref
       where this != null
         && 
        $Is(this, Tclass.Traits.C())
         && $IsAlloc(this, Tclass.Traits.C(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Traits.C.Infloop (override check)"} OverrideCheck$$Traits.C.Infloop(this: ref, b#0: bv8)
{
    assume {:id "id35"} b#0 == Lit(3bv8);
    assert {:id "id36"} b#0 == Lit(3bv8);
    assert {:id "id37"} le_bv8(add_bv8(b#0, 1bv8), b#0);
    ...
    assume {:id "id40"} Lit(false);
    assert {:id "id41"} Lit(false);
}



procedure {:verboseName "Traits.C.Infloop (call)"} Call$$Traits.C.Infloop(this: ref
       where this != null
         && 
        $Is(this, Tclass.Traits.C())
         && $IsAlloc(this, Tclass.Traits.C(), $Heap), 
...
procedure {:verboseName "Traits.C.Infloop (correctness)"} Impl$$Traits.C.Infloop(this: ref
       where this != null
         && 
        $Is(this, Tclass.Traits.C())
         && $IsAlloc(this, Tclass.Traits.C(), $Heap), 
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id44"} b#0 == Lit(3bv8);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id45"} Lit(false);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Traits.C.Infloop (correctness)"} Impl$$Traits.C.Infloop(this: ref, b#0: bv8) returns ($_reverifyPost: bool)
{
  ...
  var b##0: bv8;
    ...
    // AddMethodImpl: Infloop, Impl$$Traits.C.Infloop
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2511.dfy(56,26)
    // TrCallStmt: Before ProcessCallStmt
    newtype$check#0 := this;
    newtype$check#1 := this;
    assume true;
    assert {:id "id46"} this != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    b##0 := b#0;
    assert {:id "id47"} lt_bv8(b##0, add_bv8(b#0, 1bv8));
    call {:id "id48"} Call$$Traits.T.Infloop(this, b##0);
    // TrCallStmt: After ProcessCallStmt
}



// $Is axiom for non-null type Traits.C
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass.Traits.C()) } { $Is(c#0, Tclass.Traits.C?()) } 
  $Is(c#0, Tclass.Traits.C()) <==> $Is(c#0, Tclass.Traits.C?()) && c#0 != null);

// $IsAlloc axiom for non-null type Traits.C
axiom (forall c#0: ref, $h: Heap :: 
  { $IsAlloc(c#0, Tclass.Traits.C(), $h) } 
    { $IsAlloc(c#0, Tclass.Traits.C?(), $h) } 
  $IsAlloc(c#0, Tclass.Traits.C(), $h) <==> $IsAlloc(c#0, Tclass.Traits.C?(), $h));

// type axiom for trait parent: C? extends T?
axiom (forall $o: ref :: 
  { $Is($o, Tclass.Traits.C?()) } 
  $Is($o, Tclass.Traits.C?()) ==> $Is($o, Tclass.Traits.T?()));

axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.Traits.C?()) } 
  $IsBox(bx, Tclass.Traits.C?()) ==> $IsBox(bx, Tclass.Traits.T?()));

// allocation axiom for trait parent: C? extends T?
axiom (forall $o: ref, $heap: Heap :: 
  { $IsAlloc($o, Tclass.Traits.C?(), $heap) } 
  $IsAlloc($o, Tclass.Traits.C?(), $heap)
     ==> $IsAlloc($o, Tclass.Traits.T?(), $heap));

axiom (forall bx: Box, $h: Heap :: 
  { $IsAllocBox(bx, Tclass.Traits.C?(), $h) } 
  $IsAllocBox(bx, Tclass.Traits.C?(), $h) && $IsGoodHeap($h)
     ==> $IsAllocBox(bx, Tclass.Traits.T?(), $h));
