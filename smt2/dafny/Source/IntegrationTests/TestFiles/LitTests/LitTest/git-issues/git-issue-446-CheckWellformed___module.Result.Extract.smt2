...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType this@@3 (Tclass._module.Result _module.Result$T@@13)) ($IsAlloc DatatypeTypeType this@@3 (Tclass._module.Result _module.Result$T@@13) $Heap@@0)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
