...
(declare-fun _module.C.G (T@U T@U Int T@U) Int)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun HandleTypeType () T@T)
(declare-fun LitInt (Int) Int)
(declare-fun BoxType () T@T)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.C.G#canCall| (T@U T@U Int T@U) Bool)
...
(declare-fun |$let#38$canCall| (T@U T@U T@U T@U) Bool)
(declare-fun |$let#38_n| (T@U T@U T@U T@U) Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.C$X T@U) ($Heap T@U) (|p#0| T@U) (|k#0| Int) (|x#0| T@U) ) (!  (=> (or (|_module.C.G#canCall| _module.C$X (Lit HandleTypeType |p#0|) (LitInt |k#0|) (Lit BoxType |x#0|)) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap) ($Is HandleTypeType |p#0| (Tclass._System.___hTotalFunc2 Tclass._System.nat _module.C$X TBool))) (<= (LitInt 0) |k#0|)) ($IsBox |x#0| _module.C$X)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X TBool $Heap (Lit HandleTypeType |p#0|) ($Box intType (int_2_U (LitInt |k#0|))) (Lit BoxType |x#0|))))))) (and (|$let#38$canCall| _module.C$X $Heap (Lit HandleTypeType |p#0|) (Lit BoxType |x#0|)) (= (_module.C.G _module.C$X (Lit HandleTypeType |p#0|) (LitInt |k#0|) (Lit BoxType |x#0|)) (let ((|n#2| (|$let#38_n| _module.C$X $Heap (Lit HandleTypeType |p#0|) (Lit BoxType |x#0|))))
|n#2|))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |671|
 :pattern ( (_module.C.G _module.C$X (Lit HandleTypeType |p#0|) (LitInt |k#0|) (Lit BoxType |x#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((_module.C$X@@0 T@U) ($heap T@U) (p T@U) (x@@2 T@U) ) (!  (=> (|$let#38$canCall| _module.C$X@@0 $heap p x@@2) (and (<= (LitInt 0) (|$let#38_n| _module.C$X@@0 $heap p x@@2)) (and (<= (LitInt 0) (|$let#38_n| _module.C$X@@0 $heap p x@@2)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@0 TBool $heap p ($Box intType (int_2_U (|$let#38_n| _module.C$X@@0 $heap p x@@2))) x@@2))))))
 :qid |gitissue1256dfy.40:5|
 :skolemid |668|
 :pattern ( (|$let#38_n| _module.C$X@@0 $heap p x@@2))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.C$X@@1 T@U) ($Heap@@0 T@U) (|p#0@@0| T@U) (|k#0@@0| Int) (|x#0@@1| T@U) ) (!  (=> (or (|_module.C.G#canCall| _module.C$X@@1 |p#0@@0| (LitInt |k#0@@0|) |x#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |p#0@@0| (Tclass._System.___hTotalFunc2 Tclass._System.nat _module.C$X@@1 TBool))) (<= (LitInt 0) |k#0@@0|)) ($IsBox |x#0@@1| _module.C$X@@1)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@1 TBool $Heap@@0 |p#0@@0| ($Box intType (int_2_U (LitInt |k#0@@0|))) |x#0@@1|)))))) (and (|$let#38$canCall| _module.C$X@@1 $Heap@@0 |p#0@@0| |x#0@@1|) (= (_module.C.G _module.C$X@@1 |p#0@@0| (LitInt |k#0@@0|) |x#0@@1|) (let ((|n#1| (|$let#38_n| _module.C$X@@1 $Heap@@0 |p#0@@0| |x#0@@1|)))
|n#1|))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |670|
 :pattern ( (_module.C.G _module.C$X@@1 |p#0@@0| (LitInt |k#0@@0|) |x#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (and (and (and (and (and (and (= (Ctor refType) 5) (forall ((t0 T@T) (t1 T@T) (val T@U) (m T@U) (x0 T@U) ) (! (= (MapType0Select t0 t1 (MapType0Store t0 t1 m x0 val) x0) val)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.C$X@@2 T@U) ($Heap@@1 T@U) (|p#0@@1| T@U) (|k#0@@1| Int) (|x#0@@3| T@U) ) (!  (=> (or (|_module.C.G#canCall| _module.C$X@@2 |p#0@@1| |k#0@@1| |x#0@@3|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@1) (and ($Is HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc2 Tclass._System.nat _module.C$X@@2 TBool)) ($IsAlloc HandleTypeType |p#0@@1| (Tclass._System.___hTotalFunc2 Tclass._System.nat _module.C$X@@2 TBool) $Heap@@1))) (<= (LitInt 0) |k#0@@1|)) (and ($IsBox |x#0@@3| _module.C$X@@2) ($IsAllocBox |x#0@@3| _module.C$X@@2 $Heap@@1))) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@2 TBool $Heap@@1 |p#0@@1| ($Box intType (int_2_U |k#0@@1|)) |x#0@@3|)))))) (<= (LitInt 0) (_module.C.G _module.C$X@@2 |p#0@@1| |k#0@@1| |x#0@@3|)))
 :qid |unknown.0:0|
 :skolemid |666|
 :pattern ( (_module.C.G _module.C$X@@2 |p#0@@1| |k#0@@1| |x#0@@3|) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.C$X@@3 T@U) ($Heap@@2 T@U) (|p#0@@2| T@U) (|k#0@@2| Int) (|x#0@@4| T@U) ) (!  (=> (or (|_module.C.G#canCall| _module.C$X@@3 |p#0@@2| |k#0@@2| |x#0@@4|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@2) ($Is HandleTypeType |p#0@@2| (Tclass._System.___hTotalFunc2 Tclass._System.nat _module.C$X@@3 TBool))) (<= (LitInt 0) |k#0@@2|)) ($IsBox |x#0@@4| _module.C$X@@3)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@3 TBool $Heap@@2 |p#0@@2| ($Box intType (int_2_U |k#0@@2|)) |x#0@@4|)))))) (and (|$let#38$canCall| _module.C$X@@3 $Heap@@2 |p#0@@2| |x#0@@4|) (= (_module.C.G _module.C$X@@3 |p#0@@2| |k#0@@2| |x#0@@4|) (let ((|n#0| (|$let#38_n| _module.C$X@@3 $Heap@@2 |p#0@@2| |x#0@@4|)))
|n#0|))))
 :qid |unknown.0:0|
 :skolemid |669|
 :pattern ( (_module.C.G _module.C$X@@3 |p#0@@2| |k#0@@2| |x#0@@4|) ($IsGoodHeap $Heap@@2))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.C.G)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@4 TBool $Heap@@3 |p#0@@3| ($Box intType (int_2_U (LitInt 0))) |x#0@@5|))))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@4 TBool $Heap@@3 |p#0@@3| ($Box intType (int_2_U (LitInt 0))) |x#0@@5|))))) (or (and ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (and (<= (LitInt 0) (LitInt 0)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@4 TBool $Heap@@3 |p#0@@3| ($Box intType (int_2_U (LitInt 0))) |x#0@@5|))))) (exists ((|n#4| T@U) ) (!  (and (<= (LitInt 0) (U_2_int |n#4|)) (and (<= (LitInt 0) (U_2_int |n#4|)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@4 TBool $Heap@@3 |p#0@@3| ($Box intType |n#4|) |x#0@@5|)))))
 :qid |gitissue1256dfy.40:9|
 :skolemid |672|
))))))))
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@3 alloc false)) (U_2_bool ($Unbox boolType (Apply2 Tclass._System.nat _module.C$X@@4 TBool $Heap@@3 |p#0@@3| ($Box intType (int_2_U |k#0@@3|)) |x#0@@5|)))) (and (and (=> (= (ControlFlow 0 8) 1) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 4) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) ($Is HandleTypeType |p#0@@3| (Tclass._System.___hTotalFunc2 Tclass._System.nat _module.C$X@@4 TBool))) (and (and (<= (LitInt 0) |k#0@@3|) ($IsBox |x#0@@5| _module.C$X@@4)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8)))) anon0_correct)))
