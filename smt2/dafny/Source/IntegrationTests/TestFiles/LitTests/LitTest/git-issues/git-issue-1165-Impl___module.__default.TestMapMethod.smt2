...
(declare-fun |lambda#1| (T@U T@U Bool) T@U)
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| Bool) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1| |l#2|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (and (|Set#IsMember| |l#1| |$w#0|) |l#2|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |741|
 :pattern ( (MapType0Select BoxType boolType (|lambda#1| |l#0| |l#1| |l#2|) |$w#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|$w#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#3| |l#0@@0| |l#1@@0|) |$w#1|))  (and ($IsBox |$w#1| |l#0@@0|) (|Set#IsMember| |l#1@@0| |$w#1|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |743|
 :pattern ( (MapType0Select BoxType boolType (|lambda#3| |l#0@@0| |l#1@@0|) |$w#1|))
)))
...
(assert (forall ((|l#0@@1| T@U) (|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#2| |l#0@@1|) |$w#0@@0|) |l#0@@1|)
 :qid |gitissue1165dfy.8:8|
 :skolemid |742|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#2| |l#0@@1|) |$w#0@@0|))
)))
...
(declare-fun |key#6@0| () Int)
(declare-fun |_module.__default.P#canCall| () Bool)
(declare-fun |m#0@3| () T@U)
(declare-fun _module.__default.P () Bool)
(declare-fun |key#4@0| () Int)
(declare-fun |m#0@2| () T@U)
(declare-fun |key#2@0| () Int)
...
(set-info :boogie-vc-id Impl$$_module.__default.TestMapMethod)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon16_correct  (=> (and (= |m#0@4| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#3| TInt (|Set#Union| |s0#0| |s1#0|))) (|lambda#2| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool))) (= (ControlFlow 0 6) (- 0 5))) (U_2_bool (Lit boolType (bool_2_U true))))))
(let ((anon26_Else_correct  (=> (and (not (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#6@0|)))) (= (ControlFlow 0 8) 6)) anon16_correct)))
(let ((anon26_Then_correct  (=> (and (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#6@0|))) (= (ControlFlow 0 7) 6)) anon16_correct)))
(let ((anon25_Then_correct  (and (=> (= (ControlFlow 0 9) 7) anon26_Then_correct) (=> (= (ControlFlow 0 9) 8) anon26_Else_correct))))
(let ((anon25_Else_correct true))
(let ((anon13_correct  (=> (and (forall ((|key#5| T@U) ) (!  (=> (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType |key#5|)) |_module.__default.P#canCall|)
 :qid |gitissue1165dfy.10:12|
 :skolemid |593|
 :pattern ( (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType |key#5|)))
)) (= |m#0@3| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#1| TInt (|Set#Union| |s0#0| |s1#0|) _module.__default.P)) (|lambda#2| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool)))) (and (=> (= (ControlFlow 0 10) 9) anon25_Then_correct) (=> (= (ControlFlow 0 10) 4) anon25_Else_correct)))))
(let ((anon24_Else_correct  (=> (and (not (and (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#4@0|))) _module.__default.P)) (= (ControlFlow 0 12) 10)) anon13_correct)))
(let ((anon24_Then_correct  (=> (and (and (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#4@0|))) _module.__default.P) (= (ControlFlow 0 11) 10)) anon13_correct)))
(let ((anon23_Else_correct  (=> (not (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#4@0|)))) (and (=> (= (ControlFlow 0 14) 11) anon24_Then_correct) (=> (= (ControlFlow 0 14) 12) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (and (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#4@0|))) |_module.__default.P#canCall|) (and (=> (= (ControlFlow 0 13) 11) anon24_Then_correct) (=> (= (ControlFlow 0 13) 12) anon24_Else_correct)))))
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 15) 13) anon23_Then_correct) (=> (= (ControlFlow 0 15) 14) anon23_Else_correct))))
(let ((anon22_Else_correct true))
(let ((anon8_correct  (=> (= |m#0@2| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#3| TInt (|Set#Union| |s0#0| |s1#0|))) (|lambda#2| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool))) (and (=> (= (ControlFlow 0 16) 15) anon22_Then_correct) (=> (= (ControlFlow 0 16) 3) anon22_Else_correct)))))
(let ((anon21_Else_correct  (=> (and (not (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#2@0|)))) (= (ControlFlow 0 18) 16)) anon8_correct)))
(let ((anon21_Then_correct  (=> (and (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#2@0|))) (= (ControlFlow 0 17) 16)) anon8_correct)))
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 19) 17) anon21_Then_correct) (=> (= (ControlFlow 0 19) 18) anon21_Else_correct))))
(let ((anon20_Else_correct true))
(let ((anon5_correct  (=> (and (forall ((|key#1| T@U) ) (!  (=> (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType |key#1|)) |_module.__default.P#canCall|)
 :qid |gitissue1165dfy.8:12|
 :skolemid |592|
 :pattern ( (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType |key#1|)))
)) (= |m#0@1| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#1| TInt (|Set#Union| |s0#0| |s1#0|) _module.__default.P)) (|lambda#2| ($Box boolType (Lit boolType (bool_2_U true)))) (TMap TInt TBool)))) (and (=> (= (ControlFlow 0 20) 19) anon20_Then_correct) (=> (= (ControlFlow 0 20) 2) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (not (and (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#0@0|))) _module.__default.P)) (= (ControlFlow 0 22) 20)) anon5_correct)))
(let ((anon19_Then_correct  (=> (and (and (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#0@0|))) _module.__default.P) (= (ControlFlow 0 21) 20)) anon5_correct)))
(let ((anon18_Else_correct  (=> (not (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#0@0|)))) (and (=> (= (ControlFlow 0 24) 21) anon19_Then_correct) (=> (= (ControlFlow 0 24) 22) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (and (|Set#IsMember| (|Set#Union| |s0#0| |s1#0|) ($Box intType (int_2_U |key#0@0|))) |_module.__default.P#canCall|) (and (=> (= (ControlFlow 0 23) 21) anon19_Then_correct) (=> (= (ControlFlow 0 23) 22) anon19_Else_correct)))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is MapType |m#0@0| (TMap TInt TBool)) ($IsAlloc MapType |m#0@0| (TMap TInt TBool) $Heap)) (and (=> (= (ControlFlow 0 26) 25) anon17_Then_correct) (=> (= (ControlFlow 0 26) 1) anon17_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |s0#0| (TSet TInt)) ($IsAlloc SetType |s0#0| (TSet TInt) $Heap)) (and ($Is SetType |s1#0| (TSet TInt)) ($IsAlloc SetType |s1#0| (TSet TInt) $Heap))) (=> (and (and (and ($Is MapType |m#0| (TMap TInt TBool)) ($IsAlloc MapType |m#0| (TMap TInt TBool) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 27) 26))) anon0_correct)))))
