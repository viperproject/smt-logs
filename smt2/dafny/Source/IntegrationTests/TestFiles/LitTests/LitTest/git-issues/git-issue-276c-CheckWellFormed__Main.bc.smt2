...
(let ((anon11_Else_correct  (=> (and (|Seq#Equal| Main.__default.s Main.__default.s) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (not (|Seq#Equal| Main.__default.s Main.__default.s)) (= (ControlFlow 0 6) 4)) anon6_correct)))
...
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 (ite  (not (|Seq#Equal| Main.__default.s Main.__default.s)) 30 40))))))
