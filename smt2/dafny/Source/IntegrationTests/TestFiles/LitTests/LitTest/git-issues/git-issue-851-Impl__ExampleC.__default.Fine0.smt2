...
(set-info :boogie-vc-id Impl$$ExampleC.__default.Fine0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |d#0| null)) (not true))) (=> (or (not (= |d#0| null)) (not true)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (U_2_bool (Lit boolType (bool_2_U false)))) (and (= $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (U_2_bool (Lit boolType (bool_2_U false)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |d#0| Tclass.ExampleC.D) ($IsAlloc refType |d#0| Tclass.ExampleC.D $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
