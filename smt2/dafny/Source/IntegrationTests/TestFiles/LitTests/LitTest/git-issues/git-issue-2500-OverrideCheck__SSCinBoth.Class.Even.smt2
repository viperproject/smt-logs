...
(set-info :boogie-vc-id OverrideCheck$$SSCinBoth.Class.Even)
...
(assert (not
 ...
 :qid |gitissue2500dfy.74:15|
 :skolemid |1684|
)) (=> (and (or (= |i#0@@9| (LitInt 0)) (= (= (Mod |i#0@@9| (LitInt 2)) (LitInt 0)) (SSCinBoth.Class.Odd ($LS $LZ) this@@9 (- |i#0@@9| 1)))) (= (ControlFlow 0 2) (- 0 1))) (or (= |i#0@@9| (LitInt 0)) (= (= (Mod |i#0@@9| (LitInt 2)) (LitInt 0)) (SSCinBoth.Class.Odd ($LS ($LS $LZ)) this@@9 (- |i#0@@9| 1))))))))))))
