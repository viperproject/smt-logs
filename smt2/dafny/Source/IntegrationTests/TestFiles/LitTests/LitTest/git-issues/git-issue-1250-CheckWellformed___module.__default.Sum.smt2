...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@0 T@U) (|n#0@@1| Int) (|f#0@@3| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| (LitInt |n#0@@1|) |f#0@@3|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (<= (LitInt 0) |n#0@@1|)) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt))))) (and (=> (or (not (= (LitInt |n#0@@1|) (LitInt 0))) (not true)) (|_module.__default.Sum#canCall| (LitInt (- |n#0@@1| 1)) |f#0@@3|)) (= (_module.__default.Sum ($LS $ly@@1) (LitInt |n#0@@1|) |f#0@@3|) (+ (U_2_int ($Unbox intType (Apply1 Tclass._System.nat TInt $Heap@@0 |f#0@@3| ($Box intType (int_2_U (LitInt |n#0@@1|)))))) (ite (= (LitInt |n#0@@1|) (LitInt 0)) 0 (_module.__default.Sum ($LS $ly@@1) (LitInt (- |n#0@@1| 1)) |f#0@@3|))))))
 :qid |gitissue1250dfy.20:16|
 :weight 3
 :skolemid |543|
 :pattern ( (_module.__default.Sum ($LS $ly@@1) (LitInt |n#0@@1|) |f#0@@3|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@2 T@U) ($Heap@@1 T@U) (|n#0@@2| Int) (|f#0@@6| T@U) ) (!  (=> (or (|_module.__default.Sum#canCall| (LitInt |n#0@@2|) (Lit HandleTypeType |f#0@@6|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (<= (LitInt 0) |n#0@@2|)) ($Is HandleTypeType |f#0@@6| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt))))) (and (=> (or (not (= (LitInt |n#0@@2|) (LitInt 0))) (not true)) (|_module.__default.Sum#canCall| (LitInt (- |n#0@@2| 1)) (Lit HandleTypeType |f#0@@6|))) (= (_module.__default.Sum ($LS $ly@@2) (LitInt |n#0@@2|) (Lit HandleTypeType |f#0@@6|)) (+ (U_2_int ($Unbox intType (Apply1 Tclass._System.nat TInt $Heap@@1 (Lit HandleTypeType |f#0@@6|) ($Box intType (int_2_U (LitInt |n#0@@2|)))))) (ite (= (LitInt |n#0@@2|) (LitInt 0)) 0 (_module.__default.Sum ($LS $ly@@2) (LitInt (- |n#0@@2| 1)) (Lit HandleTypeType |f#0@@6|)))))))
 :qid |gitissue1250dfy.20:16|
 :weight 3
 :skolemid |544|
 :pattern ( (_module.__default.Sum ($LS $ly@@2) (LitInt |n#0@@2|) (Lit HandleTypeType |f#0@@6|)) ($IsGoodHeap $Heap@@1))
))))
...
(let ((anon9_Else_correct  (=> (or (not (= |n#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 7)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (= |##n#0@0| (- |n#0@@3| 1)) (=> (and ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@@2) ($IsAlloc HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt) $Heap@@2)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< |##n#0@0| |n#0@@3|)) (=> (< |##n#0@0| |n#0@@3|) (=> (and (|_module.__default.Sum#canCall| (- |n#0@@3| 1) |f#0@@7|) (= (ControlFlow 0 4) 2)) anon6_correct))))))))))))
(let ((anon9_Then_correct  (=> (and (= |n#0@@3| (LitInt 0)) (= (ControlFlow 0 3) 2)) anon6_correct)))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon8_Then_correct) (=> (= (ControlFlow 0 8) 3) anon9_Then_correct)) (=> (= (ControlFlow 0 8) 4) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (<= (LitInt 0) |n#0@@3|) ($Is HandleTypeType |f#0@@7| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
