...
(set-info :boogie-vc-id Impl$$_module.__default.Bv8)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |v#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U (bvsub #x00 (bvsub #x00 #x80))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |v#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x80))))) (=> (= |v#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x80)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= |v#0@0| (U_2_bv8 (Lit bv8Type (bv8_2_U (bvsub #x00 (bvsub #x00 #x80))))))))))))
