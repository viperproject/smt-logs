...
(assert (distinct TInt TagInt alloc Tagclass._module.MyClass Tagclass._module.MyClass? tytagFamily$MyClass)
)
...
(declare-fun |_module.MyClass.Foo#canCall| (T@U Int) Bool)
(declare-fun |defass#c#0| () Bool)
(declare-fun |c#0@@1| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.TestException)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (or (not (= call1formal@this null)) (not true)) (and ($Is refType call1formal@this Tclass._module.MyClass) ($IsAlloc refType call1formal@this Tclass._module.MyClass $Heap))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call1formal@this@0 null)) (not true)) (and ($Is refType call1formal@this@0 Tclass._module.MyClass) ($IsAlloc refType call1formal@this@0 Tclass._module.MyClass $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call1formal@this@0) alloc))))) (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |gitissue2013dfy.84:3|
 :skolemid |3003|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= call1formal@this@0 null)) (not true))) (=> ($IsAllocBox ($Box refType call1formal@this@0) Tclass._module.MyClass? $Heap@0) (=> (and (and (= |##u#0@0| (LitInt 2)) ($IsAlloc intType (int_2_U |##u#0@0|) TInt $Heap@0)) (and (|_module.MyClass.Foo#canCall| call1formal@this@0 (LitInt 2)) (|_module.MyClass.Foo#canCall| call1formal@this@0 (LitInt 2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= call1formal@this@0 null)) (not true)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#c#0| (and ($Is refType |c#0@@1| Tclass._module.MyClass) ($IsAlloc refType |c#0@@1| Tclass._module.MyClass $Heap))) true) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
