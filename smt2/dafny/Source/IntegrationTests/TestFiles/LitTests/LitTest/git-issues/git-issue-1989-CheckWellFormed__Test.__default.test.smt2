...
(declare-fun |x#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$Test.__default.test)
...
(let ((anon4_Else_correct  (=> (and (< |i#0@@0| (LitInt 0)) (= (ControlFlow 0 4) 1)) anon3_correct)))
(let ((anon4_Then_correct  (=> (<= (LitInt 0) |i#0@@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |a#0@@3| null)) (not true))) (=> (or (not (= |a#0@@3| null)) (not true)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@2 alloc |a#0@@3|)) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and ($Is refType |a#0@@3| (Tclass._System.array Tclass.Test.C)) ($IsAlloc refType |a#0@@3| (Tclass._System.array Tclass.Test.C) $Heap@@2))) (and (and ($Is refType |x#0| Tclass.Test.C) ($IsAlloc refType |x#0| Tclass.Test.C $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
