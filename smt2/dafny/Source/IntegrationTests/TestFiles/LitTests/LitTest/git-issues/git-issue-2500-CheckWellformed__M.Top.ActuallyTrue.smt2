...
(assert (distinct alloc Tagclass.M.Top? Tagclass.M.Top tytagFamily$Top)
)
...
(assert (forall (($o T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o Tclass.M.Top? $h@@0)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |534|
 :pattern ( ($IsAlloc refType $o Tclass.M.Top? $h@@0))
)))
...
(assert (forall ((|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| Tclass.M.Top)  (and ($Is refType |c#0@@0| Tclass.M.Top?) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |538|
 :pattern ( ($Is refType |c#0@@0| Tclass.M.Top))
 :pattern ( ($Is refType |c#0@@0| Tclass.M.Top?))
)))
...
(assert (= (Tag Tclass.M.Top) Tagclass.M.Top))
(assert (= (TagFamily Tclass.M.Top) tytagFamily$Top))
(assert (forall (($o@@1 T@U) ) (! (= ($Is refType $o@@1 Tclass.M.Top?)  (or (= $o@@1 null) (implements$M.Top (dtype $o@@1))))
 :qid |unknown.0:0|
 :skolemid |533|
 :pattern ( ($Is refType $o@@1 Tclass.M.Top?))
)))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$M.Top.ActuallyTrue)
...
(let ((anon4_Then_correct  (=> (and ($IsAllocBox ($Box refType this@@0) Tclass.M.Top? $Heap) (= (ControlFlow 0 2) (- 0 1))) (= this@@0 this@@0))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.M.Top) ($IsAlloc refType this@@0 Tclass.M.Top $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
