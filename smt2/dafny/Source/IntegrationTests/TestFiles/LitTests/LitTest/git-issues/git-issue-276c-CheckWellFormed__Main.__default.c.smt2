...
(set-info :boogie-vc-id CheckWellFormed$$Main.__default.c)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 4)) (< (LitInt 4) (|Seq#Length| Main.__default.s))))))
