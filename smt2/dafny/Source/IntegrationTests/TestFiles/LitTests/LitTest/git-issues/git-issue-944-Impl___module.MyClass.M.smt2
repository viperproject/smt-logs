...
(assert (distinct TReal TagReal alloc Tagclass._module.Result Tagclass._module.MyClass? Tagclass._module.MyClass tytagFamily$Result tytagFamily$MyClass)
)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module.Result$T T@U) (this T@U) ) (!  (=> (and (or (|_module.Result.PropagateFailure#canCall| _module.Result$T this) (and (< 1 $FunctionContextHeight) ($IsAlloc DatatypeTypeType this (Tclass._module.Result _module.Result$T) $Heap))) ($IsGoodHeap $Heap)) ($IsAlloc DatatypeTypeType (_module.Result.PropagateFailure _module.Result$T this) (Tclass._module.Result _module.Result$T) $Heap))
 :qid |gitissue944dfy.14:12|
 :skolemid |518|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Result.PropagateFailure _module.Result$T this) (Tclass._module.Result _module.Result$T) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module.Result$T@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.Result.PropagateFailure#canCall| _module.Result$T@@0 this@@0) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this@@0 (Tclass._module.Result _module.Result$T@@0)))) ($Is DatatypeTypeType (_module.Result.PropagateFailure _module.Result$T@@0 this@@0) (Tclass._module.Result _module.Result$T@@0)))
 :qid |unknown.0:0|
 :skolemid |517|
 :pattern ( (_module.Result.PropagateFailure _module.Result$T@@0 this@@0))
))))
...
(assert (forall ((_module.Result$T@@2 T@U) ) (! (= (Tclass._module.Result_0 (Tclass._module.Result _module.Result$T@@2)) _module.Result$T@@2)
 :qid |unknown.0:0|
 :skolemid |480|
