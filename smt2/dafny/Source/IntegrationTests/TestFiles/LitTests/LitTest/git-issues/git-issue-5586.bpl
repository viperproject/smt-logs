// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5586.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5586-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5586.dfy
...
function _module.__default.P(t#0: ref) : bool
uses {
// definition axiom for _module.__default.P (revealed)
axiom {:id "id0"} 1 <= $FunctionContextHeight
   ==> (forall t#0: ref :: 
    { _module.__default.P(t#0) } 
    _module.__default.P#canCall(t#0)
         || (1 < $FunctionContextHeight && $Is(t#0, Tclass._module.Trait()))
       ==> _module.__default.P(t#0) == $Is(t#0, Tclass._module.Class()));
// definition axiom for _module.__default.P for all literals (revealed)
axiom {:id "id1"} 1 <= $FunctionContextHeight
   ==> (forall t#0: ref :: 
    {:weight 3} { _module.__default.P(Lit(t#0)) } 
    _module.__default.P#canCall(Lit(t#0))
         || (1 < $FunctionContextHeight && $Is(t#0, Tclass._module.Trait()))
       ==> _module.__default.P(Lit(t#0)) == $Is(Lit(t#0), Tclass._module.Class()));
}

function _module.__default.P#canCall(t#0: ref) : bool;
...
axiom (forall t#0: ref :: 
  { _module.__default.P#requires(t#0) } 
  $Is(t#0, Tclass._module.Trait()) ==> _module.__default.P#requires(t#0) == true);
...
procedure {:verboseName "P (well-formedness)"} CheckWellformed$$_module.__default.P(t#0: ref where $Is(t#0, Tclass._module.Trait()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M (well-formedness)"} CheckWellFormed$$_module.__default.M(u#0: ref
       where $Is(u#0, Tclass._module.Trait()) && $IsAlloc(u#0, Tclass._module.Trait(), $Heap));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M (call)"} Call$$_module.__default.M(u#0: ref
       where $Is(u#0, Tclass._module.Trait()) && $IsAlloc(u#0, Tclass._module.Trait(), $Heap));
  modifies $Heap;
...
procedure {:verboseName "M (correctness)"} Impl$$_module.__default.M(u#0: ref
       where $Is(u#0, Tclass._module.Trait()) && $IsAlloc(u#0, Tclass._module.Trait(), $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M (correctness)"} Impl$$_module.__default.M(u#0: ref) returns ($_reverifyPost: bool)
{
  ...
  var ##t#0: ref;
    ...
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-5586.dfy(14,3)
    ##t#0 := u#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##t#0, Tclass._module.Trait(), $Heap);
    assume _module.__default.P#canCall(u#0);
    assume _module.__default.P#canCall(u#0);
    assert {:id "id3"} {:subsumption 0} _module.__default.P#canCall(u#0)
       ==> _module.__default.P(u#0) || $Is(u#0, Tclass._module.Class());
    assume {:id "id4"} _module.__default.P(u#0);
}
