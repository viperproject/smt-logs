...
(assert (forall ((m@@7 T@U) (v@@2 T@U) ) (! (= (|Set#IsMember| (|Map#Values| m@@7) v@@2) (exists ((u@@3 T@U) ) (!  (and (|Set#IsMember| (|Map#Domain| m@@7) u@@3) (= v@@2 (MapType1Select BoxType BoxType (|Map#Elements| m@@7) u@@3)))
...
(assert (forall ((v@@3 T@U) (t0@@2 T@U) (t1@@1 T@U) ) (! (= ($Is MapType v@@3 (TMap t0@@2 t1@@1)) (forall ((bx@@4 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@3) bx@@4) (and ($IsBox (MapType1Select BoxType BoxType (|Map#Elements| v@@3) bx@@4) t1@@1) ($IsBox bx@@4 t0@@2)))
 :qid |DafnyPreludebpl.261:19|
 :skolemid |55|
 :pattern ( (MapType1Select BoxType BoxType (|Map#Elements| v@@3) bx@@4))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.map0)
...
(let ((anon9_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |k#0@0|))) (= (U_2_int ($Unbox intType (MapType1Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |k#0@0|))))) (LitInt 0))) (= (ControlFlow 0 6) 3)) anon5_correct)))
(let ((anon9_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |k#0@0|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |k#0@0|)))) (=> (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |k#0@0|))) (=> (and (= (U_2_int ($Unbox intType (MapType1Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |k#0@0|))))) (LitInt 0)) (= (ControlFlow 0 4) 3)) anon5_correct))))))
(let ((anon8_Then_correct  (=> ($Is MapType |m#0| (TMap TInt TInt)) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|k#2| Int) ) (!  (=> (|Set#IsMember| (|Map#Domain| |Map#Empty|) ($Box intType (int_2_U |k#2|))) (= (U_2_int ($Unbox intType (MapType1Select BoxType BoxType (|Map#Elements| (Lit MapType |Map#Empty|)) ($Box intType (int_2_U |k#2|))))) (LitInt 0)))
