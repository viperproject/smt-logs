...
(declare-fun |lambda#17| (T@U T@U T@U Bool Int) T@U)
...
(assert (distinct TBool TInt TagBool TagInt TagISet TagIMap alloc Tagclass._System.object? Tagclass._System.object |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.OtherBindersInStatements.C Tagclass.OtherBindersInStatements.C? tytagFamily$object |tytagFamily$_tuple#2| tytagFamily$C)
)
...
(assert (forall ((v T@U) (t0@@0 T@U) ) (! (= ($Is (MapType0Type BoxType boolType) v (TISet t0@@0)) (forall ((bx@@0 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType v bx@@0)) ($IsBox bx@@0 t0@@0))
 :qid |DafnyPreludebpl.244:11|
 :skolemid |2511|
 :pattern ( (MapType0Select BoxType boolType v bx@@0))
)))
...
(assert (forall ((bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 Tclass.OtherBindersInStatements.C) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) Tclass.OtherBindersInStatements.C)))
 :qid |unknown.0:0|
 :skolemid |2950|
 :pattern ( ($IsBox bx@@3 Tclass.OtherBindersInStatements.C))
)))
...
(assert (forall ((v@@2 T@U) (t0@@1 T@U) (h@@0 T@U) ) (! (= ($IsAlloc (MapType0Type BoxType boolType) v@@2 (TISet t0@@1) h@@0) (forall ((bx@@5 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType v@@2 bx@@5)) ($IsAllocBox bx@@5 t0@@1 h@@0))
 :qid |DafnyPreludebpl.303:11|
 :skolemid |2532|
 :pattern ( (MapType0Select BoxType boolType v@@2 bx@@5))
)))
...
(assert (forall ((v@@4 T@U) (t0@@2 T@U) (t1@@0 T@U) (h@@1 T@U) ) (! (= ($IsAlloc IMapType v@@4 (TIMap t0@@2 t1@@0) h@@1) (forall ((bx@@6 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| v@@4) bx@@6)) (and ($IsAllocBox (MapType0Select BoxType BoxType (|IMap#Elements| v@@4) bx@@6) t1@@0 h@@1) ($IsAllocBox bx@@6 t0@@2 h@@1)))
 :qid |DafnyPreludebpl.327:19|
 :skolemid |2540|
 :pattern ( (MapType0Select BoxType BoxType (|IMap#Elements| v@@4) bx@@6))
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| v@@4) bx@@6))
)))
...
(assert (forall ((v@@7 T@U) (t0@@3 T@U) (t1@@1 T@U) ) (! (= ($Is IMapType v@@7 (TIMap t0@@3 t1@@1)) (forall ((bx@@9 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| v@@7) bx@@9)) (and ($IsBox (MapType0Select BoxType BoxType (|IMap#Elements| v@@7) bx@@9) t1@@1) ($IsBox bx@@9 t0@@3)))
 :qid |DafnyPreludebpl.276:19|
 :skolemid |2521|
 :pattern ( (MapType0Select BoxType BoxType (|IMap#Elements| v@@7) bx@@9))
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| v@@7) bx@@9))
)))
...
(assert (forall ((bx@@10 T@U) (s T@U) (t@@8 T@U) ) (!  (=> ($IsBox bx@@10 (TIMap s t@@8)) (and (= ($Box IMapType ($Unbox IMapType bx@@10)) bx@@10) ($Is IMapType ($Unbox IMapType bx@@10) (TIMap s t@@8))))
 :qid |DafnyPreludebpl.210:15|
 :skolemid |2500|
 :pattern ( ($IsBox bx@@10 (TIMap s t@@8)))
)))
...
(assert (forall ((a@@1 T@U) (b@@1 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@12 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType a@@1 bx@@12)) (and ($IsBox bx@@12 t0@@5) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@12) t1@@3)))
...
(assert (= (Tag Tclass.OtherBindersInStatements.C?) Tagclass.OtherBindersInStatements.C?))
(assert (= (TagFamily Tclass.OtherBindersInStatements.C?) tytagFamily$C))
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) (|l#4| Int) (|$w#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#17| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4|) |$w#0@@0|))  (and (and ($IsBox |$w#0@@0| |l#0@@1|) ($IsAllocBox |$w#0@@0| |l#1@@0| |l#2@@0|)) (exists ((|a#0#0#0@@0| T@U) ) (!  (and |l#3@@0| (= (U_2_int ($Unbox intType |$w#0@@0|)) |l#4|))
 :qid |gitissue851dfy.192:19|
 :skolemid |2984|
))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |4126|
 :pattern ( (MapType0Select BoxType boolType (|lambda#17| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0| |l#4|) |$w#0@@0|))
)))
...
(set-info :boogie-vc-id Impl$$OtherBindersInStatements.__default.MapComprehension3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon7_correct  (=> (forall ((|a#1#0#0@@0| T@U) ) (!  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (LitInt 20) (LitInt 20))))
 :qid |gitissue851dfy.192:19|
 :skolemid |2986|
)) (=> (and (= |b#0@0| (|IMap#Glue| (|lambda#17| TInt TInt $Heap (U_2_bool (Lit boolType (bool_2_U true))) (LitInt 20)) (|lambda#9| ($Box boolType (bool_2_U (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) (TIMap TInt TBool))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true))))))
...
(let ((anon11_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (or (not (= (LitInt 20) (LitInt 20))) (not true)) (= (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) (=> (or (or (not (= (LitInt 20) (LitInt 20))) (not true)) (= (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)) (= (LitInt (Div 5 (LitInt 0))) (LitInt 19)))) (=> (= (ControlFlow 0 4) 2) anon7_correct))))))
(let ((anon10_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 10) 4) anon11_Then_correct) (=> (= (ControlFlow 0 10) 6) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (and (=> (= (ControlFlow 0 7) 4) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct))))))))))
(let ((anon9_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 12) 7) anon10_Then_correct) (=> (= (ControlFlow 0 12) 10) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 11) 7) anon10_Then_correct) (=> (= (ControlFlow 0 11) 10) anon10_Else_correct)))))
(let ((anon8_Then_correct  (=> (and (and ($Is refType |c#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@0| Tclass.OtherBindersInStatements.C $Heap)) (and ($Is refType |c#prime#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#prime#0@0| Tclass.OtherBindersInStatements.C $Heap))) (and (=> (= (ControlFlow 0 13) 11) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is IMapType |b#0| (TIMap TInt TBool)) ($IsAlloc IMapType |b#0| (TIMap TInt TBool) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 15) 14))) anon0_correct))))
