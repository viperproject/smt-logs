...
(assert (forall ((a@@1 T@U) (b@@1 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@12 T@U) )  (=> (U_2_bool (MapType0Select BoxType boolType a@@1 bx@@12)) (and ($IsBox bx@@12 t0@@5) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@12) t1@@3)))) ($Is IMapType (|IMap#Glue| a@@1 b@@1 (TIMap t0@@5 t1@@3)) (TIMap t0@@5 t1@@3)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon7_correct  (=> (forall ((|a#1#0#0@@0| T@U) )  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (LitInt 20) (LitInt 20))))) (=> (and (= |b#0@0| (|IMap#Glue| (|lambda#17| TInt TInt $Heap (U_2_bool (Lit boolType (bool_2_U true))) (LitInt 20)) (|lambda#9| ($Box boolType (bool_2_U (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) (TIMap TInt TBool))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true))))))
