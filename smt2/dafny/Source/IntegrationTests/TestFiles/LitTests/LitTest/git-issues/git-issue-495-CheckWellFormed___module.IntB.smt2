...
(set-info :boogie-vc-id CheckWellFormed$$_module.IntB)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (and (= |newtype$check#3@0| (LitInt 0)) (= (ControlFlow 0 4) (- 0 3))) (= (LitInt (Mod 0 (LitInt 2))) (LitInt 0)))))
(let ((anon5_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (and (= |newtype$check#0@0| (LitInt 2)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 2) 0)) (not true))))))
