...
(declare-fun _module.Cl.True (T@U) Bool)
(declare-fun |_module.Cl.True#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|_module.Cl.True#canCall| this) (and (< 0 $FunctionContextHeight) (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.Cl)))) (= (_module.Cl.True this) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |gitissue2500dfy.21:13|
 :skolemid |2244|
 :pattern ( (_module.Cl.True this))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|_module.Cl.True#canCall| (Lit refType this@@0)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.Cl)))) (= (_module.Cl.True (Lit refType this@@0)) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |gitissue2500dfy.21:13|
 :weight 3
 :skolemid |2245|
 :pattern ( (_module.Cl.True (Lit refType this@@0)))
))))
(push 1)
...
(declare-fun |ret#0| () Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id OverrideCheck$$_module.Cl.True)
...
(assert (not
 ...
 :qid |gitissue2500dfy.21:13|
 :skolemid |2247|
)) (=> (and (= (_module.Cl.True this@@1) |ret#0|) (= (ControlFlow 0 2) (- 0 1))) |ret#0|)))))))
