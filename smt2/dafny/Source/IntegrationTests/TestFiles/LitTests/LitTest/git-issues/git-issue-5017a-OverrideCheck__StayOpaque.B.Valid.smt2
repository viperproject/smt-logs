...
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass.StayOpaque.B $h@@0) ($IsAlloc refType |c#0@@0| Tclass.StayOpaque.B? $h@@0))
 :qid |unknown.0:0|
 :skolemid |2055|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.StayOpaque.B $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass.StayOpaque.B? $h@@0))
)))
...
(assert (forall (($o@@0 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass.StayOpaque.B? $h@@2)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2047|
 :pattern ( ($IsAlloc refType $o@@0 Tclass.StayOpaque.B? $h@@2))
)))
...
(set-info :boogie-vc-id OverrideCheck$$StayOpaque.B.Valid)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.StayOpaque.B) ($IsAlloc refType this Tclass.StayOpaque.B $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
