...
(assert (forall ((x@@5 Int) (y Int) ) (! (= (Mul x@@5 y) (* x@@5 y))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (= |forty_two#0| (Mul |forty_two#0| |one#0|)) (= (ControlFlow 0 3) 2))) anon0_correct)))
