...
(assert (distinct TBool TagBool TagSet TagMap alloc Tagclass._System.object? Tagclass._System.object |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 Tagclass.OtherBindersInStatements.C Tagclass.OtherBindersInStatements.C? tytagFamily$object |tytagFamily$_tuple#2| tytagFamily$C)
)
...
(set-info :boogie-vc-id Impl$$OtherBindersInStatements.__default.MapComprehension1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon3_correct  (=> (and (= |b#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#4| Tclass.OtherBindersInStatements.C Tclass.OtherBindersInStatements.C $Heap (U_2_bool (Lit boolType (bool_2_U true))))) (|lambda#9| ($Box boolType (bool_2_U (= (LitInt (Div 5 (LitInt 0))) (LitInt 19))))) (TMap Tclass.OtherBindersInStatements.C TBool))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon5_Else_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 7) 2)) anon3_correct)))
(let ((anon5_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (=> (= (ControlFlow 0 4) 2) anon3_correct)))))))))
(let ((anon4_Then_correct  (=> (and ($Is refType |c#0@0| Tclass.OtherBindersInStatements.C) ($IsAlloc refType |c#0@0| Tclass.OtherBindersInStatements.C $Heap)) (and (=> (= (ControlFlow 0 8) 4) anon5_Then_correct) (=> (= (ControlFlow 0 8) 7) anon5_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |b#0| (TMap Tclass.OtherBindersInStatements.C TBool)) ($IsAlloc MapType |b#0| (TMap Tclass.OtherBindersInStatements.C TBool) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
