...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TestAOK)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (|ORD#IsNat| |o#0|) (= (ControlFlow 0 2) (- 0 1))) (|ORD#IsNat| |o#0|)))))
