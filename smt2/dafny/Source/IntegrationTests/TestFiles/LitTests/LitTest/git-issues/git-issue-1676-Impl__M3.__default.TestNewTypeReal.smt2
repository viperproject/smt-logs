...
(declare-fun Tagclass.M3.NewTypeReal () T@U)
(declare-fun Tagclass.M3.MyNewTypeReal () T@U)
(declare-fun tytagFamily$NewTypeReal () T@U)
(declare-fun tytagFamily$MyNewTypeReal () T@U)
...
(declare-fun Tclass.M3.NewTypeReal () T@U)
(declare-fun Tclass.M3.MyNewTypeReal () T@U)
...
(assert (distinct TagMultiSet alloc Tagclass.M3.NewTypeReal Tagclass.M3.MyNewTypeReal tytagFamily$NewTypeReal tytagFamily$MyNewTypeReal)
)
(assert (forall ((|r#0| T@U) ($h T@U) ) (! ($IsAlloc realType |r#0| Tclass.M3.NewTypeReal $h)
 :qid |unknown.0:0|
 :skolemid |2044|
 :pattern ( ($IsAlloc realType |r#0| Tclass.M3.NewTypeReal $h))
)))
(assert (forall ((|n#0| T@U) ($h@@0 T@U) ) (! ($IsAlloc realType |n#0| Tclass.M3.MyNewTypeReal $h@@0)
 :qid |unknown.0:0|
 :skolemid |2048|
 :pattern ( ($IsAlloc realType |n#0| Tclass.M3.MyNewTypeReal $h@@0))
)))
...
(assert (forall ((|n#0@@0| T@U) ) (! (= ($Is realType |n#0@@0| Tclass.M3.MyNewTypeReal)  (and (and (<= (LitReal 0.0) (U_2_real |n#0@@0|)) (< (U_2_real |n#0@@0|) 100.0)) (<= (LitReal 2.0) (U_2_real |n#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |2047|
 :pattern ( ($Is realType |n#0@@0| Tclass.M3.MyNewTypeReal))
)))
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass.M3.NewTypeReal) (and (= ($Box realType ($Unbox realType bx)) bx) ($Is realType ($Unbox realType bx) Tclass.M3.NewTypeReal)))
 :qid |unknown.0:0|
 :skolemid |2023|
 :pattern ( ($IsBox bx Tclass.M3.NewTypeReal))
)))
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass.M3.MyNewTypeReal) (and (= ($Box realType ($Unbox realType bx@@0)) bx@@0) ($Is realType ($Unbox realType bx@@0) Tclass.M3.MyNewTypeReal)))
 :qid |unknown.0:0|
 :skolemid |2024|
 :pattern ( ($IsBox bx@@0 Tclass.M3.MyNewTypeReal))
)))
...
(assert (= (Tag Tclass.M3.NewTypeReal) Tagclass.M3.NewTypeReal))
(assert (= (TagFamily Tclass.M3.NewTypeReal) tytagFamily$NewTypeReal))
(assert (= (Tag Tclass.M3.MyNewTypeReal) Tagclass.M3.MyNewTypeReal))
(assert (= (TagFamily Tclass.M3.MyNewTypeReal) tytagFamily$MyNewTypeReal))
(assert (forall ((|r#0@@0| T@U) ) (! (= ($Is realType |r#0@@0| Tclass.M3.NewTypeReal)  (and (<= (LitReal 0.0) (U_2_real |r#0@@0|)) (< (U_2_real |r#0@@0|) 100.0)))
 :qid |unknown.0:0|
 :skolemid |2043|
 :pattern ( ($Is realType |r#0@@0| Tclass.M3.NewTypeReal))
)))
...
(set-info :boogie-vc-id Impl$$M3.__default.TestNewTypeReal)
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is MultiSetType (|MultiSet#Union| |s1#0@0| |s0#0@0|) (TMultiSet Tclass.M3.MyNewTypeReal)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is MultiSetType (|MultiSet#Union| |s0#0@0| |s1#0@0|) (TMultiSet Tclass.M3.MyNewTypeReal)))))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |s0#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box realType (real_2_U |x0#0|)))) (= |s1#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box realType (real_2_U |x1#0|))))) (and (and (and (and (and (and (=> (= (ControlFlow 0 11) 1) anon8_Then_correct) (=> (= (ControlFlow 0 11) 2) anon9_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 8) anon13_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon13_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitReal 0.0) |x0#0|) (< |x0#0| 100.0))) (=> (and (and (and (<= (LitReal 0.0) |x1#0|) (< |x1#0| 100.0)) (<= (LitReal 2.0) |x1#0|)) (and (and ($Is MultiSetType |s0#0| (TMultiSet Tclass.M3.NewTypeReal)) ($IsAlloc MultiSetType |s0#0| (TMultiSet Tclass.M3.NewTypeReal) $Heap)) true)) (=> (and (and (and (and (and ($Is MultiSetType |s1#0| (TMultiSet Tclass.M3.MyNewTypeReal)) ($IsAlloc MultiSetType |s1#0| (TMultiSet Tclass.M3.MyNewTypeReal) $Heap)) true) (and (and ($Is MultiSetType |a#0_0| (TMultiSet Tclass.M3.NewTypeReal)) ($IsAlloc MultiSetType |a#0_0| (TMultiSet Tclass.M3.NewTypeReal) $Heap)) true)) (and (and (and ($Is MultiSetType |a#1_0| (TMultiSet Tclass.M3.NewTypeReal)) ($IsAlloc MultiSetType |a#1_0| (TMultiSet Tclass.M3.NewTypeReal) $Heap)) true) (and (and ($Is MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyNewTypeReal)) ($IsAlloc MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyNewTypeReal) $Heap)) true))) (and (and (and (and ($Is MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyNewTypeReal)) ($IsAlloc MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyNewTypeReal) $Heap)) true) (and (and ($Is MultiSetType |a#4_0| (TMultiSet Tclass.M3.NewTypeReal)) ($IsAlloc MultiSetType |a#4_0| (TMultiSet Tclass.M3.NewTypeReal) $Heap)) true)) (and (and (and ($Is MultiSetType |a#5_0| (TMultiSet Tclass.M3.NewTypeReal)) ($IsAlloc MultiSetType |a#5_0| (TMultiSet Tclass.M3.NewTypeReal) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 12) 11))))) anon0_correct)))))
