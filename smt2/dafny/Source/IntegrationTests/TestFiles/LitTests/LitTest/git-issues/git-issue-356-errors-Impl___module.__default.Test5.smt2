...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is charType |ch#0| TChar) true)) (and (and (= 0 $FunctionContextHeight) (<= (LitReal 0.0) |r#0|)) (and (= |r#0| (q@Real (q@Int |r#0|))) (= (ControlFlow 0 4) 2)))) anon0_correct)))
