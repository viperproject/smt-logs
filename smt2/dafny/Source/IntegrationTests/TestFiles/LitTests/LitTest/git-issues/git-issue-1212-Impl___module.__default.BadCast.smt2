...
(assert (distinct TInt TagInt alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.Tuple0 Tagclass._module.K Tagclass._module.K? Tagclass._module.H Tagclass._module.H? tytagFamily$object |tytagFamily$_tuple#0| tytagFamily$K tytagFamily$H)
)
...
(assert (forall ((|c#0@@1| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0@@1| Tclass._module.K $h@@1) ($IsAlloc refType |c#0@@1| Tclass._module.K? $h@@1))
 :qid |unknown.0:0|
 :skolemid |508|
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.K $h@@1))
 :pattern ( ($IsAlloc refType |c#0@@1| Tclass._module.K? $h@@1))
)))
...
(assert (forall (($o@@2 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.K? $h@@4)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |506|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.K? $h@@4))
)))
(assert (forall (($o@@3 T@U) ) (!  (=> ($Is refType $o@@3 Tclass._module.K?) ($Is refType $o@@3 (Tclass._module.H? TInt)))
 :qid |unknown.0:0|
 :skolemid |511|
 :pattern ( ($Is refType $o@@3 Tclass._module.K?))
)))
...
(assert (forall ((_module.H$Y@@1 T@U) (|c#0@@2| T@U) ) (! (= ($Is refType |c#0@@2| (Tclass._module.H _module.H$Y@@1))  (and ($Is refType |c#0@@2| (Tclass._module.H? _module.H$Y@@1)) (or (not (= |c#0@@2| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($Is refType |c#0@@2| (Tclass._module.H _module.H$Y@@1)))
 :pattern ( ($Is refType |c#0@@2| (Tclass._module.H? _module.H$Y@@1)))
)))
(assert (forall ((_module.H$Y@@2 T@U) ) (!  (and (= (Tag (Tclass._module.H _module.H$Y@@2)) Tagclass._module.H) (= (TagFamily (Tclass._module.H _module.H$Y@@2)) tytagFamily$H))
 :qid |unknown.0:0|
 :skolemid |484|
 :pattern ( (Tclass._module.H _module.H$Y@@2))
)))
...
(assert (forall ((|c#0@@4| T@U) ) (! (= ($Is refType |c#0@@4| Tclass._module.K)  (and ($Is refType |c#0@@4| Tclass._module.K?) (or (not (= |c#0@@4| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |507|
 :pattern ( ($Is refType |c#0@@4| Tclass._module.K))
 :pattern ( ($Is refType |c#0@@4| Tclass._module.K?))
)))
(assert (forall (($o@@4 T@U) ($heap T@U) ) (!  (=> ($IsAlloc refType $o@@4 Tclass._module.K? $heap) ($IsAlloc refType $o@@4 (Tclass._module.H? TInt) $heap))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsAlloc refType $o@@4 Tclass._module.K? $heap))
)))
...
(assert (forall ((_module.H$Y@@4 T@U) ) (! (= (Tclass._module.H_0 (Tclass._module.H _module.H$Y@@4)) _module.H$Y@@4)
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( (Tclass._module.H _module.H$Y@@4))
)))
(assert (forall ((_module.H$Y@@5 T@U) ) (! (= (Tclass._module.H?_0 (Tclass._module.H? _module.H$Y@@5)) _module.H$Y@@5)
 :qid |unknown.0:0|
 :skolemid |497|
 :pattern ( (Tclass._module.H? _module.H$Y@@5))
)))
...
(assert (forall ((_module.H$Y@@6 T@U) ($o@@6 T@U) ) (! (= ($Is refType $o@@6 (Tclass._module.H? _module.H$Y@@6))  (or (= $o@@6 null) (implements$_module.H (dtype $o@@6) _module.H$Y@@6)))
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( ($Is refType $o@@6 (Tclass._module.H? _module.H$Y@@6)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.BadCast)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is refType |k#0| (Tclass._module.H Tclass._System.Tuple0))) (=> ($Is refType |k#0| (Tclass._module.H Tclass._System.Tuple0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) (= |k#0| |k#0|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |k#0| Tclass._module.K) ($IsAlloc refType |k#0| Tclass._module.K $Heap)) (=> |defass#b#0| (and ($Is refType |b#0| (Tclass._module.H Tclass._System.Tuple0)) ($IsAlloc refType |b#0| (Tclass._module.H Tclass._System.Tuple0) $Heap)))) (and (and (=> |defass#oo#0| (and ($Is refType |oo#0| Tclass._System.object) ($IsAlloc refType |oo#0| Tclass._System.object $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2)))) anon0_correct))))
