...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (and (_module.Cell.Cell_q (Lit DatatypeTypeType (|#_module.Cell.Cell| (LitInt 0)))) (= (ControlFlow 0 4) (- 0 3))) (= (LitInt (Mod (_module.Cell.x (Lit DatatypeTypeType (|#_module.Cell.Cell| (LitInt 0)))) (LitInt 2))) (LitInt 0)))))
(let ((anon5_Then_correct  (=> ($Is DatatypeTypeType |c#0| Tclass._module.Cell) (=> (and (_module.Cell.Cell_q |c#0|) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (LitInt 2) 0)) (not true))))))
