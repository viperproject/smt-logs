...
(set-info :boogie-vc-id CheckWellFormed$$SubsetTypeSubsetType.CompilableTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (|SubsetTypeSubsetType.__default.Q#canCall| (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|SubsetTypeSubsetType.__default.Q#canCall| (LitInt 0)) (or (U_2_bool (Lit boolType (bool_2_U (SubsetTypeSubsetType.__default.Q (LitInt 0))))) (U_2_bool (Lit boolType (bool_2_U  (or (not (= 0 5)) (not true)))))))) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U (< 0 8)))))))))
