...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon5_Else_correct  (=> (not (_module.Result.IsFailure TInt |call1formal@r#0@0|)) (=> (and ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) (Tclass._module.Result TInt) $Heap@4) (= (ControlFlow 0 4) (- 0 3))) (not (_module.Result.IsFailure TInt |call1formal@r#0@0|))))))
(let ((anon5_Then_correct  (=> (_module.Result.IsFailure TInt |call1formal@r#0@0|) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) (Tclass._module.Result TInt) $Heap@4) (= (ControlFlow 0 2) (- 0 1))) (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0|)) (or (_module.Result.IsFailure TInt |call1formal@r#0@0|) (_module.Result.Failure_q |call1formal@r#0@0|))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 5) (- 0 14)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 10)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 5) (- 0 13)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (=> (and (and (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc))))) (and (= (_System.array.Length $nw@1) (LitInt 10)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true))))))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and ($Is DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt) $Heap@1)))) (and (=> (= (ControlFlow 0 5) (- 0 12)) (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (LitInt 2) (LitInt 2))) (not true)))) (=> (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (LitInt 2) (LitInt 2))) (not true))) (and (=> (= (ControlFlow 0 5) (- 0 11)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 10)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@0))) (=> (= $index1@0 (IndexField (LitInt 2))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index1@0))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index1@0)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@0))) (=> (= $index2@0 (IndexField (LitInt 2))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index2@0))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index2@0)) (=> (and ($Is DatatypeTypeType |call1formal@r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call1formal@r#0| (Tclass._module.Result TInt) $Heap@@1)) (=> (and (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and ($Is DatatypeTypeType |call1formal@r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call1formal@r#0@0| (Tclass._module.Result TInt) $Heap@2))) (and (and (=> (_module.Result.Success_q |call1formal@r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |call1formal@r#0@0|))) (LitInt 200))) (= |call2formal@i#0@0| (LitInt 3))) (and (= |call3formal@j#0@0| (LitInt 4)) (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@6)))
 :qid |gitissue817cdfy.33:8|
 :skolemid |483|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@6))
))))) (and (and (and ($HeapSucc $Heap@1 $Heap@2) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) $index1@0 ($Box intType (int_2_U |call2formal@i#0@0|)))))) (and ($IsGoodHeap $Heap@3) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) $index2@0 ($Box intType (int_2_U |call3formal@j#0@0|))))))) (and (and ($IsGoodHeap $Heap@4) ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) (Tclass._module.Result TInt) $Heap@4)) (and (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0|) (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0|))))) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct)))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@1))) (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap@@1)) true)) (=> (and (and (and (and ($Is refType |aa#0| (Tclass._System.array TInt)) ($IsAlloc refType |aa#0| (Tclass._System.array TInt) $Heap@@1)) true) (and (and ($Is refType |aaa#0| (Tclass._System.array TInt)) ($IsAlloc refType |aaa#0| (Tclass._System.array TInt) $Heap@@1)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 15) 5)))) anon0_correct))))
