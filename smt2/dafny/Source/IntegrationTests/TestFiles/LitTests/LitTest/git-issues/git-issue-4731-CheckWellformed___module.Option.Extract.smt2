...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((_module.Option$T@@4 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Option.Extract#canCall| _module.Option$T@@4 (Lit DatatypeTypeType this@@1)) (and (< 0 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@1 (Tclass._module.Option _module.Option$T@@4)) (U_2_bool (Lit boolType (bool_2_U (_module.Option.Some_q (Lit DatatypeTypeType this@@1)))))))) (= (_module.Option.Extract _module.Option$T@@4 (Lit DatatypeTypeType this@@1)) (Lit BoxType (_module.Option.val (Lit DatatypeTypeType this@@1)))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |520|
 :pattern ( (_module.Option.Extract _module.Option$T@@4 (Lit DatatypeTypeType this@@1)))
))))
(assert (forall ((_module.Option$T@@5 T@U) (|a#2#0#0| T@U) ($h@@0 T@U) ) (!  (=> ($IsGoodHeap $h@@0) (= ($IsAlloc DatatypeTypeType (|#_module.Option.Some| |a#2#0#0|) (Tclass._module.Option _module.Option$T@@5) $h@@0) ($IsAllocBox |a#2#0#0| _module.Option$T@@5 $h@@0)))
 :qid |unknown.0:0|
 :skolemid |493|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Option.Some| |a#2#0#0|) (Tclass._module.Option _module.Option$T@@5) $h@@0))
)))
...
(assert (forall ((d@@4 T@U) (_module.Option$T@@9 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Option.Some_q d@@4) ($IsAlloc DatatypeTypeType d@@4 (Tclass._module.Option _module.Option$T@@9) $h@@1))) ($IsAllocBox (_module.Option.val d@@4) _module.Option$T@@9 $h@@1))
 :qid |unknown.0:0|
 :skolemid |494|
 :pattern ( ($IsAllocBox (_module.Option.val d@@4) _module.Option$T@@9 $h@@1))
)))
