...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.fNullify_split1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Memory) ($IsAlloc refType this Tclass._module.Memory $Heap))) (and ($Is refType |o#0| Tclass._module.Object) ($IsAlloc refType |o#0| Tclass._module.Object $Heap))) (=> (and (and (and ($Is SeqType |f#0| (TSeq TChar)) ($IsAlloc SeqType |f#0| (TSeq TChar) $Heap)) (and (= 9 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |o#0| _module.Object.fields)))) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Memory.objects)) ($Box refType |o#0|)) (or (not (= |o#0| null)) (not true))) (and (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |o#0|)) ($Box SeqType |f#0|)) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= |o#0| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
