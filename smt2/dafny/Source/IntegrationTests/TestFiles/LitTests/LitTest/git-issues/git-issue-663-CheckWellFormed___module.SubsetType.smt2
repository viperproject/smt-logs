...
(set-info :boogie-vc-id CheckWellFormed$$_module.SubsetType)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 4) (- 0 3))) (= (LitInt (Mod 5 (LitInt 2))) (LitInt 1)))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= (LitInt 2) 0)) (not true)))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 5) 2) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Then_correct)))))
