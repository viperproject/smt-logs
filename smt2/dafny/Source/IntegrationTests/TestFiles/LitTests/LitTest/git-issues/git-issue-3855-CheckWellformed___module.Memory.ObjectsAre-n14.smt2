...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((|o#0@@2| T@U) (|t#0@@1| T@U) ) (!  (=> (or (|_module.__default.AssignmentCompatible#canCall| (Lit refType |o#0@@2|) (Lit DatatypeTypeType |t#0@@1|)) (and (< 3 $FunctionContextHeight) (and ($Is refType |o#0@@2| Tclass._module.Object) ($Is DatatypeTypeType |t#0@@1| Tclass._module.Mode)))) (= (_module.__default.AssignmentCompatible (Lit refType |o#0@@2|) (Lit DatatypeTypeType |t#0@@1|)) (let ((|r#1| (_module.Object.region (Lit refType |o#0@@2|))))
(ite (_module.Mode.Imm_q (Lit DatatypeTypeType |t#0@@1|)) (_module.Region.Frozen_q |r#1|) (ite (_module.Mode.Iso_q (Lit DatatypeTypeType |t#0@@1|)) (_module.Region.Isolate_q |r#1|) (ite (_module.Mode.Mut_q (Lit DatatypeTypeType |t#0@@1|)) (_module.Region.Heap_q |r#1|) (ite (_module.Mode.Tmp_q (Lit DatatypeTypeType |t#0@@1|)) (_module.Region.Stack_q |r#1|)  (or (_module.Region.Heap_q |r#1|) (_module.Region.Stack_q |r#1|)))))))))
 ...
 :weight 3
 :skolemid |598|
 :pattern ( (_module.__default.AssignmentCompatible (Lit refType |o#0@@2|) (Lit DatatypeTypeType |t#0@@1|)))
))))
(assert (= (Ctor SeqType) 10))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.Object.AllFieldsContentsConsistentWithTheirDeclaration#canCall| $Heap@@0 this@@0) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.Object) ($IsAlloc refType this@@0 Tclass._module.Object $Heap@@0)))) (_module.Object.AllFieldsAreDeclared $Heap@@0 this@@0)))) (and (forall ((|n#0| T@U) ) (!  (=> ($Is SeqType |n#0| (TSeq TChar)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Object.fields))) ($Box SeqType |n#0|)) (|_module.__default.AssignmentCompatible#canCall| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Object.fields))) ($Box SeqType |n#0|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@0)) ($Box SeqType |n#0|))))))
 :qid |gitissue3855dfy.128:14|
 :skolemid |784|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@0)) ($Box SeqType |n#0|))))
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Object.fields))) ($Box SeqType |n#0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Object.fields))) ($Box SeqType |n#0|)))
)) (= (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@0 this@@0) (forall ((|n#0@@0| T@U) ) (!  (=> (and ($Is SeqType |n#0@@0| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Object.fields))) ($Box SeqType |n#0@@0|))) (_module.__default.AssignmentCompatible ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Object.fields))) ($Box SeqType |n#0@@0|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@0)) ($Box SeqType |n#0@@0|)))))
 :qid |gitissue3855dfy.128:14|
 :skolemid |783|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@0)) ($Box SeqType |n#0@@0|))))
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Object.fields))) ($Box SeqType |n#0@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.Object.fields))) ($Box SeqType |n#0@@0|)))
)))))
 :qid |gitissue3855dfy.124:13|
 :skolemid |785|
 :pattern ( (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@0 this@@0) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($h@@8 T@U) ($o@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) Tclass._module.Object?))) ($Is MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@7) _module.Object.fields)) (TMap (TSeq TChar) Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |742|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@7) _module.Object.fields)))
)))
(assert (forall (($h@@9 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass._module.Object?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@8) alloc)))) ($IsAlloc MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@8) _module.Object.fields)) (TMap (TSeq TChar) Tclass._module.Object) $h@@9))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |743|
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) ) (!  (=> (or (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@1 this@@1) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Object) ($IsAlloc refType this@@1 Tclass._module.Object $Heap@@1)))))) (= (_module.Object.AllFieldsAreDeclared $Heap@@1 this@@1) (|Set#Subset| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) (|Map#Domain| (_module.Object.fieldModes this@@1)))))
 :qid |gitissue3855dfy.120:13|
 :skolemid |778|
 :pattern ( (_module.Object.AllFieldsAreDeclared $Heap@@1 this@@1) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@2 T@U) ) (!  (=> (or (|_module.Object.Valid#canCall| $Heap@@2 this@@2) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Object) ($IsAlloc refType this@@2 Tclass._module.Object $Heap@@2)))))) (and (and (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@2 this@@2) (=> (_module.Object.AllFieldsAreDeclared $Heap@@2 this@@2) (and (|_module.Object.AllFieldsContentsConsistentWithTheirDeclaration#canCall| $Heap@@2 this@@2) (=> (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@2 this@@2) (|_module.Object.AllOutgoingReferencesAreVenice#canCall| $Heap@@2 this@@2))))) (= (_module.Object.Valid true $Heap@@2 this@@2)  (and (and (_module.Object.AllFieldsAreDeclared $Heap@@2 this@@2) (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@2 this@@2)) (_module.Object.AllOutgoingReferencesAreVenice $Heap@@2 this@@2)))))
 :qid |gitissue3855dfy.110:23|
 :skolemid |770|
 :pattern ( (_module.Object.Valid true $Heap@@2 this@@2) ($IsGoodHeap $Heap@@2))
))))
(assert (forall ((v@@7 T@U) (t0@@4 T@U) (t1@@1 T@U) ) (! (= ($Is MapType v@@7 (TMap t0@@4 t1@@1)) (forall ((bx@@14 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@14) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@14) t1@@1) ($IsBox bx@@14 t0@@4)))
...
(assert (forall ((d@@23 T@U) ($h@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@13) ($Is DatatypeTypeType d@@23 Tclass._module.Mode)) ($IsAlloc DatatypeTypeType d@@23 Tclass._module.Mode $h@@13))
 :qid |unknown.0:0|
 :skolemid |688|
 :pattern ( ($IsAlloc DatatypeTypeType d@@23 Tclass._module.Mode $h@@13))
)))
...
(assert (forall ((d@@26 T@U) (|_System._tuple#2$T0@@6| T@U) ($h@@14 T@U) ) (!  (=> (and ($IsGoodHeap $h@@14) (and (_System.Tuple2.___hMake2_q d@@26) (exists ((|_System._tuple#2$T1@@6| T@U) ) (! ($IsAlloc DatatypeTypeType d@@26 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@14)
 :qid |unknown.0:0|
 :skolemid |458|
 :pattern ( ($IsAlloc DatatypeTypeType d@@26 (Tclass._System.Tuple2 |_System._tuple#2$T0@@6| |_System._tuple#2$T1@@6|) $h@@14))
)))) ($IsAllocBox (_System.Tuple2._0 d@@26) |_System._tuple#2$T0@@6| $h@@14))
 :qid |unknown.0:0|
 :skolemid |459|
 :pattern ( ($IsAllocBox (_System.Tuple2._0 d@@26) |_System._tuple#2$T0@@6| $h@@14))
)))
(assert (forall ((d@@27 T@U) (|_System._tuple#2$T1@@7| T@U) ($h@@15 T@U) ) (!  (=> (and ($IsGoodHeap $h@@15) (and (_System.Tuple2.___hMake2_q d@@27) (exists ((|_System._tuple#2$T0@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@27 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@15)
 :qid |unknown.0:0|
 :skolemid |460|
 :pattern ( ($IsAlloc DatatypeTypeType d@@27 (Tclass._System.Tuple2 |_System._tuple#2$T0@@7| |_System._tuple#2$T1@@7|) $h@@15))
)))) ($IsAllocBox (_System.Tuple2._1 d@@27) |_System._tuple#2$T1@@7| $h@@15))
 :qid |unknown.0:0|
 :skolemid |461|
 :pattern ( ($IsAllocBox (_System.Tuple2._1 d@@27) |_System._tuple#2$T1@@7| $h@@15))
)))
(assert (forall ((d@@28 T@U) ($h@@16 T@U) ) (!  (=> (and ($IsGoodHeap $h@@16) (and (_module.Region.Heap_q d@@28) ($IsAlloc DatatypeTypeType d@@28 Tclass._module.Region $h@@16))) ($IsAlloc refType (_module.Region.region d@@28) Tclass._module.Object $h@@16))
 :qid |unknown.0:0|
 :skolemid |706|
 :pattern ( ($IsAlloc refType (_module.Region.region d@@28) Tclass._module.Object $h@@16))
)))
(assert (forall ((d@@29 T@U) ($h@@17 T@U) ) (!  (=> (and ($IsGoodHeap $h@@17) (and (_module.Region.Stack_q d@@29) ($IsAlloc DatatypeTypeType d@@29 Tclass._module.Region $h@@17))) ($IsAlloc refType (_module.Region.region d@@29) Tclass._module.Object $h@@17))
 :qid |unknown.0:0|
 :skolemid |715|
 :pattern ( ($IsAlloc refType (_module.Region.region d@@29) Tclass._module.Object $h@@17))
)))
(assert (forall ((d@@30 T@U) ($h@@18 T@U) ) (!  (=> (and ($IsGoodHeap $h@@18) (and (_module.Region.Frame_q d@@30) ($IsAlloc DatatypeTypeType d@@30 Tclass._module.Region $h@@18))) ($IsAlloc refType (_module.Region.prev d@@30) Tclass._module.Object $h@@18))
 :qid |unknown.0:0|
 :skolemid |724|
 :pattern ( ($IsAlloc refType (_module.Region.prev d@@30) Tclass._module.Object $h@@18))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@9 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#34| |l#0| |l#1| |l#2| |l#3|) $o@@9 $f))  (=> (and (or (not (= $o@@9 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@9) |l#2|)))) (|Set#IsMember| |l#3| ($Box refType $o@@9))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1412|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#34| |l#0| |l#1| |l#2| |l#3|) $o@@9 $f))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@3 T@U) ) (!  (=> (or (|_module.Object.AllOutgoingReferencesAreVenice#canCall| $Heap@@3 this@@3) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.Object) ($IsAlloc refType this@@3 Tclass._module.Object $Heap@@3)))))) (and (forall ((|n#0@@1| T@U) ) (!  (=> ($Is SeqType |n#0@@1| (TSeq TChar)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Object.fields))) ($Box SeqType |n#0@@1|)) (|_module.__default.VeniceReferenceOK#canCall| this@@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Object.fields))) ($Box SeqType |n#0@@1|))))))
 :qid |gitissue3855dfy.134:16|
 :skolemid |796|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Object.fields))) ($Box SeqType |n#0@@1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Object.fields))) ($Box SeqType |n#0@@1|)))
)) (= (_module.Object.AllOutgoingReferencesAreVenice $Heap@@3 this@@3) (forall ((|n#0@@2| T@U) ) (!  (=> (and ($Is SeqType |n#0@@2| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Object.fields))) ($Box SeqType |n#0@@2|))) (_module.__default.VeniceReferenceOK this@@3 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Object.fields))) ($Box SeqType |n#0@@2|)))))
 :qid |gitissue3855dfy.134:16|
 :skolemid |795|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Object.fields))) ($Box SeqType |n#0@@2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.Object.fields))) ($Box SeqType |n#0@@2|)))
)))))
 :qid |gitissue3855dfy.131:13|
 :skolemid |797|
 :pattern ( (_module.Object.AllOutgoingReferencesAreVenice $Heap@@3 this@@3) ($IsGoodHeap $Heap@@3))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.ObjectsAreValid)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon6_correct  (=> (and (and (= (_module.Memory.ObjectsAreValid $Heap@@4 this@@4 |os#0@@0|) (forall ((|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| Tclass._module.Object) (|Set#IsMember| |os#0@@0| ($Box refType |o#2|))) (_module.Object.Valid reveal__module.Object.Valid $Heap@@4 |o#2|))
 :qid |gitissue3855dfy.207:15|
 :skolemid |860|
 :pattern ( (_module.Object.Valid reveal__module.Object.Valid $Heap@@4 |o#2|))
 :pattern ( (|Set#IsMember| |os#0@@0| ($Box refType |o#2|)))
))) (forall ((|o#2@@0| T@U) ) (!  (=> ($Is refType |o#2@@0| Tclass._module.Object) (=> (|Set#IsMember| |os#0@@0| ($Box refType |o#2@@0|)) (|_module.Object.Valid#canCall| $Heap@@4 |o#2@@0|)))
 :qid |gitissue3855dfy.207:15|
 :skolemid |861|
 :pattern ( (_module.Object.Valid reveal__module.Object.Valid $Heap@@4 |o#2@@0|))
 :pattern ( (|Set#IsMember| |os#0@@0| ($Box refType |o#2@@0|)))
))) (and ($Is boolType (bool_2_U (_module.Memory.ObjectsAreValid $Heap@@4 this@@4 |os#0@@0|)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@1|)))
(let ((anon10_Else_correct  (=> (not (|Set#IsMember| |os#0@@0| ($Box refType |o#1@0|))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 7) 3)) anon6_correct))))
(let ((anon10_Then_correct  (=> (|Set#IsMember| |os#0@@0| ($Box refType |o#1@0|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |o#1@0| null)) (not true))) (=> (or (not (= |o#1@0| null)) (not true)) (=> ($IsAllocBox ($Box refType |o#1@0|) Tclass._module.Object? $Heap@@4) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@10) alloc)))) (and (= $o@@10 |o#1@0|) (= $f@@0 _module.Object.fields))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@10 $f@@0)))
 :qid |gitissue3855dfy.207:28|
 :skolemid |858|
))) (|_module.Object.Valid#canCall| $Heap@@4 |o#1@0|)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 5) 3))) anon6_correct)))))))
(let ((anon9_Then_correct  (=> (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@4)) (and (=> (= (ControlFlow 0 8) 5) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (not (and ($Is refType |o#1@0| Tclass._module.Object) ($IsAlloc refType |o#1@0| Tclass._module.Object $Heap@@4))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 4) 3)) anon6_correct))))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#34| null $Heap@@4 alloc |os#0@@0|)) (and (and (=> (= (ControlFlow 0 9) 1) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon9_Then_correct)) (=> (= (ControlFlow 0 9) 4) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@4) ($IsHeapAnchor $Heap@@4)) (=> (and (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Memory) ($IsAlloc refType this@@4 Tclass._module.Memory $Heap@@4))) ($Is SetType |os#0@@0| (TSet Tclass._module.Object))) (and (= 6 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
