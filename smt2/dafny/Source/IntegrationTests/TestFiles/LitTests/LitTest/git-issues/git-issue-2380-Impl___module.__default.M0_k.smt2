...
(set-info :boogie-vc-id Impl$$_module.__default.M0_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon6_Else_correct  (=> (and (|Set#Equal| (|Map#Values| |t#0|) (|Set#UnionOne| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 4))))) (= (ControlFlow 0 6) (- 0 5))) (>= (|Set#Card| (|Map#Values| |t#0|)) (LitInt 2)))))
(let ((anon6_Then_correct  (=> (|Set#Equal| (|Map#Items| |t#0|) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 2))))))) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 4)))))))) (=> (and (= |_v1#1_0_0@0| (|Set#Card| (|Map#Items| |t#0|))) (= (ControlFlow 0 4) (- 0 3))) (= (|Map#Card| |t#0|) (LitInt 2))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct))))
(let ((anon5_Then_correct  (=> (and (= |_v0#0_0@0| (|Set#Card| (|Map#Domain| (|Map#Subtract| |t#0| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |k#0|))))))) (= (ControlFlow 0 2) (- 0 1))) (= (|Map#Card| |t#0|) (+ (|Map#Card| (|Map#Subtract| |t#0| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |k#0|))))) 1)))))
