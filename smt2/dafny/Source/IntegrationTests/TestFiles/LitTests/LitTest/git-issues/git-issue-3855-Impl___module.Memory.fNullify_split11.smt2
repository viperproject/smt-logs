...
(assert (forall (($reveal@@0 Bool) ($h0 T@U) ($h1 T@U) (this@@8 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.Memory))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (or (and (= $o@@3 this@@8) (= $f _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 this@@8) _module.Memory.objects)) ($Box refType $o@@3)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f)))
 :qid |unknown.0:0|
 :skolemid |832|
)) (= (_module.Memory.Valid $reveal@@0 $h0 this@@8) (_module.Memory.Valid $reveal@@0 $h1 this@@8))))
 :qid |unknown.0:0|
 :skolemid |833|
...
(assert (forall ((m@@6 T@U) (|m'| T@U) ) (! (= (|Map#Equal| m@@6 |m'|)  (and (forall ((u@@0 T@U) ) (! (= (|Set#IsMember| (|Map#Domain| m@@6) u@@0) (|Set#IsMember| (|Map#Domain| |m'|) u@@0))
 :qid |DafnyPreludebpl.1498:35|
 :skolemid |297|
)) (forall ((u@@1 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| m@@6) u@@1) (= (MapType0Select BoxType BoxType (|Map#Elements| m@@6) u@@1) (MapType0Select BoxType BoxType (|Map#Elements| |m'|) u@@1)))
...
(assert (forall (($reveal@@4 Bool) ($h0@@11 T@U) ($h1@@11 T@U) (this@@50 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@11) ($IsGoodHeap $h1@@11)) (and (or (not (= this@@50 null)) (not true)) ($Is refType this@@50 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@11) ($HeapSucc $h0@@11 $h1@@11))) (=> (forall (($o@@24 T@U) ($f@@12 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (and (= $o@@24 this@@50) (= $f@@12 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@11 $o@@24) $f@@12) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@11 $o@@24) $f@@12)))
 :qid |unknown.0:0|
 :skolemid |766|
)) (= (_module.Object.Valid $reveal@@4 $h0@@11 this@@50) (_module.Object.Valid $reveal@@4 $h1@@11 this@@50))))
 :qid |unknown.0:0|
 :skolemid |767|
...
(assert (forall ((a@@30 T@U) (x@@14 T@U) ) (!  (=> (not (|Set#IsMember| a@@30 x@@14)) (= (|Set#Card| (|Set#UnionOne| a@@30 x@@14)) (+ (|Set#Card| a@@30) 1)))
 :qid |DafnyPreludebpl.698:15|
 :skolemid |132|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@30 x@@14)))
)))
...
(set-info :boogie-vc-id Impl$$_module.Memory.fNullify_split11)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and (and ($IsGoodHeap $Heap@@23) ($IsHeapAnchor $Heap@@23)) (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Memory) ($IsAlloc refType this@@53 Tclass._module.Memory $Heap@@23)))) (=> (and (and (and ($Is refType |o#0@@12| Tclass._module.Object) ($IsAlloc refType |o#0@@12| Tclass._module.Object $Heap@@23)) (and ($Is SeqType |f#0@@1| (TSeq TChar)) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@@23))) (and (and ($Is SetType |xedges#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |xedges#0| (TSet Tclass._module.Edge) $Heap@@23)) true)) (=> (and (and (and (and (and ($Is SetType |xisos#0| (TSet Tclass._module.Object)) ($IsAlloc SetType |xisos#0| (TSet Tclass._module.Object) $Heap@@23)) true) (and (=> |defass#nedge#0| (and ($Is DatatypeTypeType |nedge#0| Tclass._module.Edge) ($IsAlloc DatatypeTypeType |nedge#0| Tclass._module.Edge $Heap@@23))) true)) (and (and (and ($Is SetType |zedges#0| (TSet Tclass._module.Edge)) ($IsAlloc SetType |zedges#0| (TSet Tclass._module.Edge) $Heap@@23)) true) (and (and (= 9 $FunctionContextHeight) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects)) ($Box refType |o#0@@12|))) (and (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |o#0@@12|)) ($Box SeqType |f#0@@1|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))) (and (and (and (and (|Set#IsMember| (_module.Memory.edges $Heap@@23 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects))) ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@12| |f#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))) (not (_module.Region.Frozen_q (_module.Object.region |o#0@@12|)))) (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@23 this@@53) (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@23 alloc |o#0@@12| _module.Object.fields)))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@23 $Heap@0) reveal__module.Memory.Valid))) (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and reveal__module.Object.Valid ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@1))))) (=> (and (and (and (and (and (and (= |##os#4@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))) ($IsAlloc SetType |##os#4@0| (TSet Tclass._module.Object) $Heap@1)) (and (|_module.Memory.edges#canCall| $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))) (|_module.Memory.edges#canCall| $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))))) (and (and (= |xedges#0@0| (_module.Memory.edges $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects)))) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@1)) (and (= |##os#5@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))) ($IsAlloc SetType |##os#5@0| (TSet Tclass._module.Object) $Heap@1)))) (and (and (and (|_module.Memory.justTheIsos#canCall| $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects))) (|_module.Memory.justTheIsos#canCall| $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects)))) (and (= |xisos#0@0| (_module.Memory.justTheIsos $Heap@1 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects)))) (or (not (= |o#0@@12| null)) (not true)))) (and (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)) (= |nedge#0@0| (|#_module.Edge.Edge| |o#0@@12| |f#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))) (and (or (not (= |o#0@@12| null)) (not true)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |o#0@@12| _module.Object.fields)))))) (and (and (and (and (or (not (= |o#0@@12| null)) (not true)) (= |##m#1@0| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields)))) (and ($IsAlloc MapType |##m#1@0| (TMap (TSeq TChar) Tclass._module.Object) $Heap@1) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@1))) (and (and (|_module.__default.RemoveKey#canCall| (TSeq TChar) Tclass._module.Object ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|)) (|_module.__default.RemoveKey#canCall| (TSeq TChar) Tclass._module.Object ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|))) (and (= |$rhs#0@0| (_module.__default.RemoveKey (TSeq TChar) Tclass._module.Object reveal__module._default.RemoveKey ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|))) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |o#0@@12|) _module.Object.fields ($Box MapType |$rhs#0@0|))))))) (and (and (and ($IsGoodHeap $Heap@2) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@2)) (and (= |##os#6@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@53) _module.Memory.objects))) ($IsAlloc SetType |##os#6@0| (TSet Tclass._module.Object) $Heap@2))) (and (and (|_module.Memory.edges#canCall| $Heap@2 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@53) _module.Memory.objects))) (|_module.Memory.edges#canCall| $Heap@2 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@53) _module.Memory.objects)))) (and (= |zedges#0@0| (_module.Memory.edges $Heap@2 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@53) _module.Memory.objects)))) (|Set#Subset| |zedges#0@0| |xedges#0@0|)))))) (and (and (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (forall ((|i#1| T@U) ) (!  (=> ($Is refType |i#1| Tclass._module.Object) (=> (|Set#IsMember| |xisos#0@0| ($Box refType |i#1|)) (and (|_module.Memory.refCountEdges#canCall| this@@53 |i#1| |xedges#0@0|) (|_module.Memory.refCountEdges#canCall| this@@53 |i#1| |zedges#0@0|))))
 :qid |gitissue3855dfy.549:15|
 :skolemid |1150|
 :pattern ( (_module.Memory.refCountEdges this@@53 |i#1| |zedges#0@0|))
 :pattern ( (_module.Memory.refCountEdges this@@53 |i#1| |xedges#0@0|))
 :pattern ( (|Set#IsMember| |xisos#0@0| ($Box refType |i#1|)))
))) (and (forall ((|i#1@@0| T@U) ) (!  (=> (and ($Is refType |i#1@@0| Tclass._module.Object) (|Set#IsMember| |xisos#0@0| ($Box refType |i#1@@0|))) (>= (_module.Memory.refCountEdges this@@53 |i#1@@0| |xedges#0@0|) (_module.Memory.refCountEdges this@@53 |i#1@@0| |zedges#0@0|)))
 :qid |gitissue3855dfy.549:15|
 :skolemid |1151|
 :pattern ( (_module.Memory.refCountEdges this@@53 |i#1@@0| |zedges#0@0|))
 :pattern ( (_module.Memory.refCountEdges this@@53 |i#1@@0| |xedges#0@0|))
 :pattern ( (|Set#IsMember| |xisos#0@0| ($Box refType |i#1@@0|)))
)) (= $Heap@2 $Heap@3))) (and (and (and ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3) ($IsAlloc SetType |xedges#0@0| (TSet Tclass._module.Edge) $Heap@3)) (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |xedges#0@0|) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |xedges#0@0|))) (and (and (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |xedges#0@0|) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3)) (and ($IsAlloc SetType |zedges#0@0| (TSet Tclass._module.Edge) $Heap@3) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|))))) (and (and (and (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|) (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |zedges#0@0|)) (and ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3) ($IsAlloc SetType |zedges#0@0| (TSet Tclass._module.Edge) $Heap@3))) (and (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|)) (and (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |zedges#0@0|) (= call0formal@previous$Heap@0 $Heap@@23)))) (and (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (= $Heap@3 $Heap@4) reveal__module.Memory.Valid2)) (and (and (forall (($o@@25 T@U) ($f@@13 T@U) ) (!  (=> (or (not (= $o@@25 null)) (not true)) (=> (and (= $o@@25 this@@53) (or (= $f@@13 _module.Memory.objects) (= $f@@13 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@25) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@25) $f@@13))))
 :qid |gitissue3855dfy.652:13|
 :skolemid |1253|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@25) $f@@13))
)) (forall (($o@@26 T@U) ($f@@14 T@U) ) (!  (=> (or (not (= $o@@26 null)) (not true)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@53) _module.Memory.objects)) ($Box refType $o@@26)) (or (not (= $o@@26 |o#0@@12|)) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@26) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@26) $f@@14))))
 :qid |gitissue3855dfy.653:13|
 :skolemid |1254|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@26) $f@@14))
))) (and (|Map#Equal| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |o#0@@12|) _module.Object.fields)) (_module.__default.RemoveKey (TSeq TChar) Tclass._module.Object reveal__module._default.RemoveKey ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 |o#0@@12|) _module.Object.fields)) ($Box SeqType |f#0@@1|))) (= (ControlFlow 0 2) (- 0 1)))))))) (|Set#Subset| (_module.Memory.edges $Heap@4 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 this@@53) _module.Memory.objects))) (_module.Memory.edges $Heap@@23 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 this@@53) _module.Memory.objects))))))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
