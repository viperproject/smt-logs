...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Meh)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |tr#0| Tclass.M.Tr) ($IsAlloc refType |tr#0| Tclass.M.Tr $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
