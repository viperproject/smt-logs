...
(assert (forall ((a@@5 T@U) (x@@11 T@U) ) (! (= (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@5 x@@11) x@@11) (+ (|MultiSet#Multiplicity| a@@5 x@@11) 1))
 :qid |DafnyPreludebpl.968:15|
 :skolemid |193|
 :pattern ( (|MultiSet#UnionOne| a@@5 x@@11))
)))
...
(assert (forall ((s@@4 T@U) ) (!  (and (= (= (|MultiSet#Card| s@@4) 0) (= s@@4 |MultiSet#Empty|)) (=> (or (not (= (|MultiSet#Card| s@@4) 0)) (not true)) (exists ((x@@13 T@U) ) (! (< 0 (|MultiSet#Multiplicity| s@@4 x@@13))
 :qid |DafnyPreludebpl.946:20|
 :skolemid |188|
 :pattern ( (|MultiSet#Multiplicity| s@@4 x@@13))
))))
...
(assert (forall ((a@@6 T@U) (x@@14 T@U) ) (!  (=> (|Set#IsMember| a@@6 x@@14) (= (|Set#Card| (|Set#UnionOne| a@@6 x@@14)) (|Set#Card| a@@6)))
 :qid |DafnyPreludebpl.694:15|
 :skolemid |131|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@6 x@@14)))
)))
(assert (forall ((h@@3 T@U) (r T@U) (f T@U) (x@@15 T@U) ) (!  (=> ($IsGoodHeap (MapType0Store refType (MapType0Type FieldType BoxType) h@@3 r (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@3 r) f x@@15))) ($HeapSucc h@@3 (MapType0Store refType (MapType0Type FieldType BoxType) h@@3 r (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@3 r) f x@@15))))
 :qid |DafnyPreludebpl.603:15|
 :skolemid |116|
 :pattern ( (MapType0Store refType (MapType0Type FieldType BoxType) h@@3 r (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@3 r) f x@@15)))
)))
...
(assert (forall ((a@@7 T@U) (x@@18 T@U) (y@@1 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| a@@7 y@@1)) (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@7 x@@18) y@@1)))
 :qid |DafnyPreludebpl.973:15|
 :skolemid |194|
 :pattern ( (|MultiSet#UnionOne| a@@7 x@@18) (|MultiSet#Multiplicity| a@@7 y@@1))
)))
...
(assert (forall ((a@@8 T@U) (x@@19 T@U) (o@@4 T@U) ) (! (= (< 0 (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@8 x@@19) o@@4))  (or (= o@@4 x@@19) (< 0 (|MultiSet#Multiplicity| a@@8 o@@4))))
 :qid |DafnyPreludebpl.963:15|
 :skolemid |192|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#UnionOne| a@@8 x@@19) o@@4))
)))
...
(assert (forall ((a@@9 T@U) (x@@20 T@U) ) (!  (=> (not (|Set#IsMember| a@@9 x@@20)) (= (|Set#Card| (|Set#UnionOne| a@@9 x@@20)) (+ (|Set#Card| a@@9) 1)))
 :qid |DafnyPreludebpl.698:15|
 :skolemid |132|
 :pattern ( (|Set#Card| (|Set#UnionOne| a@@9 x@@20)))
)))
...
(declare-fun |v_int_seq#0@0| () Int)
(declare-fun |v_int_s#0@0| () Int)
(declare-fun |v_int_m#0@0| () Int)
(declare-fun |v_array#0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (LitInt 2) 2)) (=> (= (LitInt 2) 2) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (=> (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 2))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) (IndexField 0)))) (LitInt 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) (IndexField 1)))) (LitInt 2)))) (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)) (and ($IsHeapAnchor $Heap@0) (= |v_int_seq#0@0| (|Seq#Length| (|Seq#Build| |Seq#Empty| ($Box refType $nw@0))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= |v_int_seq#0@0| (LitInt 1))) (=> (= |v_int_seq#0@0| (LitInt 1)) (=> (= |v_int_s#0@0| (|Set#Card| (|Set#UnionOne| |Set#Empty| ($Box refType $nw@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |v_int_s#0@0| (LitInt 1))) (=> (= |v_int_s#0@0| (LitInt 1)) (=> (and (= |v_int_m#0@0| (|MultiSet#Card| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box refType $nw@0)))) (= (ControlFlow 0 2) (- 0 1))) (= |v_int_m#0@0| (LitInt 1)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |v_array#0| (Tclass._System.array TInt)) ($IsAlloc refType |v_array#0| (Tclass._System.array TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
