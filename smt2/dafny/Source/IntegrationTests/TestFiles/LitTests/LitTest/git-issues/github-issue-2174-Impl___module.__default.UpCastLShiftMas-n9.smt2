...
(set-info :boogie-vc-id Impl$$_module.__default.UpCastLShiftMasking)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (bvshl (concat #x0000000000000000 |v#0|) (concat #x000000000000000000000000000000 #x40)) (bvand (bvshl (concat #x0000000000000000 |v#0|) (concat #x000000000000000000000000000000 #x40)) (bvshl _module.__default.Ones (concat #x000000000000000000000000000000 ((_ int2bv 8) |idx#0|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |idx#0|)) (and (and (= 1 $FunctionContextHeight) (<= (LitInt 0) |idx#0|)) (and (<= |idx#0| (LitInt 64)) (= (ControlFlow 0 3) 2)))) anon0_correct)))
