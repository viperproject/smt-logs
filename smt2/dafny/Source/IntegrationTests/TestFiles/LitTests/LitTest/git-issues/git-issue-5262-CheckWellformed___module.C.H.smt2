...
(declare-fun _module.C.H (T@U) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.C.H#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.C.H#canCall| this) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap)))))) (= (_module.C.H this) (U_2_int (let ((|th#0| this))
($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |th#0|) _module.C.data))))))
 :qid |gitissue5262dfy.19:12|
 :skolemid |502|
 :pattern ( (_module.C.H this) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.C.H#canCall| (Lit refType this@@0)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.C) ($IsAlloc refType this@@0 Tclass._module.C $Heap@@0)))))) (= (_module.C.H (Lit refType this@@0)) (U_2_int (let ((|th#1| (Lit refType this@@0)))
($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |th#1|) _module.C.data))))))
 :qid |gitissue5262dfy.19:12|
 :weight 3
 :skolemid |503|
 :pattern ( (_module.C.H (Lit refType this@@0)) ($IsGoodHeap $Heap@@0))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (= |let#0#0#0| this@@1) (=> (and ($Is refType |let#0#0#0| Tclass._module.C) (= |th#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |th#Z#0@0| null)) (not true))) (=> (or (not (= |th#Z#0@0| null)) (not true)) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |th#Z#0@0| _module.C.data))) (= (_module.C.H this@@1) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |th#Z#0@0|) _module.C.data))))) (and ($Is intType (int_2_U (_module.C.H this@@1)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))
