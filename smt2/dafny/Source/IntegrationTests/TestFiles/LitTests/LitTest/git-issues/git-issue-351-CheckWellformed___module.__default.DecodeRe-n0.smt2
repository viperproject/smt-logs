...
(declare-fun _module.__default.DecodeRecursively (T@U) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.DecodeRecursively#canCall| (T@U) Bool)
...
(declare-fun |lambda#0| (Int T@U) T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|s#0| T@U) ) (!  (=> (or (|_module.__default.DecodeRecursively#canCall| |s#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is SeqType |s#0| (TSeq TInt))))) (= (_module.__default.DecodeRecursively |s#0|) (|Seq#Create| TInt $Heap (|Seq#Length| |s#0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| (U_2_int ($Unbox intType (|Seq#Index| |s#0| (LitInt 0)))) |s#0|) (|lambda#1| TInt (LitInt 0) (|Seq#Length| |s#0|)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))
 :qid |gitissue351dfy.5:10|
 :skolemid |481|
 :pattern ( (_module.__default.DecodeRecursively |s#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|s#0@@0| T@U) ) (!  (=> (or (|_module.__default.DecodeRecursively#canCall| (Lit SeqType |s#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is SeqType |s#0@@0| (TSeq TInt))))) (= (_module.__default.DecodeRecursively (Lit SeqType |s#0@@0|)) (|Seq#Create| TInt $Heap@@0 (|Seq#Length| (Lit SeqType |s#0@@0|)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) (LitInt 0)))) (Lit SeqType |s#0@@0|)) (|lambda#1| TInt (LitInt 0) (|Seq#Length| (Lit SeqType |s#0@@0|))) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))
 :qid |gitissue351dfy.5:10|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.DecodeRecursively (Lit SeqType |s#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#2| |l#0|) |$l#0#o#0|)) |l#0|)
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( (MapType1Select refType boolType (|lambda#2| |l#0|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@0| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@0|) |$l#0#ly#0|) |l#0@@0|)
 :qid |gitissue351dfy.6:12|
 :skolemid |490|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#4| |l#0@@0|) |$l#0#ly#0|))
)))
(assert (forall ((|l#0@@1| Int) (|l#1| T@U) (|$l#0#heap#0| T@U) (|$l#0#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@1| |l#1|) |$l#0#heap#0| |$l#0#i#0|) ($Box intType ($Unbox intType (|Seq#Index| |l#1| (U_2_int ($Unbox intType |$l#0#i#0|))))))
 :qid |gitissue351dfy.7:15|
 :skolemid |486|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0@@1| |l#1|) |$l#0#heap#0| |$l#0#i#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@0| Int) (|l#2| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0@@2| |l#1@@0| |l#2|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))  (and ($IsBox |$l#0#i#0@@0| |l#0@@2|) (and (<= |l#1@@0| (U_2_int ($Unbox intType |$l#0#i#0@@0|))) (< (U_2_int ($Unbox intType |$l#0#i#0@@0|)) |l#2|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |487|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#1| |l#0@@2| |l#1@@0| |l#2|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@1| T@U) (|l#2@@0| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@3| |l#1@@1| |l#2@@0| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@1| $o@@0) |l#2@@0|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |491|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@3| |l#1@@1| |l#2@@0| |l#3|) $o@@0 $f))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|s#0@@1| T@U) ) (!  (=> (or (|_module.__default.DecodeRecursively#canCall| |s#0@@1|) (and (< 0 $FunctionContextHeight) ($Is SeqType |s#0@@1| (TSeq TInt)))) ($Is SeqType (_module.__default.DecodeRecursively |s#0@@1|) (TSeq TInt)))
 :qid |gitissue351dfy.5:28|
 :skolemid |479|
 :pattern ( (_module.__default.DecodeRecursively |s#0@@1|))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.DecodeRecursively)
...
(let ((anon16_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@2|)))) (= (ControlFlow 0 10) 6)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@2|))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@2|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@2|))) (=> (= |let#0#0#0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@2| (LitInt 0))))) (=> (and ($Is intType (int_2_U |let#0#0#0|) TInt) (= |d#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@2|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@2|))) (=> (= |lambdaResult#0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@2| |i#0@0|)))) (=> (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 7) 6)) anon9_correct)))))))))))
(let ((anon15_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 12) 7) anon16_Then_correct) (=> (= (ControlFlow 0 12) 10) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 11) 7) anon16_Then_correct) (=> (= (ControlFlow 0 11) 10) anon16_Else_correct)))))
(let ((anon14_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#10| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 13) 11) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 14) 13) anon14_Then_correct) (=> (= (ControlFlow 0 14) 5) anon14_Else_correct)))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (|Seq#Length| |s#0@@2|))) (Requires1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@2| (LitInt 0)))) |s#0@@2|) (|lambda#1| TInt (LitInt 0) (|Seq#Length| |s#0@@2|)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |gitissue351dfy.6:3|
 :skolemid |483|
))) (=> (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| (|Seq#Length| |s#0@@2|))) (forall (($o@@1 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@1 $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@2| (LitInt 0)))) |s#0@@2|) (|lambda#1| TInt (LitInt 0) (|Seq#Length| |s#0@@2|)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@1))) (U_2_bool (MapType0Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@0)))
 :qid |gitissue351dfy.6:3|
 :skolemid |484|
)))
 :qid |gitissue351dfy.6:3|
 :skolemid |485|
))) (=> (and (and (= (_module.__default.DecodeRecursively |s#0@@2|) (|Seq#Create| TInt $Heap@@1 (|Seq#Length| |s#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@2| (LitInt 0)))) |s#0@@2|) (|lambda#1| TInt (LitInt 0) (|Seq#Length| |s#0@@2|)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))) ($Is SeqType (_module.__default.DecodeRecursively |s#0@@2|) (TSeq TInt))) (and (= (_module.__default.DecodeRecursively |s#0@@2|) |b#0|) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= 0 (|Seq#Length| |s#0@@2|))) (=> (<= 0 (|Seq#Length| |s#0@@2|)) (and (=> (= (ControlFlow 0 15) 14) anon13_Then_correct) (=> (= (ControlFlow 0 15) 3) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#10| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 17) 1) anon12_Then_correct) (=> (= (ControlFlow 0 17) 15) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is SeqType |s#0@@2| (TSeq TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 18) 17))) anon0_correct)))
