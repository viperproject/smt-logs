...
(assert (distinct TInt TagInt alloc allocName Tagclass.A.EvenGood__OddBad? Tagclass.A.EvenGood__OddBad class.A.EvenGood__OddBad? tytagFamily$EvenGood_OddBad field$a)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id Impl$$A.__default.IncreaseAndReturn)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc |c#0@@1|)) (<= (LitInt 0) |n#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| A.EvenGood__OddBad.a))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| A.EvenGood__OddBad.a)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (=> (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) A.EvenGood__OddBad.a))) |n#0@0|)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |c#0@@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) A.EvenGood__OddBad.a ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) A.EvenGood__OddBad.a))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) A.EvenGood__OddBad.a))))) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) A.EvenGood__OddBad.a))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) A.EvenGood__OddBad.a)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= |c#0@@1| |c#0@@1|))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |c#0@@1| Tclass.A.EvenGood__OddBad) ($IsAlloc refType |c#0@@1| Tclass.A.EvenGood__OddBad $Heap)) (=> |defass#r#0| (and ($Is refType |r#0| Tclass.A.EvenGood__OddBad) ($IsAlloc refType |r#0| Tclass.A.EvenGood__OddBad $Heap)))) (and (and (<= (LitInt 0) |n#0|) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 2)))) anon0_correct))))
