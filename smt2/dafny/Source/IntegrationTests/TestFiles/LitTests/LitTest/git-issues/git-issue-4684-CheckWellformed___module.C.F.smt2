...
(declare-fun _module.C.F (T@U T@U T@U Int T@U) Int)
...
(declare-fun |_module.C.F#canCall| (T@U T@U Int T@U) Bool)
...
(assert (forall (($ly T@U) ($Heap T@U) (this T@U) (|n#0| Int) (|g#0| T@U) ) (! (= (_module.C.F ($LS $ly) $Heap this |n#0| |g#0|) (_module.C.F $ly $Heap this |n#0| |g#0|))
 :qid |gitissue4684dfy.28:12|
 :skolemid |554|
 :pattern ( (_module.C.F ($LS $ly) $Heap this |n#0| |g#0|))
)))
...
(assert (forall (($ly@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|n#0@@0| Int) (|g#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.C) ($IsAlloc refType this@@0 Tclass._module.C $h0)))) (or (|_module.C.F#canCall| $h0 this@@0 |n#0@@0| |g#0@@0|) (and (<= (LitInt 0) |n#0@@0|) (and ($Is HandleTypeType |g#0@@0| (Tclass._System.___hFunc0 TInt)) ($IsAlloc HandleTypeType |g#0@@0| (Tclass._System.___hFunc0 TInt) $h0))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))
 :qid |unknown.0:0|
 :skolemid |556|
)) (= (_module.C.F $ly@@0 $h0 this@@0 |n#0@@0| |g#0@@0|) (_module.C.F $ly@@0 $h1 this@@0 |n#0@@0| |g#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |557|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.C.F $ly@@0 $h1 this@@0 |n#0@@0| |g#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@0 T@U) (this@@1 T@U) (|n#0@@1| Int) (|g#0@@1| T@U) ) (!  (=> (or (|_module.C.F#canCall| $Heap@@0 this@@1 |n#0@@1| |g#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.C) ($IsAlloc refType this@@1 Tclass._module.C $Heap@@0)))) (<= (LitInt 0) |n#0@@1|)) ($Is HandleTypeType |g#0@@1| (Tclass._System.___hFunc0 TInt))) (Requires0 TInt $Heap@@0 |g#0@@1|)))) (and (=> (not (or (= |n#0@@1| (LitInt 0)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.C.next)) null))) (let ((|h#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle0 (|lambda#34| this@@1 _module.C.data) (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#36| this@@1))))) $ly@@1))))
(|_module.C.F#canCall| $Heap@@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.C.next)) (- |n#0@@1| 1) (ite (< |n#0@@1| 20) |g#0@@1| |h#0|)))) (= (_module.C.F ($LS $ly@@1) $Heap@@0 this@@1 |n#0@@1| |g#0@@1|) (ite  (or (= |n#0@@1| (LitInt 0)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.C.next)) null)) (U_2_int ($Unbox intType (Apply0 TInt $Heap@@0 |g#0@@1|))) (let ((|h#0@@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle0 (|lambda#34| this@@1 _module.C.data) (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#36| this@@1))))) $ly@@1))))
(_module.C.F $ly@@1 $Heap@@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) _module.C.next)) (- |n#0@@1| 1) (ite (< |n#0@@1| 20) |g#0@@1| |h#0@@0|)))))))
 :qid |gitissue4684dfy.28:12|
 :skolemid |560|
 :pattern ( (_module.C.F ($LS $ly@@1) $Heap@@0 this@@1 |n#0@@1| |g#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(let ((anon14_correct  (=> (and (= |##g#0@0| (ite (< |n#0@@2| 20) |g#0@@2| |h#Z#0@0|)) ($IsAlloc HandleTypeType |##g#0@0| (Tclass._System.___hFunc0 TInt) $Heap@@1)) (and (=> (= (ControlFlow 0 7) (- 0 13)) (Requires0 TInt $Heap@@1 |##g#0@0|)) (=> (and (Requires0 TInt $Heap@@1 |##g#0@0|) (= |b$reqreads#4@0| (forall (($o@@10 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@10) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@10) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@10 $f@@2)))
 :qid |gitissue4684dfy.36:12|
 :skolemid |563|
)))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (or (or (<= 0 |n#0@@2|) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (= |##n#0@0| |n#0@@2|))) (=> (or (or (<= 0 |n#0@@2|) (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|))))) (= |##n#0@0| |n#0@@2|)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (or (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))) (and (|Set#Equal| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (< |##n#0@0| |n#0@@2|)))) (=> (or (and (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (not (|Set#Subset| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)))) (and (|Set#Equal| (Lit SetType |Set#Empty|) (Lit SetType |Set#Empty|)) (< |##n#0@0| |n#0@@2|))) (=> (and (and (|_module.C.F#canCall| $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.C.next)) (- |n#0@@2| 1) (ite (< |n#0@@2| 20) |g#0@@2| |h#Z#0@0|)) (= (_module.C.F ($LS $LZ) $Heap@@1 this@@2 |n#0@@2| |g#0@@2|) (_module.C.F ($LS $LZ) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.C.next)) (- |n#0@@2| 1) (ite (< |n#0@@2| 20) |g#0@@2| |h#Z#0@0|)))) (and (|_module.C.F#canCall| $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.C.next)) (- |n#0@@2| 1) (ite (< |n#0@@2| 20) |g#0@@2| |h#Z#0@0|)) ($Is intType (int_2_U (_module.C.F ($LS $LZ) $Heap@@1 this@@2 |n#0@@2| |g#0@@2|)) TInt))) (and (=> (= (ControlFlow 0 7) (- 0 10)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 7) (- 0 9)) true) (and (=> (= (ControlFlow 0 7) (- 0 8)) |b$reqreads#3@0|) (=> |b$reqreads#3@0| (=> (= (ControlFlow 0 7) (- 0 6)) |b$reqreads#4@0|))))))))))))))))
...
(let ((anon18_Then_correct  (=> (or (= |n#0@@2| (LitInt 0)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.C.next)) null)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (Requires0 TInt $Heap@@1 |g#0@@2|)) (=> (Requires0 TInt $Heap@@1 |g#0@@2|) (=> (= |b$reqreads#2@0| (forall (($o@@11 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) alloc)))) (|Set#IsMember| (Reads0 TInt $Heap@@1 |g#0@@2|) ($Box refType $o@@11))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@11 $f@@3)))
 :qid |gitissue4684dfy.33:7|
 :skolemid |562|
))) (=> (and (= (_module.C.F ($LS $LZ) $Heap@@1 this@@2 |n#0@@2| |g#0@@2|) (U_2_int ($Unbox intType (Apply0 TInt $Heap@@1 |g#0@@2|)))) ($Is intType (int_2_U (_module.C.F ($LS $LZ) $Heap@@1 this@@2 |n#0@@2| |g#0@@2|)) TInt)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@0|))))))))))
