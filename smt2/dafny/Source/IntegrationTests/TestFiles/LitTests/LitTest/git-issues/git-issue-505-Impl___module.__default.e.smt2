...
(declare-fun |testbv#0@0| () (_ BitVec 8))
(declare-fun |testval#0@0| () Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.e)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (LitInt 239))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |a#0@0|) (< |a#0@0| 256))) (=> (and (<= 0 |a#0@0|) (< |a#0@0| 256)) (=> (= |testbv#0@0| ((_ int2bv 8) |a#0@0|)) (=> (and (= |testval#0@0| (nat_from_bv8 |testbv#0@0|)) (= (ControlFlow 0 2) (- 0 1))) (= |testval#0@0| |a#0@0|))))))))
