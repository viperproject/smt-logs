...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@97  (=> (= (ControlFlow 0 3) (- 0 2)) (> 0.0 ($generated@@24 ($generated (- 0 4)))))))
(let (($generated@@98 true))
(let (($generated@@99  (=> (= $generated@@90 ($generated@@31 $generated@@91 $generated@@92 $generated@@93 false)) (and (=> (= (ControlFlow 0 4) 1) $generated@@98) (=> (= (ControlFlow 0 4) 3) $generated@@97)))))
(let (($generated@@100  (=> (and (and ($generated@@94 $generated@@92) ($generated@@95 $generated@@92)) (and (= 0 $generated@@96) (= (ControlFlow 0 5) 4))) $generated@@99)))
$generated@@100)))))
))
(check-sat)
(get-info :rlimit)
