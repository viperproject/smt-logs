...
(set-info :boogie-vc-id Impl$$_module.__default.TestOnlyAfter)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (=> (and (>= |i#0| (LitInt 1)) (>= |i#0| (LitInt 2))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (>= |i#0| (LitInt 3))) (=> (>= |i#0| (LitInt 3)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= |i#0| (LitInt 4))) (=> (>= |i#0| (LitInt 4)) (=> (= (ControlFlow 0 2) (- 0 1)) (>= |i#0| (LitInt 5)))))))))))
