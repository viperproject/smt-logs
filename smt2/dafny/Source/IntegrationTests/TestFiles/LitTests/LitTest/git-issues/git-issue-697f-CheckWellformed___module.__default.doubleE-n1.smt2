...
(assert (distinct TInt TagInt alloc Tagclass._module.EvenCell |##_module.Cell.Cell| Tagclass._module.Cell tytagFamily$EvenCell tytagFamily$Cell)
)
(assert (= (Ctor DatatypeTypeType) 3))
(assert (forall ((|c#0| T@U) ) (! (= ($Is DatatypeTypeType |c#0| Tclass._module.EvenCell)  (and ($Is DatatypeTypeType |c#0| Tclass._module.Cell) (_module.__default.ghostPredicate (_module.Cell.x |c#0|))))
 :qid |unknown.0:0|
 :skolemid |506|
