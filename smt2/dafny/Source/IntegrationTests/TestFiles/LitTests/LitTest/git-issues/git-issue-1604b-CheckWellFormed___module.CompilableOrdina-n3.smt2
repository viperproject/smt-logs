...
(assert (distinct TInt TagInt alloc Tagclass._module.Cell |##_module.Cell.Cell| Tagclass._module.CompilableNaturalCell tytagFamily$Cell tytagFamily$CompilableNaturalCell)
)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.CompilableOrdinalCell)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon6_Then_correct  (=> (= |newtype$check#0@0| (Lit DatatypeTypeType (|#_module.Cell.Cell| (LitInt 1)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (>= (_module.Cell.x |newtype$check#0@0|) (LitInt 0))) (=> (>= (_module.Cell.x |newtype$check#0@0|) (LitInt 0)) (=> (= |newtype$check#1@0| (Lit DatatypeTypeType (|#_module.Cell.Cell| (LitInt 1)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (>= (_module.Cell.x |newtype$check#1@0|) (LitInt 0))) (=> (>= (_module.Cell.x |newtype$check#1@0|) (LitInt 0)) (=> (and (_module.Cell.Cell_q (Lit DatatypeTypeType (|#_module.Cell.Cell| (LitInt 1)))) (= (ControlFlow 0 3) (- 0 2))) (U_2_bool (Lit boolType (bool_2_U  (or (not (= (_module.Cell.x (Lit DatatypeTypeType (|#_module.Cell.Cell| (LitInt 1)))) 0)) (not true))))))))))))))
