...
(set-info :boogie-vc-id CheckWellFormed$$_module.IntC)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (= |newtype$check#1@0| (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (Mod |newtype$check#1@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#1@0| (LitInt 2)) (LitInt 0)) (=> (= (ControlFlow 0 3) (- 0 2)) (<= (LitInt 0) (LitInt 0))))))))
