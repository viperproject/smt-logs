...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let (($generated@@107 true))
(let (($generated@@108  (=> (not ($generated@@6 ($generated@@48 $generated@@8 ($generated@@12 false)))) (=> (and (= $generated@@96 ($generated@@46 1)) (= (ControlFlow 0 6) 4)) $generated@@107))))
(let (($generated@@109  (=> (and ($generated@@6 ($generated@@48 $generated@@8 ($generated@@12 false))) (= (ControlFlow 0 5) 4)) $generated@@107)))
(let (($generated@@110  (=> (or (not (= $generated@@97 $generated@@98)) (not true)) (and (=> (= (ControlFlow 0 7) 5) $generated@@109) (=> (= (ControlFlow 0 7) 6) $generated@@108)))))
(let (($generated@@111 true))
(let (($generated@@112  (=> $generated@@99 (and (=> (= (ControlFlow 0 8) 3) $generated@@111) (=> (= (ControlFlow 0 8) 7) $generated@@110)))))
(let (($generated@@113 true))
(let (($generated@@114  (and (=> (= (ControlFlow 0 9) 2) $generated@@113) (=> (= (ControlFlow 0 9) 8) $generated@@112))))
(let (($generated@@115 true))
(let (($generated@@116  (=> (and (and (and (and (not false) (<= 3 $generated@@97)) (= $generated@@100 3)) (= $generated@@98 18)) (and (and (and (<= $generated@@100 $generated@@97) (<= $generated@@97 $generated@@98)) (forall (($generated@@117 T@U) ) (!  (=> (and (or (not (= $generated@@117 $generated@@102)) (not true)) ($generated@@6 ($generated@@7 $generated@@8 ($generated@@0 $generated@@1 $generated@@2 ($generated@@0 $generated@@3 ($generated@@4 $generated@@1 $generated@@2) $generated@@101 $generated@@117) $generated@@5)))) (= ($generated@@0 $generated@@3 ($generated@@4 $generated@@1 $generated@@2) $generated@@101 $generated@@117) ($generated@@0 $generated@@3 ($generated@@4 $generated@@1 $generated@@2) $generated@@101 $generated@@117)))
...
))))) (and (=> (= (ControlFlow 0 10) 1) $generated@@115) (=> (= (ControlFlow 0 10) 9) $generated@@114)))))
(let (($generated@@120  (=> (= $generated@@103 ($generated@@60 $generated@@102 $generated@@101 $generated@@5 false)) (=> (and (= $generated@@100 ($generated@@46 3)) (= $generated@@98 ($generated@@46 18))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (<= $generated@@100 $generated@@98)) (=> (<= $generated@@100 $generated@@98) (=> (= (ControlFlow 0 11) 10) $generated@@116)))))))
(let (($generated@@121  (=> (and (and ($generated@@104 $generated@@101) ($generated@@105 $generated@@101)) (and (= 0 $generated@@106) (= (ControlFlow 0 13) 11))) $generated@@120)))
$generated@@121)))))))))))))
))
(check-sat)
(get-info :rlimit)
