...
axiom {:id "id323"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    Regressions.__default.P#canCall(x#0) || 0 < $FunctionContextHeight
...
axiom {:id "id324"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    {:weight 3} { Regressions.__default.P(LitInt(x#0)) } 
    Regressions.__default.P#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
...
procedure {:verboseName "Regressions.P (well-formedness)"} CheckWellformed$$Regressions.__default.P(x#0: int);
...
procedure {:verboseName "Regressions.Test0 (correctness)"} Impl$$Regressions.__default.Test0() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Regressions.Test0 (correctness)"} Impl$$Regressions.__default.Test0() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var s#0: Set
     where $Is(s#0, TSet(Tclass.Regressions.byte()))
       && $IsAlloc(s#0, TSet(Tclass.Regressions.byte()), $Heap);
  var b#0: int;
  var ##x#0: int;
  var u#0: int;
  var u#1: int;

    // AddMethodImpl: Test0, Impl$$Regressions.__default.Test0
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-697j.dfy(259,11)
    assume true;
    // Begin Comprehension WF check
    havoc b#0;
    if (b#0 < 256 && b#0 != 7 && LitInt(0) <= b#0)
    {
        if (LitInt(5) <= b#0)
        {
        }

        if (LitInt(5) <= b#0 && b#0 < 12)
        {
            ##x#0 := b#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##x#0, TInt, $Heap);
            assume Regressions.__default.P#canCall(b#0);
        }

        if (LitInt(5) <= b#0 && b#0 < 12 && Regressions.__default.P(b#0))
        {
        }
    }

    // End Comprehension WF check
    assume (forall b#1: int :: 
      b#1 < 256 && b#1 != 7 && LitInt(0) <= b#1
         ==> 
        LitInt(5) <= b#1 && b#1 < 12
         ==> Regressions.__default.P#canCall(b#1));
    s#0 := Set#FromBoogieMap((lambda $y#0: Box :: 
        $IsBox($y#0, Tclass.Regressions.byte())
           && 
          LitInt(5) <= $Unbox($y#0): int
           && $Unbox($y#0): int < 12
           && Regressions.__default.P($Unbox($y#0): int)));
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-697j.dfy(260,5)
    assume true;
    assert {:id "id327"} Set#IsMember(s#0, $Box(LitInt(9)));
    // ----- assign-such-that statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-697j.dfy(261,11)
    havoc u#1;
    if (true)
    {
        assume true;
    ...
    assert {:id "id328"} ($Is(LitInt(0), TInt) && Set#IsMember(s#0, $Box(LitInt(0))))
       || (exists $as#u0#0: int :: Set#IsMember(s#0, $Box($as#u0#0)));
    havoc u#0;
    assume {:id "id329"} Set#IsMember(s#0, $Box(u#0));
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-697j.dfy(262,5)
    assume true;
    assume true;
}
...
axiom {:id "id330"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    Regressions.__default.Filter#canCall(x#0) || 0 < $FunctionContextHeight
       ==> Regressions.__default.Filter(x#0)
...
axiom {:id "id331"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    Regressions.__default.Filter#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
...
procedure {:verboseName "Regressions.Filter (well-formedness)"} CheckWellformed$$Regressions.__default.Filter(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Regressions.Filter (well-formedness)"} CheckWellformed$$Regressions.__default.Filter(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    else
    {
        ...
        assert {:id "id332"} LitInt(2) != 0;
        if (Mod(x#0, LitInt(2)) == LitInt(1))
        {
        }

        assume {:id "id333"} Regressions.__default.Filter(x#0)
           == (Mod(x#0, LitInt(2)) == LitInt(1) && x#0 < 10);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(Regressions.__default.Filter(x#0), TBool);
        return;
...
procedure {:verboseName "Regressions.Test1 (correctness)"} Impl$$Regressions.__default.Test1() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "Regressions.byte (well-formedness)"} CheckWellFormed$$Regressions.byte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Regressions.byte (well-formedness)"} CheckWellFormed$$Regressions.byte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id337"} x#0 < 256;
        assume {:id "id338"} x#0 != 7;
        assume {:id "id339"} LitInt(0) <= x#0;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id340"} {:subsumption 0} Lit(0 < 256);
        assert {:id "id341"} {:subsumption 0} Lit(0 != 7);
        assert {:id "id342"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assume false;
    }
}
...
procedure {:verboseName "Regressions.NewByte (well-formedness)"} CheckWellFormed$$Regressions.NewByte(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Regressions.NewByte (well-formedness)"} CheckWellFormed$$Regressions.NewByte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype NewByte
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of newtype constraint
        assume {:id "id343"} x#0 < 256;
        assume {:id "id344"} x#0 != 7;
        assume {:id "id345"} LitInt(0) <= x#0;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id346"} {:subsumption 0} Lit(0 < 256);
        assert {:id "id347"} {:subsumption 0} Lit(0 != 7);
        assert {:id "id348"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assume false;
    }
}
...
procedure {:verboseName "Regressions.ByteBase (well-formedness)"} CheckWellFormed$$Regressions.ByteBase(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Regressions.ByteBase (well-formedness)"} CheckWellFormed$$Regressions.ByteBase(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype ByteBase
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        // check well-formedness of newtype constraint
        assume {:id "id349"} x#0 != 7;
        assume false;
    }
...
procedure {:verboseName "Regressions.Byyyte (well-formedness)"} CheckWellFormed$$Regressions.Byyyte(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Regressions.Byyyte (well-formedness)"} CheckWellFormed$$Regressions.Byyyte(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  ...
  var newtype$check#2: int;
    ...
    // AddWellformednessCheck for subset type Byyyte
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        ...
        assert {:id "id351"} newtype$check#0 != 7;
        assume {:id "id352"} x#0 < 256;
        newtype$check#1 := LitInt(0);
        assert {:id "id353"} newtype$check#1 != 7;
        assume {:id "id354"} LitInt(0) <= x#0;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id355"} newtype$check#2 != 7;
        assume true;
        assert {:id "id356"} {:subsumption 0} Lit(0 < 256);
        assert {:id "id357"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assume false;
    }
}
