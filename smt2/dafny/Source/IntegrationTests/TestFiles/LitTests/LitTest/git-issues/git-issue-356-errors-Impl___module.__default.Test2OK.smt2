...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@102  (=> (and (= $generated@@94 ($generated@@34 $generated@@95 $generated@@96 $generated@@97 false)) (= (ControlFlow 0 2) (- 0 1))) (<= 0 $generated@@98))))
(let (($generated@@103  (=> (and (and (and ($generated@@99 $generated@@96) ($generated@@100 $generated@@96)) (= 0 $generated@@101)) (and (>= $generated@@98 ($generated 0)) (= (ControlFlow 0 3) 2))) $generated@@102)))
$generated@@103)))
))
(check-sat)
(get-info :rlimit)
