...
(assert (distinct TChar TagChar TagSeq alloc Tagclass._module.Foo |##_module.Result.Success| Tagclass._module.Result |##_module.Result.Failure| Tagclass._module.Foo? tytagFamily$Foo tytagFamily$Result)
)
...
(set-info :boogie-vc-id Impl$$_module.Foo.FooMethod5)
...
(let ((anon6_Then_correct  (=> (= |r#0| (|#_module.Result.Success| ($Box SeqType |_mcc#0#1_0@0|))) (=> (and ($Is SeqType |_mcc#0#1_0@0| (TSeq TChar)) ($IsAlloc SeqType |_mcc#0#1_0@0| (TSeq TChar) $Heap)) (=> (and (and (and ($Is SeqType |C1#1_0@0| (TSeq TChar)) ($IsAlloc SeqType |C1#1_0@0| (TSeq TChar) $Heap)) (and (= |let#1_0#0#0| |_mcc#0#1_0@0|) ($Is SeqType |let#1_0#0#0| (TSeq TChar)))) (and (and (= |C1#1_0@0| |let#1_0#0#0|) (= |x#0@1| (LitInt 1))) (and (= |x#0@3| |x#0@1|) (= (ControlFlow 0 9) 7)))) anon4_correct)))))
(let ((anon7_Else_correct true))
(let ((anon6_Else_correct  (=> (or (not (= |r#0| (|#_module.Result.Success| ($Box SeqType |_mcc#0#1_0@0|)))) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon7_Then_correct) (=> (= (ControlFlow 0 11) 1) anon7_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Foo) ($IsAlloc refType this Tclass._module.Foo $Heap)))) (=> (and (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result (TSeq TChar))) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result (TSeq TChar)) $Heap)) (|$IsA#_module.Result| |r#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
