...
(set-info :boogie-vc-id CheckWellFormed$$StayOpaque.__default.TestByRequires)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |b#0| Tclass.StayOpaque.B) ($IsAlloc refType |b#0| Tclass.StayOpaque.B $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
