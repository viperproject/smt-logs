...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@2|))) (=> (=> (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@2|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (<= (LitInt 0) |i#0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |r#0@2|))) |i#0|))) (=> (=> (<= (LitInt 0) |i#0|) (= (U_2_int ($Unbox intType (_module.Result.Extract TInt |r#0@2|))) |i#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (< |i#0| 0) (_module.Result.Failure_q |r#0@2|)))))))))
(let ((anon5_Else_correct  (=> (and (and (<= 0 |i#0|) (= |r#0@1| (|#_module.Result.Success| ($Box intType (int_2_U |i#0|))))) (and (= |r#0@2| |r#0@1|) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct)))
(let ((anon5_Then_correct  (=> (and (and (< |i#0| 0) (= |r#0@0| (Lit DatatypeTypeType (|#_module.Result.Failure| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 110))) ($Box charType (|char#FromInt| 101))) ($Box charType (|char#FromInt| 103))) ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 116))) ($Box charType (|char#FromInt| 105))) ($Box charType (|char#FromInt| 118))) ($Box charType (|char#FromInt| 101)))))))) (and (= |r#0@2| |r#0@0|) (= (ControlFlow 0 5) 2))) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (=> (= (ControlFlow 0 7) 5) anon5_Then_correct) (=> (= (ControlFlow 0 7) 6) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
