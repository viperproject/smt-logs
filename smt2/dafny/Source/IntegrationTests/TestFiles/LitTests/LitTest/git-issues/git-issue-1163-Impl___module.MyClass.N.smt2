...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|$l#1_1_1_0#heap#0@@0| T@U) (|$l#1_1_1_0#x#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@0| |l#1|) |$l#1_1_1_0#heap#0@@0| |$l#1_1_1_0#x#0@@0|) (SetRef_to_SetBox (|lambda#3| (_module.MyClass.R |$l#1_1_1_0#heap#0@@0| |l#0@@0| |l#1|))))
 :qid |gitissue1163dfy.18:9|
 :skolemid |524|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@0| |l#1|) |$l#1_1_1_0#heap#0@@0| |$l#1_1_1_0#x#0@@0|))
)))
...
(assert (forall ((|l#0@@1| T@U) (|$l#1_1_1_0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#3| |l#0@@1|) |$l#1_1_1_0#o#0|)) (= |$l#1_1_1_0#o#0| |l#0@@1|))
 :qid |gitissue1163dfy.27:43|
 :skolemid |523|
 :pattern ( (MapType1Select refType boolType (|lambda#3| |l#0@@1|) |$l#1_1_1_0#o#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@2| |l#1@@0| |l#2| |l#3|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@3) |l#2|)))) (= $o@@3 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |520|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@2| |l#1@@0| |l#2| |l#3|) $o@@3 $f))
)))
...
(assert (forall ((|$l#1_1_1_0#heap#0@@1| T@U) (|$l#1_1_1_0#x#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#1| |$l#1_1_1_0#heap#0@@1| |$l#1_1_1_0#x#0@@1|) ($Box intType ($Unbox intType |$l#1_1_1_0#x#0@@1|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |521|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#1| |$l#1_1_1_0#heap#0@@1| |$l#1_1_1_0#x#0@@1|))
)))
...
(assert (= (Tag Tclass._module.MyClass) Tagclass._module.MyClass))
(assert (= (TagFamily Tclass._module.MyClass) tytagFamily$MyClass))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) (|c#0@@5| T@U) ) (!  (=> (or (|_module.MyClass.R#canCall| $Heap@@1 this@@1 |c#0@@5|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.MyClass) ($IsAlloc refType this@@1 Tclass._module.MyClass $Heap@@1)))) (and ($Is refType |c#0@@5| Tclass._module.MyClass) ($IsAlloc refType |c#0@@5| Tclass._module.MyClass $Heap@@1))))) ($Is refType (_module.MyClass.R $Heap@@1 this@@1 |c#0@@5|) Tclass._module.MyClass))
 :qid |gitissue1163dfy.61:18|
 :skolemid |514|
 :pattern ( (_module.MyClass.R $Heap@@1 this@@1 |c#0@@5|))
))))
...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@2 T@U) (|c#0@@6| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.MyClass))) (or (|_module.MyClass.R#canCall| $h0 this@@2 |c#0@@6|) ($Is refType |c#0@@6| Tclass._module.MyClass))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (= $o@@6 this@@2)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h0 $o@@6) $f@@0) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $h1 $o@@6) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |512|
)) (= (_module.MyClass.R $h0 this@@2 |c#0@@6|) (_module.MyClass.R $h1 this@@2 |c#0@@6|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |513|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.MyClass.R $h1 this@@2 |c#0@@6|))
)))
...
(declare-fun |$Heap_at_$lambdaHeap#1_0_0@0| () T@U)
(declare-fun |b$reqreads#1_0_0@0| () Bool)
(declare-fun |$_Frame#l1_1_0_0@0| () T@U)
(declare-fun |$Heap_at_$lambdaHeap#1_1_0_0@0| () T@U)
(declare-fun |b$reqreads#1_1_0_0@0| () Bool)
(declare-fun $Heap@1 () T@U)
(declare-fun |$_Frame#l1_1_1_0@0| () T@U)
(declare-fun |$Heap_at_$lambdaHeap#1_1_1_0@0| () T@U)
(declare-fun |b$reqreads#1_1_1_0@0| () Bool)
(declare-fun $Heap@@2 () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun |$rhs#0@0| () Int)
(declare-fun |defass#p#0| () Bool)
(declare-fun |p#0| () T@U)
(declare-fun |g#0_0| () T@U)
(declare-fun |g#1_0_0| () T@U)
(declare-fun |g#1_1_0_0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 46) (let ((anon25_Else_correct true))
(let ((anon25_Then_correct  (=> (= |$_Frame#l0_0@0| (|lambda#0| null |$Heap_at_$lambdaHeap#0_0@0| alloc (_module.MyClass.R |$Heap_at_$lambdaHeap#0_0@0| $nw@0 this@@3))) (and (=> (= (ControlFlow 0 36) (- 0 40)) true) (and (=> (= (ControlFlow 0 36) (- 0 39)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 36) (- 0 38)) ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|)) (=> ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|) (and (=> (= (ControlFlow 0 36) (- 0 37)) ($IsAlloc refType this@@3 Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|)) (=> ($IsAlloc refType this@@3 Tclass._module.MyClass |$Heap_at_$lambdaHeap#0_0@0|) (=> (= |b$reqreads#0_0@0| (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#0_0@0| $o@@7) alloc)))) (= $o@@7 $nw@0)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0_0@0| $o@@7 $f@@1)))
 :qid |gitissue1163dfy.21:45|
 :skolemid |495|
))) (=> (and (|_module.MyClass.R#canCall| |$Heap_at_$lambdaHeap#0_0@0| $nw@0 this@@3) (= (ControlFlow 0 36) (- 0 35))) |b$reqreads#0_0@0|))))))))))))
(let ((anon24_Then_correct  (=> (and ($IsGoodHeap |$Heap_at_$lambdaHeap#0_0@0|) (or (= $Heap@0 |$Heap_at_$lambdaHeap#0_0@0|) ($HeapSucc $Heap@0 |$Heap_at_$lambdaHeap#0_0@0|))) (and (=> (= (ControlFlow 0 42) 36) anon25_Then_correct) (=> (= (ControlFlow 0 42) 41) anon25_Else_correct)))))
(let ((anon24_Else_correct true))
(let ((anon23_Then_correct  (and (=> (= (ControlFlow 0 43) 42) anon24_Then_correct) (=> (= (ControlFlow 0 43) 34) anon24_Else_correct))))
(let ((anon28_Else_correct true))
(let ((anon28_Then_correct  (=> (= |$_Frame#l1_0_0@0| (|lambda#0| null |$Heap_at_$lambdaHeap#1_0_0@0| alloc (_module.MyClass.R |$Heap_at_$lambdaHeap#1_0_0@0| this@@3 $nw@0))) (and (=> (= (ControlFlow 0 26) (- 0 29)) true) (and (=> (= (ControlFlow 0 26) (- 0 28)) ($IsAlloc refType this@@3 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_0_0@0|)) (=> ($IsAlloc refType this@@3 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_0_0@0|) (and (=> (= (ControlFlow 0 26) (- 0 27)) ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_0_0@0|)) (=> ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_0_0@0|) (=> (= |b$reqreads#1_0_0@0| (forall (($o@@8 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#1_0_0@0| $o@@8) alloc)))) (= $o@@8 this@@3)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l1_0_0@0| $o@@8 $f@@2)))
 :qid |gitissue1163dfy.23:43|
 :skolemid |496|
))) (=> (and (|_module.MyClass.R#canCall| |$Heap_at_$lambdaHeap#1_0_0@0| this@@3 $nw@0) (= (ControlFlow 0 26) (- 0 25))) |b$reqreads#1_0_0@0|))))))))))
(let ((anon27_Then_correct  (=> (and ($IsGoodHeap |$Heap_at_$lambdaHeap#1_0_0@0|) (or (= $Heap@0 |$Heap_at_$lambdaHeap#1_0_0@0|) ($HeapSucc $Heap@0 |$Heap_at_$lambdaHeap#1_0_0@0|))) (and (=> (= (ControlFlow 0 31) 26) anon28_Then_correct) (=> (= (ControlFlow 0 31) 30) anon28_Else_correct)))))
(let ((anon27_Else_correct true))
(let ((anon26_Then_correct  (and (=> (= (ControlFlow 0 32) 31) anon27_Then_correct) (=> (= (ControlFlow 0 32) 24) anon27_Else_correct))))
(let ((anon31_Else_correct true))
(let ((anon31_Then_correct  (=> (= |$_Frame#l1_1_0_0@0| (|lambda#0| null |$Heap_at_$lambdaHeap#1_1_0_0@0| alloc (_module.MyClass.R |$Heap_at_$lambdaHeap#1_1_0_0@0| $nw@0 $nw@0))) (and (=> (= (ControlFlow 0 14) (- 0 19)) true) (and (=> (= (ControlFlow 0 14) (- 0 18)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 17)) true) (and (=> (= (ControlFlow 0 14) (- 0 16)) ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_1_0_0@0|)) (=> ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_1_0_0@0|) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_1_0_0@0|)) (=> ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_1_0_0@0|) (=> (= |b$reqreads#1_1_0_0@0| (forall (($o@@9 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#1_1_0_0@0| $o@@9) alloc)))) (= $o@@9 $nw@0)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l1_1_0_0@0| $o@@9 $f@@3)))
 :qid |gitissue1163dfy.25:45|
 :skolemid |497|
))) (=> (and (|_module.MyClass.R#canCall| |$Heap_at_$lambdaHeap#1_1_0_0@0| $nw@0 $nw@0) (= (ControlFlow 0 14) (- 0 13))) |b$reqreads#1_1_0_0@0|)))))))))))))
(let ((anon30_Then_correct  (=> (and ($IsGoodHeap |$Heap_at_$lambdaHeap#1_1_0_0@0|) (or (= $Heap@1 |$Heap_at_$lambdaHeap#1_1_0_0@0|) ($HeapSucc $Heap@1 |$Heap_at_$lambdaHeap#1_1_0_0@0|))) (and (=> (= (ControlFlow 0 21) 14) anon31_Then_correct) (=> (= (ControlFlow 0 21) 20) anon31_Else_correct)))))
(let ((anon30_Else_correct true))
(let ((anon29_Then_correct  (and (=> (= (ControlFlow 0 22) 21) anon30_Then_correct) (=> (= (ControlFlow 0 22) 12) anon30_Else_correct))))
(let ((anon33_Else_correct true))
(let ((anon33_Then_correct  (=> (= |$_Frame#l1_1_1_0@0| (|lambda#0| null |$Heap_at_$lambdaHeap#1_1_1_0@0| alloc (_module.MyClass.R |$Heap_at_$lambdaHeap#1_1_1_0@0| $nw@0 $nw@0))) (and (=> (= (ControlFlow 0 3) (- 0 8)) true) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) true) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_1_1_0@0|)) (=> ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_1_1_0@0|) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_1_1_0@0|)) (=> ($IsAlloc refType $nw@0 Tclass._module.MyClass |$Heap_at_$lambdaHeap#1_1_1_0@0|) (=> (= |b$reqreads#1_1_1_0@0| (forall (($o@@10 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |$Heap_at_$lambdaHeap#1_1_1_0@0| $o@@10) alloc)))) (= $o@@10 $nw@0)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l1_1_1_0@0| $o@@10 $f@@4)))
 :qid |gitissue1163dfy.27:43|
 :skolemid |498|
))) (=> (and (|_module.MyClass.R#canCall| |$Heap_at_$lambdaHeap#1_1_1_0@0| $nw@0 $nw@0) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#1_1_1_0@0|)))))))))))))
(let ((anon32_Then_correct  (=> (and ($IsGoodHeap |$Heap_at_$lambdaHeap#1_1_1_0@0|) (or (= $Heap@@2 |$Heap_at_$lambdaHeap#1_1_1_0@0|) ($HeapSucc $Heap@@2 |$Heap_at_$lambdaHeap#1_1_1_0@0|))) (and (=> (= (ControlFlow 0 10) 3) anon33_Then_correct) (=> (= (ControlFlow 0 10) 9) anon33_Else_correct)))))
(let ((anon32_Else_correct true))
(let ((anon29_Else_correct  (and (=> (= (ControlFlow 0 11) 10) anon32_Then_correct) (=> (= (ControlFlow 0 11) 1) anon32_Else_correct))))
(let ((anon26_Else_correct  (and (=> (= (ControlFlow 0 23) 22) anon29_Then_correct) (=> (= (ControlFlow 0 23) 11) anon29_Else_correct))))
(let ((anon23_Else_correct  (and (=> (= (ControlFlow 0 33) 32) anon26_Then_correct) (=> (= (ControlFlow 0 33) 23) anon26_Else_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc this@@3)) (and (=> (= (ControlFlow 0 44) (- 0 45)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 this@@3 _module.MyClass.y))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 this@@3 _module.MyClass.y)) (=> (= |$rhs#0@0| (LitInt 8)) (=> (and (and (and (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@@2 this@@3 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@@2 this@@3) _module.MyClass.y ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.MyClass?))) (and (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@0) alloc)))) (= $Heap@1 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@0 $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (=> (= (ControlFlow 0 44) 43) anon23_Then_correct) (=> (= (ControlFlow 0 44) 33) anon23_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.MyClass) ($IsAlloc refType this@@3 Tclass._module.MyClass $Heap@@2))) (and (=> |defass#p#0| (and ($Is refType |p#0| Tclass._module.MyClass) ($IsAlloc refType |p#0| Tclass._module.MyClass $Heap@@2))) true)) (and (and ($Is HandleTypeType |g#0_0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#0_0| (Tclass._System.___hFunc1 TInt TInt) $Heap@@2)) true)) (=> (and (and (and (and ($Is HandleTypeType |g#1_0_0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#1_0_0| (Tclass._System.___hFunc1 TInt TInt) $Heap@@2)) true) (and (and ($Is HandleTypeType |g#1_1_0_0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#1_1_0_0| (Tclass._System.___hFunc1 TInt TInt) $Heap@@2)) true)) (and (and (and ($Is HandleTypeType |g#1_1_1_0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#1_1_1_0| (Tclass._System.___hFunc1 TInt TInt) $Heap@@2)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 46) 44)))) anon0_correct)))))
