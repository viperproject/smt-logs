...
(set-info :boogie-vc-id Impl$$_module.__default.Test1b)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is charType |ch#0| TChar) true) (= 0 $FunctionContextHeight)) (and (< |n#0| 65536) (= (ControlFlow 0 3) 2))) anon0_correct))))
