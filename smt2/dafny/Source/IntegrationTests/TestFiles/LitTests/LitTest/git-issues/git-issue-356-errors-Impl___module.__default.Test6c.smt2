...
(set-info :boogie-vc-id Impl$$_module.__default.Test6c)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 0 $FunctionContextHeight) (<= (LitReal 0.0) |r#0|)) (and (<= |r#0| (LitReal 255.0)) (= (ControlFlow 0 4) 2))) anon0_correct))))
