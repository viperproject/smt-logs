// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-261.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-261-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-261.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var x#0: DatatypeType
     where $Is(x#0, 
        Tclass._module.Option(Tclass._System.Tuple2(Tclass._System.nat(), Tclass._System.nat())))
       && $IsAlloc(x#0, 
        Tclass._module.Option(Tclass._System.Tuple2(Tclass._System.nat(), Tclass._System.nat())), 
        $Heap);
  var a#0: int;
  ...
  var let#0#0#0: DatatypeType;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-261.dfy(6,30)
    assume true;
    assert {:id "id0"} $Is(Lit(#_System._tuple#2._#Make2($Box(LitInt(2)), $Box(LitInt(3)))), 
      Tclass._System.Tuple2(Tclass._System.nat(), Tclass._System.nat()));
    assume true;
    x#0 := Lit(#_module.Option.Some($Box(Lit(#_System._tuple#2._#Make2($Box(LitInt(2)), $Box(LitInt(3)))))));
    havoc a#0;
    assume LitInt(0) <= a#0;
    havoc b#0;
    assume LitInt(0) <= b#0;
    assume {:id "id2"} let#0#0#0 == x#0;
    assume true;
    assume true;
    // CheckWellformedWithResult: any expression
    assume $Is(let#0#0#0, 
      Tclass._module.Option(Tclass._System.Tuple2(Tclass._System.nat(), Tclass._System.nat())));
    assert {:id "id3"} _module.Option.Some_q(let#0#0#0);
    assume _System.Tuple2.___hMake2_q($Unbox(_module.Option._h0(let#0#0#0)): DatatypeType);
    assume {:id "id4"} #_module.Option.Some($Box(#_System._tuple#2._#Make2($Box(a#0), $Box(b#0))))
       == let#0#0#0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-261.dfy(8,3)
    assume true;
    assume true;
    assume true;
    assume true;
...
axiom (forall d: DatatypeType, _module.Option$T: Ty, $h: Heap :: 
  { $IsAllocBox(_module.Option._h0(d), _module.Option$T, $h) } 
  $IsGoodHeap($h)
       && 
      _module.Option.Some_q(d)
