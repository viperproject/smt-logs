...
(declare-fun _module.__default.F0 (T@U T@U T@U) Bool)
...
(declare-fun _module.__default.F0_h (T@U T@U T@U T@U) Bool)
...
(declare-fun |_module.__default.F0_h#canCall| (T@U T@U T@U) Bool)
...
(declare-fun |_module.__default.F0#canCall| (T@U T@U) Bool)
...
(assert (forall ((_module._default.F0$Y T@U) ($ly T@U) (|s#0| T@U) ) (! (= (_module.__default.F0 _module._default.F0$Y ($LS $ly) |s#0|) (_module.__default.F0 _module._default.F0$Y $ly |s#0|))
 :qid |unknown.0:0|
 :skolemid |555|
 :pattern ( (_module.__default.F0 _module._default.F0$Y ($LS $ly) |s#0|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.F0#$Y| T@U) ($ly@@0 T@U) (|s#0@@0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@0| (Tclass._module.Stream |_module._default.F0#$Y|)) (_module.__default.F0 |_module._default.F0#$Y| ($LS $ly@@0) |s#0@@0|)) (exists ((|_k#0| T@U) ) (! (_module.__default.F0_h |_module._default.F0#$Y| ($LS $ly@@0) |_k#0| |s#0@@0|)
 :qid |gitissue2947dfy.12:17|
 :skolemid |560|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y| ($LS $ly@@0) |_k#0| |s#0@@0|))
)))
 :qid |unknown.0:0|
 :skolemid |561|
 :pattern ( (_module.__default.F0 |_module._default.F0#$Y| ($LS $ly@@0) |s#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.F0#$Y@@0| T@U) ($ly@@1 T@U) (|s#0@@1| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@1| (Tclass._module.Stream |_module._default.F0#$Y@@0|)) (exists ((|_k#0@@0| T@U) ) (! (_module.__default.F0_h |_module._default.F0#$Y@@0| ($LS $ly@@1) |_k#0@@0| |s#0@@1|)
 :qid |gitissue2947dfy.12:17|
 :skolemid |560|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@0| ($LS $ly@@1) |_k#0@@0| |s#0@@1|))
))) (_module.__default.F0 |_module._default.F0#$Y@@0| ($LS $ly@@1) |s#0@@1|))
 :qid |unknown.0:0|
 :skolemid |562|
 :pattern ( (_module.__default.F0 |_module._default.F0#$Y@@0| ($LS $ly@@1) |s#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.F0#$Y@@1| T@U) ($ly@@2 T@U) (|s#0@@2| T@U) (|_k#0@@1| T@U) (_m T@U) (_limit T@U) ) (!  (=> (|ORD#Less| |_k#0@@1| _m) (=> (_module.__default.F0_h |_module._default.F0#$Y@@1| $ly@@2 |_k#0@@1| |s#0@@2|) (_module.__default.F0_h |_module._default.F0#$Y@@1| $ly@@2 _m |s#0@@2|)))
 :qid |unknown.0:0|
 :skolemid |564|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@1| $ly@@2 |_k#0@@1| |s#0@@2|) (|ORD#LessThanLimit| |_k#0@@1| _limit) (|ORD#LessThanLimit| _m _limit))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.F0#$Y@@2| T@U) ($ly@@3 T@U) (|_k#0@@2| T@U) (|s#0@@3| T@U) ) (!  (=> (or (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@2| (Lit BoxType |_k#0@@2|) (Lit DatatypeTypeType |s#0@@3|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@3| (Tclass._module.Stream |_module._default.F0#$Y@@2|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (let ((|nil#3| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (and (and (|$IsA#_module.Stream| (Lit DatatypeTypeType |s#0@@3|)) (|$IsA#_module.Stream| |nil#3|)) (=> (not (|$Eq#_module.Stream| |_module._default.F0#$Y@@2| |_module._default.F0#$Y@@2| ($LS ($LS $LZ)) |s#0@@3| |nil#3|)) (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@2| (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|)))))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (let ((|nil#3@@0| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (or (|$Eq#_module.Stream| |_module._default.F0#$Y@@2| |_module._default.F0#$Y@@2| ($LS ($LS $LZ)) |s#0@@3| |nil#3@@0|) (_module.__default.F0_h |_module._default.F0#$Y@@2| ($LS $ly@@3) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (forall ((|_k'#2| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#2| |_k#0@@2|) (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@2| |_k'#2| |s#0@@3|))
 :qid |gitissue2947dfy.12:17|
 :skolemid |577|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@2| ($LS $ly@@3) |_k'#2| |s#0@@3|))
))))) (= (_module.__default.F0_h |_module._default.F0#$Y@@2| ($LS $ly@@3) (Lit BoxType |_k#0@@2|) (Lit DatatypeTypeType |s#0@@3|))  (and (=> (< 0 (|ORD#Offset| |_k#0@@2|)) (let ((|nil#3@@1| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (or (|$Eq#_module.Stream| |_module._default.F0#$Y@@2| |_module._default.F0#$Y@@2| ($LS ($LS $LZ)) |s#0@@3| |nil#3@@1|) (_module.__default.F0_h |_module._default.F0#$Y@@2| ($LS $ly@@3) (|ORD#Minus| |_k#0@@2| (|ORD#FromNat| 1)) (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType |s#0@@3|))))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@2|)) (exists ((|_k'#2@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#2@@0| |_k#0@@2|) (_module.__default.F0_h |_module._default.F0#$Y@@2| ($LS $ly@@3) |_k'#2@@0| |s#0@@3|))
 :qid |gitissue2947dfy.12:17|
 :skolemid |576|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@2| ($LS $ly@@3) |_k'#2@@0| |s#0@@3|))
)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |578|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@2| ($LS $ly@@3) (Lit BoxType |_k#0@@2|) (Lit DatatypeTypeType |s#0@@3|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.F0#$Y@@3| T@U) ($ly@@4 T@U) (|_k#0@@3| T@U) (|s#0@@4| T@U) ) (!  (=> (or (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@3| |_k#0@@3| |s#0@@4|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@4| (Tclass._module.Stream |_module._default.F0#$Y@@3|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (let ((|nil#1| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (and (and (|$IsA#_module.Stream| |s#0@@4|) (|$IsA#_module.Stream| |nil#1|)) (=> (not (|$Eq#_module.Stream| |_module._default.F0#$Y@@3| |_module._default.F0#$Y@@3| ($LS ($LS $LZ)) |s#0@@4| |nil#1|)) (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@3| (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@4|)))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (let ((|nil#1@@0| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (or (|$Eq#_module.Stream| |_module._default.F0#$Y@@3| |_module._default.F0#$Y@@3| ($LS ($LS $LZ)) |s#0@@4| |nil#1@@0|) (_module.__default.F0_h |_module._default.F0#$Y@@3| $ly@@4 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@4|))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#0| |_k#0@@3|) (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@3| |_k'#0| |s#0@@4|))
 :qid |gitissue2947dfy.12:17|
 :skolemid |571|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@3| $ly@@4 |_k'#0| |s#0@@4|))
))))) (= (_module.__default.F0_h |_module._default.F0#$Y@@3| ($LS $ly@@4) |_k#0@@3| |s#0@@4|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@3|)) (let ((|nil#1@@1| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (or (|$Eq#_module.Stream| |_module._default.F0#$Y@@3| |_module._default.F0#$Y@@3| ($LS ($LS $LZ)) |s#0@@4| |nil#1@@1|) (_module.__default.F0_h |_module._default.F0#$Y@@3| $ly@@4 (|ORD#Minus| |_k#0@@3| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@4|))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@3|)) (exists ((|_k'#0@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@0| |_k#0@@3|) (_module.__default.F0_h |_module._default.F0#$Y@@3| $ly@@4 |_k'#0@@0| |s#0@@4|))
 :qid |gitissue2947dfy.12:17|
 :skolemid |570|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@3| $ly@@4 |_k'#0@@0| |s#0@@4|))
)))))))
 :qid |unknown.0:0|
 :skolemid |572|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@3| ($LS $ly@@4) |_k#0@@3| |s#0@@4|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.F0$Y@@0 T@U) ($ly@@5 T@U) (|s#0@@5| T@U) ) (!  (=> (or (|_module.__default.F0#canCall| _module._default.F0$Y@@0 |s#0@@5|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@5| (Tclass._module.Stream _module._default.F0$Y@@0)))) (and (let ((|nil#0| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (and (and (|$IsA#_module.Stream| |s#0@@5|) (|$IsA#_module.Stream| |nil#0|)) (=> (not (|$Eq#_module.Stream| _module._default.F0$Y@@0 _module._default.F0$Y@@0 ($LS ($LS $LZ)) |s#0@@5| |nil#0|)) (|_module.__default.F0#canCall| _module._default.F0$Y@@0 (_module.Stream.tail |s#0@@5|))))) (= (_module.__default.F0 _module._default.F0$Y@@0 ($LS $ly@@5) |s#0@@5|) (let ((|nil#0@@0| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (or (|$Eq#_module.Stream| _module._default.F0$Y@@0 _module._default.F0$Y@@0 ($LS ($LS $LZ)) |s#0@@5| |nil#0@@0|) (_module.__default.F0 _module._default.F0$Y@@0 $ly@@5 (_module.Stream.tail |s#0@@5|)))))))
 :qid |unknown.0:0|
 :skolemid |559|
 :pattern ( (_module.__default.F0 _module._default.F0$Y@@0 ($LS $ly@@5) |s#0@@5|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.F0#$Y@@4| T@U) ($ly@@6 T@U) (|s#0@@6| T@U) (|_k#0@@4| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#0@@6| (Tclass._module.Stream |_module._default.F0#$Y@@4|)) (= |_k#0@@4| (|ORD#FromNat| 0))) (not (_module.__default.F0_h |_module._default.F0#$Y@@4| $ly@@6 |_k#0@@4| |s#0@@6|)))
 :qid |unknown.0:0|
 :skolemid |563|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@4| $ly@@6 |_k#0@@4| |s#0@@6|))
))))
...
(assert (forall ((|_module._default.F0#$Y@@5| T@U) ($ly@@7 T@U) (|_k#0@@5| T@U) (|s#0@@7| T@U) ) (! (= (_module.__default.F0_h |_module._default.F0#$Y@@5| ($LS $ly@@7) |_k#0@@5| |s#0@@7|) (_module.__default.F0_h |_module._default.F0#$Y@@5| $ly@@7 |_k#0@@5| |s#0@@7|))
 :qid |unknown.0:0|
 :skolemid |566|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@5| ($LS $ly@@7) |_k#0@@5| |s#0@@7|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.F0#$Y@@6| T@U) ($ly@@8 T@U) (|_k#0@@6| T@U) (|s#0@@8| T@U) ) (!  (=> (or (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@6| (Lit BoxType |_k#0@@6|) |s#0@@8|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0@@8| (Tclass._module.Stream |_module._default.F0#$Y@@6|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (let ((|nil#2| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (and (and (|$IsA#_module.Stream| |s#0@@8|) (|$IsA#_module.Stream| |nil#2|)) (=> (not (|$Eq#_module.Stream| |_module._default.F0#$Y@@6| |_module._default.F0#$Y@@6| ($LS ($LS $LZ)) |s#0@@8| |nil#2|)) (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@6| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@8|)))))) (=> (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (let ((|nil#2@@0| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (or (|$Eq#_module.Stream| |_module._default.F0#$Y@@6| |_module._default.F0#$Y@@6| ($LS ($LS $LZ)) |s#0@@8| |nil#2@@0|) (_module.__default.F0_h |_module._default.F0#$Y@@6| ($LS $ly@@8) (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@8|))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@6|)) (forall ((|_k'#1| T@U) ) (!  (=> (|ORD#LessThanLimit| |_k'#1| |_k#0@@6|) (|_module.__default.F0_h#canCall| |_module._default.F0#$Y@@6| |_k'#1| |s#0@@8|))
 :qid |gitissue2947dfy.12:17|
 :skolemid |574|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@6| ($LS $ly@@8) |_k'#1| |s#0@@8|))
))))) (= (_module.__default.F0_h |_module._default.F0#$Y@@6| ($LS $ly@@8) (Lit BoxType |_k#0@@6|) |s#0@@8|)  (and (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (let ((|nil#2@@1| (Lit DatatypeTypeType |#_module.Stream.Nil|)))
 (or (|$Eq#_module.Stream| |_module._default.F0#$Y@@6| |_module._default.F0#$Y@@6| ($LS ($LS $LZ)) |s#0@@8| |nil#2@@1|) (_module.__default.F0_h |_module._default.F0#$Y@@6| ($LS $ly@@8) (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0@@8|))))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@6|)) (exists ((|_k'#1@@0| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@0| |_k#0@@6|) (_module.__default.F0_h |_module._default.F0#$Y@@6| ($LS $ly@@8) |_k'#1@@0| |s#0@@8|))
 :qid |gitissue2947dfy.12:17|
 :skolemid |573|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@6| ($LS $ly@@8) |_k'#1@@0| |s#0@@8|))
)))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |575|
 :pattern ( (_module.__default.F0_h |_module._default.F0#$Y@@6| ($LS $ly@@8) (Lit BoxType |_k#0@@6|) |s#0@@8|))
))))
...
(declare-fun _module._default.F0$Y@@1 () T@U)
(declare-fun |s#0@@9| () T@U)
(declare-fun |nil#Z#0@0| () T@U)
...
(let ((anon8_Else_correct  (=> (and (|$Eq#_module.Stream| _module._default.F0$Y@@1 _module._default.F0$Y@@1 ($LS ($LS $LZ)) |s#0@@9| |nil#Z#0@0|) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> (not (|$Eq#_module.Stream| _module._default.F0$Y@@1 _module._default.F0$Y@@1 ($LS ($LS $LZ)) |s#0@@9| |nil#Z#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.Stream.Cons_q |s#0@@9|)) (=> (_module.Stream.Cons_q |s#0@@9|) (=> (and (and (= |##s#0@0| (_module.Stream.tail |s#0@@9|)) ($IsAlloc DatatypeTypeType |##s#0@0| (Tclass._module.Stream _module._default.F0$Y@@1) $Heap)) (and (|_module.__default.F0#canCall| _module._default.F0$Y@@1 (_module.Stream.tail |s#0@@9|)) (= (ControlFlow 0 3) 2))) anon5_correct))))))
(let ((anon7_Else_correct  (=> (= |let#0#0#0| (Lit DatatypeTypeType |#_module.Stream.Nil|)) (=> (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Stream _module._default.F0$Y@@1)) (= |nil#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 6) 3) anon8_Then_correct) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |s#0@@9| (Tclass._module.Stream _module._default.F0$Y@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
