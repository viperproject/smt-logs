...
(set-info :boogie-vc-id Impl$$_module.Foo.FooMethod2q)
...
(let ((anon25_Else_correct  (=> (and (or (or (= |x#5@3| (LitInt 0)) (= |x#5@3| (LitInt 1))) (= |x#5@3| (LitInt 3))) (= (ControlFlow 0 7) 4)) GeneratedUnifiedExit_correct)))
...
(let ((anon24_Else_correct  (=> (and (or (= |x#5@3| (LitInt 0)) (= |x#5@3| (LitInt 1))) (= (ControlFlow 0 10) 8)) anon15_correct)))
(let ((anon24_Then_correct  (=> (and (not (or (= |x#5@3| (LitInt 0)) (= |x#5@3| (LitInt 1)))) (= (ControlFlow 0 9) 8)) anon15_correct)))
(let ((anon23_Else_correct  (=> (= |x#5@3| (LitInt 0)) (and (=> (= (ControlFlow 0 12) 9) anon24_Then_correct) (=> (= (ControlFlow 0 12) 10) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (or (not (= |x#5@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 11) 9) anon24_Then_correct) (=> (= (ControlFlow 0 11) 10) anon24_Else_correct)))))
(let ((anon11_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (or (= |x#5@3| (LitInt 0)) (= |x#5@3| (LitInt 1))) (= |x#5@3| (LitInt 3)))) (=> (or (or (= |x#5@3| (LitInt 0)) (= |x#5@3| (LitInt 1))) (= |x#5@3| (LitInt 3))) (and (=> (= (ControlFlow 0 13) 11) anon23_Then_correct) (=> (= (ControlFlow 0 13) 12) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (and (or (= |x#5@3| (LitInt 0)) (= |x#5@3| (LitInt 1))) (= (ControlFlow 0 16) 13)) anon11_correct)))
(let ((anon22_Then_correct  (=> (and (not (or (= |x#5@3| (LitInt 0)) (= |x#5@3| (LitInt 1)))) (= (ControlFlow 0 15) 13)) anon11_correct)))
(let ((anon21_Else_correct  (=> (= |x#5@3| (LitInt 0)) (and (=> (= (ControlFlow 0 18) 15) anon22_Then_correct) (=> (= (ControlFlow 0 18) 16) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (or (not (= |x#5@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 17) 15) anon22_Then_correct) (=> (= (ControlFlow 0 17) 16) anon22_Else_correct)))))
...
(let ((anon18_Then_correct  (=> (= |_mcc#0#1_0@0| |#_module.C.C1|) (=> (and (= |x#5@2| (LitInt 1)) (= |x#5@3| |x#5@2|)) (and (=> (= (ControlFlow 0 21) 17) anon21_Then_correct) (=> (= (ControlFlow 0 21) 18) anon21_Else_correct))))))
...
(let ((anon20_Then_correct  (=> (= |r#0| (|#_module.Result.Failure| |_mcc#2#0_0@0|)) (=> (and ($Is SeqType |_mcc#2#0_0@0| (TSeq TChar)) ($IsAlloc SeqType |_mcc#2#0_0@0| (TSeq TChar) $Heap)) (=> (and (and (and ($Is SeqType |e#0_0@0| (TSeq TChar)) ($IsAlloc SeqType |e#0_0@0| (TSeq TChar) $Heap)) (= |let#0_0#0#0| |_mcc#2#0_0@0|)) (and (and ($Is SeqType |let#0_0#0#0| (TSeq TChar)) (= |e#0_0@0| |let#0_0#0#0|)) (and (= |x#5@1| (LitInt 3)) (= |x#5@3| |x#5@1|)))) (and (=> (= (ControlFlow 0 19) 17) anon21_Then_correct) (=> (= (ControlFlow 0 19) 18) anon21_Else_correct)))))))
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x#5@0| (LitInt 0))) (and (=> (= (ControlFlow 0 26) 25) anon17_Then_correct) (=> (= (ControlFlow 0 26) 20) anon17_Else_correct)))))
