...
(set-info :boogie-vc-id Impl$$_module.__default.Workaround)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |s#0|)))) (=> (and (<= 0 |i#0|) (< |i#0| (|Seq#Length| |s#0|))) (=> (= |t#0@0| (|Seq#Update| |s#0| |i#0| ($Box intType (int_2_U |v#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 |n#0|) (<= |n#0| (|Seq#Length| |s#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 |n#0|) (<= |n#0| (|Seq#Length| |t#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Seq#Equal| (|Seq#Drop| |s#0| |n#0|) (|Seq#Drop| |t#0@0| |n#0|))) (=> (|Seq#Equal| (|Seq#Drop| |s#0| |n#0|) (|Seq#Drop| |t#0@0| |n#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |n#0|) (<= |n#0| (|Seq#Length| |t#0@0|)))) (=> (= |##s#1@0| (|Seq#Drop| |t#0@0| |n#0|)) (=> (and (and ($IsAlloc SeqType |##s#1@0| (TSeq TInt) $Heap) (|_module.__default.P#canCall| TInt (|Seq#Drop| |t#0@0| |n#0|))) (and (|_module.__default.P#canCall| TInt (|Seq#Drop| |t#0@0| |n#0|)) (= (ControlFlow 0 2) (- 0 1)))) (_module.__default.P TInt (|Seq#Drop| |t#0@0| |n#0|)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) (and (<= (LitInt 0) |i#0|) (<= (LitInt 0) |n#0|))) (=> (and (and (and (and ($Is SeqType |t#0| (TSeq TInt)) ($IsAlloc SeqType |t#0| (TSeq TInt) $Heap)) true) (= 1 $FunctionContextHeight)) (and (and (< |i#0| |n#0|) (<= |n#0| (|Seq#Length| |s#0|))) (and (_module.__default.P TInt (|Seq#Drop| |s#0| |n#0|)) (= (ControlFlow 0 8) 2)))) anon0_correct)))))
