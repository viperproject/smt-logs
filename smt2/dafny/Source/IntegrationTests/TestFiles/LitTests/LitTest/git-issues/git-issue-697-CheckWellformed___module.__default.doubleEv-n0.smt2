...
(assert (distinct TInt TagInt alloc Tagclass._module.EvenCell Tagclass._module.Cell |##_module.Cell.Cell| tytagFamily$EvenCell tytagFamily$Cell)
)
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|c#0| T@U) ) (!  (=> (or (|_module.__default.doubleEvenCell#canCall| (Lit DatatypeTypeType |c#0|)) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |c#0| Tclass._module.EvenCell))) (and (and (_module.Cell.Cell_q (Lit DatatypeTypeType |c#0|)) (=> (or (not (= (LitInt (Mod (_module.Cell.x (Lit DatatypeTypeType |c#0|)) (LitInt 2))) (LitInt 1))) (not true)) (_module.Cell.Cell_q (Lit DatatypeTypeType |c#0|)))) (= (_module.__default.doubleEvenCell (Lit DatatypeTypeType |c#0|)) (ite (= (LitInt (Mod (_module.Cell.x (Lit DatatypeTypeType |c#0|)) (LitInt 2))) (LitInt 1)) (Div 1 (LitInt 0)) (Mul (LitInt (_module.Cell.x (Lit DatatypeTypeType |c#0|))) (LitInt 2))))))
 :qid |gitissue697dfy.6:25|
 :weight 3
 :skolemid |483|
 :pattern ( (_module.__default.doubleEvenCell (Lit DatatypeTypeType |c#0|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|c#0@@0| T@U) ) (!  (=> (or (|_module.__default.doubleEvenCell#canCall| |c#0@@0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |c#0@@0| Tclass._module.EvenCell))) (and (and (_module.Cell.Cell_q |c#0@@0|) (=> (or (not (= (Mod (_module.Cell.x |c#0@@0|) (LitInt 2)) (LitInt 1))) (not true)) (_module.Cell.Cell_q |c#0@@0|))) (= (_module.__default.doubleEvenCell |c#0@@0|) (ite (= (Mod (_module.Cell.x |c#0@@0|) (LitInt 2)) (LitInt 1)) (Div 1 (LitInt 0)) (Mul (_module.Cell.x |c#0@@0|) (LitInt 2))))))
 :qid |gitissue697dfy.6:25|
 :skolemid |482|
 :pattern ( (_module.__default.doubleEvenCell |c#0@@0|))
))))
...
(assert (forall ((|c#0@@1| T@U) ) (! (= ($Is DatatypeTypeType |c#0@@1| Tclass._module.EvenCell)  (and ($Is DatatypeTypeType |c#0@@1| Tclass._module.Cell) (= (Mod (_module.Cell.x |c#0@@1|) (LitInt 2)) (LitInt 0))))
 :qid |unknown.0:0|
 :skolemid |503|
 :pattern ( ($Is DatatypeTypeType |c#0@@1| Tclass._module.EvenCell))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.doubleEvenCell)
...
(let ((anon8_Then_correct  (=> (and (= (Mod (_module.Cell.x |c#0@@2|) (LitInt 2)) (LitInt 1)) (= (ControlFlow 0 3) (- 0 2))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon7_Else_correct  (=> (_module.Cell.Cell_q |c#0@@2|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 5) 3) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |c#0@@2| Tclass._module.EvenCell)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
