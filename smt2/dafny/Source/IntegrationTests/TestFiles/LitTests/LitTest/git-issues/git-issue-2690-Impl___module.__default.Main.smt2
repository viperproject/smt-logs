...
(assert (distinct TBool TInt TagBool TagInt alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1|)
)
...
(declare-fun call0formal@_module._default.InSeq$T () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |call3formal@f#0@0| () T@U)
(declare-fun |ts##1@0| () T@U)
(declare-fun |call3formal@f#0@@0| () T@U)
(declare-fun call0formal@_module._default.InSeq2$T () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun |call3formal@f#0@0@@0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |ts##0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2))))))) (and ($Is HandleTypeType |call3formal@f#0| (Tclass._System.___hPartialFunc1 call0formal@_module._default.InSeq$T TBool)) ($IsAlloc HandleTypeType |call3formal@f#0| (Tclass._System.___hPartialFunc1 call0formal@_module._default.InSeq$T TBool) $Heap))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($Is HandleTypeType |call3formal@f#0@0| (Tclass._System.___hPartialFunc1 TInt TBool)) ($IsAlloc HandleTypeType |call3formal@f#0@0| (Tclass._System.___hPartialFunc1 TInt TBool) $Heap@0))) (and (and (forall ((|t#1| T@U) ) (!  (=> ($IsBox |t#1| TInt) (=> (|Seq#Contains| |ts##0@0| |t#1|) true))
 :qid |gitissue2690dfy.6:18|
 :skolemid |481|
 :pattern ( (Requires1 TInt TBool $Heap@0 |call3formal@f#0@0| |t#1|))
 :pattern ( (|Seq#Contains| |ts##0@0| |t#1|))
)) (forall ((|t#1@@0| T@U) ) (!  (=> (and ($IsBox |t#1@@0| TInt) (|Seq#Contains| |ts##0@0| |t#1@@0|)) (Requires1 TInt TBool $Heap@0 |call3formal@f#0@0| |t#1@@0|))
 :qid |gitissue2690dfy.6:18|
 :skolemid |482|
 :pattern ( (Requires1 TInt TBool $Heap@0 |call3formal@f#0@0| |t#1@@0|))
 :pattern ( (|Seq#Contains| |ts##0@0| |t#1@@0|))
 ...
 :qid |gitissue2690dfy.5:8|
 :skolemid |483|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires1 TInt TBool $Heap@0 |call3formal@f#0@0| ($Box intType (int_2_U (LitInt 2))))) (=> (Requires1 TInt TBool $Heap@0 |call3formal@f#0@0| ($Box intType (int_2_U (LitInt 2)))) (=> (= |ts##1@0| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))))) (=> (and (and ($Is HandleTypeType |call3formal@f#0@@0| (Tclass._System.___hPartialFunc1 call0formal@_module._default.InSeq2$T TBool)) ($IsAlloc HandleTypeType |call3formal@f#0@@0| (Tclass._System.___hPartialFunc1 call0formal@_module._default.InSeq2$T TBool) $Heap)) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (=> (and (and (and ($Is HandleTypeType |call3formal@f#0@0@@0| (Tclass._System.___hPartialFunc1 TInt TBool)) ($IsAlloc HandleTypeType |call3formal@f#0@0@@0| (Tclass._System.___hPartialFunc1 TInt TBool) $Heap@1)) (forall ((|t#1@@1| T@U) ) (!  (=> ($IsBox |t#1@@1| TInt) (=> (|Seq#Contains| |ts##1@0| |t#1@@1|) true))
 :qid |gitissue2690dfy.13:18|
 :skolemid |489|
 :pattern ( (Requires1 TInt TBool $Heap@1 |call3formal@f#0@0@@0| |t#1@@1|))
 :pattern ( (|Seq#Contains| |ts##1@0| |t#1@@1|))
))) (and (and (forall ((|t#1@@2| T@U) ) (!  (=> (and ($IsBox |t#1@@2| TInt) (|Seq#Contains| |ts##1@0| |t#1@@2|)) (Requires1 TInt TBool $Heap@1 |call3formal@f#0@0@@0| |t#1@@2|))
 :qid |gitissue2690dfy.13:18|
 :skolemid |490|
 :pattern ( (Requires1 TInt TBool $Heap@1 |call3formal@f#0@0@@0| |t#1@@2|))
 :pattern ( (|Seq#Contains| |ts##1@0| |t#1@@2|))
 ...
 :qid |gitissue2690dfy.12:8|
 :skolemid |491|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@1))
))) (and ($HeapSucc $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1))))) (Requires1 TInt TBool $Heap@1 |call3formal@f#0@0@@0| ($Box intType (int_2_U (LitInt 2)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc1 TInt TBool)) ($IsAlloc HandleTypeType |f#0@@1| (Tclass._System.___hPartialFunc1 TInt TBool) $Heap)) true) (=> (and (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hPartialFunc1 TInt TBool)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hPartialFunc1 TInt TBool) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))))
