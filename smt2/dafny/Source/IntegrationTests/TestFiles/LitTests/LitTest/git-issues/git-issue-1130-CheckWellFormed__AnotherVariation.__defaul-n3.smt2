...
(set-info :boogie-vc-id CheckWellFormed$$AnotherVariation.__default.CallUseFoo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc (AnotherVariation.Foo.Repr AnotherVariation._default.CallUseFoo$T |t#0|))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |t#0| null)) (not true)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |t#0| (Tclass.AnotherVariation.Foo AnotherVariation._default.CallUseFoo$T)) ($IsAlloc refType |t#0| (Tclass.AnotherVariation.Foo AnotherVariation._default.CallUseFoo$T) $Heap@@0)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
