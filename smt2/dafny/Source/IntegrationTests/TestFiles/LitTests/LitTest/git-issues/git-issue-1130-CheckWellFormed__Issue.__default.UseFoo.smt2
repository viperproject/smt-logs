...
(declare-fun Issue._default.UseFoo$T () T@U)
(declare-fun |t#0| () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellFormed$$Issue.__default.UseFoo)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc (Issue.Foo.Repr Issue._default.UseFoo$T |t#0|))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |t#0| null)) (not true)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |t#0| (Tclass.Issue.Foo Issue._default.UseFoo$T)) ($IsAlloc refType |t#0| (Tclass.Issue.Foo Issue._default.UseFoo$T) $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
