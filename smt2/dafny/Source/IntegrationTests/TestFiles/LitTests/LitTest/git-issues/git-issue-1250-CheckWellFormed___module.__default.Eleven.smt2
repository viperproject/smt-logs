...
(declare-fun $LZ () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Eleven)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($Is intType (int_2_U (LitInt 9)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 9)) Tclass._System.nat) (=> (and (= |##n#0@0| (LitInt 9)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (=> (and (and (= |##f#0@0| (|_module.__default.Fib#Handle| ($LS $LZ))) ($IsAlloc HandleTypeType |##f#0@0| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt) $Heap@0)) (and (|_module.__default.Sum#canCall| (LitInt 9) (|_module.__default.Fib#Handle| ($LS $LZ))) (= (ControlFlow 0 2) (- 0 1)))) ($Is intType (int_2_U (LitInt 6)) Tclass._System.nat)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct)))
