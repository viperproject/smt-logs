...
(let ((anon10_Then_correct  (=> (and ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap) (|CompilableExpressions.__default.P#canCall| |x#0@0|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#1@@3| Int) ) (CompilableExpressions.__default.P |x#1@@3|)))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#1@@4| Int) ) (CompilableExpressions.__default.P |x#1@@4|))) (=> (and (CompilableExpressions.__default.P |x#0@0|) |$let#15$canCall|) (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))))
