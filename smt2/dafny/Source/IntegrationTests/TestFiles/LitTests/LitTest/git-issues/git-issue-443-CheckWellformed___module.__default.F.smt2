...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.F#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.F (LitInt 12)))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.F#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.F (LitInt 12)))))
...
(let ((anon8_Then_correct  (=> (= |u#0_0@0| (LitReal 5.0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< |u#0_0@0| 6.0)) (=> (< |u#0_0@0| 6.0) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U (< 20 30))))))))))
(let ((anon7_Else_correct  (=> (= |let#0#0#0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (and ($Is boolType (bool_2_U |let#0#0#0|) TBool) (= |rx#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 6) 3) anon8_Then_correct) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 1) anon7_Then_correct) (=> (= (ControlFlow 0 7) 6) anon7_Else_correct)))))
