...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.Valid2ImpliesValid)
...
(let ((anon4_Then_correct  (=> (and ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? $Heap@0) (= (ControlFlow 0 2) (- 0 1))) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@25 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@25 $Heap@0)) (and (=> (= (ControlFlow 0 4) 2) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@25) ($IsHeapAnchor $Heap@@25)) (=> (and (and (or (not (= this@@60 null)) (not true)) (and ($Is refType this@@60 Tclass._module.Memory) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25))) (and (= 9 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
