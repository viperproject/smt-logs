...
(declare-fun |alsoThis#Z#0@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$M.Tr.ActuallyTrue_k_k)
...
(let ((anon4_Then_correct  (=> (and (and (= |let#0#0#0| this@@0) ($Is refType |let#0#0#0| Tclass.M.Tr)) (and (= |alsoThis#Z#0@0| |let#0#0#0|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |alsoThis#Z#0@0| null)) (not true)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.M.Tr) ($IsAlloc refType this@@0 Tclass.M.Tr $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
