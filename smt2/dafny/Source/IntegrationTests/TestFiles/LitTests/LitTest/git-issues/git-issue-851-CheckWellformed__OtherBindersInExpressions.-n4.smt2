...
(declare-fun |OtherBindersInExpressions.__default.Forall2#canCall| () Bool)
(declare-fun OtherBindersInExpressions.__default.Forall2 () Int)
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.Forall2#canCall| (< 1 $FunctionContextHeight)) (= OtherBindersInExpressions.__default.Forall2 (LitInt (Div 40 (LitInt 0)))))))
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.Forall2#canCall| (< 1 $FunctionContextHeight)) (= OtherBindersInExpressions.__default.Forall2 (LitInt (Div 40 (LitInt 0)))))))
...
(set-info :boogie-vc-id CheckWellformed$$OtherBindersInExpressions.__default.Forall2)
