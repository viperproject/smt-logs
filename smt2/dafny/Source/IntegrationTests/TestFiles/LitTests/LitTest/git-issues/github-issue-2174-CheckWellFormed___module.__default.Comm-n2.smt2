...
(declare-fun $generated@@94 () (_ BitVec 64))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let (($generated@@99  (=> (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false)) (<= $generated@@92 ($generated 64))) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (<= 0 $generated@@92) (< $generated@@92 256))) (=> (and (<= 0 $generated@@92) (< $generated@@92 256)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (bvule ((_ int2bv 8) $generated@@92) #x80)) (=> (bvule ((_ int2bv 8) $generated@@92) #x80) (=> (= $generated@@93 ($generated 64)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 $generated@@93) (< $generated@@93 256))) (=> (and (<= 0 $generated@@93) (< $generated@@93 256)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (bvule #x40 #x80)) (=> (bvule #x40 #x80) (=> (bvult (bvshl (concat #x0000000000000000 $generated@@94) (concat #x000000000000000000000000000000 ((_ int2bv 8) $generated@@92))) (bvshl #x00000000000000000000000000000001 (concat #x000000000000000000000000000000 #x40))) (=> (and (and ($generated@@95 $generated@@96) ($generated@@97 $generated@@96)) (= $generated@@90 $generated@@96)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 $generated@@92) (< $generated@@92 128))) (=> (and (<= 0 $generated@@92) (< $generated@@92 128)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bvule ((_ int2bv 7) $generated@@92) #b1000000)) (=> (bvule ((_ int2bv 7) $generated@@92) #b1000000) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 $generated@@92) (< $generated@@92 256))) (=> (and (<= 0 $generated@@92) (< $generated@@92 256)) (=> (= (ControlFlow 0 2) (- 0 1)) (bvule ((_ int2bv 8) $generated@@92) #x80))))))))))))))))))))))
(let (($generated@@100  (=> (and (and (and ($generated@@95 $generated@@90) ($generated@@97 $generated@@90)) (<= ($generated 0) $generated@@92)) (and (= 0 $generated@@98) (= (ControlFlow 0 10) 2))) $generated@@99)))
$generated@@100)))
))
(check-sat)
(get-info :rlimit)
