...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.MapComprehension3#canCall| (< 1 $FunctionContextHeight)) (and (forall ((|a#1#0#0@@0| T@U) )  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (LitInt 20) (LitInt 20))))) (= OtherBindersInExpressions.__default.MapComprehension3 (LitInt (Div 40 (LitInt 0))))))))
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |OtherBindersInExpressions.__default.MapComprehension3#canCall| (< 1 $FunctionContextHeight)) (and (forall ((|a#4#0#0| T@U) )  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (LitInt 20) (LitInt 20))))) (= OtherBindersInExpressions.__default.MapComprehension3 (LitInt (Div 40 (LitInt 0))))))))
...
(assert (forall ((a@@1 T@U) (b@@1 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@7 T@U) )  (=> (U_2_bool (MapType0Select BoxType boolType a@@1 bx@@7)) (and ($IsBox bx@@7 t0@@5) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@7) t1@@3)))) ($Is IMapType (|IMap#Glue| a@@1 b@@1 (TIMap t0@@5 t1@@3)) (TIMap t0@@5 t1@@3)))
