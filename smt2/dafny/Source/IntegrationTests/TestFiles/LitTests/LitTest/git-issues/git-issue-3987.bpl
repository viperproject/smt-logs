// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3987.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3987-@PROC@.smt2 /normalizeNames:0 /emitDebugInformation:1 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3987.dfy
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Main (correctness)"} Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var a#0_0: ref
     where $Is(a#0_0, Tclass._System.array(Tclass._System.nat()))
       && $IsAlloc(a#0_0, Tclass._System.array(Tclass._System.nat()), $Heap);
  ...
  var $prevHeap: Heap;
    ...
    $_reverifyPost := false;
    assume true;
    if (Lit(#_module.D.A()) == #_module.D.A())
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3987.dfy(9,25)
        assume true;
        assert {:id "id0"} 0 <= LitInt(1);
        ...
        if (*)
        {
            ...
            if (LitInt(0) <= i#0_0)
            {
                ...
                assume {:id "id1"} lambdaResult#0_0 == i#0_0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(lambdaResult#0_0, Tclass._System.nat());
            }
        ...
        assert {:id "id2"} {:subsumption 0} (forall arrayinit#0_0#i0#0: int :: 
          0 <= arrayinit#0_0#i0#0 && arrayinit#0_0#i0#0 < LitInt(1)
             ==> Requires1(Tclass._System.nat(), 
              Tclass._System.nat(), 
              $Heap, 
              Lit(AtLayer((lambda $l#0_0#ly#0: LayerType :: 
                    Handle1((lambda $l#0_0#heap#0: Heap, $l#0_0#i#0: Box :: $Box($Unbox($l#0_0#i#0): int)), 
                      (lambda $l#0_0#heap#0: Heap, $l#0_0#i#0: Box :: 
                        $IsBox($l#0_0#i#0, Tclass._System.nat())), 
                      (lambda $l#0_0#heap#0: Heap, $l#0_0#i#0: Box :: 
        ...
        assume (forall arrayinit#0_0#i0#0: int :: 
          ...
          0 <= arrayinit#0_0#i0#0 && arrayinit#0_0#i0#0 < LitInt(1)
             ==> $Unbox(read($Heap, $nw, IndexField(arrayinit#0_0#i0#0))): int
                  ...
                  Lit(AtLayer((lambda $l#0_0#ly#0: LayerType :: 
                        Handle1((lambda $l#0_0#heap#0: Heap, $l#0_0#i#0: Box :: $Box($Unbox($l#0_0#i#0): int)), 
                          ...
                          (lambda $l#0_0#heap#0: Heap, $l#0_0#i#0: Box :: 
                            SetRef_to_SetBox((lambda $l#0_0#o#0: ref :: false))))), 
                      $LS($LZ))), 
                  $Box(arrayinit#0_0#i0#0))): int);
        $Heap := update($Heap, $nw, alloc, $Box(true));
        assume $IsGoodHeap($Heap);
        assume $IsHeapAnchor($Heap);
        a#0_0 := $nw;
        // ----- forall statement (assign) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3987.dfy(10,7)
        if (*)
        {
            ...
            if (LitInt(0) <= i#0_0_0)
            {
                assert {:id "id4"} {:subsumption 0} a#0_0 != null;
            }

            assume true;
            assume LitInt(0) <= i#0_0_0 && i#0_0_0 < _System.array.Length(a#0_0);
            assert {:id "id5"} a#0_0 != null;
            assert {:id "id6"} {:subsumption 0} 0 <= i#0_0_0 && i#0_0_0 < _System.array.Length(a#0_0);
            assume true;
            assert {:id "id7"} $_ModifiesFrame[a#0_0, IndexField(i#0_0_0)];
            assume true;
            havoc i#0_0_1;
            assume true;
            assume LitInt(0) <= i#0_0_1 && i#0_0_1 < _System.array.Length(a#0_0);
            assume i#0_0_0 != i#0_0_1;
            assert {:id "id8"} a#0_0 != a#0_0
        ...
        else
        {
            ...
            assume (forall $o: ref, $f: Field :: 
              ...
              read($Heap, $o, $f) == read($prevHeap, $o, $f)
                 || (exists i#0_0_2: int :: 
                  LitInt(0) <= i#0_0_2
                     && i#0_0_2 < _System.array.Length(a#0_0)
                     && $o == a#0_0
                     && $f == IndexField(i#0_0_2)));
            assume (forall i#inv#0_0_0: int :: 
              { $Unbox(read($Heap, a#0_0, IndexField(i#inv#0_0_0))): int } 
              LitInt(0) <= i#inv#0_0_0 && i#inv#0_0_0 < _System.array.Length(a#0_0)
                 ==> read($Heap, a#0_0, IndexField(i#inv#0_0_0)) == $Box(i#inv#0_0_0));
        }
    }
    else
    {
    ...
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3987.dfy(14,3)
    assume true;
}
...
axiom (forall d: DatatypeType :: 
  { $IsA#_module.D(d) } 
  $IsA#_module.D(d) ==> _module.D.A_q(d));

// Questionmark data type disjunctivity
axiom (forall d: DatatypeType :: 
  { _module.D.A_q(d), $Is(d, Tclass._module.D()) } 
  $Is(d, Tclass._module.D()) ==> _module.D.A_q(d));
