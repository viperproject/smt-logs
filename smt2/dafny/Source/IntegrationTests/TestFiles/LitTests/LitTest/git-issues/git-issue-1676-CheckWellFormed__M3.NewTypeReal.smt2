...
(set-info :boogie-vc-id CheckWellFormed$$M3.NewTypeReal)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitReal 0.0) (LitReal 0.0))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< 0.0 100.0))))))))
