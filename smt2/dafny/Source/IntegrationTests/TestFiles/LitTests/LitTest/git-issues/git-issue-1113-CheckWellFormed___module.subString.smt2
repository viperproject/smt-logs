...
(let ((anon8_Else_correct  (=> (and (< (|Seq#Length| |x#0|) (LitInt 0)) (= (ControlFlow 0 6) 4)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) (|Seq#Length| |x#0|)) (= (ControlFlow 0 5) 4)) anon4_correct)))
(let ((anon7_Then_correct  (=> ($Is SeqType |x#0| (TSeq TChar)) (and (=> (= (ControlFlow 0 7) 5) anon8_Then_correct) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (|Seq#Length| (Lit SeqType |Seq#Empty|)))) (=> (= (ControlFlow 0 2) (- 0 1)) (< (|Seq#Length| (Lit SeqType |Seq#Empty|)) 2147483648)))))
