...
(set-info :boogie-vc-id Impl$$_module.__default.t3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.Status.Failure_q |r#0@2|)) (=> (_module.Status.Failure_q |r#0@2|) (=> (= (ControlFlow 0 2) (- 0 1)) (= |z#0@2| (LitInt 0)))))))
