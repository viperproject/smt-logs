...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (=> (= Cl_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@10 T@U) ($f@@0 T@U) ) true)) (=> (forall (($o@@11 T@U) ($f@@1 T@U) ) true) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Cl.True_k#canCall| this@@1) (or (_module.Cl.True_k this@@1) (U_2_bool (Lit boolType (bool_2_U false))))))))))))
