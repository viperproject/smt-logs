...
(declare-fun _module.Cl.True_k (T@U) Bool)
(declare-fun |_module.Cl.True_k#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|_module.Cl.True_k#canCall| this) (and (< 0 $FunctionContextHeight) (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.Cl)))) (= (_module.Cl.True_k this) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |gitissue2500dfy.24:13|
 :skolemid |2250|
 :pattern ( (_module.Cl.True_k this))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|_module.Cl.True_k#canCall| (Lit refType this@@0)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.Cl)))) (= (_module.Cl.True_k (Lit refType this@@0)) (U_2_bool (Lit boolType (bool_2_U false)))))
 :qid |gitissue2500dfy.24:13|
 :weight 3
 :skolemid |2251|
 :pattern ( (_module.Cl.True_k (Lit refType this@@0)))
))))
(push 1)
...
(set-info :boogie-vc-id OverrideCheck$$_module.Cl.True_k)
...
(assert (not
 ...
 :qid |gitissue2500dfy.24:13|
 :skolemid |2253|
)) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Cl.True_k#canCall| this@@1) (or (_module.Cl.True_k this@@1) (U_2_bool (Lit boolType (bool_2_U false))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Cl) ($IsAlloc refType this@@1 Tclass._module.Cl $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
