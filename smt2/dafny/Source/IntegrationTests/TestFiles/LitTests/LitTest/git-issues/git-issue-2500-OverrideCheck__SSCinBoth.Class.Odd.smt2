...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= |i#0@@9| |i#0@@9|)) (=> (<= |i#0@@9| |i#0@@9|) (=> (= Class_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@6 T@U) ($f@@0 T@U) ) true)) (=> (forall (($o@@7 T@U) ($f@@1 T@U) ) true) (=> (and (or (= |i#0@@9| (LitInt 0)) (= (= (Mod |i#0@@9| (LitInt 2)) (LitInt 1)) (SSCinBoth.Class.Even ($LS $LZ) this@@9 (- |i#0@@9| 1)))) (= (ControlFlow 0 2) (- 0 1))) (or (= |i#0@@9| (LitInt 0)) (= (= (Mod |i#0@@9| (LitInt 2)) (LitInt 1)) (SSCinBoth.Class.Even ($LS ($LS $LZ)) this@@9 (- |i#0@@9| 1))))))))))))
