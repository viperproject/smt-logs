...
(let ((anon8_Else_correct  (=> (and (and (not (exists ((|eg$d#0| T@U) )  (and (and ($Is refType |eg$d#0| Tclass.ExampleC.D) ($IsAlloc refType |eg$d#0| Tclass.ExampleC.D $Heap)) (= |eg$d#0| |eg$d#0|)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 3) (- 0 2))) false)))
