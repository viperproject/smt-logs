...
(set-info :boogie-vc-id CheckWellFormed$$_module.Memory.fNullify_split8)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 2) (let ((anon0_correct  (=> (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (=> (and (and (or (not (= this@@53 null)) (not true)) (and ($Is refType this@@53 Tclass._module.Memory) ($IsAlloc refType this@@53 Tclass._module.Memory $Heap@@21))) (and ($Is refType |o#0@@12| Tclass._module.Object) ($IsAlloc refType |o#0@@12| Tclass._module.Object $Heap@@21))) (=> (and (and (and (and (and ($Is SeqType |f#0@@1| (TSeq TChar)) ($IsAlloc SeqType |f#0@@1| (TSeq TChar) $Heap@@21)) (and (= 9 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@21 alloc |o#0@@12| _module.Object.fields)))) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) _module.Memory.objects)) ($Box refType |o#0@@12|)) (or (not (= |o#0@@12| null)) (not true))) (and (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes |o#0@@12|)) ($Box SeqType |f#0@@1|)) (or (not (= |o#0@@12| null)) (not true))))) (and (and (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)) (or (not (= |o#0@@12| null)) (not true))) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@@21))) (and (and (= |##os#0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) _module.Memory.objects))) ($IsAlloc SetType |##os#0@0| (TSet Tclass._module.Object) $Heap@@21)) (and (|_module.Memory.edges#canCall| $Heap@@21 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) _module.Memory.objects))) (|Set#IsMember| (_module.Memory.edges $Heap@@21 this@@53 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) _module.Memory.objects))) ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@12| |f#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 |o#0@@12|) _module.Object.fields))) ($Box SeqType |f#0@@1|)))))))))) (and (and (and (and (or (not (= |o#0@@12| null)) (not true)) (not (_module.Region.Frozen_q (_module.Object.region |o#0@@12|)))) (and ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@@21) (|_module.Memory.Valid#canCall| $Heap@@21 this@@53))) (and (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@21 this@@53) (or (not (= |o#0@@12| null)) (not true))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (and (and (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@25) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@25)) (= $o@@25 |o#0@@12|)))
...
))) (and ($HeapSucc $Heap@@21 $Heap@0) ($IsAlloc refType this@@53 Tclass._module.Memory $Heap@@21))) (and (and (forall (($o@@27 T@U) ($f@@14 T@U) ) (!  (=> (or (not (= $o@@27 null)) (not true)) (=> (and (= $o@@27 this@@53) (or (= $f@@14 _module.Memory.objects) (= $f@@14 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@27) $f@@14) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 $o@@27) $f@@14))))
...
)) (= (ControlFlow 0 2) (- 0 1))))))) (or (not (= |o#0@@12| null)) (not true)))))))
anon0_correct))
))
(check-sat)
(get-info :rlimit)
