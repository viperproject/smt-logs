...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (and ($IsAllocBox ($Box DatatypeTypeType this@@7) Tclass.B.S $Heap) (B.S.S_q this@@7)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| (B.S.rep this@@7)) ($Box intType (int_2_U |r#0@@7|)))) (=> (|Set#IsMember| (|Map#Domain| (B.S.rep this@@7)) ($Box intType (int_2_U |r#0@@7|))) (=> (and (and (and (= |let#0#0#0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (B.S.rep this@@7)) ($Box intType (int_2_U |r#0@@7|))))) (B.S.S_q this@@7)) (and ($Is DatatypeTypeType |let#0#0#0| Tclass.B.R) (= |dt_update_tmp#0#Z#0@0| |let#0#0#0|))) (and (and (= |let#1#0#0| |v#0@@2|) ($Is intType (int_2_U |let#1#0#0|) Tclass._System.nat)) (and (= |dt_update#v#0#Z#0@0| |let#1#0#0|) (= (ControlFlow 0 3) (- 0 2))))) ($Is DatatypeTypeType (|#B.R_.R| |dt_update#v#0#Z#0@0|) Tclass.B.R)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (B.S.S_q this@@7) (|Set#IsMember| (|Map#Domain| (B.S.rep this@@7)) ($Box intType (int_2_U |r#0@@7|)))) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is DatatypeTypeType this@@7 Tclass.B.S) ($IsAlloc DatatypeTypeType this@@7 Tclass.B.S $Heap))) (and (and (<= (LitInt 0) |r#0@@7|) (<= (LitInt 0) |v#0@@2|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct)))
