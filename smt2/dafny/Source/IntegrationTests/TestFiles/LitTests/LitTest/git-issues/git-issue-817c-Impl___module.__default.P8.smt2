...
(declare-fun |call2formal@i#0@0@@0| () Int)
(declare-fun |call3formal@j#0@0@@0| () Int)
(declare-fun |r#0| () T@U)
(declare-fun |a#0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon10_Else_correct  (=> (not (_module.Result.IsFailure TInt |call1formal@r#0@0|)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (and (<= 0 |idx1#0@0|) (< |idx1#0@0| (_System.array.Length $nw@0)))) (=> (and (<= 0 |idx1#0@0|) (< |idx1#0@0| (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |idx1#0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |idx1#0@0|))) (=> (and ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) (Tclass._module.Result TInt) $Heap@6) (= (ControlFlow 0 6) (- 0 5))) (not (_module.Result.IsFailure TInt |call1formal@r#0@0|))))))))))))
(let ((anon10_Then_correct  (=> (_module.Result.IsFailure TInt |call1formal@r#0@0|) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) (Tclass._module.Result TInt) $Heap@6) (= (ControlFlow 0 4) (- 0 3))) (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0|)) (or (_module.Result.IsFailure TInt |call1formal@r#0@0|) (_module.Result.Failure_q |call1formal@r#0@0|))))))
(let ((anon9_Else_correct  (=> (not (_module.Result.IsFailure TInt |call1formal@r#0@0@@0|)) (and (=> (= (ControlFlow 0 10) (- 0 18)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 17)) (and (<= 0 |idx0#0@0|) (< |idx0#0@0| (_System.array.Length $nw@0)))) (=> (and (<= 0 |idx0#0@0|) (< |idx0#0@0| (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 10) (- 0 16)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |idx0#0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField |idx0#0@0|))) (=> ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@3) (and (=> (= (ControlFlow 0 10) (- 0 15)) (not (_module.Result.IsFailure TInt |call1formal@r#0@0@@0|))) (=> (not (_module.Result.IsFailure TInt |call1formal@r#0@0@@0|)) (=> (and (and (and (|_module.Result.Extract#canCall| TInt |call1formal@r#0@0@@0|) (|_module.Result.Extract#canCall| TInt |call1formal@r#0@0@@0|)) (and (= |$rhs#0@0| (U_2_int ($Unbox intType (_module.Result.Extract TInt |call1formal@r#0@0@@0|)))) (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |idx0#0@0|) ($Box intType (int_2_U |$rhs#0@0|))))))) (and (and ($IsGoodHeap $Heap@4) (= |idx1#0@0| (LitInt 2))) (and ($Is DatatypeTypeType |valueOrError1#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError1#0@0| (Tclass._module.Result TInt) $Heap@4)))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (or (or (not (= $nw@1 $nw@0)) (not true)) (or (not (= (LitInt 2) (LitInt 2))) (not true)))) (=> (or (or (not (= $nw@1 $nw@0)) (not true)) (or (not (= (LitInt 2) (LitInt 2))) (not true))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 12)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@1)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length $nw@1))) (=> (= $index2@1 (IndexField (LitInt 2))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@1 $index2@1))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@1 $index2@1)) (=> (and (and (and (and ($Is DatatypeTypeType |call1formal@r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call1formal@r#0| (Tclass._module.Result TInt) $Heap@@1)) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))) (and (and ($Is DatatypeTypeType |call1formal@r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call1formal@r#0@0| (Tclass._module.Result TInt) $Heap@5)) (and (=> (_module.Result.Success_q |call1formal@r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |call1formal@r#0@0|))) (LitInt 200))) (= |call2formal@i#0@0| (LitInt 3))))) (and (and (and (= |call3formal@j#0@0| (LitInt 4)) (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@6)))
 :qid |gitissue817cdfy.33:8|
 :skolemid |483|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@6))
))) (and ($HeapSucc $Heap@4 $Heap@5) (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@1) $index2@1 ($Box intType (int_2_U |call3formal@j#0@0|))))))) (and (and ($IsGoodHeap $Heap@6) ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0|) (Tclass._module.Result TInt) $Heap@6)) (and (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0|) (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0|))))) (and (=> (= (ControlFlow 0 10) 4) anon10_Then_correct) (=> (= (ControlFlow 0 10) 6) anon10_Else_correct)))))))))))))))))))))))))
(let ((anon9_Then_correct  (=> (_module.Result.IsFailure TInt |call1formal@r#0@0@@0|) (=> (and (and ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@3) (= (ControlFlow 0 2) (- 0 1))) (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0@@0|)) (or (_module.Result.IsFailure TInt |call1formal@r#0@0@@0|) (_module.Result.Failure_q |call1formal@r#0@0@@0|))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 19) (- 0 25)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 10)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 19) (- 0 24)) (<= 0 (LitInt 10))) (=> (<= 0 (LitInt 10)) (=> (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? TInt))) (=> (and (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc)))) (= (_System.array.Length $nw@1) (LitInt 10))) (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@1))) (and (and ($IsHeapAnchor $Heap@1) (= |idx0#0@0| (LitInt 2))) (and ($Is DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| (Tclass._module.Result TInt) $Heap@1)))) (and (=> (= (ControlFlow 0 19) (- 0 23)) (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (LitInt 3) (LitInt 2))) (not true)))) (=> (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (LitInt 3) (LitInt 2))) (not true))) (and (=> (= (ControlFlow 0 19) (- 0 22)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 19) (- 0 21)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length $nw@0))) (=> (= $index2@0 (IndexField (LitInt 3))) (and (=> (= (ControlFlow 0 19) (- 0 20)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index2@0))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 $index2@0)) (=> (and (and (and (and ($Is DatatypeTypeType |call1formal@r#0@@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call1formal@r#0@@0| (Tclass._module.Result TInt) $Heap@@1)) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and ($Is DatatypeTypeType |call1formal@r#0@0@@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |call1formal@r#0@0@@0| (Tclass._module.Result TInt) $Heap@2)) (and (=> (_module.Result.Success_q |call1formal@r#0@0@@0|) (= (U_2_int ($Unbox intType (_module.Result.value |call1formal@r#0@0@@0|))) (LitInt 200))) (= |call2formal@i#0@0@@0| (LitInt 3))))) (and (and (and (= |call3formal@j#0@0@@0| (LitInt 4)) (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@7)))
 :qid |gitissue817cdfy.33:8|
 :skolemid |483|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@7))
))) (and ($HeapSucc $Heap@1 $Heap@2) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) $index2@0 ($Box intType (int_2_U |call3formal@j#0@0@@0|))))))) (and (and ($IsGoodHeap $Heap@3) ($IsAllocBox ($Box DatatypeTypeType |call1formal@r#0@0@@0|) (Tclass._module.Result TInt) $Heap@3)) (and (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0@@0|) (|_module.Result.IsFailure#canCall| TInt |call1formal@r#0@0@@0|))))) (and (=> (= (ControlFlow 0 19) 2) anon9_Then_correct) (=> (= (ControlFlow 0 19) 10) anon9_Else_correct))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap@@1))) (=> (and (and (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap@@1)) true) (and (and ($Is refType |aa#0| (Tclass._System.array TInt)) ($IsAlloc refType |aa#0| (Tclass._System.array TInt) $Heap@@1)) true)) (and (and (and ($Is refType |aaa#0| (Tclass._System.array TInt)) ($IsAlloc refType |aaa#0| (Tclass._System.array TInt) $Heap@@1)) true) (and (and ($Is refType |recv0#0| (Tclass._System.array TInt)) ($IsAlloc refType |recv0#0| (Tclass._System.array TInt) $Heap@@1)) true))) (and (and (and (and ($Is DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError0#0| (Tclass._module.Result TInt) $Heap@@1)) true) (and (and ($Is refType |recv1#0| (Tclass._System.array TInt)) ($IsAlloc refType |recv1#0| (Tclass._System.array TInt) $Heap@@1)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError1#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |valueOrError1#0| (Tclass._module.Result TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 26) 19))))) anon0_correct))))
