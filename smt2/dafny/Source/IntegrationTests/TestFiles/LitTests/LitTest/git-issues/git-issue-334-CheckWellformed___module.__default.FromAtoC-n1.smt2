...
(declare-fun _module.__default.FromAtoC (T@U) T@U)
(declare-fun SeqType () T@T)
(declare-fun |_module.__default.FromAtoC#canCall| (T@U) Bool)
(declare-fun TSeq (T@U) T@U)
(declare-fun |lambda#4| (T@U) T@U)
(declare-fun |lambda#23| (T@U Int Int) T@U)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#0| |l#0|) |$l#0#heap#0| |$l#0#i#0|) ($Box intType ($Unbox intType (|Seq#Index| |l#0| (U_2_int ($Unbox intType |$l#0#i#0|))))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| T@U) ) (!  (=> (or (|_module.__default.FromAtoC#canCall| (Lit SeqType |a#0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is SeqType |a#0| (TSeq TInt))))) (= (_module.__default.FromAtoC (Lit SeqType |a#0|)) (|Seq#Create| TInt $Heap (|Seq#Length| (Lit SeqType |a#0|)) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| (Lit SeqType |a#0|)) (|lambda#23| TInt (LitInt 0) (|Seq#Length| (Lit SeqType |a#0|))) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))
 :qid |gitissue334dfy.9:10|
 :weight 3
 :skolemid |489|
 :pattern ( (_module.__default.FromAtoC (Lit SeqType |a#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((|l#0@@2| T@U) (|l#1| Int) (|l#2| Int) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#23| |l#0@@2| |l#1| |l#2|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))  (and ($IsBox |$l#0#i#0@@0| |l#0@@2|) (and (<= |l#1| (U_2_int ($Unbox intType |$l#0#i#0@@0|))) (< (U_2_int ($Unbox intType |$l#0#i#0@@0|)) |l#2|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |499|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#23| |l#0@@2| |l#1| |l#2|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| Bool) ($o@@0 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@3| |l#1@@0| |l#2@@0| |l#3|) $o@@0 $f))  (=> (and (or (not (= $o@@0 |l#0@@3|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@0) |l#2@@0|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |498|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#10| |l#0@@3| |l#1@@0| |l#2@@0| |l#3|) $o@@0 $f))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.FromAtoC#canCall| |a#0@@0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is SeqType |a#0@@0| (TSeq TInt))))) (= (_module.__default.FromAtoC |a#0@@0|) (|Seq#Create| TInt $Heap@@0 (|Seq#Length| |a#0@@0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@0|) (|lambda#23| TInt (LitInt 0) (|Seq#Length| |a#0@@0|)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))))))
 :qid |gitissue334dfy.9:10|
 :skolemid |488|
 :pattern ( (_module.__default.FromAtoC |a#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|a#0@@1| T@U) ) (!  (=> (or (|_module.__default.FromAtoC#canCall| |a#0@@1|) (and (< 0 $FunctionContextHeight) ($Is SeqType |a#0@@1| (TSeq TInt)))) ($Is SeqType (_module.__default.FromAtoC |a#0@@1|) (TSeq TInt)))
 :qid |gitissue334dfy.9:19|
 :skolemid |486|
 :pattern ( (_module.__default.FromAtoC |a#0@@1|))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.FromAtoC)
...
(let ((anon16_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0@@2|)))) (= (ControlFlow 0 9) 6)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0@@2|))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0@@2|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0@@2|))) (=> (= |lambdaResult#0| (U_2_int ($Unbox intType (|Seq#Index| |a#0@@2| |i#0@0|)))) (=> (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 7) 6)) anon9_correct)))))))
(let ((anon15_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 11) 7) anon16_Then_correct) (=> (= (ControlFlow 0 11) 9) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 10) 7) anon16_Then_correct) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct)))))
(let ((anon14_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#10| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 12) 10) anon15_Then_correct) (=> (= (ControlFlow 0 12) 11) anon15_Else_correct)))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@1 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@1 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 13) 12) anon14_Then_correct) (=> (= (ControlFlow 0 13) 5) anon14_Else_correct)))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| (|Seq#Length| |a#0@@2|))) (Requires1 TInt TInt $Heap@@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@2|) (|lambda#23| TInt (LitInt 0) (|Seq#Length| |a#0@@2|)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |gitissue334dfy.11:3|
 :skolemid |490|
 ...
 :qid |gitissue334dfy.11:3|
 :skolemid |492|
))) (= (_module.__default.FromAtoC |a#0@@2|) (|Seq#Create| TInt $Heap@@1 (|Seq#Length| |a#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#4| (Handle1 (|lambda#0| |a#0@@2|) (|lambda#23| TInt (LitInt 0) (|Seq#Length| |a#0@@2|)) (|lambda#3| (SetRef_to_SetBox (|lambda#2| false))))) ($LS $LZ)))))) (and ($Is SeqType (_module.__default.FromAtoC |a#0@@2|) (TSeq TInt)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 14) (- 0 15)) (<= 0 (|Seq#Length| |a#0@@2|))) (=> (<= 0 (|Seq#Length| |a#0@@2|)) (and (=> (= (ControlFlow 0 14) 13) anon13_Then_correct) (=> (= (ControlFlow 0 14) 3) anon13_Else_correct))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#10| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 16) 1) anon12_Then_correct) (=> (= (ControlFlow 0 16) 14) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is SeqType |a#0@@2| (TSeq TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct)))
