...
(set-info :boogie-vc-id Impl$$_module.__default.RegressionTest)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon3_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= (ite (< (Div 3 (LitInt 0)) 7) |c#0@0| |c#0@0|) null)) (not true)))))
(let ((anon4_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U (< (Div 3 (LitInt 0)) 7))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) |defass#c#0|) (=> |defass#c#0| (=> (= (ControlFlow 0 5) 2) anon3_correct))))))
(let ((anon4_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U (< (Div 3 (LitInt 0)) 7)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |defass#c#0|) (=> |defass#c#0| (=> (= (ControlFlow 0 3) 2) anon3_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> |defass#c#0| (and ($Is refType |c#0@0| Tclass._module.C) ($IsAlloc refType |c#0@0| Tclass._module.C $Heap)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= (LitInt 0) 0)) (not true))) (=> (or (not (= (LitInt 0) 0)) (not true)) (and (=> (= (ControlFlow 0 7) 3) anon4_Then_correct) (=> (= (ControlFlow 0 7) 5) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#c#0| (and ($Is refType |c#0@@1| Tclass._module.C) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 7))) anon0_correct))))
