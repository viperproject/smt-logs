...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= (LitInt 0) |x#0|) (<= |x#0| (LitInt 100)))) (=> (and (<= (LitInt 0) |x#0|) (<= |x#0| (LitInt 100))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= (LitInt 0) |x#0|) (<= |x#0| (LitInt 100)))) (=> (and (<= (LitInt 0) |x#0|) (<= |x#0| (LitInt 100))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (and (<= 0 |x#0|) (< |x#0| 55296)) (and (<= 57344 |x#0|) (< |x#0| 1114112)))) (=> (or (and (<= 0 |x#0|) (< |x#0| 55296)) (and (<= 57344 |x#0|) (< |x#0| 1114112))) (=> (and (= |c#0@0| (|char#FromInt| |x#0|)) (= |r#0@0| (q@Real |x#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |x#0|) (< |x#0| 256))) (=> (and (<= 0 |x#0|) (< |x#0| 256)) (=> (and (= |b#0@0| ((_ int2bv 8) |x#0|)) (= (ControlFlow 0 2) (- 0 1))) (<= 0 |x#0|))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 0) |x#0|) (<= |x#0| (LitInt 100)))) (=> (and (and (and (<= (LitInt 0) |z#0|) (<= |z#0| (LitInt 100))) true) (and (and ($Is charType |c#0| TChar) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct))))
