...
(assert (distinct TInt TagInt alloc Tagclass._module.Result tytagFamily$Result)
)
...
(assert (forall ((_module.Result$T@@0 T@U) ) (! (= (Tclass._module.Result_0 (Tclass._module.Result _module.Result$T@@0)) _module.Result$T@@0)
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( (Tclass._module.Result _module.Result$T@@0))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o $f))  (=> (and (or (not (= $o |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |545|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o $f))
)))
