...
(set-info :boogie-vc-id CheckWellFormed$$_module.MyMatrix)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct true))
(let ((anon5_Then_correct  (=> ($Is refType |m#0| (Tclass._System.array2 TInt)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |m#0| null)) (not true))))))))
