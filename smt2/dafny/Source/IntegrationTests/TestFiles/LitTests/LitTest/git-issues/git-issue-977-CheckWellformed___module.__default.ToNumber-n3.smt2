...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.__default.ToNumber#canCall| |n#0@@1|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@1|))) (and (=> (or (not (= |n#0@@1| (LitInt 0))) (not true)) (|_module.__default.ToNumber#canCall| (- |n#0@@1| 1))) (= (_module.__default.ToNumber ($LS $ly@@1) |n#0@@1|) (ite (= |n#0@@1| (LitInt 0)) |#_module.Number.Zero| (|#_module.Number.Succ| (_module.__default.ToNumber $ly@@1 (- |n#0@@1| 1)))))))
 :qid |gitissue977dfy.50:16|
 :skolemid |1177|
 :pattern ( (_module.__default.ToNumber ($LS $ly@@1) |n#0@@1|))
))))
...
(assert (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (! (= (_module.__default.ToNumber ($LS $ly@@2) |n#0@@2|) (_module.__default.ToNumber $ly@@2 |n#0@@2|))
 :qid |gitissue977dfy.50:16|
 :skolemid |1172|
 :pattern ( (_module.__default.ToNumber ($LS $ly@@2) |n#0@@2|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ToNumber)
