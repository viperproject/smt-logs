...
procedure {:verboseName "M (well-formedness)"} CheckWellFormed$$_module.__default.M(x#0: DatatypeType
       where $Is(x#0, Tclass._module.D())
         && $IsAlloc(x#0, Tclass._module.D(), $Heap)
         && $IsA#_module.D(x#0), 
    u#0: int where LitInt(0) <= u#0 && u#0 < 65536)
   returns (r#0: int where LitInt(0) <= r#0 && r#0 < 65536);
...
procedure {:verboseName "M (correctness)"} Impl$$_module.__default.M(x#0: DatatypeType
       where $Is(x#0, Tclass._module.D())
         ...
         && $IsA#_module.D(x#0), 
    u#0: int where LitInt(0) <= u#0 && u#0 < 65536)
   returns (r#0: int where LitInt(0) <= r#0 && r#0 < 65536, $_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M (correctness)"} Impl$$_module.__default.M(x#0: DatatypeType, u#0: int) returns (r#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var v#0: int where LitInt(0) <= v#0 && v#0 < 65536;
  ...
  var newtype$check#1_0: int;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/github-issue-3797.dfy(8,9)
    assume true;
    newtype$check#0 := LitInt(5);
    assert {:id "id0"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 65536;
    assume true;
    v#0 := LitInt(5);
    assume true;
    if (x#0 == #_module.D.A())
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/github-issue-3797.dfy(10,17)
        assume true;
        newtype$check#1_0 := LitInt(12);
        assert {:id "id4"} LitInt(0) <= newtype$check#1_0 && newtype$check#1_0 < 65536;
        assume true;
        r#0 := LitInt(12);
    }
    else if (x#0 == #_module.D.B())
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/github-issue-3797.dfy(11,17)
        assume true;
        newtype$check#0_0 := LitInt(13);
        assert {:id "id2"} LitInt(0) <= newtype$check#0_0 && newtype$check#0_0 < 65536;
        assume true;
        r#0 := LitInt(13);
    }
    else
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/github-issue-3797.dfy(13,5)
    assume true;
    assume true;
    r#0 := v#0;
}
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "uint16 (well-formedness)"} CheckWellFormed$$_module.uint16(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id7"} LitInt(0) <= x#0 && x#0 < 65536;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id9"} {:subsumption 0} Lit(0 < 65536);
        assume false;
    }
}
