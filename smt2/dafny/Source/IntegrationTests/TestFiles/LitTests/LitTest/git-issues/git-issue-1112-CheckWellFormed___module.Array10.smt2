...
(assert (distinct TInt TReal TagInt TagReal alloc Tagclass._System.array? Tagclass._System.array tytagFamily$array)
)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Array10)
...
(let ((anon9_Else_correct  (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and (= (_System.array.Length |a#0|) (LitInt 10)) (= (ControlFlow 0 5) 3)) anon5_correct))))))
(let ((anon9_Then_correct  (=> (and (= |a#0| null) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($Is refType |a#0| (Tclass._System.array? TReal)) (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 5) anon9_Else_correct)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (= null null) (= (_System.array.Length null) (LitInt 10))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#9| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 7) anon8_Then_correct) (=> (= (ControlFlow 0 8) 2) anon10_Then_correct)))))
