...
(assert (forall (($o@@3 T@U) ) (!  (=> ($Is refType $o@@3 Tclass.Traits.C?) ($Is refType $o@@3 Tclass.Traits.T?))
 :qid |unknown.0:0|
 :skolemid |1509|
 :pattern ( ($Is refType $o@@3 Tclass.Traits.C?))
)))
...
(assert (= (Tag Tclass.Traits.C) Tagclass.Traits.C))
(assert (= (TagFamily Tclass.Traits.C) tytagFamily$C))
(assert (forall (($o@@4 T@U) ) (! (= ($Is refType $o@@4 Tclass.Traits.T?)  (or (= $o@@4 null) (implements$Traits.T (dtype $o@@4))))
 :qid |unknown.0:0|
 :skolemid |1487|
 :pattern ( ($Is refType $o@@4 Tclass.Traits.T?))
)))
...
(set-info :boogie-vc-id OverrideCheck$$Traits.C.Infloop)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= |b#0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x03)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= |b#0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x03))))) (=> (= |b#0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x03)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (bvule (bvadd |b#0| #x01) |b#0|)) (=> (bvule (bvadd |b#0| #x01) |b#0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@5 T@U) ($f T@U) ) (! true
 :qid |gitissue2511dfy.51:12|
 :skolemid |1499|
 ...
 :qid |gitissue2511dfy.51:12|
 :skolemid |1500|
)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9)))
 :qid |gitissue2511dfy.51:12|
 :skolemid |1501|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9))
)) ($HeapSucc $Heap $Heap@0)) (and (U_2_bool (Lit boolType (bool_2_U false))) (= (ControlFlow 0 2) (- 0 1)))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.Traits.C) ($IsAlloc refType this Tclass.Traits.C $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct))))
