...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= |b#0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x03)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= |b#0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x03))))) (=> (= |b#0| (U_2_bv8 (Lit bv8Type (bv8_2_U #x03)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (bvule (bvadd |b#0| #x01) |b#0|)) (=> (bvule (bvadd |b#0| #x01) |b#0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@5 T@U) ($f T@U) ) true)) (=> (forall (($o@@6 T@U) ($f@@0 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@7 T@U) ($f@@1 T@U) ) true)) (=> (forall (($o@@8 T@U) ($f@@2 T@U) ) true) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9)))
