...
(set-info :boogie-vc-id Impl$$_module.Even.NewtypeTest)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= (Mod this (LitInt 2)) (LitInt 0))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
