...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc0 Tagclass._module.C Tagclass._module.C? tytagFamily$nat tytagFamily$object |tytagFamily$_#Func0| tytagFamily$C)
)
...
(assert (forall ((|l#0| T@U) (|$l#1#heap#0| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#1| |l#0|) |$l#1#heap#0|) |l#0|)
 :qid |unknown.0:0|
 :skolemid |567|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#1| |l#0|) |$l#1#heap#0|))
)))
(assert (forall ((|l#0@@0| Bool) (|$l#1#heap#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#2| |l#0@@0|) |$l#1#heap#0@@0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |568|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#2| |l#0@@0|) |$l#1#heap#0@@0|))
)))
(assert (forall ((|l#0@@1| Bool) (|$l#1#o#0| T@U) ) (! (= (U_2_bool (MapType0Select refType boolType (|lambda#3| |l#0@@1|) |$l#1#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |569|
 :pattern ( (MapType0Select refType boolType (|lambda#3| |l#0@@1|) |$l#1#o#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#1#heap#0@@1| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#4| |l#0@@2|) |$l#1#heap#0@@1|) |l#0@@2|)
 :qid |gitissue4684dfy.42:37|
 :skolemid |570|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#4| |l#0@@2|) |$l#1#heap#0@@1|))
)))
(assert (forall ((|l#0@@3| T@U) (|$l#1#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@3|) |$l#1#ly#0|) |l#0@@3|)
 :qid |gitissue4684dfy.42:37|
 :skolemid |571|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#5| |l#0@@3|) |$l#1#ly#0|))
)))
...
(assert (forall ((v@@3 T@U) (t0@@8 T@U) (h@@6 T@U) ) (! (= ($IsAlloc SetType v@@3 (TSet t0@@8) h@@6) (forall ((bx@@9 T@U) ) (!  (=> (|Set#IsMember| v@@3 bx@@9) ($IsAllocBox bx@@9 t0@@8 h@@6))
...
(assert (forall ((|l#0@@4| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1| |l#2| |l#3|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |566|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1| |l#2| |l#3|) $o@@3 $f))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon10_Else_correct true))
(let ((anon10_Then_correct true))
(let ((anon9_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@0 |$lambdaHeap#0@0|) ($HeapSucc $Heap@0 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 13) 11) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct)))))
(let ((anon12_Else_correct true))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap@0 |$lambdaHeap#1@0|) ($HeapSucc $Heap@0 |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (= |##g#1@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle0 (|lambda#1| ($Box intType (int_2_U (LitInt (- 0 1))))) (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##g#1@0| (Tclass._System.___hFunc0 TInt) $Heap@0) (= (ControlFlow 0 2) (- 0 1))) (Requires0 TInt $Heap@0 |##g#1@0|)))))
(let ((anon9_Else_correct  (=> (and (= |##g#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle0 (|lambda#1| ($Box intType (int_2_U (LitInt (- 0 1))))) (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) ($IsAlloc HandleTypeType |##g#0@0| (Tclass._System.___hFunc0 TInt) $Heap@0)) (and (=> (= (ControlFlow 0 6) (- 0 10)) (Requires0 TInt $Heap@0 |##g#0@0|)) (=> (and (|_module.C.FWithoutTailRecursion#canCall| $Heap@0 call2formal@this@0 (LitInt 25) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle0 (|lambda#1| ($Box intType (int_2_U (LitInt (- 0 1))))) (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (|_module.C.FWithoutTailRecursion#canCall| $Heap@0 call2formal@this@0 (LitInt 25) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle0 (|lambda#1| ($Box intType (int_2_U (LitInt (- 0 1))))) (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) true) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= call2formal@this@0 null)) (not true))) (=> ($IsAllocBox ($Box refType call2formal@this@0) Tclass._module.C? $Heap@0) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat) (=> (and (= |##n#1@0| (LitInt 25)) ($IsAlloc intType (int_2_U |##n#1@0|) Tclass._System.nat $Heap@0)) (and (=> (= (ControlFlow 0 6) 5) anon11_Then_correct) (=> (= (ControlFlow 0 6) 2) anon11_Else_correct)))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 14) (- 0 18)) ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat) (=> (= |n##0@0| (LitInt 25)) (=> (and (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass._module.C) ($IsAlloc refType call2formal@this Tclass._module.C $Heap))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass._module.C) ($IsAlloc refType call2formal@this@0 Tclass._module.C $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call2formal@this@0) alloc))))) (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)))
 :qid |gitissue4684dfy.7:3|
 :skolemid |541|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 14) (- 0 17)) true) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= call2formal@this@0 null)) (not true))) (=> ($IsAllocBox ($Box refType call2formal@this@0) Tclass._module.C? $Heap@0) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat) (=> (and (= |##n#0@0| (LitInt 25)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap@0)) (and (=> (= (ControlFlow 0 14) 13) anon9_Then_correct) (=> (= (ControlFlow 0 14) 6) anon9_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#c#0| (and ($Is refType |c#0@@3| Tclass._module.C) ($IsAlloc refType |c#0@@3| Tclass._module.C $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 19) 14))) anon0_correct))))
