...
(assert (forall ((o T@U) ) (! (<= 0 (|ORD#Offset| o))
...
(assert (forall ((o@@0 T@U) ) (!  (=> (|ORD#IsNat| o@@0) (= o@@0 (|ORD#FromNat| (|ORD#Offset| o@@0))))
...
(declare-fun |r#0| () Real)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Test3OK)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (q@Real (q@Int |r#0|)) |r#0|)) (=> (= (q@Real (q@Int |r#0|)) |r#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (<= 0 (q@Int |r#0|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 0 $FunctionContextHeight) (= (q@Real (q@Int |r#0|)) |r#0|)) (and (>= |r#0| (LitReal 0.0)) (= (ControlFlow 0 4) 2))) anon0_correct))))
