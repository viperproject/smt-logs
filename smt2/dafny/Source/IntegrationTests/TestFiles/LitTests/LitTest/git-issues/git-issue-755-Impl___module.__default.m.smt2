...
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |ss#0@0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#i0_0#0_0| T@U) ) (! (|Set#IsMember| |ss#0@0| ($Box intType |$as#i0_0#0_0|))
 :qid |gitissue755dfy.21:9|
 :skolemid |489|
)))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |ss#0@0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#i0_0#0_0@@0| Int) ) (! (|Set#IsMember| |ss#0@0| ($Box intType (int_2_U |$as#i0_0#0_0@@0|)))
 :qid |gitissue755dfy.21:9|
 :skolemid |489|
))) (=> (and (|Set#IsMember| |ss#0@0| ($Box intType (int_2_U |i#0_0@1|))) (= |ss#0@1| (|Set#Difference| |ss#0@0| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |i#0_0@1|)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| |ss#0@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| |ss#0@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (|Set#Card| |ss#0@1|) |$decr$loop#00@1|)))))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#Equal| |ss#0@0| |Set#Empty|)) (= |$decr$loop#00@1| (|Set#Card| |ss#0@0|))) (and (=> (= (ControlFlow 0 9) 5) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 10) 3) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
...
(let ((anon8_LoopHead_correct  (=> (and (and (and ($Is SetType |ss#0@0| (TSet TInt)) ($IsAlloc SetType |ss#0@0| (TSet TInt) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |gitissue755dfy.18:3|
 :skolemid |487|
...
)) (<= (|Set#Card| |ss#0@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 12) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 12) 11) anon8_LoopBody_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (|Set#Card| |s#0|)) (= (ControlFlow 0 13) 12)) anon8_LoopHead_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap))) (=> (and (and (and ($Is SetType |ss#0| (TSet TInt)) ($IsAlloc SetType |ss#0| (TSet TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
