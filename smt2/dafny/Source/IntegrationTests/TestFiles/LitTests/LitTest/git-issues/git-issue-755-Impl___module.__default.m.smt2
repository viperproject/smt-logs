...
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |ss#0@0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#i0_0#0_0| T@U) ) (|Set#IsMember| |ss#0@0| ($Box intType |$as#i0_0#0_0|))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |ss#0@0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#i0_0#0_0@@0| Int) ) (|Set#IsMember| |ss#0@0| ($Box intType (int_2_U |$as#i0_0#0_0@@0|))))) (=> (and (|Set#IsMember| |ss#0@0| ($Box intType (int_2_U |i#0_0@1|))) (= |ss#0@1| (|Set#Difference| |ss#0@0| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U |i#0_0@1|)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| |ss#0@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| |ss#0@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (|Set#Card| |ss#0@1|) |$decr$loop#00@1|)))))))))
