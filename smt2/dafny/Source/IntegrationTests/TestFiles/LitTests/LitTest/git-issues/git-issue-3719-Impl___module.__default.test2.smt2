...
(declare-fun _module.__default.CheckThis (T@U) Bool)
(declare-fun |_module.__default.CheckThis#canCall| (T@U) Bool)
...
(assert (distinct TBool TagBool TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc0 Tagclass._System.___hPartialFunc0 Tagclass._System.___hTotalFunc0 tytagFamily$nat tytagFamily$object |tytagFamily$_#Func0| |tytagFamily$_#PartialFunc0| |tytagFamily$_#TotalFunc0|)
)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($reveal Bool) (|x#0@@0| Int) ) (!  (=> (or (|_module.__default.inc#canCall| |x#0@@0|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |x#0@@0|))) (<= (LitInt 0) (_module.__default.inc $reveal |x#0@@0|)))
 :qid |gitissue3719dfy.4:17|
 :skolemid |479|
 :pattern ( (_module.__default.inc $reveal |x#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|p#0| T@U) ) (!  (=> (or (|_module.__default.CheckThis#canCall| |p#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) ($Is HandleTypeType |p#0| (Tclass._System.___hTotalFunc0 TBool))))) (= (_module.__default.CheckThis |p#0|) (U_2_bool ($Unbox boolType (Apply0 TBool $Heap |p#0|)))))
 :qid |gitissue3719dfy.7:11|
 :skolemid |485|
 :pattern ( (_module.__default.CheckThis |p#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|p#0@@0| T@U) ) (!  (=> (or (|_module.__default.CheckThis#canCall| (Lit HandleTypeType |p#0@@0|)) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is HandleTypeType |p#0@@0| (Tclass._System.___hTotalFunc0 TBool))))) (= (_module.__default.CheckThis (Lit HandleTypeType |p#0@@0|)) (U_2_bool ($Unbox boolType (Apply0 TBool $Heap@@0 (Lit HandleTypeType |p#0@@0|))))))
 :qid |gitissue3719dfy.7:11|
 :weight 3
 :skolemid |486|
 :pattern ( (_module.__default.CheckThis (Lit HandleTypeType |p#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0| T@U) (|$l#1#heap#0| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#3| |l#0|) |$l#1#heap#0|) |l#0|)
 :qid |gitissue3719dfy.12:33|
 :skolemid |498|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#3| |l#0|) |$l#1#heap#0|))
)))
(assert (forall ((|l#0@@0| Bool) (|$l#1#heap#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#4| |l#0@@0|) |$l#1#heap#0@@0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |499|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#4| |l#0@@0|) |$l#1#heap#0@@0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|$l#1#heap#0@@1| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#6| |l#0@@2|) |$l#1#heap#0@@1|) |l#0@@2|)
 :qid |gitissue3719dfy.12:20|
 :skolemid |501|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#6| |l#0@@2|) |$l#1#heap#0@@1|))
)))
(assert (forall ((|l#0@@3| T@U) (|$l#1#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#7| |l#0@@3|) |$l#1#ly#0|) |l#0@@3|)
 :qid |gitissue3719dfy.12:20|
 :skolemid |502|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#7| |l#0@@3|) |$l#1#ly#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@2| Int) ) (!  (=> (or (|_module.__default.inc#canCall| |x#0@@2|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |x#0@@2|))) (= (_module.__default.inc true |x#0@@2|) (+ |x#0@@2| 1)))
 :qid |gitissue3719dfy.4:21|
 :skolemid |481|
 :pattern ( (_module.__default.inc true |x#0@@2|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@3| Int) ) (!  (=> (or (|_module.__default.inc#canCall| (LitInt |x#0@@3|)) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |x#0@@3|))) (= (_module.__default.inc true (LitInt |x#0@@3|)) (LitInt (+ |x#0@@3| 1))))
 :qid |gitissue3719dfy.4:21|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.inc true (LitInt |x#0@@3|)))
))))
...
(assert (forall ((|#$R@@8| T@U) (bx@@9 T@U) ) (!  (=> ($IsBox bx@@9 (Tclass._System.___hFunc0 |#$R@@8|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@9)) bx@@9) ($Is HandleTypeType ($Unbox HandleTypeType bx@@9) (Tclass._System.___hFunc0 |#$R@@8|))))
 :qid |unknown.0:0|
 :skolemid |413|
 :pattern ( ($IsBox bx@@9 (Tclass._System.___hFunc0 |#$R@@8|)))
)))
(assert (forall ((|#$R@@9| T@U) (bx@@10 T@U) ) (!  (=> ($IsBox bx@@10 (Tclass._System.___hPartialFunc0 |#$R@@9|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@10)) bx@@10) ($Is HandleTypeType ($Unbox HandleTypeType bx@@10) (Tclass._System.___hPartialFunc0 |#$R@@9|))))
 :qid |unknown.0:0|
 :skolemid |440|
 :pattern ( ($IsBox bx@@10 (Tclass._System.___hPartialFunc0 |#$R@@9|)))
)))
(assert (forall ((|#$R@@10| T@U) (bx@@11 T@U) ) (!  (=> ($IsBox bx@@11 (Tclass._System.___hTotalFunc0 |#$R@@10|)) (and (= ($Box HandleTypeType ($Unbox HandleTypeType bx@@11)) bx@@11) ($Is HandleTypeType ($Unbox HandleTypeType bx@@11) (Tclass._System.___hTotalFunc0 |#$R@@10|))))
 :qid |unknown.0:0|
 :skolemid |445|
 :pattern ( ($IsBox bx@@11 (Tclass._System.___hTotalFunc0 |#$R@@10|)))
)))
...
(declare-fun reveal__module._default.inc () Bool)
(declare-fun $LZ () T@U)
...
(let ((anon6_Then_correct  (=> (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= (ControlFlow 0 4) (- 0 3))) ($Is intType (int_2_U (LitInt 1)) Tclass._System.nat))))
...
(let ((anon5_Else_correct  (=> (= |##p#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle0 (|lambda#3| ($Box boolType (bool_2_U (= (_module.__default.inc reveal__module._default.inc (LitInt 1)) (LitInt 2))))) (|lambda#4| true) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ)))) (=> (and ($IsAlloc HandleTypeType |##p#0@0| (Tclass._System.___hTotalFunc0 TBool) $Heap@0) (|_module.__default.CheckThis#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle0 (|lambda#3| ($Box boolType (bool_2_U (= (_module.__default.inc reveal__module._default.inc (LitInt 1)) (LitInt 2))))) (|lambda#4| true) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))) (=> (and (and (and (|_module.__default.inc#canCall| (LitInt 1)) (|_module.__default.CheckThis#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle0 (|lambda#3| ($Box boolType (bool_2_U (= (_module.__default.inc reveal__module._default.inc (LitInt 1)) (LitInt 2))))) (|lambda#4| true) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.CheckThis#canCall| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle0 (|lambda#3| ($Box boolType (bool_2_U (= (_module.__default.inc reveal__module._default.inc (LitInt 1)) (LitInt 2))))) (|lambda#4| true) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.CheckThis (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle0 (|lambda#3| ($Box boolType (bool_2_U (= (_module.__default.inc reveal__module._default.inc (LitInt 1)) (LitInt 2))))) (|lambda#4| true) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))))) (U_2_bool ($Unbox boolType (Apply0 TBool $Heap@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle0 (|lambda#3| ($Box boolType (bool_2_U (= (_module.__default.inc reveal__module._default.inc (LitInt 1)) (LitInt 2))))) (|lambda#4| true) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap@@1 $Heap@0) reveal__module._default.inc)) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct))))))
