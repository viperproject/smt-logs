...
(declare-fun |Absy3.__default.f#canCall| () Bool)
(declare-fun Absy3.__default.f () Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |Absy3.__default.f#canCall| (< 0 $FunctionContextHeight)) (= Absy3.__default.f (LitInt (Div 0 (LitInt 0)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |Absy3.__default.f#canCall| (< 0 $FunctionContextHeight)) (= Absy3.__default.f (LitInt (Div 0 (LitInt 0)))))))
...
(set-info :boogie-vc-id CheckWellformed$$Absy3.__default.f)
