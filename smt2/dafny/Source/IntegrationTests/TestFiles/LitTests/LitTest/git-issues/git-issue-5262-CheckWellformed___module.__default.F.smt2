...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| T@U) ) (!  (=> (or (|_module.__default.F#canCall| |a#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is refType |a#0| (Tclass._System.array TInt))) (> (_System.array.Length |a#0|) 0)))) (= (_module.__default.F |a#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0)))))))
 :qid |gitissue5262dfy.4:10|
 :skolemid |481|
 :pattern ( (_module.__default.F |a#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|a#0@@0| T@U) ) (!  (=> (or (|_module.__default.F#canCall| (Lit refType |a#0@@0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is refType |a#0@@0| (Tclass._System.array TInt))) (U_2_bool (Lit boolType (bool_2_U (> (_System.array.Length (Lit refType |a#0@@0|)) 0))))))) (= (_module.__default.F (Lit refType |a#0@@0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |a#0@@0|)) (IndexField (LitInt 0)))))))
 :qid |gitissue5262dfy.4:10|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.F (Lit refType |a#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0@@1|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0@@1|))) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@1| (IndexField (LitInt 0))))) (= (_module.__default.F |a#0@@1|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |a#0@@1|) (IndexField (LitInt 0))))))) (and ($Is intType (int_2_U (_module.__default.F |a#0@@1|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (=> (> (_System.array.Length |a#0@@1|) 0) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is refType |a#0@@1| (Tclass._System.array TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 6))) anon0_correct)))
