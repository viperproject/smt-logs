...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (and (<= (|Seq#Length| |a#0@0|) (|Seq#Length| |x#0|)) (|Seq#SameUntil| |a#0@0| |x#0| (|Seq#Length| |a#0@0|))) (and (< (|Seq#Length| |a#0@0|) (|Seq#Length| |b#0@0|)) (|Seq#SameUntil| |a#0@0| |b#0@0| (|Seq#Length| |a#0@0|)))))))
(let ((anon3_Else_correct  (=> (and (not (and (<= (|Seq#Length| |a#0@0|) (|Seq#Length| |x#0|)) (|Seq#SameUntil| |a#0@0| |x#0| (|Seq#Length| |a#0@0|)))) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and (<= (|Seq#Length| |a#0@0|) (|Seq#Length| |x#0|)) (|Seq#SameUntil| |a#0@0| |x#0| (|Seq#Length| |a#0@0|))) (= (ControlFlow 0 3) 2)) anon2_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |a#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box charType (|char#FromInt| 97))) ($Box charType (|char#FromInt| 98))) ($Box charType (|char#FromInt| 99))))) (= |b#0@0| (|Seq#Append| |x#0| |y#0|))) (and (=> (= (ControlFlow 0 5) 3) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is SeqType |x#0| (TSeq TChar)) ($IsAlloc SeqType |x#0| (TSeq TChar) $Heap)) (and ($Is SeqType |y#0| (TSeq TChar)) ($IsAlloc SeqType |y#0| (TSeq TChar) $Heap))) (and (and ($Is SeqType |a#0| (TSeq TChar)) ($IsAlloc SeqType |a#0| (TSeq TChar) $Heap)) true)) (and (and (and ($Is SeqType |b#0| (TSeq TChar)) ($IsAlloc SeqType |b#0| (TSeq TChar) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct))))
