...
(declare-fun |_module.__default.P3#canCall| (Int) Bool)
...
(let ((anon11_Else_correct  (=> (not (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@1|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@1|))) (=> (= |##a#1@0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|)))) (=> (and (and ($IsAlloc intType (int_2_U |##a#1@0|) TInt $Heap) (|_module.__default.P2#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|))))) (and (_module.__default.P2 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|)))) (= (ControlFlow 0 6) 1))) anon8_correct)))))))
(let ((anon11_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@1|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@1|))) (=> (= |##a#0@0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|)))) (=> (and (and ($IsAlloc intType (int_2_U |##a#0@0|) TInt $Heap) (|_module.__default.P1#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|))))) (and (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|)))) (= (ControlFlow 0 4) 1))) anon8_correct))))))
(let ((anon10_Else_correct  (=> (not (or (_module.__default.P1 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|)))) (_module.__default.P2 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@1|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@1|))) (=> (= |##a#2@0| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|)))) (=> (and (and ($IsAlloc intType (int_2_U |##a#2@0|) TInt $Heap) (|_module.__default.P3#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|))))) (and (_module.__default.P3 (U_2_int ($Unbox intType (|Seq#Index| |s#0@@1| |i#0@0|)))) (= (ControlFlow 0 2) 1))) anon8_correct)))))))
(let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |s#0@@1|))) (and (and (=> (= (ControlFlow 0 8) 2) anon10_Else_correct) (=> (= (ControlFlow 0 8) 4) anon11_Then_correct)) (=> (= (ControlFlow 0 8) 6) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 10) 8)) anon3_correct)))
(let ((anon9_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (= (ControlFlow 0 9) 8)) anon3_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 11) 9) anon9_Then_correct) (=> (= (ControlFlow 0 11) 10) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |s#0@@1| (TSeq TInt)) ($IsAlloc SeqType |s#0@@1| (TSeq TInt) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
