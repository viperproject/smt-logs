...
(set-info :boogie-vc-id CheckWellFormed$$_module.ClassA.Read)
...
(let ((anon4_Then_correct  (=> (and (_module.Result.Success_q |res#0@0|) (= (ControlFlow 0 2) (- 0 1))) (_module.Result.Success_q |res#0@0|))))
...
)) ($HeapSucc $Heap $Heap@0)) (and ($Is DatatypeTypeType |res#0@0| (Tclass._module.Result (TSeq _module.ClassA$T@@9))) ($IsAlloc DatatypeTypeType |res#0@0| (Tclass._module.Result (TSeq _module.ClassA$T@@9)) $Heap@0))) (and (=> (= (ControlFlow 0 4) 2) anon4_Then_correct) (=> (= (ControlFlow 0 4) 3) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.ClassA _module.ClassA$T@@9)) ($IsAlloc refType this (Tclass._module.ClassA _module.ClassA$T@@9) $Heap)))) (and (and ($Is DatatypeTypeType |res#0| (Tclass._module.Result (TSeq _module.ClassA$T@@9))) ($IsAlloc DatatypeTypeType |res#0| (Tclass._module.Result (TSeq _module.ClassA$T@@9)) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4)))) anon0_correct)))
