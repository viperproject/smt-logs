...
(assert (not
 ...
 :qid |gitissue2384dfy.11:10|
 :skolemid |496|
))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) ) (! true
 :qid |gitissue2384dfy.11:10|
 :skolemid |496|
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall (($o@@7 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7) alloc)))) (= $o@@7 this)) false)
 :qid |gitissue2384dfy.11:10|
 :skolemid |497|
))))))))
