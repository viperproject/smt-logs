...
(let ((anon7_Else_correct  (=> (=> (<= (LitInt 0) |i#0|) (and (and (_module.Result.Success_q |r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) |i#0|)) (= |o#0@0| (+ (+ |i#0| |i#0|) |i#0|)))) (and (=> (= (ControlFlow 0 5) 1) anon8_Then_correct) (=> (= (ControlFlow 0 5) 2) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.Result.Success_q |r#0@0|)) (=> (_module.Result.Success_q |r#0@0|) (=> (and (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) |i#0|) (= |o#0@0| (+ (+ |i#0| |i#0|) |i#0|))) (and (=> (= (ControlFlow 0 3) 1) anon8_Then_correct) (=> (= (ControlFlow 0 3) 2) anon8_Else_correct))))))))
...
)) ($HeapSucc $Heap $Heap@0)) (and ($Is DatatypeTypeType |r#0@0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0@0| (Tclass._module.Result TInt) $Heap@0))) (and (=> (= (ControlFlow 0 6) 3) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
