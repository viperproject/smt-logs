...
(assert (forall ((d@@6 T@U) ) (!  (=> (_module.Option.Some_q d@@6) (exists ((|a#13#0#0| T@U) ) (! (= d@@6 (|#_module.Option.Some| |a#13#0#0|))
 :qid |gitissue3868bdfy.37:35|
 :skolemid |558|
)))
 :qid |unknown.0:0|
 :skolemid |559|
...
(assert (forall ((_module.Option$T@@9 T@U) (|a#14#0#0| T@U) ($h@@0 T@U) ) (!  (=> ($IsGoodHeap $h@@0) (= ($IsAlloc DatatypeTypeType (|#_module.Option.Some| |a#14#0#0|) (Tclass._module.Option _module.Option$T@@9) $h@@0) ($IsAllocBox |a#14#0#0| _module.Option$T@@9 $h@@0)))
 :qid |unknown.0:0|
 :skolemid |561|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Option.Some| |a#14#0#0|) (Tclass._module.Option _module.Option$T@@9) $h@@0))
)))
...
(assert (forall ((|a#12#0#0| T@U) ) (! (= (DatatypeCtorId (|#_module.Option.Some| |a#12#0#0|)) |##_module.Option.Some|)
 :qid |gitissue3868bdfy.37:35|
 :skolemid |556|
 :pattern ( (|#_module.Option.Some| |a#12#0#0|))
)))
(assert (forall ((|a#16#0#0| T@U) ) (! (= (_module.Option.value (|#_module.Option.Some| |a#16#0#0|)) |a#16#0#0|)
 :qid |gitissue3868bdfy.37:35|
 :skolemid |564|
 :pattern ( (|#_module.Option.Some| |a#16#0#0|))
)))
...
(assert (forall ((_module.Option$T@@13 T@U) (|a#14#0#0@@0| T@U) ) (! (= ($Is DatatypeTypeType (|#_module.Option.Some| |a#14#0#0@@0|) (Tclass._module.Option _module.Option$T@@13)) ($IsBox |a#14#0#0@@0| _module.Option$T@@13))
 :qid |unknown.0:0|
 :skolemid |560|
 :pattern ( ($Is DatatypeTypeType (|#_module.Option.Some| |a#14#0#0@@0|) (Tclass._module.Option _module.Option$T@@13)))
)))
...
(assert (forall ((|a#17#0#0| T@U) ) (! (< (BoxRank |a#17#0#0|) (DtRank (|#_module.Option.Some| |a#17#0#0|)))
 :qid |gitissue3868bdfy.37:35|
 :skolemid |565|
 :pattern ( (|#_module.Option.Some| |a#17#0#0|))
)))
...
(assert (forall ((|a#15#0#0| T@U) ) (! (= (|#_module.Option.Some| (Lit BoxType |a#15#0#0|)) (Lit DatatypeTypeType (|#_module.Option.Some| |a#15#0#0|)))
 :qid |gitissue3868bdfy.37:35|
 :skolemid |563|
 :pattern ( (|#_module.Option.Some| (Lit BoxType |a#15#0#0|)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.WoahThat_ksDeep)
