...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (exists ((|e#3| T@U) )  (and ($IsBox |e#3| _module._default.P$_T0@@2) (|Set#IsMember| |s#0@@1| |e#3|)))) (=> (exists ((|e#3@@0| T@U) )  (and ($IsBox |e#3@@0| _module._default.P$_T0@@2) (|Set#IsMember| |s#0@@1| |e#3@@0|))) (=> (and (and (and ($IsBox |e#2@0| _module._default.P$_T0@@2) ($IsAllocBox |e#2@0| _module._default.P$_T0@@2 $Heap@@1)) (|Set#IsMember| |s#0@@1| |e#2@0|)) (and (and ($IsBox |e#4@0| _module._default.P$_T0@@2) ($IsAllocBox |e#4@0| _module._default.P$_T0@@2 $Heap@@1)) (and (|Set#IsMember| |s#0@@1| |e#4@0|) (= (ControlFlow 0 3) (- 0 2))))) (= (= |e#2@0| |e#2@0|) (= |e#4@0| |e#4@0|)))))))
