...
(declare-fun |lambda#89| (T@U T@U T@U T@U T@U T@U T@U T@U) T@U)
...
(assert  (=> (<= 8 $FunctionContextHeight) (forall (($Heap@@7 T@U) (this@@18 T@U) (|o#0@@7| T@U) (|n#0@@1| T@U) ) (!  (=> (or (|_module.Memory.fExists#canCall| $Heap@@7 this@@18 |o#0@@7| |n#0@@1|) (and (< 8 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $Heap@@7) (and (or (not (= this@@18 null)) (not true)) (and ($Is refType this@@18 Tclass._module.Memory) ($IsAlloc refType this@@18 Tclass._module.Memory $Heap@@7)))) ($Is refType |o#0@@7| Tclass._module.Object)) ($Is SeqType |n#0@@1| (TSeq TChar))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 this@@18) _module.Memory.objects)) ($Box refType |o#0@@7|)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@7 this@@18))))) (= (_module.Memory.fExists $Heap@@7 this@@18 |o#0@@7| |n#0@@1|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@7 |o#0@@7|) _module.Object.fields))) ($Box SeqType |n#0@@1|))))
 :qid |gitissue3855dfy.401:13|
 :skolemid |1051|
 :pattern ( (_module.Memory.fExists $Heap@@7 this@@18 |o#0@@7| |n#0@@1|) ($IsGoodHeap $Heap@@7))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@8 T@U) (this@@19 T@U) ) (!  (=> (or (|_module.Object.outgoing#canCall| $Heap@@8 this@@19) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@8) (and (or (not (= this@@19 null)) (not true)) (and ($Is refType this@@19 Tclass._module.Object) ($IsAlloc refType this@@19 Tclass._module.Object $Heap@@8)))))) (= (_module.Object.outgoing $Heap@@8 this@@19) (|Map#Values| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@8 this@@19) _module.Object.fields)))))
 :qid |gitissue3855dfy.106:12|
 :skolemid |755|
 :pattern ( (_module.Object.outgoing $Heap@@8 this@@19) ($IsGoodHeap $Heap@@8))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@9 T@U) (this@@22 T@U) (|os#0@@4| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@9 this@@22 |os#0@@4|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@9) (and (or (not (= this@@22 null)) (not true)) (and ($Is refType this@@22 Tclass._module.Memory) ($IsAlloc refType this@@22 Tclass._module.Memory $Heap@@9)))) (and ($Is SetType |os#0@@4| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@4| (TSet Tclass._module.Object) $Heap@@9))))) (and (and (forall ((|edge#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |edge#0| Tclass._module.Edge) (|Set#IsMember| (_module.Memory.edges $Heap@@9 this@@22 |os#0@@4|) ($Box DatatypeTypeType |edge#0|))) (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|))) (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@9 (_module.Edge.f |edge#0|)) _module.Object.fields))) ($Box SeqType (_module.Edge.n |edge#0|)))) (_module.Edge.t |edge#0|))))
 :qid |gitissue3855dfy.258:20|
 :skolemid |916|
 :pattern ( (_module.Edge.t |edge#0|))
 :pattern ( (_module.Edge.f |edge#0|))
 :pattern ( (_module.Edge.n |edge#0|))
 :pattern ( (|Set#IsMember| (_module.Memory.edges $Heap@@9 this@@22 |os#0@@4|) ($Box DatatypeTypeType |edge#0|)))
)) (=> (|Set#Equal| |os#0@@4| |Set#Empty|) (|Set#Equal| (_module.Memory.edges $Heap@@9 this@@22 |os#0@@4|) |Set#Empty|))) ($Is SetType (_module.Memory.edges $Heap@@9 this@@22 |os#0@@4|) (TSet Tclass._module.Edge))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |917|
 :pattern ( (_module.Memory.edges $Heap@@9 this@@22 |os#0@@4|))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@10 T@U) (this@@23 T@U) ) (!  (=> (or (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@10 this@@23) (and (< 3 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@10) (and (or (not (= this@@23 null)) (not true)) (and ($Is refType this@@23 Tclass._module.Object) ($IsAlloc refType this@@23 Tclass._module.Object $Heap@@10)))))) (= (_module.Object.AllFieldsAreDeclared $Heap@@10 this@@23) (|Set#Subset| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@10 this@@23) _module.Object.fields))) (|Map#Domain| (_module.Object.fieldModes this@@23)))))
 :qid |gitissue3855dfy.120:13|
 :skolemid |778|
 :pattern ( (_module.Object.AllFieldsAreDeclared $Heap@@10 this@@23) ($IsGoodHeap $Heap@@10))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@11 T@U) (this@@24 T@U) (|os#0@@5| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@11 this@@24 |os#0@@5|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@11) (and (or (not (= this@@24 null)) (not true)) (and ($Is refType this@@24 Tclass._module.Memory) ($IsAlloc refType this@@24 Tclass._module.Memory $Heap@@11)))) ($Is SetType |os#0@@5| (TSet Tclass._module.Object))))) (= (_module.Memory.justTheIsos $Heap@@11 this@@24 |os#0@@5|) (|Set#FromBoogieMap| (|lambda#38| Tclass._module.Object |os#0@@5|))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |893|
 :pattern ( (_module.Memory.justTheIsos $Heap@@11 this@@24 |os#0@@5|) ($IsGoodHeap $Heap@@11))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@12 T@U) (this@@25 T@U) ) (!  (=> (or (|_module.Object.outgoing#canCall| $Heap@@12 this@@25) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@12) (or (not (= this@@25 null)) (not true))) ($IsAlloc refType this@@25 Tclass._module.Object $Heap@@12)))) ($IsAlloc SetType (_module.Object.outgoing $Heap@@12 this@@25) (TSet Tclass._module.Object) $Heap@@12))
 :qid |gitissue3855dfy.106:12|
 :skolemid |753|
 :pattern ( ($IsAlloc SetType (_module.Object.outgoing $Heap@@12 this@@25) (TSet Tclass._module.Object) $Heap@@12))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@13 T@U) (this@@26 T@U) (|edges#0@@12| T@U) ) (!  (=> (and (or (|_module.Memory.justHeapExternalEdges#canCall| this@@26 |edges#0@@12|) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@26 null)) (not true)) ($IsAlloc refType this@@26 Tclass._module.Memory $Heap@@13)) (and ($Is SetType |edges#0@@12| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@12| (TSet Tclass._module.Edge) $Heap@@13))))) ($IsGoodHeap $Heap@@13)) ($IsAlloc SetType (_module.Memory.justHeapExternalEdges this@@26 |edges#0@@12|) (TSet Tclass._module.Edge) $Heap@@13))
 :qid |gitissue3855dfy.345:12|
 :skolemid |1010|
 :pattern ( ($IsAlloc SetType (_module.Memory.justHeapExternalEdges this@@26 |edges#0@@12|) (TSet Tclass._module.Edge) $Heap@@13))
))))
...
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@14 T@U) (this@@27 T@U) (|os#0@@6| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOne#canCall| $Heap@@14 this@@27 |os#0@@6|) (and (< 5 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@14) (and (or (not (= this@@27 null)) (not true)) (and ($Is refType this@@27 Tclass._module.Memory) ($IsAlloc refType this@@27 Tclass._module.Memory $Heap@@14)))) ($Is SetType |os#0@@6| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@14 this@@27 |os#0@@6|) (let ((|edges#0@@13| (_module.Memory.edges $Heap@@14 this@@27 |os#0@@6|)))
(|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@27 |edges#0@@13|))) (= (_module.Memory.heapExternalsZeroOrOne $Heap@@14 this@@27 |os#0@@6|) (let ((|edges#0@@14| (_module.Memory.edges $Heap@@14 this@@27 |os#0@@6|)))
(_module.Memory.heapExternalsZeroOrOneEdges this@@27 |edges#0@@14|)))))
 :qid |gitissue3855dfy.273:13|
 :skolemid |937|
 :pattern ( (_module.Memory.heapExternalsZeroOrOne $Heap@@14 this@@27 |os#0@@6|) ($IsGoodHeap $Heap@@14))
))))
...
(assert (forall ((|l#0@@5| T@U) (|l#1@@5| T@U) (|l#2@@2| T@U) (|l#3@@0| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) ($o@@11 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#89| |l#0@@5| |l#1@@5| |l#2@@2| |l#3@@0| |l#4| |l#5| |l#6| |l#7|) $o@@11 $f))  (=> (and (or (not (= $o@@11 |l#0@@5|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@5| $o@@11) |l#2@@2|)))) (or (or (and (= $o@@11 |l#3@@0|) (= $f |l#4|)) (|Set#IsMember| |l#5| ($Box refType $o@@11))) (and (= $o@@11 |l#6|) (= $f |l#7|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1422|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#89| |l#0@@5| |l#1@@5| |l#2@@2| |l#3@@0| |l#4| |l#5| |l#6| |l#7|) $o@@11 $f))
)))
...
(assert (forall ((v@@4 T@U) (t0@@5 T@U) (t1@@2 T@U) (h@@2 T@U) ) (! (= ($IsAlloc MapType v@@4 (TMap t0@@5 t1@@2) h@@2) (forall ((bx@@12 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@4) bx@@12) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@4) bx@@12) t1@@2 h@@2) ($IsAllocBox bx@@12 t0@@5 h@@2)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@15 T@U) (this@@28 T@U) (|t#0@@8| T@U) (|edges#0@@15| T@U) ) (!  (=> (and (or (|_module.Memory.incomingEdges#canCall| this@@28 |t#0@@8| |edges#0@@15|) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@28 null)) (not true)) ($IsAlloc refType this@@28 Tclass._module.Memory $Heap@@15)) (and ($Is refType |t#0@@8| Tclass._module.Object) ($IsAlloc refType |t#0@@8| Tclass._module.Object $Heap@@15))) (and ($Is SetType |edges#0@@15| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@15| (TSet Tclass._module.Edge) $Heap@@15))))) ($IsGoodHeap $Heap@@15)) ($IsAlloc SetType (_module.Memory.incomingEdges this@@28 |t#0@@8| |edges#0@@15|) (TSet Tclass._module.Edge) $Heap@@15))
 :qid |gitissue3855dfy.245:12|
 :skolemid |899|
 :pattern ( ($IsAlloc SetType (_module.Memory.incomingEdges this@@28 |t#0@@8| |edges#0@@15|) (TSet Tclass._module.Edge) $Heap@@15))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@16 T@U) (this@@29 T@U) (|o#0@@8| T@U) (|edges#0@@16| T@U) ) (!  (=> (and (or (|_module.Memory.externalEdges#canCall| this@@29 |o#0@@8| |edges#0@@16|) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@29 null)) (not true)) ($IsAlloc refType this@@29 Tclass._module.Memory $Heap@@16)) (and ($Is DatatypeTypeType |o#0@@8| Tclass._module.Region) ($IsAlloc DatatypeTypeType |o#0@@8| Tclass._module.Region $Heap@@16))) (and ($Is SetType |edges#0@@16| (TSet Tclass._module.Edge)) ($IsAlloc SetType |edges#0@@16| (TSet Tclass._module.Edge) $Heap@@16))))) ($IsGoodHeap $Heap@@16)) ($IsAlloc SetType (_module.Memory.externalEdges this@@29 |o#0@@8| |edges#0@@16|) (TSet Tclass._module.Edge) $Heap@@16))
 :qid |gitissue3855dfy.336:12|
 :skolemid |1000|
 :pattern ( ($IsAlloc SetType (_module.Memory.externalEdges this@@29 |o#0@@8| |edges#0@@16|) (TSet Tclass._module.Edge) $Heap@@16))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((this@@30 T@U) (|t#0@@9| T@U) (|edges#0@@17| T@U) ) (!  (=> (or (|_module.Memory.incomingEdges#canCall| this@@30 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)) (and (< 2 $FunctionContextHeight) (and (and (and (or (not (= this@@30 null)) (not true)) ($Is refType this@@30 Tclass._module.Memory)) ($Is refType |t#0@@9| Tclass._module.Object)) ($Is SetType |edges#0@@17| (TSet Tclass._module.Edge))))) (and (forall ((|e#1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@17|) ($Box DatatypeTypeType |e#1|)) (_module.Edge.Edge_q |e#1|)))
 :qid |gitissue3855dfy.248:9|
 :skolemid |903|
 :pattern ( (_module.Edge.t |e#1|))
 :pattern ( (|Set#IsMember| |edges#0@@17| ($Box DatatypeTypeType |e#1|)))
)) (= (_module.Memory.incomingEdges this@@30 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)) (|Set#FromBoogieMap| (|lambda#41| Tclass._module.Edge (Lit SetType |edges#0@@17|) (Lit refType |t#0@@9|))))))
 :qid |gitissue3855dfy.245:12|
 :weight 3
 :skolemid |904|
 :pattern ( (_module.Memory.incomingEdges this@@30 (Lit refType |t#0@@9|) (Lit SetType |edges#0@@17|)))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@31 T@U) (|edges#0@@18| T@U) ) (!  (=> (or (|_module.Memory.justHeapExternalEdges#canCall| this@@31 (Lit SetType |edges#0@@18|)) (and (< 3 $FunctionContextHeight) (and (and (or (not (= this@@31 null)) (not true)) ($Is refType this@@31 Tclass._module.Memory)) ($Is SetType |edges#0@@18| (TSet Tclass._module.Edge))))) (and (forall ((|e#1@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@0| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@18|) ($Box DatatypeTypeType |e#1@@0|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#1@@0|))) (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#1@@0|)))) (and (_module.Edge.Edge_q |e#1@@0|) (_module.Edge.Edge_q |e#1@@0|))) (=> (not (|_module.Region#Equal| (_module.Object.region (_module.Edge.f |e#1@@0|)) (_module.Object.region (_module.Edge.t |e#1@@0|)))) (_module.Edge.Edge_q |e#1@@0|)))))
 :qid |gitissue3855dfy.348:9|
 :skolemid |1014|
 :pattern ( (_module.Edge.t |e#1@@0|))
 :pattern ( (_module.Edge.f |e#1@@0|))
 :pattern ( (|Set#IsMember| |edges#0@@18| ($Box DatatypeTypeType |e#1@@0|)))
)) (= (_module.Memory.justHeapExternalEdges this@@31 (Lit SetType |edges#0@@18|)) (|Set#FromBoogieMap| (|lambda#76| Tclass._module.Edge (Lit SetType |edges#0@@18|))))))
 :qid |gitissue3855dfy.345:12|
 :weight 3
 :skolemid |1015|
 :pattern ( (_module.Memory.justHeapExternalEdges this@@31 (Lit SetType |edges#0@@18|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@32 T@U) (|o#0@@9| T@U) (|edges#0@@19| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| (Lit refType this@@32) (Lit DatatypeTypeType |o#0@@9|) (Lit SetType |edges#0@@19|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@32 null)) (not true)) ($Is refType this@@32 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@9| Tclass._module.Region)) ($Is SetType |edges#0@@19| (TSet Tclass._module.Edge))))) (and (forall ((|e#2@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#2@@1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@19|) ($Box DatatypeTypeType |e#2@@1|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#2@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@9|))) (_module.Edge.Edge_q |e#2@@1|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#2@@1|)) |o#0@@9|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#2@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@9|))) (_module.Edge.Edge_q |e#2@@1|))))))
 :qid |gitissue3855dfy.339:9|
 :skolemid |1006|
 :pattern ( (_module.Edge.f |e#2@@1|))
 :pattern ( (_module.Edge.t |e#2@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@19| ($Box DatatypeTypeType |e#2@@1|)))
)) (= (_module.Memory.externalEdges (Lit refType this@@32) (Lit DatatypeTypeType |o#0@@9|) (Lit SetType |edges#0@@19|)) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge (Lit SetType |edges#0@@19|) |o#0@@9| |o#0@@9|)))))
 :qid |gitissue3855dfy.336:12|
 :weight 3
 :skolemid |1007|
 :pattern ( (_module.Memory.externalEdges (Lit refType this@@32) (Lit DatatypeTypeType |o#0@@9|) (Lit SetType |edges#0@@19|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall (($Heap@@17 T@U) (this@@33 T@U) (|os#0@@7| T@U) ) (!  (=> (or (|_module.Memory.justTheIsos#canCall| $Heap@@17 this@@33 |os#0@@7|) (and (< 3 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@17) (and (or (not (= this@@33 null)) (not true)) (and ($Is refType this@@33 Tclass._module.Memory) ($IsAlloc refType this@@33 Tclass._module.Memory $Heap@@17)))) (and ($Is SetType |os#0@@7| (TSet Tclass._module.Object)) ($IsAlloc SetType |os#0@@7| (TSet Tclass._module.Object) $Heap@@17))))) (and (and (and (forall ((|r#0@@2| T@U) ) (!  (=> (and ($Is refType |r#0@@2| Tclass._module.Object) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@17 this@@33 |os#0@@7|) ($Box refType |r#0@@2|))) (_module.Region.Isolate_q (_module.Object.region |r#0@@2|)))
 :qid |gitissue3855dfy.237:20|
 :skolemid |888|
 :pattern ( (_module.Object.region |r#0@@2|))
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@17 this@@33 |os#0@@7|) ($Box refType |r#0@@2|)))
)) (forall ((|o#0@@10| T@U) ) (!  (=> (and ($Is refType |o#0@@10| Tclass._module.Object) (|Set#IsMember| |os#0@@7| ($Box refType |o#0@@10|))) (=> (_module.Region.Isolate_q (_module.Object.region |o#0@@10|)) (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@17 this@@33 |os#0@@7|) ($Box refType |o#0@@10|))))
 :qid |gitissue3855dfy.238:20|
 :skolemid |889|
 :pattern ( (|Set#IsMember| (_module.Memory.justTheIsos $Heap@@17 this@@33 |os#0@@7|) ($Box refType |o#0@@10|)))
 :pattern ( (_module.Object.region |o#0@@10|))
 :pattern ( (|Set#IsMember| |os#0@@7| ($Box refType |o#0@@10|)))
))) (=> (|Set#Equal| |os#0@@7| |Set#Empty|) (|Set#Equal| (_module.Memory.justTheIsos $Heap@@17 this@@33 |os#0@@7|) |Set#Empty|))) ($Is SetType (_module.Memory.justTheIsos $Heap@@17 this@@33 |os#0@@7|) (TSet Tclass._module.Object))))
 :qid |gitissue3855dfy.235:12|
 :skolemid |890|
 :pattern ( (_module.Memory.justTheIsos $Heap@@17 this@@33 |os#0@@7|))
))))
(assert (forall ((bx@@13 T@U) (s@@2 T@U) (t@@10 T@U) ) (!  (=> ($IsBox bx@@13 (TMap s@@2 t@@10)) (and (= ($Box MapType ($Unbox MapType bx@@13)) bx@@13) ($Is MapType ($Unbox MapType bx@@13) (TMap s@@2 t@@10))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@13 (TMap s@@2 t@@10)))
)))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((this@@34 T@U) (|edges#0@@20| T@U) ) (!  (=> (or (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@34 |edges#0@@20|) (and (< 4 $FunctionContextHeight) (and (and (or (not (= this@@34 null)) (not true)) ($Is refType this@@34 Tclass._module.Memory)) ($Is SetType |edges#0@@20| (TSet Tclass._module.Edge))))) (and (and (|_module.Memory.justHeapExternalEdges#canCall| this@@34 |edges#0@@20|) (let ((|heapExternalEdges#0| (_module.Memory.justHeapExternalEdges this@@34 |edges#0@@20|)))
...
(forall ((|r#0@@3| T@U) ) (!  (=> ($Is DatatypeTypeType |r#0@@3| Tclass._module.Region) (=> (|Set#IsMember| |allRelevantHeapRegions#0| ($Box DatatypeTypeType |r#0@@3|)) (|_module.Memory.externalEdges#canCall| this@@34 |r#0@@3| |heapExternalEdges#0|)))
 :qid |gitissue3855dfy.285:11|
 :skolemid |945|
 :pattern ( (_module.Memory.externalEdges this@@34 |r#0@@3| |heapExternalEdges#0|))
 :pattern ( (|Set#IsMember| |allRelevantHeapRegions#0| ($Box DatatypeTypeType |r#0@@3|)))
)))))) (= (_module.Memory.heapExternalsZeroOrOneEdges this@@34 |edges#0@@20|) (let ((|heapExternalEdges#0@@0| (_module.Memory.justHeapExternalEdges this@@34 |edges#0@@20|)))
...
(let ((|heapExternalEdgesPartitionedByRegion#0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#54| Tclass._module.Region |allRelevantHeapRegions#0@@0|)) (|lambda#55| this@@34 |heapExternalEdges#0@@0|) (TMap Tclass._module.Region (TSet Tclass._module.Edge)))))
(forall ((|hr#0| T@U) ) (!  (=> (and ($Is DatatypeTypeType |hr#0| Tclass._module.Region) (|Set#IsMember| (|Map#Domain| |heapExternalEdgesPartitionedByRegion#0|) ($Box DatatypeTypeType |hr#0|))) (<= (|Set#Card| ($Unbox SetType (MapType0Select BoxType BoxType (|Map#Elements| |heapExternalEdgesPartitionedByRegion#0|) ($Box DatatypeTypeType |hr#0|)))) (LitInt 1)))
 ...
 :qid |gitissue3855dfy.280:13|
 :skolemid |947|
 :pattern ( (_module.Memory.heapExternalsZeroOrOneEdges this@@34 |edges#0@@20|))
))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@18 T@U) (this@@35 T@U) (|os#0@@8| T@U) ) (!  (=> (or (|_module.Memory.isosRefCountZeroOrOne#canCall| $Heap@@18 this@@35 |os#0@@8|) (and (< 4 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@18) (and (or (not (= this@@35 null)) (not true)) (and ($Is refType this@@35 Tclass._module.Memory) ($IsAlloc refType this@@35 Tclass._module.Memory $Heap@@18)))) ($Is SetType |os#0@@8| (TSet Tclass._module.Object))))) (and (and (|_module.Memory.edges#canCall| $Heap@@18 this@@35 |os#0@@8|) (let ((|edges#0@@21| (_module.Memory.edges $Heap@@18 this@@35 |os#0@@8|)))
 (and (|_module.Memory.justTheIsos#canCall| $Heap@@18 this@@35 |os#0@@8|) (let ((|isos#0| (_module.Memory.justTheIsos $Heap@@18 this@@35 |os#0@@8|)))
(forall ((|i#0| T@U) ) (!  (=> ($Is refType |i#0| Tclass._module.Object) (=> (|Set#IsMember| |isos#0| ($Box refType |i#0|)) (|_module.Memory.refCountEdges#canCall| this@@35 |i#0| |edges#0@@21|)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |983|
 :pattern ( (_module.Memory.refCountEdges this@@35 |i#0| |edges#0@@21|))
 :pattern ( (|Set#IsMember| |isos#0| ($Box refType |i#0|)))
)))))) (= (_module.Memory.isosRefCountZeroOrOne $Heap@@18 this@@35 |os#0@@8|) (let ((|edges#0@@22| (_module.Memory.edges $Heap@@18 this@@35 |os#0@@8|)))
(let ((|isos#0@@0| (_module.Memory.justTheIsos $Heap@@18 this@@35 |os#0@@8|)))
(forall ((|i#0@@0| T@U) ) (!  (=> (and ($Is refType |i#0@@0| Tclass._module.Object) (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|))) (<= (_module.Memory.refCountEdges this@@35 |i#0@@0| |edges#0@@22|) (LitInt 1)))
 :qid |gitissue3855dfy.320:12|
 :skolemid |982|
 :pattern ( (_module.Memory.refCountEdges this@@35 |i#0@@0| |edges#0@@22|))
 :pattern ( (|Set#IsMember| |isos#0@@0| ($Box refType |i#0@@0|)))
)))))))
 :qid |gitissue3855dfy.315:13|
 :skolemid |984|
 :pattern ( (_module.Memory.isosRefCountZeroOrOne $Heap@@18 this@@35 |os#0@@8|) ($IsGoodHeap $Heap@@18))
))))
(assert  (=> (<= 5 $FunctionContextHeight) (forall (($Heap@@19 T@U) (this@@36 T@U) ) (!  (=> (or (|_module.Object.Valid#canCall| $Heap@@19 this@@36) (and (< 5 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@19) (and (or (not (= this@@36 null)) (not true)) (and ($Is refType this@@36 Tclass._module.Object) ($IsAlloc refType this@@36 Tclass._module.Object $Heap@@19)))))) (and (and (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@19 this@@36) (=> (_module.Object.AllFieldsAreDeclared $Heap@@19 this@@36) (and (|_module.Object.AllFieldsContentsConsistentWithTheirDeclaration#canCall| $Heap@@19 this@@36) (=> (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@19 this@@36) (|_module.Object.AllOutgoingReferencesAreVenice#canCall| $Heap@@19 this@@36))))) (= (_module.Object.Valid true $Heap@@19 this@@36)  (and (and (_module.Object.AllFieldsAreDeclared $Heap@@19 this@@36) (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@19 this@@36)) (_module.Object.AllOutgoingReferencesAreVenice $Heap@@19 this@@36)))))
 :qid |gitissue3855dfy.110:23|
 :skolemid |770|
 :pattern ( (_module.Object.Valid true $Heap@@19 this@@36) ($IsGoodHeap $Heap@@19))
))))
(assert (forall ((v@@7 T@U) (t0@@6 T@U) (t1@@3 T@U) ) (! (= ($Is MapType v@@7 (TMap t0@@6 t1@@3)) (forall ((bx@@17 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@7) bx@@17) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@17) t1@@3) ($IsBox bx@@17 t0@@6)))
 :qid |DafnyPreludebpl.261:19|
 :skolemid |55|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| v@@7) bx@@17))
 :pattern ( (|Set#IsMember| (|Map#Domain| v@@7) bx@@17))
)))
...
(assert (forall ((|l#0@@7| T@U) (|l#1@@7| T@U) (|l#2@@3| T@U) (|l#3@@1| T@U) (|l#4@@0| T@U) (|l#5@@0| T@U) (|l#6@@0| T@U) (|l#7@@0| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|$y#0@@3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@1| |l#4@@0| |l#5@@0| |l#6@@0| |l#7@@0| |l#8| |l#9| |l#10|) |$y#0@@3|)) (exists ((|o#0@@11| T@U) (|n#0@@2| T@U) ) (!  (and (and (and ($Is refType |o#0@@11| |l#0@@7|) ($Is SeqType |n#0@@2| |l#1@@7|)) (and (|Set#IsMember| |l#2@@3| ($Box refType |o#0@@11|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3@@1| |o#0@@11|) |l#4@@0|))) ($Box SeqType |n#0@@2|)))) (= |$y#0@@3| ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@11| |n#0@@2| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#5@@0| |o#0@@11|) |l#6@@0|))) ($Box SeqType |n#0@@2|)))))))
 :qid |gitissue3855dfy.261:10|
 :skolemid |920|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#9| |o#0@@11|) |l#10|))) ($Box SeqType |n#0@@2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#7@@0| |o#0@@11|) |l#8|))) ($Box SeqType |n#0@@2|)))
)))
 :qid |gitissue3855dfy.87:7|
 :skolemid |1416|
 :pattern ( (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@1| |l#4@@0| |l#5@@0| |l#6@@0| |l#7@@0| |l#8| |l#9| |l#10|) |$y#0@@3|))
)))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($Heap@@20 T@U) (this@@37 T@U) (|os#0@@9| T@U) ) (!  (=> (or (|_module.Memory.edges#canCall| $Heap@@20 this@@37 |os#0@@9|) (and (< 2 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@20) (and (or (not (= this@@37 null)) (not true)) (and ($Is refType this@@37 Tclass._module.Memory) ($IsAlloc refType this@@37 Tclass._module.Memory $Heap@@20)))) ($Is SetType |os#0@@9| (TSet Tclass._module.Object))))) (= (_module.Memory.edges $Heap@@20 this@@37 |os#0@@9|) (|Set#FromBoogieMap| (|lambda#47| Tclass._module.Object (TSeq TChar) |os#0@@9| $Heap@@20 _module.Object.fields $Heap@@20 _module.Object.fields $Heap@@20 _module.Object.fields $Heap@@20 _module.Object.fields))))
 :qid |gitissue3855dfy.256:12|
 :skolemid |921|
 :pattern ( (_module.Memory.edges $Heap@@20 this@@37 |os#0@@9|) ($IsGoodHeap $Heap@@20))
))))
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@38 T@U) (|t#0@@11| T@U) (|edges#0@@23| T@U) ) (!  (=> (or (|_module.Memory.refCountEdges#canCall| this@@38 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@38 null)) (not true)) ($Is refType this@@38 Tclass._module.Memory)) ($Is refType |t#0@@11| Tclass._module.Object)) ($Is SetType |edges#0@@23| (TSet Tclass._module.Edge))))) (and (|_module.Memory.incomingEdges#canCall| this@@38 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (= (_module.Memory.refCountEdges this@@38 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)) (|Set#Card| (_module.Memory.incomingEdges this@@38 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|))))))
 :qid |gitissue3855dfy.251:12|
 :weight 3
 :skolemid |911|
 :pattern ( (_module.Memory.refCountEdges this@@38 (Lit refType |t#0@@11|) (Lit SetType |edges#0@@23|)))
))))
...
(assert  (=> (<= 3 $FunctionContextHeight) (forall ((this@@39 T@U) (|o#0@@12| T@U) (|edges#0@@24| T@U) ) (!  (=> (or (|_module.Memory.externalEdges#canCall| this@@39 (Lit DatatypeTypeType |o#0@@12|) (Lit SetType |edges#0@@24|)) (and (< 3 $FunctionContextHeight) (and (and (and (or (not (= this@@39 null)) (not true)) ($Is refType this@@39 Tclass._module.Memory)) ($Is DatatypeTypeType |o#0@@12| Tclass._module.Region)) ($Is SetType |edges#0@@24| (TSet Tclass._module.Edge))))) (and (forall ((|e#1@@1| T@U) ) (!  (=> ($Is DatatypeTypeType |e#1@@1| Tclass._module.Edge) (=> (|Set#IsMember| (Lit SetType |edges#0@@24|) ($Box DatatypeTypeType |e#1@@1|)) (and (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.t |e#1@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@12|))) (_module.Edge.Edge_q |e#1@@1|)) (=> (|_module.Region#Equal| (_module.Object.region (_module.Edge.t |e#1@@1|)) |o#0@@12|) (and (and (|$IsA#_module.Region| (_module.Object.region (_module.Edge.f |e#1@@1|))) (|$IsA#_module.Region| (Lit DatatypeTypeType |o#0@@12|))) (_module.Edge.Edge_q |e#1@@1|))))))
 :qid |gitissue3855dfy.339:9|
 :skolemid |1004|
 :pattern ( (_module.Edge.f |e#1@@1|))
 :pattern ( (_module.Edge.t |e#1@@1|))
 :pattern ( (|Set#IsMember| |edges#0@@24| ($Box DatatypeTypeType |e#1@@1|)))
)) (= (_module.Memory.externalEdges this@@39 (Lit DatatypeTypeType |o#0@@12|) (Lit SetType |edges#0@@24|)) (|Set#FromBoogieMap| (|lambda#71| Tclass._module.Edge (Lit SetType |edges#0@@24|) |o#0@@12| |o#0@@12|)))))
 :qid |gitissue3855dfy.336:12|
 :weight 3
 :skolemid |1005|
 :pattern ( (_module.Memory.externalEdges this@@39 (Lit DatatypeTypeType |o#0@@12|) (Lit SetType |edges#0@@24|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@21 T@U) (this@@40 T@U) ) (!  (=> (or (|_module.Object.AllOutgoingReferencesAreVenice#canCall| $Heap@@21 this@@40) (and (< 4 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@21) (and (or (not (= this@@40 null)) (not true)) (and ($Is refType this@@40 Tclass._module.Object) ($IsAlloc refType this@@40 Tclass._module.Object $Heap@@21)))))) (and (forall ((|n#0@@3| T@U) ) (!  (=> ($Is SeqType |n#0@@3| (TSeq TChar)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Object.fields))) ($Box SeqType |n#0@@3|)) (|_module.__default.VeniceReferenceOK#canCall| this@@40 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Object.fields))) ($Box SeqType |n#0@@3|))))))
 :qid |gitissue3855dfy.134:16|
 :skolemid |796|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Object.fields))) ($Box SeqType |n#0@@3|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Object.fields))) ($Box SeqType |n#0@@3|)))
)) (= (_module.Object.AllOutgoingReferencesAreVenice $Heap@@21 this@@40) (forall ((|n#0@@4| T@U) ) (!  (=> (and ($Is SeqType |n#0@@4| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Object.fields))) ($Box SeqType |n#0@@4|))) (_module.__default.VeniceReferenceOK this@@40 ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Object.fields))) ($Box SeqType |n#0@@4|)))))
 :qid |gitissue3855dfy.134:16|
 :skolemid |795|
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Object.fields))) ($Box SeqType |n#0@@4|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@40) _module.Object.fields))) ($Box SeqType |n#0@@4|)))
)))))
 :qid |gitissue3855dfy.131:13|
 :skolemid |797|
 :pattern ( (_module.Object.AllOutgoingReferencesAreVenice $Heap@@21 this@@40) ($IsGoodHeap $Heap@@21))
))))
...
(declare-fun this@@41 () T@U)
(declare-fun |n#0@@5| () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun |b$reqreads#1@0| () Bool)
(declare-fun |b$reqreads#2@0| () Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.fExists)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |o#0@@13| null)) (not true))) (=> (or (not (= |o#0@@13| null)) (not true)) (=> (and (and (= |b$reqreads#3@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |o#0@@13| _module.Object.fields))) (= (_module.Memory.fExists $Heap@@22 this@@41 |o#0@@13| |n#0@@5|) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 |o#0@@13|) _module.Object.fields))) ($Box SeqType |n#0@@5|)))) (and ($Is boolType (bool_2_U (_module.Memory.fExists $Heap@@22 this@@41 |o#0@@13| |n#0@@5|)) TBool) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#3@0|)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#89| null $Heap@@22 alloc this@@41 _module.Memory.objects ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@41) _module.Memory.objects)) |o#0@@13| _module.Object.fields)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@41 _module.Memory.objects))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@41) _module.Memory.objects)) ($Box refType |o#0@@13|))) (=> (and (and ($IsAllocBox ($Box refType this@@41) Tclass._module.Memory? $Heap@@22) (= |b$reqreads#1@0| (forall (($o@@12 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 $o@@12) alloc)))) (or (and (= $o@@12 this@@41) (= $f@@0 _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@22 this@@41) _module.Memory.objects)) ($Box refType $o@@12)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@12 $f@@0)))
 :qid |gitissue3855dfy.403:14|
 :skolemid |1052|
)))) (and (|_module.Memory.Valid#canCall| $Heap@@22 this@@41) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@@22 this@@41))) (and (=> (= (ControlFlow 0 5) (- 0 10)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 5) (- 0 9)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= this@@41 null)) (not true))) (=> (or (not (= this@@41 null)) (not true)) (=> (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@41 _module.Memory.objects))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (not (= |o#0@@13| null)) (not true))) (=> (or (not (= |o#0@@13| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) |b$reqreads#2@0|) (=> |b$reqreads#2@0| (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@22) ($IsHeapAnchor $Heap@@22)) (and (or (not (= this@@41 null)) (not true)) (and ($Is refType this@@41 Tclass._module.Memory) ($IsAlloc refType this@@41 Tclass._module.Memory $Heap@@22)))) (and (and ($Is refType |o#0@@13| Tclass._module.Object) ($Is SeqType |n#0@@5| (TSeq TChar))) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 11) 5)))) anon0_correct)))
