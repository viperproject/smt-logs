...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@151  (=> (and (= $generated@@143 ($generated@@83 $generated@@144 $generated@@145 $generated@@146 false)) (< $generated@@147 64)) (=> (and (and ($generated@@148 $generated@@149) ($generated@@150 $generated@@149)) (= $generated@@145 $generated@@149)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 $generated@@147) (< $generated@@147 256))) (=> (and (<= 0 $generated@@147) (< $generated@@147 256)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bvule ((_ int2bv 8) $generated@@147) #x80)) (=> (bvule ((_ int2bv 8) $generated@@147) #x80) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 $generated@@147) (< $generated@@147 128))) (=> (and (<= 0 $generated@@147) (< $generated@@147 128)) (=> (= (ControlFlow 0 2) (- 0 1)) (bvule ((_ int2bv 7) $generated@@147) #b1000000))))))))))))
(let (($generated@@152  (=> (and (and (and ($generated@@148 $generated@@145) ($generated@@150 $generated@@145)) (<= ($generated@@66 0) $generated@@147)) (and (= 1 $generated@@139) (= (ControlFlow 0 6) 2))) $generated@@151)))
$generated@@152)))
))
(check-sat)
(get-info :rlimit)
