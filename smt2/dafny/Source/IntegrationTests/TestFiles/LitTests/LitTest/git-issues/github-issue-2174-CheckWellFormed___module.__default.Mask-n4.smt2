...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.MaskedCommLShiftUpCast)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (< |idx#0| 64)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 |idx#0|) (< |idx#0| 256))) (=> (and (<= 0 |idx#0|) (< |idx#0| 256)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (bvule ((_ int2bv 8) |idx#0|) #x80)) (=> (bvule ((_ int2bv 8) |idx#0|) #x80) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |idx#0|) (< |idx#0| 128))) (=> (and (<= 0 |idx#0|) (< |idx#0| 128)) (=> (= (ControlFlow 0 2) (- 0 1)) (bvule ((_ int2bv 7) |idx#0|) #b1000000))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |idx#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct)))
