...
procedure {:verboseName "MatchExpressions.Test (correctness)"} Impl$$MatchExpressions.__default.Test() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressions.Test (correctness)"} Impl$$MatchExpressions.__default.Test() returns ($_reverifyPost: bool)
{
  ...
  var ##o#3: DatatypeType;
  var ##n#2: int;
  var ##m#0: int;

    // AddMethodImpl: Test, Impl$$MatchExpressions.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(197,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    c##0 := Lit(#MatchExpressions.Color.Green());
    call {:id "id0"} Call$$MatchExpressions.__default.M(c##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(198,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    c##1 := Lit(#MatchExpressions.Color.Red());
    call {:id "id1"} Call$$MatchExpressions.__default.N(c##1);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(199,15)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    c##2 := Lit(#MatchExpressions.Color.Blue());
    assume true;
    // ProcessCallStmt: CheckSubrange
    y##0 := LitInt(10);
    call {:id "id2"} $rhs##0 := Call$$MatchExpressions.__default.O(c##2, y##0);
    // TrCallStmt: After ProcessCallStmt
    r#0 := $rhs##0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(200,5)
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(201,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    s##0 := LitInt(7);
    ...
    // ProcessCallStmt: CheckSubrange
    t##0 := LitInt(2);
    call {:id "id4"} Call$$MatchExpressions.__default.P(s##0, t##0);
    // TrCallStmt: After ProcessCallStmt
    $Heap_at_0 := $Heap;
    push;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(203,15)
    assume true;
    assume true;
    abc#0 := LitInt(0);
    // ----- break statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(204,7)
    pop;
    goto after_0;
  ...
  after_0:
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(206,5)
    ##o#0 := Lit(#MatchExpressions.AB.A());
    // assume allocatedness for argument to function
    assume $IsAlloc(##o#0, Tclass.MatchExpressions.AB(), $Heap);
    assert {:id "id6"} $Is(LitInt(19), Tclass._System.nat());
    ##n#0 := LitInt(19);
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
    assume MatchExpressions.__default.TailRecursive#canCall(Lit(#MatchExpressions.AB.A()), LitInt(19));
    assume MatchExpressions.__default.TailRecursive#canCall(Lit(#MatchExpressions.AB.A()), LitInt(19));
    assume true;
    ##o#1 := Lit(#MatchExpressions.AB.A());
    // assume allocatedness for argument to function
    assume $IsAlloc(##o#1, Tclass.MatchExpressions.AB(), $Heap);
    assert {:id "id7"} $Is(LitInt(19), Tclass._System.nat());
    ##n#1 := LitInt(19);
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#1, Tclass._System.nat(), $Heap);
    assume MatchExpressions.__default.AutoAccumulator#canCall(Lit(#MatchExpressions.AB.A()), LitInt(19));
    assume MatchExpressions.__default.AutoAccumulator#canCall(Lit(#MatchExpressions.AB.A()), LitInt(19));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(207,5)
    ##o#2 := Lit(#MatchExpressions.ABC.BB());
    // assume allocatedness for argument to function
    assume $IsAlloc(##o#2, Tclass.MatchExpressions.ABC(), $Heap);
    assume MatchExpressions.__default.LastCaseIsDisjunctive#canCall(Lit(#MatchExpressions.ABC.BB()));
    assume MatchExpressions.__default.LastCaseIsDisjunctive#canCall(Lit(#MatchExpressions.ABC.BB()));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(208,5)
    ##o#3 := Lit(#MatchExpressions.AB.A());
    // assume allocatedness for argument to function
    assume $IsAlloc(##o#3, Tclass.MatchExpressions.AB(), $Heap);
    assert {:id "id8"} $Is(LitInt(12), Tclass._System.nat());
    ##n#2 := LitInt(12);
    // assume allocatedness for argument to function
    ...
    assume MatchExpressions.__default.F#canCall(Lit(#MatchExpressions.AB.A()), LitInt(12), LitInt(80));
    assume MatchExpressions.__default.F#canCall(Lit(#MatchExpressions.AB.A()), LitInt(12), LitInt(80));
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(209,5)
    assume true;
}
...
procedure {:verboseName "MatchExpressions.M (well-formedness)"} CheckWellFormed$$MatchExpressions.__default.M(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "MatchExpressions.M (call)"} Call$$MatchExpressions.__default.M(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0));
  modifies $Heap;
...
procedure {:verboseName "MatchExpressions.M (correctness)"} Impl$$MatchExpressions.__default.M(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0))
...
procedure {:verboseName "MatchExpressions.N (well-formedness)"} CheckWellFormed$$MatchExpressions.__default.N(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0));
  free requires 1 == $FunctionContextHeight;
...
procedure {:verboseName "MatchExpressions.N (call)"} Call$$MatchExpressions.__default.N(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0));
  // user-defined preconditions
  requires {:id "id11"} MatchExpressions.Color#Equal(c#0, #MatchExpressions.Color.Red());
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "MatchExpressions.N (correctness)"} Impl$$MatchExpressions.__default.N(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0))
   returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id12"} MatchExpressions.Color#Equal(c#0, #MatchExpressions.Color.Red());
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressions.N (correctness)"} Impl$$MatchExpressions.__default.N(c#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x#0: int;

    // AddMethodImpl: N, Impl$$MatchExpressions.__default.N
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(223,11)
    assume true;
    if (c#0 == #MatchExpressions.Color.Red())
    {
    }
    else if (c#0 == #MatchExpressions.Color.Blue())
    {
        assert {:id "id14"} false;
    }
    else if (c#0 == #MatchExpressions.Color.Green())
    {
    ...
    assume true;
    x#0 := LitInt(5);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(225,5)
    assume true;
    assume true;
}
...
procedure {:verboseName "MatchExpressions.O (well-formedness)"} CheckWellFormed$$MatchExpressions.__default.O(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0), 
    y#0: int)
...
procedure {:verboseName "MatchExpressions.O (call)"} Call$$MatchExpressions.__default.O(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0), 
    y#0: int)
...
procedure {:verboseName "MatchExpressions.O (correctness)"} Impl$$MatchExpressions.__default.O(c#0: DatatypeType
       where $Is(c#0, Tclass.MatchExpressions.Color())
         && $IsAlloc(c#0, Tclass.MatchExpressions.Color(), $Heap)
         && $IsA#MatchExpressions.Color(c#0), 
    y#0: int)
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressions.O (correctness)"} Impl$$MatchExpressions.__default.O(c#0: DatatypeType, y#0: int) returns (r#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x#0_0: int;

    // AddMethodImpl: O, Impl$$MatchExpressions.__default.O
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(231,5)
    assume true;
    if (y#0 < 0)
    {
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(233,18)
        assume true;
        if (c#0 == #MatchExpressions.Color.Blue())
        {
        ...
        else if (c#0 == #MatchExpressions.Color.Red())
        {
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(235,7)
    assume true;
    assume true;
    r#0 := LitInt(12);
}
...
procedure {:verboseName "MatchExpressions.P (well-formedness)"} CheckWellFormed$$MatchExpressions.__default.P(s#0: int, t#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "MatchExpressions.P (call)"} Call$$MatchExpressions.__default.P(s#0: int, t#0: int);
  // user-defined preconditions
  requires {:id "id27"} t#0 == LitInt(0) || t#0 == LitInt(2);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "MatchExpressions.P (correctness)"} Impl$$MatchExpressions.__default.P(s#0: int, t#0: int) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id28"} t#0 == LitInt(0) || t#0 == LitInt(2);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressions.P (correctness)"} Impl$$MatchExpressions.__default.P(s#0: int, t#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x#0: int;
  var y#0: int;
  ...
  var x#0_1: int;
    ...
    // AddMethodImpl: P, Impl$$MatchExpressions.__default.P
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(241,16)
    assume true;
    if (s#0 == LitInt(0))
    {
    }
    ...
    assume true;
    x#0 := (if s#0 == LitInt(0) then 100 else (if s#0 == LitInt(2) then 200 else 400));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(245,16)
    assume true;
    if (t#0 == LitInt(0))
    {
    }
    ...
    {
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(245,19)
        assume true;
        assert {:id "id30"} {:error "missing case in match expression: not all possibilities for selector of type int have been covered"} t#0 == LitInt(2);
    }

    assume true;
    y#0 := (if t#0 == LitInt(0) then 60 else 80);
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(248,5)
    assume true;
    if (t#0 == LitInt(1))
    {
        push;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(250,18)
        assume true;
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(250,21)
        assume true;
        assert {:id "id32"} {:error "match has no cases and this is only allowed when the verifier can prove the match is unreachable"} Lit(false);
        havoc x#0_1;
        if (true)
        {
        }

        assert {:id "id33"} Lit(true);
        assume true;
        assume true;
        assume $let#0$canCall();
        assume $let#0$canCall();
        z#0_0 := (var x#0_0 := $let#0_x(); x#0_0);
        pop;
    }
    else
    {
    ...
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-3868.dfy(252,5)
    assume true;
    assume true;
    assume true;
    assume true;
...
axiom {:id "id35"} 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, o#0: DatatypeType, n#0: int :: 
...
procedure {:verboseName "MatchExpressions.TailRecursive (well-formedness)"} CheckWellformed$$MatchExpressions.__default.TailRecursive(o#0: DatatypeType where $Is(o#0, Tclass.MatchExpressions.AB()), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressions.TailRecursive (well-formedness)"} CheckWellformed$$MatchExpressions.__default.TailRecursive(o#0: DatatypeType, n#0: int)
{
  ...
  var ##n#1: int;
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume {:id "id37"} MatchExpressions.__default.TailRecursive($LS($LZ), o#0, n#0) == LitInt(6);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(MatchExpressions.__default.TailRecursive($LS($LZ), o#0, n#0), TInt);
            return;
        }
        else
        {
            if (o#0 == #MatchExpressions.AB.A())
            {
                ##o#1 := o#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##o#1, Tclass.MatchExpressions.AB(), $Heap);
                assert {:id "id42"} $Is(n#0 - 1, Tclass._System.nat());
                ##n#1 := n#0 - 1;
                // assume allocatedness for argument to function
                assume $IsAlloc(##n#1, Tclass._System.nat(), $Heap);
                assert {:id "id43"} 0 <= n#0 || DtRank(##o#1) < DtRank(o#0) || ##n#1 == n#0;
                assert {:id "id44"} DtRank(##o#1) < DtRank(o#0) || (DtRank(##o#1) == DtRank(o#0) && ##n#1 < n#0);
                assume MatchExpressions.__default.TailRecursive#canCall(o#0, n#0 - 1);
                assume {:id "id45"} MatchExpressions.__default.TailRecursive($LS($LZ), o#0, n#0)
                   == MatchExpressions.__default.TailRecursive($LS($LZ), o#0, n#0 - 1);
                assume MatchExpressions.__default.TailRecursive#canCall(o#0, n#0 - 1);
                // CheckWellformedWithResult: any expression
                assume $Is(MatchExpressions.__default.TailRecursive($LS($LZ), o#0, n#0), TInt);
                return;
            }
            else if (o#0 == #MatchExpressions.AB.B())
            {
                ##o#0 := o#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##o#0, Tclass.MatchExpressions.AB(), $Heap);
                assert {:id "id38"} $Is(n#0 - 1, Tclass._System.nat());
                ##n#0 := n#0 - 1;
                // assume allocatedness for argument to function
                assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
                assert {:id "id39"} 0 <= n#0 || DtRank(##o#0) < DtRank(o#0) || ##n#0 == n#0;
                assert {:id "id40"} DtRank(##o#0) < DtRank(o#0) || (DtRank(##o#0) == DtRank(o#0) && ##n#0 < n#0);
                assume MatchExpressions.__default.TailRecursive#canCall(o#0, n#0 - 1);
                assume {:id "id41"} MatchExpressions.__default.TailRecursive($LS($LZ), o#0, n#0)
                   == MatchExpressions.__default.TailRecursive($LS($LZ), o#0, n#0 - 1);
                assume MatchExpressions.__default.TailRecursive#canCall(o#0, n#0 - 1);
                // CheckWellformedWithResult: any expression
                assume $Is(MatchExpressions.__default.TailRecursive($LS($LZ), o#0, n#0), TInt);
...
procedure {:verboseName "MatchExpressions.AutoAccumulator (well-formedness)"} CheckWellformed$$MatchExpressions.__default.AutoAccumulator(o#0: DatatypeType where $Is(o#0, Tclass.MatchExpressions.AB()), 
    n#0: int where LitInt(0) <= n#0);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressions.AutoAccumulator (well-formedness)"} CheckWellformed$$MatchExpressions.__default.AutoAccumulator(o#0: DatatypeType, n#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##o#0: DatatypeType;
  var ##n#0: int;
  ...
  var ##n#1: int;
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume {:id "id48"} MatchExpressions.__default.AutoAccumulator($LS($LZ), o#0, n#0) == LitInt(6);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(MatchExpressions.__default.AutoAccumulator($LS($LZ), o#0, n#0), TInt);
            return;
        }
        else
        {
            if (o#0 == #MatchExpressions.AB.A())
            {
                ...
                // assume allocatedness for argument to function
                assume $IsAlloc(##o#1, Tclass.MatchExpressions.AB(), $Heap);
                assert {:id "id53"} $Is(n#0 - 1, Tclass._System.nat());
                ##n#1 := n#0 - 1;
                // assume allocatedness for argument to function
                assume $IsAlloc(##n#1, Tclass._System.nat(), $Heap);
                assert {:id "id54"} 0 <= n#0 || DtRank(##o#1) < DtRank(o#0) || ##n#1 == n#0;
                assert {:id "id55"} DtRank(##o#1) < DtRank(o#0) || (DtRank(##o#1) == DtRank(o#0) && ##n#1 < n#0);
                assume MatchExpressions.__default.AutoAccumulator#canCall(o#0, n#0 - 1);
                assume {:id "id56"} MatchExpressions.__default.AutoAccumulator($LS($LZ), o#0, n#0)
                   == MatchExpressions.__default.AutoAccumulator($LS($LZ), o#0, n#0 - 1) + 1;
                assume MatchExpressions.__default.AutoAccumulator#canCall(o#0, n#0 - 1);
                // CheckWellformedWithResult: any expression
                assume $Is(MatchExpressions.__default.AutoAccumulator($LS($LZ), o#0, n#0), TInt);
                return;
            ...
            else if (o#0 == #MatchExpressions.AB.B())
            {
                ...
                // assume allocatedness for argument to function
                assume $IsAlloc(##n#0, Tclass._System.nat(), $Heap);
                assert {:id "id50"} 0 <= n#0 || DtRank(##o#0) < DtRank(o#0) || ##n#0 == n#0;
                assert {:id "id51"} DtRank(##o#0) < DtRank(o#0) || (DtRank(##o#0) == DtRank(o#0) && ##n#0 < n#0);
                assume MatchExpressions.__default.AutoAccumulator#canCall(o#0, n#0 - 1);
                assume {:id "id52"} MatchExpressions.__default.AutoAccumulator($LS($LZ), o#0, n#0)
                   == MatchExpressions.__default.AutoAccumulator($LS($LZ), o#0, n#0 - 1) + 1;
                assume MatchExpressions.__default.AutoAccumulator#canCall(o#0, n#0 - 1);
                // CheckWellformedWithResult: any expression
                assume $Is(MatchExpressions.__default.AutoAccumulator($LS($LZ), o#0, n#0), TInt);
...
procedure {:verboseName "MatchExpressions.LastCaseIsDisjunctive (well-formedness)"} CheckWellformed$$MatchExpressions.__default.LastCaseIsDisjunctive(o#0: DatatypeType where $Is(o#0, Tclass.MatchExpressions.ABC()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id62"} 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, $Heap: Heap, o#0: DatatypeType, n#0: int, m#0: int :: 
         ...
         && MatchExpressions.__default.F($LS($ly), o#0, n#0, m#0)
           == (if n#0 == LitInt(0)
             then m#0
               ...
               then (var ff#0 := Lit(AtLayer((lambda $l#0#ly#0: LayerType :: 
                      ...
                      $ly)); 
                (var s#0 := $Unbox(Apply0(TInt, $Heap, ff#0)): int; 
                  MatchExpressions.__default.F($ly, o#0, n#0 - 1, m#0)))
               else (var u#0 := (if MatchExpressions.AB.A_q(o#0) then 20 else 999); 
                MatchExpressions.__default.F($ly, o#0, n#0 - 1, m#0)))));
         ...
         && MatchExpressions.__default.F($LS($ly), Lit(o#0), LitInt(n#0), LitInt(m#0))
           == (if LitInt(n#0) == LitInt(0)
             then m#0
               ...
               then (var ff#1 := Lit(AtLayer((lambda $l#3#ly#0: LayerType :: 
                      ...
                      $LS($ly))); 
                (var s#1 := $Unbox(Apply0(TInt, $Heap, ff#1)): int; 
                  LitInt(MatchExpressions.__default.F($LS($ly), Lit(o#0), LitInt(n#0 - 1), LitInt(m#0)))))
               else (var u#1 := (if MatchExpressions.AB.A_q(Lit(o#0)) then 20 else 999); 
                LitInt(MatchExpressions.__default.F($LS($ly), Lit(o#0), LitInt(n#0 - 1), LitInt(m#0)))))));
}
...
procedure {:verboseName "MatchExpressions.F (well-formedness)"} CheckWellformed$$MatchExpressions.__default.F(o#0: DatatypeType where $Is(o#0, Tclass.MatchExpressions.AB()), 
    n#0: int where LitInt(0) <= n#0, 
    m#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressions.F (well-formedness)"} CheckWellformed$$MatchExpressions.__default.F(o#0: DatatypeType, n#0: int, m#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ff#Z#0: HandleType;
  ...
  var ##m#1: int;
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume {:id "id64"} MatchExpressions.__default.F($LS($LZ), o#0, n#0, m#0) == m#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(MatchExpressions.__default.F($LS($LZ), o#0, n#0, m#0), TInt);
            return;
        }
        else
        {
            if (n#0 == LitInt(1))
            {
                ...
                if (*)
                {
                    ...
                    if (true)
                    {
                        ...
                        if (o#0 == #MatchExpressions.AB.A())
                        {
                            assume {:id "id66"} lambdaResult#0 == LitInt(20);
                            assume true;
                            // CheckWellformedWithResult: any expression
                        ...
                        {
                            assume {:id "id65"} lambdaResult#0 == LitInt(999);
                            assume true;
                            // CheckWellformedWithResult: any expression
                            assume $Is(lambdaResult#0, TInt);
                        }
                ...
                assume {:id "id67"} let#0#0#0
                   == Lit(AtLayer((lambda $l#7#ly#0: LayerType :: 
                        Handle0((lambda $l#7#heap#0: Heap :: 
                            $Box((if MatchExpressions.AB.A_q(o#0) then 20 else 999))), 
                ...
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#0#0#0, Tclass._System.___hTotalFunc0(TInt));
                assume {:id "id68"} ff#Z#0 == let#0#0#0;
                havoc s#Z#0;
                assume {:id "id69"} let#1#0#0 == $Unbox(Apply0(TInt, $Heap, ff#Z#0)): int;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#1#0#0, TInt);
                assume {:id "id70"} s#Z#0 == let#1#0#0;
                ##o#0 := o#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##o#0, Tclass.MatchExpressions.AB(), $Heap);
                ...
                // assume allocatedness for argument to function
                assume $IsAlloc(##m#0, TInt, $Heap);
                assert {:id "id72"} 0 <= n#0 || DtRank(##o#0) < DtRank(o#0) || ##n#0 == n#0;
                assert {:id "id73"} 0 <= m#0 || DtRank(##o#0) < DtRank(o#0) || ##n#0 < n#0 || ##m#0 == m#0;
                assert {:id "id74"} DtRank(##o#0) < DtRank(o#0)
                   || (DtRank(##o#0) == DtRank(o#0) && (##n#0 < n#0 || (##n#0 == n#0 && ##m#0 < m#0)));
                assume MatchExpressions.__default.F#canCall(o#0, n#0 - 1, m#0);
                assume {:id "id75"} MatchExpressions.__default.F($LS($LZ), o#0, n#0, m#0)
                   == MatchExpressions.__default.F($LS($LZ), o#0, n#0 - 1, m#0);
                assume MatchExpressions.__default.F#canCall(o#0, n#0 - 1, m#0);
                // CheckWellformedWithResult: any expression
                assume $Is(MatchExpressions.__default.F($LS($LZ), o#0, n#0, m#0), TInt);
                return;
            ...
            else
            {
                ...
                if (o#0 == #MatchExpressions.AB.A())
                {
                    assume {:id "id77"} let#2#0#0 == LitInt(20);
                    assume true;
                    // CheckWellformedWithResult: any expression
                ...
                {
                    assume {:id "id76"} let#2#0#0 == LitInt(999);
                    assume true;
                    // CheckWellformedWithResult: any expression
                    assume $Is(let#2#0#0, TInt);
                }
                ...
                assume {:id "id78"} u#Z#0 == let#2#0#0;
                ##o#1 := o#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##o#1, Tclass.MatchExpressions.AB(), $Heap);
                ...
                assert {:id "id80"} 0 <= n#0 || DtRank(##o#1) < DtRank(o#0) || ##n#1 == n#0;
                assert {:id "id81"} 0 <= m#0 || DtRank(##o#1) < DtRank(o#0) || ##n#1 < n#0 || ##m#1 == m#0;
                assert {:id "id82"} DtRank(##o#1) < DtRank(o#0)
                   || (DtRank(##o#1) == DtRank(o#0) && (##n#1 < n#0 || (##n#1 == n#0 && ##m#1 < m#0)));
                assume MatchExpressions.__default.F#canCall(o#0, n#0 - 1, m#0);
                assume {:id "id83"} MatchExpressions.__default.F($LS($LZ), o#0, n#0, m#0)
                   == MatchExpressions.__default.F($LS($LZ), o#0, n#0 - 1, m#0);
                assume MatchExpressions.__default.F#canCall(o#0, n#0 - 1, m#0);
                // CheckWellformedWithResult: any expression
                assume $Is(MatchExpressions.__default.F($LS($LZ), o#0, n#0, m#0), TInt);
