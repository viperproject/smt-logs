...
(set-info :boogie-vc-id Impl$$_module.Dt.DatatypeTest)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType this Tclass._module.Dt) ($IsAlloc DatatypeTypeType this Tclass._module.Dt $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
