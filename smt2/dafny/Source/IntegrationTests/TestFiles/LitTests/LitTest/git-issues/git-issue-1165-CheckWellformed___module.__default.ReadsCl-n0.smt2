...
(declare-fun _module.__default.ReadsClauses (T@U T@U T@U T@U T@U Int) Int)
(declare-fun |_module.__default.ReadsClauses#canCall| (T@U T@U T@U T@U T@U Int) Bool)
(declare-fun DeclType (T@U) T@U)
(declare-fun Inv0_TSet (T@U) T@U)
(declare-fun TagFamily (T@U) T@U)
(declare-fun MapType1Select (T@T T@T T@T T@U T@U T@U) T@U)
(declare-fun |lambda#41| (T@U T@U T@U T@U T@U) T@U)
...
(assert (distinct TInt TagInt TagSet alloc allocName Tagclass._System.object? Tagclass._System.object Tagclass._module.Cell class._module.Cell? Tagclass._module.Cell? tytagFamily$object tytagFamily$Cell field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@3 T@U) ($o@@2 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass._module.Cell?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@2) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@2) _module.Cell.data)) TInt $h@@3))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |737|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@2) _module.Cell.data)))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|S#0| T@U) (|T#0| T@U) (|p#0| T@U) (|q#0| T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.ReadsClauses#canCall| $Heap |S#0| |T#0| |p#0| |q#0| |n#0|) (and (< 1 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $Heap) ($Is SetType |S#0| (TSet Tclass._System.object))) ($Is SetType |T#0| (TSet Tclass._System.object))) ($Is refType |p#0| Tclass._module.Cell)) ($Is refType |q#0| Tclass._module.Cell)) (and (|Set#IsMember| (|Set#Union| |S#0| |T#0|) ($Box refType |p#0|)) (|Set#IsMember| |S#0| ($Box refType |q#0|)))))) (= (_module.__default.ReadsClauses $Heap |S#0| |T#0| |p#0| |q#0| |n#0|) (+ (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |p#0|) _module.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |q#0|) _module.Cell.data)))) |n#0|)))
 :qid |gitissue1165dfy.73:16|
 :skolemid |718|
 :pattern ( (_module.__default.ReadsClauses $Heap |S#0| |T#0| |p#0| |q#0| |n#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.Cell?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) _module.Cell.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |736|
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@5 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#41| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@5 $f))  (=> (and (or (not (= $o@@5 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) (or (|Set#IsMember| |l#3| ($Box refType $o@@5)) (|Set#IsMember| |l#4| ($Box refType $o@@5)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |748|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#41| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@5 $f))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ReadsClauses)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |p#0@@0| null)) (not true))) (=> (or (not (= |p#0@@0| null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |p#0@@0| _module.Cell.data))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |q#0@@0| null)) (not true))) (=> (or (not (= |q#0@@0| null)) (not true)) (=> (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |q#0@@0| _module.Cell.data))) (=> (and (= (_module.__default.ReadsClauses $Heap@@0 |S#0@@0| |T#0@@0| |p#0@@0| |q#0@@0| |n#0@@0|) (+ (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |p#0@@0|) _module.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |q#0@@0|) _module.Cell.data)))) |n#0@@0|)) ($Is intType (int_2_U (_module.__default.ReadsClauses $Heap@@0 |S#0@@0| |T#0@@0| |p#0@@0| |q#0@@0| |n#0@@0|)) TInt)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@0|))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#41| null $Heap@@0 alloc |S#0@@0| |T#0@@0|)) (=> (and (|Set#IsMember| (|Set#Union| |S#0@@0| |T#0@@0|) ($Box refType |p#0@@0|)) (|Set#IsMember| |S#0@@0| ($Box refType |q#0@@0|))) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and ($Is SetType |S#0@@0| (TSet Tclass._System.object)) ($Is SetType |T#0@@0| (TSet Tclass._System.object)))) (and (and ($Is refType |p#0@@0| Tclass._module.Cell) ($Is refType |q#0@@0| Tclass._module.Cell)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7)))) anon0_correct)))
