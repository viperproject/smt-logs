...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|_module.__default.foo#canCall| |x#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.foo |x#0|) (LitInt 1)))
 :qid |gitissue1992dfy.4:14|
 :skolemid |481|
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|_module.__default.foo#canCall| (LitInt |x#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.foo (LitInt |x#0@@0|)) (LitInt 1)))
 :qid |gitissue1992dfy.4:14|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.foo (LitInt |x#0@@0|)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= |x#0@@1| (LitInt 0)))))
