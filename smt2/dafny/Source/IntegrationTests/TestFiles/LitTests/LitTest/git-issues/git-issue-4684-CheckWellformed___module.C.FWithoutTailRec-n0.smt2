...
(assert (forall (($ly@@0 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|n#0@@0| Int) (|g#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.C) ($IsAlloc refType this@@0 Tclass._module.C $h0)))) (or (|_module.C.FWithoutTailRecursion#canCall| $h0 this@@0 |n#0@@0| |g#0@@0|) (and (<= (LitInt 0) |n#0@@0|) (and ($Is HandleTypeType |g#0@@0| (Tclass._System.___hFunc0 TInt)) ($IsAlloc HandleTypeType |g#0@@0| (Tclass._System.___hFunc0 TInt) $h0))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))) (= (_module.C.FWithoutTailRecursion $ly@@0 $h0 this@@0 |n#0@@0| |g#0@@0|) (_module.C.FWithoutTailRecursion $ly@@0 $h1 this@@0 |n#0@@0| |g#0@@0|))))
