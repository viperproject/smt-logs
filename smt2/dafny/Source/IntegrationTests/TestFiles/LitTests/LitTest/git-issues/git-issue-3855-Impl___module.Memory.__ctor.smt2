...
(assert (forall (($reveal Bool) ($h0 T@U) ($h1 T@U) (this@@8 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@8 null)) (not true)) ($Is refType this@@8 Tclass._module.Memory))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) )  (=> (and (or (not (= $o@@3 null)) (not true)) (or (and (= $o@@3 this@@8) (= $f _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 this@@8) _module.Memory.objects)) ($Box refType $o@@3)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f)))) (= (_module.Memory.Valid $reveal $h0 this@@8) (_module.Memory.Valid $reveal $h1 this@@8))))
...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@22 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@10 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@10 null)) (not true)) (and (= $o@@10 this@@22) (= $f@@0 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@10) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@10) $f@@0)))) (= (_module.Object.AllFieldsAreDeclared $h0@@0 this@@22) (_module.Object.AllFieldsAreDeclared $h1@@0 this@@22))))
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.Object.AllFieldsAreDeclared $h1@@0 this@@22))
)))
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (this@@23 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@11 T@U) ($f@@1 T@U) )  (=> (and (or (not (= $o@@11 null)) (not true)) (and (= $o@@11 this@@23) (= $f@@1 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@11) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@11) $f@@1)))) (= (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $h0@@1 this@@23) (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $h1@@1 this@@23))))
 :pattern ( ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1) (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $h1@@1 this@@23))
)))
(assert (forall (($h0@@2 T@U) ($h1@@2 T@U) (this@@24 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@24 null)) (not true)) ($Is refType this@@24 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@12 T@U) ($f@@2 T@U) )  (=> (and (or (not (= $o@@12 null)) (not true)) (and (= $o@@12 this@@24) (= $f@@2 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@12) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@12) $f@@2)))) (= (_module.Object.AllOutgoingReferencesAreVenice $h0@@2 this@@24) (_module.Object.AllOutgoingReferencesAreVenice $h1@@2 this@@24))))
...
(assert (forall (($h0@@8 T@U) ($h1@@8 T@U) (this@@35 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@20 T@U) ($f@@8 T@U) )  (=> (and (or (not (= $o@@20 null)) (not true)) (and (= $o@@20 this@@35) (= $f@@8 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@20) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@20) $f@@8)))) (= (_module.Object.outgoing $h0@@8 this@@35) (_module.Object.outgoing $h1@@8 this@@35))))
...
(assert (forall (($h0@@9 T@U) ($h1@@9 T@U) (this@@37 T@U) (|os#0@@12| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@9) ($IsGoodHeap $h1@@9)) (and (or (not (= this@@37 null)) (not true)) ($Is refType this@@37 Tclass._module.Memory))) (or (|_module.Memory.justTheIsos#canCall| $h0@@9 this@@37 |os#0@@12|) ($Is SetType |os#0@@12| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9))) (=> (forall (($o@@21 T@U) ($f@@9 T@U) )  (=> (and (or (not (= $o@@21 null)) (not true)) (|Set#IsMember| |os#0@@12| ($Box refType $o@@21))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@9 $o@@21) $f@@9) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@9 $o@@21) $f@@9)))) (= (_module.Memory.justTheIsos $h0@@9 this@@37 |os#0@@12|) (_module.Memory.justTheIsos $h1@@9 this@@37 |os#0@@12|))))
 :pattern ( ($IsHeapAnchor $h0@@9) ($HeapSucc $h0@@9 $h1@@9) (_module.Memory.justTheIsos $h1@@9 this@@37 |os#0@@12|))
)))
(assert (forall (($h0@@10 T@U) ($h1@@10 T@U) (this@@38 T@U) (|os#0@@13| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@38 null)) (not true)) ($Is refType this@@38 Tclass._module.Memory))) (or (|_module.Memory.edges#canCall| $h0@@10 this@@38 |os#0@@13|) ($Is SetType |os#0@@13| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@22 T@U) ($f@@10 T@U) )  (=> (and (or (not (= $o@@22 null)) (not true)) (|Set#IsMember| |os#0@@13| ($Box refType $o@@22))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@22) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@22) $f@@10)))) (= (_module.Memory.edges $h0@@10 this@@38 |os#0@@13|) (_module.Memory.edges $h1@@10 this@@38 |os#0@@13|))))
