...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@22 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@22 null)) (not true)) ($Is refType this@@22 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (and (= $o@@10 this@@22) (= $f@@0 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@10) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@10) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |774|
...
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (this@@23 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@23 null)) (not true)) ($Is refType this@@23 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (and (= $o@@11 this@@23) (= $f@@1 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@11) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@11) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |779|
...
(assert (forall (($h@@11 T@U) ($o@@13 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass._module.Object?))) ($Is MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) _module.Object.fields)) (TMap (TSeq TChar) Tclass._module.Object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |742|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@11 $o@@13) _module.Object.fields)))
)))
(assert (forall (($h@@12 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@12) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass._module.Object?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) alloc)))) ($IsAlloc MapType ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) _module.Object.fields)) (TMap (TSeq TChar) Tclass._module.Object) $h@@12))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |743|
 :pattern ( ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@12 $o@@14) _module.Object.fields)))
)))
(assert (forall (($h0@@3 T@U) ($h1@@3 T@U) (this@@25 T@U) (|os#0@@4| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@3) ($IsGoodHeap $h1@@3)) (and (or (not (= this@@25 null)) (not true)) ($Is refType this@@25 Tclass._module.Memory))) (or (|_module.Memory.OutgoingReferencesAreInThisHeap#canCall| $h0@@3 this@@25 |os#0@@4|) ($Is SetType |os#0@@4| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@3) ($HeapSucc $h0@@3 $h1@@3))) (=> (forall (($o@@15 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@15 null)) (not true)) (or (or (and (= $o@@15 this@@25) (= $f@@3 _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 this@@25) _module.Memory.objects)) ($Box refType $o@@15))) (|Set#IsMember| |os#0@@4| ($Box refType $o@@15)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@3 $o@@15) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@3 $o@@15) $f@@3)))
 :qid |unknown.0:0|
 :skolemid |862|
...
(assert (forall (($h0@@4 T@U) ($h1@@4 T@U) (this@@30 T@U) (|os#0@@7| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@4) ($IsGoodHeap $h1@@4)) (and (or (not (= this@@30 null)) (not true)) ($Is refType this@@30 Tclass._module.Memory))) (or (|_module.Memory.ObjectsAreValid#canCall| $h0@@4 this@@30 |os#0@@7|) ($Is SetType |os#0@@7| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@4) ($HeapSucc $h0@@4 $h1@@4))) (=> (forall (($o@@16 T@U) ($f@@4 T@U) ) (!  (=> (and (or (not (= $o@@16 null)) (not true)) (|Set#IsMember| |os#0@@7| ($Box refType $o@@16))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@4 $o@@16) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@4 $o@@16) $f@@4)))
 :qid |unknown.0:0|
 :skolemid |851|
...
(assert (forall (($h0@@5 T@U) ($h1@@5 T@U) (this@@31 T@U) (|os#0@@8| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@5) ($IsGoodHeap $h1@@5)) (and (or (not (= this@@31 null)) (not true)) ($Is refType this@@31 Tclass._module.Memory))) (or (|_module.Memory.wholeEnchilada#canCall| $h0@@5 this@@31 |os#0@@8|) ($Is SetType |os#0@@8| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@5) ($HeapSucc $h0@@5 $h1@@5))) (=> (forall (($o@@17 T@U) ($f@@5 T@U) ) (!  (=> (and (or (not (= $o@@17 null)) (not true)) (|Set#IsMember| |os#0@@8| ($Box refType $o@@17))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@5 $o@@17) $f@@5) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@5 $o@@17) $f@@5)))
 :qid |unknown.0:0|
 :skolemid |926|
...
(assert (forall (($h0@@8 T@U) ($h1@@8 T@U) (this@@35 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@8) ($IsGoodHeap $h1@@8)) (and (or (not (= this@@35 null)) (not true)) ($Is refType this@@35 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@8) ($HeapSucc $h0@@8 $h1@@8))) (=> (forall (($o@@20 T@U) ($f@@8 T@U) ) (!  (=> (and (or (not (= $o@@20 null)) (not true)) (and (= $o@@20 this@@35) (= $f@@8 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@8 $o@@20) $f@@8) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@8 $o@@20) $f@@8)))
 :qid |unknown.0:0|
 :skolemid |750|
...
(assert (forall ((a@@9 T@U) (b@@9 T@U) ) (!  (=> (and (_module.Region.Frozen_q a@@9) (_module.Region.Frozen_q b@@9)) (|_module.Region#Equal| a@@9 b@@9))
 :qid |unknown.0:0|
 :skolemid |732|
 :pattern ( (|_module.Region#Equal| a@@9 b@@9) (_module.Region.Frozen_q a@@9))
 :pattern ( (|_module.Region#Equal| a@@9 b@@9) (_module.Region.Frozen_q b@@9))
)))
(assert (forall ((a@@10 T@U) (b@@10 T@U) ) (!  (=> (and (_module.Region.Isolate_q a@@10) (_module.Region.Isolate_q b@@10)) (|_module.Region#Equal| a@@10 b@@10))
 :qid |unknown.0:0|
 :skolemid |736|
 :pattern ( (|_module.Region#Equal| a@@10 b@@10) (_module.Region.Isolate_q a@@10))
 :pattern ( (|_module.Region#Equal| a@@10 b@@10) (_module.Region.Isolate_q b@@10))
)))
...
(assert (forall (($h0@@10 T@U) ($h1@@10 T@U) (this@@38 T@U) (|os#0@@13| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@10) ($IsGoodHeap $h1@@10)) (and (or (not (= this@@38 null)) (not true)) ($Is refType this@@38 Tclass._module.Memory))) (or (|_module.Memory.edges#canCall| $h0@@10 this@@38 |os#0@@13|) ($Is SetType |os#0@@13| (TSet Tclass._module.Object)))) (and ($IsHeapAnchor $h0@@10) ($HeapSucc $h0@@10 $h1@@10))) (=> (forall (($o@@22 T@U) ($f@@10 T@U) ) (!  (=> (and (or (not (= $o@@22 null)) (not true)) (|Set#IsMember| |os#0@@13| ($Box refType $o@@22))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@10 $o@@22) $f@@10) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@10 $o@@22) $f@@10)))
 :qid |unknown.0:0|
 :skolemid |914|
...
(assert (forall ((v@@5 T@U) (t0@@4 T@U) (t1@@1 T@U) (h@@5 T@U) ) (! (= ($IsAlloc MapType v@@5 (TMap t0@@4 t1@@1) h@@5) (forall ((bx@@12 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@5) bx@@12) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@5) bx@@12) t1@@1 h@@5) ($IsAllocBox bx@@12 t0@@4 h@@5)))
...
(assert (forall ((|l#0@@6| T@U) (|l#1@@6| T@U) (|l#2@@2| T@U) (|l#3@@0| Bool) ($o@@23 T@U) ($f@@11 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@6| |l#1@@6| |l#2@@2| |l#3@@0|) $o@@23 $f@@11))  (=> (and (or (not (= $o@@23 |l#0@@6|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@6| $o@@23) |l#2@@2|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1406|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@6| |l#1@@6| |l#2@@2| |l#3@@0|) $o@@23 $f@@11))
)))
...
(assert (forall ((a@@11 T@U) (b@@11 T@U) ) (! (= (|Set#Equal| a@@11 b@@11) (forall ((o@@2 T@U) ) (! (= (|Set#IsMember| a@@11 o@@2) (|Set#IsMember| b@@11 o@@2))
...
(assert (forall ((|l#0@@7| T@U) (|l#1@@7| T@U) (|l#2@@3| T@U) (|l#3@@1| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|$y#0@@3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@1| |l#4| |l#5| |l#6| |l#7| |l#8| |l#9| |l#10|) |$y#0@@3|)) (exists ((|o#0@@10| T@U) (|n#0@@1| T@U) ) (!  (and (and (and ($Is refType |o#0@@10| |l#0@@7|) ($Is SeqType |n#0@@1| |l#1@@7|)) (and (|Set#IsMember| |l#2@@3| ($Box refType |o#0@@10|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3@@1| |o#0@@10|) |l#4|))) ($Box SeqType |n#0@@1|)))) (= |$y#0@@3| ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@10| |n#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#5| |o#0@@10|) |l#6|))) ($Box SeqType |n#0@@1|)))))))
...
(declare-fun this.objects@0 () T@U)
(declare-fun this@@53 () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $Heap@1 () T@U)
(declare-fun reveal__module.Memory.Valid () Bool)
(set-info :boogie-vc-id Impl$$_module.Memory.__ctor)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@21 alloc false)) (= this.objects@0 (Lit SetType |Set#Empty|))) (=> (and (and (or (not (= this@@53 null)) (not true)) ($Is refType this@@53 Tclass._module.Memory?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) alloc))))) (=> (and (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) _module.Memory.objects)) this.objects@0) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (= $Heap@0 $Heap@1) reveal__module.Memory.Valid))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (_module.Memory.Valid reveal__module.Memory.Valid $Heap@1 this@@53)) (=> (_module.Memory.Valid reveal__module.Memory.Valid $Heap@1 this@@53) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (or (not (= this@@53 null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) alloc)))))) (=> (and (or (not (= this@@53 null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@21 this@@53) alloc))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@53) _module.Memory.objects)) |Set#Empty|)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@21) ($IsHeapAnchor $Heap@@21)) (and (= 8 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct)))
