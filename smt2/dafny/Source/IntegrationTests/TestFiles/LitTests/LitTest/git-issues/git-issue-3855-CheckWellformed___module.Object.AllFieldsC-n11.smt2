...
(set-info :boogie-vc-id CheckWellformed$$_module.Object.AllFieldsContentsConsistentWithTheirDeclaration)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (= (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@1 this@@1) (forall ((|n#2| T@U) ) (!  (=> (and ($Is SeqType |n#2| (TSeq TChar)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#2|))) (_module.__default.AssignmentCompatible ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#2|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@1)) ($Box SeqType |n#2|)))))
 :qid |gitissue3855dfy.128:14|
 :skolemid |789|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@1)) ($Box SeqType |n#2|))))
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#2|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#2|)))
))) (=> (and (forall ((|n#2@@0| T@U) ) (!  (=> ($Is SeqType |n#2@@0| (TSeq TChar)) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#2@@0|)) (|_module.__default.AssignmentCompatible#canCall| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#2@@0|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@1)) ($Box SeqType |n#2@@0|))))))
 :qid |gitissue3855dfy.128:14|
 :skolemid |790|
 :pattern ( ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@1)) ($Box SeqType |n#2@@0|))))
 :pattern ( ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#2@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#2@@0|)))
)) ($Is boolType (bool_2_U (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $Heap@@1 this@@1)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|)))))))
(let ((anon10_Else_correct  (=> (and (and (not (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#1@0|))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 9) 3))) anon6_correct)))
(let ((anon10_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#1@0|)) (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Object.fields)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#1@0|))) (=> (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#1@0|)) (=> (and (= |##o#0@0| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#1@0|)))) ($IsAlloc refType |##o#0@0| Tclass._module.Object $Heap@@1)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes this@@1)) ($Box SeqType |n#1@0|))) (=> (|Set#IsMember| (|Map#Domain| (_module.Object.fieldModes this@@1)) ($Box SeqType |n#1@0|)) (=> (and (= |##t#0@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@1)) ($Box SeqType |n#1@0|)))) ($IsAlloc DatatypeTypeType |##t#0@0| Tclass._module.Mode $Heap@@1)) (=> (and (and (|_module.__default.AssignmentCompatible#canCall| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Object.fields))) ($Box SeqType |n#1@0|))) ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| (_module.Object.fieldModes this@@1)) ($Box SeqType |n#1@0|)))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon6_correct))))))))))
(let ((anon9_Then_correct  (=> (and (and ($Is SeqType |n#1@0| (TSeq TChar)) ($IsAlloc SeqType |n#1@0| (TSeq TChar) $Heap@@1)) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Object.fields)))) (and (=> (= (ControlFlow 0 10) 6) anon10_Then_correct) (=> (= (ControlFlow 0 10) 9) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (and (not (and ($Is SeqType |n#1@0| (TSeq TChar)) ($IsAlloc SeqType |n#1@0| (TSeq TChar) $Heap@@1))) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 5) 3))) anon6_correct)))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#4| null $Heap@@1 alloc this@@1 _module.Object.fields)) (=> (and (and ($IsAllocBox ($Box refType this@@1) Tclass._module.Object? $Heap@@1) (= |b$reqreads#0@0| (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@8) alloc)))) (and (= $o@@8 this@@1) (= $f@@0 _module.Object.fields))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@8 $f@@0)))
 :qid |gitissue3855dfy.125:14|
 :skolemid |786|
)))) (and (|_module.Object.AllFieldsAreDeclared#canCall| $Heap@@1 this@@1) (_module.Object.AllFieldsAreDeclared $Heap@@1 this@@1))) (and (=> (= (ControlFlow 0 11) (- 0 13)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= this@@1 null)) (not true))) (=> (or (not (= this@@1 null)) (not true)) (and (and (=> (= (ControlFlow 0 11) 1) anon8_Then_correct) (=> (= (ControlFlow 0 11) 10) anon9_Then_correct)) (=> (= (ControlFlow 0 11) 5) anon9_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Object) ($IsAlloc refType this@@1 Tclass._module.Object $Heap@@1))) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 14) 11))) anon0_correct))))
