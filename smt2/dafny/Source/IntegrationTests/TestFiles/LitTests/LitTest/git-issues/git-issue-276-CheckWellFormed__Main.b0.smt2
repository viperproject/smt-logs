...
(declare-fun Main.__default.BIG () Int)
...
(assert (= Main.__default.BIG (LitInt (Mul (LitInt (Mul (LitInt (Mul (LitInt 16) (LitInt 4))) (LitInt (- (+ (- 0 2) 8) 2)))) (LitInt 10)))))
(assert  (=> (< 0 $FunctionContextHeight) ($Is intType (int_2_U Main.__default.BIG) TInt)))
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (< 0 Main.__default.BIG)))))
