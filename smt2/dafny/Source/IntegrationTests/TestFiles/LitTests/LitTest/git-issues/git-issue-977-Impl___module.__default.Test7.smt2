...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_correct  (=> (and (and (and (= |##n#2@0| (ite (< |n#0@@5| 0) 0 |n#0@@5|)) ($IsAlloc intType (int_2_U |##n#2@0|) Tclass._System.nat $Heap@0)) (and (|_module.__default.ToNumber#canCall| (ite (< |n#0@@5| 0) 0 |n#0@@5|)) (= |##n#1@0| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))))) (and (and ($IsAlloc DatatypeTypeType |##n#1@0| Tclass._module.Number $Heap@0) (|_module.__default.RicochetNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|)))) (and (|_module.__default.ToNumber#canCall| (ite (< |n#0@@5| 0) 0 |n#0@@5|)) (|_module.__default.RicochetNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.RicochetNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (or (_module.__default.RicochetNat |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (=> (|_module.__default.GreatestPredNat_h#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (or (_module.__default.GreatestPredNat_h ($LS $LZ) |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (=> (< 0 |k#0@@4|) (=> (_module.Number.Succ_q (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (let ((|prev#0@@0| (_module.Number.prev (_module.__default.ToNumber ($LS ($LS $LZ)) (ite (< |n#0@@5| 0) 0 |n#0@@5|)))))
(_module.__default.GreatestPredNat_h ($LS ($LS $LZ)) (- |k#0@@4| 1) |prev#0@@0|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.RicochetNat#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (or (_module.__default.RicochetNat |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (=> (|_module.__default.GreatestPredNat_h#canCall| |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (or (_module.__default.GreatestPredNat_h ($LS $LZ) |k#0@@4| (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|))) (=> (< 0 |k#0@@4|) (=> (not (_module.Number.Succ_q (_module.__default.ToNumber ($LS $LZ) (ite (< |n#0@@5| 0) 0 |n#0@@5|)))) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))
