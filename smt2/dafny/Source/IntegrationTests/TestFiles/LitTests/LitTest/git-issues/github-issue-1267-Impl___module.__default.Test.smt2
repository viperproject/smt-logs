...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |tuple0#0@0| (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 10))) ($Box intType (int_2_U (LitInt 300)))))) (= |tuple1#0@0| (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 10))) ($Box intType (int_2_U (LitInt 300))))))) (=> (and (and (|$IsA#_System.Tuple2| |tuple0#0@0|) (|$IsA#_System.Tuple2| |tuple1#0@0|)) (= (ControlFlow 0 2) (- 0 1))) (|_System.Tuple2#Equal| |tuple0#0@0| |tuple1#0@0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |tuple0#0| (Tclass._System.Tuple2 TInt TInt)) ($IsAlloc DatatypeTypeType |tuple0#0| (Tclass._System.Tuple2 TInt TInt) $Heap)) true) (=> (and (and (and ($Is DatatypeTypeType |tuple1#0| (Tclass._System.Tuple2 TInt TInt)) ($IsAlloc DatatypeTypeType |tuple1#0| (Tclass._System.Tuple2 TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
