...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 3))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 2)) (<= (LitInt 2) (|Seq#Length| |s#0@0|)))) (=> (and (<= 0 (LitInt 2)) (<= (LitInt 2) (|Seq#Length| |s#0@0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= (LitInt 2) (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@0|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) true) (=> (and (and (and ($Is SeqType |a#0| (TSeq TInt)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))))
