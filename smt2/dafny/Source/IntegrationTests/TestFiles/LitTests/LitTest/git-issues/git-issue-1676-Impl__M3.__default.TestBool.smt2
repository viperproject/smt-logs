...
(declare-fun Tagclass.M3.MyBool () T@U)
(declare-fun tytagFamily$MyBool () T@U)
...
(declare-fun Tclass.M3.MyBool () T@U)
...
(assert (distinct TBool TagBool TagMultiSet alloc Tagclass.M3.MyBool tytagFamily$MyBool)
)
(assert (= (Tag TBool) TagBool))
(assert (forall ((|b#0| T@U) ($h T@U) ) (! ($IsAlloc boolType |b#0| Tclass.M3.MyBool $h)
 :qid |unknown.0:0|
 :skolemid |2034|
 :pattern ( ($IsAlloc boolType |b#0| Tclass.M3.MyBool $h))
)))
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass.M3.MyBool) (and (= ($Box boolType ($Unbox boolType bx)) bx) ($Is boolType ($Unbox boolType bx) Tclass.M3.MyBool)))
 :qid |unknown.0:0|
 :skolemid |2002|
 :pattern ( ($IsBox bx Tclass.M3.MyBool))
)))
...
(assert (forall ((|b#0@@0| T@U) ) (! (= ($Is boolType |b#0@@0| Tclass.M3.MyBool)  (not (U_2_bool |b#0@@0|)))
 :qid |unknown.0:0|
 :skolemid |2033|
 :pattern ( ($Is boolType |b#0@@0| Tclass.M3.MyBool))
)))
...
(assert (= (Tag Tclass.M3.MyBool) Tagclass.M3.MyBool))
(assert (= (TagFamily Tclass.M3.MyBool) tytagFamily$MyBool))
...
(declare-fun |x0#0| () Bool)
(declare-fun |x1#0| () Bool)
...
(set-info :boogie-vc-id Impl$$M3.__default.TestBool)
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is MultiSetType (|MultiSet#Union| |s1#0@0| |s0#0@0|) (TMultiSet Tclass.M3.MyBool)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is MultiSetType (|MultiSet#Union| |s0#0@0| |s1#0@0|) (TMultiSet Tclass.M3.MyBool)))))
(let ((anon9_Then_correct true))
(let ((anon8_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |s0#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box boolType (bool_2_U |x0#0|)))) (= |s1#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| ($Box boolType (bool_2_U |x1#0|))))) (and (and (and (and (and (and (=> (= (ControlFlow 0 11) 1) anon8_Then_correct) (=> (= (ControlFlow 0 11) 2) anon9_Then_correct)) (=> (= (ControlFlow 0 11) 4) anon10_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon11_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon12_Then_correct)) (=> (= (ControlFlow 0 11) 8) anon13_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon13_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (not |x1#0|)) (and (and ($Is MultiSetType |s0#0| (TMultiSet TBool)) ($IsAlloc MultiSetType |s0#0| (TMultiSet TBool) $Heap)) true)) (=> (and (and (and (and (and ($Is MultiSetType |s1#0| (TMultiSet Tclass.M3.MyBool)) ($IsAlloc MultiSetType |s1#0| (TMultiSet Tclass.M3.MyBool) $Heap)) true) (and (and ($Is MultiSetType |a#0_0| (TMultiSet TBool)) ($IsAlloc MultiSetType |a#0_0| (TMultiSet TBool) $Heap)) true)) (and (and (and ($Is MultiSetType |a#1_0| (TMultiSet TBool)) ($IsAlloc MultiSetType |a#1_0| (TMultiSet TBool) $Heap)) true) (and (and ($Is MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyBool)) ($IsAlloc MultiSetType |a#2_0| (TMultiSet Tclass.M3.MyBool) $Heap)) true))) (and (and (and (and ($Is MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyBool)) ($IsAlloc MultiSetType |a#3_0| (TMultiSet Tclass.M3.MyBool) $Heap)) true) (and (and ($Is MultiSetType |a#4_0| (TMultiSet TBool)) ($IsAlloc MultiSetType |a#4_0| (TMultiSet TBool) $Heap)) true)) (and (and (and ($Is MultiSetType |a#5_0| (TMultiSet TBool)) ($IsAlloc MultiSetType |a#5_0| (TMultiSet TBool) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))))) anon0_correct))))
