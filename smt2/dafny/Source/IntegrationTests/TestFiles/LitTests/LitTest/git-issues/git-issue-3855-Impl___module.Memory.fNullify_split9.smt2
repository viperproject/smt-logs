...
(set-info :boogie-vc-id Impl$$_module.Memory.fNullify_split9)
...
)))) (and (and (and (forall ((|i#1@@0| T@U) ) (!  (=> (and ($Is refType |i#1@@0| Tclass._module.Object) (|Set#IsMember| |xisos#0@0| ($Box refType |i#1@@0|))) (>= (_module.Memory.refCountEdges this@@53 |i#1@@0| |xedges#0@0|) (_module.Memory.refCountEdges this@@53 |i#1@@0| |zedges#0@0|)))
 :qid |gitissue3855dfy.549:15|
 :skolemid |1151|
...
)) (= $Heap@2 $Heap@3)) (and ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3) ($IsAlloc SetType |xedges#0@0| (TSet Tclass._module.Edge) $Heap@3))) (and (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |xedges#0@0|) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |xedges#0@0|)) (and (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |xedges#0@0|) ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3))))) (and (and (and (and ($IsAlloc SetType |zedges#0@0| (TSet Tclass._module.Edge) $Heap@3) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|)) (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|) (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |zedges#0@0|))) (and (and ($IsAllocBox ($Box refType this@@53) Tclass._module.Memory? $Heap@3) ($IsAlloc SetType |zedges#0@0| (TSet Tclass._module.Edge) $Heap@3)) (and (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@53 |zedges#0@0|)))) (and (and (and (_module.Memory.heapExternalsZeroOrOneEdges this@@53 |zedges#0@0|) (= call0formal@previous$Heap@0 $Heap@@23)) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))) (and (and (= $Heap@3 $Heap@4) reveal__module.Memory.Valid2) (and (forall (($o@@25 T@U) ($f@@13 T@U) ) (!  (=> (or (not (= $o@@25 null)) (not true)) (=> (and (= $o@@25 this@@53) (or (= $f@@13 _module.Memory.objects) (= $f@@13 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@25) $f@@13) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@23 $o@@25) $f@@13))))
