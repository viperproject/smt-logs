...
(declare-fun Tagclass.A.Result () T@U)
(declare-fun Tagclass.A.EvenGood__OddBad? () T@U)
(declare-fun Tagclass.A.EvenGood__OddBad () T@U)
(declare-fun class.A.EvenGood__OddBad? () T@U)
(declare-fun |##A.Result.Good| () T@U)
(declare-fun |##A.Result.Bad| () T@U)
...
(declare-fun A.Result.Good_q (T@U) Bool)
(declare-fun DatatypeCtorId (T@U) T@U)
(declare-fun A.Result.Bad_q (T@U) Bool)
(declare-fun $Box (T@T T@U) T@U)
(declare-fun |#A.Result.Good| (Int) T@U)
(declare-fun |#A.Result.Bad| (T@U) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun MapType1Select (T@T T@T T@T T@U T@U T@U) T@U)
(declare-fun |lambda#2| (T@U T@U T@U T@U) T@U)
(declare-fun MapType1Store (T@T T@T T@T T@U T@U T@U T@U) T@U)
(declare-fun DatatypeTypeType () T@T)
(declare-fun Tclass.A.Result () T@U)
(declare-fun DeclType (T@U) T@U)
(declare-fun A.Result.x (T@U) Int)
(declare-fun A.Result.c (T@U) T@U)
...
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass.A.EvenGood__OddBad?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) A.EvenGood__OddBad.a)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |493|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) A.EvenGood__OddBad.a)))
)))
...
(assert (= (TagFamily Tclass.A.Result) tytagFamily$Result))
...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$A.EvenGood__OddBad.PropagateFailure)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@0 alloc this@@1)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@1 A.EvenGood__OddBad.a)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.A.EvenGood__OddBad) ($IsAlloc refType this@@1 Tclass.A.EvenGood__OddBad $Heap@@0)))) (=> (and (and (and ($Is DatatypeTypeType |r#0| Tclass.A.Result) ($IsAlloc DatatypeTypeType |r#0| Tclass.A.Result $Heap@@0)) (= 2 $FunctionContextHeight)) (and (and (|A.EvenGood__OddBad.IsFailure#canCall| $Heap@@0 this@@1) (and (A.EvenGood__OddBad.IsFailure $Heap@@0 this@@1) (= (Mod (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) A.EvenGood__OddBad.a))) (LitInt 2)) (LitInt 1)))) (= (ControlFlow 0 3) 2))) anon0_correct))))
