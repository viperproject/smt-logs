...
(set-info :boogie-vc-id Impl$$M0.__default.N0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|c#3| T@U) ) (!  (=> (and ($Is refType |c#3| Tclass.M0.Cell) ($IsAlloc refType |c#3| Tclass.M0.Cell $Heap@0)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#3|) M0.Cell.y))) (LitInt 8)))
 :qid |gitissue19bdfy.64:19|
 :skolemid |532|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#3|) M0.Cell.y)))
)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (=> |defass#o#0| (and ($Is refType |o#0| Tclass.M0.Cell) ($IsAlloc refType |o#0| Tclass.M0.Cell $Heap))) true) (= 2 $FunctionContextHeight)) (and (forall ((|c#1| T@U) ) (!  (=> (and ($Is refType |c#1| Tclass.M0.Cell) ($IsAlloc refType |c#1| Tclass.M0.Cell $Heap)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#1|) M0.Cell.y))) (LitInt 8)))
 :qid |gitissue19bdfy.61:21|
 :skolemid |528|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#1|) M0.Cell.y)))
