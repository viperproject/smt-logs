...
(set-info :boogie-vc-id Impl$$_module.__default.FibSum)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap@@2 $Heap@0)) (and (forall ((|$ih#n0#0| Int) ) (!  (=> (and (and (<= (LitInt 0) |$ih#n0#0|) (U_2_bool (Lit boolType (bool_2_U true)))) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@7|))) (= (_module.__default.Sum ($LS $LZ) |$ih#n0#0| (|_module.__default.Fib#Handle| ($LS $LZ))) (- (_module.__default.Fib ($LS $LZ) (+ |$ih#n0#0| 2)) (_module.__default.Fib ($LS $LZ) (LitInt 1)))))
 :qid |gitissue1250dfy.29:14|
 :skolemid |551|
 :pattern ( (_module.__default.Sum ($LS $LZ) |$ih#n0#0| (|_module.__default.Fib#Handle| ($LS $LZ))))
)) (= (ControlFlow 0 2) (- 0 1)))) (= (_module.__default.Sum ($LS ($LS $LZ)) |n#0@@7| (|_module.__default.Fib#Handle| ($LS ($LS $LZ)))) (- (_module.__default.Fib ($LS ($LS $LZ)) (+ |n#0@@7| 2)) (_module.__default.Fib ($LS ($LS $LZ)) (LitInt 1))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (<= (LitInt 0) |n#0@@7|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
