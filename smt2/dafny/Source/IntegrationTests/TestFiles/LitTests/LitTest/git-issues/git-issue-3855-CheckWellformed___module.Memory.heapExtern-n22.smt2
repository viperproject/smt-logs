...
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.heapExternalsZeroOrOne)
...
(assert (not
 ...
 :qid |gitissue3855dfy.276:18|
 :skolemid |938|
)))) (=> (and (and (|_module.Memory.edges#canCall| $Heap@@5 this@@16 |os#0@@3|) (= |let#0#0#0| (_module.Memory.edges $Heap@@5 this@@16 |os#0@@3|))) (and (|_module.Memory.edges#canCall| $Heap@@5 this@@16 |os#0@@3|) ($Is SetType |let#0#0#0| (TSet Tclass._module.Edge)))) (=> (and (and (and (= |edges#Z#0@0| |let#0#0#0|) ($IsAllocBox ($Box refType this@@16) Tclass._module.Memory? $Heap@@5)) (and ($IsAlloc SetType |edges#Z#0@0| (TSet Tclass._module.Edge) $Heap@@5) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@16 |edges#Z#0@0|))) (and (and (= (_module.Memory.heapExternalsZeroOrOne $Heap@@5 this@@16 |os#0@@3|) (_module.Memory.heapExternalsZeroOrOneEdges this@@16 |edges#Z#0@0|)) (|_module.Memory.heapExternalsZeroOrOneEdges#canCall| this@@16 |edges#Z#0@0|)) (and ($Is boolType (bool_2_U (_module.Memory.heapExternalsZeroOrOne $Heap@@5 this@@16 |os#0@@3|)) TBool) (= (ControlFlow 0 3) (- 0 2))))) |b$reqreads#0@0|))))))
