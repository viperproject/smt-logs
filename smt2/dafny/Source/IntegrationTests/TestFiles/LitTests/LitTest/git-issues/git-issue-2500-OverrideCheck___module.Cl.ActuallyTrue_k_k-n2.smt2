...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|_module.Cl.ActuallyTrue_k_k#canCall| this@@0) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.Cl)))) (_module.Cl.ActuallyTrue_k_k this@@0))
...
(assert (forall ((this@@1 T@U) ) (!  (=> (or (|M.Top.ActuallyTrue#canCall| this@@1) (and (< 1 $FunctionContextHeight) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass.M.Top)))) (M.Top.ActuallyTrue this@@1))
 :qid |gitissue2500dfy.6:15|
 :skolemid |2288|
 :pattern ( (M.Top.ActuallyTrue this@@1))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@2 T@U) ) (!  (=> (or (|_module.Cl.ActuallyTrue#canCall| this@@2) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.Cl)))) (= (_module.Cl.ActuallyTrue this@@2) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |gitissue2500dfy.27:13|
 :skolemid |2256|
 :pattern ( (_module.Cl.ActuallyTrue this@@2))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@3 T@U) ) (!  (=> (or (|_module.Cl.ActuallyTrue#canCall| this@@3) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@3 null)) (not true)) ($Is refType this@@3 Tclass._module.Cl)))) (= (M.Top.ActuallyTrue this@@3) (_module.Cl.ActuallyTrue this@@3)))
 :qid |gitissue2500dfy.6:15|
 :skolemid |2258|
 :pattern ( (M.Top.ActuallyTrue this@@3) ($Is refType this@@3 Tclass._module.Cl))
 :pattern ( (M.Top.ActuallyTrue this@@3) (_module.Cl.ActuallyTrue this@@3))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@4 T@U) ) (!  (=> (or (|_module.Cl.ActuallyTrue_k_k#canCall| this@@4) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@4 null)) (not true)) ($Is refType this@@4 Tclass._module.Cl)))) (= (_module.Cl.ActuallyTrue_k_k this@@4) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |gitissue2500dfy.33:13|
 :skolemid |2268|
 :pattern ( (_module.Cl.ActuallyTrue_k_k this@@4))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@5 T@U) ) (!  (=> (or (|_module.Cl.ActuallyTrue#canCall| (Lit refType this@@5)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Cl)))) (= (_module.Cl.ActuallyTrue (Lit refType this@@5)) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |gitissue2500dfy.27:13|
 :weight 3
 :skolemid |2257|
 :pattern ( (_module.Cl.ActuallyTrue (Lit refType this@@5)))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@6 T@U) ) (!  (=> (or (|_module.Cl.ActuallyTrue_k_k#canCall| (Lit refType this@@6)) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@6 null)) (not true)) ($Is refType this@@6 Tclass._module.Cl)))) (= (_module.Cl.ActuallyTrue_k_k (Lit refType this@@6)) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |gitissue2500dfy.33:13|
 :weight 3
 :skolemid |2269|
 :pattern ( (_module.Cl.ActuallyTrue_k_k (Lit refType this@@6)))
))))
(push 1)
...
(set-info :boogie-vc-id OverrideCheck$$_module.Cl.ActuallyTrue_k_k)
...
(assert (not
 ...
 :qid |gitissue2500dfy.33:13|
 :skolemid |2271|
)) (=> (and (_module.Cl.ActuallyTrue_k_k this@@7) (= (ControlFlow 0 2) (- 0 1))) (let ((|alsoThis#0| this@@7))
(M.Top.ActuallyTrue |alsoThis#0|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@7 null)) (not true)) (and ($Is refType this@@7 Tclass._module.Cl) ($IsAlloc refType this@@7 Tclass._module.Cl $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
