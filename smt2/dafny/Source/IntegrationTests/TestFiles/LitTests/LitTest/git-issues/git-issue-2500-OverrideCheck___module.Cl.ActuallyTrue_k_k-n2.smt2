...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (=> (= Cl_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@10 T@U) ($f@@0 T@U) ) true)) (=> (forall (($o@@11 T@U) ($f@@1 T@U) ) true) (=> (and (_module.Cl.ActuallyTrue_k_k this@@7) (= (ControlFlow 0 2) (- 0 1))) (let ((|alsoThis#0| this@@7))
