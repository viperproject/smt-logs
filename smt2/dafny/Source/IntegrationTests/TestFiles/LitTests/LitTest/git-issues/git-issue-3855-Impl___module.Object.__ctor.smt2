...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.Object))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@5 T@U) ($f T@U) )  (=> (and (or (not (= $o@@5 null)) (not true)) (and (= $o@@5 this@@0) (= $f _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@5) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@5) $f)))) (= (_module.Object.AllFieldsAreDeclared $h0 this@@0) (_module.Object.AllFieldsAreDeclared $h1 this@@0))))
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.Object.AllFieldsAreDeclared $h1 this@@0))
)))
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@1 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@6 null)) (not true)) (and (= $o@@6 this@@1) (= $f@@0 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@6) $f@@0)))) (= (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $h0@@0 this@@1) (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $h1@@0 this@@1))))
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (_module.Object.AllFieldsContentsConsistentWithTheirDeclaration $h1@@0 this@@1))
)))
(assert (forall (($h0@@1 T@U) ($h1@@1 T@U) (this@@2 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@1) ($IsGoodHeap $h1@@1)) (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@1) ($HeapSucc $h0@@1 $h1@@1))) (=> (forall (($o@@7 T@U) ($f@@1 T@U) )  (=> (and (or (not (= $o@@7 null)) (not true)) (and (= $o@@7 this@@2) (= $f@@1 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@1 $o@@7) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@1 $o@@7) $f@@1)))) (= (_module.Object.AllOutgoingReferencesAreVenice $h0@@1 this@@2) (_module.Object.AllOutgoingReferencesAreVenice $h1@@1 this@@2))))
...
(assert (forall (($reveal Bool) ($h0@@2 T@U) ($h1@@2 T@U) (this@@5 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@2) ($IsGoodHeap $h1@@2)) (and (or (not (= this@@5 null)) (not true)) ($Is refType this@@5 Tclass._module.Object))) (and ($IsHeapAnchor $h0@@2) ($HeapSucc $h0@@2 $h1@@2))) (=> (forall (($o@@11 T@U) ($f@@3 T@U) )  (=> (and (or (not (= $o@@11 null)) (not true)) (and (= $o@@11 this@@5) (= $f@@3 _module.Object.fields))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@2 $o@@11) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@2 $o@@11) $f@@3)))) (= (_module.Object.Valid $reveal $h0@@2 this@@5) (_module.Object.Valid $reveal $h1@@2 this@@5))))
