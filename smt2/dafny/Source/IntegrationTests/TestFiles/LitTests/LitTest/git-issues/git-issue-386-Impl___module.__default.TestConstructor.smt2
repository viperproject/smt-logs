...
(assert (distinct TBool TagBool TagSet alloc Tagclass._module.Foo Tagclass._module.Foo? tytagFamily$Foo)
)
...
(assert (forall (($o T@U) ) (! (= ($Is refType $o Tclass._module.Foo?)  (or (= $o null) (= (dtype $o) Tclass._module.Foo?)))
 :qid |unknown.0:0|
 :skolemid |490|
 :pattern ( ($Is refType $o Tclass._module.Foo?))
)))
...
(assert (forall (($o@@0 T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass._module.Foo? $h@@0)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |491|
 :pattern ( ($IsAlloc refType $o@@0 Tclass._module.Foo? $h@@0))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestConstructor)
