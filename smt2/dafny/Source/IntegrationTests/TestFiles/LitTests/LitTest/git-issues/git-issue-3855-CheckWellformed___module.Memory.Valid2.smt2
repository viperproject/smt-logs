...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) (|l#5| T@U) (|l#6| T@U) (|l#7| T@U) ($o@@9 T@U) ($f@@1 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#33| |l#0@@0| |l#1@@0| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7|) $o@@9 $f@@1))  (=> (and (or (not (= $o@@9 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@9) |l#2|)))) (or (or (and (= $o@@9 |l#3|) (= $f@@1 |l#4|)) (|Set#IsMember| |l#5| ($Box refType $o@@9))) (and (|Set#IsMember| |l#6| ($Box refType $o@@9)) (= $f@@1 |l#7|)))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1411|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#33| |l#0@@0| |l#1@@0| |l#2| |l#3| |l#4| |l#5| |l#6| |l#7|) $o@@9 $f@@1))
)))
...
(assert (forall ((a@@16 T@U) (b@@13 T@U) (t0@@1 T@U) (t1@@1 T@U) ) (!  (=> (forall ((bx T@U) ) (!  (=> (|Set#IsMember| a@@16 bx) (and ($IsBox bx t0@@1) ($IsBox (MapType0Select BoxType BoxType b@@13 bx) t1@@1)))
 :qid |DafnyPreludebpl.1452:11|
 :skolemid |288|
)) ($Is MapType (|Map#Glue| a@@16 b@@13 (TMap t0@@1 t1@@1)) (TMap t0@@1 t1@@1)))
 :qid |DafnyPreludebpl.1449:15|
 :skolemid |289|
 :pattern ( (|Map#Glue| a@@16 b@@13 (TMap t0@@1 t1@@1)))
)))
...
(assert (forall ((|l#0@@7| T@U) (|l#1@@7| T@U) (|l#2@@3| T@U) (|l#3@@1| T@U) (|l#4@@0| T@U) (|l#5@@0| T@U) (|l#6@@0| T@U) (|l#7@@0| T@U) (|l#8| T@U) (|l#9| T@U) (|l#10| T@U) (|$y#0@@3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#47| |l#0@@7| |l#1@@7| |l#2@@3| |l#3@@1| |l#4@@0| |l#5@@0| |l#6@@0| |l#7@@0| |l#8| |l#9| |l#10|) |$y#0@@3|)) (exists ((|o#0@@11| T@U) (|n#0@@1| T@U) ) (!  (and (and (and ($Is refType |o#0@@11| |l#0@@7|) ($Is SeqType |n#0@@1| |l#1@@7|)) (and (|Set#IsMember| |l#2@@3| ($Box refType |o#0@@11|)) (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#3@@1| |o#0@@11|) |l#4@@0|))) ($Box SeqType |n#0@@1|)))) (= |$y#0@@3| ($Box DatatypeTypeType (|#_module.Edge.Edge| |o#0@@11| |n#0@@1| ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#5@@0| |o#0@@11|) |l#6@@0|))) ($Box SeqType |n#0@@1|)))))))
 ...
 :pattern ( (|Set#IsMember| (|Map#Domain| ($Unbox MapType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#7@@0| |o#0@@11|) |l#8|))) ($Box SeqType |n#0@@1|)))
)))
 :qid |gitissue3855dfy.87:7|
 :skolemid |1416|
...
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.Valid2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (=> (_module.Memory.Valid2 reveal__module.Memory.Valid2 previous$Heap current$Heap this@@60) (_module.Memory.Valid reveal__module.Memory.Valid current$Heap this@@60)))))
(let ((anon10_correct  (=> (= (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@@25 $Heap@0 this@@60)  (and (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@0 this@@60) (_module.Memory.HeapObjectsAreMonotonic $Heap@@25 $Heap@0 this@@60)) (_module.Memory.AllImmutablesAreImmutable $Heap@@25 $Heap@0 this@@60))) (=> (and (and (|_module.Memory.Valid#canCall| $Heap@0 this@@60) (=> (_module.Memory.Valid reveal__module.Memory.Valid $Heap@0 this@@60) (and (|_module.Memory.HeapObjectsAreMonotonic#canCall| $Heap@@25 $Heap@0 this@@60) (=> (_module.Memory.HeapObjectsAreMonotonic $Heap@@25 $Heap@0 this@@60) (|_module.Memory.AllImmutablesAreImmutable#canCall| $Heap@@25 $Heap@0 this@@60))))) ($Is boolType (bool_2_U (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@@25 $Heap@0 this@@60)) TBool)) (and (=> (= (ControlFlow 0 8) (- 0 11)) |b$reqreads#2@0|) (=> |b$reqreads#2@0| (and (=> (= (ControlFlow 0 8) (- 0 10)) |b$reqreads#3@1|) (=> |b$reqreads#3@1| (and (=> (= (ControlFlow 0 8) (- 0 9)) |b$reqreads#4@1|) (=> |b$reqreads#4@1| (=> (= (ControlFlow 0 8) 7) GeneratedUnifiedExit_correct)))))))))))
(let ((anon15_Else_correct  (=> (not (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@0 this@@60) (_module.Memory.HeapObjectsAreMonotonic $Heap@@25 $Heap@0 this@@60))) (=> (and (= |b$reqreads#4@1| true) (= (ControlFlow 0 14) 8)) anon10_correct))))
(let ((anon15_Then_correct  (=> (and (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@0 this@@60) (_module.Memory.HeapObjectsAreMonotonic $Heap@@25 $Heap@0 this@@60)) ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? $Heap@0)) (and (=> (= (ControlFlow 0 12) (- 0 13)) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25)) (=> ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25) (=> (and (and (= |b$reqreads#4@0| (forall (($o@@28 T@U) ($f@@16 T@U) ) (!  (=> (and (and (or (not (= $o@@28 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@28) alloc)))) (or (or (and (= $o@@28 this@@60) (= $f@@16 _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects)) ($Box refType $o@@28))) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects)) ($Box refType $o@@28)) (= $f@@16 _module.Object.fields)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@28 $f@@16)))
 :qid |gitissue3855dfy.201:6|
 :skolemid |850|
))) (|_module.Memory.AllImmutablesAreImmutable#canCall| $Heap@@25 $Heap@0 this@@60)) (and (= |b$reqreads#4@1| |b$reqreads#4@0|) (= (ControlFlow 0 12) 8))) anon10_correct))))))
(let ((anon14_Else_correct  (=> (and (not (_module.Memory.Valid reveal__module.Memory.Valid $Heap@0 this@@60)) (= |b$reqreads#3@1| true)) (and (=> (= (ControlFlow 0 17) 12) anon15_Then_correct) (=> (= (ControlFlow 0 17) 14) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (_module.Memory.Valid reveal__module.Memory.Valid $Heap@0 this@@60) ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? $Heap@0)) (and (=> (= (ControlFlow 0 15) (- 0 16)) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25)) (=> ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25) (=> (= |b$reqreads#3@0| (forall (($o@@29 T@U) ($f@@17 T@U) ) (!  (=> (and (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) alloc)))) (and (= $o@@29 this@@60) (= $f@@17 _module.Memory.objects))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@29 $f@@17)))
 :qid |gitissue3855dfy.199:6|
 :skolemid |849|
))) (=> (and (|_module.Memory.HeapObjectsAreMonotonic#canCall| $Heap@@25 $Heap@0 this@@60) (= |b$reqreads#3@1| |b$reqreads#3@0|)) (and (=> (= (ControlFlow 0 15) 12) anon15_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct)))))))))
(let ((anon12_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= current$Heap $Heap@0)) (and (and reveal__module.Memory.Valid ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? $Heap@0)) (and (= |b$reqreads#2@0| (forall (($o@@30 T@U) ($f@@18 T@U) ) (!  (=> (and (and (or (not (= $o@@30 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) alloc)))) (or (and (= $o@@30 this@@60) (= $f@@18 _module.Memory.objects)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@60) _module.Memory.objects)) ($Box refType $o@@30)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@30 $f@@18)))
 :qid |gitissue3855dfy.197:6|
 :skolemid |848|
))) (|_module.Memory.Valid#canCall| $Heap@0 this@@60)))) (and (=> (= (ControlFlow 0 18) 15) anon14_Then_correct) (=> (= (ControlFlow 0 18) 17) anon14_Else_correct)))))
(let ((anon5_correct true))
(let ((anon13_Else_correct  (=> (and (=> (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@@25 current$Heap this@@60) (_module.Memory.Valid reveal__module.Memory.Valid current$Heap this@@60)) (= (ControlFlow 0 5) 1)) anon5_correct)))
(let ((anon13_Then_correct  (=> ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? current$Heap) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25)) (=> ($IsAlloc refType this@@60 Tclass._module.Memory $Heap@@25) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= this@@60 this@@60) (and (|Set#Subset| (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects))) (|Set#UnionOne| |Set#Empty| ($Box refType this@@60))) (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects))) (|Set#UnionOne| |Set#Empty| ($Box refType this@@60)))) (not (|Set#Subset| (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects))) (|Set#UnionOne| |Set#Empty| ($Box refType this@@60))) (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects))) (|Set#UnionOne| |Set#Empty| ($Box refType this@@60)))))))) (=> (or (= this@@60 this@@60) (and (|Set#Subset| (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects))) (|Set#UnionOne| |Set#Empty| ($Box refType this@@60))) (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects))) (|Set#UnionOne| |Set#Empty| ($Box refType this@@60)))) (not (|Set#Subset| (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects))) (|Set#UnionOne| |Set#Empty| ($Box refType this@@60))) (|Set#Union| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects))) (|Set#UnionOne| |Set#Empty| ($Box refType this@@60))))))) (=> (and (or (= this@@60 this@@60) (|_module.Memory.Valid2#canCall| $Heap@@25 current$Heap this@@60)) (_module.Memory.Valid2 reveal__module.Memory.Valid2 $Heap@@25 current$Heap this@@60)) (=> (and (and ($IsAllocBox ($Box refType this@@60) Tclass._module.Memory? current$Heap) (|_module.Memory.Valid#canCall| current$Heap this@@60)) (and (_module.Memory.Valid reveal__module.Memory.Valid current$Heap this@@60) (= (ControlFlow 0 2) 1))) anon5_correct)))))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#33| null current$Heap alloc this@@60 _module.Memory.objects ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap this@@60) _module.Memory.objects)) _module.Object.fields)) (and (=> (= (ControlFlow 0 19) (- 0 22)) (or (not (= this@@60 null)) (not true))) (=> (or (not (= this@@60 null)) (not true)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@60 _module.Memory.objects))) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@60 _module.Memory.objects)))) (and (=> (= (ControlFlow 0 19) (- 0 21)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 19) (- 0 20)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (and (=> (= (ControlFlow 0 19) 18) anon12_Else_correct) (=> (= (ControlFlow 0 19) 2) anon13_Then_correct)) (=> (= (ControlFlow 0 19) 5) anon13_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@25) ($IsHeapAnchor $Heap@@25)) (=> (and (and (and (or (not (= this@@60 null)) (not true)) (and ($Is refType this@@60 Tclass._module.Memory) ($IsAlloc refType this@@60 Tclass._module.Memory previous$Heap))) (= 8 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@25) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 23) 19))) anon0_correct))))
