...
(assert (forall ((a@@16 T@U) (b@@13 T@U) (t0@@1 T@U) (t1@@1 T@U) ) (!  (=> (forall ((bx T@U) )  (=> (|Set#IsMember| a@@16 bx) (and ($IsBox bx t0@@1) ($IsBox (MapType0Select BoxType BoxType b@@13 bx) t1@@1)))) ($Is MapType (|Map#Glue| a@@16 b@@13 (TMap t0@@1 t1@@1)) (TMap t0@@1 t1@@1)))
