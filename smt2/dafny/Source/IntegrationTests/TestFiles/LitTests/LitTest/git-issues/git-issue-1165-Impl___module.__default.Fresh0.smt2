...
(set-info :boogie-vc-id Impl$$_module.__default.Fresh0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |$rhs#0@0| (|Set#UnionOne| |Set#Empty| ($Box refType |p#0|)))) (and (= |$rhs#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType |p#0|))) (= (ControlFlow 0 2) (- 0 1)))) (and (forall (($o@@4 T@U) ) (!  (=> (and (|Set#IsMember| |$rhs#0@0| ($Box refType $o@@4)) (not (|Set#IsMember| |$rhs#1@0| ($Box refType $o@@4)))) (or (not (= $o@@4 null)) (not true)))
 :qid |gitissue1165dfy.56:11|
 :skolemid |693|
 :pattern (  (or (not (= $o@@4 null)) (not true)))
)) (forall (($o@@5 T@U) ) (!  (=> (and (|Set#IsMember| |$rhs#0@0| ($Box refType $o@@5)) (not (|Set#IsMember| |$rhs#1@0| ($Box refType $o@@5)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@5) alloc)))))
 :qid |gitissue1165dfy.56:11|
 :skolemid |694|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@5) alloc)))
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |p#0| Tclass._module.Cell) ($IsAlloc refType |p#0| Tclass._module.Cell $Heap))) (=> (and (and (and ($Is refType |q#0| Tclass._module.Cell) ($IsAlloc refType |q#0| Tclass._module.Cell $Heap)) (and ($Is SetType |S#0| (TSet Tclass._System.object)) ($IsAlloc SetType |S#0| (TSet Tclass._System.object) $Heap))) (and (and ($Is SetType |T#0| (TSet Tclass._System.object)) ($IsAlloc SetType |T#0| (TSet Tclass._System.object) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
