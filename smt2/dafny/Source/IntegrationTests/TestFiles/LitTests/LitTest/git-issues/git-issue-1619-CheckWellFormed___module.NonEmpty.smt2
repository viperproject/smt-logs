...
(set-info :boogie-vc-id CheckWellFormed$$_module.NonEmpty)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 2) (LitInt 6))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< 6 7))))))))
