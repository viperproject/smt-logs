...
(declare-fun |$let#14$canCall| () Bool)
(declare-fun CompilableExpressions.__default.P (Int) Bool)
(declare-fun |$let#14_x| () Int)
...
(assert  (=> |$let#14$canCall| (CompilableExpressions.__default.P |$let#14_x|)))
...
(declare-fun |y#0| () Int)
(set-info :boogie-vc-id Impl$$CompilableExpressions.__default.M11)
...
(let ((anon13_Else_correct  (=> (or (not (= (ite (= (let ((|x#1| |$let#14_x|))
...
(let ((anon12_Else_correct  (=> (or (not (= (ite (= (let ((|x#1@@0| |$let#14_x|))
...
(let ((anon5_correct  (=> |$let#14$canCall| (and (=> (= (ControlFlow 0 8) 2) anon12_Then_correct) (=> (= (ControlFlow 0 8) 7) anon12_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (or (not (= (let ((|x#1@@1| |$let#14_x|))
|x#1@@1|) (LitInt 0))) (not true)) (= (ControlFlow 0 10) 8)) anon5_correct)))
(let ((anon11_Then_correct  (=> (and (= (let ((|x#1@@2| |$let#14_x|))
|x#1@@2|) (LitInt 0)) (= (ControlFlow 0 9) 8)) anon5_correct)))
(let ((anon10_Then_correct  (=> (and ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap) (|CompilableExpressions.__default.P#canCall| |x#0@0|)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (CompilableExpressions.__default.P (LitInt 0))) (exists ((|x#1@@3| Int) ) (! (CompilableExpressions.__default.P |x#1@@3|)
 :qid |gitissue2640dfy.112:19|
 :skolemid |542|
 ...
 :qid |gitissue2640dfy.112:19|
 :skolemid |542|
))) (=> (CompilableExpressions.__default.P |x#0@0|) (=> (and (|CompilableExpressions.__default.P#canCall| |x#2@0|) (CompilableExpressions.__default.P |x#2@0|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= |x#0@0| |x#2@0|)) (=> (= |x#0@0| |x#2@0|) (=> |$let#14$canCall| (and (=> (= (ControlFlow 0 11) 9) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))))))))
(let ((anon10_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 14) 11) anon10_Then_correct) (=> (= (ControlFlow 0 14) 1) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |c#0| Tclass.CompilableExpressions.Color) ($IsAlloc DatatypeTypeType |c#0| Tclass.CompilableExpressions.Color $Heap)) (|$IsA#CompilableExpressions.Color| |c#0|)) (= 1 $FunctionContextHeight)) (and (CompilableExpressions.__default.P |y#0|) (= (ControlFlow 0 15) 14))) anon0_correct))))
