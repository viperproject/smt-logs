...
(declare-fun |o#0| () T@U)
(set-info :boogie-vc-id Impl$$Example2.__default.MF)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (=> |defass#o#0| (and ($IsBox |o#0@0| Tclass.Example2.R) ($IsAllocBox |o#0@0| Tclass.Example2.R $Heap@@1))) ($IsAlloc intType (int_2_U |v#0|) Tclass._System.nat $Heap@@1)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (exists ((|b#0@@0| T@U) ) (!  (and ($IsBox |b#0@@0| Tclass.Example2.BaseType) (Example2.BaseType.i |b#0@@0|))
 :qid |gitissue1958dfy.49:21|
 :skolemid |1674|
 :pattern ( (Example2.BaseType.i |b#0@@0|))
))) (=> (and (and (exists ((|b#0@@1| T@U) ) (!  (and ($IsBox |b#0@@1| Tclass.Example2.BaseType) (Example2.BaseType.i |b#0@@1|))
 :qid |gitissue1958dfy.49:21|
 :skolemid |1675|
 :pattern ( (Example2.BaseType.i |b#0@@1|))
)) (|Example2.__default.Ctor#canCall| |v#0|)) (and (|Example2.__default.Ctor#canCall| |v#0|) (= |o#0@1| (Example2.__default.Ctor |v#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) true))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (<= (LitInt 0) |v#0|) (=> |defass#r#0| (and ($IsBox |r#0@@1| Tclass.Example2.R) ($IsAllocBox |r#0@@1| Tclass.Example2.R $Heap@@1))))) (and (and (=> |defass#o#0| (and ($IsBox |o#0| Tclass.Example2.R) ($IsAllocBox |o#0| Tclass.Example2.R $Heap@@1))) true) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))
