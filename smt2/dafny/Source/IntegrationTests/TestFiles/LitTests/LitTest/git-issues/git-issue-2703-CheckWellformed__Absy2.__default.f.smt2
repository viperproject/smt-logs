...
(declare-fun |Absy2.__default.f#canCall| () Bool)
(declare-fun Absy2.__default.f () Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |Absy2.__default.f#canCall| (< 0 $FunctionContextHeight)) (= Absy2.__default.f (LitInt (Div 0 (LitInt 0)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |Absy2.__default.f#canCall| (< 0 $FunctionContextHeight)) (= Absy2.__default.f (LitInt (Div 0 (LitInt 0)))))))
...
(set-info :boogie-vc-id CheckWellformed$$Absy2.__default.f)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (not (= (LitInt 0) 0)) (not true)))))
