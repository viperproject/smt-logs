...
(assert (distinct TBool TagBool alloc Tagclass._module.A Tagclass._module.Tr Tagclass._module.B Tagclass._module.A? Tagclass._module.B? Tagclass._module.Tr? tytagFamily$A tytagFamily$Tr tytagFamily$B)
)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|x#0| T@U) ) (!  (=> (or (|_module.__default.test#canCall| (Lit refType |x#0|)) (and (< 1 $FunctionContextHeight) (and ($Is refType |x#0| Tclass._module.Tr) ($Is refType (Lit refType |x#0|) Tclass._module.A)))) (= (_module.__default.test (Lit refType |x#0|)) (ite ($Is refType (Lit refType |x#0|) Tclass._module.B) (= (LitInt (Div 1 (LitInt 0))) (LitInt 0)) true)))
 :qid |gitissue1604dfy.19:15|
 :weight 3
 :skolemid |494|
 :pattern ( (_module.__default.test (Lit refType |x#0|)))
))))
...
(assert (forall ((|c#0| T@U) ) (! (= ($Is refType |c#0| Tclass._module.Tr)  (and ($Is refType |c#0| Tclass._module.Tr?) (or (not (= |c#0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |507|
 :pattern ( ($Is refType |c#0| Tclass._module.Tr))
 :pattern ( ($Is refType |c#0| Tclass._module.Tr?))
)))
...
(assert (forall ((|c#0@@1| T@U) ) (! (= ($Is refType |c#0@@1| Tclass._module.B)  (and ($Is refType |c#0@@1| Tclass._module.B?) (or (not (= |c#0@@1| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |515|
 :pattern ( ($Is refType |c#0@@1| Tclass._module.B))
 :pattern ( ($Is refType |c#0@@1| Tclass._module.B?))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|x#0@@0| T@U) ) (!  (=> (or (|_module.__default.test#canCall| |x#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is refType |x#0@@0| Tclass._module.Tr) ($Is refType |x#0@@0| Tclass._module.A)))) (= (_module.__default.test |x#0@@0|) (ite ($Is refType |x#0@@0| Tclass._module.B) (= (LitInt (Div 1 (LitInt 0))) (LitInt 0)) true)))
 :qid |gitissue1604dfy.19:15|
 :skolemid |493|
...
(assert (forall (($o@@2 T@U) ) (!  (=> ($Is refType $o@@2 Tclass._module.A?) ($Is refType $o@@2 Tclass._module.Tr?))
 :qid |unknown.0:0|
 :skolemid |522|
 :pattern ( ($Is refType $o@@2 Tclass._module.A?))
)))
(assert (forall (($o@@3 T@U) ) (!  (=> ($Is refType $o@@3 Tclass._module.B?) ($Is refType $o@@3 Tclass._module.Tr?))
 :qid |unknown.0:0|
 :skolemid |526|
 :pattern ( ($Is refType $o@@3 Tclass._module.B?))
)))
...
(assert (= (Tag Tclass._module.Tr?) Tagclass._module.Tr?))
(assert (= (TagFamily Tclass._module.Tr?) tytagFamily$Tr))
(assert (forall (($o@@4 T@U) ) (! (= ($Is refType $o@@4 Tclass._module.Tr?)  (or (= $o@@4 null) (implements$_module.Tr (dtype $o@@4))))
 :qid |unknown.0:0|
 :skolemid |505|
 :pattern ( ($Is refType $o@@4 Tclass._module.Tr?))
)))
...
(let ((anon8_Then_correct  (=> (and ($Is refType |x#0@@1| Tclass._module.B) (= (ControlFlow 0 3) (- 0 2))) (or (not (= (LitInt 0) 0)) (not true)))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($Is refType |x#0@@1| Tclass._module.A)) (and (and (=> (= (ControlFlow 0 5) 1) anon7_Then_correct) (=> (= (ControlFlow 0 5) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is refType |x#0@@1| Tclass._module.Tr)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
