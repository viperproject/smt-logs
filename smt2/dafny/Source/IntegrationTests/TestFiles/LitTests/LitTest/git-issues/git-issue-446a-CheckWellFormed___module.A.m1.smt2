...
(set-info :boogie-vc-id CheckWellFormed$$_module.A.m1)
...
(let ((anon7_Else_correct  (=> (=> (<= (LitInt 0) |i#0|) (and (_module.Result.Success_q |r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) |i#0|))) (and (=> (= (ControlFlow 0 5) 1) anon8_Then_correct) (=> (= (ControlFlow 0 5) 2) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (and (<= (LitInt 0) |i#0|) (_module.Result.Success_q |r#0@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.Result.Success_q |r#0@0|)) (=> (_module.Result.Success_q |r#0@0|) (=> (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) |i#0|) (and (=> (= (ControlFlow 0 3) 1) anon8_Then_correct) (=> (= (ControlFlow 0 3) 2) anon8_Else_correct))))))))
