...
(set-info :boogie-vc-id Impl$$_module.__default.MS)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (|_module.MStatus#Equal| |r#0@1| (|#_module.MStatus.Error| (LitInt 5))))))
(let ((anon3_Else_correct  (=> (not (_module.MStatus.IsFailure |call1formal@status#0@0|)) (=> (and (= |r#0@1| |r#0|) (= (ControlFlow 0 5) 2)) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (and (_module.MStatus.IsFailure |call1formal@status#0@0|) ($IsAllocBox ($Box DatatypeTypeType |call1formal@status#0@0|) Tclass._module.MStatus $Heap@0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.MStatus.Error_q |call1formal@status#0@0|)) (=> (and (_module.MStatus.Error_q |call1formal@status#0@0|) (|_module.MStatus.PropagateFailure#canCall| |call1formal@status#0@0|)) (=> (and (and (|_module.MStatus.PropagateFailure#canCall| |call1formal@status#0@0|) (= |r#0@0| (_module.MStatus.PropagateFailure |call1formal@status#0@0|))) (and (= |r#0@1| |r#0@0|) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($Is DatatypeTypeType |r#1@0| Tclass._module.MStatus) ($IsAlloc DatatypeTypeType |r#1@0| Tclass._module.MStatus $Heap)) (and ($Is DatatypeTypeType |valueOrError0#0@0| Tclass._module.MStatus) ($IsAlloc DatatypeTypeType |valueOrError0#0@0| Tclass._module.MStatus $Heap))) (and (and ($Is DatatypeTypeType |call1formal@status#0| Tclass._module.MStatus) ($IsAlloc DatatypeTypeType |call1formal@status#0| Tclass._module.MStatus $Heap)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (=> (and (and (and (and ($Is DatatypeTypeType |call1formal@status#0@0| Tclass._module.MStatus) ($IsAlloc DatatypeTypeType |call1formal@status#0@0| Tclass._module.MStatus $Heap@0)) (|$IsA#_module.MStatus| |call1formal@status#0@0|)) (and (|_module.MStatus#Equal| |call1formal@status#0@0| (|#_module.MStatus.Error| (LitInt 5))) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |gitissue1094dfy.83:8|
 :skolemid |522|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)))) (and (and ($HeapSucc $Heap $Heap@0) ($IsAllocBox ($Box DatatypeTypeType |call1formal@status#0@0|) Tclass._module.MStatus $Heap@0)) (and (|_module.MStatus.IsFailure#canCall| |call1formal@status#0@0|) (|_module.MStatus.IsFailure#canCall| |call1formal@status#0@0|)))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is DatatypeTypeType |r#0| Tclass._module.MStatus) ($IsAlloc DatatypeTypeType |r#0| Tclass._module.MStatus $Heap))) (and (and ($Is DatatypeTypeType |r#1| Tclass._module.MStatus) ($IsAlloc DatatypeTypeType |r#1| Tclass._module.MStatus $Heap)) true)) (and (and (and ($Is DatatypeTypeType |valueOrError0#0| Tclass._module.MStatus) ($IsAlloc DatatypeTypeType |valueOrError0#0| Tclass._module.MStatus $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
