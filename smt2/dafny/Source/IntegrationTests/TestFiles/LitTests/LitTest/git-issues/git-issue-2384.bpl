// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2384.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2384-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/git-issues/git-issue-2384.dfy
...
function _module.T.P(this: ref) : bool;

function _module.T.P#canCall(this: ref) : bool;

function _module.T.P#requires(ref) : bool;

// #requires axiom for _module.T.P
axiom (forall this: ref :: 
  { _module.T.P#requires(this) } 
  this != null && $Is(this, Tclass._module.T())
     ==> _module.T.P#requires(this) == true);
...
function _module.T.F(this: ref) : int;
...
function _module.C.P($heap: Heap, this: ref) : bool;

function _module.C.P#canCall($heap: Heap, this: ref) : bool;

// frame axiom for _module.C.P
axiom (forall $h0: Heap, $h1: Heap, this: ref :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), _module.C.P($h1, this) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && 
      this != null
    ...
    (forall $o: ref, $f: Field :: 
     ...
     ==> _module.C.P($h0, this) == _module.C.P($h1, this));

function _module.C.P#requires(Heap, ref) : bool;

// #requires axiom for _module.C.P
axiom (forall $Heap: Heap, this: ref :: 
  { _module.C.P#requires($Heap, this), $IsGoodHeap($Heap) } 
  $IsGoodHeap($Heap)
       && 
      this != null
       && 
      $Is(this, Tclass._module.C())
       && $IsAlloc(this, Tclass._module.C(), $Heap)
     ==> _module.C.P#requires($Heap, this) == true);

// override axiom for _module.T.P in class _module.C
axiom 0 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, this: ref :: 
    { _module.T.P(this), $Is(this, Tclass._module.C()), $IsGoodHeap($Heap) } 
      { _module.T.P(this), _module.C.P($Heap, this), $IsGoodHeap($Heap) } 
    _module.C.P#canCall($Heap, this)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass._module.C()))
       ==> _module.T.P(this) == _module.C.P($Heap, this));
