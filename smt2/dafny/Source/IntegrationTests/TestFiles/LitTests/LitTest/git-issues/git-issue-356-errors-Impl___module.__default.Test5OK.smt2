...
(set-info :boogie-vc-id Impl$$_module.__default.Test5OK)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is charType |ch#0| TChar) true) (= 0 $FunctionContextHeight)) (and (and (<= (LitReal 0.0) |r#0|) (< |r#0| 65536.0)) (and (= |r#0| (q@Real (q@Int |r#0|))) (= (ControlFlow 0 4) 2)))) anon0_correct))))
