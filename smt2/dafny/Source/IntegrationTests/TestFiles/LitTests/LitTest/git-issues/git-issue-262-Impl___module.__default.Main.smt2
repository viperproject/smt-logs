...
(declare-fun |_module.__default.tst#requires| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|_module.__default.tst#canCall| |x#0@@0|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |x#0@@0|))) (<= (LitInt 0) (_module.__default.tst |x#0@@0|)))
 :qid |gitissue262dfy.4:14|
 :skolemid |479|
 :pattern ( (_module.__default.tst |x#0@@0|))
))))
...
(assert (forall (($heap T@U) (|$fh$0x#0| T@U) ) (! (= (Requires1 Tclass._System.nat Tclass._System.nat $heap |_module.__default.tst#Handle| |$fh$0x#0|) (|_module.__default.tst#requires| (U_2_int ($Unbox intType |$fh$0x#0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |487|
 :pattern ( (Requires1 Tclass._System.nat Tclass._System.nat $heap |_module.__default.tst#Handle| |$fh$0x#0|))
)))
(assert (forall ((|x#0@@1| Int) ) (!  (=> (<= (LitInt 0) |x#0@@1|) (= (|_module.__default.tst#requires| |x#0@@1|) true))
 :qid |gitissue262dfy.4:14|
 :skolemid |480|
 :pattern ( (|_module.__default.tst#requires| |x#0@@1|))
)))
(assert (forall (($bx T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (|Set#IsMember| (Reads1 Tclass._System.nat Tclass._System.nat $heap@@0 |_module.__default.tst#Handle| |$fh$0x#0@@0|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |488|
 :pattern ( (|Set#IsMember| (Reads1 Tclass._System.nat Tclass._System.nat $heap@@0 |_module.__default.tst#Handle| |$fh$0x#0@@0|) $bx))
)))
...
(assert (forall (($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (Apply1 Tclass._System.nat Tclass._System.nat $heap@@1 |_module.__default.tst#Handle| |$fh$0x#0@@1|) ($Box intType (int_2_U (_module.__default.tst (U_2_int ($Unbox intType |$fh$0x#0@@1|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |486|
 :pattern ( (Apply1 Tclass._System.nat Tclass._System.nat $heap@@1 |_module.__default.tst#Handle| |$fh$0x#0@@1|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@3| Int) ) (!  (=> (or (|_module.__default.tst#canCall| |x#0@@3|) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |x#0@@3|))) (= (_module.__default.tst |x#0@@3|) (+ |x#0@@3| 1)))
 :qid |gitissue262dfy.4:14|
 :skolemid |481|
 :pattern ( (_module.__default.tst |x#0@@3|))
))))
...
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| Int) ) (! (= (_module.__default.tst |$fh$0x#0@@2|) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat Tclass._System.nat $heap@@2 |_module.__default.tst#Handle| ($Box intType (int_2_U |$fh$0x#0@@2|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |489|
 :pattern ( (_module.__default.tst |$fh$0x#0@@2|) ($IsGoodHeap $heap@@2))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@4| Int) ) (!  (=> (or (|_module.__default.tst#canCall| (LitInt |x#0@@4|)) (and (< 0 $FunctionContextHeight) (<= (LitInt 0) |x#0@@4|))) (= (_module.__default.tst (LitInt |x#0@@4|)) (LitInt (+ |x#0@@4| 1))))
 :qid |gitissue262dfy.4:14|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.tst (LitInt |x#0@@4|)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (= |f#0@0| |_module.__default.tst#Handle|) (= (ControlFlow 0 2) (- 0 1))) (or (not (= 0 $FunctionContextHeight)) (not true))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat Tclass._System.nat)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat Tclass._System.nat) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
