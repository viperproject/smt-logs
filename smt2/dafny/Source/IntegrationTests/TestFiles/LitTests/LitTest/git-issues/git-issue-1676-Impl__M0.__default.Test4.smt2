...
(set-info :boogie-vc-id Impl$$M0.__default.Test4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (and (= |s1#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))))) (= |s#0@0| (Lit SeqType (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt (- 0 1)))))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($Is SeqType (|Seq#Append| |s1#0@0| |s#0@0|) (TSeq Tclass._System.nat))) (=> ($Is SeqType (|Seq#Append| |s1#0@0| |s#0@0|) (TSeq Tclass._System.nat)) (=> (= |s1or0#0@0| (|Seq#Append| |s1#0@0| |s#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s1or0#0@0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s1or0#0@0|))) (=> (= |x##0@0| (U_2_int ($Unbox intType (|Seq#Index| |s1or0#0@0| (LitInt 0))))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (<= (LitInt 0) |x##0@0|) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s1or0#0@0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s1or0#0@0|))) (=> (= |x##1@0| (U_2_int ($Unbox intType (|Seq#Index| |s1or0#0@0| (LitInt 1))))) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (<= (LitInt 0) |x##1@0|) (= $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= (LitInt (- 0 1)) (LitInt 0))) (=> (>= (LitInt (- 0 1)) (LitInt 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is SeqType |s1#0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |s1#0| (TSeq Tclass._System.nat) $Heap)) true) (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) true)) (and (and (and ($Is SeqType |s1or0#0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |s1or0#0| (TSeq Tclass._System.nat) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 2)))) anon0_correct))))
