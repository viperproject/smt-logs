...
(assert (forall ((_module.Result$T@@0 T@U) (|a#9#0#0| T@U) ($h@@5 T@U) ) (!  (=> ($IsGoodHeap $h@@5) (= ($IsAlloc DatatypeTypeType (|#_module.Result.Success| |a#9#0#0|) (Tclass._module.Result _module.Result$T@@0) $h@@5) ($IsAllocBox |a#9#0#0| _module.Result$T@@0 $h@@5)))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Result.Success| |a#9#0#0|) (Tclass._module.Result _module.Result$T@@0) $h@@5))
)))
(assert (= (Ctor SeqType) 8))
(assert (forall ((d@@3 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_module.Result.Failure_q d@@3) (exists ((_module.Result$T@@1 T@U) ) (! ($IsAlloc DatatypeTypeType d@@3 (Tclass._module.Result _module.Result$T@@1) $h@@6)
 :qid |unknown.0:0|
 :skolemid |501|
 :pattern ( ($IsAlloc DatatypeTypeType d@@3 (Tclass._module.Result _module.Result$T@@1) $h@@6))
)))) ($IsAlloc SeqType (_module.Result.msg d@@3) (TSeq TChar) $h@@6))
 :qid |unknown.0:0|
 :skolemid |502|
 :pattern ( ($IsAlloc SeqType (_module.Result.msg d@@3) (TSeq TChar) $h@@6))
)))
(assert (forall ((_module.Result$T@@2 T@U) (|a#2#0#0| T@U) ($h@@7 T@U) ) (!  (=> ($IsGoodHeap $h@@7) (= ($IsAlloc DatatypeTypeType (|#_module.Result.Failure| |a#2#0#0|) (Tclass._module.Result _module.Result$T@@2) $h@@7) ($IsAlloc SeqType |a#2#0#0| (TSeq TChar) $h@@7)))
 :qid |unknown.0:0|
 :skolemid |500|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_module.Result.Failure| |a#2#0#0|) (Tclass._module.Result _module.Result$T@@2) $h@@7))
)))
...
(assert (forall ((d@@5 T@U) (_module.Result$T@@6 T@U) ($h@@11 T@U) ) (!  (=> (and ($IsGoodHeap $h@@11) (and (_module.Result.Success_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.Result _module.Result$T@@6) $h@@11))) ($IsAllocBox (_module.Result.value d@@5) _module.Result$T@@6 $h@@11))
 :qid |unknown.0:0|
 :skolemid |513|
 :pattern ( ($IsAllocBox (_module.Result.value d@@5) _module.Result$T@@6 $h@@11))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc |a#0| |c#0@@3|)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 7))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 7)))) (=> (= |$rhs#0@0| (LitInt 180)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 7)) ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |c#0@@3| null)) (not true))) (=> (or (not (= |c#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@3| _module.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@3| _module.Cell.data)) (=> (and (and (= |$rhs#1@0| (LitInt 9)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@3| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@3|) _module.Cell.data ($Box intType (int_2_U |$rhs#1@0|)))))) (and ($IsGoodHeap $Heap@1) (= |r#0@0| (Lit DatatypeTypeType (|#_module.Result.Success| ($Box intType (int_2_U (LitInt 200)))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (_module.Result.Success_q |r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) (LitInt 200)))) (=> (=> (_module.Result.Success_q |r#0@0|) (= (U_2_int ($Unbox intType (_module.Result.value |r#0@0|))) (LitInt 200))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#0@@3|) _module.Cell.data))) (LitInt 9)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and ($Is refType |c#0@@3| Tclass._module.Cell) ($IsAlloc refType |c#0@@3| Tclass._module.Cell $Heap))) (=> (and (and (and ($Is DatatypeTypeType |r#0| (Tclass._module.Result TInt)) ($IsAlloc DatatypeTypeType |r#0| (Tclass._module.Result TInt) $Heap)) (= 1 $FunctionContextHeight)) (and (= (_System.array.Length |a#0|) (LitInt 10)) (= (ControlFlow 0 9) 2))) anon0_correct)))))
