...
(declare-fun |region#0@@4| () T@U)
(declare-fun |owned#0| () T@U)
(declare-fun this@@4 () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun |o#6@0| () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.Memory.ownedBy)
...
(let ((anon14_Else_correct  (=> (and (=> (|Set#IsMember| |os#0@@4| ($Box refType |o#5@0|)) (= (|_module.Region#Equal| (_module.Object.region |o#5@0|) |region#0@@4|) (|Set#IsMember| |owned#0| ($Box refType |o#5@0|)))) (= (ControlFlow 0 14) 11)) anon5_correct)))
(let ((anon14_Then_correct  (=> (|Set#IsMember| |os#0@@4| ($Box refType |o#5@0|)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |o#5@0| null)) (not true))) (=> (or (not (= |o#5@0| null)) (not true)) (=> (and (= (|_module.Region#Equal| (_module.Object.region |o#5@0|) |region#0@@4|) (|Set#IsMember| |owned#0| ($Box refType |o#5@0|))) (= (ControlFlow 0 12) 11)) anon5_correct))))))
(let ((anon13_Then_correct  (=> (and (and ($Is SetType (_module.Memory.ownedBy this@@4 |os#0@@4| |region#0@@4|) (TSet Tclass._module.Object)) ($Is SetType |owned#0| (TSet Tclass._module.Object))) (and ($Is refType |o#5@0| Tclass._module.Object) ($IsAlloc refType |o#5@0| Tclass._module.Object $Heap@@0))) (and (=> (= (ControlFlow 0 15) 12) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon14_Else_correct)))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|o#4| T@U) ) (!  (=> (and ($Is refType |o#4| Tclass._module.Object) (|Set#IsMember| |os#0@@4| ($Box refType |o#4|))) (= (|_module.Region#Equal| (_module.Object.region |o#4|) |region#0@@4|) (|Set#IsMember| |owned#0| ($Box refType |o#4|))))
 :qid |gitissue3855dfy.595:18|
 :skolemid |1177|
 :pattern ( (|Set#IsMember| |owned#0| ($Box refType |o#4|)))
 :pattern ( (_module.Object.region |o#4|))
 :pattern ( (|Set#IsMember| |os#0@@4| ($Box refType |o#4|)))
)))))
(let ((anon11_correct  (=> (= (_module.Memory.ownedBy this@@4 |os#0@@4| |region#0@@4|) (|Set#FromBoogieMap| (|lambda#117| Tclass._module.Object |os#0@@4| |region#0@@4|))) (=> (and (and (forall ((|o#7| T@U) ) (!  (=> ($Is refType |o#7| Tclass._module.Object) (=> (|Set#IsMember| |os#0@@4| ($Box refType |o#7|)) (and (|$IsA#_module.Region| (_module.Object.region |o#7|)) (|$IsA#_module.Region| |region#0@@4|))))
 :qid |gitissue3855dfy.597:7|
 :skolemid |1179|
 :pattern ( (_module.Object.region |o#7|))
 :pattern ( (|Set#IsMember| |os#0@@4| ($Box refType |o#7|)))
)) ($Is SetType (_module.Memory.ownedBy this@@4 |os#0@@4| |region#0@@4|) (TSet Tclass._module.Object))) (and (= (_module.Memory.ownedBy this@@4 |os#0@@4| |region#0@@4|) |owned#0|) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))
(let ((anon17_Else_correct  (=> (and (not (and (|Set#IsMember| |os#0@@4| ($Box refType |o#6@0|)) (|_module.Region#Equal| (_module.Object.region |o#6@0|) |region#0@@4|))) (= (ControlFlow 0 6) 3)) anon11_correct)))
(let ((anon17_Then_correct  (=> (and (and (|Set#IsMember| |os#0@@4| ($Box refType |o#6@0|)) (|_module.Region#Equal| (_module.Object.region |o#6@0|) |region#0@@4|)) (= (ControlFlow 0 5) 3)) anon11_correct)))
(let ((anon16_Else_correct  (=> (not (|Set#IsMember| |os#0@@4| ($Box refType |o#6@0|))) (and (=> (= (ControlFlow 0 9) 5) anon17_Then_correct) (=> (= (ControlFlow 0 9) 6) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (|Set#IsMember| |os#0@@4| ($Box refType |o#6@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |o#6@0| null)) (not true))) (=> (or (not (= |o#6@0| null)) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon17_Then_correct) (=> (= (ControlFlow 0 7) 6) anon17_Else_correct)))))))
(let ((anon15_Then_correct  (=> (and ($Is refType |o#6@0| Tclass._module.Object) ($IsAlloc refType |o#6@0| Tclass._module.Object $Heap@@0)) (and (=> (= (ControlFlow 0 10) 7) anon16_Then_correct) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (not (and ($Is refType |o#6@0| Tclass._module.Object) ($IsAlloc refType |o#6@0| Tclass._module.Object $Heap@@0))) (= (ControlFlow 0 4) 3)) anon11_correct)))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (and (and (=> (= (ControlFlow 0 16) 15) anon13_Then_correct) (=> (= (ControlFlow 0 16) 10) anon15_Then_correct)) (=> (= (ControlFlow 0 16) 4) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.Memory) ($IsAlloc refType this@@4 Tclass._module.Memory $Heap@@0)))) (and (and ($Is SetType |os#0@@4| (TSet Tclass._module.Object)) ($Is DatatypeTypeType |region#0@@4| Tclass._module.Region)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 17) 16)))) anon0_correct)))
