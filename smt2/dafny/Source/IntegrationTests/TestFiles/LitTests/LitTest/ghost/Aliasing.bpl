// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/Aliasing.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/Aliasing-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/Aliasing.dfy
...
axiom (forall a#12#0#0: Box, a#12#1#0: Box, a#12#2#0: Box :: 
  { #_System._tuple#3OOG._#Make3(a#12#0#0, a#12#1#0, a#12#2#0) } 
  DatatypeCtorId(#_System._tuple#3OOG._#Make3(a#12#0#0, a#12#1#0, a#12#2#0))
...
axiom (forall d: DatatypeType :: 
  ...
  _System.Tuple3OOG.___hMake3_q(d)
     ==> (exists a#13#0#0: Box, a#13#1#0: Box, a#13#2#0: Box :: 
      d == #_System._tuple#3OOG._#Make3(a#13#0#0, a#13#1#0, a#13#2#0)));
...
axiom (forall _System._tuple#3OOG$T0: Ty, 
    ...
    a#14#1#0: Box, 
    a#14#2#0: Box :: 
  { $Is(#_System._tuple#3OOG._#Make3(a#14#0#0, a#14#1#0, a#14#2#0), 
      Tclass._System.Tuple3OOG(_System._tuple#3OOG$T0, _System._tuple#3OOG$T1, _System._tuple#3OOG$T2)) } 
  $Is(#_System._tuple#3OOG._#Make3(a#14#0#0, a#14#1#0, a#14#2#0), 
      Tclass._System.Tuple3OOG(_System._tuple#3OOG$T0, _System._tuple#3OOG$T1, _System._tuple#3OOG$T2))
     <==> $IsBox(a#14#0#0, _System._tuple#3OOG$T0)
       && $IsBox(a#14#1#0, _System._tuple#3OOG$T1)
       && $IsBox(a#14#2#0, _System._tuple#3OOG$T2));
...
axiom (forall _System._tuple#3OOG$T0: Ty, 
    ...
    a#14#2#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#_System._tuple#3OOG._#Make3(a#14#0#0, a#14#1#0, a#14#2#0), 
      Tclass._System.Tuple3OOG(_System._tuple#3OOG$T0, _System._tuple#3OOG$T1, _System._tuple#3OOG$T2), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_System._tuple#3OOG._#Make3(a#14#0#0, a#14#1#0, a#14#2#0), 
        Tclass._System.Tuple3OOG(_System._tuple#3OOG$T0, _System._tuple#3OOG$T1, _System._tuple#3OOG$T2), 
        $h)
       <==> $IsAllocBox(a#14#0#0, _System._tuple#3OOG$T0, $h)
         && $IsAllocBox(a#14#1#0, _System._tuple#3OOG$T1, $h)
         && $IsAllocBox(a#14#2#0, _System._tuple#3OOG$T2, $h)));
...
axiom (forall a#15#0#0: Box, a#15#1#0: Box, a#15#2#0: Box :: 
  { #_System._tuple#3OOG._#Make3(Lit(a#15#0#0), Lit(a#15#1#0), Lit(a#15#2#0)) } 
  #_System._tuple#3OOG._#Make3(Lit(a#15#0#0), Lit(a#15#1#0), Lit(a#15#2#0))
     == Lit(#_System._tuple#3OOG._#Make3(a#15#0#0, a#15#1#0, a#15#2#0)));

function _System.Tuple3OOG._0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#16#0#0: Box, a#16#1#0: Box, a#16#2#0: Box :: 
  { #_System._tuple#3OOG._#Make3(a#16#0#0, a#16#1#0, a#16#2#0) } 
  _System.Tuple3OOG._0(#_System._tuple#3OOG._#Make3(a#16#0#0, a#16#1#0, a#16#2#0))
     == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box, a#17#1#0: Box, a#17#2#0: Box :: 
  { #_System._tuple#3OOG._#Make3(a#17#0#0, a#17#1#0, a#17#2#0) } 
  BoxRank(a#17#0#0)
     < DtRank(#_System._tuple#3OOG._#Make3(a#17#0#0, a#17#1#0, a#17#2#0)));

function _System.Tuple3OOG._1(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#18#0#0: Box, a#18#1#0: Box, a#18#2#0: Box :: 
  { #_System._tuple#3OOG._#Make3(a#18#0#0, a#18#1#0, a#18#2#0) } 
  _System.Tuple3OOG._1(#_System._tuple#3OOG._#Make3(a#18#0#0, a#18#1#0, a#18#2#0))
     == a#18#1#0);

// Inductive rank
axiom (forall a#19#0#0: Box, a#19#1#0: Box, a#19#2#0: Box :: 
  { #_System._tuple#3OOG._#Make3(a#19#0#0, a#19#1#0, a#19#2#0) } 
  BoxRank(a#19#1#0)
     < DtRank(#_System._tuple#3OOG._#Make3(a#19#0#0, a#19#1#0, a#19#2#0)));

function _System.Tuple3OOG._2(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#20#0#0: Box, a#20#1#0: Box, a#20#2#0: Box :: 
  { #_System._tuple#3OOG._#Make3(a#20#0#0, a#20#1#0, a#20#2#0) } 
  _System.Tuple3OOG._2(#_System._tuple#3OOG._#Make3(a#20#0#0, a#20#1#0, a#20#2#0))
     == a#20#2#0);

// Inductive rank
axiom (forall a#21#0#0: Box, a#21#1#0: Box, a#21#2#0: Box :: 
  { #_System._tuple#3OOG._#Make3(a#21#0#0, a#21#1#0, a#21#2#0) } 
  BoxRank(a#21#2#0)
     < DtRank(#_System._tuple#3OOG._#Make3(a#21#0#0, a#21#1#0, a#21#2#0)));
...
axiom (forall a#22#0#0: Box, a#22#1#0: Box :: 
  { #_System._tuple#2OG._#Make2(a#22#0#0, a#22#1#0) } 
  DatatypeCtorId(#_System._tuple#2OG._#Make2(a#22#0#0, a#22#1#0))
...
axiom (forall d: DatatypeType :: 
  { _System.Tuple2OG.___hMake2_q(d) } 
  _System.Tuple2OG.___hMake2_q(d)
     ==> (exists a#23#0#0: Box, a#23#1#0: Box :: 
      d == #_System._tuple#2OG._#Make2(a#23#0#0, a#23#1#0)));
...
axiom (forall _System._tuple#2OG$T0: Ty, 
    ...
    a#24#0#0: Box, 
    a#24#1#0: Box :: 
  { $Is(#_System._tuple#2OG._#Make2(a#24#0#0, a#24#1#0), 
      Tclass._System.Tuple2OG(_System._tuple#2OG$T0, _System._tuple#2OG$T1)) } 
  $Is(#_System._tuple#2OG._#Make2(a#24#0#0, a#24#1#0), 
      Tclass._System.Tuple2OG(_System._tuple#2OG$T0, _System._tuple#2OG$T1))
     <==> $IsBox(a#24#0#0, _System._tuple#2OG$T0)
       && $IsBox(a#24#1#0, _System._tuple#2OG$T1));
...
axiom (forall _System._tuple#2OG$T0: Ty, 
    ...
    a#24#1#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#_System._tuple#2OG._#Make2(a#24#0#0, a#24#1#0), 
      Tclass._System.Tuple2OG(_System._tuple#2OG$T0, _System._tuple#2OG$T1), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_System._tuple#2OG._#Make2(a#24#0#0, a#24#1#0), 
        Tclass._System.Tuple2OG(_System._tuple#2OG$T0, _System._tuple#2OG$T1), 
        $h)
       <==> $IsAllocBox(a#24#0#0, _System._tuple#2OG$T0, $h)
         && $IsAllocBox(a#24#1#0, _System._tuple#2OG$T1, $h)));
...
axiom (forall a#25#0#0: Box, a#25#1#0: Box :: 
  { #_System._tuple#2OG._#Make2(Lit(a#25#0#0), Lit(a#25#1#0)) } 
  #_System._tuple#2OG._#Make2(Lit(a#25#0#0), Lit(a#25#1#0))
     == Lit(#_System._tuple#2OG._#Make2(a#25#0#0, a#25#1#0)));

function _System.Tuple2OG._0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#26#0#0: Box, a#26#1#0: Box :: 
  { #_System._tuple#2OG._#Make2(a#26#0#0, a#26#1#0) } 
  _System.Tuple2OG._0(#_System._tuple#2OG._#Make2(a#26#0#0, a#26#1#0)) == a#26#0#0);

// Inductive rank
axiom (forall a#27#0#0: Box, a#27#1#0: Box :: 
  { #_System._tuple#2OG._#Make2(a#27#0#0, a#27#1#0) } 
  BoxRank(a#27#0#0) < DtRank(#_System._tuple#2OG._#Make2(a#27#0#0, a#27#1#0)));

function _System.Tuple2OG._1(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#28#0#0: Box, a#28#1#0: Box :: 
  { #_System._tuple#2OG._#Make2(a#28#0#0, a#28#1#0) } 
  _System.Tuple2OG._1(#_System._tuple#2OG._#Make2(a#28#0#0, a#28#1#0)) == a#28#1#0);

// Inductive rank
axiom (forall a#29#0#0: Box, a#29#1#0: Box :: 
  { #_System._tuple#2OG._#Make2(a#29#0#0, a#29#1#0) } 
  BoxRank(a#29#1#0) < DtRank(#_System._tuple#2OG._#Make2(a#29#0#0, a#29#1#0)));
...
procedure {:verboseName "Test1 (well-formedness)"} CheckWellFormed$$_module.__default.Test1(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(Tclass._System.Tuple3OOG(TInt, TInt, TInt)))
         && $IsAlloc(b#0, Tclass._System.array(Tclass._System.Tuple3OOG(TInt, TInt, TInt)), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Test1 (call)"} Call$$_module.__default.Test1(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(Tclass._System.Tuple3OOG(TInt, TInt, TInt)))
...
procedure {:verboseName "Test1 (correctness)"} Impl$$_module.__default.Test1(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(Tclass._System.Tuple3OOG(TInt, TInt, TInt)))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Test1 (correctness)"} Impl$$_module.__default.Test1(a#0: ref, b#0: ref) returns ($_reverifyPost: bool)
{
  ...
  var newtype$check#1: ref;
    ...
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/Aliasing.dfy(5,3)
    newtype$check#0 := a#0;
    newtype$check#1 := a#0;
    assume true;
    assert {:id "id0"} a#0 != b#0;
}



procedure {:verboseName "Test2 (well-formedness)"} CheckWellFormed$$_module.__default.Test2(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(Tclass._System.Tuple2OG(TInt, TInt)))
         && $IsAlloc(b#0, Tclass._System.array(Tclass._System.Tuple2OG(TInt, TInt)), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Test2 (call)"} Call$$_module.__default.Test2(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(Tclass._System.Tuple2OG(TInt, TInt)))
...
procedure {:verboseName "Test2 (correctness)"} Impl$$_module.__default.Test2(a#0: ref
       where $Is(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(a#0, Tclass._System.array(Tclass._System.Tuple2(TInt, TInt)), $Heap), 
    b#0: ref
       where $Is(b#0, Tclass._System.array(Tclass._System.Tuple2OG(TInt, TInt)))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Test2 (correctness)"} Impl$$_module.__default.Test2(a#0: ref, b#0: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var newtype$check#0: ref;
  var newtype$check#1: ref;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/Aliasing.dfy(9,3)
    newtype$check#0 := a#0;
    newtype$check#1 := a#0;
    assume true;
    assert {:id "id1"} a#0 != b#0;
}
