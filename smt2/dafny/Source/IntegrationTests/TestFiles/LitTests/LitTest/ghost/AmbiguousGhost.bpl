// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/AmbiguousGhost.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/AmbiguousGhost-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/AmbiguousGhost.dfy
...
axiom (forall a#20#0#0: Box, a#20#1#0: Box :: 
  { #_System._tuple#2GG._#Make2(a#20#0#0, a#20#1#0) } 
  DatatypeCtorId(#_System._tuple#2GG._#Make2(a#20#0#0, a#20#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  _System.Tuple2GG.___hMake2_q(d)
     ==> (exists a#21#0#0: Box, a#21#1#0: Box :: 
      d == #_System._tuple#2GG._#Make2(a#21#0#0, a#21#1#0)));
...
axiom (forall _System._tuple#2GG$T0: Ty, 
    ...
    a#22#0#0: Box, 
    a#22#1#0: Box :: 
  { $Is(#_System._tuple#2GG._#Make2(a#22#0#0, a#22#1#0), 
      Tclass._System.Tuple2GG(_System._tuple#2GG$T0, _System._tuple#2GG$T1)) } 
  $Is(#_System._tuple#2GG._#Make2(a#22#0#0, a#22#1#0), 
      Tclass._System.Tuple2GG(_System._tuple#2GG$T0, _System._tuple#2GG$T1))
     <==> $IsBox(a#22#0#0, _System._tuple#2GG$T0)
       && $IsBox(a#22#1#0, _System._tuple#2GG$T1));
...
axiom (forall _System._tuple#2GG$T0: Ty, 
    ...
    a#22#1#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#_System._tuple#2GG._#Make2(a#22#0#0, a#22#1#0), 
      Tclass._System.Tuple2GG(_System._tuple#2GG$T0, _System._tuple#2GG$T1), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_System._tuple#2GG._#Make2(a#22#0#0, a#22#1#0), 
        Tclass._System.Tuple2GG(_System._tuple#2GG$T0, _System._tuple#2GG$T1), 
        $h)
       <==> $IsAllocBox(a#22#0#0, _System._tuple#2GG$T0, $h)
         && $IsAllocBox(a#22#1#0, _System._tuple#2GG$T1, $h)));
...
axiom (forall a#23#0#0: Box, a#23#1#0: Box :: 
  { #_System._tuple#2GG._#Make2(Lit(a#23#0#0), Lit(a#23#1#0)) } 
  #_System._tuple#2GG._#Make2(Lit(a#23#0#0), Lit(a#23#1#0))
     == Lit(#_System._tuple#2GG._#Make2(a#23#0#0, a#23#1#0)));

function _System.Tuple2GG._0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#24#0#0: Box, a#24#1#0: Box :: 
  { #_System._tuple#2GG._#Make2(a#24#0#0, a#24#1#0) } 
  _System.Tuple2GG._0(#_System._tuple#2GG._#Make2(a#24#0#0, a#24#1#0)) == a#24#0#0);

// Inductive rank
axiom (forall a#25#0#0: Box, a#25#1#0: Box :: 
  { #_System._tuple#2GG._#Make2(a#25#0#0, a#25#1#0) } 
  BoxRank(a#25#0#0) < DtRank(#_System._tuple#2GG._#Make2(a#25#0#0, a#25#1#0)));

function _System.Tuple2GG._1(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#26#0#0: Box, a#26#1#0: Box :: 
  { #_System._tuple#2GG._#Make2(a#26#0#0, a#26#1#0) } 
  _System.Tuple2GG._1(#_System._tuple#2GG._#Make2(a#26#0#0, a#26#1#0)) == a#26#1#0);

// Inductive rank
axiom (forall a#27#0#0: Box, a#27#1#0: Box :: 
  { #_System._tuple#2GG._#Make2(a#27#0#0, a#27#1#0) } 
  BoxRank(a#27#1#0) < DtRank(#_System._tuple#2GG._#Make2(a#27#0#0, a#27#1#0)));
...
axiom (forall a#28#0#0: Box, a#28#1#0: Box :: 
  { #_System._tuple#2GO._#Make2(a#28#0#0, a#28#1#0) } 
  DatatypeCtorId(#_System._tuple#2GO._#Make2(a#28#0#0, a#28#1#0))
...
axiom (forall d: DatatypeType :: 
  { _System.Tuple2GO.___hMake2_q(d) } 
  _System.Tuple2GO.___hMake2_q(d)
     ==> (exists a#29#0#0: Box, a#29#1#0: Box :: 
      d == #_System._tuple#2GO._#Make2(a#29#0#0, a#29#1#0)));
...
axiom (forall _System._tuple#2GO$T0: Ty, 
    ...
    a#30#0#0: Box, 
    a#30#1#0: Box :: 
  { $Is(#_System._tuple#2GO._#Make2(a#30#0#0, a#30#1#0), 
      Tclass._System.Tuple2GO(_System._tuple#2GO$T0, _System._tuple#2GO$T1)) } 
  $Is(#_System._tuple#2GO._#Make2(a#30#0#0, a#30#1#0), 
      Tclass._System.Tuple2GO(_System._tuple#2GO$T0, _System._tuple#2GO$T1))
     <==> $IsBox(a#30#0#0, _System._tuple#2GO$T0)
       && $IsBox(a#30#1#0, _System._tuple#2GO$T1));
...
axiom (forall _System._tuple#2GO$T0: Ty, 
    ...
    a#30#1#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#_System._tuple#2GO._#Make2(a#30#0#0, a#30#1#0), 
      Tclass._System.Tuple2GO(_System._tuple#2GO$T0, _System._tuple#2GO$T1), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_System._tuple#2GO._#Make2(a#30#0#0, a#30#1#0), 
        Tclass._System.Tuple2GO(_System._tuple#2GO$T0, _System._tuple#2GO$T1), 
        $h)
       <==> $IsAllocBox(a#30#0#0, _System._tuple#2GO$T0, $h)
         && $IsAllocBox(a#30#1#0, _System._tuple#2GO$T1, $h)));
...
// Constructor literal
axiom (forall a#31#0#0: Box, a#31#1#0: Box :: 
  { #_System._tuple#2GO._#Make2(Lit(a#31#0#0), Lit(a#31#1#0)) } 
  #_System._tuple#2GO._#Make2(Lit(a#31#0#0), Lit(a#31#1#0))
     == Lit(#_System._tuple#2GO._#Make2(a#31#0#0, a#31#1#0)));

function _System.Tuple2GO._0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#32#0#0: Box, a#32#1#0: Box :: 
  { #_System._tuple#2GO._#Make2(a#32#0#0, a#32#1#0) } 
  _System.Tuple2GO._0(#_System._tuple#2GO._#Make2(a#32#0#0, a#32#1#0)) == a#32#0#0);

// Inductive rank
axiom (forall a#33#0#0: Box, a#33#1#0: Box :: 
  { #_System._tuple#2GO._#Make2(a#33#0#0, a#33#1#0) } 
  BoxRank(a#33#0#0) < DtRank(#_System._tuple#2GO._#Make2(a#33#0#0, a#33#1#0)));

function _System.Tuple2GO._1(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#34#0#0: Box, a#34#1#0: Box :: 
  { #_System._tuple#2GO._#Make2(a#34#0#0, a#34#1#0) } 
  _System.Tuple2GO._1(#_System._tuple#2GO._#Make2(a#34#0#0, a#34#1#0)) == a#34#1#0);

// Inductive rank
axiom (forall a#35#0#0: Box, a#35#1#0: Box :: 
  { #_System._tuple#2GO._#Make2(a#35#0#0, a#35#1#0) } 
  BoxRank(a#35#1#0) < DtRank(#_System._tuple#2GO._#Make2(a#35#0#0, a#35#1#0)));
...
function _module.__default.F(x#0: int) : DatatypeType
uses {
...
axiom 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    _module.__default.F#canCall(x#0) || 0 < $FunctionContextHeight
       ==> $Is(_module.__default.F(x#0), Tclass._System.Tuple0()));
// definition axiom for _module.__default.F (revealed)
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    { _module.__default.F(x#0) } 
    _module.__default.F#canCall(x#0) || 0 < $FunctionContextHeight
       ==> _module.__default.F(x#0) == Lit(#_System._tuple#0._#Make0()));
...
axiom {:id "id1"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    _module.__default.F#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
       ==> _module.__default.F(LitInt(x#0)) == Lit(#_System._tuple#0._#Make0()));
}
...
function _module.__default.a(_module._default.a$T: Ty, _module._default.a$U: Ty, x#0: int) : int
uses {
// definition axiom for _module.__default.a (revealed)
axiom {:id "id3"} 0 <= $FunctionContextHeight
   ==> (forall _module._default.a$T: Ty, _module._default.a$U: Ty, x#0: int :: 
    { _module.__default.a(_module._default.a$T, _module._default.a$U, x#0) } 
    _module.__default.a#canCall(_module._default.a$T, _module._default.a$U, x#0)
         || 0 < $FunctionContextHeight
       ==> _module.__default.a(_module._default.a$T, _module._default.a$U, x#0) == x#0);
// definition axiom for _module.__default.a for all literals (revealed)
axiom {:id "id4"} 0 <= $FunctionContextHeight
   ==> (forall _module._default.a$T: Ty, _module._default.a$U: Ty, x#0: int :: 
    {:weight 3} { _module.__default.a(_module._default.a$T, _module._default.a$U, LitInt(x#0)) } 
    _module.__default.a#canCall(_module._default.a$T, _module._default.a$U, LitInt(x#0))
         || 0 < $FunctionContextHeight
       ==> _module.__default.a(_module._default.a$T, _module._default.a$U, LitInt(x#0))
         == LitInt(x#0));
}

function _module.__default.a#canCall(_module._default.a$T: Ty, _module._default.a$U: Ty, x#0: int) : bool;

function _module.__default.a#requires(Ty, Ty, int) : bool;

// #requires axiom for _module.__default.a
axiom (forall _module._default.a$T: Ty, _module._default.a$U: Ty, x#0: int :: 
  { _module.__default.a#requires(_module._default.a$T, _module._default.a$U, x#0) } 
  _module.__default.a#requires(_module._default.a$T, _module._default.a$U, x#0)
     == true);

procedure {:verboseName "a (well-formedness)"} CheckWellformed$$_module.__default.a(_module._default.a$T: Ty, _module._default.a$U: Ty, x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M (well-formedness)"} CheckWellFormed$$_module.__default.M(_module._default.M$b: Ty, _module._default.M$c: Ty, d#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M (call)"} Call$$_module.__default.M(_module._default.M$b: Ty, _module._default.M$c: Ty, d#0: int);
  modifies $Heap;
...
procedure {:verboseName "M (correctness)"} Impl$$_module.__default.M(_module._default.M$b: Ty, _module._default.M$c: Ty, d#0: int)
