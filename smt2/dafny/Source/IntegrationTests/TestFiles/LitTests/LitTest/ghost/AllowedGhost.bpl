// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/AllowedGhost.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/AllowedGhost-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/AllowedGhost.dfy
...
axiom (forall a#18#0#0: Box, a#18#1#0: Box, a#18#2#0: Box :: 
  { #_System._tuple#3OGO._#Make3(a#18#0#0, a#18#1#0, a#18#2#0) } 
  DatatypeCtorId(#_System._tuple#3OGO._#Make3(a#18#0#0, a#18#1#0, a#18#2#0))
...
axiom (forall d: DatatypeType :: 
  { _System.Tuple3OGO.___hMake3_q(d) } 
  _System.Tuple3OGO.___hMake3_q(d)
     ==> (exists a#19#0#0: Box, a#19#1#0: Box, a#19#2#0: Box :: 
      d == #_System._tuple#3OGO._#Make3(a#19#0#0, a#19#1#0, a#19#2#0)));
...
axiom (forall _System._tuple#3OGO$T0: Ty, 
    ...
    a#20#1#0: Box, 
    a#20#2#0: Box :: 
  { $Is(#_System._tuple#3OGO._#Make3(a#20#0#0, a#20#1#0, a#20#2#0), 
      Tclass._System.Tuple3OGO(_System._tuple#3OGO$T0, _System._tuple#3OGO$T1, _System._tuple#3OGO$T2)) } 
  $Is(#_System._tuple#3OGO._#Make3(a#20#0#0, a#20#1#0, a#20#2#0), 
      Tclass._System.Tuple3OGO(_System._tuple#3OGO$T0, _System._tuple#3OGO$T1, _System._tuple#3OGO$T2))
     <==> $IsBox(a#20#0#0, _System._tuple#3OGO$T0)
       && $IsBox(a#20#1#0, _System._tuple#3OGO$T1)
       && $IsBox(a#20#2#0, _System._tuple#3OGO$T2));
...
axiom (forall _System._tuple#3OGO$T0: Ty, 
    ...
    a#20#2#0: Box, 
    $h: Heap :: 
  { $IsAlloc(#_System._tuple#3OGO._#Make3(a#20#0#0, a#20#1#0, a#20#2#0), 
      Tclass._System.Tuple3OGO(_System._tuple#3OGO$T0, _System._tuple#3OGO$T1, _System._tuple#3OGO$T2), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#_System._tuple#3OGO._#Make3(a#20#0#0, a#20#1#0, a#20#2#0), 
        Tclass._System.Tuple3OGO(_System._tuple#3OGO$T0, _System._tuple#3OGO$T1, _System._tuple#3OGO$T2), 
        $h)
       <==> $IsAllocBox(a#20#0#0, _System._tuple#3OGO$T0, $h)
         && $IsAllocBox(a#20#1#0, _System._tuple#3OGO$T1, $h)
         && $IsAllocBox(a#20#2#0, _System._tuple#3OGO$T2, $h)));
...
axiom (forall a#21#0#0: Box, a#21#1#0: Box, a#21#2#0: Box :: 
  { #_System._tuple#3OGO._#Make3(Lit(a#21#0#0), Lit(a#21#1#0), Lit(a#21#2#0)) } 
  #_System._tuple#3OGO._#Make3(Lit(a#21#0#0), Lit(a#21#1#0), Lit(a#21#2#0))
     == Lit(#_System._tuple#3OGO._#Make3(a#21#0#0, a#21#1#0, a#21#2#0)));

function _System.Tuple3OGO._0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#22#0#0: Box, a#22#1#0: Box, a#22#2#0: Box :: 
  { #_System._tuple#3OGO._#Make3(a#22#0#0, a#22#1#0, a#22#2#0) } 
  _System.Tuple3OGO._0(#_System._tuple#3OGO._#Make3(a#22#0#0, a#22#1#0, a#22#2#0))
     == a#22#0#0);

// Inductive rank
axiom (forall a#23#0#0: Box, a#23#1#0: Box, a#23#2#0: Box :: 
  { #_System._tuple#3OGO._#Make3(a#23#0#0, a#23#1#0, a#23#2#0) } 
  BoxRank(a#23#0#0)
     < DtRank(#_System._tuple#3OGO._#Make3(a#23#0#0, a#23#1#0, a#23#2#0)));

function _System.Tuple3OGO._1(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#24#0#0: Box, a#24#1#0: Box, a#24#2#0: Box :: 
  { #_System._tuple#3OGO._#Make3(a#24#0#0, a#24#1#0, a#24#2#0) } 
  _System.Tuple3OGO._1(#_System._tuple#3OGO._#Make3(a#24#0#0, a#24#1#0, a#24#2#0))
     == a#24#1#0);

// Inductive rank
axiom (forall a#25#0#0: Box, a#25#1#0: Box, a#25#2#0: Box :: 
  { #_System._tuple#3OGO._#Make3(a#25#0#0, a#25#1#0, a#25#2#0) } 
  BoxRank(a#25#1#0)
     < DtRank(#_System._tuple#3OGO._#Make3(a#25#0#0, a#25#1#0, a#25#2#0)));
...
axiom (forall a#26#0#0: Box, a#26#1#0: Box, a#26#2#0: Box :: 
  ...
  _System.Tuple3OGO._2(#_System._tuple#3OGO._#Make3(a#26#0#0, a#26#1#0, a#26#2#0))
     == a#26#2#0);

// Inductive rank
axiom (forall a#27#0#0: Box, a#27#1#0: Box, a#27#2#0: Box :: 
  { #_System._tuple#3OGO._#Make3(a#27#0#0, a#27#1#0, a#27#2#0) } 
  BoxRank(a#27#2#0)
     < DtRank(#_System._tuple#3OGO._#Make3(a#27#0#0, a#27#1#0, a#27#2#0)));
