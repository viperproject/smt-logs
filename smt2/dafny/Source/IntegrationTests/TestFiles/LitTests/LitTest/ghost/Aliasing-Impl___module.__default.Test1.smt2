...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass._System.Tuple2 Tagclass._System.Tuple3OOG tytagFamily$array |tytagFamily$_tuple#2| |tytagFamily$_tuple#3OOG|)
)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array (Tclass._System.Tuple2 TInt TInt))) ($IsAlloc refType |a#0| (Tclass._System.array (Tclass._System.Tuple2 TInt TInt)) $Heap))) (and (and ($Is refType |b#0| (Tclass._System.array (Tclass._System.Tuple3OOG TInt TInt TInt))) ($IsAlloc refType |b#0| (Tclass._System.array (Tclass._System.Tuple3OOG TInt TInt TInt)) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
