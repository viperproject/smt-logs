...
(declare-fun _module._default.UpdateArray$T () T@U)
(declare-fun $Heap@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |t#0| () T@U)
(declare-fun |tt#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.UpdateArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap alloc |arr#0|)) (=> (and ($IsBox |tt#0@0| _module._default.UpdateArray$T) ($IsAllocBox |tt#0@0| _module._default.UpdateArray$T $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |arr#0| null)) (not true))) (=> (or (not (= |arr#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array.Length |arr#0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (_System.array.Length |arr#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |arr#0| (IndexField (LitInt 1))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |arr#0| (IndexField (LitInt 1)))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |arr#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |arr#0|) (IndexField (LitInt 1)) |tt#0@0|))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |arr#0| null)) (not true))) (=> (or (not (= |arr#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length |arr#0|)))) (=> (and (<= 0 (LitInt 2)) (< (LitInt 2) (_System.array.Length |arr#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |arr#0| (IndexField (LitInt 2))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |arr#0| (Tclass._System.array _module._default.UpdateArray$T)) ($IsAlloc refType |arr#0| (Tclass._System.array _module._default.UpdateArray$T) $Heap)) (and ($IsBox |t#0| _module._default.UpdateArray$T) ($IsAllocBox |t#0| _module._default.UpdateArray$T $Heap))) (=> (and (and (and (and ($IsBox |tt#0| _module._default.UpdateArray$T) ($IsAllocBox |tt#0| _module._default.UpdateArray$T $Heap)) true) (= 0 $FunctionContextHeight)) (and (<= (LitInt 10) (_System.array.Length |arr#0|)) (= (ControlFlow 0 8) 2))) anon0_correct)))))
