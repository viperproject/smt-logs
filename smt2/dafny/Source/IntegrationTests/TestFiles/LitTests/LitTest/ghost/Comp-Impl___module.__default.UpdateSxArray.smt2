...
(assert (forall ((|_System._tuple#3GOG$T0@@4| T@U) (|_System._tuple#3GOG$T1@@4| T@U) (|_System._tuple#3GOG$T2@@4| T@U) (|a#130#0#0| T@U) (|a#130#1#0| T@U) (|a#130#2#0| T@U) ($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) (= ($IsAlloc DatatypeTypeType (|#_System._tuple#3GOG._#Make3| |a#130#0#0| |a#130#1#0| |a#130#2#0|) (Tclass._System.Tuple3GOG |_System._tuple#3GOG$T0@@4| |_System._tuple#3GOG$T1@@4| |_System._tuple#3GOG$T2@@4|) $h@@2)  (and (and ($IsAllocBox |a#130#0#0| |_System._tuple#3GOG$T0@@4| $h@@2) ($IsAllocBox |a#130#1#0| |_System._tuple#3GOG$T1@@4| $h@@2)) ($IsAllocBox |a#130#2#0| |_System._tuple#3GOG$T2@@4| $h@@2))))
 :qid |unknown.0:0|
 :skolemid |813|
 :pattern ( ($IsAlloc DatatypeTypeType (|#_System._tuple#3GOG._#Make3| |a#130#0#0| |a#130#1#0| |a#130#2#0|) (Tclass._System.Tuple3GOG |_System._tuple#3GOG$T0@@4| |_System._tuple#3GOG$T1@@4| |_System._tuple#3GOG$T2@@4|) $h@@2))
)))
...
(assert (forall ((_System.array$arg@@9 T@U) ($h@@3 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) (Tclass._System.array? _System.array$arg@@9)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) alloc)))) ($IsAlloc intType (int_2_U (_System.array.Length $o@@4)) TInt $h@@3))
 :qid |unknown.0:0|
 :skolemid |360|
 :pattern ( (_System.array.Length $o@@4) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) alloc)) (Tclass._System.array? _System.array$arg@@9))
)))
(assert (forall ((_System.array$arg@@10 T@U) ($h@@4 T@U) ($o@@5 T@U) ($i0@@0 Int) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) (Tclass._System.array? _System.array$arg@@10)))) (and (<= 0 $i0@@0) (< $i0@@0 (_System.array.Length $o@@5)))) ($IsBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) (IndexField $i0@@0)) _System.array$arg@@10))
 :qid |unknown.0:0|
 :skolemid |355|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) (IndexField $i0@@0)) (Tclass._System.array? _System.array$arg@@10))
)))
...
(assert (forall ((d@@4 T@U) (|_System._tuple#3GOG$T0@@7| T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_System.Tuple3GOG.___hMake3_q d@@4) (exists ((|_System._tuple#3GOG$T1@@7| T@U) (|_System._tuple#3GOG$T2@@7| T@U) ) (! ($IsAlloc DatatypeTypeType d@@4 (Tclass._System.Tuple3GOG |_System._tuple#3GOG$T0@@7| |_System._tuple#3GOG$T1@@7| |_System._tuple#3GOG$T2@@7|) $h@@5)
 :qid |unknown.0:0|
 :skolemid |814|
 :pattern ( ($IsAlloc DatatypeTypeType d@@4 (Tclass._System.Tuple3GOG |_System._tuple#3GOG$T0@@7| |_System._tuple#3GOG$T1@@7| |_System._tuple#3GOG$T2@@7|) $h@@5))
)))) ($IsAllocBox (_System.Tuple3GOG._0 d@@4) |_System._tuple#3GOG$T0@@7| $h@@5))
 :qid |unknown.0:0|
 :skolemid |815|
 :pattern ( ($IsAllocBox (_System.Tuple3GOG._0 d@@4) |_System._tuple#3GOG$T0@@7| $h@@5))
)))
(assert (forall ((d@@5 T@U) (|_System._tuple#3GOG$T1@@8| T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_System.Tuple3GOG.___hMake3_q d@@5) (exists ((|_System._tuple#3GOG$T0@@8| T@U) (|_System._tuple#3GOG$T2@@8| T@U) ) (! ($IsAlloc DatatypeTypeType d@@5 (Tclass._System.Tuple3GOG |_System._tuple#3GOG$T0@@8| |_System._tuple#3GOG$T1@@8| |_System._tuple#3GOG$T2@@8|) $h@@6)
 :qid |unknown.0:0|
 :skolemid |816|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 (Tclass._System.Tuple3GOG |_System._tuple#3GOG$T0@@8| |_System._tuple#3GOG$T1@@8| |_System._tuple#3GOG$T2@@8|) $h@@6))
)))) ($IsAllocBox (_System.Tuple3GOG._1 d@@5) |_System._tuple#3GOG$T1@@8| $h@@6))
 :qid |unknown.0:0|
 :skolemid |817|
 :pattern ( ($IsAllocBox (_System.Tuple3GOG._1 d@@5) |_System._tuple#3GOG$T1@@8| $h@@6))
)))
(assert (forall ((d@@6 T@U) (|_System._tuple#3GOG$T2@@9| T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_System.Tuple3GOG.___hMake3_q d@@6) (exists ((|_System._tuple#3GOG$T0@@9| T@U) (|_System._tuple#3GOG$T1@@9| T@U) ) (! ($IsAlloc DatatypeTypeType d@@6 (Tclass._System.Tuple3GOG |_System._tuple#3GOG$T0@@9| |_System._tuple#3GOG$T1@@9| |_System._tuple#3GOG$T2@@9|) $h@@7)
 :qid |unknown.0:0|
 :skolemid |818|
 :pattern ( ($IsAlloc DatatypeTypeType d@@6 (Tclass._System.Tuple3GOG |_System._tuple#3GOG$T0@@9| |_System._tuple#3GOG$T1@@9| |_System._tuple#3GOG$T2@@9|) $h@@7))
)))) ($IsAllocBox (_System.Tuple3GOG._2 d@@6) |_System._tuple#3GOG$T2@@9| $h@@7))
 :qid |unknown.0:0|
 :skolemid |819|
 :pattern ( ($IsAllocBox (_System.Tuple3GOG._2 d@@6) |_System._tuple#3GOG$T2@@9| $h@@7))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.UpdateSxArray)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null $Heap alloc |arr#0|)) (=> (and ($Is DatatypeTypeType |tt#0@0| (Tclass._System.Tuple3GOG TInt TInt TInt)) ($IsAlloc DatatypeTypeType |tt#0@0| (Tclass._System.Tuple3GOG TInt TInt TInt) $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |arr#0| null)) (not true))) (=> (or (not (= |arr#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 (LitInt 4)) (< (LitInt 4) (_System.array.Length |arr#0|)))) (=> (and (<= 0 (LitInt 4)) (< (LitInt 4) (_System.array.Length |arr#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |arr#0| (IndexField (LitInt 4))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |arr#0| (IndexField (LitInt 4)))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |arr#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |arr#0|) (IndexField (LitInt 4)) ($Box DatatypeTypeType |tt#0@0|)))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |arr#0| null)) (not true))) (=> (or (not (= |arr#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 5)) (< (LitInt 5) (_System.array.Length |arr#0|)))) (=> (and (<= 0 (LitInt 5)) (< (LitInt 5) (_System.array.Length |arr#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |arr#0| (IndexField (LitInt 5))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |arr#0| (Tclass._System.array (Tclass._System.Tuple3GOG TInt TInt TInt))) ($IsAlloc refType |arr#0| (Tclass._System.array (Tclass._System.Tuple3GOG TInt TInt TInt)) $Heap))) (and (and ($Is DatatypeTypeType |t#0| (Tclass._System.Tuple3GOG TInt TInt TInt)) ($IsAlloc DatatypeTypeType |t#0| (Tclass._System.Tuple3GOG TInt TInt TInt) $Heap)) (|$IsA#_System.Tuple3GOG| |t#0|))) (=> (and (and (and (and ($Is DatatypeTypeType |tt#0| (Tclass._System.Tuple3GOG TInt TInt TInt)) ($IsAlloc DatatypeTypeType |tt#0| (Tclass._System.Tuple3GOG TInt TInt TInt) $Heap)) true) (= 1 $FunctionContextHeight)) (and (<= (LitInt 10) (_System.array.Length |arr#0|)) (= (ControlFlow 0 8) 2))) anon0_correct))))
