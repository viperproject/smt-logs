// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/Signature.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/Signature-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/ghost/Signature.dfy
...
procedure {:verboseName "Test (well-formedness)"} CheckWellFormed$$_module.__default.Test(c#0: DatatypeType
       where $Is(c#0, Tclass._System.Tuple2OG(TInt, Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(c#0, Tclass._System.Tuple2OG(TInt, Tclass._System.Tuple2(TInt, TInt)), $Heap)
         && $IsA#_System.Tuple2OG(c#0));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "Test (call)"} Call$$_module.__default.Test(c#0: DatatypeType
       where $Is(c#0, Tclass._System.Tuple2OG(TInt, Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(c#0, Tclass._System.Tuple2OG(TInt, Tclass._System.Tuple2(TInt, TInt)), $Heap)
         && $IsA#_System.Tuple2OG(c#0));
  modifies $Heap;
...
procedure {:verboseName "Test (correctness)"} Impl$$_module.__default.Test(c#0: DatatypeType
       where $Is(c#0, Tclass._System.Tuple2OG(TInt, Tclass._System.Tuple2(TInt, TInt)))
         && $IsAlloc(c#0, Tclass._System.Tuple2OG(TInt, Tclass._System.Tuple2(TInt, TInt)), $Heap)
         && $IsA#_System.Tuple2OG(c#0))
