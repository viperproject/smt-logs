...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.UpdateArray)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |arr#0| (Tclass._System.array _module._default.UpdateArray$T)) ($IsAlloc refType |arr#0| (Tclass._System.array _module._default.UpdateArray$T) $Heap))) (and (and ($IsBox |t#0| _module._default.UpdateArray$T) ($IsAllocBox |t#0| _module._default.UpdateArray$T $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
