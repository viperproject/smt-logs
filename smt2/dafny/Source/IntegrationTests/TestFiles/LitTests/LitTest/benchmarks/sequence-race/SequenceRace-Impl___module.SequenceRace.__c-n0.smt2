...
(declare-fun Tagclass._module.SequenceRace? () T@U)
(declare-fun Tagclass._module.SequenceRace () T@U)
(declare-fun tytagFamily$SequenceRace () T@U)
...
(declare-fun _module.SequenceRace.s (T@U) T@U)
...
(declare-fun Tclass._module.SequenceRace? () T@U)
...
(assert (distinct TInt TagInt TagSeq alloc Tagclass._module.SequenceRace? Tagclass._module.SequenceRace tytagFamily$SequenceRace)
)
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h T@U) ($o T@U) ) (!  (=> (and (and ($IsGoodHeap $h) (and (or (not (= $o null)) (not true)) (= (dtype $o) Tclass._module.SequenceRace?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) alloc)))) ($IsAlloc SeqType (_module.SequenceRace.s $o) (TSeq TInt) $h))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |483|
 :pattern ( (_module.SequenceRace.s $o) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) alloc)))
))))
(assert (= (|Seq#Length| |Seq#Empty|) 0))
(assert (forall (($o@@0 T@U) ) (! (= ($Is refType $o@@0 Tclass._module.SequenceRace?)  (or (= $o@@0 null) (= (dtype $o@@0) Tclass._module.SequenceRace?)))
 :qid |unknown.0:0|
 :skolemid |480|
 :pattern ( ($Is refType $o@@0 Tclass._module.SequenceRace?))
)))
(assert (forall ((|c#0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0| Tclass._module.SequenceRace $h@@0) ($IsAlloc refType |c#0| Tclass._module.SequenceRace? $h@@0))
 :qid |unknown.0:0|
 :skolemid |497|
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.SequenceRace $h@@0))
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.SequenceRace? $h@@0))
)))
(assert (forall (($o@@1 T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType $o@@1 Tclass._module.SequenceRace? $h@@1)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |481|
 :pattern ( ($IsAlloc refType $o@@1 Tclass._module.SequenceRace? $h@@1))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass._module.SequenceRace?)) ($Is SeqType (_module.SequenceRace.s $o@@2) (TSeq TInt)))
 :qid |unknown.0:0|
 :skolemid |482|
 :pattern ( (_module.SequenceRace.s $o@@2))
))))
...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.SequenceRace?) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) Tclass._module.SequenceRace?)))
 :qid |unknown.0:0|
 :skolemid |479|
 :pattern ( ($IsBox bx@@1 Tclass._module.SequenceRace?))
)))
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass._module.SequenceRace) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) Tclass._module.SequenceRace)))
 :qid |unknown.0:0|
 :skolemid |485|
 :pattern ( ($IsBox bx@@2 Tclass._module.SequenceRace))
)))
(assert (forall ((|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| Tclass._module.SequenceRace)  (and ($Is refType |c#0@@0| Tclass._module.SequenceRace?) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( ($Is refType |c#0@@0| Tclass._module.SequenceRace))
 :pattern ( ($Is refType |c#0@@0| Tclass._module.SequenceRace?))
)))
...
(assert (= (Tag Tclass._module.SequenceRace?) Tagclass._module.SequenceRace?))
(assert (= (TagFamily Tclass._module.SequenceRace?) tytagFamily$SequenceRace))
(assert (= (Tag Tclass._module.SequenceRace) Tagclass._module.SequenceRace))
(assert (= (TagFamily Tclass._module.SequenceRace) tytagFamily$SequenceRace))
...
(declare-fun |x#0#lo@0| () Int)
(declare-fun |x#0#hi@0| () Int)
(declare-fun $Heap () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun this.s@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$_module.SequenceRace.__ctor)
...
(let ((anon8_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 5) 3) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct)))))
(let ((anon8_Then_correct true))
(let ((anon7_LoopBody_correct  (and (=> (= (ControlFlow 0 6) 2) anon8_Then_correct) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct))))
(let ((anon7_LoopDone_correct true))
(let ((anon7_LoopHead_correct  (=> (and (and (and (and (not false) (<= 0 |x#0@0|)) (= |x#0#lo@0| 0)) (= |x#0#hi@0| 1000)) (and (and (and (<= |x#0#lo@0| |x#0@0|) (<= |x#0@0| |x#0#hi@0|)) (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)))
 :qid |SequenceRacedfy.41:5|
 :skolemid |488|
...
))))) (and (=> (= (ControlFlow 0 7) 1) anon7_LoopDone_correct) (=> (= (ControlFlow 0 7) 6) anon7_LoopBody_correct)))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= this.s@0 (Lit SeqType |Seq#Empty|))) (and (= |x#0#lo@0| (LitInt 0)) (= |x#0#hi@0| (LitInt 1000)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= |x#0#lo@0| |x#0#hi@0|)) (=> (<= |x#0#lo@0| |x#0#hi@0|) (=> (= (ControlFlow 0 8) 7) anon7_LoopHead_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 8))) anon0_correct)))
