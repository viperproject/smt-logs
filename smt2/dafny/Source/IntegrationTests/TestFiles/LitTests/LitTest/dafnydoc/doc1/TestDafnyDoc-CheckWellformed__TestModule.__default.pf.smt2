...
(declare-fun |TestModule.__default.pf#canCall| () Bool)
(declare-fun TestModule.__default.pf () Bool)
...
(assert (distinct TBool TInt TagBool TagInt alloc Tagclass.TestModule.A? Tagclass.TestModule.A Tagclass.TestModule.T1? Tagclass.TestModule.T1 Tagclass.TestModule.T2? Tagclass.TestModule.T2 Tagclass.TestModule.T3? Tagclass.TestModule.T3 tytagFamily$A tytagFamily$T1 tytagFamily$T2 tytagFamily$T3)
)
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |TestModule.__default.pf#canCall| (< 1 $FunctionContextHeight)) (= TestModule.__default.pf (U_2_bool (Lit boolType (bool_2_U true)))))))
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |TestModule.__default.pf#canCall| (< 1 $FunctionContextHeight)) (= TestModule.__default.pf (U_2_bool (Lit boolType (bool_2_U true)))))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |TestModule.__default.pf#canCall| (< 1 $FunctionContextHeight)) (= (TestModule.__default.pp reveal_TestModule._default.pp null (LitInt 1)) (U_2_bool (Lit boolType (bool_2_U true)))))))
...
(set-info :boogie-vc-id CheckWellformed$$TestModule.__default.pf)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= (TestModule.__default.pp reveal_TestModule._default.pp null (LitInt 1)) (U_2_bool (Lit boolType (bool_2_U true)))))))
(let ((anon5_Else_correct  (=> (= TestModule.__default.pf (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and ($Is boolType (bool_2_U TestModule.__default.pf) TBool) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct))))
