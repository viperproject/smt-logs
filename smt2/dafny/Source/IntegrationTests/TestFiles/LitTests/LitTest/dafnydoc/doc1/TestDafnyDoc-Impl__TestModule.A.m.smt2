...
(declare-fun |x#0| () Int)
(set-info :boogie-vc-id Impl$$TestModule.A.m)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc this this TestModule.A.j)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U (< 0 1)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.TestModule.A) ($IsAlloc refType this Tclass.TestModule.A $Heap))) (= 0 $FunctionContextHeight)) (and (> |x#0| 0) (= (ControlFlow 0 3) 2))) anon0_correct))))
