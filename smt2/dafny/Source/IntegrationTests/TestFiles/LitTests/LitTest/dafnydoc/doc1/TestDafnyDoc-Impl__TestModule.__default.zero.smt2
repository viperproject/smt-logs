...
(set-info :boogie-vc-id Impl$$TestModule.__default.zero)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |z#0@0| (LitInt 0)) (= (ControlFlow 0 2) (- 0 1))) (= |z#0@0| (LitInt 0))))))
