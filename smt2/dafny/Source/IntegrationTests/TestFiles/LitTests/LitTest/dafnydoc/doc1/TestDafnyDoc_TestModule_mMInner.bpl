...
const unique class.TestModule_mMInner.__default: ClassName;

function TestModule_mMInner.__default.ic() : int
uses {
axiom TestModule_mMInner.__default.ic(): int == LitInt(0);
// _default.ic: Type axiom
axiom 0 < $FunctionContextHeight ==> $Is(TestModule_mMInner.__default.ic(), TInt);
}

procedure {:verboseName "TestModule.MInner.ic (well-formedness)"} CheckWellFormed$$TestModule_mMInner.__default.ic();
...
axiom 0 < $FunctionContextHeight ==> $Is(TestModule_mMInner.__default.icc(), TInt);
}

procedure {:verboseName "TestModule.MInner.icc (well-formedness)"} CheckWellFormed$$TestModule_mMInner.__default.icc();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> 
  TestModule_mMInner.__default.p#canCall() || 0 < $FunctionContextHeight
   ==> TestModule_mMInner.__default.p() == Lit(true);
...
procedure {:verboseName "TestModule.MInner.p (well-formedness)"} CheckWellformed$$TestModule_mMInner.__default.p();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id3"} 0 <= $FunctionContextHeight
   ==> 
  TestModule_mMInner.__default.f#canCall() || 0 < $FunctionContextHeight
   ==> TestModule_mMInner.__default.f() == LitInt(42 - Mul(LitInt(6), LitInt(7)));
...
procedure {:verboseName "TestModule.MInner.f (well-formedness)"} CheckWellformed$$TestModule_mMInner.__default.f();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
