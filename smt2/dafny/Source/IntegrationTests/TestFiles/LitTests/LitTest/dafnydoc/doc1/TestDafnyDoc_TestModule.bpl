...
axiom 0 < $FunctionContextHeight ==> $Is(TestModule.__default.c(), TInt);
}

procedure {:verboseName "TestModule.c (well-formedness)"} CheckWellFormed$$TestModule.__default.c();
...
axiom 0 < $FunctionContextHeight ==> $Is(TestModule.__default.cc(), TReal);
}
...
axiom 0 < $FunctionContextHeight ==> $Is(TestModule.__default.ccc(), TBool);
}
...
axiom 0 < $FunctionContextHeight
   ==> $Is(TestModule.__default.cccc(), Tclass.TestModule.A?());
}
...
axiom 0 < $FunctionContextHeight
   ==> $Is(TestModule.__default.f1(), Tclass._System.___hTotalFunc1(TInt, TInt));
}
...
axiom 0 < $FunctionContextHeight
   ==> $Is(TestModule.__default.f2(), Tclass._System.___hFunc1(TSet(TInt), TSeq(TInt)));
}
...
axiom 0 < $FunctionContextHeight
   ==> $Is(TestModule.__default.tup0(), Tclass._System.Tuple0());
}
...
axiom 0 < $FunctionContextHeight
   ==> $Is(TestModule.__default.tup2(), 
    Tclass._System.Tuple2(Tclass.TestModule.B?(TReal), TSet(TInt)));
}

procedure {:verboseName "TestModule.tup2 (well-formedness)"} CheckWellFormed$$TestModule.__default.tup2();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall r#0: real, x#0: int :: 
    { TestModule.__default.f(r#0, x#0) } 
    TestModule.__default.f#canCall(r#0, x#0) || 0 < $FunctionContextHeight
...
axiom {:id "id7"} 0 <= $FunctionContextHeight
   ==> (forall r#0: real, x#0: int :: 
    ...
    TestModule.__default.f#canCall(LitReal(r#0), LitInt(x#0))
...
procedure {:verboseName "TestModule.f (well-formedness)"} CheckWellformed$$TestModule.__default.f(r#0: real, x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures {:id "id8"} TestModule.__default.f(r#0, x#0) == LitInt(42);



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.f (well-formedness)"} CheckWellformed$$TestModule.__default.f(r#0: real, x#0: int)
{
  ...
  var ##x#0: int;
    ...
    if (*)
    {
        ...
        assert {:id "id9"} 0e0 <= r#0 || ##r#0 == r#0;
        assert {:id "id10"} 0 <= x#0 || ##r#0 <= r#0 - 1e0 || ##x#0 == x#0;
        assert {:id "id11"} (r#0 == r#0 && x#0 == x#0)
           || 
          ##r#0 <= r#0 - 1e0
           || (##r#0 == r#0 && ##x#0 < x#0);
        assume (r#0 == r#0 && x#0 == x#0) || TestModule.__default.f#canCall(r#0, x#0);
        assume {:id "id12"} TestModule.__default.f(r#0, x#0) == LitInt(42);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id13"} TestModule.__default.f(r#0, x#0) == LitInt(42);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(TestModule.__default.f(r#0, x#0), TInt);
        return;
...
axiom 0 <= $FunctionContextHeight
   ==> (forall $reveal: bool, a#0: ref, x#0: int :: 
    { TestModule.__default.pp($reveal, a#0, x#0) } 
    TestModule.__default.pp#canCall(a#0, x#0)
         || (0 < $FunctionContextHeight && $Is(a#0, Tclass.TestModule.A?()))
...
procedure {:verboseName "TestModule.pp (well-formedness)"} CheckWellformed$$TestModule.__default.pp(a#0: ref where $Is(a#0, Tclass.TestModule.A?()), x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures (forall $olderHeap: Heap :: 
    ...
    $IsGoodHeap($olderHeap)
         && $OlderTag($olderHeap)
         && TestModule.__default.pp(reveal_TestModule._default.pp, a#0, x#0)
       ==> $IsAlloc(a#0, Tclass.TestModule.A?(), $olderHeap));



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.pp (well-formedness)"} CheckWellformed$$TestModule.__default.pp(a#0: ref, x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id16"} TestModule.__default.pp(reveal_TestModule._default.pp, a#0, x#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(TestModule.__default.pp(reveal_TestModule._default.pp, a#0, x#0), TBool);
        return;
...
axiom {:id "id18"} 1 <= $FunctionContextHeight
   ==> (forall z#0: ref :: 
    ...
    TestModule.__default.fif#canCall(Lit(z#0))
         || (1 < $FunctionContextHeight && $Is(z#0, Tclass.TestModule.A()))
...
procedure {:verboseName "TestModule.fif (well-formedness)"} CheckWellformed$$TestModule.__default.fif(z#0: ref where $Is(z#0, Tclass.TestModule.A()));
...
procedure {:verboseName "TestModule.tf (well-formedness)"} CheckWellformed$$TestModule.__default.tf(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TestModule.A())
         && $IsAlloc(a#0, Tclass.TestModule.A(), previous$Heap), 
    b#0: ref
       where $Is(b#0, Tclass.TestModule.A())
         && $IsAlloc(b#0, Tclass.TestModule.A(), current$Heap));
  free requires 1 == $FunctionContextHeight;
...
axiom 0 <= $FunctionContextHeight
   ==> 
  TestModule.__default.p#canCall() || 0 < $FunctionContextHeight
   ==> Lit(TestModule.__default.p()) == Lit(true);
// definition axiom for TestModule.__default.p (revealed)
axiom {:id "id23"} 0 <= $FunctionContextHeight
   ==> 
  TestModule.__default.p#canCall() || 0 < $FunctionContextHeight
   ==> TestModule.__default.p() == Lit(true);
...
procedure {:verboseName "TestModule.p (well-formedness)"} CheckWellformed$$TestModule.__default.p();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures {:id "id25"} Lit(TestModule.__default.p()) == Lit(true);



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.p (well-formedness)"} CheckWellformed$$TestModule.__default.p()
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    {
        // Check well-formedness of postcondition and assume false
        assert {:id "id26"} Lit(true);
        assume Lit(true) || TestModule.__default.p#canCall();
        assume {:id "id27"} Lit(TestModule.__default.p()) == Lit(true);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id28"} TestModule.__default.p() == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(TestModule.__default.p(), TBool);
        return;
...
axiom 1 <= $FunctionContextHeight
   ==> 
  TestModule.__default.pf#canCall() || 1 < $FunctionContextHeight
   ==> TestModule.__default.pp(reveal_TestModule._default.pp, null, LitInt(1))
     == Lit(true);
// definition axiom for TestModule.__default.pf (revealed)
axiom {:id "id29"} 1 <= $FunctionContextHeight
   ==> 
  TestModule.__default.pf#canCall() || 1 < $FunctionContextHeight
   ==> TestModule.__default.pf() == Lit(true);
...
procedure {:verboseName "TestModule.pf (well-formedness)"} CheckWellformed$$TestModule.__default.pf();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  ensures {:id "id31"} TestModule.__default.pp(reveal_TestModule._default.pp, null, LitInt(1))
     == Lit(true);



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.pf (well-formedness)"} CheckWellformed$$TestModule.__default.pf()
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##a#0: ref;
  ...
  var ##x#0: int;
    ...
    if (*)
    {
        ...
        ##a#0 := null;
        // assume allocatedness for argument to function
        assume $IsAlloc(##a#0, Tclass.TestModule.A?(), $Heap);
        ##x#0 := LitInt(1);
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assume TestModule.__default.pp#canCall(null, LitInt(1));
        assume {:id "id32"} TestModule.__default.pp(reveal_TestModule._default.pp, null, LitInt(1))
           == Lit(true);
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id33"} TestModule.__default.pf() == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(TestModule.__default.pf(), TBool);
        return;
...
axiom {:id "id34"} 1 <= $FunctionContextHeight
   ==> (forall s#0: Seq, ss#0: Set, mm#0: Map :: 
...
procedure {:verboseName "TestModule.ppp (well-formedness)"} CheckWellformed$$TestModule.__default.ppp(s#0: Seq where $Is(s#0, TSeq(TInt)), 
    ss#0: Set where $Is(ss#0, TSet(Tclass.TestModule.A?())), 
    mm#0: Map
       where $Is(mm#0, TMap(TSet(Tclass.TestModule.A()), TSeq(TSet(Tclass.TestModule.A?())))));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id37"} 0 <= $FunctionContextHeight
   ==> 
  TestModule.__default.lp#canCall() || 0 < $FunctionContextHeight
   ==> TestModule.__default.lp() == Lit(false);
}
...
procedure {:verboseName "TestModule.lp (well-formedness)"} CheckWellformed$$TestModule.__default.lp();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id39"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: Box :: 
    { TestModule.__default.lp_h(_k#0) } 
    TestModule.__default.lp_h#canCall(_k#0) || 1 < $FunctionContextHeight
       ==> (
          (0 < ORD#Offset(_k#0)
           ==> false)
           ==> 
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#0: Box :: 
            { TestModule.__default.lp_h(_k'#0) } 
            ORD#LessThanLimit(_k'#0, _k#0) ==> TestModule.__default.lp_h#canCall(_k'#0)))
         && TestModule.__default.lp_h(_k#0)
           == ((0 < ORD#Offset(_k#0) ==> false)
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (exists _k'#0: Box :: 
                { TestModule.__default.lp_h(_k'#0) } 
                ORD#LessThanLimit(_k'#0, _k#0) && TestModule.__default.lp_h(_k'#0)))));
...
axiom {:id "id40"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: Box :: 
    ...
    TestModule.__default.lp_h#canCall(Lit(_k#0)) || 1 < $FunctionContextHeight
       ==> (
          (0 < ORD#Offset(_k#0)
           ==> false)
           ==> 
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#1: Box :: 
            { TestModule.__default.lp_h(_k'#1) } 
            ORD#LessThanLimit(_k'#1, _k#0) ==> TestModule.__default.lp_h#canCall(_k'#1)))
         && TestModule.__default.lp_h(Lit(_k#0))
           == ((0 < ORD#Offset(_k#0) ==> false)
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (exists _k'#1: Box :: 
                { TestModule.__default.lp_h(_k'#1) } 
                ORD#LessThanLimit(_k'#1, _k#0) && TestModule.__default.lp_h(_k'#1)))));
}
...
procedure {:verboseName "TestModule.bump (well-formedness)"} CheckWellFormed$$TestModule.__default.bump(i#0: int) returns (j#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestModule.bump (call)"} Call$$TestModule.__default.bump(i#0: int) returns (j#0: int);
  modifies $Heap;
...
procedure {:verboseName "TestModule.bump (correctness)"} Impl$$TestModule.__default.bump(i#0: int) returns (j#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "TestModule.ModifyA (well-formedness)"} CheckWellFormed$$TestModule.__default.ModifyA(a#0: ref
       where $Is(a#0, Tclass.TestModule.A()) && $IsAlloc(a#0, Tclass.TestModule.A(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.ModifyA (well-formedness)"} CheckWellFormed$$TestModule.__default.ModifyA(a#0: ref)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: ModifyA, CheckWellFormed$$TestModule.__default.ModifyA
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> $o == a#0 || ($o == a#0 && $f == TestModule.A.j));
    assert {:id "id42"} a#0 != null;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
         ==> $Heap[$o] == old($Heap)[$o] || $o == a#0 || $o == a#0);
    assume (forall $o: ref, $f: Field :: 
      ...
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
         ==> read($Heap, $o, $f) == read(old($Heap), $o, $f)
           || 
          $o == a#0
           || ($o == a#0 && $f == TestModule.A.j));
    assume $HeapSucc(old($Heap), $Heap);
}



procedure {:verboseName "TestModule.ModifyA (call)"} Call$$TestModule.__default.ModifyA(a#0: ref
       where $Is(a#0, Tclass.TestModule.A()) && $IsAlloc(a#0, Tclass.TestModule.A(), $Heap));
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "TestModule.ModifyA (correctness)"} Impl$$TestModule.__default.ModifyA(a#0: ref
       where $Is(a#0, Tclass.TestModule.A()) && $IsAlloc(a#0, Tclass.TestModule.A(), $Heap))
...
procedure {:verboseName "TestModule.zero (well-formedness)"} CheckWellFormed$$TestModule.__default.zero() returns (z#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestModule.zero (call)"} Call$$TestModule.__default.zero() returns (z#0: int);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id44"} z#0 == LitInt(0);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
procedure {:verboseName "TestModule.zero (correctness)"} Impl$$TestModule.__default.zero() returns (z#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id45"} z#0 == LitInt(0);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.zero (correctness)"} Impl$$TestModule.__default.zero() returns (z#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: zero, Impl$$TestModule.__default.zero
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- return statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafnydoc/doc1/TestDafnyDoc.dfy(124,5)
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafnydoc/doc1/TestDafnyDoc.dfy(124,5)
    assume true;
    assume true;
    z#0 := LitInt(0);
    return;
...
procedure {:verboseName "TestModule.IsX (well-formedness)"} CheckWellFormed$$TestModule.__default.IsX();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestModule.IsX (call)"} Call$$TestModule.__default.IsX();
  // user-defined preconditions
  requires {:id "id49"} Lit(true);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id50"} Lit(true);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "TestModule.TS (well-formedness)"} CheckWellFormed$$TestModule.__default.TS(previous$Heap: Heap, current$Heap: Heap);
  free requires 0 == $FunctionContextHeight;
  free requires previous$Heap == $Heap
     && 
    $HeapSucc(previous$Heap, current$Heap)
...
procedure {:verboseName "TestModule.TS (call)"} Call$$TestModule.__default.TS(previous$Heap: Heap, current$Heap: Heap);
  // user-defined preconditions
  requires {:id "id53"} Lit(true);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id54"} Lit(true);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "TestModule.reveal_pp (well-formedness)"} {:verify false} CheckWellFormed$$TestModule.__default.reveal__pp();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestModule.reveal_pp (call)"} {:verify false} Call$$TestModule.__default.reveal__pp();
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures reveal_TestModule._default.pp;
...
procedure {:verboseName "TestModule.T.m (correctness)"} Impl$$TestModule.T.m(this: Box
       where $IsBox(this, Tclass.TestModule.T())
         && $IsAllocBox(this, Tclass.TestModule.T(), $Heap))
   returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
...
procedure {:verboseName "TestModule.Small (well-formedness)"} CheckWellFormed$$TestModule.Small(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.Small (well-formedness)"} CheckWellFormed$$TestModule.Small(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
    ...
    if (*)
    {
        ...
        assert {:id "id56"} LitInt(0) <= newtype$check#0;
        assume true;
        assert {:id "id57"} Lit(0 < 100);
        assume false;
    }
}
...
procedure {:verboseName "TestModule.SmallW (well-formedness)"} CheckWellFormed$$TestModule.SmallW(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.SmallW (well-formedness)"} CheckWellFormed$$TestModule.SmallW(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
    ...
    // AddWellformednessCheck for subset type SmallW
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
    ...
    if (*)
    {
        ...
        assert {:id "id60"} LitInt(0) <= newtype$check#1;
        assume true;
        assert {:id "id61"} Lit(99 < 100);
        assume false;
    }
}
...
procedure {:verboseName "TestModule.SmallS (well-formedness)"} CheckWellFormed$$TestModule.SmallS(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "TestModule.Smaller (well-formedness)"} CheckWellFormed$$TestModule.Smaller(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.Smaller (well-formedness)"} CheckWellFormed$$TestModule.Smaller(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;


    // AddWellformednessCheck for newtype Smaller
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
    ...
    if (*)
    {
        ...
        assert {:id "id64"} LitInt(0) <= newtype$check#0;
        assume true;
        assert {:id "id65"} Lit(9 < 10);
        assume false;
    }
}
...
procedure {:verboseName "TestModule.Dup (well-formedness)"} CheckWellFormed$$TestModule.Dup();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom (forall c0#0: int :: 
  { $Is(c0#0, Tclass.TestModule.Dup()) } 
  $Is(c0#0, Tclass.TestModule.Dup()) <==> Lit(true));

// $IsAlloc axiom for newtype TestModule.Dup
axiom (forall c1#0: int, $h: Heap :: 
  { $IsAlloc(c1#0, Tclass.TestModule.Dup(), $h) } 
  $IsAlloc(c1#0, Tclass.TestModule.Dup(), $h));
...
axiom {:id "id66"} 0 <= $FunctionContextHeight
   ==> (forall this: int :: 
    ...
    TestModule.Dup.IsEven#canCall(this) || (0 < $FunctionContextHeight && Lit(true))
...
axiom {:id "id67"} 0 <= $FunctionContextHeight
   ==> (forall this: int :: 
    ...
    TestModule.Dup.IsEven#canCall(LitInt(this))
...
procedure {:verboseName "TestModule.Dup.IsEven (well-formedness)"} CheckWellformed$$TestModule.Dup.IsEven(this: int where Lit(true));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.Dup.IsEven (well-formedness)"} CheckWellformed$$TestModule.Dup.IsEven(this: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: int;
  var newtype$check#2: int;
    ...
    else
    {
        ...
        newtype$check#1 := Mod(this, LitInt(2));
        newtype$check#2 := LitInt(0);
        assume {:id "id69"} TestModule.Dup.IsEven(this) == (Mod(this, LitInt(2)) == LitInt(0));
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(TestModule.Dup.IsEven(this), TBool);
        return;
...
procedure {:verboseName "TestModule.Size (well-formedness)"} CheckWellFormed$$TestModule.Size(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.Size (well-formedness)"} CheckWellFormed$$TestModule.Size(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype Size
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        ...
        assume {:id "id70"} LitInt(0) <= x#0 && x#0 < 1000;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id72"} {:subsumption 0} Lit(0 < 1000);
        assume false;
    }
}
...
procedure {:verboseName "TestModule.Gen._ctor (well-formedness)"} CheckWellFormed$$TestModule.Gen.__ctor(start#0: int) returns (this: ref);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "TestModule.Gen._ctor (call)"} Call$$TestModule.Gen.__ctor(start#0: int)
   returns (this: ref
       where this != null
         && 
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id80"} TestModule.Gen.start(this) == start#0;
  free ensures true;
  ensures {:id "id81"} Seq#Equal($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq, Seq#Empty(): Seq);
  free ensures TestModule.Gen.Valid#canCall($Heap, this);
  ensures {:id "id82"} TestModule.Gen.Valid($Heap, this);
  free ensures true;
  ensures {:id "id83"} Set#Equal(TestModule.Gen.__reads(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id84"} Set#Equal(TestModule.Gen.__modifies(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id85"} Set#Equal($Unbox(read($Heap, this, TestModule.Gen.__new)): Set, Set#Empty(): Set);
  free ensures true;
  ensures {:id "id86"} TestModule.Gen.__decreases0(this) == start#0;
...
procedure {:verboseName "TestModule.Gen.Valid (well-formedness)"} CheckWellformed$$TestModule.Gen.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.Gen())
         && $IsAlloc(this, Tclass.TestModule.Gen(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.Gen.Valid (well-formedness)"} CheckWellformed$$TestModule.Gen.Valid(this: ref)
{
  var $_ReadsFrame: [ref,Field]bool;
  var b$reqreads#0: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> $o == this
           || Set#IsMember(TestModule.Gen.__reads(this), $Box($o))
           || Set#IsMember($Unbox(read($Heap, this, TestModule.Gen.__new)): Set, $Box($o)));
    // Check well-formedness of preconditions, and then assume them
    // Check well-formedness of the reads clause
    b$reqreads#0 := $_ReadsFrame[this, TestModule.Gen.__new];
    assert {:id "id87"} b$reqreads#0;
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    {
...
procedure {:verboseName "TestModule.Gen.MoveNext (call)"} Call$$TestModule.Gen.MoveNext(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.Gen())
         && $IsAlloc(this, Tclass.TestModule.Gen(), $Heap))
   returns (more#0: bool);
  // user-defined preconditions
  requires {:id "id88"} TestModule.Gen.Valid($Heap, this);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id89"} (forall $o: ref :: 
      { $o != null } 
      Set#IsMember($Unbox(read($Heap, this, TestModule.Gen.__new)): Set, $Box($o))
           && !Set#IsMember($Unbox(read(old($Heap), this, TestModule.Gen.__new)): Set, $Box($o))
         ==> $o != null)
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, TestModule.Gen.__new)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id90"} !Set#IsMember($Unbox(read($Heap, this, TestModule.Gen.__new)): Set, $Box(null));
  free ensures more#0 ==> TestModule.Gen.Valid#canCall($Heap, this);
  ensures {:id "id91"} more#0 ==> TestModule.Gen.Valid($Heap, this);
  free ensures true;
  ensures {:id "id92"} Seq#Equal($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq, 
    (if more#0
       then Seq#Append($Unbox(read(old($Heap), this, TestModule.Gen.xs)): Seq, 
        Seq#Build(Seq#Empty(): Seq, read($Heap, this, TestModule.Gen.x)))
       else $Unbox(read(old($Heap), this, TestModule.Gen.xs)): Seq));
  free ensures true;
  ensures {:id "id93"} more#0
     ==> Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq) <= LitInt(10);
  ensures {:id "id94"} more#0
     ==> $Unbox(read($Heap, this, TestModule.Gen.x)): int
       == TestModule.Gen.start(this)
           + Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq)
         - 1;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
       ==> $Heap[$o] == old($Heap)[$o]
         || 
        $o == this
         || Set#IsMember(TestModule.Gen.__modifies(this), $Box($o))
         || Set#IsMember($Unbox(read(old($Heap), this, TestModule.Gen.__new)): Set, $Box($o)));
  // boilerplate
  free ensures $HeapSucc(old($Heap), $Heap);
...
procedure {:verboseName "TestModule.Gen (correctness)"} Impl$$TestModule.Gen(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.Gen())
         && $IsAlloc(this, Tclass.TestModule.Gen(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.Gen (correctness)"} Impl$$TestModule.Gen(this: ref, start#0: int)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var _yieldCount#0: int
     where _yieldCount#0 == Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq);
  ...
  var $rhs#0_0: int;
    ...
    assume {:id "id105"} TestModule.Gen.start(this) == start#0;
    assume {:id "id106"} Seq#Equal($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq, Seq#Empty(): Seq);
    assume {:id "id107"} TestModule.Gen.Valid($Heap, this);
    assume {:id "id108"} Set#Equal(TestModule.Gen.__reads(this), Set#Empty(): Set);
    assume {:id "id109"} Set#Equal(TestModule.Gen.__modifies(this), Set#Empty(): Set);
    assume {:id "id110"} Set#Equal($Unbox(read($Heap, this, TestModule.Gen.__new)): Set, Set#Empty(): Set);
    assume {:id "id111"} TestModule.Gen.__decreases0(this) == start#0;
    assume _yieldCount#0 == 0;
    call $YieldHavoc(this, TestModule.Gen.__reads(this), $Unbox(read($Heap, this, TestModule.Gen.__new)): Set);
    $_OldIterHeap := $Heap;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafnydoc/doc1/TestDafnyDoc.dfy(130,11)
    assume true;
    assume true;
    i#0 := LitInt(0);
    // ----- while statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafnydoc/doc1/TestDafnyDoc.dfy(131,5)
    // Assume Fuel Constant
    $PreLoopHeap$loop#0 := $Heap;
    $decr_init$loop#00 := _yieldCount#0;
    $decr_init$loop#01 := 10 - i#0;
    havoc $w$loop#0;
    while (true)
      free invariant true;
      invariant {:id "id114"} $w$loop#0
         ==> Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq) == i#0;
      ...
      free invariant _yieldCount#0 >= $decr_init$loop#00
         && (_yieldCount#0 == $decr_init$loop#00 ==> 10 - i#0 <= $decr_init$loop#01);
    {
        if (!$w$loop#0)
        {
            assume true;
            assume {:id "id113"} Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq) == i#0;
            assume true;
            assume true;
            assume false;
        }
        ...
        $decr$loop#01 := 10 - i#0;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafnydoc/doc1/TestDafnyDoc.dfy(132,9)
        assume true;
        assert {:id "id115"} $_ModifiesFrame[this, TestModule.Gen.x];
        assume true;
        $rhs#0_0 := TestModule.Gen.start(this) + i#0;
        $Heap := update($Heap, this, TestModule.Gen.x, $Box($rhs#0_0));
        assume $IsGoodHeap($Heap);
        // ----- yield statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafnydoc/doc1/TestDafnyDoc.dfy(133,7)
        $Heap := update($Heap, 
          this, 
          TestModule.Gen.xs, 
          $Box(Seq#Append($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq, 
              Seq#Build(Seq#Empty(): Seq, read($Heap, this, TestModule.Gen.x)))));
        _yieldCount#0 := _yieldCount#0 + 1;
        assume _yieldCount#0 == Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq);
        assume $IsGoodHeap($Heap);
        assert {:id "id118"} {:subsumption 0} Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq) <= LitInt(10);
        assert {:id "id119"} {:subsumption 0} $Unbox(read($Heap, this, TestModule.Gen.x)): int
           == TestModule.Gen.start(this)
               + Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq)
             - 1;
        assume {:id "id120"} Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq) <= LitInt(10)
           && $Unbox(read($Heap, this, TestModule.Gen.x)): int
             == TestModule.Gen.start(this)
                 + Seq#Length($Unbox(read($Heap, this, TestModule.Gen.xs)): Seq)
               - 1;
        call $YieldHavoc(this, TestModule.Gen.__reads(this), $Unbox(read($Heap, this, TestModule.Gen.__new)): Set);
        $_OldIterHeap := $Heap;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafnydoc/doc1/TestDafnyDoc.dfy(134,9)
        assume true;
        assume true;
        i#0 := i#0 + 1;
        // ----- loop termination check ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafnydoc/doc1/TestDafnyDoc.dfy(131,5)
        assert {:id "id122"} 0 <= $decr$loop#01 || _yieldCount#0 > $decr$loop#00 || 10 - i#0 == $decr$loop#01;
        assert {:id "id123"} _yieldCount#0 > $decr$loop#00
           || (_yieldCount#0 == $decr$loop#00 && 10 - i#0 < $decr$loop#01);
        assume true;
    }
}
...
procedure {:verboseName "TestModule.A.c (well-formedness)"} CheckWellFormed$$TestModule.A.c(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
         && $IsAlloc(this, Tclass.TestModule.A(), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestModule.A.m (well-formedness)"} CheckWellFormed$$TestModule.A.m(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
         && $IsAlloc(this, Tclass.TestModule.A(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.A.m (well-formedness)"} CheckWellFormed$$TestModule.A.m(this: ref, x#0: int)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: m, CheckWellFormed$$TestModule.A.m
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> $o == this || ($o == this && $f == TestModule.A.j));
    assume {:id "id124"} x#0 > 0;
    assert {:id "id125"} this != null;
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
    ...
    assume (forall $o: ref, $f: Field :: 
      ...
      $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
         ==> read($Heap, $o, $f) == read(old($Heap), $o, $f)
           || 
          $o == this
           || ($o == this && $f == TestModule.A.j));
    assume $HeapSucc(old($Heap), $Heap);
    assume {:id "id126"} Lit(0 < 1);
}



procedure {:verboseName "TestModule.A.m (call)"} Call$$TestModule.A.m(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
         && $IsAlloc(this, Tclass.TestModule.A(), $Heap), 
    x#0: int);
  // user-defined preconditions
  requires {:id "id127"} x#0 > 0;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id128"} Lit(0 < 1);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
procedure {:verboseName "TestModule.A.m (correctness)"} Impl$$TestModule.A.m(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
         && $IsAlloc(this, Tclass.TestModule.A(), $Heap), 
  ...
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id129"} x#0 > 0;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id130"} Lit(0 < 1);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.A.m (correctness)"} Impl$$TestModule.A.m(this: ref, x#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: m, Impl$$TestModule.A.m
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> $o == this || ($o == this && $f == TestModule.A.j));
    $_reverifyPost := false;
...
axiom {:id "id131"} 0 <= $FunctionContextHeight
   ==> (forall TestModule.A.f$Q: Ty, this: ref :: 
    { TestModule.A.f(TestModule.A.f$Q, this) } 
    TestModule.A.f#canCall(TestModule.A.f$Q, this)
         || (0 < $FunctionContextHeight && this != null && $Is(this, Tclass.TestModule.A()))
...
procedure {:verboseName "TestModule.A.f (well-formedness)"} CheckWellformed$$TestModule.A.f(TestModule.A.f$Q: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
...
procedure {:verboseName "TestModule.A.ftr (well-formedness)"} CheckWellformed$$TestModule.A.ftr(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
         && $IsAlloc(this, Tclass.TestModule.A(), $Heap));
...
procedure {:verboseName "TestModule.A.ftr (override check)"} OverrideCheck$$TestModule.A.ftr(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
         && $IsAlloc(this, Tclass.TestModule.A(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.A.ftr (override check)"} OverrideCheck$$TestModule.A.ftr(this: ref)
{
  var A_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id137"} true;
...
procedure {:verboseName "TestModule.A._ctor (well-formedness)"} CheckWellFormed$$TestModule.A.__ctor() returns (this: ref);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestModule.A._ctor (call)"} Call$$TestModule.A.__ctor()
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
...
procedure {:verboseName "TestModule.A._ctor (correctness)"} Impl$$TestModule.A.__ctor() returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "TestModule.A.A (well-formedness)"} CheckWellFormed$$TestModule.A._A(i#0: int) returns (this: ref);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestModule.A.A (call)"} Call$$TestModule.A._A(i#0: int)
   returns (this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
...
procedure {:verboseName "TestModule.A.A (correctness)"} Impl$$TestModule.A._A(i#0: int) returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "TestModule.A.reveal_c (well-formedness)"} {:verify false} CheckWellFormed$$TestModule.A.reveal__c(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
         && $IsAlloc(this, Tclass.TestModule.A(), $Heap));
...
procedure {:verboseName "TestModule.A.reveal_c (call)"} {:verify false} Call$$TestModule.A.reveal__c(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.A())
         && $IsAlloc(this, Tclass.TestModule.A(), $Heap));
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id140"} TestModule.A.c(this) == LitInt(42);
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure {:verboseName "TestModule.B.ftr (well-formedness)"} CheckWellformed$$TestModule.B.ftr(TestModule.B$Z: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.B(TestModule.B$Z))
         && $IsAlloc(this, Tclass.TestModule.B(TestModule.B$Z), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TestModule.B.ftr (override check)"} OverrideCheck$$TestModule.B.ftr(TestModule.B$Z: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.B(TestModule.B$Z))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TestModule.B.ftr (override check)"} OverrideCheck$$TestModule.B.ftr(TestModule.B$Z: Ty, this: ref)
{
  var B_$_ReadsFrame: [ref,Field]bool;

    assert {:id "id144"} true;
...
// T1.one: Type axiom
axiom 0 < $FunctionContextHeight
   ==> (forall TestModule.T1$TR: Ty, $o: ref :: 
...
axiom 0 < $FunctionContextHeight
   ==> (forall TestModule.T1$TR: Ty, $h: Heap, $o: ref :: 
...
procedure {:verboseName "TestModule.T1.one (well-formedness)"} CheckWellFormed$$TestModule.T1.one(TestModule.T1$TR: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.T1(TestModule.T1$TR))
         && $IsAlloc(this, Tclass.TestModule.T1(TestModule.T1$TR), $Heap));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "TestModule.T3.ftr (well-formedness)"} CheckWellformed$$TestModule.T3.ftr(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.T3())
         && $IsAlloc(this, Tclass.TestModule.T3(), $Heap));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "TestModule.T3.ftz (well-formedness)"} CheckWellformed$$TestModule.T3.ftz(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.T3())
         && $IsAlloc(this, Tclass.TestModule.T3(), $Heap));
...
procedure {:verboseName "TestModule.T3.mmm (well-formedness)"} CheckWellFormed$$TestModule.T3.mmm(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.T3())
         && $IsAlloc(this, Tclass.TestModule.T3(), $Heap));
...
procedure {:verboseName "TestModule.T3.mmm (call)"} Call$$TestModule.T3.mmm(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.T3())
         && $IsAlloc(this, Tclass.TestModule.T3(), $Heap));
...
procedure {:verboseName "TestModule.T3.mmm (correctness)"} Impl$$TestModule.T3.mmm(this: ref
       where this != null
         && 
        $Is(this, Tclass.TestModule.T3())
         && $IsAlloc(this, Tclass.TestModule.T3(), $Heap))
...
axiom {:id "id149"} TestModule_mMInner.__default.p() == Lit(true);
// definition axiom for TestModule_mMInner.__default.p for all literals (revealed)
axiom {:id "id150"} TestModule_mMInner.__default.p() == Lit(true);
}
...
axiom {:id "id151"} TestModule_mMInner.__default.f() == LitInt(42 - Mul(LitInt(6), LitInt(7)));
// definition axiom for TestModule_mMInner.__default.f for all literals (revealed)
axiom {:id "id152"} TestModule_mMInner.__default.f() == LitInt(42 - Mul(LitInt(6), LitInt(7)));
}
