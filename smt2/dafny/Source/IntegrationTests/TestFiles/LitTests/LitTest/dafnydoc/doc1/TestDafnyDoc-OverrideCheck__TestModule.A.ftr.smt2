...
(assert (distinct alloc Tagclass.TestModule.A? Tagclass.TestModule.A Tagclass.TestModule.T1? Tagclass.TestModule.T1 Tagclass.TestModule.T2? Tagclass.TestModule.T2 Tagclass.TestModule.T3? Tagclass.TestModule.T3 tytagFamily$A tytagFamily$T1 tytagFamily$T2 tytagFamily$T3)
)
...
(set-info :boogie-vc-id OverrideCheck$$TestModule.A.ftr)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (and (= A_$_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (forall (($o@@16 T@U) ($f@@0 T@U) ) (! true
 :qid |TestDafnyDocdfy.150:15|
 :skolemid |3702|
))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.TestModule.A) ($IsAlloc refType this Tclass.TestModule.A $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
