...
(declare-fun Tagclass.TestModule.B? () T@U)
(declare-fun Tagclass.TestModule.A () T@U)
(declare-fun Tagclass.TestModule.B () T@U)
...
(declare-fun Tclass.TestModule.B (T@U) T@U)
(declare-fun Tclass.TestModule.B? (T@U) T@U)
...
(declare-fun Tclass.TestModule.B?_0 (T@U) T@U)
(declare-fun Tclass.TestModule.B_0 (T@U) T@U)
