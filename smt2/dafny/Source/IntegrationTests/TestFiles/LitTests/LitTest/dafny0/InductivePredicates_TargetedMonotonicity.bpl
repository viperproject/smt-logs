...
procedure {:verboseName "TargetedMonotonicity.Next (well-formedness)"} CheckWellformed$$TargetedMonotonicity.__default.Next(x#0: int);
...
procedure {:verboseName "TargetedMonotonicity.P (well-formedness)"} CheckWellformed$$TargetedMonotonicity.__default.P(x#0: int, y#0: int, z#0: int);
...
procedure {:verboseName "TargetedMonotonicity.Deterministic (well-formedness)"} CheckWellFormed$$TargetedMonotonicity.__default.Deterministic(x#0: int, y#0: int, z#0: int, z'#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TargetedMonotonicity.Deterministic (call)"} Call$$TargetedMonotonicity.__default.Deterministic(x#0: int, y#0: int, z#0: int, z'#0: int);
  // user-defined preconditions
  requires {:id "id117"} TargetedMonotonicity.__default.P#canCall(x#0, y#0, z#0)
  ...
  requires {:id "id118"} TargetedMonotonicity.__default.P#canCall(x#0, y#0, z'#0)
     ==> TargetedMonotonicity.__default.P($LS($LZ), x#0, y#0, z'#0)
       || 
      (x#0 == LitInt(0) && y#0 == z'#0)
       || (x#0 != 0
  ...
  free ensures true;
  ensures {:id "id119"} z#0 == z'#0;
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "TargetedMonotonicity.Deterministic# (co-call)"} CoCall$$TargetedMonotonicity.__default.Deterministic_h(_k#0: Box, x#1: int, y#1: int, z#1: int, z'#1: int);
  // user-defined preconditions
  requires {:id "id120"} TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z#1)
         ...
         ==> (x#1 == LitInt(0) && y#1 == z#1)
           || (x#1 != 0
             && TargetedMonotonicity.__default.P_h($LS($LS($LZ)), 
              ...
              y#1, 
              z#1)));
  requires {:id "id121"} TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z#1)
     ==> TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z#1)
       || (LitInt(0) == ORD#Offset(_k#0)
         ==> (exists _k'#0: Box :: 
          { TargetedMonotonicity.__default.P_h($LS($LZ), _k'#0, x#1, y#1, z#1) } 
          ORD#LessThanLimit(_k'#0, _k#0)
             && TargetedMonotonicity.__default.P_h($LS($LZ), _k'#0, x#1, y#1, z#1)));
  requires {:id "id122"} TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z'#1)
     ==> TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z'#1)
       || (0 < ORD#Offset(_k#0)
         ==> (x#1 == LitInt(0) && y#1 == z'#1)
           || (x#1 != 0
             && TargetedMonotonicity.__default.P_h($LS($LS($LZ)), 
              ...
              y#1, 
              z'#1)));
  requires {:id "id123"} TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z'#1)
     ==> TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z'#1)
       || (LitInt(0) == ORD#Offset(_k#0)
         ==> (exists _k'#1: Box :: 
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id124"} z#1 == z'#1;
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "TargetedMonotonicity.Deterministic# (correctness)"} Impl$$TargetedMonotonicity.__default.Deterministic_h(_k#0: Box, x#1: int, y#1: int, z#1: int, z'#1: int)
   returns ($_reverifyPost: bool);
  free requires 3 == $FunctionContextHeight;
  // user-defined preconditions
  free requires {:id "id125"} TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z#1)
     && 
    TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z#1)
     && 
    (0 < ORD#Offset(_k#0)
     ...
     && (LitInt(0) == ORD#Offset(_k#0)
       ==> (exists _k'#2: Box :: 
        ...
        ORD#LessThanLimit(_k'#2, _k#0)
           && TargetedMonotonicity.__default.P_h($LS($LZ), _k'#2, x#1, y#1, z#1)));
  free requires {:id "id126"} TargetedMonotonicity.__default.P_h#canCall(_k#0, x#1, y#1, z'#1)
     && 
    TargetedMonotonicity.__default.P_h($LS($LZ), _k#0, x#1, y#1, z'#1)
     && 
    (0 < ORD#Offset(_k#0)
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id127"} z#1 == z'#1;
  // frame condition
  free ensures old($Heap) == $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TargetedMonotonicity.Deterministic# (correctness)"} Impl$$TargetedMonotonicity.__default.Deterministic_h(_k#0: Box, x#1: int, y#1: int, z#1: int, z'#1: int)
   returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    assume (forall $ih#_k0#0: Box, $ih#x0#0: int, $ih#y0#0: int, $ih#z0#0: int, $ih#z'0#0: int :: 
      { TargetedMonotonicity.__default.P_h($LS($LZ), $ih#_k0#0, $ih#x0#0, $ih#y0#0, $ih#z'0#0), TargetedMonotonicity.__default.P_h($LS($LZ), $ih#_k0#0, $ih#x0#0, $ih#y0#0, $ih#z0#0) } 
      TargetedMonotonicity.__default.P_h($LS($LZ), $ih#_k0#0, $ih#x0#0, $ih#y0#0, $ih#z0#0)
         ...
         ==> $ih#z0#0 == $ih#z'0#0);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/InductivePredicates.dfy(246,3)
    assume true;
    ...
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/InductivePredicates.dfy(246,3)
        $initHeapForallStmt#1_0_0 := $Heap;
        havoc $Heap;
        assume $initHeapForallStmt#1_0_0 == $Heap;
        assume (forall _k'#4: Box, x#2: int, y#2: int, z#2: int, z'#2: int :: 
          { TargetedMonotonicity.__default.P_h($LS($LZ), _k'#4, x#2, y#2, z'#2), TargetedMonotonicity.__default.P_h($LS($LZ), _k'#4, x#2, y#2, z#2) } 
          ORD#Less(_k'#4, _k#0)
               && 
