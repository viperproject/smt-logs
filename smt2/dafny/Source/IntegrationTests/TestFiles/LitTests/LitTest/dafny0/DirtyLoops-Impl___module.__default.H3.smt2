...
(set-info :boogie-vc-id Impl$$_module.__default.H3)
...
(let ((anon8_LoopHead_correct  (=> (and (and (and (and (and true (not false)) (= |$rhs#0@0| 12)) (= |$decr_init$loop#00@0| 7)) (=> |$w$loop#0@1| (<= |i#0@1| (LitInt 7)))) (and (and (forall (($o@@10 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@10) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@10)))
 :qid |DirtyLoopsdfy.343:3|
 :skolemid |623|
