...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|_module.__default.F#canCall| |x#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.F |x#0|) (LitInt 10)))
 :qid |PrintEffectsdfy.45:12|
 :skolemid |514|
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|_module.__default.F#canCall| (LitInt |x#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.F (LitInt |x#0@@0|)) (LitInt 10)))
 :qid |PrintEffectsdfy.45:12|
 :weight 3
 :skolemid |515|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |#result#0@0| (LitInt 10))) (and (|_module.__default.F#canCall| |x#0@@1|) (= (ControlFlow 0 2) (- 0 1)))) (= |#result#0@0| (_module.__default.F |x#0@@1|)))))
