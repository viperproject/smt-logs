...
(set-info :boogie-vc-id CheckWellformed$$TerminationCheck.__default.F)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= |##x#0@0| (LitInt 5))) (and ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap) (= (ControlFlow 0 2) (- 0 1)))) false)))
