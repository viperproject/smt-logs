...
(set-info :boogie-vc-id Impl$$_module.__default.Outside__CoLemma__Caller__PosLemma_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.Pos_h#canCall| |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (< 0 (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Upward ($LS ($LS $LZ)) |n#1|))))))))) (=> (=> (|_module.__default.Pos_h#canCall| |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (< 0 (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Upward ($LS ($LS $LZ)) |n#1|)))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.Pos_h#canCall| |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (_module.__default.Pos_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.Stream.tail (_module.__default.Upward ($LS ($LS $LZ)) |n#1|))))))) (=> (=> (|_module.__default.Pos_h#canCall| |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (_module.__default.Pos_h ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.Stream.tail (_module.__default.Upward ($LS ($LS $LZ)) |n#1|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.Pos_h#canCall| |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (or (_module.__default.Pos_h ($LS $LZ) |_k#0@@6| (_module.__default.Upward ($LS $LZ) |n#1|)) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@6|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@6|) (_module.__default.Pos_h ($LS ($LS $LZ)) |_k'#1@@1| (_module.__default.Upward ($LS ($LS $LZ)) |n#1|)))
 :qid |CoinductiveProofsdfy.11:20|
 :skolemid |598|
 :pattern ( (_module.__default.Pos_h ($LS ($LS $LZ)) |_k'#1@@1| (_module.__default.Upward ($LS ($LS $LZ)) |n#1|)))
))))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@6|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|n#2| Int) ) (!  (=> (and (|ORD#Less| |_k'#2@@1| |_k#0@@6|) (<= (LitInt 1) |n#2|)) (_module.__default.Pos_h ($LS $LZ) |_k'#2@@1| (_module.__default.Upward ($LS $LZ) |n#2|)))
 :qid |CoinductiveProofsdfy.52:35|
 :skolemid |602|
 :pattern ( (_module.__default.Upward ($LS $LZ) |n#2|) (|ORD#Less| |_k'#2@@1| |_k#0@@6|))
)) (= (ControlFlow 0 11) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@6|)) (=> (and (and ($IsAlloc intType (int_2_U |n#1|) TInt $Heap) (|_module.__default.Upward#canCall| |n#1|)) (and (_module.Stream.Cons_q (_module.__default.Upward ($LS $LZ) |n#1|)) (_module.Stream.Cons_q (_module.__default.Upward ($LS $LZ) |n#1|)))) (=> (and (and (and (= |##n#2@0| (+ |n#1| 1)) ($IsAlloc intType (int_2_U |##n#2@0|) TInt $Heap)) (and (|_module.__default.Upward#canCall| (+ |n#1| 1)) (_module.Stream.Cons_q (_module.__default.Upward ($LS $LZ) (+ |n#1| 1))))) (and (and (|$IsA#_module.Stream| (_module.Stream.tail (_module.__default.Upward ($LS $LZ) |n#1|))) (|$IsA#_module.Stream| (_module.__default.Upward ($LS $LZ) (+ |n#1| 1)))) (and (and (|_module.__default.Upward#canCall| |n#1|) (_module.Stream.Cons_q (_module.__default.Upward ($LS $LZ) |n#1|))) (|_module.__default.Upward#canCall| (+ |n#1| 1))))) (and (=> (= (ControlFlow 0 5) (- 0 10)) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Upward ($LS ($LS $LZ)) |n#1|)) (_module.__default.Upward ($LS ($LS $LZ)) (+ |n#1| 1)))) (=> (and (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Upward ($LS $LZ) |n#1|)) (_module.__default.Upward ($LS $LZ) (+ |n#1| 1))) (= |n##0@0| (+ |n#1| 1))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (<= (LitInt 1) |n##0@0|)) (=> (<= (LitInt 1) |n##0@0|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (|_module.__default.Upward#canCall| |n##0@0|) (|_module.__default.Pos#canCall| (_module.__default.Upward ($LS $LZ) |n##0@0|)))) (and (and (|_module.__default.Pos#canCall| (_module.__default.Upward ($LS $LZ) |n##0@0|)) (and (_module.__default.Pos ($LS $LZ) (_module.__default.Upward ($LS $LZ) |n##0@0|)) (and (< 0 (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Upward ($LS $LZ) |n##0@0|))))) (_module.__default.Pos ($LS $LZ) (_module.Stream.tail (_module.__default.Upward ($LS $LZ) |n##0@0|)))))) (= $Heap $Heap@0))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@6|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@6|)) (=> (= |##_k#0@0| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1))) (=> (and ($IsAlloc BoxType |##_k#0@0| TORDINAL $Heap@0) (= |##n#3@0| (+ |n#1| 1))) (=> (and (and (and ($IsAlloc intType (int_2_U |##n#3@0|) TInt $Heap@0) (|_module.__default.Upward#canCall| (+ |n#1| 1))) (and (_module.Stream.Cons_q (_module.__default.Upward ($LS $LZ) (+ |n#1| 1))) (= |##s#1@0| (_module.__default.Upward ($LS $LZ) (+ |n#1| 1))))) (and (and ($IsAlloc DatatypeTypeType |##s#1@0| (Tclass._module.Stream TInt) $Heap@0) (|_module.__default.Pos_h#canCall| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.__default.Upward ($LS $LZ) (+ |n#1| 1)))) (and (|_module.__default.Upward#canCall| (+ |n#1| 1)) (|_module.__default.Pos_h#canCall| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.__default.Upward ($LS $LZ) (+ |n#1| 1)))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|_module.__default.Pos_h#canCall| (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.__default.Upward ($LS $LZ) (+ |n#1| 1))) (_module.__default.Pos_h ($LS $LZ) (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.__default.Upward ($LS $LZ) (+ |n#1| 1))))) (=> (and (_module.__default.Pos_h ($LS $LZ) (|ORD#Minus| |_k#0@@6| (|ORD#FromNat| 1)) (_module.__default.Upward ($LS $LZ) (+ |n#1| 1))) (= (ControlFlow 0 5) 2)) GeneratedUnifiedExit_correct)))))))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 12) 5) anon3_Then_correct) (=> (= (ControlFlow 0 12) 11) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 4 $FunctionContextHeight)) (and (<= (LitInt 1) |n#1|) (= (ControlFlow 0 13) 12))) anon0_correct)))
