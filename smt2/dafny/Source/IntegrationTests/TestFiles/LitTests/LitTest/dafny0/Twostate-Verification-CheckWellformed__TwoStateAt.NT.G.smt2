...
(assert (forall ((TwoStateAt.NT.G$Y@@1 T@U) ($prevHeap@@1 T@U) ($h0 T@U) ($h1 T@U) (|y#0| T@U) (|c#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|TwoStateAt.NT.G#canCall| TwoStateAt.NT.G$Y@@1 $prevHeap@@1 $h0 |y#0| |c#0|) (and ($IsBox |y#0| TwoStateAt.NT.G$Y@@1) ($Is refType |c#0| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o T@U) ($f T@U) ) (!  (=> (and (or (not (= $o null)) (not true)) (= $o |c#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o) $f)))
 :qid |unknown.0:0|
 :skolemid |861|
)) (= (TwoStateAt.NT.G TwoStateAt.NT.G$Y@@1 $prevHeap@@1 $h0 |y#0| |c#0|) (TwoStateAt.NT.G TwoStateAt.NT.G$Y@@1 $prevHeap@@1 $h1 |y#0| |c#0|))))
 :qid |unknown.0:0|
 :skolemid |862|
...
(assert (forall ((TwoStateAt.NT.F$Y@@5 T@U) ($prevHeap@@11 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this@@1 Int) (|y#0@@4| T@U) (|c#0@@6| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (<= (LitInt 0) this@@1) (< this@@1 86))) (or (|TwoStateAt.NT.F#canCall| TwoStateAt.NT.F$Y@@5 $prevHeap@@11 $h0@@0 this@@1 |y#0@@4| |c#0@@6|) (and ($IsBox |y#0@@4| TwoStateAt.NT.F$Y@@5) ($Is refType |c#0@@6| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@5 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (= $o@@5 |c#0@@6|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@5) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@5) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |856|
)) (= (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@5 $prevHeap@@11 $h0@@0 this@@1 |y#0@@4| |c#0@@6|) (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@5 $prevHeap@@11 $h1@@0 this@@1 |y#0@@4| |c#0@@6|))))
 :qid |unknown.0:0|
 :skolemid |857|
...
(set-info :boogie-vc-id CheckWellformed$$TwoStateAt.NT.G)
...
(assert (not
 ...
 :qid |TwostateVerificationdfy.517:18|
 :skolemid |866|
