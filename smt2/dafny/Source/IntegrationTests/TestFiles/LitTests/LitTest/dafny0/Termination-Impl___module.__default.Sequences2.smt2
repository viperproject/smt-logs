...
(assert (forall ((s0 T@U) (s1 T@U) (n@@1 Int) ) (! (= (|Seq#SameUntil| s0 s1 n@@1) (forall ((j@@0 Int) ) (!  (=> (and (<= 0 j@@0) (< j@@0 n@@1)) (= (|Seq#Index| s0 j@@0) (|Seq#Index| s1 j@@0)))
 ...
 :skolemid |2621|
 :pattern ( (|Seq#SameUntil| s0 s1 n@@1))
)))
...
(declare-fun _module._default.Sequences2$T () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Sequences2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (and (< (|Seq#Length| |Seq#Empty|) (|Seq#Length| |s#0@0|)) (|Seq#SameUntil| |Seq#Empty| |s#0@0| (|Seq#Length| |Seq#Empty|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 (- (|Seq#Length| |s#0@0|) 1)) (<= (- (|Seq#Length| |s#0@0|) 1) (|Seq#Length| |s#0@0|)))) (=> (and (<= 0 (- (|Seq#Length| |s#0@0|) 1)) (<= (- (|Seq#Length| |s#0@0|) 1) (|Seq#Length| |s#0@0|))) (=> (and (= |s#0@1| (|Seq#Take| |s#0@0| (- (|Seq#Length| |s#0@0|) 1))) (= (ControlFlow 0 5) (- 0 4))) (< (|Seq#Rank| |s#0@1|) (|Seq#Rank| |s#0@0|))))))))
...
(let ((anon6_LoopHead_correct  (=> (and (and (and ($Is SeqType |s#0@0| (TSeq _module._default.Sequences2$T)) ($IsAlloc SeqType |s#0@0| (TSeq _module._default.Sequences2$T) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.862:3|
 :skolemid |3277|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SeqType |S#0| (TSeq _module._default.Sequences2$T)) ($IsAlloc SeqType |S#0| (TSeq _module._default.Sequences2$T) $Heap))) (=> (and (and (and ($Is SeqType |s#0| (TSeq _module._default.Sequences2$T)) ($IsAlloc SeqType |s#0| (TSeq _module._default.Sequences2$T) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct))))
