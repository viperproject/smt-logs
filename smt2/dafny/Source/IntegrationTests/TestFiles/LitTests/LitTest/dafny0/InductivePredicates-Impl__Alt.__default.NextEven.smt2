...
(set-info :boogie-vc-id Impl$$Alt.__default.NextEven)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#Alt.natinf| |x#0@@14|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (and (forall ((|$ih#x0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#x0#0| Tclass.Alt.natinf) (Alt.__default.Even ($LS $LZ) |$ih#x0#0|)) (< (DtRank |$ih#x0#0|) (DtRank |x#0@@14|))) (Alt.__default.Even ($LS $LZ) (Alt.__default.S (Alt.__default.S |$ih#x0#0|))))
 :qid |InductivePredicatesdfy.183:18|
 :skolemid |758|
 :pattern ( (Alt.__default.S (Alt.__default.S |$ih#x0#0|)))
)) (= (ControlFlow 0 2) (- 0 1))) (|Alt.__default.Even#canCall| (Alt.__default.S (Alt.__default.S |x#0@@14|))))) (or (Alt.__default.Even ($LS $LZ) (Alt.__default.S (Alt.__default.S |x#0@@14|))) (or (and (Alt.natinf.N_q (Alt.__default.S (Alt.__default.S |x#0@@14|))) (= (Alt.natinf.n (Alt.__default.S (Alt.__default.S |x#0@@14|))) (LitInt 0))) (exists ((|y#3@@2| T@U) ) (!  (and ($Is DatatypeTypeType |y#3@@2| Tclass.Alt.natinf) (and (|Alt.natinf#Equal| (Alt.__default.S (Alt.__default.S |x#0@@14|)) (Alt.__default.S (Alt.__default.S |y#3@@2|))) (Alt.__default.Even ($LS ($LS $LZ)) |y#3@@2|)))
 :qid |InductivePredicatesdfy.132:12|
 :skolemid |756|
 :pattern ( (Alt.__default.Even ($LS ($LS $LZ)) |y#3@@2|))
 :pattern ( (Alt.__default.S (Alt.__default.S |y#3@@2|)))
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |x#0@@14| Tclass.Alt.natinf) ($IsAlloc DatatypeTypeType |x#0@@14| Tclass.Alt.natinf $Heap)) (|$IsA#Alt.natinf| |x#0@@14|)) (= 3 $FunctionContextHeight)) (and (and (|Alt.__default.Even#canCall| |x#0@@14|) (and (Alt.__default.Even ($LS $LZ) |x#0@@14|) (or (and (Alt.natinf.N_q |x#0@@14|) (= (Alt.natinf.n |x#0@@14|) (LitInt 0))) (exists ((|y#2| T@U) ) (!  (and ($Is DatatypeTypeType |y#2| Tclass.Alt.natinf) (and (|Alt.natinf#Equal| |x#0@@14| (Alt.__default.S (Alt.__default.S |y#2|))) (Alt.__default.Even ($LS $LZ) |y#2|)))
 :qid |InductivePredicatesdfy.132:12|
 :skolemid |755|
 :pattern ( (Alt.__default.Even ($LS $LZ) |y#2|))
