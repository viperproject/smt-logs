...
(declare-fun _module._default.UnderscoresAndPatterns1$T () T@U)
...
(declare-fun |b'#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.UnderscoresAndPatterns1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (=> (and ($IsBox |a#0@0| _module._default.UnderscoresAndPatterns1$T) ($IsAllocBox |a#0@0| _module._default.UnderscoresAndPatterns1$T $Heap@@0)) (=> (and (and ($IsBox |b#0@0| _module._default.UnderscoresAndPatterns1$T) ($IsAllocBox |b#0@0| _module._default.UnderscoresAndPatterns1$T $Heap@@0)) ($IsAllocBox |tt#0| _module._default.UnderscoresAndPatterns1$T $Heap@@0)) (=> (and (and (and (|_module.__default.Two#canCall| _module._default.UnderscoresAndPatterns1$T |tt#0|) (_System.Tuple2.___hMake2_q (_module.__default.Two _module._default.UnderscoresAndPatterns1$T |tt#0|))) (and (= |let#0#0#0| (_module.__default.Two _module._default.UnderscoresAndPatterns1$T |tt#0|)) (|_module.__default.Two#canCall| _module._default.UnderscoresAndPatterns1$T |tt#0|))) (and (and (|_module.__default.Two#canCall| _module._default.UnderscoresAndPatterns1$T |tt#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._System.Tuple2 _module._default.UnderscoresAndPatterns1$T _module._default.UnderscoresAndPatterns1$T))) (and (_System.Tuple2.___hMake2_q |let#0#0#0|) (= (|#_System._tuple#2._#Make2| |a#0@0| |b#0@0|) |let#0#0#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) true))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and ($IsBox |tt#0| _module._default.UnderscoresAndPatterns1$T) ($IsAllocBox |tt#0| _module._default.UnderscoresAndPatterns1$T $Heap@@0)) (and (=> |defass#a'#0| (and ($IsBox |a'#0| _module._default.UnderscoresAndPatterns1$T) ($IsAllocBox |a'#0| _module._default.UnderscoresAndPatterns1$T $Heap@@0))) true)) (and (and (=> |defass#b'#0| (and ($IsBox |b'#0| _module._default.UnderscoresAndPatterns1$T) ($IsAllocBox |b'#0| _module._default.UnderscoresAndPatterns1$T $Heap@@0))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
