...
(let ((anon12_Then_correct  (=> (and (= |d#0| |#_module.D.Green|) (= (ControlFlow 0 9) (- 0 8))) false)))
(let ((anon11_Else_correct  (=> (or (not (= |d#0| |#_module.D.Blue|)) (not true)) (and (=> (= (ControlFlow 0 11) 9) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (and (= |d#0| |#_module.D.Blue|) (= (ControlFlow 0 7) (- 0 6))) false)))
(let ((anon10_Else_correct  (=> (or (not (= |d#0| |#_module.D.Red|)) (not true)) (and (=> (= (ControlFlow 0 12) 7) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (and (= |d#0| |#_module.D.Red|) (= (ControlFlow 0 5) (- 0 4))) false)))
(let ((anon9_Else_correct  (=> (or (not (= |d#0| |#_module.D.Purple|)) (not true)) (and (=> (= (ControlFlow 0 13) 5) anon10_Then_correct) (=> (= (ControlFlow 0 13) 12) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (= |d#0| |#_module.D.Purple|) (= (ControlFlow 0 3) (- 0 2))) false)))
(let ((anon8_Then_correct  (=> (not (|_module.D#Equal| |d#0| |#_module.D.Green|)) (and (=> (= (ControlFlow 0 14) 3) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct)))))
(let ((anon8_Else_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.D| |d#0|)) (and (=> (= (ControlFlow 0 15) 14) anon8_Then_correct) (=> (= (ControlFlow 0 15) 1) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |d#0| Tclass._module.D) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.D $Heap)) (|$IsA#_module.D| |d#0|)) (= 1 $FunctionContextHeight)) (and (or (|_module.D#Equal| |d#0| |#_module.D.Green|) (|_module.D#Equal| |d#0| |#_module.D.Red|)) (= (ControlFlow 0 16) 15))) anon0_correct))))
