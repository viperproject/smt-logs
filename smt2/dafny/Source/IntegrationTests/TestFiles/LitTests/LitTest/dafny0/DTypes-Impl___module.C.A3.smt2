...
(assert (forall ((a@@2 T@U) (b T@U) (o@@1 T@U) ) (! (= (|Set#IsMember| (|Set#Intersection| a@@2 b) o@@1)  (and (|Set#IsMember| a@@2 o@@1) (|Set#IsMember| b o@@1)))
 :qid |DafnyPreludebpl.724:15|
 :skolemid |1632|
 :pattern ( (|Set#IsMember| (|Set#Intersection| a@@2 b) o@@1))
)))
...
(assert (forall ((a@@3 T@U) (b@@0 T@U) ) (! (= (|Set#Intersection| (|Set#Intersection| a@@3 b@@0) b@@0) (|Set#Intersection| a@@3 b@@0))
 :qid |DafnyPreludebpl.737:15|
 :skolemid |1635|
 :pattern ( (|Set#Intersection| (|Set#Intersection| a@@3 b@@0) b@@0))
)))
...
(assert (forall ((a@@5 T@U) (b@@2 T@U) ) (! (= (|Set#Intersection| a@@5 (|Set#Intersection| a@@5 b@@2)) (|Set#Intersection| a@@5 b@@2))
 :qid |DafnyPreludebpl.741:15|
 :skolemid |1636|
 :pattern ( (|Set#Intersection| a@@5 (|Set#Intersection| a@@5 b@@2)))
)))
...
(set-info :boogie-vc-id Impl$$_module.C.A3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |x#0@0| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.C.a2x))) (= (ControlFlow 0 2) (- 0 1))) (|Set#Subset| (|Set#Intersection| |x#0@0| |b#0|) (|Set#UnionOne| |Set#Empty| ($Box refType null)))))))
