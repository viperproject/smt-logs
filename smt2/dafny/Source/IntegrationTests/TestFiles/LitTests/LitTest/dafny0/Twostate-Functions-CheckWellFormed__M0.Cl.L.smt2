...
(assert (forall (($h@@7 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass.M0.C?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@5) M0.C.data)) Tclass._System.nat))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1272|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@5) M0.C.data)))
)))
...
(assert (forall (($h@@8 T@U) ($o@@6 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) Tclass.M0.C?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@6) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@6) M0.C.data)) Tclass._System.nat $h@@8))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1273|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@6) M0.C.data)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$M0.Cl.L)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |c#0@@8| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |c#0@@8| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType |c#0@@8| Tclass.M0.C $Heap@@1)) (=> ($IsAlloc refType |c#0@@8| Tclass.M0.C $Heap@@1) (=> (and (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data)))) ($IsAllocBox ($Box refType this@@2) Tclass.M0.Cl? current$Heap)) (and ($IsAlloc refType |c#0@@8| Tclass.M0.C? current$Heap) ($IsAlloc refType |d#0@@2| Tclass.M0.C current$Heap))) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAlloc refType this@@2 Tclass.M0.Cl $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass.M0.Cl $Heap@@1) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType |c#0@@8| Tclass.M0.C $Heap@@1)) (=> ($IsAlloc refType |c#0@@8| Tclass.M0.C $Heap@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (or (not (= |c#0@@8| null)) (not true)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data)))))) (=> (=> (or (not (= |c#0@@8| null)) (not true)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))))) (=> (and (|M0.Cl.G#canCall| $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |c#0@@8| null)) (not true)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.M0.Cl) ($IsAlloc refType this@@2 Tclass.M0.Cl previous$Heap))) (and ($Is refType |c#0@@8| Tclass.M0.C) ($IsAlloc refType |c#0@@8| Tclass.M0.C previous$Heap))) (=> (and (and (and ($Is refType |d#0@@2| Tclass.M0.C) ($IsAlloc refType |d#0@@2| Tclass.M0.C current$Heap)) (= 2 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |c#0@@8| Tclass.M0.C previous$Heap) (= (ControlFlow 0 9) 2)))) anon0_correct)))))
