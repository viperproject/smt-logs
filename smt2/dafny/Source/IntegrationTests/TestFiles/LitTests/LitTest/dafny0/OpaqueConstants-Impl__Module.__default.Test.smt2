...
(declare-fun Module_mM.__default.Five () Int)
...
(assert ($Is intType (int_2_U Module_mM.__default.Five) TInt))
...
(set-info :boogie-vc-id Impl$$Module.__default.Test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon3_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= Module_mM.__default.Five (LitInt 5))) (and (= $Heap $Heap@0) (= (ControlFlow 0 4) (- 0 3)))) (= Module_mM.__default.Five (LitInt 5)))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= Module_mM.__default.Five (LitInt 5)))))
