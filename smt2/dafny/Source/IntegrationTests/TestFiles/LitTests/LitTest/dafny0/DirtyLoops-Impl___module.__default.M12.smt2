...
(set-info :boogie-vc-id Impl$$_module.__default.M12)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon11_Then_correct  (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) _module.C.y))) |i#0@1|) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= |c#0@@1| null)) (not true))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= |c#0@@1| null)) (not true))) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap) (=> (= (ControlFlow 0 6) (- 0 5)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) _module.C.y))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.y))))))))))))
(let ((anon6_correct true))
(let ((anon11_Else_correct  (=> (and (< |i#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) _module.C.y)))) (= (ControlFlow 0 10) 4)) anon6_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 11) 6) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))))
(let ((anon9_Else_correct  (=> |$w$loop#0@1| (and (=> (= (ControlFlow 0 13) 11) anon10_Then_correct) (=> (= (ControlFlow 0 13) 4) anon6_correct)))))
(let ((anon9_Then_correct  (=> (and (not |$w$loop#0@1|) (= (ControlFlow 0 3) (- 0 2))) (or (not (= |c#0@@1| null)) (not true)))))
...
)) (<= (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) _module.C.y))) |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 15) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 15) 14) anon8_LoopBody_correct)))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |c#0@@1|)) (= |i#0@0| (LitInt 0))) (and (= |$decr_init$loop#00@0| (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.y))) |i#0@0|)) (= (ControlFlow 0 16) 15))) anon8_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |c#0@@1| Tclass._module.C) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
