...
(set-info :boogie-vc-id Impl$$_module.C.A4)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (and ($Is SetType |b#0| (TSet (Tclass._module.CP? Tclass._module.Node Tclass._module.C))) ($IsAlloc SetType |b#0| (TSet (Tclass._module.CP? Tclass._module.Node Tclass._module.C)) $Heap))) (and (and ($Is SetType |x#0| (TSet Tclass._System.object?)) ($IsAlloc SetType |x#0| (TSet Tclass._System.object?) $Heap)) true)) (and (and (and ($Is SetType |y#0| (TSet Tclass._System.object?)) ($IsAlloc SetType |y#0| (TSet Tclass._System.object?) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
