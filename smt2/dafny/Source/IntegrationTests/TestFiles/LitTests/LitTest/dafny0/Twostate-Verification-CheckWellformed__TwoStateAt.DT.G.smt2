...
(assert (distinct TInt TagInt alloc allocName Tagclass._System.___hFunc3 Tagclass.TwoStateAt.Cell Tagclass.TwoStateAt.Cell? Tagclass.TwoStateAt.DT class.TwoStateAt.Cell? |##TwoStateAt.DT.Green| |tytagFamily$_#Func3| tytagFamily$Cell tytagFamily$DT field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((TwoStateAt.DT$X@@8 T@U) (TwoStateAt.DT.G$Y@@2 T@U) ($prevHeap@@5 T@U) ($h0 T@U) ($h1 T@U) (|x#0@@1| T@U) (|y#0@@1| T@U) (|c#0@@3| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|TwoStateAt.DT.G#canCall| TwoStateAt.DT$X@@8 TwoStateAt.DT.G$Y@@2 $prevHeap@@5 $h0 |x#0@@1| |y#0@@1| |c#0@@3|) (and (and ($IsBox |x#0@@1| TwoStateAt.DT$X@@8) ($IsBox |y#0@@1| TwoStateAt.DT.G$Y@@2)) ($Is refType |c#0@@3| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= $o@@3 |c#0@@3|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@3) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@3) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |844|
)) (= (TwoStateAt.DT.G TwoStateAt.DT$X@@8 TwoStateAt.DT.G$Y@@2 $prevHeap@@5 $h0 |x#0@@1| |y#0@@1| |c#0@@3|) (TwoStateAt.DT.G TwoStateAt.DT$X@@8 TwoStateAt.DT.G$Y@@2 $prevHeap@@5 $h1 |x#0@@1| |y#0@@1| |c#0@@3|))))
 :qid |unknown.0:0|
 :skolemid |845|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (TwoStateAt.DT.G TwoStateAt.DT$X@@8 TwoStateAt.DT.G$Y@@2 $prevHeap@@5 $h1 |x#0@@1| |y#0@@1| |c#0@@3|))
)))
...
(assert (forall ((TwoStateAt.DT$X@@9 T@U) (TwoStateAt.DT.F$Y@@2 T@U) ($prevHeap@@6 T@U) ($h0@@0 T@U) ($h1@@0 T@U) (this T@U) (|x#0@@2| T@U) (|y#0@@2| T@U) (|c#0@@4| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) ($Is DatatypeTypeType this (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@9))) (or (|TwoStateAt.DT.F#canCall| TwoStateAt.DT$X@@9 TwoStateAt.DT.F$Y@@2 $prevHeap@@6 $h0@@0 this |x#0@@2| |y#0@@2| |c#0@@4|) (and (and ($IsBox |x#0@@2| TwoStateAt.DT$X@@9) ($IsBox |y#0@@2| TwoStateAt.DT.F$Y@@2)) ($Is refType |c#0@@4| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@4 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (= $o@@4 |c#0@@4|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@4) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@4) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |839|
)) (= (TwoStateAt.DT.F TwoStateAt.DT$X@@9 TwoStateAt.DT.F$Y@@2 $prevHeap@@6 $h0@@0 this |x#0@@2| |y#0@@2| |c#0@@4|) (TwoStateAt.DT.F TwoStateAt.DT$X@@9 TwoStateAt.DT.F$Y@@2 $prevHeap@@6 $h1@@0 this |x#0@@2| |y#0@@2| |c#0@@4|))))
 :qid |unknown.0:0|
 :skolemid |840|
 :pattern ( ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0) (TwoStateAt.DT.F TwoStateAt.DT$X@@9 TwoStateAt.DT.F$Y@@2 $prevHeap@@6 $h1@@0 this |x#0@@2| |y#0@@2| |c#0@@4|))
)))
(assert (forall ((TwoStateAt.DT$X@@10 T@U) (TwoStateAt.DT.G$Y@@3 T@U) ($prevHeap@@7 T@U) ($heap@@3 T@U) (|$fh$0x#0@@3| T@U) (|$fh$0x#1@@3| T@U) (|$fh$0x#2@@3| T@U) ) (! (= (Requires3 TwoStateAt.DT$X@@10 TwoStateAt.DT.G$Y@@3 Tclass.TwoStateAt.Cell TInt $heap@@3 (|TwoStateAt.DT.G#Handle| TwoStateAt.DT$X@@10 TwoStateAt.DT.G$Y@@3 $prevHeap@@7) |$fh$0x#0@@3| |$fh$0x#1@@3| |$fh$0x#2@@3|) (|TwoStateAt.DT.G#requires| TwoStateAt.DT$X@@10 TwoStateAt.DT.G$Y@@3 $prevHeap@@7 $heap@@3 |$fh$0x#0@@3| |$fh$0x#1@@3| ($Unbox refType |$fh$0x#2@@3|)))
 :qid |unknown.0:0|
 :skolemid |777|
 :pattern ( (Requires3 TwoStateAt.DT$X@@10 TwoStateAt.DT.G$Y@@3 Tclass.TwoStateAt.Cell TInt $heap@@3 (|TwoStateAt.DT.G#Handle| TwoStateAt.DT$X@@10 TwoStateAt.DT.G$Y@@3 $prevHeap@@7) |$fh$0x#0@@3| |$fh$0x#1@@3| |$fh$0x#2@@3|))
)))
(assert (forall ((TwoStateAt.DT$X@@11 T@U) (TwoStateAt.DT.F$Y@@3 T@U) ($prevHeap@@8 T@U) ($self@@2 T@U) ($heap@@4 T@U) (|$fh$0x#0@@4| T@U) (|$fh$0x#1@@4| T@U) (|$fh$0x#2@@4| T@U) ) (! (= (Apply3 TwoStateAt.DT$X@@11 TwoStateAt.DT.F$Y@@3 Tclass.TwoStateAt.Cell TInt $heap@@4 (|TwoStateAt.DT.F#Handle| TwoStateAt.DT$X@@11 TwoStateAt.DT.F$Y@@3 $prevHeap@@8 $self@@2) |$fh$0x#0@@4| |$fh$0x#1@@4| |$fh$0x#2@@4|) ($Box intType (int_2_U (TwoStateAt.DT.F TwoStateAt.DT$X@@11 TwoStateAt.DT.F$Y@@3 $prevHeap@@8 $heap@@4 $self@@2 |$fh$0x#0@@4| |$fh$0x#1@@4| ($Unbox refType |$fh$0x#2@@4|)))))
 :qid |unknown.0:0|
 :skolemid |764|
 :pattern ( (Apply3 TwoStateAt.DT$X@@11 TwoStateAt.DT.F$Y@@3 Tclass.TwoStateAt.Cell TInt $heap@@4 (|TwoStateAt.DT.F#Handle| TwoStateAt.DT$X@@11 TwoStateAt.DT.F$Y@@3 $prevHeap@@8 $self@@2) |$fh$0x#0@@4| |$fh$0x#1@@4| |$fh$0x#2@@4|))
)))
...
(assert (forall ((TwoStateAt.DT$X@@12 T@U) (TwoStateAt.DT.F$Y@@4 T@U) ($prevHeap@@9 T@U) ($Heap@@1 T@U) (this@@0 T@U) (|x#0@@3| T@U) (|y#0@@3| T@U) (|c#0@@5| T@U) ) (!  (=> (and (and (and (and (and (and ($IsGoodHeap $prevHeap@@9) ($IsGoodHeap $Heap@@1)) ($HeapSucc $prevHeap@@9 $Heap@@1)) (and ($Is DatatypeTypeType this@@0 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@12)) ($IsAlloc DatatypeTypeType this@@0 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@12) $prevHeap@@9))) ($IsBox |x#0@@3| TwoStateAt.DT$X@@12)) ($IsBox |y#0@@3| TwoStateAt.DT.F$Y@@4)) ($Is refType |c#0@@5| Tclass.TwoStateAt.Cell)) (= (|TwoStateAt.DT.F#requires| TwoStateAt.DT$X@@12 TwoStateAt.DT.F$Y@@4 $prevHeap@@9 $Heap@@1 this@@0 |x#0@@3| |y#0@@3| |c#0@@5|)  (and (and ($IsAllocBox |x#0@@3| TwoStateAt.DT$X@@12 $prevHeap@@9) ($IsAllocBox |y#0@@3| TwoStateAt.DT.F$Y@@4 $prevHeap@@9)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $prevHeap@@9))))
 :qid |unknown.0:0|
 :skolemid |842|
 :pattern ( (|TwoStateAt.DT.F#requires| TwoStateAt.DT$X@@12 TwoStateAt.DT.F$Y@@4 $prevHeap@@9 $Heap@@1 this@@0 |x#0@@3| |y#0@@3| |c#0@@5|) ($IsGoodHeap $Heap@@1))
)))
(assert (forall (($bx@@0 T@U) (TwoStateAt.DT$X@@13 T@U) (TwoStateAt.DT.G$Y@@4 T@U) ($prevHeap@@10 T@U) ($heap@@5 T@U) (|$fh$0x#0@@5| T@U) (|$fh$0x#1@@5| T@U) (|$fh$0x#2@@5| T@U) ) (! (= (|Set#IsMember| (Reads3 TwoStateAt.DT$X@@13 TwoStateAt.DT.G$Y@@4 Tclass.TwoStateAt.Cell TInt $heap@@5 (|TwoStateAt.DT.G#Handle| TwoStateAt.DT$X@@13 TwoStateAt.DT.G$Y@@4 $prevHeap@@10) |$fh$0x#0@@5| |$fh$0x#1@@5| |$fh$0x#2@@5|) $bx@@0) (= ($Unbox refType $bx@@0) ($Unbox refType |$fh$0x#2@@5|)))
 :qid |unknown.0:0|
 :skolemid |778|
 :pattern ( (|Set#IsMember| (Reads3 TwoStateAt.DT$X@@13 TwoStateAt.DT.G$Y@@4 Tclass.TwoStateAt.Cell TInt $heap@@5 (|TwoStateAt.DT.G#Handle| TwoStateAt.DT$X@@13 TwoStateAt.DT.G$Y@@4 $prevHeap@@10) |$fh$0x#0@@5| |$fh$0x#1@@5| |$fh$0x#2@@5|) $bx@@0))
)))
(assert (forall ((TwoStateAt.DT$X@@14 T@U) ) (! (= (Tclass.TwoStateAt.DT_0 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@14)) TwoStateAt.DT$X@@14)
 :qid |unknown.0:0|
 :skolemid |727|
 :pattern ( (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@14))
)))
...
(assert (forall (($h@@3 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass.TwoStateAt.Cell?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@5) TwoStateAt.Cell.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |798|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@5) TwoStateAt.Cell.data)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((TwoStateAt.DT$X@@15 T@U) (TwoStateAt.DT.F$Y@@5 T@U) ($prevHeap@@11 T@U) ($Heap@@2 T@U) (this@@1 T@U) (|x#0@@4| T@U) (|y#0@@4| T@U) (|c#0@@6| T@U) ) (!  (=> (or (|TwoStateAt.DT.F#canCall| TwoStateAt.DT$X@@15 TwoStateAt.DT.F$Y@@5 $prevHeap@@11 $Heap@@2 this@@1 |x#0@@4| |y#0@@4| |c#0@@6|) (and (< 1 $FunctionContextHeight) (and (and (and (and (and (and ($IsGoodHeap $prevHeap@@11) ($IsGoodHeap $Heap@@2)) ($HeapSucc $prevHeap@@11 $Heap@@2)) (and ($Is DatatypeTypeType this@@1 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@15)) ($IsAlloc DatatypeTypeType this@@1 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@15) $prevHeap@@11))) ($IsBox |x#0@@4| TwoStateAt.DT$X@@15)) ($IsBox |y#0@@4| TwoStateAt.DT.F$Y@@5)) ($Is refType |c#0@@6| Tclass.TwoStateAt.Cell)))) (= (TwoStateAt.DT.F TwoStateAt.DT$X@@15 TwoStateAt.DT.F$Y@@5 $prevHeap@@11 $Heap@@2 this@@1 |x#0@@4| |y#0@@4| |c#0@@6|) (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#0@@6|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@11 |c#0@@6|) TwoStateAt.Cell.data))))))
 :qid |unknown.0:0|
 :skolemid |843|
 :pattern ( (TwoStateAt.DT.F TwoStateAt.DT$X@@15 TwoStateAt.DT.F$Y@@5 $prevHeap@@11 $Heap@@2 this@@1 |x#0@@4| |y#0@@4| |c#0@@6|) ($IsGoodHeap $Heap@@2))
))))
...
(assert (forall ((TwoStateAt.DT$X@@16 T@U) (bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@16)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@8)) bx@@8) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@8) (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@16))))
 :qid |unknown.0:0|
 :skolemid |728|
 :pattern ( ($IsBox bx@@8 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@16)))
)))
(assert (forall ((TwoStateAt.DT$X@@17 T@U) (TwoStateAt.DT.G$Y@@5 T@U) ($prevHeap@@12 T@U) ($heap@@6 T@U) (|$fh$0x#0@@6| T@U) (|$fh$0x#1@@6| T@U) (|$fh$0x#2@@6| T@U) ) (! (= (Apply3 TwoStateAt.DT$X@@17 TwoStateAt.DT.G$Y@@5 Tclass.TwoStateAt.Cell TInt $heap@@6 (|TwoStateAt.DT.G#Handle| TwoStateAt.DT$X@@17 TwoStateAt.DT.G$Y@@5 $prevHeap@@12) |$fh$0x#0@@6| |$fh$0x#1@@6| |$fh$0x#2@@6|) ($Box intType (int_2_U (TwoStateAt.DT.G TwoStateAt.DT$X@@17 TwoStateAt.DT.G$Y@@5 $prevHeap@@12 $heap@@6 |$fh$0x#0@@6| |$fh$0x#1@@6| ($Unbox refType |$fh$0x#2@@6|)))))
 :qid |unknown.0:0|
 :skolemid |776|
 :pattern ( (Apply3 TwoStateAt.DT$X@@17 TwoStateAt.DT.G$Y@@5 Tclass.TwoStateAt.Cell TInt $heap@@6 (|TwoStateAt.DT.G#Handle| TwoStateAt.DT$X@@17 TwoStateAt.DT.G$Y@@5 $prevHeap@@12) |$fh$0x#0@@6| |$fh$0x#1@@6| |$fh$0x#2@@6|))
)))
...
(declare-fun TwoStateAt.DT$X@@18 () T@U)
(declare-fun current$Heap () T@U)
(declare-fun |x#0@@5| () T@U)
(declare-fun |y#0@@5| () T@U)
(declare-fun TwoStateAt.DT.G$Y@@6 () T@U)
(declare-fun |c#0@@7| () T@U)
(declare-fun $Heap@@3 () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun previous$Heap () T@U)
(set-info :boogie-vc-id CheckWellformed$$TwoStateAt.DT.G)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon5_Else_correct  (=> (and (and ($IsAllocBox ($Box DatatypeTypeType (Lit DatatypeTypeType |#TwoStateAt.DT.Green|)) (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@18) current$Heap) ($IsAllocBox |x#0@@5| TwoStateAt.DT$X@@18 current$Heap)) (and ($IsAllocBox |y#0@@5| TwoStateAt.DT.G$Y@@6 current$Heap) ($IsAlloc refType |c#0@@7| Tclass.TwoStateAt.Cell current$Heap))) (and (=> (= (ControlFlow 0 3) (- 0 7)) ($IsAlloc DatatypeTypeType (Lit DatatypeTypeType |#TwoStateAt.DT.Green|) (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@18) $Heap@@3)) (=> ($IsAlloc DatatypeTypeType (Lit DatatypeTypeType |#TwoStateAt.DT.Green|) (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@18) $Heap@@3) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($IsAllocBox |x#0@@5| TwoStateAt.DT$X@@18 $Heap@@3)) (=> ($IsAllocBox |x#0@@5| TwoStateAt.DT$X@@18 $Heap@@3) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAllocBox |y#0@@5| TwoStateAt.DT.G$Y@@6 $Heap@@3)) (=> ($IsAllocBox |y#0@@5| TwoStateAt.DT.G$Y@@6 $Heap@@3) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType |c#0@@7| Tclass.TwoStateAt.Cell $Heap@@3)) (=> ($IsAlloc refType |c#0@@7| Tclass.TwoStateAt.Cell $Heap@@3) (=> (and (= |b$reqreads#0@0| (forall (($o@@6 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@6) alloc)))) (= $o@@6 |c#0@@7|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@6 $f@@2)))
 :qid |TwostateVerificationdfy.492:13|
 :skolemid |849|
))) (|TwoStateAt.DT.F#canCall| TwoStateAt.DT$X@@18 TwoStateAt.DT.G$Y@@6 $Heap@@3 current$Heap (Lit DatatypeTypeType |#TwoStateAt.DT.Green|) |x#0@@5| |y#0@@5| |c#0@@7|)) (=> (and (and (= (TwoStateAt.DT.G TwoStateAt.DT$X@@18 TwoStateAt.DT.G$Y@@6 $Heap@@3 current$Heap |x#0@@5| |y#0@@5| |c#0@@7|) (TwoStateAt.DT.F TwoStateAt.DT$X@@18 TwoStateAt.DT.G$Y@@6 $Heap@@3 current$Heap (Lit DatatypeTypeType |#TwoStateAt.DT.Green|) |x#0@@5| |y#0@@5| |c#0@@7|)) (|TwoStateAt.DT.F#canCall| TwoStateAt.DT$X@@18 TwoStateAt.DT.G$Y@@6 $Heap@@3 current$Heap (Lit DatatypeTypeType |#TwoStateAt.DT.Green|) |x#0@@5| |y#0@@5| |c#0@@7|)) (and ($Is intType (int_2_U (TwoStateAt.DT.G TwoStateAt.DT$X@@18 TwoStateAt.DT.G$Y@@6 $Heap@@3 current$Heap |x#0@@5| |y#0@@5| |c#0@@7|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))))))))
