...
procedure {:verboseName "TypeSubstitutionInModifiesClause.Client (well-formedness)"} CheckWellFormed$$TypeSubstitutionInModifiesClause.__default.Client();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TypeSubstitutionInModifiesClause.Client (call)"} Call$$TypeSubstitutionInModifiesClause.__default.Client();
  modifies $Heap;
...
procedure {:verboseName "TypeSubstitutionInModifiesClause.Client (correctness)"} Impl$$TypeSubstitutionInModifiesClause.__default.Client() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
axiom 0 < $FunctionContextHeight
   ==> (forall TypeSubstitutionInModifiesClause.C$T: Ty, $o: ref :: 
...
axiom 0 < $FunctionContextHeight
   ==> (forall TypeSubstitutionInModifiesClause.C$T: Ty, $h: Heap, $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeSubstitutionInModifiesClause.Client (correctness)"} Impl$$TypeSubstitutionInModifiesClause.__default.Client() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var defass#c#0: bool;
  var c#0: ref
     where defass#c#0
       ==> $Is(c#0, Tclass.TypeSubstitutionInModifiesClause.C(TInt))
         && $IsAlloc(c#0, Tclass.TypeSubstitutionInModifiesClause.C(TInt), $Heap);
  var $nw: ref;

    // AddMethodImpl: Client, Impl$$TypeSubstitutionInModifiesClause.__default.Client
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(398,11)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(398,14)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id41"} $nw := Call$$TypeSubstitutionInModifiesClause.C.__ctor(TInt);
    // TrCallStmt: After ProcessCallStmt
    c#0 := $nw;
    defass#c#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(400,13)
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id43"} defass#c#0;
    assume true;
    assert {:id "id44"} c#0 != null;
    assert {:id "id45"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && Set#IsMember(TypeSubstitutionInModifiesClause.C.Repr(TInt, c#0), $Box($o))
         ==> $_ModifiesFrame[$o, $f]);
    call {:id "id46"} Call$$TypeSubstitutionInModifiesClause.C.Update(TInt, c#0);
    // TrCallStmt: After ProcessCallStmt
}
...
procedure {:verboseName "TypeSubstitutionInModifiesClause.C._ctor (well-formedness)"} CheckWellFormed$$TypeSubstitutionInModifiesClause.C.__ctor(TypeSubstitutionInModifiesClause.C$T: Ty) returns (this: ref);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TypeSubstitutionInModifiesClause.C._ctor (call)"} Call$$TypeSubstitutionInModifiesClause.C.__ctor(TypeSubstitutionInModifiesClause.C$T: Ty)
   returns (this: ref
       where this != null
         && 
        $Is(this, 
  ...
  ensures {:id "id48"} (forall $o: ref :: 
      { $o != null } 
      Set#IsMember(TypeSubstitutionInModifiesClause.C.Repr(TypeSubstitutionInModifiesClause.C$T, this), 
          $Box($o))
         ==> $o != null)
     && (forall $o: ref :: 
      { Set#IsMember(TypeSubstitutionInModifiesClause.C.Repr(TypeSubstitutionInModifiesClause.C$T, this), 
...
procedure {:verboseName "TypeSubstitutionInModifiesClause.C.Update (well-formedness)"} CheckWellFormed$$TypeSubstitutionInModifiesClause.C.Update(TypeSubstitutionInModifiesClause.C$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, 
...
procedure {:verboseName "TypeSubstitutionInModifiesClause.C.Update (call)"} Call$$TypeSubstitutionInModifiesClause.C.Update(TypeSubstitutionInModifiesClause.C$T: Ty, 
    this: ref
       where this != null
         && 
        $Is(this, 
