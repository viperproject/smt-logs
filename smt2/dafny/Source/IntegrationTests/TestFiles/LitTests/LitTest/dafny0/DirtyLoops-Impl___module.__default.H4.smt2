...
(assert (distinct TInt TagInt alloc allocName Tagclass._System.array? Tagclass._System.array Tagclass._module.C Tagclass._module.C? class._module.C? tytagFamily$array tytagFamily$C field$y)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id Impl$$_module.__default.H4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon11_Then_correct  (=> (<= 7 |i#0@1|) (and (=> (= (ControlFlow 0 9) (- 0 12)) true) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= |k#0@0| null)) (not true))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |k#0@0|) _module.C.y))) (LitInt 12))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |k#0@0|) _module.C.y))) (LitInt 12)) (=> (= (ControlFlow 0 9) (- 0 8)) true))))))))
...
(let ((anon11_Else_correct  (=> (and (< |i#0@1| 7) (= (ControlFlow 0 13) 7)) anon6_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 14) 9) anon11_Then_correct) (=> (= (ControlFlow 0 14) 13) anon11_Else_correct))))
(let ((anon9_Else_correct  (=> |$w$loop#0@1| (and (=> (= (ControlFlow 0 15) 14) anon10_Then_correct) (=> (= (ControlFlow 0 15) 7) anon6_correct)))))
...
(let ((anon8_LoopBody_correct  (and (=> (= (ControlFlow 0 16) 3) anon9_Then_correct) (=> (= (ControlFlow 0 16) 15) anon9_Else_correct))))
(let ((anon8_LoopDone_correct true))
(let ((anon8_LoopHead_correct  (=> (=> true (and ($Is refType |k#0@0| Tclass._module.C) ($IsAlloc refType |k#0@0| Tclass._module.C $Heap@2))) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (and (and (and true (not false)) (= |$rhs#0@0| 12)) (= |$decr_init$loop#00@0| 7)) (=> |$w$loop#0@1| (= (Mod (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |k#0@0|) _module.C.y))) (LitInt 2)) (LitInt 0)))) (and (and (forall (($o@@10 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@10) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@10)))
 :qid |DirtyLoopsdfy.354:3|
 :skolemid |628|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@10))
)) ($HeapSucc $Heap@1 $Heap@2)) (and (forall (($o@@11 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@11) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@11) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@11) $f@@0)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@11 $f@@0))))
 :qid |DirtyLoopsdfy.354:3|
 :skolemid |629|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@11) $f@@0))
)) (<= (- 7 |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 17) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 17) 16) anon8_LoopBody_correct)))))))
(let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |i#0@0| (LitInt 0))) (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.C?))) (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 18) (- 0 22)) true) (and (=> (= (ControlFlow 0 18) (- 0 21)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.C.y))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.C.y)) (=> (and (and (= |$rhs#0@0| (LitInt 12)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.C.y ($Box intType (int_2_U |$rhs#0@0|)))))) (and ($IsGoodHeap $Heap@1) (= |$decr_init$loop#00@0| (- 7 |i#0@0|)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (=> |$w$loop#0@0| (= (Mod (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) _module.C.y))) (LitInt 2)) (LitInt 0)))) (=> (=> |$w$loop#0@0| (= (Mod (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) _module.C.y))) (LitInt 2)) (LitInt 0))) (=> (= (ControlFlow 0 18) 17) anon8_LoopHead_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (=> |defass#k#0| (and ($Is refType |k#0| Tclass._module.C) ($IsAlloc refType |k#0| Tclass._module.C $Heap)))) (and (and (= 1 $FunctionContextHeight) (= (_System.array.Length |a#0|) (LitInt 10))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) (LitInt 8)) (= (ControlFlow 0 23) 18)))) anon0_correct))))
