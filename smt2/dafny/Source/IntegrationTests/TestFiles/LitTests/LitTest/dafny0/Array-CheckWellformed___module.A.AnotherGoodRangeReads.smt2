...
(declare-fun _module.A.AnotherGoodRangeReads (T@U T@U Int) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.A.AnotherGoodRangeReads#canCall| (T@U T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|a#0| T@U) (|j#0| Int) ) (!  (=> (or (|_module.A.AnotherGoodRangeReads#canCall| this |a#0| |j#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A $Heap)))) ($Is refType |a#0| (Tclass._System.array TInt))))) (= (_module.A.AnotherGoodRangeReads this |a#0| |j#0|)  (and (and (<= (LitInt 0) |j#0|) (<= |j#0| (_System.array.Length |a#0|))) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| (|Seq#FromArray| $Heap |a#0|) |j#0|) |j#0|) |Seq#Empty|))))
 :qid |Arraydfy.133:18|
 :skolemid |1263|
 :pattern ( (_module.A.AnotherGoodRangeReads this |a#0| |j#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) (|a#0@@0| T@U) (|j#0@@0| Int) ) (!  (=> (or (|_module.A.AnotherGoodRangeReads#canCall| (Lit refType this@@0) (Lit refType |a#0@@0|) (LitInt |j#0@@0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.A) ($IsAlloc refType this@@0 Tclass._module.A $Heap@@0)))) ($Is refType |a#0@@0| (Tclass._System.array TInt))))) (= (_module.A.AnotherGoodRangeReads (Lit refType this@@0) (Lit refType |a#0@@0|) (LitInt |j#0@@0|))  (and (and (<= (LitInt 0) (LitInt |j#0@@0|)) (<= (LitInt |j#0@@0|) (LitInt (_System.array.Length (Lit refType |a#0@@0|))))) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| (|Seq#FromArray| $Heap@@0 (Lit refType |a#0@@0|)) (LitInt |j#0@@0|)) (LitInt |j#0@@0|)) |Seq#Empty|))))
 :qid |Arraydfy.133:18|
 :weight 3
 :skolemid |1265|
 :pattern ( (_module.A.AnotherGoodRangeReads (Lit refType this@@0) (Lit refType |a#0@@0|) (LitInt |j#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@1 T@U) (|a#0@@1| T@U) (|j#0@@1| Int) ) (!  (=> (or (|_module.A.AnotherGoodRangeReads#canCall| this@@1 (Lit refType |a#0@@1|) (LitInt |j#0@@1|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.A) ($IsAlloc refType this@@1 Tclass._module.A $Heap@@1)))) ($Is refType |a#0@@1| (Tclass._System.array TInt))))) (= (_module.A.AnotherGoodRangeReads this@@1 (Lit refType |a#0@@1|) (LitInt |j#0@@1|))  (and (and (<= (LitInt 0) (LitInt |j#0@@1|)) (<= (LitInt |j#0@@1|) (LitInt (_System.array.Length (Lit refType |a#0@@1|))))) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| (|Seq#FromArray| $Heap@@1 (Lit refType |a#0@@1|)) (LitInt |j#0@@1|)) (LitInt |j#0@@1|)) |Seq#Empty|))))
 :qid |Arraydfy.133:18|
 :weight 3
 :skolemid |1264|
 :pattern ( (_module.A.AnotherGoodRangeReads this@@1 (Lit refType |a#0@@1|) (LitInt |j#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.A.AnotherGoodRangeReads)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon7_correct  (=> (= (_module.A.AnotherGoodRangeReads this@@2 |a#0@@2| |j#0@@2|)  (and (and (<= (LitInt 0) |j#0@@2|) (<= |j#0@@2| (_System.array.Length |a#0@@2|))) (|Seq#Equal| (|Seq#Drop| (|Seq#Take| (|Seq#FromArray| $Heap@@2 |a#0@@2|) |j#0@@2|) |j#0@@2|) |Seq#Empty|))) (=> (and ($Is boolType (bool_2_U (_module.A.AnotherGoodRangeReads this@@2 |a#0@@2| |j#0@@2|)) TBool) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#0@1|))))
(let ((anon11_Else_correct  (=> (not (and (<= (LitInt 0) |j#0@@2|) (<= |j#0@@2| (_System.array.Length |a#0@@2|)))) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 8) 3)) anon7_correct))))
(let ((anon11_Then_correct  (=> (and (<= (LitInt 0) |j#0@@2|) (<= |j#0@@2| (_System.array.Length |a#0@@2|))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (not (= |a#0@@2| null)) (not true))) (=> (or (not (= |a#0@@2| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (and (<= 0 |j#0@@2|) (<= |j#0@@2| (_System.array.Length |a#0@@2|)))) (=> (and (<= 0 |j#0@@2|) (<= |j#0@@2| (_System.array.Length |a#0@@2|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= |j#0@@2| |j#0@@2|) (<= |j#0@@2| (_System.array.Length |a#0@@2|)))) (=> (and (<= |j#0@@2| |j#0@@2|) (<= |j#0@@2| (_System.array.Length |a#0@@2|))) (=> (= |b$reqreads#0@0| (forall (($i Int) ) (!  (=> (and (<= |j#0@@2| $i) (< $i |j#0@@2|)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@2| (IndexField $i))))
 :qid |Arraydfy.136:6|
 :skolemid |1266|
 :pattern ( (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@2| (IndexField $i)))
))) (=> (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 4) 3)) anon7_correct)))))))))))
(let ((anon10_Else_correct  (=> (< |j#0@@2| (LitInt 0)) (and (=> (= (ControlFlow 0 11) 4) anon11_Then_correct) (=> (= (ControlFlow 0 11) 8) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |j#0@@2|) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |a#0@@2| null)) (not true))) (=> (or (not (= |a#0@@2| null)) (not true)) (and (=> (= (ControlFlow 0 9) 4) anon11_Then_correct) (=> (= (ControlFlow 0 9) 8) anon11_Else_correct)))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (and (=> (= (ControlFlow 0 12) 1) anon9_Then_correct) (=> (= (ControlFlow 0 12) 9) anon10_Then_correct)) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.A) ($IsAlloc refType this@@2 Tclass._module.A $Heap@@2))) ($Is refType |a#0@@2| (Tclass._System.array TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
