...
procedure {:verboseName "TypeInstantiations.F (well-formedness)"} CheckWellformed$$TypeInstantiations.__default.F(TypeInstantiations._default.F$G: Ty);
...
axiom {:id "id137"} 0 <= $FunctionContextHeight
   ==> (forall TypeInstantiations._default.H$G: Ty, g#0: Box :: 
    ...
    TypeInstantiations.__default.H#canCall(TypeInstantiations._default.H$G, g#0)
         || (0 < $FunctionContextHeight && $IsBox(g#0, TypeInstantiations._default.H$G))
       ==> TypeInstantiations.__default.H(TypeInstantiations._default.H$G, g#0)
         == LitInt(57));
...
procedure {:verboseName "TypeInstantiations.H (well-formedness)"} CheckWellformed$$TypeInstantiations.__default.H(TypeInstantiations._default.H$G: Ty, 
...
procedure {:verboseName "TypeInstantiations.M (well-formedness)"} CheckWellFormed$$TypeInstantiations.__default.M(TypeInstantiations._default.M$G: Ty) returns (r#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TypeInstantiations.M (call)"} Call$$TypeInstantiations.__default.M(TypeInstantiations._default.M$G: Ty) returns (r#0: int);
  modifies $Heap;
...
procedure {:verboseName "TypeInstantiations.M (correctness)"} Impl$$TypeInstantiations.__default.M(TypeInstantiations._default.M$G: Ty) returns (r#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "TypeInstantiations.N (well-formedness)"} CheckWellFormed$$TypeInstantiations.__default.N(TypeInstantiations._default.N$G: Ty, 
    g#0: Box
...
procedure {:verboseName "TypeInstantiations.N (call)"} Call$$TypeInstantiations.__default.N(TypeInstantiations._default.N$G: Ty, 
    g#0: Box
       where $IsBox(g#0, TypeInstantiations._default.N$G)
         && $IsAllocBox(g#0, TypeInstantiations._default.N$G, $Heap))
   returns (r#0: int);
...
procedure {:verboseName "TypeInstantiations.N (correctness)"} Impl$$TypeInstantiations.__default.N(TypeInstantiations._default.N$G: Ty, 
    g#0: Box
       where $IsBox(g#0, TypeInstantiations._default.N$G)
         && $IsAllocBox(g#0, TypeInstantiations._default.N$G, $Heap))
...
procedure {:verboseName "TypeInstantiations.TestMain (correctness)"} Impl$$TypeInstantiations.__default.TestMain() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TypeInstantiations.TestMain (correctness)"} Impl$$TypeInstantiations.__default.TestMain() returns ($_reverifyPost: bool)
{
  ...
  var cl#0: ref
     where defass#cl#0
       ==> $Is(cl#0, Tclass.TypeInstantiations.GenCl(TChar))
  ...
  var $rhs##3: int;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(409,11)
    assume true;
    ...
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(411,11)
    assume true;
    ##g#0 := ch#0;
    ...
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(412,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(414,12)
    assume true;
    assume TypeInstantiations.GenCl.Static#canCall(TChar, TReal);
    assume TypeInstantiations.GenCl.Static#canCall(TChar, TReal);
    a0#0 := LitInt(TypeInstantiations.GenCl.Static(TChar, TReal));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(415,12)
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.TypeInstantiations.GenCl?(TChar));
    ...
    cl#0 := $nw;
    defass#cl#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(416,12)
    assume true;
    assert {:id "id146"} defass#cl#0;
    assert {:id "id147"} cl#0 != null;
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(cl#0), Tclass.TypeInstantiations.GenCl?(TChar), $Heap);
    assume TypeInstantiations.GenCl.Inst#canCall(TChar, TReal, cl#0);
    assume TypeInstantiations.GenCl.Inst#canCall(TChar, TReal, cl#0);
    a1#0 := TypeInstantiations.GenCl.Inst(TChar, TReal, cl#0);
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(417,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(419,17)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id149"} $rhs##0 := Call$$TypeInstantiations.__default.M(TChar);
    // TrCallStmt: After ProcessCallStmt
    x#0 := $rhs##0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(420,11)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    g##0 := ch#0;
    call {:id "id151"} $rhs##1 := Call$$TypeInstantiations.__default.N(TChar, $Box(g##0));
    // TrCallStmt: After ProcessCallStmt
    y#0 := $rhs##1;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(421,5)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(423,31)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id153"} $rhs##2 := Call$$TypeInstantiations.GenCl.Ms(TChar, TReal);
    // TrCallStmt: After ProcessCallStmt
    a0#0 := $rhs##2;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(424,22)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id155"} defass#cl#0;
    assume true;
    assert {:id "id156"} cl#0 != null;
    call {:id "id157"} $rhs##3 := Call$$TypeInstantiations.GenCl.Mi(TChar, TReal, cl#0);
    // TrCallStmt: After ProcessCallStmt
    a1#0 := $rhs##3;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(425,5)
    assume true;
    assume true;
    assume true;
    assume true;
...
procedure {:verboseName "TypeInstantiations.GenCl.Static (well-formedness)"} CheckWellformed$$TypeInstantiations.GenCl.Static(TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Static$G: Ty);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "TypeInstantiations.GenCl.Inst (well-formedness)"} CheckWellformed$$TypeInstantiations.GenCl.Inst(TypeInstantiations.GenCl$U: Ty, 
...
procedure {:verboseName "TypeInstantiations.GenCl.Ms (well-formedness)"} CheckWellFormed$$TypeInstantiations.GenCl.Ms(TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Ms$G: Ty)
   returns (r#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "TypeInstantiations.GenCl.Ms (call)"} Call$$TypeInstantiations.GenCl.Ms(TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Ms$G: Ty)
   returns (r#0: int);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "TypeInstantiations.GenCl.Ms (correctness)"} Impl$$TypeInstantiations.GenCl.Ms(TypeInstantiations.GenCl$U: Ty, TypeInstantiations.GenCl.Ms$G: Ty)
   returns (r#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
...
procedure {:verboseName "TypeInstantiations.GenCl.Mi (well-formedness)"} CheckWellFormed$$TypeInstantiations.GenCl.Mi(TypeInstantiations.GenCl$U: Ty, 
...
procedure {:verboseName "TypeInstantiations.GenCl.Mi (call)"} Call$$TypeInstantiations.GenCl.Mi(TypeInstantiations.GenCl$U: Ty, 
    TypeInstantiations.GenCl.Mi$G: Ty, 
    this: ref
       where this != null
         && 
...
procedure {:verboseName "TypeInstantiations.GenCl.Mi (correctness)"} Impl$$TypeInstantiations.GenCl.Mi(TypeInstantiations.GenCl$U: Ty, 
    TypeInstantiations.GenCl.Mi$G: Ty, 
    this: ref
       where this != null
         && 
