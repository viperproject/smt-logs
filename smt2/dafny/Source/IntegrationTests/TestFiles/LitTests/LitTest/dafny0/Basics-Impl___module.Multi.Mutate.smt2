...
(assert (distinct TInt TagInt alloc allocName Tagclass._module.Multi Tagclass._module.Multi? class._module.Multi? tytagFamily$Multi field$x field$y)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@3 T@U) ($o@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass._module.Multi?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) _module.Multi.x)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2918|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@4) _module.Multi.x)))
)))
(assert (forall (($h@@4 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.Multi?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) _module.Multi.y)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2920|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@5) _module.Multi.y)))
)))
...
(set-info :boogie-vc-id Impl$$_module.Multi.Mutate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#12| null $Heap alloc this)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.Multi.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.Multi.x)) (=> (and (and (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Multi.x))) |z#0|)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap this (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Multi.x ($Box intType (int_2_U |$rhs#0@0|)))))) (and ($IsGoodHeap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this) _module.Multi.y))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.Multi.y))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Multi) ($IsAlloc refType this Tclass._module.Multi $Heap)))) (=> (and (and (and ($Is refType |m#0| Tclass._module.Multi?) ($IsAlloc refType |m#0| Tclass._module.Multi? $Heap)) (= 0 $FunctionContextHeight)) (and (<= (LitInt 0) |z#0|) (= (ControlFlow 0 4) 2))) anon0_correct))))
