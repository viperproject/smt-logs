...
(set-info :boogie-vc-id Impl$$_module.__default.Down3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (=> (and (and (and (or (not (= |i#0@0| |$rhs#1@0|)) (not true)) (= |i#0@1| (- |i#0@0| 1))) (and (= |j#0@2| (- |j#0@1| 1)) (= |$rhs#0_0@1| (- |Hi#0@0| 1)))) (and (and (= |$rhs#0_1@1| (+ |Lo#0@0| 5)) (= (ControlFlow 0 6) (- 0 5))) |$w$loop#0@0|)) (= |i#0@1| |j#0@2|))))
(let ((anon9_Then_correct  (=> (and (= |i#0@0| |$rhs#1@0|) (= (ControlFlow 0 4) (- 0 3))) (= |j#0@1| (Mul (LitInt 2) |lo#0|)))))
(let ((anon8_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 7) 4) anon9_Then_correct) (=> (= (ControlFlow 0 7) 6) anon9_Else_correct)))))
...
(let ((anon7_LoopHead_correct  (=> (not false) (=> (and (<= |$rhs#1@0| |i#0@0|) (<= |i#0@0| |$rhs#0@0|)) (=> (and (and (=> |$w$loop#0@0| (= |i#0@0| |j#0@1|)) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |ForLoopsdfy.164:3|
 :skolemid |554|
...
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |$rhs#0@0| (Mul (LitInt 2) |hi#0|))) (and (= |$rhs#1@0| (Mul (LitInt 2) |lo#0|)) (= |j#0@0| (Mul (LitInt 2) |hi#0|)))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (<= |$rhs#1@0| |$rhs#0@0|)) (=> (<= |$rhs#1@0| |$rhs#0@0|) (and (=> (= (ControlFlow 0 10) (- 0 11)) (=> |$w$loop#0@0| (= |$rhs#0@0| |j#0@0|))) (=> (=> |$w$loop#0@0| (= |$rhs#0@0| |j#0@0|)) (=> (= (ControlFlow 0 10) 9) anon7_LoopHead_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 0 $FunctionContextHeight)) (and (<= |lo#0| |hi#0|) (= (ControlFlow 0 13) 10))) anon0_correct)))
