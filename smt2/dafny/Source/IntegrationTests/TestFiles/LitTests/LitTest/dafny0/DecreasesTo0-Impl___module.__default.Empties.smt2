...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@87  (=> (= $generated@@80 ($generated@@24 $generated@@81 $generated@@82 $generated@@83 false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) true) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not false)) (=> (not false) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) false))))))))
(let (($generated@@88  (=> (and (and ($generated@@84 $generated@@82) ($generated@@85 $generated@@82)) (and (= 0 $generated@@86) (= (ControlFlow 0 6) 2))) $generated@@87)))
$generated@@88)))
))
(check-sat)
