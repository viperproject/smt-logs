...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) (|n#0@@1| T@U) (|m#0@@1| T@U) ) (!  (=> (or (|LitLet.__default.plus#canCall| (Lit DatatypeTypeType |n#0@@1|) (Lit DatatypeTypeType |m#0@@1|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@1| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0@@1| Tclass.LitLet.Nat)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (LitLet.Nat.O_q (Lit DatatypeTypeType |n#0@@1|)))))) (let ((|n'#3| (Lit DatatypeTypeType (LitLet.Nat.pred (Lit DatatypeTypeType |n#0@@1|)))))
(|LitLet.__default.plus#canCall| |n'#3| (Lit DatatypeTypeType |m#0@@1|)))) (= (LitLet.__default.plus ($LS $ly@@1) (Lit DatatypeTypeType |n#0@@1|) (Lit DatatypeTypeType |m#0@@1|)) (ite (LitLet.Nat.O_q (Lit DatatypeTypeType |n#0@@1|)) |m#0@@1| (let ((|n'#2| (Lit DatatypeTypeType (LitLet.Nat.pred (Lit DatatypeTypeType |n#0@@1|)))))
(Lit DatatypeTypeType (|#LitLet.Nat.S| (Lit DatatypeTypeType (LitLet.__default.plus ($LS $ly@@1) |n'#2| (Lit DatatypeTypeType |m#0@@1|))))))))))
 :qid |LetExprdfy.410:18|
 :weight 3
 :skolemid |1668|
 :pattern ( (LitLet.__default.plus ($LS $ly@@1) (Lit DatatypeTypeType |n#0@@1|) (Lit DatatypeTypeType |m#0@@1|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| T@U) (|m#0@@2| T@U) ) (!  (=> (or (|LitLet.__default.plus#canCall| |n#0@@2| |m#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@2| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0@@2| Tclass.LitLet.Nat)))) ($Is DatatypeTypeType (LitLet.__default.plus $ly@@2 |n#0@@2| |m#0@@2|) Tclass.LitLet.Nat))
 :qid |LetExprdfy.410:18|
 :skolemid |1665|
 :pattern ( (LitLet.__default.plus $ly@@2 |n#0@@2| |m#0@@2|))
))))
(assert  (=> (<= 2 $FunctionContextHeight) (forall (($ly@@3 T@U) (|n#0@@3| T@U) (|m#0@@3| T@U) ) (!  (=> (or (|LitLet.__default.mult#canCall| |n#0@@3| |m#0@@3|) (and (< 2 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@3| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0@@3| Tclass.LitLet.Nat)))) ($Is DatatypeTypeType (LitLet.__default.mult $ly@@3 |n#0@@3| |m#0@@3|) Tclass.LitLet.Nat))
 :qid |LetExprdfy.416:18|
 :skolemid |1672|
 :pattern ( (LitLet.__default.mult $ly@@3 |n#0@@3| |m#0@@3|))
))))
(assert (forall (($ly@@4 T@U) (|n#0@@4| T@U) (|m#0@@4| T@U) ) (! (= (LitLet.__default.plus ($LS $ly@@4) |n#0@@4| |m#0@@4|) (LitLet.__default.plus $ly@@4 |n#0@@4| |m#0@@4|))
 :qid |LetExprdfy.410:18|
 :skolemid |1662|
 :pattern ( (LitLet.__default.plus ($LS $ly@@4) |n#0@@4| |m#0@@4|))
)))
(assert (forall (($ly@@5 T@U) (|n#0@@5| T@U) (|m#0@@5| T@U) ) (! (= (LitLet.__default.mult ($LS $ly@@5) |n#0@@5| |m#0@@5|) (LitLet.__default.mult $ly@@5 |n#0@@5| |m#0@@5|))
 :qid |LetExprdfy.416:18|
 :skolemid |1670|
 :pattern ( (LitLet.__default.mult ($LS $ly@@5) |n#0@@5| |m#0@@5|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@6 T@U) (|n#0@@6| T@U) (|m#0@@6| T@U) ) (!  (=> (or (|LitLet.__default.plus#canCall| |n#0@@6| |m#0@@6|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@6| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0@@6| Tclass.LitLet.Nat)))) (and (=> (not (LitLet.Nat.O_q |n#0@@6|)) (let ((|n'#1@@1| (LitLet.Nat.pred |n#0@@6|)))
(|LitLet.__default.plus#canCall| |n'#1@@1| |m#0@@6|))) (= (LitLet.__default.plus ($LS $ly@@6) |n#0@@6| |m#0@@6|) (ite (LitLet.Nat.O_q |n#0@@6|) |m#0@@6| (let ((|n'#0@@1| (LitLet.Nat.pred |n#0@@6|)))
(|#LitLet.Nat.S| (LitLet.__default.plus $ly@@6 |n'#0@@1| |m#0@@6|)))))))
 :qid |LetExprdfy.410:18|
 :skolemid |1667|
 :pattern ( (LitLet.__default.plus ($LS $ly@@6) |n#0@@6| |m#0@@6|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$LitLet.__default.mult)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon8_Else_correct  (=> (not (LitLet.Nat.O_q |n#0@@7|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (LitLet.Nat.S_q |n#0@@7|)) (=> (LitLet.Nat.S_q |n#0@@7|) (=> (= |let#0#0#0| (LitLet.Nat.pred |n#0@@7|)) (=> (and ($Is DatatypeTypeType |let#0#0#0| Tclass.LitLet.Nat) (= |n'#Z#0@0| |let#0#0#0|)) (=> (and (and ($IsAlloc DatatypeTypeType |m#0@@7| Tclass.LitLet.Nat $Heap) ($IsAlloc DatatypeTypeType |n'#Z#0@0| Tclass.LitLet.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |m#0@@7| Tclass.LitLet.Nat $Heap) (= (ControlFlow 0 4) (- 0 3)))) (or (< (DtRank |n'#Z#0@0|) (DtRank |n#0@@7|)) (and (= (DtRank |n'#Z#0@0|) (DtRank |n#0@@7|)) (< (DtRank |m#0@@7|) (DtRank |m#0@@7|))))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |n#0@@7| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0@@7| Tclass.LitLet.Nat)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
