...
(set-info :boogie-vc-id Impl$$_module.__default.BadEquality1_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#1|) (_module.__default.UpwardBy2 ($LS $LZ) (+ |n#1| 1))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (and (_module.Stream.Cons_q (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (_module.Stream.tail (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1)))))))))) (=> (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#1|) (_module.__default.UpwardBy2 ($LS $LZ) (+ |n#1| 1))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (and (_module.Stream.Cons_q (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (_module.Stream.tail (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#1|) (_module.__default.UpwardBy2 ($LS $LZ) (+ |n#1| 1))) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (and (_module.Stream.Cons_q (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (_module.Stream.tail (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (+ |n#1| 1)))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#1|) (_module.__default.UpwardBy2 ($LS $LZ) (+ |n#1| 1)))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|_k'#0| T@U) (|n#2| Int) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0|) (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#2|) (_module.__default.UpwardBy2 ($LS $LZ) (+ |n#2| 1))))
 :qid |CoinductiveProofsdfy.207:35|
 :skolemid |834|
 :pattern ( (_module.__default.Doubles ($LS $LZ) |n#2|) (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (and (and (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (= |n##0@0| (+ |n#1| 1))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (|_module.__default.Doubles#canCall| |n##0@0|) (|_module.__default.UpwardBy2#canCall| (+ |n##0@0| 1))) (|$PrefixEq#_module.Stream| TInt TInt |_k##0@0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n##0@0|) (_module.__default.UpwardBy2 ($LS $LZ) (+ |n##0@0| 1)))) (and (= $Heap $Heap@0) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct)))))))))
