...
(set-info :boogie-vc-id Impl$$_module.DigitUnderscore__Names__Functions__and__Methods._498)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x##0@0| (LitInt 200))) (=> (and (and (or (not (= call2formal@this null)) (not true)) (and ($Is refType call2formal@this Tclass._module.DigitUnderscore__Names__Functions__and__Methods) ($IsAlloc refType call2formal@this Tclass._module.DigitUnderscore__Names__Functions__and__Methods $Heap))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (or (not (= call2formal@this@0 null)) (not true)) (and ($Is refType call2formal@this@0 Tclass._module.DigitUnderscore__Names__Functions__and__Methods) ($IsAlloc refType call2formal@this@0 Tclass._module.DigitUnderscore__Names__Functions__and__Methods $Heap@0))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call2formal@this@0) alloc))))) (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |Compilationlegacydfy.354:15|
 :skolemid |11030|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.DigitUnderscore__Names__Functions__and__Methods) ($IsAlloc refType this Tclass._module.DigitUnderscore__Names__Functions__and__Methods $Heap)))) (and (and (=> |defass#p#0| (and ($Is refType |p#0| Tclass._module.DigitUnderscore__Names__Functions__and__Methods) ($IsAlloc refType |p#0| Tclass._module.DigitUnderscore__Names__Functions__and__Methods $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
