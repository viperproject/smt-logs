...
(set-info :boogie-vc-id CheckWellformed$$TestModule4.__default.pos)
...
(let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= StartFuel_TestModule4._default.pos ($LS BaseFuel_TestModule4._default.pos))) (and (= StartFuelAssert_TestModule4._default.pos ($LS ($LS BaseFuel_TestModule4._default.pos))) (= (AsFuelBottom BaseFuel_TestModule4._default.pos) BaseFuel_TestModule4._default.pos))) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 2) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 4) anon8_Else_correct)))))
