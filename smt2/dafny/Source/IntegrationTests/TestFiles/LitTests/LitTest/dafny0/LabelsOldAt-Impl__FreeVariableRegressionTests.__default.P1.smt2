...
(assert (distinct TInt TagInt alloc allocName Tagclass.FreeVariableRegressionTests.C class.FreeVariableRegressionTests.C? Tagclass.FreeVariableRegressionTests.C? tytagFamily$C field$x)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id Impl$$FreeVariableRegressionTests.__default.P1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc |c#0@@1|)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| FreeVariableRegressionTests.C.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@1| FreeVariableRegressionTests.C.x)) (=> (and (and (= |$rhs#0@0| (LitInt 7)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |c#0@@1| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) FreeVariableRegressionTests.C.x ($Box intType (int_2_U |$rhs#0@0|)))))) (and ($IsGoodHeap $Heap@0) (= $Heap@1 $Heap))) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#0@@1| Tclass.FreeVariableRegressionTests.C $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass.FreeVariableRegressionTests.C $Heap) (=> (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (=> (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |c#0@@1|) FreeVariableRegressionTests.C.x))) (LitInt 8)) (= $Heap@1 $Heap@2)) (and (= |y#0@0| (LitInt 3)) (= (ControlFlow 0 2) (- 0 1)))) (U_2_bool (Lit boolType (bool_2_U false)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |c#0@@1| Tclass.FreeVariableRegressionTests.C) ($IsAlloc refType |c#0@@1| Tclass.FreeVariableRegressionTests.C $Heap)) (= 2 $FunctionContextHeight)) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) FreeVariableRegressionTests.C.x))) (LitInt 8)) (= (ControlFlow 0 6) 2))) anon0_correct))))
