...
procedure {:verboseName "B.P (well-formedness)"} CheckWellFormed$$B.__default.P(x#0: int, y#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "B.P (call)"} Call$$B.__default.P(x#0: int, y#0: int);
  modifies $Heap;
...
procedure {:verboseName "B.P (correctness)"} Impl$$B.__default.P(x#0: int, y#0: int) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
