...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon11_Then_correct  (=> (<= |n#0| |i#0@1|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (= |s#0| |s#0|)) (=> (= |s#0| |s#0|) (=> (= (ControlFlow 0 5) (- 0 4)) (= |i#0@1| (LitInt 0))))))))
(let ((anon6_correct true))
(let ((anon11_Else_correct  (=> (and (< |i#0@1| |n#0|) (= (ControlFlow 0 7) 3)) anon6_correct)))
...
)) (<= (- |n#0| |i#0@1|) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 11) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 11) 10) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |i#0@0| (LitInt 0))) (and (= |$decr_init$loop#00@0| (- |n#0| |i#0@0|)) (= (ControlFlow 0 12) 11))) anon8_LoopHead_correct)))
