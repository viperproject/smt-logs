...
(set-info :boogie-vc-id CheckWellFormed$$_module.Pos.Collect)
...
))) (and ($HeapSucc $Heap $Heap@0) (= |newtype$check#0@0| (LitInt 2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< 0 |newtype$check#0@0|)) (=> (< 0 |newtype$check#0@0|) (=> (and (= |newtype$check#1@0| (+ this 2)) (= (ControlFlow 0 2) (- 0 1))) (< 0 |newtype$check#1@0|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (< 0 this)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))
