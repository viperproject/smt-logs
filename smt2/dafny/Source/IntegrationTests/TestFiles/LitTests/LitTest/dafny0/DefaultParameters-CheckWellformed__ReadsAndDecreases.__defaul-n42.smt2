...
(declare-fun ReadsAndDecreases.__default.ReadNeither (T@U T@U) Int)
(declare-fun |ReadsAndDecreases.__default.ReadNeither#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| T@U) (|m#0| T@U) ) (!  (=> (or (|ReadsAndDecreases.__default.ReadNeither#canCall| |a#0| |m#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) ($Is refType |a#0| (Tclass._System.array TInt))) ($Is refType |m#0| (Tclass._System.array2 TInt))) (and (= (_System.array.Length |a#0|) (LitInt 0)) (= (LitInt 0) (_System.array2.Length0 |m#0|)))))) (and (|ReadsAndDecreases.__default.MoreReads#canCall| |a#0| |m#0| (ite (< 0 (_System.array.Length |a#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 |m#0|)) (< 0 (_System.array2.Length1 |m#0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)) (= (ReadsAndDecreases.__default.ReadNeither |a#0| |m#0|) (ReadsAndDecreases.__default.MoreReads |a#0| |m#0| (ite (< 0 (_System.array.Length |a#0|)) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 |m#0|)) (< 0 (_System.array2.Length1 |m#0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)))))
 :pattern ( (ReadsAndDecreases.__default.ReadNeither |a#0| |m#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|a#0@@0| T@U) (|m#0@@0| T@U) ) (!  (=> (or (|ReadsAndDecreases.__default.ReadNeither#canCall| (Lit refType |a#0@@0|) (Lit refType |m#0@@0|)) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) ($Is refType |a#0@@0| (Tclass._System.array TInt))) ($Is refType |m#0@@0| (Tclass._System.array2 TInt))) (and (= (LitInt (_System.array.Length (Lit refType |a#0@@0|))) (LitInt 0)) (= (LitInt 0) (LitInt (_System.array2.Length0 (Lit refType |m#0@@0|)))))))) (and (|ReadsAndDecreases.__default.MoreReads#canCall| (Lit refType |a#0@@0|) (Lit refType |m#0@@0|) (ite (< 0 (_System.array.Length (Lit refType |a#0@@0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |a#0@@0|)) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 (Lit refType |m#0@@0|))) (< 0 (_System.array2.Length1 (Lit refType |m#0@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |m#0@@0|)) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)) (= (ReadsAndDecreases.__default.ReadNeither (Lit refType |a#0@@0|) (Lit refType |m#0@@0|)) (ReadsAndDecreases.__default.MoreReads (Lit refType |a#0@@0|) (Lit refType |m#0@@0|) (ite (< 0 (_System.array.Length (Lit refType |a#0@@0|))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |a#0@@0|)) (IndexField (LitInt 0))))) 3) (ite  (and (< 0 (_System.array2.Length0 (Lit refType |m#0@@0|))) (< 0 (_System.array2.Length1 (Lit refType |m#0@@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (Lit refType |m#0@@0|)) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) 3)))))
 :weight 3
 :pattern ( (ReadsAndDecreases.__default.ReadNeither (Lit refType |a#0@@0|) (Lit refType |m#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(let ((anon3_correct  (=> (and (= (_System.array.Length |a#0@@1|) (LitInt 0)) (= (LitInt 0) (_System.array2.Length0 |m#0@@1|))) (and (=> (= (ControlFlow 0 3) 1) anon8_Then_correct) (=> (= (ControlFlow 0 3) 2) anon8_Else_correct)))))
(let ((anon7_Else_correct  (=> (and (or (not (= (_System.array.Length |a#0@@1|) (LitInt 0))) (not true)) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon7_Then_correct  (=> (= (_System.array.Length |a#0@@1|) (LitInt 0)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |m#0@@1| null)) (not true))) (=> (or (not (= |m#0@@1| null)) (not true)) (=> (= (ControlFlow 0 4) 3) anon3_correct))))))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (not (= |a#0@@1| null)) (not true))) (=> (or (not (= |a#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 7) 4) anon7_Then_correct) (=> (= (ControlFlow 0 7) 6) anon7_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is refType |a#0@@1| (Tclass._System.array TInt)) ($Is refType |m#0@@1| (Tclass._System.array2 TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 7))) anon0_correct))))
