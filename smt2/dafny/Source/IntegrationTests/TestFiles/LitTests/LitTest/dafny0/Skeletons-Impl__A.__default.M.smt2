...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let (($generated@@110  (=> (and (or (not (= $generated@@96 ($generated@@46 120))) (not true)) (= $generated@@97 (+ $generated@@96 1))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (<= 0 $generated@@98) (= (- 120 $generated@@97) $generated@@98))) (=> (or (<= 0 $generated@@98) (= (- 120 $generated@@97) $generated@@98)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (< (- 120 $generated@@97) $generated@@98)) (=> (< (- 120 $generated@@97) $generated@@98) (=> (= (ControlFlow 0 6) (- 0 5)) (=> $generated@@99 (<= $generated@@97 ($generated@@46 120)))))))))))
(let (($generated@@111 true))
(let (($generated@@112  (=> (and (= $generated@@96 ($generated@@46 120)) (= (ControlFlow 0 4) 3)) $generated@@111)))
(let (($generated@@113  (=> (= $generated@@98 (- 120 $generated@@96)) (and (=> (= (ControlFlow 0 9) 4) $generated@@112) (=> (= (ControlFlow 0 9) 6) $generated@@110)))))
(let (($generated@@114  (=> $generated@@99 (and (=> (= (ControlFlow 0 10) 9) $generated@@113) (=> (= (ControlFlow 0 10) 3) $generated@@111)))))
(let (($generated@@115 true))
(let (($generated@@116  (and (=> (= (ControlFlow 0 11) 2) $generated@@115) (=> (= (ControlFlow 0 11) 10) $generated@@114))))
(let (($generated@@117 true))
(let (($generated@@118  (=> (and (and (and (not false) (<= 69 $generated@@100)) (=> $generated@@99 (<= $generated@@96 ($generated@@46 120)))) (and (and (forall (($generated@@119 T@U) ) (!  (=> (and (or (not (= $generated@@119 $generated@@102)) (not true)) ($generated@@6 ($generated@@7 $generated@@8 ($generated@@0 $generated@@1 $generated@@2 ($generated@@0 $generated@@3 ($generated@@4 $generated@@1 $generated@@2) $generated@@101 $generated@@119) $generated@@5)))) (= ($generated@@0 $generated@@3 ($generated@@4 $generated@@1 $generated@@2) $generated@@101 $generated@@119) ($generated@@0 $generated@@3 ($generated@@4 $generated@@1 $generated@@2) $generated@@101 $generated@@119)))
...
)) (<= (- 120 $generated@@96) $generated@@100)))) (and (=> (= (ControlFlow 0 12) 1) $generated@@117) (=> (= (ControlFlow 0 12) 11) $generated@@116)))))
(let (($generated@@122  (=> (= $generated@@103 ($generated@@60 $generated@@102 $generated@@101 $generated@@5 false)) (=> (and (and (< $generated@@104 100) (= $generated@@105 (+ $generated@@104 20))) (and (= $generated@@106 (+ $generated@@105 1)) (= $generated@@100 (- 120 $generated@@106)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (=> $generated@@99 (<= $generated@@106 ($generated@@46 120)))) (=> (=> $generated@@99 (<= $generated@@106 ($generated@@46 120))) (=> (= (ControlFlow 0 13) 12) $generated@@118)))))))
(let (($generated@@123  (=> (and (and (and ($generated@@107 $generated@@101) ($generated@@108 $generated@@101)) (= 0 $generated@@109)) (and (<= $generated@@104 ($generated@@46 30)) (= (ControlFlow 0 15) 13))) $generated@@122)))
$generated@@123))))))))))))
))
(check-sat)
(get-info :rlimit)
