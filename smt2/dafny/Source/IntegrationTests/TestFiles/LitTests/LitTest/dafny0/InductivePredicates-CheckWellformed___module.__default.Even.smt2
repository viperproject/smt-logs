...
(assert (distinct TBool TagBool alloc Tagclass._System.nat Tagclass._module.natinf |##_module.natinf.N| |##_module.natinf.Inf| tytagFamily$nat tytagFamily$natinf)
)
...
(let ((anon16_Else_correct  (=> (and (not (and (_module.natinf.N_q |x#0@@11|) (<= (LitInt 2) (_module.natinf.n |x#0@@11|)))) (= (ControlFlow 0 7) 2)) anon10_correct)))
(let ((anon16_Then_correct  (=> (and (_module.natinf.N_q |x#0@@11|) (<= (LitInt 2) (_module.natinf.n |x#0@@11|))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (_module.natinf.N_q |x#0@@11|)) (=> (_module.natinf.N_q |x#0@@11|) (and (=> (= (ControlFlow 0 4) (- 0 5)) ($Is intType (int_2_U (- (_module.natinf.n |x#0@@11|) 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- (_module.natinf.n |x#0@@11|) 2)) Tclass._System.nat) (=> (and (and (= |##x#0@0| (|#_module.natinf.N| (- (_module.natinf.n |x#0@@11|) 2))) ($IsAlloc DatatypeTypeType |##x#0@0| Tclass._module.natinf $Heap)) (and (|_module.__default.Even#canCall| (|#_module.natinf.N| (- (_module.natinf.n |x#0@@11|) 2))) (= (ControlFlow 0 4) 2))) anon10_correct))))))))
(let ((anon15_Else_correct  (=> (not (_module.natinf.N_q |x#0@@11|)) (and (=> (= (ControlFlow 0 10) 4) anon16_Then_correct) (=> (= (ControlFlow 0 10) 7) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (_module.natinf.N_q |x#0@@11|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (_module.natinf.N_q |x#0@@11|)) (=> (_module.natinf.N_q |x#0@@11|) (and (=> (= (ControlFlow 0 8) 4) anon16_Then_correct) (=> (= (ControlFlow 0 8) 7) anon16_Else_correct)))))))
(let ((anon14_Then_correct  (=> (not (and (_module.natinf.N_q |x#0@@11|) (= (_module.natinf.n |x#0@@11|) (LitInt 0)))) (and (=> (= (ControlFlow 0 11) 8) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))
(let ((anon14_Else_correct  (=> (and (and (_module.natinf.N_q |x#0@@11|) (= (_module.natinf.n |x#0@@11|) (LitInt 0))) (= (ControlFlow 0 3) 2)) anon10_correct)))
(let ((anon13_Else_correct  (=> (not (_module.natinf.N_q |x#0@@11|)) (and (=> (= (ControlFlow 0 14) 11) anon14_Then_correct) (=> (= (ControlFlow 0 14) 3) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (_module.natinf.N_q |x#0@@11|) (and (=> (= (ControlFlow 0 12) (- 0 13)) (_module.natinf.N_q |x#0@@11|)) (=> (_module.natinf.N_q |x#0@@11|) (and (=> (= (ControlFlow 0 12) 11) anon14_Then_correct) (=> (= (ControlFlow 0 12) 3) anon14_Else_correct)))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 15) 1) anon12_Then_correct) (=> (= (ControlFlow 0 15) 12) anon13_Then_correct)) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |x#0@@11| Tclass._module.natinf)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct)))
