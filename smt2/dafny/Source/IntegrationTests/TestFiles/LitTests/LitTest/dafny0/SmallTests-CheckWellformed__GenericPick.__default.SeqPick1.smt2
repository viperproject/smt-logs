...
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (or (not (|Seq#Equal| |s#0@@3| |Seq#Empty|)) (or (not (= (|Seq#Length| |s#0@@3|) 0)) (not true))) (exists ((|i#1| Int) )  (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |s#0@@3|)))))) (=> (or (or (not (|Seq#Equal| |s#0@@3| |Seq#Empty|)) (or (not (= (|Seq#Length| |s#0@@3|) 0)) (not true))) (exists ((|i#1@@0| Int) )  (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (|Seq#Length| |s#0@@3|))))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (exists ((|x#1@@0| T@U) ) (!  (and ($IsBox |x#1@@0| GenericPick._default.SeqPick1$U@@4) (|Seq#Contains| |s#0@@3| |x#1@@0|))
