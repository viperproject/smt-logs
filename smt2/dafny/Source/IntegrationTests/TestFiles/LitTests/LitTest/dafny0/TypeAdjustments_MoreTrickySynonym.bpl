...
procedure {:verboseName "MoreTrickySynonym.M0 (well-formedness)"} CheckWellFormed$$MoreTrickySynonym.__default.M0(n#0: int, b#0: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "MoreTrickySynonym.M0 (call)"} Call$$MoreTrickySynonym.__default.M0(n#0: int, b#0: bool);
  modifies $Heap;
...
procedure {:verboseName "MoreTrickySynonym.M0 (correctness)"} Impl$$MoreTrickySynonym.__default.M0(n#0: int, b#0: bool) returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
