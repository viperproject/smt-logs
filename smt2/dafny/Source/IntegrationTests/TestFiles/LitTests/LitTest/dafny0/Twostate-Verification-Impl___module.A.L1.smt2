...
(declare-fun |res#0@0| () Bool)
(declare-fun this () T@U)
(declare-fun |other#0| () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $Heap () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun previous$Heap () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.A.L1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and (and (= |res#0@0| (= this |other#0|)) (= (ControlFlow 0 2) (- 0 1))) |res#0@0|) (= this |other#0|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A previous$Heap)))) (and (and ($Is refType |other#0| Tclass._module.A) ($IsAlloc refType |other#0| Tclass._module.A previous$Heap)) (= 1 $FunctionContextHeight))) (and (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAlloc refType |other#0| Tclass._module.A previous$Heap)) (and (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@2 null)) (not true)) (=> (= $o@@2 this) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@2) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap $o@@2) $f@@0))))
 :qid |TwostateVerificationdfy.26:14|
 :skolemid |1549|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@2) $f@@0))
