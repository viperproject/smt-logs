...
)) (forall ((|k#0_2@@0| T@U) )  (=> (|Set#IsMember| |S#0@0| ($Box intType |k#0_2@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))) ($Box intType (int_2_U (LitInt 0)))))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array2.Length0 $nw@0)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array2.Length1 $nw@0)))) (=> (= (ControlFlow 0 8) (- 0 7)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) (MultiIndexField (IndexField (LitInt 0)) (LitInt 0))))) (LitInt 0))))))))))
