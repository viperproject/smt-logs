...
procedure {:verboseName "CorrectReqOrdering.f1 (well-formedness)"} CheckWellformed$$CorrectReqOrdering.__default.f1(x#0: int);
...
procedure {:verboseName "CorrectReqOrdering.f2 (well-formedness)"} CheckWellformed$$CorrectReqOrdering.__default.f2(b#0: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id119"} 1 <= $FunctionContextHeight
   ==> (forall z#0: int :: 
    ...
    CorrectReqOrdering.__default.f3#canCall(z#0)
         || (1 < $FunctionContextHeight && z#0 > 3 && CorrectReqOrdering.__default.f1(z#0))
   ...
   ==> (forall z#0: int :: 
    ...
    CorrectReqOrdering.__default.f3#canCall(LitInt(z#0))
         || (1 < $FunctionContextHeight
           && 
          Lit(z#0 > 3)
           && CorrectReqOrdering.__default.f1(LitInt(z#0)))
...
procedure {:verboseName "CorrectReqOrdering.f3 (well-formedness)"} CheckWellformed$$CorrectReqOrdering.__default.f3(z#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CorrectReqOrdering.f3 (well-formedness)"} CheckWellformed$$CorrectReqOrdering.__default.f3(z#0: int)
{
  ...
  var ##x#1: int;
    ...
    assume {:id "id121"} z#0 > 3;
    ##x#0 := z#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assert {:id "id122"} {:subsumption 0} ##x#0 > 3;
    assume ##x#0 > 3;
    assume CorrectReqOrdering.__default.f1#canCall(z#0);
    assume {:id "id123"} CorrectReqOrdering.__default.f1(z#0);
    ...
    else
    {
        ...
        assert {:id "id124"} {:subsumption 0} ##x#1 > 3;
        assume ##x#1 > 3;
        assume CorrectReqOrdering.__default.f1#canCall(z#0);
        ##b#0 := CorrectReqOrdering.__default.f1(z#0);
        // assume allocatedness for argument to function
        assume $IsAlloc(##b#0, TBool, $Heap);
        assert {:id "id125"} {:subsumption 0} ##b#0;
        assume ##b#0;
        assume CorrectReqOrdering.__default.f2#canCall(CorrectReqOrdering.__default.f1(z#0));
        assume {:id "id126"} CorrectReqOrdering.__default.f3(z#0)
           == CorrectReqOrdering.__default.f2(CorrectReqOrdering.__default.f1(z#0));
        assume CorrectReqOrdering.__default.f1#canCall(z#0)
           && CorrectReqOrdering.__default.f2#canCall(CorrectReqOrdering.__default.f1(z#0));
        // CheckWellformedWithResult: any expression
        assume $Is(CorrectReqOrdering.__default.f3(z#0), TBool);
        return;
