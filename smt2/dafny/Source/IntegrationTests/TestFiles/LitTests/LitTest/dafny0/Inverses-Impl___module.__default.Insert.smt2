...
(declare-fun |lambda#36| (Bool) T@U)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#_v0#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#35| |l#0|) |$l#0#heap#0| |$l#0#_v0#0|)) ($IsBox |$l#0#_v0#0| |l#0|))
 :qid |unknown.0:0|
 :skolemid |665|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#35| |l#0|) |$l#0#heap#0| |$l#0#_v0#0|))
)))
...
(assert (forall ((|l#0@@1| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#36| |l#0@@1|) |$l#0#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |666|
 :pattern ( (MapType1Select refType boolType (|lambda#36| |l#0@@1|) |$l#0#o#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@1| Int) ) (!  (=> (or (|_module.__default.Id#canCall| |x#0@@1|) (< 0 $FunctionContextHeight)) (= (_module.__default.Id |x#0@@1|) |x#0@@1|))
 :qid |Inversesdfy.12:13|
 :skolemid |481|
 :pattern ( (_module.__default.Id |x#0@@1|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@2| Int) ) (!  (=> (or (|_module.__default.Id#canCall| (LitInt |x#0@@2|)) (< 0 $FunctionContextHeight)) (= (_module.__default.Id (LitInt |x#0@@2|)) (LitInt |x#0@@2|)))
 :qid |Inversesdfy.12:13|
 :weight 3
 :skolemid |482|
 :pattern ( (_module.__default.Id (LitInt |x#0@@2|)))
))))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#i#0|) |l#0@@3|)
 :qid |Inversesdfy.17:24|
 :skolemid |661|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#5| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#i#0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#_v0#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#34| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#_v0#0@@0|) |l#0@@4|)
 :qid |Inversesdfy.53:47|
 :skolemid |664|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#34| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#_v0#0@@0|))
)))
...
(declare-fun |t#0| () T@U)
(declare-fun _module._default.Insert$T () T@U)
...
(declare-fun $LZ () T@U)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Insert)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon3_correct true))
(let ((anon13_Else_correct  (=> (and (< |_v0#0@0| (LitInt 0)) (= (ControlFlow 0 25) 23)) anon3_correct)))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |_v0#0@0|) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| |t#0|)) (and ($IsBox |lambdaResult#0| _module._default.Insert$T) (= (ControlFlow 0 24) 23))) anon3_correct))))
(let ((anon12_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 26) 24) anon13_Then_correct) (=> (= (ControlFlow 0 26) 25) anon13_Else_correct)))))
(let ((anon10_correct  (and (=> (= (ControlFlow 0 8) (- 0 12)) (and (<= 0 (ite (< |i#0_0@0| |p#0|) |i#0_0@0| (+ |i#0_0@0| |n#0|))) (< (ite (< |i#0_0@0| |p#0|) |i#0_0@0| (+ |i#0_0@0| |n#0|)) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (ite (< |i#0_0@0| |p#0|) |i#0_0@0| (+ |i#0_0@0| |n#0|)))))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (ite (< |i#0_0@0| |p#0|) |i#0_0@0| (+ |i#0_0@0| |n#0|))))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and ($IsAlloc intType (int_2_U |i#0_0@0|) TInt $Heap@0) (|_module.__default.Id#canCall| |i#0_0@0|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (<= 0 (_module.__default.Id |i#0_0@0|)) (< (_module.__default.Id |i#0_0@0|) (_System.array.Length |a#0|)))) (=> (|_module.__default.Id#canCall| |i#0_0@0|) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 8) (- 0 7)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (ite (< |i#0_0@0| |p#0|) |i#0_0@0| (+ |i#0_0@0| |n#0|))) (IndexField (ite (< |i#0_1@0| |p#0|) |i#0_1@0| (+ |i#0_1@0| |n#0|))))) (not true))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_0@0|))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_1@0|))))))))))))))))
(let ((anon16_Else_correct  (=> (and (<= |p#0| |i#0_0@0|) (= (ControlFlow 0 14) 8)) anon10_correct)))
(let ((anon16_Then_correct  (=> (and (< |i#0_0@0| |p#0|) (= (ControlFlow 0 13) 8)) anon10_correct)))
(let ((anon7_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 15) 13) anon16_Then_correct) (=> (= (ControlFlow 0 15) 14) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 19) 15)) anon7_correct)))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 17) 15) anon7_correct)))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 20) 17) anon15_Then_correct) (=> (= (ControlFlow 0 20) 19) anon15_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |r#0@0|) alloc)))))) (=> (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |r#0@0|) alloc))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (_System.array.Length |r#0@0|) (+ (_System.array.Length |a#0|) |n#0|))) (=> (= (_System.array.Length |r#0@0|) (+ (_System.array.Length |a#0|) |n#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|k#1| Int) ) (!  (=> (and (<= (LitInt 0) |k#1|) (< |k#1| |p#0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |r#0@0|) (IndexField |k#1|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#1|))))
 :qid |Inversesdfy.56:18|
 :skolemid |533|
...
))) (=> (forall ((|k#1@@0| Int) ) (!  (=> (and (<= (LitInt 0) |k#1@@0|) (< |k#1@@0| |p#0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |r#0@0|) (IndexField |k#1@@0|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#1@@0|))))
 :qid |Inversesdfy.56:18|
 :skolemid |533|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#1@@0|)))
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |r#0@0|) (IndexField |k#1@@0|)))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|k#3| Int) ) (!  (=> (and (<= |p#0| |k#3|) (< |k#3| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |r#0@0|) (IndexField (+ |k#3| |n#0|))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#3|))))
 :qid |Inversesdfy.57:18|
 :skolemid |534|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#3|)))
)))))))))))
(let ((anon14_Else_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) ($HeapSucc $Heap@0 $Heap@1)) (and (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (or (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@8) $f@@0) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@8) $f@@0)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| (_System.array.Length |a#0|))) (= $o@@8 $nw@0)) (= $f@@0 (IndexField (ite (< |i#0_2| |p#0|) |i#0_2| (+ |i#0_2| |n#0|)))))
 :qid |Inversesdfy.60:10|
 :skolemid |538|
)))
 :qid |Inversesdfy.60:3|
 :skolemid |539|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@8) $f@@0))
)) (forall ((|i#inv#0_0| Int) ) (!  (=> (and (and (<= (LitInt 0) |i#inv#0_0|) (< |i#inv#0_0| (_System.array.Length |a#0|))) (< |i#inv#0_0| |p#0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#inv#0_0|)))))
 :qid |Inversesdfy.60:10|
 :skolemid |540|
...
)))) (and (and (forall ((|i#inv#0_0@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) (- |i#inv#0_0@@0| |n#0|)) (< (- |i#inv#0_0@@0| |n#0|) (_System.array.Length |a#0|))) (not (< (- |i#inv#0_0@@0| |n#0|) |p#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0@@0|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id (- |i#inv#0_0@@0| |n#0|))))))
 :qid |Inversesdfy.60:10|
 :skolemid |541|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0@@0|)))
)) (= $Heap@2 $Heap@1)) (and (= |r#0@0| $nw@0) (= (ControlFlow 0 6) 2)))) GeneratedUnifiedExit_correct)))
(let ((anon12_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.Insert$T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (+ (_System.array.Length |a#0|) |n#0|)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (+ (_System.array.Length |a#0|) |n#0|))) (Requires1 Tclass._System.nat _module._default.Insert$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#34| |t#0|) (|lambda#35| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#36| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Inversesdfy.59:8|
 :skolemid |536|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (+ (_System.array.Length |a#0|) |n#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 Tclass._System.nat _module._default.Insert$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#34| |t#0|) (|lambda#35| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#36| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |Inversesdfy.59:8|
 :skolemid |537|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 21) 20) anon14_Then_correct) (=> (= (ControlFlow 0 21) 6) anon14_Else_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 27) (- 0 29)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= 0 (+ (_System.array.Length |a#0|) |n#0|))) (=> (<= 0 (+ (_System.array.Length |a#0|) |n#0|)) (and (=> (= (ControlFlow 0 27) 26) anon12_Then_correct) (=> (= (ControlFlow 0 27) 21) anon12_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array _module._default.Insert$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.Insert$T) $Heap))) (and (and (<= (LitInt 0) |p#0|) (<= (LitInt 0) |n#0|)) (and ($IsBox |t#0| _module._default.Insert$T) ($IsAllocBox |t#0| _module._default.Insert$T $Heap)))) (and (and (and ($Is refType |r#0| (Tclass._System.array _module._default.Insert$T)) ($IsAlloc refType |r#0| (Tclass._System.array _module._default.Insert$T) $Heap)) (= 1 $FunctionContextHeight)) (and (<= |p#0| (_System.array.Length |a#0|)) (= (ControlFlow 0 30) 27)))) anon0_correct)))
