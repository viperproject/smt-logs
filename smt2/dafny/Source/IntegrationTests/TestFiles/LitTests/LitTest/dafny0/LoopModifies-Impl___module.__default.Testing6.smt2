...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| T@U) (|l#4| T@U) ($o@@6 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#15| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0| |l#4|) $o@@6 $f@@0))  (=> (and (or (not (= $o@@6 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@6) |l#2@@0|)))) (or (= $o@@6 |l#3@@0|) (= $o@@6 |l#4|))))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |594|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#15| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0| |l#4|) $o@@6 $f@@0))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Testing6)
...
(let ((anon10_Else_correct  (=> (and (< |i#0@1| (LitInt 0)) (= (ControlFlow 0 17) 15)) anon4_correct)))
(let ((anon10_Then_correct  (=> (and (<= (LitInt 0) |i#0@1|) (= (ControlFlow 0 16) 15)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 18) 16) anon10_Then_correct) (=> (= (ControlFlow 0 18) 17) anon10_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (< |i#0@1| 10) (= |$decr$loop#00@1| (- 10 |i#0@1|))) (and (=> (= (ControlFlow 0 4) (- 0 13)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 12)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 4) (- 0 11)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |a#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |a#0| (IndexField (LitInt 0)))) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (LitInt 0)) ($Box intType (int_2_U |i#0@1|))))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 4) (- 0 10)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |b#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |b#0|))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |b#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |b#0| (IndexField (LitInt 0)))) (=> (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 |b#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |b#0|) (IndexField (LitInt 0)) ($Box intType (int_2_U |i#0@1|))))) (=> (and ($IsGoodHeap $Heap@2) (= |i#0@2| (+ |i#0@1| 1))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (< (- 10 |i#0@2|) |$decr$loop#00@1|)) (=> (< (- 10 |i#0@2|) |$decr$loop#00@1|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|)) (=> (= (ControlFlow 0 4) (- 0 3)) (=> |$w$loop#0@0| (<= |i#0@2| (LitInt 10))))))))))))))))))))))))))))
(let ((anon11_Then_correct true))
(let ((anon9_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 14) 2) anon11_Then_correct) (=> (= (ControlFlow 0 14) 4) anon11_Else_correct)))))
(let ((anon8_LoopBody_correct  (and (=> (= (ControlFlow 0 19) 18) anon9_Then_correct) (=> (= (ControlFlow 0 19) 14) anon9_Else_correct))))
(let ((anon8_LoopDone_correct true))
(let ((anon8_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (<= |i#0@1| (LitInt 10))))) (and (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7)) (or (= $o@@7 |a#0|) (= $o@@7 |b#0|))))
 :qid |LoopModifiesdfy.92:4|
 :skolemid |514|
...
)) (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 20) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 20) 19) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#15| null $Heap alloc |a#0| |b#0|)) (= |i#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall (($o@@9 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@9) alloc)))) (= $o@@9 |a#0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@9 $f@@2)))
 :qid |LoopModifiesdfy.92:4|
 :skolemid |513|
))) (=> (forall (($o@@10 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@10) alloc)))) (= $o@@10 |a#0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@10 $f@@3)))
 :qid |LoopModifiesdfy.92:4|
 :skolemid |513|
)) (=> (and (= |$Frame$loop#0@0| (|lambda#4| null $Heap alloc |a#0|)) (= |$decr_init$loop#00@0| (- 10 |i#0@0|))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10)))) (=> (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10))) (=> (= (ControlFlow 0 21) 20) anon8_LoopHead_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and ($Is refType |b#0| (Tclass._System.array TInt)) ($IsAlloc refType |b#0| (Tclass._System.array TInt) $Heap))) (and (and (= 0 $FunctionContextHeight) (> (_System.array.Length |a#0|) 0)) (and (> (_System.array.Length |b#0|) 0) (= (ControlFlow 0 25) 21)))) anon0_correct))))
