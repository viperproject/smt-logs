...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@92  (=> (= (ControlFlow 0 4) (- 0 3)) ($generated@@5 ($generated $generated@@1 ($generated@@4  (or (not (= 0 0)) (not true))))))))
(let (($generated@@93  (=> (= (ControlFlow 0 2) (- 0 1)) ($generated@@5 ($generated $generated@@1 ($generated@@4 true))))))
(let (($generated@@94  (=> (= $generated@@85 ($generated@@27 $generated@@86 $generated@@87 $generated@@88 false)) (and (=> (= (ControlFlow 0 5) 2) $generated@@93) (=> (= (ControlFlow 0 5) 4) $generated@@92)))))
(let (($generated@@95  (=> (and (and ($generated@@89 $generated@@87) ($generated@@90 $generated@@87)) (and (= 0 $generated@@91) (= (ControlFlow 0 6) 5))) $generated@@94)))
$generated@@95)))))
))
(check-sat)
