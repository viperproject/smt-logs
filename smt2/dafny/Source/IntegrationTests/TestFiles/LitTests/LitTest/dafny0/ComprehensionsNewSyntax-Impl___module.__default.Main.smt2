...
(assert (forall ((|l#0| T@U) (|l#1| Bool) (|$y#2| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#6| |l#0| |l#1|) |$y#2|))  (and ($IsBox |$y#2| |l#0|) |l#1|))
 :qid |ComprehensionsNewSyntaxdfy.17:10|
 :skolemid |764|
 :pattern ( (MapType0Select BoxType boolType (|lambda#6| |l#0| |l#1|) |$y#2|))
)))
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| Int) (|l#2| Int) (|l#3| Int) (|$y#5| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#9| |l#0@@0| |l#1@@0| |l#2| |l#3|) |$y#5|)) (exists ((|k#5| Int) (|i#3| Int) ) (!  (and (and (|Seq#Contains| |l#0@@0| ($Box intType (int_2_U |k#5|))) (and (and (<= |l#1@@0| |i#3|) (< |i#3| |k#5|)) (= (Mod |i#3| |l#2|) |l#3|))) (= |$y#5| ($Box intType (int_2_U (+ |k#5| |i#3|)))))
 :qid |ComprehensionsNewSyntaxdfy.32:16|
 :skolemid |501|
)))
 :qid |ComprehensionsNewSyntaxdfy.31:7|
 :skolemid |767|
 :pattern ( (MapType0Select BoxType boolType (|lambda#9| |l#0@@0| |l#1@@0| |l#2| |l#3|) |$y#5|))
)))
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@1| T@U) (|l#2@@0| Int) (|l#3@@0| Int) (|$y#4| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#8| |l#0@@1| |l#1@@1| |l#2@@0| |l#3@@0|) |$y#4|))  (and ($IsBox |$y#4| |l#0@@1|) (and (|Set#IsMember| |l#1@@1| |$y#4|) (= (Mod (U_2_int ($Unbox intType |$y#4|)) |l#2@@0|) |l#3@@0|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |766|
 :pattern ( (MapType0Select BoxType boolType (|lambda#8| |l#0@@1| |l#1@@1| |l#2@@0| |l#3@@0|) |$y#4|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@2| Int) (|l#2@@1| T@U) (|$y#3| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#7| |l#0@@2| |l#1@@2| |l#2@@1|) |$y#3|)) (exists ((|k#0| Int) ) (!  (and (|Set#IsMember| |l#0@@2| ($Box intType (int_2_U |k#0|))) (= |$y#3| ($Box intType (int_2_U (Mul |l#1@@2| |k#0|)))))
 :qid |ComprehensionsNewSyntaxdfy.28:16|
 :skolemid |498|
 :pattern ( (|Set#IsMember| |l#2@@1| ($Box intType (int_2_U |k#0|))))
)))
 :qid |ComprehensionsNewSyntaxdfy.22:7|
 :skolemid |765|
 :pattern ( (MapType0Select BoxType boolType (|lambda#7| |l#0@@2| |l#1@@2| |l#2@@1|) |$y#3|))
)))
(assert (forall ((|l#0@@3| Int) (|l#1@@3| Int) (|l#2@@2| Int) (|l#3@@1| Int) (|$y#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#4| |l#0@@3| |l#1@@3| |l#2@@2| |l#3@@1|) |$y#0|)) (exists ((|i#0| Int) (|j#0| Int) ) (!  (and (and (and (<= |l#0@@3| |i#0|) (< |i#0| |l#1@@3|)) (and (<= |l#2@@2| |j#0|) (< |j#0| |l#3@@1|))) (= |$y#0| ($Box intType (int_2_U (+ |i#0| |j#0|)))))
 :qid |ComprehensionsNewSyntaxdfy.22:16|
 :skolemid |491|
)))
 :qid |unknown.0:0|
 :skolemid |762|
 :pattern ( (MapType0Select BoxType boolType (|lambda#4| |l#0@@3| |l#1@@3| |l#2@@2| |l#3@@1|) |$y#0|))
)))
...
(assert (forall ((|l#0@@4| Bool) (|l#1@@4| Int) (|l#2@@3| Int) (|$y#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#5| |l#0@@4| |l#1@@4| |l#2@@3|) |$y#1|)) (exists ((|b#0| Bool) ) (!  (and |l#0@@4| (= |$y#1| ($Box intType (int_2_U (ite |b#0| |l#1@@4| |l#2@@3|)))))
 :qid |ComprehensionsNewSyntaxdfy.24:12|
 :skolemid |493|
)))
 :qid |ComprehensionsNewSyntaxdfy.24:40|
 :skolemid |763|
...
(let ((anon70_Else_correct  (=> (and (not (and (|Seq#Contains| |sq#0@0| ($Box intType (int_2_U |k#7@0|))) (and (and (<= (LitInt 0) |i#5@0|) (< |i#5@0| |k#7@0|)) (= (Mod |i#5@0| (LitInt 7)) (LitInt 0))))) (= (ControlFlow 0 9) 7)) anon43_correct)))
(let ((anon70_Then_correct  (=> (and (and (|Seq#Contains| |sq#0@0| ($Box intType (int_2_U |k#7@0|))) (and (and (<= (LitInt 0) |i#5@0|) (< |i#5@0| |k#7@0|)) (= (Mod |i#5@0| (LitInt 7)) (LitInt 0)))) (= (ControlFlow 0 8) 7)) anon43_correct)))
(let ((anon69_Else_correct  (=> (not (and (<= (LitInt 0) |i#5@0|) (< |i#5@0| |k#7@0|))) (and (=> (= (ControlFlow 0 13) 8) anon70_Then_correct) (=> (= (ControlFlow 0 13) 9) anon70_Else_correct)))))
(let ((anon69_Then_correct  (=> (and (<= (LitInt 0) |i#5@0|) (< |i#5@0| |k#7@0|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= (LitInt 7) 0)) (not true))) (=> (or (not (= (LitInt 7) 0)) (not true)) (and (=> (= (ControlFlow 0 11) 8) anon70_Then_correct) (=> (= (ControlFlow 0 11) 9) anon70_Else_correct)))))))
(let ((anon68_Else_correct  (=> (< |i#5@0| (LitInt 0)) (and (=> (= (ControlFlow 0 15) 11) anon69_Then_correct) (=> (= (ControlFlow 0 15) 13) anon69_Else_correct)))))
(let ((anon68_Then_correct  (=> (<= (LitInt 0) |i#5@0|) (and (=> (= (ControlFlow 0 14) 11) anon69_Then_correct) (=> (= (ControlFlow 0 14) 13) anon69_Else_correct)))))
...
(let ((anon67_Else_correct  (=> (not (|Seq#Contains| |sq#0@0| ($Box intType (int_2_U |k#7@0|)))) (and (=> (= (ControlFlow 0 10) 8) anon70_Then_correct) (=> (= (ControlFlow 0 10) 9) anon70_Else_correct)))))
(let ((anon66_Then_correct  (and (=> (= (ControlFlow 0 17) 16) anon67_Then_correct) (=> (= (ControlFlow 0 17) 10) anon67_Else_correct))))
...
(let ((anon35_correct  (=> (= |s##4@0| (|Set#FromBoogieMap| (|lambda#9| |sq#0@0| (LitInt 0) (LitInt 7) (LitInt 0)))) (=> (and (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4)) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@0)))
 :qid |ComprehensionsNewSyntaxdfy.36:8|
 :skolemid |505|
...
(let ((anon65_Else_correct  (=> (and (not (and (|Seq#Contains| |sq#0@0| ($Box intType (int_2_U |k#4@0|))) (and (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |k#4@0|)) (= (Mod |i#2@0| (LitInt 7)) (LitInt 0))))) (= (ControlFlow 0 20) 18)) anon35_correct)))
(let ((anon65_Then_correct  (=> (and (and (|Seq#Contains| |sq#0@0| ($Box intType (int_2_U |k#4@0|))) (and (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |k#4@0|)) (= (Mod |i#2@0| (LitInt 7)) (LitInt 0)))) (= (ControlFlow 0 19) 18)) anon35_correct)))
(let ((anon64_Else_correct  (=> (not (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |k#4@0|))) (and (=> (= (ControlFlow 0 24) 19) anon65_Then_correct) (=> (= (ControlFlow 0 24) 20) anon65_Else_correct)))))
(let ((anon64_Then_correct  (=> (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| |k#4@0|)) (and (=> (= (ControlFlow 0 22) (- 0 23)) (or (not (= (LitInt 7) 0)) (not true))) (=> (or (not (= (LitInt 7) 0)) (not true)) (and (=> (= (ControlFlow 0 22) 19) anon65_Then_correct) (=> (= (ControlFlow 0 22) 20) anon65_Else_correct)))))))
(let ((anon63_Else_correct  (=> (< |i#2@0| (LitInt 0)) (and (=> (= (ControlFlow 0 26) 22) anon64_Then_correct) (=> (= (ControlFlow 0 26) 24) anon64_Else_correct)))))
(let ((anon63_Then_correct  (=> (<= (LitInt 0) |i#2@0|) (and (=> (= (ControlFlow 0 25) 22) anon64_Then_correct) (=> (= (ControlFlow 0 25) 24) anon64_Else_correct)))))
...
(let ((anon62_Else_correct  (=> (not (|Seq#Contains| |sq#0@0| ($Box intType (int_2_U |k#4@0|)))) (and (=> (= (ControlFlow 0 21) 19) anon65_Then_correct) (=> (= (ControlFlow 0 21) 20) anon65_Else_correct)))))
(let ((anon61_Then_correct  (and (=> (= (ControlFlow 0 28) 27) anon62_Then_correct) (=> (= (ControlFlow 0 28) 21) anon62_Else_correct))))
...
(let ((anon19_correct  (=> (and (forall ((|d#1| T@U) ) (!  (=> ($Is DatatypeTypeType |d#1| Tclass._module.D) (and (|$IsA#_module.D| |d#1|) (=> (not (|_module.D#Equal| |d#1| |#_module.D.A|)) (|$IsA#_module.D| |d#1|))))
 :qid |ComprehensionsNewSyntaxdfy.26:22|
 :skolemid |496|
