...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@106  (=> (and (= $generated@@96 ($generated@@60 $generated@@97 $generated@@98 $generated@@5 false)) (= $generated@@99 ($generated@@46 (- 0 127)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= ($generated@@46 (- 0 128)) $generated@@99) (< $generated@@99 128))) (=> (and (<= ($generated@@46 (- 0 128)) $generated@@99) (< $generated@@99 128)) (=> (= $generated@@100 ($generated@@46 1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= ($generated@@46 (- 0 128)) $generated@@100) (< $generated@@100 128))) (=> (and (<= ($generated@@46 (- 0 128)) $generated@@100) (< $generated@@100 128)) (=> (and (= $generated@@101 ($generated@@46 (- (- 0 127) 1))) (= (ControlFlow 0 2) (- 0 1))) (and (<= ($generated@@46 (- 0 128)) $generated@@101) (< $generated@@101 128)))))))))))
(let (($generated@@107  (=> (and ($generated@@102 $generated@@98) ($generated@@103 $generated@@98)) (=> (and (and (<= ($generated@@46 (- 0 128)) $generated@@104) (< $generated@@104 128)) (and (= 1 $generated@@105) (= (ControlFlow 0 5) 2))) $generated@@106))))
$generated@@107)))
))
(check-sat)
(get-info :rlimit)
