...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@107  (=> (= (ControlFlow 0 3) (- 0 2)) (or (not (= ($generated@@19 2) 0)) (not true)))))
(let (($generated@@108 true))
(let (($generated@@109  (=> (= $generated@@102 ($generated@@39 $generated@@103 $generated@@104 $generated@@1 false)) (and (=> (= (ControlFlow 0 4) 1) $generated@@108) (=> (= (ControlFlow 0 4) 3) $generated@@107)))))
(let (($generated@@110  (=> (and (and ($generated@@105 $generated@@104) ($generated@@106 $generated@@104)) (and (= 0 $generated@@28) (= (ControlFlow 0 5) 4))) $generated@@109)))
$generated@@110)))))
))
(check-sat)
(get-info :rlimit)
