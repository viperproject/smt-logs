...
(declare-fun Abstract.__default.inc (Int) Int)
(declare-fun |Abstract.__default.inc#canCall| (Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|Abstract.__default.inc#canCall| |x#0|) (< 0 $FunctionContextHeight)) (> (Abstract.__default.inc |x#0|) |x#0|))
 :qid |Includeedfy.16:16|
 :skolemid |479|
 :pattern ( (Abstract.__default.inc |x#0|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Abstract.__default.inc)
...
(let ((anon4_Then_correct  (=> ($IsAlloc intType (int_2_U |x#0@@0|) TInt $Heap) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 |x#0@@0|) (= |x#0@@0| |x#0@@0|))) (=> (or (<= 0 |x#0@@0|) (= |x#0@@0| |x#0@@0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (= |x#0@@0| |x#0@@0|) (< |x#0@@0| |x#0@@0|))))))))
