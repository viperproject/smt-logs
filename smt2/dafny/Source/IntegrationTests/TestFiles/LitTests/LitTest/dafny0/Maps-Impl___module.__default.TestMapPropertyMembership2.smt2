...
(declare-fun |m#0| () T@U)
(declare-fun |kv#0@0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.TestMapPropertyMembership2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (exists ((|kv#1| T@U) ) (!  (and ($Is DatatypeTypeType |kv#1| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) (|Set#IsMember| (|Map#Items| |m#0|) ($Box DatatypeTypeType |kv#1|)))
 :qid |Mapsdfy.547:17|
 :skolemid |851|
 :pattern ( (|Set#IsMember| (|Map#Items| |m#0|) ($Box DatatypeTypeType |kv#1|)))
)))))
(let ((anon3_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |kv#0@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) ($IsAlloc DatatypeTypeType |kv#0@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)) $Heap))) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and ($Is DatatypeTypeType |kv#0@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) ($IsAlloc DatatypeTypeType |kv#0@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)) $Heap)) (= (ControlFlow 0 3) 2)) anon2_correct)))
