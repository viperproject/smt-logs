...
(assert (forall ((_module.CellX$X@@9 T@U) (bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 (Tclass._module.CellX _module.CellX$X@@9)) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) (Tclass._module.CellX _module.CellX$X@@9))))
 :qid |unknown.0:0|
 :skolemid |7893|
 :pattern ( ($IsBox bx@@0 (Tclass._module.CellX _module.CellX$X@@9)))
)))
(assert (forall ((_module.CellX$X@@10 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._module.CellX? _module.CellX$X@@10)) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) (Tclass._module.CellX? _module.CellX$X@@10))))
 :qid |unknown.0:0|
 :skolemid |7897|
 :pattern ( ($IsBox bx@@1 (Tclass._module.CellX? _module.CellX$X@@10)))
)))
...
(set-info :boogie-vc-id Impl$$_module.CellX.__ctor)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |u#0| _module.CellX$X@@11) ($IsAllocBox |u#0| _module.CellX$X@@11 $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
