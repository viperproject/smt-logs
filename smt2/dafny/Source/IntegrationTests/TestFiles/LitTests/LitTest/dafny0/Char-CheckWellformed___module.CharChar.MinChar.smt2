...
(set-info :boogie-vc-id CheckWellformed$$_module.CharChar.MinChar)
...
(let ((anon10_Else_correct  (=> (and (or (not (= (|Seq#Length| |s#0@@4|) (LitInt 1))) (not true)) ($IsAllocBox ($Box refType this@@4) Tclass._module.CharChar? $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@4|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |s#0@@4|))) (=> (and (= |##s#0@0| (|Seq#Drop| |s#0@@4| (LitInt 1))) ($IsAlloc SeqType |##s#0@0| (TSeq TChar) $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (not (|Seq#Equal| |##s#0@0| |Seq#Empty|))) (=> (not (|Seq#Equal| |##s#0@0| |Seq#Empty|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (|Seq#Rank| |##s#0@0|) (|Seq#Rank| |s#0@@4|))) (=> (< (|Seq#Rank| |##s#0@0|) (|Seq#Rank| |s#0@@4|)) (=> (|_module.CharChar.MinChar#canCall| this@@4 (|Seq#Drop| |s#0@@4| (LitInt 1))) (=> (and (and (= |let#1#0#0| (_module.CharChar.MinChar ($LS $LZ) this@@4 (|Seq#Drop| |s#0@@4| (LitInt 1)))) (|_module.CharChar.MinChar#canCall| this@@4 (|Seq#Drop| |s#0@@4| (LitInt 1)))) (and ($Is charType |let#1#0#0| TChar) (= |m#Z#0@0| |let#1#0#0|))) (and (=> (= (ControlFlow 0 5) 3) anon11_Then_correct) (=> (= (ControlFlow 0 5) 4) anon11_Else_correct))))))))))))))
(let ((anon10_Then_correct true))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@4|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0@@4|))) (=> (= |let#0#0#0| ($Unbox charType (|Seq#Index| |s#0@@4| (LitInt 0)))) (=> (and ($Is charType |let#0#0#0| TChar) (= |ch#Z#0@0| |let#0#0#0|)) (and (=> (= (ControlFlow 0 9) 2) anon10_Then_correct) (=> (= (ControlFlow 0 9) 5) anon10_Else_correct))))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (not (|Seq#Equal| |s#0@@4| |Seq#Empty|))) (and (=> (= (ControlFlow 0 11) 1) anon9_Then_correct) (=> (= (ControlFlow 0 11) 9) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.CharChar) ($IsAlloc refType this@@4 Tclass._module.CharChar $Heap))) ($Is SeqType |s#0@@4| (TSeq TChar))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
