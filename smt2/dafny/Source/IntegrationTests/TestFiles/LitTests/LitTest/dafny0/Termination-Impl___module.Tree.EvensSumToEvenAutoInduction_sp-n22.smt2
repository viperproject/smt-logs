...
(set-info :boogie-vc-id Impl$$_module.Tree.EvensSumToEvenAutoInduction_split4)
...
))))) (=> (and (and (and (and (and (or (not (= this@@6 |#_module.Tree.Empty|)) (not true)) (= this@@6 (|#_module.Tree.Node| |_mcc#0#0_0@0| |_mcc#1#0_0@0| |_mcc#2#0_0@0|))) (and ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass._module.Tree) ($Is DatatypeTypeType |_mcc#2#0_0@0| Tclass._module.Tree))) (and (and ($Is DatatypeTypeType |right#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |right#0_0@0| Tclass._module.Tree $Heap@0)) (= |let#0_0#0#0| |_mcc#2#0_0@0|))) (and (and (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Tree) (= |right#0_0@0| |let#0_0#0#0|)) (and ($Is DatatypeTypeType |left#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |left#0_0@0| Tclass._module.Tree $Heap@0))) (and (and (= |let#0_1#0#0| |_mcc#1#0_0@0|) ($Is DatatypeTypeType |let#0_1#0#0| Tclass._module.Tree)) (and (= |left#0_0@0| |let#0_1#0#0|) (= |let#0_2#0#0| |_mcc#0#0_0@0|))))) (and (and (and (and ($Is intType (int_2_U |let#0_2#0#0|) TInt) (= |x#0_0@0| |let#0_2#0#0|)) (and ($IsAllocBox ($Box DatatypeTypeType this@@6) Tclass._module.Tree $Heap@0) (|_module.Tree.Elements#canCall| this@@6))) (and (and (|_module.Tree.Elements#canCall| this@@6) (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@6) ($Box intType (int_2_U |x#0_0@0|)))) (and (< (DtRank |left#0_0@0|) (DtRank this@@6)) (forall ((|u#1@@0| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType |u#1@@0|)) (= (Mod (U_2_int |u#1@@0|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.504:21|
 :skolemid |3668|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType |u#1@@0|)))
))))) (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|_module.Tree.Sum#canCall| |left#0_0@0|)) (and (and (= (Mod (_module.Tree.Sum ($LS ($LS $LZ)) |left#0_0@0|) (LitInt 2)) (LitInt 0)) (= $Heap@0 $Heap@1)) (and (< (DtRank |right#0_0@0|) (DtRank this@@6)) (= (ControlFlow 0 2) (- 0 1))))))) (forall ((|u#1@@1| Int) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |right#0_0@0|) ($Box intType (int_2_U |u#1@@1|))) (= (Mod |u#1@@1| (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.504:21|
 :skolemid |3668|
