...
(set-info :boogie-vc-id Impl$$_module.IterC)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon6_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= (_module.IterC.c this@@0) null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= |tmp#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.IterC.c this@@0)) _module.Cell.data))))) (=> (= |tmp#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.IterC.c this@@0)) _module.Cell.data)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= (_module.IterC.c this@@0) null)) (not true))) (=> (or (not (= (_module.IterC.c this@@0) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 (_module.IterC.c this@@0) _module.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 (_module.IterC.c this@@0) _module.Cell.data)) (=> (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 (_module.IterC.c this@@0) (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 (_module.IterC.c this@@0)) _module.Cell.data ($Box intType (int_2_U |$rhs#0@0|))))) (=> (and ($IsGoodHeap $Heap@5) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U true))))))))))))))
(let ((anon8_Else_correct  (=> (and (= $Heap@4 $Heap@2) (= (ControlFlow 0 9) 2)) anon6_correct)))
(let ((anon8_Then_correct  (=> (and (= |_yieldCount#0@1| (+ |_yieldCount#0| 1)) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.IterC.c this@@0)) _module.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $_OldIterHeap@0 (_module.IterC.c this@@0)) _module.Cell.data))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 (_module.IterC.c this@@0)) _module.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $_OldIterHeap@0 (_module.IterC.c this@@0)) _module.Cell.data)))) (=> (and (and (and (= call1formal@rds@0 (_module.IterC.__reads this@@0)) (= call2formal@nw@0 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 this@@0) _module.IterC.__new)))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3))) (and (and (forall (($o@@23 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@23 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@23) alloc)))) (=> (or (or (= $o@@23 this@@0) (|Set#IsMember| call1formal@rds@0 ($Box refType $o@@23))) (|Set#IsMember| call2formal@nw@0 ($Box refType $o@@23))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@23) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $o@@23) $f@@1))))
 :qid |DafnyPreludebpl.620:19|
 :skolemid |4315|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@23) $f@@1))
)) ($HeapSucc $Heap@2 $Heap@3)) (and (= $Heap@4 $Heap@3) (= (ControlFlow 0 7) 2)))) anon6_correct))))))
(let ((anon3_correct  (and (=> (= (ControlFlow 0 10) 7) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))
(let ((anon7_Else_correct  (=> (= $_OldIterHeap@0 $Heap@0) (=> (and (= $Heap@2 $Heap@0) (= (ControlFlow 0 13) 10)) anon3_correct))))
(let ((anon7_Then_correct  (=> (and (= |_yieldCount#0@0| (+ |_yieldCount#0| 1)) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.IterC.c this@@0)) _module.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.IterC.c this@@0)) _module.Cell.data))))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.IterC.c this@@0)) _module.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.IterC.c this@@0)) _module.Cell.data)))) (=> (and (= call1formal@rds@0@@0 (_module.IterC.__reads this@@0)) (= call2formal@nw@0@@0 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.IterC.__new)))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (forall (($o@@24 T@U) ($f@@2 T@U) ) (!  (=> (and (or (not (= $o@@24 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24) alloc)))) (=> (or (or (= $o@@24 this@@0) (|Set#IsMember| call1formal@rds@0@@0 ($Box refType $o@@24))) (|Set#IsMember| call2formal@nw@0@@0 ($Box refType $o@@24))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@24) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@24) $f@@2))))
 :qid |DafnyPreludebpl.620:19|
 :skolemid |4315|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@24) $f@@2))
))) (and (and ($HeapSucc $Heap@0 $Heap@1) (= $_OldIterHeap@0 $Heap@1)) (and (= $Heap@2 $Heap@1) (= (ControlFlow 0 11) 10)))) anon3_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#13| null $Heap alloc this@@0 |c#0@@5|)) (=> (and (and (and (and (or (not (= |c#0@@5| null)) (not true)) (= (_module.IterC.c this@@0) |c#0@@5|)) (and (_module.IterC.Valid $Heap this@@0) (|Set#Equal| (_module.IterC.__reads this@@0) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@5|))))) (and (and (|Set#Equal| (_module.IterC.__modifies this@@0) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@5|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.IterC.__new)) |Set#Empty|)) (and (= (_module.IterC.__decreases0 this@@0) |c#0@@5|) (= (_module.IterC.__decreases1 this@@0) |c#0@@5|)))) (and (and (and (= (_module.IterC.__decreases2 this@@0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@5|) _module.Cell.data)))) (= |_yieldCount#0| 0)) (and (= call1formal@rds@0@@1 (_module.IterC.__reads this@@0)) (= call2formal@nw@0@@1 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.IterC.__new))))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@25 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@25) alloc)))) (=> (or (or (= $o@@25 this@@0) (|Set#IsMember| call1formal@rds@0@@1 ($Box refType $o@@25))) (|Set#IsMember| call2formal@nw@0@@1 ($Box refType $o@@25))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@25) $f@@3))))
 :qid |DafnyPreludebpl.620:19|
 :skolemid |4315|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) $f@@3))
)) ($HeapSucc $Heap $Heap@0))))) (and (=> (= (ControlFlow 0 14) (- 0 17)) (or (not (= (_module.IterC.c this@@0) null)) (not true))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (= (_module.IterC.__decreases2 this@@0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.IterC.c this@@0)) _module.Cell.data))))) (=> (= (_module.IterC.__decreases2 this@@0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.IterC.c this@@0)) _module.Cell.data)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= (_module.IterC.c this@@0) null)) (not true))) (=> (or (not (= (_module.IterC.c this@@0) null)) (not true)) (=> (= |tmp#0@0| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 (_module.IterC.c this@@0)) _module.Cell.data)))) (and (=> (= (ControlFlow 0 14) 11) anon7_Then_correct) (=> (= (ControlFlow 0 14) 13) anon7_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.IterC) ($IsAlloc refType this@@0 Tclass._module.IterC $Heap)))) (and (and ($Is refType |c#0@@5| Tclass._module.Cell?) ($IsAlloc refType |c#0@@5| Tclass._module.Cell? $Heap)) (and true true))) (=> (and (and (and (and ($IsGoodHeap $_OldIterHeap) ($HeapSucc $_OldIterHeap $Heap)) true) (= 0 $FunctionContextHeight)) (and (or (not (= |c#0@@5| null)) (not true)) (= (ControlFlow 0 18) 14))) anon0_correct))))
