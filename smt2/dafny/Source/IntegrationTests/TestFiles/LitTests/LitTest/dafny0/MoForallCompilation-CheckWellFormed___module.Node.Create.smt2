...
(declare-fun |n#0| () Int)
(declare-fun |d#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.Create)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7)))
 :qid |MoForallCompilationdfy.128:17|
 :skolemid |655|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap@@1 $Heap@0)) (and ($Is refType |d#0@0| Tclass._module.Node) ($IsAlloc refType |d#0@0| Tclass._module.Node $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |d#0@0| null)) (not true))) (=> (or (not (= |d#0@0| null)) (not true)) (=> (and (and ($IsAllocBox ($Box refType |d#0@0|) Tclass._module.Node? $Heap@0) (|_module.Node.Valid#canCall| $Heap@0 |d#0@0|)) (and (_module.Node.Valid ($LS $LZ) $Heap@0 |d#0@0|) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |d#0@0| null)) (not true))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (<= (LitInt 0) |n#0|)) (and (and ($Is refType |d#0| Tclass._module.Node) ($IsAlloc refType |d#0| Tclass._module.Node $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct)))
