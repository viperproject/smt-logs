...
axiom {:id "id67"} 2 <= $FunctionContextHeight
   ==> (forall Reachable4._default.Reachable$Extra: Ty, 
      $Heap: Heap, 
      source#0: ref, 
      sink#0: ref, 
      S#0: Set :: 
    ...
    Reachable4.__default.Reachable#canCall(Reachable4._default.Reachable$Extra, $Heap, source#0, sink#0, S#0)
       ...
       ==> (forall via#0: DatatypeType :: 
          ...
          $Is(via#0, 
             ...
             ==> Reachable4.__default.ReachableVia#canCall(Reachable4._default.Reachable$Extra, $Heap, source#0, via#0, sink#0, S#0))
...
procedure {:verboseName "Reachable4.Reachable (well-formedness)"} CheckWellformed$$Reachable4.__default.Reachable(Reachable4._default.Reachable$Extra: Ty, 
    source#0: ref where $Is(source#0, Tclass.Reachable4.Node()), 
    sink#0: ref where $Is(sink#0, Tclass.Reachable4.Node()), 
    S#0: Set where $Is(S#0, TSet(Tclass.Reachable4.Node())));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Reachable4.Reachable (well-formedness)"} CheckWellformed$$Reachable4.__default.Reachable(Reachable4._default.Reachable$Extra: Ty, source#0: ref, sink#0: ref, S#0: Set)
{
  ...
  var b$reqreads#0: bool;
    ...
    else
    {
            ...
            $Heap))
        {
            ...
            assume $IsAlloc(##source#0, Tclass.Reachable4.Node(), $Heap);
            ##p#0 := via#1;
            // assume allocatedness for argument to function
            assume $IsAlloc(##p#0, 
              Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.Reachable$Extra), 
            ...
            ##sink#0 := sink#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##sink#0, Tclass.Reachable4.Node(), $Heap);
            ##S#0 := S#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##S#0, TSet(Tclass.Reachable4.Node()), $Heap);
            b$reqreads#0 := (forall $o: ref, $f: Field :: 
              $o != null
                   && $Unbox(read($Heap, $o, alloc)): bool
                   && Set#IsMember(##S#0, $Box($o))
                 ==> $_ReadsFrame[$o, $f]);
            assume Reachable4.__default.ReachableVia#canCall(Reachable4._default.Reachable$Extra, $Heap, source#0, via#1, sink#0, S#0);
        }

        // End Comprehension WF check
        assume {:id "id68"} Reachable4.__default.Reachable(Reachable4._default.Reachable$Extra, $Heap, source#0, sink#0, S#0)
        ...
        assume (forall via#2: DatatypeType :: 
          ...
          $Is(via#2, 
              Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.Reachable$Extra))
             ==> Reachable4.__default.ReachableVia#canCall(Reachable4._default.Reachable$Extra, $Heap, source#0, via#2, sink#0, S#0));
        // CheckWellformedWithResult: any expression
        assume $Is(Reachable4.__default.Reachable(Reachable4._default.Reachable$Extra, $Heap, source#0, sink#0, S#0), 
          TBool);
...
axiom 1 <= $FunctionContextHeight
   ==> (forall Reachable4._default.ReachableVia$Extra: Ty, 
      $ly: LayerType, 
      $Heap: Heap, 
      source#0: ref, 
      p#0: DatatypeType, 
   ...
   ==> (forall Reachable4._default.ReachableVia$Extra: Ty, 
    ...
    Reachable4.__default.ReachableVia#canCall(Reachable4._default.ReachableVia$Extra, $Heap, source#0, p#0, sink#0, S#0)
       ...
       ==> (!Reachable4.Path.Empty_q(p#0)
           ==> (var n#1 := $Unbox(Reachable4.Path._h11(p#0)): ref; 
            (var prefix#1 := Reachable4.Path._h10(p#0); 
              Set#IsMember(S#0, $Box(n#1))
                 ==> 
                Seq#Contains($Unbox(read($Heap, n#1, Reachable4.Node.children)): Seq, $Box(sink#0))
                 ==> Reachable4.__default.ReachableVia#canCall(Reachable4._default.ReachableVia$Extra, $Heap, source#0, prefix#1, n#1, S#0))))
         && Reachable4.__default.ReachableVia(Reachable4._default.ReachableVia$Extra, 
            $LS($ly), 
            $Heap, 
            source#0, 
           ...
           == (if Reachable4.Path.Empty_q(p#0)
             then false
             else (var extra#0 := Reachable4.Path._h12(p#0); 
              (var n#0 := $Unbox(Reachable4.Path._h11(p#0)): ref; 
                (var prefix#0 := Reachable4.Path._h10(p#0); 
                  Set#IsMember(S#0, $Box(n#0))
                     && Seq#Contains($Unbox(read($Heap, n#0, Reachable4.Node.children)): Seq, $Box(sink#0))
                     && Reachable4.__default.ReachableVia(Reachable4._default.ReachableVia$Extra, $ly, $Heap, source#0, prefix#0, n#0, S#0))))));
}
...
procedure {:verboseName "Reachable4.ReachableVia (well-formedness)"} CheckWellformed$$Reachable4.__default.ReachableVia(Reachable4._default.ReachableVia$Extra: Ty, 
    source#0: ref where $Is(source#0, Tclass.Reachable4.Node()), 
    p#0: DatatypeType
       where $Is(p#0, 
        Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.ReachableVia$Extra)), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Reachable4.ReachableVia (well-formedness)"} CheckWellformed$$Reachable4.__default.ReachableVia(Reachable4._default.ReachableVia$Extra: Ty, 
    source#0: ref, 
    p#0: DatatypeType, 
    sink#0: ref, 
    S#0: Set)
{
  ...
  var b$reqreads#1: bool;
    ...
    {
        // Check well-formedness of body and result subset type constraint
        if (p#0 == #Reachable4.Path.Empty())
        {
            assume {:id "id82"} Reachable4.__default.ReachableVia(Reachable4._default.ReachableVia$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
            ...
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(Reachable4.__default.ReachableVia(Reachable4._default.ReachableVia$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
        ...
        else if (p#0 == #Reachable4.Path.Extend(_mcc#0#0, $Box(_mcc#1#0), _mcc#2#0))
        {
            assume $Is(_mcc#0#0, 
              Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.ReachableVia$Extra));
            assume $Is(_mcc#1#0, Tclass.Reachable4.Node());
            assume $IsBox(_mcc#2#0, Reachable4._default.ReachableVia$Extra);
            havoc extra#Z#0;
            assume {:id "id71"} let#0#0#0 == _mcc#2#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(let#0#0#0, Reachable4._default.ReachableVia$Extra);
            assume {:id "id72"} extra#Z#0 == let#0#0#0;
            havoc n#Z#0;
            assume {:id "id73"} let#1#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, Tclass.Reachable4.Node());
            assume {:id "id74"} n#Z#0 == let#1#0#0;
            havoc prefix#Z#0;
            assume {:id "id75"} let#2#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, 
              Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.ReachableVia$Extra));
            assume {:id "id76"} prefix#Z#0 == let#2#0#0;
            if (Set#IsMember(S#0, $Box(n#Z#0)))
            {
                assert {:id "id77"} n#Z#0 != null;
                b$reqreads#0 := $_ReadsFrame[n#Z#0, Reachable4.Node.children];
            }

            if (Set#IsMember(S#0, $Box(n#Z#0))
               && Seq#Contains($Unbox(read($Heap, n#Z#0, Reachable4.Node.children)): Seq, $Box(sink#0)))
            {
                ##source#0 := source#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##source#0, Tclass.Reachable4.Node(), $Heap);
                ...
                b$reqreads#1 := (forall $o: ref, $f: Field :: 
                  $o != null
                       ...
                       && Set#IsMember(##S#0, $Box($o))
                     ==> $_ReadsFrame[$o, $f]);
                assert {:id "id78"} DtRank(##p#0) < DtRank(p#0);
                assume Reachable4.__default.ReachableVia#canCall(Reachable4._default.ReachableVia$Extra, $Heap, source#0, prefix#Z#0, n#Z#0, S#0);
            }

            assume {:id "id79"} Reachable4.__default.ReachableVia(Reachable4._default.ReachableVia$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
            ...
            assume Set#IsMember(S#0, $Box(n#Z#0))
               ==> 
              Seq#Contains($Unbox(read($Heap, n#Z#0, Reachable4.Node.children)): Seq, $Box(sink#0))
               ==> Reachable4.__default.ReachableVia#canCall(Reachable4._default.ReachableVia$Extra, $Heap, source#0, prefix#Z#0, n#Z#0, S#0);
            // CheckWellformedWithResult: any expression
            assume $Is(Reachable4.__default.ReachableVia(Reachable4._default.ReachableVia$Extra, 
                $LS($LZ), 
                $Heap, 
                ...
                S#0), 
              TBool);
            assert {:id "id80"} b$reqreads#0;
            assert {:id "id81"} b$reqreads#1;
            return;
        }
        else
        {
...
axiom 1 <= $FunctionContextHeight
   ==> (forall Reachable4._default.ReachableViaEnsures$Extra: Ty, 
      $ly: LayerType, 
      $Heap: Heap, 
      source#0: ref, 
      p#0: DatatypeType, 
...
procedure {:verboseName "Reachable4.ReachableViaEnsures (well-formedness)"} CheckWellformed$$Reachable4.__default.ReachableViaEnsures(Reachable4._default.ReachableViaEnsures$Extra: Ty, 
    source#0: ref where $Is(source#0, Tclass.Reachable4.Node()), 
    p#0: DatatypeType
       where $Is(p#0, 
        Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.ReachableViaEnsures$Extra)), 
  ...
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  ensures {:id "id86"} !Reachable4.__default.ReachableViaEnsures(Reachable4._default.ReachableViaEnsures$Extra, 
    $LS($LS($LZ)), 
    $Heap, 
    source#0, 
    p#0, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Reachable4.ReachableViaEnsures (well-formedness)"} CheckWellformed$$Reachable4.__default.ReachableViaEnsures(Reachable4._default.ReachableViaEnsures$Extra: Ty, 
    source#0: ref, 
    p#0: DatatypeType, 
    sink#0: ref, 
    S#0: Set)
{
  ...
  var b$reqreads#1: bool;
    ...
    if (*)
    {
        ...
        assume (
            source#0 == source#0
             ...
             && Set#Equal(S#0, S#0))
           || Reachable4.__default.ReachableViaEnsures#canCall(Reachable4._default.ReachableViaEnsures$Extra, $Heap, source#0, p#0, sink#0, S#0);
        assume {:id "id88"} !Reachable4.__default.ReachableViaEnsures(Reachable4._default.ReachableViaEnsures$Extra, 
          $LS($LZ), 
          $Heap, 
          source#0, 
          p#0, 
    ...
    else
    {
        ...
        if (p#0 == #Reachable4.Path.Empty())
        {
            assume {:id "id100"} Reachable4.__default.ReachableViaEnsures(Reachable4._default.ReachableViaEnsures$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
            ...
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(Reachable4.__default.ReachableViaEnsures(Reachable4._default.ReachableViaEnsures$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
        ...
        else if (p#0 == #Reachable4.Path.Extend(_mcc#0#0, $Box(_mcc#1#0), _mcc#2#0))
        {
            assume $Is(_mcc#0#0, 
              Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.ReachableViaEnsures$Extra));
            assume $Is(_mcc#1#0, Tclass.Reachable4.Node());
            assume $IsBox(_mcc#2#0, Reachable4._default.ReachableViaEnsures$Extra);
            havoc extra#Z#0;
            assume {:id "id89"} let#0#0#0 == _mcc#2#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(let#0#0#0, Reachable4._default.ReachableViaEnsures$Extra);
            assume {:id "id90"} extra#Z#0 == let#0#0#0;
            havoc n#Z#0;
            assume {:id "id91"} let#1#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, Tclass.Reachable4.Node());
            assume {:id "id92"} n#Z#0 == let#1#0#0;
            havoc prefix#Z#0;
            assume {:id "id93"} let#2#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#2#0#0, 
              Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.ReachableViaEnsures$Extra));
            assume {:id "id94"} prefix#Z#0 == let#2#0#0;
            if (Set#IsMember(S#0, $Box(n#Z#0)))
            {
                assert {:id "id95"} n#Z#0 != null;
                b$reqreads#0 := $_ReadsFrame[n#Z#0, Reachable4.Node.children];
            }
               ...
               && Seq#Contains($Unbox(read($Heap, n#Z#0, Reachable4.Node.children)): Seq, $Box(sink#0)))
            {
                ##source#1 := source#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##source#1, Tclass.Reachable4.Node(), $Heap);
                ##p#1 := prefix#Z#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##p#1, 
                  Tclass.Reachable4.Path(Tclass.Reachable4.Node(), Reachable4._default.ReachableViaEnsures$Extra), 
                ...
                ##sink#1 := n#Z#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##sink#1, Tclass.Reachable4.Node(), $Heap);
                ##S#1 := S#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##S#1, TSet(Tclass.Reachable4.Node()), $Heap);
                b$reqreads#1 := (forall $o: ref, $f: Field :: 
                  $o != null
                       && $Unbox(read($Heap, $o, alloc)): bool
                       && Set#IsMember(##S#1, $Box($o))
                     ==> $_ReadsFrame[$o, $f]);
                assert {:id "id96"} DtRank(##p#1) < DtRank(p#0);
                assume Reachable4.__default.ReachableViaEnsures#canCall(Reachable4._default.ReachableViaEnsures$Extra, 
                  $Heap, 
                  source#0, 
                  prefix#Z#0, 
                  n#Z#0, 
            ...
            assume {:id "id97"} Reachable4.__default.ReachableViaEnsures(Reachable4._default.ReachableViaEnsures$Extra, 
                $LS($LZ), 
                $Heap, 
                source#0, 
                p#0, 
