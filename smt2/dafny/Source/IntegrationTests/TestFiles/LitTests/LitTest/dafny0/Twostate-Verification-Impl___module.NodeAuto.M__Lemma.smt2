...
(set-info :boogie-vc-id Impl$$_module.NodeAuto.M__Lemma)
...
))) (=> (forall (($o@@13 T@U) ($f@@3 T@U) ) (!  (=> (or (not (= $o@@13 null)) (not true)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 call2formal@this@0) _module.NodeAuto.Repr)) ($Box refType $o@@13)) (or (not (= $o@@13 |node#0|)) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@13) $f@@3))))
 :qid |TwostateVerificationdfy.220:14|
 :skolemid |1689|
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= current$Heap $Heap@0) (forall ((|$ih#this0#0| T@U) ) (!  (=> (and (and ($Is refType |$ih#this0#0| Tclass._module.NodeAuto) (and (and (_module.NodeAuto.Valid $Heap@@3 |$ih#this0#0|) (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |node#0|) _module.NodeAuto.x))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |node#0|) _module.NodeAuto.x)))) (|_System.Tuple2#Equal| (|#_System._tuple#2._#Make2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |node#0|) _module.NodeAuto.next) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |node#0|) _module.NodeAuto.Repr)) (|#_System._tuple#2._#Make2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |node#0|) _module.NodeAuto.next) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |node#0|) _module.NodeAuto.Repr))))) (forall (($o@@14 T@U) ($f@@4 T@U) ) (!  (=> (or (not (= $o@@14 null)) (not true)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |$ih#this0#0|) _module.NodeAuto.Repr)) ($Box refType $o@@14)) (or (not (= $o@@14 |node#0|)) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@14) $f@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@14) $f@@4))))
 :qid |TwostateVerificationdfy.220:14|
 :skolemid |1691|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@14) $f@@4))
 ...
 :qid |TwostateVerificationdfy.218:18|
 :skolemid |1692|
