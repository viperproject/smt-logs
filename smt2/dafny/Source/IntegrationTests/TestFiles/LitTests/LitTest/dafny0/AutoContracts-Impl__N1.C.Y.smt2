...
(set-info :boogie-vc-id Impl$$N1.C.Y)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass.N1.C?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) alloc))))) (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) N1.C.Repr)) this.Repr) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|N1.C.Valid#canCall| $Heap@0 this@@2) (or (N1.C.Valid $Heap@0 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) N1.C.Repr)) ($Box refType this@@2))))) (=> (=> (|N1.C.Valid#canCall| $Heap@0 this@@2) (or (N1.C.Valid $Heap@0 this@@2) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) N1.C.Repr)) ($Box refType this@@2)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|N1.C.Valid#canCall| $Heap@0 this@@2) (or (N1.C.Valid $Heap@0 this@@2) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) N1.C.Repr)) ($Box refType null)))))) (=> (=> (|N1.C.Valid#canCall| $Heap@0 this@@2) (or (N1.C.Valid $Heap@0 this@@2) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) N1.C.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|N1.C.Valid#canCall| $Heap@0 this@@2) (or (N1.C.Valid $Heap@0 this@@2) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (=> (|N1.C.Valid#canCall| $Heap@0 this@@2) (or (N1.C.Valid $Heap@0 this@@2) (U_2_bool (Lit boolType (bool_2_U true))))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@7 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) N1.C.Repr)) ($Box refType $o@@7)) (or (not (= $o@@7 null)) (not true)))
 :qid |AutoContractsdfy.60:17|
 :skolemid |1606|
 :pattern (  (or (not (= $o@@7 null)) (not true)))
)) (forall (($o@@8 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) N1.C.Repr)) ($Box refType $o@@8)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@8) alloc)))))
 :qid |AutoContractsdfy.60:17|
 :skolemid |1607|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@2) N1.C.Repr)) ($Box refType $o@@8)))
))))))))))))))
