...
procedure {:verboseName "ShortCircuiting.f1 (well-formedness)"} CheckWellformed$$ShortCircuiting.__default.f1(x#0: int);
...
procedure {:verboseName "ShortCircuiting.f2 (well-formedness)"} CheckWellformed$$ShortCircuiting.__default.f2(y#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
   ...
   ==> (forall x'#0: int, y'#0: int :: 
    ...
    ShortCircuiting.__default.test1#canCall(x'#0, y'#0)
         || (1 < $FunctionContextHeight
           && 
          x'#0 > 3
           && (ShortCircuiting.__default.f1(x'#0) ==> y'#0 < 10))
   ...
   ==> (forall x'#0: int, y'#0: int :: 
    ...
    ShortCircuiting.__default.test1#canCall(LitInt(x'#0), LitInt(y'#0))
         || (1 < $FunctionContextHeight
           && 
          Lit(x'#0 > 3)
           && (ShortCircuiting.__default.f1(LitInt(x'#0)) ==> y'#0 < 10))
...
procedure {:verboseName "ShortCircuiting.test1 (well-formedness)"} CheckWellformed$$ShortCircuiting.__default.test1(x'#0: int, y'#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ShortCircuiting.test1 (well-formedness)"} CheckWellformed$$ShortCircuiting.__default.test1(x'#0: int, y'#0: int)
{
  ...
  var ##y#0: int;
    ...
    assume {:id "id131"} x'#0 > 3;
    ##x#0 := x'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assert {:id "id132"} {:subsumption 0} ##x#0 > 3;
    assume ##x#0 > 3;
    assume ShortCircuiting.__default.f1#canCall(x'#0);
    if (ShortCircuiting.__default.f1(x'#0))
    {
    }

    assume {:id "id133"} ShortCircuiting.__default.f1(x'#0) ==> y'#0 < 10;
    ...
    else
    {
        ...
        assert {:id "id134"} {:subsumption 0} ##x#1 > 3;
        assume ##x#1 > 3;
        assume ShortCircuiting.__default.f1#canCall(x'#0);
        if (ShortCircuiting.__default.f1(x'#0))
        {
            ...
            assert {:id "id135"} {:subsumption 0} ##y#0 < 10;
            assume ##y#0 < 10;
            assume ShortCircuiting.__default.f2#canCall(y'#0);
        }

        assume {:id "id136"} ShortCircuiting.__default.test1(x'#0, y'#0)
           == (ShortCircuiting.__default.f1(x'#0) && ShortCircuiting.__default.f2(y'#0));
        assume ShortCircuiting.__default.f1#canCall(x'#0)
           && (ShortCircuiting.__default.f1(x'#0)
             ==> ShortCircuiting.__default.f2#canCall(y'#0));
        // CheckWellformedWithResult: any expression
        assume $Is(ShortCircuiting.__default.test1(x'#0, y'#0), TBool);
        return;
...
procedure {:verboseName "ShortCircuiting.test2 (well-formedness)"} CheckWellformed$$ShortCircuiting.__default.test2(x'#0: int, y'#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ShortCircuiting.test2 (well-formedness)"} CheckWellformed$$ShortCircuiting.__default.test2(x'#0: int, y'#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##x#0: int;
  var ##x#1: int;
  var ##y#0: int;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id139"} x'#0 > 3;
    ##x#0 := x'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assert {:id "id140"} {:subsumption 0} ##x#0 > 3;
    assume ##x#0 > 3;
    assume ShortCircuiting.__default.f1#canCall(x'#0);
    if (ShortCircuiting.__default.f1(x'#0))
    {
    ...
    assume {:id "id141"} ShortCircuiting.__default.f1(x'#0) ==> y'#0 < 10;
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#1, TInt, $Heap);
        assert {:id "id142"} {:subsumption 0} ##x#1 > 3;
        assume ##x#1 > 3;
        assume ShortCircuiting.__default.f1#canCall(x'#0);
        if (ShortCircuiting.__default.f1(x'#0))
        {
            ...
            // assume allocatedness for argument to function
            assume $IsAlloc(##y#0, TInt, $Heap);
            assert {:id "id143"} {:subsumption 0} ##y#0 < 10;
            assume ##y#0 < 10;
            assume ShortCircuiting.__default.f2#canCall(y'#0);
        }

        assume {:id "id144"} ShortCircuiting.__default.test2(x'#0, y'#0)
           == (ShortCircuiting.__default.f1(x'#0) ==> ShortCircuiting.__default.f2(y'#0));
        assume ShortCircuiting.__default.f1#canCall(x'#0)
           && (ShortCircuiting.__default.f1(x'#0)
             ==> ShortCircuiting.__default.f2#canCall(y'#0));
        // CheckWellformedWithResult: any expression
        assume $Is(ShortCircuiting.__default.test2(x'#0, y'#0), TBool);
        return;
...
axiom {:id "id145"} 1 <= $FunctionContextHeight
   ==> (forall x'#0: int, y'#0: int :: 
...
axiom {:id "id146"} 1 <= $FunctionContextHeight
   ==> (forall x'#0: int, y'#0: int :: 
...
procedure {:verboseName "ShortCircuiting.test3 (well-formedness)"} CheckWellformed$$ShortCircuiting.__default.test3(x'#0: int, y'#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ShortCircuiting.test3 (well-formedness)"} CheckWellformed$$ShortCircuiting.__default.test3(x'#0: int, y'#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##x#0: int;
  var ##x#1: int;
  var ##y#0: int;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id147"} x'#0 > 3;
    ##x#0 := x'#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assert {:id "id148"} {:subsumption 0} ##x#0 > 3;
    assume ##x#0 > 3;
    assume ShortCircuiting.__default.f1#canCall(x'#0);
    if (!ShortCircuiting.__default.f1(x'#0))
    {
    ...
    assume {:id "id149"} !ShortCircuiting.__default.f1(x'#0) ==> y'#0 < 10;
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#1, TInt, $Heap);
        assert {:id "id150"} {:subsumption 0} ##x#1 > 3;
        assume ##x#1 > 3;
        assume ShortCircuiting.__default.f1#canCall(x'#0);
        if (!ShortCircuiting.__default.f1(x'#0))
        {
            ...
            // assume allocatedness for argument to function
            assume $IsAlloc(##y#0, TInt, $Heap);
            assert {:id "id151"} {:subsumption 0} ##y#0 < 10;
            assume ##y#0 < 10;
            assume ShortCircuiting.__default.f2#canCall(y'#0);
        }

        assume {:id "id152"} ShortCircuiting.__default.test3(x'#0, y'#0)
           == (ShortCircuiting.__default.f1(x'#0) || ShortCircuiting.__default.f2(y'#0));
        assume ShortCircuiting.__default.f1#canCall(x'#0)
           && (!ShortCircuiting.__default.f1(x'#0)
             ==> ShortCircuiting.__default.f2#canCall(y'#0));
        // CheckWellformedWithResult: any expression
        assume $Is(ShortCircuiting.__default.test3(x'#0, y'#0), TBool);
        return;
