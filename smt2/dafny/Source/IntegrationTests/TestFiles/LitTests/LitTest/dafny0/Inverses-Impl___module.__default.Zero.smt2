...
(set-info :boogie-vc-id Impl$$_module.__default.Zero)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |i#0_0@0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |i#0_0@0|))) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 5) (- 0 4)))) (or (or (or (not (= |a#0| |a#0|)) (not true)) (or (not (= (IndexField |i#0_0@0|) (IndexField |i#0_1@0|))) (not true))) (= (LitInt 0) (LitInt 0))))))))))))
(let ((anon6_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 11) 5)) anon3_correct)))
(let ((anon6_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 9) 5) anon3_correct)))))
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 12) 9) anon6_Then_correct) (=> (= (ControlFlow 0 12) 11) anon6_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (_System.array.Length |a#0|))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |a#0|) (IndexField |i#1|)))) (LitInt 0)))
 :qid |Inversesdfy.114:18|
 :skolemid |592|
...
(let ((anon5_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) ($HeapSucc $Heap $Heap@0)) (and (and (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) $f@@0)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| (_System.array.Length |a#0|))) (= $o@@6 |a#0|)) (= $f@@0 (IndexField |i#0_2|)))
 :qid |Inversesdfy.116:10|
 :skolemid |594|
)))
 :qid |Inversesdfy.116:3|
 :skolemid |595|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) $f@@0))
)) (forall ((|i#inv#0_0| Int) ) (!  (=> (and (<= (LitInt 0) |i#inv#0_0|) (< |i#inv#0_0| (_System.array.Length |a#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |i#inv#0_0|)) ($Box intType (int_2_U (LitInt 0)))))
 :qid |Inversesdfy.116:10|
 :skolemid |596|
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#7| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 13) 12) anon5_Then_correct) (=> (= (ControlFlow 0 13) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13))) anon0_correct))))
