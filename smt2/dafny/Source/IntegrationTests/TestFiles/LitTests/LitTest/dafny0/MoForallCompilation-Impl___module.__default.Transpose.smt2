...
(assert (forall ((_module._default.MatrixEqual$T@@0 T@U) ($h0 T@U) ($h1 T@U) (|m#0@@0| T@U) (|m'#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.MatrixEqual#canCall| _module._default.MatrixEqual$T@@0 $h0 |m#0@@0| |m'#0@@0|) (and ($Is refType |m#0@@0| (Tclass._System.array2 _module._default.MatrixEqual$T@@0)) ($Is refType |m'#0@@0| (Tclass._System.array2 _module._default.MatrixEqual$T@@0))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@5 T@U) ($f T@U) )  (=> (and (or (not (= $o@@5 null)) (not true)) (or (= $o@@5 |m#0@@0|) (= $o@@5 |m'#0@@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@5) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@5) $f)))) (= (_module.__default.MatrixEqual _module._default.MatrixEqual$T@@0 $h0 |m#0@@0| |m'#0@@0|) (_module.__default.MatrixEqual _module._default.MatrixEqual$T@@0 $h1 |m#0@@0| |m'#0@@0|))))
...
)) (forall ((|i#2_2@@0| Int) (|j#2_2@@0| Int) )  (=> (and (<= (LitInt 0) |i#2_2@@0|) (and (and (< (- 0 |$rhs#1@0|) (- 0 |j#2_2@@0|)) (< (+ 3 |i#2_2@@0|) (+ |$rhs#0@0| 3))) (>= |j#2_2@@0| (LitInt 0)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $nw@2) (MultiIndexField (IndexField |i#2_2@@0|) |j#2_2@@0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |m#0@@1|) (MultiIndexField (IndexField |j#2_2@@0|) |i#2_2@@0|)))))) (and (= $Heap@6 $Heap@5) (= (ControlFlow 0 9) 2)))) GeneratedUnifiedExit_correct)))
...
)) (forall ((|i#1_2@@0| Int) (|j#1_2@@0| Int) )  (=> (and (and (<= (LitInt 0) |i#1_2@@0|) (<= (LitInt 0) |j#1_2@@0|)) (and (< |i#1_2@@0| |$rhs#0@0|) (< |j#1_2@@0| |$rhs#1@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@1) (MultiIndexField (IndexField |i#1_2@@0|) |j#1_2@@0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |m#0@@1|) (MultiIndexField (IndexField |j#1_2@@0|) |i#1_2@@0|))))))) (and (=> (= (ControlFlow 0 24) 23) anon26_Then_correct) (=> (= (ControlFlow 0 24) 9) anon26_Else_correct)))))
...
)) (forall ((|i#0_2@@0| Int) (|j#0_2@@0| Int) )  (=> (and (and (<= (LitInt 0) |i#0_2@@0|) (< |i#0_2@@0| |$rhs#0@0|)) (and (<= (LitInt 0) |j#0_2@@0|) (< |j#0_2@@0| |$rhs#1@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $nw@0) (MultiIndexField (IndexField |i#0_2@@0|) |j#0_2@@0|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |m#0@@1|) (MultiIndexField (IndexField |j#0_2@@0|) |i#0_2@@0|))))))) (and (=> (= (ControlFlow 0 37) 36) anon24_Then_correct) (=> (= (ControlFlow 0 37) 24) anon24_Else_correct)))))
