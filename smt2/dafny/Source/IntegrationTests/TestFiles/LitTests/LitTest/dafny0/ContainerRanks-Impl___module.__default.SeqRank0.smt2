...
(declare-fun |$IsA#_module.Abc| (T@U) Bool)
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass._module.Abc) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@0)) bx@@0) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@0) Tclass._module.Abc)))
 :qid |unknown.0:0|
 :skolemid |479|
 :pattern ( ($IsBox bx@@0 Tclass._module.Abc))
)))
...
(assert (forall ((d@@3 T@U) ) (!  (=> (|$IsA#_module.Abc| d@@3) (or (_module.Abc.End_q d@@3) (_module.Abc.Wrapper_q d@@3)))
 :qid |unknown.0:0|
 :skolemid |495|
 :pattern ( (|$IsA#_module.Abc| d@@3))
)))
...
(assert (forall ((d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 Tclass._module.Abc) (or (_module.Abc.End_q d@@4) (_module.Abc.Wrapper_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( (_module.Abc.Wrapper_q d@@4) ($Is DatatypeTypeType d@@4 Tclass._module.Abc))
 :pattern ( (_module.Abc.End_q d@@4) ($Is DatatypeTypeType d@@4 Tclass._module.Abc))
)))
...
(assert (forall ((d@@5 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) ($Is DatatypeTypeType d@@5 Tclass._module.Abc)) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Abc $h))
 :qid |unknown.0:0|
 :skolemid |494|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Abc $h))
)))
...
(assert (forall ((d@@6 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Abc.Wrapper_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.Abc $h@@0))) ($IsAlloc SeqType (_module.Abc._h0 d@@6) (TSeq Tclass._module.Abc) $h@@0))
 :qid |unknown.0:0|
 :skolemid |489|
 :pattern ( ($IsAlloc SeqType (_module.Abc._h0 d@@6) (TSeq Tclass._module.Abc) $h@@0))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.SeqRank0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |a#0|)))))) (=> (and (|$IsA#_module.Abc| ($Unbox DatatypeTypeType (|Seq#Index| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |a#0|)) (LitInt 0)))) (|$IsA#_module.Abc| |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|_module.Abc#Equal| ($Unbox DatatypeTypeType (|Seq#Index| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |a#0|)) (LitInt 0))) |a#0|)) (=> (|_module.Abc#Equal| ($Unbox DatatypeTypeType (|Seq#Index| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |a#0|)) (LitInt 0))) |a#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (not (|_module.Abc#Equal| |a#0| (|#_module.Abc.Wrapper| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType |a#0|)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |a#0| Tclass._module.Abc) ($IsAlloc DatatypeTypeType |a#0| Tclass._module.Abc $Heap)) (|$IsA#_module.Abc| |a#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
