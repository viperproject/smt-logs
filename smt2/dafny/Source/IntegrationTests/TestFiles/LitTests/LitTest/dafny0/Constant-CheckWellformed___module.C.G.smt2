...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|c#0@@0| T@U) ) (!  (=> (or (|_module.C.G#canCall| |c#0@@0|) (and (< 2 $FunctionContextHeight) ($Is refType |c#0@@0| Tclass._module.C))) (= (_module.C.G |c#0@@0|) (+ (+ _module.C.x _module.C.y) _module.C.y)))
 :qid |Constantdfy.54:21|
 :skolemid |2013|
 :pattern ( (_module.C.G |c#0@@0|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|c#0@@1| T@U) ) (!  (=> (or (|_module.C.G#canCall| (Lit refType |c#0@@1|)) (and (< 2 $FunctionContextHeight) ($Is refType |c#0@@1| Tclass._module.C))) (= (_module.C.G (Lit refType |c#0@@1|)) (+ (+ _module.C.x _module.C.y) _module.C.y)))
 :qid |Constantdfy.54:21|
 :weight 3
 :skolemid |2014|
 :pattern ( (_module.C.G (Lit refType |c#0@@1|)))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|c#0@@3| T@U) ) (!  (=> (or (|_module.C.G#canCall| |c#0@@3|) (and (< 2 $FunctionContextHeight) ($Is refType |c#0@@3| Tclass._module.C))) (= (_module.C.G |c#0@@3|) (LitInt 16)))
 :qid |Constantdfy.54:21|
 :skolemid |2011|
 :pattern ( (_module.C.G |c#0@@3|))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (= (_module.C.G |c#0@@4|) (LitInt 16)))))
(let ((anon5_Else_correct  (=> (= (_module.C.G |c#0@@4|) (+ (+ _module.C.x _module.C.y) _module.C.y)) (=> (and ($Is intType (int_2_U (_module.C.G |c#0@@4|)) TInt) (= (ControlFlow 0 5) 4)) GeneratedUnifiedExit_correct))))
(let ((anon5_Then_correct  (=> (and ($IsAlloc refType |c#0@@4| Tclass._module.C $Heap) (= (ControlFlow 0 2) (- 0 1))) (or (= |c#0@@4| |c#0@@4|) (and (= |c#0@@4| null) (or (not (= |c#0@@4| null)) (not true)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is refType |c#0@@4| Tclass._module.C)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
