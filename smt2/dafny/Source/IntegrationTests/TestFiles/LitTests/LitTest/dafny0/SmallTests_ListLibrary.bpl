...
// Constructor $Is
axiom (forall ListLibrary.List$T: Ty, a#18#0#0: Box, a#18#1#0: DatatypeType :: 
  { $Is(#ListLibrary.List.Cons(a#18#0#0, a#18#1#0), 
      Tclass.ListLibrary.List(ListLibrary.List$T)) } 
  $Is(#ListLibrary.List.Cons(a#18#0#0, a#18#1#0), 
      Tclass.ListLibrary.List(ListLibrary.List$T))
     <==> $IsBox(a#18#0#0, ListLibrary.List$T)
       && $Is(a#18#1#0, Tclass.ListLibrary.List(ListLibrary.List$T)));

// Constructor $IsAlloc
axiom (forall ListLibrary.List$T: Ty, a#18#0#0: Box, a#18#1#0: DatatypeType, $h: Heap :: 
  ...
  $IsGoodHeap($h)
     ==> ($IsAlloc(#ListLibrary.List.Cons(a#18#0#0, a#18#1#0), 
        Tclass.ListLibrary.List(ListLibrary.List$T), 
        $h)
       <==> $IsAllocBox(a#18#0#0, ListLibrary.List$T, $h)
         && $IsAlloc(a#18#1#0, Tclass.ListLibrary.List(ListLibrary.List$T), $h)));
...
axiom (forall a#20#0#0: Box, a#20#1#0: DatatypeType :: 
  ...
  ListLibrary.List._h3(#ListLibrary.List.Cons(a#20#0#0, a#20#1#0)) == a#20#0#0);
...
axiom (forall a#22#0#0: Box, a#22#1#0: DatatypeType :: 
  ...
  ListLibrary.List._h4(#ListLibrary.List.Cons(a#22#0#0, a#22#1#0)) == a#22#1#0);
