...
(declare-fun |PrefixEquality._default.Test0#$_T0| () T@U)
...
(set-info :boogie-vc-id Impl$$PrefixEquality.__default.Test0_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon7_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (ite (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 2)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) ($LS ($LS $LZ)) |t#1| |s#1|) (=> (< 0 (|ORD#Offset| (ite (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 2)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))))) (=> (PrefixEquality.Stream.Cons_q |t#1|) (and (PrefixEquality.Stream.Cons_q |s#1|) (and (= (PrefixEquality.Stream.head |t#1|) (PrefixEquality.Stream.head |s#1|)) (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (|ORD#Minus| (ite (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 2)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (PrefixEquality.Stream._h1 |t#1|) (PrefixEquality.Stream._h1 |s#1|)))))))) (=> (= (ControlFlow 0 13) (- 0 12)) (or (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (ite (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 2)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) ($LS ($LS $LZ)) |t#1| |s#1|) (or (=> (< 0 (|ORD#Offset| (ite (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 2)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))))) (=> (PrefixEquality.Stream.Cons_q |t#1|) (and (PrefixEquality.Stream.Cons_q |s#1|) (and (= (PrefixEquality.Stream.head |t#1|) (PrefixEquality.Stream.head |s#1|)) (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (|ORD#Minus| (ite (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 2)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (PrefixEquality.Stream._h1 |t#1|) (PrefixEquality.Stream._h1 |s#1|)))))) (=> (and (or (not (= (ite (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 2)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| (ite (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 2)) (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)))) 0)) (|$Eq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| ($LS ($LS $LZ)) |t#1| |s#1|))))))))
(let ((anon15_Else_correct  (=> (< (|ORD#Offset| |_k#0|) (LitInt 2)) (and (=> (= (ControlFlow 0 18) (- 0 20)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (= (ControlFlow 0 18) 13) anon7_correct))))))))
(let ((anon15_Then_correct  (=> (<= (LitInt 2) (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 2)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 2))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 2))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 2))) (|ORD#Offset| |_k#0|)) (=> (= (ControlFlow 0 15) 13) anon7_correct))))))))
(let ((anon14_Then_correct  (and (=> (= (ControlFlow 0 21) 15) anon15_Then_correct) (=> (= (ControlFlow 0 21) 18) anon15_Else_correct))))
(let ((anon16_Else_correct true))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (Lit BoxType (|ORD#FromNat| 0)) ($LS ($LS $LZ)) |s#1| |t#1|) (=> (< 0 (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 0)))) (=> (PrefixEquality.Stream.Cons_q |s#1|) (and (PrefixEquality.Stream.Cons_q |t#1|) (and (= (PrefixEquality.Stream.head |s#1|) (PrefixEquality.Stream.head |t#1|)) (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (|ORD#Minus| (Lit BoxType (|ORD#FromNat| 0)) (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (PrefixEquality.Stream._h1 |s#1|) (PrefixEquality.Stream._h1 |t#1|)))))))) (=> (= (ControlFlow 0 9) (- 0 8)) (or (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (Lit BoxType (|ORD#FromNat| 0)) ($LS ($LS $LZ)) |s#1| |t#1|) (or (=> (< 0 (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 0)))) (=> (PrefixEquality.Stream.Cons_q |s#1|) (and (PrefixEquality.Stream.Cons_q |t#1|) (and (= (PrefixEquality.Stream.head |s#1|) (PrefixEquality.Stream.head |t#1|)) (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (|ORD#Minus| (Lit BoxType (|ORD#FromNat| 0)) (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (PrefixEquality.Stream._h1 |s#1|) (PrefixEquality.Stream._h1 |t#1|)))))) (=> (and (or (not (= (Lit BoxType (|ORD#FromNat| 0)) (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 0))) 0)) (|$Eq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| ($LS ($LS $LZ)) |s#1| |t#1|))))))))
(let ((anon13_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) |s#1| |t#1|) (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)))) (=> (PrefixEquality.Stream.Cons_q |s#1|) (and (PrefixEquality.Stream.Cons_q |t#1|) (and (= (PrefixEquality.Stream.head |s#1|) (PrefixEquality.Stream.head |t#1|)) (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (|ORD#Minus| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (PrefixEquality.Stream._h1 |s#1|) (PrefixEquality.Stream._h1 |t#1|)))))))) (=> (= (ControlFlow 0 4) (- 0 3)) (or (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) |s#1| |t#1|) (or (=> (< 0 (|ORD#Offset| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)))) (=> (PrefixEquality.Stream.Cons_q |s#1|) (and (PrefixEquality.Stream.Cons_q |t#1|) (and (= (PrefixEquality.Stream.head |s#1|) (PrefixEquality.Stream.head |t#1|)) (|$PrefixEq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| (|ORD#Minus| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (PrefixEquality.Stream._h1 |s#1|) (PrefixEquality.Stream._h1 |t#1|)))))) (=> (and (or (not (= (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) 0)) (|$Eq#PrefixEquality.Stream| |PrefixEquality._default.Test0#$_T0| |PrefixEquality._default.Test0#$_T0| ($LS ($LS $LZ)) |s#1| |t#1|))))))))))))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (and (and (and (=> (= (ControlFlow 0 22) 2) anon12_Then_correct) (=> (= (ControlFlow 0 22) 4) anon13_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon14_Then_correct)) (=> (= (ControlFlow 0 22) 9) anon16_Then_correct)) (=> (= (ControlFlow 0 22) 11) anon16_Else_correct)))))
(let ((anon11_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 23) 22) anon11_Then_correct) (=> (= (ControlFlow 0 23) 1) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |s#1| (Tclass.PrefixEquality.Stream |PrefixEquality._default.Test0#$_T0|)) ($IsAlloc DatatypeTypeType |s#1| (Tclass.PrefixEquality.Stream |PrefixEquality._default.Test0#$_T0|) $Heap)) (|$IsA#PrefixEquality.Stream| |s#1|)) (=> (and (and (and (and ($Is DatatypeTypeType |t#1| (Tclass.PrefixEquality.Stream |PrefixEquality._default.Test0#$_T0|)) ($IsAlloc DatatypeTypeType |t#1| (Tclass.PrefixEquality.Stream |PrefixEquality._default.Test0#$_T0|) $Heap)) (|$IsA#PrefixEquality.Stream| |t#1|)) (= 2 $FunctionContextHeight)) (and (= (PrefixEquality.Stream.head |s#1|) (PrefixEquality.Stream.head |t#1|)) (= (ControlFlow 0 24) 23))) anon0_correct)))))
