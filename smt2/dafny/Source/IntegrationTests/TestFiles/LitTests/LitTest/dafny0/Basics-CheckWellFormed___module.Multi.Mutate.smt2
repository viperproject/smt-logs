...
(assert (distinct TInt TagInt alloc allocName Tagclass._module.Multi Tagclass._module.Multi? class._module.Multi? tytagFamily$Multi field$y)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@1 T@U) ($o@@1 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@1) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) Tclass._module.Multi?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) _module.Multi.y)) TInt $h@@1))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2921|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) _module.Multi.y)))
)))
...
(assert (forall (($h@@2 T@U) ($o@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass._module.Multi?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) _module.Multi.y)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2920|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) _module.Multi.y)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.Multi.Mutate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#12| null $Heap alloc this)) (<= (LitInt 0) |z#0|)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)) (= $o@@4 this)))
 :qid |Basicsdfy.124:10|
 :skolemid |2924|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is refType |m#0@0| Tclass._module.Multi?) ($IsAlloc refType |m#0@0| Tclass._module.Multi? $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this Tclass._module.Multi $Heap)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Multi) ($IsAlloc refType this Tclass._module.Multi $Heap)))) (and (and ($Is refType |m#0| Tclass._module.Multi?) ($IsAlloc refType |m#0| Tclass._module.Multi? $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
