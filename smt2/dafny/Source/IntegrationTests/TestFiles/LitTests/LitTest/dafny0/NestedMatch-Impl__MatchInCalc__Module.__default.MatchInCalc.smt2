...
(declare-fun |x#Z#0_0_0@0| () Int)
(declare-fun |let#0_0_1#0#0| () Int)
(declare-fun |v#Z#0_0_0@0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$MatchInCalc__Module.__default.MatchInCalc)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon6_correct  (=> (= (ControlFlow 0 11) (- 0 10)) (= (MatchInCalc__Module.__default.P |t#0|) (ite (MatchInCalc__Module.T.Leaf_q |t#0|) (let ((|v#0_1_2| (MatchInCalc__Module.T.h |t#0|)))
(= (LitInt 2) (Div 10 |v#0_1_2|))) (U_2_bool (Lit boolType (bool_2_U false))))))))
(let ((anon16_Then_correct  (=> (= |t#0| (|#MatchInCalc_Module.T.Node| |_mcc#1#0_0_0|)) (=> (and (and (= |let#0_1_0#0#0| |_mcc#1#0_0_0|) ($Is intType (int_2_U |let#0_1_0#0#0|) TInt)) (and (= |x#Z#0_1_0@0| |let#0_1_0#0#0|) (= (ControlFlow 0 14) 11))) anon6_correct))))
(let ((anon15_Then_correct  (=> (and (and (= |t#0| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|)) (= |let#0_1_1#0#0| |_mcc#0#0_0_0|)) (and ($Is intType (int_2_U |let#0_1_1#0#0|) TInt) (= |v#Z#0_1_0@0| |let#0_1_1#0#0|))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (not (= |v#Z#0_1_0@0| 0)) (not true))) (=> (= (ControlFlow 0 12) 11) anon6_correct)))))
(let ((anon16_Else_correct true))
(let ((anon15_Else_correct  (=> (or (not (= |t#0| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|))) (not true)) (and (=> (= (ControlFlow 0 15) 14) anon16_Then_correct) (=> (= (ControlFlow 0 15) 9) anon16_Else_correct)))))
(let ((anon14_Then_correct  (=> ($IsAlloc DatatypeTypeType |t#0| Tclass.MatchInCalc__Module.T $Heap) (=> (and (|MatchInCalc__Module.__default.P#canCall| |t#0|) (|MatchInCalc__Module.__default.P#canCall| |t#0|)) (and (=> (= (ControlFlow 0 16) 12) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct))))))
(let ((anon11_correct  (=> (and (and ($IsAlloc DatatypeTypeType |t#0| Tclass.MatchInCalc__Module.T $Heap) (|MatchInCalc__Module.__default.Q#canCall| |t#0|)) (and (|MatchInCalc__Module.__default.Q#canCall| |t#0|) (= (ControlFlow 0 5) (- 0 4)))) (= (ite (MatchInCalc__Module.T.Leaf_q |t#0|) (let ((|v#0_0_2| (MatchInCalc__Module.T.h |t#0|)))
(= (LitInt 2) (Div 10 |v#0_0_2|))) (U_2_bool (Lit boolType (bool_2_U false))))  (not (MatchInCalc__Module.__default.Q |t#0|))))))
(let ((anon19_Then_correct  (=> (= |t#0| (|#MatchInCalc_Module.T.Node| |_mcc#1#0_0_0|)) (=> (and (and (= |let#0_0_0#0#0| |_mcc#1#0_0_0|) ($Is intType (int_2_U |let#0_0_0#0#0|) TInt)) (and (= |x#Z#0_0_0@0| |let#0_0_0#0#0|) (= (ControlFlow 0 7) 5))) anon11_correct))))
(let ((anon18_Then_correct  (=> (and (= |t#0| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|)) (= |let#0_0_1#0#0| |_mcc#0#0_0_0|)) (=> (and (and ($Is intType (int_2_U |let#0_0_1#0#0|) TInt) (= |v#Z#0_0_0@0| |let#0_0_1#0#0|)) (and (or (not (= |v#Z#0_0_0@0| 0)) (not true)) (= (ControlFlow 0 6) 5))) anon11_correct))))
(let ((anon19_Else_correct true))
(let ((anon18_Else_correct  (=> (or (not (= |t#0| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|))) (not true)) (and (=> (= (ControlFlow 0 8) 7) anon19_Then_correct) (=> (= (ControlFlow 0 8) 3) anon19_Else_correct)))))
(let ((anon17_Else_correct true))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (=> (= (ControlFlow 0 17) 1) anon13_Then_correct) (=> (= (ControlFlow 0 17) 16) anon14_Then_correct)) (=> (= (ControlFlow 0 17) 2) anon17_Else_correct)) (=> (= (ControlFlow 0 17) 6) anon18_Then_correct)) (=> (= (ControlFlow 0 17) 8) anon18_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0| Tclass.MatchInCalc__Module.T) ($IsAlloc DatatypeTypeType |t#0| Tclass.MatchInCalc__Module.T $Heap)) (|$IsA#MatchInCalc__Module.T| |t#0|)) (= 2 $FunctionContextHeight)) (and (and (not (MatchInCalc__Module.__default.P |t#0|)) (MatchInCalc__Module.__default.Q |t#0|)) (and (MatchInCalc__Module.T.Node_q |t#0|) (= (ControlFlow 0 18) 17)))) anon0_correct))))
