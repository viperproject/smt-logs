...
axiom 1 <= $FunctionContextHeight
   ==> (forall Comprehension._default.ElementsContainedIn$X: Ty, 
      $ly: LayerType, 
      xs#0: DatatypeType, 
      S#0: Set :: 
   ...
   ==> (forall Comprehension._default.ElementsContainedIn$X: Ty, 
    ...
    Comprehension.__default.ElementsContainedIn#canCall(Comprehension._default.ElementsContainedIn$X, xs#0, S#0)
       ...
       ==> (!Comprehension.List.Nil_q(xs#0)
           ==> (var tail#1 := Comprehension.List._h16(xs#0); 
            (var x#1 := Comprehension.List._h15(xs#0); 
              Set#IsMember(S#0, x#1)
                 ==> Comprehension.__default.ElementsContainedIn#canCall(Comprehension._default.ElementsContainedIn$X, tail#1, S#0))))
         && Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($ly), xs#0, S#0)
           == (if Comprehension.List.Nil_q(xs#0)
             then true
             else (var tail#0 := Comprehension.List._h16(xs#0); 
              (var x#0 := Comprehension.List._h15(xs#0); 
                Set#IsMember(S#0, x#0)
                   && Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $ly, tail#0, S#0)))));
   ...
   ==> (forall Comprehension._default.ElementsContainedIn$X: Ty, 
    ...
    Comprehension.__default.ElementsContainedIn#canCall(Comprehension._default.ElementsContainedIn$X, Lit(xs#0), Lit(S#0))
       ...
       ==> (!Lit(Comprehension.List.Nil_q(Lit(xs#0)))
           ==> (var tail#3 := Lit(Comprehension.List._h16(Lit(xs#0))); 
            (var x#3 := Lit(Comprehension.List._h15(Lit(xs#0))); 
              Set#IsMember(Lit(S#0), x#3)
                 ==> Comprehension.__default.ElementsContainedIn#canCall(Comprehension._default.ElementsContainedIn$X, tail#3, Lit(S#0)))))
         && Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($ly), Lit(xs#0), Lit(S#0))
           == (if Comprehension.List.Nil_q(Lit(xs#0))
             then true
             else (var tail#2 := Lit(Comprehension.List._h16(Lit(xs#0))); 
              (var x#2 := Lit(Comprehension.List._h15(Lit(xs#0))); 
                Set#IsMember(Lit(S#0), x#2)
                   && Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($ly), tail#2, Lit(S#0))))));
}
...
procedure {:verboseName "Comprehension.ElementsContainedIn (well-formedness)"} CheckWellformed$$Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X: Ty, 
    xs#0: DatatypeType
       where $Is(xs#0, Tclass.Comprehension.List(Comprehension._default.ElementsContainedIn$X)), 
    S#0: Set where $Is(S#0, TSet(Comprehension._default.ElementsContainedIn$X)));
  ...
  ensures (forall $olderHeap: Heap :: 
    ...
    $IsGoodHeap($olderHeap)
         && $OlderTag($olderHeap)
         && 
        Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($LZ), xs#0, S#0)
         && $IsAlloc(S#0, TSet(Comprehension._default.ElementsContainedIn$X), $olderHeap)
       ==> $IsAlloc(xs#0, 
        Tclass.Comprehension.List(Comprehension._default.ElementsContainedIn$X), 
        $olderHeap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "Comprehension.ElementsContainedIn (well-formedness)"} CheckWellformed$$Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X: Ty, xs#0: DatatypeType, S#0: Set)
{
  ...
  var ##S#0: Set;
    ...
    else
    {
        ...
        if (xs#0 == #Comprehension.List.Nil())
        {
            assume {:id "id127"} Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($LZ), xs#0, S#0)
               == Lit(true);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($LZ), xs#0, S#0), 
              TBool);
            return;
        }
        else if (xs#0 == #Comprehension.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            assume $IsBox(_mcc#0#0, Comprehension._default.ElementsContainedIn$X);
            assume $Is(_mcc#1#0, 
              Tclass.Comprehension.List(Comprehension._default.ElementsContainedIn$X));
            havoc tail#Z#0;
            assume {:id "id121"} let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, 
              Tclass.Comprehension.List(Comprehension._default.ElementsContainedIn$X));
            assume {:id "id122"} tail#Z#0 == let#0#0#0;
            havoc x#Z#0;
            assume {:id "id123"} let#1#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(let#1#0#0, Comprehension._default.ElementsContainedIn$X);
            assume {:id "id124"} x#Z#0 == let#1#0#0;
            if (Set#IsMember(S#0, x#Z#0))
            {
                ##xs#0 := tail#Z#0;
                ...
                ##S#0 := S#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##S#0, TSet(Comprehension._default.ElementsContainedIn$X), $Heap);
                assert {:id "id125"} DtRank(##xs#0) < DtRank(xs#0)
                   || (DtRank(##xs#0) == DtRank(xs#0)
                     && 
                    Set#Subset(##S#0, S#0)
                     && !Set#Subset(S#0, ##S#0));
                assume Comprehension.__default.ElementsContainedIn#canCall(Comprehension._default.ElementsContainedIn$X, tail#Z#0, S#0);
            }

            assume {:id "id126"} Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($LZ), xs#0, S#0)
               == (Set#IsMember(S#0, x#Z#0)
                 && Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($LZ), tail#Z#0, S#0));
            assume Set#IsMember(S#0, x#Z#0)
               ==> Comprehension.__default.ElementsContainedIn#canCall(Comprehension._default.ElementsContainedIn$X, tail#Z#0, S#0);
            // CheckWellformedWithResult: any expression
            assume $Is(Comprehension.__default.ElementsContainedIn(Comprehension._default.ElementsContainedIn$X, $LS($LZ), xs#0, S#0), 
              TBool);
            return;
...
axiom 2 <= $FunctionContextHeight
   ==> (forall Comprehension._default.Collection$X: Ty, S#0: Set :: 
...
axiom 2 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, Comprehension._default.Collection$X: Ty, S#0: Set :: 
   ...
   ==> (forall Comprehension._default.Collection$X: Ty, S#0: Set :: 
    ...
    Comprehension.__default.Collection#canCall(Comprehension._default.Collection$X, S#0)
       ...
       ==> (forall xs#0: DatatypeType :: 
          { Comprehension.__default.ElementsContainedIn(Comprehension._default.Collection$X, $LS($LZ), xs#0, S#0) } 
          $Is(xs#0, Tclass.Comprehension.List(Comprehension._default.Collection$X))
             ==> Comprehension.__default.ElementsContainedIn#canCall(Comprehension._default.Collection$X, xs#0, S#0))
         && Comprehension.__default.Collection(Comprehension._default.Collection$X, S#0)
           == (lambda $y#0: Box :: 
            $IsBox($y#0, Tclass.Comprehension.List(Comprehension._default.Collection$X))
               && Comprehension.__default.ElementsContainedIn(Comprehension._default.Collection$X, $LS($LZ), $Unbox($y#0): DatatypeType, S#0)));
...
axiom {:id "id129"} 2 <= $FunctionContextHeight
   ==> (forall Comprehension._default.Collection$X: Ty, S#0: Set :: 
    ...
    Comprehension.__default.Collection#canCall(Comprehension._default.Collection$X, Lit(S#0))
         || (2 < $FunctionContextHeight
           && $Is(S#0, TSet(Comprehension._default.Collection$X)))
       ==> (forall xs#1: DatatypeType :: 
          { Comprehension.__default.ElementsContainedIn(Comprehension._default.Collection$X, $LS($LZ), xs#1, S#0) } 
          $Is(xs#1, Tclass.Comprehension.List(Comprehension._default.Collection$X))
             ==> Comprehension.__default.ElementsContainedIn#canCall(Comprehension._default.Collection$X, xs#1, Lit(S#0)))
         && Comprehension.__default.Collection(Comprehension._default.Collection$X, Lit(S#0))
           == (lambda $y#1: Box :: 
            $IsBox($y#1, Tclass.Comprehension.List(Comprehension._default.Collection$X))
               && Comprehension.__default.ElementsContainedIn(Comprehension._default.Collection$X, 
                $LS($LZ), 
                $Unbox($y#1): DatatypeType, 
                Lit(S#0))));
}
...
procedure {:verboseName "Comprehension.Collection (well-formedness)"} CheckWellformed$$Comprehension.__default.Collection(Comprehension._default.Collection$X: Ty, 
    S#0: Set where $Is(S#0, TSet(Comprehension._default.Collection$X)));
