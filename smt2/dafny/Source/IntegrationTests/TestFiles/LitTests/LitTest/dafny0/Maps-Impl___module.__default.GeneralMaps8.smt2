...
(declare-fun |lambda#84| (T@U Bool) T@U)
(declare-fun $IsBox (T@U T@U) Bool)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun _module.__default.P8 (Int) Bool)
...
(declare-fun |_module.__default.P8#canCall| (Int) Bool)
...
(assert (forall ((|l#0| T@U) (|l#1| Bool) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#84| |l#0| |l#1|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (exists ((|a#0#0#0| Int) ) (!  (and |l#1| (= (U_2_bool ($Unbox boolType |$w#0|)) (_module.__default.P8 |a#0#0#0|)))
 :qid |Mapsdfy.286:23|
 :skolemid |733|
))))
 :qid |DafnyPreludebpl.21:1|
 :skolemid |948|
 :pattern ( (MapType0Select BoxType boolType (|lambda#84| |l#0| |l#1|) |$w#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|$w#1_1_0_0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#48| |l#0@@0|) |$w#1_1_0_0|) |l#0@@0|)
 :qid |Mapsdfy.224:14|
 :skolemid |927|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#48| |l#0@@0|) |$w#1_1_0_0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0| Int) ) (!  (=> (or (|_module.__default.P8#canCall| |x#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.P8 |x#0|) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |Mapsdfy.283:14|
 :skolemid |728|
 :pattern ( (_module.__default.P8 |x#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|_module.__default.P8#canCall| (LitInt |x#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.P8 (LitInt |x#0@@0|)) (U_2_bool (Lit boolType (bool_2_U true)))))
 :qid |Mapsdfy.283:14|
 :weight 3
 :skolemid |729|
 :pattern ( (_module.__default.P8 (LitInt |x#0@@0|)))
))))
...
(declare-fun |map$project$15#0#x#0| (Bool) Int)
(declare-fun |c4#0@0| () T@U)
...
(declare-fun |c4#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.GeneralMaps8)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon7_correct  (=> (and (forall ((|x#1| Int) ) (!  (and (|_module.__default.P8#canCall| |x#1|) (forall ((|a#1#0#0@@0| Int) ) (!  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (U_2_bool (Lit boolType (bool_2_U true))) (= (_module.__default.P8 |a#1#0#0@@0|) (_module.__default.P8 (|map$project$15#0#x#0| (_module.__default.P8 |a#1#0#0@@0|))))))
 :qid |Mapsdfy.286:23|
 :skolemid |734|
 :pattern ( (_module.__default.P8 |a#1#0#0@@0|))
)))
 :qid |Mapsdfy.286:23|
 :skolemid |735|
 :pattern ( (_module.__default.P8 |x#1|))
)) (= |c4#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#84| TBool (U_2_bool (Lit boolType (bool_2_U true))))) (|lambda#48| ($Box intType (int_2_U (LitInt 6)))) (TMap TBool TInt)))) (=> (and (and (= |##x#1@0| (LitInt 177)) ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap)) (and (|_module.__default.P8#canCall| (LitInt 177)) (|_module.__default.P8#canCall| (LitInt 177)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|_module.__default.P8#canCall| (LitInt 177)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.P8 (LitInt 177))))) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.P8 (LitInt 177))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (|Set#IsMember| (|Map#Domain| |c4#0@0|) ($Box boolType (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |c4#0@0|) ($Box boolType (Lit boolType (bool_2_U true)))))) (LitInt 6))) (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |c4#0@0|) ($Box boolType (Lit boolType (bool_2_U true)))))) (LitInt 6)) (=> (= (ControlFlow 0 3) (- 0 2)) (not (|Set#IsMember| (|Map#Domain| |c4#0@0|) ($Box boolType (Lit boolType (bool_2_U false)))))))))))))))
(let ((anon11_Else_correct  (=> (and (not (and (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 9) 3)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (= (_module.__default.P8 |x#0@0|)  (not (_module.__default.P8 |x#prime#0@0|))) (= (LitInt 6) (LitInt 6)))) (=> (or (= (_module.__default.P8 |x#0@0|)  (not (_module.__default.P8 |x#prime#0@0|))) (= (LitInt 6) (LitInt 6))) (=> (= (ControlFlow 0 7) 3) anon7_correct))))))
(let ((anon10_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 11) 7) anon11_Then_correct) (=> (= (ControlFlow 0 11) 9) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 10) 7) anon11_Then_correct) (=> (= (ControlFlow 0 10) 9) anon11_Else_correct)))))
(let ((anon9_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 13) 10) anon10_Then_correct) (=> (= (ControlFlow 0 13) 11) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (and ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap) (|_module.__default.P8#canCall| |x#0@0|)) (and (=> (= (ControlFlow 0 12) 10) anon10_Then_correct) (=> (= (ControlFlow 0 12) 11) anon10_Else_correct))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 14) 12) anon9_Then_correct) (=> (= (ControlFlow 0 14) 13) anon9_Else_correct))))
(let ((anon8_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 15) 14) anon8_Then_correct) (=> (= (ControlFlow 0 15) 1) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |c4#0| (TMap TBool TInt)) ($IsAlloc MapType |c4#0| (TMap TBool TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 16) 15))) anon0_correct))))
