...
(declare-fun |_module.Cell.F#requires| (T@U) Bool)
...
(assert (distinct alloc allocName Tagclass._System.nat Tagclass._System.___hFunc0 Tagclass._System.___hPartialFunc0 Tagclass._System.___hTotalFunc0 Tagclass._module.Cell Tagclass._module.Cell? class._module.Cell? tytagFamily$nat |tytagFamily$_#Func0| |tytagFamily$_#PartialFunc0| |tytagFamily$_#TotalFunc0| tytagFamily$Cell field$data)
)
...
(assert (forall (($self T@U) ($heap T@U) ) (! (= (Requires0 Tclass._System.nat $heap (|_module.Cell.F#Handle| $self)) (|_module.Cell.F#requires| $self))
 :qid |unknown.0:0|
 :skolemid |7885|
 :pattern ( (Requires0 Tclass._System.nat $heap (|_module.Cell.F#Handle| $self)))
)))
(assert (forall ((|c#0| T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType |c#0| Tclass._module.Cell $h@@2) ($IsAlloc refType |c#0| Tclass._module.Cell? $h@@2))
 :qid |unknown.0:0|
 :skolemid |7954|
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.Cell $h@@2))
 :pattern ( ($IsAlloc refType |c#0| Tclass._module.Cell? $h@@2))
)))
...
(assert (forall (($o@@0 T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType $o@@0 Tclass._module.Cell? $h@@3)  (or (= $o@@0 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@0) alloc)))))
 :qid |unknown.0:0|
 :skolemid |7943|
 :pattern ( ($IsAlloc refType $o@@0 Tclass._module.Cell? $h@@3))
)))
...
(assert (forall (($self@@0 T@U) ($heap@@0 T@U) ) (! (= (Apply0 Tclass._System.nat $heap@@0 (|_module.Cell.F#Handle| $self@@0)) ($Box intType (int_2_U (_module.Cell.F $self@@0))))
 :qid |unknown.0:0|
 :skolemid |7884|
 :pattern ( (Apply0 Tclass._System.nat $heap@@0 (|_module.Cell.F#Handle| $self@@0)))
)))
...
(assert (forall (($bx T@U) ($self@@1 T@U) ($heap@@1 T@U) ) (! (= (|Set#IsMember| (Reads0 Tclass._System.nat $heap@@1 (|_module.Cell.F#Handle| $self@@1)) $bx) false)
 :qid |unknown.0:0|
 :skolemid |7886|
 :pattern ( (|Set#IsMember| (Reads0 Tclass._System.nat $heap@@1 (|_module.Cell.F#Handle| $self@@1)) $bx))
)))
...
(assert (forall (($h@@4 T@U) ($o@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) Tclass._module.Cell?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@1) _module.Cell.data)) Tclass._System.nat))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |7944|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@1) _module.Cell.data)))
)))
...
(assert (forall ((h@@5 T@U) (r@@0 T@U) (f@@9 T@U) (x@@6 T@U) ) (!  (=> ($IsGoodHeap (MapType0Store refType (MapType0Type FieldType BoxType) h@@5 r@@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@5 r@@0) f@@9 x@@6))) ($HeapSucc h@@5 (MapType0Store refType (MapType0Type FieldType BoxType) h@@5 r@@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@5 r@@0) f@@9 x@@6))))
 :qid |DafnyPreludebpl.603:15|
 :skolemid |7426|
 :pattern ( (MapType0Store refType (MapType0Type FieldType BoxType) h@@5 r@@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@5 r@@0) f@@9 x@@6)))
)))
...
(assert (forall ((f@@11 T@U) (t0@@12 T@U) (u0@@2 T@U) ) (!  (=> (and ($Is HandleTypeType f@@11 (Tclass._System.___hFunc0 t0@@12)) (forall ((bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 t0@@12) ($IsBox bx@@6 u0@@2))
 :qid |unknown.0:0|
 :skolemid |7743|
...
(assert (forall (($self@@2 T@U) ($heap@@2 T@U) ) (! (= (_module.Cell.F $self@@2) (U_2_int ($Unbox intType (Apply0 Tclass._System.nat $heap@@2 (|_module.Cell.F#Handle| $self@@2)))))
 :qid |unknown.0:0|
 :skolemid |7887|
 :pattern ( (_module.Cell.F $self@@2) ($IsGoodHeap $heap@@2))
)))
(assert (forall ((this@@2 T@U) ) (!  (=> (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass._module.Cell)) (= (|_module.Cell.F#requires| this@@2) true))
 :qid |TypeAdjustmentsdfy.164:12|
 :skolemid |7947|
 :pattern ( (|_module.Cell.F#requires| this@@2))
)))
(push 1)
...
(declare-fun |call2formal@x#0| () Int)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.Cell?)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)) (and ($IsHeapAnchor $Heap@0) (<= (LitInt 0) |x#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) true) (and (=> (= (ControlFlow 0 2) (- 0 15)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (and (= |x#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.Cell.data)))) (<= (LitInt 0) |y#0@0|)) (and (=> (= (ControlFlow 0 2) (- 0 14)) true) (and (=> (= (ControlFlow 0 2) (- 0 13)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> ($IsAllocBox ($Box refType $nw@0) Tclass._module.Cell? $Heap@0) (=> (and (and (|_module.Cell.F#canCall| $nw@0) (|_module.Cell.F#canCall| $nw@0)) (and (= |y#0@1| (_module.Cell.F $nw@0)) (<= (LitInt 0) |z#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 12)) true) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (<= (LitInt 0) |call2formal@x#0|) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (<= (LitInt 0) |call2formal@x#0@0|)) (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4)))
 :qid |TypeAdjustmentsdfy.167:10|
 :skolemid |7951|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@4))
)) ($HeapSucc $Heap@0 $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 9)) true) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (= |ff#0@0| (|_module.Cell.F#Handle| $nw@0)) (=> (and (and (and ($Is HandleTypeType |ff#0@1| (Tclass._System.___hTotalFunc0 Tclass._System.nat)) ($IsAlloc HandleTypeType |ff#0@1| (Tclass._System.___hTotalFunc0 Tclass._System.nat) $Heap@1)) (and (<= (LitInt 0) |u#0@0|) (= |u#0@1| (U_2_int ($Unbox intType (Apply0 Tclass._System.nat $Heap@1 |ff#0@1|)))))) (and (and (<= (LitInt 0) |$rhs#0@0|) (<= (LitInt 0) |$rhs#1@0|)) (and (<= (LitInt 0) |$rhs#2@0|) (<= (LitInt 0) |$rhs#4@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (<= (LitInt 0) |$rhs#0@0|)) (=> (<= (LitInt 0) |$rhs#0@0|) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= (LitInt 0) |$rhs#1@0|)) (=> (<= (LitInt 0) |$rhs#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= (LitInt 0) |$rhs#2@0|)) (=> (<= (LitInt 0) |$rhs#2@0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= (LitInt 0) |$rhs#3@0|)) (=> (<= (LitInt 0) |$rhs#3@0|) (=> ($IsAllocBox ($Box HandleTypeType |ff#0@1|) (Tclass._System.___hFunc0 Tclass._System.nat) $Heap@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Requires0 Tclass._System.nat $Heap@1 |ff#0@1|)) (=> (Requires0 Tclass._System.nat $Heap@1 |ff#0@1|) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitInt 0) |$rhs#4@0|))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (=> (and (and (and (=> |defass#cell#0| (and ($Is refType |cell#0| Tclass._module.Cell) ($IsAlloc refType |cell#0| Tclass._module.Cell $Heap))) true) (and (<= (LitInt 0) |x#0@@1|) true)) (and (and (<= (LitInt 0) |y#0|) true) (and (<= (LitInt 0) |z#0|) true))) (=> (and (and (and (and ($Is HandleTypeType |ff#0| (Tclass._System.___hTotalFunc0 Tclass._System.nat)) ($IsAlloc HandleTypeType |ff#0| (Tclass._System.___hTotalFunc0 Tclass._System.nat) $Heap)) true) (and (and (<= (LitInt 0) |u#0|) true) (and (<= (LitInt 0) |$rhs#0|) true))) (and (and (and (<= (LitInt 0) |$rhs#1|) true) (and (<= (LitInt 0) |$rhs#2|) true)) (and (and (<= (LitInt 0) |$rhs#4|) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 2))))) anon0_correct)))))
