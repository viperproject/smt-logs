...
(set-info :boogie-vc-id Impl$$_module.__default.TestMapPropertyMembership1)
...
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (exists ((|v#1| T@U) ) (! (|Set#IsMember| (|Map#Values| |m#0|) ($Box bv3Type |v#1|))
 :qid |Mapsdfy.541:17|
 :skolemid |846|
 :pattern ( (|Set#IsMember| (|Map#Values| |m#0|) ($Box bv3Type |v#1|)))
)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (|Set#Equal| (|Map#Values| |m#0|) |Set#Empty|))) (=> (not (|Set#Equal| (|Map#Values| |m#0|) |Set#Empty|)) (and (=> (= (ControlFlow 0 4) 2) anon3_Then_correct) (=> (= (ControlFlow 0 4) 3) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc MapType |m#0| (TMap Tclass._module.MyClass (TBitvector 3)) $Heap)) (= 1 $FunctionContextHeight)) (and (or (or (not (= (|Set#Card| (|Map#Items| |m#0|)) 0)) (not true)) (or (not (= (|Set#Card| (|Map#Domain| |m#0|)) 0)) (not true))) (= (ControlFlow 0 6) 4))) anon0_correct))))
