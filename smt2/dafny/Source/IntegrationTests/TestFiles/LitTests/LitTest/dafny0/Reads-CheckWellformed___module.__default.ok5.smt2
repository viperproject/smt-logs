...
(declare-fun _module.__default.ok5 (T@U T@U) T@U)
(declare-fun |_module.__default.ok5#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|r#0| T@U) ) (!  (=> (or (|_module.__default.ok5#canCall| $Heap |r#0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and ($Is refType |r#0| Tclass._module.R?) ($IsAlloc refType |r#0| Tclass._module.R? $Heap))))) ($Is DatatypeTypeType (_module.__default.ok5 $Heap |r#0|) Tclass._System.Tuple0))
 :qid |Readsdfy.59:16|
 :skolemid |578|
 :pattern ( (_module.__default.ok5 $Heap |r#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|r#0@@0| T@U) ) (!  (=> (or (|_module.__default.ok5#canCall| $Heap@@0 |r#0@@0|) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) ($Is refType |r#0@@0| Tclass._module.R?)))) (= (_module.__default.ok5 $Heap@@0 |r#0@@0|) (Lit DatatypeTypeType |#_System._tuple#0._#Make0|)))
 :qid |Readsdfy.59:16|
 :skolemid |580|
 :pattern ( (_module.__default.ok5 $Heap@@0 |r#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ok5)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#2| null $Heap@@1 alloc (ite  (or (not (= |r#0@@1| null)) (not true)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |r#0@@1|)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |r#0@@1|) _module.R.r)) |Set#Empty|))) (and (=> (= (ControlFlow 0 11) 8) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct)))))
