...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Shift)
...
(let ((anon4_correct  (=> (and (<= |k#0| |i#0@0|) (< |i#0@0| (_System.array.Length |b#0|))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |b#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |b#0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 (- |i#0@0| |k#0|)) (< (- |i#0@0| |k#0|) (_System.array.Length |a#0|)))) (=> (and (<= 0 (- |i#0@0| |k#0|)) (< (- |i#0@0| |k#0|) (_System.array.Length |a#0|))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b#0|) (IndexField |i#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (- |i#0@0| |k#0|)))))) (= (ControlFlow 0 3) 1)) anon6_correct))))))))))))
(let ((anon8_Else_correct  (=> (and (< |i#0@0| |k#0|) (= (ControlFlow 0 10) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (<= |k#0| |i#0@0|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (=> (= (ControlFlow 0 8) 3) anon4_correct))))))
(let ((anon7_Else_correct  (=> (and (=> (and (<= |k#0| |i#0@0|) (< |i#0@0| (_System.array.Length |b#0|))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |b#0|) (IndexField |i#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (- |i#0@0| |k#0|))))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
