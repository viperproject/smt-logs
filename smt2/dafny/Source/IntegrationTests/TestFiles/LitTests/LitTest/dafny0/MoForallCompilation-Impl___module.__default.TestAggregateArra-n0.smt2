...
(assert (distinct TBool TInt TReal TagBool TagInt TagReal TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 tytagFamily$nat tytagFamily$object tytagFamily$array |tytagFamily$_#Func1|)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0@@0| Real) (|$l#0#heap#0@@0| T@U) (|$l#0#i#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@0|) |$l#0#heap#0@@0| |$l#0#i#0@@0|) ($Box realType (real_2_U (- (q@Real (U_2_int ($Unbox intType |$l#0#i#0@@0|))) |l#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |709|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#2| |l#0@@0|) |$l#0#heap#0@@0| |$l#0#i#0@@0|))
)))
...
(assert (forall ((h@@12 T@U) (v@@5 T@U) ) (! ($IsAlloc realType v@@5 TReal h@@12)
 :qid |DafnyPreludebpl.290:14|
 :skolemid |62|
 :pattern ( ($IsAlloc realType v@@5 TReal h@@12))
)))
(assert (forall ((h@@13 T@U) (v@@6 T@U) ) (! ($IsAlloc boolType v@@6 TBool h@@13)
 :qid |DafnyPreludebpl.291:14|
 :skolemid |63|
 :pattern ( ($IsAlloc boolType v@@6 TBool h@@13))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestAggregateArrayUpdate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 37) (let ((anon3_correct true))
(let ((anon16_Else_correct  (=> (and (< |i#0@0| (LitInt 0)) (= (ControlFlow 0 33) 31)) anon3_correct)))
(let ((anon16_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| (- (q@Real |i#0@0|) 4.0))) (and ($Is realType (real_2_U |lambdaResult#0|) TReal) (= (ControlFlow 0 32) 31))) anon3_correct))))
(let ((anon15_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 34) 32) anon16_Then_correct) (=> (= (ControlFlow 0 34) 33) anon16_Else_correct)))))
(let ((anon7_correct  (=> (and (<= (- 2 |i#0_0@0|) (LitInt 2)) (< |i#0_0@0| (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 17) (- 0 22)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (and (=> (= (ControlFlow 0 17) (- 0 21)) (and (<= 0 (- 7 |i#0_0@0|)) (< (- 7 |i#0_0@0|) (_System.array.Length $nw@1)))) (and (=> (= (ControlFlow 0 17) (- 0 20)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@1 (IndexField (- 7 |i#0_0@0|))))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@1 (IndexField (- 7 |i#0_0@0|)))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 17) (- 0 18)) (and (<= 0 |i#0_0@0|) (< |i#0_0@0| (_System.array.Length $nw@0)))) (=> (and (and (<= (- 2 |i#0_1@0|) (LitInt 2)) (< |i#0_1@0| (_System.array.Length $nw@0))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 17) (- 0 16)))) (or (or (or (not (= $nw@1 $nw@1)) (not true)) (or (not (= (IndexField (- 7 |i#0_0@0|)) (IndexField (- 7 |i#0_1@0|)))) (not true))) (= (+ (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#0_0@0|)))) 4.0) (+ (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#0_1@0|)))) 4.0)))))))))))))))
(let ((anon18_Else_correct  (=> (and (< (LitInt 2) (- 2 |i#0_0@0|)) (= (ControlFlow 0 25) 17)) anon7_correct)))
(let ((anon18_Then_correct  (=> (<= (- 2 |i#0_0@0|) (LitInt 2)) (and (=> (= (ControlFlow 0 23) (- 0 24)) (or (not (= $nw@0 null)) (not true))) (=> (= (ControlFlow 0 23) 17) anon7_correct)))))
(let ((anon17_Then_correct  (and (=> (= (ControlFlow 0 26) 23) anon18_Then_correct) (=> (= (ControlFlow 0 26) 25) anon18_Else_correct))))
(let ((anon12_correct  (=> (and (<= (LitInt 0) |i#1_0@0|) (< |i#1_0@0| (_System.array.Length $nw@0))) (and (=> (= (ControlFlow 0 3) (- 0 10)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 9)) (and (<= 0 |i#1_0@0|) (< |i#1_0@0| (_System.array.Length $nw@2)))) (and (=> (= (ControlFlow 0 3) (- 0 8)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@2 (IndexField |i#1_0@0|)))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@2 (IndexField |i#1_0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |i#1_0@0|) (< |i#1_0@0| (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |i#1_0@0|) (< |i#1_0@0| (_System.array.Length $nw@1)))) (=> (and (and (<= (LitInt 0) |i#1_1@0|) (< |i#1_1@0| (_System.array.Length $nw@0))) (and (or (not (= |i#1_0@0| |i#1_1@0|)) (not true)) (= (ControlFlow 0 3) (- 0 2)))) (or (or (or (not (= $nw@2 $nw@2)) (not true)) (or (not (= (IndexField |i#1_0@0|) (IndexField |i#1_1@0|))) (not true))) (= (< (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#1_0@0|)))) (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@1) (IndexField |i#1_0@0|))))) (< (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@0) (IndexField |i#1_1@0|)))) (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@1) (IndexField |i#1_1@0|))))))))))))))))))))))
(let ((anon20_Else_correct  (=> (and (< |i#1_0@0| (LitInt 0)) (= (ControlFlow 0 13) 3)) anon12_correct)))
(let ((anon20_Then_correct  (=> (<= (LitInt 0) |i#1_0@0|) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= $nw@0 null)) (not true))) (=> (= (ControlFlow 0 11) 3) anon12_correct)))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 14) 11) anon20_Then_correct) (=> (= (ControlFlow 0 14) 13) anon20_Else_correct))))
(let ((anon19_Else_correct true))
(let ((anon17_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) ($HeapSucc $Heap@2 $Heap@3)) (and (forall (($o@@8 T@U) ($f@@0 T@U) ) (!  (or (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $o@@8) $f@@0) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $o@@8) $f@@0)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (- 2 |i#0_2|) (LitInt 2)) (< |i#0_2| (_System.array.Length $nw@0))) (= $o@@8 $nw@1)) (= $f@@0 (IndexField (- 7 |i#0_2|))))
 :qid |MoForallCompilationdfy.15:10|
 :skolemid |557|
)))
 :qid |MoForallCompilationdfy.15:3|
 :skolemid |558|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $o@@8) $f@@0))
)) (forall ((|i#inv#0_0| Int) ) (!  (=> (and (<= (- 2 (- 7 |i#inv#0_0|)) (LitInt 2)) (< (- 7 |i#inv#0_0|) (_System.array.Length $nw@0))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@1) (IndexField |i#inv#0_0|)) ($Box realType (real_2_U (+ (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) (IndexField (- 7 |i#inv#0_0|))))) 4.0)))))
 :qid |MoForallCompilationdfy.15:10|
 :skolemid |559|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@3 $nw@1) (IndexField |i#inv#0_0|)))
)))) (and (=> (= (ControlFlow 0 15) 14) anon19_Then_correct) (=> (= (ControlFlow 0 15) 1) anon19_Else_correct)))))
(let ((anon15_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TReal))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 8)))) (and (=> (= (ControlFlow 0 27) (- 0 30)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 8))) (Requires1 Tclass._System.nat TReal $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| 4.0) (|lambda#3| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |MoForallCompilationdfy.12:12|
 :skolemid |555|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (LitInt 8))) (= (U_2_real ($Unbox realType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)))) (U_2_real ($Unbox realType (Apply1 Tclass._System.nat TReal $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| 4.0) (|lambda#3| Tclass._System.nat) (|lambda#5| (SetRef_to_SetBox (|lambda#4| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))))
 :qid |MoForallCompilationdfy.12:12|
 :skolemid |556|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 27) (- 0 29)) (<= 0 (LitInt 8))) (=> (<= 0 (LitInt 8)) (=> (and (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? TReal))) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) alloc))))) (and (and (= (_System.array.Length $nw@1) (LitInt 8)) (= $Heap@1 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (<= 0 (LitInt 8))) (=> (<= 0 (LitInt 8)) (=> (and (and (and (or (not (= $nw@2 null)) (not true)) ($Is refType $nw@2 (Tclass._System.array? TBool))) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@2) alloc))))) (and (and (= (_System.array.Length $nw@2) (LitInt 8)) (= $Heap@2 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@1 $nw@2 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (=> (= (ControlFlow 0 27) 26) anon17_Then_correct) (=> (= (ControlFlow 0 27) 15) anon17_Else_correct)))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (<= 0 (LitInt 8))) (=> (<= 0 (LitInt 8)) (and (=> (= (ControlFlow 0 35) 34) anon15_Then_correct) (=> (= (ControlFlow 0 35) 27) anon15_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is refType |a#0| (Tclass._System.array TReal)) ($IsAlloc refType |a#0| (Tclass._System.array TReal) $Heap)) true) (and (and ($Is refType |b#0| (Tclass._System.array TReal)) ($IsAlloc refType |b#0| (Tclass._System.array TReal) $Heap)) true)) (and (and (and ($Is refType |c#0@@3| (Tclass._System.array TBool)) ($IsAlloc refType |c#0@@3| (Tclass._System.array TBool) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 37) 35)))) anon0_correct))))
