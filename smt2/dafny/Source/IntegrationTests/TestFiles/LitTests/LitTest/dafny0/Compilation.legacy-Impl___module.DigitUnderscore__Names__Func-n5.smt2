...
(assert (= (Tag Tclass._module.DigitUnderscore__Names__Functions__and__Methods) Tagclass._module.DigitUnderscore__Names__Functions__and__Methods))
(assert (= (TagFamily Tclass._module.DigitUnderscore__Names__Functions__and__Methods) tytagFamily$DigitUnderscore_Names_Functions_and_Methods))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|_module.DigitUnderscore__Names__Functions__and__Methods._70#canCall| this@@0) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.DigitUnderscore__Names__Functions__and__Methods)))) (= (_module.DigitUnderscore__Names__Functions__and__Methods._70 this@@0) (LitInt 80)))
 :qid |Compilationlegacydfy.336:18|
 :skolemid |11020|
 :pattern ( (_module.DigitUnderscore__Names__Functions__and__Methods._70 this@@0))
))))
...
(set-info :boogie-vc-id Impl$$_module.DigitUnderscore__Names__Functions__and__Methods._120)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (_module.DigitUnderscore__Names__Functions__and__Methods._70 this@@1) (LitInt 80)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.DigitUnderscore__Names__Functions__and__Methods) ($IsAlloc refType this@@1 Tclass._module.DigitUnderscore__Names__Functions__and__Methods $Heap))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
