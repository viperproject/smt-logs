...
(declare-fun _module.A.GoodRangeReads (T@U T@U T@U Bool) Bool)
(declare-fun |_module.A.GoodRangeReads#canCall| (T@U T@U T@U Bool) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|a#0| T@U) (|all#0| Bool) ) (!  (=> (or (|_module.A.GoodRangeReads#canCall| $Heap this |a#0| |all#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A $Heap)))) ($Is refType |a#0| (Tclass._System.array TInt))))) (= (_module.A.GoodRangeReads $Heap this |a#0| |all#0|)  (and (= (_System.array.Length |a#0|) (LitInt 10)) (ite |all#0| (|Seq#Equal| (|Seq#FromArray| $Heap |a#0|) |Seq#Empty|) (|Seq#Equal| (|Seq#Append| (|Seq#Append| (|Seq#Drop| (|Seq#Take| (|Seq#FromArray| $Heap |a#0|) (LitInt 5)) (LitInt 2)) (|Seq#Take| (|Seq#FromArray| $Heap |a#0|) (LitInt 5))) (|Seq#Drop| (|Seq#FromArray| $Heap |a#0|) (LitInt 2))) |Seq#Empty|)))))
 :qid |Arraydfy.124:18|
 :skolemid |1256|
 :pattern ( (_module.A.GoodRangeReads $Heap this |a#0| |all#0|) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.A.GoodRangeReads)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon7_correct  (=> (and (= (_module.A.GoodRangeReads $Heap@@0 this@@0 |a#0@@0| |all#0@@0|)  (and (= (_System.array.Length |a#0@@0|) (LitInt 10)) (ite |all#0@@0| (|Seq#Equal| (|Seq#FromArray| $Heap@@0 |a#0@@0|) |Seq#Empty|) (|Seq#Equal| (|Seq#Append| (|Seq#Append| (|Seq#Drop| (|Seq#Take| (|Seq#FromArray| $Heap@@0 |a#0@@0|) (LitInt 5)) (LitInt 2)) (|Seq#Take| (|Seq#FromArray| $Heap@@0 |a#0@@0|) (LitInt 5))) (|Seq#Drop| (|Seq#FromArray| $Heap@@0 |a#0@@0|) (LitInt 2))) |Seq#Empty|)))) ($Is boolType (bool_2_U (_module.A.GoodRangeReads $Heap@@0 this@@0 |a#0@@0| |all#0@@0|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 6)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#3@1|))))))))))
(let ((anon11_Else_correct  (=> (not |all#0@@0|) (and (=> (= (ControlFlow 0 10) (- 0 17)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 16)) (and (<= 0 (LitInt 2)) (<= (LitInt 2) (_System.array.Length |a#0@@0|)))) (=> (and (<= 0 (LitInt 2)) (<= (LitInt 2) (_System.array.Length |a#0@@0|))) (and (=> (= (ControlFlow 0 10) (- 0 15)) (and (<= (LitInt 2) (LitInt 5)) (<= (LitInt 5) (_System.array.Length |a#0@@0|)))) (=> (and (<= (LitInt 2) (LitInt 5)) (<= (LitInt 5) (_System.array.Length |a#0@@0|))) (=> (= |b$reqreads#1@0| (forall (($i Int) ) (!  (=> (and (<= (LitInt 2) $i) (< $i (LitInt 5))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i))))
 :qid |Arraydfy.131:8|
 :skolemid |1258|
 :pattern ( (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i)))
))) (and (=> (= (ControlFlow 0 10) (- 0 14)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 13)) (and (<= 0 (LitInt 5)) (<= (LitInt 5) (_System.array.Length |a#0@@0|)))) (=> (and (<= 0 (LitInt 5)) (<= (LitInt 5) (_System.array.Length |a#0@@0|))) (=> (= |b$reqreads#2@0| (forall (($i@@0 Int) ) (!  (=> (and (<= 0 $i@@0) (< $i@@0 (LitInt 5))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i@@0))))
 :qid |Arraydfy.131:18|
 :skolemid |1259|
 :pattern ( (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i@@0)))
))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (and (<= 0 (LitInt 2)) (<= (LitInt 2) (_System.array.Length |a#0@@0|)))) (=> (and (<= 0 (LitInt 2)) (<= (LitInt 2) (_System.array.Length |a#0@@0|))) (=> (and (= |b$reqreads#3@0| (forall (($i@@1 Int) ) (!  (=> (and (<= (LitInt 2) $i@@1) (< $i@@1 (_System.array.Length |a#0@@0|))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i@@1))))
 :qid |Arraydfy.131:27|
 :skolemid |1260|
 :pattern ( (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i@@1)))
...
(let ((anon11_Then_correct  (=> |all#0@@0| (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (=> (and (= |b$reqreads#0@0| (forall (($i@@2 Int) ) (!  (=> (and (<= 0 $i@@2) (< $i@@2 (_System.array.Length |a#0@@0|))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i@@2))))
 :qid |Arraydfy.129:8|
 :skolemid |1257|
 :pattern ( (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i@@2)))
...
(let ((anon10_Then_correct  (=> (= (_System.array.Length |a#0@@0|) (LitInt 10)) (and (=> (= (ControlFlow 0 18) 8) anon11_Then_correct) (=> (= (ControlFlow 0 18) 10) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (or (not (= (_System.array.Length |a#0@@0|) (LitInt 10))) (not true)) (= |b$reqreads#1@1| true)) (=> (and (and (= |b$reqreads#2@1| true) (= |b$reqreads#3@1| true)) (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 7) 3))) anon7_correct))))
(let ((anon9_Else_correct  (and (=> (= (ControlFlow 0 19) (- 0 20)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (and (=> (= (ControlFlow 0 19) 18) anon10_Then_correct) (=> (= (ControlFlow 0 19) 7) anon10_Else_correct))))))
(let ((anon9_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#21| null $Heap@@0 alloc |a#0@@0|)) (and (=> (= (ControlFlow 0 21) 1) anon9_Then_correct) (=> (= (ControlFlow 0 21) 19) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.A) ($IsAlloc refType this@@0 Tclass._module.A $Heap@@0))) ($Is refType |a#0@@0| (Tclass._System.array TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 22) 21))) anon0_correct))))
