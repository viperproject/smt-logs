...
(assert (forall (($h@@6 T@U) ($o@@8 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass.ITER__D.RecursiveIterator?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) ITER__D.RecursiveIterator.__new)) (TSet Tclass._System.object?)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2071|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@8) ITER__D.RecursiveIterator.__new)))
)))
(assert (forall (($h@@7 T@U) ($o@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass.ITER__D.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) ITER__D.RecursiveIterator.__new)) (TSet Tclass._System.object?) $h@@7))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2072|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@9) ITER__D.RecursiveIterator.__new)))
)))
...
(assert (forall (($h@@8 T@U) ($o@@11 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@11 null)) (not true)) (= (dtype $o@@11) Tclass.ITER__D.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@11) alloc)))) ($IsAlloc boolType (bool_2_U (ITER__D.RecursiveIterator.good $o@@11)) TBool $h@@8))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2066|
 :pattern ( (ITER__D.RecursiveIterator.good $o@@11) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@11) alloc)))
)))
(assert (forall (($h@@9 T@U) ($o@@12 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass.ITER__D.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@12) alloc)))) ($IsAlloc intType (int_2_U (ITER__D.RecursiveIterator.__decreases0 $o@@12)) TInt $h@@9))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2074|
 :pattern ( (ITER__D.RecursiveIterator.__decreases0 $o@@12) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@12) alloc)))
)))
(assert (forall (($h@@10 T@U) ($o@@13 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass.ITER__D.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@13) alloc)))) ($IsAlloc boolType (bool_2_U (ITER__D.RecursiveIterator.__decreases2 $o@@13)) TBool $h@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2078|
 :pattern ( (ITER__D.RecursiveIterator.__decreases2 $o@@13) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@13) alloc)))
)))
...
(declare-fun |ITER__D.RecursiveIterator.Valid#canCall| (T@U T@U) Bool)
(declare-fun |incomparable#0| () T@U)
(declare-fun |defass#iter#0| () Bool)
(declare-fun |iter#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$ITER__D.RecIterCaller.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc false)) (=> (and (or (not (= call4formal@this null)) (not true)) (and ($Is refType call4formal@this Tclass.ITER__D.RecursiveIterator) ($IsAlloc refType call4formal@this Tclass.ITER__D.RecursiveIterator $Heap))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= this@@0 null)) (not true))) (=> (or (not (= this@@0 null)) (not true)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (or (not (= call4formal@this@0 null)) (not true)) (and ($Is refType call4formal@this@0 Tclass.ITER__D.RecursiveIterator) ($IsAlloc refType call4formal@this@0 Tclass.ITER__D.RecursiveIterator $Heap@0))) (and (= (ITER__D.RecursiveIterator.n call4formal@this@0) |n#0|) (= (ITER__D.RecursiveIterator.r call4formal@this@0) this@@0))) (and (and (= (ITER__D.RecursiveIterator.good call4formal@this@0) |good#0@0|) (|ITER__D.RecursiveIterator.Valid#canCall| $Heap@0 call4formal@this@0)) (and (ITER__D.RecursiveIterator.Valid $Heap@0 call4formal@this@0) (|Set#Equal| (ITER__D.RecursiveIterator.__reads call4formal@this@0) |Set#Empty|)))) (and (and (and (|Set#Equal| (ITER__D.RecursiveIterator.__modifies call4formal@this@0) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) ITER__D.RecursiveIterator.__new)) |Set#Empty|)) (and (= (ITER__D.RecursiveIterator.__decreases0 call4formal@this@0) |n#0|) (= (ITER__D.RecursiveIterator.__decreases1 call4formal@this@0) this@@0))) (and (and (= (ITER__D.RecursiveIterator.__decreases2 call4formal@this@0) |good#0@0|) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap call4formal@this@0) alloc))))) (and (forall (($o@@25 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@25) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@25)))
 :qid |Iteratorsdfy.310:12|
 :skolemid |2081|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25))
)) ($HeapSucc $Heap $Heap@0))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) true) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= call4formal@this@0 null)) (not true))) (=> (or (not (= call4formal@this@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall (($o@@26 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@26 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@26) alloc)))) (or (or (= $o@@26 call4formal@this@0) (|Set#IsMember| (ITER__D.RecursiveIterator.__modifies call4formal@this@0) ($Box refType $o@@26))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) ITER__D.RecursiveIterator.__new)) ($Box refType $o@@26)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@26 $f@@1)))
 :qid |Iteratorsdfy.326:32|
 :skolemid |2103|
))) (=> (forall (($o@@27 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@27) alloc)))) (or (or (= $o@@27 call4formal@this@0) (|Set#IsMember| (ITER__D.RecursiveIterator.__modifies call4formal@this@0) ($Box refType $o@@27))) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 call4formal@this@0) ITER__D.RecursiveIterator.__new)) ($Box refType $o@@27)))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@27 $f@@2)))
 :qid |Iteratorsdfy.326:32|
 :skolemid |2103|
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (<= 0 |n#0|) (= (ITER__D.RecursiveIterator.__decreases0 call4formal@this@0) |n#0|))) (=> (or (<= 0 |n#0|) (= (ITER__D.RecursiveIterator.__decreases0 call4formal@this@0) |n#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (ITER__D.RecursiveIterator.__decreases0 call4formal@this@0) |n#0|)) (=> (< (ITER__D.RecursiveIterator.__decreases0 call4formal@this@0) |n#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (ITER__D.RecursiveIterator.Valid $Heap@0 call4formal@this@0)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.ITER__D.RecIterCaller) ($IsAlloc refType this@@0 Tclass.ITER__D.RecIterCaller $Heap))) (<= (LitInt 0) |n#0|)) (and ($Is SetType |incomparable#0| (TSet TInt)) ($IsAlloc SetType |incomparable#0| (TSet TInt) $Heap))) (and (and (=> |defass#iter#0| (and ($Is refType |iter#0| Tclass.ITER__D.RecursiveIterator) ($IsAlloc refType |iter#0| Tclass.ITER__D.RecursiveIterator $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 9) 2)))) anon0_correct))))
