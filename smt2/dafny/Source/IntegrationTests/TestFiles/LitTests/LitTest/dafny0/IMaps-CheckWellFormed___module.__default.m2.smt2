...
(let ((anon4_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|)))) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |b#0|) ($Box intType (int_2_U |i#0@0|)))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |b#0|) ($Box intType (int_2_U |i#0@0|))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |b#0|) ($Box intType (int_2_U |i#0@0|)))) (=> (and (= (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0|) ($Box intType (int_2_U |i#0@0|)))))  (not (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|IMap#Elements| |b#0|) ($Box intType (int_2_U |i#0@0|))))))) (= (ControlFlow 0 3) 1)) anon6_correct))))))))
...
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (and (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|)))) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |b#0|) ($Box intType (int_2_U |i#0@0|))))) (= (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0|) ($Box intType (int_2_U |i#0@0|)))))  (not (U_2_bool ($Unbox boolType (MapType0Select BoxType BoxType (|IMap#Elements| |b#0|) ($Box intType (int_2_U |i#0@0|))))))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 8) 2) anon7_Else_correct) (=> (= (ControlFlow 0 8) 6) anon8_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is IMapType |a#0| (TIMap TInt TBool)) ($IsAlloc IMapType |a#0| (TIMap TInt TBool) $Heap))) (and (and ($Is IMapType |b#0| (TIMap TInt TBool)) ($IsAlloc IMapType |b#0| (TIMap TInt TBool) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8)))) anon0_correct)))
