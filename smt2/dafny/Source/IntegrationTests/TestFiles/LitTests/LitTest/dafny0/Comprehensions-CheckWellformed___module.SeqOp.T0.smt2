...
(declare-fun _module.SeqOp.T0 (T@U Int) T@U)
(declare-fun |_module.SeqOp.T0#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.T0#canCall| (Lit refType this) (LitInt |n#0|)) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)) (<= (LitInt |n#0|) (LitInt 20))))) (= (_module.SeqOp.T0 (Lit refType this) (LitInt |n#0|)) (|Seq#Create| TReal $Heap (LitInt |n#0|) (|_module.SeqOp.G#Handle| (Lit refType this)))))
 :qid |Comprehensionsdfy.129:12|
 :weight 3
 :skolemid |627|
 :pattern ( (_module.SeqOp.T0 (Lit refType this) (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($Heap@@0 T@U) (this@@0 T@U) (|i#0| Int) ) (!  (=> (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.SeqOp) ($IsAlloc refType this@@0 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |i#0|)) (= (|_module.SeqOp.G#requires| $Heap@@0 this@@0 |i#0|) true))
 :qid |Comprehensionsdfy.87:12|
 :skolemid |544|
 :pattern ( (|_module.SeqOp.G#requires| $Heap@@0 this@@0 |i#0|) ($IsGoodHeap $Heap@@0))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@1 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.T0#canCall| this@@1 |n#0@@0|) (and (< 1 $FunctionContextHeight) (and (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)) (<= |n#0@@0| (LitInt 20))))) ($Is SeqType (_module.SeqOp.T0 this@@1 |n#0@@0|) (TSeq TReal)))
 :qid |Comprehensionsdfy.129:12|
 :skolemid |623|
 :pattern ( (_module.SeqOp.T0 this@@1 |n#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.T0#canCall| this@@2 |n#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@1|)) (<= |n#0@@1| (LitInt 20))))) (= (_module.SeqOp.T0 this@@2 |n#0@@1|) (|Seq#Create| TReal $Heap@@1 |n#0@@1| (|_module.SeqOp.G#Handle| this@@2))))
 :qid |Comprehensionsdfy.129:12|
 :skolemid |625|
 :pattern ( (_module.SeqOp.T0 this@@2 |n#0@@1|) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@3 T@U) (|i#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.G#canCall| $Heap@@2 this@@3 |i#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass._module.SeqOp) ($IsAlloc refType this@@3 Tclass._module.SeqOp $Heap@@2)))) (<= (LitInt 0) |i#0@@0|)))) (= (_module.SeqOp.G $Heap@@2 this@@3 |i#0@@0|) (ite (< |i#0@@0| 20) 2.5 (U_2_real ($Unbox realType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@3) _module.SeqOp.x))))))
 :qid |Comprehensionsdfy.87:12|
 :skolemid |545|
 :pattern ( (_module.SeqOp.G $Heap@@2 this@@3 |i#0@@0|) ($IsGoodHeap $Heap@@2))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@4 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.T0#canCall| this@@4 (LitInt |n#0@@2|)) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.SeqOp) ($IsAlloc refType this@@4 Tclass._module.SeqOp $Heap@@3)))) (<= (LitInt 0) |n#0@@2|)) (<= (LitInt |n#0@@2|) (LitInt 20))))) (= (_module.SeqOp.T0 this@@4 (LitInt |n#0@@2|)) (|Seq#Create| TReal $Heap@@3 (LitInt |n#0@@2|) (|_module.SeqOp.G#Handle| this@@4))))
 :qid |Comprehensionsdfy.129:12|
 :weight 3
 :skolemid |626|
 :pattern ( (_module.SeqOp.T0 this@@4 (LitInt |n#0@@2|)) ($IsGoodHeap $Heap@@3))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.T0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= 0 |n#0@@3|)) (=> (<= 0 |n#0@@3|) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 Tclass._System.nat TReal $Heap@@4 (|_module.SeqOp.G#Handle| this@@5) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |Comprehensionsdfy.132:5|
 :skolemid |628|
))) (=> (and (and (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| |n#0@@3|)) (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@4) alloc)))) (|Set#IsMember| (Reads1 Tclass._System.nat TReal $Heap@@4 (|_module.SeqOp.G#Handle| this@@5) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |Comprehensionsdfy.132:5|
 :skolemid |629|
)))
 :qid |Comprehensionsdfy.132:5|
 :skolemid |630|
))) (= (_module.SeqOp.T0 this@@5 |n#0@@3|) (|Seq#Create| TReal $Heap@@4 |n#0@@3| (|_module.SeqOp.G#Handle| this@@5)))) (and ($Is SeqType (_module.SeqOp.T0 this@@5 |n#0@@3|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))))))
