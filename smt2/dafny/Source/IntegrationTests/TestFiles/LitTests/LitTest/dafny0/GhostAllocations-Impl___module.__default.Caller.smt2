...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon9_correct  (and (=> (= (ControlFlow 0 21) (- 0 22)) (or (and ($Is refType null Tclass._module.Cell) (and (_module.__default.P null) (and (or (not (= null null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap null) alloc))))))) (exists ((|$as#c1_0#1_0| T@U) )  (and (and ($Is refType |$as#c1_0#1_0| Tclass._module.Cell) ($IsAlloc refType |$as#c1_0#1_0| Tclass._module.Cell $Heap@4)) (and (_module.__default.P |$as#c1_0#1_0|) (and (or (not (= |$as#c1_0#1_0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |$as#c1_0#1_0|) alloc)))))))))) (=> (or (and ($Is refType null Tclass._module.Cell) (and (_module.__default.P null) (and (or (not (= null null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap null) alloc))))))) (exists ((|$as#c1_0#1_0@@0| T@U) )  (and (and ($Is refType |$as#c1_0#1_0@@0| Tclass._module.Cell) ($IsAlloc refType |$as#c1_0#1_0@@0| Tclass._module.Cell $Heap@4)) (and (_module.__default.P |$as#c1_0#1_0@@0|) (and (or (not (= |$as#c1_0#1_0@@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |$as#c1_0#1_0@@0|) alloc))))))))) (=> (=> true (and ($Is refType |c#1_0@0| Tclass._module.Cell) ($IsAlloc refType |c#1_0@0| Tclass._module.Cell $Heap@4))) (=> (and (and (_module.__default.P |c#1_0@0|) (and (or (not (= |c#1_0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#1_0@0|) alloc)))))) (= (ControlFlow 0 21) (- 0 20))) (U_2_bool (Lit boolType (bool_2_U false)))))))))
...
(let ((anon14_correct  (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (and ($Is refType null Tclass._module.Cell) (and (_module.__default.P null) (and (or (not (= null null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap null) alloc))))))) (exists ((|$as#c0_0#0_0| T@U) )  (and (and ($Is refType |$as#c0_0#0_0| Tclass._module.Cell) ($IsAlloc refType |$as#c0_0#0_0| Tclass._module.Cell $Heap@5)) (and (_module.__default.P |$as#c0_0#0_0|) (and (or (not (= |$as#c0_0#0_0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |$as#c0_0#0_0|) alloc)))))))))) (=> (or (and ($Is refType null Tclass._module.Cell) (and (_module.__default.P null) (and (or (not (= null null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap null) alloc))))))) (exists ((|$as#c0_0#0_0@@0| T@U) )  (and (and ($Is refType |$as#c0_0#0_0@@0| Tclass._module.Cell) ($IsAlloc refType |$as#c0_0#0_0@@0| Tclass._module.Cell $Heap@5)) (and (_module.__default.P |$as#c0_0#0_0@@0|) (and (or (not (= |$as#c0_0#0_0@@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |$as#c0_0#0_0@@0|) alloc))))))))) (=> (=> true (and ($Is refType |c#0_0@0| Tclass._module.Cell) ($IsAlloc refType |c#0_0@0| Tclass._module.Cell $Heap@5))) (=> (and (and (_module.__default.P |c#0_0@0|) (and (or (not (= |c#0_0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0_0@0|) alloc)))))) (= (ControlFlow 0 12) (- 0 11))) (U_2_bool (Lit boolType (bool_2_U false)))))))))
