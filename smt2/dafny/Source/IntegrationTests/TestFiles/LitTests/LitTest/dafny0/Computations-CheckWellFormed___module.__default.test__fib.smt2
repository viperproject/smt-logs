...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.test__fib)
...
(assert (not
 ...
 :qid |Computationsdfy.170:14|
 :skolemid |689|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
))) (and ($HeapSuccGhost $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($Is intType (int_2_U (LitInt 12)) Tclass._System.nat)))))
