...
(assert (forall ((EqualityIsSuperDestructive.Stream$T T@U) (d T@U) ) (!  (=> ($Is DatatypeTypeType d (Tclass.EqualityIsSuperDestructive.Stream EqualityIsSuperDestructive.Stream$T)) (EqualityIsSuperDestructive.Stream.Cons_q d))
 :qid |unknown.0:0|
 :skolemid |1743|
 :pattern ( (EqualityIsSuperDestructive.Stream.Cons_q d) ($Is DatatypeTypeType d (Tclass.EqualityIsSuperDestructive.Stream EqualityIsSuperDestructive.Stream$T)))
)))
...
(assert (forall ((d@@0 T@U) ) (! (= (EqualityIsSuperDestructive.Stream.Cons_q d@@0) (= (DatatypeCtorId d@@0) |##EqualityIsSuperDestructive.Stream.Cons|))
 :qid |unknown.0:0|
 :skolemid |1733|
 :pattern ( (EqualityIsSuperDestructive.Stream.Cons_q d@@0))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (EqualityIsSuperDestructive.Stream.Cons_q d@@1) (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (! (= d@@1 (|#EqualityIsSuperDestructive.Stream.Cons| |a#1#0#0| |a#1#1#0|))
...
(assert (forall ((d@@2 T@U) (EqualityIsSuperDestructive.Stream$T@@3 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) (and (EqualityIsSuperDestructive.Stream.Cons_q d@@2) ($IsAlloc DatatypeTypeType d@@2 (Tclass.EqualityIsSuperDestructive.Stream EqualityIsSuperDestructive.Stream$T@@3) $h))) ($IsAllocBox (EqualityIsSuperDestructive.Stream.head d@@2) EqualityIsSuperDestructive.Stream$T@@3 $h))
 :qid |unknown.0:0|
 :skolemid |1738|
 :pattern ( ($IsAllocBox (EqualityIsSuperDestructive.Stream.head d@@2) EqualityIsSuperDestructive.Stream$T@@3 $h))
)))
...
(assert (forall ((d@@3 T@U) (EqualityIsSuperDestructive.Stream$T@@5 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (EqualityIsSuperDestructive.Stream.Cons_q d@@3) ($IsAlloc DatatypeTypeType d@@3 (Tclass.EqualityIsSuperDestructive.Stream EqualityIsSuperDestructive.Stream$T@@5) $h@@0))) ($IsAlloc DatatypeTypeType (EqualityIsSuperDestructive.Stream.tail d@@3) (Tclass.EqualityIsSuperDestructive.Stream EqualityIsSuperDestructive.Stream$T@@5) $h@@0))
 :qid |unknown.0:0|
 :skolemid |1739|
 :pattern ( ($IsAlloc DatatypeTypeType (EqualityIsSuperDestructive.Stream.tail d@@3) (Tclass.EqualityIsSuperDestructive.Stream EqualityIsSuperDestructive.Stream$T@@5) $h@@0))
)))
...
(set-info :boogie-vc-id CheckWellformed$$EqualityIsSuperDestructive.__default.F)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon7_Else_correct  (=> (and ($IsAlloc DatatypeTypeType |s#0@@3| (Tclass.EqualityIsSuperDestructive.Stream TInt) $Heap) (= (ControlFlow 0 3) (- 0 2))) false)))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 4) 1) anon7_Then_correct) (=> (= (ControlFlow 0 4) 3) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |s#0@@3| (Tclass.EqualityIsSuperDestructive.Stream TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct)))
