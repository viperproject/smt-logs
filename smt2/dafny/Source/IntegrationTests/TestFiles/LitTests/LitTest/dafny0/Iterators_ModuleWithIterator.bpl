...
procedure {:verboseName "ModuleWithIterator.Iter._ctor (well-formedness)"} CheckWellFormed$$ModuleWithIterator.Iter.__ctor(x#0: int) returns (this: ref);
...
procedure {:verboseName "ModuleWithIterator.Iter._ctor (call)"} Call$$ModuleWithIterator.Iter.__ctor(x#0: int)
   returns (this: ref
       where this != null
         && 
  ...
  free ensures true;
  ensures {:id "id421"} ModuleWithIterator.Iter.x(this) == x#0;
  free ensures true;
  ensures {:id "id422"} Seq#Equal($Unbox(read($Heap, this, ModuleWithIterator.Iter.ys)): Seq, Seq#Empty(): Seq);
  free ensures ModuleWithIterator.Iter.Valid#canCall($Heap, this);
  ensures {:id "id423"} ModuleWithIterator.Iter.Valid($Heap, this);
  free ensures true;
  ensures {:id "id424"} Set#Equal(ModuleWithIterator.Iter.__reads(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id425"} Set#Equal(ModuleWithIterator.Iter.__modifies(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id426"} Set#Equal($Unbox(read($Heap, this, ModuleWithIterator.Iter.__new)): Set, Set#Empty(): Set);
  free ensures true;
  ensures {:id "id427"} ModuleWithIterator.Iter.__decreases0(this) == x#0;
...
procedure {:verboseName "ModuleWithIterator.Iter.Valid (well-formedness)"} CheckWellformed$$ModuleWithIterator.Iter.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.ModuleWithIterator.Iter())
         && $IsAlloc(this, Tclass.ModuleWithIterator.Iter(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ModuleWithIterator.Iter.Valid (well-formedness)"} CheckWellformed$$ModuleWithIterator.Iter.Valid(this: ref)
{
  ...
  var b$reqreads#0: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> $o == this
           || Set#IsMember(ModuleWithIterator.Iter.__reads(this), $Box($o))
           || Set#IsMember($Unbox(read($Heap, this, ModuleWithIterator.Iter.__new)): Set, $Box($o)));
    // Check well-formedness of preconditions, and then assume them
    // Check well-formedness of the reads clause
    b$reqreads#0 := $_ReadsFrame[this, ModuleWithIterator.Iter.__new];
...
procedure {:verboseName "ModuleWithIterator.Iter.MoveNext (call)"} Call$$ModuleWithIterator.Iter.MoveNext(this: ref
       where this != null
         && 
        $Is(this, Tclass.ModuleWithIterator.Iter())
         && $IsAlloc(this, Tclass.ModuleWithIterator.Iter(), $Heap))
  ...
  requires {:id "id429"} ModuleWithIterator.Iter.Valid($Heap, this);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id430"} (forall $o: ref :: 
      { $o != null } 
      Set#IsMember($Unbox(read($Heap, this, ModuleWithIterator.Iter.__new)): Set, $Box($o))
           && !Set#IsMember($Unbox(read(old($Heap), this, ModuleWithIterator.Iter.__new)): Set, $Box($o))
         ==> $o != null)
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, ModuleWithIterator.Iter.__new)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id431"} !Set#IsMember($Unbox(read($Heap, this, ModuleWithIterator.Iter.__new)): Set, $Box(null));
  free ensures more#0 ==> ModuleWithIterator.Iter.Valid#canCall($Heap, this);
  ensures {:id "id432"} more#0 ==> ModuleWithIterator.Iter.Valid($Heap, this);
  free ensures true;
  ensures {:id "id433"} Seq#Equal($Unbox(read($Heap, this, ModuleWithIterator.Iter.ys)): Seq, 
    (if more#0
       then Seq#Append($Unbox(read(old($Heap), this, ModuleWithIterator.Iter.ys)): Seq, 
        Seq#Build(Seq#Empty(): Seq, read($Heap, this, ModuleWithIterator.Iter.y)))
       else $Unbox(read(old($Heap), this, ModuleWithIterator.Iter.ys)): Seq));
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
       ==> $Heap[$o] == old($Heap)[$o]
         || 
        $o == this
         || Set#IsMember(ModuleWithIterator.Iter.__modifies(this), $Box($o))
         || Set#IsMember($Unbox(read(old($Heap), this, ModuleWithIterator.Iter.__new)): Set, $Box($o)));
  // boilerplate
  free ensures $HeapSucc(old($Heap), $Heap);
...
procedure {:verboseName "ModuleWithIterator.Iter (correctness)"} Impl$$ModuleWithIterator.Iter(this: ref
       where this != null
         && 
        $Is(this, Tclass.ModuleWithIterator.Iter())
         && $IsAlloc(this, Tclass.ModuleWithIterator.Iter(), $Heap), 
