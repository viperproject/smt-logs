...
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.Sequence)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon6_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 |j#0|) (< |j#0| (|Seq#Length| |t#0@0|))))))
(let ((anon8_Else_correct  (=> (= (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| (LitInt 8))))  (not (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| (LitInt 8)))))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (and (<= 0 (LitInt 9)) (< (LitInt 9) (|Seq#Length| |t#0@0|)))) (=> (and (<= 0 (LitInt 9)) (< (LitInt 9) (|Seq#Length| |t#0@0|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (and (<= 0 (LitInt 9)) (< (LitInt 9) (|Seq#Length| |s#0|)))) (=> (and (<= 0 (LitInt 9)) (< (LitInt 9) (|Seq#Length| |s#0|))) (=> (and (= (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| (LitInt 9)))) (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| (LitInt 9))))) (= (ControlFlow 0 6) 2)) anon6_correct))))))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 (LitInt 8)) (< (LitInt 8) (|Seq#Length| |t#0@0|)))) (=> (and (<= 0 (LitInt 8)) (< (LitInt 8) (|Seq#Length| |t#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 (LitInt 8)) (< (LitInt 8) (|Seq#Length| |s#0|)))) (=> (and (<= 0 (LitInt 8)) (< (LitInt 8) (|Seq#Length| |s#0|))) (=> (and (= (U_2_bool ($Unbox boolType (|Seq#Index| |t#0@0| (LitInt 8)))) (U_2_bool ($Unbox boolType (|Seq#Index| |s#0| (LitInt 8))))) (= (ControlFlow 0 3) 2)) anon6_correct)))))))
(let ((anon3_correct  (=> (and (<= (LitInt 8) |j#0|) (< |j#0| (|Seq#Length| |s#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |SmallTestsdfy.37:10|
 :skolemid |3310|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is SeqType |t#0@0| (TSeq TBool)) ($IsAlloc SeqType |t#0@0| (TSeq TBool) $Heap@0)) (= (|Seq#Length| |t#0@0|) (|Seq#Length| |s#0|)))) (and (=> (= (ControlFlow 0 9) 3) anon8_Then_correct) (=> (= (ControlFlow 0 9) 6) anon8_Else_correct))))))
(let ((anon7_Else_correct  (=> (and (< |j#0| (LitInt 8)) (= (ControlFlow 0 11) 9)) anon3_correct)))
(let ((anon7_Then_correct  (=> (and (<= (LitInt 8) |j#0|) (= (ControlFlow 0 10) 9)) anon3_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (LitInt 10) (|Seq#Length| |s#0|))) (and (=> (= (ControlFlow 0 12) 10) anon7_Then_correct) (=> (= (ControlFlow 0 12) 11) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Node) ($IsAlloc refType this Tclass._module.Node $Heap))) (and ($Is SeqType |s#0| (TSeq TBool)) ($IsAlloc SeqType |s#0| (TSeq TBool) $Heap))) (and (and ($Is SeqType |t#0| (TSeq TBool)) ($IsAlloc SeqType |t#0| (TSeq TBool) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 13) 12)))) anon0_correct))))
