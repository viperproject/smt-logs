...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QualifiedNames.__default.P#canCall(x#0) || 0 < $FunctionContextHeight
       ==> MyModule.__default.MyFunction#canCall(x#0)
         && QualifiedNames.__default.P(x#0)
           == (var u#0 := x#0; MyModule.__default.MyFunction(x#0) == x#0));
...
axiom {:id "id1"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QualifiedNames.__default.P#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
...
procedure {:verboseName "QualifiedNames.P (well-formedness)"} CheckWellformed$$QualifiedNames.__default.P(x#0: int);
...
axiom {:id "id5"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QualifiedNames.__default.Q#canCall(x#0) || 0 < $FunctionContextHeight
       ==> MyModule.__default.MyFunction#canCall(x#0)
         && QualifiedNames.__default.Q(x#0)
           == (var u#0 := x#0; x#0 == MyModule.__default.MyFunction(x#0)));
...
axiom {:id "id6"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QualifiedNames.__default.Q#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
       ==> MyModule.__default.MyFunction#canCall(LitInt(x#0))
...
procedure {:verboseName "QualifiedNames.Q (well-formedness)"} CheckWellformed$$QualifiedNames.__default.Q(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QualifiedNames.Q (well-formedness)"} CheckWellformed$$QualifiedNames.__default.Q(x#0: int)
{
  ...
  var ##x#0: int;
    ...
    else
    {
        ...
        assume {:id "id8"} u#Z#0 == let#0#0#0;
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/PrecedenceLinter.dfy(542,19)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        x##0 := x#0;
        call {:id "id9"} Call$$MyModule.__default.Lemma(x##0);
        // TrCallStmt: After ProcessCallStmt
        ##x#0 := x#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assume MyModule.__default.MyFunction#canCall(x#0);
        assume {:id "id10"} QualifiedNames.__default.Q(x#0) == (x#0 == MyModule.__default.MyFunction(x#0));
        assume MyModule.__default.MyFunction#canCall(x#0);
        // CheckWellformedWithResult: any expression
        assume $Is(QualifiedNames.__default.Q(x#0), TBool);
        return;
...
axiom {:id "id11"} 0 <= $FunctionContextHeight
   ==> 
  QualifiedNames.__default.F#canCall() || 0 < $FunctionContextHeight
   ==> QualifiedNames.__default.F() == (var p#0 := LitInt(1000); p#0);
// definition axiom for QualifiedNames.__default.F for all literals (revealed)
axiom {:id "id12"} 0 <= $FunctionContextHeight
   ==> 
  QualifiedNames.__default.F#canCall() || 0 < $FunctionContextHeight
   ==> QualifiedNames.__default.F() == (var p#1 := LitInt(1000); p#1);
}
...
procedure {:verboseName "QualifiedNames.F (well-formedness)"} CheckWellformed$$QualifiedNames.__default.F();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QualifiedNames.F (well-formedness)"} CheckWellformed$$QualifiedNames.__default.F()
{
  var $_ReadsFrame: [ref,Field]bool;
  var p#Z#0: int;
  var let#0#0#0: int;
  var x##0: int;
    ...
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc p#Z#0;
        assume {:id "id13"} let#0#0#0 == LitInt(1000);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id14"} p#Z#0 == let#0#0#0;
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/PrecedenceLinter.dfy(549,19)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        x##0 := p#Z#0;
        call {:id "id15"} Call$$MyModule.__default.Lemma(x##0);
        // TrCallStmt: After ProcessCallStmt
        assume {:id "id16"} QualifiedNames.__default.F() == p#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(QualifiedNames.__default.F(), TInt);
        return;
...
axiom {:id "id17"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QualifiedNames.__default.R#canCall(x#0) || 0 < $FunctionContextHeight
       ==> MyModule.__default.MyFunction#canCall(x#0)
         && QualifiedNames.__default.R(x#0)
           == (var u#0 := x#0; x#0 == MyModule.__default.MyFunction(x#0)));
...
axiom {:id "id18"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QualifiedNames.__default.R#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
       ==> MyModule.__default.MyFunction#canCall(LitInt(x#0))
...
procedure {:verboseName "QualifiedNames.R (well-formedness)"} CheckWellformed$$QualifiedNames.__default.R(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QualifiedNames.R (well-formedness)"} CheckWellformed$$QualifiedNames.__default.R(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var u#Z#0: int;
  var let#0#0#0: int;
  ...
  var ##x#0: int;
    ...
    else
    {
        // Check well-formedness of body and result subset type constraint
        havoc u#Z#0;
        assume {:id "id19"} let#0#0#0 == x#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, TInt);
        assume {:id "id20"} u#Z#0 == let#0#0#0;
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/PrecedenceLinter.dfy(556,22)
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        x##0 := x#0;
        call {:id "id21"} Call$$MyModule.__default.Lemma(x##0);
        // TrCallStmt: After ProcessCallStmt
        ##x#0 := x#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assume MyModule.__default.MyFunction#canCall(x#0);
        assume {:id "id22"} QualifiedNames.__default.R(x#0) == (x#0 == MyModule.__default.MyFunction(x#0));
        assume MyModule.__default.MyFunction#canCall(x#0);
        // CheckWellformedWithResult: any expression
        assume $Is(QualifiedNames.__default.R(x#0), TBool);
        return;
...
procedure {:verboseName "MyModule.Lemma (well-formedness)"} CheckWellFormed$$MyModule.__default.Lemma(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "MyModule.Lemma (call)"} Call$$MyModule.__default.Lemma(x#0: int);
  modifies $Heap;
  // frame condition
