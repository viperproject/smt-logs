...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon10_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (exists ((|$as#x0_0#0_0| T@U) )  (and ($IsBox |$as#x0_0#0_0| _module._default.MultisetsST0$Y) (and (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0) (or (or (not (= |$as#x0_0#0_0| |y#0|)) (not true)) (<= (LitInt 2) (|MultiSet#Multiplicity| |s#0@0| |y#0|))))))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) )  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.MultisetsST0$Y) (and (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0) (or (or (not (= |$as#x0_0#0_0@@0| |y#0|)) (not true)) (<= (LitInt 2) (|MultiSet#Multiplicity| |s#0@0| |y#0|)))))) (=> (=> true (and ($IsBox |x#0_0@1| _module._default.MultisetsST0$Y) ($IsAllocBox |x#0_0@1| _module._default.MultisetsST0$Y $Heap))) (=> (and (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0) (or (or (not (= |x#0_0@1| |y#0|)) (not true)) (<= (LitInt 2) (|MultiSet#Multiplicity| |s#0@0| |y#0|)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) true) (=> (= |s#0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|))))))))))))
