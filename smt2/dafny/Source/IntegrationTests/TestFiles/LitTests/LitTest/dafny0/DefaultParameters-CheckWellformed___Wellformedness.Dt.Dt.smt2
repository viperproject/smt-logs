...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@88  (=> (and (= $generated@@80 ($generated@@24 $generated@@81 $generated@@82 $generated@@83 false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@84 0)) (not true)))))
