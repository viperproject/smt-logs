...
(assert (distinct alloc Tagclass._System.array? Tagclass._System.array Tagclass._module.Six tytagFamily$array tytagFamily$Six)
)
...
(set-info :boogie-vc-id Impl$$_module.__default.QCaller)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (<= (LitInt 6) |s#0@0|) (= |y##0@0| (LitInt 217))) (=> (and (and ($Is refType |call3formal@a#0| (Tclass._System.array Tclass._module.Six)) ($IsAlloc refType |call3formal@a#0| (Tclass._System.array Tclass._module.Six) $Heap)) (= (ControlFlow 0 2) (- 0 1))) (<= (LitInt 100) |y##0@0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (<= (LitInt 6) |s#0|) true)) (and (and ($Is refType |a#0| (Tclass._System.array Tclass._module.Six)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._module.Six) $Heap)) true)) (and (and (and ($Is refType |b#0| (Tclass._System.array Tclass._module.Six)) ($IsAlloc refType |b#0| (Tclass._System.array Tclass._module.Six) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
