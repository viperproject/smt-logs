...
)))) (and (and (forall ((|t#3_2@@0| Int) (|u#3_2@@0| Int) )  (=> (and (and (|Seq#Contains| |sq#0@0| ($Box intType (int_2_U |t#3_2@@0|))) (< |t#3_2@@0| 4)) (and (<= (LitInt 10) |u#3_2@@0|) (< |u#3_2@@0| (+ 10 |t#3_2@@0|)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $nw@0) (IndexField |u#3_2@@0|)) ($Box intType (int_2_U (+ 6000 |t#3_2@@0|)))))) (= |k#0@0| (LitInt 0))) (and (= |$decr_init$loop#00@0| (- 180 |k#0@0|)) (= (ControlFlow 0 20) 19)))) anon40_LoopHead_correct)))
