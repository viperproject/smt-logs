...
// function declaration for B._default.F
function B.__default.F(x#0: int) : int
uses {
// consequence axiom for B.__default.F
axiom 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    { B.__default.F(x#0) } 
    B.__default.F#canCall(x#0) || 0 < $FunctionContextHeight
       ==> B.__default.F(x#0) == x#0);
// definition axiom for B.__default.F (revealed)
axiom {:id "id109"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    { B.__default.F(x#0) } 
    B.__default.F#canCall(x#0) || 0 < $FunctionContextHeight
       ==> B.__default.F(x#0) == x#0);
// definition axiom for B.__default.F for all literals (revealed)
axiom {:id "id110"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    {:weight 3} { B.__default.F(LitInt(x#0)) } 
    B.__default.F#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
       ==> B.__default.F(LitInt(x#0)) == LitInt(x#0));
}

function B.__default.F#canCall(x#0: int) : bool;

function B.__default.F#requires(int) : bool;

// #requires axiom for B.__default.F
axiom (forall x#0: int :: 
  { B.__default.F#requires(x#0) } 
  B.__default.F#requires(x#0) == true);

procedure {:verboseName "B.F (well-formedness)"} CheckWellformed$$B.__default.F(x#0: int) returns (r#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  ensures {:id "id111"} r#0 == x#0;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "B.F (well-formedness)"} CheckWellformed$$B.__default.F(x#0: int) returns (r#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assume {:id "id112"} r#0 == x#0;
        assume false;
    }
    else
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id113"} B.__default.F(x#0) == x#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(B.__default.F(x#0), TInt);
        assume {:id "id114"} B.__default.F(x#0) == r#0;
        return;
...
procedure {:verboseName "B.M (well-formedness)"} CheckWellFormed$$B.__default.M(x#0: int) returns (r#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "B.M (call)"} Call$$B.__default.M(x#0: int) returns (r#0: int);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id116"} r#0 == x#0;
...
procedure {:verboseName "B.M (correctness)"} Impl$$B.__default.M(x#0: int) returns (r#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id117"} r#0 == x#0;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "B.M (correctness)"} Impl$$B.__default.M(x#0: int) returns (r#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: M, Impl$$B.__default.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(85,41)
    assume true;
    assume true;
    r#0 := x#0;
}
...
// function declaration for B._default.F'
function B.__default.F_k(x#0: int) : int
uses {
// definition axiom for B.__default.F_k (revealed)
axiom {:id "id119"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    { B.__default.F_k(x#0) } 
    B.__default.F_k#canCall(x#0) || 0 < $FunctionContextHeight
       ==> B.__default.F_k(x#0) == x#0);
// definition axiom for B.__default.F_k for all literals (revealed)
axiom {:id "id120"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    {:weight 3} { B.__default.F_k(LitInt(x#0)) } 
    B.__default.F_k#canCall(LitInt(x#0)) || 0 < $FunctionContextHeight
       ==> B.__default.F_k(LitInt(x#0)) == LitInt(x#0));
}

function B.__default.F_k#canCall(x#0: int) : bool;

function B.__default.F_k#requires(int) : bool;

// #requires axiom for B.__default.F_k
axiom (forall x#0: int :: 
  { B.__default.F_k#requires(x#0) } 
  B.__default.F_k#requires(x#0) == true);

procedure {:verboseName "B.F' (well-formedness)"} CheckWellformed$$B.__default.F_k(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "B.M' (well-formedness)"} CheckWellFormed$$B.__default.M_k(x#0: int) returns (r#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "B.M' (call)"} Call$$B.__default.M_k(x#0: int) returns (r#0: int);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id123"} r#0 == x#0;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
procedure {:verboseName "B.M' (correctness)"} Impl$$B.__default.M_k(x#0: int) returns (r#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id124"} r#0 == x#0;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "B.M' (correctness)"} Impl$$B.__default.M_k(x#0: int) returns (r#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: M', Impl$$B.__default.M_k
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(88,62)
    assume true;
    assume true;
    r#0 := x#0;
}
...
procedure {:verboseName "B.Lemma1 (well-formedness)"} CheckWellFormed$$B.__default.Lemma1();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "B.Lemma1 (call)"} Call$$B.__default.Lemma1();
  modifies $Heap;
  // user-defined postconditions
  free ensures B.__default.F#canCall(LitInt(5));
  ensures {:id "id127"} LitInt(B.__default.F(LitInt(5))) == LitInt(6);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "B.Lemma1 (correctness)"} Impl$$B.__default.Lemma1() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures B.__default.F#canCall(LitInt(5));
  ensures {:id "id128"} LitInt(B.__default.F(LitInt(5))) == LitInt(6);
  // frame condition
  free ensures old($Heap) == $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "B.Lemma1 (correctness)"} Impl$$B.__default.Lemma1() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Lemma1, Impl$$B.__default.Lemma1
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
}
...
procedure {:verboseName "B.TestLemmas (well-formedness)"} CheckWellFormed$$B.__default.TestLemmas();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "B.TestLemmas (call)"} Call$$B.__default.TestLemmas();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "B.TestLemmas (correctness)"} Impl$$B.__default.TestLemmas() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "B.TestLemmas (correctness)"} Impl$$B.__default.TestLemmas() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var y#0: int;
  var ##x#0: int;
  ...
  var ##x#1_1_1_1_0: int;
  var r#1_1_1_1_0: int;
  var $rhs##1_1_1_1_0: int;
  var x##1_1_1_1_0: int;

    // AddMethodImpl: TestLemmas, Impl$$B.__default.TestLemmas
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(96,11)
    assume true;
    ##x#0 := LitInt(5);
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assume B.__default.F#canCall(LitInt(5));
    assume B.__default.F#canCall(LitInt(5));
    y#0 := LitInt(B.__default.F(LitInt(5)));
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(97,5)
    if (*)
    {
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(98,13)
        // TrCallStmt: Before ProcessCallStmt
        call {:id "id130"} Call$$B.__default.Lemma0();
        // TrCallStmt: After ProcessCallStmt
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(99,7)
        assume true;
        assert {:id "id131"} y#0 == LitInt(5);
    }
    else
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(100,12)
        if (*)
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(101,13)
            // TrCallStmt: Before ProcessCallStmt
            call {:id "id132"} Call$$B.__default.Lemma0();
            // TrCallStmt: After ProcessCallStmt
            // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(102,7)
            assume true;
            assert {:id "id133"} y#0 == LitInt(6);
        }
        else
        {
            // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(103,12)
            if (*)
            {
                // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(104,13)
                // TrCallStmt: Before ProcessCallStmt
                call {:id "id134"} Call$$B.__default.Lemma1();
                // TrCallStmt: After ProcessCallStmt
                // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(105,7)
                ##x#1_1_0_0 := LitInt(5);
                // assume allocatedness for argument to function
                assume $IsAlloc(##x#1_1_0_0, TInt, $Heap);
                assume B.__default.F#canCall(LitInt(5));
                if (LitInt(B.__default.F(LitInt(5))) == LitInt(5))
                {
                    ##x#1_1_0_1 := LitInt(5);
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##x#1_1_0_1, TInt, $Heap);
                    assume B.__default.F#canCall(LitInt(5));
                }

                assume B.__default.F#canCall(LitInt(5))
                   && (LitInt(B.__default.F(LitInt(5))) == LitInt(5)
                     ==> B.__default.F#canCall(LitInt(5)));
                assert {:id "id135"} {:subsumption 0} LitInt(B.__default.F(LitInt(5))) == LitInt(5);
                assert {:id "id136"} {:subsumption 0} LitInt(B.__default.F(LitInt(5))) == LitInt(6);
                assume {:id "id137"} LitInt(B.__default.F(LitInt(5))) == LitInt(5)
                   && LitInt(B.__default.F(LitInt(5))) == LitInt(6);
            }
            else
            {
                // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(106,12)
                if (*)
                {
                    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(107,7)
                    ##x#1_1_1_0_0 := LitInt(5);
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##x#1_1_1_0_0, TInt, $Heap);
                    assume B.__default.F#canCall(LitInt(5));
                    assume B.__default.F#canCall(LitInt(5));
                    assert {:id "id138"} LitInt(B.__default.F(LitInt(5))) == LitInt(5);
                    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(108,17)
                    assume true;
                    // TrCallStmt: Adding lhs with type int
                    // TrCallStmt: Before ProcessCallStmt
                    // ProcessCallStmt: CheckSubrange
                    x##1_1_1_0_0 := LitInt(5);
                    call {:id "id139"} $rhs##1_1_1_0_0 := Call$$B.__default.M(x##1_1_1_0_0);
                    // TrCallStmt: After ProcessCallStmt
                    r#1_1_1_0_0 := $rhs##1_1_1_0_0;
                    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(109,7)
                    assume true;
                    assert {:id "id141"} r#1_1_1_0_0 == LitInt(5);
                    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(110,7)
                    assume true;
                    assert {:id "id142"} r#1_1_1_0_0 == LitInt(7);
                }
                else
                {
                    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(112,7)
                    ##x#1_1_1_1_0 := LitInt(6);
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##x#1_1_1_1_0, TInt, $Heap);
                    assume B.__default.F_k#canCall(LitInt(6));
                    assume B.__default.F_k#canCall(LitInt(6));
                    assert {:id "id143"} LitInt(B.__default.F_k(LitInt(6))) == LitInt(6);
                    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(113,18)
                    assume true;
                    // TrCallStmt: Adding lhs with type int
                    // TrCallStmt: Before ProcessCallStmt
                    // ProcessCallStmt: CheckSubrange
                    x##1_1_1_1_0 := LitInt(6);
                    call {:id "id144"} $rhs##1_1_1_1_0 := Call$$B.__default.M_k(x##1_1_1_1_0);
                    // TrCallStmt: After ProcessCallStmt
                    r#1_1_1_1_0 := $rhs##1_1_1_1_0;
                    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(114,7)
                    assume true;
                    assert {:id "id146"} r#1_1_1_1_0 == LitInt(6);
                }
            }
        }
    }
...
procedure {:verboseName "B.Lemma0 (well-formedness)"} CheckWellFormed$$B.__default.Lemma0();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "B.Lemma0 (call)"} Call$$B.__default.Lemma0();
  modifies $Heap;
  // user-defined postconditions
  free ensures B.__default.F#canCall(LitInt(5));
  ensures {:id "id148"} LitInt(B.__default.F(LitInt(5))) == LitInt(5);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "B.Lemma0 (correctness)"} Impl$$B.__default.Lemma0() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // user-defined postconditions
  free ensures B.__default.F#canCall(LitInt(5));
  ensures {:id "id149"} $_reverifyPost ==> LitInt(B.__default.F(LitInt(5))) == LitInt(5);
  // frame condition
  free ensures old($Heap) == $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "B.Lemma0 (correctness)"} Impl$$B.__default.Lemma0() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;

    // AddMethodImpl: Lemma0, Impl$$B.__default.Lemma0
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
}
