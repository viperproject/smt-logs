...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@128  (=> (= $generated@@121 ($generated@@83 $generated@@22 $generated@@122 $generated false)) (=> (and (or (not (= $generated@@123 0)) (not true)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@123 0)) (not true))))))
(let (($generated@@129  (=> (and ($generated@@124 $generated@@122) ($generated@@125 $generated@@122)) (=> (and (and (or (not (= $generated@@126 $generated@@22)) (not true)) (and ($generated@@19 $generated@@20 $generated@@126 $generated@@26) ($generated@@25 $generated@@20 $generated@@126 $generated@@26 $generated@@122))) (and (= 0 $generated@@127) (= (ControlFlow 0 3) 2))) $generated@@128))))
$generated@@129)))
))
(check-sat)
(get-info :rlimit)
