...
(set-info :boogie-vc-id CheckWellFormed$$_module.StatementTwoShoes.T)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= |a#0| 0)) (not true)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |a#0| 0)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.StatementTwoShoes) ($IsAlloc refType this Tclass._module.StatementTwoShoes $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
