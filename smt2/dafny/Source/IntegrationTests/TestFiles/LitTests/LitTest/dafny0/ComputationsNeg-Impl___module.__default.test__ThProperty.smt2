...
(set-info :boogie-vc-id Impl$$_module.__default.test__ThProperty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.ThProperty#canCall| (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.ThProperty ($LS $LZ) (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))))))) (U_2_bool (Lit boolType (bool_2_U true))))))) (=> (=> (|_module.__default.ThProperty#canCall| (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.ThProperty ($LS $LZ) (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))))))) (U_2_bool (Lit boolType (bool_2_U true)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.ThProperty#canCall| (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.ThProperty ($LS $LZ) (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|)))))))) (U_2_bool (Lit boolType (bool_2_U (> 10 0)))))))) (=> (=> (|_module.__default.ThProperty#canCall| (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.ThProperty ($LS $LZ) (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|)))))))) (U_2_bool (Lit boolType (bool_2_U (> 10 0))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.ThProperty#canCall| (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.ThProperty ($LS $LZ) (LitInt 10) (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|))) (LitInt 0))))) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Nat.Zero_q (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|)))))))) (let ((|o#2@@0| (Lit DatatypeTypeType (_module.Nat.tail (Lit DatatypeTypeType (|#_module.Nat.Succ| (Lit DatatypeTypeType |#_module.Nat.Zero|)))))))
(exists ((|ro#2@@0| Int) (|ss#2@@0| Int) ) (!  (and (and (<= (LitInt 0) |ro#2@@0|) (<= (LitInt 0) |ss#2@@0|)) (and (= |ss#2@@0| (LitInt (- 10 1))) (_module.__default.ThProperty ($LS $LZ) |ss#2@@0| |o#2@@0| |ro#2@@0|)))
 :qid |ComputationsNegdfy.19:36|
 :skolemid |562|
 :pattern ( (_module.__default.ThProperty ($LS $LZ) |ss#2@@0| |o#2@@0| |ro#2@@0|))
))))))))))))))
