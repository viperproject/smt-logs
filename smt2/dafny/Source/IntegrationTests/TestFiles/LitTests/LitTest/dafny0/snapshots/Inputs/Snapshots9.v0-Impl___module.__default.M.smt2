...
(declare-fun |ok#0@2| () Bool)
(declare-fun |ok#0@1| () Bool)
(declare-fun |ok#0@0| () Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) |ok#0@2|)))
(let ((anon3_Else_correct  (=> (= |ok#0@1| (U_2_bool (Lit boolType (bool_2_U true)))) (=> (and (= |ok#0@2| |ok#0@1|) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (= |ok#0@0| (U_2_bool (Lit boolType (bool_2_U false)))) (=> (and (= |ok#0@2| |ok#0@0|) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct))))
