...
const unique class.TrickyProvides0_mBBB.__default: ClassName;
...
axiom 1 <= $FunctionContextHeight
   ==> 
  TrickyProvides0_mBBB.__default.Empty#canCall() || 1 < $FunctionContextHeight
   ==> (var u#0 := TrickyProvides0_mBBB.__default.Empty(); Lit(true))
     && $IsBox(TrickyProvides0_mBBB.__default.Empty(), Tclass.TrickyProvides0_mCCC.W());
// alloc consequence axiom for TrickyProvides0_mBBB.__default.Empty
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap :: 
    { $IsAllocBox(TrickyProvides0_mBBB.__default.Empty(), Tclass.TrickyProvides0_mCCC.W(), $Heap) } 
    (TrickyProvides0_mBBB.__default.Empty#canCall() || 1 < $FunctionContextHeight)
         && $IsGoodHeap($Heap)
       ==> $IsAllocBox(TrickyProvides0_mBBB.__default.Empty(), Tclass.TrickyProvides0_mCCC.W(), $Heap));
}
...
procedure {:verboseName "TrickyProvides0.BBB.Empty (well-formedness)"} CheckWellformed$$TrickyProvides0_mBBB.__default.Empty();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  ensures {:id "id285"} (var u#1 := TrickyProvides0_mBBB.__default.Empty(); Lit(true));



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TrickyProvides0.BBB.Empty (well-formedness)"} CheckWellformed$$TrickyProvides0_mBBB.__default.Empty()
{
  ...
  var let#0#0#0: Box;
    ...
    if (*)
    {
        ...
        assume $IsBox(TrickyProvides0_mBBB.__default.Empty(), Tclass.TrickyProvides0_mCCC.W());
        havoc u#Z#0;
        assert {:id "id286"} Lit(true);
        assume Lit(true) || TrickyProvides0_mBBB.__default.Empty#canCall();
        assume {:id "id287"} let#0#0#0 == TrickyProvides0_mBBB.__default.Empty();
        assume TrickyProvides0_mBBB.__default.Empty#canCall();
        // CheckWellformedWithResult: any expression
        assume $IsBox(let#0#0#0, Tclass.TrickyProvides0_mCCC.W());
        assume {:id "id288"} u#Z#0 == let#0#0#0;
        assume {:id "id289"} (var u#1 := TrickyProvides0_mBBB.__default.Empty(); Lit(true));
        assume false;
    }
    else
    {
