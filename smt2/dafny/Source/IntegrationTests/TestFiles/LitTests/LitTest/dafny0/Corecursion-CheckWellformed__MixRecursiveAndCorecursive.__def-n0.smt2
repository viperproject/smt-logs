...
(declare-fun MixRecursiveAndCorecursive.__default.F (T@U Int) T@U)
(declare-fun $LS (T@U) T@U)
(declare-fun |MixRecursiveAndCorecursive.__default.F#canCall| (Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|MixRecursiveAndCorecursive.__default.F#canCall| |n#0|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0|))) (and (and (=> (= |n#0| (LitInt 0)) (|MixRecursiveAndCorecursive.__default.F#canCall| (LitInt 5))) (=> (or (not (= |n#0| (LitInt 0))) (not true)) (and (|MixRecursiveAndCorecursive.__default.F#canCall| (- |n#0| 1)) (MixRecursiveAndCorecursive.Stream.Cons_q (MixRecursiveAndCorecursive.__default.F $ly (- |n#0| 1)))))) (= (MixRecursiveAndCorecursive.__default.F ($LS $ly) |n#0|) (ite (= |n#0| (LitInt 0)) (|#MixRecursiveAndCorecursive.Stream.Cons| ($Box intType (int_2_U (LitInt 0))) (Lit DatatypeTypeType (MixRecursiveAndCorecursive.__default.F $ly (LitInt 5)))) (MixRecursiveAndCorecursive.Stream.tail (MixRecursiveAndCorecursive.__default.F $ly (- |n#0| 1)))))))
 :qid |Corecursiondfy.90:18|
 :skolemid |2290|
 :pattern ( (MixRecursiveAndCorecursive.__default.F ($LS $ly) |n#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|MixRecursiveAndCorecursive.__default.F#canCall| |n#0@@0|) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@0|))) ($Is DatatypeTypeType (MixRecursiveAndCorecursive.__default.F $ly@@0 |n#0@@0|) (Tclass.MixRecursiveAndCorecursive.Stream TInt)))
 :qid |Corecursiondfy.90:18|
 :skolemid |2288|
 :pattern ( (MixRecursiveAndCorecursive.__default.F $ly@@0 |n#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (! (= (MixRecursiveAndCorecursive.__default.F ($LS $ly@@1) |n#0@@1|) (MixRecursiveAndCorecursive.__default.F $ly@@1 |n#0@@1|))
 :qid |Corecursiondfy.90:18|
 :skolemid |2283|
 :pattern ( (MixRecursiveAndCorecursive.__default.F ($LS $ly@@1) |n#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|MixRecursiveAndCorecursive.__default.F#canCall| (LitInt |n#0@@2|)) (and (< 1 $FunctionContextHeight) (<= (LitInt 0) |n#0@@2|))) (and (and (=> (= (LitInt |n#0@@2|) (LitInt 0)) (|MixRecursiveAndCorecursive.__default.F#canCall| (LitInt 5))) (=> (or (not (= (LitInt |n#0@@2|) (LitInt 0))) (not true)) (and (|MixRecursiveAndCorecursive.__default.F#canCall| (LitInt (- |n#0@@2| 1))) (MixRecursiveAndCorecursive.Stream.Cons_q (Lit DatatypeTypeType (MixRecursiveAndCorecursive.__default.F ($LS $ly@@2) (LitInt (- |n#0@@2| 1)))))))) (= (MixRecursiveAndCorecursive.__default.F ($LS $ly@@2) (LitInt |n#0@@2|)) (ite (= (LitInt |n#0@@2|) (LitInt 0)) (|#MixRecursiveAndCorecursive.Stream.Cons| ($Box intType (int_2_U (LitInt 0))) (Lit DatatypeTypeType (MixRecursiveAndCorecursive.__default.F ($LS $ly@@2) (LitInt 5)))) (MixRecursiveAndCorecursive.Stream.tail (Lit DatatypeTypeType (MixRecursiveAndCorecursive.__default.F ($LS $ly@@2) (LitInt (- |n#0@@2| 1)))))))))
 :qid |Corecursiondfy.90:18|
 :weight 3
 :skolemid |2291|
 :pattern ( (MixRecursiveAndCorecursive.__default.F ($LS $ly@@2) (LitInt |n#0@@2|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$MixRecursiveAndCorecursive.__default.F)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (or (not (= |n#0@@3| (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 9)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (and (= |##n#1@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#1@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (<= 0 |n#0@@3|) (= |##n#1@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#1@0| |n#0@@3|)) (=> (= (ControlFlow 0 7) (- 0 6)) (< |##n#1@0| |n#0@@3|))))))))))
(let ((anon8_Then_correct  (=> (= |n#0@@3| (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($Is intType (int_2_U (LitInt 5)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 5)) Tclass._System.nat) (=> (and (= |##n#0@0| (LitInt 5)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (=> (= (ControlFlow 0 3) (- 0 2)) (< |##n#0@0| |n#0@@3|))))))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 10) 1) anon7_Then_correct) (=> (= (ControlFlow 0 10) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 7) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0@@3|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 10))) anon0_correct)))
