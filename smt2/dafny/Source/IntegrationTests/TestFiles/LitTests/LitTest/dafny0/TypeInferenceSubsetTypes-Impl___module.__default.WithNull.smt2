...
(set-info :boogie-vc-id Impl$$_module.__default.WithNull)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon9_Else_correct  (=> (or (not (= |i#0@0| |i#0#hi@0|)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |c#0@0| null)) (not true))) (=> (or (not (= |c#0@0| null)) (not true)) (=> (and (= |s#0@2| (+ |s#0@1| (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@0|) _module.Cell.data))))) (= (ControlFlow 0 5) (- 0 4))) true))))))
...
))) (and ($HeapSucc $Heap $Heap@0) (= |s#0@0| (LitInt 0))))) (and (=> (= (ControlFlow 0 10) (- 0 12)) true) (=> (and (= |i#0#lo@0| (LitInt 0)) (= |i#0#hi@0| (LitInt 3))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= |i#0#lo@0| |i#0#hi@0|)) (=> (<= |i#0#lo@0| |i#0#hi@0|) (=> (= (ControlFlow 0 10) 9) anon7_LoopHead_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#cc#0| (and ($Is refType |cc#0| Tclass._module.Cell) ($IsAlloc refType |cc#0| Tclass._module.Cell $Heap))) true)) (=> (and (and (and ($Is refType |c#0@@1| Tclass._module.Cell?) ($IsAlloc refType |c#0@@1| Tclass._module.Cell? $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 13) 10))) anon0_correct))))
