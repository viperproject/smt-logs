...
(set-info :boogie-vc-id Impl$$TestModule4.__default.test2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (and (= (AsFuelBottom StartFuel_TestModule4._default.pos) StartFuel_TestModule4._default.pos) (= (AsFuelBottom StartFuelAssert_TestModule4._default.pos) StartFuelAssert_TestModule4._default.pos)) (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc intType (int_2_U |z#0|) TInt $Heap)) (and (|TestModule4.__default.pos#canCall| |z#0|) (|TestModule4.__default.pos#canCall| |z#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (TestModule4.__default.pos StartFuelAssert_TestModule4._default.pos |z#0|) (LitInt 0))) (=> (= (TestModule4.__default.pos StartFuel_TestModule4._default.pos |z#0|) (LitInt 0)) (=> (and (and (= |##x#1@0| (LitInt (- 0 1))) ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap)) (and (|TestModule4.__default.pos#canCall| (LitInt (- 0 1))) (|TestModule4.__default.pos#canCall| (LitInt (- 0 1))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (LitInt (TestModule4.__default.pos StartFuelAssert_TestModule4._default.pos (LitInt (- 0 1)))) (LitInt 0))) (=> (and (= (LitInt (TestModule4.__default.pos StartFuel_TestModule4._default.pos (LitInt (- 0 1)))) (LitInt 0)) ($IsAlloc intType (int_2_U |y#0|) TInt $Heap)) (=> (and (and (and (|TestModule4.__default.pos#canCall| |y#0|) (= |##x#3@0| (- |y#0| 3))) (and ($IsAlloc intType (int_2_U |##x#3@0|) TInt $Heap) (|TestModule4.__default.pos#canCall| (- |y#0| 3)))) (and (and (|TestModule4.__default.pos#canCall| |y#0|) (|TestModule4.__default.pos#canCall| (- |y#0| 3))) (= (ControlFlow 0 2) (- 0 1)))) (= (TestModule4.__default.pos StartFuelAssert_TestModule4._default.pos |y#0|) (+ 3 (TestModule4.__default.pos StartFuelAssert_TestModule4._default.pos (- |y#0| 3))))))))))))))
