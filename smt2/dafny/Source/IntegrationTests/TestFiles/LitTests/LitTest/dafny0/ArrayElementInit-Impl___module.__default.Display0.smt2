...
(declare-fun _module._default.Display0$D () T@U)
(declare-fun |d#0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Display0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 19)) (<= 0 (LitInt 4))) (=> (<= 0 (LitInt 4)) (and (=> (= (ControlFlow 0 2) (- 0 18)) (= (LitInt 4) 4)) (=> (= (LitInt 4) 4) (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass._System.nat))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 4)))) (and (=> (= (ControlFlow 0 2) (- 0 17)) ($Is intType (int_2_U (LitInt 100)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 100)) Tclass._System.nat) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) (IndexField 0)))) (LitInt 100)) (and (=> (= (ControlFlow 0 2) (- 0 16)) ($Is intType (int_2_U (LitInt 75)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 75)) Tclass._System.nat) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) (IndexField 1)))) (LitInt 75)) (and (=> (= (ControlFlow 0 2) (- 0 15)) ($Is intType (int_2_U (LitInt 50)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 50)) Tclass._System.nat) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) (IndexField 2)))) (LitInt 50)) (and (=> (= (ControlFlow 0 2) (- 0 14)) ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat) (=> (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) (IndexField 3)))) (LitInt 25)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (<= 0 (LitInt 4))) (=> (<= 0 (LitInt 4)) (and (=> (= (ControlFlow 0 2) (- 0 12)) (= (LitInt 4) 4)) (=> (= (LitInt 4) 4) (=> (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? Tclass._System.nat))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc)))) (= (_System.array.Length $nw@1) (LitInt 4)))) (and (=> (= (ControlFlow 0 2) (- 0 11)) ($Is intType (int_2_U (LitInt 100)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 100)) Tclass._System.nat) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) (IndexField 0)))) (LitInt 100)) (and (=> (= (ControlFlow 0 2) (- 0 10)) ($Is intType (int_2_U (LitInt 75)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 75)) Tclass._System.nat) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) (IndexField 1)))) (LitInt 75)) (and (=> (= (ControlFlow 0 2) (- 0 9)) ($Is intType (int_2_U |n#0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |n#0|) Tclass._System.nat) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) (IndexField 2)))) |n#0|) (and (=> (= (ControlFlow 0 2) (- 0 8)) ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 25)) Tclass._System.nat) (=> (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) (IndexField 3)))) (LitInt 25)) (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (= (LitInt 2) 2)) (=> (= (LitInt 2) 2) (=> (and (and (and (and (or (not (= $nw@2 null)) (not true)) ($Is refType $nw@2 (Tclass._System.array? _module._default.Display0$D))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) alloc))))) (and (= (_System.array.Length $nw@2) (LitInt 2)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) (IndexField 0)) |d#0|))) (and (and (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) (IndexField 1)) |d#0|) (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (<= 0 (LitInt 0))) (=> (<= 0 (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (LitInt 0) 0)) (=> (= (LitInt 0) 0) (=> (and (and (and (or (not (= $nw@3 null)) (not true)) ($Is refType $nw@3 (Tclass._System.array? TChar))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3) alloc))))) (and (and (= (_System.array.Length $nw@3) (LitInt 0)) (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@3) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 3))) (=> (<= 0 (LitInt 3)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (LitInt 3) 4)))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |d#0| _module._default.Display0$D) ($IsAllocBox |d#0| _module._default.Display0$D $Heap))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._System.nat) $Heap)) true) (and (and ($Is refType |b#0| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |b#0| (Tclass._System.array Tclass._System.nat) $Heap)) true)) (=> (and (and (and (and ($Is refType |c#0@@1| (Tclass._System.array _module._default.Display0$D)) ($IsAlloc refType |c#0@@1| (Tclass._System.array _module._default.Display0$D) $Heap)) true) (and (and ($Is refType |d#1| (Tclass._System.array TChar)) ($IsAlloc refType |d#1| (Tclass._System.array TChar) $Heap)) true)) (and (and (and ($Is refType |e#0| (Tclass._System.array TReal)) ($IsAlloc refType |e#0| (Tclass._System.array TReal) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 20) 2)))) anon0_correct)))))
