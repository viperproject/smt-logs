...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (Lit DatatypeTypeType (|#TerminationCheck_tricky.S.S| (LitInt (- 0 3)))))) (and (TerminationCheck__tricky.S.S_q |s#0@0|) (TerminationCheck__tricky.S.S_q |s#0@0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (TerminationCheck__tricky.S.x |s#0@0|) (LitInt (- 0 3)))) (=> (= (TerminationCheck__tricky.S.x |s#0@0|) (LitInt (- 0 3))) (=> ($IsAlloc DatatypeTypeType |s#0@0| Tclass.TerminationCheck__tricky.S $Heap) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (=> (|TerminationCheck__tricky.__default.Id#canCall| |s#0@0|) (=> (and (and (TerminationCheck__tricky.S.S_q (TerminationCheck__tricky.__default.Id ($LS $LZ) |s#0@0|)) (TerminationCheck__tricky.S.S_q (TerminationCheck__tricky.__default.Id ($LS $LZ) |s#0@0|))) (and (|TerminationCheck__tricky.__default.Id#canCall| |s#0@0|) (TerminationCheck__tricky.S.S_q (TerminationCheck__tricky.__default.Id ($LS $LZ) |s#0@0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (TerminationCheck__tricky.S.x (TerminationCheck__tricky.__default.Id ($LS ($LS $LZ)) |s#0@0|)))) (=> (and (<= (LitInt 0) (TerminationCheck__tricky.S.x (TerminationCheck__tricky.__default.Id ($LS $LZ) |s#0@0|))) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U false))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |s#0@@3| Tclass.TerminationCheck__tricky.S) ($IsAlloc DatatypeTypeType |s#0@@3| Tclass.TerminationCheck__tricky.S $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
