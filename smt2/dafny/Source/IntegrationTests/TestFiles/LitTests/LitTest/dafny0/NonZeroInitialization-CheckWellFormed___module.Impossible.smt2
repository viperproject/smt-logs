...
(set-info :boogie-vc-id CheckWellFormed$$_module.Impossible)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (= |newtype$check#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 6) |newtype$check#0@0|)) (=> (<= (LitInt 6) |newtype$check#0@0|) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U (< 0 2))))))))))
