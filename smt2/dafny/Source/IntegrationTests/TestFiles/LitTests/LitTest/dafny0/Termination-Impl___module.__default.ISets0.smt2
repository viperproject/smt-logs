...
(declare-fun _module._default.ISets0$_T0 () T@U)
(declare-fun |S#0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.ISets0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.ISets0$_T0) (U_2_bool (MapType0Select BoxType boolType |S#0| |$as#x0_0#0_0|)))
 :qid |Terminationdfy.715:9|
 :skolemid |3189|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.ISets0$_T0) (U_2_bool (MapType0Select BoxType boolType |S#0| |$as#x0_0#0_0@@0|)))
 :qid |Terminationdfy.715:9|
 :skolemid |3189|
)) (=> (and (=> true (and ($IsBox |x#0_0@0| _module._default.ISets0$_T0) ($IsAllocBox |x#0_0@0| _module._default.ISets0$_T0 $Heap))) (U_2_bool (MapType0Select BoxType boolType |S#0| |x#0_0@0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (= |s#0@0| (|ISet#Difference| |S#0| (|ISet#UnionOne| |ISet#Empty| |x#0_0@0|))) (= (ControlFlow 0 5) (- 0 4))) false)))))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |x#0_1@0| _module._default.ISets0$_T0) ($IsAllocBox |x#0_1@0| _module._default.ISets0$_T0 $Heap))) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |x#0_1@0| _module._default.ISets0$_T0) ($IsAllocBox |x#0_1@0| _module._default.ISets0$_T0 $Heap)) (= (ControlFlow 0 8) 5)) anon7_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is (MapType0Type BoxType boolType) |S#0| (TISet _module._default.ISets0$_T0)) ($IsAlloc (MapType0Type BoxType boolType) |S#0| (TISet _module._default.ISets0$_T0) $Heap))) (=> (and (and (and ($Is (MapType0Type BoxType boolType) |s#0| (TISet _module._default.ISets0$_T0)) ($IsAlloc (MapType0Type BoxType boolType) |s#0| (TISet _module._default.ISets0$_T0) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.ISets0$_T0) ($IsAllocBox |x#0_0| _module._default.ISets0$_T0 $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13)))) anon0_correct))))
