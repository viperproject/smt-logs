...
(set-info :boogie-vc-id Impl$$_module.Modifies.F)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon3_correct  (=> (and (|Set#IsMember| |s#0| ($Box refType |m#0_0@0|)) (<= (LitInt 2) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0_0@0|) _module.Modifies.x))))) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= |m#0_0@0| null)) (not true))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |m#0_0@0| _module.Modifies.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |m#0_0@0| _module.Modifies.x)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |m#0_0@0| null)) (not true))) (=> (and ($Is refType |m#0_1@0| Tclass._module.Modifies) ($IsAlloc refType |m#0_1@0| Tclass._module.Modifies $Heap)) (=> (and (and (|Set#IsMember| |s#0| ($Box refType |m#0_1@0|)) (<= (LitInt 2) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0_1@0|) _module.Modifies.x))))) (and (or (not (= |m#0_0@0| |m#0_1@0|)) (not true)) (= (ControlFlow 0 6) (- 0 5)))) (or (or (or (not (= |m#0_0@0| |m#0_1@0|)) (not true)) (or (not (= _module.Modifies.x _module.Modifies.x)) (not true))) (= (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0_0@0|) _module.Modifies.x))) 1) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0_1@0|) _module.Modifies.x))) 1))))))))))))
(let ((anon9_Else_correct  (=> (and (not (|Set#IsMember| |s#0| ($Box refType |m#0_0@0|))) (= (ControlFlow 0 12) 6)) anon3_correct)))
(let ((anon9_Then_correct  (=> (|Set#IsMember| |s#0| ($Box refType |m#0_0@0|)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |m#0_0@0| null)) (not true))) (=> (= (ControlFlow 0 10) 6) anon3_correct)))))
(let ((anon8_Then_correct  (=> (and ($Is refType |m#0_0@0| Tclass._module.Modifies) ($IsAlloc refType |m#0_0@0| Tclass._module.Modifies $Heap)) (and (=> (= (ControlFlow 0 13) 10) anon9_Then_correct) (=> (= (ControlFlow 0 13) 12) anon9_Else_correct)))))
(let ((anon10_Else_correct true))
(let ((anon10_Then_correct  (=> (and (|Set#IsMember| |s#0| ($Box refType this)) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this _module.Modifies.x)))))
(let ((anon8_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) ($HeapSucc $Heap $Heap@0)) (and (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) $f@@0)) (exists ((|m#0_2| T@U) ) (!  (and (and (and ($Is refType |m#0_2| Tclass._module.Modifies) (and (|Set#IsMember| |s#0| ($Box refType |m#0_2|)) (<= (LitInt 2) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0_2|) _module.Modifies.x)))))) (= $o@@4 |m#0_2|)) (= $f@@0 _module.Modifies.x))
 :qid |SmallTestsdfy.150:12|
 :skolemid |3370|
)))
 :qid |SmallTestsdfy.150:5|
 :skolemid |3371|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) $f@@0))
)) (forall ((|m#inv#0_0| T@U) ) (!  (=> (and ($Is refType |m#inv#0_0| Tclass._module.Modifies) (and (or (not (= |m#inv#0_0| null)) (not true)) (and (|Set#IsMember| |s#0| ($Box refType |m#inv#0_0|)) (<= (LitInt 2) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#inv#0_0|) _module.Modifies.x))))))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |m#inv#0_0|) _module.Modifies.x) ($Box intType (int_2_U (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#inv#0_0|) _module.Modifies.x))) 1)))))
 :qid |SmallTestsdfy.150:12|
 :skolemid |3372|
...
)))) (and (=> (= (ControlFlow 0 4) 2) anon10_Then_correct) (=> (= (ControlFlow 0 4) 3) anon10_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#16| null $Heap alloc |s#0|)) (and (=> (= (ControlFlow 0 14) 13) anon8_Then_correct) (=> (= (ControlFlow 0 14) 4) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Modifies) ($IsAlloc refType this Tclass._module.Modifies $Heap)))) (and (and ($Is SetType |s#0| (TSet Tclass._module.Modifies)) ($IsAlloc SetType |s#0| (TSet Tclass._module.Modifies) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 15) 14)))) anon0_correct)))
