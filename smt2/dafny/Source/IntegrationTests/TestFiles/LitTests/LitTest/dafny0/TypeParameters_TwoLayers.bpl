...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, TwoLayers._default.F$U: Ty, w#0: DatatypeType :: 
...
procedure {:verboseName "TwoLayers.F (well-formedness)"} CheckWellformed$$TwoLayers.__default.F(TwoLayers._default.F$U: Ty, 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, TwoLayers._default.G$U: Ty, w#0: DatatypeType :: 
...
procedure {:verboseName "TwoLayers.G (well-formedness)"} CheckWellformed$$TwoLayers.__default.G(TwoLayers._default.G$U: Ty, 
...
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, TwoLayers._default.H$U: Ty, w#0: DatatypeType :: 
...
procedure {:verboseName "TwoLayers.H (well-formedness)"} CheckWellformed$$TwoLayers.__default.H(TwoLayers._default.H$U: Ty, 
...
axiom (forall a#6#0#0: Box :: 
  ...
  DatatypeCtorId(#OneLayer.wrap.Wrap(a#6#0#0)) == ##OneLayer.wrap.Wrap);
}
...
axiom (forall d: DatatypeType :: 
  { OneLayer.wrap.Wrap_q(d) } 
  OneLayer.wrap.Wrap_q(d)
     ==> (exists a#7#0#0: Box :: d == #OneLayer.wrap.Wrap(a#7#0#0)));

// Constructor $Is
axiom (forall OneLayer.wrap$V: Ty, a#8#0#0: Box :: 
  { $Is(#OneLayer.wrap.Wrap(a#8#0#0), Tclass.OneLayer.wrap(OneLayer.wrap$V)) } 
  $Is(#OneLayer.wrap.Wrap(a#8#0#0), Tclass.OneLayer.wrap(OneLayer.wrap$V))
     <==> $IsBox(a#8#0#0, OneLayer.wrap$V));

// Constructor $IsAlloc
axiom (forall OneLayer.wrap$V: Ty, a#8#0#0: Box, $h: Heap :: 
  { $IsAlloc(#OneLayer.wrap.Wrap(a#8#0#0), Tclass.OneLayer.wrap(OneLayer.wrap$V), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#OneLayer.wrap.Wrap(a#8#0#0), Tclass.OneLayer.wrap(OneLayer.wrap$V), $h)
       <==> $IsAllocBox(a#8#0#0, OneLayer.wrap$V, $h)));
...
axiom (forall a#9#0#0: Box :: 
  { #OneLayer.wrap.Wrap(Lit(a#9#0#0)) } 
  #OneLayer.wrap.Wrap(Lit(a#9#0#0)) == Lit(#OneLayer.wrap.Wrap(a#9#0#0)));

function OneLayer.wrap._h0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#10#0#0: Box :: 
  { #OneLayer.wrap.Wrap(a#10#0#0) } 
  OneLayer.wrap._h0(#OneLayer.wrap.Wrap(a#10#0#0)) == a#10#0#0);

// Inductive rank
axiom (forall a#11#0#0: Box :: 
  { #OneLayer.wrap.Wrap(a#11#0#0) } 
  BoxRank(a#11#0#0) < DtRank(#OneLayer.wrap.Wrap(a#11#0#0)));
