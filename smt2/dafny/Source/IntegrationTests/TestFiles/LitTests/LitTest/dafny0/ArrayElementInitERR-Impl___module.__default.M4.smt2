...
(set-info :boogie-vc-id Impl$$_module.__default.M4)
...
(let ((anon11_Else_correct  (=> (and (not (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 25))) (= (ControlFlow 0 11) 8)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 25)) (= |lambdaResult#0| |d#0|)) (and ($Is charType |lambdaResult#0| TChar) (= (ControlFlow 0 10) 8))) anon6_correct)))
