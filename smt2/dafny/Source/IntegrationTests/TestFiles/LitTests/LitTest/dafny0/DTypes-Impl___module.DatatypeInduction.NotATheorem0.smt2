...
(set-info :boogie-vc-id Impl$$_module.DatatypeInduction.NotATheorem0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon2_correct  (=> (forall ((|t#1| T@U) ) (!  (=> ($Is DatatypeTypeType |t#1| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (|_module.DatatypeInduction.LeafCount#canCall| _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 this@@3 |t#1|))
 :qid |DTypesdfy.121:19|
 :skolemid |2141|
...
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|t#1@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#1@@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (forall ((|t$ih#0#0| T@U) ) (!  (=> ($Is DatatypeTypeType |t$ih#0#0| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (=> (< (DtRank |t$ih#0#0|) (DtRank |t#1@@0|)) (= (Mod (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS $LZ) this@@3 |t$ih#0#0|) (LitInt 2)) (LitInt 1))))
 :qid |DTypesdfy.121:19|
 :skolemid |2142|
...
)))) (= (Mod (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS ($LS $LZ)) this@@3 |t#1@@0|) (LitInt 2)) (LitInt 1)))
 :qid |DTypesdfy.121:19|
 :skolemid |2145|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|t#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#1@@1| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (forall ((|t$ih#0#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |t$ih#0#0@@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (=> (< (DtRank |t$ih#0#0@@0|) (DtRank |t#1@@1|)) (= (Mod (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS $LZ) this@@3 |t$ih#0#0@@0|) (LitInt 2)) (LitInt 1))))
 :qid |DTypesdfy.121:19|
 :skolemid |2142|
...
)))) (= (Mod (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS ($LS $LZ)) this@@3 |t#1@@1|) (LitInt 2)) (LitInt 1)))
 :qid |DTypesdfy.121:19|
 :skolemid |2146|
...
))) (=> (and (forall ((|t#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |t#1@@2| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (= (Mod (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS $LZ) this@@3 |t#1@@2|) (LitInt 2)) (LitInt 1)))
 :qid |DTypesdfy.121:19|
 :skolemid |2148|
...
)) (= (ControlFlow 0 2) (- 0 1))) (= (Mod (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS ($LS $LZ)) this@@3 |tree#0@@3|) (LitInt 2)) (LitInt 1))))))))
(let ((anon3_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |t#0@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) ($IsAlloc DatatypeTypeType |t#0@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13) $Heap))) (= (ControlFlow 0 7) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and (and ($Is DatatypeTypeType |t#0@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) ($IsAlloc DatatypeTypeType |t#0@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13) $Heap)) ($IsAllocBox ($Box refType this@@3) (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@13) $Heap)) (and ($IsAlloc DatatypeTypeType |t#0@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13) $Heap) (|_module.DatatypeInduction.LeafCount#canCall| _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 this@@3 |t#0@0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (LitInt 2) 0)) (not true))) (=> (= (ControlFlow 0 5) 2) anon2_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 5) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($AlwaysAllocated _module.DatatypeInduction$T@@13)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@13)) ($IsAlloc refType this@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@13) $Heap)))) (and (and (and ($Is DatatypeTypeType |tree#0@@3| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) ($IsAlloc DatatypeTypeType |tree#0@@3| (Tclass._module.Tree _module.DatatypeInduction$T@@13) $Heap)) (|$IsA#_module.Tree| |tree#0@@3|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 9) 8)))) anon0_correct)))
