...
(let ((anon4_correct  (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (|Seq#Length| |zeros#0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |zeros#0|)))) (=> (and (<= 0 |k#0@0|) (< |k#0@0| (|Seq#Length| |zeros#0|))) (=> (and (= (U_2_bool ($Unbox boolType (|Seq#Index| |zeros#0| |k#0@0|))) |Z#0|) (= (ControlFlow 0 3) 1)) anon6_correct))))))
(let ((anon8_Else_correct  (=> (and (< |k#0@0| (LitInt 0)) (= (ControlFlow 0 6) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 0) |k#0@0|) (= (ControlFlow 0 5) 3)) anon4_correct)))
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (|Seq#Length| |zeros#0|))) (= (U_2_bool ($Unbox boolType (|Seq#Index| |zeros#0| |k#0@0|))) |Z#0|)) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (<= (LitInt 1) (|Seq#Length| |zeros#0|)) (= |Z#0| (U_2_bool (Lit boolType (bool_2_U false))))) (and (and (=> (= (ControlFlow 0 7) 2) anon7_Else_correct) (=> (= (ControlFlow 0 7) 5) anon8_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |zeros#0| (TSeq TBool)) ($IsAlloc SeqType |zeros#0| (TSeq TBool) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
