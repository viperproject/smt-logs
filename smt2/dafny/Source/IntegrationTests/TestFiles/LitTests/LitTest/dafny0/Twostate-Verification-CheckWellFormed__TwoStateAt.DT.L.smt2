...
(assert (distinct TInt TagInt alloc allocName Tagclass.TwoStateAt.Cell Tagclass.TwoStateAt.Cell? Tagclass.TwoStateAt.DT class.TwoStateAt.Cell? tytagFamily$Cell tytagFamily$DT field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((TwoStateAt.DT$X T@U) ) (!  (and (= (Tag (Tclass.TwoStateAt.DT TwoStateAt.DT$X)) Tagclass.TwoStateAt.DT) (= (TagFamily (Tclass.TwoStateAt.DT TwoStateAt.DT$X)) tytagFamily$DT))
 :qid |unknown.0:0|
 :skolemid |726|
 :pattern ( (Tclass.TwoStateAt.DT TwoStateAt.DT$X))
)))
...
(assert (forall ((TwoStateAt.DT$X@@0 T@U) ) (! (= (Tclass.TwoStateAt.DT_0 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@0)) TwoStateAt.DT$X@@0)
 :qid |unknown.0:0|
 :skolemid |727|
...
(assert (forall ((TwoStateAt.DT$X@@1 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@1)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@1))))
 :qid |unknown.0:0|
 :skolemid |728|
 :pattern ( ($IsBox bx@@3 (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@1)))
)))
...
(declare-fun TwoStateAt.DT$X@@2 () T@U)
...
(set-info :boogie-vc-id CheckWellFormed$$TwoStateAt.DT.L)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell $Heap) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |c#0@@1| null)) (not true))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType this (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@2)) ($IsAlloc DatatypeTypeType this (Tclass.TwoStateAt.DT TwoStateAt.DT$X@@2) previous$Heap)) (and ($IsBox |x#0| TwoStateAt.DT$X@@2) ($IsAllocBox |x#0| TwoStateAt.DT$X@@2 previous$Heap))) (and (and ($IsBox |y#0| TwoStateAt.DT.L$Y) ($IsAllocBox |y#0| TwoStateAt.DT.L$Y previous$Heap)) (and ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap)))) (and (and (and (<= (LitInt 0) |n#0|) (= 2 $FunctionContextHeight)) (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and ($IsAllocBox |x#0| TwoStateAt.DT$X@@2 previous$Heap) ($IsAllocBox |y#0| TwoStateAt.DT.L$Y previous$Heap)) (and ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap) (= (ControlFlow 0 5) 2))))) anon0_correct))))
