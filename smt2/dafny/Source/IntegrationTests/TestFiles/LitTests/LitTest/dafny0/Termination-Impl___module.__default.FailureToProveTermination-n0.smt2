...
(set-info :boogie-vc-id Impl$$_module.__default.FailureToProveTermination0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (< |n#0@0| 100) (=> (and (= |$decr$loop#00@1| (- 100 |n#0@0|)) (= |n#0@1| (- |n#0@0| 1))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- 100 |n#0@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 100 |n#0@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- 100 |n#0@1|) |$decr$loop#00@1|))))))))
...
)) (<= (- 100 |n#0@0|) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 9) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 9) 8) anon6_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (- 100 |N#0|)) (= (ControlFlow 0 10) 9)) anon6_LoopHead_correct))))
