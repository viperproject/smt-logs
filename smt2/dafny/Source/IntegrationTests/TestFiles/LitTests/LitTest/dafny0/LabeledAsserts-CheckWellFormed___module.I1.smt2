...
(set-info :boogie-vc-id CheckWellFormed$$_module.I1)
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#20| null $Heap alloc this@@0 |c#0@@5| |d#0|)) (or (not (= |c#0@@5| |d#0|)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@5|) _module.C.g))) |u#0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |d#0| null)) (not true))) (=> (or (not (= |d#0| null)) (not true)) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |d#0|) _module.C.g))) |u#0|) (=> (and (and (= (_module.I1.c this@@0) |c#0@@5|) (= (_module.I1.d this@@0) |d#0|)) (and (= (_module.I1.u this@@0) |u#0|) (_module.I1.Valid $Heap this@@0))) (=> (and (and (and (|Set#Equal| (_module.I1.__reads this@@0) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@5|))) (|Set#Equal| (_module.I1.__modifies this@@0) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@5|)) ($Box refType |d#0|)))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) _module.I1.__new)) |Set#Empty|) (= (_module.I1.__decreases0 this@@0) |c#0@@5|))) (and (and (= (_module.I1.__decreases1 this@@0) |d#0|) (= (_module.I1.__decreases2 this@@0) |u#0|)) (and (= call1formal@rds@0 (_module.I1.__reads this@@0)) (= call2formal@modi@0 (_module.I1.__modifies this@@0))))) (=> (and (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@27 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@27 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@27) alloc)))) (=> (and (and (|Set#IsMember| call1formal@rds@0 ($Box refType $o@@27)) (not (|Set#IsMember| call2formal@modi@0 ($Box refType $o@@27)))) (or (not (= $o@@27 this@@0)) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@27) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@27) $f@@1))))
...
)) ($HeapSucc $Heap@0 $Heap@1))) (and (and (forall (($o@@29 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.I1.__new)) ($Box refType $o@@29)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.I1.__new)) ($Box refType $o@@29)))) (or (not (= $o@@29 null)) (not true)))
 :qid |LabeledAssertsdfy.151:10|
 :skolemid |577|
 :pattern (  (or (not (= $o@@29 null)) (not true)))
)) (forall (($o@@30 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.I1.__new)) ($Box refType $o@@30)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@0) _module.I1.__new)) ($Box refType $o@@30)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@30) alloc)))))
 :qid |LabeledAssertsdfy.151:10|
 :skolemid |578|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.I1) ($IsAlloc refType this@@0 Tclass._module.I1 $Heap))) (and ($Is refType |c#0@@5| Tclass._module.C) ($IsAlloc refType |c#0@@5| Tclass._module.C $Heap))) (and (and ($Is refType |d#0| Tclass._module.C) ($IsAlloc refType |d#0| Tclass._module.C $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct))))
