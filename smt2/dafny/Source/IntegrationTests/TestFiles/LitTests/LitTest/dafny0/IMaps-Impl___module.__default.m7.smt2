...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon8_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((|i#3| Int) ) (!  (=> (or (< |i#3| 1) (> |i#3| 3)) (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U |i#3|))))))
 :qid |IMapsdfy.71:18|
 :skolemid |547|
...
(let ((anon3_correct  (and (=> (= (ControlFlow 0 10) (- 0 15)) (forall ((|i#1| Int) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U |i#1|)))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0@0|) ($Box intType (int_2_U |i#1|))))) (Mul |i#1| |i#1|)))
 :qid |IMapsdfy.66:18|
 :skolemid |545|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0@0|) ($Box intType (int_2_U |i#1|)))))
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U |i#1|))))
))) (=> (forall ((|i#1@@0| T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType |i#1@@0|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0@0|) ($Box intType |i#1@@0|)))) (Mul (U_2_int |i#1@@0|) (U_2_int |i#1@@0|))))
 :qid |IMapsdfy.66:18|
 :skolemid |545|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0@0|) ($Box intType |i#1@@0|))))
 :pattern ( (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType |i#1@@0|)))
)) (and (=> (= (ControlFlow 0 10) (- 0 14)) (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U 0)))))) (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U 0))))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U 1))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U 1)))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U 2))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U 2)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U 3))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U 3)))) (and (=> (= (ControlFlow 0 10) 9) anon11_Then_correct) (=> (= (ControlFlow 0 10) 2) anon11_Else_correct))))))))))))))
(let ((anon10_Else_correct  (=> (and (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U |i#0@0|))))) (= (ControlFlow 0 18) 10)) anon3_correct)))
(let ((anon10_Then_correct  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U |i#0@0|)))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0@0|) ($Box intType (int_2_U |i#0@0|))))) (=> (= (ControlFlow 0 16) 10) anon3_correct)))))
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (Lit IMapType (|IMap#Build| (|IMap#Build| (|IMap#Build| |IMap#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 4)))) ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 9))))))) (and (=> (= (ControlFlow 0 20) 19) anon9_Then_correct) (=> (= (ControlFlow 0 20) 1) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is IMapType |a#0| (TIMap TInt TInt)) ($IsAlloc IMapType |a#0| (TIMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 21) 20))) anon0_correct))))
