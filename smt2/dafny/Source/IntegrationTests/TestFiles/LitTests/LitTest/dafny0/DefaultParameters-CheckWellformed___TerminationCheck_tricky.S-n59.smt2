...
(set-info :boogie-vc-id |CheckWellformed$$#TerminationCheck_tricky.S.S|)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 3))) false)))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |x#0@@0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))
