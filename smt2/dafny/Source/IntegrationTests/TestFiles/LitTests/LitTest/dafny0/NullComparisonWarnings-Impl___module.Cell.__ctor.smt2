...
(assert (distinct alloc allocName Tagclass._module.Cell class._module.Cell? Tagclass._module.Cell? tytagFamily$Cell field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((_module.Cell$G@@1 T@U) (|c#0| T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType |c#0| (Tclass._module.Cell _module.Cell$G@@1) $h@@1) ($IsAlloc refType |c#0| (Tclass._module.Cell? _module.Cell$G@@1) $h@@1))
 :qid |unknown.0:0|
 :skolemid |519|
 :pattern ( ($IsAlloc refType |c#0| (Tclass._module.Cell _module.Cell$G@@1) $h@@1))
 :pattern ( ($IsAlloc refType |c#0| (Tclass._module.Cell? _module.Cell$G@@1) $h@@1))
)))
(assert (forall ((_module.Cell$G@@2 T@U) ($o@@1 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@1 (Tclass._module.Cell? _module.Cell$G@@2) $h@@2)  (or (= $o@@1 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsAlloc refType $o@@1 (Tclass._module.Cell? _module.Cell$G@@2) $h@@2))
)))
...
(assert (forall ((_module.Cell$G@@3 T@U) (|c#0@@0| T@U) ) (! (= ($Is refType |c#0@@0| (Tclass._module.Cell _module.Cell$G@@3))  (and ($Is refType |c#0@@0| (Tclass._module.Cell? _module.Cell$G@@3)) (or (not (= |c#0@@0| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |518|
 :pattern ( ($Is refType |c#0@@0| (Tclass._module.Cell _module.Cell$G@@3)))
 :pattern ( ($Is refType |c#0@@0| (Tclass._module.Cell? _module.Cell$G@@3)))
)))
...
(assert (forall ((_module.Cell$G@@6 T@U) ($o@@2 T@U) ) (! (= ($Is refType $o@@2 (Tclass._module.Cell? _module.Cell$G@@6))  (or (= $o@@2 null) (= (dtype $o@@2) (Tclass._module.Cell? _module.Cell$G@@6))))
 :qid |unknown.0:0|
 :skolemid |511|
 :pattern ( ($Is refType $o@@2 (Tclass._module.Cell? _module.Cell$G@@6)))
)))
...
(assert (forall ((_module.Cell$G@@9 T@U) (bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 (Tclass._module.Cell _module.Cell$G@@9)) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) (Tclass._module.Cell _module.Cell$G@@9))))
 :qid |unknown.0:0|
 :skolemid |496|
 :pattern ( ($IsBox bx@@0 (Tclass._module.Cell _module.Cell$G@@9)))
)))
(assert (forall ((_module.Cell$G@@10 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._module.Cell? _module.Cell$G@@10)) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) (Tclass._module.Cell? _module.Cell$G@@10))))
 :qid |unknown.0:0|
 :skolemid |510|
 :pattern ( ($IsBox bx@@1 (Tclass._module.Cell? _module.Cell$G@@10)))
)))
...
(declare-fun |g#0| () T@U)
(declare-fun _module.Cell$G@@11 () T@U)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |g#0| _module.Cell$G@@11) ($IsAllocBox |g#0| _module.Cell$G@@11 $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
