...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Display1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (<= (LitInt 0) |n#0|) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |w#0| null)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |d#0| _module._default.Display1$D) ($IsAllocBox |d#0| _module._default.Display1$D $Heap))) (and (and ($Is refType |w#0| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |w#0| (Tclass._System.array Tclass._System.nat) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
