...
(set-info :boogie-vc-id Impl$$_module.__default.UpdateValiditySeq)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0@0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0@0|))) (=> (= (ControlFlow 0 5) (- 0 4)) ($Is intType (int_2_U (LitInt (- 0 5))) Tclass._System.nat))))))
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 10)) (< (LitInt 10) (|Seq#Length| |s#0@0|)))) (=> (and (<= 0 (LitInt 10)) (< (LitInt 10) (|Seq#Length| |s#0@0|))) (=> (= (ControlFlow 0 2) (- 0 1)) ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) (- 0 12)) ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat) (and (=> (= (ControlFlow 0 7) (- 0 11)) ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat) (and (=> (= (ControlFlow 0 7) (- 0 10)) ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat) (and (=> (= (ControlFlow 0 7) (- 0 9)) ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 4)) Tclass._System.nat) (=> (= |s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 4)))) ($Box intType (int_2_U (LitInt 4)))) ($Box intType (int_2_U (LitInt 4)))) ($Box intType (int_2_U (LitInt 4)))) ($Box intType (int_2_U (LitInt 4)))))) (and (=> (= (ControlFlow 0 7) 2) anon3_Then_correct) (=> (= (ControlFlow 0 7) 5) anon3_Else_correct))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq Tclass._System.nat)) ($IsAlloc SeqType |s#0| (TSeq Tclass._System.nat) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 13) 7))) anon0_correct))))
