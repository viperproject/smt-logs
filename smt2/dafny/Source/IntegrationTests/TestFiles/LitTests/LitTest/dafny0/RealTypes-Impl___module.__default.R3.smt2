...
(set-info :boogie-vc-id Impl$$_module.__default.R3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |x#0@0| (LitReal 1.5)) (= |y#0@0| (q@Real (LitInt 3)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= (LitReal 2.0) 0.0)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= |x#0@0| (/ |y#0@0| 2.0))) (=> (= |x#0@0| (/ |y#0@0| 2.0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= (LitReal 2.000000000000000000000000001) 0.0)) (not true))) (=> (= (ControlFlow 0 2) (- 0 1)) (= |x#0@0| (/ |y#0@0| 2.000000000000000000000000001)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct)))
