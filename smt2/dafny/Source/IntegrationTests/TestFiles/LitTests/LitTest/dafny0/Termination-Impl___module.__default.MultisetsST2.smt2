...
(declare-fun _module._default.MultisetsST2$Y () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.MultisetsST2)
...
(let ((anon19_Else_correct  (=> (and (|MultiSet#Equal| |s#0@0| |t#0@0|) (= (ControlFlow 0 20) 18)) anon5_correct)))
(let ((anon19_Then_correct  (=> (and (not (|MultiSet#Equal| |s#0@0| |t#0@0|)) (= (ControlFlow 0 19) 18)) anon5_correct)))
(let ((anon18_Then_correct  (=> (and (not |$w$loop#0@0|) (= |newtype$check#0@0| (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (= |newtype$check#1@0| (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@0|))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (<= (LitInt 0) |newtype$check#1@0|)) (=> (<= (LitInt 0) |newtype$check#1@0|) (and (=> (= (ControlFlow 0 21) 19) anon19_Then_correct) (=> (= (ControlFlow 0 21) 20) anon19_Else_correct))))))))))
(let ((anon23_Else_correct  (=> (or (not (= |x#0_0@1| |y#0|)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) true) (=> (= |s#0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (or (< (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|) (and (= (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|) (and (|MultiSet#Subset| (ite  (not (|MultiSet#Equal| |s#0@1| |t#0@0|)) |s#0@1| |MultiSet#Empty|) |$decr$loop#01@1|) (not (|MultiSet#Equal| (ite  (not (|MultiSet#Equal| |s#0@1| |t#0@0|)) |s#0@1| |MultiSet#Empty|) |$decr$loop#01@1|)))))))))))))
(let ((anon23_Then_correct true))
(let ((anon12_correct  (and (=> (= (ControlFlow 0 8) (- 0 10)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.MultisetsST2$Y) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0))
 :qid |Terminationdfy.795:9|
 :skolemid |3243|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.MultisetsST2$Y) (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0))
 :qid |Terminationdfy.795:9|
 :skolemid |3243|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.MultisetsST2$Y) ($IsAllocBox |x#0_0@1| _module._default.MultisetsST2$Y $Heap))) (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0)) (and (=> (= (ControlFlow 0 8) (- 0 9)) true) (and (=> (= (ControlFlow 0 8) 3) anon23_Then_correct) (=> (= (ControlFlow 0 8) 5) anon23_Else_correct))))))))
(let ((anon22_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.MultisetsST2$Y) ($IsAllocBox |x#0_1@1| _module._default.MultisetsST2$Y $Heap))) (= (ControlFlow 0 12) 8)) anon12_correct)))
(let ((anon22_Then_correct  (=> (and (and ($IsBox |x#0_1@1| _module._default.MultisetsST2$Y) ($IsAllocBox |x#0_1@1| _module._default.MultisetsST2$Y $Heap)) (= (ControlFlow 0 11) 8)) anon12_correct)))
(let ((anon21_Else_correct  (=> (and (and (not (|MultiSet#Equal| |s#0@0| |t#0@0|)) (not (|MultiSet#Equal| |s#0@0| |MultiSet#Empty|))) (and (= |$decr$loop#00@1| (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@0|)))) (= |$decr$loop#01@1| (ite  (not (|MultiSet#Equal| |s#0@0| |t#0@0|)) |s#0@0| |MultiSet#Empty|)))) (and (=> (= (ControlFlow 0 13) 11) anon22_Then_correct) (=> (= (ControlFlow 0 13) 12) anon22_Else_correct)))))
...
(let ((anon20_Else_correct  (=> (and (|MultiSet#Equal| |s#0@0| |t#0@0|) (= (ControlFlow 0 16) 14)) anon8_correct)))
(let ((anon20_Then_correct  (=> (and (not (|MultiSet#Equal| |s#0@0| |t#0@0|)) (= (ControlFlow 0 15) 14)) anon8_correct)))
...
(let ((anon17_LoopHead_correct  (=> (and (and (and (and ($Is MultiSetType |s#0@0| (TMultiSet _module._default.MultisetsST2$Y)) ($IsAlloc MultiSetType |s#0@0| (TMultiSet _module._default.MultisetsST2$Y) $Heap)) (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.MultisetsST2$Y) ($IsAllocBox |x#0_0@0| _module._default.MultisetsST2$Y $Heap)))) (and (not false) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.794:3|
 :skolemid |3241|
...
))) (and (<= (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@0|))) |$decr_init$loop#00@0|) (=> (= (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@0|))) |$decr_init$loop#00@0|) (|MultiSet#Subset| (ite  (not (|MultiSet#Equal| |s#0@0| |t#0@0|)) |s#0@0| |MultiSet#Empty|) |$decr_init$loop#01@0|))))) (and (=> (= (ControlFlow 0 25) 1) anon17_LoopDone_correct) (=> (= (ControlFlow 0 25) 24) anon17_LoopBody_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |t#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |y#0|)) (= |$decr_init$loop#00@0| (+ (|MultiSet#Card| (|MultiSet#Difference| |S#0| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |S#0|))))) (and (= |$decr_init$loop#01@0| (ite  (not (|MultiSet#Equal| |S#0| |t#0@0|)) |S#0| |MultiSet#Empty|)) (= (ControlFlow 0 26) 25))) anon17_LoopHead_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is MultiSetType |S#0| (TMultiSet _module._default.MultisetsST2$Y)) ($IsAlloc MultiSetType |S#0| (TMultiSet _module._default.MultisetsST2$Y) $Heap)) (and ($IsBox |y#0| _module._default.MultisetsST2$Y) ($IsAllocBox |y#0| _module._default.MultisetsST2$Y $Heap))) (and (and ($Is MultiSetType |s#0| (TMultiSet _module._default.MultisetsST2$Y)) ($IsAlloc MultiSetType |s#0| (TMultiSet _module._default.MultisetsST2$Y) $Heap)) true)) (and (and (and ($Is MultiSetType |t#0| (TMultiSet _module._default.MultisetsST2$Y)) ($IsAlloc MultiSetType |t#0| (TMultiSet _module._default.MultisetsST2$Y) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.MultisetsST2$Y) ($IsAllocBox |x#0_0| _module._default.MultisetsST2$Y $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 27) 26))))) anon0_correct))))
