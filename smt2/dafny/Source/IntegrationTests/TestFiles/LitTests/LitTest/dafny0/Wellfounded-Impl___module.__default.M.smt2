...
(declare-fun |s#5_0@0| () T@U)
(declare-fun |e#5_0_0@0| () T@U)
(declare-fun |d#0| () T@U)
(declare-fun $Heap () T@U)
(declare-fun |eg$e#5_0@0| () T@U)
(declare-fun |_mcc#1#5_0@0| () T@U)
(declare-fun |let#5_0#0#0| () T@U)
(declare-fun |j#4_1_0_0@0| () Int)
(declare-fun |s#4_0@0| () T@U)
(declare-fun |d##4_1_1_0@0| () T@U)
(declare-fun |eg$j#4_1_0@0| () Int)
(declare-fun |_mcc#2#4_0@0| () T@U)
(declare-fun |let#4_0#0#0| () T@U)
(declare-fun |s#3_0@0| () T@U)
(declare-fun |e#3_0_0@0| () T@U)
(declare-fun |eg$e#3_0@0| () T@U)
(declare-fun |_mcc#3#3_0@0| () T@U)
(declare-fun |let#3_0#0#0| () T@U)
(declare-fun |m#2_0@0| () T@U)
(declare-fun |e#2_0_0@0| () T@U)
(declare-fun |eg$e#2_0@0| () T@U)
(declare-fun |_mcc#4#2_0@0| () T@U)
(declare-fun |let#2_0#0#0| () T@U)
(declare-fun |m#1_0@0| () T@U)
(declare-fun |d'#0| () T@U)
(declare-fun |d##1_0_0@0| () T@U)
(declare-fun |_mcc#5#1_0@0| () T@U)
(declare-fun |let#1_0#0#0| () T@U)
(declare-fun |m#0_0@0| () T@U)
(declare-fun |d##0_0_0@0| () T@U)
(declare-fun |_mcc#6#0_0@0| () T@U)
(declare-fun |let#0_0#0#0| () T@U)
(declare-fun |_mcc#0#6_0@0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |e#2_0_0| () T@U)
(declare-fun |e#3_0_0| () T@U)
(declare-fun |e#5_0_0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 59) (let ((anon39_Else_correct true))
(let ((anon39_Then_correct  (=> (and (|Set#IsMember| |s#5_0@0| ($Box DatatypeTypeType |e#5_0_0@0|)) (= (ControlFlow 0 51) (- 0 50))) (< (DtRank |e#5_0_0@0|) (DtRank |d#0|)))))
(let ((anon4_correct  (=> (and ($Is DatatypeTypeType |e#5_0_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |e#5_0_0@0| Tclass._module.Dt $Heap)) (and (=> (= (ControlFlow 0 53) 51) anon39_Then_correct) (=> (= (ControlFlow 0 53) 52) anon39_Else_correct)))))
(let ((anon38_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |eg$e#5_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |eg$e#5_0@0| Tclass._module.Dt $Heap))) (= (ControlFlow 0 55) 53)) anon4_correct)))
(let ((anon38_Then_correct  (=> (and (and ($Is DatatypeTypeType |eg$e#5_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |eg$e#5_0@0| Tclass._module.Dt $Heap)) (= (ControlFlow 0 54) 53)) anon4_correct)))
(let ((anon37_Then_correct  (=> (= |d#0| (|#_module.Dt.Set| |_mcc#1#5_0@0|)) (=> (and ($Is SetType |_mcc#1#5_0@0| (TSet Tclass._module.Dt)) ($IsAlloc SetType |_mcc#1#5_0@0| (TSet Tclass._module.Dt) $Heap)) (=> (and (and (and ($Is SetType |s#5_0@0| (TSet Tclass._module.Dt)) ($IsAlloc SetType |s#5_0@0| (TSet Tclass._module.Dt) $Heap)) (= |let#5_0#0#0| |_mcc#1#5_0@0|)) (and ($Is SetType |let#5_0#0#0| (TSet Tclass._module.Dt)) (= |s#5_0@0| |let#5_0#0#0|))) (and (=> (= (ControlFlow 0 56) 54) anon38_Then_correct) (=> (= (ControlFlow 0 56) 55) anon38_Else_correct)))))))
(let ((anon44_Else_correct true))
(let ((anon44_Then_correct  (=> (and (<= (LitInt 0) |j#4_1_0_0@0|) (< |j#4_1_0_0@0| (|Seq#Length| |s#4_0@0|))) (and (=> (= (ControlFlow 0 41) (- 0 42)) (and (<= 0 |j#4_1_0_0@0|) (< |j#4_1_0_0@0| (|Seq#Length| |s#4_0@0|)))) (=> (and (<= 0 |j#4_1_0_0@0|) (< |j#4_1_0_0@0| (|Seq#Length| |s#4_0@0|))) (=> (and (= |d##4_1_1_0@0| ($Unbox DatatypeTypeType (|Seq#Index| |s#4_0@0| |j#4_1_0_0@0|))) (= (ControlFlow 0 41) (- 0 40))) (< (DtRank |d##4_1_1_0@0|) (DtRank |d#0|))))))))
(let ((anon12_correct  (and (=> (= (ControlFlow 0 44) 41) anon44_Then_correct) (=> (= (ControlFlow 0 44) 43) anon44_Else_correct))))
(let ((anon43_Else_correct  (=> (and (< |eg$j#4_1_0@0| (LitInt 0)) (= (ControlFlow 0 46) 44)) anon12_correct)))
(let ((anon43_Then_correct  (=> (and (<= (LitInt 0) |eg$j#4_1_0@0|) (= (ControlFlow 0 45) 44)) anon12_correct)))
(let ((anon42_Then_correct  (and (=> (= (ControlFlow 0 47) 45) anon43_Then_correct) (=> (= (ControlFlow 0 47) 46) anon43_Else_correct))))
(let ((anon42_Else_correct true))
(let ((anon41_Then_correct  (=> (= (ControlFlow 0 38) (- 0 37)) (< (|Seq#Rank| |s#4_0@0|) (DtRank |d#0|)))))
(let ((anon40_Then_correct  (=> (= |d#0| (|#_module.Dt.Seq| |_mcc#2#4_0@0|)) (=> (and ($Is SeqType |_mcc#2#4_0@0| (TSeq Tclass._module.Dt)) ($IsAlloc SeqType |_mcc#2#4_0@0| (TSeq Tclass._module.Dt) $Heap)) (=> (and (and (and ($Is SeqType |s#4_0@0| (TSeq Tclass._module.Dt)) ($IsAlloc SeqType |s#4_0@0| (TSeq Tclass._module.Dt) $Heap)) (= |let#4_0#0#0| |_mcc#2#4_0@0|)) (and ($Is SeqType |let#4_0#0#0| (TSeq Tclass._module.Dt)) (= |s#4_0@0| |let#4_0#0#0|))) (and (and (=> (= (ControlFlow 0 48) 38) anon41_Then_correct) (=> (= (ControlFlow 0 48) 47) anon42_Then_correct)) (=> (= (ControlFlow 0 48) 39) anon42_Else_correct)))))))
(let ((anon47_Else_correct true))
(let ((anon47_Then_correct  (=> (and (> (|MultiSet#Multiplicity| |s#3_0@0| ($Box DatatypeTypeType |e#3_0_0@0|)) 0) (= (ControlFlow 0 30) (- 0 29))) (< (DtRank |e#3_0_0@0|) (DtRank |d#0|)))))
(let ((anon17_correct  (=> (and ($Is DatatypeTypeType |e#3_0_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |e#3_0_0@0| Tclass._module.Dt $Heap)) (and (=> (= (ControlFlow 0 32) 30) anon47_Then_correct) (=> (= (ControlFlow 0 32) 31) anon47_Else_correct)))))
(let ((anon46_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |eg$e#3_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |eg$e#3_0@0| Tclass._module.Dt $Heap))) (= (ControlFlow 0 34) 32)) anon17_correct)))
(let ((anon46_Then_correct  (=> (and (and ($Is DatatypeTypeType |eg$e#3_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |eg$e#3_0@0| Tclass._module.Dt $Heap)) (= (ControlFlow 0 33) 32)) anon17_correct)))
(let ((anon45_Then_correct  (=> (= |d#0| (|#_module.Dt.Multiset| |_mcc#3#3_0@0|)) (=> (and ($Is MultiSetType |_mcc#3#3_0@0| (TMultiSet Tclass._module.Dt)) ($IsAlloc MultiSetType |_mcc#3#3_0@0| (TMultiSet Tclass._module.Dt) $Heap)) (=> (and (and (and ($Is MultiSetType |s#3_0@0| (TMultiSet Tclass._module.Dt)) ($IsAlloc MultiSetType |s#3_0@0| (TMultiSet Tclass._module.Dt) $Heap)) (= |let#3_0#0#0| |_mcc#3#3_0@0|)) (and ($Is MultiSetType |let#3_0#0#0| (TMultiSet Tclass._module.Dt)) (= |s#3_0@0| |let#3_0#0#0|))) (and (=> (= (ControlFlow 0 35) 33) anon46_Then_correct) (=> (= (ControlFlow 0 35) 34) anon46_Else_correct)))))))
(let ((anon50_Else_correct true))
(let ((anon50_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |m#2_0@0|) ($Box DatatypeTypeType |e#2_0_0@0|)) (= (ControlFlow 0 22) (- 0 21))) (< (DtRank |e#2_0_0@0|) (DtRank |d#0|)))))
(let ((anon22_correct  (=> (and ($Is DatatypeTypeType |e#2_0_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |e#2_0_0@0| Tclass._module.Dt $Heap)) (and (=> (= (ControlFlow 0 24) 22) anon50_Then_correct) (=> (= (ControlFlow 0 24) 23) anon50_Else_correct)))))
(let ((anon49_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |eg$e#2_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |eg$e#2_0@0| Tclass._module.Dt $Heap))) (= (ControlFlow 0 26) 24)) anon22_correct)))
(let ((anon49_Then_correct  (=> (and (and ($Is DatatypeTypeType |eg$e#2_0@0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |eg$e#2_0@0| Tclass._module.Dt $Heap)) (= (ControlFlow 0 25) 24)) anon22_correct)))
(let ((anon48_Then_correct  (=> (= |d#0| (|#_module.Dt.Map0| |_mcc#4#2_0@0|)) (=> (and ($Is MapType |_mcc#4#2_0@0| (TMap Tclass._module.Dt TInt)) ($IsAlloc MapType |_mcc#4#2_0@0| (TMap Tclass._module.Dt TInt) $Heap)) (=> (and (and (and ($Is MapType |m#2_0@0| (TMap Tclass._module.Dt TInt)) ($IsAlloc MapType |m#2_0@0| (TMap Tclass._module.Dt TInt) $Heap)) (= |let#2_0#0#0| |_mcc#4#2_0@0|)) (and ($Is MapType |let#2_0#0#0| (TMap Tclass._module.Dt TInt)) (= |m#2_0@0| |let#2_0#0#0|))) (and (=> (= (ControlFlow 0 27) 25) anon49_Then_correct) (=> (= (ControlFlow 0 27) 26) anon49_Else_correct)))))))
(let ((anon53_Else_correct true))
(let ((anon53_Then_correct  (=> (and (|Set#IsMember| (|Map#Values| |m#1_0@0|) ($Box DatatypeTypeType |d'#0|)) (= (ControlFlow 0 16) (- 0 15))) (< (DtRank |d'#0|) (DtRank |d#0|)))))
(let ((anon52_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |m#1_0@0|) ($Box intType (int_2_U (LitInt 15))))) (and (=> (= (ControlFlow 0 18) 16) anon53_Then_correct) (=> (= (ControlFlow 0 18) 17) anon53_Else_correct)))))
(let ((anon52_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#1_0@0|) ($Box intType (int_2_U (LitInt 15)))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (|Set#IsMember| (|Map#Domain| |m#1_0@0|) ($Box intType (int_2_U (LitInt 15))))) (=> (|Set#IsMember| (|Map#Domain| |m#1_0@0|) ($Box intType (int_2_U (LitInt 15)))) (=> (and (= |d##1_0_0@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|Map#Elements| |m#1_0@0|) ($Box intType (int_2_U (LitInt 15)))))) (= (ControlFlow 0 13) (- 0 12))) (< (DtRank |d##1_0_0@0|) (DtRank |d#0|))))))))
(let ((anon51_Then_correct  (=> (= |d#0| (|#_module.Dt.Map1| |_mcc#5#1_0@0|)) (=> (and ($Is MapType |_mcc#5#1_0@0| (TMap TInt Tclass._module.Dt)) ($IsAlloc MapType |_mcc#5#1_0@0| (TMap TInt Tclass._module.Dt) $Heap)) (=> (and (and (and ($Is MapType |m#1_0@0| (TMap TInt Tclass._module.Dt)) ($IsAlloc MapType |m#1_0@0| (TMap TInt Tclass._module.Dt) $Heap)) (= |let#1_0#0#0| |_mcc#5#1_0@0|)) (and ($Is MapType |let#1_0#0#0| (TMap TInt Tclass._module.Dt)) (= |m#1_0@0| |let#1_0#0#0|))) (and (=> (= (ControlFlow 0 19) 13) anon52_Then_correct) (=> (= (ControlFlow 0 19) 18) anon52_Else_correct)))))))
(let ((anon56_Else_correct true))
(let ((anon56_Then_correct  (=> (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Values| |m#0_0@0|) ($Box DatatypeTypeType |d'#0|))) (= (ControlFlow 0 7) (- 0 6))) (< (DtRank |d'#0|) (DtRank |d#0|)))))
(let ((anon55_Else_correct  (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0_0@0|) ($Box intType (int_2_U (LitInt 15)))))) (and (=> (= (ControlFlow 0 9) 7) anon56_Then_correct) (=> (= (ControlFlow 0 9) 8) anon56_Else_correct)))))
(let ((anon55_Then_correct  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0_0@0|) ($Box intType (int_2_U (LitInt 15))))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0_0@0|) ($Box intType (int_2_U (LitInt 15)))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0_0@0|) ($Box intType (int_2_U (LitInt 15))))) (=> (and (= |d##0_0_0@0| ($Unbox DatatypeTypeType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0_0@0|) ($Box intType (int_2_U (LitInt 15)))))) (= (ControlFlow 0 4) (- 0 3))) (< (DtRank |d##0_0_0@0|) (DtRank |d#0|))))))))
(let ((anon54_Then_correct  (=> (= |d#0| (|#_module.Dt.IMap1| |_mcc#6#0_0@0|)) (=> (and ($Is IMapType |_mcc#6#0_0@0| (TIMap TInt Tclass._module.Dt)) ($IsAlloc IMapType |_mcc#6#0_0@0| (TIMap TInt Tclass._module.Dt) $Heap)) (=> (and (and (and ($Is IMapType |m#0_0@0| (TIMap TInt Tclass._module.Dt)) ($IsAlloc IMapType |m#0_0@0| (TIMap TInt Tclass._module.Dt) $Heap)) (= |let#0_0#0#0| |_mcc#6#0_0@0|)) (and ($Is IMapType |let#0_0#0#0| (TIMap TInt Tclass._module.Dt)) (= |m#0_0@0| |let#0_0#0#0|))) (and (=> (= (ControlFlow 0 10) 4) anon55_Then_correct) (=> (= (ControlFlow 0 10) 9) anon55_Else_correct)))))))
(let ((anon54_Else_correct true))
(let ((anon51_Else_correct  (=> (or (not (= |d#0| (|#_module.Dt.Map1| |_mcc#5#1_0@0|))) (not true)) (and (=> (= (ControlFlow 0 11) 10) anon54_Then_correct) (=> (= (ControlFlow 0 11) 2) anon54_Else_correct)))))
(let ((anon48_Else_correct  (=> (or (not (= |d#0| (|#_module.Dt.Map0| |_mcc#4#2_0@0|))) (not true)) (and (=> (= (ControlFlow 0 20) 19) anon51_Then_correct) (=> (= (ControlFlow 0 20) 11) anon51_Else_correct)))))
(let ((anon45_Else_correct  (=> (or (not (= |d#0| (|#_module.Dt.Multiset| |_mcc#3#3_0@0|))) (not true)) (and (=> (= (ControlFlow 0 28) 27) anon48_Then_correct) (=> (= (ControlFlow 0 28) 20) anon48_Else_correct)))))
(let ((anon40_Else_correct  (=> (or (not (= |d#0| (|#_module.Dt.Seq| |_mcc#2#4_0@0|))) (not true)) (and (=> (= (ControlFlow 0 36) 35) anon45_Then_correct) (=> (= (ControlFlow 0 36) 28) anon45_Else_correct)))))
(let ((anon37_Else_correct  (=> (or (not (= |d#0| (|#_module.Dt.Set| |_mcc#1#5_0@0|))) (not true)) (and (=> (= (ControlFlow 0 49) 48) anon40_Then_correct) (=> (= (ControlFlow 0 49) 36) anon40_Else_correct)))))
(let ((anon36_Else_correct  (=> (or (not (= |d#0| (|#_module.Dt.Int| |_mcc#0#6_0@0|))) (not true)) (and (=> (= (ControlFlow 0 57) 56) anon37_Then_correct) (=> (= (ControlFlow 0 57) 49) anon37_Else_correct)))))
(let ((anon36_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 58) 1) anon36_Then_correct) (=> (= (ControlFlow 0 58) 57) anon36_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |d#0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.Dt $Heap)) (|$IsA#_module.Dt| |d#0|)) (and (and ($Is DatatypeTypeType |d'#0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |d'#0| Tclass._module.Dt $Heap)) (|$IsA#_module.Dt| |d'#0|))) (=> (and (and (and (and ($Is DatatypeTypeType |e#2_0_0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |e#2_0_0| Tclass._module.Dt $Heap)) true) (and (and ($Is DatatypeTypeType |e#3_0_0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |e#3_0_0| Tclass._module.Dt $Heap)) true)) (and (and (and ($Is DatatypeTypeType |e#5_0_0| Tclass._module.Dt) ($IsAlloc DatatypeTypeType |e#5_0_0| Tclass._module.Dt $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 59) 58)))) anon0_correct)))))
