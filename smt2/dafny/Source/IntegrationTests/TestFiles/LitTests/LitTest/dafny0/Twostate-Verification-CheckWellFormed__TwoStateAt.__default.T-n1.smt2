...
(set-info :boogie-vc-id CheckWellFormed$$TwoStateAt.__default.Test)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell $Heap))) (and (and ($IsBox |y#0| TwoStateAt._default.Test$Y) ($IsAllocBox |y#0| TwoStateAt._default.Test$Y $Heap)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
