...
(let ((anon12_Then_correct  (=> (|Set#IsMember| |S#0@@5| |x#7@0|) (=> (and ($IsAllocBox ($Box HandleTypeType |f#0@@5|) (Tclass._System.___hFunc1 _module._default.ApplyToSet$X@@6 _module._default.ApplyToSet$X@@6) $Heap@@4) ($IsAllocBox |x#7@0| _module._default.ApplyToSet$X@@6 $Heap@@4)) (=> (and (and (= |b$reqreads#0@0| (forall (($o@@1 T@U) ($f@@1 T@U) )  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@1) alloc)))) (|Set#IsMember| (Reads1 _module._default.ApplyToSet$X@@6 _module._default.ApplyToSet$X@@6 $Heap@@4 |f#0@@5| |x#7@0|) ($Box refType $o@@1))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@1))))) (Requires1 _module._default.ApplyToSet$X@@6 _module._default.ApplyToSet$X@@6 $Heap@@4 |f#0@@5| |x#7@0|)) (and ($IsAllocBox ($Box HandleTypeType |f#0@@5|) (Tclass._System.___hFunc1 _module._default.ApplyToSet$X@@6 _module._default.ApplyToSet$X@@6) $Heap@@4) ($IsAllocBox |x#7@0| _module._default.ApplyToSet$X@@6 $Heap@@4))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (Requires1 _module._default.ApplyToSet$X@@6 _module._default.ApplyToSet$X@@6 $Heap@@4 |f#0@@5| |x#7@0|)) (=> (Requires1 _module._default.ApplyToSet$X@@6 _module._default.ApplyToSet$X@@6 $Heap@@4 |f#0@@5| |x#7@0|) (=> (= |b$reqreads#1@0| (forall (($o@@2 T@U) ($f@@2 T@U) )  (=> (and (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@4 $o@@2) alloc)))) (|Set#IsMember| (Reads1 _module._default.ApplyToSet$X@@6 _module._default.ApplyToSet$X@@6 $Heap@@4 |f#0@@5| |x#7@0|) ($Box refType $o@@2))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@2 $f@@2))))) (=> (and (and (|Set#Equal| (Reads1 _module._default.ApplyToSet$X@@6 _module._default.ApplyToSet$X@@6 $Heap@@4 |f#0@@5| |x#7@0|) |Set#Empty|) (= |b$reqreads#0@1| |b$reqreads#0@0|)) (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 15) 12))) anon4_correct)))))))))
