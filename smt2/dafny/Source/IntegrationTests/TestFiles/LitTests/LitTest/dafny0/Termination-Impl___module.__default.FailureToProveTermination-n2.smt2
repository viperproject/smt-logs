...
(set-info :boogie-vc-id Impl$$_module.__default.FailureToProveTermination2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon11_Else_correct  (=> (and (and (< |x#0| |y#0|) (< |n#0@0| 100)) (and (= |$decr$loop#00@1| (- |n#0@0| |x#0|)) (= |n#0@1| (+ |n#0@0| 1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- |n#0@1| |x#0|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- |n#0@1| |x#0|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- |n#0@1| |x#0|) |$decr$loop#00@1|)))))))
...
)) (<= (- |n#0@0| |x#0|) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 12) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 12) 11) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (- |N#0| |x#0|)) (= (ControlFlow 0 13) 12)) anon8_LoopHead_correct))))
