...
(declare-fun |lambda#18| (T@U Int Int) T@U)
...
(assert (distinct TChar TInt TagChar TagInt TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 tytagFamily$nat tytagFamily$object tytagFamily$array |tytagFamily$_#Func1|)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0@@1| T@U) (|l#1| Int) (|l#2| Int) (|$l#0#heap#0| T@U) (|$l#0#x#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#18| |l#0@@1| |l#1| |l#2|) |$l#0#heap#0| |$l#0#x#0|))  (and ($IsBox |$l#0#x#0| |l#0@@1|) (and (<= |l#1| (U_2_int ($Unbox intType |$l#0#x#0|))) (< (U_2_int ($Unbox intType |$l#0#x#0|)) |l#2|))))
 :qid |unknown.0:0|
 :skolemid |809|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#18| |l#0@@1| |l#1| |l#2|) |$l#0#heap#0| |$l#0#x#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| Bool) ($o@@7 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@2| |l#1@@0| |l#2@@0| |l#3|) $o@@7 $f))  (=> (and (or (not (= $o@@7 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@7) |l#2@@0|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |803|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@2| |l#1@@0| |l#2@@0| |l#3|) $o@@7 $f))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#_v0#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#_v0#0|) |l#0@@3|)
 :qid |ArrayElementInitERRdfy.6:29|
 :skolemid |804|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#_v0#0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#_v0#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#_v0#0@@0|) |l#0@@4|)
 :qid |ArrayElementInitERRdfy.6:24|
 :skolemid |807|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#_v0#0@@0|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.M5)
...
(let ((anon11_Else_correct  (=> (and (not (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 24))) (= (ControlFlow 0 11) 8)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 24)) (= |lambdaResult#0| |d#0|)) (and ($Is charType |lambdaResult#0| TChar) (= (ControlFlow 0 10) 8))) anon6_correct)))
(let ((anon10_Else_correct  (=> (< |x#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 13) 10) anon11_Then_correct) (=> (= (ControlFlow 0 13) 11) anon11_Else_correct)))))
(let ((anon10_Then_correct  (=> (<= (LitInt 0) |x#0@0|) (and (=> (= (ControlFlow 0 12) 10) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (<= (LitInt 0) |x#0@0|) (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false))) (and (=> (= (ControlFlow 0 14) 12) anon10_Then_correct) (=> (= (ControlFlow 0 14) 13) anon10_Else_correct)))))
(let ((anon9_Else_correct  (=> (and (< |x#0@0| (LitInt 0)) (= (ControlFlow 0 9) 8)) anon6_correct)))
(let ((anon8_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 15) 14) anon9_Then_correct) (=> (= (ControlFlow 0 15) 9) anon9_Else_correct)))))
(let ((anon8_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TChar))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 25)))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 25))) (Requires1 Tclass._System.nat TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box charType |d#0|)) (|lambda#18| Tclass._System.nat (LitInt 0) 24) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |ArrayElementInitERRdfy.39:12|
 :skolemid |739|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (LitInt 25))) (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|))) ($Unbox charType (Apply1 Tclass._System.nat TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| ($Box charType |d#0|)) (|lambda#18| Tclass._System.nat (LitInt 0) 24) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|))))))
 :qid |ArrayElementInitERRdfy.39:12|
 :skolemid |740|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= $nw@0 null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (= (_System.array.Length $nw@0) (LitInt 25))) (=> (= (_System.array.Length $nw@0) (LitInt 25)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 18)) (< (LitInt 18) (_System.array.Length $nw@0)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@0) (IndexField (LitInt 18)))) |d#0|)))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 16) (- 0 17)) (<= 0 (LitInt 25))) (=> (<= 0 (LitInt 25)) (and (=> (= (ControlFlow 0 16) 15) anon8_Then_correct) (=> (= (ControlFlow 0 16) 2) anon8_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is charType |d#0| TChar)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TChar)) ($IsAlloc refType |a#0| (Tclass._System.array TChar) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 18) 16))) anon0_correct))))
