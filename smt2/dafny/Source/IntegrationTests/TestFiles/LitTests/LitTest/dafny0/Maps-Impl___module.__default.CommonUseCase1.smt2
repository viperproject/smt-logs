...
(declare-fun |kv#0_1@1| () T@U)
(declare-fun |$w$loop#0@0| () Bool)
(declare-fun |defass#kv#0_0@0| () Bool)
(declare-fun |kv#0_0@0| () T@U)
...
(declare-fun |s#0| () Int)
(declare-fun |m#1| () T@U)
(declare-fun |defass#kv#0_0| () Bool)
(declare-fun |kv#0_0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.CommonUseCase1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (exists ((|$as#kv0_0#0_0| T@U) ) (!  (and ($Is DatatypeTypeType |$as#kv0_0#0_0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType |$as#kv0_0#0_0|)))
 :qid |Mapsdfy.476:9|
 :skolemid |814|
))) (=> (exists ((|$as#kv0_0#0_0@@0| T@U) ) (!  (and ($Is DatatypeTypeType |$as#kv0_0#0_0@@0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType |$as#kv0_0#0_0@@0|)))
 :qid |Mapsdfy.476:9|
 :skolemid |814|
)) (=> (and (and (=> true (and ($Is DatatypeTypeType |kv#0_0@1| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) ($IsAlloc DatatypeTypeType |kv#0_0@1| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)) $Heap))) (|Set#IsMember| (|Map#Items| |m#1@0|) ($Box DatatypeTypeType |kv#0_0@1|))) (and ($Is refType |k#0_0@1| Tclass._module.MyClass) ($IsAlloc refType |k#0_0@1| Tclass._module.MyClass $Heap))) (and (=> (= (ControlFlow 0 5) (- 0 7)) true) (=> (and (and (= |let#0_0#0#0| |kv#0_0@1|) ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)))) (and (_System.Tuple2.___hMake2_q |let#0_0#0#0|) (= (|#_System._tuple#2._#Make2| ($Box refType |k#0_0@1|) ($Box bv3Type (bv3_2_U |v#0_0@1|))) |let#0_0#0#0|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) Tclass._System.nat) (=> (= |s#0@2| (+ |s#0@1| (nat_from_bv3 |v#0_0@1|))) (=> (and (= |m#1@1| (|Map#Subtract| |m#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType |k#0_0@1|)))) (= (ControlFlow 0 5) (- 0 4))) (and (|Set#Subset| (|Map#Domain| |m#1@1|) |$decr$loop#00@1|) (not (|Set#Subset| |$decr$loop#00@1| (|Map#Domain| |m#1@1|)))))))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |kv#0_1@1| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) ($IsAlloc DatatypeTypeType |kv#0_1@1| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)) $Heap))) (= (ControlFlow 0 10) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($Is DatatypeTypeType |kv#0_1@1| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3))) ($IsAlloc DatatypeTypeType |kv#0_1@1| (Tclass._System.Tuple2 Tclass._module.MyClass (TBitvector 3)) $Heap)) (= (ControlFlow 0 9) 5)) anon7_correct)))
