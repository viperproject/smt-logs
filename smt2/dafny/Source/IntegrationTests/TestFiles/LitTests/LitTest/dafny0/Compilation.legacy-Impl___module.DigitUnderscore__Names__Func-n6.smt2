...
(declare-fun _module.DigitUnderscore__Names__Functions__and__Methods._70 (T@U) Int)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun |_module.DigitUnderscore__Names__Functions__and__Methods._70#canCall| (T@U) Bool)
(declare-fun $Is (T@T T@U T@U) Bool)
(declare-fun Tclass._module.DigitUnderscore__Names__Functions__and__Methods () T@U)
(declare-fun LitInt (Int) Int)
(declare-fun _module.DigitUnderscore__Names__Functions__and__Methods._90 (T@U) T@U)
...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.___hFunc0 Tagclass._System.___hPartialFunc0 Tagclass._System.___hTotalFunc0 Tagclass._module.DigitUnderscore__Names__Functions__and__Methods? Tagclass._module.DigitUnderscore__Names__Functions__and__Methods tytagFamily$object |tytagFamily$_#Func0| |tytagFamily$_#PartialFunc0| |tytagFamily$_#TotalFunc0| tytagFamily$DigitUnderscore_Names_Functions_and_Methods)
)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|_module.DigitUnderscore__Names__Functions__and__Methods._70#canCall| (Lit refType this)) (and (< 0 $FunctionContextHeight) (and (or (not (= this null)) (not true)) ($Is refType this Tclass._module.DigitUnderscore__Names__Functions__and__Methods)))) (= (_module.DigitUnderscore__Names__Functions__and__Methods._70 (Lit refType this)) (LitInt 80)))
 :qid |Compilationlegacydfy.336:18|
 :weight 3
 :skolemid |11021|
 :pattern ( (_module.DigitUnderscore__Names__Functions__and__Methods._70 (Lit refType this)))
))))
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h T@U) ($o T@U) ) (!  (=> (and (and ($IsGoodHeap $h) (and (or (not (= $o null)) (not true)) (= (dtype $o) Tclass._module.DigitUnderscore__Names__Functions__and__Methods?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) alloc)))) ($IsAlloc HandleTypeType (_module.DigitUnderscore__Names__Functions__and__Methods._90 $o) (Tclass._System.___hTotalFunc0 TInt) $h))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |11024|
 :pattern ( (_module.DigitUnderscore__Names__Functions__and__Methods._90 $o) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) alloc)))
))))
...
(assert (forall (($o@@0 T@U) ) (! (= ($Is refType $o@@0 Tclass._module.DigitUnderscore__Names__Functions__and__Methods?)  (or (= $o@@0 null) (= (dtype $o@@0) Tclass._module.DigitUnderscore__Names__Functions__and__Methods?)))
 :qid |unknown.0:0|
 :skolemid |11015|
 :pattern ( ($Is refType $o@@0 Tclass._module.DigitUnderscore__Names__Functions__and__Methods?))
)))
...
(assert (forall ((|c#0@@0| T@U) ($h@@3 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.DigitUnderscore__Names__Functions__and__Methods $h@@3) ($IsAlloc refType |c#0@@0| Tclass._module.DigitUnderscore__Names__Functions__and__Methods? $h@@3))
 :qid |unknown.0:0|
 :skolemid |11085|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.DigitUnderscore__Names__Functions__and__Methods $h@@3))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.DigitUnderscore__Names__Functions__and__Methods? $h@@3))
)))
...
(assert (forall (($o@@2 T@U) ($h@@5 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.DigitUnderscore__Names__Functions__and__Methods? $h@@5)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |11016|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.DigitUnderscore__Names__Functions__and__Methods? $h@@5))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($o@@3 T@U) ) (!  (=> (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass._module.DigitUnderscore__Names__Functions__and__Methods?)) ($Is HandleTypeType (_module.DigitUnderscore__Names__Functions__and__Methods._90 $o@@3) (Tclass._System.___hTotalFunc0 TInt)))
 :qid |unknown.0:0|
 :skolemid |11023|
 :pattern ( (_module.DigitUnderscore__Names__Functions__and__Methods._90 $o@@3))
))))
...
(assert (forall ((bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 Tclass._module.DigitUnderscore__Names__Functions__and__Methods?) (and (= ($Box refType ($Unbox refType bx@@5)) bx@@5) ($Is refType ($Unbox refType bx@@5) Tclass._module.DigitUnderscore__Names__Functions__and__Methods?)))
 :qid |unknown.0:0|
 :skolemid |11014|
 :pattern ( ($IsBox bx@@5 Tclass._module.DigitUnderscore__Names__Functions__and__Methods?))
)))
(assert (forall ((bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 Tclass._module.DigitUnderscore__Names__Functions__and__Methods) (and (= ($Box refType ($Unbox refType bx@@6)) bx@@6) ($Is refType ($Unbox refType bx@@6) Tclass._module.DigitUnderscore__Names__Functions__and__Methods)))
 :qid |unknown.0:0|
 :skolemid |11017|
 :pattern ( ($IsBox bx@@6 Tclass._module.DigitUnderscore__Names__Functions__and__Methods))
)))
...
(assert (forall ((|c#0@@2| T@U) ) (! (= ($Is refType |c#0@@2| Tclass._module.DigitUnderscore__Names__Functions__and__Methods)  (and ($Is refType |c#0@@2| Tclass._module.DigitUnderscore__Names__Functions__and__Methods?) (or (not (= |c#0@@2| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |11084|
 :pattern ( ($Is refType |c#0@@2| Tclass._module.DigitUnderscore__Names__Functions__and__Methods))
 :pattern ( ($Is refType |c#0@@2| Tclass._module.DigitUnderscore__Names__Functions__and__Methods?))
)))
(assert (forall ((this@@0 T@U) ) (! (= (_module.DigitUnderscore__Names__Functions__and__Methods._90 this@@0) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#13| (Handle0 (|lambda#9| ($Box intType (int_2_U (LitInt 92)))) (|lambda#10| true) (|lambda#12| (SetRef_to_SetBox (|lambda#11| false))))) ($LS $LZ))))
 :qid |Compilationlegacydfy.342:9|
 :skolemid |11022|
 :pattern ( (_module.DigitUnderscore__Names__Functions__and__Methods._90 this@@0))
)))
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#9| |l#0|) |$l#0#heap#0|) |l#0|)
 :qid |unknown.0:0|
 :skolemid |11320|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) BoxType (|lambda#9| |l#0|) |$l#0#heap#0|))
)))
(assert (forall ((|l#0@@0| Bool) (|$l#0#heap#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#10| |l#0@@0|) |$l#0#heap#0@@0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |11321|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) boolType (|lambda#10| |l#0@@0|) |$l#0#heap#0@@0|))
)))
(assert (forall ((|l#0@@1| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType0Select refType boolType (|lambda#11| |l#0@@1|) |$l#0#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |11322|
 :pattern ( (MapType0Select refType boolType (|lambda#11| |l#0@@1|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#0#heap#0@@1| T@U) ) (! (= (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#12| |l#0@@2|) |$l#0#heap#0@@1|) |l#0@@2|)
 :qid |Compilationlegacydfy.342:15|
 :skolemid |11323|
 :pattern ( (MapType0Select (MapType0Type refType (MapType0Type FieldType BoxType)) SetType (|lambda#12| |l#0@@2|) |$l#0#heap#0@@1|))
)))
(assert (forall ((|l#0@@3| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType0Select LayerTypeType HandleTypeType (|lambda#13| |l#0@@3|) |$l#0#ly#0|) |l#0@@3|)
 :qid |Compilationlegacydfy.342:15|
 :skolemid |11324|
 :pattern ( (MapType0Select LayerTypeType HandleTypeType (|lambda#13| |l#0@@3|) |$l#0#ly#0|))
)))
...
(assert (forall ((|l#0@@4| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@5 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1| |l#2| |l#3|) $o@@5 $f))  (=> (and (or (not (= $o@@5 |l#0@@4|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |11318|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@4| |l#1| |l#2| |l#3|) $o@@5 $f))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@1 T@U) ) (!  (=> (or (|_module.DigitUnderscore__Names__Functions__and__Methods._70#canCall| this@@1) (and (< 0 $FunctionContextHeight) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.DigitUnderscore__Names__Functions__and__Methods)))) (= (_module.DigitUnderscore__Names__Functions__and__Methods._70 this@@1) (LitInt 80)))
 :qid |Compilationlegacydfy.336:18|
 :skolemid |11020|
 :pattern ( (_module.DigitUnderscore__Names__Functions__and__Methods._70 this@@1))
))))
...
(declare-fun |m#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.DigitUnderscore__Names__Functions__and__Methods._567)
...
(let ((anon3_Then_correct  (=> (and (< 0 |y#0|) ($IsAllocBox ($Box refType this@@2) Tclass._module.DigitUnderscore__Names__Functions__and__Methods? $Heap)) (=> (and (and (|_module.DigitUnderscore__Names__Functions__and__Methods._70#canCall| this@@2) (|_module.DigitUnderscore__Names__Functions__and__Methods._70#canCall| this@@2)) (and (= |g#0_0@0| (_module.DigitUnderscore__Names__Functions__and__Methods._70 this@@2)) (= |y##0_0@0| (- |y#0| 1)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (<= 0 |y#0|) (= |y##0_0@0| |y#0|))) (=> (or (<= 0 |y#0|) (= |y##0_0@0| |y#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< |y##0_0@0| |y#0|)) (=> (< |y##0_0@0| |y#0|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |Compilationlegacydfy.343:10|
 :skolemid |11026|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
))) (and ($HeapSucc $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) (= |g#0_0@0| (LitInt 80)))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |m#0@0| (_module.DigitUnderscore__Names__Functions__and__Methods._90 this@@2)) (= |k#0@0| (U_2_int ($Unbox intType (Apply0 TInt $Heap (_module.DigitUnderscore__Names__Functions__and__Methods._90 this@@2)))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= |k#0@0| (LitInt 92))) (=> (= |k#0@0| (LitInt 92)) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.DigitUnderscore__Names__Functions__and__Methods) ($IsAlloc refType this@@2 Tclass._module.DigitUnderscore__Names__Functions__and__Methods $Heap)))) (=> (and (and (and ($Is HandleTypeType |m#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |m#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 6))) anon0_correct))))
