...
(set-info :boogie-vc-id Impl$$_module.__default.DownDiagonal)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| |n#0|)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 8)) (and (<= 0 (- (- |n#0| 1) |i#0_0@0|)) (< (- (- |n#0| 1) |i#0_0@0|) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (- (- |n#0| 1) |i#0_0@0|))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (- (- |n#0| 1) |i#0_0@0|)))) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| |n#0|)) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 6) (- 0 5)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (- (- |n#0| 1) |i#0_0@0|)) (IndexField (- (- |n#0| 1) |i#0_1@0|)))) (not true))) (= |i#0_0@0| |i#0_1@0|)))))))))))
...
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (_System.array.Length $nw@0) |n#0|)) (=> (= (_System.array.Length $nw@0) |n#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| |n#0|)) (= (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#1|)))) |i#1|) (- |n#0| 1)))
 :qid |Inversesdfy.173:18|
 :skolemid |646|
