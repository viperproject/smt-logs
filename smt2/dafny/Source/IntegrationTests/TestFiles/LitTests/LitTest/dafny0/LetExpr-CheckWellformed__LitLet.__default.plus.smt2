...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| T@U) (|m#0| T@U) ) (!  (=> (or (|LitLet.__default.plus#canCall| (Lit DatatypeTypeType |n#0|) (Lit DatatypeTypeType |m#0|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0| Tclass.LitLet.Nat)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (LitLet.Nat.O_q (Lit DatatypeTypeType |n#0|)))))) (let ((|n'#3| (Lit DatatypeTypeType (LitLet.Nat.pred (Lit DatatypeTypeType |n#0|)))))
(|LitLet.__default.plus#canCall| |n'#3| (Lit DatatypeTypeType |m#0|)))) (= (LitLet.__default.plus ($LS $ly) (Lit DatatypeTypeType |n#0|) (Lit DatatypeTypeType |m#0|)) (ite (LitLet.Nat.O_q (Lit DatatypeTypeType |n#0|)) |m#0| (let ((|n'#2| (Lit DatatypeTypeType (LitLet.Nat.pred (Lit DatatypeTypeType |n#0|)))))
(Lit DatatypeTypeType (|#LitLet.Nat.S| (Lit DatatypeTypeType (LitLet.__default.plus ($LS $ly) |n'#2| (Lit DatatypeTypeType |m#0|))))))))))
 :qid |LetExprdfy.410:18|
 :weight 3
 :skolemid |1668|
 :pattern ( (LitLet.__default.plus ($LS $ly) (Lit DatatypeTypeType |n#0|) (Lit DatatypeTypeType |m#0|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| T@U) (|m#0@@0| T@U) ) (!  (=> (or (|LitLet.__default.plus#canCall| |n#0@@0| |m#0@@0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@0| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0@@0| Tclass.LitLet.Nat)))) ($Is DatatypeTypeType (LitLet.__default.plus $ly@@0 |n#0@@0| |m#0@@0|) Tclass.LitLet.Nat))
 :qid |LetExprdfy.410:18|
 :skolemid |1665|
 :pattern ( (LitLet.__default.plus $ly@@0 |n#0@@0| |m#0@@0|))
))))
(assert (forall (($ly@@1 T@U) (|n#0@@1| T@U) (|m#0@@1| T@U) ) (! (= (LitLet.__default.plus ($LS $ly@@1) |n#0@@1| |m#0@@1|) (LitLet.__default.plus $ly@@1 |n#0@@1| |m#0@@1|))
 :qid |LetExprdfy.410:18|
 :skolemid |1662|
 :pattern ( (LitLet.__default.plus ($LS $ly@@1) |n#0@@1| |m#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|n#0@@2| T@U) (|m#0@@2| T@U) ) (!  (=> (or (|LitLet.__default.plus#canCall| |n#0@@2| |m#0@@2|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |n#0@@2| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0@@2| Tclass.LitLet.Nat)))) (and (=> (not (LitLet.Nat.O_q |n#0@@2|)) (let ((|n'#1| (LitLet.Nat.pred |n#0@@2|)))
(|LitLet.__default.plus#canCall| |n'#1| |m#0@@2|))) (= (LitLet.__default.plus ($LS $ly@@2) |n#0@@2| |m#0@@2|) (ite (LitLet.Nat.O_q |n#0@@2|) |m#0@@2| (let ((|n'#0| (LitLet.Nat.pred |n#0@@2|)))
(|#LitLet.Nat.S| (LitLet.__default.plus $ly@@2 |n'#0| |m#0@@2|)))))))
 :qid |LetExprdfy.410:18|
 :skolemid |1667|
 :pattern ( (LitLet.__default.plus ($LS $ly@@2) |n#0@@2| |m#0@@2|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$LitLet.__default.plus)
...
(let ((anon10_Then_correct  (=> (and (and (and (= |n#0@@3| (|#LitLet.Nat.S| |_mcc#0#0|)) ($Is DatatypeTypeType |_mcc#0#0| Tclass.LitLet.Nat)) (and (= |let#0#0#0| |_mcc#0#0|) ($Is DatatypeTypeType |let#0#0#0| Tclass.LitLet.Nat))) (and (and (= |n'#Z#0@0| |let#0#0#0|) ($IsAlloc DatatypeTypeType |n'#Z#0@0| Tclass.LitLet.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |m#0@@3| Tclass.LitLet.Nat $Heap) (= (ControlFlow 0 4) (- 0 3))))) (or (< (DtRank |n'#Z#0@0|) (DtRank |n#0@@3|)) (and (= (DtRank |n'#Z#0@0|) (DtRank |n#0@@3|)) (< (DtRank |m#0@@3|) (DtRank |m#0@@3|)))))))
(let ((anon9_Else_correct  (=> (or (not (= |n#0@@3| |#LitLet.Nat.O|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |n#0@@3| Tclass.LitLet.Nat) ($Is DatatypeTypeType |m#0@@3| Tclass.LitLet.Nat)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
