...
(declare-fun _module.__default.elems (T@U T@U T@U) T@U)
...
(declare-fun |_module.__default.elems#canCall| (T@U T@U) Bool)
...
(assert (forall ((_module._default.elems$_T0 T@U) ($ly T@U) (|xs#0| T@U) ) (! (= (_module.__default.elems _module._default.elems$_T0 $ly |xs#0|) (_module.__default.elems _module._default.elems$_T0 $LZ |xs#0|))
 :qid |unknown.0:0|
 :skolemid |4173|
 :pattern ( (_module.__default.elems _module._default.elems$_T0 (AsFuelBottom $ly) |xs#0|))
)))
...
(assert (forall ((_module._default.elems$_T0@@0 T@U) ($ly@@0 T@U) (|xs#0@@0| T@U) ) (! (= (_module.__default.elems _module._default.elems$_T0@@0 ($LS $ly@@0) |xs#0@@0|) (_module.__default.elems _module._default.elems$_T0@@0 $ly@@0 |xs#0@@0|))
 :qid |unknown.0:0|
 :skolemid |4172|
 :pattern ( (_module.__default.elems _module._default.elems$_T0@@0 ($LS $ly@@0) |xs#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.elems$_T0@@1 T@U) ($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.elems#canCall| _module._default.elems$_T0@@1 |xs#0@@1|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@1| (Tclass._module.List _module._default.elems$_T0@@1)))) (and (=> (not (_module.List.Nil_q |xs#0@@1|)) (let ((|tail#1| (_module.List._h2 |xs#0@@1|)))
(|_module.__default.elems#canCall| _module._default.elems$_T0@@1 |tail#1|))) (= (_module.__default.elems _module._default.elems$_T0@@1 ($LS $ly@@1) |xs#0@@1|) (ite (_module.List.Nil_q |xs#0@@1|) |Set#Empty| (let ((|tail#0| (_module.List._h2 |xs#0@@1|)))
(let ((|x#0| (_module.List._h1 |xs#0@@1|)))
(|Set#Union| (|Set#UnionOne| |Set#Empty| |x#0|) (_module.__default.elems _module._default.elems$_T0@@1 $ly@@1 |tail#0|))))))))
 :qid |unknown.0:0|
 :skolemid |4177|
 :pattern ( (_module.__default.elems _module._default.elems$_T0@@1 ($LS $ly@@1) |xs#0@@1|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.elems$_T0@@2 T@U) ($ly@@2 T@U) (|xs#0@@2| T@U) ) (!  (=> (or (|_module.__default.elems#canCall| _module._default.elems$_T0@@2 (Lit DatatypeTypeType |xs#0@@2|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@2| (Tclass._module.List _module._default.elems$_T0@@2)))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)))))) (let ((|tail#3| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(|_module.__default.elems#canCall| _module._default.elems$_T0@@2 |tail#3|))) (= (_module.__default.elems _module._default.elems$_T0@@2 ($LS $ly@@2) (Lit DatatypeTypeType |xs#0@@2|)) (ite (_module.List.Nil_q (Lit DatatypeTypeType |xs#0@@2|)) |Set#Empty| (let ((|tail#2| (Lit DatatypeTypeType (_module.List._h2 (Lit DatatypeTypeType |xs#0@@2|)))))
(let ((|x#2| (Lit BoxType (_module.List._h1 (Lit DatatypeTypeType |xs#0@@2|)))))
(|Set#Union| (|Set#UnionOne| |Set#Empty| |x#2|) (_module.__default.elems _module._default.elems$_T0@@2 ($LS $ly@@2) |tail#2|))))))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |4178|
 :pattern ( (_module.__default.elems _module._default.elems$_T0@@2 ($LS $ly@@2) (Lit DatatypeTypeType |xs#0@@2|)))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (_module._default.elems$_T0@@3 T@U) ($ly@@3 T@U) (|xs#0@@3| T@U) ) (!  (=> (and (or (|_module.__default.elems#canCall| _module._default.elems$_T0@@3 |xs#0@@3|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |xs#0@@3| (Tclass._module.List _module._default.elems$_T0@@3)) ($IsAlloc DatatypeTypeType |xs#0@@3| (Tclass._module.List _module._default.elems$_T0@@3) $Heap)))) ($IsGoodHeap $Heap)) ($IsAlloc SetType (_module.__default.elems _module._default.elems$_T0@@3 $ly@@3 |xs#0@@3|) (TSet _module._default.elems$_T0@@3) $Heap))
 :qid |TypeParametersdfy.280:16|
 :skolemid |4175|
 :pattern ( ($IsAlloc SetType (_module.__default.elems _module._default.elems$_T0@@3 $ly@@3 |xs#0@@3|) (TSet _module._default.elems$_T0@@3) $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((_module._default.elems$_T0@@4 T@U) ($ly@@4 T@U) (|xs#0@@4| T@U) ) (!  (=> (or (|_module.__default.elems#canCall| _module._default.elems$_T0@@4 |xs#0@@4|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |xs#0@@4| (Tclass._module.List _module._default.elems$_T0@@4)))) ($Is SetType (_module.__default.elems _module._default.elems$_T0@@4 $ly@@4 |xs#0@@4|) (TSet _module._default.elems$_T0@@4)))
 :qid |unknown.0:0|
 :skolemid |4174|
 :pattern ( (_module.__default.elems _module._default.elems$_T0@@4 $ly@@4 |xs#0@@4|))
))))
...
(assert (forall ((d@@4 T@U) (_module.List$T@@5 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.List.Cons_q d@@4) ($IsAlloc DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@5) $h@@0))) ($IsAllocBox (_module.List._h1 d@@4) _module.List$T@@5 $h@@0))
 :qid |unknown.0:0|
 :skolemid |4334|
 :pattern ( ($IsAllocBox (_module.List._h1 d@@4) _module.List$T@@5 $h@@0))
)))
...
(assert (forall ((d@@6 T@U) (_module.List$T@@7 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 (Tclass._module.List _module.List$T@@7) $h@@1))) ($IsAlloc DatatypeTypeType (_module.List._h2 d@@6) (Tclass._module.List _module.List$T@@7) $h@@1))
 :qid |unknown.0:0|
 :skolemid |4335|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h2 d@@6) (Tclass._module.List _module.List$T@@7) $h@@1))
)))
...
(declare-fun _module._default.elems$_T0@@5 () T@U)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.elems)
...
(let ((anon10_Then_correct  (=> (= |xs#0@@5| (|#_module.List.Cons| |_mcc#0#0| |_mcc#1#0|)) (=> (and ($IsBox |_mcc#0#0| _module._default.elems$_T0@@5) ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List _module._default.elems$_T0@@5))) (=> (and (and (and (= |let#0#0#0| |_mcc#1#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List _module._default.elems$_T0@@5))) (and (= |tail#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|))) (and (and ($IsBox |let#1#0#0| _module._default.elems$_T0@@5) (= |x#Z#0@0| |let#1#0#0|)) (and ($IsAlloc DatatypeTypeType |tail#Z#0@0| (Tclass._module.List _module._default.elems$_T0@@5) $Heap@@0) (= (ControlFlow 0 4) (- 0 3))))) (< (DtRank |tail#Z#0@0|) (DtRank |xs#0@@5|)))))))
