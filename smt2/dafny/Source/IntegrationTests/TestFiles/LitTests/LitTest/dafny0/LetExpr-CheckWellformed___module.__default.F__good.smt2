...
(declare-fun _module.__default.F__good (T@U) Int)
(declare-fun |_module.__default.F__good#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|d#0| T@U) ) (!  (=> (or (|_module.__default.F__good#canCall| |d#0|) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |d#0| (Tclass._module.Tuple (Tclass._module.Tuple TBool TInt) (Tclass._module.Tuple (Tclass._module.Tuple TInt TInt) (Tclass._module.Tuple TBool TBool)))) (and (<= (LitInt 0) (U_2_int ($Unbox intType (_module.Tuple._1 ($Unbox DatatypeTypeType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._1 |d#0|)))))))) (< (U_2_int ($Unbox intType (_module.Tuple._1 ($Unbox DatatypeTypeType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._1 |d#0|))))))) 100))))) (and (and (and (_module.Tuple.Pair_q |d#0|) (and (and (_module.Tuple.Pair_q |d#0|) (_module.Tuple.Pair_q ($Unbox DatatypeTypeType (_module.Tuple._1 |d#0|)))) (_module.Tuple.Pair_q ($Unbox DatatypeTypeType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._1 |d#0|))))))) (let ((|p#0| ($Unbox DatatypeTypeType (_module.Tuple._0 |d#0|))))
(_module.Tuple.Pair_q |p#0|))) (= (_module.__default.F__good |d#0|) (let ((|y1#0| (U_2_int ($Unbox intType (_module.Tuple._1 ($Unbox DatatypeTypeType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._1 |d#0|)))))))))
(let ((|y0#0| (U_2_int ($Unbox intType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._1 |d#0|)))))))))
(let ((|x#0@@0| (U_2_int ($Unbox intType (_module.Tuple._1 ($Unbox DatatypeTypeType (_module.Tuple._0 |d#0|)))))))
(let ((|b0#0| (U_2_bool ($Unbox boolType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._0 |d#0|)))))))
(let ((|p#0@@0| ($Unbox DatatypeTypeType (_module.Tuple._0 |d#0|))))
(+ (U_2_int ($Unbox intType (_module.Tuple._1 |p#0@@0|))) (ite |b0#0| (+ |x#0@@0| |y0#0|) (+ |x#0@@0| |y1#0|)))))))))))
 :qid |LetExprdfy.298:17|
 :skolemid |2319|
 :pattern ( (_module.__default.F__good |d#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|d#0@@0| T@U) ) (!  (=> (or (|_module.__default.F__good#canCall| (Lit DatatypeTypeType |d#0@@0|)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType |d#0@@0| (Tclass._module.Tuple (Tclass._module.Tuple TBool TInt) (Tclass._module.Tuple (Tclass._module.Tuple TInt TInt) (Tclass._module.Tuple TBool TBool)))) (and (<= (LitInt 0) (LitInt (U_2_int ($Unbox intType (_module.Tuple._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._1 (Lit DatatypeTypeType |d#0@@0|)))))))))))) (< (U_2_int ($Unbox intType (_module.Tuple._1 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._1 (Lit DatatypeTypeType |d#0@@0|)))))))))) 100))))) (and (and (and (_module.Tuple.Pair_q (Lit DatatypeTypeType |d#0@@0|)) (and (and (_module.Tuple.Pair_q (Lit DatatypeTypeType |d#0@@0|)) (_module.Tuple.Pair_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._1 (Lit DatatypeTypeType |d#0@@0|)))))) (_module.Tuple.Pair_q (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._0 (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._1 (Lit DatatypeTypeType |d#0@@0|)))))))))) (let ((|p#1| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._0 (Lit DatatypeTypeType |d#0@@0|))))))
(_module.Tuple.Pair_q |p#1|))) (= (_module.__default.F__good (Lit DatatypeTypeType |d#0@@0|)) (let ((|y1#1| (U_2_int ($Unbox intType (_module.Tuple._1 ($Unbox DatatypeTypeType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._1 (Lit DatatypeTypeType |d#0@@0|))))))))))
(let ((|y0#1| (U_2_int ($Unbox intType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._1 (Lit DatatypeTypeType |d#0@@0|))))))))))
(let ((|x#1| (U_2_int ($Unbox intType (_module.Tuple._1 ($Unbox DatatypeTypeType (_module.Tuple._0 (Lit DatatypeTypeType |d#0@@0|))))))))
(let ((|b0#1| (U_2_bool ($Unbox boolType (_module.Tuple._0 ($Unbox DatatypeTypeType (_module.Tuple._0 (Lit DatatypeTypeType |d#0@@0|))))))))
(let ((|p#1@@0| (Lit DatatypeTypeType ($Unbox DatatypeTypeType (_module.Tuple._0 (Lit DatatypeTypeType |d#0@@0|))))))
(+ (U_2_int ($Unbox intType (_module.Tuple._1 |p#1@@0|))) (ite |b0#1| (+ |x#1| |y0#1|) (+ |x#1| |y1#1|)))))))))))
 :qid |LetExprdfy.298:17|
 :weight 3
 :skolemid |2320|
 :pattern ( (_module.__default.F__good (Lit DatatypeTypeType |d#0@@0|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.F__good)
