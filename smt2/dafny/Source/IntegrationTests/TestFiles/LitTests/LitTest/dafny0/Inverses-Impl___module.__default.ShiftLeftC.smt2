...
(declare-fun _module._default.ShiftLeftC$T () T@U)
...
(declare-fun $LZ () T@U)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.ShiftLeftC)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 34) (let ((anon6_correct true))
(let ((anon15_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|)))) (= (ControlFlow 0 25) 20)) anon6_correct)))
(let ((anon15_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 23)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| |a#0| (IndexField |i#0@0|)))) (=> (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| |a#0| (IndexField |i#0@0|))) (=> (= |lambdaResult#0| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@0|))) (=> (and ($IsBox |lambdaResult#0| _module._default.ShiftLeftC$T) (= (ControlFlow 0 21) 20)) anon6_correct)))))))))))
(let ((anon14_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 28) 21) anon15_Then_correct) (=> (= (ControlFlow 0 28) 25) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 26) (- 0 27)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 26) 21) anon15_Then_correct) (=> (= (ControlFlow 0 26) 25) anon15_Else_correct)))))))
(let ((anon13_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#7| null |$lambdaHeap#0@0| alloc |a#0|)) (and (=> (= (ControlFlow 0 29) 26) anon14_Then_correct) (=> (= (ControlFlow 0 29) 28) anon14_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 30) 29) anon13_Then_correct) (=> (= (ControlFlow 0 30) 19) anon13_Else_correct)))))
(let ((anon10_correct  (=> (and (<= |n#0| |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (and (<= 0 (- (- (+ |i#0_0@0| 15) |n#0|) 15)) (< (- (- (+ |i#0_0@0| 15) |n#0|) 15) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (- (- (+ |i#0_0@0| 15) |n#0|) 15))))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (- (- (+ |i#0_0@0| 15) |n#0|) 15)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and ($IsAlloc intType (int_2_U |i#0_0@0|) TInt $Heap@0) (|_module.__default.Id#canCall| |i#0_0@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 (_module.__default.Id |i#0_0@0|)) (< (_module.__default.Id |i#0_0@0|) (_System.array.Length |a#0|)))) (=> (|_module.__default.Id#canCall| |i#0_0@0|) (=> (and (and (<= |n#0| |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 7) (- 0 6)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (- (- (+ |i#0_0@0| 15) |n#0|) 15)) (IndexField (- (- (+ |i#0_1@0| 15) |n#0|) 15)))) (not true))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_0@0|))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_1@0|)))))))))))))))))))
(let ((anon17_Else_correct  (=> (and (< |i#0_0@0| |n#0|) (= (ControlFlow 0 15) 7)) anon10_correct)))
(let ((anon17_Then_correct  (=> (<= |n#0| |i#0_0@0|) (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 13) 7) anon10_correct)))))
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 16) 13) anon17_Then_correct) (=> (= (ControlFlow 0 16) 15) anon17_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |r#0@0|) alloc)))))) (=> (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |r#0@0|) alloc))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (_System.array.Length |r#0@0|) (- (_System.array.Length |a#0|) |n#0|))) (=> (= (_System.array.Length |r#0@0|) (- (_System.array.Length |a#0|) |n#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|k#1| Int) ) (!  (=> (and (<= (LitInt 0) |k#1|) (< |k#1| (- (_System.array.Length |a#0|) |n#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |r#0@0|) (IndexField |k#1|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField (+ |k#1| |n#0|)))))
 :qid |Inversesdfy.45:58|
 :skolemid |520|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |r#0@0|) (IndexField |k#1|)))
)))))))))
(let ((anon16_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and ($HeapSucc $Heap@0 $Heap@1) (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (or (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@9) $f@@1) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@9) $f@@1)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= |n#0| |i#0_2|) (< |i#0_2| (_System.array.Length |a#0|))) (= $o@@9 $nw@0)) (= $f@@1 (IndexField (- (- (+ |i#0_2| 15) |n#0|) 15))))
 :qid |Inversesdfy.48:10|
 :skolemid |524|
)))
 :qid |Inversesdfy.48:3|
 :skolemid |525|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@9) $f@@1))
)))) (and (and (forall ((|i#inv#0_0| Int) ) (!  (=> (and (<= |n#0| (- (+ (+ |i#inv#0_0| 15) |n#0|) 15)) (< (- (+ (+ |i#inv#0_0| 15) |n#0|) 15) (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id (- (+ (+ |i#inv#0_0| 15) |n#0|) 15))))))
 :qid |Inversesdfy.48:10|
 :skolemid |526|
...
(let ((anon12_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.ShiftLeftC$T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (- (_System.array.Length |a#0|) |n#0|)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (- (_System.array.Length |a#0|) |n#0|))) (Requires1 TInt _module._default.ShiftLeftC$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Inversesdfy.47:8|
 :skolemid |522|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (- (_System.array.Length |a#0|) |n#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 TInt _module._default.ShiftLeftC$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |Inversesdfy.47:8|
 :skolemid |523|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 17) 16) anon16_Then_correct) (=> (= (ControlFlow 0 17) 5) anon16_Else_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 31) (- 0 33)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 31) (- 0 32)) (<= 0 (- (_System.array.Length |a#0|) |n#0|))) (=> (<= 0 (- (_System.array.Length |a#0|) |n#0|)) (and (=> (= (ControlFlow 0 31) 30) anon12_Then_correct) (=> (= (ControlFlow 0 31) 17) anon12_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array _module._default.ShiftLeftC$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.ShiftLeftC$T) $Heap)) (<= (LitInt 0) |n#0|)) (=> (and (and (and ($Is refType |r#0| (Tclass._System.array _module._default.ShiftLeftC$T)) ($IsAlloc refType |r#0| (Tclass._System.array _module._default.ShiftLeftC$T) $Heap)) (= 1 $FunctionContextHeight)) (and (<= |n#0| (_System.array.Length |a#0|)) (= (ControlFlow 0 34) 31))) anon0_correct)))))
