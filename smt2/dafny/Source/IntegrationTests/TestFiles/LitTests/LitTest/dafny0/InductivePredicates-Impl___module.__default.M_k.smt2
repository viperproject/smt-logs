...
(declare-fun |##_k#0_0_0@0| () T@U)
(declare-fun |##x#0_0_0@0| () T@U)
(declare-fun |k'#1_1@0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 40) (let ((anon19_Else_correct  (=> (=> (_module.natinf.N_q |x#0@@7|) (=> (<= (LitInt 2) (_module.natinf.n |x#0@@7|)) (|_module.__default.Even_h#canCall| (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2))))) (=> (and (and (not (and (_module.natinf.N_q |x#0@@7|) (= (_module.natinf.n |x#0@@7|) (LitInt 0)))) (not (and (and (_module.natinf.N_q |x#0@@7|) (<= (LitInt 2) (_module.natinf.n |x#0@@7|))) (_module.__default.Even_h ($LS $LZ) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2)))))) (= (ControlFlow 0 16) (- 0 15))) false))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.natinf.N_q |x#0@@7|)) (=> (_module.natinf.N_q |x#0@@7|) (=> (= (ControlFlow 0 3) (- 0 2)) (= (Mod (_module.natinf.n |x#0@@7|) (LitInt 2)) (LitInt 0)))))))
(let ((anon9_correct  (=> (=> (_module.natinf.N_q |x#0@@7|) (=> (<= (LitInt 2) (_module.natinf.n |x#0@@7|)) (|_module.__default.Even_h#canCall| (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2))))) (=> (and (and (_module.natinf.N_q |x#0@@7|) (<= (LitInt 2) (_module.natinf.n |x#0@@7|))) (_module.__default.Even_h ($LS $LZ) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2)))) (and (=> (= (ControlFlow 0 21) (- 0 28)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 21) (- 0 27)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |k#0|)) (=> (= |k##0_0_0@0| (|ORD#Minus| |k#0| (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 21) (- 0 26)) (_module.natinf.N_q |x#0@@7|)) (=> (_module.natinf.N_q |x#0@@7|) (and (=> (= (ControlFlow 0 21) (- 0 25)) ($Is intType (int_2_U (- (_module.natinf.n |x#0@@7|) 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- (_module.natinf.n |x#0@@7|) 2)) Tclass._System.nat) (=> (= |x##0_0_0@0| (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2))) (and (=> (= (ControlFlow 0 21) (- 0 24)) (or (|ORD#Less| |k##0_0_0@0| |k#0|) (and (= |k##0_0_0@0| |k#0|) (< (DtRank |x##0_0_0@0|) (DtRank |x#0@@7|))))) (=> (or (|ORD#Less| |k##0_0_0@0| |k#0|) (and (= |k##0_0_0@0| |k#0|) (< (DtRank |x##0_0_0@0|) (DtRank |x#0@@7|)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (=> (|_module.__default.Even_h#canCall| |k##0_0_0@0| |x##0_0_0@0|) (or (_module.__default.Even_h ($LS $LZ) |k##0_0_0@0| |x##0_0_0@0|) (=> (< 0 (|ORD#Offset| |k##0_0_0@0|)) (or (and (_module.natinf.N_q |x##0_0_0@0|) (= (_module.natinf.n |x##0_0_0@0|) (LitInt 0))) (and (and (_module.natinf.N_q |x##0_0_0@0|) (<= (LitInt 2) (_module.natinf.n |x##0_0_0@0|))) (_module.__default.Even_h ($LS ($LS $LZ)) (|ORD#Minus| |k##0_0_0@0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x##0_0_0@0|) 2))))))))) (=> (=> (|_module.__default.Even_h#canCall| |k##0_0_0@0| |x##0_0_0@0|) (or (_module.__default.Even_h ($LS $LZ) |k##0_0_0@0| |x##0_0_0@0|) (=> (< 0 (|ORD#Offset| |k##0_0_0@0|)) (or (and (_module.natinf.N_q |x##0_0_0@0|) (= (_module.natinf.n |x##0_0_0@0|) (LitInt 0))) (and (and (_module.natinf.N_q |x##0_0_0@0|) (<= (LitInt 2) (_module.natinf.n |x##0_0_0@0|))) (_module.__default.Even_h ($LS ($LS $LZ)) (|ORD#Minus| |k##0_0_0@0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x##0_0_0@0|) 2)))))))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> (|_module.__default.Even_h#canCall| |k##0_0_0@0| |x##0_0_0@0|) (or (_module.__default.Even_h ($LS $LZ) |k##0_0_0@0| |x##0_0_0@0|) (=> (= (LitInt 0) (|ORD#Offset| |k##0_0_0@0|)) (exists ((|_k'#0@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@1| |k##0_0_0@0|) (_module.__default.Even_h ($LS $LZ) |_k'#0@@1| |x##0_0_0@0|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2843|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#0@@1| |x##0_0_0@0|))
)))))) (=> (=> (|_module.__default.Even_h#canCall| |k##0_0_0@0| |x##0_0_0@0|) (or (_module.__default.Even_h ($LS $LZ) |k##0_0_0@0| |x##0_0_0@0|) (=> (= (LitInt 0) (|ORD#Offset| |k##0_0_0@0|)) (exists ((|_k'#0@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@2| |k##0_0_0@0|) (_module.__default.Even_h ($LS $LZ) |_k'#0@@2| |x##0_0_0@0|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2843|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#0@@2| |x##0_0_0@0|))
))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (_module.natinf.N_q |x##0_0_0@0|) (= (Mod (_module.natinf.n |x##0_0_0@0|) (LitInt 2)) (LitInt 0))) (and (= $Heap $Heap@1) (= (ControlFlow 0 21) 3))) GeneratedUnifiedExit_correct))))))))))))))))))))))
(let ((anon21_Else_correct  (=> (and (not (and (_module.natinf.N_q |x#0@@7|) (<= (LitInt 2) (_module.natinf.n |x#0@@7|)))) (= (ControlFlow 0 34) 21)) anon9_correct)))
(let ((anon21_Then_correct  (=> (and (_module.natinf.N_q |x#0@@7|) (<= (LitInt 2) (_module.natinf.n |x#0@@7|))) (and (=> (= (ControlFlow 0 29) (- 0 33)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 29) (- 0 32)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |k#0|)) (=> (and (= |##_k#0_0_0@0| (|ORD#Minus| |k#0| (|ORD#FromNat| 1))) ($IsAlloc BoxType |##_k#0_0_0@0| TORDINAL $Heap)) (and (=> (= (ControlFlow 0 29) (- 0 31)) (_module.natinf.N_q |x#0@@7|)) (=> (_module.natinf.N_q |x#0@@7|) (and (=> (= (ControlFlow 0 29) (- 0 30)) ($Is intType (int_2_U (- (_module.natinf.n |x#0@@7|) 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- (_module.natinf.n |x#0@@7|) 2)) Tclass._System.nat) (=> (and (and (= |##x#0_0_0@0| (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2))) ($IsAlloc DatatypeTypeType |##x#0_0_0@0| Tclass._module.natinf $Heap)) (and (|_module.__default.Even_h#canCall| (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2))) (= (ControlFlow 0 29) 21))) anon9_correct)))))))))))))
(let ((anon20_Else_correct  (=> (not (_module.natinf.N_q |x#0@@7|)) (and (=> (= (ControlFlow 0 37) 29) anon21_Then_correct) (=> (= (ControlFlow 0 37) 34) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (_module.natinf.N_q |x#0@@7|) (and (=> (= (ControlFlow 0 35) (- 0 36)) (_module.natinf.N_q |x#0@@7|)) (=> (_module.natinf.N_q |x#0@@7|) (and (=> (= (ControlFlow 0 35) 29) anon21_Then_correct) (=> (= (ControlFlow 0 35) 34) anon21_Else_correct)))))))
(let ((anon4_correct  (=> (and (and (_module.natinf.N_q |x#0@@7|) (= (_module.natinf.n |x#0@@7|) (LitInt 0))) (= (ControlFlow 0 17) 3)) GeneratedUnifiedExit_correct)))
(let ((anon18_Else_correct  (=> (and (not (_module.natinf.N_q |x#0@@7|)) (= (ControlFlow 0 20) 17)) anon4_correct)))
(let ((anon18_Then_correct  (=> (_module.natinf.N_q |x#0@@7|) (and (=> (= (ControlFlow 0 18) (- 0 19)) (_module.natinf.N_q |x#0@@7|)) (=> (_module.natinf.N_q |x#0@@7|) (=> (= (ControlFlow 0 18) 17) anon4_correct))))))
(let ((anon16_Then_correct  (=> (< 0 (|ORD#Offset| |k#0|)) (and (and (and (and (=> (= (ControlFlow 0 38) 16) anon19_Else_correct) (=> (= (ControlFlow 0 38) 35) anon20_Then_correct)) (=> (= (ControlFlow 0 38) 37) anon20_Else_correct)) (=> (= (ControlFlow 0 38) 18) anon18_Then_correct)) (=> (= (ControlFlow 0 38) 20) anon18_Else_correct)))))
(let ((anon14_correct  (=> (=> (|ORD#Less| |k'#1_1@0| |k#0|) (|_module.__default.Even_h#canCall| |k'#1_1@0| |x#0@@7|)) (and (=> (= (ControlFlow 0 5) (- 0 9)) (exists ((|$as#k'1_0#1_0| T@U) ) (!  (and (|ORD#Less| |$as#k'1_0#1_0| |k#0|) (_module.__default.Even_h ($LS $LZ) |$as#k'1_0#1_0| |x#0@@7|))
 :qid |InductivePredicatesdfy.34:9|
 :skolemid |2850|
))) (=> (exists ((|$as#k'1_0#1_0@@0| T@U) ) (!  (and (|ORD#Less| |$as#k'1_0#1_0@@0| |k#0|) (_module.__default.Even_h ($LS $LZ) |$as#k'1_0#1_0@@0| |x#0@@7|))
 :qid |InductivePredicatesdfy.34:9|
 :skolemid |2850|
)) (=> (and (|ORD#Less| |k'#1_0@0| |k#0|) (_module.__default.Even_h ($LS $LZ) |k'#1_0@0| |x#0@@7|)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (|ORD#Less| |k'#1_0@0| |k#0|) (and (= |k'#1_0@0| |k#0|) (< (DtRank |x#0@@7|) (DtRank |x#0@@7|))))) (=> (or (|ORD#Less| |k'#1_0@0| |k#0|) (and (= |k'#1_0@0| |k#0|) (< (DtRank |x#0@@7|) (DtRank |x#0@@7|)))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|_module.__default.Even_h#canCall| |k'#1_0@0| |x#0@@7|) (or (_module.__default.Even_h ($LS $LZ) |k'#1_0@0| |x#0@@7|) (=> (< 0 (|ORD#Offset| |k'#1_0@0|)) (or (and (_module.natinf.N_q |x#0@@7|) (= (_module.natinf.n |x#0@@7|) (LitInt 0))) (and (and (_module.natinf.N_q |x#0@@7|) (<= (LitInt 2) (_module.natinf.n |x#0@@7|))) (_module.__default.Even_h ($LS ($LS $LZ)) (|ORD#Minus| |k'#1_0@0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2))))))))) (=> (=> (|_module.__default.Even_h#canCall| |k'#1_0@0| |x#0@@7|) (or (_module.__default.Even_h ($LS $LZ) |k'#1_0@0| |x#0@@7|) (=> (< 0 (|ORD#Offset| |k'#1_0@0|)) (or (and (_module.natinf.N_q |x#0@@7|) (= (_module.natinf.n |x#0@@7|) (LitInt 0))) (and (and (_module.natinf.N_q |x#0@@7|) (<= (LitInt 2) (_module.natinf.n |x#0@@7|))) (_module.__default.Even_h ($LS ($LS $LZ)) (|ORD#Minus| |k'#1_0@0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@7|) 2)))))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|_module.__default.Even_h#canCall| |k'#1_0@0| |x#0@@7|) (or (_module.__default.Even_h ($LS $LZ) |k'#1_0@0| |x#0@@7|) (=> (= (LitInt 0) (|ORD#Offset| |k'#1_0@0|)) (exists ((|_k'#0@@3| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@3| |k'#1_0@0|) (_module.__default.Even_h ($LS $LZ) |_k'#0@@3| |x#0@@7|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2843|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#0@@3| |x#0@@7|))
)))))) (=> (=> (|_module.__default.Even_h#canCall| |k'#1_0@0| |x#0@@7|) (or (_module.__default.Even_h ($LS $LZ) |k'#1_0@0| |x#0@@7|) (=> (= (LitInt 0) (|ORD#Offset| |k'#1_0@0|)) (exists ((|_k'#0@@4| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@4| |k'#1_0@0|) (_module.__default.Even_h ($LS $LZ) |_k'#0@@4| |x#0@@7|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2843|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#0@@4| |x#0@@7|))
))))) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (_module.natinf.N_q |x#0@@7|) (= (Mod (_module.natinf.n |x#0@@7|) (LitInt 2)) (LitInt 0))) (and (= $Heap $Heap@0) (= (ControlFlow 0 5) 3))) GeneratedUnifiedExit_correct))))))))))))))
(let ((anon23_Else_correct  (=> (and (not (|ORD#Less| |k'#1_1@0| |k#0|)) (= (ControlFlow 0 11) 5)) anon14_correct)))
(let ((anon23_Then_correct  (=> (|ORD#Less| |k'#1_1@0| |k#0|) (=> (and (and ($IsAlloc BoxType |k'#1_1@0| TORDINAL $Heap) ($IsAlloc DatatypeTypeType |x#0@@7| Tclass._module.natinf $Heap)) (and (|_module.__default.Even_h#canCall| |k'#1_1@0| |x#0@@7|) (= (ControlFlow 0 10) 5))) anon14_correct))))
...
(let ((anon16_Else_correct  (=> (not (< 0 (|ORD#Offset| |k#0|))) (and (=> (= (ControlFlow 0 13) (- 0 14)) (= (|ORD#Offset| |k#0|) 0)) (=> (= (|ORD#Offset| |k#0|) 0) (and (=> (= (ControlFlow 0 13) 12) anon22_Then_correct) (=> (= (ControlFlow 0 13) 1) anon22_Else_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 39) 38) anon16_Then_correct) (=> (= (ControlFlow 0 39) 13) anon16_Else_correct)))))
