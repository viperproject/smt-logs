...
(set-info :boogie-vc-id Impl$$_module.__default.Testing8)
...
(let ((anon19_Else_correct  (=> (and (< |i#0@1| (LitInt 0)) (= (ControlFlow 0 37) 35)) anon4_correct)))
(let ((anon19_Then_correct  (=> (and (<= (LitInt 0) |i#0@1|) (= (ControlFlow 0 36) 35)) anon4_correct)))
(let ((anon18_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 38) 36) anon19_Then_correct) (=> (= (ControlFlow 0 38) 37) anon19_Else_correct)))))
...
(let ((anon24_Else_correct  (=> (and (< |j#0_0@2| 10) (= |$decr$loop#0_00@2| (- 10 |j#0_0@2|))) (and (=> (= (ControlFlow 0 13) (- 0 22)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 13) (- 0 21)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 13) (- 0 20)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0_0@1| |a#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0_0@1| |a#0| (IndexField (LitInt 0)))) (=> (and (= $Heap@4 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@3 |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 |a#0|) (IndexField (LitInt 0)) ($Box intType (int_2_U |j#0_0@2|))))) ($IsGoodHeap $Heap@4)) (and (=> (= (ControlFlow 0 13) (- 0 19)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (and (=> (= (ControlFlow 0 13) (- 0 18)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |b#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |b#0|))) (and (=> (= (ControlFlow 0 13) (- 0 17)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0_0@1| |b#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0_0@1| |b#0| (IndexField (LitInt 0)))) (=> (= $Heap@5 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@4 |b#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 |b#0|) (IndexField (LitInt 0)) ($Box intType (int_2_U |i#0@1|))))) (=> (and ($IsGoodHeap $Heap@5) (= |j#0_0@3| (+ |j#0_0@2| 1))) (and (=> (= (ControlFlow 0 13) (- 0 16)) (or (<= 0 |$decr$loop#0_00@2|) (= (- 10 |j#0_0@3|) |$decr$loop#0_00@2|))) (=> (or (<= 0 |$decr$loop#0_00@2|) (= (- 10 |j#0_0@3|) |$decr$loop#0_00@2|)) (and (=> (= (ControlFlow 0 13) (- 0 15)) (< (- 10 |j#0_0@3|) |$decr$loop#0_00@2|)) (=> (< (- 10 |j#0_0@3|) |$decr$loop#0_00@2|) (and (=> (= (ControlFlow 0 13) (- 0 14)) (=> |$w$loop#0_0@1| (<= (LitInt 0) |j#0_0@3|))) (=> (=> |$w$loop#0_0@1| (<= (LitInt 0) |j#0_0@3|)) (=> (= (ControlFlow 0 13) (- 0 12)) (=> |$w$loop#0_0@1| (<= |j#0_0@3| (LitInt 10))))))))))))))))))))))))))))
(let ((anon24_Then_correct  (=> (and (<= 10 |j#0_0@2|) (= |i#0@2| (+ |i#0@1| 1))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (< (- 10 |i#0@2|) |$decr$loop#00@1|)) (=> (< (- 10 |i#0@2|) |$decr$loop#00@1|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|)) (=> (= (ControlFlow 0 8) (- 0 7)) (=> |$w$loop#0@0| (<= |i#0@2| (LitInt 10)))))))))))))
(let ((anon22_Else_correct  (=> |$w$loop#0_0@1| (and (=> (= (ControlFlow 0 23) 8) anon24_Then_correct) (=> (= (ControlFlow 0 23) 13) anon24_Else_correct)))))
...
(let ((anon21_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@3) ($IsHeapAnchor $Heap@3)) (=> (and (and (and (and (and (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 10))) (= |$rhs#0@0| 4)) (= |$decr_init$loop#00@0| 10)) |$w$loop#0@0|) (and (<= 1 |$decr$loop#00@1|) (< |$decr$loop#00@1| 11))) (and (<= 0 |j#0_0@2|) (< |j#0_0@2| 11))) (= |$decr_init$loop#0_00@1| 10)) (and (=> |$w$loop#0_0@1| (<= (LitInt 0) |j#0_0@2|)) (=> |$w$loop#0_0@1| (<= |j#0_0@2| (LitInt 10))))) (and (and (forall (($o@@8 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@8) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@8)) (or (or (= $o@@8 |a#0|) (= $o@@8 |b#0|)) (= $o@@8 |c#0@@1|))))
 :qid |LoopModifiesdfy.141:7|
 :skolemid |529|
...
(let ((anon20_Else_correct  (=> (< |i#0@1| 10) (=> (and (= |$decr$loop#00@1| (- 10 |i#0@1|)) (= |j#0_0@1| (LitInt 0))) (and (=> (= (ControlFlow 0 30) (- 0 33)) (forall (($o@@10 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@10) alloc)))) (= $o@@10 |a#0|)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@10 $f@@3)))
 :qid |LoopModifiesdfy.141:7|
 :skolemid |528|
))) (=> (forall (($o@@11 T@U) ($f@@4 T@U) ) (!  (=> (and (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@11) alloc)))) (= $o@@11 |a#0|)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@11 $f@@4)))
 :qid |LoopModifiesdfy.141:7|
 :skolemid |528|
)) (=> (and (= |$Frame$loop#0_0@1| (|lambda#4| null $Heap@1 alloc |a#0|)) (= |$decr_init$loop#0_00@1| (- 10 |j#0_0@1|))) (and (=> (= (ControlFlow 0 30) (- 0 32)) (=> |$w$loop#0_0@1| (<= (LitInt 0) |j#0_0@1|))) (=> (=> |$w$loop#0_0@1| (<= (LitInt 0) |j#0_0@1|)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (=> |$w$loop#0_0@1| (<= |j#0_0@1| (LitInt 10)))) (=> (=> |$w$loop#0_0@1| (<= |j#0_0@1| (LitInt 10))) (=> (= (ControlFlow 0 30) 29) anon21_LoopHead_correct))))))))))))
...
(let ((anon18_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 34) 3) anon20_Then_correct) (=> (= (ControlFlow 0 34) 30) anon20_Else_correct)))))
(let ((anon17_LoopBody_correct  (and (=> (= (ControlFlow 0 39) 38) anon18_Then_correct) (=> (= (ControlFlow 0 39) 34) anon18_Else_correct))))
...
)) (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 40) 1) anon17_LoopDone_correct) (=> (= (ControlFlow 0 40) 39) anon17_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#21| null $Heap alloc |a#0| |b#0| |c#0@@1|)) (= |i#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 41) (- 0 47)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (and (=> (= (ControlFlow 0 41) (- 0 46)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |b#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |b#0|))) (and (=> (= (ControlFlow 0 41) (- 0 45)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |b#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |b#0| (IndexField (LitInt 0)))) (=> (= |$rhs#0@0| (LitInt 4)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |b#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |b#0|) (IndexField (LitInt 0)) ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 41) (- 0 44)) (forall (($o@@14 T@U) ($f@@6 T@U) ) (!  (=> (and (and (or (not (= $o@@14 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@14) alloc)))) (or (= $o@@14 |a#0|) (= $o@@14 |b#0|))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@14 $f@@6)))
 :qid |LoopModifiesdfy.136:4|
 :skolemid |525|
