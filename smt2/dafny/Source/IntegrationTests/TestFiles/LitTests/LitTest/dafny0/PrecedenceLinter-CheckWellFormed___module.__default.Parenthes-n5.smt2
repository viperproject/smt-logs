...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Parentheses3)
...
(let ((anon10_Else_correct  (=> (and (not (and (and (< |i#0| |j#0|) (< |j#0| (_System.array.Length |arr#0|))) (<= (_System.array.Length |arr#0|) (_System.array2.Length0 |m#0|)))) (= (ControlFlow 0 5) 1)) anon7_correct)))
(let ((anon10_Then_correct  (=> (and (and (< |i#0| |j#0|) (< |j#0| (_System.array.Length |arr#0|))) (<= (_System.array.Length |arr#0|) (_System.array2.Length0 |m#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (= (ControlFlow 0 2) 1) anon7_correct))))))))
(let ((anon9_Else_correct  (=> (not (and (< |i#0| |j#0|) (< |j#0| (_System.array.Length |arr#0|)))) (and (=> (= (ControlFlow 0 9) 2) anon10_Then_correct) (=> (= (ControlFlow 0 9) 5) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (and (< |i#0| |j#0|) (< |j#0| (_System.array.Length |arr#0|))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= |arr#0| null)) (not true))) (=> (or (not (= |arr#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) 2) anon10_Then_correct) (=> (= (ControlFlow 0 6) 5) anon10_Else_correct)))))))))
(let ((anon8_Else_correct  (=> (<= |j#0| |i#0|) (and (=> (= (ControlFlow 0 12) 6) anon9_Then_correct) (=> (= (ControlFlow 0 12) 9) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (< |i#0| |j#0|) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |arr#0| null)) (not true))) (=> (or (not (= |arr#0| null)) (not true)) (and (=> (= (ControlFlow 0 10) 6) anon9_Then_correct) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 13) 10) anon8_Then_correct) (=> (= (ControlFlow 0 13) 12) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |arr#0| (Tclass._System.array TInt)) ($IsAlloc refType |arr#0| (Tclass._System.array TInt) $Heap)) (and ($Is refType |m#0| (Tclass._System.array2 TInt)) ($IsAlloc refType |m#0| (Tclass._System.array2 TInt) $Heap))) (and (and (<= (LitInt 0) |i#0|) (<= (LitInt 0) |j#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 14) 13)))) anon0_correct))))
