...
(assert (forall ((|l#0| Int) (|$w#0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#16| |l#0|) |$w#0|) ($Box intType (int_2_U (Mul (U_2_int ($Unbox intType |$w#0|)) |l#0|))))
 :qid |unknown.0:0|
 :skolemid |916|
...
(assert (forall ((|l#0@@0| T@U) (|l#1| Int) (|l#2| Int) (|$w#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#15| |l#0@@0| |l#1| |l#2|) |$w#0@@0|))  (and ($IsBox |$w#0@@0| |l#0@@0|) (and (<= |l#1| (U_2_int ($Unbox intType |$w#0@@0|))) (< (U_2_int ($Unbox intType |$w#0@@0|)) |l#2|))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) ($Box intType (int_2_U (LitInt 0)))))) (LitInt 0))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) ($Box intType (int_2_U (LitInt 2)))))) (LitInt 4))))))
(let ((anon11_Else_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) ($Box intType (int_2_U (LitInt 0)))))) (LitInt 0))) (not true)) (= (ControlFlow 0 7) 3)) anon7_correct)))
(let ((anon11_Then_correct  (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |x#0@0|) ($Box intType (int_2_U (LitInt 0)))))) (LitInt 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U (LitInt 2))))) (=> (= (ControlFlow 0 5) 3) anon7_correct)))))
(let ((anon5_correct  (=> (= |x#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#15| TInt (LitInt 0) 10)) (|lambda#16| (LitInt 2)) (TMap TInt TInt))) (and (=> (= (ControlFlow 0 8) (- 0 12)) (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U 0)))) (=> (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U 0))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U 1)))) (=> (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U 1))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (not (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U 10))))) (=> (not (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U 10)))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (|Set#IsMember| (|Map#Domain| |x#0@0|) ($Box intType (int_2_U (LitInt 0))))) (and (=> (= (ControlFlow 0 8) 5) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct))))))))))))
(let ((anon10_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 10))) (= (ControlFlow 0 14) 8)) anon5_correct)))
(let ((anon10_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 10)) (= (ControlFlow 0 13) 8)) anon5_correct)))
(let ((anon9_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 16) 13) anon10_Then_correct) (=> (= (ControlFlow 0 16) 14) anon10_Else_correct)))))
(let ((anon9_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 15) 13) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |x#0| (TMap TInt TInt)) ($IsAlloc MapType |x#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
