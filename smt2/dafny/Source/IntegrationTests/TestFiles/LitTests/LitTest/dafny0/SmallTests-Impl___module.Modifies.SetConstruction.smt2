...
(assert (distinct TInt TagInt TagSet alloc Tagclass._module.Modifies? Tagclass._module.Modifies tytagFamily$Modifies)
)
...
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass._module.Modifies?) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) Tclass._module.Modifies?)))
 :qid |unknown.0:0|
 :skolemid |3326|
 :pattern ( ($IsBox bx@@0 Tclass._module.Modifies?))
)))
...
(set-info :boogie-vc-id Impl$$_module.Modifies.SetConstruction)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (not (|Set#Equal| |s#0@0| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 0)))))))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (not (|Set#Equal| |s#0@0| (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 0)))) ($Box intType (int_2_U (LitInt 1)))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (Lit SetType (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 1))))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (not (|Set#Equal| |s#0@0| |Set#Empty|))) (=> (not (|Set#Equal| |s#0@0| |Set#Empty|)) (and (=> (= (ControlFlow 0 5) 2) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Modifies) ($IsAlloc refType this Tclass._module.Modifies $Heap)))) (=> (and (and (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 5))) anon0_correct))))
