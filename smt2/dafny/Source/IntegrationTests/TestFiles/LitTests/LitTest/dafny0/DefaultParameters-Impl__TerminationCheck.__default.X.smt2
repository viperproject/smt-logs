...
(declare-fun |TerminationCheck.__default.F#canCall| (Int) Bool)
(declare-fun |##x#1@0| () Int)
(declare-fun |TerminationCheck.__default.G#canCall| (Int) Bool)
...
(set-info :boogie-vc-id Impl$$TerminationCheck.__default.X)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |r#0@0| (Lit DatatypeTypeType (|#TerminationCheck.R.R| (LitInt 5)))) (= |##x#0@0| (LitInt 5))) (=> (and (and ($IsAlloc intType (int_2_U |##x#0@0|) TInt $Heap) (|TerminationCheck.__default.F#canCall| (LitInt 5))) (and (= |##x#1@0| (LitInt 5)) ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap))) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (|TerminationCheck.__default.G#canCall| (LitInt 5)) (=> (and (and (and (|TerminationCheck.__default.F#canCall| (LitInt 5)) (|TerminationCheck.__default.G#canCall| (LitInt 5))) (= |f#0@0| (+ (TerminationCheck.__default.F ($LS $LZ) (LitInt 5)) (TerminationCheck.__default.G ($LS $LZ) (LitInt 5))))) (and (= |x##0@0| (LitInt 3)) (= (ControlFlow 0 2) (- 0 1)))) true))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |r#0| Tclass.TerminationCheck.R) ($IsAlloc DatatypeTypeType |r#0| Tclass.TerminationCheck.R $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
