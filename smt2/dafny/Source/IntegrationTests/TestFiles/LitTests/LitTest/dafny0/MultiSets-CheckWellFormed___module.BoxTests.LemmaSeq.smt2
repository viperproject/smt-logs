...
(assert (distinct TInt TagInt TagSeq alloc Tagclass._module.BoxTests? Tagclass._module.BoxTests tytagFamily$BoxTests)
)
...
(set-info :boogie-vc-id CheckWellFormed$$_module.BoxTests.LemmaSeq)
...
(let ((anon4_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |b#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (|Seq#Length| |b#0|))) (=> (and (= (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#0@0|))) (U_2_int ($Unbox intType (|Seq#Index| |b#0| |i#0@0|)))) (= (ControlFlow 0 3) 1)) anon6_correct))))))))
...
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (|Seq#Length| |a#0|))) (= (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#0@0|))) (U_2_int ($Unbox intType (|Seq#Index| |b#0| |i#0@0|))))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (<= (|Seq#Length| |a#0|) (|Seq#Length| |b#0|))) (and (and (=> (= (ControlFlow 0 8) 2) anon7_Else_correct) (=> (= (ControlFlow 0 8) 6) anon8_Then_correct)) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.BoxTests _module.BoxTests$G@@9)) ($IsAlloc refType this (Tclass._module.BoxTests _module.BoxTests$G@@9) $Heap))) (and ($Is SeqType |a#0| (TSeq TInt)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap))) (and (and ($Is SeqType |b#0| (TSeq TInt)) ($IsAlloc SeqType |b#0| (TSeq TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8)))) anon0_correct))))
