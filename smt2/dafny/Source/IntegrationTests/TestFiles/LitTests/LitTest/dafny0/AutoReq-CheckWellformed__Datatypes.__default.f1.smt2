...
(assert (distinct TInt TagInt alloc Tagclass.Datatypes.TheType |##Datatypes.TheType.TheType_builder| |##Datatypes.TheType.TheType_copier| tytagFamily$TheType)
)
...
(set-info :boogie-vc-id CheckWellformed$$Datatypes.__default.f1)
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (Datatypes.TheType.TheType__builder_q |t#0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (Datatypes.TheType.TheType__builder_q |t#0|)) (=> (Datatypes.TheType.TheType__builder_q |t#0|) (=> (> (Datatypes.TheType.x |t#0|) 3) (and (=> (= (ControlFlow 0 3) 1) anon4_Then_correct) (=> (= (ControlFlow 0 3) 2) anon4_Else_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |t#0| Tclass.Datatypes.TheType)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 3))) anon0_correct)))
