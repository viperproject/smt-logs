...
(declare-fun |_module.XList#Equal| (T@U T@U) Bool)
...
(assert (forall ((a T@U) (b T@U) ) (! (= (|_module.XList#Equal| a b) (= a b))
 :qid |unknown.0:0|
 :skolemid |2656|
 :pattern ( (|_module.XList#Equal| a b))
)))
...
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (!  (=> (and (_module.XList.XCons_q a@@0) (_module.XList.XCons_q b@@0)) (= (|_module.XList#Equal| a@@0 b@@0)  (and (= (_module.XList.Car a@@0) (_module.XList.Car b@@0)) (|_module.XList#Equal| (_module.XList.Cdr a@@0) (_module.XList.Cdr b@@0)))))
 :qid |unknown.0:0|
 :skolemid |2655|
 :pattern ( (|_module.XList#Equal| a@@0 b@@0) (_module.XList.XCons_q a@@0))
 :pattern ( (|_module.XList#Equal| a@@0 b@@0) (_module.XList.XCons_q b@@0))
)))
...
(assert (forall ((a@@2 T@U) (b@@2 T@U) ) (!  (=> (and (_module.XList.XNil_q a@@2) (_module.XList.XNil_q b@@2)) (|_module.XList#Equal| a@@2 b@@2))
 :qid |unknown.0:0|
 :skolemid |2654|
 :pattern ( (|_module.XList#Equal| a@@2 b@@2) (_module.XList.XNil_q a@@2))
 :pattern ( (|_module.XList#Equal| a@@2 b@@2) (_module.XList.XNil_q b@@2))
)))
...
(declare-fun |tl#0_0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.Destructors0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon5_Else_correct  (=> (and (and (not (_module.XList.XNil_q |d#0|)) (not (_module.XList.XCons_q |d#0|))) (= (ControlFlow 0 8) (- 0 7))) false)))
(let ((anon5_Then_correct  (=> (_module.XList.XCons_q |d#0|) (and (=> (= (ControlFlow 0 4) (- 0 6)) (_module.XList.XCons_q |d#0|)) (=> (_module.XList.XCons_q |d#0|) (=> (= |hd#0_0@0| (_module.XList.Car |d#0|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (_module.XList.XCons_q |d#0|)) (=> (_module.XList.XCons_q |d#0|) (=> (= |tl#0_0@0| (_module.XList.Cdr |d#0|)) (=> (and (|$IsA#_module.XList| |d#0|) (= (ControlFlow 0 4) (- 0 3))) (|_module.XList#Equal| |d#0| (|#_module.XList.XCons| |hd#0_0@0| |tl#0_0@0|))))))))))))
(let ((anon4_Then_correct  (=> (_module.XList.XNil_q |d#0|) (=> (and (|$IsA#_module.XList| |d#0|) (= (ControlFlow 0 2) (- 0 1))) (|_module.XList#Equal| |d#0| |#_module.XList.XNil|)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (or (_module.XList.XNil_q |d#0|) (_module.XList.XCons_q |d#0|))) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Datatypesdfy.176:14|
 :skolemid |2499|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSuccGhost $Heap $Heap@0))) (and (and (=> (= (ControlFlow 0 9) 2) anon4_Then_correct) (=> (= (ControlFlow 0 9) 4) anon5_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |d#0| Tclass._module.XList) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.XList $Heap)) (|$IsA#_module.XList| |d#0|)) (=> (and (and (and ($Is DatatypeTypeType |tl#0_0| Tclass._module.XList) ($IsAlloc DatatypeTypeType |tl#0_0| Tclass._module.XList $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))))
