...
(declare-fun _module.__default.UpwardBy2 (T@U Int) T@U)
(declare-fun |_module.__default.UpwardBy2#canCall| (Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|n#0| Int) ) (!  (=> (or (|_module.__default.Doubles#canCall| |n#0|) (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.Doubles $ly |n#0|) (Tclass._module.Stream TInt)))
 :qid |CoinductiveProofsdfy.168:16|
 :skolemid |780|
 :pattern ( (_module.__default.Doubles $ly |n#0|))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.__default.UpwardBy2#canCall| |n#0@@0|) (< 1 $FunctionContextHeight)) ($Is DatatypeTypeType (_module.__default.UpwardBy2 $ly@@0 |n#0@@0|) (Tclass._module.Stream TInt)))
 :qid |CoinductiveProofsdfy.184:16|
 :skolemid |817|
 :pattern ( (_module.__default.UpwardBy2 $ly@@0 |n#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (|n#0@@1| Int) ) (! (= (_module.__default.Doubles ($LS $ly@@1) |n#0@@1|) (_module.__default.Doubles $ly@@1 |n#0@@1|))
 :qid |CoinductiveProofsdfy.168:16|
 :skolemid |778|
 :pattern ( (_module.__default.Doubles ($LS $ly@@1) |n#0@@1|))
)))
(assert (forall (($ly@@2 T@U) (|n#0@@2| Int) ) (! (= (_module.__default.UpwardBy2 ($LS $ly@@2) |n#0@@2|) (_module.__default.UpwardBy2 $ly@@2 |n#0@@2|))
 :qid |CoinductiveProofsdfy.184:16|
 :skolemid |815|
 :pattern ( (_module.__default.UpwardBy2 ($LS $ly@@2) |n#0@@2|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@3 T@U) (|n#0@@3| Int) ) (!  (=> (or (|_module.__default.UpwardBy2#canCall| |n#0@@3|) (< 1 $FunctionContextHeight)) (and (|_module.__default.UpwardBy2#canCall| (+ |n#0@@3| 2)) (= (_module.__default.UpwardBy2 ($LS $ly@@3) |n#0@@3|) (|#_module.Stream.Cons| ($Box intType (int_2_U |n#0@@3|)) (_module.__default.UpwardBy2 $ly@@3 (+ |n#0@@3| 2))))))
 :qid |CoinductiveProofsdfy.184:16|
 :skolemid |819|
 :pattern ( (_module.__default.UpwardBy2 ($LS $ly@@3) |n#0@@3|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@4 T@U) (|n#0@@4| Int) ) (!  (=> (or (|_module.__default.Doubles#canCall| |n#0@@4|) (< 1 $FunctionContextHeight)) (and (|_module.__default.Doubles#canCall| (+ |n#0@@4| 1)) (= (_module.__default.Doubles ($LS $ly@@4) |n#0@@4|) (|#_module.Stream.Cons| ($Box intType (int_2_U (Mul (LitInt 2) |n#0@@4|))) (_module.__default.Doubles $ly@@4 (+ |n#0@@4| 1))))))
 :qid |CoinductiveProofsdfy.168:16|
 :skolemid |782|
 :pattern ( (_module.__default.Doubles ($LS $ly@@4) |n#0@@4|))
))))
...
(set-info :boogie-vc-id Impl$$_module.__default.ProveEquality_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#1|) (_module.__default.UpwardBy2 ($LS $LZ) (Mul (LitInt 2) |n#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (and (_module.Stream.Cons_q (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (_module.Stream.tail (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|)))))))))) (=> (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#1|) (_module.__default.UpwardBy2 ($LS $LZ) (Mul (LitInt 2) |n#1|))) (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (and (_module.Stream.Cons_q (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (_module.Stream.tail (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|$PrefixEq#_module.Stream| TInt TInt |_k#0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#1|) (_module.__default.UpwardBy2 ($LS $LZ) (Mul (LitInt 2) |n#1|))) (or (=> (< 0 (|ORD#Offset| |_k#0|)) (=> (_module.Stream.Cons_q (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (and (_module.Stream.Cons_q (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|))) (and (= (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)))) (U_2_int ($Unbox intType (_module.Stream.head (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|)))))) (|$PrefixEq#_module.Stream| TInt TInt (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) ($LS ($LS $LZ)) (_module.Stream.tail (_module.__default.Doubles ($LS ($LS $LZ)) |n#1|)) (_module.Stream.tail (_module.__default.UpwardBy2 ($LS ($LS $LZ)) (Mul (LitInt 2) |n#1|)))))))) (=> (and (or (not (= |_k#0| (|ORD#FromNat| 0))) (not true)) (= (|ORD#Offset| |_k#0|) 0)) (|$Eq#_module.Stream| TInt TInt ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#1|) (_module.__default.UpwardBy2 ($LS $LZ) (Mul (LitInt 2) |n#1|)))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|_k'#0| T@U) (|n#2| Int) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0|) (|$PrefixEq#_module.Stream| TInt TInt |_k'#0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n#2|) (_module.__default.UpwardBy2 ($LS $LZ) (Mul (LitInt 2) |n#2|))))
 :qid |CoinductiveProofsdfy.195:35|
 :skolemid |830|
 :pattern ( (_module.__default.UpwardBy2 ($LS $LZ) (Mul 2 |n#2|)) (|ORD#Less| |_k'#0| |_k#0|))
 :pattern ( (_module.__default.Doubles ($LS $LZ) |n#2|) (|ORD#Less| |_k'#0| |_k#0|))
)) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0|)) (=> (and (and (= |_k##0@0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1))) (= |n##0@0| (+ |n#1| 1))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (|_module.__default.Doubles#canCall| |n##0@0|) (|_module.__default.UpwardBy2#canCall| (Mul (LitInt 2) |n##0@0|))) (|$PrefixEq#_module.Stream| TInt TInt |_k##0@0| ($LS ($LS $LZ)) (_module.__default.Doubles ($LS $LZ) |n##0@0|) (_module.__default.UpwardBy2 ($LS $LZ) (Mul (LitInt 2) |n##0@0|)))) (and (= $Heap $Heap@0) (= (ControlFlow 0 4) 2))) GeneratedUnifiedExit_correct)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
