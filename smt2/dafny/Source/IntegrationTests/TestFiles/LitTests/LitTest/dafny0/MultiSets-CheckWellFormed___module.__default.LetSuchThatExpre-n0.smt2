...
(assert (forall ((s@@0 T@U) ) (!  (=> (|$let#0$canCall| s@@0) (> (|MultiSet#Multiplicity| s@@0 ($Box intType (int_2_U (|$let#0_x| s@@0)))) 0))
 :qid |MultiSetsdfy.249:24|
 :skolemid |587|
 :pattern ( (|$let#0_x| s@@0))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.LetSuchThatExpression)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon7_Else_correct true))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (> (|MultiSet#Multiplicity| |s#0| ($Box intType (int_2_U (LitInt 0)))) 0)) (exists ((|x#1| T@U) ) (! (> (|MultiSet#Multiplicity| |s#0| ($Box intType |x#1|)) 0)
 :qid |MultiSetsdfy.249:28|
 :skolemid |586|
))))))
(let ((anon6_Then_correct  (=> (or (not (= (|MultiSet#Card| |s#0|) 0)) (not true)) (and (=> (= (ControlFlow 0 5) 3) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |MultiSetsdfy.248:8|
 :skolemid |585|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 6) 5) anon6_Then_correct) (=> (= (ControlFlow 0 6) 1) anon6_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MultiSetType |s#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |s#0| (TMultiSet TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct))))
