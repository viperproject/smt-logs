...
const unique class.TrickyProvides1_mCCC.__default: ClassName;

// Constructor function declaration
function #TrickyProvides1.CCC.W.Leaf() : DatatypeType
uses {
// Constructor identifier
axiom DatatypeCtorId(#TrickyProvides1.CCC.W.Leaf()) == ##TrickyProvides1.CCC.W.Leaf;
// Constructor $Is
axiom $Is(#TrickyProvides1.CCC.W.Leaf(), Tclass.TrickyProvides1_mCCC.W());
// Constructor literal
axiom #TrickyProvides1.CCC.W.Leaf() == Lit(#TrickyProvides1.CCC.W.Leaf());
}

const unique ##TrickyProvides1.CCC.W.Leaf: DtCtorId
uses {
// Constructor identifier
axiom DatatypeCtorId(#TrickyProvides1.CCC.W.Leaf()) == ##TrickyProvides1.CCC.W.Leaf;
}

function TrickyProvides1_mCCC.W.Leaf_q(DatatypeType) : bool;

// Questionmark and identifier
axiom (forall d: DatatypeType :: 
  { TrickyProvides1_mCCC.W.Leaf_q(d) } 
  TrickyProvides1_mCCC.W.Leaf_q(d)
     <==> DatatypeCtorId(d) == ##TrickyProvides1.CCC.W.Leaf);

// Constructor questionmark has arguments
axiom (forall d: DatatypeType :: 
  { TrickyProvides1_mCCC.W.Leaf_q(d) } 
  TrickyProvides1_mCCC.W.Leaf_q(d) ==> d == #TrickyProvides1.CCC.W.Leaf());

function Tclass.TrickyProvides1_mCCC.W() : Ty
uses {
// Tclass.TrickyProvides1_mCCC.W Tag
axiom Tag(Tclass.TrickyProvides1_mCCC.W()) == Tagclass.TrickyProvides1_mCCC.W
   && TagFamily(Tclass.TrickyProvides1_mCCC.W()) == tytagFamily$W;
}

const unique Tagclass.TrickyProvides1_mCCC.W: TyTag;

// Box/unbox axiom for Tclass.TrickyProvides1_mCCC.W
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.TrickyProvides1_mCCC.W()) } 
  $IsBox(bx, Tclass.TrickyProvides1_mCCC.W())
     ==> $Box($Unbox(bx): DatatypeType) == bx
       && $Is($Unbox(bx): DatatypeType, Tclass.TrickyProvides1_mCCC.W()));

// Constructor function declaration
function #TrickyProvides1.CCC.W.Node() : DatatypeType
uses {
// Constructor identifier
axiom DatatypeCtorId(#TrickyProvides1.CCC.W.Node()) == ##TrickyProvides1.CCC.W.Node;
// Constructor $Is
axiom $Is(#TrickyProvides1.CCC.W.Node(), Tclass.TrickyProvides1_mCCC.W());
// Constructor literal
axiom #TrickyProvides1.CCC.W.Node() == Lit(#TrickyProvides1.CCC.W.Node());
}

const unique ##TrickyProvides1.CCC.W.Node: DtCtorId
uses {
// Constructor identifier
axiom DatatypeCtorId(#TrickyProvides1.CCC.W.Node()) == ##TrickyProvides1.CCC.W.Node;
}

function TrickyProvides1_mCCC.W.Node_q(DatatypeType) : bool;

// Questionmark and identifier
axiom (forall d: DatatypeType :: 
  { TrickyProvides1_mCCC.W.Node_q(d) } 
  TrickyProvides1_mCCC.W.Node_q(d)
     <==> DatatypeCtorId(d) == ##TrickyProvides1.CCC.W.Node);

// Constructor questionmark has arguments
axiom (forall d: DatatypeType :: 
  { TrickyProvides1_mCCC.W.Node_q(d) } 
  TrickyProvides1_mCCC.W.Node_q(d) ==> d == #TrickyProvides1.CCC.W.Node());

// Datatype $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(d, Tclass.TrickyProvides1_mCCC.W(), $h) } 
  $IsGoodHeap($h) && $Is(d, Tclass.TrickyProvides1_mCCC.W())
     ==> $IsAlloc(d, Tclass.TrickyProvides1_mCCC.W(), $h));

// Depth-one case-split function
function $IsA#TrickyProvides1_mCCC.W(DatatypeType) : bool;

// Depth-one case-split axiom
axiom (forall d: DatatypeType :: 
  { $IsA#TrickyProvides1_mCCC.W(d) } 
  $IsA#TrickyProvides1_mCCC.W(d)
     ==> TrickyProvides1_mCCC.W.Leaf_q(d) || TrickyProvides1_mCCC.W.Node_q(d));

// Questionmark data type disjunctivity
axiom (forall d: DatatypeType :: 
  { TrickyProvides1_mCCC.W.Node_q(d), $Is(d, Tclass.TrickyProvides1_mCCC.W()) } 
    { TrickyProvides1_mCCC.W.Leaf_q(d), $Is(d, Tclass.TrickyProvides1_mCCC.W()) } 
  $Is(d, Tclass.TrickyProvides1_mCCC.W())
     ==> TrickyProvides1_mCCC.W.Leaf_q(d) || TrickyProvides1_mCCC.W.Node_q(d));

// Datatype extensional equality declaration
function TrickyProvides1_mCCC.W#Equal(DatatypeType, DatatypeType) : bool;

// Datatype extensional equality definition: #TrickyProvides1.CCC.W.Leaf
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { TrickyProvides1_mCCC.W#Equal(a, b), TrickyProvides1_mCCC.W.Leaf_q(a) } 
    { TrickyProvides1_mCCC.W#Equal(a, b), TrickyProvides1_mCCC.W.Leaf_q(b) } 
  TrickyProvides1_mCCC.W.Leaf_q(a) && TrickyProvides1_mCCC.W.Leaf_q(b)
     ==> TrickyProvides1_mCCC.W#Equal(a, b));

// Datatype extensional equality definition: #TrickyProvides1.CCC.W.Node
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { TrickyProvides1_mCCC.W#Equal(a, b), TrickyProvides1_mCCC.W.Node_q(a) } 
    { TrickyProvides1_mCCC.W#Equal(a, b), TrickyProvides1_mCCC.W.Node_q(b) } 
  TrickyProvides1_mCCC.W.Node_q(a) && TrickyProvides1_mCCC.W.Node_q(b)
     ==> TrickyProvides1_mCCC.W#Equal(a, b));

// Datatype extensionality axiom: TrickyProvides1.CCC.W
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { TrickyProvides1_mCCC.W#Equal(a, b) } 
  TrickyProvides1_mCCC.W#Equal(a, b) <==> a == b);

const unique class.TrickyProvides1_mCCC.W: ClassName;
