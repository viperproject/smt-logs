...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon8_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((|i#3| Int) ) (!  (=> (or (< |i#3| 1) (> |i#3| 3)) (not (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U |i#3|)))))
 :qid |Mapsdfy.104:18|
 :skolemid |568|
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U |i#3|))))
)))))
(let ((anon13_Else_correct  (=> (and (not (or (< |i#2@0| 1) (> |i#2@0| 3))) (= (ControlFlow 0 6) 4)) anon8_correct)))
(let ((anon13_Then_correct  (=> (and (or (< |i#2@0| 1) (> |i#2@0| 3)) (= (ControlFlow 0 5) 4)) anon8_correct)))
(let ((anon12_Else_correct  (=> (< |i#2@0| 1) (and (=> (= (ControlFlow 0 8) 5) anon13_Then_correct) (=> (= (ControlFlow 0 8) 6) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (<= 1 |i#2@0|) (and (=> (= (ControlFlow 0 7) 5) anon13_Then_correct) (=> (= (ControlFlow 0 7) 6) anon13_Else_correct)))))
...
(let ((anon3_correct  (and (=> (= (ControlFlow 0 10) (- 0 15)) (forall ((|i#1| Int) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U |i#1|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0@0|) ($Box intType (int_2_U |i#1|))))) (Mul |i#1| |i#1|)))
 :qid |Mapsdfy.99:18|
 :skolemid |566|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0@0|) ($Box intType (int_2_U |i#1|)))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U |i#1|))))
))) (=> (forall ((|i#1@@0| T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType |i#1@@0|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0@0|) ($Box intType |i#1@@0|)))) (Mul (U_2_int |i#1@@0|) (U_2_int |i#1@@0|))))
 :qid |Mapsdfy.99:18|
 :skolemid |566|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0@0|) ($Box intType |i#1@@0|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType |i#1@@0|)))
)) (and (=> (= (ControlFlow 0 10) (- 0 14)) (not (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U 0))))) (=> (not (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U 0)))) (and (=> (= (ControlFlow 0 10) (- 0 13)) (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U 1)))) (=> (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U 1))) (and (=> (= (ControlFlow 0 10) (- 0 12)) (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U 2)))) (=> (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U 2))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U 3)))) (=> (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U 3))) (and (=> (= (ControlFlow 0 10) 9) anon11_Then_correct) (=> (= (ControlFlow 0 10) 2) anon11_Else_correct))))))))))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U |i#0@0|)))) (= (ControlFlow 0 18) 10)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U |i#0@0|))) (and (=> (= (ControlFlow 0 16) (- 0 17)) (|Set#IsMember| (|Map#Domain| |a#0@0|) ($Box intType (int_2_U |i#0@0|)))) (=> (= (ControlFlow 0 16) 10) anon3_correct)))))
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |a#0@0| (Lit MapType (|Map#Build| (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 1))) ($Box intType (int_2_U (LitInt 1)))) ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 4)))) ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 9))))))) (and (=> (= (ControlFlow 0 20) 19) anon9_Then_correct) (=> (= (ControlFlow 0 20) 1) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |a#0| (TMap TInt TInt)) ($IsAlloc MapType |a#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 21) 20))) anon0_correct))))
