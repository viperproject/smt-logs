...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (= |x##0@0| (LitInt 2))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= |x##0@0| (LitInt 3))) (=> (= |x##0@0| (LitInt 3)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (=> (= (ControlFlow 0 3) 1) anon4_Then_correct) (=> (= (ControlFlow 0 3) 2) anon4_Else_correct))))))))
