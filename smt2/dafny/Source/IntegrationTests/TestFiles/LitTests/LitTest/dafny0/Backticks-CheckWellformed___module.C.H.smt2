...
(declare-fun |_module.C.F#canCall| (T@U T@U) Bool)
(declare-fun _module.C.F (T@U T@U) Int)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.C.H#canCall| $Heap this) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap)))))) (and (|_module.C.F#canCall| $Heap this) (= (_module.C.H $Heap this) (_module.C.F $Heap this))))
 :qid |Backticksdfy.21:18|
 :skolemid |504|
 :pattern ( (_module.C.H $Heap this) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) ) (!  (=> (or (|_module.C.F#canCall| $Heap@@0 this@@0) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.C) ($IsAlloc refType this@@0 Tclass._module.C $Heap@@0)))))) (= (_module.C.F $Heap@@0 this@@0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.C.x)))))
 :qid |Backticksdfy.9:18|
 :skolemid |493|
 :pattern ( (_module.C.F $Heap@@0 this@@0) ($IsGoodHeap $Heap@@0))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> ($IsAllocBox ($Box refType this@@1) Tclass._module.C? $Heap@@1) (=> (and (= |b$reqreads#0@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@4) alloc)))) (and (= $o@@4 this@@1) (= $f@@0 _module.C.x))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |Backticksdfy.24:5|
 :skolemid |505|
))) (|_module.C.F#canCall| $Heap@@1 this@@1)) (=> (and (and (= (_module.C.H $Heap@@1 this@@1) (_module.C.F $Heap@@1 this@@1)) (|_module.C.F#canCall| $Heap@@1 this@@1)) (and ($Is intType (int_2_U (_module.C.H $Heap@@1 this@@1)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#2| null $Heap@@1 alloc this@@1)) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.C) ($IsAlloc refType this@@1 Tclass._module.C $Heap@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
