...
(set-info :boogie-vc-id Impl$$_module.Tree.EvensSumToEven_split2)
...
))))) (and (and (and (or (not (= this@@6 |#_module.Tree.Empty|)) (not true)) (= this@@6 (|#_module.Tree.Node| |_mcc#0#0_0@0| |_mcc#1#0_0@0| |_mcc#2#0_0@0|))) (and ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass._module.Tree) ($Is DatatypeTypeType |_mcc#2#0_0@0| Tclass._module.Tree))) (and (and ($Is DatatypeTypeType |right#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |right#0_0@0| Tclass._module.Tree $Heap@0)) (= |let#0_0#0#0| |_mcc#2#0_0@0|)))) (and (and (and (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.Tree) (= |right#0_0@0| |let#0_0#0#0|)) (and ($Is DatatypeTypeType |left#0_0@0| Tclass._module.Tree) ($IsAlloc DatatypeTypeType |left#0_0@0| Tclass._module.Tree $Heap@0))) (and (and (= |let#0_1#0#0| |_mcc#1#0_0@0|) ($Is DatatypeTypeType |let#0_1#0#0| Tclass._module.Tree)) (and (= |left#0_0@0| |let#0_1#0#0|) (= |let#0_2#0#0| |_mcc#0#0_0@0|)))) (and (and (and ($Is intType (int_2_U |let#0_2#0#0|) TInt) (= |x#0_0@0| |let#0_2#0#0|)) (and ($IsAllocBox ($Box DatatypeTypeType this@@6) Tclass._module.Tree $Heap@0) (|_module.Tree.Elements#canCall| this@@6))) (and (and (|_module.Tree.Elements#canCall| this@@6) (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@6) ($Box intType (int_2_U |x#0_0@0|)))) (and (< (DtRank |left#0_0@0|) (DtRank this@@6)) (= (ControlFlow 0 2) (- 0 1))))))) (forall ((|u#1@@0| Int) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType (int_2_U |u#1@@0|))) (= (Mod |u#1@@0| (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.491:21|
 :skolemid |3659|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS ($LS $LZ)) |left#0_0@0|) ($Box intType (int_2_U |u#1@@0|))))
))))))
anon0_correct))
))
(check-sat)
