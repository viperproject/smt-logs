...
(declare-fun _module._default.Sets3$_T0 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Sets3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon7_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.Sets3$_T0) (|Set#IsMember| |s#0@0| |$as#x0_0#0_0|))
 :qid |Terminationdfy.635:9|
 :skolemid |3146|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.Sets3$_T0) (|Set#IsMember| |s#0@0| |$as#x0_0#0_0@@0|))
 :qid |Terminationdfy.635:9|
 :skolemid |3146|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.Sets3$_T0) ($IsAllocBox |x#0_0@1| _module._default.Sets3$_T0 $Heap))) (|Set#IsMember| |s#0@0| |x#0_0@1|)) (and (=> (= (ControlFlow 0 6) (- 0 8)) true) (=> (= |s#0@1| (|Set#Difference| |s#0@0| (|Set#UnionOne| |Set#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| |s#0@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| |s#0@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 6) (- 0 5)) (< (|Set#Card| |s#0@1|) |$decr$loop#00@1|)))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.Sets3$_T0) ($IsAllocBox |x#0_1@1| _module._default.Sets3$_T0 $Heap))) (= (ControlFlow 0 11) 6)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |x#0_1@1| _module._default.Sets3$_T0) ($IsAllocBox |x#0_1@1| _module._default.Sets3$_T0 $Heap)) (= (ControlFlow 0 10) 6)) anon7_correct)))
(let ((anon10_Else_correct  (=> (and (and (|Set#Subset| |Set#Empty| |s#0@0|) (not (|Set#Subset| |s#0@0| |Set#Empty|))) (= |$decr$loop#00@1| (|Set#Card| |s#0@0|))) (and (=> (= (ControlFlow 0 12) 10) anon11_Then_correct) (=> (= (ControlFlow 0 12) 11) anon11_Else_correct)))))
...
(let ((anon9_Then_correct  (=> (not |$w$loop#0@0|) (=> (and (= |newtype$check#0@0| (|Set#Card| |s#0@0|)) (= (ControlFlow 0 3) (- 0 2))) (<= (LitInt 0) |newtype$check#0@0|)))))
...
(let ((anon8_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.Sets3$_T0) ($IsAllocBox |x#0_0@0| _module._default.Sets3$_T0 $Heap))) (=> (and (and (and ($Is SetType |s#0@0| (TSet _module._default.Sets3$_T0)) ($IsAlloc SetType |s#0@0| (TSet _module._default.Sets3$_T0) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.634:3|
 :skolemid |3144|
...
)) (<= (|Set#Card| |s#0@0|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 15) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 15) 14) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$decr_init$loop#00@0| (|Set#Card| |S#0|)) (= (ControlFlow 0 16) 15)) anon8_LoopHead_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |S#0| (TSet _module._default.Sets3$_T0)) ($IsAlloc SetType |S#0| (TSet _module._default.Sets3$_T0) $Heap))) (=> (and (and (and ($Is SetType |s#0| (TSet _module._default.Sets3$_T0)) ($IsAlloc SetType |s#0| (TSet _module._default.Sets3$_T0) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.Sets3$_T0) ($IsAllocBox |x#0_0| _module._default.Sets3$_T0 $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 17) 16)))) anon0_correct))))
