...
(set-info :boogie-vc-id CheckWellformed$$Nested.__default.ABC2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (and (= |##x#0@0| (Nested.__default.B ($LS $LZ) (LitInt (Nested.__default.C ($LS $LZ))))) ($IsAlloc intType (int_2_U |##x#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 (LitInt 6)) (= |##x#0@0| (LitInt 6)))) (=> (or (<= 0 (LitInt 6)) (= |##x#0@0| (LitInt 6))) (=> (= (ControlFlow 0 3) (- 0 2)) (< |##x#0@0| (LitInt 6))))))))
