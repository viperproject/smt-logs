...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3@@0| Bool) ($o@@6 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@6 $f@@0))  (=> (and (or (not (= $o@@6 |l#0@@0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1@@0| $o@@6) |l#2@@0|)))) |l#3@@0|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |592|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0@@0| |l#1@@0| |l#2@@0| |l#3@@0|) $o@@6 $f@@0))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.Testing4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon4_correct true))
(let ((anon11_Else_correct  (=> (and (< |i#0@1| (LitInt 0)) (= (ControlFlow 0 17) 15)) anon4_correct)))
(let ((anon11_Then_correct  (=> (and (<= (LitInt 0) |i#0@1|) (= (ControlFlow 0 16) 15)) anon4_correct)))
(let ((anon10_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 18) 16) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct)))))
(let ((anon12_Else_correct  (=> (and (< |i#0@1| 10) (= |$decr$loop#00@1| (- 10 |i#0@1|))) (and (=> (= (ControlFlow 0 7) (- 0 13)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 12)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 7) (- 0 11)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |a#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |a#0| (IndexField (LitInt 0)))) (=> (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (LitInt 0)) ($Box intType (int_2_U |i#0@1|))))) (=> (and ($IsGoodHeap $Heap@2) (= |i#0@2| (+ |i#0@1| 1))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 7) (- 0 9)) (< (- 10 |i#0@2|) |$decr$loop#00@1|)) (=> (< (- 10 |i#0@2|) |$decr$loop#00@1|) (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|)) (=> (= (ControlFlow 0 7) (- 0 6)) (=> |$w$loop#0@0| (<= |i#0@2| (LitInt 10)))))))))))))))))))))
(let ((anon12_Then_correct  (=> (<= 10 |i#0@1|) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 0))))))))))))
(let ((anon10_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 14) 3) anon12_Then_correct) (=> (= (ControlFlow 0 14) 7) anon12_Else_correct)))))
(let ((anon9_LoopBody_correct  (and (=> (= (ControlFlow 0 19) 18) anon10_Then_correct) (=> (= (ControlFlow 0 19) 14) anon10_Else_correct))))
(let ((anon9_LoopDone_correct true))
(let ((anon9_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (<= |i#0@1| (LitInt 10))))) (and (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7)) (= $o@@7 |a#0|)))
 :qid |LoopModifiesdfy.59:4|
 :skolemid |502|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap $Heap@0)) (and (forall (($o@@8 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@8 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@8) $f@@1)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| $o@@8 $f@@1))))
 :qid |LoopModifiesdfy.59:4|
 :skolemid |503|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@8) $f@@1))
)) (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 20) 1) anon9_LoopDone_correct) (=> (= (ControlFlow 0 20) 19) anon9_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |a#0|)) (= |i#0@0| (LitInt 0))) (and (= |$Frame$loop#0@0| (|lambda#0| null $Heap alloc false)) (= |$decr_init$loop#00@0| (- 10 |i#0@0|)))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10)))) (=> (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10))) (=> (= (ControlFlow 0 21) 20) anon9_LoopHead_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (> (_System.array.Length |a#0|) 0) (= (ControlFlow 0 24) 21))) anon0_correct))))
