...
(declare-fun |lambda#90| (T@U Int Int Bool) T@U)
...
(assert (forall ((|l#0@@1| T@U) (|l#1@@0| Int) (|l#2@@0| Int) (|l#3@@0| Bool) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#90| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0|) |$w#0|))  (and ($IsBox |$w#0| |l#0@@1|) (exists ((|a#0#0#0@@0| Int) ) (!  (and (and (and (<= |l#1@@0| |a#0#0#0@@0|) (< |a#0#0#0@@0| |l#2@@0|)) (_module.__default.Thirteen |a#0#0#0@@0|)) (= (U_2_bool ($Unbox boolType |$w#0|)) |l#3@@0|))
 :qid |Mapsdfy.300:23|
 :skolemid |745|
))))
 :qid |DafnyPreludebpl.21:1|
 :skolemid |950|
 :pattern ( (MapType0Select BoxType boolType (|lambda#90| |l#0@@1| |l#1@@0| |l#2@@0| |l#3@@0|) |$w#0|))
)))
...
(declare-fun |map$project$17#0#x#0| (Bool) Int)
...
(set-info :boogie-vc-id Impl$$_module.__default.GeneralMaps8_k_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon11_correct  (=> (forall ((|x#1| Int) ) (!  (and (=> (and (<= (LitInt 0) |x#1|) (< |x#1| 10)) (|_module.__default.Thirteen#canCall| |x#1|)) (forall ((|a#1#0#0@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) |a#1#0#0@@0|) (< |a#1#0#0@@0| 10)) (_module.__default.Thirteen |a#1#0#0@@0|)) (and (and (and (<= (LitInt 0) (|map$project$17#0#x#0| (U_2_bool (Lit boolType (bool_2_U true))))) (< (|map$project$17#0#x#0| (U_2_bool (Lit boolType (bool_2_U true)))) 10)) (_module.__default.Thirteen (|map$project$17#0#x#0| (U_2_bool (Lit boolType (bool_2_U true)))))) (= (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true))))))
 :qid |Mapsdfy.300:23|
 :skolemid |746|
 ...
 :qid |Mapsdfy.300:23|
 :skolemid |747|
 :pattern ( (_module.__default.Thirteen |x#1|))
)) (=> (and (= |c4#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#90| TBool (LitInt 0) 10 (U_2_bool (Lit boolType (bool_2_U true))))) (|lambda#48| ($Box intType (int_2_U (LitInt 6)))) (TMap TBool TInt))) (= (ControlFlow 0 3) (- 0 2))) (|Map#Equal| |c4#0@0| |Map#Empty|)))))
(let ((anon17_Else_correct  (=> (and (not (and (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 10)) (_module.__default.Thirteen |x#0@0|)) (and (and (<= (LitInt 0) |x#prime#0@0|) (< |x#prime#0@0| 10)) (_module.__default.Thirteen |x#prime#0@0|)))) (= (ControlFlow 0 6) 3)) anon11_correct)))
(let ((anon17_Then_correct  (=> (and (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 10)) (_module.__default.Thirteen |x#0@0|)) (and (and (<= (LitInt 0) |x#prime#0@0|) (< |x#prime#0@0| 10)) (_module.__default.Thirteen |x#prime#0@0|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (= (U_2_bool (Lit boolType (bool_2_U true)))  (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (LitInt 6) (LitInt 6)))) (=> (or (= (U_2_bool (Lit boolType (bool_2_U true)))  (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (LitInt 6) (LitInt 6))) (=> (= (ControlFlow 0 4) 3) anon11_correct))))))
(let ((anon16_Else_correct  (=> (not (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 10)) (_module.__default.Thirteen |x#0@0|))) (and (=> (= (ControlFlow 0 8) 4) anon17_Then_correct) (=> (= (ControlFlow 0 8) 6) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 10)) (_module.__default.Thirteen |x#0@0|)) (and (=> (= (ControlFlow 0 7) 4) anon17_Then_correct) (=> (= (ControlFlow 0 7) 6) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (not (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 10)) (_module.__default.Thirteen |x#0@0|))) (and (=> (= (ControlFlow 0 10) 7) anon16_Then_correct) (=> (= (ControlFlow 0 10) 8) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 10)) (_module.__default.Thirteen |x#0@0|)) (and (=> (= (ControlFlow 0 9) 7) anon16_Then_correct) (=> (= (ControlFlow 0 9) 8) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (not (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 10))) (and (=> (= (ControlFlow 0 12) 9) anon15_Then_correct) (=> (= (ControlFlow 0 12) 10) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (and (<= (LitInt 0) |x#0@0|) (< |x#0@0| 10)) (and ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap) (|_module.__default.Thirteen#canCall| |x#0@0|))) (and (=> (= (ControlFlow 0 11) 9) anon15_Then_correct) (=> (= (ControlFlow 0 11) 10) anon15_Else_correct)))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 16) 15) anon12_Then_correct) (=> (= (ControlFlow 0 16) 1) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |c4#0| (TMap TBool TInt)) ($IsAlloc MapType |c4#0| (TMap TBool TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 16))) anon0_correct))))
