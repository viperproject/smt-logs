...
(declare-fun |AssignmentToSetNat.__default.Pf#Handle| () T@U)
(declare-fun |AssignmentToSetNat.__default.Pg#Handle| () T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun AssignmentToSetNat.__default.Pf (T@U) T@U)
(declare-fun |AssignmentToSetNat.__default.Pf#canCall| (T@U) Bool)
...
(declare-fun AssignmentToSetNat.__default.Pg (T@U) T@U)
...
(declare-fun |AssignmentToSetNat.__default.Pg#requires| (T@U) Bool)
(declare-fun |AssignmentToSetNat.__default.Pf#requires| (T@U) Bool)
...
(declare-fun |AssignmentToSetNat.__default.Pg#canCall| (T@U) Bool)
...
(assert (forall (($bx T@U) ($heap T@U) (|$fh$0x#0| T@U) ) (! (= (|Set#IsMember| (Reads1 (TSet Tclass._System.nat) (TSet TInt) $heap |AssignmentToSetNat.__default.Pf#Handle| |$fh$0x#0|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |1042|
 :pattern ( (|Set#IsMember| (Reads1 (TSet Tclass._System.nat) (TSet TInt) $heap |AssignmentToSetNat.__default.Pf#Handle| |$fh$0x#0|) $bx))
)))
(assert (forall (($bx@@0 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (|Set#IsMember| (Reads1 (TSet TInt) (TSet Tclass._System.nat) $heap@@0 |AssignmentToSetNat.__default.Pg#Handle| |$fh$0x#0@@0|) $bx@@0) false)
 :qid |unknown.0:0|
 :skolemid |1046|
 :pattern ( (|Set#IsMember| (Reads1 (TSet TInt) (TSet Tclass._System.nat) $heap@@0 |AssignmentToSetNat.__default.Pg#Handle| |$fh$0x#0@@0|) $bx@@0))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|n#0| T@U) ) (!  (=> (or (|AssignmentToSetNat.__default.Pf#canCall| |n#0|) (and (< 0 $FunctionContextHeight) ($Is SetType |n#0| (TSet Tclass._System.nat)))) ($Is SetType (AssignmentToSetNat.__default.Pf |n#0|) (TSet TInt)))
 :qid |SubsetTypesdfy.94:15|
 :skolemid |1030|
 :pattern ( (AssignmentToSetNat.__default.Pf |n#0|))
))))
...
(assert (forall (($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (AssignmentToSetNat.__default.Pg |$fh$0x#0@@1|) ($Unbox SetType (Apply1 (TSet TInt) (TSet Tclass._System.nat) $heap@@1 |AssignmentToSetNat.__default.Pg#Handle| ($Box SetType |$fh$0x#0@@1|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1047|
 :pattern ( (AssignmentToSetNat.__default.Pg |$fh$0x#0@@1|) ($IsGoodHeap $heap@@1))
)))
...
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (AssignmentToSetNat.__default.Pf |$fh$0x#0@@2|) ($Unbox SetType (Apply1 (TSet Tclass._System.nat) (TSet TInt) $heap@@2 |AssignmentToSetNat.__default.Pf#Handle| ($Box SetType |$fh$0x#0@@2|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1043|
 :pattern ( (AssignmentToSetNat.__default.Pf |$fh$0x#0@@2|) ($IsGoodHeap $heap@@2))
)))
...
(assert (forall ((|x#0@@1| T@U) ) (!  (=> ($Is SetType |x#0@@1| (TSet TInt)) (= (|AssignmentToSetNat.__default.Pg#requires| |x#0@@1|) true))
 :qid |SubsetTypesdfy.95:15|
 :skolemid |1033|
 :pattern ( (|AssignmentToSetNat.__default.Pg#requires| |x#0@@1|))
)))
...
(assert (forall (($heap@@3 T@U) (|$fh$0x#0@@3| T@U) ) (! (= (Requires1 (TSet Tclass._System.nat) (TSet TInt) $heap@@3 |AssignmentToSetNat.__default.Pf#Handle| |$fh$0x#0@@3|) (|AssignmentToSetNat.__default.Pf#requires| ($Unbox SetType |$fh$0x#0@@3|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1041|
 :pattern ( (Requires1 (TSet Tclass._System.nat) (TSet TInt) $heap@@3 |AssignmentToSetNat.__default.Pf#Handle| |$fh$0x#0@@3|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@2| T@U) ) (!  (=> (or (|AssignmentToSetNat.__default.Pg#canCall| |x#0@@2|) (and (< 0 $FunctionContextHeight) ($Is SetType |x#0@@2| (TSet TInt)))) ($Is SetType (AssignmentToSetNat.__default.Pg |x#0@@2|) (TSet Tclass._System.nat)))
 :qid |SubsetTypesdfy.95:15|
 :skolemid |1032|
 :pattern ( (AssignmentToSetNat.__default.Pg |x#0@@2|))
))))
...
(assert (forall (($heap@@4 T@U) (|$fh$0x#0@@4| T@U) ) (! (= (Requires1 (TSet TInt) (TSet Tclass._System.nat) $heap@@4 |AssignmentToSetNat.__default.Pg#Handle| |$fh$0x#0@@4|) (|AssignmentToSetNat.__default.Pg#requires| ($Unbox SetType |$fh$0x#0@@4|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1045|
 :pattern ( (Requires1 (TSet TInt) (TSet Tclass._System.nat) $heap@@4 |AssignmentToSetNat.__default.Pg#Handle| |$fh$0x#0@@4|))
)))
...
(assert (forall ((|n#0@@0| T@U) ) (!  (=> ($Is SetType |n#0@@0| (TSet Tclass._System.nat)) (= (|AssignmentToSetNat.__default.Pf#requires| |n#0@@0|) true))
 :qid |SubsetTypesdfy.94:15|
 :skolemid |1031|
 :pattern ( (|AssignmentToSetNat.__default.Pf#requires| |n#0@@0|))
)))
...
(assert (= (Tag Tclass._System.object) Tagclass._System.object))
(assert (= (TagFamily Tclass._System.object) tytagFamily$object))
(assert (forall (($heap@@5 T@U) (|$fh$0x#0@@5| T@U) ) (! (= (Apply1 (TSet Tclass._System.nat) (TSet TInt) $heap@@5 |AssignmentToSetNat.__default.Pf#Handle| |$fh$0x#0@@5|) ($Box SetType (AssignmentToSetNat.__default.Pf ($Unbox SetType |$fh$0x#0@@5|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1040|
 :pattern ( (Apply1 (TSet Tclass._System.nat) (TSet TInt) $heap@@5 |AssignmentToSetNat.__default.Pf#Handle| |$fh$0x#0@@5|))
)))
...
(assert (forall (($heap@@6 T@U) (|$fh$0x#0@@6| T@U) ) (! (= (Apply1 (TSet TInt) (TSet Tclass._System.nat) $heap@@6 |AssignmentToSetNat.__default.Pg#Handle| |$fh$0x#0@@6|) ($Box SetType (AssignmentToSetNat.__default.Pg ($Unbox SetType |$fh$0x#0@@6|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1044|
 :pattern ( (Apply1 (TSet TInt) (TSet Tclass._System.nat) $heap@@6 |AssignmentToSetNat.__default.Pg#Handle| |$fh$0x#0@@6|))
)))
...
(set-info :boogie-vc-id Impl$$AssignmentToSetNat.__default.Q)
...
(let ((anon6_Else_correct  (=> (and (not (and ($Is SetType |u#0@0| (TSet TInt)) ($IsAlloc SetType |u#0@0| (TSet TInt) |$lambdaHeap#0@0|))) (= (ControlFlow 0 5) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (and ($Is SetType |u#0@0| (TSet TInt)) ($IsAlloc SetType |u#0@0| (TSet TInt) |$lambdaHeap#0@0|)) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| |u#0@0|)) (and ($Is SetType |lambdaResult#0| (TSet TInt)) (= (ControlFlow 0 4) 3))) anon3_correct))))
...
(let ((anon5_Else_correct  (=> (and (= |id#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#9| (Handle1 |lambda#5| (|lambda#6| (TSet TInt)) (|lambda#8| (SetRef_to_SetBox (|lambda#7| false))))) ($LS $LZ)))) (= (ControlFlow 0 2) (- 0 1))) ($Is HandleTypeType |id#0@0| (Tclass._System.___hTotalFunc1 (TSet TInt) (TSet Tclass._System.nat))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) (- 0 10)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |f#0@0| |AssignmentToSetNat.__default.Pf#Handle|) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |g#0@0| |AssignmentToSetNat.__default.Pg#Handle|) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($Is SetType |x#0@@3| (TSet Tclass._System.nat))) (=> ($Is SetType |x#0@@3| (TSet Tclass._System.nat)) (=> (= |a#0@0| ($Unbox SetType (Apply1 (TSet Tclass._System.nat) (TSet TInt) $Heap |f#0@0| ($Box SetType |x#0@@3|)))) (and (=> (= (ControlFlow 0 7) 6) anon5_Then_correct) (=> (= (ControlFlow 0 7) 2) anon5_Else_correct))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |x#0@@3| (TSet TInt)) ($IsAlloc SetType |x#0@@3| (TSet TInt) $Heap))) (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 (TSet Tclass._System.nat) (TSet TInt))) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 (TSet Tclass._System.nat) (TSet TInt)) $Heap)) true)) (=> (and (and (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 (TSet TInt) (TSet Tclass._System.nat))) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 (TSet TInt) (TSet Tclass._System.nat)) $Heap)) true) (and (and ($Is SetType |a#0| (TSet TInt)) ($IsAlloc SetType |a#0| (TSet TInt) $Heap)) true)) (and (and (and ($Is HandleTypeType |id#0| (Tclass._System.___hTotalFunc1 (TSet TInt) (TSet TInt))) ($IsAlloc HandleTypeType |id#0| (Tclass._System.___hTotalFunc1 (TSet TInt) (TSet TInt)) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 7)))) anon0_correct))))
