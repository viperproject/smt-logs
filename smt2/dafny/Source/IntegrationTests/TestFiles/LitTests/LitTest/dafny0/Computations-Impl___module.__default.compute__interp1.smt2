...
(assert (forall ((v@@3 T@U) (t0@@2 T@U) (t1@@1 T@U) ) (! (= ($Is MapType v@@3 (TMap t0@@2 t1@@1)) (forall ((bx@@5 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@3) bx@@5) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@3) bx@@5) t1@@1) ($IsBox bx@@5 t0@@2)))
...
(set-info :boogie-vc-id Impl$$_module.__default.compute__interp1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (_module.__default.interp ($LS ($LS $LZ)) (Lit MapType |Map#Empty|) (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 1))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 2))))) (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 3))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 4))))))))) (LitInt 10)))))
