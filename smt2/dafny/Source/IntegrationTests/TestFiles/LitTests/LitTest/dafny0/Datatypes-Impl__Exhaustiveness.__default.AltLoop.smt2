...
(set-info :boogie-vc-id Impl$$Exhaustiveness.__default.AltLoop)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon10_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (U_2_bool (Lit boolType (bool_2_U false))))))
(let ((anon16_Else_correct  (=> (|$IsA#Exhaustiveness.Color| |c#0@0|) (=> (and (|$IsA#Exhaustiveness.Color| |c#0@0|) (|$IsA#Exhaustiveness.Color| |c#0@0|)) (=> (and (and (and (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.A|)) (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.B|))) (not (|Exhaustiveness.Color#Equal| |c#0@0| |#Exhaustiveness.Color.C|))) (= (ControlFlow 0 9) 7)) anon10_correct)))))
(let ((anon13_Then_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 8) 7)) anon10_correct)))
(let ((anon16_Then_correct true))
(let ((anon15_Then_correct true))
(let ((anon14_Then_correct true))
(let ((anon13_Else_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (and (and (=> (= (ControlFlow 0 10) 3) anon14_Then_correct) (=> (= (ControlFlow 0 10) 4) anon15_Then_correct)) (=> (= (ControlFlow 0 10) 5) anon16_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct)))))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 11) 8) anon13_Then_correct) (=> (= (ControlFlow 0 11) 10) anon13_Else_correct)))))
