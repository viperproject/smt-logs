...
(declare-fun |ReadsAndDecreases.__default.J#canCall| () Bool)
(declare-fun ReadsAndDecreases.__default.J () Int)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$ReadsAndDecreases.__default.Jx)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) |ReadsAndDecreases.__default.J#canCall|) (and (and (or (not (= ReadsAndDecreases.__default.J 0)) (not true)) (= $Heap $Heap@0)) (and |ReadsAndDecreases.__default.J#canCall| (= (ControlFlow 0 2) (- 0 1))))) (or (not (= ReadsAndDecreases.__default.J 0)) (not true))))))
