...
(declare-fun _module.__default.ok4 (T@U T@U T@U) T@U)
(declare-fun |_module.__default.ok4#canCall| (T@U T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|c#0@@0| T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.ok4#canCall| $Heap |c#0@@0| |xs#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and ($Is refType |c#0@@0| Tclass._module.C) ($IsAlloc refType |c#0@@0| Tclass._module.C $Heap))) (and ($Is SetType |xs#0| (TSet Tclass._module.C)) ($IsAlloc SetType |xs#0| (TSet Tclass._module.C) $Heap))) (=> (|Set#IsMember| |xs#0| ($Box refType |c#0@@0|)) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@0|) _module.C.u))) 0))))) ($Is DatatypeTypeType (_module.__default.ok4 $Heap |c#0@@0| |xs#0|) Tclass._System.Tuple0))
 :qid |Readsdfy.41:16|
 :skolemid |567|
 :pattern ( (_module.__default.ok4 $Heap |c#0@@0| |xs#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|c#0@@2| T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.ok4#canCall| $Heap@@0 |c#0@@2| |xs#0@@0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap@@0) ($Is refType |c#0@@2| Tclass._module.C)) ($Is SetType |xs#0@@0| (TSet Tclass._module.C))) (=> (|Set#IsMember| |xs#0@@0| ($Box refType |c#0@@2|)) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@2|) _module.C.u))) 0))))) (= (_module.__default.ok4 $Heap@@0 |c#0@@2| |xs#0@@0|) (Lit DatatypeTypeType |#_System._tuple#0._#Make0|)))
 :qid |Readsdfy.41:16|
 :skolemid |569|
 :pattern ( (_module.__default.ok4 $Heap@@0 |c#0@@2| |xs#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ok4)
...
(let ((anon8_Else_correct  (=> (=> (|Set#IsMember| |xs#0@@1| ($Box refType |c#0@@3|)) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@3|) _module.C.u))) 0)) (=> (and (= |b$reqreads#0@1| true) (= (ControlFlow 0 7) 3)) anon4_correct))))
(let ((anon8_Then_correct  (=> (|Set#IsMember| |xs#0@@1| ($Box refType |c#0@@3|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |c#0@@3| null)) (not true))) (=> (or (not (= |c#0@@3| null)) (not true)) (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |c#0@@3| _module.C.u))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@3|) _module.C.u))) 0)) (and (= |b$reqreads#0@1| |b$reqreads#0@0|) (= (ControlFlow 0 5) 3))) anon4_correct))))))
