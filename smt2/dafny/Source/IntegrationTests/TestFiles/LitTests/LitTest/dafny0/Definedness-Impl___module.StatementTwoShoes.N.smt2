...
(set-info :boogie-vc-id Impl$$_module.StatementTwoShoes.N)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0| 0)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| 0)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Div 5 |a#0|) (Div 5 |a#0|))) (=> (= (Div 5 |a#0|) (Div 5 |a#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |b#0| 0)) (not true))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.StatementTwoShoes) ($IsAlloc refType this Tclass._module.StatementTwoShoes $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 2))) anon0_correct))))
