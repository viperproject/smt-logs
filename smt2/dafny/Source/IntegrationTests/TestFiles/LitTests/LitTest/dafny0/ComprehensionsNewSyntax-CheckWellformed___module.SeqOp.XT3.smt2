...
(declare-fun _module.SeqOp.XT3 (T@U Int) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.XT3#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.XT3#canCall| this |n#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) (= (_module.SeqOp.XT3 this |n#0|) (|Seq#Create| TInt $Heap |n#0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt (- 0 7))))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.170:12|
 :skolemid |699|
 :pattern ( (_module.SeqOp.XT3 this |n#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.XT3#canCall| this@@0 (LitInt |n#0@@0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.SeqOp) ($IsAlloc refType this@@0 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@0|)))) (= (_module.SeqOp.XT3 this@@0 (LitInt |n#0@@0|)) (|Seq#Create| TInt $Heap@@0 (LitInt |n#0@@0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt (- 0 7))))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.170:12|
 :weight 3
 :skolemid |700|
 :pattern ( (_module.SeqOp.XT3 this@@0 (LitInt |n#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.XT3#canCall| this@@1 |n#0@@1|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@1|)))) ($Is SeqType (_module.SeqOp.XT3 this@@1 |n#0@@1|) (TSeq Tclass._System.nat)))
 :qid |ComprehensionsNewSyntaxdfy.170:12|
 :skolemid |697|
 :pattern ( (_module.SeqOp.XT3 this@@1 |n#0@@1|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.XT3#canCall| (Lit refType this@@2) (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@2|)))) (= (_module.SeqOp.XT3 (Lit refType this@@2) (LitInt |n#0@@2|)) (|Seq#Create| TInt $Heap@@1 (LitInt |n#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt (- 0 7))))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.170:12|
 :weight 3
 :skolemid |701|
 :pattern ( (_module.SeqOp.XT3 (Lit refType this@@2) (LitInt |n#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.XT3)
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt (- 0 7))))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |ComprehensionsNewSyntaxdfy.171:5|
 :skolemid |702|
 ...
 :qid |ComprehensionsNewSyntaxdfy.171:5|
 :skolemid |705|
))) (=> (= (_module.SeqOp.XT3 this@@3 |n#0@@3|) (|Seq#Create| TInt $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt (- 0 7))))) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))) (=> (and ($Is SeqType (_module.SeqOp.XT3 this@@3 |n#0@@3|) (TSeq Tclass._System.nat)) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#0@0|)))))))
