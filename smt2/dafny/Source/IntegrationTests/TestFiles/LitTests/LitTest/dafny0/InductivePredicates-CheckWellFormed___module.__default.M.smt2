...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc DatatypeTypeType |x#0@@11| Tclass._module.natinf $Heap)) (and (|_module.__default.Even#canCall| |x#0@@11|) (_module.__default.Even ($LS $LZ) |x#0@@11|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (_module.natinf.N_q |x#0@@11|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (_module.natinf.N_q |x#0@@11|)) (=> (_module.natinf.N_q |x#0@@11|) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= (LitInt 2) 0)) (not true))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |x#0@@11| Tclass._module.natinf) ($IsAlloc DatatypeTypeType |x#0@@11| Tclass._module.natinf $Heap)) (|$IsA#_module.natinf| |x#0@@11|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
