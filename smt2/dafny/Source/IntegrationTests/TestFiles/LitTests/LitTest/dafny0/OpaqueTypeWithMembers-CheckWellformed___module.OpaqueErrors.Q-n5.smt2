...
(set-info :boogie-vc-id CheckWellformed$$_module.OpaqueErrors.Q)
...
(let ((anon8_Else_correct  (=> (and (< (+ (Div 100 (_module.OpaqueErrors.y this@@10)) (_module.OpaqueErrors.z this@@10)) 20) (= (ControlFlow 0 4) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> (and (<= 20 (+ (Div 100 (_module.OpaqueErrors.y this@@10)) (_module.OpaqueErrors.z this@@10))) ($IsAllocBox this@@10 Tclass._module.OpaqueErrors $Heap)) (=> (and (and (= |##u#0@0| (+ |u#0@@9| 1)) ($IsAlloc intType (int_2_U |##u#0@0|) TInt $Heap)) (and (|_module.OpaqueErrors.Q#canCall| this@@10 (+ |u#0@@9| 1)) (= (ControlFlow 0 3) 2))) anon5_correct))))
(let ((anon7_Else_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= (_module.OpaqueErrors.y this@@10) 0)) (not true))) (=> (or (not (= (_module.OpaqueErrors.y this@@10) 0)) (not true)) (and (=> (= (ControlFlow 0 5) 3) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox this@@10 Tclass._module.OpaqueErrors) ($IsAllocBox this@@10 Tclass._module.OpaqueErrors $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
