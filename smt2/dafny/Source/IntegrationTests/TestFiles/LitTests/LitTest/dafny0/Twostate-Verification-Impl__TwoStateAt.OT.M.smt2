...
(declare-fun |x#0| () T@U)
(declare-fun |y#0| () T@U)
(declare-fun TwoStateAt.OT.M$Y () T@U)
...
(set-info :boogie-vc-id Impl$$TwoStateAt.OT.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 9)) ($IsAllocBox |ot#0| (Tclass.TwoStateAt.OT TwoStateAt.OT$X) $Heap)) (=> ($IsAllocBox |ot#0| (Tclass.TwoStateAt.OT TwoStateAt.OT$X) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 8)) ($IsAllocBox |x#0| TwoStateAt.OT$X $Heap)) (=> ($IsAllocBox |x#0| TwoStateAt.OT$X $Heap) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($IsAllocBox |y#0| TwoStateAt.OT.M$Y $Heap)) (=> ($IsAllocBox |y#0| TwoStateAt.OT.M$Y $Heap) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell $Heap) (=> (and (<= (LitInt 0) |call9formal@n#0|) (= call0formal@previous$Heap@0 $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAllocBox |x#0| TwoStateAt.OT$X call0formal@previous$Heap@0)) (=> ($IsAllocBox |x#0| TwoStateAt.OT$X call0formal@previous$Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAllocBox |y#0| TwoStateAt.OT.M$Y call0formal@previous$Heap@0)) (=> ($IsAllocBox |y#0| TwoStateAt.OT.M$Y call0formal@previous$Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell call0formal@previous$Heap@0)) (=> ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell call0formal@previous$Heap@0) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |c#0@@1|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@1|) TwoStateAt.Cell.data)))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |ot#0| (Tclass.TwoStateAt.OT TwoStateAt.OT$X)) ($IsAllocBox |ot#0| (Tclass.TwoStateAt.OT TwoStateAt.OT$X) previous$Heap))) (=> (and (and (and (and ($IsBox |x#0| TwoStateAt.OT$X) ($IsAllocBox |x#0| TwoStateAt.OT$X previous$Heap)) (and ($IsBox |y#0| TwoStateAt.OT.M$Y) ($IsAllocBox |y#0| TwoStateAt.OT.M$Y previous$Heap))) (and (and ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap)) (and (<= (LitInt 0) |n#0|) (= 3 $FunctionContextHeight)))) (and (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAllocBox |ot#0| (Tclass.TwoStateAt.OT TwoStateAt.OT$X) previous$Heap) ($IsAllocBox |x#0| TwoStateAt.OT$X previous$Heap))) (and (and ($IsAllocBox |y#0| TwoStateAt.OT.M$Y previous$Heap) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap)) (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |c#0@@1|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@1|) TwoStateAt.Cell.data)))) (= (ControlFlow 0 10) 2))))) anon0_correct))))
