...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|)))) (=> (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|))) (=> (= |$rhs#0@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |x#0|)))))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |y#0|)))) (=> (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |y#0|))) (=> (and (= |$rhs#1@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |y#0|)))))) (= |m'#0@0| (|Map#Subtract| |m#0| |s#0|))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (not (|Set#IsMember| (|Map#Domain| |m'#0@0|) ($Box intType (int_2_U |x#0|))))) (=> (not (|Set#IsMember| (|Map#Domain| |m'#0@0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Set#IsMember| (|Map#Domain| |m'#0@0|) ($Box intType (int_2_U |y#0|)))) (=> (|Set#IsMember| (|Map#Domain| |m'#0@0|) ($Box intType (int_2_U |y#0|))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |m'#0@0|) ($Box intType (int_2_U |y#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#0@0|) ($Box intType (int_2_U |y#0|))))) |$rhs#1@0|)) (=> (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#0@0|) ($Box intType (int_2_U |y#0|))))) |$rhs#1@0|) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#Subset| (|Map#Domain| |m'#0@0|) (|Map#Domain| |m#0|))) (=> (|Set#Subset| (|Map#Domain| |m'#0@0|) (|Map#Domain| |m#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#Equal| (|Map#Domain| |m'#0@0|) (|Set#Difference| (|Map#Domain| |m#0|) |s#0|)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |m#0| (TMap TInt TReal)) ($IsAlloc MapType |m#0| (TMap TInt TReal) $Heap)) (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap))) (=> (and (and (and (and ($Is MapType |m'#0| (TMap TInt TReal)) ($IsAlloc MapType |m'#0| (TMap TInt TReal) $Heap)) true) (and (= 0 $FunctionContextHeight) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|))))) (and (and (|Set#IsMember| |s#0| ($Box intType (int_2_U |x#0|))) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |y#0|)))) (and (not (|Set#IsMember| |s#0| ($Box intType (int_2_U |y#0|)))) (= (ControlFlow 0 10) 2)))) anon0_correct)))))
