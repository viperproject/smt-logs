...
(declare-fun GenericPick.__default.MapPick1 (T@U T@U T@U) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |GenericPick.__default.MapPick1#canCall| (T@U T@U T@U) Bool)
(declare-fun $Is (T@T T@U T@U) Bool)
(declare-fun MapType () T@T)
(declare-fun TMap (T@U T@U) T@U)
(declare-fun |Map#Card| (T@U) Int)
(declare-fun |$let#39$canCall| (T@U T@U T@U) Bool)
(declare-fun |$let#39_x| (T@U T@U T@U) T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericPick._default.MapPick1$U T@U) (GenericPick._default.MapPick1$V T@U) ($Heap T@U) (|m#0| T@U) ) (!  (=> (or (|GenericPick.__default.MapPick1#canCall| GenericPick._default.MapPick1$U GenericPick._default.MapPick1$V |m#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is MapType |m#0| (TMap GenericPick._default.MapPick1$U GenericPick._default.MapPick1$V))) (or (not (= (|Map#Card| |m#0|) 0)) (not true))))) (and (|$let#39$canCall| GenericPick._default.MapPick1$U GenericPick._default.MapPick1$V |m#0|) (= (GenericPick.__default.MapPick1 GenericPick._default.MapPick1$U GenericPick._default.MapPick1$V |m#0|) (let ((|x#0| (|$let#39_x| GenericPick._default.MapPick1$U GenericPick._default.MapPick1$V |m#0|)))
|x#0|))))
 :qid |unknown.0:0|
 :skolemid |599|
 :pattern ( (GenericPick.__default.MapPick1 GenericPick._default.MapPick1$U GenericPick._default.MapPick1$V |m#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericPick._default.MapPick1$U@@0 T@U) (GenericPick._default.MapPick1$V@@0 T@U) ($Heap@@0 T@U) (|m#0@@0| T@U) ) (!  (=> (or (|GenericPick.__default.MapPick1#canCall| GenericPick._default.MapPick1$U@@0 GenericPick._default.MapPick1$V@@0 (Lit MapType |m#0@@0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is MapType |m#0@@0| (TMap GenericPick._default.MapPick1$U@@0 GenericPick._default.MapPick1$V@@0))) (or (not (= (|Map#Card| (Lit MapType |m#0@@0|)) 0)) (not true))))) (and (|$let#39$canCall| GenericPick._default.MapPick1$U@@0 GenericPick._default.MapPick1$V@@0 (Lit MapType |m#0@@0|)) (= (GenericPick.__default.MapPick1 GenericPick._default.MapPick1$U@@0 GenericPick._default.MapPick1$V@@0 (Lit MapType |m#0@@0|)) (let ((|x#1| (|$let#39_x| GenericPick._default.MapPick1$U@@0 GenericPick._default.MapPick1$V@@0 (Lit MapType |m#0@@0|))))
|x#1|))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |600|
 :pattern ( (GenericPick.__default.MapPick1 GenericPick._default.MapPick1$U@@0 GenericPick._default.MapPick1$V@@0 (Lit MapType |m#0@@0|)) ($IsGoodHeap $Heap@@0))
))))
(assert (forall ((GenericPick._default.MapPick1$U@@1 T@U) (GenericPick._default.MapPick1$V@@1 T@U) (m T@U) ) (!  (=> (|$let#39$canCall| GenericPick._default.MapPick1$U@@1 GenericPick._default.MapPick1$V@@1 m) (|Set#IsMember| (|Map#Domain| m) (|$let#39_x| GenericPick._default.MapPick1$U@@1 GenericPick._default.MapPick1$V@@1 m)))
 :qid |SmallTestsdfy.848:5|
 :skolemid |598|
 :pattern ( (|$let#39_x| GenericPick._default.MapPick1$U@@1 GenericPick._default.MapPick1$V@@1 m))
)))
(assert (forall ((m@@0 T@U) ) (! (= (= (|Map#Card| m@@0) 0) (= m@@0 |Map#Empty|))
 :qid |DafnyPreludebpl.1382:15|
 :skolemid |272|
 :pattern ( (|Map#Card| m@@0))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((GenericPick._default.MapPick1$U@@2 T@U) (GenericPick._default.MapPick1$V@@2 T@U) (|m#0@@1| T@U) ) (!  (=> (or (|GenericPick.__default.MapPick1#canCall| GenericPick._default.MapPick1$U@@2 GenericPick._default.MapPick1$V@@2 |m#0@@1|) (and (< 0 $FunctionContextHeight) (and ($Is MapType |m#0@@1| (TMap GenericPick._default.MapPick1$U@@2 GenericPick._default.MapPick1$V@@2)) (or (not (= (|Map#Card| |m#0@@1|) 0)) (not true))))) ($IsBox (GenericPick.__default.MapPick1 GenericPick._default.MapPick1$U@@2 GenericPick._default.MapPick1$V@@2 |m#0@@1|) GenericPick._default.MapPick1$U@@2))
 :qid |unknown.0:0|
 :skolemid |595|
 :pattern ( (GenericPick.__default.MapPick1 GenericPick._default.MapPick1$U@@2 GenericPick._default.MapPick1$V@@2 |m#0@@1|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (GenericPick._default.MapPick1$U@@3 T@U) (GenericPick._default.MapPick1$V@@3 T@U) (|m#0@@2| T@U) ) (!  (=> (and (or (|GenericPick.__default.MapPick1#canCall| GenericPick._default.MapPick1$U@@3 GenericPick._default.MapPick1$V@@3 |m#0@@2|) (and (< 0 $FunctionContextHeight) (and (and ($Is MapType |m#0@@2| (TMap GenericPick._default.MapPick1$U@@3 GenericPick._default.MapPick1$V@@3)) ($IsAlloc MapType |m#0@@2| (TMap GenericPick._default.MapPick1$U@@3 GenericPick._default.MapPick1$V@@3) $Heap@@1)) (or (not (= (|Map#Card| |m#0@@2|) 0)) (not true))))) ($IsGoodHeap $Heap@@1)) ($IsAllocBox (GenericPick.__default.MapPick1 GenericPick._default.MapPick1$U@@3 GenericPick._default.MapPick1$V@@3 |m#0@@2|) GenericPick._default.MapPick1$U@@3 $Heap@@1))
 :qid |SmallTestsdfy.845:18|
 :skolemid |596|
 :pattern ( ($IsAllocBox (GenericPick.__default.MapPick1 GenericPick._default.MapPick1$U@@3 GenericPick._default.MapPick1$V@@3 |m#0@@2|) GenericPick._default.MapPick1$U@@3 $Heap@@1))
))))
...
(assert (forall ((m@@1 T@U) ) (! (<= 0 (|Map#Card| m@@1))
...
(assert  (and (and (forall ((t0@@1 T@T) (t1 T@T) (val T@U) (m@@2 T@U) (x0 T@U) ) (! (= (MapType0Select t0@@1 t1 (MapType0Store t0@@1 t1 m@@2 x0 val) x0) val)
...
(assert (forall ((bx@@2 T@U) (s@@1 T@U) (t@@6 T@U) ) (!  (=> ($IsBox bx@@2 (TMap s@@1 t@@6)) (and (= ($Box MapType ($Unbox MapType bx@@2)) bx@@2) ($Is MapType ($Unbox MapType bx@@2) (TMap s@@1 t@@6))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@2 (TMap s@@1 t@@6)))
)))
...
(assert (forall ((m@@10 T@U) (v@@5 T@U) ) (! (= (|Set#IsMember| (|Map#Values| m@@10) v@@5) (exists ((u@@3 T@U) ) (!  (and (|Set#IsMember| (|Map#Domain| m@@10) u@@3) (= v@@5 (MapType0Select BoxType BoxType (|Map#Elements| m@@10) u@@3)))
...
(assert (forall ((m@@14 T@U) ) (!  (or (= m@@14 |Map#Empty|) (exists ((k@@0 T@U) (v@@7 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@14) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@7)))
...
(declare-fun GenericPick._default.MapPick1$U@@4 () T@U)
...
(declare-fun GenericPick._default.MapPick1$V@@4 () T@U)
(set-info :boogie-vc-id CheckWellformed$$GenericPick.__default.MapPick1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (exists ((|x#3| T@U) ) (!  (and ($IsBox |x#3| GenericPick._default.MapPick1$U@@4) (|Set#IsMember| (|Map#Domain| |m#0@@3|) |x#3|))
 :qid |SmallTestsdfy.848:9|
 :skolemid |601|
)))))
(let ((anon8_Else_correct  (=> (and (not (and ($IsBox |x#2@0| GenericPick._default.MapPick1$U@@4) ($IsAllocBox |x#2@0| GenericPick._default.MapPick1$U@@4 $Heap@@2))) (= (ControlFlow 0 5) 3)) anon5_correct)))
(let ((anon8_Then_correct  (=> (and (and ($IsBox |x#2@0| GenericPick._default.MapPick1$U@@4) ($IsAllocBox |x#2@0| GenericPick._default.MapPick1$U@@4 $Heap@@2)) (= (ControlFlow 0 4) 3)) anon5_correct)))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (or (not (= (|Map#Card| |m#0@@3|) 0)) (not true))) (and (and (=> (= (ControlFlow 0 6) 1) anon7_Then_correct) (=> (= (ControlFlow 0 6) 4) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is MapType |m#0@@3| (TMap GenericPick._default.MapPick1$U@@4 GenericPick._default.MapPick1$V@@4))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))
