...
(set-info :boogie-vc-id Impl$$_module.__default.Modify3)
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |$Frame$modify#0@0| (|lambda#0| null $Heap alloc false))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and ($HeapSuccGhost $Heap $Heap@0) (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) $f@@0)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$modify#0@0| $o@@2 $f@@0))))
 :qid |GhostAllocationsdfy.80:3|
 :skolemid |588|
