...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($o@@3 T@U) ) (!  (=> ($IsBox $o@@3 Tclass._module.OpaqueErrors) ($Is intType (int_2_U (_module.OpaqueErrors.y $o@@3)) TInt))
 :qid |unknown.0:0|
 :skolemid |631|
 :pattern ( (_module.OpaqueErrors.y $o@@3))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.OpaqueErrors.Two)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 9)) ($IsAllocBox this Tclass._module.OpaqueErrors $Heap)) (=> ($IsAllocBox this Tclass._module.OpaqueErrors $Heap) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|))) (=> (= (+ (_module.OpaqueErrors.y this) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 3)))))) (_module.OpaqueErrors.y this)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAllocBox this Tclass._module.OpaqueErrors $Heap))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox this Tclass._module.OpaqueErrors) ($IsAllocBox this Tclass._module.OpaqueErrors previous$Heap))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) previous$Heap)) (= 2 $FunctionContextHeight)) (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |a#0| (Tclass._System.array TInt) previous$Heap) (= (ControlFlow 0 10) 2)))) anon0_correct))))
