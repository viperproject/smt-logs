...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TReal)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TReal) $Heap))) (=> (and (and (and (and ($Is refType |a#0| (Tclass._System.array TReal)) ($IsAlloc refType |a#0| (Tclass._System.array TReal) $Heap)) true) (= 0 $FunctionContextHeight)) (and (forall ((|x#1| T@U) ) (!  (=> (< (U_2_int |x#1|) 25) (Requires1 TInt TReal $Heap |f#0| ($Box intType |x#1|)))
 :qid |ArrayElementInitdfy.24:19|
 :skolemid |727|
 :pattern ( (Requires1 TInt TReal $Heap |f#0| ($Box intType |x#1|)))
