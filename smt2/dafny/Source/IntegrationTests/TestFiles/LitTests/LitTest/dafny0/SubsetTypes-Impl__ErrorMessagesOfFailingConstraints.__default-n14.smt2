...
(set-info :boogie-vc-id Impl$$ErrorMessagesOfFailingConstraints.__default.m2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U |x#0@@0|) Tclass._System.nat))))
