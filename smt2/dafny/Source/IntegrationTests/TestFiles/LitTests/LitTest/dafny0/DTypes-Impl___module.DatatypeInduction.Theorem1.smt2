...
(assert (distinct TBool TInt TagBool TagInt alloc |##_module.Tree.Leaf| Tagclass._module.Tree |##_module.Tree.Branch| Tagclass._module.DatatypeInduction? Tagclass._module.DatatypeInduction tytagFamily$Tree tytagFamily$DatatypeInduction)
)
...
(assert (forall ((_module.Tree$T@@7 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._module.Tree _module.Tree$T@@7)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@1)) bx@@1) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@1) (Tclass._module.Tree _module.Tree$T@@7))))
 :qid |unknown.0:0|
 :skolemid |2066|
 :pattern ( ($IsBox bx@@1 (Tclass._module.Tree _module.Tree$T@@7)))
)))
(assert (forall ((_module.DatatypeInduction$T@@9 T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@9)) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@9))))
 :qid |unknown.0:0|
 :skolemid |2093|
 :pattern ( ($IsBox bx@@2 (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@9)))
)))
(assert (forall ((_module.DatatypeInduction$T@@10 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@10)) (and (= ($Box refType ($Unbox refType bx@@3)) bx@@3) ($Is refType ($Unbox refType bx@@3) (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@10))))
 :qid |unknown.0:0|
 :skolemid |2100|
 :pattern ( ($IsBox bx@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@10)))
)))
...
(set-info :boogie-vc-id Impl$$_module.DatatypeInduction.Theorem1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon4_correct  (=> (forall ((|t#3| T@U) ) (!  (=> ($Is DatatypeTypeType |t#3| (Tclass._module.Tree TInt)) (|_module.DatatypeInduction.LeafCount#canCall| _module.DatatypeInduction$T@@13 TInt this@@3 |t#3|))
 :qid |DTypesdfy.115:19|
 :skolemid |2130|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS $LZ) this@@3 |t#3|))
)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|t#3@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#3@@0| (Tclass._module.Tree TInt)) (forall ((|t$ih#1#0| T@U) ) (!  (=> ($Is DatatypeTypeType |t$ih#1#0| (Tclass._module.Tree TInt)) (=> (< (DtRank |t$ih#1#0|) (DtRank |t#3@@0|)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS $LZ) this@@3 |t$ih#1#0|))))
 :qid |DTypesdfy.115:19|
 :skolemid |2131|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS $LZ) this@@3 |t$ih#1#0|))
))) (and true (exists ((|a#2#0#0| T@U) ) (! (= (|#_module.Tree.Leaf| |a#2#0#0|) |t#3@@0|)
 :qid |DTypesdfy.93:25|
 :skolemid |2132|
 :pattern ( (|#_module.Tree.Leaf| |a#2#0#0|))
)))) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS ($LS $LZ)) this@@3 |t#3@@0|)))
 :qid |DTypesdfy.115:19|
 :skolemid |2134|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS ($LS $LZ)) this@@3 |t#3@@0|))
))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|t#3@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#3@@1| (Tclass._module.Tree TInt)) (forall ((|t$ih#1#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |t$ih#1#0@@0| (Tclass._module.Tree TInt)) (=> (< (DtRank |t$ih#1#0@@0|) (DtRank |t#3@@1|)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS $LZ) this@@3 |t$ih#1#0@@0|))))
 :qid |DTypesdfy.115:19|
 :skolemid |2131|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS $LZ) this@@3 |t$ih#1#0@@0|))
))) (and true (exists ((|a#3#0#0| T@U) (|a#3#1#0| T@U) ) (!  (and (and ($Is DatatypeTypeType |a#3#0#0| (Tclass._module.Tree TInt)) ($Is DatatypeTypeType |a#3#1#0| (Tclass._module.Tree TInt))) (= (|#_module.Tree.Branch| |a#3#0#0| |a#3#1#0|) |t#3@@1|))
 :qid |DTypesdfy.93:37|
 :skolemid |2133|
 :pattern ( (|#_module.Tree.Branch| |a#3#0#0| |a#3#1#0|))
)))) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS ($LS $LZ)) this@@3 |t#3@@1|)))
 :qid |DTypesdfy.115:19|
 :skolemid |2135|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS ($LS $LZ)) this@@3 |t#3@@1|))
))) (=> (forall ((|t#3@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |t#3@@2| (Tclass._module.Tree TInt)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS $LZ) this@@3 |t#3@@2|)))
 :qid |DTypesdfy.115:19|
 :skolemid |2137|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS $LZ) this@@3 |t#3@@2|))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS ($LS $LZ)) this@@3 |bt#0|))) (=> (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS ($LS $LZ)) this@@3 |bt#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TInt ($LS ($LS $LZ)) this@@3 |it#0|)))))))))))
(let ((anon6_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |t#2@0| (Tclass._module.Tree TInt)) ($IsAlloc DatatypeTypeType |t#2@0| (Tclass._module.Tree TInt) $Heap))) (= (ControlFlow 0 7) 2)) anon4_correct)))
(let ((anon6_Then_correct  (=> (and ($Is DatatypeTypeType |t#2@0| (Tclass._module.Tree TInt)) ($IsAlloc DatatypeTypeType |t#2@0| (Tclass._module.Tree TInt) $Heap)) (=> (and (and ($IsAllocBox ($Box refType this@@3) (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@13) $Heap) ($IsAlloc DatatypeTypeType |t#2@0| (Tclass._module.Tree TInt) $Heap)) (and (|_module.DatatypeInduction.LeafCount#canCall| _module.DatatypeInduction$T@@13 TInt this@@3 |t#2@0|) (= (ControlFlow 0 6) 2))) anon4_correct))))
(let ((anon2_correct  (=> (forall ((|t#1| T@U) ) (!  (=> ($Is DatatypeTypeType |t#1| (Tclass._module.Tree TBool)) (|_module.DatatypeInduction.LeafCount#canCall| _module.DatatypeInduction$T@@13 TBool this@@3 |t#1|))
 :qid |DTypesdfy.114:19|
 :skolemid |2122|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS $LZ) this@@3 |t#1|))
)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (forall ((|t#1@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#1@@0| (Tclass._module.Tree TBool)) (forall ((|t$ih#0#0| T@U) ) (!  (=> ($Is DatatypeTypeType |t$ih#0#0| (Tclass._module.Tree TBool)) (=> (< (DtRank |t$ih#0#0|) (DtRank |t#1@@0|)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS $LZ) this@@3 |t$ih#0#0|))))
 :qid |DTypesdfy.114:19|
 :skolemid |2123|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS $LZ) this@@3 |t$ih#0#0|))
))) (and true (exists ((|a#0#0#0| T@U) ) (! (= (|#_module.Tree.Leaf| |a#0#0#0|) |t#1@@0|)
 :qid |DTypesdfy.93:25|
 :skolemid |2124|
 :pattern ( (|#_module.Tree.Leaf| |a#0#0#0|))
)))) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS ($LS $LZ)) this@@3 |t#1@@0|)))
 :qid |DTypesdfy.114:19|
 :skolemid |2126|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS ($LS $LZ)) this@@3 |t#1@@0|))
))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (forall ((|t#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#1@@1| (Tclass._module.Tree TBool)) (forall ((|t$ih#0#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |t$ih#0#0@@0| (Tclass._module.Tree TBool)) (=> (< (DtRank |t$ih#0#0@@0|) (DtRank |t#1@@1|)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS $LZ) this@@3 |t$ih#0#0@@0|))))
 :qid |DTypesdfy.114:19|
 :skolemid |2123|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS $LZ) this@@3 |t$ih#0#0@@0|))
))) (and true (exists ((|a#1#0#0| T@U) (|a#1#1#0| T@U) ) (!  (and (and ($Is DatatypeTypeType |a#1#0#0| (Tclass._module.Tree TBool)) ($Is DatatypeTypeType |a#1#1#0| (Tclass._module.Tree TBool))) (= (|#_module.Tree.Branch| |a#1#0#0| |a#1#1#0|) |t#1@@1|))
 :qid |DTypesdfy.93:37|
 :skolemid |2125|
 :pattern ( (|#_module.Tree.Branch| |a#1#0#0| |a#1#1#0|))
)))) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS ($LS $LZ)) this@@3 |t#1@@1|)))
 :qid |DTypesdfy.114:19|
 :skolemid |2127|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS ($LS $LZ)) this@@3 |t#1@@1|))
))) (=> (forall ((|t#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |t#1@@2| (Tclass._module.Tree TBool)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS $LZ) this@@3 |t#1@@2|)))
 :qid |DTypesdfy.114:19|
 :skolemid |2129|
 :pattern ( (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 TBool ($LS $LZ) this@@3 |t#1@@2|))
)) (and (=> (= (ControlFlow 0 8) 6) anon6_Then_correct) (=> (= (ControlFlow 0 8) 7) anon6_Else_correct))))))))
(let ((anon5_Else_correct  (=> (and (not (and ($Is DatatypeTypeType |t#0@0| (Tclass._module.Tree TBool)) ($IsAlloc DatatypeTypeType |t#0@0| (Tclass._module.Tree TBool) $Heap))) (= (ControlFlow 0 12) 8)) anon2_correct)))
(let ((anon5_Then_correct  (=> (and ($Is DatatypeTypeType |t#0@0| (Tclass._module.Tree TBool)) ($IsAlloc DatatypeTypeType |t#0@0| (Tclass._module.Tree TBool) $Heap)) (=> (and (and ($IsAllocBox ($Box refType this@@3) (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@13) $Heap) ($IsAlloc DatatypeTypeType |t#0@0| (Tclass._module.Tree TBool) $Heap)) (and (|_module.DatatypeInduction.LeafCount#canCall| _module.DatatypeInduction$T@@13 TBool this@@3 |t#0@0|) (= (ControlFlow 0 11) 8))) anon2_correct))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($AlwaysAllocated _module.DatatypeInduction$T@@13)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@13)) ($IsAlloc refType this@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@13) $Heap)))) (and (and ($Is DatatypeTypeType |bt#0| (Tclass._module.Tree TBool)) ($IsAlloc DatatypeTypeType |bt#0| (Tclass._module.Tree TBool) $Heap)) (|$IsA#_module.Tree| |bt#0|))) (and (and (and ($Is DatatypeTypeType |it#0| (Tclass._module.Tree TInt)) ($IsAlloc DatatypeTypeType |it#0| (Tclass._module.Tree TInt) $Heap)) (|$IsA#_module.Tree| |it#0|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 14) 13)))) anon0_correct)))
