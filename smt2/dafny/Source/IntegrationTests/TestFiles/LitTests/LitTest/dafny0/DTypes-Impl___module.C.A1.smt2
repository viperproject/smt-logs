...
(assert (distinct TInt TagInt alloc Tagclass._System.object? Tagclass._System.object Tagclass._module.C? Tagclass._module.C Tagclass._module.Stack Tagclass._module.Stack? Tagclass._module.CP? Tagclass._module.CP tytagFamily$object tytagFamily$C tytagFamily$Stack tytagFamily$CP)
)
...
(assert (forall (($o@@3 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.Stack? $h@@4)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2033|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.Stack? $h@@4))
)))
...
(assert (forall ((|c#0@@6| T@U) ) (! (= ($Is refType |c#0@@6| Tclass._module.Stack)  (and ($Is refType |c#0@@6| Tclass._module.Stack?) (or (not (= |c#0@@6| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |2034|
 :pattern ( ($Is refType |c#0@@6| Tclass._module.Stack))
 :pattern ( ($Is refType |c#0@@6| Tclass._module.Stack?))
)))
...
(set-info :boogie-vc-id Impl$$_module.C.A1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|b#1| T@U) ) (!  (=> ($Is refType |b#1| (Tclass._module.CP? TInt Tclass._module.Stack)) (=> (= |a#0| |b#1|) (= |b#1| null)))
 :qid |DTypesdfy.31:19|
 :skolemid |2008|
)))))
(let ((anon5_Else_correct  (=> (and (or (not (= |a#0| |b#0@0|)) (not true)) (= (ControlFlow 0 5) 2)) anon3_correct)))
(let ((anon5_Then_correct  (=> (and (= |a#0| |b#0@0|) (= (ControlFlow 0 4) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and ($Is refType |b#0@0| (Tclass._module.CP? TInt Tclass._module.Stack)) ($IsAlloc refType |b#0@0| (Tclass._module.CP? TInt Tclass._module.Stack) $Heap)) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
(let ((anon4_Else_correct  (=> (and (not (and ($Is refType |b#0@0| (Tclass._module.CP? TInt Tclass._module.Stack)) ($IsAlloc refType |b#0@0| (Tclass._module.CP? TInt Tclass._module.Stack) $Heap))) (= (ControlFlow 0 3) 2)) anon3_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (and ($Is refType |a#0| (Tclass._module.CP? TInt Tclass._module.C)) ($IsAlloc refType |a#0| (Tclass._module.CP? TInt Tclass._module.C) $Heap))) (=> (and (and (and ($Is refType |x#0| Tclass._System.object?) ($IsAlloc refType |x#0| Tclass._System.object? $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))))
