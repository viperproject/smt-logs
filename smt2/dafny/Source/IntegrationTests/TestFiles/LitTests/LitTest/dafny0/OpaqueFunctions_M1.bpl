...
procedure {:verboseName "M1.F (well-formedness)"} CheckWellformed$$M1.__default.F();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M1.reveal_F (well-formedness)"} {:verify false} CheckWellFormed$$M1.__default.reveal__F();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M1.reveal_F (call)"} {:verify false} Call$$M1.__default.reveal__F();
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures reveal_M1._default.F;
