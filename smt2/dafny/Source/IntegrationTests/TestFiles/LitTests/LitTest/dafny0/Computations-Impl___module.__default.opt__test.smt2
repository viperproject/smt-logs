...
(set-info :boogie-vc-id Impl$$_module.__default.opt__test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_module.exp#Equal| (_module.__default.opt ($LS ($LS $LZ)) (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 0))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 0))))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 0))))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 1)))))) (|#_module.exp.Num| (LitInt 1))))))
