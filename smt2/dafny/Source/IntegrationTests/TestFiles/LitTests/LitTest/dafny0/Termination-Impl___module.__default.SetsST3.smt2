...
(declare-fun _module._default.SetsST3$Y () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.SetsST3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((anon7_correct  (and (=> (= (ControlFlow 0 7) (- 0 11)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.SetsST3$Y) (|Set#IsMember| |s#0@0| |$as#x0_0#0_0|))
 :qid |Terminationdfy.677:9|
 :skolemid |3170|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.SetsST3$Y) (|Set#IsMember| |s#0@0| |$as#x0_0#0_0@@0|))
 :qid |Terminationdfy.677:9|
 :skolemid |3170|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.SetsST3$Y) ($IsAllocBox |x#0_0@1| _module._default.SetsST3$Y $Heap))) (|Set#IsMember| |s#0@0| |x#0_0@1|)) (and (=> (= (ControlFlow 0 7) (- 0 10)) true) (=> (= |s#0@1| (|Set#Difference| |s#0@0| (|Set#UnionOne| |Set#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (<= 0 |$decr$loop#00@1|) (= (+ (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (+ (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< (+ (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|)) (=> (< (+ (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|) (=> (= (ControlFlow 0 7) (- 0 6)) (=> |$w$loop#0@0| (|Set#Subset| |t#0@0| |s#0@1|))))))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.SetsST3$Y) ($IsAllocBox |x#0_1@1| _module._default.SetsST3$Y $Heap))) (= (ControlFlow 0 13) 7)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |x#0_1@1| _module._default.SetsST3$Y) ($IsAllocBox |x#0_1@1| _module._default.SetsST3$Y $Heap)) (= (ControlFlow 0 12) 7)) anon7_correct)))
(let ((anon10_Else_correct  (=> (and (not (|Set#Equal| |s#0@0| |t#0@0|)) (= |$decr$loop#00@1| (+ (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@0|))))) (and (=> (= (ControlFlow 0 14) 12) anon11_Then_correct) (=> (= (ControlFlow 0 14) 13) anon11_Else_correct)))))
...
(let ((anon9_Then_correct  (=> (not |$w$loop#0@0|) (=> (and (|Set#Subset| |t#0@0| |s#0@0|) (= |newtype$check#0@0| (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (and (= |newtype$check#1@0| (|Set#Card| (|Set#Difference| |t#0@0| |s#0@0|))) (= (ControlFlow 0 3) (- 0 2))) (<= (LitInt 0) |newtype$check#1@0|))))))))
...
(let ((anon8_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.SetsST3$Y) ($IsAllocBox |x#0_0@0| _module._default.SetsST3$Y $Heap))) (=> (and (and (and ($Is SetType |s#0@0| (TSet _module._default.SetsST3$Y)) ($IsAlloc SetType |s#0@0| (TSet _module._default.SetsST3$Y) $Heap)) (and (not false) (=> |$w$loop#0@0| (|Set#Subset| |t#0@0| |s#0@0|)))) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.674:3|
 :skolemid |3168|
...
)) (<= (+ (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@0|))) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 17) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 17) 16) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |t#0@0| (|Set#UnionOne| |Set#Empty| |y#0|)) (= |$decr_init$loop#00@0| (+ (|Set#Card| (|Set#Difference| |S#0| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |S#0|))))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (=> |$w$loop#0@0| (|Set#Subset| |t#0@0| |S#0|))) (=> (=> |$w$loop#0@0| (|Set#Subset| |t#0@0| |S#0|)) (=> (= (ControlFlow 0 18) 17) anon8_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |S#0| (TSet _module._default.SetsST3$Y)) ($IsAlloc SetType |S#0| (TSet _module._default.SetsST3$Y) $Heap)) (and ($IsBox |y#0| _module._default.SetsST3$Y) ($IsAllocBox |y#0| _module._default.SetsST3$Y $Heap))) (=> (and (and (and (and ($Is SetType |s#0| (TSet _module._default.SetsST3$Y)) ($IsAlloc SetType |s#0| (TSet _module._default.SetsST3$Y) $Heap)) true) (and (and ($Is SetType |t#0| (TSet _module._default.SetsST3$Y)) ($IsAlloc SetType |t#0| (TSet _module._default.SetsST3$Y) $Heap)) true)) (and (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.SetsST3$Y) ($IsAllocBox |x#0_0| _module._default.SetsST3$Y $Heap))) true) (= 0 $FunctionContextHeight)) (and (|Set#IsMember| |S#0| |y#0|) (= (ControlFlow 0 20) 18)))) anon0_correct)))))
