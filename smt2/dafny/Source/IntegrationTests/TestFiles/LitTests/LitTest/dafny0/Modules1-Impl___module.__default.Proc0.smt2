...
(set-info :boogie-vc-id Impl$$_module.__default.Proc0)
...
(let ((anon3_Then_correct  (=> (and (<= (LitInt 0) |x#0|) (= |x##0_0@0| (- |x#0| 1))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 |x#0|) (= |x##0_0@0| |x#0|))) (=> (or (<= 0 |x#0|) (= |x##0_0@0| |x#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (< |x##0_0@0| |x#0|)))))))
