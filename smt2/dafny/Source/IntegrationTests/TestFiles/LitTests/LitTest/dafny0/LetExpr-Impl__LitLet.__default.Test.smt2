...
(declare-fun |LitLet.Nat#Equal| (T@U T@U) Bool)
...
(declare-fun |$IsA#LitLet.Nat| (T@U) Bool)
...
(assert (forall ((a T@U) (b T@U) ) (! (= (|LitLet.Nat#Equal| a b) (= a b))
 :qid |unknown.0:0|
 :skolemid |1702|
 :pattern ( (|LitLet.Nat#Equal| a b))
)))
...
(assert (forall ((a@@0 T@U) (b@@0 T@U) ) (!  (=> (and (LitLet.Nat.S_q a@@0) (LitLet.Nat.S_q b@@0)) (= (|LitLet.Nat#Equal| a@@0 b@@0) (|LitLet.Nat#Equal| (LitLet.Nat.pred a@@0) (LitLet.Nat.pred b@@0))))
 :qid |unknown.0:0|
 :skolemid |1701|
 :pattern ( (|LitLet.Nat#Equal| a@@0 b@@0) (LitLet.Nat.S_q a@@0))
 :pattern ( (|LitLet.Nat#Equal| a@@0 b@@0) (LitLet.Nat.S_q b@@0))
)))
...
(assert (forall ((d@@3 T@U) ) (!  (=> (|$IsA#LitLet.Nat| d@@3) (or (LitLet.Nat.O_q d@@3) (LitLet.Nat.S_q d@@3)))
 :qid |unknown.0:0|
 :skolemid |1698|
 :pattern ( (|$IsA#LitLet.Nat| d@@3))
)))
...
(assert (forall ((d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 Tclass.LitLet.Nat) (or (LitLet.Nat.O_q d@@4) (LitLet.Nat.S_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |1699|
 :pattern ( (LitLet.Nat.S_q d@@4) ($Is DatatypeTypeType d@@4 Tclass.LitLet.Nat))
 :pattern ( (LitLet.Nat.O_q d@@4) ($Is DatatypeTypeType d@@4 Tclass.LitLet.Nat))
)))
(assert (forall ((a@@1 T@U) (b@@1 T@U) ) (!  (=> (and (LitLet.Nat.O_q a@@1) (LitLet.Nat.O_q b@@1)) (|LitLet.Nat#Equal| a@@1 b@@1))
 :qid |unknown.0:0|
 :skolemid |1700|
 :pattern ( (|LitLet.Nat#Equal| a@@1 b@@1) (LitLet.Nat.O_q a@@1))
 :pattern ( (|LitLet.Nat#Equal| a@@1 b@@1) (LitLet.Nat.O_q b@@1))
)))
...
(assert (forall ((d@@5 T@U) ($h T@U) ) (!  (=> (and ($IsGoodHeap $h) ($Is DatatypeTypeType d@@5 Tclass.LitLet.Nat)) ($IsAlloc DatatypeTypeType d@@5 Tclass.LitLet.Nat $h))
 :qid |unknown.0:0|
 :skolemid |1697|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 Tclass.LitLet.Nat $h))
)))
...
(assert (forall ((d@@6 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (LitLet.Nat.S_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass.LitLet.Nat $h@@0))) ($IsAlloc DatatypeTypeType (LitLet.Nat.pred d@@6) Tclass.LitLet.Nat $h@@0))
 :qid |unknown.0:0|
 :skolemid |1693|
 :pattern ( ($IsAlloc DatatypeTypeType (LitLet.Nat.pred d@@6) Tclass.LitLet.Nat $h@@0))
)))
...
(set-info :boogie-vc-id Impl$$LitLet.__default.Test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |n2#0@0| (Lit DatatypeTypeType (|#LitLet.Nat.S| (Lit DatatypeTypeType (|#LitLet.Nat.S| (Lit DatatypeTypeType |#LitLet.Nat.O|)))))) (= |n3#0@0| (|#LitLet.Nat.S| |n2#0@0|))) (=> (and (and (= |n5#0@0| (|#LitLet.Nat.S| (|#LitLet.Nat.S| |n3#0@0|))) ($IsAlloc DatatypeTypeType |n5#0@0| Tclass.LitLet.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |n5#0@0| Tclass.LitLet.Nat $Heap) (|LitLet.__default.plus#canCall| |n5#0@0| |n5#0@0|))) (=> (and (and (and (and (|LitLet.__default.plus#canCall| |n5#0@0| |n5#0@0|) (= |n10#0@0| (LitLet.__default.plus ($LS $LZ) |n5#0@0| |n5#0@0|))) (and (= |n12#0@0| (|#LitLet.Nat.S| (|#LitLet.Nat.S| |n10#0@0|))) ($IsAlloc DatatypeTypeType |n5#0@0| Tclass.LitLet.Nat $Heap))) (and (and (|LitLet.__default.factorial#canCall| |n5#0@0|) ($IsAlloc DatatypeTypeType |n10#0@0| Tclass.LitLet.Nat $Heap)) (and ($IsAlloc DatatypeTypeType |n12#0@0| Tclass.LitLet.Nat $Heap) (|LitLet.__default.mult#canCall| |n10#0@0| |n12#0@0|)))) (and (and (and (|$IsA#LitLet.Nat| (LitLet.__default.factorial ($LS $LZ) |n5#0@0|)) (|$IsA#LitLet.Nat| (LitLet.__default.mult ($LS $LZ) |n10#0@0| |n12#0@0|))) (and (|LitLet.__default.factorial#canCall| |n5#0@0|) (|LitLet.__default.mult#canCall| |n10#0@0| |n12#0@0|))) (= (ControlFlow 0 2) (- 0 1)))) (|LitLet.Nat#Equal| (LitLet.__default.factorial ($LS ($LS $LZ)) |n5#0@0|) (LitLet.__default.mult ($LS ($LS $LZ)) |n10#0@0| |n12#0@0|))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |n2#0| Tclass.LitLet.Nat) ($IsAlloc DatatypeTypeType |n2#0| Tclass.LitLet.Nat $Heap)) true) (and (and ($Is DatatypeTypeType |n3#0| Tclass.LitLet.Nat) ($IsAlloc DatatypeTypeType |n3#0| Tclass.LitLet.Nat $Heap)) true)) (=> (and (and (and (and ($Is DatatypeTypeType |n5#0| Tclass.LitLet.Nat) ($IsAlloc DatatypeTypeType |n5#0| Tclass.LitLet.Nat $Heap)) true) (and (and ($Is DatatypeTypeType |n10#0| Tclass.LitLet.Nat) ($IsAlloc DatatypeTypeType |n10#0| Tclass.LitLet.Nat $Heap)) true)) (and (and (and ($Is DatatypeTypeType |n12#0| Tclass.LitLet.Nat) ($IsAlloc DatatypeTypeType |n12#0| Tclass.LitLet.Nat $Heap)) true) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))))
