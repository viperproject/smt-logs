...
axiom {:id "id0"} 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: DatatypeType :: 
    ...
    NestedMatch.__default.Even#canCall(n#0)
         || (1 < $FunctionContextHeight && $Is(n#0, Tclass.NestedMatch.Nat()))
...
procedure {:verboseName "NestedMatch.Even (well-formedness)"} CheckWellformed$$NestedMatch.__default.Even(n#0: DatatypeType where $Is(n#0, Tclass.NestedMatch.Nat()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NestedMatch.Even (well-formedness)"} CheckWellformed$$NestedMatch.__default.Even(n#0: DatatypeType)
{
  ...
  var ##n#0: DatatypeType;
    ...
    else
    {
        ...
        {
            assume {:id "id7"} NestedMatch.__default.Even($LS($LZ), n#0) == Lit(true);
            assume true;
        ...
        else if (n#0 == #NestedMatch.Nat.Suc(_mcc#0#0))
        {
            ...
            {
                assume {:id "id6"} NestedMatch.__default.Even($LS($LZ), n#0) == Lit(false);
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(NestedMatch.__default.Even($LS($LZ), n#0), TBool);
                return;
            ...
            else if (_mcc#0#0 == #NestedMatch.Nat.Suc(_mcc#1#0))
            {
                ...
                assume {:id "id5"} NestedMatch.__default.Even($LS($LZ), n#0)
...
procedure {:verboseName "NestedMatch.checkEven (well-formedness)"} CheckWellFormed$$NestedMatch.__default.checkEven(n#0: DatatypeType
...
procedure {:verboseName "NestedMatch.checkEven (call)"} Call$$NestedMatch.__default.checkEven(n#0: DatatypeType
       where $Is(n#0, Tclass.NestedMatch.Nat())
         && $IsAlloc(n#0, Tclass.NestedMatch.Nat(), $Heap)
         && $IsA#NestedMatch.Nat(n#0));
  modifies $Heap;
...
procedure {:verboseName "NestedMatch.checkEven (correctness)"} Impl$$NestedMatch.__default.checkEven(n#0: DatatypeType
       where $Is(n#0, Tclass.NestedMatch.Nat())
         && $IsAlloc(n#0, Tclass.NestedMatch.Nat(), $Heap)
         && $IsA#NestedMatch.Nat(n#0))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NestedMatch.checkEven (correctness)"} Impl$$NestedMatch.__default.checkEven(n#0: DatatypeType) returns ($_reverifyPost: bool)
{
  ...
  var ##n#3: DatatypeType;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NestedMatch.dfy(17,5)
    ##n#0 := Lit(#NestedMatch.Nat.Zero());
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#0, Tclass.NestedMatch.Nat(), $Heap);
    assume NestedMatch.__default.Even#canCall(Lit(#NestedMatch.Nat.Zero()));
    assume NestedMatch.__default.Even#canCall(Lit(#NestedMatch.Nat.Zero()));
    assert {:id "id8"} {:subsumption 0} Lit(NestedMatch.__default.Even($LS($LS($LZ)), Lit(#NestedMatch.Nat.Zero())))
       == Lit(true);
    assume {:id "id9"} Lit(NestedMatch.__default.Even($LS($LZ), Lit(#NestedMatch.Nat.Zero())))
       == Lit(true);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NestedMatch.dfy(18,5)
    ...
    assume NestedMatch.__default.Even#canCall(Lit(#NestedMatch.Nat.Suc(Lit(#NestedMatch.Nat.Zero()))));
    assert {:id "id10"} {:subsumption 0} Lit(NestedMatch.__default.Even($LS($LS($LZ)), Lit(#NestedMatch.Nat.Suc(Lit(#NestedMatch.Nat.Zero())))))
       == Lit(false);
    assume {:id "id11"} Lit(NestedMatch.__default.Even($LS($LZ), Lit(#NestedMatch.Nat.Suc(Lit(#NestedMatch.Nat.Zero())))))
       == Lit(false);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NestedMatch.dfy(19,5)
    ...
    assume NestedMatch.__default.Even#canCall(#NestedMatch.Nat.Suc(#NestedMatch.Nat.Suc(n#0)))
       && NestedMatch.__default.Even#canCall(n#0);
    assert {:id "id12"} {:subsumption 0} NestedMatch.__default.Even($LS($LS($LZ)), #NestedMatch.Nat.Suc(#NestedMatch.Nat.Suc(n#0)))
       == NestedMatch.__default.Even($LS($LS($LZ)), n#0);
    assume {:id "id13"} NestedMatch.__default.Even($LS($LZ), #NestedMatch.Nat.Suc(#NestedMatch.Nat.Suc(n#0)))
...
// alloc consequence axiom for NestedMatch.__default.last
axiom 1 <= $FunctionContextHeight
   ==> (forall $Heap: Heap, NestedMatch._default.last$T: Ty, $ly: LayerType, xs#0: DatatypeType :: 
    { $IsAllocBox(NestedMatch.__default.last(NestedMatch._default.last$T, $ly, xs#0), 
        NestedMatch._default.last$T, 
        $Heap) } 
    (NestedMatch.__default.last#canCall(NestedMatch._default.last$T, xs#0)
           || (1 < $FunctionContextHeight
...
procedure {:verboseName "NestedMatch.last (well-formedness)"} CheckWellformed$$NestedMatch.__default.last(NestedMatch._default.last$T: Ty, 
    xs#0: DatatypeType
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NestedMatch.last (well-formedness)"} CheckWellformed$$NestedMatch.__default.last(NestedMatch._default.last$T: Ty, xs#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var _mcc#0#0: Box;
  var _mcc#1#0: DatatypeType;
  ...
  var let#3#0#0: Box;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id16"} !NestedMatch.List#Equal(xs#0, #NestedMatch.List.Nil());
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    else
    {
        ...
        if (xs#0 == #NestedMatch.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            ...
            {
                havoc y#Z#1;
                assume {:id "id27"} let#3#0#0 == _mcc#0#0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $IsBox(let#3#0#0, NestedMatch._default.last$T);
                assume {:id "id28"} y#Z#1 == let#3#0#0;
                assume {:id "id29"} NestedMatch.__default.last(NestedMatch._default.last$T, $LS($LZ), xs#0) == y#Z#1;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $IsBox(NestedMatch.__default.last(NestedMatch._default.last$T, $LS($LZ), xs#0), 
                  NestedMatch._default.last$T);
            ...
            else if (_mcc#1#0 == #NestedMatch.List.Cons(_mcc#2#0, _mcc#3#0))
            {
                ...
                assume {:id "id26"} NestedMatch.__default.last(NestedMatch._default.last$T, $LS($LZ), xs#0)
...
procedure {:verboseName "NestedMatch.checkLast (well-formedness)"} CheckWellFormed$$NestedMatch.__default.checkLast(NestedMatch._default.checkLast$T: Ty, 
    y#0: Box
...
procedure {:verboseName "NestedMatch.checkLast (call)"} Call$$NestedMatch.__default.checkLast(NestedMatch._default.checkLast$T: Ty, 
    y#0: Box
       where $IsBox(y#0, NestedMatch._default.checkLast$T)
         && $IsAllocBox(y#0, NestedMatch._default.checkLast$T, $Heap));
  modifies $Heap;
...
procedure {:verboseName "NestedMatch.checkLast (correctness)"} Impl$$NestedMatch.__default.checkLast(NestedMatch._default.checkLast$T: Ty, 
    y#0: Box
       where $IsBox(y#0, NestedMatch._default.checkLast$T)
         && $IsAllocBox(y#0, NestedMatch._default.checkLast$T, $Heap))
   returns ($_reverifyPost: bool);
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NestedMatch.checkLast (correctness)"} Impl$$NestedMatch.__default.checkLast(NestedMatch._default.checkLast$T: Ty, y#0: Box) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var ##xs#0: DatatypeType;
  ...
  var ##xs#2: DatatypeType;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NestedMatch.dfy(33,5)
    ...
    assert {:id "id30"} {:subsumption 0} !NestedMatch.List#Equal(##xs#0, #NestedMatch.List.Nil());
    ...
    assume NestedMatch.__default.last#canCall(NestedMatch._default.checkLast$T, 
      #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil())));
    assert {:id "id31"} {:subsumption 0} NestedMatch.__default.last(NestedMatch._default.checkLast$T, 
        $LS($LS($LZ)), 
        #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil())))
       == y#0;
    assume {:id "id32"} NestedMatch.__default.last(NestedMatch._default.checkLast$T, 
        $LS($LZ), 
        #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil())))
       == y#0;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NestedMatch.dfy(34,5)
    ...
    assert {:id "id33"} {:subsumption 0} !NestedMatch.List#Equal(##xs#1, #NestedMatch.List.Nil());
    assume NestedMatch.__default.last#canCall(NestedMatch._default.checkLast$T, 
    ...
    assert {:id "id34"} {:subsumption 0} !NestedMatch.List#Equal(##xs#2, #NestedMatch.List.Nil());
    assume NestedMatch.__default.last#canCall(NestedMatch._default.checkLast$T, 
      #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil())));
    assume NestedMatch.__default.last#canCall(NestedMatch._default.checkLast$T, 
        #NestedMatch.List.Cons(y#0, #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil()))))
       && NestedMatch.__default.last#canCall(NestedMatch._default.checkLast$T, 
        #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil())));
    assert {:id "id35"} {:subsumption 0} NestedMatch.__default.last(NestedMatch._default.checkLast$T, 
        $LS($LS($LZ)), 
        #NestedMatch.List.Cons(y#0, #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil()))))
       == NestedMatch.__default.last(NestedMatch._default.checkLast$T, 
        $LS($LS($LZ)), 
        #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil())));
    assume {:id "id36"} NestedMatch.__default.last(NestedMatch._default.checkLast$T, 
        $LS($LZ), 
        #NestedMatch.List.Cons(y#0, #NestedMatch.List.Cons(y#0, Lit(#NestedMatch.List.Nil()))))
       == NestedMatch.__default.last(NestedMatch._default.checkLast$T, 
        $LS($LZ), 
...
procedure {:verboseName "NestedMatch.minus (well-formedness)"} CheckWellformed$$NestedMatch.__default.minus(x#0: DatatypeType where $Is(x#0, Tclass.NestedMatch.Nat()), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NestedMatch.minus (well-formedness)"} CheckWellformed$$NestedMatch.__default.minus(x#0: DatatypeType, y#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var _mcc#0#0: DatatypeType;
  var _mcc#1#0: DatatypeType;
  ...
  var ##y#0: DatatypeType;
    ...
    else
    {
           ...
           == #_System._tuple#2._#Make2($Box(_mcc#0#0), $Box(_mcc#1#0)))
        {
            ...
            if (_mcc#0#0 == #NestedMatch.Nat.Zero())
            {
                assume {:id "id46"} NestedMatch.__default.minus($LS($LZ), x#0, y#0) == Lit(#NestedMatch.Nat.Zero());
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(NestedMatch.__default.minus($LS($LZ), x#0, y#0), Tclass.NestedMatch.Nat());
                return;
            ...
            else if (_mcc#0#0 == #NestedMatch.Nat.Suc(_mcc#2#0))
            {
                ...
                {
                    assume {:id "id45"} NestedMatch.__default.minus($LS($LZ), x#0, y#0) == x#0;
                    assume true;
                    // CheckWellformedWithResult: any expression
                    assume $Is(NestedMatch.__default.minus($LS($LZ), x#0, y#0), Tclass.NestedMatch.Nat());
                    return;
                ...
                else if (_mcc#1#0 == #NestedMatch.Nat.Suc(_mcc#3#0))
                {
                    ...
                    havoc b#Z#0;
                    assume {:id "id39"} let#0#0#0 == _mcc#3#0;
                    assume true;
                    // CheckWellformedWithResult: any expression
                    assume $Is(let#0#0#0, Tclass.NestedMatch.Nat());
                    assume {:id "id40"} b#Z#0 == let#0#0#0;
                    havoc a#Z#0;
                    assume {:id "id41"} let#1#0#0 == _mcc#2#0;
                    assume true;
                    // CheckWellformedWithResult: any expression
                    assume $Is(let#1#0#0, Tclass.NestedMatch.Nat());
                    assume {:id "id42"} a#Z#0 == let#1#0#0;
                    ##x#0 := a#Z#0;
                    // assume allocatedness for argument to function
...
procedure {:verboseName "NestedMatch.checkMinus (well-formedness)"} CheckWellFormed$$NestedMatch.__default.checkMinus(x#0: DatatypeType
...
procedure {:verboseName "NestedMatch.checkMinus (call)"} Call$$NestedMatch.__default.checkMinus(x#0: DatatypeType
       where $Is(x#0, Tclass.NestedMatch.Nat())
         && $IsAlloc(x#0, Tclass.NestedMatch.Nat(), $Heap)
         && $IsA#NestedMatch.Nat(x#0), 
    y#0: DatatypeType
...
procedure {:verboseName "NestedMatch.checkMinus (correctness)"} Impl$$NestedMatch.__default.checkMinus(x#0: DatatypeType
       where $Is(x#0, Tclass.NestedMatch.Nat())
         && $IsAlloc(x#0, Tclass.NestedMatch.Nat(), $Heap)
         && $IsA#NestedMatch.Nat(x#0), 
    y#0: DatatypeType
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NestedMatch.checkMinus (correctness)"} Impl$$NestedMatch.__default.checkMinus(x#0: DatatypeType, y#0: DatatypeType) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var ##x#0: DatatypeType;
  var ##y#0: DatatypeType;
  ...
  var ##y#1: DatatypeType;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NestedMatch.dfy(47,5)
    ...
    assume $IsA#NestedMatch.Nat(NestedMatch.__default.minus($LS($LZ), #NestedMatch.Nat.Suc(x#0), #NestedMatch.Nat.Suc(y#0)))
      ...
      NestedMatch.__default.minus#canCall(#NestedMatch.Nat.Suc(x#0), #NestedMatch.Nat.Suc(y#0))
       && NestedMatch.__default.minus#canCall(x#0, y#0);
    assert {:id "id47"} {:subsumption 0} NestedMatch.Nat#Equal(NestedMatch.__default.minus($LS($LS($LZ)), #NestedMatch.Nat.Suc(x#0), #NestedMatch.Nat.Suc(y#0)), 
      NestedMatch.__default.minus($LS($LS($LZ)), x#0, y#0));
    assume {:id "id48"} NestedMatch.Nat#Equal(NestedMatch.__default.minus($LS($LZ), #NestedMatch.Nat.Suc(x#0), #NestedMatch.Nat.Suc(y#0)), 
...
procedure {:verboseName "NestedMatch.Last (call)"} Call$$NestedMatch.__default.Last(NestedMatch._default.Last$T: Ty, 
    xs#0: DatatypeType
       where $Is(xs#0, Tclass.NestedMatch.List(NestedMatch._default.Last$T))
         && $IsAlloc(xs#0, Tclass.NestedMatch.List(NestedMatch._default.Last$T), $Heap)
         && $IsA#NestedMatch.List(xs#0))
  ...
  requires {:id "id50"} !NestedMatch.List#Equal(xs#0, #NestedMatch.List.Nil());
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "NestedMatch.Last (correctness)"} Impl$$NestedMatch.__default.Last(NestedMatch._default.Last$T: Ty, 
    xs#0: DatatypeType
       where $Is(xs#0, Tclass.NestedMatch.List(NestedMatch._default.Last$T))
         && $IsAlloc(xs#0, Tclass.NestedMatch.List(NestedMatch._default.Last$T), $Heap)
         && $IsA#NestedMatch.List(xs#0))
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id51"} !NestedMatch.List#Equal(xs#0, #NestedMatch.List.Nil());
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "NestedMatch.Last (correctness)"} Impl$$NestedMatch.__default.Last(NestedMatch._default.Last$T: Ty, xs#0: DatatypeType)
  ...
  var let#0_1_0#0#0: Box;
    ...
    if (xs#0 == #NestedMatch.List.Cons(_mcc#0#0_0, _mcc#1#0_0))
    {
        ...
        if (_mcc#1#0_0 == #NestedMatch.List.Nil())
        {
            ...
            assume {:id "id62"} let#0_1_0#0#0 == _mcc#0#0_0;
            assume true;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $IsBox(let#0_1_0#0#0, NestedMatch._default.Last$T);
            assume {:id "id63"} y#0_1_0 == let#0_1_0#0#0;
            // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NestedMatch.dfy(57,26)
            assume true;
            assume true;
            x#0 := y#0_1_0;
            defass#x#0 := true;
        ...
        else if (_mcc#1#0_0 == #NestedMatch.List.Cons(_mcc#2#0_0_0, _mcc#3#0_0_0))
        {
            ...
            assert {:id "id59"} DtRank(xs##0_0_0) < DtRank(xs#0);
            call {:id "id60"} $rhs##0_0_0 := Call$$NestedMatch.__default.Last(NestedMatch._default.Last$T, xs##0_0_0);
...
axiom (forall a#4#0#0: DatatypeType :: 
  { #NestedMatch.Nat.Suc(a#4#0#0) } 
  DatatypeCtorId(#NestedMatch.Nat.Suc(a#4#0#0)) == ##NestedMatch.Nat.Suc);
}
...
axiom (forall d: DatatypeType :: 
  { NestedMatch.Nat.Suc_q(d) } 
  NestedMatch.Nat.Suc_q(d)
     ==> (exists a#5#0#0: DatatypeType :: d == #NestedMatch.Nat.Suc(a#5#0#0)));

// Constructor $Is
axiom (forall a#6#0#0: DatatypeType :: 
  { $Is(#NestedMatch.Nat.Suc(a#6#0#0), Tclass.NestedMatch.Nat()) } 
  $Is(#NestedMatch.Nat.Suc(a#6#0#0), Tclass.NestedMatch.Nat())
     <==> $Is(a#6#0#0, Tclass.NestedMatch.Nat()));
...
axiom (forall a#7#0#0: DatatypeType :: 
  { #NestedMatch.Nat.Suc(Lit(a#7#0#0)) } 
  #NestedMatch.Nat.Suc(Lit(a#7#0#0)) == Lit(#NestedMatch.Nat.Suc(a#7#0#0)));

function NestedMatch.Nat._h0(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#8#0#0: DatatypeType :: 
  { #NestedMatch.Nat.Suc(a#8#0#0) } 
  NestedMatch.Nat._h0(#NestedMatch.Nat.Suc(a#8#0#0)) == a#8#0#0);

// Inductive rank
axiom (forall a#9#0#0: DatatypeType :: 
  { #NestedMatch.Nat.Suc(a#9#0#0) } 
  DtRank(a#9#0#0) < DtRank(#NestedMatch.Nat.Suc(a#9#0#0)));

// Datatype $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(d, Tclass.NestedMatch.Nat(), $h) } 
  $IsGoodHeap($h) && $Is(d, Tclass.NestedMatch.Nat())
     ==> $IsAlloc(d, Tclass.NestedMatch.Nat(), $h));
...
axiom (forall a#14#0#0: Box, a#14#1#0: DatatypeType :: 
  { #NestedMatch.List.Cons(a#14#0#0, a#14#1#0) } 
  DatatypeCtorId(#NestedMatch.List.Cons(a#14#0#0, a#14#1#0))
...
axiom (forall d: DatatypeType :: 
  ...
  NestedMatch.List.Cons_q(d)
     ==> (exists a#15#0#0: Box, a#15#1#0: DatatypeType :: 
      d == #NestedMatch.List.Cons(a#15#0#0, a#15#1#0)));

// Constructor $Is
axiom (forall NestedMatch.List$T: Ty, a#16#0#0: Box, a#16#1#0: DatatypeType :: 
  { $Is(#NestedMatch.List.Cons(a#16#0#0, a#16#1#0), 
      Tclass.NestedMatch.List(NestedMatch.List$T)) } 
  $Is(#NestedMatch.List.Cons(a#16#0#0, a#16#1#0), 
      Tclass.NestedMatch.List(NestedMatch.List$T))
     <==> $IsBox(a#16#0#0, NestedMatch.List$T)
       && $Is(a#16#1#0, Tclass.NestedMatch.List(NestedMatch.List$T)));

// Constructor $IsAlloc
axiom (forall NestedMatch.List$T: Ty, a#16#0#0: Box, a#16#1#0: DatatypeType, $h: Heap :: 
  { $IsAlloc(#NestedMatch.List.Cons(a#16#0#0, a#16#1#0), 
      Tclass.NestedMatch.List(NestedMatch.List$T), 
      $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#NestedMatch.List.Cons(a#16#0#0, a#16#1#0), 
        Tclass.NestedMatch.List(NestedMatch.List$T), 
        $h)
       <==> $IsAllocBox(a#16#0#0, NestedMatch.List$T, $h)
         && $IsAlloc(a#16#1#0, Tclass.NestedMatch.List(NestedMatch.List$T), $h)));
...
axiom (forall a#17#0#0: Box, a#17#1#0: DatatypeType :: 
  { #NestedMatch.List.Cons(Lit(a#17#0#0), Lit(a#17#1#0)) } 
  #NestedMatch.List.Cons(Lit(a#17#0#0), Lit(a#17#1#0))
     == Lit(#NestedMatch.List.Cons(a#17#0#0, a#17#1#0)));

function NestedMatch.List._h1(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#18#0#0: Box, a#18#1#0: DatatypeType :: 
  { #NestedMatch.List.Cons(a#18#0#0, a#18#1#0) } 
  NestedMatch.List._h1(#NestedMatch.List.Cons(a#18#0#0, a#18#1#0)) == a#18#0#0);

// Inductive rank
axiom (forall a#19#0#0: Box, a#19#1#0: DatatypeType :: 
  { #NestedMatch.List.Cons(a#19#0#0, a#19#1#0) } 
  BoxRank(a#19#0#0) < DtRank(#NestedMatch.List.Cons(a#19#0#0, a#19#1#0)));

function NestedMatch.List._h2(DatatypeType) : DatatypeType;

// Constructor injectivity
axiom (forall a#20#0#0: Box, a#20#1#0: DatatypeType :: 
  { #NestedMatch.List.Cons(a#20#0#0, a#20#1#0) } 
  NestedMatch.List._h2(#NestedMatch.List.Cons(a#20#0#0, a#20#1#0)) == a#20#1#0);

// Inductive rank
axiom (forall a#21#0#0: Box, a#21#1#0: DatatypeType :: 
  { #NestedMatch.List.Cons(a#21#0#0, a#21#1#0) } 
  DtRank(a#21#1#0) < DtRank(#NestedMatch.List.Cons(a#21#0#0, a#21#1#0)));
