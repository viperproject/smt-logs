...
(set-info :boogie-vc-id Impl$$_module.__default.ZeroRangeK)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| 10)) (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 (+ |i#0_0@0| |k#0|)) (< (+ |i#0_0@0| |k#0|) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (+ |i#0_0@0| |k#0|))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (+ |i#0_0@0| |k#0|)))) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| 10)) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 5) (- 0 4)))) (or (or (or (not (= |a#0| |a#0|)) (not true)) (or (not (= (IndexField (+ |i#0_0@0| |k#0|)) (IndexField (+ |i#0_1@0| |k#0|)))) (not true))) (= (LitInt 0) (LitInt 0))))))))))))
...
(let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#1| Int) ) (!  (=> (and (<= |k#0| |i#1|) (< |i#1| (+ |k#0| 10))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |a#0|) (IndexField |i#1|)))) (LitInt 0)))
 :qid |Inversesdfy.134:18|
 :skolemid |610|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (<= (LitInt 0) |k#0|)) (and (and (= 0 $FunctionContextHeight) (<= (LitInt 100) (_System.array.Length |a#0|))) (and (<= |k#0| (LitInt 90)) (= (ControlFlow 0 13) 12)))) anon0_correct))))
