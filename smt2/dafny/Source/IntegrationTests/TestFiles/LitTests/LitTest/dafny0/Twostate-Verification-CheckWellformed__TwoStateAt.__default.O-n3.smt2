...
(assert (forall (($reveal Bool) ($prevHeap@@1 T@U) ($h0 T@U) ($h1 T@U) (|c#0@@3| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|TwoStateAt.__default.Opaque#canCall| $prevHeap@@1 $h0 |c#0@@3|) ($Is refType |c#0@@3| Tclass.TwoStateAt.Cell))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) ) (! true
 :qid |unknown.0:0|
 :skolemid |664|
...
(set-info :boogie-vc-id CheckWellformed$$TwoStateAt.__default.Opaque)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |c#0@@4| null)) (not true))) (=> (or (not (= |c#0@@4| null)) (not true)) (=> (= (ControlFlow 0 3) (- 0 2)) ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell $Heap@@1))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#3| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and ($Is refType |c#0@@4| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell previous$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 6) 5))) anon0_correct))))
