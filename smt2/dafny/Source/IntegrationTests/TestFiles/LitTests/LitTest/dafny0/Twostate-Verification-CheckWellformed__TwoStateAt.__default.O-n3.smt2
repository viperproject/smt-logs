...
(assert (forall (($reveal Bool) ($prevHeap@@1 T@U) ($h0 T@U) ($h1 T@U) (|c#0@@3| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|TwoStateAt.__default.Opaque#canCall| $prevHeap@@1 $h0 |c#0@@3|) ($Is refType |c#0@@3| Tclass.TwoStateAt.Cell))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@3 T@U) ($f T@U) ) true) (= (TwoStateAt.__default.Opaque $reveal $prevHeap@@1 $h0 |c#0@@3|) (TwoStateAt.__default.Opaque $reveal $prevHeap@@1 $h1 |c#0@@3|))))
