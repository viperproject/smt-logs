...
procedure {:verboseName "Module1.N9 (well-formedness)"} CheckWellFormed$$Module1.N9();
...
axiom (forall c0#0: int :: 
  { $Is(c0#0, Tclass.Module1.N9()) } 
  $Is(c0#0, Tclass.Module1.N9()) <==> Lit(true));

// $IsAlloc axiom for newtype Module1.N9
axiom (forall c1#0: int, $h: Heap :: 
  { $IsAlloc(c1#0, Tclass.Module1.N9(), $h) } 
  $IsAlloc(c1#0, Tclass.Module1.N9(), $h));
