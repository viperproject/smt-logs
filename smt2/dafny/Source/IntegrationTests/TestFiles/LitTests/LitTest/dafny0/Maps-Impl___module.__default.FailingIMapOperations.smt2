...
(assert (forall ((m@@10 T@U) (n T@U) (u@@5 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| (|IMap#Merge| m@@10 n)) u@@5)) (and (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| n) u@@5))) (= (MapType0Select BoxType BoxType (|IMap#Elements| (|IMap#Merge| m@@10 n)) u@@5) (MapType0Select BoxType BoxType (|IMap#Elements| m@@10) u@@5))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| n) u@@5)) (= (MapType0Select BoxType BoxType (|IMap#Elements| (|IMap#Merge| m@@10 n)) u@@5) (MapType0Select BoxType BoxType (|IMap#Elements| n) u@@5)))))
 :qid |DafnyPreludebpl.1618:15|
 :skolemid |326|
 :pattern ( (MapType0Select BoxType BoxType (|IMap#Elements| (|IMap#Merge| m@@10 n)) u@@5))
)))
...
(assert  (and (and (and (forall ((t0@@6 T@T) (t1@@2 T@T) (t2 T@T) (val@@1 T@U) (m@@11 T@U) (x0@@1 T@U) (x1 T@U) ) (! (= (MapType1Select t0@@6 t1@@2 t2 (MapType1Store t0@@6 t1@@2 t2 m@@11 x0@@1 x1 val@@1) x0@@1 x1) val@@1)
...
(assert (forall ((m@@14 T@U) (n@@0 T@U) ) (! (= (|IMap#Domain| (|IMap#Merge| m@@14 n@@0)) (|ISet#Union| (|IMap#Domain| m@@14) (|IMap#Domain| n@@0)))
 :qid |DafnyPreludebpl.1615:15|
 :skolemid |325|
 :pattern ( (|IMap#Domain| (|IMap#Merge| m@@14 n@@0)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.FailingIMapOperations)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon5_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) (|Set#IsMember| |s#0| ($Box intType (int_2_U |x#0|))))) (=> (and (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) (|Set#IsMember| |s#0| ($Box intType (int_2_U |x#0|)))) (= (ControlFlow 0 16) (- 0 15))) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))))))
(let ((anon11_Else_correct  (=> (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (= (ControlFlow 0 19) 16)) anon5_correct)))
(let ((anon11_Then_correct  (=> (and (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) (= (ControlFlow 0 18) 16)) anon5_correct)))
(let ((anon3_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|))) (=> (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|)) (and (=> (= (ControlFlow 0 20) 18) anon11_Then_correct) (=> (= (ControlFlow 0 20) 19) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) (= (ControlFlow 0 24) 20)) anon3_correct)))
(let ((anon10_Then_correct  (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) (=> (= (ControlFlow 0 22) 20) anon3_correct)))))
(let ((anon9_Then_correct  (=> (= |m'#0_0@0| (|IMap#Subtract| |m#0| |s#0|)) (and (=> (= (ControlFlow 0 25) 22) anon10_Then_correct) (=> (= (ControlFlow 0 25) 24) anon10_Else_correct)))))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |n#0|) ($Box intType (int_2_U |x#0|))))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0|) ($Box intType (int_2_U |x#0|)))))))) (=> (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |n#0|) ($Box intType (int_2_U |x#0|))))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0|) ($Box intType (int_2_U |x#0|))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0|) ($Box intType (int_2_U |x#0|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0|) ($Box intType (int_2_U |x#0|))))))) (=> (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0|) ($Box intType (int_2_U |x#0|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0|) ($Box intType (int_2_U |y#0|)))))))))))))
(let ((anon12_Else_correct  (=> (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |n#0|) ($Box intType (int_2_U |x#0|)))) (= (ControlFlow 0 10) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |n#0|) ($Box intType (int_2_U |x#0|))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0|) ($Box intType (int_2_U |x#0|))))) (=> (= (ControlFlow 0 7) 2) anon8_correct))))))
(let ((anon9_Else_correct  (=> (= |m'#1_0@0| (|IMap#Merge| |m#0| |n#0|)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m'#1_0@0|) ($Box intType (int_2_U |y#0|))))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |n#0|) ($Box intType (int_2_U |y#0|))))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m'#1_0@0|) ($Box intType (int_2_U |y#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |n#0|) ($Box intType (int_2_U |y#0|))))))) (=> (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m'#1_0@0|) ($Box intType (int_2_U |y#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |n#0|) ($Box intType (int_2_U |y#0|)))))) (and (=> (= (ControlFlow 0 11) 7) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0|) ($Box intType (int_2_U |x#0|))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0|) ($Box intType (int_2_U |x#0|)))) (=> (= |$rhs#0@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0|) ($Box intType (int_2_U |x#0|)))))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |n#0|) ($Box intType (int_2_U |y#0|))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |n#0|) ($Box intType (int_2_U |y#0|)))) (=> (= |$rhs#1@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|IMap#Elements| |n#0|) ($Box intType (int_2_U |y#0|)))))) (and (=> (= (ControlFlow 0 26) 25) anon9_Then_correct) (=> (= (ControlFlow 0 26) 11) anon9_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is IMapType |m#0| (TIMap TInt TReal)) ($IsAlloc IMapType |m#0| (TIMap TInt TReal) $Heap))) (=> (and (and (and (and ($Is IMapType |n#0| (TIMap TInt TReal)) ($IsAlloc IMapType |n#0| (TIMap TInt TReal) $Heap)) (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap))) (and (and ($Is IMapType |m'#0_0| (TIMap TInt TReal)) ($IsAlloc IMapType |m'#0_0| (TIMap TInt TReal) $Heap)) true)) (and (and (and ($Is IMapType |m'#1_0| (TIMap TInt TReal)) ($IsAlloc IMapType |m'#1_0| (TIMap TInt TReal) $Heap)) true) (and (and (= 0 $FunctionContextHeight) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0|) ($Box intType (int_2_U |x#0|))))) (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |n#0|) ($Box intType (int_2_U |y#0|)))) (= (ControlFlow 0 29) 26))))) anon0_correct))))
