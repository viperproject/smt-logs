...
(set-info :boogie-vc-id Impl$$MatchInCalc__Module.__default.FunctionX)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon6_correct  (=> (= (ControlFlow 0 17) (- 0 16)) (= (MatchInCalc__Module.__default.F |t#0@@1|) (ite (MatchInCalc__Module.T.Leaf_q |t#0@@1|) (let ((|s0#0_1_2| (MatchInCalc__Module.T.h |t#0@@1|)))
|s0#0_1_2|) (let ((|s1#0_1_2| (MatchInCalc__Module.T.g |t#0@@1|)))
(Mul (LitInt 2) |s1#0_1_2|)))))))
(let ((anon19_Then_correct  (=> (= |t#0@@1| (|#MatchInCalc_Module.T.Node| |_mcc#1#0_0_0|)) (=> (and (and (= |let#0_1_0#0#0| |_mcc#1#0_0_0|) ($Is intType (int_2_U |let#0_1_0#0#0|) TInt)) (and (= |s1#Z#0_1_0@0| |let#0_1_0#0#0|) (= (ControlFlow 0 19) 17))) anon6_correct))))
(let ((anon18_Then_correct  (=> (= |t#0@@1| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|)) (=> (and (and (= |let#0_1_1#0#0| |_mcc#0#0_0_0|) ($Is intType (int_2_U |let#0_1_1#0#0|) TInt)) (and (= |s0#Z#0_1_0@0| |let#0_1_1#0#0|) (= (ControlFlow 0 18) 17))) anon6_correct))))
(let ((anon19_Else_correct true))
(let ((anon18_Else_correct  (=> (or (not (= |t#0@@1| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|))) (not true)) (and (=> (= (ControlFlow 0 20) 19) anon19_Then_correct) (=> (= (ControlFlow 0 20) 15) anon19_Else_correct)))))
(let ((anon17_Then_correct  (=> ($IsAlloc DatatypeTypeType |t#0@@1| Tclass.MatchInCalc__Module.T $Heap) (=> (and (|MatchInCalc__Module.__default.F#canCall| |t#0@@1|) (|MatchInCalc__Module.__default.F#canCall| |t#0@@1|)) (and (=> (= (ControlFlow 0 21) 18) anon18_Then_correct) (=> (= (ControlFlow 0 21) 20) anon18_Else_correct))))))
(let ((anon14_correct  (=> (= (ControlFlow 0 5) (- 0 4)) (= (ite (MatchInCalc__Module.T.Leaf_q |t#0@@1|) (let ((|s0#0_0_2| (MatchInCalc__Module.T.h |t#0@@1|)))
|s0#0_0_2|) (let ((|s1#0_0_2| (MatchInCalc__Module.T.g |t#0@@1|)))
(Mul (LitInt 2) |s1#0_0_2|))) (ite (MatchInCalc__Module.T.Leaf_q |t#0@@1|) (MatchInCalc__Module.T.h |t#0@@1|) (+ (MatchInCalc__Module.T.g |t#0@@1|) (MatchInCalc__Module.T.g |t#0@@1|)))))))
(let ((anon23_Else_correct  (=> (not (MatchInCalc__Module.T.Leaf_q |t#0@@1|)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (MatchInCalc__Module.T.Node_q |t#0@@1|)) (=> (MatchInCalc__Module.T.Node_q |t#0@@1|) (and (=> (= (ControlFlow 0 8) (- 0 9)) (MatchInCalc__Module.T.Node_q |t#0@@1|)) (=> (MatchInCalc__Module.T.Node_q |t#0@@1|) (=> (= (ControlFlow 0 8) 5) anon14_correct))))))))
(let ((anon23_Then_correct  (=> (MatchInCalc__Module.T.Leaf_q |t#0@@1|) (and (=> (= (ControlFlow 0 6) (- 0 7)) (MatchInCalc__Module.T.Leaf_q |t#0@@1|)) (=> (MatchInCalc__Module.T.Leaf_q |t#0@@1|) (=> (= (ControlFlow 0 6) 5) anon14_correct))))))
(let ((anon11_correct  (and (=> (= (ControlFlow 0 11) 6) anon23_Then_correct) (=> (= (ControlFlow 0 11) 8) anon23_Else_correct))))
(let ((anon22_Then_correct  (=> (= |t#0@@1| (|#MatchInCalc_Module.T.Node| |_mcc#1#0_0_0|)) (=> (and (and (= |let#0_0_0#0#0| |_mcc#1#0_0_0|) ($Is intType (int_2_U |let#0_0_0#0#0|) TInt)) (and (= |s1#Z#0_0_0@0| |let#0_0_0#0#0|) (= (ControlFlow 0 13) 11))) anon11_correct))))
(let ((anon21_Then_correct  (=> (= |t#0@@1| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|)) (=> (and (and (= |let#0_0_1#0#0| |_mcc#0#0_0_0|) ($Is intType (int_2_U |let#0_0_1#0#0|) TInt)) (and (= |s0#Z#0_0_0@0| |let#0_0_1#0#0|) (= (ControlFlow 0 12) 11))) anon11_correct))))
(let ((anon22_Else_correct true))
(let ((anon21_Else_correct  (=> (or (not (= |t#0@@1| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|))) (not true)) (and (=> (= (ControlFlow 0 14) 13) anon22_Then_correct) (=> (= (ControlFlow 0 14) 3) anon22_Else_correct)))))
(let ((anon20_Else_correct true))
(let ((anon16_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (=> (= (ControlFlow 0 22) 1) anon16_Then_correct) (=> (= (ControlFlow 0 22) 21) anon17_Then_correct)) (=> (= (ControlFlow 0 22) 2) anon20_Else_correct)) (=> (= (ControlFlow 0 22) 12) anon21_Then_correct)) (=> (= (ControlFlow 0 22) 14) anon21_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |t#0@@1| Tclass.MatchInCalc__Module.T) ($IsAlloc DatatypeTypeType |t#0@@1| Tclass.MatchInCalc__Module.T $Heap)) (|$IsA#MatchInCalc__Module.T| |t#0@@1|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 23) 22))) anon0_correct))))
