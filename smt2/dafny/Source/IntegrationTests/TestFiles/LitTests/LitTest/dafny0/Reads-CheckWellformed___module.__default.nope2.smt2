...
(declare-fun _module.__default.nope2 (T@U T@U) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.nope2#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|c#0| T@U) ) (!  (=> (or (|_module.__default.nope2#canCall| $Heap |c#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is refType |c#0| Tclass._module.C?)) (and (or (not (= |c#0| null)) (not true)) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0|) _module.C.u))) 0))))) (= (_module.__default.nope2 $Heap |c#0|) (Lit DatatypeTypeType |#_System._tuple#0._#Make0|)))
 :qid |Readsdfy.17:16|
 :skolemid |543|
 :pattern ( (_module.__default.nope2 $Heap |c#0|) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|c#0@@1| T@U) ) (!  (=> (or (|_module.__default.nope2#canCall| $Heap@@0 |c#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and ($Is refType |c#0@@1| Tclass._module.C?) ($IsAlloc refType |c#0@@1| Tclass._module.C? $Heap@@0))) (and (or (not (= |c#0@@1| null)) (not true)) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1|) _module.C.u))) 0))))) ($Is DatatypeTypeType (_module.__default.nope2 $Heap@@0 |c#0@@1|) Tclass._System.Tuple0))
 :qid |Readsdfy.17:16|
 :skolemid |541|
 :pattern ( (_module.__default.nope2 $Heap@@0 |c#0@@1|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.nope2)
...
(let ((anon12_Else_correct  (=> (= |c#0@@3| null) (and (=> (= (ControlFlow 0 4) 1) anon13_Then_correct) (=> (= (ControlFlow 0 4) 2) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (or (not (= |c#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 3) 1) anon13_Then_correct) (=> (= (ControlFlow 0 3) 2) anon13_Else_correct)))))
(let ((anon11_Else_correct  (=> (= |c#0@@3| null) (and (=> (= (ControlFlow 0 6) 3) anon12_Then_correct) (=> (= (ControlFlow 0 6) 4) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (or (not (= |c#0@@3| null)) (not true)) (and (=> (= (ControlFlow 0 5) 3) anon12_Then_correct) (=> (= (ControlFlow 0 5) 4) anon12_Else_correct)))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#2| null $Heap@@1 alloc (ite  (or (not (= |c#0@@3| null)) (not true)) |Set#Empty| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@3|))))) (or (not (= |c#0@@3| null)) (not true))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |c#0@@3| null)) (not true))) (=> (or (not (= |c#0@@3| null)) (not true)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |c#0@@3| _module.C.u))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@3|) _module.C.u))) 0)) (and (=> (= (ControlFlow 0 7) (- 0 8)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 7) 5) anon11_Then_correct) (=> (= (ControlFlow 0 7) 6) anon11_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) ($Is refType |c#0@@3| Tclass._module.C?)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 7))) anon0_correct)))
