...
(declare-fun |xt#0| () Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellformed$$Nested.__default.F_k)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) ($IsAlloc intType (int_2_U |xt#0|) TInt $Heap)) (and ($IsAlloc intType (int_2_U |xt#0|) TInt $Heap) (= (ControlFlow 0 2) (- 0 1)))) false)))
