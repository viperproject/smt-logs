...
(declare-fun $generated@@88 () (_ BitVec 32))
(declare-fun $generated@@89 () (_ BitVec 6))
(declare-fun $generated@@90 () (_ BitVec 6))
(declare-fun $generated@@91 () (_ BitVec 6))
(declare-fun $generated@@92 () (_ BitVec 6))
...
(declare-fun $generated@@99 () (_ BitVec 6))
(declare-fun $generated@@100 () (_ BitVec 6))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let (($generated@@103  (=> (and (and (and (and (not ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 true)))) (not (bvult $generated@@88 #x0000001e))) (not (bvule #x0000001e $generated@@88))) (not (bvult $generated@@88 #x00000014))) (= (ControlFlow 0 18) (- 0 17))) false)))
(let (($generated@@104  (=> (bvult $generated@@88 #x00000014) (and (=> (= (ControlFlow 0 14) (- 0 16)) (bvult $generated@@88 #x00000040)) (=> (bvult $generated@@88 #x00000040) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= ((_ extract 5 0) $generated@@88) #b010111)) (not true))) (=> (or (not (= ((_ extract 5 0) $generated@@88) #b010111)) (not true)) (=> (and (= $generated@@89 ((_ extract 5 0) $generated@@88)) (= (ControlFlow 0 14) (- 0 13))) (or (not (= $generated@@89 #b010111)) (not true))))))))))
(let (($generated@@105  (=> (bvule #x0000001e $generated@@88) (and (=> (= (ControlFlow 0 10) (- 0 12)) (bvult $generated@@88 #x00000040)) (=> (bvult $generated@@88 #x00000040) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= ((_ extract 5 0) $generated@@88) #b010111)) (not true))) (=> (or (not (= ((_ extract 5 0) $generated@@88) #b010111)) (not true)) (=> (and (= $generated@@90 ((_ extract 5 0) $generated@@88)) (= (ControlFlow 0 10) (- 0 9))) (or (not (= $generated@@90 #b010111)) (not true))))))))))
(let (($generated@@106  (=> (bvult $generated@@88 #x0000001e) (and (=> (= (ControlFlow 0 6) (- 0 8)) (bvult $generated@@88 #x00000040)) (=> (bvult $generated@@88 #x00000040) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= ((_ extract 5 0) $generated@@88) #b010111)) (not true))) (=> (or (not (= ((_ extract 5 0) $generated@@88) #b010111)) (not true)) (=> (and (= $generated@@91 ((_ extract 5 0) $generated@@88)) (= (ControlFlow 0 6) (- 0 5))) (or (not (= $generated@@91 #b010111)) (not true))))))))))
(let (($generated@@107  (and (=> (= (ControlFlow 0 2) (- 0 4)) (bvult $generated@@88 #x00000040)) (=> (bvult $generated@@88 #x00000040) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= ((_ extract 5 0) $generated@@88) #b010111)) (not true))) (=> (or (not (= ((_ extract 5 0) $generated@@88) #b010111)) (not true)) (=> (and (= $generated@@92 ((_ extract 5 0) $generated@@88)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@92 #b010111)) (not true)))))))))
(let (($generated@@108  (=> (= $generated@@93 ($generated@@29 $generated@@94 $generated@@95 $generated@@96 false)) (and (and (and (and (=> (= (ControlFlow 0 19) 2) $generated@@107) (=> (= (ControlFlow 0 19) 6) $generated@@106)) (=> (= (ControlFlow 0 19) 10) $generated@@105)) (=> (= (ControlFlow 0 19) 14) $generated@@104)) (=> (= (ControlFlow 0 19) 18) $generated@@103)))))
(let (($generated@@109  (=> (and ($generated@@97 $generated@@95) ($generated@@98 $generated@@95)) (=> (and (and (and (or (not (= $generated@@99 #b010111)) (not true)) ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 true)))) (and (or (not (= $generated@@100 #b010111)) (not true)) ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 true))))) (and (and (<= ($generated (- 0 2147483648)) $generated@@101) (< $generated@@101 2147483648)) (and (= 1 $generated@@102) (= (ControlFlow 0 20) 19)))) $generated@@108))))
$generated@@109))))))))
))
(check-sat)
