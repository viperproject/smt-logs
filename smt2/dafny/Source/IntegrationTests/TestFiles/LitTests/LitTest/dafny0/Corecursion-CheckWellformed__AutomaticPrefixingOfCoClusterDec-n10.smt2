...
(declare-fun AutomaticPrefixingOfCoClusterDecreasesClauses.__default.F (T@U Bool) T@U)
(declare-fun |AutomaticPrefixingOfCoClusterDecreasesClauses.__default.F#canCall| (Bool) Bool)
(declare-fun AutomaticPrefixingOfCoClusterDecreasesClauses.__default.G (T@U) T@U)
(declare-fun $LS (T@U) T@U)
(declare-fun |AutomaticPrefixingOfCoClusterDecreasesClauses.__default.G#canCall| () Bool)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun AutomaticPrefixingOfCoClusterDecreasesClauses.__default.H (T@U) T@U)
(declare-fun |AutomaticPrefixingOfCoClusterDecreasesClauses.__default.H#canCall| () Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (and (= |##b#0@0| (U_2_bool (Lit boolType (bool_2_U false)))) ($IsAlloc boolType (bool_2_U |##b#0@0|) TBool $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 (LitInt 1)) (= (LitInt 0) (LitInt 1)))) (=> (or (<= 0 (LitInt 1)) (= (LitInt 0) (LitInt 1))) (=> (= (ControlFlow 0 3) (- 0 2)) (<= (LitInt 0) (LitInt 1))))))))
