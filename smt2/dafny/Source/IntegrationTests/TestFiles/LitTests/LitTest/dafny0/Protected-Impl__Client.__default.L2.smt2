...
(declare-fun |Library.__default.H#canCall| () Bool)
(declare-fun Library.__default.H () Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$Client.__default.L2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) |Library.__default.H#canCall|) (and |Library.__default.H#canCall| (= (ControlFlow 0 2) (- 0 1)))) (= Library.__default.H (LitInt 5)))))
