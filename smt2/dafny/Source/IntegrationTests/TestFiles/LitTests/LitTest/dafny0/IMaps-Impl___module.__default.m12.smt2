...
(declare-fun |lambda#27| (Int) T@U)
(declare-fun Mul (Int Int) Int)
(declare-fun |IMap#Empty| () T@U)
(declare-fun |lambda#26| (T@U Int Int) T@U)
...
(assert (forall ((|l#0| Int) (|$w#0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#27| |l#0|) |$w#0|) ($Box intType (int_2_U (Mul (U_2_int ($Unbox intType |$w#0|)) |l#0|))))
 :qid |unknown.0:0|
 :skolemid |596|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#27| |l#0|) |$w#0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1| Int) (|l#2| Int) (|$w#0@@0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#26| |l#0@@0| |l#1| |l#2|) |$w#0@@0|))  (and ($IsBox |$w#0@@0| |l#0@@0|) (and (<= |l#1| (U_2_int ($Unbox intType |$w#0@@0|))) (< (U_2_int ($Unbox intType |$w#0@@0|)) |l#2|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |595|
 :pattern ( (MapType0Select BoxType boolType (|lambda#26| |l#0@@0| |l#1| |l#2|) |$w#0@@0|))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |x#0@0|) ($Box intType (int_2_U (LitInt 0)))))) (LitInt 0))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |x#0@0|) ($Box intType (int_2_U (LitInt 2)))))) (LitInt 4))))))
(let ((anon11_Else_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |x#0@0|) ($Box intType (int_2_U (LitInt 0)))))) (LitInt 0))) (not true)) (= (ControlFlow 0 7) 3)) anon7_correct)))
(let ((anon11_Then_correct  (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |x#0@0|) ($Box intType (int_2_U (LitInt 0)))))) (LitInt 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U (LitInt 2)))))) (=> (= (ControlFlow 0 5) 3) anon7_correct)))))
(let ((anon5_correct  (=> (= |x#0@0| (|IMap#Glue| (|lambda#26| TInt (LitInt 0) 10) (|lambda#27| (LitInt 2)) (TIMap TInt TInt))) (and (=> (= (ControlFlow 0 8) (- 0 12)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U 0))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U 0)))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U 1))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U 1)))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U 10)))))) (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U 10))))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |x#0@0|) ($Box intType (int_2_U (LitInt 0)))))) (and (=> (= (ControlFlow 0 8) 5) anon11_Then_correct) (=> (= (ControlFlow 0 8) 7) anon11_Else_correct))))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is IMapType |x#0| (TIMap TInt TInt)) ($IsAlloc IMapType |x#0| (TIMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
