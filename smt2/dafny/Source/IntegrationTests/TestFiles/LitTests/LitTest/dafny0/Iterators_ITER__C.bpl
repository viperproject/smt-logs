...
procedure {:verboseName "ITER_C.RecursiveIterator._ctor (well-formedness)"} CheckWellFormed$$ITER__C.RecursiveIterator.__ctor(n#0: int where LitInt(0) <= n#0, 
    r#0: ref
...
procedure {:verboseName "ITER_C.RecursiveIterator._ctor (call)"} Call$$ITER__C.RecursiveIterator.__ctor(n#0: int where LitInt(0) <= n#0, 
    r#0: ref
       where $Is(r#0, Tclass.ITER__C.RecIterCaller?())
         && $IsAlloc(r#0, Tclass.ITER__C.RecIterCaller?(), $Heap), 
    good#0: bool)
  ...
  requires {:id "id137"} r#0 != null;
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id138"} ITER__C.RecursiveIterator.n(this) == n#0;
  free ensures true;
  ensures {:id "id139"} ITER__C.RecursiveIterator.r(this) == r#0;
  free ensures true;
  ensures {:id "id140"} ITER__C.RecursiveIterator.good(this) == good#0;
  free ensures ITER__C.RecursiveIterator.Valid#canCall($Heap, this);
  ensures {:id "id141"} ITER__C.RecursiveIterator.Valid($Heap, this);
  free ensures true;
  ensures {:id "id142"} Set#Equal(ITER__C.RecursiveIterator.__reads(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id143"} Set#Equal(ITER__C.RecursiveIterator.__modifies(this), Set#Empty(): Set);
  free ensures true;
  ensures {:id "id144"} Set#Equal($Unbox(read($Heap, this, ITER__C.RecursiveIterator.__new)): Set, 
    Set#Empty(): Set);
  free ensures true;
  ensures {:id "id145"} ITER__C.RecursiveIterator.__decreases0(this) == n#0;
  free ensures true;
  ensures {:id "id146"} ITER__C.RecursiveIterator.__decreases1(this) == r#0;
  free ensures true;
  ensures {:id "id147"} ITER__C.RecursiveIterator.__decreases2(this) == good#0;
...
procedure {:verboseName "ITER_C.RecursiveIterator.Valid (well-formedness)"} CheckWellformed$$ITER__C.RecursiveIterator.Valid(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__C.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__C.RecursiveIterator(), $Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_C.RecursiveIterator.Valid (well-formedness)"} CheckWellformed$$ITER__C.RecursiveIterator.Valid(this: ref)
{
  ...
  var b$reqreads#0: bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool
         ==> $o == this
           || Set#IsMember(ITER__C.RecursiveIterator.__reads(this), $Box($o))
           || Set#IsMember($Unbox(read($Heap, this, ITER__C.RecursiveIterator.__new)): Set, $Box($o)));
    // Check well-formedness of preconditions, and then assume them
    // Check well-formedness of the reads clause
    b$reqreads#0 := $_ReadsFrame[this, ITER__C.RecursiveIterator.__new];
    assert {:id "id148"} b$reqreads#0;
...
procedure {:verboseName "ITER_C.RecursiveIterator.MoveNext (call)"} Call$$ITER__C.RecursiveIterator.MoveNext(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__C.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__C.RecursiveIterator(), $Heap))
   returns (more#0: bool);
  // user-defined preconditions
  requires {:id "id149"} ITER__C.RecursiveIterator.Valid($Heap, this);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id150"} (forall $o: ref :: 
      { $o != null } 
      Set#IsMember($Unbox(read($Heap, this, ITER__C.RecursiveIterator.__new)): Set, $Box($o))
           && !Set#IsMember($Unbox(read(old($Heap), this, ITER__C.RecursiveIterator.__new)): Set, $Box($o))
         ==> $o != null)
     && (forall $o: ref :: 
      ...
      Set#IsMember($Unbox(read($Heap, this, ITER__C.RecursiveIterator.__new)): Set, $Box($o))
         ...
         ==> !$Unbox(read(old($Heap), $o, alloc)): bool);
  free ensures true;
  ensures {:id "id151"} !Set#IsMember($Unbox(read($Heap, this, ITER__C.RecursiveIterator.__new)): Set, $Box(null));
  free ensures more#0 ==> ITER__C.RecursiveIterator.Valid#canCall($Heap, this);
  ensures {:id "id152"} more#0 ==> ITER__C.RecursiveIterator.Valid($Heap, this);
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
    $o != null && $Unbox(read(old($Heap), $o, alloc)): bool
       ==> $Heap[$o] == old($Heap)[$o]
         || 
        $o == this
         || Set#IsMember(ITER__C.RecursiveIterator.__modifies(this), $Box($o))
         || Set#IsMember($Unbox(read(old($Heap), this, ITER__C.RecursiveIterator.__new)): Set, $Box($o)));
  // boilerplate
  free ensures $HeapSucc(old($Heap), $Heap);
...
procedure {:verboseName "ITER_C.RecursiveIterator (correctness)"} Impl$$ITER__C.RecursiveIterator(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__C.RecursiveIterator())
         && $IsAlloc(this, Tclass.ITER__C.RecursiveIterator(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_C.RecursiveIterator (correctness)"} Impl$$ITER__C.RecursiveIterator(this: ref, n#0: int, r#0: ref, good#0: bool)
{
  ...
  var $iter_newUpdate1_1_0: Set;
    ...
    assume {:id "id165"} r#0 != null;
    assume {:id "id166"} ITER__C.RecursiveIterator.n(this) == n#0;
    assume {:id "id167"} ITER__C.RecursiveIterator.r(this) == r#0;
    assume {:id "id168"} ITER__C.RecursiveIterator.good(this) == good#0;
    assume {:id "id169"} ITER__C.RecursiveIterator.Valid($Heap, this);
    assume {:id "id170"} Set#Equal(ITER__C.RecursiveIterator.__reads(this), Set#Empty(): Set);
    assume {:id "id171"} Set#Equal(ITER__C.RecursiveIterator.__modifies(this), Set#Empty(): Set);
    assume {:id "id172"} Set#Equal($Unbox(read($Heap, this, ITER__C.RecursiveIterator.__new)): Set, 
      Set#Empty(): Set);
    assume {:id "id173"} ITER__C.RecursiveIterator.__decreases0(this) == n#0;
    assume {:id "id174"} ITER__C.RecursiveIterator.__decreases1(this) == r#0;
    assume {:id "id175"} ITER__C.RecursiveIterator.__decreases2(this) == good#0;
    assume _yieldCount#0 == 0;
    call $YieldHavoc(this, ITER__C.RecursiveIterator.__reads(this), $Unbox(read($Heap, this, ITER__C.RecursiveIterator.__new)): Set);
    $_OldIterHeap := $Heap;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(292,5)
    assume true;
    ...
    {
        // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(293,12)
        assume true;
        if (ITER__C.RecursiveIterator.good(this))
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(294,10)
            $initHeapCallStmt#1_0_0 := $Heap;
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert {:id "id176"} ITER__C.RecursiveIterator.r(this) != null;
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert {:id "id177"} $Is(ITER__C.RecursiveIterator.n(this) - 1, Tclass._System.nat());
            n##0 := ITER__C.RecursiveIterator.n(this) - 1;
            assert {:id "id178"} 0 <= n#0 || n##0 == n#0;
            assert {:id "id179"} n##0 < n#0;
            call {:id "id180"} Call$$ITER__C.RecIterCaller.M(ITER__C.RecursiveIterator.r(this), n##0);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate1_0_0 := $IterCollectNewObjects($initHeapCallStmt#1_0_0, $Heap, this, ITER__C.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__C.RecursiveIterator.__new, $Box($iter_newUpdate1_0_0));
            assume $IsGoodHeap($Heap);
        }
        else
        {
            // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(296,10)
            $initHeapCallStmt#1_1_0 := $Heap;
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            assert {:id "id181"} ITER__C.RecursiveIterator.r(this) != null;
            assume true;
            // ProcessCallStmt: CheckSubrange
            assert {:id "id182"} $Is(ITER__C.RecursiveIterator.n(this) + 1, Tclass._System.nat());
            n##1 := ITER__C.RecursiveIterator.n(this) + 1;
            assert {:id "id183"} 0 <= n#0 || n##1 == n#0;
            assert {:id "id184"} n##1 < n#0;
            call {:id "id185"} Call$$ITER__C.RecIterCaller.M(ITER__C.RecursiveIterator.r(this), n##1);
            // TrCallStmt: After ProcessCallStmt
            call $iter_newUpdate1_1_0 := $IterCollectNewObjects($initHeapCallStmt#1_1_0, $Heap, this, ITER__C.RecursiveIterator.__new);
            $Heap := update($Heap, this, ITER__C.RecursiveIterator.__new, $Box($iter_newUpdate1_1_0));
            assume $IsGoodHeap($Heap);
        }
    }
}
...
procedure {:verboseName "ITER_C.RecIterCaller.M (well-formedness)"} CheckWellFormed$$ITER__C.RecIterCaller.M(this: ref
       where this != null
         && 
...
procedure {:verboseName "ITER_C.RecIterCaller.M (call)"} Call$$ITER__C.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__C.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__C.RecIterCaller(), $Heap), 
...
procedure {:verboseName "ITER_C.RecIterCaller.M (correctness)"} Impl$$ITER__C.RecIterCaller.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.ITER__C.RecIterCaller())
         && $IsAlloc(this, Tclass.ITER__C.RecIterCaller(), $Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ITER_C.RecIterCaller.M (correctness)"} Impl$$ITER__C.RecIterCaller.M(this: ref, n#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var good#0: bool;
  ...
  var iter#0: ref
     where defass#iter#0
       ==> $Is(iter#0, Tclass.ITER__C.RecursiveIterator())
  ...
  var $rhs##0: bool;
    ...
    $_reverifyPost := false;
    havoc good#0;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(304,16)
    assume true;
    // ----- init call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(304,19)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    n##0 := n#0;
    ...
    // ProcessCallStmt: CheckSubrange
    good##0 := good#0;
    call {:id "id186"} $nw := Call$$ITER__C.RecursiveIterator.__ctor(n##0, r##0, good##0);
    // TrCallStmt: After ProcessCallStmt
    iter#0 := $nw;
    defass#iter#0 := true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Iterators.dfy(305,32)
    assume true;
    // TrCallStmt: Adding lhs with type bool
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id188"} defass#iter#0;
    assume true;
    assert {:id "id189"} iter#0 != null;
    assert {:id "id190"} (forall $o: ref, $f: Field :: 
      $o != null
           && $Unbox(read($Heap, $o, alloc)): bool
           && (
            $o == iter#0
             || Set#IsMember(ITER__C.RecursiveIterator.__modifies(iter#0), $Box($o))
             || Set#IsMember($Unbox(read($Heap, iter#0, ITER__C.RecursiveIterator.__new)): Set, $Box($o)))
         ==> $_ModifiesFrame[$o, $f]);
    assert {:id "id191"} 0 <= n#0 || ITER__C.RecursiveIterator.__decreases0(iter#0) == n#0;
    assert {:id "id192"} ITER__C.RecursiveIterator.__decreases0(iter#0) <= n#0;
    call {:id "id193"} $rhs##0 := Call$$ITER__C.RecursiveIterator.MoveNext(iter#0);
    // TrCallStmt: After ProcessCallStmt
    more#0 := $rhs##0;
}
