...
(declare-fun |_module.StaticOpaque.F#canCall| () Bool)
(declare-fun _module.StaticOpaque.F () Int)
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@3 T@U) ) (!  (=> ($IsGoodHeap $h@@3) ($IsAlloc intType (int_2_U _module.StaticOpaque.z) TInt $h@@3))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |589|
 :pattern ( ($IsAlloc intType (int_2_U _module.StaticOpaque.z) TInt $h@@3))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |_module.StaticOpaque.F#canCall| (< 1 $FunctionContextHeight)) (= _module.StaticOpaque.F _module.StaticOpaque.z))))
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |_module.StaticOpaque.F#canCall| (< 1 $FunctionContextHeight)) (= _module.StaticOpaque.F _module.StaticOpaque.z))))
...
(set-info :boogie-vc-id Impl$$_module.StaticOpaque.Two)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|))) (=> (and (and (= |u#0@0| (+ _module.StaticOpaque.y (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 3))))))) |_module.StaticOpaque.F#canCall|) (and |_module.StaticOpaque.F#canCall| (= |f#0@0| (LitInt _module.StaticOpaque.F)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|))) (=> (= |u'#0@0| (+ _module.StaticOpaque.y (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |a#0|) (IndexField (LitInt 3))))))) (=> (and (and |_module.StaticOpaque.F#canCall| |_module.StaticOpaque.F#canCall|) (and (= |f'#0@0| (LitInt _module.StaticOpaque.F)) (= (ControlFlow 0 2) (- 0 1)))) (= (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |a#0|) (IndexField (LitInt 3))))) _module.StaticOpaque.y) _module.StaticOpaque.y)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) previous$Heap)) (= 2 $FunctionContextHeight)) (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and ($IsAlloc refType |a#0| (Tclass._System.array TInt) previous$Heap) (= (_System.array.Length |a#0|) (LitInt 100))) (and (= (+ _module.StaticOpaque.y (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |a#0|) (IndexField (LitInt 3)))))) _module.StaticOpaque.y) (= (ControlFlow 0 8) 2)))) anon0_correct))))
