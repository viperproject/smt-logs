...
(set-info :boogie-vc-id Impl$$TwoStateAt.__default.TwoLemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@5|) TwoStateAt.Cell.data)))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |c#0@@5|) TwoStateAt.Cell.data))) (TwoStateAt.__default.SP TwoStateAt._default.TwoLemma$Y previous$Heap current$Heap |c#0@@5| |y#0@@6|)))) (=> (=> (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@5|) TwoStateAt.Cell.data)))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |c#0@@5|) TwoStateAt.Cell.data))) (TwoStateAt.__default.SP TwoStateAt._default.TwoLemma$Y previous$Heap current$Heap |c#0@@5| |y#0@@6|))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@5|) TwoStateAt.Cell.data)))) (= (TwoStateAt.__default.SP TwoStateAt._default.TwoLemma$Y previous$Heap current$Heap |c#0@@5| |y#0@@6|) (TwoStateAt.Cell.Plus TwoStateAt._default.TwoLemma$Y previous$Heap current$Heap |c#0@@5| |y#0@@6|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and ($Is refType |c#0@@5| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell previous$Heap))) (=> (and (and (and (and ($IsBox |y#0@@6| TwoStateAt._default.TwoLemma$Y) ($IsAllocBox |y#0@@6| TwoStateAt._default.TwoLemma$Y previous$Heap)) (= 4 $FunctionContextHeight)) (and (= previous$Heap $Heap@@3) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell previous$Heap) ($IsAllocBox |y#0@@6| TwoStateAt._default.TwoLemma$Y previous$Heap)) (and (<= (Mul (LitInt 2) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |c#0@@5|) TwoStateAt.Cell.data)))) (TwoStateAt.Cell.Sum TInt previous$Heap current$Heap |c#0@@5| ($Box intType (int_2_U (LitInt 0))))) (= (ControlFlow 0 4) 2)))) anon0_correct))))
