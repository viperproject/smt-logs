...
(declare-fun _module.SeqOp.S3 (T@U T@U Int) T@U)
(declare-fun |_module.SeqOp.S3#canCall| (T@U T@U Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.S3#canCall| $Heap this |n#0|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) ($Is SeqType (_module.SeqOp.S3 $Heap this |n#0|) (TSeq TReal)))
 :qid |ComprehensionsNewSyntaxdfy.109:12|
 :skolemid |585|
 :pattern ( (_module.SeqOp.S3 $Heap this |n#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.S3#canCall| $Heap@@0 this@@0 |n#0@@0|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.SeqOp) ($IsAlloc refType this@@0 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@0|)))) (= (_module.SeqOp.S3 $Heap@@0 this@@0 |n#0@@0|) (|Seq#Create| TReal $Heap@@0 |n#0@@0| (|_module.SeqOp.H#Handle| this@@0))))
 :qid |ComprehensionsNewSyntaxdfy.109:12|
 :skolemid |587|
 :pattern ( (_module.SeqOp.S3 $Heap@@0 this@@0 |n#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall (($Heap@@1 T@U) (this@@1 T@U) (|i#0| Int) ) (!  (=> (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |i#0|)) (= (|_module.SeqOp.H#requires| $Heap@@1 this@@1 |i#0|) true))
 :qid |ComprehensionsNewSyntaxdfy.92:12|
 :skolemid |549|
 :pattern ( (|_module.SeqOp.H#requires| $Heap@@1 this@@1 |i#0|) ($IsGoodHeap $Heap@@1))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@2 T@U) (this@@2 T@U) (|i#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.H#canCall| $Heap@@2 this@@2 |i#0@@0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@2) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@2)))) (<= (LitInt 0) |i#0@@0|)))) (= (_module.SeqOp.H $Heap@@2 this@@2 |i#0@@0|) (ite (< |i#0@@0| 20) 2.5 (U_2_real ($Unbox realType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 this@@2) _module.SeqOp.x))))))
 :qid |ComprehensionsNewSyntaxdfy.92:12|
 :skolemid |550|
 :pattern ( (_module.SeqOp.H $Heap@@2 this@@2 |i#0@@0|) ($IsGoodHeap $Heap@@2))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.S3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (<= 0 |n#0@@1|)) (=> (<= 0 |n#0@@1|) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@1|)) (Requires1 Tclass._System.nat TReal $Heap@@3 (|_module.SeqOp.H#Handle| this@@3) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |ComprehensionsNewSyntaxdfy.112:5|
 :skolemid |588|
))) (=> (and (and (= |b$reqreads#0@0| (forall ((|seqinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0@@0|) (< |seqinit#0#i0#0@@0| |n#0@@1|)) (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@4) alloc)))) (|Set#IsMember| (Reads1 Tclass._System.nat TReal $Heap@@3 (|_module.SeqOp.H#Handle| this@@3) ($Box intType (int_2_U |seqinit#0#i0#0@@0|))) ($Box refType $o@@4))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |ComprehensionsNewSyntaxdfy.112:5|
 :skolemid |589|
)))
 :qid |ComprehensionsNewSyntaxdfy.112:5|
 :skolemid |590|
))) (= (_module.SeqOp.S3 $Heap@@3 this@@3 |n#0@@1|) (|Seq#Create| TReal $Heap@@3 |n#0@@1| (|_module.SeqOp.H#Handle| this@@3)))) (and ($Is SeqType (_module.SeqOp.S3 $Heap@@3 this@@3 |n#0@@1|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))))))
