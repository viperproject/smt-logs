...
(set-info :boogie-vc-id Impl$$N1.C.L)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N1.C.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|N1.C.Valid#canCall| $Heap@@1 this@@1) (or (N1.C.Valid $Heap@@1 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N1.C.Repr)) ($Box refType this@@1))))) (=> (=> (|N1.C.Valid#canCall| $Heap@@1 this@@1) (or (N1.C.Valid $Heap@@1 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N1.C.Repr)) ($Box refType this@@1)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|N1.C.Valid#canCall| $Heap@@1 this@@1) (or (N1.C.Valid $Heap@@1 this@@1) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N1.C.Repr)) ($Box refType null)))))) (=> (=> (|N1.C.Valid#canCall| $Heap@@1 this@@1) (or (N1.C.Valid $Heap@@1 this@@1) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N1.C.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|N1.C.Valid#canCall| $Heap@@1 this@@1) (or (N1.C.Valid $Heap@@1 this@@1) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (=> (|N1.C.Valid#canCall| $Heap@@1 this@@1) (or (N1.C.Valid $Heap@@1 this@@1) (U_2_bool (Lit boolType (bool_2_U true))))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@6 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N1.C.Repr)) ($Box refType $o@@6)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) N1.C.Repr)) ($Box refType $o@@6)))) (or (not (= $o@@6 null)) (not true)))
 :qid |AutoContractsdfy.70:57|
 :skolemid |1654|
