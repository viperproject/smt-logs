...
(declare-fun MoreFuel_TestModule9._default.abs0 () T@U)
(declare-fun BaseFuel_TestModule9._default.abs () T@U)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id Impl$$TestModule9.__default.test3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (=> (and (and (= (TestModule9.__default.abs StartFuel_TestModule9._default.abs |z#0|) (Mul (LitInt (- 0 1)) |z#0|)) ($IsAlloc intType (int_2_U |y#0|) TInt $Heap)) (and (|TestModule9.__default.abs#canCall| |y#0|) (|TestModule9.__default.abs#canCall| |y#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (TestModule9.__default.abs StartFuelAssert_TestModule9._default.abs |y#0|) |y#0|)) (=> (and (= (TestModule9.__default.abs StartFuel_TestModule9._default.abs |y#0|) |y#0|) (= |##x#2@0| (LitInt (- 0 1)))) (=> (and (and ($IsAlloc intType (int_2_U |##x#2@0|) TInt $Heap) (|TestModule9.__default.abs#canCall| (LitInt (- 0 1)))) (and (|TestModule9.__default.abs#canCall| (LitInt (- 0 1))) (= (ControlFlow 0 2) (- 0 1)))) (= (LitInt (TestModule9.__default.abs StartFuelAssert_TestModule9._default.abs (LitInt (- 0 1)))) (LitInt 1))))))))
(let ((anon3_Then_correct  (=> (= StartFuel_TestModule9._default.abs MoreFuel_TestModule9._default.abs0) (=> (and (and (= StartFuelAssert_TestModule9._default.abs MoreFuel_TestModule9._default.abs0) ($IsAlloc intType (int_2_U |z#0|) TInt $Heap)) (and (|TestModule9.__default.abs#canCall| |z#0|) (|TestModule9.__default.abs#canCall| |z#0|))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (TestModule9.__default.abs StartFuelAssert_TestModule9._default.abs |z#0|) (Mul (LitInt (- 0 1)) |z#0|))) (=> (= (ControlFlow 0 4) 2) anon2_correct))))))
(let ((anon0_correct  (=> (and (and (= StartFuel_TestModule9._default.abs ($LS BaseFuel_TestModule9._default.abs)) (= StartFuelAssert_TestModule9._default.abs ($LS ($LS BaseFuel_TestModule9._default.abs)))) (and (= (AsFuelBottom BaseFuel_TestModule9._default.abs) BaseFuel_TestModule9._default.abs) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 2) anon2_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (= 1 $FunctionContextHeight) (> |y#0| 5)) (and (< |z#0| 0) (= (ControlFlow 0 7) 6))) anon0_correct))))
