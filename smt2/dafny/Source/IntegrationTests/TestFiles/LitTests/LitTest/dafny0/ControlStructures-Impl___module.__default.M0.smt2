...
(let ((anon9_Then_correct  (=> (and (= |d#0| |#_module.D.Blue|) (= (ControlFlow 0 6) (- 0 5))) false)))
(let ((anon8_Else_correct  (=> (or (not (= |d#0| |#_module.D.Purple|)) (not true)) (and (=> (= (ControlFlow 0 8) 6) anon9_Then_correct) (=> (= (ControlFlow 0 8) 7) anon9_Else_correct)))))
(let ((anon8_Then_correct  (=> (and (= |d#0| |#_module.D.Purple|) (= (ControlFlow 0 4) (- 0 3))) false)))
(let ((anon7_Else_correct  (=> (or (not (= |d#0| |#_module.D.Red|)) (not true)) (and (=> (= (ControlFlow 0 9) 4) anon8_Then_correct) (=> (= (ControlFlow 0 9) 8) anon8_Else_correct)))))
(let ((anon7_Then_correct true))
(let ((anon6_Else_correct  (=> (or (not (= |d#0| |#_module.D.Green|)) (not true)) (and (=> (= (ControlFlow 0 10) 2) anon7_Then_correct) (=> (= (ControlFlow 0 10) 9) anon7_Else_correct)))))
(let ((anon6_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 11) 1) anon6_Then_correct) (=> (= (ControlFlow 0 11) 10) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |d#0| Tclass._module.D) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.D $Heap)) (|$IsA#_module.D| |d#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 11))) anon0_correct))))
