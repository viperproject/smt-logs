...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@116  (=> (and (= $generated@@110 ($generated@@75 $generated@@22 $generated@@111 $generated false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@112 0)) (not true)))))
(let (($generated@@117  (=> (and (and ($generated@@113 $generated@@111) ($generated@@114 $generated@@111)) (and (= 0 $generated@@115) (= (ControlFlow 0 3) 2))) $generated@@116)))
$generated@@117)))
))
(check-sat)
