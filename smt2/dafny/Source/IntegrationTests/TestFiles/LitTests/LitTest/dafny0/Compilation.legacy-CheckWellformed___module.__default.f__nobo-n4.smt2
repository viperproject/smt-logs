...
(declare-fun |_module.__default.f__nobody#canCall| () Bool)
(declare-fun _module.__default.f__nobody () Int)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.f__nobody#canCall| (< 0 $FunctionContextHeight)) (> _module.__default.f__nobody 5))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.f__nobody)
...
(let ((anon4_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U true))))))
