...
(set-info :boogie-vc-id Impl$$_module.__default.TestSequences0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon7_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 7))))))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (exists ((|n#1_1| T@U) ) (!  (and (|Seq#Contains| |s#0@0| ($Box intType |n#1_1|)) (and (<= (LitInt (- 0 3)) (U_2_int |n#1_1|)) (< (U_2_int |n#1_1|) 2)))
 :qid |SmallTestsdfy.377:19|
 :skolemid |3160|
 :pattern ( (|Seq#Contains| |s#0@0| ($Box intType |n#1_1|)))
))) (=> (exists ((|n#1_1@@0| Int) ) (!  (and (|Seq#Contains| |s#0@0| ($Box intType (int_2_U |n#1_1@@0|))) (and (<= (LitInt (- 0 3)) |n#1_1@@0|) (< |n#1_1@@0| 2)))
 :qid |SmallTestsdfy.377:19|
 :skolemid |3160|
 :pattern ( (|Seq#Contains| |s#0@0| ($Box intType (int_2_U |n#1_1@@0|))))
)) (=> (= (ControlFlow 0 8) 3) anon7_correct)))))
(let ((anon11_Else_correct  (=> (and (< |n#1_0@0| (LitInt (- 0 3))) (= (ControlFlow 0 12) 8)) anon6_correct)))
(let ((anon11_Then_correct  (=> (and (<= (LitInt (- 0 3)) |n#1_0@0|) (= (ControlFlow 0 11) 8)) anon6_correct)))
(let ((anon10_Then_correct  (=> (|Seq#Contains| |s#0@0| ($Box intType (int_2_U |n#1_0@0|))) (and (=> (= (ControlFlow 0 13) 11) anon11_Then_correct) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))
(let ((anon10_Else_correct  (=> (and (not (|Seq#Contains| |s#0@0| ($Box intType (int_2_U |n#1_0@0|)))) (= (ControlFlow 0 10) 8)) anon6_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 14) 13) anon10_Then_correct) (=> (= (ControlFlow 0 14) 10) anon10_Else_correct))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 4)))) (=> (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 4))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 0)))) (=> (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 1))))) (=> (not (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 1)))) (=> (= (ControlFlow 0 4) 3) anon7_correct)))))))))
(let ((anon9_Else_correct true))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 2)))) (=> (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 2))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 0)))) (=> (|Seq#Contains| |s#0@0| ($Box intType (int_2_U 0))) (and (=> (= (ControlFlow 0 15) 14) anon9_Then_correct) (=> (= (ControlFlow 0 15) 1) anon9_Else_correct))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 0)))) ($Box intType (int_2_U (LitInt 2)))) ($Box intType (int_2_U (LitInt 4))))))) (and (=> (= (ControlFlow 0 18) 4) anon8_Then_correct) (=> (= (ControlFlow 0 18) 15) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
