...
(declare-fun _module.__default.seq__dec__drop (T@U T@U) Int)
(declare-fun $LS (T@U) T@U)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun SeqType () T@T)
(declare-fun |_module.__default.seq__dec__drop#canCall| (T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.seq__dec__drop#canCall| (Lit SeqType |xs#0|)) (and (< 0 $FunctionContextHeight) ($Is SeqType |xs#0| (TSeq TInt)))) (and (=> (or (not (= (|Seq#Length| (Lit SeqType |xs#0|)) (LitInt 0))) (not true)) (|_module.__default.seq__dec__drop#canCall| (Lit SeqType (|Seq#Drop| (Lit SeqType |xs#0|) (LitInt 1))))) (= (_module.__default.seq__dec__drop ($LS $ly) (Lit SeqType |xs#0|)) (ite (= (|Seq#Length| (Lit SeqType |xs#0|)) (LitInt 0)) 0 (+ 1 (_module.__default.seq__dec__drop ($LS $ly) (Lit SeqType (|Seq#Drop| (Lit SeqType |xs#0|) (LitInt 1)))))))))
 :qid |RankPosdfy.35:16|
 :weight 3
 :skolemid |519|
 :pattern ( (_module.__default.seq__dec__drop ($LS $ly) (Lit SeqType |xs#0|)))
))))
...
(assert (forall (($ly@@0 T@U) (|xs#0@@0| T@U) ) (! (= (_module.__default.seq__dec__drop ($LS $ly@@0) |xs#0@@0|) (_module.__default.seq__dec__drop $ly@@0 |xs#0@@0|))
 :qid |RankPosdfy.35:16|
 :skolemid |514|
 :pattern ( (_module.__default.seq__dec__drop ($LS $ly@@0) |xs#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($ly@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.seq__dec__drop#canCall| |xs#0@@1|) (and (< 0 $FunctionContextHeight) ($Is SeqType |xs#0@@1| (TSeq TInt)))) (and (=> (or (not (= (|Seq#Length| |xs#0@@1|) (LitInt 0))) (not true)) (|_module.__default.seq__dec__drop#canCall| (|Seq#Drop| |xs#0@@1| (LitInt 1)))) (= (_module.__default.seq__dec__drop ($LS $ly@@1) |xs#0@@1|) (ite (= (|Seq#Length| |xs#0@@1|) (LitInt 0)) 0 (+ 1 (_module.__default.seq__dec__drop $ly@@1 (|Seq#Drop| |xs#0@@1| (LitInt 1))))))))
 :qid |RankPosdfy.35:16|
 :skolemid |518|
 :pattern ( (_module.__default.seq__dec__drop ($LS $ly@@1) |xs#0@@1|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.seq__dec__drop)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon8_Else_correct  (=> (or (not (= (|Seq#Length| |xs#0@@2|) (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |xs#0@@2|)))) (=> (and (<= 0 (LitInt 1)) (<= (LitInt 1) (|Seq#Length| |xs#0@@2|))) (=> (= |##xs#0@0| (|Seq#Drop| |xs#0@@2| (LitInt 1))) (=> (and ($IsAlloc SeqType |##xs#0@0| (TSeq TInt) $Heap) (= (ControlFlow 0 4) (- 0 3))) (< (|Seq#Rank| |##xs#0@0|) (|Seq#Rank| |xs#0@@2|)))))))))
