...
(declare-fun $Heap@0 () T@U)
(set-info :boogie-vc-id Impl$$Abstract.MyNumber.Init)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@0 alloc false)) (=> (and (= |$rhs#0@0| (LitInt 0)) (= |$rhs#1@0| (|Set#UnionOne| |Set#Empty| ($Box refType this@@1)))) (=> (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass.Abstract.MyNumber?)) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) alloc)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.N))) |$rhs#0@0|))) (=> (and (and (and (= ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.Repr)) |$rhs#1@0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and ($IsAllocBox ($Box refType this@@1) Tclass.Abstract.MyNumber? $Heap@0) (|Abstract.MyNumber.Valid#canCall| $Heap@0 this@@1)) (and (|Abstract.MyNumber.Valid#canCall| $Heap@0 this@@1) (Abstract.MyNumber.Valid $Heap@0 this@@1)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) Abstract.MyNumber.N))) (LitInt 0))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) Abstract.MyNumber.N))) (LitInt 0)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Abstract.MyNumber.Valid $Heap@0 this@@1)) (=> (Abstract.MyNumber.Valid $Heap@0 this@@1) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@9 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) Abstract.MyNumber.Repr)) ($Box refType $o@@9)) (or (not (= $o@@9 null)) (not true)))
 ...
 :qid |Refinementdfy.118:26|
 :skolemid |4454|
 :pattern ( (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) Abstract.MyNumber.Repr)) ($Box refType $o@@10)))
))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct)))
