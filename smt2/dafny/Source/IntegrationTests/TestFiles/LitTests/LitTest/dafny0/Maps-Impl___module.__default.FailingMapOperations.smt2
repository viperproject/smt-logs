...
(assert (distinct TInt TReal TagInt TagReal TagSet TagMap alloc |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 |tytagFamily$_tuple#2|)
)
...
(assert (forall ((bx@@4 T@U) (s@@0 T@U) (t@@6 T@U) ) (!  (=> ($IsBox bx@@4 (TMap s@@0 t@@6)) (and (= ($Box MapType ($Unbox MapType bx@@4)) bx@@4) ($Is MapType ($Unbox MapType bx@@4) (TMap s@@0 t@@6))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |36|
 :pattern ( ($IsBox bx@@4 (TMap s@@0 t@@6)))
)))
...
(assert (forall ((m@@10 T@U) (s@@1 T@U) ) (! (= (|Map#Domain| (|Map#Subtract| m@@10 s@@1)) (|Set#Difference| (|Map#Domain| m@@10) s@@1))
 :qid |DafnyPreludebpl.1486:15|
 :skolemid |295|
 :pattern ( (|Map#Domain| (|Map#Subtract| m@@10 s@@1)))
)))
...
(assert (forall ((m@@12 T@U) ) (!  (or (= m@@12 |Map#Empty|) (exists ((k@@0 T@U) (v@@9 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@12) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@9)))
...
(set-info :boogie-vc-id Impl$$_module.__default.FailingMapOperations)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 29) (let ((anon5_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (=> (not (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (|Set#IsMember| |s#0| ($Box intType (int_2_U |x#0|))))) (=> (and (=> (not (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (|Set#IsMember| |s#0| ($Box intType (int_2_U |x#0|)))) (= (ControlFlow 0 16) (- 0 15))) (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))))))
(let ((anon11_Else_correct  (=> (and (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))) (= (ControlFlow 0 19) 16)) anon5_correct)))
(let ((anon11_Then_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (= (ControlFlow 0 18) 16)) anon5_correct)))
(let ((anon3_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (=> (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|))) (=> (=> (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|)) (and (=> (= (ControlFlow 0 20) 18) anon11_Then_correct) (=> (= (ControlFlow 0 20) 19) anon11_Else_correct))))))
(let ((anon10_Else_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (= (ControlFlow 0 24) 20)) anon3_correct)))
(let ((anon10_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|))) (and (=> (= (ControlFlow 0 22) (- 0 23)) (|Set#IsMember| (|Map#Domain| |m'#0_0@0|) ($Box intType (int_2_U |x#0|)))) (=> (= (ControlFlow 0 22) 20) anon3_correct)))))
(let ((anon9_Then_correct  (=> (= |m'#0_0@0| (|Map#Subtract| |m#0| |s#0|)) (and (=> (= (ControlFlow 0 25) 22) anon10_Then_correct) (=> (= (ControlFlow 0 25) 24) anon10_Else_correct)))))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (not (|Set#IsMember| (|Map#Domain| |n#0|) ($Box intType (int_2_U |x#0|)))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |x#0|)))))))) (=> (=> (not (|Set#IsMember| (|Map#Domain| |n#0|) ($Box intType (int_2_U |x#0|)))) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |x#0|))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Set#IsMember| (|Map#Domain| |m'#1_0@0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |x#0|))))))) (=> (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#1_0@0|) ($Box intType (int_2_U |x#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |x#0|)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |y#0|))))))))))))
(let ((anon12_Else_correct  (=> (and (|Set#IsMember| (|Map#Domain| |n#0|) ($Box intType (int_2_U |x#0|))) (= (ControlFlow 0 10) 2)) anon8_correct)))
(let ((anon12_Then_correct  (=> (not (|Set#IsMember| (|Map#Domain| |n#0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (|Set#IsMember| (|Map#Domain| |m'#1_0@0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|)))) (=> (= (ControlFlow 0 7) 2) anon8_correct))))))
(let ((anon9_Else_correct  (=> (= |m'#1_0@0| (|Map#Merge| |m#0| |n#0|)) (and (=> (= (ControlFlow 0 11) (- 0 14)) (|Set#IsMember| (|Map#Domain| |m'#1_0@0|) ($Box intType (int_2_U |y#0|)))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (|Set#IsMember| (|Map#Domain| |n#0|) ($Box intType (int_2_U |y#0|)))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#1_0@0|) ($Box intType (int_2_U |y#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |n#0|) ($Box intType (int_2_U |y#0|))))))) (=> (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m'#1_0@0|) ($Box intType (int_2_U |y#0|))))) (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |n#0|) ($Box intType (int_2_U |y#0|)))))) (and (=> (= (ControlFlow 0 11) 7) anon12_Then_correct) (=> (= (ControlFlow 0 11) 10) anon12_Else_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|)))) (=> (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|))) (=> (= |$rhs#0@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0|) ($Box intType (int_2_U |x#0|)))))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (|Set#IsMember| (|Map#Domain| |n#0|) ($Box intType (int_2_U |y#0|)))) (=> (|Set#IsMember| (|Map#Domain| |n#0|) ($Box intType (int_2_U |y#0|))) (=> (= |$rhs#1@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |n#0|) ($Box intType (int_2_U |y#0|)))))) (and (=> (= (ControlFlow 0 26) 25) anon9_Then_correct) (=> (= (ControlFlow 0 26) 11) anon9_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |m#0| (TMap TInt TReal)) ($IsAlloc MapType |m#0| (TMap TInt TReal) $Heap))) (=> (and (and (and (and ($Is MapType |n#0| (TMap TInt TReal)) ($IsAlloc MapType |n#0| (TMap TInt TReal) $Heap)) (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap))) (and (and ($Is MapType |m'#0_0| (TMap TInt TReal)) ($IsAlloc MapType |m'#0_0| (TMap TInt TReal) $Heap)) true)) (and (and (and ($Is MapType |m'#1_0| (TMap TInt TReal)) ($IsAlloc MapType |m'#1_0| (TMap TInt TReal) $Heap)) true) (and (and (= 0 $FunctionContextHeight) (|Set#IsMember| (|Map#Domain| |m#0|) ($Box intType (int_2_U |x#0|)))) (and (|Set#IsMember| (|Map#Domain| |n#0|) ($Box intType (int_2_U |y#0|))) (= (ControlFlow 0 29) 26))))) anon0_correct))))
