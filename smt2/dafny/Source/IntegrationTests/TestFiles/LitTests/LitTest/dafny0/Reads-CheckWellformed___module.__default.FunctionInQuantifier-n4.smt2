...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.FunctionInQuantifier1)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($Is HandleTypeType |f#2@0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#2@0| (Tclass._System.___hFunc1 TInt TInt) $Heap)) ($IsAllocBox ($Box HandleTypeType |f#2@0|) (Tclass._System.___hFunc1 TInt TInt) $Heap)) (and (and (= |##x0#0@0| (LitInt 10)) ($IsAlloc intType (int_2_U |##x0#0@0|) TInt $Heap)) (and (= |b$reqreads#0@0| (forall (($o@@0 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap |f#2@0| ($Box intType (int_2_U |##x0#0@0|))) ($Box refType $o@@0))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@0 $f@@0)))
 :qid |Readsdfy.125:38|
 :skolemid |643|
))) (Requires1 TInt TInt $Heap |f#2@0| ($Box intType (int_2_U (LitInt 10))))))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (Requires1 TInt TInt $Heap |f#2@0| ($Box intType (int_2_U (LitInt 10))))) (=> (Requires1 TInt TInt $Heap |f#2@0| ($Box intType (int_2_U (LitInt 10)))) (=> (and (= |b$reqreads#1@0| (forall (($o@@1 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@1 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@1) alloc)))) (|Set#IsMember| (Reads1 TInt TInt $Heap |f#2@0| ($Box intType (int_2_U (LitInt 10)))) ($Box refType $o@@1))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@1 $f@@1)))
 :qid |Readsdfy.125:54|
 :skolemid |644|
))) (= (U_2_int ($Unbox intType (Apply1 TInt TInt $Heap |f#2@0| ($Box intType (int_2_U (LitInt 10)))))) (LitInt 100))) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@0|) (=> |b$reqreads#1@0| (and (=> (= (ControlFlow 0 3) 1) anon4_Then_correct) (=> (= (ControlFlow 0 3) 2) anon4_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 3))) anon0_correct)))
