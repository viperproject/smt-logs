...
axiom {:id "id247"} 0 <= $FunctionContextHeight
   ==> 
  M0.__default.F#canCall() || 0 < $FunctionContextHeight
   ==> M0.__default.F(true) == LitInt(12);
...
procedure {:verboseName "M0.F (well-formedness)"} CheckWellformed$$M0.__default.F();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M0.reveal_F (well-formedness)"} {:verify false} CheckWellFormed$$M0.__default.reveal__F();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "M0.reveal_F (call)"} {:verify false} Call$$M0.__default.reveal__F();
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
  free ensures reveal_M0._default.F;
