...
(set-info :boogie-vc-id CheckWellFormed$$_module.IterC.__ctor)
...
)) ($HeapSucc $Heap $Heap@0))) (and (and (or (not (= this@0 null)) (not true)) (and ($Is refType this@0 Tclass._module.IterC) ($IsAlloc refType this@0 Tclass._module.IterC $Heap@0))) (= (_module.IterC.c this@0) |c#0@@5|))) (and (and (and ($IsAllocBox ($Box refType this@0) Tclass._module.IterC? $Heap@0) (|_module.IterC.Valid#canCall| $Heap@0 this@0)) (and (_module.IterC.Valid $Heap@0 this@0) (|Set#Equal| (_module.IterC.__reads this@0) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@5|))))) (and (and (|Set#Equal| (_module.IterC.__modifies this@0) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@5|))) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@0) _module.IterC.__new)) |Set#Empty|)) (and (= (_module.IterC.__decreases0 this@0) |c#0@@5|) (= (_module.IterC.__decreases1 this@0) |c#0@@5|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType |c#0@@5| Tclass._module.Cell? $Heap))))))))
