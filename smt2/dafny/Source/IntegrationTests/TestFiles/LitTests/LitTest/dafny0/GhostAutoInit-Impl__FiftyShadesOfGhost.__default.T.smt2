...
(assert (forall ((d T@U) ) (!  (=> ($Is DatatypeTypeType d Tclass.FiftyShadesOfGhost.LongCell) (FiftyShadesOfGhost.LongCell.LongGH_q d))
 :qid |unknown.0:0|
 :skolemid |2059|
 :pattern ( (FiftyShadesOfGhost.LongCell.LongGH_q d) ($Is DatatypeTypeType d Tclass.FiftyShadesOfGhost.LongCell))
)))
...
(assert (forall ((d@@0 T@U) ) (! (= (FiftyShadesOfGhost.LongCell.LongGH_q d@@0) (= (DatatypeCtorId d@@0) |##FiftyShadesOfGhost.LongCell.LongGH|))
 :qid |unknown.0:0|
 :skolemid |2044|
 :pattern ( (FiftyShadesOfGhost.LongCell.LongGH_q d@@0))
)))
...
(assert (forall ((d@@1 T@U) ) (!  (=> (FiftyShadesOfGhost.LongCell.LongGH_q d@@1) (exists ((|a#1#0#0| Int) (|a#1#1#0| Int) (|a#1#2#0| T@U) (|a#1#3#0| T@U) ) (! (= d@@1 (|#FiftyShadesOfGhost.LongCell.LongGH| |a#1#0#0| |a#1#1#0| |a#1#2#0| |a#1#3#0|))
 :qid |GhostAutoInitdfy.249:30|
 :skolemid |2045|
)))
 :qid |unknown.0:0|
...
(assert (forall ((d@@2 T@U) ($h@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (FiftyShadesOfGhost.LongCell.LongGH_q d@@2) ($IsAlloc DatatypeTypeType d@@2 Tclass.FiftyShadesOfGhost.LongCell $h@@3))) ($IsAlloc intType (int_2_U (FiftyShadesOfGhost.LongCell.c d@@2)) Tclass.FiftyShadesOfGhost.G $h@@3))
 :qid |unknown.0:0|
 :skolemid |2049|
 :pattern ( ($IsAlloc intType (int_2_U (FiftyShadesOfGhost.LongCell.c d@@2)) Tclass.FiftyShadesOfGhost.G $h@@3))
)))
(assert (forall ((d@@3 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (FiftyShadesOfGhost.LongCell.LongGH_q d@@3) ($IsAlloc DatatypeTypeType d@@3 Tclass.FiftyShadesOfGhost.LongCell $h@@4))) ($IsAlloc intType (int_2_U (FiftyShadesOfGhost.LongCell.g d@@3)) Tclass.FiftyShadesOfGhost.G $h@@4))
 :qid |unknown.0:0|
 :skolemid |2050|
 :pattern ( ($IsAlloc intType (int_2_U (FiftyShadesOfGhost.LongCell.g d@@3)) Tclass.FiftyShadesOfGhost.G $h@@4))
)))
(assert (forall ((d@@4 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (FiftyShadesOfGhost.LongCell.LongGH_q d@@4) ($IsAlloc DatatypeTypeType d@@4 Tclass.FiftyShadesOfGhost.LongCell $h@@5))) ($IsAlloc refType (FiftyShadesOfGhost.LongCell.d d@@4) Tclass.FiftyShadesOfGhost.H $h@@5))
 :qid |unknown.0:0|
 :skolemid |2051|
 :pattern ( ($IsAlloc refType (FiftyShadesOfGhost.LongCell.d d@@4) Tclass.FiftyShadesOfGhost.H $h@@5))
)))
(assert (forall ((d@@5 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (FiftyShadesOfGhost.LongCell.LongGH_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass.FiftyShadesOfGhost.LongCell $h@@6))) ($IsAlloc refType (FiftyShadesOfGhost.LongCell.h d@@5) Tclass.FiftyShadesOfGhost.H $h@@6))
 :qid |unknown.0:0|
 :skolemid |2052|
 :pattern ( ($IsAlloc refType (FiftyShadesOfGhost.LongCell.h d@@5) Tclass.FiftyShadesOfGhost.H $h@@6))
)))
...
(set-info :boogie-vc-id Impl$$FiftyShadesOfGhost.__default.T)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (=> |defass#m#0| (= (Mod |m#0@0| (LitInt 2)) (LitInt 1))) (= (Mod |n#0@0| (LitInt 2)) (LitInt 1))) (and (=> |defass#x#0| (and ($Is refType |x#0@0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |x#0@0| Tclass.FiftyShadesOfGhost.H $Heap))) (=> |defass#y#0| (and ($Is refType |y#0@0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |y#0@0| Tclass.FiftyShadesOfGhost.H $Heap))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) |defass#m#0|) (=> |defass#m#0| (and (=> (= (ControlFlow 0 2) (- 0 3)) |defass#x#0|) (=> |defass#x#0| (=> (= (ControlFlow 0 2) (- 0 1)) |defass#y#0|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (=> |defass#m#0| (= (Mod |m#0| (LitInt 2)) (LitInt 1))) true) (and (= (Mod |n#0| (LitInt 2)) (LitInt 1)) true)) (=> (and (and (and (=> |defass#x#0| (and ($Is refType |x#0@@1| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |x#0@@1| Tclass.FiftyShadesOfGhost.H $Heap))) true) (and (=> |defass#y#0| (and ($Is refType |y#0| Tclass.FiftyShadesOfGhost.H) ($IsAlloc refType |y#0| Tclass.FiftyShadesOfGhost.H $Heap))) true)) (and (and (=> |defass#cell#0| (and ($Is DatatypeTypeType |cell#0| Tclass.FiftyShadesOfGhost.LongCell) ($IsAlloc DatatypeTypeType |cell#0| Tclass.FiftyShadesOfGhost.LongCell $Heap))) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))))
