...
(declare-fun _module.__default.intsize (T@U T@U) Int)
(declare-fun $LS (T@U) T@U)
(declare-fun |_module.__default.intsize#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) (|l#0| T@U) ) (!  (=> (or (|_module.__default.intsize#canCall| (Lit DatatypeTypeType |l#0|)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0| Tclass._module.intlist))) (and (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.intlist.IntNil_q (Lit DatatypeTypeType |l#0|)))))) (|_module.__default.intsize#canCall| (Lit DatatypeTypeType (_module.intlist.tail (Lit DatatypeTypeType |l#0|))))) (= (_module.__default.intsize ($LS $ly) (Lit DatatypeTypeType |l#0|)) (ite (_module.intlist.IntNil_q (Lit DatatypeTypeType |l#0|)) 0 (+ 1 (_module.__default.intsize ($LS $ly) (Lit DatatypeTypeType (_module.intlist.tail (Lit DatatypeTypeType |l#0|)))))))))
 :qid |Computationsdfy.23:16|
 :weight 3
 :skolemid |552|
 :pattern ( (_module.__default.intsize ($LS $ly) (Lit DatatypeTypeType |l#0|)))
))))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@0 T@U) (|l#0@@0| T@U) ) (!  (=> (or (|_module.__default.intsize#canCall| |l#0@@0|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@0| Tclass._module.intlist))) (<= (LitInt 0) (_module.__default.intsize $ly@@0 |l#0@@0|)))
 :qid |Computationsdfy.23:16|
 :skolemid |549|
 :pattern ( (_module.__default.intsize $ly@@0 |l#0@@0|))
))))
...
(assert (forall (($ly@@1 T@U) (|l#0@@1| T@U) ) (! (= (_module.__default.intsize ($LS $ly@@1) |l#0@@1|) (_module.__default.intsize $ly@@1 |l#0@@1|))
 :qid |Computationsdfy.23:16|
 :skolemid |546|
 :pattern ( (_module.__default.intsize ($LS $ly@@1) |l#0@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@2 T@U) (|l#0@@3| T@U) ) (!  (=> (or (|_module.__default.intsize#canCall| |l#0@@3|) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType |l#0@@3| Tclass._module.intlist))) (and (=> (not (_module.intlist.IntNil_q |l#0@@3|)) (|_module.__default.intsize#canCall| (_module.intlist.tail |l#0@@3|))) (= (_module.__default.intsize ($LS $ly@@2) |l#0@@3|) (ite (_module.intlist.IntNil_q |l#0@@3|) 0 (+ 1 (_module.__default.intsize $ly@@2 (_module.intlist.tail |l#0@@3|)))))))
 :qid |Computationsdfy.23:16|
 :skolemid |551|
 :pattern ( (_module.__default.intsize ($LS $ly@@2) |l#0@@3|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.intsize)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon8_Else_correct  (=> (not (_module.intlist.IntNil_q |l#0@@4|)) (and (=> (= (ControlFlow 0 5) (- 0 7)) (_module.intlist.IntCons_q |l#0@@4|)) (=> (_module.intlist.IntCons_q |l#0@@4|) (=> (and (= |##l#0@0| (_module.intlist.tail |l#0@@4|)) ($IsAlloc DatatypeTypeType |##l#0@0| Tclass._module.intlist $Heap)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (< (DtRank |##l#0@0|) (DtRank |l#0@@4|))) (=> (< (DtRank |##l#0@0|) (DtRank |l#0@@4|)) (=> (and (|_module.__default.intsize#canCall| (_module.intlist.tail |l#0@@4|)) (= (ControlFlow 0 5) (- 0 4))) ($Is intType (int_2_U (+ 1 (_module.__default.intsize ($LS $LZ) (_module.intlist.tail |l#0@@4|)))) Tclass._System.nat))))))))))
(let ((anon8_Then_correct  (=> (and (_module.intlist.IntNil_q |l#0@@4|) (= (ControlFlow 0 3) (- 0 2))) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 8) 1) anon7_Then_correct) (=> (= (ControlFlow 0 8) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 8) 5) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |l#0@@4| Tclass._module.intlist)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct)))
