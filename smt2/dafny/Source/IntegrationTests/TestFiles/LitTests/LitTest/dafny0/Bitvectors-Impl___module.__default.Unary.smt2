...
(declare-fun $generated@@85 () (_ BitVec 16))
(declare-fun $generated@@86 () (_ BitVec 16))
(declare-fun $generated@@87 () (_ BitVec 16))
(declare-fun $generated@@88 () T@U)
(declare-fun $generated@@89 () T@U)
(declare-fun $generated@@90 () T@U)
(declare-fun $generated@@91 () T@U)
(declare-fun $generated@@92 () (_ BitVec 16))
(declare-fun $generated@@93 (T@U) (_ BitVec 16))
(declare-fun $generated@@94 () T@T)
(declare-fun $generated@@95 ((_ BitVec 16)) T@U)
(declare-fun $generated@@96 (T@U) Bool)
(declare-fun $generated@@97 (T@U) Bool)
(declare-fun $generated@@98 () Int)
(assert  (and (and (= ($generated@@0 $generated@@94) 7) (forall (($generated@@99 (_ BitVec 16)) ) (! (= ($generated@@93 ($generated@@95 $generated@@99)) $generated@@99)
 :pattern ( ($generated@@95 $generated@@99))
))) (forall (($generated@@100 T@U) ) (! (= ($generated@@95 ($generated@@93 $generated@@100)) $generated@@100)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let (($generated@@101  (and (=> (= (ControlFlow 0 21) (- 0 23)) (= (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))) (bvsub #x0000 (bvsub #x0000 $generated@@85)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (= (bvsub #x0000 (bvsub #x0000 $generated@@85)) $generated@@85)) (=> (and (and (= (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))) (bvsub #x0000 (bvsub #x0000 $generated@@85))) (= (bvsub #x0000 (bvsub #x0000 $generated@@85)) $generated@@85)) (= (ControlFlow 0 21) (- 0 20))) (= (bvadd (bvadd $generated@@86 $generated@@86) (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))) (bvadd (bvadd $generated@@86 $generated@@86) $generated@@85)))))))
(let (($generated@@102  (=> (and (or (not (= (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))) (bvsub #x0000 (bvsub #x0000 $generated@@85)))) (not true)) (= (ControlFlow 0 25) 21)) $generated@@101)))
(let (($generated@@103  (=> (and (= (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))) (bvsub #x0000 (bvsub #x0000 $generated@@85))) (= (ControlFlow 0 24) 21)) $generated@@101)))
(let (($generated@@104  (and (=> (= (ControlFlow 0 26) 24) $generated@@103) (=> (= (ControlFlow 0 26) 25) $generated@@102))))
(let (($generated@@105  (=> (= (ControlFlow 0 18) (- 0 17)) (= $generated@@87 (bvsub $generated@@85 #x0002)))))
(let (($generated@@106  (=> (and (= $generated@@87 (bvsub $generated@@85 #x0002)) (= (ControlFlow 0 19) 18)) $generated@@105)))
(let (($generated@@107  (=> (= (ControlFlow 0 16) (- 0 15)) (= (bvadd (bvadd $generated@@86 $generated@@86) $generated@@85) (bvsub $generated@@85 #x0002)))))
(let (($generated@@108  (=> (= (ControlFlow 0 14) (- 0 13)) (= (bvsub (bvadd $generated@@86 $generated@@86) (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))))) (bvadd (bvadd $generated@@86 $generated@@86) (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))))))))
(let (($generated@@109  (=> (= (ControlFlow 0 12) (- 0 11)) (= (bvadd $generated@@86 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))))) (bvsub (bvadd $generated@@86 $generated@@86) (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))))))))
(let (($generated@@110  (=> (= (ControlFlow 0 10) (- 0 9)) (= (bvsub $generated@@86 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))))))) (bvadd $generated@@86 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))))))))))
(let (($generated@@111  (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (bvsub #x0000 (bvsub #x0000 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))))))) (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))))))) (=> (= (bvsub #x0000 (bvsub #x0000 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))))))) (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))))))) (=> (= (ControlFlow 0 7) (- 0 6)) (= (bvsub $generated@@86 (bvsub #x0000 (bvsub #x0000 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))))))))) (bvsub $generated@@86 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))))))))))))
(let (($generated@@112  (=> (= (ControlFlow 0 5) (- 0 4)) (= (bvnot (bvsub #x0000 (bvsub #x0000 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))))))))) (bvsub $generated@@86 (bvsub #x0000 (bvsub #x0000 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))))))))))))
(let (($generated@@113  (=> (= (ControlFlow 0 3) (- 0 2)) (= $generated@@87 (bvnot (bvsub #x0000 (bvsub #x0000 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85))))))))))))))
(let (($generated@@114 true))
(let (($generated@@115  (=> (and (and (= $generated@@88 ($generated@@27 $generated@@89 $generated@@90 $generated@@91 false)) (= $generated@@92 (bvsub #x0000 (bvsub #x0000 (bvnot (bvsub #x0000 (bvnot (bvnot (bvsub #x0000 (bvsub #x0000 $generated@@85)))))))))) (and (= $generated@@87 (bvnot (bvsub #x0000 $generated@@92))) (= $generated@@86 ($generated@@93 ($generated $generated@@94 ($generated@@95 #xffff)))))) (and (and (and (and (and (and (and (and (and (=> (= (ControlFlow 0 27) 1) $generated@@114) (=> (= (ControlFlow 0 27) 3) $generated@@113)) (=> (= (ControlFlow 0 27) 5) $generated@@112)) (=> (= (ControlFlow 0 27) 7) $generated@@111)) (=> (= (ControlFlow 0 27) 10) $generated@@110)) (=> (= (ControlFlow 0 27) 12) $generated@@109)) (=> (= (ControlFlow 0 27) 14) $generated@@108)) (=> (= (ControlFlow 0 27) 26) $generated@@104)) (=> (= (ControlFlow 0 27) 16) $generated@@107)) (=> (= (ControlFlow 0 27) 19) $generated@@106)))))
(let (($generated@@116  (=> (and (and ($generated@@96 $generated@@90) ($generated@@97 $generated@@90)) (and (= 0 $generated@@98) (= (ControlFlow 0 28) 27))) $generated@@115)))
$generated@@116)))))))))))))))))
))
(check-sat)
(get-info :rlimit)
