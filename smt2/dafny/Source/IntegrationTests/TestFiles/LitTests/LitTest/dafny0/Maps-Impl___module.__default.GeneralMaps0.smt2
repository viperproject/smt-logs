...
(declare-fun |lambda#42| (T@U Int Int Int) T@U)
...
(declare-fun |lambda#41| (Int) T@U)
(declare-fun |lambda#43| (Int) T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) (|y#0@@0| Int) ) (!  (=> (or (|_module.__default.Plus#canCall| |x#0@@0| |y#0@@0|) (< 0 $FunctionContextHeight)) (= (_module.__default.Plus |x#0@@0| |y#0@@0|) (+ |x#0@@0| |y#0@@0|)))
 :qid |Mapsdfy.198:15|
 :skolemid |644|
 :pattern ( (_module.__default.Plus |x#0@@0| |y#0@@0|))
))))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| Int) (|l#2@@0| Int) (|l#3| Int) (|$w#1| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#42| |l#0@@0| |l#1@@0| |l#2@@0| |l#3|) |$w#1|))  (and ($IsBox |$w#1| |l#0@@0|) (exists ((|a#0#0#0@@0| Int) ) (!  (and (and (<= |l#1@@0| |a#0#0#0@@0|) (< |a#0#0#0@@0| |l#2@@0|)) (= (U_2_int ($Unbox intType |$w#1|)) (_module.__default.Plus |a#0#0#0@@0| |l#3|)))
 :qid |Mapsdfy.206:12|
 :skolemid |649|
))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |923|
 :pattern ( (MapType0Select BoxType boolType (|lambda#42| |l#0@@0| |l#1@@0| |l#2@@0| |l#3|) |$w#1|))
)))
...
(assert (forall ((|l#0@@2| Int) (|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#41| |l#0@@2|) |$w#0@@0|) ($Box intType (int_2_U (+ (U_2_int ($Unbox intType |$w#0@@0|)) |l#0@@2|))))
 :qid |unknown.0:0|
 :skolemid |922|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#41| |l#0@@2|) |$w#0@@0|))
)))
...
(assert (forall ((|l#0@@3| Int) (|$w#1@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#43| |l#0@@3|) |$w#1@@0|) ($Box intType (int_2_U (+ (|map$project$0#0#y#0| (U_2_int ($Unbox intType |$w#1@@0|))) |l#0@@3|))))
 :qid |unknown.0:0|
 :skolemid |924|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#43| |l#0@@3|) |$w#1@@0|))
)))
...
(declare-fun |m#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.GeneralMaps0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 33) (let ((anon14_correct  (=> (and (and (and (forall ((|y#1| Int) ) (!  (and (|_module.__default.Plus#canCall| |y#1| (LitInt 1)) (forall ((|a#1#0#0@@0| Int) ) (!  (=> (and (<= (LitInt 2) |a#1#0#0@@0|) (< |a#1#0#0@@0| 6)) (and (and (<= (LitInt 2) (|map$project$0#0#y#0| (_module.__default.Plus |a#1#0#0@@0| (LitInt 1)))) (< (|map$project$0#0#y#0| (_module.__default.Plus |a#1#0#0@@0| (LitInt 1))) 6)) (= (_module.__default.Plus |a#1#0#0@@0| (LitInt 1)) (_module.__default.Plus (|map$project$0#0#y#0| (_module.__default.Plus |a#1#0#0@@0| (LitInt 1))) (LitInt 1)))))
 :qid |Mapsdfy.206:12|
 :skolemid |650|
 :pattern ( (_module.__default.Plus |a#1#0#0@@0| 1))
)))
 :qid |Mapsdfy.206:12|
 :skolemid |651|
 :pattern ( (_module.__default.Plus |y#1| 1))
)) (= |m#0@1| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#42| TInt (LitInt 2) 6 (LitInt 1))) (|lambda#43| 3) (TMap TInt TInt)))) (and (= |##x#1@0| (LitInt 5)) ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap))) (and (and (= |##y#1@0| (LitInt 1)) ($IsAlloc intType (int_2_U |##y#1@0|) TInt $Heap)) (and (|_module.__default.Plus#canCall| (LitInt 5) (LitInt 1)) (|_module.__default.Plus#canCall| (LitInt 5) (LitInt 1))))) (and (=> (= (ControlFlow 0 4) (- 0 9)) (|Set#IsMember| (|Map#Domain| |m#0@1|) ($Box intType (int_2_U (LitInt (_module.__default.Plus (LitInt 5) (LitInt 1))))))) (=> (|Set#IsMember| (|Map#Domain| |m#0@1|) ($Box intType (int_2_U (LitInt (_module.__default.Plus (LitInt 5) (LitInt 1)))))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (not (|Set#IsMember| (|Map#Domain| |m#0@1|) ($Box intType (int_2_U (LitInt 7)))))) (=> (not (|Set#IsMember| (|Map#Domain| |m#0@1|) ($Box intType (int_2_U (LitInt 7))))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (|Set#IsMember| (|Map#Domain| |m#0@1|) ($Box intType (int_2_U (LitInt 6))))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@1|) ($Box intType (int_2_U (LitInt 6)))))) (LitInt 8))) (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@1|) ($Box intType (int_2_U (LitInt 6)))))) (LitInt 8)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (|Set#IsMember| (|Map#Values| |m#0@1|) ($Box intType (int_2_U (LitInt 8))))) (=> (|Set#IsMember| (|Map#Values| |m#0@1|) ($Box intType (int_2_U (LitInt 8)))) (=> (= (ControlFlow 0 4) (- 0 3)) (|Set#IsMember| (|Map#Items| |m#0@1|) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 6))) ($Box intType (int_2_U (LitInt 8))))))))))))))))))))
(let ((anon22_Else_correct  (=> (and (not (and (and (<= (LitInt 2) |y#0@0|) (< |y#0@0| 6)) (and (<= (LitInt 2) |y#prime#0@0|) (< |y#prime#0@0| 6)))) (= (ControlFlow 0 12) 4)) anon14_correct)))
(let ((anon22_Then_correct  (=> (and (and (<= (LitInt 2) |y#0@0|) (< |y#0@0| 6)) (and (<= (LitInt 2) |y#prime#0@0|) (< |y#prime#0@0| 6))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (or (not (= (_module.__default.Plus |y#0@0| (LitInt 1)) (_module.__default.Plus |y#prime#0@0| (LitInt 1)))) (not true)) (= (+ |y#0@0| 3) (+ |y#prime#0@0| 3)))) (=> (or (or (not (= (_module.__default.Plus |y#0@0| (LitInt 1)) (_module.__default.Plus |y#prime#0@0| (LitInt 1)))) (not true)) (= (+ |y#0@0| 3) (+ |y#prime#0@0| 3))) (=> (= (ControlFlow 0 10) 4) anon14_correct))))))
(let ((anon21_Else_correct  (=> (not (and (<= (LitInt 2) |y#0@0|) (< |y#0@0| 6))) (and (=> (= (ControlFlow 0 14) 10) anon22_Then_correct) (=> (= (ControlFlow 0 14) 12) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (and (<= (LitInt 2) |y#0@0|) (< |y#0@0| 6)) (and (=> (= (ControlFlow 0 13) 10) anon22_Then_correct) (=> (= (ControlFlow 0 13) 12) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (not (and (<= (LitInt 2) |y#0@0|) (< |y#0@0| 6))) (and (=> (= (ControlFlow 0 16) 13) anon21_Then_correct) (=> (= (ControlFlow 0 16) 14) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and (<= (LitInt 2) |y#0@0|) (< |y#0@0| 6)) (=> (and (and ($IsAlloc intType (int_2_U |y#0@0|) TInt $Heap) (= |##y#0@0| (LitInt 1))) (and ($IsAlloc intType (int_2_U |##y#0@0|) TInt $Heap) (|_module.__default.Plus#canCall| |y#0@0| (LitInt 1)))) (and (=> (= (ControlFlow 0 15) 13) anon21_Then_correct) (=> (= (ControlFlow 0 15) 14) anon21_Else_correct))))))
(let ((anon19_Else_correct  (=> (< |y#0@0| (LitInt 2)) (and (=> (= (ControlFlow 0 18) 15) anon20_Then_correct) (=> (= (ControlFlow 0 18) 16) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (<= (LitInt 2) |y#0@0|) (and (=> (= (ControlFlow 0 17) 15) anon20_Then_correct) (=> (= (ControlFlow 0 17) 16) anon20_Else_correct)))))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 19) 17) anon19_Then_correct) (=> (= (ControlFlow 0 19) 18) anon19_Else_correct))))
(let ((anon18_Else_correct true))
(let ((anon5_correct  (=> (= |m#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#15| TInt (LitInt 2) 6)) (|lambda#41| 1) (TMap TInt TInt))) (and (=> (= (ControlFlow 0 20) (- 0 26)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U (LitInt 5))))) (=> (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U (LitInt 5)))) (and (=> (= (ControlFlow 0 20) (- 0 25)) (not (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U (LitInt 6)))))) (=> (not (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U (LitInt 6))))) (and (=> (= (ControlFlow 0 20) (- 0 24)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U (LitInt 5))))) (and (=> (= (ControlFlow 0 20) (- 0 23)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U (LitInt 5)))))) (LitInt 6))) (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U (LitInt 5)))))) (LitInt 6)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (|Set#IsMember| (|Map#Values| |m#0@0|) ($Box intType (int_2_U (LitInt 6))))) (=> (|Set#IsMember| (|Map#Values| |m#0@0|) ($Box intType (int_2_U (LitInt 6)))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (|Set#IsMember| (|Map#Items| |m#0@0|) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 6)))))))) (=> (|Set#IsMember| (|Map#Items| |m#0@0|) ($Box DatatypeTypeType (Lit DatatypeTypeType (|#_System._tuple#2._#Make2| ($Box intType (int_2_U (LitInt 5))) ($Box intType (int_2_U (LitInt 6))))))) (and (=> (= (ControlFlow 0 20) 19) anon18_Then_correct) (=> (= (ControlFlow 0 20) 2) anon18_Else_correct))))))))))))))))
(let ((anon17_Else_correct  (=> (and (not (and (<= (LitInt 2) |x#0@0|) (< |x#0@0| 6))) (= (ControlFlow 0 28) 20)) anon5_correct)))
(let ((anon17_Then_correct  (=> (and (and (<= (LitInt 2) |x#0@0|) (< |x#0@0| 6)) (= (ControlFlow 0 27) 20)) anon5_correct)))
(let ((anon16_Else_correct  (=> (< |x#0@0| (LitInt 2)) (and (=> (= (ControlFlow 0 30) 27) anon17_Then_correct) (=> (= (ControlFlow 0 30) 28) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (<= (LitInt 2) |x#0@0|) (and (=> (= (ControlFlow 0 29) 27) anon17_Then_correct) (=> (= (ControlFlow 0 29) 28) anon17_Else_correct)))))
(let ((anon15_Then_correct  (and (=> (= (ControlFlow 0 31) 29) anon16_Then_correct) (=> (= (ControlFlow 0 31) 30) anon16_Else_correct))))
(let ((anon15_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 32) 31) anon15_Then_correct) (=> (= (ControlFlow 0 32) 1) anon15_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap TInt TInt)) ($IsAlloc MapType |m#0| (TMap TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 33) 32))) anon0_correct))))
