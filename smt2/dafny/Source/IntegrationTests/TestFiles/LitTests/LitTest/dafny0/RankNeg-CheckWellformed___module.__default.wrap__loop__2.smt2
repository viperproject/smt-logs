...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.wrap__loop__2)
...
(let ((anon8_Then_correct  (=> (and (and (|_module.wrap#Equal| |xs#0@@8| (|#_module.wrap.WS| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.wrap.X|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.wrap.X|)))))) (= |##xs#0@0| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.wrap.X|))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#_module.wrap.X|)))))) (and ($IsAlloc SeqType |##xs#0@0| (TSeq Tclass._module.wrap) $Heap) (= (ControlFlow 0 3) (- 0 2)))) (< (|Seq#Rank| |##xs#0@0|) (DtRank |xs#0@@8|)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($Is DatatypeTypeType |xs#0@@8| Tclass._module.wrap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
