...
(set-info :boogie-vc-id Impl$$_module.__default.FailureToProveTermination4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon11_Else_correct  (=> (and (and (< |n#0@0| 100) (< |x#0| |y#0|)) (and (= |$decr$loop#00@1| (- 100 |n#0@0|)) (= |n#0@1| (+ |n#0@0| 1)))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- 100 |n#0@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 100 |n#0@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- 100 |n#0@1|) |$decr$loop#00@1|)))))))
(let ((anon11_Then_correct true))
(let ((anon5_correct  (and (=> (= (ControlFlow 0 7) 3) anon11_Then_correct) (=> (= (ControlFlow 0 7) 5) anon11_Else_correct))))
(let ((anon10_Else_correct  (=> (and (<= 100 |n#0@0|) (= (ControlFlow 0 9) 7)) anon5_correct)))
(let ((anon10_Then_correct  (=> (and (< |n#0@0| 100) (= (ControlFlow 0 8) 7)) anon5_correct)))
