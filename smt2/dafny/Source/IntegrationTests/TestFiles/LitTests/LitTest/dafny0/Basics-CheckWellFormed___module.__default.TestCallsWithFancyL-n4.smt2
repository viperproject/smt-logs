...
(assert (distinct alloc allocName Tagclass._module.Multi Tagclass._module.Multi? class._module.Multi? tytagFamily$Multi field$next)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@1 T@U) ($o@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) Tclass._module.Multi?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) _module.Multi.next)) Tclass._module.Multi?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2922|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@1) _module.Multi.next)))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TestCallsWithFancyLhss)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#5| null $Heap alloc |m#0| ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) _module.Multi.next)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |m#0| null)) (not true))) (=> (or (not (= |m#0| null)) (not true)) (=> (and (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |m#0|) _module.Multi.next)) null)) (not true)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |m#0| null)) (not true))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |m#0| Tclass._module.Multi) ($IsAlloc refType |m#0| Tclass._module.Multi $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
