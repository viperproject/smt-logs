...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@102  (=> (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false)) (= $generated@@92 0)) (=> (and (and (= $generated@@93 0) (= $generated@@94 0)) (and (= $generated@@95 0) (= (ControlFlow 0 2) (- 0 1)))) (= $generated@@95 ($generated 0))))))
(let (($generated@@103  (=> (and (and (and ($generated@@96 $generated@@90) ($generated@@97 $generated@@90)) (= 0 $generated@@98)) (and (and (= 0 $generated@@99) (= 0 $generated@@100)) (and (= 0 $generated@@101) (= (ControlFlow 0 3) 2)))) $generated@@102)))
$generated@@103)))
))
(check-sat)
(get-info :rlimit)
