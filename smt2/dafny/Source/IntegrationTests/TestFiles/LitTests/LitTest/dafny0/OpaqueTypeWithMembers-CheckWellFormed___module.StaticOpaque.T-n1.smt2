...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@2 T@U) ) (!  (=> ($IsGoodHeap $h@@2) ($IsAlloc intType (int_2_U _module.StaticOpaque.y) TInt $h@@2))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |588|
 :pattern ( ($IsAlloc intType (int_2_U _module.StaticOpaque.y) TInt $h@@2))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.StaticOpaque.Two)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (_System.array.Length |a#0|) (LitInt 100)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|))) (=> (= (+ _module.StaticOpaque.y (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 3)))))) _module.StaticOpaque.y) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap)) (=> ($IsAlloc refType |a#0| (Tclass._System.array? TInt) $Heap) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length |a#0|)))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) previous$Heap)) (= 2 $FunctionContextHeight)) (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |a#0| (Tclass._System.array TInt) previous$Heap) (= (ControlFlow 0 9) 2)))) anon0_correct))))
