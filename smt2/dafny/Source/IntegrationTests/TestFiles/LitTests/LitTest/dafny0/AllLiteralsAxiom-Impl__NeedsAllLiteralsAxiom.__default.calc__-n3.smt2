...
(set-info :boogie-vc-id Impl$$NeedsAllLiteralsAxiom.__default.calc__trick)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (NeedsAllLiteralsAxiom.__default.trick ($LS ($LS $LZ)) (LitInt 100) (LitInt 10))) (LitInt 100)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |n#0@@4|) (<= (LitInt 0) |m#0@@4|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
