...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let (($generated@@92 true))
(let (($generated@@93  (=> (and (not $generated@@80) (= (ControlFlow 0 3) 1)) $generated@@92)))
(let (($generated@@94  (=> (and $generated@@80 (= (ControlFlow 0 2) 1)) $generated@@92)))
(let (($generated@@95  (=> (= $generated@@81  (and $generated@@82 (< 0 $generated@@83))) (and (=> (= (ControlFlow 0 4) 2) $generated@@94) (=> (= (ControlFlow 0 4) 3) $generated@@93)))))
(let (($generated@@96  (=> (and (not $generated@@82) (= (ControlFlow 0 6) 4)) $generated@@95)))
(let (($generated@@97  (=> (and $generated@@82 (= (ControlFlow 0 5) 4)) $generated@@95)))
(let (($generated@@98  (and (=> (= (ControlFlow 0 7) (- 0 10)) $generated@@82) (and (=> (= (ControlFlow 0 7) (- 0 9)) $generated@@80) (and (=> (= (ControlFlow 0 7) (- 0 8)) $generated@@84) (=> (and (and $generated@@82 $generated@@80) $generated@@84) (and (=> (= (ControlFlow 0 7) 5) $generated@@97) (=> (= (ControlFlow 0 7) 6) $generated@@96))))))))
(let (($generated@@99  (=> (and (not (and $generated@@82 $generated@@80)) (= (ControlFlow 0 12) 7)) $generated@@98)))
(let (($generated@@100  (=> (and (and $generated@@82 $generated@@80) (= (ControlFlow 0 11) 7)) $generated@@98)))
(let (($generated@@101  (=> (not $generated@@82) (and (=> (= (ControlFlow 0 14) 11) $generated@@100) (=> (= (ControlFlow 0 14) 12) $generated@@99)))))
(let (($generated@@102  (=> $generated@@82 (and (=> (= (ControlFlow 0 13) 11) $generated@@100) (=> (= (ControlFlow 0 13) 12) $generated@@99)))))
(let (($generated@@103  (=> (and (and (= $generated@@85 ($generated@@24 $generated@@86 $generated@@87 $generated@@88 false)) $generated@@82) (and $generated@@80 $generated@@84)) (and (=> (= (ControlFlow 0 15) 13) $generated@@102) (=> (= (ControlFlow 0 15) 14) $generated@@101)))))
(let (($generated@@104  (=> (and (and ($generated@@89 $generated@@87) ($generated@@90 $generated@@87)) (and (= 0 $generated@@91) (= (ControlFlow 0 16) 15))) $generated@@103)))
$generated@@104))))))))))))))
))
(check-sat)
(get-info :rlimit)
