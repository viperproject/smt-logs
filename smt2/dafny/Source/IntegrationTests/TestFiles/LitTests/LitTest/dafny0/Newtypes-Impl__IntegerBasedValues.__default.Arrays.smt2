...
(assert (distinct TInt TagInt TagSet alloc Tagclass._System.nat Tagclass._System.object? Tagclass._System.object Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 Tagclass._System.array2? Tagclass._System.array2 Tagclass._System.___hFunc2 tytagFamily$nat tytagFamily$object tytagFamily$array |tytagFamily$_#Func1| tytagFamily$array2 |tytagFamily$_#Func2|)
)
(assert (= (FDim alloc) 0))
...
(assert (forall ((|l#0@@0| T@U) (|l#1| T@U) (|$l#2#heap#0| T@U) (|$l#2#_v4#0| T@U) (|$l#2#_v5#0| T@U) ) (! (= (U_2_bool (MapType2Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#14| |l#0@@0| |l#1|) |$l#2#heap#0| |$l#2#_v4#0| |$l#2#_v5#0|))  (and ($IsBox |$l#2#_v4#0| |l#0@@0|) ($IsBox |$l#2#_v5#0| |l#1|)))
 :qid |unknown.0:0|
 :skolemid |6332|
 :pattern ( (MapType2Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType boolType (|lambda#14| |l#0@@0| |l#1|) |$l#2#heap#0| |$l#2#_v4#0| |$l#2#_v5#0|))
)))
...
(assert (forall ((|l#0@@1| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#5| |l#0@@1|) |$l#0#o#0|)) |l#0@@1|)
 :qid |unknown.0:0|
 :skolemid |6328|
 :pattern ( (MapType1Select refType boolType (|lambda#5| |l#0@@1|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@2| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#7| |l#0@@2|) |$l#0#ly#0|) |l#0@@2|)
 :qid |Newtypesdfy.182:23|
 :skolemid |6330|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#7| |l#0@@2|) |$l#0#ly#0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#2#heap#0@@0| T@U) (|$l#2#_v4#0@@0| T@U) (|$l#2#_v5#0@@0| T@U) ) (! (= (MapType2Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#13| |l#0@@3|) |$l#2#heap#0@@0| |$l#2#_v4#0@@0| |$l#2#_v5#0@@0|) |l#0@@3|)
 :qid |Newtypesdfy.179:60|
 :skolemid |6331|
 :pattern ( (MapType2Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType BoxType (|lambda#13| |l#0@@3|) |$l#2#heap#0@@0| |$l#2#_v4#0@@0| |$l#2#_v5#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#2#heap#0@@1| T@U) (|$l#2#_v4#0@@1| T@U) (|$l#2#_v5#0@@1| T@U) ) (! (= (MapType2Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#16| |l#0@@4|) |$l#2#heap#0@@1| |$l#2#_v4#0@@1| |$l#2#_v5#0@@1|) |l#0@@4|)
 :qid |Newtypesdfy.184:26|
 :skolemid |6333|
 :pattern ( (MapType2Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType SetType (|lambda#16| |l#0@@4|) |$l#2#heap#0@@1| |$l#2#_v4#0@@1| |$l#2#_v5#0@@1|))
)))
...
(assert (forall ((|l#0@@5| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@15 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@5| |l#1@@0| |l#2| |l#3|) $o@@15 $f))  (=> (and (or (not (= $o@@15 |l#0@@5|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@15) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |6325|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@5| |l#1@@0| |l#2| |l#3|) $o@@15 $f))
)))
...
(assert (forall ((h@@15 T@U) (r@@6 T@U) (f@@23 T@U) (x@@7 T@U) ) (!  (=> ($IsGoodHeap (MapType1Store refType (MapType1Type FieldType BoxType) h@@15 r@@6 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h@@15 r@@6) f@@23 x@@7))) ($HeapSucc h@@15 (MapType1Store refType (MapType1Type FieldType BoxType) h@@15 r@@6 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h@@15 r@@6) f@@23 x@@7))))
 :qid |DafnyPreludebpl.603:15|
 :skolemid |3494|
 :pattern ( (MapType1Store refType (MapType1Type FieldType BoxType) h@@15 r@@6 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) h@@15 r@@6) f@@23 x@@7)))
)))
...
(assert (forall ((|l#0@@6| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#_v2#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#3| |l#0@@6|) |$l#0#heap#0@@0| |$l#0#_v2#0@@0|) |l#0@@6|)
 :qid |Newtypesdfy.179:60|
 :skolemid |6326|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#3| |l#0@@6|) |$l#0#heap#0@@0| |$l#0#_v2#0@@0|))
)))
(assert (forall ((|l#0@@7| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#_v2#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#6| |l#0@@7|) |$l#0#heap#0@@1| |$l#0#_v2#0@@1|) |l#0@@7|)
 :qid |Newtypesdfy.182:23|
 :skolemid |6329|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#6| |l#0@@7|) |$l#0#heap#0@@1| |$l#0#_v2#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$IntegerBasedValues.__default.Arrays)
...
(let ((anon36_Else_correct  (=> (and (< |_v2#0@0| (LitInt 0)) (= (ControlFlow 0 84) 82)) anon3_correct)))
(let ((anon36_Then_correct  (=> (<= (LitInt 0) |_v2#0@0|) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| |t#0|)) (and ($IsBox |lambdaResult#0| Tclass.IntegerBasedValues.T) (= (ControlFlow 0 83) 82))) anon3_correct))))
(let ((anon35_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 85) 83) anon36_Then_correct) (=> (= (ControlFlow 0 85) 84) anon36_Else_correct)))))
(let ((anon7_correct true))
(let ((anon38_Else_correct  (=> (and (< |_v3#0@0| (LitInt 0)) (= (ControlFlow 0 77) 75)) anon7_correct)))
(let ((anon38_Then_correct  (=> (<= (LitInt 0) |_v3#0@0|) (=> (and (and (= |$_Frame#l1@0| (|lambda#0| null |$lambdaHeap#1@0| alloc false)) (= |lambdaResult#1| |t#0|)) (and ($IsBox |lambdaResult#1| Tclass.IntegerBasedValues.T) (= (ControlFlow 0 76) 75))) anon7_correct))))
(let ((anon37_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#1@0|) (or (= $Heap@0 |$lambdaHeap#1@0|) ($HeapSucc $Heap@0 |$lambdaHeap#1@0|))) (and (=> (= (ControlFlow 0 78) 76) anon38_Then_correct) (=> (= (ControlFlow 0 78) 77) anon38_Else_correct)))))
(let ((anon11_correct true))
(let ((anon40_Else_correct  (=> (and (< |_v4#0@0| (LitInt 0)) (= (ControlFlow 0 69) 67)) anon11_correct)))
(let ((anon40_Then_correct  (=> (<= (LitInt 0) |_v4#0@0|) (=> (and (and (= |$_Frame#l2@0| (|lambda#0| null |$lambdaHeap#2@0| alloc false)) (= |lambdaResult#2| |t#0|)) (and ($IsBox |lambdaResult#2| Tclass.IntegerBasedValues.T) (= (ControlFlow 0 68) 67))) anon11_correct))))
(let ((anon39_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#2@0|) (or (= $Heap@1 |$lambdaHeap#2@0|) ($HeapSucc $Heap@1 |$lambdaHeap#2@0|))) (and (=> (= (ControlFlow 0 70) 68) anon40_Then_correct) (=> (= (ControlFlow 0 70) 69) anon40_Else_correct)))))
(let ((anon34_correct  (=> (= (ControlFlow 0 4) (- 0 3)) true)))
(let ((anon19_correct  (=> (and (< |k#0| (_System.array2.Length0 $nw@2)) (< |j#0| (_System.array2.Length1 $nw@2))) (and (=> (= (ControlFlow 0 56) (- 0 59)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 56) (- 0 58)) (and (<= 0 |k#0|) (< |k#0| (_System.array2.Length0 $nw@2)))) (=> (and (<= 0 |k#0|) (< |k#0| (_System.array2.Length0 $nw@2))) (and (=> (= (ControlFlow 0 56) (- 0 57)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 $nw@2)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 $nw@2))) (=> (and (= |x#0@8| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@2) (MultiIndexField (IndexField |k#0|) |j#0|))) (= (ControlFlow 0 56) 4)) anon34_correct))))))))))
(let ((anon46_Else_correct  (=> (and (<= (_System.array2.Length0 $nw@2) |k#0|) (= (ControlFlow 0 62) 56)) anon19_correct)))
(let ((anon46_Then_correct  (=> (< |k#0| (_System.array2.Length0 $nw@2)) (and (=> (= (ControlFlow 0 60) (- 0 61)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (=> (= (ControlFlow 0 60) 56) anon19_correct))))))
(let ((anon45_Then_correct  (and (=> (= (ControlFlow 0 63) (- 0 64)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 63) 60) anon46_Then_correct) (=> (= (ControlFlow 0 63) 62) anon46_Else_correct))))))
(let ((anon22_correct  (=> (and (< |i#0| (_System.array2.Length0 $nw@2)) (< |k#0| (_System.array2.Length1 $nw@2))) (and (=> (= (ControlFlow 0 47) (- 0 50)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 47) (- 0 49)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 $nw@2)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 $nw@2))) (and (=> (= (ControlFlow 0 47) (- 0 48)) (and (<= 0 |k#0|) (< |k#0| (_System.array2.Length1 $nw@2)))) (=> (and (<= 0 |k#0|) (< |k#0| (_System.array2.Length1 $nw@2))) (=> (and (= |x#0@7| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@2) (MultiIndexField (IndexField |i#0|) |k#0|))) (= (ControlFlow 0 47) 4)) anon34_correct))))))))))
(let ((anon48_Else_correct  (=> (and (<= (_System.array2.Length0 $nw@2) |i#0|) (= (ControlFlow 0 53) 47)) anon22_correct)))
(let ((anon48_Then_correct  (=> (< |i#0| (_System.array2.Length0 $nw@2)) (and (=> (= (ControlFlow 0 51) (- 0 52)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (=> (= (ControlFlow 0 51) 47) anon22_correct))))))
(let ((anon47_Then_correct  (and (=> (= (ControlFlow 0 54) (- 0 55)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 54) 51) anon48_Then_correct) (=> (= (ControlFlow 0 54) 53) anon48_Else_correct))))))
(let ((anon25_correct  (=> (and (< |i#0| (_System.array2.Length0 $nw@2)) (< |j#0| (_System.array2.Length1 $nw@2))) (and (=> (= (ControlFlow 0 38) (- 0 41)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 38) (- 0 40)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 $nw@2)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 $nw@2))) (and (=> (= (ControlFlow 0 38) (- 0 39)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 $nw@2)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 $nw@2))) (=> (and (= |x#0@6| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@2) (MultiIndexField (IndexField |i#0|) |j#0|))) (= (ControlFlow 0 38) 4)) anon34_correct))))))))))
(let ((anon50_Else_correct  (=> (and (<= (_System.array2.Length0 $nw@2) |i#0|) (= (ControlFlow 0 44) 38)) anon25_correct)))
(let ((anon50_Then_correct  (=> (< |i#0| (_System.array2.Length0 $nw@2)) (and (=> (= (ControlFlow 0 42) (- 0 43)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (=> (= (ControlFlow 0 42) 38) anon25_correct))))))
(let ((anon49_Then_correct  (and (=> (= (ControlFlow 0 45) (- 0 46)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 45) 42) anon50_Then_correct) (=> (= (ControlFlow 0 45) 44) anon50_Else_correct))))))
(let ((anon28_correct  (=> (and (< |i#0| (_System.array2.Length0 $nw@2)) (< |j#0| (_System.array2.Length1 $nw@2))) (and (=> (= (ControlFlow 0 29) (- 0 32)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 29) (- 0 31)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length0 $nw@2)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length0 $nw@2))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 $nw@2)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 $nw@2))) (=> (and (= |x#0@5| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@2) (MultiIndexField (IndexField |j#0|) |j#0|))) (= (ControlFlow 0 29) 4)) anon34_correct))))))))))
(let ((anon52_Else_correct  (=> (and (<= (_System.array2.Length0 $nw@2) |i#0|) (= (ControlFlow 0 35) 29)) anon28_correct)))
(let ((anon52_Then_correct  (=> (< |i#0| (_System.array2.Length0 $nw@2)) (and (=> (= (ControlFlow 0 33) (- 0 34)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (=> (= (ControlFlow 0 33) 29) anon28_correct))))))
(let ((anon51_Then_correct  (and (=> (= (ControlFlow 0 36) (- 0 37)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 36) 33) anon52_Then_correct) (=> (= (ControlFlow 0 36) 35) anon52_Else_correct))))))
(let ((anon31_correct  (=> (and (< |i#0| (_System.array2.Length0 $nw@2)) (< |j#0| (_System.array2.Length1 $nw@2))) (and (=> (= (ControlFlow 0 20) (- 0 23)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 20) (- 0 22)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 $nw@2)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 $nw@2))) (and (=> (= (ControlFlow 0 20) (- 0 21)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length1 $nw@2)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length1 $nw@2))) (=> (and (= |x#0@4| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@2) (MultiIndexField (IndexField |i#0|) |i#0|))) (= (ControlFlow 0 20) 4)) anon34_correct))))))))))
(let ((anon54_Else_correct  (=> (and (<= (_System.array2.Length0 $nw@2) |i#0|) (= (ControlFlow 0 26) 20)) anon31_correct)))
(let ((anon54_Then_correct  (=> (< |i#0| (_System.array2.Length0 $nw@2)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (=> (= (ControlFlow 0 24) 20) anon31_correct))))))
(let ((anon53_Then_correct  (and (=> (= (ControlFlow 0 27) (- 0 28)) (or (not (= $nw@2 null)) (not true))) (=> (or (not (= $nw@2 null)) (not true)) (and (=> (= (ControlFlow 0 27) 24) anon54_Then_correct) (=> (= (ControlFlow 0 27) 26) anon54_Else_correct))))))
(let ((anon55_Then_correct  (=> (= (ControlFlow 0 19) 4) anon34_correct)))
(let ((anon44_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 18)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (=> (< |i#0| (_System.array.Length $nw@1)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (and (<= 0 |i#0|) (< |i#0| (_System.array.Length $nw@1)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array.Length $nw@1))) (=> (and (= |x#0@3| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@1) (IndexField |i#0|))) (= (ControlFlow 0 15) 4)) anon34_correct))))))))))
(let ((anon43_Then_correct  (=> (< |i#0| |o#0|) (and (=> (= (ControlFlow 0 12) (- 0 14)) (or (not (= $nw@1 null)) (not true))) (=> (or (not (= $nw@1 null)) (not true)) (and (=> (= (ControlFlow 0 12) (- 0 13)) (and (<= 0 |i#0|) (< |i#0| (_System.array.Length $nw@1)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array.Length $nw@1))) (=> (and (= |x#0@2| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@1) (IndexField |i#0|))) (= (ControlFlow 0 12) 4)) anon34_correct))))))))
(let ((anon42_Then_correct  (and (=> (= (ControlFlow 0 8) (- 0 11)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (< |i#0| (_System.array.Length $nw@0)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (and (<= 0 |i#0|) (< |i#0| (_System.array.Length $nw@0)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array.Length $nw@0))) (=> (and (= |x#0@1| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#0|))) (= (ControlFlow 0 8) 4)) anon34_correct))))))))))
(let ((anon41_Then_correct  (=> (< |i#0| |n#0|) (and (=> (= (ControlFlow 0 5) (- 0 7)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 |i#0|) (< |i#0| (_System.array.Length $nw@0)))) (=> (and (<= 0 |i#0|) (< |i#0| (_System.array.Length $nw@0))) (=> (and (= |x#0@0| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 $nw@0) (IndexField |i#0|))) (= (ControlFlow 0 5) 4)) anon34_correct))))))))
(let ((anon55_Else_correct  (=> (and (and (and (and (and (and (and (and (and (and (<= |n#0| |i#0|) (<= (_System.array.Length $nw@0) |i#0|)) (<= |o#0| |i#0|)) (<= (_System.array.Length $nw@1) |i#0|)) (not (and (< |k#0| (_System.array2.Length0 $nw@2)) (< |j#0| (_System.array2.Length1 $nw@2))))) (not (and (< |i#0| (_System.array2.Length0 $nw@2)) (< |k#0| (_System.array2.Length1 $nw@2))))) (not (and (< |i#0| (_System.array2.Length0 $nw@2)) (< |j#0| (_System.array2.Length1 $nw@2))))) (not (and (< |i#0| (_System.array2.Length0 $nw@2)) (< |j#0| (_System.array2.Length1 $nw@2))))) (not (and (< |i#0| (_System.array2.Length0 $nw@2)) (< |j#0| (_System.array2.Length1 $nw@2))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon39_Else_correct  (=> (and (and (and (or (not (= $nw@2 null)) (not true)) ($Is refType $nw@2 (Tclass._System.array2? Tclass.IntegerBasedValues.T))) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@2) alloc))))) (and (= (_System.array2.Length0 $nw@2) |o#0|) (= (_System.array2.Length1 $nw@2) |n#0|))) (and (=> (= (ControlFlow 0 65) (- 0 66)) (forall ((|arrayinit#2#i0#0| Int) (|arrayinit#2#i1#0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#2#i0#0|) (< |arrayinit#2#i0#0| |o#0|)) (and (<= 0 |arrayinit#2#i1#0|) (< |arrayinit#2#i1#0| |n#0|))) (Requires2 Tclass._System.nat TInt Tclass.IntegerBasedValues.T $Heap@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle2 (|lambda#13| |t#0|) (|lambda#14| Tclass._System.nat TInt) (|lambda#16| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#2#i0#0|)) ($Box intType (int_2_U |arrayinit#2#i1#0|))))
 :qid |Newtypesdfy.184:14|
 :skolemid |3933|
))) (=> (and (and (forall ((|arrayinit#2#i0#0@@0| Int) (|arrayinit#2#i1#0@@0| Int) ) (!  (=> (and (and (<= 0 |arrayinit#2#i0#0@@0|) (< |arrayinit#2#i0#0@@0| |o#0|)) (and (<= 0 |arrayinit#2#i1#0@@0|) (< |arrayinit#2#i1#0@@0| |n#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@2) (MultiIndexField (IndexField |arrayinit#2#i0#0@@0|) |arrayinit#2#i1#0@@0|)) (Apply2 Tclass._System.nat TInt Tclass.IntegerBasedValues.T $Heap@1 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle2 (|lambda#13| |t#0|) (|lambda#14| Tclass._System.nat TInt) (|lambda#16| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#2#i0#0@@0|)) ($Box intType (int_2_U |arrayinit#2#i1#0@@0|)))))
 :qid |Newtypesdfy.184:14|
 :skolemid |3934|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@2) (MultiIndexField (IndexField |arrayinit#2#i0#0@@0|) |arrayinit#2#i1#0@@0|)))
)) (= $Heap@2 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@1 $nw@2 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@2) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2))) (and (and (and (and (and (and (and (and (and (and (=> (= (ControlFlow 0 65) 5) anon41_Then_correct) (=> (= (ControlFlow 0 65) 8) anon42_Then_correct)) (=> (= (ControlFlow 0 65) 12) anon43_Then_correct)) (=> (= (ControlFlow 0 65) 15) anon44_Then_correct)) (=> (= (ControlFlow 0 65) 63) anon45_Then_correct)) (=> (= (ControlFlow 0 65) 54) anon47_Then_correct)) (=> (= (ControlFlow 0 65) 45) anon49_Then_correct)) (=> (= (ControlFlow 0 65) 36) anon51_Then_correct)) (=> (= (ControlFlow 0 65) 27) anon53_Then_correct)) (=> (= (ControlFlow 0 65) 19) anon55_Then_correct)) (=> (= (ControlFlow 0 65) 2) anon55_Else_correct)))))))
(let ((anon37_Else_correct  (=> (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? Tclass.IntegerBasedValues.T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) alloc)))) (= (_System.array.Length $nw@1) |o#0|))) (and (=> (= (ControlFlow 0 71) (- 0 74)) (forall ((|arrayinit#1#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0|) (< |arrayinit#1#i0#0| |o#0|)) (Requires1 Tclass._System.nat Tclass.IntegerBasedValues.T $Heap@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| |t#0|) (|lambda#4| Tclass._System.nat) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#1#i0#0|))))
 :qid |Newtypesdfy.183:14|
 :skolemid |3931|
))) (=> (and (and (forall ((|arrayinit#1#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0@@0|) (< |arrayinit#1#i0#0@@0| |o#0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) (IndexField |arrayinit#1#i0#0@@0|)) (Apply1 Tclass._System.nat Tclass.IntegerBasedValues.T $Heap@0 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| |t#0|) (|lambda#4| Tclass._System.nat) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#1#i0#0@@0|)))))
 :qid |Newtypesdfy.183:14|
 :skolemid |3932|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) (IndexField |arrayinit#1#i0#0@@0|)))
)) (= $Heap@1 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $nw@1) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1))) (and (=> (= (ControlFlow 0 71) (- 0 73)) (<= 0 |o#0|)) (=> (<= 0 |o#0|) (and (=> (= (ControlFlow 0 71) (- 0 72)) (<= 0 |n#0|)) (=> (<= 0 |n#0|) (and (=> (= (ControlFlow 0 71) 70) anon39_Then_correct) (=> (= (ControlFlow 0 71) 65) anon39_Else_correct)))))))))))
(let ((anon35_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass.IntegerBasedValues.T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) |n#0|))) (and (=> (= (ControlFlow 0 79) (- 0 81)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| |n#0|)) (Requires1 Tclass._System.nat Tclass.IntegerBasedValues.T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| |t#0|) (|lambda#4| Tclass._System.nat) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Newtypesdfy.182:14|
 :skolemid |3929|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| |n#0|)) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 Tclass._System.nat Tclass.IntegerBasedValues.T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#7| (Handle1 (|lambda#3| |t#0|) (|lambda#4| Tclass._System.nat) (|lambda#6| (SetRef_to_SetBox (|lambda#5| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |Newtypesdfy.182:14|
 :skolemid |3930|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 79) (- 0 80)) (<= 0 |o#0|)) (=> (<= 0 |o#0|) (and (=> (= (ControlFlow 0 79) 78) anon37_Then_correct) (=> (= (ControlFlow 0 79) 71) anon37_Else_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 86) (- 0 87)) (<= 0 |n#0|)) (=> (<= 0 |n#0|) (and (=> (= (ControlFlow 0 86) 85) anon35_Then_correct) (=> (= (ControlFlow 0 86) 79) anon35_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (=> (and (and (and (and (and (= (Mod |o#0| (LitInt 2)) (LitInt 0)) (= (Mod |i#0| (LitInt 2)) (LitInt 0))) (and (= (Mod |j#0| (LitInt 2)) (LitInt 0)) (<= (LitInt 0) |k#0|))) (and (and ($IsBox |t#0| Tclass.IntegerBasedValues.T) ($IsAllocBox |t#0| Tclass.IntegerBasedValues.T $Heap)) (=> |defass#x#0| (and ($IsBox |x#0@@1| Tclass.IntegerBasedValues.T) ($IsAllocBox |x#0@@1| Tclass.IntegerBasedValues.T $Heap))))) (and (and (and ($Is refType |a#0| (Tclass._System.array Tclass.IntegerBasedValues.T)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass.IntegerBasedValues.T) $Heap)) true) (and (and ($Is refType |b#0| (Tclass._System.array Tclass.IntegerBasedValues.T)) ($IsAlloc refType |b#0| (Tclass._System.array Tclass.IntegerBasedValues.T) $Heap)) true))) (and (and (and (and ($Is refType |m#0| (Tclass._System.array2 Tclass.IntegerBasedValues.T)) ($IsAlloc refType |m#0| (Tclass._System.array2 Tclass.IntegerBasedValues.T) $Heap)) true) (= 1 $FunctionContextHeight)) (and (and (<= (LitInt 0) |o#0|) (<= (LitInt 0) |i#0|)) (and (<= (LitInt 0) |j#0|) (= (ControlFlow 0 88) 86))))) anon0_correct))))
