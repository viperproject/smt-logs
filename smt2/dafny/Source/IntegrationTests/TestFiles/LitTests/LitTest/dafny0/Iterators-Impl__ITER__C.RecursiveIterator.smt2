...
(assert (forall (($h@@6 T@U) ($o@@9 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@9 null)) (not true)) (= (dtype $o@@9) Tclass.ITER__C.RecursiveIterator?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) ITER__C.RecursiveIterator.__new)) (TSet Tclass._System.object?)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1543|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@9) ITER__C.RecursiveIterator.__new)))
)))
(assert (forall (($h@@7 T@U) ($o@@10 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass.ITER__C.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@10) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@10) ITER__C.RecursiveIterator.__new)) (TSet Tclass._System.object?) $h@@7))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1544|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@10) ITER__C.RecursiveIterator.__new)))
)))
...
(assert (forall (($h@@8 T@U) ($o@@12 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@12 null)) (not true)) (= (dtype $o@@12) Tclass.ITER__C.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@12) alloc)))) ($IsAlloc boolType (bool_2_U (ITER__C.RecursiveIterator.good $o@@12)) TBool $h@@8))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1538|
 :pattern ( (ITER__C.RecursiveIterator.good $o@@12) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@12) alloc)))
)))
(assert (forall (($h@@9 T@U) ($o@@13 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@13 null)) (not true)) (= (dtype $o@@13) Tclass.ITER__C.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@13) alloc)))) ($IsAlloc intType (int_2_U (ITER__C.RecursiveIterator.__decreases0 $o@@13)) TInt $h@@9))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1546|
 :pattern ( (ITER__C.RecursiveIterator.__decreases0 $o@@13) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@13) alloc)))
)))
(assert (forall (($h@@10 T@U) ($o@@14 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@10) (and (or (not (= $o@@14 null)) (not true)) (= (dtype $o@@14) Tclass.ITER__C.RecursiveIterator?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@14) alloc)))) ($IsAlloc boolType (bool_2_U (ITER__C.RecursiveIterator.__decreases2 $o@@14)) TBool $h@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1550|
 :pattern ( (ITER__C.RecursiveIterator.__decreases2 $o@@14) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@10 $o@@14) alloc)))
)))
...
(set-info :boogie-vc-id Impl$$ITER__C.RecursiveIterator)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_Else_correct  (=> (not (ITER__C.RecursiveIterator.good this@@0)) (and (=> (= (ControlFlow 0 8) (- 0 11)) (or (not (= (ITER__C.RecursiveIterator.r this@@0) null)) (not true))) (=> (or (not (= (ITER__C.RecursiveIterator.r this@@0) null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 10)) ($Is intType (int_2_U (+ (ITER__C.RecursiveIterator.n this@@0) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (ITER__C.RecursiveIterator.n this@@0) 1)) Tclass._System.nat) (=> (= |n##1@0| (+ (ITER__C.RecursiveIterator.n this@@0) 1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (<= 0 |n#0|) (= |n##1@0| |n#0|))) (=> (or (<= 0 |n#0|) (= |n##1@0| |n#0|)) (=> (= (ControlFlow 0 8) (- 0 7)) (< |n##1@0| |n#0|))))))))))))
(let ((anon6_Then_correct  (=> (ITER__C.RecursiveIterator.good this@@0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= (ITER__C.RecursiveIterator.r this@@0) null)) (not true))) (=> (or (not (= (ITER__C.RecursiveIterator.r this@@0) null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($Is intType (int_2_U (- (ITER__C.RecursiveIterator.n this@@0) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- (ITER__C.RecursiveIterator.n this@@0) 1)) Tclass._System.nat) (=> (= |n##0@0| (- (ITER__C.RecursiveIterator.n this@@0) 1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 |n#0|) (= |n##0@0| |n#0|))) (=> (or (<= 0 |n#0|) (= |n##0@0| |n#0|)) (=> (= (ControlFlow 0 3) (- 0 2)) (< |n##0@0| |n#0|))))))))))))
(let ((anon5_Else_correct  (=> (or (not (= (ITER__C.RecursiveIterator.n this@@0) (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 12) 3) anon6_Then_correct) (=> (= (ControlFlow 0 12) 8) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc this@@0)) (=> (and (or (not (= |r#0| null)) (not true)) (= (ITER__C.RecursiveIterator.n this@@0) |n#0|)) (=> (and (and (and (and (= (ITER__C.RecursiveIterator.r this@@0) |r#0|) (= (ITER__C.RecursiveIterator.good this@@0) |good#0|)) (and (ITER__C.RecursiveIterator.Valid $Heap this@@0) (|Set#Equal| (ITER__C.RecursiveIterator.__reads this@@0) |Set#Empty|))) (and (and (|Set#Equal| (ITER__C.RecursiveIterator.__modifies this@@0) |Set#Empty|) (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) ITER__C.RecursiveIterator.__new)) |Set#Empty|)) (and (= (ITER__C.RecursiveIterator.__decreases0 this@@0) |n#0|) (= (ITER__C.RecursiveIterator.__decreases1 this@@0) |r#0|)))) (and (and (and (= (ITER__C.RecursiveIterator.__decreases2 this@@0) |good#0|) (= |_yieldCount#0| 0)) (and (= call1formal@rds@0 (ITER__C.RecursiveIterator.__reads this@@0)) (= call2formal@nw@0 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) ITER__C.RecursiveIterator.__new))))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@25 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@25 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@25) alloc)))) (=> (or (or (= $o@@25 this@@0) (|Set#IsMember| call1formal@rds@0 ($Box refType $o@@25))) (|Set#IsMember| call2formal@nw@0 ($Box refType $o@@25))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@25) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@25) $f@@1))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.ITER__C.RecursiveIterator) ($IsAlloc refType this@@0 Tclass.ITER__C.RecursiveIterator $Heap))) (<= (LitInt 0) |n#0|)) (and (and ($Is refType |r#0| Tclass.ITER__C.RecIterCaller?) ($IsAlloc refType |r#0| Tclass.ITER__C.RecIterCaller? $Heap)) (and true true))) (=> (and (and (and (and ($IsGoodHeap $_OldIterHeap) ($HeapSucc $_OldIterHeap $Heap)) true) (= 0 $FunctionContextHeight)) (and (or (not (= |r#0| null)) (not true)) (= (ControlFlow 0 14) 13))) anon0_correct)))))
