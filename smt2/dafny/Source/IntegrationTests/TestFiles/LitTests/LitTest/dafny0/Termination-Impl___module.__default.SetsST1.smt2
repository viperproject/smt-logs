...
(declare-fun _module._default.SetsST1$Y () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.SetsST1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 24) (let ((anon19_Else_correct  (=> (not (|Set#Equal| |s#0@1| |Set#Empty|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 7) (- 0 6)) (< (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|)))))))
(let ((anon19_Then_correct true))
(let ((anon10_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.SetsST1$Y) (and (|Set#IsMember| |s#0@0| |$as#x0_0#0_0|) (or (or (not (= |$as#x0_0#0_0| |y#0|)) (not true)) (|Set#Equal| |s#0@0| |t#0@0|))))
 :qid |Terminationdfy.653:9|
 :skolemid |3158|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.SetsST1$Y) (and (|Set#IsMember| |s#0@0| |$as#x0_0#0_0@@0|) (or (or (not (= |$as#x0_0#0_0@@0| |y#0|)) (not true)) (|Set#Equal| |s#0@0| |t#0@0|))))
 :qid |Terminationdfy.653:9|
 :skolemid |3158|
)) (=> (=> true (and ($IsBox |x#0_0@1| _module._default.SetsST1$Y) ($IsAllocBox |x#0_0@1| _module._default.SetsST1$Y $Heap))) (=> (and (|Set#IsMember| |s#0@0| |x#0_0@1|) (or (or (not (= |x#0_0@1| |y#0|)) (not true)) (|Set#Equal| |s#0@0| |t#0@0|))) (and (=> (= (ControlFlow 0 9) (- 0 10)) true) (=> (= |s#0@1| (|Set#Difference| |s#0@0| (|Set#UnionOne| |Set#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 9) 5) anon19_Then_correct) (=> (= (ControlFlow 0 9) 7) anon19_Else_correct))))))))))
(let ((anon9_correct  (=> (= (ControlFlow 0 13) 9) anon10_correct)))
(let ((anon18_Else_correct  (=> (and (or (not (= |x#0_1@1| |y#0|)) (not true)) (= (ControlFlow 0 16) 13)) anon9_correct)))
(let ((anon18_Then_correct  (=> (and (= |x#0_1@1| |y#0|) (= (ControlFlow 0 15) 13)) anon9_correct)))
(let ((anon17_Then_correct  (=> (|Set#IsMember| |s#0@0| |x#0_1@1|) (and (=> (= (ControlFlow 0 17) 15) anon18_Then_correct) (=> (= (ControlFlow 0 17) 16) anon18_Else_correct)))))
(let ((anon17_Else_correct  (=> (and (not (|Set#IsMember| |s#0@0| |x#0_1@1|)) (= (ControlFlow 0 14) 13)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and ($IsBox |x#0_1@1| _module._default.SetsST1$Y) ($IsAllocBox |x#0_1@1| _module._default.SetsST1$Y $Heap)) (and (=> (= (ControlFlow 0 18) 17) anon17_Then_correct) (=> (= (ControlFlow 0 18) 14) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.SetsST1$Y) ($IsAllocBox |x#0_1@1| _module._default.SetsST1$Y $Heap))) (= (ControlFlow 0 12) 9)) anon10_correct)))
(let ((anon15_Else_correct  (=> (and (|Set#Subset| |t#0@0| |s#0@0|) (= |$decr$loop#00@1| (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|)))) (and (=> (= (ControlFlow 0 19) 18) anon16_Then_correct) (=> (= (ControlFlow 0 19) 12) anon16_Else_correct)))))
(let ((anon15_Then_correct true))
(let ((anon14_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 20) 4) anon15_Then_correct) (=> (= (ControlFlow 0 20) 19) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (not |$w$loop#0@0|) (=> (and (= |newtype$check#0@0| (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|))) (= (ControlFlow 0 3) (- 0 2))) (<= (LitInt 0) |newtype$check#0@0|)))))
(let ((anon13_LoopBody_correct  (and (=> (= (ControlFlow 0 21) 3) anon14_Then_correct) (=> (= (ControlFlow 0 21) 20) anon14_Else_correct))))
(let ((anon13_LoopDone_correct true))
(let ((anon13_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.SetsST1$Y) ($IsAllocBox |x#0_0@0| _module._default.SetsST1$Y $Heap))) (=> (and (and (and ($Is SetType |s#0@0| (TSet _module._default.SetsST1$Y)) ($IsAlloc SetType |s#0@0| (TSet _module._default.SetsST1$Y) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.652:3|
 :skolemid |3156|
...
)) (<= (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|)) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 22) 1) anon13_LoopDone_correct) (=> (= (ControlFlow 0 22) 21) anon13_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |t#0@0| (|Set#UnionOne| |Set#Empty| |y#0|))) (and (= |$decr_init$loop#00@0| (|Set#Card| (|Set#Difference| |S#0| |t#0@0|))) (= (ControlFlow 0 23) 22))) anon13_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is SetType |S#0| (TSet _module._default.SetsST1$Y)) ($IsAlloc SetType |S#0| (TSet _module._default.SetsST1$Y) $Heap)) (and ($IsBox |y#0| _module._default.SetsST1$Y) ($IsAllocBox |y#0| _module._default.SetsST1$Y $Heap))) (and (and ($Is SetType |s#0| (TSet _module._default.SetsST1$Y)) ($IsAlloc SetType |s#0| (TSet _module._default.SetsST1$Y) $Heap)) true)) (and (and (and ($Is SetType |t#0| (TSet _module._default.SetsST1$Y)) ($IsAlloc SetType |t#0| (TSet _module._default.SetsST1$Y) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.SetsST1$Y) ($IsAllocBox |x#0_0| _module._default.SetsST1$Y $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 24) 23))))) anon0_correct))))
