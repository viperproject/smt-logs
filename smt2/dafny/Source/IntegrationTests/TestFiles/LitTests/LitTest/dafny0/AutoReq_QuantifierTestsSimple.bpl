...
axiom {:id "id17"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QuantifierTestsSimple.__default.byte#canCall(x#0) || 0 < $FunctionContextHeight
...
axiom {:id "id18"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QuantifierTestsSimple.__default.byte#canCall(LitInt(x#0))
...
procedure {:verboseName "QuantifierTestsSimple.byte (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.byte(x#0: int);
...
axiom {:id "id20"} 1 <= $FunctionContextHeight
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsSimple.__default.f__forall#canCall(s#0)
       ...
       ==> (forall i#0: int :: 
          ...
          LitInt(0) <= i#0
             ==> 
            i#0 < Seq#Length(s#0)
             ==> QuantifierTestsSimple.__default.byte#canCall($Unbox(Seq#Index(s#0, i#0)): int))
         && QuantifierTestsSimple.__default.f__forall(s#0)
           == (forall i#0: int :: 
            { $Unbox(Seq#Index(s#0, i#0)): int } 
            LitInt(0) <= i#0 && i#0 < Seq#Length(s#0)
               ==> QuantifierTestsSimple.__default.byte($Unbox(Seq#Index(s#0, i#0)): int)));
       ...
       ==> (forall i#1: int :: 
          ...
          LitInt(0) <= i#1
            ...
            i#1 < Seq#Length(Lit(s#0))
             ==> QuantifierTestsSimple.__default.byte#canCall($Unbox(Seq#Index(Lit(s#0), i#1)): int))
         && QuantifierTestsSimple.__default.f__forall(Lit(s#0))
           == (forall i#1: int :: 
            { $Unbox(Seq#Index(s#0, i#1)): int } 
            LitInt(0) <= i#1 && i#1 < Seq#Length(Lit(s#0))
               ==> QuantifierTestsSimple.__default.byte($Unbox(Seq#Index(Lit(s#0), i#1)): int)));
}
...
procedure {:verboseName "QuantifierTestsSimple.f_forall (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.f__forall(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsSimple.f_forall (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.f__forall(s#0: Seq)
{
  ...
  var ##x#0: int;
    ...
    else
    {
        ...
        if (true)
        {
            ...
            {
                assert {:id "id22"} 0 <= i#2 && i#2 < Seq#Length(s#0);
                ##x#0 := $Unbox(Seq#Index(s#0, i#2)): int;
                // assume allocatedness for argument to function
                assume $IsAlloc(##x#0, TInt, $Heap);
                assume QuantifierTestsSimple.__default.byte#canCall($Unbox(Seq#Index(s#0, i#2)): int);
            }
        }

        // End Comprehension WF check
        assume {:id "id23"} QuantifierTestsSimple.__default.f__forall(s#0)
           == (forall i#3: int :: 
            { $Unbox(Seq#Index(s#0, i#3)): int } 
            LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
               ==> QuantifierTestsSimple.__default.byte($Unbox(Seq#Index(s#0, i#3)): int));
        assume (forall i#3: int :: 
          { $Unbox(Seq#Index(s#0, i#3)): int } 
          LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
             ==> QuantifierTestsSimple.__default.byte#canCall($Unbox(Seq#Index(s#0, i#3)): int));
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsSimple.__default.f__forall(s#0), TBool);
        return;
...
axiom {:id "id24"} 1 <= $FunctionContextHeight
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsSimple.__default.f__exists#canCall(s#0)
         || (1 < $FunctionContextHeight && $Is(s#0, TSeq(TInt)))
       ==> (forall i#0: int :: 
          { $Unbox(Seq#Index(s#0, i#0)): int } 
          LitInt(0) <= i#0
...
procedure {:verboseName "QuantifierTestsSimple.f_exists (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.f__exists(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsSimple.f_exists (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.f__exists(s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var i#2: int;
  var ##x#0: int;
    ...
    else
    {
        ...
        if (true)
        {
            ...
            if (LitInt(0) <= i#2 && i#2 < Seq#Length(s#0))
            {
                assert {:id "id26"} 0 <= i#2 && i#2 < Seq#Length(s#0);
                ##x#0 := $Unbox(Seq#Index(s#0, i#2)): int;
                // assume allocatedness for argument to function
                assume $IsAlloc(##x#0, TInt, $Heap);
                assume QuantifierTestsSimple.__default.byte#canCall($Unbox(Seq#Index(s#0, i#2)): int);
        ...
        // End Comprehension WF check
        assume {:id "id27"} QuantifierTestsSimple.__default.f__exists(s#0)
           == (exists i#3: int :: 
            { $Unbox(Seq#Index(s#0, i#3)): int } 
            LitInt(0) <= i#3
               && i#3 < Seq#Length(s#0)
        ...
        assume (forall i#3: int :: 
          ...
          LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
             ==> QuantifierTestsSimple.__default.byte#canCall($Unbox(Seq#Index(s#0, i#3)): int));
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsSimple.__default.f__exists(s#0), TBool);
        return;
...
procedure {:verboseName "QuantifierTestsSimple.g_forall (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.g__forall(s#0: Seq where $Is(s#0, TSeq(TInt)));
...
procedure {:verboseName "QuantifierTestsSimple.g_exists (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.g__exists(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "QuantifierTestsSimple.h (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.h(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsSimple.h (well-formedness)"} CheckWellformed$$QuantifierTestsSimple.__default.h(s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##s#0: Seq;
  var ##s#1: Seq;
  ...
  var ##s#4: Seq;
    ...
    assume QuantifierTestsSimple.__default.f__forall#canCall(s#0);
    assume {:id "id38"} QuantifierTestsSimple.__default.f__forall(s#0);
    ##s#1 := s#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##s#1, TSeq(TInt), $Heap);
    assert {:id "id39"} {:subsumption 0} QuantifierTestsSimple.__default.f__forall#canCall(##s#1)
       ==> QuantifierTestsSimple.__default.f__forall(##s#1)
         || (forall i#0: int :: 
          { $Unbox(Seq#Index(##s#1, i#0)): int } 
          LitInt(0) <= i#0 && i#0 < Seq#Length(##s#1)
             ==> QuantifierTestsSimple.__default.byte($Unbox(Seq#Index(##s#1, i#0)): int));
    assume QuantifierTestsSimple.__default.f__forall(##s#1);
    assume QuantifierTestsSimple.__default.g__forall#canCall(s#0);
    if (QuantifierTestsSimple.__default.g__forall(s#0))
    {
        ##s#2 := s#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##s#2, TSeq(TInt), $Heap);
        assume QuantifierTestsSimple.__default.f__exists#canCall(s#0);
    }

    assume {:id "id40"} QuantifierTestsSimple.__default.g__forall(s#0)
       ==> QuantifierTestsSimple.__default.f__exists(s#0);
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    ...
    else
    {
        ...
        assert {:id "id41"} {:subsumption 0} QuantifierTestsSimple.__default.f__forall#canCall(##s#3)
           ==> QuantifierTestsSimple.__default.f__forall(##s#3)
             || (forall i#1: int :: 
              { $Unbox(Seq#Index(##s#3, i#1)): int } 
              LitInt(0) <= i#1 && i#1 < Seq#Length(##s#3)
                 ==> QuantifierTestsSimple.__default.byte($Unbox(Seq#Index(##s#3, i#1)): int));
        assume QuantifierTestsSimple.__default.f__forall(##s#3);
        assume QuantifierTestsSimple.__default.g__forall#canCall(s#0);
        if (QuantifierTestsSimple.__default.g__forall(s#0))
        {
            ##s#4 := s#0;
            ...
            assert {:id "id42"} {:subsumption 0} QuantifierTestsSimple.__default.f__exists#canCall(##s#4)
               ==> QuantifierTestsSimple.__default.f__exists(##s#4)
                 || (exists i#2: int :: 
                  { $Unbox(Seq#Index(##s#4, i#2)): int } 
                  LitInt(0) <= i#2
                     && i#2 < Seq#Length(##s#4)
                     && QuantifierTestsSimple.__default.byte($Unbox(Seq#Index(##s#4, i#2)): int));
            assume QuantifierTestsSimple.__default.f__exists(##s#4);
            assume QuantifierTestsSimple.__default.g__exists#canCall(s#0);
        }

        assume {:id "id43"} QuantifierTestsSimple.__default.h(s#0)
           == (QuantifierTestsSimple.__default.g__forall(s#0)
             && QuantifierTestsSimple.__default.g__exists(s#0));
        assume QuantifierTestsSimple.__default.g__forall#canCall(s#0)
           && (QuantifierTestsSimple.__default.g__forall(s#0)
             ==> QuantifierTestsSimple.__default.g__exists#canCall(s#0));
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsSimple.__default.h(s#0), TBool);
        return;
