...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.TestsWhereTriggersMatter)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (<= (LitInt 10) (|Seq#Length| |uu#0|)) (= (ControlFlow 0 2) (- 0 1))) (and (<= 0 (LitInt 4)) (< (LitInt 4) (|Seq#Length| |uu#0|)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |t#0| _module._default.TestsWhereTriggersMatter$T) ($IsAllocBox |t#0| _module._default.TestsWhereTriggersMatter$T $Heap))) (and (and ($Is SeqType |uu#0| (TSeq _module._default.TestsWhereTriggersMatter$T)) ($IsAlloc SeqType |uu#0| (TSeq _module._default.TestsWhereTriggersMatter$T) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
