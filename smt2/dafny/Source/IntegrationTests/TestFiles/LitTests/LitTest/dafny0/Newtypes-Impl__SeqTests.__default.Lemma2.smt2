...
(declare-fun |s#0| () T@U)
(declare-fun |elt#0| () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun SeqTests._default.Lemma2$T () T@U)
(declare-fun |index#0| () Int)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$SeqTests.__default.Lemma2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|Seq#Contains| |s#0| |elt#0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |elt#0| SeqTests._default.Lemma2$T) ($IsAllocBox |elt#0| SeqTests._default.Lemma2$T $Heap))) (=> (and (and (and ($Is SeqType |s#0| (TSeq SeqTests._default.Lemma2$T)) ($IsAlloc SeqType |s#0| (TSeq SeqTests._default.Lemma2$T) $Heap)) (<= (LitInt 0) |index#0|)) (and (and (= 0 $FunctionContextHeight) (< |index#0| (|Seq#Length| |s#0|))) (and (= |elt#0| (|Seq#Index| |s#0| |index#0|)) (= (ControlFlow 0 3) 2)))) anon0_correct))))
