...
(assert (forall (($o@@8 T@U) ) (!  (=> ($Is refType $o@@8 Tclass.M0.Cl?) ($Is refType $o@@8 Tclass.M0.Tr?))
 :qid |unknown.0:0|
 :skolemid |1315|
 :pattern ( ($Is refType $o@@8 Tclass.M0.Cl?))
)))
...
(assert (= (Tag Tclass.M0.Cl) Tagclass.M0.Cl))
(assert (= (TagFamily Tclass.M0.Cl) tytagFamily$Cl))
(assert (forall (($o@@9 T@U) ) (! (= ($Is refType $o@@9 Tclass.M0.Tr?)  (or (= $o@@9 null) (implements$M0.Tr (dtype $o@@9))))
 :qid |unknown.0:0|
 :skolemid |1277|
 :pattern ( ($Is refType $o@@9 Tclass.M0.Tr?))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@10 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@10 $f@@0))  (=> (and (or (not (= $o@@10 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@10) |l#2|)))) (or (= $o@@10 |l#3|) (= $o@@10 |l#4|))))
...
(set-info :boogie-vc-id OverrideCheck$$M0.Cl.G)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (or (= |c#0@@8| null) (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@11 null)) (not true)) (=> (= $o@@11 |c#0@@8|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@11) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@11) $f@@1))))
...
))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (or (not (= |c#0@@8| null)) (not true)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data)))))) (=> (=> (or (not (= |c#0@@8| null)) (not true)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) ($Box refType |d#0@@2|))) (=> (|Set#Equal| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) ($Box refType |d#0@@2|))) (and (=> (or (not (= |c#0@@8| null)) (not true)) (or (not (= |c#0@@8| null)) (not true))) (=> (=  (or (not (= |c#0@@8| null)) (not true))  (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (or (not (= |d#0@@2| null)) (not true)))))))) (=> (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) ($Box refType |d#0@@2|))) (=> (|Set#Equal| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) ($Box refType |d#0@@2|))) (and (=> (or (not (= |c#0@@8| null)) (not true)) (or (not (= |c#0@@8| null)) (not true))) (=> (=  (or (not (= |c#0@@8| null)) (not true))  (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (or (not (= |d#0@@2| null)) (not true))))))) (=> (= Cl_$_ReadsFrame@0 (|lambda#0| null current$Heap alloc |c#0@@8| |d#0@@2|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@12 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@12) alloc)))) (= $o@@12 |c#0@@8|)) (or (= $o@@12 |c#0@@8|) (= $o@@12 |d#0@@2|)))
 :qid |TwostateFunctionsdfy.125:23|
 :skolemid |1307|
))) (=> (forall (($o@@13 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@13) alloc)))) (= $o@@13 |c#0@@8|)) (or (= $o@@13 |c#0@@8|) (= $o@@13 |d#0@@2|)))
 :qid |TwostateFunctionsdfy.125:23|
 :skolemid |1307|
)) (=> (=> (or (not (= |c#0@@8| null)) (not true)) (= (M0.Cl.G $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))))) (=> (and (and (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |d#0@@2|) M0.C.data)))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |c#0@@8| null)) (not true))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))) (M0.Cl.G $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.M0.Cl) ($IsAlloc refType this@@2 Tclass.M0.Cl current$Heap@@0))) ($Is refType |c#0@@8| Tclass.M0.C?)) (and ($Is refType |d#0@@2| Tclass.M0.C) (= 1 $FunctionContextHeight))) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap@@0) ($IsGoodHeap current$Heap@@0))) (= (ControlFlow 0 6) 2))) anon0_correct))))
