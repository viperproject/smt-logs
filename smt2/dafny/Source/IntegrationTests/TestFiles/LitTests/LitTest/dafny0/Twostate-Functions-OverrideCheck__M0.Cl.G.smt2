...
))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (or (not (= |c#0@@8| null)) (not true)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data)))))) (=> (=> (or (not (= |c#0@@8| null)) (not true)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) ($Box refType |d#0@@2|))) (=> (|Set#Equal| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) ($Box refType |d#0@@2|))) (and (=> (or (not (= |c#0@@8| null)) (not true)) (or (not (= |c#0@@8| null)) (not true))) (=> (=  (or (not (= |c#0@@8| null)) (not true))  (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (or (not (= |d#0@@2| null)) (not true)))))))) (=> (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) ($Box refType |d#0@@2|))) (=> (|Set#Equal| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@8|)) ($Box refType |d#0@@2|))) (and (=> (or (not (= |c#0@@8| null)) (not true)) (or (not (= |c#0@@8| null)) (not true))) (=> (=  (or (not (= |c#0@@8| null)) (not true))  (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (or (not (= |d#0@@2| null)) (not true))))))) (=> (= Cl_$_ReadsFrame@0 (|lambda#0| null current$Heap alloc |c#0@@8| |d#0@@2|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@12 T@U) ($f@@2 T@U) )  (=> (and (and (or (not (= $o@@12 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@12) alloc)))) (= $o@@12 |c#0@@8|)) (or (= $o@@12 |c#0@@8|) (= $o@@12 |d#0@@2|))))) (=> (forall (($o@@13 T@U) ($f@@3 T@U) )  (=> (and (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@13) alloc)))) (= $o@@13 |c#0@@8|)) (or (= $o@@13 |c#0@@8|) (= $o@@13 |d#0@@2|)))) (=> (=> (or (not (= |c#0@@8| null)) (not true)) (= (M0.Cl.G $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))))) (=> (and (and (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |d#0@@2|) M0.C.data)))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |c#0@@8| null)) (not true))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))) (M0.Cl.G $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|))))))))))))))
