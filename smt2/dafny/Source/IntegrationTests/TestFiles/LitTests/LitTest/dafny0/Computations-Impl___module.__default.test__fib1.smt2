...
(set-info :boogie-vc-id Impl$$_module.__default.test__fib1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= |k#0| (LitInt 12))) (= (_module.__default.fib ($LS ($LS $LZ)) |k#0|) (LitInt 144)))))
