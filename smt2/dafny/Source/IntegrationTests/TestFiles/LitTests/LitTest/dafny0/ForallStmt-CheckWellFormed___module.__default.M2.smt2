...
(let ((anon8_correct  (=> (and (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (Div (_System.array.Length |a#0@0|) (LitInt 2)))) (<= (Div (_System.array.Length |a#0@0|) (LitInt 2)) |j#0@0|)) (< |j#0@0| (_System.array.Length |a#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= |a#0@0| null)) (not true))) (=> (or (not (= |a#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0@0| null)) (not true))) (=> (or (not (= |a#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array.Length |a#0@0|)))) (=> (and (<= 0 |j#0@0|) (< |j#0@0| (_System.array.Length |a#0@0|))) (=> (and (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@0|) (IndexField |i#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@0|) (IndexField |j#0@0|))))) (= (ControlFlow 0 3) 1)) anon10_correct))))))))))))
(let ((anon14_Else_correct  (=> (and (not (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (Div (_System.array.Length |a#0@0|) (LitInt 2)))) (<= (Div (_System.array.Length |a#0@0|) (LitInt 2)) |j#0@0|))) (= (ControlFlow 0 10) 3)) anon8_correct)))
(let ((anon14_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (Div (_System.array.Length |a#0@0|) (LitInt 2)))) (<= (Div (_System.array.Length |a#0@0|) (LitInt 2)) |j#0@0|)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (not (= |a#0@0| null)) (not true))) (=> (or (not (= |a#0@0| null)) (not true)) (=> (= (ControlFlow 0 8) 3) anon8_correct))))))
(let ((anon13_Else_correct  (=> (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (Div (_System.array.Length |a#0@0|) (LitInt 2))))) (and (=> (= (ControlFlow 0 14) 8) anon14_Then_correct) (=> (= (ControlFlow 0 14) 10) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (Div (_System.array.Length |a#0@0|) (LitInt 2)))) (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= |a#0@0| null)) (not true))) (=> (or (not (= |a#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 11) 8) anon14_Then_correct) (=> (= (ControlFlow 0 11) 10) anon14_Else_correct)))))))))
(let ((anon12_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 18) 11) anon13_Then_correct) (=> (= (ControlFlow 0 18) 14) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 15) (- 0 17)) (or (not (= |a#0@0| null)) (not true))) (=> (or (not (= |a#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 15) (- 0 16)) (or (not (= (LitInt 2) 0)) (not true))) (=> (or (not (= (LitInt 2) 0)) (not true)) (and (=> (= (ControlFlow 0 15) 11) anon13_Then_correct) (=> (= (ControlFlow 0 15) 14) anon13_Else_correct)))))))))
(let ((anon11_Else_correct  (=> (and (=> (and (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (Div (_System.array.Length |a#0@0|) (LitInt 2)))) (<= (Div (_System.array.Length |a#0@0|) (LitInt 2)) |j#0@0|)) (< |j#0@0| (_System.array.Length |a#0@0|))) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@0|) (IndexField |i#0@0|)))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0@0|) (IndexField |j#0@0|)))))) (= (ControlFlow 0 2) 1)) anon10_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |ForallStmtdfy.103:8|
 :skolemid |626|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0)) (and ($Is refType |a#0@0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0@0| (Tclass._System.array TInt) $Heap@0))) (and (and (=> (= (ControlFlow 0 19) 2) anon11_Else_correct) (=> (= (ControlFlow 0 19) 15) anon12_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon12_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 20) 19))) anon0_correct))))
