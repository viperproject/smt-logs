...
(declare-fun _module.C.G (T@U T@U) Int)
(declare-fun |_module.C.G#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.C.G#canCall| $Heap this) (and (< 1 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap)))))) (and (|_module.C.F#canCall| $Heap this) (= (_module.C.G $Heap this) (_module.C.F $Heap this))))
 :qid |Backticksdfy.15:18|
 :skolemid |498|
 :pattern ( (_module.C.G $Heap this) ($IsGoodHeap $Heap))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> ($IsAllocBox ($Box refType this@@1) Tclass._module.C? $Heap@@1) (=> (and (= |b$reqreads#0@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@4) alloc)))) (and (= $o@@4 this@@1) (= $f@@0 _module.C.x))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |Backticksdfy.18:5|
 :skolemid |499|
))) (|_module.C.F#canCall| $Heap@@1 this@@1)) (=> (and (and (= (_module.C.G $Heap@@1 this@@1) (_module.C.F $Heap@@1 this@@1)) (|_module.C.F#canCall| $Heap@@1 this@@1)) (and ($Is intType (int_2_U (_module.C.G $Heap@@1 this@@1)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc this@@1 _module.C.x)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= this@@1 null)) (not true))) (=> (or (not (= this@@1 null)) (not true)) (and (=> (= (ControlFlow 0 4) 1) anon5_Then_correct) (=> (= (ControlFlow 0 4) 3) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.C) ($IsAlloc refType this@@1 Tclass._module.C $Heap@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 4))) anon0_correct))))
