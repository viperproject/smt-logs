...
(set-info :boogie-vc-id Impl$$_module.__default.compute__cintsize4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (LitInt (_module.__default.cintsize ($LS ($LS $LZ)) (Lit DatatypeTypeType (|#_module.intlist.IntCons| (LitInt 1) (Lit DatatypeTypeType (|#_module.intlist.IntCons| (LitInt 2) (Lit DatatypeTypeType (|#_module.intlist.IntCons| (LitInt 3) (Lit DatatypeTypeType (|#_module.intlist.IntCons| (LitInt 4) (Lit DatatypeTypeType |#_module.intlist.IntNil|))))))))))) (LitInt 4)))))
