...
(declare-fun |AssignmentToNat.__default.Pf#requires| (Int) Bool)
...
(declare-fun AssignmentToNat.__default.Pg (Int) Int)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun |AssignmentToNat.__default.Pg#Handle| () T@U)
...
(declare-fun |AssignmentToNat.__default.Pg#requires| (Int) Bool)
...
(declare-fun |AssignmentToNat.__default.Pf#Handle| () T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun |AssignmentToNat.__default.Pg#canCall| (Int) Bool)
(declare-fun $LS (T@U) T@U)
(declare-fun AssignmentToNat.__default.Pf (Int) Int)
...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#u#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#7| |l#0|) |$l#0#heap#0| |$l#0#u#0|)) ($IsBox |$l#0#u#0| |l#0|))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |9966|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#7| |l#0|) |$l#0#heap#0| |$l#0#u#0|))
)))
...
(assert (forall ((|n#0| Int) ) (!  (=> (<= (LitInt 0) |n#0|) (= (|AssignmentToNat.__default.Pf#requires| |n#0|) true))
 :qid |SubsetTypesdfy.38:15|
 :skolemid |502|
 :pattern ( (|AssignmentToNat.__default.Pf#requires| |n#0|))
)))
...
(assert (forall (($heap T@U) (|$fh$0x#0| Int) ) (! (= (AssignmentToNat.__default.Pg |$fh$0x#0|) (U_2_int ($Unbox intType (Apply1 TInt Tclass._System.nat $heap |AssignmentToNat.__default.Pg#Handle| ($Box intType (int_2_U |$fh$0x#0|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |518|
 :pattern ( (AssignmentToNat.__default.Pg |$fh$0x#0|) ($IsGoodHeap $heap))
)))
...
(assert (forall ((|l#0@@0| Bool) (|$l#0#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#8| |l#0@@0|) |$l#0#o#0|)) |l#0@@0|)
 :qid |unknown.0:0|
 :skolemid |9967|
 :pattern ( (MapType1Select refType boolType (|lambda#8| |l#0@@0|) |$l#0#o#0|))
)))
(assert (forall ((|l#0@@1| T@U) (|$l#0#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#10| |l#0@@1|) |$l#0#ly#0|) |l#0@@1|)
 :qid |SubsetTypesdfy.50:15|
 :skolemid |9969|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#10| |l#0@@1|) |$l#0#ly#0|))
)))
(assert (forall ((|x#0@@1| Int) ) (! (= (|AssignmentToNat.__default.Pg#requires| |x#0@@1|) true)
 :qid |SubsetTypesdfy.39:15|
 :skolemid |504|
 :pattern ( (|AssignmentToNat.__default.Pg#requires| |x#0@@1|))
)))
...
(assert (forall (($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 Tclass._System.nat TInt $heap@@0 |AssignmentToNat.__default.Pf#Handle| |$fh$0x#0@@0|) (|AssignmentToNat.__default.Pf#requires| (U_2_int ($Unbox intType |$fh$0x#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |512|
 :pattern ( (Requires1 Tclass._System.nat TInt $heap@@0 |AssignmentToNat.__default.Pf#Handle| |$fh$0x#0@@0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@2| Int) ) (!  (=> (or (|AssignmentToNat.__default.Pg#canCall| |x#0@@2|) (< 0 $FunctionContextHeight)) (<= (LitInt 0) (AssignmentToNat.__default.Pg |x#0@@2|)))
 :qid |SubsetTypesdfy.39:15|
 :skolemid |503|
 :pattern ( (AssignmentToNat.__default.Pg |x#0@@2|))
))))
...
(assert (forall (($heap@@1 T@U) (|$fh$0x#0@@1| Int) ) (! (= (AssignmentToNat.__default.Pf |$fh$0x#0@@1|) (U_2_int ($Unbox intType (Apply1 Tclass._System.nat TInt $heap@@1 |AssignmentToNat.__default.Pf#Handle| ($Box intType (int_2_U |$fh$0x#0@@1|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |514|
 :pattern ( (AssignmentToNat.__default.Pf |$fh$0x#0@@1|) ($IsGoodHeap $heap@@1))
)))
...
(assert (forall (($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Requires1 TInt Tclass._System.nat $heap@@2 |AssignmentToNat.__default.Pg#Handle| |$fh$0x#0@@2|) (|AssignmentToNat.__default.Pg#requires| (U_2_int ($Unbox intType |$fh$0x#0@@2|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |516|
 :pattern ( (Requires1 TInt Tclass._System.nat $heap@@2 |AssignmentToNat.__default.Pg#Handle| |$fh$0x#0@@2|))
)))
...
(assert (forall ((|$l#0#heap#0@@0| T@U) (|$l#0#u#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#6| |$l#0#heap#0@@0| |$l#0#u#0@@0|) ($Box intType ($Unbox intType |$l#0#u#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |9965|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType |lambda#6| |$l#0#heap#0@@0| |$l#0#u#0@@0|))
)))
...
(assert (forall (($bx T@U) ($heap@@3 T@U) (|$fh$0x#0@@3| T@U) ) (! (= (|Set#IsMember| (Reads1 Tclass._System.nat TInt $heap@@3 |AssignmentToNat.__default.Pf#Handle| |$fh$0x#0@@3|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |513|
 :pattern ( (|Set#IsMember| (Reads1 Tclass._System.nat TInt $heap@@3 |AssignmentToNat.__default.Pf#Handle| |$fh$0x#0@@3|) $bx))
)))
(assert (forall (($bx@@0 T@U) ($heap@@4 T@U) (|$fh$0x#0@@4| T@U) ) (! (= (|Set#IsMember| (Reads1 TInt Tclass._System.nat $heap@@4 |AssignmentToNat.__default.Pg#Handle| |$fh$0x#0@@4|) $bx@@0) false)
 :qid |unknown.0:0|
 :skolemid |517|
 :pattern ( (|Set#IsMember| (Reads1 TInt Tclass._System.nat $heap@@4 |AssignmentToNat.__default.Pg#Handle| |$fh$0x#0@@4|) $bx@@0))
)))
...
(assert (forall (($heap@@5 T@U) (|$fh$0x#0@@5| T@U) ) (! (= (Apply1 Tclass._System.nat TInt $heap@@5 |AssignmentToNat.__default.Pf#Handle| |$fh$0x#0@@5|) ($Box intType (int_2_U (AssignmentToNat.__default.Pf (U_2_int ($Unbox intType |$fh$0x#0@@5|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |511|
 :pattern ( (Apply1 Tclass._System.nat TInt $heap@@5 |AssignmentToNat.__default.Pf#Handle| |$fh$0x#0@@5|))
)))
...
(assert (forall (($heap@@6 T@U) (|$fh$0x#0@@6| T@U) ) (! (= (Apply1 TInt Tclass._System.nat $heap@@6 |AssignmentToNat.__default.Pg#Handle| |$fh$0x#0@@6|) ($Box intType (int_2_U (AssignmentToNat.__default.Pg (U_2_int ($Unbox intType |$fh$0x#0@@6|))))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |515|
 :pattern ( (Apply1 TInt Tclass._System.nat $heap@@6 |AssignmentToNat.__default.Pg#Handle| |$fh$0x#0@@6|))
)))
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#u#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#9| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#u#0@@1|) |l#0@@3|)
 :qid |SubsetTypesdfy.50:15|
 :skolemid |9968|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#9| |l#0@@3|) |$l#0#heap#0@@1| |$l#0#u#0@@1|))
)))
...
(set-info :boogie-vc-id Impl$$AssignmentToNat.__default.Q)
...
(let ((anon5_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 5) 3) anon6_Then_correct) (=> (= (ControlFlow 0 5) 4) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (= |id#0@0| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#10| (Handle1 |lambda#6| (|lambda#7| TInt) (|lambda#9| (SetRef_to_SetBox (|lambda#8| false))))) ($LS $LZ)))) (= (ControlFlow 0 2) (- 0 1))) ($Is HandleTypeType |id#0@0| (Tclass._System.___hTotalFunc1 TInt Tclass._System.nat)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |f#0@0| |AssignmentToNat.__default.Pf#Handle|) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (= |g#0@0| |AssignmentToNat.__default.Pg#Handle|) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($Is intType (int_2_U |x#0@@3|) Tclass._System.nat)) (=> ($Is intType (int_2_U |x#0@@3|) Tclass._System.nat) (=> (= |a#0@0| (U_2_int ($Unbox intType (Apply1 Tclass._System.nat TInt $Heap |f#0@0| ($Box intType (int_2_U |x#0@@3|)))))) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 2) anon5_Else_correct))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 Tclass._System.nat TInt) $Heap)) true) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt Tclass._System.nat)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt Tclass._System.nat) $Heap)) true)) (and (and (and ($Is HandleTypeType |id#0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |id#0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 10) 6)))) anon0_correct))))
