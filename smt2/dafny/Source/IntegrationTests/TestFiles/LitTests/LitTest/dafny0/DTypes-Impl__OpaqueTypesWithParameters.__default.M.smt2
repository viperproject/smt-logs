...
(assert (forall ((|l#0| T@U) (|$l#0#heap#0| T@U) (|$l#0#_v4#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0|) |$l#0#heap#0| |$l#0#_v4#0|)) ($IsBox |$l#0#_v4#0| |l#0|))
 :qid |unknown.0:0|
 :skolemid |2222|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#2| |l#0|) |$l#0#heap#0| |$l#0#_v4#0|))
)))
...
(assert (forall ((|l#0@@3| T@U) (|$l#0#heap#0@@0| T@U) (|$l#0#_v4#0@@0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#_v4#0@@0|) |l#0@@3|)
 :qid |DTypesdfy.165:24|
 :skolemid |2221|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#1| |l#0@@3|) |$l#0#heap#0@@0| |$l#0#_v4#0@@0|))
)))
(assert (forall ((|l#0@@4| T@U) (|$l#0#heap#0@@1| T@U) (|$l#0#_v4#0@@1| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#_v4#0@@1|) |l#0@@4|)
 :qid |DTypesdfy.168:30|
 :skolemid |2224|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType SetType (|lambda#4| |l#0@@4|) |$l#0#heap#0@@1| |$l#0#_v4#0@@1|))
)))
...
(declare-fun |p#0| () T@U)
(declare-fun OpaqueTypesWithParameters._default.M$B () T@U)
(declare-fun |defass#q#0| () Bool)
(declare-fun |q#0| () T@U)
(declare-fun |a#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$OpaqueTypesWithParameters.__default.M)
...
(let ((anon6_Else_correct  (=> (and (< |_v4#0@0| (LitInt 0)) (= (ControlFlow 0 6) 4)) anon3_correct)))
(let ((anon6_Then_correct  (=> (<= (LitInt 0) |_v4#0@0|) (=> (and (and (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (= |lambdaResult#0| |it#0|)) (and ($IsBox |lambdaResult#0| (Tclass.OpaqueTypesWithParameters.P TInt)) (= (ControlFlow 0 5) 4))) anon3_correct))))
...
(let ((anon5_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? (Tclass.OpaqueTypesWithParameters.P TInt)))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 500)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 500))) (Requires1 Tclass._System.nat (Tclass.OpaqueTypesWithParameters.P TInt) $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| |it#0|) (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |DTypesdfy.168:14|
 :skolemid |482|
))) (=> (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (LitInt 500))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 Tclass._System.nat (Tclass.OpaqueTypesWithParameters.P TInt) $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle1 (|lambda#1| |it#0|) (|lambda#2| Tclass._System.nat) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |DTypesdfy.168:14|
 :skolemid |483|
...
)) (=> (and (and (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true))))) ($IsGoodHeap $Heap@0)) (and ($IsHeapAnchor $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) true))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= 0 (LitInt 500))) (=> (<= 0 (LitInt 500)) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |p#0| (Tclass.OpaqueTypesWithParameters.P OpaqueTypesWithParameters._default.M$B)) ($IsAllocBox |p#0| (Tclass.OpaqueTypesWithParameters.P OpaqueTypesWithParameters._default.M$B) $Heap))) (and (and ($IsBox |it#0| (Tclass.OpaqueTypesWithParameters.P TInt)) ($IsAllocBox |it#0| (Tclass.OpaqueTypesWithParameters.P TInt) $Heap)) (=> |defass#q#0| (and ($IsBox |q#0| (Tclass.OpaqueTypesWithParameters.P OpaqueTypesWithParameters._default.M$B)) ($IsAllocBox |q#0| (Tclass.OpaqueTypesWithParameters.P OpaqueTypesWithParameters._default.M$B) $Heap))))) (and (and (and ($Is refType |a#0| (Tclass._System.array (Tclass.OpaqueTypesWithParameters.P TInt))) ($IsAlloc refType |a#0| (Tclass._System.array (Tclass.OpaqueTypesWithParameters.P TInt)) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 8)))) anon0_correct)))
