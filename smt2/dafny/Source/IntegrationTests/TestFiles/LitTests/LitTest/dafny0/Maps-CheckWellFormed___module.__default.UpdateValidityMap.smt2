...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.UpdateValidityMap)
...
(let ((anon9_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box intType (int_2_U |k#2@0|))) (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |mm#0|) ($Box intType (int_2_U |k#2@0|))))))) (= (ControlFlow 0 4) 1)) anon7_correct)))
(let ((anon9_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box intType (int_2_U |k#2@0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box intType (int_2_U |k#2@0|)))) (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box intType (int_2_U |k#2@0|))) (=> (and (<= (LitInt 0) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |mm#0|) ($Box intType (int_2_U |k#2@0|)))))) (= (ControlFlow 0 2) 1)) anon7_correct))))))
(let ((anon4_correct  (=> (forall ((|k#1| T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box intType |k#1|)) (<= (LitInt 0) (U_2_int |k#1|)))
 :qid |Mapsdfy.323:19|
 :skolemid |754|
...
(let ((anon8_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box intType (int_2_U |k#0@0|))) (<= (LitInt 0) |k#0@0|)) (= (ControlFlow 0 7) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box intType (int_2_U |k#0@0|))) (=> (and (<= (LitInt 0) |k#0@0|) (= (ControlFlow 0 6) 5)) anon4_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |mm#0| (TMap TInt TInt)) ($IsAlloc MapType |mm#0| (TMap TInt TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
