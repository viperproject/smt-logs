...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.UpdateValidityMapNull)
...
(let ((anon9_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box refType |k#2@0|)) (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |mm#0|) ($Box refType |k#2@0|))) null)) (not true))) (= (ControlFlow 0 4) 1)) anon7_correct)))
(let ((anon9_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box refType |k#2@0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box refType |k#2@0|))) (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box refType |k#2@0|)) (=> (and (or (not (= ($Unbox refType (MapType0Select BoxType BoxType (|Map#Elements| |mm#0|) ($Box refType |k#2@0|))) null)) (not true)) (= (ControlFlow 0 2) 1)) anon7_correct))))))
(let ((anon4_correct  (=> (forall ((|k#1| T@U) ) (!  (=> ($Is refType |k#1| Tclass._module.Elem?) (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box refType |k#1|)) (or (not (= |k#1| null)) (not true))))
 :qid |Mapsdfy.353:19|
 :skolemid |771|
 :pattern ( (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box refType |k#1|)))
)) (=> (and ($Is refType |k#2@0| Tclass._module.Elem?) ($IsAlloc refType |k#2@0| Tclass._module.Elem? $Heap)) (and (=> (= (ControlFlow 0 5) 2) anon9_Then_correct) (=> (= (ControlFlow 0 5) 4) anon9_Else_correct))))))
(let ((anon8_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box refType |k#0@0|)) (or (not (= |k#0@0| null)) (not true))) (= (ControlFlow 0 7) 5)) anon4_correct)))
(let ((anon8_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |mm#0|) ($Box refType |k#0@0|)) (=> (and (or (not (= |k#0@0| null)) (not true)) (= (ControlFlow 0 6) 5)) anon4_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is refType |k#0@0| Tclass._module.Elem?) ($IsAlloc refType |k#0@0| Tclass._module.Elem? $Heap)) (and (=> (= (ControlFlow 0 8) 6) anon8_Then_correct) (=> (= (ControlFlow 0 8) 7) anon8_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |mm#0| (TMap Tclass._module.Elem? Tclass._module.Elem?)) ($IsAlloc MapType |mm#0| (TMap Tclass._module.Elem? Tclass._module.Elem?) $Heap)) (and ($Is refType |d#0| Tclass._module.Elem?) ($IsAlloc refType |d#0| Tclass._module.Elem? $Heap))) (and (and ($Is refType |e#0| Tclass._module.Elem) ($IsAlloc refType |e#0| Tclass._module.Elem $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8)))) anon0_correct))))
