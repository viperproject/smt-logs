...
(assert (distinct TagSeq alloc Tagclass._module.Elem? Tagclass._module.Elem tytagFamily$Elem)
)
...
(set-info :boogie-vc-id Impl$$_module.__default.UpdateValiditySeqNull)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon3_Else_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0@0|)))) (=> (and (<= 0 (LitInt 1)) (< (LitInt 1) (|Seq#Length| |s#0@0|))) (=> (= (ControlFlow 0 4) (- 0 3)) ($Is refType |d#0| Tclass._module.Elem))))))
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 10)) (< (LitInt 10) (|Seq#Length| |s#0@0|))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box refType |e#0|)) ($Box refType |e#0|)) ($Box refType |e#0|)) ($Box refType |e#0|)) ($Box refType |e#0|)))) (and (=> (= (ControlFlow 0 6) 2) anon3_Then_correct) (=> (= (ControlFlow 0 6) 4) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |d#0| Tclass._module.Elem?) ($IsAlloc refType |d#0| Tclass._module.Elem? $Heap)) (and ($Is refType |e#0| Tclass._module.Elem) ($IsAlloc refType |e#0| Tclass._module.Elem $Heap))) (=> (and (and (and ($Is SeqType |s#0| (TSeq Tclass._module.Elem)) ($IsAlloc SeqType |s#0| (TSeq Tclass._module.Elem) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6))) anon0_correct)))))
