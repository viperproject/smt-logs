...
const unique class.StmtExprCallPreconditionRegression.__default: ClassName;

// function declaration for StmtExprCallPreconditionRegression._default.G
function StmtExprCallPreconditionRegression.__default.G() : int;

function StmtExprCallPreconditionRegression.__default.G#canCall() : bool;

function StmtExprCallPreconditionRegression.__default.G#requires() : bool
uses {
// #requires axiom for StmtExprCallPreconditionRegression.__default.G
axiom StmtExprCallPreconditionRegression.__default.G#requires() == Lit(true);
}

procedure {:verboseName "StmtExprCallPreconditionRegression.G (well-formedness)"} CheckWellformed$$StmtExprCallPreconditionRegression.__default.G();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "StmtExprCallPreconditionRegression.G (well-formedness)"} CheckWellformed$$StmtExprCallPreconditionRegression.__default.G()
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(500,16)
    // TrCallStmt: Before ProcessCallStmt
    call {:id "id744"} Call$$StmtExprCallPreconditionRegression.__default.X();
    // TrCallStmt: After ProcessCallStmt
    assume {:id "id745"} true;
...
procedure {:verboseName "StmtExprCallPreconditionRegression.X (well-formedness)"} CheckWellFormed$$StmtExprCallPreconditionRegression.__default.X();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "StmtExprCallPreconditionRegression.X (call)"} Call$$StmtExprCallPreconditionRegression.__default.X();
  // user-defined preconditions
  requires {:id "id747"} Lit(false);
  modifies $Heap;
  // frame condition
...
procedure {:verboseName "StmtExprCallPreconditionRegression.X (correctness)"} Impl$$StmtExprCallPreconditionRegression.__default.X() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id748"} Lit(false);
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
