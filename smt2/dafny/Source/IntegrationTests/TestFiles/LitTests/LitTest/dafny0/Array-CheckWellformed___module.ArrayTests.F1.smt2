...
(declare-fun _module.ArrayTests.F1 (T@U T@U) Bool)
(declare-fun |_module.ArrayTests.F1#canCall| (T@U T@U) Bool)
...
(assert (distinct TBool TInt TagBool TagInt alloc allocName Tagclass._System.array? Tagclass._System.array class._module.ArrayTests? Tagclass._module.ArrayTests? Tagclass._module.ArrayTests tytagFamily$array tytagFamily$ArrayTests field$b)
)
(assert (= (FDim alloc) 0))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) ) (!  (=> (or (|_module.ArrayTests.F1#canCall| $Heap this) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.ArrayTests) ($IsAlloc refType this Tclass._module.ArrayTests $Heap)))))) (= (_module.ArrayTests.F1 $Heap this)  (and (<= (LitInt 10) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.ArrayTests.b)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.ArrayTests.b))) (IndexField (LitInt 7))))) (LitInt 13)))))
 :qid |Arraydfy.164:18|
 :skolemid |1299|
 :pattern ( (_module.ArrayTests.F1 $Heap this) ($IsGoodHeap $Heap))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.ArrayTests.F1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon5_correct  (=> (and (= (_module.ArrayTests.F1 $Heap@@0 this@@0)  (and (<= (LitInt 10) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b)))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b))) (IndexField (LitInt 7))))) (LitInt 13)))) ($Is boolType (bool_2_U (_module.ArrayTests.F1 $Heap@@0 this@@0)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|))))))))
(let ((anon8_Else_correct  (=> (and (and (< (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b))) (LitInt 10)) (= |b$reqreads#1@1| true)) (and (= |b$reqreads#2@1| true) (= (ControlFlow 0 9) 3))) anon5_correct)))
(let ((anon8_Then_correct  (=> (and (<= (LitInt 10) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b)))) (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@0 _module.ArrayTests.b)))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b)) null)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b)))))) (=> (and (<= 0 (LitInt 7)) (< (LitInt 7) (_System.array.Length ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b))))) (=> (and (and (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b)) (IndexField (LitInt 7))))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3))) anon5_correct))))))))
(let ((anon7_Else_correct  (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@0 _module.ArrayTests.b))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) _module.ArrayTests.b)) null)) (not true)) (and (=> (= (ControlFlow 0 10) 6) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct)))))))
(let ((anon7_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#21| null $Heap@@0 alloc this@@0)) (and (=> (= (ControlFlow 0 12) 1) anon7_Then_correct) (=> (= (ControlFlow 0 12) 10) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass._module.ArrayTests) ($IsAlloc refType this@@0 Tclass._module.ArrayTests $Heap@@0))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 13) 12))) anon0_correct))))
