...
(declare-fun |a0#0_0@2| () Bool)
(declare-fun |a0#0_0@1| () Bool)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon9_correct  (=> (and (= |a0#0_0@2|  (and |a0#0_0@1| (< 0 |y#0@0|))) (= |y#0@1| (+ |y#0@0| 1))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |$decr$loop#00@1|) (= (- 0 |y#0@1|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 0 |y#0@1|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< (- 0 |y#0@1|) |$decr$loop#00@1|)))))))
(let ((anon14_Else_correct  (=> (and (not |a0#0_0@1|) (= (ControlFlow 0 8) 5)) anon9_correct)))
(let ((anon14_Then_correct  (=> (and |a0#0_0@1| (= (ControlFlow 0 7) 5)) anon9_correct)))
(let ((anon13_Else_correct  (=> (< |y#0@0| 0) (=> (and (= |$decr$loop#00@1| (- 0 |y#0@0|)) |a0#0_0@1|) (and (=> (= (ControlFlow 0 9) (- 0 10)) |a0#0_0@1|) (=> |a0#0_0@1| (and (=> (= (ControlFlow 0 9) 7) anon14_Then_correct) (=> (= (ControlFlow 0 9) 8) anon14_Else_correct))))))))
(let ((anon13_Then_correct true))
(let ((anon12_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 11) 3) anon13_Then_correct) (=> (= (ControlFlow 0 11) 9) anon13_Else_correct)))))
...
(let ((anon11_LoopHead_correct  (=> (not false) (=> (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |AssumptionVariables1dfy.27:3|
 :skolemid |485|
...
)) (<= (- 0 |y#0@0|) |$decr_init$loop#00@0|))) (and (=> (= (ControlFlow 0 13) 1) anon11_LoopDone_correct) (=> (= (ControlFlow 0 13) 12) anon11_LoopBody_correct))))))
(let ((anon2_correct  (=> (= |a0#0@1|  (and |a0#0@0| (< 0 |x#0|))) (=> (and (= |$decr_init$loop#00@0| (- 0 |x#0|)) (= (ControlFlow 0 14) 13)) anon11_LoopHead_correct))))
(let ((anon10_Else_correct  (=> (and (not |a0#0@0|) (= (ControlFlow 0 16) 14)) anon2_correct)))
(let ((anon10_Then_correct  (=> (and |a0#0@0| (= (ControlFlow 0 15) 14)) anon2_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) |a0#0@0|) (and (=> (= (ControlFlow 0 17) (- 0 18)) |a0#0@0|) (=> |a0#0@0| (and (=> (= (ControlFlow 0 17) 15) anon10_Then_correct) (=> (= (ControlFlow 0 17) 16) anon10_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 19) 17))) anon0_correct)))
