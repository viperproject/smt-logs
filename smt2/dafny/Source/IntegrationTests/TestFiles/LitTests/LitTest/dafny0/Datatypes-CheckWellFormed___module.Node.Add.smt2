...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$_module.Node.Add)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (and ($IsAllocBox ($Box refType this@@2) Tclass._module.Node? $Heap@@1) ($IsAlloc DatatypeTypeType |L#0| (Tclass._module.List TInt) $Heap@@1)) (and (|_module.Node.Repr#canCall| $Heap@@1 this@@2 |L#0|) (_module.Node.Repr ($LS $LZ) $Heap@@1 this@@2 |L#0|))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7)))
 :qid |Datatypesdfy.27:10|
 :skolemid |2586|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (and ($Is refType |r#0@0| Tclass._module.Node) ($IsAlloc refType |r#0@0| Tclass._module.Node $Heap@0)) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= |r#0@0| null)) (not true)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Node) ($IsAlloc refType this@@2 Tclass._module.Node $Heap@@1)))) (=> (and (and (and ($Is DatatypeTypeType |L#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |L#0| (Tclass._module.List TInt) $Heap@@1)) (|$IsA#_module.List| |L#0|)) (and (and ($Is refType |r#0| Tclass._module.Node) ($IsAlloc refType |r#0| Tclass._module.Node $Heap@@1)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct))))
