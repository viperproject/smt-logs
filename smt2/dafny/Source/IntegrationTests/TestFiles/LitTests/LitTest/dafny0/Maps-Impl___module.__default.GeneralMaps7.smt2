...
(declare-fun |lambda#81| (T@U Int Int Int) T@U)
...
(declare-fun |lambda#82| () T@U)
(declare-fun |map$project$14#0#i#0| (Int) Int)
...
(assert (forall ((|l#0| T@U) (|l#1| Int) (|l#2| Int) (|l#3| Int) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#81| |l#0| |l#1| |l#2| |l#3|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (exists ((|a#0#0#0| Int) ) (!  (and (and (and (<= |l#1| |a#0#0#0|) (< |a#0#0#0| |l#2|)) (_module.__default.Thirteen |a#0#0#0|)) (= (U_2_int ($Unbox intType |$w#0|)) |l#3|))
 :qid |Mapsdfy.278:17|
 :skolemid |723|
))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |946|
 :pattern ( (MapType0Select BoxType boolType (|lambda#81| |l#0| |l#1| |l#2| |l#3|) |$w#0|))
)))
...
(assert (forall ((|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType |lambda#82| |$w#0@@0|) ($Box intType (int_2_U (|map$project$14#0#i#0| (U_2_int ($Unbox intType |$w#0@@0|))))))
 :qid |Mapsdfy.278:13|
 :skolemid |947|
 :pattern ( (MapType0Select BoxType BoxType |lambda#82| |$w#0@@0|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.GeneralMaps7)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 19) (let ((anon11_correct  (=> (and (forall ((|i#1| Int) ) (!  (and (=> (and (<= (LitInt 0) |i#1|) (< |i#1| 100)) (|_module.__default.Thirteen#canCall| |i#1|)) (forall ((|a#1#0#0@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) |a#1#0#0@@0|) (< |a#1#0#0@@0| 100)) (_module.__default.Thirteen |a#1#0#0@@0|)) (and (and (and (<= (LitInt 0) (|map$project$14#0#i#0| (LitInt 5))) (< (|map$project$14#0#i#0| (LitInt 5)) 100)) (_module.__default.Thirteen (|map$project$14#0#i#0| (LitInt 5)))) (= (LitInt 5) (LitInt 5))))
 :qid |Mapsdfy.278:17|
 :skolemid |724|
 :pattern ( (_module.__default.Thirteen |a#1#0#0@@0|))
)))
 :qid |Mapsdfy.278:17|
 :skolemid |725|
 :pattern ( (_module.__default.Thirteen |i#1|))
)) (= |c3#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#81| TInt (LitInt 0) 100 (LitInt 5))) |lambda#82| (TMap TInt TInt)))) (=> (and (and (= |##x#1@0| (LitInt 13)) ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap)) (and (|_module.__default.Thirteen#canCall| (LitInt 13)) (|_module.__default.Thirteen#canCall| (LitInt 13)))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|_module.__default.Thirteen#canCall| (LitInt 13)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.Thirteen (LitInt 13))))) (= (LitInt 13) (LitInt 13))))) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.Thirteen (LitInt 13))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| |c3#0@0|) ($Box intType (int_2_U (LitInt 5))))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |c3#0@0|) ($Box intType (int_2_U (LitInt 5)))))) (LitInt 13))))))))))
(let ((anon17_Else_correct  (=> (and (not (and (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (_module.__default.Thirteen |i#0@0|)) (and (and (<= (LitInt 0) |i#prime#0@0|) (< |i#prime#0@0| 100)) (_module.__default.Thirteen |i#prime#0@0|)))) (= (ControlFlow 0 8) 3)) anon11_correct)))
(let ((anon17_Then_correct  (=> (and (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (_module.__default.Thirteen |i#0@0|)) (and (and (<= (LitInt 0) |i#prime#0@0|) (< |i#prime#0@0| 100)) (_module.__default.Thirteen |i#prime#0@0|))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (or (not (= (LitInt 5) (LitInt 5))) (not true)) (= |i#0@0| |i#prime#0@0|))) (=> (or (or (not (= (LitInt 5) (LitInt 5))) (not true)) (= |i#0@0| |i#prime#0@0|)) (=> (= (ControlFlow 0 6) 3) anon11_correct))))))
(let ((anon16_Else_correct  (=> (not (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (_module.__default.Thirteen |i#0@0|))) (and (=> (= (ControlFlow 0 10) 6) anon17_Then_correct) (=> (= (ControlFlow 0 10) 8) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (_module.__default.Thirteen |i#0@0|)) (and (=> (= (ControlFlow 0 9) 6) anon17_Then_correct) (=> (= (ControlFlow 0 9) 8) anon17_Else_correct)))))
(let ((anon15_Else_correct  (=> (not (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (_module.__default.Thirteen |i#0@0|))) (and (=> (= (ControlFlow 0 12) 9) anon16_Then_correct) (=> (= (ControlFlow 0 12) 10) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (_module.__default.Thirteen |i#0@0|)) (and (=> (= (ControlFlow 0 11) 9) anon16_Then_correct) (=> (= (ControlFlow 0 11) 10) anon16_Else_correct)))))
(let ((anon14_Else_correct  (=> (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100))) (and (=> (= (ControlFlow 0 14) 11) anon15_Then_correct) (=> (= (ControlFlow 0 14) 12) anon15_Else_correct)))))
(let ((anon14_Then_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (and ($IsAlloc intType (int_2_U |i#0@0|) TInt $Heap) (|_module.__default.Thirteen#canCall| |i#0@0|))) (and (=> (= (ControlFlow 0 13) 11) anon15_Then_correct) (=> (= (ControlFlow 0 13) 12) anon15_Else_correct)))))
(let ((anon13_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 16) 13) anon14_Then_correct) (=> (= (ControlFlow 0 16) 14) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 15) 13) anon14_Then_correct) (=> (= (ControlFlow 0 15) 14) anon14_Else_correct)))))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 17) 15) anon13_Then_correct) (=> (= (ControlFlow 0 17) 16) anon13_Else_correct))))
(let ((anon12_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 18) 17) anon12_Then_correct) (=> (= (ControlFlow 0 18) 1) anon12_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |c3#0| (TMap TInt TInt)) ($IsAlloc MapType |c3#0| (TMap TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 19) 18))) anon0_correct))))
