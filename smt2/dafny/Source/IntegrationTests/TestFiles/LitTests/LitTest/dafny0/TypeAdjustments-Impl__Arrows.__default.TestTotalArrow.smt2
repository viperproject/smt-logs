...
(set-info :boogie-vc-id Impl$$Arrows.__default.TestTotalArrow)
...
(let ((anon9_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 9) 7) anon10_Then_correct) (=> (= (ControlFlow 0 9) 8) anon10_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 5) (- 0 4))) false)))
(let ((anon13_Then_correct true))
(let ((anon12_Then_correct true))
(let ((anon11_Then_correct true))
(let ((anon9_Else_correct  (=> (= |k#0@1| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle0 (|lambda#1| ($Box intType (int_2_U (LitInt 3)))) (|lambda#2| true) (|lambda#4| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ)))) (=> (and ($Is HandleTypeType |k#0@2| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |k#0@2| (Tclass._System.___hTotalFunc0 TInt) $Heap)) (and (and (and (=> (= (ControlFlow 0 6) 1) anon11_Then_correct) (=> (= (ControlFlow 0 6) 2) anon12_Then_correct)) (=> (= (ControlFlow 0 6) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon13_Else_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is HandleTypeType |k#0@0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |k#0@0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) (and (=> (= (ControlFlow 0 10) 9) anon9_Then_correct) (=> (= (ControlFlow 0 10) 6) anon9_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hFunc0 TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hFunc0 TInt) $Heap))) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hPartialFunc0 TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hPartialFunc0 TInt) $Heap)) (and ($Is HandleTypeType |h#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |h#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)))) (and (and (and ($Is HandleTypeType |k#0| (Tclass._System.___hTotalFunc0 TInt)) ($IsAlloc HandleTypeType |k#0| (Tclass._System.___hTotalFunc0 TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct)))
