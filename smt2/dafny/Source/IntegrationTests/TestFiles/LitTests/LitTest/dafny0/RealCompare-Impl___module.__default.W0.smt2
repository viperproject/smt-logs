...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (< |i#0@1| |N#0|) (=> (and (= |$decr$loop#00@1| (- |N#0| |i#0@1|)) (= |i#0@2| (+ |i#0@1| 1.0))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0.0 |$decr$loop#00@1|) (= (- |N#0| |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0.0 |$decr$loop#00@1|) (= (- |N#0| |i#0@2|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 5) (- 0 4)) (<= (- |N#0| |i#0@2|) (- |$decr$loop#00@1| 1.0)))))))))
...
(let ((anon6_LoopHead_correct  (=> (and (not false) (<= 0.0 |i#0@1|)) (=> (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |RealComparedfy.56:3|
 :skolemid |508|
...
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |i#0@0| (LitReal 0.0))) (and (= |$decr_init$loop#00@0| (- |N#0| |i#0@0|)) (= (ControlFlow 0 10) 9))) anon6_LoopHead_correct)))
