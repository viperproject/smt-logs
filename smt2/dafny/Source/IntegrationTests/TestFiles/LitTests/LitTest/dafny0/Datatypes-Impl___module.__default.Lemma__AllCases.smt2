...
(set-info :boogie-vc-id Impl$$_module.__default.Lemma__AllCases)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (_module.XList.XNil_q |d#0|) (_module.XList.XCons_q |d#0|)))))
(let ((anon5_Then_correct  (=> (= |d#0| (|#_module.XList.XCons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass._module.XList) (= (ControlFlow 0 5) 3)) GeneratedUnifiedExit_correct))))
(let ((anon4_Then_correct  (=> (and (= |d#0| |#_module.XList.XNil|) (= (ControlFlow 0 4) 3)) GeneratedUnifiedExit_correct)))
(let ((anon5_Else_correct true))
(let ((anon4_Else_correct  (=> (or (not (= |d#0| |#_module.XList.XNil|)) (not true)) (and (=> (= (ControlFlow 0 6) 5) anon5_Then_correct) (=> (= (ControlFlow 0 6) 1) anon5_Else_correct)))))
