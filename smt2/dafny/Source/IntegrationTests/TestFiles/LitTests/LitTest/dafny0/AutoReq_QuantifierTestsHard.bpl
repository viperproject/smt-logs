...
axiom {:id "id44"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QuantifierTestsHard.__default.byte#canCall(x#0)
         || (0 < $FunctionContextHeight && LitInt(0) <= x#0 && x#0 < 256)
...
axiom {:id "id45"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    QuantifierTestsHard.__default.byte#canCall(LitInt(x#0))
         || (0 < $FunctionContextHeight && LitInt(0) <= LitInt(x#0) && x#0 < 256)
...
procedure {:verboseName "QuantifierTestsHard.byte (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.byte(x#0: int);
...
axiom {:id "id48"} 1 <= $FunctionContextHeight
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsHard.__default.f__forall#canCall(s#0)
         || (1 < $FunctionContextHeight && $Is(s#0, TSeq(TInt)))
       ==> (forall i#0: int :: 
          { $Unbox(Seq#Index(s#0, i#0)): int } 
          (LitInt(0) <= i#0 && i#0 < Seq#Length(s#0)
             ==> LitInt(0) <= $Unbox(Seq#Index(s#0, i#0)): int
               && $Unbox(Seq#Index(s#0, i#0)): int < 256)
             ==> 
            LitInt(0) <= i#0
             ==> 
            i#0 < Seq#Length(s#0)
             ==> QuantifierTestsHard.__default.byte#canCall($Unbox(Seq#Index(s#0, i#0)): int))
         && QuantifierTestsHard.__default.f__forall(s#0)
           == (forall i#0: int :: 
            { $Unbox(Seq#Index(s#0, i#0)): int } 
            (LitInt(0) <= i#0 && i#0 < Seq#Length(s#0)
                 ==> LitInt(0) <= $Unbox(Seq#Index(s#0, i#0)): int
                   && $Unbox(Seq#Index(s#0, i#0)): int < 256)
               && (LitInt(0) <= i#0 && i#0 < Seq#Length(s#0)
                 ==> QuantifierTestsHard.__default.byte($Unbox(Seq#Index(s#0, i#0)): int))));
    ...
    QuantifierTestsHard.__default.f__forall#canCall(Lit(s#0))
       ...
       ==> (forall i#1: int :: 
          ...
          (LitInt(0) <= i#1 && i#1 < Seq#Length(Lit(s#0))
             ==> LitInt(0) <= $Unbox(Seq#Index(Lit(s#0), i#1)): int
               && $Unbox(Seq#Index(Lit(s#0), i#1)): int < 256)
             ==> 
            LitInt(0) <= i#1
             ==> 
            i#1 < Seq#Length(Lit(s#0))
             ==> QuantifierTestsHard.__default.byte#canCall($Unbox(Seq#Index(Lit(s#0), i#1)): int))
           ...
           == (forall i#1: int :: 
            ...
            (LitInt(0) <= i#1 && i#1 < Seq#Length(Lit(s#0))
                 ==> LitInt(0) <= $Unbox(Seq#Index(Lit(s#0), i#1)): int
                   && $Unbox(Seq#Index(Lit(s#0), i#1)): int < 256)
               && (LitInt(0) <= i#1 && i#1 < Seq#Length(Lit(s#0))
                 ==> QuantifierTestsHard.__default.byte($Unbox(Seq#Index(Lit(s#0), i#1)): int))));
}
...
procedure {:verboseName "QuantifierTestsHard.f_forall (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.f__forall(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsHard.f_forall (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.f__forall(s#0: Seq)
{
  ...
  var ##x#0: int;
    ...
    else
    {
        ...
        if (true)
        {
            ...
            {
                assert {:id "id50"} 0 <= i#2 && i#2 < Seq#Length(s#0);
                if (LitInt(0) <= $Unbox(Seq#Index(s#0, i#2)): int)
                {
                    assert {:id "id51"} 0 <= i#2 && i#2 < Seq#Length(s#0);
                }
            }

            if (LitInt(0) <= i#2 && i#2 < Seq#Length(s#0)
               ==> LitInt(0) <= $Unbox(Seq#Index(s#0, i#2)): int
                 && $Unbox(Seq#Index(s#0, i#2)): int < 256)
            {
                if (LitInt(0) <= i#2)
                {
                }
                ...
                if (LitInt(0) <= i#2 && i#2 < Seq#Length(s#0))
                {
                    assert {:id "id52"} 0 <= i#2 && i#2 < Seq#Length(s#0);
                    ##x#0 := $Unbox(Seq#Index(s#0, i#2)): int;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##x#0, TInt, $Heap);
                    assert {:id "id53"} {:subsumption 0} LitInt(0) <= ##x#0;
                    assert {:id "id54"} {:subsumption 0} ##x#0 < 256;
                    assume LitInt(0) <= ##x#0 && ##x#0 < 256;
                    assume QuantifierTestsHard.__default.byte#canCall($Unbox(Seq#Index(s#0, i#2)): int);
                }
            }
        }

        // End Comprehension WF check
        assume {:id "id55"} QuantifierTestsHard.__default.f__forall(s#0)
           == (forall i#3: int :: 
            { $Unbox(Seq#Index(s#0, i#3)): int } 
            (LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
                 ==> LitInt(0) <= $Unbox(Seq#Index(s#0, i#3)): int
                   && $Unbox(Seq#Index(s#0, i#3)): int < 256)
               && (LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
                 ==> QuantifierTestsHard.__default.byte($Unbox(Seq#Index(s#0, i#3)): int)));
        assume (forall i#3: int :: 
          ...
          (LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
             ...
             ==> 
            LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
             ==> QuantifierTestsHard.__default.byte#canCall($Unbox(Seq#Index(s#0, i#3)): int));
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsHard.__default.f__forall(s#0), TBool);
        return;
...
axiom {:id "id56"} 1 <= $FunctionContextHeight
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsHard.__default.f__exists#canCall(s#0)
         || (1 < $FunctionContextHeight && $Is(s#0, TSeq(TInt)))
       ==> (forall i#0: int :: 
          { $Unbox(Seq#Index(s#0, i#0)): int } 
          (LitInt(0) <= i#0 && i#0 < Seq#Length(s#0)
...
procedure {:verboseName "QuantifierTestsHard.f_exists (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.f__exists(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsHard.f_exists (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.f__exists(s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var i#2: int;
  var ##x#0: int;
    ...
    else
    {
        ...
        if (true)
        {
            ...
            if (LitInt(0) <= i#2 && i#2 < Seq#Length(s#0))
            {
                ...
                if (LitInt(0) <= $Unbox(Seq#Index(s#0, i#2)): int)
                {
                    assert {:id "id59"} 0 <= i#2 && i#2 < Seq#Length(s#0);
                }
            }
                 ...
                 && $Unbox(Seq#Index(s#0, i#2)): int < 256)
            {
                ...
                if (LitInt(0) <= i#2 && i#2 < Seq#Length(s#0))
                {
                    assert {:id "id60"} 0 <= i#2 && i#2 < Seq#Length(s#0);
                    ##x#0 := $Unbox(Seq#Index(s#0, i#2)): int;
                    // assume allocatedness for argument to function
                    assume $IsAlloc(##x#0, TInt, $Heap);
                    assert {:id "id61"} {:subsumption 0} LitInt(0) <= ##x#0;
                    assert {:id "id62"} {:subsumption 0} ##x#0 < 256;
                    assume LitInt(0) <= ##x#0 && ##x#0 < 256;
                    assume QuantifierTestsHard.__default.byte#canCall($Unbox(Seq#Index(s#0, i#2)): int);
                }
            }
        ...
        // End Comprehension WF check
        assume {:id "id63"} QuantifierTestsHard.__default.f__exists(s#0)
           == (exists i#3: int :: 
            { $Unbox(Seq#Index(s#0, i#3)): int } 
            (LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
                 ==> LitInt(0) <= $Unbox(Seq#Index(s#0, i#3)): int
        ...
        assume (forall i#3: int :: 
          ...
          (LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
            ...
            LitInt(0) <= i#3 && i#3 < Seq#Length(s#0)
             ==> QuantifierTestsHard.__default.byte#canCall($Unbox(Seq#Index(s#0, i#3)): int));
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsHard.__default.f__exists(s#0), TBool);
        return;
   ...
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsHard.__default.g__forall#canCall(s#0)
         || (1 < $FunctionContextHeight
          ...
          $Is(s#0, TSeq(TInt))
           && (forall j#1: int :: 
            { $Unbox(Seq#Index(s#0, j#1)): int } 
            (LitInt(0) <= j#1 && j#1 < Seq#Length(s#0)
                 ==> LitInt(0) <= $Unbox(Seq#Index(s#0, j#1)): int
                   && $Unbox(Seq#Index(s#0, j#1)): int < 256)
               && (LitInt(0) <= j#1 && j#1 < Seq#Length(s#0)
                 ==> QuantifierTestsHard.__default.byte($Unbox(Seq#Index(s#0, j#1)): int))))
   ...
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsHard.__default.g__forall#canCall(Lit(s#0))
         || (1 < $FunctionContextHeight
          ...
          $Is(s#0, TSeq(TInt))
           && (forall j#2: int :: 
            { $Unbox(Seq#Index(s#0, j#2)): int } 
            (LitInt(0) <= j#2 && j#2 < Seq#Length(Lit(s#0))
                 ==> LitInt(0) <= $Unbox(Seq#Index(Lit(s#0), j#2)): int
                   && $Unbox(Seq#Index(Lit(s#0), j#2)): int < 256)
               && (LitInt(0) <= j#2 && j#2 < Seq#Length(Lit(s#0))
                 ==> QuantifierTestsHard.__default.byte($Unbox(Seq#Index(Lit(s#0), j#2)): int))))
...
procedure {:verboseName "QuantifierTestsHard.g_forall (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.g__forall(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsHard.g_forall (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.g__forall(s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var j#3: int;
  var ##x#0: int;
    ...
    if (*)
    {
        ...
        assume {:id "id66"} LitInt(0) <= j#3 && j#3 < Seq#Length(s#0);
        assert {:id "id67"} 0 <= j#3 && j#3 < Seq#Length(s#0);
        if (LitInt(0) <= $Unbox(Seq#Index(s#0, j#3)): int)
        {
            assert {:id "id68"} 0 <= j#3 && j#3 < Seq#Length(s#0);
        }

        assume {:id "id69"} LitInt(0) <= $Unbox(Seq#Index(s#0, j#3)): int
           && $Unbox(Seq#Index(s#0, j#3)): int < 256;
    }
    else
    {
        assume {:id "id70"} LitInt(0) <= j#3 && j#3 < Seq#Length(s#0)
           ==> LitInt(0) <= $Unbox(Seq#Index(s#0, j#3)): int
             && $Unbox(Seq#Index(s#0, j#3)): int < 256;
    }
    ...
    if (*)
    {
        ...
        assume {:id "id71"} LitInt(0) <= j#3 && j#3 < Seq#Length(s#0);
        assert {:id "id72"} 0 <= j#3 && j#3 < Seq#Length(s#0);
        ##x#0 := $Unbox(Seq#Index(s#0, j#3)): int;
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assert {:id "id73"} {:subsumption 0} LitInt(0) <= ##x#0;
        assert {:id "id74"} {:subsumption 0} ##x#0 < 256;
        assume LitInt(0) <= ##x#0 && ##x#0 < 256;
        assume QuantifierTestsHard.__default.byte#canCall($Unbox(Seq#Index(s#0, j#3)): int);
        assume {:id "id75"} QuantifierTestsHard.__default.byte($Unbox(Seq#Index(s#0, j#3)): int);
    }
    else
    {
        assume {:id "id76"} LitInt(0) <= j#3 && j#3 < Seq#Length(s#0)
           ==> QuantifierTestsHard.__default.byte($Unbox(Seq#Index(s#0, j#3)): int);
    }

    assume {:id "id77"} (forall j#0: int :: 
      { $Unbox(Seq#Index(s#0, j#0)): int } 
      (LitInt(0) <= j#0 && j#0 < Seq#Length(s#0)
           ==> LitInt(0) <= $Unbox(Seq#Index(s#0, j#0)): int
             && $Unbox(Seq#Index(s#0, j#0)): int < 256)
         && (LitInt(0) <= j#0 && j#0 < Seq#Length(s#0)
           ==> QuantifierTestsHard.__default.byte($Unbox(Seq#Index(s#0, j#0)): int)));
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id78"} QuantifierTestsHard.__default.g__forall(s#0) == (Seq#Length(s#0) > 2);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsHard.__default.g__forall(s#0), TBool);
        return;
...
axiom {:id "id79"} 2 <= $FunctionContextHeight
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsHard.__default.h__forall#canCall(s#0)
         || (2 < $FunctionContextHeight && $Is(s#0, TSeq(TInt)))
       ==> QuantifierTestsHard.__default.f__forall#canCall(s#0)
         && QuantifierTestsHard.__default.h__forall(s#0)
           == QuantifierTestsHard.__default.f__forall(s#0));
...
procedure {:verboseName "QuantifierTestsHard.h_forall (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.h__forall(s#0: Seq where $Is(s#0, TSeq(TInt)));
...
procedure {:verboseName "QuantifierTestsHard.h (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.h(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsHard.h (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.h(s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var j#3: int;
  var ##x#0: int;
  var ##s#0: Seq;
    ...
    if (true)
    {
        ...
        if (LitInt(0) <= j#3 && j#3 < Seq#Length(s#0))
        {
            assert {:id "id84"} 0 <= j#3 && j#3 < Seq#Length(s#0);
            if (LitInt(0) <= $Unbox(Seq#Index(s#0, j#3)): int)
            {
                assert {:id "id85"} 0 <= j#3 && j#3 < Seq#Length(s#0);
            }
        }
             ...
             && $Unbox(Seq#Index(s#0, j#3)): int < 256)
        {
            ...
            if (LitInt(0) <= j#3 && j#3 < Seq#Length(s#0))
            {
                assert {:id "id86"} 0 <= j#3 && j#3 < Seq#Length(s#0);
                ##x#0 := $Unbox(Seq#Index(s#0, j#3)): int;
                // assume allocatedness for argument to function
                assume $IsAlloc(##x#0, TInt, $Heap);
                assert {:id "id87"} {:subsumption 0} LitInt(0) <= ##x#0;
                assert {:id "id88"} {:subsumption 0} ##x#0 < 256;
                assume LitInt(0) <= ##x#0 && ##x#0 < 256;
                assume QuantifierTestsHard.__default.byte#canCall($Unbox(Seq#Index(s#0, j#3)): int);
            }
        }
    ...
    else
    {
        ...
        assert {:id "id90"} {:subsumption 0} (forall j#4: int :: 
        ...
        assume (forall j#4: int :: 
          ...
          (LitInt(0) <= j#4 && j#4 < Seq#Length(##s#0)
             ...
             && (LitInt(0) <= j#4 && j#4 < Seq#Length(##s#0)
               ==> QuantifierTestsHard.__default.byte($Unbox(Seq#Index(##s#0, j#4)): int)));
        assume QuantifierTestsHard.__default.g__forall#canCall(s#0);
        assume {:id "id91"} QuantifierTestsHard.__default.h(s#0)
           == QuantifierTestsHard.__default.g__forall(s#0);
        assume QuantifierTestsHard.__default.g__forall#canCall(s#0);
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsHard.__default.h(s#0), TBool);
        return;
   ...
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsHard.__default.i#canCall(s#0)
         || (0 < $FunctionContextHeight
          ...
          $Is(s#0, TSeq(TInt))
           && (forall k#1: int :: 
            { $Unbox(Seq#Index(s#0, k#1)): int } 
            (LitInt(0) <= k#1 && k#1 < Seq#Length(s#0)
                 ==> LitInt(0) <= $Unbox(Seq#Index(s#0, k#1)): int)
               && (LitInt(0) <= k#1 && k#1 < Seq#Length(s#0)
                 ==> $Unbox(Seq#Index(s#0, k#1)): int < 5)))
   ...
   ==> (forall s#0: Seq :: 
    ...
    QuantifierTestsHard.__default.i#canCall(Lit(s#0))
         || (0 < $FunctionContextHeight
          ...
          $Is(s#0, TSeq(TInt))
           && (forall k#2: int :: 
            { $Unbox(Seq#Index(s#0, k#2)): int } 
            (LitInt(0) <= k#2 && k#2 < Seq#Length(Lit(s#0))
                 ==> LitInt(0) <= $Unbox(Seq#Index(Lit(s#0), k#2)): int)
               && (LitInt(0) <= k#2 && k#2 < Seq#Length(Lit(s#0))
                 ==> $Unbox(Seq#Index(Lit(s#0), k#2)): int < 5)))
...
procedure {:verboseName "QuantifierTestsHard.i (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.i(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsHard.i (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.i(s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var k#3: int;
    ...
    if (*)
    {
        ...
        assume {:id "id94"} LitInt(0) <= k#3 && k#3 < Seq#Length(s#0);
        assert {:id "id95"} 0 <= k#3 && k#3 < Seq#Length(s#0);
        if (LitInt(0) <= $Unbox(Seq#Index(s#0, k#3)): int)
        {
            assert {:id "id96"} 0 <= k#3 && k#3 < Seq#Length(s#0);
        }

        assume {:id "id97"} LitInt(0) <= $Unbox(Seq#Index(s#0, k#3)): int
           && $Unbox(Seq#Index(s#0, k#3)): int < 5;
    }
    else
    {
        assume {:id "id98"} LitInt(0) <= k#3 && k#3 < Seq#Length(s#0)
           ==> LitInt(0) <= $Unbox(Seq#Index(s#0, k#3)): int
             && $Unbox(Seq#Index(s#0, k#3)): int < 5;
    }

    assume {:id "id99"} (forall k#0: int :: 
      { $Unbox(Seq#Index(s#0, k#0)): int } 
      (LitInt(0) <= k#0 && k#0 < Seq#Length(s#0)
           ==> LitInt(0) <= $Unbox(Seq#Index(s#0, k#0)): int)
         && (LitInt(0) <= k#0 && k#0 < Seq#Length(s#0)
           ==> $Unbox(Seq#Index(s#0, k#0)): int < 5));
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    {
        // Check well-formedness of body and result subset type constraint
        assume {:id "id100"} QuantifierTestsHard.__default.i(s#0) == Lit(true);
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsHard.__default.i(s#0), TBool);
        return;
...
axiom {:id "id101"} 1 <= $FunctionContextHeight
   ==> (forall s#0: Seq :: 
...
axiom {:id "id102"} 1 <= $FunctionContextHeight
   ==> (forall s#0: Seq :: 
...
procedure {:verboseName "QuantifierTestsHard.j (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.j(s#0: Seq where $Is(s#0, TSeq(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsHard.j (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.j(s#0: Seq)
{
  var $_ReadsFrame: [ref,Field]bool;
  var k#3: int;
  var ##s#0: Seq;
    ...
    if (true)
    {
        ...
        if (LitInt(0) <= k#3 && k#3 < Seq#Length(s#0))
        {
            assert {:id "id103"} 0 <= k#3 && k#3 < Seq#Length(s#0);
            if (LitInt(0) <= $Unbox(Seq#Index(s#0, k#3)): int)
            {
                assert {:id "id104"} 0 <= k#3 && k#3 < Seq#Length(s#0);
            }
        }
    }

    // End Comprehension WF check
    assume {:id "id105"} (forall k#0: int :: 
      { $Unbox(Seq#Index(s#0, k#0)): int } 
      (LitInt(0) <= k#0 && k#0 < Seq#Length(s#0)
           ==> LitInt(0) <= $Unbox(Seq#Index(s#0, k#0)): int)
         && (LitInt(0) <= k#0 && k#0 < Seq#Length(s#0)
    ...
    else
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##s#0, TSeq(TInt), $Heap);
        assert {:id "id106"} {:subsumption 0} (forall k#4: int :: 
        ...
        assume (forall k#4: int :: 
          ...
          (LitInt(0) <= k#4 && k#4 < Seq#Length(##s#0)
             ...
             && (LitInt(0) <= k#4 && k#4 < Seq#Length(##s#0)
               ==> $Unbox(Seq#Index(##s#0, k#4)): int < 5));
        assume QuantifierTestsHard.__default.i#canCall(s#0);
        assume {:id "id107"} QuantifierTestsHard.__default.j(s#0) == QuantifierTestsHard.__default.i(s#0);
        assume QuantifierTestsHard.__default.i#canCall(s#0);
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsHard.__default.j(s#0), TBool);
        return;
...
procedure {:verboseName "QuantifierTestsHard.m (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.m(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "QuantifierTestsHard.n (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.n(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "QuantifierTestsHard.f1 (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.f1(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
   ...
   ==> (forall x#0: int :: 
    ...
    QuantifierTestsHard.__default.variable__uniqueness__test#canCall(x#0)
         || (1 < $FunctionContextHeight
           && 
          ((forall y#2: int :: 
              { QuantifierTestsHard.__default.m(y#2) } 
              QuantifierTestsHard.__default.m(y#2))
             ==> x#0 > 3)
           && ((forall y#3: int :: 
              { QuantifierTestsHard.__default.m(y#3) } 
              QuantifierTestsHard.__default.m(y#3))
             ==> x#0 < 16))
       ==> (forall y#4: int :: 
          { QuantifierTestsHard.__default.m(y#4) } 
          QuantifierTestsHard.__default.m#canCall(y#4))
         && ((forall y#4: int :: 
            { QuantifierTestsHard.__default.m(y#4) } 
            QuantifierTestsHard.__default.m(y#4))
   ...
   ==> (forall x#0: int :: 
    ...
    QuantifierTestsHard.__default.variable__uniqueness__test#canCall(LitInt(x#0))
         || (1 < $FunctionContextHeight
           && 
          ((forall y#5: int :: 
              { QuantifierTestsHard.__default.m(y#5) } 
              QuantifierTestsHard.__default.m(y#5))
             ==> x#0 > 3)
           && ((forall y#6: int :: 
              { QuantifierTestsHard.__default.m(y#6) } 
              QuantifierTestsHard.__default.m(y#6))
             ==> x#0 < 16))
       ==> (forall y#7: int :: 
          { QuantifierTestsHard.__default.m(y#7) } 
          QuantifierTestsHard.__default.m#canCall(y#7))
         && ((forall y#7: int :: 
            { QuantifierTestsHard.__default.m(y#7) } 
            QuantifierTestsHard.__default.m(y#7))
...
procedure {:verboseName "QuantifierTestsHard.variable_uniqueness_test (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.variable__uniqueness__test(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "QuantifierTestsHard.variable_uniqueness_test (well-formedness)"} CheckWellformed$$QuantifierTestsHard.__default.variable__uniqueness__test(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var y#8: int;
  var ##x#0: int;
  ...
  var ##x#3: int;
    ...
    if (true)
    {
        ...
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#0, TInt, $Heap);
        assume QuantifierTestsHard.__default.m#canCall(y#8);
    }

    // End Comprehension WF check
    if ((forall y#0: int :: 
      { QuantifierTestsHard.__default.m(y#0) } 
      QuantifierTestsHard.__default.m(y#0)))
    {
    }

    assume {:id "id112"} (forall y#0: int :: 
        { QuantifierTestsHard.__default.m(y#0) } 
        QuantifierTestsHard.__default.m(y#0))
       ==> x#0 > 3;
    // Begin Comprehension WF check
    ...
    if (true)
    {
        ...
        assume QuantifierTestsHard.__default.m#canCall(y#9);
    }

    // End Comprehension WF check
    if ((forall y#1: int :: 
      { QuantifierTestsHard.__default.m(y#1) } 
      QuantifierTestsHard.__default.m(y#1)))
    {
    }

    assume {:id "id113"} (forall y#1: int :: 
        { QuantifierTestsHard.__default.m(y#1) } 
        QuantifierTestsHard.__default.m(y#1))
       ==> x#0 < 16;
    // Check well-formedness of the reads clause
    ...
    else
    {
        ...
        if (true)
        {
            ...
            assume QuantifierTestsHard.__default.m#canCall(y#10);
        }

        // End Comprehension WF check
        if ((forall y#11: int :: 
          { QuantifierTestsHard.__default.m(y#11) } 
          QuantifierTestsHard.__default.m(y#11)))
        {
            ##x#3 := x#0;
            // assume allocatedness for argument to function
            assume $IsAlloc(##x#3, TInt, $Heap);
            assert {:id "id114"} {:subsumption 0} ##x#3 > 3;
            assume ##x#3 > 3;
            assert {:id "id115"} {:subsumption 0} ##x#3 < 16;
            assume ##x#3 < 16;
            assume QuantifierTestsHard.__default.f1#canCall(x#0);
        }

        assume {:id "id116"} QuantifierTestsHard.__default.variable__uniqueness__test(x#0)
           == ((forall y#11: int :: 
              { QuantifierTestsHard.__default.m(y#11) } 
              QuantifierTestsHard.__default.m(y#11))
             && QuantifierTestsHard.__default.f1(x#0));
        assume (forall y#11: int :: 
            { QuantifierTestsHard.__default.m(y#11) } 
            QuantifierTestsHard.__default.m#canCall(y#11))
           && ((forall y#11: int :: 
              { QuantifierTestsHard.__default.m(y#11) } 
              QuantifierTestsHard.__default.m(y#11))
             ==> QuantifierTestsHard.__default.f1#canCall(x#0));
        // CheckWellformedWithResult: any expression
        assume $Is(QuantifierTestsHard.__default.variable__uniqueness__test(x#0), TBool);
        return;
