...
(set-info :boogie-vc-id Impl$$_module.__default.Theorem1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (and (forall ((|$ih#n0#0| Int) ) (!  (=> (and (<= (LitInt 1) |$ih#n0#0|) (and (<= 0 |$ih#n0#0|) (< |$ih#n0#0| |n#0@@3|))) (<= (LitInt 1) (_module.__default.Fib ($LS $LZ) |$ih#n0#0|)))
 :qid |LetExprdfy.130:16|
 :skolemid |2268|
 :pattern ( (_module.__default.Fib ($LS $LZ) |$ih#n0#0|))
)) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 1) (_module.__default.Fib ($LS ($LS $LZ)) |n#0@@3|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 1 $FunctionContextHeight)) (and (<= (LitInt 1) |n#0@@3|) (= (ControlFlow 0 3) 2))) anon0_correct)))
