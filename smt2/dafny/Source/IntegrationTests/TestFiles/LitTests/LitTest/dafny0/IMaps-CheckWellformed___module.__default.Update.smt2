...
(assert (forall ((a@@11 T@U) (b@@8 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@5 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType a@@11 bx@@5)) (and ($IsBox bx@@5 t0@@5) ($IsBox (MapType0Select BoxType BoxType b@@8 bx@@5) t1@@3)))
 :qid |DafnyPreludebpl.1585:11|
 :skolemid |318|
)) ($Is IMapType (|IMap#Glue| a@@11 b@@8 (TIMap t0@@5 t1@@3)) (TIMap t0@@5 t1@@3)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Update)
