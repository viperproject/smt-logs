...
(set-info :boogie-vc-id CheckWellFormed$$_module.A.L1)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType this Tclass._module.A $Heap)) (=> ($IsAlloc refType this Tclass._module.A $Heap) (=> (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@2 null)) (not true)) (=> (= $o@@2 this) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@2) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) $f@@0))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A previous$Heap)))) (=> (and (and (and ($Is refType |other#0| Tclass._module.A) ($IsAlloc refType |other#0| Tclass._module.A previous$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |other#0| Tclass._module.A previous$Heap) (= (ControlFlow 0 5) 3)))) anon0_correct))))
