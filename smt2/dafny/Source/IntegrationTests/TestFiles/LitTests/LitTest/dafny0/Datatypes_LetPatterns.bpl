...
procedure {:verboseName "LetPatterns.M (well-formedness)"} CheckWellformed$$LetPatterns.__default.M(m#0: DatatypeType where $Is(m#0, Tclass.LetPatterns.MyDt()));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "LetPatterns.M (well-formedness)"} CheckWellformed$$LetPatterns.__default.M(m#0: DatatypeType)
{
  ...
  var let#0#0#0: DatatypeType;
    ...
    assume {:id "id58"} LetPatterns.MyDt.AAA_q(m#0);
    ...
    else
    {
        ...
        havoc u#Z#0;
        assume {:id "id59"} let#0#0#0 == m#0;
        assume true;
        // CheckWellformedWithResult: any expression
        assume $Is(let#0#0#0, Tclass.LetPatterns.MyDt());
        assert {:id "id60"} LetPatterns.MyDt.AAA_q(let#0#0#0);
        assume {:id "id61"} #LetPatterns.MyDt.AAA(u#Z#0) == let#0#0#0;
        assume {:id "id62"} LetPatterns.__default.M(m#0) == u#Z#0;
        assume true;
        // CheckWellformedWithResult: any expression
...
procedure {:verboseName "LetPatterns.P (well-formedness)"} CheckWellFormed$$LetPatterns.__default.P();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "LetPatterns.P (call)"} Call$$LetPatterns.__default.P();
  modifies $Heap;
...
procedure {:verboseName "LetPatterns.P (correctness)"} Impl$$LetPatterns.__default.P() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "LetPatterns.P (correctness)"} Impl$$LetPatterns.__default.P() returns ($_reverifyPost: bool)
{
  ...
  var let#0#0#0: DatatypeType;
    ...
    havoc m#0 /* where $Is(m#0, Tclass.LetPatterns.MyDt())
       && $IsAlloc(m#0, Tclass.LetPatterns.MyDt(), $Heap) */;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Datatypes.dfy(377,11)
    assume true;
    havoc u#Z#0;
    assume {:id "id63"} let#0#0#0 == m#0;
    assume true;
    // CheckWellformedWithResult: any expression
    assume $Is(let#0#0#0, Tclass.LetPatterns.MyDt());
    assert {:id "id64"} LetPatterns.MyDt.AAA_q(let#0#0#0);
    assume {:id "id65"} #LetPatterns.MyDt.AAA(u#Z#0) == let#0#0#0;
    assume true;
