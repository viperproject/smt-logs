...
(assert (forall ((d@@5 T@U) ($h@@0 T@U) ) (!  (=> (and ($IsGoodHeap $h@@0) (and (_module.Tree.Node_q d@@5) ($IsAlloc DatatypeTypeType d@@5 Tclass._module.Tree $h@@0))) ($IsAlloc DatatypeTypeType (_module.Tree.left d@@5) Tclass._module.Tree $h@@0))
 :qid |unknown.0:0|
 :skolemid |559|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Tree.left d@@5) Tclass._module.Tree $h@@0))
)))
(assert (forall ((d@@6 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Tree.Node_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.Tree $h@@1))) ($IsAlloc DatatypeTypeType (_module.Tree.right d@@6) Tclass._module.Tree $h@@1))
 :qid |unknown.0:0|
 :skolemid |560|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Tree.right d@@6) Tclass._module.Tree $h@@1))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Tree.Elements)
...
(let ((anon10_Then_correct  (=> (and (= this@@3 (|#_module.Tree.Node| |_mcc#0#0| |_mcc#1#0|)) ($Is DatatypeTypeType |_mcc#0#0| Tclass._module.Tree)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#1#0| Tclass._module.Tree) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#0#0#0| Tclass._module.Tree) (= |right#Z#0@0| |let#0#0#0|))) (and (and (= |let#1#0#0| |_mcc#0#0|) ($Is DatatypeTypeType |let#1#0#0| Tclass._module.Tree)) (and (= |left#Z#0@0| |let#1#0#0|) ($IsAllocBox ($Box DatatypeTypeType |left#Z#0@0|) Tclass._module.Tree $Heap)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (DtRank |left#Z#0@0|) (DtRank this@@3))) (=> (< (DtRank |left#Z#0@0|) (DtRank this@@3)) (=> (|_module.Tree.Elements#canCall| |left#Z#0@0|) (=> (and ($IsAllocBox ($Box DatatypeTypeType |right#Z#0@0|) Tclass._module.Tree $Heap) (= (ControlFlow 0 4) (- 0 3))) (< (DtRank |right#Z#0@0|) (DtRank this@@3))))))))))
