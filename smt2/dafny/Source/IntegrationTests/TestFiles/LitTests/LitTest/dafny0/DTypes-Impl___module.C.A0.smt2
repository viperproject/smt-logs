...
(set-info :boogie-vc-id Impl$$_module.C.A0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (=> (= |a#0| |b#0|) (= |a#0| null)))))
(let ((anon3_Else_correct  (=> (and (or (not (= |a#0| |b#0|)) (not true)) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (= |a#0| |b#0|) (= (ControlFlow 0 3) 2)) anon2_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap)))) (=> (and (and (and (and ($Is refType |a#0| (Tclass._module.CP? TInt Tclass._module.C)) ($IsAlloc refType |a#0| (Tclass._module.CP? TInt Tclass._module.C) $Heap)) (and ($Is refType |b#0| (Tclass._module.CP? TInt Tclass._System.object)) ($IsAlloc refType |b#0| (Tclass._module.CP? TInt Tclass._System.object) $Heap))) (and (and ($Is refType |x#0| Tclass._System.object?) ($IsAlloc refType |x#0| Tclass._System.object? $Heap)) true)) (and (and (and ($Is refType |y#0| Tclass._System.object?) ($IsAlloc refType |y#0| Tclass._System.object? $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct))))
