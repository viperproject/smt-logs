...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (<= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U (LitInt 20)))))) (LitInt 0)) (< 0 (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U (LitInt 20)))))))))))
(let ((anon3_Else_correct  (=> (and (<= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U (LitInt 20)))))) (LitInt 0)) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (< (LitInt 0) (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U (LitInt 20))))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U (LitInt 20))))) (=> (= (ControlFlow 0 3) 2) anon2_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U (LitInt 20))))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |a#0| (TMap TInt TInt)) ($IsAlloc MapType |a#0| (TMap TInt TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U 20))) (= (ControlFlow 0 8) 6))) anon0_correct))))
