...
(set-info :boogie-vc-id Impl$$Ghost.__default.M1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon7_Else_correct  (=> (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 10) (- 0 9))) false)))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (Types.XY.G1_q |xy#0|) (Types.XY.D1_q |xy#0|))) (=> (or (Types.XY.G1_q |xy#0|) (Types.XY.D1_q |xy#0|)) (=> (= (ControlFlow 0 7) (- 0 6)) (not (Types.XY.G1_q |xy#0|)))))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (or (Types.XY.G0_q |xy#0|) (Types.XY.G1_q |xy#0|)) (Types.XY.D1_q |xy#0|))) (=> (or (or (Types.XY.G0_q |xy#0|) (Types.XY.G1_q |xy#0|)) (Types.XY.D1_q |xy#0|)) (=> (= (ControlFlow 0 4) (- 0 3)) (and (not (Types.XY.G0_q |xy#0|)) (not (Types.XY.G1_q |xy#0|))))))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (Types.XY.D0_q |xy#0|))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (=> (= (ControlFlow 0 11) 2) anon5_Then_correct) (=> (= (ControlFlow 0 11) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 11) 7) anon7_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |xy#0| Tclass.Types.XY) ($IsAlloc DatatypeTypeType |xy#0| Tclass.Types.XY $Heap)) (|$IsA#Types.XY| |xy#0|)) (= 0 $FunctionContextHeight)) (and (Types.XY.G1_q |xy#0|) (= (ControlFlow 0 12) 11))) anon0_correct))))
