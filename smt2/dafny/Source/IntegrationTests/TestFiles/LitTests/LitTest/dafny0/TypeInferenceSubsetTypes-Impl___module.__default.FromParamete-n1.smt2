...
(set-info :boogie-vc-id Impl$$_module.__default.FromParameter)
...
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |s#0@0| (LitInt 0))) (and (= |i#0#lo@0| (LitInt 0)) (= |i#0#hi@0| (LitInt 3)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (<= |i#0#lo@0| |i#0#hi@0|)) (=> (<= |i#0#lo@0| |i#0#hi@0|) (=> (= (ControlFlow 0 10) 9) anon7_LoopHead_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |cc#0| Tclass._module.Cell) ($IsAlloc refType |cc#0| Tclass._module.Cell $Heap))) (and (and (=> |defass#c#0| (and ($Is refType |c#0@@1| Tclass._module.Cell) ($IsAlloc refType |c#0@@1| Tclass._module.Cell $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 12) 10)))) anon0_correct)))
