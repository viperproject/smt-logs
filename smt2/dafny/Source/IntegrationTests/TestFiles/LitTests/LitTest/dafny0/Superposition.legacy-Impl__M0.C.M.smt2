...
(assert (distinct alloc Tagclass.M0.C? Tagclass.M0.C tytagFamily$C)
)
...
(set-info :boogie-vc-id Impl$$M0.C.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon6_correct  (=> (and (= |r#0@0| (LitInt 8)) (= (ControlFlow 0 2) (- 0 1))) (< |r#0@0| 100))))
(let ((anon5_correct  (=> (= (ControlFlow 0 5) 2) anon6_correct)))
(let ((anon8_Else_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (<= (LitInt 0) |y#0|)) (=> (<= (LitInt 0) |y#0|) (=> (= (ControlFlow 0 8) 5) anon5_correct)))))
(let ((anon8_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (<= (LitInt 0) |x#0|)) (=> (<= (LitInt 0) |x#0|) (=> (= (ControlFlow 0 6) 5) anon5_correct)))))
(let ((anon7_Else_correct  (=> (or (not (= |c#0@@1| null)) (not true)) (and (=> (= (ControlFlow 0 10) 6) anon8_Then_correct) (=> (= (ControlFlow 0 10) 8) anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (= |c#0@@1| null) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= |c#0@@1| null)) (=> (= |c#0@@1| null) (=> (= (ControlFlow 0 3) 2) anon6_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 11) 3) anon7_Then_correct) (=> (= (ControlFlow 0 11) 10) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.M0.C) ($IsAlloc refType this Tclass.M0.C $Heap))) (and ($Is refType |c#0@@1| Tclass.M0.C?) ($IsAlloc refType |c#0@@1| Tclass.M0.C? $Heap))) (and (and (= 0 $FunctionContextHeight) (<= (LitInt 0) |x#0|)) (and (<= (LitInt 0) |y#0|) (= (ControlFlow 0 12) 11)))) anon0_correct))))
