...
(declare-fun _module.SeqOp.XT5 (T@U Int) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.XT5#canCall| (T@U Int) Bool)
(declare-fun Tclass._module.SeqOp () T@U)
...
(declare-fun |lambda#344| (T@U Int Int) T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.XT5#canCall| this (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) (= (_module.SeqOp.XT5 this (LitInt |n#0|)) (|Seq#Create| TInt $Heap (LitInt |n#0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 10)))) (|lambda#344| TInt (LitInt 0) |n#0|) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.176:12|
 :weight 3
 :skolemid |718|
 :pattern ( (_module.SeqOp.XT5 this (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.XT5#canCall| this@@0 |n#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)))) ($Is SeqType (_module.SeqOp.XT5 this@@0 |n#0@@0|) (TSeq Tclass._System.nat)))
 :qid |ComprehensionsNewSyntaxdfy.176:12|
 :skolemid |715|
 :pattern ( (_module.SeqOp.XT5 this@@0 |n#0@@0|))
))))
...
(assert (forall ((|l#0| Bool) (|$l#1#o#0| T@U) ) (! (= (U_2_bool (MapType1Select refType boolType (|lambda#16| |l#0|) |$l#1#o#0|)) |l#0|)
 :qid |unknown.0:0|
 :skolemid |771|
 :pattern ( (MapType1Select refType boolType (|lambda#16| |l#0|) |$l#1#o#0|))
)))
(assert (forall ((|l#0@@0| T@U) (|$l#1#ly#0| T@U) ) (! (= (MapType1Select LayerTypeType HandleTypeType (|lambda#18| |l#0@@0|) |$l#1#ly#0|) |l#0@@0|)
 :qid |ComprehensionsNewSyntaxdfy.71:27|
 :skolemid |773|
 :pattern ( (MapType1Select LayerTypeType HandleTypeType (|lambda#18| |l#0@@0|) |$l#1#ly#0|))
)))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.XT5#canCall| (Lit refType this@@1) (LitInt |n#0@@1|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@1|)))) (= (_module.SeqOp.XT5 (Lit refType this@@1) (LitInt |n#0@@1|)) (|Seq#Create| TInt $Heap@@0 (LitInt |n#0@@1|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 10)))) (|lambda#344| TInt (LitInt 0) |n#0@@1|) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.176:12|
 :weight 3
 :skolemid |719|
 :pattern ( (_module.SeqOp.XT5 (Lit refType this@@1) (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((|l#0@@1| T@U) (|l#1| Int) (|l#2| Int) (|$l#0#heap#0| T@U) (|$l#0#i#0| T@U) ) (! (= (U_2_bool (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#344| |l#0@@1| |l#1| |l#2|) |$l#0#heap#0| |$l#0#i#0|))  (and ($IsBox |$l#0#i#0| |l#0@@1|) (and (<= |l#1| (U_2_int ($Unbox intType |$l#0#i#0|))) (< (U_2_int ($Unbox intType |$l#0#i#0|)) |l#2|))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |783|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType boolType (|lambda#344| |l#0@@1| |l#1| |l#2|) |$l#0#heap#0| |$l#0#i#0|))
)))
...
(assert (forall ((|l#0@@2| T@U) (|l#1@@0| T@U) (|l#2@@0| T@U) (|l#3| Bool) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@2| |l#1@@0| |l#2@@0| |l#3|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0@@2|)) (not true)) (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) |l#1@@0| $o@@3) |l#2@@0|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |759|
 :pattern ( (MapType0Select refType FieldType boolType (|lambda#0| |l#0@@2| |l#1@@0| |l#2@@0| |l#3|) $o@@3 $f))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.XT5#canCall| this@@2 |n#0@@2|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@2|)))) (= (_module.SeqOp.XT5 this@@2 |n#0@@2|) (|Seq#Create| TInt $Heap@@1 |n#0@@2| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 10)))) (|lambda#344| TInt (LitInt 0) |n#0@@2|) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.176:12|
 :skolemid |717|
 :pattern ( (_module.SeqOp.XT5 this@@2 |n#0@@2|) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((|l#0@@3| T@U) (|$l#1#heap#0| T@U) (|$l#1#_v0#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#14| |l#0@@3|) |$l#1#heap#0| |$l#1#_v0#0|) |l#0@@3|)
 :qid |unknown.0:0|
 :skolemid |769|
 :pattern ( (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#14| |l#0@@3|) |$l#1#heap#0| |$l#1#_v0#0|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.XT5)
...
(let ((anon16_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |n#0@@3|))) (= (ControlFlow 0 9) 7)) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| |n#0@@3|)) (= |lambdaResult#0| (LitInt 10))) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 8) 7))) anon9_correct)))
(let ((anon15_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 11) 8) anon16_Then_correct) (=> (= (ControlFlow 0 11) 9) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 10) 8) anon16_Then_correct) (=> (= (ControlFlow 0 10) 9) anon16_Else_correct)))))
(let ((anon14_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 12) 10) anon15_Then_correct) (=> (= (ControlFlow 0 12) 11) anon15_Else_correct)))))
(let ((anon14_Else_correct true))
(let ((anon13_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 13) 12) anon14_Then_correct) (=> (= (ControlFlow 0 13) 6) anon14_Else_correct)))))
(let ((anon13_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 10)))) (|lambda#344| TInt (LitInt 0) |n#0@@3|) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |ComprehensionsNewSyntaxdfy.177:5|
 :skolemid |720|
 ...
 :qid |ComprehensionsNewSyntaxdfy.177:5|
 :skolemid |723|
))) (=> (= (_module.SeqOp.XT5 this@@3 |n#0@@3|) (|Seq#Create| TInt $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#14| ($Box intType (int_2_U (LitInt 10)))) (|lambda#344| TInt (LitInt 0) |n#0@@3|) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))) (=> (and ($Is SeqType (_module.SeqOp.XT5 this@@3 |n#0@@3|) (TSeq Tclass._System.nat)) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#0@0|)))))))
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (and (=> (= (ControlFlow 0 16) 1) anon12_Then_correct) (=> (= (ControlFlow 0 16) 14) anon12_Else_correct)))))
