...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.duplicate__array)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |input#0| null)) (not true)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |input#0| (Tclass._System.array TInt)) ($IsAlloc refType |input#0| (Tclass._System.array TInt) $Heap))) (and (and ($Is refType |output#0| (Tclass._System.array TInt)) ($IsAlloc refType |output#0| (Tclass._System.array TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
