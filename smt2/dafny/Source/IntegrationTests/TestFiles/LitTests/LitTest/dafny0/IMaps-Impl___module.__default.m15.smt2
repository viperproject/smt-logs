...
(assert (forall ((a@@2 T@U) (b@@2 T@U) (t0@@7 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@11 T@U) )  (=> (U_2_bool (MapType0Select BoxType boolType a@@2 bx@@11)) (and ($IsBox bx@@11 t0@@7) ($IsBox (MapType0Select BoxType BoxType b@@2 bx@@11) t1@@3)))) ($Is IMapType (|IMap#Glue| a@@2 b@@2 (TIMap t0@@7 t1@@3)) (TIMap t0@@7 t1@@3)))
