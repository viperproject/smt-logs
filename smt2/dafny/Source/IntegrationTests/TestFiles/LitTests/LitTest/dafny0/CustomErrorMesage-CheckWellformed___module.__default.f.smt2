...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@0| Int) ) (!  (=> (or (|_module.__default.f#canCall| (LitInt |x#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.f (LitInt |x#0@@0|)) (LitInt |x#0@@0|)))
 :qid |CustomErrorMesagedfy.9:18|
 :weight 3
 :skolemid |485|
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (> |x#0@@1| 0))))
