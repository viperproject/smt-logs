...
(set-info :boogie-vc-id Impl$$_module.Node.Max1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_correct  (=> (= |r#0@0| (ite (< |x#0| |y#0|) |y#0| |x#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (= |r#0@0| |x#0|) (= |r#0@0| |y#0|))) (=> (or (= |r#0@0| |x#0|) (= |r#0@0| |y#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= |x#0| |r#0@0|)) (=> (<= |x#0| |r#0@0|) (=> (= (ControlFlow 0 2) (- 0 1)) (<= |y#0| |r#0@0|)))))))))
(let ((anon4_Else_correct  (=> (and (<= |y#0| |x#0|) (= (ControlFlow 0 6) 2)) anon3_correct)))
(let ((anon4_Then_correct  (=> (and (< |x#0| |y#0|) (= (ControlFlow 0 5) 2)) anon3_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Node) ($IsAlloc refType this Tclass._module.Node $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
