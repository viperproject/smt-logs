...
(set-info :boogie-vc-id Impl$$TypeParameters.__default.Tuples)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($Is DatatypeTypeType |p#0@0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.nat)) ($IsAlloc DatatypeTypeType |p#0@0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.nat) $Heap)) (= |p#0@1| (|#_System._tuple#2._#Make2| ($Box intType (int_2_U |n#0|)) ($Box intType (int_2_U |n#0|))))) (and (and ($Is DatatypeTypeType |p#0@2| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.nat)) ($IsAlloc DatatypeTypeType |p#0@2| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.nat) $Heap)) (and (_System.Tuple2.___hMake2_q |p#0@2|) (_System.Tuple2.___hMake2_q |p#0@2|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt 0) (U_2_int ($Unbox intType (_System.Tuple2._0 |p#0@2|))))) (=> (<= (LitInt 0) (U_2_int ($Unbox intType (_System.Tuple2._0 |p#0@2|)))) (=> (_System.Tuple2.___hMake2_q |p#0@2|) (=> (and (_System.Tuple2.___hMake2_q |p#0@2|) (= (ControlFlow 0 2) (- 0 1))) (<= (LitInt 0) (U_2_int ($Unbox intType (_System.Tuple2._1 |p#0@2|))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (=> (and (and (and ($Is DatatypeTypeType |p#0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.nat)) ($IsAlloc DatatypeTypeType |p#0| (Tclass._System.Tuple2 Tclass._System.nat Tclass._System.nat) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
