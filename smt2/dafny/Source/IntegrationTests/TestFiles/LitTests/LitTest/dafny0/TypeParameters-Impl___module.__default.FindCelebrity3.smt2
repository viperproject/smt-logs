...
(set-info :boogie-vc-id Impl$$_module.__default.FindCelebrity3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= StartFuel_ParseGenerics._default.Many ($LS BaseFuel_ParseGenerics._default.Many)) (= StartFuelAssert_ParseGenerics._default.Many ($LS ($LS BaseFuel_ParseGenerics._default.Many)))) (=> (and (and (= (AsFuelBottom BaseFuel_ParseGenerics._default.Many) BaseFuel_ParseGenerics._default.Many) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false))) (and ($IsAlloc intType (int_2_U |c#0@@4|) TInt $Heap) ($IsAlloc SetType |people#0@@4| (TSet TInt) $Heap))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= |c#0@@4| |c#0@@4|) (|Set#IsMember| |people#0@@4| ($Box intType (int_2_U |c#0@@4|))))) (=> (or (= |c#0@@4| |c#0@@4|) (|Set#IsMember| |people#0@@4| ($Box intType (int_2_U |c#0@@4|)))) (=> (and (and (and (|_module.__default.IsCelebrity#canCall| TInt ($Box intType (int_2_U |c#0@@4|)) |people#0@@4|) (|_module.__default.IsCelebrity#canCall| TInt ($Box intType (int_2_U |c#0@@4|)) |people#0@@4|)) (and (= |b#0@1| (_module.__default.IsCelebrity TInt ($Box intType (int_2_U |c#0@@4|)) |people#0@@4|)) ($IsAlloc intType (int_2_U |c#0@@4|) TInt $Heap))) (and (and ($IsAlloc SetType |people#0@@4| (TSet TInt) $Heap) (= (ControlFlow 0 2) (- 0 1))) (|_module.__default.IsCelebrity#canCall| TInt ($Box intType (int_2_U |c#0@@4|)) |people#0@@4|))) (or (_module.__default.IsCelebrity TInt ($Box intType (int_2_U |c#0@@4|)) |people#0@@4|) (U_2_bool (Lit boolType (bool_2_U false)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SetType |people#0@@4| (TSet TInt)) ($IsAlloc SetType |people#0@@4| (TSet TInt) $Heap)) (= 2 $FunctionContextHeight)) (and (and (|_module.__default.IsCelebrity#canCall| TInt ($Box intType (int_2_U |c#0@@4|)) |people#0@@4|) (and (_module.__default.IsCelebrity TInt ($Box intType (int_2_U |c#0@@4|)) |people#0@@4|) (U_2_bool (Lit boolType (bool_2_U false))))) (= (ControlFlow 0 4) 2))) anon0_correct))))
