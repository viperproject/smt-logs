...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (|u#0@@0| T@U) (|s#0@@0| T@U) (|t#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.M1#canCall| $prevHeap@@0 $h0 |u#0@@0| |s#0@@0| |t#0@@0|) (and (and ($Is refType |u#0@@0| Tclass._module.C?) ($Is SetType |s#0@@0| (TSet Tclass._module.C?))) ($Is SeqType |t#0@@0| (TSeq Tclass._module.C?))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@5 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (or (or (= $o@@5 |u#0@@0|) (|Set#IsMember| |s#0@@0| ($Box refType $o@@5))) (exists (($i@@1 Int) ) (!  (and (and (<= 0 $i@@1) (< $i@@1 (|Seq#Length| |t#0@@0|))) (= (|Seq#Index| |t#0@@0| $i@@1) ($Box refType $o@@5)))
 ...
 :qid |unknown.0:0|
 :skolemid |1429|
)) (= (_module.__default.M1 $prevHeap@@0 $h0 |u#0@@0| |s#0@@0| |t#0@@0|) (_module.__default.M1 $prevHeap@@0 $h1 |u#0@@0| |s#0@@0| |t#0@@0|))))
...
))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (=> (and (<= 0 |$unchanged#x1@0|) (< |$unchanged#x1@0| (|Seq#Length| |t#0@@1|))) (or (not (= ($Unbox refType (|Seq#Index| |t#0@@1| |$unchanged#x1@0|)) null)) (not true)))) (=> (=> (and (<= 0 |$unchanged#x1@0|) (< |$unchanged#x1@0| (|Seq#Length| |t#0@@1|))) (or (not (= ($Unbox refType (|Seq#Index| |t#0@@1| |$unchanged#x1@0|)) null)) (not true))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (and (and (<= 0 |$unchanged#x1@0|) (< |$unchanged#x1@0| (|Seq#Length| |t#0@@1|))) (or (not (= ($Unbox refType (|Seq#Index| |t#0@@1| |$unchanged#x1@0|)) null)) (not true))) ($IsAlloc refType ($Unbox refType (|Seq#Index| |t#0@@1| |$unchanged#x1@0|)) Tclass._module.C? $Heap@@0))) (=> (=> (and (and (<= 0 |$unchanged#x1@0|) (< |$unchanged#x1@0| (|Seq#Length| |t#0@@1|))) (or (not (= ($Unbox refType (|Seq#Index| |t#0@@1| |$unchanged#x1@0|)) null)) (not true))) ($IsAlloc refType ($Unbox refType (|Seq#Index| |t#0@@1| |$unchanged#x1@0|)) Tclass._module.C? $Heap@@0)) (=> (= |b$reqreads#2@0| (forall (($o@@13 T@U) ($f@@11 T@U) ) (!  (=> (and (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@13) alloc)))) (exists (($i@@3 Int) ) (!  (and (and (<= 0 $i@@3) (< $i@@3 (|Seq#Length| |t#0@@1|))) (= (|Seq#Index| |t#0@@1| $i@@3) ($Box refType $o@@13)))
 :qid |LabelsOldAtdfy.268:16|
 :skolemid |1444|
