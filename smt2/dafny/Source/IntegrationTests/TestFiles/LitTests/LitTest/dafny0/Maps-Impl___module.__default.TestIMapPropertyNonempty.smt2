...
(assert (forall ((m@@9 T@U) ) (!  (or (= m@@9 |IMap#Empty|) (exists ((k@@0 T@U) (v@@9 T@U) ) (! (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| m@@9) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@9))))
...
(assert (forall ((v@@10 T@U) (t@@0 T@U) (T@@2 T@T) ) (! (= ($IsBox ($Box T@@2 v@@10) t@@0) ($Is T@@2 v@@10 t@@0))
 :qid |DafnyPreludebpl.214:18|
 :skolemid |38|
 :pattern ( ($IsBox ($Box T@@2 v@@10) t@@0))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestIMapPropertyNonempty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon7_Else_correct  (=> (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 8) (- 0 7))) false)))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (not (|ISet#Equal| (|IMap#Items| |m#0|) |ISet#Empty|)))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (not (|ISet#Equal| (|IMap#Values| |m#0|) |ISet#Empty|)))))
(let ((anon5_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (not (|ISet#Equal| (|IMap#Domain| |m#0|) |ISet#Empty|)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 4) anon6_Then_correct)) (=> (= (ControlFlow 0 9) 6) anon7_Then_correct)) (=> (= (ControlFlow 0 9) 8) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is IMapType |m#0| (TIMap Tclass._module.MyClass (TBitvector 3))) ($IsAlloc IMapType |m#0| (TIMap Tclass._module.MyClass (TBitvector 3)) $Heap)) (= 1 $FunctionContextHeight)) (and (not (|IMap#Equal| |m#0| |IMap#Empty|)) (= (ControlFlow 0 10) 9))) anon0_correct))))
