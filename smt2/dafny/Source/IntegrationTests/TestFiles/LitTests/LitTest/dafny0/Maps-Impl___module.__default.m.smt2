...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |a#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 3)))))) (= |b#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 2))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (|Set#IsMember| (|Map#Domain| |b#0@0|) ($Box intType (int_2_U (LitInt 3))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |a#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |b#0@0|) ($Box intType (int_2_U (LitInt 3)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0@0|) (MapType0Select BoxType BoxType (|Map#Elements| |b#0@0|) ($Box intType (int_2_U (LitInt 3))))))) (LitInt 3)))))))))
