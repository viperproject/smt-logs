...
(set-info :boogie-vc-id Impl$$_module.__default.BadLoop)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon8_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (<= 0 |x'#0@0|) (= |x'#0@2| |x'#0@0|))) (=> (or (<= 0 |x'#0@0|) (= |x'#0@2| |x'#0@0|)) (=> (= (ControlFlow 0 5) (- 0 4)) (< |x'#0@2| |x'#0@0|))))))
(let ((anon12_Else_correct  (=> (and (and (>= |y'#0@0| |x'#0@0|) (= |y'#0@1| (- |y'#0@0| 1))) (and (= |x'#0@2| |x'#0@0|) (= (ControlFlow 0 8) 5))) anon8_correct)))
(let ((anon12_Then_correct  (=> (and (and (> |x'#0@0| |y'#0@0|) (= |x'#0@1| (- |x'#0@0| 1))) (and (= |x'#0@2| |x'#0@1|) (= (ControlFlow 0 7) 5))) anon8_correct)))
(let ((anon11_Else_correct  (=> (> (+ |x'#0@0| |y'#0@0|) 0) (and (=> (= (ControlFlow 0 9) 7) anon12_Then_correct) (=> (= (ControlFlow 0 9) 8) anon12_Else_correct)))))
...
)) (<= |x'#0@0| |x#0|))) (and (=> (= (ControlFlow 0 12) 1) anon9_LoopDone_correct) (=> (= (ControlFlow 0 12) 11) anon9_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 13) 12)) anon9_LoopHead_correct)))
