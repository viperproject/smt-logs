...
(set-info :boogie-vc-id Impl$$EqualitySupport.__default.N)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (and (not (Types.XY.G0_q |xy#0|)) (not (Types.XY.G1_q |xy#0|)))) (=> (and (not (Types.XY.G0_q |xy#0|)) (not (Types.XY.G1_q |xy#0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (not (Types.XY.G0_q |xy#0|)) (not (Types.XY.G1_q |xy#0|)))) (=> (and (not (Types.XY.G0_q |xy#0|)) (not (Types.XY.G1_q |xy#0|))) (=> (and (|$IsA#Types.XY| |xy#0|) (|$IsA#Types.XY| |xy#0|)) (and (=> (= (ControlFlow 0 3) 1) anon3_Then_correct) (=> (= (ControlFlow 0 3) 2) anon3_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |xy#0| Tclass.Types.XY) ($IsAlloc DatatypeTypeType |xy#0| Tclass.Types.XY $Heap)) (|$IsA#Types.XY| |xy#0|)) (= 0 $FunctionContextHeight)) (and (or (Types.XY.D0_q |xy#0|) (Types.XY.D1_q |xy#0|)) (= (ControlFlow 0 6) 3))) anon0_correct))))
