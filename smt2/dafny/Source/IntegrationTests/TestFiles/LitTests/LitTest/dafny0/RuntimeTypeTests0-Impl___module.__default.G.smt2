...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is SetType |s#0@0| (TSet TInt)) ($IsAlloc SetType |s#0@0| (TSet TInt) $Heap)) (=> (and (and ($Is SetType |t#0@0| (TSet Tclass._System.nat)) ($IsAlloc SetType |t#0@0| (TSet Tclass._System.nat) $Heap)) (and (= |s#0@1| (Lit SetType (|Set#UnionOne| (|Set#UnionOne| |Set#Empty| ($Box intType (int_2_U (LitInt 5)))) ($Box intType (int_2_U (LitInt 7)))))) (= (ControlFlow 0 2) (- 0 1)))) ($Is SetType |s#0@1| (TSet Tclass._System.nat)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap)) true) (=> (and (and (and ($Is SetType |t#0| (TSet Tclass._System.nat)) ($IsAlloc SetType |t#0| (TSet Tclass._System.nat) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))))
