...
(declare-fun $generated@@84 () (_ BitVec 7))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@88  (=> (and (= $generated@@80 ($generated@@24 $generated@@81 $generated@@82 $generated@@83 false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@84 #b0000000)) (not true)))))
(let (($generated@@89  (=> (and (and ($generated@@85 $generated@@82) ($generated@@86 $generated@@82)) (and (= 0 $generated@@87) (= (ControlFlow 0 3) 2))) $generated@@88)))
$generated@@89)))
))
(check-sat)
