...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@98  (=> (and (= $generated@@91 ($generated@@32 $generated@@92 $generated@@93 $generated@@94 false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= ($generated 2) 0)) (not true)))))
(let (($generated@@99  (=> (and (and ($generated@@95 $generated@@93) ($generated@@96 $generated@@93)) (and (= 0 $generated@@97) (= (ControlFlow 0 3) 2))) $generated@@98)))
$generated@@99)))
))
(check-sat)
(get-info :rlimit)
