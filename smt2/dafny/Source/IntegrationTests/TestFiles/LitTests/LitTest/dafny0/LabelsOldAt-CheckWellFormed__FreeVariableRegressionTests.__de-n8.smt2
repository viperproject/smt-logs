...
(set-info :boogie-vc-id CheckWellFormed$$FreeVariableRegressionTests.__default.P3)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |c#0@@1| Tclass.FreeVariableRegressionTests.C) ($IsAlloc refType |c#0@@1| Tclass.FreeVariableRegressionTests.C $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
