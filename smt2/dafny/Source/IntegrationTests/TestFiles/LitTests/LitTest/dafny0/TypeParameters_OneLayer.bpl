...
axiom (forall a#12#0#0: Box :: 
  { #OneLayer.wrap.Wrap(a#12#0#0) } 
  DatatypeCtorId(#OneLayer.wrap.Wrap(a#12#0#0)) == ##OneLayer.wrap.Wrap);
}
...
axiom (forall d: DatatypeType :: 
  { OneLayer.wrap.Wrap_q(d) } 
  OneLayer.wrap.Wrap_q(d)
     ==> (exists a#13#0#0: Box :: d == #OneLayer.wrap.Wrap(a#13#0#0)));
...
// Constructor $Is
axiom (forall OneLayer.wrap$V: Ty, a#14#0#0: Box :: 
  { $Is(#OneLayer.wrap.Wrap(a#14#0#0), Tclass.OneLayer.wrap(OneLayer.wrap$V)) } 
  $Is(#OneLayer.wrap.Wrap(a#14#0#0), Tclass.OneLayer.wrap(OneLayer.wrap$V))
     <==> $IsBox(a#14#0#0, OneLayer.wrap$V));

// Constructor $IsAlloc
axiom (forall OneLayer.wrap$V: Ty, a#14#0#0: Box, $h: Heap :: 
  { $IsAlloc(#OneLayer.wrap.Wrap(a#14#0#0), Tclass.OneLayer.wrap(OneLayer.wrap$V), $h) } 
  $IsGoodHeap($h)
     ==> ($IsAlloc(#OneLayer.wrap.Wrap(a#14#0#0), Tclass.OneLayer.wrap(OneLayer.wrap$V), $h)
       <==> $IsAllocBox(a#14#0#0, OneLayer.wrap$V, $h)));
...
axiom (forall a#15#0#0: Box :: 
  { #OneLayer.wrap.Wrap(Lit(a#15#0#0)) } 
  #OneLayer.wrap.Wrap(Lit(a#15#0#0)) == Lit(#OneLayer.wrap.Wrap(a#15#0#0)));

function OneLayer.wrap._h0(DatatypeType) : Box;

// Constructor injectivity
axiom (forall a#16#0#0: Box :: 
  { #OneLayer.wrap.Wrap(a#16#0#0) } 
  OneLayer.wrap._h0(#OneLayer.wrap.Wrap(a#16#0#0)) == a#16#0#0);

// Inductive rank
axiom (forall a#17#0#0: Box :: 
  { #OneLayer.wrap.Wrap(a#17#0#0) } 
  BoxRank(a#17#0#0) < DtRank(#OneLayer.wrap.Wrap(a#17#0#0)));
