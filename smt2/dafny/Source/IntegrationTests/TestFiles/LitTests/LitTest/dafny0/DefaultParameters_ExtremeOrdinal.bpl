...
const unique class.ExtremeOrdinal.__default: ClassName;

// function declaration for ExtremeOrdinal._default.P
function ExtremeOrdinal.__default.P(x#0: int, u#0: int) : bool
uses {
// definition axiom for ExtremeOrdinal.__default.P (revealed)
axiom {:id "id856"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int :: 
    { ExtremeOrdinal.__default.P(x#0, u#0) } 
    ExtremeOrdinal.__default.P#canCall(x#0, u#0) || 0 < $FunctionContextHeight
       ==> ExtremeOrdinal.__default.P(x#0, u#0) == (x#0 == u#0));
}

function ExtremeOrdinal.__default.P#canCall(x#0: int, u#0: int) : bool;

function ExtremeOrdinal.__default.P#requires(int, int) : bool;

// #requires axiom for ExtremeOrdinal.__default.P
axiom (forall x#0: int, u#0: int :: 
  { ExtremeOrdinal.__default.P#requires(x#0, u#0) } 
  ExtremeOrdinal.__default.P#requires(x#0, u#0) == true);

// 1st prefix predicate axiom for ExtremeOrdinal.__default.P_h
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int :: 
    { ExtremeOrdinal.__default.P(x#0, u#0) } 
    ExtremeOrdinal.__default.P(x#0, u#0)
       ==> (forall _k#0: Box :: 
        { ExtremeOrdinal.__default.P_h(_k#0, x#0, u#0) } 
        ExtremeOrdinal.__default.P_h(_k#0, x#0, u#0)));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int, _k#0: Box :: 
    { ExtremeOrdinal.__default.P_h(_k#0, x#0, u#0) } 
    _k#0 == ORD#FromNat(0) ==> ExtremeOrdinal.__default.P_h(_k#0, x#0, u#0));

procedure {:verboseName "ExtremeOrdinal.P (well-formedness)"} CheckWellformed$$ExtremeOrdinal.__default.P(x#0: int, u#0: int);
...
// function declaration for ExtremeOrdinal._default.P#
function ExtremeOrdinal.__default.P_h(_k#0: Box, x#0: int, u#0: int) : bool
uses {
// definition axiom for ExtremeOrdinal.__default.P_h (revealed)
axiom {:id "id858"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: Box, x#0: int, u#0: int :: 
    { ExtremeOrdinal.__default.P_h(_k#0, x#0, u#0) } 
    ExtremeOrdinal.__default.P_h#canCall(_k#0, x#0, u#0)
       ...
       ==> (
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#0: Box :: 
            { ExtremeOrdinal.__default.P_h(_k'#0, x#0, u#0) } 
            ORD#Less(_k'#0, _k#0) ==> ExtremeOrdinal.__default.P_h#canCall(_k'#0, x#0, u#0)))
         && ExtremeOrdinal.__default.P_h(_k#0, x#0, u#0)
           == ((0 < ORD#Offset(_k#0) ==> x#0 == u#0)
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (forall _k'#0: Box :: 
                { ExtremeOrdinal.__default.P_h(_k'#0, x#0, u#0) } 
                ORD#Less(_k'#0, _k#0) ==> ExtremeOrdinal.__default.P_h(_k'#0, x#0, u#0)))));
// definition axiom for ExtremeOrdinal.__default.P_h for decreasing-related literals (revealed)
axiom {:id "id859"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: Box, x#0: int, u#0: int :: 
    {:weight 3} { ExtremeOrdinal.__default.P_h(Lit(_k#0), x#0, u#0) } 
    ExtremeOrdinal.__default.P_h#canCall(Lit(_k#0), x#0, u#0)
         || 1 < $FunctionContextHeight
       ==> (
          (0 < ORD#Offset(_k#0)
           ==> x#0 == u#0)
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#1: Box :: 
            { ExtremeOrdinal.__default.P_h(_k'#1, x#0, u#0) } 
            ORD#Less(_k'#1, _k#0) ==> ExtremeOrdinal.__default.P_h#canCall(_k'#1, x#0, u#0)))
         && ExtremeOrdinal.__default.P_h(Lit(_k#0), x#0, u#0)
           == ((0 < ORD#Offset(_k#0) ==> x#0 == u#0)
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (forall _k'#1: Box :: 
                { ExtremeOrdinal.__default.P_h(_k'#1, x#0, u#0) } 
                ORD#Less(_k'#1, _k#0) ==> ExtremeOrdinal.__default.P_h(_k'#1, x#0, u#0)))));
// definition axiom for ExtremeOrdinal.__default.P_h for all literals (revealed)
axiom {:id "id860"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: Box, x#0: int, u#0: int :: 
    {:weight 3} { ExtremeOrdinal.__default.P_h(Lit(_k#0), LitInt(x#0), LitInt(u#0)) } 
    ExtremeOrdinal.__default.P_h#canCall(Lit(_k#0), LitInt(x#0), LitInt(u#0))
         || 1 < $FunctionContextHeight
       ==> (
          (0 < ORD#Offset(_k#0)
           ==> LitInt(x#0) == LitInt(u#0))
           ==> 
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
            { ExtremeOrdinal.__default.P_h(_k'#2, x#0, u#0) } 
            ORD#Less(_k'#2, _k#0) ==> ExtremeOrdinal.__default.P_h#canCall(_k'#2, x#0, u#0)))
         && ExtremeOrdinal.__default.P_h(Lit(_k#0), LitInt(x#0), LitInt(u#0))
           == ((0 < ORD#Offset(_k#0) ==> LitInt(x#0) == LitInt(u#0))
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (forall _k'#2: Box :: 
                { ExtremeOrdinal.__default.P_h(_k'#2, x#0, u#0) } 
                ORD#Less(_k'#2, _k#0) ==> ExtremeOrdinal.__default.P_h(_k'#2, x#0, u#0)))));
}

function ExtremeOrdinal.__default.P_h#canCall(_k#0: Box, x#0: int, u#0: int) : bool;

function ExtremeOrdinal.__default.P_h#requires(Box, int, int) : bool;

// #requires axiom for ExtremeOrdinal.__default.P_h
axiom (forall _k#0: Box, x#0: int, u#0: int :: 
  { ExtremeOrdinal.__default.P_h#requires(_k#0, x#0, u#0) } 
  ExtremeOrdinal.__default.P_h#requires(_k#0, x#0, u#0) == true);

// function declaration for ExtremeOrdinal._default.Q
function ExtremeOrdinal.__default.Q(x#0: int, u#0: int) : bool
uses {
// definition axiom for ExtremeOrdinal.__default.Q (revealed)
axiom {:id "id861"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int :: 
    { ExtremeOrdinal.__default.Q(x#0, u#0) } 
    ExtremeOrdinal.__default.Q#canCall(x#0, u#0) || 0 < $FunctionContextHeight
       ==> ExtremeOrdinal.__default.Q(x#0, u#0) == (x#0 == u#0));
}

function ExtremeOrdinal.__default.Q#canCall(x#0: int, u#0: int) : bool;

function ExtremeOrdinal.__default.Q#requires(int, int) : bool;

// #requires axiom for ExtremeOrdinal.__default.Q
axiom (forall x#0: int, u#0: int :: 
  { ExtremeOrdinal.__default.Q#requires(x#0, u#0) } 
  ExtremeOrdinal.__default.Q#requires(x#0, u#0) == true);

// 1st prefix predicate axiom for ExtremeOrdinal.__default.Q_h
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int :: 
    { ExtremeOrdinal.__default.Q(x#0, u#0) } 
    ExtremeOrdinal.__default.Q(x#0, u#0)
       ==> (exists _k#0: Box :: 
        { ExtremeOrdinal.__default.Q_h(_k#0, x#0, u#0) } 
        ExtremeOrdinal.__default.Q_h(_k#0, x#0, u#0)));
...
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int, _k#0: Box :: 
    { ExtremeOrdinal.__default.Q_h(_k#0, x#0, u#0) } 
    _k#0 == ORD#FromNat(0) ==> !ExtremeOrdinal.__default.Q_h(_k#0, x#0, u#0));

// targeted prefix predicate monotonicity axiom
axiom 1 <= $FunctionContextHeight
   ==> (forall x#0: int, u#0: int, _k#0: Box, _m: Box, _limit: Box :: 
    { ExtremeOrdinal.__default.Q_h(_k#0, x#0, u#0), ORD#LessThanLimit(_k#0, _limit), ORD#LessThanLimit(_m, _limit) } 
    ORD#Less(_k#0, _m)
       ==> 
      ExtremeOrdinal.__default.Q_h(_k#0, x#0, u#0)
       ==> ExtremeOrdinal.__default.Q_h(_m, x#0, u#0));

procedure {:verboseName "ExtremeOrdinal.Q (well-formedness)"} CheckWellformed$$ExtremeOrdinal.__default.Q(x#0: int, u#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
// function declaration for ExtremeOrdinal._default.Q#
function ExtremeOrdinal.__default.Q_h(_k#0: Box, x#0: int, u#0: int) : bool
uses {
// definition axiom for ExtremeOrdinal.__default.Q_h (revealed)
axiom {:id "id863"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: Box, x#0: int, u#0: int :: 
    { ExtremeOrdinal.__default.Q_h(_k#0, x#0, u#0) } 
    ExtremeOrdinal.__default.Q_h#canCall(_k#0, x#0, u#0)
         || 1 < $FunctionContextHeight
       ==> (
          (0 < ORD#Offset(_k#0)
           ==> x#0 == u#0)
         ...
         && ExtremeOrdinal.__default.Q_h(_k#0, x#0, u#0)
           == ((0 < ORD#Offset(_k#0) ==> x#0 == u#0)
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (exists _k'#0: Box :: 
                { ExtremeOrdinal.__default.Q_h(_k'#0, x#0, u#0) } 
                ORD#LessThanLimit(_k'#0, _k#0) && ExtremeOrdinal.__default.Q_h(_k'#0, x#0, u#0)))));
// definition axiom for ExtremeOrdinal.__default.Q_h for decreasing-related literals (revealed)
axiom {:id "id864"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: Box, x#0: int, u#0: int :: 
    {:weight 3} { ExtremeOrdinal.__default.Q_h(Lit(_k#0), x#0, u#0) } 
    ExtremeOrdinal.__default.Q_h#canCall(Lit(_k#0), x#0, u#0)
         || 1 < $FunctionContextHeight
       ==> (
          (0 < ORD#Offset(_k#0)
           ==> x#0 == u#0)
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#1: Box :: 
            { ExtremeOrdinal.__default.Q_h(_k'#1, x#0, u#0) } 
            ORD#LessThanLimit(_k'#1, _k#0)
               ==> ExtremeOrdinal.__default.Q_h#canCall(_k'#1, x#0, u#0)))
         && ExtremeOrdinal.__default.Q_h(Lit(_k#0), x#0, u#0)
           == ((0 < ORD#Offset(_k#0) ==> x#0 == u#0)
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (exists _k'#1: Box :: 
                { ExtremeOrdinal.__default.Q_h(_k'#1, x#0, u#0) } 
                ORD#LessThanLimit(_k'#1, _k#0) && ExtremeOrdinal.__default.Q_h(_k'#1, x#0, u#0)))));
// definition axiom for ExtremeOrdinal.__default.Q_h for all literals (revealed)
axiom {:id "id865"} 1 <= $FunctionContextHeight
   ==> (forall _k#0: Box, x#0: int, u#0: int :: 
    {:weight 3} { ExtremeOrdinal.__default.Q_h(Lit(_k#0), LitInt(x#0), LitInt(u#0)) } 
    ExtremeOrdinal.__default.Q_h#canCall(Lit(_k#0), LitInt(x#0), LitInt(u#0))
         || 1 < $FunctionContextHeight
       ==> (
          (0 < ORD#Offset(_k#0)
           ==> LitInt(x#0) == LitInt(u#0))
          ...
          LitInt(0) == ORD#Offset(_k#0)
           ==> (forall _k'#2: Box :: 
            { ExtremeOrdinal.__default.Q_h(_k'#2, x#0, u#0) } 
            ORD#LessThanLimit(_k'#2, _k#0)
               ==> ExtremeOrdinal.__default.Q_h#canCall(_k'#2, x#0, u#0)))
         && ExtremeOrdinal.__default.Q_h(Lit(_k#0), LitInt(x#0), LitInt(u#0))
           == ((0 < ORD#Offset(_k#0) ==> LitInt(x#0) == LitInt(u#0))
             && (LitInt(0) == ORD#Offset(_k#0)
               ==> (exists _k'#2: Box :: 
                { ExtremeOrdinal.__default.Q_h(_k'#2, x#0, u#0) } 
                ORD#LessThanLimit(_k'#2, _k#0) && ExtremeOrdinal.__default.Q_h(_k'#2, x#0, u#0)))));
}

function ExtremeOrdinal.__default.Q_h#canCall(_k#0: Box, x#0: int, u#0: int) : bool;

function ExtremeOrdinal.__default.Q_h#requires(Box, int, int) : bool;

// #requires axiom for ExtremeOrdinal.__default.Q_h
axiom (forall _k#0: Box, x#0: int, u#0: int :: 
  { ExtremeOrdinal.__default.Q_h#requires(_k#0, x#0, u#0) } 
  ExtremeOrdinal.__default.Q_h#requires(_k#0, x#0, u#0) == true);

procedure {:verboseName "ExtremeOrdinal.L (well-formedness)"} CheckWellFormed$$ExtremeOrdinal.__default.L(x#0: int, u#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ExtremeOrdinal.L (call)"} Call$$ExtremeOrdinal.__default.L(x#0: int, u#0: int);
  // user-defined preconditions
  requires {:id "id867"} x#0 == u#0;
  modifies $Heap;
  // frame condition
...
procedure {:verboseName "ExtremeOrdinal.L# (co-call)"} CoCall$$ExtremeOrdinal.__default.L_h(_k#0: Box, x#1: int, u#1: int);
  // user-defined preconditions
  requires {:id "id868"} x#1 == u#1;
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure {:verboseName "ExtremeOrdinal.L# (correctness)"} Impl$$ExtremeOrdinal.__default.L_h(_k#0: Box, x#1: int, u#1: int) returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id869"} x#1 == u#1;
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure {:verboseName "ExtremeOrdinal.TestLeast (well-formedness)"} CheckWellFormed$$ExtremeOrdinal.__default.TestLeast(y#0: int, z#0: int, v#0: int, w#0: int, a#0: int, b#0: int, o#0: Box);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ExtremeOrdinal.TestLeast (call)"} Call$$ExtremeOrdinal.__default.TestLeast(y#0: int, z#0: int, v#0: int, w#0: int, a#0: int, b#0: int, o#0: Box);
  // user-defined preconditions
  requires {:id "id871"} !ORD#IsLimit(o#0);
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure {:verboseName "ExtremeOrdinal.TestLeast (correctness)"} Impl$$ExtremeOrdinal.__default.TestLeast(y#0: int, z#0: int, v#0: int, w#0: int, a#0: int, b#0: int, o#0: Box)
   returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id872"} !ORD#IsLimit(o#0);
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ExtremeOrdinal.TestLeast (correctness)"} Impl$$ExtremeOrdinal.__default.TestLeast(y#0: int, z#0: int, v#0: int, w#0: int, a#0: int, b#0: int, o#0: Box)
   returns ($_reverifyPost: bool)
{
  ...
  var ##u#3: int;
    ...
    // AddMethodImpl: TestLeast, Impl$$ExtremeOrdinal.__default.TestLeast
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(568,5)
    ##x#0 := y#0;
    ...
    assume ExtremeOrdinal.__default.P#canCall(y#0, y#0);
    assume ExtremeOrdinal.__default.P#canCall(y#0, y#0);
    assert {:id "id873"} {:subsumption 0} ExtremeOrdinal.__default.P#canCall(y#0, y#0)
       ==> ExtremeOrdinal.__default.P(y#0, y#0) || y#0 == y#0;
    assume {:id "id874"} ExtremeOrdinal.__default.P(y#0, y#0);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(569,5)
    ##_k#0 := o#0;
    // assume allocatedness for argument to function
    ...
    assume ExtremeOrdinal.__default.P_h#canCall(o#0, z#0, z#0);
    assume ExtremeOrdinal.__default.P_h#canCall(o#0, z#0, z#0);
    assert {:id "id875"} {:subsumption 0} ExtremeOrdinal.__default.P_h#canCall(o#0, z#0, z#0)
       ==> ExtremeOrdinal.__default.P_h(o#0, z#0, z#0)
         || (0 < ORD#Offset(o#0) ==> z#0 == z#0);
    assert {:id "id876"} {:subsumption 0} ExtremeOrdinal.__default.P_h#canCall(o#0, z#0, z#0)
       ==> ExtremeOrdinal.__default.P_h(o#0, z#0, z#0)
         || (LitInt(0) == ORD#Offset(o#0)
           ==> (forall _k'#0: Box :: 
            { ExtremeOrdinal.__default.P_h(_k'#0, z#0, z#0) } 
            ORD#Less(_k'#0, o#0) ==> ExtremeOrdinal.__default.P_h(_k'#0, z#0, z#0)));
    assume {:id "id877"} ExtremeOrdinal.__default.P_h(o#0, z#0, z#0);
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(570,6)
    ...
    // ProcessCallStmt: CheckSubrange
    u##0 := v#0;
    call {:id "id878"} Call$$ExtremeOrdinal.__default.L(x##0, u##0);
    // TrCallStmt: After ProcessCallStmt
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(571,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    _k##0 := o#0;
    ...
    // ProcessCallStmt: CheckSubrange
    u##1 := w#0;
    call {:id "id879"} CoCall$$ExtremeOrdinal.__default.L_h(_k##0, x##1, u##1);
    // TrCallStmt: After ProcessCallStmt
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(572,5)
    ##x#2 := a#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#2, TInt, $Heap);
    ##u#2 := a#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#2, TInt, $Heap);
    assume ExtremeOrdinal.__default.Q#canCall(a#0, a#0);
    assume ExtremeOrdinal.__default.Q#canCall(a#0, a#0);
    assert {:id "id880"} {:subsumption 0} ExtremeOrdinal.__default.Q#canCall(a#0, a#0)
       ==> ExtremeOrdinal.__default.Q(a#0, a#0) || a#0 == a#0;
    assume {:id "id881"} ExtremeOrdinal.__default.Q(a#0, a#0);
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(573,5)
    ##_k#1 := o#0;
    // assume allocatedness for argument to function
    ...
    ##u#3 := b#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##u#3, TInt, $Heap);
    assume ExtremeOrdinal.__default.Q_h#canCall(o#0, b#0, b#0);
    assume ExtremeOrdinal.__default.Q_h#canCall(o#0, b#0, b#0);
    assert {:id "id882"} {:subsumption 0} ExtremeOrdinal.__default.Q_h#canCall(o#0, b#0, b#0)
       ==> ExtremeOrdinal.__default.Q_h(o#0, b#0, b#0)
         || (0 < ORD#Offset(o#0) ==> b#0 == b#0);
    assert {:id "id883"} {:subsumption 0} ExtremeOrdinal.__default.Q_h#canCall(o#0, b#0, b#0)
       ==> ExtremeOrdinal.__default.Q_h(o#0, b#0, b#0)
         || (LitInt(0) == ORD#Offset(o#0)
           ==> (exists _k'#1: Box :: 
            { ExtremeOrdinal.__default.Q_h(_k'#1, b#0, b#0) } 
            ORD#LessThanLimit(_k'#1, o#0) && ExtremeOrdinal.__default.Q_h(_k'#1, b#0, b#0)));
    assume {:id "id884"} ExtremeOrdinal.__default.Q_h(o#0, b#0, b#0);
}
