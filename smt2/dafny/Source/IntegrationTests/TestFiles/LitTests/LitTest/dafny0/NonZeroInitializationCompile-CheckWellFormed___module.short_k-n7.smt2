...
(set-info :boogie-vc-id CheckWellFormed$$_module.short_k)
...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= (LitInt (- 0 32768)) (LitInt (- 0 35)))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (Lit boolType (bool_2_U (< (- 0 35) 32768))))))))
