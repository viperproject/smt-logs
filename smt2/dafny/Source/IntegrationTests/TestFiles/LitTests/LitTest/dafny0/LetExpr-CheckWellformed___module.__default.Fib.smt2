...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon8_Else_correct  (=> (<= 2 |n#0@@3|) (and (=> (= (ControlFlow 0 4) (- 0 10)) ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@3| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#0@0| |n#0@@3|)) (and (=> (= (ControlFlow 0 4) (- 0 8)) (< |##n#0@0| |n#0@@3|)) (=> (< |##n#0@0| |n#0@@3|) (=> (|_module.__default.Fib#canCall| (- |n#0@@3| 1)) (and (=> (= (ControlFlow 0 4) (- 0 7)) ($Is intType (int_2_U (- |n#0@@3| 2)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@3| 2)) Tclass._System.nat) (=> (and (= |##n#1@0| (- |n#0@@3| 2)) ($IsAlloc intType (int_2_U |##n#1@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (or (<= 0 |n#0@@3|) (= |##n#1@0| |n#0@@3|))) (=> (or (<= 0 |n#0@@3|) (= |##n#1@0| |n#0@@3|)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< |##n#1@0| |n#0@@3|)) (=> (< |##n#1@0| |n#0@@3|) (=> (and (|_module.__default.Fib#canCall| (- |n#0@@3| 2)) (= (ControlFlow 0 4) (- 0 3))) ($Is intType (int_2_U (+ (_module.__default.Fib ($LS $LZ) (- |n#0@@3| 1)) (_module.__default.Fib ($LS $LZ) (- |n#0@@3| 2)))) Tclass._System.nat))))))))))))))))))))
