...
(set-info :boogie-vc-id CheckWellFormed$$Tight.MyNumber.Inc)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)))) ($IsAllocBox ($Box refType this@@3) Tclass.Tight.MyNumber? $Heap@@1)) (=> (and (and (and (and (|Tight.MyNumber.Valid#canCall| $Heap@@1 this@@3) (Tight.MyNumber.Valid $Heap@@1 this@@3)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (forall (($o@@10 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@10) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@10)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@10))))
 :qid |Predicatesdfy.53:12|
 :skolemid |1017|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10))
)) ($HeapSucc $Heap@@1 $Heap@0)) (and ($IsAlloc refType this@@3 Tclass.Tight.MyNumber $Heap@@1) (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.N))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.N))))))) (and (and (and ($IsAllocBox ($Box refType this@@3) Tclass.Tight.MyNumber? $Heap@0) (|Tight.MyNumber.Valid#canCall| $Heap@0 this@@3)) (and (Tight.MyNumber.Valid $Heap@0 this@@3) ($IsAlloc refType this@@3 Tclass.Tight.MyNumber $Heap@@1))) (and (and (forall (($o@@11 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@11)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@11)))) (or (not (= $o@@11 null)) (not true)))
 :qid |Predicatesdfy.31:26|
 :skolemid |1018|
 :pattern (  (or (not (= $o@@11 null)) (not true)))
)) (forall (($o@@12 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@12)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@3) Tight.MyNumber.Repr)) ($Box refType $o@@12)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@12) alloc)))))
 :qid |Predicatesdfy.31:26|
 :skolemid |1019|
...
))) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType this@@3 Tclass.Tight.MyNumber $Heap@@1)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 Tclass.Tight.MyNumber) ($IsAlloc refType this@@3 Tclass.Tight.MyNumber $Heap@@1))) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
