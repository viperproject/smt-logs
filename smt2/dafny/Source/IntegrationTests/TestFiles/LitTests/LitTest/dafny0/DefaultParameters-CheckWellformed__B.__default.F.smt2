...
(set-info :boogie-vc-id CheckWellformed$$B.__default.F)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (= |r#0| |x#0@@2|))))
(let ((anon5_Else_correct  (=> (and (and (= (B.__default.F |x#0@@2|) |x#0@@2|) ($Is intType (int_2_U (B.__default.F |x#0@@2|)) TInt)) (and (= (B.__default.F |x#0@@2|) |r#0|) (= (ControlFlow 0 4) 3))) GeneratedUnifiedExit_correct)))
