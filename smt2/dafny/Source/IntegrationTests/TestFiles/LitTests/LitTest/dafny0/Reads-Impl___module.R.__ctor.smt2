...
(assert (distinct alloc allocName Tagclass._module.R? class._module.R? Tagclass._module.R tytagFamily$R field$r)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id Impl$$_module.R.__ctor)
