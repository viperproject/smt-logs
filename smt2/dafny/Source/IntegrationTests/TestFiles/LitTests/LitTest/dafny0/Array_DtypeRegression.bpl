...
procedure {:verboseName "DtypeRegression.array_equal (well-formedness)"} CheckWellformed$$DtypeRegression.__default.array__equal(a#0: ref where $Is(a#0, Tclass._System.array(TInt)), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "DtypeRegression.array_equal (well-formedness)"} CheckWellformed$$DtypeRegression.__default.array__equal(a#0: ref, b#0: ref)
{
  ...
  var b$reqreads#1: bool;
    ...
    else
    {
        ...
        assert {:id "id2"} b#0 != null;
        b$reqreads#1 := (forall $i: int :: 
          { $_ReadsFrame[b#0, IndexField($i)] } 
          0 <= $i && $i < _System.array.Length(b#0) ==> $_ReadsFrame[b#0, IndexField($i)]);
        assume {:id "id3"} DtypeRegression.__default.array__equal($Heap, a#0, b#0)
           == Seq#Equal(Seq#FromArray($Heap, a#0), Seq#FromArray($Heap, b#0));
        assume true;
...
procedure {:verboseName "DtypeRegression.duplicate_array (well-formedness)"} CheckWellFormed$$DtypeRegression.__default.duplicate__array(input#0: ref
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "DtypeRegression.duplicate_array (well-formedness)"} CheckWellFormed$$DtypeRegression.__default.duplicate__array(input#0: ref, len#0: int) returns (output#0: ref)
{
  ...
  var ##b#0: ref;
    ...
    assert {:id "id6"} input#0 != null;
    assume {:id "id7"} len#0 == _System.array.Length(input#0);
    havoc $Heap;
    assume (forall $o: ref :: 
      { $Heap[$o] } 
    ...
    assume {:id "id8"} DtypeRegression.__default.array__equal($Heap, input#0, output#0);
}



procedure {:verboseName "DtypeRegression.duplicate_array (call)"} Call$$DtypeRegression.__default.duplicate__array(input#0: ref
       where $Is(input#0, Tclass._System.array(TInt))
         && $IsAlloc(input#0, Tclass._System.array(TInt), $Heap), 
    len#0: int)
   returns (output#0: ref
  ...
  requires {:id "id9"} len#0 == _System.array.Length(input#0);
  modifies $Heap;
  // user-defined postconditions
  free ensures DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0);
  free ensures {:id "id10"} DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0)
     && 
...
procedure {:verboseName "DtypeRegression.duplicate_array (correctness)"} Impl$$DtypeRegression.__default.duplicate__array(input#0: ref
       where $Is(input#0, Tclass._System.array(TInt))
         && $IsAlloc(input#0, Tclass._System.array(TInt), $Heap), 
    len#0: int)
   returns (output#0: ref
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id11"} len#0 == _System.array.Length(input#0);
  modifies $Heap;
  // user-defined postconditions
  free ensures DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0);
  ensures {:id "id12"} DtypeRegression.__default.array__equal#canCall($Heap, input#0, output#0)
     ==> DtypeRegression.__default.array__equal($Heap, input#0, output#0)
       || Seq#Equal(Seq#FromArray($Heap, input#0), Seq#FromArray($Heap, output#0));
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "DtypeRegression.duplicate_array (correctness)"} Impl$$DtypeRegression.__default.duplicate__array(input#0: ref, len#0: int) returns (output#0: ref, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $nw: ref;
  var i#0: int;
  ...
  var $rhs#0_0: int;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Array.dfy(314,12)
    assume true;
    assert {:id "id13"} 0 <= len#0;
    havoc $nw;
    ...
    output#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Array.dfy(315,11)
    assume true;
    assume true;
    i#0 := LitInt(0);
    // ----- while statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Array.dfy(316,5)
    ...
    while (true)
      free invariant true;
      invariant {:id "id17"} $w$loop#0 ==> LitInt(0) <= i#0;
      invariant {:id "id18"} $w$loop#0 ==> i#0 <= len#0;
      free invariant true;
      ...
      free invariant len#0 - i#0 <= $decr_init$loop#00;
    {
        if (!$w$loop#0)
        {
            ...
            assume true;
            assume {:id "id16"} LitInt(0) <= i#0 && i#0 <= len#0;
            ...
            if (true)
            {
                ...
                {
                    assert {:id "id19"} output#0 != null;
                    assert {:id "id20"} {:subsumption 0} 0 <= j#0 && j#0 < _System.array.Length(output#0);
                    assert {:id "id21"} input#0 != null;
                    assert {:id "id22"} {:subsumption 0} 0 <= j#0 && j#0 < _System.array.Length(input#0);
                }
            }

            // End Comprehension WF check
            assume true;
            assume {:id "id23"} (forall j#1: int :: 
              { $Unbox(read($Heap, input#0, IndexField(j#1))): int } 
                { $Unbox(read($Heap, output#0, IndexField(j#1))): int } 
              LitInt(0) <= j#1 && j#1 < i#0
                 ==> $Unbox(read($Heap, output#0, IndexField(j#1))): int
        ...
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Array.dfy(320,17)
        assert {:id "id25"} output#0 != null;
        assert {:id "id26"} 0 <= i#0 && i#0 < _System.array.Length(output#0);
        assume true;
        assert {:id "id27"} $_ModifiesFrame[output#0, IndexField(i#0)];
        assert {:id "id28"} input#0 != null;
        assert {:id "id29"} 0 <= i#0 && i#0 < _System.array.Length(input#0);
        assume true;
        $rhs#0_0 := $Unbox(read($Heap, input#0, IndexField(i#0))): int;
        $Heap := update($Heap, output#0, IndexField(i#0), $Box($rhs#0_0));
        assume $IsGoodHeap($Heap);
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Array.dfy(321,9)
        assume true;
        assume true;
        i#0 := i#0 + 1;
        // ----- loop termination check ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Array.dfy(316,5)
        assert {:id "id33"} 0 <= $decr$loop#00 || len#0 - i#0 == $decr$loop#00;
        assert {:id "id34"} len#0 - i#0 < $decr$loop#00;
        assume true;
    }
}
