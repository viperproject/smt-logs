...
(assert (distinct TBool TInt TagBool TagInt alloc allocName Tagclass._module.Node Tagclass._module.List Tagclass._module.Node? |##_module.List.Nil| |##_module.List.Cons| class._module.Node? tytagFamily$Node tytagFamily$List field$data field$next)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@2 T@U) ($o@@2 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass._module.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) _module.Node.data)) TInt $h@@2))
 ...
 :skolemid |2572|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) _module.Node.data)))
)))
...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass._module.Node) (and (= ($Box refType ($Unbox refType bx)) bx) ($Is refType ($Unbox refType bx) Tclass._module.Node)))
 :qid |unknown.0:0|
 :skolemid |2478|
 :pattern ( ($IsBox bx Tclass._module.Node))
)))
...
(assert (forall (($ly@@0 T@U) ($Heap@@0 T@U) (this@@0 T@U) (|list#0@@0| T@U) ) (! (= (_module.Node.Repr ($LS $ly@@0) $Heap@@0 this@@0 |list#0@@0|) (_module.Node.Repr $ly@@0 $Heap@@0 this@@0 |list#0@@0|))
 :qid |Datatypesdfy.10:18|
 :skolemid |2575|
 :pattern ( (_module.Node.Repr ($LS $ly@@0) $Heap@@0 this@@0 |list#0@@0|))
)))
...
(set-info :boogie-vc-id CheckWellformed$$_module.Node.Repr)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon9_correct  (=> (= (_module.Node.Repr ($LS $LZ) $Heap@@1 this@@1 |list#0@@1|)  (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.data))) |d#Z#0@0|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) null)) (not true))) (_module.Node.Repr ($LS $LZ) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) |cdr#Z#0@0|))) (=> (and (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.data))) |d#Z#0@0|) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) null)) (not true)) (|_module.Node.Repr#canCall| $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) |cdr#Z#0@0|))) ($Is boolType (bool_2_U (_module.Node.Repr ($LS $LZ) $Heap@@1 this@@1 |list#0@@1|)) TBool)) (and (=> (= (ControlFlow 0 10) (- 0 13)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 10) (- 0 12)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (and (=> (= (ControlFlow 0 10) (- 0 11)) |b$reqreads#2@1|) (=> |b$reqreads#2@1| (=> (= (ControlFlow 0 10) (- 0 9)) |b$reqreads#3@1|)))))))))))
(let ((anon16_Else_correct  (=> (and (and (not (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.data))) |d#Z#0@0|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) null)) (not true)))) (= |b$reqreads#2@1| true)) (and (= |b$reqreads#3@1| true) (= (ControlFlow 0 17) 10))) anon9_correct)))
(let ((anon16_Then_correct  (=> (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.data))) |d#Z#0@0|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) null)) (not true))) (= |b$reqreads#2@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Node.next)))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) null)) (not true)) (=> ($IsAllocBox (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next) Tclass._module.Node? $Heap@@1) (=> (and ($IsAlloc DatatypeTypeType |cdr#Z#0@0| (Tclass._module.List TInt) $Heap@@1) (= |b$reqreads#3@0| (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@6) alloc)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@6) alloc)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@6 $f@@0)))
 :qid |Datatypesdfy.17:41|
 :skolemid |2582|
)))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (< (DtRank |cdr#Z#0@0|) (DtRank |list#0@@1|))) (=> (< (DtRank |cdr#Z#0@0|) (DtRank |list#0@@1|)) (=> (and (and (|_module.Node.Repr#canCall| $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) |cdr#Z#0@0|) (= |b$reqreads#2@1| |b$reqreads#2@0|)) (and (= |b$reqreads#3@1| |b$reqreads#3@0|) (= (ControlFlow 0 14) 10))) anon9_correct))))))))))
(let ((anon15_Else_correct  (=> (and (or (not (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.data))) |d#Z#0@0|)) (not true)) (= |b$reqreads#1@1| true)) (and (=> (= (ControlFlow 0 19) 14) anon16_Then_correct) (=> (= (ControlFlow 0 19) 17) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.data))) |d#Z#0@0|) (=> (and (= |b$reqreads#1@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Node.next))) (= |b$reqreads#1@1| |b$reqreads#1@0|)) (and (=> (= (ControlFlow 0 18) 14) anon16_Then_correct) (=> (= (ControlFlow 0 18) 17) anon16_Else_correct))))))
(let ((anon14_Then_correct  (=> (= |list#0@@1| (|#_module.List.Cons| ($Box intType (int_2_U |_mcc#0#0|)) |_mcc#1#0|)) (=> (and (and (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.List TInt)) (= |let#0#0#0| |_mcc#1#0|)) (and ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.List TInt)) (= |cdr#Z#0@0| |let#0#0#0|))) (and (and (= |let#1#0#0| |_mcc#0#0|) ($Is intType (int_2_U |let#1#0#0|) TInt)) (and (= |d#Z#0@0| |let#1#0#0|) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Node.data)))))) (and (=> (= (ControlFlow 0 20) 18) anon15_Then_correct) (=> (= (ControlFlow 0 20) 19) anon15_Else_correct))))))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |list#0@@1| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 21) 20) anon14_Then_correct) (=> (= (ControlFlow 0 21) 8) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (and (and (= |list#0@@1| |#_module.List.Nil|) (= |b$reqreads#4@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@1 _module.Node.next)))) (and (= (_module.Node.Repr ($LS $LZ) $Heap@@1 this@@1 |list#0@@1|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@1) _module.Node.next)) null)) ($Is boolType (bool_2_U (_module.Node.Repr ($LS $LZ) $Heap@@1 this@@1 |list#0@@1|)) TBool))) (and (=> (= (ControlFlow 0 3) (- 0 7)) true) (and (=> (= (ControlFlow 0 3) (- 0 6)) true) (and (=> (= (ControlFlow 0 3) (- 0 5)) true) (and (=> (= (ControlFlow 0 3) (- 0 4)) true) (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#4@0|))))))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#15| null $Heap@@1 alloc $Heap@@1 alloc)) (and (and (=> (= (ControlFlow 0 22) 1) anon12_Then_correct) (=> (= (ControlFlow 0 22) 3) anon13_Then_correct)) (=> (= (ControlFlow 0 22) 21) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.Node) ($IsAlloc refType this@@1 Tclass._module.Node $Heap@@1))) ($Is DatatypeTypeType |list#0@@1| (Tclass._module.List TInt))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 23) 22))) anon0_correct))))
