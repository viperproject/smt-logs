...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (_module.natinf.N_q |x#0@@11|)) (=> (_module.natinf.N_q |x#0@@11|) (=> (= (ControlFlow 0 3) (- 0 2)) (= (Mod (_module.natinf.n |x#0@@11|) (LitInt 2)) (LitInt 0)))))))
(let ((anon3_Then_correct  (=> (and (and ($IsAlloc BoxType |k#1@0| TORDINAL $Heap@0) ($IsAlloc DatatypeTypeType |x#0@@11| Tclass._module.natinf $Heap@0)) (and (|_module.__default.Even_h#canCall| |k#1@0| |x#0@@11|) (|_module.__default.Even_h#canCall| |k#1@0| |x#0@@11|))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (exists ((|$as#k0#0| T@U) ) (! (_module.__default.Even_h ($LS $LZ) |$as#k0#0| |x#0@@11|)
 :qid |InductivePredicatesdfy.16:7|
 :skolemid |2841|
))) (=> (exists ((|$as#k0#0@@0| T@U) ) (! (_module.__default.Even_h ($LS $LZ) |$as#k0#0@@0| |x#0@@11|)
 :qid |InductivePredicatesdfy.16:7|
 :skolemid |2841|
)) (=> (_module.__default.Even_h ($LS $LZ) |k#0@0| |x#0@@11|) (and (=> (= (ControlFlow 0 5) (- 0 7)) (=> (|_module.__default.Even_h#canCall| |k#0@0| |x#0@@11|) (or (_module.__default.Even_h ($LS $LZ) |k#0@0| |x#0@@11|) (=> (< 0 (|ORD#Offset| |k#0@0|)) (or (and (_module.natinf.N_q |x#0@@11|) (= (_module.natinf.n |x#0@@11|) (LitInt 0))) (and (and (_module.natinf.N_q |x#0@@11|) (<= (LitInt 2) (_module.natinf.n |x#0@@11|))) (_module.__default.Even_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0@0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@11|) 2))))))))) (=> (=> (|_module.__default.Even_h#canCall| |k#0@0| |x#0@@11|) (or (_module.__default.Even_h ($LS $LZ) |k#0@0| |x#0@@11|) (=> (< 0 (|ORD#Offset| |k#0@0|)) (or (and (_module.natinf.N_q |x#0@@11|) (= (_module.natinf.n |x#0@@11|) (LitInt 0))) (and (and (_module.natinf.N_q |x#0@@11|) (<= (LitInt 2) (_module.natinf.n |x#0@@11|))) (_module.__default.Even_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0@0| (|ORD#FromNat| 1)) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@11|) 2)))))))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (=> (|_module.__default.Even_h#canCall| |k#0@0| |x#0@@11|) (or (_module.__default.Even_h ($LS $LZ) |k#0@0| |x#0@@11|) (=> (= (LitInt 0) (|ORD#Offset| |k#0@0|)) (exists ((|_k'#0@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@1| |k#0@0|) (_module.__default.Even_h ($LS $LZ) |_k'#0@@1| |x#0@@11|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2843|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#0@@1| |x#0@@11|))
)))))) (=> (=> (|_module.__default.Even_h#canCall| |k#0@0| |x#0@@11|) (or (_module.__default.Even_h ($LS $LZ) |k#0@0| |x#0@@11|) (=> (= (LitInt 0) (|ORD#Offset| |k#0@0|)) (exists ((|_k'#0@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@2| |k#0@0|) (_module.__default.Even_h ($LS $LZ) |_k'#0@@2| |x#0@@11|))
 :qid |InductivePredicatesdfy.6:17|
 :skolemid |2843|
 :pattern ( (_module.__default.Even_h ($LS $LZ) |_k'#0@@2| |x#0@@11|))
))))) (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (_module.natinf.N_q |x#0@@11|) (= (Mod (_module.natinf.n |x#0@@11|) (LitInt 2)) (LitInt 0))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 5) 3))) GeneratedUnifiedExit_correct))))))))))))
(let ((anon3_Else_correct true))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.natinf| |x#0@@11|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#x0#0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |$ih#x0#0| Tclass._module.natinf) (_module.__default.Even ($LS $LZ) |$ih#x0#0|)) (< (DtRank |$ih#x0#0|) (DtRank |x#0@@11|))) (and (_module.natinf.N_q |$ih#x0#0|) (= (Mod (_module.natinf.n |$ih#x0#0|) (LitInt 2)) (LitInt 0))))
 :qid |InductivePredicatesdfy.12:9|
 :skolemid |2840|
 :pattern ( (_module.natinf.n |$ih#x0#0|))
 :pattern ( (_module.natinf.N_q |$ih#x0#0|))
 :pattern ( (_module.__default.Even ($LS $LZ) |$ih#x0#0|))
)))) (and (=> (= (ControlFlow 0 9) 5) anon3_Then_correct) (=> (= (ControlFlow 0 9) 1) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |x#0@@11| Tclass._module.natinf) ($IsAlloc DatatypeTypeType |x#0@@11| Tclass._module.natinf $Heap)) (|$IsA#_module.natinf| |x#0@@11|)) (= 4 $FunctionContextHeight)) (and (and (|_module.__default.Even#canCall| |x#0@@11|) (and (_module.__default.Even ($LS $LZ) |x#0@@11|) (or (and (_module.natinf.N_q |x#0@@11|) (= (_module.natinf.n |x#0@@11|) (LitInt 0))) (and (and (_module.natinf.N_q |x#0@@11|) (<= (LitInt 2) (_module.natinf.n |x#0@@11|))) (_module.__default.Even ($LS $LZ) (|#_module.natinf.N| (- (_module.natinf.n |x#0@@11|) 2))))))) (= (ControlFlow 0 10) 9))) anon0_correct))))
