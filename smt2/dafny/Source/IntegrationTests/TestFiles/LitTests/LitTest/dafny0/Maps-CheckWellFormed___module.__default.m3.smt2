...
(let ((anon4_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|)))) (=> (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U |i#0@0|))))) (Mul |i#0@0| |i#0@0|)) (= (ControlFlow 0 3) 1)) anon6_correct))))))
...
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (and (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U |i#0@0|))))) (Mul |i#0@0| |i#0@0|)))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (=> (= (ControlFlow 0 7) 2) anon7_Else_correct) (=> (= (ControlFlow 0 7) 5) anon8_Then_correct)) (=> (= (ControlFlow 0 7) 6) anon8_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MapType |a#0| (TMap TInt TInt)) ($IsAlloc MapType |a#0| (TMap TInt TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
