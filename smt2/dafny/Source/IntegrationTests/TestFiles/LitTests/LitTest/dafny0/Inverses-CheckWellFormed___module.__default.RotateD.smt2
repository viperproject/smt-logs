...
(declare-fun _module._default.RotateD$T () T@U)
(declare-fun |r#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.RotateD)
...
(let ((anon4_correct  (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 3) (- 0 9)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 8)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 7)) (or (not (= (_System.array.Length |a#0|) 0)) (not true))) (=> (or (not (= (_System.array.Length |a#0|) 0)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 (Mod (+ |k#0@0| 1) (_System.array.Length |a#0|))) (< (Mod (+ |k#0@0| 1) (_System.array.Length |a#0|)) (_System.array.Length |r#0@0|)))) (=> (and (<= 0 (Mod (+ |k#0@0| 1) (_System.array.Length |a#0|))) (< (Mod (+ |k#0@0| 1) (_System.array.Length |a#0|)) (_System.array.Length |r#0@0|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|))) (=> (and (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) (IndexField (Mod (+ |k#0@0| 1) (_System.array.Length |a#0|)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |k#0@0|))) (= (ControlFlow 0 3) 1)) anon6_correct))))))))))))))))
(let ((anon8_Else_correct  (=> (and (< |k#0@0| (LitInt 0)) (= (ControlFlow 0 12) 3)) anon4_correct)))
(let ((anon8_Then_correct  (=> (<= (LitInt 0) |k#0@0|) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (ControlFlow 0 10) 3) anon4_correct))))))
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |k#0@0|) (< |k#0@0| (_System.array.Length |a#0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |r#0@0|) (IndexField (Mod (+ |k#0@0| 1) (_System.array.Length |a#0|)))) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |k#0@0|)))) (= (ControlFlow 0 2) 1)) anon6_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |Inversesdfy.99:8|
 :skolemid |576|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is refType |r#0@0| (Tclass._System.array _module._default.RotateD$T)) ($IsAlloc refType |r#0@0| (Tclass._System.array _module._default.RotateD$T) $Heap@0)) (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |r#0@0|) alloc))))))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (_System.array.Length |r#0@0|) (_System.array.Length |a#0|)) (and (and (=> (= (ControlFlow 0 13) 2) anon7_Else_correct) (=> (= (ControlFlow 0 13) 10) anon8_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon8_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array _module._default.RotateD$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.RotateD$T) $Heap))) (and (and ($Is refType |r#0| (Tclass._System.array _module._default.RotateD$T)) ($IsAlloc refType |r#0| (Tclass._System.array _module._default.RotateD$T) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 16) 13)))) anon0_correct)))
