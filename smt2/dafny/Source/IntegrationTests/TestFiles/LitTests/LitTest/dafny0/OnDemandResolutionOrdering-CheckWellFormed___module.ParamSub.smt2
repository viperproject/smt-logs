...
(declare-fun _module.ParamSub$X () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellFormed$$_module.ParamSub)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (|_module.CC.GetEmpty#canCall| _module.ParamSub$X) (= (ControlFlow 0 3) (- 0 2))) (|Seq#Equal| |Seq#Empty| (_module.CC.GetEmpty _module.ParamSub$X)))))
