...
(declare-fun |y#0| () T@U)
(declare-fun |x#0| () T@U)
(set-info :boogie-vc-id CheckWellFormed$$Basic.U.AM)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon4_Else_correct  (=> (not (forall (($o@@5 T@U) ($f@@1 T@U) ) (!  (=> (or (not (= $o@@5 null)) (not true)) (=> (and (= $o@@5 this@@1) (or (= $f@@1 Basic.U.aa) (= $f@@1 alloc))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@5) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@5) $f@@1))))
...
))) (=> (and ($IsAllocBox ($Box refType this@@1) Tclass.Basic.U? $Heap@0) (= (ControlFlow 0 4) (- 0 3))) ($IsAlloc refType this@@1 Tclass.Basic.U $Heap@@0)))))
(let ((anon4_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType this@@1 Tclass.Basic.U $Heap@@0))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@0 alloc |y#0|)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@6) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@6)) (= $o@@6 |y#0|)))
 :qid |TwostateFunctionsdfy.57:12|
 :skolemid |641|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap@@0 $Heap@0))) (and (=> (= (ControlFlow 0 5) 2) anon4_Then_correct) (=> (= (ControlFlow 0 5) 4) anon4_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.Basic.U) ($IsAlloc refType this@@1 Tclass.Basic.U $Heap@@0))) (and ($Is refType |x#0| Tclass.Basic.U) ($IsAlloc refType |x#0| Tclass.Basic.U $Heap@@0))) (and (and ($Is refType |y#0| Tclass.Basic.U) ($IsAlloc refType |y#0| Tclass.Basic.U $Heap@@0)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5)))) anon0_correct))))
