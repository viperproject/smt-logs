...
(assert (forall (($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (|d#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Hof.D.Q#canCall| $prevHeap@@2 $h0 |d#0|) ($Is refType |d#0| Tclass.Hof.D))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@4 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@4 null)) (not true)) (= $o@@4 |d#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@4) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@4) $f@@0)))) (= (Hof.D.Q $prevHeap@@2 $h0 |d#0|) (Hof.D.Q $prevHeap@@2 $h1 |d#0|))))
