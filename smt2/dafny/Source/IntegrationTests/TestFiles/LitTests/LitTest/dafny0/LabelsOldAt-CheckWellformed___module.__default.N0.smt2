...
(declare-fun _module.__default.N0 (T@U T@U T@U T@U T@U) Bool)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.N0#canCall| (T@U T@U T@U T@U T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap T@U) ($Heap T@U) (|u#0| T@U) (|s#0| T@U) (|t#0| T@U) ) (!  (=> (or (|_module.__default.N0#canCall| $prevHeap $Heap |u#0| |s#0| |t#0|) (and (< 1 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $prevHeap) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap $Heap)) ($Is refType |u#0| Tclass._module.C)) ($Is SetType |s#0| (TSet Tclass._module.C))) ($Is SeqType |t#0| (TSeq Tclass._module.C))))) (= (_module.__default.N0 $prevHeap $Heap |u#0| |s#0| |t#0|)  (and (and (forall (($o@@2 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@2 null)) (not true)) (=> (= $o@@2 |u#0|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap $o@@2) $f@@0))))
 ...
 :qid |LabelsOldAtdfy.271:20|
 :skolemid |1469|
 :pattern ( (_module.__default.N0 $prevHeap $Heap |u#0| |s#0| |t#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (|u#0@@0| T@U) (|s#0@@0| T@U) (|t#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|_module.__default.N0#canCall| $prevHeap@@0 $h0 |u#0@@0| |s#0@@0| |t#0@@0|) (and (and ($Is refType |u#0@@0| Tclass._module.C) ($Is SetType |s#0@@0| (TSet Tclass._module.C))) ($Is SeqType |t#0@@0| (TSeq Tclass._module.C))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@5 T@U) ($f@@3 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (or (or (= $o@@5 |u#0@@0|) (|Set#IsMember| |s#0@@0| ($Box refType $o@@5))) (exists (($i@@1 Int) ) (!  (and (and (<= 0 $i@@1) (< $i@@1 (|Seq#Length| |t#0@@0|))) (= (|Seq#Index| |t#0@@0| $i@@1) ($Box refType $o@@5)))
 :qid |LabelsOldAtdfy.271:20|
 :skolemid |1458|
 ...
 :qid |unknown.0:0|
 :skolemid |1459|
)) (= (_module.__default.N0 $prevHeap@@0 $h0 |u#0@@0| |s#0@@0| |t#0@@0|) (_module.__default.N0 $prevHeap@@0 $h1 |u#0@@0| |s#0@@0| |t#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1460|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.__default.N0 $prevHeap@@0 $h1 |u#0@@0| |s#0@@0| |t#0@@0|))
)))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.N0)
...
)))) ($Is boolType (bool_2_U (_module.__default.N0 $Heap@@0 current$Heap |u#0@@1| |s#0@@1| |t#0@@1|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 5)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#2@1|))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |u#0@@1| Tclass._module.C) ($IsAlloc refType |u#0@@1| Tclass._module.C current$Heap)) (and ($Is SetType |s#0@@1| (TSet Tclass._module.C)) ($IsAlloc SetType |s#0@@1| (TSet Tclass._module.C) current$Heap))) (=> (and (and (and ($Is SeqType |t#0@@1| (TSeq Tclass._module.C)) ($IsAlloc SeqType |t#0@@1| (TSeq Tclass._module.C) current$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@0) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 19) 18))) anon0_correct)))))
