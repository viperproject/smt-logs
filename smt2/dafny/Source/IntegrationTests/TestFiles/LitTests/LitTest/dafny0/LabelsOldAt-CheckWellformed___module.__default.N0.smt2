...
))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (=> (and (<= 0 |$unchanged#x1@0|) (< |$unchanged#x1@0| (|Seq#Length| |t#0@@1|))) ($IsAlloc refType ($Unbox refType (|Seq#Index| |t#0@@1| |$unchanged#x1@0|)) Tclass._module.C $Heap@@0))) (=> (=> (and (<= 0 |$unchanged#x1@0|) (< |$unchanged#x1@0| (|Seq#Length| |t#0@@1|))) ($IsAlloc refType ($Unbox refType (|Seq#Index| |t#0@@1| |$unchanged#x1@0|)) Tclass._module.C $Heap@@0)) (=> (= |b$reqreads#2@0| (forall (($o@@13 T@U) ($f@@11 T@U) )  (=> (and (and (or (not (= $o@@13 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@13) alloc)))) (exists (($i@@3 Int) )  (and (and (<= 0 $i@@3) (< $i@@3 (|Seq#Length| |t#0@@1|))) (= (|Seq#Index| |t#0@@1| $i@@3) ($Box refType $o@@13))))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@13 $f@@11))))) (=> (and (= |b$reqreads#2@1| |b$reqreads#2@0|) (= (ControlFlow 0 6) 3)) anon10_correct)))))))
