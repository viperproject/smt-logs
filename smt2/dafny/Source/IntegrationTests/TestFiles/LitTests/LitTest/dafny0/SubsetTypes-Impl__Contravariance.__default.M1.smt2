...
(assert (distinct TInt TagInt alloc Tagclass._System.nat Tagclass._System.___hFunc1 tytagFamily$nat |tytagFamily$_#Func1|)
)
...
(set-info :boogie-vc-id Impl$$Contravariance.__default.M1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon9_Else_correct  (=> (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 9) (- 0 8))) false)))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 7) (- 0 6)) ($Is HandleTypeType |d#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)))))
(let ((anon8_Then_correct  (=> (= (ControlFlow 0 5) (- 0 4)) ($Is HandleTypeType |c#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)))))
(let ((anon7_Then_correct true))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) ($Is HandleTypeType |a#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (=> (= (ControlFlow 0 10) 2) anon6_Then_correct) (=> (= (ControlFlow 0 10) 3) anon7_Then_correct)) (=> (= (ControlFlow 0 10) 5) anon8_Then_correct)) (=> (= (ControlFlow 0 10) 7) anon9_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is HandleTypeType |a#0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |a#0| (Tclass._System.___hFunc1 TInt TInt) $Heap)) (and ($Is HandleTypeType |b#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)) ($IsAlloc HandleTypeType |b#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat) $Heap))) (=> (and (and (and ($Is HandleTypeType |c#0| (Tclass._System.___hFunc1 Tclass._System.nat TInt)) ($IsAlloc HandleTypeType |c#0| (Tclass._System.___hFunc1 Tclass._System.nat TInt) $Heap)) (and ($Is HandleTypeType |d#0| (Tclass._System.___hFunc1 Tclass._System.nat Tclass._System.nat)) ($IsAlloc HandleTypeType |d#0| (Tclass._System.___hFunc1 Tclass._System.nat Tclass._System.nat) $Heap))) (and (and ($Is HandleTypeType |r#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)) ($IsAlloc HandleTypeType |r#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 11) 10)))) anon0_correct)))))
