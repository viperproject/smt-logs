...
(declare-fun EqualitySupport.Enum.P (T@U) Bool)
(declare-fun |EqualitySupport.Enum.P#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|EqualitySupport.Enum.P#canCall| this) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this Tclass.EqualitySupport.Enum))) (and (|$IsA#EqualitySupport.Enum| this) (= (EqualitySupport.Enum.P this)  (not (|EqualitySupport.Enum#Equal| this |#EqualitySupport.Enum.EnumB|)))))
 :qid |GhostDatatypeConstructorsVerificationdfy.185:15|
 :skolemid |2698|
 :pattern ( (EqualitySupport.Enum.P this))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|EqualitySupport.Enum.P#canCall| (Lit DatatypeTypeType this@@0)) (and (< 1 $FunctionContextHeight) ($Is DatatypeTypeType this@@0 Tclass.EqualitySupport.Enum))) (and (|$IsA#EqualitySupport.Enum| (Lit DatatypeTypeType this@@0)) (= (EqualitySupport.Enum.P (Lit DatatypeTypeType this@@0))  (not (|EqualitySupport.Enum#Equal| this@@0 |#EqualitySupport.Enum.EnumB|)))))
 :qid |GhostDatatypeConstructorsVerificationdfy.185:15|
 :weight 3
 :skolemid |2699|
 :pattern ( (EqualitySupport.Enum.P (Lit DatatypeTypeType this@@0)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$EqualitySupport.Enum.P)
