...
(let ((anon7_Else_correct  (=> (and (not (and (< |j#0| |n#0|) (= |n#0| (_System.array.Length |a#0|)))) (= (ControlFlow 0 5) 1)) anon5_correct)))
(let ((anon7_Then_correct  (=> (and (< |j#0| |n#0|) (= |n#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (=> (= (ControlFlow 0 2) 1) anon5_correct))))))))
(let ((anon6_Else_correct  (=> (<= |n#0| |j#0|) (and (=> (= (ControlFlow 0 8) 2) anon7_Then_correct) (=> (= (ControlFlow 0 8) 5) anon7_Else_correct)))))
(let ((anon6_Then_correct  (=> (< |j#0| |n#0|) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) 2) anon7_Then_correct) (=> (= (ControlFlow 0 6) 5) anon7_Else_correct)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (and ($Is refType |c#0@@1| (Tclass._System.array TInt)) ($IsAlloc refType |c#0@@1| (Tclass._System.array TInt) $Heap))) (and (and (<= (LitInt 0) |n#0|) (<= (LitInt 0) |j#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct))))
