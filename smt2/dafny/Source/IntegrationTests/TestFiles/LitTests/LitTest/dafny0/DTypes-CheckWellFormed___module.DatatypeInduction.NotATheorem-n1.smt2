...
(set-info :boogie-vc-id CheckWellFormed$$_module.DatatypeInduction.NotATheorem0)
...
(assert (not
 ...
 :qid |DTypesdfy.118:10|
 :skolemid |2138|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($IsAllocBox ($Box refType this@@3) (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@13) $Heap@0) ($IsAlloc DatatypeTypeType |tree#0@@3| (Tclass._module.Tree _module.DatatypeInduction$T@@13) $Heap@0)) (and (|_module.DatatypeInduction.LeafCount#canCall| _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 this@@3 |tree#0@@3|) (= (ControlFlow 0 2) (- 0 1))))) (or (not (= (LitInt 2) 0)) (not true))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($AlwaysAllocated _module.DatatypeInduction$T@@13)) (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@13)) ($IsAlloc refType this@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@13) $Heap)))) (and (and (and ($Is DatatypeTypeType |tree#0@@3| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) ($IsAlloc DatatypeTypeType |tree#0@@3| (Tclass._module.Tree _module.DatatypeInduction$T@@13) $Heap)) (|$IsA#_module.Tree| |tree#0@@3|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
