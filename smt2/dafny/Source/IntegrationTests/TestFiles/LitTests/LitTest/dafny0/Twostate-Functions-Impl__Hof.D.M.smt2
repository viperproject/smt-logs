...
(declare-fun Hof.D.P (T@U T@U T@U T@U) Int)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun Tclass.Hof.D () T@U)
(declare-fun |Hof.D.P#Handle| (T@U T@U) T@U)
...
(declare-fun |Hof.D.P#canCall| (T@U T@U T@U T@U) Bool)
...
(declare-fun |Hof.D.P#requires| (T@U T@U T@U T@U) Bool)
...
(assert (forall (($prevHeap T@U) ($self T@U) ($heap T@U) (|$fh$0x#0| T@U) ) (! (= (Hof.D.P $prevHeap $heap $self |$fh$0x#0|) (U_2_int ($Unbox intType (Apply1 Tclass.Hof.D TInt $heap (|Hof.D.P#Handle| $prevHeap $self) ($Box refType |$fh$0x#0|)))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2550|
 :pattern ( (Hof.D.P $prevHeap $heap $self |$fh$0x#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@0 T@U) ($Heap T@U) (this T@U) (|d#0| T@U) ) (!  (=> (or (|Hof.D.P#canCall| $prevHeap@@0 $Heap this |d#0|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@0) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@0 $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass.Hof.D) ($IsAlloc refType this Tclass.Hof.D $prevHeap@@0)))) ($Is refType |d#0| Tclass.Hof.D)))) (= (Hof.D.P $prevHeap@@0 $Heap this |d#0|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |d#0|) Hof.D.data)))))
 :qid |TwostateFunctionsdfy.155:23|
 :skolemid |2543|
 :pattern ( (Hof.D.P $prevHeap@@0 $Heap this |d#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($prevHeap@@1 T@U) ($self@@0 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 Tclass.Hof.D TInt $heap@@0 (|Hof.D.P#Handle| $prevHeap@@1 $self@@0) |$fh$0x#0@@0|) (|Hof.D.P#requires| $prevHeap@@1 $heap@@0 $self@@0 ($Unbox refType |$fh$0x#0@@0|)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2548|
 :pattern ( (Requires1 Tclass.Hof.D TInt $heap@@0 (|Hof.D.P#Handle| $prevHeap@@1 $self@@0) |$fh$0x#0@@0|))
)))
...
(assert (forall (($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (this@@0 T@U) (|d#0@@0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.Hof.D))) (or (|Hof.D.P#canCall| $prevHeap@@2 $h0 this@@0 |d#0@@0|) ($Is refType |d#0@@0| Tclass.Hof.D))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |d#0@@0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))
 :qid |unknown.0:0|
 :skolemid |2538|
)) (= (Hof.D.P $prevHeap@@2 $h0 this@@0 |d#0@@0|) (Hof.D.P $prevHeap@@2 $h1 this@@0 |d#0@@0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2540|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (Hof.D.P $prevHeap@@2 $h1 this@@0 |d#0@@0|))
)))
...
(assert (forall (($bx T@U) ($prevHeap@@3 T@U) ($self@@1 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (|Set#IsMember| (Reads1 Tclass.Hof.D TInt $heap@@1 (|Hof.D.P#Handle| $prevHeap@@3 $self@@1) |$fh$0x#0@@1|) $bx) (= ($Unbox refType $bx) ($Unbox refType |$fh$0x#0@@1|)))
 :qid |unknown.0:0|
 :skolemid |2549|
 :pattern ( (|Set#IsMember| (Reads1 Tclass.Hof.D TInt $heap@@1 (|Hof.D.P#Handle| $prevHeap@@3 $self@@1) |$fh$0x#0@@1|) $bx))
)))
(assert (forall (($prevHeap@@4 T@U) ($self@@2 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Apply1 Tclass.Hof.D TInt $heap@@2 (|Hof.D.P#Handle| $prevHeap@@4 $self@@2) |$fh$0x#0@@2|) ($Box intType (int_2_U (Hof.D.P $prevHeap@@4 $heap@@2 $self@@2 ($Unbox refType |$fh$0x#0@@2|)))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2547|
 :pattern ( (Apply1 Tclass.Hof.D TInt $heap@@2 (|Hof.D.P#Handle| $prevHeap@@4 $self@@2) |$fh$0x#0@@2|))
)))
...
(assert (forall (($prevHeap@@5 T@U) ($Heap@@0 T@U) (this@@1 T@U) (|d#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $prevHeap@@5) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@5 $Heap@@0)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.Hof.D) ($IsAlloc refType this@@1 Tclass.Hof.D $prevHeap@@5)))) ($Is refType |d#0@@1| Tclass.Hof.D)) (= (|Hof.D.P#requires| $prevHeap@@5 $Heap@@0 this@@1 |d#0@@1|) ($IsAlloc refType |d#0@@1| Tclass.Hof.D $prevHeap@@5)))
 :qid |TwostateFunctionsdfy.155:23|
 :skolemid |2542|
 :pattern ( (|Hof.D.P#requires| $prevHeap@@5 $Heap@@0 this@@1 |d#0@@1|) ($IsGoodHeap $Heap@@0))
)))
...
(declare-fun |p#1_0_0| () T@U)
(declare-fun |p#1_1_0| () T@U)
(set-info :boogie-vc-id Impl$$Hof.D.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon6_Else_correct  (and (=> (= (ControlFlow 0 11) (- 0 13)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType this@@2 Tclass.Hof.D $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass.Hof.D $Heap@@1) (=> (and (= |p#1_1_0@0| (|Hof.D.P#Handle| $Heap@@1 this@@2)) (= (ControlFlow 0 11) (- 0 10))) (Requires1 Tclass.Hof.D TInt $Heap@0 |p#1_1_0@0| ($Box refType |e#0|)))))))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= 1 $FunctionContextHeight)) (not true))) (=> (or (not (= 1 $FunctionContextHeight)) (not true)) (and (=> (= (ControlFlow 0 6) (- 0 8)) ($IsAlloc refType this@@2 Tclass.Hof.D $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass.Hof.D $Heap@@1) (=> (= |p#1_0_0@0| (|Hof.D.P#Handle| $Heap@@1 this@@2)) (and (=> (= (ControlFlow 0 6) (- 0 7)) true) (=> (= (ControlFlow 0 6) (- 0 5)) (Requires1 Tclass.Hof.D TInt $Heap@0 |p#1_0_0@0| ($Box refType $nw@0)))))))))))
(let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 14) 6) anon6_Then_correct) (=> (= (ControlFlow 0 14) 11) anon6_Else_correct))))
(let ((anon5_Then_correct  (=> ($IsAllocBox ($Box refType this@@2) Tclass.Hof.D? $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (=> ($IsAlloc refType $nw@0 Tclass.Hof.D $Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType this@@2 Tclass.Hof.D $Heap@@1)) (=> ($IsAlloc refType this@@2 Tclass.Hof.D $Heap@@1) (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAlloc refType $nw@0 Tclass.Hof.D $Heap@@1)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap@@1 alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass.Hof.D?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 15) 2) anon5_Then_correct) (=> (= (ControlFlow 0 15) 14) anon5_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.Hof.D) ($IsAlloc refType this@@2 Tclass.Hof.D $Heap@@1)))) (=> (and (and (and (and ($Is refType |e#0| Tclass.Hof.D) ($IsAlloc refType |e#0| Tclass.Hof.D $Heap@@1)) (and (=> |defass#d#0| (and ($Is refType |d#0@@2| Tclass.Hof.D) ($IsAlloc refType |d#0@@2| Tclass.Hof.D $Heap@@1))) true)) (and (and ($Is HandleTypeType |p#1_0_0| (Tclass._System.___hFunc1 Tclass.Hof.D TInt)) ($IsAlloc HandleTypeType |p#1_0_0| (Tclass._System.___hFunc1 Tclass.Hof.D TInt) $Heap@@1)) true)) (and (and (and ($Is HandleTypeType |p#1_1_0| (Tclass._System.___hFunc1 Tclass.Hof.D TInt)) ($IsAlloc HandleTypeType |p#1_1_0| (Tclass._System.___hFunc1 Tclass.Hof.D TInt) $Heap@@1)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 16) 15)))) anon0_correct))))
