...
(declare-fun |y#0| () T@U)
(declare-fun TwoStateAt.NT.L$Y () T@U)
(declare-fun previous$Heap () T@U)
(declare-fun |n#0| () Int)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$TwoStateAt.NT.L)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (<= (LitInt 0) this) (< this 86)) (and ($IsBox |y#0| TwoStateAt.NT.L$Y) ($IsAllocBox |y#0| TwoStateAt.NT.L$Y previous$Heap))) (and (and ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap)) (and (<= (LitInt 0) |n#0|) (= 2 $FunctionContextHeight)))) (and (and (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAllocBox |y#0| TwoStateAt.NT.L$Y previous$Heap)) (and ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap) (= (ControlFlow 0 5) 2)))) anon0_correct))))
