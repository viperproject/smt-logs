...
axiom 1 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, n#0: int :: 
    ...
    CoRecursion.__default.AscendingChain#canCall(n#0) || 1 < $FunctionContextHeight
...
procedure {:verboseName "CoRecursion.AscendingChain (well-formedness)"} CheckWellformed$$CoRecursion.__default.AscendingChain(n#0: int);
...
procedure {:verboseName "CoRecursion.Prefix (well-formedness)"} CheckWellformed$$CoRecursion.__default.Prefix(CoRecursion._default.Prefix$_T0: Ty, 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CoRecursion.Prefix (well-formedness)"} CheckWellformed$$CoRecursion.__default.Prefix(CoRecursion._default.Prefix$_T0: Ty, n#0: int, s#0: DatatypeType)
{
  ...
  var ##s#0: DatatypeType;
    ...
    else
    {
        ...
        if (n#0 == LitInt(0))
        {
            assume {:id "id10"} CoRecursion.__default.Prefix(CoRecursion._default.Prefix$_T0, $LS($LZ), n#0, s#0)
        ...
        else
        {
            ...
            assert {:id "id11"} $Is(n#0 - 1, Tclass._System.nat());
            ##n#0 := n#0 - 1;
            ...
            assert {:id "id12"} 0 <= n#0 || ##n#0 == n#0;
            assert {:id "id13"} ##n#0 < n#0;
            assume CoRecursion.__default.Prefix#canCall(CoRecursion._default.Prefix$_T0, n#0 - 1, CoRecursion.Stream.rest(s#0));
            assume {:id "id14"} CoRecursion.__default.Prefix(CoRecursion._default.Prefix$_T0, $LS($LZ), n#0, s#0)
...
procedure {:verboseName "CoRecursion.TestMain (correctness)"} Impl$$CoRecursion.__default.TestMain() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CoRecursion.TestMain (correctness)"} Impl$$CoRecursion.__default.TestMain() returns ($_reverifyPost: bool)
{
  ...
  var cell#0: ref
     where defass#cell#0
       ==> $Is(cell#0, Tclass.CoRecursion.Cell())
  ...
  var hi##1: int;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(50,11)
    assume true;
    assume true;
    m#0 := LitInt(17);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(51,14)
    assume true;
    havoc $nw;
    assume $nw != null && $Is($nw, Tclass.CoRecursion.Cell?());
    ...
    cell#0 := $nw;
    defass#cell#0 := true;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(52,15)
    assert {:id "id17"} defass#cell#0;
    assert {:id "id18"} cell#0 != null;
    assume true;
    assert {:id "id19"} $_ModifiesFrame[cell#0, CoRecursion.Cell.data];
    assume true;
    $rhs#0 := LitInt(40);
    $Heap := update($Heap, cell#0, CoRecursion.Cell.data, $Box($rhs#0));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(53,12)
    assume true;
    assert {:id "id22"} defass#cell#0;
    assert {:id "id23"} cell#0 != null;
    ##n#0 := $Unbox(read($Heap, cell#0, CoRecursion.Cell.data)): int;
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#0, TInt, $Heap);
    assume CoRecursion.__default.AscendingChain#canCall($Unbox(read($Heap, cell#0, CoRecursion.Cell.data)): int);
    assume CoRecursion.Stream.More_q(CoRecursion.__default.AscendingChain($LS($LZ), $Unbox(read($Heap, cell#0, CoRecursion.Cell.data)): int));
    assume CoRecursion.__default.AscendingChain#canCall($Unbox(read($Heap, cell#0, CoRecursion.Cell.data)): int);
    mr#0 := #CoRecursion.Stream.More($Box(LitInt(400)), 
      #CoRecursion.Stream.More($Box(LitInt(320)), 
        CoRecursion.__default.AscendingChain($LS($LZ), $Unbox(read($Heap, cell#0, CoRecursion.Cell.data)): int)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(54,7)
    assume true;
    assume true;
    m#0 := LitInt(30);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(55,15)
    assert {:id "id26"} defass#cell#0;
    assert {:id "id27"} cell#0 != null;
    assume true;
    assert {:id "id28"} $_ModifiesFrame[cell#0, CoRecursion.Cell.data];
    assume true;
    $rhs#1 := LitInt(60);
    $Heap := update($Heap, cell#0, CoRecursion.Cell.data, $Box($rhs#1));
    assume $IsGoodHeap($Heap);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(56,11)
    assume true;
    assert {:id "id31"} $Is(LitInt(5), Tclass._System.nat());
    ##n#1 := LitInt(5);
    // assume allocatedness for argument to function
    ...
    // ----- while statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(57,5)
      ...
      free invariant DtRank(l#0) <= DtRank($decr_init$loop#00);
    {
        ...
        // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(61,7)
        assert {:id "id34"} CoRecursion.List.Cons_q(l#0);
        assume true;
        assume true;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(62,9)
        assume true;
        assert {:id "id35"} CoRecursion.List.Cons_q(l#0);
        assume true;
        l#0 := CoRecursion.List.cdr(l#0);
        pop;
        // ----- loop termination check ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(57,5)
        assert {:id "id37"} DtRank(l#0) < DtRank($decr$loop#00);
    }

    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(64,23)
    assume true;
    ...
    // ProcessCallStmt: CheckSubrange
    hi##0 := LitInt(10);
    call {:id "id38"} $rhs##0 := Call$$CoRecursion.__default.OneLess(lo##0, hi##0);
    // TrCallStmt: After ProcessCallStmt
    nio#0 := $rhs##0;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(65,5)
    assume true;
    assume true;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(66,20)
    assume true;
    // TrCallStmt: Adding lhs with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    // ProcessCallStmt: CheckSubrange
    hi##1 := LitInt(10);
    call {:id "id40"} $rhs##1 := Call$$CoRecursion.__default.OneLess_k(lo##1, hi##1);
    // TrCallStmt: After ProcessCallStmt
    nio#0 := $rhs##1;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(67,5)
    assume true;
    assume true;
}
...
procedure {:verboseName "CoRecursion.OneLess (well-formedness)"} CheckWellFormed$$CoRecursion.__default.OneLess(lo#0: int, hi#0: int) returns (m#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "CoRecursion.OneLess (call)"} Call$$CoRecursion.__default.OneLess(lo#0: int, hi#0: int) returns (m#0: int);
  // user-defined preconditions
  requires {:id "id43"} lo#0 < hi#0;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "CoRecursion.OneLess (correctness)"} Impl$$CoRecursion.__default.OneLess(lo#0: int, hi#0: int) returns (m#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id44"} lo#0 < hi#0;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CoRecursion.OneLess (correctness)"} Impl$$CoRecursion.__default.OneLess(lo#0: int, hi#0: int) returns (m#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var eg$y#0: int;
  var y#0_0: int;
  ...
  var hi##1_0: int;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(75,5)
    ...
    if (*)
    {
        ...
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(76,19)
        assume true;
        // TrCallStmt: Adding lhs with type int
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        ...
        // ProcessCallStmt: CheckSubrange
        hi##1_0 := hi#0;
        assert {:id "id45"} 0 <= hi#0 - lo#0 || hi##1_0 - lo##1_0 == hi#0 - lo#0;
        assert {:id "id46"} hi##1_0 - lo##1_0 < hi#0 - lo#0;
        call {:id "id47"} $rhs##1_0 := Call$$CoRecursion.__default.OneLess(lo##1_0, hi##1_0);
        // TrCallStmt: After ProcessCallStmt
        m#0 := $rhs##1_0;
    }
    else
    {
        assume {:id "id49"} !(exists eg$y#1: int :: lo#0 < eg$y#1 && eg$y#1 < hi#0);
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(78,9)
        assume true;
        assume true;
        m#0 := lo#0;
    }
...
procedure {:verboseName "CoRecursion.OneLess' (well-formedness)"} CheckWellFormed$$CoRecursion.__default.OneLess_k(lo#0: int, hi#0: int) returns (m#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "CoRecursion.OneLess' (call)"} Call$$CoRecursion.__default.OneLess_k(lo#0: int, hi#0: int) returns (m#0: int);
  // user-defined preconditions
  requires {:id "id52"} lo#0 < hi#0;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "CoRecursion.OneLess' (correctness)"} Impl$$CoRecursion.__default.OneLess_k(lo#0: int, hi#0: int) returns (m#0: int, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id53"} lo#0 < hi#0;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CoRecursion.OneLess' (correctness)"} Impl$$CoRecursion.__default.OneLess_k(lo#0: int, hi#0: int) returns (m#0: int, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $rhs##1_0: int;
  var lo##1_0: int;
  ...
  var hi##2_0: int;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- alternative statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(87,5)
    havoc y#2_0;
    if (*)
    {
        // Begin Comprehension WF check
        ...
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(89,22)
        assume true;
        // TrCallStmt: Adding lhs with type int
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        ...
        // ProcessCallStmt: CheckSubrange
        hi##2_0 := hi#0;
        assert {:id "id62"} 0 <= hi#0 - lo#0 || hi##2_0 - lo##2_0 == hi#0 - lo#0;
        assert {:id "id63"} hi##2_0 - lo##2_0 < hi#0 - lo#0;
        call {:id "id64"} $rhs##2_0 := Call$$CoRecursion.__default.OneLess_k(lo##2_0, hi##2_0);
        // TrCallStmt: After ProcessCallStmt
        m#0 := $rhs##2_0;
    }
    else if (*)
    {
        assume true;
        assume {:id "id57"} lo#0 + 1 < hi#0;
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(91,22)
        assume true;
        // TrCallStmt: Adding lhs with type int
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        ...
        // ProcessCallStmt: CheckSubrange
        hi##1_0 := hi#0;
        assert {:id "id58"} 0 <= hi#0 - lo#0 || hi##1_0 - lo##1_0 == hi#0 - lo#0;
        assert {:id "id59"} hi##1_0 - lo##1_0 < hi#0 - lo#0;
        call {:id "id60"} $rhs##1_0 := Call$$CoRecursion.__default.OneLess_k(lo##1_0, hi##1_0);
        // TrCallStmt: After ProcessCallStmt
        m#0 := $rhs##1_0;
    }
    else if (*)
    {
        assume true;
        assume {:id "id55"} lo#0 + 1 == hi#0;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Compilation.legacy.dfy(93,11)
        assume true;
        assume true;
        m#0 := lo#0;
    }
