...
(let ((anon8_correct  (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> false (<= (LitInt 0) |i#0@2|))) (=> (=> false (<= (LitInt 0) |i#0@2|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> false (<= |i#0@2| |n#0|))) (=> (=> false (<= |i#0@2| |n#0|)) (=> (= (ControlFlow 0 3) (- 0 2)) (=> false (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@4 null)) (not true)) (=> (= $o@@4 |c#0@@1|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@4) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) $f@@0))))
 :qid |DirtyLoopsdfy.218:15|
 :skolemid |566|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@4) $f@@0))
)))))))))))
(let ((anon13_Else_correct  (=> (and (< |i#0@1| |n#0|) (= (ControlFlow 0 13) 3)) anon8_correct)))
(let ((anon12_Then_correct  (and (=> (= (ControlFlow 0 14) 7) anon13_Then_correct) (=> (= (ControlFlow 0 14) 13) anon13_Else_correct))))
(let ((anon10_Else_correct  (=> |$w$loop#0@1| (and (=> (= (ControlFlow 0 15) 14) anon12_Then_correct) (=> (= (ControlFlow 0 15) 3) anon8_correct)))))
(let ((anon9_LoopBody_correct  (and (=> (= (ControlFlow 0 21) 20) anon10_Then_correct) (=> (= (ControlFlow 0 21) 15) anon10_Else_correct))))
...
)) (<= (- |n#0| |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 22) 1) anon9_LoopDone_correct) (=> (= (ControlFlow 0 22) 21) anon9_LoopBody_correct))))))
...
))) (=> (= (ControlFlow 0 23) 22) anon9_LoopHead_correct)))))))))))
