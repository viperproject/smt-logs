...
(assert (forall ((v@@4 T@U) (t0@@3 T@U) (h@@0 T@U) ) (! (= ($IsAlloc SetType v@@4 (TSet t0@@3) h@@0) (forall ((bx@@5 T@U) ) (!  (=> (|Set#IsMember| v@@4 bx@@5) ($IsAllocBox bx@@5 t0@@3 h@@0))
...
(assert (forall ((v@@6 T@U) (t0@@5 T@U) (t1@@0 T@U) (h@@2 T@U) ) (! (= ($IsAlloc MapType v@@6 (TMap t0@@5 t1@@0) h@@2) (forall ((bx@@6 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@6) bx@@6) (and ($IsAllocBox (MapType0Select BoxType BoxType (|Map#Elements| v@@6) bx@@6) t1@@0 h@@2) ($IsAllocBox bx@@6 t0@@5 h@@2)))
...
(assert (forall ((bx@@7 T@U) (s@@2 T@U) (t@@10 T@U) ) (!  (=> ($IsBox bx@@7 (TMap s@@2 t@@10)) (and (= ($Box MapType ($Unbox MapType bx@@7)) bx@@7) ($Is MapType ($Unbox MapType bx@@7) (TMap s@@2 t@@10))))
 :qid |DafnyPreludebpl.207:15|
 :skolemid |3565|
 :pattern ( ($IsBox bx@@7 (TMap s@@2 t@@10)))
)))
...
(assert (forall ((bx@@10 T@U) (t@@12 T@U) ) (!  (=> ($IsBox bx@@10 (TMultiSet t@@12)) (and (= ($Box MultiSetType ($Unbox MultiSetType bx@@10)) bx@@10) ($Is MultiSetType ($Unbox MultiSetType bx@@10) (TMultiSet t@@12))))
 :qid |DafnyPreludebpl.201:15|
 :skolemid |3563|
 :pattern ( ($IsBox bx@@10 (TMultiSet t@@12)))
)))
(assert (forall ((bx@@11 T@U) (t@@13 T@U) ) (!  (=> ($IsBox bx@@11 (TSeq t@@13)) (and (= ($Box SeqType ($Unbox SeqType bx@@11)) bx@@11) ($Is SeqType ($Unbox SeqType bx@@11) (TSeq t@@13))))
 :qid |DafnyPreludebpl.204:15|
 :skolemid |3564|
 :pattern ( ($IsBox bx@@11 (TSeq t@@13)))
)))
(assert (forall ((v@@10 T@U) (t0@@7 T@U) (t1@@2 T@U) ) (! (= ($Is MapType v@@10 (TMap t0@@7 t1@@2)) (forall ((bx@@12 T@U) ) (!  (=> (|Set#IsMember| (|Map#Domain| v@@10) bx@@12) (and ($IsBox (MapType0Select BoxType BoxType (|Map#Elements| v@@10) bx@@12) t1@@2) ($IsBox bx@@12 t0@@7)))
...
(assert (forall ((v@@11 T@U) (t0@@8 T@U) (h@@3 T@U) ) (! (= ($IsAlloc MultiSetType v@@11 (TMultiSet t0@@8) h@@3) (forall ((bx@@13 T@U) ) (!  (=> (< 0 (|MultiSet#Multiplicity| v@@11 bx@@13)) ($IsAllocBox bx@@13 t0@@8 h@@3))
 :qid |DafnyPreludebpl.307:11|
 :skolemid |3600|
 :pattern ( (|MultiSet#Multiplicity| v@@11 bx@@13))
)))
 :qid |DafnyPreludebpl.305:15|
 :skolemid |3601|
 :pattern ( ($IsAlloc MultiSetType v@@11 (TMultiSet t0@@8) h@@3))
)))
...
(set-info :boogie-vc-id Impl$$RegressionsSubsetElementTypes.__default.M1)
...
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) ($Is intType (int_2_U (LitInt 20)) Tclass.RegressionsSubsetElementTypes.byte)) (=> ($Is intType (int_2_U (LitInt 20)) Tclass.RegressionsSubsetElementTypes.byte) (=> (= (ControlFlow 0 5) (- 0 4)) ($Is intType (int_2_U (LitInt 500)) Tclass.RegressionsSubsetElementTypes.byte))))))
(let ((anon4_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U (LitInt 500)) Tclass.RegressionsSubsetElementTypes.byte)) (=> ($Is intType (int_2_U (LitInt 500)) Tclass.RegressionsSubsetElementTypes.byte) (=> (= (ControlFlow 0 2) (- 0 1)) ($Is intType (int_2_U (LitInt 20)) Tclass.RegressionsSubsetElementTypes.byte))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |dt#0| Tclass.RegressionsSubsetElementTypes.Dt) ($IsAlloc DatatypeTypeType |dt#0| Tclass.RegressionsSubsetElementTypes.Dt $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct))))
