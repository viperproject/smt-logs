...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly T@U) ($Heap T@U) (|source#0| T@U) (|p#0| T@U) (|sink#0| T@U) (|S#0| T@U) (|T#0| T@U) ) (!  (=> (or (|Reachable5.__default.ReachableVia#canCall| $Heap |source#0| |p#0| |sink#0| |S#0| |T#0|) (and (< 1 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $Heap) ($Is refType |source#0| Tclass.Reachable5.Node)) ($Is DatatypeTypeType |p#0| (Tclass.Reachable5.Path Tclass.Reachable5.Node))) ($Is refType |sink#0| Tclass.Reachable5.Node)) ($Is SetType |S#0| (TSet Tclass.Reachable5.Node))) ($Is SetType |T#0| (TSet Tclass.Reachable5.Node))))) (and (=> (not (Reachable5.Path.Empty_q |p#0|)) (let ((|n#1| ($Unbox refType (Reachable5.Path._h14 |p#0|))))
(let ((|prefix#1| (Reachable5.Path._h13 |p#0|)))
 (=> (|Set#IsMember| |S#0| ($Box refType |n#1|)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#1|) Reachable5.Node.children)) ($Box refType |sink#0|)) (|Reachable5.__default.ReachableVia#canCall| $Heap |source#0| |prefix#1| |n#1| |S#0| |T#0|)))))) (= (Reachable5.__default.ReachableVia ($LS $ly) $Heap |source#0| |p#0| |sink#0| |S#0| |T#0|) (ite (Reachable5.Path.Empty_q |p#0|) (= |source#0| |sink#0|) (let ((|n#0| ($Unbox refType (Reachable5.Path._h14 |p#0|))))
(let ((|prefix#0| (Reachable5.Path._h13 |p#0|)))
 (and (and (|Set#IsMember| |S#0| ($Box refType |n#0|)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#0|) Reachable5.Node.children)) ($Box refType |sink#0|))) (Reachable5.__default.ReachableVia $ly $Heap |source#0| |prefix#0| |n#0| |S#0| |T#0|))))))))
 :qid |OlderVerificationdfy.203:19|
 :skolemid |4514|
 :pattern ( (Reachable5.__default.ReachableVia ($LS $ly) $Heap |source#0| |p#0| |sink#0| |S#0| |T#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($ly@@0 T@U) ($Heap@@0 T@U) (|source#0@@0| T@U) (|p#0@@0| T@U) (|sink#0@@0| T@U) (|S#0@@0| T@U) (|T#0@@0| T@U) ) (! (= (Reachable5.__default.ReachableVia ($LS $ly@@0) $Heap@@0 |source#0@@0| |p#0@@0| |sink#0@@0| |S#0@@0| |T#0@@0|) (Reachable5.__default.ReachableVia $ly@@0 $Heap@@0 |source#0@@0| |p#0@@0| |sink#0@@0| |S#0@@0| |T#0@@0|))
 :qid |OlderVerificationdfy.203:19|
 :skolemid |4507|
 :pattern ( (Reachable5.__default.ReachableVia ($LS $ly@@0) $Heap@@0 |source#0@@0| |p#0@@0| |sink#0@@0| |S#0@@0| |T#0@@0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($ly@@1 T@U) ($Heap@@1 T@U) (|source#0@@1| T@U) (|p#0@@1| T@U) (|sink#0@@1| T@U) (|S#0@@1| T@U) (|T#0@@1| T@U) ) (!  (=> (or (|Reachable5.__default.ReachableVia#canCall| $Heap@@1 |source#0@@1| |p#0@@1| |sink#0@@1| |S#0@@1| |T#0@@1|) (and (< 1 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $Heap@@1) (and ($Is refType |source#0@@1| Tclass.Reachable5.Node) ($IsAlloc refType |source#0@@1| Tclass.Reachable5.Node $Heap@@1))) (and ($Is DatatypeTypeType |p#0@@1| (Tclass.Reachable5.Path Tclass.Reachable5.Node)) ($IsAlloc DatatypeTypeType |p#0@@1| (Tclass.Reachable5.Path Tclass.Reachable5.Node) $Heap@@1))) (and ($Is refType |sink#0@@1| Tclass.Reachable5.Node) ($IsAlloc refType |sink#0@@1| Tclass.Reachable5.Node $Heap@@1))) (and ($Is SetType |S#0@@1| (TSet Tclass.Reachable5.Node)) ($IsAlloc SetType |S#0@@1| (TSet Tclass.Reachable5.Node) $Heap@@1))) (and ($Is SetType |T#0@@1| (TSet Tclass.Reachable5.Node)) ($IsAlloc SetType |T#0@@1| (TSet Tclass.Reachable5.Node) $Heap@@1))))) (forall (($olderHeap T@U) ) (!  (=> (and (and ($IsGoodHeap $olderHeap) ($OlderTag $olderHeap)) (and (Reachable5.__default.ReachableVia $ly@@1 $Heap@@1 |source#0@@1| |p#0@@1| |sink#0@@1| |S#0@@1| |T#0@@1|) (and (and (and ($IsAlloc refType |source#0@@1| Tclass.Reachable5.Node $olderHeap) ($IsAlloc refType |sink#0@@1| Tclass.Reachable5.Node $olderHeap)) ($IsAlloc SetType |S#0@@1| (TSet Tclass.Reachable5.Node) $olderHeap)) ($IsAlloc SetType |T#0@@1| (TSet Tclass.Reachable5.Node) $olderHeap)))) ($IsAlloc DatatypeTypeType |p#0@@1| (Tclass.Reachable5.Path Tclass.Reachable5.Node) $olderHeap))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4511|
 ...
 :qid |OlderVerificationdfy.203:19|
 :skolemid |4512|
 :pattern ( (Reachable5.__default.ReachableVia $ly@@1 $Heap@@1 |source#0@@1| |p#0@@1| |sink#0@@1| |S#0@@1| |T#0@@1|))
))))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) (|l#4| T@U) ($o@@3 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#1| |l#0| |l#1| |l#2| |l#3| |l#4|) $o@@3 $f))  (=> (and (or (not (= $o@@3 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@3) |l#2|)))) (or (|Set#IsMember| |l#3| ($Box refType $o@@3)) (|Set#IsMember| |l#4| ($Box refType $o@@3)))))
...
(set-info :boogie-vc-id CheckWellformed$$Reachable5.__default.ReachableVia)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 20) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall (($olderHeap@@0 T@U) ) (!  (=> (and (and ($IsGoodHeap $olderHeap@@0) ($OlderTag $olderHeap@@0)) (and (Reachable5.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2| |T#0@@2|) (and (and (and ($IsAlloc refType |source#0@@2| Tclass.Reachable5.Node $olderHeap@@0) ($IsAlloc refType |sink#0@@2| Tclass.Reachable5.Node $olderHeap@@0)) ($IsAlloc SetType |S#0@@2| (TSet Tclass.Reachable5.Node) $olderHeap@@0)) ($IsAlloc SetType |T#0@@2| (TSet Tclass.Reachable5.Node) $olderHeap@@0)))) ($IsAlloc DatatypeTypeType |p#0@@2| (Tclass.Reachable5.Path Tclass.Reachable5.Node) $olderHeap@@0))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4515|
 :pattern ( ($OlderTag $olderHeap@@0))
)))))
(let ((anon9_correct  (=> (= (Reachable5.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2| |T#0@@2|)  (and (and (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#Z#0@0|) Reachable5.Node.children)) ($Box refType |sink#0@@2|))) (Reachable5.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |prefix#Z#0@0| |n#Z#0@0| |S#0@@2| |T#0@@2|))) (=> (and (=> (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (=> (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#Z#0@0|) Reachable5.Node.children)) ($Box refType |sink#0@@2|)) (|Reachable5.__default.ReachableVia#canCall| $Heap@@2 |source#0@@2| |prefix#Z#0@0| |n#Z#0@0| |S#0@@2| |T#0@@2|))) ($Is boolType (bool_2_U (Reachable5.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2| |T#0@@2|)) TBool)) (and (=> (= (ControlFlow 0 8) (- 0 10)) |b$reqreads#0@1|) (=> |b$reqreads#0@1| (and (=> (= (ControlFlow 0 8) (- 0 9)) |b$reqreads#1@1|) (=> |b$reqreads#1@1| (=> (= (ControlFlow 0 8) 4) GeneratedUnifiedExit_correct)))))))))
...
(let ((anon16_Then_correct  (=> (and (and (and (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (|Seq#Contains| ($Unbox SeqType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |n#Z#0@0|) Reachable5.Node.children)) ($Box refType |sink#0@@2|))) (and ($IsAlloc refType |source#0@@2| Tclass.Reachable5.Node $Heap@@2) ($IsAlloc DatatypeTypeType |prefix#Z#0@0| (Tclass.Reachable5.Path Tclass.Reachable5.Node) $Heap@@2))) (and (and ($IsAlloc refType |n#Z#0@0| Tclass.Reachable5.Node $Heap@@2) ($IsAlloc SetType |S#0@@2| (TSet Tclass.Reachable5.Node) $Heap@@2)) (and ($IsAlloc SetType |T#0@@2| (TSet Tclass.Reachable5.Node) $Heap@@2) (= |b$reqreads#1@0| (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 $o@@4) alloc)))) (or (|Set#IsMember| |S#0@@2| ($Box refType $o@@4)) (|Set#IsMember| |T#0@@2| ($Box refType $o@@4)))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@4 $f@@0)))
 :qid |OlderVerificationdfy.209:63|
 :skolemid |4516|
)))))) (and (=> (= (ControlFlow 0 11) (- 0 12)) (< (DtRank |prefix#Z#0@0|) (DtRank |p#0@@2|))) (=> (< (DtRank |prefix#Z#0@0|) (DtRank |p#0@@2|)) (=> (|Reachable5.__default.ReachableVia#canCall| $Heap@@2 |source#0@@2| |prefix#Z#0@0| |n#Z#0@0| |S#0@@2| |T#0@@2|) (=> (and (= |b$reqreads#1@1| |b$reqreads#1@0|) (= (ControlFlow 0 11) 8)) anon9_correct)))))))
...
(let ((anon15_Then_correct  (=> (|Set#IsMember| |S#0@@2| ($Box refType |n#Z#0@0|)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |n#Z#0@0| null)) (not true))) (=> (or (not (= |n#Z#0@0| null)) (not true)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |n#Z#0@0| Reachable5.Node.children))) (= |b$reqreads#0@1| |b$reqreads#0@0|)) (and (=> (= (ControlFlow 0 14) 11) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct))))))))
(let ((anon14_Then_correct  (=> (= |p#0@@2| (|#Reachable5.Path.Extend| |_mcc#0#0| ($Box refType |_mcc#1#0|))) (=> (and (and (and ($Is DatatypeTypeType |_mcc#0#0| (Tclass.Reachable5.Path Tclass.Reachable5.Node)) ($Is refType |_mcc#1#0| Tclass.Reachable5.Node)) (and (= |let#0#0#0| |_mcc#1#0|) ($Is refType |let#0#0#0| Tclass.Reachable5.Node))) (and (and (= |n#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#0#0|)) (and ($Is DatatypeTypeType |let#1#0#0| (Tclass.Reachable5.Path Tclass.Reachable5.Node)) (= |prefix#Z#0@0| |let#1#0#0|)))) (and (=> (= (ControlFlow 0 17) 14) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct))))))
(let ((anon13_Then_correct  (=> (= |p#0@@2| |#Reachable5.Path.Empty|) (=> (and (= (Reachable5.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2| |T#0@@2|) (= |source#0@@2| |sink#0@@2|)) ($Is boolType (bool_2_U (Reachable5.__default.ReachableVia ($LS $LZ) $Heap@@2 |source#0@@2| |p#0@@2| |sink#0@@2| |S#0@@2| |T#0@@2|)) TBool)) (and (=> (= (ControlFlow 0 5) (- 0 7)) true) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (= (ControlFlow 0 5) 4) GeneratedUnifiedExit_correct)))))))
(let ((anon14_Else_correct true))
(let ((anon13_Else_correct  (=> (or (not (= |p#0@@2| |#Reachable5.Path.Empty|)) (not true)) (and (=> (= (ControlFlow 0 18) 17) anon14_Then_correct) (=> (= (ControlFlow 0 18) 2) anon14_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap@@2 alloc |S#0@@2| |T#0@@2|)) (and (and (=> (= (ControlFlow 0 19) 1) anon12_Then_correct) (=> (= (ControlFlow 0 19) 5) anon13_Then_correct)) (=> (= (ControlFlow 0 19) 18) anon13_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is refType |source#0@@2| Tclass.Reachable5.Node)) (and ($Is DatatypeTypeType |p#0@@2| (Tclass.Reachable5.Path Tclass.Reachable5.Node)) ($Is refType |sink#0@@2| Tclass.Reachable5.Node))) (and (and ($Is SetType |S#0@@2| (TSet Tclass.Reachable5.Node)) ($Is SetType |T#0@@2| (TSet Tclass.Reachable5.Node))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 20) 19)))) anon0_correct)))
