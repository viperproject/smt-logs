...
(declare-fun |pp#0@2| () T@U)
(declare-fun |y#0| () Int)
(declare-fun |let#1_0#0#0| () T@U)
(declare-fun |nn#0| () T@U)
(declare-fun |dt_update_tmp#1#Z#1_0@0| () T@U)
(declare-fun |let#1_1#0#0| () Real)
(declare-fun |dt_update#10#1#Z#1_0@0| () Real)
(declare-fun |let#1_2#0#0| () Bool)
(declare-fun |dt_update#f#0#Z#1_0@0| () Bool)
(declare-fun |let#1_3#0#0| () Int)
(declare-fun |dt_update#010#1#Z#1_0@0| () Int)
(declare-fun |pp#0@1| () T@U)
(declare-fun |let#0_0#0#0| () T@U)
(declare-fun |dt_update_tmp#0#Z#0_0@0| () T@U)
(declare-fun |let#0_1#0#0| () Int)
(declare-fun |dt_update#010#0#Z#0_0@0| () Int)
(declare-fun |let#0_2#0#0| () Real)
(declare-fun |dt_update#10#0#Z#0_0@0| () Real)
...
(set-info :boogie-vc-id Impl$$NewSyntax.__default.MultipleUpdates)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (= (NewSyntax.NumericNames._010 |pp#0@2|) |y#0|))))
(let ((anon3_Else_correct  (=> (= |let#1_0#0#0| |nn#0|) (=> (and ($Is DatatypeTypeType |let#1_0#0#0| Tclass.NewSyntax.NumericNames) (= |dt_update_tmp#1#Z#1_0@0| |let#1_0#0#0|)) (=> (and (and (= |let#1_1#0#0| (LitReal 0.1)) ($Is realType (real_2_U |let#1_1#0#0|) TReal)) (and (= |dt_update#10#1#Z#1_0@0| |let#1_1#0#0|) (= |let#1_2#0#0| (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (and (and (and ($Is boolType (bool_2_U |let#1_2#0#0|) TBool) (= |dt_update#f#0#Z#1_0@0| |let#1_2#0#0|)) (and (= |let#1_3#0#0| |y#0|) ($Is intType (int_2_U |let#1_3#0#0|) TInt))) (and (and (= |dt_update#010#1#Z#1_0@0| |let#1_3#0#0|) (= |pp#0@1| (let ((|dt_update#10#1#1_0| (LitReal 0.1)))
(let ((|dt_update#f#0#1_0| (U_2_bool (Lit boolType (bool_2_U true)))))
(let ((|dt_update#010#1#1_0| |y#0|))
(|#NewSyntax.NumericNames.NumNam| |dt_update#010#1#1_0| |dt_update#10#1#1_0| |dt_update#f#0#1_0|)))))) (and (= |pp#0@2| |pp#0@1|) (= (ControlFlow 0 4) 2)))) GeneratedUnifiedExit_correct))))))
(let ((anon3_Then_correct  (=> (and (= |let#0_0#0#0| |nn#0|) ($Is DatatypeTypeType |let#0_0#0#0| Tclass.NewSyntax.NumericNames)) (=> (and (and (= |dt_update_tmp#0#Z#0_0@0| |let#0_0#0#0|) (= |let#0_1#0#0| |y#0|)) (and ($Is intType (int_2_U |let#0_1#0#0|) TInt) (= |dt_update#010#0#Z#0_0@0| |let#0_1#0#0|))) (=> (and (and (and (= |let#0_2#0#0| (LitReal 0.1)) ($Is realType (real_2_U |let#0_2#0#0|) TReal)) (and (= |dt_update#10#0#Z#0_0@0| |let#0_2#0#0|) (NewSyntax.NumericNames.NumNam_q |dt_update_tmp#0#Z#0_0@0|))) (and (and (let ((|dt_update_tmp#0#0_0| |nn#0|))
(NewSyntax.NumericNames.NumNam_q |dt_update_tmp#0#0_0|)) (= |pp#0@0| (let ((|dt_update_tmp#0#0_0@@0| |nn#0|))
(let ((|dt_update#010#0#0_0| |y#0|))
(let ((|dt_update#10#0#0_0| (LitReal 0.1)))
(|#NewSyntax.NumericNames.NumNam| |dt_update#010#0#0_0| |dt_update#10#0#0_0| (NewSyntax.NumericNames.f |dt_update_tmp#0#0_0@@0|))))))) (and (= |pp#0@2| |pp#0@0|) (= (ControlFlow 0 3) 2)))) GeneratedUnifiedExit_correct)))))
