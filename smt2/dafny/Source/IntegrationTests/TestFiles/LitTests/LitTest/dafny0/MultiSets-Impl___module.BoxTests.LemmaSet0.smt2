...
(declare-fun _module.BoxTests.LemmaSet0$T () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.BoxTests.LemmaSet0)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.BoxTests _module.BoxTests$G@@9)) ($IsAlloc refType this (Tclass._module.BoxTests _module.BoxTests$G@@9) $Heap))) (and ($Is SetType |a#0| (TSet _module.BoxTests.LemmaSet0$T)) ($IsAlloc SetType |a#0| (TSet _module.BoxTests.LemmaSet0$T) $Heap))) (=> (and (and (and ($Is SetType |b#0| (TSet _module.BoxTests.LemmaSet0$T)) ($IsAlloc SetType |b#0| (TSet _module.BoxTests.LemmaSet0$T) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|x#1| T@U) ) (!  (=> ($IsBox |x#1| _module.BoxTests.LemmaSet0$T) (=> (|Set#IsMember| |a#0| |x#1|) (|Set#IsMember| |b#0| |x#1|)))
 :qid |MultiSetsdfy.111:21|
 :skolemid |605|
