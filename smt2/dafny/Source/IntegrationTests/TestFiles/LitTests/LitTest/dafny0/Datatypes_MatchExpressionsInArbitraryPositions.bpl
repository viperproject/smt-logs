...
procedure {:verboseName "MatchExpressionsInArbitraryPositions.M (well-formedness)"} CheckWellFormed$$MatchExpressionsInArbitraryPositions.__default.M(xs#0: DatatypeType
...
procedure {:verboseName "MatchExpressionsInArbitraryPositions.M (call)"} Call$$MatchExpressionsInArbitraryPositions.__default.M(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt))
         && $IsAlloc(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt), $Heap)
         && $IsA#MatchExpressionsInArbitraryPositions.AList(xs#0))
   returns (y#0: int);
...
procedure {:verboseName "MatchExpressionsInArbitraryPositions.M (correctness)"} Impl$$MatchExpressionsInArbitraryPositions.__default.M(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt))
         && $IsAlloc(xs#0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt), $Heap)
         && $IsA#MatchExpressionsInArbitraryPositions.AList(xs#0))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressionsInArbitraryPositions.M (correctness)"} Impl$$MatchExpressionsInArbitraryPositions.__default.M(xs#0: DatatypeType) returns (y#0: int, $_reverifyPost: bool)
{
  ...
  var let#1_0#0#0: int;
    ...
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Datatypes.dfy(297,5)
    if (*)
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Datatypes.dfy(298,9)
        assume true;
        havoc a#0_0#0#0;
           ...
           == #MatchExpressionsInArbitraryPositions.AList.ACons($Box(_mcc#0#0_0), _mcc#1#0_0))
        {
            ...
            havoc x#Z#0_0;
            assume {:id "id4"} let#0_0#0#0 == _mcc#0#0_0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0_0#0#0, TInt);
            assume {:id "id5"} x#Z#0_0 == let#0_0#0#0;
        }
        ...
        y#0 := (if MatchExpressionsInArbitraryPositions.AList.ANil_q(xs#0)
           then 0
           else (var x#0_0 := $Unbox(MatchExpressionsInArbitraryPositions.AList.head(xs#0)): int; 
            x#0_0));
    }
    else
    {
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Datatypes.dfy(302,9)
        assume true;
        assume true;
        y#0 := LitInt(0);
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Datatypes.dfy(303,19)
        assume true;
        // Begin Comprehension WF check
        havoc tl#1_1;
        if ($Is(tl#1_1, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt))
           && $IsAlloc(tl#1_1, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt), $Heap))
        {
            havoc a#1_1#0#0;
            if (#MatchExpressionsInArbitraryPositions.AList.ACons($Box(LitInt(8)), tl#1_1)
               == #MatchExpressionsInArbitraryPositions.AList.ACons($Box(_mcc#3#1_0), _mcc#4#1_0))
            {
                assume $Is(_mcc#4#1_0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt));
                havoc w#Z#1_0;
                assume {:id "id10"} let#1_0#0#0 == _mcc#3#1_0;
                assume true;
                // CheckWellformedWithResult: any expression
                assume $Is(let#1_0#0#0, TInt);
                assume {:id "id11"} w#Z#1_0 == let#1_0#0#0;
            }
            else if (#MatchExpressionsInArbitraryPositions.AList.ACons($Box(LitInt(8)), tl#1_1)
               == #MatchExpressionsInArbitraryPositions.AList.Appendix(a#1_1#0#0))
            {
                assert {:id "id9"} false;
            }
            else if (#MatchExpressionsInArbitraryPositions.AList.ACons($Box(LitInt(8)), tl#1_1)
        ...
        assume true;
        b#1_0 := (forall tl#1_0: DatatypeType :: 
          { #MatchExpressionsInArbitraryPositions.AList.ACons($Box(8), tl#1_0) } 
          $Is(tl#1_0, Tclass.MatchExpressionsInArbitraryPositions.AList(TInt))
             ==> (var w#1_0 := $Unbox(MatchExpressionsInArbitraryPositions.AList.head(#MatchExpressionsInArbitraryPositions.AList.ACons($Box(LitInt(8)), tl#1_0))): int; 
              w#1_0 <= LitInt(16)));
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Datatypes.dfy(306,7)
        assume true;
        assert {:id "id13"} b#1_0;
    }
}
...
procedure {:verboseName "MatchExpressionsInArbitraryPositions.F (well-formedness)"} CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.F(xs#0: DatatypeType
...
procedure {:verboseName "MatchExpressionsInArbitraryPositions.G (well-formedness)"} CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.G(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    ys#0: DatatypeType
       where $Is(ys#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    k#0: int);
...
procedure {:verboseName "MatchExpressionsInArbitraryPositions.H (well-formedness)"} CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.H(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    ys#0: DatatypeType
       where $Is(ys#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)), 
    k#0: int);
...
procedure {:verboseName "MatchExpressionsInArbitraryPositions.J (well-formedness)"} CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.J(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressionsInArbitraryPositions.J (well-formedness)"} CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.J(xs#0: DatatypeType)
{
...
procedure {:verboseName "MatchExpressionsInArbitraryPositions.K (well-formedness)"} CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.K(xs#0: DatatypeType
       where $Is(xs#0, Tclass.MatchExpressionsInArbitraryPositions.List(TInt)));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MatchExpressionsInArbitraryPositions.K (well-formedness)"} CheckWellformed$$MatchExpressionsInArbitraryPositions.__default.K(xs#0: DatatypeType)
{
  var $_ReadsFrame: [ref,Field]bool;
  var _mcc#0#0: int;
  ...
  var a#1#1#0: DatatypeType;
    ...
    else
    {
        ...
        {
            assume {:id "id55"} MatchExpressionsInArbitraryPositions.__default.K(xs#0) == LitInt(0);
            assume true;
            // CheckWellformedWithResult: any expression
