...
procedure {:verboseName "CanCallRegressionTests.C.Id (well-formedness)"} CheckWellformed$$CanCallRegressionTests.C.Id(this: ref
       where this != null
         && 
        $Is(this, Tclass.CanCallRegressionTests.C())
         && $IsAlloc(this, Tclass.CanCallRegressionTests.C(), $Heap), 
...
procedure {:verboseName "CanCallRegressionTests.C.M (well-formedness)"} CheckWellFormed$$CanCallRegressionTests.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.CanCallRegressionTests.C())
         && $IsAlloc(this, Tclass.CanCallRegressionTests.C(), $Heap));
...
procedure {:verboseName "CanCallRegressionTests.C.M (call)"} Call$$CanCallRegressionTests.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.CanCallRegressionTests.C())
         && $IsAlloc(this, Tclass.CanCallRegressionTests.C(), $Heap));
...
procedure {:verboseName "CanCallRegressionTests.C.M (correctness)"} Impl$$CanCallRegressionTests.C.M(this: ref
       where this != null
         && 
        $Is(this, Tclass.CanCallRegressionTests.C())
         && $IsAlloc(this, Tclass.CanCallRegressionTests.C(), $Heap))
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "CanCallRegressionTests.C.M (correctness)"} Impl$$CanCallRegressionTests.C.M(this: ref) returns ($_reverifyPost: bool)
{
  ...
  var c#4: ref;
    ...
    $_reverifyPost := false;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/LetExpr.dfy(366,7)
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(this), Tclass.CanCallRegressionTests.C?(), $Heap);
    ##c#0 := this;
    // assume allocatedness for argument to function
    assume $IsAlloc(##c#0, Tclass.CanCallRegressionTests.C(), $Heap);
    assume CanCallRegressionTests.C.Id#canCall(this, this);
    assume CanCallRegressionTests.C.Id#canCall(this, this);
    assert {:id "id16"} CanCallRegressionTests.C.Id(this, this) == this;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/LetExpr.dfy(367,13)
    assume true;
    // assume allocatedness for receiver argument to function
    assume $IsAllocBox($Box(this), Tclass.CanCallRegressionTests.C?(), $Heap);
    ##c#1 := this;
    ...
    assume CanCallRegressionTests.C.Id#canCall(this, this);
    assert {:id "id17"} CanCallRegressionTests.C.Id(this, this) != null;
    assume CanCallRegressionTests.C.Id#canCall(this, this);
    e#0 := $Unbox(read($Heap, CanCallRegressionTests.C.Id(this, this), CanCallRegressionTests.C.x)): int;
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/LetExpr.dfy(368,7)
    havoc c#0;
    ...
    assert {:id "id19"} ($Is(this, Tclass.CanCallRegressionTests.C()) && this == this)
       || 
    ...
    assume $let#0$canCall(this);
    assert {:id "id20"} (var c#1 := $let#0_c(this); c#1) == this;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/LetExpr.dfy(369,13)
    assume true;
    havoc c#3;
    if ($Is(c#3, Tclass.CanCallRegressionTests.C())
       && $IsAlloc(c#3, Tclass.CanCallRegressionTests.C(), $Heap))
    {
    }

    assert {:id "id21"} ($Is(this, Tclass.CanCallRegressionTests.C()) && this == this)
       || 
      ($Is(null, Tclass.CanCallRegressionTests.C()) && null == this)
       || (exists c#2: ref :: $Is(c#2, Tclass.CanCallRegressionTests.C()) && c#2 == this);
    assume $Is(c#3, Tclass.CanCallRegressionTests.C())
       && $IsAlloc(c#3, Tclass.CanCallRegressionTests.C(), $Heap);
    assume c#3 == this;
    havoc c#4;
    assume $Is(c#4, Tclass.CanCallRegressionTests.C())
       && $IsAlloc(c#4, Tclass.CanCallRegressionTests.C(), $Heap);
    assume true;
    assume {:id "id22"} c#4 == this;
    assume true;
    assert {:id "id23"} c#3 == c#4;
    assume $let#1$canCall(this);
    assert {:id "id24"} (var c#2 := $let#1_c(this); c#2) != null;
    assume $let#1$canCall(this);
    d#0 := $Unbox(read($Heap, (var c#2 := $let#1_c(this); c#2), CanCallRegressionTests.C.x)): int;
}
