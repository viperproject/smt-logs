...
(set-info :boogie-vc-id CheckWellFormed$$Alt.__default.MyLemma__NotSoNice)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |x#0@@14| Tclass.Alt.natinf) ($IsAlloc DatatypeTypeType |x#0@@14| Tclass.Alt.natinf $Heap)) (|$IsA#Alt.natinf| |x#0@@14|)) (and (= 4 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
