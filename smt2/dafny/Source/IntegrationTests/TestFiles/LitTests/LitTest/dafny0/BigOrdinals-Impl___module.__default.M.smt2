...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |five#0@0| (Lit BoxType (|ORD#FromNat| 5))) (= (ControlFlow 0 2) (- 0 1))) (= |o#0| |o#0|)))))
