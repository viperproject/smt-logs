...
(set-info :boogie-vc-id Impl$$_module.__default.Testing7)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon4_correct true))
...
(let ((anon9_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (=> (and (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$rhs#0@0| 4)) (= |$decr_init$loop#00@0| 10)) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (<= |i#0@1| (LitInt 10))))) (and (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@7) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7)) (or (= $o@@7 |a#0|) (= $o@@7 |b#0|))))
 :qid |LoopModifiesdfy.114:4|
 :skolemid |520|
...
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#15| null $Heap alloc |a#0| |b#0|)) (= |i#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 21) (- 0 27)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (and (=> (= (ControlFlow 0 21) (- 0 26)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |b#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |b#0|))) (and (=> (= (ControlFlow 0 21) (- 0 25)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |b#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |b#0| (IndexField (LitInt 0)))) (=> (= |$rhs#0@0| (LitInt 4)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |b#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |b#0|) (IndexField (LitInt 0)) ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 21) (- 0 24)) (forall (($o@@9 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@9 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@9) alloc)))) (= $o@@9 |a#0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@9 $f@@2)))
 :qid |LoopModifiesdfy.114:4|
 :skolemid |519|
))) (=> (forall (($o@@10 T@U) ($f@@3 T@U) ) (!  (=> (and (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@10) alloc)))) (= $o@@10 |a#0|)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@10 $f@@3)))
 :qid |LoopModifiesdfy.114:4|
 :skolemid |519|
)) (=> (and (= |$Frame$loop#0@0| (|lambda#4| null $Heap@0 alloc |a#0|)) (= |$decr_init$loop#00@0| (- 10 |i#0@0|))) (and (=> (= (ControlFlow 0 21) (- 0 23)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10)))) (=> (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10))) (=> (= (ControlFlow 0 21) 20) anon9_LoopHead_correct)))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (=> (and (and (and ($Is refType |b#0| (Tclass._System.array TInt)) ($IsAlloc refType |b#0| (Tclass._System.array TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (and (> (_System.array.Length |a#0|) 0) (> (_System.array.Length |b#0|) 0)) (and (or (not (= |a#0| |b#0|)) (not true)) (= (ControlFlow 0 28) 21)))) anon0_correct))))
