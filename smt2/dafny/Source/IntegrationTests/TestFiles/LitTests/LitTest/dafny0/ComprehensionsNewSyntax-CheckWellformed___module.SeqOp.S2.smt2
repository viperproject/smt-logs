...
(declare-fun _module.SeqOp.S2 (T@U Int) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.S2#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.S2#canCall| this (LitInt |n#0|)) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) (= (_module.SeqOp.S2 this (LitInt |n#0|)) (|Seq#Create| TReal $Heap (LitInt |n#0|) (|_module.SeqOp.H#Handle| this))))
 :qid |ComprehensionsNewSyntaxdfy.106:12|
 :weight 3
 :skolemid |578|
 :pattern ( (_module.SeqOp.S2 this (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@1 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.S2#canCall| this@@1 |n#0@@0|) (and (< 1 $FunctionContextHeight) (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)))) ($Is SeqType (_module.SeqOp.S2 this@@1 |n#0@@0|) (TSeq TReal)))
 :qid |ComprehensionsNewSyntaxdfy.106:12|
 :skolemid |571|
 :pattern ( (_module.SeqOp.S2 this@@1 |n#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.S2#canCall| (Lit refType this@@2) (LitInt |n#0@@1|)) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@1|)))) (= (_module.SeqOp.S2 (Lit refType this@@2) (LitInt |n#0@@1|)) (|Seq#Create| TReal $Heap@@1 (LitInt |n#0@@1|) (|_module.SeqOp.H#Handle| (Lit refType this@@2)))))
 :qid |ComprehensionsNewSyntaxdfy.106:12|
 :weight 3
 :skolemid |579|
 :pattern ( (_module.SeqOp.S2 (Lit refType this@@2) (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@3 T@U) (this@@4 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.S2#canCall| this@@4 |n#0@@2|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@3) (and (or (not (= this@@4 null)) (not true)) (and ($Is refType this@@4 Tclass._module.SeqOp) ($IsAlloc refType this@@4 Tclass._module.SeqOp $Heap@@3)))) (<= (LitInt 0) |n#0@@2|)))) (= (_module.SeqOp.S2 this@@4 |n#0@@2|) (|Seq#Create| TReal $Heap@@3 |n#0@@2| (|_module.SeqOp.H#Handle| this@@4))))
 :qid |ComprehensionsNewSyntaxdfy.106:12|
 :skolemid |577|
 :pattern ( (_module.SeqOp.S2 this@@4 |n#0@@2|) ($IsGoodHeap $Heap@@3))
))))
(push 1)
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.S2)
...
(assert (not
 ...
 :qid |ComprehensionsNewSyntaxdfy.107:5|
 :skolemid |580|
 ...
 :qid |ComprehensionsNewSyntaxdfy.107:5|
 :skolemid |582|
))) (= (_module.SeqOp.S2 this@@5 |n#0@@3|) (|Seq#Create| TReal $Heap@@4 |n#0@@3| (|_module.SeqOp.H#Handle| this@@5)))) (and ($Is SeqType (_module.SeqOp.S2 this@@5 |n#0@@3|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@4 alloc false)) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct)))))
