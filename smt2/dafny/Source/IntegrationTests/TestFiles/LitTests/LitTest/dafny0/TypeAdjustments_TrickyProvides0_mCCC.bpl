...
const unique class.TrickyProvides0_mCCC.__default: ClassName;

// Constructor function declaration
function #TrickyProvides0.CCC.W.Leaf() : DatatypeType
uses {
// Constructor identifier
axiom DatatypeCtorId(#TrickyProvides0.CCC.W.Leaf()) == ##TrickyProvides0.CCC.W.Leaf;
// Constructor $Is
axiom $Is(#TrickyProvides0.CCC.W.Leaf(), Tclass.TrickyProvides0_mCCC.W());
// Constructor literal
axiom #TrickyProvides0.CCC.W.Leaf() == Lit(#TrickyProvides0.CCC.W.Leaf());
}

const unique ##TrickyProvides0.CCC.W.Leaf: DtCtorId
uses {
// Constructor identifier
axiom DatatypeCtorId(#TrickyProvides0.CCC.W.Leaf()) == ##TrickyProvides0.CCC.W.Leaf;
}

function TrickyProvides0_mCCC.W.Leaf_q(DatatypeType) : bool;

// Questionmark and identifier
axiom (forall d: DatatypeType :: 
  { TrickyProvides0_mCCC.W.Leaf_q(d) } 
  TrickyProvides0_mCCC.W.Leaf_q(d)
     <==> DatatypeCtorId(d) == ##TrickyProvides0.CCC.W.Leaf);

// Constructor questionmark has arguments
axiom (forall d: DatatypeType :: 
  { TrickyProvides0_mCCC.W.Leaf_q(d) } 
  TrickyProvides0_mCCC.W.Leaf_q(d) ==> d == #TrickyProvides0.CCC.W.Leaf());

function Tclass.TrickyProvides0_mCCC.W() : Ty
uses {
// Tclass.TrickyProvides0_mCCC.W Tag
axiom Tag(Tclass.TrickyProvides0_mCCC.W()) == Tagclass.TrickyProvides0_mCCC.W
   && TagFamily(Tclass.TrickyProvides0_mCCC.W()) == tytagFamily$W;
}

const unique Tagclass.TrickyProvides0_mCCC.W: TyTag;

// Box/unbox axiom for Tclass.TrickyProvides0_mCCC.W
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.TrickyProvides0_mCCC.W()) } 
  $IsBox(bx, Tclass.TrickyProvides0_mCCC.W())
     ==> $Box($Unbox(bx): DatatypeType) == bx
       && $Is($Unbox(bx): DatatypeType, Tclass.TrickyProvides0_mCCC.W()));

// Constructor function declaration
function #TrickyProvides0.CCC.W.Node() : DatatypeType
uses {
// Constructor identifier
axiom DatatypeCtorId(#TrickyProvides0.CCC.W.Node()) == ##TrickyProvides0.CCC.W.Node;
// Constructor $Is
axiom $Is(#TrickyProvides0.CCC.W.Node(), Tclass.TrickyProvides0_mCCC.W());
// Constructor literal
axiom #TrickyProvides0.CCC.W.Node() == Lit(#TrickyProvides0.CCC.W.Node());
}

const unique ##TrickyProvides0.CCC.W.Node: DtCtorId
uses {
// Constructor identifier
axiom DatatypeCtorId(#TrickyProvides0.CCC.W.Node()) == ##TrickyProvides0.CCC.W.Node;
}

function TrickyProvides0_mCCC.W.Node_q(DatatypeType) : bool;

// Questionmark and identifier
axiom (forall d: DatatypeType :: 
  { TrickyProvides0_mCCC.W.Node_q(d) } 
  TrickyProvides0_mCCC.W.Node_q(d)
     <==> DatatypeCtorId(d) == ##TrickyProvides0.CCC.W.Node);

// Constructor questionmark has arguments
axiom (forall d: DatatypeType :: 
  { TrickyProvides0_mCCC.W.Node_q(d) } 
  TrickyProvides0_mCCC.W.Node_q(d) ==> d == #TrickyProvides0.CCC.W.Node());

// Datatype $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(d, Tclass.TrickyProvides0_mCCC.W(), $h) } 
  $IsGoodHeap($h) && $Is(d, Tclass.TrickyProvides0_mCCC.W())
     ==> $IsAlloc(d, Tclass.TrickyProvides0_mCCC.W(), $h));

// Depth-one case-split function
function $IsA#TrickyProvides0_mCCC.W(DatatypeType) : bool;

// Depth-one case-split axiom
axiom (forall d: DatatypeType :: 
  { $IsA#TrickyProvides0_mCCC.W(d) } 
  $IsA#TrickyProvides0_mCCC.W(d)
     ==> TrickyProvides0_mCCC.W.Leaf_q(d) || TrickyProvides0_mCCC.W.Node_q(d));

// Questionmark data type disjunctivity
axiom (forall d: DatatypeType :: 
  { TrickyProvides0_mCCC.W.Node_q(d), $Is(d, Tclass.TrickyProvides0_mCCC.W()) } 
    { TrickyProvides0_mCCC.W.Leaf_q(d), $Is(d, Tclass.TrickyProvides0_mCCC.W()) } 
  $Is(d, Tclass.TrickyProvides0_mCCC.W())
     ==> TrickyProvides0_mCCC.W.Leaf_q(d) || TrickyProvides0_mCCC.W.Node_q(d));

// Datatype extensional equality declaration
function TrickyProvides0_mCCC.W#Equal(DatatypeType, DatatypeType) : bool;

// Datatype extensional equality definition: #TrickyProvides0.CCC.W.Leaf
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { TrickyProvides0_mCCC.W#Equal(a, b), TrickyProvides0_mCCC.W.Leaf_q(a) } 
    { TrickyProvides0_mCCC.W#Equal(a, b), TrickyProvides0_mCCC.W.Leaf_q(b) } 
  TrickyProvides0_mCCC.W.Leaf_q(a) && TrickyProvides0_mCCC.W.Leaf_q(b)
     ==> TrickyProvides0_mCCC.W#Equal(a, b));

// Datatype extensional equality definition: #TrickyProvides0.CCC.W.Node
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { TrickyProvides0_mCCC.W#Equal(a, b), TrickyProvides0_mCCC.W.Node_q(a) } 
    { TrickyProvides0_mCCC.W#Equal(a, b), TrickyProvides0_mCCC.W.Node_q(b) } 
  TrickyProvides0_mCCC.W.Node_q(a) && TrickyProvides0_mCCC.W.Node_q(b)
     ==> TrickyProvides0_mCCC.W#Equal(a, b));

// Datatype extensionality axiom: TrickyProvides0.CCC.W
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { TrickyProvides0_mCCC.W#Equal(a, b) } 
  TrickyProvides0_mCCC.W#Equal(a, b) <==> a == b);

const unique class.TrickyProvides0_mCCC.W: ClassName;
