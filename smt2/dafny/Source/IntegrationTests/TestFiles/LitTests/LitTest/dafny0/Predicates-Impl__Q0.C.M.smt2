...
(set-info :boogie-vc-id Impl$$Q0.C.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc this@@0)) (= (ControlFlow 0 2) (- 0 1))) (forall ((|c#1| T@U) ) (!  (=> ($Is refType |c#1| Tclass.Q0.C) (=> ($IsAllocBox ($Box refType |c#1|) Tclass.Q0.C $Heap@@0) (Q0.C.P $Heap@@0 |c#1|)))
 :qid |Predicatesdfy.94:22|
 :skolemid |2562|
 :pattern ( (Q0.C.P $Heap@@0 |c#1|))
)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.Q0.C) ($IsAlloc refType this@@0 Tclass.Q0.C $Heap@@0))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
