...
(assert (forall ((bx T@U) ) (!  (=> ($IsBox bx Tclass._module.Termination?) (and (= ($Box refType ($Unbox refType bx)) bx) ($Is refType ($Unbox refType bx) Tclass._module.Termination?)))
 :qid |unknown.0:0|
 :skolemid |3441|
 :pattern ( ($IsBox bx Tclass._module.Termination?))
)))
...
(declare-fun _module.Termination.Traverse$T () T@U)
...
(declare-fun |defass#val#0| () Bool)
(declare-fun |val#0| () T@U)
(declare-fun |b#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.Termination.Traverse)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (|_module.List#Equal| |a#0| (|#_module.List.Cons| |val#0@0| |b#0@0|)))))
(let ((anon5_Then_correct  (=> (= |a#0| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) (=> (and (and ($IsBox |_mcc#0#0_0@0| _module.Termination.Traverse$T) ($IsAllocBox |_mcc#0#0_0@0| _module.Termination.Traverse$T $Heap)) (and ($Is DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module.Termination.Traverse$T)) ($IsAlloc DatatypeTypeType |_mcc#1#0_0@0| (Tclass._module.List _module.Termination.Traverse$T) $Heap))) (=> (and (and (and (and ($Is DatatypeTypeType |r#0_0@0| (Tclass._module.List _module.Termination.Traverse$T)) ($IsAlloc DatatypeTypeType |r#0_0@0| (Tclass._module.List _module.Termination.Traverse$T) $Heap)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List _module.Termination.Traverse$T)) (= |r#0_0@0| |let#0_0#0#0|))) (and (and (and ($IsBox |v#0_0@0| _module.Termination.Traverse$T) ($IsAllocBox |v#0_0@0| _module.Termination.Traverse$T $Heap)) (= |let#0_1#0#0| |_mcc#0#0_0@0|)) (and ($IsBox |let#0_1#0#0| _module.Termination.Traverse$T) (= |v#0_0@0| |let#0_1#0#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 8)) true) (=> (= |val#0@0| |v#0_0@0|) (=> (and (= |b#0@0| |r#0_0@0|) (= (ControlFlow 0 7) 6)) GeneratedUnifiedExit_correct))))))))
(let ((anon6_Else_correct true))
(let ((anon6_Then_correct  (=> (and (= |a#0| |#_module.List.Nil|) (= (ControlFlow 0 2) (- 0 1))) false)))
(let ((anon5_Else_correct  (=> (or (not (= |a#0| (|#_module.List.Cons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|))) (not true)) (and (=> (= (ControlFlow 0 4) 2) anon6_Then_correct) (=> (= (ControlFlow 0 4) 3) anon6_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 9) 7) anon5_Then_correct) (=> (= (ControlFlow 0 9) 4) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.Termination) ($IsAlloc refType this Tclass._module.Termination $Heap)))) (=> (and (and (and (and ($Is DatatypeTypeType |a#0| (Tclass._module.List _module.Termination.Traverse$T)) ($IsAlloc DatatypeTypeType |a#0| (Tclass._module.List _module.Termination.Traverse$T) $Heap)) (|$IsA#_module.List| |a#0|)) (=> |defass#val#0| (and ($IsBox |val#0| _module.Termination.Traverse$T) ($IsAllocBox |val#0| _module.Termination.Traverse$T $Heap)))) (and (and (and ($Is DatatypeTypeType |b#0| (Tclass._module.List _module.Termination.Traverse$T)) ($IsAlloc DatatypeTypeType |b#0| (Tclass._module.List _module.Termination.Traverse$T) $Heap)) (= 1 $FunctionContextHeight)) (and (not (|_module.List#Equal| |a#0| |#_module.List.Nil|)) (= (ControlFlow 0 10) 9)))) anon0_correct))))
