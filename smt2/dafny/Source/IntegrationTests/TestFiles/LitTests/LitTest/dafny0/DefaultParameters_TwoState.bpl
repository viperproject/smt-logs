...
const unique class.TwoState.__default: ClassName;

// function declaration for TwoState._default.P0
function TwoState.__default.P0($prevHeap: Heap, $heap: Heap, a#0: ref, b#0: ref) : bool;

function TwoState.__default.P0#canCall($prevHeap: Heap, $heap: Heap, a#0: ref, b#0: ref) : bool;

function Tclass.TwoState.C() : Ty
uses {
// Tclass.TwoState.C Tag
axiom Tag(Tclass.TwoState.C()) == Tagclass.TwoState.C
   && TagFamily(Tclass.TwoState.C()) == tytagFamily$C;
}

const unique Tagclass.TwoState.C: TyTag;

// Box/unbox axiom for Tclass.TwoState.C
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.TwoState.C()) } 
  $IsBox(bx, Tclass.TwoState.C())
     ==> $Box($Unbox(bx): ref) == bx && $Is($Unbox(bx): ref, Tclass.TwoState.C()));

// frame axiom for TwoState.__default.P0
axiom (forall $prevHeap: Heap, $h0: Heap, $h1: Heap, a#0: ref, b#0: ref :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), TwoState.__default.P0($prevHeap, $h1, a#0, b#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && (TwoState.__default.P0#canCall($prevHeap, $h0, a#0, b#0)
         || ($Is(a#0, Tclass.TwoState.C()) && $Is(b#0, Tclass.TwoState.C())))
       && 
      $IsHeapAnchor($h0)
       && $HeapSucc($h0, $h1)
     ==> 
    (forall $o: ref, $f: Field :: true)
     ==> TwoState.__default.P0($prevHeap, $h0, a#0, b#0)
       == TwoState.__default.P0($prevHeap, $h1, a#0, b#0));

function TwoState.__default.P0#requires(Heap, Heap, ref, ref) : bool;

// #requires axiom for TwoState.__default.P0
axiom (forall $prevHeap: Heap, $Heap: Heap, a#0: ref, b#0: ref :: 
  { TwoState.__default.P0#requires($prevHeap, $Heap, a#0, b#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($prevHeap)
       && $IsGoodHeap($Heap)
       && $HeapSucc($prevHeap, $Heap)
       && $Is(a#0, Tclass.TwoState.C())
       && $Is(b#0, Tclass.TwoState.C())
     ==> TwoState.__default.P0#requires($prevHeap, $Heap, a#0, b#0)
       == ($IsAlloc(a#0, Tclass.TwoState.C(), $prevHeap)
         && $IsAlloc(b#0, Tclass.TwoState.C(), $prevHeap)));

procedure {:verboseName "TwoState.P0 (well-formedness)"} CheckWellformed$$TwoState.__default.P0(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), previous$Heap), 
    b#0: ref
       where $Is(b#0, Tclass.TwoState.C())
         && $IsAlloc(b#0, Tclass.TwoState.C(), previous$Heap));
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoState.P0 (well-formedness)"} CheckWellformed$$TwoState.__default.P0(previous$Heap: Heap, current$Heap: Heap, a#0: ref, b#0: ref)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    assume true;
    assert {:id "id98"} $IsAlloc(a#0, Tclass.TwoState.C(), old($Heap));
...
// function declaration for TwoState._default.P1
function TwoState.__default.P1($prevHeap: Heap, $heap: Heap, a#0: ref, b#0: ref) : bool;

function TwoState.__default.P1#canCall($prevHeap: Heap, $heap: Heap, a#0: ref, b#0: ref) : bool;

// frame axiom for TwoState.__default.P1
axiom (forall $prevHeap: Heap, $h0: Heap, $h1: Heap, a#0: ref, b#0: ref :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), TwoState.__default.P1($prevHeap, $h1, a#0, b#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && (TwoState.__default.P1#canCall($prevHeap, $h0, a#0, b#0)
         || ($Is(a#0, Tclass.TwoState.C()) && $Is(b#0, Tclass.TwoState.C())))
       && 
      $IsHeapAnchor($h0)
       && $HeapSucc($h0, $h1)
     ==> 
    (forall $o: ref, $f: Field :: true)
     ==> TwoState.__default.P1($prevHeap, $h0, a#0, b#0)
       == TwoState.__default.P1($prevHeap, $h1, a#0, b#0));

function TwoState.__default.P1#requires(Heap, Heap, ref, ref) : bool;

// #requires axiom for TwoState.__default.P1
axiom (forall $prevHeap: Heap, $Heap: Heap, a#0: ref, b#0: ref :: 
  { TwoState.__default.P1#requires($prevHeap, $Heap, a#0, b#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($prevHeap)
       && $IsGoodHeap($Heap)
       && $HeapSucc($prevHeap, $Heap)
       && $Is(a#0, Tclass.TwoState.C())
       && $Is(b#0, Tclass.TwoState.C())
     ==> TwoState.__default.P1#requires($prevHeap, $Heap, a#0, b#0)
       == $IsAlloc(a#0, Tclass.TwoState.C(), $prevHeap));

procedure {:verboseName "TwoState.P1 (well-formedness)"} CheckWellformed$$TwoState.__default.P1(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), previous$Heap), 
    b#0: ref
       where $Is(b#0, Tclass.TwoState.C())
         && $IsAlloc(b#0, Tclass.TwoState.C(), current$Heap));
  free requires 1 == $FunctionContextHeight;
  free requires previous$Heap == $Heap
     && 
    $HeapSucc(previous$Heap, current$Heap)
...
// function declaration for TwoState._default.P2
function TwoState.__default.P2($prevHeap: Heap, $heap: Heap, a#0: ref, b#0: ref) : bool;

function TwoState.__default.P2#canCall($prevHeap: Heap, $heap: Heap, a#0: ref, b#0: ref) : bool;

// frame axiom for TwoState.__default.P2
axiom (forall $prevHeap: Heap, $h0: Heap, $h1: Heap, a#0: ref, b#0: ref :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), TwoState.__default.P2($prevHeap, $h1, a#0, b#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && (TwoState.__default.P2#canCall($prevHeap, $h0, a#0, b#0)
         || ($Is(a#0, Tclass.TwoState.C()) && $Is(b#0, Tclass.TwoState.C())))
       && 
      $IsHeapAnchor($h0)
       && $HeapSucc($h0, $h1)
     ==> 
    (forall $o: ref, $f: Field :: true)
     ==> TwoState.__default.P2($prevHeap, $h0, a#0, b#0)
       == TwoState.__default.P2($prevHeap, $h1, a#0, b#0));

function TwoState.__default.P2#requires(Heap, Heap, ref, ref) : bool;

// #requires axiom for TwoState.__default.P2
axiom (forall $prevHeap: Heap, $Heap: Heap, a#0: ref, b#0: ref :: 
  { TwoState.__default.P2#requires($prevHeap, $Heap, a#0, b#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($prevHeap)
       && $IsGoodHeap($Heap)
       && $HeapSucc($prevHeap, $Heap)
       && $Is(a#0, Tclass.TwoState.C())
       && $Is(b#0, Tclass.TwoState.C())
     ==> TwoState.__default.P2#requires($prevHeap, $Heap, a#0, b#0)
       == $IsAlloc(b#0, Tclass.TwoState.C(), $prevHeap));

procedure {:verboseName "TwoState.P2 (well-formedness)"} CheckWellformed$$TwoState.__default.P2(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), current$Heap), 
    b#0: ref
       where $Is(b#0, Tclass.TwoState.C())
         && $IsAlloc(b#0, Tclass.TwoState.C(), previous$Heap));
  free requires 1 == $FunctionContextHeight;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoState.P2 (well-formedness)"} CheckWellformed$$TwoState.__default.P2(previous$Heap: Heap, current$Heap: Heap, a#0: ref, b#0: ref)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assume true;
    assert {:id "id99"} $IsAlloc(a#0, Tclass.TwoState.C(), old($Heap));
    // Check well-formedness of preconditions, and then assume them
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
...
// function declaration for TwoState._default.P3
function TwoState.__default.P3($prevHeap: Heap, $heap: Heap, a#0: ref, b#0: ref) : bool;

function TwoState.__default.P3#canCall($prevHeap: Heap, $heap: Heap, a#0: ref, b#0: ref) : bool;

// frame axiom for TwoState.__default.P3
axiom (forall $prevHeap: Heap, $h0: Heap, $h1: Heap, a#0: ref, b#0: ref :: 
  { $IsHeapAnchor($h0), $HeapSucc($h0, $h1), TwoState.__default.P3($prevHeap, $h1, a#0, b#0) } 
  $IsGoodHeap($h0)
       && $IsGoodHeap($h1)
       && (TwoState.__default.P3#canCall($prevHeap, $h0, a#0, b#0)
         || ($Is(a#0, Tclass.TwoState.C()) && $Is(b#0, Tclass.TwoState.C())))
       && 
      $IsHeapAnchor($h0)
       && $HeapSucc($h0, $h1)
     ==> 
    (forall $o: ref, $f: Field :: true)
     ==> TwoState.__default.P3($prevHeap, $h0, a#0, b#0)
       == TwoState.__default.P3($prevHeap, $h1, a#0, b#0));

function TwoState.__default.P3#requires(Heap, Heap, ref, ref) : bool;

// #requires axiom for TwoState.__default.P3
axiom (forall $prevHeap: Heap, $Heap: Heap, a#0: ref, b#0: ref :: 
  { TwoState.__default.P3#requires($prevHeap, $Heap, a#0, b#0), $IsGoodHeap($Heap) } 
  $IsGoodHeap($prevHeap)
       && $IsGoodHeap($Heap)
       && $HeapSucc($prevHeap, $Heap)
       && $Is(a#0, Tclass.TwoState.C())
       && $Is(b#0, Tclass.TwoState.C())
     ==> TwoState.__default.P3#requires($prevHeap, $Heap, a#0, b#0) == true);

procedure {:verboseName "TwoState.P3 (well-formedness)"} CheckWellformed$$TwoState.__default.P3(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), current$Heap), 
...
procedure {:verboseName "TwoState.L0 (well-formedness)"} CheckWellFormed$$TwoState.__default.L0(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), previous$Heap), 
  ...
  free requires previous$Heap == $Heap
    ...
    $HeapSucc(previous$Heap, current$Heap)
     && $IsGoodHeap(current$Heap);
  requires $IsAlloc(a#0, Tclass.TwoState.C(), previous$Heap);
  requires $IsAlloc(b#0, Tclass.TwoState.C(), previous$Heap);
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoState.L0 (well-formedness)"} CheckWellFormed$$TwoState.__default.L0(previous$Heap: Heap, current$Heap: Heap, a#0: ref, b#0: ref)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: L0, CheckWellFormed$$TwoState.__default.L0
    $Heap := current$Heap;
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assume true;
    assert {:id "id100"} $IsAlloc(a#0, Tclass.TwoState.C(), old($Heap));
}



procedure {:verboseName "TwoState.L0 (call)"} Call$$TwoState.__default.L0(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), previous$Heap), 
...
procedure {:verboseName "TwoState.L1 (well-formedness)"} CheckWellFormed$$TwoState.__default.L1(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), previous$Heap), 
...
procedure {:verboseName "TwoState.L1 (call)"} Call$$TwoState.__default.L1(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), previous$Heap), 
...
procedure {:verboseName "TwoState.L2 (well-formedness)"} CheckWellFormed$$TwoState.__default.L2(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), current$Heap), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoState.L2 (well-formedness)"} CheckWellFormed$$TwoState.__default.L2(previous$Heap: Heap, current$Heap: Heap, a#0: ref, b#0: ref)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: L2, CheckWellFormed$$TwoState.__default.L2
    $Heap := current$Heap;
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    assume true;
    assert {:id "id101"} $IsAlloc(a#0, Tclass.TwoState.C(), old($Heap));
}



procedure {:verboseName "TwoState.L2 (call)"} Call$$TwoState.__default.L2(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), current$Heap), 
...
procedure {:verboseName "TwoState.L3 (well-formedness)"} CheckWellFormed$$TwoState.__default.L3(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), current$Heap), 
...
procedure {:verboseName "TwoState.L3 (call)"} Call$$TwoState.__default.L3(previous$Heap: Heap, 
    current$Heap: Heap, 
    a#0: ref
       where $Is(a#0, Tclass.TwoState.C())
         && $IsAlloc(a#0, Tclass.TwoState.C(), current$Heap), 
...
const unique class.TwoState.C?: ClassName;
...
axiom (forall $o: ref :: 
  { $Is($o, Tclass.TwoState.C?()) } 
  $Is($o, Tclass.TwoState.C?())
     <==> $o == null || dtype($o) == Tclass.TwoState.C?());

// $IsAlloc axiom for class C
axiom (forall $o: ref, $h: Heap :: 
  { $IsAlloc($o, Tclass.TwoState.C?(), $h) } 
  $IsAlloc($o, Tclass.TwoState.C?(), $h)
     <==> $o == null || $Unbox(read($h, $o, alloc)): bool);

// $Is axiom for non-null type TwoState.C
axiom (forall c#0: ref :: 
  { $Is(c#0, Tclass.TwoState.C()) } { $Is(c#0, Tclass.TwoState.C?()) } 
  $Is(c#0, Tclass.TwoState.C()) <==> $Is(c#0, Tclass.TwoState.C?()) && c#0 != null);

// $IsAlloc axiom for non-null type TwoState.C
axiom (forall c#0: ref, $h: Heap :: 
  { $IsAlloc(c#0, Tclass.TwoState.C(), $h) } 
    { $IsAlloc(c#0, Tclass.TwoState.C?(), $h) } 
  $IsAlloc(c#0, Tclass.TwoState.C(), $h)
     <==> $IsAlloc(c#0, Tclass.TwoState.C?(), $h));
