...
(set-info :boogie-vc-id Impl$$_module.__default.ContinueK0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 39) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 32) (- 0 31)) (= |k#0@4| (LitInt 25)))))
(let ((anon27_Then_correct  (=> (<= 25 |k#0@1|) (=> (and (= |k#0@4| |k#0@1|) (= (ControlFlow 0 33) 32)) GeneratedUnifiedExit_correct))))
...
(let ((continue_0_correct  (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (<= 0 |$decr$loop#00@1|) (= (- 25 |k#0@3|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 25 |k#0@3|) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 9) (- 0 8)) (< (- 25 |k#0@3|) |$decr$loop#00@1|))))))
(let ((after_0_0_correct  (and (=> (= (ControlFlow 0 13) (- 0 14)) ($Is intType (int_2_U (+ |k#0@1| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |k#0@1| 1)) Tclass._System.nat) (=> (= |k#0@2| (+ |k#0@1| 1)) (=> (and (= |k#0@3| |k#0@2|) (= (ControlFlow 0 13) 9)) continue_0_correct))))))
...
(let ((anon35_Then_correct  (=> (and (and (= |i#0_0@2| |p#0|) (= |i#0_0@3| (LitInt 8))) (and (= |k#0@3| |k#0@1|) (= (ControlFlow 0 11) 9))) continue_0_correct)))
...
(let ((anon34_Else_correct  (=> (or (not (= |i#0_0@2| (LitInt 7))) (not true)) (and (=> (= (ControlFlow 0 12) 11) anon35_Then_correct) (=> (= (ControlFlow 0 12) 5) anon35_Else_correct)))))
...
(let ((anon27_Else_correct  (=> (and (and (< |k#0@1| 25) (= |$decr$loop#00@1| (- 25 |k#0@1|))) (and (= |i#0_0@1| (LitInt 0)) (= |$decr_init$loop#0_00@1| (- |n#0| |i#0_0@1|)))) (and (=> (= (ControlFlow 0 29) (- 0 30)) (=> |$w$loop#0_0@1| (or (or (and (<= |i#0_0@1| (LitInt 7)) (<= |i#0_0@1| |p#0|)) (= |i#0_0@1| (LitInt 7))) (< |p#0| 7)))) (=> (=> |$w$loop#0_0@1| (or (or (and (<= |i#0_0@1| (LitInt 7)) (<= |i#0_0@1| |p#0|)) (= |i#0_0@1| (LitInt 7))) (< |p#0| 7))) (=> (= (ControlFlow 0 29) 28) anon28_LoopHead_correct))))))
...
(let ((anon25_LoopHead_correct  (=> (<= (LitInt 0) |k#0@1|) (=> (and (and (and (and (<= 0 |k#0@1|) (< |k#0@1| 26)) (not false)) (= |$decr_init$loop#00@0| 25)) (and (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |ControlStructuresdfy.381:3|
 :skolemid |646|
...
)) (<= (- 25 |k#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 36) 1) anon25_LoopDone_correct) (=> (= (ControlFlow 0 36) 35) anon25_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 37) (- 0 38)) ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 0)) Tclass._System.nat) (=> (= |k#0@0| (LitInt 0)) (=> (and (= |$decr_init$loop#00@0| (- 25 |k#0@0|)) (= (ControlFlow 0 37) 36)) anon25_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (and (and (<= (LitInt 0) |p#0|) (<= (LitInt 0) |k#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 39) 37)))) anon0_correct)))
