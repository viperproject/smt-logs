...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 tytagFamily$array |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1|)
)
(assert (= (FDim alloc) 0))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 12))) (=> (<= 0 (LitInt 12)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.InitArray$D))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (= (_System.array.Length $nw@0) (LitInt 12)) (= (ControlFlow 0 2) (- 0 1)))) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 12))) (Requires1 TInt _module._default.InitArray$D $Heap |f#0@@3| ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |ArrayElementInitCompiledfy.42:8|
 :skolemid |584|
))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt _module._default.InitArray$D)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt _module._default.InitArray$D) $Heap))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array _module._default.InitArray$D)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.InitArray$D) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|x#1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |x#1|)) (< (U_2_int |x#1|) 12)) (Requires1 TInt _module._default.InitArray$D $Heap |f#0@@3| ($Box intType |x#1|)))
 :qid |ArrayElementInitCompiledfy.40:19|
 :skolemid |582|
 :pattern ( (Requires1 TInt _module._default.InitArray$D $Heap |f#0@@3| ($Box intType |x#1|)))
