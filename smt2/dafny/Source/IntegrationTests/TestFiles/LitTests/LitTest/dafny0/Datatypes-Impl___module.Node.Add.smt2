...
(assert (forall (($h@@3 T@U) ($o@@2 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@2 null)) (not true)) (= (dtype $o@@2) Tclass._module.Node?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@2) _module.Node.next)) Tclass._module.Node?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2573|
...
(assert (forall (($h@@4 T@U) ($o@@3 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass._module.Node?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@3) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@3) _module.Node.next)) Tclass._module.Node? $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2574|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@3) _module.Node.next)))
)))
...
(assert (forall (($h@@5 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.Node?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) _module.Node.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2571|
...
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.Node.Add)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.Node?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 12)) true) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Node.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Node.data)) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.Node.data ($Box intType (int_2_U |d#0@@0|))))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 2) (- 0 9)) true) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Node.next))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Node.next)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) _module.Node.next ($Box refType this@@2)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 6)) true) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.Node.Repr#canCall| $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.Node.Repr ($LS $LZ) $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.Node.next)) null))))) (=> (=> (|_module.Node.Repr#canCall| $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.Node.Repr ($LS $LZ) $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.Node.next)) null)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.Node.Repr#canCall| $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.Node.Repr ($LS $LZ) $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (let ((|d#7| (U_2_int ($Unbox intType (_module.List._h0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))))))
(= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.Node.data))) |d#7|)))))) (=> (=> (|_module.Node.Repr#canCall| $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.Node.Repr ($LS $LZ) $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (let ((|d#7@@0| (U_2_int ($Unbox intType (_module.List._h0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))))))
(= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.Node.data))) |d#7@@0|))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.Node.Repr#canCall| $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.Node.Repr ($LS $LZ) $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.Node.next)) null)) (not true)))))) (=> (=> (|_module.Node.Repr#canCall| $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.Node.Repr ($LS $LZ) $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.Node.next)) null)) (not true))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.Node.Repr#canCall| $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.Node.Repr ($LS $LZ) $Heap@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (let ((|cdr#6| (_module.List._h1 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))))
(_module.Node.Repr ($LS ($LS $LZ)) $Heap@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.Node.next)) |cdr#6|))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.Node) ($IsAlloc refType this@@2 Tclass._module.Node $Heap@@1)))) (=> (and (and (and (and ($Is DatatypeTypeType |L#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |L#0| (Tclass._module.List TInt) $Heap@@1)) (|$IsA#_module.List| |L#0|)) (and (=> |defass#r#0| (and ($Is refType |r#0| Tclass._module.Node) ($IsAlloc refType |r#0| Tclass._module.Node $Heap@@1))) (= 2 $FunctionContextHeight))) (and (and (|_module.Node.Repr#canCall| $Heap@@1 this@@2 |L#0|) (and (_module.Node.Repr ($LS $LZ) $Heap@@1 this@@2 |L#0|) (ite (_module.List.Nil_q |L#0|) (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.next)) null) (let ((|cdr#5| (_module.List._h1 |L#0|)))
(let ((|d#6| (U_2_int ($Unbox intType (_module.List._h0 |L#0|)))))
 (and (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.data))) |d#6|) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.next)) null)) (not true))) (_module.Node.Repr ($LS $LZ) $Heap@@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) _module.Node.next)) |cdr#5|))))))) (= (ControlFlow 0 13) 2))) anon0_correct))))
