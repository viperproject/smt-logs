...
(declare-fun VariationOnOrdering0.ParamSub$X () T@U)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap@@0 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellFormed$$VariationOnOrdering0.ParamSub)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (|VariationOnOrdering0.CC.GetEmpty#canCall| VariationOnOrdering0.ParamSub$X) (= (ControlFlow 0 3) (- 0 2))) (|Seq#Equal| |Seq#Empty| (VariationOnOrdering0.CC.GetEmpty VariationOnOrdering0.ParamSub$X)))))
