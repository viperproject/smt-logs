...
(set-info :boogie-vc-id Impl$$_module.__default.W0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon10_Then_correct true))
(let ((anon6_correct  (=> (and ($Is refType |k#0@1| Tclass._module.C?) ($IsAlloc refType |k#0@1| Tclass._module.C? $Heap@1)) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= (ControlFlow 0 5) (- 0 4))) false) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |k#0@1|) _module.C.y))) (LitInt 3))))))
(let ((anon10_Else_correct  (=> (and (< |i#0@1| 7) (= (ControlFlow 0 7) 5)) anon6_correct)))
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 8) 6) anon10_Then_correct) (=> (= (ControlFlow 0 8) 7) anon10_Else_correct))))
(let ((anon8_Else_correct  (=> |$w$loop#0@1| (and (=> (= (ControlFlow 0 9) 8) anon9_Then_correct) (=> (= (ControlFlow 0 9) 5) anon6_correct)))))
(let ((anon8_Then_correct  (=> (and (not |$w$loop#0@1|) (= (ControlFlow 0 3) (- 0 2))) (or (not (= |k#0@0| null)) (not true)))))
(let ((anon7_LoopBody_correct  (and (=> (= (ControlFlow 0 10) 3) anon8_Then_correct) (=> (= (ControlFlow 0 10) 9) anon8_Else_correct))))
(let ((anon7_LoopDone_correct true))
(let ((anon7_LoopHead_correct  (=> (and (and ($Is refType |k#0@0| Tclass._module.C?) ($IsAlloc refType |k#0@0| Tclass._module.C? $Heap@0)) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (=> (and (and (and (not false) (= |$decr_init$loop#00@0| 7)) (=> |$w$loop#0@1| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |k#0@0|) _module.C.y))) (LitInt 3)))) (and (and (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4)) (= $o@@4 |c#0@@1|)))
 :qid |DirtyLoopsdfy.413:3|
 :skolemid |656|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
)) ($HeapSucc $Heap $Heap@0)) (and (forall (($o@@5 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@5) alloc)))) (or (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@5) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@5) $f@@0)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@5 $f@@0))))
 :qid |DirtyLoopsdfy.413:3|
 :skolemid |657|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@5) $f@@0))
)) (<= (- 7 |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 11) 1) anon7_LoopDone_correct) (=> (= (ControlFlow 0 11) 10) anon7_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |c#0@@1|)) (=> (and (= |i#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- 7 |i#0@0|))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (=> |$w$loop#0@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.y))) (LitInt 3)))) (=> (=> |$w$loop#0@0| (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.y))) (LitInt 3))) (=> (= (ControlFlow 0 12) 11) anon7_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |c#0@@1| Tclass._module.C) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap))) (=> (and (and (and ($Is refType |k#0| Tclass._module.C?) ($IsAlloc refType |k#0| Tclass._module.C? $Heap)) (= 1 $FunctionContextHeight)) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.y))) (LitInt 3)) (= (ControlFlow 0 14) 12))) anon0_correct))))
