...
(declare-fun |t#0| () T@U)
(declare-fun _module._default.Tests$T () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Tests)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |t#0| _module._default.Tests$T) ($IsAllocBox |t#0| _module._default.Tests$T $Heap))) (and (and ($Is SeqType |uu#0| (TSeq _module._default.Tests$T)) ($IsAlloc SeqType |uu#0| (TSeq _module._default.Tests$T) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
