// dafny 4.9.2.0
// Command Line Options: /deprecation:0 /compile:0 /timeLimit:10 /print:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Matrix-OOB.bpl /vcsCores:1 /proverLog:/home/runner/work/smt-logs/smt-logs/dafny/../smt2/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Matrix-OOB-@PROC@.smt2 /normalizeNames:0 /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Matrix-OOB.dfy
...
procedure {:verboseName "M (well-formedness)"} CheckWellFormed$$_module.__default.M(m#0: ref
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M (well-formedness)"} CheckWellFormed$$_module.__default.M(m#0: ref)
{
  ...
  var j#0: int;
    ...
    assert {:id "id1"} 0 <= i#0 && i#0 < _System.array2.Length0(m#0);
    assert {:id "id2"} 0 <= j#0 && j#0 < _System.array2.Length1(m#0);
    assume {:id "id3"} $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#0), j#0))): int
       == LitInt(0);
    assume {:id "id4"} (forall i#1: int, j#1: int :: 
...
procedure {:verboseName "M (call)"} Call$$_module.__default.M(m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap));
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id5"} (forall i#1: int, j#1: int :: 
    { $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int } 
    $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int
       == LitInt(0));
...
procedure {:verboseName "M (correctness)"} Impl$$_module.__default.M(m#0: ref
       where $Is(m#0, Tclass._System.array2(TInt))
         && $IsAlloc(m#0, Tclass._System.array2(TInt), $Heap))
  ...
  // user-defined postconditions
  free ensures true;
  ensures {:id "id6"} (forall i#1: int, j#1: int :: 
    { $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int } 
    $Unbox(read($Heap, m#0, MultiIndexField(IndexField(i#1), j#1))): int
       == LitInt(0));
  // frame condition: object granularity
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M (correctness)"} Impl$$_module.__default.M(m#0: ref) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
