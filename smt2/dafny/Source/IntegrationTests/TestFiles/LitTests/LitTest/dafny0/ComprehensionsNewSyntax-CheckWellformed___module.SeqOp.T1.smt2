...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.T1#canCall| $Heap this |n#0|) (and (< 1 $FunctionContextHeight) (and (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)) (<= |n#0| (LitInt 20))))) ($Is SeqType (_module.SeqOp.T1 $Heap this |n#0|) (TSeq TReal)))
 :qid |ComprehensionsNewSyntaxdfy.134:12|
 :skolemid |633|
...
(assert (forall (($Heap@@1 T@U) (this@@1 T@U) (|i#0| Int) ) (!  (=> (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |i#0|)) (= (|_module.SeqOp.G#requires| $Heap@@1 this@@1 |i#0|) true))
 :qid |ComprehensionsNewSyntaxdfy.87:12|
 :skolemid |544|
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.T1)
