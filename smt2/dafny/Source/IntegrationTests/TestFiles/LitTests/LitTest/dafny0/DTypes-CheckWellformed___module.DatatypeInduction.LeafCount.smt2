...
(declare-fun _module.DatatypeInduction.LeafCount$G@@3 () T@U)
...
(let ((anon10_Then_correct  (=> (= |tree#0@@3| (|#_module.Tree.Branch| |_mcc#1#0| |_mcc#2#0|)) (=> (and ($Is DatatypeTypeType |_mcc#1#0| (Tclass._module.Tree _module.DatatypeInduction.LeafCount$G@@3)) ($Is DatatypeTypeType |_mcc#2#0| (Tclass._module.Tree _module.DatatypeInduction.LeafCount$G@@3))) (=> (and (and (and (= |let#0#0#0| |_mcc#2#0|) ($Is DatatypeTypeType |let#0#0#0| (Tclass._module.Tree _module.DatatypeInduction.LeafCount$G@@3))) (and (= |right#Z#0@0| |let#0#0#0|) (= |let#1#0#0| |_mcc#1#0|))) (and (and ($Is DatatypeTypeType |let#1#0#0| (Tclass._module.Tree _module.DatatypeInduction.LeafCount$G@@3)) (= |left#Z#0@0| |let#1#0#0|)) (and ($IsAllocBox ($Box refType this@@3) (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@13) $Heap) ($IsAlloc DatatypeTypeType |left#Z#0@0| (Tclass._module.Tree _module.DatatypeInduction.LeafCount$G@@3) $Heap)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (< (DtRank |left#Z#0@0|) (DtRank |tree#0@@3|))) (=> (< (DtRank |left#Z#0@0|) (DtRank |tree#0@@3|)) (=> (and (and (|_module.DatatypeInduction.LeafCount#canCall| _module.DatatypeInduction$T@@13 _module.DatatypeInduction.LeafCount$G@@3 this@@3 |left#Z#0@0|) ($IsAllocBox ($Box refType this@@3) (Tclass._module.DatatypeInduction? _module.DatatypeInduction$T@@13) $Heap)) (and ($IsAlloc DatatypeTypeType |right#Z#0@0| (Tclass._module.Tree _module.DatatypeInduction.LeafCount$G@@3) $Heap) (= (ControlFlow 0 4) (- 0 3)))) (< (DtRank |right#Z#0@0|) (DtRank |tree#0@@3|))))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) ($AlwaysAllocated _module.DatatypeInduction$T@@13)) (=> (and (and (and (or (not (= this@@3 null)) (not true)) (and ($Is refType this@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@13)) ($IsAlloc refType this@@3 (Tclass._module.DatatypeInduction _module.DatatypeInduction$T@@13) $Heap))) ($Is DatatypeTypeType |tree#0@@3| (Tclass._module.Tree _module.DatatypeInduction.LeafCount$G@@3))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
