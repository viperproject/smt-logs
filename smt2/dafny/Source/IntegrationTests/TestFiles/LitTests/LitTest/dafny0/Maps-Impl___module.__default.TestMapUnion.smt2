...
(assert (forall ((m@@9 T@U) (n@@0 T@U) ) (! (= (|Map#Domain| (|Map#Merge| m@@9 n@@0)) (|Set#Union| (|Map#Domain| m@@9) (|Map#Domain| n@@0)))
 :qid |DafnyPreludebpl.1476:15|
 :skolemid |293|
 :pattern ( (|Map#Domain| (|Map#Merge| m@@9 n@@0)))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.TestMapUnion)
...
(let ((anon18_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|u#1| Int) ) (! (= (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |u#1|))) (|Set#IsMember| (|Set#Union| (|Set#Union| (|Map#Domain| |m0#0|) (|Map#Domain| |m1#0|)) (|Map#Domain| |m2#0|)) ($Box intType (int_2_U |u#1|))))
 :qid |Mapsdfy.401:17|
 :skolemid |790|
 :pattern ( (|Set#IsMember| (|Set#Union| (|Set#Union| (|Map#Domain| |m0#0|) (|Map#Domain| |m1#0|)) (|Map#Domain| |m2#0|)) ($Box intType (int_2_U |u#1|))))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |u#1|))))
)))))
(let ((anon10_correct  (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |y#0|))))) |$rhs#1@0|) (|Set#IsMember| (|Map#Domain| |m2#0|) ($Box intType (int_2_U |y#0|))))) (=> (or (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |y#0|))))) |$rhs#1@0|) (|Set#IsMember| (|Map#Domain| |m2#0|) ($Box intType (int_2_U |y#0|)))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |z#0|)))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |z#0|))))) |$rhs#2@0|)) (=> (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |z#0|))))) |$rhs#2@0|) (and (=> (= (ControlFlow 0 4) 2) anon18_Then_correct) (=> (= (ControlFlow 0 4) 3) anon18_Else_correct)))))))))
(let ((anon17_Else_correct  (=> (and (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |y#0|))))) |$rhs#1@0|) (= (ControlFlow 0 9) 4)) anon10_correct)))
(let ((anon17_Then_correct  (=> (and (or (not (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |y#0|))))) |$rhs#1@0|)) (not true)) (= (ControlFlow 0 8) 4)) anon10_correct)))
(let ((anon8_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (or (or (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|) (|Set#IsMember| (|Map#Domain| |m1#0|) ($Box intType (int_2_U |x#0|)))) (|Set#IsMember| (|Map#Domain| |m2#0|) ($Box intType (int_2_U |x#0|))))) (=> (or (or (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|) (|Set#IsMember| (|Map#Domain| |m1#0|) ($Box intType (int_2_U |x#0|)))) (|Set#IsMember| (|Map#Domain| |m2#0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |y#0|)))) (and (=> (= (ControlFlow 0 10) 8) anon17_Then_correct) (=> (= (ControlFlow 0 10) 9) anon17_Else_correct)))))))
(let ((anon16_Else_correct  (=> (and (or (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|) (|Set#IsMember| (|Map#Domain| |m1#0|) ($Box intType (int_2_U |x#0|)))) (= (ControlFlow 0 14) 10)) anon8_correct)))
(let ((anon16_Then_correct  (=> (and (not (or (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|) (|Set#IsMember| (|Map#Domain| |m1#0|) ($Box intType (int_2_U |x#0|))))) (= (ControlFlow 0 13) 10)) anon8_correct)))
(let ((anon15_Else_correct  (=> (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|) (and (=> (= (ControlFlow 0 16) 13) anon16_Then_correct) (=> (= (ControlFlow 0 16) 14) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (or (not (= (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U |x#0|))))) |$rhs#0@0|)) (not true)) (and (=> (= (ControlFlow 0 15) 13) anon16_Then_correct) (=> (= (ControlFlow 0 15) 14) anon16_Else_correct)))))
(let ((anon4_correct  (and (=> (= (ControlFlow 0 17) (- 0 21)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 17) (- 0 20)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |y#0|)))) (and (=> (= (ControlFlow 0 17) (- 0 19)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |z#0|)))) (=> (and (and (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0|))) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |y#0|)))) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |z#0|)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 17) 15) anon15_Then_correct) (=> (= (ControlFlow 0 17) 16) anon15_Else_correct)))))))))
(let ((anon14_Else_correct  (=> (and (not (and (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0|))) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |y#0|))))) (= (ControlFlow 0 23) 17)) anon4_correct)))
(let ((anon14_Then_correct  (=> (and (and (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0|))) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |y#0|)))) (= (ControlFlow 0 22) 17)) anon4_correct)))
(let ((anon13_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0|)))) (and (=> (= (ControlFlow 0 25) 22) anon14_Then_correct) (=> (= (ControlFlow 0 25) 23) anon14_Else_correct)))))
(let ((anon13_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U |x#0|))) (and (=> (= (ControlFlow 0 24) 22) anon14_Then_correct) (=> (= (ControlFlow 0 24) 23) anon14_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 26) (- 0 29)) (|Set#IsMember| (|Map#Domain| |m0#0|) ($Box intType (int_2_U |x#0|)))) (=> (|Set#IsMember| (|Map#Domain| |m0#0|) ($Box intType (int_2_U |x#0|))) (=> (= |$rhs#0@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m0#0|) ($Box intType (int_2_U |x#0|)))))) (and (=> (= (ControlFlow 0 26) (- 0 28)) (|Set#IsMember| (|Map#Domain| |m1#0|) ($Box intType (int_2_U |y#0|)))) (=> (|Set#IsMember| (|Map#Domain| |m1#0|) ($Box intType (int_2_U |y#0|))) (=> (= |$rhs#1@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m1#0|) ($Box intType (int_2_U |y#0|)))))) (and (=> (= (ControlFlow 0 26) (- 0 27)) (|Set#IsMember| (|Map#Domain| |m2#0|) ($Box intType (int_2_U |z#0|)))) (=> (|Set#IsMember| (|Map#Domain| |m2#0|) ($Box intType (int_2_U |z#0|))) (=> (and (= |$rhs#2@0| (U_2_real ($Unbox realType (MapType0Select BoxType BoxType (|Map#Elements| |m2#0|) ($Box intType (int_2_U |z#0|)))))) (= |m#0@0| (|Map#Merge| (|Map#Merge| |m0#0| |m1#0|) |m2#0|))) (and (=> (= (ControlFlow 0 26) 24) anon13_Then_correct) (=> (= (ControlFlow 0 26) 25) anon13_Else_correct))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |m0#0| (TMap TInt TReal)) ($IsAlloc MapType |m0#0| (TMap TInt TReal) $Heap))) (and (and ($Is MapType |m1#0| (TMap TInt TReal)) ($IsAlloc MapType |m1#0| (TMap TInt TReal) $Heap)) (and ($Is MapType |m2#0| (TMap TInt TReal)) ($IsAlloc MapType |m2#0| (TMap TInt TReal) $Heap)))) (=> (and (and (and (and ($Is MapType |m#0| (TMap TInt TReal)) ($IsAlloc MapType |m#0| (TMap TInt TReal) $Heap)) true) (= 0 $FunctionContextHeight)) (and (and (|Set#IsMember| (|Map#Domain| |m0#0|) ($Box intType (int_2_U |x#0|))) (|Set#IsMember| (|Map#Domain| |m1#0|) ($Box intType (int_2_U |y#0|)))) (and (|Set#IsMember| (|Map#Domain| |m2#0|) ($Box intType (int_2_U |z#0|))) (= (ControlFlow 0 30) 26)))) anon0_correct))))
