...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h T@U) ($o T@U) ) (!  (=> (and (and ($IsGoodHeap $h) (and (or (not (= $o null)) (not true)) (= (dtype $o) Tclass.ModuleContainTraitAndClass.Class?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) alloc)))) ($IsAlloc intType (int_2_U (ModuleContainTraitAndClass.Class.c0 $o)) TInt $h))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4455|
 :pattern ( (ModuleContainTraitAndClass.Class.c0 $o) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h $o) alloc)))
))))
(assert (= (Tag TInt) TagInt))
(assert (implements$ModuleContainTraitAndClass.Trait Tclass.ModuleContainTraitAndClass.Class?))
(assert (forall (($o@@0 T@U) ) (! (= ($Is refType $o@@0 Tclass.ModuleContainTraitAndClass.Class?)  (or (= $o@@0 null) (= (dtype $o@@0) Tclass.ModuleContainTraitAndClass.Class?)))
 :qid |unknown.0:0|
 :skolemid |4449|
 :pattern ( ($Is refType $o@@0 Tclass.ModuleContainTraitAndClass.Class?))
)))
...
(assert (forall (($o@@2 T@U) ($h@@4 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass.ModuleContainTraitAndClass.Trait? $h@@4)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |4439|
 :pattern ( ($IsAlloc refType $o@@2 Tclass.ModuleContainTraitAndClass.Trait? $h@@4))
)))
(assert (forall (($o@@3 T@U) ($h@@5 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass.ModuleContainTraitAndClass.Class? $h@@5)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |4450|
 :pattern ( ($IsAlloc refType $o@@3 Tclass.ModuleContainTraitAndClass.Class? $h@@5))
)))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($o@@4 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass.ModuleContainTraitAndClass.Class?)) ($Is intType (int_2_U (ModuleContainTraitAndClass.Class.c0 $o@@4)) TInt))
 :qid |unknown.0:0|
 :skolemid |4454|
 :pattern ( (ModuleContainTraitAndClass.Class.c0 $o@@4))
))))
(assert  (=> (< 0 $FunctionContextHeight) (forall (($h@@6 T@U) ($o@@5 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@5 null)) (not true)) ($Is refType $o@@5 Tclass.ModuleContainTraitAndClass.Trait?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) alloc)))) ($IsAlloc intType (int_2_U (ModuleContainTraitAndClass.Trait.t0 $o@@5)) TInt $h@@6))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4444|
 :pattern ( (ModuleContainTraitAndClass.Trait.t0 $o@@5) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@5) alloc)))
))))
...
(assert  (=> (< 0 $FunctionContextHeight) (forall (($o@@9 T@U) ) (!  (=> (and (or (not (= $o@@9 null)) (not true)) ($Is refType $o@@9 Tclass.ModuleContainTraitAndClass.Trait?)) ($Is intType (int_2_U (ModuleContainTraitAndClass.Trait.t0 $o@@9)) TInt))
 :qid |unknown.0:0|
 :skolemid |4443|
 :pattern ( (ModuleContainTraitAndClass.Trait.t0 $o@@9))
))))
...
(set-info :boogie-vc-id Impl$$ModuleContainTraitAndClass.__default.Tests1)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |t#0| Tclass.ModuleContainTraitAndClass.Trait?) ($IsAlloc refType |t#0| Tclass.ModuleContainTraitAndClass.Trait? $Heap)) (and ($Is refType |c#0@@5| Tclass.ModuleContainTraitAndClass.Class?) ($IsAlloc refType |c#0@@5| Tclass.ModuleContainTraitAndClass.Class? $Heap))) (and (and (= 1 $FunctionContextHeight) (or (not (= |t#0| null)) (not true))) (and (or (not (= |c#0@@5| null)) (not true)) (= (ControlFlow 0 8) 2)))) anon0_correct))))
