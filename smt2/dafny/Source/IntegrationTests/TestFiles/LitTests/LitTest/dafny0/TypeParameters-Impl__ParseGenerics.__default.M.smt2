...
(declare-fun ParseGenerics.__default.F (T@U T@U) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $Unbox (T@T T@U) T@U)
(declare-fun Apply1 (T@U T@U T@U T@U T@U) T@U)
(declare-fun |ParseGenerics.__default.F#Handle| (T@U) T@U)
(declare-fun Requires1 (T@U T@U T@U T@U T@U) Bool)
(declare-fun |ParseGenerics.__default.F#requires| (T@U T@U) Bool)
...
(assert (distinct TInt TagInt alloc Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 |##_System._tuple#2._#Make2| Tagclass._System.Tuple2 |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| |tytagFamily$_tuple#2|)
)
...
(assert (forall ((ParseGenerics._default.F$X T@U) ($heap T@U) (|$fh$0x#0| T@U) ) (! (= (ParseGenerics.__default.F ParseGenerics._default.F$X |$fh$0x#0|) (U_2_int ($Unbox intType (Apply1 ParseGenerics._default.F$X TInt $heap (|ParseGenerics.__default.F#Handle| ParseGenerics._default.F$X) |$fh$0x#0|))))
 :qid |unknown.0:0|
 :skolemid |2758|
 :pattern ( (ParseGenerics.__default.F ParseGenerics._default.F$X |$fh$0x#0|) ($IsGoodHeap $heap))
)))
(assert (forall ((ParseGenerics._default.F$X@@0 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (Requires1 ParseGenerics._default.F$X@@0 TInt $heap@@0 (|ParseGenerics.__default.F#Handle| ParseGenerics._default.F$X@@0) |$fh$0x#0@@0|) (|ParseGenerics.__default.F#requires| ParseGenerics._default.F$X@@0 |$fh$0x#0@@0|))
 :qid |unknown.0:0|
 :skolemid |2756|
 :pattern ( (Requires1 ParseGenerics._default.F$X@@0 TInt $heap@@0 (|ParseGenerics.__default.F#Handle| ParseGenerics._default.F$X@@0) |$fh$0x#0@@0|))
)))
...
(assert (forall ((ParseGenerics._default.F$X@@1 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (Apply1 ParseGenerics._default.F$X@@1 TInt $heap@@1 (|ParseGenerics.__default.F#Handle| ParseGenerics._default.F$X@@1) |$fh$0x#0@@1|) ($Box intType (int_2_U (ParseGenerics.__default.F ParseGenerics._default.F$X@@1 |$fh$0x#0@@1|))))
 :qid |unknown.0:0|
 :skolemid |2755|
 :pattern ( (Apply1 ParseGenerics._default.F$X@@1 TInt $heap@@1 (|ParseGenerics.__default.F#Handle| ParseGenerics._default.F$X@@1) |$fh$0x#0@@1|))
)))
...
(assert (forall ((ParseGenerics._default.F$X@@2 T@U) (|x#0| T@U) ) (!  (=> ($IsBox |x#0| ParseGenerics._default.F$X@@2) (= (|ParseGenerics.__default.F#requires| ParseGenerics._default.F$X@@2 |x#0|) true))
 :qid |unknown.0:0|
 :skolemid |2751|
 :pattern ( (|ParseGenerics.__default.F#requires| ParseGenerics._default.F$X@@2 |x#0|))
)))
...
(assert (forall (($bx T@U) (ParseGenerics._default.F$X@@3 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (|Set#IsMember| (Reads1 ParseGenerics._default.F$X@@3 TInt $heap@@2 (|ParseGenerics.__default.F#Handle| ParseGenerics._default.F$X@@3) |$fh$0x#0@@2|) $bx) false)
 :qid |unknown.0:0|
 :skolemid |2757|
 :pattern ( (|Set#IsMember| (Reads1 ParseGenerics._default.F$X@@3 TInt $heap@@2 (|ParseGenerics.__default.F#Handle| ParseGenerics._default.F$X@@3) |$fh$0x#0@@2|) $bx))
)))
...
(declare-fun Tclass.ParseGenerics.MyType () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |pair#0| () T@U)
(declare-fun |pair'#0| () T@U)
(set-info :boogie-vc-id Impl$$ParseGenerics.__default.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (and (= StartFuel_ParseGenerics._default.Many ($LS BaseFuel_ParseGenerics._default.Many)) (= StartFuelAssert_ParseGenerics._default.Many ($LS ($LS BaseFuel_ParseGenerics._default.Many)))) (and (= (AsFuelBottom BaseFuel_ParseGenerics._default.Many) BaseFuel_ParseGenerics._default.Many) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= 0 $FunctionContextHeight)) (not true))) (=> (or (not (= 0 $FunctionContextHeight)) (not true)) (=> (and (= |pair#0@0| (|#_System._tuple#2._#Make2| ($Box HandleTypeType (|ParseGenerics.__default.F#Handle| Tclass.ParseGenerics.MyType)) ($Box intType (int_2_U (LitInt 5))))) (= (ControlFlow 0 2) (- 0 1))) (or (not (= 0 $FunctionContextHeight)) (not true))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |pair#0| (Tclass._System.Tuple2 (Tclass._System.___hTotalFunc1 Tclass.ParseGenerics.MyType TInt) TInt)) ($IsAlloc DatatypeTypeType |pair#0| (Tclass._System.Tuple2 (Tclass._System.___hTotalFunc1 Tclass.ParseGenerics.MyType TInt) TInt) $Heap)) true) (=> (and (and (and ($Is DatatypeTypeType |pair'#0| (Tclass._System.Tuple2 (Tclass._System.___hTotalFunc1 Tclass.ParseGenerics.MyType TInt) TInt)) ($IsAlloc DatatypeTypeType |pair'#0| (Tclass._System.Tuple2 (Tclass._System.___hTotalFunc1 Tclass.ParseGenerics.MyType TInt) TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct)))))
