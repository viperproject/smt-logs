...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@96  (=> (and (= $generated@@88 ($generated@@29 $generated@@89 $generated@@90 $generated@@91 false)) (= (ControlFlow 0 2) (- 0 1))) false)))
(let (($generated@@97  (=> (and (and (and ($generated@@92 $generated@@90) ($generated@@93 $generated@@90)) (<= ($generated 0) $generated@@94)) (and (= 0 $generated@@95) (= (ControlFlow 0 3) 2))) $generated@@96)))
$generated@@97)))
))
(check-sat)
