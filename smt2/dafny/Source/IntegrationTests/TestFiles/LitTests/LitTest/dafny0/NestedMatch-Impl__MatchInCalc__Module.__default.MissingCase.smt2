...
(set-info :boogie-vc-id Impl$$MatchInCalc__Module.__default.MissingCase)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon16_Else_correct true))
(let ((anon16_Then_correct  (=> (and (= |t#0| (|#MatchInCalc_Module.T.Node| |a#0_1_0#0#0@0|)) (= (ControlFlow 0 12) (- 0 11))) false)))
(let ((anon15_Else_correct  (=> (or (not (= |t#0| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|))) (not true)) (and (=> (= (ControlFlow 0 14) 12) anon16_Then_correct) (=> (= (ControlFlow 0 14) 13) anon16_Else_correct)))))
(let ((anon15_Then_correct  (=> (and (and (= |t#0| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|)) (= |let#0_1_0#0#0| |_mcc#0#0_0_0|)) (and ($Is intType (int_2_U |let#0_1_0#0#0|) TInt) (= |w#Z#0_1_0@0| |let#0_1_0#0#0|))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (or (not (= |w#Z#0_1_0@0| 0)) (not true))) (=> (= (ControlFlow 0 9) (- 0 8)) (= (MatchInCalc__Module.__default.P |t#0|) (let ((|w#0_1_2| (MatchInCalc__Module.T.h |t#0|)))
(= (LitInt 2) (Div 10 |w#0_1_2|)))))))))
(let ((anon14_Then_correct  (=> ($IsAlloc DatatypeTypeType |t#0| Tclass.MatchInCalc__Module.T $Heap) (=> (and (|MatchInCalc__Module.__default.P#canCall| |t#0|) (|MatchInCalc__Module.__default.P#canCall| |t#0|)) (and (=> (= (ControlFlow 0 15) 9) anon15_Then_correct) (=> (= (ControlFlow 0 15) 14) anon15_Else_correct))))))
(let ((anon19_Else_correct true))
(let ((anon19_Then_correct true))
(let ((anon18_Else_correct  (=> (or (not (= |t#0| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|))) (not true)) (and (=> (= (ControlFlow 0 7) 5) anon19_Then_correct) (=> (= (ControlFlow 0 7) 6) anon19_Else_correct)))))
(let ((anon18_Then_correct  (=> (= |t#0| (|#MatchInCalc_Module.T.Leaf| |_mcc#0#0_0_0|)) (=> (and (and (and (= |let#0_0_0#0#0| |_mcc#0#0_0_0|) ($Is intType (int_2_U |let#0_0_0#0#0|) TInt)) (and (= |w#Z#0_0_0@0| |let#0_0_0#0#0|) (or (not (= |w#Z#0_0_0@0| 0)) (not true)))) (and (and ($IsAlloc DatatypeTypeType |t#0| Tclass.MatchInCalc__Module.T $Heap) (|MatchInCalc__Module.__default.Q#canCall| |t#0|)) (and (|MatchInCalc__Module.__default.Q#canCall| |t#0|) (= (ControlFlow 0 4) (- 0 3))))) (= (let ((|w#0_0_2| (MatchInCalc__Module.T.h |t#0|)))
(= (LitInt 2) (Div 10 |w#0_0_2|))) (MatchInCalc__Module.__default.Q |t#0|))))))
(let ((anon17_Else_correct true))
(let ((anon13_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (=> (= (ControlFlow 0 16) 1) anon13_Then_correct) (=> (= (ControlFlow 0 16) 15) anon14_Then_correct)) (=> (= (ControlFlow 0 16) 2) anon17_Else_correct)) (=> (= (ControlFlow 0 16) 4) anon18_Then_correct)) (=> (= (ControlFlow 0 16) 7) anon18_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0| Tclass.MatchInCalc__Module.T) ($IsAlloc DatatypeTypeType |t#0| Tclass.MatchInCalc__Module.T $Heap)) (|$IsA#MatchInCalc__Module.T| |t#0|)) (= 2 $FunctionContextHeight)) (and (and (not (MatchInCalc__Module.__default.P |t#0|)) (not (MatchInCalc__Module.__default.Q |t#0|))) (and (|MatchInCalc__Module.T#Equal| |t#0| (|#MatchInCalc_Module.T.Leaf| (LitInt 1))) (= (ControlFlow 0 17) 16)))) anon0_correct))))
