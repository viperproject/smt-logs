...
(set-info :boogie-vc-id Impl$$_module.__default.AssignSuchThat4)
...
(let ((anon3_correct  (=> (= (ControlFlow 0 3) 1) anon4_correct)))
(let ((anon6_Else_correct  (=> (and (= |n#1@0| null) (= (ControlFlow 0 6) 3)) anon3_correct)))
(let ((anon6_Then_correct  (=> (or (not (= |n#1@0| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (or (not (= |n#1@0| null)) (not true))) (=> (= (ControlFlow 0 4) 3) anon3_correct)))))
(let ((anon5_Then_correct  (=> (and ($Is refType |n#1@0| Tclass._module.Node?) ($IsAlloc refType |n#1@0| Tclass._module.Node? $Heap@1)) (and (=> (= (ControlFlow 0 7) 4) anon6_Then_correct) (=> (= (ControlFlow 0 7) 6) anon6_Else_correct)))))
(let ((anon5_Else_correct  (=> (and (not (and ($Is refType |n#1@0| Tclass._module.Node?) ($IsAlloc refType |n#1@0| Tclass._module.Node? $Heap@1))) (= (ControlFlow 0 2) 1)) anon4_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.Node?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Node.next))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.Node.next)) (=> ($Is refType |$rhs#0@0| Tclass._module.Node?) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.Node.next ($Box refType |$rhs#0@0|)))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 8) 7) anon5_Then_correct) (=> (= (ControlFlow 0 8) 2) anon5_Else_correct)))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |n#0| Tclass._module.Node?) ($IsAlloc refType |n#0| Tclass._module.Node? $Heap)) true) (and (and ($Is refType |$rhs#0| Tclass._module.Node?) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 11) 8)))) anon0_correct))))
