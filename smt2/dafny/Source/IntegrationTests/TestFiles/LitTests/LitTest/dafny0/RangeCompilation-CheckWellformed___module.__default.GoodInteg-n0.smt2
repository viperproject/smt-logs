...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.GoodInteger)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (not (= (LitInt 5) 0)) (not true)))))
