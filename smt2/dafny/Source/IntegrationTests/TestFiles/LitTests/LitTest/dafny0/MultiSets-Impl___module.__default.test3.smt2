...
(assert (forall ((s T@U) (a T@U) ) (!  (and (= (= (|MultiSet#Multiplicity| (|MultiSet#FromSet| s) a) 0)  (not (|Set#IsMember| s a))) (= (= (|MultiSet#Multiplicity| (|MultiSet#FromSet| s) a) 1) (|Set#IsMember| s a)))
 :qid |DafnyPreludebpl.1069:15|
 :skolemid |212|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#FromSet| s) a))
)))
...
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|x#1| Int) ) (! (= (|Set#IsMember| |s#0| ($Box intType (int_2_U |x#1|))) (> (|MultiSet#Multiplicity| (|MultiSet#FromSet| |s#0|) ($Box intType (int_2_U |x#1|))) 0))
 :qid |MultiSetsdfy.32:18|
 :skolemid |504|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#FromSet| |s#0|) ($Box intType (int_2_U |x#1|))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |s#0| (TSet TInt)) ($IsAlloc SetType |s#0| (TSet TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
