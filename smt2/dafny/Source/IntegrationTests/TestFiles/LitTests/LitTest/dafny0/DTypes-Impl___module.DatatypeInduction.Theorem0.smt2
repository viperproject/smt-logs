...
(set-info :boogie-vc-id Impl$$_module.DatatypeInduction.Theorem0)
...
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|t#1@@0| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#1@@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (forall ((|t$ih#0#0| T@U) ) (!  (=> ($Is DatatypeTypeType |t$ih#0#0| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (=> (< (DtRank |t$ih#0#0|) (DtRank |t#1@@0|)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS $LZ) this@@3 |t$ih#0#0|))))
 :qid |DTypesdfy.106:19|
 :skolemid |2112|
...
)))) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS ($LS $LZ)) this@@3 |t#1@@0|)))
 :qid |DTypesdfy.106:19|
 :skolemid |2115|
...
))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|t#1@@1| T@U) ) (!  (=> (and (and ($Is DatatypeTypeType |t#1@@1| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (forall ((|t$ih#0#0@@0| T@U) ) (!  (=> ($Is DatatypeTypeType |t$ih#0#0@@0| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (=> (< (DtRank |t$ih#0#0@@0|) (DtRank |t#1@@1|)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS $LZ) this@@3 |t$ih#0#0@@0|))))
 :qid |DTypesdfy.106:19|
 :skolemid |2112|
...
)))) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS ($LS $LZ)) this@@3 |t#1@@1|)))
 :qid |DTypesdfy.106:19|
 :skolemid |2116|
...
))) (=> (and (forall ((|t#1@@2| T@U) ) (!  (=> ($Is DatatypeTypeType |t#1@@2| (Tclass._module.Tree _module.DatatypeInduction$T@@13)) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS $LZ) this@@3 |t#1@@2|)))
 :qid |DTypesdfy.106:19|
 :skolemid |2118|
...
)) (= (ControlFlow 0 2) (- 0 1))) (<= (LitInt 1) (_module.DatatypeInduction.LeafCount _module.DatatypeInduction$T@@13 _module.DatatypeInduction$T@@13 ($LS ($LS $LZ)) this@@3 |tree#0@@3|))))))))
