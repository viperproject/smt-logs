...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@103  (=> (and (= $generated@@96 ($generated@@60 $generated@@97 $generated@@98 $generated@@5 false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@99 0)) (not true)))))
(let (($generated@@104  (=> (and (and ($generated@@100 $generated@@98) ($generated@@101 $generated@@98)) (and (= 0 $generated@@102) (= (ControlFlow 0 3) 2))) $generated@@103)))
$generated@@104)))
))
(check-sat)
