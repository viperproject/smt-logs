...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@96  (=> (and (= $generated@@88 ($generated 0)) (= (ControlFlow 0 3) (- 0 2))) (<= ($generated 0) $generated@@88))))
...
(let (($generated@@99  (=> (and (and ($generated@@93 $generated@@91) ($generated@@94 $generated@@91)) (and (= 0 $generated@@95) (= (ControlFlow 0 5) 4))) $generated@@98)))
$generated@@99)))))
))
(check-sat)
(get-info :rlimit)
