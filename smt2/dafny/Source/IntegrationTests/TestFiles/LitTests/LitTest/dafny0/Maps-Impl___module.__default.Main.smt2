...
(assert (forall ((a T@U) (b T@U) ) (! (= (|Set#Disjoint| a b) (forall ((o T@U) ) (!  (or (not (|Set#IsMember| a o)) (not (|Set#IsMember| b o)))
...
(assert (forall ((m@@11 T@U) ) (!  (or (= m@@11 |Map#Empty|) (exists ((k@@0 T@U) (v@@9 T@U) ) (! (|Set#IsMember| (|Map#Items| m@@11) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@0 v@@9)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon27_Else_correct  (=> (and (not (|Map#Equal| |m#0@0| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 3)))))) (= (ControlFlow 0 3) (- 0 2))) (U_2_bool (Lit boolType (bool_2_U false))))))
(let ((anon27_Then_correct true))
(let ((anon18_correct  (and (=> (= (ControlFlow 0 4) 1) anon27_Then_correct) (=> (= (ControlFlow 0 4) 3) anon27_Else_correct))))
(let ((anon26_Else_correct  (=> (not (|Map#Equal| (|Map#Build| |m#0@0| ($Box intType (int_2_U (LitInt 7))) ($Box intType (int_2_U (LitInt 1)))) (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 7))) ($Box intType (int_2_U (LitInt 1)))))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 6) 4) anon18_correct))))))
(let ((anon26_Then_correct  (=> (and (|Map#Equal| (|Map#Build| |m#0@0| ($Box intType (int_2_U (LitInt 7))) ($Box intType (int_2_U (LitInt 1)))) (|Map#Build| (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 3)))) ($Box intType (int_2_U (LitInt 7))) ($Box intType (int_2_U (LitInt 1))))) (= (ControlFlow 0 5) 4)) anon18_correct)))
(let ((anon15_correct  (and (=> (= (ControlFlow 0 8) 5) anon26_Then_correct) (=> (= (ControlFlow 0 8) 6) anon26_Else_correct))))
(let ((anon25_Else_correct  (=> (not (|Map#Equal| (|Map#Build| |m#0@0| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 4)))) (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 4)))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 10) 8) anon15_correct))))))
(let ((anon25_Then_correct  (=> (and (|Map#Equal| (|Map#Build| |m#0@0| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 4)))) (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 4))))) (= (ControlFlow 0 9) 8)) anon15_correct)))
(let ((anon12_correct  (and (=> (= (ControlFlow 0 12) 9) anon25_Then_correct) (=> (= (ControlFlow 0 12) 10) anon25_Else_correct))))
(let ((anon24_Else_correct  (=> (not (|Set#Disjoint| (|Map#Domain| |m#0@0|) (|Map#Domain| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 3)))))))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 14) 12) anon12_correct))))))
(let ((anon24_Then_correct  (=> (and (|Set#Disjoint| (|Map#Domain| |m#0@0|) (|Map#Domain| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 3))) ($Box intType (int_2_U (LitInt 3))))))) (= (ControlFlow 0 13) 12)) anon12_correct)))
(let ((anon9_correct  (and (=> (= (ControlFlow 0 16) 13) anon24_Then_correct) (=> (= (ControlFlow 0 16) 14) anon24_Else_correct))))
(let ((anon23_Else_correct  (=> (or (not (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U (LitInt 2)))))) (LitInt 3))) (not true)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 18) 16) anon9_correct))))))
(let ((anon23_Then_correct  (=> (and (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |m#0@0|) ($Box intType (int_2_U (LitInt 2)))))) (LitInt 3)) (= (ControlFlow 0 17) 16)) anon9_correct)))
(let ((anon6_correct  (and (=> (= (ControlFlow 0 20) (- 0 21)) (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U (LitInt 2))))) (=> (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U (LitInt 2)))) (and (=> (= (ControlFlow 0 20) 17) anon23_Then_correct) (=> (= (ControlFlow 0 20) 18) anon23_Else_correct))))))
(let ((anon22_Else_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U 3))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 23) 20) anon6_correct))))))
(let ((anon22_Then_correct  (=> (and (not (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U 3)))) (= (ControlFlow 0 22) 20)) anon6_correct)))
(let ((anon3_correct  (and (=> (= (ControlFlow 0 25) 22) anon22_Then_correct) (=> (= (ControlFlow 0 25) 23) anon22_Else_correct))))
(let ((anon21_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U 2)))) (and (=> (= (ControlFlow 0 27) (- 0 28)) (U_2_bool (Lit boolType (bool_2_U false)))) (=> (U_2_bool (Lit boolType (bool_2_U false))) (=> (= (ControlFlow 0 27) 25) anon3_correct))))))
(let ((anon21_Then_correct  (=> (and (|Set#IsMember| (|Map#Domain| |m#0@0|) ($Box intType (int_2_U 2))) (= (ControlFlow 0 26) 25)) anon3_correct)))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |m#0@0| (Lit MapType (|Map#Build| |Map#Empty| ($Box intType (int_2_U (LitInt 2))) ($Box intType (int_2_U (LitInt 3))))))) (and (=> (= (ControlFlow 0 29) 26) anon21_Then_correct) (=> (= (ControlFlow 0 29) 27) anon21_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |m#0| (TMap TInt TInt)) ($IsAlloc MapType |m#0| (TMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 30) 29))) anon0_correct))))
