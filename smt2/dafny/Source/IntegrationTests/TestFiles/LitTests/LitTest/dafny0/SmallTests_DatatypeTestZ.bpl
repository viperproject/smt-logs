...
procedure {:verboseName "DatatypeTestZ.Test (well-formedness)"} CheckWellFormed$$DatatypeTestZ.__default.Test();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "DatatypeTestZ.Test (call)"} Call$$DatatypeTestZ.__default.Test();
  modifies $Heap;
...
procedure {:verboseName "DatatypeTestZ.Test (correctness)"} Impl$$DatatypeTestZ.__default.Test() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "DatatypeTestZ.Test (correctness)"} Impl$$DatatypeTestZ.__default.Test() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var aa#0: DatatypeType
     where $Is(aa#0, Tclass.ListLibrary.List(TReal))
       && $IsAlloc(aa#0, Tclass.ListLibrary.List(TReal), $Heap);
  var bb#0: DatatypeType
     where $Is(bb#0, Tclass.ListLibrary.List(TReal))
       && $IsAlloc(bb#0, Tclass.ListLibrary.List(TReal), $Heap);

    // AddMethodImpl: Test, Impl$$DatatypeTestZ.__default.Test
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(872,12)
    assume true;
    assume true;
    aa#0 := Lit(#ListLibrary.List.Nil());
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(873,12)
    assume true;
    assume true;
    bb#0 := Lit(#ListLibrary.List.Nil());
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/SmallTests.dfy(874,5)
    assume $IsA#ListLibrary.List(aa#0) && $IsA#ListLibrary.List(bb#0);
    assert {:id "id94"} ListLibrary.List#Equal(aa#0, bb#0);
}
