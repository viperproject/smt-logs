...
(declare-fun _module.__default.Postie2 (T@U T@U) T@U)
(declare-fun |_module.__default.Postie2#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|c#0@@1| T@U) ) (!  (=> (or (|_module.__default.Postie2#canCall| $Heap |c#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and ($Is refType |c#0@@1| Tclass._module.Mountain?) ($IsAlloc refType |c#0@@1| Tclass._module.Mountain? $Heap))) (and (or (not (= |c#0@@1| null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.Mountain.x))) (LitInt 5)))))) ($IsAlloc refType (_module.__default.Postie2 $Heap |c#0@@1|) Tclass._module.Mountain? $Heap))
 :qid |Definednessdfy.222:16|
 :skolemid |493|
 :pattern ( ($IsAlloc refType (_module.__default.Postie2 $Heap |c#0@@1|) Tclass._module.Mountain? $Heap))
))))
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|c#0@@2| T@U) ) (!  (=> (or (|_module.__default.Postie2#canCall| $Heap@@0 |c#0@@2|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and ($Is refType |c#0@@2| Tclass._module.Mountain?) ($IsAlloc refType |c#0@@2| Tclass._module.Mountain? $Heap@@0))) (and (or (not (= |c#0@@2| null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@2|) _module.Mountain.x))) (LitInt 5)))))) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 (_module.__default.Postie2 $Heap@@0 |c#0@@2|)) _module.Mountain.x))) (LitInt 5)) ($Is refType (_module.__default.Postie2 $Heap@@0 |c#0@@2|) Tclass._module.Mountain?)))
 :qid |Definednessdfy.222:16|
 :skolemid |492|
 :pattern ( (_module.__default.Postie2 $Heap@@0 |c#0@@2|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|c#0@@3| T@U) ) (!  (=> (or (|_module.__default.Postie2#canCall| $Heap@@1 |c#0@@3|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is refType |c#0@@3| Tclass._module.Mountain?)) (and (or (not (= |c#0@@3| null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@3|) _module.Mountain.x))) (LitInt 5)))))) (= (_module.__default.Postie2 $Heap@@1 |c#0@@3|) |c#0@@3|))
 :qid |Definednessdfy.222:16|
 :skolemid |495|
 :pattern ( (_module.__default.Postie2 $Heap@@1 |c#0@@3|) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.Postie2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 (_module.__default.Postie2 $Heap@@2 |c#0@@4|)) _module.Mountain.x))) (LitInt 5)))))
(let ((anon5_Else_correct  (=> (= (_module.__default.Postie2 $Heap@@2 |c#0@@4|) |c#0@@4|) (=> (and ($Is refType (_module.__default.Postie2 $Heap@@2 |c#0@@4|) Tclass._module.Mountain?) (= (ControlFlow 0 8) 7)) GeneratedUnifiedExit_correct))))
(let ((anon5_Then_correct  (=> (and ($Is refType (_module.__default.Postie2 $Heap@@2 |c#0@@4|) Tclass._module.Mountain?) ($IsAlloc refType |c#0@@4| Tclass._module.Mountain? $Heap@@2)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |c#0@@4| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#0@@4|) _module.Mountain.x))) (LitInt 5))) (=> (and (or (not (= |c#0@@4| null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#0@@4|) _module.Mountain.x))) (LitInt 5))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (= |c#0@@4| |c#0@@4|) (or (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|)) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|))) (not (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|)) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|))))) (and (|Set#Equal| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|)) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|))) (and (= |c#0@@4| null) (or (not (= |c#0@@4| null)) (not true))))))) (=> (or (= |c#0@@4| |c#0@@4|) (or (and (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|)) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|))) (not (|Set#Subset| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|)) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|))))) (and (|Set#Equal| (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|)) (|Set#UnionOne| |Set#Empty| ($Box refType |c#0@@4|))) (and (= |c#0@@4| null) (or (not (= |c#0@@4| null)) (not true)))))) (=> (and (or (= |c#0@@4| |c#0@@4|) (|_module.__default.Postie2#canCall| $Heap@@2 |c#0@@4|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (_module.__default.Postie2 $Heap@@2 |c#0@@4|) null)) (not true)))))))))))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#2| null $Heap@@2 alloc |c#0@@4|)) (or (not (= |c#0@@4| null)) (not true))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (or (not (= |c#0@@4| null)) (not true))) (=> (or (not (= |c#0@@4| null)) (not true)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |c#0@@4| _module.Mountain.x))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 |c#0@@4|) _module.Mountain.x))) (LitInt 5))) (and (=> (= (ControlFlow 0 9) (- 0 10)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 9) 2) anon5_Then_correct) (=> (= (ControlFlow 0 9) 8) anon5_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is refType |c#0@@4| Tclass._module.Mountain?)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 12) 9))) anon0_correct)))
