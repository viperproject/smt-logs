...
(set-info :boogie-vc-id CheckWellformed$$A.C.Get)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon5_Else_correct  (=> (and (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@0 A.C.x))) (= (A.C.Get $Heap@@0 this@@0) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) A.C.x))))) (and ($Is intType (int_2_U (A.C.Get $Heap@@0 this@@0)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.A.C) ($IsAlloc refType this@@0 Tclass.A.C $Heap@@0))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 4))) anon0_correct))))
