...
(set-info :boogie-vc-id Impl$$_module.StatementTwoShoes.P)
...
(let ((anon7_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (not (= |a#0| 0)) (not true))) (=> (or (not (= |a#0| 0)) (not true)) (and (=> (= (ControlFlow 0 5) 3) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct)))))))
(let ((anon7_Then_correct true))
(let ((anon6_LoopBody_correct  (and (=> (= (ControlFlow 0 7) 2) anon7_Then_correct) (=> (= (ControlFlow 0 7) 5) anon7_Else_correct))))
(let ((anon6_LoopDone_correct true))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |Definednessdfy.108:5|
 :skolemid |582|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.StatementTwoShoes) ($IsAlloc refType this Tclass._module.StatementTwoShoes $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
