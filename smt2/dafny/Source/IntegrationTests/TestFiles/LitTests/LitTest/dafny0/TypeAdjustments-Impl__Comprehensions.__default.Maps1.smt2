...
(declare-fun |lambda#17| (T@U Int Int Int) T@U)
...
(declare-fun |lambda#18| (Int) T@U)
(declare-fun |map$project$0#0#n#0| (Int) Int)
...
(set-info :boogie-vc-id Impl$$Comprehensions.__default.Maps1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 52) (let ((anon63_Else_correct  (=> (and (and (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 9) (- 0 8))) false)))
(let ((anon63_Then_correct true))
(let ((anon62_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is MapType |$rhs#3@0| (TMap Tclass._System.nat TInt)))))
(let ((anon61_Then_correct true))
(let ((anon60_Then_correct true))
(let ((anon59_Then_correct true))
(let ((anon58_Then_correct true))
(let ((anon32_correct  (=> (and (forall ((|n#7| Int) ) (!  (=> (<= (LitInt 0) |n#7|) (and (=> (and (<= (LitInt (- 0 2)) |n#7|) (< |n#7| 8)) (|Comprehensions.__default.P#canCall| |n#7|)) (forall ((|a#1#0#0@@0| Int) ) (!  (=> (and (and (<= (LitInt (- 0 2)) |a#1#0#0@@0|) (< |a#1#0#0@@0| 8)) (Comprehensions.__default.P |a#1#0#0@@0|)) (and (and (and (<= (LitInt (- 0 2)) (|map$project$0#0#n#0| (+ |a#1#0#0@@0| 2))) (< (|map$project$0#0#n#0| (+ |a#1#0#0@@0| 2)) 8)) (Comprehensions.__default.P (|map$project$0#0#n#0| (+ |a#1#0#0@@0| 2)))) (= (+ |a#1#0#0@@0| 2) (+ (|map$project$0#0#n#0| (+ |a#1#0#0@@0| 2)) 2))))
 :qid |TypeAdjustmentsdfy.558:19|
 :skolemid |2345|
 :pattern ( (Comprehensions.__default.P |a#1#0#0@@0|))
))))
 :qid |TypeAdjustmentsdfy.558:19|
 :skolemid |2346|
 :pattern ( (Comprehensions.__default.P |n#7|))
)) (= |jj#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#17| TInt (LitInt (- 0 2)) 8 2)) (|lambda#18| 2) (TMap TInt TInt)))) (=> (and (and ($Is MapType |$rhs#0@0| (TMap Tclass._System.nat Tclass._System.nat)) ($Is MapType |$rhs#1@0| (TMap Tclass._System.nat Tclass._System.nat))) (and ($Is MapType |$rhs#2@0| (TMap Tclass._System.nat TInt)) ($Is MapType |$rhs#3@0| (TMap TInt TInt)))) (and (and (and (and (and (and (=> (= (ControlFlow 0 10) 1) anon58_Then_correct) (=> (= (ControlFlow 0 10) 2) anon59_Then_correct)) (=> (= (ControlFlow 0 10) 3) anon60_Then_correct)) (=> (= (ControlFlow 0 10) 4) anon61_Then_correct)) (=> (= (ControlFlow 0 10) 6) anon62_Then_correct)) (=> (= (ControlFlow 0 10) 7) anon63_Then_correct)) (=> (= (ControlFlow 0 10) 9) anon63_Else_correct))))))
(let ((anon57_Else_correct  (=> (and (not (and (and (and (<= (LitInt (- 0 2)) |n#6@0|) (< |n#6@0| 8)) (Comprehensions.__default.P |n#6@0|)) (and (and (<= (LitInt (- 0 2)) |n#prime#0@0|) (< |n#prime#0@0| 8)) (Comprehensions.__default.P |n#prime#0@0|)))) (= (ControlFlow 0 14) 10)) anon32_correct)))
(let ((anon57_Then_correct  (=> (and (and (and (<= (LitInt (- 0 2)) |n#6@0|) (< |n#6@0| 8)) (Comprehensions.__default.P |n#6@0|)) (and (and (<= (LitInt (- 0 2)) |n#prime#0@0|) (< |n#prime#0@0| 8)) (Comprehensions.__default.P |n#prime#0@0|))) (and (=> (= (ControlFlow 0 12) (- 0 13)) (or (or (not (= (+ |n#6@0| 2) (+ |n#prime#0@0| 2))) (not true)) (= (+ |n#6@0| 2) (+ |n#prime#0@0| 2)))) (=> (or (or (not (= (+ |n#6@0| 2) (+ |n#prime#0@0| 2))) (not true)) (= (+ |n#6@0| 2) (+ |n#prime#0@0| 2))) (=> (= (ControlFlow 0 12) 10) anon32_correct))))))
(let ((anon56_Else_correct  (=> (not (and (and (<= (LitInt (- 0 2)) |n#6@0|) (< |n#6@0| 8)) (Comprehensions.__default.P |n#6@0|))) (and (=> (= (ControlFlow 0 16) 12) anon57_Then_correct) (=> (= (ControlFlow 0 16) 14) anon57_Else_correct)))))
(let ((anon56_Then_correct  (=> (and (and (<= (LitInt (- 0 2)) |n#6@0|) (< |n#6@0| 8)) (Comprehensions.__default.P |n#6@0|)) (and (=> (= (ControlFlow 0 15) 12) anon57_Then_correct) (=> (= (ControlFlow 0 15) 14) anon57_Else_correct)))))
(let ((anon55_Else_correct  (=> (not (and (and (<= (LitInt (- 0 2)) |n#6@0|) (< |n#6@0| 8)) (Comprehensions.__default.P |n#6@0|))) (and (=> (= (ControlFlow 0 18) 15) anon56_Then_correct) (=> (= (ControlFlow 0 18) 16) anon56_Else_correct)))))
(let ((anon55_Then_correct  (=> (and (and (<= (LitInt (- 0 2)) |n#6@0|) (< |n#6@0| 8)) (Comprehensions.__default.P |n#6@0|)) (and (=> (= (ControlFlow 0 17) 15) anon56_Then_correct) (=> (= (ControlFlow 0 17) 16) anon56_Else_correct)))))
(let ((anon54_Else_correct  (=> (not (and (<= (LitInt (- 0 2)) |n#6@0|) (< |n#6@0| 8))) (and (=> (= (ControlFlow 0 20) 17) anon55_Then_correct) (=> (= (ControlFlow 0 20) 18) anon55_Else_correct)))))
(let ((anon54_Then_correct  (=> (and (and (<= (LitInt (- 0 2)) |n#6@0|) (< |n#6@0| 8)) (and ($IsAlloc intType (int_2_U |n#6@0|) Tclass._System.nat $Heap) (|Comprehensions.__default.P#canCall| |n#6@0|))) (and (=> (= (ControlFlow 0 19) 17) anon55_Then_correct) (=> (= (ControlFlow 0 19) 18) anon55_Else_correct)))))
(let ((anon53_Else_correct  (=> (< |n#6@0| (LitInt (- 0 2))) (and (=> (= (ControlFlow 0 22) 19) anon54_Then_correct) (=> (= (ControlFlow 0 22) 20) anon54_Else_correct)))))
(let ((anon53_Then_correct  (=> (<= (LitInt (- 0 2)) |n#6@0|) (and (=> (= (ControlFlow 0 21) 19) anon54_Then_correct) (=> (= (ControlFlow 0 21) 20) anon54_Else_correct)))))
(let ((anon52_Then_correct  (=> (and (<= (LitInt 0) |n#6@0|) (<= (LitInt 0) |n#prime#0@0|)) (and (=> (= (ControlFlow 0 23) 21) anon53_Then_correct) (=> (= (ControlFlow 0 23) 22) anon53_Else_correct)))))
(let ((anon52_Else_correct  (=> (and (< |n#6@0| (LitInt 0)) (= (ControlFlow 0 11) 10)) anon32_correct)))
(let ((anon21_correct  (=> (and (forall ((|n#5| Int) ) (!  (=> (<= (LitInt 0) |n#5|) (=> (and (<= (LitInt (- 0 2)) |n#5|) (< |n#5| 8)) (|Comprehensions.__default.P#canCall| |n#5|)))
 :qid |TypeAdjustmentsdfy.557:19|
 :skolemid |2343|
 :pattern ( (Comprehensions.__default.P |n#5|))
)) (= |ii#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#2| Tclass._System.nat (LitInt (- 0 2)) 8)) (|lambda#16| 2) (TMap Tclass._System.nat TInt)))) (and (=> (= (ControlFlow 0 24) 23) anon52_Then_correct) (=> (= (ControlFlow 0 24) 11) anon52_Else_correct)))))
(let ((anon51_Else_correct  (=> (and (not (and (and (<= (LitInt (- 0 2)) |n#4@0|) (< |n#4@0| 8)) (Comprehensions.__default.P |n#4@0|))) (= (ControlFlow 0 27) 24)) anon21_correct)))
(let ((anon51_Then_correct  (=> (and (and (and (<= (LitInt (- 0 2)) |n#4@0|) (< |n#4@0| 8)) (Comprehensions.__default.P |n#4@0|)) (= (ControlFlow 0 26) 24)) anon21_correct)))
(let ((anon50_Else_correct  (=> (not (and (<= (LitInt (- 0 2)) |n#4@0|) (< |n#4@0| 8))) (and (=> (= (ControlFlow 0 29) 26) anon51_Then_correct) (=> (= (ControlFlow 0 29) 27) anon51_Else_correct)))))
(let ((anon50_Then_correct  (=> (and (and (<= (LitInt (- 0 2)) |n#4@0|) (< |n#4@0| 8)) (and ($IsAlloc intType (int_2_U |n#4@0|) Tclass._System.nat $Heap) (|Comprehensions.__default.P#canCall| |n#4@0|))) (and (=> (= (ControlFlow 0 28) 26) anon51_Then_correct) (=> (= (ControlFlow 0 28) 27) anon51_Else_correct)))))
(let ((anon49_Else_correct  (=> (< |n#4@0| (LitInt (- 0 2))) (and (=> (= (ControlFlow 0 31) 28) anon50_Then_correct) (=> (= (ControlFlow 0 31) 29) anon50_Else_correct)))))
(let ((anon49_Then_correct  (=> (<= (LitInt (- 0 2)) |n#4@0|) (and (=> (= (ControlFlow 0 30) 28) anon50_Then_correct) (=> (= (ControlFlow 0 30) 29) anon50_Else_correct)))))
(let ((anon48_Then_correct  (=> (<= (LitInt 0) |n#4@0|) (and (=> (= (ControlFlow 0 32) 30) anon49_Then_correct) (=> (= (ControlFlow 0 32) 31) anon49_Else_correct)))))
(let ((anon48_Else_correct  (=> (and (< |n#4@0| (LitInt 0)) (= (ControlFlow 0 25) 24)) anon21_correct)))
(let ((anon14_correct  (=> (and (forall ((|n#3| Int) ) (!  (=> (<= (LitInt 0) |n#3|) (=> (and (<= (LitInt (- 0 2)) |n#3|) (< |n#3| 8)) (|Comprehensions.__default.P#canCall| |n#3|)))
 :qid |TypeAdjustmentsdfy.556:19|
 :skolemid |2342|
 :pattern ( (Comprehensions.__default.P |n#3|))
)) (= |mm#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#2| Tclass._System.nat (LitInt (- 0 2)) 8)) |lambda#9| (TMap Tclass._System.nat Tclass._System.nat)))) (and (=> (= (ControlFlow 0 33) 32) anon48_Then_correct) (=> (= (ControlFlow 0 33) 25) anon48_Else_correct)))))
(let ((anon47_Else_correct  (=> (and (not (and (and (<= (LitInt (- 0 2)) |n#2@0|) (< |n#2@0| 8)) (Comprehensions.__default.P |n#2@0|))) (= (ControlFlow 0 36) 33)) anon14_correct)))
(let ((anon47_Then_correct  (=> (and (and (and (<= (LitInt (- 0 2)) |n#2@0|) (< |n#2@0| 8)) (Comprehensions.__default.P |n#2@0|)) (= (ControlFlow 0 35) 33)) anon14_correct)))
(let ((anon46_Else_correct  (=> (not (and (<= (LitInt (- 0 2)) |n#2@0|) (< |n#2@0| 8))) (and (=> (= (ControlFlow 0 38) 35) anon47_Then_correct) (=> (= (ControlFlow 0 38) 36) anon47_Else_correct)))))
(let ((anon46_Then_correct  (=> (and (and (<= (LitInt (- 0 2)) |n#2@0|) (< |n#2@0| 8)) (and ($IsAlloc intType (int_2_U |n#2@0|) Tclass._System.nat $Heap) (|Comprehensions.__default.P#canCall| |n#2@0|))) (and (=> (= (ControlFlow 0 37) 35) anon47_Then_correct) (=> (= (ControlFlow 0 37) 36) anon47_Else_correct)))))
(let ((anon45_Else_correct  (=> (< |n#2@0| (LitInt (- 0 2))) (and (=> (= (ControlFlow 0 40) 37) anon46_Then_correct) (=> (= (ControlFlow 0 40) 38) anon46_Else_correct)))))
(let ((anon45_Then_correct  (=> (<= (LitInt (- 0 2)) |n#2@0|) (and (=> (= (ControlFlow 0 39) 37) anon46_Then_correct) (=> (= (ControlFlow 0 39) 38) anon46_Else_correct)))))
(let ((anon44_Then_correct  (=> (<= (LitInt 0) |n#2@0|) (and (=> (= (ControlFlow 0 41) 39) anon45_Then_correct) (=> (= (ControlFlow 0 41) 40) anon45_Else_correct)))))
(let ((anon44_Else_correct  (=> (and (< |n#2@0| (LitInt 0)) (= (ControlFlow 0 34) 33)) anon14_correct)))
(let ((anon7_correct  (=> (and (forall ((|n#1| Int) ) (!  (=> (<= (LitInt 0) |n#1|) (=> (and (<= (LitInt (- 0 2)) |n#1|) (< |n#1| 8)) (|Comprehensions.__default.P#canCall| |n#1|)))
 :qid |TypeAdjustmentsdfy.555:19|
 :skolemid |2341|
 :pattern ( (Comprehensions.__default.P |n#1|))
)) (= |nn#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#2| Tclass._System.nat (LitInt (- 0 2)) 8)) |lambda#9| (TMap Tclass._System.nat Tclass._System.nat)))) (and (=> (= (ControlFlow 0 42) 41) anon44_Then_correct) (=> (= (ControlFlow 0 42) 34) anon44_Else_correct)))))
(let ((anon43_Else_correct  (=> (and (not (and (and (<= (LitInt (- 0 2)) |n#0@0|) (< |n#0@0| 8)) (Comprehensions.__default.P |n#0@0|))) (= (ControlFlow 0 45) 42)) anon7_correct)))
(let ((anon43_Then_correct  (=> (and (and (and (<= (LitInt (- 0 2)) |n#0@0|) (< |n#0@0| 8)) (Comprehensions.__default.P |n#0@0|)) (= (ControlFlow 0 44) 42)) anon7_correct)))
(let ((anon42_Else_correct  (=> (not (and (<= (LitInt (- 0 2)) |n#0@0|) (< |n#0@0| 8))) (and (=> (= (ControlFlow 0 47) 44) anon43_Then_correct) (=> (= (ControlFlow 0 47) 45) anon43_Else_correct)))))
(let ((anon42_Then_correct  (=> (and (and (<= (LitInt (- 0 2)) |n#0@0|) (< |n#0@0| 8)) (and ($IsAlloc intType (int_2_U |n#0@0|) Tclass._System.nat $Heap) (|Comprehensions.__default.P#canCall| |n#0@0|))) (and (=> (= (ControlFlow 0 46) 44) anon43_Then_correct) (=> (= (ControlFlow 0 46) 45) anon43_Else_correct)))))
(let ((anon41_Else_correct  (=> (< |n#0@0| (LitInt (- 0 2))) (and (=> (= (ControlFlow 0 49) 46) anon42_Then_correct) (=> (= (ControlFlow 0 49) 47) anon42_Else_correct)))))
(let ((anon41_Then_correct  (=> (<= (LitInt (- 0 2)) |n#0@0|) (and (=> (= (ControlFlow 0 48) 46) anon42_Then_correct) (=> (= (ControlFlow 0 48) 47) anon42_Else_correct)))))
(let ((anon40_Then_correct  (=> (<= (LitInt 0) |n#0@0|) (and (=> (= (ControlFlow 0 50) 48) anon41_Then_correct) (=> (= (ControlFlow 0 50) 49) anon41_Else_correct)))))
(let ((anon40_Else_correct  (=> (and (< |n#0@0| (LitInt 0)) (= (ControlFlow 0 43) 42)) anon7_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 51) 50) anon40_Then_correct) (=> (= (ControlFlow 0 51) 43) anon40_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MapType |nn'#0| (TMap Tclass._System.nat Tclass._System.nat)) ($IsAlloc MapType |nn'#0| (TMap Tclass._System.nat Tclass._System.nat) $Heap))) (=> (and (and (and (and (and ($Is MapType |ii'#0| (TMap Tclass._System.nat TInt)) ($IsAlloc MapType |ii'#0| (TMap Tclass._System.nat TInt) $Heap)) (and ($Is MapType |jj'#0| (TMap TInt TInt)) ($IsAlloc MapType |jj'#0| (TMap TInt TInt) $Heap))) (and (and ($Is MapType |nn#0| (TMap Tclass._System.nat Tclass._System.nat)) ($IsAlloc MapType |nn#0| (TMap Tclass._System.nat Tclass._System.nat) $Heap)) true)) (and (and (and ($Is MapType |mm#0| (TMap Tclass._System.nat Tclass._System.nat)) ($IsAlloc MapType |mm#0| (TMap Tclass._System.nat Tclass._System.nat) $Heap)) true) (and (and ($Is MapType |ii#0| (TMap Tclass._System.nat TInt)) ($IsAlloc MapType |ii#0| (TMap Tclass._System.nat TInt) $Heap)) true))) (and (and (and (and ($Is MapType |jj#0| (TMap TInt TInt)) ($IsAlloc MapType |jj#0| (TMap TInt TInt) $Heap)) true) (and ($Is MapType |$rhs#0| (TMap Tclass._System.nat Tclass._System.nat)) true)) (and (and (and ($Is MapType |$rhs#1| (TMap Tclass._System.nat Tclass._System.nat)) true) (and ($Is MapType |$rhs#2| (TMap Tclass._System.nat TInt)) true)) (and (and ($Is MapType |$rhs#3| (TMap TInt TInt)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 52) 51)))))) anon0_correct))))
