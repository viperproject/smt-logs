...
(set-info :boogie-vc-id CheckWellFormed$$Constraints.Tb)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon6_Then_correct  (=> (= |newtype$check#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 3))) (=> (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 3)) (=> (= (ControlFlow 0 5) (- 0 4)) (or (not (= (Mod (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 5)))) ($Box intType (int_2_U (LitInt 7)))) ($Box intType (int_2_U (LitInt 8))))) (LitInt 0)))) (LitInt 2)) 0)) (not true))))))))
(let ((anon5_Then_correct  (=> (and (<= (LitInt 0) |y#0|) (< |y#0| 3)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |y#0|) (< |y#0| (|Seq#Length| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 5)))) ($Box intType (int_2_U (LitInt 7)))) ($Box intType (int_2_U (LitInt 8))))))))) (=> (and (<= 0 |y#0|) (< |y#0| (|Seq#Length| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U (LitInt 5)))) ($Box intType (int_2_U (LitInt 7)))) ($Box intType (int_2_U (LitInt 8)))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= (LitInt 2) 0)) (not true))))))))
