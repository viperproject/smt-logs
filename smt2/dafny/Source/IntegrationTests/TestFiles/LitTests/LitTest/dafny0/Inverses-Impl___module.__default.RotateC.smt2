...
(declare-fun _module._default.RotateC$T () T@U)
...
(declare-fun $LZ () T@U)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.RotateC)
...
(let ((anon13_correct  (and (=> (= (ControlFlow 0 7) (- 0 11)) (and (<= 0 (ite (= |i#0_0@0| (- (_System.array.Length |a#0|) 1)) 0 (+ |i#0_0@0| 1))) (< (ite (= |i#0_0@0| (- (_System.array.Length |a#0|) 1)) 0 (+ |i#0_0@0| 1)) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (ite (= |i#0_0@0| (- (_System.array.Length |a#0|) 1)) 0 (+ |i#0_0@0| 1)))))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (ite (= |i#0_0@0| (- (_System.array.Length |a#0|) 1)) 0 (+ |i#0_0@0| 1))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and ($IsAlloc intType (int_2_U |i#0_0@0|) TInt $Heap@0) (|_module.__default.Id#canCall| |i#0_0@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 (_module.__default.Id |i#0_0@0|)) (< (_module.__default.Id |i#0_0@0|) (_System.array.Length |a#0|)))) (=> (|_module.__default.Id#canCall| |i#0_0@0|) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 7) (- 0 6)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (ite (= |i#0_0@0| (- (_System.array.Length |a#0|) 1)) 0 (+ |i#0_0@0| 1))) (IndexField (ite (= |i#0_1@0| (- (_System.array.Length |a#0|) 1)) 0 (+ |i#0_1@0| 1))))) (not true))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_0@0|))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_1@0|))))))))))))))))
(let ((anon21_Else_correct  (=> (and (or (not (= |i#0_0@0| (- (_System.array.Length |a#0|) 1))) (not true)) (= (ControlFlow 0 13) 7)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (= |i#0_0@0| (- (_System.array.Length |a#0|) 1)) (= (ControlFlow 0 12) 7)) anon13_correct)))
...
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |r#0@0|) alloc)))))) (=> (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |r#0@0|) alloc))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (_System.array.Length |r#0@0|) (_System.array.Length |a#0|))) (=> (= (_System.array.Length |r#0@0|) (_System.array.Length |a#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|k#1| Int) ) (!  (=> (and (<= (LitInt 0) |k#1|) (< |k#1| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |r#0@0|) (IndexField (Mod (+ |k#1| 1) (_System.array.Length |a#0|)))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#1|))))
 :qid |Inversesdfy.91:18|
 :skolemid |568|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#1|)))
)))))))))
(let ((anon19_Else_correct  (=> (and (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) ($HeapSucc $Heap@0 $Heap@1)) (and (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (or (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@9) $f@@1) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@9) $f@@1)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| (_System.array.Length |a#0|))) (= $o@@9 $nw@0)) (= $f@@1 (IndexField (ite (= |i#0_2| (- (_System.array.Length |a#0|) 1)) 0 (+ |i#0_2| 1)))))
 :qid |Inversesdfy.94:10|
 :skolemid |572|
)))
 :qid |Inversesdfy.94:3|
 :skolemid |573|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@9) $f@@1))
)) (forall ((|i#inv#0_0| Int) ) (!  (=> (and (and (<= (LitInt 0) (- (_System.array.Length |a#0|) 1)) (< (- (_System.array.Length |a#0|) 1) (_System.array.Length |a#0|))) (= |i#inv#0_0| (LitInt 0))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id (- (_System.array.Length |a#0|) 1))))))
 :qid |Inversesdfy.94:10|
 :skolemid |574|
...
)))) (and (and (forall ((|i#inv#0_0@@0| Int) ) (!  (=> (and (and (<= (LitInt 0) (- |i#inv#0_0@@0| 1)) (< (- |i#inv#0_0@@0| 1) (_System.array.Length |a#0|))) (or (not (= (- |i#inv#0_0@@0| 1) (- (_System.array.Length |a#0|) 1))) (not true))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0@@0|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id (- |i#inv#0_0@@0| 1))))))
 :qid |Inversesdfy.94:10|
 :skolemid |575|
...
(let ((anon15_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.RotateC$T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (_System.array.Length |a#0|))) (Requires1 TInt _module._default.RotateC$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Inversesdfy.93:8|
 :skolemid |570|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 TInt _module._default.RotateC$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |Inversesdfy.93:8|
 :skolemid |571|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array _module._default.RotateC$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.RotateC$T) $Heap))) (and (and ($Is refType |r#0| (Tclass._System.array _module._default.RotateC$T)) ($IsAlloc refType |r#0| (Tclass._System.array _module._default.RotateC$T) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 38) 35)))) anon0_correct)))
