...
(set-info :boogie-vc-id Impl$$Recursion.__default.B_h)
...
(let ((anon3_Then_correct  (=> (and (< 0 (|ORD#Offset| |_k#0|)) (= |_k##0@0| (Lit BoxType (|ORD#FromNat| 10)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (or (<= 0 |x#1|) (|ORD#Less| |_k##0@0| |_k#0|)) (= |x#1| |x#1|))) (=> (or (or (<= 0 |x#1|) (|ORD#Less| |_k##0@0| |_k#0|)) (= |x#1| |x#1|)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (|ORD#Less| |_k##0@0| |_k#0|) (and (= |_k##0@0| |_k#0|) (< |x#1| |x#1|)))))))))
