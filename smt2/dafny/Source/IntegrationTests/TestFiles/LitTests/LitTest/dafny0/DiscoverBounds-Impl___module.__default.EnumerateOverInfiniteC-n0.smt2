...
(assert (forall ((a@@4 T@U) (b@@1 T@U) (t0@@8 T@U) (t1@@4 T@U) ) (!  (=> (forall ((bx@@11 T@U) )  (=> (U_2_bool (MapType0Select BoxType boolType a@@4 bx@@11)) (and ($IsBox bx@@11 t0@@8) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@11) t1@@4)))) ($Is IMapType (|IMap#Glue| a@@4 b@@1 (TIMap t0@@8 t1@@4)) (TIMap t0@@8 t1@@4)))
