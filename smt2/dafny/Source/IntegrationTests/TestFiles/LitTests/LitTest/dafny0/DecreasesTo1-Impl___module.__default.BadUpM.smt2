...
(set-info :boogie-vc-id Impl$$_module.__default.BadUpM)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon3_Else_correct  (=> (or (not (= |m#0| |n#0|)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 6)) ($Is intType (int_2_U (+ |m#0| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ |m#0| 1)) Tclass._System.nat) (=> (= |m##1_0@0| (+ |m#0| 1)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (<= 0 (+ |n#0| |m#0|)) (= (+ |n#0| |m##1_0@0|) (+ |n#0| |m#0|)))) (=> (or (<= 0 (+ |n#0| |m#0|)) (= (+ |n#0| |m##1_0@0|) (+ |n#0| |m#0|))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< (+ |n#0| |m##1_0@0|) (+ |n#0| |m#0|))) (=> (< (+ |n#0| |m##1_0@0|) (+ |n#0| |m#0|)) (=> (and (and ($Is DatatypeTypeType |call3formal@r#0| Tclass._module.List) ($IsAlloc DatatypeTypeType |call3formal@r#0| Tclass._module.List $Heap)) (= (ControlFlow 0 3) (- 0 2))) (<= |m##1_0@0| |n#0|))))))))))))
(let ((anon3_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 7) 1) anon3_Then_correct) (=> (= (ControlFlow 0 7) 3) anon3_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |m#0|) (<= (LitInt 0) |n#0|)) (and ($Is DatatypeTypeType |r#0| Tclass._module.List) ($IsAlloc DatatypeTypeType |r#0| Tclass._module.List $Heap))) (=> (and (and (and (and ($Is DatatypeTypeType |r'#1_0| Tclass._module.List) ($IsAlloc DatatypeTypeType |r'#1_0| Tclass._module.List $Heap)) true) (= 1 $FunctionContextHeight)) (and (<= |m#0| |n#0|) (= (ControlFlow 0 8) 7))) anon0_correct)))))
