...
(set-info :boogie-vc-id Impl$$_module.__default.TestAllCases)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon2_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (_module.Fwd.FwdNil_q |f#0|) (_module.Fwd.FwdCons_q |f#0|)))))
(let ((anon3_Else_correct  (=> (and (_module.Fwd.FwdNil_q |f#0|) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (not (_module.Fwd.FwdNil_q |f#0|)) (= (ControlFlow 0 3) 2)) anon2_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |f#0| Tclass._module.Fwd) ($IsAlloc DatatypeTypeType |f#0| Tclass._module.Fwd $Heap)) (|$IsA#_module.Fwd| |f#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct))))
