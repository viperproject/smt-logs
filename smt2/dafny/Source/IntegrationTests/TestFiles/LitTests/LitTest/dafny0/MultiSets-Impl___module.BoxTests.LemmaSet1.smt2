...
(assert (distinct TagSet alloc Tagclass._module.BoxTests? Tagclass._module.BoxTests tytagFamily$BoxTests)
)
...
(set-info :boogie-vc-id Impl$$_module.BoxTests.LemmaSet1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|Set#Subset| |a#0| |b#0|))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.BoxTests _module.BoxTests$G@@9)) ($IsAlloc refType this (Tclass._module.BoxTests _module.BoxTests$G@@9) $Heap))) (and ($Is SetType |a#0| (TSet _module.BoxTests$G@@9)) ($IsAlloc SetType |a#0| (TSet _module.BoxTests$G@@9) $Heap))) (=> (and (and (and ($Is SetType |b#0| (TSet _module.BoxTests$G@@9)) ($IsAlloc SetType |b#0| (TSet _module.BoxTests$G@@9) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|x#1| T@U) ) (!  (=> ($IsBox |x#1| _module.BoxTests$G@@9) (=> (|Set#IsMember| |a#0| |x#1|) (|Set#IsMember| |b#0| |x#1|)))
 :qid |MultiSetsdfy.117:21|
 :skolemid |611|
 :pattern ( (|Set#IsMember| |b#0| |x#1|))
 :pattern ( (|Set#IsMember| |a#0| |x#1|))
