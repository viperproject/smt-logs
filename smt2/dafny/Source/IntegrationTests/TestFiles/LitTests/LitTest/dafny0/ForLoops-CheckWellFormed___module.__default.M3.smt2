...
(assert (not
 ...
 :qid |ForLoopsdfy.30:8|
 :skolemid |494|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@0))
))) (and (and ($HeapSucc $Heap $Heap@0) (<= (LitInt 0) |r#0@0|)) (and (= |newtype$check#0@0| (Mul |n#0| |n#0|)) (= (ControlFlow 0 2) (- 0 1))))) (<= (LitInt 0) |newtype$check#0@0|)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (<= (LitInt 0) |n#0|) (<= (LitInt 0) |r#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
