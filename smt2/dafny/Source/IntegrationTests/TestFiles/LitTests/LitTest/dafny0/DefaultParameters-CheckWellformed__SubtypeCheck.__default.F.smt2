...
(set-info :boogie-vc-id CheckWellformed$$SubtypeCheck.__default.F)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($Is intType (int_2_U |i#0|) Tclass._System.nat)) (=> ($Is intType (int_2_U |i#0|) Tclass._System.nat) (and (=> (= (ControlFlow 0 3) 1) anon4_Then_correct) (=> (= (ControlFlow 0 3) 2) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |x#0@@0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 3))) anon0_correct)))
