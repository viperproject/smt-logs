...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@4 T@U) ($f@@0 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o@@4 $f@@0))  (=> (and (or (not (= $o@@4 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@4) |l#2|)))) (= $o@@4 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1822|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#2| |l#0| |l#1| |l#2| |l#3|) $o@@4 $f@@0))
)))
(assert (forall (($h@@5 T@U) ($o@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (or (not (= $o@@5 null)) (not true)) (= (dtype $o@@5) Tclass._module.NodeAuto?))) ($Is refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) _module.NodeAuto.next)) Tclass._module.NodeAuto?))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1648|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@5 $o@@5) _module.NodeAuto.next)))
)))
...
(assert (forall (($h@@6 T@U) ($o@@6 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@6) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) Tclass._module.NodeAuto?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@6) alloc)))) ($IsAlloc refType ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@6) _module.NodeAuto.next)) Tclass._module.NodeAuto? $h@@6))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1649|
 :pattern ( ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@6 $o@@6) _module.NodeAuto.next)))
)))
...
(assert (forall (($h@@7 T@U) ($o@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (or (not (= $o@@7 null)) (not true)) (= (dtype $o@@7) Tclass._module.NodeAuto?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@7) _module.NodeAuto.Repr)) (TSet Tclass._System.object?)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1700|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@7 $o@@7) _module.NodeAuto.Repr)))
)))
(assert (forall (($h@@8 T@U) ($o@@8 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@8) (and (or (not (= $o@@8 null)) (not true)) (= (dtype $o@@8) Tclass._module.NodeAuto?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@8) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@8) _module.NodeAuto.Repr)) (TSet Tclass._System.object?) $h@@8))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1701|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@8 $o@@8) _module.NodeAuto.Repr)))
)))
...
(assert (forall (($h@@9 T@U) ($o@@10 T@U) ) (!  (=> (and ($IsGoodHeap $h@@9) (and (or (not (= $o@@10 null)) (not true)) (= (dtype $o@@10) Tclass._module.NodeAuto?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@10) _module.NodeAuto.x)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1646|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@9 $o@@10) _module.NodeAuto.x)))
)))
...
(assert (forall (($h0@@0 T@U) ($h1@@0 T@U) (this@@1 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0@@0) ($IsGoodHeap $h1@@0)) (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.NodeAuto))) (and ($IsHeapAnchor $h0@@0) ($HeapSucc $h0@@0 $h1@@0))) (=> (forall (($o@@11 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (or (= $o@@11 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 this@@1) _module.NodeAuto.Repr)) ($Box refType $o@@11)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0@@0 $o@@11) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1@@0 $o@@11) $f@@1)))
 :qid |unknown.0:0|
 :skolemid |1702|
...
(set-info :boogie-vc-id Impl$$_module.NodeAuto.M)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 41) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@3 alloc |node#0|)) ($IsAllocBox ($Box refType this@@5) Tclass._module.NodeAuto? $Heap@@3)) (and (=> (= (ControlFlow 0 2) (- 0 40)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@@3 this@@5) (or (_module.NodeAuto.Valid $Heap@@3 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr)) ($Box refType this@@5))))) (and (=> (= (ControlFlow 0 2) (- 0 39)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@@3 this@@5) (or (_module.NodeAuto.Valid $Heap@@3 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr)) ($Box refType null)))))) (and (=> (= (ControlFlow 0 2) (- 0 38)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@@3 this@@5) (or (_module.NodeAuto.Valid $Heap@@3 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next)))))) (and (=> (= (ControlFlow 0 2) (- 0 37)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@@3 this@@5) (or (_module.NodeAuto.Valid $Heap@@3 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr))))))) (and (=> (= (ControlFlow 0 2) (- 0 36)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@@3 this@@5) (or (_module.NodeAuto.Valid $Heap@@3 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Box refType this@@5))))))) (and (=> (= (ControlFlow 0 2) (- 0 35)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@@3 this@@5) (or (_module.NodeAuto.Valid $Heap@@3 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next)) null)) (not true)) (_module.NodeAuto.Valid $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next))))))) (and (=> (= (ControlFlow 0 2) (- 0 34)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@@3 this@@5) (or (_module.NodeAuto.Valid $Heap@@3 this@@5) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (and (and (_module.NodeAuto.Valid $Heap@@3 this@@5) (|_module.NodeAuto.Sum#canCall| $Heap@@3 this@@5)) (and (|_module.NodeAuto.Sum#canCall| $Heap@@3 this@@5) (= |s#0@0| (_module.NodeAuto.Sum ($LS $LZ) $Heap@@3 this@@5)))) (and (=> (= (ControlFlow 0 2) (- 0 33)) (or (not (= |node#0| null)) (not true))) (=> (or (not (= |node#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 32)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |node#0| _module.NodeAuto.x))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |node#0| _module.NodeAuto.x)) (and (=> (= (ControlFlow 0 2) (- 0 31)) (or (not (= |node#0| null)) (not true))) (=> (or (not (= |node#0| null)) (not true)) (=> (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |node#0|) _module.NodeAuto.x))) 1)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@3 |node#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |node#0|) _module.NodeAuto.x ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 30)) ($IsAlloc refType this@@5 Tclass._module.NodeAuto $Heap@@3)) (=> ($IsAlloc refType this@@5 Tclass._module.NodeAuto $Heap@@3) (and (=> (= (ControlFlow 0 2) (- 0 29)) ($IsAlloc refType |node#0| Tclass._module.NodeAuto $Heap@@3)) (=> ($IsAlloc refType |node#0| Tclass._module.NodeAuto $Heap@@3) (=> (= call0formal@previous$Heap@0 $Heap@@3) (and (=> (= (ControlFlow 0 2) (- 0 28)) ($IsAlloc refType |node#0| Tclass._module.NodeAuto call0formal@previous$Heap@0)) (=> ($IsAlloc refType |node#0| Tclass._module.NodeAuto call0formal@previous$Heap@0) (and (=> (= (ControlFlow 0 2) (- 0 27)) (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)) ($Box refType this@@5))))) (=> (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)) ($Box refType this@@5)))) (and (=> (= (ControlFlow 0 2) (- 0 26)) (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)) ($Box refType null)))))) (=> (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 25)) (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)))))) (=> (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next))))) (and (=> (= (ControlFlow 0 2) (- 0 24)) (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr))))))) (=> (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)))))) (and (=> (= (ControlFlow 0 2) (- 0 23)) (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Box refType this@@5))))))) (=> (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Box refType this@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 22)) (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (_module.NodeAuto.Valid call0formal@previous$Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next))))))) (=> (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (_module.NodeAuto.Valid call0formal@previous$Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.next)))))) (and (=> (= (ControlFlow 0 2) (- 0 21)) (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (=> (|_module.NodeAuto.Valid#canCall| call0formal@previous$Heap@0 this@@5) (or (_module.NodeAuto.Valid call0formal@previous$Heap@0 this@@5) (U_2_bool (Lit boolType (bool_2_U true))))) (and (=> (= (ControlFlow 0 2) (- 0 20)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |node#0|) _module.NodeAuto.x))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |node#0|) _module.NodeAuto.x))))) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |node#0|) _module.NodeAuto.x))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |node#0|) _module.NodeAuto.x)))) (and (=> (= (ControlFlow 0 2) (- 0 19)) (|_System.Tuple2#Equal| (|#_System._tuple#2._#Make2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |node#0|) _module.NodeAuto.next) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |node#0|) _module.NodeAuto.Repr)) (|#_System._tuple#2._#Make2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |node#0|) _module.NodeAuto.next) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |node#0|) _module.NodeAuto.Repr)))) (=> (|_System.Tuple2#Equal| (|#_System._tuple#2._#Make2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |node#0|) _module.NodeAuto.next) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 |node#0|) _module.NodeAuto.Repr)) (|#_System._tuple#2._#Make2| (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |node#0|) _module.NodeAuto.next) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |node#0|) _module.NodeAuto.Repr))) (and (=> (= (ControlFlow 0 2) (- 0 18)) (forall (($o@@12 T@U) ($f@@2 T@U) ) (!  (=> (or (not (= $o@@12 null)) (not true)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)) ($Box refType $o@@12)) (or (not (= $o@@12 |node#0|)) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@12) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@12) $f@@2))))
 :qid |TwostateVerificationdfy.220:14|
 :skolemid |1689|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@12) $f@@2))
))) (=> (forall (($o@@13 T@U) ($f@@3 T@U) ) (!  (=> (or (not (= $o@@13 null)) (not true)) (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 this@@5) _module.NodeAuto.Repr)) ($Box refType $o@@13)) (or (not (= $o@@13 |node#0|)) (not true))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13) $f@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) call0formal@previous$Heap@0 $o@@13) $f@@3))))
 :qid |TwostateVerificationdfy.220:14|
 :skolemid |1689|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@13) $f@@3))
)) (=> (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and (|_module.NodeAuto.Valid#canCall| $Heap@0 this@@5) (=> (_module.NodeAuto.Valid $Heap@0 this@@5) (and (|_module.NodeAuto.Sum#canCall| call0formal@previous$Heap@0 this@@5) (|_module.NodeAuto.Sum#canCall| $Heap@0 this@@5))))) (=> (and (and (and (|_module.NodeAuto.Valid#canCall| $Heap@0 this@@5) (and (_module.NodeAuto.Valid $Heap@0 this@@5) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.Repr)) ($Box refType this@@5)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.Repr)) ($Box refType null)))) (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.next)) null)) (not true)) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.next)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.Repr))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Box refType this@@5))))) (_module.NodeAuto.Valid $Heap@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@5) _module.NodeAuto.next))))) true)))) (<= (_module.NodeAuto.Sum ($LS ($LS $LZ)) call0formal@previous$Heap@0 this@@5) (_module.NodeAuto.Sum ($LS ($LS $LZ)) $Heap@0 this@@5))) (and (= $Heap@0 $Heap@1) ($IsAllocBox ($Box refType this@@5) Tclass._module.NodeAuto? $Heap@1))) (and (=> (= (ControlFlow 0 2) (- 0 17)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) ($Box refType this@@5))))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) ($Box refType null)))))) (and (=> (= (ControlFlow 0 2) (- 0 15)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)))))) (and (=> (= (ControlFlow 0 2) (- 0 14)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr))))))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Box refType this@@5))))))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (_module.NodeAuto.Valid $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))))))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (and (|_module.NodeAuto.Sum#canCall| $Heap@1 this@@5) (|_module.NodeAuto.Sum#canCall| $Heap@1 this@@5)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (<= |s#0@0| (_module.NodeAuto.Sum ($LS ($LS $LZ)) $Heap@1 this@@5))) (=> (<= |s#0@0| (_module.NodeAuto.Sum ($LS $LZ) $Heap@1 this@@5)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) ($Box refType this@@5))))) (=> (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) ($Box refType this@@5)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) ($Box refType null)))))) (=> (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) ($Box refType null))))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)))))) (=> (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr))))))) (=> (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Box refType this@@5))))))) (=> (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Box refType this@@5)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (_module.NodeAuto.Valid $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next))))))) (=> (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)) null)) (not true)) (_module.NodeAuto.Valid $Heap@1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.next)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (U_2_bool (Lit boolType (bool_2_U true)))))) (=> (=> (|_module.NodeAuto.Valid#canCall| $Heap@1 this@@5) (or (_module.NodeAuto.Valid $Heap@1 this@@5) (U_2_bool (Lit boolType (bool_2_U true))))) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@14 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) ($Box refType $o@@14)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr)) ($Box refType $o@@14)))) (or (not (= $o@@14 null)) (not true)))
 :qid |TwostateVerificationdfy.209:10|
 :skolemid |1684|
 :pattern (  (or (not (= $o@@14 null)) (not true)))
)) (forall (($o@@15 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@5) _module.NodeAuto.Repr)) ($Box refType $o@@15)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr)) ($Box refType $o@@15)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@15) alloc)))))
 :qid |TwostateVerificationdfy.209:10|
 :skolemid |1685|
 :pattern ( ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 $o@@15) alloc)))
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.NodeAuto) ($IsAlloc refType this@@5 Tclass._module.NodeAuto $Heap@@3)))) (=> (and (and (and ($Is refType |node#0| Tclass._module.NodeAuto) ($IsAlloc refType |node#0| Tclass._module.NodeAuto $Heap@@3)) (= 3 $FunctionContextHeight)) (and (and (|_module.NodeAuto.Valid#canCall| $Heap@@3 this@@5) (and (_module.NodeAuto.Valid $Heap@@3 this@@5) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr)) ($Box refType this@@5)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr)) ($Box refType null)))) (and (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next)) null)) (not true)) (and (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr)) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.Repr))) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Box refType this@@5))))) (_module.NodeAuto.Valid $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@5) _module.NodeAuto.next))))) true)))) (= (ControlFlow 0 41) 2))) anon0_correct))))
