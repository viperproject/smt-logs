...
(assert (distinct TagSet alloc Tagclass._System.object? Tagclass._System.object Tagclass._module.BoxTests? Tagclass._module.BoxTests tytagFamily$object tytagFamily$BoxTests)
)
...
(assert (forall ((_module.BoxTests$G@@0 T@U) ($o T@U) ($h@@1 T@U) ) (! (= ($IsAlloc refType $o (Tclass._module.BoxTests? _module.BoxTests$G@@0) $h@@1)  (or (= $o null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o) alloc)))))
 :qid |unknown.0:0|
 :skolemid |597|
 :pattern ( ($IsAlloc refType $o (Tclass._module.BoxTests? _module.BoxTests$G@@0) $h@@1))
)))
...
(assert (forall ((_module.BoxTests$G@@1 T@U) (|c#0@@1| T@U) ) (! (= ($Is refType |c#0@@1| (Tclass._module.BoxTests _module.BoxTests$G@@1))  (and ($Is refType |c#0@@1| (Tclass._module.BoxTests? _module.BoxTests$G@@1)) (or (not (= |c#0@@1| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |654|
 :pattern ( ($Is refType |c#0@@1| (Tclass._module.BoxTests _module.BoxTests$G@@1)))
 :pattern ( ($Is refType |c#0@@1| (Tclass._module.BoxTests? _module.BoxTests$G@@1)))
)))
...
(assert (forall ((_module.BoxTests$G@@4 T@U) ($o@@1 T@U) ) (! (= ($Is refType $o@@1 (Tclass._module.BoxTests? _module.BoxTests$G@@4))  (or (= $o@@1 null) (= (dtype $o@@1) (Tclass._module.BoxTests? _module.BoxTests$G@@4))))
 :qid |unknown.0:0|
 :skolemid |596|
 :pattern ( ($Is refType $o@@1 (Tclass._module.BoxTests? _module.BoxTests$G@@4)))
)))
...
(assert (forall ((_module.BoxTests$G@@7 T@U) (bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 (Tclass._module.BoxTests? _module.BoxTests$G@@7)) (and (= ($Box refType ($Unbox refType bx@@4)) bx@@4) ($Is refType ($Unbox refType bx@@4) (Tclass._module.BoxTests? _module.BoxTests$G@@7))))
 :qid |unknown.0:0|
 :skolemid |595|
 :pattern ( ($IsBox bx@@4 (Tclass._module.BoxTests? _module.BoxTests$G@@7)))
)))
(assert (forall ((_module.BoxTests$G@@8 T@U) (bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 (Tclass._module.BoxTests _module.BoxTests$G@@8)) (and (= ($Box refType ($Unbox refType bx@@5)) bx@@5) ($Is refType ($Unbox refType bx@@5) (Tclass._module.BoxTests _module.BoxTests$G@@8))))
 :qid |unknown.0:0|
 :skolemid |600|
 :pattern ( ($IsBox bx@@5 (Tclass._module.BoxTests _module.BoxTests$G@@8)))
)))
...
(set-info :boogie-vc-id Impl$$_module.BoxTests.LemmaSet3)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.BoxTests _module.BoxTests$G@@9)) ($IsAlloc refType this (Tclass._module.BoxTests _module.BoxTests$G@@9) $Heap))) (and ($Is SetType |a#0| (TSet Tclass._System.object)) ($IsAlloc SetType |a#0| (TSet Tclass._System.object) $Heap))) (=> (and (and (and ($Is SetType |b#0| (TSet Tclass._System.object)) ($IsAlloc SetType |b#0| (TSet Tclass._System.object) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|x#1| T@U) ) (!  (=> ($Is refType |x#1| Tclass._System.object) (=> (|Set#IsMember| |a#0| ($Box refType |x#1|)) (|Set#IsMember| |b#0| ($Box refType |x#1|))))
 :qid |MultiSetsdfy.129:21|
 :skolemid |623|
 :pattern ( (|Set#IsMember| |b#0| ($Box refType |x#1|)))
 :pattern ( (|Set#IsMember| |a#0| ($Box refType |x#1|)))
