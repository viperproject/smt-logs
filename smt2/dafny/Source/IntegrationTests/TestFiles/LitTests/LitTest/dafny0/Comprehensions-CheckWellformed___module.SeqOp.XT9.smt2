...
(declare-fun _module.SeqOp.XT9 (T@U Int) T@U)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.XT9#canCall| (T@U Int) Bool)
(declare-fun Tclass._module.SeqOp () T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.XT9#canCall| (Lit refType this) (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) (= (_module.SeqOp.XT9 (Lit refType this) (LitInt |n#0|)) (|Seq#Create| TInt $Heap (LitInt |n#0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |Comprehensionsdfy.188:12|
 :weight 3
 :skolemid |752|
 :pattern ( (_module.SeqOp.XT9 (Lit refType this) (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.XT9#canCall| this@@0 |n#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)))) ($Is SeqType (_module.SeqOp.XT9 this@@0 |n#0@@0|) (TSeq Tclass._System.nat)))
 :qid |Comprehensionsdfy.188:12|
 :skolemid |748|
 :pattern ( (_module.SeqOp.XT9 this@@0 |n#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.XT9#canCall| this@@1 |n#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@1|)))) (= (_module.SeqOp.XT9 this@@1 |n#0@@1|) (|Seq#Create| TInt $Heap@@0 |n#0@@1| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0@@1| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |Comprehensionsdfy.188:12|
 :skolemid |750|
 :pattern ( (_module.SeqOp.XT9 this@@1 |n#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.XT9)
...
(let ((anon14_Else_correct  (=> (and (and (<= |n#0@@3| |i#0@0|) (= |lambdaResult#0| (LitInt 10))) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 9) 7))) anon8_correct)))
(let ((anon14_Then_correct  (=> (and (and (< |i#0@0| |n#0@@3|) (= |lambdaResult#0| (LitInt (- 0 7)))) (and ($Is intType (int_2_U |lambdaResult#0|) TInt) (= (ControlFlow 0 8) 7))) anon8_correct)))
(let ((anon13_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#0| null |$lambdaHeap#0@0| alloc false)) (and (=> (= (ControlFlow 0 10) 8) anon14_Then_correct) (=> (= (ControlFlow 0 10) 9) anon14_Else_correct)))))
(let ((anon13_Else_correct true))
(let ((anon12_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap@@2 |$lambdaHeap#0@0|) ($HeapSucc $Heap@@2 |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 11) 10) anon13_Then_correct) (=> (= (ControlFlow 0 11) 6) anon13_Else_correct)))))
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 5)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt TInt $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0@@3| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 :qid |Comprehensionsdfy.189:5|
 :skolemid |753|
 ...
 :qid |Comprehensionsdfy.189:5|
 :skolemid |756|
))) (=> (= (_module.SeqOp.XT9 this@@3 |n#0@@3|) (|Seq#Create| TInt $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0@@3| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))) (=> (and ($Is SeqType (_module.SeqOp.XT9 this@@3 |n#0@@3|) (TSeq Tclass._System.nat)) (= (ControlFlow 0 3) (- 0 2))) |b$reqreads#0@0|)))))))
