...
(assert (forall ((a@@7 T@U) (b@@7 T@U) ) (! (= (|Set#Subset| a@@7 b@@7) (forall ((o@@0 T@U) ) (!  (=> (|Set#IsMember| a@@7 o@@0) (|Set#IsMember| b@@7 o@@0))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| T@U) (|l#2| T@U) (|$w#0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#25| |l#0@@0| |l#1@@0| |l#2|) |$w#0|) (ite (|Set#IsMember| |l#0@@0| |$w#0|) (MapType0Select BoxType BoxType |l#1@@0| |$w#0|) (MapType0Select BoxType BoxType |l#2| |$w#0|)))
 :qid |Mapsdfy.177:50|
 :skolemid |919|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#25| |l#0@@0| |l#1@@0| |l#2|) |$w#0|))
)))
...
(declare-fun |i#12@0| () T@U)
(declare-fun _module._default.union$U@@3 () T@U)
(declare-fun _module._default.union$V@@3 () T@U)
(declare-fun |m#0@@7| () T@U)
(declare-fun $Heap@@1 () T@U)
(declare-fun |i#11@0| () T@U)
(declare-fun |i#10@0| () T@U)
(declare-fun |i#9@0| () T@U)
(declare-fun |i#13@0| () T@U)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 41) (let ((anon14_correct true))
(let ((anon26_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |m'#0@@3|) |i#12@0|) (= (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#12@0|) (MapType0Select BoxType BoxType (|Map#Elements| |m'#0@@3|) |i#12@0|))) (= (ControlFlow 0 21) 15)) anon14_correct)))
(let ((anon26_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m'#0@@3|) |i#12@0|) (=> (and ($IsAlloc MapType |m#0@@7| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1) ($IsAlloc MapType |m'#0@@3| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1)) (and (=> (= (ControlFlow 0 16) (- 0 20)) (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|))) (=> (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) (and (=> (= (ControlFlow 0 16) (- 0 19)) (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (or (and (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (not (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)))) (and (|Set#Equal| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (and (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)) (not (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)))))))) (=> (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (or (and (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (not (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)))) (and (|Set#Equal| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (and (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)) (not (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|))))))) (=> (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (|_module.__default.union#canCall| _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) (and (=> (= (ControlFlow 0 16) (- 0 18)) (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#12@0|)) (=> (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#12@0|) (and (=> (= (ControlFlow 0 16) (- 0 17)) (|Set#IsMember| (|Map#Domain| |m'#0@@3|) |i#12@0|)) (=> (|Set#IsMember| (|Map#Domain| |m'#0@@3|) |i#12@0|) (=> (and (= (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#12@0|) (MapType0Select BoxType BoxType (|Map#Elements| |m'#0@@3|) |i#12@0|)) (= (ControlFlow 0 16) 15)) anon14_correct))))))))))))))
(let ((anon11_correct  (=> (forall ((|i#7| T@U) ) (!  (=> ($IsBox |i#7| _module._default.union$U@@3) (=> (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#7|) (= (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#7|) (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@7|) |i#7|))))
 :qid |Mapsdfy.174:19|
 :skolemid |630|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@7|) |i#7|))
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#7|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#7|))
)) (=> (and ($IsBox |i#12@0| _module._default.union$U@@3) ($IsAllocBox |i#12@0| _module._default.union$U@@3 $Heap@@1)) (and (=> (= (ControlFlow 0 22) 16) anon26_Then_correct) (=> (= (ControlFlow 0 22) 21) anon26_Else_correct))))))
(let ((anon25_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#11@0|) (= (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#11@0|) (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@7|) |i#11@0|))) (= (ControlFlow 0 28) 22)) anon11_correct)))
(let ((anon25_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#11@0|) (=> (and ($IsAlloc MapType |m#0@@7| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1) ($IsAlloc MapType |m'#0@@3| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1)) (and (=> (= (ControlFlow 0 23) (- 0 27)) (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|))) (=> (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) (and (=> (= (ControlFlow 0 23) (- 0 26)) (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (or (and (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (not (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)))) (and (|Set#Equal| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (and (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)) (not (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)))))))) (=> (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (or (and (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (not (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)))) (and (|Set#Equal| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (and (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)) (not (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|))))))) (=> (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (|_module.__default.union#canCall| _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) (and (=> (= (ControlFlow 0 23) (- 0 25)) (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#11@0|)) (=> (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#11@0|) (and (=> (= (ControlFlow 0 23) (- 0 24)) (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#11@0|)) (=> (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#11@0|) (=> (and (= (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#11@0|) (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@7|) |i#11@0|)) (= (ControlFlow 0 23) 22)) anon11_correct))))))))))))))
(let ((anon8_correct  (=> (forall ((|i#6| T@U) ) (!  (=> ($IsBox |i#6| _module._default.union$U@@3) (=> (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#6|) (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#6|)))
 :qid |Mapsdfy.173:19|
 :skolemid |629|
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#6|))
 :pattern ( (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#6|))
)) (=> (and ($IsBox |i#11@0| _module._default.union$U@@3) ($IsAllocBox |i#11@0| _module._default.union$U@@3 $Heap@@1)) (and (=> (= (ControlFlow 0 29) 23) anon25_Then_correct) (=> (= (ControlFlow 0 29) 28) anon25_Else_correct))))))
(let ((anon24_Else_correct  (=> (and (=> (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#10@0|) (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#10@0|)) (= (ControlFlow 0 33) 29)) anon8_correct)))
(let ((anon24_Then_correct  (=> (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#10@0|) (=> (and ($IsAlloc MapType |m#0@@7| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1) ($IsAlloc MapType |m'#0@@3| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1)) (and (=> (= (ControlFlow 0 30) (- 0 32)) (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|))) (=> (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) (and (=> (= (ControlFlow 0 30) (- 0 31)) (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (or (and (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (not (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)))) (and (|Set#Equal| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (and (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)) (not (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)))))))) (=> (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (or (and (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (not (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)))) (and (|Set#Equal| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (and (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)) (not (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|))))))) (=> (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (|_module.__default.union#canCall| _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) (=> (and (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#10@0|) (= (ControlFlow 0 30) 29)) anon8_correct))))))))))
(let ((anon5_correct  (=> (forall ((|i#5| T@U) ) (!  (=> ($IsBox |i#5| _module._default.union$U@@3) (=> (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#5|) (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#5|)))
 :qid |Mapsdfy.172:19|
 :skolemid |628|
 :pattern ( (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#5|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#5|))
)) (=> (and ($IsBox |i#10@0| _module._default.union$U@@3) ($IsAllocBox |i#10@0| _module._default.union$U@@3 $Heap@@1)) (and (=> (= (ControlFlow 0 34) 30) anon24_Then_correct) (=> (= (ControlFlow 0 34) 33) anon24_Else_correct))))))
(let ((anon23_Else_correct  (=> (and (=> (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#9@0|) (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#9@0|)) (= (ControlFlow 0 38) 34)) anon5_correct)))
(let ((anon23_Then_correct  (=> (and ($IsAlloc MapType |m#0@@7| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1) ($IsAlloc MapType |m'#0@@3| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1)) (and (=> (= (ControlFlow 0 35) (- 0 37)) (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|))) (=> (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (or (and (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (not (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)))) (and (|Set#Equal| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (and (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)) (not (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)))))))) (=> (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (or (and (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (not (|Set#Subset| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)))) (and (|Set#Equal| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m#0@@7|)) (and (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|)) (not (|Set#Subset| (|Map#Domain| |m'#0@@3|) (|Map#Domain| |m'#0@@3|))))))) (=> (and (and (or (and (|Map#Equal| |m#0@@7| |m#0@@7|) (|Map#Equal| |m'#0@@3| |m'#0@@3|)) (|_module.__default.union#canCall| _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#9@0|)) (and (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#9@0|) (= (ControlFlow 0 35) 34))) anon5_correct))))))))
(let ((anon22_Then_correct  (=> ($Is MapType (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|) (TMap _module._default.union$U@@3 _module._default.union$V@@3)) (=> (and ($IsBox |i#9@0| _module._default.union$U@@3) ($IsAllocBox |i#9@0| _module._default.union$U@@3 $Heap@@1)) (and (=> (= (ControlFlow 0 39) 35) anon23_Then_correct) (=> (= (ControlFlow 0 39) 38) anon23_Else_correct))))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|i#5@@0| T@U) ) (!  (=> ($IsBox |i#5@@0| _module._default.union$U@@3) (=> (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#5@@0|) (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#5@@0|)))
 :qid |Mapsdfy.172:19|
 :skolemid |624|
 :pattern ( (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#5@@0|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#5@@0|))
))) (=> (forall ((|i#5@@1| T@U) ) (!  (=> ($IsBox |i#5@@1| _module._default.union$U@@3) (=> (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#5@@1|) (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#5@@1|)))
 :qid |Mapsdfy.172:19|
 :skolemid |624|
 :pattern ( (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#5@@1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#5@@1|))
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|i#6@@0| T@U) ) (!  (=> ($IsBox |i#6@@0| _module._default.union$U@@3) (=> (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#6@@0|) (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#6@@0|)))
 :qid |Mapsdfy.173:19|
 :skolemid |625|
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#6@@0|))
 :pattern ( (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#6@@0|))
))) (=> (forall ((|i#6@@1| T@U) ) (!  (=> ($IsBox |i#6@@1| _module._default.union$U@@3) (=> (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#6@@1|) (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#6@@1|)))
 :qid |Mapsdfy.173:19|
 :skolemid |625|
 :pattern ( (|Set#IsMember| (|Map#Domain| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#6@@1|))
 :pattern ( (|Set#IsMember| (|Set#Union| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|)) |i#6@@1|))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|i#7@@0| T@U) ) (!  (=> ($IsBox |i#7@@0| _module._default.union$U@@3) (=> (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#7@@0|) (= (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#7@@0|) (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@7|) |i#7@@0|))))
 :qid |Mapsdfy.174:19|
 :skolemid |626|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@7|) |i#7@@0|))
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#7@@0|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#7@@0|))
))) (=> (forall ((|i#7@@1| T@U) ) (!  (=> ($IsBox |i#7@@1| _module._default.union$U@@3) (=> (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#7@@1|) (= (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#7@@1|) (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@7|) |i#7@@1|))))
 :qid |Mapsdfy.174:19|
 :skolemid |626|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| |m#0@@7|) |i#7@@1|))
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#7@@1|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#7@@1|))
)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|i#8| T@U) ) (!  (=> ($IsBox |i#8| _module._default.union$U@@3) (=> (|Set#IsMember| (|Map#Domain| |m'#0@@3|) |i#8|) (= (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#8|) (MapType0Select BoxType BoxType (|Map#Elements| |m'#0@@3|) |i#8|))))
 :qid |Mapsdfy.175:19|
 :skolemid |627|
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| |m'#0@@3|) |i#8|))
 :pattern ( (MapType0Select BoxType BoxType (|Map#Elements| (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|)) |i#8|))
 :pattern ( (|Set#IsMember| (|Map#Domain| |m'#0@@3|) |i#8|))
)))))))))))
(let ((anon20_correct  (=> (= (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|) (|Map#Glue| (|Set#FromBoogieMap| (|lambda#17| _module._default.union$U@@3 (|Set#Union| (_module.__default.domain _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7|) (_module.__default.domain _module._default.union$U@@3 _module._default.union$V@@3 |m'#0@@3|)))) (|lambda#25| (|Map#Domain| |m#0@@7|) (|Map#Elements| |m#0@@7|) (|Map#Elements| |m'#0@@3|)) (TMap _module._default.union$U@@3 _module._default.union$V@@3))) (=> (and (and (|_module.__default.domain#canCall| _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7|) (|_module.__default.domain#canCall| _module._default.union$U@@3 _module._default.union$V@@3 |m'#0@@3|)) (and ($Is MapType (_module.__default.union _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7| |m'#0@@3|) (TMap _module._default.union$U@@3 _module._default.union$V@@3)) (= (ControlFlow 0 6) 2))) GeneratedUnifiedExit_correct))))
(let ((anon29_Else_correct  (=> (not (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#13@0|)) (and (=> (= (ControlFlow 0 11) (- 0 12)) (|Set#IsMember| (|Map#Domain| |m'#0@@3|) |i#13@0|)) (=> (|Set#IsMember| (|Map#Domain| |m'#0@@3|) |i#13@0|) (=> (= (ControlFlow 0 11) 6) anon20_correct))))))
(let ((anon29_Then_correct  (=> (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#13@0|) (and (=> (= (ControlFlow 0 9) (- 0 10)) (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#13@0|)) (=> (|Set#IsMember| (|Map#Domain| |m#0@@7|) |i#13@0|) (=> (= (ControlFlow 0 9) 6) anon20_correct))))))
(let ((anon28_Then_correct  (=> (|Set#IsMember| (|Set#Union| (_module.__default.domain _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7|) (_module.__default.domain _module._default.union$U@@3 _module._default.union$V@@3 |m'#0@@3|)) |i#13@0|) (and (=> (= (ControlFlow 0 13) 9) anon29_Then_correct) (=> (= (ControlFlow 0 13) 11) anon29_Else_correct)))))
(let ((anon28_Else_correct  (=> (and (not (|Set#IsMember| (|Set#Union| (_module.__default.domain _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7|) (_module.__default.domain _module._default.union$U@@3 _module._default.union$V@@3 |m'#0@@3|)) |i#13@0|)) (= (ControlFlow 0 8) 6)) anon20_correct)))
(let ((anon27_Then_correct  (=> (and ($IsBox |i#13@0| _module._default.union$U@@3) ($IsAllocBox |i#13@0| _module._default.union$U@@3 $Heap@@1)) (=> (and (and ($IsAlloc MapType |m#0@@7| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1) (|_module.__default.domain#canCall| _module._default.union$U@@3 _module._default.union$V@@3 |m#0@@7|)) (and ($IsAlloc MapType |m'#0@@3| (TMap _module._default.union$U@@3 _module._default.union$V@@3) $Heap@@1) (|_module.__default.domain#canCall| _module._default.union$U@@3 _module._default.union$V@@3 |m'#0@@3|))) (and (=> (= (ControlFlow 0 14) 13) anon28_Then_correct) (=> (= (ControlFlow 0 14) 8) anon28_Else_correct))))))
(let ((anon27_Else_correct  (=> (and (not (and ($IsBox |i#13@0| _module._default.union$U@@3) ($IsAllocBox |i#13@0| _module._default.union$U@@3 $Heap@@1))) (= (ControlFlow 0 7) 6)) anon20_correct)))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (|Set#Disjoint| (|Map#Domain| |m#0@@7|) (|Map#Domain| |m'#0@@3|))) (and (and (=> (= (ControlFlow 0 40) 39) anon22_Then_correct) (=> (= (ControlFlow 0 40) 14) anon27_Then_correct)) (=> (= (ControlFlow 0 40) 7) anon27_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and ($Is MapType |m#0@@7| (TMap _module._default.union$U@@3 _module._default.union$V@@3)) ($Is MapType |m'#0@@3| (TMap _module._default.union$U@@3 _module._default.union$V@@3))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 41) 40))) anon0_correct))))
