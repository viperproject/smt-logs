...
(declare-fun |s#0| () T@U)
(declare-fun GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$GenericPick.__default.EquivalentWaysOfSayingSequenceIsNonempty)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |s#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Contains| |s#0| (|Seq#Index| |s#0| (LitInt 0)))) (=> (|Seq#Contains| |s#0| (|Seq#Index| |s#0| (LitInt 0))) (=> (= (ControlFlow 0 2) (- 0 1)) (exists ((|x#1| T@U) ) (!  (and ($IsBox |x#1| GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U) (|Seq#Contains| |s#0| |x#1|))
 :qid |SmallTestsdfy.835:20|
 :skolemid |587|
 :pattern ( (|Seq#Contains| |s#0| |x#1|))
)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |s#0| (TSeq GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U)) ($IsAlloc SeqType |s#0| (TSeq GenericPick._default.EquivalentWaysOfSayingSequenceIsNonempty$U) $Heap)) (= 0 $FunctionContextHeight)) (and (or (or (not (|Seq#Equal| |s#0| |Seq#Empty|)) (or (not (= (|Seq#Length| |s#0|) 0)) (not true))) (exists ((|i#1| Int) ) (!  (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |s#0|)))
