...
(set-info :boogie-vc-id CheckWellFormed$$_module.YetAnotherNewSix)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon6_Then_correct  (=> (= |newtype$check#0@0| (LitInt 80)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 6) |newtype$check#0@0|)) (=> (<= (LitInt 6) |newtype$check#0@0|) (=> (and (= |newtype$check#1@0| (LitInt 80)) (= (ControlFlow 0 3) (- 0 2))) (<= (LitInt 6) |newtype$check#1@0|)))))))
