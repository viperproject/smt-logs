...
(let ((anon14_Then_correct  (=> (and ($IsAlloc realType (real_2_U |b#1@0|) TReal $Heap) (|_module.__default.ItWasReal#canCall| |b#1@0|)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (and ($Is realType (real_2_U (LitReal 0.0)) TReal) (U_2_bool (Lit boolType (bool_2_U (_module.__default.ItWasReal (LitReal 0.0)))))) (exists ((|b#0| Real) ) (! (_module.__default.ItWasReal |b#0|)
 :qid |RuntimeTypeTests2dfy.22:12|
 :skolemid |492|
)))) (=> (or (and ($Is realType (real_2_U (LitReal 0.0)) TReal) (U_2_bool (Lit boolType (bool_2_U (_module.__default.ItWasReal (LitReal 0.0)))))) (exists ((|b#0@@0| Real) ) (! (_module.__default.ItWasReal |b#0@@0|)
 :qid |RuntimeTypeTests2dfy.22:12|
 :skolemid |492|
))) (=> (and (and (_module.__default.ItWasReal |b#1@0|) (|_module.__default.ItWasReal#canCall| |b#2@0|)) (and (_module.__default.ItWasReal |b#2@0|) (= (ControlFlow 0 3) (- 0 2)))) (= |b#1@0| |b#2@0|)))))))
(let ((anon7_correct  (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (and ($Is intType (int_2_U (LitInt (- 30 1))) TInt) (and (and (and (= (LitInt (Mod (- 30 1) (LitInt 5))) (LitInt 0)) (= (LitInt (Mod (- 30 1) (LitInt 7))) (LitInt 0))) (<= (LitInt 0) (LitInt (- 30 1)))) (< (- 30 1) 30))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (and (= (LitInt (Mod 0 (LitInt 5))) (LitInt 0)) (= (LitInt (Mod 0 (LitInt 7))) (LitInt 0))) (<= (LitInt 0) (LitInt 0))) (< 0 30))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (and (= (LitInt (Mod 0 (LitInt 5))) (LitInt 0)) (= (LitInt (Mod 0 (LitInt 7))) (LitInt 0))) (<= (LitInt 0) (LitInt 0))) (< 0 30))) (exists ((|a#0| Int) ) (!  (and (and (and (= (Mod |a#0| (LitInt 5)) (LitInt 0)) (= (Mod |a#0| (LitInt 7)) (LitInt 0))) (<= (LitInt 0) |a#0|)) (< |a#0| 30))
 :qid |RuntimeTypeTests2dfy.20:12|
 :skolemid |491|
)))))) (=> (or (and ($Is intType (int_2_U (LitInt (- 30 1))) TInt) (and (and (and (= (LitInt (Mod (- 30 1) (LitInt 5))) (LitInt 0)) (= (LitInt (Mod (- 30 1) (LitInt 7))) (LitInt 0))) (<= (LitInt 0) (LitInt (- 30 1)))) (< (- 30 1) 30))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (and (= (LitInt (Mod 0 (LitInt 5))) (LitInt 0)) (= (LitInt (Mod 0 (LitInt 7))) (LitInt 0))) (<= (LitInt 0) (LitInt 0))) (< 0 30))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (and (and (= (LitInt (Mod 0 (LitInt 5))) (LitInt 0)) (= (LitInt (Mod 0 (LitInt 7))) (LitInt 0))) (<= (LitInt 0) (LitInt 0))) (< 0 30))) (exists ((|a#0@@0| Int) ) (!  (and (and (and (= (Mod |a#0@@0| (LitInt 5)) (LitInt 0)) (= (Mod |a#0@@0| (LitInt 7)) (LitInt 0))) (<= (LitInt 0) |a#0@@0|)) (< |a#0@@0| 30))
 :qid |RuntimeTypeTests2dfy.20:12|
 :skolemid |491|
))))) (=> (and (and (and (and (= (Mod |a#1@0| (LitInt 5)) (LitInt 0)) (= (Mod |a#1@0| (LitInt 7)) (LitInt 0))) (<= (LitInt 0) |a#1@0|)) (< |a#1@0| 30)) (and (and (and (= (Mod |a#2@0| (LitInt 5)) (LitInt 0)) (= (Mod |a#2@0| (LitInt 7)) (LitInt 0))) (<= (LitInt 0) |a#2@0|)) (< |a#2@0| 30))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (= |a#1@0| |a#2@0|)) (=> (= |a#1@0| |a#2@0|) (=> |$let#0$canCall| (=> (and |$let#0$canCall| (= |x#0@0| (let ((|a#0@@1| |$let#0_a|))
