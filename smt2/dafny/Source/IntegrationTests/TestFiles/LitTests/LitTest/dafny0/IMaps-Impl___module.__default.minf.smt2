...
(declare-fun |lambda#35| (T@U Int) T@U)
...
(assert (forall ((|l#0| T@U) (|l#1| Int) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#35| |l#0| |l#1|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (> (U_2_int ($Unbox intType |$w#0|)) |l#1|)))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |600|
 :pattern ( (MapType0Select BoxType boolType (|lambda#35| |l#0| |l#1|) |$w#0|))
)))
...
(assert (forall ((|l#0@@1| Int) (|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType (|lambda#36| |l#0@@1|) |$w#0@@0|) ($Box intType (int_2_U (Mul |l#0@@1| (U_2_int ($Unbox intType |$w#0@@0|))))))
 :qid |unknown.0:0|
 :skolemid |601|
 :pattern ( (MapType0Select BoxType BoxType (|lambda#36| |l#0@@1|) |$w#0@@0|))
)))
...
(set-info :boogie-vc-id Impl$$_module.__default.minf)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 18) (let ((anon6_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (forall ((|i#3| Int) ) (!  (=> (> |i#3| 200) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0@0|) ($Box intType (int_2_U |i#3|))))) (Mul (LitInt 2) |i#3|)))
 :qid |IMapsdfy.133:17|
 :skolemid |582|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0@0|) ($Box intType (int_2_U |i#3|)))))
)))))
(let ((anon10_Else_correct  (=> (and (>= 200 |i#2@0|) (= (ControlFlow 0 7) 4)) anon6_correct)))
(let ((anon10_Then_correct  (=> (> |i#2@0| 200) (and (=> (= (ControlFlow 0 5) (- 0 6)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U |i#2@0|))))) (=> (= (ControlFlow 0 5) 4) anon6_correct)))))
...
(let ((anon3_correct  (=> (= |m#0@0| (|IMap#Glue| (|lambda#35| TInt 100) (|lambda#36| (LitInt 2)) (TIMap TInt TInt))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U 101))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U 101)))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U 99)))))) (=> (not (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U 99))))) (and (=> (= (ControlFlow 0 9) (- 0 11)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |m#0@0|) ($Box intType (int_2_U (LitInt 101)))))) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0@0|) ($Box intType (int_2_U (LitInt 101)))))) (LitInt 202))) (=> (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |m#0@0|) ($Box intType (int_2_U (LitInt 101)))))) (LitInt 202)) (and (=> (= (ControlFlow 0 9) 8) anon9_Then_correct) (=> (= (ControlFlow 0 9) 2) anon9_Else_correct))))))))))))
(let ((anon8_Else_correct  (=> (and (>= 100 |i#0@0|) (= (ControlFlow 0 15) 9)) anon3_correct)))
(let ((anon8_Then_correct  (=> (and (> |i#0@0| 100) (= (ControlFlow 0 14) 9)) anon3_correct)))
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 16) 14) anon8_Then_correct) (=> (= (ControlFlow 0 16) 15) anon8_Else_correct))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 17) 16) anon7_Then_correct) (=> (= (ControlFlow 0 17) 1) anon7_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is IMapType |m#0| (TIMap TInt TInt)) ($IsAlloc IMapType |m#0| (TIMap TInt TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 18) 17))) anon0_correct))))
