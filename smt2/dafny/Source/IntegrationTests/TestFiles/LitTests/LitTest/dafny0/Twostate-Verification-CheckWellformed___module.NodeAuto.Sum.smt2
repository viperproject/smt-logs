...
(set-info :boogie-vc-id CheckWellformed$$_module.NodeAuto.Sum)
...
(assert (not
 ...
 :qid |TwostateVerificationdfy.206:42|
 :skolemid |1677|
)))) (and (=> (= (ControlFlow 0 6) (- 0 11)) (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.next))) _module.NodeAuto.Repr)))))) (=> (and (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.next))) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.Repr))) (not (|Set#Subset| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.Repr)) ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.next))) _module.NodeAuto.Repr))))) (=> (and (and (|_module.NodeAuto.Sum#canCall| $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.next))) (= (_module.NodeAuto.Sum ($LS $LZ) $Heap@@3 this@@3) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.x))) (_module.NodeAuto.Sum ($LS $LZ) $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.next)))))) (and (|_module.NodeAuto.Sum#canCall| $Heap@@3 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 this@@3) _module.NodeAuto.next))) ($Is intType (int_2_U (_module.NodeAuto.Sum ($LS $LZ) $Heap@@3 this@@3)) TInt))) (and (=> (= (ControlFlow 0 6) (- 0 10)) |b$reqreads#2@0|) (=> |b$reqreads#2@0| (and (=> (= (ControlFlow 0 6) (- 0 9)) true) (and (=> (= (ControlFlow 0 6) (- 0 8)) |b$reqreads#4@0|) (=> |b$reqreads#4@0| (and (=> (= (ControlFlow 0 6) (- 0 7)) |b$reqreads#5@0|) (=> |b$reqreads#5@0| (=> (= (ControlFlow 0 6) (- 0 5)) |b$reqreads#6@0|))))))))))))))))))))))))))
