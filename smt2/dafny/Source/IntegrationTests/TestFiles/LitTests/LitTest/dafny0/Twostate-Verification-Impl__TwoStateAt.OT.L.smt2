...
(assert (distinct TInt TagInt alloc allocName Tagclass._System.nat Tagclass._System.___hFunc3 Tagclass.TwoStateAt.Cell Tagclass.TwoStateAt.Cell? class.TwoStateAt.Cell? tytagFamily$nat |tytagFamily$_#Func3| tytagFamily$Cell field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($bx T@U) (TwoStateAt.OT$X@@0 T@U) (TwoStateAt.OT.F$Y@@0 T@U) ($prevHeap@@0 T@U) ($self@@0 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) (|$fh$0x#1@@0| T@U) (|$fh$0x#2@@0| T@U) ) (! (= (|Set#IsMember| (Reads3 TwoStateAt.OT$X@@0 TwoStateAt.OT.F$Y@@0 Tclass.TwoStateAt.Cell TInt $heap@@0 (|TwoStateAt.OT.F#Handle| TwoStateAt.OT$X@@0 TwoStateAt.OT.F$Y@@0 $prevHeap@@0 $self@@0) |$fh$0x#0@@0| |$fh$0x#1@@0| |$fh$0x#2@@0|) $bx) (= ($Unbox refType $bx) ($Unbox refType |$fh$0x#2@@0|)))
 :qid |unknown.0:0|
 :skolemid |774|
 :pattern ( (|Set#IsMember| (Reads3 TwoStateAt.OT$X@@0 TwoStateAt.OT.F$Y@@0 Tclass.TwoStateAt.Cell TInt $heap@@0 (|TwoStateAt.OT.F#Handle| TwoStateAt.OT$X@@0 TwoStateAt.OT.F$Y@@0 $prevHeap@@0 $self@@0) |$fh$0x#0@@0| |$fh$0x#1@@0| |$fh$0x#2@@0|) $bx))
)))
...
(assert (forall ((TwoStateAt.OT$X@@1 T@U) (TwoStateAt.OT.F$Y@@1 T@U) ($prevHeap@@1 T@U) ($self@@1 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) (|$fh$0x#1@@1| T@U) (|$fh$0x#2@@1| T@U) ) (! (= (Requires3 TwoStateAt.OT$X@@1 TwoStateAt.OT.F$Y@@1 Tclass.TwoStateAt.Cell TInt $heap@@1 (|TwoStateAt.OT.F#Handle| TwoStateAt.OT$X@@1 TwoStateAt.OT.F$Y@@1 $prevHeap@@1 $self@@1) |$fh$0x#0@@1| |$fh$0x#1@@1| |$fh$0x#2@@1|) (|TwoStateAt.OT.F#requires| TwoStateAt.OT$X@@1 TwoStateAt.OT.F$Y@@1 $prevHeap@@1 $heap@@1 $self@@1 |$fh$0x#0@@1| |$fh$0x#1@@1| ($Unbox refType |$fh$0x#2@@1|)))
 :qid |unknown.0:0|
 :skolemid |773|
 :pattern ( (Requires3 TwoStateAt.OT$X@@1 TwoStateAt.OT.F$Y@@1 Tclass.TwoStateAt.Cell TInt $heap@@1 (|TwoStateAt.OT.F#Handle| TwoStateAt.OT$X@@1 TwoStateAt.OT.F$Y@@1 $prevHeap@@1 $self@@1) |$fh$0x#0@@1| |$fh$0x#1@@1| |$fh$0x#2@@1|))
)))
...
(assert (forall ((TwoStateAt.OT$X@@2 T@U) (TwoStateAt.OT.F$Y@@2 T@U) ($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (this T@U) (|x#0@@1| T@U) (|y#0| T@U) (|c#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) ($IsBox this (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@2))) (or (|TwoStateAt.OT.F#canCall| TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h0 this |x#0@@1| |y#0| |c#0@@1|) (and (and ($IsBox |x#0@@1| TwoStateAt.OT$X@@2) ($IsBox |y#0| TwoStateAt.OT.F$Y@@2)) ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |c#0@@1|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))
 :qid |unknown.0:0|
 :skolemid |872|
)) (= (TwoStateAt.OT.F TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h0 this |x#0@@1| |y#0| |c#0@@1|) (TwoStateAt.OT.F TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h1 this |x#0@@1| |y#0| |c#0@@1|))))
 :qid |unknown.0:0|
 :skolemid |873|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (TwoStateAt.OT.F TwoStateAt.OT$X@@2 TwoStateAt.OT.F$Y@@2 $prevHeap@@2 $h1 this |x#0@@1| |y#0| |c#0@@1|))
)))
(assert (forall ((TwoStateAt.OT$X@@3 T@U) (TwoStateAt.OT.F$Y@@3 T@U) ($prevHeap@@3 T@U) ($self@@2 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) (|$fh$0x#1@@2| T@U) (|$fh$0x#2@@2| T@U) ) (! (= (Apply3 TwoStateAt.OT$X@@3 TwoStateAt.OT.F$Y@@3 Tclass.TwoStateAt.Cell TInt $heap@@2 (|TwoStateAt.OT.F#Handle| TwoStateAt.OT$X@@3 TwoStateAt.OT.F$Y@@3 $prevHeap@@3 $self@@2) |$fh$0x#0@@2| |$fh$0x#1@@2| |$fh$0x#2@@2|) ($Box intType (int_2_U (TwoStateAt.OT.F TwoStateAt.OT$X@@3 TwoStateAt.OT.F$Y@@3 $prevHeap@@3 $heap@@2 $self@@2 |$fh$0x#0@@2| |$fh$0x#1@@2| ($Unbox refType |$fh$0x#2@@2|)))))
 :qid |unknown.0:0|
 :skolemid |772|
 :pattern ( (Apply3 TwoStateAt.OT$X@@3 TwoStateAt.OT.F$Y@@3 Tclass.TwoStateAt.Cell TInt $heap@@2 (|TwoStateAt.OT.F#Handle| TwoStateAt.OT$X@@3 TwoStateAt.OT.F$Y@@3 $prevHeap@@3 $self@@2) |$fh$0x#0@@2| |$fh$0x#1@@2| |$fh$0x#2@@2|))
)))
...
(assert (forall ((TwoStateAt.OT$X@@4 T@U) (TwoStateAt.OT.F$Y@@4 T@U) ($prevHeap@@4 T@U) ($Heap T@U) (this@@0 T@U) (|x#0@@2| T@U) (|y#0@@0| T@U) (|c#0@@2| T@U) ) (!  (=> (and (and (and (and (and (and ($IsGoodHeap $prevHeap@@4) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@4 $Heap)) (and ($IsBox this@@0 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@4)) ($IsAllocBox this@@0 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@4) $prevHeap@@4))) ($IsBox |x#0@@2| TwoStateAt.OT$X@@4)) ($IsBox |y#0@@0| TwoStateAt.OT.F$Y@@4)) ($Is refType |c#0@@2| Tclass.TwoStateAt.Cell)) (= (|TwoStateAt.OT.F#requires| TwoStateAt.OT$X@@4 TwoStateAt.OT.F$Y@@4 $prevHeap@@4 $Heap this@@0 |x#0@@2| |y#0@@0| |c#0@@2|)  (and (and ($IsAllocBox |x#0@@2| TwoStateAt.OT$X@@4 $prevHeap@@4) ($IsAllocBox |y#0@@0| TwoStateAt.OT.F$Y@@4 $prevHeap@@4)) ($IsAlloc refType |c#0@@2| Tclass.TwoStateAt.Cell $prevHeap@@4))))
 :qid |unknown.0:0|
 :skolemid |875|
 :pattern ( (|TwoStateAt.OT.F#requires| TwoStateAt.OT$X@@4 TwoStateAt.OT.F$Y@@4 $prevHeap@@4 $Heap this@@0 |x#0@@2| |y#0@@0| |c#0@@2|) ($IsGoodHeap $Heap))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((TwoStateAt.OT$X@@5 T@U) (TwoStateAt.OT.F$Y@@5 T@U) ($prevHeap@@5 T@U) ($Heap@@0 T@U) (this@@1 T@U) (|x#0@@3| T@U) (|y#0@@1| T@U) (|c#0@@3| T@U) ) (!  (=> (or (|TwoStateAt.OT.F#canCall| TwoStateAt.OT$X@@5 TwoStateAt.OT.F$Y@@5 $prevHeap@@5 $Heap@@0 this@@1 |x#0@@3| |y#0@@1| |c#0@@3|) (and (< 1 $FunctionContextHeight) (and (and (and (and (and (and ($IsGoodHeap $prevHeap@@5) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@5 $Heap@@0)) (and ($IsBox this@@1 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@5)) ($IsAllocBox this@@1 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@5) $prevHeap@@5))) ($IsBox |x#0@@3| TwoStateAt.OT$X@@5)) ($IsBox |y#0@@1| TwoStateAt.OT.F$Y@@5)) ($Is refType |c#0@@3| Tclass.TwoStateAt.Cell)))) (= (TwoStateAt.OT.F TwoStateAt.OT$X@@5 TwoStateAt.OT.F$Y@@5 $prevHeap@@5 $Heap@@0 this@@1 |x#0@@3| |y#0@@1| |c#0@@3|) (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@3|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@5 |c#0@@3|) TwoStateAt.Cell.data))))))
 :qid |unknown.0:0|
 :skolemid |876|
 :pattern ( (TwoStateAt.OT.F TwoStateAt.OT$X@@5 TwoStateAt.OT.F$Y@@5 $prevHeap@@5 $Heap@@0 this@@1 |x#0@@3| |y#0@@1| |c#0@@3|) ($IsGoodHeap $Heap@@0))
))))
...
(declare-fun TwoStateAt.OT$X@@6 () T@U)
...
(declare-fun |n#0| () Int)
(set-info :boogie-vc-id Impl$$TwoStateAt.OT.L)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#3| null current$Heap alloc false)) (=> (and (and ($IsAllocBox this@@2 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@6) current$Heap) ($IsAllocBox |x#0@@4| TwoStateAt.OT$X@@6 current$Heap)) (and ($IsAllocBox |y#0@@2| TwoStateAt.OT.L$Y current$Heap) ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell current$Heap))) (and (=> (= (ControlFlow 0 2) (- 0 6)) ($IsAllocBox this@@2 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@6) $Heap@@1)) (=> ($IsAllocBox this@@2 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@6) $Heap@@1) (and (=> (= (ControlFlow 0 2) (- 0 5)) ($IsAllocBox |x#0@@4| TwoStateAt.OT$X@@6 $Heap@@1)) (=> ($IsAllocBox |x#0@@4| TwoStateAt.OT$X@@6 $Heap@@1) (and (=> (= (ControlFlow 0 2) (- 0 4)) ($IsAllocBox |y#0@@2| TwoStateAt.OT.L$Y $Heap@@1)) (=> ($IsAllocBox |y#0@@2| TwoStateAt.OT.L$Y $Heap@@1) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell $Heap@@1)) (=> ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell $Heap@@1) (=> (and (|TwoStateAt.OT.F#canCall| TwoStateAt.OT$X@@6 TwoStateAt.OT.L$Y $Heap@@1 current$Heap this@@2 |x#0@@4| |y#0@@2| |c#0@@4|) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U (TwoStateAt.OT.F TwoStateAt.OT$X@@6 TwoStateAt.OT.L$Y $Heap@@1 current$Heap this@@2 |x#0@@4| |y#0@@2| |c#0@@4|)) Tclass._System.nat))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (and ($IsBox this@@2 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@6)) ($IsAllocBox this@@2 (Tclass.TwoStateAt.OT TwoStateAt.OT$X@@6) previous$Heap))) (=> (and (and (and (and ($IsBox |x#0@@4| TwoStateAt.OT$X@@6) ($IsAllocBox |x#0@@4| TwoStateAt.OT$X@@6 previous$Heap)) (and ($IsBox |y#0@@2| TwoStateAt.OT.L$Y) ($IsAllocBox |y#0@@2| TwoStateAt.OT.L$Y previous$Heap))) (and (and ($Is refType |c#0@@4| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell previous$Heap)) (and (<= (LitInt 0) |n#0|) (= 2 $FunctionContextHeight)))) (and (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) ($IsAllocBox |x#0@@4| TwoStateAt.OT$X@@6 previous$Heap)) (and (and ($IsAllocBox |y#0@@2| TwoStateAt.OT.L$Y previous$Heap) ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell previous$Heap)) (and (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) previous$Heap |c#0@@4|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@4|) TwoStateAt.Cell.data)))) (= (ControlFlow 0 7) 2))))) anon0_correct))))
