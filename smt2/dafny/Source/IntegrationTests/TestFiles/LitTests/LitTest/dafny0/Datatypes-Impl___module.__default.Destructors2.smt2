...
(set-info :boogie-vc-id Impl$$_module.__default.Destructors2)
...
(let ((anon5_Then_correct  (=> (and (= |d#0| (|#_module.XList.XCons| |_mcc#0#0_0@0| |_mcc#1#0_0@0|)) ($Is DatatypeTypeType |_mcc#1#0_0@0| Tclass._module.XList)) (=> (and (and (and (and ($Is DatatypeTypeType |tl#0_0@0| Tclass._module.XList) ($IsAlloc DatatypeTypeType |tl#0_0@0| Tclass._module.XList $Heap)) (= |let#0_0#0#0| |_mcc#1#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| Tclass._module.XList) (= |tl#0_0@0| |let#0_0#0#0|))) (and (and (= |let#0_1#0#0| |_mcc#0#0_0@0|) ($Is intType (int_2_U |let#0_1#0#0|) TInt)) (and (= |hd#0_0@0| |let#0_1#0#0|) (= (ControlFlow 0 4) (- 0 3))))) (_module.XList.XNil_q |d#0|)))))
(let ((anon4_Else_correct  (=> (or (not (= |d#0| |#_module.XList.XNil|)) (not true)) (and (=> (= (ControlFlow 0 6) 4) anon5_Then_correct) (=> (= (ControlFlow 0 6) 5) anon5_Else_correct)))))
(let ((anon4_Then_correct  (=> (and (= |d#0| |#_module.XList.XNil|) (= (ControlFlow 0 2) (- 0 1))) (_module.XList.XCons_q |d#0|))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |d#0| Tclass._module.XList) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.XList $Heap)) (|$IsA#_module.XList| |d#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
