...
(set-info :boogie-vc-id CheckWellFormed$$B__AnonymousClass.XX.Increment)
...
(assert (not
 ...
 :qid |Refinementdfy.53:12|
 :skolemid |1987|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@4))
))) (and ($HeapSucc $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this Tclass.B__AnonymousClass.XX $Heap)))))
