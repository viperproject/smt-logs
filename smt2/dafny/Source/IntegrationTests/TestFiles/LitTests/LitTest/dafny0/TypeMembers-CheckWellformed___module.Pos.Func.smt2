...
(set-info :boogie-vc-id CheckWellformed$$_module.Pos.Func)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (= |newtype$check#0@0| (LitInt 3)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< 0 |newtype$check#0@0|)) (=> (< 0 |newtype$check#0@0|) (=> (and (= |newtype$check#1@0| (+ |y#0@@1| 3)) (= (ControlFlow 0 3) (- 0 2))) (< 0 |newtype$check#1@0|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (< 0 |y#0@@1|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
