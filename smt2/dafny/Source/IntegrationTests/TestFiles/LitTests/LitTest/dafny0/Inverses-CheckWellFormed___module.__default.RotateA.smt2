...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.RotateA)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |Inversesdfy.65:8|
 :skolemid |542|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6))
)) ($HeapSucc $Heap $Heap@0))) (and (and ($Is refType |r#0@0| (Tclass._System.array _module._default.RotateA$T)) ($IsAlloc refType |r#0@0| (Tclass._System.array _module._default.RotateA$T) $Heap@0)) (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |r#0@0|) alloc))))))) (and (=> (= (ControlFlow 0 13) (- 0 15)) (or (not (= |r#0@0| null)) (not true))) (=> (or (not (= |r#0@0| null)) (not true)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (= (_System.array.Length |r#0@0|) (_System.array.Length |a#0|)) (and (and (=> (= (ControlFlow 0 13) 2) anon7_Else_correct) (=> (= (ControlFlow 0 13) 10) anon8_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon8_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array _module._default.RotateA$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.RotateA$T) $Heap))) (and (and ($Is refType |r#0| (Tclass._System.array _module._default.RotateA$T)) ($IsAlloc refType |r#0| (Tclass._System.array _module._default.RotateA$T) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 16) 13)))) anon0_correct)))
