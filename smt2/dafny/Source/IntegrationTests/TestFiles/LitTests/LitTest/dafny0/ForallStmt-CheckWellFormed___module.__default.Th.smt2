...
(assert (forall ((d@@6 T@U) ($h@@1 T@U) ) (!  (=> (and ($IsGoodHeap $h@@1) (and (_module.Nat.Succ_q d@@6) ($IsAlloc DatatypeTypeType d@@6 Tclass._module.Nat $h@@1))) ($IsAlloc DatatypeTypeType (_module.Nat.tail d@@6) Tclass._module.Nat $h@@1))
 :qid |unknown.0:0|
 :skolemid |779|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.Nat.tail d@@6) Tclass._module.Nat $h@@1))
)))
...
(declare-fun |ro#0@0| () Int)
(declare-fun |ss#0@0| () Int)
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Th)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (=> (and (_module.Nat.Succ_q |t#0@@2|) ($IsAlloc intType (int_2_U |step#0@@2|) Tclass._System.nat $Heap)) (=> (and (and (and (and ($IsAlloc DatatypeTypeType |t#0@@2| Tclass._module.Nat $Heap) ($IsAlloc intType (int_2_U |r#0@@2|) Tclass._System.nat $Heap)) (and (|_module.__default.ThProperty#canCall| |step#0@@2| |t#0@@2| |r#0@@2|) (_module.__default.ThProperty ($LS $LZ) |step#0@@2| |t#0@@2| |r#0@@2|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0))) (and (and (and (<= (LitInt 0) |ro#0@0|) (<= (LitInt 0) |ss#0@0|)) (= |ss#0@0| (- |step#0@@2| 1))) (and ($IsAlloc intType (int_2_U |ss#0@0|) Tclass._System.nat $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (_module.Nat.Succ_q |t#0@@2|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |step#0@@2|)) (=> (and (and (and (and ($Is DatatypeTypeType |t#0@@2| Tclass._module.Nat) ($IsAlloc DatatypeTypeType |t#0@@2| Tclass._module.Nat $Heap)) (|$IsA#_module.Nat| |t#0@@2|)) (<= (LitInt 0) |r#0@@2|)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
