...
(assert (distinct TInt TagInt alloc Tagclass._System.nat Tagclass._System.array? Tagclass._System.array Tagclass._System.___hFunc1 tytagFamily$nat tytagFamily$array |tytagFamily$_#Func1|)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id Impl$$_module.__default.SubtypeConstraint)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= 0 (LitInt 100))) (=> (<= 0 (LitInt 100)) (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? Tclass._System.nat))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (LitInt 100)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 100))) (Requires1 TInt Tclass._System.nat $Heap |g#0| ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |ArrayElementInitdfy.101:12|
 :skolemid |784|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (LitInt 100))) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)))) (U_2_int ($Unbox intType (Apply1 TInt Tclass._System.nat $Heap |g#0| ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))))
 :qid |ArrayElementInitdfy.101:12|
 :skolemid |785|
...
)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= 0 (LitInt 100))) (=> (<= 0 (LitInt 100)) (=> (and (and (or (not (= $nw@1 null)) (not true)) ($Is refType $nw@1 (Tclass._System.array? Tclass._System.nat))) (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@1) alloc)))) (= (_System.array.Length $nw@1) (LitInt 100)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall ((|arrayinit#1#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0|) (< |arrayinit#1#i0#0| (LitInt 100))) (Requires1 TInt TInt $Heap@0 |f#0| ($Box intType (int_2_U |arrayinit#1#i0#0|))))
 :qid |ArrayElementInitdfy.102:12|
 :skolemid |786|
))) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|arrayinit#1#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#1#i0#0@@0|) (< |arrayinit#1#i0#0@@0| (LitInt 100))) ($Is intType ($Unbox intType (Apply1 TInt TInt $Heap@0 |f#0| ($Box intType (int_2_U |arrayinit#1#i0#0@@0|)))) Tclass._System.nat))
 :qid |ArrayElementInitdfy.102:12|
 :skolemid |787|
)))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 TInt TInt) $Heap)) (and ($Is HandleTypeType |g#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat) $Heap))) (and (and ($Is refType |a#0| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |a#0| (Tclass._System.array Tclass._System.nat) $Heap)) true)) (=> (and (and (and (and ($Is refType |b#0| (Tclass._System.array Tclass._System.nat)) ($IsAlloc refType |b#0| (Tclass._System.array Tclass._System.nat) $Heap)) true) (= 0 $FunctionContextHeight)) (and (forall ((|x#1| T@U) ) (!  (and (=> (and (<= (LitInt 0) (U_2_int |x#1|)) (< (U_2_int |x#1|) 100)) (Requires1 TInt TInt $Heap |f#0| ($Box intType |x#1|))) (=> (and (<= (LitInt 0) (U_2_int |x#1|)) (< (U_2_int |x#1|) 100)) (Requires1 TInt Tclass._System.nat $Heap |g#0| ($Box intType |x#1|))))
 :qid |ArrayElementInitdfy.99:19|
 :skolemid |782|
 :pattern ( (Requires1 TInt Tclass._System.nat $Heap |g#0| ($Box intType |x#1|)))
 :pattern ( (Requires1 TInt TInt $Heap |f#0| ($Box intType |x#1|)))
