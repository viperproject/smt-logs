...
(set-info :boogie-vc-id Impl$$_module.__default.Testing3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon4_correct true))
(let ((anon10_Else_correct  (=> (and (< |i#0@1| (LitInt 0)) (= (ControlFlow 0 14) 12)) anon4_correct)))
(let ((anon10_Then_correct  (=> (and (<= (LitInt 0) |i#0@1|) (= (ControlFlow 0 13) 12)) anon4_correct)))
(let ((anon9_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 15) 13) anon10_Then_correct) (=> (= (ControlFlow 0 15) 14) anon10_Else_correct)))))
(let ((anon11_Else_correct  (=> (and (< |i#0@1| 10) (= |$decr$loop#00@1| (- 10 |i#0@1|))) (and (=> (= (ControlFlow 0 4) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 4) (- 0 9)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 4) (- 0 8)) (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |a#0| (IndexField (LitInt 0))))) (=> (U_2_bool (MapType1Select refType FieldType boolType |$Frame$loop#0@0| |a#0| (IndexField (LitInt 0)))) (=> (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (LitInt 0)) ($Box intType (int_2_U |i#0@1|))))) (=> (and ($IsGoodHeap $Heap@1) (= |i#0@2| (+ |i#0@1| 1))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (- 10 |i#0@2|) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (< (- 10 |i#0@2|) |$decr$loop#00@1|)) (=> (< (- 10 |i#0@2|) |$decr$loop#00@1|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@2|)) (=> (= (ControlFlow 0 4) (- 0 3)) (=> |$w$loop#0@0| (<= |i#0@2| (LitInt 10)))))))))))))))))))))
(let ((anon11_Then_correct true))
(let ((anon9_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 11) 2) anon11_Then_correct) (=> (= (ControlFlow 0 11) 4) anon11_Else_correct)))))
(let ((anon8_LoopBody_correct  (and (=> (= (ControlFlow 0 16) 15) anon9_Then_correct) (=> (= (ControlFlow 0 16) 11) anon9_Else_correct))))
(let ((anon8_LoopDone_correct true))
(let ((anon8_LoopHead_correct  (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (and (and (not false) (and (<= 0 |i#0@1|) (< |i#0@1| 11))) (= |$decr_init$loop#00@0| 10)) (and (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@1|)) (=> |$w$loop#0@0| (<= |i#0@1| (LitInt 10))))) (and (and (forall (($o@@6 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@6) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@6)))
 :qid |LoopModifiesdfy.44:4|
 :skolemid |496|
...
)) (<= (- 10 |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 17) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 17) 16) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |i#0@0| (LitInt 0))) (and (= |$Frame$loop#0@0| (|lambda#0| null $Heap alloc false)) (= |$decr_init$loop#00@0| (- 10 |i#0@0|)))) (and (=> (= (ControlFlow 0 18) (- 0 20)) (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|))) (=> (=> |$w$loop#0@0| (<= (LitInt 0) |i#0@0|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10)))) (=> (=> |$w$loop#0@0| (<= |i#0@0| (LitInt 10))) (=> (= (ControlFlow 0 18) 17) anon8_LoopHead_correct))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (> (_System.array.Length |a#0|) 0) (= (ControlFlow 0 21) 18))) anon0_correct))))
