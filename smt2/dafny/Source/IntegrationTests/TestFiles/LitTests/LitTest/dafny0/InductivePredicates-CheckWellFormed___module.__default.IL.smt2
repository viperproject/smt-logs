...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.IL)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |x#0@@11| Tclass._module.natinf) ($IsAlloc DatatypeTypeType |x#0@@11| Tclass._module.natinf $Heap)) (|$IsA#_module.natinf| |x#0@@11|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
