...
(declare-fun _module._default.RotateB$T () T@U)
...
(declare-fun $LZ () T@U)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.RotateB)
...
(let ((anon18_Else_correct  (=> (and (not (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|)))) (= (ControlFlow 0 29) 24)) anon6_correct)))
(let ((anon18_Then_correct  (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 25) (- 0 28)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 25) (- 0 27)) (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |i#0@0|) (< |i#0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 25) (- 0 26)) (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| |a#0| (IndexField |i#0@0|)))) (=> (U_2_bool (MapType0Select refType FieldType boolType |$_Frame#l0@0| |a#0| (IndexField |i#0@0|))) (=> (= |lambdaResult#0| (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |a#0|) (IndexField |i#0@0|))) (=> (and ($IsBox |lambdaResult#0| _module._default.RotateB$T) (= (ControlFlow 0 25) 24)) anon6_correct)))))))))))
(let ((anon17_Else_correct  (=> (< |i#0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 32) 25) anon18_Then_correct) (=> (= (ControlFlow 0 32) 29) anon18_Else_correct)))))
(let ((anon17_Then_correct  (=> (<= (LitInt 0) |i#0@0|) (and (=> (= (ControlFlow 0 30) (- 0 31)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 30) 25) anon18_Then_correct) (=> (= (ControlFlow 0 30) 29) anon18_Else_correct)))))))
(let ((anon16_Then_correct  (=> (= |$_Frame#l0@0| (|lambda#7| null |$lambdaHeap#0@0| alloc |a#0|)) (and (=> (= (ControlFlow 0 33) 30) anon17_Then_correct) (=> (= (ControlFlow 0 33) 32) anon17_Else_correct)))))
(let ((anon16_Else_correct true))
(let ((anon15_Then_correct  (=> (and ($IsGoodHeap |$lambdaHeap#0@0|) (or (= $Heap |$lambdaHeap#0@0|) ($HeapSucc $Heap |$lambdaHeap#0@0|))) (and (=> (= (ControlFlow 0 34) 33) anon16_Then_correct) (=> (= (ControlFlow 0 34) 23) anon16_Else_correct)))))
(let ((anon13_correct  (and (=> (= (ControlFlow 0 7) (- 0 11)) (and (<= 0 (ite (= (+ |i#0_0@0| 1) (_System.array.Length |a#0|)) 0 (+ |i#0_0@0| 1))) (< (ite (= (+ |i#0_0@0| 1) (_System.array.Length |a#0|)) 0 (+ |i#0_0@0| 1)) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (ite (= (+ |i#0_0@0| 1) (_System.array.Length |a#0|)) 0 (+ |i#0_0@0| 1)))))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (ite (= (+ |i#0_0@0| 1) (_System.array.Length |a#0|)) 0 (+ |i#0_0@0| 1))))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and ($IsAlloc intType (int_2_U |i#0_0@0|) TInt $Heap@0) (|_module.__default.Id#canCall| |i#0_0@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 (_module.__default.Id |i#0_0@0|)) (< (_module.__default.Id |i#0_0@0|) (_System.array.Length |a#0|)))) (=> (|_module.__default.Id#canCall| |i#0_0@0|) (=> (and (and (<= (LitInt 0) |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 7) (- 0 6)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (ite (= (+ |i#0_0@0| 1) (_System.array.Length |a#0|)) 0 (+ |i#0_0@0| 1))) (IndexField (ite (= (+ |i#0_1@0| 1) (_System.array.Length |a#0|)) 0 (+ |i#0_1@0| 1))))) (not true))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_0@0|))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_1@0|))))))))))))))))
(let ((anon21_Else_correct  (=> (and (or (not (= (+ |i#0_0@0| 1) (_System.array.Length |a#0|))) (not true)) (= (ControlFlow 0 13) 7)) anon13_correct)))
(let ((anon21_Then_correct  (=> (and (= (+ |i#0_0@0| 1) (_System.array.Length |a#0|)) (= (ControlFlow 0 12) 7)) anon13_correct)))
(let ((anon10_correct  (=> (and (<= (LitInt 0) |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 14) (- 0 16)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (not (= |a#0| null)) (not true))) (and (=> (= (ControlFlow 0 14) 12) anon21_Then_correct) (=> (= (ControlFlow 0 14) 13) anon21_Else_correct))))))))
(let ((anon20_Else_correct  (=> (and (< |i#0_0@0| (LitInt 0)) (= (ControlFlow 0 19) 14)) anon10_correct)))
(let ((anon20_Then_correct  (=> (<= (LitInt 0) |i#0_0@0|) (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (not (= |a#0| null)) (not true))) (=> (= (ControlFlow 0 17) 14) anon10_correct)))))
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 20) 17) anon20_Then_correct) (=> (= (ControlFlow 0 20) 19) anon20_Else_correct))))
(let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |r#0@0|) alloc)))))) (=> (and (or (not (= |r#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap |r#0@0|) alloc))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (_System.array.Length |r#0@0|) (_System.array.Length |a#0|))) (=> (= (_System.array.Length |r#0@0|) (_System.array.Length |a#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (forall ((|k#1| Int) ) (!  (=> (and (<= (LitInt 0) |k#1|) (< |k#1| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |r#0@0|) (IndexField (Mod (+ |k#1| 1) (_System.array.Length |a#0|)))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#1|))))
 :qid |Inversesdfy.79:18|
 :skolemid |557|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |k#1|)))
)))))))))
(let ((anon19_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and ($HeapSucc $Heap@0 $Heap@1) (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (or (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@9) $f@@1) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@9) $f@@1)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= (LitInt 0) |i#0_2|) (< |i#0_2| (_System.array.Length |a#0|))) (= $o@@9 $nw@0)) (= $f@@1 (IndexField (ite (= (+ |i#0_2| 1) (_System.array.Length |a#0|)) 0 (+ |i#0_2| 1)))))
 :qid |Inversesdfy.82:10|
 :skolemid |561|
)))
 :qid |Inversesdfy.82:3|
 :skolemid |562|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@9) $f@@1))
)))) (and (and (forall ((|i#0_2@@0| Int) ) (!  (=> (and (<= (LitInt 0) |i#0_2@@0|) (< |i#0_2@@0| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField (ite (= (+ |i#0_2@@0| 1) (_System.array.Length |a#0|)) 0 (+ |i#0_2@@0| 1)))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_2@@0|)))))
 :qid |Inversesdfy.82:10|
 :skolemid |563|
)) (= $Heap@2 $Heap@1)) (and (= |r#0@0| $nw@0) (= (ControlFlow 0 5) 2)))) GeneratedUnifiedExit_correct)))
(let ((anon15_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.RotateB$T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (_System.array.Length |a#0|))) (Requires1 TInt _module._default.RotateB$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Inversesdfy.81:8|
 :skolemid |559|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 TInt _module._default.RotateB$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |Inversesdfy.81:8|
 :skolemid |560|
...
)) (= $Heap@0 (MapType1Store refType (MapType1Type FieldType BoxType) $Heap $nw@0 (MapType1Store FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 21) 20) anon19_Then_correct) (=> (= (ControlFlow 0 21) 5) anon19_Else_correct)))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 35) (- 0 37)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 35) (- 0 36)) (<= 0 (_System.array.Length |a#0|))) (=> (<= 0 (_System.array.Length |a#0|)) (and (=> (= (ControlFlow 0 35) 34) anon15_Then_correct) (=> (= (ControlFlow 0 35) 21) anon15_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array _module._default.RotateB$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.RotateB$T) $Heap))) (and (and ($Is refType |r#0| (Tclass._System.array _module._default.RotateB$T)) ($IsAlloc refType |r#0| (Tclass._System.array _module._default.RotateB$T) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 38) 35)))) anon0_correct)))
