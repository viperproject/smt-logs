...
(declare-fun _module.__default.ok2 (T@U T@U) T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.__default.ok2#canCall| (T@U T@U) Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|c#0@@1| T@U) ) (!  (=> (or (|_module.__default.ok2#canCall| $Heap@@0 |c#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and ($Is refType |c#0@@1| Tclass._module.C?) ($IsAlloc refType |c#0@@1| Tclass._module.C? $Heap@@0))) (and (or (not (= |c#0@@1| null)) (not true)) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1|) _module.C.u))) 0))))) ($Is DatatypeTypeType (_module.__default.ok2 $Heap@@0 |c#0@@1|) Tclass._System.Tuple0))
 :qid |Readsdfy.22:16|
 :skolemid |546|
 :pattern ( (_module.__default.ok2 $Heap@@0 |c#0@@1|))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.ok2)
