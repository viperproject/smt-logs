...
(set-info :boogie-vc-id Impl$$_module.__default.MultisetCardinalityB_k)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MultiSetType |s#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |s#0| (TMultiSet TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (= (|MultiSet#Card| |s#0|) (LitInt 0)) (= (ControlFlow 0 16) 15))) anon0_correct))))
