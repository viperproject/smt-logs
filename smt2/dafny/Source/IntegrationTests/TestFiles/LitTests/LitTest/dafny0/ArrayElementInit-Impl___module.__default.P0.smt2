...
(set-info :boogie-vc-id Impl$$_module.__default.P0)
...
(let ((anon5_Else_correct  (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array3? TChar))) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array3.Length0 $nw@0) (LitInt 25))) (and (= (_System.array3.Length1 $nw@0) (LitInt 10)) (= (_System.array3.Length2 $nw@0) (LitInt 100)))) (and (=> (= (ControlFlow 0 2) (- 0 13)) (forall ((|arrayinit#0#i0#0| Int) (|arrayinit#0#i1#0| Int) (|arrayinit#0#i2#0| Int) ) (!  (=> (and (and (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (LitInt 25))) (and (<= 0 |arrayinit#0#i1#0|) (< |arrayinit#0#i1#0| (LitInt 10)))) (and (<= 0 |arrayinit#0#i2#0|) (< |arrayinit#0#i2#0| (LitInt 100)))) (Requires3 Tclass._System.nat TInt TInt TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle3 (|lambda#31| ($Box charType |d#0|)) (|lambda#32| Tclass._System.nat TInt TInt) (|lambda#34| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|)) ($Box intType (int_2_U |arrayinit#0#i1#0|)) ($Box intType (int_2_U |arrayinit#0#i2#0|))))
 :qid |ArrayElementInitdfy.46:12|
 :skolemid |744|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) (|arrayinit#0#i1#0@@0| Int) (|arrayinit#0#i2#0@@0| Int) ) (!  (=> (and (and (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (LitInt 25))) (and (<= 0 |arrayinit#0#i1#0@@0|) (< |arrayinit#0#i1#0@@0| (LitInt 10)))) (and (<= 0 |arrayinit#0#i2#0@@0|) (< |arrayinit#0#i2#0@@0| (LitInt 100)))) (= ($Unbox charType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (MultiIndexField (MultiIndexField (IndexField |arrayinit#0#i0#0@@0|) |arrayinit#0#i1#0@@0|) |arrayinit#0#i2#0@@0|))) ($Unbox charType (Apply3 Tclass._System.nat TInt TInt TChar $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#5| (Handle3 (|lambda#31| ($Box charType |d#0|)) (|lambda#32| Tclass._System.nat TInt TInt) (|lambda#34| (SetRef_to_SetBox (|lambda#3| false))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)) ($Box intType (int_2_U |arrayinit#0#i1#0@@0|)) ($Box intType (int_2_U |arrayinit#0#i2#0@@0|))))))
 :qid |ArrayElementInitdfy.46:12|
 :skolemid |745|
