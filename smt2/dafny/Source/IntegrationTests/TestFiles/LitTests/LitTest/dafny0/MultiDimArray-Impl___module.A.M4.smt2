...
(assert (distinct TBool TInt TagBool TagInt alloc Tagclass._System.array2? Tagclass._System.array2 Tagclass._module.A? Tagclass._module.A tytagFamily$array2 tytagFamily$A)
)
...
(assert (forall (($o@@1 T@U) ) (! (= ($Is refType $o@@1 Tclass._module.A?)  (or (= $o@@1 null) (= (dtype $o@@1) Tclass._module.A?)))
 :qid |unknown.0:0|
 :skolemid |2774|
 :pattern ( ($Is refType $o@@1 Tclass._module.A?))
)))
...
(assert (forall (($o@@3 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@3 Tclass._module.A? $h@@2)  (or (= $o@@3 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) alloc)))))
 :qid |unknown.0:0|
 :skolemid |2775|
 :pattern ( ($IsAlloc refType $o@@3 Tclass._module.A? $h@@2))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o@@7 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#6| |l#0| |l#1| |l#2| |l#3|) $o@@7 $f))  (=> (and (or (not (= $o@@7 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@7) |l#2|)))) |l#3|))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2810|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#6| |l#0| |l#1| |l#2| |l#3|) $o@@7 $f))
)))
...
(set-info :boogie-vc-id Impl$$_module.A.M4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and (= |k#0@0| (+ (_System.array2.Length0 |a#0|) (_System.array2.Length1 |a#0|))) (= (ControlFlow 0 2) (- 0 1))) (<= (LitInt 0) |k#0@0|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.A) ($IsAlloc refType this Tclass._module.A $Heap)))) (and (and ($Is refType |a#0| (Tclass._System.array2 TBool)) ($IsAlloc refType |a#0| (Tclass._System.array2 TBool) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))
