...
(set-info :boogie-vc-id Impl$$_module.__default.compute__cinterp3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (_module.__default.cinterp ($LS ($LS $LZ)) |env#0@@3| (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Var| (LitInt 0))) (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Var| (LitInt 1))) (Lit DatatypeTypeType (|#_module.exp.Var| (LitInt 0)))))))) (LitInt 20)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |env#0@@3| (TMap TInt TInt)) ($IsAlloc MapType |env#0@@3| (TMap TInt TInt) $Heap)) (= 2 $FunctionContextHeight)) (and (and (|Set#IsMember| (|Map#Domain| |env#0@@3|) ($Box intType (int_2_U 0))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |env#0@@3|) ($Box intType (int_2_U (LitInt 0)))))) (LitInt 10))) (and (not (|Set#IsMember| (|Map#Domain| |env#0@@3|) ($Box intType (int_2_U 1)))) (= (ControlFlow 0 3) 2)))) anon0_correct))))
