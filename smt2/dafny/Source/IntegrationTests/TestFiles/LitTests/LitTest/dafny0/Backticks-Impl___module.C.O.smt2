...
(assert (distinct TInt TagInt alloc allocName class._module.C? Tagclass._module.C? Tagclass._module.C tytagFamily$C field$x)
)
(assert (= (FDim alloc) 0))
...
(set-info :boogie-vc-id Impl$$_module.C.O)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc this)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (and (or (not (= $o@@4 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@4) alloc)))) (and (= $o@@4 this) (= $f@@0 _module.C.x))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@4 $f@@0)))
 :qid |Backticksdfy.69:6|
 :skolemid |554|
))) (=> (forall (($o@@5 T@U) ($f@@1 T@U) ) (!  (=> (and (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@5) alloc)))) (and (= $o@@5 this) (= $f@@1 _module.C.x))) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $o@@5 $f@@1)))
 :qid |Backticksdfy.69:6|
 :skolemid |554|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0 |n#0|) (= |n#0| |n#0|))) (=> (or (<= 0 |n#0|) (= |n#0| |n#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (<= |n#0| |n#0|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.C) ($IsAlloc refType this Tclass._module.C $Heap))) (<= (LitInt 0) |n#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct))))
