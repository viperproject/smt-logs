...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 32) (let ((anon14_correct  (and (=> (= (ControlFlow 0 10) (- 0 12)) (forall ((|z#3| T@U) )  (=> ($Is refType |z#3| Tclass._System.object?) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@0) _module.NewRemainsFresh.__new)) ($Box refType |z#3|)) (and (or (not (= |z#3| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |z#3|) alloc))))))))) (=> (forall ((|z#3@@0| T@U) )  (=> ($Is refType |z#3@@0| Tclass._System.object?) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@0) _module.NewRemainsFresh.__new)) ($Box refType |z#3@@0|)) (and (or (not (= |z#3@@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |z#3@@0|) alloc)))))))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (> |_yieldCount#0@1| |_yieldCount#0@0|)) (=> (> |_yieldCount#0@1| |_yieldCount#0@0|) (=> (= (ControlFlow 0 10) (- 0 9)) (and (forall (($o@@21 T@U) ) (!  (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 this@@0) _module.NewRemainsFresh.__new)) ($Box refType $o@@21)) (or (not (= $o@@21 null)) (not true)))
...
(let ((anon9_correct  (and (=> (= (ControlFlow 0 18) (- 0 19)) (forall ((|z#1| T@U) )  (=> ($Is refType |z#1| Tclass._System.object?) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.NewRemainsFresh.__new)) ($Box refType |z#1|)) (and (or (not (= |z#1| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |z#1|) alloc))))))))) (=> (forall ((|z#1@@0| T@U) )  (=> ($Is refType |z#1@@0| Tclass._System.object?) (=> (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 this@@0) _module.NewRemainsFresh.__new)) ($Box refType |z#1@@0|)) (and (or (not (= |z#1@@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |z#1@@0|) alloc)))))))) (=> (= (ControlFlow 0 18) 17) anon11_correct)))))
