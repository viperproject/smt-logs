...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let (($generated@@95  (=> (and (= $generated@@88 ($generated@@55 $generated@@89 $generated@@90 $generated@@5 false)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= $generated@@91 0)) (not true)))))
