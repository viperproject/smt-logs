...
(set-info :boogie-vc-id Impl$$_module.__default.compute__interp2)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (= (_module.__default.interp ($LS ($LS $LZ)) |env#0@@3| (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Plus| (Lit DatatypeTypeType (|#_module.exp.Var| (LitInt 0))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 1))))) (Lit DatatypeTypeType (|#_module.exp.Num| (LitInt 0)))))) (LitInt 11)))))
