...
procedure {:verboseName "TerminationRefinement0.M (well-formedness)"} CheckWellFormed$$TerminationRefinement0.__default.M(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TerminationRefinement0.M (call)"} Call$$TerminationRefinement0.__default.M(x#0: int);
  modifies $Heap;
...
procedure {:verboseName "TerminationRefinement0.M (correctness)"} Impl$$TerminationRefinement0.__default.M(x#0: int) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TerminationRefinement0.M (correctness)"} Impl$$TerminationRefinement0.__default.M(x#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x##0: int;

    // AddMethodImpl: M, Impl$$TerminationRefinement0.__default.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Termination.dfy(441,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := x#0;
    call {:id "id34"} Call$$TerminationRefinement0.__default.M(x##0);
