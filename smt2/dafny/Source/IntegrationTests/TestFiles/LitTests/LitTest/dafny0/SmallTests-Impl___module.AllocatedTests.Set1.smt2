...
(set-info :boogie-vc-id Impl$$_module.AllocatedTests.Set1)
...
(let ((anon10_Then_correct  (=> (and (= |n#0@0| null) (= (ControlFlow 0 6) (- 0 5))) (and (forall (($o@@4 T@U) ) (!  (=> (|Set#IsMember| |U#0@0| ($Box refType $o@@4)) (or (not (= $o@@4 null)) (not true)))
 :qid |SmallTestsdfy.225:31|
 :skolemid |3432|
...
(let ((anon9_Then_correct  (=> (and (= |n#0@0| null) (= (ControlFlow 0 4) (- 0 3))) ($IsAllocBox ($Box SetType |U#0@0|) (TSet Tclass._module.Node?) $Heap))))
(let ((anon8_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) ($IsAllocBox ($Box SetType |U#0@0|) (TSet Tclass._module.Node?) $Heap))))
