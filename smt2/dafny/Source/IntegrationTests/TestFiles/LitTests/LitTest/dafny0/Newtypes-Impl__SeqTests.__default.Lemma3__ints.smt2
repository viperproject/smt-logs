...
(set-info :boogie-vc-id Impl$$SeqTests.__default.Lemma3__ints)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is SeqType |data#0| (TSeq TInt)) ($IsAlloc SeqType |data#0| (TSeq TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (> (|Seq#Length| |data#0|) 25) (= (ControlFlow 0 3) 2))) anon0_correct))))
