...
(assert (forall ((_module.List$T@@4 T@U) (d@@4 T@U) ) (!  (=> ($Is DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@4)) (or (_module.List.Nil_q d@@4) (_module.List.Cons_q d@@4)))
 :qid |unknown.0:0|
 :skolemid |653|
 :pattern ( (_module.List.Cons_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@4)))
 :pattern ( (_module.List.Nil_q d@@4) ($Is DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@4)))
)))
(assert (forall ((d@@5 T@U) ($h@@4 T@U) ) (!  (=> (and ($IsGoodHeap $h@@4) (and (_module.List.Cons_q d@@5) (exists ((_module.List$T@@5 T@U) ) (! ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.List _module.List$T@@5) $h@@4)
 :qid |unknown.0:0|
 :skolemid |642|
 :pattern ( ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.List _module.List$T@@5) $h@@4))
)))) ($IsAlloc intType (int_2_U (_module.List._h2 d@@5)) Tclass._System.nat $h@@4))
 :qid |unknown.0:0|
 :skolemid |643|
 :pattern ( ($IsAlloc intType (int_2_U (_module.List._h2 d@@5)) Tclass._System.nat $h@@4))
)))
...
(assert (forall ((d@@6 T@U) (_module.List$T@@7 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_module.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 (Tclass._module.List _module.List$T@@7) $h@@5))) ($IsAllocBox (_module.List._h3 d@@6) _module.List$T@@7 $h@@5))
 :qid |unknown.0:0|
 :skolemid |644|
 :pattern ( ($IsAllocBox (_module.List._h3 d@@6) _module.List$T@@7 $h@@5))
)))
...
(assert (forall ((_module.List$T@@8 T@U) (bx@@3 T@U) ) (!  (=> ($IsBox bx@@3 (Tclass._module.List _module.List$T@@8)) (and (= ($Box DatatypeTypeType ($Unbox DatatypeTypeType bx@@3)) bx@@3) ($Is DatatypeTypeType ($Unbox DatatypeTypeType bx@@3) (Tclass._module.List _module.List$T@@8))))
 :qid |unknown.0:0|
 :skolemid |556|
 :pattern ( ($IsBox bx@@3 (Tclass._module.List _module.List$T@@8)))
)))
(assert (forall ((d@@8 T@U) (_module.List$T@@9 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_module.List.Cons_q d@@8) ($IsAlloc DatatypeTypeType d@@8 (Tclass._module.List _module.List$T@@9) $h@@6))) ($IsAlloc DatatypeTypeType (_module.List._h4 d@@8) (Tclass._module.List _module.List$T@@9) $h@@6))
 :qid |unknown.0:0|
 :skolemid |645|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h4 d@@8) (Tclass._module.List _module.List$T@@9) $h@@6))
)))
...
(declare-fun |call2formal@k#0@0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun |k#0| () Int)
(declare-fun |w#0_0| () Int)
(declare-fun |m#0| () Int)
(set-info :boogie-vc-id Impl$$_module.__default.MatchIt)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 12) (let ((anon4_correct  (=> ($IsAlloc DatatypeTypeType |list#0@@3| (Tclass._module.List Tclass._System.object) $Heap@1) (=> (and (and (|_module.__default.Sum#canCall| |list#0@@3|) (|_module.__default.Sum#canCall| |list#0@@3|)) (and (= |m#0@0| (_module.__default.Sum ($LS $LZ) |list#0@@3|)) (= (ControlFlow 0 3) (- 0 2)))) (<= (LitInt 0) |m#0@0|)))))
(let ((anon6_Then_correct  (=> (and (= |list#0@@3| (|#_module.List.Cons| |_mcc#0#0_0@0| ($Box refType |_mcc#1#0_0@0|) |_mcc#2#0_0@0|)) (<= (LitInt 0) |_mcc#0#0_0@0|)) (=> (and (and ($Is refType |_mcc#1#0_0@0| Tclass._System.object) ($IsAlloc refType |_mcc#1#0_0@0| Tclass._System.object $Heap)) (and ($Is DatatypeTypeType |_mcc#2#0_0@0| (Tclass._module.List Tclass._System.object)) ($IsAlloc DatatypeTypeType |_mcc#2#0_0@0| (Tclass._module.List Tclass._System.object) $Heap))) (=> (and (and (and ($Is DatatypeTypeType |tail#0_0@0| (Tclass._module.List Tclass._System.object)) ($IsAlloc DatatypeTypeType |tail#0_0@0| (Tclass._module.List Tclass._System.object) $Heap)) (= |let#0_0#0#0| |_mcc#2#0_0@0|)) (and ($Is DatatypeTypeType |let#0_0#0#0| (Tclass._module.List Tclass._System.object)) (= |tail#0_0@0| |let#0_0#0#0|))) (=> (and (and (and (and ($Is refType |extra#0_0@0| Tclass._System.object) ($IsAlloc refType |extra#0_0@0| Tclass._System.object $Heap)) (= |let#0_1#0#0| |_mcc#1#0_0@0|)) (and ($Is refType |let#0_1#0#0| Tclass._System.object) (= |extra#0_0@0| |let#0_1#0#0|))) (and (and (<= (LitInt 0) |n#0_0@0|) (= |let#0_2#0#0| |_mcc#0#0_0@0|)) (and ($Is intType (int_2_U |let#0_2#0#0|) Tclass._System.nat) (= |n#0_0@0| |let#0_2#0#0|)))) (and (=> (= (ControlFlow 0 5) (- 0 9)) (< (DtRank |tail#0_0@0|) (DtRank |list#0@@3|))) (=> (< (DtRank |tail#0_0@0|) (DtRank |list#0@@3|)) (=> (<= (LitInt 0) |call2formal@k#0|) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (<= (LitInt 0) |call2formal@k#0@0|)) (and (forall (($o@@2 T@U) ) (!  (=> (and (or (not (= $o@@2 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@2)))
 :qid |NatTypesdfy.97:8|
 :skolemid |558|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@2))
)) ($HeapSucc $Heap $Heap@0))) (and (=> (= (ControlFlow 0 5) (- 0 8)) (<= (LitInt 0) |call2formal@k#0@0|)) (=> (<= (LitInt 0) |call2formal@k#0@0|) (and (=> (= (ControlFlow 0 5) (- 0 7)) (<= (LitInt 0) |n#0_0@0|)) (=> (<= (LitInt 0) |n#0_0@0|) (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= (LitInt 0) (- |n#0_0@0| 10))) (=> (<= (LitInt 0) (- |n#0_0@0| 10)) (=> (and (= $Heap@1 $Heap@0) (= (ControlFlow 0 5) 3)) anon4_correct)))))))))))))))))
(let ((anon5_Then_correct  (=> (= |list#0@@3| |#_module.List.Nil|) (=> (and (= $Heap@1 $Heap) (= (ControlFlow 0 4) 3)) anon4_correct))))
(let ((anon6_Else_correct true))
(let ((anon5_Else_correct  (=> (or (not (= |list#0@@3| |#_module.List.Nil|)) (not true)) (and (=> (= (ControlFlow 0 10) 5) anon6_Then_correct) (=> (= (ControlFlow 0 10) 1) anon6_Else_correct)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 11) 4) anon5_Then_correct) (=> (= (ControlFlow 0 11) 10) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and (and ($Is DatatypeTypeType |list#0@@3| (Tclass._module.List Tclass._System.object)) ($IsAlloc DatatypeTypeType |list#0@@3| (Tclass._module.List Tclass._System.object) $Heap)) (|$IsA#_module.List| |list#0@@3|)) (<= (LitInt 0) |k#0|)) (and (<= (LitInt 0) |w#0_0|) true)) (and (and (<= (LitInt 0) |m#0|) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 12) 11)))) anon0_correct))))
