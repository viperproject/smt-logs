...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((GenericPick._default.SeqPick3$U T@U) (|s#0| T@U) ) (!  (=> (or (|GenericPick.__default.SeqPick3#canCall| GenericPick._default.SeqPick3$U |s#0|) (and (< 1 $FunctionContextHeight) (and ($Is SeqType |s#0| (TSeq GenericPick._default.SeqPick3$U)) (exists ((|i#0| Int) ) (!  (and (<= (LitInt 0) |i#0|) (< |i#0| (|Seq#Length| |s#0|)))
 :qid |SmallTestsdfy.821:21|
 :skolemid |563|
))))) ($IsBox (GenericPick.__default.SeqPick3 GenericPick._default.SeqPick3$U |s#0|) GenericPick._default.SeqPick3$U))
 :qid |unknown.0:0|
 :skolemid |564|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((GenericPick._default.SeqPick3$U@@1 T@U) ($Heap T@U) (|s#0@@0| T@U) ) (!  (=> (or (|GenericPick.__default.SeqPick3#canCall| GenericPick._default.SeqPick3$U@@1 |s#0@@0|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is SeqType |s#0@@0| (TSeq GenericPick._default.SeqPick3$U@@1))) (exists ((|i#1| Int) ) (!  (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |s#0@@0|)))
 :qid |SmallTestsdfy.821:21|
 :skolemid |566|
))))) (and (|$let#30$canCall| GenericPick._default.SeqPick3$U@@1 |s#0@@0|) (= (GenericPick.__default.SeqPick3 GenericPick._default.SeqPick3$U@@1 |s#0@@0|) (let ((|x#0| (|$let#30_x| GenericPick._default.SeqPick3$U@@1 |s#0@@0|)))
|x#0|))))
 :qid |unknown.0:0|
 :skolemid |569|
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((GenericPick._default.SeqPick3$U@@3 T@U) ($Heap@@1 T@U) (|s#0@@2| T@U) ) (!  (=> (or (|GenericPick.__default.SeqPick3#canCall| GenericPick._default.SeqPick3$U@@3 (Lit SeqType |s#0@@2|)) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) ($Is SeqType |s#0@@2| (TSeq GenericPick._default.SeqPick3$U@@3))) (exists ((|i#2| Int) ) (!  (and (<= (LitInt 0) |i#2|) (< |i#2| (|Seq#Length| (Lit SeqType |s#0@@2|))))
 :qid |SmallTestsdfy.821:21|
 :skolemid |570|
))))) (and (|$let#30$canCall| GenericPick._default.SeqPick3$U@@3 (Lit SeqType |s#0@@2|)) (= (GenericPick.__default.SeqPick3 GenericPick._default.SeqPick3$U@@3 (Lit SeqType |s#0@@2|)) (let ((|x#1| (|$let#30_x| GenericPick._default.SeqPick3$U@@3 (Lit SeqType |s#0@@2|))))
|x#1|))))
 :qid |unknown.0:0|
 :weight 3
 :skolemid |571|
...
(set-info :boogie-vc-id CheckWellformed$$GenericPick.__default.SeqPick3)
...
(let ((anon10_Else_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (or (not (|Seq#Equal| |s#0@@3| |Seq#Empty|)) (or (not (= (|Seq#Length| |s#0@@3|) 0)) (not true))) (exists ((|i#1@@0| Int) ) (!  (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (|Seq#Length| |s#0@@3|)))
 :qid |SmallTestsdfy.834:21|
 :skolemid |584|
)))) (=> (or (or (not (|Seq#Equal| |s#0@@3| |Seq#Empty|)) (or (not (= (|Seq#Length| |s#0@@3|) 0)) (not true))) (exists ((|i#1@@1| Int) ) (!  (and (<= (LitInt 0) |i#1@@1|) (< |i#1@@1| (|Seq#Length| |s#0@@3|)))
 :qid |SmallTestsdfy.834:21|
 :skolemid |584|
))) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (exists ((|x#1@@0| T@U) ) (!  (and ($IsBox |x#1@@0| GenericPick._default.SeqPick3$U@@4) (|Seq#Contains| |s#0@@3| |x#1@@0|))
