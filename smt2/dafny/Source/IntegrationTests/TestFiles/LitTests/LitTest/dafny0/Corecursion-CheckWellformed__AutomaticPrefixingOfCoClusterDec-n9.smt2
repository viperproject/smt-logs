...
(set-info :boogie-vc-id CheckWellformed$$AutomaticPrefixingOfCoClusterDecreasesClauses.__default.H)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (and (= |##b#0@0| (U_2_bool (Lit boolType (bool_2_U true)))) ($IsAlloc boolType (bool_2_U |##b#0@0|) TBool $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 (LitInt 1)) (= (LitInt 0) (LitInt 1)))) (=> (or (<= 0 (LitInt 1)) (= (LitInt 0) (LitInt 1))) (=> (= (ControlFlow 0 3) (- 0 2)) (<= (LitInt 0) (LitInt 1))))))))
