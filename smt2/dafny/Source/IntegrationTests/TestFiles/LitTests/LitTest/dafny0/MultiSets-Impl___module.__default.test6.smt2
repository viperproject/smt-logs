...
(assert (forall ((s@@8 T@U) (v@@3 T@U) ) (! (= (|Seq#Length| (|Seq#Build| s@@8 v@@3)) (+ 1 (|Seq#Length| s@@8)))
 :qid |DafnyPreludebpl.1144:15|
 :skolemid |224|
 :pattern ( (|Seq#Build| s@@8 v@@3))
)))
...
(assert (forall ((v@@4 T@U) (t@@0 T@U) (h@@1 T@U) (T@@1 T@T) ) (! (= ($IsAllocBox ($Box T@@1 v@@4) t@@0 h@@1) ($IsAlloc T@@1 v@@4 t@@0 h@@1))
 :qid |DafnyPreludebpl.217:18|
 :skolemid |39|
 :pattern ( ($IsAllocBox ($Box T@@1 v@@4) t@@0 h@@1))
)))
(assert (forall ((h@@2 T@U) (k@@0 T@U) (bx T@U) (t@@1 T@U) ) (!  (=> ($HeapSucc h@@2 k@@0) (=> ($IsAllocBox bx t@@1 h@@2) ($IsAllocBox bx t@@1 k@@0)))
 :qid |DafnyPreludebpl.557:15|
 :skolemid |111|
 :pattern ( ($HeapSucc h@@2 k@@0) ($IsAllocBox bx t@@1 h@@2))
)))
(assert (forall ((h@@3 T@U) (k@@1 T@U) (v@@5 T@U) (t@@2 T@U) (T@@2 T@T) ) (!  (=> ($HeapSucc h@@3 k@@1) (=> ($IsAlloc T@@2 v@@5 t@@2 h@@3) ($IsAlloc T@@2 v@@5 t@@2 k@@1)))
 :qid |DafnyPreludebpl.554:18|
 :skolemid |110|
 :pattern ( ($HeapSucc h@@3 k@@1) ($IsAlloc T@@2 v@@5 t@@2 h@@3))
)))
(assert (forall ((s@@9 T@U) (n@@6 Int) (j@@1 Int) ) (!  (=> (and (and (<= 0 n@@6) (<= 0 j@@1)) (< j@@1 (- (|Seq#Length| s@@9) n@@6))) (= (|Seq#Index| (|Seq#Drop| s@@9 n@@6) j@@1) (|Seq#Index| s@@9 (+ j@@1 n@@6))))
 :qid |DafnyPreludebpl.1253:15|
 :weight 25
 :skolemid |247|
 :pattern ( (|Seq#Index| (|Seq#Drop| s@@9 n@@6) j@@1))
)))
...
(assert (forall ((s@@10 T@U) (i@@2 Int) (v@@6 T@U) ) (!  (and (=> (= i@@2 (|Seq#Length| s@@10)) (= (|Seq#Index| (|Seq#Build| s@@10 v@@6) i@@2) v@@6)) (=> (or (not (= i@@2 (|Seq#Length| s@@10))) (not true)) (= (|Seq#Index| (|Seq#Build| s@@10 v@@6) i@@2) (|Seq#Index| s@@10 i@@2))))
 :qid |DafnyPreludebpl.1148:15|
 :skolemid |225|
 :pattern ( (|Seq#Index| (|Seq#Build| s@@10 v@@6) i@@2))
)))
(assert (forall ((s@@11 T@U) (x@@8 T@U) ) (! (= (exists ((i@@3 Int) ) (!  (and (and (<= 0 i@@3) (< i@@3 (|Seq#Length| s@@11))) (= x@@8 (|Seq#Index| s@@11 i@@3)))
 :qid |DafnyPreludebpl.1108:11|
 :skolemid |219|
 :pattern ( (|Seq#Index| s@@11 i@@3))
)) (< 0 (|MultiSet#Multiplicity| (|MultiSet#FromSeq| s@@11) x@@8)))
 :qid |DafnyPreludebpl.1106:15|
 :skolemid |220|
 :pattern ( (|MultiSet#Multiplicity| (|MultiSet#FromSeq| s@@11) x@@8))
)))
...
(assert (forall ((s@@12 T@U) (i@@5 Int) (v@@7 T@U) (n@@7 Int) ) (!  (=> (and (and (<= 0 i@@5) (< i@@5 n@@7)) (<= n@@7 (|Seq#Length| s@@12))) (= (|Seq#Drop| (|Seq#Update| s@@12 i@@5 v@@7) n@@7) (|Seq#Drop| s@@12 n@@7)))
 :qid |DafnyPreludebpl.1283:15|
 :skolemid |253|
 :pattern ( (|Seq#Drop| (|Seq#Update| s@@12 i@@5 v@@7) n@@7))
)))
...
(assert (forall ((s@@14 T@U) (i@@6 Int) (v@@9 T@U) (n@@9 Int) ) (!  (=> (and (<= n@@9 i@@6) (< i@@6 (|Seq#Length| s@@14))) (= (|Seq#Take| (|Seq#Update| s@@14 i@@6 v@@9) n@@9) (|Seq#Take| s@@14 n@@9)))
 :qid |DafnyPreludebpl.1273:15|
 :skolemid |251|
 :pattern ( (|Seq#Take| (|Seq#Update| s@@14 i@@6 v@@9) n@@9))
)))
...
(assert (forall ((s@@15 T@U) ) (! (<= 0 (|MultiSet#Card| s@@15))
 :qid |DafnyPreludebpl.928:15|
 :skolemid |185|
 :pattern ( (|MultiSet#Card| s@@15))
)))
(assert (forall ((s@@16 T@U) ) (! (<= 0 (|Seq#Length| s@@16))
...
(assert (forall ((h@@5 T@U) (i@@9 Int) (v@@10 T@U) (a@@14 T@U) ) (!  (=> (and (<= 0 i@@9) (< i@@9 (_System.array.Length a@@14))) (= (|Seq#FromArray| (MapType0Store refType (MapType0Type FieldType BoxType) h@@5 a@@14 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@5 a@@14) (IndexField i@@9) v@@10)) a@@14) (|Seq#Update| (|Seq#FromArray| h@@5 a@@14) i@@9 v@@10)))
 :qid |DafnyPreludebpl.1343:15|
 :skolemid |265|
 :pattern ( (|Seq#FromArray| (MapType0Store refType (MapType0Type FieldType BoxType) h@@5 a@@14 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@5 a@@14) (IndexField i@@9) v@@10)) a@@14))
)))
...
(assert (forall ((s@@17 T@U) ) (!  (and (= (= (|MultiSet#Card| s@@17) 0) (= s@@17 |MultiSet#Empty|)) (=> (or (not (= (|MultiSet#Card| s@@17) 0)) (not true)) (exists ((x@@11 T@U) ) (! (< 0 (|MultiSet#Multiplicity| s@@17 x@@11))
 :qid |DafnyPreludebpl.946:20|
 :skolemid |188|
 :pattern ( (|MultiSet#Multiplicity| s@@17 x@@11))
))))
...
(assert (forall ((s@@18 T@U) (i@@10 Int) (v@@11 T@U) ) (!  (=> (and (<= 0 i@@10) (< i@@10 (|Seq#Length| s@@18))) (= (|Seq#Length| (|Seq#Update| s@@18 i@@10 v@@11)) (|Seq#Length| s@@18)))
 :qid |DafnyPreludebpl.1167:15|
 :skolemid |228|
 :pattern ( (|Seq#Length| (|Seq#Update| s@@18 i@@10 v@@11)))
)))
(assert (forall ((h@@6 T@U) (a@@18 T@U) ) (! (= (|Seq#Length| (|Seq#FromArray| h@@6 a@@18)) (_System.array.Length a@@18))
 :qid |DafnyPreludebpl.1323:15|
 :skolemid |261|
 :pattern ( (|Seq#Length| (|Seq#FromArray| h@@6 a@@18)))
)))
(assert (forall ((s@@19 T@U) (val@@4 T@U) ) (!  (and (= (|Seq#Build_inv0| (|Seq#Build| s@@19 val@@4)) s@@19) (= (|Seq#Build_inv1| (|Seq#Build| s@@19 val@@4)) val@@4))
 :qid |DafnyPreludebpl.1139:15|
 :skolemid |223|
 :pattern ( (|Seq#Build| s@@19 val@@4))
)))
...
(assert (forall ((s@@20 T@U) ) (! (= (|MultiSet#Card| (|MultiSet#FromSeq| s@@20)) (|Seq#Length| s@@20))
 :qid |DafnyPreludebpl.1085:15|
 :skolemid |215|
 :pattern ( (|MultiSet#Card| (|MultiSet#FromSeq| s@@20)))
)))
...
(assert (forall ((s@@21 T@U) (v@@12 T@U) ) (! (= (|MultiSet#FromSeq| (|Seq#Build| s@@21 v@@12)) (|MultiSet#UnionOne| (|MultiSet#FromSeq| s@@21) v@@12))
 :qid |DafnyPreludebpl.1089:15|
 :skolemid |216|
 :pattern ( (|MultiSet#FromSeq| (|Seq#Build| s@@21 v@@12)))
)))
...
(assert (forall ((s@@22 T@U) (n@@10 Int) (k@@2 Int) ) (!  (=> (and (and (<= 0 n@@10) (<= n@@10 k@@2)) (< k@@2 (|Seq#Length| s@@22))) (= (|Seq#Index| (|Seq#Drop| s@@22 n@@10) (- k@@2 n@@10)) (|Seq#Index| s@@22 k@@2)))
 :qid |DafnyPreludebpl.1258:15|
 :weight 25
 :skolemid |248|
 :pattern ( (|Seq#Index| s@@22 k@@2) (|Seq#Drop| s@@22 n@@10))
)))
...
(assert (forall ((s@@23 T@U) (m@@4 Int) (n@@11 Int) ) (!  (=> (and (and (<= 0 m@@4) (<= 0 n@@11)) (<= (+ m@@4 n@@11) (|Seq#Length| s@@23))) (= (|Seq#Drop| (|Seq#Drop| s@@23 m@@4) n@@11) (|Seq#Drop| s@@23 (+ m@@4 n@@11))))
 :qid |DafnyPreludebpl.1299:15|
 :skolemid |257|
 :pattern ( (|Seq#Drop| (|Seq#Drop| s@@23 m@@4) n@@11))
)))
...
(assert (forall ((s@@24 T@U) ) (!  (=> (= (|Seq#Length| s@@24) 0) (= s@@24 |Seq#Empty|))
 :qid |DafnyPreludebpl.1131:15|
 :skolemid |222|
 :pattern ( (|Seq#Length| s@@24))
)))
(assert (forall ((s@@25 T@U) (n@@13 Int) ) (!  (=> (= n@@13 0) (= (|Seq#Take| s@@25 n@@13) |Seq#Empty|))
 :qid |DafnyPreludebpl.1295:15|
 :skolemid |256|
 :pattern ( (|Seq#Take| s@@25 n@@13))
)))
...
(assert (forall ((s@@26 T@U) (i@@11 Int) (v@@14 T@U) (n@@14 Int) ) (!  (=> (and (and (<= 0 i@@11) (< i@@11 n@@14)) (<= n@@14 (|Seq#Length| s@@26))) (= (|Seq#Take| (|Seq#Update| s@@26 i@@11 v@@14) n@@14) (|Seq#Update| (|Seq#Take| s@@26 n@@14) i@@11 v@@14)))
 :qid |DafnyPreludebpl.1268:15|
 :skolemid |250|
 :pattern ( (|Seq#Take| (|Seq#Update| s@@26 i@@11 v@@14) n@@14))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (<= 0 |n#0|) (< |n#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |n#0|) (< |n#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |n#0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |n#0|))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField |n#0|) ($Box intType (int_2_U |e#0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (and (<= 0 (+ |n#0| 1)) (<= (+ |n#0| 1) (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |n#0|) (<= |n#0| (_System.array.Length |a#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Seq#Equal| (|Seq#Take| (|Seq#FromArray| $Heap@0 |a#0|) (+ |n#0| 1)) (|Seq#Append| (|Seq#Take| (|Seq#FromArray| $Heap@0 |a#0|) |n#0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |e#0|)))))) (=> (|Seq#Equal| (|Seq#Take| (|Seq#FromArray| $Heap@0 |a#0|) (+ |n#0| 1)) (|Seq#Append| (|Seq#Take| (|Seq#FromArray| $Heap@0 |a#0|) |n#0|) (|Seq#Build| |Seq#Empty| ($Box intType (int_2_U |e#0|))))) (=> (= (ControlFlow 0 2) (- 0 1)) (|MultiSet#Equal| (|MultiSet#FromSeq| (|Seq#Take| (|Seq#FromArray| $Heap@0 |a#0|) (+ |n#0| 1))) (|MultiSet#Union| (|MultiSet#FromSeq| (|Seq#Take| (|Seq#FromArray| $Heap@0 |a#0|) |n#0|)) (|MultiSet#UnionOne| |MultiSet#Empty| ($Box intType (int_2_U |e#0|))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (and (and (= 0 $FunctionContextHeight) (<= (LitInt 0) |n#0|)) (and (< |n#0| (_System.array.Length |a#0|)) (= (ControlFlow 0 11) 2)))) anon0_correct)))
