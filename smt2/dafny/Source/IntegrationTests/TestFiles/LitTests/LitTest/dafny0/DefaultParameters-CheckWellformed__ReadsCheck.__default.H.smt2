...
(set-info :boogie-vc-id CheckWellformed$$ReadsCheck.__default.H)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#1| null $Heap alloc |d#0|)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |c#0@@1| null)) (not true))) (=> (or (not (= |c#0@@1| null)) (not true)) (=> (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |c#0@@1| ReadsCheck.Cell.data))) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= |c#0@@1| |d#0|) (and (=> (= (ControlFlow 0 3) 1) anon4_Then_correct) (=> (= (ControlFlow 0 3) 2) anon4_Else_correct)))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |c#0@@1| Tclass.ReadsCheck.Cell) ($Is refType |d#0| Tclass.ReadsCheck.Cell)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 6) 3))) anon0_correct))))
