...
procedure {:verboseName "M.F (well-formedness)"} CheckWellformed$$M.__default.F();
...
procedure {:verboseName "M.public._ctor (correctness)"} Impl$$M.public.__ctor() returns (this: ref, $_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
