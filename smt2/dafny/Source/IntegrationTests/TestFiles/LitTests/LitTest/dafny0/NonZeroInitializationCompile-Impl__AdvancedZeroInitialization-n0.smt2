...
(declare-fun AdvancedZeroInitialization._default.MyMethod1$G () T@U)
...
(set-info :boogie-vc-id Impl$$AdvancedZeroInitialization.__default.MyMethod1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= 0 (LitInt 8))) (=> (<= 0 (LitInt 8)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? AdvancedZeroInitialization._default.MyMethod1$G))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 8)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (and (<= 0 (LitInt 3)) (< (LitInt 3) (_System.array.Length $nw@0))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($IsBox |g#0| AdvancedZeroInitialization._default.MyMethod1$G) ($IsAllocBox |g#0| AdvancedZeroInitialization._default.MyMethod1$G $Heap)) (and ($IsBox |h#0| AdvancedZeroInitialization._default.MyMethod1$G) ($IsAllocBox |h#0| AdvancedZeroInitialization._default.MyMethod1$G $Heap))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array AdvancedZeroInitialization._default.MyMethod1$G)) ($IsAlloc refType |a#0| (Tclass._System.array AdvancedZeroInitialization._default.MyMethod1$G) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2))) anon0_correct)))))
