...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 35) (let ((anon24_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (or (exists ((|b#3| Bool) ) (U_2_bool (Lit boolType (bool_2_U true)))) (or (not (= 5 5)) (not true))))))
(let ((anon36_Else_correct  (=> (and (exists ((|b#3@@0| Bool) ) (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 8) 6)) anon24_correct)))
(let ((anon36_Then_correct  (=> (and (not (exists ((|b#3@@1| Bool) ) (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 7) 6)) anon24_correct)))
...
(let ((anon19_correct  (and (=> (= (ControlFlow 0 11) (- 0 12)) (or (exists ((|b#3_1| Bool) ) (U_2_bool (Lit boolType (bool_2_U true)))) (or (not (= 4 4)) (not true)))) (=> (or (exists ((|b#3_1@@0| Bool) ) (U_2_bool (Lit boolType (bool_2_U true)))) (or (not (= 4 4)) (not true))) (and (=> (= (ControlFlow 0 11) 9) anon35_Then_correct) (=> (= (ControlFlow 0 11) 4) anon35_Else_correct))))))
(let ((anon34_Else_correct  (=> (and (exists ((|b#3_1@@1| Bool) ) (U_2_bool (Lit boolType (bool_2_U true)))) (= (ControlFlow 0 14) 11)) anon19_correct)))
(let ((anon34_Then_correct  (=> (and (not (exists ((|b#3_1@@2| Bool) ) (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 13) 11)) anon19_correct)))
...
(let ((anon13_correct  (and (=> (= (ControlFlow 0 17) (- 0 18)) (or (forall ((|b#1| Bool) )  (or |b#1| (not |b#1|))) (or (not (= 3 3)) (not true)))) (=> (or (forall ((|b#1@@0| Bool) )  (or |b#1@@0| (not |b#1@@0|))) (or (not (= 3 3)) (not true))) (and (=> (= (ControlFlow 0 17) 10) anon32_Then_correct) (=> (= (ControlFlow 0 17) 16) anon32_Else_correct))))))
(let ((anon31_Else_correct  (=> (and (forall ((|b#1@@1| Bool) )  (or |b#1@@1| (not |b#1@@1|))) (= (ControlFlow 0 20) 17)) anon13_correct)))
(let ((anon31_Then_correct  (=> (and (not (forall ((|b#1@@2| Bool) )  (or |b#1@@2| (not |b#1@@2|)))) (= (ControlFlow 0 19) 17)) anon13_correct)))
...
(let ((anon7_correct  (and (=> (= (ControlFlow 0 26) (- 0 27)) (or (forall ((|b#1_1| Bool) )  (or |b#1_1| (not |b#1_1|))) (or (not (= 0 0)) (not true)))) (=> (or (forall ((|b#1_1@@0| Bool) )  (or |b#1_1@@0| (not |b#1_1@@0|))) (or (not (= 0 0)) (not true))) (=> (= (ControlFlow 0 26) 24) anon8_correct)))))
(let ((anon28_Else_correct  (=> (and (forall ((|b#1_1@@1| Bool) )  (or |b#1_1@@1| (not |b#1_1@@1|))) (= (ControlFlow 0 29) 26)) anon7_correct)))
(let ((anon28_Then_correct  (=> (and (not (forall ((|b#1_1@@2| Bool) )  (or |b#1_1@@2| (not |b#1_1@@2|)))) (= (ControlFlow 0 28) 26)) anon7_correct)))
