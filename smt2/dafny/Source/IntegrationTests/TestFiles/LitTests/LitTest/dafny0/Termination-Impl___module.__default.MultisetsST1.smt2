...
(declare-fun _module._default.MultisetsST1$Y () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.MultisetsST1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 26) (let ((anon22_Else_correct  (=> (not (|MultiSet#Equal| |s#0@1| |MultiSet#Empty|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (or (<= 0 |$decr$loop#00@1|) (= (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|)) (=> (= (ControlFlow 0 7) (- 0 6)) (< (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) |$decr$loop#00@1|)))))))
(let ((anon22_Then_correct true))
(let ((anon12_correct  (and (=> (= (ControlFlow 0 9) (- 0 11)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.MultisetsST1$Y) (and (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0) (or (or (or (not (= |$as#x0_0#0_0| |y#0|)) (not true)) (<= (LitInt 2) (|MultiSet#Multiplicity| |s#0@0| |y#0|))) (|MultiSet#Equal| |s#0@0| |t#0@0|))))
 :qid |Terminationdfy.785:9|
 :skolemid |3237|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.MultisetsST1$Y) (and (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0) (or (or (or (not (= |$as#x0_0#0_0@@0| |y#0|)) (not true)) (<= (LitInt 2) (|MultiSet#Multiplicity| |s#0@0| |y#0|))) (|MultiSet#Equal| |s#0@0| |t#0@0|))))
 :qid |Terminationdfy.785:9|
 :skolemid |3237|
)) (=> (=> true (and ($IsBox |x#0_0@1| _module._default.MultisetsST1$Y) ($IsAllocBox |x#0_0@1| _module._default.MultisetsST1$Y $Heap))) (=> (and (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0) (or (or (or (not (= |x#0_0@1| |y#0|)) (not true)) (<= (LitInt 2) (|MultiSet#Multiplicity| |s#0@0| |y#0|))) (|MultiSet#Equal| |s#0@0| |t#0@0|))) (and (=> (= (ControlFlow 0 9) (- 0 10)) true) (=> (= |s#0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 9) 5) anon22_Then_correct) (=> (= (ControlFlow 0 9) 7) anon22_Else_correct))))))))))
(let ((anon11_correct  (=> (= (ControlFlow 0 13) 9) anon12_correct)))
(let ((anon21_Else_correct  (=> (and (or (or (not (= |x#0_1@1| |y#0|)) (not true)) (<= (LitInt 2) (|MultiSet#Multiplicity| |s#0@0| |y#0|))) (= (ControlFlow 0 16) 13)) anon11_correct)))
(let ((anon21_Then_correct  (=> (and (not (or (or (not (= |x#0_1@1| |y#0|)) (not true)) (<= (LitInt 2) (|MultiSet#Multiplicity| |s#0@0| |y#0|)))) (= (ControlFlow 0 15) 13)) anon11_correct)))
(let ((anon20_Else_correct  (=> (or (not (= |x#0_1@1| |y#0|)) (not true)) (and (=> (= (ControlFlow 0 18) 15) anon21_Then_correct) (=> (= (ControlFlow 0 18) 16) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (= |x#0_1@1| |y#0|) (and (=> (= (ControlFlow 0 17) 15) anon21_Then_correct) (=> (= (ControlFlow 0 17) 16) anon21_Else_correct)))))
(let ((anon19_Then_correct  (=> (> (|MultiSet#Multiplicity| |s#0@0| |x#0_1@1|) 0) (and (=> (= (ControlFlow 0 19) 17) anon20_Then_correct) (=> (= (ControlFlow 0 19) 18) anon20_Else_correct)))))
(let ((anon19_Else_correct  (=> (and (>= 0 (|MultiSet#Multiplicity| |s#0@0| |x#0_1@1|)) (= (ControlFlow 0 14) 13)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and ($IsBox |x#0_1@1| _module._default.MultisetsST1$Y) ($IsAllocBox |x#0_1@1| _module._default.MultisetsST1$Y $Heap)) (and (=> (= (ControlFlow 0 20) 19) anon19_Then_correct) (=> (= (ControlFlow 0 20) 14) anon19_Else_correct)))))
(let ((anon18_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.MultisetsST1$Y) ($IsAllocBox |x#0_1@1| _module._default.MultisetsST1$Y $Heap))) (= (ControlFlow 0 12) 9)) anon12_correct)))
(let ((anon17_Else_correct  (=> (and (|MultiSet#Subset| |t#0@0| |s#0@0|) (= |$decr$loop#00@1| (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)))) (and (=> (= (ControlFlow 0 21) 20) anon18_Then_correct) (=> (= (ControlFlow 0 21) 12) anon18_Else_correct)))))
(let ((anon17_Then_correct true))
(let ((anon16_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 22) 4) anon17_Then_correct) (=> (= (ControlFlow 0 22) 21) anon17_Else_correct)))))
(let ((anon16_Then_correct  (=> (not |$w$loop#0@0|) (=> (and (= |newtype$check#0@0| (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|))) (= (ControlFlow 0 3) (- 0 2))) (<= (LitInt 0) |newtype$check#0@0|)))))
(let ((anon15_LoopBody_correct  (and (=> (= (ControlFlow 0 23) 3) anon16_Then_correct) (=> (= (ControlFlow 0 23) 22) anon16_Else_correct))))
(let ((anon15_LoopDone_correct true))
(let ((anon15_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.MultisetsST1$Y) ($IsAllocBox |x#0_0@0| _module._default.MultisetsST1$Y $Heap))) (=> (and (and (and ($Is MultiSetType |s#0@0| (TMultiSet _module._default.MultisetsST1$Y)) ($IsAlloc MultiSetType |s#0@0| (TMultiSet _module._default.MultisetsST1$Y) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.784:3|
 :skolemid |3235|
...
)) (<= (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 24) 1) anon15_LoopDone_correct) (=> (= (ControlFlow 0 24) 23) anon15_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |t#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |y#0|))) (and (= |$decr_init$loop#00@0| (|MultiSet#Card| (|MultiSet#Difference| |S#0| |t#0@0|))) (= (ControlFlow 0 25) 24))) anon15_LoopHead_correct)))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is MultiSetType |S#0| (TMultiSet _module._default.MultisetsST1$Y)) ($IsAlloc MultiSetType |S#0| (TMultiSet _module._default.MultisetsST1$Y) $Heap)) (and ($IsBox |y#0| _module._default.MultisetsST1$Y) ($IsAllocBox |y#0| _module._default.MultisetsST1$Y $Heap))) (and (and ($Is MultiSetType |s#0| (TMultiSet _module._default.MultisetsST1$Y)) ($IsAlloc MultiSetType |s#0| (TMultiSet _module._default.MultisetsST1$Y) $Heap)) true)) (and (and (and ($Is MultiSetType |t#0| (TMultiSet _module._default.MultisetsST1$Y)) ($IsAlloc MultiSetType |t#0| (TMultiSet _module._default.MultisetsST1$Y) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.MultisetsST1$Y) ($IsAllocBox |x#0_0| _module._default.MultisetsST1$Y $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 26) 25))))) anon0_correct))))
