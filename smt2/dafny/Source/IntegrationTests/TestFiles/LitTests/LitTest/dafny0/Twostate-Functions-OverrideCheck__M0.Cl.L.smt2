...
(set-info :boogie-vc-id OverrideCheck$$M0.Cl.L)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (forall (($o@@10 T@U) ($f@@0 T@U) ) (!  (=> (or (not (= $o@@10 null)) (not true)) (=> (= $o@@10 |c#0@@8|) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@10) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@10) $f@@0))))
 :qid |TwostateFunctionsdfy.121:16|
 :skolemid |1308|
 :pattern ( (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@10) $f@@0))
)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))))) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (=> (or (not (= |c#0@@8| null)) (not true)) (or (not (= |c#0@@8| null)) (not true))) (=> (=  (or (not (= |c#0@@8| null)) (not true))  (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (or (not (= |d#0@@2| null)) (not true)))))) (=> (and (=> (or (not (= |c#0@@8| null)) (not true)) (or (not (= |c#0@@8| null)) (not true))) (=> (=  (or (not (= |c#0@@8| null)) (not true))  (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (or (not (= |d#0@@2| null)) (not true))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@11 T@U) ($f@@1 T@U) ) (! true
 :qid |TwostateFunctionsdfy.133:20|
 :skolemid |1309|
))) (=> (forall (($o@@12 T@U) ($f@@2 T@U) ) (! true
 :qid |TwostateFunctionsdfy.133:20|
 :skolemid |1309|
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@13 T@U) ($f@@3 T@U) ) (! true
 :qid |TwostateFunctionsdfy.133:20|
 :skolemid |1310|
))) (=> (forall (($o@@14 T@U) ($f@@4 T@U) ) (! true
 :qid |TwostateFunctionsdfy.133:20|
 :skolemid |1310|
)) (=> (and (= (M0.Cl.G $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data)))) (= (ControlFlow 0 2) (- 0 1))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))) (M0.Cl.G $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.M0.Cl) ($IsAlloc refType this@@2 Tclass.M0.Cl previous$Heap))) (and ($Is refType |c#0@@8| Tclass.M0.C) ($IsAlloc refType |c#0@@8| Tclass.M0.C previous$Heap))) (=> (and (and (and ($Is refType |d#0@@2| Tclass.M0.C) ($IsAlloc refType |d#0@@2| Tclass.M0.C current$Heap)) (= 2 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (and ($IsAlloc refType |c#0@@8| Tclass.M0.C previous$Heap) (= (ControlFlow 0 7) 2)))) anon0_correct)))))
