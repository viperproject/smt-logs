...
)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))))) (=> (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (=> (or (not (= |c#0@@8| null)) (not true)) (or (not (= |c#0@@8| null)) (not true))) (=> (=  (or (not (= |c#0@@8| null)) (not true))  (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (or (not (= |d#0@@2| null)) (not true)))))) (=> (and (=> (or (not (= |c#0@@8| null)) (not true)) (or (not (= |c#0@@8| null)) (not true))) (=> (=  (or (not (= |c#0@@8| null)) (not true))  (or (not (= |c#0@@8| null)) (not true))) (=> (or (not (= |d#0@@2| null)) (not true)) (or (not (= |d#0@@2| null)) (not true))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall (($o@@11 T@U) ($f@@1 T@U) ) true)) (=> (forall (($o@@12 T@U) ($f@@2 T@U) ) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) (forall (($o@@13 T@U) ($f@@3 T@U) ) true)) (=> (forall (($o@@14 T@U) ($f@@4 T@U) ) true) (=> (and (= (M0.Cl.G $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap |c#0@@8|) M0.C.data)))) (= (ControlFlow 0 2) (- 0 1))) (<= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |c#0@@8|) M0.C.data))) (M0.Cl.G $Heap@@1 current$Heap this@@2 |c#0@@8| |d#0@@2|))))))))))))))
