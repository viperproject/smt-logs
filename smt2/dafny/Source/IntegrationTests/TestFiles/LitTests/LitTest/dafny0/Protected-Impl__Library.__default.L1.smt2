...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let (($generated@@104  (=> (and (and (= $generated@@91 3) $generated@@0) (and $generated@@0 (= (ControlFlow 0 8) (- 0 7)))) (= ($generated@@1 $generated@@92) ($generated@@2 5)))))
(let (($generated@@105  (=> (and (and (or (not (= $generated@@91 3)) (not true)) $generated@@0) (and $generated@@0 (= (ControlFlow 0 6) (- 0 5)))) (= ($generated@@1 $generated@@92) ($generated@@2 5)))))
(let (($generated@@106  (and (=> (= (ControlFlow 0 9) 6) $generated@@105) (=> (= (ControlFlow 0 9) 8) $generated@@104))))
(let (($generated@@107  (=> (= $generated@@93 ($generated@@2 3)) (=> (and (= $generated@@91 $generated@@93) (= (ControlFlow 0 13) 9)) $generated@@106))))
(let (($generated@@108  (=> (and (and (and ($generated@@94 $generated@@95) ($generated@@96 $generated@@95)) (= $generated@@97 $generated@@95)) (and (and $generated@@92 (= $generated@@98 ($generated@@2 2))) (and (= $generated@@91 $generated@@98) (= (ControlFlow 0 12) 9)))) $generated@@106)))
(let (($generated@@109  (=> (and ($generated@@94 $generated@@99) ($generated@@96 $generated@@99)) (=> (and (and (= $generated@@97 $generated@@99) $generated@@92) (and $generated@@0 $generated@@0)) (and (=> (= (ControlFlow 0 10) (- 0 11)) (= ($generated@@1 $generated@@92) ($generated@@2 5))) (=> (= ($generated@@1 $generated@@92) ($generated@@2 5)) (=> (and (= $generated@@91 $generated@@100) (= (ControlFlow 0 10) 9)) $generated@@106)))))))
(let (($generated@@110  (=> (and (and (and (and (not ($generated@@8 ($generated@@20 $generated@@4 ($generated@@7 true)))) (not ($generated@@8 ($generated@@20 $generated@@4 ($generated@@7 true))))) (not ($generated@@8 ($generated@@20 $generated@@4 ($generated@@7 true))))) (not ($generated@@8 ($generated@@20 $generated@@4 ($generated@@7 true))))) (= (ControlFlow 0 4) (- 0 3))) false)))
(let (($generated@@111  (=> $generated@@0 (=> (and $generated@@0 (= (ControlFlow 0 2) (- 0 1))) (= ($generated@@1 $generated@@92) ($generated@@2 5))))))
(let (($generated@@112  (=> (= $generated@@101 ($generated@@32 $generated@@102 $generated@@97 $generated@@103 false)) (and (and (and (and (=> (= (ControlFlow 0 14) 2) $generated@@111) (=> (= (ControlFlow 0 14) 10) $generated@@109)) (=> (= (ControlFlow 0 14) 12) $generated@@108)) (=> (= (ControlFlow 0 14) 13) $generated@@107)) (=> (= (ControlFlow 0 14) 4) $generated@@110)))))
(let (($generated@@113  (=> (and (and ($generated@@94 $generated@@97) ($generated@@96 $generated@@97)) (and (= 1 $generated) (= (ControlFlow 0 15) 14))) $generated@@112)))
$generated@@113)))))))))))
))
(check-sat)
