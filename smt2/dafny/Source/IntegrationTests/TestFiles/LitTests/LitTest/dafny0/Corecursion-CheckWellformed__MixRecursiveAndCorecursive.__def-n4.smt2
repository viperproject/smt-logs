...
(set-info :boogie-vc-id CheckWellformed$$MixRecursiveAndCorecursive.__default.Y)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- |n#0@@5| 1)) Tclass._System.nat) (=> (and (= |##n#0@0| (- |n#0@@5| 1)) ($IsAlloc intType (int_2_U |##n#0@0|) Tclass._System.nat $Heap)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (<= 0 (LitInt 0)) (= (LitInt 0) (LitInt 0)))) (=> (or (<= 0 (LitInt 0)) (= (LitInt 0) (LitInt 0))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (or (<= 0 |n#0@@5|) (< (LitInt 0) (LitInt 0))) (= |##n#0@0| |n#0@@5|))) (=> (or (or (<= 0 |n#0@@5|) (< (LitInt 0) (LitInt 0))) (= |##n#0@0| |n#0@@5|)) (=> (= (ControlFlow 0 3) (- 0 2)) (or (< (LitInt 0) (LitInt 0)) (and (= (LitInt 0) (LitInt 0)) (< |##n#0@0| |n#0@@5|)))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (or (not (= |n#0@@5| 0)) (not true))) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0@@5|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct)))
