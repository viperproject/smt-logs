...
(declare-fun call0formal@AssumeTypeAssumptions.Cell$T () T@U)
(declare-fun $Heap@4 () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun call3formal@this@0 () T@U)
(declare-fun call3formal@this@@0 () T@U)
(declare-fun call0formal@AssumeTypeAssumptions.Cell$T@@0 () T@U)
...
(set-info :boogie-vc-id Impl$$AssumeTypeAssumptions.__default.Client__CellU)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#9| null $Heap alloc |x#0| |a#0|)) (=> |defass#xx#0| (and ($Is refType |xx#0@0| (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U)) ($IsAlloc refType |xx#0@0| (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U) $Heap)))) (and (=> (= (ControlFlow 0 2) (- 0 16)) (or (not (= |x#0| null)) (not true))) (=> (or (not (= |x#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 15)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |x#0| AssumeTypeAssumptions.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |x#0| AssumeTypeAssumptions.Cell.data)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |x#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |x#0|) AssumeTypeAssumptions.Cell.data ($Box refType |u#0|)))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 2) (- 0 14)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 13)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 12)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |j#0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |j#0|))) (=> (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField |j#0|) ($Box refType |u#0|)))) (=> (and ($IsGoodHeap $Heap@1) (=> true (and ($Is refType |xx#0@1| (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U)) ($IsAlloc refType |xx#0@1| (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U) $Heap@1)))) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= |x#0| null)) (not true))) (=> (or (not (= |x#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |x#0| AssumeTypeAssumptions.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |x#0| AssumeTypeAssumptions.Cell.data)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 |x#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |x#0|) AssumeTypeAssumptions.Cell.data ($Box refType |$rhs#2@0|)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 8)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |j#0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |j#0|))) (=> (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@2 |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 |a#0|) (IndexField |j#0|) ($Box refType |$rhs#3@0|)))) ($IsGoodHeap $Heap@3)) (=> (and (and (or (not (= call3formal@this null)) (not true)) (and ($Is refType call3formal@this (Tclass.AssumeTypeAssumptions.Cell call0formal@AssumeTypeAssumptions.Cell$T)) ($IsAlloc refType call3formal@this (Tclass.AssumeTypeAssumptions.Cell call0formal@AssumeTypeAssumptions.Cell$T) $Heap))) (and ($IsGoodHeap $Heap@4) ($IsHeapAnchor $Heap@4))) (=> (and (and (and (or (not (= call3formal@this@0 null)) (not true)) (and ($Is refType call3formal@this@0 (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U)) ($IsAlloc refType call3formal@this@0 (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U) $Heap@4))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 call3formal@this@0) alloc))))) (and (forall (($o@@10 T@U) ) (!  (=> (and (or (not (= $o@@10 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@10) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@10) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@3 $o@@10)))
 :qid |Basicsdfy.534:5|
 :skolemid |1186|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@10))
)) ($HeapSucc $Heap@3 $Heap@4))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |x#0| null)) (not true))) (=> (or (not (= |x#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |x#0| AssumeTypeAssumptions.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |x#0| AssumeTypeAssumptions.Cell.data)) (=> (and (and (or (not (= call3formal@this@@0 null)) (not true)) (and ($Is refType call3formal@this@@0 (Tclass.AssumeTypeAssumptions.Cell call0formal@AssumeTypeAssumptions.Cell$T@@0)) ($IsAlloc refType call3formal@this@@0 (Tclass.AssumeTypeAssumptions.Cell call0formal@AssumeTypeAssumptions.Cell$T@@0) $Heap))) (and ($IsGoodHeap $Heap@5) ($IsHeapAnchor $Heap@5))) (=> (and (and (and (or (not (= call3formal@this@0@@0 null)) (not true)) (and ($Is refType call3formal@this@0@@0 (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U)) ($IsAlloc refType call3formal@this@0@@0 (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U) $Heap@5))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 call3formal@this@0@@0) alloc))))) (and (and (forall (($o@@11 T@U) ) (!  (=> (and (or (not (= $o@@11 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@11) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@11) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@4 $o@@11)))
 :qid |Basicsdfy.534:5|
 :skolemid |1186|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 $o@@11))
)) ($HeapSucc $Heap@4 $Heap@5)) (and (= $Heap@6 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@5 |x#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@5 |x#0|) AssumeTypeAssumptions.Cell.data ($Box refType call3formal@this@0@@0)))) ($IsGoodHeap $Heap@6)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|)))) (=> (and (<= 0 |j#0|) (< |j#0| (_System.array.Length |a#0|))) (=> (= (ControlFlow 0 2) (- 0 1)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField |j#0|))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |x#0| (Tclass.AssumeTypeAssumptions.Cell (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U))) ($IsAlloc refType |x#0| (Tclass.AssumeTypeAssumptions.Cell (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U)) $Heap))) (and (and ($Is refType |a#0| (Tclass._System.array (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U))) ($IsAlloc refType |a#0| (Tclass._System.array (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U)) $Heap)) (and ($Is refType |u#0| (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U)) ($IsAlloc refType |u#0| (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U) $Heap)))) (and (and (and ($IsBox |u1#0| AssumeTypeAssumptions._default.Client_CellU$U) ($IsAllocBox |u1#0| AssumeTypeAssumptions._default.Client_CellU$U $Heap)) (and (=> |defass#xx#0| (and ($Is refType |xx#0| (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U)) ($IsAlloc refType |xx#0| (Tclass.AssumeTypeAssumptions.Cell AssumeTypeAssumptions._default.Client_CellU$U) $Heap))) true)) (and (and (= 1 $FunctionContextHeight) (<= (LitInt 0) |j#0|)) (and (< |j#0| (_System.array.Length |a#0|)) (= (ControlFlow 0 17) 2))))) anon0_correct)))
