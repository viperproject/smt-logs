...
(assert (forall ((_System.array$arg@@8 T@U) ($h@@1 T@U) ($o@@3 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@1) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) (Tclass._System.array? _System.array$arg@@8)))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@3) alloc)))) ($IsAlloc intType (int_2_U (_System.array.Length $o@@3)) TInt $h@@1))
 :qid |unknown.0:0|
 :skolemid |360|
 :pattern ( (_System.array.Length $o@@3) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@3) alloc)) (Tclass._System.array? _System.array$arg@@8))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.M2)
...
(let ((anon4_Else_correct  (=> (and (< (_System.array.Length |a#0|) (LitInt 10)) (= (ControlFlow 0 5) 1)) anon3_correct)))
(let ((anon4_Then_correct  (=> (<= (LitInt 10) (_System.array.Length |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |b#0| null)) (not true))) (=> (or (not (= |b#0| null)) (not true)) (=> (= (ControlFlow 0 2) 1) anon3_correct))))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |a#0|)) (or (not (= |a#0| |b#0|)) (not true))) (and (=> (= (ControlFlow 0 6) (- 0 7)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 6) 2) anon4_Then_correct) (=> (= (ControlFlow 0 6) 5) anon4_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (=> (and (and (and ($Is refType |b#0| (Tclass._System.array TInt)) ($IsAlloc refType |b#0| (Tclass._System.array TInt) $Heap)) (<= (LitInt 0) |n#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 6))) anon0_correct))))
