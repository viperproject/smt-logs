...
(let ((anon16_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (or (and ($Is intType (int_2_U |x#3@0|) TInt) (<= |x#3@0| |x#3@0|)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (<= |x#3@0| (LitInt 0))) (exists ((|bigger#3| Int) ) (<= |x#3@0| |bigger#3|))))) (=> (or (and ($Is intType (int_2_U |x#3@0|) TInt) (<= |x#3@0| |x#3@0|)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (<= |x#3@0| (LitInt 0))) (exists ((|bigger#3@@0| Int) ) (<= |x#3@0| |bigger#3@@0|)))) (=> (<= |x#3@0| |bigger#2@0|) (=> (and (|$let#0$canCall| |x#3@0|) (= (ControlFlow 0 5) 3)) anon10_correct))))))
