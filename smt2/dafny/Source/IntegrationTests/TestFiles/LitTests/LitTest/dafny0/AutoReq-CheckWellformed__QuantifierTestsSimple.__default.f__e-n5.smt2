...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0| T@U) ) (!  (=> (or (|QuantifierTestsSimple.__default.f__exists#canCall| |s#0|) (and (< 1 $FunctionContextHeight) ($Is SeqType |s#0| (TSeq TInt)))) (and (forall ((|i#0| Int) ) (!  (=> (<= (LitInt 0) |i#0|) (=> (< |i#0| (|Seq#Length| |s#0|)) (|QuantifierTestsSimple.__default.byte#canCall| (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0|))))))
 :qid |AutoReqdfy.82:12|
 :skolemid |1145|
 :pattern ( ($Unbox intType (|Seq#Index| |s#0| |i#0|)))
)) (= (QuantifierTestsSimple.__default.f__exists |s#0|) (exists ((|i#0@@0| Int) ) (!  (and (and (<= (LitInt 0) |i#0@@0|) (< |i#0@@0| (|Seq#Length| |s#0|))) (QuantifierTestsSimple.__default.byte (U_2_int ($Unbox intType (|Seq#Index| |s#0| |i#0@@0|)))))
 :qid |AutoReqdfy.82:12|
 :skolemid |1144|
 ...
 :skolemid |1146|
 :pattern ( (QuantifierTestsSimple.__default.f__exists |s#0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((|s#0@@0| T@U) ) (!  (=> (or (|QuantifierTestsSimple.__default.f__exists#canCall| (Lit SeqType |s#0@@0|)) (and (< 1 $FunctionContextHeight) ($Is SeqType |s#0@@0| (TSeq TInt)))) (and (forall ((|i#1| Int) ) (!  (=> (<= (LitInt 0) |i#1|) (=> (< |i#1| (|Seq#Length| (Lit SeqType |s#0@@0|))) (|QuantifierTestsSimple.__default.byte#canCall| (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1|))))))
 :qid |AutoReqdfy.82:12|
 :skolemid |1148|
 :pattern ( ($Unbox intType (|Seq#Index| |s#0@@0| |i#1|)))
)) (= (QuantifierTestsSimple.__default.f__exists (Lit SeqType |s#0@@0|)) (exists ((|i#1@@0| Int) ) (!  (and (and (<= (LitInt 0) |i#1@@0|) (< |i#1@@0| (|Seq#Length| (Lit SeqType |s#0@@0|)))) (QuantifierTestsSimple.__default.byte (U_2_int ($Unbox intType (|Seq#Index| (Lit SeqType |s#0@@0|) |i#1@@0|)))))
 :qid |AutoReqdfy.82:12|
 :skolemid |1147|
 ...
 :weight 3
 :skolemid |1149|
 :pattern ( (QuantifierTestsSimple.__default.f__exists (Lit SeqType |s#0@@0|)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$QuantifierTestsSimple.__default.f__exists)
