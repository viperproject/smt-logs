...
(let ((anon3_Then_correct  (=> (or (= |k#0_0@0| (LitInt (- 0 3))) (= |k#0_0@0| (LitInt 4))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) null)) (not true))) (=> (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 |i#0|) (< |i#0| (_System.array2.Length0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 |j#0|) (< |j#0| (_System.array2.Length1 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) (MultiIndexField (IndexField |i#0|) |j#0|)))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) (MultiIndexField (IndexField |i#0|) |j#0|))) (=> (or (= |k#0_1@0| (LitInt (- 0 3))) (= |k#0_1@0| (LitInt 4))) (=> (and (or (not (= |k#0_0@0| |k#0_1@0|)) (not true)) (= (ControlFlow 0 2) (- 0 1))) (or (or (or (not (= ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)) ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))) (not true)) (or (not (= (MultiIndexField (IndexField |i#0|) |j#0|) (MultiIndexField (IndexField |i#0|) |j#0|))) (not true))) (= (LitInt 50) (LitInt 50))))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this) _module.MyClass.arr)))) (and (=> (= (ControlFlow 0 8) 2) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct)))))
