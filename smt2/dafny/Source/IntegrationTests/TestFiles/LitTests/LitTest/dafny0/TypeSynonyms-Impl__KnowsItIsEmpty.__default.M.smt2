...
(set-info :boogie-vc-id Impl$$KnowsItIsEmpty.__default.M)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (U_2_bool (Lit boolType (bool_2_U false)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct)))
