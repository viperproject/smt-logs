...
(declare-fun _module._default.ShiftLeftB$T () T@U)
...
(declare-fun $LZ () T@U)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.ShiftLeftB)
...
(let ((anon10_correct  (=> (and (<= |n#0| |i#0_0@0|) (< |i#0_0@0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 7) (- 0 12)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 7) (- 0 11)) (and (<= 0 (- |i#0_0@0| |n#0|)) (< (- |i#0_0@0| |n#0|) (_System.array.Length $nw@0)))) (and (=> (= (ControlFlow 0 7) (- 0 10)) (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (- |i#0_0@0| |n#0|))))) (=> (U_2_bool (MapType0Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 (IndexField (- |i#0_0@0| |n#0|)))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (=> (and ($IsAlloc intType (int_2_U |i#0_0@0|) TInt $Heap@0) (|_module.__default.Id#canCall| |i#0_0@0|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (and (<= 0 (_module.__default.Id |i#0_0@0|)) (< (_module.__default.Id |i#0_0@0|) (_System.array.Length |a#0|)))) (=> (|_module.__default.Id#canCall| |i#0_0@0|) (=> (and (and (<= |n#0| |i#0_1@0|) (< |i#0_1@0| (_System.array.Length |a#0|))) (and (or (not (= |i#0_0@0| |i#0_1@0|)) (not true)) (= (ControlFlow 0 7) (- 0 6)))) (or (or (or (not (= $nw@0 $nw@0)) (not true)) (or (not (= (IndexField (- |i#0_0@0| |n#0|)) (IndexField (- |i#0_1@0| |n#0|)))) (not true))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_0@0|))) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id |i#0_1@0|)))))))))))))))))))
...
(let ((anon16_Else_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (and ($HeapSucc $Heap@0 $Heap@1) (forall (($o@@9 T@U) ($f@@1 T@U) ) (!  (or (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@9) $f@@1) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 $o@@9) $f@@1)) (exists ((|i#0_2| Int) ) (!  (and (and (and (<= |n#0| |i#0_2|) (< |i#0_2| (_System.array.Length |a#0|))) (= $o@@9 $nw@0)) (= $f@@1 (IndexField (- |i#0_2| |n#0|))))
 :qid |Inversesdfy.38:10|
 :skolemid |513|
)))
 :qid |Inversesdfy.38:3|
 :skolemid |514|
 :pattern ( (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $o@@9) $f@@1))
)))) (and (and (forall ((|i#inv#0_0| Int) ) (!  (=> (and (<= |n#0| (+ |i#inv#0_0| |n#0|)) (< (+ |i#inv#0_0| |n#0|) (_System.array.Length |a#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@1 $nw@0) (IndexField |i#inv#0_0|)) (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (_module.__default.Id (+ |i#inv#0_0| |n#0|))))))
 :qid |Inversesdfy.38:10|
 :skolemid |515|
...
(let ((anon12_Else_correct  (=> (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? _module._default.ShiftLeftB$T))) (and (not (U_2_bool ($Unbox boolType (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) alloc)))) (= (_System.array.Length $nw@0) (- (_System.array.Length |a#0|) |n#0|)))) (and (=> (= (ControlFlow 0 17) (- 0 18)) (forall ((|arrayinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0|) (< |arrayinit#0#i0#0| (- (_System.array.Length |a#0|) |n#0|))) (Requires1 TInt _module._default.ShiftLeftB$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0|))))
 :qid |Inversesdfy.37:8|
 :skolemid |511|
))) (=> (and (and (forall ((|arrayinit#0#i0#0@@0| Int) ) (!  (=> (and (<= 0 |arrayinit#0#i0#0@@0|) (< |arrayinit#0#i0#0@@0| (- (_System.array.Length |a#0|) |n#0|))) (= (MapType1Select FieldType BoxType (MapType1Select refType (MapType1Type FieldType BoxType) $Heap $nw@0) (IndexField |arrayinit#0#i0#0@@0|)) (Apply1 TInt _module._default.ShiftLeftB$T $Heap (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#6| (Handle1 (|lambda#2| |a#0|) (|lambda#3| TInt (LitInt 0) (_System.array.Length |a#0|)) (|lambda#5| (SetRef_to_SetBox (|lambda#4| |a#0|))))) ($LS $LZ))) ($Box intType (int_2_U |arrayinit#0#i0#0@@0|)))))
 :qid |Inversesdfy.37:8|
 :skolemid |512|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |a#0| (Tclass._System.array _module._default.ShiftLeftB$T)) ($IsAlloc refType |a#0| (Tclass._System.array _module._default.ShiftLeftB$T) $Heap)) (<= (LitInt 0) |n#0|)) (=> (and (and (and ($Is refType |r#0| (Tclass._System.array _module._default.ShiftLeftB$T)) ($IsAlloc refType |r#0| (Tclass._System.array _module._default.ShiftLeftB$T) $Heap)) (= 1 $FunctionContextHeight)) (and (<= |n#0| (_System.array.Length |a#0|)) (= (ControlFlow 0 34) 31))) anon0_correct)))))
