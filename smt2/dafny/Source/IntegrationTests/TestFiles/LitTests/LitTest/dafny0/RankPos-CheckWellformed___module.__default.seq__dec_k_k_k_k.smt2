...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon8_correct  (and (=> (= (ControlFlow 0 5) (- 0 8)) (or (and ($Is intType (int_2_U (- (|Seq#Length| |xs#0@@2|) 1)) TInt) (and (<= (LitInt 0) (- (|Seq#Length| |xs#0@@2|) 1)) (< (- (|Seq#Length| |xs#0@@2|) 1) (|Seq#Length| |xs#0@@2|)))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (<= (LitInt 0) (LitInt 0)) (< 0 (|Seq#Length| |xs#0@@2|)))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (<= (LitInt 0) (LitInt 0)) (< 0 (|Seq#Length| |xs#0@@2|)))) (exists ((|i#3| Int) )  (and (<= (LitInt 0) |i#3|) (< |i#3| (|Seq#Length| |xs#0@@2|)))))))) (=> (or (and ($Is intType (int_2_U (- (|Seq#Length| |xs#0@@2|) 1)) TInt) (and (<= (LitInt 0) (- (|Seq#Length| |xs#0@@2|) 1)) (< (- (|Seq#Length| |xs#0@@2|) 1) (|Seq#Length| |xs#0@@2|)))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (<= (LitInt 0) (LitInt 0)) (< 0 (|Seq#Length| |xs#0@@2|)))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (and (<= (LitInt 0) (LitInt 0)) (< 0 (|Seq#Length| |xs#0@@2|)))) (exists ((|i#3@@0| Int) )  (and (<= (LitInt 0) |i#3@@0|) (< |i#3@@0| (|Seq#Length| |xs#0@@2|))))))) (=> (and (<= (LitInt 0) |i#2@0|) (< |i#2@0| (|Seq#Length| |xs#0@@2|))) (and (=> (= (ControlFlow 0 5) (- 0 7)) (and (<= 0 |i#2@0|) (<= |i#2@0| (|Seq#Length| |xs#0@@2|)))) (=> (and (<= 0 |i#2@0|) (<= |i#2@0| (|Seq#Length| |xs#0@@2|))) (and (=> (= (ControlFlow 0 5) (- 0 6)) (and (<= 0 (+ |i#2@0| 1)) (<= (+ |i#2@0| 1) (|Seq#Length| |xs#0@@2|)))) (=> (and (<= 0 (+ |i#2@0| 1)) (<= (+ |i#2@0| 1) (|Seq#Length| |xs#0@@2|))) (=> (= |##xs#0@0| (|Seq#Append| (|Seq#Take| |xs#0@@2| |i#2@0|) (|Seq#Drop| |xs#0@@2| (+ |i#2@0| 1)))) (=> (and ($IsAlloc SeqType |##xs#0@0| (TSeq TInt) $Heap@@1) (= (ControlFlow 0 5) (- 0 4))) (< (|Seq#Rank| |##xs#0@0|) (|Seq#Rank| |xs#0@@2|)))))))))))))
