...
(set-info :boogie-vc-id CheckWellFormed$$Chars.BV)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (U_2_bool (Lit boolType (bool_2_U  (or (not (= #b000000 #b010111)) (not true))))))))
