...
(assert (forall ((d@@4 T@U) (_module.List$T@@5 T@U) ($h@@5 T@U) ) (!  (=> (and ($IsGoodHeap $h@@5) (and (_module.List.Cons_q d@@4) ($IsAlloc DatatypeTypeType d@@4 (Tclass._module.List _module.List$T@@5) $h@@5))) ($IsAllocBox (_module.List.car d@@4) _module.List$T@@5 $h@@5))
 :qid |unknown.0:0|
 :skolemid |511|
 :pattern ( ($IsAllocBox (_module.List.car d@@4) _module.List$T@@5 $h@@5))
)))
...
(assert (forall ((d@@6 T@U) (_module.List$T@@7 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_module.List.Cons_q d@@6) ($IsAlloc DatatypeTypeType d@@6 (Tclass._module.List _module.List$T@@7) $h@@6))) ($IsAlloc DatatypeTypeType (_module.List.cdr d@@6) (Tclass._module.List _module.List$T@@7) $h@@6))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List.cdr d@@6) (Tclass._module.List _module.List$T@@7) $h@@6))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@0 alloc false)) (= |xs#0@0| (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 28))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 22))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 28))) (Lit DatatypeTypeType (|#_module.List.Cons| ($Box intType (int_2_U (LitInt 5))) (Lit DatatypeTypeType |#_module.List.Nil|))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 (LitInt 2))) (=> (<= 0 (LitInt 2)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (LitInt 2) 2)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (and (and ($Is DatatypeTypeType |xs#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |xs#0| (Tclass._module.List TInt) $Heap@@0)) true) (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap@@0)) true)) (and (and (and ($Is DatatypeTypeType |nil#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |nil#0| (Tclass._module.List TInt) $Heap@@0)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 4) 2)))) anon0_correct))))
