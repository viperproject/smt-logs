...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType (int_2_U (LitInt 20))))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType (int_2_U (LitInt 20)))))) (LitInt 400)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |a#0| (TMap TInt TInt)) ($IsAlloc MapType |a#0| (TMap TInt TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|i#1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |i#1|)) (< (U_2_int |i#1|) 100)) (and (|Set#IsMember| (|Map#Domain| |a#0|) ($Box intType |i#1|)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType |i#1|)))) (Mul (U_2_int |i#1|) (U_2_int |i#1|)))))
 :qid |Mapsdfy.71:20|
 :skolemid |550|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |a#0|) ($Box intType |i#1|))))
