...
axiom {:id "id0"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    TwoLayersOfRequires.__default.f#canCall(x#0)
         || (0 < $FunctionContextHeight && x#0 > 4)
...
axiom {:id "id1"} 0 <= $FunctionContextHeight
   ==> (forall x#0: int :: 
    ...
    TwoLayersOfRequires.__default.f#canCall(LitInt(x#0))
         || (0 < $FunctionContextHeight && Lit(x#0 > 4))
...
procedure {:verboseName "TwoLayersOfRequires.f (well-formedness)"} CheckWellformed$$TwoLayersOfRequires.__default.f(x#0: int);
...
axiom {:id "id4"} 1 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    TwoLayersOfRequires.__default.g#canCall(y#0)
         || (1 < $FunctionContextHeight && y#0 < 50 && y#0 > 4)
...
axiom {:id "id5"} 1 <= $FunctionContextHeight
   ==> (forall y#0: int :: 
    ...
    TwoLayersOfRequires.__default.g#canCall(LitInt(y#0))
         || (1 < $FunctionContextHeight && Lit(y#0 < 50) && Lit(y#0 > 4))
...
procedure {:verboseName "TwoLayersOfRequires.g (well-formedness)"} CheckWellformed$$TwoLayersOfRequires.__default.g(y#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoLayersOfRequires.g (well-formedness)"} CheckWellformed$$TwoLayersOfRequires.__default.g(y#0: int)
{
  ...
  var ##x#0: int;
    ...
    else
    {
        ...
        assert {:id "id8"} {:subsumption 0} ##x#0 > 4;
        assume ##x#0 > 4;
        assume TwoLayersOfRequires.__default.f#canCall(y#0);
        assume {:id "id9"} TwoLayersOfRequires.__default.g(y#0) == TwoLayersOfRequires.__default.f(y#0);
        assume TwoLayersOfRequires.__default.f#canCall(y#0);
        // CheckWellformedWithResult: any expression
        assume $Is(TwoLayersOfRequires.__default.g(y#0), TBool);
        return;
...
axiom {:id "id10"} 2 <= $FunctionContextHeight
   ==> (forall z#0: int :: 
    ...
    TwoLayersOfRequires.__default.h#canCall(z#0)
         || (2 < $FunctionContextHeight && z#0 < 50 && z#0 > 4)
...
axiom {:id "id11"} 2 <= $FunctionContextHeight
   ==> (forall z#0: int :: 
    ...
    TwoLayersOfRequires.__default.h#canCall(LitInt(z#0))
         || (2 < $FunctionContextHeight && Lit(z#0 < 50) && Lit(z#0 > 4))
...
procedure {:verboseName "TwoLayersOfRequires.h (well-formedness)"} CheckWellformed$$TwoLayersOfRequires.__default.h(z#0: int);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TwoLayersOfRequires.h (well-formedness)"} CheckWellformed$$TwoLayersOfRequires.__default.h(z#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
  var ##y#0: int;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // Check well-formedness of preconditions, and then assume them
    assume {:id "id12"} z#0 < 50;
    assume {:id "id13"} z#0 > 4;
    // Check well-formedness of the reads clause
    // Check well-formedness of the decreases clause
    // Check body and ensures clauses
    if (*)
    ...
    else
    {
        ...
        assert {:id "id14"} {:subsumption 0} ##y#0 < 50;
        assume ##y#0 < 50;
        assert {:id "id15"} {:subsumption 0} ##y#0 > 4;
        assume ##y#0 > 4;
        assume TwoLayersOfRequires.__default.g#canCall(z#0);
        assume {:id "id16"} TwoLayersOfRequires.__default.h(z#0) == TwoLayersOfRequires.__default.g(z#0);
        assume TwoLayersOfRequires.__default.g#canCall(z#0);
        // CheckWellformedWithResult: any expression
        assume $Is(TwoLayersOfRequires.__default.h(z#0), TBool);
        return;
