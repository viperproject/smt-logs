...
(set-info :boogie-vc-id Impl$$ITER__F.RecursiveIterator)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon6_Else_correct  (=> (not (ITER__F.RecursiveIterator.good this@@0)) (and (=> (= (ControlFlow 0 8) (- 0 11)) (or (not (= (ITER__F.RecursiveIterator.r this@@0) null)) (not true))) (=> (or (not (= (ITER__F.RecursiveIterator.r this@@0) null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 10)) ($Is intType (int_2_U (+ (ITER__F.RecursiveIterator.n this@@0) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (+ (ITER__F.RecursiveIterator.n this@@0) 1)) Tclass._System.nat) (=> (= |n##1@0| (+ (ITER__F.RecursiveIterator.n this@@0) 1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (or (<= 0 (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))) (= |n##1@0| (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))))) (=> (or (<= 0 (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))) (= |n##1@0| (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|)))) (=> (= (ControlFlow 0 8) (- 0 7)) (< |n##1@0| (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))))))))))))))
(let ((anon6_Then_correct  (=> (ITER__F.RecursiveIterator.good this@@0) (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= (ITER__F.RecursiveIterator.r this@@0) null)) (not true))) (=> (or (not (= (ITER__F.RecursiveIterator.r this@@0) null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($Is intType (int_2_U (- (ITER__F.RecursiveIterator.n this@@0) 1)) Tclass._System.nat)) (=> ($Is intType (int_2_U (- (ITER__F.RecursiveIterator.n this@@0) 1)) Tclass._System.nat) (=> (= |n##0@0| (- (ITER__F.RecursiveIterator.n this@@0) 1)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (<= 0 (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))) (= |n##0@0| (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))))) (=> (or (<= 0 (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))) (= |n##0@0| (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|)))) (=> (= (ControlFlow 0 3) (- 0 2)) (< |n##0@0| (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|))))))))))))))
(let ((anon5_Else_correct  (=> (or (not (= (ITER__F.RecursiveIterator.n this@@0) (LitInt 0))) (not true)) (and (=> (= (ControlFlow 0 12) 3) anon6_Then_correct) (=> (= (ControlFlow 0 12) 8) anon6_Else_correct)))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap alloc this@@0 |cell#0|)) (=> (and (and (or (not (= |cell#0| null)) (not true)) (or (not (= |r#0| null)) (not true))) (= (ITER__F.RecursiveIterator.cell this@@0) |cell#0|)) (=> (and (and (and (and (= (ITER__F.RecursiveIterator.n this@@0) |n#0|) (= (ITER__F.RecursiveIterator.r this@@0) |r#0|)) (and (= (ITER__F.RecursiveIterator.good this@@0) |good#0|) (ITER__F.RecursiveIterator.Valid $Heap this@@0))) (and (and (|Set#Equal| (ITER__F.RecursiveIterator.__reads this@@0) |Set#Empty|) (|Set#Equal| (ITER__F.RecursiveIterator.__modifies this@@0) (|Set#UnionOne| |Set#Empty| ($Box refType |cell#0|)))) (and (|Set#Equal| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) ITER__F.RecursiveIterator.__new)) |Set#Empty|) (= (ITER__F.RecursiveIterator.__decreases0 this@@0) (ite (< (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |cell#0|) ITER__F.Cell.data))) 2) |n#0| (- (+ |n#0| |n#0|) |n#0|)))))) (and (and (and (= (ITER__F.RecursiveIterator.__decreases1 this@@0) (LitInt 0)) (= |_yieldCount#0| 0)) (and (= call1formal@rds@0 (ITER__F.RecursiveIterator.__reads this@@0)) (= call2formal@nw@0 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap this@@0) ITER__F.RecursiveIterator.__new))))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@29 T@U) ($f@@1 T@U) ) (!  (=> (and (or (not (= $o@@29 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@29) alloc)))) (=> (or (or (= $o@@29 this@@0) (|Set#IsMember| call1formal@rds@0 ($Box refType $o@@29))) (|Set#IsMember| call2formal@nw@0 ($Box refType $o@@29))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@29) $f@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@29) $f@@1))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.ITER__F.RecursiveIterator) ($IsAlloc refType this@@0 Tclass.ITER__F.RecursiveIterator $Heap)))) (=> (and (and (and (and ($Is refType |cell#0| Tclass.ITER__F.Cell?) ($IsAlloc refType |cell#0| Tclass.ITER__F.Cell? $Heap)) (<= (LitInt 0) |n#0|)) (and (and ($Is refType |r#0| Tclass.ITER__F.RecIterCaller?) ($IsAlloc refType |r#0| Tclass.ITER__F.RecIterCaller? $Heap)) (and true true))) (and (and (and ($IsGoodHeap $_OldIterHeap) ($HeapSucc $_OldIterHeap $Heap)) true) (and (and (= 0 $FunctionContextHeight) (or (not (= |cell#0| null)) (not true))) (and (or (not (= |r#0| null)) (not true)) (= (ControlFlow 0 14) 13))))) anon0_correct))))
