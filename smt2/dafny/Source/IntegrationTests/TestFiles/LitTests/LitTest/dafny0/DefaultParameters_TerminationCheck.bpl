...
const unique class.TerminationCheck.__default: ClassName;

procedure {:verboseName "TerminationCheck.X (well-formedness)"} CheckWellFormed$$TerminationCheck.__default.X();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TerminationCheck.X (call)"} Call$$TerminationCheck.__default.X();
  modifies $Heap;
  // frame condition
...
procedure {:verboseName "TerminationCheck.X (correctness)"} Impl$$TerminationCheck.__default.X() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
function Tclass.TerminationCheck.R() : Ty
uses {
// Tclass.TerminationCheck.R Tag
axiom Tag(Tclass.TerminationCheck.R()) == Tagclass.TerminationCheck.R
   && TagFamily(Tclass.TerminationCheck.R()) == tytagFamily$R;
}

const unique Tagclass.TerminationCheck.R: TyTag;

// Box/unbox axiom for Tclass.TerminationCheck.R
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.TerminationCheck.R()) } 
  $IsBox(bx, Tclass.TerminationCheck.R())
     ==> $Box($Unbox(bx): DatatypeType) == bx
       && $Is($Unbox(bx): DatatypeType, Tclass.TerminationCheck.R()));

implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TerminationCheck.X (correctness)"} Impl$$TerminationCheck.__default.X() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var r#0: DatatypeType
     where $Is(r#0, Tclass.TerminationCheck.R())
       && $IsAlloc(r#0, Tclass.TerminationCheck.R(), $Heap);
  var f#0: int;
  var ##x#0: int;
  var ##x#1: int;
  var x##0: int;

    // AddMethodImpl: X, Impl$$TerminationCheck.__default.X
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(411,11)
    assume true;
    assume true;
    r#0 := Lit(#TerminationCheck.R.R(LitInt(5)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(412,11)
    assume true;
    ##x#0 := LitInt(5);
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#0, TInt, $Heap);
    assume TerminationCheck.__default.F#canCall(LitInt(5));
    ##x#1 := LitInt(5);
    // assume allocatedness for argument to function
    assume $IsAlloc(##x#1, TInt, $Heap);
    assert {:id "id676"} true;
    assume TerminationCheck.__default.G#canCall(LitInt(5));
    assume TerminationCheck.__default.F#canCall(LitInt(5))
       && TerminationCheck.__default.G#canCall(LitInt(5));
    f#0 := TerminationCheck.__default.F($LS($LZ), LitInt(5))
       + TerminationCheck.__default.G($LS($LZ), LitInt(5));
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(413,6)
    // TrCallStmt: Before ProcessCallStmt
    // ProcessCallStmt: CheckSubrange
    x##0 := LitInt(3);
    assert {:id "id678"} true;
    call {:id "id679"} Call$$TerminationCheck.__default.M(x##0);
    // TrCallStmt: After ProcessCallStmt
}



// function declaration for TerminationCheck._default.F
function TerminationCheck.__default.F($ly: LayerType, x#0: int) : int;

function TerminationCheck.__default.F#canCall(x#0: int) : bool;

// layer synonym axiom
axiom (forall $ly: LayerType, x#0: int :: 
  { TerminationCheck.__default.F($LS($ly), x#0) } 
  TerminationCheck.__default.F($LS($ly), x#0)
     == TerminationCheck.__default.F($ly, x#0));

// fuel synonym axiom
axiom (forall $ly: LayerType, x#0: int :: 
  { TerminationCheck.__default.F(AsFuelBottom($ly), x#0) } 
  TerminationCheck.__default.F($ly, x#0) == TerminationCheck.__default.F($LZ, x#0));

function TerminationCheck.__default.F#requires(LayerType, int) : bool;

// #requires axiom for TerminationCheck.__default.F
axiom (forall $ly: LayerType, x#0: int :: 
  { TerminationCheck.__default.F#requires($ly, x#0) } 
  TerminationCheck.__default.F#requires($ly, x#0) == true);

procedure {:verboseName "TerminationCheck.F (well-formedness)"} CheckWellformed$$TerminationCheck.__default.F(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TerminationCheck.F (well-formedness)"} CheckWellformed$$TerminationCheck.__default.F(x#0: int)
{
...
// function declaration for TerminationCheck._default.G
function TerminationCheck.__default.G($ly: LayerType, x#0: int) : int;

function TerminationCheck.__default.G#canCall(x#0: int) : bool;

// layer synonym axiom
axiom (forall $ly: LayerType, x#0: int :: 
  { TerminationCheck.__default.G($LS($ly), x#0) } 
  TerminationCheck.__default.G($LS($ly), x#0)
     == TerminationCheck.__default.G($ly, x#0));

// fuel synonym axiom
axiom (forall $ly: LayerType, x#0: int :: 
  { TerminationCheck.__default.G(AsFuelBottom($ly), x#0) } 
  TerminationCheck.__default.G($ly, x#0) == TerminationCheck.__default.G($LZ, x#0));

function TerminationCheck.__default.G#requires(LayerType, int) : bool;

// #requires axiom for TerminationCheck.__default.G
axiom (forall $ly: LayerType, x#0: int :: 
  { TerminationCheck.__default.G#requires($ly, x#0) } 
  TerminationCheck.__default.G#requires($ly, x#0) == true);

procedure {:verboseName "TerminationCheck.G (well-formedness)"} CheckWellformed$$TerminationCheck.__default.G(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TerminationCheck.G (well-formedness)"} CheckWellformed$$TerminationCheck.__default.G(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(418,31)
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id681"} false;
    call {:id "id682"} Call$$TerminationCheck.__default.X();
    // TrCallStmt: After ProcessCallStmt
    assume true;
    // Check well-formedness of preconditions, and then assume them
    // Check well-formedness of the reads clause
...
procedure {:verboseName "TerminationCheck.M (well-formedness)"} CheckWellFormed$$TerminationCheck.__default.M(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TerminationCheck.M (well-formedness)"} CheckWellFormed$$TerminationCheck.__default.M(x#0: int)
{
  var $_ModifiesFrame: [ref,Field]bool;


    // AddMethodImpl: M, CheckWellFormed$$TerminationCheck.__default.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(419,22)
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id683"} false;
    call {:id "id684"} Call$$TerminationCheck.__default.X();
    // TrCallStmt: After ProcessCallStmt
    assume true;
    havoc $Heap;
...
procedure {:verboseName "TerminationCheck.M (call)"} Call$$TerminationCheck.__default.M(x#0: int);
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure {:verboseName "TerminationCheck.Caller (well-formedness)"} CheckWellFormed$$TerminationCheck.__default.Caller();
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TerminationCheck.Caller (call)"} Call$$TerminationCheck.__default.Caller();
  modifies $Heap;
...
procedure {:verboseName "TerminationCheck.Caller (correctness)"} Impl$$TerminationCheck.__default.Caller() returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TerminationCheck.Caller (correctness)"} Impl$$TerminationCheck.__default.Caller() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x##0_0: int;
  var z#1_0: int;
  ...
  var z#2_0: int;
  var ##x#2_0: int;
  var z#3_0: DatatypeType
     where $Is(z#3_0, Tclass.TerminationCheck.R())
       && $IsAlloc(z#3_0, Tclass.TerminationCheck.R(), $Heap);

    // AddMethodImpl: Caller, Impl$$TerminationCheck.__default.Caller
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- alternative statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(423,5)
    if (*)
    {
        assume true;
        assume {:id "id692"} true;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(425,13)
        assume true;
        assume true;
        z#3_0 := Lit(#TerminationCheck.R.R(LitInt(3)));
    }
    else if (*)
    {
        assume true;
        assume {:id "id690"} true;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(427,13)
        assume true;
        ##x#2_0 := TerminationCheck.__default.F($LS($LZ), LitInt(5));
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#2_0, TInt, $Heap);
        assume TerminationCheck.__default.F#canCall(TerminationCheck.__default.F($LS($LZ), LitInt(5)));
        assume TerminationCheck.__default.F#canCall(LitInt(5))
           && TerminationCheck.__default.F#canCall(TerminationCheck.__default.F($LS($LZ), LitInt(5)));
        z#2_0 := TerminationCheck.__default.F($LS($LZ), TerminationCheck.__default.F($LS($LZ), LitInt(5)));
    }
    else if (*)
    {
        assume true;
        assume {:id "id688"} true;
        // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(429,13)
        assume true;
        ##x#1_0 := LitInt(3);
        // assume allocatedness for argument to function
        assume $IsAlloc(##x#1_0, TInt, $Heap);
        assume TerminationCheck.__default.G#canCall(LitInt(3));
        assume TerminationCheck.__default.G#canCall(LitInt(3));
        z#1_0 := TerminationCheck.__default.G($LS($LZ), LitInt(3));
    }
    else if (*)
    {
        assume true;
        assume {:id "id686"} true;
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(431,8)
        // TrCallStmt: Before ProcessCallStmt
        // ProcessCallStmt: CheckSubrange
        x##0_0 := LitInt(3);
        call {:id "id687"} Call$$TerminationCheck.__default.M(x##0_0);
        // TrCallStmt: After ProcessCallStmt
    }
    else
    {
...
// Constructor function declaration
function #TerminationCheck.R.R(int) : DatatypeType;

const unique ##TerminationCheck.R.R: DtCtorId
uses {
// Constructor identifier
axiom (forall a#0#0#0: int :: 
  { #TerminationCheck.R.R(a#0#0#0) } 
  DatatypeCtorId(#TerminationCheck.R.R(a#0#0#0)) == ##TerminationCheck.R.R);
}

function TerminationCheck.R.R_q(DatatypeType) : bool;

// Questionmark and identifier
axiom (forall d: DatatypeType :: 
  { TerminationCheck.R.R_q(d) } 
  TerminationCheck.R.R_q(d) <==> DatatypeCtorId(d) == ##TerminationCheck.R.R);

procedure {:verboseName "#TerminationCheck.R.R (well-formedness)"} CheckWellformed$$#TerminationCheck.R.R(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "#TerminationCheck.R.R (well-formedness)"} CheckWellformed$$#TerminationCheck.R.R(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/DefaultParameters.dfy(416,29)
    // TrCallStmt: Before ProcessCallStmt
    assert {:id "id694"} false;
    call {:id "id695"} Call$$TerminationCheck.__default.X();
    // TrCallStmt: After ProcessCallStmt
    assume true;
}
...
axiom (forall d: DatatypeType :: 
  { TerminationCheck.R.R_q(d) } 
  TerminationCheck.R.R_q(d)
     ==> (exists a#0#0#0: int :: d == #TerminationCheck.R.R(a#0#0#0)));

// Constructor $Is
axiom (forall a#1#0#0: int :: 
  { $Is(#TerminationCheck.R.R(a#1#0#0), Tclass.TerminationCheck.R()) } 
  $Is(#TerminationCheck.R.R(a#1#0#0), Tclass.TerminationCheck.R())
     <==> $Is(a#1#0#0, TInt));

// Destructor $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(TerminationCheck.R.x(d), TInt, $h) } 
  $IsGoodHeap($h)
       && 
      TerminationCheck.R.R_q(d)
       && $IsAlloc(d, Tclass.TerminationCheck.R(), $h)
     ==> $IsAlloc(TerminationCheck.R.x(d), TInt, $h));

// Constructor literal
axiom (forall a#2#0#0: int :: 
  { #TerminationCheck.R.R(LitInt(a#2#0#0)) } 
  #TerminationCheck.R.R(LitInt(a#2#0#0)) == Lit(#TerminationCheck.R.R(a#2#0#0)));

function TerminationCheck.R.x(DatatypeType) : int;

// Constructor injectivity
axiom (forall a#3#0#0: int :: 
  { #TerminationCheck.R.R(a#3#0#0) } 
  TerminationCheck.R.x(#TerminationCheck.R.R(a#3#0#0)) == a#3#0#0);

// Datatype $IsAlloc
axiom (forall d: DatatypeType, $h: Heap :: 
  { $IsAlloc(d, Tclass.TerminationCheck.R(), $h) } 
  $IsGoodHeap($h) && $Is(d, Tclass.TerminationCheck.R())
     ==> $IsAlloc(d, Tclass.TerminationCheck.R(), $h));

// Depth-one case-split function
function $IsA#TerminationCheck.R(DatatypeType) : bool;

// Depth-one case-split axiom
axiom (forall d: DatatypeType :: 
  { $IsA#TerminationCheck.R(d) } 
  $IsA#TerminationCheck.R(d) ==> TerminationCheck.R.R_q(d));

// Questionmark data type disjunctivity
axiom (forall d: DatatypeType :: 
  { TerminationCheck.R.R_q(d), $Is(d, Tclass.TerminationCheck.R()) } 
  $Is(d, Tclass.TerminationCheck.R()) ==> TerminationCheck.R.R_q(d));

// Datatype extensional equality declaration
function TerminationCheck.R#Equal(DatatypeType, DatatypeType) : bool;

// Datatype extensional equality definition: #TerminationCheck.R.R
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { TerminationCheck.R#Equal(a, b) } 
  TerminationCheck.R#Equal(a, b)
     <==> TerminationCheck.R.x(a) == TerminationCheck.R.x(b));

// Datatype extensionality axiom: TerminationCheck.R
axiom (forall a: DatatypeType, b: DatatypeType :: 
  { TerminationCheck.R#Equal(a, b) } 
  TerminationCheck.R#Equal(a, b) <==> a == b);

const unique class.TerminationCheck.R: ClassName;
