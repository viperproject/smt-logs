...
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.AnotherNode?) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) Tclass._module.AnotherNode?)))
 :qid |unknown.0:0|
 :skolemid |2591|
 :pattern ( ($IsBox bx@@1 Tclass._module.AnotherNode?))
)))
...
(assert (forall ((d@@5 T@U) (_module.List$T@@5 T@U) ($h@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@6) (and (_module.List.Cons_q d@@5) ($IsAlloc DatatypeTypeType d@@5 (Tclass._module.List _module.List$T@@5) $h@@6))) ($IsAllocBox (_module.List._h0 d@@5) _module.List$T@@5 $h@@6))
 :qid |unknown.0:0|
 :skolemid |2557|
 :pattern ( ($IsAllocBox (_module.List._h0 d@@5) _module.List$T@@5 $h@@6))
)))
...
(assert (forall (($ly@@1 T@U) ($h0 T@U) ($h1 T@U) (this@@1 T@U) (|n#0@@1| T@U) (|list#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.AnotherNode) ($IsAlloc refType this@@1 Tclass._module.AnotherNode $h0)))) (or (|_module.AnotherNode.Repr#canCall| $h0 this@@1 |n#0@@1| |list#0@@1|) (and (and ($Is refType |n#0@@1| Tclass._module.AnotherNode?) ($IsAlloc refType |n#0@@1| Tclass._module.AnotherNode? $h0)) (and ($Is DatatypeTypeType |list#0@@1| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |list#0@@1| (Tclass._module.List TInt) $h0))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@6) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |2600|
)) (= (_module.AnotherNode.Repr $ly@@1 $h0 this@@1 |n#0@@1| |list#0@@1|) (_module.AnotherNode.Repr $ly@@1 $h1 this@@1 |n#0@@1| |list#0@@1|))))
 :qid |unknown.0:0|
 :skolemid |2601|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (_module.AnotherNode.Repr $ly@@1 $h1 this@@1 |n#0@@1| |list#0@@1|))
)))
...
(assert (forall ((d@@7 T@U) (_module.List$T@@7 T@U) ($h@@7 T@U) ) (!  (=> (and ($IsGoodHeap $h@@7) (and (_module.List.Cons_q d@@7) ($IsAlloc DatatypeTypeType d@@7 (Tclass._module.List _module.List$T@@7) $h@@7))) ($IsAlloc DatatypeTypeType (_module.List._h1 d@@7) (Tclass._module.List _module.List$T@@7) $h@@7))
 :qid |unknown.0:0|
 :skolemid |2558|
 :pattern ( ($IsAlloc DatatypeTypeType (_module.List._h1 d@@7) (Tclass._module.List _module.List$T@@7) $h@@7))
)))
...
(declare-fun |n#0@@2| () T@U)
(declare-fun this@@2 () T@U)
(declare-fun |L#0| () T@U)
(declare-fun $LZ () T@U)
(declare-fun |defass#r#0| () Bool)
(declare-fun |r#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.AnotherNode.Add)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 13) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@1 alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.AnotherNode?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 2) (- 0 12)) true) (and (=> (= (ControlFlow 0 2) (- 0 11)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 10)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.AnotherNode.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.AnotherNode.data)) (=> (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) _module.AnotherNode.data ($Box intType (int_2_U |d#0@@0|))))) ($IsGoodHeap $Heap@1)) (and (=> (= (ControlFlow 0 2) (- 0 9)) true) (and (=> (= (ControlFlow 0 2) (- 0 8)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 7)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.AnotherNode.next))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 $nw@0 _module.AnotherNode.next)) (=> (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 $nw@0) _module.AnotherNode.next ($Box refType |n#0@@2|)))) ($IsGoodHeap $Heap@2)) (and (=> (= (ControlFlow 0 2) (- 0 6)) true) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.AnotherNode.Repr#canCall| $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.AnotherNode.Repr ($LS $LZ) $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (= $nw@0 null))))) (=> (=> (|_module.AnotherNode.Repr#canCall| $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.AnotherNode.Repr ($LS $LZ) $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (= $nw@0 null)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.AnotherNode.Repr#canCall| $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.AnotherNode.Repr ($LS $LZ) $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (or (not (= $nw@0 null)) (not true)))))) (=> (=> (|_module.AnotherNode.Repr#canCall| $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.AnotherNode.Repr ($LS $LZ) $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (or (not (= $nw@0 null)) (not true))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.AnotherNode.Repr#canCall| $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.AnotherNode.Repr ($LS $LZ) $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (let ((|d#7| (U_2_int ($Unbox intType (_module.List._h0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))))))
(= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.AnotherNode.data))) |d#7|)))))) (=> (=> (|_module.AnotherNode.Repr#canCall| $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.AnotherNode.Repr ($LS $LZ) $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (let ((|d#7@@0| (U_2_int ($Unbox intType (_module.List._h0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))))))
(= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.AnotherNode.data))) |d#7@@0|))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.AnotherNode.Repr#canCall| $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (or (_module.AnotherNode.Repr ($LS $LZ) $Heap@2 this@@2 $nw@0 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|)) (=> (not (_module.List.Nil_q (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))) (let ((|cdr#6| (_module.List._h1 (|#_module.List.Cons| ($Box intType (int_2_U |d#0@@0|)) |L#0|))))
(_module.AnotherNode.Repr ($LS ($LS $LZ)) $Heap@2 this@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@2 $nw@0) _module.AnotherNode.next)) |cdr#6|))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.AnotherNode) ($IsAlloc refType this@@2 Tclass._module.AnotherNode $Heap@@1))) (and ($Is refType |n#0@@2| Tclass._module.AnotherNode) ($IsAlloc refType |n#0@@2| Tclass._module.AnotherNode $Heap@@1))) (=> (and (and (and (and ($Is DatatypeTypeType |L#0| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |L#0| (Tclass._module.List TInt) $Heap@@1)) (|$IsA#_module.List| |L#0|)) (and (=> |defass#r#0| (and ($Is refType |r#0| Tclass._module.AnotherNode) ($IsAlloc refType |r#0| Tclass._module.AnotherNode $Heap@@1))) (= 2 $FunctionContextHeight))) (and (and (|_module.AnotherNode.Repr#canCall| $Heap@@1 this@@2 |n#0@@2| |L#0|) (and (_module.AnotherNode.Repr ($LS $LZ) $Heap@@1 this@@2 |n#0@@2| |L#0|) (ite (_module.List.Nil_q |L#0|) (= |n#0@@2| null) (let ((|cdr#5| (_module.List._h1 |L#0|)))
(let ((|d#6| (U_2_int ($Unbox intType (_module.List._h0 |L#0|)))))
 (and (and (or (not (= |n#0@@2| null)) (not true)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |n#0@@2|) _module.AnotherNode.data))) |d#6|)) (_module.AnotherNode.Repr ($LS $LZ) $Heap@@1 this@@2 ($Unbox refType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |n#0@@2|) _module.AnotherNode.next)) |cdr#5|))))))) (= (ControlFlow 0 13) 2))) anon0_correct)))))
