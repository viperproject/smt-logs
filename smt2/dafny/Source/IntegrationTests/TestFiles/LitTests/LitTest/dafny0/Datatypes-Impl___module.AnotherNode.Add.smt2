...
(assert (forall (($ly@@1 T@U) ($h0 T@U) ($h1 T@U) (this@@1 T@U) (|n#0@@1| T@U) (|list#0@@1| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.AnotherNode) ($IsAlloc refType this@@1 Tclass._module.AnotherNode $h0)))) (or (|_module.AnotherNode.Repr#canCall| $h0 this@@1 |n#0@@1| |list#0@@1|) (and (and ($Is refType |n#0@@1| Tclass._module.AnotherNode?) ($IsAlloc refType |n#0@@1| Tclass._module.AnotherNode? $h0)) (and ($Is DatatypeTypeType |list#0@@1| (Tclass._module.List TInt)) ($IsAlloc DatatypeTypeType |list#0@@1| (Tclass._module.List TInt) $h0))))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@6 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) alloc)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@6) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@6) $f@@0)))) (= (_module.AnotherNode.Repr $ly@@1 $h0 this@@1 |n#0@@1| |list#0@@1|) (_module.AnotherNode.Repr $ly@@1 $h1 this@@1 |n#0@@1| |list#0@@1|))))
