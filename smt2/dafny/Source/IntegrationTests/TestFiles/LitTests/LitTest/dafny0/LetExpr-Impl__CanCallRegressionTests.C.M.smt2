...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon4_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (and ($Is refType this@@6 Tclass.CanCallRegressionTests.C) (= this@@6 this@@6)) (or (and ($Is refType null Tclass.CanCallRegressionTests.C) (= null this@@6)) (exists ((|c#2| T@U) )  (and ($Is refType |c#2| Tclass.CanCallRegressionTests.C) (= |c#2| this@@6)))))) (=> (or (and ($Is refType this@@6 Tclass.CanCallRegressionTests.C) (= this@@6 this@@6)) (or (and ($Is refType null Tclass.CanCallRegressionTests.C) (= null this@@6)) (exists ((|c#2@@0| T@U) )  (and ($Is refType |c#2@@0| Tclass.CanCallRegressionTests.C) (= |c#2@@0| this@@6))))) (=> (and (and (and ($Is refType |c#3@0| Tclass.CanCallRegressionTests.C) ($IsAlloc refType |c#3@0| Tclass.CanCallRegressionTests.C $Heap@@0)) (= |c#3@0| this@@6)) (and (and ($Is refType |c#4@0| Tclass.CanCallRegressionTests.C) ($IsAlloc refType |c#4@0| Tclass.CanCallRegressionTests.C $Heap@@0)) (= |c#4@0| this@@6))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |c#3@0| |c#4@0|)) (=> (= |c#3@0| |c#4@0|) (=> (and (|$let#1$canCall| this@@6) (= (ControlFlow 0 2) (- 0 1))) (or (not (= (let ((|c#2@@1| (|$let#1_c| this@@6)))
|c#2@@1|) null)) (not true))))))))))
...
(let ((anon2_correct  (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (and ($Is refType this@@6 Tclass.CanCallRegressionTests.C) (= this@@6 this@@6)) (or (and ($Is refType null Tclass.CanCallRegressionTests.C) (= null this@@6)) (exists ((|c#1| T@U) )  (and ($Is refType |c#1| Tclass.CanCallRegressionTests.C) (= |c#1| this@@6)))))) (=> (or (and ($Is refType this@@6 Tclass.CanCallRegressionTests.C) (= this@@6 this@@6)) (or (and ($Is refType null Tclass.CanCallRegressionTests.C) (= null this@@6)) (exists ((|c#1@@0| T@U) )  (and ($Is refType |c#1@@0| Tclass.CanCallRegressionTests.C) (= |c#1@@0| this@@6))))) (=> (and (and (and ($Is refType |c#0@0| Tclass.CanCallRegressionTests.C) ($IsAlloc refType |c#0@0| Tclass.CanCallRegressionTests.C $Heap@@0)) (= |c#0@0| this@@6)) (and (|$let#0$canCall| this@@6) (|$let#0$canCall| this@@6))) (and (=> (= (ControlFlow 0 7) (- 0 8)) (= (let ((|c#1@@1| (|$let#0_c| this@@6)))
