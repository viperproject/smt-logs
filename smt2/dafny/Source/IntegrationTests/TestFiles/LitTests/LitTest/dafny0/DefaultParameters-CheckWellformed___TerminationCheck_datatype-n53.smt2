...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let (($generated@@103  (=> (and (= $generated@@96 ($generated@@35 $generated@@97 $generated@@98 $generated false)) (= (ControlFlow 0 2) (- 0 3))) false)))
(let (($generated@@104  (=> (and (and (and ($generated@@99 $generated@@98) ($generated@@100 $generated@@98)) (<= ($generated@@18 0) $generated@@101)) (and (= 0 $generated@@102) (= (ControlFlow 0 4) 2))) $generated@@103)))
$generated@@104)))
))
(check-sat)
