...
(assert (forall (($prevHeap@@0 T@U) ($h0 T@U) ($h1 T@U) (|x#0@@2| Int) (|c#0@@2| T@U) (|d#0@@0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|M1.__default.F#canCall| $prevHeap@@0 $h0 |x#0@@2| |c#0@@2| |d#0@@0|) (and ($Is refType |c#0@@2| Tclass.M1.C) ($Is refType |d#0@@0| Tclass.M1.C)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@4 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@4 null)) (not true)) (or (= $o@@4 |c#0@@2|) (= $o@@4 |d#0@@0|))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@4) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@4) $f@@0)))) (= (M1.__default.F $prevHeap@@0 $h0 |x#0@@2| |c#0@@2| |d#0@@0|) (M1.__default.F $prevHeap@@0 $h1 |x#0@@2| |c#0@@2| |d#0@@0|))))
