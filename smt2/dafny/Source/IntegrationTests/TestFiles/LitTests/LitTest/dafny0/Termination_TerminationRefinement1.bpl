...
procedure {:verboseName "TerminationRefinement1.M (well-formedness)"} CheckWellFormed$$TerminationRefinement1.__default.M(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "TerminationRefinement1.M (call)"} Call$$TerminationRefinement1.__default.M(x#0: int);
  modifies $Heap;
...
procedure {:verboseName "TerminationRefinement1.M (correctness)"} Impl$$TerminationRefinement1.__default.M(x#0: int) returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "TerminationRefinement1.M (correctness)"} Impl$$TerminationRefinement1.__default.M(x#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x##0: int;

    // AddMethodImpl: M, Impl$$TerminationRefinement1.__default.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Termination.dfy[TerminationRefinement1](441,6)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := x#0;
    assert {:id "id35"} 0 <= LitInt(4) || LitInt(4) == LitInt(4);
    assert {:id "id36"} LitInt(4) < LitInt(4);
    call {:id "id37"} Call$$TerminationRefinement1.__default.M(x##0);
