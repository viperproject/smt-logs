...
(declare-fun $Heap@0 () T@U)
(set-info :boogie-vc-id CheckWellFormed$$Basic.U.AThis)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap@@0 alloc this@@1)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (forall (($o@@5 T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@5) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@5) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@5)) (= $o@@5 this@@1)))
 :qid |TwostateFunctionsdfy.72:12|
 :skolemid |650|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@5))
)) ($HeapSucc $Heap@@0 $Heap@0)) (and ($IsAllocBox ($Box refType this@@1) Tclass.Basic.U? $Heap@0) (= (ControlFlow 0 2) (- 0 1)))) ($IsAlloc refType this@@1 Tclass.Basic.U $Heap@@0))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.Basic.U) ($IsAlloc refType this@@1 Tclass.Basic.U $Heap@@0))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
