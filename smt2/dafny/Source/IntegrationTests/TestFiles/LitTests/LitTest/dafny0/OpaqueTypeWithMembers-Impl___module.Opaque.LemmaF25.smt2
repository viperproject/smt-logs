...
(declare-fun |n#0| () Int)
(set-info :boogie-vc-id Impl$$_module.Opaque.LemmaF25)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |zz#0@0| (+ (_module.Opaque.z this@@0) (_module.Opaque.y this@@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (- |zz#0@0| (_module.Opaque.y this@@0)) (LitInt 25))) (=> (= (- |zz#0@0| (_module.Opaque.y this@@0)) (LitInt 25)) (=> (= (ControlFlow 0 2) (- 0 1)) (= (_module.Opaque.z this@@0) (LitInt 25))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($IsBox this@@0 Tclass._module.Opaque) ($IsAllocBox this@@0 Tclass._module.Opaque $Heap)) (<= (LitInt 0) |n#0|)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 4) 2))) anon0_correct))))
