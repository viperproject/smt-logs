...
(declare-fun TestModule8.__default.parse__Request2 (T@U) T@U)
(declare-fun |TestModule8.__default.parse__Request2#canCall| (T@U) Bool)
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|val#0@@1| T@U) ) (!  (=> (or (|TestModule8.__default.parse__Request2#canCall| |val#0@@1|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |val#0@@1| Tclass.TestModule8.V) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@1| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar))))) ($Is DatatypeTypeType (TestModule8.__default.parse__Request2 |val#0@@1|) Tclass.TestModule8.CRequest))
 :qid |Fuellegacydfy.341:33|
 :skolemid |6002|
 :pattern ( (TestModule8.__default.parse__Request2 |val#0@@1|))
))))
...
(assert  (=> (<= 2 $FunctionContextHeight) (=> (or |TestModule8.__default.CRequest__grammar#canCall| (< 2 $FunctionContextHeight)) (and (and |TestModule8.__default.EndPoint__grammar#canCall| |TestModule8.__default.CAppMessage__grammar#canCall|) (= TestModule8.__default.CRequest__grammar (Lit DatatypeTypeType (|#TestModule8.G.GTaggedUnion| (Lit SeqType (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType (|#TestModule8.G.GTuple| (Lit SeqType (|Seq#Build| (|Seq#Build| (|Seq#Build| |Seq#Empty| ($Box DatatypeTypeType (Lit DatatypeTypeType TestModule8.__default.EndPoint__grammar))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#TestModule8.G.GUint64|))) ($Box DatatypeTypeType (Lit DatatypeTypeType TestModule8.__default.CAppMessage__grammar)))))))) ($Box DatatypeTypeType (Lit DatatypeTypeType |#TestModule8.G.GUint64|)))))))))))
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|val#0@@2| T@U) ) (!  (=> (or (|TestModule8.__default.parse__Request2#canCall| (Lit DatatypeTypeType |val#0@@2|)) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |val#0@@2| Tclass.TestModule8.V) (U_2_bool (Lit boolType (bool_2_U (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar (Lit DatatypeTypeType |val#0@@2|) (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar)))))))) (and (=> (= (LitInt (TestModule8.V.c (Lit DatatypeTypeType |val#0@@2|))) (LitInt 0)) (and (|TestModule8.__default.parse__EndPoint#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 0)))) (|TestModule8.__default.parse__AppMessage#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 2)))))) (= (TestModule8.__default.parse__Request2 (Lit DatatypeTypeType |val#0@@2|)) (ite (= (LitInt (TestModule8.V.c (Lit DatatypeTypeType |val#0@@2|))) (LitInt 0)) (let ((|ep#1| (TestModule8.__default.parse__EndPoint ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 0))))))
(|#TestModule8.CRequest.CRequest| |ep#1| (TestModule8.V.u ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 1)))) (TestModule8.__default.parse__AppMessage ($Unbox DatatypeTypeType (|Seq#Index| (Lit SeqType (TestModule8.V.t (Lit DatatypeTypeType (TestModule8.V.val (Lit DatatypeTypeType |val#0@@2|))))) (LitInt 2)))))) |#TestModule8.CRequest.CRequestNoOp|))))
 ...
 :weight 3
 :skolemid |6006|
 :pattern ( (TestModule8.__default.parse__Request2 (Lit DatatypeTypeType |val#0@@2|)))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall ((|val#0@@3| T@U) ) (!  (=> (or (|TestModule8.__default.parse__Request2#canCall| |val#0@@3|) (and (< 4 $FunctionContextHeight) (and ($Is DatatypeTypeType |val#0@@3| Tclass.TestModule8.V) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@3| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar))))) (and (=> (= (TestModule8.V.c |val#0@@3|) (LitInt 0)) (and (|TestModule8.__default.parse__EndPoint#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 0)))) (|TestModule8.__default.parse__AppMessage#canCall| ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 2)))))) (= (TestModule8.__default.parse__Request2 |val#0@@3|) (ite (= (TestModule8.V.c |val#0@@3|) (LitInt 0)) (let ((|ep#0| (TestModule8.__default.parse__EndPoint ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 0))))))
(|#TestModule8.CRequest.CRequest| |ep#0| (TestModule8.V.u ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 1)))) (TestModule8.__default.parse__AppMessage ($Unbox DatatypeTypeType (|Seq#Index| (TestModule8.V.t (TestModule8.V.val |val#0@@3|)) (LitInt 2)))))) |#TestModule8.CRequest.CRequestNoOp|))))
 :qid |Fuellegacydfy.341:33|
 :skolemid |6005|
 :pattern ( (TestModule8.__default.parse__Request2 |val#0@@3|))
))))
...
(assert  (=> (<= 4 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|val#0@@6| T@U) ) (!  (=> (and (or (|TestModule8.__default.parse__Request2#canCall| |val#0@@6|) (and (< 4 $FunctionContextHeight) (and (and ($Is DatatypeTypeType |val#0@@6| Tclass.TestModule8.V) ($IsAlloc DatatypeTypeType |val#0@@6| Tclass.TestModule8.V $Heap@@1)) (TestModule8.__default.ValInGrammar StartFuelAssert_TestModule8._default.ValInGrammar |val#0@@6| (Lit DatatypeTypeType TestModule8.__default.CRequest__grammar))))) ($IsGoodHeap $Heap@@1)) ($IsAlloc DatatypeTypeType (TestModule8.__default.parse__Request2 |val#0@@6|) Tclass.TestModule8.CRequest $Heap@@1))
 :qid |Fuellegacydfy.341:18|
 :skolemid |6003|
 :pattern ( ($IsAlloc DatatypeTypeType (TestModule8.__default.parse__Request2 |val#0@@6|) Tclass.TestModule8.CRequest $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$TestModule8.__default.parse__Request2)
