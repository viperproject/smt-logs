...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let (($generated@@184  (=> (= $generated@@180 ($generated@@139 $generated@@33 $generated@@181 $generated false)) (and (=> (= (ControlFlow 0 2) (- 0 5)) $generated@@182) (=> $generated@@182 (and (=> (= (ControlFlow 0 2) (- 0 4)) true) (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) true))))))))
(let (($generated@@185  (=> (and (and ($generated@@32 $generated@@181) ($generated@@183 $generated@@181)) (and (= 1 $generated@@85) (= (ControlFlow 0 6) 2))) $generated@@184)))
$generated@@185)))
))
(check-sat)
