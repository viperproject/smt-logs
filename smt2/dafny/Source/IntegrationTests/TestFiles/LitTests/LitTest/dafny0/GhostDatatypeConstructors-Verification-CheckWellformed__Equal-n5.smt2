...
(declare-fun EqualitySupport.Enum.Q (T@U) Bool)
(declare-fun |EqualitySupport.Enum.Q#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this T@U) ) (!  (=> (or (|EqualitySupport.Enum.Q#canCall| this) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this Tclass.EqualitySupport.Enum) (EqualitySupport.Enum.EnumB_q this)))) (and (|$IsA#EqualitySupport.Enum| this) (= (EqualitySupport.Enum.Q this)  (not (|EqualitySupport.Enum#Equal| this |#EqualitySupport.Enum.EnumB|)))))
 :qid |GhostDatatypeConstructorsVerificationdfy.189:15|
 :skolemid |2702|
 :pattern ( (EqualitySupport.Enum.Q this))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@0 T@U) ) (!  (=> (or (|EqualitySupport.Enum.Q#canCall| (Lit DatatypeTypeType this@@0)) (and (< 1 $FunctionContextHeight) (and ($Is DatatypeTypeType this@@0 Tclass.EqualitySupport.Enum) (U_2_bool (Lit boolType (bool_2_U (EqualitySupport.Enum.EnumB_q (Lit DatatypeTypeType this@@0)))))))) (and (|$IsA#EqualitySupport.Enum| (Lit DatatypeTypeType this@@0)) (= (EqualitySupport.Enum.Q (Lit DatatypeTypeType this@@0))  (not (|EqualitySupport.Enum#Equal| this@@0 |#EqualitySupport.Enum.EnumB|)))))
 :qid |GhostDatatypeConstructorsVerificationdfy.189:15|
 :weight 3
 :skolemid |2703|
 :pattern ( (EqualitySupport.Enum.Q (Lit DatatypeTypeType this@@0)))
))))
...
(set-info :boogie-vc-id CheckWellformed$$EqualitySupport.Enum.Q)
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap alloc false)) (EqualitySupport.Enum.EnumB_q this@@1)) (and (=> (= (ControlFlow 0 5) 1) anon5_Then_correct) (=> (= (ControlFlow 0 5) 3) anon5_Else_correct)))))
