...
(set-info :boogie-vc-id Impl$$_module.__default.Nested)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (|_System.Tuple2#Equal| (|#_System._tuple#2._#Make2| ($Box boolType (Lit boolType (bool_2_U true))) ($Box boolType (bool_2_U  (and (not (U_2_bool (Lit boolType (bool_2_U false)))) (U_2_bool (Lit boolType (bool_2_U true))))))) (|#_System._tuple#2._#Make2| ($Box boolType (Lit boolType (bool_2_U true))) ($Box boolType (Lit boolType (bool_2_U true))))))))
