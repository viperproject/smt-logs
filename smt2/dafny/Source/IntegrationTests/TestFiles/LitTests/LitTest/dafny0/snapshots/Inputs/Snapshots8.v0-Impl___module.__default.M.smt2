...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (< |x#0| 20) (<= (LitInt 10) |x#0|))) (=> (or (< |x#0| 20) (<= (LitInt 10) |x#0|)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< |x#0| 10)) (=> (< |x#0| 10) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitInt 0) |x#0|))))))))
(let ((anon3_Else_correct  (=> (and (< |x#0| 20) (= (ControlFlow 0 6) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (<= 20 |x#0|) (= (ControlFlow 0 5) 2)) anon2_correct)))
