...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let (($generated@@103  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (< $generated@@96 20) (<= ($generated@@46 10) $generated@@96))) (=> (or (< $generated@@96 20) (<= ($generated@@46 10) $generated@@96)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (< $generated@@96 10)) (=> (< $generated@@96 10) (=> (= (ControlFlow 0 2) (- 0 1)) (<= ($generated@@46 0) $generated@@96))))))))
(let (($generated@@104  (=> (and (< $generated@@96 20) (= (ControlFlow 0 6) 2)) $generated@@103)))
(let (($generated@@105  (=> (and (<= 20 $generated@@96) (= (ControlFlow 0 5) 2)) $generated@@103)))
(let (($generated@@106  (=> (= $generated@@97 ($generated@@60 $generated@@98 $generated@@99 $generated@@5 false)) (and (=> (= (ControlFlow 0 7) 5) $generated@@105) (=> (= (ControlFlow 0 7) 6) $generated@@104)))))
(let (($generated@@107  (=> (and (and ($generated@@100 $generated@@99) ($generated@@101 $generated@@99)) (and (= 1 $generated@@102) (= (ControlFlow 0 8) 7))) $generated@@106)))
$generated@@107))))))
))
(check-sat)
