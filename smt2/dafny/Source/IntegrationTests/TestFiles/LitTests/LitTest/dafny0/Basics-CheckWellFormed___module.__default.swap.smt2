...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@1 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#12| |l#0| |l#1| |l#2| |l#3|) $o@@1 $f))  (=> (and (or (not (= $o@@1 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@1) |l#2|)))) (= $o@@1 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |2986|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#12| |l#0| |l#1| |l#2| |l#3|) $o@@1 $f))
)))
...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.swap)
...
(let ((anon3_correct  (=> (and (<= (LitInt 0) |i#0|) (< |i#0| (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 5) 2) anon7_Then_correct) (=> (= (ControlFlow 0 5) 4) anon7_Else_correct)))))
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#12| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 9) 6) anon6_Then_correct) (=> (= (ControlFlow 0 9) 8) anon6_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (and (and (<= (LitInt 0) |i#0|) (<= (LitInt 0) |j#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 9)))) anon0_correct)))
