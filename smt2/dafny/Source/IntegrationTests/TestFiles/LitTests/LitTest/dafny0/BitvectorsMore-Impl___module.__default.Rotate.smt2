...
(set-info :boogie-vc-id Impl$$_module.__default.Rotate)
...
(let ((anon5_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= 0 |x#0|)) (=> (<= 0 |x#0|) (=> (= (ControlFlow 0 5) (- 0 4)) (<= |x#0| 5))))))
(let ((anon4_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 |x#0|)) (=> (<= 0 |x#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (<= |x#0| 5))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |x#0|)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 9))) anon0_correct)))
