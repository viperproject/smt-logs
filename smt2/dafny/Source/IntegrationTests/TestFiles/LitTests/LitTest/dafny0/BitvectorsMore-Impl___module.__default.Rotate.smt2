...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let (($generated@@96  (=> (and (and (not ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 true)))) (not ($generated@@5 ($generated@@17 $generated@@1 ($generated@@4 true))))) (= (ControlFlow 0 8) (- 0 7))) false)))
(let (($generated@@97  (and (=> (= (ControlFlow 0 5) (- 0 6)) (<= 0 $generated@@88)) (=> (<= 0 $generated@@88) (=> (= (ControlFlow 0 5) (- 0 4)) (<= $generated@@88 5))))))
(let (($generated@@98  (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 $generated@@88)) (=> (<= 0 $generated@@88) (=> (= (ControlFlow 0 2) (- 0 1)) (<= $generated@@88 5))))))
(let (($generated@@99  (=> (= $generated@@89 ($generated@@29 $generated@@90 $generated@@91 $generated@@92 false)) (and (and (=> (= (ControlFlow 0 9) 2) $generated@@98) (=> (= (ControlFlow 0 9) 5) $generated@@97)) (=> (= (ControlFlow 0 9) 8) $generated@@96)))))
(let (($generated@@100  (=> (and (and (and ($generated@@93 $generated@@91) ($generated@@94 $generated@@91)) (<= ($generated 0) $generated@@88)) (and (= 0 $generated@@95) (= (ControlFlow 0 10) 9))) $generated@@99)))
$generated@@100))))))
))
(check-sat)
