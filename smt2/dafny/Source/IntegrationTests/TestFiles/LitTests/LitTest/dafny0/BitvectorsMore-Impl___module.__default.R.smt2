...
(declare-fun |x#0| () (_ BitVec 60))
(declare-fun |y#0| () (_ BitVec 60))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |$rhs#0@0| (bvult |x#0| |y#0|)) (= |$rhs#1@0| (bvugt |y#0| |x#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= |$rhs#0@0| |$rhs#1@0|)) (=> (= |$rhs#0@0| |$rhs#1@0|) (=> (= |$rhs#2@0| (bvule |x#0| |y#0|)) (=> (and (= |$rhs#3@0| (bvuge |y#0| |x#0|)) (= (ControlFlow 0 2) (- 0 1))) (= |$rhs#2@0| |$rhs#3@0|)))))))))
