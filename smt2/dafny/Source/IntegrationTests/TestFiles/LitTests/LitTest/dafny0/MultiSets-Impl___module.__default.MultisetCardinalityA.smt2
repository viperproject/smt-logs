...
(set-info :boogie-vc-id Impl$$_module.__default.MultisetCardinalityA)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MultiSetType |s#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |s#0| (TMultiSet TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (not (|MultiSet#Equal| |s#0| |MultiSet#Empty|)) (= (ControlFlow 0 16) 15))) anon0_correct))))
