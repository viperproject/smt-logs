...
(assert (forall ((TwoStateAt.Cell.Plus$Y@@1 T@U) ($prevHeap@@2 T@U) ($self@@0 T@U) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) ) (! (= (TwoStateAt.Cell.Plus TwoStateAt.Cell.Plus$Y@@1 $prevHeap@@2 $heap@@0 $self@@0 |$fh$0x#0@@0|) (U_2_int ($Unbox intType (Apply1 TwoStateAt.Cell.Plus$Y@@1 TInt $heap@@0 (|TwoStateAt.Cell.Plus#Handle| TwoStateAt.Cell.Plus$Y@@1 $prevHeap@@2 $self@@0) |$fh$0x#0@@0|))))
 :qid |unknown.0:0|
 :skolemid |688|
 :pattern ( (TwoStateAt.Cell.Plus TwoStateAt.Cell.Plus$Y@@1 $prevHeap@@2 $heap@@0 $self@@0 |$fh$0x#0@@0|))
)))
...
(assert (forall (($o@@1 T@U) ) (! (= ($Is refType $o@@1 Tclass.TwoStateAt.Cell?)  (or (= $o@@1 null) (= (dtype $o@@1) Tclass.TwoStateAt.Cell?)))
 :qid |unknown.0:0|
 :skolemid |796|
 :pattern ( ($Is refType $o@@1 Tclass.TwoStateAt.Cell?))
)))
...
(assert (forall (($o@@2 T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass.TwoStateAt.Cell? $h@@0)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@0 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |797|
 :pattern ( ($IsAlloc refType $o@@2 Tclass.TwoStateAt.Cell? $h@@0))
)))
...
(assert (forall (($bx T@U) (TwoStateAt.Cell.Plus$Y@@2 T@U) ($prevHeap@@3 T@U) ($self@@1 T@U) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) ) (! (= (|Set#IsMember| (Reads1 TwoStateAt.Cell.Plus$Y@@2 TInt $heap@@1 (|TwoStateAt.Cell.Plus#Handle| TwoStateAt.Cell.Plus$Y@@2 $prevHeap@@3 $self@@1) |$fh$0x#0@@1|) $bx) (= ($Unbox refType $bx) $self@@1))
 :qid |unknown.0:0|
 :skolemid |687|
 :pattern ( (|Set#IsMember| (Reads1 TwoStateAt.Cell.Plus$Y@@2 TInt $heap@@1 (|TwoStateAt.Cell.Plus#Handle| TwoStateAt.Cell.Plus$Y@@2 $prevHeap@@3 $self@@1) |$fh$0x#0@@1|) $bx))
)))
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((TwoStateAt.Cell.Plus$Y@@3 T@U) ($prevHeap@@4 T@U) ($Heap T@U) (this@@0 T@U) (|y#0@@1| T@U) ) (!  (=> (or (|TwoStateAt.Cell.Plus#canCall| TwoStateAt.Cell.Plus$Y@@3 $prevHeap@@4 $Heap this@@0 |y#0@@1|) (and (< 2 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@4) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@4 $Heap)) (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.TwoStateAt.Cell) ($IsAlloc refType this@@0 Tclass.TwoStateAt.Cell $prevHeap@@4)))) ($IsBox |y#0@@1| TwoStateAt.Cell.Plus$Y@@3)))) (and (|TwoStateAt.__default.SP#canCall| TwoStateAt.Cell.Plus$Y@@3 $prevHeap@@4 $Heap this@@0 |y#0@@1|) (= (TwoStateAt.Cell.Plus TwoStateAt.Cell.Plus$Y@@3 $prevHeap@@4 $Heap this@@0 |y#0@@1|) (TwoStateAt.__default.SP TwoStateAt.Cell.Plus$Y@@3 $prevHeap@@4 $Heap this@@0 |y#0@@1|))))
 :qid |unknown.0:0|
 :skolemid |813|
 :pattern ( (TwoStateAt.Cell.Plus TwoStateAt.Cell.Plus$Y@@3 $prevHeap@@4 $Heap this@@0 |y#0@@1|) ($IsGoodHeap $Heap))
))))
...
(assert (forall (($h@@1 T@U) ($o@@3 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@1) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass.TwoStateAt.Cell?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@3) alloc)))) ($IsAlloc intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@3) TwoStateAt.Cell.data)) TInt $h@@1))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |799|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@1 $o@@3) TwoStateAt.Cell.data)))
)))
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((TwoStateAt._default.SP$Y@@0 T@U) ($prevHeap@@5 T@U) ($Heap@@0 T@U) (|c#0@@1| T@U) (|y#0@@2| T@U) ) (!  (=> (or (|TwoStateAt.__default.SP#canCall| TwoStateAt._default.SP$Y@@0 $prevHeap@@5 $Heap@@0 |c#0@@1| |y#0@@2|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@5) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@5 $Heap@@0)) ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell)) ($IsBox |y#0@@2| TwoStateAt._default.SP$Y@@0)))) (= (TwoStateAt.__default.SP TwoStateAt._default.SP$Y@@0 $prevHeap@@5 $Heap@@0 |c#0@@1| |y#0@@2|) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@5 |c#0@@1|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@1|) TwoStateAt.Cell.data))))))
 :qid |unknown.0:0|
 :skolemid |651|
 :pattern ( (TwoStateAt.__default.SP TwoStateAt._default.SP$Y@@0 $prevHeap@@5 $Heap@@0 |c#0@@1| |y#0@@2|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((TwoStateAt.Cell.Plus$Y@@4 T@U) ($prevHeap@@6 T@U) ($Heap@@1 T@U) (this@@1 T@U) (|y#0@@3| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $prevHeap@@6) ($IsGoodHeap $Heap@@1)) ($HeapSucc $prevHeap@@6 $Heap@@1)) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.TwoStateAt.Cell) ($IsAlloc refType this@@1 Tclass.TwoStateAt.Cell $prevHeap@@6)))) ($IsBox |y#0@@3| TwoStateAt.Cell.Plus$Y@@4)) (= (|TwoStateAt.Cell.Plus#requires| TwoStateAt.Cell.Plus$Y@@4 $prevHeap@@6 $Heap@@1 this@@1 |y#0@@3|) ($IsAllocBox |y#0@@3| TwoStateAt.Cell.Plus$Y@@4 $prevHeap@@6)))
 :qid |unknown.0:0|
 :skolemid |812|
 :pattern ( (|TwoStateAt.Cell.Plus#requires| TwoStateAt.Cell.Plus$Y@@4 $prevHeap@@6 $Heap@@1 this@@1 |y#0@@3|) ($IsGoodHeap $Heap@@1))
)))
...
(assert (forall ((TwoStateAt.Cell.Plus$Y@@5 T@U) ($prevHeap@@7 T@U) ($self@@2 T@U) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) ) (! (= (Requires1 TwoStateAt.Cell.Plus$Y@@5 TInt $heap@@2 (|TwoStateAt.Cell.Plus#Handle| TwoStateAt.Cell.Plus$Y@@5 $prevHeap@@7 $self@@2) |$fh$0x#0@@2|) (|TwoStateAt.Cell.Plus#requires| TwoStateAt.Cell.Plus$Y@@5 $prevHeap@@7 $heap@@2 $self@@2 |$fh$0x#0@@2|))
 :qid |unknown.0:0|
 :skolemid |686|
 :pattern ( (Requires1 TwoStateAt.Cell.Plus$Y@@5 TInt $heap@@2 (|TwoStateAt.Cell.Plus#Handle| TwoStateAt.Cell.Plus$Y@@5 $prevHeap@@7 $self@@2) |$fh$0x#0@@2|))
)))
...
(declare-fun TwoStateAt.Cell.Plus$Y@@6 () T@U)
(declare-fun $Heap@@2 () T@U)
(declare-fun |b$reqreads#0@0| () Bool)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun previous$Heap () T@U)
(set-info :boogie-vc-id CheckWellformed$$TwoStateAt.Cell.Plus)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon5_Else_correct  (=> (and ($IsAlloc refType this@@2 Tclass.TwoStateAt.Cell current$Heap) ($IsAllocBox |y#0@@4| TwoStateAt.Cell.Plus$Y@@6 current$Heap)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType this@@2 Tclass.TwoStateAt.Cell $Heap@@2)) (=> ($IsAlloc refType this@@2 Tclass.TwoStateAt.Cell $Heap@@2) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAllocBox |y#0@@4| TwoStateAt.Cell.Plus$Y@@6 $Heap@@2)) (=> ($IsAllocBox |y#0@@4| TwoStateAt.Cell.Plus$Y@@6 $Heap@@2) (=> (and (= |b$reqreads#0@0| (forall (($o@@6 T@U) ($f@@2 T@U) ) (!  (=> (and (and (or (not (= $o@@6 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) current$Heap $o@@6) alloc)))) (= $o@@6 this@@2)) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 $o@@6 $f@@2)))
 :qid |TwostateVerificationdfy.259:7|
 :skolemid |814|
))) (|TwoStateAt.__default.SP#canCall| TwoStateAt.Cell.Plus$Y@@6 $Heap@@2 current$Heap this@@2 |y#0@@4|)) (=> (and (and (= (TwoStateAt.Cell.Plus TwoStateAt.Cell.Plus$Y@@6 $Heap@@2 current$Heap this@@2 |y#0@@4|) (TwoStateAt.__default.SP TwoStateAt.Cell.Plus$Y@@6 $Heap@@2 current$Heap this@@2 |y#0@@4|)) (|TwoStateAt.__default.SP#canCall| TwoStateAt.Cell.Plus$Y@@6 $Heap@@2 current$Heap this@@2 |y#0@@4|)) (and ($Is intType (int_2_U (TwoStateAt.Cell.Plus TwoStateAt.Cell.Plus$Y@@6 $Heap@@2 current$Heap this@@2 |y#0@@4|)) TInt) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|)))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null current$Heap alloc this@@2)) (and (=> (= (ControlFlow 0 6) 1) anon5_Then_correct) (=> (= (ControlFlow 0 6) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.TwoStateAt.Cell) ($IsAlloc refType this@@2 Tclass.TwoStateAt.Cell previous$Heap)))) (=> (and (and (and ($IsBox |y#0@@4| TwoStateAt.Cell.Plus$Y@@6) ($IsAllocBox |y#0@@4| TwoStateAt.Cell.Plus$Y@@6 previous$Heap)) (= 2 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@2) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 7) 6))) anon0_correct))))
