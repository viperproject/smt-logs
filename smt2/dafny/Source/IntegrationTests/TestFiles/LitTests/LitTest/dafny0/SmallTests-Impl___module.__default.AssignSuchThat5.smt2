...
(set-info :boogie-vc-id Impl$$_module.__default.AssignSuchThat5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (and ($Is refType null Tclass._module.Node) (and (or (not (= null null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap null) alloc)))))) (exists ((|$as#n0#0| T@U) ) (!  (and (and ($Is refType |$as#n0#0| Tclass._module.Node) ($IsAlloc refType |$as#n0#0| Tclass._module.Node $Heap@0)) (and (or (not (= |$as#n0#0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |$as#n0#0|) alloc))))))
 :qid |SmallTestsdfy.639:13|
 :skolemid |3226|
)))) (=> (or (and ($Is refType null Tclass._module.Node) (and (or (not (= null null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap null) alloc)))))) (exists ((|$as#n0#0@@0| T@U) ) (!  (and (and ($Is refType |$as#n0#0@@0| Tclass._module.Node) ($IsAlloc refType |$as#n0#0@@0| Tclass._module.Node $Heap@0)) (and (or (not (= |$as#n0#0@@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |$as#n0#0@@0|) alloc))))))
 :qid |SmallTestsdfy.639:13|
 :skolemid |3226|
))) (=> (=> true (and ($Is refType |n#0@0| Tclass._module.Node) ($IsAlloc refType |n#0@0| Tclass._module.Node $Heap@0))) (=> (and (and (or (not (= |n#0@0| null)) (not true)) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |n#0@0|) alloc))))) (= (ControlFlow 0 2) (- 0 1))) (U_2_bool (Lit boolType (bool_2_U false)))))))))
(let ((anon3_Else_correct  (=> (and (not (and ($Is refType |n#1@0| Tclass._module.Node) ($IsAlloc refType |n#1@0| Tclass._module.Node $Heap@0))) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (and ($Is refType |n#1@0| Tclass._module.Node) ($IsAlloc refType |n#1@0| Tclass._module.Node $Heap@0)) (= (ControlFlow 0 4) 2)) anon2_correct)))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 Tclass._module.Node?)) (=> (and (and (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc)))) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (=> (= (ControlFlow 0 6) 4) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (=> |defass#k#0| (and ($Is refType |k#0| Tclass._module.Node) ($IsAlloc refType |k#0| Tclass._module.Node $Heap))) true)) (and (and (=> |defass#n#0| (and ($Is refType |n#0| Tclass._module.Node) ($IsAlloc refType |n#0| Tclass._module.Node $Heap))) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 6)))) anon0_correct)))
