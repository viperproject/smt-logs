...
(declare-fun |g#0| () T@U)
(declare-fun TypeParameters._default.MFitToAnything$G () T@U)
(declare-fun |defass#r#0| () Bool)
(declare-fun |r#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$TypeParameters.__default.MFitToAnything)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($IsBox |g#0| TypeParameters._default.MFitToAnything$G) ($IsAllocBox |g#0| TypeParameters._default.MFitToAnything$G $Heap)) (=> |defass#r#0| (and ($IsBox |r#0| TypeParameters._default.MFitToAnything$G) ($IsAllocBox |r#0| TypeParameters._default.MFitToAnything$G $Heap)))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
