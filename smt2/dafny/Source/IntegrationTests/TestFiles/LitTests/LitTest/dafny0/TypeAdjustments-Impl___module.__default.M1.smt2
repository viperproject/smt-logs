...
(assert (distinct TInt TagInt alloc Tagclass._System.object? Tagclass._System.object Tagclass._System.array? Tagclass._System.array tytagFamily$object tytagFamily$array)
)
(assert (= (FDim alloc) 0))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($Is refType |arr#0@0| (Tclass._System.array TInt)) ($IsAlloc refType |arr#0@0| (Tclass._System.array TInt) $Heap)) (and (=> (= (ControlFlow 0 2) (- 0 6)) (<= 0 (LitInt 100))) (=> (<= 0 (LitInt 100)) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) (LitInt 100)) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (or (not (= $nw@0 null)) (not true))) (=> (or (not (= $nw@0 null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@0)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (_System.array.Length $nw@0))) (=> (and (= |y#0@1| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $nw@0) (IndexField (LitInt 0))))) 15)) ($Is refType |$rhs#0@0| (Tclass._System.array TInt))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |$rhs#0@0| null)) (not true))) (=> (or (not (= |$rhs#0@0| null)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) (<= (LitInt 0) |$rhs#1@0|))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (and ($Is refType |arr#0| (Tclass._System.array TInt)) ($IsAlloc refType |arr#0| (Tclass._System.array TInt) $Heap)) true) (and ($Is refType |$rhs#0| (Tclass._System.array TInt)) true)) (and (and (and ($Is refType |obj#0| Tclass._System.object?) ($IsAlloc refType |obj#0| Tclass._System.object? $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 7) 2)))) anon0_correct))))
