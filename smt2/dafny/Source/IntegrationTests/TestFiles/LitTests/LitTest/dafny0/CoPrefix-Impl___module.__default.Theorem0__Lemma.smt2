...
(declare-fun $LZ () T@U)
(declare-fun |k#0| () T@U)
(set-info :boogie-vc-id Impl$$_module.__default.Theorem0__Lemma)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#k0#0| T@U) ) (!  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (|ORD#Less| |$ih#k0#0| |k#0|)) (_module.__default.atmost_h ($LS $LZ) |$ih#k0#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))))
 :qid |CoPrefixdfy.81:40|
 :skolemid |1871|
 :pattern ( (_module.__default.atmost_h ($LS $LZ) |$ih#k0#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))))
)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |k#0|)) (=> (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))))))) (U_2_bool (Lit boolType (bool_2_U true)))))))) (=> (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |k#0|)) (=> (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))))))) (U_2_bool (Lit boolType (bool_2_U true))))))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |k#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ)))))))) (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))))))))) (=> (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |k#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ)))))))) (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Cons_q (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |k#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ)))))))) (let ((|h#2@@0| (LitInt (_module.Stream.head (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ))))))))
(<= |h#2@@0| (LitInt (_module.Stream.head (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))))))))) (=> (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |k#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ)))))))) (let ((|h#2@@1| (LitInt (_module.Stream.head (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ))))))))
(<= |h#2@@1| (LitInt (_module.Stream.head (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |k#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ)))))))) (let ((|t#2@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ))))))))
(_module.__default.atmost_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) |t#2@@0| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))))))))) (=> (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (< 0 (|ORD#Offset| |k#0|)) (=> (not (U_2_bool (Lit boolType (bool_2_U (_module.Stream.Nil_q (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ)))))))) (let ((|t#2@@1| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ))))))))
(_module.__default.atmost_h ($LS ($LS $LZ)) (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) |t#2@@1| (Lit DatatypeTypeType (_module.Stream.tail (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ)))))))))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.atmost_h#canCall| |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (or (_module.__default.atmost_h ($LS $LZ) |k#0| (Lit DatatypeTypeType (_module.__default.zeros ($LS $LZ))) (Lit DatatypeTypeType (_module.__default.ones ($LS $LZ)))) (=> (= (LitInt 0) (|ORD#Offset| |k#0|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |k#0|) (_module.__default.atmost_h ($LS ($LS $LZ)) |_k'#1@@1| (Lit DatatypeTypeType (_module.__default.zeros ($LS ($LS $LZ)))) (Lit DatatypeTypeType (_module.__default.ones ($LS ($LS $LZ))))))
 :qid |CoPrefixdfy.25:20|
 :skolemid |1868|
 :pattern ( (_module.__default.atmost_h ($LS ($LS $LZ)) |_k'#1@@1| (_module.__default.zeros ($LS ($LS $LZ))) (_module.__default.ones ($LS ($LS $LZ)))))
))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 7) 2))) anon0_correct)))
