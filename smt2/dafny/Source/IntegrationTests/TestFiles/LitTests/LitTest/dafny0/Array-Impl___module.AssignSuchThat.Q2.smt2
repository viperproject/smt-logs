...
(assert (distinct TInt TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass._module.AssignSuchThat? Tagclass._module.AssignSuchThat tytagFamily$array tytagFamily$AssignSuchThat)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($o@@0 T@U) ) (! (= ($Is refType $o@@0 Tclass._module.AssignSuchThat?)  (or (= $o@@0 null) (= (dtype $o@@0) Tclass._module.AssignSuchThat?)))
 :qid |unknown.0:0|
 :skolemid |1342|
 :pattern ( ($Is refType $o@@0 Tclass._module.AssignSuchThat?))
)))
(assert (forall ((|c#0@@0| T@U) ($h@@0 T@U) ) (! (= ($IsAlloc refType |c#0@@0| Tclass._module.AssignSuchThat $h@@0) ($IsAlloc refType |c#0@@0| Tclass._module.AssignSuchThat? $h@@0))
 :qid |unknown.0:0|
 :skolemid |1363|
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.AssignSuchThat $h@@0))
 :pattern ( ($IsAlloc refType |c#0@@0| Tclass._module.AssignSuchThat? $h@@0))
)))
...
(assert (forall (($o@@2 T@U) ($h@@2 T@U) ) (! (= ($IsAlloc refType $o@@2 Tclass._module.AssignSuchThat? $h@@2)  (or (= $o@@2 null) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@2) alloc)))))
 :qid |unknown.0:0|
 :skolemid |1343|
 :pattern ( ($IsAlloc refType $o@@2 Tclass._module.AssignSuchThat? $h@@2))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@4 T@U) ($f T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#21| |l#0| |l#1| |l#2| |l#3|) $o@@4 $f))  (=> (and (or (not (= $o@@4 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@4) |l#2|)))) (= $o@@4 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1373|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#21| |l#0| |l#1| |l#2| |l#3|) $o@@4 $f))
)))
(assert (forall ((bx@@0 T@U) ) (!  (=> ($IsBox bx@@0 Tclass._module.AssignSuchThat?) (and (= ($Box refType ($Unbox refType bx@@0)) bx@@0) ($Is refType ($Unbox refType bx@@0) Tclass._module.AssignSuchThat?)))
 :qid |unknown.0:0|
 :skolemid |1341|
 :pattern ( ($IsBox bx@@0 Tclass._module.AssignSuchThat?))
)))
(assert (forall ((bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 Tclass._module.AssignSuchThat) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) Tclass._module.AssignSuchThat)))
 :qid |unknown.0:0|
 :skolemid |1346|
 :pattern ( ($IsBox bx@@1 Tclass._module.AssignSuchThat))
)))
...
(assert (forall ((|c#0@@2| T@U) ) (! (= ($Is refType |c#0@@2| Tclass._module.AssignSuchThat)  (and ($Is refType |c#0@@2| Tclass._module.AssignSuchThat?) (or (not (= |c#0@@2| null)) (not true))))
 :qid |unknown.0:0|
 :skolemid |1362|
 :pattern ( ($Is refType |c#0@@2| Tclass._module.AssignSuchThat))
 :pattern ( ($Is refType |c#0@@2| Tclass._module.AssignSuchThat?))
)))
...
(set-info :boogie-vc-id Impl$$_module.AssignSuchThat.Q2)
...
(let ((anon3_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (and (<= 0 (LitInt 22)) (< (LitInt 22) (_System.array.Length |a#0|)))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (LitInt 22))))) (LitInt 12)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (and (<= 0 (LitInt 22)) (< (LitInt 22) (_System.array.Length |a#0|)))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |a#0|) (IndexField (LitInt 22))))) (LitInt 0))))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#21| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 8) (- 0 11)) (or (not (= |a#0| null)) (not true))) (=> (or (not (= |a#0| null)) (not true)) (and (=> (= (ControlFlow 0 8) (- 0 10)) (and (<= 0 (LitInt 22)) (< (LitInt 22) (_System.array.Length |a#0|)))) (=> (and (<= 0 (LitInt 22)) (< (LitInt 22) (_System.array.Length |a#0|))) (and (=> (= (ControlFlow 0 8) (- 0 9)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 22))))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |a#0| (IndexField (LitInt 22)))) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap |a#0| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |a#0|) (IndexField (LitInt 22)) ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and (=> (= (ControlFlow 0 8) 2) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.AssignSuchThat) ($IsAlloc refType this Tclass._module.AssignSuchThat $Heap)))) (=> (and (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (= (_System.array.Length |a#0|) (LitInt 50)) (= (ControlFlow 0 12) 8))) anon0_correct))))
