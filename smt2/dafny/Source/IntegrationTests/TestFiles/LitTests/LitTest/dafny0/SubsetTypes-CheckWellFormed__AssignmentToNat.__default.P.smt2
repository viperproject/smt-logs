...
(set-info :boogie-vc-id CheckWellFormed$$AssignmentToNat.__default.P)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and ($IsAllocBox ($Box HandleTypeType |f#0|) (Tclass._System.___hFunc1 Tclass._System.nat TInt) $Heap) (= (ControlFlow 0 2) (- 0 1))) ($Is intType (int_2_U |x#0@@1|) Tclass._System.nat)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 Tclass._System.nat TInt)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 Tclass._System.nat TInt) $Heap))) (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
