...
procedure {:verboseName "AdvancedZeroInitialization.MyMethod0 (well-formedness)"} CheckWellFormed$$AdvancedZeroInitialization.__default.MyMethod0(AdvancedZeroInitialization._default.MyMethod0$G: Ty, 
    g#0: Box
...
procedure {:verboseName "AdvancedZeroInitialization.MyMethod0 (call)"} Call$$AdvancedZeroInitialization.__default.MyMethod0(AdvancedZeroInitialization._default.MyMethod0$G: Ty, 
    g#0: Box
       where $IsBox(g#0, AdvancedZeroInitialization._default.MyMethod0$G)
         && $IsAllocBox(g#0, AdvancedZeroInitialization._default.MyMethod0$G, $Heap))
   returns (h#0: Box
...
procedure {:verboseName "AdvancedZeroInitialization.MyMethod0 (correctness)"} Impl$$AdvancedZeroInitialization.__default.MyMethod0(AdvancedZeroInitialization._default.MyMethod0$G: Ty, 
    g#0: Box
       where $IsBox(g#0, AdvancedZeroInitialization._default.MyMethod0$G)
         && $IsAllocBox(g#0, AdvancedZeroInitialization._default.MyMethod0$G, $Heap))
   returns (h#0: Box
...
procedure {:verboseName "AdvancedZeroInitialization.MyMethod1 (well-formedness)"} CheckWellFormed$$AdvancedZeroInitialization.__default.MyMethod1(AdvancedZeroInitialization._default.MyMethod1$G: Ty, 
    g#0: Box
...
procedure {:verboseName "AdvancedZeroInitialization.MyMethod1 (call)"} Call$$AdvancedZeroInitialization.__default.MyMethod1(AdvancedZeroInitialization._default.MyMethod1$G: Ty, 
    g#0: Box
       where $IsBox(g#0, AdvancedZeroInitialization._default.MyMethod1$G)
         && $IsAllocBox(g#0, AdvancedZeroInitialization._default.MyMethod1$G, $Heap))
   returns (h#0: Box
...
procedure {:verboseName "AdvancedZeroInitialization.MyMethod1 (correctness)"} Impl$$AdvancedZeroInitialization.__default.MyMethod1(AdvancedZeroInitialization._default.MyMethod1$G: Ty, 
    g#0: Box
       where $IsBox(g#0, AdvancedZeroInitialization._default.MyMethod1$G)
         && $IsAllocBox(g#0, AdvancedZeroInitialization._default.MyMethod1$G, $Heap))
   returns (h#0: Box
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AdvancedZeroInitialization.MyMethod1 (correctness)"} Impl$$AdvancedZeroInitialization.__default.MyMethod1(AdvancedZeroInitialization._default.MyMethod1$G: Ty, g#0: Box)
   returns (h#0: Box, $_reverifyPost: bool)
{
  ...
  var $nw: ref;
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(72,11)
    assume true;
    assert {:id "id0"} 0 <= LitInt(8);
    havoc $nw;
    assume $nw != null
       && $Is($nw, Tclass._System.array?(AdvancedZeroInitialization._default.MyMethod1$G));
    ...
    a#0 := $nw;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(73,7)
    assume true;
    assert {:id "id2"} a#0 != null;
    assert {:id "id3"} 0 <= LitInt(3) && LitInt(3) < _System.array.Length(a#0);
    assume true;
...
procedure {:verboseName "AdvancedZeroInitialization.MyMethodSelect (well-formedness)"} CheckWellFormed$$AdvancedZeroInitialization.__default.MyMethodSelect(AdvancedZeroInitialization._default.MyMethodSelect$G: Ty, 
    which#0: int, 
    g#0: Box
...
procedure {:verboseName "AdvancedZeroInitialization.MyMethodSelect (call)"} Call$$AdvancedZeroInitialization.__default.MyMethodSelect(AdvancedZeroInitialization._default.MyMethodSelect$G: Ty, 
    which#0: int, 
    g#0: Box
       where $IsBox(g#0, AdvancedZeroInitialization._default.MyMethodSelect$G)
         && $IsAllocBox(g#0, AdvancedZeroInitialization._default.MyMethodSelect$G, $Heap))
  ...
  requires {:id "id8"} which#0 == LitInt(0) || which#0 == LitInt(1);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "AdvancedZeroInitialization.MyMethodSelect (correctness)"} Impl$$AdvancedZeroInitialization.__default.MyMethodSelect(AdvancedZeroInitialization._default.MyMethodSelect$G: Ty, 
    which#0: int, 
    g#0: Box
       where $IsBox(g#0, AdvancedZeroInitialization._default.MyMethodSelect$G)
         && $IsAllocBox(g#0, AdvancedZeroInitialization._default.MyMethodSelect$G, $Heap))
  ...
  free requires 1 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id9"} which#0 == LitInt(0) || which#0 == LitInt(1);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AdvancedZeroInitialization.MyMethodSelect (correctness)"} Impl$$AdvancedZeroInitialization.__default.MyMethodSelect(AdvancedZeroInitialization._default.MyMethodSelect$G: Ty, which#0: int, g#0: Box)
   returns (h#0: Box, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $rhs##0_0: Box;
  ...
  var g##1_0: Box;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- alternative statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(79,5)
    if (*)
    {
        assume true;
        assume {:id "id14"} which#0 == LitInt(0);
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(80,38)
        assume true;
        ...
        g##1_0 := g#0;
        call {:id "id15"} $rhs##1_0 := Call$$AdvancedZeroInitialization.__default.MyMethod0(AdvancedZeroInitialization._default.MyMethodSelect$G, g##1_0);
    ...
    {
        assume true;
        assume {:id "id11"} which#0 == LitInt(1);
        // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(81,38)
        assume true;
        // TrCallStmt: Adding lhs with type G
        // TrCallStmt: Before ProcessCallStmt
        assume true;
        // ProcessCallStmt: CheckSubrange
        g##0_0 := g#0;
        call {:id "id12"} $rhs##0_0 := Call$$AdvancedZeroInitialization.__default.MyMethod1(AdvancedZeroInitialization._default.MyMethodSelect$G, g##0_0);
        // TrCallStmt: After ProcessCallStmt
        h#0 := $rhs##0_0;
    }
    else
...
procedure {:verboseName "AdvancedZeroInitialization.Test (call)"} Call$$AdvancedZeroInitialization.__default.Test(which#0: int);
  // user-defined preconditions
  requires {:id "id20"} which#0 == LitInt(0) || which#0 == LitInt(1);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "AdvancedZeroInitialization.Test (correctness)"} Impl$$AdvancedZeroInitialization.__default.Test(which#0: int) returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id21"} which#0 == LitInt(0) || which#0 == LitInt(1);
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AdvancedZeroInitialization.Test (correctness)"} Impl$$AdvancedZeroInitialization.__default.Test(which#0: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var x#0: real;
  var x'#0: real;
  ...
  var ##ch#1: char;
    ...
    $_reverifyPost := false;
    havoc x#0;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(88,29)
    assume true;
    ...
    // ProcessCallStmt: CheckSubrange
    g##0 := x#0;
    call {:id "id22"} $tmp##0 := Call$$AdvancedZeroInitialization.__default.MyMethodSelect(TReal, which##0, $Box(g##0));
    havoc $rhs##0;
    assume $rhs##0 == $Unbox($tmp##0): real;
    // TrCallStmt: After ProcessCallStmt
    x'#0 := $rhs##0;
    havoc ch#0 /* where $Is(ch#0, TChar) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(91,30)
    assume true;
    ...
    // ProcessCallStmt: CheckSubrange
    g##1 := ch#0;
    call {:id "id24"} $tmp##1 := Call$$AdvancedZeroInitialization.__default.MyMethodSelect(TChar, which##1, $Box(g##1));
    havoc $rhs##1;
    assume $rhs##1 == $Unbox($tmp##1): char;
    // TrCallStmt: After ProcessCallStmt
    ch'#0 := $rhs##1;
    havoc s#0 /* where $Is(s#0, TSet(TReal)) && $IsAlloc(s#0, TSet(TReal), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(94,29)
    assume true;
    ...
    // ProcessCallStmt: CheckSubrange
    g##2 := s#0;
    call {:id "id26"} $tmp##2 := Call$$AdvancedZeroInitialization.__default.MyMethodSelect(TSet(TReal), which##2, $Box(g##2));
    havoc $rhs##2;
    assume $rhs##2 == $Unbox($tmp##2): Set;
    // TrCallStmt: After ProcessCallStmt
    s'#0 := $rhs##2;
    havoc d#0 /* where $Is(d#0, Tclass.AdvancedZeroInitialization.Xt())
       && $IsAlloc(d#0, Tclass.AdvancedZeroInitialization.Xt(), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(97,29)
    assume true;
    ...
    // ProcessCallStmt: CheckSubrange
    g##3 := d#0;
    call {:id "id28"} $tmp##3 := Call$$AdvancedZeroInitialization.__default.MyMethodSelect(Tclass.AdvancedZeroInitialization.Xt(), which##3, $Box(g##3));
    havoc $rhs##3;
    ...
    havoc y#0 /* where $Is(y#0, Tclass.AdvancedZeroInitialization.Yt(TSeq(TInt)))
       && $IsAlloc(y#0, Tclass.AdvancedZeroInitialization.Yt(TSeq(TInt)), $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(100,29)
    assume true;
    ...
    // ProcessCallStmt: CheckSubrange
    g##4 := y#0;
    call {:id "id30"} $tmp##4 := Call$$AdvancedZeroInitialization.__default.MyMethodSelect(Tclass.AdvancedZeroInitialization.Yt(TSeq(TInt)), which##4, $Box(g##4));
    havoc $rhs##4;
    ...
    havoc z#0 /* where $Is(z#0, 
       ...
       && $IsAlloc(z#0, 
        Tclass.AdvancedZeroInitialization.Yt(Tclass.AdvancedZeroInitialization.Even()), 
        $Heap) */;
    // ----- call statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(103,29)
    assume true;
    ...
    // ProcessCallStmt: CheckSubrange
    g##5 := z#0;
    call {:id "id32"} $tmp##5 := Call$$AdvancedZeroInitialization.__default.MyMethodSelect(Tclass.AdvancedZeroInitialization.Yt(Tclass.AdvancedZeroInitialization.Even()), which##5, $Box(g##5));
    havoc $rhs##5;
    assume $rhs##5 == $Unbox($tmp##5): DatatypeType;
    // TrCallStmt: After ProcessCallStmt
    z'#0 := $rhs##5;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(105,5)
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(106,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(107,5)
    assume true;
    ##ch#0 := ch#0;
    ...
    assume AdvancedZeroInitialization.__default.PrCh#canCall(ch'#0);
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(108,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(109,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(110,5)
    assume true;
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- print statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/NonZeroInitializationCompile.dfy(111,5)
    assume true;
    assume true;
    assume true;
    assume true;
...
procedure {:verboseName "AdvancedZeroInitialization.PrCh (well-formedness)"} CheckWellformed$$AdvancedZeroInitialization.__default.PrCh(ch#0: char where $Is(ch#0, TChar));
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "AdvancedZeroInitialization.Even (well-formedness)"} CheckWellFormed$$AdvancedZeroInitialization.Even(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "AdvancedZeroInitialization.Even (well-formedness)"} CheckWellFormed$$AdvancedZeroInitialization.Even(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;
    ...
    if (*)
    {
        ...
        assert {:id "id39"} LitInt(2) != 0;
        assume {:id "id40"} Mod(x#0, LitInt(2)) == LitInt(0);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id41"} LitInt(Mod(0, LitInt(2))) == LitInt(0);
        assume false;
    }
}
