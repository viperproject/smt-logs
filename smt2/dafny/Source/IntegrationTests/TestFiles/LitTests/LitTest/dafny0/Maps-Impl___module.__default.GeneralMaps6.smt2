...
(declare-fun |lambda#78| (T@U Int Int) T@U)
(declare-fun _module.__default.Thirteen (Int) Bool)
(declare-fun _module.__default.Odd (Int) Bool)
(declare-fun |Set#FromBoogieMap| (T@U) T@U)
(declare-fun $FunctionContextHeight () Int)
(declare-fun |_module.__default.Thirteen#canCall| (Int) Bool)
(declare-fun SetType () T@T)
(declare-fun TSet (T@U) T@U)
(declare-fun |_module.__default.Odd#canCall| (Int) Bool)
...
(declare-fun |lambda#79| () T@U)
(declare-fun |map$project$13#0#y#0| (Int) Int)
...
(assert (forall ((|l#0| T@U) (|l#1| Int) (|l#2| Int) (|$w#0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#78| |l#0| |l#1| |l#2|) |$w#0|))  (and ($IsBox |$w#0| |l#0|) (exists ((|a#0#0#0| Int) (|a#0#1#0| Int) ) (!  (and (and (and (and (and (<= |l#1| |a#0#0#0|) (< |a#0#0#0| |a#0#1#0|)) (< |a#0#1#0| |l#2|)) (_module.__default.Thirteen |a#0#0#0|)) (_module.__default.Odd |a#0#1#0|)) (= (U_2_int ($Unbox intType |$w#0|)) |a#0#0#0|))
 :qid |Mapsdfy.272:17|
 :skolemid |717|
))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |944|
 :pattern ( (MapType0Select BoxType boolType (|lambda#78| |l#0| |l#1| |l#2|) |$w#0|))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|y#0| Int) ) (!  (=> (or (|_module.__default.Odd#canCall| |y#0|) (< 0 $FunctionContextHeight)) (= (_module.__default.Odd |y#0|) (= (Mod |y#0| (LitInt 2)) (LitInt 1))))
 :qid |Mapsdfy.269:15|
 :skolemid |712|
 :pattern ( (_module.__default.Odd |y#0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|y#0@@0| Int) ) (!  (=> (or (|_module.__default.Odd#canCall| (LitInt |y#0@@0|)) (< 0 $FunctionContextHeight)) (= (_module.__default.Odd (LitInt |y#0@@0|)) (= (LitInt (Mod |y#0@@0| (LitInt 2))) (LitInt 1))))
 :qid |Mapsdfy.269:15|
 :weight 3
 :skolemid |713|
 :pattern ( (_module.__default.Odd (LitInt |y#0@@0|)))
))))
...
(assert (forall ((|$w#0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType |lambda#79| |$w#0@@0|) ($Box intType (int_2_U (|map$project$13#0#y#0| (U_2_int ($Unbox intType |$w#0@@0|))))))
 :qid |Mapsdfy.272:13|
 :skolemid |945|
 :pattern ( (MapType0Select BoxType BoxType |lambda#79| |$w#0@@0|))
)))
...
(declare-fun |map$project$13#0#x#0| (Int) Int)
...
(set-info :boogie-vc-id Impl$$_module.__default.GeneralMaps6)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((anon17_correct  (=> (and (|_module.__default.Thirteen#canCall| (LitInt 13)) (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.Thirteen (LitInt 13))))) (|_module.__default.Odd#canCall| (LitInt 15)))) (and (=> (= (ControlFlow 0 3) (- 0 6)) (=> (|_module.__default.Thirteen#canCall| (LitInt 13)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.Thirteen (LitInt 13))))) (= (LitInt 13) (LitInt 13))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (=> (|_module.__default.Odd#canCall| (LitInt 15)) (or (U_2_bool (Lit boolType (bool_2_U (_module.__default.Odd (LitInt 15))))) (= (LitInt (Mod 15 (LitInt 2))) (LitInt 1))))) (=> (U_2_bool (Lit boolType (bool_2_U  (and (_module.__default.Thirteen (LitInt 13)) (_module.__default.Odd (LitInt 15)))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Set#IsMember| (|Map#Domain| |c2#0@0|) ($Box intType (int_2_U (LitInt 13))))) (=> (= (ControlFlow 0 3) (- 0 2)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|Map#Elements| |c2#0@0|) ($Box intType (int_2_U (LitInt 13)))))) (LitInt 15))))))))))
(let ((anon26_Else_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U (_module.__default.Thirteen (LitInt 13)))))) (= (ControlFlow 0 8) 3)) anon17_correct)))
(let ((anon26_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U (_module.__default.Thirteen (LitInt 13))))) (=> (and (and (= |##y#1@0| (LitInt 15)) ($IsAlloc intType (int_2_U |##y#1@0|) TInt $Heap)) (and (|_module.__default.Odd#canCall| (LitInt 15)) (= (ControlFlow 0 7) 3))) anon17_correct))))
(let ((anon15_correct  (=> (forall ((|x#1| Int) (|y#1| Int) ) (!  (and (=> (and (and (<= (LitInt 12) |x#1|) (< |x#1| |y#1|)) (< |y#1| 17)) (and (|_module.__default.Thirteen#canCall| |x#1|) (=> (_module.__default.Thirteen |x#1|) (|_module.__default.Odd#canCall| |y#1|)))) (forall ((|a#1#0#0@@0| Int) (|a#1#1#0@@0| Int) ) (!  (=> (and (and (and (and (<= (LitInt 12) |a#1#0#0@@0|) (< |a#1#0#0@@0| |a#1#1#0@@0|)) (< |a#1#1#0@@0| 17)) (_module.__default.Thirteen |a#1#0#0@@0|)) (_module.__default.Odd |a#1#1#0@@0|)) (and (and (and (and (and (<= (LitInt 12) (|map$project$13#0#x#0| |a#1#0#0@@0|)) (< (|map$project$13#0#x#0| |a#1#0#0@@0|) (|map$project$13#0#y#0| |a#1#0#0@@0|))) (< (|map$project$13#0#y#0| |a#1#0#0@@0|) 17)) (_module.__default.Thirteen (|map$project$13#0#x#0| |a#1#0#0@@0|))) (_module.__default.Odd (|map$project$13#0#y#0| |a#1#0#0@@0|))) (= |a#1#0#0@@0| (|map$project$13#0#x#0| |a#1#0#0@@0|))))
 :qid |Mapsdfy.272:17|
 :skolemid |718|
 :pattern ( (_module.__default.Odd |a#1#1#0@@0|) (_module.__default.Thirteen |a#1#0#0@@0|))
)))
 :qid |Mapsdfy.272:17|
 :skolemid |719|
 :pattern ( (_module.__default.Odd |y#1|) (_module.__default.Thirteen |x#1|))
)) (=> (and (and (= |c2#0@0| (|Map#Glue| (|Set#FromBoogieMap| (|lambda#78| TInt (LitInt 12) 17)) |lambda#79| (TMap TInt TInt))) (= |##x#1@0| (LitInt 13))) (and ($IsAlloc intType (int_2_U |##x#1@0|) TInt $Heap) (|_module.__default.Thirteen#canCall| (LitInt 13)))) (and (=> (= (ControlFlow 0 9) 7) anon26_Then_correct) (=> (= (ControlFlow 0 9) 8) anon26_Else_correct))))))
(let ((anon25_Else_correct  (=> (and (not (and (and (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (_module.__default.Thirteen |x#0@0|)) (_module.__default.Odd |y#0@0|)) (and (and (and (and (<= (LitInt 12) |x#prime#0@0|) (< |x#prime#0@0| |y#prime#0@0|)) (< |y#prime#0@0| 17)) (_module.__default.Thirteen |x#prime#0@0|)) (_module.__default.Odd |y#prime#0@0|)))) (= (ControlFlow 0 12) 9)) anon15_correct)))
(let ((anon25_Then_correct  (=> (and (and (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (_module.__default.Thirteen |x#0@0|)) (_module.__default.Odd |y#0@0|)) (and (and (and (and (<= (LitInt 12) |x#prime#0@0|) (< |x#prime#0@0| |y#prime#0@0|)) (< |y#prime#0@0| 17)) (_module.__default.Thirteen |x#prime#0@0|)) (_module.__default.Odd |y#prime#0@0|))) (and (=> (= (ControlFlow 0 10) (- 0 11)) (or (or (not (= |x#0@0| |x#prime#0@0|)) (not true)) (= |y#0@0| |y#prime#0@0|))) (=> (or (or (not (= |x#0@0| |x#prime#0@0|)) (not true)) (= |y#0@0| |y#prime#0@0|)) (=> (= (ControlFlow 0 10) 9) anon15_correct))))))
(let ((anon24_Else_correct  (=> (not (and (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (_module.__default.Thirteen |x#0@0|)) (_module.__default.Odd |y#0@0|))) (and (=> (= (ControlFlow 0 14) 10) anon25_Then_correct) (=> (= (ControlFlow 0 14) 12) anon25_Else_correct)))))
(let ((anon24_Then_correct  (=> (and (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (_module.__default.Thirteen |x#0@0|)) (_module.__default.Odd |y#0@0|)) (and (=> (= (ControlFlow 0 13) 10) anon25_Then_correct) (=> (= (ControlFlow 0 13) 12) anon25_Else_correct)))))
(let ((anon23_Else_correct  (=> (not (and (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (_module.__default.Thirteen |x#0@0|)) (_module.__default.Odd |y#0@0|))) (and (=> (= (ControlFlow 0 16) 13) anon24_Then_correct) (=> (= (ControlFlow 0 16) 14) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (and (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (_module.__default.Thirteen |x#0@0|)) (_module.__default.Odd |y#0@0|)) (and (=> (= (ControlFlow 0 15) 13) anon24_Then_correct) (=> (= (ControlFlow 0 15) 14) anon24_Else_correct)))))
(let ((anon22_Else_correct  (=> (not (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (_module.__default.Thirteen |x#0@0|))) (and (=> (= (ControlFlow 0 18) 15) anon23_Then_correct) (=> (= (ControlFlow 0 18) 16) anon23_Else_correct)))))
(let ((anon22_Then_correct  (=> (and (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (_module.__default.Thirteen |x#0@0|)) (and ($IsAlloc intType (int_2_U |y#0@0|) TInt $Heap) (|_module.__default.Odd#canCall| |y#0@0|))) (and (=> (= (ControlFlow 0 17) 15) anon23_Then_correct) (=> (= (ControlFlow 0 17) 16) anon23_Else_correct)))))
(let ((anon21_Else_correct  (=> (not (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17))) (and (=> (= (ControlFlow 0 20) 17) anon22_Then_correct) (=> (= (ControlFlow 0 20) 18) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (and (and (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (< |y#0@0| 17)) (and ($IsAlloc intType (int_2_U |x#0@0|) TInt $Heap) (|_module.__default.Thirteen#canCall| |x#0@0|))) (and (=> (= (ControlFlow 0 19) 17) anon22_Then_correct) (=> (= (ControlFlow 0 19) 18) anon22_Else_correct)))))
(let ((anon20_Else_correct  (=> (not (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|))) (and (=> (= (ControlFlow 0 22) 19) anon21_Then_correct) (=> (= (ControlFlow 0 22) 20) anon21_Else_correct)))))
(let ((anon20_Then_correct  (=> (and (<= (LitInt 12) |x#0@0|) (< |x#0@0| |y#0@0|)) (and (=> (= (ControlFlow 0 21) 19) anon21_Then_correct) (=> (= (ControlFlow 0 21) 20) anon21_Else_correct)))))
(let ((anon19_Else_correct  (=> (< |x#0@0| (LitInt 12)) (and (=> (= (ControlFlow 0 24) 21) anon20_Then_correct) (=> (= (ControlFlow 0 24) 22) anon20_Else_correct)))))
(let ((anon19_Then_correct  (=> (<= (LitInt 12) |x#0@0|) (and (=> (= (ControlFlow 0 23) 21) anon20_Then_correct) (=> (= (ControlFlow 0 23) 22) anon20_Else_correct)))))
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 25) 23) anon19_Then_correct) (=> (= (ControlFlow 0 25) 24) anon19_Else_correct))))
(let ((anon18_Else_correct true))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 26) 25) anon18_Then_correct) (=> (= (ControlFlow 0 26) 1) anon18_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MapType |c2#0| (TMap TInt TInt)) ($IsAlloc MapType |c2#0| (TMap TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 27) 26))) anon0_correct))))
