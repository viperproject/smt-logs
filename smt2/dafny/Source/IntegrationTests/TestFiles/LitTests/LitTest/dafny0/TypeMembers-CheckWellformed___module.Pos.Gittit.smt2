...
(declare-fun this@@1 () Int)
(declare-fun $_ReadsFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $Heap () T@U)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun $IsHeapAnchor (T@U) Bool)
(set-info :boogie-vc-id CheckWellformed$$_module.Pos.Gittit)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon5_Else_correct  (=> (= |newtype$check#0@0| (LitInt 2)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (< 0 |newtype$check#0@0|)) (=> (< 0 |newtype$check#0@0|) (=> (and (= |newtype$check#1@0| (+ this@@1 2)) (= (ControlFlow 0 3) (- 0 2))) (< 0 |newtype$check#1@0|)))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (< 0 this@@1)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 6) 5))) anon0_correct)))
