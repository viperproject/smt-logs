...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 17) (let ((anon11_Then_correct  (=> (<= 7 |i#0@1|) (and (=> (= (ControlFlow 0 6) (- 0 9)) (or (not (= |c#0@@1| null)) (not true))) (and (=> (= (ControlFlow 0 6) (- 0 8)) (or (not (= |c#0@@1| null)) (not true))) (and (=> (= (ControlFlow 0 6) (- 0 7)) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap)) (=> ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap) (=> (= (ControlFlow 0 6) (- 0 5)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@1|) _module.C.y))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap |c#0@@1|) _module.C.y))))))))))))
(let ((anon6_correct  (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= (ControlFlow 0 4) (- 0 3))) false) ($IsAllocBox ($Box refType |c#0@@1|) Tclass._module.C $Heap@1))))
(let ((anon11_Else_correct  (=> (and (< |i#0@1| 7) (= (ControlFlow 0 10) 4)) anon6_correct)))
(let ((anon10_Then_correct  (and (=> (= (ControlFlow 0 11) 6) anon11_Then_correct) (=> (= (ControlFlow 0 11) 10) anon11_Else_correct))))
(let ((anon9_Else_correct  (=> |$w$loop#0@1| (and (=> (= (ControlFlow 0 12) 11) anon10_Then_correct) (=> (= (ControlFlow 0 12) 4) anon6_correct)))))
...
)) (<= (- 7 |i#0@1|) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 14) 1) anon8_LoopDone_correct) (=> (= (ControlFlow 0 14) 13) anon8_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#4| null $Heap alloc |c#0@@1|)) (=> (and (= |i#0@0| (LitInt 0)) (= |$decr_init$loop#00@0| (- 7 |i#0@0|))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (=> |$w$loop#0@0| ($IsAllocBox ($Box refType |c#0@@1|) Tclass._module.C $Heap))) (=> (=> |$w$loop#0@0| ($IsAllocBox ($Box refType |c#0@@1|) Tclass._module.C $Heap)) (=> (= (ControlFlow 0 15) 14) anon8_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |c#0@@1| Tclass._module.C) ($IsAlloc refType |c#0@@1| Tclass._module.C $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 17) 15))) anon0_correct))))
