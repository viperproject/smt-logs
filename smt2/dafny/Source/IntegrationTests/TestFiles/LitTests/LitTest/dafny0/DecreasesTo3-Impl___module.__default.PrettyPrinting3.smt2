...
(set-info :boogie-vc-id Impl$$_module.__default.PrettyPrinting3)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (= $Heap $Heap@0)) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap@0 $Heap@1)) (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (and (= $Heap@1 $Heap@2) (= (ControlFlow 0 2) (- 0 1))))) (and (not (U_2_bool (Lit boolType (bool_2_U false)))) (= |b#0|  (not |b#0|))))))))
