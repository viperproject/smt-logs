...
(set-info :boogie-vc-id Impl$$Alt.__default.InfNotEven)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (not (U_2_bool (Lit boolType (bool_2_U (Alt.__default.Even ($LS ($LS $LZ)) (Lit DatatypeTypeType |#Alt.natinf.Inf|)))))))))
(let ((anon3_Else_correct  (=> (and (not (U_2_bool (Lit boolType (bool_2_U (Alt.__default.Even ($LS $LZ) (Lit DatatypeTypeType |#Alt.natinf.Inf|)))))) (= (ControlFlow 0 5) 2)) GeneratedUnifiedExit_correct)))
(let ((anon3_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U (Alt.__default.Even ($LS $LZ) (Lit DatatypeTypeType |#Alt.natinf.Inf|))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (=> (|Alt.__default.Even#canCall| (Lit DatatypeTypeType |#Alt.natinf.Inf|)) (or (U_2_bool (Lit boolType (bool_2_U (Alt.__default.Even ($LS $LZ) (Lit DatatypeTypeType |#Alt.natinf.Inf|))))) (or (and (Alt.natinf.N_q (Lit DatatypeTypeType |#Alt.natinf.Inf|)) (= (LitInt (Alt.natinf.n (Lit DatatypeTypeType |#Alt.natinf.Inf|))) (LitInt 0))) (exists ((|y#0@@1| T@U) ) (!  (and ($Is DatatypeTypeType |y#0@@1| Tclass.Alt.natinf) (and (|Alt.natinf#Equal| |#Alt.natinf.Inf| (Alt.__default.S (Alt.__default.S |y#0@@1|))) (Alt.__default.Even ($LS ($LS $LZ)) |y#0@@1|)))
 :qid |InductivePredicatesdfy.132:12|
 :skolemid |736|
 :pattern ( (Alt.__default.Even ($LS ($LS $LZ)) |y#0@@1|))
 :pattern ( (Alt.__default.S (Alt.__default.S |y#0@@1|)))
)))))) (=> (=> (|Alt.__default.Even#canCall| (Lit DatatypeTypeType |#Alt.natinf.Inf|)) (or (U_2_bool (Lit boolType (bool_2_U (Alt.__default.Even ($LS $LZ) (Lit DatatypeTypeType |#Alt.natinf.Inf|))))) (or (and (Alt.natinf.N_q (Lit DatatypeTypeType |#Alt.natinf.Inf|)) (= (LitInt (Alt.natinf.n (Lit DatatypeTypeType |#Alt.natinf.Inf|))) (LitInt 0))) (exists ((|y#0@@2| T@U) ) (!  (and ($Is DatatypeTypeType |y#0@@2| Tclass.Alt.natinf) (and (|Alt.natinf#Equal| |#Alt.natinf.Inf| (Alt.__default.S (Alt.__default.S |y#0@@2|))) (Alt.__default.Even ($LS ($LS $LZ)) |y#0@@2|)))
 :qid |InductivePredicatesdfy.132:12|
 :skolemid |736|
 :pattern ( (Alt.__default.Even ($LS ($LS $LZ)) |y#0@@2|))
 :pattern ( (Alt.__default.S (Alt.__default.S |y#0@@2|)))
))))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (U_2_bool (Lit boolType (bool_2_U false)))) (and (= $Heap $Heap@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and (= |##x#1@0| (Lit DatatypeTypeType |#Alt.natinf.Inf|)) ($IsAlloc DatatypeTypeType |##x#1@0| Tclass.Alt.natinf $Heap)) (and (|Alt.__default.Even#canCall| (Lit DatatypeTypeType |#Alt.natinf.Inf|)) (|Alt.__default.Even#canCall| (Lit DatatypeTypeType |#Alt.natinf.Inf|)))) (and (=> (= (ControlFlow 0 6) 3) anon3_Then_correct) (=> (= (ControlFlow 0 6) 5) anon3_Else_correct))))))
