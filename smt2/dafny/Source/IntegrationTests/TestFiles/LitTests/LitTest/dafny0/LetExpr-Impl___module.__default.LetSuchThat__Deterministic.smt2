...
(set-info :boogie-vc-id Impl$$_module.__default.LetSuchThat__Deterministic)
...
(let ((anon18_Then_correct  (and (=> (= (ControlFlow 0 24) (- 0 26)) (or (and ($Is intType (int_2_U (LitInt (- 0 1))) TInt) (U_2_bool (Lit boolType (bool_2_U (< (- 0 1) 0))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (U_2_bool (Lit boolType (bool_2_U (< 0 0))))) (exists ((|y#2_0| Int) ) (! (< |y#2_0| 0)
 :qid |LetExprdfy.323:16|
 :skolemid |2330|
))))) (=> (or (and ($Is intType (int_2_U (LitInt (- 0 1))) TInt) (U_2_bool (Lit boolType (bool_2_U (< (- 0 1) 0))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (U_2_bool (Lit boolType (bool_2_U (< 0 0))))) (exists ((|y#2_0@@0| Int) ) (! (< |y#2_0@@0| 0)
 :qid |LetExprdfy.323:16|
 :skolemid |2330|
)))) (=> (and (< |y#2_1@0| 0) (< |y#2_2@0| 0)) (and (=> (= (ControlFlow 0 24) (- 0 25)) (= |y#2_1@0| |y#2_2@0|)) (=> (= |y#2_1@0| |y#2_2@0|) (=> (and (and |$let#2$canCall| |$let#2$canCall|) (and (= |x#0@2| (let ((|y#2_0@@1| |$let#2_y|))
...
(let ((anon20_Then_correct  (and (=> (= (ControlFlow 0 19) (- 0 21)) (or (and ($Is intType (int_2_U (LitInt (- 0 1))) TInt) (U_2_bool (Lit boolType (bool_2_U (< (- 0 1) 0))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (U_2_bool (Lit boolType (bool_2_U (< 0 0))))) (exists ((|y#1_0| Int) ) (! (< |y#1_0| 0)
 :qid |LetExprdfy.325:16|
 :skolemid |2329|
))))) (=> (or (and ($Is intType (int_2_U (LitInt (- 0 1))) TInt) (U_2_bool (Lit boolType (bool_2_U (< (- 0 1) 0))))) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (U_2_bool (Lit boolType (bool_2_U (< 0 0))))) (exists ((|y#1_0@@0| Int) ) (! (< |y#1_0@@0| 0)
 :qid |LetExprdfy.325:16|
 :skolemid |2329|
)))) (=> (and (< |y#1_1@0| 0) (< |y#1_2@0| 0)) (and (=> (= (ControlFlow 0 19) (- 0 20)) (= (Mul |y#1_1@0| (LitInt 0)) (Mul |y#1_2@0| (LitInt 0)))) (=> (= (Mul |y#1_1@0| (LitInt 0)) (Mul |y#1_2@0| (LitInt 0))) (=> (and (and |$let#1$canCall| |$let#1$canCall|) (and (= |x#0@1| (let ((|y#1_0@@1| |$let#1_y|))
...
(let ((anon22_Then_correct  (and (=> (= (ControlFlow 0 15) (- 0 17)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (LitInt 0) (LitInt (Mul (LitInt 2) (LitInt 0))))) (exists ((|w#0_0| Int) ) (! (= |w#0_0| (Mul (LitInt 2) |w#0_0|))
 :qid |LetExprdfy.327:16|
 :skolemid |2328|
)))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (= (LitInt 0) (LitInt (Mul (LitInt 2) (LitInt 0))))) (exists ((|w#0_0@@0| Int) ) (! (= |w#0_0@@0| (Mul (LitInt 2) |w#0_0@@0|))
 :qid |LetExprdfy.327:16|
 :skolemid |2328|
))) (=> (and (= |w#0_1@0| (Mul (LitInt 2) |w#0_1@0|)) (= |w#0_2@0| (Mul (LitInt 2) |w#0_2@0|))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= |w#0_1@0| |w#0_2@0|)) (=> (= |w#0_1@0| |w#0_2@0|) (=> (and (and |$let#0$canCall| |$let#0$canCall|) (and (= |x#0@0| (let ((|w#0_0@@1| |$let#0_w|))
