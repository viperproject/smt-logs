...
procedure {:verboseName "X.M (well-formedness)"} CheckWellFormed$$X.__default.M()
   returns (i#0: int where LitInt(0) <= i#0 && i#0 < 100, 
    r#0: real where LitReal(0e0) <= r#0 && r#0 <= LitReal(1e2));
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "X.M (call)"} Call$$X.__default.M()
   returns (i#0: int where LitInt(0) <= i#0 && i#0 < 100, 
    r#0: real where LitReal(0e0) <= r#0 && r#0 <= LitReal(1e2));
  modifies $Heap;
...
procedure {:verboseName "X.M (correctness)"} Impl$$X.__default.M()
   returns (i#0: int where LitInt(0) <= i#0 && i#0 < 100, 
    r#0: real where LitReal(0e0) <= r#0 && r#0 <= LitReal(1e2), 
    $_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "X.M (correctness)"} Impl$$X.__default.M() returns (i#0: int, r#0: real, $_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var newtype$check#0: int;
  var newtype$check#1: real;

    // AddMethodImpl: M, Impl$$X.__default.M
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Newtypes.dfy(148,7)
    assume true;
    newtype$check#0 := LitInt(4);
    assert {:id "id107"} LitInt(0) <= newtype$check#0 && newtype$check#0 < 100;
    assume true;
    i#0 := LitInt(4);
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/Newtypes.dfy(149,7)
    assume true;
    newtype$check#1 := LitReal(4e0);
    assert {:id "id109"} LitReal(0e0) <= newtype$check#1 && newtype$check#1 <= LitReal(1e2);
    assume true;
    r#0 := LitReal(4e0);
}
...
procedure {:verboseName "X.N (well-formedness)"} CheckWellFormed$$X.__default.N();
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "X.N (call)"} Call$$X.__default.N();
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
    { $Heap[$o] } 
...
procedure {:verboseName "X.N (correctness)"} Impl$$X.__default.N() returns ($_reverifyPost: bool);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
procedure {:verboseName "X.Int (well-formedness)"} CheckWellFormed$$X.Int(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "X.Int (well-formedness)"} CheckWellFormed$$X.Int(x#0: int)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype Int
    ...
    if (*)
    {
        ...
        assume {:id "id117"} LitInt(0) <= x#0 && x#0 < 100;
        assume false;
    }
    ...
    if (*)
    {
        ...
        assume true;
        assert {:id "id118"} {:subsumption 0} LitInt(0) <= LitInt(0);
        assert {:id "id119"} {:subsumption 0} Lit(0 < 100);
        assume false;
    }
}
...
function Tclass.X.Int() : Ty
uses {
// Tclass.X.Int Tag
axiom Tag(Tclass.X.Int()) == Tagclass.X.Int
   && TagFamily(Tclass.X.Int()) == tytagFamily$Int;
}

const unique Tagclass.X.Int: TyTag;

// Box/unbox axiom for Tclass.X.Int
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.X.Int()) } 
  $IsBox(bx, Tclass.X.Int())
     ==> $Box($Unbox(bx): int) == bx && $Is($Unbox(bx): int, Tclass.X.Int()));

// $Is axiom for newtype X.Int
axiom (forall x#0: int :: 
  { $Is(x#0, Tclass.X.Int()) } 
  $Is(x#0, Tclass.X.Int()) <==> LitInt(0) <= x#0 && x#0 < 100);

// $IsAlloc axiom for newtype X.Int
axiom (forall x#0: int, $h: Heap :: 
  { $IsAlloc(x#0, Tclass.X.Int(), $h) } 
  $IsAlloc(x#0, Tclass.X.Int(), $h));

const unique class.X.Int: ClassName;

procedure {:verboseName "X.Real (well-formedness)"} CheckWellFormed$$X.Real(r#0: real);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "X.Real (well-formedness)"} CheckWellFormed$$X.Real(r#0: real)
{
  var $_ReadsFrame: [ref,Field]bool;


    // AddWellformednessCheck for newtype Real
    $_ReadsFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    if (*)
    {
        ...
        assume {:id "id120"} LitReal(0e0) <= r#0 && r#0 <= LitReal(1e2);
        assume false;
    }
    ...
    if (*)
    {
        ...
        assert {:id "id122"} {:subsumption 0} LitReal(0e0) <= LitReal(1e2);
        assume false;
    }
}
...
function Tclass.X.Real() : Ty
uses {
// Tclass.X.Real Tag
axiom Tag(Tclass.X.Real()) == Tagclass.X.Real
   && TagFamily(Tclass.X.Real()) == tytagFamily$Real;
}

const unique Tagclass.X.Real: TyTag;

// Box/unbox axiom for Tclass.X.Real
axiom (forall bx: Box :: 
  { $IsBox(bx, Tclass.X.Real()) } 
  $IsBox(bx, Tclass.X.Real())
     ==> $Box($Unbox(bx): real) == bx && $Is($Unbox(bx): real, Tclass.X.Real()));

// $Is axiom for newtype X.Real
axiom (forall r#0: real :: 
  { $Is(r#0, Tclass.X.Real()) } 
  $Is(r#0, Tclass.X.Real()) <==> LitReal(0e0) <= r#0 && r#0 <= LitReal(1e2));

// $IsAlloc axiom for newtype X.Real
axiom (forall r#0: real, $h: Heap :: 
  { $IsAlloc(r#0, Tclass.X.Real(), $h) } 
  $IsAlloc(r#0, Tclass.X.Real(), $h));

const unique class.X.Real: ClassName;
...
const unique tytagFamily$Real: TyTagFamily;
