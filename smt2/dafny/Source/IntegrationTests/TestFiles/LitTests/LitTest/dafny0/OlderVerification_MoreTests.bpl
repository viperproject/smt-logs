...
axiom 2 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: DatatypeType, y#0: Set :: 
   ...
   ==> (forall $ly: LayerType, x#0: DatatypeType, y#0: Set :: 
    ...
    MoreTests.__default.P#canCall(x#0, y#0)
       ...
       ==> (!MoreTests.List.Nil_q(x#0)
           ==> (var tail#1 := MoreTests.List._h18(x#0); 
            (var head#1 := $Unbox(MoreTests.List._h17(x#0)): ref; 
              Set#IsMember(y#0, $Box(head#1)) ==> MoreTests.__default.P#canCall(tail#1, y#0))))
         && MoreTests.__default.P($LS($ly), x#0, y#0)
           == (if MoreTests.List.Nil_q(x#0)
             then true
             else (var tail#0 := MoreTests.List._h18(x#0); 
              (var head#0 := $Unbox(MoreTests.List._h17(x#0)): ref; 
                Set#IsMember(y#0, $Box(head#0)) && MoreTests.__default.P($ly, tail#0, y#0)))));
   ...
   ==> (forall $ly: LayerType, x#0: DatatypeType, y#0: Set :: 
    ...
    MoreTests.__default.P#canCall(Lit(x#0), Lit(y#0))
       ...
       ==> (!Lit(MoreTests.List.Nil_q(Lit(x#0)))
           ==> (var tail#3 := Lit(MoreTests.List._h18(Lit(x#0))); 
            (var head#3 := Lit($Unbox(MoreTests.List._h17(Lit(x#0))): ref); 
              Set#IsMember(Lit(y#0), $Box(head#3))
                 ==> MoreTests.__default.P#canCall(tail#3, Lit(y#0)))))
         && MoreTests.__default.P($LS($ly), Lit(x#0), Lit(y#0))
           == (if MoreTests.List.Nil_q(Lit(x#0))
             then true
             else (var tail#2 := Lit(MoreTests.List._h18(Lit(x#0))); 
              (var head#2 := Lit($Unbox(MoreTests.List._h17(Lit(x#0))): ref); 
                Set#IsMember(Lit(y#0), $Box(head#2))
                   && MoreTests.__default.P($LS($ly), tail#2, Lit(y#0))))));
}
...
procedure {:verboseName "MoreTests.P (well-formedness)"} CheckWellformed$$MoreTests.__default.P(x#0: DatatypeType where $Is(x#0, Tclass.MoreTests.List(Tclass.MoreTests.C())), 
    y#0: Set where $Is(y#0, TSet(Tclass.MoreTests.C())));
  ...
  ensures (forall $olderHeap: Heap :: 
    ...
    $IsGoodHeap($olderHeap)
         && $OlderTag($olderHeap)
         && 
        MoreTests.__default.P($LS($LZ), x#0, y#0)
         && $IsAlloc(y#0, TSet(Tclass.MoreTests.C()), $olderHeap)
       ==> $IsAlloc(x#0, Tclass.MoreTests.List(Tclass.MoreTests.C()), $olderHeap));



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "MoreTests.P (well-formedness)"} CheckWellformed$$MoreTests.__default.P(x#0: DatatypeType, y#0: Set)
{
  ...
  var ##y#0: Set;
    ...
    else
    {
        ...
        if (x#0 == #MoreTests.List.Nil())
        {
            assume {:id "id139"} MoreTests.__default.P($LS($LZ), x#0, y#0) == Lit(true);
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(MoreTests.__default.P($LS($LZ), x#0, y#0), TBool);
            return;
        }
        else if (x#0 == #MoreTests.List.Cons($Box(_mcc#0#0), _mcc#1#0))
        {
            assume $Is(_mcc#0#0, Tclass.MoreTests.C());
            assume $Is(_mcc#1#0, Tclass.MoreTests.List(Tclass.MoreTests.C()));
            havoc tail#Z#0;
            assume {:id "id133"} let#0#0#0 == _mcc#1#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#0#0#0, Tclass.MoreTests.List(Tclass.MoreTests.C()));
            assume {:id "id134"} tail#Z#0 == let#0#0#0;
            havoc head#Z#0;
            assume {:id "id135"} let#1#0#0 == _mcc#0#0;
            assume true;
            // CheckWellformedWithResult: any expression
            assume $Is(let#1#0#0, Tclass.MoreTests.C());
            assume {:id "id136"} head#Z#0 == let#1#0#0;
            if (Set#IsMember(y#0, $Box(head#Z#0)))
            {
                ##x#0 := tail#Z#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##x#0, Tclass.MoreTests.List(Tclass.MoreTests.C()), $Heap);
                ##y#0 := y#0;
                // assume allocatedness for argument to function
                assume $IsAlloc(##y#0, TSet(Tclass.MoreTests.C()), $Heap);
                assert {:id "id137"} DtRank(##x#0) < DtRank(x#0)
                   || (DtRank(##x#0) == DtRank(x#0)
                     && 
                    Set#Subset(##y#0, y#0)
                     && !Set#Subset(y#0, ##y#0));
                assume MoreTests.__default.P#canCall(tail#Z#0, y#0);
            }

            assume {:id "id138"} MoreTests.__default.P($LS($LZ), x#0, y#0)
               == (Set#IsMember(y#0, $Box(head#Z#0))
                 && MoreTests.__default.P($LS($LZ), tail#Z#0, y#0));
            assume Set#IsMember(y#0, $Box(head#Z#0))
               ==> MoreTests.__default.P#canCall(tail#Z#0, y#0);
            // CheckWellformedWithResult: any expression
            assume $Is(MoreTests.__default.P($LS($LZ), x#0, y#0), TBool);
            return;
        }
...
axiom {:id "id140"} 3 <= $FunctionContextHeight
   ==> (forall y#0: Set :: 
    { MoreTests.__default.F(y#0) } 
    MoreTests.__default.F#canCall(y#0)
         || (3 < $FunctionContextHeight && $Is(y#0, TSet(Tclass.MoreTests.C())))
       ==> (forall x#0: DatatypeType :: 
          { MoreTests.__default.G(x#0, y#0) } 
            { MoreTests.__default.P($LS($LZ), x#0, y#0) } 
          $Is(x#0, Tclass.MoreTests.List(Tclass.MoreTests.C()))
             ==> MoreTests.__default.P#canCall(x#0, y#0)
               && (MoreTests.__default.P($LS($LZ), x#0, y#0)
                 ==> MoreTests.__default.G#canCall(x#0, y#0)))
         && MoreTests.__default.F(y#0)
           == (if (forall x#0: DatatypeType :: 
              { MoreTests.__default.G(x#0, y#0) } 
                { MoreTests.__default.P($LS($LZ), x#0, y#0) } 
              $Is(x#0, Tclass.MoreTests.List(Tclass.MoreTests.C()))
                 ==> 
                MoreTests.__default.P($LS($LZ), x#0, y#0)
                 ==> MoreTests.__default.G(x#0, y#0) == LitInt(3))
             then 100
             else 0));
...
axiom {:id "id141"} 3 <= $FunctionContextHeight
   ==> (forall y#0: Set :: 
    ...
    MoreTests.__default.F#canCall(Lit(y#0))
         || (3 < $FunctionContextHeight && $Is(y#0, TSet(Tclass.MoreTests.C())))
       ==> (forall x#1: DatatypeType :: 
          { MoreTests.__default.G(x#1, y#0) } 
            { MoreTests.__default.P($LS($LZ), x#1, y#0) } 
          $Is(x#1, Tclass.MoreTests.List(Tclass.MoreTests.C()))
             ==> MoreTests.__default.P#canCall(x#1, Lit(y#0))
               && (MoreTests.__default.P($LS($LZ), x#1, Lit(y#0))
                 ==> MoreTests.__default.G#canCall(x#1, Lit(y#0))))
         && MoreTests.__default.F(Lit(y#0))
           == (if (forall x#1: DatatypeType :: 
              { MoreTests.__default.G(x#1, y#0) } 
                { MoreTests.__default.P($LS($LZ), x#1, y#0) } 
              $Is(x#1, Tclass.MoreTests.List(Tclass.MoreTests.C()))
                 ==> 
                MoreTests.__default.P($LS($LZ), x#1, Lit(y#0))
                 ==> MoreTests.__default.G(x#1, Lit(y#0)) == LitInt(3))
             then 100
             else 0));
}
...
procedure {:verboseName "MoreTests.F (well-formedness)"} CheckWellformed$$MoreTests.__default.F(y#0: Set where $Is(y#0, TSet(Tclass.MoreTests.C())));
...
procedure {:verboseName "MoreTests.G (well-formedness)"} CheckWellformed$$MoreTests.__default.G(x#0: DatatypeType where $Is(x#0, Tclass.MoreTests.List(Tclass.MoreTests.C())), 
    y#0: Set where $Is(y#0, TSet(Tclass.MoreTests.C())));
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id144"} 3 <= $FunctionContextHeight
   ==> (forall y#0: Set :: 
    { MoreTests.__default.Collection(y#0) } 
    MoreTests.__default.Collection#canCall(y#0)
         || (3 < $FunctionContextHeight && $Is(y#0, TSet(Tclass.MoreTests.C())))
       ==> (forall x#0: DatatypeType :: 
         ...
         && MoreTests.__default.Collection(y#0)
           == (lambda $y#0: Box :: 
            $IsBox($y#0, Tclass.MoreTests.List(Tclass.MoreTests.C()))
               && MoreTests.__default.P($LS($LZ), $Unbox($y#0): DatatypeType, y#0)));
// definition axiom for MoreTests.__default.Collection for all literals (revealed)
axiom {:id "id145"} 3 <= $FunctionContextHeight
   ==> (forall y#0: Set :: 
    ...
    MoreTests.__default.Collection#canCall(Lit(y#0))
       ...
       ==> (forall x#1: DatatypeType :: 
         ...
         && MoreTests.__default.Collection(Lit(y#0))
           == (lambda $y#1: Box :: 
            $IsBox($y#1, Tclass.MoreTests.List(Tclass.MoreTests.C()))
               && MoreTests.__default.P($LS($LZ), $Unbox($y#1): DatatypeType, Lit(y#0))));
}
...
procedure {:verboseName "MoreTests.Collection (well-formedness)"} CheckWellformed$$MoreTests.__default.Collection(y#0: Set where $Is(y#0, TSet(Tclass.MoreTests.C())));
  free requires 3 == $FunctionContextHeight;
  modifies $Heap;
