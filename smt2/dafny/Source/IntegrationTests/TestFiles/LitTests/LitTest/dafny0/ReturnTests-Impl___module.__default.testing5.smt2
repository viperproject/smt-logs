...
(set-info :boogie-vc-id Impl$$_module.__default.testing5)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#1| null $Heap alloc false)) (=> (and (= |r#0@0| (LitInt 2)) (= (ControlFlow 0 2) (- 0 1))) (= |r#0@0| (LitInt 2))))))
