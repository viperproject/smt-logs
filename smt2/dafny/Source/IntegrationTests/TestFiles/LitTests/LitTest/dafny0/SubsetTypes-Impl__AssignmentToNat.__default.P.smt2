...
(set-info :boogie-vc-id Impl$$AssignmentToNat.__default.P)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) ($Is intType (int_2_U |x#0@@1|) Tclass._System.nat)) (=> ($Is intType (int_2_U |x#0@@1|) Tclass._System.nat) (=> (= (ControlFlow 0 2) (- 0 1)) (Requires1 Tclass._System.nat TInt $Heap |f#0| ($Box intType (int_2_U |x#0@@1|)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is HandleTypeType |f#0| (Tclass._System.___hFunc1 Tclass._System.nat TInt)) ($IsAlloc HandleTypeType |f#0| (Tclass._System.___hFunc1 Tclass._System.nat TInt) $Heap))) (=> (and (and (and ($Is HandleTypeType |g#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hFunc1 TInt Tclass._System.nat) $Heap)) (= 0 $FunctionContextHeight)) (and (Requires1 Tclass._System.nat TInt $Heap |f#0| ($Box intType (int_2_U |x#0@@1|))) (= (ControlFlow 0 4) 2))) anon0_correct))))
