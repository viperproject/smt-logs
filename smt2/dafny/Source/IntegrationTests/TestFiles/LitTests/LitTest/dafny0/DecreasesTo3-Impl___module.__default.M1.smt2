...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon2_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (< (LitInt 0) (LitInt 1))) (=> (= (ControlFlow 0 2) (- 0 1)) (< (LitInt 1) (LitInt 0))))))
(let ((anon3_Else_correct  (=> (and (<= (LitInt 1) (LitInt 0)) (= (ControlFlow 0 5) 2)) anon2_correct)))
(let ((anon3_Then_correct  (=> (and (< (LitInt 0) (LitInt 1)) (= (ControlFlow 0 4) 2)) anon2_correct)))
