...
(declare-fun _module.__default.nope3 (T@U) T@U)
(declare-fun SeqType () T@T)
(declare-fun |_module.__default.nope3#canCall| (T@U) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (|xs#0| T@U) ) (!  (=> (or (|_module.__default.nope3#canCall| (Lit SeqType |xs#0|)) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is SeqType |xs#0| (TSeq Tclass._module.C))) (and (> (|Seq#Length| (Lit SeqType |xs#0|)) 0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap ($Unbox refType (|Seq#Index| (Lit SeqType |xs#0|) (LitInt 0)))) _module.C.u))) 0))))) (= (_module.__default.nope3 (Lit SeqType |xs#0|)) (Lit DatatypeTypeType |#_System._tuple#0._#Make0|)))
 :qid |Readsdfy.27:16|
 :weight 3
 :skolemid |552|
 :pattern ( (_module.__default.nope3 (Lit SeqType |xs#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@0 T@U) (|xs#0@@0| T@U) ) (!  (=> (or (|_module.__default.nope3#canCall| |xs#0@@0|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) ($Is SeqType |xs#0@@0| (TSeq Tclass._module.C))) (and (> (|Seq#Length| |xs#0@@0|) 0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 ($Unbox refType (|Seq#Index| |xs#0@@0| (LitInt 0)))) _module.C.u))) 0))))) (= (_module.__default.nope3 |xs#0@@0|) (Lit DatatypeTypeType |#_System._tuple#0._#Make0|)))
 :qid |Readsdfy.27:16|
 :skolemid |551|
 :pattern ( (_module.__default.nope3 |xs#0@@0|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (|xs#0@@1| T@U) ) (!  (=> (or (|_module.__default.nope3#canCall| |xs#0@@1|) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and ($Is SeqType |xs#0@@1| (TSeq Tclass._module.C)) ($IsAlloc SeqType |xs#0@@1| (TSeq Tclass._module.C) $Heap@@1))) (and (> (|Seq#Length| |xs#0@@1|) 0) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 ($Unbox refType (|Seq#Index| |xs#0@@1| (LitInt 0)))) _module.C.u))) 0))))) ($Is DatatypeTypeType (_module.__default.nope3 |xs#0@@1|) Tclass._System.Tuple0))
 :qid |Readsdfy.27:16|
 :skolemid |549|
 :pattern ( (_module.__default.nope3 |xs#0@@1|) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.__default.nope3)
...
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@2 alloc false)) (> (|Seq#Length| |xs#0@@2|) 0)) (and (=> (= (ControlFlow 0 3) (- 0 6)) (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |xs#0@@2|)))) (=> (and (<= 0 (LitInt 0)) (< (LitInt 0) (|Seq#Length| |xs#0@@2|))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= ($Unbox refType (|Seq#Index| |xs#0@@2| (LitInt 0))) null)) (not true))) (=> (or (not (= ($Unbox refType (|Seq#Index| |xs#0@@2| (LitInt 0))) null)) (not true)) (=> (and (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 ($Unbox refType (|Seq#Index| |xs#0@@2| (LitInt 0))) _module.C.u))) (> (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@2 ($Unbox refType (|Seq#Index| |xs#0@@2| (LitInt 0)))) _module.C.u))) 0)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap@@2) ($IsHeapAnchor $Heap@@2)) ($Is SeqType |xs#0@@2| (TSeq Tclass._module.C))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 7) 3))) anon0_correct)))
