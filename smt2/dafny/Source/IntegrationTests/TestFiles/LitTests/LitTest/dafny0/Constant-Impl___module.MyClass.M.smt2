...
(declare-fun _module.MyClass.B (T@U) T@U)
(declare-fun Tclass._module.MyClass () T@U)
...
(assert (distinct alloc Tagclass._System.array? Tagclass._System.array Tagclass._module.byte Tagclass._module.MyClass? Tagclass._module.MyClass tytagFamily$array tytagFamily$byte tytagFamily$MyClass)
)
...
(assert  (=> (< 1 $FunctionContextHeight) (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (= (dtype $o@@0) Tclass._module.MyClass?)) ($Is refType (_module.MyClass.B $o@@0) (Tclass._System.array Tclass._module.byte)))
 :qid |unknown.0:0|
 :skolemid |2103|
 :pattern ( (_module.MyClass.B $o@@0))
))))
...
(assert  (=> (< 1 $FunctionContextHeight) (forall (($h@@2 T@U) ($o@@1 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@1 null)) (not true)) (= (dtype $o@@1) Tclass._module.MyClass?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))) ($IsAlloc refType (_module.MyClass.B $o@@1) (Tclass._System.array Tclass._module.byte) $h@@2))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |2104|
 :pattern ( (_module.MyClass.B $o@@1) ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@1) alloc)))
))))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |x#0@0| (_module.MyClass.B this)) (= (ControlFlow 0 2) (- 0 1))) ($Is refType |x#0@0| (Tclass._System.array Tclass._module.byte))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.MyClass) ($IsAlloc refType this Tclass._module.MyClass $Heap)))) (and (and ($Is refType |x#0@@1| (Tclass._System.array? Tclass._module.byte)) ($IsAlloc refType |x#0@@1| (Tclass._System.array? Tclass._module.byte) $Heap)) true)) (and (and (and ($Is refType |y#0| (Tclass._System.array Tclass._module.byte)) ($IsAlloc refType |y#0| (Tclass._System.array Tclass._module.byte) $Heap)) true) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 3) 2)))) anon0_correct)))
