...
(declare-fun _module._default.Negation0$_T0 () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.Negation0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 15) (let ((anon7_correct  (and (=> (= (ControlFlow 0 5) (- 0 7)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.Negation0$_T0) (|Set#IsMember| |s#0@0| |$as#x0_0#0_0|))
 :qid |Terminationdfy.890:9|
 :skolemid |3294|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.Negation0$_T0) (|Set#IsMember| |s#0@0| |$as#x0_0#0_0@@0|))
 :qid |Terminationdfy.890:9|
 :skolemid |3294|
)) (=> (and (=> true (and ($IsBox |x#0_0@1| _module._default.Negation0$_T0) ($IsAllocBox |x#0_0@1| _module._default.Negation0$_T0 $Heap))) (|Set#IsMember| |s#0@0| |x#0_0@1|)) (and (=> (= (ControlFlow 0 5) (- 0 6)) true) (=> (and (= |s#0@1| (|Set#Difference| |s#0@0| (|Set#UnionOne| |Set#Empty| |x#0_0@1|))) (= (ControlFlow 0 5) (- 0 4))) (and (|Set#Subset| |s#0@1| |s#0@0|) (not (|Set#Subset| |s#0@0| |s#0@1|))))))))))
(let ((anon11_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.Negation0$_T0) ($IsAllocBox |x#0_1@1| _module._default.Negation0$_T0 $Heap))) (= (ControlFlow 0 9) 5)) anon7_correct)))
(let ((anon11_Then_correct  (=> (and (and ($IsBox |x#0_1@1| _module._default.Negation0$_T0) ($IsAllocBox |x#0_1@1| _module._default.Negation0$_T0 $Heap)) (= (ControlFlow 0 8) 5)) anon7_correct)))
...
(let ((anon8_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.Negation0$_T0) ($IsAllocBox |x#0_0@0| _module._default.Negation0$_T0 $Heap))) (=> (and (and (and ($Is SetType |s#0@0| (TSet _module._default.Negation0$_T0)) ($IsAlloc SetType |s#0@0| (TSet _module._default.Negation0$_T0) $Heap)) (not false)) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.889:3|
 :skolemid |3292|
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is SetType |S#0| (TSet _module._default.Negation0$_T0)) ($IsAlloc SetType |S#0| (TSet _module._default.Negation0$_T0) $Heap))) (=> (and (and (and ($Is SetType |s#0| (TSet _module._default.Negation0$_T0)) ($IsAlloc SetType |s#0| (TSet _module._default.Negation0$_T0) $Heap)) true) (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.Negation0$_T0) ($IsAllocBox |x#0_0| _module._default.Negation0$_T0 $Heap))) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 15) 14)))) anon0_correct))))
