...
(declare-fun _module.SeqOp.S0 (T@U Int) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.S0#canCall| (T@U Int) Bool)
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.S0#canCall| this (LitInt |n#0|)) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) (= (_module.SeqOp.S0 this (LitInt |n#0|)) (|Seq#Create| TReal $Heap (LitInt |n#0|) (|_module.SeqOp.G#Handle| this))))
 :qid |Comprehensionsdfy.98:12|
 :weight 3
 :skolemid |558|
 :pattern ( (_module.SeqOp.S0 this (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((this@@1 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.S0#canCall| this@@1 |n#0@@0|) (and (< 1 $FunctionContextHeight) (and (and (or (not (= this@@1 null)) (not true)) ($Is refType this@@1 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)))) ($Is SeqType (_module.SeqOp.S0 this@@1 |n#0@@0|) (TSeq TReal)))
 :qid |Comprehensionsdfy.98:12|
 :skolemid |551|
 :pattern ( (_module.SeqOp.S0 this@@1 |n#0@@0|))
))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.S0#canCall| (Lit refType this@@2) (LitInt |n#0@@1|)) (and (< 1 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@1|)))) (= (_module.SeqOp.S0 (Lit refType this@@2) (LitInt |n#0@@1|)) (|Seq#Create| TReal $Heap@@1 (LitInt |n#0@@1|) (|_module.SeqOp.G#Handle| (Lit refType this@@2)))))
 :qid |Comprehensionsdfy.98:12|
 :weight 3
 :skolemid |559|
 :pattern ( (_module.SeqOp.S0 (Lit refType this@@2) (LitInt |n#0@@1|)) ($IsGoodHeap $Heap@@1))
))))
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.S0)
...
(assert (not
 ...
 :qid |Comprehensionsdfy.99:5|
 :skolemid |562|
))) (= (_module.SeqOp.S0 this@@5 |n#0@@3|) (|Seq#Create| TReal $Heap@@4 |n#0@@3| (|_module.SeqOp.G#Handle| this@@5)))) (and ($Is SeqType (_module.SeqOp.S0 this@@5 |n#0@@3|) (TSeq TReal)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))))))
