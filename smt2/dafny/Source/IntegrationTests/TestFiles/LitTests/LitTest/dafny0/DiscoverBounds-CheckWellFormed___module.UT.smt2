...
(set-info :boogie-vc-id CheckWellFormed$$_module.UT)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon6_Then_correct  (=> (and (= |newtype$check#0@0| (LitInt 0)) (= (ControlFlow 0 3) (- 0 2))) (and (<= (LitInt 0) |newtype$check#0@0|) (< |newtype$check#0@0| 100)))))
