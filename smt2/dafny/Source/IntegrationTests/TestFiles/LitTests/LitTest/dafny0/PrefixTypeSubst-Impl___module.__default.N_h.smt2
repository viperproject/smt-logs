...
(declare-fun |_module._default.N#$D0| () T@U)
(declare-fun |_module._default.N#$D1| () T@U)
(declare-fun |_module._default.N#$D2| () T@U)
(declare-fun |o#1| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.N_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.MyClass.R_h#canCall| |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| |o#1| |_k#0@@4|) (or (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| |_k#0@@4|) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS ($LS $LZ)) |o#1| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1))))))) (=> (=> (|_module.MyClass.R_h#canCall| |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| |o#1| |_k#0@@4|) (or (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| |_k#0@@4|) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS ($LS $LZ)) |o#1| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.MyClass.R_h#canCall| |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| |o#1| |_k#0@@4|) (or (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| |_k#0@@4|) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@4|) (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS ($LS $LZ)) |o#1| |_k'#1@@1|))
 :qid |PrefixTypeSubstdfy.9:22|
 :skolemid |1207|
 :pattern ( (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS ($LS $LZ)) |o#1| |_k'#1@@1|))
))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@4|) 0) (=> (and (and (and ($IsGoodHeap $Heap@2) ($IsHeapAnchor $Heap@2)) (= $Heap@0 $Heap@2)) (and (forall ((|_k'#2@@1| T@U) (|o#2| T@U) ) (!  (=> (and ($Is refType |o#2| (Tclass._module.MyClass |_module._default.N#$D0| |_module._default.N#$D1|)) (|ORD#Less| |_k'#2@@1| |_k#0@@4|)) (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#2| |_k'#2@@1|))
 :qid |PrefixTypeSubstdfy.38:16|
 :skolemid |1212|
 :pattern ( (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#2| |_k'#2@@1|))
)) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@4|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@4|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (|_module.MyClass.R_h#canCall| |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| |o#1| |_k##0@0|)) (and (and (|_module.MyClass.R_h#canCall| |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| |o#1| |_k##0@0|) (and (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| |_k##0@0|) (and (=> (< 0 (|ORD#Offset| |_k##0@0|)) (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)))) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k##0@0|) (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| |_k'#0@@1|))
 :qid |PrefixTypeSubstdfy.9:22|
 :skolemid |1206|
 :pattern ( (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| |_k'#0@@1|))
)))))) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 4) 2)))) GeneratedUnifiedExit_correct)))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#_k0#0| T@U) ) (!  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (or (|ORD#Less| |$ih#_k0#0| |_k#0@@4|) (and (= |$ih#_k0#0| |_k#0@@4|) (and (= |o#1| null) (or (not (= |o#1| null)) (not true)))))) (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| |$ih#_k0#0|))
 :qid |PrefixTypeSubstdfy.38:16|
 :skolemid |1210|
 :pattern ( (_module.MyClass.R_h |_module._default.N#$D0| |_module._default.N#$D1| |_module._default.N#$D2| ($LS $LZ) |o#1| |$ih#_k0#0|))
)))) (and (=> (= (ControlFlow 0 8) 4) anon3_Then_correct) (=> (= (ControlFlow 0 8) 7) anon3_Else_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is refType |o#1| (Tclass._module.MyClass |_module._default.N#$D0| |_module._default.N#$D1|)) ($IsAlloc refType |o#1| (Tclass._module.MyClass |_module._default.N#$D0| |_module._default.N#$D1|) $Heap)) (and (= 2 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
