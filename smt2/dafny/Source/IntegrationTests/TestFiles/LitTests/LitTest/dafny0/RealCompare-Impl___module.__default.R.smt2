...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= |x##0@0| (- |x#0| 1.0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (<= 0.0 |x#0|) (= |x##0@0| |x#0|))) (=> (or (<= 0.0 |x#0|) (= |x##0@0| |x#0|)) (=> (= (ControlFlow 0 2) (- 0 1)) (<= |x##0@0| (- |x#0| 1.0))))))))
