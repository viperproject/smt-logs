...
(let ((anon4_correct  (=> (and (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|))))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|))))) (=> (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|)))) (=> (and (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0|) ($Box intType (int_2_U |i#0@0|))))) (Mul |i#0@0| |i#0@0|)) (= (ControlFlow 0 3) 1)) anon6_correct))))))
...
(let ((anon7_Else_correct  (=> (and (=> (and (<= (LitInt 0) |i#0@0|) (< |i#0@0| 100)) (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U |i#0@0|)))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0|) ($Box intType (int_2_U |i#0@0|))))) (Mul |i#0@0| |i#0@0|)))) (= (ControlFlow 0 2) 1)) anon6_correct)))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is IMapType |a#0| (TIMap TInt TInt)) ($IsAlloc IMapType |a#0| (TIMap TInt TInt) $Heap)) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
