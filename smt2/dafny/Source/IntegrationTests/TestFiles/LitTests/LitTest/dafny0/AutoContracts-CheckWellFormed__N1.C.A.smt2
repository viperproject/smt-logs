...
(assert (forall ((bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 Tclass.N1.C) (and (= ($Box refType ($Unbox refType bx@@4)) bx@@4) ($Is refType ($Unbox refType bx@@4) Tclass.N1.C)))
 :qid |unknown.0:0|
 :skolemid |1594|
 :pattern ( ($IsBox bx@@4 Tclass.N1.C))
)))
...
(assert (forall (($h0 T@U) ($h1 T@U) (this@@0 T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass.N1.C))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@5 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@5 null)) (not true)) (or (= $o@@5 this@@0) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 this@@0) N1.C.Repr)) ($Box refType $o@@5)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@5) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@5) $f)))
 :qid |unknown.0:0|
 :skolemid |1666|
)) (= (N1.C.Valid $h0 this@@0) (N1.C.Valid $h1 this@@0))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |1667|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (N1.C.Valid $h1 this@@0))
)))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@1 T@U) ) (!  (=> (or (|N1.C.Valid#canCall| $Heap@@0 this@@1) (and (< 0 $FunctionContextHeight) (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass.N1.C) ($IsAlloc refType this@@1 Tclass.N1.C $Heap@@0)))))) (=> (N1.C.Valid $Heap@@0 this@@1) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) N1.C.Repr)) ($Box refType this@@1))))
 :qid |AutoContractsdfy.65:21|
 :skolemid |1668|
 :pattern ( (N1.C.Valid $Heap@@0 this@@1))
))))
...
(set-info :boogie-vc-id CheckWellFormed$$N1.C.A)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@1 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) N1.C.Repr)))) ($IsAllocBox ($Box refType this@@2) Tclass.N1.C? $Heap@@1)) (and (|N1.C.Valid#canCall| $Heap@@1 this@@2) (N1.C.Valid $Heap@@1 this@@2))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (forall (($o@@7 T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7) alloc)))) (or (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 $o@@7)) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 this@@2) N1.C.Repr)) ($Box refType $o@@7))))
 :qid |AutoContractsdfy.81:12|
 :skolemid |1618|
 :pattern ( (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 $o@@7))
)) ($HeapSucc $Heap@@1 $Heap@0))) (and (and ($IsAllocBox ($Box refType this@@2) Tclass.N1.C? $Heap@0) (|N1.C.Valid#canCall| $Heap@0 this@@2)) (and (N1.C.Valid $Heap@0 this@@2) (= (ControlFlow 0 2) (- 0 1))))) ($IsAlloc refType this@@2 Tclass.N1.C $Heap@@1)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass.N1.C) ($IsAlloc refType this@@2 Tclass.N1.C $Heap@@1))) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 3) 2))) anon0_correct))))
