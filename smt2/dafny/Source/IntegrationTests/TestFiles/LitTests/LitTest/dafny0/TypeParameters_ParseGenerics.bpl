...
procedure {:verboseName "ParseGenerics.F (well-formedness)"} CheckWellformed$$ParseGenerics.__default.F(ParseGenerics._default.F$X: Ty, 
...
procedure {:verboseName "ParseGenerics.M (well-formedness)"} CheckWellFormed$$ParseGenerics.__default.M();
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ParseGenerics.M (call)"} Call$$ParseGenerics.__default.M();
  modifies $Heap;
...
procedure {:verboseName "ParseGenerics.M (correctness)"} Impl$$ParseGenerics.__default.M() returns ($_reverifyPost: bool);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition: object granularity
  free ensures (forall $o: ref :: 
...
function Tclass.ParseGenerics.MyType() : Ty;

function ParseGenerics.__default.F#Handle(ParseGenerics._default.F$X: Ty) : HandleType;
...
axiom (forall $bx: Box, ParseGenerics._default.F$X: Ty, $heap: Heap, $fh$0x#0: Box :: 
  { Set#IsMember(Reads1(ParseGenerics._default.F$X, 
        TInt, 
        $heap, 
        ParseGenerics.__default.F#Handle(ParseGenerics._default.F$X), 
        $fh$0x#0), 
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ParseGenerics.M (correctness)"} Impl$$ParseGenerics.__default.M() returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var pair#0: DatatypeType
     where $Is(pair#0, 
        Tclass._System.Tuple2(Tclass._System.___hTotalFunc1(Tclass.ParseGenerics.MyType(), TInt), TInt))
       && $IsAlloc(pair#0, 
        Tclass._System.Tuple2(Tclass._System.___hTotalFunc1(Tclass.ParseGenerics.MyType(), TInt), TInt), 
        $Heap);
  var pair'#0: DatatypeType
    ...
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(361,14)
    assume true;
    assert {:id "id24"} 0 != $FunctionContextHeight;
    assume true;
    pair#0 := #_System._tuple#2._#Make2($Box(ParseGenerics.__default.F#Handle(Tclass.ParseGenerics.MyType())), 
      $Box(LitInt(5)));
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(362,15)
    assume true;
    assert {:id "id26"} 0 != $FunctionContextHeight;
    assume true;
    pair'#0 := #_System._tuple#2._#Make2($Box(ParseGenerics.__default.F#Handle(Tclass.ParseGenerics.MyType())), 
      $Box(LitInt(5)));
}
...
procedure {:verboseName "ParseGenerics.Many (well-formedness)"} CheckWellformed$$ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0: Ty, 
    n#0: DatatypeType
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ParseGenerics.Many (well-formedness)"} CheckWellformed$$ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0: Ty, n#0: DatatypeType)
{
  ...
  var ##n#0: DatatypeType;
    ...
    else
    {
        ...
        {
            assume {:id "id34"} ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, StartFuel_ParseGenerics._default.Many, n#0)
               == LitInt(18);
            assume true;
        ...
        else if (n#0 == #ParseGenerics.List.Cons(_mcc#0#0, _mcc#1#0))
        {
            ...
            assert {:id "id32"} DtRank(##n#0) < DtRank(n#0);
            assume ParseGenerics.__default.Many#canCall(ParseGenerics._default.Many$_T0, tail#Z#0);
            assume {:id "id33"} ParseGenerics.__default.Many(ParseGenerics._default.Many$_T0, StartFuel_ParseGenerics._default.Many, n#0)
...
procedure {:verboseName "ParseGenerics.TestA (well-formedness)"} CheckWellFormed$$ParseGenerics.__default.TestA(u#0: real);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ParseGenerics.TestA (call)"} Call$$ParseGenerics.__default.TestA(u#0: real);
  modifies $Heap;
  // frame condition
...
procedure {:verboseName "ParseGenerics.TestA (correctness)"} Impl$$ParseGenerics.__default.TestA(u#0: real) returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ParseGenerics.TestA (correctness)"} Impl$$ParseGenerics.__default.TestA(u#0: real) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  ...
  var ##n#0: DatatypeType;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(375,12)
    assume true;
    assume true;
    ...
    // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(376,5)
    ##n#0 := xs#0;
    // assume allocatedness for argument to function
    assume $IsAlloc(##n#0, Tclass.ParseGenerics.List(TReal), $Heap);
    assume ParseGenerics.__default.Many#canCall(TReal, xs#0);
    assume ParseGenerics.__default.Many#canCall(TReal, xs#0);
    assert {:id "id36"} {:subsumption 0} ParseGenerics.__default.Many(TReal, StartFuelAssert_ParseGenerics._default.Many, xs#0)
       == LitInt(18);
    assume {:id "id37"} ParseGenerics.__default.Many(TReal, StartFuel_ParseGenerics._default.Many, xs#0)
       == LitInt(18);
}



procedure {:verboseName "ParseGenerics.TestB (well-formedness)"} CheckWellFormed$$ParseGenerics.__default.TestB(u#0: real);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "ParseGenerics.TestB (call)"} Call$$ParseGenerics.__default.TestB(u#0: real);
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
procedure {:verboseName "ParseGenerics.TestB (correctness)"} Impl$$ParseGenerics.__default.TestB(u#0: real) returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  modifies $Heap;
  // frame condition
  free ensures old($Heap) == $Heap;
...
implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "ParseGenerics.TestB (correctness)"} Impl$$ParseGenerics.__default.TestB(u#0: real) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var xs#0: DatatypeType
     where $Is(xs#0, Tclass.ParseGenerics.List(TReal))
  ...
  var ##n#0: DatatypeType;
    ...
    $_ModifiesFrame := (lambda $o: ref, $f: Field :: 
      $o != null && $Unbox(read($Heap, $o, alloc)): bool ==> false);
    $_reverifyPost := false;
    // ----- assignment statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(380,12)
    assume true;
    assume true;
    xs#0 := #ParseGenerics.List.Cons($Box(u#0), 
      #ParseGenerics.List.Cons($Box(u#0), 
    ...
    if (*)
    {
        ...
        // ----- assert statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/TypeParameters.dfy(382,5)
        ##n#0 := xs#0;
        // assume allocatedness for argument to function
        assume $IsAlloc(##n#0, Tclass.ParseGenerics.List(TReal), $Heap);
        assume ParseGenerics.__default.Many#canCall(TReal, xs#0);
        assume ParseGenerics.__default.Many#canCall(TReal, xs#0);
        assert {:id "id39"} {:subsumption 0} ParseGenerics.__default.Many(TReal, StartFuelAssert_ParseGenerics._default.Many, xs#0)
           == LitInt(18);
    }

    assume {:id "id40"} ParseGenerics.__default.Many(TReal, StartFuelAssert_ParseGenerics._default.Many, xs#0)
       == LitInt(18);
}
