...
(set-info :boogie-vc-id Impl$$_module.__default.TestIMapPropertyMembership1)
...
(let ((anon3_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (exists ((|v#1| T@U) ) (! (U_2_bool (MapType0Select BoxType boolType (|IMap#Values| |m#0|) ($Box bv3Type |v#1|)))
 :qid |Mapsdfy.625:17|
 :skolemid |888|
 :pattern ( (MapType0Select BoxType boolType (|IMap#Values| |m#0|) ($Box bv3Type |v#1|)))
)))))
