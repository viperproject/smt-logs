...
(assert  (and (and (= (Ctor bv3Type) 7) (forall ((arg0@@5 (_ BitVec 3)) ) (! (= (U_2_bv3 (bv3_2_U arg0@@5)) arg0@@5)
 :qid |typeInv:U_2_bv3|
 :pattern ( (bv3_2_U arg0@@5))
...
(assert  (and (and (= (Ctor bv19Type) 8) (forall ((arg0@@6 (_ BitVec 19)) ) (! (= (U_2_bv19 (bv19_2_U arg0@@6)) arg0@@6)
 :qid |typeInv:U_2_bv19|
 :pattern ( (bv19_2_U arg0@@6))
...
(assert (forall ((t0@@1 T@U) (t1@@1 T@U) (heap@@1 T@U) (f@@0 T@U) (bx0 T@U) ) (!  (=> (and ($IsGoodHeap heap@@1) (and ($IsBox bx0 t0@@1) ($Is HandleTypeType f@@0 (Tclass._System.___hFunc1 t0@@1 t1@@1)))) (= (|Set#Equal| (Reads1 t0@@1 t1@@1 $OneHeap f@@0 bx0) |Set#Empty|) (|Set#Equal| (Reads1 t0@@1 t1@@1 heap@@1 f@@0 bx0) |Set#Empty|)))
 :qid |unknown.0:0|
 :skolemid |393|
 :pattern ( (Reads1 t0@@1 t1@@1 $OneHeap f@@0 bx0) ($IsGoodHeap heap@@1))
 :pattern ( (Reads1 t0@@1 t1@@1 heap@@1 f@@0 bx0))
)))
...
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| T@U) ($o@@5 T@U) ($f@@2 T@U) ) (! (= (U_2_bool (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@5 $f@@2))  (=> (and (or (not (= $o@@5 |l#0|)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) |l#1| $o@@5) |l#2|)))) (= $o@@5 |l#3|)))
 :qid |DafnyPreludebpl.156:1|
 :skolemid |1819|
 :pattern ( (MapType1Select refType FieldType boolType (|lambda#0| |l#0| |l#1| |l#2| |l#3|) $o@@5 $f@@2))
)))
...
(assert (forall ((f@@7 T@U) (t0@@9 T@U) (t1@@9 T@U) (h@@4 T@U) ) (!  (=> (and ($IsGoodHeap h@@4) ($IsAlloc HandleTypeType f@@7 (Tclass._System.___hFunc1 t0@@9 t1@@9) h@@4)) (forall ((bx0@@6 T@U) ) (!  (=> (and ($IsAllocBox bx0@@6 t0@@9 h@@4) (Requires1 t0@@9 t1@@9 h@@4 f@@7 bx0@@6)) ($IsAllocBox (Apply1 t0@@9 t1@@9 h@@4 f@@7 bx0@@6) t1@@9 h@@4))
 :qid |unknown.0:0|
 :skolemid |403|
 :pattern ( (Apply1 t0@@9 t1@@9 h@@4 f@@7 bx0@@6))
)))
 :qid |unknown.0:0|
 :skolemid |404|
 :pattern ( ($IsAlloc HandleTypeType f@@7 (Tclass._System.___hFunc1 t0@@9 t1@@9) h@@4))
)))
...
(assert (forall ((f@@8 T@U) (t0@@10 T@U) (t1@@10 T@U) ) (! (= ($Is HandleTypeType f@@8 (Tclass._System.___hFunc1 t0@@10 t1@@10)) (forall ((h@@5 T@U) (bx0@@7 T@U) ) (!  (=> (and (and ($IsGoodHeap h@@5) ($IsBox bx0@@7 t0@@10)) (Requires1 t0@@10 t1@@10 h@@5 f@@8 bx0@@7)) ($IsBox (Apply1 t0@@10 t1@@10 h@@5 f@@8 bx0@@7) t1@@10))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |395|
 :pattern ( (Apply1 t0@@10 t1@@10 h@@5 f@@8 bx0@@7))
)))
 :qid |unknown.0:0|
 :skolemid |396|
...
(assert (forall (($h@@2 T@U) ($o@@6 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@6 null)) (not true)) (= (dtype $o@@6) Tclass.TwoStateAt.Cell?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@6) TwoStateAt.Cell.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |798|
 :pattern ( ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@6) TwoStateAt.Cell.data)))
)))
...
(assert (forall ((f@@9 T@U) (t0@@11 T@U) (t1@@11 T@U) (h@@6 T@U) ) (!  (=> ($IsGoodHeap h@@6) (= ($IsAlloc HandleTypeType f@@9 (Tclass._System.___hFunc1 t0@@11 t1@@11) h@@6) (forall ((bx0@@8 T@U) ) (!  (=> (and (and ($IsBox bx0@@8 t0@@11) ($IsAllocBox bx0@@8 t0@@11 h@@6)) (Requires1 t0@@11 t1@@11 h@@6 f@@9 bx0@@8)) (forall ((r T@U) ) (!  (=> (and (or (not (= r null)) (not true)) (|Set#IsMember| (Reads1 t0@@11 t1@@11 h@@6 f@@9 bx0@@8) ($Box refType r))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h@@6 r) alloc))))
 :qid |unknown.0:0|
 :skolemid |400|
 :pattern ( (|Set#IsMember| (Reads1 t0@@11 t1@@11 h@@6 f@@9 bx0@@8) ($Box refType r)))
)))
 :qid |unknown.0:0|
 :skolemid |401|
 :pattern ( (Apply1 t0@@11 t1@@11 h@@6 f@@9 bx0@@8))
 :pattern ( (Reads1 t0@@11 t1@@11 h@@6 f@@9 bx0@@8))
))))
 :qid |unknown.0:0|
 :skolemid |402|
 :pattern ( ($IsAlloc HandleTypeType f@@9 (Tclass._System.___hFunc1 t0@@11 t1@@11) h@@6))
)))
...
(assert (forall ((t0@@12 T@U) (t1@@12 T@U) (heap@@2 T@U) (f@@10 T@U) (bx0@@9 T@U) ) (!  (=> (and (and ($IsGoodHeap heap@@2) (and ($IsBox bx0@@9 t0@@12) ($Is HandleTypeType f@@10 (Tclass._System.___hFunc1 t0@@12 t1@@12)))) (|Set#Equal| (Reads1 t0@@12 t1@@12 $OneHeap f@@10 bx0@@9) |Set#Empty|)) (= (Requires1 t0@@12 t1@@12 $OneHeap f@@10 bx0@@9) (Requires1 t0@@12 t1@@12 heap@@2 f@@10 bx0@@9)))
 :qid |unknown.0:0|
 :skolemid |394|
 :pattern ( (Requires1 t0@@12 t1@@12 $OneHeap f@@10 bx0@@9) ($IsGoodHeap heap@@2))
 :pattern ( (Requires1 t0@@12 t1@@12 heap@@2 f@@10 bx0@@9))
)))
...
(assert (forall ((bx@@7 T@U) ) (!  (=> ($IsBox bx@@7 (TBitvector 3)) (and (= ($Box bv3Type ($Unbox bv3Type bx@@7)) bx@@7) ($Is bv3Type ($Unbox bv3Type bx@@7) (TBitvector 3))))
 :qid |unknown.0:0|
 :skolemid |347|
 :pattern ( ($IsBox bx@@7 (TBitvector 3)))
)))
(assert (forall ((bx@@8 T@U) ) (!  (=> ($IsBox bx@@8 (TBitvector 19)) (and (= ($Box bv19Type ($Unbox bv19Type bx@@8)) bx@@8) ($Is bv19Type ($Unbox bv19Type bx@@8) (TBitvector 19))))
 :qid |unknown.0:0|
 :skolemid |343|
 :pattern ( ($IsBox bx@@8 (TBitvector 19)))
)))
...
(declare-fun TwoStateAt._default.Test$Y () T@U)
...
(set-info :boogie-vc-id Impl$$TwoStateAt.__default.Test)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 65) (let ((anon13_correct  (=> (and (and (=> (not |b#0|) (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|)) (= (ControlFlow 0 2) (- 0 1))) (not |b#0|)) (= (TwoStateAt.Cell.Sum TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (LitInt 30)))))
(let ((anon19_Else_correct  (=> (and |b#0| (= (ControlFlow 0 6) 2)) anon13_correct)))
(let ((anon19_Then_correct  (=> (not |b#0|) (=> (and ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@4) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@4)) (and (=> (= (ControlFlow 0 3) (- 0 5)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@0)) (=> ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@0) (=> (and (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (= (ControlFlow 0 3) 2)) anon13_correct)))))))))
(let ((anon11_correct  (and (=> (= (ControlFlow 0 7) (- 0 8)) (=> |b#0| (= |u#0@0| (LitInt 21)))) (=> (=> |b#0| (= |u#0@0| (LitInt 21))) (and (=> (= (ControlFlow 0 7) 3) anon19_Then_correct) (=> (= (ControlFlow 0 7) 6) anon19_Else_correct))))))
(let ((anon18_Else_correct  (=> (and (not |b#0|) (= (ControlFlow 0 10) 7)) anon11_correct)))
(let ((anon18_Then_correct  (=> (and |b#0| (= (ControlFlow 0 9) 7)) anon11_correct)))
(let ((anon9_correct  (=> (=> (not |b#0|) (|TwoStateAt.__default.SP#canCall| TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|)) (and (=> (= (ControlFlow 0 11) (- 0 13)) (=> (not |b#0|) (= (TwoStateAt.__default.SP TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|) (LitInt 52)))) (=> (and (and (=> (not |b#0|) (= (TwoStateAt.__default.SP TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|) (LitInt 52))) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@4)) (and (= |##y#9@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##y#9@0|) TInt $Heap@4))) (and (=> (= (ControlFlow 0 11) (- 0 12)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0) (=> (|TwoStateAt.__default.SP#canCall| TInt $Heap@0 $Heap@4 |c#0@@5| ($Box intType (int_2_U (LitInt 0)))) (=> (and (|TwoStateAt.__default.SP#canCall| TInt $Heap@0 $Heap@4 |c#0@@5| ($Box intType (int_2_U (LitInt 0)))) (= |u#0@0| (TwoStateAt.__default.SP TInt $Heap@0 $Heap@4 |c#0@@5| ($Box intType (int_2_U (LitInt 0)))))) (and (=> (= (ControlFlow 0 11) 9) anon18_Then_correct) (=> (= (ControlFlow 0 11) 10) anon18_Else_correct)))))))))))
(let ((anon17_Else_correct  (=> (and |b#0| (= (ControlFlow 0 17) 11)) anon9_correct)))
(let ((anon17_Then_correct  (=> (not |b#0|) (=> (and ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@4) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@4)) (and (=> (= (ControlFlow 0 14) (- 0 16)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@4)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@4) (and (=> (= (ControlFlow 0 14) (- 0 15)) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@4)) (=> ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@4) (=> (and (|TwoStateAt.__default.SP#canCall| TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|) (= (ControlFlow 0 14) 11)) anon9_correct)))))))))
(let ((anon7_correct  (=> (=> |b#0| (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|)) (and (=> (= (ControlFlow 0 18) (- 0 19)) (=> |b#0| (= (let ((|w#0| (TwoStateAt.Cell.Sum TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|)))
|w#0|) (LitInt 32)))) (=> (=> |b#0| (= (let ((|w#0@@0| (TwoStateAt.Cell.Sum TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|)))
|w#0@@0|) (LitInt 32))) (and (=> (= (ControlFlow 0 18) 14) anon17_Then_correct) (=> (= (ControlFlow 0 18) 17) anon17_Else_correct)))))))
(let ((anon16_Else_correct  (=> (and (not |b#0|) (= (ControlFlow 0 23) 18)) anon7_correct)))
(let ((anon16_Then_correct  (=> |b#0| (=> (and ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@4) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@4)) (and (=> (= (ControlFlow 0 20) (- 0 22)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@4)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@4) (and (=> (= (ControlFlow 0 20) (- 0 21)) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@4)) (=> ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@4) (=> (and (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|) (= |let#0#0#0| (TwoStateAt.Cell.Sum TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|))) (=> (and (and (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@4 $Heap@4 |c#0@@5| |y#0@@6|) ($Is intType (int_2_U |let#0#0#0|) TInt)) (and (= |w#Z#0@0| |let#0#0#0|) (= (ControlFlow 0 20) 18))) anon7_correct))))))))))
(let ((anon5_correct  (=> (and (|TwoStateAt.Cell.Plus#canCall| TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (=> (or (not (= (TwoStateAt.Cell.Plus TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (LitInt 21))) (not true)) (|TwoStateAt.Cell.Plus#canCall| TInt $Heap@0 $Heap@4 |c#0@@5| ($Box intType (int_2_U (LitInt 0)))))) (and (=> (= (ControlFlow 0 24) (- 0 25)) (or (= (TwoStateAt.Cell.Plus TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (LitInt 21)) (= (TwoStateAt.Cell.Plus TInt $Heap@0 $Heap@4 |c#0@@5| ($Box intType (int_2_U (LitInt 0)))) (LitInt 31)))) (=> (or (= (TwoStateAt.Cell.Plus TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (LitInt 21)) (= (TwoStateAt.Cell.Plus TInt $Heap@0 $Heap@4 |c#0@@5| ($Box intType (int_2_U (LitInt 0)))) (LitInt 31))) (and (=> (= (ControlFlow 0 24) 20) anon16_Then_correct) (=> (= (ControlFlow 0 24) 23) anon16_Else_correct)))))))
(let ((anon15_Else_correct  (=> (and (= (TwoStateAt.Cell.Plus TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (LitInt 21)) (= (ControlFlow 0 29) 24)) anon5_correct)))
(let ((anon15_Then_correct  (=> (or (not (= (TwoStateAt.Cell.Plus TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (LitInt 21))) (not true)) (and (=> (= (ControlFlow 0 26) (- 0 28)) (or (not (= |c#0@@5| null)) (not true))) (=> ($IsAllocBox ($Box refType |c#0@@5|) Tclass.TwoStateAt.Cell? $Heap@4) (=> (and (= |##y#6@0| (LitInt 0)) ($IsAlloc intType (int_2_U |##y#6@0|) TInt $Heap@4)) (and (=> (= (ControlFlow 0 26) (- 0 27)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0) (=> (and (|TwoStateAt.Cell.Plus#canCall| TInt $Heap@0 $Heap@4 |c#0@@5| ($Box intType (int_2_U (LitInt 0)))) (= (ControlFlow 0 26) 24)) anon5_correct)))))))))
(let ((anon3_correct  (and (=> (= (ControlFlow 0 30) (- 0 33)) (or (not (= |c#0@@5| null)) (not true))) (=> (and ($IsAllocBox ($Box refType |c#0@@5|) Tclass.TwoStateAt.Cell? $Heap@4) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@4)) (and (=> (= (ControlFlow 0 30) (- 0 32)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0) (and (=> (= (ControlFlow 0 30) (- 0 31)) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@0)) (=> ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@0) (=> (|TwoStateAt.Cell.Plus#canCall| TwoStateAt._default.Test$Y $Heap@0 $Heap@4 |c#0@@5| |y#0@@6|) (and (=> (= (ControlFlow 0 30) 26) anon15_Then_correct) (=> (= (ControlFlow 0 30) 29) anon15_Else_correct)))))))))))
(let ((anon14_Else_correct  (=> (not |b#0|) (and (=> (= (ControlFlow 0 38) (- 0 41)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (and (=> (= (ControlFlow 0 38) (- 0 40)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@5| TwoStateAt.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@5| TwoStateAt.Cell.data)) (and (=> (= (ControlFlow 0 38) (- 0 39)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (=> (= |$rhs#1_0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#0@@5|) TwoStateAt.Cell.data))) 20)) (=> (and (and (= $Heap@3 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 |c#0@@5| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#0@@5|) TwoStateAt.Cell.data ($Box intType (int_2_U |$rhs#1_0@0|))))) ($IsGoodHeap $Heap@3)) (and (= $Heap@4 $Heap@3) (= (ControlFlow 0 38) 30))) anon3_correct)))))))))))
(let ((anon14_Then_correct  (=> |b#0| (and (=> (= (ControlFlow 0 34) (- 0 37)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (and (=> (= (ControlFlow 0 34) (- 0 36)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@5| TwoStateAt.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@5| TwoStateAt.Cell.data)) (and (=> (= (ControlFlow 0 34) (- 0 35)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (=> (= |$rhs#0_0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#0@@5|) TwoStateAt.Cell.data))) 10)) (=> (and (and (= $Heap@2 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@1 |c#0@@5| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@1 |c#0@@5|) TwoStateAt.Cell.data ($Box intType (int_2_U |$rhs#0_0@0|))))) ($IsGoodHeap $Heap@2)) (and (= $Heap@4 $Heap@2) (= (ControlFlow 0 34) 30))) anon3_correct)))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap@@3 alloc |c#0@@5|)) (and (=> (= (ControlFlow 0 42) (- 0 64)) (or (not (= |c#0@@5| null)) (not true))) (=> (and ($IsAllocBox ($Box refType |c#0@@5|) Tclass.TwoStateAt.Cell? $Heap@@3) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@@3)) (and (=> (= (ControlFlow 0 42) (- 0 63)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3) (and (=> (= (ControlFlow 0 42) (- 0 62)) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@@3)) (=> ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@@3) (=> (and (|TwoStateAt.Cell.Plus#canCall| TwoStateAt._default.Test$Y $Heap@@3 $Heap@@3 |c#0@@5| |y#0@@6|) (|TwoStateAt.Cell.Plus#canCall| TwoStateAt._default.Test$Y $Heap@@3 $Heap@@3 |c#0@@5| |y#0@@6|)) (and (=> (= (ControlFlow 0 42) (- 0 61)) (= (TwoStateAt.Cell.Plus TwoStateAt._default.Test$Y $Heap@@3 $Heap@@3 |c#0@@5| |y#0@@6|) (LitInt 4))) (=> (= (TwoStateAt.Cell.Plus TwoStateAt._default.Test$Y $Heap@@3 $Heap@@3 |c#0@@5| |y#0@@6|) (LitInt 4)) (and (=> (= (ControlFlow 0 42) (- 0 60)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (and (=> (= (ControlFlow 0 42) (- 0 59)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@5| TwoStateAt.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@5| TwoStateAt.Cell.data)) (and (=> (= (ControlFlow 0 42) (- 0 58)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (=> (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |c#0@@5|) TwoStateAt.Cell.data))) 3)) (=> (and (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@3 |c#0@@5| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |c#0@@5|) TwoStateAt.Cell.data ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (and ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@0))) (and (=> (= (ControlFlow 0 42) (- 0 57)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3) (and (=> (= (ControlFlow 0 42) (- 0 56)) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@@3)) (=> ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@@3) (=> (and (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@@3 $Heap@0 |c#0@@5| |y#0@@6|) (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@@3 $Heap@0 |c#0@@5| |y#0@@6|)) (and (=> (= (ControlFlow 0 42) (- 0 55)) (= (TwoStateAt.Cell.Sum TwoStateAt._default.Test$Y $Heap@@3 $Heap@0 |c#0@@5| |y#0@@6|) (LitInt 7))) (=> (= (TwoStateAt.Cell.Sum TwoStateAt._default.Test$Y $Heap@@3 $Heap@0 |c#0@@5| |y#0@@6|) (LitInt 7)) (=> (and ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@0)) (and (=> (= (ControlFlow 0 42) (- 0 54)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0) (and (=> (= (ControlFlow 0 42) (- 0 53)) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@0)) (=> ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@0) (=> (and (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@0 $Heap@0 |c#0@@5| |y#0@@6|) (|TwoStateAt.Cell.Sum#canCall| TwoStateAt._default.Test$Y $Heap@0 $Heap@0 |c#0@@5| |y#0@@6|)) (and (=> (= (ControlFlow 0 42) (- 0 52)) (= (TwoStateAt.Cell.Sum TwoStateAt._default.Test$Y $Heap@0 $Heap@0 |c#0@@5| |y#0@@6|) (LitInt 10))) (=> (= (TwoStateAt.Cell.Sum TwoStateAt._default.Test$Y $Heap@0 $Heap@0 |c#0@@5| |y#0@@6|) (LitInt 10)) (and (=> (= (ControlFlow 0 42) (- 0 51)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (and (=> (= (ControlFlow 0 42) (- 0 50)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@5| TwoStateAt.Cell.data))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 |c#0@@5| TwoStateAt.Cell.data)) (and (=> (= (ControlFlow 0 42) (- 0 49)) (or (not (= |c#0@@5| null)) (not true))) (=> (or (not (= |c#0@@5| null)) (not true)) (=> (= |$rhs#1@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@5|) TwoStateAt.Cell.data))) 1)) (=> (and (and (= $Heap@1 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@5| (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 |c#0@@5|) TwoStateAt.Cell.data ($Box intType (int_2_U |$rhs#1@0|))))) ($IsGoodHeap $Heap@1)) (and ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@1) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@1))) (and (=> (= (ControlFlow 0 42) (- 0 48)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3) (and (=> (= (ControlFlow 0 42) (- 0 47)) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@@3)) (=> ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@@3) (=> (and (|TwoStateAt.__default.SP#canCall| TwoStateAt._default.Test$Y $Heap@@3 $Heap@1 |c#0@@5| |y#0@@6|) (|TwoStateAt.__default.SP#canCall| TwoStateAt._default.Test$Y $Heap@@3 $Heap@1 |c#0@@5| |y#0@@6|)) (and (=> (= (ControlFlow 0 42) (- 0 46)) (= (TwoStateAt.__default.SP TwoStateAt._default.Test$Y $Heap@@3 $Heap@1 |c#0@@5| |y#0@@6|) (LitInt 8))) (=> (= (TwoStateAt.__default.SP TwoStateAt._default.Test$Y $Heap@@3 $Heap@1 |c#0@@5| |y#0@@6|) (LitInt 8)) (=> (and ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@1) (= |newtype$check#0@0| (LitInt 0))) (and (=> (= (ControlFlow 0 42) (- 0 45)) (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 8))) (=> (and (<= 0 |newtype$check#0@0|) (< |newtype$check#0@0| 8)) (=> ($IsAlloc bv3Type (bv3_2_U #b000) (TBitvector 3) $Heap@1) (and (=> (= (ControlFlow 0 42) (- 0 44)) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0)) (=> ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@0) (=> (and (|TwoStateAt.__default.SP#canCall| (TBitvector 3) $Heap@0 $Heap@1 |c#0@@5| ($Box bv3Type (bv3_2_U #b000))) (|TwoStateAt.__default.SP#canCall| (TBitvector 3) $Heap@0 $Heap@1 |c#0@@5| ($Box bv3Type (bv3_2_U #b000)))) (and (=> (= (ControlFlow 0 42) (- 0 43)) (= (TwoStateAt.__default.SP (TBitvector 3) $Heap@0 $Heap@1 |c#0@@5| ($Box bv3Type (bv3_2_U #b000))) (LitInt 11))) (=> (= (TwoStateAt.__default.SP (TBitvector 3) $Heap@0 $Heap@1 |c#0@@5| ($Box bv3Type (bv3_2_U #b000))) (LitInt 11)) (and (=> (= (ControlFlow 0 42) 34) anon14_Then_correct) (=> (= (ControlFlow 0 42) 38) anon14_Else_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap@@3) ($IsHeapAnchor $Heap@@3)) (and ($Is refType |c#0@@5| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@5| Tclass.TwoStateAt.Cell $Heap@@3))) (=> (and (and (and ($IsBox |y#0@@6| TwoStateAt._default.Test$Y) ($IsAllocBox |y#0@@6| TwoStateAt._default.Test$Y $Heap@@3)) (= 4 $FunctionContextHeight)) (and (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@3 |c#0@@5|) TwoStateAt.Cell.data))) (LitInt 2)) (= (ControlFlow 0 65) 42))) anon0_correct))))
