...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((|x#0@@1| Int) ) (!  (=> (or (|B.__default.F#canCall| (LitInt |x#0@@1|)) (< 0 $FunctionContextHeight)) (= (B.__default.F (LitInt |x#0@@1|)) (LitInt |x#0@@1|)))
 :qid |DefaultParametersdfy.72:14|
 :weight 3
 :skolemid |3408|
 :pattern ( (B.__default.F (LitInt |x#0@@1|)))
))))
...
(set-info :boogie-vc-id Impl$$B.__default.Lemma0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) false) (= (LitInt (B.__default.F (LitInt 5))) (LitInt 5)))))
