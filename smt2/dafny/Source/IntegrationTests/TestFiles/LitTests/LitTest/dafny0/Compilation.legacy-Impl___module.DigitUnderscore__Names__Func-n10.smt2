...
(declare-fun |k#0| () T@U)
(declare-fun |y#0@@5| () Int)
(declare-fun $Heap@1 () T@U)
(set-info :boogie-vc-id Impl$$_module.DigitUnderscore__Names__Functions__and__Methods.Another)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) (forall ((|$ih#k0#0| T@U) (|$ih#y0#0| Int) ) (!  (=> (and (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |$ih#k0#0| |$ih#y0#0|) (or (|ORD#Less| |$ih#k0#0| |k#0|) (and (= |$ih#k0#0| |k#0|) (and (<= 0 |$ih#y0#0|) (< |$ih#y0#0| |y#0@@5|))))) (<= (LitInt 0) |$ih#y0#0|))
 :qid |Compilationlegacydfy.378:17|
 :skolemid |11076|
 :pattern ( (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |$ih#k0#0| |$ih#y0#0|))
)))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (=> (|_module.DigitUnderscore__Names__Functions__and__Methods._500##canCall| this@@5 |k#0| |y#0@@5|) (or (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |k#0| |y#0@@5|) (=> (< 0 (|ORD#Offset| |k#0|)) (or (= |y#0@@5| (LitInt 0)) (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS ($LS $LZ)) this@@5 (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (- |y#0@@5| 1))))))) (=> (=> (|_module.DigitUnderscore__Names__Functions__and__Methods._500##canCall| this@@5 |k#0| |y#0@@5|) (or (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |k#0| |y#0@@5|) (=> (< 0 (|ORD#Offset| |k#0|)) (or (= |y#0@@5| (LitInt 0)) (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS ($LS $LZ)) this@@5 (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (- |y#0@@5| 1)))))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.DigitUnderscore__Names__Functions__and__Methods._500##canCall| this@@5 |k#0| |y#0@@5|) (or (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |k#0| |y#0@@5|) (=> (= (LitInt 0) (|ORD#Offset| |k#0|)) (exists ((|_k'#0@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@1| |k#0|) (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |_k'#0@@1| |y#0@@5|))
 :qid |Compilationlegacydfy.368:19|
 :skolemid |11062|
 :pattern ( (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |_k'#0@@1| |y#0@@5|))
)))))) (=> (=> (|_module.DigitUnderscore__Names__Functions__and__Methods._500##canCall| this@@5 |k#0| |y#0@@5|) (or (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |k#0| |y#0@@5|) (=> (= (LitInt 0) (|ORD#Offset| |k#0|)) (exists ((|_k'#0@@2| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#0@@2| |k#0|) (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |_k'#0@@2| |y#0@@5|))
 :qid |Compilationlegacydfy.368:19|
 :skolemid |11062|
 :pattern ( (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |_k'#0@@2| |y#0@@5|))
))))) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (<= (LitInt 0) |y#0@@5|)) (and (= $Heap@0 $Heap@1) (= (ControlFlow 0 2) (- 0 1)))) (<= (LitInt 0) |y#0@@5|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and (or (not (= this@@5 null)) (not true)) (and ($Is refType this@@5 Tclass._module.DigitUnderscore__Names__Functions__and__Methods) ($IsAlloc refType this@@5 Tclass._module.DigitUnderscore__Names__Functions__and__Methods $Heap))) (= 3 $FunctionContextHeight)) (and (and (|_module.DigitUnderscore__Names__Functions__and__Methods._500##canCall| this@@5 |k#0| |y#0@@5|) (and (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |k#0| |y#0@@5|) (and (=> (< 0 (|ORD#Offset| |k#0|)) (or (= |y#0@@5| (LitInt 0)) (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 (|ORD#Minus| |k#0| (|ORD#FromNat| 1)) (- |y#0@@5| 1)))) (=> (= (LitInt 0) (|ORD#Offset| |k#0|)) (exists ((|_k'#1@@1| T@U) ) (!  (and (|ORD#LessThanLimit| |_k'#1@@1| |k#0|) (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |_k'#1@@1| |y#0@@5|))
 :qid |Compilationlegacydfy.368:19|
 :skolemid |11075|
 :pattern ( (|_module.DigitUnderscore__Names__Functions__and__Methods._500#| ($LS $LZ) this@@5 |_k'#1@@1| |y#0@@5|))
