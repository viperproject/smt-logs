...
(assert (forall ((v@@4 T@U) (t0@@1 T@U) (h@@2 T@U) ) (! (= ($IsAlloc SeqType v@@4 (TSeq t0@@1) h@@2) (forall ((i@@1 Int) ) (!  (=> (and (<= 0 i@@1) (< i@@1 (|Seq#Length| v@@4))) ($IsAllocBox (|Seq#Index| v@@4 i@@1) t0@@1 h@@2))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 10) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#6| null $Heap alloc |a#0|)) (and (=> (= (ControlFlow 0 2) (- 0 9)) (and (<= 0 (|Seq#Length| |sq#0|)) (<= (|Seq#Length| |sq#0|) (|Seq#Length| |sq#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 8)) (|Seq#Equal| |sq#0| (|Seq#Take| |sq#0| (|Seq#Length| |sq#0|)))) (=> (|Seq#Equal| |sq#0| (|Seq#Take| |sq#0| (|Seq#Length| |sq#0|))) (and (=> (= (ControlFlow 0 2) (- 0 7)) (and (<= 0 (LitInt 0)) (<= (LitInt 0) (|Seq#Length| |sq#0|)))) (and (=> (= (ControlFlow 0 2) (- 0 6)) (|Seq#Equal| |sq#0| (|Seq#Drop| |sq#0| (LitInt 0)))) (=> (|Seq#Equal| |sq#0| (|Seq#Drop| |sq#0| (LitInt 0))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (|Seq#Equal| |sq#0| |sq#0|)) (=> (|Seq#Equal| |sq#0| |sq#0|) (and (=> (= (ControlFlow 0 2) (- 0 4)) (or (not (= |a#0| null)) (not true))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (>= (_System.array.Length |a#0|) (LitInt 0))) (=> (>= (_System.array.Length |a#0|) (LitInt 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (= |a#0| null)) (not true)))))))))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SeqType |sq#0| (TSeq TInt)) ($IsAlloc SeqType |sq#0| (TSeq TInt) $Heap)) (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap))) (=> (and (and (and ($Is SeqType |s#0| (TSeq TInt)) ($IsAlloc SeqType |s#0| (TSeq TInt) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 10) 2))) anon0_correct)))))
