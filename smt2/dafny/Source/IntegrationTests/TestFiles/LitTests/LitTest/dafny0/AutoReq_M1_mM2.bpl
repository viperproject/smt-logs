...
procedure {:verboseName "M1.M2.f (well-formedness)"} CheckWellformed$$M1_mM2.__default.f(x#0: int);
...
procedure {:verboseName "M1.M2.h (well-formedness)"} CheckWellformed$$M1_mM2.__default.h(y#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "M1.M2.h (well-formedness)"} CheckWellformed$$M1_mM2.__default.h(y#0: int)
{
  ...
  var ##x#0: int;
    ...
    else
    {
        ...
        assert {:id "id170"} {:subsumption 0} ##x#0 > 3;
        assume ##x#0 > 3;
        assume M1_mM2.__default.f#canCall(y#0);
        assume {:id "id171"} M1_mM2.__default.h(y#0) == M1_mM2.__default.f(y#0);
        assume M1_mM2.__default.f#canCall(y#0);
