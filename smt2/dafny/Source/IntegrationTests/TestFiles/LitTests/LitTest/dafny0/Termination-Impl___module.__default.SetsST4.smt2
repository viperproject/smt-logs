...
(declare-fun _module._default.SetsST4$Y () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.SetsST4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 23) (let ((anon9_correct  (and (=> (= (ControlFlow 0 7) (- 0 11)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.SetsST4$Y) (and (|Set#IsMember| |s#0@0| |$as#x0_0#0_0|) (or (not (= |$as#x0_0#0_0| |y#0|)) (not true))))
 :qid |Terminationdfy.690:9|
 :skolemid |3176|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.SetsST4$Y) (and (|Set#IsMember| |s#0@0| |$as#x0_0#0_0@@0|) (or (not (= |$as#x0_0#0_0@@0| |y#0|)) (not true))))
 :qid |Terminationdfy.690:9|
 :skolemid |3176|
)) (=> (=> true (and ($IsBox |x#0_0@1| _module._default.SetsST4$Y) ($IsAllocBox |x#0_0@1| _module._default.SetsST4$Y $Heap))) (=> (and (|Set#IsMember| |s#0@0| |x#0_0@1|) (or (not (= |x#0_0@1| |y#0|)) (not true))) (and (=> (= (ControlFlow 0 7) (- 0 10)) true) (=> (= |s#0@1| (|Set#Difference| |s#0@0| (|Set#UnionOne| |Set#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 7) (- 0 9)) (or (<= 0 |$decr$loop#00@1|) (= (+ (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (+ (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 7) (- 0 8)) (< (+ (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|)) (=> (< (+ (|Set#Card| (|Set#Difference| |s#0@1| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|) (=> (= (ControlFlow 0 7) (- 0 6)) (=> |$w$loop#0@0| (|Set#Subset| |t#0@0| |s#0@1|)))))))))))))))
(let ((anon8_correct  (=> (= (ControlFlow 0 13) 7) anon9_correct)))
(let ((anon14_Else_correct  (=> (and (not (|Set#IsMember| |s#0@0| |x#0_1@1|)) (= (ControlFlow 0 15) 13)) anon8_correct)))
(let ((anon14_Then_correct  (=> (and (|Set#IsMember| |s#0@0| |x#0_1@1|) (= (ControlFlow 0 14) 13)) anon8_correct)))
(let ((anon13_Then_correct  (=> (and ($IsBox |x#0_1@1| _module._default.SetsST4$Y) ($IsAllocBox |x#0_1@1| _module._default.SetsST4$Y $Heap)) (and (=> (= (ControlFlow 0 16) 14) anon14_Then_correct) (=> (= (ControlFlow 0 16) 15) anon14_Else_correct)))))
(let ((anon13_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.SetsST4$Y) ($IsAllocBox |x#0_1@1| _module._default.SetsST4$Y $Heap))) (= (ControlFlow 0 12) 7)) anon9_correct)))
(let ((anon12_Else_correct  (=> (and (not (|Set#Equal| |s#0@0| |t#0@0|)) (= |$decr$loop#00@1| (+ (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@0|))))) (and (=> (= (ControlFlow 0 17) 16) anon13_Then_correct) (=> (= (ControlFlow 0 17) 12) anon13_Else_correct)))))
(let ((anon12_Then_correct true))
(let ((anon11_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 18) 5) anon12_Then_correct) (=> (= (ControlFlow 0 18) 17) anon12_Else_correct)))))
(let ((anon11_Then_correct  (=> (not |$w$loop#0@0|) (=> (and (|Set#Subset| |t#0@0| |s#0@0|) (= |newtype$check#0@0| (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (and (= |newtype$check#1@0| (|Set#Card| (|Set#Difference| |t#0@0| |s#0@0|))) (= (ControlFlow 0 3) (- 0 2))) (<= (LitInt 0) |newtype$check#1@0|))))))))
(let ((anon10_LoopBody_correct  (and (=> (= (ControlFlow 0 19) 3) anon11_Then_correct) (=> (= (ControlFlow 0 19) 18) anon11_Else_correct))))
(let ((anon10_LoopDone_correct true))
(let ((anon10_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.SetsST4$Y) ($IsAllocBox |x#0_0@0| _module._default.SetsST4$Y $Heap))) (=> (and (and (and ($Is SetType |s#0@0| (TSet _module._default.SetsST4$Y)) ($IsAlloc SetType |s#0@0| (TSet _module._default.SetsST4$Y) $Heap)) (and (not false) (=> |$w$loop#0@0| (|Set#Subset| |t#0@0| |s#0@0|)))) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.687:3|
 :skolemid |3174|
...
)) (<= (+ (|Set#Card| (|Set#Difference| |s#0@0| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |s#0@0|))) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 20) 1) anon10_LoopDone_correct) (=> (= (ControlFlow 0 20) 19) anon10_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |t#0@0| (|Set#UnionOne| |Set#Empty| |y#0|)) (= |$decr_init$loop#00@0| (+ (|Set#Card| (|Set#Difference| |S#0| |t#0@0|)) (|Set#Card| (|Set#Difference| |t#0@0| |S#0|))))) (and (=> (= (ControlFlow 0 21) (- 0 22)) (=> |$w$loop#0@0| (|Set#Subset| |t#0@0| |S#0|))) (=> (=> |$w$loop#0@0| (|Set#Subset| |t#0@0| |S#0|)) (=> (= (ControlFlow 0 21) 20) anon10_LoopHead_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is SetType |S#0| (TSet _module._default.SetsST4$Y)) ($IsAlloc SetType |S#0| (TSet _module._default.SetsST4$Y) $Heap)) (and ($IsBox |y#0| _module._default.SetsST4$Y) ($IsAllocBox |y#0| _module._default.SetsST4$Y $Heap))) (=> (and (and (and (and ($Is SetType |s#0| (TSet _module._default.SetsST4$Y)) ($IsAlloc SetType |s#0| (TSet _module._default.SetsST4$Y) $Heap)) true) (and (and ($Is SetType |t#0| (TSet _module._default.SetsST4$Y)) ($IsAlloc SetType |t#0| (TSet _module._default.SetsST4$Y) $Heap)) true)) (and (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.SetsST4$Y) ($IsAllocBox |x#0_0| _module._default.SetsST4$Y $Heap))) true) (= 0 $FunctionContextHeight)) (and (|Set#IsMember| |S#0| |y#0|) (= (ControlFlow 0 23) 21)))) anon0_correct)))))
