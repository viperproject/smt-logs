...
(set-info :boogie-vc-id Impl$$Ghost.__default.M2)
...
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (or (Types.XY.G1_q |xy#0|) (Types.XY.D1_q |xy#0|)))))
(let ((anon8_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (Types.XY.G1_q |xy#0|))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (or (Types.XY.G0_q |xy#0|) (Types.XY.G1_q |xy#0|)) (Types.XY.D1_q |xy#0|)))))
(let ((anon6_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (Types.XY.D0_q |xy#0|))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) ($Is charType |w#0@0| TChar)) (and (and (and (and (=> (= (ControlFlow 0 11) 2) anon6_Then_correct) (=> (= (ControlFlow 0 11) 4) anon7_Then_correct)) (=> (= (ControlFlow 0 11) 6) anon8_Then_correct)) (=> (= (ControlFlow 0 11) 8) anon9_Then_correct)) (=> (= (ControlFlow 0 11) 10) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType |xy#0| Tclass.Types.XY) ($IsAlloc DatatypeTypeType |xy#0| Tclass.Types.XY $Heap)) (|$IsA#Types.XY| |xy#0|)) (=> (and (and (and ($Is charType |w#0| TChar) true) (= 0 $FunctionContextHeight)) (and (Types.XY.G1_q |xy#0|) (= (ControlFlow 0 12) 11))) anon0_correct)))))
