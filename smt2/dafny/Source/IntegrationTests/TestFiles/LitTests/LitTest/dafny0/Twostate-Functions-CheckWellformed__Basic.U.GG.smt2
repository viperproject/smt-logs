...
(assert (= (Tag Tclass.Basic.U) Tagclass.Basic.U))
(assert (= (TagFamily Tclass.Basic.U) tytagFamily$U))
(assert (forall ((Basic.U.GG$T@@2 T@U) ($ly@@2 T@U) ($prevHeap@@2 T@U) ($h0 T@U) ($h1 T@U) (this@@2 T@U) (|x#0@@2| Int) (|t#0@@2| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this@@2 null)) (not true)) ($Is refType this@@2 Tclass.Basic.U))) (or (|Basic.U.GG#canCall| Basic.U.GG$T@@2 $prevHeap@@2 $h0 this@@2 |x#0@@2| |t#0@@2|) ($IsBox |t#0@@2| Basic.U.GG$T@@2))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@8 T@U) ($f@@2 T@U) )  (=> (and (or (not (= $o@@8 null)) (not true)) (= $o@@8 this@@2)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@8) $f@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@8) $f@@2)))) (= (Basic.U.GG Basic.U.GG$T@@2 $ly@@2 $prevHeap@@2 $h0 this@@2 |x#0@@2| |t#0@@2|) (Basic.U.GG Basic.U.GG$T@@2 $ly@@2 $prevHeap@@2 $h1 this@@2 |x#0@@2| |t#0@@2|))))
