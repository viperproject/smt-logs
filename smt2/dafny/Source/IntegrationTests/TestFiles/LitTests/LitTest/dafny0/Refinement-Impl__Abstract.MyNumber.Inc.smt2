...
(assert (forall (($h0 T@U) ($h1 T@U) (this T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this Tclass.Abstract.MyNumber))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@7 T@U) ($f T@U) ) (!  (=> (and (or (not (= $o@@7 null)) (not true)) (or (= $o@@7 this) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 this) Abstract.MyNumber.Repr)) ($Box refType $o@@7)))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@7) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@7) $f)))
 :qid |unknown.0:0|
 :skolemid |4442|
)) (= (Abstract.MyNumber.Valid $h0 this) (Abstract.MyNumber.Valid $h1 this))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4444|
...
(declare-fun $Heap@0 () T@U)
(set-info :boogie-vc-id Impl$$Abstract.MyNumber.Inc)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 6) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#2| null $Heap@@0 alloc ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.Repr)))) (and (=> (= (ControlFlow 0 2) (- 0 5)) (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@1 Abstract.MyNumber.N))) (=> (U_2_bool (MapType1Select refType FieldType boolType $_ModifiesFrame@0 this@@1 Abstract.MyNumber.N)) (=> (= |$rhs#0@0| (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.N))) 1)) (=> (and (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.N ($Box intType (int_2_U |$rhs#0@0|))))) ($IsGoodHeap $Heap@0)) (=> (and (and ($IsAllocBox ($Box refType this@@1) Tclass.Abstract.MyNumber? $Heap@0) (|Abstract.MyNumber.Valid#canCall| $Heap@0 this@@1)) (and (|Abstract.MyNumber.Valid#canCall| $Heap@0 this@@1) (Abstract.MyNumber.Valid $Heap@0 this@@1))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) Abstract.MyNumber.N))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.N))) 1))) (=> (= (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) Abstract.MyNumber.N))) (+ (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.N))) 1)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (Abstract.MyNumber.Valid $Heap@0 this@@1)) (=> (Abstract.MyNumber.Valid $Heap@0 this@@1) (=> (= (ControlFlow 0 2) (- 0 1)) (and (forall (($o@@9 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) Abstract.MyNumber.Repr)) ($Box refType $o@@9)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.Repr)) ($Box refType $o@@9)))) (or (not (= $o@@9 null)) (not true)))
 :qid |Refinementdfy.128:26|
 :skolemid |4462|
 :pattern (  (or (not (= $o@@9 null)) (not true)))
)) (forall (($o@@10 T@U) ) (!  (=> (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@0 this@@1) Abstract.MyNumber.Repr)) ($Box refType $o@@10)) (not (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@1) Abstract.MyNumber.Repr)) ($Box refType $o@@10)))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 $o@@10) alloc)))))
 :qid |Refinementdfy.128:26|
 :skolemid |4463|
