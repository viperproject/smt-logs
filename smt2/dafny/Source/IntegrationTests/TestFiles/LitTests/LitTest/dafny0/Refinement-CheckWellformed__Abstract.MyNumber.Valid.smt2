...
(assert (distinct TagSet alloc allocName Tagclass._System.object? Tagclass._System.object class.Abstract.MyNumber? Tagclass.Abstract.MyNumber? Tagclass.Abstract.MyNumber tytagFamily$object tytagFamily$MyNumber field$Repr)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($h@@3 T@U) ($o@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@3) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass.Abstract.MyNumber?))) ($Is SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) Abstract.MyNumber.Repr)) (TSet Tclass._System.object)))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4440|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@3 $o@@3) Abstract.MyNumber.Repr)))
)))
(assert (forall (($h@@4 T@U) ($o@@4 T@U) ) (!  (=> (and (and ($IsGoodHeap $h@@4) (and (or (not (= $o@@4 null)) (not true)) (= (dtype $o@@4) Tclass.Abstract.MyNumber?))) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) alloc)))) ($IsAlloc SetType ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) Abstract.MyNumber.Repr)) (TSet Tclass._System.object) $h@@4))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |4441|
 :pattern ( ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@4 $o@@4) Abstract.MyNumber.Repr)))
)))
...
(set-info :boogie-vc-id CheckWellformed$$Abstract.MyNumber.Valid)
...
(let ((anon8_Else_correct  (=> (and (=> (Abstract.MyNumber.Valid $Heap@@0 this@@0) (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) ($Box refType this@@0))) (= (ControlFlow 0 5) 2)) anon5_correct)))
(let ((anon8_Then_correct  (=> ($IsAllocBox ($Box refType this@@0) Tclass.Abstract.MyNumber? $Heap@@0) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (= this@@0 this@@0) (and (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@0)))) (not (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@0)))))))) (=> (or (= this@@0 this@@0) (and (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@0)))) (not (|Set#Subset| (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))) (|Set#Union| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) (|Set#UnionOne| |Set#Empty| ($Box refType this@@0))))))) (=> (and (and (or (= this@@0 this@@0) (|Abstract.MyNumber.Valid#canCall| $Heap@@0 this@@0)) (Abstract.MyNumber.Valid $Heap@@0 this@@0)) (and (|Set#IsMember| ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)) ($Box refType this@@0)) (= (ControlFlow 0 3) 2))) anon5_correct))))))
(let ((anon7_Else_correct true))
(let ((anon0_correct  (=> (and (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc this@@0 ($Unbox SetType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 this@@0) Abstract.MyNumber.Repr)))) (= |b$reqreads#0@0| (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 this@@0 Abstract.MyNumber.Repr)))) (and (=> (= (ControlFlow 0 6) (- 0 7)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (and (and (=> (= (ControlFlow 0 6) 1) anon7_Else_correct) (=> (= (ControlFlow 0 6) 3) anon8_Then_correct)) (=> (= (ControlFlow 0 6) 5) anon8_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and (or (not (= this@@0 null)) (not true)) (and ($Is refType this@@0 Tclass.Abstract.MyNumber) ($IsAlloc refType this@@0 Tclass.Abstract.MyNumber $Heap@@0))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 6))) anon0_correct))))
