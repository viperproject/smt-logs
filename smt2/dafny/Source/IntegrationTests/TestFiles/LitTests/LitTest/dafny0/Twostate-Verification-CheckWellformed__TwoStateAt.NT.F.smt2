...
(assert (distinct TInt TagInt alloc allocName Tagclass._System.___hFunc2 Tagclass.TwoStateAt.Cell Tagclass.TwoStateAt.Cell? class.TwoStateAt.Cell? |tytagFamily$_#Func2| tytagFamily$Cell field$data)
)
(assert (= (FDim alloc) 0))
...
(assert (forall (($bx T@U) (TwoStateAt.NT.F$Y T@U) ($prevHeap T@U) ($self Int) ($heap T@U) (|$fh$0x#0| T@U) (|$fh$0x#1| T@U) ) (! (= (|Set#IsMember| (Reads2 TwoStateAt.NT.F$Y Tclass.TwoStateAt.Cell TInt $heap (|TwoStateAt.NT.F#Handle| TwoStateAt.NT.F$Y $prevHeap $self) |$fh$0x#0| |$fh$0x#1|) $bx) (= ($Unbox refType $bx) ($Unbox refType |$fh$0x#1|)))
 :qid |unknown.0:0|
 :skolemid |770|
 :pattern ( (|Set#IsMember| (Reads2 TwoStateAt.NT.F$Y Tclass.TwoStateAt.Cell TInt $heap (|TwoStateAt.NT.F#Handle| TwoStateAt.NT.F$Y $prevHeap $self) |$fh$0x#0| |$fh$0x#1|) $bx))
)))
...
(assert (forall ((TwoStateAt.NT.F$Y@@0 T@U) ($prevHeap@@0 T@U) ($Heap T@U) (this Int) (|y#0| T@U) (|c#0@@0| T@U) ) (!  (=> (and (and (and (and (and ($IsGoodHeap $prevHeap@@0) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@0 $Heap)) (and (<= (LitInt 0) this) (< this 86))) ($IsBox |y#0| TwoStateAt.NT.F$Y@@0)) ($Is refType |c#0@@0| Tclass.TwoStateAt.Cell)) (= (|TwoStateAt.NT.F#requires| TwoStateAt.NT.F$Y@@0 $prevHeap@@0 $Heap this |y#0| |c#0@@0|)  (and ($IsAllocBox |y#0| TwoStateAt.NT.F$Y@@0 $prevHeap@@0) ($IsAlloc refType |c#0@@0| Tclass.TwoStateAt.Cell $prevHeap@@0))))
 :qid |unknown.0:0|
 :skolemid |859|
 :pattern ( (|TwoStateAt.NT.F#requires| TwoStateAt.NT.F$Y@@0 $prevHeap@@0 $Heap this |y#0| |c#0@@0|) ($IsGoodHeap $Heap))
)))
(assert (forall ((TwoStateAt.NT.F$Y@@1 T@U) ($prevHeap@@1 T@U) ($self@@0 Int) ($heap@@0 T@U) (|$fh$0x#0@@0| T@U) (|$fh$0x#1@@0| T@U) ) (! (= (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@1 $prevHeap@@1 $heap@@0 $self@@0 |$fh$0x#0@@0| |$fh$0x#1@@0|) (U_2_int ($Unbox intType (Apply2 TwoStateAt.NT.F$Y@@1 Tclass.TwoStateAt.Cell TInt $heap@@0 (|TwoStateAt.NT.F#Handle| TwoStateAt.NT.F$Y@@1 $prevHeap@@1 $self@@0) |$fh$0x#0@@0| ($Box refType |$fh$0x#1@@0|)))))
 :qid |unknown.0:0|
 :skolemid |771|
 :pattern ( (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@1 $prevHeap@@1 $heap@@0 $self@@0 |$fh$0x#0@@0| |$fh$0x#1@@0|))
)))
...
(assert (forall ((TwoStateAt.NT.F$Y@@2 T@U) ($prevHeap@@2 T@U) ($self@@1 Int) ($heap@@1 T@U) (|$fh$0x#0@@1| T@U) (|$fh$0x#1@@1| T@U) ) (! (= (Requires2 TwoStateAt.NT.F$Y@@2 Tclass.TwoStateAt.Cell TInt $heap@@1 (|TwoStateAt.NT.F#Handle| TwoStateAt.NT.F$Y@@2 $prevHeap@@2 $self@@1) |$fh$0x#0@@1| |$fh$0x#1@@1|) (|TwoStateAt.NT.F#requires| TwoStateAt.NT.F$Y@@2 $prevHeap@@2 $heap@@1 $self@@1 |$fh$0x#0@@1| ($Unbox refType |$fh$0x#1@@1|)))
 :qid |unknown.0:0|
 :skolemid |769|
 :pattern ( (Requires2 TwoStateAt.NT.F$Y@@2 Tclass.TwoStateAt.Cell TInt $heap@@1 (|TwoStateAt.NT.F#Handle| TwoStateAt.NT.F$Y@@2 $prevHeap@@2 $self@@1) |$fh$0x#0@@1| |$fh$0x#1@@1|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall ((TwoStateAt.NT.F$Y@@3 T@U) ($prevHeap@@3 T@U) ($Heap@@0 T@U) (this@@0 Int) (|y#0@@0| T@U) (|c#0@@2| T@U) ) (!  (=> (or (|TwoStateAt.NT.F#canCall| TwoStateAt.NT.F$Y@@3 $prevHeap@@3 $Heap@@0 this@@0 |y#0@@0| |c#0@@2|) (and (< 1 $FunctionContextHeight) (and (and (and (and (and ($IsGoodHeap $prevHeap@@3) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@3 $Heap@@0)) (and (<= (LitInt 0) this@@0) (< this@@0 86))) ($IsBox |y#0@@0| TwoStateAt.NT.F$Y@@3)) ($Is refType |c#0@@2| Tclass.TwoStateAt.Cell)))) (= (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@3 $prevHeap@@3 $Heap@@0 this@@0 |y#0@@0| |c#0@@2|) (- (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@0 |c#0@@2|) TwoStateAt.Cell.data))) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@3 |c#0@@2|) TwoStateAt.Cell.data))))))
 :qid |unknown.0:0|
 :skolemid |860|
 :pattern ( (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@3 $prevHeap@@3 $Heap@@0 this@@0 |y#0@@0| |c#0@@2|) ($IsGoodHeap $Heap@@0))
))))
...
(assert (forall ((TwoStateAt.NT.F$Y@@4 T@U) ($prevHeap@@4 T@U) ($self@@2 Int) ($heap@@2 T@U) (|$fh$0x#0@@2| T@U) (|$fh$0x#1@@2| T@U) ) (! (= (Apply2 TwoStateAt.NT.F$Y@@4 Tclass.TwoStateAt.Cell TInt $heap@@2 (|TwoStateAt.NT.F#Handle| TwoStateAt.NT.F$Y@@4 $prevHeap@@4 $self@@2) |$fh$0x#0@@2| |$fh$0x#1@@2|) ($Box intType (int_2_U (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@4 $prevHeap@@4 $heap@@2 $self@@2 |$fh$0x#0@@2| ($Unbox refType |$fh$0x#1@@2|)))))
 :qid |unknown.0:0|
 :skolemid |768|
 :pattern ( (Apply2 TwoStateAt.NT.F$Y@@4 Tclass.TwoStateAt.Cell TInt $heap@@2 (|TwoStateAt.NT.F#Handle| TwoStateAt.NT.F$Y@@4 $prevHeap@@4 $self@@2) |$fh$0x#0@@2| |$fh$0x#1@@2|))
)))
...
(assert (forall (($h@@2 T@U) ($o@@3 T@U) ) (!  (=> (and ($IsGoodHeap $h@@2) (and (or (not (= $o@@3 null)) (not true)) (= (dtype $o@@3) Tclass.TwoStateAt.Cell?))) ($Is intType ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h@@2 $o@@3) TwoStateAt.Cell.data)) TInt))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |798|
...
(assert (forall ((f@@4 T@U) (t0@@6 T@U) (t1@@6 T@U) (t2@@5 T@U) (u0@@2 T@U) (u1@@2 T@U) (u2@@1 T@U) ) (!  (=> (and (and (and ($Is HandleTypeType f@@4 (Tclass._System.___hFunc2 t0@@6 t1@@6 t2@@5)) (forall ((bx@@4 T@U) ) (!  (=> ($IsBox bx@@4 u0@@2) ($IsBox bx@@4 t0@@6))
 :qid |unknown.0:0|
 :skolemid |511|
 :pattern ( ($IsBox bx@@4 u0@@2))
 :pattern ( ($IsBox bx@@4 t0@@6))
))) (forall ((bx@@5 T@U) ) (!  (=> ($IsBox bx@@5 u1@@2) ($IsBox bx@@5 t1@@6))
 :qid |unknown.0:0|
 :skolemid |512|
 :pattern ( ($IsBox bx@@5 u1@@2))
 :pattern ( ($IsBox bx@@5 t1@@6))
))) (forall ((bx@@6 T@U) ) (!  (=> ($IsBox bx@@6 t2@@5) ($IsBox bx@@6 u2@@1))
 :qid |unknown.0:0|
 :skolemid |513|
 :pattern ( ($IsBox bx@@6 t2@@5))
 :pattern ( ($IsBox bx@@6 u2@@1))
...
(assert (forall ((TwoStateAt.NT.F$Y@@5 T@U) ($prevHeap@@5 T@U) ($h0 T@U) ($h1 T@U) (this@@1 Int) (|y#0@@1| T@U) (|c#0@@3| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (<= (LitInt 0) this@@1) (< this@@1 86))) (or (|TwoStateAt.NT.F#canCall| TwoStateAt.NT.F$Y@@5 $prevHeap@@5 $h0 this@@1 |y#0@@1| |c#0@@3|) (and ($IsBox |y#0@@1| TwoStateAt.NT.F$Y@@5) ($Is refType |c#0@@3| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@4 T@U) ($f@@0 T@U) ) (!  (=> (and (or (not (= $o@@4 null)) (not true)) (= $o@@4 |c#0@@3|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@4) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@4) $f@@0)))
 :qid |unknown.0:0|
 :skolemid |856|
)) (= (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@5 $prevHeap@@5 $h0 this@@1 |y#0@@1| |c#0@@3|) (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@5 $prevHeap@@5 $h1 this@@1 |y#0@@1| |c#0@@3|))))
 :qid |unknown.0:0|
 :skolemid |857|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@5 $prevHeap@@5 $h1 this@@1 |y#0@@1| |c#0@@3|))
)))
(assert (forall ((t0@@7 T@U) (t1@@7 T@U) (t2@@6 T@U) (h0 T@U) (h1 T@U) (f@@5 T@U) (bx0@@4 T@U) (bx1@@4 T@U) ) (!  (=> (and (and (and ($HeapSucc h0 h1) (and ($IsGoodHeap h0) ($IsGoodHeap h1))) (and (and ($IsBox bx0@@4 t0@@7) ($IsBox bx1@@4 t1@@7)) ($Is HandleTypeType f@@5 (Tclass._System.___hFunc2 t0@@7 t1@@7 t2@@6)))) (forall ((o@@1 T@U) (fld T@U) ) (!  (=> (and (or (not (= o@@1 null)) (not true)) (|Set#IsMember| (Reads2 t0@@7 t1@@7 t2@@6 h0 f@@5 bx0@@4 bx1@@4) ($Box refType o@@1))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0 o@@1) fld) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1 o@@1) fld)))
 :qid |unknown.0:0|
 :skolemid |499|
...
(assert (forall ((t0@@9 T@U) (t1@@9 T@U) (t2@@8 T@U) (h0@@1 T@U) (h1@@1 T@U) (f@@7 T@U) (bx0@@6 T@U) (bx1@@6 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@1 h1@@1) (and ($IsGoodHeap h0@@1) ($IsGoodHeap h1@@1))) (and (and ($IsBox bx0@@6 t0@@9) ($IsBox bx1@@6 t1@@9)) ($Is HandleTypeType f@@7 (Tclass._System.___hFunc2 t0@@9 t1@@9 t2@@8)))) (forall ((o@@4 T@U) (fld@@1 T@U) ) (!  (=> (and (or (not (= o@@4 null)) (not true)) (|Set#IsMember| (Reads2 t0@@9 t1@@9 t2@@8 h0@@1 f@@7 bx0@@6 bx1@@6) ($Box refType o@@4))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@1 o@@4) fld@@1) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@1 o@@4) fld@@1)))
 :qid |unknown.0:0|
 :skolemid |495|
))) (= (Reads2 t0@@9 t1@@9 t2@@8 h0@@1 f@@7 bx0@@6 bx1@@6) (Reads2 t0@@9 t1@@9 t2@@8 h1@@1 f@@7 bx0@@6 bx1@@6)))
 :qid |unknown.0:0|
 :skolemid |496|
...
(assert (forall ((t0@@10 T@U) (t1@@10 T@U) (t2@@9 T@U) (h0@@2 T@U) (h1@@2 T@U) (f@@8 T@U) (bx0@@7 T@U) (bx1@@7 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@2 h1@@2) (and ($IsGoodHeap h0@@2) ($IsGoodHeap h1@@2))) (and (and ($IsBox bx0@@7 t0@@10) ($IsBox bx1@@7 t1@@10)) ($Is HandleTypeType f@@8 (Tclass._System.___hFunc2 t0@@10 t1@@10 t2@@9)))) (forall ((o@@5 T@U) (fld@@2 T@U) ) (!  (=> (and (or (not (= o@@5 null)) (not true)) (|Set#IsMember| (Reads2 t0@@10 t1@@10 t2@@9 h1@@2 f@@8 bx0@@7 bx1@@7) ($Box refType o@@5))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@2 o@@5) fld@@2) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@2 o@@5) fld@@2)))
 :qid |unknown.0:0|
 :skolemid |497|
))) (= (Reads2 t0@@10 t1@@10 t2@@9 h0@@2 f@@8 bx0@@7 bx1@@7) (Reads2 t0@@10 t1@@10 t2@@9 h1@@2 f@@8 bx0@@7 bx1@@7)))
 :qid |unknown.0:0|
 :skolemid |498|
 :pattern ( ($HeapSucc h0@@2 h1@@2) (Reads2 t0@@10 t1@@10 t2@@9 h1@@2 f@@8 bx0@@7 bx1@@7))
)))
(assert (forall ((t0@@11 T@U) (t1@@11 T@U) (t2@@10 T@U) (h0@@3 T@U) (h1@@3 T@U) (f@@9 T@U) (bx0@@8 T@U) (bx1@@8 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@3 h1@@3) (and ($IsGoodHeap h0@@3) ($IsGoodHeap h1@@3))) (and (and ($IsBox bx0@@8 t0@@11) ($IsBox bx1@@8 t1@@11)) ($Is HandleTypeType f@@9 (Tclass._System.___hFunc2 t0@@11 t1@@11 t2@@10)))) (forall ((o@@6 T@U) (fld@@3 T@U) ) (!  (=> (and (or (not (= o@@6 null)) (not true)) (|Set#IsMember| (Reads2 t0@@11 t1@@11 t2@@10 h0@@3 f@@9 bx0@@8 bx1@@8) ($Box refType o@@6))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@3 o@@6) fld@@3) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@3 o@@6) fld@@3)))
 :qid |unknown.0:0|
 :skolemid |503|
))) (= (Apply2 t0@@11 t1@@11 t2@@10 h0@@3 f@@9 bx0@@8 bx1@@8) (Apply2 t0@@11 t1@@11 t2@@10 h1@@3 f@@9 bx0@@8 bx1@@8)))
 :qid |unknown.0:0|
 :skolemid |504|
 :pattern ( ($HeapSucc h0@@3 h1@@3) (Apply2 t0@@11 t1@@11 t2@@10 h1@@3 f@@9 bx0@@8 bx1@@8))
)))
(assert (forall ((t0@@12 T@U) (t1@@12 T@U) (t2@@11 T@U) (h0@@4 T@U) (h1@@4 T@U) (f@@10 T@U) (bx0@@9 T@U) (bx1@@9 T@U) ) (!  (=> (and (and (and ($HeapSucc h0@@4 h1@@4) (and ($IsGoodHeap h0@@4) ($IsGoodHeap h1@@4))) (and (and ($IsBox bx0@@9 t0@@12) ($IsBox bx1@@9 t1@@12)) ($Is HandleTypeType f@@10 (Tclass._System.___hFunc2 t0@@12 t1@@12 t2@@11)))) (forall ((o@@7 T@U) (fld@@4 T@U) ) (!  (=> (and (or (not (= o@@7 null)) (not true)) (|Set#IsMember| (Reads2 t0@@12 t1@@12 t2@@11 h1@@4 f@@10 bx0@@9 bx1@@9) ($Box refType o@@7))) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h0@@4 o@@7) fld@@4) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) h1@@4 o@@7) fld@@4)))
 :qid |unknown.0:0|
 :skolemid |505|
))) (= (Apply2 t0@@12 t1@@12 t2@@11 h0@@4 f@@10 bx0@@9 bx1@@9) (Apply2 t0@@12 t1@@12 t2@@11 h1@@4 f@@10 bx0@@9 bx1@@9)))
 :qid |unknown.0:0|
 :skolemid |506|
...
(declare-fun TwoStateAt.NT.F$Y@@6 () T@U)
(declare-fun current$Heap () T@U)
(declare-fun this@@2 () Int)
(declare-fun |y#0@@2| () T@U)
(declare-fun previous$Heap () T@U)
(set-info :boogie-vc-id CheckWellformed$$TwoStateAt.NT.F)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (<= (LitInt 0) this@@2) (< this@@2 86)) (and ($IsBox |y#0@@2| TwoStateAt.NT.F$Y@@6) ($IsAllocBox |y#0@@2| TwoStateAt.NT.F$Y@@6 previous$Heap))) (=> (and (and (and ($Is refType |c#0@@4| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@4| Tclass.TwoStateAt.Cell previous$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 8) 7))) anon0_correct)))))
