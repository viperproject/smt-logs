...
(assert (forall ((TwoStateAt.NT.F$Y@@5 T@U) ($prevHeap@@5 T@U) ($h0 T@U) ($h1 T@U) (this@@1 Int) (|y#0@@1| T@U) (|c#0@@3| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (<= (LitInt 0) this@@1) (< this@@1 86))) (or (|TwoStateAt.NT.F#canCall| TwoStateAt.NT.F$Y@@5 $prevHeap@@5 $h0 this@@1 |y#0@@1| |c#0@@3|) (and ($IsBox |y#0@@1| TwoStateAt.NT.F$Y@@5) ($Is refType |c#0@@3| Tclass.TwoStateAt.Cell)))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@4 T@U) ($f@@0 T@U) )  (=> (and (or (not (= $o@@4 null)) (not true)) (= $o@@4 |c#0@@3|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@4) $f@@0) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@4) $f@@0)))) (= (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@5 $prevHeap@@5 $h0 this@@1 |y#0@@1| |c#0@@3|) (TwoStateAt.NT.F TwoStateAt.NT.F$Y@@5 $prevHeap@@5 $h1 this@@1 |y#0@@1| |c#0@@3|))))
