...
procedure {:verboseName "TrickyProvides1.AAA.T (well-formedness)"} CheckWellFormed$$TrickyProvides1_mAAA.T(t#0: Box);
...
axiom (var u#2 := TrickyProvides1_mBBB.__default.Empty(); Lit(true))
