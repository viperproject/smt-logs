...
(assert (forall ((a@@12 T@U) (b@@9 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@7 T@U) )  (=> (U_2_bool (MapType0Select BoxType boolType a@@12 bx@@7)) (and ($IsBox bx@@7 t0@@5) ($IsBox (MapType0Select BoxType BoxType b@@9 bx@@7) t1@@3)))) ($Is IMapType (|IMap#Glue| a@@12 b@@9 (TIMap t0@@5 t1@@3)) (TIMap t0@@5 t1@@3)))
