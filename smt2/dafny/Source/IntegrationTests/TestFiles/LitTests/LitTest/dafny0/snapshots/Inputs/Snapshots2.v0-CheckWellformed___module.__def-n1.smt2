...
(declare-fun |_module.__default.R#canCall| () Bool)
(declare-fun _module.__default.R () Bool)
...
(declare-fun _module.__default.Q () Bool)
...
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.R#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.R (U_2_bool (Lit boolType (bool_2_U false)))))))
(assert  (=> (<= 0 $FunctionContextHeight) (=> (or |_module.__default.R#canCall| (< 0 $FunctionContextHeight)) (= _module.__default.R (U_2_bool (Lit boolType (bool_2_U false)))))))
...
(assert  (=> (<= 1 $FunctionContextHeight) (=> (or |_module.__default.Q#canCall| (< 1 $FunctionContextHeight)) (= _module.__default.Q (U_2_bool (Lit boolType (bool_2_U _module.__default.R)))))))
