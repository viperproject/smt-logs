...
(declare-fun IntegerBasedValues._default.MultisetUpdate$U () T@U)
(declare-fun |m'#0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$IntegerBasedValues.__default.MultisetUpdate)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 21) (let ((anon9_Else_correct  (=> (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (< |n#0| (LitInt 0))) (< |n#0| (LitInt 0))) (< |n#0| (LitInt 0))) (= (ControlFlow 0 19) (- 0 18))) false)))
(let ((anon9_Then_correct  (=> (= |newtype$check#0_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 15) (- 0 17)) (= (Mod |newtype$check#0_0@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#0_0@0| (LitInt 2)) (LitInt 0)) (=> (and (<= (LitInt 0) |n#0|) (= |newtype$check#0_1@0| (+ |n#0| |n#0|))) (and (=> (= (ControlFlow 0 15) (- 0 16)) (= (Mod |newtype$check#0_1@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#0_1@0| (LitInt 2)) (LitInt 0)) (=> (= (ControlFlow 0 15) (- 0 14)) (<= 0 (+ (+ |n#0| |n#0|) 1)))))))))))
(let ((anon8_Then_correct  (=> (= |newtype$check#1_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 9) (- 0 13)) (= (Mod |newtype$check#1_0@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#1_0@0| (LitInt 2)) (LitInt 0)) (=> (and (<= (LitInt 0) |n#0|) (= |newtype$check#1_1@0| (+ |n#0| |n#0|))) (and (=> (= (ControlFlow 0 9) (- 0 12)) (= (Mod |newtype$check#1_1@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#1_1@0| (LitInt 2)) (LitInt 0)) (=> (= |newtype$check#1_2@0| (LitInt 1)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (= (Mod |newtype$check#1_2@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#1_2@0| (LitInt 2)) (LitInt 0)) (=> (= |newtype$check#1_3@0| (+ (+ |n#0| |n#0|) 1)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= (Mod |newtype$check#1_3@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#1_3@0| (LitInt 2)) (LitInt 0)) (=> (= (ControlFlow 0 9) (- 0 8)) (<= 0 (+ (+ |n#0| |n#0|) 1)))))))))))))))))
(let ((anon7_Then_correct  (=> (= |newtype$check#2_0@0| (LitInt 0)) (and (=> (= (ControlFlow 0 6) (- 0 7)) (= (Mod |newtype$check#2_0@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#2_0@0| (LitInt 2)) (LitInt 0)) (=> (and (<= (LitInt 0) |n#0|) (= (ControlFlow 0 6) (- 0 5))) (<= 0 |n#0|)))))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= 0 |n#0|)) (=> (<= 0 |n#0|) (=> (and (= |m'#0@0| (|MultiSet#UpdateMultiplicity| |m#0| |t#0| |n#0|)) (= |newtype$check#3_0@0| (+ |n#0| |n#0|))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= (Mod |newtype$check#3_0@0| (LitInt 2)) (LitInt 0))) (=> (= (Mod |newtype$check#3_0@0| (LitInt 2)) (LitInt 0)) (=> (= (ControlFlow 0 2) (- 0 1)) (<= 0 (+ |n#0| |n#0|))))))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (=> (= (ControlFlow 0 20) 2) anon6_Then_correct) (=> (= (ControlFlow 0 20) 6) anon7_Then_correct)) (=> (= (ControlFlow 0 20) 9) anon8_Then_correct)) (=> (= (ControlFlow 0 20) 15) anon9_Then_correct)) (=> (= (ControlFlow 0 20) 19) anon9_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($Is MultiSetType |m#0| (TMultiSet IntegerBasedValues._default.MultisetUpdate$U)) ($IsAlloc MultiSetType |m#0| (TMultiSet IntegerBasedValues._default.MultisetUpdate$U) $Heap))) (=> (and (and (and ($IsBox |t#0| IntegerBasedValues._default.MultisetUpdate$U) ($IsAllocBox |t#0| IntegerBasedValues._default.MultisetUpdate$U $Heap)) (= (Mod |n#0| (LitInt 2)) (LitInt 0))) (and (and ($Is MultiSetType |m'#0| (TMultiSet IntegerBasedValues._default.MultisetUpdate$U)) ($IsAlloc MultiSetType |m'#0| (TMultiSet IntegerBasedValues._default.MultisetUpdate$U) $Heap)) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 21) 20)))) anon0_correct))))
