...
(declare-fun |x#0| () T@U)
(declare-fun TwoStateAt.DT$X () T@U)
(declare-fun previous$Heap () T@U)
(declare-fun |y#0| () T@U)
(declare-fun TwoStateAt.DT.M$Y () T@U)
(declare-fun |n#0| () Int)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id CheckWellFormed$$TwoStateAt.DT.M)
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and ($IsBox |x#0| TwoStateAt.DT$X) ($IsAllocBox |x#0| TwoStateAt.DT$X previous$Heap))) (and (and ($IsBox |y#0| TwoStateAt.DT.M$Y) ($IsAllocBox |y#0| TwoStateAt.DT.M$Y previous$Heap)) (and ($Is refType |c#0@@1| Tclass.TwoStateAt.Cell) ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap)))) (and (and (and (<= (LitInt 0) |n#0|) (= 3 $FunctionContextHeight)) (and (= previous$Heap $Heap) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap)))) (and (and ($IsAllocBox |x#0| TwoStateAt.DT$X previous$Heap) ($IsAllocBox |y#0| TwoStateAt.DT.M$Y previous$Heap)) (and ($IsAlloc refType |c#0@@1| Tclass.TwoStateAt.Cell previous$Heap) (= (ControlFlow 0 5) 2))))) anon0_correct)))
