...
(set-info :boogie-vc-id Impl$$_module.StatementTwoShoes.O)
...
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (not (= |a#0| 0)) (not true))) (=> (or (not (= |a#0| 0)) (not true)) (and (=> (= (ControlFlow 0 3) 1) anon3_Then_correct) (=> (= (ControlFlow 0 3) 2) anon3_Else_correct)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.StatementTwoShoes) ($IsAlloc refType this Tclass._module.StatementTwoShoes $Heap))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 3))) anon0_correct))))
