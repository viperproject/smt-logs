...
(set-info :boogie-vc-id Impl$$_module.__default.MultisetCardinalityB)
...
(let ((anon13_Then_correct  (=> (= (ControlFlow 0 12) (- 0 11)) (exists ((|x#1_1| T@U) ) (! (> (|MultiSet#Multiplicity| |s#0| ($Box intType |x#1_1|)) 0)
 :qid |MultiSetsdfy.199:33|
 :skolemid |552|
 :pattern ( (|MultiSet#Multiplicity| |s#0| ($Box intType |x#1_1|)))
)))))
...
(let ((anon15_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (> (|MultiSet#Multiplicity| |s#0| ($Box intType (int_2_U (LitInt 0)))) 0)) (exists ((|$as#y0_0#0_0| T@U) ) (! (> (|MultiSet#Multiplicity| |s#0| ($Box intType |$as#y0_0#0_0|)) 0)
 :qid |MultiSetsdfy.200:23|
 :skolemid |550|
))))))
...
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) (or (not (= (|MultiSet#Card| |s#0|) 0)) (not true)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (not (|MultiSet#Equal| |s#0| |MultiSet#Empty|)))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is MultiSetType |s#0| (TMultiSet TInt)) ($IsAlloc MultiSetType |s#0| (TMultiSet TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (or (not (= (|MultiSet#Card| |s#0|) 0)) (not true)) (= (ControlFlow 0 16) 15))) anon0_correct))))
