...
(assert (forall ((_module.BoxTests$G@@7 T@U) (bx@@1 T@U) ) (!  (=> ($IsBox bx@@1 (Tclass._module.BoxTests? _module.BoxTests$G@@7)) (and (= ($Box refType ($Unbox refType bx@@1)) bx@@1) ($Is refType ($Unbox refType bx@@1) (Tclass._module.BoxTests? _module.BoxTests$G@@7))))
 :qid |unknown.0:0|
 :skolemid |595|
 :pattern ( ($IsBox bx@@1 (Tclass._module.BoxTests? _module.BoxTests$G@@7)))
)))
(assert (forall ((_module.BoxTests$G@@8 T@U) (bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 (Tclass._module.BoxTests _module.BoxTests$G@@8)) (and (= ($Box refType ($Unbox refType bx@@2)) bx@@2) ($Is refType ($Unbox refType bx@@2) (Tclass._module.BoxTests _module.BoxTests$G@@8))))
 :qid |unknown.0:0|
 :skolemid |600|
 :pattern ( ($IsBox bx@@2 (Tclass._module.BoxTests _module.BoxTests$G@@8)))
)))
...
(set-info :boogie-vc-id Impl$$_module.BoxTests.LemmaSeq)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 2) (- 0 1))) (and (<= (|Seq#Length| |a#0|) (|Seq#Length| |b#0|)) (|Seq#SameUntil| |a#0| |b#0| (|Seq#Length| |a#0|))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (and (or (not (= this null)) (not true)) (and ($Is refType this (Tclass._module.BoxTests _module.BoxTests$G@@9)) ($IsAlloc refType this (Tclass._module.BoxTests _module.BoxTests$G@@9) $Heap)))) (=> (and (and (and ($Is SeqType |a#0| (TSeq TInt)) ($IsAlloc SeqType |a#0| (TSeq TInt) $Heap)) (and ($Is SeqType |b#0| (TSeq TInt)) ($IsAlloc SeqType |b#0| (TSeq TInt) $Heap))) (and (and (= 0 $FunctionContextHeight) (<= (|Seq#Length| |a#0|) (|Seq#Length| |b#0|))) (and (forall ((|i#1| Int) ) (!  (=> (and (<= (LitInt 0) |i#1|) (< |i#1| (|Seq#Length| |a#0|))) (= (U_2_int ($Unbox intType (|Seq#Index| |a#0| |i#1|))) (U_2_int ($Unbox intType (|Seq#Index| |b#0| |i#1|)))))
 :qid |MultiSetsdfy.149:35|
 :skolemid |640|
 :pattern ( ($Unbox intType (|Seq#Index| |b#0| |i#1|)))
 :pattern ( ($Unbox intType (|Seq#Index| |a#0| |i#1|)))
