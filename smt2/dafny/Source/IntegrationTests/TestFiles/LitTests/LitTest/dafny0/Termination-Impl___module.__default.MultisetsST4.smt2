...
(declare-fun _module._default.MultisetsST4$Y () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.MultisetsST4)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((anon4_correct  (=> (and (and (|MultiSet#Subset| |t#0@0| |s#0@0|) (<= (|MultiSet#Multiplicity| |s#0@0| |y#0|) (LitInt 1))) (= |newtype$check#0@0| (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)))) (and (=> (= (ControlFlow 0 18) (- 0 19)) (<= (LitInt 0) |newtype$check#0@0|)) (=> (<= (LitInt 0) |newtype$check#0@0|) (=> (and (= |newtype$check#1@0| (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@0|))) (= (ControlFlow 0 18) (- 0 17))) (<= (LitInt 0) |newtype$check#1@0|)))))))
(let ((anon14_Else_correct  (=> (and (not (|MultiSet#Subset| |t#0@0| |s#0@0|)) (= (ControlFlow 0 21) 18)) anon4_correct)))
(let ((anon14_Then_correct  (=> (and (|MultiSet#Subset| |t#0@0| |s#0@0|) (= (ControlFlow 0 20) 18)) anon4_correct)))
(let ((anon13_Then_correct  (=> (not |$w$loop#0@0|) (and (=> (= (ControlFlow 0 22) 20) anon14_Then_correct) (=> (= (ControlFlow 0 22) 21) anon14_Else_correct)))))
(let ((anon11_correct  (and (=> (= (ControlFlow 0 4) (- 0 9)) (exists ((|$as#x0_0#0_0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0| _module._default.MultisetsST4$Y) (and (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0|) 0) (or (not (= |$as#x0_0#0_0| |y#0|)) (not true))))
 :qid |Terminationdfy.822:9|
 :skolemid |3255|
))) (=> (exists ((|$as#x0_0#0_0@@0| T@U) ) (!  (and ($IsBox |$as#x0_0#0_0@@0| _module._default.MultisetsST4$Y) (and (> (|MultiSet#Multiplicity| |s#0@0| |$as#x0_0#0_0@@0|) 0) (or (not (= |$as#x0_0#0_0@@0| |y#0|)) (not true))))
 :qid |Terminationdfy.822:9|
 :skolemid |3255|
)) (=> (=> true (and ($IsBox |x#0_0@1| _module._default.MultisetsST4$Y) ($IsAllocBox |x#0_0@1| _module._default.MultisetsST4$Y $Heap))) (=> (and (> (|MultiSet#Multiplicity| |s#0@0| |x#0_0@1|) 0) (or (not (= |x#0_0@1| |y#0|)) (not true))) (and (=> (= (ControlFlow 0 4) (- 0 8)) true) (=> (= |s#0@1| (|MultiSet#Difference| |s#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |x#0_0@1|))) (and (=> (= (ControlFlow 0 4) (- 0 7)) (or (<= 0 |$decr$loop#00@1|) (= (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|))) (=> (or (<= 0 |$decr$loop#00@1|) (= (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (< (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|)) (=> (< (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@1| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@1|))) |$decr$loop#00@1|) (and (=> (= (ControlFlow 0 4) (- 0 5)) (=> |$w$loop#0@0| (|MultiSet#Subset| |t#0@0| |s#0@1|))) (=> (=> |$w$loop#0@0| (|MultiSet#Subset| |t#0@0| |s#0@1|)) (=> (= (ControlFlow 0 4) (- 0 3)) (=> |$w$loop#0@0| (<= (|MultiSet#Multiplicity| |s#0@1| |y#0|) (LitInt 1))))))))))))))))))
(let ((anon10_correct  (=> (= (ControlFlow 0 11) 4) anon11_correct)))
(let ((anon17_Else_correct  (=> (and (>= 0 (|MultiSet#Multiplicity| |s#0@0| |x#0_1@1|)) (= (ControlFlow 0 13) 11)) anon10_correct)))
(let ((anon17_Then_correct  (=> (and (> (|MultiSet#Multiplicity| |s#0@0| |x#0_1@1|) 0) (= (ControlFlow 0 12) 11)) anon10_correct)))
(let ((anon16_Then_correct  (=> (and ($IsBox |x#0_1@1| _module._default.MultisetsST4$Y) ($IsAllocBox |x#0_1@1| _module._default.MultisetsST4$Y $Heap)) (and (=> (= (ControlFlow 0 14) 12) anon17_Then_correct) (=> (= (ControlFlow 0 14) 13) anon17_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not (and ($IsBox |x#0_1@1| _module._default.MultisetsST4$Y) ($IsAllocBox |x#0_1@1| _module._default.MultisetsST4$Y $Heap))) (= (ControlFlow 0 10) 4)) anon11_correct)))
(let ((anon15_Else_correct  (=> (and (not (|MultiSet#Equal| |s#0@0| |t#0@0|)) (= |$decr$loop#00@1| (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@0|))))) (and (=> (= (ControlFlow 0 15) 14) anon16_Then_correct) (=> (= (ControlFlow 0 15) 10) anon16_Else_correct)))))
(let ((anon15_Then_correct true))
(let ((anon13_Else_correct  (=> |$w$loop#0@0| (and (=> (= (ControlFlow 0 16) 2) anon15_Then_correct) (=> (= (ControlFlow 0 16) 15) anon15_Else_correct)))))
(let ((anon12_LoopBody_correct  (and (=> (= (ControlFlow 0 23) 22) anon13_Then_correct) (=> (= (ControlFlow 0 23) 16) anon13_Else_correct))))
(let ((anon12_LoopDone_correct true))
(let ((anon12_LoopHead_correct  (=> (=> |defass#x#0_0@0| (and ($IsBox |x#0_0@0| _module._default.MultisetsST4$Y) ($IsAllocBox |x#0_0@0| _module._default.MultisetsST4$Y $Heap))) (=> (and (and (and (and ($Is MultiSetType |s#0@0| (TMultiSet _module._default.MultisetsST4$Y)) ($IsAlloc MultiSetType |s#0@0| (TMultiSet _module._default.MultisetsST4$Y) $Heap)) (not false)) (and (=> |$w$loop#0@0| (|MultiSet#Subset| |t#0@0| |s#0@0|)) (=> |$w$loop#0@0| (<= (|MultiSet#Multiplicity| |s#0@0| |y#0|) (LitInt 1))))) (and (and (forall (($o@@0 T@U) ) (!  (=> (and (or (not (= $o@@0 null)) (not true)) (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) alloc)))) (= (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0) (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $o@@0)))
 :qid |Terminationdfy.819:3|
 :skolemid |3253|
...
)) (<= (+ (|MultiSet#Card| (|MultiSet#Difference| |s#0@0| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |s#0@0|))) |$decr_init$loop#00@0|)))) (and (=> (= (ControlFlow 0 24) 1) anon12_LoopDone_correct) (=> (= (ControlFlow 0 24) 23) anon12_LoopBody_correct))))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (=> (and (= |t#0@0| (|MultiSet#UnionOne| |MultiSet#Empty| |y#0|)) (= |$decr_init$loop#00@0| (+ (|MultiSet#Card| (|MultiSet#Difference| |S#0| |t#0@0|)) (|MultiSet#Card| (|MultiSet#Difference| |t#0@0| |S#0|))))) (and (=> (= (ControlFlow 0 25) (- 0 27)) (=> |$w$loop#0@0| (|MultiSet#Subset| |t#0@0| |S#0|))) (=> (=> |$w$loop#0@0| (|MultiSet#Subset| |t#0@0| |S#0|)) (and (=> (= (ControlFlow 0 25) (- 0 26)) (=> |$w$loop#0@0| (<= (|MultiSet#Multiplicity| |S#0| |y#0|) (LitInt 1)))) (=> (=> |$w$loop#0@0| (<= (|MultiSet#Multiplicity| |S#0| |y#0|) (LitInt 1))) (=> (= (ControlFlow 0 25) 24) anon12_LoopHead_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is MultiSetType |S#0| (TMultiSet _module._default.MultisetsST4$Y)) ($IsAlloc MultiSetType |S#0| (TMultiSet _module._default.MultisetsST4$Y) $Heap)) (and ($IsBox |y#0| _module._default.MultisetsST4$Y) ($IsAllocBox |y#0| _module._default.MultisetsST4$Y $Heap))) (=> (and (and (and (and ($Is MultiSetType |s#0| (TMultiSet _module._default.MultisetsST4$Y)) ($IsAlloc MultiSetType |s#0| (TMultiSet _module._default.MultisetsST4$Y) $Heap)) true) (and (and ($Is MultiSetType |t#0| (TMultiSet _module._default.MultisetsST4$Y)) ($IsAlloc MultiSetType |t#0| (TMultiSet _module._default.MultisetsST4$Y) $Heap)) true)) (and (and (and (=> |defass#x#0_0| (and ($IsBox |x#0_0| _module._default.MultisetsST4$Y) ($IsAllocBox |x#0_0| _module._default.MultisetsST4$Y $Heap))) true) (= 0 $FunctionContextHeight)) (and (= (|MultiSet#Multiplicity| |S#0| |y#0|) (LitInt 1)) (= (ControlFlow 0 28) 25)))) anon0_correct)))))
