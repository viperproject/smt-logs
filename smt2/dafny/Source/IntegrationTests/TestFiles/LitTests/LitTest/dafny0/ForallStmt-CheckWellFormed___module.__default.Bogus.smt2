...
(set-info :boogie-vc-id CheckWellFormed$$_module.__default.Bogus)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#13| null $Heap alloc |c#0@@1|)) (= (ControlFlow 0 2) (- 0 1))) (or (not (= |c#0@@1| null)) (not true)))))
