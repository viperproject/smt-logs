...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let (($generated@@186  (=> (= $generated@@180 ($generated@@139 $generated@@33 $generated@@181 $generated false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) $generated@@182) (=> $generated@@182 (=> (= (ControlFlow 0 2) (- 0 1)) true))))))
