...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (|a#0| T@U) (|b#0| T@U) ) (!  (=> (or (|DtypeRegression.__default.array__equal#canCall| $Heap |a#0| |b#0|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) ($Is refType |a#0| (Tclass._System.array TInt))) ($Is refType |b#0| (Tclass._System.array TInt))))) (= (DtypeRegression.__default.array__equal $Heap |a#0| |b#0|) (|Seq#Equal| (|Seq#FromArray| $Heap |a#0|) (|Seq#FromArray| $Heap |b#0|))))
 :qid |Arraydfy.304:19|
 :skolemid |550|
 :pattern ( (DtypeRegression.__default.array__equal $Heap |a#0| |b#0|) ($IsGoodHeap $Heap))
))))
...
(assert (forall ((h@@1 T@U) (a@@1 T@U) ) (! (= (|Seq#Length| (|Seq#FromArray| h@@1 a@@1)) (_System.array.Length a@@1))
 :qid |DafnyPreludebpl.1323:15|
 :skolemid |261|
 :pattern ( (|Seq#Length| (|Seq#FromArray| h@@1 a@@1)))
)))
...
(assert (forall ((h@@2 T@U) (v@@1 T@U) ) (! ($IsAlloc intType v@@1 TInt h@@2)
 :qid |DafnyPreludebpl.289:14|
 :skolemid |61|
 :pattern ( ($IsAlloc intType v@@1 TInt h@@2))
)))
...
(set-info :boogie-vc-id CheckWellformed$$DtypeRegression.__default.array__equal)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 8) (let ((anon5_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 6)) (or (not (= |a#0@@0| null)) (not true))) (=> (or (not (= |a#0@@0| null)) (not true)) (=> (= |b$reqreads#0@0| (forall (($i Int) ) (!  (=> (and (<= 0 $i) (< $i (_System.array.Length |a#0@@0|))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i))))
 :qid |Arraydfy.307:6|
 :skolemid |551|
 :pattern ( (MapType1Select refType FieldType boolType $_ReadsFrame@0 |a#0@@0| (IndexField $i)))
))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |b#0@@0| null)) (not true))) (=> (or (not (= |b#0@@0| null)) (not true)) (=> (= |b$reqreads#1@0| (forall (($i@@0 Int) ) (!  (=> (and (<= 0 $i@@0) (< $i@@0 (_System.array.Length |b#0@@0|))) (U_2_bool (MapType1Select refType FieldType boolType $_ReadsFrame@0 |b#0@@0| (IndexField $i@@0))))
 :qid |Arraydfy.307:15|
 :skolemid |552|
 :pattern ( (MapType1Select refType FieldType boolType $_ReadsFrame@0 |b#0@@0| (IndexField $i@@0)))
))) (=> (and (= (DtypeRegression.__default.array__equal $Heap@@0 |a#0@@0| |b#0@@0|) (|Seq#Equal| (|Seq#FromArray| $Heap@@0 |a#0@@0|) (|Seq#FromArray| $Heap@@0 |b#0@@0|))) ($Is boolType (bool_2_U (DtypeRegression.__default.array__equal $Heap@@0 |a#0@@0| |b#0@@0|)) TBool)) (and (=> (= (ControlFlow 0 3) (- 0 4)) |b$reqreads#0@0|) (=> |b$reqreads#0@0| (=> (= (ControlFlow 0 3) (- 0 2)) |b$reqreads#1@0|))))))))))))
(let ((anon5_Then_correct true))
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null $Heap@@0 alloc |a#0@@0| |b#0@@0|)) (and (=> (= (ControlFlow 0 7) 1) anon5_Then_correct) (=> (= (ControlFlow 0 7) 3) anon5_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@0) ($IsHeapAnchor $Heap@@0)) (=> (and (and ($Is refType |a#0@@0| (Tclass._System.array TInt)) ($Is refType |b#0@@0| (Tclass._System.array TInt))) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 8) 7))) anon0_correct))))
