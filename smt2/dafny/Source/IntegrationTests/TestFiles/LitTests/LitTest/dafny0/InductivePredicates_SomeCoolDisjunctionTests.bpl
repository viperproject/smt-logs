...
procedure {:verboseName "SomeCoolDisjunctionTests.P (well-formedness)"} CheckWellformed$$SomeCoolDisjunctionTests.__default.P(x#0: int);
...
procedure {:verboseName "SomeCoolDisjunctionTests.Q (well-formedness)"} CheckWellformed$$SomeCoolDisjunctionTests.__default.Q(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "SomeCoolDisjunctionTests.L (well-formedness)"} CheckWellFormed$$SomeCoolDisjunctionTests.__default.L(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "SomeCoolDisjunctionTests.L (call)"} Call$$SomeCoolDisjunctionTests.__default.L(x#0: int);
  // user-defined preconditions
  requires {:id "id142"} SomeCoolDisjunctionTests.__default.P($LS($LS($LZ)), x#0)
...
procedure {:verboseName "SomeCoolDisjunctionTests.L# (co-call)"} CoCall$$SomeCoolDisjunctionTests.__default.L_h(_k#0: Box, x#1: int);
  // user-defined preconditions
  requires {:id "id144"} SomeCoolDisjunctionTests.__default.P_h($LS($LS($LZ)), _k#0, x#1)
     || SomeCoolDisjunctionTests.__default.Q_h($LS($LS($LZ)), _k#0, x#1);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id145"} Lit(false);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "SomeCoolDisjunctionTests.L# (correctness)"} Impl$$SomeCoolDisjunctionTests.__default.L_h(_k#0: Box, x#1: int) returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id146"} SomeCoolDisjunctionTests.__default.P_h($LS($LS($LZ)), _k#0, x#1)
     || SomeCoolDisjunctionTests.__default.Q_h($LS($LS($LZ)), _k#0, x#1);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id147"} Lit(false);
  // frame condition
  free ensures old($Heap) == $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SomeCoolDisjunctionTests.L# (correctness)"} Impl$$SomeCoolDisjunctionTests.__default.L_h(_k#0: Box, x#1: int) returns ($_reverifyPost: bool)
{
  ...
  var $initHeapForallStmt#1_0_0: Heap;
    ...
    assume (forall $ih#_k0#0: Box, $ih#x0#0: int :: 
      ...
      (SomeCoolDisjunctionTests.__default.P_h($LS($LZ), $ih#_k0#0, $ih#x0#0)
         ...
         ==> Lit(false));
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/InductivePredicates.dfy(265,3)
    assume true;
    ...
    {
        // ----- forall statement (call) ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/InductivePredicates.dfy(265,3)
...
axiom {:id "id148"} 0 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    ...
    SomeCoolDisjunctionTests.__default.Pn#canCall(x#0) || 0 < $FunctionContextHeight
...
procedure {:verboseName "SomeCoolDisjunctionTests.Pn (well-formedness)"} CheckWellformed$$SomeCoolDisjunctionTests.__default.Pn(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
axiom {:id "id153"} 0 <= $FunctionContextHeight
   ==> (forall $ly: LayerType, x#0: int :: 
    ...
    SomeCoolDisjunctionTests.__default.Qn#canCall(x#0) || 0 < $FunctionContextHeight
...
procedure {:verboseName "SomeCoolDisjunctionTests.Qn (well-formedness)"} CheckWellformed$$SomeCoolDisjunctionTests.__default.Qn(x#0: int);
  free requires 0 == $FunctionContextHeight;
  modifies $Heap;
...
procedure {:verboseName "SomeCoolDisjunctionTests.Ln (well-formedness)"} CheckWellFormed$$SomeCoolDisjunctionTests.__default.Ln(x#0: int);
  free requires 1 == $FunctionContextHeight;
  modifies $Heap;



procedure {:verboseName "SomeCoolDisjunctionTests.Ln (call)"} Call$$SomeCoolDisjunctionTests.__default.Ln(x#0: int);
  // user-defined preconditions
  requires {:id "id162"} SomeCoolDisjunctionTests.__default.Pn($LS($LS($LZ)), x#0)
     || SomeCoolDisjunctionTests.__default.Qn($LS($LS($LZ)), x#0);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id163"} Lit(false);
  // frame condition
  free ensures old($Heap) == $Heap;



procedure {:verboseName "SomeCoolDisjunctionTests.Ln# (co-call)"} CoCall$$SomeCoolDisjunctionTests.__default.Ln_h(_k#0: int where LitInt(0) <= _k#0, x#1: int);
  // user-defined preconditions
  requires {:id "id164"} SomeCoolDisjunctionTests.__default.Pn_h($LS($LS($LZ)), _k#0, x#1)
...
procedure {:verboseName "SomeCoolDisjunctionTests.Ln# (correctness)"} Impl$$SomeCoolDisjunctionTests.__default.Ln_h(_k#0: int where LitInt(0) <= _k#0, x#1: int) returns ($_reverifyPost: bool);
  free requires 2 == $FunctionContextHeight;
  // user-defined preconditions
  requires {:id "id166"} SomeCoolDisjunctionTests.__default.Pn_h($LS($LS($LZ)), _k#0, x#1)
     || SomeCoolDisjunctionTests.__default.Qn_h($LS($LS($LZ)), _k#0, x#1);
  modifies $Heap;
  // user-defined postconditions
  free ensures true;
  ensures {:id "id167"} Lit(false);
  // frame condition
  free ensures old($Heap) == $Heap;



implementation {:smt_option "smt.arith.solver", "2"} {:verboseName "SomeCoolDisjunctionTests.Ln# (correctness)"} Impl$$SomeCoolDisjunctionTests.__default.Ln_h(_k#0: int, x#1: int) returns ($_reverifyPost: bool)
{
  var $_ModifiesFrame: [ref,Field]bool;
  var $initHeapForallStmt#0: Heap;
    ...
    assume (forall $ih#_k0#0: int, $ih#x0#0: int :: 
      ...
      LitInt(0) <= $ih#_k0#0
         ...
         ==> Lit(false));
    $_reverifyPost := false;
    // ----- if statement ----- /home/runner/work/smt-logs/smt-logs/dafny/dafny/Source/IntegrationTests/TestFiles/LitTests/LitTest/dafny0/InductivePredicates.dfy(281,3)
    assume true;
    if (0 < _k#0)
    {
    }
