...
(set-info :boogie-vc-id Impl$$_module.__default.A)
...
(let ((anon3_Then_correct  (=> ($IsAlloc intType (int_2_U |y#0@0|) TInt $Heap) (=> (and (|_module.__default.P#canCall| |y#0@0|) (forall ((|y#1| Int) ) (! (|_module.__default.P#canCall| |y#1|)
 :qid |columnsdfy.9:18|
 :skolemid |484|
 :pattern ( (_module.__default.P |y#1|))
))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (forall ((|y#1@@0| Int) ) (! (_module.__default.P |y#1@@0|)
 :qid |columnsdfy.9:18|
 :skolemid |486|
 :pattern ( (_module.__default.P |y#1@@0|))
))) (=> (forall ((|y#1@@1| Int) ) (! (_module.__default.P |y#1@@1|)
 :qid |columnsdfy.9:18|
 :skolemid |486|
 :pattern ( (_module.__default.P |y#1@@1|))
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (or (not (= |x#0| 1)) (not true))) (=> (or (not (= |x#0| 1)) (not true)) (=> (= (ControlFlow 0 2) (- 0 1)) false)))))))))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (= 1 $FunctionContextHeight)) (and (> |x#0| 0) (= (ControlFlow 0 7) 6))) anon0_correct)))
