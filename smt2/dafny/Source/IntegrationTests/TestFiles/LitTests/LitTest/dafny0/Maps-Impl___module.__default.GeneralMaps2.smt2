...
(assert (forall ((a@@1 T@U) (b@@1 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@6 T@U) )  (=> (U_2_bool (MapType0Select BoxType boolType a@@1 bx@@6)) (and ($IsBox bx@@6 t0@@5) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@6) t1@@3)))) ($Is IMapType (|IMap#Glue| a@@1 b@@1 (TIMap t0@@5 t1@@3)) (TIMap t0@@5 t1@@3)))
