...
(declare-fun |lambda#54| (T@U Bool) T@U)
...
(declare-fun |lambda#56| (T@U Int Int) T@U)
...
(declare-fun |lambda#55| () T@U)
(declare-fun |map$project$6#1_0#z#0| (Int) Int)
(declare-fun |lambda#57| () T@U)
(declare-fun |map$project$5#0_0#z#0| (Int) Int)
...
(assert (forall ((|l#0| T@U) (|l#1| Bool) (|$w#1_0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#54| |l#0| |l#1|) |$w#1_0|))  (and ($IsBox |$w#1_0| |l#0|) (exists ((|a#1_0#0#0| Int) ) (!  (and |l#1| (= (U_2_int ($Unbox intType |$w#1_0|)) (_module.__default.g |a#1_0#0#0|)))
 :qid |Mapsdfy.234:19|
 :skolemid |675|
))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |931|
 :pattern ( (MapType0Select BoxType boolType (|lambda#54| |l#0| |l#1|) |$w#1_0|))
)))
...
(assert (forall ((|l#0@@0| T@U) (|l#1@@0| Int) (|l#2| Int) (|$w#0_0| T@U) ) (! (= (U_2_bool (MapType0Select BoxType boolType (|lambda#56| |l#0@@0| |l#1@@0| |l#2|) |$w#0_0|))  (and ($IsBox |$w#0_0| |l#0@@0|) (exists ((|a#0_0#0#0| Int) ) (!  (and (and (<= |l#1@@0| |a#0_0#0#0|) (< |a#0_0#0#0| |l#2|)) (= (U_2_int ($Unbox intType |$w#0_0|)) (_module.__default.g |a#0_0#0#0|)))
 :qid |Mapsdfy.232:19|
 :skolemid |672|
))))
 :qid |DafnyPreludebpl.27:1|
 :skolemid |933|
 :pattern ( (MapType0Select BoxType boolType (|lambda#56| |l#0@@0| |l#1@@0| |l#2|) |$w#0_0|))
)))
...
(assert (forall ((a@@1 T@U) (b@@1 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (!  (=> (forall ((bx@@6 T@U) ) (!  (=> (U_2_bool (MapType0Select BoxType boolType a@@1 bx@@6)) (and ($IsBox bx@@6 t0@@5) ($IsBox (MapType0Select BoxType BoxType b@@1 bx@@6) t1@@3)))
...
(assert (forall ((|$w#1_0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType |lambda#55| |$w#1_0@@0|) ($Box intType (int_2_U (|map$project$6#1_0#z#0| (U_2_int ($Unbox intType |$w#1_0@@0|))))))
 :qid |Mapsdfy.234:14|
 :skolemid |932|
 :pattern ( (MapType0Select BoxType BoxType |lambda#55| |$w#1_0@@0|))
)))
(assert (forall ((|$w#0_0@@0| T@U) ) (! (= (MapType0Select BoxType BoxType |lambda#57| |$w#0_0@@0|) ($Box intType (int_2_U (|map$project$5#0_0#z#0| (U_2_int ($Unbox intType |$w#0_0@@0|))))))
 :qid |Mapsdfy.232:14|
 :skolemid |934|
 :pattern ( (MapType0Select BoxType BoxType |lambda#57| |$w#0_0@@0|))
)))
...
(declare-fun |z#prime#0_0@0| () Int)
(declare-fun $Heap () T@U)
(declare-fun |_module.__default.g#canCall| (Int) Bool)
(declare-fun |z#1_0@0| () Int)
(declare-fun |z#prime#1_0@0| () Int)
(declare-fun $_ModifiesFrame@0 () T@U)
(declare-fun null () T@U)
(declare-fun $IsHeapAnchor (T@U) Bool)
(declare-fun |m#0_0| () T@U)
(declare-fun |m#1_0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$_module.__default.GeneralMaps2)
...
(let ((anon24_Else_correct  (=> (and (not (and (and (<= (LitInt 2) |z#0_0@0|) (< |z#0_0@0| 6)) (and (<= (LitInt 2) |z#prime#0_0@0|) (< |z#prime#0_0@0| 6)))) (= (ControlFlow 0 16) 13)) anon10_correct)))
(let ((anon24_Then_correct  (=> (and (and (<= (LitInt 2) |z#0_0@0|) (< |z#0_0@0| 6)) (and (<= (LitInt 2) |z#prime#0_0@0|) (< |z#prime#0_0@0| 6))) (and (=> (= (ControlFlow 0 14) (- 0 15)) (or (or (not (= (_module.__default.g |z#0_0@0|) (_module.__default.g |z#prime#0_0@0|))) (not true)) (= |z#0_0@0| |z#prime#0_0@0|))) (=> (or (or (not (= (_module.__default.g |z#0_0@0|) (_module.__default.g |z#prime#0_0@0|))) (not true)) (= |z#0_0@0| |z#prime#0_0@0|)) (=> (= (ControlFlow 0 14) 13) anon10_correct))))))
(let ((anon23_Else_correct  (=> (not (and (<= (LitInt 2) |z#0_0@0|) (< |z#0_0@0| 6))) (and (=> (= (ControlFlow 0 18) 14) anon24_Then_correct) (=> (= (ControlFlow 0 18) 16) anon24_Else_correct)))))
(let ((anon23_Then_correct  (=> (and (<= (LitInt 2) |z#0_0@0|) (< |z#0_0@0| 6)) (and (=> (= (ControlFlow 0 17) 14) anon24_Then_correct) (=> (= (ControlFlow 0 17) 16) anon24_Else_correct)))))
(let ((anon22_Else_correct  (=> (not (and (<= (LitInt 2) |z#0_0@0|) (< |z#0_0@0| 6))) (and (=> (= (ControlFlow 0 20) 17) anon23_Then_correct) (=> (= (ControlFlow 0 20) 18) anon23_Else_correct)))))
(let ((anon22_Then_correct  (=> (and (and (<= (LitInt 2) |z#0_0@0|) (< |z#0_0@0| 6)) (and ($IsAlloc intType (int_2_U |z#0_0@0|) TInt $Heap) (|_module.__default.g#canCall| |z#0_0@0|))) (and (=> (= (ControlFlow 0 19) 17) anon23_Then_correct) (=> (= (ControlFlow 0 19) 18) anon23_Else_correct)))))
(let ((anon21_Else_correct  (=> (< |z#0_0@0| (LitInt 2)) (and (=> (= (ControlFlow 0 22) 19) anon22_Then_correct) (=> (= (ControlFlow 0 22) 20) anon22_Else_correct)))))
(let ((anon21_Then_correct  (=> (<= (LitInt 2) |z#0_0@0|) (and (=> (= (ControlFlow 0 21) 19) anon22_Then_correct) (=> (= (ControlFlow 0 21) 20) anon22_Else_correct)))))
...
(let ((anon19_Then_correct  (and (=> (= (ControlFlow 0 24) 23) anon20_Then_correct) (=> (= (ControlFlow 0 24) 12) anon20_Else_correct))))
(let ((anon18_correct true))
(let ((anon28_Else_correct  (=> (and (not (and (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 5) 2)) anon18_correct)))
(let ((anon28_Then_correct  (=> (and (U_2_bool (Lit boolType (bool_2_U true))) (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (or (or (not (= (_module.__default.g |z#1_0@0|) (_module.__default.g |z#prime#1_0@0|))) (not true)) (= |z#1_0@0| |z#prime#1_0@0|))) (=> (or (or (not (= (_module.__default.g |z#1_0@0|) (_module.__default.g |z#prime#1_0@0|))) (not true)) (= |z#1_0@0| |z#prime#1_0@0|)) (=> (= (ControlFlow 0 3) 2) anon18_correct))))))
(let ((anon27_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 7) 3) anon28_Then_correct) (=> (= (ControlFlow 0 7) 5) anon28_Else_correct)))))
(let ((anon27_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (and (=> (= (ControlFlow 0 6) 3) anon28_Then_correct) (=> (= (ControlFlow 0 6) 5) anon28_Else_correct)))))
(let ((anon26_Else_correct  (=> (not (U_2_bool (Lit boolType (bool_2_U true)))) (and (=> (= (ControlFlow 0 9) 6) anon27_Then_correct) (=> (= (ControlFlow 0 9) 7) anon27_Else_correct)))))
(let ((anon26_Then_correct  (=> (U_2_bool (Lit boolType (bool_2_U true))) (=> (and ($IsAlloc intType (int_2_U |z#1_0@0|) TInt $Heap) (|_module.__default.g#canCall| |z#1_0@0|)) (and (=> (= (ControlFlow 0 8) 6) anon27_Then_correct) (=> (= (ControlFlow 0 8) 7) anon27_Else_correct))))))
(let ((anon25_Then_correct  (and (=> (= (ControlFlow 0 10) 8) anon26_Then_correct) (=> (= (ControlFlow 0 10) 9) anon26_Else_correct))))
(let ((anon25_Else_correct true))
(let ((anon19_Else_correct  (and (=> (= (ControlFlow 0 11) 10) anon25_Then_correct) (=> (= (ControlFlow 0 11) 1) anon25_Else_correct))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 25) 24) anon19_Then_correct) (=> (= (ControlFlow 0 25) 11) anon19_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is IMapType |m#0_0| (TIMap TInt TInt)) ($IsAlloc IMapType |m#0_0| (TIMap TInt TInt) $Heap)) true) (=> (and (and (and ($Is IMapType |m#1_0| (TIMap TInt TInt)) ($IsAlloc IMapType |m#1_0| (TIMap TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 26) 25))) anon0_correct)))))
