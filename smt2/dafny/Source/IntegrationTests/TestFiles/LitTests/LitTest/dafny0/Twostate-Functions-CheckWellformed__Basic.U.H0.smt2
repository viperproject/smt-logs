...
(declare-fun Basic.U.H0 (T@U T@U T@U) Int)
(declare-fun |Basic.U.H0#canCall| (T@U T@U T@U) Bool)
...
(assert (forall (($prevHeap T@U) ($h0 T@U) ($h1 T@U) (|u#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Basic.U.H0#canCall| $prevHeap $h0 |u#0|) ($Is refType |u#0| Tclass.Basic.U))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) (! true
 :qid |unknown.0:0|
 :skolemid |590|
)) (= (Basic.U.H0 $prevHeap $h0 |u#0|) (Basic.U.H0 $prevHeap $h1 |u#0|))))
 :qid |DafnyPreludebpl.593:12|
 :skolemid |592|
 :pattern ( ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1) (Basic.U.H0 $prevHeap $h1 |u#0|))
)))
...
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@0 T@U) ($Heap T@U) (|u#0@@0| T@U) ) (!  (=> (or (|Basic.U.H0#canCall| $prevHeap@@0 $Heap |u#0@@0|) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@0) ($IsGoodHeap $Heap)) ($HeapSucc $prevHeap@@0 $Heap)) ($Is refType |u#0@@0| Tclass.Basic.U)) (<= (LitInt 10) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@0 |u#0@@0|) Basic.U.aa))))))) (= (Basic.U.H0 $prevHeap@@0 $Heap |u#0@@0|) (LitInt 5)))
 :qid |TwostateFunctionsdfy.10:30|
 :skolemid |595|
 :pattern ( (Basic.U.H0 $prevHeap@@0 $Heap |u#0@@0|) ($IsGoodHeap $Heap))
))))
...
(assert (= (Tag Tclass.Basic.U) Tagclass.Basic.U))
(assert (= (TagFamily Tclass.Basic.U) tytagFamily$U))
(assert  (=> (<= 1 $FunctionContextHeight) (forall (($prevHeap@@1 T@U) ($Heap@@0 T@U) (|u#0@@1| T@U) ) (!  (=> (or (|Basic.U.H0#canCall| $prevHeap@@1 $Heap@@0 (Lit refType |u#0@@1|)) (and (< 1 $FunctionContextHeight) (and (and (and (and ($IsGoodHeap $prevHeap@@1) ($IsGoodHeap $Heap@@0)) ($HeapSucc $prevHeap@@1 $Heap@@0)) ($Is refType |u#0@@1| Tclass.Basic.U)) (<= (LitInt 10) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $prevHeap@@1 (Lit refType |u#0@@1|)) Basic.U.aa))))))) (= (Basic.U.H0 $prevHeap@@1 $Heap@@0 (Lit refType |u#0@@1|)) (LitInt 5)))
 :qid |TwostateFunctionsdfy.10:30|
 :weight 3
 :skolemid |596|
 :pattern ( (Basic.U.H0 $prevHeap@@1 $Heap@@0 (Lit refType |u#0@@1|)) ($IsGoodHeap $Heap@@0))
))))
...
(set-info :boogie-vc-id CheckWellformed$$Basic.U.H0)
...
(let ((anon0_correct  (=> (= $_ReadsFrame@0 (|lambda#0| null current$Heap alloc false)) (and (=> (= (ControlFlow 0 3) (- 0 5)) (or (not (= |u#0@@2| null)) (not true))) (=> (or (not (= |u#0@@2| null)) (not true)) (and (=> (= (ControlFlow 0 3) (- 0 4)) ($IsAlloc refType |u#0@@2| Tclass.Basic.U $Heap@@1)) (=> ($IsAlloc refType |u#0@@2| Tclass.Basic.U $Heap@@1) (=> (<= (LitInt 10) (U_2_int ($Unbox intType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap@@1 |u#0@@2|) Basic.U.aa)))) (and (=> (= (ControlFlow 0 3) 1) anon5_Then_correct) (=> (= (ControlFlow 0 3) 2) anon5_Else_correct))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap@@1) ($IsHeapAnchor $Heap@@1)) (=> (and (and (and ($Is refType |u#0@@2| Tclass.Basic.U) ($IsAlloc refType |u#0@@2| Tclass.Basic.U current$Heap)) (= 1 $FunctionContextHeight)) (and (and (= previous$Heap $Heap@@1) (and ($HeapSucc previous$Heap current$Heap) ($IsGoodHeap current$Heap))) (= (ControlFlow 0 6) 3))) anon0_correct))))
