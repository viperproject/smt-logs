...
(assert (forall (($prevHeap T@U) ($h0 T@U) ($h1 T@U) (|u#0| T@U) ) (!  (=> (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (or (|Basic.U.H0#canCall| $prevHeap $h0 |u#0|) ($Is refType |u#0| Tclass.Basic.U))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) ) true) (= (Basic.U.H0 $prevHeap $h0 |u#0|) (Basic.U.H0 $prevHeap $h1 |u#0|))))
