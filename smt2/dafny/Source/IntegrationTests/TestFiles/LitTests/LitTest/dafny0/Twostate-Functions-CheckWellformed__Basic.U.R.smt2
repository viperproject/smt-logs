...
(assert (forall (($prevHeap T@U) ($h0 T@U) ($h1 T@U) (this T@U) (|u#0| T@U) ) (!  (=> (and (and (and (and ($IsGoodHeap $h0) ($IsGoodHeap $h1)) (and (or (not (= this null)) (not true)) ($Is refType this Tclass.Basic.U))) (or (|Basic.U.R#canCall| $prevHeap $h0 this |u#0|) ($Is refType |u#0| Tclass.Basic.U))) (and ($IsHeapAnchor $h0) ($HeapSucc $h0 $h1))) (=> (forall (($o@@2 T@U) ($f T@U) )  (=> (and (or (not (= $o@@2 null)) (not true)) (= $o@@2 |u#0|)) (= (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h0 $o@@2) $f) (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $h1 $o@@2) $f)))) (= (Basic.U.R $prevHeap $h0 this |u#0|) (Basic.U.R $prevHeap $h1 this |u#0|))))
