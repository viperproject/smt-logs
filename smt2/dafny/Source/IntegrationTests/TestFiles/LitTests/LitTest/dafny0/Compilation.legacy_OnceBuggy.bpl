...
procedure {:verboseName "OnceBuggy.M (well-formedness)"} CheckWellFormed$$OnceBuggy.__default.M(OnceBuggy._default.M$U: Ty, 
    x#0: DatatypeType
...
procedure {:verboseName "OnceBuggy.M (call)"} Call$$OnceBuggy.__default.M(OnceBuggy._default.M$U: Ty, 
    x#0: DatatypeType
       where $Is(x#0, Tclass.OnceBuggy.MyDt(TInt))
         && $IsAlloc(x#0, Tclass.OnceBuggy.MyDt(TInt), $Heap)
         && $IsA#OnceBuggy.MyDt(x#0));
...
procedure {:verboseName "OnceBuggy.M (correctness)"} Impl$$OnceBuggy.__default.M(OnceBuggy._default.M$U: Ty, 
    x#0: DatatypeType
       where $Is(x#0, Tclass.OnceBuggy.MyDt(TInt))
         && $IsAlloc(x#0, Tclass.OnceBuggy.MyDt(TInt), $Heap)
         && $IsA#OnceBuggy.MyDt(x#0))
