...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |d#0| Tclass._module.D) ($IsAlloc DatatypeTypeType |d#0| Tclass._module.D $Heap)) (|$IsA#_module.D| |d#0|)) (and (and (= 1 $FunctionContextHeight) (not (|_module.D#Equal| |d#0| |#_module.D.Blue|))) (and (not (|_module.D#Equal| |d#0| |#_module.D.Purple|)) (= (ControlFlow 0 12) 11)))) anon0_correct))))
