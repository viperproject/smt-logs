...
(set-info :boogie-vc-id CheckWellFormed$$_module.Tree.EvensSumToEven_split0)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon4_correct  (=> (forall ((|u#1| T@U) ) (!  (=> (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@3) ($Box intType |u#1|)) (= (Mod (U_2_int |u#1|) (LitInt 2)) (LitInt 0)))
 :qid |Terminationdfy.491:21|
 :skolemid |3658|
 :pattern ( (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@3) ($Box intType |u#1|)))
)) (=> (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (=> (and (and (= $Heap $Heap@0) ($IsAllocBox ($Box DatatypeTypeType this@@3) Tclass._module.Tree $Heap@0)) (and (|_module.Tree.Sum#canCall| this@@3) (= (ControlFlow 0 2) (- 0 1)))) (or (not (= (LitInt 2) 0)) (not true)))))))
(let ((anon5_Else_correct  (=> (and (=> (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@3) ($Box intType (int_2_U |u#0@0|))) (= (Mod |u#0@0| (LitInt 2)) (LitInt 0))) (= (ControlFlow 0 4) 2)) anon4_correct)))
(let ((anon5_Then_correct  (=> (and ($IsAllocBox ($Box DatatypeTypeType this@@3) Tclass._module.Tree $Heap) (|_module.Tree.Elements#canCall| this@@3)) (=> (and (and (|Set#IsMember| (_module.Tree.Elements ($LS $LZ) this@@3) ($Box intType (int_2_U |u#0@0|))) (or (not (= (LitInt 2) 0)) (not true))) (and (= (Mod |u#0@0| (LitInt 2)) (LitInt 0)) (= (ControlFlow 0 3) 2))) anon4_correct))))
(let ((anon0_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is DatatypeTypeType this@@3 Tclass._module.Tree) ($IsAlloc DatatypeTypeType this@@3 Tclass._module.Tree $Heap)) (and (= 2 $FunctionContextHeight) (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)))) (and (=> (= (ControlFlow 0 5) 3) anon5_Then_correct) (=> (= (ControlFlow 0 5) 4) anon5_Else_correct))))))
anon0_correct)))))
))
(check-sat)
(get-info :rlimit)
