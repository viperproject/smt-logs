...
(assert  (=> (<= 2 $FunctionContextHeight) (forall ((|_module._default.Y#$_T0| T@U) ($ly T@U) (|_k#0| T@U) (|s#0| T@U) ) (!  (=> (or (|_module.__default.Y_h#canCall| |_module._default.Y#$_T0| |_k#0| |s#0|) (and (< 2 $FunctionContextHeight) ($Is DatatypeTypeType |s#0| (Tclass._module.Stream |_module._default.Y#$_T0|)))) (and (and (=> (< 0 (|ORD#Offset| |_k#0|)) (and (_module.Stream.Cons_q |s#0|) (|_module.__default.Y_h#canCall| |_module._default.Y#$_T0| (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0|)))) (=> (=> (< 0 (|ORD#Offset| |_k#0|)) (_module.__default.Y_h |_module._default.Y#$_T0| $ly (|ORD#Minus| |_k#0| (|ORD#FromNat| 1)) (_module.Stream.tail |s#0|))) (=> (= (LitInt 0) (|ORD#Offset| |_k#0|)) (forall ((|_k'#0| T@U) ) (!  (=> (|ORD#Less| |_k'#0| |_k#0|) (|_module.__default.Y_h#canCall| |_module._default.Y#$_T0| |_k'#0| |s#0|))
 :qid |CoinductiveProofsdfy.113:20|
 :skolemid |694|
...
(declare-fun |_module._default.AlwaysLemma_Y1#$_T0| () T@U)
...
(set-info :boogie-vc-id Impl$$_module.__default.AlwaysLemma__Y1_h)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> (|_module.__default.Y_h#canCall| |_module._default.AlwaysLemma_Y1#$_T0| |_k#0@@4| |s#1|) (or (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) |_k#0@@4| |s#1|) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) (_module.Stream.tail |s#1|)))))) (=> (=> (|_module.__default.Y_h#canCall| |_module._default.AlwaysLemma_Y1#$_T0| |_k#0@@4| |s#1|) (or (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) |_k#0@@4| |s#1|) (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS ($LS $LZ)) (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1)) (_module.Stream.tail |s#1|))))) (=> (= (ControlFlow 0 2) (- 0 1)) (=> (|_module.__default.Y_h#canCall| |_module._default.AlwaysLemma_Y1#$_T0| |_k#0@@4| |s#1|) (or (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) |_k#0@@4| |s#1|) (=> (= (LitInt 0) (|ORD#Offset| |_k#0@@4|)) (forall ((|_k'#1@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#1@@1| |_k#0@@4|) (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS ($LS $LZ)) |_k'#1@@1| |s#1|))
 :qid |CoinductiveProofsdfy.113:20|
 :skolemid |718|
 :pattern ( (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS ($LS $LZ)) |_k'#1@@1| |s#1|))
))))))))))
(let ((anon3_Else_correct  (=> (<= (|ORD#Offset| |_k#0@@4|) 0) (=> (and (and (and ($IsGoodHeap $Heap@1) ($IsHeapAnchor $Heap@1)) (= $Heap $Heap@1)) (and (forall ((|_k'#2@@1| T@U) (|s#2| T@U) ) (!  (=> (and ($Is DatatypeTypeType |s#2| (Tclass._module.Stream |_module._default.AlwaysLemma_Y1#$_T0|)) (|ORD#Less| |_k'#2@@1| |_k#0@@4|)) (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) |_k'#2@@1| |s#2|))
 :qid |CoinductiveProofsdfy.125:35|
 :skolemid |722|
 :pattern ( (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) |_k'#2@@1| |s#2|))
)) (= (ControlFlow 0 7) 2))) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (< 0 (|ORD#Offset| |_k#0@@4|)) (and (=> (= (ControlFlow 0 4) (- 0 6)) (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1)))) (=> (|ORD#IsNat| (Lit BoxType (|ORD#FromNat| 1))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@4|))) (=> (<= (|ORD#Offset| (Lit BoxType (|ORD#FromNat| 1))) (|ORD#Offset| |_k#0@@4|)) (=> (= |_k##0@0| (|ORD#Minus| |_k#0@@4| (|ORD#FromNat| 1))) (=> (and (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (|_module.__default.Y_h#canCall| |_module._default.AlwaysLemma_Y1#$_T0| |_k##0@0| |s#1|)) (and (and (|_module.__default.Y_h#canCall| |_module._default.AlwaysLemma_Y1#$_T0| |_k##0@0| |s#1|) (and (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) |_k##0@0| |s#1|) (and (=> (< 0 (|ORD#Offset| |_k##0@0|)) (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) (|ORD#Minus| |_k##0@0| (|ORD#FromNat| 1)) (_module.Stream.tail |s#1|))) (=> (= (LitInt 0) (|ORD#Offset| |_k##0@0|)) (forall ((|_k'#0@@1| T@U) ) (!  (=> (|ORD#Less| |_k'#0@@1| |_k##0@0|) (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) |_k'#0@@1| |s#1|))
 :qid |CoinductiveProofsdfy.113:20|
 :skolemid |717|
 :pattern ( (_module.__default.Y_h |_module._default.AlwaysLemma_Y1#$_T0| ($LS $LZ) |_k'#0@@1| |s#1|))
...
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is DatatypeTypeType |s#1| (Tclass._module.Stream |_module._default.AlwaysLemma_Y1#$_T0|)) ($IsAlloc DatatypeTypeType |s#1| (Tclass._module.Stream |_module._default.AlwaysLemma_Y1#$_T0|) $Heap)) (|$IsA#_module.Stream| |s#1|)) (and (= 3 $FunctionContextHeight) (= (ControlFlow 0 9) 8))) anon0_correct))))
