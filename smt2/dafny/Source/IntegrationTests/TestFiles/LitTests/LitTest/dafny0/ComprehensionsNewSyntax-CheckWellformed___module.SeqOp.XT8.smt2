...
(declare-fun _module.SeqOp.XT8 (T@U Int) T@U)
(declare-fun Lit (T@T T@U) T@U)
(declare-fun LitInt (Int) Int)
(declare-fun $IsGoodHeap (T@U) Bool)
(declare-fun |_module.SeqOp.XT8#canCall| (T@U Int) Bool)
(declare-fun Tclass._module.SeqOp () T@U)
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap T@U) (this T@U) (|n#0| Int) ) (!  (=> (or (|_module.SeqOp.XT8#canCall| (Lit refType this) (LitInt |n#0|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap) (and (or (not (= this null)) (not true)) (and ($Is refType this Tclass._module.SeqOp) ($IsAlloc refType this Tclass._module.SeqOp $Heap)))) (<= (LitInt 0) |n#0|)))) (= (_module.SeqOp.XT8 (Lit refType this) (LitInt |n#0|)) (|Seq#Create| TInt $Heap (LitInt |n#0|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.185:12|
 :weight 3
 :skolemid |744|
 :pattern ( (_module.SeqOp.XT8 (Lit refType this) (LitInt |n#0|)) ($IsGoodHeap $Heap))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall ((this@@0 T@U) (|n#0@@0| Int) ) (!  (=> (or (|_module.SeqOp.XT8#canCall| this@@0 |n#0@@0|) (and (< 0 $FunctionContextHeight) (and (and (or (not (= this@@0 null)) (not true)) ($Is refType this@@0 Tclass._module.SeqOp)) (<= (LitInt 0) |n#0@@0|)))) ($Is SeqType (_module.SeqOp.XT8 this@@0 |n#0@@0|) (TSeq Tclass._System.nat)))
 :qid |ComprehensionsNewSyntaxdfy.185:12|
 :skolemid |740|
 :pattern ( (_module.SeqOp.XT8 this@@0 |n#0@@0|))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@0 T@U) (this@@1 T@U) (|n#0@@1| Int) ) (!  (=> (or (|_module.SeqOp.XT8#canCall| this@@1 |n#0@@1|) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@0) (and (or (not (= this@@1 null)) (not true)) (and ($Is refType this@@1 Tclass._module.SeqOp) ($IsAlloc refType this@@1 Tclass._module.SeqOp $Heap@@0)))) (<= (LitInt 0) |n#0@@1|)))) (= (_module.SeqOp.XT8 this@@1 |n#0@@1|) (|Seq#Create| TInt $Heap@@0 |n#0@@1| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0@@1| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.185:12|
 :skolemid |742|
 :pattern ( (_module.SeqOp.XT8 this@@1 |n#0@@1|) ($IsGoodHeap $Heap@@0))
))))
...
(assert  (=> (<= 0 $FunctionContextHeight) (forall (($Heap@@1 T@U) (this@@2 T@U) (|n#0@@2| Int) ) (!  (=> (or (|_module.SeqOp.XT8#canCall| this@@2 (LitInt |n#0@@2|)) (and (< 0 $FunctionContextHeight) (and (and ($IsGoodHeap $Heap@@1) (and (or (not (= this@@2 null)) (not true)) (and ($Is refType this@@2 Tclass._module.SeqOp) ($IsAlloc refType this@@2 Tclass._module.SeqOp $Heap@@1)))) (<= (LitInt 0) |n#0@@2|)))) (= (_module.SeqOp.XT8 this@@2 (LitInt |n#0@@2|)) (|Seq#Create| TInt $Heap@@1 (LitInt |n#0@@2|) (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0@@2| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))))))
 :qid |ComprehensionsNewSyntaxdfy.185:12|
 :weight 3
 :skolemid |743|
 :pattern ( (_module.SeqOp.XT8 this@@2 (LitInt |n#0@@2|)) ($IsGoodHeap $Heap@@1))
))))
...
(assert (forall ((|l#0@@3| Int) (|l#1@@0| Int) (|l#2@@0| Int) (|$l#0#heap#0| T@U) (|$l#0#i#0| T@U) ) (! (= (MapType0Select (MapType1Type refType (MapType1Type FieldType BoxType)) BoxType BoxType (|lambda#397| |l#0@@3| |l#1@@0| |l#2@@0|) |$l#0#heap#0| |$l#0#i#0|) ($Box intType (int_2_U (ite (< (U_2_int ($Unbox intType |$l#0#i#0|)) |l#0@@3|) |l#1@@0| |l#2@@0|))))
 :qid |ComprehensionsNewSyntaxdfy.179:16|
 :skolemid |784|
...
(set-info :boogie-vc-id CheckWellformed$$_module.SeqOp.XT8)
...
(let ((anon14_Else_correct  (=> (<= |n#0@@3| |i#0@0|) (and (=> (= (ControlFlow 0 9) (- 0 10)) ($Is intType (int_2_U (LitInt 10)) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt 10)) Tclass._System.nat) (=> (= |lambdaResult#0| (LitInt 10)) (=> (and ($Is intType (int_2_U |lambdaResult#0|) Tclass._System.nat) (= (ControlFlow 0 9) 6)) anon8_correct)))))))
(let ((anon14_Then_correct  (=> (< |i#0@0| |n#0@@3|) (and (=> (= (ControlFlow 0 7) (- 0 8)) ($Is intType (int_2_U (LitInt (- 0 7))) Tclass._System.nat)) (=> ($Is intType (int_2_U (LitInt (- 0 7))) Tclass._System.nat) (=> (= |lambdaResult#0| (LitInt (- 0 7))) (=> (and ($Is intType (int_2_U |lambdaResult#0|) Tclass._System.nat) (= (ControlFlow 0 7) 6)) anon8_correct)))))))
...
(let ((anon12_Else_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (forall ((|seqinit#0#i0#0| Int) ) (!  (=> (and (<= 0 |seqinit#0#i0#0|) (< |seqinit#0#i0#0| |n#0@@3|)) (Requires1 TInt Tclass._System.nat $Heap@@2 (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0@@3| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ))) ($Box intType (int_2_U |seqinit#0#i0#0|))))
 ...
 :qid |ComprehensionsNewSyntaxdfy.186:5|
 :skolemid |747|
))) (= (_module.SeqOp.XT8 this@@3 |n#0@@3|) (|Seq#Create| TInt $Heap@@2 |n#0@@3| (Lit HandleTypeType (AtLayer HandleTypeType (|lambda#18| (Handle1 (|lambda#397| |n#0@@3| (- 0 7) 10) (|lambda#15| TInt) (|lambda#17| (SetRef_to_SetBox (|lambda#16| false))))) ($LS $LZ)))))) (and ($Is SeqType (_module.SeqOp.XT8 this@@3 |n#0@@3|) (TSeq Tclass._System.nat)) (= (ControlFlow 0 3) (- 0 2)))) |b$reqreads#0@0|))))
