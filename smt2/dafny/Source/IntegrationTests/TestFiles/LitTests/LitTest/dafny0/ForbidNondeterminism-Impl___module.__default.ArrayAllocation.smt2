...
(assert (distinct TBool TInt TagBool TagInt alloc Tagclass._System.array? Tagclass._System.array Tagclass._System.array2? Tagclass._System.array2 tytagFamily$array tytagFamily$array2)
)
...
(set-info :boogie-vc-id Impl$$_module.__default.ArrayAllocation)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (<= 0 |n#0|)) (=> (<= 0 |n#0|) (=> (and (and (and (or (not (= $nw@0 null)) (not true)) ($Is refType $nw@0 (Tclass._System.array? TInt))) (not (U_2_bool ($Unbox boolType (MapType0Select FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc))))) (and (and (= (_System.array.Length $nw@0) |n#0|) (= $Heap@0 (MapType0Store refType (MapType0Type FieldType BoxType) $Heap $nw@0 (MapType0Store FieldType BoxType (MapType0Select refType (MapType0Type FieldType BoxType) $Heap $nw@0) alloc ($Box boolType (bool_2_U true)))))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (<= 0 |p#0|)) (=> (<= 0 |p#0|) (=> (= (ControlFlow 0 2) (- 0 1)) (<= 0 |q#0|))))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (and (and (and (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (<= (LitInt 0) |n#0|)) (and (<= (LitInt 0) |p#0|) (<= (LitInt 0) |q#0|))) (and (and ($Is refType |a#0| (Tclass._System.array TInt)) ($IsAlloc refType |a#0| (Tclass._System.array TInt) $Heap)) true)) (and (and (and ($Is refType |m#0| (Tclass._System.array2 TBool)) ($IsAlloc refType |m#0| (Tclass._System.array2 TBool) $Heap)) true) (and (= 0 $FunctionContextHeight) (= (ControlFlow 0 5) 2)))) anon0_correct)))
