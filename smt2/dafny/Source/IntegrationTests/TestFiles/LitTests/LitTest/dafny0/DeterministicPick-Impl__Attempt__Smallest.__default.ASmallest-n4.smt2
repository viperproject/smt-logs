...
(let ((anon9_Then_correct  (and (=> (= (ControlFlow 0 16) (- 0 17)) (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |s#0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#z0#0| T@U) ) (|Set#IsMember| |s#0| ($Box intType |$as#z0#0|))))) (=> (or (and ($Is intType (int_2_U (LitInt 0)) TInt) (|Set#IsMember| |s#0| ($Box intType (int_2_U (LitInt 0))))) (exists ((|$as#z0#0@@0| Int) ) (|Set#IsMember| |s#0| ($Box intType (int_2_U |$as#z0#0@@0|))))) (=> (|Set#IsMember| |s#0| ($Box intType (int_2_U |z#0@0|))) (and (=> (= (ControlFlow 0 16) 15) anon10_Then_correct) (=> (= (ControlFlow 0 16) 4) anon10_Else_correct)))))))
