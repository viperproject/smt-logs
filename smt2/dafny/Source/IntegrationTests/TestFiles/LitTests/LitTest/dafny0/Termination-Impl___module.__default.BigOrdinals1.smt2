...
(set-info :boogie-vc-id Impl$$_module.__default.BigOrdinals1)
...
(let ((anon13_Else_correct  (=> (or (not (= |b#0@0| (|ORD#FromNat| 0))) (not true)) (and (=> (= (ControlFlow 0 13) (- 0 14)) (|ORD#Less| (|ORD#FromNat| 0) |b#0@0|)) (=> (|ORD#Less| (|ORD#FromNat| 0) |b#0@0|) (and (=> (= (ControlFlow 0 13) 12) anon14_Then_correct) (=> (= (ControlFlow 0 13) 6) anon14_Else_correct)))))))
...
)) (or (= |b#0@0| |B#0|) (|ORD#Less| |b#0@0| |B#0|)))) (and (=> (= (ControlFlow 0 17) 1) anon11_LoopDone_correct) (=> (= (ControlFlow 0 17) 16) anon11_LoopBody_correct))))))
(let ((anon0_correct  (=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (= (ControlFlow 0 18) 17)) anon11_LoopHead_correct)))
