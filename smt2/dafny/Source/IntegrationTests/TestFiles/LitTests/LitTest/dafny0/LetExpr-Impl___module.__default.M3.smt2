...
(let ((anon12_Else_correct  (=> (and (forall ((|i#0_1| Int) )  (=> (and (<= (LitInt 0) |i#0_1|) (< |i#0_1| (_System.array.Length |a#0|))) (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 3) 2)) GeneratedUnifiedExit_correct)))
