...
(assert (distinct TInt TagInt alloc Tagclass._System.nat Tagclass._System.___hFunc1 Tagclass._System.___hPartialFunc1 Tagclass._System.___hTotalFunc1 Tagclass.ErrorMessagesOfFailingConstraints.X tytagFamily$nat |tytagFamily$_#Func1| |tytagFamily$_#PartialFunc1| |tytagFamily$_#TotalFunc1| tytagFamily$X)
)
...
(assert (forall ((|u#0| T@U) ($h@@0 T@U) ) (! ($IsAlloc intType |u#0| Tclass.ErrorMessagesOfFailingConstraints.X $h@@0)
 :qid |unknown.0:0|
 :skolemid |8952|
 :pattern ( ($IsAlloc intType |u#0| Tclass.ErrorMessagesOfFailingConstraints.X $h@@0))
)))
...
(assert (forall ((bx@@2 T@U) ) (!  (=> ($IsBox bx@@2 Tclass.ErrorMessagesOfFailingConstraints.X) (and (= ($Box intType ($Unbox intType bx@@2)) bx@@2) ($Is intType ($Unbox intType bx@@2) Tclass.ErrorMessagesOfFailingConstraints.X)))
 :qid |unknown.0:0|
 :skolemid |8944|
 :pattern ( ($IsBox bx@@2 Tclass.ErrorMessagesOfFailingConstraints.X))
)))
...
(declare-fun |hh#0_0| () T@U)
(declare-fun |hh#1_0| () T@U)
(declare-fun |gg#2_0| () T@U)
(declare-fun |gg#3_0| () T@U)
(declare-fun |ff#4_0| () T@U)
(declare-fun $FunctionContextHeight () Int)
(set-info :boogie-vc-id Impl$$ErrorMessagesOfFailingConstraints.__default.M1)
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 14) (let ((anon11_Else_correct  (=> (and (and (and (and (and (not (U_2_bool (Lit boolType (bool_2_U true)))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (not (U_2_bool (Lit boolType (bool_2_U true))))) (= (ControlFlow 0 12) (- 0 11))) false)))
(let ((anon11_Then_correct  (=> (= (ControlFlow 0 10) (- 0 9)) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hFunc1 TInt Tclass.ErrorMessagesOfFailingConstraints.X)))))
(let ((anon10_Then_correct  (=> (= (ControlFlow 0 8) (- 0 7)) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hFunc1 TInt Tclass._System.nat)))))
(let ((anon9_Then_correct  (=> (= (ControlFlow 0 6) (- 0 5)) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hTotalFunc1 TInt TInt)))))
(let ((anon8_Then_correct  (=> (= (ControlFlow 0 4) (- 0 3)) ($Is HandleTypeType |g#0| (Tclass._System.___hTotalFunc1 TInt TInt)))))
(let ((anon7_Then_correct  (=> (= (ControlFlow 0 2) (- 0 1)) ($Is HandleTypeType |f#0@@3| (Tclass._System.___hPartialFunc1 TInt TInt)))))
(let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (and (and (and (and (=> (= (ControlFlow 0 13) 2) anon7_Then_correct) (=> (= (ControlFlow 0 13) 4) anon8_Then_correct)) (=> (= (ControlFlow 0 13) 6) anon9_Then_correct)) (=> (= (ControlFlow 0 13) 8) anon10_Then_correct)) (=> (= (ControlFlow 0 13) 10) anon11_Then_correct)) (=> (= (ControlFlow 0 13) 12) anon11_Else_correct)))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and ($Is HandleTypeType |f#0@@3| (Tclass._System.___hFunc1 TInt TInt)) ($IsAlloc HandleTypeType |f#0@@3| (Tclass._System.___hFunc1 TInt TInt) $Heap)) (and ($Is HandleTypeType |g#0| (Tclass._System.___hPartialFunc1 TInt TInt)) ($IsAlloc HandleTypeType |g#0| (Tclass._System.___hPartialFunc1 TInt TInt) $Heap))) (=> (and (and (and ($Is HandleTypeType |hh#0_0| (Tclass._System.___hFunc1 TInt Tclass.ErrorMessagesOfFailingConstraints.X)) ($IsAlloc HandleTypeType |hh#0_0| (Tclass._System.___hFunc1 TInt Tclass.ErrorMessagesOfFailingConstraints.X) $Heap)) true) (and (and ($Is HandleTypeType |hh#1_0| (Tclass._System.___hFunc1 TInt Tclass._System.nat)) ($IsAlloc HandleTypeType |hh#1_0| (Tclass._System.___hFunc1 TInt Tclass._System.nat) $Heap)) true)) (=> (and (and (and (and ($Is HandleTypeType |gg#2_0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |gg#2_0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true) (and (and ($Is HandleTypeType |gg#3_0| (Tclass._System.___hTotalFunc1 TInt TInt)) ($IsAlloc HandleTypeType |gg#3_0| (Tclass._System.___hTotalFunc1 TInt TInt) $Heap)) true)) (and (and (and ($Is HandleTypeType |ff#4_0| (Tclass._System.___hPartialFunc1 TInt TInt)) ($IsAlloc HandleTypeType |ff#4_0| (Tclass._System.___hPartialFunc1 TInt TInt) $Heap)) true) (and (= 1 $FunctionContextHeight) (= (ControlFlow 0 14) 13)))) anon0_correct))))))
