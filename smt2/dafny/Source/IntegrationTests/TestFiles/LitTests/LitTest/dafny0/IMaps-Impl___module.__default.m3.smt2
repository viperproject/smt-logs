...
(assert (forall ((v@@9 T@U) (t0@@5 T@U) (t1@@3 T@U) ) (!  (=> ($Is IMapType v@@9 (TIMap t0@@5 t1@@3)) (and (and ($Is (MapType0Type BoxType boolType) (|IMap#Domain| v@@9) (TISet t0@@5)) ($Is (MapType0Type BoxType boolType) (|IMap#Values| v@@9) (TISet t1@@3))) ($Is (MapType0Type BoxType boolType) (|IMap#Items| v@@9) (TISet (Tclass._System.Tuple2 t0@@5 t1@@3)))))
 :qid |DafnyPreludebpl.281:15|
 :skolemid |60|
 :pattern ( ($Is IMapType v@@9 (TIMap t0@@5 t1@@3)))
)))
...
(set-option :smt.arith.solver 2)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType (int_2_U (LitInt 20)))))) (=> (= (ControlFlow 0 2) (- 0 1)) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0|) ($Box intType (int_2_U (LitInt 20)))))) (LitInt 400)))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and ($IsGoodHeap $Heap) ($IsHeapAnchor $Heap)) (=> (and (and (and ($Is IMapType |a#0| (TIMap TInt TInt)) ($IsAlloc IMapType |a#0| (TIMap TInt TInt) $Heap)) (= 0 $FunctionContextHeight)) (and (forall ((|i#1| T@U) ) (!  (=> (and (<= (LitInt 0) (U_2_int |i#1|)) (< (U_2_int |i#1|) 100)) (and (U_2_bool (MapType0Select BoxType boolType (|IMap#Domain| |a#0|) ($Box intType |i#1|))) (= (U_2_int ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0|) ($Box intType |i#1|)))) (Mul (U_2_int |i#1|) (U_2_int |i#1|)))))
 :qid |IMapsdfy.45:20|
 :skolemid |542|
 :pattern ( ($Unbox intType (MapType0Select BoxType BoxType (|IMap#Elements| |a#0|) ($Box intType |i#1|))))
