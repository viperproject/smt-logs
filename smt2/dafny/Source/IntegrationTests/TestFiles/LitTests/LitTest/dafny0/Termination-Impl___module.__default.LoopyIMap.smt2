...
(assert (forall ((m@@8 T@U) ) (!  (or (= m@@8 |IMap#Empty|) (exists ((k@@4 T@U) (v@@6 T@U) ) (! (U_2_bool (MapType0Select BoxType boolType (|IMap#Items| m@@8) ($Box DatatypeTypeType (|#_System._tuple#2._#Make2| k@@4 v@@6))))
...
(set-info :boogie-vc-id Impl$$_module.__default.LoopyIMap)
...
)) (|ISet#Equal| (|IMap#Domain| |m#0|) (|IMap#Domain| |m#0|)))) (and (=> (= (ControlFlow 0 8) 1) anon6_LoopDone_correct) (=> (= (ControlFlow 0 8) 7) anon6_LoopBody_correct))))))
